...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_5, var_2_4("escape_series_rank"))
	...
	var_1(var_2_8, var_2_7("escape_series_task"))
	...
	var_1(var_2.Find(var_2_10, "Battle/Nodes"), function(arg_3_0, arg_3_1)
	...
	var_1(var_2.Find(var_2_11, "Story/Nodes"), function(arg_4_0, arg_4_1)
	...
	pg = var_3
	arg_2_0.camEventId = var_2_14(var_2_13, var_3.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_5_0, arg_5_1)
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_11()
		...
		i18n = var_2_10003
		var_11_2.helps = var_2_10003("escape_manor_series_help")
	...
	local function var_8_14()
		...
		BossRushEscapeManorMediator = var_2_10002
...
function var_0_1.UpdateView(arg_21_0)
	...
	local var_21_6 = arg_21_0.ptBtn
	local var_21_7 = var_4.Find(var_21_6, "Text")

	i18n = var_21_6

	var_3(var_21_7, var_21_6("escape_series_pt", arg_21_0.ptActivity.data1))

	setActive = var_3

	local var_21_8 = arg_21_0.ptTip

	Activity = var_5

	var_3(var_21_8, var_5.IsActivityReady(arg_21_0.ptActivity))

	local var_21_9 = arg_21_0.contextData.displayMode

	arg_21_0:addbubbleMsgBoxList({
		function(arg_23_0)
			local var_23_0

			if var_21_9 == var_0_1.DISPLAY.BATTLE then
				local var_23_1 = arg_21_0.activity

				var_23_0 = var_2.getConfig(var_23_1, "config_client").openActivityStory
			elseif var_21_9 == var_0_1.DISPLAY.STORY then
...
function var_0_1.UpdateBattle(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_26_0(var_26_1) do
		...
		local var_26_8 = var_26_3
		local var_26_9 = var_26_3.Find(var_26_8, "blue")

		BossRushSeriesData = var_26_8

		var_26_6(var_26_9, var_26_7 == var_26_8.TYPE.NORMAL)

		setActive = var_26_6

		local var_26_10 = var_26_3
		local var_26_11 = var_26_3.Find(var_26_10, "red")

		BossRushSeriesData = var_26_10

		var_26_6(var_26_11, var_26_7 ~= var_26_10.TYPE.NORMAL)

		local var_26_12

		BossRushSeriesData = var_26_11

		if var_26_7 == var_26_11.TYPE.NORMAL then
			var_26_12 = var_26_3:Find("blue")
		else
			var_26_12 = var_26_3:Find("red")
		end

		setText = var_13

		var_13(var_26_12:Find("Text"), var_1_10009:GetName())

		setText = var_13

		local var_26_13 = var_26_12
		local var_26_14 = var_26_12.Find(var_26_13, "diff/Text")

		switch = var_26_13

		local var_26_15 = iter_26_1
		local var_26_16 = {
			[6001] = function()
				i18n = var_2_10000
		...
		local function var_26_17()
			i18n = var_2_10000

			return var_2_10000("zengke_series_ex")
		end

		var_26_16[6005] = var_26_17

		var_13(var_26_14, var_26_13(var_26_15, var_26_16))

		BossRushSeriesData = var_13

		local var_26_18 = var_26_7 == var_13.TYPE.SP

		setActive = var_26_14

		var_26_14(var_26_3:Find("times"), var_26_18)

		local var_26_19 = true
		local var_26_20, var_26_22
		...
		if var_26_18 then
			...
			local var_26_21 = var_1_10009:GetMaxBonusCount() - var_26_20 > 0

			setText = var_17
			var_26_22 = var_26_3

			local var_26_23 = var_26_3.Find(var_26_22, "times/Text")

			i18n = var_26_22
			var_26_22 = var_26_22("series_enemy_SP_count")
			setColorStr = var_20
			math = var_1_10021

			var_17(var_26_23, var_26_22 .. var_20(var_1_10021.max(0, var_16 - var_26_20) .. "/" .. var_16, var_26_21 and "#6EE868" or "#7f7f7f"))
		end

		onButton = var_26_20

		local var_26_24 = arg_26_0
		local var_26_25 = var_26_3

		local function var_26_26()
			...
			local var_32_4 = arg_26_0
			local var_32_5 = var_0.emit

			BossRushEscapeManorMediator = var_2_10002

			var_32_5(var_32_4, var_2_10002.ON_FLEET_SELECT, var_1_10009)
		...
		var_26_20(var_26_24, var_26_25, var_26_26, var_26_22)
	end
...
function var_0_1.UpdateStory(arg_33_0)
	...
	for iter_33_0, iter_33_1 in var_1_10004(arg_33_0.storyNodesDict) do
		...
		var_1_10009(var_33_3 .. var_1_10011(iter_33_1.id))

		var_1_10009 = arg_33_0.nodes
		tostring = var_10
		var_1_10009 = var_1_10009[var_10(iter_33_1.id)]
		var_1_10011 = iter_33_1

		local var_33_4 = iter_33_1.IsActive(var_1_10011, arg_33_0.activity, arg_33_0.ptActivity)

		setActive = var_1_10011

		var_1_10011(var_1_10009, var_33_4)

		setText = var_1_10011

		var_1_10011(var_1_10009:Find("main/char/bg/Text"), iter_33_1:GetName())

		var_33_1 = var_33_1 + (iter_33_1:IsReaded() and 1 or 0)
		var_33_2 = var_33_2 + 1
		setActive = var_12

		var_12(var_1_10009:Find("main/char"), not var_1_10011)

		setActive = var_12

		var_12(var_1_10009:Find("main/talk"), var_1_10011)

		onButton = var_12

		var_12(arg_33_0, var_1_10009, function()
			if not var_33_4 or var_1_10011 then
				return
			end
	...
	var_4(var_33_5, var_6("escape_story_reward_count"))

	setText = var_4
	findTF = var_33_5

	local var_33_6 = var_33_5(arg_33_0.progressText, "progress")

	setColorStr = var_6

	var_4(var_33_6, var_6(var_33_1, "#f34f66") .. "/" .. var_33_2)
	...
	var_37_0({
		function(arg_38_0)
			...
			if var_1(arg_37_1) and var_1 > 0 then
				...
				BossRushEscapeManorMediator = var_2_10004
...
function var_0_1.UpdateStoryTask(arg_39_0)
	...
	var_39_3(var_39_8, var_39_9(var_39_11(var_39_10, var_1_10007.ESCAPE_BOSS_RUSH_TASK_ACT_ID)))
	...
	if arg_39_0.storyTask then
		...
		local var_39_18 = var_39_16:Find("IconTpl")
	...
	local var_39_24 = var_39_22.Create(var_39_23[1])
	local var_39_25 = arg_39_0.storyAward
	local var_39_26 = var_4.Find(var_39_25, "award_bg")

	updateDrop = var_39_25

	var_39_25(var_39_26:Find("IconTpl"), var_39_24)
	...
	var_39_25(var_39_27, var_39_28, var_39_29, var_1_10009)
	...
	var_39_30(var_39_26:Find("get"), var_39_31 == 1)

	setActive = var_39_30

	var_39_30(var_39_26:Find("got"), var_39_31 == 2)

	if var_39_31 == 1 then
		local var_39_32 = arg_39_0
		local var_39_33 = arg_39_0.emit

		BossRushEscapeManorMediator = var_8

		var_39_33(var_39_32, var_8.ON_TASK_SUBMIT, arg_39_0.storyTask)
	end
