...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local var_2_0 = var_2(arg_2_0.btnRule, "text")

	i18n = var_3

	var_1(var_2_0, var_3("pac_game_rule_btn"))
	...
	local function var_2_3()
		...
		pg = var_2_10003
		var_3_2.helps = var_2_10003.gametip.pac_minigame_help.tip
	...
	local var_2_4 = var_2(arg_2_0.btnStart, "text")

	i18n = var_3

	var_1(var_2_4, var_3("pac_game_start_btn"))
	...
	for iter_2_0 = 1, 7 do
		...
		var_1_10008(var_2_10, var_1_10010(arg_2_0._tf, "ad/awards/Viewport/Content"))

		var_1_10008 = iter_2_0
		setText = var_2_10
		findTF = var_1_10010
		var_1_10010 = var_1_10010(var_1_10007, "ad/desc")
		i18n = var_11

		var_2_10(var_1_10010, var_11("which_day_2", var_1_10008))

		findTF = var_2_10

		local var_2_11 = var_2_10(var_1_10007, "ad/iconMask/icon")
		...
		var_11(var_2_12, var_2_13, var_2_14, var_1_10015)
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	if var_1.GetHighScore(var_6_1, var_0_2) then
		local var_6_2 = #var_1
		local var_6_3
		...
		local var_6_4 = arg_6_0.highScore

		i18n = var_1_10005

		var_3(var_6_4, var_1_10005("pac_game_high_score_tip", var_6_3))
