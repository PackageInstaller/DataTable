...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	if not arg_5_0.isAvailable then
		for iter_5_0 = 1, arg_5_0.resultTF.childCount do
			...
			var_1_10005(var_6.GetChild(var_5_0, iter_5_0 - 1), iter_5_0 == arg_5_0.resultNum)
		end
	end
	...
	if var_1.getConfig(var_5_1, "config_data")[2] then
		...
		local var_5_2 = var_5_1.filter(var_1, function(arg_6_0)
			ipairs = var_2_10001
		...
		for iter_5_1, iter_5_2 in var_2(var_5_2) do
			if arg_5_0.progressNum == iter_5_2[1] then
				...
				var_5_4(var_5_3, var_1_10009.EVENT_OPERATION, {
					cmd = 2,
...
function var_0_1.showLotteryAwardResult(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	local var_8_1 = var_1_10004(var_8_0, var_1_10006(var_1_10007))
	...
	var_4.SetEndEvent(var_8_1, function(arg_9_0)
		...
		for iter_9_0 = 1, arg_8_0.resultTextTF.childCount do
			...
			var_2_10005(var_2_10006.GetChild(var_9_0, iter_9_0 - 1), iter_9_0 == arg_8_2)
		end
		...
		for iter_9_1, iter_9_2 in var_1(arg_8_1) do
			...
			var_8(var_9_2, var_9_3, var_9_4, var_2_10012)
		end
		...
		var_9_6(var_9_5, var_3.LOCK_ACT_MAIN, false)
		arg_8_3()
	...
	ActivityMainScene = var_7

	var_8_3(var_8_2, var_7.LOCK_ACT_MAIN, true)
...
function var_0_1.IsTip()
	...
	if var_12_1(var_12_0, var_1_10002.CYGNET_BATHROBE_PAGE_ID) and not var_0:isEnd() then
