...
function var_0_0.Init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.scoreTxt = var_2_1(var_2_0, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.comboTxt = var_2_3(var_2_2, var_3(var_1_10004))
	findTF = var_1
	...
	local var_2_6 = var_2_5(var_2_4, var_3(var_1_10004))
	...
	arg_2_0.refrigerator = var_2_8(var_2_7, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	SpineAnimUI = var_1_10004
	arg_2_0.char = var_2_10(var_2_9, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.timeTxt = var_2_12(var_2_11, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.gearTr = var_2_14(var_2_13, var_3(var_1_10004))
	arg_2_0.gearTrPos = arg_2_0.gearTr.transform.localPosition.y

	local var_2_15 = {}

	ValentineQteGameConst = var_2_13

	local var_2_16 = var_2_13.OP_SCORE_GEAR_PERFECT

	GetSpriteFromAtlas = var_3
	var_2_15[var_2_16] = var_3("ui/minigameui/valentineqtegame_atlas", "Perfect")
	...
	arg_2_0.msgBox = var_2_20(var_2.Find(var_2_21, "msgbox"))
	ValentineQteGamePoolMgr = var_1

	local var_2_22 = var_1.New
	local var_2_23 = arg_2_0._tf

	arg_2_0.itemPoolMgr = var_2_22(var_2.Find(var_2_23, "root/item"), 2, 4)
	ValentineQteGameResultWindow = var_1

	local var_2_24 = var_1.New
	local var_2_25 = arg_2_0._tf

	arg_2_0.resultWindow = var_2_24(var_2.Find(var_2_25, "result_panel"))
	findTF = var_1
...
function var_0_0.CountDown(arg_11_0, arg_11_1)
	...
	Timer = var_4
	arg_11_0.countDownTimer = var_4.New(function()
		var_11_1 = var_11_1 + 1
...
function var_0_0.InitGame(arg_25_0, arg_25_1)
	...
	var_25_0.sizeDelta = var_1_10003(var_1_10004.SLIDEWAY_WIDTH, arg_25_0.slideWay.sizeDelta.y)

	local var_25_1 = arg_25_0.slider

	Vector2 = var_3
	ValentineQteGameConst = var_4
	var_25_1.sizeDelta = var_3(var_4.SLIDER_WIDTH, arg_25_0.slider.sizeDelta.y)

	local var_25_2 = arg_25_0.goodArea

	Vector2 = var_3
	ValentineQteGameConst = var_4
	var_25_2.sizeDelta = var_3(var_4.GOOD_WIDTH, arg_25_0.goodArea.sizeDelta.y)

	local var_25_3 = arg_25_0.greatArea

	Vector2 = var_3
	ValentineQteGameConst = var_4
	var_25_3.sizeDelta = var_3(var_4.GREAT_WIDTH, arg_25_0.greatArea.sizeDelta.y)

	local var_25_4 = arg_25_0.perfectArea

	Vector2 = var_3
	ValentineQteGameConst = var_4
	var_25_4.sizeDelta = var_3(var_4.PERFECT_WIDTH, arg_25_0.perfectArea.sizeDelta.y)
...
function var_0_0.CreateDebugArea(arg_28_0, arg_28_1)
	...
	Vector3 = var_3
	var_28_0.localPosition = var_3(arg_28_0[arg_28_1].x, var_28_0.localPosition.y, 0)
	setActive = var_3
...
function var_0_0.CreateDebugLinePos(arg_29_0, arg_29_1)
	...
	Vector3 = var_3
	var_29_0.localPosition = var_3(arg_29_0[arg_29_1], var_29_0.localPosition.y, 0)
	setActive = var_3
...
function var_0_0.StartGame(arg_31_0)
	...
	local function var_31_3()
		if not arg_31_0.puaseGameFlag then
			...
			ValentineQteGameMsgBox = var_2_10003
			var_32_3.content = var_2_10003.PAUSE_TXT
	...
	var_1(var_31_1, var_31_2, var_31_3, var_1_10005)
	...
	local function var_31_6()
		...
		ValentineQteGameMsgBox = var_2_10003
		var_35_3.content = var_2_10003.EXIT_TXT
	...
	var_1(var_31_4, var_31_5, var_31_6, var_1_10005)
	...
	var_1.AddPointDownFunc(var_31_7, function()
		...
		if arg_31_0.opCdTime <= 0 and not arg_31_0.puaseGameFlag then
			...
			ValentineQteGameConst = var_38_0
			var_38_1.opCdTime = var_38_0.OP_INTERVAL
		end
...
function var_0_0.RandomItemPosition(arg_48_0, arg_48_1)
	...
	if arg_48_0:IsValidItemPos(var_48_1) then
		...
		var_48_2(var_48_3, arg_48_0.itemContainer)

		ValentineQteGameItem = var_48_2

		local var_48_4 = var_48_2.New
		local var_48_5 = var_48_3

		Vector2 = var_8

		local var_48_6 = var_48_4(var_48_5, var_8(var_48_1, arg_48_0.slider.localPosition.y), arg_48_0.time)

		table = var_48_5

		var_48_5.insert(arg_48_0.items, var_48_6)
	else
...
function var_0_0.UpdateSlider(arg_49_0)
	...
	local var_49_3 = var_49_0(var_49_1 + var_49_2 * var_1_10005.deltaTime, arg_49_0.missMinPosX, arg_49_0.missMaxPosX)
...
function var_0_0.UpdateSpeed(arg_51_0)
	...
	local var_51_1 = var_1_10002.ceil

	ValentineQteGameConst = var_1_10003

	if var_51_0(var_51_1(var_1_10003.GMAE_TIME - arg_51_0.time) / 5) > 0 and not arg_51_0.elapseTimes[var_1] then
...
function var_0_0.UpdateOpCdTime(arg_52_0)
	if arg_52_0.opCdTime > 0 then
		...
		Time = var_1_10004
		arg_52_0.opCdTime = var_52_0(var_52_1, var_52_2 - var_1_10004.deltaTime)
	end
...
function var_0_0.Snap(arg_53_0)
	...
	if var_53_1 == var_1_10005.OP_SCORE_GEAR_GREAT then
...
function var_0_0.UpdateGear(arg_54_0, arg_54_1, arg_54_2)
	...
	if arg_54_2 then
		...
		var_54_2(var_54_1, var_5.OP_SCORE_GEAR_GREAT)
		...
		var_54_4(var_54_3, var_5.SOUND_PICK_ITEM)
	else
		...
		var_54_6(var_54_5, var_5.GEAR_SOUND[arg_54_1])
	end
...
function var_0_0.GearAnim(arg_56_0)
	...
	local var_56_3 = var_56_2(var_56_1, var_3.Action_float(function(arg_57_0)
	...
	var_56_4(var_56_3, var_3.Action(function()
...
function var_0_0.GenEffect(arg_59_0, arg_59_1)
	...
	var_59_0(var_59_1, arg_59_0.effectContainer)

	local var_59_2 = var_59_1.transform

	Vector3 = var_5
	var_59_2.localPosition = var_5(arg_59_0.slider.localPosition.x, arg_59_0.slider.localPosition.y, -100)
	Timer = var_59_2
...
function var_0_0.PlayPickAnim(arg_64_0, arg_64_1, arg_64_2)
	...
	local var_64_3 = var_64_2(var_64_1, var_6.Action_float(function(arg_65_0)
	...
	var_64_4(var_64_3, var_6.Action(function()
		local var_66_0 = arg_64_0.pickPool
		local var_66_1 = var_0.Dequeue(var_66_0)

		SetParent = var_66_0

		var_66_0(var_66_1, arg_64_0.effectContainer)

		local var_66_2 = var_66_1.transform

		Vector3 = var_2
		var_66_2.localPosition = var_2(arg_64_1._tf.localPosition.x, arg_64_1._tf.localPosition.y, -100)
		Timer = var_66_2
...
function var_0_0.UpdateTimeText(arg_68_0, arg_68_1)
	...
	if var_1_10002.ceil(arg_68_1) <= 0 then
		...
		math = var_1_10004
		var_68_0.text = var_1_10004.max(0, var_2)
	end
...
function var_0_0.GetScore(arg_72_0, arg_72_1, arg_72_2)
	...
	ipairs = var_1_10006
	ValentineQteGameConst = var_1_10007

	for iter_72_0, iter_72_1 in var_1_10006(var_1_10007.COMBO_EXTRA_SCORE_RATIO) do
