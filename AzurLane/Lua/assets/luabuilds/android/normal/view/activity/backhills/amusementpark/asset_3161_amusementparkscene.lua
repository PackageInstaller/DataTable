...
function var_0_1.init(arg_1_0)
	...
	local var_1_5 = arg_1_0._map

	arg_1_0._shipTpl = var_1.Find(var_1_5, "ship")
	arg_1_0.containers = {
		arg_1_0.map_middle,
		arg_1_0.map_top
	}
	...
	import = var_2
	arg_1_0.graphPath = var_1_6(var_2("GameCfg.BackHillGraphs.AmusementParkGraph"))

	local var_1_7 = arg_1_0._tf

	arg_1_0._upper = var_1.Find(var_1_7, "upper")

	for iter_1_1 = 0, arg_1_0._upper.childCount - 1 do
		local var_1_8 = arg_1_0._upper
		local var_1_9 = var_5.GetChild(var_1_8, iter_1_1)

		go = var_1_8

		local var_1_10 = var_1_8(var_1_9).name

		arg_1_0["upper_" .. var_1_10] = var_1_9
	end

	local var_1_11 = arg_1_0.top
	local var_1_12 = var_1.Find(var_1_11, "GameCount/text")
	local var_1_13 = var_1.GetComponent

	typeof = var_3
	Text = iter_1_1
	arg_1_0.gameCountTxt = var_1_13(var_1_12, var_3(iter_1_1))

	local var_1_14 = arg_1_0.top
	local var_1_15 = var_1.Find(var_1_14, "MaterialCount/text")
	local var_1_16 = var_1.GetComponent

	typeof = var_3
	Text = iter_1_1
	arg_1_0.materialTxt = var_1_16(var_1_15, var_3(iter_1_1))
	setActive = var_1

	local var_1_17 = arg_1_0.map_huiyichengbao

	PLATFORM_CODE = var_3
	PLATFORM_CH = iter_1_1

	var_1(var_1_17, var_3 == iter_1_1)

	setActive = var_1

	local var_1_18 = arg_1_0.upper_huiyichengbao

	PLATFORM_CODE = var_3
	PLATFORM_CH = iter_1_1

	var_1(var_1_18, var_3 == iter_1_1)
...
function var_0_1.didEnter(arg_7_0)
	...
	var_1_10001(var_7_0, var_3.Find(var_7_1, "Back"), function()
	...
	var_1_10001(var_7_2, var_3.Find(var_7_3, "Home"), function()
	...
	var_1_10001(var_7_4, var_3.Find(var_7_5, "Help"), function()
		pg = var_2_10000
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.amusementpark_help.tip
	...
	var_1_10001(var_7_6, var_3.Find(var_7_7, "Invitation"), function()
		...
		if var_11_1(var_11_0, var_2_10002.ACTIVITY_TYPE_CLIENT_DISPLAY) and not var_0:isEnd() then
			local var_11_2 = arg_7_0
			local var_11_3 = var_1.emit

			BackHillMediatorTemplate = var_2_10003

			local var_11_4 = var_2_10003.GO_SCENE

			SCENE = var_2_10004

			var_11_3(var_11_2, var_11_4, var_2_10004.ACTIVITY, {
				id = var_0.id
			})
		end
	...
	arg_7_0:InitFacilityCross(arg_7_0._map, arg_7_0._upper, "jiujiuduihuanwu", function()
		...
		AmusementParkMediator = var_2_10002
		...
		AmusementParkShopMediator = var_2_10005
		var_12_4.mediator = var_2_10005
		AmusementParkShopPage = var_2_10005
	...
	arg_7_0:InitFacilityCross(arg_7_0._map, arg_7_0._upper, "dangaobaoweizhan", function()
		...
		var_14_1(var_14_0, var_2_10002.GO_MINI_GAME, 23)
	...
	arg_7_0:InitFacilityCross(arg_7_0._map, arg_7_0._upper, "huiyichengbao", function()
		...
		var_15_1(var_15_0, var_15_2, var_2_10003.SUMMARY)
	...
	arg_7_0.InitFacilityCross(var_7_8, arg_7_0._map, arg_7_0._upper, "huanzhuangshandian", function()
		...
		var_17_1(var_17_0, var_17_2, var_2_10003.SKINSHOP)
	...
	local var_7_11 = var_7_10(var_7_9, var_3.ACTIVITY_TYPE_MINIGAME)
...
function var_0_1.UpdateView(arg_20_0)
	...
	local var_20_7 = var_20_4(var_5)
	local var_20_8 = var_4.GetHubByHubId(var_20_7, var_20_6:getConfig("config_id")).count > 0

	arg_20_0.Respones.dangaobaoweizhanTip = var_20_8

	local var_20_9 = arg_20_0

	arg_20_0.UpdateHubData(var_20_9, var_5)

	local var_20_10 = arg_20_0.Respones

	AmusementParkShopPage = var_20_9
	var_20_10.jiujiuduihuanwuTip = var_20_9.GetActivityShopTip()
