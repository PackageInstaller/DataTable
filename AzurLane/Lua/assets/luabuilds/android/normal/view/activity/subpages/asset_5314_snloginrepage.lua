...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1.make(var_2_0, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventInit then
			var_2_10004 = arg_3_2
			var_3_0 = arg_3_2.Find(var_2_10004, "item")
			...
			local function var_3_4()
				...
				var_4_1(var_4_0, var_3_10002.ON_DROP, var_3_1)
			...
			var_6(var_3_2, var_3_3, var_3_4, var_2_10010)

			GetImageSpriteFromAtlasAsync = var_6

			var_6("ui/activityuipage/snloginrepage_atlas", "DAY" .. arg_3_1 + 1, arg_3_2:Find("day"), true)
		else
			UIItemList = var_3_0
