...
DROP_TYPE_SHIP = var_2
var_0_2[var_2] = function(arg_1_0, arg_1_1)
	pg = var_1_10002
...
var_0_2[var_2] = function(arg_2_0, arg_2_1)
	pg = var_1_10002
...
TASK_SUB_TYPE_COLLECT_SHIP = var_2
DROP_TYPE_SHIP = var_3
var_0_3[var_2] = var_3
TASK_SUB_TYPE_COLLECT_FURNITURE = var_2
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	arg_4_0.finalTasks = var_1_10001(var_2.getConfig(var_4_0, "config_client"))

	local var_4_1 = arg_4_0.finalTasks

	_ = var_2

	var_2.each(var_4_1, function(arg_5_0)
		pg = var_2_10001
		...
		if var_2_10001.task_data_template[arg_5_0] and var_1.target_id then
			...
			var_5_0(var_5_1, var_2_10005(var_2))
		end
	...
	var_2(var_4_3, var_4_2("bismarck_chapter_desc"))
...
function var_0_1.InitInteractable(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10002(arg_6_0.finalTasks) do
		...
		local function var_6_4()
			...
			if var_0.getTaskStatus(var_7_1) == 1 then
				...
				var_7_3(var_7_2, var_2_10003.ON_TASK_SUBMIT, var_0)
		...
		var_1_10009(var_6_2, var_6_3, var_6_4, var_1_10013)
	end
	...
	local function var_6_7()
		...
		var_8_1(var_8_0, var_2_10002.BATTLE_OPERA)
	...
	var_2(var_6_5, var_6_6, var_6_7, iter_6_1)
	...
	local function var_6_10()
		...
		if var_2_10000.shopLinkActID then
			...
			var_2_10001 = var_9_0(var_2_10001)

			local var_9_0 = var_9_0.getActivitiesById

			configClinet = var_2_10002

			if not var_9_0(var_2_10001, var_2_10002.shopLinkActID) then
				underscore = var_9_0
				...
				var_9_0 = var_9_0(var_2_10001(var_9_1, var_2_10003.ACTIVITY_TYPE_SHOP), function(arg_10_0)
			...
			local var_9_6 = var_2_10003.GO_SHOPS_LAYER
			local var_9_7 = {}

			NewShopsScene = var_2_10005
			var_9_7.warp = var_2_10005.TYPE_ACTIVITY
	...
	var_2(var_6_8, var_6_9, var_6_10, iter_6_1)
	...
	local function var_6_13()
		...
		local var_11_3 = var_2_10003.GETBOAT
		local var_11_4 = {}

		BuildShipScene = var_2_10005
		var_11_4.projectName = var_2_10005.PROJECTS.ACTIVITY
	...
	var_2(var_6_11, var_6_12, var_6_13, iter_6_1)
...
function var_0_1.UpdateView(arg_14_0)
	...
	for iter_14_0 = 1, #arg_14_0.finalTasks do
		...
		local var_14_2 = var_14_0:getTaskVO(var_1_10006)
		local var_14_3 = var_10.getTaskStatus(var_14_2)

		setActive = var_14_2

		var_14_2(var_14_1:Find("active"), var_14_3 == 0)

		setActive = var_14_2

		var_14_2(var_14_1:Find("finished"), var_14_3 == 1)

		setActive = var_14_2

		var_14_2(var_14_1:Find("achieved"), var_14_3 == 2)

		setButtonEnabled = var_14_2

		var_14_2(var_14_1, var_14_3 < 2)

		arg_14_0.tabType = arg_14_0.tabType == iter_14_0 and var_14_3 == 2 and 0 or arg_14_0.tabType
	end
...
function var_0_1.UpdateTab(arg_15_0)
	...
	for iter_15_0 = 1, var_15_0 do
		...
		local var_15_7 = var_15_5.Find(var_15_6, "title/Text")

		string = var_15_6

		var_15_4(var_15_7, var_15_6.format("Task-%02d", iter_15_0))

		local var_15_8 = var_1[iter_15_0]

		pg = var_15_7

		local var_15_9 = var_15_7.task_data_template[var_15_8]

		tonumber = var_12

		local var_15_10 = var_12(var_15_9.target_id)
		local var_15_11 = var_0_1.TransformType[var_15_9.sub_type]

		setActive = var_14

		local var_15_12 = var_15_5
		local var_15_13 = var_15_5.Find(var_15_12, "tip2")

		DROP_TYPE_FURNITURE = var_15_12

		var_14(var_15_13, var_15_11 == var_15_12)

		setActive = var_14

		local var_15_14 = var_15_5
		local var_15_15 = var_15_5.Find(var_15_14, "tip")

		DROP_TYPE_SHIP = var_15_14

		var_14(var_15_15, var_15_11 == var_15_14)

		local var_15_16 = false
		local var_15_17 = var_15_2
		local var_15_18

		if not var_15_2.getTaskById(var_15_17, var_15_8) then
			var_15_17 = var_15_2
			var_15_18 = var_15_2.getFinishTaskById(var_15_17, var_15_8)
		end

		setActive = var_15_17

		local var_15_19 = var_15_5
		local var_15_20 = var_15_5.Find(var_15_19, "completed")

		defaultValue = var_15_19

		var_15_17(var_15_20, var_15_19(var_15_18 and var_15_18:isFinish(), false))

		setText = var_15_17

		var_15_17(var_15_5:Find("text"), var_15_9.desc)
		arg_15_0:UpdateIcon(var_15_5:Find("icon"), var_15_11, var_15_10)

		var_15_3 = var_15_3 + (var_15_18 and var_15_18:isFinish() and 1 or 0)
	end

	setText = var_5

	local var_15_21 = arg_15_0.tab
	local var_15_22 = var_6.Find(var_15_21, "slider/progress")

	string = var_15_21

	var_5(var_15_22, var_15_21.format("[%d/%d]", var_15_3, var_15_0))

	local var_15_23 = arg_15_0.scrollList
	local var_15_24 = var_5.GetComponent

	typeof = var_7
	ScrollRect = var_8
	var_15_24(var_15_23, var_7(var_8)).verticalNormalizedPosition = 1

	local var_15_25 = arg_15_0.tab.transform.anchoredPosition
	local var_15_26 = arg_15_0.tab.sizeDelta

	var_15_25.x = var_0_1.tabPos[arg_15_0.tabType]
	setAnchoredPosition = var_7

	var_7(arg_15_0.tab, var_15_25)

	local var_15_27

	var_15_27.x, var_15_27 = arg_15_0._tf.sizeDelta.x - arg_15_0.bar.anchoredPosition.x - var_15_25.x - var_15_26.x, arg_15_0.bar.sizeDelta

	local var_15_28 = arg_15_0.bar

	var_15_28.sizeDelta = var_15_27
	setActive = var_15_28

	var_15_28(arg_15_0.tab, true)
	...
	for iter_18_0, iter_18_1 in var_1_10002(arg_18_0.subtasks) do
		...
		for iter_18_2, iter_18_3 in var_1_10007(iter_18_1) do
			if var_18_0:getTaskById(iter_18_3) and var_12:isFinish() then
				...
				ActivityMediator = var_1_10015

				var_18_2(var_18_1, var_1_10015.ON_TASK_SUBMIT, var_12)
			end
		end
	end
