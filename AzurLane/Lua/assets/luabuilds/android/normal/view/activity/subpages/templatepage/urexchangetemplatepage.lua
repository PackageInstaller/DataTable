...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.shopProxy = var_1_10001(var_1_10002)
	getProxy = var_1
	PlayerProxy = var_1_10002
	arg_1_0.playerProxy = var_1(var_1_10002)
	getProxy = var_1
	TaskProxy = var_1_10002
	arg_1_0.taskProxy = var_1(var_1_10002)
	getProxy = var_1
	ShopsProxy = var_1_10002
	arg_1_0.shopProxy = var_1(var_1_10002)
	...
	arg_2_0.taskTypeDic = {
		[var_0_1.SP_FIRST] = function(arg_3_0, arg_3_1)
			...
			local function var_3_1()
				...
				local var_4_3 = var_3_10003.TASK
				local var_4_4 = {}

				TaskScene = var_3_10005
				var_4_4.page = var_3_10005.PAGE_TYPE_ACT
		...
		[var_0_1.SP_DAILY] = function(arg_5_0, arg_5_1)
			...
			local function var_5_2()
				...
				if var_0.isUnlock(var_6_0) then
					...
					ActivityMediator = var_3_10002
					var_3_10002 = var_3_10002.EVENT_GO_SCENE
					SCENE = var_3_10003

					local var_6_3 = var_3_10003.LEVEL
					local var_6_4 = {}

					pg = var_3_10005
					var_6_4.mapIdx = var_3_10005.chapter_template[arg_5_1[1]].map

					var_6_2(var_6_1, var_3_10002, var_6_3, var_6_4)
				else
					...
					var_6_6(var_6_5, var_3_10002.SPECIAL_BATTLE_OPERA)
				end
		...
		[var_0_1.RANDOM_DAILY] = function(arg_7_0, arg_7_1)
			...
			local function var_7_1()
				...
				local var_8_3 = var_3_10003.TASK
				local var_8_4 = {}

				TaskScene = var_3_10005
				var_8_4.page = var_3_10005.PAGE_TYPE_ACT
		...
		[var_0_1.CHALLANGE] = function(arg_9_0, arg_9_1)
			...
			local function var_9_3()
				...
				local var_10_2 = var_3_10002.EVENT_GO_SCENE

				SCENE = var_3_10003

				local var_10_3 = var_3_10003.TASK
				local var_10_4 = {}

				TaskScene = var_3_10005
				var_10_4.page = var_3_10005.PAGE_TYPE_ACT
		...
		[var_0_1.MINI_GAME] = function(arg_11_0, arg_11_1)
			...
			local var_11_1 = var_2_10003(var_2_10004)
			...
			local function var_11_3()
				...
				var_12_1(var_12_0, var_3_10002.GO_MINI_GAME, var_11_0)
		...
		[var_0_1.SHOP_BUY] = function(arg_13_0, arg_13_1)
			local function var_13_0()
				...
				local var_14_2 = var_3_10002.GO_SHOPS_LAYER
				local var_14_3 = {}

				NewShopsScene = var_3_10004
				var_14_3.warp = var_3_10004.TYPE_ACTIVITY
			...
			local var_13_2 = arg_13_0.GetGoodsResCnt(var_13_1, arg_13_1[1])

			pg = var_13_1

			local var_13_3 = var_13_1.activity_shop_template[arg_13_1[1]].num_limit
			local var_13_4 = var_13_2 == 0

			return var_13_3 - var_13_2 .. "/" .. var_13_3, not var_13_4 and var_13_0 or nil
		end
	}
...
function var_0_1.OnFirstFlush(arg_16_0)
	...
	var_1_10001(var_16_0, var_1_10003("UrExchange_Pt_NotEnough"))
	...
	var_16_2 = var_1.getActivityById(var_16_1, arg_16_0.config.activitytime) and not var_1:isEnd()
	arg_16_0.isLinkActOpen = var_16_2
	setActive = var_16_2

	var_16_2(arg_16_0._tasksTF, arg_16_0.isLinkActOpen)

	local var_16_3 = arg_16_0.uilist

	var_2.make(var_16_3, function(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_16_5 = arg_16_0._btnSimulate
	...
	local function var_16_6()
		...
		if arg_16_0.config.expedition == 0 then
			...
			var_18_1(var_18_0, var_2_10002("tech_simulate_closed"))
		else
			i18n = var_18_1
			...
			local var_18_3 = var_1.MsgboxMgr.GetInstance()
			...
			var_1.ShowMsgBox(var_18_3, {
				...
				onYes = function()
					...
					local var_19_2 = var_3_10002.ON_SIMULATION_COMBAT
					local var_19_3 = {
					...
					var_19_1(var_19_0, var_19_2, var_19_3, var_19_4, var_3_10005)
	...
	var_2(var_16_4, var_16_5, var_16_6, var_1_10006)

	onButton = var_2

	local var_16_7 = arg_16_0
	local var_16_8 = arg_16_0._btnExchange
	...
	local function var_16_9()
		...
		if arg_16_0.canExchange then
			...
			var_21_2.type = var_2_10003
			Drop = var_2_10003
			var_21_2.drop = var_2_10003.Create({
			...
			function var_21_2.onYes()
				...
				var_22_1(var_22_0, var_3_10002.ON_ACT_SHOPPING, arg_16_0.shopId, 1, arg_16_0.curGoods.id, 1)
			...
			local var_21_4 = var_1.delayedCall
			local var_21_5 = 1

			System = var_2_10003
			var_21_3.leantween = var_21_4(var_21_5, var_2_10003.Action(function()
	...
	var_2(var_16_7, var_16_8, var_16_9, var_1_10006)

	onButton = var_2

	local var_16_10 = arg_16_0
	local var_16_11 = arg_16_0._btnHelp
	...
	local function var_16_12()
		...
		i18n = var_2_10003
		var_24_2.helps = var_2_10003("UrExchange_Pt_help")
	...
	var_2(var_16_10, var_16_11, var_16_12, var_1_10006)
...
function var_0_1.UpdatePtCount(arg_32_0)
	...
	if arg_32_0.exchangeState < arg_32_0.length and arg_32_0.ptCount < arg_32_0.curGoods.resource_num then
		...
		local var_32_1 = arg_32_0.ptCount

		COLOR_RED = var_1_10005

		local var_32_2

		if not var_3(var_32_1, var_1_10005) then
			var_32_2 = arg_32_0.ptCount
		end

		var_1_10001(var_32_0, var_32_2)

		setText = var_1_10001

		local var_32_3 = arg_32_0._resText
		local var_32_4 = "/"
		local var_32_5 = arg_32_0.exchangeState == 3 and "--" or arg_32_0.curGoods.resource_num

		i18n = var_1_10005

		var_1_10001(var_32_3, var_32_4 .. var_32_5 .. var_1_10005("UrExchange_Pt_charges", arg_32_0.restExchange))
