...
function var_0_1.Init(arg_2_0)
	...
	arg_2_0.candicatesRect = var_1(var_2.Find(var_2_1, "Frame/List"), "LScrollRect")
...
function var_0_1.InitCustom(arg_4_0)
	...
	local var_4_3 = var_4_1.Find(var_4_2, "IconBG/Lack/Text")

	i18n = var_4_2

	var_4_0(var_4_3, var_4_2("ryza_ui_show_acess"))
...
function var_0_1.UpdateCandicateItem(arg_9_0, arg_9_1, arg_9_2)
	...
	var_6(var_9_4, var_9_5, var_9_6, var_1_10010)
...
function var_0_1.ShowCandicatePanel(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_2 = var_11_0(var_6(arg_11_1))
	...
	var_6(var_11_3, var_1_10008(var_1_10009), false)

	removeAllChildren = var_6

	local var_11_4 = arg_11_0._tf

	var_6(var_7.Find(var_11_4, "Target"))
	...
	var_10(var_11_12, var_12(var_1_10013), false)
...
function var_0_1.HideCandicatePanel(arg_14_0)
	...
	var_1(var_2.Find(var_14_2, "Target"))
	...
	var_1(var_14_3, var_14_2(var_4), true)
...
function var_0_1.UpdateCandicatePanel(arg_15_0, arg_15_1)
	...
	local var_15_5 = var_15_4(var_1_10005.activity_ryza_item.all, function(arg_16_0)
		local var_16_0
	...
	var_5.sort(var_15_5, function(arg_18_0, arg_18_1)
	...
	var_5.each(var_15_5, function(arg_19_0)
		...
		for iter_19_0 = var_19_0, var_2_10002.max(arg_19_0.count, 1) do
			...
			var_2_10005.insert(arg_15_0.candicates, arg_19_0)
		end
...
function var_0_1.HideNodeLinks(arg_21_0, arg_21_1)
	for iter_21_0 = 1, 6 do
		...
		var_1_10006(var_7.GetChild(var_21_0, iter_21_0 - 1), false)
	end
...
function var_0_1.PlayBgAnimation(arg_22_0)
	...
	Quaternion = var_22_0
	var_22_1.localRotation = var_22_0.identity

	local var_22_2 = arg_22_0.nodeTarget.Data
	local var_22_3 = var_2.GetType(var_22_2)

	AtelierFormulaCircle = var_22_2

	local var_22_4 = var_22_3 == var_22_2.TYPE.BASE and 300 or 245
	...
	local var_22_6 = var_3(var_22_5, var_5(var_1_10006))
...
function var_0_1.StopBgAnimation(arg_23_0, arg_23_1)
	...
	local var_23_2 = var_3.Find(var_23_1, "TargetBG")

	typeof = var_23_1
	DftAniEvent = var_5

	local var_23_3 = var_2(var_23_2, var_23_1(var_5))
	...
	local var_23_5 = var_4.Find(var_23_4, "TargetBG")

	typeof = var_23_4
	Animator = var_6

	local var_23_6 = var_3(var_23_5, var_23_4(var_6))
