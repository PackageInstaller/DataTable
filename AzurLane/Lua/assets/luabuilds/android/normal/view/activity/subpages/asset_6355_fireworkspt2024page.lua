...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".FireworksPtPage"))
...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local function var_1_2()
		...
		var_2_1(var_2_0, var_2_2, var_2_10003.SPRING_FESTIVAL_BACKHILL_2024, {
...
function var_0_1.UpdateFrieworkPanel(arg_3_0, arg_3_1)
	...
	if arg_3_0.fireworkAct then
		...
		var_3_2 = not var_3.isEnd(var_3_1)
	end
	...
	for iter_3_0, iter_3_1 in var_3_4(arg_3_0.fireworkPages) do
		setActive = var_1_10008

		local var_3_5 = iter_3_1

		tonumber = var_1_10010
		var_1_10010 = var_1_10010(iter_3_1.name) == arg_3_1

		var_1_10008(var_3_5, var_1_10010)
	end
	...
	for iter_3_2, iter_3_3 in var_3(arg_3_0.dots) do
		...
		local var_3_6 = iter_3_3

		tonumber = var_1_10010
		var_1_10010 = var_1_10010(iter_3_3.name) == arg_3_1

		var_1_10008(var_3_6, var_1_10010)
	end
	...
	local var_3_7 = var_3(var_4)
	local var_3_8 = var_3.getRawData(var_3_7)

	arg_3_0.ptNum = var_3.getResource(var_3_8, arg_3_0.ptID)
	setText = var_4

	var_4(arg_3_0.ptText, arg_3_0.ptNum)

	local var_3_9 = arg_3_0:getAnimId()
	local var_3_10 = arg_3_0.unlockCount > 0 and arg_3_0.ptNum >= arg_3_0.ptConsume
	...
	for iter_3_4 = #arg_3_0.fireworkPages, 1, -1 do
		...
		var_1_10010(arg_3_0.fireworkPages[iter_3_4], function(arg_4_0)
			...
			if var_2.contains(arg_3_0.unlockIds, var_4_0) then
				setActive = var_2
				...
				if var_3_10 and var_3_9 and var_4_0 == var_3_9 then
				...
				var_2(var_4_3, var_4_4, var_4_5, var_2_10006)
			end
...
function var_0_1.playSwingAnim(arg_7_0, arg_7_1)
	...
	local var_7_2 = var_7_1(var_7_0, var_4(var_1_10005))
...
function var_0_1.stopSwingAnim(arg_8_0, arg_8_1)
	...
	local var_8_2 = var_8_1(var_8_0, var_4(var_1_10005))
