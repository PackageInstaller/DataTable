...
function var_0_0.initUI(arg_4_0)
	...
	arg_4_0.commonAnim = var_4_1(var_4_0, var_3(var_1_10004))
	findTF = var_1
	...
	local var_4_5 = var_4_3.GetInstance()
	...
	var_3.GetSpineChar(var_4_5, var_4_4, true, function(arg_5_0)
		...
		var_5_3.anim = var_5_5(var_5_4, var_4(var_2_10005))
...
function var_0_0.initEvent(arg_6_0)
	...
	local function var_6_5()
		...
		pg = var_2_10003
		var_9_2.helps = var_2_10003.gametip.help_monopoly_3th.tip
	...
	local function var_6_8()
		...
		if var_10_0(var_2_10001(arg_6_0.cellPos)) then
			LeanTween = var_0
			...
			var_10_1(var_1(arg_6_0.cellPos))
		end
	...
	local function var_6_11()
		if arg_6_0.leftAwardCnt > 0 then
			...
			Monopoly3thPage = var_2_10002

			var_12_1(var_12_0, var_2_10002.ON_AWARD)
		end
...
function var_0_0.checkPlayerRandomMove(arg_13_0)
	...
	if var_1.random() > 0.5 then
		...
		local var_13_7 = var_13_6(var_13_5, var_7.linear)
		local var_13_8 = var_5.setOnUpdate

		System = var_7

		local var_13_9 = var_13_8(var_13_7, var_7.Action_float(function(arg_14_0)
		...
		var_13_10(var_13_9, var_7.Action(function()
...
function var_0_0.checkCountStory(arg_17_0, arg_17_1)
	...
	if var_17_1.detect(var_17_2, function(arg_18_0)
		return arg_18_0[1] == var_17_0
	end) then
		pg = var_6

		local var_17_3 = var_6.NewStoryMgr.GetInstance()
...
function var_0_0.changeAnimeState(arg_19_0, arg_19_1)
	if arg_19_1 then
		...
		typeof = var_1_10004
		Image = var_1_10005
		var_1_10002 = var_1_10002(var_19_0, var_1_10004(var_1_10005))
		...
		var_1_10002(var_19_1, var_1_10004.LOCK_ACT_MAIN, true)
	else
		...
		typeof = var_1_10004
		Image = var_1_10005
		var_1_10002 = var_1_10002(var_19_2, var_1_10004(var_1_10005))
		...
		var_1_10002(var_19_3, var_4.LOCK_ACT_MAIN, false)
	end
...
function var_0_0.checkLastBonus(arg_25_0)
	if (not arg_25_0.lastBonusFlag or arg_25_0.lastBonusFlag == 0) and arg_25_0.useCount then
		local var_25_0 = arg_25_0.useCount

		if arg_25_0.lastBonusTimes <= var_25_0 then
			var_1_10002 = arg_25_0._event

			local var_25_1 = var_1.emit

			Monopoly3thPage = var_1_10003

			var_25_1(var_1_10002, var_1_10003.MONOPOLY_OP_LAST, arg_25_0.activity.id, function(arg_26_0)
				...
				var_26_0(var_2(arg_25_0.labelDropShip, "get"), false)

				setActive = var_26_0
				findTF = var_2

				var_26_0(var_2(arg_25_0.labelDropShip, "got"), true)

				setActive = var_26_0
				findTF = var_2

				var_26_0(var_2(arg_25_0.labelDropShip, "text"), false)
	...
	if arg_25_0.lastBonusFlag == 1 then
		...
		var_1(var_1_10002(arg_25_0.labelDropShip, "get"), false)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_25_0.labelDropShip, "got"), true)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_25_0.labelDropShip, "text"), false)
	end
...
function var_0_0.activityDataUpdata(arg_27_0, arg_27_1)
	...
	local var_27_3 = var_1_10004.ceil((var_27_1 - var_27_2) / 0)
	...
	local var_27_6 = var_10.max
	local var_27_7 = 0

	math = var_1_10012
	arg_27_0.advanceRpCount = var_27_6(var_27_7, var_1_10012.min(var_9, arg_27_0.advanceTotalCnt) - var_27_5)
	math = var_10

	local var_27_8 = var_10.max(0, var_9 - arg_27_0.advanceTotalCnt)

	math = var_11
	arg_27_0.commonRpCount = var_27_8 - var_11.max(0, var_27_5 - arg_27_0.advanceTotalCnt)
...
function var_0_0.checkStep(arg_28_0, arg_28_1)
	if arg_28_0.step > 0 then
		...
		var_28_1(var_28_0, var_1_10004.ON_MOVE, arg_28_0.activity.id, function(arg_29_0, arg_29_1, arg_29_2)
...
function var_0_0.updataUI(arg_33_0)
	...
	local var_33_1 = var_2(arg_33_0.btnRp)
	local var_33_2 = 1

	System = var_4

	var_33_0(var_33_1, var_33_2, var_4.Action(function()
...
function var_0_0.checkEffect(arg_36_0, arg_36_1)
	if arg_36_0.effectId > 0 then
		...
		local var_36_2 = arg_36_0.getActionName(var_36_1, arg_36_0.pos)
		...
		var_36_1({
			function(arg_37_0)
				if var_36_2 then
					...
					var_1.changeCharAction(var_37_0, var_36_2, 1, function()
...
function var_0_0.triggerEfect(arg_42_0, arg_42_1)
	...
	var_42_1(var_42_0, var_1_10004.ON_TRIGGER, arg_42_0.activity.id, function(arg_43_0, arg_43_1)
...
function var_0_0.moveCharWithPaths(arg_46_0, arg_46_1, arg_46_2, arg_46_3)
	...
	var_1_10005.insert(var_46_0, function(arg_47_0)
		...
		local var_47_7 = var_6.isTweening

		go = var_7

		local var_47_8

		if var_47_7(var_7(arg_46_0.cellPos)) then
			LeanTween = var_47_8
			var_47_8 = var_47_8.cancel
			go = var_7

			var_47_8(var_7(arg_46_0.cellPos))
		end
		...
		local var_47_10 = var_47_9(var_7(arg_46_0.cellPos), 0, var_47_1, var_47_0)
		local var_47_11 = var_6.setEase

		LeanTweenType = var_8

		local var_47_12 = var_47_11(var_47_10, var_8.linear)
		local var_47_13 = var_6.setOnUpdate

		System = var_8

		local var_47_14 = var_47_13(var_47_12, var_8.Action_float(function(arg_48_0)
		...
		var_47_15(var_47_14, var_8.Action(function()
			arg_47_0()
...
function var_0_0.createCell(arg_51_0, arg_51_1)
	...
	local var_51_2 = var_1_10004(var_1_10005(var_1_10006(arg_51_0.tplCell)))

	Vector3 = var_5
	var_51_2.localPosition = var_5(arg_51_1, 0, 0)
	...
	local var_51_6 = var_51_5(var_51_4, var_8(var_1_10009))
	...
	local var_51_9 = var_51_8(var_51_7, var_8(var_1_10009))
...
function var_0_0.updateMap(arg_52_0, arg_52_1)
	...
	for iter_52_3 = 1, #arg_52_0.groundChildsList do
		for iter_52_4 = #arg_52_0.groundChildsList[iter_52_3], 1, -1 do
			if var_6[iter_52_4].anchoredPosition.x <= -var_11.sizeDelta.x and #var_6 > 1 then
				table = var_12

				local var_52_3 = var_12.remove(var_6, iter_52_4)

				Vector3 = var_13
				var_52_3.anchoredPosition = var_13(var_6[#var_6].anchoredPosition.x + var_6[#var_6].sizeDelta.x, var_11.anchoredPosition.y, var_11.anchoredPosition.z)
				table = var_13

				var_13.insert(var_6, var_52_3)
			end
		end
	end
...
function var_0_0.dispose(arg_56_0)
	if arg_56_0.model then
		PoolMgr = var_1
		var_1_10002 = var_1.GetInstance()

		var_1.ReturnSpineChar(var_1_10002, var_0_1, arg_56_0.model)
	end

	if arg_56_0.randomMoveTiemr then
		if arg_56_0.randomMoveTiemr.running then
			var_1_10002 = arg_56_0.randomMoveTiemr
	...
	if var_56_0(var_1_10002(arg_56_0.btnRp)) then
		LeanTween = var_56_1
		var_56_1 = var_56_1.cancel
		go = var_2

		var_56_1(var_2(arg_56_0.btnRp))
	end
	...
	if var_56_2(var_2(arg_56_0.cellPos)) then
		LeanTween = var_1
		...
		var_56_3(var_2(arg_56_0.cellPos))
	end
