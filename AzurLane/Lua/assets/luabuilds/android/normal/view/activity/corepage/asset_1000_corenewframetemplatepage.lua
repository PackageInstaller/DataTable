...
local var_0_0 = "CoreNewFrameTemplatePage"
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	if not var_3_10(var_2.Find(var_3_11, "Text")) then
		setText = var_1

		local var_3_12 = arg_3_0.gotTag
		local var_3_13 = var_2.Find(var_3_12, "Text")

		i18n = var_3_12

		var_1(var_3_13, var_3_12("avatarframe_got"))
	end
...
function var_0_1.Switch(arg_8_0, arg_8_1)
	...
	local var_8_4 = var_8_2(var_8_3, var_1_10006(var_1_10007))
	...
	local var_8_8 = var_8_7(var_8(var_8_0), var_8_6, 0.4)
	local var_8_9 = var_7.setOnComplete

	System = var_9

	var_8_9(var_8_8, var_9.Action(function()
		setActive = var_2_10000

		local var_9_0 = var_8_0

		var_2_10000(var_1.Find(var_9_0, "label"), true)
	...
	var_8_12(var_8_11, var_9.Action_float(function(arg_10_0)
	...
	local var_8_14 = var_8_12(var_8_13, var_9(var_10))

	LeanTween = var_8_13

	local var_8_15 = var_8_13.value

	go = var_9

	local var_8_16 = var_8_15(var_9(var_8_1), 0, 1, 0.4)
	local var_8_17 = var_8.setOnUpdate

	System = var_10

	var_8_17(var_8_16, var_10.Action_float(function(arg_11_0)
	...
	local var_8_19 = var_8_18(var_9(var_8_1), var_8_5, 0.4)
	local var_8_20 = var_8.setOnComplete

	System = var_10

	var_8_20(var_8_19, var_10.Action(function()
