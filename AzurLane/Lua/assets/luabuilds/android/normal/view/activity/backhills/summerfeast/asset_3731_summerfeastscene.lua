...
function var_0_1.GetTheDay()
	...
	return var_1.date("*t", var_3_0).yday
end
...
function var_0_1.TransformColor(arg_4_0)
	...
	local var_4_0 = var_1_10001(var_1_10002.sub(arg_4_0, 1, 2), 16)

	tonumber = var_2
	string = var_3

	local var_4_1 = var_2(var_3.sub(arg_4_0, 3, 4), 16)

	tonumber = var_3
	string = var_4

	local var_4_2 = var_3(var_4.sub(arg_4_0, 5, 6), 16)
	local var_4_3 = 255
	...
	if var_5.len(arg_4_0) > 6 then
		...
		if var_5.len(arg_4_0) <= 8 then
			tonumber = var_5
			string = var_6
			var_4_3 = var_5(var_6.sub(arg_4_0, 7, 8), 16)
		end
	end
...
function var_0_1.GenerateRandomFanPosition(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5, arg_5_6)
	...
	for iter_5_0 = 1, arg_5_6 do
		...
		math = var_1_10014
		var_1_10014 = var_1_10014.lerp
		var_1_10015 = arg_5_4

		local var_5_2 = arg_5_5

		math = var_1_10017

		var_1_10012(var_5_1, var_1_10014(var_1_10015, var_5_2, var_1_10017.random(1, 100) / 100))
	end
	...
	var_5_10(var_5_11, var_1_10017.New(arg_5_1.x + var_5_0[1] * var_5_8, arg_5_1.y + var_5_0[1] * var_5_9))
	...
	for iter_5_1 = 2, arg_5_6 do
		...
		var_5_14(var_5_15, var_1_10023.New(arg_5_1.x + var_5_0[iter_5_1] * var_5_8, arg_5_1.y + var_5_0[iter_5_1] * var_5_9))
	end
...
function var_0_1.didEnter(arg_8_0)
	...
	var_1_10002(arg_8_0, arg_8_0._helpBtn, function()
		...
		pg = var_2_10003
		var_11_2.helps = var_2_10003.gametip.help_summer_feast.tip
	...
	var_1_10002(arg_8_0, arg_8_0.btn_shouce_help, function()
		...
		pg = var_2_10003
		var_14_2.helps = var_2_10003.gametip.help_summer_stamp.tip
	...
	var_1_10002(arg_8_0, arg_8_0.btn_receive, function()
		...
		if var_0.GetHubByHubId(var_15_0, arg_8_0.HUB_ID).ultimate == 0 then
			...
			if var_15_1 < var_0.getConfig(var_2_10003, "reward_need") then
				return
			end
			...
			SummerFeastMediator = var_2_10003

			local var_15_4 = var_2_10003.MINI_GAME_OPERATOR
			local var_15_5 = {
				hubid = var_0.id
			}

			MiniGameOPCommand = var_5
			var_15_5.cmd = var_5.CMD_ULTIMATE
			var_15_5.args1 = {}
	...
	arg_8_0:InitFacility(arg_8_0.shrine, function()
		...
		var_16_1(var_16_0, var_2_10002.GO_MINI_GAME, 3)
	...
	arg_8_0:InitFacility(arg_8_0.snack_street, function()
		...
		var_17_1(var_17_0, var_2_10002.GO_MINI_GAME, 2)
	...
	arg_8_0:InitFacility(arg_8_0.entertainment_street, function()
		...
		var_18_1(var_18_0, var_2_10002.GO_MINI_GAME, 5)
	...
	arg_8_0:InitFacility(arg_8_0.firework_factory, function()
		...
		var_19_1(var_19_0, var_2_10002.GO_MINI_GAME, 4)
...
function var_0_1.UpdateView(arg_21_0)
	...
	var_4(arg_21_0.ticketTimes, var_2.count)

	setText = var_4

	var_4(arg_21_0.yinhuaceTimes, var_21_1)

	ipairs = var_4

	for iter_21_0, iter_21_1 in var_4(arg_21_0.group_get) do
	...
	var_8(arg_21_0.btn_fire, var_21_5)
...
function var_0_1.PlayFirework(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in var_4(var_23_1) do
		pg = var_1_10009
...
function var_0_1.ClearEffectFirework(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_25_0(arg_25_0.workingEffect) do
		var_25_1:ReturnPrefab("ui/firework", "", iter_25_1)
	end

	var_25_1:DestroyPrefab("ui/firework", "")
...
function var_0_1.getStudents(arg_29_0)
	...
	if not var_29_2(var_29_1, var_1_10005.SUMMER_FEAST_ID) then
		return var_29_0
	end

	local var_29_3 = var_3
	local var_29_4

	if var_3.getConfig(var_29_3, "config_client") then
		var_29_4 = var_29_4.ships
	end
	...
	if var_29_4 then
		...
		while var_29_6 < 15 and 0 < var_29_7 do
			math = var_29_8

			local var_29_8 = var_29_8.random(1, var_29_7)

			table = var_8

			var_8.insert(var_29_0, var_29_5[var_29_8])

			var_29_5[var_29_8] = var_29_5[var_29_7]
			var_29_7 = var_29_7 - 1
			math = var_8
			var_29_6 = var_29_6 + var_8.random(3, 5)
		end
	end
...
function var_0_1.updateStudents(arg_31_0)
	...
	local var_31_1 = arg_31_0.getStudents(var_31_0)

	pairs = var_31_0

	for iter_31_0, iter_31_1 in var_31_0(var_31_1) do
		if not arg_31_0.academyStudents[iter_31_0] then
			cloneTplTo = var_7

			local var_31_2 = var_7(arg_31_0._shipTpl, arg_31_0._map).gameObject

			var_31_2.name = iter_31_0
			SummerFeastNavigationAgent = var_31_2

			local var_31_3 = var_31_2.New(var_7.gameObject)

			var_8.attach(var_31_3)
			...
			var_8:SetOnTransEdge(function(arg_32_0, arg_32_1, arg_32_2)
				...
				math = var_4
				arg_32_2 = var_4.max(arg_32_1, arg_32_2)
				arg_32_1 = var_32_0
	...
	if #var_31_1 > 0 then
		...
		local var_31_4 = arg_31_0.sortTimer

		var_2.Start(var_31_4)
	...
	for iter_34_0, iter_34_1 in var_2(var_34_0) do
		if iter_34_1.childCount > 1 then
			...
			for iter_34_2 = 1, iter_34_1.childCount do
				...
				local var_34_3 = iter_34_1.GetChild(var_34_2, iter_34_2 - 1)

				table = var_34_2

				var_34_2.insert(var_34_1, {
					tf = var_34_3,
					index = iter_34_2
				})
			end
			...
			for iter_34_3, iter_34_4 in var_8(var_34_1) do
				local var_34_4 = iter_34_4.tf

				var_13.SetSiblingIndex(var_34_4, iter_34_3 - 1)
			end
		end
	end
