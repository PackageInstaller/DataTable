...
local var_0_0 = "SkinMagazinePage4"
...
function var_0_1.RefreshData(arg_3_0)
	...
	local var_3_3 = var_3_1(var_3_0, var_4.getStartTime(var_3_2), var_1:GetServerTime()) + 1
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	for iter_4_1 = 1, arg_4_0.items.childCount do
		...
		local var_4_6 = var_4_5(var_4_4, var_1_10008(var_1_10009))
		local var_4_7
		...
		local var_4_8 = var_5.Find(var_1_10008, "window/Image")

		var_1_10008 = iter_4_1 == arg_4_0.index and 0 or 1

		var_4_6(var_4_8, var_1_10008)

		setImageAlpha = var_4_6
		var_1_10008 = var_5

		var_4_6(var_5.Find(var_1_10008, "window/main"), 1)
		...
		var_4_6(var_4_9, var_1_10008, var_1_10009, var_1_10010)
	end

	local var_4_10 = arg_4_0.taskProxy
	local var_4_11 = var_1.getTaskVO(var_4_10, arg_4_0.taskList[arg_4_0.index])
	local var_4_12 = {}

	unpack = var_3

	local var_4_13, var_4_14, var_4_15 = var_3(var_4_11:getConfig("award_display")[1])

	var_4_12.count = var_4_15
	var_4_12.id = var_4_14
	var_4_12.type = var_4_13
	updateDrop = var_4_13

	var_4_13(arg_4_0.rtAward, var_4_12)

	onButton = var_4_13

	local var_4_16 = arg_4_0
	local var_4_17 = arg_4_0.rtAward
	local var_4_18 = var_5.Find(var_4_17, "get")
	...
	local function var_4_19()
		...
		var_6_1(var_6_0, var_6_2, var_3.getTaskVO(var_6_3, arg_4_0.taskList[arg_4_0.index]))
	...
	var_4_13(var_4_16, var_4_18, var_4_19, var_7)

	onButton = var_4_13

	var_4_13(arg_4_0, arg_4_0.rtAward, function()
		local var_7_0 = arg_4_0
		local var_7_1 = var_0.emit

		BaseUI = var_2_10002

		var_7_1(var_7_0, var_2_10002.ON_DROP, var_4_12)
	...
	local var_4_20 = arg_4_0.rtAward
	local var_4_21 = var_4.Find(var_4_20, "get/click/desc")

	i18n = var_4_20

	var_4_13(var_4_21, var_4_20(var_0_1.TIP_KEY))

	local var_4_22 = arg_4_0.activity

	if var_3.getConfig(var_4_22, "config_client").firstStory then
		pg = var_4_22

		local var_4_23 = var_4_22.NewStoryMgr.GetInstance()

		var_4.Play(var_4_23, var_3)
	end
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10003(arg_8_0.taskList) do
		...
		var_8_1[iter_8_1] = var_1_10008(var_9.getFinishTaskById(var_8_2, iter_8_1))
		...
		local var_8_4 = var_9.GetChild(var_8_3, iter_8_0 - 1)

		var_1_10008(var_9.Find(var_8_4, "window/got"), var_8_1[iter_8_1])
	end
	...
	var_4(var_5.Find(var_8_8, "got"), var_8_7)

	setActive = var_4

	local var_8_9 = arg_8_0.rtAward

	var_4(var_5.Find(var_8_9, "get"), arg_8_0.remainCnt > 0 and not var_8_7)
	...
	for iter_8_2, iter_8_3 in var_8_10(arg_8_0.taskList) do
		...
		if var_10.getFinishTaskById(var_8_12, iter_8_3) then
			...
			if var_8_12(var_8_11, {
				...
				local var_8_13 = var_11.NewStoryMgr.GetInstance()

				var_11.Play(var_8_13, var_8_11[iter_8_2][1])
			end
		end
	end
...
function var_0_1.SelectPage(arg_9_0, arg_9_1)
	...
	for iter_9_2 = 1, arg_9_0.items.childCount do
		...
		local var_9_4 = var_9_3(var_9_2, var_1_10009(var_1_10010))

		var_1_10009 = var_6

		local var_9_5 = var_6.Find(var_1_10009, "window/Image")

		var_1_10010 = var_6
		var_1_10009 = var_6.Find(var_1_10010, "window/main")
		...
		if var_1_10010 ~= var_9_6 then
			math = var_1_10012
			var_1_10012 = var_1_10012.abs(var_9_6 - var_1_10010) / 2000
			table = var_13

			local var_9_7 = var_13.insert
			local var_9_8 = arg_9_0.LTList

			LeanTween = var_1_10015
			var_1_10015 = var_1_10015.value
			go = var_1_10016
			var_1_10016 = var_1_10015(var_1_10016(var_6), var_1_10010, var_9_6, var_1_10012)
			var_1_10015 = var_1_10015.setEase
			LeanTweenType = var_17
			var_1_10016 = var_1_10015(var_1_10016, var_17.easeOutSine)
			var_1_10015 = var_1_10015.setOnUpdate
			System = var_17

			var_9_7(var_9_8, var_1_10015(var_1_10016, var_17.Action_float(function(arg_10_0)
			...
			local var_9_10 = arg_9_0.LTList

			LeanTween = var_1_10015
			var_1_10016 = var_1_10015.alpha(var_6:Find("window/Image"), iter_9_2 == arg_9_1 and 0 or 1, var_1_10012)
			var_1_10015 = var_1_10015.setEase
			LeanTweenType = var_17

			var_9_9(var_9_10, var_1_10015(var_1_10016, var_17.easeOutSine).uniqueId)
		end
	end

	local var_9_11 = arg_9_0.taskProxy
	local var_9_12 = var_2.getTaskVO(var_9_11, arg_9_0.taskList[arg_9_0.index])
	local var_9_13 = {}

	unpack = var_4

	local var_9_14, var_9_15, var_9_16 = var_4(var_9_12:getConfig("award_display")[1])

	var_9_13.count = var_9_16
	var_9_13.id = var_9_15
	var_9_13.type = var_9_14
	updateDrop = var_9_14

	var_9_14(arg_9_0.rtAward, var_9_13)

	local var_9_17 = var_9_12
	local var_9_18 = var_9_12.isReceive(var_9_17)

	setActive = var_9_17

	local var_9_19 = arg_9_0.rtAward

	var_9_17(var_6.Find(var_9_19, "got"), var_9_18)

	setActive = var_9_17

	local var_9_20 = arg_9_0.rtAward

	var_9_17(var_6.Find(var_9_20, "get"), arg_9_0.remainCnt > 0 and not var_9_18)

	setActive = var_9_17

	var_9_17(arg_9_0.rtTask, false)

	setActive = var_9_17

	var_9_17(arg_9_0.rtTask, true)
