...
function var_0_1.BindEvent(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10003.ON_TASK_SUBMIT, function(arg_3_0, arg_3_1)
	...
	var_2_3(var_2_2, var_3.ON_TASK_GO, function(arg_4_0, arg_4_1)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.MEMORYBOOK_UNLOCK_DONE then
		...
		if var_6_0 == var_4.ACTIVITY_SHOW_AWARDS then
			...
			var_4.PlayStory(var_6_4, function()
				...
				var_7_1(var_7_0, var_2_10002.ON_ACHIEVE, var_6_2.awards, var_6_2.callback)
			...
			if var_6_0 == var_4.SUBMIT_TASK_DONE then
				...
				var_6_6(var_6_5, var_1_10006.ON_ACHIEVE, var_6_2, function()
				...
				if var_6_0 == var_6_6.ACTIVITY_OPERATION_DONE then
