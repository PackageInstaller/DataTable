...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.START_ORDER, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_3.cmd = var_2_10008.CMD.START_ORDER
	...
	arg_1_0:bind(var_0_1.COMPLETE_ORDER, function(arg_3_0, arg_3_1, arg_3_2)
		...
		local var_3_2 = var_2_10005.ACTIVITY_MALL_OP
		local var_3_3 = {
			activity_id = arg_3_1
		}

		ActivityMallOPCommand = var_2_10007
		var_3_3.cmd = var_2_10007.CMD.COMPLETE_ORDER
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.ACTIVITY_MALL_OP_DONE then
		...
		if var_5_6 == var_1_10008.CMD.COMPLETE_ORDER then
			...
			if #var_5_2.awards >= 0 then
				...
				var_8.insert(var_5_5, function(arg_8_0)
					...
					var_8_1(var_8_0, var_2_10003.ON_ACHIEVE, var_5_2.awards, arg_8_0)
		...
		if var_5_0 == var_5_3.ZERO_HOUR_OP_DONE then
