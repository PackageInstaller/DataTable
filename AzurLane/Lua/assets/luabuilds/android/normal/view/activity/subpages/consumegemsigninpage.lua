...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_7 = var_2.Find(var_1_6, "AD/targets")
	local var_1_8 = arg_1_0._tf

	arg_1_0.uiTargetList = var_1_5(var_1_7, var_3.Find(var_1_8, "AD/targets/task"))
	...
	local function var_1_13()
		...
		pg = var_2_10003
		var_2_2.helps = var_2_10003.gametip.ConsumeGem_tip.tip
	...
	local function var_1_16()
		...
		var_3_1(var_3_0, var_3_2, var_2_10003.NEW_SHOP)
	...
	local function var_1_19()
		...
		for iter_4_0, iter_4_1 in var_2(var_0) do
			...
			var_2_10007.insert(var_4_1, function(arg_5_0)
				...
				var_5_1(var_5_0, var_3_10003.EVENT_PT_OPERATION, {
					cmd = 1,
	...
	var_1(var_1_17, var_1_18, var_1_19, var_5)
...
function var_0_1.OnDataSetting(arg_7_0)
	...
	arg_7_0.taskProxy = var_1(var_1_10002)
...
function var_0_1.FlushTargetPtAct(arg_9_0)
	...
	local var_9_1 = arg_9_0.CollectCanGetAwards(var_9_0)

	setActive = var_9_0

	var_9_0(arg_9_0.getAllBtnEnb, #var_9_1 > 0)
	...
	var_3.make(var_9_3, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			var_5(arg_10_2:Find("day/Text"), var_10_0)

			table = var_5

			local var_10_2 = var_5.contains(arg_9_0.gotList, var_10_0)
			...
			local var_10_5 = arg_10_2:Find("get")
			...
			local function var_10_6()
				...
				var_11_1(var_11_0, var_3_10002.EVENT_PT_OPERATION, {
					cmd = 1,
			...
			var_7(var_10_4, var_10_5, var_10_6, var_11)
			...
			local function var_10_9()
				...
				var_12_1(var_12_0, var_3_10002.ON_DROP, var_10_1)
			...
			var_7(var_10_7, var_10_8, var_10_9, var_11)
		end

		return
	end)

	local var_9_4 = arg_9_0.uiTargetList

	var_3.align(var_9_4, #arg_9_0.targets)

	local var_9_5 = arg_9_0.itemWid * 0.5 + (var_9_2 - 1) * arg_9_0.itemWid
	local var_9_6 = arg_9_0.sliderTr

	Vector2 = var_1_10006
	var_9_6.sizeDelta = var_1_10006(var_9_5, arg_9_0.sliderTr.sizeDelta.y)
...
function var_0_1.FlushSignInAct(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10002(arg_13_0.taskGroup) do
		...
		var_13_4(var_13_5:Find("day/Text"), "DAY" .. iter_13_0)
		...
		var_11(var_13_5:Find("IconTpl"), var_13_6)

		onButton = var_11

		local var_13_7 = arg_13_0
		local var_13_8 = var_13_5:Find("get")
		...
		local function var_13_9()
			...
			var_14_1(var_14_0, var_2_10002.ON_TASK_SUBMIT, var_13_3)
		...
		var_11(var_13_7, var_13_8, var_13_9, var_15)
		...
		local function var_13_12()
			...
			var_15_1(var_15_0, var_2_10002.ON_DROP, var_13_6)
		...
		var_11(var_13_10, var_13_11, var_13_12, var_15)
	end
...
function var_0_1.UpdateSignInAct(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10003(arg_17_0.taskGroup) do
		...
		var_17_7(var_17_6:Find("got"), var_17_8 or iter_17_0 < arg_17_0.nday)

		local var_17_9 = not var_17_0 and not var_17_8 and iter_17_0 == arg_17_0.nday

		setActive = var_13

		var_13(var_17_6:Find("get"), var_17_9)
...
function var_0_1.Hx4Channel(arg_20_0)
	...
	if not var_2(var_20_0) then
		...
		var_2(var_20_1, var_1_10004.isHx())
	end
