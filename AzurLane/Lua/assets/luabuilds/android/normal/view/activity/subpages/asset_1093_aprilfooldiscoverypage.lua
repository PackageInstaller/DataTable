...
local var_0_0 = "AprilFoolDiscoveryPage"
...
function var_0_1.OnDataSetting(arg_2_0)
	...
	if arg_2_0.activity.data1 == 0 and arg_2_0.activity.data3 == 1 then
		...
		var_2_0(var_2_1, var_1_10003.PUZZLE_PIECE_OP, {
			cmd = 1,
	...
	for iter_2_0, iter_2_1 in var_2_0(arg_2_0.activity.data1_list) do
		...
		if not var_1_10006.contains(arg_2_0.activity.data2_list, iter_2_1) then
			...
			var_1_10006(var_2_2, var_8.MEMORYBOOK_UNLOCK, {
				id = iter_2_1,
				actId = arg_2_0.activity.id
			})
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_2(var_3_1, var_4.format("keyList has {0}, but items has 9", #arg_3_0.keyList))
	...
	local function var_3_4()
		...
		pg = var_2_10003
		var_4_2.helps = var_2_10003.gametip.bulin_help.tip
	...
	var_2(var_3_2, var_3_3, var_3_4, var_6)
	...
	local function var_3_8()
		if #arg_3_0.activity.data2_list < #arg_3_0.keyList then
			...
			var_5_1(var_5_0, var_2_10002("common_activity_not_start"))
		...
		var_5_3(var_5_2, var_2_10002.ON_SIMULATION_COMBAT, {
	...
	var_3_2(var_3_6, var_3_7, var_3_8, var_1_10007)
	...
	local var_3_11 = var_3_9.SystemGuideMgr.GetInstance()
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	if (var_7_0 and "activity_bg_aprilfool_final" or "activity_bg_aprilfool_discovery") ~= arg_7_0.bgName then
		...
		local var_7_2 = arg_7_0.bg

		LoadSprite = var_1_10006

		var_4(var_7_2, var_1_10006("ui/activityuipage/AprilFoolDiscoveryPage_atlas", var_3))

		local var_7_3 = arg_7_0.bg
		local var_7_4 = var_4.GetComponent

		typeof = var_1_10006
		Image = var_7
		var_7_4(var_7_3, var_1_10006(var_7)).enabled = true
		arg_7_0.bgName = var_3
	end

	local var_7_5 = arg_7_0.activity.data2_list
	local var_7_6 = arg_7_0.activity.data3_list

	ipairs = var_1_10006

	for iter_7_0, iter_7_1 in var_1_10006(arg_7_0.items) do
		local var_7_7 = arg_7_0.keyList[iter_7_0]

		table = var_1_10012

		if var_1_10012.contains(var_7_5, var_7_7) then
			var_1_10012 = 3
		else
			table = var_1_10012
			var_1_10012 = var_1_10012.contains(var_7_6, var_7_7) and 2 or 1
		end

		onButton = var_13

		var_13(arg_7_0, iter_7_1, function()
			...
			elseif var_1_10012 == 1 then
				...
				if var_0.GetServerTime(var_8_1) < arg_7_0.activity.data2 then
					...
					var_8_3(var_8_2, var_2_10002("bulin_tip_other2"))
				...
				i18n = var_2_10003
				var_8_6.content = var_2_10003("bulin_tip_other1")
				...
				function var_8_6.onYes()
					...
					var_9_1(var_9_0, var_3_10002.PUZZLE_PIECE_OP, {
						cmd = 3,
		...
		var_13.GetSprite(var_7_8, "UI/ActivityUIPage/AprilFoolDiscoveryPage_atlas", var_0_2[var_1_10012], iter_7_1:Find("state"))

		setActive = var_13

		var_13(iter_7_1:Find("character"), var_1_10012 == 3)
	end
...
function var_0_1.UpdateSelection(arg_10_0)
	...
	if var_10_1 then
		...
		if not var_1_10005("bulin_tip" .. arg_10_0.selectIndex) then
			var_10_3 = ""
		end

		var_3(var_10_2, var_10_3)
	...
	if #arg_11_0.activity.data2_list ~= #arg_11_0.keyList then
		...
		arg_11_0.CDTimer = var_1.New(function()
			...
			if var_12_0 <= var_1.GetServerTime(var_12_1) then
				...
				var_12_1(arg_11_0.slider, false)
			...
			local var_12_2 = var_12_0 - var_1

			math = var_2_10003

			local var_12_3 = var_2_10003.floor(var_12_2 / 60)
			local var_12_4 = var_12_2 % 60

			setText = var_2_10005

			local var_12_5 = arg_11_0.leftTime

			string = var_2_10007

			var_2_10005(var_12_5, var_2_10007.format("%d:%02d", var_12_3, var_12_4))

			local var_12_6 = arg_11_0.puzzleConfig.cd

			setSlider = var_12_5

			var_12_5(arg_11_0.slider, 0, 1, var_12_2 / var_12_6)
