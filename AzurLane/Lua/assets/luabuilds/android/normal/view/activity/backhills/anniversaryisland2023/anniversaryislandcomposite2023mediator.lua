...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.WORKBENCH_COMPOSITE, function(arg_2_0, arg_2_1, arg_2_2)
		local var_2_0 = arg_1_0
		local var_2_1 = var_3.sendNotification

		GAME = var_2_10005

		var_2_1(var_2_0, var_2_10005.WORKBENCH_COMPOSITE, {
			formulaId = arg_2_1,
			repeats = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.OPEN_STOREHOUSE, function(arg_3_0)
		...
		AnniversaryIslandStoreHouse2023Mediator = var_2_10005
		var_3_3.mediator = var_2_10005
		AnniversaryIslandStoreHouse2023Window = var_2_10005
	...
	arg_1_0:bind(var_0_1.OPEN_UPGRADE_PANEL, function(arg_4_0)
		...
		local var_4_5 = var_2_10006.keyof

		AnniversaryIsland2023Scene = var_2_10007
		var_4_4.buildingID = var_4_5(var_2_10007.Buildings, "craft")
	...
	var_1_3(var_1_2, var_3.SHOW_DETAIL, function(arg_5_0, arg_5_1)
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_7_1.WORKBENCH_COMPOSITE_DONE then
		local var_7_3 = arg_7_0.viewComponent

		var_7_4 = var_7_4.emit
		BaseUI = var_1_10006

		var_7_4(var_7_3, var_1_10006.ON_ACHIEVE, var_7_2)
	...
	if var_7_0 == var_7_4.ACTIVITY_UPDATED then
		local var_7_5 = var_7_2
		local var_7_6 = var_7_2.getConfig(var_7_5, "type")

		ActivityConst = var_7_5

		if var_7_6 ~= var_7_5.ACTIVITY_TYPE_WORKBENCH then
			local var_7_7 = var_7_2
			local var_7_8 = var_7_2.getConfig(var_7_7, "type")

			ActivityConst = var_7_7

			if var_7_8 ~= var_7_7.ACTIVITY_TYPE_VIRTUAL_BAG then
				do
					local var_7_9 = var_7_2
					local var_7_10 = var_7_2.getConfig(var_7_9, "type")

					ActivityConst = var_7_9

					if var_7_10 == var_7_9.ACTIVITY_TYPE_BUILDING_BUFF_2 then
						local var_7_11 = arg_7_0.viewComponent

						var_4.BuildActivityEnv(var_7_11)

						local var_7_12 = arg_7_0.viewComponent

						var_4.UpdateView(var_7_12)

						goto label_7_0

						if var_7_0 == var_0_1.OPEN_FORMULA then
							if not var_7_2 then
								return
							end
							...
							var_4.OnReceiveFormualRequest(var_7_13, var_7_2)
						end
					end
				end
