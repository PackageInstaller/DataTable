...
function var_0_1.init(arg_2_0)
	...
	local var_2_10 = var_1.map

	_ = var_2
	arg_2_0.tipTfs = var_2_10(var_2.range(arg_2_0._upper.childCount), function(arg_3_0)
	...
	import = var_2
	arg_2_0.graphPath = var_2_12(var_2("GameCfg.BackHillGraphs.SpringFestival2023Graph"))
	AutoLoader = var_1
...
function var_0_1.didEnter(arg_4_0)
	...
	var_4_0(var_4_1, var_3.Find(var_4_2, "top/return_btn"), function()
	...
	var_4_0(var_4_3, var_3.Find(var_4_4, "top/return_main_btn"), function()
	...
	var_4_0(var_4_5, var_3.Find(var_4_6, "top/help_btn"), function()
		pg = var_2_10000
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.help_chunjie2023.tip
	...
	var_4_0(var_4_7, var_3.Find(var_4_8, "top/firework_btn"), function()
	...
	local var_4_12 = var_4_11(var_4_10, var_3.MINIGAME_SPRING_FESTIVAL_2023)
	...
	arg_4_0.InitFacilityCross(var_4_13, arg_4_0._map, arg_4_0._upper, "xiaoyouxi", function()
		...
		var_10_1(var_10_0, var_2_10002.GO_MINI_GAME, 48)
	...
	local var_4_16 = var_4_15(var_4_14, var_4.FIREWORK_PT_ID)
	...
	arg_4_0.InitFacilityCross(var_4_17, arg_4_0._map, arg_4_0._upper, "yanhua", function()
		...
		SpringFestival2023Mediator = var_2_10002

		local var_11_2 = var_2_10002.GO_SCENE

		SCENE = var_2_10003

		local var_11_3 = var_2_10003.ACTIVITY
		local var_11_4 = {}
		local var_11_5
	...
	local var_4_20 = var_4_19(var_4_18, var_5.ACTIVITY_COUPLET)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "jiulou", function()
		...
		local var_13_2 = var_2_10002.GO_SUBLAYER
		...
		var_13_4.mediator = var_2_10005
		RedPacketLayer = var_2_10005
		var_13_4.viewComponent = var_2_10005
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "huituriji", function()
		...
		var_15_1(var_15_0, var_15_2, var_2_10003.COLORING)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "huazhongshijie", function()
		...
		if not var_16_1(var_16_0, var_2_10002.ACTIVITY_TYPE_WORLDINPICTURE) or var_0:isEnd() then
			pg = var_16_0

			local var_16_2 = var_16_0.TipsMgr.GetInstance()
			local var_16_3 = var_1.ShowTips

			i18n = var_2_10003

			var_16_3(var_16_2, var_2_10003("common_activity_end"))

			return
		end

		local var_16_4 = var_0
		local var_16_5 = var_0.getConfig(var_16_4, "config_client").linkActID

		pg = var_16_4

		local var_16_6 = var_16_4.m02
		local var_16_7 = var_2.sendNotification

		GAME = var_2_10004

		local var_16_8 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		var_16_7(var_16_6, var_16_8, var_2_10005.ACTIVITY, {
			id = var_16_5
		})
...
function var_0_1.OpenFireworkLayer(arg_17_0)
	...
	SpringFestival2023Mediator = var_1_10003

	local var_17_2 = var_1_10003.GO_SUBLAYER

	Context = var_1_10004

	local var_17_3 = var_1_10004.New
	local var_17_4 = {}

	FireworkPanelMediator = var_1_10006
	var_17_4.mediator = var_1_10006
	FireworkPanelLayer = var_1_10006
	var_17_4.viewComponent = var_1_10006
...
function var_0_1.PlayerOneFirework(arg_21_0)
	if arg_21_0.index == #arg_21_0.fireworks then
		...
		local var_21_1 = arg_21_0.managedTween

		LeanTween = var_1_10003

		var_21_1(var_21_0, var_1_10003.delayedCall, function()
	...
	local var_21_2 = arg_21_0.fireworks[arg_21_0.index]
	local var_21_3 = arg_21_0.fireworksTF
	local var_21_4 = var_2.Find

	tostring = var_1_10004

	local var_21_5 = var_21_4(var_21_3, var_1_10004(var_21_2))

	math = var_21_3

	local var_21_6 = var_21_3.random(#var_0_1.SFX_LIST)

	if var_21_5 then
		setLocalPosition = var_4

		var_4(var_21_5, arg_21_0:GetFireworkPos())
		...
		local var_21_7 = var_4.CriMgr.GetInstance()

		var_4.PlaySoundEffect_V3(var_21_7, var_0_1.SFX_LIST[var_21_6])
	else
		local var_21_8 = arg_21_0.loader

		var_4.GetPrefab(var_21_8, "ui/" .. var_0_1.Id2EffectName[var_21_2], "", function(arg_23_0)
			pg = var_2_10001
			...
			var_1(var_23_0, var_3.GetFireworkPos(var_23_1))
			...
			var_1.PlaySoundEffect_V3(var_23_2, var_0_1.SFX_LIST[var_21_6])
...
function var_0_1.UpdateView(arg_27_0)
	...
	var_1_10001.each(arg_27_0.tipTfs, function(arg_28_0)
		if arg_28_0.trans then
			...
			var_1(var_28_0, var_2_10003(var_0_1.CheckTip(arg_28_0.name)))
		end
...
function var_0_1.CheckTip(arg_30_0)
	...
	return var_1_10002(arg_30_0, {
		xiaoyouxi = function()
			...
			return var_31_0(var_2_10001.MINIGAME_SPRING_FESTIVAL_2023)
		end,
		huituriji = function()
			getProxy = var_2_10000
		...
		huazhongshijie = function()
			...
			local var_33_2 = var_33_1(var_33_0, var_2_10002.ACTIVITY_TYPE_WORLDINPICTURE)

			Activity = var_33_0

			return var_33_0.IsActivityReady(var_33_2)
		end,
		jiulou = function()
		...
		yanhua = function()
			...
			local var_35_2 = var_35_1(var_35_0, var_2_10002.FIREWORK_PT_ID)

			Activity = var_35_0

			return var_35_0.IsActivityReady(var_35_2)
		end,
		duilian = function()
			...
			local var_36_2 = var_36_1(var_36_0, var_2_10002.ACTIVITY_COUPLET)

			Activity = var_36_0

			return var_36_0.IsActivityReady(var_36_2)
		end
	}, function()
		return false
	end)
