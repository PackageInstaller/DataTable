...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.CoreURExchangeTemplatePage"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		var_1(arg_2_0._msgBoxItem, var_3_0)

		setText = var_1

		var_1(arg_2_0._msgBoxItemName, var_3_0:getName())

		setText = var_1

		var_1(arg_2_0._msgBoxItemDesc, var_3_0.desc)

		pg = var_1

		local var_3_1 = var_1.UIMgr.GetInstance()
	...
	local function var_2_5()
		...
		local var_4_1 = var_1.delayedCall
		local var_4_2 = 1

		System = var_2_10003
		var_4_0.leantween = var_4_1(var_4_2, var_2_10003.Action(function()
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	var_1(var_2.Find(var_6_1, "red"), arg_6_0.canExchange)
