...
function var_0_1.OnUpdateFlush(arg_2_0)
	...
	if 1 <= var_2_12 then
		...
		if not var_11(var_2_14, var_13) then
			var_2_15 = var_2_10
		end
		...
		var_2_20(arg_2_0.battleBtn, var_2_21 and not var_2_17 and var_2_19)

		setActive = var_2_20

		var_2_20(arg_2_0.getBtn, var_2_17)

		setActive = var_2_20

		var_2_20(arg_2_0.gotBtn, not var_2_19)
		...
		var_2_22(arg_2_0.awardTF, var_2_23)
		...
		local function var_2_26()
			...
			var_3_1(var_3_0, var_2_10002.ON_DROP, var_2_23)
		...
		var_2_22(var_2_24, var_2_25, var_2_26, var_1_10017)
