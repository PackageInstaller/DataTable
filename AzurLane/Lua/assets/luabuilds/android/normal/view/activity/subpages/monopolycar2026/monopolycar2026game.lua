...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..MonopolyCar2024.MonopolyCar2024Game"))
local var_0_2 = 1
local var_0_3 = 2
...
function var_0_1.InitUI(arg_8_0)
	...
	local var_8_2 = var_2.Find(var_8_1, "Text")

	i18n = var_8_1

	var_1(var_8_2, var_8_1("mono_car_2026_toggle_main"))

	setText = var_1

	local var_8_3 = arg_8_0.mainModeBtn
	local var_8_4 = var_2.Find(var_8_3, "sel/Text")

	i18n = var_8_3

	var_1(var_8_4, var_8_3("mono_car_2026_toggle_main"))

	setText = var_1

	local var_8_5 = arg_8_0.storyModeBtn
	local var_8_6 = var_2.Find(var_8_5, "Text")

	i18n = var_8_5

	var_1(var_8_6, var_8_5("mono_car_2026_toggle_story"))

	setText = var_1

	local var_8_7 = arg_8_0.storyModeBtn
	local var_8_8 = var_2.Find(var_8_7, "sel/Text")

	i18n = var_8_7

	var_1(var_8_8, var_8_7("mono_car_2026_toggle_story"))
...
function var_0_1.CheckMainStorys(arg_12_0, arg_12_1)
	...
	if #var_12_2 <= 0 then
		...
		arg_12_0.PlayStepHideAnim(var_12_4, arg_12_1)
	...
	for iter_12_2, iter_12_3 in var_12_4(var_12_2) do
		table = var_1_10012

		var_1_10012.insert(var_12_5, function(arg_14_0)
...
function var_0_1.PlayStepHideAnim(arg_16_0, arg_16_1)
	...
	local var_16_2 = var_16_1(var_16_0, var_4(var_1_10005))
	local var_16_3 = var_2.GetComponent

	typeof = var_1_10005
	DftAniEvent = var_1_10006

	local var_16_4 = var_16_3(var_16_2, var_1_10005(var_1_10006))
...
function var_0_1.PlayRollAnimation(arg_18_0, arg_18_1, arg_18_2)
	...
	var_1_10003(var_1_10004(arg_18_0.rollStep, "animroot/Image/Text"), "00")
	...
	local var_18_2 = var_18_1(var_18_0, var_5(var_6))
	local var_18_3 = var_3.GetComponent

	typeof = var_6
	DftAniEvent = var_1_10007

	local var_18_4 = var_18_3(var_18_2, var_6(var_1_10007))

	findTF = var_18_2

	local var_18_5 = var_18_2(arg_18_0.rollStep, "animroot")
	local var_18_6 = var_5.GetComponent

	typeof = var_7
	Animation = var_1_10008

	local var_18_7 = var_18_6(var_18_5, var_7(var_1_10008))
	local var_18_8 = var_5.GetComponent

	typeof = var_1_10008
	DftAniEvent = var_1_10009

	local var_18_9 = var_18_8(var_18_7, var_1_10008(var_1_10009))

	var_6.SetTriggerEvent(var_18_9, function()
		setText = var_2_10000
		findTF = var_2_10001

		var_2_10000(var_2_10001(arg_18_0.rollStep, "animroot/Image/Text"), "0" .. arg_18_1)
...
function var_0_1.InitMap(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1(var_1_10002.activity_monopolycar2026_map_event.all) do
		pg = var_1_10006
		...
		var_1_10008 = var_1_10008(var_26_1, var_26_2, var_1_10011(var_26_0))
		Vector3 = var_26_1
		var_1_10008.localPosition = var_26_1(var_1_10006.pos.x, var_1_10006.pos.y, 0)
		setActive = var_10

		var_10(var_1_10008, false)

		pg = var_10

		local var_26_3 = var_10.activity_event_monopoly_map[var_26_0].icon

		var_1_10011 = {}
		col = var_12
		var_1_10011.col = var_12
		row = var_12
		var_1_10011.row = var_12
		var_1_10011.mapId = var_26_0
		var_1_10011.tf = var_1_10008
		var_1_10011.icon = var_26_3
		var_1_10011.position = var_9
		...
		var_1_10011.flip = var_26_4
		table = var_26_4

		var_26_4.insert(arg_26_0.mapCells, var_1_10011)
	end
...
function var_0_1.SetRollStepAct(arg_28_0, arg_28_1)
	if not arg_28_1 then
		...
		var_1_10002(var_1_10003(arg_28_0.rollStep, "animroot/Image/Text"), "")
	end
...
function var_0_1.InitStoryMap(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1(var_1_10002.activity_monopolycar2026_story_event.all) do
		pg = var_1_10006
		...
		var_1_10007 = var_1_10007(var_29_0, var_29_1, var_1_10010(iter_29_1))
		Vector3 = var_29_0
		var_1_10007.localPosition = var_29_0(var_1_10006.pos.x, var_1_10006.pos.y, 0)

		if var_0_4(var_1_10006) then
			onButton = var_9
			var_1_10010 = arg_29_0
			...
			var_9(var_1_10010, var_29_2, var_29_3, var_1_10013)
		end

		findTF = var_9

		local var_29_4 = var_9(var_1_10007, "Image")

		pg = var_1_10010
		var_1_10010 = var_1_10010.ship_skin_template[var_1_10006.icon]
		GetImageSpriteFromAtlasAsync = var_11

		var_11("SquareIcon/" .. var_1_10010.prefab, "", var_29_4)

		setActive = var_11

		var_11(var_1_10007, var_8)

		table = var_11

		var_11.insert(arg_29_0.storyCells, var_1_10007)
	end
...
function var_0_1.UpdateStoryAward(arg_31_0)
	if var_0_7() then
		...
		pg = var_1_10002
		var_1_10003 = var_1_10002.NewStoryMgr.GetInstance()
		var_1_10002 = var_1_10002.StoryName2StoryId(var_1_10003, var_1.story)
	end
	...
	if var_1_10003 and var_1_10003.drop_client then
		var_31_0 = var_1_10003.drop_client[1]
	end
	...
	if var_31_0 then
		...
		var_6(arg_31_0.storyAward, var_31_1)
	end
...
function var_0_1.UpdateUI(arg_35_0)
	...
	var_1(var_35_0, var_1_10003("monopoly2026_left_cnt", arg_35_0.leftCount))
...
function var_0_1.UpdateStoryUI(arg_36_0)
	...
	for iter_36_0, iter_36_1 in var_1_10006(var_1_10007.activity_monopolycar2026_story_event.all) do
		pg = var_1_10011
		...
		if var_12 then
			...
			var_36_5 = var_36_6 and not var_1_10014
			var_36_2 = var_36_2 or var_36_5
		else
			setActive = var_1_10014

			var_1_10014(arg_36_0.storyCells[iter_36_0], false)
		end
		...
		var_1_10014(var_15.Find(var_36_7, "tip"), var_36_5)
	end
	...
	var_6(var_36_8, var_8("monopoly2026_story_award", var_36_1, var_36_0))

	local var_36_9 = var_36_0 > 0 and var_36_1 == var_36_0

	setActive = var_36_8

	var_36_8(arg_36_0.storyAwardGot, var_36_9)

	setActive = var_36_8

	var_36_8(arg_36_0.storyModeBtnTip, var_36_2)
...
function var_0_1.ApplyModelFlip(arg_40_0, arg_40_1)
	...
	if arg_40_0.modelIconTf and arg_40_0.modelIconBasePos then
		...
		if arg_40_1 == 1 then
			local var_40_1 = arg_40_0.modelIconTf
			local var_40_2 = var_3.GetComponent

			typeof = var_1_10005
			RectTransform = var_1_10006

			local var_40_3 = var_40_2(var_40_1, var_1_10005(var_1_10006))
			local var_40_4

			if arg_40_0.modelArrTf then
				var_1_10005 = arg_40_0.modelArrTf
				var_40_4 = var_40_4.GetComponent
				typeof = var_1_10006
				RectTransform = var_1_10007
				var_40_4 = var_40_4(var_1_10005, var_1_10006(var_1_10007))
			end

			if not var_40_3 or not var_40_3.rect.height then
				var_1_10005 = 0
			end
...
function var_0_1.RegisterUI(arg_43_0)
	...
	var_1(var_43_0, var_43_1, var_43_2, var_1_10005)
	...
	var_1(var_43_3, var_43_4, var_43_5, var_1_10005)
	...
	local function var_43_8()
		...
		var_46_2.type = var_2_10003
		pg = var_2_10003
		var_46_2.helps = var_2_10003.gametip.help_monopoly_car2026.tip
	...
	var_1(var_43_6, var_43_7, var_43_8, var_1_10005)
	...
	var_1(var_43_9, var_43_10, var_43_11, var_1_10005)
