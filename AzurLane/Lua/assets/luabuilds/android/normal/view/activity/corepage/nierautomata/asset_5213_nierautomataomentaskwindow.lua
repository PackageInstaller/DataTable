...
local var_0_0 = "NieRAutomataOmenTaskWindow"
...
function var_0_1.UpdateListItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = var_4(var_9_0, "day/dayText")
	...
	local var_9_4 = var_7(var_9_3, "desc_bg/desc")
...
function var_0_1.UpdateTaskItem(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_12 = var_12_4 and var_12_4:getTaskStatus() == 2
	local var_12_13 = var_12_5.desc

	utf8 = var_1_10014

	if var_1_10014.len(var_12_13) >= 17 then
		setScrollText = var_14

		var_14(arg_12_3:Find("mask/description"), var_12_13)
	else
		setText = var_14
	...
	var_14(arg_12_3:Find("progress"), 0, var_12_11, var_12_10)

	setText = var_14

	var_14(arg_12_3:Find("progressText"), var_12_10 .. "<color=#52514a>/" .. var_12_11 .. "</color>")

	setActive = var_14

	var_14(arg_12_3:Find("progressText"), not var_12_12)

	setActive = var_14

	var_14(arg_12_3:Find("mask_got"), var_12_12)

	setText = var_14

	local var_12_14 = arg_12_3
	local var_12_15 = arg_12_3.Find(var_12_14, "mask_got/Text")

	i18n = var_12_14

	var_14(var_12_15, var_12_14("nier_a2_item_got"))
...
function var_0_1.isTaskLock(arg_15_0, arg_15_1)
	...
	for iter_15_0 = 1, arg_15_1 - 1 do
		...
		for iter_15_1, iter_15_2 in var_1_10007(var_15_0) do
			local var_15_1 = arg_15_0.taskProxy
			local var_15_3

			if not var_12.getTaskById(var_15_1, iter_15_2) then
				local var_15_2 = arg_15_0.taskProxy

				var_15_3 = var_12.getFinishTaskById(var_15_2, iter_15_2)
			end

			if not var_15_3 or var_15_3:getTaskStatus() ~= 2 then
				return 2
			end
		end
	end
