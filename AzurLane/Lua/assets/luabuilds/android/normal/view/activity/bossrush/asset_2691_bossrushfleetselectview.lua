...
function var_0_1.InitUI(arg_4_0)
	...
	local var_4_15 = var_3.Find(var_4_14, "Panel/Fleet/SonarRange/Text")

	i18n = var_4_14

	var_2(var_4_15, var_4_14("fleet_antisub_range") .. ":")

	setText = var_2

	local var_4_16 = arg_4_0._tf
	local var_4_17 = var_3.Find(var_4_16, "Panel/Fleet/CostLimit/Title")

	i18n = var_4_16

	var_2(var_4_17, var_4_16("formationScene_use_oil_limit_tip_worldboss"))

	setText = var_2

	local var_4_18 = arg_4_0._tf
	local var_4_19 = var_3.Find(var_4_18, "Panel/Reward/Normal/Base/Text")

	i18n = var_4_18

	var_2(var_4_19, var_4_18("series_enemy_reward_tip1"))

	setText = var_2

	local var_4_20 = arg_4_0._tf
	local var_4_21 = var_3.Find(var_4_20, "Panel/Reward/Normal/Mode/Text")

	i18n = var_4_20

	var_2(var_4_21, var_4_20("series_enemy_reward_tip2"))

	setText = var_2

	local var_4_22 = arg_4_0._tf
	local var_4_23 = var_3.Find(var_4_22, "Panel/Reward/EX/Title")

	i18n = var_4_22

	var_2(var_4_23, var_4_22("series_enemy_reward_tip4"))

	setText = var_2

	local var_4_24 = arg_4_0._tf
	local var_4_25 = var_3.Find(var_4_24, "Panel/Reward/Tip")

	i18n = var_4_24

	var_2(var_4_25, var_4_24("limit_team_character_tips"))

	setText = var_2

	local var_4_26 = arg_4_0._tf
	local var_4_27 = var_3.Find(var_4_26, "Panel/Info/Modes/Single/On/Text")

	i18n = var_4_26

	var_2(var_4_27, var_4_26("series_enemy_mode_1"))

	setText = var_2

	local var_4_28 = arg_4_0._tf
	local var_4_29 = var_3.Find(var_4_28, "Panel/Info/Modes/Single/Off/Text")

	i18n = var_4_28

	var_2(var_4_29, var_4_28("series_enemy_mode_1"))

	setText = var_2

	local var_4_30 = arg_4_0._tf
	local var_4_31 = var_3.Find(var_4_30, "Panel/Info/Modes/Multiple/On/Text")

	i18n = var_4_30

	var_2(var_4_31, var_4_30("series_enemy_mode_2"))

	setText = var_2

	local var_4_32 = arg_4_0._tf
	local var_4_33 = var_3.Find(var_4_32, "Panel/Info/Modes/Multiple/Off/Text")

	i18n = var_4_32

	var_2(var_4_33, var_4_32("series_enemy_mode_2"))

	setText = var_2

	local var_4_34 = arg_4_0._tf
	local var_4_35 = var_3.Find(var_4_34, "Panel/Fleet/Normal/main/Item/Ship/EnergyWarn/Text")

	i18n = var_4_34

	var_2(var_4_35, var_4_34("series_enemy_mood"))

	setText = var_2

	local var_4_36 = arg_4_0._tf
	local var_4_37 = var_3.Find(var_4_36, "Panel/Fleet/Normal/vanguard/Item/Ship/EnergyWarn/Text")

	i18n = var_4_36

	var_2(var_4_37, var_4_36("series_enemy_mood"))

	setText = var_2

	local var_4_38 = arg_4_0._tf
	local var_4_39 = var_3.Find(var_4_38, "Panel/Fleet/Submarine/main/Item/Ship/EnergyWarn/Text")

	i18n = var_4_38

	var_2(var_4_39, var_4_38("series_enemy_mood"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_3()
		for iter_6_0 = 1, #arg_5_0.contextData.fleets - 1 do
			...
			if var_2_10004.isLegalToFight(var_6_0) ~= true then
				pg = var_2_10005
				...
				var_2_10005(var_6_1, var_2_10007("series_enemy_team_notenough"))
		...
		if var_0.any(arg_5_0.contextData.fleets, function(arg_7_0)
			...
			if var_7_0 then
				...
				var_3.ShowTips(var_7_2, var_7_1)
		...
		BossRushSeriesData = var_6_2

		local var_6_4 = var_6_3 == var_6_2.TYPE.SP
		local var_6_5 = true
		...
		if var_6_4 then
			...
			local var_6_6 = iter_6_0(var_2_10004)

			var_2_10005 = var_3.getActivityById(var_6_6, var_5_0.actId)

			local var_6_7 = var_3.GetActiveSeriesIds(var_2_10005)

			table = var_2_10005
			var_2_10005 = var_2_10005.getIndex(var_6_7, function(arg_8_0)
				return arg_8_0 == var_5_0.id
			end)

			local var_6_8

			if not var_3:GetUsedBonus()[var_2_10005] then
				var_6_8 = 0
			end

			local var_6_9 = var_5_0

			if not (var_7.GetMaxBonusCount(var_6_9) - var_6_8 > 0) then
				pg = var_8
				...
				var_6_11(var_6_10, var_2_10010("series_enemy_SP_error"))
		...
		BossRushFleetSelectMediator = var_2_10005

		var_6_13(var_6_12, var_2_10005.ON_PRECOMBAT)
	...
	var_1_10002(var_5_1, var_5_2, var_5_3, var_1_10006)
	...
	local function var_5_6()
		...
		pg = var_2_10003
		var_9_2.helps = var_2_10003.gametip.fleet_antisub_range_tip.tip
	...
	var_1_10002(var_5_4, var_5_5, var_5_6, var_1_10006)
	...
	var_1_10002(var_5_7, var_5_8, var_5_9, var_1_10006)
	...
	var_1_10002(var_5_10, var_5_12, var_5_13, var_6)

	local var_5_14 = var_5_0
	local var_5_15 = var_5_0.IsSingleFight(var_5_14)

	setActive = var_5_14

	var_5_14(arg_5_0.modeToggles[1].parent, var_5_15)

	if var_5_15 then
		table = var_5_14

		var_5_14.Foreach(arg_5_0.modeToggles, function(arg_12_0, arg_12_1)
		...
		var_3.Foreach(arg_5_0.modeToggles, function(arg_13_0, arg_13_1)
			...
			local function var_13_2(arg_14_0)
				...
				var_14_1(var_14_0, var_3_10003.ON_SWITCH_MODE, arg_13_0)
			...
			var_2_10002(var_13_0, var_13_1, var_13_2, var_2_10006)
	...
	local var_5_17 = var_3.Find(var_5_16, "Panel/Fleet/Indexes").childCount

	UIItemList = var_5

	var_5.StaticAlign(var_3, var_3:GetChild(0), var_5_17, function(arg_15_0, arg_15_1, arg_15_2)
		arg_15_1 = arg_15_1 + 1
		UIItemList = var_2_10003

		if arg_15_0 == var_2_10003.EventUpdate then
			if arg_15_1 < var_5_17 then
				setText = var_3

				local var_15_0 = arg_15_2
				local var_15_1 = arg_15_2.Find(var_15_0, "Text")

				i18n = var_15_0

				local var_15_2 = "series_enemy_fleet_prefix"

				GetRomanDigit = var_2_10007

				var_3(var_15_1, var_15_0(var_15_2, var_2_10007(arg_15_1)))
			else
				setText = var_3

				local var_15_3 = arg_15_2
				local var_15_4 = arg_15_2.Find(var_15_3, "Text")

				i18n = var_15_3

				var_3(var_15_4, var_15_3("formationScene_use_oil_limit_submarine"))
			end

			onToggle = var_3

			local var_15_5 = arg_5_0
			local var_15_6 = arg_15_2

			local function var_15_7(arg_16_0)
				setActive = var_3_10001

				local var_16_0 = arg_15_2

				var_3_10001(var_2.Find(var_16_0, "Selected"), arg_16_0)
				...
				var_3(var_4.Find(var_16_4, "Text"), arg_16_0 and var_16_2 or var_16_3)
			...
			var_3(var_15_5, var_15_6, var_15_7, var_2_10007)
		end
	...
	var_5(var_6.Find(var_5_18, "Panel/Info/Title/Text"), var_5_0:GetName())

	setText = var_5

	local var_5_19 = arg_5_0._tf

	var_5(var_6.Find(var_5_19, "Panel/Info/Title/Text/EN"), var_5_0:GetSeriesCode())

	setText = var_5

	local var_5_20 = arg_5_0._tf

	var_5(var_6.Find(var_5_20, "Panel/Info/Description/Text"), var_5_0:GetDescription())

	local var_5_21 = var_5_0:GetExpeditionIds()
	local var_5_22 = var_5_0:GetBossIcons()
	local var_5_23 = arg_5_0._tf
	local var_5_24 = var_7.Find(var_5_23, "Panel/Info/Boss")

	UIItemList = var_5_23

	var_5_23.StaticAlign(var_5_24, var_5_24:GetChild(0), #var_5_21, function(arg_17_0, arg_17_1, arg_17_2)
		UIItemList = var_2_10003
		...
		local var_17_0 = var_5_21[arg_17_1 + 1]
		...
		local var_17_5 = var_17_3(var_17_4, "icon_bg")

		findTF = var_9

		local var_17_6 = var_9(var_17_4, "icon_bg/frame")
		...
		GetImageSpriteFromAtlasAsync = var_17_7

		var_17_7("SquareIcon/" .. var_17_1, "", var_17_8)

		findTF = var_17_7

		if var_17_7(var_17_4, "ship_type") then
			setActive = var_12
			...
			shipType2print = var_2_10016

			var_12(var_17_9, var_14(var_17_10, var_2_10016(var_5_22[arg_17_1 + 1][2])))
		end
	...
	local var_5_27 = var_5_0.GetType(var_5_26)

	BossRushSeriesData = var_5_26

	local var_5_28 = var_5_27 == var_5_26.TYPE.EXTRA

	setActive = var_5_32

	local var_5_29 = arg_5_0._tf

	var_5_32(var_11.Find(var_5_29, "Panel/Reward/Normal"), not var_5_28)

	setActive = var_5_32

	local var_5_30 = arg_5_0._tf

	var_5_32(var_11.Find(var_5_30, "Panel/Reward/EX"), var_5_28)

	local var_5_31, var_5_32, var_5_33

	if not var_5_28 then
		var_5_31 = arg_5_0._tf
		var_5_32 = var_5_32.Find(var_5_31, "Panel/Reward/Normal/Base/Items")
		var_5_31 = var_5_25(var_5_0:GetPassAwards())
		UIItemList = var_5_33
		var_5_33 = var_5_33.StaticAlign

		local var_5_34 = var_5_32

		var_1_10015 = var_5_32

		var_5_33(var_5_34, var_5_32.GetChild(var_1_10015, 0), #var_5_31, function(arg_19_0, arg_19_1, arg_19_2)
			UIItemList = var_2_10003
			...
			local var_19_0 = var_5_31[arg_19_1 + 1]
			...
			var_5(var_19_2, var_19_3, var_19_4, var_2_10009)

			return
		end)

		local var_5_35 = arg_5_0.extraAwardTF

		var_5_33 = var_5_33.Find(var_5_35, "Items")

		local var_5_36 = var_5_25

		var_1_10015 = var_5_0

		local var_5_37 = var_5_36(var_5_0.GetAdditionalAwards(var_1_10015))

		UIItemList = var_14

		var_14.StaticAlign(var_5_33, var_5_33:GetChild(0), #var_5_37, function(arg_21_0, arg_21_1, arg_21_2)
			UIItemList = var_2_10003
			...
			local var_21_0 = var_5_37[arg_21_1 + 1]
			...
			var_5(var_21_2, var_21_3, var_21_4, var_2_10009)

			return
		end)
	else
		getProxy = var_5_32
		ActivityProxy = var_5_31

		local var_5_38 = var_5_32(var_5_31)
		local var_5_39 = var_10.getActivityByType

		ActivityConst = var_5_33

		local var_5_40 = var_5_39(var_5_38, var_5_33.ACTIVITY_TYPE_EXTRA_BOSSRUSH_RANK)
		local var_5_41 = var_10.GetScore(var_5_40)
		local var_5_42 = arg_5_0._tf
		local var_5_43

		var_5_43, setText = var_12.Find(var_5_42, "Panel/Reward/EX/Title/Text"), var_5_42
		math = var_1_10015

		var_5_42(var_5_43, var_1_10015.floor(var_5_41))
	end
...
function var_0_1.onCancelHard(arg_25_0)
	...
	BossRushFleetSelectMediator = var_1_10003

	var_25_1(var_25_0, var_1_10003.ON_UPDATE_CUSTOM_FLEET)
	arg_25_0:closeView()
...
function var_0_1.initAddButton(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	var_11.StaticAlign(arg_28_1, arg_28_1:GetChild(0), 3, function(arg_31_0, arg_31_1, arg_31_2)
		...
		if var_31_0 then
			...
			if not arg_31_2.Find(var_31_1, "Ship") then
				var_31_1 = arg_31_2
				var_31_2 = arg_31_2.Find(var_31_1, "Empty")
			end
			...
			if var_31_0 then
				...
				local var_31_3 = var_31_2:Find("EnergyWarn")
				local var_31_4 = arg_28_0.contextData.mode

				BossRushSeriesData = var_8

				if var_31_4 == var_8.MODE.SINGLE then
					local var_31_5 = var_31_0
					local var_31_6 = var_31_0.getEnergy(var_31_5)

					pg = var_31_5

					local var_31_7

					if not (var_31_6 <= var_31_5.gameset.series_enemy_mood_limit.key_value) then
						var_31_7 = false
					else
						var_31_7 = true
					end

					var_31_1(var_31_3, var_31_7)

					setActive = var_31_1

					var_31_1(var_31_2:Find("event_block"), var_31_0:getFlag("inEvent"))

					setActive = var_31_1

					var_31_1(var_31_2:Find("ship_type"), false)

					GetOrAddComponent = var_31_1

					local var_31_8 = var_31_2

					typeof = var_7
					UILongPressTrigger = var_8

					local var_31_9 = var_31_1(var_31_8, var_7(var_8)).onLongPressed

					var_6.RemoveAllListeners(var_31_9)

					if var_31_0 then
						local var_31_10 = var_5.onLongPressed

						var_6.AddListener(var_31_10, function()
							local var_32_0 = arg_28_0
							local var_32_1 = var_0.emit

							BossRushFleetSelectMediator = var_3_10002

							var_32_1(var_32_0, var_3_10002.ON_FLEET_SHIPINFO, {
								shipId = var_31_0.id,
								shipVOs = var_28_5
							})
					...
					local var_31_11 = var_6(var_31_2, "EventTriggerListener")

					var_6.RemovePointClickFunc(var_31_11)
					var_6:AddPointClickFunc(function(arg_33_0, arg_33_1)
						...
						var_33_1(var_33_0, var_3_10004.ON_OPEN_DECK, {
							fleet = var_28_2,
...
function var_0_1.updateEliteFleets(arg_36_0)
	...
	var_1_10005(var_6.Find(var_36_4, "Panel/Fleet/Normal"), not var_36_3)

	setActive = var_1_10005

	local var_36_5 = arg_36_0._tf

	var_1_10005(var_6.Find(var_36_5, "Panel/Fleet/Submarine"), var_36_3)
	...
	if not var_36_3 then
		...
		local var_36_10 = var_36_9[var_1_10009.Normal]

		setText = var_1_10009

		local var_36_11 = var_36_10

		var_1_10010 = var_36_10.Find(var_36_11, "bg/name")
		Fleet = var_36_11

		var_1_10009(var_1_10010, var_36_11.DEFAULT_NAME[var_36_1])

		var_1_10010 = arg_36_0
		var_1_10009 = arg_36_0.initAddButton

		local var_36_12 = var_36_10
		local var_36_13 = var_36_10.Find

		TeamType = var_1_10013

		local var_36_14 = var_36_13(var_36_12, var_1_10013.Main)

		TeamType = var_36_12

		var_1_10009(var_1_10010, var_36_14, var_36_12.Main, var_36_1)

		var_1_10010 = arg_36_0
		var_1_10009 = arg_36_0.initAddButton

		local var_36_15 = var_36_10
		local var_36_16 = var_36_10.Find

		TeamType = var_13

		local var_36_17 = var_36_16(var_36_15, var_13.Vanguard)

		TeamType = var_36_15

		var_1_10009(var_1_10010, var_36_17, var_36_15.Vanguard, var_36_1)
	else
		local var_36_18 = arg_36_0.tfFleets

		FleetType = var_1_10009

		local var_36_19 = var_36_18[var_1_10009.Submarine]
		local var_36_20 = #arg_36_0.contextData.fleets

		setText = var_1_10010

		local var_36_21 = var_36_19
		local var_36_22 = var_36_19.Find(var_36_21, "bg/name")

		Fleet = var_36_21

		local var_36_23 = var_36_21.DEFAULT_NAME

		Fleet = var_13

		var_1_10010(var_36_22, var_36_23[var_13.SUBMARINE_FLEET_ID])

		local var_36_24 = arg_36_0
		local var_36_25 = arg_36_0.initAddButton
		local var_36_26 = var_36_19
		local var_36_27 = var_36_19.Find

		TeamType = var_1_10014

		local var_36_28 = var_36_27(var_36_26, var_1_10014.Main)

		TeamType = var_36_26

		var_36_25(var_36_24, var_36_28, var_36_26.Submarine, var_36_20)
	end
	...
	local var_36_29 = arg_36_0.sonarRangeTexts[1]

	math = var_10

	var_8(var_36_29, var_10.floor(var_36_2:GetFleetSonarRange()))

	local var_36_30 = #var_36_2:GetRawShipIds() == (var_36_3 and 3 or 6)

	onButton = var_10

	var_10(arg_36_0, var_36_6, function()
		if var_0 == 0 then
			return
		end
		...
		i18n = var_2_10003
		var_37_2.content = var_2_10003("battle_preCombatLayer_clear_confirm")
		...
		function var_37_2.onYes()
			...
			var_38_1(var_38_0, var_3_10002.ON_ELITE_CLEAR, {
				index = var_36_1
			})
	...
	var_10(arg_36_0, var_36_7, function()
		if var_36_30 then
			return
		end
		...
		var_0({
			function(arg_40_0)
				...
				i18n = var_3_10004
				var_40_2.content = var_3_10004("battle_preCombatLayer_auto_confirm")
			...
			function(arg_41_0)
				...
				var_41_1(var_41_0, var_3_10003.ON_ELITE_RECOMMEND, {
					index = var_36_1
				})
	...
	local var_36_31 = var_36_0
	local var_36_32 = var_36_0.GetOilLimit(var_36_31)

	setActive = var_36_31

	local var_36_33 = arg_36_0.rtCostLimit

	_ = var_13

	var_36_31(var_36_33, var_13.any(var_36_32, function(arg_42_0)
		return arg_42_0 > 0
	end))

	if #var_36_32 > 0 then
		local var_36_34 = var_36_3 and "formationScene_use_oil_limit_submarine" or "formationScene_use_oil_limit_surface"
		local var_36_35

		if not var_36_3 or not var_36_32[2] then
			var_36_35 = var_36_32[1]
		end

		setText = var_13

		local var_36_36 = arg_36_0.rtCostLimit
		local var_36_37 = var_14.Find(var_36_36, "Text")

		string = var_36_36

		local var_36_38 = var_36_36.format

		var_1_10016 = "%s(%d)"
		i18n = var_1_10017

		var_13(var_36_37, var_36_38(var_1_10016, var_1_10017(var_36_34), var_36_35))
	end

	local var_36_39 = (function(arg_43_0)
		type = var_2_10001
	...
	local var_36_40 = arg_36_0.extraAwardTF
	local var_36_41 = arg_36_0.contextData.mode

	BossRushSeriesData = var_1_10016

	var_13(var_36_40, var_36_41 == var_1_10016.MODE.MULTIPLE and #var_36_39 > 0)

	local var_36_42 = var_36_0:GetExpeditionIds()
	local var_36_43 = arg_36_0._tf
	local var_36_44 = var_14.Find(var_36_43, "Panel/Info/Boss")

	UIItemList = var_36_43

	var_36_43.StaticAlign(var_36_44, var_36_44:GetChild(0), #var_36_42, function(arg_44_0, arg_44_1, arg_44_2)
		UIItemList = var_2_10003
		...
		if arg_44_1 + 1 ~= var_36_1 then
			...
			if not (#var_36_42 < var_44_0) then
...
function var_0_1.initCommander(arg_45_0, arg_45_1, arg_45_2)
	...
	for iter_45_0 = 1, 2 do
		...
		if var_45_1 then
			...
			CommanderProxy = var_1_10011
			var_1_10011 = var_1_10010(var_1_10011)
			var_45_2 = var_1_10010.getCommanderById(var_1_10011, var_45_1)
		end

		var_1_10011 = arg_45_2

		local var_45_3 = arg_45_2.Find(var_1_10011, iter_45_0)

		var_1_10011 = var_1_10010.Find(var_45_3, "add")

		local var_45_4 = var_1_10010
		local var_45_5 = var_1_10010.Find(var_45_4, "info")

		setActive = var_45_4

		var_45_4(var_1_10011, not var_45_2)

		setActive = var_45_4

		var_45_4(var_45_5, var_45_2)

		if var_45_2 then
			Commander = var_45_4
			var_45_4 = var_45_4.rarity2Frame(var_45_2:getRarity())
			setImageSprite = var_14

			local var_45_6 = var_45_5
			local var_45_7 = var_45_5.Find(var_45_6, "frame")

			GetSpriteFromAtlas = var_45_6

			var_14(var_45_7, var_45_6("weaponframes", "commander_" .. var_45_4))

			GetImageSpriteFromAtlasAsync = var_14

			local var_45_8 = "CommanderHrz/"

			var_1_10017 = var_45_2

			var_14(var_45_8 .. var_45_2.getPainting(var_1_10017), "", var_45_5:Find("mask/icon"))
		end

		onButton = var_45_4

		local var_45_9 = arg_45_0
		local var_45_10 = var_1_10011

		local function var_45_11()
			local var_46_0 = arg_45_0
			local var_46_1 = var_0.emit

			BossRushFleetSelectMediator = var_2_10002

			var_46_1(var_46_0, var_2_10002.OPEN_COMMANDER_PANEL, arg_45_1)
		...
		var_45_4(var_45_9, var_45_10, var_45_11, var_1_10017)

		onButton = var_45_4

		local var_45_12 = arg_45_0
		local var_45_13 = var_45_5
		...
		local function var_45_14()
			...
			var_47_1(var_47_0, var_2_10002.OPEN_COMMANDER_PANEL, arg_45_1)
		...
		var_45_4(var_45_12, var_45_13, var_45_14, var_1_10017)
	end
