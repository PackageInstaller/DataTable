...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.Atelier.base.AtelierFormulaDetailView"))
...
function var_0_1.InitCustom(arg_1_0)
	...
	local var_1_3 = var_2.Find(var_1_2, "Overlay/compositePanel/backBtn/Text")

	i18n = var_1_2

	var_1(var_1_3, var_1_2("yumia_atelier_tip9"))

	setText = var_1

	local var_1_4 = arg_1_0._tf
	local var_1_5 = var_2.Find(var_1_4, "Overlay/compositePanel/CompositeBtn/Text")

	i18n = var_1_4

	var_1(var_1_5, var_1_4("yumia_atelier_tip18"))

	setText = var_1

	local var_1_6 = arg_1_0._tf
	local var_1_7 = var_2.Find(var_1_6, "Overlay/compositePanel/autoBtn/Text")

	i18n = var_1_6

	var_1(var_1_7, var_1_6("yumia_atelier_tip23"))
	...
	var_1_8(var_1_12, var_1_11(var_4), false)
...
function var_0_1.didEnter(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "Overlay/compositePanel/CompositeBtn")
	...
	local var_2_7 = var_3.Find(var_2_6, "Overlay/compositePanel/backBtn")
	...
	local var_2_11 = var_3.Find(var_2_10, "Overlay/compositePanel/autoBtn")
...
function var_0_1.Show(arg_6_0, arg_6_1)
	...
	if not arg_6_0.nodePools then
		...
		var_6_0.core = var_6_1(var_4.Find(var_6_2, "coreNode").gameObject, 100)

		local var_6_3 = var_0_2.New
		local var_6_4 = arg_6_0._tf

		var_6_0.material = var_6_3(var_4.Find(var_6_4, "materialNode").gameObject, 100)
	...
	if not arg_6_0.pluralRoot then
		pg = var_6_5
		var_6_5 = var_6_5.PoolMgr.GetInstance().root
	end

	arg_6_0.pluralRoot = var_6_5
	...
	arg_6_0.nodeList = var_6_6
	_ = var_6_6

	var_6_6.each(arg_6_0.nodeList, function(arg_8_0)
		...
		if not var_8_4(var_8_3, var_5(arg_8_0.GO)) then
			setParent = var_8_3
			go = var_5

			var_8_3(var_5(arg_8_0.GO), arg_6_0.pluralRoot)

			setActive = var_8_3
			go = var_5

			var_8_3(var_5(arg_8_0.GO), false)
		end
	...
	local var_6_7 = arg_6_0.viewContent

	Vector2 = var_4

	var_2(var_6_7, var_4.zero)

	local var_6_8 = 0

	_ = var_6_7

	var_6_7.each(arg_6_1:GetCircleList(), function(arg_9_0)
		...
		var_9_3(var_5(var_9_4), arg_6_0.viewContent)
	...
	local var_6_9 = arg_6_0.atelierFormulaOverlayView

	var_3.RefreshFormulaInfo(var_6_9, arg_6_1)
...
function var_0_1.UpdateNodeView(arg_10_0, arg_10_1)
	...
	var_10_3(arg_10_1.GO, not var_10_4)
	...
	if var_7.contains(arg_10_0.nodeLayer[1], arg_10_1.ID) then
		-- block empty
	else
		local var_10_6 = var_3

		var_10_7 = var_3.GetType(var_10_6)
		AtelierFormulaCircle = var_10_6

		if var_10_7 == var_10_6.TYPE.NONE then
			arg_10_0:RefreshElement(arg_10_1)
			arg_10_0:HideCategory(arg_10_1)
		else
			AtelierFormulaCircle = var_9

			if var_10_7 == var_9.TYPE.ELEMENT then
				arg_10_0:RefreshElement(arg_10_1)
				arg_10_0:HideCategory(arg_10_1)
			else
				AtelierFormulaCircle = var_9

				if var_10_7 == var_9.TYPE.CATEGORY then
					arg_10_0:RefreshElement(arg_10_1)
					arg_10_0:RefreshCategory(arg_10_1)
				else
					AtelierFormulaCircle = var_9

					if var_10_7 == var_9.TYPE.ELEMENT_CATEGORY then
						arg_10_0:RefreshElement(arg_10_1)
						arg_10_0:RefreshCategory(arg_10_1)
					end
				end
	...
	var_10_7(var_10_8, var_10_9, var_10_10, var_1_10012)
...
function var_0_1.RefreshElement(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_3, var_12_4 .. var_1_10008.ELEMENT_NAME[var_12_2], var_12_0:Find("icon"))

	local var_12_5 = var_12_0
	local var_12_6

	var_12_6, setImageColor = var_12_0.Find(var_12_5, "light"), var_12_5

	local var_12_7 = var_3
	local var_12_8 = var_3.GetElementLightColor

	instance = var_10

	var_12_5(var_12_6, var_12_8(var_12_7, var_10))
...
function var_0_1.RefreshCategory(arg_13_0, arg_13_1)
	...
	if var_3.GetCategory(var_13_1) ~= 0 then
		...
		var_13_1("ui/ateliercommonyumiaui_atlas", "category" .. var_4, var_13_0:Find("categoryBg/category"))
	end

	setActive = var_13_1

	var_13_1(var_13_0:Find("categoryBg"), true)
...
function var_0_1.HideCategory(arg_14_0, arg_14_1)
	...
	var_3(var_14_0:Find("categoryBg"), false)
...
function var_0_1.FillNodeAndPlayAnim(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	...
	if not arg_16_1.ChangeInstance then
		...
		tobool = var_6
		var_16_1 = var_16_1 ~= var_6(arg_16_2)
	end
	...
	var_1_10007({
		function(arg_17_0)
			...
			var_2_10001.ParallelIpairsAsync({
				...
				var_18_0[arg_18_0] = var_4.GetPrefab(var_18_1, arg_18_1, "", function(arg_19_0)
					...
					var_4_10001(var_19_0, var_4_10003(arg_16_1.GO))
					...
					var_4_10001(var_19_1, var_3.zero)
		...
		function(arg_20_0)
			...
			var_20_2(var_20_1, var_3.delayedCall, function()
		...
		function(arg_22_0)
			...
			var_22_1(var_22_0, var_3.delayedCall, function()
				arg_22_0()
...
function var_0_1.InitLine(arg_25_0, arg_25_1)
	...
	local var_25_1 = arg_25_1.GetShapeID(var_25_0)

	ipairs = var_25_0

	for iter_25_0, iter_25_1 in var_25_0(arg_25_0.lineGoList) do
		setActive = var_1_10008

		var_1_10008(iter_25_1, iter_25_0 == var_25_1)
...
function var_0_1.RefreshLine(arg_26_0)
	for iter_26_0 = 0, arg_26_0.lineGo.childCount - 1 do
		...
		var_1_10005(var_6.GetChild(var_26_0, iter_26_0), iter_26_0 < arg_26_0.unLockLayerIndex - 1)
	end
...
function var_0_1.RefreshScrollViewPosition(arg_28_0)
	if arg_28_0.nodeList[1].Instance == nil then
		...
		var_1(var_28_0, var_1_10003.zero)
		...
		var_1(var_28_1, var_1_10003.zero)
		...
		var_1(var_28_4, var_1_10003("yumia_atelier_tip7"))
	else
		...
		var_1(var_28_5, var_1_10003("yumia_atelier_tip17"))
	end
...
function var_0_1.AddStarList(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in var_5(var_2:GetStarList()) do
		if iter_32_0 <= var_32_3.childCount then
			var_1_10011 = var_32_3

			local var_32_4

			if not var_32_3.GetChild(var_1_10011, iter_32_0 - 1) then
				cloneTplTo = var_32_4
			...
			var_1_10011(var_32_5, var_13(var_1_10014(iter_32_1)))
		end
	end
...
function var_0_1.PlayStarAnimation(arg_33_0, arg_33_1)
	...
	for iter_33_0 = 0, var_33_3.childCount - 1 do
		...
		var_1_10011 = var_1_10011.moveLocal

		local var_33_6
		local var_33_7 = var_33_3
		local var_33_8 = var_33_3.GetChild(var_33_7, iter_33_0).gameObject

		Vector3 = var_33_7

		var_33_5(var_33_4, var_1_10011, var_33_6, var_33_8, var_33_7.zero, 0.5)
	end

	local var_33_9 = arg_33_0._parentClass
	local var_33_10 = var_5.managedTween

	LeanTween = var_7

	var_33_10(var_33_9, var_7.delayedCall, function()
...
function var_0_1.ShowNodeLight(arg_36_0, arg_36_1)
	...
	var_2(var_3.Find(var_36_1, "light"), true)
...
function var_0_1.HideNodeLight(arg_37_0, arg_37_1)
	...
	var_1_10002(var_3.Find(var_37_0, "light"), false)
...
function var_0_1.SetCirclePanel(arg_40_0)
	...
	var_2(var_40_1, (var_40_2 + var_1_10005.New(var_40_0, var_40_0)) * 2)
...
function var_0_1.SetCirclePosition(arg_41_0)
	...
	var_1_10003.each(arg_41_0.nodeList, function(arg_42_0)
		...
		local var_42_2 = var_42_0(var_42_1[2], var_42_1[3])

		setAnchoredPosition = var_4

		var_4(arg_42_0.GO, var_42_2)

		math = var_4

		local var_42_3 = var_4.max
		local var_42_4 = var_41_0

		math = var_6
		var_41_0 = var_42_3(var_42_4, var_6.abs(var_42_1[2]))
		math = var_4
		...
		math = var_6
		var_41_1 = var_42_5(var_42_6, var_6.abs(var_42_1[3]))
