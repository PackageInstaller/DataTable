...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.Manual, function()
		...
		local var_4_3 = var_2_10003.WORLD_COLLECTION
		local var_4_4 = {}

		WorldMediaCollectionScene = var_2_10005
		var_4_4.page = var_2_10005.PAGE_ALBUM
...
function var_0_1.updateUI(arg_7_0)
	...
	local var_7_3, var_7_4 = var_7_2(var_7_1, var_1_10004.shop_template[var_0_2].time)
	local var_7_5
	...
	if var_7_4 then
		...
		var_1_10007 = var_0_1
		var_7_5 = var_6.skinCommdityTimeStamps(var_1_10007, var_7_7)
	end
	...
	local var_7_10, var_7_11 = var_7_9(var_7_8, var_1_10007.activity_template[var_0_4].time)
	local var_7_12 = 0
	local var_7_14
		...
		shop = function(arg_8_0)
			...
			var_2_10001(arg_7_0, arg_8_0, function()
				if var_7_5 == nil then
					...
					var_9_1(var_9_0, var_3_10002("common_activity_end"))
				...
				var_9_3(var_9_2, var_3_10002.GO_CHANGE_SHOP)
		...
		build = function(arg_10_0)
			...
			var_2_10001(arg_7_0, arg_10_0, function()
				if var_7_12 == nil then
					...
					var_11_1(var_11_0, var_3_10002("common_activity_end"))
				...
				local var_11_4 = var_3_10002.EVENT_GO_SCENE

				SCENE = var_3_10003

				local var_11_5 = var_3_10003.GETBOAT
				local var_11_6 = {}

				BuildShipScene = var_3_10005
				var_11_6.page = var_3_10005.PAGE_BUILD
				BuildShipScene = var_5
				var_11_6.projectName = var_5.PROJECTS.ACTIVITY
...
function var_0_1.skinCommdityTimeStamps(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_14_0.max(arg_14_1 - var_14_1, 0)

	math = var_4

	local var_14_3 = var_4.floor(var_14_2 / 0)
	...
	if 0 < var_14_3 then
		...
		if 0 < var_14_4 then
			...
			return var_14_5 .. var_14_6 .. var_1_10008("word_hour")
		else
			math = var_14_5
			...
			if 0 < var_14_7 then
				...
				return var_14_8 .. var_14_9 .. var_1_10009("word_minute")
			else
				i18n = var_14_8
				...
				return var_14_10 .. var_14_11 .. var_1_10009("word_second")
			end
		end
	end
