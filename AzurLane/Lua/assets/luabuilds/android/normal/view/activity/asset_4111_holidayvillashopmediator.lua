...
function var_0_1.register(arg_1_0)
	...
	local var_1_3 = var_3(var_1_10004)

	var_1_2(var_1_1, var_3.getData(var_1_3))
	arg_1_0:bind(var_0_1.OPEN_GOODS_WINDOW, function(arg_2_0, arg_2_1)
		...
		HolidayVillaShopWindowMediator = var_2_10006
		var_2_3.mediator = var_2_10006
		HolidayVillaShopWindowLayer = var_2_10006
...
function var_0_1.initNotificationHandleDic(arg_3_0)
	...
	var_3_0[var_1_10002.ISLAND_SHOPPING_DONE] = function(arg_4_0, arg_4_1)
		...
		if #var_4_0.awards > 0 then
			...
			var_4.insert(var_4_1, function(arg_5_0)
				...
				var_5_1(var_5_0, var_3_10003.ON_ACHIEVE, var_4_0.awards, arg_5_0)
		...
		local var_4_5 = var_6(var_2_10007)

		var_4_4(var_4_3, var_6.getData(var_4_5))
	...
	var_3_0[var_2.USE_ITEM_DONE] = function(arg_7_0, arg_7_1)
		if #arg_7_1:getBody().drops > 0 then
			...
			var_7_1(var_7_0, var_2_10005.ON_ACHIEVE, var_2)
		end
