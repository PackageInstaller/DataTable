...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_10 = var_2.Find(var_1_9, "heart")
	local var_1_11 = arg_1_0.AD

	arg_1_0.hearts = var_1_8(var_1_10, var_3.Find(var_1_11, "heart/1"))
...
function var_0_1.InitLocal(arg_4_0)
	...
	var_1(var_4_0, var_3("doa3_activityPageUI_7"))
	...
	var_1(var_4_1, var_3("doa3_activityPageUI_6"))
...
function var_0_1.UpdateBtnGroup(arg_7_0)
	...
	var_7_4(arg_7_0.battleBtn, var_7_5 and not var_7_1 and var_7_3)

	setActive = var_7_4

	var_7_4(arg_7_0.getBtn, var_7_1)

	setActive = var_7_4

	var_7_4(arg_7_0.gotBtn, not var_7_3)
...
function var_0_1.UpdateAward(arg_10_0)
	...
	var_10_0(arg_10_0.awardTF, var_10_1)
	...
	local function var_10_4()
		...
		var_11_1(var_11_0, var_2_10002.ON_DROP, var_10_1)
