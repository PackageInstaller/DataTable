...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.timeAnim = var_2_8(var_2_7, var_3(var_1_10004))
	...
	typeof = var_3
	Animation = var_1_10004
	arg_2_0.anim = var_2_10(var_2_9, var_3(var_1_10004))
	...
	arg_2_0.animEvent = var_2_12(var_2_11, var_3(var_1_10004))
...
function var_0_1.ShowAnim(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	local var_5_4 = var_5_1.GetType(var_5_3)

	LinerTime = var_5_3

	local var_5_5

	if var_5_4 ~= var_5_3.TYPE.STORY or not (var_5_0 - 1) then
		var_5_5 = var_5_0
	end
	...
	var_9(var_5_6, var_1_10011.format("%02d", var_5_5))
	...
	var_9(var_5_7, var_11.format("%02d", var_5_5))
	...
	local var_5_9 = var_5_2:GetTime()[1]
	...
	local var_5_16 = var_17.floor(var_5_14 * 180 / 19)
	...
	var_18({
		function(arg_6_0)
			...
			var_6_1(var_6_0, var_2_10003.delayedCall, function()
				arg_6_0()
		...
		function(arg_8_0)
			if var_5_15 > var_5_16 then
				...
				var_8_1(var_8_0, var_2_10003.delayedCall, function()
					...
					var_0(var_9_0, var_2.format("%02d", var_5_0))

					setText = var_0

					local var_9_1 = arg_5_0.pointAfterTF
					local var_9_2 = var_5_2

					var_0(var_9_1, var_2.GetStartTimeDesc(var_9_2))
				...
				local var_8_4 = var_2_10003.value
				local var_8_5

				go = var_2_10005

				local var_8_6 = var_8_3(var_8_2, var_8_4, var_8_5, var_2_10005(arg_5_0.rotateTF), var_5_15, var_5_16, var_0_1.ANIM_TIME)
				...
				local var_8_10 = var_8_9(var_8_8, var_3.easeInOutCubic)
				local var_8_11 = var_1.setOnComplete

				System = var_3

				var_8_11(var_8_10, var_3.Action(function()
					arg_8_0()
				...
				var_8_11(var_8_12, var_3.format("%02d", var_5_0))

				setText = var_8_11

				local var_8_13 = arg_5_0.pointAfterTF
				local var_8_14 = var_5_2

				var_8_11(var_8_13, var_3.GetStartTimeDesc(var_8_14))
		...
		function(arg_12_0)
			...
			var_12_1(var_12_0, var_2_10003.delayedCall, function()
				arg_12_0()
