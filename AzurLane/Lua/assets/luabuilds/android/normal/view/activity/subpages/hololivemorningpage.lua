...
function var_0_1.OnInit(arg_1_0)
	...
	local function var_1_6()
		...
		var_2_1(var_2_0, var_2_10002.EVENT_OPERATION, {
			cmd = 1,
	...
	local function var_1_9()
		...
		pg = var_2_10003
		var_3_2.helps = var_2_10003.gametip.hololive_goodmorning.tip
	...
	var_1(var_1_7, var_1_8, var_1_9, var_1_10005)
...
function var_0_1.OnDataSetting(arg_4_0)
	...
	local var_4_4 = var_1_10004.TimeMgr.GetInstance()
	local var_4_5 = var_4_2(var_4_1, var_4_3, var_4.GetServerTime(var_4_4)) + 1

	math = var_4_1
	arg_4_0.maxday = var_4_1.clamp(var_4_5, 1, arg_4_0.configData.total_num)
	print = var_2
	...
	local var_4_7 = var_4(arg_4_0.maxday)

	tostring = var_5

	local var_4_8 = var_5(arg_4_0.isGotFinalAward)

	tostring = var_6

	local var_4_9 = var_6(arg_4_0.progressStep)

	tostring = var_7

	var_2(var_4_6, var_4_7, var_4_8, var_4_9, var_7(arg_4_0.activity.data4))
...
function var_0_1.OnUpdateFlush(arg_6_0)
	if arg_6_0.curIndex == 0 and arg_6_0.activity.data4 > 0 then
		...
		var_1_10003 = var_1_10003(arg_6_0.curShipGroupID)
		tostring = var_4

		local var_6_1 = var_4(arg_6_0.curIndex)

		tostring = var_5

		var_1(var_6_0, var_1_10003, var_6_1, var_5(arg_6_0.curStoryID))
		arg_6_0:rotate()
	elseif arg_6_0.activity.data4 > 0 then
		if arg_6_0.activity.data4 <= arg_6_0.groupNum then
			...
			local var_6_2 = "direct update"

			tostring = var_1_10003

			local var_6_3 = var_1_10003(arg_6_0.curShipGroupID)

			tostring = var_4

			local var_6_4 = var_4(arg_6_0.curIndex)

			tostring = var_5

			var_1(var_6_2, var_6_3, var_6_4, var_5(arg_6_0.curStoryID))
...
function var_0_1.onDestroy(arg_7_0)
	...
	var_7_0(var_1_10002(arg_7_0.circleTF))
...
function var_0_1.rotate(arg_8_0)
	...
	local var_8_2 = var_8_0.activity_event_turning[var_8_1]
	local var_8_3 = {
		6,
		0,
		4,
	...
	local var_8_8 = var_8_7(var_1_10010(arg_8_0.circleTF), 0, var_8_6, var_8_4)
	local var_8_9 = var_9.setEase

	LeanTweenType = var_11

	local var_8_10 = var_8_9(var_8_8, var_11.easeInOutCirc)
	local var_8_11 = var_9.setOnUpdate

	System = var_11

	local var_8_12 = var_8_11(var_8_10, var_11.Action_float(function(arg_9_0)
	...
	var_8_13(var_8_12, var_11.Action(function()
		pg = var_2_10000
...
function var_0_1.updateTaskPanel(arg_12_0)
	...
	var_2("ui/activityuipage/hololivemorningpage", var_12_8, function(arg_13_0)
		if arg_12_0.curShipGroupID == 17 then
			...
			Vector2 = var_2
			var_13_0.sizeDelta = var_2(1058, 714)
		...
		elseif arg_12_0.curShipGroupID == 19 then
			...
			Vector2 = var_2
			var_13_1.sizeDelta = var_2(1122, 714)
			...
			if arg_12_0.curShipGroupID == 21 then
				...
				Vector2 = var_2
				var_13_2.sizeDelta = var_2(1044, 714)
	...
	var_3.make(var_12_10, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			if not var_6.getTaskById(var_15_3, var_15_2) then
				var_15_3 = arg_12_0.taskProxy
				var_15_4 = var_6.getFinishTaskById(var_15_3, var_15_2)
			end

			assert = var_15_3

			var_15_3(var_15_4, "without this task by id: " .. var_15_2)

			local var_15_5 = var_15_4:getConfig("award_display")[1]
			local var_15_6 = {
				type = var_15_5[1],
				id = var_15_5[2],
				count = var_15_5[3]
			...
			var_9(var_15_1, var_15_6)

			onButton = var_9

			local var_15_7 = arg_12_0
			...
			local function var_15_9()
				...
				var_16_1(var_16_0, var_3_10002.ON_DROP, var_15_6)
			...
			var_9(var_15_7, var_15_8, var_15_9, var_2_10013)

			local var_15_10 = var_15_4:getProgress()
			local var_15_11 = var_15_4
			local var_15_12 = var_15_4.getConfig(var_15_11, "target_num")

			setText = var_15_11

			var_15_11(arg_15_2:Find("description"), var_15_4:getConfig("desc") .. "(" .. var_15_10 .. "/" .. var_15_12 .. ")")

			setSlider = var_15_11

			var_15_11(arg_15_2:Find("progress"), 0, var_15_12, var_15_10)

			local var_15_13 = arg_15_2:Find("go_btn")
			local var_15_14 = arg_15_2:Find("get_btn")
			local var_15_15 = arg_15_2:Find("got_btn")
			local var_15_16 = var_15_4
			local var_15_17 = var_15_4.getTaskStatus(var_15_16)

			setActive = var_15_16

			var_15_16(var_15_13, var_15_17 == 0)

			setActive = var_15_16

			var_15_16(var_15_14, var_15_17 == 1)

			setActive = var_15_16

			var_15_16(var_15_15, var_15_17 == 2)

			onButton = var_15_16

			local var_15_18 = arg_12_0
			local var_15_19 = var_15_13
			...
			local function var_15_20()
				...
				var_17_1(var_17_0, var_3_10002.ON_TASK_GO, var_15_4)
			...
			var_15_16(var_15_18, var_15_19, var_15_20, var_2_10019)

			onButton = var_15_16

			local var_15_21 = arg_12_0
			local var_15_22 = var_15_14
			...
			local function var_15_23()
				...
				var_18_1(var_18_0, var_3_10002.ON_TASK_SUBMIT, var_15_4)
			...
			var_15_16(var_15_21, var_15_22, var_15_23, var_2_10019)
		end
	...
	for iter_12_0, iter_12_1 in var_12_11(arg_12_0.curTaskIDList) do
	...
	if var_12_12 then
		...
		local var_12_17 = var_12_15.activity_event_turning[var_12_16].story_task[arg_12_0.progressStep][1]

		print = var_7
		iter_12_1 = "story"
		tostring = var_1_10009

		var_7(iter_12_1, var_1_10009(var_12_17))

		if var_12_17 then
			pg = var_7
			iter_12_1 = var_7.NewStoryMgr.GetInstance()

			var_7.Play(iter_12_1, var_12_17, nil)
		end
	end
	...
	if var_12_12 then
		...
		var_4(var_12_18, var_6(arg_12_0.maxday - arg_12_0.progressStep))
	end
	...
	SFX_CANCEL = iter_12_1

	var_4(var_12_19, var_12_20, var_12_21, iter_12_1)
	...
	local function var_12_24()
		...
		pg = var_2_10003
		var_20_2.helps = var_2_10003.gametip.hololive_goodmorning.tip
	...
	var_4(var_12_22, var_12_23, var_12_24, iter_12_1)
	...
	if arg_21_0.isGotFinalAward == 0 and arg_21_0.progressStep == arg_21_0.groupNum then
		if arg_21_0.curTaskIDList then
			...
			if var_21_0 and arg_21_0.activity.data4 ~= 0 and arg_21_0.activity.data3 == arg_21_0.groupNum then
				...
				var_21_4(var_1_10003, var_4.EVENT_OPERATION, {
					cmd = 2,
			...
			var_21_6(var_21_5, var_1_10003.EVENT_OPERATION, {
				cmd = 1,
				activity_id = arg_21_0.activity.id
			})
		end
...
function var_0_1.resetIndex(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10003.EVENT_OPERATION, {
		cmd = 2,
