...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	var_1.GetSpineChar(var_1_0, "xiaotiane_2", false, function(arg_2_0)
		...
		var_2_2(var_2_1, var_3.Find(var_2_3, "char"), false)
		...
		local var_2_6 = var_2_5(var_2_4, var_3(var_4))
...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	var_1(var_3_0, var_3_1, var_4.Find(var_3_2, "day1"))

	setText = var_1

	local var_3_3 = arg_3_0.bg

	var_1(var_2.Find(var_3_3, "progress"), "進度:" .. arg_3_0.nday .. "/10")
