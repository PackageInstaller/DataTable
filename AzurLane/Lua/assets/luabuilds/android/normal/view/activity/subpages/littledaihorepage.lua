...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_8()
		...
		i18n = var_2_10003
		var_9_2.helps = var_2_10003("littleTaihou_npc")
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	var_10_1(var_10_0, var_3.GetLevel(var_10_2))
	...
	if 1 <= var_10_6 then
		...
		if not var_6(var_10_4, "#9F413AFF") then
			var_10_8 = var_10_4
		end

		var_10_2(var_10_7, var_10_8 .. "/" .. var_10_5)
