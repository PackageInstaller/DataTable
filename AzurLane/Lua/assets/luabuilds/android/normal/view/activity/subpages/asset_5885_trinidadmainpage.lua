...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.Manual, function()
		...
		TowerRoseMedalAlbumView = var_2_10002
...
function var_0_1.TimeStamps(arg_10_0, arg_10_1)
	...
	if 0 < var_10_3 then
		...
		if 0 < var_10_4 then
			...
			return var_10_5 .. var_10_6 .. var_1_10008("word_hour")
		else
			math = var_10_5
			...
			if 0 < var_10_7 then
				...
				return var_10_8 .. var_10_9 .. var_1_10009("word_minute")
			else
				i18n = var_10_8
				...
				return var_10_10 .. var_10_11 .. var_1_10009("word_second")
			end
		end
	end
