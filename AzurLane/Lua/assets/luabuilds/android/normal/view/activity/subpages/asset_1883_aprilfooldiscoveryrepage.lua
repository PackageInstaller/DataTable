...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".AprilFoolDiscoveryPage"))
...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_4, var_1_3("super_bulin_tip"))
...
function var_0_1.OnDataSetting(arg_5_0)
	...
	local function var_5_1()
		if arg_5_0.activity.data1 == 1 and arg_5_0.activity.data3 == 1 then
			...
			var_6_2(var_6_1, var_2_10002.PUZZLE_PIECE_OP, {
				cmd = 4,
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_2(var_7_1, var_4.format("keyList has {0}, but items has 9", #arg_7_0.keyList))
	...
	local function var_7_4()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip.bulin_help.tip
	...
	var_2(var_7_2, var_7_3, var_7_4, var_6)
	...
	local function var_7_8()
		if #arg_7_0.activity.data2_list < #arg_7_0.keyList then
			...
			var_9_1(var_9_0, var_2_10002("common_activity_not_start"))
		...
		var_9_3(var_9_2, var_2_10002.ON_SIMULATION_COMBAT, {
	...
	var_7_2(var_7_6, var_7_7, var_7_8, var_1_10007)

	onButton = var_7_2

	var_7_2(arg_7_0, arg_7_0.bulin, function()
		if arg_7_0.activity.data1 >= 1 then
			...
			var_0({
				function(arg_12_0)
					...
					i18n = var_3_10004
					var_12_2.content = var_3_10004("super_bulin")
				...
				function(arg_13_0)
					...
					local var_13_2 = var_3_10003.ON_SIMULATION_COMBAT
					local var_13_3 = {
						warnMsg = "bulin_tip_other3"
					}
					local var_13_4 = arg_7_0

					var_13_3.stageId = var_5.GetLinkStage(var_13_4)

					var_13_1(var_13_0, var_13_2, var_13_3, function()
						getProxy = var_4_10000
						ActivityProxy = var_4_10001

						local var_14_0 = var_4_10000(var_4_10001)
...
function var_0_1.OnUpdateFlush(arg_16_0)
	...
	if (var_16_0 and "activity_bg_aprilfool_final" or "activity_bg_aprilfool_discovery") ~= arg_16_0.bgName then
		...
		local var_16_2 = arg_16_0.bg

		LoadSprite = var_1_10006

		var_4(var_16_2, var_1_10006("ui/activityuipage/AprilFoolDiscoveryRePage_atlas", var_3))

		local var_16_3 = arg_16_0.bg
		local var_16_4 = var_4.GetComponent

		typeof = var_1_10006
		Image = var_7
		var_16_4(var_16_3, var_1_10006(var_7)).enabled = true
		arg_16_0.bgName = var_3
	end

	local var_16_5 = arg_16_0.activity.data2_list
	local var_16_6 = arg_16_0.activity.data3_list

	ipairs = var_1_10006

	for iter_16_0, iter_16_1 in var_1_10006(arg_16_0.items) do
		local var_16_7 = arg_16_0.keyList[iter_16_0]

		table = var_1_10012

		if var_1_10012.contains(var_16_5, var_16_7) then
			var_1_10012 = 3
		else
			table = var_1_10012
			var_1_10012 = var_1_10012.contains(var_16_6, var_16_7) and 2 or 1
		end

		onButton = var_13

		var_13(arg_16_0, iter_16_1, function()
			...
			elseif var_1_10012 == 1 then
				...
				if var_0.GetServerTime(var_17_1) < arg_16_0.activity.data2 then
					...
					var_17_3(var_17_2, var_2_10002("bulin_tip_other2"))
				...
				i18n = var_2_10003
				var_17_6.content = var_2_10003("bulin_tip_other1")
				...
				function var_17_6.onYes()
					...
					var_18_1(var_18_0, var_3_10002.PUZZLE_PIECE_OP, {
						cmd = 3,
		...
		local var_16_8 = arg_16_0.loader

		var_13.GetSprite(var_16_8, "UI/ActivityUIPage/AprilFoolDiscoveryRePage_atlas", var_0_2[var_1_10012], iter_16_1:Find("state"))

		setActive = var_13

		var_13(iter_16_1:Find("character"), var_1_10012 == 3)
	end
	...
	if arg_16_0.activity.data1 == 1 then
		local var_16_9 = arg_16_0.activity
		local var_16_10 = var_6.getConfig(var_16_9, "config_client").popStory
		...
		arg_16_0:AddFunc(function(arg_19_0)
			...
			var_1.Play(var_19_0, var_16_10, arg_19_0)
		...
		arg_16_0:AddFunc(function(arg_20_0)
			...
			if var_20_0.GetInt("SuperBurinPopUp_" .. var_20_1.id, 0) == 0 then
				LoadContextCommand = var_3

				local var_20_2 = var_3.LoadLayerOnTopContext

				Context = var_4

				local var_20_3 = var_4.New
				local var_20_4 = {}

				SuperBulinPopMediator = var_2_10006
				var_20_4.mediator = var_2_10006
				SuperBulinPopView = var_2_10006
				var_20_4.viewComponent = var_2_10006

				local var_20_5 = {}
				local var_20_6 = arg_16_0

				var_20_5.stageId = var_7.GetLinkStage(var_20_6)
