...
function var_0_0.DoCheck(arg_7_0, arg_7_1)
	...
	if var_4(var_7_0).y + var_7_0.rect.height + arg_7_0.list[arg_7_1 + 1].rect.height - arg_7_0.tr.rect.height >= 50 then
		...
		typeof = var_1_10008
		Image = var_1_10009
		var_7_3 = var_7_3(var_7_2, var_1_10008(var_1_10009))
		var_1_10008 = arg_7_0

		local var_7_4 = arg_7_0.GetBg(var_1_10008, arg_7_1 + 2)

		if arg_7_0.names[var_7_1] ~= var_7_4 then
			var_1_10009 = arg_7_0

			arg_7_0.LoadImage(var_1_10009, var_7_4, function(arg_8_0)
			...
			arg_7_0.LoadEffect(var_1_10009, var_7_4, var_7_1)

			var_1_10008 = arg_7_0.names
			var_1_10008[var_7_1] = var_7_4
		end
	end
	...
	if var_7_3.abs(var_4.y) >= var_7_0.rect.height then
		...
		typeof = var_1_10008
		Image = var_1_10009
		var_7_6(var_7_5, var_1_10008(var_1_10009)).sprite = nil
...
function var_0_0.ReturnEffect(arg_14_0, arg_14_1)
	if arg_14_1.childCount > 0 then
		...
		local var_14_1 = arg_14_1.GetChild(var_14_0, 0)

		PoolMgr = var_14_0

		local var_14_2 = var_14_0.GetInstance()

		var_4.ReturnUI(var_14_2, var_14_1.name, var_14_1.gameObject)
	end
...
function var_0_0.Clear(arg_15_0)
	...
	var_1_10001(arg_15_0.tr, function(arg_16_0)
		...
		typeof = var_2_10003
		Image = var_2_10004
		var_16_1(var_16_0, var_2_10003(var_2_10004)).sprite = nil
