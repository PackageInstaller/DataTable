...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		pg = var_2_10003
		var_3_2.helps = var_2_10003.gametip.crossroad_minigame_help.tip
	...
	for iter_2_0 = 1, 7 do
		...
		var_2_8(var_1_10010(var_1_10007, "ad/desc"), "DAY" .. var_1_10008)
...
function var_0_1.setChildVisible(arg_7_0, arg_7_1, arg_7_2)
	for iter_7_0 = 1, arg_7_1.childCount do
		...
		local var_7_1 = arg_7_1.GetChild(var_7_0, iter_7_0 - 1)

		setActive = var_7_0

		var_7_0(var_7_1, arg_7_2)
	end
