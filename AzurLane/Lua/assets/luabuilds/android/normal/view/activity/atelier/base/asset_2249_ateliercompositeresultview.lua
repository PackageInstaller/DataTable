...
function var_0_1.Init(arg_2_0)
	...
	local var_2_1 = var_2.Find(var_2_0, "Window/CountBG/Tip")

	i18n = var_2_0

	var_1_10001(var_2_1, var_2_0("ryza_composite_count"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "BG")
...
function var_0_1.ShowCompositeResult(arg_7_0, arg_7_1)
	...
	var_7_2(var_7_1, var_5.Find(var_7_3, "Window/Icon"), var_2)

	setScrollText = var_7_2

	local var_7_4 = arg_7_0._tf

	var_7_2(var_4.Find(var_7_4, "Window/NameBG/Rect/Name"), var_2:getName())

	setText = var_7_2

	local var_7_5 = arg_7_0._tf

	var_7_2(var_4.Find(var_7_5, "Window/CountBG/Text"), var_2.count)
