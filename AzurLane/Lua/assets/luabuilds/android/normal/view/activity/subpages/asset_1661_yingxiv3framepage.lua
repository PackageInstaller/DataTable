...
function var_0_1.Switch(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10004(var_2_2, var_1_10006(var_1_10007))
	...
	local var_2_7 = var_2_6(var_8(var_2_0), 0, 1, 0.4)
	local var_2_8 = var_7.setOnUpdate

	System = var_9

	var_2_8(var_2_7, var_9.Action_float(function(arg_3_0)
	...
	local var_2_10 = var_2_8(var_2_9, var_9(var_10))

	LeanTween = var_2_9

	local var_2_11 = var_2_9.value

	go = var_9

	local var_2_12 = var_2_11(var_9(var_2_1), 0, 1, 0.4)
	local var_2_13 = var_8.setOnUpdate

	System = var_10

	var_2_13(var_2_12, var_10.Action_float(function(arg_4_0)
	...
	var_2_13(var_9(var_2_1), var_2_4)
