...
function var_0_1.AddTogglesListener(arg_8_0)
	...
	local var_8_1 = arg_8_0.GetTogglesDropTypes(var_8_0)

	assert = var_8_0

	var_8_0(#var_8_1 == arg_8_0.togglesTF.childCount, "dropType数量与togglesTF子节点数不匹配")

	ipairs = var_8_0

	for iter_8_0, iter_8_1 in var_8_0(var_8_1) do
		local var_8_2 = arg_8_0.togglesTF
		local var_8_3 = var_7.Find(var_8_2, var_0_1.DropType2Name[iter_8_1])
		...
		var_8_2(var_8_4, var_8_5, var_8_6, var_1_10012)

		arg_8_0.toggles[iter_8_1] = var_8_3
	end
...
function var_0_1.AddSpecialBtnListener(arg_10_0)
	...
	if arg_10_0.furnitureThemeBtn and var_10_1.furniture_theme_link then
		...
		var_2(var_10_3, var_10_4, var_10_5, var_1_10006)
	end
	...
	if arg_10_0.medalBtn and var_10_1.medal_link then
		...
		var_2(var_10_7, var_10_8, var_10_9, var_1_10006)
	end
	...
	if arg_10_0.equipSkinBoxBtn and var_10_1.equipskin_box_link then
		...
		local function var_10_15()
			...
			var_13_2.show_type = var_2_10003.SHOW_TYPE_NORMAL
		...
		var_10_11(var_10_13, var_10_14, var_10_15, var_1_10007)
	end
...
function var_0_1.OnUpdateItem(arg_14_0, arg_14_1, arg_14_2)
	...
	var_6(var_14_3, var_14_4, var_14_5, var_1_10010)

	changeToScrollText = var_6

	local var_14_6 = arg_14_2
	local var_14_7 = arg_14_2.Find(var_14_6, "name_mask/name")

	Drop = var_14_6

	local var_14_8 = var_14_6.New({
		type = var_14_0.config.type,
		id = var_14_0.config.drop_id
	})

	var_6(var_14_7, var_8.getName(var_14_8))
	...
	local var_14_10 = arg_14_2.Find(var_14_9, "owner")

	typeof = var_14_9
	CanvasGroup = var_9
	var_6(var_14_10, var_14_9(var_9)).alpha = var_14_0.count == var_14_0.config.count and 0.5 or 1
	setActive = var_7
...
function var_0_1.OnClickItem(arg_16_0, arg_16_1)
	...
	MSGBOX_TYPE_LIKN_COLLECT_GUIDE = var_1_10005
	var_16_2.type = var_1_10005
	Msgbox4LinkCollectGuide = var_1_10005
	var_16_2.show_type = var_1_10005.SHOW_TYPE_LIMIT
...
function var_0_1.DoSkip(arg_21_0, arg_21_1, arg_21_2)
	if arg_21_1 == 2 then
		...
		var_1_10003(var_21_0, var_1_10005, var_1_10006, var_21_1)
	elseif arg_21_1 == 3 then
		...
		local var_21_4 = var_1_10005.GO_SCENE

		SCENE = var_1_10006

		var_21_3(var_21_2, var_21_4, var_1_10006.ACTIVITY, {
			id = arg_21_2
		})
	end
