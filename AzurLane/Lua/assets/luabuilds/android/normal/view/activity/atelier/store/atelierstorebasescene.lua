...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.storehouseRect = var_1_10001(var_2.Find(var_2_0, "Window/ScrollView"), "LScrollRect")
...
function var_0_1.InitCustom(arg_3_0)
	...
	local var_3_1 = var_2.Find(var_3_0, "Window/Empty")

	i18n = var_3_0

	var_1_10001(var_3_1, var_3_0("ryza_tip_no_item"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "Window/Close")
...
function var_0_1.ShowStoreHouseWindow(arg_7_0)
	...
	local var_7_5 = var_7_2(var_7_3(var_4.GetItems(var_7_4)), function(arg_8_0)
		return arg_8_0.count > 0 and arg_8_0:GetVersion() == var_7_0 and arg_8_0:IsShow() ~= 0
	end)

	table = var_3

	var_3.sort(var_7_5, function(arg_9_0, arg_9_1)
	...
	var_3(var_4.Find(var_7_6, "Window/Empty"), #var_7_5 == 0)

	setActive = var_3

	local var_7_7 = arg_7_0._tf

	var_3(var_4.Find(var_7_7, "Window/ScrollView"), #var_7_5 > 0)
	...
	function arg_7_0.storehouseRect.onUpdateItem(arg_10_0, arg_10_1)
		...
		var_4(var_10_0:Find("NameBG/Rect/Name"), var_10_1:GetName())
...
function var_0_1.UpdateRyzaItem(arg_12_0, arg_12_1, arg_12_2)
	...
	CustomIndexLayer = var_12_1

	local var_12_3 = var_12_1.Clone2Full(arg_12_1:Find("List"), #var_12_2)

	ipairs = var_6

	for iter_12_0, iter_12_1 in var_6(var_12_3) do
		GetImageSpriteFromAtlasAsync = var_1_10011

		local var_12_4 = "ui/AtelierCommonUI_atlas"
		local var_12_5 = "element_"

		AtelierFormulaCircle = var_1_10014

		var_1_10011(var_12_4, var_12_5 .. var_1_10014.ELEMENT_NAME[var_12_2[iter_12_0]], iter_12_1)
	end
...
function var_0_1.ShowItemDetail(arg_13_0, arg_13_1)
	...
	var_13_1(var_13_0, var_1_10004.SHOW_DETAIL, arg_13_1)
