...
function var_0_1.OnUpdateFlush(arg_4_0)
	...
	var_1(var_4_0, var_1_10003("littleyunxian_tip1"))
	...
	var_1(var_4_1, var_3("littleyunxian_tip2"))
	...
	local var_4_11 = var_1_10009(var_4_3, "#b9aef8")
	local var_4_12 = " / "

	setColorStr = var_11

	var_1_10007(var_4_10, var_4_11 .. var_4_12 .. var_11(var_4_4, "#666176"))
	...
	if 1 <= var_4_9 then
		...
		if not var_4_15(var_4_14, var_11) then
			setColorStr = var_4_15
		...
		var_1_10007(var_4_13, var_4_15 .. var_4_16 .. var_11(var_4_8, "#666176"))
		...
		if arg_4_0.firstSliderInit then
			...
			typeof = var_9
			Slider = var_4_16
			var_4_17 = var_4_17(var_4_18, var_9(var_4_16)).value
			...
			local var_4_20 = var_4_19(var_9(arg_4_0.slider), var_4_17, var_4_9, 1)
			local var_4_21 = var_8.setOnUpdate

			System = var_10

			var_4_21(var_4_20, var_10.Action_float(function(arg_5_0)
...
function var_0_1.updateTaskList(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	if arg_12_4.subType ~= 33 then
		...
		local var_12_10 = var_17(var_12_1, "#b1a2d3")
		local var_12_11 = "/"

		setColorStr = var_19

		var_15(var_12_9, var_12_10 .. var_12_11 .. var_19(var_12_0, "#b1a2d3"))
	else
		setText = var_15
		findTF = var_12_9
