...
local var_0_0 = "SpringFestival2026SkinMagazinePage"
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local var_4_20 = arg_4_0.activity

	if var_3.getConfig(var_4_20, "config_client").firstStory then
		pg = var_4_20

		local var_4_21 = var_4_20.NewStoryMgr.GetInstance()

		var_4.Play(var_4_21, var_3)
	end
