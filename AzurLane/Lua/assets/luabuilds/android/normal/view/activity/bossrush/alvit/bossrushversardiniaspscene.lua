...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2.Find(var_2_1, "Battle/Nodes"), function(arg_3_0, arg_3_1)
	...
	for iter_2_0 = 1, arg_2_0.rtStoryItems.childCount do
		...
		local var_2_6 = var_2_5(var_2_4, var_1_10008(var_1_10009))
		local var_2_7
		...
		local var_2_8 = var_5.Find(var_1_10008, "close")

		var_1_10008 = iter_2_0 == arg_2_0.index and 0 or 1

		var_2_6(var_2_8, var_1_10008)

		setText = var_2_6
		var_1_10008 = var_5

		local var_2_9 = var_5.Find(var_1_10008, "get/Text")

		i18n = var_1_10008

		var_2_6(var_2_9, var_1_10008("SardiniaSPCoreActivityUI_unlock"))
		...
		var_2_6(var_2_10, var_1_10008, var_1_10009, var_1_10010)
	end
...
function var_0_1.SetPtActivity(arg_6_0, arg_6_1)
	...
	var_1_10002(var_6_0, var_4.IsActivityReady(arg_6_0.ptActivity))
...
function var_0_1.SelectItem(arg_9_0, arg_9_1)
	...
	for iter_9_2 = 1, arg_9_0.rtStoryItems.childCount do
		...
		local var_9_4 = var_9_3(var_9_2, var_1_10009(var_1_10010)).preferredWidth

		if iter_9_2 ~= arg_9_1 or not arg_9_0.EXPAND_WIDTH then
			var_1_10009 = arg_9_0.CLOSE_WIDTH
		end

		if var_9_4 ~= var_1_10009 then
			math = var_1_10010
			var_1_10010 = var_1_10010.abs(var_1_10009 - var_9_4) / arg_9_0.DURATION_PARAMETER
			table = var_11

			local var_9_5 = var_11.insert
			local var_9_6 = arg_9_0.LTList

			LeanTween = var_1_10013
			var_1_10013 = var_1_10013.value
			go = var_1_10014
			var_1_10014 = var_1_10013(var_1_10014(var_6), var_9_4, var_1_10009, var_1_10010)
			...
			var_9_5(var_9_6, var_1_10013(var_1_10014, var_15.Action_float(function(arg_10_0)
			...
			LeanTween = var_1_10013
			var_1_10013 = var_1_10013.alphaCanvas

			local var_9_9 = var_6:Find("close")

			var_1_10014 = var_1_10014.GetComponent
			typeof = var_16
			CanvasGroup = var_17
			var_1_10014 = var_1_10013(var_1_10014(var_9_9, var_16(var_17)), iter_9_2 == arg_9_1 and 0 or 1, var_1_10010)
			var_1_10013 = var_1_10013.setEase
			LeanTweenType = var_15

			var_9_7(var_9_8, var_1_10013(var_1_10014, var_15.easeOutSine).uniqueId)
		end
	end

	pg = var_2

	local var_9_10 = var_2.NewStoryMgr.GetInstance()

	if arg_9_0.index ~= 1 and arg_9_0.storyActivity.data1 > 0 and not var_9_10:IsPlayed(arg_9_0.storyList[arg_9_0.index - 1][1]) then
		local var_9_11 = arg_9_0
		local var_9_12 = arg_9_0.emit

		BossRushVerSardiniaSPMediator = var_5

		var_9_12(var_9_11, var_5.ON_ACTIVITY_UNLOCKSTOIRY, arg_9_0.storyActivity.id, var_9_10:StoryName2StoryId(arg_9_0.storyList[arg_9_0.index - 1][1]))
	else
...
function var_0_1.didEnter(arg_11_0)
	...
	local function var_11_8()
		...
		i18n = var_2_10003
		var_14_2.helps = var_2_10003("SardiniaSPCoreActivityUI_help")
	...
	local function var_11_11()
		...
		BossRushVerSardiniaSPMediator = var_2_10002

		var_15_1(var_15_0, var_2_10002.ON_EXTRA_RANK)
	...
	local function var_11_14()
		...
		var_16_1(var_16_0, var_16_2, var_2_10003.ACTIVITY, {
	...
	var_1_10001(var_11_12, var_11_13, var_11_14, var_1_10005)
	...
	local function var_11_17()
		...
		var_17_1(var_17_0, var_17_2, var_2_10003.TASK)
	...
	var_1_10001(var_11_15, var_11_16, var_11_17, var_1_10005)

	onButton = var_1_10001

	local var_11_18 = arg_11_0
	local var_11_19 = arg_11_0.switchToggle
	local var_11_20 = var_3.Find(var_11_19, "Story")
	...
	var_1_10001(var_11_18, var_11_20, var_11_21, var_5)

	onButton = var_1_10001

	local var_11_22 = arg_11_0
	local var_11_23 = arg_11_0.switchToggle
	local var_11_24 = var_3.Find(var_11_23, "Battle")
	...
	var_1_10001(var_11_22, var_11_24, var_11_25, var_5)
...
function var_0_1.UpdateBattle(arg_22_0)
	...
	if arg_22_0.contextData.showFlash then
		...
		for iter_22_0, iter_22_1 in var_4(var_22_0:getConfig("config_data")) do
			...
			var_22_5(var_22_4:Find("lock"), not var_22_6)
			...
			var_22_7(var_22_4:Find("finish"), var_22_8)

			setActive = var_22_7

			local var_22_9 = var_22_4:Find("finish")
			local var_22_10 = var_14.GetChild(var_22_9, 0)

			if var_22_1 and arg_22_0.contextData.passCounts then
				table = var_22_9

				if not var_22_9.contains(arg_22_0.contextData.passCounts, var_1_10010.id) then
					table = var_22_9
					var_22_9 = var_22_9.contains(var_22_1, var_1_10010.id)
				else
					var_22_9 = false
				end
			end
			...
			var_22_7(var_22_10, var_22_9)

			local var_22_11 = var_1_10010
			local var_22_12 = var_1_10010.GetType(var_22_11)

			BossRushSeriesData = var_22_11

			local var_22_13 = var_22_12 == var_22_11.TYPE.SP
			...
			if var_22_13 then
				...
				var_22_15(var_22_4:Find("times"), var_22_6)

				if not var_22_0:GetUsedBonus()[iter_22_0] then
					var_22_15 = 0
				end

				var_22_14 = var_1_10010:GetMaxBonusCount() - var_22_15 > 0
				setText = var_18
				var_1_10020 = var_22_4

				local var_22_16 = var_22_4.Find(var_1_10020, "times/Text")

				i18n = var_1_10020
				var_1_10020 = var_1_10020("series_enemy_SP_count")
				setColorStr = var_21
				math = var_1_10022

				var_18(var_22_16, var_1_10020 .. var_21(var_1_10022.max(0, var_17 - var_22_15) .. "/" .. var_17, "#f77d24"))
			end
			...
			local function var_22_19()
				if not var_22_6 then
					...
					BossRushSeriesData = var_23_0

					local var_23_2 = var_23_0.New({
						id = var_23_1
					})

					pg = var_2_10002

					local var_23_3 = var_2_10002.TipsMgr.GetInstance()

					var_2_10002 = var_2_10002.ShowTips
					i18n = var_2_10004

					var_2_10002(var_23_3, var_2_10004("series_enemy_unlock", var_23_2:GetName()))
				...
				if not var_22_14 then
					...
					local var_23_4 = var_0.TipsMgr.GetInstance()
					local var_23_5 = var_0.ShowTips

					i18n = var_2_10002

					var_23_5(var_23_4, var_2_10002("series_enemy_SP_error"))
				...
				if iter_22_0 > 1 then
					local var_23_8 = var_1_10010

					if var_2.IsFleetsEmpty(var_23_8) then
						table = var_2

						var_2.insert(var_23_6, function(arg_24_0)
							pg = var_3_10001
							...
							i18n = var_3_10004
							var_24_2.content = var_3_10004("SardiniaSPCoreActivityUI_fleetconfirm")
				...
				var_2(var_23_6, function()
					local var_26_0 = arg_22_0
					local var_26_1 = var_0.emit

					BossRushVerSardiniaSPMediator = var_3_10002

					var_26_1(var_26_0, var_3_10002.ON_FLEET_SELECT, var_1_10010)
			...
			var_22_15(var_22_17, var_22_18, var_22_19, var_1_10020)
		end
...
function var_0_1.UpdataStoryState(arg_28_0, arg_28_1)
	...
	if arg_28_1 then
		...
		if not var_28_0.StoryId2StoryName(var_1_10004, arg_28_1) then
			var_28_1 = nil
		end
	...
	var_35_0({
		function(arg_36_0)
			...
			if var_1(arg_35_1) and var_1 > 0 then
				...
				BossRushVerSardiniaSPMediator = var_2_10004

				var_36_1(var_36_0, var_2_10004.ON_PERFORM_COMBAT, var_1)
			else
...
function var_0_1.UpdateStoryTask(arg_37_0)
	...
	var_37_6(var_37_8, var_1_10006("SardiniaSPCoreActivityUI_story_reward_count", arg_37_0.storyActivity.data1, var_37_5))
	...
	local var_37_11 = var_37_9.Create(var_37_10[1])
	local var_37_12 = arg_37_0.rtStoryAward
	local var_37_13 = var_6.Find(var_37_12, "IconTpl")

	updateDrop = var_37_12

	var_37_12(var_37_13, var_37_11)
	...
	local function var_37_16()
		...
		var_38_1(var_38_0, var_2_10002.ON_DROP, var_37_11)
	...
	var_37_12(var_37_14, var_37_15, var_37_16, var_1_10011)
	...
	var_37_17(var_37_13:Find("get"), var_37_18 == 1)

	setActive = var_37_17

	var_37_17(var_37_13:Find("got"), var_37_18 == 2)

	if var_37_18 == 1 then
		local var_37_19 = arg_37_0
		local var_37_20 = arg_37_0.emit

		BossRushVerSardiniaSPMediator = var_10

		var_37_20(var_37_19, var_10.ON_TASK_SUBMIT, arg_37_0.storyTask)
	end
...
function var_0_1.UpdateTipDisplay(arg_45_0)
	...
	local var_45_1 = var_2.Find(var_45_0, "tip")

	Activity = var_45_0

	var_1_10001(var_45_1, var_45_0.IsActivityReady(arg_45_0.tasksActivity))
...
function var_0_1.IsStoryTip(arg_46_0)
	...
	if not var_46_1(var_46_0, var_4.GetConfigClientSetting(var_46_2, "openStory")) then
		return true
	end
	...
	if not var_46_4(var_46_3, var_4.GetConfigClientSetting(var_46_5, "endStory")) then
		underscore = var_2
	...
	if var_2.GetConfigClientSetting(var_46_6, "tasks")[1] then
		...
		local var_46_7 = var_46_6(var_4)

		var_46_6 = var_46_6.getTaskVO(var_46_7, var_2)
	end

	if var_46_6 and var_46_6:getTaskStatus() == 1 then
		return true
	end
...
function var_0_1.willExit(arg_48_0)
	...
	var_48_0.passCounts = var_48_1(var_3.GetPassCounts(var_48_2))
