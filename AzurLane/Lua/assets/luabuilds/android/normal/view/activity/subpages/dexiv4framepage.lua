...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".TemplatePage.FrameTemplatePage"))
...
function var_0_1.Switch(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_2(var_1_0, var_1_10004(var_1_10005))
	...
	var_5(var_6.Find(var_1_5, "Image"), false)

	setLocalPosition = var_5
	go = var_6

	var_5(var_6(arg_1_0.phases[1]), var_1_3)

	setActive = var_5

	local var_1_6 = arg_1_0.phases[1]

	var_5(var_6.Find(var_1_6, "label"), true)
	...
	local var_1_8 = var_1_7(var_6(arg_1_0.phases[1]), 0, 1, 0.4)
	local var_1_9 = var_5.setOnUpdate

	System = var_7

	var_1_9(var_1_8, var_7.Action_float(function(arg_2_0)
	...
	var_1_9(var_6.Find(var_1_10, "Image"), true)
	...
	local var_1_12 = var_1_9(var_1_11, var_7(var_8))

	LeanTween = var_1_11

	local var_1_13 = var_1_11.value

	go = var_7

	local var_1_14 = var_1_13(var_7(arg_1_0.phases[2]), 0, 1, 0.4)
	local var_1_15 = var_6.setOnUpdate

	System = var_8

	var_1_15(var_1_14, var_8.Action_float(function(arg_3_0)
	...
	var_1_15(var_7.Find(var_1_16, "label"), false)

	setLocalPosition = var_1_15
	go = var_7

	var_1_15(var_7(arg_1_0.phases[2]), var_1_2)
