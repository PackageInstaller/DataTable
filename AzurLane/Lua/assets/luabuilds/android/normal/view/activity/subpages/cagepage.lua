...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		DivineLightMedalAlbumView = var_2_10002
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10002.BATTLE_OPERA)
	...
	if arg_3_0.xc_time <= 0 then
		...
		if var_1.date("%d") >= "01" then
			...
			var_1(var_3_14, var_3("tolovemainpage_skin_countdown", 24 - arg_3_0.times - 1))
		else
			setText = var_1
			...
			var_1(var_3_15, var_3("tolovemainpage_skin_countdown", 24 - arg_3_0.times))
		end
	end
