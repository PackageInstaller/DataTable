...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_SETTLE, function()
		...
		if not arg_1_0.contextData.win then
			...
			var_2_1(var_2_0, var_2_10002.GO_BACK)
...
function var_0_1.ShowTotalAward(arg_13_0, arg_13_1)
	...
	if var_13_1(var_13_0, var_1_10004.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB) then
		local var_13_2 = var_2
		local var_13_3

		if not var_2.getConfig(var_13_2, "config_client").mediator then
			var_13_3 = "BossRushDALCollabMediator"
		end

		getProxy = var_13_2
		ContextProxy = var_1_10005

		local var_13_4 = var_13_2(var_1_10005)
		local var_13_5 = var_4.getContextByMediator

		_G = var_1_10006

		local var_13_6, var_13_7 = var_13_5(var_13_4, var_1_10006[var_13_3])

		getProxy = var_6
		ActivityProxy = var_1_10007

		local var_13_8 = var_6(var_1_10007)
		local var_13_9, var_13_10 = var_6.GetContinuousTime(var_13_8)
		local var_13_11 = var_13_7
		local var_13_12 = var_13_7.addChild

		Context = var_1_10010

		local var_13_13 = var_1_10010.New
		local var_13_14 = {}

		BossRushTotalRewardPanelMediator = var_1_10012
		var_13_14.mediator = var_1_10012
		BossRushTotalRewardPanel = var_1_10012
		var_13_14.viewComponent = var_1_10012
		var_13_14.data = {
			isLayer = true,
			rewards = arg_13_1,
		...
		var_13_16(var_13_15, var_10.GO_BACK)
