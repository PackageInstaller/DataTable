...
function var_0_1.BindEvent(arg_2_0)
	arg_2_0:bind(var_0_1.ON_TASK_SUBMIT_ONESTEP, function(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
		...
		var_3_1(var_3_0, var_2_10006.SUBMIT_ACTIVITY_TASK, {
			act_id = arg_3_1,
			task_ids = arg_3_2,
			callback = arg_3_3
		})
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.SUBMIT_TASK_AWARD_DOWN and #var_6_2.awards > 0 then
		local var_6_3 = arg_6_0.viewComponent
		local var_6_4 = var_4.emit

		BaseUI = var_1_10006

		var_6_4(var_6_3, var_1_10006.ON_ACHIEVE, var_6_2.awards, function()
