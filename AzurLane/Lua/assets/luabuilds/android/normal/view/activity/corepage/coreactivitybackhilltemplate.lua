...
function var_0_1.InitFacilityCross(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	...
	local var_3_1 = arg_3_1:Find(arg_3_3)
	local var_3_2 = arg_3_4

	SFX_PANEL = var_9

	var_1_10005(var_3_0, var_3_1, var_3_2, var_9)

	onButton = var_1_10005

	local var_3_3 = arg_3_0
	local var_3_4 = arg_3_2:Find(arg_3_3)
	local var_3_5 = arg_3_4

	SFX_PANEL = var_9

	var_1_10005(var_3_3, var_3_4, var_3_5, var_9)
...
function var_0_1.getStudents(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = var_1_10004(var_1_10005)
	...
	if var_5.getConfig(var_4_2, "config_client") then
		var_4_3 = var_4_3.ships
	end
	...
	if var_4_3 then
		...
		local var_4_5 = var_7.random(arg_4_1, arg_4_2)
		local var_4_6 = #var_4_4

		while var_4_5 > 0 and 0 < var_4_6 do
			math = var_4_7

			local var_4_7 = var_4_7.random(1, var_4_6)

			table = var_10

			var_10.insert(var_4_0, var_4_4[var_4_7])

			var_4_4[var_4_7] = var_4_4[var_4_6]
			var_4_6 = var_4_6 - 1
			var_4_5 = var_4_5 - 1
		end
	end
	...
	for iter_5_2, iter_5_3 in var_8(var_5_0) do
		if not arg_5_0.academyStudents[iter_5_2] then
			...
			var_15:SetOnTransEdge(function(arg_6_0, arg_6_1, arg_6_2)
				...
				math = var_4
				arg_6_2 = var_4.max(arg_6_1, arg_6_2)
				arg_6_1 = var_6_0
...
function var_0_1.ChooseRandomPos(arg_8_0, arg_8_1)
	...
	var_3.Tool.Swap(arg_8_0, var_2, arg_8_1)
	...
	for iter_9_0, iter_9_1 in var_1_10002(var_9_0) do
		if iter_9_1.childCount > 1 then
			...
			for iter_9_2 = 1, iter_9_1.childCount do
				...
				local var_9_3 = iter_9_1.GetChild(var_9_2, iter_9_2 - 1)

				table = var_9_2

				var_9_2.insert(var_9_1, {
					tf = var_9_3,
					index = iter_9_2
				})
			end
			...
			for iter_9_3, iter_9_4 in var_8(var_9_1) do
				local var_9_4 = iter_9_4.tf

				var_13.SetSiblingIndex(var_9_4, iter_9_3 - 1)
			end
		end
	end
...
function var_0_1.IsMiniActNeedTip(arg_13_0)
	...
	return var_13_0.IsActivityReady(var_13_1)
end
...
function var_0_1.BindItemActivityShop(arg_15_0)
	arg_15_0:InitFacilityCross(arg_15_0._map, arg_15_0._upper, "bujishangdian", function()
		...
		local var_16_3 = var_2_10003.SHOP
		local var_16_4 = {}

		NewShopsScene = var_2_10005
		var_16_4.warp = var_2_10005.TYPE_ACTIVITY
...
function var_0_1.BindItemSkinShop(arg_17_0)
	arg_17_0:InitFacilityCross(arg_17_0._map, arg_17_0._upper, "huanzhuangshangdian", function()
		...
		var_18_1(var_18_0, var_18_2, var_2_10003.SKINSHOP)
...
function var_0_1.BindItemBuildShip(arg_19_0)
	arg_19_0:InitFacilityCross(arg_19_0._map, arg_19_0._upper, "xianshijianzao", function()
		...
		local var_20_1 = var_2_10001(var_2_10002)
		local var_20_2 = var_1.getActivityByType

		ActivityConst = var_2_10003

		local var_20_3 = var_20_2(var_20_1, var_2_10003.ACTIVITY_TYPE_BUILDSHIP_1)

		getProxy = var_20_1
		ActivityProxy = var_3

		local var_20_4 = var_20_1(var_3)
		local var_20_5 = var_2.getActivityByType

		ActivityConst = var_2_10004

		local var_20_6 = var_20_5(var_20_4, var_2_10004.ACTIVITY_TYPE_BUILD)

		if var_20_3 and not var_20_3:isEnd() then
			BuildShipScene = var_20_4
			var_20_0 = var_20_4.PROJECTS.ACTIVITY
		else
			if var_20_6 then
				local var_20_7 = var_20_6

				if not var_20_6.isEnd(var_20_7) then
					var_20_4 = {}
					BuildShipScene = var_20_7
					var_20_4[1] = var_20_7.PROJECTS.SPECIAL
					BuildShipScene = var_4
					var_20_4[2] = var_4.PROJECTS.LIGHT
					BuildShipScene = var_4
					var_20_4[3] = var_4.PROJECTS.HEAVY
					var_2_10005 = var_20_6
					var_20_0 = var_20_4[var_20_6.getConfig(var_2_10005, "config_client").id]
			...
			local var_20_8 = var_20_4.TipsMgr.GetInstance()
			local var_20_9 = var_3.ShowTips

			i18n = var_2_10005

			var_20_9(var_20_8, var_2_10005("common_activity_end"))
		...
		local var_20_11 = var_3.emit

		BackHillMediatorTemplate = var_2_10005

		local var_20_12 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		local var_20_13 = var_2_10006.GETBOAT
		local var_20_14 = {}

		BuildShipScene = var_2_10008
		var_20_14.page = var_2_10008.PAGE_BUILD
		var_20_14.projectName = var_20_0

		var_20_11(var_20_10, var_20_12, var_20_13, var_20_14)
...
function var_0_1.BindItemBattle(arg_21_0)
	arg_21_0:InitFacilityCross(arg_21_0._map, arg_21_0._upper, "tebiezuozhan", function()
		...
		if var_22_1 then
			...
			if not var_2_10003.isUnlock(var_22_3) then
				pg = var_2_10003

				local var_22_4 = var_2_10003.TipsMgr.GetInstance()
				local var_22_5 = var_3.ShowTips

				i18n = var_2_10005

				var_22_5(var_22_4, var_2_10005("common_activity_end"))
			else
				...
				local var_22_8 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_22_7(var_22_6, var_22_8, var_2_10006.LEVEL, {
					chapterId = var_22_2,
					mapIdx = var_22_1
				})
			end
...
function var_0_1.UpdateBuildingTip(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_1 = arg_23_1.GetBuildingLevel(var_23_0, arg_23_2)

	pg = var_23_0

	if not var_23_0.activity_event_building[arg_23_2] or var_23_1 >= #var_4.buff then
		return false
	end

	local var_23_2 = var_4.material[var_23_1]

	_ = var_1_10006

	return var_1_10006.all(var_23_2, function(arg_24_0)
		...
		if var_24_0 == var_2_10005 then
			...
			Item = var_2_10006
			var_2_10005 = var_2_10005(var_2_10006.getConfigData(var_24_1), "link_id")
			assert = var_2_10006
			...
			if var_2_10005 < var_24_0 then
				...
				local var_24_5 = var_2_10005(var_2_10006.activity_drop_type[var_24_0], "activity_id")
