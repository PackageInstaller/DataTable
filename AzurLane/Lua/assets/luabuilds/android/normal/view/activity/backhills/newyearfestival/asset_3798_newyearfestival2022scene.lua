...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._middle = var_1.Find(var_2_5, "middle")
	...
	local var_2_12 = var_1.Find(var_2_11, "usable_count/text")
	local var_2_13 = var_1.GetComponent

	typeof = var_3
	Text = iter_2_1
	arg_2_0.usableTxt = var_2_13(var_2_12, var_3(iter_2_1))

	local var_2_14 = arg_2_0.top
	local var_2_15 = var_1.Find(var_2_14, "material/text")
	local var_2_16 = var_1.GetComponent

	typeof = var_3
	Text = iter_2_1
	arg_2_0.materialTxt = var_2_16(var_2_15, var_3(iter_2_1))

	local var_2_17 = arg_2_0.top

	arg_2_0.btnPlayFirework = var_1.Find(var_2_17, "playFirework")
	GraphPath = var_1

	local var_2_18 = var_1.New

	import = var_2_17
	arg_2_0.graphPath = var_2_18(var_2_17("GameCfg.BackHillGraphs.NewyearFestival2022Graph"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.help_xinnian2022_feast.tip
	...
	var_3_13(var_3_12, var_3.MINIGAME_CURLING, 3, 3)
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "qiyuanwu", function()
		...
		var_8_1(var_8_0, var_2_10002.GO_MINI_GAME, 34)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "bingqiu", function()
		...
		var_9_1(var_9_0, var_2_10002.GO_MINI_GAME, 33)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "yanhua", function()
		...
		var_10_1(var_10_0, var_2_10002.GO_MINI_GAME, 36)
...
function var_0_1.UpdateView(arg_17_0)
	...
	local var_17_2 = var_17_1(var_17_0, var_1_10003.ACTIVITY_TYPE_BUILDING_BUFF)

	pairs = var_17_0

	for iter_17_0, iter_17_1 in var_17_0(arg_17_0.Buildings) do
		local var_17_3 = arg_17_0.Respones

		if not var_17_2.data1KeyValueList[2][iter_17_0] then
			var_1_10008 = 1
		end

		var_17_3[iter_17_1] = var_1_10008
		arg_17_0.Respones[iter_17_1 .. "Tip"] = arg_17_0:UpdateBuildingTip(var_17_2, iter_17_0)
	end
	...
	local var_17_4 = var_3(var_17_2.data1KeyValueList[1])
	local var_17_5 = arg_17_0.Respones
	local var_17_6

	if not var_17_2.data1KeyValueList[1][var_17_4] then
		var_17_6 = 0
	end

	var_17_5.materialCount = var_17_6
	getProxy = var_17_5
	MiniGameProxy = var_17_6

	local var_17_7 = var_17_5(var_17_6)
	local var_17_8 = var_4.GetMiniGameDataByType

	MiniGameConst = iter_17_1

	local var_17_9

	if not var_17_8(var_17_7, iter_17_1.MG_TYPE_5) or not var_4:GetRuntimeData("count") then
		var_17_9 = 0
	end

	arg_17_0.Respones.shrineCount = var_17_9

	local var_17_10 = arg_17_0.Respones
	local var_17_11 = var_0_1.IsMiniActNeedTip

	ActivityConst = var_1_10008
	var_17_10.bingqiuTip = var_17_11(var_1_10008.MINIGAME_CURLING)

	local var_17_12 = arg_17_0.Respones
	local var_17_13 = var_0_1.IsMiniActNeedTip

	ActivityConst = var_8
	var_17_12.yanhuaTip = var_17_13(var_8.MINIGAME_FIREWORK_2022)

	local var_17_14 = arg_17_0.Respones

	Shrine2022View = var_7
	var_17_14.qiyuanwuTip = var_7.IsNeedShowTipWithoutActivityFinalReward()
	getProxy = var_17_14
	MiniGameProxy = var_7

	local var_17_15 = var_17_14(var_7)
	local var_17_16 = var_6.GetMiniGameData(var_17_15, 36)

	if var_6.GetRuntimeData(var_17_16, "elements") then
		::label_17_0::
		...
		if 4 <= var_17_16 then
			var_17_16 = var_7[4]
			SummerFeastScene = var_9

			if var_17_16 ~= var_9.GetCurrentDay() then
				var_17_16 = false
			else
				var_17_16 = true
			end
			...
			local var_17_17 = arg_17_0.btnPlayFirework
			...
			if var_17_16 then
				...
				local var_17_18 = arg_17_0.loader

				var_1_10011 = not var_1_10011(var_12.GetRequestPackage(var_17_18, "Firework"))
			end

			var_9(var_17_17, var_1_10011)
...
function var_0_1.TryPlayStory(arg_19_0)
	...
	if not var_19_1(var_19_0, var_1_10003.ACTIVITY_TYPE_BUILDING_BUFF).data1KeyValueList[2][17] then
		var_19_2 = 1
	end
	...
	local var_19_6 = var_19_4.NewStoryMgr.GetInstance()

	table = var_6

	var_6.Foreach(var_19_5, function(arg_20_0, arg_20_1)
...
function var_0_1.PlayFirework(arg_22_0, arg_22_1)
	...
	var_3.GetPrefab(var_22_1, "ui/firework", "", function(arg_23_0)
		...
		SummerFeastScene = var_4
		var_23_3.startColor = var_23_4(var_4.TransformColor(var_23_0[arg_22_1[1]].color))
		tf = var_23_3
		...
		SummerFeastScene = var_4
		var_23_7.startColor = var_23_8(var_4.TransformColor(var_23_0[arg_22_1[2]].color))
		tf = var_23_7
		...
		SummerFeastScene = var_4
		var_23_11.startColor = var_23_12(var_4.TransformColor(var_23_0[arg_22_1[3]].color))
		setParent = var_23_11
	...
	arg_22_0.fireworkTimer = var_3.New(function()
		...
		var_0.GetPrefab(var_24_0, "ui/firework", "", function(arg_25_0)
			...
			SummerFeastScene = var_4
			var_25_3.startColor = var_25_4(var_4.TransformColor(var_25_0[arg_22_1[1]].color))
			tf = var_25_3
			...
			SummerFeastScene = var_4
			var_25_7.startColor = var_25_8(var_4.TransformColor(var_25_0[arg_22_1[2]].color))
			tf = var_25_7
			...
			SummerFeastScene = var_4
			var_25_11.startColor = var_25_12(var_4.TransformColor(var_25_0[arg_22_1[3]].color))
			setParent = var_25_11
	...
	arg_22_0.fireworkTimer2 = var_3.New(function()
		...
		var_0.GetPrefab(var_26_0, "ui/firework", "", function(arg_27_0)
			...
			SummerFeastScene = var_4
			var_27_3.startColor = var_27_4(var_4.TransformColor(var_27_0[arg_22_1[1]].color))
			tf = var_27_3
			...
			SummerFeastScene = var_4
			var_27_7.startColor = var_27_8(var_4.TransformColor(var_27_0[arg_22_1[2]].color))
			tf = var_27_7
			...
			SummerFeastScene = var_4
			var_27_11.startColor = var_27_12(var_4.TransformColor(var_27_0[arg_22_1[3]].color))
			setParent = var_27_11
