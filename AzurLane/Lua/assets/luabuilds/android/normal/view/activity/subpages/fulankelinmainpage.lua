...
local var_0_3 = var_2.Valleyhospital_ACT_ID
...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_2 = var_1(var_1_1, var_3(var_1_10004))
	...
	local var_1_4 = var_1(var_1_3, var_3(var_1_10004))
	...
	local var_1_6 = var_1(var_1_5, var_3(var_1_10004))
	...
	local var_1_8 = var_1(var_1_7, var_3(var_1_10004))
	...
	var_1(arg_1_0, arg_1_0.btnCollect, function()
		...
		local var_2_3 = var_2_10003.WORLD_COLLECTION
		local var_2_4 = {}

		WorldMediaCollectionScene = var_2_10005
		var_2_4.page = var_2_10005.PAGE_ALBUM
	...
	var_1(var_1_9, var_1_10, var_1_11, var_1_10005)
	...
	local function var_1_14()
		...
		var_4_1(var_4_0, var_4_2, var_2_10003.CLUE_MAP)
...
function var_0_1.updateUI(arg_9_0)
	...
	local var_9_2, var_9_3 = var_9_1(var_9_0, var_1_10003.shop_template[var_0_2].time)
	local var_9_4
	local var_9_6
	...
	local var_9_9, var_9_10 = var_9_8(var_9_7, var_1_10006.activity_template[var_0_4].time)
	local var_9_11
	local var_9_12

	if var_9_10 then
		pg = var_9_12
		var_1_10008 = var_9_12.TimeMgr.GetInstance()
		var_9_12 = var_9_12.Table2ServerTime(var_1_10008, var_9_10)
		skinCommdityTimeStamp = var_1_10008
		var_9_11 = var_1_10008(var_9_12)
	end
	...
	if var_9_4 then
		...
		var_9_12(var_1_10008(arg_9_0.btnSkin, "bgTime"), false)
	end
	...
	if var_9_11 then
		...
		var_9_12(var_8(arg_9_0.btnBuild, "bgTime"), false)
	end
