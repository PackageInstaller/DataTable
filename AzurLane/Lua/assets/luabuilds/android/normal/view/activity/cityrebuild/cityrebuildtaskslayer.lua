...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3_7, var_3_6("other_world_task_get_all"))
...
function var_0_1.ShouldShowTip()
	...
	local var_7_2 = var_1_10002(var_1_10003)
...
function var_0_1.InitData(arg_8_0)
	getProxy = var_1_10001
	TaskProxy = var_1_10002
	arg_8_0.taskProxy = var_1_10001(var_1_10002)
	ActivityConst = var_1
...
function var_0_1.GetAllAward(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10004(arg_12_0.config_data) do
		var_1_10010 = arg_12_0.taskProxy
		arg_12_0.taskvo = var_9.getFinishTaskById(var_1_10010, arg_12_0.config_data[iter_12_0])
		var_1_10010 = arg_12_0.taskProxy
		arg_12_0.task = var_9.getTaskVO(var_1_10010, arg_12_0.config_data[iter_12_0])
		var_1_10010 = arg_12_0.task

		if var_9.getTaskStatus(var_1_10010) == 1 then
	...
	for iter_12_4 = 1, #var_12_2 do
		...
		CityRebuildTasksMediator = var_1_10010

		var_12_4(var_12_3, var_1_10010.ON_SUBMIT_TASK, var_12_2[iter_12_4])
	end

	local var_12_5 = arg_12_0
	local var_12_6 = arg_12_0.emit

	CityRebuildTasksMediator = var_6

	var_12_6(var_12_5, var_6.ON_TASK_SUBMIT_ONESTEP, arg_12_0.taskActivityId_2, var_12_1)
...
function var_0_1.UpdateList(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_5 = arg_13_2.Find(var_13_4, "desc")

	setText = var_13_4

	var_13_4(var_13_5, var_13_3:getConfig("desc"))

	local var_13_6 = var_13_3:getProgress()
	local var_13_7 = var_13_3
	local var_13_8 = var_13_3.getConfig(var_13_7, "target_num")

	setText = var_13_7

	local var_13_9 = arg_13_2
	local var_13_10 = arg_13_2.Find(var_13_9, "progress")

	setColorStr = var_13_9

	var_13_7(var_13_10, var_13_9(var_13_6, "#000000") .. "/" .. var_13_8)

	setSlider = var_13_7

	var_13_7(arg_13_2:Find("slider"), 0, var_13_8, var_13_6)

	local var_13_11 = arg_13_2:GetChild(0)
	local var_13_12 = arg_13_2:Find("awards")

	arg_13_0:updateAwards(var_13_3:getConfig("award_display"), var_13_12, var_13_11)

	local var_13_13 = arg_13_2:Find("go_btn")
	local var_13_14 = arg_13_2:Find("get_btn")
	local var_13_15 = arg_13_2:Find("got_btn")
	local var_13_16 = var_13_3
	local var_13_17 = var_13_3.getTaskStatus(var_13_16)

	setActive = var_13_16

	var_13_16(var_13_13, var_13_17 == 0)

	setActive = var_13_16

	var_13_16(var_13_14, var_13_17 == 1)

	setActive = var_13_16

	var_13_16(var_13_15, var_13_17 == 2)

	SetActive = var_13_16

	var_13_16(arg_13_2:Find("tip"), var_13_17 == 1)

	onButton = var_13_16

	local var_13_18 = arg_13_0
	local var_13_19 = var_13_14
	...
	local function var_13_20()
		for iter_14_0 = 1, #arg_13_0.data[arg_13_0.nday] do
			if var_13_3.id == arg_13_0.data[arg_13_0.nday][iter_14_0] then
				...
				CityRebuildTasksMediator = var_2_10006

				var_14_1(var_14_0, var_2_10006.ON_SUBMIT_TASK, var_13_3.id)
			end
		end
		...
		for iter_14_1 = 1, #arg_13_0.data2 do
			if var_13_3.id == arg_13_0.data2[iter_14_1] then
				...
				var_14_3(var_14_2, var_2_10006.ON_TASK_SUBMIT_ONESTEP, arg_13_0.taskActivityId_2, {
					var_13_3.id
				})
			end
		end
	...
	var_13_16(var_13_18, var_13_19, var_13_20, var_1_10020)

	onButton = var_13_16

	local var_13_21 = arg_13_0
	local var_13_22 = var_13_13

	local function var_13_23()
		local var_15_0 = arg_13_0
		local var_15_1 = var_0.emit

		CityRebuildTasksMediator = var_2_10002

		var_15_1(var_15_0, var_2_10002.ON_TASK_GO, var_13_3)
	...
	var_13_16(var_13_21, var_13_22, var_13_23, var_1_10020)
...
function var_0_1.updateAwards(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	for iter_16_1 = 1, var_16_1 do
		...
		if var_16_3 then
			...
			local var_16_6 = var_16_2:Find("mask")
			...
			var_14(var_1_10015, var_16_6, var_16_7, var_18)
		end
	end
