...
DROP_TYPE_EQUIP = var_2
var_0_2[var_2] = "equip"
DROP_TYPE_FURNITURE = var_2
var_0_2[var_2] = "furniture"
DROP_TYPE_EQUIPMENT_SKIN = var_2
var_0_2[var_2] = "equip_skin"
DROP_TYPE_SPWEAPON = var_2
var_0_2[var_2] = "special_weapon"
...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.itemList = var_1_5(var_1_6, var_3.Find(var_1_7, "tpl"))
	setText = var_1

	local var_1_8 = arg_1_0.content
	local var_1_9 = var_2.Find(var_1_8, "tpl/owner/title")

	i18n = var_1_8

	var_1(var_1_9, var_1_8("collect_page_got"))
	...
	var_1(var_1_25, var_1_26, var_1_27, var_5)
	...
	var_1(var_1_28, var_1_29, var_1_30, var_5)
...
function var_0_1.AddTogglesListener(arg_10_0)
	...
	local var_10_1 = arg_10_0.GetTogglesDropTypes(var_10_0)

	assert = var_10_0

	var_10_0(#var_10_1 == arg_10_0.togglesTF.childCount, "dropType数量与togglesTF子节点数不匹配")

	ipairs = var_10_0

	for iter_10_0, iter_10_1 in var_10_0(var_10_1) do
		local var_10_2 = arg_10_0.togglesTF
		local var_10_3 = var_7.Find(var_10_2, var_0_1.DropType2Name[iter_10_1])
		...
		var_10_2(var_10_4, var_10_5, var_10_6, var_1_10012)

		arg_10_0.toggles[iter_10_1] = var_10_3
	end
...
function var_0_1.AddSpecialBtnListener(arg_12_0)
	...
	if arg_12_0.furnitureThemeBtn and var_12_1.furniture_theme_link then
		...
		var_2(var_12_3, var_12_4, var_12_5, var_1_10006)
	end
	...
	if arg_12_0.medalBtn and var_12_1.medal_link then
		...
		var_2(var_12_7, var_12_8, var_12_9, var_1_10006)
	end
	...
	if arg_12_0.equipSkinBoxBtn and var_12_1.equipskin_box_link then
		...
		local function var_12_15()
			...
			var_15_2.show_type = var_2_10003.SHOW_TYPE_NORMAL
		...
		var_12_11(var_12_13, var_12_14, var_12_15, var_1_10007)
	end
...
function var_0_1.OnUpdateItem(arg_16_0, arg_16_1, arg_16_2)
	...
	var_6(var_16_3, var_16_4, var_16_5, var_1_10010)

	changeToScrollText = var_6

	local var_16_6 = arg_16_2
	local var_16_7 = arg_16_2.Find(var_16_6, "name_mask/name")

	Drop = var_16_6

	local var_16_8 = var_16_6.New({
		type = var_16_0.config.type,
		id = var_16_0.config.drop_id
	})

	var_6(var_16_7, var_8.getName(var_16_8))
	arg_16_0:RefreshCountText(var_16_0, arg_16_2)

	GetOrAddComponent = var_6

	local var_16_9 = arg_16_2
	local var_16_10 = arg_16_2.Find(var_16_9, "owner")

	typeof = var_16_9
	CanvasGroup = var_9
	var_6(var_16_10, var_16_9(var_9)).alpha = var_16_0.count == var_16_0.config.count and 0.5 or 1
	setActive = var_7
...
function var_0_1.updateBoxPanel(arg_24_0, arg_24_1)
	...
	var_3(arg_24_0.boxIconTF, var_24_0)
	...
	var_4(var_24_2, var_6(var_24_0.desc))
	...
	var_4(var_24_3, var_6("collect_page_got"))

	local var_24_4 = arg_24_1.show_type

	Msgbox4LinkCollectGuide = var_24_3

	if var_24_4 == var_24_3.SHOW_TYPE_NORMAL then
		setText = var_24_4
	...
	var_24_4.StaticAlign(arg_24_0.boxSrcContent, arg_24_0.boxSrcTpl, #arg_24_1.skipable_list, function(arg_25_0, arg_25_1, arg_25_2)
		...
		if arg_25_0 == var_2_10003.EventUpdate then
			...
			var_2_10007(arg_25_2:Find("SrcText"), var_25_2)

			local var_25_3 = arg_25_2
			local var_25_4 = arg_25_2.Find(var_25_3, "GoBtn")

			setText = var_25_3

			local var_25_5 = var_25_4
			local var_25_6 = var_25_4.Find(var_25_5, "go")

			i18n = var_25_5

			var_25_3(var_25_6, var_25_5("brs_reward_tip_2"))
			...
			var_25_3(var_25_7, var_25_8, var_25_9, var_2_10012)
		end
...
function var_0_1.DoSkip(arg_28_0, arg_28_1, arg_28_2)
	...
	if arg_28_1 == var_1_10003.SKIP_TYPE_SCENE then
		...
		var_28_1(var_28_0, var_1_10005, var_1_10006, var_28_2)
	else
		...
		if arg_28_1 == var_28_1.SKIP_TYPE_SCENE then
			...
			local var_28_5 = var_1_10005.GO_SCENE

			SCENE = var_1_10006

			var_28_4(var_28_3, var_28_5, var_1_10006.ACTIVITY, {
				id = arg_28_2
			})
		end
	end
