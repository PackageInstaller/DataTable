...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local var_1_16 = var_1_14.TimeMgr.GetInstance()

	if var_2.inTime(var_1_16, var_1_15) then
		triggerToggle = var_1_16

		var_1_16(arg_1_0.switchBtn, true)
	end
...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	var_4_7(var_4_6, var_7.Action(function()
	...
	local var_4_11 = var_4_10(var_4_9, var_7.Action_float(function(arg_6_0)
	...
	var_4_12(var_4_11, var_7.Action(function()
		...
		var_7_0(var_1.Find(var_7_1, "Image"), false)
	...
	var_4_12(var_6.Find(var_4_13, "Image"), true)
	...
	local var_4_15 = var_4_12(var_4_14, var_7(var_8))

	LeanTween = var_4_14

	local var_4_16 = var_4_14.value

	go = var_7

	local var_4_17 = var_4_16(var_7(arg_4_0.phases[2]), 0, 1, 0.4)
	local var_4_18 = var_6.setOnUpdate

	System = var_8

	var_4_18(var_4_17, var_8.Action_float(function(arg_8_0)
	...
	var_4_18(var_7.Find(var_4_19, "label"), false)
	...
	local var_4_21 = var_4_20(var_7(arg_4_0.phases[2]), var_4_2, 0.4)
	local var_4_22 = var_6.setOnComplete

	System = var_8

	var_4_22(var_4_21, var_8.Action(function()
...
function var_0_1.UpdateAwardGot(arg_10_0)
	...
	var_10_4(var_10_1, var_10_5)

	if var_10_5 or var_10_3 then
		setActive = var_10_4

		var_10_4(arg_10_0.battleBtn, false)
	end
...
function var_0_1.OnUpdateFlush(arg_11_0)
	...
	local var_11_2 = var_11_0.TimeMgr.GetInstance()
	local var_11_3 = var_3.inTime(var_11_2, var_11_1)

	setActive = var_11_2

	var_11_2(arg_11_0.battleBtn, var_11_3)
	...
	if 1 <= var_11_7 then
		...
		if not var_9(var_11_5, "#487CFFFF") then
			var_11_9 = var_11_5
		end

		var_1_10007(var_11_8, var_11_9)

		setText = var_1_10007

		var_1_10007(arg_11_0.progress, "/" .. var_11_6)

		setFillAmount = var_1_10007

		var_1_10007(arg_11_0.bar, var_11_5 / var_11_6)
