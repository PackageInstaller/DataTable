...
function var_0_1.InitCustom(arg_3_0)
	...
	local var_3_1 = var_2.Find(var_3_0, "Frame/Text")

	i18n = var_3_0

	var_1_10001(var_3_1, var_3_0("ryza_tip_item_access"))
...
function var_0_1.ShowMaterialsPreview(arg_8_0, arg_8_1)
	...
	var_1_10009.each(arg_8_1, function(arg_10_0)
		...
		if var_1.GetLimitItemID(var_10_0) ~= 0 then
			...
			if var_10_1 and var_10_1.count > 0 then
				...
				var_5.insert(var_8_6, var_2_10004)
				var_8_9(var_10_1)
			else
				AtelierMaterial = var_2_10004
	...
	local function var_8_10(arg_11_0)
		if arg_11_0.Instance then
			...
			local var_11_1 = {}
			local var_11_2 = arg_11_0.Instance

			var_11_1.configId = var_2_10003.GetConfigID(var_11_2)

			local var_11_3 = var_11_0(var_11_1)

			var_11_3.count = false
			table = var_2

			var_2.insert(var_8_6, var_11_3)
			var_8_9(arg_11_0.Instance)

			return
		end

		local var_11_4 = arg_11_0.Data
		local var_11_5
		...
		for iter_11_0, iter_11_1 in var_2_10003(var_8_5.all) do
			...
			if not var_8_8[iter_11_1] and not var_8_2[iter_11_1] then
				AtelierMaterial = var_11_6
				var_11_6 = var_11_6.New({
					configId = iter_11_1
				})
			end

			if var_11_6:IsNormal() and var_11_4:CanUseMaterial(var_11_6, var_8_4, arg_8_0.contextData.versionIndex) then
				var_11_5 = var_11_5 or iter_11_1

				if var_11_6.count > 0 then
					AtelierMaterial = var_9

					local var_11_7 = var_9.New({
						configId = iter_11_1
					})
					...
					var_10.insert(var_8_6, var_11_7)
					var_8_9(var_11_6)
		...
		local var_11_8 = var_3.New({
			configId = var_11_5
		})

		var_11_8.count = false
		table = var_4

		var_4.insert(var_8_7, var_11_8)
	...
	var_10.each(arg_8_1, function(arg_13_0)
		...
		if var_13_1 == var_13_0.TYPE.ANY then
			var_8_10(arg_13_0)
		end
	...
	var_10.each(arg_8_1, function(arg_14_0)
		...
		AtelierFormulaCircle = var_14_0

		if var_14_1 == var_14_0.TYPE.ELEMENT_CATEGORY then
			var_8_10(arg_14_0)
		end
	...
	var_10.each(arg_8_1, function(arg_15_0)
		...
		AtelierFormulaCircle = var_15_0

		if var_15_1 == var_15_0.TYPE.CATEGORY then
			var_8_10(arg_15_0)
		end
	...
	var_10.each(arg_8_1, function(arg_16_0)
		...
		AtelierFormulaCircle = var_16_0

		if var_16_1 == var_16_0.TYPE.ELEMENT then
			var_8_10(arg_16_0)
		end
	...
	var_10.each(arg_8_1, function(arg_17_0)
		...
		AtelierFormulaCircle = var_17_0

		if var_17_1 == var_17_0.TYPE.NONE then
			var_8_10(arg_17_0)
		end
	...
	local function var_8_12()
		...
		var_19_0(var_19_1.parent, #var_8_6 > 0)
		...
		var_2.Foreach(var_19_2, function(arg_20_0, arg_20_1)
			...
			var_3(var_20_2, var_20_3, var_20_4, var_7)
	...
	local function var_8_13()
		...
		var_22_0(var_22_1.parent, #var_8_7 > 0)
		...
		var_2.Foreach(var_22_2, function(arg_23_0, arg_23_1)
			...
			var_3(var_23_2, var_23_3, var_23_4, var_7)
