...
function var_0_1.initData(arg_7_0)
	...
	arg_7_0.activityProxy = var_1_10001(var_1_10002)
...
function var_0_1.findUI(arg_8_0)
	...
	for iter_8_0 = 1, #arg_8_0.allIDList do
		...
		local var_8_4 = arg_8_0.medalItemList
		local var_8_5 = arg_8_0.pageCollection

		var_1_10007(var_8_4, var_1_10009.Find(var_8_5, "Images/Medal" .. iter_8_0))
	end
	...
	for iter_8_1 = 1, #arg_8_0.allIDList do
		...
		local var_8_6 = arg_8_0.medalTextList
		local var_8_7 = arg_8_0.pageCollection

		var_1_10007(var_8_6, var_1_10009.Find(var_8_7, "Texts/Medal" .. iter_8_1))
	end

	arg_8_0.selectPanel = var_2:Find("SelectPanel")

	local var_8_8 = arg_8_0.selectPanel

	arg_8_0.selectPanelContainer = var_3.Find(var_8_8, "Scroll/Container")
	arg_8_0.allItems = {}
	...
	for iter_8_2 = 0, arg_8_0.selectPanelContainer.childCount - 1 do
		local var_8_9 = arg_8_0.selectPanelContainer
		local var_8_10 = var_7.GetChild(var_8_9, iter_8_2)
		local var_8_11 = arg_8_0.selectedPositionsInPanels

		var_8_11[var_8_10] = var_8_10.anchoredPosition
		table = var_8_11

		var_8_11.insert(arg_8_0.listStayInPanel, var_8_10)

		table = var_8

		var_8.insert(arg_8_0.allItems, var_8_10)
	end

	pairs = var_3

	for iter_8_3, iter_8_4 in var_3(var_0_2) do
		local var_8_12 = arg_8_0.allItems[iter_8_3]

		setParent = var_1_10009

		var_1_10009(var_8_12, arg_8_0.pageModified)

		table = var_1_10009

		var_1_10009.removebyvalue(arg_8_0.listStayInPanel, var_8_12)

		table = var_1_10009

		var_1_10009.insert(arg_8_0.listShowOnPanel, var_8_12)

		setAnchoredPosition = var_1_10009

		var_1_10009(var_8_12, iter_8_4)
	end

	setText = var_3

	local var_8_13 = arg_8_0.pageModified
	local var_8_14 = var_4.Find(var_8_13, "TextTip")

	i18n = var_8_13

	var_3(var_8_14, var_8_13("collect_idol_tip"))
	arg_8_0:AddLeanTween(function()
		...
		local var_9_2 = var_9_0(var_2_10001(var_2.Find(var_9_1, "TextTip")), 1, 2)
...
function var_0_1.addListener(arg_10_0)
	...
	local function var_10_5()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip.music_collection.tip
	...
	local function var_10_11()
		...
		var_16_1(var_16_0, var_2_10002("hand_account_tip"))
	...
	local function var_10_17()
		...
		i18n = var_2_10003
		var_18_2.content = var_2_10003("hand_account_resetting_tip")
	...
	local function var_10_20()
		...
		var_20_1.x = var_3.GetContainerPositions(var_20_2)[1]
		...
		var_2_10000(var_1.Find(var_20_3, "TextTip"), false)
		...
		var_20_7(var_20_6, var_3.ShareMgr.TypePoraisMedals)
		...
		var_20_7(var_2.Find(var_20_8, "TextTip"), true)
	...
	var_1_10001(var_10_18, var_10_19, var_10_20, var_1_10005)
	...
	for iter_10_0, iter_10_1 in var_10_21(arg_10_0.allItems) do
		...
		var_1_10008:AddDragFunc(function(arg_24_0, arg_24_1)
			...
			local var_24_1 = var_24_0(var_2_10003(arg_10_0.OverlayPanel), arg_24_1.position, var_10_22)

			setAnchoredPosition = var_3

			var_3(iter_10_1, var_24_1)
		...
		var_1_10008:AddDragEndFunc(function(arg_25_0, arg_25_1)
			...
			if var_10_25 then
				var_2_10004 = var_10_25
				var_2_10004 = var_3.Sub(var_2_10004, var_25_0)
				var_25_1 = var_3.SqrMagnitude(var_2_10004) < 1
			end
			...
			local var_25_3 = var_25_2(var_2_10005(arg_10_0.pageModified), arg_25_1.position, var_10_22)

			rtf = var_5

			local var_25_4 = var_5(arg_10_0.pageModified).rect

			if not var_5.Contains(var_25_4, var_25_3) then
				setParent = var_25_4

				var_25_4(iter_10_1, arg_10_0.selectPanelContainer)

				table = var_25_4

				var_25_4.removebyvalue(arg_10_0.listStayInPanel, iter_10_1)

				table = var_25_4

				var_25_4.removebyvalue(arg_10_0.listShowOnPanel, iter_10_1)

				table = var_25_4

				var_25_4.insert(arg_10_0.listStayInPanel, iter_10_1)

				var_25_4 = var_0_2
				var_25_4[iter_10_0] = nil
				setAnchoredPosition = var_25_4

				var_25_4(iter_10_1, var_10_23)

				local var_25_5 = iter_10_1

				var_25_4.SetAsLastSibling(var_25_5)
			else
				setParent = var_25_4

				var_25_4(iter_10_1, arg_10_0.pageModified)
				...
				local var_25_6 = var_0_2

				var_25_6[iter_10_0] = var_25_3
				setAnchoredPosition = var_25_6

				var_25_6(iter_10_1, var_25_3)

				local var_25_7 = iter_10_1

				var_7.SetAsLastSibling(var_25_7)
			end
...
function var_0_1.SwitchSelectedImage(arg_26_0, arg_26_1)
	...
	if arg_26_0.lastSelectedImage then
		...
		var_2(var_3.Find(var_26_0, "Selected"), false)
	end
...
function var_0_1.UpdateView(arg_28_0)
	...
	for iter_28_0 = 1, #arg_28_0.pages do
		...
		var_1_10005(arg_28_0.pages[iter_28_0], iter_28_0 == arg_28_0.pageIndex)
	end

	setAnchoredPosition = var_1

	var_1(arg_28_0.medalContainer, {
	...
	var_2(arg_28_0.buttonNext, var_28_0 and arg_28_0.pageIndex == 1)

	setActive = var_2

	var_2(arg_28_0.buttonNextLocked, not var_28_0 and arg_28_0.pageIndex == 1)
	...
	local var_28_1 = arg_28_0.progressText

	setColorStr = var_4
	tostring = var_5

	local var_28_2 = var_5(#arg_28_0.activeIDList)

	COLOR_RED = var_6

	var_2(var_28_1, var_4(var_28_2, var_6) .. "/" .. #arg_28_0.allIDList)
...
function var_0_1.updateMedalView(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_1 = var_4.contains(arg_30_0.activeIDList, arg_30_2)
	...
	setImageAlpha = var_30_7

	var_30_7(var_30_4, var_30_1 and 1 or 0)

	setActive = var_30_7

	var_30_7(var_30_6, var_30_2)

	setActive = var_30_7

	var_30_7(var_30_8, var_30_3)
	...
	local function var_30_11()
		...
		var_31_1(var_31_0, var_2_10002.MEMORYBOOK_UNLOCK, {
			id = arg_30_2,
	...
	var_30_7(var_30_9, var_30_10, var_30_11, var_1_10015)

	local var_30_12 = ""

	setText = var_30_9

	var_30_9(var_30_8, var_30_12)
...
function var_0_1.checkAward(arg_35_0)
	if #arg_35_0.activeIDList == #arg_35_0.allIDList and arg_35_0.activityData.data1 ~= 1 then
		...
		var_35_1(var_35_0, var_1_10003.ACTIVITY_OPERATION, {
			cmd = 1,
