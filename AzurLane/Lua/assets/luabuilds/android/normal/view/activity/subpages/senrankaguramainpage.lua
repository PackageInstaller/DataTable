...
function var_0_1.OnInit(arg_1_0)
	...
	for iter_1_0 = 1, arg_1_0.totalNum do
		...
		var_1_3.insert(arg_1_0.children, var_1_4)
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "mountain")
	...
	local function var_2_3()
		...
		var_3_1(var_3_0, var_3_2, var_2_10003.SENRANKAGURA_BACKHILL)
	...
	for iter_2_0 = 1, arg_2_0.totalNum do
		...
		var_5.insert(arg_2_0.randomList, iter_2_0)
	end
	...
	function arg_2_0.Interval()
		...
		local var_4_2 = var_2_10002.delayedCall

		go = var_2_10003

		local var_4_3 = var_2_10003(arg_2_0._tf)
		local var_4_4 = var_0_1.SWITCH_INTERVAL

		System = var_2_10005

		var_4_0(var_4_1, var_4_2(var_4_3, var_4_4, var_2_10005.Action(arg_2_0.FadeIn)).uniqueId)
	...
	function arg_2_0.FadeIn()
		...
		LeanTween = var_2_10008

		local var_5_8 = var_2_10008.delayedCall

		go = var_2_10009

		local var_5_9 = var_2_10009(arg_2_0._tf)
		local var_5_10 = var_0_1.SWITCH_TIME + var_0_1.TACHIE_DELAY

		System = var_11

		var_5_6(var_5_7, var_5_8(var_5_9, var_5_10, var_11.Action(arg_2_0.Interval)).uniqueId)
		...
		var_5_6.Foreach(var_5_3, function(arg_6_0, arg_6_1)
			...
			local function var_6_1()
				...
				local var_7_2 = var_4_10002.alpha(arg_6_1, 1, var_0_1.SWITCH_TIME)
				local var_7_3 = var_2.setEase

				LeanTweenType = var_4

				var_7_0(var_7_1, var_7_3(var_7_2, var_4.easeOutSine).uniqueId)
				...
				local var_7_6 = var_2.moveX

				rtf = var_7_2

				local var_7_7 = var_7_6(var_7_2(arg_6_1), 0 + var_6_0, var_0_1.SWITCH_TIME)
				local var_7_8 = var_2.setEase

				LeanTweenType = var_4

				var_7_4(var_7_5, var_7_8(var_7_7, var_4.easeOutSine).uniqueId)
			...
			if var_5_5[arg_6_0] > 0 then
				...
				local var_6_4 = var_6.delayedCall

				go = var_3_10007

				local var_6_5 = var_3_10007(arg_6_1)
				local var_6_6 = var_5_5[arg_6_0]

				System = var_3_10009

				var_6_2(var_6_3, var_6_4(var_6_5, var_6_6, var_3_10009.Action(var_6_1)).uniqueId)
			else
				var_6_1()
			end
		...
		var_6.Foreach(var_5_4, function(arg_8_0, arg_8_1)
			...
			local function var_8_2()
				...
				local var_10_2 = var_4_10002.alpha(arg_8_1, 0, var_0_1.SWITCH_TIME)
				local var_10_3 = var_2.setEase

				LeanTweenType = var_4

				var_10_0(var_10_1, var_10_3(var_10_2, var_4.easeOutSine).uniqueId)
				...
				local var_10_6 = var_2.moveX

				rtf = var_10_2

				local var_10_7 = var_10_6(var_10_2(arg_8_1), -var_5_2 + var_8_0, var_0_1.SWITCH_TIME)
				local var_10_8 = var_2.setOnComplete

				System = var_4

				local var_10_9 = var_10_8(var_10_7, var_4.Action(var_8_1))
				local var_10_10 = var_2.setEase

				LeanTweenType = var_4

				var_10_4(var_10_5, var_10_10(var_10_9, var_4.easeOutSine).uniqueId)
			...
			if var_5_5[arg_8_0] > 0 then
				...
				LeanTween = var_3_10007

				local var_8_5 = var_3_10007.delayedCall

				go = var_3_10008

				local var_8_6 = var_3_10008(arg_8_1)
				local var_8_7 = var_5_5[arg_8_0]

				System = var_3_10010

				var_8_3(var_8_4, var_8_5(var_8_6, var_8_7, var_3_10010.Action(var_8_2)).uniqueId)
			else
				var_8_2()
			end
