...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.items = var_1_1.Clone2Full(var_1_2, 11)
	...
	arg_1_0.tip = var_2.Find(var_1_5, "tip")

	local var_1_6 = arg_1_0.bg

	arg_1_0.slider = var_2.Find(var_1_6, "slider")

	local var_1_7 = arg_1_0.slider

	arg_1_0.leftTime = var_2.Find(var_1_7, "time")
	AutoLoader = var_2
	arg_1_0.loader = var_2.New()

	for iter_1_0 = 1, #var_0_2 do
		local var_1_8 = arg_1_0.loader
		local var_1_9 = var_6.GetSprite
		local var_1_10 = "ui/activityuipage/AprilFoolDiscovery2024Page_atlas"

		string = var_1_10009
		var_1_10009 = var_1_10009.sub(var_0_2, iter_1_0, iter_1_0)

		local var_1_11 = arg_1_0.items[iter_1_0]

		var_1_9(var_1_8, var_1_10, var_1_10009, var_10.Find(var_1_11, "Character"))
	end
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	var_2(var_4_1, var_4.format("keyList has {0}, but items has {1}", #arg_4_0.keyList, #arg_4_0.items))
	...
	local function var_4_8()
		if #arg_4_0.activity.data2_list < #arg_4_0.keyList then
			...
			var_6_1(var_6_0, var_2_10002("caibulin_lock_tip"))
	...
	var_4_2(var_4_6, var_4_7, var_4_8, var_7)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	local var_8_5 = arg_8_0.btnBattle

	var_5(var_6.Find(var_8_5, "Lock"), not var_8_1)
	arg_8_0:UpdateSelection()

	pg = var_5

	local var_8_6 = var_5.activity_event_picturepuzzle[arg_8_0.activity.id]

	table = var_6

	if #var_6.mergeArray(arg_8_0.activity.data1_list, arg_8_0.activity.data2_list, true) >= #var_8_6.pickup_picturepuzzle + #var_8_6.drop_picturepuzzle then
		local var_8_7 = arg_8_0.activity
		local var_8_8 = var_7.getConfig(var_8_7, "config_client").comStory
		...
		arg_8_0:AddFunc(function(arg_11_0)
			...
			var_1.Play(var_11_0, var_8_8, arg_11_0)
