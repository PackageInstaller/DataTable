...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	var_1_10003.insert(var_2_0, function(arg_3_0)
		...
		local var_3_2 = var_2_10003.GET_NEW_SERVER_SHOP
		local var_3_3 = {}

		ActivityConst = var_2_10005
		var_3_3.actType = var_2_10005.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP
...
function var_0_1.setData(arg_6_0)
	...
	local var_6_4 = var_6_3(var_6_2, var_1_10005.ACTIVITY_TYPE_TASKS)

	ipairs = var_6_2

	for iter_6_0, iter_6_1 in var_6_2(var_6_4) do
	...
	local var_6_7 = var_6_6(var_6_5, var_6.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP)
	local var_6_8 = var_6_0
	local var_6_9 = var_6_0.getActivityByType

	ActivityConst = iter_6_0

	local var_6_10 = var_6_9(var_6_8, iter_6_0.ACTIVITY_TYPE_GIFT_UP)
	local var_6_11
...
function var_0_1.init(arg_7_0)
	...
	local var_7_14 = var_7_8.Find(var_7_13, "Image")

	i18n = var_7_13

	var_7_11(var_7_14, var_7_13("blackfriday_task"))

	setText = var_7_11

	local var_7_15 = var_7_10
	local var_7_16 = var_7_10.Find(var_7_15, "Image")

	i18n = var_7_15

	var_7_11(var_7_16, var_7_15("blackfriday_shop"))

	setText = var_7_11

	local var_7_17 = var_7_12
	local var_7_18 = var_7_12.Find(var_7_17, "Image")

	i18n = var_7_17

	var_7_11(var_7_18, var_7_17("blackfriday_gift"))
	...
	arg_7_0.main = var_4.Find(var_7_19, "main")

	local var_7_20 = {}
	local var_7_21 = arg_7_0.main

	var_7_20[1] = var_5.Find(var_7_21, "task_container")

	local var_7_22 = arg_7_0.main

	var_7_20[2] = var_5.Find(var_7_22, "shop_container")

	local var_7_23 = arg_7_0.main

	var_7_20[3] = var_5.Find(var_7_23, "gift_container")
	arg_7_0.pages = var_7_20
	ChargeTipWindow = var_7_20
	arg_7_0.chargeTipWindow = var_7_20.New(arg_7_0._tf, arg_7_0.event)
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_5()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.blackfriday_main_tip.tip
	...
	local var_8_8 = var_3.Find(var_8_7, "gem")
...
function var_0_1.updatePages(arg_15_0)
	if arg_15_0.taskActivity then
		...
		local var_15_3 = var_2.Find(var_15_2, "tip")
		local var_15_4 = arg_15_0.blackFridayTaskPage

		var_1(var_15_3, var_3.isTip(var_15_4))
	end
	...
	if arg_15_0.shopActivity then
		...
		local var_15_9 = var_2.Find(var_15_8, "tip")
		local var_15_10 = arg_15_0.blackFridaySalesShopPage

		var_1(var_15_9, var_3.isTip(var_15_10))
	end
	...
	if arg_15_0.giftActivity then
		...
		local var_15_15 = var_2.Find(var_15_14, "tip")
		local var_15_16 = arg_15_0.blackFridaySalesGiftPage

		var_1(var_15_15, var_3.isTip(var_15_16))
	end
...
function var_0_1.updateTime(arg_17_0)
	...
	local var_17_4 = var_17_2.floor(var_17_3 / 0)

	math = var_5

	local var_17_5 = var_5.floor((var_17_3 - var_17_4 * 0) / 16)
	...
	local var_17_7 = var_1_10008("time_remaining_tip")

	i18n = var_9

	var_6(var_17_6, var_17_7 .. var_9("newserver_time", var_17_4, var_17_5))
...
function var_0_1.onUpdatePlayer(arg_19_0, arg_19_1)
	...
	local var_19_1 = var_3.Find(var_19_0, "gem/gem_value")
	local var_19_2 = arg_19_0.player

	var_1_10002(var_19_1, var_4.getTotalGem(var_19_2))
...
function var_0_1.isShow()
	...
	local var_23_2 = var_1_10002(var_1_10003)
	local var_23_3 = var_2.getActivitiesByType

	ActivityConst = var_1_10004

	local var_23_4 = var_23_3(var_23_2, var_1_10004.ACTIVITY_TYPE_TASKS)

	ipairs = var_23_2

	for iter_23_0, iter_23_1 in var_23_2(var_23_4) do
	...
	local var_23_7 = var_23_6(var_23_5, var_5.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP)
	local var_23_8 = var_23_0
	local var_23_9 = var_23_0.getActivityByType

	ActivityConst = iter_23_0

	local var_23_10 = var_23_9(var_23_8, iter_23_0.ACTIVITY_TYPE_SKIN_COUPON)
...
function var_0_1.isTip()
	...
	local var_24_1 = var_1_10001(var_1_10002)
	local var_24_2 = var_1.getActivitiesByType

	ActivityConst = var_1_10003

	local var_24_3 = var_24_2(var_24_1, var_1_10003.ACTIVITY_TYPE_TASKS)

	ipairs = var_24_1

	for iter_24_0, iter_24_1 in var_24_1(var_24_3) do
	...
	if var_24_0 then
		...
		if not var_24_0.isEnd(var_24_4) then
			...
			local var_24_7 = var_24_0.getConfig(var_24_6, "config_data")

			ipairs = var_24_6

			for iter_24_2, iter_24_3 in var_24_6(var_24_7) do
				ipairs = var_1_10009
				...
				for iter_24_4, iter_24_5 in var_1_10009(iter_24_3) do
					...
					local var_24_8 = var_24_5:getTaskVO(iter_24_5)

					if var_1_10014.getTaskStatus(var_24_8) == 1 then
						return true
					end
				end
			end
