...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	local var_1_0 = var_6(arg_1_0.taskItemTpl, "btnGo/text")

	i18n = var_7

	var_5(var_1_0, var_7(var_0_7))
	...
	local function var_1_16()
		...
		var_0(var_1(arg_1_0.btnAll, "text_selected"), true)

		setActive = var_0
		findTF = var_1

		var_0(var_1(arg_1_0.btnAll, "text"), false)

		setImageColor = var_0
		findTF = var_1

		local var_3_1 = var_1(arg_1_0.btnAll, "bg")

		Color = var_2

		var_0(var_3_1, var_2.New(1, 0.9882352941176471, 0.9098039215686274, 1))
	...
	var_5(var_1_14, var_1_15, var_1_16, var_1_10009)
	...
	local function var_1_19()
		...
		var_0(var_1(arg_1_0.btnDaily, "text_selected"), true)

		setActive = var_0
		findTF = var_1

		var_0(var_1(arg_1_0.btnDaily, "text"), false)

		setImageColor = var_0
		findTF = var_1

		local var_4_1 = var_1(arg_1_0.btnDaily, "bg")

		Color = var_2

		var_0(var_4_1, var_2.New(1, 0.9882352941176471, 0.9098039215686274, 1))
	...
	var_5(var_1_17, var_1_18, var_1_19, var_1_10009)
	...
	local function var_1_22()
		...
		var_0(var_1(arg_1_0.btnMain, "text_selected"), true)

		setActive = var_0
		findTF = var_1

		var_0(var_1(arg_1_0.btnMain, "text"), false)

		setImageColor = var_0
		findTF = var_1

		local var_5_1 = var_1(arg_1_0.btnMain, "bg")

		Color = var_2

		var_0(var_5_1, var_2.New(1, 0.9882352941176471, 0.9098039215686274, 1))
	...
	var_5(var_1_20, var_1_21, var_1_22, var_1_10009)
	...
	local function var_1_25()
		...
		var_6_2(var_6_1, var_2_10003.SUBMIT_TASK_ALL, {
	...
	var_5(var_1_23, var_1_24, var_1_25, var_1_10009)
...
function var_0_0.clearTagBtn(arg_8_0)
	...
	var_1_10001(var_1_10002(arg_8_0.btnAll, "bg_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnDaily, "bg_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnMain, "bg_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnMain, "text_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnDaily, "text_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnAll, "text_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnMain, "text"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnDaily, "text"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_8_0.btnAll, "text"), true)

	setImageColor = var_1_10001
	findTF = var_2

	local var_8_0 = var_2(arg_8_0.btnMain, "bg")

	Color = var_3

	var_1_10001(var_8_0, var_3.New(0.7372549019607844, 0.6352941176470588, 0.5882352941176471, 1))
	...
	var_1_10001(var_8_1, var_3.New(0.7372549019607844, 0.6352941176470588, 0.5882352941176471, 1))
	...
	var_1_10001(var_8_2, var_3.New(0.7372549019607844, 0.6352941176470588, 0.5882352941176471, 1))
...
function var_0_0.onUpdateTaskItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_11 = var_3:getConfig("type")
	local var_9_12 = var_3
	local var_9_13 = var_3.getConfig(var_9_12, "priority_type")

	setScrollText = var_9_12
	findTF = var_18

	var_9_12(var_18(arg_9_2, "desc/text"), var_9_2)

	PLATFORM_CODE = var_9_12
	PLATFORM_CH = var_9_14
	...
	if not var_9_4 then
		setText = var_9_12
		findTF = var_9_14
		var_9_14 = var_9_14(arg_9_2, "progressDesc/text")
		setColorStr = var_19

		local var_9_15 = var_19(var_9_1, "#51382E")
		local var_9_16 = " / "

		setColorStr = var_21

		var_9_12(var_9_14, var_9_15 .. var_9_16 .. var_21(var_9_6, "#51382E"))
	else
		setText = var_9_12
		findTF = var_9_14

		var_9_12(var_9_14(arg_9_2, "progressDesc/text"), "--/--")
	end

	setSlider = var_9_12
	findTF = var_9_14

	var_9_12(var_9_14(arg_9_2, "progressBar"), 0, 1, var_9_4 and 1 or var_9_1 / var_9_6)

	pg = var_9_12

	local var_9_17 = var_9_12.task_data_template[var_9_0].award_display

	findTF = var_19

	if var_19(arg_9_2, "awardDisplay/viewport/content").childCount < #var_9_17 then
		local var_9_18 = #var_9_17 - var_20

		for iter_9_0 = 1, var_9_18 do
			tf = var_1_10026
			Instantiate = var_1_10027
			var_1_10026 = var_1_10026(var_1_10027(arg_9_0.iconTpl))
	...
	for iter_9_1 = 1, var_19.childCount do
		local var_9_19 = var_19:GetChild(iter_9_1 - 1)
		local var_9_20

		if iter_9_1 <= #var_9_17 then
			var_9_20 = var_9_17[iter_9_1]
			...
			var_28(var_9_19, var_9_21)

			onButton = var_28

			local var_9_22 = arg_9_0._event
			local var_9_23 = var_9_19
			...
			local function var_9_24()
				...
				var_10_1(var_10_0, var_2_10002.ON_DROP, var_9_21)
			...
			var_28(var_9_22, var_9_23, var_9_24, var_1_10032)

			setActive = var_28

			var_28(var_9_19, true)
		else
			setActive = var_9_20

			var_9_20(var_9_19, false)
		end
	end
	...
	var_21(var_22(arg_9_2, "btnGo"), not var_9_4 and not var_9_5 and var_9_10 ~= 1006)

	setActive = var_21
	findTF = var_22

	var_21(var_22(arg_9_2, "btnGet"), not var_9_4 and var_9_5 and not var_9_9)

	setActive = var_21
	findTF = var_22

	var_21(var_22(arg_9_2, "btnGot"), var_9_5)

	setSlider = var_21
	findTF = var_22

	var_21(var_22(arg_9_2, "progressBar"), 0, 1, var_9_1 / var_9_6)

	local var_9_25

	if var_9_13 == var_0_1 then
		if var_9_11 == 16 and var_9_10 == 20 then
			var_9_25 = var_0_5
		else
			var_9_25 = var_0_3
		end
	...
	local var_9_26 = var_23(arg_9_2, "tag/text")

	i18n = var_24

	var_22(var_9_26, var_24(var_9_25))

	onButton = var_22

	local var_9_27 = arg_9_0._event

	findTF = var_24

	local var_9_28 = var_24(arg_9_2, "btnGo")

	local function var_9_29()
		local var_11_0 = arg_9_0._event
		local var_11_1 = var_0.emit

		OtherWorldTaskMediator = var_2_10002

		var_11_1(var_11_0, var_2_10002.TASK_GO, {
			taskVO = var_0
		})
	...
	var_22(var_9_27, var_9_28, var_9_29, var_26)

	onButton = var_22

	local var_9_30 = arg_9_0._event

	findTF = var_9_28

	local var_9_31 = var_9_28(arg_9_2, "btnGet")
	...
	local function var_9_32()
		...
		var_12_5(var_12_4, var_2_10004.SUBMIT_TASK, {
	...
	var_22(var_9_30, var_9_31, var_9_32, var_26)
