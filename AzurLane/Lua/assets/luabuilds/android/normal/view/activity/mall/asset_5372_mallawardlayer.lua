...
function var_0_1.init(arg_2_0)
	...
	local function var_2_6()
		...
		MallAwardMediator = var_2_10002

		var_4_1(var_4_0, var_2_10002.INPUT_GOLD, arg_2_0.activity.id, arg_2_0.curGold)
	...
	local function var_2_9()
		...
		local var_5_4 = var_2_10003.GET_PT_AWARD
		local var_5_5 = {
			cmd = 4
		}
	...
	arg_2_0.awardUIList = var_2_12(var_2_13, var_3.Find(var_2_14, "tpl"))
	...
	var_1(var_2_16, var_3("mall_input_header"))
	...
	var_1(var_2_17, var_3("common_already owned"))
	...
	var_1(var_2_18, var_3("mall_get_all_btn"))
	...
	var_1(var_2_19, var_3("mall_input_btn"))
	...
	local var_2_21 = var_2.Find(var_2_20, "go/Text")

	i18n = var_2_20

	var_1(var_2_21, var_2_20("task_go"))

	setText = var_1

	local var_2_22 = arg_2_0.uiTaskTpl
	local var_2_23 = var_2.Find(var_2_22, "get/Text")

	i18n = var_2_22

	var_1(var_2_23, var_2_22("task_get"))

	setText = var_1

	local var_2_24 = arg_2_0.uiTaskTpl
	local var_2_25 = var_2.Find(var_2_24, "got/Text")

	i18n = var_2_24

	var_1(var_2_25, var_2_24("task_got"))

	setText = var_1

	local var_2_26 = arg_2_0.uiAwardTF
	local var_2_27 = var_2.Find(var_2_26, "tpl/target/icon/Text")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("target_get_tip"))

	setText = var_1

	local var_2_28 = arg_2_0.uiAwardTF
	local var_2_29 = var_2.Find(var_2_28, "tpl/get/Text")

	i18n = var_2_28

	var_1(var_2_29, var_2_28("mall_award_can_get"))

	setText = var_1

	local var_2_30 = arg_2_0.uiAwardTF
	local var_2_31 = var_2.Find(var_2_30, "tpl/got/Text")

	i18n = var_2_30

	var_1(var_2_31, var_2_30("mall_award_got"))
...
function var_0_1.UpdateData(arg_11_0)
	...
	arg_11_0.activity = var_11_1(var_11_0, var_1_10004.ACTIVITY_TYPE_MALL)
	...
	arg_11_0.ptActivity = var_11_4(var_11_3, var_4.getConfig(var_11_5, "config_id"))
...
function var_0_1.UpdateAwardView(arg_12_0)
	...
	var_1_10001(var_12_0, var_3.CanGetAward(var_12_1))
...
function var_0_1.UpdateAwardTpl(arg_13_0, arg_13_1, arg_13_2)
	...
	var_7(arg_13_2:Find("award"), var_13_3)

	onButton = var_7

	local var_13_4 = arg_13_0
	local var_13_5 = arg_13_2:Find("award")
	...
	local function var_13_6()
		...
		var_14_1(var_14_0, var_2_10002.ON_DROP, var_13_3)
	...
	var_7(var_13_4, var_13_5, var_13_6, var_11)

	local var_13_7 = var_13_0 <= arg_13_0.ptData.level

	setActive = var_13_4

	var_13_4(arg_13_2:Find("got"), var_13_7)

	setActive = var_13_4

	var_13_4(arg_13_2:Find("get"), not var_13_7 and var_13_2 <= arg_13_0.inputGold)

	local var_13_8 = arg_13_0.ptDataUnlockStamps[var_13_0]

	setActive = var_9

	var_9(arg_13_2:Find("lock"), var_13_8)

	if var_13_8 then
		pg = var_9

		local var_13_9 = var_9.TimeMgr.GetInstance()

		setActive = var_10

		var_10(arg_13_2:Find("lock"), var_13_8 > var_13_9:GetServerTime())

		local var_13_10 = var_13_9:STimeDescS(var_13_8, "%m")
		local var_13_11 = var_13_9
		local var_13_12 = var_13_9.STimeDescS(var_13_11, var_13_8, "%d")

		setText = var_13_11

		local var_13_13 = arg_13_2
		local var_13_14 = arg_13_2.Find(var_13_13, "lock/Text")

		i18n = var_13_13

		var_13_11(var_13_14, var_13_13("mall_unlock_date_tip2", var_13_10, var_13_12))
	end
...
function var_0_1.UpdateTaskView(arg_15_0)
	...
	local var_15_1 = var_15_0(var_2)

	ipairs = var_2

	local var_15_2 = arg_15_0.activity

	for iter_15_0, iter_15_1 in var_2(var_3.getConfig(var_15_2, "config_client").story_task) do
		local var_15_3 = var_15_1
		local var_15_4 = var_15_1.getTaskVO(var_15_3, iter_15_1)

		table = var_15_3

		var_15_3.insert(arg_15_0.storyTaskList, var_15_4)
	end

	ipairs = var_2

	local var_15_5 = arg_15_0.activity

	for iter_15_2, iter_15_3 in var_2(var_3.getConfig(var_15_5, "config_client").daily_task) do
		local var_15_6 = var_15_1
		local var_15_7 = var_15_1.getTaskVO(var_15_6, iter_15_3)

		table = var_15_6

		var_15_6.insert(arg_15_0.dailyTaskList, var_15_7)
	end

	arg_15_0:SortTaskList(arg_15_0.storyTaskList)
	arg_15_0:SortTaskList(arg_15_0.dailyTaskList)

	local var_15_8 = arg_15_0.storyTaskUIList

	var_2.align(var_15_8, #arg_15_0.storyTaskList)

	local var_15_9 = arg_15_0.dailyTaskUIList

	var_2.align(var_15_9, #arg_15_0.dailyTaskList)
...
function var_0_1.UpdateTaskTpl(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_2 = arg_20_1.getConfig(var_20_1, "target_num")

	setText = var_20_1

	var_20_1(arg_20_2:Find("slider/progress"), var_20_0 .. "/" .. var_20_2)

	setSlider = var_20_1

	var_20_1(arg_20_2:Find("slider"), 0, 1, var_20_0 / var_20_2)

	onButton = var_20_1

	local var_20_3 = arg_20_0
	local var_20_4 = arg_20_2:Find("go")
	...
	local function var_20_5()
		...
		var_21_1(var_21_0, var_2_10002.TASK_GO, arg_20_1)
	...
	var_20_1(var_20_3, var_20_4, var_20_5, var_9)

	onButton = var_20_1

	local var_20_6 = arg_20_0
	local var_20_7 = arg_20_2:Find("get")
	...
	local function var_20_8()
		...
		var_22_1(var_22_0, var_2_10002.SUBMIT_TASK, arg_20_1)
	...
	var_20_1(var_20_6, var_20_7, var_20_8, var_9)

	local var_20_9 = arg_20_1
	local var_20_10 = arg_20_1.getTaskStatus(var_20_9)

	setActive = var_20_9

	var_20_9(arg_20_2:Find("go"), var_20_10 == 0)

	setActive = var_20_9

	var_20_9(arg_20_2:Find("get"), var_20_10 == 1)

	setActive = var_20_9

	var_20_9(arg_20_2:Find("got"), var_20_10 == 2)

	local var_20_11 = arg_20_1
	local var_20_12 = arg_20_1.getConfig(var_20_11, "award_display")[1]

	setActive = var_20_11

	var_20_11(arg_20_2:Find("award"), var_20_12)

	if var_20_12 then
		Drop = var_20_11

		local var_20_13 = var_20_11.Create(var_20_12)

		updateDrop = var_8

		var_8(arg_20_2:Find("award"), var_20_13)

		onButton = var_8

		local var_20_14 = arg_20_0
		local var_20_15 = arg_20_2:Find("award")
		...
		local function var_20_16()
			...
			var_23_1(var_23_0, var_2_10002.ON_DROP, var_20_13)
		...
		var_8(var_20_14, var_20_15, var_20_16, var_12)
	end
...
function var_0_1.IsAwardTip()
	...
	local var_25_0 = var_1_10000(var_1_10001)
	local var_25_1 = var_0.getActivityByType

	ActivityConst = var_1_10003

	local var_25_2 = var_25_1(var_25_0, var_1_10003.ACTIVITY_TYPE_MALL)
	local var_25_3 = var_0
	local var_25_4 = var_0.getActivityById(var_25_3, var_25_2:getConfig("config_id"))

	Activity = var_25_3

	return var_25_3.IsActivityReady(var_25_4)
end
...
function var_0_1.IsInputTip()
	...
	local var_26_2 = var_26_1(var_26_0, var_1_10003.ACTIVITY_TYPE_MALL)
	local var_26_3 = var_0
	local var_26_4 = var_0.getActivityById(var_26_3, var_26_2:getConfig("config_id"))

	ActivityPtData = var_26_3

	local var_26_5 = var_26_3.New(var_26_4)
	local var_26_6 = var_26_2:GetGold()

	local function var_26_7()
		local var_27_0 = var_26_5
		local var_27_1, var_27_2, var_27_3 = var_0.GetResProgress(var_27_0)

		return var_27_2 <= var_27_1 + var_26_6
	end

	local var_26_8

	if var_26_5:CanGetNextAward() then
		var_26_8 = var_26_7()
	end
...
function var_0_1.IsTaskTip()
	...
	local var_28_2 = var_28_1(var_28_0, var_1_10002.ACTIVITY_TYPE_MALL)

	table = var_28_0

	local var_28_3 = var_28_0.mergeArray(var_28_2:getConfig("config_client").story_task, var_28_2:getConfig("config_client").daily_task)

	getProxy = var_2
	TaskProxy = var_3

	local var_28_4 = var_2(var_3)
