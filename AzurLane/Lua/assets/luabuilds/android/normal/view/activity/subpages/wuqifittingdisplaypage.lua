...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10003(var_1_10004))
	...
	local function var_2_5()
		...
		local var_4_2 = var_2_10002(var_2_10003)
		local var_4_3, var_4_4 = var_4_1(var_4_0, var_2.getData(var_4_2).level, "TechnologyMediator")

		if not var_4_3 then
			pg = var_2

			local var_4_5 = var_2.TipsMgr.GetInstance()

			var_2.ShowTips(var_4_5, var_4_4)
