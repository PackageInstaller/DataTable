...
function var_0_1.initData(arg_5_0)
	...
	Clone = var_5_0
	pg = var_3
	arg_5_0.taskIDList = var_5_0(var_3.task_data_template[var_5_1].target_id)
	getProxy = var_2
	TaskProxy = var_3
	arg_5_0.taskProxy = var_2(var_3)
	arg_5_0.taskVOList = {}
	ipairs = var_2
	...
	for iter_5_0, iter_5_1 in var_2(arg_5_0.taskIDList) do
		...
		var_5_2.insert(arg_5_0.taskVOList, var_5_3)
	end
...
function var_0_1.initUI(arg_6_0)
	...
	var_1(var_6_5, var_6_6, var_6_7, var_1_10005)
...
function var_0_1.updateProgress(arg_8_0)
	...
	var_3(var_8_2, var_5.format("%2d", var_8_1))
	...
	var_3(var_8_3, var_5.format("%2d", var_8_0))
...
function var_0_1.updateTaskList(arg_9_0)
	...
	var_1.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local var_10_4 = arg_10_2:Find("ItemBG/Icon")
			local var_10_5 = arg_10_2
			local var_10_6 = arg_10_2.Find(var_10_5, "ItemBG/Finished")

			setText = var_10_5

			local var_10_7 = var_10_1

			string = var_2_10011

			var_10_5(var_10_7, var_2_10011.format("%02d", arg_10_1))

			setText = var_10_5

			local var_10_8 = var_10_2
			local var_10_9 = "TASK-"

			string = var_12

			var_10_5(var_10_8, var_10_9 .. var_12.format("%02d", arg_10_1))

			local var_10_10 = var_10_0
			local var_10_11 = var_10_0.getConfig(var_10_10, "desc")

			setText = var_10_10

			var_10_10(var_10_3, var_10_11)

			tonumber = var_10_10

			local var_10_12 = var_10_0
			local var_10_13 = var_10_10(var_10_0.getConfig(var_10_12, "target_id"))

			pg = var_11

			if not var_11.ship_data_statistics[var_10_13] then
				var_10_13 = 205054
			end

			pg = var_11

			local var_10_14 = var_11.ship_data_statistics[var_10_13].skin_id

			pg = var_10_12

			local var_10_15 = var_10_12.ship_skin_template[var_10_14].painting

			LoadImageSpriteAsync = var_13

			var_13("SquareIcon/" .. var_10_15, var_10_4)

			local var_10_16 = var_10_0
			local var_10_17 = var_10_0.getTaskStatus(var_10_16)

			setActive = var_10_16

			var_10_16(var_10_6, var_10_17 >= 1)
		end
