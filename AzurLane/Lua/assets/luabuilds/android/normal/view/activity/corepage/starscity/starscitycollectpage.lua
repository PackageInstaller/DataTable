...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.EscapeManor.EscapeManorCollectPage"))
...
function var_0_1.AddSpecialBtnListener(arg_2_0)
	...
	if arg_2_0.equipSkinBoxBtn and var_2_1.equipskin_box_link then
		...
		var_2_11(var_2_13, var_2_14, var_2_15, var_1_10007)
	end
