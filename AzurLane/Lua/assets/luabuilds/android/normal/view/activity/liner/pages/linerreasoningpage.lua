...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_1, var_3("liner_event_reasoning_title"))
	...
	local var_2_8 = var_2_7(var_2_6, var_3(var_4))
...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.cluesUIList = var_3_4(var_3_5, var_3.Find(var_3_6, "tpl"))
	...
	arg_3_0.optionsUIList = var_3_8(var_3_9, var_3.Find(var_3_10, "tpl"))
	...
	var_1.make(var_3_11, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			local function var_6_3()
				...
				LinerLogBookMediator = var_3_10002

				local var_7_2 = var_3_10002.GET_EVENT_AWARD
				local var_7_3 = arg_3_0.actId
				local var_7_4 = arg_3_0.groupIdx
				local var_7_5 = var_6_0
				local var_7_6 = arg_3_0.eventGroup

				var_7_1(var_7_0, var_7_2, var_7_3, var_7_4, var_7_5, var_6.GetDrop(var_7_6))
...
function var_0_1.ShowOptions(arg_8_0, arg_8_1, arg_8_2)
	...
	var_4(var_8_1, var_6.GetTitle(var_8_2))
	...
	for iter_8_0 = 1, #arg_8_0.options do
		...
		var_1_10009.insert(var_8_6, function(arg_9_0)
			local var_9_0 = arg_8_0
			local var_9_1 = var_1.managedTween

			LeanTween = var_2_10003

			var_9_1(var_9_0, var_2_10003.delayedCall, function()
