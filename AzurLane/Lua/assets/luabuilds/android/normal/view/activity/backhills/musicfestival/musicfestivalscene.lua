...
function var_0_1.init(arg_2_0)
	...
	import = var_2
	arg_2_0.graphPath = var_2_19(var_2("GameCfg/BackHillGraphs/MusicFestivalGraph"))
	arg_2_0._loadingRequest = {}
	arg_2_0._ReturnRequest = {}

	local var_2_20 = "ouxiangxiaoditu"

	LoadPrefabRequestPackage = var_2

	local var_2_21 = var_2.New("ui/" .. var_2_20, var_2_20, function(arg_3_0)
		...
		local var_3_2 = var_3_1(var_3_0, var_3(var_2_10004)).sortingOrder
	...
	var_2_21.insert(arg_2_0._loadingRequest, var_2_22)
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1_10001(arg_4_0, arg_4_0.btn_actskin, function()
		...
		local var_7_3 = var_2_10003.ACTIVITY
		local var_7_4 = {}

		ActivityConst = var_2_10005
		var_7_4.id = var_2_10005.MUSIC_CHUIXUE7DAY_ID
	...
	var_1_10001(arg_4_0, arg_4_0.btn_ins, function()
		...
		var_8_5.id = var_2_10006.IDOL_INS_ID
	...
	var_1_10001(arg_4_0, arg_4_0._xiefei, function()
		...
		ActivityConst = var_2_10005
		var_9_4.id = var_2_10005.MUSIC_FESTIVAL_ID
	...
	arg_4_0:InitFacility(arg_4_0.stage, function()
		...
		var_10_1(var_10_0, var_2_10002.GO_MINI_GAME, 6)
	...
	arg_4_0:InitFacility(arg_4_0.screen, function()
		...
		ActivityConst = var_2_10005
		var_11_4.id = var_2_10005.IDOL_PT_ID
	...
	arg_4_0:InitFacility(arg_4_0.shop, function()
		...
		local var_12_3 = var_2_10003.SHOP
		local var_12_4 = {}

		NewShopsScene = var_2_10005
		var_12_4.warp = var_2_10005.TYPE_ACTIVITY
	...
	arg_4_0:InitFacility(arg_4_0.painting, function()
		...
		var_13_1(var_13_0, var_13_2, var_2_10003.SKINSHOP)
	...
	arg_4_0:InitFacility(arg_4_0.cube, function()
		...
		var_14_1(var_14_0, var_14_2, var_2_10003.GETBOAT, {
			projectName = "new",
			page = 1
		})
	...
	arg_4_0:InitFacility(arg_4_0.foutain, function()
		...
		var_15_1.mediator = var_2_10002
		IdolMedalCollectionView = var_2_10002
		var_15_1.viewComponent = var_2_10002
		var_15_1.data = {}
		...
		var_15_4(var_15_3, var_2_10003.GO_SUBLAYER, var_15_2, function()
			setActive = var_3_10000
	...
	arg_4_0:InitFacility(arg_4_0.door, function()
		...
		if var_18_1 then
			...
			if not var_2_10003.isUnlock(var_18_3) then
				pg = var_2_10003

				local var_18_4 = var_2_10003.TipsMgr.GetInstance()
				local var_18_5 = var_3.ShowTips

				i18n = var_2_10005

				var_18_5(var_18_4, var_2_10005("common_activity_end"))
			else
				local var_18_6 = arg_4_0
				local var_18_7 = var_3.emit

				MusicFestivalMediator = var_2_10005

				local var_18_8 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_18_7(var_18_6, var_18_8, var_2_10006.LEVEL, {
					chapterId = var_18_2,
					mapIdx = var_18_1
				})
			end
...
function var_0_1.UpdateView(arg_19_0)
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10004.MUSIC_FESTIVAL_ID)
	local var_19_3
	...
	var_4(arg_19_0._modeltip, var_19_3)
	...
	local var_19_8 = var_19_7(var_19_6, var_1_10007.MUSIC_CHUIXUE7DAY_ID) and not var_5:isEnd() and var_5:readyToAchieve()

	setActive = var_19_6

	var_19_6(var_19_5, var_19_8)

	local var_19_9 = arg_19_0.btn_ins
	local var_19_10 = var_6.Find(var_19_9, "tip")

	getProxy = var_19_9
	InstagramProxy = var_8

	local var_19_11 = var_19_9(var_8)
	...
	IdolPTPage = var_19_13

	local var_19_15 = var_19_13.NeedTip()
	...
	local var_19_21 = var_19_19(var_11)
...
function var_0_1.getStudents(arg_21_0)
	...
	if not var_21_2(var_21_1, var_1_10005.MUSIC_FESTIVAL_ID) then
		return var_21_0
	end

	local var_21_3 = var_3
	local var_21_4

	if var_3.getConfig(var_21_3, "config_client") then
		var_21_4 = var_21_4.stage_off_ship
	end

	if var_21_4 then
		Clone = var_21_3

		local var_21_5 = var_21_3(var_21_4)
		local var_21_6 = 0
		local var_21_7 = #var_21_5

		while var_21_6 < 3 and 0 < var_21_7 do
			math = var_21_8

			local var_21_8 = var_21_8.random(1, var_21_7)

			table = var_8

			var_8.insert(var_21_0, var_21_5[var_21_8])

			var_21_5[var_21_8] = var_21_5[var_21_7]
			var_21_7 = var_21_7 - 1
			var_21_6 = var_21_6 + 1
		end
	end
...
function var_0_1.updateStudents(arg_23_0)
	...
	local var_23_1 = arg_23_0.getStudents(var_23_0)
	...
	for iter_23_0, iter_23_1 in var_23_0(var_23_1) do
		if not arg_23_0.academyStudents[iter_23_0] then
			...
			local var_23_2 = var_7(arg_23_0._shipTpl, arg_23_0._map).gameObject

			var_23_2.name = iter_23_0
			SummerFeastNavigationAgent = var_23_2

			local var_23_3 = var_23_2.New(var_7.gameObject)

			var_8.attach(var_23_3)
			...
			var_8:SetOnTransEdge(function(arg_24_0, arg_24_1, arg_24_2)
				...
				math = var_4
				arg_24_2 = var_4.max(arg_24_1, arg_24_2)
				arg_24_1 = var_24_0
	...
	if #var_23_1 > 0 then
		...
		local var_23_4 = arg_23_0.sortTimer

		var_2.Start(var_23_4)
...
function var_0_1.getStageShip(arg_26_0)
	...
	if not var_26_1(var_26_0, var_1_10004.MUSIC_FESTIVAL_ID) then
		return
	end
	...
	if var_2:getConfig("config_client") and var_3.stage_on_ship then
		...
		return var_4[var_1_10006.random(1, var_26_2)], var_4.action[1]
	end
...
function var_0_1.updateStageShip(arg_27_0)
	...
	if var_27_0 then
		GetSpineRequestPackage = var_1_10003

		local var_27_2 = var_1_10003.New(var_27_0, function(arg_28_0)
			local var_28_0 = arg_28_0
			local var_28_1 = arg_28_0.SetLocalScale

			Vector3 = var_2_10003

			var_28_1(var_28_0, var_2_10003(0.5, 0.5, 1))
			...
			local var_28_5 = var_27_0

			ReturnSpineRequestPackage = var_3
			var_28_4[var_28_5] = var_3.New(var_27_0, arg_28_0)

			return
		end)
		local var_27_3 = var_3.Start(var_27_2)

		arg_27_0._loadingRequest[var_27_0] = var_27_3
	end
	...
	for iter_29_0, iter_29_1 in var_2(var_29_0) do
		if iter_29_1.childCount > 1 then
			...
			for iter_29_2 = 1, iter_29_1.childCount do
				...
				local var_29_3 = iter_29_1.GetChild(var_29_2, iter_29_2 - 1)

				table = var_29_2

				var_29_2.insert(var_29_1, {
					tf = var_29_3,
					index = iter_29_2
				})
			end
			...
			for iter_29_3, iter_29_4 in var_8(var_29_1) do
				local var_29_4 = iter_29_4.tf

				var_13.SetSiblingIndex(var_29_4, iter_29_3 - 1)
			end
		end
	end
...
function var_0_1.MedalTip()
	...
	local var_33_2 = var_33_1(var_33_0, var_1_10002.ACTIVITY_TYPE_PUZZLA)
