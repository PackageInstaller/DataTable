...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_48 = var_2.Find(var_1_47, "window/top/bg/infomation/title")

	i18n = var_1_47

	var_1(var_1_48, var_1_47("words_information"))

	setText = var_1

	local var_1_49 = arg_1_0.singleBuffBox
	local var_1_50 = var_2.Find(var_1_49, "window/sure_btn/pic")

	i18n = var_1_49

	var_1(var_1_50, var_1_49("text_confirm"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_5(var_3_0, function()
			...
			local var_5_9 = var_3_10006.EVENT_PT_OPERATION
			local var_5_10 = {
				cmd = 1
			}
			local var_5_11 = arg_2_0.ptData

			var_5_10.activity_id = var_8.GetId(var_5_11)
	...
	local function var_2_5()
		...
		if var_2.fightLinkActID then
			...
			var_7_6(var_7_5, var_2_10006.SKIP_ACTIVITY_MAP, var_3)
		...
		if not var_7_0 then
			...
			var_7_8(var_7_7, var_2_10006.BATTLE_OPERA)
		elseif var_7_1 and not var_7_1:isEnd() then
			...
			var_7_10(var_7_9, var_2_10006.BATTLE_OPERA)
		else
			...
			var_7_12(var_7_11, var_2_10006("common_activity_end"))
		end
	...
	local function var_2_8()
		...
		i18n = var_2_10003
		var_8_2.helps = var_2_10003("doa_pt_help")
	...
	var_1.SetEndEvent(var_2_13, function()
		...
		var_10_2(var_10_1, var_2_10002.delayedCall, function()
	...
	var_1.SetEndEvent(var_2_15, function()
		...
		var_12_2(var_12_1, var_2_10002.delayedCall, function()
...
function var_0_1.showUpEffect(arg_14_0, arg_14_1)
	...
	if var_2.GetBuffLevelProgress(var_14_0) == 8 or var_2 == 9 then
		...
		var_14_0(arg_14_0.starEffect, true)

		local var_14_1 = arg_14_0.starEffect
		local var_14_2 = var_14_0.GetComponent(var_14_1, "Animator")

		var_14_0.Play(var_14_2, "saoguang_anim", -1, 0)
	else
		setActive = var_14_0

		var_14_0(arg_14_0.shieldEffect, true)

		local var_14_3 = arg_14_0.shieldEffect
		local var_14_4 = var_14_0.GetComponent(var_14_3, "Animator")

		var_14_0.Play(var_14_4, "saoguang_anim", -1, 0)
	end

	setActive = var_14_0

	var_14_0(arg_14_0.mask, true)

	pg = var_14_0

	local var_14_5 = var_14_0.UIMgr.GetInstance()
...
function var_0_1.updateLevelPanel(arg_15_0)
	...
	var_1_10003(arg_15_0.f2aPanel, false)

	setActive = var_1_10003

	var_1_10003(arg_15_0.sPanel, false)

	setActive = var_1_10003

	var_1_10003(arg_15_0.sssPanel, false)
	...
	local var_15_4 = var_4.Find(var_15_3, "bar")
	local var_15_5 = arg_15_0.lvBarImages
	local var_15_6 = var_5.Find(var_15_5, var_15_1)
	local var_15_7 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_3(var_15_4, var_15_7(var_15_6, var_7(var_1_10008)).sprite)

	setImageSprite = var_3

	local var_15_8 = arg_15_0.curPanel
	local var_15_9 = var_4.Find(var_15_8, "lv_tag")
	local var_15_10 = arg_15_0.lvTagImages
	local var_15_11 = var_5.Find(var_15_10, var_15_1)
	local var_15_12 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_3(var_15_9, var_15_12(var_15_11, var_7(var_1_10008)).sprite, true)
...
function var_0_1.OnUpdateFlush(arg_16_0)
	...
	if 1 <= var_16_9 then
		...
		if not var_10(var_16_11, var_12) then
			var_16_12 = var_16_7
		end
		...
		var_16_19(arg_16_0.battleBtn, var_16_18 and not var_16_14 and var_16_16)

		setActive = var_16_19

		var_16_19(arg_16_0.getBtn, var_16_14)

		setActive = var_16_19

		var_16_19(arg_16_0.getGreyBtn, not var_16_14)

		setActive = var_16_19

		var_16_19(arg_16_0.gotBtn, not var_16_16 and not var_16_20)
		...
		var_16_19(var_16_21, var_14.isInBuffTime(var_16_22))

		local var_16_23 = arg_16_0.ptData
		local var_16_24 = var_12.GetAward(var_16_23)

		updateDrop = var_16_23

		var_16_23(arg_16_0.awardTF, var_16_24)
		...
		local function var_16_27()
			...
			var_17_1(var_17_0, var_2_10002.ON_DROP, var_16_24)
		...
		var_16_23(var_16_25, var_16_26, var_16_27, var_1_10017)

		ipairs = var_16_23

		local var_16_28 = arg_16_0.ptData

		for iter_16_0, iter_16_1 in var_16_23(var_14.GetCurBuffInfos(var_16_28)) do
			setText = var_1_10018
...
function var_0_1.showTrianPanel(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_2(arg_18_0.trainSkillBtns) do
		...
		var_1_10007(var_18_2, var_18_3, var_18_4, var_1_10011)
	end
	...
	var_2(var_18_5, var_18_6, var_18_7, iter_18_1)
	;(function()
		ipairs = var_2_10000
...
function var_0_1.flushTrainPanel(arg_23_0)
	...
	if var_1.GetCurBuffInfos(var_23_0) then
		...
		for iter_23_0, iter_23_1 in var_23_0(var_1) do
			setText = var_1_10007

			local var_23_1 = arg_23_0.trainSkillBtns[iter_23_1.group]
			local var_23_2 = var_8.Find(var_23_1, "lv_bg/lv")
			local var_23_3
	...
	for iter_23_2, iter_23_3 in var_23_0(arg_23_0.trainSkillBtns) do
	...
	if arg_23_0.selectIndex then
		...
		var_2(var_23_4, var_4.benefit_buff_template[arg_23_0.selectBuffId].desc)
		...
		var_2(var_23_5, var_4.benefit_buff_template[arg_23_0.selectNewBuffId].desc)
	else
		setActive = var_2
...
function var_0_1.showMsgBox(arg_26_0)
	if arg_26_0.selectBuffId then
		...
		var_1(var_26_0, var_3(var_26_1, var_26_3(var_26_2, var_1_10007.benefit_buff_template[arg_26_0.selectBuffId].id)))
		...
		var_1(var_26_4, var_26_5, var_26_6, var_5)
		...
		var_1(var_26_7, var_26_8, var_26_9, var_5)
		...
		local function var_26_12()
			...
			local var_29_3 = var_2_10002.EVENT_PT_OPERATION
			local var_29_4 = {
				cmd = 3
			}
			local var_29_5 = arg_26_0.ptData

			var_29_4.activity_id = var_4.GetId(var_29_5)

			local var_29_6 = arg_26_0.ptData

			var_29_4.arg1 = var_4.CanTrain(var_29_6)
		...
		var_1(var_26_10, var_26_11, var_26_12, var_5)
	end
...
function var_0_1.showBuffBox(arg_35_0)
	...
	local var_35_0 = var_1_10001(arg_35_0:updateLevelPanel(), arg_35_0.buffIconParent)
	...
	var_2(var_35_1, var_1_10004(0, 0, 0))
	...
	var_2(var_35_2, var_4(1.3, 1.3, 1))

	local var_35_3 = arg_35_0.ptData

	if var_2.GetCurBuffInfos(var_35_3) then
		ipairs = var_35_3

		for iter_35_0, iter_35_1 in var_35_3(var_2) do
			local var_35_4

			if iter_35_0 <= arg_35_0.buffDescContent.childCount then
				local var_35_5 = arg_35_0.buffDescContent

				var_35_4 = var_9.GetChild(var_35_5, iter_35_0 - 1)
			else
				cloneTplTo = var_9
				var_35_4 = var_9(arg_35_0.buffDescTpl, arg_35_0.buffDescContent)
			end
			...
			pg = var_1_10011
			var_1_10011 = var_1_10011.benefit_buff_template[iter_35_1.id].name
			pg = var_12

			var_9(var_35_6, var_1_10011 .. var_12.benefit_buff_template[iter_35_1.id].desc)
		end
	end
	...
	local var_35_8 = arg_35_0.buffMask
	...
	var_35_3(var_35_7, var_35_8, var_35_9, iter_35_1)
...
function var_0_1.showSingleBuffBox(arg_37_0)
	...
	local var_37_1 = var_1(arg_37_0:updateLevelPanel(), arg_37_0.singleIconParent)
	...
	var_2(var_37_2, var_1_10004(0, 0, 0))
	...
	var_2(var_37_3, var_4(1.3, 1.3, 1))

	local var_37_4 = arg_37_0.ptData

	if var_2.GetCurBuffInfos(var_37_4) then
		ipairs = var_37_4

		for iter_37_0, iter_37_1 in var_37_4(var_2) do
			var_1_10008 = nil

			if iter_37_0 <= arg_37_0.singleDescContent.childCount then
				local var_37_5 = arg_37_0.singleDescContent

				var_1_10008 = var_9.GetChild(var_37_5, iter_37_0 - 1)
			else
				cloneTplTo = var_9
				var_1_10008 = var_9(arg_37_0.singleDescTpl, arg_37_0.singleDescContent)
			end

			setText = var_9

			local var_37_6 = var_1_10008

			pg = var_1_10011
			var_1_10011 = var_1_10011.benefit_buff_template[iter_37_1.id].name
			pg = var_12

			var_9(var_37_6, var_1_10011 .. var_12.benefit_buff_template[iter_37_1.id].desc)
		end
	end
	...
	local function var_37_7()
		...
		ActivitySingleScene = var_2

		var_38_1(var_38_0, var_2.EXIT)
		...
		var_38_3(var_38_2, var_2.ON_CLOSE)
	...
	local var_37_9 = arg_37_0.singleBuffMask
	...
	var_4(var_37_8, var_37_9, var_37_10, var_1_10008)

	onButton = var_4

	local var_37_11 = arg_37_0
	local var_37_12 = arg_37_0.singleCloseBtn
	...
	var_4(var_37_11, var_37_12, var_37_13, var_1_10008)

	onButton = var_4

	local var_37_14 = arg_37_0
	local var_37_15 = arg_37_0.singleSureBtn
	...
	var_4(var_37_14, var_37_15, var_37_16, var_1_10008)
