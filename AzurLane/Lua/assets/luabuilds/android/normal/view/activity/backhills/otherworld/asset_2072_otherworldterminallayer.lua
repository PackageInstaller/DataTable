...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_4 = var_2.Find(var_4_3, var_0_1.PAGE_PERSONAL .. "/Text")

	i18n = var_4_3

	var_1(var_4_4, var_4_3("terminal_personal_title"))

	setText = var_1

	local var_4_5 = arg_4_0.togglesTF
	local var_4_6 = var_2.Find(var_4_5, var_0_1.PAGE_ADVENTURE .. "/Text")

	i18n = var_4_5

	var_1(var_4_6, var_4_5("terminal_adventure_title"))

	setText = var_1

	local var_4_7 = arg_4_0.togglesTF
	local var_4_8 = var_2.Find(var_4_7, var_0_1.PAGE_GUARDIAN .. "/Text")

	i18n = var_4_7

	var_1(var_4_8, var_4_7("terminal_guardian_title"))
	...
	local var_4_11 = var_4_9(var_3)
	local var_4_12 = var_2.getActivityById

	ActivityConst = var_4

	if var_4_12(var_4_11, var_4.OTHER_WORLD_TERMINAL_EVENT_ID) and not var_2:isEnd() then
		TerminalPersonalPage = var_4_11
		arg_4_0.personalPage = var_4_11.New(var_4_10, arg_4_0, {
	...
	TerminalAdventurePage = var_4_11
	arg_4_0.adventurePage = var_4_11.New(var_4_10, arg_4_0)
...
function var_0_1.addListener(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "close_btn")
	...
	local var_5_6 = var_3.Find(var_5_5, "mask")
	...
	local var_5_10 = var_3.Find(var_5_9, "help_btn")
	...
	local function var_5_11()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip.otherworld_terminal_help.tip
		...
		var_2_10001(arg_5_0, arg_9_0, function(arg_10_0)
			if arg_10_0 then
				...
				if var_10_0 == var_0_1.PAGE_PERSONAL and not arg_5_0.personalPage then
					...
					var_10_2(var_10_1, var_3_10004("common_activity_end"))
...
function var_0_1.didEnter(arg_11_0)
	...
	local var_11_2 = var_3.Find

	tostring = var_1_10005

	var_2(var_11_2(var_11_1, var_1_10005(var_11_0)), true)
