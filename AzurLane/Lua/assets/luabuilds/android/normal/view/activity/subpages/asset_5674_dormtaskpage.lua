...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_1_0.stepMax = var_1_9(var_1_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_1_0.progress = var_1_12(var_1_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_1_0.desc = var_1_15(var_1_14, var_3(var_1_10004))
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10002.ON_TASK_GO, arg_3_0.taskVO)
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	local function var_6_9()
		...
		var_7_1(var_7_0, var_2_10002.ON_DROP, var_6_6)
	...
	var_4(var_6_7, var_6_8, var_6_9, var_1_10008)
	...
	var_6_12(var_6_14, var_8.getConfig(var_6_15, "desc"))

	setText = var_6_12

	var_6_12(arg_6_0.progress, var_6_11 .. "/" .. var_6_13)

	setSlider = var_6_12

	var_6_12(arg_6_0.slider, 0, var_6_13, var_6_11)
	...
	var_6_16(arg_6_0.battleBtn, var_6_17 == 0)

	setActive = var_6_16

	var_6_16(arg_6_0.getBtn, var_6_17 == 1)

	setActive = var_6_16

	var_6_16(arg_6_0.gotBtn, var_6_17 == 2)

	setActive = var_6_16

	var_6_16(arg_6_0.awardGot, var_6_17 == 2)
...
function var_0_1.getTaskIdx(arg_8_0, arg_8_1)
	...
	local var_8_3 = var_1_10005.min(var_8_1, var_8_2)
	local var_8_4 = true
	...
	return var_7.min(var_8_0, var_8_2)
end
...
function var_0_1.isTaskFinished(arg_9_0, arg_9_1)
	if not arg_9_0.taskProxy then
		...
		arg_9_0.taskProxy = var_2(var_1_10003)
	end
