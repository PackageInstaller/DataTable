...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_7 = var_2.Find(var_1_6, "tip")

	i18n = var_1_6

	var_1(var_1_7, var_1_6("auction_pt_info"))

	setText = var_1

	local var_1_8 = arg_1_0.bg
	local var_1_9 = var_2.Find(var_1_8, "get_btn/text")

	i18n = var_1_8

	var_1(var_1_9, var_1_8("auction_signin_collect"))

	setText = var_1

	local var_1_10 = arg_1_0.bg
	local var_1_11 = var_2.Find(var_1_10, "PT_bg/Text")

	i18n = var_1_10

	var_1(var_1_11, var_1_10("auction_pt_tip"))
...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	local var_3_2 = var_3.GetMaxAvailableTargetIndex(var_3_1)
	local var_3_3 = arg_3_0.ptData

	var_1(var_3_0, var_3_2 == var_4.GetLevel(var_3_3))
...
function var_0_1.setPlayerInfo(arg_4_0)
	...
	local var_4_3 = var_4_1(var_1_10004)
	local var_4_4 = var_3.GetShipPhantom(var_4_3, var_4_2)

	GetImageSpriteFromAtlasAsync = var_4_3

	var_4_3("SquareIcon/" .. var_4_4:getPainting(), "", arg_4_0.playerIcon)

	setText = var_4_3

	var_4_3(arg_4_0.playerName, var_1.name)

	setText = var_4_3

	local var_4_5 = arg_4_0.playerCount

	StringHelper = var_6

	local var_4_6 = var_6.ForamtNumberK

	AuctionGameTools = var_7

	var_4_3(var_4_5, var_4_6(var_7.GetCurrencyCnt()))
