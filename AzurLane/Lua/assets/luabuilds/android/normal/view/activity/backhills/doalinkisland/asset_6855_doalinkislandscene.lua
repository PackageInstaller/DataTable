...
local var_0_0 = "DOALinkIslandScene"
...
function var_0_1.didEnter(arg_3_0)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "shatanpaiqiu", function()
		...
		var_7_1(var_7_0, var_2_10002.GO_MINI_GAME, 17)
	...
	local var_3_9 = arg_3_0._upper
	local var_3_10 = var_3.Find(var_3_9, "pengpengdong")
	...
	local function var_3_11()
		...
		var_8_1(var_8_0, var_2_10002.GO_MINI_GAME, 51)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "daoyvjianshe", function()
		...
		DOALinkIslandMediator = var_2_10002
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "tebiezuozhan", function()
		...
		local var_14_1, var_14_2 = var_0.getLastMapForActivity(var_14_0)

		if var_14_1 then
			local var_14_3 = var_0:getMapById(var_14_1)

			if not var_2_10003.isUnlock(var_14_3) then
				pg = var_2_10003

				local var_14_4 = var_2_10003.TipsMgr.GetInstance()
				local var_14_5 = var_3.ShowTips

				i18n = var_2_10005

				var_14_5(var_14_4, var_2_10005("common_activity_end"))
			else
				local var_14_6 = arg_3_0
				local var_14_7 = var_3.emit

				DOALinkIslandMediator = var_2_10005

				local var_14_8 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_14_7(var_14_6, var_14_8, var_2_10006.LEVEL, {
					chapterId = var_14_2,
					mapIdx = var_14_1
				})
			end
