...
function var_0_1.init(arg_2_0)
	...
	local var_2_5 = var_2.remove(arg_2_0.slotTFs, 11)
	...
	local var_2_7 = var_4.range
	local var_2_8 = arg_2_0.scrollRect

	arg_2_0.poolItems = var_2_6(var_2_7(var_5.Find(var_2_8, "Pool").childCount), function(arg_6_0)
	...
	local var_2_11 = var_4.ShaderMgr.GetInstance()

	arg_2_0.washMaterial = var_2_10(var_4.GetShader(var_2_11, "M02/Unlit_Colored_Semitransparent"))
...
function var_0_1.didEnter(arg_10_0)
	...
	var_10_1(var_10_0, var_3.getConfig(var_10_2, "config_client").unlockstory)
...
function var_0_1.GetRecordPos(arg_12_0)
	...
	local var_12_1 = var_2.map

	string = var_3

	local var_12_2 = var_12_1(var_3.split(var_12_0, ";"), function(arg_13_0)
	...
	for iter_12_0 = 1, #var_12_2, 2 do
		...
		var_1_10008(var_12_4, var_1_10010.New(var_12_2[iter_12_0], var_12_2[iter_12_0 + 1]))
	end
...
function var_0_1.RecordPos(arg_14_0, arg_14_1)
	...
	local var_14_1 = var_14_0(var_1_10003.reduce(arg_14_1, {}, function(arg_15_0, arg_15_1)
		table = var_2_10002
	...
	var_3.SetString("hotspring_ship_pos_2023", var_14_1)
