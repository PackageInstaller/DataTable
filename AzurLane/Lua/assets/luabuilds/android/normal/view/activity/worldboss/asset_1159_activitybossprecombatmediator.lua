...
function var_0_1.bindEvent(arg_2_0)
		...
		var_2_10003({
			function(arg_10_0)
				...
				for iter_10_0, iter_10_1 in var_3_10005(var_10_2.ships) do
					...
					var_3_10010(var_10_5, var_3_10012.getShipById(var_3_10013, iter_10_1))
				end

				local var_10_6 = var_10_2
				local var_10_7 = var_10_2.GetName(var_10_6)

				Fleet = var_10_6

				var_10_6.EnergyCheck(var_10_4, var_10_7, function(arg_11_0)
					if arg_11_0 then
						arg_10_0()
					end
	...
	arg_2_0:bind(var_0_1.SHOW_CONTINUOUS_OPERATION_WINDOW, function(arg_15_0, arg_15_1)
		...
		ContinuousOperationWindowMediator = var_2_10006
		var_15_3.mediator = var_2_10006
		ContinuousOperationWindow = var_2_10006
...
function var_0_1.handleNotification(arg_23_0, arg_23_1)
	...
	if var_23_0 == var_23_1.BEGIN_STAGE_DONE then
		...
		if var_23_0 == var_23_4.UPDATED then
			...
			var_23_6(var_23_5, var_1_10006.getData(var_1_10007))
		else
			GAME = var_23_6

			local var_23_8

			if var_23_0 == var_23_6.BEGIN_STAGE_ERRO then
				if var_23_2 == 3 then
					pg = var_23_8

					local var_23_7 = var_23_8.MsgboxMgr.GetInstance()

					var_23_8 = var_23_8.ShowMsgBox
					var_1_10006 = {
						hideNo = true
					}
					i18n = var_1_10007
					...
					function var_1_10006.onYes()
						...
						var_24_1(var_24_0, var_2_10002.ON_CLOSE)

						return
					end

					var_23_8(var_23_7, var_1_10006)
				end
			else
				PreCombatMediator = var_23_8

				if var_23_0 == var_23_8.BEGIN_STAGE_PROXY then
					local var_23_9 = arg_23_0.viewComponent
					local var_23_10 = var_4.emit

					PreCombatMediator = var_1_10006

					var_23_10(var_23_9, var_1_10006.BEGIN_STAGE_PROXY, var_23_2)
				elseif var_23_0 == var_0_1.CONTINUOUS_OPERATION then
					local var_23_11 = arg_23_0.viewComponent
					local var_23_12 = var_4.emit

					PreCombatMediator = var_1_10006

					var_23_12(var_23_11, var_1_10006.ON_START, var_23_2.mainFleetId, var_23_2.battleTimes)
				end
			end
		end
	end
