...
function var_0_1.OnInit(arg_1_0)
	...
	var_2(var_1_12, var_1_13, var_1_14, var_1_10006)
	...
	var_2(var_1_15, var_1_16, var_1_17, var_1_10006)
	...
	local function var_1_20()
		...
		local var_6_3 = var_2_10003.CHARGE
		local var_6_4 = {}

		ChargeScene = var_2_10005
		var_6_4.wrap = var_2_10005.TYPE_PICK
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	var_1_10001(var_2.Find(var_8_0, "before"), not arg_8_0.isPay)

	setActive = var_1_10001

	local var_8_1 = arg_8_0.textPay

	var_1_10001(var_2.Find(var_8_1, "after"), arg_8_0.isPay)
	...
	var_2(var_3.Find(var_8_5, "tip"), var_8_4)

	setActive = var_2

	local var_8_6 = arg_8_0.btnGoPay

	var_2(var_3.Find(var_8_6, "tip"), var_8_4)
	...
	var_2(function()
		if arg_8_0.isPay then
			...
			if var_0.GetInt("first_crusing_page_display:" .. arg_8_0.activity.id, 0) == 0 then
				...
				local var_9_1 = var_1.delayedCall
				local var_9_2 = 3

				System = var_2_10003
				var_9_0.LTFirst = var_9_1(var_9_2, var_2_10003.Action(function()
					...
					local var_10_1 = var_1.delayedCall
					local var_10_2 = 3

					System = var_3_10003
					var_10_0.LTFirst = var_10_1(var_10_2, var_3_10003.Action(function()
