...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local var_1_2 = var_3.Find(var_1_1, "help")
	...
	local function var_1_3()
		...
		pg = var_2_10003
		var_2_2.helps = var_2_10003.gametip.maid_task_tips1.tip
	...
	local var_1_6 = var_3.Find(var_1_5, "ClickIron")
	...
	local function var_1_7()
		...
		var_3_1(var_3_2, var_2_10003.NEWYEAR_BACKHILL_2022)
		...
		var_3_6.mediator = var_2_10005
		BuildingCafeUpgradeLayer = var_2_10005
		var_3_6.viewComponent = var_2_10005
		var_3_6.data = {
			buildingID = 18,
			isLayer = true
		}
		...
		var_3_8(var_3_7, var_3.LOAD_SCENE, {
			context = var_3_0
		})
	...
	local var_1_10 = var_3.Find(var_1_9, "ClickRoyal")
	...
	local function var_1_11()
		...
		var_4_1(var_4_2, var_2_10003.NEWYEAR_BACKHILL_2022)
		...
		local var_4_5 = var_3.New
		local var_4_6 = {}

		BuildingUpgradeMediator = var_2_10005
		var_4_6.mediator = var_2_10005
		BuildingCafeUpgradeLayer = var_2_10005
		var_4_6.viewComponent = var_2_10005
		var_4_6.data = {
			buildingID = 17,
			isLayer = true
		}
		...
		var_4_8(var_4_7, var_3.LOAD_SCENE, {
			context = var_4_0
		})
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	var_1(var_5_0, var_1_10003(var_1_10004(arg_5_0.nday), "#7B3B2C"))
