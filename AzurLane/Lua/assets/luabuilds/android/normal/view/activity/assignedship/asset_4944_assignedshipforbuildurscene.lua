...
function var_0_1.preload(arg_3_0, arg_3_1)
	...
	arg_3_0.ids = var_3_0(var_3.getConfig(var_3_1, "usage_arg"), function(arg_4_0)
		pg = var_2_10001
	...
	for iter_3_0, iter_3_1 in var_3(arg_3_0.ids) do
		table = var_1_10008
		...
		var_1_10008.insert(var_3_2, function(arg_5_0)
			...
			var_2_10001(var_5_0, var_2_10003(iter_3_1), function(arg_6_0)
...
function var_0_1.init(arg_7_0)
	...
	UIItemList = var_7_4
	arg_7_0.iconList = var_7_4.New(var_7_5, var_7_5:Find("tpl"))

	local var_7_6 = arg_7_0.iconList

	var_2.make(var_7_6, function(arg_9_0, arg_9_1, arg_9_2)
		arg_9_1 = arg_9_1 + 1
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			var_4(arg_9_2:Find("Image"), arg_7_0.iconSprites[var_9_0.configId], true)

			setActive = var_4

			local var_9_1 = arg_9_2
			local var_9_2 = arg_9_2.Find(var_9_1, "noget")

			getProxy = var_9_1
			CollectionProxy = var_7

			local var_9_3 = var_9_1(var_7)

			var_4(var_9_2, not var_6.getShipGroup(var_9_3, var_9_0:getGroupId()))
			...
			var_4(var_9_4, var_9_5, var_9_6, var_8)

			triggerToggle = var_4

			var_4(arg_9_2, arg_9_1 == 1)
		end
	...
	arg_7_0.btnConfirm = var_2.Find(var_7_7, "select/operation/confirm")
	onButton = var_2

	local var_7_8 = arg_7_0
	local var_7_9 = arg_7_0.btnConfirm
	...
	local function var_7_10()
		...
		var_11_2.content = var_2_10003(var_11_3, var_5.getName(var_11_4))
		...
		function var_11_2.onYes()
			...
			local var_12_2 = var_3_10002.ON_USE_ITEM
			...
			var_12_5[1] = var_12_6[var_7.GetConfigID(var_12_7)]
	...
	var_2(var_7_8, var_7_9, var_7_10, var_6)

	local var_7_11 = arg_7_0._tf

	arg_7_0.rtName = var_2.Find(var_7_11, "select/name_bg")

	local var_7_12 = arg_7_0._tf

	arg_7_0.rtPaint = var_2.Find(var_7_12, "main/paint")
...
function var_0_1.willExit(arg_16_0)
	...
	if arg_16_0.shipVO then
		...
		var_1(var_16_0, var_3.getPainting(var_16_1))
	end
