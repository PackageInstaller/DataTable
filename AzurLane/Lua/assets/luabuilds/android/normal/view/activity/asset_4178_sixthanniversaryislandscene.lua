...
function var_0_1.setPlayer(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_3.Find(var_4_0, "tpl/Text")
	local var_4_2 = arg_4_0.player
	local var_4_3

	if not var_4.getResById(var_4_2, 350) then
		var_4_3 = 0
	end
...
function var_0_1.setResDrop(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = var_4.Find(var_5_0, "tpl_2/Text")
	local var_5_2
...
function var_0_1.init(arg_6_0)
	...
	UIItemList = var_6_3
	arg_6_0.nodeItemList = var_6_3.New(var_6_4, var_6_4:Find("node"))
	...
	var_3.make(var_6_5, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_2 = var_4
			local var_7_3, var_7_4 = var_5(var_4.getConfig(var_7_2, "address"))
			...
			local var_7_5 = var_4
			local var_7_6 = var_4.getConfig(var_7_5, "type")

			eachChild = var_7_5

			var_7_5(arg_7_2:Find("main/type"), function(arg_8_0)
				...
				var_3_10001(var_8_0, var_8_1 == var_3_10004(var_7_6))

				return
			end)

			setLocalScale = var_7_5

			local var_7_7 = arg_7_2

			Vector3 = var_10

			var_7_5(var_7_7, var_10(0, 0, 1))

			setActive = var_7_5

			var_7_5(arg_7_2:Find("name"), var_4:getConfig("icon_name") ~= "")

			onToggle = var_7_5

			var_7_5(arg_6_0, arg_7_2, function(arg_9_0)
				if arg_9_0 then
			...
			var_7_5(arg_7_2:Find("click"), true)

			onButton = var_7_5

			local var_7_8 = arg_6_0
			local var_7_9 = arg_7_2:Find("click")

			local function var_7_10()
				local var_10_0 = arg_6_0.proxy
				local var_10_1 = var_0.GetNode(var_10_0, var_7_0)

				triggerToggle = var_10_0

				var_10_0(arg_7_2, var_10_1:CanToggleOn())
				...
				elseif var_10_1:IsRefresh() and var_10_1:IsCompleted() then
					...
					var_4.New(function()
						...
						if var_10_7 == 0 then
							...
							var_0(var_1.Find(var_11_1, "main/time"), false)
						else
							setText = var_0

							local var_11_2 = arg_7_2
							local var_11_3 = var_1.Find(var_11_2, "main/time/Text")

							i18n = var_11_2

							local var_11_4 = var_11_2("islandnode_tips1")
							local var_11_5 = var_6_2

							var_0(var_11_3, var_11_4 .. var_3.DescCDTime(var_11_5, var_10_6))
					...
					var_4(var_5.Find(var_10_9, "main/time"), true)
				end
			...
			var_7_5(var_7_8, var_7_9, var_7_10, var_12)

			local var_7_11 = arg_6_0

			var_8.refreshNode(var_7_11, var_7_0)
		end
	...
	UIItemList = var_6_6
	arg_6_0.panelItemList = var_6_6.New(var_6_7, var_6_7:Find("tpl"))
	...
	var_4.make(var_6_8, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			...
			local var_12_1 = "ui/sixthanniversaryislandui_atlas"
			local var_12_2 = var_3:getConfig("icon")
			local var_12_3 = arg_12_2

			var_4(var_12_1, var_12_2, arg_12_2.Find(var_12_3, "Image"))

			setActive = var_4

			var_4(arg_12_2:Find("mask"), not var_3:RedDotHint())
			...
			local function var_12_6()
				...
				LeanTweenType = var_3_10003

				var_13_1(var_13_0, var_13_2, var_3_10003.easeInOutSine)
			...
			var_4(var_12_4, var_12_5, var_12_6, var_12_3)
		end
	...
	var_4(var_5.Find(var_6_9, "panel/toggle"), false)
	...
	var_5.make(var_6_15, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			local function var_14_2()
				...
				var_15_1(var_15_0, var_15_2, var_3.easeInOutSine)
			...
			var_3(var_14_0, var_14_1, var_14_2, var_2_10007)
		end
	...
	local var_6_20 = var_6_19(var_6_18, var_7(var_6_14)).onValueChanged
	...
	Vector2 = var_6_14
	arg_6_0.delta = var_6_14(var_6_22 - 100, var_6_23 - 100) / 2
	Vector2 = var_8
	...
	local var_6_26 = var_10.Find(var_6_25, "btn_back")
	...
	var_8(var_6_24, var_6_26, var_6_27, var_12)

	setActive = var_8

	local var_6_28 = arg_6_0.rtTop

	var_8(var_9.Find(var_6_28, "btn_now"), false)

	onButton = var_8

	local var_6_29 = arg_6_0
	local var_6_30 = arg_6_0.rtTop
	local var_6_31 = var_10.Find(var_6_30, "btns/btn_shop")

	local function var_6_32()
		local var_18_0 = arg_6_0
		local var_18_1 = var_0.emit

		SixthAnniversaryIslandMediator = var_2_10002

		var_18_1(var_18_0, var_2_10002.GO_SHOP)
	...
	var_8(var_6_29, var_6_31, var_6_32, var_12)

	onButton = var_8

	local var_6_33 = arg_6_0
	local var_6_34 = arg_6_0.rtTop
	local var_6_35 = var_10.Find(var_6_34, "btns/btn_note")
	...
	local function var_6_36()
		...
		var_19_1(var_19_0, var_2_10002.OPEN_NOTE)
	...
	var_8(var_6_33, var_6_35, var_6_36, var_12)

	onButton = var_8

	local var_6_37 = arg_6_0
	local var_6_38 = arg_6_0.rtTop
	local var_6_39 = var_10.Find(var_6_38, "btns/btn_help")
	...
	local function var_6_40()
		...
		i18n = var_2_10003
		var_20_2.helps = var_2_10003("island_help")
	...
	var_8(var_6_37, var_6_39, var_6_40, var_12)

	onButton = var_8

	local var_6_41 = arg_6_0
	local var_6_42 = arg_6_0.rtResPanel
	local var_6_43 = var_10.Find(var_6_42, "tpl")
	...
	local function var_6_44()
		...
		var_21_1(var_21_0, var_2_10002.OPEN_RES, {
			id = 350,
			type = 1
		}, "")
	...
	var_8(var_6_41, var_6_43, var_6_44, var_12)

	onButton = var_8

	local var_6_45 = arg_6_0
	local var_6_46 = arg_6_0.rtResPanel
	local var_6_47 = var_10.Find(var_6_46, "tpl_2")
	...
	local function var_6_48()
		...
		local var_22_2 = var_2_10002.OPEN_RES

		Clone = var_2_10003

		local var_22_3 = var_2_10003(arg_6_0.resDrop)

		i18n = var_4

		var_22_1(var_22_0, var_22_2, var_22_3, var_4("island_game_limit_help", arg_6_0.resDailyNumber))
	...
	var_8(var_6_45, var_6_47, var_6_48, var_12)
...
function var_0_1.onDragFunction(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_23_0(arg_23_0.mainIds) do
		...
		for iter_23_2, iter_23_3 in var_9(var_0_1.screenPoints) do
			local var_23_7 = var_0_1.screenPoints[iter_23_2 % 4 + 1]

			LineLine = var_15
			Vector2 = var_1_10016
			var_1_10016 = var_1_10016.zero
			Vector2 = var_1_10017

			local var_23_8

			var_23_8, var_1_10016, var_1_10017 = var_15(var_1_10016, var_1_10017(var_23_5.x, var_23_5.y), iter_23_3, var_23_7)

			if var_23_8 then
				var_23_6 = var_23_5 * var_1_10016
		...
		typeof = iter_23_2
		CanvasGroup = iter_23_3

		local var_23_12 = var_23_11(var_23_10, iter_23_2(iter_23_3))

		tobool = var_23_10
		var_23_12.interactable = var_23_10(var_23_6)
		tobool = var_11
		...
		if var_23_6 then
			...
			local var_23_14 = var_23_13 * var_12.atan2(var_23_6.y, var_23_6.x) - 45
...
function var_0_1.focus(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if not arg_24_3 then
		triggerToggle = var_24_0
		var_24_2 = var_24_1

		local var_24_3 = arg_24_0.proxy
		local var_24_4 = var_7.GetNode(var_24_3, arg_24_1)

		var_24_0(var_24_2, var_7.CanToggleOn(var_24_4))
	end

	local var_24_5 = var_24_1.anchoredPosition * -1

	math = var_24_2
	var_24_5.x = var_24_2.clamp(var_24_5.x, -arg_24_0.extendLimit.x, arg_24_0.extendLimit.x)
	math = var_6
	...
	if arg_24_2 then
		...
		var_7.insert(var_24_6, function(arg_25_0)
			...
			var_2_10001(var_25_0, var_2_10003(var_2_10004), false)
			...
			if 0 < var_25_1 then
				...
				local var_25_6 = var_25_4(var_25_5, var_2_10006(var_24_5.x, var_24_5.y), var_25_2)
				local var_25_7 = var_4.setEase(var_25_6, arg_24_2)
				local var_25_8 = var_4.setOnUpdate

				System = var_6

				local var_25_9 = var_25_8(var_25_7, var_6.Action_float(function(arg_26_0)
				...
				System = var_6
				var_25_3.twFocusId = var_25_10(var_25_9, var_6.Action(arg_25_0)).uniqueId
		...
		var_7(var_24_6, function()
			...
			var_2_10000(var_27_0, var_2_10002(var_2_10003), true)
...
function var_0_1.triggerNode(arg_28_0, arg_28_1)
	...
	SixthAnniversaryIslandProxy = var_1_10003
	...
	if var_2.IsNew(var_28_1) then
		...
		SixthAnniversaryIslandMediator = var_1_10005

		var_28_3(var_28_2, var_1_10005.MARK_NODE_AFTER_NEW, arg_28_1)
	end
	...
	if var_2:IsCompleted() then
		if var_2:getConfig("type") == 5 then
			...
			SixthAnniversaryIslandMediator = var_5

			var_28_5(var_28_4, var_5.INTO_ENTRANCE, var_2:getConfig("params")[1])
		end
	else
	...
	var_3(var_29_1:getConfig("type"), {
		[3] = function()
			...
			if var_1.getConfig(var_30_1, "story") and var_1 ~= "" then
				...
				var_30_1.insert(var_30_0, function(arg_31_0)
				...
				var_30_1.insert(var_30_0, function(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
			...
			var_30_1(var_30_0, function(arg_33_0)
				local var_33_0 = arg_29_0
				local var_33_1 = var_1.emit

				SixthAnniversaryIslandMediator = var_3_10003

				local var_33_2 = var_3_10003.OPEN_QTE_GAME
				local var_33_3 = var_29_1

				var_33_1(var_33_0, var_33_2, var_4.getConfig(var_33_3, "params")[1], function(arg_34_0)
					local var_34_0 = arg_29_0
					local var_34_1 = var_1.emit

					SixthAnniversaryIslandMediator = var_4_10003

					var_34_1(var_34_0, var_4_10003.TRIGGER_NODE_EVENT, arg_29_1.id, arg_34_0 or 0)
		...
		if var_1.getConfig(var_35_1, "story") and var_1 ~= "" then
			...
			var_35_1.insert(var_35_0, function(arg_36_0)
				if arg_29_0.isAutoPlayStory then
					pg = var_1
			...
			var_35_1.insert(var_35_0, function(arg_37_0, arg_37_1, arg_37_2, arg_37_3)
		...
		var_35_1(var_35_0, function(arg_38_0)
			local var_38_0 = arg_29_0
			local var_38_1 = var_1.emit

			SixthAnniversaryIslandMediator = var_3_10003

			var_38_1(var_38_0, var_3_10003.TRIGGER_NODE_EVENT, arg_29_1.id, arg_38_0 or 0)
...
function var_0_1.afterTriggerEvent(arg_39_0, arg_39_1)
	...
	if var_2:CanTrigger() then
		...
		var_3(var_4.Find(var_39_2, arg_39_1), var_2:CanToggleOn())
...
function var_0_1.refreshNode(arg_41_0, arg_41_1)
	...
	if var_41_4 then
		...
		local var_41_7 = var_41_5(var_41_6, var_41_6, 1)
		local var_41_9
		...
		if var_41_1.localScale ~= var_41_7 then
			...
			var_41_9(var_41_8, var_8.easeInOutSine)
		end
		...
		if var_41_4 and not arg_41_0.displayDic[arg_41_1] then
			...
			if var_3.getConfig(var_41_10, "icon") == "" then
				SetCompomentEnabled = var_41_10

				local var_41_11 = var_41_1
				local var_41_12 = var_41_1.Find(var_41_11, "main")

				typeof = var_41_11
				Image = var_10

				var_41_10(var_41_12, var_41_11(var_10), false)

				SetCompomentEnabled = var_41_10

				local var_41_13 = var_41_1
				local var_41_14 = var_41_1.Find(var_41_13, "selected_back/light")

				typeof = var_41_13
				Image = var_10

				var_41_10(var_41_14, var_41_13(var_10), false)
			else
				GetSpriteFromAtlasAsync = var_41_10

				var_41_10("ui/sixthanniversaryislandui_atlas", var_41_9, function(arg_42_0)
					setImageSprite = var_2_10001

					local var_42_0 = var_41_1

					var_2_10001(var_2.Find(var_42_0, "main"), arg_42_0)

					setImageSprite = var_2_10001

					local var_42_1 = var_41_1

					var_2_10001(var_2.Find(var_42_1, "main/mask"), arg_42_0)

					return
				end)

				GetImageSpriteFromAtlasAsync = var_41_10

				var_41_10("ui/sixthanniversaryislandui_atlas", var_41_9 .. "_light", var_41_1:Find("selected_back/light"))
			end

			if var_3:getConfig("icon_name") ~= "" then
				GetImageSpriteFromAtlasAsync = var_7

				var_7("ui/sixthanniversaryislandui_atlas", var_3:getConfig("icon_name"), var_41_1:Find("name/Image"), true)
			end

			local var_41_15 = var_3

			if var_3.GetEffectName(var_41_15) ~= "" then
				pg = var_41_15

				local var_41_16 = var_41_15.PoolMgr.GetInstance()

				var_8.GetUI(var_41_16, var_7, true, function(arg_43_0)
					table = var_2_10001
					...
					var_1(var_43_0, var_3.Find(var_43_1, "click"), false)
		...
		local var_41_17 = var_3
		local var_41_18

		if var_3.IsRefresh(var_41_17) then
			var_41_17 = var_3
			var_41_18 = var_3.IsCompleted(var_41_17)
		end

		setActive = var_41_17

		var_41_17(var_41_1:Find("name"), not var_41_18 and not var_3:IsTreasure())

		setActive = var_41_17

		var_41_17(var_41_1:Find("main/mask"), var_41_18)

		setActive = var_41_17

		var_41_17(var_41_1:Find("main/time"), false)

		setActive = var_41_17

		var_41_17(var_41_1:Find("main/new"), var_3:IsNew())

		GetOrAddComponent = var_41_17

		local var_41_19 = var_41_1
		local var_41_20 = var_41_1.Find(var_41_19, "main")

		typeof = var_41_19

		local var_41_21 = var_41_17(var_41_20, var_41_19("LOutLine"))

		ReflectionHelp = var_41_20

		local var_41_22 = var_41_20.RefSetField

		typeof = var_9

		var_41_22(var_9("LOutLine"), "OutlineWidth", var_41_21, var_41_18 and 0 or 3)

		ReflectionHelp = var_41_22

		local var_41_23 = var_41_22.RefCallMethod

		typeof = var_9

		var_41_23(var_9("LOutLine"), "_Refresh", var_41_21)

		triggerToggle = var_41_23

		var_41_23(var_41_1, arg_41_0.selectId == arg_41_1 and var_3:CanToggleOn())
...
function var_0_1.didEnter(arg_48_0)
	...
	if arg_48_0.contextData.nodeIds and #arg_48_0.contextData.nodeIds > 0 then
		...
		var_2.insert(var_48_1, function(arg_49_0)
			...
			if not var_1.focusList(var_49_0, arg_48_0.contextData.nodeIds) then
				...
				var_49_2(var_49_1, var_3("islandnode_tips8"))
				arg_49_0()
			end
	...
	elseif arg_48_0.contextData.checkMain then
		...
		var_2.insert(var_48_1, function(arg_50_0)
			...
			local var_50_0 = var_2_10001(var_2_10002)
			...
			local var_50_2 = var_50_1(var_2_10003.map(arg_48_0.ids, function(arg_51_0)
			...
			local var_50_5 = var_50_4(var_50_3, var_5.ACTIVITY_TYPE_BUILDING_BUFF_2)
			...
			if #var_50_2 > 0 then
				...
				if var_4.all(var_50_2, function(arg_53_0)
					...
					var_50_8(var_50_7, var_6("islandnode_tips9"))
				end
			end
		...
		if arg_48_0.contextData.wraps then
			...
			var_0(arg_48_0.contextData.wraps, {
				[var_0_1.SHOP] = function()
					...
					SixthAnniversaryIslandMediator = var_3_10002

					var_57_1(var_57_0, var_3_10002.GO_SHOP)
...
function var_0_1.updateTaskTip(arg_58_0)
	...
	local var_58_1 = var_2.Find(var_58_0, "btns/btn_note/tip")

	getProxy = var_58_0
	ActivityTaskProxy = var_4

	local var_58_2 = var_58_0(var_4)
	local var_58_3 = var_3.getActTaskTip

	ActivityConst = var_1_10005

	var_1_10001(var_58_1, var_58_3(var_58_2, var_1_10005.ISLAND_TASK_ID))
...
function var_0_1.willExit(arg_59_0)
	...
	local var_59_3 = var_59_2(var_59_1, var_3(var_4)).onValueChanged
	...
	for iter_59_0, iter_59_1 in var_59_3(arg_59_0.effectObjs) do
