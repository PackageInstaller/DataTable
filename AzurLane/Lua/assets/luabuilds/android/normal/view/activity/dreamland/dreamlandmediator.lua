...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.BackHills.AnniversaryIsland2023.AnniversaryIslandHotSpringMediator"))
...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.GET_MAP_AWARD, function(arg_3_0, arg_3_1, arg_3_2)
		...
		local var_3_2 = var_2_10005.ACTIVITY_DREAMLAND_OP
		local var_3_3 = {
			activity_id = arg_3_1
		}

		DreamlandData = var_2_10007
		var_3_3.cmd = var_2_10007.OP_GET_MAP_AWARD
	...
	arg_1_0:bind(var_0_1.GET_EXPLORE_AWARD, function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_2 = var_2_10005.ACTIVITY_DREAMLAND_OP
		local var_4_3 = {
			activity_id = arg_4_1
		}

		DreamlandData = var_2_10007
		var_4_3.cmd = var_2_10007.OP_GET_EXPLORE_AWARD
	...
	arg_1_0.bind(var_1_0, var_0_1.RECORD_EXPLORE, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		...
		local var_5_2 = var_2_10006.ACTIVITY_DREAMLAND_OP
		local var_5_3 = {
			activity_id = arg_5_1
		}

		DreamlandData = var_2_10008
		var_5_3.cmd = var_2_10008.OP_RECORD_EXPLORE
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.ACTIVITY_DREAMLAND_OP_DONE then
		var_1_10005 = arg_8_0.viewComponent

		var_8_3.UpdateActivity(var_1_10005, var_8_2.activity, var_8_2.cmd)

		var_8_3 = #var_8_2.awards
		...
		if 0 < var_8_3 then
			...
			var_8_3(var_1_10005, var_1_10006.ON_ACHIEVE, var_8_2.awards)
		end
	else
		...
		if var_8_0 == var_8_3.ACTIVITY_UPDATED then
			var_1_10005 = var_8_2
			var_8_4 = var_8_2.getConfig(var_1_10005, "type")
			ActivityConst = var_1_10005

			if var_8_4 == var_1_10005.ACTIVITY_TYPE_HOTSPRING_2 then
				arg_8_0.activity = var_8_2
				var_1_10005 = arg_8_0.viewComponent

				var_8_4.UpdateSpringActivity(var_1_10005, var_8_2)
			end
		else
			GAME = var_8_4

			if var_8_0 == var_8_4.STORY_UPDATE_DONE then
				getProxy = var_4
				ActivityProxy = var_1_10005

				local var_8_5 = var_4(var_1_10005)
				local var_8_6 = var_4.getActivityByType

				ActivityConst = var_1_10006
				arg_8_0.activity = var_8_6(var_8_5, var_1_10006.ACTIVITY_TYPE_HOTSPRING_2)

				local var_8_7 = arg_8_0.viewComponent

				var_4.UpdateSpringActivity(var_8_7, arg_8_0.activity)
			end
		end
	end
