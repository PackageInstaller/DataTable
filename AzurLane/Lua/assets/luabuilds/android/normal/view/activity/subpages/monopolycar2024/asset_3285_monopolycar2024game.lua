...
function var_0_0.UpdateActData(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_1_10004.ceil((var_6_1 - var_6_2) / 0) * arg_6_1:getDataConfig("daily_time")
	local var_6_4
	...
	local var_6_11 = arg_6_1
	local var_6_12

	if not arg_6_1.getDataConfig(var_6_11, "sum_lap_reward_show") then
		var_6_12 = {}
	end

	arg_6_0.lapReward = var_6_12

	local var_6_13 = {}

	i18n = var_6_11
	var_6_13[1] = var_6_11("MonopolyCar2024Game_title1")
	i18n = var_8
	var_6_13[2] = var_8("MonopolyCar2024Game_title2")
	arg_6_0.titles = var_6_13
	_ = var_6_13
	arg_6_0.pickableShipId = var_6_13.map(arg_6_1:getDataConfig("ship_reward"), function(arg_7_0)
		return arg_7_0[1]
	end)
	arg_6_0.spEvents = {}
	ipairs = var_7
	...
	for iter_6_0, iter_6_1 in var_7(var_6_14) do
	...
	for iter_21_0, iter_21_1 in var_3(var_0_6) do
		...
		var_1_10008.insert(var_21_0, function(arg_22_0)
			...
			var_1.GetSpineChar(var_22_0, iter_21_1, true, function(arg_23_0)
				...
				local var_23_4 = var_23_3(var_23_2, var_4(var_5))
...
function var_0_0.InitUI(arg_26_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_26_0.btnAutoImg = var_26_2(var_26_1, var_3(var_1_10004))
	findTF = var_1
...
function var_0_0.RegisterUI(arg_27_0)
	...
	local function var_27_2()
		if arg_27_0.leftCount and arg_27_0.leftCount <= 0 then
			...
			var_28_1(var_28_0, var_2_10002("common_count_noenough"))
	...
	var_1_10001(var_27_0, var_27_1, var_27_2, var_1_10005)
	...
	local function var_27_5()
		...
		var_29_2.type = var_2_10003
		pg = var_2_10003
		var_29_2.helps = var_2_10003.gametip.help_monopoly_car2024.tip
	...
	var_1_10001(var_27_3, var_27_4, var_27_5, var_1_10005)
	...
	var_1_10001(var_27_6, var_27_7, var_27_8, var_1_10005)
	...
	local function var_27_11()
		...
		var_31_1(var_31_0, var_2_10002.ON_CLOSE)
	...
	var_1_10001(var_27_9, var_27_10, var_27_11, var_1_10005)
	...
	var_1_10001(var_27_12, var_27_13, var_27_14, var_1_10005)
...
function var_0_0.EnableAuto(arg_34_0)
	...
	if arg_34_0.leftCount <= 0 then
		...
		var_34_1(var_34_0, var_1_10003("common_count_noenough"))
	...
	if arg_34_0.useCount < 10 then
		...
		var_34_3(var_34_2, var_1_10003("MonopolyCar2024Game_lock_auto_tip", arg_34_0.useCount))
	...
	var_34_6(var_34_5, var_1_10003("MonopolyCar2024Game_open_auto_tip"))
...
function var_0_0.Roll(arg_40_0, arg_40_1)
	...
	var_3({
		function(arg_41_0)
			...
			var_41_1(var_41_0, var_2_10003.ON_START, arg_40_0.actId, function(arg_42_0)
...
function var_0_0.PlayRollAnimation(arg_53_0, arg_53_1, arg_53_2)
	...
	var_1_10003(var_1_10004(arg_53_0.rollStep, "animroot/Image/Text"), "00")
	...
	local var_53_2 = var_53_1(var_53_0, var_5(var_6))
	local var_53_3 = var_3.GetComponent

	typeof = var_6
	DftAniEvent = var_1_10007

	local var_53_4 = var_53_3(var_53_2, var_6(var_1_10007))

	findTF = var_53_2

	local var_53_5 = var_53_2(arg_53_0.rollStep, "animroot")
	local var_53_6 = var_5.GetComponent

	typeof = var_7
	Animation = var_1_10008

	local var_53_7 = var_53_6(var_53_5, var_7(var_1_10008))
	local var_53_8 = var_5.GetComponent

	typeof = var_1_10008
	DftAniEvent = var_1_10009

	local var_53_9 = var_53_8(var_53_7, var_1_10008(var_1_10009))

	var_6.SetTriggerEvent(var_53_9, function()
		setText = var_2_10000
		findTF = var_2_10001

		var_2_10000(var_2_10001(arg_53_0.rollStep, "animroot/Image/Text"), "0" .. arg_53_1)
...
function var_0_0.TriggerEvent(arg_73_0, arg_73_1)
	...
	var_73_1(var_73_0, var_1_10004.ON_TRIGGER, arg_73_0.actId, function(arg_74_0, arg_74_1)
...
function var_0_0.CheckCountStory(arg_75_0, arg_75_1)
	...
	if var_1_10004.detect(var_75_1, function(arg_76_0)
		...
		local var_75_2 = var_5.NewStoryMgr.GetInstance()
...
function var_0_0.CheckMove(arg_85_0, arg_85_1)
	...
	var_1_10003({
		function(arg_86_0)
			...
			var_86_1(var_86_0, var_2_10003.ON_MOVE, arg_85_0.actId, function(arg_87_0, arg_87_1, arg_87_2)
...
function var_0_0.ReadyMoveCar(arg_89_0, arg_89_1, arg_89_2)
	...
	var_7.insert(var_89_0, function(arg_92_0)
		...
		local var_92_1 = var_92_0(var_2_10002(arg_89_0._tf), 1, 0, 0.1)
		local var_92_2 = var_1.setOnComplete

		System = var_3

		var_92_2(var_92_1, var_3.Action(arg_92_0))
...
function var_0_0.MoveCar(arg_93_0)
	...
	local var_93_1 = var_2.abs(arg_93_0.targetPosition.y - arg_93_0.car.localPosition.y)
	...
	if not (var_93_2 > var_4.abs(arg_93_0.baseSpeedX)) or not arg_93_0.baseSpeedX then
...
function var_0_0.CheckPickCharacter(arg_95_0, arg_95_1)
	if arg_95_0.selectedShipId == 0 or #arg_95_0.pickCharList == 0 then
		local function var_95_0(arg_96_0)
			...
			var_96_3(var_96_2, var_4.ON_PICK, arg_95_0.actId, var_96_0, function(arg_97_0)
	...
	for iter_101_0 = 1, #var_0_4 do
		...
		for iter_101_1 = 1, #var_101_2 do
			...
			if 0 < var_101_4 then
				...
				local var_101_7 = var_14(var_101_5, var_101_6, var_1_10017(var_101_4))

				Vector2 = var_101_5
				var_101_7.localPosition = var_101_5(var_0_1 * var_101_3 + var_101_1.x, -var_0_2 * var_101_3 + var_101_1.y)
				pg = var_16

				local var_101_8 = var_16.activity_event_monopoly_map[var_101_4].icon

				GetSpriteFromAtlas = var_1_10017
				var_1_10017 = var_1_10017("ui/MonopolyCar2024_atlas", var_101_8)

				local var_101_9 = var_101_7
				local var_101_10 = var_101_7.GetComponent

				typeof = var_1_10020
				Image = var_1_10021
				var_101_10(var_101_9, var_1_10020(var_1_10021)).sprite = var_1_10017

				local var_101_11 = var_101_7
				local var_101_12 = var_101_7.GetComponent

				typeof = var_1_10020
				Image = var_1_10021

				local var_101_13 = var_101_12(var_101_11, var_1_10020(var_1_10021))

				var_18.SetNativeSize(var_101_13)
				...
				var_101_13.insert(arg_101_0.mapCells, var_101_14)
			end
		end
	end
...
function var_0_0.InitCar(arg_103_0, arg_103_1)
	...
	var_2.GetSpineChar(var_103_0, var_0_3, true, function(arg_104_0)
		...
		var_104_3.anim = var_104_5(var_104_4, var_4(var_2_10005))
