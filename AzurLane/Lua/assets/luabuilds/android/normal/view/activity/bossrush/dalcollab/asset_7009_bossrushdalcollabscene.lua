...
function var_0_1.init(arg_7_0)
	...
	arg_7_0.seriesNodes = var_7_5(var_7_6(var_3.Find(var_7_7, "Battle/Nodes").childCount), function(arg_8_0)
	...
	var_1.Foreach(arg_7_0.seriesNodes, function(arg_9_0, arg_9_1)
		...
		local var_9_2 = var_9_1(var_9_0, var_2_10005(var_2_10006))
		local var_9_3 = var_2
		...
		local var_9_5 = var_9_4(var_9_3, var_2_10006(var_2_10007))
		...
		var_4.SetEndEvent(var_9_5, function()
			...
			if var_0.IsPlaying(var_10_0, "anim_BossRushDALCollabUI_ship_out") then
				...
				var_0(var_1.Find(var_10_1, "vx_teleport_1"), true)

				setActive = var_0

				local var_10_2 = var_0

				var_0(var_1.Find(var_10_2, "vx_teleport_2"), false)
				...
				if var_0.IsPlaying(var_10_4, "anim_BossRushDALCollabUI_ship_in") then
					...
					if arg_7_0._openSeriesData then
						...
						typeof = var_2
						CanvasGroup = var_3
						var_10_8 = var_10_8(var_10_7, var_2(var_3))
					...
					var_10_8(var_1.Find(var_10_9, "vx_teleport_1"), false)
	...
	for iter_7_0 = 1, 6 do
		...
		var_7_8[iter_7_0] = var_6.Find(var_7_9, "Map/map_" .. iter_7_0)
	end
	...
	for iter_7_1 = 1, 6 do
		...
		var_7_11[iter_7_1] = var_6.Find(var_7_12, "map_" .. iter_7_1)
	end
	...
	typeof = var_3
	Animation = iter_7_1
	arg_7_0.mapAnima = var_7_15(var_7_14, var_3(iter_7_1))
	...
	typeof = var_3
	DftAniEvent = iter_7_1
	arg_7_0.mapDftEvt = var_7_18(var_7_17, var_3(iter_7_1))
	...
	var_1(var_7_25, var_3("pt_count_tip"))
...
function var_0_1.didEnter(arg_15_0)
	...
	local var_15_2 = var_3.Find(var_15_1, "back_btn")
	...
	var_1_10001(var_15_0, var_15_2, var_15_3, var_5)

	onButton = var_1_10001

	local var_15_4 = arg_15_0
	local var_15_5 = arg_15_0.top
	local var_15_6 = var_3.Find(var_15_5, "option")
	...
	var_1_10001(var_15_4, var_15_6, var_15_7, var_5)
	...
	var_1_10001(var_15_8, var_15_9, var_15_10, var_5)

	onButton = var_1_10001

	local var_15_11 = arg_15_0
	local var_15_12 = arg_15_0.top
	local var_15_13 = var_3.Find(var_15_12, "help")
	...
	local function var_15_14()
		...
		i18n = var_2_10005
		var_19_4.info = var_2_10005("dal_chapter_tip")
		var_19_3[1] = var_19_4
	...
	var_1_10001(var_15_11, var_15_13, var_15_14, var_5)
	...
	local function var_15_17()
		...
		local var_20_2 = var_20_0(var_2)

		if not var_1.getActivityById(var_20_2, var_20_1) or var_1:isEnd() then
			pg = var_20_2

			local var_20_3 = var_20_2.TipsMgr.GetInstance()
			local var_20_4 = var_2.ShowTips

			i18n = var_2_10004

			var_20_4(var_20_3, var_2_10004("common_activity_end"))
		...
		BossRushDALCollabMediator = var_2_10004

		local var_20_7 = var_2_10004.GO_SHOPS_LAYER
		local var_20_8 = {}

		NewShopsScene = var_2_10006
		var_20_8.warp = var_2_10006.TYPE_ACTIVITY
	...
	var_1_10001(var_15_15, var_15_16, var_15_17, var_5)
	arg_15_0:PlayBGM()
...
function var_0_1.playAnima(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	local var_23_2 = var_23_1(var_23_0, var_1_10006(var_1_10007))
	...
	if arg_23_3 then
		...
		local var_23_5 = var_23_4(var_23_3, var_7(var_1_10008))
...
function var_0_1.PlayMapShiftAnima(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	for iter_25_0, iter_25_1 in var_1_10004(arg_25_0.maps) do
		...
		var_10(iter_25_1, var_1_10009, true)
	end
	...
	for iter_25_2, iter_25_3 in var_4(arg_25_0.shiftMapList) do
		...
		var_10(iter_25_3, var_1_10009, true)
	end
...
function var_0_1.updateActivityRes(arg_26_0)
	...
	var_26_1.id = var_4(var_5.getConfig(var_26_2, "config_id"))

	local var_26_3 = var_26_0(var_26_1)

	var_1_10001(var_2.getIcon(var_26_3), "", arg_26_0.ptIcon, true)
...
function var_0_1.UpdateMap(arg_27_0)
	...
	if var_3.IsPass(var_27_1) and var_3:GetDefeated(arg_27_0.activity) then
		...
		var_4(var_5.Find(var_27_2, "state_3"), true)

		setActive = var_4

		local var_27_3 = arg_27_0.mapFX

		var_4(var_5.Find(var_27_3, "state_4"), true)

		setActive = var_4

		local var_27_4 = arg_27_0.mapFX

		var_4(var_5.Find(var_27_4, "state_4/6_3"), true)
		...
		for iter_27_0, iter_27_1 in var_4(arg_27_0.maps) do
			if iter_27_0 ~= 1 and iter_27_0 ~= 6 then
				...
				var_1_10009(var_10.Find(var_27_5, "state_4/" .. iter_27_0), false)
			end

			setActive = var_1_10009

			var_1_10009(iter_27_1, true)

			GetSpriteFromAtlas = var_1_10009
			var_1_10009 = var_1_10009("ui/dalcollabbossrushsceneui_atlas", "map_" .. iter_27_0)
			setImageSprite = var_10

			var_10(iter_27_1, var_1_10009, true)
		end
	elseif var_3:IsPlayerUnlock(var_1) and (not var_3:IsPass() or not var_3:GetDefeated(arg_27_0.activity)) then
		setActive = var_4

		local var_27_6 = arg_27_0.mapFX

		var_4(var_5.Find(var_27_6, "state_4"), true)
		...
		for iter_27_2, iter_27_3 in var_4(arg_27_0.maps) do
			...
			var_1_10009(iter_27_3, true)

			if iter_27_2 == 6 then
				var_1_10009 = nil

				if var_3:GetBossHpRate() > 0.5 then
					var_1_10009 = "_1"
					setActive = var_10

					local var_27_7 = arg_27_0.mapFX

					var_10(var_11.Find(var_27_7, "state_4/6_1"), true)
				else
					setActive = var_10

					local var_27_8 = arg_27_0.mapFX

					var_10(var_11.Find(var_27_8, "state_4/6_2"), true)
				...
				local var_27_9 = var_10("ui/dalcollabbossrushsceneui_atlas", "map_" .. iter_27_2 .. var_1_10009)

				setImageSprite = var_11

				var_11(iter_27_3, var_27_9, true)
			else
				GetSpriteFromAtlas = var_1_10009
				var_1_10009 = var_1_10009("ui/dalcollabbossrushsceneui_atlas", "map_" .. iter_27_2 .. "_3")
				setImageSprite = var_10

				var_10(iter_27_3, var_1_10009, true)
			end
		end
	else
		setActive = var_4
		...
		var_4(var_5.Find(var_27_10, "state_2"), true)

		setActive = var_4

		local var_27_11 = arg_27_0.mapFX

		var_4(var_5.Find(var_27_11, "state_1"), true)

		setActive = var_4

		local var_27_12 = arg_27_0.mapFX

		var_4(var_5.Find(var_27_12, "state_3"), true)
		...
		for iter_27_4, iter_27_5 in var_4(arg_27_0.maps) do
			if iter_27_4 == 6 then
				...
				var_1_10009(iter_27_5, false)
			else
				setActive = var_1_10009

				var_1_10009(iter_27_5, true)

				local var_27_13 = var_2[iter_27_4]
				local var_27_14 = var_1_10009.GetDefeated(var_27_13, arg_27_0.activity)
				local var_27_15
				local var_27_16 = not var_27_14 and "_1" or var_1_10009:GetBossTimeStamp() ~= 0 and "" or var_1_10009:GetBossHpRate() > 0.5 and "_1" or "_2"

				GetSpriteFromAtlas = var_12

				local var_27_17 = var_12("ui/dalcollabbossrushsceneui_atlas", "map_" .. iter_27_4 .. var_27_16)

				setImageSprite = var_13

				var_13(iter_27_5, var_27_17, true)

				if iter_27_4 ~= 1 then
					if var_27_16 == "" then
						setActive = var_13

						local var_27_18 = arg_27_0.mapFX

						var_13(var_14.Find(var_27_18, "state_3/" .. iter_27_4), true)
					elseif var_27_16 == "_1" then
						setActive = var_13

						local var_27_19 = arg_27_0.mapFX

						var_13(var_14.Find(var_27_19, "state_1/" .. iter_27_4), true)
					elseif var_27_16 == "_2" then
						setActive = var_13

						local var_27_20 = arg_27_0.mapFX

						var_13(var_14.Find(var_27_20, "state_2/" .. iter_27_4), true)
					end
				end
			end
		end
...
function var_0_1.UpdateBattle(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_1_10005(var_28_3) do
		table = var_1_10010
	...
	var_5.Foreach(arg_28_0.seriesNodes, function(arg_30_0, arg_30_1)
		...
		local var_30_4 = var_3:IsPass()
		local var_30_5 = var_3
		local var_30_6 = var_3.GetDefeated(var_30_5, arg_28_0.activity)

		if var_30_0 == 6 and not var_30_3 then
			setActive = var_30_5

			var_30_5(arg_30_1, false)
		end

		setActive = var_30_5

		var_30_5(arg_30_1:Find("lock"), not var_30_3)

		setActive = var_30_5

		var_30_5(arg_30_1:Find("clear"), var_30_3 and var_30_4 and var_30_6)

		setActive = var_30_5

		var_30_5(arg_30_1:Find("active"), var_30_3 and (not var_30_4 or not var_30_6))

		table = var_30_5

		local var_30_7 = var_30_5.indexof(var_28_4, var_3)

		if not var_30_3 then
			setText = var_8

			var_8(arg_30_1:Find("lock/name"), var_3:GetSeriesCode())
		elseif var_3:IsPass() and var_30_6 then
			setText = var_8
			...
			local var_30_8 = var_3:GetBossHpRate() * 100 .. "%"

			setText = var_9

			var_9(arg_30_1:Find("active/common/value"), var_3:IsPass() and "HOLD" or var_30_8)

			setText = var_9

			var_9(arg_30_1:Find("active/current/value"), var_3:IsPass() and "HOLD" or var_30_8)
			...
			local var_30_9 = arg_30_1:Find("active/current/progress")
			local var_30_10 = var_9.GetComponent

			typeof = var_11
			Image = var_12
			var_30_10(var_30_9, var_11(var_12)).fillAmount = var_3:IsPass() and 1 or var_3:GetBossHpRate()
		end
		...
		;(function(arg_31_0)
			if var_30_7 > 3 then
				...
				local var_31_0 = var_1.map

				_ = var_2

				local var_31_1 = var_31_0(var_2.range(arg_31_0.childCount), function(arg_32_0)
				...
				var_2.Foreach(var_31_1, function(arg_33_0, arg_33_1)
					setActive = var_4_10002

					var_4_10002(arg_33_1, arg_33_0 <= 4 - var_30_7)
		...
		local var_30_11 = arg_28_0
		local var_30_12 = arg_30_1
		...
		local function var_30_13()
			if not var_30_3 then
				...
				CollabrateBossRushSeriesData = var_34_4

				local var_34_6 = var_34_4.New({
				...
				var_34_10(var_34_9, var_3_10007("series_enemy_unlock", var_34_7))
			...
			local function var_34_11()
				...
				if not var_0.updateShipPosition(var_35_1) then
					...
					typeof = var_3
					CanvasGroup = var_4
					var_35_5(var_35_4, var_3(var_4)).interactable = true
				end
		...
		var_9(var_30_11, var_30_12, var_30_13, var_2_10013)
...
function var_0_1.updateShipPosition(arg_41_0)
	...
	var_41_1.Foreach(arg_41_0.seriesNodes, function(arg_42_0, arg_42_1)
		...
		local var_42_3 = var_42_2(var_42_1, var_2_10006(var_2_10007))
	...
	if arg_41_0._lastShip then
		if arg_41_0._lastShip ~= arg_41_0._currentShip then
			...
			var_41_5(var_4.Find(var_41_3, "vx_teleport_2"), true)
			...
			typeof = var_5
			CanvasGroup = var_6
			var_41_5 = var_41_5(var_41_4, var_5(var_6))
		...
		var_41_5(var_4.Find(var_41_6, "vx_teleport_1"), true)
...
function var_0_1.checkAllStory(arg_43_0)
	...
	for iter_43_0, iter_43_1 in var_1_10003(var_43_1) do
		table = var_1_10008
		var_1_10008 = var_1_10008.contains

		local var_43_3 = arg_43_0.activity

		if var_1_10008(var_9.GetPassCounts(var_43_3), iter_43_0) then
			local var_43_4 = iter_43_1

			var_1_10008 = iter_43_1.GetStorys(var_43_4)
			ipairs = var_43_4

			for iter_43_2, iter_43_3 in var_43_4(var_1_10008) do
				table = var_1_10014
	...
	local function var_43_6()
		...
		local var_44_0 = var_43_2[var_43_5]
		local var_44_1
		...
		if var_44_0 == nil and var_44_3 then
			...
			local var_44_4 = var_44_2.NewStoryMgr.GetInstance()

			var_44_1 = true
			ipairs = var_4

			for iter_44_0, iter_44_1 in var_4(var_44_3[2]) do
		...
		if var_44_1 then
			local function var_44_5()
				...
				var_3_10000(var_1.Find(var_45_0, "map_6"), false)
			...
			var_3.PlayStory(var_44_7, var_44_0, var_43_6)
		end

		return
	end

	arg_43_0:PlayStory(var_43_2[var_43_5], var_43_6)
...
function var_0_1.GetFinalStoryName(arg_46_0)
	...
	local var_46_2 = var_1_10003(var_46_1:getConfig("story_worldboss"))

	table = var_4

	var_4.sort(var_46_2, function(arg_47_0, arg_47_1)
