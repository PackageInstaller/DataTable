...
function var_0_1.OnInit(arg_3_0)
	...
	for iter_3_0 = 0, arg_3_0.toggleList.childCount - 1 do
		...
		var_3_9(var_3_23, var_7.Find(var_3_24, "item" .. iter_3_0 + 1))
	end
	...
	var_1(var_2.Find(var_3_27, "panel/title/ASvalue"), false)

	setText = var_1

	local var_3_28 = arg_3_0._tf
	local var_3_29 = var_2.Find(var_3_28, "panel/formation_btn/text")

	i18n = var_3_28

	var_1(var_3_29, var_3_28("autofight_formation"))

	setText = var_1

	local var_3_30 = arg_3_0._tf
	local var_3_31 = var_2.Find(var_3_30, "panel/commander_btn/text")

	i18n = var_3_30

	var_1(var_3_31, var_3_30("autofight_cat"))

	setText = var_1

	local var_3_32 = arg_3_0._tf
	local var_3_33 = var_2.Find(var_3_32, "panel/title/Image/text")

	i18n = var_3_32

	var_1(var_3_33, var_3_32("fleet_select_title"))
...
function var_0_1.SetFleets(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_11_0(arg_11_1) do
		...
		if iter_11_1.isSubmarineFleet(var_11_1) then
			local var_11_2 = arg_11_0.fleets

			FleetType = var_11_1

			local var_11_3 = #var_11_2[var_11_1.Submarine]
			local var_11_4 = arg_11_0

			var_11_1 = arg_11_0.getLimitNums
			FleetType = var_1_10010

			if var_11_3 < var_11_1(var_11_4, var_1_10010.Submarine) then
				table = var_11_3

				local var_11_5 = var_11_3.insert

				var_11_1 = arg_11_0.fleets
				FleetType = var_11_4

				var_11_5(var_11_1[var_11_4.Submarine], iter_11_1)
			end
		else
			...
			local var_11_7 = #var_11_6[var_11_1.Normal]
			local var_11_8 = arg_11_0
			local var_11_9 = arg_11_0.getLimitNums

			FleetType = var_1_10010

			if var_11_7 < var_11_9(var_11_8, var_1_10010.Normal) then
				table = var_11_7

				local var_11_10 = var_11_7.insert
				local var_11_11 = arg_11_0.fleets

				FleetType = var_11_8

				var_11_10(var_11_11[var_11_8.Normal], iter_11_1)
			end
		end
	end
...
function var_0_1.SetOilLimit(arg_12_0, arg_12_1)
	...
	var_3(arg_12_0.rtCostLimit, var_12_0)

	setText = var_3

	local var_12_1 = arg_12_0.rtCostLimit
	local var_12_2 = var_4.Find(var_12_1, "text")

	i18n = var_12_1

	var_3(var_12_2, var_12_1("formationScene_use_oil_limit_tip_worldboss"))
	...
	if var_12_0 then
		...
		var_12_2(var_5.Find(var_12_5, "cost_noraml/Text"), var_12_4 > 0)

		if 0 < var_12_4 then
			setText = var_4

			local var_12_6 = arg_12_0.rtCostLimit
			local var_12_7 = var_5.Find(var_12_6, "cost_noraml/Text")

			string = var_12_6

			local var_12_8 = var_12_6.format
			local var_12_9 = "%s(%d)"

			i18n = var_1_10008

			var_4(var_12_7, var_12_8(var_12_9, var_1_10008("formationScene_use_oil_limit_surface"), var_12_4))
		end
		...
		var_4(var_5.Find(var_12_11, "cost_boss/Text"), var_12_10 > 0)
		...
		var_4(var_5.Find(var_12_13, "cost_sub/Text"), var_12_12 > 0)

		if 0 < var_12_12 then
			setText = var_4

			local var_12_14 = arg_12_0.rtCostLimit
			local var_12_15 = var_5.Find(var_12_14, "cost_sub/Text")

			string = var_12_14

			local var_12_16 = var_12_14.format
			local var_12_17 = "%s(%d)"

			i18n = var_1_10008

			var_4(var_12_15, var_12_16(var_12_17, var_1_10008("formationScene_use_oil_limit_submarine"), var_12_12))
		end
	end
...
function var_0_1.UpdateView(arg_15_0)
	...
	arg_15_0.UpdateFleets(var_15_0)
	...
	if not var_1 then
		pg = var_1
		var_15_0 = var_1.SystemOpenMgr.GetInstance()
		...
		var_15_3 = var_15_1(var_15_0, var_3.getRawData(var_15_2).level, "CommanderCatMediator")
	else
		var_15_3 = false
	end
	...
	var_15_0(var_15_4, true)

	setActive = var_15_0

	var_15_0(arg_15_0.commanderToggle, var_15_3)

	setActive = var_15_0

	var_15_0(arg_15_0.btnTry, arg_15_0.showTryBtn)
...
function var_0_1.updateFleet(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_5 = var_18_4(var_18_3, var_1_10009.Main)
	local var_18_6 = var_18_1
	local var_18_7 = var_18_1.Find

	TeamType = var_1_10010

	local var_18_8 = var_18_7(var_18_6, var_1_10010.Vanguard)
	local var_18_9 = var_18_1
	local var_18_10 = var_18_1.Find

	TeamType = var_1_10011

	local var_18_11 = var_18_10(var_18_9, var_1_10011.Submarine)
	local var_18_12 = var_18_1:Find("btn_recom")
	local var_18_13 = var_18_1:Find("btn_clear")
	local var_18_14 = var_18_1:Find("selected")
	local var_18_15 = var_18_1
	local var_18_16 = var_18_1.Find(var_18_15, "commander")
	...
	if var_3 and var_18_0 then
		...
		var_18_15(var_18_21, var_18_22)

		FleetType = var_18_15

		if arg_18_1 == var_18_15.Submarine then
			local var_18_23 = arg_18_0
			local var_18_24 = arg_18_0.updateShips
			local var_18_25 = var_18_11
			local var_18_26 = var_18_0.subShips

			var_1_10018 = var_18_0.id
			TeamType = var_1_10019

			var_18_24(var_18_23, var_18_25, var_18_26, var_1_10018, var_1_10019.Submarine)
		else
			...
			var_18_28(var_18_27, var_18_29, var_18_30, var_1_10018, var_1_10019.Main)
			...
			var_18_32(var_18_31, var_18_33, var_18_34, var_1_10018, var_19.Vanguard)
		end
		...
		var_14(var_18_35, var_18_36, var_18_37, var_1_10018)
	end
...
function var_0_1.updateShips(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4)
	...
	local var_21_0 = var_1_10005(var_6)

	for iter_21_0 = 1, 3 do
		local var_21_1

		if not var_21_0:getShipById(arg_21_2[iter_21_0]) or not arg_21_0.tfShipTpl then
			var_21_1 = arg_21_0.tfEmptyTpl
		end

		cloneTplTo = var_12

		local var_21_2 = var_12(var_21_1, arg_21_1)

		setActive = var_13

		var_13(var_21_2, true)

		if var_10 then
			updateShip = var_13

			var_13(var_21_2, var_10)

			setActive = var_13

			var_13(var_21_2:Find("event_block"), var_10:getFlag("inEvent"))
		end

		setActive = var_13

		var_13(var_21_2:Find("ship_type"), false)
		...
		local var_21_4 = var_13(var_21_3, var_15(var_16)).onLongPressed

		var_14.RemoveAllListeners(var_21_4)
		...
		var_21_4(arg_21_0, var_21_2, var_21_5)

		local var_21_6 = var_13.onLongPressed

		var_15.AddListener(var_21_6, function()
			if var_0 then
...
function var_0_1.updateCommanderBtn(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_5 = var_5:Find("blank")
	local var_24_6 = var_5
	local var_24_7 = var_5.Find(var_24_6, "commander")

	setActive = var_24_6

	var_24_6(var_24_2, false)

	setActive = var_24_6

	var_24_6(var_24_3, var_3 and not arg_24_0.viewParent.contextData.showCommander)

	setActive = var_24_6

	var_24_6(var_24_4, var_3 and not arg_24_0.viewParent.contextData.showCommander)

	setActive = var_24_6

	var_24_6(var_24_7, var_3 and var_24_0 and arg_24_0.viewParent.contextData.showCommander)

	setActive = var_24_6

	var_24_6(var_24_5, not var_3 or var_3 and not var_24_0 and arg_24_0.viewParent.contextData.showCommander)
...
function var_0_1.updateCommanders(arg_25_0, arg_25_1, arg_25_2)
	for iter_25_0 = 1, 2 do
		...
		var_25_3(var_25_2, not var_25_0)

		setActive = var_25_3

		var_25_3(var_25_4, var_25_0)

		if var_25_0 then
			Commander = var_25_3
			var_25_3 = var_25_3.rarity2Frame(var_25_0:getRarity())
			setImageSprite = var_12

			local var_25_5 = var_25_4
			local var_25_6 = var_25_4.Find(var_25_5, "frame")

			GetSpriteFromAtlas = var_25_5

			var_12(var_25_6, var_25_5("weaponframes", "commander_" .. var_25_3))

			GetImageSpriteFromAtlasAsync = var_12

			local var_25_7 = "CommanderHrz/"

			var_1_10015 = var_25_0

			var_12(var_25_7 .. var_25_0.getPainting(var_1_10015), "", var_25_4:Find("mask/icon"))
		end
		...
		var_25_3(var_25_8, var_25_9, var_25_10, var_1_10015)

		onButton = var_25_3

		local var_25_11 = arg_25_0
		local var_25_12 = var_25_4

		local function var_25_13()
		...
		var_25_3(var_25_11, var_25_12, var_25_13, var_1_10015)
	end
