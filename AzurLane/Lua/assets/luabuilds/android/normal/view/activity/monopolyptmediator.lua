...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	local var_3_3 = arg_3_1.getType(var_3_2)

	ActivityProxy = var_3_2

	if var_3_0 ~= var_3_2.ACTIVITY_UPDATED then
		ActivityProxy = var_5
		...
		if var_3_0 == var_5.ACTIVITY_ADDED then
			...
			if var_3_0 == var_5.ACT_NEW_PT_DONE then
				...
				var_3_5(var_3_4, var_1_10007.ON_ACHIEVE, var_3_1.awards, var_3_1.callback)
			else
				GAME = var_3_5
				...
				if var_3_0 == var_3_5.BEGIN_STAGE_DONE then
					...
					local var_3_8 = var_1_10007.GO_SCENE

					SCENE = var_1_10008

					var_3_7(var_3_6, var_3_8, var_1_10008.COMBATLOAD, var_3_1)
				end
			end
		end
