...
function var_0_1.register(arg_1_0)
	...
	WorkBenchItemDetailMediator = var_1_10003
	...
	local var_1_4 = var_1_3(var_1_2, var_3.ACTIVITY_TYPE_VIRTUAL_BAG)
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.ACTIVITY_UPDATED then
		...
		if var_4_4 == var_4_3.ACTIVITY_TYPE_VIRTUAL_BAG then
		...
		if var_4_0 == var_4_4.WORKBENCH_ITEM_GO then
