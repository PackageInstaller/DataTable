...
function var_0_0.initData(arg_2_0)
	...
	if var_0_4 and #var_0_4 > 0 then
		...
		var_2_0(var_2_1, var_1_10003(var_2_2[var_1_10005.random(1, #var_0_4)]))
	end
	...
	if var_0_5 and #var_0_5 > 0 then
		...
		var_2_3(var_2_4, var_1_10003(var_2_5[var_1_10005.random(1, #var_0_5)]))
	end
	...
	if var_0_6 and #var_0_6 > 0 then
		...
		var_2_6(var_2_7, var_1_10003(var_2_8[var_1_10005.random(1, #var_0_6)]))
	end
...
function var_0_0.initUI(arg_3_0)
	...
	for iter_3_0 = 1, 3 do
		...
		var_1_10005(var_3_0, var_1_10007(arg_3_0._tf, "showChar" .. iter_3_0))
	end
	...
	typeof = var_3
	Animator = iter_3_0
	arg_3_0.commonAnim = var_3_2(var_3_1, var_3(iter_3_0))
	findTF = var_1
...
function var_0_0.initEvent(arg_4_0)
	...
	local function var_4_5()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.help_monopoly_car_2.tip
	...
	for iter_4_0 = 1, #arg_4_0.showChars do
		var_1_10005 = arg_4_0.showChars[iter_4_0]
		onButton = var_1_10006

		local var_4_6 = arg_4_0._binder
		local var_4_7 = var_1_10005
		...
		var_1_10006(var_4_6, var_4_7, var_4_8, var_1_10010)
	end
	...
	for iter_29_0 = 1, #var_29_0 do
		...
		for iter_29_1 = 1, #var_29_3 do
			...
			if 0 < var_29_5 then
				...
				var_1_10018 = var_1_10018(var_0_9, var_29_9)
				findTF = var_19
...
function var_0_0.initChar(arg_31_0)
	...
	for iter_31_0 = 1, #arg_31_0.showCharNames do
		...
		local var_31_2 = var_1_10006.GetInstance()

		var_1_10006.GetSpineChar(var_31_2, var_31_1, true, function(arg_33_0)
			...
			local var_33_5 = var_33_4(var_33_3, var_3(var_4))
