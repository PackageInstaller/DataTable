	...
	arg_2_0.awardsTimer = var_1.New(function()
		if arg_2_0.awardTfs and #arg_2_0.awardTfs > 0 then
			for iter_4_0 = #arg_2_0.awardTfs, 1, -1 do
				...
				local var_4_0 = var_5.y

				if 150 <= var_4_0 then
					Destroy = var_4_0
					table = var_7

					var_4_0(var_7.remove(arg_2_0.awardTfs, iter_4_0))
				else
...
function var_0_0.initUI(arg_5_0)
	...
	local var_5_0 = var_2(arg_5_0._tf, "desc")

	i18n = var_3

	var_1(var_5_0, var_3("monopoly3thre_tip"))
	...
	typeof = var_3
	Animator = var_4
	arg_5_0.commonAnim = var_5_2(var_5_1, var_3(var_4))
	findTF = var_1
	...
	for iter_5_0 = 1, 3 do
		findTF = var_1_10005
		var_1_10005 = var_1_10005(arg_5_0._tf, "map/mask/ground" .. iter_5_0)

		local var_5_3 = {}

		for iter_5_1 = 1, var_1_10005.childCount do
			table = var_1_10011

			var_1_10011.insert(var_5_3, var_1_10005:GetChild(iter_5_1 - 1))
		end

		table = var_7

		var_7.insert(arg_5_0.groundChildsList, var_5_3)
	end

	Ship = var_1

	local var_5_4 = var_1.New({
		configId = var_0_1,
		skin_id = var_0_2
	})
	local var_5_5 = var_1.getPrefab(var_5_4)

	PoolMgr = var_5_4

	local var_5_6 = var_5_4.GetInstance()

	var_3.GetSpineChar(var_5_6, var_5_5, true, function(arg_6_0)
		...
		var_6_3.anim = var_6_5(var_6_4, var_4(var_2_10005))
	...
	local var_5_7 = arg_5_0.randomMoveTiemr
...
function var_0_0.initEvent(arg_7_0)
	...
	local function var_7_11()
		...
		pg = var_2_10003
		var_11_2.helps = var_2_10003.gametip.help_monopoly_3th.tip
	...
	local function var_7_14()
		...
		if var_12_0(var_2_10001(arg_7_0.cellPos)) then
			LeanTween = var_0
			...
			var_12_1(var_1(arg_7_0.cellPos))
		end
	...
	local function var_7_17()
		if arg_7_0.leftAwardCnt > 0 then
			...
			Monopoly3thRePage = var_2_10002

			var_14_1(var_14_0, var_2_10002.ON_AWARD)
		end
	...
	var_1_10001(var_7_15, var_7_16, var_7_17, var_1_10005)
...
function var_0_0.addAwards(arg_15_0, arg_15_1)
	...
	for iter_15_0 = 1, #arg_15_1 do
		...
		go = var_1_10009
		var_1_10007 = var_1_10007(var_1_10008(var_1_10009(arg_15_0.awardTf)))
...
function var_0_0.start(arg_16_0)
	...
	if arg_16_0.leftCount and arg_16_0.leftCount <= 0 then
		...
		var_16_1(var_16_0, var_1_10003("common_count_noenough"))
	...
	var_16_3(var_16_2, var_3.ON_START, arg_16_0.activity.id, function(arg_17_0)
...
function var_0_0.checkPlayerRandomMove(arg_18_0)
	...
	if var_1.random() > 0.5 then
		...
		local var_18_7 = var_18_6(var_18_5, var_7.linear)
		local var_18_8 = var_5.setOnUpdate

		System = var_7

		local var_18_9 = var_18_8(var_18_7, var_7.Action_float(function(arg_19_0)
		...
		var_18_10(var_18_9, var_7.Action(function()
...
function var_0_0.checkCountStory(arg_22_0, arg_22_1)
	...
	if var_22_1.detect(var_22_2, function(arg_23_0)
		return arg_23_0[1] == var_22_0
	end) then
		pg = var_6

		local var_22_3 = var_6.NewStoryMgr.GetInstance()
...
function var_0_0.changeAnimeState(arg_24_0, arg_24_1, arg_24_2)
	if arg_24_1 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_24_0, var_1_10005(var_1_10006))
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_24_1, var_1_10005(var_1_10006))
		var_1_10003.raycastTarget = false
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_24_2, var_1_10005(var_1_10006))
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_24_3, var_1_10005(var_1_10006))
		var_1_10003.raycastTarget = true
	end
	...
	if not arg_24_1 and not arg_24_0.autoFlag and arg_24_2 then
		...
		var_24_5(var_24_4, var_1_10005.ON_STOP, nil, function()
			return
		end)
	end
...
function var_0_0.checkLastBonus(arg_31_0)
	if (not arg_31_0.lastBonusFlag or arg_31_0.lastBonusFlag == 0) and arg_31_0.useCount then
		local var_31_0 = arg_31_0.useCount

		if arg_31_0.lastBonusTimes <= var_31_0 then
			var_1_10002 = arg_31_0._event

			local var_31_1 = var_1.emit

			Monopoly3thRePage = var_1_10003

			var_31_1(var_1_10002, var_1_10003.MONOPOLY_OP_LAST, arg_31_0.activity.id, function(arg_32_0)
				...
				var_32_0(var_2(arg_31_0.labelDropShip, "get"), false)

				setActive = var_32_0
				findTF = var_2

				var_32_0(var_2(arg_31_0.labelDropShip, "got"), true)

				setActive = var_32_0
				findTF = var_2

				var_32_0(var_2(arg_31_0.labelDropShip, "text"), false)
	...
	if arg_31_0.lastBonusFlag == 1 then
		...
		var_1(var_1_10002(arg_31_0.labelDropShip, "get"), false)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_31_0.labelDropShip, "got"), true)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_31_0.labelDropShip, "text"), false)
	end
...
function var_0_0.activityDataUpdata(arg_33_0, arg_33_1)
	...
	local var_33_3 = var_1_10004.ceil((var_33_1 - var_33_2) / 0)
	...
	local var_33_6 = var_10.max
	local var_33_7 = 0

	math = var_1_10012
	arg_33_0.advanceRpCount = var_33_6(var_33_7, var_1_10012.min(var_9, arg_33_0.advanceTotalCnt) - var_33_5)
	math = var_10

	local var_33_8 = var_10.max(0, var_9 - arg_33_0.advanceTotalCnt)

	math = var_11
	arg_33_0.commonRpCount = var_33_8 - var_11.max(0, var_33_5 - arg_33_0.advanceTotalCnt)
...
function var_0_0.checkStep(arg_34_0, arg_34_1)
	if arg_34_0.step > 0 then
		...
		var_34_1(var_34_0, var_1_10004.ON_MOVE, arg_34_0.activity.id, function(arg_35_0, arg_35_1, arg_35_2)
...
function var_0_0.updataUI(arg_39_0)
	...
	if var_39_0(var_2(arg_39_0.btnRp)) then
		LeanTween = var_39_1
		var_39_1 = var_39_1.cancel
		go = var_2

		var_39_1(var_2(arg_39_0.btnRp))
	end
	...
	local var_39_3 = var_2(arg_39_0.btnRp)
	local var_39_4 = 1

	System = var_4

	var_39_2(var_39_3, var_39_4, var_4.Action(function()
	...
	if arg_39_0.nextredPacketStep and arg_39_0.nextredPacketStep ~= 0 then
		...
		var_2(var_3(arg_39_0._tf, "countTip/ad"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_39_0._tf, "countTip/adB"), false)
	else
		setText = var_2
		...
		var_2(var_3(arg_39_0._tf, "countTip/ad"), false)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_39_0._tf, "countTip/adB"), true)
	end
...
function var_0_0.checkEffect(arg_42_0, arg_42_1)
	if arg_42_0.effectId > 0 then
		...
		local var_42_2 = arg_42_0.getActionName(var_42_1, arg_42_0.pos)
		...
		var_42_1({
			function(arg_43_0)
				if var_42_2 then
					...
					var_1.changeCharAction(var_43_0, var_42_2, 1, function()
...
function var_0_0.triggerEfect(arg_48_0, arg_48_1)
	...
	var_48_1(var_48_0, var_1_10004.ON_TRIGGER, arg_48_0.activity.id, function(arg_49_0, arg_49_1)
...
function var_0_0.moveCharWithPaths(arg_52_0, arg_52_1, arg_52_2, arg_52_3)
	...
	var_1_10005.insert(var_52_0, function(arg_53_0)
		...
		local var_53_7 = var_6.isTweening

		go = var_7

		local var_53_8

		if var_53_7(var_7(arg_52_0.cellPos)) then
			LeanTween = var_53_8
			var_53_8 = var_53_8.cancel
			go = var_7

			var_53_8(var_7(arg_52_0.cellPos))
		end
		...
		local var_53_10 = var_53_9(var_7(arg_52_0.cellPos), 0, var_53_1, var_53_0)
		local var_53_11 = var_6.setEase

		LeanTweenType = var_8

		local var_53_12 = var_53_11(var_53_10, var_8.linear)
		local var_53_13 = var_6.setOnUpdate

		System = var_8

		local var_53_14 = var_53_13(var_53_12, var_8.Action_float(function(arg_54_0)
		...
		var_53_15(var_53_14, var_8.Action(function()
			arg_53_0()
...
function var_0_0.createCell(arg_57_0, arg_57_1)
	...
	local var_57_2 = var_1_10004(var_1_10005(var_1_10006(arg_57_0.tplCell)))

	Vector3 = var_5
	var_57_2.localPosition = var_5(arg_57_1, 0, 0)
	...
	local var_57_6 = var_57_5(var_57_4, var_8(var_1_10009))
	...
	local var_57_9 = var_57_8(var_57_7, var_8(var_1_10009))
...
function var_0_0.updateMap(arg_58_0, arg_58_1)
	...
	for iter_58_3 = 1, #arg_58_0.groundChildsList do
		for iter_58_4 = #arg_58_0.groundChildsList[iter_58_3], 1, -1 do
			if var_6[iter_58_4].anchoredPosition.x <= -var_11.sizeDelta.x and #var_6 > 1 then
				table = var_12

				local var_58_3 = var_12.remove(var_6, iter_58_4)

				Vector3 = var_13
				var_58_3.anchoredPosition = var_13(var_6[#var_6].anchoredPosition.x + var_6[#var_6].sizeDelta.x, var_11.anchoredPosition.y, var_11.anchoredPosition.z)
				table = var_13

				var_13.insert(var_6, var_58_3)
			end
		end
	end
...
function var_0_0.dispose(arg_63_0)
	...
	if var_63_4(var_2(arg_63_0.cellPos)) then
		LeanTween = var_1
		...
		var_63_5(var_2(arg_63_0.cellPos))
	end
	...
	if arg_63_0.awardTfs and #arg_63_0.awardTfs > 0 then
		for iter_63_1 = #arg_63_0.awardTfs, 1, -1 do
			...
			var_1_10005(var_1_10006.remove(arg_63_0.awardTfs, iter_63_1))
		end
	end
