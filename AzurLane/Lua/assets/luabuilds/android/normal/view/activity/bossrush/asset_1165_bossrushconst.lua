...
function var_0_0.GetPassedLayer(arg_1_0)
	...
	var_1_1[var_1_10004.ALVIT_BOSS_RUSH_ID] = function()
		BossRushAlvitPassedLayer = var_2_10000

		return var_2_10000
	end
	ActivityConst = var_4
	var_1_1[var_4.ZENGKEHAIJUNSHANGJIANG_BOSS_RUSH_ID] = function()
		BossRushSardiniaPassedLayer = var_2_10000

		return var_2_10000
	end
	ActivityConst = var_4
	var_1_1[var_4.ESCAPE_BOSS_RUSH_ID] = function()
	...
	return var_1_10001(var_1_0, var_1_1, function()
		...
		if var_2_10000(var_2_10001.activity_template[arg_1_0], {
			"config_client"
		}, {
			"passed"
		}) then
			...
			if not var_1[var_0] then
				BossRushPassedCombatLoadLayer = var_1
			end
...
function var_0_0.GetEXBattleResultLayer(arg_6_0)
	...
	ActivityConst = var_1_10004
	var_6_1[var_1_10004.ALVIT_BOSS_RUSH_ID] = function()
		BossRushAlvitEXBattleResultLayer = var_2_10000

		return var_2_10000
	end
	ActivityConst = var_4
	var_6_1[var_4.ZENGKEHAIJUNSHANGJIANG_BOSS_RUSH_ID] = function()
		BossRushVerZenkerEXBattleResultLayer = var_2_10000

		return var_2_10000
	end
	ActivityConst = var_4
	var_6_1[var_4.ESCAPE_BOSS_RUSH_ID] = function()
	...
	return var_1_10001(var_6_0, var_6_1, function()
		...
		if var_2_10000(var_2_10001.activity_template[arg_6_0], {
			"config_client"
		}, {
			"result"
		}) then
			...
			if not var_1[var_0] then
				BossRushEXBattleResultLayer = var_1
			end
