...
local var_0_0 = "SkinMagazinePage3"
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local var_4_2 = var_2.Find(var_4_1, "get/tip/Text")

	i18n = var_4_1

	var_1(var_4_2, var_4_1(var_0_1.TIP_KEY))
	...
	for iter_4_1 = 1, arg_4_0.items.childCount do
		...
		local var_4_8 = var_4_7(var_4_6, var_1_10008(var_1_10009))
		local var_4_9
		...
		local var_4_10 = var_5.Find(var_1_10008, "close")

		var_1_10008 = iter_4_1 == arg_4_0.index and 0 or 1

		var_4_8(var_4_10, var_1_10008)
		...
		var_4_8(var_4_11, var_1_10008, var_1_10009, var_1_10010)
	end
	...
	if var_1.getConfig(var_4_12, "config_client").firstStory then
		playStory = var_4_12
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10003(arg_6_0.taskList) do
		...
		var_6_1[iter_6_1] = var_1_10008(var_9.getFinishTaskById(var_6_2, iter_6_1))
		...
		local var_6_4 = var_9.GetChild(var_6_3, iter_6_0 - 1)

		var_1_10008(var_9.Find(var_6_4, "got"), var_6_1[iter_6_1])
	end
	...
	var_4(var_5.Find(var_6_8, "got"), var_6_7)

	setActive = var_4

	local var_6_9 = arg_6_0.awardTf

	var_4(var_5.Find(var_6_9, "get"), arg_6_0.remainCnt > 0 and not var_6_7)
...
function var_0_1.SelectItem(arg_7_0, arg_7_1)
	...
	for iter_7_2 = 1, arg_7_0.items.childCount do
		...
		local var_7_4 = var_7_3(var_7_2, var_1_10009(var_1_10010)).preferredWidth

		if iter_7_2 ~= arg_7_1 or not var_0_1.EXPAND_WIDTH then
			var_1_10009 = var_0_1.CLOSE_WIDTH
		end

		if var_7_4 ~= var_1_10009 then
			math = var_1_10010
			var_1_10010 = var_1_10010.abs(var_1_10009 - var_7_4) / var_0_1.DURATION_PARAMETER
			table = var_11

			local var_7_5 = var_11.insert
			local var_7_6 = arg_7_0.LTList

			LeanTween = var_1_10013
			var_1_10013 = var_1_10013.value
			go = var_1_10014
			var_1_10014 = var_1_10013(var_1_10014(var_6), var_7_4, var_1_10009, var_1_10010)
			var_1_10013 = var_1_10013.setEase
			LeanTweenType = var_15
			var_1_10014 = var_1_10013(var_1_10014, var_15.easeOutSine)
			var_1_10013 = var_1_10013.setOnUpdate
			System = var_15

			var_7_5(var_7_6, var_1_10013(var_1_10014, var_15.Action_float(function(arg_8_0)
			...
			local var_7_7 = var_7_5.insert
			local var_7_8 = arg_7_0.LTList

			LeanTween = var_1_10013
			var_1_10014 = var_1_10013.alpha(var_6:Find("close"), iter_7_2 == arg_7_1 and 0 or 1, var_1_10010)
			var_1_10013 = var_1_10013.setEase
			LeanTweenType = var_15

			var_7_7(var_7_8, var_1_10013(var_1_10014, var_15.easeOutSine).uniqueId)
		end
	end
...
function var_0_1.UpdateDrop(arg_9_0)
	...
	local var_9_3, var_9_4, var_9_5 = var_3(var_9_1:getConfig("award_display")[1])
	...
	local var_9_8 = var_5.Find(var_9_7, "get")
	...
	local function var_9_9()
		...
		var_10_1(var_10_0, var_2_10002.ON_TASK_SUBMIT, var_9_1)
	...
	var_9_3(var_9_6, var_9_8, var_9_9, var_7)
	...
	var_9_3(arg_9_0, arg_9_0.awardTf, function()
		...
		var_11_1(var_11_0, var_2_10002.ON_DROP, var_9_2)

		return
	end)

	local var_9_10 = var_9_1
	local var_9_11 = var_9_1.isReceive(var_9_10)

	setActive = var_9_10

	local var_9_12 = arg_9_0.awardTf

	var_9_10(var_5.Find(var_9_12, "got"), var_9_11)

	setActive = var_9_10

	local var_9_13 = arg_9_0.awardTf

	var_9_10(var_5.Find(var_9_13, "get"), arg_9_0.remainCnt > 0 and not var_9_11)
