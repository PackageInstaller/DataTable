...
function var_0_1.didEnter(arg_3_0)
	...
	handler = var_1_10005
	var_3_0[1] = var_3_2(var_3_1, var_3_3, var_1_10005(arg_3_0, arg_3_0.OnUpdateEventInfo))
...
function var_0_1.RefreshUI(arg_5_0, arg_5_1, arg_5_2)
	...
	for iter_5_0, iter_5_1 in var_1_10005(var_5_0:GetEventSummary()) do
		if iter_5_1.commonEventData then
			...
			AuctionGameConst = var_1_10014
			var_5_4.type = var_1_10014.EVENT_TYPE_GROUP.COMMON
			var_5_4.round = iter_5_0
			var_5_4.eventData = iter_5_1.commonEventData

			var_5_2(var_5_3, var_1_10012, var_5_4)
		end
		...
		if iter_5_1.personalEventData then
			...
			AuctionGameConst = var_1_10014
			var_5_7.type = var_1_10014.EVENT_TYPE_GROUP.PERSONAL
			var_5_7.round = iter_5_0
			var_5_7.eventData = iter_5_1.personalEventData

			var_5_5(var_5_6, var_1_10012, var_5_7)
		end
	end
	...
	for iter_5_2, iter_5_3 in var_5(var_5_1) do
		...
		if not arg_5_0.itemList[iter_5_2] then
			...
			var_5_9 = var_5_9(var_1_10012(arg_5_0.uiItemTf, arg_5_0.uiContentTf), arg_5_0._parentClass)
		end
