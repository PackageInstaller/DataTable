...
function var_0_1.init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("auction_value"))
	...
	var_1_10001(var_2_1, var_3("auction_ticket"))
	...
	var_1_10001(var_2_2, var_3("auction_matching"))
	...
	var_1_10001(var_2_3, var_3("auction_assistant"))
	...
	var_1_10001(var_2_4, var_3("auction_activity_closed"))
	...
	var_1_10001(var_2_5, var_3("auction_relief_tip"))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_2_0.matchEventCom = var_1_10001(var_2_6, var_3(var_4))
	...
	var_1.SetEndEvent(var_2_7, function(arg_3_0)
		...
		PlayRoomCommonMediator = var_2_10003

		local var_3_2 = var_2_10003.ON_CLICK_QUICK_MATCH
		local var_3_3 = {}

		pg = var_2_10005
		var_3_3.type = var_2_10005.auction_session[arg_2_0.curSelectedID].game_type
	...
	local function var_2_13()
		...
		var_5_1(var_5_0, var_2_10002.BuildAuctionHelp())
		...
		var_5_4.type = var_2_10003
		pg = var_2_10003
		var_5_4.helps = var_2_10003.gametip.auction_help.tip
	...
	local function var_2_19()
		if not arg_2_0.quickMatchSuccess and arg_2_0.startQuickMatch == true then
			...
			BaseUI = var_2_10002
			var_2_10002 = var_2_10002.ON_ADD_SUBLAYER
			Context = var_2_10003
			var_2_10003 = var_2_10003.New

			local var_7_2 = {}

			AuctionGameMainMsgLayer = var_2_10005
			var_7_2.viewComponent = var_2_10005
			AuctionGameMainMsgMediator = var_2_10005
			var_7_2.mediator = var_2_10005
			var_2_10005 = {}
			i18n = var_2_10006
			var_2_10005.content = var_2_10006("auction_main_match_exit")

			function var_2_10005.comformCallback()
				...
				local var_8_3 = var_3_10002.ON_ADD_SUBLAYER

				Context = var_3_10003

				local var_8_4 = var_3_10003.New
				local var_8_5 = {}

				AuctionGameTaskScene = var_3_10005
				var_8_5.viewComponent = var_3_10005
				AuctionGameTaskMediator = var_3_10005
				var_8_5.mediator = var_3_10005
				var_8_5.data = {}
			...
			function var_2_10005.cancelCallback()
				return
			end

			var_7_2.data = var_2_10005

			var_7_1(var_7_0, var_2_10002, var_2_10003(var_7_2))
		else
			...
			local var_7_5 = var_2_10002.ON_ADD_SUBLAYER

			Context = var_2_10003

			local var_7_6 = var_2_10003.New
			local var_7_7 = {}

			AuctionGameTaskScene = var_2_10005
			var_7_7.viewComponent = var_2_10005
			AuctionGameTaskMediator = var_2_10005
			var_7_7.mediator = var_2_10005
			var_7_7.data = {}
	...
	local function var_2_22()
		...
		local var_10_0 = var_0(var_2_10001)
		local var_10_1 = var_0.getActivityByType

		ActivityConst = var_2_10003

		local var_10_2 = var_10_1(var_10_0, var_2_10003.ACTIVITY_TYPE_AUCTION_GAME)
		...
		local var_10_5 = var_10_3.GetPreorderCurrentyCnt()

		AuctionGameTools = var_2_10004

		if var_2_10004.GetCurrencyCnt() < var_10_5 then
			pg = var_4
			...
			var_10_7(var_10_6, var_2_10006("auction_currency_noenough"))
		...
		local var_10_10 = var_2_10006.ON_ADD_SUBLAYER

		Context = var_2_10007

		local var_10_11 = var_2_10007.New
		local var_10_12 = {}

		AuctionGameMainMsgLayer = var_2_10009
		var_10_12.viewComponent = var_2_10009
		AuctionGameMainMsgMediator = var_2_10009
		var_10_12.mediator = var_2_10009

		local var_10_13 = {}

		i18n = var_2_10010
		var_10_13.content = var_2_10010("auction_preorder_tips", var_10_5)

		function var_10_13.comformCallback()
			local var_11_0 = arg_2_0
			local var_11_1 = var_0.emit

			AuctionGameEntranceMediator = var_3_10002

			var_11_1(var_11_0, var_3_10002.CLICK_PREORDER_BOX)
	...
	var_1(var_2_20, var_2_21, var_2_22, var_1_10005)
	...
	local function var_2_25()
		...
		getProxy = var_0
		AuctionGameBaseProxy = var_2_10001

		local var_13_0 = var_0(var_2_10001)
		...
		if var_13_1 == 1 and var_13_5 < var_13_3 then
			...
			local var_13_6 = var_13_4.TipsMgr.GetInstance()
			local var_13_7 = var_4.ShowTips

			i18n = var_2_10006

			var_13_7(var_13_6, var_2_10006("auction_preorder_tips_1"))
		...
		AuctionGameEntranceMediator = var_2_10006

		var_13_9(var_13_8, var_2_10006.CLICK_OPEN_BOX)
	...
	var_1(var_2_23, var_2_24, var_2_25, var_1_10005)
	...
	local function var_2_28()
		...
		if not var_0.IsPlayed(var_14_0, "AUCTION_GUIDE_6") then
			...
			GAME = var_14_2
			var_14_2 = var_14_2.GO_SCENE
			SCENE = var_2_10003

			var_14_1(var_14_0, var_14_2, var_2_10003.AUCTION_GAME_MAIN_GUIDE)
		...
		if var_14_1(var_14_0).serverForbidden == 1 then
			pg = var_1
			var_14_2 = var_1.TipsMgr.GetInstance()

			local var_14_3 = var_1.ShowTips

			i18n = var_2_10003

			var_14_3(var_14_2, var_2_10003("auction_game_match_forbidden"))
		...
		if var_0.isForbidden == 1 then
			...
			var_14_4(var_14_2, var_2_10003("auction_game_match_forbidden"))
		...
		if var_0.inactiveNum == 1 and var_0.isMatchWarning == 0 then
			var_14_2 = arg_2_0
			var_14_5 = var_14_5.emit
			BaseUI = var_2_10003

			local var_14_6 = var_2_10003.ON_ADD_SUBLAYER

			Context = var_2_10004

			local var_14_7 = var_2_10004.New
			local var_14_8 = {}

			AuctionGameMainMsgLayer = var_2_10006
			var_14_8.viewComponent = var_2_10006
			AuctionGameMainMsgMediator = var_2_10006
			var_14_8.mediator = var_2_10006

			local var_14_9 = {}

			i18n = var_2_10007
			var_14_9.content = var_2_10007("auction_game_match_warning")

			function var_14_9.comformCallback()
				return
			end

			function var_14_9.cancelCallback()
				return
			end

			var_14_8.data = var_14_9

			var_14_5(var_14_2, var_14_6, var_14_7(var_14_8))

			var_14_2 = arg_2_0
			var_14_5 = var_14_5.emit
			AuctionGameEntranceMediator = var_14_6

			var_14_5(var_14_2, var_14_6.SHOW_WARNING_TIP)
		end

		AuctionGameTools = var_14_5

		local var_14_10 = var_14_5.GetCurrencyCnt()

		pg = var_14_2

		if var_14_10 < var_14_2.auction_session[arg_2_0.lastSelectedID].threshold then
			pg = var_14_10

			local var_14_11 = var_14_10.TipsMgr.GetInstance()
			local var_14_12 = var_1.ShowTips

			i18n = var_3

			var_14_12(var_14_11, var_3("auction_currency_noenough"))
		...
		local var_14_13 = arg_2_0

		var_14_13.startMatch = true
		quickPlayAnimation = var_14_13

		var_14_13(arg_2_0.uiMatchBtn, "Anim_AuctionGameEntranceUI_matchBtn_click")
	...
	var_1(var_2_26, var_2_27, var_2_28, var_1_10005.SOUND_EFFECT.START_MATCHING)
	...
	var_1(var_2_29, var_2_30, var_2_31, var_5.SOUND_EFFECT.CANCEL_MATCHING)
	...
	local function var_2_34()
		...
		local var_18_4 = var_2_10004.ON_ADD_SUBLAYER

		Context = var_2_10005

		local var_18_5 = var_2_10005.New
		local var_18_6 = {}

		AuctionGameMainMsgLayer = var_2_10007
		var_18_6.viewComponent = var_2_10007
		AuctionGameMainMsgMediator = var_2_10007
		var_18_6.mediator = var_2_10007

		local var_18_7 = {}

		i18n = var_2_10008
		var_18_7.content = var_2_10008("auction_relief_tip_2", var_18_1 - var_18_0.reliefCnt, var_18_1)
		...
		function var_18_7.comformCallback()
			...
			var_19_1(var_19_0, var_3_10002.CLICK_GET_RELIEF)
	...
	for iter_2_0, iter_2_1 in var_1(var_2.auction_session.all) do
		pg = var_1_10006

		if var_1_10006.auction_session[iter_2_1].game_type ~= 0 then
			table = var_7

			local var_2_35 = var_7.insert
			local var_2_36 = arg_2_0.locationItemList

			AuctionGameEntranceLocationItem = var_1_10009
			var_1_10009 = var_1_10009.New
			string = var_1_10010

			var_2_35(var_2_36, var_1_10009(arg_2_0[var_1_10010.format("uiLocationTf%s", #arg_2_0.locationItemList + 1)], arg_2_0, iter_2_1))
		end
	end
...
function var_0_1.didEnter(arg_21_0)
	...
	var_21_1(var_21_0, var_3.BuildAuctionEnter())
	...
	AuctionGameEntranceLocationItem = var_4

	local var_21_7 = var_4.SELECTED_LOCATION

	handler = var_5
	var_21_4[1] = var_21_6(var_21_5, var_21_7, var_5(arg_21_0, arg_21_0.OnSelectedLocation))
	...
	local var_21_12 = var_21_9.SystemGuideMgr.GetInstance()
...
function var_0_1.RefreshLocationList(arg_25_0)
	...
	local var_25_4 = iter_25_1.format
	local var_25_5 = "<color=%s>%s</color>"
	local var_25_6 = var_25_2 and "#393a3c" or "#bf5050"

	StringHelper = var_1_10008

	var_3(var_25_3, var_25_4(var_25_5, var_25_6, var_1_10008.ForamtNumberK(var_25_0.ticket)))
...
function var_0_1.FormatMatchDuration(arg_26_0, arg_26_1)
	...
	math = var_1_10004
	arg_26_1 = var_26_0(var_26_1, var_1_10004.floor(arg_26_1 or 0))
	math = var_2
...
function var_0_1.OnQuickMatch(arg_27_0)
	...
	var_27_3(var_27_2, var_3.BuildAuctionMatching(0, 0, arg_27_0.curSelectedID))
...
function var_0_1.OnClickStopQuickMatch(arg_28_0)
	if arg_28_0.startQuickMatch == true then
		...
		var_1_10003 = var_1_10003.BuildAuctionMatching

		local var_28_2 = 1

		pg = var_1_10005

		local var_28_3 = var_1_10005.TimeMgr.GetInstance()

		var_28_1(var_28_0, var_1_10003(var_28_2, var_5.GetServerTime(var_28_3) - arg_28_0.startTime, arg_28_0.curSelectedID))
	end

	local var_28_4 = arg_28_0
	local var_28_5 = arg_28_0.emit

	PlayRoomCommonMediator = var_1_10003

	var_28_5(var_28_4, var_1_10003.PLAY_ROOM_MATCH_STOP)
...
function var_0_1.OnQuickMatchSuccess(arg_29_0)
	...
	local var_29_2 = var_1_10003.BuildAuctionMatching
	local var_29_3 = 2
	...
	var_29_1(var_29_0, var_29_2(var_29_3, var_5.GetServerTime(var_29_4) - arg_29_0.startTime, arg_29_0.curSelectedID))
	...
	var_29_6(var_29_5, var_29_3.auction_session[arg_29_0.curSelectedID].ticket * -1)
	...
	AuctionGameMainMsgMediator = var_4

	local var_29_10

	if var_29_9(var_29_8, var_4) then
	...
	local var_29_13 = var_4.GO_SCENE

	SCENE = var_5

	var_29_12(var_29_11, var_29_13, var_5.AUCTION_GAME_MAIN)
...
function var_0_1.AddMatchTimer(arg_32_0)
	...
	arg_32_0.matchTimer = var_1.New(function()
		...
		var_1(var_33_2, var_3.FormatMatchDuration(var_33_3, var_33_1))
...
function var_0_1.RefreshForbidden(arg_35_0)
	...
	local var_35_0 = var_1_10001(var_1_10002).forbiddenTime
	...
	if var_35_0 > var_3.GetServerTime(var_35_1) then
		...
		var_35_1(arg_35_0.uiForbiddenGo, true)
		arg_35_0:AddForbiddenTimer(var_35_0)
	else
		setActive = var_35_1

		var_35_1(arg_35_0.uiForbiddenGo, false)
	end
...
function var_0_1.AddForbiddenTimer(arg_36_0, arg_36_1)
	...
	arg_36_0.forbiddenTimer = var_2.New(function()
		...
		if var_0.GetServerTime(var_37_0) < arg_36_1 then
			...
			var_1(var_37_1, var_2_10003(var_37_2, var_5.FormatPreorderDuration(var_37_3, arg_36_1 - var_0)))
		else
...
function var_0_1.RefreshPreorderBtn(arg_39_0)
	...
	local var_39_4 = var_39_2.TimeMgr.GetInstance()
	local var_39_5 = var_4.GetServerTime(var_39_4)

	if var_39_1 == 1 then
		setActive = var_39_4

		var_39_4(arg_39_0.uiPreorderEndGo, false)

		if var_39_5 < var_39_3 then
			setActive = var_39_4

			var_39_4(arg_39_0.uiPreorderBtn, false)

			setActive = var_39_4

			var_39_4(arg_39_0.uiPreorderTimeGo, true)

			setActive = var_39_4

			var_39_4(arg_39_0.uiOpenPreorderBtn, true)

			var_1_10006 = arg_39_0

			arg_39_0.AddPreorderTimer(var_1_10006)
		else
			setActive = var_39_4
			...
			var_39_4(arg_39_0.uiPreorderTimeGo, false)
			...
			arg_39_0.StopPreorderTimer(var_1_10006)
		end
	else
		getProxy = var_39_4
		ActivityProxy = var_1_10006

		local var_39_6 = var_39_4(var_1_10006)
		local var_39_7 = var_5.getActivityByType

		ActivityConst = var_1_10008

		local var_39_8 = var_39_7(var_39_6, var_1_10008.ACTIVITY_TYPE_AUCTION_GAME).stopTime

		pg = var_8

		local var_39_9 = var_8.TimeMgr.GetInstance()
		local var_39_10 = var_8.IsSameDay(var_39_9, var_39_5, var_39_8)

		setActive = var_39_9

		var_39_9(arg_39_0.uiPreorderBtn, not var_39_10)

		setActive = var_39_9

		var_39_9(arg_39_0.uiPreorderEndGo, var_39_10)

		setActive = var_39_9

		var_39_9(arg_39_0.uiPreorderTimeGo, false)

		setActive = var_39_9

		var_39_9(arg_39_0.uiOpenPreorderBtn, false)

		AuctionGameTools = var_39_9

		local var_39_11 = var_39_9.GetPreorderCurrentyCnt()
		...
		local var_39_13 = var_1_10012.format
		local var_39_14 = "<color=%s>%s</color>"

		AuctionGameTools = var_1_10014

		local var_39_15 = var_39_11 > var_1_10014.GetCurrencyCnt() and "#bf5050" or "#ffffff"

		StringHelper = var_1_10015

		var_10(var_39_12, var_39_13(var_39_14, var_39_15, var_1_10015.ForamtNumberK(var_39_11)))
	end
...
function var_0_1.AddPreorderTimer(arg_40_0)
	...
	Timer = var_40_1
	arg_40_0.preorderTimer = var_40_1.New(function()
		pg = var_2_10000
		...
		if var_40_2 <= var_41_1 then
			...
			var_1(var_41_4, var_3.FormatPreorderDuration(var_41_5, var_40_2 - var_41_1))
		end
...
function var_0_1.FormatPreorderDuration(arg_42_0, arg_42_1)
	...
	math = var_1_10004
	arg_42_1 = var_42_0(var_42_1, var_1_10004.floor(arg_42_1 or 0))
	math = var_2
	...
	local var_42_3 = var_3.floor(arg_42_1 / 60) % 60
...
function var_0_1.RefreshTaskTip(arg_44_0)
	...
	local var_44_2 = var_44_1(var_44_0, var_1_10004.ACTIVITY_TYPE_AUCTION_GAME)

	setActive = var_44_0

	var_44_0(arg_44_0.uiTaskTipGo, var_44_2:GetTaskTip())
...
function var_0_1.RefreshPreorderTip(arg_45_0)
	...
	local var_45_2 = var_45_1(var_45_0, var_1_10004.ACTIVITY_TYPE_AUCTION_GAME)

	setActive = var_45_0

	var_45_0(arg_45_0.uiPreorderTipGo, var_45_2:GetPreorderTip())
...
function var_0_1.RefreshOpenPreorderTip(arg_46_0)
	...
	local var_46_2 = var_46_1(var_46_0, var_1_10004.ACTIVITY_TYPE_AUCTION_GAME)

	setActive = var_46_0

	var_46_0(arg_46_0.uiOpenPreorderTipGo, var_46_2:GetOpenPreorderTip())
...
function var_0_1.RefreshRelief(arg_48_0)
	...
	local var_48_2 = var_48_0(var_1_10003)
	local var_48_3 = var_2.getActivityByType

	ActivityConst = var_1_10005

	local var_48_4 = var_48_3(var_48_2, var_1_10005.ACTIVITY_TYPE_AUCTION_GAME)
	local var_48_5 = var_3.GetReliefTip(var_48_4)

	setActive = var_48_4

	var_48_4(arg_48_0.uiReliefBtn, var_48_5)
...
function var_0_1.ShowWarning(arg_49_0)
	...
	local var_49_3 = var_1_10004.TimeMgr.GetInstance()
	local var_49_4 = var_49_2(var_49_1, var_4.GetServerTime(var_49_3), "%Y/%m/%d")

	getProxy = var_49_1
	PlayerProxy = var_4

	local var_49_5 = var_49_1(var_4)
	local var_49_6 = var_3.getPlayerId(var_49_5)

	PlayerPrefs = var_49_5

	local var_49_7 = var_49_5.GetInt

	string = var_5

	local var_49_8 = var_49_7(var_5.format("AUCTION_GAME_WARNING_%s_%s", var_49_6, var_49_4), 0)
	...
	if var_49_0.inactiveNum ~= var_49_8 then
		...
		local var_49_11 = var_7.ON_ADD_SUBLAYER

		Context = var_8

		local var_49_12 = var_8.New
		local var_49_13 = {}

		AuctionGameMainMsgLayer = var_1_10010
		var_49_13.viewComponent = var_1_10010
		AuctionGameMainMsgMediator = var_1_10010
		var_49_13.mediator = var_1_10010

		local var_49_14 = {}

		i18n = var_1_10011
		var_49_14.content = var_1_10011("auction_game_punishment", var_49_0.inactiveNum)
...
function var_0_1.willExit(arg_52_0)
	...
	var_52_0.sleepTimeout, Screen = var_1.GetMainSceneScreenSleepTime(var_52_0), var_52_0
...
function var_0_1.onBackPressed(arg_53_0)
	if not arg_53_0.quickMatchSuccess and arg_53_0.startQuickMatch == true then
		...
		local var_53_2 = var_1_10003.ON_ADD_SUBLAYER
		...
		var_53_4.viewComponent = var_1_10006
		AuctionGameMainMsgMediator = var_1_10006
		var_53_4.mediator = var_1_10006

		local var_53_5 = {}

		i18n = var_1_10007
		var_53_5.content = var_1_10007("auction_main_match_exit")
