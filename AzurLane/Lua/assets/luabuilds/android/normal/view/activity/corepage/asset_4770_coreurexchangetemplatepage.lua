...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10003("UrExchange_Pt_NotEnough"))
	...
	var_3_2 = var_1.getActivityById(var_3_1, arg_3_0.config.activitytime) and not var_1:isEnd()
	arg_3_0.isLinkActOpen = var_3_2
	setActive = var_3_2

	var_3_2(arg_3_0._tasksTF, arg_3_0.isLinkActOpen)

	local var_3_3 = arg_3_0.uilist

	var_2.make(var_3_3, function(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_3_5 = arg_3_0._btnSimulate
	...
	local function var_3_6()
		...
		if arg_3_0.config.expedition == 0 then
			...
			var_5_1(var_5_0, var_2_10002("tech_simulate_closed"))
		else
			i18n = var_5_1
			...
			local var_5_3 = var_1.MsgboxMgr.GetInstance()
			...
			var_1.ShowMsgBox(var_5_3, {
				...
				onYes = function()
					...
					local var_6_2 = var_3_10002.ON_SIMULATION_COMBAT
					local var_6_3 = {
					...
					var_6_1(var_6_0, var_6_2, var_6_3, var_6_4, var_3_10005)
	...
	var_2(var_3_4, var_3_5, var_3_6, var_1_10006)
	...
	var_2(arg_3_0, arg_3_0._msgBoxBtnConfirm, function()
		...
		var_10_2(var_10_1, var_2_10002.ON_ACT_SHOPPING, arg_3_0.shopId, 1, arg_3_0.curGoods.id, 1)
		...
		var_10_4(var_10_3, var_2.BuildUrRedeem(arg_3_0.curGoods.commodity_id, 2))
	...
	local var_3_8 = arg_3_0._btnExchange
	...
	local function var_3_9()
		...
		if arg_3_0.canExchange then
			...
			var_1(arg_3_0._msgBoxItem, var_11_0)

			setText = var_1

			var_1(arg_3_0._msgBoxItemName, var_11_0:getName())

			setText = var_1

			var_1(arg_3_0._msgBoxItemDesc, var_11_0.desc)

			pg = var_1

			local var_11_1 = var_1.UIMgr.GetInstance()

			var_1.BlurPanel(var_11_1, arg_3_0._msgBox)

			setActive = var_1

			var_1(arg_3_0._msgBox, true)
			...
			local var_11_3 = var_1.delayedCall
			local var_11_4 = 1

			System = var_2_10003
			var_11_2.leantween = var_11_3(var_11_4, var_2_10003.Action(function()
	...
	var_2(var_3_7, var_3_8, var_3_9, var_1_10006)

	onButton = var_2

	local var_3_10 = arg_3_0
	local var_3_11 = arg_3_0._btnHelp
...
var_0_1.taskTypeDic = {
	...
	[var_0_1.GO_TASK] = function(arg_27_0, arg_27_1, arg_27_2)
		local function var_27_0()
			...
			var_28_1(var_28_0, var_2_10002.EVENT_GO_SCENE, arg_27_2)
	...
	[var_0_1.MINI_GAME_ACT] = function(arg_29_0, arg_29_1, arg_29_2)
		...
		local var_29_2 = var_1_10005(var_1_10006)
		...
		local function var_29_4()
			...
			local var_30_2 = var_2_10002.GO_SCENE

			SCENE = var_2_10003

			var_30_1(var_30_0, var_30_2, var_2_10003.ACTIVITY, {
				id = var_29_1
			})
...
function var_0_1.UpdateTask(arg_31_0, arg_31_1, arg_31_2)
	...
	if var_31_6 then
		...
		var_10(arg_31_0, arg_31_2:Find("btn_go"), function()
			...
			var_32_1(var_32_0, var_2_10002.BuildUrJump(var_31_1))
...
function var_0_1.OnUpdateFlush(arg_33_0)
	...
	var_1(var_2.Find(var_33_1, "red"), arg_33_0.canExchange)
