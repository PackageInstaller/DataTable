...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.BossSingle.BossSingleSceneTemplate"))
...
function var_0_1.init(arg_3_0)
	...
	var_1(var_2.Find(var_3_9, "tpl"), false)
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "return_btn")
	...
	local var_4_6 = var_3.Find(var_4_5, "home_btn")
	...
	local var_4_10 = var_3.Find(var_4_9, "help_btn")
	...
	local function var_4_11()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.otherworld_map_help.tip
	...
	var_1(var_4_8, var_4_10, var_4_11, var_5)
	...
	var_1(var_4_12, var_4_13, var_4_14, var_5)
	...
	local function var_4_17()
		if not arg_4_0.eventAct then
			...
			var_10_1(var_10_0, var_2_10002("common_activity_end"))
	...
	var_1(var_4_15, var_4_16, var_4_17, var_5)

	onButton = var_1

	local var_4_18 = arg_4_0
	local var_4_19 = arg_4_0.leftUI
	local var_4_20 = var_3.Find(var_4_19, "terminal_btn")
	...
	var_1(var_2.getIcon(var_4_24), "", arg_4_0.ptIconTF)
	...
	if arg_4_0.eventAct then
		var_4_28 = arg_4_0.eventAct
		var_4_29 = var_4.getConfig(var_4_28, "config_client").open_story
	end

	if var_4_29 and var_4_29 ~= "" then
		pg = var_4_28

		local var_4_30 = var_4_28.NewStoryMgr.GetInstance()

		if var_4_28.IsPlayed(var_4_30, var_4_29) then
			pg = var_4_28

			local var_4_31 = var_4_28.NewStoryMgr.GetInstance()

			if not var_5.IsPlayed(var_4_31, "NG0044") then
			...
			var_5({
				function(arg_14_0)
					...
					if not var_2.HasKey(var_0_2 .. arg_4_0.playerId) then
				...
				function(arg_15_0)
					...
					if arg_4_0.eventAct then
						var_2_10002 = arg_4_0.eventAct
						var_15_0 = var_1.getConfig(var_2_10002, "config_client").open_story
					end

					if var_15_0 and var_15_0 ~= "" then
						pg = var_2_10002

						local var_15_1 = var_2_10002.NewStoryMgr.GetInstance()

						var_2.Play(var_15_1, var_15_0, arg_15_0)
					else
						arg_15_0()
					end
				...
				if arg_4_0.eventAct and arg_4_0.contextData.eventTriggerId then
					...
					var_18_1(var_18_0, var_2_10002.delayedCall, function()
						local var_19_0 = arg_4_0
						local var_19_1 = var_0.emit

						OtherworldMapMediator = var_3_10002

						var_19_1(var_19_0, var_3_10002.ON_EVENT_TRIGGER, {
...
function var_0_1.SetNativeSizes(arg_20_0)
	...
	var_1_10001(arg_20_0.bgTF, function(arg_21_0)
		...
		var_2_10001(arg_21_0, function(arg_22_0)
			...
			if var_22_1(var_22_0, var_3_10003(var_3_10004)) then
				var_1:SetNativeSize()
			end
	...
	var_1_10001(arg_20_0.locationsTF, function(arg_23_0)
		if arg_23_0.childCount > 0 then
			...
			var_1(arg_23_0, function(arg_24_0)
				...
				if var_24_1(var_24_0, var_3_10003(var_3_10004)) then
					var_1:SetNativeSize()
				end
			...
			if var_23_1(var_23_0, var_2_10003(var_2_10004)) then
				var_1:SetNativeSize()
			end
		end
	...
	var_1_10001(arg_20_0.strongholdsTF, function(arg_25_0)
		...
		if arg_25_0.Find(var_25_0, "name/Image") then
			::label_25_0::

			local var_25_1 = var_1

			var_25_0 = var_1.GetComponent
			typeof = var_2_10004
			Image = var_2_10005
			var_25_0 = var_25_0(var_25_1, var_2_10004(var_2_10005))
		end

		if var_25_0 then
			var_25_0:SetNativeSize()
		end
...
function var_0_1.BindStronghold(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_2 = var_5.Find(var_26_1, arg_26_1 .. "/icon")
	local var_26_3 = arg_26_2

	SFX_PANEL = var_7

	var_1_10003(var_26_0, var_26_2, var_26_3, var_7)

	onButton = var_1_10003

	local var_26_4 = arg_26_0
	local var_26_5 = arg_26_0.strongholdsTF
	local var_26_6 = var_5.Find(var_26_5, arg_26_1 .. "/name")
	local var_26_7 = arg_26_2

	SFX_PANEL = var_7

	var_1_10003(var_26_4, var_26_6, var_26_7, var_7)
...
function var_0_1.InitStrongholds(arg_27_0, arg_27_1, arg_27_2)
	arg_27_0:BindStronghold("wangdu", function()
		...
		var_28_1(var_28_0, var_2_10002.OTHERWORLD_BACKHILL)
	...
	for iter_27_0, iter_27_1 in var_3(var_0_1.NAME2INDEX) do
		arg_27_0:BindStronghold(iter_27_0, function()
			...
			if var_29_1 then
				...
				var_2.ShowNormalFleet(var_29_3, iter_27_1)
			else
				pg = var_2

				local var_29_4 = var_2.TipsMgr.GetInstance()
...
function var_0_1.InitStoryNodes(arg_30_0)
	...
	var_1.make(var_30_0, function(arg_31_0, arg_31_1, arg_31_2)
		...
		if arg_31_0 == var_2_10003.EventUpdate then
			...
			local var_31_5 = var_31_4(var_31_3, var_2_10008(var_2_10009))
			...
			if not arg_30_0.playInAnimId or arg_30_0.playInAnimId ~= var_5.id then
				...
				var_31_8 = var_31_8(var_31_7, var_8(var_2_10009))
				var_31_8.alpha = 1
			end

			unpack = var_31_8

			local var_31_9 = var_5
			local var_31_10, var_31_11 = var_31_8(var_5.GetPos(var_31_9))

			setAnchoredPosition = var_31_9
			...
			setImageSprite = var_31_9

			local var_31_12 = arg_31_2
			local var_31_13 = arg_31_2.Find(var_31_12, "type")

			GetSpriteFromAtlas = var_31_12

			var_31_9(var_31_13, var_31_12("ui/otherworldmapui_atlas", var_5:GetIconName()))

			setText = var_31_9

			var_31_9(arg_31_2:Find("title"), var_5:GetName())
			...
			var_31_9(var_31_14, var_31_15, var_31_16, var_12)
		end
	...
	arg_30_0.floatItemList = var_30_1(var_30_2, var_3.Find(var_30_3, "tpl"))
	...
	var_1.make(var_30_4, function(arg_33_0, arg_33_1, arg_33_2)
		...
		if arg_33_0 == var_2_10003.EventUpdate then
			...
			setImageSprite = var_33_1

			local var_33_3 = arg_33_2
			local var_33_4 = arg_33_2.Find(var_33_3, "type")

			GetSpriteFromAtlas = var_33_3

			var_33_1(var_33_4, var_33_3("ui/otherworldmapui_atlas", var_33_2:GetIconName()))

			onButton = var_33_1

			local var_33_5 = arg_30_0
			local var_33_6 = arg_33_2
			...
			var_33_1(var_33_5, var_33_6, var_33_7, var_9)
		end
...
function var_0_1.onDragFunction(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_35_0(arg_35_0.eventIds) do
		...
		if var_35_3(var_35_2, var_1_10008(iter_35_1)) then
			var_1_10008 = arg_35_0._tf

			local var_35_4 = var_7.InverseTransformPoint(var_1_10008, var_6.position)

			var_1_10008 = nil
			ipairs = var_9

			for iter_35_2, iter_35_3 in var_9(var_0_1.screenPoints) do
				local var_35_5 = var_0_1.screenPoints[iter_35_2 % 4 + 1]

				Vector2 = var_15

				local var_35_6 = var_15(var_35_4.x, var_35_4.y)

				if iter_35_3.x < 0 then
					var_35_6.x = var_35_6.x + var_0_1.STORY_TPL_HALF_WIDTH
				end

				local var_35_7 = iter_35_3.x
				...
				local var_35_8, var_35_9, var_35_10 = var_35_7(var_17.zero, var_35_6, iter_35_3, var_35_5)

				if var_35_8 then
					var_1_10008 = var_35_6 * var_35_9

					break
				end
			end

			var_1_10010 = arg_35_0.floatItemList.container

			local var_35_11 = var_9.Find

			tostring = var_11

			local var_35_12 = var_35_11(var_1_10010, var_11(iter_35_1))

			var_1_10010 = var_9.GetComponent
			typeof = iter_35_2
			CanvasGroup = iter_35_3
			var_1_10010 = var_1_10010(var_35_12, iter_35_2(iter_35_3))
			tobool = var_35_12
			var_1_10010.interactable = var_35_12(var_1_10008)
			tobool = var_11
			var_1_10010.blocksRaycasts = var_11(var_1_10008)
			tobool = var_11
			var_1_10010.alpha = var_11(var_1_10008) and 1 or 0

			if var_1_10008 then
				iter_35_2 = var_1_10008

				if (var_1_10008 * (1 - 50 / var_1_10008.Magnitude(iter_35_2))).x < 0 and var_11.y < var_0_1.FLOAT_LEFT_MIN_Y then
					var_11.y = var_0_1.FLOAT_LEFT_MIN_Y
				end

				if var_11.y >= var_0_1.FLOAT_ARROW_LIMIT_Y[1] and var_11.y <= var_0_1.FLOAT_ARROW_LIMIT_Y[2] then
					if var_11.x < 0 then
						setActive = iter_35_2

						iter_35_2(arg_35_0.leftArrow, false)
					end

					if var_11.x > 0 then
						setActive = iter_35_2

						iter_35_2(arg_35_0.rightArrow, false)
					end
				end

				setAnchoredPosition = iter_35_2

				iter_35_2(var_9, var_11)

				math = iter_35_2
				iter_35_2 = iter_35_2.rad2Deg
				math = var_13
				iter_35_2 = iter_35_2 * var_13.atan2(var_1_10008.y, var_1_10008.x)
				setLocalEulerAngles = var_13

				var_13(var_9:Find("arrow"), {
					z = iter_35_2
				})
			end
		end
	...
	if arg_35_0.contextData.mode == var_0_1.MODE_BATTLE then
		local var_35_13
		local var_35_14 = arg_35_0._tf
		local var_35_15 = var_2.InverseTransformPoint
		local var_35_16 = arg_35_0.strongholdsTF

		var_2.x = var_35_15(var_35_14, var_4.Find(var_35_16, "wangdu").position).x + 22
		ipairs = var_3

		for iter_35_4, iter_35_5 in var_3(var_0_1.screenPoints) do
			local var_35_17 = var_0_1.screenPoints[iter_35_4 % 4 + 1]

			LineLine = var_9
			Vector2 = var_1_10010

			local var_35_18, var_35_19

			var_35_18, var_1_10010, var_35_19 = var_9(var_1_10010.zero, var_2, iter_35_5, var_35_17)

			if var_35_18 then
				var_35_13 = var_2 * var_1_10010
		...
		local var_35_20 = arg_35_0.leftArrow
		local var_35_21 = var_4.Find(var_35_20, "tip")
		local var_35_22
		...
		var_3(var_35_21, var_35_22)

		local var_35_23
		local var_35_24 = arg_35_0._tf
		local var_35_25 = var_4.InverseTransformPoint
		local var_35_26 = arg_35_0.strongholdsTF

		var_4.x = var_35_25(var_35_24, var_6.Find(var_35_26, "mowangcheng").position).x + 100
		ipairs = var_5

		for iter_35_6, iter_35_7 in var_5(var_0_1.screenPoints) do
			local var_35_27 = var_0_1.screenPoints[iter_35_6 % 4 + 1]

			LineLine = var_11
			Vector2 = iter_35_2

			local var_35_28, var_35_29

			var_35_28, iter_35_2, var_35_29 = var_11(iter_35_2.zero, var_4, iter_35_7, var_35_27)

			if var_35_28 then
				var_35_23 = var_4 * iter_35_2
		...
		local var_35_30 = arg_35_0.rightArrow
		local var_35_31 = var_6.Find(var_35_30, "tip")
		local var_35_32
...
function var_0_1.FocusNode(arg_36_0, arg_36_1, arg_36_2)
	...
	math = var_5
	var_36_1.x = var_5.clamp(var_36_1.x, -arg_36_0.extendLimit.x, arg_36_0.extendLimit.x)
	math = var_5
	...
	var_6.insert(var_36_2, function(arg_37_0)
		...
		var_2_10001(var_37_0, var_2_10003(var_2_10004), false)
		...
		if 0 < var_37_1 then
			...
			local var_37_6 = var_37_4(var_37_5, var_2_10006(var_36_1.x, var_36_1.y), var_37_2)
			local var_37_7 = var_4.setEase

			LeanTweenType = var_6

			local var_37_8 = var_37_7(var_37_6, var_6.easeInOutSine)
			local var_37_9 = var_4.setOnUpdate

			System = var_6

			local var_37_10 = var_37_9(var_37_8, var_6.Action_float(function(arg_38_0)
			...
			System = var_6
			var_37_3.twFocusId = var_37_11(var_37_10, var_6.Action(arg_37_0)).uniqueId
	...
	var_6(var_36_2, function()
		...
		var_2_10000(var_39_0, var_2_10002(var_2_10003), true)
...
function var_0_1.FocusPoint(arg_40_0, arg_40_1, arg_40_2)
	...
	var_4.insert(var_40_0, function(arg_41_0)
		SetCompomentEnabled = var_2_10001
		...
		var_2_10001(var_41_0, var_2_10003(var_2_10004), false)
		...
		if 0 < var_41_1 then
			...
			local var_41_6 = var_41_4(var_41_5, var_2_10006(arg_40_1.x, arg_40_1.y), var_41_2)
			local var_41_7 = var_4.setEase

			LeanTweenType = var_6

			local var_41_8 = var_41_7(var_41_6, var_6.easeInOutSine)
			local var_41_9 = var_4.setOnUpdate

			System = var_6

			local var_41_10 = var_41_9(var_41_8, var_6.Action_float(function(arg_42_0)
			...
			System = var_6
			var_41_3.twFocusId = var_41_11(var_41_10, var_6.Action(arg_41_0)).uniqueId
	...
	var_4(var_40_0, function()
		...
		var_2_10000(var_43_0, var_2_10002(var_2_10003), true)
...
function var_0_1.TriggerEvent(arg_44_0, arg_44_1, arg_44_2)
	...
	local var_44_2 = var_44_1:GetStoryType()
	local var_44_3 = {}

	SingleEvent = var_1_10007
	var_44_3[var_1_10007.STORY_TYPE.STORY] = function()
		...
		var_2_10000({
			function(arg_46_0)
				...
				if var_1.GetStory(var_46_0) and var_1 ~= "" then
					...
					local var_46_1 = var_46_0.NewStoryMgr.GetInstance()
			...
			var_47_1(var_47_0, var_3_10002.ON_EVENT_TRIGGER, {
	...
	SingleEvent = var_7
	var_44_3[var_7.STORY_TYPE.BATTLE] = function()
		seriesAsync = var_2_10000
		...
		var_2_10000({
			function(arg_49_0)
				...
				if var_3_10001(var_2.GetStory(var_49_0)) and var_1 > 0 then
					local var_49_1 = arg_44_0
					local var_49_2 = var_2.emit

					OtherworldMapMediator = var_3_10004

					var_49_2(var_49_1, var_3_10004.ON_PERFORM_COMBAT, var_1)
				end
	...
	var_44_0(var_44_2, var_44_3, function()
		pg = var_2_10000
		...
		var_51_1(var_51_0, var_51_2 .. var_3.GetStoryType(var_51_3))
...
function var_0_1.UpdateToggleTip(arg_52_0)
	if not arg_52_0.eventAct then
		...
		var_1(var_2.Find(var_52_0, "new"), false)

		setActive = var_1

		local var_52_1 = arg_52_0.battleBtn

		var_1(var_2.Find(var_52_1, "new"), false)
	...
	local var_52_4 = var_52_2.any(var_52_3, function(arg_53_0)
		...
		if var_1.GetEventById(var_53_0, arg_53_0) then
			...
			if var_53_0.CheckTrigger(var_53_1, var_1.id) then
				local var_53_2 = var_1

				var_53_0 = var_1.GetMode(var_53_2)
				SingleEvent = var_53_2
				var_53_0 = var_53_0 == var_53_2.MODE_TYPE.STORY
			end
		end
	...
	local var_52_5 = var_3.any(var_52_3, function(arg_54_0)
		...
		if var_1.GetEventById(var_54_0, arg_54_0) then
			...
			if var_54_0.CheckTrigger(var_54_1, var_1.id) then
				local var_54_2 = var_1

				var_54_0 = var_1.GetMode(var_54_2)
				SingleEvent = var_54_2
				var_54_0 = var_54_0 == var_54_2.MODE_TYPE.BATTLE
			end
		end
	...
	var_4(var_5.Find(var_52_6, "new"), var_52_4)

	setActive = var_4

	local var_52_7 = arg_52_0.battleBtn

	var_4(var_5.Find(var_52_7, "new"), var_52_5)
...
function var_0_1.UpdateMapArea(arg_55_0)
	...
	for iter_55_0 = var_0_1.MAP_AREA_START, var_0_1.MAP_AREA_CNT do
		...
		local var_55_4 = var_9.Find

		tostring = var_1_10011

		var_8(var_55_4(var_55_3, var_1_10011(iter_55_0)), not var_55_0 or not var_1_10007)

		setActive = var_8

		local var_55_5 = arg_55_0.bgTF
		local var_55_6 = var_9.Find

		tostring = var_1_10011

		var_8(var_55_6(var_55_5, var_1_10011(iter_55_0)), var_1_10007 and var_55_0)
	end
...
function var_0_1.PlayMapAnim(arg_56_0, arg_56_1, arg_56_2)
	...
	if var_56_4 and var_56_6 then
		...
		var_56_5(var_56_4, true)

		GetOrAddComponent = var_56_5

		local var_56_7 = var_56_4

		typeof = var_8
		CanvasGroup = var_1_10009
		var_56_5(var_56_7, var_8(var_1_10009)).alpha = 0
		...
		local var_56_10 = var_8.value
		local var_56_11

		go = var_1_10010

		local var_56_12 = var_56_9(var_56_8, var_56_10, var_56_11, var_1_10010(var_56_4), 0, 1, var_0_1.MAP_ANIM_TIME)
		...
		local var_56_14 = var_56_13(var_56_12, var_56_10.Action_float(function(arg_57_0)
			...
			var_2_10001(var_57_0, var_2_10003(var_2_10004)).alpha = arg_57_0
		...
		var_56_15(var_56_14, var_8.Action(function()
			arg_56_2()
		...
		typeof = var_8
		CanvasGroup = var_9
		var_56_15(var_56_16, var_8(var_9)).alpha = 1
		...
		local var_56_19 = var_8.value
		local var_56_20

		go = var_10

		local var_56_21 = var_56_18(var_56_17, var_56_19, var_56_20, var_10(var_56_4), 1, 0, var_0_1.MAP_ANIM_TIME)
		...
		local var_56_23 = var_56_22(var_56_21, var_56_19.Action_float(function(arg_59_0)
			...
			typeof = var_2_10003
			CanvasGroup = var_2_10004
			var_2_10001(var_59_0, var_2_10003(var_2_10004)).alpha = arg_59_0
		...
		var_56_24(var_56_23, var_8.Action(function()
...
function var_0_1.UpdateWangduBtn(arg_61_0)
	...
	var_1(var_2.Find(var_61_0, "wangdu/name/tip"), arg_61_0.isShowWangduTip)

	setActive = var_1

	local var_61_1 = arg_61_0.leftArrow
	local var_61_2 = var_2.Find(var_61_1, "tip")
	local var_61_3
...
function var_0_1.UpdateEntrances(arg_62_0)
	...
	for iter_62_2, iter_62_3 in var_2(var_62_0:GetEnemyDatas()) do
		...
		if var_62_1 and not var_62_2 then
			...
			var_62_5 = var_10.GetComponent
			typeof = var_1_10014
			DftAniEvent = var_1_10015

			if var_62_5(var_62_7, var_1_10014(var_1_10015)) then
				var_1_10014 = var_62_5

				var_62_5.SetEndEvent(var_1_10014, function(arg_63_0)
					if var_62_6 then
						setActive = var_1
			...
			if var_62_8(var_1_10014, var_1_10015(var_1_10016)) and var_13.clip then
				var_1_10015 = var_13

				var_13.Play(var_1_10015)
			end
		elseif var_62_6 then
			setActive = var_62_5

			var_62_5(var_62_6, not var_62_1)
		end

		BossSingleEnemyData = var_62_5

		local var_62_10

		if var_62_3 == var_62_5.TYPE.SP then
			setActive = var_62_10
			var_1_10014 = var_10

			local var_62_9 = var_10.Find(var_1_10014, "count")

			if var_62_1 then
				::label_62_0::

				var_1_10015 = iter_62_3
				var_1_10014 = iter_62_3.InTime(var_1_10015)
			end

			var_62_10(var_62_9, var_1_10014)

			local var_62_11

			var_62_10, var_62_11 = var_62_0:GetCounts(iter_62_3.id)
			setText = var_1_10014
			var_1_10016 = var_10
			var_1_10015 = var_10.Find(var_1_10016, "count/Text")
			i18n = var_1_10016

			var_1_10014(var_1_10015, var_1_10016("levelScene_chapter_count_tip") .. var_62_10 .. "/" .. var_62_11)
			...
			var_1_10015(var_10:Find("name/tip"), var_1_10014)

			setActive = var_1_10015

			local var_62_12 = arg_62_0.rightArrow

			var_1_10015(var_1_10016.Find(var_62_12, "tip"), var_1_10014 and arg_62_0.contextData.mode == var_0_1.MODE_BATTLE)
		end

		setActive = var_62_10
		var_1_10014 = var_10

		var_62_10(var_10.Find(var_1_10014, "exp"), false)
...
function var_0_1.OpenTerminal(arg_64_0, arg_64_1)
	...
	OtherworldMapMediator = var_1_10004

	local var_64_2 = var_1_10004.GO_SUBLAYER

	Context = var_1_10005

	local var_64_3 = var_1_10005.New
	local var_64_4 = {}

	OtherworldTerminalMediator = var_1_10007
	var_64_4.mediator = var_1_10007
	OtherworldTerminalLayer = var_1_10007
	var_64_4.viewComponent = var_1_10007
...
function var_0_1.UpdateEvents(arg_65_0, arg_65_1)
	...
	if arg_65_0.contextData.mode == var_0_1.MODE_STORY then
		...
		arg_65_0.eventIds = var_65_1(var_4.GetAllEventIds(var_65_2), function(arg_66_0)
		...
		if arg_65_1 then
			...
			var_65_5 = var_65_5.Find
			tostring = var_1_10006
			var_65_5 = var_65_5(var_65_4, var_1_10006(arg_65_1)).anchoredPosition * -1

			local var_65_6 = arg_65_0.contextData.mode == var_0_1.MODE_STORY and #arg_65_0.eventIds > 0
			local var_65_7 = arg_65_0.eventAct
			local var_65_8 = var_6.GetEventById(var_65_7, arg_65_1)

			if #var_6.GetOptions(var_65_8) > 0 then
				table = var_65_11

				var_65_11.insert(var_65_3, function(arg_67_0)
			...
			if var_65_6 then
				...
				local var_65_9 = arg_65_0.eventAct
				local var_65_10 = var_8.GetEventById(var_65_9, arg_65_0.eventIds[1])
				local var_65_12

				var_65_11, var_65_12 = var_65_11(var_8.GetPos(var_65_10))
				Vector2 = var_65_10

				local var_65_13 = var_65_10(var_65_11, var_65_12) * -1

				table = var_10

				var_10.insert(var_65_3, function(arg_68_0)
					local var_68_0 = arg_65_0

					var_1.FocusPoint(var_68_0, {
						x = (var_65_5.x + var_65_13.x) / 2,
						y = (var_65_5.y + var_65_13.y) / 2
					}, arg_68_0)
			...
			var_65_11.insert(var_65_3, function(arg_69_0)
				local var_69_0 = arg_65_0.nodeItemList.container
				local var_69_1 = var_1.Find

				tostring = var_2_10003

				local var_69_2 = var_69_1(var_69_0, var_2_10003(arg_65_1))
				local var_69_3 = var_1.GetComponent

				typeof = var_4
				Animation = var_2_10005

				local var_69_4 = var_69_3(var_69_2, var_4(var_2_10005))
				...
				local var_69_7 = var_69_6(var_69_5, var_2_10005(var_2_10006))
			...
			var_7.insert(var_65_3, function(arg_71_0)
				...
				var_71_4(var_71_3, var_3.delayedCall, function()
					arg_71_0()
			...
			local var_65_14 = arg_65_0.eventAct

			if var_7.IsShowMapAnim(var_65_14, arg_65_1) then
				table = var_7
			...
			if var_65_6 then
				...
				var_7.insert(var_65_3, function(arg_74_0)
					...
					local var_74_2 = var_74_1(var_74_0, var_2_10003(arg_65_0.eventIds[1]))
					local var_74_3 = var_1.GetComponent

					typeof = var_4
					Animation = var_2_10005

					local var_74_4 = var_74_3(var_74_2, var_4(var_2_10005))
					...
					local var_74_7 = var_74_6(var_74_5, var_2_10005(var_2_10006))
					...
					var_4(var_74_8, var_6(var_2_10007)).alpha = 0
			...
			var_65_5.insert(var_65_3, function(arg_76_0)
					...
					var_1(arg_65_0.nodeItemList.container, function(arg_77_0)
						...
						if var_3_10001(arg_77_0) then
							...
							var_1(function()
								...
								typeof = var_4_10002
								Animation = var_4_10003

								local var_78_2 = var_78_1(var_78_0, var_4_10002(var_4_10003))
		...
		var_65_5(arg_65_0.clickMask, true)

		seriesAsync = var_65_5

		var_65_5(var_65_3, function()
...
function var_0_1.UpdateRes(arg_80_0)
	...
	local var_80_1 = var_1_10003(var_1_10004)
	local var_80_2 = var_3.getData(var_80_1)

	var_1_10001(var_80_0, var_3.getResource(var_80_2, arg_80_0.contextData.resId))
...
function var_0_1.UpdateTerminalTip(arg_81_0)
	...
	local var_81_1 = var_2.Find(var_81_0, "terminal_btn/tip")

	TerminalAdventurePage = var_81_0

	var_1_10001(var_81_1, var_81_0.IsTip())
...
function var_0_1.ShowBattleMode(arg_82_0)
	...
	BossSingleEnemyData = iter_82_0

	local var_82_3 = var_82_2(var_82_1, iter_82_0.TYPE.SP)
	local var_82_4 = var_1

	if not var_1.IsUnlockByEnemyId(var_82_4, var_82_3.id) or not var_82_3:InTime() then
		arg_82_0.isShowSpTip = false
	else
		local var_82_5

		var_82_4, var_82_5 = var_1:GetCounts(var_82_3.id)
		arg_82_0.isShowSpTip = var_82_4 > 0
	end

	setActive = var_82_4

	local var_82_6 = arg_82_0.rightArrow

	var_82_4(var_5.Find(var_82_6, "tip"), arg_82_0.isShowSpTip)

	setActive = var_82_4

	local var_82_7 = arg_82_0.leftArrow

	var_82_4(var_5.Find(var_82_7, "tip"), arg_82_0.isShowWangduTip)

	PlayerPrefs = var_82_4

	var_82_4.SetInt(var_0_3 .. arg_82_0.playerId, arg_82_0.contextData.mode)
...
function var_0_1.ShowStoryMode(arg_83_0)
	...
	var_1(var_2.Find(var_83_1, "tip"), false)

	setActive = var_1

	local var_83_2 = arg_83_0.leftArrow

	var_1(var_2.Find(var_83_2, "tip"), false)
...
function var_0_1.PlaySwithAnim(arg_84_0, arg_84_1)
	...
	var_1_10002({
		...
		function(arg_87_0)
			...
			local var_87_3 = var_87_2(var_87_1, var_3(var_2_10004))
...
function var_0_1.IsShowTip()
	local function var_92_0()
		...
		local var_93_0 = var_2_10000(var_2_10001)
		local var_93_1 = var_0.getActivityById

		ActivityConst = var_2_10002

		if not var_93_1(var_93_0, var_2_10002.OTHER_WORLD_TERMINAL_BATTLE_ID) or var_0:isEnd() then
			return false
		end
		...
		BossSingleEnemyData = var_2_10003

		local var_93_4 = var_93_3(var_93_2, var_2_10003.TYPE.SP)
