...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_9 = var_2.Find(var_1_8, "login/Text")

	i18n = var_1_8

	var_1(var_1_9, var_1_8("yearly_sign_in"))

	setText = var_1

	local var_1_10 = arg_1_0._tf
	local var_1_11 = var_2.Find(var_1_10, "login/count/Text")

	i18n = var_1_10

	var_1(var_1_11, var_1_10("word_date"))
...
function var_0_1.OnDataSetting(arg_3_0)
	...
	local var_3_3 = var_3.TimeMgr.GetInstance()
	local var_3_4 = var_3_1(var_3.STimeDescS(var_3_3, var_3_2, "%m"))

	pg = var_3

	local var_3_5 = var_3.activity_template

	ActivityConst = var_3_3

	if var_3_4 == var_3_5[var_3_3.MONTH_SIGN_ACTIVITY_ID].config_client[1] then
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			local function var_5_4()
				if #var_5_1 == 1 then
					...
					var_7_1(var_7_0, var_3_10002.ON_DROP, var_5_1[1])
				else
					...
					var_7_3(var_7_2, var_3_10002.ON_DROP_LIST, {
						content = "",
						item2Row = true,
						itemList = var_5_1
					})
			...
			var_5(arg_5_2:Find("day/Text"), "Day " .. var_5_0)

			setActive = var_5

			var_5(arg_5_2:Find("got"), var_5_0 <= #arg_4_0.activity.data1_list)

			setActive = var_5

			var_5(arg_5_2:Find("today"), var_5_0 == #arg_4_0.activity.data1_list)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if arg_8_0.specialTag then
		...
		var_1_10004 = arg_8_0._tf

		local var_8_4 = var_3.Find(var_1_10004, "ProgressBar")

		GetComponent = var_1_10004
		var_1_10004 = var_1_10004(var_8_4, "Slider")
		var_1_10004.value = #arg_8_0.activity.data1_list
	end
	...
	if var_1.getSpecialData(var_8_5, "month_sign_awards") then
		...
		if 0 < var_8_6 then
			...
			local var_8_7 = var_8_6(var_3)
			local var_8_8 = var_2.getPlayerId(var_8_7)

			table = var_8_7

			local var_8_9 = var_8_7.contains

			MonthSignPage = var_1_10004

			if not var_8_9(var_1_10004.MONTH_SIGN_SHOW, arg_8_0.activity.id .. ":" .. var_8_8) then
				table = var_3
				...
				var_8_10(var_4.MONTH_SIGN_SHOW, arg_8_0.activity.id .. ":" .. var_8_8)
...
function var_0_1.UseSecondPage(arg_11_0, arg_11_1)
	...
	local var_11_0 = var_1_10003.TimeMgr.GetInstance()
	local var_11_1 = var_1_10002(var_3.CurrentSTimeDesc(var_11_0, "%m", true))

	pg = var_3

	return var_11_1 == var_3.activity_template[arg_11_1.id].config_client[1]
end
...
function var_0_1.UpdateLoginInfo(arg_13_0)
	...
	local var_13_2 = var_13_1(var_13_0, var_1_10003.ACTIVITY_TYPE_LOGIN_RECORD)
	local var_13_3 = arg_13_0._tf
	local var_13_4 = var_2.Find(var_13_3, "login")

	setActive = var_13_3

	var_13_3(var_13_4, var_13_2 and not var_13_2:isEnd())
	...
	if var_13_2 and not var_13_2:isEnd() then
		...
		local var_13_9 = var_13_4.Find(var_13_8, "month")

		string = var_13_8

		var_6(var_13_9, var_13_8.format("%02d/%02d/%02d-%02d/%02d/%02d", var_13_6[1][1] % 100, var_13_6[1][2], var_13_6[1][3], var_13_7[1][1] % 100, var_13_7[1][2], var_13_7[1][3]))
...
function var_0_1.TryShowSpEffect(arg_14_0, arg_14_1)
	...
	local var_14_5 = var_14_4(var_14_3, var_1_10007("UnityEngine.ParticleSystem"))
	...
	local var_14_9 = var_14_8(var_8(var_3), 0, 1, var_14_6)
	local var_14_10 = var_7.setOnComplete

	System = var_9
	arg_14_0.spEffectLT = var_14_10(var_14_9, var_9.Action(function()
		arg_14_0.spEffectLT = nil
...
function var_0_1.ShouldPlaySpEffect(arg_18_0)
	...
	if var_18_1 ~= var_18_0.ACTIVITY_TYPE_MONTHSIGN then
		return false
	end

	local var_18_2 = arg_18_0

	if arg_18_0.getSpecialData(var_18_2, var_0_1.MILESTONE_SPECIAL_DATA) then
		::label_18_0::

		table = var_18_2
		var_18_2 = var_18_2.contains(var_0_1.MONTH_SIGN_SP_DAYS, var_1)
	end
