...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SET_NAME, function(arg_4_0, arg_4_1)
		...
		local var_4_2 = var_2_10004.ACTIVITY_STORE_DATE
		local var_4_3 = {
	...
	arg_1_0:bind(var_0_1.CLICK_ROOM, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10005.ACTIVITY_LINER_OP, {
			cmd = 1,
			activity_id = arg_5_1,
			arg1 = arg_5_2
		})
	...
	arg_1_0:bind(var_0_1.CLICK_EVENT, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.ACTIVITY_LINER_OP, {
			cmd = 1,
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.ACTIVITY_LINER_OP_DONE then
