...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	var_2_1(var_2_0, var_1_10004.REQ_OLD_INSTAGRAM_DATA, {
		callback = function()
			arg_2_1()
...
function var_0_1.init(arg_4_0)
	...
	var_4_5(var_4_4, var_3.Find(var_4_6, "MusicPlayer").gameObject)
...
function var_0_1.didEnter(arg_5_0)
	...
	if arg_5_0.contextData.current then
		...
		var_1(var_2.Find(var_5_0, "choose"), arg_5_0.contextData.current == "chat")

		SetActive = var_1

		local var_5_1 = arg_5_0.juusBtn

		var_1(var_2.Find(var_5_1, "choose"), arg_5_0.contextData.current == "juus")
	else
		triggerButton = var_1
...
function var_0_1.FlushMusicPlayer(arg_6_0)
	...
	if var_6_0(var_3.isShowing(var_6_2)) ~= var_6_1 then
		if var_6_1 then
...
function var_0_1.SetUp(arg_7_0)
	...
	local function var_7_5()
		...
		pg = var_2_10003
		var_9_2.helps = var_2_10003.gametip.music_juus.tip
	...
	local function var_7_8()
		...
		if var_10_0(var_1.Find(var_10_1, "choose")) then
			local var_10_2 = arg_7_0

			var_10_3 = var_10_3.emit
			InstagramMainMediator = var_10_1

			var_10_3(var_10_2, var_10_1.CLOSE_JUUS_DETAIL)
		end
		...
		var_10_3(var_1.Find(var_10_4, "choose"), arg_7_0.contextData.current == "chat")

		SetActive = var_10_3

		local var_10_5 = arg_7_0.juusBtn

		var_10_3(var_1.Find(var_10_5, "choose"), arg_7_0.contextData.current == "juus")
		...
		var_10_7(var_10_6, var_2.OPEN_CHAT)
		...
		var_10_9(var_10_8, var_2.CLOSE_JUUS)
	...
	local function var_7_11()
		...
		var_11_0(var_1.Find(var_11_1, "choose"), arg_7_0.contextData.current == "chat")

		SetActive = var_11_0

		local var_11_2 = arg_7_0.juusBtn

		var_11_0(var_1.Find(var_11_2, "choose"), arg_7_0.contextData.current == "juus")
		...
		var_11_4(var_11_3, var_2.OPEN_JUUS)
		...
		var_11_6(var_11_5, var_2.CLOSE_CHAT)
...
function var_0_1.OnClose(arg_12_0)
	...
	if var_1_10001(var_2.Find(var_12_0, "choose")) then
		local var_12_1 = arg_12_0
		local var_12_2 = arg_12_0.emit

		InstagramMainMediator = var_12_0

		var_12_2(var_12_1, var_12_0.INS_BACK_PRESSED)
	else
		...
		var_12_4(var_12_3, var_12_0.JUUS_BACK_PRESSED)
	end
...
function var_0_1.ChangeJuusTip(arg_13_0)
	...
	var_1_10002(var_3.Find(var_13_1, "tip"), var_13_0:ShouldShowTip())
...
function var_0_1.ChangeChatTip(arg_14_0)
	...
	local var_14_2 = var_3.Find(var_14_1, "tip")
