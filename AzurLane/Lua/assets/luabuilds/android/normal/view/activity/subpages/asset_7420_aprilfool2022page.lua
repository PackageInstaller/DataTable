...
function var_0_1.OnDataSetting(arg_2_0)
	...
	if var_2_0(var_2_1) == "table" and var_2_1[2] then
		type = var_2
	...
	if arg_2_0.activity.data2 == 0 and arg_2_0.activity.data3 == 1 then
		...
		var_2_5(var_2_4, var_1_10004.EVENT_OPERATION, {
			cmd = 2,
	...
	if arg_2_0.activity.data1 == 0 then
		...
		local var_2_8 = var_2_6.TimeMgr.GetInstance()
		...
		if var_4.getConfig(var_2_10, "config_client").autounlock <= var_2_9 - var_2_7 then
			...
			var_2_12(var_2_11, var_1_10007.EVENT_OPERATION, {
				arg1 = 1,
				cmd = 1,
				activity_id = arg_2_0.activity.id
			})
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_3(var_4_2, var_2_10003.ON_SIMULATION_COMBAT, {
			...
			if not var_5_1(var_5_0, var_3_10002(var_4_1), true) then
				pg = var_5_2
				var_5_0 = var_5_2.m02
				var_5_2 = var_5_2.sendNotification
				GAME = var_2

				local var_5_3 = var_2.STORY_UPDATE
				local var_5_4 = {}

				tostring = var_3_10004
				var_5_4.storyId = var_3_10004(var_4_1)
	...
	var_3_0.Foreach(arg_3_0.stars, function(arg_8_0, arg_8_1)
		...
		var_2_10002(arg_3_0, arg_8_1, function()
			...
			var_9_3(var_9_2, var_2.EVENT_OPERATION, {
				arg1 = 1,
				cmd = 1,
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	var_1.Foreach(arg_10_0.Order, function(arg_11_0, arg_11_1)
		...
		var_2_10002(var_3.Find(var_11_0, "Effect"), arg_11_0 <= arg_10_0.clickIndex or arg_10_0.activity.data1 ~= 0)
