...
function var_0_1.init(arg_5_0)
	...
	BulletinBoardMgr = var_2
	arg_5_0.downloadmgr = var_2.Inst
	...
	arg_5_0.imageTF = var_5_10(var_5_9, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_5_0.likeCntTxt = var_5_16(var_5_15, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_5_0.pushTimeTxt = var_5_19(var_5_18, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_5_0.nameTxt = var_5_23(var_5_22, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_5_0.contentTxt = var_5_27(var_5_26, var_4(var_1_10005))
	UIItemList = var_2

	local var_5_28 = var_2.New
	local var_5_29 = arg_5_0._tf
	local var_5_30 = var_3.Find(var_5_29, "main/right_panel/center/bottom/scroll/content")
	local var_5_31 = arg_5_0._tf

	arg_5_0.commentList = var_5_28(var_5_30, var_4.Find(var_5_31, "main/right_panel/center/bottom/scroll/content/tpl"))
	...
	local var_5_36 = var_3.Find(var_5_35, "closeBtn/Text")

	i18n = var_5_35

	var_2(var_5_36, var_5_35("word_back"))
...
function var_0_1.SetImageByUrl(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if not arg_6_1 or arg_6_1 == "" then
		...
		if arg_6_0.sprites[arg_6_1] then
			...
			var_6_1(var_6_0, var_6_2, var_6_3, var_6_4, var_1_10010.Events.UnityAction_UnityEngine_Texture(function(arg_7_0)
...
function var_0_1.didEnter(arg_8_0)
	...
	function arg_8_0.list.onInitItem(arg_9_0)
		...
		var_2(var_9_1, var_9_2, var_9_3, var_2_10006)
...
function var_0_1.ExitDetail(arg_19_0)
	if arg_19_0.contextData.instagram and not var_1:IsReaded() then
		...
		var_19_1(var_19_0, var_1_10004.ON_READED, var_1.id)
	end
...
function var_0_1.RefreshInstagram(arg_20_0)
	...
	if var_1.GetFastestRefreshTime(var_20_0) then
		...
		if var_2 - var_3.GetServerTime(var_20_1) <= 0 then
			...
			var_20_3(var_20_2, var_1_10007.ON_REPLY_UPDATE, var_1.id)
		end
	end
...
function var_0_1.InitDetailPage(arg_21_0)
	...
	local var_21_2 = arg_21_0.planeTF
	...
	local function var_21_3()
		...
		var_22_1(var_22_0, var_2_10002.ON_SHARE, var_21_0.id)
	...
	var_2(var_21_1, var_21_2, var_21_3, var_1_10006)

	local var_21_4 = arg_21_0.pushTimeTxt
	local var_21_5 = var_21_0

	var_21_4.text = var_21_0.GetPushTime(var_21_5)
	setImageSprite = var_21_4

	local var_21_6 = arg_21_0.iconTF

	LoadSprite = var_21_5

	var_21_4(var_21_6, var_21_5("qicon/" .. var_21_0:GetIcon()), false)

	arg_21_0.nameTxt.text = var_21_0:GetName()

	local var_21_7 = arg_21_0.contentTxt

	var_21_7.text = var_21_0:GetContent()
	onToggle = var_21_7

	local var_21_8 = arg_21_0
	local var_21_9 = arg_21_0.commentPanel

	local function var_21_10(arg_23_0)
		if arg_23_0 then
	...
	var_21_7(var_21_8, var_21_9, var_21_10, var_6)
...
function var_0_1.UpdateLikeBtn(arg_24_0)
	...
	if not var_1.IsLiking(var_24_0) then
		...
		local function var_24_3()
			...
			var_25_1(var_25_0, var_2_10002.ON_LIKE, var_0.id)
		...
		var_24_0(var_24_1, var_24_2, var_24_3, var_1_10007)
	else
		removeOnButton = var_24_0

		var_24_0(arg_24_0.likeBtn)
	end
	...
	var_24_0(var_4.Find(var_24_4, "heart"), var_2)
	...
	typeof = var_5
	Image = var_6
	var_24_6(var_24_5, var_5(var_6)).enabled = not var_2
...
function var_0_1.UpdateCommentList(arg_26_0)
	...
	local var_26_0, var_26_1 = var_1:GetCanDisplayComments()

	table = var_1_10004

	var_1_10004.sort(var_26_0, function(arg_27_0, arg_27_1)
		return arg_27_0.time < arg_27_1.time
	end)

	local var_26_2 = arg_26_0.commentList

	var_4.make(var_26_2, function(arg_28_0, arg_28_1, arg_28_2)
		...
		if arg_28_0 == var_2_10003.EventUpdate then
			...
			var_28_0(arg_28_2:Find("main/reply"), var_3:GetReplyBtnTxt())

			local var_28_2 = var_3
			local var_28_3 = var_3.GetContent(var_28_2)

			SwitchSpecialChar = var_28_2
			...
			local var_28_6 = arg_28_2.Find(var_28_5, "main/content")

			HXSet = var_28_5

			var_6(var_28_6, var_28_5.hxLan(var_28_4))
			...
			local var_28_9 = var_3
			local var_28_10 = var_3.GetType(var_28_9)

			Instagram = var_28_9

			if var_28_10 == var_28_9.TYPE_PLAYER_COMMENT then
				local var_28_11

				var_28_10, var_28_11 = var_3:GetIcon()
				setImageSprite = var_8

				local var_28_12 = arg_28_2

				var_28_8 = arg_28_2.Find(var_28_12, "main/head/icon")
				GetSpriteFromAtlas = var_28_12

				var_8(var_28_8, var_28_12(var_28_10, var_28_11))
			else
				setImageSprite = var_28_10

				local var_28_13 = arg_28_2
				local var_28_14 = arg_28_2.Find(var_28_13, "main/head/icon")

				LoadSprite = var_28_13

				var_28_10(var_28_14, var_28_13("qicon/" .. var_3:GetIcon()), false)
			end

			if var_28_1 then
				onToggle = var_28_10

				local var_28_15 = arg_26_0

				var_28_8 = arg_28_2

				local var_28_16 = arg_28_2.Find(var_28_8, "main/bubble")

				function var_28_8(arg_29_0)
					setActive = var_3_10001

					local var_29_0 = arg_28_2

					var_3_10001(var_2.Find(var_29_0, "replys"), arg_29_0)
				...
				var_28_10(var_28_15, var_28_16, var_28_8, var_10)

				local var_28_17 = arg_26_0

				var_28_10.UpdateReplys(var_28_17, arg_28_2, var_3)

				triggerToggle = var_28_10

				var_28_10(arg_28_2:Find("main/bubble"), true)
			else
				setActive = var_28_10

				var_28_10(arg_28_2:Find("replys"), false)

				triggerToggle = var_28_10

				var_28_10(arg_28_2:Find("main/bubble"), false)
			end
			...
			typeof = var_8
			Toggle = var_28_8
			var_28_19(var_28_18, var_8(var_28_8)).enabled = var_28_1
		end
...
function var_0_1.UpdateReplys(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_2 = var_1_10005.New(arg_30_1:Find("replys"), arg_30_1:Find("replys/sub"))

	table = var_6

	var_6.sort(var_30_0, function(arg_31_0, arg_31_1)
	...
	var_30_2:make(function(arg_32_0, arg_32_1, arg_32_2)
		...
		if arg_32_0 == var_2_10003.EventUpdate then
			...
			local var_32_2 = arg_32_2.Find(var_32_1, "head/icon")

			LoadSprite = var_32_1

			var_4(var_32_2, var_32_1("qicon/" .. var_32_0:GetIcon()), false)

			local var_32_3 = var_32_0
			local var_32_4 = var_32_0.GetContent(var_32_3)

			SwitchSpecialChar = var_32_3

			local var_32_5 = var_32_3(var_32_4)

			setText = var_5

			local var_32_6 = arg_32_2
			local var_32_7 = arg_32_2.Find(var_32_6, "content")

			HXSet = var_32_6

			var_5(var_32_7, var_32_6.hxLan(var_32_5))
		end
...
function var_0_1.OpenCommentPanel(arg_33_0)
	...
	typeof = var_1_10005
	Image = var_1_10006
	var_33_3(var_33_2, var_1_10005(var_1_10006)).enabled = true
	...
	local var_33_8 = var_33_5(var_33_6, var_5.Find(var_33_7, "option1"))
	...
	var_3.make(var_33_8, function(arg_34_0, arg_34_1, arg_34_2)
		...
		if arg_34_0 == var_2_10003.EventUpdate then
			...
			local var_34_4 = arg_34_2
			local var_34_5 = arg_34_2.Find(var_34_4, "Text")

			HXSet = var_34_4

			var_2_10007(var_34_5, var_34_4.hxLan(var_34_1))

			onButton = var_2_10007

			local var_34_6 = arg_33_0
			local var_34_7 = arg_34_2

			local function var_34_8()
				local var_35_0 = arg_33_0
				local var_35_1 = var_0.emit

				InstagramMediator = var_3_10002

				var_35_1(var_35_0, var_3_10002.ON_COMMENT, var_0.id, var_34_3, var_34_2)
			...
			var_2_10007(var_34_6, var_34_7, var_34_8, var_2_10011)
		end
...
function var_0_1.CloseCommentPanel(arg_36_0)
	...
	typeof = var_1_10003
	Image = var_1_10004
	var_36_1(var_36_0, var_1_10003(var_1_10004)).enabled = false
...
function var_0_1.onBackPressed(arg_37_0)
	...
	InstagramMediator = var_1_10003

	var_37_1(var_37_0, var_1_10003.CLOSE_ALL)
