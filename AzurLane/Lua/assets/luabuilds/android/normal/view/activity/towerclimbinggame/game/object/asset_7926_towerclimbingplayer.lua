...
function var_0_0.Init(arg_2_0, arg_2_1)
	...
	TowerClimbingResMgr = var_2_0

	var_2_0.GetPlayer(var_2_1, function(arg_3_0)
...
function var_0_0.OnLoaded(arg_4_0, arg_4_1)
	...
	arg_4_0.rigbody = var_4_1(var_4_0, var_1_10004(var_1_10005.Rigidbody2D))
	...
	var_2.AddListener(var_4_3, function(arg_5_0)
		...
		if var_1.GetHitBlock(var_5_0, arg_5_0.collider.gameObject) then
			...
			TowerClimbingGameSettings = var_5_3

			if var_5_1 == var_5_3.BLOCK_NAME then
		...
		if var_5_4 == var_5_3.FIRE_NAME then
			var_5_5 = arg_4_0.map
		...
		TowerClimbingGameSettings = var_5_5

		if var_5_6 == var_5_5.STAB_NAME and arg_5_0.otherCollider.name == "player" then
			Physics2D = var_2
		...
		if var_5_7 == var_3.STAB_NAME then
			...
			TowerClimbingGameSettings = var_5_9

			if var_5_8 == var_5_9.STAB_HURT_AREA then
				var_5_9 = arg_4_0.map
		...
		if var_5_10 == var_5_9.GROUND_NAME then
	...
	var_2.AddListener(var_4_4, function(arg_6_0)
		...
		if var_6_2 == var_2_10003.BLOCK_NAME then
	...
	var_2.AddListener(var_4_5, function(arg_7_0)
		...
		if var_7_2 == var_3.BLOCK_NAME then
	...
	var_2(var_4_7, var_4.Find(var_4_8, "game/block_play_con"))
	...
	Vector3 = var_4_7
	var_4_9.localScale = var_4_7(var_0_1, var_0_1, 1)
	setActive = var_4_9
...
function var_0_0.MoveLeft(arg_10_0, arg_10_1)
	...
	arg_10_0.SetAction(var_10_0, "walk")

	local var_10_1 = arg_10_0._tf

	Vector3 = var_10_0
	var_10_1.localScale = var_10_0(-var_0_1, var_0_1, 1)

	local var_10_2 = arg_10_0.rigbody

	Vector2 = var_3
	var_10_2.velocity = var_3(-arg_10_1, arg_10_0.rigbody.velocity.y)
...
function var_0_0.MoveRight(arg_11_0, arg_11_1)
	...
	arg_11_0.SetAction(var_11_0, "walk")

	local var_11_1 = arg_11_0._tf

	Vector3 = var_11_0
	var_11_1.localScale = var_11_0(var_0_1, var_0_1, 1)

	local var_11_2 = arg_11_0.rigbody

	Vector2 = var_3
	var_11_2.velocity = var_3(arg_11_1, arg_11_0.rigbody.velocity.y)
...
function var_0_0.Invincible(arg_15_0, arg_15_1)
	...
	if arg_15_1 then
		...
		Timer = var_15_2
		arg_15_0.timer = var_15_2.New(function()
			var_15_3 = var_15_3 + 1
...
function var_0_0.ChangePosition(arg_17_0, arg_17_1)
	...
	local var_17_3 = var_17_1(var_17_0, var_4.TransformVector(var_17_2, arg_17_1))
