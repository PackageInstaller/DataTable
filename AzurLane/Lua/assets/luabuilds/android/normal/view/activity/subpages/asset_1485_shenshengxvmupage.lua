...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	if var_1_10006(arg_3_0.battleBtn) then
		var_3_5 = var_3_3
	end
	...
	var_3_7, setActive = var_4.Find(var_3_6, "got"), var_3_6

	local var_3_8 = arg_3_0.ptData

	var_3_6(var_3_7, not var_7.CanGetNextAward(var_3_8))
	...
	if 1 <= var_3_12 then
		...
		if not var_10(var_3_14, var_1_10012) then
			var_3_15 = var_3_10
		end

		var_3_8(var_3_13, var_3_15)

		setText = var_3_8

		var_3_8(arg_3_0.progress, "/" .. var_3_11)
