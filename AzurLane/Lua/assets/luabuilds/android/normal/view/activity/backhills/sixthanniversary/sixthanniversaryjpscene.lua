...
function var_0_1.init(arg_2_0)
	...
	import = var_2_11
	arg_2_0.graphPath = var_2_12(var_2_11("GameCfg.BackHillGraphs.SixthAnniversaryJPGraph"))
	PLATFORM_CODE = var_1
	PLATFORM_JP = var_2
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.jp6th_biaohoushan_help.tip
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "jiujiuwenquan", function()
		...
		var_7_1(var_7_0, var_7_2, var_2_10003.SIXTH_ANNIVERSARY_JP_HOTSPRING)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "shujuhuigu", function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10003.SUMMARY)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "shijiandiaocha", function()
		...
		var_9_1(var_9_0, var_2_10002.SIXTH_ANNIVERSARY_JP_DARK)
	...
	arg_3_0.UpdateView(var_3_15)

	pg = var_2

	local var_3_16 = var_2.activity_template

	ActivityConst = var_3_15

	local var_3_17 = var_3_16[var_3_15.MINIGAME_ZUMA].config_client.biaohoushanstory

	pg = var_3

	local var_3_18 = var_3.NewStoryMgr.GetInstance()

	var_3.Play(var_3_18, var_3_17)
...
function var_0_1.HotSpringTip()
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10002.ACTIVITY_TYPE_HOTSPRING)

	Activity = var_10_0

	return var_10_0.IsActivityReady(var_10_2)
end
...
function var_0_1.ZumaTip()
	...
	if not var_11_0(var_1_10001.MINIGAME_ZUMA) then
...
function var_0_1.UpdateView(arg_12_0)
	...
	var_1_10001(var_2.Find(var_12_0, "Tip"), var_0_1.HotSpringTip())

	setActive = var_1_10001

	local var_12_1 = arg_12_0.upper_shijiandiaocha

	var_1_10001(var_2.Find(var_12_1, "Tip"), var_0_1.ZumaTip())
