...
function var_0_1.BindActivityShop(arg_2_0, arg_2_1)
	...
	local function var_2_2()
		...
		local var_3_3 = var_2_10003.SHOP
		local var_3_4 = {}

		NewShopsScene = var_2_10005
		var_3_4.warp = var_2_10005.TYPE_ACTIVITY
	...
	var_1_10002(var_2_0, var_2_1, var_2_2, var_1_10006)
...
function var_0_1.BindBuildShip(arg_6_0, arg_6_1)
	...
	local function var_6_2()
		...
		local var_7_3 = var_7_2(var_7_1, var_2_10003.ACTIVITY_TYPE_BUILDSHIP_1)

		getProxy = var_7_1
		ActivityProxy = var_3

		local var_7_4 = var_7_1(var_3)
		local var_7_5 = var_2.getActivityByType

		ActivityConst = var_2_10004

		local var_7_6 = var_7_5(var_7_4, var_2_10004.ACTIVITY_TYPE_BUILD)

		if var_7_3 and not var_7_3:isEnd() then
			BuildShipScene = var_7_4
			var_7_0 = var_7_4.PROJECTS.ACTIVITY
		else
			if var_7_6 then
				local var_7_7 = var_7_6

				if not var_7_6.isEnd(var_7_7) then
					var_7_4 = {}
					BuildShipScene = var_7_7
					var_7_4[1] = var_7_7.PROJECTS.SPECIAL
					BuildShipScene = var_4
					var_7_4[2] = var_4.PROJECTS.LIGHT
					BuildShipScene = var_4
					var_7_4[3] = var_4.PROJECTS.HEAVY
					var_2_10005 = var_7_6
					var_7_0 = var_7_4[var_7_6.getConfig(var_2_10005, "config_client").id]
			...
			local var_7_8 = var_7_4.TipsMgr.GetInstance()
			local var_7_9 = var_3.ShowTips

			i18n = var_2_10005

			var_7_9(var_7_8, var_2_10005("common_activity_end"))
		...
		local var_7_11 = var_3.emit

		FullPreviewMediatorTemplate = var_2_10005

		local var_7_12 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		local var_7_13 = var_2_10006.GETBOAT
		local var_7_14 = {}

		BuildShipScene = var_2_10008
		var_7_14.page = var_2_10008.PAGE_BUILD
		var_7_14.projectName = var_7_0

		var_7_11(var_7_10, var_7_12, var_7_13, var_7_14)
...
function var_0_1.BindBattle(arg_8_0, arg_8_1)
	...
	local function var_8_2()
		...
		if var_9_1 then
			...
			if not var_2_10003.isUnlock(var_9_3) then
				pg = var_2_10003

				local var_9_4 = var_2_10003.TipsMgr.GetInstance()
				local var_9_5 = var_3.ShowTips

				i18n = var_2_10005

				var_9_5(var_9_4, var_2_10005("common_activity_end"))
			else
				...
				local var_9_8 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_9_7(var_9_6, var_9_8, var_2_10006.LEVEL, {
					chapterId = var_9_2,
					mapIdx = var_9_1
				})
			end
...
function var_0_1.BindMiniGame(arg_10_0, arg_10_1, arg_10_2)
	...
	local function var_10_2()
		...
		var_11_1(var_11_0, var_2_10002.GO_MINIGAME, arg_10_2)
	...
	var_1_10003(var_10_0, var_10_1, var_10_2, var_1_10007)
