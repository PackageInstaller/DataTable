...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BossRushPassedLayer"))
...
function var_0_1.combatPreload(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10004(var_6_3) do
	...
	local function var_6_5()
		...
		ChallengePassedCombatLoadMediator = var_2

		var_7_2(var_7_1, var_2.FINISH, arg_6_0._loadObs)
