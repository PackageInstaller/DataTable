...
function var_0_1.init(arg_4_0)
	...
	var_1(var_4_5, var_4_6, var_4_7, var_1_10005)

	setText = var_1

	local var_4_8 = arg_4_0._tf
	local var_4_9 = var_2.Find(var_4_8, "window/inner/top/back/Text")

	i18n = var_4_8

	var_1(var_4_9, var_4_8("activity_permanent_total"))
	...
	local function var_4_13()
		...
		i18n = var_2_10003
		var_7_2.helps = var_2_10003("activity_permanent_help")
	...
	var_1(var_4_11, var_4_12, var_4_13, var_1_10005)
	...
	arg_4_0.itemList = var_4_15(var_4_16, var_3.Find(var_4_17, "item"))
	getProxy = var_1
	...
	var_2.make(var_4_19, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			local var_8_3 = arg_8_2:Find("main")
			...
			var_2_10005(var_8_2, var_8_3, var_8_4, var_9)

			local var_8_5 = arg_8_2
			local var_8_6 = arg_8_2.Find(var_8_5, "finish")

			GetOrAddComponent = var_8_5
			...
			local var_8_8 = var_8_5(var_8_7, var_8_4(var_9))
			local var_8_9
			...
			local var_8_11 = var_8_6.Find(var_8_10, "Image/Text")

			i18n = var_8_10

			var_8_9(var_8_11, var_8_10("activity_permanent_finished"))

			setActive = var_8_9

			local var_8_12 = var_8_6
			local var_8_13 = var_4_18

			var_8_9(var_8_12, var_9.isActivityFinish(var_8_13, var_8_0))
		end
	...
	local var_4_23 = var_4.Find(var_4_22, "bg")
	...
	var_2(var_4_21, var_4_23, var_4_24, var_6)

	onButton = var_2

	local var_4_25 = arg_4_0
	local var_4_26 = arg_4_0.rtMsgbox
	local var_4_27 = var_4.Find(var_4_26, "window/top/btnBack")
	...
	var_2(var_4_25, var_4_27, var_4_28, var_6)

	onButton = var_2

	local var_4_29 = arg_4_0
	local var_4_30 = arg_4_0.rtMsgbox
	local var_4_31 = var_4.Find(var_4_30, "window/button_container/custom_button_2")
	...
	var_2(var_4_29, var_4_31, var_4_32, var_6)
...
function var_0_1.didEnter(arg_13_0)
	...
	if arg_13_0.childFinish then
		...
		var_13_3 = var_13_3(var_13_2, var_3(var_1_10004)).viewport
		scrollTo = var_13_2
		...
		var_13_2(var_13_4, var_13_5, var_1_10005.clamp(arg_13_0.childFinish.anchoredPosition.y / (arg_13_0.content.rect.height - var_13_3.rect.height), 0, 1))
...
function var_0_1.setActivitys(arg_15_0, arg_15_1)
	...
	ActivityPermanentProxy = var_1_10003
...
function var_0_1.doFinishAnim(arg_17_0, arg_17_1)
	...
	var_17_1, GetOrAddComponent = arg_17_1.Find(var_17_0, "finish"), var_17_0
	typeof = var_1_10005
	...
	LeanTween = var_17_1
	arg_17_0.ltId = var_17_1.alphaCanvas(var_17_2, 1, 1).uniqueId
...
function var_0_1.showMsgbox(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_3.Find(var_18_0, "window/button_container/custom_button_1/pic")

	i18n = var_18_0

	var_1_10002(var_18_1, var_18_0("msgbox_text_confirm"))

	setText = var_1_10002

	local var_18_2 = arg_18_0.rtMsgbox
	local var_18_3 = var_3.Find(var_18_2, "window/button_container/custom_button_2/pic")

	i18n = var_18_2

	var_1_10002(var_18_3, var_18_2("msgbox_text_cancel"))

	setText = var_1_10002

	local var_18_4 = arg_18_0.rtMsgbox
	local var_18_5 = var_3.Find(var_18_4, "window/top/bg/infomation/title")

	i18n = var_18_4

	var_1_10002(var_18_5, var_18_4("words_information"))

	setText = var_1_10002

	local var_18_6 = arg_18_0.rtMsgbox
	local var_18_7 = var_3.Find(var_18_6, "window/msg_panel/content")
	...
	var_1_10002(var_18_7, var_18_6(var_18_8, var_1_10006.activity_task_permanent[arg_18_1].activity_name))

	setText = var_1_10002

	local var_18_9 = arg_18_0.rtMsgbox
	local var_18_10 = var_3.Find(var_18_9, "window/msg_panel/Text")

	i18n = var_18_9

	var_1_10002(var_18_10, var_18_9("activity_permanent_tips4"))

	onButton = var_1_10002

	local var_18_11 = arg_18_0
	local var_18_12 = arg_18_0.rtMsgbox
	local var_18_13 = var_4.Find(var_18_12, "window/button_container/custom_button_1")
	...
	local function var_18_14()
		...
		ActivityPermanentMediator = var_2_10002

		var_19_2(var_19_1, var_2_10002.START_SELECT, arg_18_1)
	...
	var_1_10002(var_18_11, var_18_13, var_18_14, var_6)
