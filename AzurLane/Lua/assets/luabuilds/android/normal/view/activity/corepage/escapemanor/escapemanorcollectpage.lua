...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.DOA.DOACoreActivityCollectPage"))
...
function var_0_1.AddSpecialBtnListener(arg_2_0)
	...
	if arg_2_0.furnitureThemeBtn and var_2_1.furniture_theme_link then
		...
		var_2(var_2_3, var_2_4, var_2_5, var_1_10006)
	end
	...
	if arg_2_0.equipSkinBoxBtn and var_2_1.equipskin_box_link then
		...
		var_2_7(var_2_9, var_2_10, var_2_11, var_1_10007)
	end
...
function var_0_1.OnUpdateItem(arg_9_0, arg_9_1, arg_9_2)
	...
	var_6(var_9_3, var_9_4, var_9_5, var_1_10010)

	changeToScrollText = var_6

	local var_9_6 = arg_9_2
	local var_9_7 = arg_9_2.Find(var_9_6, "name_mask/name")

	Drop = var_9_6

	local var_9_8 = var_9_6.New({
		type = var_9_0.config.type,
		id = var_9_0.config.drop_id
	})

	var_6(var_9_7, var_8.getName(var_9_8))
	arg_9_0:RefreshCountText(var_9_0, arg_9_2)

	GetOrAddComponent = var_6

	local var_9_9 = arg_9_2
	local var_9_10 = arg_9_2.Find(var_9_9, "owner")

	typeof = var_9_9
	CanvasGroup = var_9
	var_6(var_9_10, var_9_9(var_9)).alpha = var_9_0.count == var_9_0.config.count and 0.5 or 1
	setActive = var_7
