...
function var_0_0.SetUI(arg_2_0, arg_2_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_2_0.countDown = var_2_4(var_2_3, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_2_0.scoreTxt = var_2_11(var_2_10, var_4(var_1_10005))
	...
	typeof = var_4
	Animator = var_5
	arg_2_0.manjuuAnim = var_2_18(var_2_17, var_4(var_5))
	...
	typeof = var_4
	Animator = var_5
	arg_2_0.anikiAnim = var_2_21(var_2_20, var_4(var_5))
	...
	typeof = var_4
	Text = var_5
	arg_2_0.finalScoreTxt = var_2_31(var_2_30, var_4(var_5))
	...
	typeof = var_4
	Text = var_5
	arg_2_0.highestScoreText = var_2_34(var_2_33, var_4(var_5))
	...
	arg_2_0.bgMgr = var_2_42(var_3.Find(var_2_43, "AD/bgs"))
...
function var_0_0.ShowExitMsg(arg_7_0)
	...
	var_2(var_7_2, var_7_3, var_7_4, var_1_10006)
	...
	var_2(var_7_5, var_7_6, var_7_7, var_1_10006)
		...
		function(arg_12_0)
			...
			var_12_1.timer = var_3.New(function()
				...
				if var_12_0 == 3 then
					...
					SFX_STEP_PILE_COUNTDOWN = var_3_10002

					var_13_1(var_13_0, var_3_10002)
				end
...
function var_0_0.UpdateScore(arg_14_0, arg_14_1, arg_14_2)
	...
	if arg_14_0.items[arg_14_2] and var_14_0 then
		local var_14_3 = var_4:Find("anim")
		local var_14_4 = var_5.GetComponent

		typeof = var_1_10007
		Animator = var_1_10008

		local var_14_5 = var_14_4(var_14_3, var_1_10007(var_1_10008))

		var_5.SetTrigger(var_14_5, "win")
	elseif var_4 then
		local var_14_6 = var_4:Find("anim")
		local var_14_7 = var_5.GetComponent

		typeof = var_1_10007
		Animator = var_1_10008

		local var_14_8 = var_14_7(var_14_6, var_1_10007(var_1_10008))

		var_5.SetTrigger(var_14_8, "idle")
	end

	if arg_14_2 then
		local var_14_9 = arg_14_2.position.x
		local var_14_10 = arg_14_0.itemIndexTF

		Vector3 = var_1_10007
		PileGameConst = var_1_10008
		var_14_10.localPosition = var_1_10007(var_14_9 / var_1_10008.RATIO, 0, 0)
		pg = var_14_10

		local var_14_11 = var_14_10.CriMgr.GetInstance()
		local var_14_12 = var_6.PlaySoundEffect_V3

		SFX_STEP_PILE_SUCCESS = var_8

		var_14_12(var_14_11, var_8)
	end
...
function var_0_0.UpdateFailedCnt(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	if arg_15_3 then
		...
		local var_15_4 = var_15_3(var_15_2, var_8(iter_15_1))
...
function var_0_0.AddPile(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	local function var_16_0(arg_17_0)
		...
		var_2(var_17_0, arg_16_0.itemsContainer)
		...
		if not arg_16_2 then
			...
			local var_17_5 = var_17_4(var_17_3, var_4(var_5))
...
function var_0_0.OnStartDrop(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	if arg_18_3 then
		...
		PileGameController = var_1_10007

		var_18_1(var_18_0, var_18_2, var_1_10007.DROP_AREA_WARN == arg_18_2)
	else
...
function var_0_0.OnItemPositionChangeWithAnim(arg_20_0, arg_20_1, arg_20_2)
	if arg_20_0.items[arg_20_1] then
		...
		local var_20_1 = var_1_10005(var_3)
		local var_20_2 = arg_20_1.position.y

		PileGameConst = var_1_10007

		local var_20_3 = var_20_0(var_20_1, var_20_2, var_1_10007.SINK_TIME)
...
function var_0_0.DoSink(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_5 = var_23_1(var_23_2, var_23_3, var_23_4, var_1_10008.SINK_TIME)
	...
	var_23_8(var_23_7, var_6.Action(arg_23_2))
...
function var_0_0.OnRemovePile(arg_25_0, arg_25_1)
	if arg_25_0.items[arg_25_1] then
		...
		local var_25_2 = var_25_1(var_25_0, var_5(var_1_10006))
...
function var_0_0.PlaySpeAction(arg_26_0, arg_26_1)
	if arg_26_0.items[arg_26_1] then
		...
		local var_26_3 = var_26_2(var_26_1, var_8(var_1_10009))
...
function var_0_0.OnGameExited(arg_29_0)
	...
	Vector3 = var_2
	var_29_0.eulerAngles = var_2(0, 0, 0)
	...
	if var_1.DEBUG then
		...
		var_1(var_2.Find(var_29_3, "ground").gameObject)

		Destroy = var_1

		local var_29_4 = arg_29_0.gameContainer

		var_1(var_2.Find(var_29_4, "deathLineR").gameObject)

		Destroy = var_1

		local var_29_5 = arg_29_0.gameContainer

		var_1(var_2.Find(var_29_5, "deathLineL").gameObject)

		Destroy = var_1

		local var_29_6 = arg_29_0.gameContainer

		var_1(var_2.Find(var_29_6, "safeLineL").gameObject)

		Destroy = var_1

		local var_29_7 = arg_29_0.gameContainer

		var_1(var_2.Find(var_29_7, "safeLineR").gameObject)
	end
...
function var_0_0.OnCollapse(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	local function var_34_0(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
		...
		local var_35_1 = var_35_0(var_2_10005(arg_34_0.itemsContainer), arg_35_0, arg_35_1, arg_35_2)
		local var_35_2 = var_4.setOnUpdate

		System = var_6

		local var_35_3 = var_35_2(var_35_1, var_6.Action_float(function(arg_36_0)
		...
		var_35_4(var_35_3, var_6.Action(arg_35_3))
	...
	var_1_10005({
		function(arg_37_0)
			...
			Vector2 = var_2_10004
			var_37_2.pivot = var_2_10004(var_37_1, 0)
		...
		function(arg_39_0, arg_39_1)
			...
			var_4.sort(var_39_1, function(arg_40_0, arg_40_1)
				...
				var_2_10009.insert(var_39_0, function(arg_41_0)
					...
					var_3_10002({
						...
						function(arg_43_0)
							...
							local var_43_2 = var_43_1(var_4_10003(iter_39_1), 0, var_43_0, 1)
							local var_43_3 = var_2.setOnUpdate

							System = var_4

							local var_43_4 = var_43_3(var_43_2, var_4.Action_float(function(arg_44_0)
							...
							var_43_5(var_43_4, var_4.Action(arg_43_0))
						...
						function(arg_45_0)
							...
							local var_45_1 = var_45_0(var_4_10002(iter_39_1), iter_39_1.localPosition.y + 50 * iter_39_0, 1)
							local var_45_2 = var_1.setOnComplete

							System = var_3

							var_45_2(var_45_1, var_3.Action(arg_45_0))
