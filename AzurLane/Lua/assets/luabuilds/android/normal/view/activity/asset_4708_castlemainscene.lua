...
function var_0_1.InitData(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1(var_2.getConfig(var_4_1, "config_data")[3]) do
		table = var_1_10006

		var_1_10006.insert(arg_4_0.storyGroup, iter_4_1[1][1])

		table = var_1_10006

		var_1_10006.insert(arg_4_0.storyGroup, iter_4_1[2][2])

		table = var_1_10006

		var_1_10006.insert(arg_4_0.storyGroup, iter_4_1[2][1])
	end
...
function var_0_1.InitCharacter(arg_7_0)
	...
	var_1(var_7_9, var_3("roll_unlock"))
	...
	local var_7_14 = var_2.Find(var_7_13, "title_base")

	i18n = var_7_13

	var_1(var_7_14, var_7_13("roll_card_info"))

	setText = var_1

	local var_7_15 = arg_7_0.characterCard
	local var_7_16 = var_2.Find(var_7_15, "title_attr")

	i18n = var_7_15

	var_1(var_7_16, var_7_15("roll_card_attr"))

	setText = var_1

	local var_7_17 = arg_7_0.characterCard
	local var_7_18 = var_2.Find(var_7_17, "title_skill")

	i18n = var_7_17

	var_1(var_7_18, var_7_17("roll_card_skill"))
...
function var_0_1.InitVX(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10001({
		...
		local var_8_2 = var_8_0(var_8_1, iter_8_1)

		findTF = var_8

		local var_8_3 = var_8(var_8_1, "VX/glow")

		setLocalScale = var_9

		var_9(var_8_3, {
			x = var_8_2.rect.width,
			y = var_8_2.rect.height
		})
	end
...
function var_0_1.didEnter(arg_9_0)
	for iter_9_0 = 1, var_0_1.ROOM_NUM do
		...
		var_1_10005 = arg_9_0.GetRoomTF(var_9_0, iter_9_0)
		findTF = var_9_0

		local var_9_1

		var_9_1, setText = var_9_0(var_1_10005, "name"), var_7
		i18n = var_1_10009

		var_7(var_9_1, var_1_10009("roll_room_unexplored"))

		findTF = var_7

		local var_9_2 = var_7(var_1_10005, "explorable")

		setImageRaycastTarget = var_8
		findTF = var_1_10009

		var_8(var_1_10009(var_1_10005, "fill"), true)
		...
		var_8(var_1_10009, var_9_3, var_9_4, var_1_10012)
	end
	...
	if not var_1.contains(arg_9_0.explorableStories, arg_9_0.storyGroup[15]) then
		table = var_9_5
		var_9_5 = var_9_5.contains(arg_9_0.exploredStories, arg_9_0.storyGroup[15])
	end
	...
	if var_9_5 then
		...
		for iter_9_1 = #arg_9_0.exploredStories, 1, -1 do
			if not arg_9_0:IsBadEnd(arg_9_0.exploredStories[iter_9_1]) then
				var_9_6 = arg_9_0.exploredStories[iter_9_1]
		...
		if not var_9_6 or not arg_9_0.story2Map[var_9_6] then
			var_9_7 = 0
		end

		local var_9_8 = var_9_7 > 10 and var_9_7 < 17

		setActive = var_1_10005

		var_1_10005(arg_9_0.floors[1], not var_9_8)

		setActive = var_1_10005

		var_1_10005(arg_9_0.floors[2], var_9_8)

		setActive = var_1_10005

		var_1_10005(arg_9_0.button1F, not var_9_8)

		setActive = var_1_10005

		var_1_10005(arg_9_0.button2F, var_9_8)
	else
		setActive = var_9_6

		var_9_6(arg_9_0.button1F, false)

		setActive = var_9_6

		var_9_6(arg_9_0.button2F, false)
	end

	local var_9_9 = arg_9_0.taskList

	var_2.make(var_9_9, function(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_9_10 = arg_9_0.nameInput
	local var_9_11 = var_2.GetComponent

	typeof = var_4
	InputField = var_1_10005

	local var_9_12 = var_9_11(var_9_10, var_4(var_1_10005)).onValueChanged

	var_2.AddListener(var_9_12, function()
		nameValidityCheck = var_2_10000
		getInputText = var_2_10001

		if not var_2_10000(var_2_10001(arg_9_0.nameInput), 0, 40, {
			"spece_illegal_tip",
			...
			local var_12_1 = var_2(var_3)

			var_0(var_12_0, var_2.getData(var_12_1).name)
		end
	...
	if var_2.getConfig(var_9_13, "config_data")[1] and not arg_9_0:IsPlayed(var_2) then
		local var_9_14 = arg_9_0
		local var_9_15 = arg_9_0.emit

		CastleMainMediator = var_5

		var_9_15(var_9_14, var_5.CASTLE_ACT_OP, {
			cmd = 3,
			id = var_0_1.ACT_ID,
			arg1 = var_2
		})
...
function var_0_1.InitButton(arg_13_0)
	...
	var_1_10001(var_13_0, var_13_1, var_13_2, var_5)
	...
	local function var_13_5()
		...
		local var_17_1 = var_1.MsgboxMgr.GetInstance()
		local var_17_2 = var_1.ShowMsgBox
		local var_17_3 = {}

		MSGBOX_TYPE_HELP = var_2_10004
		var_17_3.type = var_2_10004
	...
	var_1_10001(var_13_3, var_13_4, var_13_5, var_5)
	...
	var_1_10001(var_13_6, var_13_7, var_13_8, var_5)
	...
	local function var_13_11()
		...
		if #var_0.value(var_19_3) > 0 then
			...
			var_19_5(var_19_4, var_2_10003.ON_TASK_SUBMIT, var_0)
		end
	...
	var_1_10001(var_13_9, var_13_10, var_13_11, var_5)
	...
	var_1_10001(var_13_12, var_13_13, var_13_14, var_5)
	...
	var_1_10001(var_13_15, var_13_16, var_13_17, var_5)
	...
	var_1_10001(var_13_18, var_13_19, var_13_20, var_5)
	...
	local function var_13_23()
		...
		if var_0.IsFinish(var_25_0) then
			...
			if #var_0(arg_13_0.nameInput) == 0 then
				...
				var_25_2(var_25_1, var_2_10003("roll_noname"))
			else
	...
	var_1_10001(var_13_21, var_13_22, var_13_23, var_5)
		...
		if arg_13_0.diceCount < 1 then
			...
			if not var_0.contains(arg_13_0.explorableStories, arg_13_0.storyGroup[23]) then
				...
				if var_26_1.contains(arg_13_0.explorableStories, arg_13_0.storyGroup[24]) then
					...
					var_26_1(var_26_0, var_2("roll_ending_tip1"))
				else
					table = var_26_1
					...
					if var_26_1.contains(arg_13_0.exploredStories, arg_13_0.storyGroup[23]) then
						...
						if var_26_3.contains(arg_13_0.exploredStories, arg_13_0.storyGroup[24]) then
							...
							var_26_3(var_26_2, var_2("roll_ending_tip2"))
					...
					var_26_5(var_26_4, var_2("roll_notimes"))
				end
	...
	var_1_10001(var_13_24, var_13_25, var_13_26, var_5)
	...
	var_1_10001(var_13_27, var_13_28, var_13_29, var_5)
...
function var_0_1.UpdateFlush(arg_28_0)
	...
	if arg_28_0.IndexofStory(var_28_3, arg_28_0.explorablePos) == 15 and arg_28_0:IndexofStory(arg_28_0.explorablePos) > arg_28_0:IndexofStory(arg_28_0.currentPos) then
		setActive = var_28_3

		var_28_3(arg_28_0.button1F, true)
	end

	setActive = var_28_3

	var_28_3(arg_28_0.buttonDice, not arg_28_0:IsFinish())
...
function var_0_1.UpdateDice(arg_29_0)
	...
	var_1(var_29_0, var_3("roll_times_left", arg_29_0.diceCount))
	...
	if arg_29_0.explorablePos == arg_29_0.currentPos and arg_29_0.diceCount > 0 then
		...
		local var_29_3 = var_29_2(var_29_1, var_3(var_4))
		...
		local var_29_6 = var_29_5(var_29_4, var_3(var_4))
...
function var_0_1.UpdateMap(arg_30_0)
	...
	for iter_30_1, iter_30_2 in var_1(arg_30_0.exploredStories) do
		...
		local var_30_2 = arg_30_0.GetRoomTF(var_30_1, var_30_0)

		setText = var_30_1
		findTF = var_9

		local var_30_3 = var_9(var_30_2, "name")

		i18n = var_10

		var_30_1(var_30_3, var_10("roll_room" .. var_30_0))
	end

	setActive = var_1
	findTF = var_2

	var_1(var_2(arg_30_0.main, "finish_mask"), false)

	local var_30_4 = arg_30_0

	if arg_30_0.IsFinish(var_30_4) then
		setActive = var_1
		findTF = var_30_4

		var_1(var_30_4(arg_30_0.main, "finish_mask"), true)
	...
	for iter_30_3, iter_30_4 in var_1(arg_30_0.exploredStories) do
		local var_30_5 = arg_30_0.story2Map[iter_30_4]

		if arg_30_0:IsBadEnd(iter_30_4) then
			if var_30_5 ~= 17 then
				if var_30_5 ~= 4 then
					arg_30_0:ChangeRoomColor(var_30_5, var_0_1.BAD_FILL_COLOR)
				end

				arg_30_0:ChangeRoomMark(var_30_5, var_0_1.MARK_BAD)
			end
		else
			arg_30_0:ChangeRoomColor(var_30_5, var_0_1.NORMAL_FILL_COLOR)
		end
	end
	...
	for iter_30_5, iter_30_6 in var_1(arg_30_0.explorableStories) do
		local var_30_6 = arg_30_0.story2Map[iter_30_6]

		arg_30_0:ChangeRoomMark(var_30_6, var_0_1.MARK_EXPLORABLE)
		arg_30_0:ChangeRoomMark(var_30_6, var_0_1.MARK_UNEXPLORED, true)
	end

	local var_30_7 = #arg_30_0.exploredStories
	...
	if 0 < var_30_7 then
		...
		arg_30_0:ChangeRoomMark(arg_30_0.story2Map[var_30_7], var_0_1.MARK_CURRENT, true)
	end

	setActive = var_30_7

	local var_30_8 = arg_30_0.button1F
	local var_30_9 = var_2.Find(var_30_8, "Image")

	table = var_30_8

	var_30_7(var_30_9, var_30_8.contains(arg_30_0.explorableStories, arg_30_0.storyGroup[24]))

	setActive = var_30_7

	local var_30_10 = arg_30_0.button2F
	local var_30_11 = var_2.Find(var_30_10, "Image")

	table = var_30_10

	var_30_7(var_30_11, var_30_10.contains(arg_30_0.explorableStories, arg_30_0.storyGroup[23]))
...
function var_0_1.UpdateAward(arg_31_0)
	...
	local var_31_4 = var_31_2(var_31_1, var_3.getConfig(var_31_3, "config_client")[1][3])
...
function var_0_1.UpdateCharacter(arg_33_0)
	...
	local var_33_4 = var_33_3(var_33_2, var_3(var_33_1))
	...
	var_33_4(var_2.Find(var_33_5, "edit"), arg_33_0:IsFinish())
...
function var_0_1.UpdateTask(arg_34_0, arg_34_1, arg_34_2)
	...
	var_34_3(var_34_4, "without this task by id: " .. var_34_2)

	setText = var_34_3

	local var_34_5 = arg_34_2
	local var_34_6 = arg_34_2.Find(var_34_5, "title")

	i18n = var_34_5

	var_34_3(var_34_6, var_34_5("roll_reward_word" .. var_34_0))

	local var_34_7 = var_34_4:getConfig("award_display")[1]
	local var_34_8 = {
		type = var_34_7[1],
		id = var_34_7[2],
		count = var_34_7[3]
	...
	var_9(var_34_1, var_34_8)

	onButton = var_9

	local var_34_9 = arg_34_0
	local var_34_10 = var_34_1
	...
	local function var_34_11()
		...
		var_35_1(var_35_0, var_2_10002.ON_DROP, var_34_8)
	...
	var_9(var_34_9, var_34_10, var_34_11, var_1_10013)

	local var_34_12 = var_34_4:getProgress()
	local var_34_13 = var_34_4
	local var_34_14 = var_34_4.getConfig(var_34_13, "target_num")

	setText = var_34_13

	local var_34_15 = arg_34_2
	local var_34_16 = arg_34_2.Find(var_34_15, "progress")

	i18n = var_34_15

	var_34_13(var_34_16, var_34_15("roll_reward_tip", var_34_12, var_34_14))

	setText = var_34_13

	local var_34_17 = arg_34_2
	local var_34_18 = arg_34_2.Find(var_34_17, "mask/Text")

	i18n = var_34_17

	var_34_13(var_34_18, var_34_17("roll_reward_got"))

	setActive = var_34_13

	var_34_13(arg_34_2:Find("mask"), var_34_4:isReceive())
...
function var_0_1.UpdateCard(arg_37_0)
	...
	local var_37_1 = var_3(var_4)

	var_1(var_37_0, var_3.getData(var_37_1).name)
	...
	var_1(var_2(arg_37_0.profession, "Text"), var_0_1.GetRollData(2, var_0_3))
	...
	for iter_37_0 = 1, arg_37_0.attrGroup.childCount do
		...
		for iter_37_1 = 1, var_37_3.childCount do
			...
			var_12(var_1_10013(var_37_4, "name"), var_0_1.GetRollData(var_37_5, var_0_2))

			setText = var_12
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_37_4, "Text")
			table = var_14

			local var_37_6

			if not var_14.contains(arg_37_0.attrLock, var_37_5) or not var_0_1.GetRollData(var_37_5, var_0_3) then
				var_37_6 = "---"
			end

			var_12(var_1_10013, var_37_6)

			setActive = var_12
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_37_4, "Text/Image")
			table = var_14

			var_12(var_1_10013, not var_14.contains(arg_37_0.attrLock, var_37_5))
		end
	end

	for iter_37_2 = 1, arg_37_0.skillGroup.childCount do
		local var_37_7 = arg_37_0.skillGroup
		local var_37_8 = var_5.GetChild(var_37_7, iter_37_2 - 1)

		for iter_37_3 = 1, var_37_8.childCount do
			local var_37_9 = var_37_8:GetChild(iter_37_3 - 1)
			local var_37_10 = (iter_37_3 - 1) * arg_37_0.attrGroup.childCount + iter_37_2 + 10

			setText = var_12
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_37_9, "group/skill_name")
			table = var_14

			local var_37_11

			if not var_14.contains(arg_37_0.attrLock, var_37_10) or not var_0_1.GetRollData(var_37_10, var_0_2) then
				var_37_11 = ""
			end

			var_12(var_1_10013, var_37_11)

			setText = var_12
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_37_9, "group/Text")
			table = var_14

			local var_37_12

			if not var_14.contains(arg_37_0.attrLock, var_37_10) or not var_0_1.GetColorValue(var_37_10, var_0_1.GetRollData(var_37_10, var_0_3)) then
				var_37_12 = ""
			end

			var_12(var_1_10013, var_37_12)

			setActive = var_12
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_37_9, "Image")
			table = var_14

			var_12(var_1_10013, not var_14.contains(arg_37_0.attrLock, var_37_10))
		end
	end
...
function var_0_1.RollCharacterCard(arg_38_0)
	for iter_38_0 = 1, arg_38_0.attrGroup.childCount do
		...
		for iter_38_1 = 1, var_38_1.childCount do
			...
			local var_38_5 = var_14(var_38_2, "Text")

			math = var_1_10015

			var_13(var_38_5, var_1_10015.random(var_38_4[1], var_38_4[2]))
		end
	end
	...
	local var_38_7 = var_38_6(var_2("roll_attr_list"), 8)
	local var_38_8 = 1
	...
	for iter_38_2 = 1, arg_38_0.skillGroup.childCount do
		...
		for iter_38_3 = 1, var_38_10.childCount do
			...
			var_14(var_1_10015(var_38_11, "group/skill_name"), var_38_7[var_38_8])

			var_38_8 = var_38_8 + 1
			setText = var_14
			findTF = var_1_10015

			var_14(var_1_10015(var_38_11, "group/Text"), var_0_1.GetColorValue(var_38_12, var_0_1.GetRandomValue(var_0_1.GetRollData(var_38_12, var_0_4), 1)[1]))
		end
	end
...
function var_0_1.GetColorValue(arg_41_0, arg_41_1)
	...
	local var_41_1 = var_3.indexof(var_41_0, arg_41_1)
...
function var_0_1.CheckAwardGet(arg_42_0)
	...
	var_2(var_3(arg_42_0.buttonAward, "red"), var_42_0)
...
function var_0_1.PlayStory(arg_43_0, arg_43_1)
	...
	CastleMainMediator = var_4

	var_43_1(var_43_0, var_4.CASTLE_ACT_OP, {
		cmd = 2,
		id = var_0_1.ACT_ID,
		arg1 = arg_43_1
	})
...
function var_0_1.StoryActEnd(arg_44_0, arg_44_1)
	...
	playStory = var_1_10005

	var_1_10005(var_44_1, function()
		if var_44_3() then
			...
			for iter_46_0, iter_46_1 in var_0(arg_44_0.story2Attr[arg_44_0.waitPlayStory]) do
				if iter_46_1 < 11 then
					...
					var_46_6(var_10(var_46_7, "Text"), var_0_1.GetRollData(iter_46_1, var_0_3))

					findTF = var_46_6

					local var_46_8 = var_46_6(var_46_7, "Text/Image")
					local var_46_9 = var_9.GetComponent

					typeof = var_11
					Animation = var_12

					local var_46_10 = var_46_9(var_46_8, var_11(var_12))

					var_9.Play(var_46_10, "anim_castle_skill")
				else
					local var_46_11 = iter_46_1 - 11

					math = var_2_10006
					var_2_10006 = var_2_10006.floor(var_46_11 / arg_44_0.skillGroup.childCount)

					local var_46_12 = var_46_11 % arg_44_0.skillGroup.childCount
					local var_46_13 = arg_44_0.skillGroup
					local var_46_14 = var_8.GetChild(var_46_13, var_46_12)
					local var_46_15 = var_8.GetChild(var_46_14, var_2_10006)

					setText = var_46_14
					findTF = var_10

					var_46_14(var_10(var_46_15, "group/skill_name"), var_0_1.GetRollData(iter_46_1, var_0_2))

					setText = var_46_14
					findTF = var_10

					var_46_14(var_10(var_46_15, "group/Text"), var_0_1.GetColorValue(iter_46_1, var_0_1.GetRollData(iter_46_1, var_0_3)))

					findTF = var_46_14

					local var_46_16 = var_46_14(var_46_15, "Image")
					local var_46_17 = var_9.GetComponent

					typeof = var_11
					Animation = var_12

					local var_46_18 = var_46_17(var_46_16, var_11(var_12))

					var_9.Play(var_46_18, "anim_castle_skill")
				end
			end

			local var_46_19 = arg_44_0

			var_0.ExploreStory(var_46_19, arg_44_0.waitPlayStory)

			local var_46_20 = arg_44_0

			var_0.UnlockStory(var_46_20, arg_44_1)

			local var_46_21 = arg_44_0

			var_0.UpdateAttrLock(var_46_21)
		else
			local var_46_22 = arg_44_0

			var_0.ExploreStory(var_46_22, arg_44_0.waitPlayStory)

			local var_46_23 = arg_44_0

			var_0.UnlockStory(var_46_23, arg_44_1)

			local var_46_24 = arg_44_0

			var_0.UpdateAttrLock(var_46_24)

			local var_46_25 = arg_44_0

			var_0.UpdateFlush(var_46_25)

			local var_46_26 = arg_44_0

			var_0.CheckGuide(var_46_26)
		end
...
function var_0_1.FirstStory(arg_47_0)
	...
	var_4(var_47_3, function()
		...
		local var_48_5 = var_2_10004.ON_AWARD
		local var_48_6 = {
			items = {
				var_48_1
			}
		...
		var_48_6.title = var_6.TITLE.ITEM
...
function var_0_1.RollDice(arg_50_0, arg_50_1, arg_50_2)
	...
	arg_50_0:SetAnim(arg_50_0.dices[2], var_50_1, function()
		...
		local var_51_1 = var_2_10001(arg_50_0._tf)
		local var_51_2 = 0.12

		System = var_2_10003

		var_51_0(var_51_1, var_51_2, var_2_10003.Action(function()
			...
			local var_52_1 = var_1(arg_50_0._tf)
			local var_52_2 = 0.495

			System = var_3_10003

			var_52_0(var_52_1, var_52_2, var_3_10003.Action(function()
...
function var_0_1.SetAnim(arg_54_0, arg_54_1, arg_54_2, arg_54_3)
	...
	local var_54_2 = var_54_1(var_54_0, var_1_10006(var_1_10007))
...
function var_0_1.ExplorableEffect(arg_61_0, arg_61_1)
	for iter_61_0 = 1, var_0_1.ROOM_NUM do
		...
		local var_61_1 = arg_61_0.GetRoomTF(var_61_0, iter_61_0)

		setActive = var_61_0
		findTF = var_8

		var_61_0(var_8(var_61_1, "explorable/glow"), arg_61_1)

		setActive = var_61_0
		findTF = var_8

		var_61_0(var_8(var_61_1, "explorable/glow1"), arg_61_1)
	end
...
function var_0_1.ChangeRoomColor(arg_62_0, arg_62_1, arg_62_2)
	...
	local var_62_2 = var_62_0(var_62_1, "fill")

	if arg_62_2 then
		setImageColor = var_5

		var_5(var_62_2, arg_62_2)
	end
...
function var_0_1.ChangeRoomMark(arg_63_0, arg_63_1, arg_63_2, arg_63_3)
	...
	local var_63_4 = var_63_2(var_63_3, "current")

	findTF = var_6

	local var_63_5 = var_6(var_63_3, "unexplored")
...
function var_0_1.CheckGuide(arg_65_0)
	...
	local var_65_3 = var_4.StoryId2StoryName
	local var_65_4 = arg_65_0.activity

	var_65_1[2] = var_65_3(var_65_2, var_6.getConfig(var_65_4, "config_client")[1][1])
	...
	local var_65_7 = var_4.StoryId2StoryName
	local var_65_8 = arg_65_0.activity

	var_65_5[2] = var_65_7(var_65_6, var_6.getConfig(var_65_8, "config_client")[1][2])
	...
	local var_65_11 = var_4.StoryId2StoryName
	local var_65_12 = arg_65_0.activity

	var_65_9[2] = var_65_11(var_65_10, var_6.getConfig(var_65_12, "config_client")[1][3])
	var_65_9[3] = function(arg_71_0)
		getProxy = var_2_10001
		TaskProxy = var_2_10002

		local var_71_0 = var_2_10001(var_2_10002)
	...
	for iter_65_0, iter_65_1 in var_1_10001(var_65_0) do
		...
		local var_65_13, var_65_14, var_65_15 = var_65_13(iter_65_1)

		if not arg_65_0:IsPlayed(var_65_14) and var_65_15(arg_65_0) then
			if var_65_13 == "guide" then
				pg = var_9

				local var_65_16 = var_9.NewGuideMgr.GetInstance()

				var_9.Play(var_65_16, var_65_14, nil, function()
					local var_72_0 = arg_65_0
					local var_72_1 = var_0.emit

					CastleMainMediator = var_2_10002

					var_72_1(var_72_0, var_2_10002.UPDATE_GUIDE, var_65_14)

					return
				end)
			elseif var_65_13 == "story" then
				playStory = var_9
