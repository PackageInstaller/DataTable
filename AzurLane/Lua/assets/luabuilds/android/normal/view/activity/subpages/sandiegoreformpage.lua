...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local var_3_3 = var_1_10005.reduce

	_ = var_1_10006

	var_3_0(var_3_2, var_3_3(var_1_10006.slice(var_3_1, 1, var_1.data2), 0, function(arg_4_0, arg_4_1)
		return arg_4_0 + arg_4_1
	end))

	setActive = var_3_0

	var_3_0(arg_3_0.getSign, var_1.data1 == 1)

	local var_3_4 = var_1:getConfig("config_data")[4]
	local var_3_5 = arg_3_0.progress
	...
	math = var_6
	var_3_5.sizeDelta = var_3_6(10 + 90 * var_6.max(var_1.data2 - 1, 0), arg_3_0.progress.sizeDelta.y)
	Color = var_3_5

	local var_3_7 = var_3_5.New(1, 0.83, 0.15)

	Color = var_5

	local var_3_8 = var_5.New(0.59, 0.62, 0.69)

	for iter_3_0 = 1, 7 do
		local var_3_9 = arg_3_0.days

		var_1_10010 = var_1_10010.Find(var_3_9, iter_3_0)
		setTextColor = var_3_9

		var_3_9(var_1_10010, iter_3_0 <= var_1.data2 and var_3_7 or var_3_8)
	end

	onButton = var_6

	local var_3_10 = arg_3_0
	local var_3_11 = arg_3_0.gameBtn
	...
	local function var_3_12()
		...
		var_5_1(var_5_0, var_5_2, var_2_10003.LINK_LINK)
	...
	var_6(var_3_10, var_3_11, var_3_12, var_1_10010)

	onButton = var_6

	local var_3_13 = arg_3_0
	local var_3_14 = arg_3_0.helpBtn
	...
	local function var_3_15()
		...
		i18n = var_2_10003
		var_6_2.helps = var_2_10003("link_link_help_tip")
	...
	var_6(var_3_13, var_3_14, var_3_15, var_1_10010)
