...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_2()
		...
		if not var_4_1(var_4_0, var_2_10002.ACTIVITY_U110_BATTLE_LEVEL) or var_0:isEnd() then
			pg = var_4_0
	...
	var_1_10001(arg_3_0, arg_3_0.buildBtn, function()
		...
		if not var_6_1(var_6_0, var_2_10002.ACTIVITY_U110_BUILD) or var_0:isEnd() then
			pg = var_6_0
			...
			var_6_3(var_6_2, var_2_10003("challenge_end_tip"))
		...
		local var_6_6 = var_2_10003.EVENT_GO_SCENE

		SCENE = var_2_10004

		local var_6_7 = var_2_10004.GETBOAT
		local var_6_8 = {}

		BuildShipScene = var_2_10006
		var_6_8.projectName = var_2_10006.PROJECTS.SPECIAL
