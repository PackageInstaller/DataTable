...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	if not var_2.getActivityById(var_6_2, var_6_1) or var_2:isEnd() then
		...
		local var_6_7 = var_5.CanGetMorePt(var_1_10006)

		setActive = var_1_10006

		local var_6_8 = arg_6_0.goBtn

		var_1_10008 = var_6_7 and not var_6_4 and var_6_6

		var_1_10006(var_6_8, var_1_10008)
		...
		var_1_10006(arg_6_0.gotBtn, not var_6_6)

		setActive = var_1_10006

		var_1_10006(arg_6_0.gotTag, not var_6_6)
	end
	...
	var_1_10006(var_6_13, var_1_10008(var_6_10, "#487CFFFF") .. "/" .. var_6_11)
