...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Text = var_2_4
	arg_2_0.currentTxt = var_2_8(var_2_7, var_3(var_2_4))
	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "window/top/bg/infomation")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("world_expedition_reward_display"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_2.Find(var_2_11, "window/pt/title")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("activityboss_sp_window_best_score"))

	setText = var_1

	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_2.Find(var_2_13, "window/panel/list/item/target/title")

	i18n = var_2_13

	var_1(var_2_14, var_2_13("activityboss_sp_score_target"))
...
function var_0_1.UpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	local function var_8_6()
		...
		var_9_1(var_9_0, var_2_10002.ON_DROP, var_8_3)
