...
local var_0_0 = "SecretsAbyssMainPage"
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.Manual, function()
		...
		MassenaMedalAlbumView = var_2_10002
...
function var_0_1.skinCommdityTimeStamps(arg_10_0, arg_10_1)
	...
	if 0 < var_10_3 then
		...
		if 0 < var_10_4 then
			...
			return var_10_5 .. var_1_10007("word_hour")
		else
			math = var_10_5

			if var_10_5.floor(var_10_2 / 60) > 0 then
				local var_10_6 = var_6

				i18n = var_1_10008

				return var_10_6 .. var_1_10008("word_minute")
			else
				local var_10_7 = var_10_2

				i18n = var_1_10008

				return var_10_7 .. var_1_10008("word_second")
			end
		end
	end
