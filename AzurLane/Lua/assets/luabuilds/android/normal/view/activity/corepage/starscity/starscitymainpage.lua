...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	type = var_2_0
	var_2_1 = var_2_0(var_2_1) == "table" and var_2_1 or {}
	...
	local function var_2_5()
		...
		local var_4_4 = var_2_10002.EVENT_GO_SCENE

		SCENE = var_2_10003

		local var_4_5 = var_2_10003.GETBOAT
		local var_4_6 = {}

		BuildShipScene = var_2_10005
		var_4_6.page = var_2_10005.PAGE_BUILD
		BuildShipScene = var_5
		var_4_6.projectName = var_5.PROJECTS.ACTIVITY
	...
	var_3(var_2_3, var_2_4, var_2_5, var_1_10007)
	...
	local function var_2_8()
		...
		if var_0 then
			...
			var_5_3(var_5_2, var_2_10003.SKIP_ACTIVITY_MAP, var_0)
		else
			...
			var_5_5(var_5_4, var_2_10003.BATTLE_OPERA)
		end
	...
	var_3(var_2_6, var_2_7, var_2_8, var_1_10007)
	...
	local function var_2_11()
		...
		if var_0 then
			...
			ActivityMediator = var_2_10003
			var_2_10003 = var_2_10003.GO_SHOPS_LAYER

			local var_6_4 = {}

			NewShopsScene = var_2_10005
			var_6_4.warp = var_2_10005.TYPE_ACTIVITY
			var_6_4.actId = var_0

			var_6_3(var_6_2, var_2_10003, var_6_4)
		else
			...
			var_6_6(var_6_5, var_2_10003.GO_CHANGE_SHOP)
		end
	...
	local function var_2_14()
		...
		StarsCityMedalAlbumView = var_2_10002
	...
	var_3(var_2_12, var_2_13, var_2_14, var_1_10007)
	...
	var_3(var_2_15, var_2_13("anniversary_nine_main_page"))
...
function var_0_1.refreshBtnResTime(arg_8_0)
	...
	type = var_8_0
	var_8_1 = var_8_0(var_8_1) == "table" and var_8_1 or {}
	pg = var_2
	...
	;(function(arg_9_0, arg_9_1)
		...
		if arg_9_1 then
			...
			local var_9_0 = var_2_10002(var_2_10003)
			local var_9_1

			if not var_2.getActivityById(var_9_0, arg_9_1) then
				var_9_1 = nil
			end
			...
			if var_9_1 then
				...
				if not var_9_1.isEnd(var_2_10004) then
					local var_9_3

					if var_9_1.stopTime then
						local var_9_2 = var_9_1.stopTime

						if not (var_8_3 < var_9_2) then
							var_9_3 = false
						else
							var_9_3 = true
						end
					...
					if var_9_3 then
						var_2_10004 = var_9_1.stopTime - var_8_3
						math = var_5

						local var_9_4 = var_5.floor(var_2_10004 / 0)

						math = var_6

						local var_9_5 = var_6.floor(var_2_10004 % 0 / 16)
						...
						if 2 <= var_9_5 then
							...
							var_7(var_9_6, var_9("StarsCityMainPage_res_day_time", var_9_4, var_9_5))
						else
							setText = var_7
							...
							var_7(var_9_7, var_9("StarsCityMainPage_no_time"))
						end
					else
...
function var_0_1.GetFujinBayMedalTaskCount()
	...
	for iter_15_0, iter_15_1 in var_1_10004(var_15_1) do
		...
		if var_1_10010.getActivityById(var_1_10011, var_15_3) and not var_1_10010:isEnd() then
