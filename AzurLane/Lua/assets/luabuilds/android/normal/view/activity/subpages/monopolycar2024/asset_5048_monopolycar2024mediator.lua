...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_TRIGGER, function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_4 = var_2_10007.MONOPOLY_OP
		local var_2_5 = {
			activity_id = arg_2_1
		}

		ActivityConst = var_2_10009
		var_2_5.cmd = var_2_10009.MONOPOLY_OP_TRIGGER
	...
	arg_1_0:bind(var_0_1.ON_AUTO, function(arg_3_0, arg_3_1)
		...
		local var_3_4 = var_2_10006.MONOPOLY_OP
		local var_3_5 = {
			activity_id = arg_3_1,
			autoFlag = var_3_0,
		...
		var_3_5.cmd = var_2_10008.MONOPOLY_OP_AUTO
	...
	arg_1_0:bind(var_0_1.ON_PICK, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		...
		local var_4_4 = var_2_10008.MONOPOLY_OP
		local var_4_5 = {
			activity_id = arg_4_1,
			arg1 = arg_4_2,
			autoFlag = var_4_0,
		...
		var_4_5.cmd = var_2_10010.MONOPOLY_OP_PICK
	...
	arg_1_0:bind(var_0_1.ON_START, function(arg_5_0, arg_5_1, arg_5_2)
		...
		local var_5_4 = var_2_10007.MONOPOLY_OP
		local var_5_5 = {
			activity_id = arg_5_1,
			autoFlag = var_5_0,
		...
		ActivityConst = var_2_10009
		var_5_5.cmd = var_2_10009.MONOPOLY_OP_THROW
	...
	arg_1_0:bind(var_0_1.ON_MOVE, function(arg_6_0, arg_6_1, arg_6_2)
		...
		local var_6_4 = var_2_10007.MONOPOLY_OP
		local var_6_5 = {
			activity_id = arg_6_1,
			autoFlag = var_6_0,
		...
		ActivityConst = var_2_10009
		var_6_5.cmd = var_2_10009.MONOPOLY_OP_MOVE
	...
	arg_1_0:bind(var_0_1.ON_DIALOGUE, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_4 = var_2_10007.MONOPOLY_OP
		local var_7_5 = {
			activity_id = arg_7_1,
			autoFlag = var_7_0,
		...
		ActivityConst = var_2_10009
		var_7_5.cmd = var_2_10009.MONOPOLY_OP_DIALOGUE
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.ACTIVITY_UPDATED then
		...
		if var_9_4 == var_9_3.ACTIVITY_TYPE_MONOPOLY then
			local var_9_5 = arg_9_0.viewComponent

			var_9_4.UpdateGame(var_9_5, var_9_2)
		end
	else
		GAME = var_9_4

		if var_9_0 == var_9_4.STORY_UPDATE_DONE then
			...
			var_9_8(var_9_7, var_1_10006.ON_ACHIEVE, var_9_2.awards, function()
				return
			end)
		end
	end
