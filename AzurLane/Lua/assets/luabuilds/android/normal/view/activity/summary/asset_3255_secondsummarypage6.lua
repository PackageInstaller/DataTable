...
function var_0_1.OnInit(arg_1_0)
	...
	var_2(var_3.Find(var_1_2, "skin_panel"), var_1_1)

	setActive = var_2

	local var_1_3 = arg_1_0._tf

	var_2(var_3.Find(var_1_3, "un_panel"), not var_1_1)
	...
	if var_1_1 then
		...
		var_1_5(var_1_6:Find("paint_panel/painting"), var_1_4, "chuanwu")

		setText = var_1_5

		var_1_5(var_1_6:Find("window_7/count/Text"), arg_1_0.summaryInfoVO.skinNum)

		setText = var_1_5

		var_1_5(var_1_6:Find("window_7/ship/Text"), arg_1_0.summaryInfoVO.skinShipNum)
	end
...
function var_0_1.Show(arg_2_0, arg_2_1)
	...
	var_2_0(var_2_1, var_2_2, var_5.Find(var_2_3, arg_2_0.summaryInfoVO.skinId > 0 and "skin_panel" or "un_panel"))
