...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".FullPreviewSceneTemplate"))
...
function var_0_1.init(arg_2_0)
	...
	local var_2_3 = var_3.Find(var_2_2, "top/info/Text")

	i18n = var_2_2

	var_2(var_2_3, var_2_2("dreamland_main_desc"))
	...
	local var_2_6 = var_2_5(var_2_4, var_4.ACTIVITY_TYPE_DREAMLAND)
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.dreamland_main_tip.tip
	...
	local function var_3_14()
		if arg_3_0.isFinishPre then
			...
			FullPreviewMediatorTemplate = var_2_10002
			var_2_10002 = var_2_10002.GO_SCENE
			SCENE = var_2_10003

			var_7_1(var_7_0, var_2_10002, var_2_10003.DREAMLAND)
		else
			...
			local var_7_4 = var_2_10002.GO_SCENE

			SCENE = var_2_10003

			var_7_3(var_7_2, var_7_4, var_2_10003.ACTIVITY, {
				id = arg_3_0.preActId
			})
		end
...
function var_0_1.UpdateView(arg_9_0)
	...
	var_1_10001(var_2.Find(var_9_0, "tip"), var_0_1.MiniGameTip())

	setActive = var_1_10001

	local var_9_1 = arg_9_0.dreamlandBtn

	var_1_10001(var_2.Find(var_9_1, "dreamland/tip"), var_0_1.DreamlandTip())
	...
	var_1(var_2.Find(var_9_2, "dreamland"), arg_9_0.isFinishPre)

	setActive = var_1

	local var_9_3 = arg_9_0.dreamlandBtn

	var_1(var_2.Find(var_9_3, "pre_act"), not arg_9_0.isFinishPre)

	getProxy = var_1
	ActivityProxy = var_2

	local var_9_4 = var_1(var_2)
	...
	var_9_4(var_3.Find(var_9_6, "pre_act/tip"), var_0_1.ActivityTip(var_9_5))
...
function var_0_1.DreamlandTip()
	...
	local var_11_2 = var_11_1(var_11_0, var_1_10002.ACTIVITY_TYPE_DREAMLAND)

	getProxy = var_11_0
	ActivityProxy = var_2

	local var_11_3 = var_11_0(var_2)
	local var_11_4 = var_1.getActivityByType

	ActivityConst = var_1_10003

	local var_11_5 = var_11_4(var_11_3, var_1_10003.ACTIVITY_TYPE_HOTSPRING_2)

	DreamlandData = var_11_3

	local var_11_6 = var_11_3.New(var_11_2, var_11_5)
...
function var_0_1.ActivityTip(arg_12_0)
	if arg_12_0 then
		var_1_10002 = arg_12_0

		if arg_12_0.isEnd(var_1_10002) then
			return false
		end
		...
		local var_12_1 = var_1_10002.flatten(arg_12_0:getConfig("config_data"))[arg_12_0.data3]
		local var_12_2 = var_12_0
		local var_12_3

		if not var_12_0.getTaskById(var_12_2, var_12_1) then
			var_12_2 = var_12_0
			var_12_3 = var_12_0.getFinishTaskById(var_12_2, var_12_1)
		end

		math = var_12_2

		local var_12_4 = var_12_2.min(arg_12_0:getDayIndex(), #var_2) - var_3

		if var_12_3:getTaskStatus() == 1 then
			var_12_4 = var_12_4 + 1
		end
