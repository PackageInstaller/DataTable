...
Vector2 = var_2
var_0_2[1] = var_2.New(121.6, 121.6)
Vector2 = var_2
...
function var_0_1.init(arg_3_0)
	...
	local var_3_28 = var_2.Find(var_3_27, "title/Text1")

	i18n = var_3_27

	var_1(var_3_28, var_3_27("LiquorFloor_title"))

	setText = var_1

	local var_3_29 = arg_3_0.top
	local var_3_30 = var_2.Find(var_3_29, "title/Text2")

	i18n = var_3_29

	var_1(var_3_30, var_3_29("LiquorFloor_title_en"))

	setText = var_1

	local var_3_31 = arg_3_0.ui
	local var_3_32 = var_2.Find(var_3_31, "decorate/decorate1_1/storyBtn/Text")

	i18n = var_3_31

	var_1(var_3_32, var_3_31("LiquorFloor_story_title"))

	setText = var_1

	local var_3_33 = arg_3_0.ui
	local var_3_34 = var_2.Find(var_3_33, "decorate/decorate1_1/decorate1_2/taskBtn/Text")

	i18n = var_3_33

	var_1(var_3_34, var_3_33("LiquorFloorTaskUI_title"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_2()
		...
		LiquorFloorMapMediator = var_2_10002

		var_6_1(var_6_0, var_2_10002.GO_FIGHT)
	...
	local function var_5_5()
		...
		LiquorFloorTaskMediator = var_2_10005
		var_7_4.mediator = var_2_10005
		LiquorFloorTaskScene = var_2_10005
	...
	local function var_5_8()
		...
		var_8_1(var_8_0, var_2_10002.OPEN_CLUE_BOOK)
	...
	var_1(var_5_12, var_5_13, var_5_14, var_1_10005)
	...
	var_1(var_5_15, var_5_16, var_5_17, var_1_10005)

	onButton = var_1

	local var_5_18 = arg_5_0
	local var_5_19 = arg_5_0.top
	local var_5_20 = var_3.Find(var_5_19, "help")
	...
	local function var_5_21()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip.LiquorFloor_tip.tip
	...
	var_1(var_5_18, var_5_20, var_5_21, var_5)

	setText = var_1

	local var_5_22 = arg_5_0.ui
	local var_5_23 = var_2.Find(var_5_22, "Allgold/Text")

	i18n = var_5_22

	var_1(var_5_23, var_5_22("LiquorFloor_gold_get"))

	onButton = var_1

	local var_5_24 = arg_5_0
	local var_5_25 = arg_5_0.ui
	local var_5_26 = var_3.Find(var_5_25, "Allgold")
	...
	local function var_5_27()
		...
		if var_0.HasMaxGold(var_13_0) then
			...
			var_13_3 = {}
			i18n = var_2_10003
			var_13_3.content = var_2_10003("LiquorFloor_gold_max_tip")
	...
	var_1(var_5_24, var_5_26, var_5_27, var_5)
...
function var_0_1.OnStory(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10001(arg_15_0.gather1) do
		...
		if var_15_0 <= var_8.GetTownLevel(var_15_1) then
			...
			if not var_7.IsPlayed(var_15_2, var_6.luaID) then
				...
				local var_15_3 = var_15_2.NewStoryMgr.GetInstance()
	...
	for iter_15_2, iter_15_3 in var_15_4(arg_15_0.gather2) do
		...
		if var_15_6 <= var_9.GetLevel(var_15_7) then
			...
			if not var_8.IsPlayed(var_15_8, var_7.luaID) then
				...
				local var_15_9 = var_15_8.NewStoryMgr.GetInstance()
	...
	for iter_15_4, iter_15_5 in var_2(arg_15_0.gather3) do
		...
		if var_15_10 <= var_9.GetLevel(var_15_11) then
			...
			if not var_8.IsPlayed(var_15_12, var_7.luaID) then
				...
				local var_15_13 = var_15_12.NewStoryMgr.GetInstance()
...
function var_0_1.UpdateBubbles(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1(arg_23_0.shipIds) do
		...
		if 0 < iter_23_1 then
			...
			local var_23_2 = var_7(var_23_2)
			local var_23_4

			if var_7.RawGetShipById(var_23_2, iter_23_1) then
				var_23_2 = arg_23_0.activity

				local var_23_3 = var_7.GetBubbleCntByPos(var_23_2, iter_23_0)

				if not (0 < var_23_3) then
					var_23_4 = false
				else
					var_23_4 = true
				end
			...
			if var_23_4 then
				...
				var_23_2.insert(arg_23_0.bubblesPosList, iter_23_0)
...
function var_0_1.UpdateShip(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if 0 < arg_24_3 then
		...
		local var_24_0 = var_4(var_1_10005)
	...
	local var_24_7 = arg_24_1:Find("icon")
	...
	local function var_24_8()
		...
		if var_0.HasMaxGold(var_25_0) then
			...
			var_2_10002 = {}
			i18n = var_2_10003
			var_2_10002.content = var_2_10003("LiquorFloor_gold_max_tip")

			function var_2_10002.onYes()
				local var_26_0 = arg_24_0
				local var_26_1 = var_0.emit

				LiquorFloorMapMediator = var_3_10002
	...
	var_8(var_24_6, var_24_7, var_24_8, var_12)
...
function var_0_1.InitData(arg_30_0)
	...
	local var_30_6 = var_4.Find(var_30_5, "Allgold/tip")

	LiquorFloorMapScene = var_30_5

	var_30_3(var_30_6, var_30_5.GetLiquorFloorMapTip())
...
function var_0_1.UpdatePlace(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	if var_4.GetType(var_33_2) == 1 then
		...
		local var_33_4 = var_33_3[var_1_10006]

		var_33_6(var_5.Find(var_33_4, "tip"), false)
		...
		local var_33_7 = arg_33_3[var_33_5]

		if not (var_33_6 < var_5.GetTypeParam(var_33_7) * 7200) then
			i = var_33_6

			local var_33_8 = arg_33_3[var_33_6]

			if var_33_6.GetTypeParam(var_33_8) == 0 then
				setImageSprite = var_33_6

				local var_33_9 = arg_33_0.architectureData

				i = var_33_7

				local var_33_10 = var_33_9[var_33_7]
				local var_33_11 = var_5.Find(var_33_10, "numbg/icon1")

				LoadSprite = var_33_10

				var_33_6(var_33_11, var_33_10("ui/LiquorFloorUI_atlas", "settleGold_1"), true)
			else
				i = var_33_6
				...
				local var_33_13 = arg_33_3[var_33_12]

				if var_33_6 > var_5.GetTypeParam(var_33_13) * 7200 then
					i = var_33_6

					local var_33_14 = arg_33_3[var_33_6]

					var_33_6 = var_33_6.OnStartTime(var_33_14)
					i = var_33_14

					local var_33_15 = arg_33_3[var_33_14]

					if var_33_6 < var_5.GetTypeParam(var_33_15) * 14400 then
						setImageSprite = var_33_6

						local var_33_16 = arg_33_0.architectureData

						i = var_33_15

						local var_33_17 = var_33_16[var_33_15]
						local var_33_18 = var_5.Find(var_33_17, "numbg/icon1")

						LoadSprite = var_33_17

						var_33_6(var_33_18, var_33_17("ui/LiquorFloorUI_atlas", "settleGold_2"), true)
				...
				local var_33_19 = arg_33_3[var_33_6]

				var_33_6 = var_33_6.OnStartTime(var_33_19)
				i = var_33_19

				local var_33_20 = arg_33_3[var_33_19]

				if var_33_6 > var_5.GetTypeParam(var_33_20) * 14400 then
					SetActive = var_33_6

					local var_33_21 = arg_33_0.architectureData

					i = var_33_20

					local var_33_22 = var_33_21[var_33_20]

					var_33_6(var_5.Find(var_33_22, "tip"), true)

					setImageSprite = var_33_6

					local var_33_23 = arg_33_0.architectureData

					i = var_6

					local var_33_24 = var_33_23[var_6]
					local var_33_25 = var_5.Find(var_33_24, "numbg/icon1")

					LoadSprite = var_33_24

					var_33_6(var_33_25, var_33_24("ui/LiquorFloorUI_atlas", "settleGold_3"), true)
				end
			end
			...
			local var_33_26 = arg_33_3[var_33_6]

			if var_4.OnStartTime(var_33_26) <= 0 then
				setText = var_4
				...
				local var_33_27 = arg_33_2
				local var_33_28 = arg_33_2.Find(var_33_27, "numbg/Text")

				TownActivity2 = var_33_27

				local var_33_29 = var_33_27.GoldToShow

				i = var_7

				local var_33_30 = arg_33_3[var_7]

				var_4(var_33_28, var_33_29(var_7.OnStartTime(var_33_30)))
			end
...
function var_0_1.AchitectureMessage(arg_34_0, arg_34_1)
	for iter_34_0 = 1, #arg_34_1 do
		...
		local var_34_1 = var_7.Find(var_34_0, "lv")
		local var_34_2 = arg_34_1[iter_34_0]

		var_1_10006(var_34_1, var_8.GetLevel(var_34_2))

		setText = var_1_10006

		local var_34_3 = arg_34_0.architectureData[iter_34_0]
		local var_34_4 = var_7.Find(var_34_3, "name")
		local var_34_5 = arg_34_1[iter_34_0]

		var_1_10006(var_34_4, var_8.GetName(var_34_5))
		...
		if var_1_10006.GetType(var_34_6) == 1 then
			...
			if var_1_10006.GetLevel(var_34_7) > 0 then
				...
				var_1_10006(var_7.Find(var_34_8, "numbg"), true)

				onButton = var_1_10006

				local var_34_9 = arg_34_0
				local var_34_10 = arg_34_0.architectureData[iter_34_0]
				local var_34_11 = var_8.Find(var_34_10, "numbg")
				...
				local function var_34_12()
					...
					if var_0.HasMaxGold(var_35_1) then
						...
						local var_35_6 = var_2_10002.ADD_WORKPLACE
						local var_35_7 = arg_34_1[iter_34_0]

						var_35_5(var_35_4, var_35_6, var_3.GetId(var_35_7))
					end
				...
				var_1_10006(var_34_9, var_34_11, var_34_12, var_1_10010)
		...
		do
			local var_34_13 = arg_34_0.architectureData[iter_34_0]

			var_1_10006(var_7.Find(var_34_13, "numbg"), false)
		end
		...
		local var_34_14 = arg_34_0
		local var_34_15 = arg_34_0.architectureData[iter_34_0]
		...
		var_1_10006(var_34_14, var_34_15, var_34_16, var_1_10010)
	end
...
function var_0_1.OnMap(arg_37_0)
	...
	for iter_37_0 = 1, #var_37_1 do
		...
		local var_37_3 = var_6.GetIcon(var_37_2)

		setImageSprite = var_37_2

		local var_37_4 = arg_37_0.architectureMapData[iter_37_0]

		LoadSprite = var_1_10009

		var_37_2(var_37_4, var_1_10009("ui/LiquorFloorUI_atlas", var_37_3))
	end

	local var_37_5 = arg_37_0.activity

	if var_2.TownLevel(var_37_5) >= 0 and var_2 <= 3 then
		setImageSprite = var_3

		local var_37_6 = arg_37_0._tf
		local var_37_7 = var_4.Find(var_37_6, "bgs")

		LoadSprite = var_37_6

		var_3(var_37_7, var_37_6("ui/LiquorFloorUI_atlas", "bg1"), true)
	elseif var_2 > 3 and var_2 <= 7 then
		setImageSprite = var_3

		local var_37_8 = arg_37_0._tf
		local var_37_9 = var_4.Find(var_37_8, "bgs")

		LoadSprite = var_37_8

		var_3(var_37_9, var_37_8("ui/LiquorFloorUI_atlas", "bg2"), true)
	elseif var_2 > 7 and var_2 <= 10 then
		setImageSprite = var_3

		local var_37_10 = arg_37_0._tf
		local var_37_11 = var_4.Find(var_37_10, "bgs")

		LoadSprite = var_37_10

		var_3(var_37_11, var_37_10("ui/LiquorFloorUI_atlas", "bg3"), true)
	end
...
function var_0_1.UpdateGold(arg_38_0)
	...
	local var_38_2 = var_38_0(var_2.GetGold(var_38_1))
	...
	local var_38_6 = var_38_5(var_38_4, var_4(var_1_10005))
	local var_38_7 = var_38_2
	local var_38_8 = "/"

	TownActivity2 = var_1_10005

	local var_38_9 = var_1_10005.GoldToShow
	local var_38_10 = arg_38_0.activity

	var_38_6.text = var_38_7 .. var_38_8 .. var_38_9(var_6.GetLimitGold(var_38_10))
	setText = var_38_6

	local var_38_11 = arg_38_0.top
	local var_38_12 = var_3.Find(var_38_11, "res/gold2/Text")
	local var_38_13 = " "

	TownActivity2 = var_5

	local var_38_14 = var_5.GoldToShow
	local var_38_15 = arg_38_0.activity

	var_38_6(var_38_12, var_38_13 .. var_38_14(var_6.GetGold2(var_38_15)))
...
function var_0_1.OnLV(arg_39_0)
	...
	if #arg_39_0.activity.listLVList2 + 1 <= var_39_1 then
		...
		var_39_5(var_3.Find(var_39_2, "Slider"), 1)

		SetActive = var_39_5

		local var_39_3 = arg_39_0.lv

		var_39_5(var_3.Find(var_39_3, "num_bg"), false)
	else
		setFillAmount = var_39_5

		local var_39_4 = arg_39_0.lv

		var_39_5(var_3.Find(var_39_4, "Slider"), var_39_1 / arg_39_0.activity.listLVList[var_39_1])
		...
		local var_39_9 = var_4.Find(var_39_8, "num_bg/num")

		TownActivity2 = var_39_8

		local var_39_10 = var_39_8.GoldToShow(var_39_5)
		local var_39_11 = "/"

		TownActivity2 = var_1_10007

		var_3(var_39_9, var_39_10 .. var_39_11 .. var_1_10007.GoldToShow(arg_39_0.activity.listLVList[var_39_1]))
	end
	...
	var_39_5(var_3.Find(var_39_12, "Lv_bg/Text"), var_39_1)

	setText = var_39_5

	local var_39_13 = arg_39_0.ui
	local var_39_14 = var_3.Find(var_39_13, "LV/lvbtn/Text")

	i18n = var_39_13

	var_39_5(var_39_14, var_39_13("LiquorFloor_level"))
...
function var_0_1.OnUpgradeMoveLV(arg_40_0)
	...
	var_40_0(arg_40_0.Text_new, var_40_1)

	SetActive = var_40_0

	var_40_0(arg_40_0.Text_new, true)

	LeanTween = var_40_0

	local var_40_2 = var_40_0.move
	local var_40_3 = arg_40_0.Text_new

	Vector3 = var_4

	local var_40_4 = var_40_2(var_40_3, var_4(0, 0, 0), 1)
	local var_40_5 = var_2.setOnComplete

	System = var_4

	var_40_5(var_40_4, var_4.Action(function()
...
function var_0_1.OnBox(arg_42_0, arg_42_1, arg_42_2, arg_42_3)
	if arg_42_1:GetType() == 1 then
		...
		var_4(var_5.Find(var_42_0, "role_bg"), false)
	elseif arg_42_1:GetType() == 3 then
		SetActive = var_4

		local var_42_1 = arg_42_0.box

		var_4(var_5.Find(var_42_1, "role_bg"), true)
		...
		var_4(var_5.Find(var_42_2, "role_bg"), false)
	end
	...
	var_4(var_5.Find(var_42_3, "box_bg/lv"), arg_42_1:GetLevel())

	setText = var_4

	local var_42_4 = arg_42_0.box

	var_4(var_5.Find(var_42_4, "box_bg/name"), arg_42_1:GetName())

	setText = var_4

	local var_42_5 = arg_42_0.box

	var_4(var_5.Find(var_42_5, "box_bg/describe"), arg_42_1:GetDesc())

	if arg_42_1:GetType() == 1 then
		setText = var_4

		local var_42_6 = arg_42_0.box
		local var_42_7 = var_5.Find(var_42_6, "box_bg/Text")

		i18n = var_42_6

		var_4(var_42_7, var_42_6("LiquorFloor_gold"))
	elseif arg_42_1:GetType() == 2 then
		setText = var_4

		local var_42_8 = arg_42_0.box
		local var_42_9 = var_5.Find(var_42_8, "box_bg/Text")

		i18n = var_42_8

		var_4(var_42_9, var_42_8("LiquorFloor_gold_num"))
	elseif arg_42_1:GetType() == 3 then
		setText = var_4

		local var_42_10 = arg_42_0.box
		local var_42_11 = var_5.Find(var_42_10, "box_bg/Text")

		i18n = var_42_10

		var_4(var_42_11, var_42_10("LiquorFloor_character_num"))
	end

	local var_42_12 = arg_42_3
	local var_42_13 = arg_42_3.GetGoldOutput(var_42_12)

	setText = var_42_12

	local var_42_14 = arg_42_0.box
	local var_42_15 = var_6.Find(var_42_14, "box_bg/num")

	TownActivity2 = var_42_14

	var_42_12(var_42_15, var_42_14.GoldToShow(arg_42_1:GetTypeParam(var_42_13)))

	local var_42_16 = arg_42_0

	if arg_42_0.OnNextArchitecture(var_42_16, arg_42_1:GetId()) == 0 then
		SetActive = var_42_16

		local var_42_17 = arg_42_0.box

		var_42_16(var_7.Find(var_42_17, "box_bg/num_1"), false)

		SetActive = var_42_16

		local var_42_18 = arg_42_0.box

		var_42_16(var_7.Find(var_42_18, "box_bg/decorate2"), false)
	else
		setText = var_42_16

		local var_42_19 = arg_42_0.box
		local var_42_20 = var_7.Find(var_42_19, "box_bg/num_1")

		TownActivity2 = var_42_19

		var_42_16(var_42_20, var_42_19.GoldToShow(var_5))
	end

	if arg_42_1:GetNeedTownLv() <= arg_42_3:TownLevel() and #arg_42_1:GetUpgrade() ~= 0 then
		SetActive = var_8

		local var_42_21 = arg_42_0.box

		var_8(var_9.Find(var_42_21, "box_bg/num"), true)

		SetActive = var_8

		local var_42_22 = arg_42_0.box

		var_8(var_9.Find(var_42_22, "box_bg/decorate2"), true)

		SetActive = var_8

		local var_42_23 = arg_42_0.box

		var_8(var_9.Find(var_42_23, "box_bg/num_1"), true)

		SetActive = var_8

		local var_42_24 = arg_42_0.box

		var_8(var_9.Find(var_42_24, "box_bg/btn_lock"), false)

		SetActive = var_8

		local var_42_25 = arg_42_0.box

		var_8(var_9.Find(var_42_25, "box_bg/upgrade"), true)

		local var_42_26 = arg_42_1
		local var_42_27 = arg_42_1.GetUpgrade(var_42_26)

		setText = var_42_26

		local var_42_28 = arg_42_0.box
		local var_42_29 = var_10.Find(var_42_28, "box_bg/upgrade/name")

		i18n = var_42_28

		var_42_26(var_42_29, var_42_28("LiquorFloor_update"))

		local var_42_30 = arg_42_3
		local var_42_31 = arg_42_3.GetUpgradeGold(var_42_30, arg_42_1:GetId())

		setText = var_42_30

		local var_42_32 = arg_42_0.box
		local var_42_33 = var_11.Find(var_42_32, "box_bg/upgrade/num1")

		TownActivity2 = var_42_32

		var_42_30(var_42_33, var_42_32.GoldToShow(var_42_31[1][3]))

		SetActive = var_42_30

		local var_42_34 = arg_42_0.box

		var_42_30(var_11.Find(var_42_34, "box_bg/num_man"), false)
		...
		if #var_42_31 == 1 then
			...
			var_10(var_11.Find(var_42_35, "box_bg/upgrade/icon2"), false)

			SetActive = var_10

			local var_42_36 = arg_42_0.box

			var_10(var_11.Find(var_42_36, "box_bg/upgrade/num2"), false)
		else
			SetActive = var_10

			local var_42_37 = arg_42_0.box

			var_10(var_11.Find(var_42_37, "box_bg/upgrade/icon2"), true)

			SetActive = var_10

			local var_42_38 = arg_42_0.box

			var_10(var_11.Find(var_42_38, "box_bg/upgrade/num2"), true)

			setText = var_10

			local var_42_39 = arg_42_0.box
			local var_42_40 = var_11.Find(var_42_39, "box_bg/upgrade/num2")

			TownActivity2 = var_42_39

			var_10(var_42_40, var_42_39.GoldToShow(var_42_31[2][3]))
		end

		local var_42_41 = arg_42_3
		local var_42_42 = arg_42_3.UpgradeGold
		local var_42_43 = arg_42_1

		if var_42_42(var_42_41, arg_42_1.GetId(var_42_43)) then
			local var_42_44 = arg_42_0.box
			local var_42_45 = var_10.Find(var_42_44, "box_bg/upgrade")
			local var_42_46 = var_10.GetComponent

			typeof = var_12
			Button = var_42_43

			local var_42_47 = var_42_46(var_42_45, var_12(var_42_43))

			var_42_47.interactable = true
			onButton = var_42_47

			local var_42_48 = arg_42_0

			var_42_43 = arg_42_0.box

			local var_42_49 = var_12.Find(var_42_43, "box_bg/upgrade")
			...
			function var_42_43()
				...
				local var_43_2 = var_2_10002.UPGRADE_WORKPLACE
				local var_43_3 = arg_42_1

				var_43_1(var_43_0, var_43_2, var_3.GetId(var_43_3), arg_42_1, arg_42_2)
			...
			var_42_47(var_42_48, var_42_49, var_42_43, var_14)
		else
			local var_42_50 = arg_42_0.box
			local var_42_51 = var_10.Find(var_42_50, "box_bg/upgrade")
			local var_42_52 = var_10.GetComponent

			typeof = var_12
			Button = var_42_43
			var_42_52(var_42_51, var_12(var_42_43)).interactable = false
		end
	else
		local var_42_62

		if #arg_42_1:GetUpgrade() == 0 and var_6 == 0 then
			SetActive = var_42_62

			local var_42_53 = arg_42_0.box

			var_42_62(var_9.Find(var_42_53, "box_bg/num"), false)

			SetActive = var_42_62

			local var_42_54 = arg_42_0.box

			var_42_62(var_9.Find(var_42_54, "box_bg/decorate2"), false)

			SetActive = var_42_62

			local var_42_55 = arg_42_0.box

			var_42_62(var_9.Find(var_42_55, "box_bg/num_1"), false)

			SetActive = var_42_62

			local var_42_56 = arg_42_0.box

			var_42_62(var_9.Find(var_42_56, "box_bg/upgrade"), false)

			SetActive = var_42_62

			local var_42_57 = arg_42_0.box

			var_42_62(var_9.Find(var_42_57, "box_bg/btn_lock/icon"), false)

			SetActive = var_42_62

			local var_42_58 = arg_42_0.box

			var_42_62(var_9.Find(var_42_58, "box_bg/btn_lock"), true)

			SetActive = var_42_62

			local var_42_59 = arg_42_0.box

			var_42_62(var_9.Find(var_42_59, "box_bg/btn_lock/name"), true)

			SetActive = var_42_62

			local var_42_60 = arg_42_0.box

			var_42_62(var_9.Find(var_42_60, "box_bg/num_man"), true)

			local var_42_61 = arg_42_3

			var_42_62 = arg_42_3.GetGoldOutput(var_42_61)
			setText = var_42_61

			local var_42_63 = arg_42_0.box
			local var_42_64 = var_10.Find(var_42_63, "box_bg/num_man")

			TownActivity2 = var_42_63

			var_42_61(var_42_64, var_42_63.GoldToShow(arg_42_1:GetTypeParam(var_42_62)))

			setText = var_42_61

			local var_42_65 = arg_42_0.box
			local var_42_66 = var_10.Find(var_42_65, "box_bg/btn_lock/name")

			i18n = var_42_65

			var_42_61(var_42_66, var_42_65("LiquorFloor_update_max"))
		else
			SetActive = var_42_62

			local var_42_67 = arg_42_0.box

			var_42_62(var_9.Find(var_42_67, "box_bg/num_man"), false)

			SetActive = var_42_62

			local var_42_68 = arg_42_0.box

			var_42_62(var_9.Find(var_42_68, "box_bg/btn_lock"), true)

			SetActive = var_42_62

			local var_42_69 = arg_42_0.box

			var_42_62(var_9.Find(var_42_69, "box_bg/upgrade"), false)

			setText = var_42_62

			local var_42_70 = arg_42_0.box
			local var_42_71 = var_9.Find(var_42_70, "box_bg/btn_lock/name")

			i18n = var_42_70

			var_42_62(var_42_71, var_42_70("LiquorFloor_update_unlock", var_6))
		end
	end
...
function var_0_1.OnRole_bg(arg_44_0, arg_44_1)
	...
	var_2.make(var_44_2, function(arg_45_0, arg_45_1, arg_45_2)
		...
		if arg_45_0 == var_2_10003.EventUpdate then
			...
			local var_45_5 = var_7.GetTypeParam(var_45_4)
			local var_45_6 = arg_44_0
			local var_45_7 = var_8.OnNextArchitecture
			local var_45_8 = arg_44_1

			var_45_1(var_45_0, var_45_2, var_45_3, var_45_5, var_45_7(var_45_6, var_10.GetId(var_45_8)), arg_44_1)
		end
	...
	local var_44_5 = var_3.Find(var_44_4, "role_bg/rule1")

	i18n = var_44_4

	var_2(var_44_5, var_44_4("LiquorFloor_character_tip"))
...
function var_0_1.UpdateTask(arg_46_0, arg_46_1, arg_46_2, arg_46_3, arg_46_4, arg_46_5)
	...
	elseif var_46_0 == arg_46_4 then
		...
		local var_46_2 = arg_46_2.Find(var_46_1, "Text")

		i18n = var_46_1

		var_7(var_46_2, var_46_1("LiquorFloor_character_unlock", arg_46_4))
	else
		SetActive = var_7
	...
	local var_46_3 = var_7("ui/LiquorFloorUI_atlas", "box_decorate1")

	setImageSprite = var_8

	var_8(arg_46_2:Find("btn"), var_46_3, true)

	local var_46_4 = arg_46_0.shipIds[var_46_0]
	local var_46_5
	...
	if arg_46_0.shipIds[var_46_0] then
		...
		local var_46_6 = var_10(var_11)

		if var_10.RawGetShipById(var_46_6, var_46_4) then
			LoadSprite = var_46_6

			local var_46_7 = "qicon/"

			var_1_10014 = var_10

			local var_46_8 = var_46_6(var_46_7 .. var_10.getPainting(var_1_10014))

			setImageSprite = var_12
			var_1_10014 = arg_46_2

			var_12(arg_46_2.Find(var_1_10014, "btn"), var_46_8, true)
		end
	end
	...
	local function var_46_11()
		...
		local var_47_2 = var_2_10002.OPEN_CHUANWU
		local var_47_3 = var_46_0
		local var_47_4 = var_46_5
		local var_47_5 = arg_46_5

		var_47_1(var_47_0, var_47_2, var_47_3, var_47_4, var_5.GetId(var_47_5))
	...
	var_10(var_46_9, var_46_10, var_46_11, var_1_10014)
...
function var_0_1.RefreshRedPoint(arg_50_0)
	...
	var_1_10001(var_2.Find(var_50_0, "tip"), var_0_1.GetCollectionBookTip())
...
function var_0_1.ShouldShowTaskTip()
	...
	local var_51_1 = var_1_10001(var_1_10002)

	getProxy = var_1_10002
	ActivityProxy = var_1_10003

	local var_51_2 = var_1_10002(var_1_10003)
	...
	local var_51_5 = var_51_3.activity_template[var_51_4].config_data

	ipairs = var_5

	for iter_51_0, iter_51_1 in var_5(var_51_5) do
...
function var_0_1.getCollectDataBySiteId(arg_52_0, arg_52_1)
	...
	for iter_52_0, iter_52_1 in var_1_10002(var_1_10003.activity_town_collection_2.all) do
		pg = var_1_10007
...
function var_0_1.GetCollectionBookTip()
	...
	local var_53_1 = var_1_10001(var_1_10002)

	getProxy = var_1_10002
	ActivityProxy = var_1_10003

	local var_53_2 = var_1_10002(var_1_10003)
	...
	for iter_53_0 = 1, #var_53_4 do
		...
		if var_1_10008.getTaskVO(var_1_10009, var_53_4[iter_53_0].task) and var_1_10008:getTaskStatus() == 1 then
			return true
		end
	end
...
function var_0_1.GetLiquorFloorMapTip()
	...
	local var_54_0 = var_1_10000(var_1_10001)
	local var_54_1 = var_0.getActivityByType

	ActivityConst = var_1_10002

	local var_54_2 = var_54_1(var_54_0, var_1_10002.ACTIVITY_TYPE_TOWN2)
