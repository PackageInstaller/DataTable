...
function var_0_1.didEnter(arg_2_0)
	...
	findTF = var_1_10002
	arg_2_0.menuPanel = var_2_0(var_1_10002(arg_2_0._tf, "ad/menu"), arg_2_0)
	PuzzleConnectDetail = var_1

	local var_2_1 = var_1.New

	findTF = var_2
	arg_2_0.detailPanel = var_2_1(var_2(arg_2_0._tf, "ad/detail"), arg_2_0)
	PuzzleConnectGame = var_1

	local var_2_2 = var_1.New

	findTF = var_2
	arg_2_0.gamePanel = var_2_2(var_2(arg_2_0._tf, "ad/game"), arg_2_0)
	arg_2_0.panelDic = {
		arg_2_0.menuPanel,
		arg_2_0.detailPanel,
		arg_2_0.gamePanel
	...
	var_2_4(var_2_3, var_3.OPEN_DETAIL, function(arg_3_0, arg_3_1)
		...
		if arg_3_1 then
			...
			local var_3_4 = var_3_2(var_4)
			local var_3_5 = var_3.getActivityByType

			ActivityConst = var_5
			var_3_3._activity = var_3_5(var_3_4, var_5.ACTIVITY_TYPE_PUZZLE_CONNECT)
	...
	var_2_6(var_2_5, var_3.OPEN_MENU, function(arg_4_0, arg_4_1)
	...
	var_2_8(var_2_7, var_3.OPEN_GAME, function(arg_5_0, arg_5_1)
	...
	ActivityConst = var_3
	arg_2_0._activity = var_2_11(var_2_10, var_3.ACTIVITY_TYPE_PUZZLE_CONNECT)
	...
	local var_2_18 = var_4(var_1_10005)

	if var_2_16(var_2_17 .. var_2_14(var_4.getPlayerId(var_2_18))) ~= 1 then
		pg = var_2
		...
		var_2.Play(var_2_19, "WEIXIANFAMINGPOJINZHONGWEITUO1", function()
			...
			var_6_0(var_6_1 .. var_2_10002(var_3.getPlayerId(var_6_2)), 1)
...
function var_0_1.updateActivity(arg_8_0)
	...
	arg_8_0._activity = var_8_1(var_8_0, var_1_10003.ACTIVITY_TYPE_PUZZLE_CONNECT)
			...
			if iter_8_0 <= var_8_12 then
				...
				if not var_1_10013.contains(var_8_10, var_8_14) then
					...
					if not var_1_10013.contains(var_8_8, var_8_14) and iter_8_0 == var_8_13 + 1 then
						...
						local var_8_15 = var_14.activity_tolove_jigsaw[var_8_14].need[2]
						local var_8_16 = var_8_7:getData()

						if var_1_10013 <= var_15.getResource(var_8_16, var_8_15) then
							local var_8_17 = arg_8_0
							local var_8_18 = arg_8_0.emit

							PuzzleConnectMediator = var_1_10018

							var_8_18(var_8_17, var_1_10018.CMD_ACTIVITY, {
								index = 1,
								config_id = var_8_14
							})
						end
