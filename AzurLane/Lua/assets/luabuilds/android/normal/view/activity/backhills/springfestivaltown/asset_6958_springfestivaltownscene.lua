...
function var_0_1.init(arg_3_0)
	...
	for iter_3_0 = 0, arg_3_0._map.childCount - 1 do
		local var_3_5 = arg_3_0._map

		var_1_10005 = var_1_10005.GetChild(var_3_5, iter_3_0)
		go = var_3_5

		local var_3_6 = var_3_5(var_1_10005).name

		arg_3_0["_" .. var_3_6] = var_1_10005
	end

	local var_3_7 = arg_3_0._map

	arg_3_0._front = var_1.Find(var_3_7, "top")

	local var_3_8 = arg_3_0._map

	arg_3_0._middle = var_1.Find(var_3_8, "middle")

	local var_3_9 = arg_3_0._map

	arg_3_0._bottom = var_1.Find(var_3_9, "bottom")
	arg_3_0.containers = {
		arg_3_0._front,
		arg_3_0._middle,
		arg_3_0._bottom
	...
	local var_3_10 = arg_3_0._map

	arg_3_0._shipTpl = var_1.Find(var_3_10, "ship")
	GraphPath = var_1

	local var_3_11 = var_1.New

	import = var_3_10
	arg_3_0.graphPath = var_3_11(var_3_10("GameCfg.BackHillGraphs.SpringFestivalTownGraph"))

	local var_3_12 = arg_3_0._tf

	arg_3_0._upper = var_1.Find(var_3_12, "upper")

	local var_3_13 = arg_3_0.top
	local var_3_14 = var_1.Find(var_3_13, "usable_count/Text")
	local var_3_15 = var_1.GetComponent

	typeof = var_3
	Text = iter_3_0
	arg_3_0.usableTxt = var_3_15(var_3_14, var_3(iter_3_0))

	local var_3_16 = arg_3_0.top

	arg_3_0.diedieleTF = var_1.Find(var_3_16, "diediele_count")

	local var_3_17 = arg_3_0.diedieleTF
	local var_3_18 = var_1.Find(var_3_17, "Text")
	local var_3_19 = var_1.GetComponent

	typeof = var_3
	Text = iter_3_0
	arg_3_0.diedieleTxt = var_3_19(var_3_18, var_3(iter_3_0))
	LoadPrefabRequestPackage = var_1

	local var_3_20 = var_1.New("ui/map_donghuangchunjie", "map_donghuangchunjie", function(arg_4_0)
		...
		local var_4_2 = var_4_1(var_4_0, var_3(var_4)).sortingOrder
		...
		local var_4_5 = var_4_4(var_4_3, var_2_10005(var_2_10006))
		local var_4_6 = var_3.ToTable(var_4_5)

		ipairs = var_4_5

		for iter_4_0, iter_4_1 in var_4_5(var_4_6) do
	...
	arg_3_0.effectReq = var_1.Start(var_3_20)

	local var_3_21 = arg_3_0
	local var_3_22 = arg_3_0.managedTween

	LeanTween = var_3

	local var_3_23 = var_3.value
	local var_3_24

	go = var_1_10005

	local var_3_25 = var_1_10005(arg_3_0._map)

	System = var_6

	local var_3_26 = var_6.Action_UnityEngine_Color(function(arg_5_0)
		go = var_2_10001
		...
		local var_5_2 = var_5_1(var_5_0, var_2_10003(var_2_10004)).material
	...
	local var_3_27 = var_7(0, 0, 0, 0)

	Color = var_8

	local var_3_28 = var_3_22(var_3_21, var_3_23, var_3_24, var_3_25, var_3_26, var_3_27, var_8(1, 1, 0, 0), 1.5)

	var_1.setLoopPingPong(var_3_28, -1)
...
function var_0_1.didEnter(arg_6_0)
	...
	var_1_10002(arg_6_0, arg_6_0.diedieleTF, function()
		...
		var_8_1(var_8_0, var_2_10002.ON_OPEN_PILE_SIGNED)
	...
	var_1_10002(arg_6_0, arg_6_0._helpBtn, function()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.help_chunjie_feast.tip
	...
	arg_6_0:InitFacilityCross(arg_6_0._map, arg_6_0._upper, "danianshou", function()
		...
		var_14_4.id = var_2_10005.BEAT_MONSTER_NIAN_2020
	...
	arg_6_0:InitFacilityCross(arg_6_0._map, arg_6_0._upper, "dafuweng", function()
		...
		local var_15_3 = var_2_10003.ACTIVITY
		local var_15_4 = {}

		ActivityConst = var_2_10005
		var_15_4.id = var_2_10005.MONOPOLY_2020
	...
	arg_6_0:InitFacilityCross(arg_6_0._map, arg_6_0._upper, "diediele", function()
		...
		var_16_1(var_16_0, var_2_10002.GO_MINI_GAME, 9)
	...
	arg_6_0:InitFacilityCross(arg_6_0._map, arg_6_0._upper, "jianzao", function()
		...
		var_17_1(var_17_0, var_17_2, var_2_10003.GETBOAT, {
			projectName = "new",
			page = 1
		})
	...
	arg_6_0:InitFacilityCross(arg_6_0._map, arg_6_0._upper, "pifushangdian", function()
		...
		local var_19_2 = var_2_10002.GO_SCENE

		SCENE = var_2_10003

		var_19_1(var_19_0, var_19_2, var_2_10003.SKINSHOP)
	...
	var_6_3(var_6_2, var_4.ACTIVITY_478, 3, 5)
	arg_6_0:UpdateView()
...
function var_0_1.UpdateView(arg_20_0)
	...
	local var_20_8 = var_20_7(var_20_6, var_7.BEAT_MONSTER_NIAN_2020)
	...
	if var_20_8 then
		...
		var_1_10008 = var_20_8
		var_20_10 = var_20_8.readyToAchieve(var_1_10008)
	end
	...
	local var_20_15 = var_20_14(var_20_13, var_7.MONOPOLY_2020)
	...
	if var_20_15 then
		...
		var_1_10008 = var_20_15
		var_20_17 = var_20_15.readyToAchieve(var_1_10008)
	end
	...
	getProxy = var_7
	ColoringProxy = var_1_10008

	local var_20_20 = var_7(var_1_10008)

	var_5(var_20_19, var_7.CheckTodayTip(var_20_20))
	...
	var_5(var_20_26, var_7.isShowRedPoint())
