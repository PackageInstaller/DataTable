...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.activity = var_3_1(var_3_0, var_1_10003.ACTIVITY_TYPE_NEWSERVER_TASK)
...
function var_0_1.initUI(arg_4_0)
	...
	arg_4_0.taskGroupItemList = var_4_7(var_4_8, var_3.Find(var_4_9, "tpl"))
...
function var_0_1.addListener(arg_5_0)
	...
	local function var_5_2()
		...
		NewServerCarnivalMediator = var_2_10002
...
function var_0_1.updateTaskGroup(arg_9_0, arg_9_1, arg_9_2)
	...
	for iter_9_0, iter_9_1 in var_6(var_9_0) do
	...
	if 0 < var_9_3 then
		...
		if not var_9_3.remove(var_9_2, 1) then
			var_9_4 = var_9_0[#var_9_0]
		end
		...
		local var_9_6 = iter_9_0(iter_9_1)
		local var_9_7 = #var_9_2

		var_7(var_9_5, var_9_6, 0 < var_9_7)
		arg_9_0:updateTaskDisplay(var_9_1, var_9_4)

		setActive = var_7

		local var_9_8 = var_9_1:Find("toggle_mark")
		local var_9_9 = #var_9_2

		var_7(var_9_8, 0 < var_9_9)

		local var_9_10 = var_9_4
		local var_9_11 = var_9_4.getTaskStatus(var_9_10)

		GetOrAddComponent = var_9_10

		local var_9_12 = arg_9_1

		typeof = var_10
		CanvasGroup = var_11
		var_9_10(var_9_12, var_10(var_11)).alpha = var_9_11 == 2 and 0.5 or 1
		setActive = var_9

		var_9(var_9_1:Find("mask"), var_9_11 == 2)

		setActive = var_9

		var_9(var_9_1:Find("bg/receive"), var_9_11 == 1)

		setActive = var_9

		local var_9_13 = var_9_1:Find("tag/tag_daily")
		local var_9_14 = var_9_4
		local var_9_15 = var_9_4.getConfig(var_9_14, "type")

		Task = var_9_14

		var_9(var_9_13, var_9_15 == var_9_14.TYPE_ACTIVITY_ROUTINE)

		setActive = var_9

		local var_9_16 = var_9_1:Find("tag/tag_target")
		local var_9_17 = var_9_4
		local var_9_18 = var_9_4.getConfig(var_9_17, "type")

		Task = var_9_17

		var_9(var_9_16, var_9_18 ~= var_9_17.TYPE_ACTIVITY_ROUTINE)

		onToggle = var_9

		var_9(arg_9_0, var_9_1, function(arg_10_0)
			if arg_10_0 then
				...
				local var_10_1 = var_10_0.New(var_2_10001, arg_9_0.extendTpl)
				...
				var_2.make(var_10_1, function(arg_11_0, arg_11_1, arg_11_2)
					...
					if arg_11_0 == var_3_10003.EventUpdate then
						...
						var_3.updateTaskDisplay(var_11_0, arg_11_2, var_9_2[arg_11_1])
					end
				...
				var_3(arg_9_0.content, 0, 1 - (arg_9_2 - 1) / (#arg_9_0.showVOGroup + #var_9_2 - 4))
			else
				removeAllChildren = var_2_10001

				local var_10_2 = arg_9_1

				var_2_10001(var_2.Find(var_10_2, "content"))
			end
...
function var_0_1.updateTaskDisplay(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_2 = arg_12_2.getConfig(var_12_1, "target_num")

	setSlider = var_12_1

	var_12_1(arg_12_1:Find("Slider"), 0, var_12_2, var_12_0)
	...
	local var_12_6 = arg_12_1:Find("IconTpl")
	...
	local function var_12_7()
		...
		var_13_1(var_13_0, var_2_10002.ON_DROP, var_12_4)
	...
	var_6(var_12_5, var_12_6, var_12_7, var_10)

	local var_12_8 = arg_12_2
	local var_12_9 = arg_12_2.getTaskStatus(var_12_8)

	setActive = var_12_8

	var_12_8(arg_12_1:Find("go"), var_12_9 == 0)

	setActive = var_12_8

	var_12_8(arg_12_1:Find("get"), var_12_9 == 1)

	setActive = var_12_8

	var_12_8(arg_12_1:Find("got"), var_12_9 == 2)

	setText = var_12_8

	local var_12_10 = arg_12_1
	local var_12_11 = arg_12_1.Find(var_12_10, "desc")

	setColorStr = var_12_10

	var_12_8(var_12_11, var_12_10(arg_12_2:getConfig("desc"), arg_12_0:getColor(var_0_1.TXT_DESC, var_12_9)))

	setText = var_12_8

	local var_12_12 = arg_12_1
	local var_12_13 = arg_12_1.Find(var_12_12, "Slider/Text")

	setColorStr = var_12_12

	local var_12_14 = var_12_12(var_12_0, arg_12_0:getColor(var_0_1.TXT_CURRENT_NUM, var_12_9))

	setColorStr = var_10

	var_12_8(var_12_13, var_12_14 .. var_10("/" .. var_12_2, arg_12_0:getColor(var_0_1.TXT_TARGET_NUM, var_12_9)))

	onButton = var_12_8

	local var_12_15 = arg_12_0
	local var_12_16 = arg_12_1:Find("go")
	...
	local function var_12_17()
		...
		var_14_1(var_14_0, var_2_10002.TASK_GO, arg_12_2)
	...
	var_12_8(var_12_15, var_12_16, var_12_17, var_11)

	onButton = var_12_8

	local var_12_18 = arg_12_0
	local var_12_19 = arg_12_1:Find("get")
	...
	local function var_12_20()
		...
		var_15_1(var_15_0, var_2_10002.TASK_SUBMIT, arg_12_2)
	...
	var_12_8(var_12_18, var_12_19, var_12_20, var_11)
...
function var_0_1.filterAll(arg_17_0)
	...
	arg_17_0.taskVOGroup = var_1_10001.map(arg_17_0.taskGroupList, function(arg_18_0)
		...
		return var_2_10001.map(arg_18_0, function(arg_19_0)
			...
			var_3_10001(var_2.getTaskVO(var_19_0, arg_19_0), "without this task:" .. arg_19_0)
...
function var_0_1.filterDaily(arg_20_0)
	...
	arg_20_0.taskVOGroup = var_1_10001.map(arg_20_0.taskGroupList, function(arg_21_0)
		...
		return var_2_10001.map(arg_21_0, function(arg_22_0)
			...
			var_3_10001(var_2.getTaskVO(var_22_0, arg_22_0), "without this task:" .. arg_22_0)
	...
	for iter_20_0, iter_20_1 in var_1(arg_20_0.taskVOGroup) do
		...
		if var_20_1 == var_20_0.TYPE_ACTIVITY_ROUTINE then
			table = var_20_1
...
function var_0_1.filterTarget(arg_23_0)
	...
	arg_23_0.taskVOGroup = var_1_10001.map(arg_23_0.taskGroupList, function(arg_24_0)
		...
		return var_2_10001.map(arg_24_0, function(arg_25_0)
			...
			var_3_10001(var_2.getTaskVO(var_25_0, arg_25_0), "without this task:" .. arg_25_0)
	...
	for iter_23_0, iter_23_1 in var_1(arg_23_0.taskVOGroup) do
		...
		if var_23_1 ~= var_23_0.TYPE_ACTIVITY_ROUTINE then
			table = var_23_1
...
function var_0_1.updataTaskList(arg_26_0)
	...
	var_26_0(var_26_1, var_1_10003({
		...
		function(arg_29_0)
			...
			return var_29_1 ~= var_29_0.TYPE_ACTIVITY_ROUTINE and 1 or 0
		end,
		function(arg_30_0)
...
function var_0_1.isTip(arg_33_0)
	...
	if arg_33_0.finishVOList then
		var_33_0 = #arg_33_0.finishVOList
		var_33_0 = 0 < var_33_0
		...
		local var_33_1 = var_33_0(var_1_10002)
		local var_33_2 = var_1.getActivityByType

		ActivityConst = var_1_10003

		if var_33_2(var_33_1, var_1_10003.ACTIVITY_TYPE_NEWSERVER_TASK) then
			...
			if not var_1.isEnd(var_33_3) then
				...
				local var_33_5 = var_1
				local var_33_6 = var_1.getConfig(var_33_5, "config_data")
				...
				for iter_33_0, iter_33_1 in var_33_5(var_33_6) do
					...
					for iter_33_2, iter_33_3 in var_1_10009(iter_33_1) do
						...
						local var_33_7 = var_33_4:getTaskVO(iter_33_3)

						if var_1_10014.getTaskStatus(var_33_7) == 1 then
							return true
						end
					end
				end
