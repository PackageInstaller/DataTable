...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	i18n = var_5
	IslandTaskScene = var_1_10006

	var_3(var_1_2, var_5(var_1_10006.island_history_desc))
	...
	for iter_1_0 = 1, var_0_1 do
		...
		var_1_10008 = var_1_10008(var_1_10009(arg_1_0.pageItemTpl))
		setParent = var_1_10009

		var_1_10009(var_1_10008, arg_1_0.pageItemContent)
		...
		local var_1_4 = arg_1_0.event
		local var_1_5 = var_1_10008
		...
		SFX_UI_CLICK = var_1_10013

		var_1_10009(var_1_4, var_1_5, var_1_6, var_1_10013)

		table = var_1_10009

		var_1_10009.insert(arg_1_0.pageItemTfs, var_1_10008)
	end
...
function var_0_0.initPageUI(arg_4_0)
	for iter_4_0 = 1, var_0_1 do
		...
		setText = var_1_10006
		findTF = var_1_10007
		var_1_10007 = var_1_10007(arg_4_0.pageItemTfs[iter_4_0], "num")
		tostring = var_8

		var_1_10006(var_1_10007, var_8(var_4_0))

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(arg_4_0.pageItemTfs[iter_4_0], "lock"), var_4_0 > #arg_4_0.mapDataList)

		setActive = var_1_10006

		var_1_10006(arg_4_0.pageItemTfs[iter_4_0], var_4_0 <= #arg_4_0.mapDataList)

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(arg_4_0.pageItemTfs[iter_4_0], "selected"), false)
		...
		var_1_10007(var_8(arg_4_0.pageItemTfs[iter_4_0], "num"), var_1_10006)
	end
...
function var_0_0.updatePage(arg_5_0, arg_5_1)
	...
	if arg_5_0.selectedPageItem then
		...
		var_3(var_1_10004(arg_5_0.selectedPageItem, "selected"), false)
		...
		var_3(var_1_10004(arg_5_0.selectedPageItem, "num"), var_5_1)
	end
	...
	var_3(var_1_10004(arg_5_0.selectedPageItem, "selected"), true)
	...
	var_3(var_4(arg_5_0.selectedPageItem, "num"), var_5_2)
...
function var_0_0.updateMap(arg_6_0, arg_6_1)
	...
	IslandTaskScene = var_1_10007

	var_4(var_6_1, var_1_10006(var_1_10007.ui_atlas, "map_" .. arg_6_0.mapIndex), true)
	...
	LoadSprite = var_6
	IslandTaskScene = var_7

	var_4(var_6_2, var_6(var_7.ui_atlas, "map_" .. arg_6_0.mapIndex .. "_desc"), true)
	...
	for iter_6_0 = 1, #arg_6_0.taskList do
		...
		if iter_6_0 <= #arg_6_0.taskDatas then
			...
			var_1_10011(var_6_4, true)

			pg = var_1_10011
			var_1_10011 = var_1_10011.task_data_template[arg_6_0.taskDatas[iter_6_0]]
			setText = var_12
			findTF = var_13

			var_12(var_13(var_6_4, "text"), var_1_10011.name)

			local var_6_5 = arg_6_0
			local var_6_6 = arg_6_0.checkTaskFinish(var_6_5, var_1_10011.id)
			...
			var_6_5(var_14(var_6_4, "tag/complete"), var_6_6)
		else
			setActive = var_1_10011

			var_1_10011(var_6_4, false)
		end
	end

	getProxy = var_6
	SixthAnniversaryIslandProxy = var_7

	local var_6_7 = var_6(var_7)
	...
	var_6_8(var_6_10 .. var_6_11 .. var_6_12 .. var_1_10011(var_6_9))

	setActive = var_6_8

	var_6_8(arg_6_0.finalAward, var_6_3 and not var_6_9)

	setActive = var_6_8

	var_6_8(arg_6_0.gotTf, var_6_3 and var_6_9)

	setLocalPosition = var_6_8
	findTF = var_8

	local var_6_13 = var_8(arg_6_0.historyPage, "finalAward")

	Vector3 = var_9

	var_6_8(var_6_13, var_9(var_0_2[arg_6_0.mapIndex][1], var_0_2[arg_6_0.mapIndex][2], var_0_2[arg_6_0.mapIndex][3]))

	setLocalEulerAngles = var_6_8
	findTF = var_6_13
	...
	var_6_8(var_6_14, var_9(var_0_3[arg_6_0.mapIndex][1], var_0_3[arg_6_0.mapIndex][2], var_0_3[arg_6_0.mapIndex][3]))
...
function var_0_0.addTaskList(arg_7_0, arg_7_1)
	for iter_7_0 = 1, arg_7_1 do
		...
		var_1_10006 = var_1_10006(var_1_10007(arg_7_0.taskListTpl))
