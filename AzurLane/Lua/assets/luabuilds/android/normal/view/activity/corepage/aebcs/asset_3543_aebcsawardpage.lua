...
function var_0_1.InitData(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10001(arg_1_0.table_Top) do
		...
		var_1_10006(var_1_0, var_1_1, var_1_2, var_1_10010)
	end
...
function var_0_1.OnAnimation(arg_3_0, arg_3_1)
	if arg_3_1 ~= 1 then
		...
		local var_3_2 = var_3_1(var_3_0, var_1_10004(var_1_10005))
...
function var_0_1.OnUpdateItem(arg_4_0, arg_4_1, arg_4_2)
	...
	var_6(var_4_3, var_4_4, var_4_5, var_1_10010)
...
function var_0_1.UpdateView(arg_6_0)
	for iter_6_0 = 1, #arg_6_0.table_Top do
		...
		var_1_10005(var_6.Find(var_6_0, "Label"), arg_6_0:OnGetCount(iter_6_0) .. "/" .. arg_6_0:OnCount(iter_6_0))

		setText = var_1_10005

		local var_6_1 = arg_6_0.table_Top[iter_6_0]
		local var_6_2 = var_6.Find(var_6_1, "type_image/name")

		i18n = var_6_1

		var_1_10005(var_6_2, var_6_1("danmachi_award_" .. iter_6_0))
	end
...
function var_0_1.selectBoxbg(arg_7_0, arg_7_1)
	...
	if var_1_10002.getCount(arg_7_1.skipable_list) > 1 then
		...
		local var_7_1 = var_3.Find(var_7_0, "Panel/BG")

		LoadSprite = var_7_0

		var_2(var_7_1, var_7_0("ui/AEBCSAwardPage_atlas", "box_bg1"), true)
	else
		table = var_2
		...
		if var_2.getCount(arg_7_1.skipable_list) == 1 then
			...
			local var_7_3 = var_3.Find(var_7_2, "Panel/BG")

			LoadSprite = var_7_2

			var_2(var_7_3, var_7_2("ui/AEBCSAwardPage_atlas", "box_bg2"), true)
		end
	end
