...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_5()
		...
		pg = var_2_10005
		var_5_2.content = var_2_10003(var_5_3, var_2_10005.ship_data_statistics[arg_3_0.selectedShipNumber].name)
		...
		function var_5_2.onYes()
			...
			var_6_1(var_6_0, var_3_10002.ON_USE_ITEM, arg_3_0.itemVO.id, arg_3_0.count, {
	...
	var_3(var_4.Find(var_3_8, "layer/" .. var_3_7), true)
	...
	arg_3_0.itemList = var_3_10(var_3_11, var_5.Find(var_3_12, "item"))
	...
	var_3.make(var_3_13, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_4.EventUpdate then
			...
			var_7_7("extra_page/" .. arg_3_0.style .. "/i_" .. var_7_0, "", arg_7_2:Find("unselected/icon"))

			GetImageSpriteFromAtlasAsync = var_7_7

			local var_7_1 = "extra_page/" .. arg_3_0.style .. "/i_" .. var_7_0
			local var_7_2 = ""
			local var_7_3 = arg_7_2

			var_7_7(var_7_1, var_7_2, arg_7_2.Find(var_7_3, "selected/icon"))

			local var_7_7

			if arg_7_1 == 5 then
				local var_7_4 = arg_7_2:Find("unselected/icon")
				local var_7_5 = var_7_7.GetComponent(var_7_4, "Image")

				var_7_7.SetNativeSize(var_7_5)

				local var_7_6 = arg_7_2:Find("unselected/icon")

				var_7_7 = var_7_7.GetComponent(var_7_6, "Image").rectTransform
				Vector2 = var_7_6
				var_7_7.sizeDelta = var_7_6(96, 228)

				local var_7_8 = arg_7_2:Find("unselected/icon")

				var_7_7 = var_7_7.GetComponent(var_7_8, "Image").rectTransform
				Vector2 = var_7_8
				var_7_7.anchoredPosition = var_7_8(0, -20)
			end
			...
			local function var_7_11(arg_8_0)
				if arg_8_0 and arg_3_0.selectTarget ~= arg_7_1 then
					...
					if arg_7_1 == 5 then
						...
						Vector2 = var_8_4
						var_8_5.sizeDelta = var_8_4(96, 228)
						...
						Vector2 = var_8_7
						var_8_5.anchoredPosition = var_8_7(0, -20)
					end
			...
			var_7_7(var_7_9, var_7_10, var_7_11, var_7_3)
		end
	...
	var_3(var_4.GetChild(var_3_15, 0), true)
