...
function var_0_1.OnInit(arg_1_0)
	...
	for iter_1_0 = 0, arg_1_0.skills.childCount - 1 do
		...
		var_1_10005(var_1_2, var_7.GetChild(var_1_3, iter_1_0))
	end
	...
	for iter_1_1 = 0, arg_1_0.trainSkills.childCount - 1 do
		...
		var_1_10005(var_1_19, var_7.GetChild(var_1_20, iter_1_1))
	end
	...
	local var_1_27 = var_2.Find(var_1_26, "panel/title/Text")

	i18n = var_1_26

	var_1(var_1_27, var_1_26("title_info"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		if var_3_5 == var_2_10005 then
			var_3_5 = var_3_2.id
			PlayerConst = var_2_10005

			if var_3_5 == var_2_10005.ResGold and var_3_4:GoldMax(var_3_2.count) then
				table = var_3_5
				...
				var_3_5.insert(var_3_0, function(arg_4_0)
					...
					local var_4_3 = var_3_10004("gold_max_tip_title")

					i18n = var_5
					var_4_2.content = var_4_3 .. var_5("award_max_warning")
		...
		var_3_5(var_3_0, function()
			...
			local var_5_5 = var_3_10004.EVENT_PT_OPERATION
			local var_5_6 = {
				cmd = 1
			}
	...
	local function var_2_5()
		...
		if not var_6_0 then
			...
			var_6_6(var_6_5, var_2_10005.BATTLE_OPERA)
		elseif var_6_1 and not var_6_1:isEnd() then
			...
			var_6_8(var_6_7, var_2_10005.BATTLE_OPERA)
		else
			...
			var_6_10(var_6_9, var_2_10005("common_activity_end"))
		end
	...
	local function var_2_11()
		...
		i18n = var_2_10003
		var_8_2.helps = var_2_10003("idol3rd_practice")
	...
	for iter_2_0, iter_2_1 in var_1(arg_2_0.skillBtns) do
		...
		var_1_10006(var_2_15, var_2_16, var_2_17, var_1_10010)
	end
	...
	var_2(var_2_22, var_4.isInBuffTime(var_2_23))
...
function var_0_1.OnUpdateFlush(arg_12_0)
	...
	var_12_16(arg_12_0.battleBtn, true)

	setActive = var_12_16

	var_12_16(arg_12_0.getBtn, var_12_11 and not var_12_0)

	setActive = var_12_16

	var_12_16(arg_12_0.trainEntranceBtn, var_12_0)

	setActive = var_12_16

	var_12_16(arg_12_0.gotBtn, not var_12_13 and not var_12_17)

	local var_12_18 = arg_12_0.ptData
	local var_12_19 = var_13.GetAward(var_12_18)

	updateDrop = var_12_18

	var_12_18(arg_12_0.awardTF, var_12_19)
	...
	local function var_12_22()
		...
		var_13_1(var_13_0, var_2_10002.ON_DROP, var_12_19)
	...
	var_12_18(var_12_20, var_12_21, var_12_22, var_1_10018)

	ipairs = var_12_18

	local var_12_23 = arg_12_0.ptData

	for iter_12_0, iter_12_1 in var_12_18(var_15.GetCurBuffInfos(var_12_23)) do
		setActive = var_1_10019

		local var_12_24 = arg_12_0.skillBtns[iter_12_1.group]

		var_1_10019(var_20.Find(var_12_24, "lv1"), false)

		setActive = var_1_10019

		local var_12_25 = arg_12_0.skillBtns[iter_12_1.group]

		var_1_10019(var_20.Find(var_12_25, "lv2"), false)

		setActive = var_1_10019

		local var_12_26 = arg_12_0.skillBtns[iter_12_1.group]

		var_1_10019(var_20.Find(var_12_26, "lv3"), false)
		...
		if iter_12_1.next then
			...
			var_1_10019(var_20.Find(var_12_27, "lv" .. iter_12_1.lv), true)
		else
			setActive = var_1_10019

			local var_12_28 = arg_12_0.skillBtns[iter_12_1.group]

			var_1_10019(var_20.Find(var_12_28, "lv3"), true)
		end
		...
		local var_12_30 = var_21.Find(var_12_29, "icon")

		LoadSprite = var_12_29

		var_20(var_12_30, var_12_29(var_1_10019))
	end
...
function var_0_1.showTrianPanel(arg_14_0)
	...
	var_1_10001(var_14_0, var_3("upgrade_idol_tip"))
	...
	for iter_14_0, iter_14_1 in var_2(arg_14_0.trainSkillBtns) do
		...
		var_1_10007(var_14_3, var_14_4, var_14_5, var_1_10011)
	end
	...
	var_2(var_14_6, var_14_7, var_14_8, iter_14_1)
...
function var_0_1.flushTrainPanel(arg_19_0)
	...
	if var_1.GetCurBuffInfos(var_19_0) then
		...
		for iter_19_0, iter_19_1 in var_19_0(var_1) do
			setActive = var_1_10007

			local var_19_1 = arg_19_0.trainSkillBtns[iter_19_1.group]

			var_1_10007(var_8.Find(var_19_1, "lv1"), false)

			setActive = var_1_10007

			local var_19_2 = arg_19_0.trainSkillBtns[iter_19_1.group]

			var_1_10007(var_8.Find(var_19_2, "lv2"), false)

			setActive = var_1_10007

			local var_19_3 = arg_19_0.trainSkillBtns[iter_19_1.group]

			var_1_10007(var_8.Find(var_19_3, "lv3"), false)
			...
			if iter_19_1.next then
				...
				var_1_10007(var_8.Find(var_19_4, "lv" .. iter_19_1.lv), true)
			else
				setActive = var_1_10007

				local var_19_5 = arg_19_0.trainSkillBtns[iter_19_1.group]

				var_1_10007(var_8.Find(var_19_5, "lv3"), true)
			end
			...
			local var_19_7 = var_9.Find(var_19_6, "icon")

			LoadSprite = var_19_6

			var_8(var_19_7, var_19_6(var_1_10007))

			setText = var_8

			local var_19_8 = arg_19_0.trainSkillBtns[iter_19_1.group]
			local var_19_9 = var_9.Find(var_19_8, "name")

			shortenString = var_19_8
			pg = var_11

			var_8(var_19_9, var_19_8(var_11.benefit_buff_template[iter_19_1.id].name, 7))
		end
	end

	ipairs = var_19_0

	for iter_19_2, iter_19_3 in var_19_0(arg_19_0.trainSkillBtns) do
		if iter_19_2 == arg_19_0.selectIndex then
			setActive = var_7

			var_7(iter_19_3:Find("selected"), true)

			setActive = var_7

			var_7(iter_19_3:Find("name"), true)
		else
			setActive = var_7

			var_7(iter_19_3:Find("selected"), false)

			setActive = var_7

			var_7(iter_19_3:Find("name"), false)
		end
	end
	...
	if arg_19_0.selectIndex then
		...
		var_2(var_19_10, var_19_11 .. var_19_12 .. iter_19_3.benefit_buff_template[arg_19_0.selectBuffId].desc)
		...
		var_2(var_19_13, var_19_14 .. var_19_15 .. var_6.benefit_buff_template[arg_19_0.selectNewBuffId].desc)
	else
		setActive = var_2
...
function var_0_1.showBuffInfoBox(arg_20_0, arg_20_1)
	...
	var_3(var_20_1, var_5.benefit_buff_template[arg_20_1.id].desc)
	...
	var_3(var_20_2, var_5("upgrade_introduce_tip", var_20_0))
	...
	var_4(var_20_4, var_6(var_20_3))

	local var_20_5 = arg_20_1.award

	updateDrop = var_20_4

	var_20_4(arg_20_0.buffAwardTF, var_20_5)
	...
	local function var_20_8()
		...
		var_21_1(var_21_0, var_2_10002.ON_DROP, var_20_5)
	...
	var_20_4(var_20_6, var_20_7, var_20_8, var_1_10009)
	...
	if arg_20_1.next then
		...
		var_5(var_6.Find(var_20_9, "icon_bg/got_mask"), false)
	else
		setText = var_5
		...
		var_5(var_6.Find(var_20_10, "icon_bg/got_mask"), true)
...
function var_0_1.showMsgBox(arg_25_0)
	if arg_25_0.selectBuffId then
		...
		var_2(var_25_1, var_1_10004(var_25_0))
		...
		var_3(var_25_3, var_5("practise_idol_tip", var_25_2))
		...
		var_3(var_25_4, var_25_5, var_25_6, var_7)
		...
		var_3(var_25_7, var_25_8, var_25_9, var_7)
		...
		local function var_25_12()
			...
			local var_28_3 = var_2_10002.EVENT_PT_OPERATION
			local var_28_4 = {
				cmd = 3
			}
			local var_28_5 = arg_25_0.ptData

			var_28_4.activity_id = var_4.GetId(var_28_5)

			local var_28_6 = arg_25_0.ptData

			var_28_4.arg1 = var_4.CanTrain(var_28_6)
			...
			function var_28_4.callback()
				...
				var_29_2(var_29_1, var_3_10002("upgrade_complete_tip"))
		...
		var_3(var_25_10, var_25_11, var_25_12, var_7)
	end
...
function var_0_1.showTip(arg_31_0, arg_31_1)
	...
	var_3(var_31_0:Find("Text"), arg_31_1)
	...
	local var_31_4 = var_31_2(var_31_3, var_5(1.8, 0.1, 1), 0.1)
	...
	local var_31_7 = var_31_5(var_31_6, var_5(1.1, 1.1, 1), 0.1)
	...
	local var_31_10 = var_4.New(function()
		...
		local var_32_2 = var_32_0(var_32_1, var_2_10002(0.1, 1.5, 1), 0.1)
		local var_32_3 = var_0.setUseEstimatedTime(var_32_2, true)
		local var_32_4 = var_0.setOnComplete

		System = var_2

		var_32_4(var_32_3, var_2.Action(function()
			...
			local var_33_2 = var_33_0(var_33_1, var_3_10002.zero, 0.1)
