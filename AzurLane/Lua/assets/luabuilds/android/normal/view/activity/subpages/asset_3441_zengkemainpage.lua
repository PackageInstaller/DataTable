...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.Manual, function()
		...
		CamouflageCityMedalAlbumView = var_2_10002
...
function var_0_1.updateUI(arg_7_0)
	...
	local var_7_2, var_7_3 = var_7_1(var_7_0, var_1_10003.shop_template[var_0_2].time)
	local var_7_4
	local var_7_6
	...
	local var_7_10, var_7_11 = var_7_9(var_7_8, var_6.activity_template[var_0_4].time)
	local var_7_12
	local var_7_14
	...
	var_7_14(var_7_16, var_9("tolovemainpage_build_countdown"))
	...
	arg_7_0.btnFuncList = {
		...
		fight = function(arg_12_0)
			...
			var_2_10001(arg_7_0, arg_12_0, function()
				...
				var_13_1(var_13_0, var_3_10002.ON_BOSSRUSH_MAP)
...
function var_0_1.skinCommdityTimeStamps(arg_14_0, arg_14_1)
	...
	if 0 < var_14_3 then
		...
		if 0 < var_14_4 then
			...
			return var_14_5 .. var_1_10007("word_hour")
		else
			math = var_14_5
			...
			if var_14_5.floor(var_14_2 / 60) > 0 then
				...
				return var_14_6 .. var_1_10008("word_minute")
			else
				local var_14_7 = var_14_2

				i18n = var_1_10008

				return var_14_7 .. var_1_10008("word_second")
			end
		end
	end
