...
local function var_0_30(arg_1_0, arg_1_1)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			Vector2 = var_2
			var_2_0.anchoredPosition = var_2(0, var_0_14)
		...
		startSliderBar = function(arg_6_0)
			...
			math = var_2_10005
			var_6_1.anchoredPosition = var_2(var_6_2, var_6_3 + var_2_10005.random(var_0_13[arg_6_0.sliderIndex][1], var_0_13[arg_6_0.sliderIndex][2]))
...
function var_0_1.initData(arg_16_0)
	...
	arg_16_0.timer = var_2.New(function()
		...
		if var_2_10000.realtimeSinceStartup - arg_16_0.realTimeStartUp > arg_16_0.stepCount then
			local var_17_0 = arg_16_0

			var_0.onTimer(var_17_0)

			local var_17_1 = arg_16_0

			Time = var_17_0
			var_17_1.realTimeStartUp = var_17_0.realtimeSinceStartup
		end
...
function var_0_1.initUI(arg_18_0)
	...
	local var_18_1 = var_3(arg_18_0.settlementUI, "btnOver")
	...
	var_1(var_18_0, var_18_1, var_18_2, var_5)
...
function var_0_1.initGameUI(arg_20_0)
	...
	var_1(var_20_0, var_3(arg_20_0.gameUI, "btnLeave"), function()
	...
	findTF = var_2
	arg_20_0.sliderController = var_20_2(var_2(arg_20_0.sceneTf, "collider"), arg_20_0)
...
function var_0_1.gameStart(arg_27_0)
	...
	var_1_10001(var_1_10002(arg_27_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_27_0.bgTf, "on"), false)
...
function var_0_1.transformColor(arg_28_0, arg_28_1)
	...
	local var_28_0 = var_1_10002(var_1_10003.sub(arg_28_1, 1, 2), 16)

	tonumber = var_3
	string = var_4

	local var_28_1 = var_3(var_4.sub(arg_28_1, 3, 4), 16)

	tonumber = var_4
	string = var_5

	local var_28_2 = var_4(var_5.sub(arg_28_1, 5, 6), 16)
...
function var_0_1.addScore(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	if arg_29_1 then
		...
		var_5(var_6(arg_29_0.sceneScoreTf, "anim/add_1"), false)

		setActive = var_5
		findTF = var_6

		var_5(var_6(arg_29_0.sceneScoreTf, "anim/add_2"), false)

		setActive = var_5
		findTF = var_6

		var_5(var_6(arg_29_0.sceneScoreTf, "anim/sub_1"), false)
		...
		if 0 <= arg_29_1 then
			...
			var_6(var_7(arg_29_0.sceneScoreTf, "anim/" .. var_0_25[arg_29_3]), true)
		...
		var_29_3(var_29_2, var_8.GAME_OPERATION, {
...
function var_0_1.updateGameUI(arg_34_0)
	...
	var_1_10001(var_34_0, var_3.ceil(arg_34_0.gameTime))
...
function var_0_1.onGameOver(arg_35_0, arg_35_1)
	...
	var_2(var_3(arg_35_0._tf, "scene_container"), false)
	...
	local var_35_1 = var_3(arg_35_0._tf)
	local var_35_2 = arg_35_1

	System = var_5

	var_35_0(var_35_1, var_35_2, var_5.Action(function()
...
function var_0_1.showSettlement(arg_37_0)
	...
	var_37_1(var_37_0, var_1_10003.GAME_OPERATION, {
	...
	if not var_37_5(var_37_6 .. var_5(var_37_4) .. "_" .. var_0_6) then
		var_37_7 = 0
	end
	...
	var_37_8(var_5(arg_37_0.settlementUI, "ad/new"), var_37_7 < var_37_2)

	local var_37_8

	if var_37_7 <= var_37_2 then
		var_37_7 = var_37_2
		PlayerPrefs = var_37_8
		var_37_8 = var_37_8.SetInt

		local var_37_9 = "mg_score_"

		tostring = var_6

		var_37_8(var_37_9 .. var_6(var_37_4) .. "_" .. var_0_6, var_37_7)
	end

	findTF = var_37_8

	local var_37_10 = var_37_8(arg_37_0.settlementUI, "ad/highText")

	findTF = var_5

	local var_37_11 = var_5(arg_37_0.settlementUI, "ad/currentText")

	setText = var_6

	var_6(var_37_10, var_37_7)

	setText = var_6

	var_6(var_37_11, var_37_2)
...
function var_0_1.checkGameExit(arg_42_0)
	if not arg_42_0.gameStartFlag then
		...
		var_42_1(var_42_0, var_1_10003.GAME_OPERATION, {
		...
		if arg_42_0.contextData.isDorm3d then
			...
			local var_42_4 = var_1_10003.NewStyleMsgboxMgr.TYPE_MSGBOX
			...
			function var_1_10004.onConfirm()
				...
				var_43_1(var_43_0, var_2_10002.GAME_OPERATION, {
					operationCode = "GAME_CLOSE",
					doTrack = false,
					miniGameId = var_0_6
				})
			...
			var_42_3(var_42_2, var_42_4, var_1_10004)
		else
			pg = var_42_3
			...
			i18n = var_1_10004
			var_42_7.content = var_1_10004("mini_game_leave")
			...
			function var_42_7.onYes()
				...
				var_45_1(var_45_0, var_2_10002.GAME_OPERATION, {
					operationCode = "GAME_CLOSE",
					doTrack = false,
					miniGameId = var_0_6
				})
...
function var_0_1.willExit(arg_47_0)
	if arg_47_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_47_0.handle)
	end
	...
	if arg_47_0._tf then
		...
		if var_47_0(var_1_10002(arg_47_0._tf)) then
			LeanTween = var_1
