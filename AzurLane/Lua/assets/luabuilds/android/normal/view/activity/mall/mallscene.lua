...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.animDft = var_2_1(var_2_0, var_1_10003(var_1_10004))
	...
	local function var_2_11()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.mall_help.tip
	...
	local function var_2_14()
		...
		local var_7_2 = var_2_10002.CHANGE_SCENE

		SCENE = var_2_10003

		var_7_1(var_7_0, var_7_2, var_2_10003.MALL_MAP)
	...
	local function var_2_26()
		...
		MallAwardMediator = var_2_10005
		var_12_4.mediator = var_2_10005
		MallAwardLayer = var_2_10005
	...
	local function var_2_29()
		...
		var_2_10000(var_14_0, var_2("mall_right_title_summary"))
	...
	var_1(var_2_27, var_2_28, var_2_29, var_1_10005)
	...
	local function var_2_32()
		...
		var_2_10000(var_15_0, var_2("mall_right_title_upgrade"))
	...
	var_1(var_2_30, var_2_31, var_2_32, var_1_10005)
	...
	arg_2_0.upgradeUIList = var_2_33(var_2_34, var_3.Find(var_2_35, "tpl"))
	...
	var_1(var_2_39, var_3("mall_round_header"))
	...
	var_1(var_2_40, var_3("mall_level_header"))

	setText = var_1

	local var_2_41 = arg_2_0.uiRightUpgradeTF
	local var_2_42 = var_2.Find(var_2_41, "max/Text")

	i18n = var_2_41

	var_1(var_2_42, var_2_41("mall_level_max"))
...
function var_0_1.UpdateData(arg_18_0)
	...
	arg_18_0.activity = var_18_1(var_18_0, var_1_10003.ACTIVITY_TYPE_MALL)
	assert = var_1

	local var_18_3

	if arg_18_0.activity then
		local var_18_2 = arg_18_0.activity

		var_18_3 = not var_2.isEnd(var_18_2)
	end

	local var_18_4 = "not exist mall act, type: "

	ActivityConst = var_1_10004

	var_1(var_18_3, var_18_4 .. var_1_10004.ACTIVITY_TYPE_MALL)

	local var_18_5 = arg_18_0.activity

	arg_18_0.levelDate = var_1.GetLevelData(var_18_5)

	local var_18_6 = arg_18_0.levelDate

	arg_18_0.conditionList = var_1.getConfig(var_18_6, "upgrade_task")

	local var_18_7 = arg_18_0.levelDate

	arg_18_0.conditionDescList = var_1.getConfig(var_18_7, "upgrade_task_desc")
	getProxy = var_1
	ActivityProxy = var_18_7

	local var_18_8 = var_1(var_18_7)
	local var_18_9 = var_1.getActivityById
	local var_18_10 = arg_18_0.activity
	local var_18_11 = var_18_9(var_18_8, var_3.getConfig(var_18_10, "config_id"))

	ActivityPtData = var_18_8
	arg_18_0.curPt = var_18_8.New(var_18_11).count
...
function var_0_1.UpdateView(arg_19_0)
	...
	var_1_10001(var_19_0, var_3.GetGold(var_19_1))
	...
	var_1_10001(var_19_2, var_3.GetRound(var_19_3))
	...
	var_19_4(var_3.Find(var_19_6, "conditions"), not var_19_5)

	setActive = var_19_4

	local var_19_7 = arg_19_0.uiRightUpgradeTF

	var_19_4(var_3.Find(var_19_7, "max"), var_19_5)
...
function var_0_1.UpdateStartBtn(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_3.GetFloorList(var_22_1)) do
	...
	if var_22_0 then
		...
		local function var_22_4()
			...
			var_23_1(var_23_0, var_2_10002("mall_floor_all_empty_tip"))
		...
		var_2(var_22_2, var_22_3, var_22_4, iter_22_1)
	...
	local function var_22_15()
		...
		var_25_1(var_25_0, var_2_10002.SETTLE_ROUND, arg_22_0.activity.id)
	...
	var_9(var_22_13, var_22_14, var_22_15, var_1_10013)
	...
	local function var_22_18()
		...
		if var_22_5 then
			...
			var_26_1(var_26_0, var_2_10002("mall_unlock_date_tip", var_22_6, var_22_7))
		else
			pg = var_26_1
			...
			var_26_3(var_26_2, var_2_10002("mall_finished_all_tip"))
		end
	...
	var_9(var_22_16, var_22_17, var_22_18, var_1_10013)
...
function var_0_1.UpdateConditionTpl(arg_27_0, arg_27_1, arg_27_2)
	...
	MallLevel = var_1_10011
	var_27_6[var_1_10011.CONDITION_TYPE.ROUND] = function()
	...
	MallLevel = var_11
	var_27_6[var_11.CONDITION_TYPE.ORDER] = function()
	...
	MallLevel = var_11
	var_27_6[var_11.CONDITION_TYPE.ROUND_INCOME] = function()
	...
	MallLevel = var_11
	var_27_6[var_11.CONDITION_TYPE.FLOOR_INCOME] = function()
	...
	var_27_5(arg_27_2:Find("unfinished"), not var_27_7)

	setActive = var_27_5

	var_27_5(arg_27_2:Find("finished"), var_27_7)

	if not var_27_7 or not var_27_2 then
		::label_27_0::

		setColorStr = var_27_5
		var_27_5 = var_27_5(var_27_2, "#bd5d4a")
	end

	string = var_10

	local var_27_8 = var_10.gsub(var_27_4, "$1", var_27_5)
...
function var_0_1.UpdateFloorTpl(arg_34_0, arg_34_1, arg_34_2)
	...
	var_34_1(arg_34_2:Find("lock"), not var_34_2)
	...
	local var_34_5 = var_34_3.reduce(var_34_4, 0, function(arg_35_0, arg_35_1)
		return arg_35_0 + (arg_35_1 ~= 0 and 1 or 0)
	end)

	setActive = var_7

	var_7(arg_34_2:Find("bg"), var_34_5 ~= 0)

	setActive = var_7

	var_7(arg_34_2:Find("empty"), var_34_5 == 0)

	setText = var_7

	var_7(arg_34_2:Find("rank/Text"), var_34_5 .. "/" .. #var_34_4)
	...
	for iter_34_2, iter_34_3 in var_8(var_34_4) do
		if iter_34_3 ~= 0 then
			...
			for iter_34_4, iter_34_5 in var_34_7(var_34_8:GetAttrList()) do
	...
	local function var_34_15()
		...
		local var_39_2 = var_2_10002.GO_SUBLAYER
		...
		MallStaffMediator = var_2_10005
		var_39_4.mediator = var_2_10005
		MallStaffLayer = var_2_10005
		var_39_4.viewComponent = var_2_10005
		var_39_4.data = {
			floorId = var_0.id
		}
	...
	var_12(var_34_13, var_34_14, var_34_15, var_16)
...
function var_0_1.StartTimer(arg_40_0)
	...
	arg_40_0.timer = var_1.New(function()
		...
		local var_41_4 = var_2.Find(var_41_3, "Text")

		pg = var_41_3

		local var_41_5 = var_41_3.TimeMgr.GetInstance()

		var_1(var_41_4, var_3.DescCDTime(var_41_5, var_41_2))
...
function var_0_1.IsOrderTip()
	...
	local var_49_2 = var_49_1(var_49_0, var_1_10002.ACTIVITY_TYPE_MALL)
	...
	local var_49_6 = var_49_4.detect

	pg = var_1_10004

	local var_49_7 = var_49_6(var_1_10004.activity_mall_custom_order.all, function(arg_50_0)
		table = var_2_10001
	...
	local var_49_8 = var_4.activity_mall_custom_order[var_49_7]
...
function var_0_1.IsMapTip()
	...
	local var_51_0 = var_1_10000(var_1_10001)
	local var_51_1 = var_0.getActivityByType

	ActivityConst = var_1_10002

	local var_51_2 = var_51_1(var_51_0, var_1_10002.ACTIVITY_TYPE_MALL)
	...
	return #var_51_4.select(var_51_5, function(arg_52_0)
		pg = var_2_10001
