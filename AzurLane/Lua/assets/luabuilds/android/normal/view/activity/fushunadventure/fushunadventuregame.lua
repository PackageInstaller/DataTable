...
function var_0_0.InitMainUI(arg_9_0)
	...
	local var_9_2 = var_1_10004(var_9_0, "btn_help")
	...
	var_1_10002(var_9_1, var_9_2, var_9_3, var_6)
	...
	var_1_10002(var_9_4, var_9_5, var_9_6, var_6)
	...
	findTF = var_4
	arg_9_0.levelList = var_9_7(var_9_8, var_4(var_9_0, "levels/scrollrect/content/level"))
	findTF = var_2
	...
	var_2(var_9_9, var_4(var_9_0, "levels/scrollrect"), function(arg_12_0)
...
function var_0_0.RefreshLevels(arg_13_0)
	...
	var_2.make(var_13_1, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			local var_14_2 = var_14_1(var_14_0, var_5(var_2_10006))

			GetSpriteFromAtlas = var_14_0
			var_14_2.sprite = var_14_0("ui/minigameui/FushunAdventureGame_atlas", "level_" .. arg_14_1 + 1)
			...
			var_5(arg_14_2:Find("lock"), var_14_4)
			...
			typeof = var_8
			Image = var_9
			var_14_7(var_14_6, var_8(var_9)).enabled = not var_14_4
		end
	...
	var_13_3(var_13_2, var_4.LEVEL_CNT)
...
function var_0_0.InitGameUI(arg_15_0)
	...
	local var_15_6 = var_15_4(var_15_0, "UI/keys/1")
	local var_15_7 = var_3.GetComponent

	typeof = var_5
	Image = var_1_10006
	var_15_5[1] = var_15_7(var_15_6, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Image = var_1_10006
	var_15_5[2] = var_15_9(var_15_8, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Image = var_1_10006
	var_15_5[3] = var_15_11(var_15_10, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	var_15_12[2] = var_15_14(var_15_13, var_5(var_1_10006)).sprite
	...
	typeof = var_5
	Image = var_1_10006
	var_15_12[3] = var_15_16(var_15_15, var_5(var_1_10006)).sprite
	...
	typeof = var_4
	Text = var_5
	arg_15_0.scoreTxt = var_15_20(var_15_19, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Image = var_5
	arg_15_0.energyBar = var_15_22(var_15_21, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Text = var_5
	arg_15_0.comboTxt = var_15_24(var_15_23, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Text = var_5
	arg_15_0.resultHighestScoreTxt = var_15_26(var_15_25, var_4(var_5))
	findTF = var_2
	...
	typeof = var_4
	Text = var_5
	arg_15_0.resultScoreTxt = var_15_28(var_15_27, var_4(var_5))
	findTF = var_2
...
function var_0_0.EnterAnimation(arg_16_0, arg_16_1)
	...
	FushunAdventureGameConst = var_6

	var_16_3(var_16_2, var_6.COUNT_DOWN_VOICE)
...
function var_0_0.ShowHelpWindow(arg_19_0, arg_19_1)
	...
	local function var_19_2()
		...
		local var_20_2 = var_2(var_2_10003)

		var_20_0(var_20_1 .. var_2.getRawData(var_20_2).id, 1)
		arg_19_1()
	...
	var_1_10002(var_19_0, var_19_1, var_19_2, var_1_10006)
...
function var_0_0.DisplayeEnergy(arg_25_0, arg_25_1, arg_25_2)
	...
	math = var_1_10009
	var_25_3.x = var_1_10009.max(0, var_25_1)

	var_1_10006(var_25_2, var_25_3)
	...
	Vector2 = var_8
	var_25_5.sizeDelta = var_8(var_25_4, arg_25_0.energyLight.sizeDelta.y)
...
function var_0_0.StartGame(arg_27_0)
	...
	arg_27_0:LoadScene(function()
		...
		FushunAdventureGameConst = var_2_10003

		var_28_2(var_28_1, var_28_3, var_2_10003.GAME_BGM_NAME)
...
function var_0_0.LoadScene(arg_29_0, arg_29_1)
	...
	var_1_10002({
		...
		function(arg_32_0)
			...
			local var_32_5 = var_3(var_4)

			if not (var_32_3(var_32_4 .. var_3.getRawData(var_32_5).id, 0) > 0) then
...
function var_0_0.EnterGame(arg_37_0)
	...
	local var_37_0 = var_1

	var_1.AddListener(var_37_0, arg_37_0.handle)

	local var_37_1 = arg_37_0.lightTF

	Vector2 = var_37_0
	FushunAdventureGameConst = var_3
	var_37_1.sizeDelta = var_37_0(var_3.FUSHUN_ATTACK_RANGE, arg_37_0.lightTF.sizeDelta.y)

	local var_37_2 = arg_37_0.lightTF

	Vector2 = var_2
	FushunAdventureGameConst = var_3

	local var_37_3 = var_3.FUSHUN_ATTACK_DISTANCE
	local var_37_4 = arg_37_0.fushun

	var_37_2.localPosition = var_2(var_37_3 + var_4.GetPosition(var_37_4).x, arg_37_0.lightTF.localPosition.y)
	...
	local var_37_5 = arg_37_0.fushun

	var_1.SetOnAnimEnd(var_37_5, function()
		arg_37_0.key = ""
...
function var_0_0.UpdateGame(arg_39_0)
	...
	if not arg_39_0.pause then
		...
		local var_39_10 = var_4.GetEnergy(var_39_9)
		local var_39_11 = arg_39_0.fushun

		var_39_8(var_39_7, var_39_10, var_5.GetEnergyTarget(var_39_11))
...
function var_0_0.EnterInvincibleMode(arg_43_0)
	...
	var_3.AddSchedule(var_43_3, var_43_0, 1, function()
		...
		FushunAdventureGameConst = var_2

		var_44_3(var_44_2, var_2.ENTER_EX_VOICE)
...
function var_0_0.ExitInvincibleMode(arg_46_0)
	...
	Color = var_46_0
	var_46_1.color = var_46_0.New(1, 1, 1, 1)
	LeanTween = var_46_1
...
function var_0_0.CheckCollision(arg_47_0, arg_47_1, arg_47_2)
	if var_0_0.IsCollision(arg_47_2.effectCollider2D, arg_47_1.collider2D) then
		...
		var_47_1(var_47_0, var_5.GetHp(var_47_2))
...
function var_0_0.AddHitEffect(arg_48_0, arg_48_1)
	...
	local var_48_7 = var_48_5(var_48_6.x, var_48_2.y, 0)
	...
	arg_48_0:loadPrefab("ui/fa_attack_effect", function(arg_49_0)
		...
		local var_49_3 = var_49_2(var_49_1, var_3(var_4))
...
function var_0_0.ShakeScreen(arg_51_0, arg_51_1)
	...
	local var_51_2 = var_1_10004(0, 0, 1)

	FushunAdventureGameConst = var_5

	local var_51_3 = var_5.SHAKE_RANGE

	FushunAdventureGameConst = var_6

	local var_51_4 = var_51_0(var_51_1, var_51_2, var_51_3, var_6.SHAKE_TIME)
	...
	local var_51_8 = var_51_7(var_51_6, -1 * var_4.SHAKE_RANGE)
	local var_51_9 = var_2.setOnComplete

	System = var_4

	var_51_9(var_51_8, var_4.Action(function()
...
function var_0_0.SpawnEnemys(arg_53_0)
	...
	local function var_53_2(arg_55_0)
		...
		var_55_6(var_55_5, var_9.ENEMY_SPAWN_POSITION)
	...
	arg_53_0.spawner = var_53_3(var_5.Find(var_53_4, "game").transform, var_53_2)
...
function var_0_0.AddScore(arg_56_0, arg_56_1)
	...
	arg_56_0.AddCombo(var_56_0, 1)

	local var_56_1 = arg_56_0.combo

	FushunAdventureGameConst = var_56_0

	if var_56_1 >= var_56_0.COMBO_SCORE_TARGET then
		FushunAdventureGameConst = var_56_1

		local var_56_2

		if not var_56_1.COMBO_EXTRA_SCORE then
			var_56_2 = 0
		end

		arg_56_0.score = arg_56_0.score + arg_56_1 + var_56_2

		arg_56_0:DisplayScore()

		local var_56_3 = arg_56_0.spawner

		var_3.UpdateScore(var_56_3, arg_56_0.score)
...
function var_0_0.AddCombo(arg_58_0, arg_58_1)
	if arg_58_1 > 0 then
		arg_58_0:loadPrefab("UI/fushun_combo", function(arg_59_0)
			...
			var_59_1(var_59_0, var_3.Find(var_59_2, "UI"), false)

			local var_59_3

			Timer = var_59_0

			local var_59_4 = var_59_0.New(function()
				if arg_59_0 then
					Destroy = var_0
...
function var_0_0.Action(arg_61_0, arg_61_1)
	...
	if var_2.InvincibleState(var_61_0) then
		...
		FushunAdventureGameConst = var_1_10004

		var_61_2(var_61_1, var_1_10004.EX_CLICK_SCORE)
	else
...
function var_0_0.OnFushunAttack(arg_62_0, arg_62_1)
	if #arg_62_0.key ~= 3 then
		...
		if not var_2.IsMissState(var_62_0) then
			...
			local var_62_2 = {}
			local var_62_3 = arg_62_0.fushun

			ipairs = var_1_10004

			for iter_62_0, iter_62_1 in var_1_10004(arg_62_0.enemys) do
				if not iter_62_1:WillDeath() and iter_62_1:GetPosition().x <= var_62_3:GetAttackPosition().x then
					table = var_9

					var_9.insert(var_62_2, iter_62_0)
				end
			end

			local var_62_4 = arg_62_0.fushun

			var_4.TriggerAction(var_62_4, arg_62_0.key, function()
				if #var_62_2 == 0 then
			...
			if #var_62_2 > 0 then
				...
				for iter_62_2, iter_62_3 in var_4(var_62_2) do
					local var_62_5 = arg_62_0.enemys[iter_62_3]

					var_9.Hurt(var_62_5, 1)
...
function var_0_0.ExitGame(arg_66_0, arg_66_1)
	...
	if arg_66_0.btnA then
		...
		var_3(var_4.GetComponent(var_66_1, "EventTriggerListener"))
	end
	...
	if arg_66_0.btnB then
		...
		var_3(var_4.GetComponent(var_66_2, "EventTriggerListener"))
	end
...
function var_0_0.ClearGameScene(arg_69_0)
	...
	if arg_69_0.gameUI then
		...
		FushunAdventureGameConst = iter_69_0

		var_69_3(var_69_2, var_69_4, iter_69_0.BGM_NAME)
	end
...
function var_0_0.AddDebugInput(arg_72_0)
	...
	if var_1_10001 then
		...
		if var_72_0(var_1_10002.A) then
			var_72_1 = arg_72_0
		...
		if var_72_2(var_72_1.A) then
			...
			var_72_4(var_72_3, var_3.A_BTN_VOICE)
		end
		...
		if var_72_7(var_72_6.S) then
			...
			var_72_9(var_72_8, var_3.B_BTN_VOICE)
		end
	end
...
function var_0_0.RegisterEventListener(arg_73_0)
	...
	var_1:AddPointUpFunc(function()
		...
		var_76_3(var_76_2, var_2.A_BTN_VOICE)
	...
	var_2:AddPointUpFunc(function()
		...
		var_79_3(var_79_2, var_2.B_BTN_VOICE)
	...
	var_3(var_73_4, var_73_5, var_73_6, var_1_10007)
	...
	var_3(var_73_7, var_73_8, var_73_9, var_1_10007)
...
function var_0_0.ShowResultWindow(arg_83_0, arg_83_1)
	...
	var_1_10002(var_83_0, var_83_1, var_83_2, var_1_10006)
...
function var_0_0.ShowPauseMsgbox(arg_86_0)
	...
	local var_86_2 = var_3.Find(var_86_1, "continue_btn")
	...
	var_1(var_86_0, var_86_2, var_86_3, var_5)
...
function var_0_0.ShowExitMsgbox(arg_89_0)
	...
	local var_89_2 = var_3.Find(var_89_1, "cancel_btn")
	...
	var_1(var_89_0, var_89_2, var_89_3, var_5)

	onButton = var_1

	local var_89_4 = arg_89_0
	local var_89_5 = arg_89_0.exitMsgboxWindow
	local var_89_6 = var_3.Find(var_89_5, "confirm_btn")
	...
	var_1(var_89_4, var_89_6, var_89_7, var_5)
