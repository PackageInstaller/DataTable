...
function var_0_1.OnClickItem(arg_8_0)
	...
	if var_1.id and var_1.id ~= 0 then
		...
		local var_8_2 = var_1_10004.ON_ADD_SUBLAYER

		Context = var_1_10005
		var_1_10005 = var_1_10005.New
		var_1_10006 = {}
		AuctionGameCollectionInfoLayer = var_1_10007
		var_1_10006.viewComponent = var_1_10007
		AuctionGameCollectionInfoMediator = var_1_10007
		var_1_10006.mediator = var_1_10007
		var_1_10006.data = {
			id = var_1.id
		}

		var_8_1(var_8_0, var_8_2, var_1_10005(var_1_10006))
	else
		local var_8_3

		if var_1.showContour then
			var_8_3 = var_1.contour
		end

		local var_8_4 = arg_8_0
		local var_8_5 = arg_8_0.emit

		BaseUI = var_1_10005

		local var_8_6 = var_1_10005.ON_ADD_SUBLAYER
		...
		AuctionGameCollectionListLayer = var_1_10008
		var_8_8.viewComponent = var_1_10008
		AuctionGameCollectionListMediator = var_1_10008
...
function var_0_1.ShowSize(arg_9_0, arg_9_1)
	if arg_9_1.contour then
		...
		local var_9_2 = var_9_1 * var_1_10005.CELL_WIDTH
		local var_9_3 = arg_9_1.contour[2]

		AuctionGameConst = var_1_10006
		var_9_0.sizeDelta = var_1_10003(var_9_2, var_9_3 * var_1_10006.CELL_HEIGHT)
	end
...
function var_0_1.ShowRarity(arg_10_0, arg_10_1)
	...
	if arg_10_1.showContour then
		...
		var_2(var_10_0, var_4.format("main_cell_item_rarity_%s", arg_10_1.rarity), function(arg_11_0)
			IsNil = var_2_10001
		...
		var_2(var_10_1, var_4.format("main_cell_item_contour_rarity_%s", arg_10_1.rarity), function(arg_12_0)
			IsNil = var_2_10001
	...
	var_2(var_10_2, var_4.format("main_cell_item_frame_rarity_%s", arg_10_1.rarity), function(arg_13_0)
		IsNil = var_2_10001
...
function var_0_1.willExit(arg_17_0)
	...
	if arg_17_0.effectGo then
		...
		AuctionGameTools = var_1_10003

		var_17_1(var_17_0, var_1_10003.GetRevealItemEffectName(arg_17_0.data.id), "", arg_17_0.effectGo, true)
	end
