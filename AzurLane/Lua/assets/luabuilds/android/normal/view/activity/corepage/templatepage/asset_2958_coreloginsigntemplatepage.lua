...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1.make(var_3_0, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_2 = var_4_0.Create(arg_3_0.config.front_drops[arg_4_1 + 1])

			updateDrop = var_5

			var_5(var_4_1, var_4_2)
			...
			var_5(var_4_3, var_4_4, var_4_5, var_2_10009)
			...
			var_4_9, setText = arg_4_2.Find(var_4_8, "day/Text"), var_4_8
			...
			if arg_4_1 < arg_3_0.nday then
				...
				if not var_4_10("word_status_inEventFinished") then
					i18n = var_4_10
					var_4_10 = var_4_10("which_day_2", arg_4_1 + 1)
				end
