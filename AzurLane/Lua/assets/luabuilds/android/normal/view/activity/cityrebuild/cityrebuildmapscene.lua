...
function var_0_1.init(arg_2_0)
	...
	local var_2_13 = var_2.Find(var_2_12, "charas")
	local var_2_14 = arg_2_0._tf

	arg_2_0.charaList = var_2_11(var_2_13, var_3.Find(var_2_14, "charas/chara"))
	UIItemList = var_1

	local var_2_15 = var_1.New
	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "buildings")
	local var_2_18 = arg_2_0._tf

	arg_2_0.buildingList = var_2_15(var_2_17, var_3.Find(var_2_18, "buildings/building"))
	UIItemList = var_1

	local var_2_19 = var_1.New
	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_2.Find(var_2_20, "stories")
	local var_2_22 = arg_2_0._tf

	arg_2_0.storyList = var_2_19(var_2_21, var_3.Find(var_2_22, "stories/story"))
	setText = var_1

	local var_2_23 = arg_2_0.ui
	local var_2_24 = var_2.Find(var_2_23, "right/tip")

	i18n = var_2_23

	var_1(var_2_24, var_2_23("ninja_game_booktip"))

	setText = var_1

	local var_2_25 = arg_2_0.ui
	local var_2_26 = var_2.Find(var_2_25, "left/cityLevel/title")

	i18n = var_2_25

	var_1(var_2_26, var_2_25("ninja_game_citylevel"))

	setText = var_1

	local var_2_27 = arg_2_0.ui
	local var_2_28 = var_2.Find(var_2_27, "left/battleLevel/title")

	i18n = var_2_27

	var_1(var_2_28, var_2_27("ninja_game_wave"))
...
function var_0_1.didEnter(arg_3_0)
	...
	CityRebuildMapMediator = var_1_10003

	var_3_1(var_3_0, var_1_10003.GET_DATA, arg_3_0.activityId)
	...
	var_3_1(var_3_2, var_3_3, var_3_4, var_1_10005)
	...
	var_3_1(var_3_5, var_3_6, var_3_7, var_1_10005)
	...
	local function var_3_10()
		...
		CityRebuildMapMediator = var_2_10002

		var_6_1(var_6_0, var_2_10002.OPEN_BATTLE)
	...
	var_3_1(var_3_8, var_3_9, var_3_10, var_1_10005)
	...
	var_3_1(var_3_11, var_3_12, var_3_13, var_1_10005)
	...
	local function var_3_16()
		...
		var_8_1(var_8_0, var_2_10002.OPEN_BOOK)
	...
	var_3_1(var_3_14, var_3_15, var_3_16, var_1_10005)
	...
	local function var_3_19()
		...
		var_9_1(var_9_0, var_2_10002.OPEN_STORY)
	...
	var_3_1(var_3_17, var_3_18, var_3_19, var_1_10005)
	...
	local function var_3_22()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.ninja_game_helper.tip
	...
	var_3_1(var_3_20, var_3_21, var_3_22, var_1_10005)
...
function var_0_1.InitData(arg_11_0)
	...
	arg_11_0.taskProxy = var_1(var_1_10002)
	pg = var_1
...
function var_0_1.Refresh(arg_12_0)
	...
	var_12_1(var_3.Find(var_12_3, "title"), var_12_2:getConfig("desc"))

	setText = var_12_1

	local var_12_4 = arg_12_0.award

	var_12_1(var_3.Find(var_12_4, "title/Text"), var_12_2:getProgress() .. "/" .. var_12_2:getTargetNumber())
	...
	var_4(var_5.Find(var_12_7, "IconTpl"), var_12_6)

	local var_12_8 = var_12_2
	local var_12_9 = var_12_2.isReceive(var_12_8)

	setActive = var_12_8

	local var_12_10 = arg_12_0.award

	var_12_8(var_6.Find(var_12_10, "got"), var_12_9)
	...
	var_12_8(var_12_11, var_12_12, var_12_13, var_1_10009)
	...
	for iter_12_0 = 2, 5 do
		...
		local var_12_15 = var_9.Find(var_12_14, "bg/" .. iter_12_0)

		setActive = var_12_14

		var_12_14(var_12_15, iter_12_0 > arg_12_0.cityRebuildData.cityLevel)
	end

	setActive = var_5

	local var_12_16 = arg_12_0.bookBtn
	local var_12_17 = var_6.Find(var_12_16, "tip")

	CityRebuildBookLayer = var_12_16

	var_5(var_12_17, var_12_16.ShouldShowTip())

	setActive = var_5

	local var_12_18 = arg_12_0.taskBtn
	local var_12_19 = var_6.Find(var_12_18, "tip")

	CityRebuildTasksLayer = var_12_18

	var_5(var_12_19, var_12_18.ShouldShowTip())
...
function var_0_1.SetCharaList(arg_14_0)
	...
	var_1.make(var_14_0, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			var_2_10008(arg_15_2, var_15_3 ~= "")

			if var_15_3 ~= "" then
				GetImageSpriteFromAtlasAsync = var_2_10008

				var_2_10008(var_15_3, "", arg_15_2)

				Vector2 = var_2_10008
				arg_15_2.anchoredPosition = var_2_10008(var_15_4[1], var_15_4[2])
				setActive = var_8
...
function var_0_1.SetBuildingList(arg_16_0)
	...
	var_1.make(var_16_0, function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			var_2_10009(arg_17_2, var_17_6 ~= "")

			if var_17_6 ~= "" then
				GetImageSpriteFromAtlasAsync = var_2_10009

				var_2_10009(var_17_6, "", arg_17_2)

				Vector2 = var_2_10009
				arg_17_2.anchoredPosition = var_2_10009(var_17_7[1], var_17_7[2])
				setActive = var_9
				...
				if var_17_5 then
					...
					local function var_17_10()
						...
						CityRebuildMapMediator = var_3_10002

						local var_18_2 = var_3_10002.OPEN_BOOK

						CityRebuildBookLayer = var_3_10003

						var_18_1(var_18_0, var_18_2, var_3_10003.Building, var_17_0)
					...
					var_9(var_17_8, var_17_9, var_17_10, var_2_10013)
	...
	var_2.make(var_19_1, function(arg_20_0, arg_20_1, arg_20_2)
		...
		if arg_20_0 == var_2_10003.EventUpdate then
			...
			if var_20_3 ~= "" then
				...
				local var_20_5 = var_2_10009.NewStoryMgr.GetInstance()

				var_20_6 = not var_9.IsPlayed(var_20_5, var_20_3[1])
			else
				var_20_6 = false
			end
			...
			var_7(var_20_4, var_20_6)

			if var_20_3 ~= "" then
				pg = var_7

				local var_20_7 = var_7.NewStoryMgr.GetInstance()

				if not var_7.IsPlayed(var_20_7, var_20_3[1]) then
					GetImageSpriteFromAtlasAsync = var_7

					var_7(var_20_3[2], "", arg_20_2:Find("icon"))

					local var_20_8 = var_20_3[3]

					Vector2 = var_8
					arg_20_2.anchoredPosition = var_8(var_20_8[1], var_20_8[2])
					onButton = var_8
					...
					var_8(var_20_9, var_20_10, var_20_11, var_12)
