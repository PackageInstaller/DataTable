...
function var_0_0.Init(arg_2_0, arg_2_1)
	...
	typeof = var_4
	Text = var_5
	arg_2_0.score = var_2_9(var_2_8, var_4(var_5))
	...
	typeof = var_4
	Text = var_5
	arg_2_0.heartProgressTxt = var_2_13(var_2_12, var_4(var_5))
	TowerClimbBgMgr = var_2

	local var_2_14 = var_2.New
	local var_2_15 = arg_2_0._tf

	arg_2_0.bg = var_2_14(var_3.Find(var_2_15, "bgs"))
...
function var_0_0.LoadSingleEffect(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	var_4.GetUI(var_4_0, arg_4_1, true, function(arg_5_0)
		if not arg_4_0.groundContainer then
			...
			Vector3 = var_2
			var_5_1.anchoredPosition3D = var_2(arg_4_2[1], arg_4_2[2], -200)
			setActive = var_5_1
	...
	if var_1_10002.MAPID2EFFECT[arg_6_1] then
		...
		for iter_6_0, iter_6_1 in var_1_10003(var_2) do
			...
			if var_9.Find(var_6_1, var_6_0) then
				...
				local var_6_2 = var_6_1.GetInstance()

				var_10.ReturnUI(var_6_2, var_6_0, var_9.gameObject)
			end
		end
	end
...
function var_0_0.OnReachAwardScore(arg_7_0)
	...
	local function var_7_6()
		local function var_9_0()
			...
			Timer = var_1
			var_10_0.awardTimer = var_1.New(function()
		...
		if not arg_7_0.awardEffect1 then
			...
			var_9_3(var_9_2, var_2_10004.AWARDEFFECT1, var_9_1, function(arg_12_0)
	...
	local function var_7_7()
		...
		var_13_2(var_13_3, var_2_10004(var_7_5.x, var_7_5.y, -200))
		...
		var_13_4(var_13_5, var_4(var_7_3.x, var_7_3.y, -200))

		local var_13_6 = arg_7_0.awardEffect.transform

		Vector3 = var_13_5
		var_13_6.localPosition = var_13_5(var_7_5.x, var_7_5.y, -200)
		setActive = var_13_6
		...
		var_13_8(var_13_7, var_4.Action(function()
			setActive = var_3_10000
	...
	if not arg_7_0.awardEffect then
		...
		var_7_10(var_7_9, var_1_10008.AWARDEFFECT, var_7_8, function(arg_15_0)
...
function var_0_0.OnCreateGround(arg_19_0, arg_19_1, arg_19_2)
	...
	var_1_10003.GetGround(arg_19_1.name, function(arg_20_0)
		...
		var_2(var_3.Find(var_20_2, "Text"), "")
		arg_19_2()
...
function var_0_0.TranslateBlockPosition(arg_21_0, arg_21_1)
	...
	return var_21_1(var_21_0, var_4.TransformVector(var_21_2, arg_21_1))
end
...
function var_0_0.OnCreateBlock(arg_22_0, arg_22_1, arg_22_2)
	...
	var_1_10003.GetBlock(arg_22_1.type, function(arg_23_0)
		...
		local var_23_4 = var_23_3(var_23_2, var_3(var_4.Collider2D))
		local var_23_5 = var_1.ToTable(var_23_4)

		table = var_23_4

		var_23_4.insert(arg_22_0.blocks, {
			go = arg_23_0,
			block = arg_22_1,
			colliders = var_23_5
		})
		...
		TowerClimbingGameSettings = var_23_6

		local var_23_8 = var_23_6.FIRE_TIME[2]

		math = var_4

		local var_23_9 = var_4.random(var_23_7, var_23_8)
		...
		if var_5.Find(var_23_10, "firer") then
			...
			local var_23_13 = var_23_12(var_23_11, var_2_10008(var_2_10009))
			local var_23_14 = arg_22_0.timers
			local var_23_15 = arg_22_1.level

			Timer = var_2_10009
			var_23_14[var_23_15] = var_2_10009.New(function()
...
function var_0_0.OnActiveBlock(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in var_3(var_25_0.colliders) do
...
function var_0_0.SinkHandler(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_4 = var_27_3(var_27_2, var_7.Action_float(function(arg_28_0)
	...
	local var_27_6 = var_27_5(var_27_4, var_7.easeOutQuad)
	local var_27_7 = var_5.setOnComplete

	System = var_7

	var_27_7(var_27_6, var_7.Action(arg_27_2))
...
function var_0_0.OnBlockDestory(arg_29_0, arg_29_1)
	...
	TowerClimbingResMgr = var_3

	var_3.ReturnBlock(var_29_2.block.type, var_29_2.go)
...
function var_0_0.OnEnableStab(arg_35_0, arg_35_1, arg_35_2)
	...
	local var_35_3 = var_35_2(var_35_1, var_1_10006(var_1_10007.Collider2D))

	ipairs = var_35_1

	for iter_35_0, iter_35_1 in var_35_1(var_35_0.colliders) do
...
function var_0_0.OnEnableGround(arg_37_0, arg_37_1)
	...
	var_37_1(var_37_0, var_1_10004(var_1_10005.Collider2D)).enabled = arg_37_1
...
function var_0_0.OnGroundSleepTimeChange(arg_42_0, arg_42_1)
	...
	if 0 < var_42_0 then
		...
		var_3(var_4.Find(var_42_1, "Text"), var_42_0)
	else
		setText = var_3

		local var_42_2 = arg_42_0.groundGo.transform

		var_3(var_4.Find(var_42_2, "Text"), "")
	end
