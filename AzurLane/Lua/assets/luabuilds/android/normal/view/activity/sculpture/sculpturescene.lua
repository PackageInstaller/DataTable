...
function var_0_1.GetBaseActivity(arg_3_0)
	...
	return var_3_1(var_3_0, var_1_10003.ACTIVITY_TYPE_VIRTUAL_BAG)
end
...
function var_0_1.init(arg_5_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.awardTxt = var_5_5(var_5_4, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_5_0.oreIcon = var_5_9(var_5_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.oreTxt = var_5_12(var_5_11, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_5_0.featherIcon = var_5_16(var_5_15, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.featherTxt = var_5_19(var_5_18, var_3(var_1_10004))
	...
	SculptureMsgBoxPage = var_2
	var_5_21.msgBoxPage = var_2.New(arg_5_0._tf, arg_5_0.event)
...
function var_0_1.UpdateResIcon(arg_11_0)
	...
	LoadSprite = var_4
	var_11_3.sprite = var_4("props/" .. var_11_2.icon)
	rtf = var_11_3
...
function var_0_1.InitMainView(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10003(var_4.getConfig(var_12_1, "config_data")) do
		table = var_1_10008
		...
		var_1_10008.insert(var_12_0, function(arg_13_0)
			...
			if 0 < var_13_0 then
				...
				var_13_2.insert(arg_12_0.cards, var_13_3)
...
function var_0_1.CreateNewCard(arg_16_0, arg_16_1, arg_16_2)
	...
	local function var_16_3()
		...
		SculptureActivity = var_17_0

		if var_17_1 == var_17_0.STATE_UNLOCK then
	...
	var_4(var_16_1, var_16_2, var_16_3, var_1_10008)
	...
	local function var_16_6()
		...
		var_18_8.content = var_7.getDataConfig(var_18_9, arg_16_2, "describe")
		...
		function var_18_8.onYes()
			...
			SculptureMediator = var_3_10002

			var_19_1(var_19_0, var_3_10002.ON_UNLOCK_SCULPTURE, arg_16_2)
		...
		var_18_8.iconName = var_7.GetResorceName(var_18_10, arg_16_2)
	...
	var_4(var_16_4, var_16_5, var_16_6, var_1_10008)
	...
	local function var_16_9()
		...
		var_20_5.content = var_5.getDataConfig(var_20_6, arg_16_2, "describe")
	...
	var_4(var_16_7, var_16_8, var_16_9, var_1_10008)
	...
	local function var_16_12()
		...
		SculptureActivity = var_21_0

		if var_21_1 == var_21_0.STATE_FINSIH then
			triggerButton = var_1
	...
	var_4(var_16_10, var_16_11, var_16_12, var_1_10008)
	...
	var_4(var_16_13, var_16_14, var_16_15, var_1_10008)
...
function var_0_1.RegisterEvent(arg_23_0, arg_23_1)
	...
	var_1_10002(var_23_0, var_23_1, var_23_2, var_1_10006)
	...
	var_1_10002(var_23_3, var_23_4, var_23_5, var_1_10006)
	...
	var_1_10002(var_23_6, var_23_7, var_23_8, var_1_10006)
	...
	var_1_10002(var_23_9, var_23_10, var_23_11, var_1_10006)
	...
	var_1_10002(var_23_12, var_23_13, var_23_14, var_1_10006)
