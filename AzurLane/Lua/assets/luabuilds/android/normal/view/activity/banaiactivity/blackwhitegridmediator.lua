...
function var_0_1.register(arg_1_0)
	...
	local var_1_2 = var_1_1(var_1_0, var_1_10004.ACTIVITY_TYPE_BLACKWHITE)
	...
	arg_1_0:bind(var_0_1.ON_FINISH, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.BLACK_WHITE_GRID_OP, {
			cmd = 1,
	...
	arg_1_0.bind(var_1_4, var_0_1.ON_UPDATE_SCORE, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.BLACK_WHITE_GRID_OP, {
			cmd = 2,
			activityId = var_1_2.id,
			id = arg_3_1,
			score = arg_3_2
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.BLACK_WHITE_GRID_OP_DONE then
		var_5_3 = {
			function(arg_6_0)
		...
		if var_5_0 == var_5_3.ACTIVITY_UPDATED and arg_5_0.viewComponent.activityVO.id == var_5_2.id then
