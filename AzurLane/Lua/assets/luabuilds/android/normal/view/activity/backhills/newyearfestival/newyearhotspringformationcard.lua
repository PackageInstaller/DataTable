...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.bgImage = var_1_3(var_1_2, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.lvTxt = var_1_8(var_1_7, var_4(var_1_10005))
	...
	arg_1_0.propsTr1 = var_2.Find(var_1_11, "info1")

	local var_1_12 = arg_1_0.detailTF

	arg_1_0.nameTxt = var_2.Find(var_1_12, "name_mask/name")

	local var_1_13 = arg_1_0.content

	arg_1_0.frame = var_2.Find(var_1_13, "front/frame")
	UIItemList = var_2

	local var_1_14 = var_2.New
	local var_1_15 = arg_1_0.content
	local var_1_16 = var_3.Find(var_1_15, "front/stars")
	local var_1_17 = arg_1_0.content

	arg_1_0.UIlist = var_1_14(var_1_16, var_4.Find(var_1_17, "front/stars/star_tpl"))

	local var_1_18 = arg_1_0.content

	arg_1_0.shipState = var_2.Find(var_1_18, "front/flag")
...
function var_0_0.flush(arg_3_0)
	...
	var_4.make(var_3_3, function(arg_4_0, arg_4_1, arg_4_2)
		UIItemList = var_2_10003

		if arg_4_0 == var_2_10003.EventUpdate then
			setActive = var_3

			var_3(arg_4_2:Find("star"), arg_4_1 < var_3_2)
		end
	...
	var_4.align(var_3_4, var_3_1)

	setScrollText = var_4

	var_4(arg_3_0.nameTxt, var_3_0:getName())
	arg_3_0:updateProps({})
	...
	local var_3_5 = arg_3_0.shipVO
	local var_3_6 = var_4.rarity2bgPrint(var_3_5)

	GetImageSpriteFromAtlasAsync = var_3_5

	var_3_5("bg/star_level_card_" .. var_3_6, "", arg_3_0.bgImage)

	local var_3_7, var_3_8 = var_3_0:GetFrameAndEffect(true)

	setRectShipCardFrame = var_7

	var_7(arg_3_0.frame, var_3_6, var_3_7)

	setFrameEffect = var_7

	var_7(arg_3_0.otherBg, var_3_8)

	local var_3_9 = arg_3_0.shipVO
	local var_3_10 = var_7.getShipType(var_3_9)

	setImageSprite = var_3_9

	local var_3_11 = arg_3_0.shipType

	GetSpriteFromAtlas = var_10

	local var_3_12 = "shiptype"

	shipType2print = var_1_10012

	var_3_9(var_3_11, var_10(var_3_12, var_1_10012(var_3_10)))
...
function var_0_0.updateProps1(arg_6_0, arg_6_1)
	for iter_6_0 = 0, 2 do
		local var_6_0 = arg_6_0.propsTr1
		local var_6_1 = var_6.GetChild(var_6_0, iter_6_0)

		if iter_6_0 < #arg_6_1 then
			local var_6_2 = var_6_1.gameObject

			var_7.SetActive(var_6_2, true)

			local var_6_3 = var_6_1:GetChild(0)

			var_7.GetComponent(var_6_3, "Text").text = arg_6_1[iter_6_0 + 1][1]

			local var_6_4 = var_6_1:GetChild(1)

			var_7.GetComponent(var_6_4, "Text").text = arg_6_1[iter_6_0 + 1][2]
		else
			local var_6_5 = var_6_1.gameObject

			var_7.SetActive(var_6_5, false)
		end
	end
...
function var_0_0.clear(arg_7_0)
	if arg_7_0.shipVO then
		...
		var_1_10002(arg_7_0.paintingTr, var_1:getPainting())
	end

	local var_7_0 = arg_7_0.loader
