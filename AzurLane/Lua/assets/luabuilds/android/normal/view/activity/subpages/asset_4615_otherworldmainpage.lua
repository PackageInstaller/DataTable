...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_7()
		...
		var_0.PlayClickEffect(var_5_0, arg_2_0.mountainBtn, function()
			...
			var_6_1(var_6_0, var_6_2, var_3_10003.OTHERWORLD_BACKHILL)
	...
	local function var_2_15()
		...
		var_0.PlayClickEffect(var_9_0, arg_2_0.fightBtn, function()
			...
			local var_10_2 = var_3_10002.GO_SCENE

			SCENE = var_3_10003

			var_10_1(var_10_0, var_10_2, var_3_10003.OTHERWORLD_MAP)
...
function var_0_1.PlayOpenEffect(arg_11_0)
	...
	var_11_1(var_11_0, var_3.delayedCall, function()
	...
	var_11_3(var_11_2, var_3.delayedCall, function()
		setActive = var_2_10000
	...
	var_11_5(var_11_4, var_3.delayedCall, function()
		setActive = var_2_10000
...
function var_0_1.PlayClickEffect(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_2 = var_15_0(192, 60, 0)
	...
	if var_15_1 then
		...
		setLocalPosition = var_15_3

		var_15_3(arg_15_0.effectClick, var_15_4)

		setActive = var_15_3

		var_15_3(arg_15_0.effectClick, true)
		...
		var_15_6(var_15_5, var_8.delayedCall, function()
			setActive = var_2_10000
