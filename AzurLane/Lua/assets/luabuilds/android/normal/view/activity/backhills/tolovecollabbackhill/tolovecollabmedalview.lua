...
function var_0_1.AddListener(arg_5_0)
	...
	local function var_5_5()
		...
		if not var_1.contains(arg_5_0.activeIDList, var_7_0) then
			table = var_2
			var_7_1 = var_2.contains(arg_5_0.activatableIDList, var_7_0)
		else
			var_7_1 = false
		end
		...
		if var_7_1 then
			...
			var_7_3(var_7_2, var_2_10005.MEMORYBOOK_UNLOCK, {
				id = var_7_0,
	...
	local function var_5_8()
		...
		if var_8_1(var_8_0, var_2_10002.TOLOVE_TASK_ID) and not var_0:isEnd() then
			var_8_0 = arg_5_0.taskList[arg_5_0.contextData.ChipIndex]
			var_2_10003 = arg_5_0

			local var_8_2 = var_2.emit

			MedalCollectionTemplateMediator = var_2_10004

			var_8_2(var_2_10003, var_2_10004.MEMORYBOOK_GO, var_8_0)
		else
			pg = var_8_0
			...
			var_8_4(var_8_3, var_2_10003("common_activity_end"))
		end
	...
	for iter_5_0 = 1, 6 do
		...
		local var_5_11 = var_7.Find(var_5_10, "Desk/Slot" .. iter_5_0 .. "/Click")
		...
		var_1_10005(var_5_9, var_5_11, var_5_12, var_9)
	end
...
function var_0_1.UpdateView(arg_14_0)
	for iter_14_0 = 1, 6 do
		...
		for iter_14_1 = 1, #arg_14_0.slots do
			...
			var_12(arg_14_0.slots[iter_14_1].char, var_1_10011)
			...
			if var_14.contains(arg_14_0.activatableIDList, arg_14_0.allIDList[iter_14_1]) then
				var_14_3 = not var_1_10011
			end

			var_12(var_14_2, var_14_3)
		end
	...
	var_3(var_4.Find(var_14_5, "Lock"), not var_14_4)

	setActive = var_3

	local var_14_6 = arg_14_0.medalTF

	var_3(var_4.Find(var_14_6, "Unlock"), var_14_4)

	setActive = var_3

	local var_14_7 = arg_14_0.syncBtn

	var_3(var_4.Find(var_14_7, "notSync"), not var_1)

	setActive = var_3

	local var_14_8 = arg_14_0.syncBtn

	var_3(var_4.Find(var_14_8, "synced"), var_14_4)
	...
	local var_14_11 = var_14_10(var_14_9, var_5(var_6))
	...
	var_14_11(var_4.Find(var_14_12, "reddot"), var_1 and not var_14_4)
	arg_14_0:UpdateInfo()
...
function var_0_1.UpdateInfo(arg_15_0)
	...
	if not var_2.contains(arg_15_0.activeIDList, var_15_0) then
		table = var_3
		var_15_1 = var_3.contains(arg_15_0.activatableIDList, var_15_0)
	else
		var_15_1 = false
	end
	...
	var_4(var_15_2, var_6.getConfig(var_15_3, "desc"))
	...
	var_4(var_15_4, var_6.item_virtual_data_statistics[arg_15_0.dropInfoList[arg_15_0.contextData.ChipIndex].id].name)
