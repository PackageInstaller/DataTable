...
function var_0_1.BindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.ON_OPEN_TOWERCLIMBING_SIGNED, function()
		...
		local var_3_3 = var_2_10003.ACTIVITY
		local var_3_4 = {}

		ActivityConst = var_2_10005
		var_3_4.id = var_2_10005.TOWERCLIMBING_SIGN
	...
	arg_2_0:bind(var_0_1.ACTIVITY_OPERATION, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_4.ACTIVITY_OPERATION, arg_4_1)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.SEND_MINI_GAME_OP_DONE then
		var_6_3 = {
			function(arg_7_0)
		...
		if var_6_0 == var_6_3.ACTIVITY_UPDATED then
			...
			local var_6_5 = var_6_2.getConfig(var_6_4, "type")

			ActivityConst = var_6_4

			if var_6_5 == var_6_4.ACTIVITY_TYPE_BUILDING_BUFF then
				arg_6_0.activity = var_6_2

				local var_6_6 = arg_6_0.viewComponent

				var_4.UpdateActivity(var_6_6, var_6_2)
			end
		end
	end
