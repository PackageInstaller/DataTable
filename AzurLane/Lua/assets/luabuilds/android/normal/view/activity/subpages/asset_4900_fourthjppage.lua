...
function var_0_1.findUI(arg_2_0)
	...
	local var_2_4 = arg_2_0.btnContainer.childCount / var_0_2
	...
	for iter_2_3 = 1, var_2_4 * var_0_2 do
		table = var_1_10006

		if var_1_10006.contains(arg_2_0.hideIndex, iter_2_3 % var_0_3) or not arg_2_0.scrollAble and var_0_3 < iter_2_3 then
...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.btnCount = arg_3_0.btnContainer.childCount / var_0_2
	arg_3_0.btnSpeed = 50
...
function var_0_1.initBtnList(arg_10_0, arg_10_1)
	...
	local function var_10_2()
		...
		var_11_1(var_11_0, var_2_10002.GO_PRAY_POOL)
	...
	var_1_10002(var_10_0, var_10_1, var_10_2, var_1_10006)
	...
	local function var_10_5()
		...
		local var_12_2 = var_2_10002.EVENT_GO_SCENE

		SCENE = var_2_10003

		var_12_1(var_12_0, var_12_2, var_2_10003.SUMMARY)
	...
	var_1_10002(var_10_3, var_10_4, var_10_5, var_1_10006)
	...
	local function var_10_8()
		...
		local var_13_2 = var_2_10002.SELECT_ACTIVITY

		ActivityConst = var_2_10003

		var_13_1(var_13_0, var_13_2, var_2_10003.RETUREN_AWARD_1)
	...
	var_1_10002(var_10_6, var_10_7, var_10_8, var_1_10006)
	...
	local function var_10_11()
		...
		var_14_1(var_14_0, var_2_10002.GO_MINI_GAME, 30)
	...
	var_1_10002(var_10_9, var_10_10, var_10_11, var_1_10006)
	...
	local function var_10_14()
		...
		local var_15_3 = var_2_10003.CHARGE
		local var_15_4 = {}

		ChargeScene = var_2_10005
		var_15_4.wrap = var_2_10005.TYPE_DIAMOND
	...
	var_1_10002(var_10_12, var_10_13, var_10_14, var_1_10006)
	...
	local function var_10_17()
		...
		var_16_1(var_16_0, var_16_2, var_2_10003.AMUSEMENT_PARK2)
	...
	var_1_10002(var_10_15, var_10_16, var_10_17, var_1_10006)
