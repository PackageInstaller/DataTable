...
function var_0_1.OnUpdateFlush(arg_3_0)
	...
	if 1 <= var_3_1 then
		...
		if not var_6(var_3_0, var_0_1.COLOR) then
			var_3_3 = var_3_0
		end
...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	local var_4_6 = var_4_2(var_4_5, var_1_10006(var_1_10007))
	...
	local var_4_10 = var_4_9(var_8(var_4_3), var_4_8, 0.4)
	local var_4_11 = var_7.setOnComplete

	System = var_9

	var_4_11(var_4_10, var_9.Action(function()
	...
	var_4_14(var_4_13, var_9.Action_float(function(arg_6_0)
	...
	local var_4_16 = var_4_14(var_4_15, var_9(var_10))

	LeanTween = var_4_15

	local var_4_17 = var_4_15.value

	go = var_9

	local var_4_18 = var_4_17(var_9(var_4_4), 0, 1, 0.4)
	local var_4_19 = var_8.setOnUpdate

	System = var_10

	var_4_19(var_4_18, var_10.Action_float(function(arg_7_0)
	...
	local var_4_21 = var_4_20(var_9(var_4_4), var_4_7, 0.4)
	local var_4_22 = var_8.setOnComplete

	System = var_10

	var_4_22(var_4_21, var_10.Action(function()
