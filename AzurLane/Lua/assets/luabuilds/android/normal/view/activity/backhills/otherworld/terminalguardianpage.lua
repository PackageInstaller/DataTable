...
var_0_1.BIND_LOTTERY_ACT_ID = var_0_0.OTHER_WORLD_TERMINAL_LOTTERY_ID
pg = var_1
...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2_0.name = var_1_10002(var_1_10003.PAGE_GUARDIAN)
	...
	local var_2_4 = var_2.Find(var_2_3, "content")
	local var_2_5 = arg_2_0.mainViewTF

	arg_2_0.mainViewUIList = var_2_2(var_2_4, var_3.Find(var_2_5, "content/tpl"))
	...
	local var_2_9 = var_2.Find(var_2_8, "top/Text")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("guardian_select_title"))
	...
	var_1(var_2_17, var_2_16("guardian_sure_btn"))
	...
	local var_2_20 = var_2.Find(var_2_19, "Text")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("guardian_cancel_btn"))
	...
	local var_2_24 = var_2.Find(var_2_23, "right/content")
	local var_2_25 = arg_2_0.selectViewTF

	arg_2_0.selectViewUIList = var_2_22(var_2_24, var_3.Find(var_2_25, "right/content/tpl"))
	setText = var_1

	local var_2_26 = arg_2_0.selectViewTF
	local var_2_27 = var_2.Find(var_2_26, "right/content/tpl/active/Text")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("guardian_active_tip"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_6()
		...
		if #arg_3_0.activeIds >= var_0_1.GUARDIAN_SELECT_CNT then
			...
			var_5_1(var_5_0, var_2_10002("guardian_sure_limit_tip"))
...
function var_0_1.ChangeActiveIds(arg_7_0)
	...
	OtherworldTerminalMediator = var_1_10003

	var_7_1(var_7_0, var_1_10003.ON_BUFF_LIST_CHANGE, {
	...
	var_1.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			if var_9_0 then
				...
				var_6(arg_9_2:Find("content/name"), var_2_10005.guardian_name)

				setText = var_6

				var_6(arg_9_2:Find("content/desc/content/Text"), var_2_10005.guardian_desc)

				local var_9_1 = arg_9_2
				local var_9_2 = arg_9_2.Find(var_9_1, "content/icon_mask/Image")

				GetImageSpriteFromAtlasAsync = var_9_1

				var_9_1("shipyardicon/" .. var_2_10005.guardian_painting, "", var_9_2, false)
			end
			...
			var_2_10005(var_9_3, var_9_4, var_9_5, var_2_10009)
		end
...
function var_0_1.InitSelectViewUI(arg_13_0)
	...
	var_1.make(var_13_0, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventInit then
			...
			var_2_10005 = arg_14_2.Find(var_14_2, "icon_mask/Image")
			GetImageSpriteFromAtlasAsync = var_14_2

			var_14_2("shipyardicon/" .. var_14_1.guardian_painting, "", var_2_10005, true)
			...
			var_14_2(var_14_3, var_14_4, var_14_5, var_10)
		else
			UIItemList = var_14_0

			if arg_14_0 == var_14_0.EventUpdate then
				local var_14_6 = arg_13_0.allIds[arg_14_1 + 1]
				local var_14_7 = var_0_1.config[var_14_6]

				table = var_2_10005

				local var_14_8 = var_2_10005.contains(arg_13_0.unlcokIds, var_14_6)

				table = var_6

				local var_14_9 = var_6.contains(arg_13_0.activeIds, var_14_6)
				local var_14_10 = var_14_7.type == 2 and not var_14_8

				setActive = var_8

				var_8(arg_14_2:Find("icon_mask/Image"), not var_14_10)

				setActive = var_8

				var_8(arg_14_2:Find("unknown"), var_14_10)

				setActive = var_8

				var_8(arg_14_2:Find("lock"), not var_14_8 and not var_14_10)

				setActive = var_8

				var_8(arg_14_2:Find("active"), var_14_9)

				setActive = var_8

				var_8(arg_14_2:Find("selected"), var_14_6 == arg_13_0.selectedId)
			end
		end
...
function var_0_1.UpdateSelectViewUI(arg_16_0)
	...
	local var_16_3 = var_4.contains(arg_16_0.activeIds, var_16_0)
	...
	if var_16_1.type == 1 then
		...
		math = var_1_10013
		var_16_5 = var_16_9(var_16_10, var_16_11, var_1_10013.min(var_16_8, var_16_1.guardian_gain[2]))
	...
	var_16_6(var_8.Find(var_16_12, "Text"), var_16_5)
