...
var_0_1.BIND_PT_ACT_ID = var_0_0.OTHER_WORLD_TERMINAL_PT_ID
ActivityConst = var_1
...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2_0.name = var_1_10002(var_1_10003.PAGE_ADVENTURE)
	...
	local var_2_3 = var_2.Find(var_2_2, "title/content/Text")

	i18n = var_2_2

	var_1(var_2_3, var_2_2("adventure_award_title"))

	setText = var_1

	local var_2_4 = arg_2_0.levelTF
	local var_2_5 = var_2.Find(var_2_4, "progress/title")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("adventure_progress_title"))

	setText = var_1

	local var_2_6 = arg_2_0.levelTF
	local var_2_7 = var_2.Find(var_2_6, "lv")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("adventure_lv_title"))
	...
	local var_2_14 = var_2.Find(var_2_13, "content")
	local var_2_15 = arg_2_0.awardView

	arg_2_0.awardUIList = var_2_12(var_2_14, var_3.Find(var_2_15, "content/tpl"))
	...
	local var_2_18 = var_2.Find(var_2_17, "title/content/Text")

	i18n = var_2_17

	var_1(var_2_18, var_2_17("adventure_record_title"))

	setText = var_1

	local var_2_19 = arg_2_0.recordTF
	local var_2_20 = var_2.Find(var_2_19, "grade")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("adventure_record_grade_title"))
	...
	local var_2_24 = var_2.Find(var_2_23, "form")
	local var_2_25 = arg_2_0.recordTF

	arg_2_0.taskUIList = var_2_22(var_2_24, var_3.Find(var_2_25, "form/tpl"))
	setText = var_1

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_2.Find(var_2_26, "frame/tip")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("adventure_award_end_tip"))
	...
	var_1(var_2_30, var_2_29("adventure_get_all"))
	...
	var_1(var_2_33, var_2_32("adventure_get_all"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_3_0(var_3_1, "not exist bind pt act, id" .. var_0_1.BIND_PT_ACT_ID)

	ActivityPtData = var_3_0
	arg_3_0.ptData = var_3_0.New(var_3_1)
	getProxy = var_2
	ActivityProxy = var_3
	...
	local function var_3_5()
		...
		OtherworldTerminalMediator = var_2_10003

		var_4_3(var_4_2, var_2_10003.ON_GET_PT_ALL_AWARD, {
...
function var_0_1.InitPtUI(arg_5_0)
	...
	local var_5_2 = var_5_0(var_3.GetRes(var_5_1))

	var_1_10001(var_2.getIcon(var_5_2), arg_5_0.ptIconTF, false)
	...
	var_1.make(var_5_3, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			var_7(arg_6_2:Find("IconTpl"), var_6_3, {
				hideName = true
			})
			...
			local var_6_5 = arg_6_2:Find("IconTpl")
			...
			var_7(var_6_4, var_6_5, var_6_6, var_11)

			local var_6_7 = arg_5_0.ptData
			local var_6_8 = var_7.GetLevel(var_6_7)

			setActive = var_6_7

			var_6_7(arg_6_2:Find("IconTpl/got"), var_6_0 <= var_6_8)

			setText = var_6_7

			var_6_7(arg_6_2:Find("lv"), "Lv:" .. var_6_0)

			setActive = var_6_7

			var_6_7(arg_6_2:Find("lv0"), var_6_0 == 1)

			local var_6_9 = arg_6_2
			local var_6_10 = arg_6_2.Find(var_6_9, "progress")

			setActive = var_6_9

			var_6_9(var_6_10:Find("left"), var_6_0 ~= 1)

			setActive = var_6_9

			var_6_9(var_6_10:Find("right"), var_6_0 == #arg_5_0.ptData.targets)

			if var_6_0 <= var_6_8 then
				setSlider = var_6_9

				var_6_9(var_6_10, 0, 1, 1)
			else
...
function var_0_1.UpdatePtView(arg_9_0)
	...
	var_9_0(arg_9_0.getGreyBtn, not var_9_1)
	...
	var_1_10005(var_9_7, var_1_10007.max(var_9_6 - var_9_5, 0))

	setText = var_1_10005

	var_1_10005(arg_9_0.ptLvTF, var_9_3)
...
function var_0_1.InitTaskUI(arg_10_0)
	...
	var_1.make(var_10_1, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_1 = var_4(var_2_10005)
			local var_11_2 = var_4.getTaskById(var_11_1, var_11_0)

			setText = var_11_1

			var_11_1(arg_11_2:Find("name"), var_11_2:getConfig("desc"))

			setText = var_11_1

			var_11_1(arg_11_2:Find("value"), var_11_2:getProgress())
		end
	...
	for iter_14_0, iter_14_1 in var_14_0(var_14_1) do
		if #iter_14_1[2] > 0 then
			...
			for iter_14_2, iter_14_3 in var_7(iter_14_1[2]) do
				...
				if var_1_10014.getTaskById(var_1_10015, var_14_2) and var_14_3 <= var_1_10014:getProgress() then
					return iter_14_1[1]
				end
			end
		else
...
function var_0_1.IsTip()
	...
	ActivityPtData = var_16_0

	local var_16_1 = var_16_0.New(var_0)
