...
function var_0_1.init(arg_3_0)
	...
	local var_3_4 = var_2.Find(var_3_3, "Upgrade/MaterialsTitle")

	i18n = var_3_3

	var_1(var_3_4, var_3_3("workbench_need_materials"))

	setText = var_1

	local var_3_5 = arg_3_0.window
	local var_3_6 = var_2.Find(var_3_5, "Display/MaxTip")

	i18n = var_3_5

	var_1(var_3_6, var_3_5("workbench_tips6"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_5 = var_4.Find(var_4_4, "Cancel")
	...
	var_1_10002(var_4_3, var_4_5, var_4_6, var_6)
	...
	var_1_10002(var_4_7, var_4.Find(var_4_8, "Upgrade"), function()
		...
		elseif arg_4_0.isOverAvg then
			...
			var_7_1(var_7_0, var_2_10002("haidaojudian_upgrade_limit"))
		elseif arg_4_0.isLackMat then
			...
			var_7_3(var_7_2, var_2_10002("haidaojudian_building_tip"))
		else
			local var_7_4 = arg_4_0
			local var_7_5 = var_0.emit

			BuildingUpgradeMediator = var_2_10002

			var_7_5(var_7_4, var_2_10002.ACTIVITY_OPERATION, {
				cmd = 1,
	...
	local var_4_11 = var_4.Find(var_4_10, "Confirm")
	...
	var_1_10002(var_4_9, var_4_11, var_4_12, var_6)
	arg_4_0:UpdateView()
...
function var_0_1.UpdateView(arg_9_0)
	...
	arg_9_0.activityId = var_9_2(var_9_1, var_1_10004.ACTIVITY_TYPE_BUILDING_BUFF_2).id

	local var_9_3 = var_2
	local var_9_4 = var_2.GetBuildingLevel(var_9_3, var_9_0)

	pg = var_9_3
	arg_9_0.isMaxLevel = #var_9_3.activity_event_building[var_9_0].buff <= var_9_4
	arg_9_0.isOverAvg = var_9_4 > var_2:GetTotalBuildingLevel()
	setActive = var_6
	...
	if not arg_9_0.isMaxLevel or not arg_9_0.displayWindow then
		var_9_5 = arg_9_0.upgradeWindow
	end

	AnniversaryIsland2023Scene = var_7

	local var_9_6 = var_7.Buildings[var_9_0]
	local var_9_7 = arg_9_0.loader

	var_8.GetSpriteQuiet(var_9_7, arg_9_0:GetAtlasPath(), var_9_6, var_9_5:Find("Title/BuildingName"), true)
	...
	;(function()
		...
		local var_10_3 = var_2.GetAtlasPath(var_10_2)
		local var_10_4 = var_9_4
		local var_10_5 = var_9_5

		var_10_1(var_10_0, var_10_3, var_10_4, var_4.Find(var_10_5, "Title/LevelBefore"), true)

		local var_10_6 = var_0.buff[var_9_4]
		...
		local var_10_8 = var_2.split(var_10_7:getConfig("desc"), "/")
		...
		local var_10_16 = var_2_10010.sub(var_10_8[2], var_10_14, #var_10_8[2])

		setText = var_11

		local var_10_17 = var_9_5

		var_11(var_12.Find(var_10_17, "Progress1/1/Desc"), var_10_11)

		setText = var_11

		local var_10_18 = var_9_5

		var_11(var_12.Find(var_10_18, "Progress1/1/Value"), var_10_12)

		setText = var_11

		local var_10_19 = var_9_5

		var_11(var_12.Find(var_10_19, "Progress2/1/Desc"), var_10_15)

		setText = var_11

		local var_10_20 = var_9_5

		var_11(var_12.Find(var_10_20, "Progress2/1/Value"), var_10_16)

		tonumber = var_11
		var_9_8 = var_11(var_10_7:getConfig("benefit_effect"))

		return
	end)()
	;(function()
		if var_9_4 >= var_0 then
			return
		end

		local var_11_0 = var_9_4 + 1
		local var_11_1 = arg_9_0.loader
		local var_11_2 = var_1.GetSpriteQuiet
		local var_11_3 = arg_9_0
		local var_11_4 = var_3.GetAtlasPath(var_11_3)
		local var_11_5 = var_11_0
		local var_11_6 = var_9_5

		var_11_2(var_11_1, var_11_4, var_11_5, var_5.Find(var_11_6, "Title/LevelAfter"), true)

		local var_11_7 = var_0.buff[var_11_0]

		CommonBuff = var_11_1

		local var_11_8 = var_11_1.New({
			id = var_11_7
		})

		string = var_3

		local var_11_9 = var_3.split(var_11_8:getConfig("desc"), "/")
		...
		local var_11_17 = var_2_10011.sub(var_11_9[2], var_11_15, #var_11_9[2])

		setText = var_12

		local var_11_18 = var_9_5

		var_12(var_13.Find(var_11_18, "Progress1/2/Desc"), var_11_12)

		setText = var_12

		local var_11_19 = var_9_5

		var_12(var_13.Find(var_11_19, "Progress1/2/Value"), var_11_13)

		setText = var_12

		local var_11_20 = var_9_5

		var_12(var_13.Find(var_11_20, "Progress2/2/Desc"), var_11_16)

		setText = var_12

		local var_11_21 = var_9_5

		var_12(var_13.Find(var_11_21, "Progress2/2/Value"), var_11_17)

		tonumber = var_12

		local var_11_22 = var_11_8
		local var_11_23 = var_12(var_11_8.getConfig(var_11_22, "benefit_effect")) > var_9_8

		setActive = var_11_22

		local var_11_24 = var_9_5

		var_11_22(var_15.Find(var_11_24, "Progress2/2/Up"), var_11_23)
	...
	;(function()
		...
		local var_12_0 = var_0.material[var_9_4]
		...
		local var_12_3 = var_12_2(var_12_1, var_2_10003.ACTIVITY_TYPE_VIRTUAL_BAG)
		...
		local var_12_6 = var_9_5
		local var_12_7 = var_3.Find(var_12_6, "Materials")
		local var_12_8 = var_9_5
		local var_12_9 = var_4.Find(var_12_8, "Materials")

		var_12_5(var_12_7, var_4.GetChild(var_12_9, 0), #var_12_0, function(arg_13_0, arg_13_1, arg_13_2)
			...
			var_5(arg_9_0, arg_13_2:Find("Icon"), function()
				...
				if var_14_0 == var_4_10001 then
					...
					WorkBenchItemDetailMediator = var_4_10002
					var_4_10002 = var_4_10002.SHOW_DETAIL
					WorkBenchItem = var_4_10003

					var_14_2(var_14_1, var_4_10002, var_4_10003.New({
					...
					var_14_4(var_14_3, var_4_10002.ON_DROP, var_13_1)
				end
			...
			local var_13_8 = arg_13_2.Find(var_13_7, "Text")

			setColorStr = var_13_7

			var_9(var_13_8, var_13_7(var_7, var_13_6 and "#bb6754" or "#6b5a48") .. "/" .. var_13_4)

			local var_13_9 = arg_9_0
			local var_13_10
