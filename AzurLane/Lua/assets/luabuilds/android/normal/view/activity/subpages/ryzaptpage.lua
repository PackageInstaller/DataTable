...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	if var_7_0(arg_7_0.getBtn) and arg_7_0.specialPhase[var_7_1] then
		setActive = var_2
...
function var_0_1.OnShowFlush(arg_19_0)
	...
	var_19_1(var_19_0, var_3.GetLevelProgress(var_19_2))
