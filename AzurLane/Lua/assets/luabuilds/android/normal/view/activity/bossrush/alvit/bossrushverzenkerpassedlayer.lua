...
function var_0_1.didEnter(arg_2_0)
	...
	var_2_0(var_3.Find(var_2_2, "main"), function(arg_3_0, arg_3_1)
		...
		if not var_2_1[arg_3_0.name] then
			...
			tostring = var_5
			BossRushVerZenkerPassedLayer = var_2_10006
			var_3_1 = var_3_1 == var_5(var_2_10006.seriesId)
		end
	...
	var_2_0(var_3.Find(var_2_3, "Image/content"), function(arg_4_0, arg_4_1)
		setActive = var_2_10002
	...
	local function var_2_4()
		...
		var_2_10000({
			function(arg_6_0)
				...
				local var_6_1 = var_2.Find(var_6_0, "Image/content")

				var_3_10001(var_2.GetChild(var_6_1, arg_2_0.contextData.curIndex - 1), true)
			...
			function(arg_7_0)
				...
				local var_7_1 = var_2.Find(var_7_0, "Image/content")

				var_3_10001(var_2.GetChild(var_7_1, arg_2_0.contextData.curIndex), true)
			...
			ChallengePassedCombatLoadMediator = var_3_10002

			var_8_1(var_8_0, var_3_10002.FINISH, arg_2_0._loadObs)
...
function var_0_1.combatPreload(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in var_1_10005(var_9_3) do
