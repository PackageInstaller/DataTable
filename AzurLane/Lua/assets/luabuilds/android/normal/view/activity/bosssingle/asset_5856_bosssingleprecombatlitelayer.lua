...
local var_0_0 = "BossSinglePreCombatLiteLayer"

import = var_0_10002

local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BossSinglePreCombatLayer"))
...
function var_0_1.CommonInit(arg_4_0)
	...
	var_2(arg_4_0._checkBtn, false)

	setActive = var_2

	var_2(arg_4_0._continuousBtn, false)
...
function var_0_1.displayFleetInfo(arg_54_0)
	local var_54_0 = arg_54_0._currentFleetVO
	local var_54_1 = var_1.getFleetType(var_54_0)

	setActive = var_54_0

	local var_54_2 = arg_54_0._vanguardGS.parent

	FleetType = var_1_10004

	var_54_0(var_54_2, var_54_1 == var_1_10004.Normal)

	setActive = var_54_0

	local var_54_3 = arg_54_0._mainGS.parent

	FleetType = var_4

	var_54_0(var_54_3, var_54_1 == var_4.Normal)

	math = var_54_0

	local var_54_4 = var_54_0.floor
	local var_54_5 = arg_54_0._currentFleetVO
	local var_54_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_54_7 = var_54_4(var_54_6(var_54_5, var_1_10005.Vanguard))

	math = var_3

	local var_54_8 = var_3.floor
	local var_54_9 = arg_54_0._currentFleetVO
	local var_54_10 = var_4.GetGearScoreSum

	TeamType = var_1_10006

	local var_54_11 = var_54_8(var_54_10(var_54_9, var_1_10006.Main))

	setActive = var_4

	local var_54_12 = arg_54_0._subGS.parent

	FleetType = var_6

	var_4(var_54_12, var_54_1 == var_6.Submarine)

	math = var_4

	local var_54_13 = var_4.floor
	local var_54_14 = arg_54_0._currentFleetVO
	local var_54_15 = var_5.GetGearScoreSum

	TeamType = var_1_10007

	local var_54_16 = var_54_13(var_54_15(var_54_14, var_1_10007.Submarine))
	local var_54_17 = arg_54_0._currentFleetVO
	local var_54_18 = var_5.GetCostSum(var_54_17)
	local var_54_19 = arg_54_0.contextData.system

	pg = var_7

	local var_54_20 = var_7.battle_cost_template[var_54_19].oil_cost == 0 and 0 or var_54_18.oil

	setActive = var_1_10009

	var_1_10009(arg_54_0._costContainer, true)
	var_0_2.tweenNumText(arg_54_0._costText, var_54_20)
	var_0_2.tweenNumText(arg_54_0._vanguardGS, var_54_7)
	var_0_2.tweenNumText(arg_54_0._mainGS, var_54_11)
	var_0_2.tweenNumText(arg_54_0._subGS, var_54_16)

	setText = var_9

	local var_54_21 = arg_54_0._fleetNameText
	local var_54_22 = arg_54_0._currentFleetVO

	var_9(var_54_21, var_11.GetName(var_54_22))

	setText = var_9

	var_9(arg_54_0._fleetNumText, arg_54_0._currentFleetVO.id)

	local var_54_23 = arg_54_0.contextData.stageId

	if arg_54_0.contextData.costLimit then
		pg = var_10

		local var_54_24 = var_10.battle_cost_template[var_54_19].oil_cost
		local var_54_25 = 0 < var_54_24
		...
		for iter_54_0, iter_54_1 in var_1_10015({
			...
			if 0 < var_54_30 then
				...
				math = var_23
				var_54_28 = var_23.min(var_54_28, var_54_30)
			end

			var_54_22 = var_54_22 + var_54_28
		end
		...
		if var_54_27 then
			...
			if not var_54_32(0.9803921568627451, 0.39215686274509803, 0.39215686274509803) then
				Color = var_54_32
				var_54_32 = var_54_32.white
			end

			var_15(var_54_31, var_54_32)
			var_0_2.tweenNumText(arg_54_0._costText, var_54_22)

			setActive = var_10

			local var_54_33 = arg_54_0._costTip

			isCostOver = var_54_22

			var_10(var_54_33, var_54_22)
			...
			if var_10 then
				...
				var_10(arg_54_0, arg_54_0._costTip, function()
					...
					local var_55_0 = var_2_10000.MsgboxMgr.GetInstance()
					local var_55_1 = var_0.ShowMsgBox
					local var_55_2 = {
						hideNo = true
					}
					...
					local var_55_3 = "use_oil_limit_help"

					baseCost = var_2_10005
					var_55_2.content = var_2_10003(var_55_3, var_2_10005, var_54_18)
...
function var_0_1.SetFleetStepper(arg_56_0)
	SetActive = var_1_10001

	var_1_10001(arg_56_0._nextPage, false)

	SetActive = var_1_10001

	var_1_10001(arg_56_0._prevPage, false)
...
function var_0_1.onBackPressed(arg_57_0)
	...
	local var_57_0 = var_1_10001.CriMgr.GetInstance()
	local var_57_1 = var_1.PlaySoundEffect_V3

	SFX_CANCEL = var_1_10003

	var_57_1(var_57_0, var_1_10003)

	triggerButton = var_57_1

	var_57_1(arg_57_0._backBtn)
...
function var_0_1.willExit(arg_58_0)
	...
	var_1.UnOverlayPanel(var_58_0, arg_58_0._tf)

	local var_58_1 = arg_58_0._formationLogic
