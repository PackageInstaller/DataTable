...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_TERMINAL, function()
		...
		OtherworldTerminalLayer = var_2_10004
	...
	arg_1_0:bind(var_0_1.SHOW_CHAR_AWARDS, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.ON_ACHIEVE, arg_3_1, arg_3_2)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.ACTIVITY_OPERATION_DONE then
		ActivityConst = var_4
		...
		if var_6_0 == var_4.ACTIVITY_LOTTERY_SHOW_AWARDS then
			local var_6_5 = arg_6_0.viewComponent

			var_6_6 = var_6_6.emit
			BaseUI = var_1_10006

			var_6_6(var_6_5, var_1_10006.ON_ACHIEVE, var_6_2.awards, function()
			...
			if var_6_0 == var_6_6.ZERO_HOUR_OP_DONE then
				-- block empty
			end
		end
	end
