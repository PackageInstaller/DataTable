...
function var_0_1.initMap(arg_3_0)
	...
	elseif arg_3_0.useCount == 19 then
		...
		if var_1.battle then
			...
			var_3_1(var_3_2, var_3_3, var_1_10004.Action(function()
				...
				local var_4_4 = var_2_10003.m02
				local var_4_5 = var_3.sendNotification

				GAME = var_2_10005

				var_4_5(var_4_4, var_2_10005.ACT_NEW_PT, {
					cmd = 1,
			...
			if arg_3_0.baoxiangModel then
				...
				local var_3_6 = var_3_5(var_3_4, var_3_3(var_4))
	...
	if arg_3_0.useCount > 0 then
		...
		if var_1.battle and arg_3_0.useCount >= 19 then
		...
		for iter_3_0 = 1, 20 do
			local var_3_7 = arg_3_0.translate

			Vector2 = var_1_10006
			var_3_7.anchoredPosition = var_1_10006(arg_3_0.mid.anchoredPosition.x + arg_3_0.distance, 0)
			var_1_10006 = arg_3_0.mapTf

			if var_5.InverseTransformPoint(var_1_10006, arg_3_0.translate.position).x <= var_0_28 - 600 then
				arg_3_0:createMap()
			end
		end
	end
	...
	if arg_3_0.useCount == 0 then
		...
		if not var_1.story then
			...
			local var_3_9 = arg_3_0.getStoryData(var_3_8, 0)

			setActive = var_3_8

			var_3_8(arg_3_0.btnStart, false)

			setActive = var_3_8

			var_3_8(arg_3_0.btnBack, false)

			setActive = var_3_8

			var_3_8(arg_3_0.btnMain, false)

			setActive = var_3_8

			var_3_8(arg_3_0.labelDropShip, false)

			pg = var_3_8

			local var_3_10 = var_3_8.NewStoryMgr.GetInstance()

			var_2.Play(var_3_10, var_3_9, function()
...
function var_0_1.createMap(arg_7_0, arg_7_1)
	...
	local var_7_2 = var_3(var_4(var_7_1))
	...
	if arg_7_1 == "ground_2" then
		...
		local var_7_11 = var_7_9.GetInstance()
		...
		var_10.GetSpineChar(var_7_11, var_7_10, true, function(arg_8_0)
			...
			var_8_3(var_8_2, var_3(var_7_4, "house/char"), false)
			...
			local var_8_6 = var_8_5(var_8_4, var_3(var_4))
	...
	elseif arg_7_1 == "ground_5" then
		if arg_7_0.useCount <= 19 then
			...
			if not var_8.battle then
				...
				var_8.GetSpineChar(var_7_12, var_0_6, true, function(arg_9_0)
					...
					var_9_3(var_9_2, var_3(var_7_4, "house/enemy"), false)
					...
					local var_9_6 = var_9_5(var_9_4, var_3(var_4))
		...
		var_8.GetSpineChar(var_7_13, var_0_4, true, function(arg_10_0)
			...
			var_10_3(var_10_2, var_3(var_7_4, "house/baoxiang"), false)
			...
			local var_10_6 = var_10_5(var_10_4, var_3(var_4))
			...
			if arg_7_0.baoxiangKai then
				...
				local var_10_9 = var_10_8(var_10_7, var_4(var_5))
	...
	arg_12_0.awardsTimer = var_2.New(function()
		if arg_12_0.awardTfs and #arg_12_0.awardTfs > 0 then
			for iter_13_0 = #arg_12_0.awardTfs, 1, -1 do
				...
				local var_13_0 = var_5.y

				if 150 <= var_13_0 then
					Destroy = var_13_0
					table = var_7

					var_13_0(var_7.remove(arg_12_0.awardTfs, iter_13_0))
				else
...
function var_0_1.initUI(arg_14_0)
	...
	for iter_14_0 = 1, #var_0_7 do
		...
		local var_14_6 = var_14_4.GetInstance()
		...
		var_11.GetSpineChar(var_14_6, var_14_5, true, function(arg_15_0)
			...
			var_15_5(var_15_4, var_3(arg_14_0.char, var_14_0), false)
			...
			local var_15_8 = var_15_7(var_15_6, var_3(var_4))

			table = var_15_6

			var_15_6.insert(arg_14_0.modelIds, var_14_1)
			...
			local var_15_13 = var_4(arg_14_0.char, var_14_0).transform
			...
			local function var_15_14()
				...
				if var_16_2(var_16_1(arg_14_0.cellPos)) then
					return
				end
			...
			var_2(var_15_12, var_15_13, var_15_14, var_6)
...
function var_0_1.initEvent(arg_18_0)
	...
	local function var_18_2()
		...
		local var_19_6 = var_19_4(var_2_10004)
		local var_19_7 = var_3.getRawData(var_19_6)

		pg = var_19_6

		local var_19_8 = var_19_6.gameset.urpt_chapter_max.description[1]

		LOCK_UR_SHIP = var_2_10006
		...
		if var_2_10006 then
			...
			var_2_10006 = var_2_10006.GetLimitCntById(var_2_10007, var_19_8)
		end

		Task = var_2_10007

		local var_19_9, var_19_10 = var_2_10007.StaticJudgeOverflow(var_19_7.gold, var_19_7.oil, var_2_10006, true, true, {
			{
				var_19_5.type,
				var_19_5.id,
				var_19_5.count
		...
		if var_19_9 then
			...
			var_9.insert(var_19_2, function(arg_20_0)
				...
				var_20_2.type = var_3_10004
				i18n = var_3_10004
				var_20_2.content = var_3_10004("award_max_warning")
				var_20_2.items = var_19_10
	...
	local function var_18_8()
		...
		var_23_1(var_23_0, var_2_10002.ON_HOME)
...
function var_0_1.getPtData(arg_24_0)
	...
	ActivityPtData = var_24_0

	return (var_24_0.New(var_24_1))
end
...
function var_0_1.addAwards(arg_25_0, arg_25_1)
	...
	for iter_25_0 = 1, #arg_25_1 do
		...
		go = var_1_10009
		var_1_10007 = var_1_10007(var_1_10008(var_1_10009(arg_25_0.awardTf)))
...
function var_0_1.start(arg_26_0)
	...
	if arg_26_0.leftCount and arg_26_0.leftCount <= 0 then
		...
		var_26_1(var_26_0, var_1_10003("common_count_noenough"))
...
function var_0_1.checkCountStory(arg_28_0, arg_28_1)
	...
	if var_28_1.detect(var_28_2, function(arg_29_0)
		return arg_29_0[1] == var_28_0
	end) then
		pg = var_6

		local var_28_3 = var_6.NewStoryMgr.GetInstance()
...
function var_0_1.changeAnimeState(arg_30_0, arg_30_1, arg_30_2)
	if arg_30_1 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_30_0, var_1_10005(var_1_10006))
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_1_10003 = var_1_10003(var_30_1, var_1_10005(var_1_10006))
...
function var_0_1.activityDataUpdata(arg_32_0)
	...
	ActivityPtData = var_32_0

	local var_32_2 = var_32_0.New(var_32_1)
	...
	local var_32_8 = var_2:CanGetNextAward()
	local var_32_9 = 20 - var_32_6

	math = var_1_10010

	local var_32_10

	if var_32_9 < var_1_10010.floor(var_32_3 / 500) - var_32_6 then
		var_32_10 = var_32_9
	end

	arg_32_0.useCount = var_32_6
	arg_32_0.leftCount = var_32_10
...
function var_0_1.updataUI(arg_33_0)
	if arg_33_0.leftLastDrop then
		...
		var_1(var_1_10002(arg_33_0.labelDropShip, "text"), "" .. arg_33_0.leftLastDrop)
...
function var_0_1.move(arg_35_0, arg_35_1, arg_35_2)
	...
	var_1_10004.insert(var_35_0, function(arg_36_0)
		...
		local var_36_8 = var_6.isTweening

		go = var_7

		local var_36_9

		if var_36_8(var_7(arg_35_0.cellPos)) then
			LeanTween = var_36_9
			var_36_9 = var_36_9.cancel
			go = var_7

			var_36_9(var_7(arg_35_0.cellPos))
		end
		...
		local var_36_11 = var_36_10(var_7(arg_35_0.cellPos), 0, var_36_0, var_36_3)
		local var_36_12 = var_6.setEase

		LeanTweenType = var_8

		local var_36_13 = var_36_12(var_36_11, var_8.linear)
		local var_36_14 = var_6.setOnUpdate

		System = var_8

		local var_36_15 = var_36_14(var_36_13, var_8.Action_float(function(arg_37_0)
		...
		var_36_16(var_36_15, var_8.Action(function()
			local var_38_0
			...
			local var_38_7, var_38_8, var_38_9

			if arg_35_0.putongModel then
				var_38_7 = arg_35_0.putongModel
				var_38_8 = var_4.GetComponent
				typeof = var_38_9
				SpineAnimUI = var_3_10008
				var_38_8 = var_38_8(var_38_7, var_38_9(var_3_10008))
				var_38_9 = arg_35_0

				var_38_7.setModelAnim(var_38_9, var_38_8, "putong_kaiqi", 1, function()
					if var_38_8 then
						local var_45_0 = arg_35_0

						var_0.setModelAnim(var_45_0, var_38_8, "putong_kai", 0, nil)
					end
			...
			if var_38_0 then
				...
				if var_4(var_38_0) ~= 0 then
					pg = var_4
					var_38_8 = var_4.NewStoryMgr.GetInstance()

					var_4.Play(var_38_8, var_38_0, function()
						if var_38_6 then
							var_38_6()
						end
						...
						local var_46_1 = var_4_10001(arg_35_0._tf)
						local var_46_2 = 1

						System = var_4_10003

						var_46_0(var_46_1, var_46_2, var_4_10003.Action(function()
							arg_36_0()
			...
			do
				...
				if arg_35_0.useCount == 19 then
					...
					if var_38_10(var_38_3) ~= 0 then
						MonopolyPtScene = var_38_10

						if not var_38_10.battle then
							MonopolyPtScene = var_38_10
							var_38_10.battle = true
							pg = var_38_10
							var_38_8 = var_38_10.m02
							var_38_10 = var_38_10.sendNotification
							GAME = var_38_7

							local var_38_11 = var_38_7.BEGIN_STAGE

							var_38_9 = {}
							SYSTEM_PERFORM = var_3_10008
							var_38_9.system = var_3_10008
							tonumber = var_3_10008
							var_38_9.stageId = var_3_10008(var_38_3)

							var_38_10(var_38_8, var_38_11, var_38_9)
				...
				local var_38_12 = var_38_10.delayedCall

				go = var_38_8

				local var_38_13 = var_38_8(arg_35_0._tf)
				local var_38_14 = 1

				System = var_38_9

				var_38_12(var_38_13, var_38_14, var_38_9.Action(function()
					arg_36_0()
	...
	var_4.insert(var_35_0, function(arg_49_0)
		...
		local var_49_4 = var_2_10004.m02
		local var_49_5 = var_4.sendNotification

		GAME = var_2_10006

		var_49_5(var_49_4, var_2_10006.ACT_NEW_PT, {
			cmd = 1,
...
function var_0_1.createCell(arg_52_0, arg_52_1, arg_52_2)
	...
	local var_52_0 = var_1_10003(var_1_10004(var_1_10005(arg_52_0.tplCell)))
	local var_52_1 = arg_52_0.cellPos
	local var_52_2 = var_4.InverseTransformPoint(var_52_1, arg_52_0.char.position)

	Vector3 = var_52_1
	var_52_0.localPosition = var_52_1(var_52_2.x + arg_52_1 + 100, 0, 0)
	Vector3 = var_5
	var_52_0.localScale = var_5(0.5, 0.5, 0.5)
	setActive = var_5
	findTF = var_6

	var_5(var_6(var_52_0, "bg_gold"), false)

	setActive = var_5
	findTF = var_6

	var_5(var_6(var_52_0, "bg_oil"), false)

	setActive = var_5
	findTF = var_6

	var_5(var_6(var_52_0, "bg_item"), false)

	local var_52_3 = arg_52_0
	local var_52_4

	if arg_52_0.getPtAwardData(var_52_3, arg_52_0.useCount + 1) then
		if var_5[1] == 1 and var_5[2] == 1 then
			setActive = var_52_3
			findTF = var_52_4

			var_52_3(var_52_4(var_52_0, "bg_gold"), true)
		elseif var_5[1] == 1 and var_5[2] == 2 then
			setActive = var_52_3
			findTF = var_52_4

			var_52_3(var_52_4(var_52_0, "bg_oil"), true)
		elseif var_5[1] == 2 and var_5[2] == 0 then
			setActive = var_52_3
			findTF = var_52_4

			var_52_3(var_52_4(var_52_0, "bg_item"), true)
		else
			PoolMgr = var_52_3
			var_52_4 = var_52_3.GetInstance()

			var_52_3.GetSpineChar(var_52_4, var_0_5, true, function(arg_53_0)
				local var_53_0
				...
				if var_52_0 then
					...
					var_53_0(var_53_1, var_3(var_52_0, "baoxiang"), false)
					...
					typeof = var_3
					SpineAnimUI = var_4
					var_53_0 = var_53_0(var_53_2, var_3(var_4))
	...
	var_52_3(var_52_0, true)

	setParent = var_52_3

	var_52_3(var_52_0, arg_52_0.cellPos)

	table = var_52_3

	var_52_3.insert(arg_52_0.mapCells, var_52_0)
...
function var_0_1.insertMapTf(arg_55_0, arg_55_1, arg_55_2, arg_55_3)
	if arg_55_2 == var_0_24 then
		...
		var_4(var_55_0, var_1_10006(arg_55_0.container, "back"))
	elseif arg_55_2 == var_0_25 then
		...
		var_4(var_55_1, var_1_10006(arg_55_0.container, "mid"))
	elseif arg_55_2 == var_0_26 then
		...
		var_4(var_55_2, var_1_10006(arg_55_0.container, "front"))
	else
		print = var_4
...
function var_0_1.updateMap(arg_59_0, arg_59_1, arg_59_2)
	...
	if var_3.InverseTransformPoint(var_59_2, arg_59_0.translate.position).x <= var_0_28 - 600 then
		if arg_59_0.useCount < 9 then
			...
			arg_59_0.createMap(var_59_3, "ground_1")
		elseif arg_59_0.useCount < 20 then
			var_59_3 = arg_59_0

			arg_59_0.createMap(var_59_3, "ground_4")
		end
	end

	arg_59_0.moveDistance = arg_59_0.moveDistance + arg_59_1

	local var_59_4 = arg_59_0.back

	Vector2 = var_59_3
	var_59_4.anchoredPosition = var_59_3(arg_59_0.back.anchoredPosition.x - arg_59_1, 0)

	local var_59_5 = arg_59_0.mid

	Vector2 = var_5
	var_59_5.anchoredPosition = var_5(arg_59_0.mid.anchoredPosition.x - arg_59_1, 0)

	local var_59_6 = arg_59_0.front

	Vector2 = var_5
	var_59_6.anchoredPosition = var_5(arg_59_0.front.anchoredPosition.x - arg_59_1, 0)

	if #arg_59_0.mapCells > 0 then
		local var_59_7 = arg_59_0.mapTf

		if var_4.InverseTransformPoint(var_59_7, arg_59_0.mapCells[1].position).x < -1500 then
			table = var_5

			local var_59_8 = var_5.remove(arg_59_0.mapCells, 1)
...
function var_0_1.willExit(arg_65_0)
	...
	if var_65_0(var_1_10002(arg_65_0.cellPos)) then
		LeanTween = var_65_1
		var_65_1 = var_65_1.cancel
		go = var_2

		var_65_1(var_2(arg_65_0.cellPos))
	end
	...
	if var_65_2(var_2(arg_65_0._tf)) then
		LeanTween = var_1
		...
		var_65_3(var_2(arg_65_0._tf))
	end

	if #arg_65_0.baoxiangCells > 0 then
		for iter_65_0 = 1, #arg_65_0.baoxiangCells do
			PoolMgr = var_1_10005
			var_1_10006 = var_1_10005.GetInstance()

			var_1_10005.ReturnSpineChar(var_1_10006, var_0_5, arg_65_0.baoxiangCells[iter_65_0])
		end
	...
	for iter_65_1 = 1, #arg_65_0.models do
		...
		var_1_10005.ReturnSpineChar(var_1_10006, arg_65_0.modelIds[iter_65_1], arg_65_0.models[iter_65_1])
	end

	for iter_65_2 = #arg_65_0.mapCells, 1, -1 do
		Destroy = var_1_10005

		var_1_10005(arg_65_0.mapCells[iter_65_2])
	end
	...
	if arg_65_0.awardTfs and #arg_65_0.awardTfs > 0 then
		for iter_65_3 = #arg_65_0.awardTfs, 1, -1 do
			...
			var_1_10005(var_1_10006.remove(arg_65_0.awardTfs, iter_65_3))
		end
	end
