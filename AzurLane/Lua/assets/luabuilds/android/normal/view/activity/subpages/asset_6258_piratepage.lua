...
function var_0_1.OnShowFlush(arg_3_0)
	...
	if not var_3.canPermanentFinish(var_3_1) then
		local var_3_2 = arg_3_0.dialog_progress

		math = var_3_1

		if not var_3_2[var_3_1.random(#arg_3_0.dialog_progress)] then
			var_3_2 = arg_3_0.dialog_complete
			math = var_3_1
			var_3_2 = var_3_2[var_3_1.random(#arg_3_0.dialog_complete)]
		end
		...
		var_3_5(var_3_4, var_3.Action(function()
...
function var_0_1.OnFirstFlush(arg_6_0)
	...
	var_1(arg_6_0.red, arg_6_0:CheckRed())

	onButton = var_1

	local var_6_0 = arg_6_0
	local var_6_1 = arg_6_0.goBtn
	...
	local function var_6_2()
		...
		var_7_1(var_7_0, var_7_2, var_2_10003.SECRET_SHIPYARD)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	if arg_9_0.progress then
		...
		var_1(var_9_0, var_1_10003.format(var_0_1.PROGRESS_TEXT, arg_9_0.count))
		...
		var_1(var_9_1, not var_3.canPermanentFinish(var_9_2))
		...
		var_1(var_9_3, var_3.canPermanentFinish(var_9_4))
	end
