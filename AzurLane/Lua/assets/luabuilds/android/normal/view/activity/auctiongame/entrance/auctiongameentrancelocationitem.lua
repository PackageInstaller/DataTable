...
function var_0_1.Init(arg_2_0)
	...
	var_2(var_2_1, var_1_10004(var_2_2, var_1_10006.ForamtNumberK(var_2_0.threshold)))
	...
	local function var_2_5()
		...
		local var_3_2 = var_2(var_2_10003)
		local var_3_3 = var_2.getActivityByType

		ActivityConst = var_2_10005

		local var_3_4 = var_3_3(var_3_2, var_2_10005.ACTIVITY_TYPE_AUCTION_GAME)
		...
		AuctionGameEntranceLocationItem = var_6

		var_3_6(var_3_5, var_6.SELECTED_LOCATION, arg_2_0.id)
	...
	var_2(var_2_3, var_2_4, var_2_5, var_6)
...
function var_0_1.didEnter(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10005.ACTIVITY_TYPE_AUCTION_GAME)
...
function var_0_1.RefreshTip(arg_7_0)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10004.ACTIVITY_TYPE_AUCTION_GAME)

	setActive = var_7_0

	var_7_0(arg_7_0.uiTipGo, var_7_2:GetLocationTip(arg_7_0.id))
