...
function var_0_0.SetUI(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(var_1_10003.activity_event_question.all) do
		local var_2_0 = arg_2_0._tf

		var_1_10007 = var_1_10007.Find(var_2_0, "labels/label" .. iter_2_0)
		arg_2_0.questioneTFs[iter_2_1] = var_1_10007
	end
	...
	typeof = var_4
	Text = iter_2_0
	arg_2_0.day = var_2_4(var_2_3, var_4(iter_2_0))
	...
	local var_2_8 = var_2_7(var_2_6, var_4(iter_2_0))

	i18n = var_2_6
	var_2_8.text = var_2_6("LanternRiddle_wait_time_tip")
	setActive = var_3
	...
	var_3(var_2_9, var_2_10, var_2_11, var_1_10007)

	onButton = var_3

	local var_2_12 = arg_2_0
	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_5.Find(var_2_13, "back")
	...
	var_3(var_2_12, var_2_14, var_2_15, var_7)

	onButton = var_3

	local var_2_16 = arg_2_0
	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_5.Find(var_2_17, "back/help")
	...
	local function var_2_19()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.lanternRiddles_gametip.tip
	...
	var_3(var_2_16, var_2_18, var_2_19, var_7)

	onButton = var_3

	local var_2_20 = arg_2_0
	local var_2_21 = arg_2_0._tf
	local var_2_22 = var_5.Find(var_2_21, "option")
	...
	var_3(var_2_20, var_2_22, var_2_23, var_7)
...
function var_0_0.InitLanternRiddles(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_1) do
		...
		var_1_10009(var_8_2, var_8_3, var_8_4, var_1_10013)
		...
		if var_1_10009(var_10(var_8_0)) then
			LeanTween = var_1_10009
			var_1_10009 = var_1_10009.cancel
			go = var_10

			var_1_10009(var_10(var_8_0))
		end

		local var_8_5 = var_8_0

		var_1_10009 = var_8_0.Find(var_8_5, "image")

		if var_8_1 and not iter_8_1.isFinish then
			LeanTween = var_8_5
			var_8_5 = var_8_5.rotateZ
			go = var_11

			local var_8_6 = var_8_5(var_11(var_8_0), 10, 2)
			local var_8_7 = var_8_5.setLoopPingPong(var_8_6, 0)

			var_8_5.setFrom(var_8_7, 0)
		end

		setActive = var_8_5

		var_8_5(var_1_10009, var_8_1)
	end
...
function var_0_0.ShowMainPanel(arg_11_0, arg_11_1)
	...
	var_2(var_3.Find(var_11_1, "frame/label_game"), arg_11_1.type == 2)

	setActive = var_2

	local var_11_2 = arg_11_0.mainPanel

	var_2(var_3.Find(var_11_2, "frame/label_his"), arg_11_1.type == 1)

	setText = var_2

	local var_11_3 = arg_11_0.mainPanel

	var_2(var_3.Find(var_11_3, "frame/Text"), arg_11_1.text)
	...
	for iter_11_0 = 1, 4 do
		...
		local var_11_11 = var_11_6.GetChild(var_11_10, iter_11_0 - 1)

		setText = var_11_10

		var_11_10(var_11_11:Find("Text"), var_11_8)

		setActive = var_11_10

		var_11_10(var_11_11:Find("right"), var_11_7 and iter_11_0 == arg_11_1.rightIndex)

		setActive = var_11_10

		var_11_10(var_11_11:Find("false"), var_11_9)
		...
		local function var_11_14()
			...
			if var_12_1 < var_1.GetLockTime(var_12_2) then
				...
				local var_12_3 = var_12_2.TipsMgr.GetInstance()
				local var_12_4 = var_2.ShowTips

				i18n = var_2_10004

				var_12_4(var_12_3, var_2_10004("lanternRiddles_wait_for_reanswer"))
		...
		var_11_10(var_11_12, var_11_13, var_11_14, var_1_10016)
	end
...
function var_0_0.UpdateMainPanelTime(arg_13_0)
	...
	var_13_2(var_4.Find(var_13_4, "frame/time"), var_13_3)
...
function var_0_0.OnUpdateAnswer(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	var_14_1(var_14_2:Find("right"), arg_14_3)

	setActive = var_14_1

	var_14_1(var_14_2:Find("false"), not arg_14_3)
	...
	if not arg_14_3 then
		...
		local var_14_3 = var_14_1.TipsMgr.GetInstance()

		var_14_1 = var_14_1.ShowTips
		i18n = var_8

		var_14_1(var_14_3, var_8("lanternRiddles_answer_is_wrong"))
	else
		pg = var_14_1

		local var_14_4 = var_14_1.TipsMgr.GetInstance()
		local var_14_5 = var_6.ShowTips

		i18n = var_8

		var_14_5(var_14_4, var_8("lanternRiddles_answer_is_right"))
		...
		if var_14_7(var_8(var_14_6)) then
			LeanTween = var_7
...
function var_0_0.AddTimer(arg_16_0)
	...
	local var_16_5 = var_16_4(var_16_3, var_4(var_1_10005))

	Timer = var_16_3
	arg_16_0.timer = var_16_3.New(function()
		pg = var_2_10000
		...
		if var_16_1 - var_17_1 <= 0 then
			var_2_10003 = arg_16_0

			var_2.RemoveTimer(var_2_10003)

			setActive = var_2

			local var_17_2 = arg_16_0.mainPanel

			var_2(var_2_10003.Find(var_17_2, "frame/time"), false)
		else
			local var_17_3 = var_16_5

			pg = var_2_10003

			local var_17_4 = var_2_10003.TimeMgr.GetInstance()

			var_17_3.text = var_3.DescCDTime(var_17_4, var_1)
		end
