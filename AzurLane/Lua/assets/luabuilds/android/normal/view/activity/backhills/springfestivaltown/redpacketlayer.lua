...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.activityID = var_5_1(var_5_0, var_1_10003.ACTIVITY_TYPE_RED_PACKETS).id
	arg_5_0.countToStory = {}

	local var_5_2 = var_1

	if var_1.getConfig(var_5_2, "config_client").story then
		ipairs = var_5_2
...
function var_0_1.findUI(arg_6_0)
	...
	var_6_9(var_6_10, var_3.Find(var_6_11, "Container/Award"))
	...
	var_6_12(var_6_13, var_3.Find(var_6_14, "Container/Award2"))
...
function var_0_1.addListener(arg_7_0)
	...
	local function var_7_5()
		...
		var_9_1(var_9_0, var_2_10002.ACTIVITY_OPERATION, {
			cmd = 1,
	...
	local function var_7_8()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.help_chunjie_jiulou.tip
	...
	for iter_7_0, iter_7_1 in var_1_10001(arg_7_0.awardBtnList) do
		if iter_7_1 then
			...
			var_1_10006(var_7_9, var_7_10, var_7_11, var_1_10010)
		end
	end
...
function var_0_1.updateUI(arg_12_0)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10003.ACTIVITY_TYPE_RED_PACKETS).data3
	local var_12_3 = var_1.data1

	math = var_1_10004

	local var_12_4 = var_12_3 - var_1_10004.min(var_1.data1, var_1.data2)
...
function var_0_1.tryPlayStory(arg_13_0)
	...
	local var_13_2 = var_13_1(var_13_0, var_1_10003.ACTIVITY_TYPE_RED_PACKETS).data3
	local var_13_3 = var_1.data1

	math = var_1_10004

	local var_13_4 = var_13_3 - var_1_10004.min(var_1.data1, var_1.data2)
...
function var_0_1.isShowRedPoint()
	...
	return var_15_1(var_15_0, var_1_10002.ACTIVITY_TYPE_RED_PACKETS).data1 > 0
end
