...
local var_0_0 = "LittleMusashiPage"
...
function var_0_1.OnInit(arg_1_0)
	...
	local function var_1_3()
		...
		var_2_2.helps = var_3.GetHelpTip(var_2_3)
...
function var_0_1.GetHelpTip(arg_3_0)
	...
	return var_1_10001.gametip.littleMusashi_npc.tip
end
...
function var_0_1.OnUpdateFlush(arg_4_0)
	...
	local var_4_8 = arg_4_0.step

	setColorStr = var_1_10009

	local var_4_9 = var_1_10009(var_4_1, "#838fff")
	local var_4_10 = " / "

	setColorStr = var_11

	var_1_10007(var_4_8, var_4_9 .. var_4_10 .. var_11(var_4_2, "#666176"))

	setText = var_1_10007

	local var_4_11 = arg_4_0.progress
	...
	if 1 <= var_4_7 then
		...
		if not var_4_13(var_4_12, var_11) then
			setColorStr = var_4_13
			var_4_13 = var_4_13(var_4_5, "#7780d3")
		end
		...
		var_1_10007(var_4_11, var_4_13 .. var_4_14 .. var_11(var_4_6, "#666176"))

		local var_4_15

		if arg_4_0.firstSliderInit then
			LeanTween = var_4_15
			var_4_15 = var_4_15.isTweening
			go = var_4_11

			if var_4_15(var_4_11(arg_4_0.slider)) then
				LeanTween = var_4_15
				var_4_15 = var_4_15.cancel
				go = var_8

				var_4_15(var_8(arg_4_0.slider))
			end

			GetComponent = var_4_15

			local var_4_16 = arg_4_0.slider

			typeof = var_9
			Slider = var_4_14
			var_4_15 = var_4_15(var_4_16, var_9(var_4_14)).value
			var_4_15 = arg_4_0.l1 ~= var_4_1 and 0 or arg_4_0.sliderValue
			LeanTween = var_8

			local var_4_17 = var_8.value

			go = var_9

			local var_4_18 = var_4_17(var_9(arg_4_0.slider), var_4_15, var_4_7, 1)
			local var_4_19 = var_8.setOnUpdate

			System = var_10

			var_4_19(var_4_18, var_10.Action_float(function(arg_5_0)
			...
			var_4_15(arg_4_0.slider, 0, 1, var_4_7)
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	local function var_7_2()
		...
		local var_8_2 = var_2_10002.SHOW_AWARD_WINDOW
		...
		local var_8_4 = var_5.New
		local var_8_5 = {}

		DROP_TYPE_RESOURCE = var_2_10007
		var_8_5.type = var_2_10007
		var_8_5.id = arg_7_0.ptData.resId

		local var_8_6 = var_8_4(var_8_5)

		var_8_3.resIcon = var_5.getIcon(var_8_6)

		var_8_1(var_8_0, var_8_2, var_2_10003, var_8_3)
	...
	local function var_7_5()
		...
		var_9_1(var_9_0, var_9_2, var_2_10003.LEVEL)
...
function var_0_1.initTask(arg_10_0)
	...
	local var_10_2 = var_10_0.activity_template[var_10_1].config_data

	getProxy = var_3
	TaskProxy = var_1_10004
	arg_10_0.taskProxy = var_3(var_1_10004)
	arg_10_0.taskTplPool = {}
	GetComponent = var_3
	findTF = var_1_10004

	local var_10_3 = var_1_10004(arg_10_0.bg, "mission")

	typeof = var_5
	ScrollRect = var_6
	arg_10_0.taskScroll = var_3(var_10_3, var_5(var_6))
	arg_10_0.taskGroups = {}
	...
	for iter_10_0 = 1, #var_10_2 do
		...
		local var_10_5 = var_1_10008.task_data_template[var_10_4].type
		local var_10_6 = var_1_10008.sub_type
		...
		if var_10_5 ~= var_1_10011.TYPE_ACTIVITY then
			...
			if var_10_5 == var_1_10011.TYPE_ACTIVITY_BRANCH then
				...
				arg_10_0:insertTaskToGroup(var_10_4, var_1_10008, var_1_10011)
			end
		end
	end
...
function var_0_1.updateTaskList(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	if var_12_2 then
		...
		var_15(var_16(var_12_8, "pahase"), false)

		setSlider = var_15
		findTF = var_16

		var_15(var_16(var_12_8, "slider"), 0, 1, 1)
	else
		setActive = var_15
		findTF = var_16

		var_15(var_16(var_12_8, "pahase"), true)

		setSlider = var_15
		findTF = var_16

		var_15(var_16(var_12_8, "slider"), 0, 1, var_12_1 / var_12_0)
	end

	setText = var_15
	findTF = var_16

	var_15(var_16(var_12_8, "desc"), var_12_4)
	...
	if arg_12_4.subType ~= 33 then
		...
		local var_12_10 = var_17(var_12_1, "#19383")
		local var_12_11 = "/"

		setColorStr = var_19

		var_15(var_12_9, var_12_10 .. var_12_11 .. var_19(var_12_0, "#5c5967"))
	else
		setText = var_15
		findTF = var_12_9
	...
	local var_12_13 = var_17(var_12_8, "award")
	...
	var_15(var_12_12, var_12_13, var_12_14, var_19)
	...
	var_15(var_16(var_12_8, "get"), false)

	setActive = var_15
	findTF = var_16

	var_15(var_16(var_12_8, "go"), false)
	...
	if not var_12_3 then
		...
		local function var_12_17()
			...
			if var_14_1 then
				...
				var_14_3(var_14_2, var_2_10003.ON_TASK_GO, var_14_1)
			end
		...
		var_15(var_12_15, var_12_16, var_12_17, var_19)
	...
	elseif var_12_0 <= var_12_1 then
		...
		local function var_12_18()
			...
			if var_0.getTaskById(var_15_0, arg_12_3.id) then
				...
				var_15_2(var_15_1, var_2_10003.ON_TASK_SUBMIT, var_0)
			end
		...
		var_15(var_12_15, var_12_16, var_12_18, var_19)
	else
		setActive = var_15
		findTF = var_12_15
		...
		local function var_12_19()
			...
			if var_16_1 then
				...
				var_16_3(var_16_2, var_2_10003.ON_TASK_GO, var_16_1)
			end
		...
		var_15(var_12_15, var_12_16, var_12_19, var_19)
	end
	...
	if var_12_7 or not var_12_3 or var_12_2 and var_12_3 then
		...
		var_15(var_16(var_12_8, "show/on"), var_12_6)

		setActive = var_15
		findTF = var_16

		var_15(var_16(var_12_8, "show/off"), not var_12_6)
	end
	...
	if var_12_3 then
		...
		var_15(var_12_20, var_12_21, var_12_22, var_19)
	end
...
function var_0_1.getTaskTfFromPool(arg_19_0)
	...
	local var_19_1 = var_19_0(var_2(arg_19_0.missionTpl))
...
function var_0_1.insertTaskToGroup(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	var_21_10.insert(arg_21_3.tasks, {
		id = arg_21_1,
		targetNum = var_21_1,
		show = var_21_4,
		finish = var_21_6,
...
function var_0_1.OnDestroy(arg_25_0)
	...
	if var_25_0(var_1_10002(arg_25_0.slider)) then
		LeanTween = var_1
		...
		var_25_1(var_2(arg_25_0.slider))
	end
