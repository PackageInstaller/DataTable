...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.storyGroup = var_3_8[var_3_7.NEWMEIXIV4_SKIRMISH_ID].config_client.storys
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "top/back_btn")
	...
	local var_4_6 = var_3.Find(var_4_5, "top/option")
	...
	local function var_4_10()
		...
		i18n = var_2_10003
		var_7_2.helps = var_2_10003("MeixiV4_help")
	...
	local var_4_12 = var_2.Find(var_4_11, "bar/tip")

	i18n = var_4_11

	var_1_10001(var_4_12, var_4_11("world_collection_back"))
	arg_4_0:playAni()
	arg_4_0:updateNodes()
...
function var_0_1.updateNodes(arg_14_0)
	...
	var_1(var_14_0, var_14_1 .. var_1_10004.format("%02d", arg_14_0.curIndex))
	...
	var_1(var_14_2, var_3.format("%02d", arg_14_0.curIndex))
	...
	var_1(arg_14_0.nodes, function(arg_15_0)
		...
		if not var_3.getTaskById(var_15_2, var_15_1) then
			var_15_2 = arg_14_0.taskProxy

			local var_15_3 = var_3.getFinishTaskById(var_15_2, var_15_1)
		end

		setActive = var_15_2

		var_15_2(arg_15_0, var_15_0 <= arg_14_0.curIndex)
		...
		var_15_2(var_15_4, var_15_5, var_15_6, var_2_10008)
...
function var_0_1.nodeInfoTween(arg_17_0, arg_17_1)
	...
	local var_17_1 = var_3.Find

	tostring = var_1_10005

	local var_17_2 = var_1_10002(var_17_1(var_17_0, var_1_10005(arg_17_1), arg_17_0.nodes)).localPosition
	...
	local function var_17_3()
		...
		var_2_10000(var_18_0, var_2_10002(var_17_2.x, var_17_2.y + 120, 0))
		...
		var_2_10000(var_18_1, var_2(0, 0, 0))
		...
		var_18_2(var_18_3, var_2.one, 0.1)
	...
	local function var_17_4(arg_19_0)
		...
		var_2_10001(var_19_0, var_2_10003(1, 1, 1))
		...
		local var_19_3 = var_19_1(var_19_2, var_3.zero, 0.1)
		local var_19_4 = var_1.setOnComplete

		System = var_3

		var_19_4(var_19_3, var_3.Action(function()
			if arg_19_0 then
				arg_19_0()
			end
	...
	if not var_5(arg_17_0.nodeInfo) then
		setActive = var_5
...
function var_0_1.updateNodeInfo(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_21_1(var_21_0, var_1_10004.NEWMEIXIV4_SKIRMISH_ID)
	...
	if not var_4.getTaskById(var_21_4, var_21_3) then
		var_21_4 = arg_21_0.taskProxy
		var_21_5 = var_4.getFinishTaskById(var_21_4, var_21_3)
	end

	pg = var_21_4

	local var_21_6 = var_21_4.task_data_template[var_21_3]
	local var_21_7

	if not var_21_5 or not var_21_5:getProgress() then
		var_21_7 = var_21_6.target_num
	end

	local var_21_8

	if not var_21_5 or not var_21_5:getConfig("target_num") then
		var_21_8 = var_21_6.target_num
	end

	local var_21_9

	if not var_21_5 or not var_21_5:getTaskStatus() then
		var_21_9 = 2
	end

	if var_21_5 then
		var_1_10010 = var_21_5

		local var_21_10

		if not var_21_5.getConfig(var_1_10010, "desc") then
			var_21_10 = var_21_6.desc
		end

		setSlider = var_1_10010

		local var_21_11 = arg_21_0.nodeInfo

		var_1_10010(var_11.Find(var_21_11, "progress"), 0, var_21_8, var_21_7)

		setText = var_1_10010

		local var_21_12 = arg_21_0.nodeInfo

		var_1_10010(var_11.Find(var_21_12, "step"), var_21_7 .. "/" .. var_21_8)

		setText = var_1_10010

		local var_21_13 = arg_21_0.nodeInfo

		var_1_10010(var_11.Find(var_21_13, "content"), var_21_10)

		setText = var_1_10010

		local var_21_14 = arg_21_0.nodeInfo
		local var_21_15 = var_11.Find(var_21_14, "title")

		string = var_21_14

		var_1_10010(var_21_15, var_21_14.format("%02d", arg_21_1))

		local var_21_16 = arg_21_0.nodeInfo
		local var_21_17 = var_10.Find(var_21_16, "go_btn")
		local var_21_18 = arg_21_0.nodeInfo
		local var_21_19 = var_11.Find(var_21_18, "get_btn")
		local var_21_20 = arg_21_0.nodeInfo
		local var_21_21 = var_12.Find(var_21_20, "step/finish")

		setActive = var_21_20

		var_21_20(var_21_17, var_21_9 == 0)

		setActive = var_21_20

		var_21_20(var_21_19, var_21_9 == 1)

		setActive = var_21_20

		var_21_20(var_21_21, var_21_9 == 2)

		onButton = var_21_20

		local var_21_22 = arg_21_0
		local var_21_23 = var_21_17

		local function var_21_24()
			local var_22_0 = arg_21_0
			local var_22_1 = var_0.emit

			NewMeixiV4Mediator = var_2_10002

			var_22_1(var_22_0, var_2_10002.ON_TASK_GO, var_21_5)
		...
		var_21_20(var_21_22, var_21_23, var_21_24, var_1_10017)

		onButton = var_21_20

		local var_21_25 = arg_21_0
		local var_21_26 = var_21_19
		...
		local function var_21_27()
			...
			var_23_1(var_23_0, var_2_10002.ON_TASK_SUBMIT, var_21_5)
		...
		var_21_20(var_21_25, var_21_26, var_21_27, var_1_10017)

		eachChild = var_21_20

		var_21_20(arg_21_0.nodes, function(arg_24_0)
			local var_24_0 = arg_24_0
			local var_24_1 = arg_24_0.Find(var_24_0, "arrow")

			LeanTween = var_24_0

			var_24_0.cancel(var_24_1.gameObject)
			...
			var_2(var_24_2, var_2_10004(0, 27, 0))
			...
			if var_2(arg_24_0.name) == arg_21_1 then
				...
				var_24_4(var_24_1, true)

				LeanTween = var_24_4

				local var_24_3 = var_24_4.moveY(var_24_1, 40, 0.5)

				var_24_4 = var_24_4.setEase
				LeanTweenType = var_5

				local var_24_5 = var_24_4(var_24_3, var_5.easeInOutSine)

				var_24_4.setLoopPingPong(var_24_5)
			else
				setActive = var_24_4

				var_24_4(var_24_1, false)
			end
...
function var_0_1.getStory(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_1 = var_4.NewStoryMgr.GetInstance()
	...
	var_4(var_5.Find(var_26_2, "bar/Anim/Frame/Mask/Name"), var_26_0)
	...
	var_4(var_5.Find(var_26_3, "bar/Button"))
	...
	local var_26_8 = var_26_7(var_26_6, var_6(var_7))
	...
	local function var_26_9()
		...
		local var_27_2 = var_2.Find(var_27_1, "bar/Button")

		local function var_27_3()
			local var_29_0 = arg_26_0
			local var_29_1 = var_0.emit

			NewMeixiV4Mediator = var_3_10002

			var_29_1(var_29_0, var_3_10002.GO_STORY, arg_26_0.memoryGroup)
		...
		var_2_10000(var_27_0, var_27_2, var_27_3, var_4)
