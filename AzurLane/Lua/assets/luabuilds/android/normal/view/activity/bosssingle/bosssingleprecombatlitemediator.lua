...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BossSinglePreCombatMediator"))
...
function var_0_1.bindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.BEGIN_STAGE_PROXY, function(arg_12_0, arg_12_1)
		...
		var_12_2(var_12_1, var_2_10005.BEGIN_STAGE, {
			stageId = arg_2_0.contextData.stageId,
...
function var_0_1.onAutoBtn(arg_15_0, arg_15_1)
	...
	var_15_3(var_15_2, var_1_10006.AUTO_BOT, {
...
function var_0_1.onAutoSubBtn(arg_16_0, arg_16_1)
	...
	var_16_3(var_16_2, var_1_10006.AUTO_SUB, {
...
function var_0_1.handleNotification(arg_19_0, arg_19_1)
	...
	if var_19_0 == var_19_1.BEGIN_STAGE_DONE then
		...
		var_19_4(var_19_3, var_1_10006, var_1_10007.COMBATLOAD, var_19_2)
	else
		GAME = var_19_4

		local var_19_6

		if var_19_0 == var_19_4.BEGIN_STAGE_ERRO then
			if var_19_2 == 3 then
				pg = var_19_6
				...
				var_19_6(var_19_5, var_1_10006)
			end
		else
			PreCombatMediator = var_19_6

			if var_19_0 == var_19_6.BEGIN_STAGE_PROXY then
				local var_19_7 = arg_19_0.viewComponent
				local var_19_8 = var_4.emit

				PreCombatMediator = var_1_10006

				var_19_8(var_19_7, var_1_10006.BEGIN_STAGE_PROXY, var_19_2)
			elseif var_19_0 == var_0_1.CONTINUOUS_OPERATION then
				local var_19_9 = arg_19_0.viewComponent
				local var_19_10 = var_4.emit

				PreCombatMediator = var_1_10006

				var_19_10(var_19_9, var_1_10006.ON_START, var_19_2.mainFleetId, var_19_2.battleTimes)
			end
		end
	end
