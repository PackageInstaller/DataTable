...
function var_0_1.IsDay()
	...
	local var_3_2 = var_3_0(var_1_10002)
	local var_3_3 = var_1.getActivityById(var_3_2, var_0_1.ACT_ID)

	assert = var_3_2

	var_3_2(var_3_3 and not var_3_3:isEnd(), "not exist liner act, type: " .. var_0_1.ACT_ID)
...
function var_0_1.init(arg_4_0)
	...
	for iter_4_0 = 0, arg_4_0._dayTF.childCount - 1 do
		...
		local var_4_4 = var_4_2(var_4_3).name

		arg_4_0["day_" .. var_4_4] = var_4_3
	end

	for iter_4_1 = 0, arg_4_0._nightTF.childCount - 1 do
		local var_4_5 = arg_4_0._nightTF
		local var_4_6 = var_5.GetChild(var_4_5, iter_4_1)

		go = var_4_5

		local var_4_7 = var_4_5(var_4_6).name

		arg_4_0["night_" .. var_4_7] = var_4_6
	end
	...
	arg_4_0._log_tip = var_1.Find(var_4_8, "top/btn_log/tip")

	local var_4_9 = arg_4_0._tf

	arg_4_0._unlock = var_1.Find(var_4_9, "top/unlock_info")
	getProxy = var_1
	ActivityProxy = var_4_9

	local var_4_10 = var_1(var_4_9)

	arg_4_0.activity = var_1.getActivityById(var_4_10, var_0_1.ACT_ID)
	pg = var_1
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "top/btn_back")
	...
	local var_5_6 = var_3.Find(var_5_5, "top/btn_help")
	...
	local function var_5_7()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip["7th_main_tip"].tip
	...
	arg_5_0:InitFacilityCross(arg_5_0._dayTF, arg_5_0._nightTF, "btn_game", function()
		...
		LinerBackHillMediator = var_2_10002

		var_8_1(var_8_0, var_2_10002.GO_MINIGAME, var_0_1.MINIGAME_ID)
	...
	arg_5_0:InitFacilityCross(arg_5_0._dayTF, arg_5_0._nightTF, "btn_cruise", function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10003.LINER)
	...
	arg_5_0.InitFacilityCross(var_5_8, arg_5_0._dayTF, arg_5_0._nightTF, "btn_task", function()
		...
		var_10_1(var_10_0, var_10_2, var_2_10003.ACTIVITY, {
	...
	local var_5_12 = var_5_10.NewStoryMgr.GetInstance()
	...
	local var_5_16 = var_6.Find(var_5_15, "top/btn_log")
	...
	local function var_5_17()
		if var_5_13 then
			...
			var_11_1(var_11_0, var_2_10002("liner_activity_lock"))
		else
			...
			local var_11_4 = var_2_10002.GO_SUBLAYER

			Context = var_2_10003

			local var_11_5 = var_2_10003.New
			local var_11_6 = {}

			LinerLogBookMediator = var_2_10005
			var_11_6.mediator = var_2_10005
			LinerLogBookLayer = var_2_10005
			var_11_6.viewComponent = var_2_10005
	...
	var_5_12(var_5_14, var_5_16, var_5_17, var_8)

	setActive = var_5_12

	var_5_12(arg_5_0.day_btn_task, var_5_13)

	setActive = var_5_12

	var_5_12(arg_5_0.night_btn_task, var_5_13)

	setActive = var_5_12

	var_5_12(arg_5_0._unlock, var_5_13)

	setActive = var_5_12

	var_5_12(arg_5_0.day_btn_cruise, not var_5_13)

	setActive = var_5_12

	var_5_12(arg_5_0.night_btn_cruise, not var_5_13)

	setActive = var_5_12

	var_5_12(arg_5_0._dayTF, var_0_1.IsDay())

	setActive = var_5_12

	var_5_12(arg_5_0._nightTF, not var_0_1.IsDay())
	arg_5_0:UpdateView()
...
function var_0_1.UpdateView(arg_12_0)
	...
	var_1_10001(var_2.Find(var_12_0, "tip"), var_0_1.MiniGameTip())

	setActive = var_1_10001

	local var_12_1 = arg_12_0.night_btn_game

	var_1_10001(var_2.Find(var_12_1, "tip"), var_0_1.MiniGameTip())

	setActive = var_1_10001

	local var_12_2 = arg_12_0.day_btn_cruise

	var_1_10001(var_2.Find(var_12_2, "tip"), var_0_1.CruiseTip())

	setActive = var_1_10001

	local var_12_3 = arg_12_0.night_btn_cruise

	var_1_10001(var_2.Find(var_12_3, "tip"), var_0_1.CruiseTip())
...
function var_0_1.GetDate()
	...
	local var_13_2 = var_1_10002.TimeMgr.GetInstance()

	return var_13_1(var_13_0, var_2.GetServerTime(var_13_2), "%Y/%m/%d")
end
...
function var_0_1.CruiseTip()
	...
	local var_16_4 = var_16_2.GetString("LinerBackHillScene") == var_0_1.GetDate()
