...
function var_0_1.init(arg_4_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0.dayTxt = var_4_5(var_4_4, var_3(var_1_10004))
	...
	local var_4_12 = var_2.Find(var_4_11, "toggles/award/selected/Text")

	i18n = var_4_11

	var_1(var_4_12, var_4_11(arg_4_0.rewardTip))

	setText = var_1

	local var_4_13 = arg_4_0.frame
	local var_4_14 = var_2.Find(var_4_13, "toggles/award/unselected/Text")

	i18n = var_4_13

	var_1(var_4_14, var_4_13(arg_4_0.rewardTip))

	setText = var_1

	local var_4_15 = arg_4_0.frame
	local var_4_16 = var_2.Find(var_4_15, "toggles/task/selected/Text")

	i18n = var_4_15

	var_1(var_4_16, var_4_15(arg_4_0.missionTip))

	setText = var_1

	local var_4_17 = arg_4_0.frame
	local var_4_18 = var_2.Find(var_4_17, "toggles/task/unselected/Text")

	i18n = var_4_17

	var_1(var_4_18, var_4_17(arg_4_0.missionTip))
	...
	var_4_19[var_4_20] = var_4_21(var_4.Find(var_4_22, "frame/award_container"), arg_4_0.event, arg_4_0.contextData)

	local var_4_23 = var_0_1.PAGE_TASK
	local var_4_24 = arg_4_0.taskPageCls.New
	local var_4_25 = arg_4_0._tf

	var_4_19[var_4_23] = var_4_24(var_4.Find(var_4_25, "frame/task_container"), arg_4_0.event, arg_4_0.contextData)
...
function var_0_1.didEnter(arg_7_0)
	...
	local var_7_2 = var_3.Find(var_7_1, "title/back")
	...
	local function var_7_6()
		...
		local var_9_2 = var_2_10002.NewStyleMsgboxMgr.TYPE_COMMON_HELP
		local var_9_3 = {}

		i18n = var_2_10004
		var_9_3.helps = var_2_10004(arg_7_0.helpBtnTip)
	...
	var_1_10001(var_7_4, var_7_5, var_7_6, var_5)
	...
	var_1_10001(var_7_7, var_7_8, var_7_9, var_5)

	local var_7_10 = arg_7_0.activity.stopTime

	pg = var_7_7

	local var_7_11 = var_7_7.TimeMgr.GetInstance()
	local var_7_12 = var_7_10 - var_2.GetServerTime(var_7_11)
	local var_7_13 = arg_7_0.dayTxt

	i18n = var_7_11

	local var_7_14 = var_7_11(arg_7_0.dayTextTip)
	...
	local var_7_16 = var_1_10006.floor(var_7_12 / 0)

	math = var_7
	var_7_13.text = var_7_14 .. var_4(var_7_15, var_7_16, var_7.floor(var_7_12 % 0 / 16))
...
function var_0_1.SetAward(arg_11_0)
	...
	var_1.make(var_11_1, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventInit then
			...
			local var_12_2 = var_12_0.Create({
			...
			local function var_12_5()
				...
				var_13_1(var_13_0, var_3_10002.ON_NEW_STYLE_DROP, {
					drop = var_12_2
				})
			...
			var_5(var_12_3, var_12_4, var_12_5, var_2_10009)
		end
...
function var_0_1.UpdatePhase(arg_14_0)
	...
	var_1_10001(var_2.Find(var_14_0, "Text"), arg_14_0.phase)
	...
	if arg_14_0.phase < #arg_14_0.awardList then
		...
		local var_14_4 = arg_14_0.phaseTF
		local var_14_5 = var_14_6.Find(var_14_4, "slider")

		var_14_6 = var_14_6.GetComponent
		typeof = var_6
		Image = var_1_10007
		var_14_6 = var_14_6(var_14_5, var_6(var_1_10007))
		var_14_6.fillAmount = var_14_2 / var_14_3
		setText = var_14_6

		local var_14_7 = arg_14_0.phaseTF

		var_14_6(var_5.Find(var_14_7, "progress/progress1"), var_14_2)

		setText = var_14_6

		local var_14_8 = arg_14_0.phaseTF

		var_14_6(var_5.Find(var_14_8, "progress/progress2"), "/" .. var_14_3)
	else
		...
		local var_14_12 = var_14_11(var_14_10, var_3(var_14_6))

		var_14_12.fillAmount = 1
		setText = var_14_12

		local var_14_13 = arg_14_0.phaseTF

		var_14_12(var_2.Find(var_14_13, "progress/progress1"), "MAX")

		setActive = var_14_12

		local var_14_14 = arg_14_0.phaseTF

		var_14_12(var_2.Find(var_14_14, "progress/progress2"), false)
	end

	local var_14_15 = arg_14_0.contextData

	var_14_15.phase = arg_14_0.phase
	setActive = var_14_15

	var_14_15(arg_14_0.btnPay, not arg_14_0.isPay)

	local var_14_16, var_14_17

	if not arg_14_0.isPay then
		var_14_16 = arg_14_0.chargePageCls.GetPassID()
		pg = var_2
		var_14_17 = var_2.TimeMgr.GetInstance()

		local var_14_18 = var_2.inTime

		pg = var_14_6

		if not var_14_18(var_14_17, var_14_6.pay_data_display[var_14_16].time) then
			setActive = var_14_17

			var_14_17(arg_14_0.btnPay, false)
		end
	end

	setText = var_14_16

	local var_14_19 = arg_14_0.titleTF

	i18n = var_14_17

	var_14_16(var_14_19, var_14_17(arg_14_0.titleTextTip))
...
function var_0_1.UpdateAwardTip(arg_16_0)
	...
	local var_16_1 = var_2.Find(var_16_0, "award/tip")
	local var_16_2 = arg_16_0.activity

	var_1_10001(var_16_1, #var_3.GetHei5UnreceiveAward(var_16_2) > 0)
