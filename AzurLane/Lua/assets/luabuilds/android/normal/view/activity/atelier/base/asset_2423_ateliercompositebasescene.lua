...
function var_0_1.OnClickStore(arg_4_0)
	...
	local var_4_3 = var_4_2(var_4_1, var_1_10004)

	addSubLayer = var_4_1
	Context = var_1_10004

	local var_4_4 = var_1_10004.New
	local var_4_5 = {}

	AtelierStoreBaseMediator = var_1_10006
	var_4_5.mediator = var_1_10006
	AtelierStoreBaseScene = var_1_10006
	var_4_5.viewComponent = var_1_10006
	var_4_5.data = {
		activity = arg_4_0.activity
	}

	var_4_1(var_4_4(var_4_5), var_4_3)
...
function var_0_1.InitCustom(arg_8_0)
	...
	local var_8_2 = var_2.Find(var_8_1, "Empty/Bar/Text")

	i18n = var_8_1

	var_1(var_8_2, var_8_1(arg_8_0.unlockText))
	...
	local var_8_7 = var_2.Find(var_8_6, "Mask/BG")

	var_8_5(var_2.GetChild(var_8_7, 0), -1)
...
function var_0_1.didEnter(arg_12_0)
	...
	local var_12_8 = var_3.Find(var_12_7, "Top/TopBar/Back")
	...
	var_1(var_12_6, var_12_8, var_12_9, var_5)

	onButton = var_1

	local var_12_10 = arg_12_0
	local var_12_11 = arg_12_0._tf
	local var_12_12 = var_3.Find(var_12_11, "Top/TopBar/Home")
	...
	var_1(var_12_10, var_12_12, var_12_13, var_5)

	onButton = var_1

	local var_12_14 = arg_12_0
	local var_12_15 = arg_12_0._tf
	local var_12_16 = var_3.Find(var_12_15, "Top/TopBar/Help")
	...
	local function var_12_17()
		...
		i18n = var_2_10003
		var_15_2.helps = var_2_10003(arg_12_0.helpStr)
	...
	var_1(var_12_14, var_12_16, var_12_17, var_5)

	onButton = var_1

	local var_12_18 = arg_12_0
	local var_12_19 = arg_12_0._tf
	local var_12_20 = var_3.Find(var_12_19, "Top/TopBar/StoreHouse")
	...
	var_1(var_12_18, var_12_20, var_12_21, var_5)
...
function var_0_1.PlayGuide(arg_17_0)
	if arg_17_0.unlockSystem then
		...
		local var_17_1 = var_1_10002.format
		...
		if var_17_0(var_17_1(var_17_2, var_4.getRawData(var_17_3).id, arg_17_0.activity.id), 0) == 0 then
			triggerButton = var_1

			local var_17_4 = arg_17_0._tf

			var_1(var_2.Find(var_17_4, "Top/TopBar/Help"))
			...
			local var_17_6 = var_2.format
			local var_17_7 = "first_enter_ryza_atelier_%s_%s"

			getProxy = var_4
			PlayerProxy = var_5

			local var_17_8 = var_4(var_5)

			var_17_5(var_17_6(var_17_7, var_4.getRawData(var_17_8).id, arg_17_0.activity.id), 1)
		end
	end
...
function var_0_1.UpdateRyzaDrop(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	local var_19_1 = arg_19_1.Find(var_19_0, "icon_bg")

	typeof = var_19_0
	Image = var_7

	var_1_10004(var_19_1, var_19_0(var_7), false)
	...
	if var_19_3 ~= var_6 then
		...
		if var_19_7 ~= var_19_6 then
			...
			var_19_7(var_19_8, var_19_9, var_19_10, var_10)
		else
...
function var_0_1.UpdateRyzaItem(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	CustomIndexLayer = var_21_3

	local var_21_5 = var_21_3.Clone2Full(arg_21_1:Find("List"), #var_21_4)

	ipairs = var_7

	for iter_21_0, iter_21_1 in var_7(var_21_5) do
		...
		AtelierFormulaCircle = var_1_10016

		var_21_7(var_21_6, var_21_8, var_21_9 .. var_1_10016.ELEMENT_NAME[var_21_4[iter_21_0]], iter_21_1)
	end
...
function var_0_1.DispalyChat(arg_33_0, arg_33_1)
	...
	local var_33_1 = var_3(arg_33_0.chat)
	local var_33_2 = 4

	System = var_1_10005
	arg_33_0.chatTween = var_33_0(var_33_1, var_33_2, var_1_10005.Action(function()
	...
	local var_33_4 = var_4.gametip[arg_33_0.tipStr].tip
	...
	var_7(var_8.Find(var_33_6, "Text"), var_33_5)
...
function var_0_1.ShowItemDetail(arg_38_0, arg_38_1)
	...
	var_38_1(var_38_0, var_1_10004.SHOW_DETAIL, arg_38_1)
...
function var_0_1.AddIdleTimer(arg_46_0)
	...
	math = var_1_10003
	arg_46_0.idleTimer = var_46_0(var_46_1, 8 + var_1_10003.random() * 4)
...
function var_0_1.OnCompositeResult(arg_51_0, arg_51_1)
	...
	var_4.GetPrefab(var_51_2, "ui/" .. arg_51_0:GetAtelierCompositEffect(), "", function(arg_52_0)
		...
		var_52_1(var_52_0, var_2_10003(arg_52_0))
		...
		var_52_1(var_52_2, var_3.GetAtelierCompositEffectPos(var_52_3))
		...
		local var_52_6 = var_3.alphaCanvas
		local var_52_7
		...
		local var_52_9 = var_52_5(var_52_4, var_52_6, var_52_7, var_2_10005(var_52_8, var_2_10007(var_2_10008)), 0, var_51_0)
		...
		local var_52_12 = var_3.alphaCanvas
		local var_52_13
		...
		local var_52_15 = var_52_11(var_52_10, var_52_12, var_52_13, var_5(var_52_14, var_7(var_2_10008)), 0, var_51_0)
		...
		local var_52_18 = var_3.alphaCanvas
		local var_52_19
		...
		local var_52_21 = var_52_17(var_52_16, var_52_18, var_52_19, var_5(var_52_20, var_7(var_2_10008)), 0, var_51_0)
		...
		local var_52_24 = var_3.delayedCall
		...
		local function var_52_25()
			...
			local var_53_6 = var_2.alphaCanvas
			local var_53_7
			...
			local var_53_9 = var_53_5(var_53_4, var_53_6, var_53_7, var_3_10004(var_53_8, var_3_10006(var_3_10007)), 1, var_51_1)
			...
			local var_53_12 = var_2.alphaCanvas
			local var_53_13
			...
			local var_53_15 = var_53_11(var_53_10, var_53_12, var_53_13, var_4(var_53_14, var_6(var_3_10007)), 1, var_51_1)
			...
			local var_53_18 = var_2.alphaCanvas
			local var_53_19
			...
			local var_53_21 = var_53_17(var_53_16, var_53_18, var_53_19, var_4(var_53_20, var_6(var_3_10007)), 1, var_51_1)
			...
			local var_53_24 = var_2.delayedCall
			...
			local function var_53_25()
				...
				var_54_2(var_54_1, var_4_10002(arg_52_0), arg_51_0._tf)
			...
			var_53_23(var_53_22, var_53_24, var_53_25, var_4(arg_51_0.compositeResultPanel), var_51_1, nil)
		...
		var_52_23(var_52_22, var_52_24, var_52_25, var_5(arg_51_0.compositeResultPanel), var_51_0, nil)
...
function var_0_1.CleanNodeInstance(arg_56_0)
	...
	if not var_1.IsAvaliable(var_56_1) then
		...
		var_56_1 = arg_56_0.contextData
		var_56_1.formulaId = nil
	...
	var_56_1.each(arg_56_0.atelierFormulaDetailView.nodeList, function(arg_57_0)
