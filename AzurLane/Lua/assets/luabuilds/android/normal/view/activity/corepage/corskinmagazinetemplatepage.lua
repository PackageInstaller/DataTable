...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	var_1(var_4_2, var_4_1(arg_4_0.TIP_KEY))
...
function var_0_1.SelectItem(arg_7_0, arg_7_1)
	...
	for iter_7_2 = 1, arg_7_0.items.childCount do
		...
		if iter_7_2 ~= arg_7_1 or not arg_7_0.EXPAND_WIDTH then
			var_1_10009 = arg_7_0.CLOSE_WIDTH
		end

		if var_7_4 ~= var_1_10009 then
			math = var_1_10010
			var_1_10010 = var_1_10010.abs(var_1_10009 - var_7_4) / arg_7_0.DURATION_PARAMETER
			table = var_11
...
function var_0_1.UpdateDrop(arg_9_0)
	...
	local var_9_2 = var_9_0.Create(var_9_1:getConfig("award_display")[1])

	updateDrop = var_3

	var_3(arg_9_0.awardTf, var_9_2)

	onButton = var_3

	local var_9_3 = arg_9_0
	local var_9_4 = arg_9_0.awardTf
	local var_9_5 = var_5.Find(var_9_4, "get")
	...
	var_3(var_9_3, var_9_5, var_9_6, var_7)

	onButton = var_3

	var_3(arg_9_0, arg_9_0.awardTf, function()
	...
	for iter_9_0, iter_9_1 in var_4(arg_9_0.taskList) do
		tobool = var_1_10009

		local var_9_8 = arg_9_0.taskProxy

		var_9_7[iter_9_1] = var_1_10009(var_10.getFinishTaskById(var_9_8, iter_9_1))
	end

	local var_9_9 = var_9_7[arg_9_0.taskList[arg_9_0.index]]

	setActive = var_5

	local var_9_10 = arg_9_0.awardTf

	var_5(var_6.Find(var_9_10, "got"), var_9_9)

	setActive = var_5

	local var_9_11 = arg_9_0.awardTf

	var_5(var_6.Find(var_9_11, "get"), arg_9_0.remainCnt > 0 and not var_9_9)
