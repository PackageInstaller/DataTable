...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	for iter_1_0 = 1, var_0_2 do
		...
		if iter_1_0 <= #var_0_1 then
			...
			local var_1_4 = var_12(var_1_10009, "off/text")

			i18n = var_13
			IslandTaskScene = var_14

			var_1_10011(var_1_4, var_13(var_14.add_tages[var_1_3]))
			...
			var_1_10011(var_1_5, var_13(var_14.add_tages[var_1_3]))
		else
			setActive = var_1_3
	...
	local var_1_6 = var_6(arg_1_0.taskDetailPanel, "desc/title")

	i18n = var_7
	IslandTaskScene = var_8

	var_5(var_1_6, var_7(var_8.ryza_task_detail_content))
	...
	var_5(var_1_7, var_7(var_8.ryza_task_detail_award))

	arg_1_0.btnTags = {}

	for iter_1_1 = 1, var_0_2 do
		var_1_10009 = iter_1_1

		local var_1_8 = var_0_1[iter_1_1]

		findTF = var_1_10011
		var_1_10011 = var_1_10011(arg_1_0.taskTagPanel, "btn" .. var_1_10009)
		onButton = var_12

		var_12(arg_1_0._event, var_1_10011, function()
			if arg_1_0.clickIndex then
				setActive = var_0
				findTF = var_2_10001

				var_0(var_2_10001(arg_1_0.btnTags[arg_1_0.clickIndex], "on"), false)

				if arg_1_0.clickIndex == var_1_10009 then
					arg_1_0.clickIndex = nil
				else
					local var_2_0 = arg_1_0

					var_2_0.clickIndex = var_1_10009
					setActive = var_2_0
					findTF = var_1

					var_2_0(var_1(arg_1_0.btnTags[arg_1_0.clickIndex], "on"), true)
				end
			else
				local var_2_1 = arg_1_0

				var_2_1.clickIndex = var_1_10009
				setActive = var_2_1
				findTF = var_1

				var_2_1(var_1(arg_1_0.btnTags[arg_1_0.clickIndex], "on"), true)
			end
			...
			var_0.onClickTag(var_2_4, var_1_10009)
		...
		var_12.insert(arg_1_0.btnTags, var_1_10011)
	end
	...
	local var_1_10 = arg_1_0.btnGetAll
	...
	local function var_1_11()
		...
		var_4_2(var_4_1, var_2_10003.SUBMIT_TASK_ALL, {
	...
	var_5(var_1_9, var_1_10, var_1_11, var_1_10009)

	onButton = var_5

	local var_1_12 = arg_1_0._event
	local var_1_13 = arg_1_0.detailBtnGo
	...
	local function var_1_14()
		...
		var_5_2(var_5_1, var_2_10003.TASK_GO, {
			taskVO = var_5_0
		})
	...
	var_5(var_1_12, var_1_13, var_1_14, var_1_10009)

	onButton = var_5

	local var_1_15 = arg_1_0._event
	local var_1_16 = arg_1_0.detailBtnSubmit
	...
	local function var_1_17()
		...
		if var_1.getConfig(var_6_2, "sub_type") == 1006 then
			...
			IslandTaskScene = var_2_10004

			var_6_4(var_6_3, var_2_10004.OPEN_SUBMIT, arg_1_0.selectTask)
		else
			...
			var_6_6(var_6_5, var_2_10004.SUBMIT_TASK, {
				activityId = arg_1_0.activityId,
	...
	var_5(var_1_15, var_1_16, var_1_17, var_1_10009)

	onButton = var_5

	local var_1_18 = arg_1_0._event
	local var_1_19 = arg_1_0.detailBtnGet
	...
	local function var_1_20()
		...
		if var_1.getConfig(var_7_2, "sub_type") == 1006 then
			...
			var_7_4(var_7_3, var_2_10004.OPEN_SUBMIT, arg_1_0.selectTask)
		else
			...
			var_7_6(var_7_5, var_2_10004.SUBMIT_TASK, {
				activityId = arg_1_0.activityId,
				id = arg_1_0.selectTask.id
			})
		end
	...
	var_5(var_1_18, var_1_19, var_1_20, var_1_10009)

	onButton = var_5

	local var_1_21 = arg_1_0._event
	local var_1_22 = arg_1_0.detailBtnDetail
	...
	local function var_1_23()
		if arg_1_0.selectTask then
			...
			if var_0(var_1.getConfig(var_8_0, "target_id_2")) and 0 < var_0 then
				...
				var_8_2.count = var_3.getConfig(var_8_3, "target_num")

				local var_8_4 = var_8_1(var_8_2)
				local var_8_5 = arg_1_0._event
				local var_8_6 = var_2.emit

				IslandTaskMediator = var_8_3

				var_8_6(var_8_5, var_8_3.SHOW_DETAIL, var_8_4)
			end
		end
	...
	var_5(var_1_21, var_1_22, var_1_23, var_1_10009)
	arg_1_0:updateTask()
	arg_1_0:onClickTag()
...
function var_0_0.onUpdateTaskItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_2 = var_3(var_9_1, var_5(var_1_10006))
	...
	local var_9_5 = var_9_4(var_9_3, var_6.linear)
	local var_9_6 = var_4.setOnUpdate

	System = var_6

	local var_9_7 = var_9_6(var_9_5, var_6.Action_float(function(arg_10_0)
	...
	var_9_8(var_9_7, var_6.Action(function()
	...
	local var_9_15 = var_4:isCircle()
	local var_9_16 = var_4
	local var_9_17 = var_4.isDaily(var_9_16)

	setActive = var_9_16
	findTF = var_1_10014

	var_9_16(var_1_10014(arg_9_2, "selected"), arg_9_0.selectIndex == arg_9_1)

	setActive = var_9_16
	findTF = var_14

	var_9_16(var_14(arg_9_2, "typeNew"), var_4:isNew())

	setActive = var_9_16
	findTF = var_14

	local var_9_18 = var_14(arg_9_2, "typeCircle")
	local var_9_19
	...
	var_9_16(var_9_18, var_9_19)

	setActive = var_9_16
	findTF = var_9_18

	var_9_16(var_9_18(arg_9_2, "finish"), var_9_13)

	setActive = var_9_16
	findTF = var_14

	var_9_16(var_14(arg_9_2, "mask"), var_9_13)

	setActive = var_9_16
	findTF = var_14

	var_9_16(var_14(arg_9_2, "complete"), not var_9_13 and var_9_14 and not var_9_15)

	setText = var_9_16
	findTF = var_14

	local var_9_20 = var_14(arg_9_2, "desc/text")

	setColorStr = var_15
	shortenString = var_16

	var_9_16(var_9_20, var_15(var_16(var_9_11, 10), "#9D6B59"))

	if not var_9_12 or var_9_12 == 0 then
		var_9_12 = "attack"
	end

	setImageSprite = var_9_16
	findTF = var_9_20
	...
	var_9_16(var_9_21, var_15(var_16.icon_atlas, var_9_12))
	...
	var_9_16(var_9_22, var_15(arg_9_2), function()
		if arg_9_0.selectItem then
			setActive = var_0
			findTF = var_2_10001

			var_0(var_2_10001(arg_9_0.selectItem, "selected"), false)

			setText = var_0
			findTF = var_2_10001
			var_2_10001 = var_2_10001(arg_9_0.selectItem, "desc/text")
			setColorStr = var_2
			shortenString = var_3

			local var_12_0 = arg_9_0.selectTask

			var_0(var_2_10001, var_2(var_3(var_4.getConfig(var_12_0, "name"), 10), "#9D6B59"))
		end

		setActive = var_0
		findTF = var_2_10001

		var_0(var_2_10001(arg_9_2, "selected"), true)

		setText = var_0
		findTF = var_1

		local var_12_1 = var_1(arg_9_2, "desc/text")

		setColorStr = var_2
		shortenString = var_3

		var_0(var_12_1, var_2(var_3(var_9_11, 10), "#5C3E24"))
...
function var_0_0.updateTask(arg_13_0, arg_13_1)
	...
	for iter_13_0 = 1, #var_13_1 do
		...
		if not var_1_10009.contains(arg_13_0.hideTask, var_13_2) then
			var_1_10010 = var_7
			var_1_10009 = var_7.getProgress(var_1_10010)
			var_1_10011 = var_7
	...
	for iter_13_2, iter_13_3 in iter_13_0(arg_13_0.displayTask) do
		table = var_1_10011
...
function var_0_0.updateDetail(arg_15_0)
	...
	local var_15_1 = var_1:getProgress()
	local var_15_2 = var_1.target

	pg = var_1_10005

	local var_15_3 = var_1_10005.task_data_template[var_15_0]
	local var_15_4 = var_1:isFinish()
	local var_15_5 = var_1:isOver()
	local var_15_6 = var_1:isCircle()
	local var_15_7 = var_1:isSubmit()

	arg_15_0.awards = var_15_3.award_display

	local var_15_8 = var_15_3.desc
	local var_15_9 = var_15_3.ryza_icon
	local var_15_10 = var_1
	local var_15_11 = var_1.getConfig(var_15_10, "sub_type")

	if not var_15_9 or var_15_9 == 0 then
		var_15_9 = "attack"
	end

	if not var_15_7 and var_15_2 < var_15_1 then
		var_15_1 = var_15_2
	end

	setText = var_15_10

	var_15_10(arg_15_0.detailDescText, var_15_8)
	...
	if not var_15_5 then
		...
		var_15_13 = var_15_13(var_15_1, "#C2695B")

		local var_15_14 = " / "

		setColorStr = var_17

		var_15_10(var_15_12, var_15_13 .. var_15_14 .. var_17(var_15_2, "#9D6B59"))
	else
		setText = var_15_10

		var_15_10(arg_15_0.detaiProgressText, "--/--")
	end
	...
	var_15_10(var_15_15, var_15_13(var_15_3.name, 11))

	setActive = var_15_10

	var_15_10(arg_15_0.detailBtnDetail, var_15_11 == 1006 and not var_15_4 and not var_15_5)

	setActive = var_15_10

	var_15_10(arg_15_0.detailBtnGo, not var_15_5 and not var_15_4 and var_15_11 ~= 1006)

	setActive = var_15_10

	var_15_10(arg_15_0.detailBtnGet, not var_15_5 and var_15_4 and not var_15_7)

	setActive = var_15_10

	var_15_10(arg_15_0.detailBtnSubmit, not var_15_5 and var_15_4 and var_15_7)

	setActive = var_15_10

	var_15_10(arg_15_0.detailActive, not var_15_5 and not var_15_4 and not var_15_6)

	setImageSprite = var_15_10
	...
	var_15_10(var_15_16, var_15(var_16.icon_atlas, var_15_9))
	...
	if #arg_15_0.iconTfs < #arg_15_0.awards then
		...
		for iter_15_0 = 1, var_15_17 do
			...
			var_1_10018 = var_1_10018(var_1_10019(arg_15_0.IconTpl))
			setParent = var_1_10019

			var_1_10019(var_1_10018, arg_15_0.detailAwardContent)
			...
			var_1_10019.insert(arg_15_0.iconTfs, var_1_10018)
		end
	end
	...
	for iter_15_1 = 1, #arg_15_0.iconTfs do
		...
		if iter_15_1 <= #arg_15_0.awards then
			var_15_18 = arg_15_0.awards[iter_15_1]
			...
			var_19(arg_15_0.iconTfs[iter_15_1], var_15_19)

			onButton = var_19

			local var_15_20 = arg_15_0._event
			local var_15_21 = arg_15_0.iconTfs[iter_15_1]
			...
			local function var_15_22()
				...
				var_16_1(var_16_0, var_2_10002.ON_DROP, var_15_19)
			...
			var_19(var_15_20, var_15_21, var_15_22, var_1_10023)
			...
			var_15_18(arg_15_0.iconTfs[iter_15_1], false)
		end
	end
