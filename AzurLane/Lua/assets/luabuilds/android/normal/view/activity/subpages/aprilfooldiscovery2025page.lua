...
function var_0_1.OnInit(arg_1_0)
	...
	for iter_1_0 = 1, #var_0_2 do
		...
		var_1_11(var_1_10, var_1_12, var_1_10009, var_10.Find(var_1_13, "Character"))
	end
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_4()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.SuperBulin2_help.tip
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10005(arg_9_0.items) do
		...
		var_12(arg_9_0, iter_9_1, function()
			...
			elseif var_1_10011 == 1 then
				...
				if var_0.GetServerTime(var_10_1) < arg_9_0.activity.data2 then
					...
					var_10_3(var_10_2, var_2_10002("bulin_tip_other2"))
				...
				i18n = var_2_10003
				var_10_6.content = var_2_10003("bulin_tip_other1")
				...
				function var_10_6.onYes()
					...
					var_11_1(var_11_0, var_3_10002.PUZZLE_PIECE_OP, {
						cmd = 3,
		...
		var_12(iter_9_1:Find("Character"), var_1_10011 == 3)

		setActive = var_12

		var_12(iter_9_1:Find("Unlock"), var_1_10011 == 2)

		setActive = var_12

		var_12(iter_9_1:Find("Locked"), var_1_10011 == 1)
	end
...
function var_0_1.UpdateSelection(arg_13_0)
	...
	if var_13_1 then
		...
		if not var_1_10005("SuperBulin2_tip" .. arg_13_0.selectIndex) then
			var_13_3 = ""
		end

		var_3(var_13_2, var_13_3)
