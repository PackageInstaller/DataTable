...
local function var_0_2(arg_1_0)
	...
	var_5.make(var_1_5, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_3 = var_3_1(var_3_2:getConfig("name"))

			setText = var_6

			var_6(arg_3_2:Find("title/Text"), "PHASE " .. var_1_1(var_3_0))

			setText = var_6

			var_6(arg_3_2:Find("target/title"), var_3_2:getConfig("name"))

			setText = var_6

			var_6(arg_3_2:Find("target/Text"), "")
			...
			local var_3_7 = arg_3_2:Find("award")
			...
			local function var_3_8()
				...
				var_4_1(var_4_0, var_3_10002.ON_DROP, var_3_5)
			...
			var_8(var_3_6, var_3_7, var_3_8, var_12)

			local var_3_9

			if var_1_3 then
				var_3_9 = var_3_0 < var_1_3
			end

			setActive = var_3_6

			local var_3_10 = arg_3_2:Find("award/mask")
			local var_3_11
