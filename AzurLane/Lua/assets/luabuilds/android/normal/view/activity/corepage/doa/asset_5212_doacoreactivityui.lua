...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.MoscowUR.MoscowURCoreActivityUI"))
...
function var_0_1.OnAnimations(arg_6_0, arg_6_1, arg_6_2)
	...
	var_1_10003(var_4.Find(var_6_0, "adapt/logo2"), arg_6_2.id == 16 or arg_6_2.id == 12)

	SetActive = var_1_10003

	local var_6_1 = arg_6_0._tf

	var_1_10003(var_4.Find(var_6_1, "adapt/logo"), arg_6_2.id ~= 16 and arg_6_2.id ~= 12)

	SetActive = var_1_10003

	local var_6_2 = arg_6_0._tf

	var_1_10003(var_4.Find(var_6_2, "left_bg"), arg_6_2.id == 9)

	SetActive = var_1_10003

	local var_6_3 = arg_6_0._tf

	var_1_10003(var_4.Find(var_6_3, "decorate"), arg_6_2.id == 9)
