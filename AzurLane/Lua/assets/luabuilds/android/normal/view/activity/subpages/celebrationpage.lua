...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_3()
		...
		HolidayVillaShopMediator = var_2_10002
		var_4_1.mediator = var_2_10002
		HolidayVillaShopLayer = var_2_10002
		...
		var_4_4(var_4_3, var_2_10003.OPEN_LAYER, var_4_2)
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	for iter_6_0 = 1, var_6_4 do
		...
		var_6_5(var_6_6:Find("icon"), iter_6_0 <= var_6_1)

		setActive = var_6_5

		var_6_5(var_6_6:Find("mark"), var_6_1 < iter_6_0)
	end
	...
	var_4(var_5.Find(var_6_7, "get"), var_6_3 == 0 and var_6_1 >= 7)

	setActive = var_4

	local var_6_8 = arg_6_0.rtBtns

	var_4(var_5.Find(var_6_8, "got"), var_6_3 > 0)

	setActive = var_4

	local var_6_9 = arg_6_0.rtBtns

	var_4(var_5.Find(var_6_9, "go"), var_6_1 < 7)

	setActive = var_4

	local var_6_10 = arg_6_0.rtBtns

	var_4(var_5.Find(var_6_10, "red"), var_6_3 == 0 and var_6_1 >= 7 and var_6_3 ~= 1)
