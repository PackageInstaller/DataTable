...
function var_0_0.SetUI(arg_2_0, arg_2_1)
	...
	typeof = var_4
	Slider = var_1_10005
	arg_2_0.hpTF = var_2_4(var_2_3, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_2_0.attackCntTF = var_2_7(var_2_6, var_4(var_1_10005))
...
function var_0_0.StartCurtainUp(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_0(var_4_1, var_4.white, var_0_1)
	local var_4_3 = var_2.setFromColor

	Color = var_4

	local var_4_4 = var_4_3(var_4_2, var_4.black)
	local var_4_5 = var_2.setOnComplete

	System = var_4

	var_4_5(var_4_4, var_4.Action(function()
		...
		var_5_1(var_5_0, var_2.Action(function()
			...
			var_6_3(var_6_2, var_2.Action(arg_4_1))
...
function var_0_0.OnInited(arg_7_0)
	local function var_7_0()
		if arg_7_0.attackCnt <= 0 then
			...
			var_8_1(var_8_0, var_2_10002("activity_hit_monster_nocount"))
		...
		if arg_7_0.hp <= 0 then
			...
			i18n = var_2_10003
			var_8_4.content = var_2_10003("activity_hit_monster_reset_tip")
	...
	arg_7_0:OnTrigger(arg_7_0.ABtn, var_7_0, function()
		...
		BeatMonsterNianConst = var_2_10002

		var_10_1(var_10_0, var_2_10002.ACTION_NAME_A)
	...
	arg_7_0:OnTrigger(arg_7_0.BBtn, var_7_0, function()
		...
		var_11_1(var_11_0, var_2_10002.ACTION_NAME_B)
	...
	arg_7_0:OnJoyStickTrigger(arg_7_0.joyStick, var_7_0, function(arg_12_0)
		if arg_12_0 > 0 then
			...
			var_12_1(var_12_0, var_2_10003.ACTION_NAME_R)
		elseif arg_12_0 < 0 then
			...
			var_12_3(var_12_2, var_2_10003.ACTION_NAME_L)
		end
...
function var_0_0.OnUIHpUpdate(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local var_15_4 = var_15_3(var_15_2, var_8.Action_float(function(arg_16_0)
	...
	var_15_5(var_15_4, var_8.Action(function()
		if arg_15_3 then
			arg_15_3()
		end
...
function var_0_0.OnAddFuShun(arg_18_0, arg_18_1)
	...
	arg_18_0.fuShun = var_18_1(var_18_0, var_1_10004(var_1_10005))
...
function var_0_0.OnAddMonsterNian(arg_19_0, arg_19_1, arg_19_2)
	...
	arg_19_0.nian = var_19_1(var_19_0, var_1_10005(var_1_10006))
...
function var_0_0.BanJoyStick(arg_22_0, arg_22_1)
	...
	var_1_10002(var_3.Find(var_22_0, "ban"), arg_22_1)
	...
	var_1_10002(var_22_1, var_4(var_5)).enabled = not arg_22_1
...
function var_0_0.OnInputChange(arg_23_0, arg_23_1)
	if arg_23_1 and arg_23_1 ~= "" then
		...
		for iter_23_0, iter_23_1 in var_1_10003(arg_23_0.actionKeys) do
			...
			local var_23_1 = iter_23_1.Find(var_23_0, "A")

			BeatMonsterNianConst = var_23_0

			var_9(var_23_1, var_1_10008 == var_23_0.ACTION_NAME_A)

			setActive = var_9

			local var_23_2 = iter_23_1
			local var_23_3 = iter_23_1.Find(var_23_2, "L")

			BeatMonsterNianConst = var_23_2

			var_9(var_23_3, var_1_10008 == var_23_2.ACTION_NAME_L)

			setActive = var_9

			local var_23_4 = iter_23_1
			local var_23_5 = iter_23_1.Find(var_23_4, "R")

			BeatMonsterNianConst = var_23_4

			var_9(var_23_5, var_1_10008 == var_23_4.ACTION_NAME_R)

			setActive = var_9

			local var_23_6 = iter_23_1
			local var_23_7 = iter_23_1.Find(var_23_6, "B")

			BeatMonsterNianConst = var_23_6

			var_9(var_23_7, var_1_10008 == var_23_6.ACTION_NAME_B)
		end
	end
...
function var_0_0.DisplayAwards(arg_25_0, arg_25_1, arg_25_2)
	...
	var_25_1(var_25_0, var_1_10005.ACTIVITY_SHOW_AWARDS, {
		awards = arg_25_1,
		callback = arg_25_2
	})
...
function var_0_0.OnTrigger(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	local var_27_3 = var_6(var_27_2, var_1_10008(var_1_10009))

	var_6.AddPointDownFunc(var_27_3, function(arg_28_0, arg_28_1)
		var_27_1 = arg_27_2()

		if var_27_1 then
			setActive = var_2

			var_2(var_27_0, false)
		end
...
function var_0_0.OnJoyStickTrigger(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	local var_30_3 = arg_30_1.Find(var_30_2, "r")

	GetOrAddComponent = var_30_2
	...
	local var_30_5 = var_30_2(var_30_4, var_1_10009(var_1_10010))
	local var_30_6
