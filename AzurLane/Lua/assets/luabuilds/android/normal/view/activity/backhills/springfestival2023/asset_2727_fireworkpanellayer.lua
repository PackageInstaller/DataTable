...
local var_0_0 = "FireworkPanelLayer"
...
function var_0_1.getLocalData(arg_4_0)
	...
	for iter_4_0 = 1, #arg_4_0.allIds do
		...
		if var_1_10006.GetInt("fireworks_" .. arg_4_0.playerId .. "_pos_" .. iter_4_0) ~= 0 then
			table = var_7
...
function var_0_1.setLocalData(arg_5_0)
	for iter_5_0 = 1, #arg_5_0.allIds do
		...
		var_1_10006.SetInt("fireworks_" .. arg_5_0.playerId .. "_pos_" .. iter_5_0, var_5_0)
	end
...
function var_0_1.didEnter(arg_6_0)
	...
	var_1_10001(arg_6_0, arg_6_0.fireBtn, function()
		if #arg_6_0.orderIds > 0 then
			...
			FireworkPanelMediator = var_2_10002

			var_9_1(var_9_0, var_2_10002.LET_OFF_FIREWORKS, arg_6_0.orderIds)
		end
