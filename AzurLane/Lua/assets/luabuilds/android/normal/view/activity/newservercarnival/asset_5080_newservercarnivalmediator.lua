...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.SUBMIT_TASK_DONE then
		...
		var_9_4(var_9_3, var_1_10006.ON_ACHIEVE, var_9_2, function()
		...
		if var_9_0 == var_9_4.UPDATED then
			...
			if var_9_0 == var_4.SHOPPING_DONE then
				if #var_9_2.awards > 0 then
					...
					var_9_7(var_9_6, var_1_10006.ON_ACHIEVE, var_9_2.awards)
				end
				...
				if var_9_0 == var_9_7.NEW_SERVER_SHOP_SHOPPING_DONE then
					if #var_9_2.awards > 0 then
						...
						var_9_10(var_9_9, var_1_10006.ON_ACHIEVE, var_9_2.awards)
					end
