...
function var_0_1.InitButton(arg_5_0)
	for iter_5_0 = 1, arg_5_0.attrGroup.childCount do
		...
		local var_5_2 = var_7.GetChild(var_5_1, iter_5_0 - 1)
		...
		local function var_5_3()
			...
			var_6_0(var_1.GetChild(var_6_1, iter_5_0 - 1), true)
			...
			var_2(var_6_4, var_2_10004("senran_pt_consume_tip", var_6_3, var_6_2))
		...
		var_1_10005(var_5_0, var_5_2, var_5_3, var_9)
	end
	...
	local function var_5_6()
		...
		if arg_5_0.ptCount < var_8_2 then
			...
			var_8_4(var_8_3, var_2_10005("senran_pt_not_enough"))
		else
			local var_8_5 = arg_5_0
			local var_8_6 = var_3.emit

			SenrankaguraTrainMediator = var_2_10005

			var_8_6(var_8_5, var_2_10005.LEVEL_UP, {
				cmd = 2,
				id = var_0_1.ACT_ID,
				arg1 = var_8_0,
				cost = var_8_2,
	...
	var_1(var_5_10, var_5_11, var_5_12, var_1_10005)
	...
	var_1(var_5_13, var_5_14, var_5_15, var_1_10005)
	...
	var_1(var_5_16, var_5_17, var_5_18, var_1_10005)
	...
	var_1(var_5_22, var_5_23, var_5_24, var_5)
	...
	var_1(var_5_25, var_5_26, var_5_27, var_5)
	...
	for iter_5_1 = 1, arg_5_0.tachie.childCount do
		...
		var_5_28(var_5_30, var_5_31, var_5_32, var_1_10010)

		setActive = var_5_28

		var_5_28(var_5_29, false)

		PLATFORM_CODE = var_5_28
		PLATFORM_CH = var_7

		if var_5_28 ~= var_7 then
			findTF = var_5_28

			if var_5_28(var_5_29, "Image") then
				setActive = var_7
...
function var_0_1.didEnter(arg_18_0)
	...
	var_2(var_3.GetChild(var_18_2, var_18_1 - 1), true)

	pg = var_2
	arg_18_0.wordsGroup = var_2.gametip[arg_18_0.wordsKey[var_18_1]].tip
	...
	for iter_18_0 = 1, #arg_18_0.standAnim do
		...
		var_1_10007.insert(var_18_3, iter_18_0)
	end
	...
	for iter_18_1 = 1, arg_18_0.scroll.childCount do
		...
		local var_18_4 = var_1_10007.GetInstance()

		var_1_10007.GetSpineChar(var_18_4, arg_18_0.standAnim[var_18_3[iter_18_1]], false, function(arg_20_0)
			...
			var_20_2(var_20_1, var_3.GetChild(var_20_3, iter_18_1 - 1), false)
			...
			local var_20_6 = var_20_5(var_20_4, var_3(var_4))
...
function var_0_1.UpdateTask(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_1 = arg_22_2.Find(var_22_0, "IconTpl")

	setText = var_22_0
	findTF = var_5

	var_22_0(var_5(arg_22_2, "title"), "PHASE" .. arg_22_1)

	local var_22_2 = arg_22_0.rewardList[arg_22_1]
	local var_22_3 = {
		type = var_22_2[1],
		id = var_22_2[2],
		count = var_22_2[3]
	...
	local function var_22_6()
		...
		var_23_1(var_23_0, var_2_10002.ON_DROP, var_22_3)
	...
	var_6(var_22_4, var_22_5, var_22_6, var_1_10010)

	setText = var_6

	local var_22_7 = arg_22_2
	local var_22_8 = arg_22_2.Find(var_22_7, "progress")

	i18n = var_22_7

	var_6(var_22_8, var_22_7("senran_pt_rank", arg_22_1))

	table = var_6

	local var_22_9 = var_6.contains(arg_22_0.awardGotList, arg_22_1)

	setActive = var_7

	var_7(arg_22_2:Find("mask"), var_22_9)
...
function var_0_1.ShowDialog(arg_24_0, arg_24_1, arg_24_2)
	...
	var_1_10005(var_1_10006(arg_24_0.dialog, "Text"), var_24_1)
	...
	local var_24_4 = var_7.scale
	local var_24_5 = arg_24_0.dialog

	Vector3 = var_1_10009

	local var_24_6 = var_24_4(var_24_5, var_1_10009.New(1, 1, 1), var_0_1.DIALOG_TIME)
	local var_24_7 = var_7.setEase

	LeanTweenType = var_9

	var_24_2(var_24_3, var_24_7(var_24_6, var_9.easeOutSine).uniqueId)
	...
	var_5.PlaySoundEffect_V3(var_24_8, var_24_0, function(arg_25_0)
		...
		local var_25_3 = var_2_10004.delayedCall

		go = var_2_10005

		local var_25_4 = var_2_10005(arg_24_0.dialog)
		local var_25_5 = var_25_0

		System = var_2_10007

		var_25_1(var_25_2, var_25_3(var_25_4, var_25_5, var_2_10007.Action(function()
...
function var_0_1.HideDialog(arg_27_0)
	...
	local var_27_2 = var_1_10003.scale
	local var_27_3 = arg_27_0.dialog

	Vector3 = var_1_10005

	local var_27_4 = var_27_2(var_27_3, var_1_10005.New(0, 0, 0), var_0_1.DIALOG_TIME)
	local var_27_5 = var_3.setEase

	LeanTweenType = var_5

	local var_27_6 = var_27_5(var_27_4, var_5.easeOutSine)
	local var_27_7 = var_3.setOnComplete

	System = var_5

	var_27_0(var_27_1, var_27_7(var_27_6, var_5.Action(function()
...
function var_0_1.GetAward(arg_31_0, arg_31_1)
	...
	var_31_1(var_31_0, var_1_10004.ON_ACHIEVE, arg_31_1, function()
...
function var_0_1.UpdateFlush(arg_34_0)
	...
	;(function(arg_35_0, arg_35_1)
		for iter_35_0 = 1, arg_35_0.childCount do
			...
			local var_35_2 = arg_34_0.attrLevel[iter_35_0]

			setActive = var_8

			var_8(var_35_1:GetChild(var_35_2), true)

			if arg_35_1 and var_35_2 < 2 and arg_34_0.ptDemand[iter_35_0][var_35_2 + 1] <= arg_34_0.ptCount then
				setActive = var_8
				findTF = var_9

				var_8(var_9(var_35_1, "red"), true)
			end
		end
...
function var_0_1.SetAnim(arg_37_0, arg_37_1, arg_37_2, arg_37_3)
	...
	local var_37_2 = var_37_1(var_37_0, var_1_10006(var_1_10007))
...
function var_0_1.IsShowRed()
	...
	local var_40_2 = var_2.activity_event_pt_consume[1].target
