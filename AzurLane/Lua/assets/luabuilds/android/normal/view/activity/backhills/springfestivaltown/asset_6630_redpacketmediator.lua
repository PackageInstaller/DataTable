...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_0 == var_3_1.ACTIVITY_SHOW_RED_PACKET_AWARDS then
		local var_3_3 = arg_3_0.viewComponent

		var_3_4 = var_3_4.emit
		BaseUI = var_1_10006

		var_3_4(var_3_3, var_1_10006.ON_ACHIEVE, var_3_2.awards, var_3_2.callback)
	else
		ActivityProxy = var_3_4

		if var_3_0 == var_3_4.ACTIVITY_UPDATED and var_3_2.id == arg_3_0.viewComponent.activityID then
