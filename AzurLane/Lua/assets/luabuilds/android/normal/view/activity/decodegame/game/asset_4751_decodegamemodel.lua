...
function var_0_0.SetData(arg_1_0, arg_1_1)
	...
	if arg_1_0.isFinished then
		...
		arg_1_0.BuildMapIndexs(var_1_10003)
	else
		local var_1_0 = 1
...
function var_0_0.BuildMapIndexs(arg_2_0)
	...
	local function var_2_1(arg_3_0)
		...
		for iter_3_0, iter_3_1 in var_2_10001(var_2_10002.MAPS_PASSWORD) do
			_ = var_2_10006
	...
	for iter_2_0 = 1, #var_2_0 do
		...
		DecodeGameConst = var_9

		local var_2_4 = var_9.Vect2Index(var_2_2[1], var_2_2[2])
		local var_2_5 = var_2_3 - 1

		DecodeGameConst = var_10

		local var_2_6 = var_10.MAP_ROW

		DecodeGameConst = var_11

		local var_2_7 = var_2_4 + var_2_5 * (var_2_6 * var_11.MAP_COLUMN)

		table = var_9

		var_9.insert(arg_2_0.mapIndexs, var_2_7)
	end
...
function var_0_0.InitMap(arg_5_0, arg_5_1)
	...
	for iter_5_0 = var_5_5, var_1_10007.MAP_ROW do
		...
		for iter_5_1 = var_5_6, var_1_10011.MAP_COLUMN do
			...
			var_15.insert(var_5_1, var_1_10014)
		end
	end
...
function var_0_0.IsUnlockMap(arg_14_0, arg_14_1)
	...
	return var_14_3(var_1_10006.range(var_3, var_14_2), function(arg_15_0)
		table = var_2_10001
...
function var_0_0.CheckIndex(arg_17_0, arg_17_1)
	...
	local var_17_2 = arg_17_0.GetCurrMapKeyIndex(var_17_1, arg_17_1)

	math = var_17_1

	local var_17_3 = (var_17_1.ceil(var_17_2 / var_17_0) - 1) * var_17_0 + 1 + (var_17_0 - 1)

	if var_17_2 == var_4 then
		return true
	end

	if var_4 < var_17_2 then
		local var_17_4 = var_17_2 - 1
...
function var_0_0.GetCurrMapKeyIndex(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in var_1_10006(var_1_10007.PASSWORD) do
...
function var_0_0.GetPassWordProgress(arg_30_0)
	...
	for iter_30_0 = var_30_3, var_30_4, var_1_10006.MAX_MAP_COUNT do
		...
		if var_1_10008(var_1_10009.slice(arg_30_0.mapIndexs, iter_30_0, 3), function(arg_31_0)
