...
local var_0_0 = "ANTTFFScenarioPage"
...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_1, var_2_0("ANTTFFCoreActivityPtpage_title"))
	...
	var_1(var_2_3, var_2_2("ANTTFFCoreActivityPtpage_title2"))
...
function var_0_1.Show(arg_4_0)
	...
	local var_4_0 = arg_4_0._parentTf

	var_1_10001(var_2.Find(var_4_0, "AD/headline/VX_logo"), false)
...
function var_0_1.Hide(arg_5_0)
	...
	local var_5_0 = arg_5_0._parentTf

	var_1_10001(var_2.Find(var_5_0, "AD/headline/VX_logo"), true)
