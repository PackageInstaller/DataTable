...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1.make(var_3_0, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_3 = arg_4_2.Find(var_4_2, "Current")

			setActive = var_4_2

			var_4_2(var_4_3, arg_4_1 == arg_3_0.playedCount)
			...
			if arg_4_1 <= arg_3_0.curDay then
				...
				var_6(var_4_1, arg_4_1 <= arg_3_0.playedCount and arg_4_1 ~= arg_3_0.needCount)
			else
				setActive = var_6
	...
	local function var_3_4()
		...
		var_5_1(var_5_0, var_2_10002.GO_MINI_GAME, 33)
...
function var_0_1.tryGetFinalAward(arg_8_0)
	...
	if var_8_4 <= var_8_3 and not var_8_6 then
		...
		local var_8_9 = var_1_10008.SEND_MINI_GAME_OP
		local var_8_10 = {
			hubid = var_2.id
		}

		MiniGameOPCommand = var_10
		var_8_10.cmd = var_10.CMD_ULTIMATE
		var_8_10.args1 = {}
