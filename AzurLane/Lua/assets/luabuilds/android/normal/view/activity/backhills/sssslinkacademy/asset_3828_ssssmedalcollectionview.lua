...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..TemplateMV.MedalCollectionTemplateView"))
local var_0_2 = {
	"qvzhu",
	"qingxvn",
	"zhongxvn",
...
function var_0_1.AddListener(arg_5_0)
	...
	local function var_5_5()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.ssss_medal_tip.tip
	...
	local function var_5_8()
		...
		if not var_2.contains(arg_5_0.activeIDList, var_8_1) then
			table = var_3
			var_8_2 = var_3.contains(arg_5_0.activatableIDList, var_8_1)
		else
			var_8_2 = false
		end
		...
		if var_8_2 then
			...
			var_8_4(var_8_3, var_2_10006.MEMORYBOOK_UNLOCK, {
				id = var_8_1,
	...
	local function var_5_11()
		...
		if not var_2.contains(arg_5_0.activeIDList, var_9_1) then
			table = var_3
			var_9_2 = var_3.contains(arg_5_0.activatableIDList, var_9_1)
		else
			var_9_2 = false
		end
		...
		if var_9_2 then
			...
			var_9_4(var_9_3, var_2_10006.MEMORYBOOK_UNLOCK, {
				id = var_9_1,
				actId = arg_5_0.activityData.id
			})
		end
	...
	for iter_5_0 = 1, 6 do
		...
		local var_5_14 = var_7.Find(var_5_13, "Desk/Slot" .. iter_5_0 .. "/Click")
		...
		var_1_10005(var_5_12, var_5_14, var_5_15, var_9)
	end
...
function var_0_1.UpdateAfterSubmit(arg_11_0, arg_11_1)
	...
	local var_11_1 = var_3.floor((var_11_0 + 1) / 2)
	...
	var_3(var_11_3, var_5(var_1_10006), false)
	arg_11_0:UpdateView()
...
function var_0_1.UpdateView(arg_13_0)
	for iter_13_0 = 1, 6 do
		...
		var_1_10008(var_13_4, var_10(var_11), false)
		...
		if not var_13_1 then
			...
			var_1_10008(var_13_5, var_10(1, 1, 1))
		end
	...
	var_2(var_3.Find(var_13_9, "Lock"), not var_13_8)

	setActive = var_2

	local var_13_10 = arg_13_0.medalTF

	var_2(var_3.Find(var_13_10, "Unlock"), var_13_8)
	arg_13_0:UpdateInfo()
	...
	var_2(var_13_11, var_4("ssssmedal_tip", #arg_13_0.activeIDList))
...
function var_0_1.UpdateInfo(arg_15_0)
	...
	;(function()
		...
		if not var_1.contains(arg_15_0.activeIDList, var_16_0) then
			table = var_2
			var_16_1 = var_2.contains(arg_15_0.activatableIDList, var_16_0)
		else
			var_16_1 = false
		end
		...
		if var_1 then
			...
			local var_16_6 = var_16_4("ssssmedal_name")

			i18n = var_8

			var_2_10005(var_16_5, var_16_6 .. var_8("ssssmedal_name" .. var_15_0))
			...
			local var_16_8 = var_16_7 .. var_6("ssssmedal_belonging" .. (var_15_0 == 6 and 2 or 1))

			setText = var_6

			var_6(var_16_3:Find("Unlock/TextDetail"), var_16_8)

			local var_16_9 = arg_15_0.loader

			var_6.GetSpriteQuiet(var_16_9, "ui/SSSSMedalCollectionUI_atlas", "icon_" .. var_0_2[var_15_0], arg_15_0.infoIcon)
		elseif var_16_2 then
			...
			var_16_10(var_16_3:Find("Lock/BG/TextTip"), var_16_11[2 * var_15_0 - 1])
		end
	...
	;(function()
		...
		if not var_1.contains(arg_15_0.activeIDList, var_17_0) then
			table = var_2
			var_17_1 = var_2.contains(arg_15_0.activatableIDList, var_17_0)
		else
			var_17_1 = false
		end
		...
		if var_1 then
			...
			local var_17_5 = var_17_3.Find(var_17_4, "Unlock")

			i18n = var_17_4

			var_2_10005(var_17_5, var_17_4("ssssmedal_desc" .. var_15_0))
		elseif var_17_2 then
			local var_17_6 = arg_15_0.activityData
			local var_17_7 = var_5.getConfig(var_17_6, "config_client").unlock_desc

			setText = var_17_6

			var_17_6(var_17_3:Find("Lock"), var_17_7[2 * var_15_0])
		end
