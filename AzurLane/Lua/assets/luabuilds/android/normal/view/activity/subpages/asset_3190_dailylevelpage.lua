...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_4 = var_2.Find(var_1_3, "bg/titleText")

	i18n = var_1_3

	var_1(var_1_4, var_1_3("open_today"))

	setText = var_1

	local var_1_5 = arg_1_0._tf
	local var_1_6 = var_2.Find(var_1_5, "bg/goBtn/Text")

	i18n = var_1_5

	var_1(var_1_6, var_1_5("daily_level_go"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1_10001(arg_2_0, arg_2_0.goBtn, function()
		...
		var_3_1(var_3_0, var_3_2, var_2_10003.DAILYLEVEL)
	...
	var_1.make(var_2_0, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			var_4(var_4_2, var_4_1.expedition_daily_template[var_4_0].title)
		end
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10003(var_5_0) do
		...
		if var_1_10008.limit_type == 1 then
			...
			local var_5_5 = var_1_10013.TimeMgr.GetInstance()

			if var_5_3(var_5_4, var_1_10012(var_1_10013.GetServerWeek(var_5_5))) then
				if var_5_2 then
					type = var_10
