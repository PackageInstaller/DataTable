...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.activity = var_3_2(var_3_1, var_1_10003.ACTIVITY_TYPE_NEWSERVER_GIFT)
...
function var_0_1.initUI(arg_4_0)
	...
	arg_4_0.giftItemList = var_4_4(var_4_5, var_3.Find(var_4_6, "gift_tpl"))
...
function var_0_1.confirm(arg_9_0, arg_9_1)
	...
	local var_9_2 = arg_9_1.getConfig(var_9_1, "effect_args")

	Item = var_9_1

	local var_9_3 = var_9_1.getConfigData(var_9_2[1]).display_icon

	type = var_1_10006

	if var_1_10006(var_9_3) == "table" then
		ipairs = var_6

		for iter_9_0, iter_9_1 in var_6(var_9_3) do
			table = var_1_10011
			...
			var_1_10011(var_9_4, var_1_10013.Create(iter_9_1))
		end
	end
	...
	i18n = var_7
	var_9_5.tipExtra = var_7("charge_title_getitem")
	var_9_5.extraItems = var_9_0
	var_9_5.price = arg_9_1:getConfig("resource_num")
	var_9_5.tagType = arg_9_1:getConfig("tag")
	...
	function var_9_5.onYes()
		...
		var_10_2.content = var_2_10003(var_10_3, var_5.getConfig(var_10_4, "resource_num"), var_0.name)

		function var_10_2.onYes()
			local var_11_0 = arg_9_0
			local var_11_1 = var_0.emit

			NewServerCarnivalMediator = var_3_10002

			var_11_1(var_11_0, var_3_10002.GIFT_BUY_ITEM, arg_9_1.id, 1)
	...
	NewServerCarnivalMediator = var_9

	var_9_7(var_9_6, var_9.GIFT_OPEN_ITEM_PANEL, var_9_5)
...
function var_0_1.updateGiftGoodsVOList(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_14_0(arg_14_0.goodIdList) do
		Goods = var_1_10007
		...
		Goods = var_1_10009
		var_1_10007 = var_1_10007(var_1_10008, var_1_10009.TYPE_NEW_SERVER)
		table = var_1_10008
	...
	for iter_14_2, iter_14_3 in var_3(arg_14_0.giftGoodsVOList) do
		...
		if iter_14_3:canPurchase() then
			...
			var_9.insert(var_14_2, iter_14_3)
		end
	end
...
function var_0_1.isTip(arg_15_0)
	if not arg_15_0.playerId then
		...
		local var_15_0 = var_1(var_1_10002)
