...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("auction_main_done"))
	...
	var_1_10001(var_2_1, var_3("auction_main_doing"))
	...
	var_1_10001(var_2_2, var_3.format("main_emoji_open"), function(arg_3_0)
		IsNil = var_2_10001
	...
	var_1_10001(arg_2_0, arg_2_0.uiEmojiBtn, function()
		...
		AuctionGameMainEmojiLayer = var_2_10005
		var_4_4.viewComponent = var_2_10005
		AuctionGameMainEmojiMediator = var_2_10005
...
function var_0_1.didEnter(arg_5_0, arg_5_1)
	...
	AttireConst = var_1_10006

	local var_5_6 = var_5_3(var_5_4, var_5_5, var_1_10006.TYPE_ICON_FRAME, arg_5_1.propose)

	PoolMgr = var_5_4

	local var_5_7 = var_5_4.GetInstance()
	...
	var_4.GetPrefab(var_5_7, "IconFrame/" .. var_5_6, var_5_6, true, function(arg_7_0)
		...
		if arg_5_0.uiFrameGo then
			...
			var_3(var_7_2, var_2_10005(arg_5_0.uiFrameGo), false)
		else
			PoolMgr = var_1
	...
	local var_5_10 = var_7(var_8)

	var_4(var_5_8, var_5_9 == var_7.getPlayerId(var_5_10))
	arg_5_0:RefreshUI()
...
function var_0_1.RefreshUI(arg_8_0)
	...
	if not var_1_10005.keyof(var_8_0:GetLeaverList(), var_8_1.id) then
		table = var_8_4
		...
		if var_8_4.keyof(var_8_0:GetForfeitList(), var_8_1.id) then
			...
			if var_8_4 == var_8_3.AUCTION_PHASE.PERSONAL_EVENT then
				if var_8_2 ~= 1 and var_8_2 ~= 2 then
					var_8_4 = false
			...
			var_8_3(arg_8_0.uiCompleteGo, var_8_4)

			setActive = var_8_3

			var_8_3(arg_8_0.uiOperateGo, not var_8_4)
...
function var_0_1.RefreshEmojiBtn(arg_9_0)
	...
	local var_9_3 = var_1_10004(var_1_10005)
...
function var_0_1.ShowEmoji(arg_11_0, arg_11_1, arg_11_2)
	...
	arg_11_0.ReturnEmoji(var_11_0)

	arg_11_0.emojiID = arg_11_2
	pg = var_3

	local var_11_1 = var_3.emoji_template[arg_11_2]

	PoolMgr = var_11_0

	local var_11_2 = var_11_0.GetInstance()

	var_4.GetPrefab(var_11_2, "emoji/" .. var_11_1.pic, var_11_1.pic, true, function(arg_12_0)
		IsNil = var_2_10001

		local var_12_1

		if not var_2_10001(arg_11_0.uiEmojiTf) then
			arg_12_0.name = var_11_1.pic
			...
			if var_12_1(var_12_0, var_2_10003(var_2_10004)) then
				var_12_1.preserveAspect = true
			end

			tf = var_12_0

			local var_12_2 = var_12_0(arg_12_0)

			Vector2 = var_3
			var_12_2.anchoredPosition = var_3.zero
			rtf = var_12_2
			...
			var_1.ReturnPrefab(var_12_4, "emoji/" .. var_11_1.pic, var_11_1.pic, arg_12_0)
		end
...
function var_0_1.AddEmojiTimer(arg_14_0)
	...
	local var_14_2 = var_14_1 + var_14_0.gameset.auction_emoji_duration.key_value
...
function var_0_1.willExit(arg_17_0)
	...
	if not var_1(arg_17_0.uiFrameGo) then
		...
		if var_1(arg_17_0.uiFrameGo).childCount > 0 then
			local var_17_0 = var_1:GetChild(0).gameObject.name

			PoolMgr = var_4

			local var_17_1 = var_4.GetInstance()

			var_4.ReturnPrefab(var_17_1, "IconFrame/" .. var_17_0, var_17_0, var_2.gameObject)
		end
	end
