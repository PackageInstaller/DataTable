...
function var_0_1.commitEdit(arg_7_0)
	...
	BossSingleMediatorTemplate = var_1_10003

	var_7_1(var_7_0, var_1_10003.ON_COMMIT_FLEET)
...
function var_0_1.commitCombat(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10003.ON_PRECOMBAT, arg_8_0.contextData.editFleet)
...
function var_0_1.openShipInfo(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_2 = var_1_10005(var_1_10006)
	...
	BossSingleMediatorTemplate = var_8

	var_11_5(var_11_4, var_8.ON_FLEET_SHIPINFO, {
		shipId = arg_11_1,
		shipVOs = var_11_1
	})
...
function var_0_1.openCommanderPanel(arg_13_0, arg_13_1, arg_13_2)
	...
	var_4.setCallback(var_13_1, function(arg_14_0)
		...
		if var_14_0 == var_2_10002.COMMANDER_OP_SHOW_SKILL then
			...
			BossSingleMediatorTemplate = var_2_10003

			var_14_2(var_14_1, var_2_10003.ON_COMMANDER_SKILL, arg_14_0.skill)
		else
			local var_14_3 = arg_14_0.type

			LevelUIConst = var_14_1

			if var_14_3 == var_14_1.COMMANDER_OP_ADD then
				...
				var_14_5(var_14_4, var_2_10003.ON_SELECT_COMMANDER, arg_13_2, arg_14_0.pos)
			else
				...
				local var_14_8 = var_2_10003.COMMANDER_FORMATION_OP
				local var_14_9 = {}

				LevelUIConst = var_2_10005
				var_14_9.FleetType = var_2_10005.FLEET_TYPE_ACTIVITY
