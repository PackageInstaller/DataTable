...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.DAL.DALMainPage"))
...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_11 = var_2.Find(var_1_10, "shop")

	i18n = var_1_10

	var_1(var_1_11, var_1_10("yumia_main_tip_3"))

	setText = var_1

	local var_1_12 = arg_1_0.fight
	local var_1_13 = var_2.Find(var_1_12, "fight")

	i18n = var_1_12

	var_1(var_1_13, var_1_12("yumia_main_tip_2"))

	setText = var_1

	local var_1_14 = arg_1_0.build
	local var_1_15 = var_2.Find(var_1_14, "build")

	i18n = var_1_14

	var_1(var_1_15, var_1_14("yumia_main_tip_1"))

	setText = var_1

	local var_1_16 = arg_1_0.Manual
	local var_1_17 = var_2.Find(var_1_16, "Manual")

	i18n = var_1_16

	var_1(var_1_17, var_1_16("fengfanV3_20251023_jinianshouce"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1(arg_2_0, arg_2_0.Manual, function()
		...
		TianqiongMedalAlbumView = var_2_10002
...
function var_0_1.updateUI(arg_4_0)
	...
	local var_4_2, var_4_3 = var_4_1(var_4_0, var_1_10003.shop_template[arg_4_0.shop_id].time)
	local var_4_4
	local var_4_6
	...
	local var_4_10, var_4_11 = var_4_9(var_4_8, var_6.activity_template[arg_4_0.activity.id].time)
	local var_4_12
	local var_4_14
	...
	var_4_14(var_4_16, var_9("tolovemainpage_build_countdown"))
	...
	var_4_14(arg_4_0, arg_4_0.shop, function()
		...
		var_5_3(var_5_2, var_2_10002.GO_CHANGE_SHOP)
	...
	var_4_14(arg_4_0, arg_4_0.build, function()
		...
		local var_6_4 = var_2_10002.EVENT_GO_SCENE

		SCENE = var_2_10003

		local var_6_5 = var_2_10003.GETBOAT
		local var_6_6 = {}

		BuildShipScene = var_2_10005
		var_6_6.page = var_2_10005.PAGE_BUILD
		BuildShipScene = var_5
		var_6_6.projectName = var_5.PROJECTS.ACTIVITY
