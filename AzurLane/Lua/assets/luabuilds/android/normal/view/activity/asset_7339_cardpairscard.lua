...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6)
	...
	typeof = var_9
	Outline = var_1_10010
	arg_1_0.outline = var_7(var_1_0, var_9(var_1_10010))
...
function var_0_0.initCard(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_1_10004(arg_7_0.pics, "pic" .. arg_7_1), arg_7_0.img, false)
...
function var_0_0.aniShowBack(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	if arg_10_1 then
		...
		arg_10_0.showBack(var_1_10005)
	else
		var_1_10005 = arg_10_0

		arg_10_0.showFront(var_1_10005)
	end
	...
	local var_10_2 = var_5(arg_10_0.cardTf)

	Vector3 = var_6

	local var_10_3 = var_10_1(var_10_2, var_6(0, 1, 1), arg_10_0.ANI_TIME)
	local var_10_4 = var_4.setDelay

	defaultValue = var_6

	local var_10_5 = var_10_4(var_10_3, var_6(arg_10_3, 0))
	...
	var_10_6(var_10_5, var_6.Action(function()
		if arg_10_1 then
			var_2_10001 = arg_10_0

			var_0.showFront(var_2_10001)
		else
			var_2_10001 = arg_10_0

			var_0.showBack(var_2_10001)
		end
		...
		local var_11_1 = var_2_10001(arg_10_0.cardTf)

		Vector3 = var_2

		local var_11_2 = var_11_0(var_11_1, var_2(1, 1, 1), arg_10_0.ANI_TIME)
		local var_11_3 = var_0.setOnComplete

		System = var_2

		var_11_3(var_11_2, var_2.Action(function()
...
function var_0_0.setSpriteTo(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_2 = var_13_1(var_13_0, var_1_10006(var_1_10007))
	local var_13_3 = arg_13_1
	local var_13_4 = arg_13_1.GetComponent

	typeof = var_1_10007
	Image = var_1_10008
	var_13_2.sprite = var_13_4(var_13_3, var_1_10007(var_1_10008)).sprite
...
function var_0_0.clear(arg_14_0)
	...
	var_14_0(var_1_10002(arg_14_0.cardTf))
...
function var_0_0.destroy(arg_15_0)
	...
	var_15_0(var_2(arg_15_0.cardTf))
