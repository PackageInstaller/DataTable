...
function var_0_0.Spawn(arg_6_0)
	...
	local var_6_3 = arg_6_0.GetConfigByScore(var_6_2, arg_6_0.score)
	...
	local var_6_4 = var_6_2.Inst

	var_4.getAssetAsync(var_6_4, "ui/fa_" .. var_6_3.name, "", function(arg_7_0)
		...
		if arg_6_0.OnSpawn then
			...
			if var_6_0 ~= var_0_1 or not var_6_3.speed then
				var_7_3 = var_6_3.crazy_speed
			end
...
function var_0_0.GetConfigByScore(arg_8_0, arg_8_1)
	...
	FushunAdventureGame = var_8

	var_8.LOG("rate :", var_8_4, var_8_5, var_8_6, " r :", var_8_7)
