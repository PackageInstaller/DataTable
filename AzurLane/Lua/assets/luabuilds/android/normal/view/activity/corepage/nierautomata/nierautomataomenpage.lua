...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1(var_3_0, var_3("nier_a2_mission_detail"))
...
function var_0_1.InvalidateWriter(arg_7_0)
	...
	if arg_7_0.desc1 then
		...
		var_1(var_7_1, var_1_10003(var_1_10004)).endFunc = nil
	end
	...
	if arg_7_0.desc2 then
		...
		typeof = var_1_10003
		Typewriter = var_1_10004
		var_1(var_7_2, var_1_10003(var_1_10004)).endFunc = nil
	end
...
function var_0_1.Playwriter(arg_8_0)
	...
	if not arg_8_0.finishAll then
		...
		var_4.insert(var_8_2, function(arg_10_0)
			...
			typeof = var_2_10004
			Typewriter = var_2_10005

			local var_10_1 = var_2_10002(var_10_0, var_2_10004(var_2_10005))
			...
			var_10_3(var_10_2, var_5.GetTypewriterSpeed(var_10_4))
			var_10_1:Play()
		...
		var_4.insert(var_8_2, function(arg_12_0)
			...
			if var_12_0(var_12_1, {
				...
				local var_12_2 = var_3.NewStoryMgr.GetInstance()
	...
	var_4.insert(var_8_2, function(arg_14_0)
		...
		local var_14_2 = var_2_10002(var_14_1, var_4(var_2_10005))
		...
		var_14_4(var_14_3, var_5.GetTypewriterSpeed(var_14_5))
		var_14_2:Play()
...
function var_0_1.lastFinish(arg_17_0)
	...
	local var_17_1 = var_2(var_1_10003)
	local var_17_2 = var_2.getTaskVO(var_17_1, var_17_0[1])

	getProxy = var_17_1
	TaskProxy = var_4

	local var_17_3 = var_17_1(var_4)
...
function var_0_1.UpdateTask(arg_18_0, arg_18_1, arg_18_2)
	...
	var_18_3(var_18_4, "without this task by id: " .. var_18_2)

	Drop = var_18_3

	local var_18_5 = var_18_3.Create(var_18_4:getConfig("award_display")[1])

	updateDrop = var_8

	var_8(var_18_1, var_18_5)
	...
	local function var_18_8()
		...
		var_19_1(var_19_0, var_2_10002.ON_DROP, var_18_5)
	...
	var_8(var_18_6, var_18_7, var_18_8, var_1_10012)

	local var_18_9 = var_18_4:getProgress()
	local var_18_10 = var_18_4:getConfig("target_num")
	local var_18_11 = var_18_4
	local var_18_12 = var_18_4.getConfig(var_18_11, "desc")

	utf8 = var_18_11

	if var_18_11.len(var_18_12) >= 11 then
		setScrollText = var_11
		var_1_10013 = arg_18_2

		var_11(arg_18_2.Find(var_1_10013, "mask/description"), var_18_12)
	else
		setText = var_11
		var_1_10013 = arg_18_2
	...
	local var_18_13, var_18_14 = arg_18_0:GetProgressColor()
	...
	if var_18_13 then
		...
		if not var_1_10013(var_18_9, var_18_13) then
			::label_18_0::
		...
		if var_18_14 then
			...
			if not var_1_10013("/" .. var_18_10, var_18_14) then
				::label_18_1::
			...
			var_1_10013(arg_18_2:Find("progressText"), var_18_15 .. var_18_16)

			setSlider = var_1_10013

			var_1_10013(arg_18_2:Find("progress"), 0, var_18_10, var_18_9)

			local var_18_17 = arg_18_2:Find("go_btn")
			local var_18_18 = arg_18_2:Find("get_btn")
			local var_18_19 = arg_18_2:Find("got_btn")
			local var_18_20 = var_18_4
			local var_18_21 = var_18_4.getTaskStatus(var_18_20)

			setActive = var_18_20

			var_18_20(var_18_17, var_18_21 == 0)

			setActive = var_18_20

			var_18_20(var_18_18, var_18_21 == 1)

			setActive = var_18_20

			var_18_20(var_18_19, var_18_21 == 2)

			onButton = var_18_20

			local var_18_22 = arg_18_0
			local var_18_23 = var_18_17
			...
			local function var_18_24()
				...
				var_20_1(var_20_0, var_2_10002.ON_TASK_GO, var_18_4)
			...
			var_18_20(var_18_22, var_18_23, var_18_24, var_1_10021)

			onButton = var_18_20

			local var_18_25 = arg_18_0
			local var_18_26 = var_18_18
			...
			local function var_18_27()
				...
				local var_21_3 = var_21_1(var_3)
				local var_21_4 = var_2.getRawData(var_21_3)

				pg = var_21_3

				local var_21_5 = var_21_3.gameset.urpt_chapter_max.description[1]
				...
				if var_2_10005 then
					...
					var_2_10005 = var_2_10005.GetLimitCntById(var_2_10006, var_21_5)
				end

				Task = var_2_10006

				local var_21_6, var_21_7 = var_2_10006.StaticJudgeOverflow(var_21_4.gold, var_21_4.oil, var_2_10005, true, true, var_21_2)
				...
				if var_21_6 then
					...
					var_8.insert(var_21_0, function(arg_22_0)
						...
						var_22_2.type = var_3_10004
						i18n = var_3_10004
						var_22_2.content = var_3_10004("award_max_warning")
						var_22_2.items = var_21_7
				...
				var_8(var_21_0, function()
					...
					var_23_1(var_23_0, var_3_10002.ON_TASK_SUBMIT, var_18_4)
			...
			var_18_20(var_18_25, var_18_26, var_18_27, var_1_10021)
...
function var_0_1.getTaskIdx(arg_25_0, arg_25_1)
	...
	local var_25_3 = var_1_10005.min(var_25_1, var_25_2)
	local var_25_4 = true
	...
	return var_7.min(var_25_0, var_25_2)
end
...
function var_0_1.isTaskFinished(arg_26_0, arg_26_1)
	if not arg_26_0.taskProxy then
		getProxy = var_2
		TaskProxy = var_1_10003
		arg_26_0.taskProxy = var_2(var_1_10003)
	end
