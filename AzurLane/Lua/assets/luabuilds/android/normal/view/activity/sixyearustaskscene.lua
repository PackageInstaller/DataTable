...
function var_0_1.UpdateList(arg_9_0, arg_9_1)
	...
	var_2.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local var_10_7 = var_8.min(var_10_2, var_10_5)
			...
			typeof = var_10
			Slider = var_11
			var_10_9(var_10_8, var_10(var_11)).value = var_10_7 / var_10_5
			...
			local function var_10_18()
				...
				SixYearUsTaskMediator = var_3_10002
			...
			var_14(var_10_16, var_10_17, var_10_18, var_2_10018)
			...
			local function var_10_21()
				...
				var_0.checkAwardOverFlow(var_12_0, {
					...
					SixYearUsTaskMediator = var_4_10002

					var_13_1(var_13_0, var_4_10002.ON_TASK_SUBMIT, var_10_0)
			...
			var_14(var_10_19, var_10_20, var_10_21, var_2_10018)
		end
	...
	if arg_9_0.canGetAward then
		...
		local function var_9_4()
			...
			var_0.checkAwardOverFlow(var_14_0, arg_9_0.canGetTaskVOs, function()
				...
				var_15_1(var_15_0, var_3_10002.ON_TASK_SUBMIT_ONESTEP, arg_9_0.canGetTaskIds)
...
function var_0_1.checkAwardOverFlow(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_0, iter_16_1 in var_1_10005(arg_16_1) do
		...
		local var_16_2 = iter_16_1.getConfig(var_1_10011, "award_display")
	...
	local var_16_6 = var_6(var_7)
	local var_16_7 = var_6.getActivityByType

	ActivityConst = var_8

	local var_16_8 = var_16_7(var_16_6, var_8.ACTIVITY_TYPE_TOWN)
	...
	if var_16_9 then
		...
		DROP_TYPE_VITEM = iter_16_7
		iter_16_6.type = iter_16_7
		iter_16_7 = "<color=#FF5C5CFF>"
		math = var_1_10011
		iter_16_6.count = iter_16_7 .. var_1_10011.abs(var_16_10) .. "</color>"
		var_16_11 = iter_16_6
	end

	getProxy = iter_16_6
	PlayerProxy = iter_16_7

	local var_16_12 = iter_16_6(iter_16_7)
	local var_16_13 = var_9.getRawData(var_16_12)

	pg = var_16_12

	local var_16_14 = var_16_12.gameset.urpt_chapter_max.description[1]

	LOCK_UR_SHIP = var_1_10012
	...
	if var_1_10012 then
		...
		var_1_10012 = var_1_10012.GetLimitCntById(var_1_10013, var_16_14)
	end

	Task = var_1_10013

	local var_16_15, var_16_16 = var_1_10013.StaticJudgeOverflow(var_16_13.gold, var_16_13.oil, var_1_10012, true, true, var_16_1)

	var_16_16 = var_16_16 or {}

	if var_16_11 then
		table = var_15

		var_15.insert(var_16_16, var_16_11)
	end

	if var_16_15 or var_16_9 then
		table = var_15
		...
		var_15.insert(var_16_0, function(arg_17_0)
			...
			i18n = var_2_10004
			var_17_2.content = var_2_10004("award_max_warning")
			var_17_2.items = var_16_16
...
function var_0_1.updateAwards(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	for iter_18_1 = 1, var_18_1 do
		...
		if var_18_3 then
			...
			var_14(var_18_2:Find("mask"), var_18_5)

			local var_18_6 = var_18_5.type

			DROP_TYPE_EQUIPMENT_SKIN = var_15

			if var_18_6 == var_15 then
				setActive = var_18_6

				var_18_6(var_18_2:Find("specialFrame"), true)
			else
				setActive = var_18_6

				var_18_6(var_18_2:Find("specialFrame"), false)
			end
			...
			var_18_6(var_18_7, var_18_8, var_18_9, var_1_10018)
		end
	end
...
function var_0_1.UpdateTaskData(arg_20_0)
	...
	local var_20_2 = var_20_1(var_20_0, var_1_10003.SIX_YEAR_US_TASK_ACT_ID)

	getProxy = var_20_0
	ActivityProxy = var_3

	local var_20_3 = var_20_0(var_3)
	local var_20_4 = var_2.getActivityById

	ActivityConst = var_1_10004

	local var_20_5 = var_20_4(var_20_3, var_1_10004.SIX_YEAR_US_TASK_2_ACT_ID)

	arg_20_0.taskVOs = {}

	if var_20_2 and not var_20_2:isEnd() then
		local var_20_6 = var_20_2
		local var_20_7 = var_20_2.getConfig(var_20_6, "config_data")

		pairs = var_20_6

		for iter_20_0, iter_20_1 in var_20_6(var_20_7) do
			table = var_1_10009
			var_1_10009 = var_1_10009.insert

			local var_20_8 = arg_20_0.taskVOs

			getProxy = var_1_10011
			TaskProxy = var_1_10012
			var_1_10012 = var_1_10011(var_1_10012)

			var_1_10009(var_20_8, var_1_10011.getTaskVO(var_1_10012, iter_20_1))
		end
	end

	if var_20_5 and not var_20_5:isEnd() then
		local var_20_9 = var_20_5
		local var_20_10 = var_20_5.getConfig(var_20_9, "config_data")

		pairs = var_20_9

		for iter_20_2, iter_20_3 in var_20_9(var_20_10) do
			table = var_1_10009
			var_1_10009 = var_1_10009.insert

			local var_20_11 = arg_20_0.taskVOs

			getProxy = var_1_10011
			TaskProxy = var_1_10012
			var_1_10012 = var_1_10011(var_1_10012)

			var_1_10009(var_20_11, var_1_10011.getTaskVO(var_1_10012, iter_20_3))
		end
	end
...
function var_0_1.getTaskProgress(arg_21_0, arg_21_1)
	...
	for iter_21_0, iter_21_1 in var_1_10002(var_0_2) do
		if iter_21_1[1] == arg_21_1:getConfig("type") and iter_21_1[2] == arg_21_1:getConfig("sub_type") then
			...
			local var_21_1 = arg_21_1.getProgress(var_21_0) / 1000

			string = var_21_0

			local var_21_2 = var_21_0.format("%.2d", arg_21_1:getProgress() / 1000)
	...
	local var_21_4 = arg_21_1.getProgress(var_21_3)

	tostring = var_21_3

	local var_21_5 = var_21_3(arg_21_1:getProgress())
end
...
function var_0_1.getTaskTarget(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_0_2) do
		if iter_22_1[1] == arg_22_1:getConfig("type") and iter_22_1[2] == arg_22_1:getConfig("sub_type") then
			...
			local var_22_1 = arg_22_1.getConfig(var_22_0, "target_num") / 1000

			string = var_22_0

			local var_22_2 = var_22_0.format("%.2d", arg_22_1:getConfig("target_num") / 1000)
	...
	local var_22_4 = arg_22_1.getConfig(var_22_3, "target_num")

	tostring = var_22_3

	local var_22_5 = var_22_3(arg_22_1:getConfig("target_num"))
end
