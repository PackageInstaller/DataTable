...
function var_0_1.CustomInit(arg_2_0)
	...
	var_1_10001(var_2.Find(var_2_0, "adapt/TopPage/top"), "Anim_SecretsAbyssCoreActivityUI_top_In")
	...
	var_1_10001(var_2_2, var_2_1("activity_ninjia_main_title"))
	...
	var_1_10001(var_2_4, var_2_3("activity_ninjia_main_title_en"))
...
function var_0_1.GetButtonNameText(arg_3_0, arg_3_1)
	...
	return var_1_10002(var_1_10003.format("activity_ninjia_main_sheet%s", arg_3_1:getConfig("is_show")))
end
