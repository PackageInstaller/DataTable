...
local var_0_0 = var_0_10000("MonopolyCarGame")
local var_0_1 = 100
local var_0_2 = 50
...
function var_0_0.initData(arg_2_0)
	...
	local var_2_0 = var_1.random(1, #var_0_4)
...
function var_0_0.initUI(arg_3_0)
	...
	findTF = var_1
	arg_3_0.showChar = var_1(arg_3_0._tf, "showChar")
	setActive = var_1
	...
	local var_3_0 = var_1(arg_3_0.btnRp, "rpAni")
	local var_3_1 = var_1.GetComponent

	typeof = var_3
	Animator = var_1_10004
	arg_3_0.commonAnim = var_3_1(var_3_0, var_3(var_1_10004))
	findTF = var_1
	...
	findTF = var_1
	arg_3_0.mcTouzi = var_1(arg_3_0._tf, "mcTouzi")
	findTF = var_1
	arg_3_0.imgTouzi = var_1(arg_3_0._tf, "imgTouzi")
	setActive = var_1

	var_1(arg_3_0.mcTouzi, false)
	arg_3_0:initMap()
	arg_3_0:initChar()
...
function var_0_0.initEvent(arg_4_0)
	...
	local function var_4_2()
		...
		if arg_4_0.leftCount and arg_4_0.leftCount <= 0 then
			...
			var_5_1(var_5_0, var_2_10002("common_count_noenough"))
		...
		MonopolyCarPage = var_2

		var_5_4(var_5_3, var_2.ON_START, arg_4_0.activity.id, function(arg_6_0)
	...
	local function var_4_5()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.help_monopoly_car.tip
	...
	local var_4_6 = arg_4_0._binder
	local var_4_7 = arg_4_0.showChar
	...
	local var_4_9 = arg_4_0._binder
	local var_4_10 = arg_4_0.btnRp
	...
	local function var_4_11()
		if arg_4_0.leftAwardCnt > 0 then
			...
			MonopolyCarPage = var_2_10002

			var_9_1(var_9_0, var_2_10002.ON_AWARD)
		end
...
function var_0_0.showRollAnimated(arg_10_0, arg_10_1)
	...
	Vector3 = var_3
	var_10_0.localEulerAngles = var_3(0, 0, 0)
	findTF = var_3
	...
	local var_10_3 = var_10_2(var_10_1, var_5(var_6))
	...
	local var_10_6 = var_10_5(var_10_4, var_5(var_6))

	var_10_6.fillAmount = 0.1
	setText = var_10_6
	findTF = var_4

	var_10_6(var_4(arg_10_0.rollStep, "labelRoll"), "0")
	...
	var_10_6({
		function(arg_11_0)
			...
			local var_11_1 = var_11_0(var_2_10002(arg_10_0._tf), 1, 0, 0.2)
			local var_11_2 = var_1.setOnUpdate

			System = var_3

			local var_11_3 = var_11_2(var_11_1, var_3.Action_float(function(arg_12_0)
				local var_12_0 = arg_10_0.btnStart
				local var_12_1 = var_1.GetComponent

				typeof = var_3_10003
				CanvasGroup = var_3_10004
				var_12_1(var_12_0, var_3_10003(var_3_10004)).alpha = arg_12_0
			...
			var_11_4(var_11_3, var_3.Action(function()
				...
				var_13_1(var_13_0, var_2(var_3_10003)).alpha = 1
		...
		function(arg_14_0)
			...
			local var_14_1 = var_14_0(var_2_10002(arg_10_0._tf), 0, 1, 0.2)
			local var_14_2 = var_1.setOnUpdate

			System = var_3

			local var_14_3 = var_14_2(var_14_1, var_3.Action_float(function(arg_15_0)
				...
				local var_15_2 = var_15_1(var_15_0, var_3_10003(var_3_10004))
		...
		function(arg_17_0)
			...
			local var_17_3 = var_17_2(var_2_10005(arg_10_0._tf), 0, 1, 0.7 + arg_10_1 / 5)
			local var_17_4 = var_4.setEase

			LeanTweenType = var_6

			local var_17_5 = var_17_4(var_17_3, var_6.easeOutCirc)
			local var_17_6 = var_4.setOnUpdate

			System = var_6

			local var_17_7 = var_17_6(var_17_5, var_6.Action_float(function(arg_18_0)
				findTF = var_3_10001
				...
				local var_18_2 = var_18_1(var_18_0, var_3(var_3_10004))
				...
				local var_18_5 = var_18_4(var_18_3, var_3(var_3_10004))
				local var_18_6 = var_17_0

				math = var_3
				var_18_5.fillAmount = var_18_6 * var_3.floor(arg_18_0 / (1 / arg_10_1)) + 0.17
				setText = var_18_5
				findTF = var_2

				local var_18_7 = var_2(arg_10_0.rollStep, "labelRoll")

				math = var_3

				var_18_5(var_18_7, var_3.floor(arg_18_0 / (1 / arg_10_1)))

				local var_18_8 = var_17_1 * arg_18_0 - 13
				local var_18_9 = var_10_0

				Vector3 = var_3
				var_18_9.localEulerAngles = var_3(0, 0, var_18_8)
			...
			var_17_8(var_17_7, var_6.Action(function()
				arg_17_0()
		...
		function(arg_20_0)
			...
			local var_20_1 = var_20_0(var_2_10002(arg_10_0._tf), 1, 0, 0.3)
			local var_20_2 = var_1.setOnComplete

			System = var_3

			var_20_2(var_20_1, var_3.Action(function()
				arg_20_0()
		...
		function(arg_22_0)
			...
			local var_22_1 = var_22_0(var_2_10002(arg_10_0._tf), 1, 0, 0.3)
			...
			local var_22_3 = var_22_2(var_22_1, var_3.Action_float(function(arg_23_0)
				...
				typeof = var_3_10003
				CanvasGroup = var_3_10004
				var_23_1(var_23_0, var_3_10003(var_3_10004)).alpha = arg_23_0
			...
			var_22_4(var_22_3, var_3.Action(function()
				setActive = var_3_10000
				...
				typeof = var_2
				CanvasGroup = var_3_10003
				var_24_1(var_24_0, var_2(var_3_10003)).alpha = 1
		...
		var_2_10000(arg_10_0.mcTouzi, true)

		setActive = var_2_10000

		var_2_10000(arg_10_0.mcTouzi, false)
		...
		if arg_10_0.step > 0 then
			...
			local var_25_0 = var_0("ui/activityuipage/monopolycar_atlas", arg_10_0.step)

			setActive = var_1

			var_1(arg_10_0.imgTouzi, true)

			local var_25_1 = arg_10_0.imgTouzi
			local var_25_2 = var_1.GetComponent

			typeof = var_3
			Image = var_2_10004
			var_25_2(var_25_1, var_3(var_2_10004)).sprite = var_25_0
		end

		local var_25_3 = arg_10_0

		var_0.updataUI(var_25_3)

		local var_25_4 = arg_10_0

		var_0.checkCharActive(var_25_4)
...
function var_0_0.checkCountStory(arg_26_0, arg_26_1)
	...
	if var_26_1.detect(var_26_2, function(arg_27_0)
		return arg_27_0[1] == var_26_0
	end) then
		pg = var_6

		local var_26_3 = var_6.NewStoryMgr.GetInstance()
...
function var_0_0.changeAnimeState(arg_28_0, arg_28_1)
	if arg_28_1 then
		...
		typeof = var_1_10004
		Image = var_1_10005
		var_1_10002 = var_1_10002(var_28_0, var_1_10004(var_1_10005))
		...
		var_1_10002(var_28_1, var_1_10004.LOCK_ACT_MAIN, true)
	else
		...
		typeof = var_1_10004
		Image = var_1_10005
		var_1_10002 = var_1_10002(var_28_2, var_1_10004(var_1_10005))
		var_1_10002.raycastTarget = true
		setActive = var_1_10002

		var_1_10002(arg_28_0.imgTouzi, false)
		...
		var_1_10002(var_28_3, var_4.LOCK_ACT_MAIN, false)
	end
...
function var_0_0.initMap(arg_29_0)
	MonopolyCarConst = var_1_10001

	local var_29_0 = var_1_10001.map_dic
	...
	for iter_29_0 = 1, #var_29_0 do
		...
		for iter_29_1 = 1, #var_29_3 do
			...
			if 0 < var_29_5 then
				...
				local var_29_8 = var_15(var_29_6, var_29_7, var_1_10018(var_29_5))

				Vector2 = var_29_6
				var_29_8.localPosition = var_29_6(var_0_1 * var_29_4 + var_29_2.x, -var_0_2 * var_29_4 + var_29_2.y)
				pg = var_17

				local var_29_9 = var_17.activity_event_monopoly_map[var_29_5].icon

				GetSpriteFromAtlas = var_1_10018
				var_1_10018 = var_1_10018("ui/activityuipage/monopolycar_atlas", var_29_9)
				findTF = var_19

				local var_29_10 = var_19(var_29_8, "image")
				local var_29_11 = var_19.GetComponent

				typeof = var_21
				Image = var_1_10022

				local var_29_12 = var_29_11(var_29_10, var_21(var_1_10022))

				var_29_12.sprite = var_1_10018
				findTF = var_29_12

				local var_29_13 = var_29_12(var_29_8, "image")
				local var_29_14 = var_19.GetComponent

				typeof = var_21
				Image = var_1_10022

				local var_29_15 = var_29_14(var_29_13, var_21(var_1_10022))

				var_19.SetNativeSize(var_29_15)
				...
				var_29_15.insert(arg_29_0.mapCells, var_29_16)
			end
		end
	end
...
function var_0_0.initChar(arg_31_0)
	...
	var_1.GetSpineChar(var_31_0, var_0_3, true, function(arg_32_0)
		...
		var_32_3.anim = var_32_5(var_32_4, var_4(var_2_10005))
	...
	local var_31_1 = var_1.GetInstance()

	var_1.GetSpineChar(var_31_1, arg_31_0.showSkinId, true, function(arg_33_0)
		arg_31_0.showModel = arg_33_0

		local var_33_0 = arg_31_0.showModel.transform

		Vector3 = var_2_10002
		var_33_0.localScale = var_2_10002.one

		local var_33_1 = arg_31_0.showModel.transform

		Vector3 = var_2
		var_33_1.localPosition = var_2.zero

		local var_33_2 = arg_31_0.showModel.transform

		var_1.SetParent(var_33_2, arg_31_0.showChar, false)

		local var_33_3 = arg_31_0
		local var_33_4 = arg_31_0.showModel
		local var_33_5 = var_2.GetComponent

		typeof = var_4
		SpineAnimUI = var_2_10005
		var_33_3.showAnim = var_33_5(var_33_4, var_4(var_2_10005))

		local var_33_6 = arg_31_0.showAnim

		var_1.SetAction(var_33_6, "stand", 0)
...
function var_0_0.getMoveType(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	MonopolyCarConst = var_1_10004

	local var_35_0 = var_1_10004.map_dic
	local var_35_1 = {}
	local var_35_2 = {}
	...
	if var_35_2.y > var_35_1.y then
		var_35_4 = arg_35_3 and var_0_9 or var_0_7
		var_35_5 = var_0_5
	elseif var_35_2.y < var_35_1.y then
		var_35_4 = arg_35_3 and var_0_8 or var_0_6
		var_35_5 = var_0_5
...
function var_0_0.activityDataUpdata(arg_41_0, arg_41_1)
	...
	local var_41_3 = var_1_10004.ceil((var_41_1 - var_41_2) / 0)
	...
	local var_41_6 = var_10.max
	local var_41_7 = 0

	math = var_1_10012
	arg_41_0.advanceRpCount = var_41_6(var_41_7, var_1_10012.min(var_9, arg_41_0.advanceTotalCnt) - var_41_5)
	math = var_10

	local var_41_8 = var_10.max(0, var_9 - arg_41_0.advanceTotalCnt)

	math = var_11
	arg_41_0.commonRpCount = var_41_8 - var_11.max(0, var_41_5 - arg_41_0.advanceTotalCnt)
...
function var_0_0.checkStep(arg_42_0, arg_42_1)
	if arg_42_0.step > 0 then
		...
		var_42_1(var_42_0, var_1_10004.ON_MOVE, arg_42_0.activity.id, function(arg_43_0, arg_43_1, arg_43_2)
...
function var_0_0.updataUI(arg_47_0)
	...
	var_1(var_47_1, var_3("monopoly_left_count"))
...
function var_0_0.triggerEfeect(arg_53_0, arg_53_1)
	...
	var_53_1(var_53_0, var_1_10004.ON_TRIGGER, arg_53_0.activity.id, function(arg_54_0, arg_54_1)
...
function var_0_0.moveCarWithPaths(arg_57_0, arg_57_1, arg_57_2, arg_57_3)
	...
	var_8.insert(var_57_0, function(arg_61_0)
		...
		local var_61_1 = var_61_0(var_2_10002(arg_57_0._tf), 1, 0, 0.1)
		local var_61_2 = var_1.setOnComplete

		System = var_3

		var_61_2(var_61_1, var_3.Action(function()
			arg_61_0()
...
function var_0_0.toMoveCar(arg_63_0)
	...
	local var_63_1 = var_2.abs(arg_63_0.targetPosition.y - arg_63_0.char.localPosition.y)
	...
	if not (var_63_2 > var_4.abs(arg_63_0.baseSpeedX)) or not arg_63_0.baseSpeedX then
...
function var_0_0.moveCharWithPaths(arg_65_0, arg_65_1, arg_65_2, arg_65_3)
	...
	for iter_65_0 = 1, #arg_65_1 do
		...
		var_11.insert(var_65_0, function(arg_66_0)
			...
			local var_66_3 = var_66_2(var_3(arg_65_0.char), var_65_2.tf.localPosition, var_66_1)
			local var_66_4 = var_2.setEase

			LeanTweenType = var_4

			local var_66_5 = var_66_4(var_66_3, var_4.linear)
			local var_66_6 = var_2.setOnComplete

			System = var_4

			var_66_6(var_66_5, var_4.Action(function()
				arg_66_0()
...
function var_0_0.dispose(arg_69_0)
	...
	var_1.ReturnSpineChar(var_69_0, var_0_3, arg_69_0.model)

	PoolMgr = var_1

	local var_69_1 = var_1.GetInstance()

	var_1.ReturnSpineChar(var_69_1, arg_69_0.showSkinId, arg_69_0.showModel)
