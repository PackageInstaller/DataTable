...
function var_0_1.OnInit(arg_1_0)
	...
	var_1_8(var_1_9, var_3.Find(var_1_10, "item"))

	for iter_1_0 = 1, 6 do
		table = var_1_11

		local var_1_11 = var_1_11.insert
		local var_1_12 = arg_1_0.tabsList
		local var_1_13 = arg_1_0.progress

		var_1_11(var_1_12, var_7.Find(var_1_13, "item_" .. iter_1_0))
	end

	local var_1_14 = arg_1_0.showList

	arg_1_0.award = var_1.Find(var_1_14, "award")

	local var_1_15 = arg_1_0.award

	arg_1_0.gotAward = var_1.Find(var_1_15, "got")
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_2(var_3_1, var_2_10003.EVENT_OPERATION, {
			cmd = 1,
	...
	local function var_2_5()
		...
		var_4_2(var_4_1, var_2_10003.EVENT_OPERATION, {
			cmd = 1,
			activity_id = arg_2_0.activity.id
		})
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	var_5_0(arg_5_0.redpoint, var_5_1)

	setActive = var_5_0

	var_5_0(arg_5_0.btnClick, arg_5_0.nday <= arg_5_0.tabCount - 1)
	...
	var_5_0(arg_5_0.btnGot, arg_5_0.nday >= arg_5_0.tabCount)

	setActive = var_5_0

	var_5_0(arg_5_0.gotAward, arg_5_0.nday >= arg_5_0.tabCount)
