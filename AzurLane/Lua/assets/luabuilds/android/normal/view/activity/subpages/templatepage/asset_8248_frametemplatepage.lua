...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local var_3_11 = var_3_9.TimeMgr.GetInstance()
	local var_3_12 = var_2.inTime(var_3_11, var_3_10)

	setActive = var_3_11

	var_3_11(arg_3_0.battleBtn, var_3_12)

	arg_3_0.inPhase2 = var_3_12

	if var_3_12 then
		triggerToggle = var_3_11

		var_3_11(arg_3_0.switchBtn, true)
	end
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	var_9_2(arg_9_0.getBtn, var_9_1)

	setActive = var_9_2

	var_9_2(arg_9_0.gotBtn, not var_9_3)
	...
	if 1 <= var_9_7 then
		...
		if not var_8(var_9_9, var_1_10010) then
			var_9_10 = var_9_5
		end

		var_1_10006(var_9_8, var_9_10)

		setText = var_1_10006

		var_1_10006(arg_9_0.progress, "/" .. var_9_6)

		setFillAmount = var_1_10006

		var_1_10006(arg_9_0.bar, var_9_5 / var_9_6)
...
function var_0_1.Switch(arg_10_0, arg_10_1)
	...
	var_5(var_6.Find(var_10_5, "Image"), false)
	...
	local var_10_7 = var_10_6(var_6(arg_10_0.phases[1]), var_10_3, 0.4)
	...
	var_10_8(var_10_7, var_7.Action(function()
		...
		var_2_10000(var_1.Find(var_11_0, "label"), true)
	...
	var_10_11(var_10_10, var_7.Action_float(function(arg_12_0)
	...
	var_10_11(var_6.Find(var_10_12, "Image"), true)
	...
	local var_10_14 = var_10_11(var_10_13, var_7(var_8))

	LeanTween = var_10_13

	local var_10_15 = var_10_13.value

	go = var_7

	local var_10_16 = var_10_15(var_7(arg_10_0.phases[2]), 0, 1, 0.4)
	local var_10_17 = var_6.setOnUpdate

	System = var_8

	var_10_17(var_10_16, var_8.Action_float(function(arg_13_0)
	...
	var_10_17(var_7.Find(var_10_18, "label"), false)
	...
	local var_10_20 = var_10_19(var_7(arg_10_0.phases[2]), var_10_2, 0.4)
	local var_10_21 = var_6.setOnComplete

	System = var_8

	var_10_21(var_10_20, var_8.Action(function()
...
function var_0_1.UpdateAwardGot(arg_15_0)
	...
	if var_15_3 then
		...
		var_15_2(arg_15_0.battleBtn, false)
	end
