...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_ACTIVITY_UNLOCKSTOIRY, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.ACTIVITY_UNLOCKSTORY, {
			cmd = 1,
			activity_id = arg_2_1,
			arg1 = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.GO_SCENE, function(arg_4_0, arg_4_1, ...)
		...
		var_4_1(var_4_0, var_2_10004.GO_SCENE, arg_4_1, ...)
	...
	arg_1_0:bind(var_0_1.ON_FLEET_SELECT, function(arg_5_0, arg_5_1)
		...
		BossRushSardiniaFleetSelectView = var_2_10006
	...
	arg_1_0:bind(var_0_1.ON_EXTRA_RANK, function(arg_6_0)
		...
		local var_6_3 = var_2_10004.BILLBOARD
		local var_6_4 = {}

		PowerRank = var_2_10006
		var_6_4.page = var_2_10006.TYPE_BOSSRUSH
	...
	arg_1_0:bind(var_0_1.ON_PERFORM_COMBAT, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_2 = var_2_10005.BEGIN_STAGE
		local var_7_3 = {}

		SYSTEM_PERFORM = var_2_10007
		var_7_3.system = var_2_10007
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_TASK_SUBMIT, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.SUBMIT_TASK, arg_8_1.id)
	...
	var_7.addbubbleMsgBox(var_1_11, function(arg_9_0)
		...
		if var_9_2(var_9_1, var_2_10003) then
			return
		end
...
function var_0_1.handleNotification(arg_12_0, arg_12_1)
	...
	if var_12_0 == var_12_2.ACTIVITY_STORYUNLOCKED_DONE then
		var_1_10006 = arg_12_0.viewComponent

		var_5.UpdataStoryState(var_1_10006, var_12_1.storyId)
	else
		GAME = var_5
		...
		if var_12_0 == var_5.BEGIN_STAGE_DONE then
			...
			var_1_10006 = var_12_4(var_1_10006)
			var_12_4 = var_12_4.getContextByMediator
			BossRushPreCombatMediator = var_1_10007

			if not var_12_4(var_1_10006, var_1_10007) then
				local var_12_5 = arg_12_0

				var_1_10006 = arg_12_0.sendNotification
				GAME = var_1_10008

				local var_12_6 = var_1_10008.GO_SCENE

				SCENE = var_1_10009

				var_1_10006(var_12_5, var_12_6, var_1_10009.COMBATLOAD, var_12_1)
			end
		else
			ActivityProxy = var_12_4

			local var_12_7

			if var_12_0 == var_12_4.ACTIVITY_UPDATED then
				var_12_7 = var_12_1
				switch = var_1_10006

				var_1_10006(var_12_7.id, {
					[arg_12_0.contextData.activityID] = function()
						local var_13_0 = arg_12_0.viewComponent

						var_0.SetActivity(var_13_0, var_12_7)
					...
					[arg_12_0.contextData.activityPTID] = function()
						...
						var_0.SetPtActivity(var_14_0, var_12_7)
					...
					[arg_12_0.contextData.activityStoryID] = function()
						...
						var_0.SetStoryActivity(var_15_0, var_12_7)
				...
				if var_12_0 == var_12_7.SUBMIT_TASK_AWARD_DOWN then
					var_12_8 = {}

					if #var_12_1.awards > 0 then
						table = var_6

						var_6.insert(var_12_8, function(arg_16_0)
							local var_16_0 = arg_12_0.viewComponent
							local var_16_1 = var_1.emit

							BaseUI = var_2_10003

							var_16_1(var_16_0, var_2_10003.ON_ACHIEVE, var_12_1.awards, arg_16_0)
					...
					BossRushTotalRewardPanelMediator = var_12_8

					if var_12_0 == var_12_8.ON_WILL_EXIT then
						arg_12_0.contextData.showFlash = true

						local var_12_9 = arg_12_0.viewComponent

						var_5.resumeBubble(var_12_9)

						local var_12_10 = arg_12_0.viewComponent

						var_5.UpdateView(var_12_10)
					end
				end
			end
		end
