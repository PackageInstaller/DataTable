...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.animEvent = var_2_4(var_2_3, var_3(var_1_10004))
	...
	var_2_6(var_2_11, var_2_10("MonopolyCar2024Game_pick_tip"))
	...
	var_2_6(var_2_13, var_2_12("MonopolyCar2024Game_sel_label"))
...
function var_0_1.UpdateList(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10001(arg_6_0.items) do
		...
		var_7(var_6_0, var_6_1, var_6_2, var_1_10011)

		setToggleEnabled = var_7

		var_7(iter_6_1, not var_1_10006)

		warning = var_7

		var_7(iter_6_0, var_1_10006)

		setActive = var_7

		var_7(iter_6_1:Find(iter_6_0 .. "/active"), not var_1_10006)

		setActive = var_7

		var_7(iter_6_1:Find(iter_6_0 .. "/coin"), arg_6_0.banCount < 3 and not var_1_10006)
	end
...
function var_0_1.Show(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	...
	var_5.OverlayPanel(var_8_0, arg_8_0._tf)

	local var_8_1 = arg_8_0.anim

	var_5.Play(var_8_1, "anim_monopolycar_pick_in")
...
function var_0_1.Hide(arg_10_0)
	...
	local var_10_1 = var_1.UIMgr.GetInstagramList()
