...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.animator = var_2_16(var_2_15, var_3(var_1_10004))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_5()
		...
		local var_5_1 = var_1.MsgboxMgr.GetInstance()
	...
	local function var_3_8()
		...
		if var_0.checkTaskFinish(var_6_0) then
			...
			SecretShipyardMediator = var_2_10002

			var_6_3(var_6_2, var_2_10002.GO_MINI_GAME, var_0_1.GAME_ID)
	...
	local function var_3_11()
		...
		var_7_1(var_7_0, var_2_10002(var_3.checkTaskFinish(var_7_2) and "shipyard_button_1" or "shipyard_button_2"))
	...
	var_1(var_3_13, var_3("shipyard_introduce"))
...
function var_0_1.UpdateTask(arg_9_0, arg_9_1, arg_9_2)
	...
	if not var_6.getTaskById(var_9_3, var_9_2) then
		var_9_3 = arg_9_0.taskProxy
		var_9_4 = var_6.getFinishTaskById(var_9_3, var_9_2)
	end

	assert = var_9_3

	var_9_3(var_9_4, "without this task by id: " .. var_9_2)

	local var_9_5 = var_9_4:getConfig("award_display")[1]
	local var_9_6 = {
		type = var_9_5[1],
		id = var_9_5[2],
		count = var_9_5[3]
	...
	var_9(var_9_1, var_9_6)

	onButton = var_9

	local var_9_7 = arg_9_0
	local var_9_8 = var_9_1
	...
	var_9(var_9_7, var_9_8, var_9_9, var_1_10013)

	local var_9_10 = var_9_4:getProgress()
	local var_9_11 = var_9_4
	local var_9_12 = var_9_4.getConfig(var_9_11, "target_num")

	setText = var_9_11

	var_9_11(arg_9_2:Find("description"), var_9_4:getConfig("desc"))

	local var_9_13 = var_9_10
	local var_9_14 = "/" .. var_9_12

	setText = var_13

	var_13(arg_9_2:Find("progress_text"), var_9_13 .. var_9_14)

	setSlider = var_13

	var_13(arg_9_2:Find("progress"), 0, var_9_12, var_9_10)

	local var_9_15 = arg_9_2:Find("go_btn")
	local var_9_16 = arg_9_2:Find("get_btn")
	local var_9_17 = arg_9_2:Find("got_btn")
	local var_9_18 = var_9_4
	local var_9_19 = var_9_4.getTaskStatus(var_9_18)

	setActive = var_9_18

	var_9_18(var_9_15, var_9_19 == 0)

	setActive = var_9_18

	var_9_18(var_9_16, var_9_19 == 1)

	setActive = var_9_18

	var_9_18(var_9_17, var_9_19 == 2)

	onButton = var_9_18

	local var_9_20 = arg_9_0
	local var_9_21 = var_9_15
	...
	local function var_9_22()
		...
		var_11_1(var_11_0, var_2_10002.TASK_GO, var_9_4)
	...
	var_9_18(var_9_20, var_9_21, var_9_22, var_1_10021)
	...
	local function var_9_25()
		...
		var_12_1(var_12_0, var_2_10002.SUBMIT_TASK, var_9_4.id)
	...
	var_9_18(var_9_23, var_9_24, var_9_25, var_1_10021)

	setActive = var_9_18

	local var_9_26 = arg_9_2:Find("mask")
	local var_9_27 = arg_9_0.taskProxy

	var_9_18(var_9_26, var_19.getFinishTaskById(var_9_27, var_9_2) ~= nil)
...
function var_0_1.updateTaskLayers(arg_13_0)
	...
	local var_13_0 = var_1_10001(var_2)
...
function var_0_1.ChangeBackground(arg_16_0)
	...
	local var_16_2 = var_2(arg_16_0._tf)
	local var_16_3 = var_0_1.ANIMATION_DELAY

	System = var_1_10004

	var_16_1(var_16_2, var_16_3, var_1_10004.Action(function()
	...
	var_16_4(var_16_5, var_16_6, var_4.Action(function()
	...
	var_16_7(var_16_8, var_16_9, var_4.Action(function()
...
function var_0_1.checkMinigame(arg_22_0)
	...
	return var_22_1.mini_game[var_0_1.GAME_ID] ~= nil and var_22_2
end
...
function var_0_1.willExit(arg_23_0)
	...
	var_23_0(var_1_10002(arg_23_0._tf))
