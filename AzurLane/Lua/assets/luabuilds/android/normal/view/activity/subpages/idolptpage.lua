...
function var_0_1.OnInit(arg_1_0)
	...
	for iter_1_0 = 0, arg_1_0.lableList.childCount - 1 do
		...
		var_1_10005(var_1_1, var_7.GetChild(var_1_2, iter_1_0))
	end
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10002.BATTLE_OPERA)
	...
	local function var_3_8()
		...
		local var_6_5 = var_2_10004.EVENT_PT_OPERATION
		local var_6_6 = {
			cmd = 1
		}
	...
	var_1_10001(arg_3_0, arg_3_0.linkBtn, function()
		...
		InstagramLayer = var_2_10005
		var_7_4.viewComponent = var_2_10005
		InstagramMediator = var_2_10005
		var_7_4.mediator = var_2_10005

		local var_7_5 = {}

		ActivityConst = var_2_10006
		var_7_5.id = var_2_10006.IDOL_INS_ID
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if arg_8_0.linkAct then
		local var_8_0 = var_1

		if not var_1.isEnd(var_8_0) then
			local var_8_1 = {}

			math = var_8_0

			local var_8_2 = var_8_0.floor(#var_1.data1_list / 2)

			for iter_8_0 = 1, var_8_2 do
				local var_8_3

				if not var_8_1[var_1.data1_list[2 * iter_8_0 - 1]] then
					var_8_3 = 0
				end
				...
				var_8_1[var_8] = var_8_3 + var_1_10010
			end
			...
			for iter_8_1, iter_8_2 in var_5(var_8_1) do
				table = var_1_10010

				var_1_10010.insert(var_8_4, {
					name = iter_8_1,
					count = iter_8_2
				})
			end
			...
			var_5.sort(var_8_4, function(arg_9_0, arg_9_1)
			...
			local var_8_5 = var_5.min(#var_8_4, #arg_8_0.lableItems)
			...
			for iter_8_3 = 1, var_8_5 do
				...
				local var_8_7 = var_8_6:Find("name")
				local var_8_8 = "#"

				tostring = var_14
				ShipGroup = var_1_10015

				var_1_10011(var_8_7, var_8_8 .. var_14(var_1_10015.getDefaultShipNameByGroupID(var_8_4[iter_8_3].name)) .. "#")

				setText = var_1_10011

				var_1_10011(var_8_6:Find("Text"), arg_8_0:TransFormat(var_8_4[iter_8_3].count))
			end
...
function var_0_1.GetWorldRank(arg_11_0, arg_11_1)
	if arg_11_0.linkAct then
		var_1_10003 = arg_11_0.linkAct

		if var_2.isEnd(var_1_10003) then
			return
		end
		...
		if not var_11_1(var_1_10005).requestTime[var_11_0] then
			var_11_3 = 0
		end
		...
		if arg_11_1 <= var_11_2 - var_11_3 then
			...
			var_11_5(var_11_4, var_1_10005.FETCH_INSTARGRAM, {
...
function var_0_1.NeedTip()
	...
	if var_12_1(var_12_0, var_1_10002.IDOL_PT_ID) and not var_0:isEnd() then
