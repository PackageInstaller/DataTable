...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BlackFridayPage"))
...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_2 = var_2.Find(var_1_1, "AD/singlist")
	local var_1_3 = arg_1_0._tf

	arg_1_0.signList = var_1_0(var_1_2, var_3.Find(var_1_3, "AD/singlist/Award"))
	...
	var_1(var_1_6, var_1_5("SkinMagazinePage2_tip"))
...
function var_0_1.FlushSignBtn(arg_4_0)
	...
	if var_1.getActivityById(var_4_0, arg_4_0.signInActId) then
		var_4_1 = var_1
		var_4_2 = var_1.isEnd(var_4_1)
	...
	var_4_1(var_4_3, var_4_4, var_4_5, var_1_10007)

	setActive = var_4_1

	var_4_1(arg_4_0.signBtn, not var_4_2 and var_1:AnyAwardCanGet())
...
function var_0_1.FlushSignList(arg_8_0, arg_8_1)
	...
	local var_8_4 = arg_8_1.getConfig(var_8_3, "config_client")

	type = var_8_3

	local var_8_5 = var_8_3(var_8_4) == "table" and var_8_4 or {}
	local var_8_6 = arg_8_0.signList

	var_7.make(var_8_6, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			if var_9_1 == var_4.STATE_GOT then
				...
				var_4.insert(var_8_2, var_8_5[arg_9_1 + 1])
			end
		end
	...
	local var_8_7 = arg_8_0.signList

	var_7.align(var_8_7, #var_8_0)
...
function var_0_1.UpdateSignAward(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	local var_12_1 = arg_12_4.Find(var_12_0, "got")

	ManualSignActivity = var_12_0

	var_1_10005(var_12_1, arg_12_2 == var_12_0.STATE_GOT)

	setActive = var_1_10005

	local var_12_2 = arg_12_4
	local var_12_3 = arg_12_4.Find(var_12_2, "get")

	ManualSignActivity = var_12_2

	var_1_10005(var_12_3, arg_12_2 == var_12_2.STATE_CAN_GET)

	onButton = var_1_10005

	local var_12_4 = arg_12_0
	local var_12_5 = arg_12_4
	...
	var_1_10005(var_12_4, var_12_5, var_12_6, var_1_10009)
...
function var_0_1.Sign(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_1_10004.ACT_MANUAL_SIGN
	local var_14_3 = {
		activity_id = arg_14_1.id
	}

	ManualSignActivity = var_6
	var_14_3.cmd = var_6.OP_GET_AWARD
