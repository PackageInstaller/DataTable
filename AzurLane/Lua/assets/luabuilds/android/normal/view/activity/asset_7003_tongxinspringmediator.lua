...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_1(var_2_0, var_2_10004.ACTIVITY_TYPE_HOTSPRING)
		local var_2_3, var_2_4 = var_2.GetUpgradeCost(var_2_2)

		MsgboxMediator = var_2_10005

		local var_2_5 = var_2_10005.ShowMsgBox
		local var_2_6 = {}

		MSGBOX_TYPE_NORMAL = var_2_10007
		var_2_6.type = var_2_10007
		i18n = var_2_10007
		var_2_6.content = var_2_10007("202406_wenquan_unlock", var_2_4)
		...
		function var_2_6.onYes()
			...
			if var_0.GetCoins(var_3_0) < var_2_4 then
				...
				var_3_2(var_3_1, var_3_10003("202406_wenquan_unlock_tip2"))
	...
	local var_1_3 = var_1_2(var_1_1, var_3.ACTIVITY_TYPE_HOTSPRING)
...
function var_0_1.OnSelShips(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_2 = var_5_1(var_5_0, var_1_10005.ACTIVITY_TYPE_HOTSPRING)
	...
	local var_5_8 = var_8.New
	local var_5_9 = {}

	DockyardScene = var_1_10010
	var_5_9.viewComponent = var_1_10010
	DockyardMediator = var_1_10010
	var_5_9.mediator = var_1_10010
...
function var_0_1.OnSelected(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	local var_9_2 = var_9_1(var_9_0, var_1_10006.ACTIVITY_TYPE_HOTSPRING)

	Clone = var_9_0

	local var_9_3 = var_9_2
	local var_9_4 = var_9_0(var_9_2.GetShipIds(var_9_3))

	_ = var_6

	local var_9_5 = var_6.each

	_ = var_9_3

	local var_9_6 = var_9_3.range
	local var_9_7 = var_9_2

	var_9_5(var_9_6(var_9_2.GetSlotCount(var_9_7)), function(arg_10_0)
		local var_10_0 = var_9_4
		local var_10_1

		if not var_9_4[arg_10_0] then
			var_10_1 = 0
		end
	...
	if arg_9_2 == nil or #arg_9_2 == 0 then
		...
		if 0 < var_9_5 then
			...
			var_9_9 = arg_9_0.sendNotification
			GAME = var_9_7

			local var_9_10 = var_9_7.ACTIVITY_OPERATION
			local var_9_11 = {
				activity_id = var_9_2.id
			}

			SpringActivity = var_11
			var_9_11.cmd = var_11.OPERATION_SETSHIP
			var_9_11.kvargs1 = {
				{
					value = 0,
					key = arg_9_1
			...
			var_9_9(var_9_8, var_9_10, var_9_11)
		end
	...
	local var_9_12 = var_9_5.filter(arg_9_2, function(arg_11_0)
		table = var_2_10001

		return not var_2_10001.contains(var_9_4, arg_11_0)
	end)

	table = var_7

	var_7.Foreach(var_9_4, function(arg_12_0, arg_12_1)
		if arg_12_1 ~= 0 then
			table = var_2_10002
	...
	if #var_9_12 == 1 and var_9_4[arg_9_1] == 0 then
		var_9_4[arg_9_1] = var_9_12[1]
	else
		local var_9_13 = 0

		_ = var_8

		var_8.each(var_9_12, function(arg_13_0)
			while var_9_13 <= #var_9_4 do
				var_9_13 = var_9_13 + 1

				if var_9_4[var_9_13] == 0 then
					break
				end
			end

			var_9_4[var_9_13] = arg_13_0
	...
	local var_9_16 = var_9_2.GetShipIds(var_9_15)

	table = var_9_15

	var_9_15.Foreach(var_9_4, function(arg_14_0, arg_14_1)
		local var_14_0

		if not var_9_16[arg_14_0] then
			var_14_0 = 0
		end
	...
	if #var_9_14 > 0 then
		...
		local var_9_18 = arg_9_0.sendNotification

		GAME = var_11

		local var_9_19 = var_11.ACTIVITY_OPERATION
		local var_9_20 = {
			activity_id = var_9_2.id
		}

		SpringActivity = var_13
		var_9_20.cmd = var_13.OPERATION_SETSHIP
		var_9_20.kvargs1 = var_9_14

		var_9_18(var_9_17, var_9_19, var_9_20)
	end
...
function var_0_1.GetSelectedShipIds(arg_15_0, arg_15_1)
	...
	local var_15_1 = var_1_10003(var_1_10004)
	local var_15_2 = var_3.getActivityByType

	ActivityConst = var_1_10005

	local var_15_3 = var_15_2(var_15_1, var_1_10005.ACTIVITY_TYPE_HOTSPRING)
	local var_15_4 = {}

	ipairs = var_5

	for iter_15_0, iter_15_1 in var_5(var_15_3:GetShipIds()) do
		local var_15_5
		...
		if 0 < iter_15_1 then
			...
			var_15_5 = var_10.RawGetShipById(var_1_10011, iter_15_1)
		else
			var_15_5 = false
		end
		...
		if var_15_5 and var_15_5.id ~= var_15_0 then
			...
			var_1_10011.insert(var_15_4, var_15_5.id)
		end
	end
...
function var_0_1.handleNotification(arg_19_0, arg_19_1)
	...
	if var_19_0 == nil then
		...
		ActivityProxy = var_19_1

		local var_19_3

		if var_19_0 == var_19_1.ACTIVITY_SHOW_AWARDS then
			var_1_10005 = arg_19_0.viewComponent
			var_19_3 = var_19_3.emit
			BaseUI = var_1_10006

			var_19_3(var_1_10005, var_1_10006.ON_ACHIEVE, var_19_2.awards, var_19_2.callback)
		else
			ActivityProxy = var_19_3

			local var_19_4

			if var_19_0 == var_19_3.ACTIVITY_UPDATED then
				var_1_10005 = var_19_2
				var_19_4 = var_19_2.getConfig(var_1_10005, "type")
				ActivityConst = var_1_10005

				if var_19_4 == var_1_10005.ACTIVITY_TYPE_HOTSPRING then
					var_1_10005 = arg_19_0.viewComponent

					var_19_4.UpdateActivity(var_1_10005, var_19_2)
				end
			else
				ActivityProxy = var_19_4

				if var_19_0 == var_19_4.ACTIVITY_OPERATION_DONE then
					getProxy = var_4
					ActivityProxy = var_1_10005

					local var_19_5 = var_4(var_1_10005)
					local var_19_6 = var_4.getActivityById(var_19_5, var_19_2)
					local var_19_7 = var_4.getConfig(var_19_6, "type")

					ActivityConst = var_19_6

					if var_19_7 == var_19_6.ACTIVITY_TYPE_HOTSPRING then
						local var_19_8 = arg_19_0.viewComponent

						var_5.UpdateActivity(var_19_8, var_4)
					end
				elseif var_19_0 == var_0_1.OPEN_CHUANWU then
					local var_19_9 = arg_19_0.viewComponent
					local var_19_10 = var_4.emit
					local var_19_11 = var_0_1.OPEN_CHUANWU

					unpack = var_1_10007

					var_19_10(var_19_9, var_19_11, var_1_10007(var_19_2))
				elseif var_19_0 == var_0_1.UNLOCK_SLOT then
					local var_19_12 = arg_19_0.viewComponent

					var_4.emit(var_19_12, var_0_1.UNLOCK_SLOT, var_19_2)
				end
			end
		end
	end
