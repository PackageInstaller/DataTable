...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0.animator = var_1_1(var_1_0, var_1_10006(var_1_10007))
	...
	arg_1_0.animatorEvent = var_1_3(var_1_2, var_6(var_1_10007))
	...
	arg_1_0.collider2D = var_1_5(var_1_4, var_6(var_1_10007.Collider2D))
	...
	typeof = var_6
	UnityEngine = var_7
	arg_1_0.effectCollider2D = var_1_8(var_1_7, var_6(var_7.Collider2D))
	UIItemList = var_4

	local var_1_9 = var_4.New
	local var_1_10 = arg_1_1.transform
	local var_1_11 = var_5.Find(var_1_10, "hp")
	local var_1_12 = arg_1_1.transform

	arg_1_0.hpBar = var_1_9(var_1_11, var_6.Find(var_1_12, "hp/tpl"))
...
function var_0_0.Move(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10003(var_8_2 * var_1_10005.deltaTime, 0, 0))
