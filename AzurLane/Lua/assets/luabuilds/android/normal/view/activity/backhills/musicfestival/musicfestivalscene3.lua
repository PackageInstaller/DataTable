...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._shipTpl = var_1.Find(var_2_10, "ship")
	GraphPath = var_1

	local var_2_11 = var_1.New

	import = var_2_10
	arg_2_0.graphPath = var_2_11(var_2_10("GameCfg.BackHillGraphs.MusicFestivalGraph3"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_11()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.idol3rd_houshan.tip
	...
	arg_3_0.InitFacilityCross(var_3_15, arg_3_0._map, arg_3_0._upper, "xiaoyouxi", function()
		...
		var_7_1(var_7_0, var_2_10002.GO_MINI_GAME, 16)
	...
	local var_3_18 = var_3_17(var_3_16, var_4.MUSIC_FESTIVAL_PT_ID_3)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "huodongye", function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10003.ACTIVITY, {
			id = var_3_18.id
		})
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "dalaozhang", function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10003.IDOL_MEDAL_COLLECTION_SCENE3)
...
function var_0_1.MiniGameTip()
	...
	return var_10_0(var_1_10001.MUSIC_FESTIVAL_ID_3)
end
...
function var_0_1.ActivityTip()
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10002.MUSIC_FESTIVAL_PT_ID_3)
...
function var_0_1.UpdateView(arg_13_0)
	...
	var_1_10001(var_2.Find(var_13_0, "Tip"), var_0_1.MiniGameTip())

	setActive = var_1_10001

	local var_13_1 = arg_13_0.upper_dalaozhang

	var_1_10001(var_2.Find(var_13_1, "Tip"), var_0_1.MedalTip())

	setActive = var_1_10001

	local var_13_2 = arg_13_0.upper_huodongye

	var_1_10001(var_2.Find(var_13_2, "Tip"), var_0_1.ActivityTip())
