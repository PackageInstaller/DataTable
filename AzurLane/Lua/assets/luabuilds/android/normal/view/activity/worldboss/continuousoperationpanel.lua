...
local var_0_0 = "ContinuousOperationPanel"
...
function var_0_1.init(arg_2_0)
	...
	arg_2_0._ratioFitter = var_1(var_2_3, var_3(var_1_10004))
	setText = var_1

	local var_2_4 = arg_2_0.btnOff
	local var_2_5 = var_2.Find(var_2_4, "common/Text")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("multiple_sorties_stopped"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local function var_4_3()
		...
		var_5_2(var_5_1, var_2_10002("multiple_sorties_stop_tip"))

		local var_5_3 = arg_4_0
		local var_5_4 = var_0.emit

		BattleMediator = var_2

		var_5_4(var_5_3, var_2.HIDE_ALL_BUTTONS, true)
	...
	var_4_0(var_4_1, var_4_2, var_4_3, var_1_10005)
	...
	local function var_4_6()
		...
		var_6_2(var_6_1, var_2_10002("multiple_sorties_resume_tip"))
		...
		var_6_4(var_6_3, var_2.HIDE_ALL_BUTTONS, false)
	...
	var_4_0(var_4_4, var_4_5, var_4_6, var_1_10005)

	local var_4_7 = arg_4_0._ratioFitter

	pg = var_4_4

	local var_4_8 = var_4_4.CameraFixMgr.GetInstance()
...
function var_0_1.UpdateBattleTimes(arg_7_0)
	...
	var_1_10003(var_4.Find(var_7_2, "Text"), var_7_1 - var_7_0 + 1 .. "/" .. var_7_1)
	...
	var_1_10003(var_4.Find(var_7_3, "small"), true)

	setActive = var_1_10003

	local var_7_4 = arg_7_0.btnOff

	var_1_10003(var_4.Find(var_7_4, "common"), false)
...
function var_0_1.OnEnterBattleResult(arg_8_0)
	...
	var_1_10001(var_2.Find(var_8_0, "small"), false)

	setActive = var_1_10001

	local var_8_1 = arg_8_0.btnOff

	var_1_10001(var_2.Find(var_8_1, "common"), true)
...
function var_0_1.AnimatingSlider(arg_9_0)
	...
	local var_9_2 = var_3.value

	local function var_9_3()
		local var_10_0 = arg_9_0
		local var_10_1 = var_0.emit

		ContinuousOperationMediator = var_2_10002

		var_10_1(var_10_0, var_2_10002.ON_REENTER)
	...
	local var_9_4 = var_9_1(var_9_0, var_9_2, var_9_3, var_1_10005(arg_9_0.slider), 1, 0, 5)
...
function var_0_1.onBackPressed(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10003.PAUSE_BATTLE)
