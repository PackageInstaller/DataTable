...
function var_0_1.OnInit(arg_1_0)
	...
	if not var_1_2(var_1_1, var_1_10004.SIX_SIGN_ACT_ID) or not var_2:isShow() then
		table = var_1_1

		var_1_1.insert(arg_1_0.hideIndex, 4)
	end
...
function var_0_1.switchNextPaint(arg_4_0)
	...
	local var_4_6 = var_4_5(var_7(arg_4_0.paintFrontTF), 1, 0, arg_4_0.paintSwitchTime)
...
function var_0_1.initBtnEvent(arg_11_0, arg_11_1, arg_11_2)
	...
	elseif arg_11_2 == 2 then
		...
		local function var_11_5()
			...
			local var_13_3 = var_2_10003.CHARGE
			local var_13_4 = {}

			ChargeScene = var_2_10005
			var_13_4.wrap = var_2_10005.TYPE_DIAMOND
	...
	elseif arg_11_2 == 3 then
		...
		local function var_11_8()
			...
			var_14_1(var_14_0, var_14_2, var_2_10003.ACTIVITY_TYPE_RETURN_AWARD_ID6)
	...
	elseif arg_11_2 == 4 then
		...
		local function var_11_11()
			...
			local var_15_2 = var_2_10002.SELECT_ACTIVITY

			ActivityConst = var_2_10003

			var_15_1(var_15_0, var_15_2, var_2_10003.SIX_SIGN_ACT_ID)
...
function var_0_1.OnDestroy(arg_20_0)
	...
	if var_20_0(var_1_10002(arg_20_0.paintFrontTF)) then
		LeanTween = var_1
		...
		var_20_1(var_2(arg_20_0.paintFrontTF))
	end
