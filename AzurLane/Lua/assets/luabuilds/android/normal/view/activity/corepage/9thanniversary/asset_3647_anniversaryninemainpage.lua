...
function var_0_1.OnFirstFlush(arg_2_0)
	if arg_2_0:GetMallActOpen() then
		...
		local function var_2_2()
			...
			var_3_1(var_3_0, var_3_2, var_2_10003.MALL_MAP)
	...
	local function var_2_8()
		...
		FujinBayMedalAlbumView = var_2_10002
...
function var_0_1.GetMallActOpen(arg_7_0)
	...
	if var_1.GetActivityIdByPageClass(var_7_0, "AnniversaryNineGamePage") then
		...
		var_7_0 = var_7_0.getActivityById(var_7_1, var_1)
	end
...
function var_0_1.IsMallAwardTip()
	...
	if not var_11_1(var_11_0, var_1_10002.ACTIVITY_TYPE_MALL) or var_0:isEnd() then
		return false
	end

	MallAwardLayer = var_11_0

	local var_11_2

	if not var_11_0.IsAwardTip() then
...
function var_0_1.GetFujinBayMedalTaskCount()
	...
	for iter_14_0, iter_14_1 in var_1_10004(var_14_1) do
		...
		if var_1_10010.getActivityById(var_1_10011, var_14_3) and not var_1_10010:isEnd() then
