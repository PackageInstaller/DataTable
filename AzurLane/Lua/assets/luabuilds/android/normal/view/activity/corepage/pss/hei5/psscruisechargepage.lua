...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_3 = var_2.Find(var_4_2, "Image")

	i18n = var_4_2

	var_1(var_4_3, var_4_2("text_cancel"))
	...
	local var_4_7 = var_2.Find(var_4_6, "left/got/desc")

	i18n = var_4_6

	var_1(var_4_7, var_4_6(arg_4_0.descTip))
	...
	local var_4_11 = var_3.Find(var_4_10, "right/items/Text")

	i18n = var_4_10

	var_4_8(var_4_11, var_4_10(arg_4_0.payTip))

	UIItemList = var_4_8
	arg_4_0.uiItemList = var_4_8.New(var_4_9, var_4_9:Find("tpl"))
	...
	var_2.make(var_4_12, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			local var_5_2 = arg_5_2.Find(var_5_1, "name")

			shortenString = var_5_1

			var_4(var_5_2, var_5_1(var_5_0:getConfig("name"), 4))
			...
			local function var_5_5()
				...
				var_6_1(var_6_0, var_3_10002.ON_NEW_STYLE_DROP, {
					drop = var_5_0
				})
			...
			var_4(var_5_3, var_5_4, var_5_5, var_8)
		end
	...
	local var_4_15 = var_4.Find(var_4_14, "bg")
	...
	var_2(var_4_13, var_4_15, var_4_16, var_6)
	...
	var_2(var_4_17, var_4_18, var_4_19, var_6)
	...
	local function var_4_22()
		...
		if var_2_10000.isNeedSetBirth() then
			...
			var_9_1(var_9_0, var_2_10002.EVENT_OPEN_BIRTHDAY)
		else
			pg = var_9_1
			...
			var_9_3(var_9_2, var_2_10002.CHARGE_OPERATION, {
	...
	var_2(var_4_20, var_4_21, var_4_22, var_6)
...
function var_0_1.ShowBuyWindow(arg_10_0)
	...
	local var_10_0 = var_0_1.GetPassID()
	...
	local var_10_3 = var_10_1(var_10_2, var_4.TYPE_CHARGE)

	Drop = var_10_2

	local var_10_4 = var_10_2.Create(var_10_3:getConfig("display")[1])

	LoadImageSpriteAtlasAsync = var_4

	local var_10_5 = var_10_4:getIcon()
	local var_10_6 = ""
	local var_10_7 = arg_10_0.buyWindow

	var_4(var_10_5, var_10_6, var_7.Find(var_10_7, "left/got/award/icon"))

	setText = var_4

	local var_10_8 = arg_10_0.buyWindow

	var_4(var_5.Find(var_10_8, "left/got/award/count"), "x" .. var_10_4.count)

	setText = var_4

	local var_10_9 = arg_10_0.buyWindow

	var_4(var_5.Find(var_10_9, "right/tip"), var_10_3:getConfig("descrip_extra"))

	local var_10_10 = var_10_3
	local var_10_11 = var_10_3.getConfig(var_10_10, "money")

	PLATFORM_CODE = var_10_10
	PLATFORM_CHT = var_6

	if var_10_10 == var_6 and var_10_3:IsLocalPrice() then
		-- block empty
	else
		GetMoneySymbol = var_10_10
		var_10_11 = var_10_10() .. var_10_11
	end

	setText = var_10_10

	var_10_10(arg_10_0.priceTF, var_10_11)

	arg_10_0.itemList = var_10_3:GetExtraServiceItem()

	local var_10_12 = arg_10_0.uiItemList

	var_5.align(var_10_12, #arg_10_0.itemList)
...
function var_0_1.GetPassID()
	...
	if var_11_1(var_11_0, var_1_10003.ACTIVITY_TYPE_PT_HEI5) then
