...
function var_0_1.tryClaimTaskReward(arg_9_0)
	...
	if #var_9_0 > 0 then
		...
		var_9_7(var_9_6, var_4.ON_TASK_SUBMIT_ONESTEP, var_9_0)
	end
...
function var_0_1.initTask(arg_10_0)
	...
	local var_10_2 = var_10_0.activity_template[var_10_1].config_data[1]
	...
	for iter_10_0 = 1, #var_10_2 do
		...
		if var_10_5 == 26 then
			...
			arg_10_0:insertTaskToGroup(var_10_4, var_1_10008, var_10_7)
		end
	end
...
function var_0_1.updateTaskList(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	if arg_12_4.subType ~= 33 then
		...
		var_15(var_12_10, var_17(var_12_1, "#b35845") .. "/" .. var_12_0)
	else
		setText = var_15
		findTF = var_12_10
	...
	local var_12_12 = var_17(var_12_8, "award")
	...
	var_15(var_12_11, var_12_12, var_12_13, var_19)
	...
	elseif var_12_0 <= var_12_1 then
		...
		var_15(var_12_14, var_12_15, var_12_16, var_19)
	else
		setActive = var_15
		findTF = var_12_14
		...
		var_15(var_12_14, var_12_15, var_12_17, var_19)
	end
	...
	if var_12_3 then
		...
		var_15(var_12_18, var_12_19, var_12_20, var_19)
	end
