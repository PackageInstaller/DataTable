...
function var_0_0.CanGetMorePt(arg_19_0)
	...
	var_19_1 = var_1.getActivityById(var_19_0, arg_19_0.bindActId) and not var_1:isEnd()
...
function var_0_0.CanTrain(arg_20_0)
	...
	if not arg_20_0.isInBuffTime(var_20_0) then
		return false
	end
	...
	for iter_20_0, iter_20_1 in var_20_0(var_3.getDataConfig(var_20_2, "target_buff")) do
		if var_20_1(iter_20_1) and iter_20_1 <= arg_20_0.level + 1 then
			return iter_20_1
		end
	end
...
function var_0_0.GetCurBuffInfos(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_22_1(arg_22_0.curBuffs) do
		ipairs = var_1_10008

		local var_22_3 = arg_22_0.activity

		for iter_22_2, iter_22_3 in var_1_10008(var_9.getDataConfig(var_22_3, "buff_group")) do
			ipairs = var_1_10013

			for iter_22_4, iter_22_5 in var_1_10013(iter_22_3) do
...
function var_0_0.GetBuffAwardInfo(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in var_23_0(var_2) do
...
function var_0_0.GetBuffLevelProgress(arg_24_0)
	...
	local var_24_1, var_24_2 = (function()
		...
		for iter_25_0, iter_25_1 in var_2_10000(var_1.getDataConfig(var_25_0, "target_buff")) do
...
function var_0_0.isInBuffTime(arg_26_0)
	...
	if var_26_0(var_26_1) == "table" then
		pg = var_2
...
function var_0_0.IsGotLevelAward(arg_34_0, arg_34_1)
	...
	local var_34_1 = arg_34_0.GetPtTarget(var_34_0, arg_34_1)

	ipairs = var_34_0

	for iter_34_0, iter_34_1 in var_34_0(arg_34_0.activity.data1_list) do
		if iter_34_1 == var_34_1 then
			return true
		end
	end
...
function var_0_0.GetAllAvailableAwards(arg_37_0)
	...
	return var_37_0(var_37_1, var_1_10003.min(arg_37_0:GetLevel() + 1, arg_37_0:GetMaxAvailableTargetIndex()), arg_37_0:GetMaxAvailableTargetIndex() - arg_37_0:GetLevel())
end
