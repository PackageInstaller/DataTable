...
function var_0_1.SetData(arg_3_0, arg_3_1)
	...
	local var_3_5 = var_3_4(var_3_3, var_1_10005.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB)
	...
	local var_3_8, var_3_9 = arg_3_1:GetCurrentProfile()

	ipairs = var_6

	for iter_3_0, iter_3_1 in var_6(arg_3_0._labelList) do
		if not var_3_8[iter_3_0] then
			...
			var_1_10011(iter_3_1:Find("desc"), var_3_8[iter_3_0])
		end
	end

	ipairs = var_6

	for iter_3_2, iter_3_3 in var_6(var_3_9) do
		setText = var_1_10011

		local var_3_10 = arg_3_0._labelList[iter_3_2]

		var_1_10011(var_12.Find(var_3_10, "state"), iter_3_3)
	end

	setText = var_6

	local var_3_11 = arg_3_0._goBtnNormal

	var_6(var_7.Find(var_3_11, "text"), arg_3_1:GetName(arg_3_1.DIFF.NORMAL))

	setText = var_6

	local var_3_12 = arg_3_0._goBtnHard

	var_6(var_7.Find(var_3_12, "text"), arg_3_1:GetName(arg_3_1.DIFF.HARD))

	local var_3_13 = arg_3_0._series

	if var_6.GetBossTimeStamp(var_3_13) == 0 then
		local var_3_14 = arg_3_1
		local var_3_15 = arg_3_1.GetDamagePerH(var_3_14) * 100

		setText = var_3_14

		var_3_14(arg_3_0._delta, "-" .. var_3_15 .. "%")

		setActive = var_3_14

		var_3_14(arg_3_0._delta, true)

		setActive = var_3_14

		var_3_14(arg_3_0._timeStamp, false)
	else
		local var_3_16 = arg_3_1
		local var_3_17 = arg_3_1.GetBossTimeStamp(var_3_16)

		os = var_3_16

		local var_3_18 = var_3_16.date("*t", var_3_17)

		setText = var_8

		local var_3_19 = arg_3_0._timeStamp
		local var_3_20 = var_9.Find(var_3_19, "date")

		string = var_3_19

		var_8(var_3_20, var_3_19.format("%02d/%02d %02d:%02d", var_3_18.month, var_3_18.day, var_3_18.hour, var_3_18.min))

		setActive = var_8

		var_8(arg_3_0._delta, false)

		setActive = var_8

		var_8(arg_3_0._timeStamp, true)
	end

	local var_3_21 = arg_3_0._series
	local var_3_22 = var_6.GetRewardDisplay(var_3_21)

	UIItemList = var_3_21

	local var_3_23 = var_3_21.StaticAlign
	local var_3_24 = arg_3_0._arwardList
	local var_3_25 = arg_3_0._arwardList

	var_3_23(var_3_24, var_9.GetChild(var_3_25, 0), #var_3_22, function(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_0 = var_3_22[arg_4_1 + 1]
...
function var_0_1.OnLoaded(arg_7_0)
	...
	local var_7_7 = var_2.Find(var_7_6, "label")

	i18n = var_7_6

	var_1(var_7_7, var_7_6("DAL_stage_finish_at"))
	...
	var_7_8(var_7_9, var_3.Find(var_7_10, "Panel/StageInfo/label_1"))
	...
	var_7_11(var_7_12, var_3.Find(var_7_13, "Panel/StageInfo/label"))
	...
	var_7_14(var_7_15, var_3.Find(var_7_16, "Panel/StageInfo/commander_label"))
	...
	var_7_17(var_7_18, var_3.Find(var_7_19, "Panel/StageInfo/label_2"))

	setText = var_7_17

	local var_7_20 = arg_7_0._tf
	local var_7_21 = var_2.Find(var_7_20, "Panel/StageInfo/label_1/label/text")

	i18n = var_7_20

	var_7_17(var_7_21, var_7_20("DAL_stage_label_data"))

	setText = var_7_17

	local var_7_22 = arg_7_0._tf
	local var_7_23 = var_2.Find(var_7_22, "Panel/StageInfo/label/label/text")

	i18n = var_7_22

	var_7_17(var_7_23, var_7_22("DAL_stage_label_data"))

	setText = var_7_17

	local var_7_24 = arg_7_0._tf
	local var_7_25 = var_2.Find(var_7_24, "Panel/StageInfo/commander_label/label/text")

	i18n = var_7_24

	var_7_17(var_7_25, var_7_24("DAL_stage_label_commander"))

	setText = var_7_17

	local var_7_26 = arg_7_0._tf
	local var_7_27 = var_2.Find(var_7_26, "Panel/StageInfo/label_2/label/text")

	i18n = var_7_26

	var_7_17(var_7_27, var_7_26("DAL_stage_label_support"))
	...
	local var_7_30 = var_2.Find(var_7_29, "text")

	i18n = var_7_29

	var_1(var_7_30, var_7_29("dal_chapter_tip2"))

	setText = var_1

	local var_7_31 = arg_7_0._tf
	local var_7_32 = var_2.Find(var_7_31, "Panel/Reward/label")

	i18n = var_7_31

	var_1(var_7_32, var_7_31("item_type17_tip1"))
...
function var_0_1.RegisterEvent(arg_8_0)
	...
	local function var_8_5()
		...
		CollabrateBossRushSeriesData = var_2_10002

		var_10_1(var_10_0, var_2_10002.DIFF.NORMAL)

		local var_10_2 = arg_8_0.event
		local var_10_3 = var_0.emit

		BossRushDALCollabMediator = var_2

		var_10_3(var_10_2, var_2.ON_FLEET_SELECT, arg_8_0._series)
	...
	local function var_8_8()
		...
		var_11_1(var_11_0, var_2_10002.DIFF.HARD)
		...
		var_11_3(var_11_2, var_2.ON_FLEET_SELECT, arg_8_0._series)
