...
local var_0_2 = var_0_0("view.activity.BackHills.NewYearFestival.NewYearHotSpringFormationCard")
...
function var_0_1.AddCard(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	if arg_9_2 == 0 and arg_9_3 then
		...
		function var_1_10010()
			...
			DOAYearHotSpringShipSelectMediator = var_2_10002
		...
		var_1_10010 = arg_9_3.state
		Ship = var_1_10011

		if var_1_10010 ~= var_1_10011.STATE_REST then
			var_1_10010 = arg_9_3.state
			Ship = var_11

			if var_1_10010 == var_11.STATE_TRAIN then
				var_1_10010 = arg_9_3.state
				Ship = var_11

				if var_1_10010 == var_11.STATE_TRAIN then
					Ship = var_1_10010
					var_9_10 = var_9_10 + var_1_10010.BACKYARD_1F_ENERGY_ADDITION
				else
					var_1_10010 = arg_9_3.state
					Ship = var_11

					if var_1_10010 == var_11.STATE_REST then
						Ship = var_1_10010
						var_9_10 = var_9_10 + var_1_10010.BACKYARD_2F_ENERGY_ADDITION
					end
				end
				...
				for iter_9_0, iter_9_1 in var_1_10010(var_11.GetBackYardEnergyBuffs()) do
					tonumber = var_1_10015
					var_9_11 = var_9_11 + var_1_10015(iter_9_1:getConfig("benefit_effect"))
				end
			end

			local var_9_12 = var_9_3

			var_1_10010 = var_9_3.updateProps1

			local var_9_13 = {}
			local var_9_14 = {}

			i18n = iter_9_1
			var_9_14[1] = iter_9_1("word_lv")
			var_9_14[2] = arg_9_3.level
			var_9_13[1] = var_9_14

			local var_9_15 = {}

			i18n = var_14
			var_9_15[1] = var_14("word_nowenergy")
			var_9_15[2] = arg_9_3.energy
			var_9_13[2] = var_9_15

			local var_9_16 = {}

			i18n = var_14
			var_9_16[1] = var_14("word_energy_recov_speed")
			setColorStr = var_14

			local var_9_17 = 10 * var_9_10

			COLOR_GREEN = var_1_10016

			local var_9_18 = var_14(var_9_17, var_1_10016)

			if 0 < var_9_11 then
				setColorStr = var_15

				local var_9_19 = "+" .. 10 * var_9_11

				COLOR_GREEN = var_17

				local var_9_20

				if not var_15(var_9_19, var_17) then
					var_9_20 = ""
				end

				var_9_16[2] = var_9_18 .. var_9_20 .. "/h"
				var_9_13[3] = var_9_16

				var_1_10010(var_9_12, var_9_13)

				setActive = var_1_10010

				var_1_10010(var_9_3.propsTr, false)

				setActive = var_1_10010

				var_1_10010(var_9_3.propsTr1, true)

				table = var_1_10010

				var_1_10010.insert(arg_9_0.shipCards, {
					info = var_9_3,
				...
				do
					local var_9_21 = var_1_10005(arg_9_0.extendShipTpl, arg_9_0.cardContainer)

					var_1_10005 = var_9_0.Find(var_9_21, "content")
					setActive = var_9_21

					var_9_21(var_1_10005:Find("label/add"), arg_9_2 == 0)

					setActive = var_9_21

					var_9_21(var_1_10005:Find("label/unlock"), arg_9_2 == 1)

					setActive = var_9_21

					var_9_21(var_1_10005:Find("label/lock"), arg_9_2 == 2)

					setActive = var_9_21

					var_9_21(var_1_10005:Find("mask"), arg_9_2 == 2)

					if arg_9_2 == 0 then
						onButton = var_9_21

						local var_9_22 = arg_9_0
						local var_9_23 = var_1_10005
						...
						var_9_21(var_9_22, var_9_23, var_9_24, var_1_10010)
					elseif arg_9_2 == 1 then
						onButton = var_9_21

						local var_9_25 = arg_9_0
						local var_9_26 = var_1_10005
						...
						var_9_21(var_9_25, var_9_26, var_9_27, var_1_10010)
