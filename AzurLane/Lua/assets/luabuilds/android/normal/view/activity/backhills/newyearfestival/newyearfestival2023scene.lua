...
function var_0_1.init(arg_2_0)
	...
	import = var_2
	arg_2_0.graphPath = var_2_6(var_2("GameCfg.BackHillGraphs.NewyearFestival2023Graph"))
	...
	local var_2_11 = var_1.map

	_ = var_2
	arg_2_0.tipTfs = var_2_11(var_2.range(arg_2_0._upper.childCount), function(arg_3_0)
	...
	local var_2_12 = var_1.ViewUtils.SetSortingOrder
	local var_2_13 = arg_2_0._map

	var_2_12(var_2.GetChild(var_2_13, arg_2_0._map.childCount - 1), 1)

	AutoLoader = var_2_12
	arg_2_0.loader = var_2_12.New()
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1_10001(var_4_0, var_3.Find(var_4_1, "Back"), function()
	...
	var_1_10001(var_4_2, var_3.Find(var_4_3, "Home"), function()
	...
	var_1_10001(var_4_4, var_3.Find(var_4_5, "Help"), function()
		pg = var_2_10000
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.resorts_help.tip
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "hotspring", function()
		...
		var_8_1(var_8_0, var_8_2, var_2_10003.HOTSPRING)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "duihuanwu", function()
		...
		var_9_1(var_9_2, var_2_10003.HOTSPRING_SHOP)
		...
		var_9_4(var_9_3, var_3.GO_SUBLAYER, var_9_0)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "firework", function()
		...
		var_10_1(var_10_0, var_2_10002.GO_MINI_GAME, 44)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "shrine", function()
		...
		var_11_1(var_11_0, var_2_10002.GO_MINI_GAME, 45)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "fudai", function()
		...
		var_12_1(var_12_0, var_12_2, var_2_10003.HOTSPRING_REDPACKET)
	...
	var_4_7(var_4_6, var_3.MINIGAME_FIREWORK_VS_SAIREN, 3, 4)
	arg_4_0:UpdateView()
	...
	var_1_10001.each(arg_14_0.tipTfs, function(arg_15_0)
		...
		local var_15_0 = var_2_10001(arg_15_0.name, {
			...
			hotspring = function()
				...
				local var_17_2 = var_17_1(var_17_0, var_3_10002.ACTIVITY_TYPE_HOTSPRING)
			...
			firework = function()
				...
				return var_20_0(var_3_10001.MINIGAME_FIREWORK_VS_SAIREN)
			end
		}, function()
			return false
		end)
...
function var_0_1.IsShowMainTip(arg_22_0)
	local var_22_0 = {
		...
		hotspring = function()
			...
			local var_24_2 = var_24_1(var_24_0, var_2_10002.ACTIVITY_TYPE_HOTSPRING)

			Activity = var_24_0

			return var_24_0.IsActivityReady(var_24_2)
		end,
		shrine = function()
		...
		firework = function()
			...
			return var_27_0(var_2_10001.MINIGAME_FIREWORK_VS_SAIREN)
		end
	}
	...
	return var_22_1(var_1_10003.values(var_22_0), function(arg_28_0)
		return arg_28_0()
	end)
end
