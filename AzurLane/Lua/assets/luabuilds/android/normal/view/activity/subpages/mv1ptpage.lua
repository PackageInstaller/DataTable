...
function var_0_1.initMv(arg_2_0)
	...
	var_1(var_2_0, var_3("island_act_tips1"))
	...
	var_1(var_2_1, var_3(arg_2_0.mvTf, "left"), function()
		if var_0_3 then
			Time = var_0
	...
	var_1(var_2_2, var_3(arg_2_0.mvTf, "right"), function()
		if var_0_3 then
			Time = var_0
	...
	local var_2_4 = var_3(arg_2_0._tf, "AD/chapter")
	...
	var_1(var_2_7, var_3(arg_2_0._tf, "AD/right"), function()
		if arg_2_0.mvIndex < arg_2_0.showItemNum and not arg_2_0.isLoading then
			arg_2_0.mvIndex = arg_2_0.mvIndex + 1
	...
	for iter_2_0 = 1, var_0_2 do
		...
		var_1_10006(var_2_9, var_1_10008(arg_2_0.mvTf, "page/" .. iter_2_0), function()
			if var_0_3 then
				Time = var_0
		...
		var_1_10006(var_2_10, var_1_10008)
	end
...
function var_0_1.UpdateTask(arg_13_0, arg_13_1, arg_13_2)
	...
	if not var_6.getTaskById(var_13_3, var_13_2) then
		var_13_3 = arg_13_0.taskProxy
		var_13_4 = var_6.getFinishTaskById(var_13_3, var_13_2)
	end

	assert = var_13_3

	var_13_3(var_13_4, "without this task by id: " .. var_13_2)

	local var_13_5 = var_13_4:getConfig("award_display")[1]
	local var_13_6 = {
		type = var_13_5[1],
		id = var_13_5[2],
		count = var_13_5[3]
	...
	var_9(var_13_7, var_13_8, var_13_9, var_1_10013)

	local var_13_10 = var_13_4:getProgress()
	local var_13_11 = var_13_4
	local var_13_12 = var_13_4.getConfig(var_13_11, "target_num")

	setText = var_13_11

	var_13_11(arg_13_2:Find("description"), var_13_4:getConfig("desc"))

	local var_13_13, var_13_14 = arg_13_0:GetProgressColor()
	...
	if var_13_13 then
		...
		if not var_13(var_13_10, var_13_13) then
			::label_13_0::
		...
		if var_13_14 then
			...
			if not var_13("/" .. var_13_12, var_13_14) then
				::label_13_1::
			...
			var_13(arg_13_2:Find("progressText"), var_13_15 .. var_13_16)

			setSlider = var_13

			var_13(arg_13_2:Find("progress"), 0, var_13_12, var_13_10)

			local var_13_17 = arg_13_2:Find("go_btn")
			local var_13_18 = arg_13_2:Find("get_btn")
			local var_13_19 = arg_13_2:Find("got_btn")
			local var_13_20 = var_13_4
			local var_13_21 = var_13_4.getTaskStatus(var_13_20)

			setActive = var_13_20

			var_13_20(var_13_17, var_13_21 == 0)

			setActive = var_13_20

			var_13_20(var_13_18, var_13_21 == 1)

			setActive = var_13_20

			var_13_20(var_13_19, var_13_21 == 2)

			onButton = var_13_20

			local var_13_22 = arg_13_0
			local var_13_23 = var_13_17
			...
			local function var_13_24()
				...
				var_15_1(var_15_0, var_2_10002.ON_TASK_GO, var_13_4)
			...
			var_13_20(var_13_22, var_13_23, var_13_24, var_1_10021)

			onButton = var_13_20

			local var_13_25 = arg_13_0
			local var_13_26 = var_13_18
			...
			local function var_13_27()
				...
				var_16_1(var_16_0, var_2_10002.ON_TASK_SUBMIT, var_13_4)
			...
			var_13_20(var_13_25, var_13_26, var_13_27, var_1_10021)

			local var_13_28 = arg_13_2:Find("get_btn")
			local var_13_29 = arg_13_1 + 1
			local var_13_30 = arg_13_0.taskGroup[arg_13_0.nday][var_13_29]
			local var_13_31 = arg_13_0.taskProxy
			local var_13_32

			if not var_20.getTaskById(var_13_31, var_13_30) then
				var_13_31 = arg_13_0.taskProxy
				var_13_32 = var_20.getFinishTaskById(var_13_31, var_13_30)
			end

			onButton = var_13_31

			local var_13_33 = arg_13_0
			local var_13_34 = var_13_28
			...
			local function var_13_35()
				if arg_13_0.nday <= var_0_2 then
					...
					var_17_1(var_17_0, var_2_10002.ON_TASK_SUBMIT, var_13_32)
				else
					...
					if var_17_2(var_17_3, {
						...
						var_1.Play(var_17_4, var_17_3[arg_13_0.nday][1], function()
							...
							var_18_1(var_18_0, var_3_10002.ON_TASK_SUBMIT, var_13_32)
						...
						var_17_6(var_17_5, var_3.ON_TASK_SUBMIT, var_13_32)
					end
				end
			...
			var_13_31(var_13_33, var_13_34, var_13_35, var_1_10025)

			local var_13_36 = arg_13_2
			local var_13_37 = arg_13_2.Find(var_13_36, "got_btn")

			onButton = var_13_36

			local var_13_38 = arg_13_0
			local var_13_39 = var_13_37
			...
			var_13_36(var_13_38, var_13_39, var_13_40, var_1_10026)
...
function var_0_1.pageUpdate(arg_21_0)
	for iter_21_0 = 1, var_0_2 do
		...
		var_1_10005(var_1_10006(arg_21_0.mvTf, "page/" .. iter_21_0 .. "/selected"), arg_21_0.mvIndex == iter_21_0)
	end
	...
	for iter_21_1 = 1, var_0_2 do
		...
		var_1_10005(var_1_10006(arg_21_0._tf, "AD/page/" .. iter_21_1 .. "/selected"), arg_21_0.mvIndex == iter_21_1)
	end
	...
	for iter_21_2 = 1, var_0_2 do
		...
		var_1_10005(var_1_10006(arg_21_0._tf, "AD/chapter/" .. iter_21_2), arg_21_0.mvIndex == iter_21_2)
	end

	setActive = var_1
	findTF = var_2

	var_1(var_2(arg_21_0._tf, "AD/right"), arg_21_0.mvIndex ~= arg_21_0.showItemNum)

	setActive = var_1
	findTF = var_2

	var_1(var_2(arg_21_0._tf, "AD/left"), arg_21_0.mvIndex ~= 1)
...
function var_0_1.OnUpdateFlush(arg_23_0)
	...
	if arg_23_0.dayTF then
		...
		var_1(var_23_0, var_1_10003(arg_23_0.nday))
	end
...
function var_0_1.updateMvUI(arg_24_0)
	...
	if arg_24_0.playHandle then
		...
		var_1(var_1_10002(arg_24_0.mvTf, "left"), false)

		setActive = var_1
		findTF = var_1_10002

		var_1(var_1_10002(arg_24_0.mvTf, "right"), false)
	else
		setActive = var_1
		findTF = var_1_10002

		var_1(var_1_10002(arg_24_0.mvTf, "left"), arg_24_0.showItemNum > 1)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_24_0.mvTf, "right"), arg_24_0.showItemNum > 1)
	end
	...
	for iter_24_0 = 1, var_0_2 do
		...
		var_1_10005(var_1_10006(arg_24_0.mvTf, "page/" .. iter_24_0 .. "/selected"), arg_24_0.mvIndex == iter_24_0)

		setActive = var_1_10005
		findTF = var_1_10006

		var_1_10005(var_1_10006(arg_24_0.mvTf, "page/" .. iter_24_0), iter_24_0 <= arg_24_0.showItemNum)
	end
...
function var_0_1.displayWindow(arg_25_0, arg_25_1)
	...
	if arg_25_1 then
		...
		local var_25_1 = var_3.height

		setSizeDelta = var_4
		findTF = var_1_10005

		local var_25_2 = var_1_10005(arg_25_0.mvTf, "bottom")

		Vector2 = var_6
		Screen = var_7

		local var_25_3 = var_7.width

		Screen = var_1_10008

		var_4(var_25_2, var_6(var_25_3, var_1_10008.height))
...
function var_0_1.loadMv(arg_29_0)
	...
	var_2.GetUI(var_29_1, var_29_0, true, function(arg_30_0)
		...
		local var_30_1 = var_2_10003(arg_29_0.mvGo, "video/cpk")

		typeof = var_4
		CriManaCpkUI = var_5
		var_30_0.mvManaCpkUI = var_2(var_30_1, var_4(var_5))
