...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1.make(var_2_2, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_3 = arg_3_2.Find(var_3_2, "Full")

			setFillAmount = var_3_2

			var_3_2(var_3_3, 1)

			setActive = var_3_2

			var_3_2(var_3_3, var_3 <= var_3_1)
		end
	...
	local function var_2_5()
		...
		pg = var_2_10003
		var_4_2.helps = var_2_10003.gametip.littleSpee_npc.tip
	...
	local function var_2_8()
		...
		var_5_1(var_5_0, var_5_2, var_2_10003.LEVEL)
	...
	local function var_2_17()
		...
		var_8_0(var_8_2, var_8_3 .. var_8_4)
		...
		var_8_6(var_8_5, var_3.GO_PERFORM_COMBAT, {
			stageId = var_8_1
		})
	...
	local function var_2_20()
		...
		var_9_0(var_9_2, var_9_3 .. var_9_4)
		...
		var_9_6(var_9_5, var_3.GO_PERFORM_COMBAT, {
			memory = true,
			stageId = var_9_1
		})
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	if var_10_1 == var_10_2 then
		...
		local var_10_8 = var_10_6.NewStoryMgr.GetInstance()
		local var_10_9 = var_5.IsPlayed(var_10_8, arg_10_0.storyName)

		setActive = var_10_8

		var_10_8(arg_10_0.performBtn, not var_10_9 and var_10_5)

		setActive = var_10_8

		var_10_8(arg_10_0.performReBtn, var_10_9)

		setActive = var_10_8

		var_10_8(arg_10_0.getFinalBtn, var_10_9 and var_10_5)

		setActive = var_10_8

		var_10_8(arg_10_0.gotFinalBtn, var_10_9 and not var_10_7)

		if not var_10_9 and var_10_5 then
			pg = var_10_8

			local var_10_10 = var_10_8.NewStoryMgr.GetInstance()

			var_10_8.Play(var_10_10, arg_10_0.activateStoryName)

			setActive = var_10_8

			var_10_8(arg_10_0.performBtn, true)

			setLocalScale = var_10_8

			local var_10_11 = arg_10_0.performImage

			Vector3 = var_8

			var_10_8(var_10_11, var_8.one)

			local var_10_12 = arg_10_0

			var_10_8 = arg_10_0.managedTween
			LeanTween = var_8

			var_10_8(var_10_12, var_8.scale, nil, arg_10_0.performImage, var_0_1.IMAGE_MAX_SCALE, var_0_1.IMAGE_ANI_TIME)
			...
			local var_10_14 = var_8.alphaCanvas
			local var_10_15
			...
			local var_10_17 = var_10_8(var_10_13, var_10_14, var_10_15, var_10(var_10_16, var_12(var_1_10013)), 1, var_0_1.IMAGE_ANI_TIME / 2)

			var_10_8.setFrom(var_10_17, 0)
			...
			var_10_8(var_10_18, var_8.delayedCall, function()
				local var_11_0 = arg_10_0
				local var_11_1 = var_0.managedTween

				LeanTween = var_2_10002

				local var_11_2 = var_2_10002.alphaCanvas
				local var_11_3

				GetOrAddComponent = var_2_10004
				...
				var_11_1(var_11_0, var_11_2, var_11_3, var_2_10004(var_11_4, var_2_10006(var_2_10007)), 0, var_0_1.IMAGE_ANI_TIME / 2)
			...
			var_10_8(arg_10_0.performText, var_0_1.TEXT_MAX_SCALE)
			...
			local var_10_20 = var_8.scale
			local var_10_21
			local var_10_22 = arg_10_0.performText

			Vector3 = var_11

			var_10_8(var_10_19, var_10_20, var_10_21, var_10_22, var_11.one, var_0_1.TEXT_ANI_TIME)
			...
			local var_10_27 = var_10_8(var_10_23, var_10_24, var_10_25, var_10_22(var_10_26, var_12(var_1_10013)), 1, var_0_1.TEXT_ANI_TIME)

			var_10_8.setFrom(var_10_27, 0)
		else
			setActive = var_10_8

			var_10_8(arg_10_0.performBtn, false)
		end
	end
...
function var_0_1.OnGetBtnClick(arg_12_0)
	...
	local var_12_3 = var_12_1(var_1_10004)
	local var_12_4 = var_3.getRawData(var_12_3)

	pg = var_12_3

	local var_12_5 = var_12_3.gameset.urpt_chapter_max.description[1]
	...
	if var_1_10006 then
		...
		var_1_10006 = var_1_10006.GetLimitCntById(var_1_10007, var_12_5)
	end

	Task = var_1_10007

	local var_12_6, var_12_7 = var_1_10007.StaticJudgeOverflow(var_12_4.gold, var_12_4.oil, var_1_10006, true, true, {
		{
			var_12_2.type,
			var_12_2.id,
			var_12_2.count
	...
	if var_12_6 then
		...
		var_9.insert(var_12_0, function(arg_13_0)
			...
			i18n = var_2_10004
			var_13_2.content = var_2_10004("award_max_warning")
			var_13_2.items = var_12_7
	...
	var_9.insert(var_12_0, function(arg_14_0)
		...
		local var_14_6 = var_5.value
		local var_14_7

		go = var_2_10007

		local var_14_8 = var_14_5(var_14_4, var_14_6, var_14_7, var_2_10007(var_14_3), 0, 1, var_0_1.FILL_ANI_TIME)
		...
		var_14_11(var_14_10, var_5.Action(function()
			arg_14_0()
