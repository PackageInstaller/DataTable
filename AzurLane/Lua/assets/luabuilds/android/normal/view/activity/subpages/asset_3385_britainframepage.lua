...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	var_5(var_6.Find(var_4_5, "background"), false)
	...
	var_4_6(var_6(arg_4_0.phases[1]), var_4_3, 0.4)
	...
	var_4_9(var_6.Find(var_4_10, "background"), true)
	...
	var_4_18(var_4_17, var_8.Action(function()
...
function var_0_1.UpdateAwardGot(arg_8_0)
	...
	var_8_4(var_8_5:Find("progress"), not var_8_3)

	setActive = var_8_4

	var_8_4(var_8_5:Find("step"), not var_8_3)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	if var_1_10006(arg_9_0.battleBtn) then
		var_9_5 = var_9_3
	end
	...
	if 1 <= var_9_9 then
		...
		if not var_9(var_9_7, "#487CFFFF") then
			var_9_11 = var_9_7
		end

		var_7(var_9_10, var_9_11)

		setText = var_7

		var_7(arg_9_0.progress, "/" .. var_9_8)

		setFillAmount = var_7

		var_7(arg_9_0.bar, var_9_7 / var_9_8)
