...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_1_0.resIcon = var_1_7(var_1_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_1_0.resNum = var_1_10(var_1_9, var_3(var_1_10004))
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.helpBtn, function()
		...
		pg = var_2_10003
		var_4_2.helps = var_2_10003.gametip.commission_event_tip.tip
	...
	var_1_10001(arg_3_0, arg_3_0.shopBtn, function()
		...
		local var_5_2 = var_2_10002.GO_SHOPS_LAYER
		local var_5_3 = {}

		NewShopsScene = var_2_10004
		var_5_3.warp = var_2_10004.TYPE_ACTIVITY
	...
	var_1_10001(arg_3_0, arg_3_0.eventBtn, function()
		...
		var_6_1(var_6_0, var_6_2, var_2_10003.EVENT)
	...
	local var_3_0 = var_1_10001(var_2)
	local var_3_1 = var_1.getData(var_3_0).id

	PlayerPrefs = var_3_0

	if var_3_0.GetInt("ACTIVITY_TYPE_EVENT_" .. arg_3_0.activity.id .. "_" .. var_3_1) == 0 then
		PlayerPrefs = var_2
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	local var_7_1 = var_2(var_1_10003)
