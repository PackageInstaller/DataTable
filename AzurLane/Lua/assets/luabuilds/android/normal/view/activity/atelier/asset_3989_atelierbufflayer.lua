...
function var_0_1.SetActivity(arg_2_0, arg_2_1)
	...
	AtelierMaterial = var_2_0

	local var_2_2 = var_2_0.bindConfigTable()

	_ = var_1_10004

	local var_2_3 = var_1_10004.map

	_ = var_1_10005
	arg_2_0.buffItems = var_2_3(var_1_10005.filter(var_2_2.all, function(arg_3_0)
...
function var_0_1.init(arg_5_0)
	...
	local var_5_2 = var_2.Find(var_5_1, "Items/List")
	local var_5_3 = var_2.GetChild(var_5_2, 0)
	local var_5_4 = var_2.Find(var_5_3, "Max/Text")

	i18n = var_5_3

	var_1(var_5_4, var_5_3("ryza_tip_control_buff_limit"))

	setText = var_1

	local var_5_5 = arg_5_0._tf
	local var_5_6 = var_2.Find(var_5_5, "Items/List")
	local var_5_7 = var_2.GetChild(var_5_6, 0)
	local var_5_8 = var_2.Find(var_5_7, "Min/Text")

	i18n = var_5_7

	var_1(var_5_8, var_5_7("ryza_tip_control_buff_not_obtain"))

	setText = var_1

	local var_5_9 = arg_5_0._tf
	local var_5_10 = var_2.Find(var_5_9, "Top/Tips")

	i18n = var_5_9

	var_1(var_5_10, var_5_9("ryza_tip_control"))

	setText = var_1

	local var_5_11 = arg_5_0._tf
	local var_5_12 = var_2.Find(var_5_11, "Effects/Total")

	i18n = var_5_11

	var_1(var_5_12, var_5_11("ryza_tip_control_buff"))
...
function var_0_1.didEnter(arg_7_0)
	...
	arg_7_0.buffItemTFs = var_7_0(var_2.Find(var_7_1, "Items/List"), #arg_7_0.buffItems)
	onButton = var_1

	local var_7_2 = arg_7_0
	local var_7_3 = arg_7_0._tf
	local var_7_4 = var_3.Find(var_7_3, "Top/Back")
	...
	var_1(var_7_2, var_7_4, var_7_5, var_5)

	onButton = var_1

	local var_7_6 = arg_7_0
	local var_7_7 = arg_7_0._tf
	local var_7_8 = var_3.Find(var_7_7, "Top/Home")
	...
	var_1(var_7_6, var_7_8, var_7_9, var_5)

	onButton = var_1

	local var_7_10 = arg_7_0
	local var_7_11 = arg_7_0._tf
	local var_7_12 = var_3.Find(var_7_11, "Top/Help")
	...
	local function var_7_13()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.ryza_control_help_tip.tip
	...
	var_1(var_7_10, var_7_12, var_7_13, var_5)
	...
	var_1.Foreach(arg_7_0.slotTfs, function(arg_11_0, arg_11_1)
		...
		var_2_10002(var_11_0, var_11_1, var_11_2, var_2_10006)
	...
	var_1.Foreach(arg_7_0.buffItemTFs, function(arg_13_0, arg_13_1)
		...
		local function var_13_2()
			...
			if not arg_7_0.contextData.selectIndex then
				...
				AtelierMaterialDetailMediator = var_3_10003

				var_14_2(var_14_1, var_3_10003.SHOW_DETAIL, var_14_0)
			...
			local function var_14_5(arg_15_0, arg_15_1)
				...
				if var_14_0.count < arg_15_1 then
					...
					var_15_1(var_15_0, var_4_10004("ryza_tip_control_buff_not_obtain_tip"))
				...
				var_15_4(var_15_3, var_4_10006.UPDATE_ATELIER_BUFF, var_2)
	...
	getProxy = var_3
	PlayerProxy = var_7_13

	local var_7_17 = var_3(var_7_13)

	if var_7_15(var_7_16 .. var_3.getRawData(var_7_17).id, 0) == 0 then
		triggerButton = var_1

		local var_7_18 = arg_7_0._tf

		var_1(var_2.Find(var_7_18, "Top/Help"))
		...
		local var_7_21 = var_7_18(var_4)

		var_7_19(var_7_20 .. var_3.getRawData(var_7_21).id, 1)
	end
...
function var_0_1.UpdateView(arg_17_0)
	...
	local var_17_2 = var_17_0.all(var_17_1, function(arg_18_0)
		return arg_18_0[1] > 0
	end)
	...
	var_3(var_4.Find(var_17_3, "Panel/Full"), var_17_2)

	arg_17_0.slotFull = var_17_2
	table = var_3

	var_3.Foreach(arg_17_0.slotTfs, function(arg_19_0, arg_19_1)
	...
	var_4.Foreach(arg_17_0.buffItems, function(arg_20_0, arg_20_1)
		...
		local var_20_2 = arg_20_1.GetBuffs(var_20_1)

		_ = var_20_1

		local var_20_3 = var_20_1.detect(var_17_1, function(arg_21_0)
		...
		local var_20_5 = var_20_3 and var_20_4 <= var_20_3[2]
		local var_20_6 = arg_20_1.count == 0 or var_20_3 and var_20_4 > var_20_3[2] and var_20_3[2] == arg_20_1.count

		if var_20_3 then
			::label_20_0::

			table = var_2_10008
			var_2_10008 = var_2_10008.indexof(var_17_1, var_20_3) == arg_17_0.contextData.selectIndex
		end

		local var_20_7

		if var_17_4 then
			var_20_7 = not var_20_5 and var_20_3 and not var_2_10008
		end

		local var_20_8

		if var_17_4 then
			var_20_8 = not var_20_3 and not var_20_6
		end

		if not var_20_6 then
			if var_17_4 then
				if not var_20_8 or var_17_4[1] ~= 0 then
					local var_20_9

					if var_2_10008 then
						::label_20_1::

						if not (var_20_4 > var_20_3[2]) then
							var_20_9 = false
					...
					if var_20_6 then
						...
						local var_20_11 = var_20_0
						local var_20_12 = var_20_0.Find(var_20_11, "Min/Text")

						i18n = var_20_11

						var_2_10013(var_20_12, var_20_11("ryza_tip_control_buff_not_obtain"))
					elseif var_20_7 then
						...
						local var_20_13 = var_20_0
						local var_20_14 = var_20_0.Find(var_20_13, "Min/Text")

						i18n = var_20_13

						var_2_10013(var_20_14, var_20_13("ryza_tip_control_buff_already_active_tip"))
					end

					setActive = var_2_10013

					var_2_10013(var_20_0:Find("Avaliable"), var_20_10)

					if var_20_9 then
						setText = var_2_10013

						local var_20_15 = var_20_0
						local var_20_16 = var_20_0.Find(var_20_15, "Avaliable/Text")

						i18n = var_20_15

						var_2_10013(var_20_16, var_20_15("ryza_tip_control_buff_upgrade"))
					elseif var_20_8 then
						setText = var_2_10013

						local var_20_17 = var_20_0
						local var_20_18 = var_20_0.Find(var_20_17, "Avaliable/Text")

						i18n = var_20_17

						var_2_10013(var_20_18, var_20_17("ryza_tip_control_buff_replace"))
					end

					setActive = var_2_10013

					var_2_10013(var_20_0:Find("Max"), var_20_5)

					setScrollText = var_2_10013

					var_2_10013(var_20_0:Find("Name/Text"), arg_20_1:GetName())

					local var_20_19 = arg_20_1.count

					if var_20_3 then
						var_20_19 = var_20_19 - var_20_3[2]
					end

					updateDrop = var_14

					local var_20_20 = var_20_0:Find("Icon")
					local var_20_21 = {}

					DROP_TYPE_RYZA_DROP = var_17
					var_20_21.type = var_17
					var_20_21.id = arg_20_1:GetConfigID()
					var_20_21.count = var_20_19

					var_14(var_20_20, var_20_21)
	...
	local var_17_5 = var_4.map(var_17_1, function(arg_22_0)
		...
		local var_22_3 = var_2[var_22_2.min(#var_2, arg_22_0[2])]

		CommonBuff = var_4

		local var_22_4 = var_4.New({
			id = var_22_3
		})
...
function var_0_1.UpdateSlot(arg_24_0, arg_24_1, arg_24_2)
	...
	if var_24_4 then
		...
		var_10(arg_24_1:Find("Avaliable/Selecting"), var_24_3)

		setActive = var_10

		var_10(arg_24_1:Find("Avaliable/Item"), var_24_1 > 0)

		setActive = var_10

		var_10(arg_24_1:Find("Avaliable/Image"), var_24_1 == 0)

		if 0 < var_24_1 then
			AtelierMaterial = var_10

			local var_24_6 = var_10.New({
				configId = var_24_1
			})

			var_24_5 = #var_10.GetBuffs(var_24_6) == var_24_2

			local var_24_7 = var_10
			local var_24_8 = var_10.GetBuffs(var_24_7)

			math = var_24_7

			local var_24_9 = var_24_8[var_24_7.min(#var_10:GetBuffs(), var_24_2)]

			CommonBuff = var_12

			local var_24_10 = var_12.New({
				id = var_24_9
			})
			local var_24_11 = arg_24_0.loader

			var_13.GetSpriteQuiet(var_24_11, var_24_10:getConfig("icon"), "", arg_24_1:Find("Avaliable/Item/Image"))

			setText = var_13

			var_13(arg_24_1:Find("Avaliable/Item/Name/Text"), var_24_10:getConfig("name"))
		end
	end

	setActive = var_10

	var_10(arg_24_1:Find("Link/3"), var_24_5)

	setActive = var_10

	var_10(arg_24_1:Find("Link/1"), not var_24_5 and var_24_2 > 0)
...
function var_0_1.PlayLevelUpAnim(arg_26_0)
	...
	local var_26_1 = var_1.Find(var_26_0, "Avaliable/LevelUp/Image")

	setActive = var_26_0

	var_26_0(var_26_1.parent, true)
	...
	local var_26_3 = var_4.value

	go = var_5

	local var_26_4 = var_26_3(var_5(var_1), 0, 2, 2)
	local var_26_5 = var_4.setOnUpdate

	System = var_6

	local var_26_6 = var_26_5(var_26_4, var_6.Action_float(function(arg_27_0)
		math = var_2_10001
		arg_27_0 = var_2_10001.clamp(arg_27_0, 0, 1)
		setImageAlpha = var_1

		var_1(var_26_1, arg_27_0)
	...
	local var_26_7 = var_4.setOnComplete

	System = var_6
	arg_26_0.tweenId = var_26_7(var_26_6, var_6.Action(function()
		setAnchoredPosition = var_2_10000

		var_2_10000(var_26_1, {
			y = var_26_2
		})

		setActive = var_2_10000

		var_2_10000(var_26_1.parent, false)
