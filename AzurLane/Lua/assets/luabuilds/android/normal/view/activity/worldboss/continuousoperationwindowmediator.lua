...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.CONTINUOUS_OPERATION, function(arg_2_0)
		...
		local var_2_3 = var_3.AUTO_BOT
		local var_2_4 = {
			isActiveBot = false
		}

		SYSTEM_ACT_BOSS = var_2_10005
		var_2_4.system = var_2_10005
		...
		local var_2_10 = var_4.AUTO_SUB
		local var_2_11 = {
			isActiveSub = false
		}

		SYSTEM_ACT_BOSS = var_2_10006
		var_2_11.system = var_2_10006
		...
		math = var_6
		var_2_15.battleTimes = var_6.min(arg_1_0.contextData.battleTimes, 15)
	...
	local var_1_4 = var_1_3(var_1_2, var_3.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2)
