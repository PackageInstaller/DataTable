...
function var_0_1.InitFacilityCross(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	local var_5_1 = arg_5_1:Find(arg_5_3)
	local var_5_2 = arg_5_4

	SFX_PANEL = var_9

	var_1_10005(var_5_0, var_5_1, var_5_2, var_9)

	onButton = var_1_10005

	local var_5_3 = arg_5_0
	local var_5_4 = arg_5_2:Find(arg_5_3)
	local var_5_5 = arg_5_4

	SFX_PANEL = var_9

	var_1_10005(var_5_3, var_5_4, var_5_5, var_9)
...
function var_0_1.getStudents(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = var_1_10004(var_1_10005)
	...
	if var_5.getConfig(var_6_2, "config_client") then
		var_6_3 = var_6_3.ships
	end
	...
	if var_6_3 then
		...
		local var_6_5 = var_7.random(arg_6_1, arg_6_2)
		local var_6_6 = #var_6_4

		while var_6_5 > 0 and 0 < var_6_6 do
			math = var_6_7

			local var_6_7 = var_6_7.random(1, var_6_6)

			table = var_10

			var_10.insert(var_6_0, var_6_4[var_6_7])

			var_6_4[var_6_7] = var_6_4[var_6_6]
			var_6_6 = var_6_6 - 1
			var_6_5 = var_6_5 - 1
		end
	end
	...
	for iter_7_2, iter_7_3 in var_8(var_7_0) do
		if not arg_7_0.academyStudents[iter_7_2] then
			...
			var_15:SetOnTransEdge(function(arg_8_0, arg_8_1, arg_8_2)
				...
				math = var_4
				arg_8_2 = var_4.max(arg_8_1, arg_8_2)
				arg_8_1 = var_8_0
...
function var_0_1.ChooseRandomPos(arg_10_0, arg_10_1)
	...
	var_3.Tool.Swap(arg_10_0, var_2, arg_10_1)
	...
	for iter_11_0, iter_11_1 in var_1_10002(var_11_0) do
		if iter_11_1.childCount > 1 then
			...
			for iter_11_2 = 1, iter_11_1.childCount do
				...
				local var_11_3 = iter_11_1.GetChild(var_11_2, iter_11_2 - 1)

				table = var_11_2

				var_11_2.insert(var_11_1, {
					tf = var_11_3,
					index = iter_11_2
				})
			end
			...
			for iter_11_3, iter_11_4 in var_8(var_11_1) do
				local var_11_4 = iter_11_4.tf

				var_13.SetSiblingIndex(var_11_4, iter_11_3 - 1)
			end
		end
	end
...
function var_0_1.IsMiniActNeedTip(arg_15_0)
	...
	return var_15_0.IsActivityReady(var_15_1)
end
...
function var_0_1.BindItemActivityShop(arg_17_0)
	arg_17_0:InitFacilityCross(arg_17_0._map, arg_17_0._upper, "bujishangdian", function()
		...
		local var_18_3 = var_2_10003.SHOP
		local var_18_4 = {}

		NewShopsScene = var_2_10005
		var_18_4.warp = var_2_10005.TYPE_ACTIVITY
...
function var_0_1.BindItemSkinShop(arg_19_0)
	arg_19_0:InitFacilityCross(arg_19_0._map, arg_19_0._upper, "huanzhuangshangdian", function()
		...
		local var_20_2 = var_2_10002.GO_SCENE

		SCENE = var_2_10003

		var_20_1(var_20_0, var_20_2, var_2_10003.SKINSHOP)
...
function var_0_1.BindItemBuildShip(arg_21_0)
	arg_21_0:InitFacilityCross(arg_21_0._map, arg_21_0._upper, "xianshijianzao", function()
		...
		local var_22_3 = var_22_2(var_22_1, var_2_10003.ACTIVITY_TYPE_BUILDSHIP_1)

		getProxy = var_22_1
		ActivityProxy = var_3

		local var_22_4 = var_22_1(var_3)
		local var_22_5 = var_2.getActivityByType

		ActivityConst = var_2_10004

		local var_22_6 = var_22_5(var_22_4, var_2_10004.ACTIVITY_TYPE_BUILD)

		if var_22_3 and not var_22_3:isEnd() then
			BuildShipScene = var_22_4
			var_22_0 = var_22_4.PROJECTS.ACTIVITY
		else
			if var_22_6 then
				local var_22_7 = var_22_6

				if not var_22_6.isEnd(var_22_7) then
					var_22_4 = {}
					BuildShipScene = var_22_7
					var_22_4[1] = var_22_7.PROJECTS.SPECIAL
					BuildShipScene = var_4
					var_22_4[2] = var_4.PROJECTS.LIGHT
					BuildShipScene = var_4
					var_22_4[3] = var_4.PROJECTS.HEAVY
					var_2_10005 = var_22_6
					var_22_0 = var_22_4[var_22_6.getConfig(var_2_10005, "config_client").id]
			...
			local var_22_8 = var_22_4.TipsMgr.GetInstance()
			local var_22_9 = var_3.ShowTips

			i18n = var_2_10005

			var_22_9(var_22_8, var_2_10005("common_activity_end"))
		...
		local var_22_10 = arg_21_0
		local var_22_11 = var_3.emit

		BackHillMediatorTemplate = var_2_10005

		local var_22_12 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		local var_22_13 = var_2_10006.GETBOAT
		local var_22_14 = {}

		BuildShipScene = var_2_10008
		var_22_14.page = var_2_10008.PAGE_BUILD
		var_22_14.projectName = var_22_0

		var_22_11(var_22_10, var_22_12, var_22_13, var_22_14)
...
function var_0_1.BindItemBattle(arg_23_0)
	arg_23_0:InitFacilityCross(arg_23_0._map, arg_23_0._upper, "tebiezuozhan", function()
		...
		if var_24_1 then
			...
			if not var_2_10003.isUnlock(var_24_3) then
				pg = var_2_10003
				...
				var_24_5(var_24_4, var_2_10005("common_activity_end"))
			else
				...
				local var_24_8 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_24_7(var_24_6, var_24_8, var_2_10006.LEVEL, {
					chapterId = var_24_2,
					mapIdx = var_24_1
				})
			end
...
function var_0_1.UpdateBuildingTip(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_1 = arg_25_1.GetBuildingLevel(var_25_0, arg_25_2)

	pg = var_25_0

	if not var_25_0.activity_event_building[arg_25_2] or var_25_1 >= #var_4.buff then
		return false
	end

	local var_25_2 = var_4.material[var_25_1]

	_ = var_1_10006

	return var_1_10006.all(var_25_2, function(arg_26_0)
		...
		if var_26_0 == var_2_10005 then
			...
			Item = var_2_10006
			var_2_10005 = var_2_10005(var_2_10006.getConfigData(var_26_1), "link_id")
			assert = var_2_10006
			...
			if var_2_10005 < var_26_0 then
				...
				local var_26_5 = var_2_10005(var_2_10006.activity_drop_type[var_26_0], "activity_id")
