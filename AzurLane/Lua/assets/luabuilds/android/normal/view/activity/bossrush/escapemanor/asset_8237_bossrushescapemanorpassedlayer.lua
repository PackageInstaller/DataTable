...
function var_0_1.didEnter(arg_2_0)
	...
	var_2_0(var_3.Find(var_2_2, "Main"), function(arg_3_0, arg_3_1)
		...
		if not var_2_1[arg_3_0.name] then
			...
			tostring = var_5
			BossRushEscapeManorPassedLayer = var_2_10006
	...
	var_4({
		...
		local var_8_4 = var_3.GetChild(var_8_3, var_8_0 - 1)

		var_8_2(var_3.Find(var_8_4, "left"), -1)

		if var_8_0 > 1 then
			local var_8_5 = var_2_3
			local var_8_6 = arg_2_0.rtContent
			local var_8_7 = var_3.GetChild(var_8_6, var_8_0 - 2)

			var_8_5(var_3.Find(var_8_7, "right"), -1)
		end
		...
		local function var_8_8()
			...
			var_3_10000({
				...
				ChallengePassedCombatLoadMediator = var_4_10002

				var_11_1(var_11_0, var_4_10002.FINISH, arg_2_0._loadObs)
...
function var_0_1.combatPreload(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10005(var_12_3) do
