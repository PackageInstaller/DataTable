...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_6 = var_4(arg_1_0._charTpl, "got/img/text")

	i18n = var_5

	var_3(var_1_6, var_5("word_got"))
...
function var_0_0.updateSelect(arg_6_0)
	...
	local var_6_1 = var_2(arg_6_0._tf, "ad/title/text")

	i18n = var_3

	var_1(var_6_1, var_3(var_0_1))
...
function var_0_0.setItemData(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_7_0.type == 1 then
		...
		local var_7_4 = var_7.gsub

		var_7_5 = var_7_0.guardian_gain_desc

		local var_7_6 = "$1"

		math = var_1_10010
		var_7_2 = var_7_4(var_7_5, var_7_6, var_1_10010.min(var_7_1:getFetchCount(), var_7_0.guardian_gain[2]))
	...
	if var_7_0.type == 2 then
		setText = var_7
		findTF = var_7_5
		var_7_5 = var_7_5(arg_7_1, "desc/text")

		local var_7_7

		if not var_7_3 or not var_7_0.guardian_desc then
			var_7_7 = "???"
		end

		var_7(var_7_5, var_7_7)

		setText = var_7
		findTF = var_7_5
		var_7_5 = var_7_5(arg_7_1, "name/text")

		local var_7_8

		if not var_7_3 or not var_7_0.guardian_name then
			var_7_8 = "???"
		end

		var_7(var_7_5, var_7_8)
	else
		setText = var_7
		findTF = var_7_5

		var_7(var_7_5(arg_7_1, "name/text"), var_7_0.guardian_name)

		setText = var_7
		findTF = var_7_5

		var_7(var_7_5(arg_7_1, "desc/text"), var_7_0.guardian_desc)
	end

	PLATFORM_CODE = var_7
	PLATFORM_CH = var_7_5

	if var_7 ~= var_7_5 then
		GetComponent = var_7
		findTF = var_7_5
		var_7_5 = var_7_5(arg_7_1, "name/text")
		typeof = var_9
		...
		local var_7_9 = var_7(var_7_5, var_9(var_10))

		var_7_9.fontSize = 30
		GetComponent = var_7_9
		findTF = var_7_5
		var_7_5 = var_7_5(arg_7_1, "desc/text")
		typeof = var_9
		Text = var_10
		var_7_9(var_7_5, var_9(var_10)).fontSize = 24
	end
	...
	if var_7_0.type == 2 then
		...
		var_7(var_7_5(arg_7_1, "icon/mask/img"), var_7_3)
	end

	LoadImageSpriteAsync = var_7

	local var_7_10 = "shipyardicon/" .. var_7_0.guardian_painting

	findTF = var_9

	var_7(var_7_10, var_9(arg_7_1, "icon/mask/img"), true)

	setText = var_7
	findTF = var_7_10

	var_7(var_7_10(arg_7_1, "tip/text"), var_7_2)

	setActive = var_7
	findTF = var_8

	var_7(var_8(arg_7_1, "icon/lock"), not var_7_3)

	setActive = var_7
	findTF = var_8

	var_7(var_8(arg_7_1, "got"), var_7_3)
...
function var_0_0.updateItemsCount(arg_8_0, arg_8_1)
	...
	for iter_8_0 = 1, var_8_0 do
		...
		var_1_10007 = var_1_10007(var_1_10008(arg_8_0._charTpl))
