...
function var_0_1.init(arg_2_0, ...)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			elseif not arg_2_0.pageDic[var_3.id] then
				...
				if arg_2_0.pageDic[var_3.id] ~= nil then
					...
					var_5(var_3_4, var_3_5, var_3_6, var_2_10009)
				end
			end
		end
	...
	pg = var_4
	arg_2_0.camEventId = var_2_4(var_2_3, var_4.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_6_0, arg_6_1)
	...
	local var_2_7 = var_4.Find(var_2_6, "adapt/TopPage/top/btn_back")
	...
	var_2(var_2_5, var_2_7, var_2_8, var_6)
