...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.seriesNodes = var_2_7(var_2_8(var_3.Find(var_2_9, "Battle/Nodes").childCount), function(arg_3_0)
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_2 = var_3.Find(var_6_1, "top/back")
	...
	local var_6_6 = var_3.Find(var_6_5, "top/home")
	...
	local function var_6_10()
		...
		BossRushAlvitMediator = var_2_10002

		var_9_1(var_9_0, var_2_10002.ON_EXTRA_RANK)
	...
	var_1_10001(var_6_8, var_6_9, var_6_10, var_5)
	...
	var_1_10001(var_6_11, var_6_12, var_6_13, var_5)
	...
	var_1_10001(var_6_14, var_6_15, var_6_16, var_5)

	onButton = var_1_10001

	local var_6_17 = arg_6_0
	local var_6_18 = arg_6_0._tf
	local var_6_19 = var_3.Find(var_6_18, "Battle/Story")
	...
	var_1_10001(var_6_17, var_6_19, var_6_20, var_5)

	onButton = var_1_10001

	local var_6_21 = arg_6_0
	local var_6_22 = arg_6_0._tf
	local var_6_23 = var_3.Find(var_6_22, "Story/Battle")
	...
	var_1_10001(var_6_21, var_6_23, var_6_24, var_5)
...
function var_0_1.UpdateView(arg_17_0)
	...
	var_2(var_3.Find(var_17_1, "Battle"), var_17_0)

	setActive = var_2

	local var_17_2 = arg_17_0._tf

	var_2(var_3.Find(var_17_2, "Story"), not var_17_0)
	...
	arg_17_0:addbubbleMsgBoxList({
		...
		function(arg_19_0)
			...
			if var_19_0(var_2_10002.values(arg_17_0.storyNodesDict), function(arg_20_0)
...
function var_0_1.UpdateBattle(arg_22_0)
	...
	var_22_0.Foreach(arg_22_0.seriesNodes, function(arg_23_0, arg_23_1)
		...
		local var_23_3 = var_3
		local var_23_4 = var_3.GetType(var_23_3)

		BossRushSeriesData = var_23_3

		local var_23_5 = var_23_4 == var_23_3.TYPE.SP
		local var_23_6 = true
		...
		if var_23_5 then
			...
			if not var_7.GetUsedBonus(var_2_10008)[arg_23_0] then
				var_23_7 = 0
			end

			local var_23_8 = var_3

			var_2_10008 = var_3.GetMaxBonusCount(var_23_8)
			setText = var_23_8
			...
			local var_23_11 = var_23_9("series_enemy_SP_count")

			math = var_12

			var_23_8(var_23_10, var_23_11 .. var_12.max(0, var_2_10008 - var_23_7) .. "/" .. var_2_10008)

			var_23_6 = var_2_10008 - var_23_7 > 0
		end
		...
		local function var_23_12()
			if not var_23_2 then
				...
				BossRushSeriesData = var_24_0

				local var_24_2 = var_24_0.New({
					id = var_24_1
				})

				pg = var_3_10002

				local var_24_3 = var_3_10002.TipsMgr.GetInstance()

				var_3_10002 = var_3_10002.ShowTips
				i18n = var_3_10004

				var_3_10002(var_24_3, var_3_10004("series_enemy_unlock", var_24_2:GetName()))
			...
			if not var_23_6 then
				...
				local var_24_4 = var_0.TipsMgr.GetInstance()
				local var_24_5 = var_0.ShowTips

				i18n = var_3_10002

				var_24_5(var_24_4, var_3_10002("series_enemy_SP_error"))

				return
			end

			local var_24_6 = arg_22_0
			local var_24_7 = var_0.emit

			BossRushAlvitMediator = var_3_10002

			var_24_7(var_24_6, var_3_10002.ON_FLEET_SELECT, var_0)
		...
		local var_23_14 = arg_23_1:Find("icon")
		...
		var_2_10008(var_23_13, var_23_14, var_23_15, var_12)

		onButton = var_2_10008

		local var_23_16 = arg_22_0
		local var_23_17 = arg_23_1:Find("text")
		...
		var_2_10008(var_23_16, var_23_17, var_23_18, var_12)
	...
	var_3(var_22_2, var_5.IsActivityReady(arg_22_0.ptActivity))

	setActive = var_3

	local var_22_3 = arg_22_0._tf
	local var_22_4 = var_4.Find(var_22_3, "Battle/Story/new")
	local var_22_6

	if arg_22_0.storyTask then
		local var_22_5 = arg_22_0.storyTask

		var_22_6 = var_5.getTaskStatus(var_22_5) ~= 2
	end
...
function var_0_1.UpdateStory(arg_27_0)
	...
	var_1_10004.Foreach(arg_27_0.storyNodesDict, function(arg_28_0, arg_28_1)
		...
		if arg_28_1.IsActive(var_28_3, arg_27_0.activity, arg_27_0.ptActivity) then
			...
			if not var_28_2 then
				...
				var_28_3 = var_28_1.GetComponent
				typeof = var_7
				Animation = var_2_10008

				local var_28_5 = var_28_3(var_28_4, var_7(var_2_10008))

				var_28_3.Play(var_28_5, "anim_kinder_bossrush_story_tip")
			end
		else
			setActive = var_28_3

			var_28_3(var_28_1, false)
		end

		setText = var_28_3

		var_28_3(var_28_1:Find("main/Text"), arg_28_1:GetName())

		local var_28_6 = arg_28_1
		local var_28_7 = arg_28_1.GetType(var_28_6)

		BossRushStoryNode = var_28_6

		if var_28_7 == var_28_6.NODE_TYPE.NORMAL then
			setActive = var_6
	...
	var_4(var_27_3, var_6(arg_27_0.storyTask))
	...
	if arg_27_0.storyTask then
		...
		var_6(var_7.GetChild(var_27_7, 0), var_27_6)
		...
		var_27_8(var_8.Find(var_27_10, "get"), var_27_9 == 1)

		setActive = var_27_8

		local var_27_11 = arg_27_0.storyAward

		var_27_8(var_8.Find(var_27_11, "got"), var_27_9 == 2)

		if var_27_9 == 1 then
			local var_27_12 = arg_27_0

			var_27_8 = arg_27_0.emit
			BossRushAlvitMediator = var_9

			var_27_8(var_27_12, var_9.ON_TASK_SUBMIT, arg_27_0.storyTask)
		end

		onButton = var_27_8

		var_27_8(arg_27_0, arg_27_0.storyAward, function()
			local var_31_0 = arg_27_0
			local var_31_1 = var_0.emit

			BaseUI = var_2_10002

			var_31_1(var_31_0, var_2_10002.ON_DROP, var_27_6)
	...
	var_32_0({
		function(arg_33_0)
			...
			if var_1(arg_32_1) and var_1 > 0 then
				...
				BossRushAlvitMediator = var_2_10004

				var_33_1(var_33_0, var_2_10004.ON_PERFORM_COMBAT, var_1)
			else
...
function var_0_1.UpdateTaskTip(arg_36_0)
	...
	local var_36_1 = var_1_10003.IsActivityReady

	getProxy = var_1_10004
	ActivityProxy = var_1_10005

	local var_36_2 = var_1_10004(var_1_10005)
	local var_36_3 = var_4.getActivityById

	ActivityConst = var_1_10006

	var_1_10001(var_36_0, var_36_1(var_36_3(var_36_2, var_1_10006.ALVIT_TASK_ACT_ID)))
...
function var_0_1.onBackPressed(arg_42_0)
	...
	BossRushAlvitMediator = var_1_10003

	local var_42_2 = var_1_10003.GO_SCENE

	SCENE = var_1_10004

	var_42_1(var_42_0, var_42_2, var_1_10004.KINDERGARTEN, {
		isBack = true
	})
