...
local var_0_0 = "IJNUranamiPileGamePage"
...
function var_0_1.FlushMarks(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10005(arg_5_0.markTrs) do
		...
		var_1_10010(iter_5_1:Find("finish"), iter_5_0 <= var_2)
	end
...
function var_0_1.FlushIndex(arg_6_0, arg_6_1)
	...
	if var_6_0 > 0 then
		...
		local var_6_2 = var_6_1[var_4.min(var_6_0, #arg_6_0.markTrs)]
		...
		Vector3 = var_6
		var_6_5.localPosition = var_6(var_6_4.x, var_6_4.y, 0)
	end
