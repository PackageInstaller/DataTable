...
function var_0_0.TrPosition2LocalPos(arg_1_0, arg_1_1, arg_1_2)
	if arg_1_0 == arg_1_1 then
		...
		local var_1_2 = arg_1_1.InverseTransformPoint(var_1_1, var_1_0)

		Vector3 = var_1_1

		return var_1_1(var_1_2.x, var_1_2.y, 0)
	end
...
function var_0_0.GetRect(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_1 = var_4(arg_2_0.x + arg_2_1 * 0.5, arg_2_0.y + arg_2_2 * 0.5)
