...
function var_0_0.SetUp(arg_3_0, arg_3_1)
	...
	var_1_10002({
		...
		function(arg_5_0)
			...
			var_5_1(var_5_0, var_2_10003.OPEN_DOOR_VOICE)
		...
		function(arg_6_0)
			...
			var_6_1(var_6_0, var_2_10003.STORYID, arg_6_0)
...
function var_0_0.UpdateProgress(arg_10_0, arg_10_1)
	...
	if var_10_7 < var_10_6 and var_10_6 ~= #var_10_5 then
		...
		var_10_9(var_10_8, var_1_10008.INCREASE_PASSWORD_PROGRESS_VOICE)
	end
		...
		var_1_10004({
			function(arg_17_0)
				if not arg_12_0.isIniting then
					...
					var_17_1(var_17_0, var_2_10003.SWITCH_MAP_VOCIE)
				end
			...
			function(arg_18_0)
				...
				var_18_1(var_18_0, var_2_10003.SCAN_MAP_VOICE)
...
function var_0_0.EnterPassWord(arg_21_0, arg_21_1)
	...
	if var_2.CheckIndex(var_21_2, arg_21_1) then
		...
		var_21_6.OnRightCode(var_21_8, arg_21_1, var_21_7, var_21_5)

		local var_21_9 = arg_21_0.model

		if var_21_6.IsSuccess(var_21_9) then
			local var_21_10 = arg_21_0.model

			var_21_6.Finish(var_21_10)

			local var_21_11 = arg_21_0

			var_21_6 = arg_21_0.PlayVoice
			DecodeGameConst = var_6

			var_21_6(var_21_11, var_6.GET_AWARD_DONE_VOICE)

			local var_21_12 = arg_21_0.view

			var_21_6.OnSuccess(var_21_12, function()
				pg = var_2_10000
				...
				var_22_1(var_22_0, var_2_10002.LAST_STORYID)
			...
			var_21_6(var_21_13, var_6.PASSWORD_IS_RIGHT_VOICE)
		end
		...
		var_21_15(var_21_14, var_21_6.PASSWORD_IS_FALSE_VOICE)

		local var_21_16 = arg_21_0.view

		var_2.OnFalseCode(var_21_16, arg_21_1)
	end
			...
			var_2({
				...
				function(arg_26_0)
					...
					if var_1.IsUnlockMap(var_26_1, arg_23_0.model.map.id) then
						...
						var_26_4(var_26_3, var_3.INCREASE_PROGRESS_VOICE)
...
function var_0_0.PlayStory(arg_27_0, arg_27_1)
	...
	DecodeGameConst = var_27_0

	if var_27_0.UNLOCK_STORYID[var_27_1] then
		pg = var_1_10004

		local var_27_2 = var_1_10004.NewStoryMgr.GetInstance()
...
function var_0_0.RepairMap(arg_28_0)
	...
	var_1_10001({
		...
		function(arg_31_0)
			...
			var_31_1(var_31_0, var_2_10003.INCREASE_PROGRESS_VOICE)
		...
		function(arg_32_0)
			...
			DecodeGameConst = var_32_0

			if var_32_1 == var_32_0.MAX_MAP_COUNT then
...
function var_0_0.ExitDeCodeMap(arg_35_0)
	...
	var_1({
		function(arg_36_0)
			...
			var_36_1(var_36_0, var_2_10003.PRESS_UP_PASSWORDBTN)
...
function var_0_0.EnterDecodeMap(arg_41_0)
	...
	var_1({
		function(arg_42_0)
			...
			var_42_1(var_42_0, var_2_10003.PRESS_DOWN_PASSWORDBTN)
