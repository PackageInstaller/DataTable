...
function var_0_1.updateSwitchBtnTF(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10001(arg_23_0.switchBtnList) do
		...
		if arg_23_0.caculateActivatable(var_23_1, iter_23_0) == 0 or iter_23_0 == arg_23_0.curPage then
			setActive = var_23_1
...
function var_0_1.updateAfterSubmit(arg_24_0, arg_24_1)
	...
	arg_24_0.activityData = var_24_1(var_24_0, var_1_10004.DOA_MEDAL_ACT_ID)
