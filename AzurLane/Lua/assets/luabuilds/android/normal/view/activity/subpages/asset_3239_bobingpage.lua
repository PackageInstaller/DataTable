...
function var_0_1.OnInit(arg_1_0)
	...
	if var_1_10001 ~= var_1_10002 then
		...
		if var_1_10001 == var_1_10002 then
			...
			var_1_10001(var_1_10002(arg_1_0._tf, "bobing"), true)

			setActive = var_1_10001
			findTF = var_1_10002

			var_1_10001(var_1_10002(arg_1_0._tf, "lottery"), false)
		else
			setActive = var_1_10001
			findTF = var_1_10002

			var_1_10001(var_1_10002(arg_1_0._tf, "bobing"), false)

			setActive = var_1_10001
			findTF = var_2

			var_1_10001(var_2(arg_1_0._tf, "lottery"), true)
		end
		...
		var_1_1(var_1_0, var_1_10003.ON_BOBING_RESULT, function(arg_2_0, arg_2_1, arg_2_2)
...
function var_0_1.lotteryUpdate(arg_6_0)
	...
	if var_6_0:getConfig("config_id") <= var_6_0.data1 then
		...
		var_5(var_6(var_6_2.phase, "bg"), false)

		setActive = var_5
		findTF = var_6

		var_5(var_6(var_6_2.phase, "Text"), false)

		setActive = var_5
		findTF = var_6

		var_5(var_6(var_6_2.phase, "finish"), true)
	else
		setActive = var_5
		findTF = var_6

		var_5(var_6(var_6_2.phase, "bg"), true)

		setActive = var_5
		findTF = var_6

		var_5(var_6(var_6_2.phase, "Text"), true)

		setText = var_5
		findTF = var_6

		local var_6_3 = var_6(var_6_2.phase, "Text")

		setColorStr = var_1_10007

		var_5(var_6_3, var_1_10007(var_6_0.data1, "FFD43F") .. "/" .. var_4)
	...
	if var_6_0.data2 < 1 then
		LeanTween = var_5
		var_6_4 = var_5.alpha(var_6_2.btnLotteryBtn, 1, 1)
		...
		onButton = var_5
		var_6_4 = arg_6_0
		var_1_10007 = var_6_2.btnLotteryBtn
		...
		local function var_6_5()
			if arg_6_0.activity.data2 < 1 then
				...
				var_7_1(var_7_0, var_2_10002.EVENT_OPERATION, {
					cmd = 1,
				...
				var_7_3(var_7_2, var_2.LOCK_ACT_MAIN, true)
			end
		...
		var_5(var_6_4, var_1_10007, var_6_5, var_1_10009)
	else
		LeanTween = var_5
		...
		var_5(var_6_4(var_6_2.btnLotteryBtn, "mask"), true)

		var_6_4 = arg_6_0

		local var_6_6 = arg_6_0.getIndexByNumbers(var_6_4, var_6_0.data1_list)

		setActive = var_6_4
		findTF = var_1_10007

		var_6_4(var_1_10007(var_6_2.btnLotteryBtn, "mask/1"), var_6_6 == 1)

		setActive = var_6_4
		findTF = var_1_10007

		var_6_4(var_1_10007(var_6_2.btnLotteryBtn, "mask/2"), var_6_6 == 2)

		setActive = var_6_4
		findTF = var_1_10007

		var_6_4(var_1_10007(var_6_2.btnLotteryBtn, "mask/3"), var_6_6 == 3)

		onButton = var_6_4
		var_1_10007 = arg_6_0

		local var_6_7 = var_6_2.btnLotteryBtn
		...
		local function var_6_8()
			if arg_6_0.activity.data2 < 1 then
				...
				var_8_1(var_8_0, var_2_10002.EVENT_OPERATION, {
					cmd = 1,
					activity_id = arg_6_0.activity.id
				})
				...
				var_8_3(var_8_2, var_2.LOCK_ACT_MAIN, true)
			end
		...
		var_6_4(var_1_10007, var_6_7, var_6_8, var_1_10010)
	end

	local var_6_9 = var_6_0.data2 == 0 and "FFD43F" or "d2d4db"

	setText = var_6_4
	findTF = var_1_10007

	local var_6_10 = var_1_10007(var_6_2.nums, "text")

	string = var_8

	var_6_4(var_6_10, var_8.format("<color=#%s>%s</color> / %s", var_6_9, 1 - var_6_0.data2, 1))
...
function var_0_1.displayLotteryAni(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_1 = arg_10_0.getIndexByNumbers(var_10_0, arg_10_2)

	findTF = var_10_0

	local var_10_2 = var_10_0(arg_10_0._tf, "lottery")
	local var_10_3 = var_5.Find(var_10_2, "omikuji_anim")
	local var_10_4 = var_6.GetComponent

	typeof = var_8
	DftAniEvent = var_1_10009

	local var_10_5 = var_10_4(var_10_3, var_8(var_1_10009))

	var_6.SetEndEvent(var_10_5, function(arg_11_0)
		...
		for iter_11_0 = 1, var_11_2.childCount do
			...
			var_2_10009 = var_11_2

			local var_11_3 = var_11_2.GetChild(var_2_10009, iter_11_0 - 1)

			var_2_10009 = iter_11_0 == var_10_1

			var_2_10007(var_11_3, var_2_10009)
		end

		local var_11_4 = var_11_1:Find("desc")
		local var_11_5 = {
			"big",
			"medium",
			"little"
		...
		local var_11_6 = "draw_"
		local var_11_7 = var_11_5[var_10_1]
		local var_11_8 = "_luck_"

		math = var_2_10009

		local var_11_9 = var_5(var_11_6 .. var_11_7 .. var_11_8 .. var_2_10009.random(1, 3))

		setText = var_6

		var_6(var_11_4, var_11_9)

		local var_11_10 = var_11_1:Find("award")
		local var_11_11 = var_11_1
		local var_11_12 = var_11_1.Find(var_11_11, "award_list")

		setActive = var_11_11

		var_11_11(var_11_10, false)
		...
		if arg_10_1 then
			...
			for iter_11_1, iter_11_2 in var_8(arg_10_1) do
				...
				var_2_10013 = var_2_10013(var_11_10, var_11_12)
				...
				var_15(var_2_10013, var_11_13)

				onButton = var_15

				local var_11_14 = arg_10_0
				local var_11_15 = var_2_10013
				...
				local function var_11_16()
					...
					var_12_1(var_12_0, var_3_10002.ON_DROP, var_11_13)
				...
				var_15(var_11_14, var_11_15, var_11_16, var_2_10019)
			end
		end

		local var_11_17 = arg_10_0
		local var_11_18 = var_8.emit

		ActivityMainScene = var_10

		var_11_18(var_11_17, var_10.LOCK_ACT_MAIN, false)

		onButton = var_11_18

		var_11_18(arg_10_0, var_11_1, function()
...
function var_0_1.bobingUpdate(arg_14_0)
	...
	if not arg_14_0.bobingWrap then
		...
		local var_14_10 = var_4.gameset.bb_front_awards.description[1]
		...
		var_7.make(var_14_12, function(arg_15_0, arg_15_1, arg_15_2)
			...
			if arg_15_0 == var_2_10003.EventUpdate then
				...
				local function var_15_3()
					...
					var_16_1(var_16_0, var_3_10002.ON_DROP, var_15_0)
		...
		UIItemList = var_8
		var_1_10010 = var_8.New(var_14_2.itemColumn, var_14_2.itemRow)

		var_8.make(var_1_10010, function(arg_17_0, arg_17_1, arg_17_2)
			UIItemList = var_2_10003
				...
				var_4.make(var_17_1, function(arg_18_0, arg_18_1, arg_18_2)
					...
					if arg_18_0 == var_3_10003.EventUpdate then
						...
						local function var_18_3()
							...
							var_19_1(var_19_0, var_4_10002.ON_DROP, var_18_0)
						...
						var_4(var_18_1, var_18_2, var_18_3, var_3_10008)
					end
		...
		var_8.align(var_1_10010, #var_14_11)

		onButton = var_9
		var_1_10010 = arg_14_0

		local var_14_13 = var_14_2.btnRule
		...
		var_9(var_1_10010, var_14_13, var_14_14, var_1_10013)

		onButton = var_9
		var_1_10010 = arg_14_0

		local var_14_15 = var_14_2.btnReturn
		...
		var_9(var_1_10010, var_14_15, var_14_16, var_1_10013)

		onButton = var_9
		var_1_10010 = arg_14_0

		local var_14_17 = var_14_2.bowlEnable

		local function var_14_18()
			local var_22_0 = arg_14_0
			local var_22_1 = var_0.emit

			ActivityMainScene = var_2_10002

			var_22_1(var_22_0, var_2_10002.LOCK_ACT_MAIN, true)
			...
			var_0.displayBBAnim(var_22_2, function()
				...
				var_23_1(var_23_0, var_3_10002.EVENT_OPERATION, {
					cmd = 1,
		...
		var_9(var_1_10010, var_14_17, var_14_18, var_1_10013)

		arg_14_0.bobingWrap = var_14_2
	end

	local var_14_19 = var_14_0
	local var_14_20 = var_14_0.getConfig(var_14_19, "config_id")

	setActive = var_14_19

	var_14_19(var_14_2.layerRule, false)

	setActive = var_14_19

	var_14_19(var_14_2.get, var_14_20 <= var_14_0.data1)

	setActive = var_14_19

	var_14_19(var_14_2.bowlDisable, var_14_0.data2 == 0)

	setActive = var_14_19

	var_14_19(var_14_2.bowlEnable, var_14_0.data2 > 0)
	...
	local var_14_23 = var_7.format
	local var_14_24 = "<color=#%s>%s</color> %s"
	local var_14_25 = "FFD43F"

	math = var_1_10010

	var_5(var_14_22, var_14_23(var_14_24, var_14_25, var_1_10010.min(var_14_0.data1, var_14_20) .. "/", var_14_20))

	local var_14_26 = var_14_0.data2 == 0 and "FFD43F" or "d2d4db"

	setActive = var_14_22

	var_14_22(var_14_2.progress, var_14_20 > var_14_0.data1)
	...
	var_14_22(var_14_27, var_8.format("<color=#%s>%s</color>", var_14_26, var_14_0.data2))
...
function var_0_1.displayBBAnim(arg_24_0, arg_24_1)
	...
	if not arg_24_0.animBowl then
		...
		arg_24_0.animBowl = var_24_5(var_24_4, var_1_10007(var_1_10008))
	...
	local function var_24_8()
		...
		typeof = var_2
		SpineAnimUI = var_2_10003

		local var_26_2 = var_26_1(var_26_0, var_2(var_2_10003))
...
function var_0_1.displayBBResult(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	var_4(var_5.Find(var_28_0, "bb_anim"), false)
	...
	local var_28_5 = var_4:Find("rank")
	local var_28_6 = var_4
	local var_28_7 = var_4.Find(var_28_6, "bgRank")

	setActive = var_28_6

	var_28_6(var_28_4, false)

	local var_28_8 = var_4:Find("award")
	local var_28_9 = var_4
	local var_28_10 = var_4.Find(var_28_9, "award_list")

	setActive = var_28_9

	var_28_9(var_28_8, false)

	removeAllChildren = var_28_9
	...
	if arg_28_1 then
		...
		for iter_28_0, iter_28_1 in var_28_9(arg_28_1) do
			cloneTplTo = var_1_10016
			var_1_10016 = var_1_10016(var_28_8, var_28_10)
			...
			local function var_28_14()
				...
				var_29_1(var_29_0, var_2_10002.ON_DROP, var_28_11)
			...
			var_18(var_28_12, var_28_13, var_28_14, var_1_10022)
		end
	end

	UIItemList = var_28_9

	local var_28_15 = var_28_9.New(var_28_3, var_28_4)
	...
	if var_28_16 < 7 then
		...
		arg_28_0.setSpriteTo(var_28_17, "bobing/bb_icon/rank" .. var_28_16, var_28_5)
	...
	local var_28_19 = var_28_17.value

	go = var_15

	local var_28_20 = var_28_19(var_15(var_28_3), 0, 1, 1)
	local var_28_21 = var_14.setOnUpdate

	System = var_16

	local var_28_22 = var_28_21(var_28_20, var_16.Action_float(function(arg_31_0)
	...
	if var_28_16 == 7 then
		var_28_23 = var_28_22
		var_28_20 = var_28_22.setOnComplete
		System = var_17

		var_28_20(var_28_23, var_17.Action(function()
			local var_33_0 = arg_28_0
			local var_33_1 = var_0.emit

			ActivityMainScene = var_2_10002

			var_33_1(var_33_0, var_2_10002.LOCK_ACT_MAIN, false)
		...
		LeanTween = var_28_20
		var_28_20 = var_28_20.value
		go = var_28_23

		local var_28_24 = var_28_20(var_28_23(var_28_5), 0, 1, 0.2)
		local var_28_25 = var_28_20.setDelay(var_28_24, 1)

		var_28_20 = var_28_20.setOnUpdate
		System = var_17

		var_28_20(var_28_25, var_17.Action_float(function(arg_34_0)
			setImageAlpha = var_2_10001

			var_2_10001(var_28_5, arg_34_0)

			local var_34_0 = var_28_5

			Vector3 = var_2

			local var_34_1 = var_2.Lerp

			Vector3 = var_3

			local var_34_2 = var_3(2, 2, 2)

			Vector3 = var_4
			var_34_0.localScale = var_34_1(var_34_2, var_4.one, arg_34_0)

			return
		end))

		local var_28_26 = var_4

		if not var_4.Find(var_28_26, "rank_p") then
			cloneTplTo = var_28_26
			var_28_20 = var_28_26(var_28_5, var_4, "rank_p")
		end

		arg_28_0:setSpriteTo("bobing/bb_icon/rank" .. var_28_16, var_28_20)

		local var_28_27 = arg_28_0

		arg_28_0.setSpriteTo(var_28_27, "bobing/bb_icon/rank" .. var_28_16, var_28_5)

		LeanTween = var_16

		local var_28_28 = var_16.value

		go = var_28_27

		local var_28_29 = var_28_28(var_28_27(var_28_20), 1, 0, 0.3)
		local var_28_30 = var_16.setDelay(var_28_29, 1.5)
		local var_28_31 = var_16.setOnUpdate

		System = var_18

		local var_28_32 = var_28_31(var_28_30, var_18.Action_float(function(arg_35_0)
			setImageAlpha = var_2_10001

			var_2_10001(var_28_20, arg_35_0)

			local var_35_0 = var_28_20

			Vector3 = var_2

			local var_35_1 = var_2.Lerp

			Vector3 = var_3

			local var_35_2 = var_3(2, 2, 2)

			Vector3 = var_4
			var_35_0.localScale = var_35_1(var_35_2, var_4.one, arg_35_0)

			return
		end))
		local var_28_33 = var_16.setOnComplete

		System = var_18

		var_28_33(var_28_32, var_18.Action(function()
			local var_36_0 = arg_28_0
			local var_36_1 = var_0.emit

			ActivityMainScene = var_2_10002

			var_36_1(var_36_0, var_2_10002.LOCK_ACT_MAIN, false)
	...
	var_28_20(var_4, true)

	onButton = var_28_20

	var_28_20(arg_28_0, var_4, function()
		if var_28_18 then
			setActive = var_0
...
function var_0_1.setSpriteTo(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	local var_38_2 = var_38_1(var_38_0, var_1_10006(var_1_10007))
	...
	typeof = var_7
	Image = var_1_10008
	var_38_2.sprite = var_38_5(var_38_4, var_7(var_1_10008)).sprite
