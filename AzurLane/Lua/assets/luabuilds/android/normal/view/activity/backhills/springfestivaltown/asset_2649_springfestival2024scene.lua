...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0 = 0, arg_2_0._map.childCount - 1 do
		...
		local var_2_4 = var_2_2(var_2_3).name

		arg_2_0["map_" .. var_2_4] = var_2_3
	end
	...
	for iter_2_1 = 0, arg_2_0._upper.childCount - 1 do
		...
		local var_2_8 = var_2_6(var_2_7).name

		arg_2_0["upper_" .. var_2_8] = var_2_7
	end
	...
	_ = var_2
	arg_2_0.tipTfs = var_2_9(var_2.range(arg_2_0._upper.childCount), function(arg_3_0)
	...
	import = var_2_11
	arg_2_0.graphPath = var_2_12(var_2_11("GameCfg.BackHillGraphs.SpringFestival2024Graph"))
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1_10001(var_4_0, var_3.Find(var_4_1, "top/Back"), function()
	...
	var_1_10001(var_4_2, var_3.Find(var_4_3, "top/Home"), function()
	...
	var_1_10001(var_4_4, var_3.Find(var_4_5, "top/Help"), function()
		pg = var_2_10000
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.help_chunjie2024.tip
	...
	var_1_10001(var_4_6, var_3.Find(var_4_7, "top/firework_btn"), function()
	...
	local var_4_11 = var_4_10(var_4_9, var_3.MINIGAME_SPRING_FESTIVAL_2024)
	local var_4_12 = arg_4_0

	arg_4_0.InitStudents(var_4_12, var_4_11 and var_4_11.id, 4, 4)

	PLATFORM_CODE = var_2
	PLATFORM_CHT = var_4_12

	if var_2 == var_4_12 then
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "feicaiyingxinchuntw", function()
			local var_9_0 = arg_4_0
			local var_9_1 = var_0.emit

			SpringFestival2024Mediator = var_2_10002
			...
			var_9_4.id = var_2_10005.FIREWORK_PT_2024_ID
		...
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "aomeiyingchun", function()
			...
			ActivityConst = var_2_10005
			var_10_4.id = var_2_10005.ACTIVITY_COUPLET
		...
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "huazhongshijie", function()
			...
			if not var_11_1(var_11_0, var_2_10002.ACTIVITY_HUAZHONGSHIJIE) or var_0:isEnd() then
				pg = var_11_0

				local var_11_2 = var_11_0.TipsMgr.GetInstance()
				local var_11_3 = var_1.ShowTips

				i18n = var_2_10003

				var_11_3(var_11_2, var_2_10003("common_activity_end"))
			...
			SpringFestival2024Mediator = var_2_10004

			local var_11_7 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			var_11_6(var_11_5, var_11_7, var_2_10005.ACTIVITY, {
				id = var_11_4
			})
		...
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "feicaiyingxinchun", function()
			...
			local var_12_3 = var_2_10003.ACTIVITY
			local var_12_4 = {}

			ActivityConst = var_2_10005
			var_12_4.id = var_2_10005.FIREWORK_PT_2024_ID
		...
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "meiyiyannian", function()
			...
			local var_13_3 = var_2_10003.ACTIVITY
			local var_13_4 = {}

			ActivityConst = var_2_10005
			var_13_4.id = var_2_10005.TAIYUAN_ALERT_TASK
		...
		arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "xinchunmaoxianwang", function()
			...
			ActivityConst = var_2_10005
			var_14_4.id = var_2_10005.FEIYUEN_LOGIN
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "fushundamaoxian", function()
		...
		var_15_1(var_15_0, var_2_10002.GO_MINI_GAME, 37)
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "jiujiudajiulou", function()
		...
		local var_16_2 = var_2_10002.GO_SUBLAYER

		Context = var_2_10003

		local var_16_3 = var_2_10003.New
		local var_16_4 = {}

		RedPacketMediator = var_2_10005
		var_16_4.mediator = var_2_10005
		RedPacketLayer = var_2_10005
		var_16_4.viewComponent = var_2_10005
	...
	arg_4_0:InitFacilityCross(arg_4_0._map, arg_4_0._upper, "huituriji", function()
		...
		var_18_1(var_18_0, var_18_2, var_2_10003.COLORING)
	...
	if arg_4_0.contextData.isOpenRedPacket then
		...
		local var_4_14 = arg_4_0.emit

		SpringFestival2024Mediator = var_4

		local var_4_15 = var_4.GO_SUBLAYER

		Context = var_5

		local var_4_16 = var_5.New
		local var_4_17 = {}

		RedPacketMediator = var_7
		var_4_17.mediator = var_7
		RedPacketLayer = var_7
		var_4_17.viewComponent = var_7

		function var_4_17.onRemoved()
		...
		var_4_14(var_4_13, var_4_15, var_4_16(var_4_17))
	end
...
function var_0_1.UpdateView(arg_21_0)
	...
	var_1_10001.each(arg_21_0.tipTfs, function(arg_22_0)
		if arg_22_0.trans then
			...
			var_1(var_22_0, var_2_10003(var_0_1.CheckTip(arg_22_0.name)))
		end
...
function var_0_1.OpenFireworkLayer(arg_23_0)
	...
	SpringFestival2024Mediator = var_1_10003

	local var_23_2 = var_1_10003.GO_SUBLAYER

	Context = var_1_10004

	local var_23_3 = var_1_10004.New
	local var_23_4 = {}

	FireworkPanel2024Mediator = var_1_10006
	var_23_4.mediator = var_1_10006
	FireworkPanel2024Layer = var_1_10006
	var_23_4.viewComponent = var_1_10006
	var_23_4.data = {
		onExit = function()
...
function var_0_1.PlayFireworks(arg_25_0)
	...
	local var_25_2 = var_25_1(var_25_0, var_1_10003.ACTIVITY_TYPE_FIREWORK)

	assert = var_25_0

	var_25_0(var_25_2 and not var_25_2:isEnd(), "烟花活动(type92)已结束")

	getProxy = var_25_0
	PlayerProxy = var_3

	local var_25_3 = var_25_0(var_3)
	local var_25_4 = var_2.getData(var_25_3).id

	pg = var_25_3

	local var_25_5 = var_25_3.activity_template[var_25_2.id].config_data[3]
	...
	for iter_25_0 = 1, #var_25_5 do
		...
		if var_1_10008.GetInt("fireworks_" .. var_25_2.id .. "_" .. var_25_4 .. "_pos_" .. iter_25_0) ~= 0 then
			...
			var_9.insert(arg_25_0.fireworks, var_1_10008)
		end
	end
...
function var_0_1.PlayerOneFirework(arg_28_0)
	if arg_28_0.index == #arg_28_0.fireworks then
		...
		var_28_1(var_28_0, var_1_10003.delayedCall, function()
	...
	if arg_28_0.firePools[var_28_2] and #arg_28_0.firePools[var_28_2] >= var_0_1.EffectPoolCnt then
		...
		var_3.GetPrefab(var_28_6, "ui/" .. var_0_1.Id2EffectName[var_28_2], "", function(arg_30_0)
			...
			var_1(var_30_0, var_3.GetFireworkPos(var_30_1))
...
function var_0_1.CheckTip(arg_35_0)
	...
	return var_1_10001(arg_35_0, {
		fushundamaoxian = function()
			...
			return var_36_0(var_2_10001.MINIGAME_SPRING_FESTIVAL_2024)
		end,
		huituriji = function()
			getProxy = var_2_10000
			ColoringProxy = var_2_10001
		...
		xinchunmaoxianwang = function()
			...
			local var_39_2 = var_39_1(var_39_0, var_2_10002.FEIYUEN_LOGIN)

			Activity = var_39_0

			return var_39_0.IsActivityReady(var_39_2)
		end,
		meiyiyannian = function()
			...
			local var_40_2 = var_40_1(var_40_0, var_2_10002.TAIYUAN_ALERT_TASK)
		...
		feicaiyingxinchun = function()
			...
			local var_41_0 = var_2_10000(var_2_10001)
			local var_41_1 = var_0.getActivityById

			ActivityConst = var_2_10002

			local var_41_2 = var_41_1(var_41_0, var_2_10002.FIREWORK_PT_2024_ID)

			Activity = var_41_0

			return var_41_0.IsActivityReady(var_41_2)
		end,
		feicaiyingxinchuntw = function()
			getProxy = var_2_10000
			ActivityProxy = var_2_10001

			local var_42_0 = var_2_10000(var_2_10001)
			local var_42_1 = var_0.getActivityById

			ActivityConst = var_2_10002

			local var_42_2 = var_42_1(var_42_0, var_2_10002.FIREWORK_PT_2024_ID)

			Activity = var_42_0

			return var_42_0.IsActivityReady(var_42_2)
		end,
		aomeiyingchun = function()
			...
			local var_43_2 = var_43_1(var_43_0, var_2_10002.ACTIVITY_COUPLET)

			Activity = var_43_0

			return var_43_0.IsActivityReady(var_43_2)
		end,
		huazhongshijie = function()
			getProxy = var_2_10000
			ActivityProxy = var_2_10001

			local var_44_0 = var_2_10000(var_2_10001)
			local var_44_1 = var_0.getActivityById

			ActivityConst = var_2_10002

			local var_44_2 = var_44_1(var_44_0, var_2_10002.ACTIVITY_HUAZHONGSHIJIE)

			Activity = var_44_0

			return var_44_0.IsActivityReady(var_44_2)
		end
	}, function()
		return false
	end)
