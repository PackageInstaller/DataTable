...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "Window/Layout/Box/ScrollView/Content/ItemGrid2")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_0(var_2_2, var_3.Find(var_2_3, "Window/Layout/Box/ScrollView/Content/ItemGrid2/GridItem"))
	...
	local var_2_7 = var_2.Find(var_2_6, "Window/Fixed/top/bg/obtain/title")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("MonopolyCar2024Game_total_award_title"))

	setText = var_1

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_2.Find(var_2_8, "Window/Fixed/ButtonGO/pic")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("text_confirm"))
