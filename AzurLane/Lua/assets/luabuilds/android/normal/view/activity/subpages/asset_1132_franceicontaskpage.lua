...
local var_0_0 = "FranceIconTaskPage"
...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local function var_1_2()
		...
		var_2_1(var_2_0, var_2_2, var_2_10003.TASK, {
			page = "activity"
		})
	...
	var_1(var_1_10, var_1_11, var_1_12, var_1_10005)
	...
	local var_1_15 = var_1_13.TimeMgr.GetInstance()

	if var_2.inTime(var_1_15, var_1_14) then
		triggerToggle = var_1_15

		var_1_15(arg_1_0.switchBtn, true)
	end
...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	local var_4_1 = var_2(var_4_0, var_1_10004(var_1_10005))
	...
	var_5(var_6.Find(var_4_5, "Image"), false)
	...
	local var_4_7 = var_4_6(var_6(arg_4_0.phases[1]), var_4_3, 0.4)
	local var_4_8 = var_5.setOnComplete

	System = var_7

	var_4_8(var_4_7, var_7.Action(function()
		setActive = var_2_10000

		local var_5_0 = arg_4_0.phases[1]

		var_2_10000(var_1.Find(var_5_0, "label"), true)
	...
	local var_4_9 = var_4_8.value

	go = var_4_7

	local var_4_10 = var_4_9(var_4_7(arg_4_0.phases[1]), 0, 1, 0.4)
	local var_4_11 = var_5.setOnUpdate

	System = var_7

	var_4_11(var_4_10, var_7.Action_float(function(arg_6_0)
	...
	local var_4_12 = arg_4_0.phases[2]

	var_4_11(var_6.Find(var_4_12, "Image"), true)

	GetOrAddComponent = var_4_11
	...
	local var_4_14 = var_4_11(var_4_13, var_7(var_8))

	LeanTween = var_4_13

	local var_4_15 = var_4_13.value

	go = var_7

	local var_4_16 = var_4_15(var_7(arg_4_0.phases[2]), 0, 1, 0.4)
	local var_4_17 = var_6.setOnUpdate

	System = var_8

	var_4_17(var_4_16, var_8.Action_float(function(arg_7_0)
		var_4_14.alpha = arg_7_0
	...
	local var_4_18 = arg_4_0.phases[2]

	var_4_17(var_7.Find(var_4_18, "label"), false)

	LeanTween = var_4_17

	local var_4_19 = var_4_17.moveLocal

	go = var_7

	local var_4_20 = var_4_19(var_7(arg_4_0.phases[2]), var_4_2, 0.4)
	local var_4_21 = var_6.setOnComplete

	System = var_8

	var_4_21(var_4_20, var_8.Action(function()
...
function var_0_1.UpdateAwardGot(arg_9_0)
	local var_9_0 = arg_9_0.bg
	local var_9_1 = var_1.Find(var_9_0, "switcher/phase2/got")
	local var_9_2 = arg_9_0.ptData
	local var_9_3 = not var_2.CanGetNextAward(var_9_2) and arg_9_0.inPhase2
...
function var_0_1.OnUpdateFlush(arg_10_0)
	...
	local var_10_3 = var_3.inTime(var_10_2, var_10_1)

	setActive = var_10_2

	local var_10_4 = arg_10_0.battleBtn

	isActive = var_1_10006

	local var_10_5

	if var_1_10006(arg_10_0.battleBtn) then
		var_10_5 = var_10_3
	end

	var_10_2(var_10_4, var_10_5)
	arg_10_0:UpdateAwardGot()

	local var_10_6 = arg_10_0.ptData
	local var_10_7, var_10_8, var_10_9 = var_4.GetResProgress(var_10_6)

	setText = var_7

	local var_10_10 = arg_10_0.step
	...
	if 1 <= var_10_9 then
		...
		if not var_9(var_10_7, "#487CFFFF") then
			var_10_11 = var_10_7
		end

		var_7(var_10_10, var_10_11)

		setText = var_7

		var_7(arg_10_0.progress, "/" .. var_10_8)

		setFillAmount = var_7

		var_7(arg_10_0.bar, var_10_7 / var_10_8)
