...
function var_0_1.GetTaskCountAble()
	...
	local var_2_2 = var_2_1.activity_template[var_2_0].config_client.player_task
	local var_2_3 = {}
	local var_2_4 = 0
	...
	local function var_2_6(arg_3_0)
		...
		local var_3_4 = var_3_2.task_data_template[arg_3_0].activity_client_config.before
	...
	for iter_2_4 = 1, #var_2_3 do
		...
		if var_1_10011.getTaskById(var_1_10012, var_2_7) then
			pg = var_1_10012
			...
			if var_1_10011:getTaskStatus() == 1 then
				...
				if not var_13.task_data_template[var_2_7].activity_client_config.before then
					var_2_4 = var_2_4 + 1
				elseif var_2_6(var_13) then
					var_2_4 = var_2_4 + 1
				end
			end
		end
...
function var_0_1.init(arg_4_0)
	...
	for iter_4_4 = 1, #arg_4_0.taskIds do
		iter_4_1 = arg_4_0.taskIds[iter_4_4]
		var_1_10006 = {}
		ipairs = var_1_10007

		for iter_4_5, iter_4_6 in var_1_10007(iter_4_1) do
			var_1_10013 = arg_4_0

			arg_4_0.initTaskListIds(var_1_10013, iter_4_6, var_1_10006)
		end
	...
	local var_4_1 = var_1(arg_4_0._tf, "ad")

	findTF = var_2
	arg_4_0.btnDetail = var_2(var_4_1, "btnDetail")
	findTF = var_2
	arg_4_0.btnBack = var_2(var_4_1, "frame/btnBack")
	findTF = var_2
	arg_4_0.btnHelp = var_2(var_4_1, "frame/btnHelp")
	findTF = var_2
	arg_4_0.btnHome = var_2(var_4_1, "frame/btnHome")
	findTF = var_2
	arg_4_0.hxTf = var_2(var_4_1, "hx")
	setActive = var_2

	local var_4_2 = arg_4_0.hxTf

	PLATFORM_CODE = var_4
	PLATFORM_CH = iter_4_1

	var_2(var_4_2, var_4 == iter_4_1)

	onButton = var_2

	local var_4_3 = arg_4_0
	local var_4_4 = arg_4_0.btnDetail
	...
	local function var_4_5()
		...
		if var_0.getMedalGetAble(var_5_0) then
			...
			GAME = var_2_10002
			var_2_10002 = var_2_10002.ACTIVITY_OPERATION
			...
			var_5_3.activity_id = var_2_10004.SENRANKAGURA_MEDAL_ID

			var_5_2(var_5_1, var_2_10002, var_5_3)
		elseif arg_4_0.taskActivity then
			...
			var_5_6(var_5_5, var_2_10002("challenge_end_tip"))
		end
	...
	local var_4_10 = arg_4_0.btnHome
	...
	var_2(var_4_9, var_4_10, var_4_11, var_1_10006)
	...
	local function var_4_14()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip[var_0_5].tip
	...
	var_2(var_4_12, var_4_13, var_4_14, var_1_10006)

	arg_4_0.btnPlayers = {}

	for iter_4_7 = 1, var_0_2 do
		local var_4_15 = iter_4_7

		findTF = var_1_10007
		var_1_10007 = var_1_10007(var_4_1, "player/" .. iter_4_7)
		GetComponent = var_8
		findTF = var_9

		local var_4_16 = var_9(var_1_10007, "img")

		typeof = var_10
		Image = var_11
		var_8(var_4_16, var_10(var_11)).alphaHitTestMinimumThreshold = 0.5
		...
		if arg_4_0.taskActivity then
			...
			var_9(var_4_17, var_4_18, var_4_19, var_1_10013)
		end

		setActive = var_9
		findTF = var_4_17

		var_9(var_4_17(var_1_10007, "redTip"), false)
	...
	local var_4_20 = var_2(arg_4_0._tf, "pop")

	findTF = var_3
	arg_4_0.detailPanel = var_3(var_4_20, "detailPanel")
	setActive = var_3
	...
	findTF = var_3
	arg_4_0.taskPanel = var_3(var_4_20, "taskPanel")
	setActive = var_3
	...
	findTF = var_3
	arg_4_0.submitPanel = var_3(var_4_20, "submitPanel")
	setActive = var_3
...
function var_0_1.updateUI(arg_11_0)
	...
	local var_11_1 = arg_11_0.getMedalGetAble(var_11_0)

	setActive = var_11_0
	findTF = var_1_10003

	var_11_0(var_1_10003(arg_11_0.btnDetail, "detail"), not var_11_1 and arg_11_0.taskActivity)

	setActive = var_11_0
	findTF = var_3

	var_11_0(var_3(arg_11_0.btnDetail, "get"), var_11_1)

	getProxy = var_11_0
	ActivityProxy = var_3

	local var_11_2 = var_11_0(var_3)
	local var_11_3 = var_2.getActivityById

	ActivityConst = var_5

	local var_11_4 = var_11_3(var_11_2, var_5.SENRANKAGURA_MEDAL_ID).data2_list
	local var_11_5 = var_3:GetPicturePuzzleIds()

	for iter_11_0 = 1, #arg_11_0.btnPlayers do
		local var_11_6 = var_11_5[iter_11_0]
		local var_11_7 = arg_11_0.btnPlayers[iter_11_0]

		setActive = var_1_10012
		findTF = var_1_10013
		var_1_10013 = var_1_10013(var_11_7, "medal/icon")
		table = var_14

		var_1_10012(var_1_10013, var_14.contains(var_11_4, var_11_6))

		setActive = var_1_10012
		findTF = var_1_10013
		var_1_10013 = var_1_10013(var_11_7, "img/got")
		table = var_14
	...
	local var_11_8 = var_6(var_7)
	local var_11_9 = var_6.getActivityById

	ActivityConst = iter_11_0

	local var_11_10 = var_11_9(var_11_8, iter_11_0.SENRANKAGURA_MEDAL_ID).data1_list
	local var_11_11 = var_7.data2_list
	local var_11_12 = false

	for iter_11_1 = 1, #var_11_10 do
		if not var_11_12 then
			table = var_1_10015

			if not var_1_10015.contains(var_11_11, var_11_10[iter_11_1]) then
				var_11_12 = true
				pg = var_1_10015

				local var_11_13 = var_1_10015.m02

				var_1_10015 = var_1_10015.sendNotification
				GAME = var_1_10017

				var_1_10015(var_11_13, var_1_10017.MEMORYBOOK_UNLOCK, {
					id = var_11_10[iter_11_1],
					actId = var_7.id
				})
			end
		end
	...
	if arg_11_0.taskActivity then
		local var_11_14 = arg_11_0:getGetAbleTask()
		local var_11_15 = {}
		...
		for iter_11_2 = 1, #arg_11_0.taskIds do
			...
			for iter_11_3, iter_11_4 in var_1_10018(arg_11_0.taskIds[iter_11_2]) do
				...
				if var_1_10023.contains(var_11_14, iter_11_4) then
					if not var_11_15[var_1_10017] then
						var_11_15[var_1_10017] = 1
					else
						var_11_15[var_1_10017] = var_11_15[var_1_10017] + 1
					end
				end
			end
		end
		...
		for iter_11_5 = 1, #arg_11_0.btnPlayers do
			...
			var_1_10017(var_1_10018(arg_11_0.btnPlayers[iter_11_5], "redTip"), var_11_15[iter_11_5] ~= nil)
		end
...
function var_0_1.getMedalGetAble(arg_12_0)
	...
	local var_12_2 = var_12_1(var_12_0, var_1_10004.SENRANKAGURA_MEDAL_ID).data1_list
...
function var_0_1.initDetailPanel(arg_14_0)
	...
	local var_14_1 = var_3(arg_14_0.detailPanel, "ad/black")
	...
	var_1(var_14_0, var_14_1, var_14_2, var_5)
	...
	for iter_14_0 = 1, var_0_2 do
		...
		var_1_10007 = arg_14_0.medalTfs
		findTF = var_1_10008

		var_1_10006(var_1_10007, var_1_10008(arg_14_0.detailPanel, "ad/medals/" .. iter_14_0))
	end

	for iter_14_1 = 1, var_0_3 do
		var_1_10006 = arg_14_0.buffs[iter_14_1].pt[1]
		tf = var_1_10007
		instantiate = var_1_10008
		var_1_10007 = var_1_10007(var_1_10008(arg_14_0.detailProgressTipTpl))
		setImageSprite = var_1_10008
		findTF = var_9

		local var_14_4 = var_9(var_1_10007, "num")

		GetSpriteFromAtlas = var_10

		var_1_10008(var_14_4, var_10("ui/senrankaguramedalui_atlas", "buff_" .. iter_14_1), true)

		setImageSprite = var_1_10008
		findTF = var_14_4

		local var_14_5 = var_14_4(var_1_10007, "count")

		GetSpriteFromAtlas = var_10

		var_1_10008(var_14_5, var_10("ui/senrankaguramedalui_atlas", "buff_count_" .. iter_14_1), true)

		Vector3 = var_1_10008
		var_1_10007.anchoredPosition = var_1_10008(var_1_10006 / arg_14_0.ptMaxNum * var_14_3, 0, 0)
		SetParent = var_1_10008

		var_1_10008(var_1_10007, arg_14_0.detailProgressTipContent)
	...
	for iter_14_2 = 1, var_0_4 do
		findTF = var_1_10006
		var_1_10006 = var_1_10006(arg_14_0.detailPanel, "ad/buff/" .. iter_14_2)
		table = var_7

		var_7.insert(arg_14_0.detailBuffTfs, var_1_10006)
	end
...
function var_0_1.updateDetailPanel(arg_17_0)
	...
	for iter_17_0 = 1, var_0_4 do
		...
		var_1_10010(var_1_10011(var_1_10009, "desc"), var_17_3)
	end
	...
	local var_17_4 = var_4(var_5)
	local var_17_5 = var_4.getActivityById

	ActivityConst = var_7

	local var_17_6 = var_17_5(var_17_4, var_7.SENRANKAGURA_MEDAL_ID).data1_list
	...
	for iter_17_1 = 1, #arg_17_0.medalTfs do
		...
		findTF = var_1_10016
		var_1_10016 = var_1_10016(var_17_9, "icon")
		table = var_17

		var_1_10015(var_1_10016, var_17.contains(var_17_7, var_17_10))
	end

	setText = var_9
	findTF = var_10

	local var_17_11 = var_10(arg_17_0.detailProgressDesc, "desc")

	i18n = var_11

	var_9(var_17_11, var_11("shan_luan_task_progress_tip", arg_17_0:getTaskCompleteCount() .. "/" .. arg_17_0.taskCount))
	...
	var_9(var_17_12, var_11("shan_luan_task_level_tip", "Lv." .. var_17_1))
...
function var_0_1.getTaskCompleteCount(arg_18_0)
	...
	local var_18_2 = arg_18_0.getActiveTask(var_18_1)

	ipairs = var_18_1

	for iter_18_0, iter_18_1 in var_18_1(var_18_2) do
		local var_18_3 = arg_18_0:getTask(iter_18_1)

		if var_8.getTaskStatus(var_18_3) == 2 then
			var_18_0 = var_18_0 + 1
		else
			print = var_8
...
function var_0_1.getPtNum(arg_19_0)
	...
	if arg_19_0.ptId then
		...
		var_19_0 = var_2.getData(var_1_10003)[arg_19_0.ptName] or 0
	else
		getProxy = var_2
		...
		local var_19_3 = var_19_2(var_19_1, var_1_10004.ACTIVITY_TYPE_BUILDING_BUFF_2)
...
function var_0_1.initTaskPanel(arg_22_0)
	...
	local var_22_1 = var_2(arg_22_0.taskPanel, "ad/frame/btnHelp")
	...
	var_4(var_22_3, var_22_4, var_22_5, var_1_10008)
	...
	local function var_22_8()
		...
		var_24_1(var_24_0, var_2_10002.ON_HOME)
	...
	var_4(var_22_6, var_22_7, var_22_8, var_1_10008)
	...
	local function var_22_11()
		...
		pg = var_2_10003
		var_25_2.helps = var_2_10003.gametip[var_0_6].tip
	...
	var_4(var_22_9, var_22_10, var_22_11, var_1_10008)
	...
	for iter_22_0 = 1, var_0_2 do
		...
		var_1_10011 = var_1_10011(var_1_10012(var_22_13))
		setImageSprite = var_1_10012
		findTF = var_1_10013
		var_1_10013 = var_1_10013(var_1_10011, "icon")
		GetSpriteFromAtlas = var_14

		var_1_10012(var_1_10013, var_14("ui/senrankaguramedalui_atlas", "player_icon_" .. iter_22_0), true)
		...
		var_1_10012(var_1_10013, var_22_15, var_22_16, var_16)
	end
	...
	for iter_22_1 = 1, var_0_2 do
		...
		local var_22_20 = arg_22_0.taskListDatas[iter_22_1]

		for iter_22_2 = 1, #var_22_20 do
			tf = var_1_10019
			instantiate = var_1_10020
			var_1_10019 = var_1_10019(var_1_10020(var_22_18))
			...
			var_1_10020 = var_22_20[iter_22_2]
			...
			for iter_22_3, iter_22_4 in var_22(var_1_10020) do
				...
				var_1_10027 = var_1_10027(var_1_10028(var_22_19))
				Vector2 = var_1_10028
				...
				if iter_22_4.special then
					if iter_22_4.pos[2] ~= 0 then
						setImageSprite = var_29
						findTF = var_22_22
						var_22_22 = var_22_22(var_1_10027, "get")
						GetSpriteFromAtlas = var_31

						var_29(var_22_22, var_31("ui/senrankaguramedalui_atlas", "task_get_" .. 4), true)

						setImageSprite = var_29
						findTF = var_22_22
						var_22_22 = var_22_22(var_1_10027, "got")
						GetSpriteFromAtlas = var_31

						var_29(var_22_22, var_31("ui/senrankaguramedalui_atlas", "task_got_" .. 4), true)
					else
						setImageSprite = var_29
						findTF = var_22_22
						var_22_22 = var_22_22(var_1_10027, "get")
						...
						var_29(var_22_22, var_31("ui/senrankaguramedalui_atlas", "task_get_" .. 2), true)
						...
						var_29(var_22_22, var_31("ui/senrankaguramedalui_atlas", "task_got_" .. 2), true)
					end
				elseif not var_1_10028 and iter_22_4.pos[2] ~= 0 then
					setImageSprite = var_29
					findTF = var_22_22

					local var_22_23 = var_22_22(var_1_10027, "get")

					GetSpriteFromAtlas = var_31

					var_29(var_22_23, var_31("ui/senrankaguramedalui_atlas", "task_get_" .. 3), true)

					setImageSprite = var_29
					findTF = var_22_23

					local var_22_24 = var_22_23(var_1_10027, "got")

					GetSpriteFromAtlas = var_31

					var_29(var_22_24, var_31("ui/senrankaguramedalui_atlas", "task_got_" .. 3), true)
				end

				setActive = var_29

				var_29(var_1_10027, true)

				SetParent = var_29

				var_29(var_1_10027, var_1_10019)

				table = var_29

				var_29.insert(var_22_21, {
					tf = var_1_10027,
					data = iter_22_4
				})
				...
				SFX_CONFIRM = var_1_10033

				var_29(var_22_25, var_22_26, var_22_27, var_1_10033)
			end

			var_1_10013.listTf = var_1_10019
			var_1_10013.taskDic = var_22_21
		end

		table = var_15

		var_15.insert(arg_22_0.taskGroups, var_1_10013)
	end
	...
	local var_22_28 = arg_22_0
	local var_22_29 = arg_22_0.taskBtnGetAll
	...
	local function var_22_30()
		...
		if var_0.getGetAbleTask(var_28_0) and #var_0 > 0 then
			...
			var_28_2(var_28_1, var_2_10003.SUBMIT_TASK_ALL, var_0)
		end
	...
	var_9(var_22_28, var_22_29, var_22_30, var_1_10013)
...
function var_0_1.updateTask(arg_29_0)
	for iter_29_0 = 1, #arg_29_0.taskGroups do
		...
		for iter_29_1, iter_29_2 in var_1_10007(var_29_0) do
			...
			var_29_2(var_15(var_29_1, "lock"), false)

			setActive = var_29_2
			findTF = var_15

			var_29_2(var_15(var_29_1, "getAble"), false)

			setActive = var_29_2
			findTF = var_15

			var_29_2(var_15(var_29_1, "get"), false)

			setActive = var_29_2
			findTF = var_15

			var_29_2(var_15(var_29_1, "got"), false)

			local var_29_4

			if var_29_3 then
				var_29_4 = arg_29_0
				var_29_2 = arg_29_0.checkTaskBeforeComplete
				var_1_10017 = var_29_3

				if var_29_2(var_29_4, var_29_3.getConfig(var_1_10017, "activity_client_config").before) then
					var_1_10016 = var_29_3

					if var_29_3.getTaskStatus(var_1_10016) == 0 then
						setActive = var_29_4
						findTF = var_1_10016

						var_29_4(var_1_10016(var_29_1, "get"), true)
					else
						var_1_10016 = var_29_3

						if var_29_3.getTaskStatus(var_1_10016) == 1 then
							setActive = var_29_4
							findTF = var_1_10016
							...
							var_29_4(var_1_10016(var_29_1, "getAble"), true)
						else
							var_1_10016 = var_29_3

							if var_29_3.getTaskStatus(var_1_10016) == 2 then
								setActive = var_29_4
								findTF = var_1_10016

								var_29_4(var_1_10016(var_29_1, "got"), true)
							end
						end
					end
				else
					...
					var_29_4(var_1_10016(var_29_1, "lock"), true)
				...
				var_29_2(var_15(var_29_1, "get"), true)
			end
		end
	end
	...
	for iter_29_3 = 1, #arg_29_0.taskGroups do
		...
		for iter_29_4, iter_29_5 in var_1_10008(var_29_5) do
			...
			var_1_10016(var_1_10017(var_29_9, "line/back"), false)

			setActive = var_1_10016
			findTF = var_1_10017

			var_1_10016(var_1_10017(var_29_9, "line/bottom"), false)

			setActive = var_1_10016
			findTF = var_1_10017

			var_1_10016(var_1_10017(var_29_9, "line/top"), false)

			var_1_10017 = var_29_9

			var_29_9.SetAsFirstSibling(var_1_10017)

			if not var_29_8 then
				setActive = var_1_10016
				findTF = var_1_10017

				var_1_10016(var_1_10017(var_29_9, "line"), false)

				goto label_29_0
			end

			var_1_10017 = arg_29_0
			var_1_10016 = arg_29_0.getTaskPos(var_1_10017, var_29_8)
			var_1_10017 = arg_29_0:getTask(var_29_8)
			...
			if arg_29_0:checkTaskBeforeComplete(var_29_8) then
				...
				do
					...
					if not var_29_10.New(0.9921568627450981, 0.9647058823529412, 0.8666666666666667) then
						Color = var_29_10
						var_29_10 = var_29_10.New(0.48627450980392156, 0.35294117647058826, 0.2901960784313726)
					end
					...
					if var_1_10016[1] < var_29_7[1] then
						...
						var_19(var_20(var_29_9, "line/back"), true)

						setImageColor = var_19
						findTF = var_20

						var_19(var_20(var_29_9, "line/back"), var_29_10)
					elseif var_1_10016[2] < var_29_7[2] then
						setActive = var_19
						findTF = var_20

						var_19(var_20(var_29_9, "line/bottom"), true)

						setImageColor = var_19
						findTF = var_20

						var_19(var_20(var_29_9, "line/bottom"), var_29_10)
					else
						setActive = var_19
						findTF = var_20

						var_19(var_20(var_29_9, "line/top"), true)

						setImageColor = var_19
						findTF = var_20

						var_19(var_20(var_29_9, "line/top"), var_29_10)
					end

					setActive = var_19
					findTF = var_20

					var_19(var_20(var_29_9, "line"), true)
				end
...
function var_0_1.getGetAbleTask(arg_34_0)
	...
	local var_34_1 = var_1_10002(var_1_10003)
	...
	for iter_35_0 = 1, #arg_35_0.taskGroups do
		...
		for iter_35_1, iter_35_2 in var_1_10007(var_35_1) do
			if not iter_35_2.data.before then
				...
				if arg_35_0.checkTaskBeforeComplete(var_35_2, iter_35_2.data.before) then
					table = var_35_2

					var_35_2.insert(var_35_0, iter_35_2.data.id)
				end
			end
		end
	end
...
function var_0_1.taskSelectTag(arg_36_0, arg_36_1, arg_36_2)
	...
	for iter_36_0 = 1, #arg_36_0.taskTagTfs do
		var_1_10008 = arg_36_0.taskTagTfs[iter_36_0]
		setActive = var_1_10009
		findTF = var_1_10010

		var_1_10009(var_1_10010(var_1_10008, "select"), arg_36_0.currentSelectTag == var_1_10008)
	end

	GetComponent = var_4
	findTF = var_5

	local var_36_1 = var_5(arg_36_0.taskPanel, "ad/task")

	typeof = var_6
	ScrollRect = var_7
	arg_36_0.taskScrollRect = var_4(var_36_1, var_6(var_7))

	local var_36_2 = var_0_2 - 1

	Vector2 = var_36_1

	local var_36_3 = var_36_1(arg_36_0.taskScrollRect.normalizedPosition.x, arg_36_0.taskScrollRect.normalizedPosition.y)
	local var_36_4

	if arg_36_2 then
		var_36_4 = arg_36_0.taskScrollRect.normalizedPosition.y

		local var_36_5 = (var_36_2 - (arg_36_1 - 1)) / var_36_2

		LeanTween = var_1_10008

		local var_36_6 = var_1_10008.isTweening

		go = var_1_10009

		local var_36_7

		if var_36_6(var_1_10009(arg_36_0._tf)) then
			LeanTween = var_36_7
			var_36_7 = var_36_7.cancel
			go = var_9

			var_36_7(var_9(arg_36_0._tf))
		end
		...
		local var_36_9 = var_36_8(var_9(arg_36_0._tf), var_36_4, var_36_5, 0.3 + var_36_0 * 0.1)
		local var_36_10 = var_8.setOnUpdate

		System = var_10

		var_36_10(var_36_9, var_10.Action_float(function(arg_37_0)
			var_36_3.y = arg_37_0
			arg_36_0.taskScrollRect.normalizedPosition = var_36_3

			local var_37_0 = arg_36_0.taskScrollRect.onValueChanged

			var_1.Invoke(var_37_0, var_36_3)
		...
		var_36_4(arg_36_0.taskScrollRect, 0, (var_36_2 - (arg_36_1 - 1)) / var_36_2)
	end
	...
	for iter_39_0 = 1, #arg_39_1 do
		...
		for iter_39_1 = 1, #var_39_3 do
			...
			elseif var_16.before then
				...
				var_18(var_39_6, "找不到前置id.." .. var_16.before)
				...
				for iter_39_2 = 1, 10 do
					if var_39_1(var_39_8) then
						...
						if var_39_8[2] > 0 then
							var_39_8[2] = var_39_8[2] * -1
						else
							math = var_24
							var_39_8[2] = var_24.abs(var_39_8[2]) + 1
						end
...
function var_0_1.openSubmitPanel(arg_42_0, arg_42_1)
	...
	local var_42_1 = var_4(arg_42_0.submitPanel, "icon/img")

	GetSpriteFromAtlas = var_5

	var_3(var_42_1, var_5("ui/senrankaguramedalui_atlas", "player_icon_" .. var_42_0), true)

	local var_42_2 = arg_42_0:getTask(arg_42_1.id)
	local var_42_3 = arg_42_0
	local var_42_4 = arg_42_0.checkTaskBeforeComplete(var_42_3, arg_42_1.before)

	if var_42_2 then
		arg_42_0.selectTask = var_42_2
		setText = var_42_3
		findTF = var_6

		var_42_3(var_6(arg_42_0.submitPanel, "taskDesc"), var_42_2:getConfig("desc"))

		setText = var_42_3
		findTF = var_6

		var_42_3(var_6(arg_42_0.submitPanel, "img/taskName"), var_42_2:getConfig("name"))

		local var_42_5 = var_42_2:getProgress()
		local var_42_6 = var_42_2
		local var_42_7 = var_42_2.getConfig(var_42_6, "target_num")

		setText = var_42_6
		findTF = var_8

		local var_42_8 = var_8(arg_42_0.submitPanel, "progress/taskProgress")

		setColorStr = var_9

		local var_42_9 = var_9(var_42_5, "#C2695B")
		local var_42_10 = "/"

		setColorStr = var_11

		var_42_6(var_42_8, var_42_9 .. var_42_10 .. var_11(var_42_7, "#9D6B59"))

		local var_42_11 = var_42_2:getConfig("award_display")

		arg_42_0:setSubmitAward(var_42_11)

		setActive = var_8

		var_8(arg_42_0.submitGo, var_42_2:getTaskStatus() == 0 or not var_42_4)

		setActive = var_8

		var_8(arg_42_0.submitGet, var_42_2:getTaskStatus() == 1 and var_42_4)

		setActive = var_8

		var_8(arg_42_0.submitGot, var_42_2:getTaskStatus() == 2)
	end
...
function var_0_1.initSubmitPanel(arg_43_0)
	...
	local var_43_1 = var_3(arg_43_0.submitPanel, "black")
	...
	var_1(var_43_0, var_43_1, var_43_2, var_5)
	...
	var_1(var_43_3, var_43_4, var_43_5, var_5)
	...
	local function var_43_8()
		...
		if arg_43_0.selectTask then
			...
			SenrankaguraMedalMediator = var_2_10002

			var_46_1(var_46_0, var_2_10002.SUBMIT_TASK, arg_43_0.selectTask.id)
		end
	...
	var_1(var_43_6, var_43_7, var_43_8, var_5)
	...
	local function var_43_11()
		...
		if arg_43_0.selectTask then
			...
			SenrankaguraMedalMediator = var_2

			var_47_1(var_47_0, var_2.TASK_GO, arg_43_0.selectTask)
		end
	...
	var_1(var_43_9, var_43_10, var_43_11, var_5)
	...
	var_1(var_43_12, var_3("ryza_task_detail_content"))
	...
	var_1(var_43_13, var_3("ryza_task_detail_award"))
...
function var_0_1.setSubmitAward(arg_48_0, arg_48_1)
	if #arg_48_0.submitItems < #arg_48_1 then
		for iter_48_0 = 1, #arg_48_1 - #arg_48_0.submitItems do
			...
			var_1_10006 = var_1_10006(var_1_10007(arg_48_0.submitItemTpl))
	...
	for iter_48_1 = 1, #arg_48_0.submitItems do
		...
		if iter_48_1 <= #arg_48_1 then
			...
			local function var_48_4()
				...
				var_49_1(var_49_0, var_2_10002.ON_DROP, var_48_1)
			...
			var_8(var_48_2, var_48_3, var_48_4, var_1_10012)
...
function var_0_1.willExit(arg_50_0)
	...
	if var_50_0(var_1_10002(arg_50_0._tf)) then
		LeanTween = var_1
