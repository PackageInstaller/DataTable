...
function var_0_1.UpdateItemDetail(arg_6_0)
	...
	local var_6_9 = var_4.Find(var_6_8, "Window/Source")
	local var_6_10

	if not var_6_7[1] then
		var_6_10 = ""
	end
	...
	local var_6_13 = var_5.Find(var_6_12, "Window/Go")
	...
	local function var_6_14()
		...
		local var_7_2 = var_2_10002.WORKBENCH_ITEM_GO
		local var_7_3 = var_6_0

		var_7_1(var_7_0, var_7_2, var_3.GetConfigID(var_7_3))
	...
	var_6_6(var_6_11, var_6_13, var_6_14, var_7)

	setActive = var_6_6

	local var_6_15 = arg_6_0._tf
	local var_6_16 = var_4.Find(var_6_15, "Window/Go")

	table = var_6_15

	var_6_6(var_6_16, var_6_15.getCount(var_6_0:GetSource()) > 1)
