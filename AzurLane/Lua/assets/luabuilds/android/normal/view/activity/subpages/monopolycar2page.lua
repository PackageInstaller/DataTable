...
local var_0_0 = "MonopolyCar2Page"
...
function var_0_1.OnInit(arg_1_0)
	...
	MonopolyCar2Page = var_1_10003

	var_1_1(var_1_0, var_1_10003.ON_START, function(arg_2_0, arg_2_1, arg_2_2)
		pg = var_2_10003
	...
	var_1_3(var_1_2, var_3.ON_MOVE, function(arg_3_0, arg_3_1, arg_3_2)
		pg = var_2_10003
	...
	var_1_5(var_1_4, var_3.ON_TRIGGER, function(arg_4_0, arg_4_1, arg_4_2)
		pg = var_2_10003
	...
	var_1_7(var_1_6, var_3.ON_AWARD, function(arg_5_0)
		pg = var_2_10001
		...
		local var_5_2 = var_2_10003.MONOPOLY_OP
		local var_5_3 = {
			activity_id = arg_1_0.activity.id
		}

		ActivityConst = var_5
		var_5_3.cmd = var_5.MONOPOLY_OP_AWARD
...
function var_0_1.OnUpdateFlush(arg_7_0)
	if arg_7_0.gameUI then
		...
		MonopolyCar2Game = var_1

		local var_7_1 = var_1.New
		local var_7_2 = arg_7_0

		findTF = var_1_10003
		arg_7_0.gameUI = var_7_1(var_7_2, var_1_10003(arg_7_0._tf, "AD"), arg_7_0.event)
