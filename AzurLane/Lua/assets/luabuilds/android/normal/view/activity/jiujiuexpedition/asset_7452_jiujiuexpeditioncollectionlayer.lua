...
function var_0_1.updateBooks(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10001(arg_10_0.books) do
		...
		typeof = var_9
		Image = var_10
		var_1_10007 = var_1_10007(var_10_1, var_9(var_10))

		if var_10_0 then
			Color = var_10_1

			if not var_10_1.New(1, 1, 1, 1) then
				Color = var_10_1
				var_10_1 = var_10_1.New(0.46, 0.46, 0.46, 1)
			end

			var_1_10007.color = var_10_1
			...
			local function var_10_4()
				if var_10_0 then
					...
					var_11_2(var_11_1, var_2_10002("jiujiu_expedition_book_tip"))
				end
			...
			var_1_10007(var_10_2, var_10_3, var_10_4, var_1_10011)
		end
	end
...
function var_0_1.OpenBook(arg_13_0, arg_13_1)
	...
	var_2(var_3.Find(var_13_0, "1"), arg_13_1 == 1)

	setActive = var_2

	local var_13_1 = arg_13_0.book

	var_2(var_3.Find(var_13_1, "2"), arg_13_1 == 2)

	setActive = var_2

	local var_13_2 = arg_13_0.book

	var_2(var_3.Find(var_13_2, "3"), arg_13_1 == 3)
	...
	var_3(var_13_4, var_13_5, var_13_6, var_1_10007)
	...
	var_3(var_13_7, var_13_8, var_13_9, var_1_10007)

	local var_13_10 = arg_13_0
	local var_13_11 = arg_13_0.GetAwardState(var_13_10, arg_13_1)

	setActive = var_13_10

	var_13_10(arg_13_0.getBtn, var_13_11 == var_0_4)

	setActive = var_13_10

	var_13_10(arg_13_0.gotBtn, var_13_11 == var_0_5)

	setActive = var_13_10

	var_13_10(arg_13_0.goBtn, var_13_11 == var_0_3)

	onButton = var_13_10

	local var_13_12 = arg_13_0
	local var_13_13 = arg_13_0.getBtn

	local function var_13_14()
		local var_16_0 = arg_13_0
		local var_16_1 = var_0.emit

		JiuJiuExpeditionCollectionMediator = var_2_10002

		var_16_1(var_16_0, var_2_10002.ON_GET, arg_13_1)
	...
	var_13_10(var_13_12, var_13_13, var_13_14, var_1_10008)

	onButton = var_13_10

	local var_13_15 = arg_13_0
	local var_13_16 = arg_13_0.goBtn
	...
	local function var_13_17()
		...
		var_17_1(var_17_0, var_2_10002("jiujiu_expedition_reward_tip"))
	...
	var_13_10(var_13_15, var_13_16, var_13_17, var_1_10008)

	triggerButton = var_13_10

	var_13_10(arg_13_0.prevPageBtn)
