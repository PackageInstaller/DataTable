...
function var_0_1.InitUI(arg_3_0)
	...
	local var_3_3 = var_2.Find(var_3_2, "frame/title_text/Text")

	i18n = var_3_2

	var_1(var_3_3, var_3_2("month_sign_resign"))

	onButton = var_1

	local var_3_4 = arg_3_0
	local var_3_5 = arg_3_0._tf
	local var_3_6 = var_3.Find(var_3_5, "frame/top/btnBack")
	...
	local var_3_10 = var_3.Find(var_3_9, "frame/actions/confirm_btn")
...
function var_0_1.displayAwards(arg_8_0)
	...
	for iter_8_0 = 1, #arg_8_0.awards do
		...
		var_7(var_1_10008(var_1_10005), var_8_1, {
			fromAwardLayer = true
		})
		...
		var_7(var_1_10008(var_1_10005, "bonus"), var_8_1.riraty)

		findTF = var_7

		local var_8_2 = var_7(var_1_10005, "name")

		findTF = var_1_10008
		var_1_10008 = var_1_10008(var_1_10005, "name_mask")
		findTF = var_9

		local var_8_3 = var_9(var_1_10005, "name_mask/name")
		local var_8_4 = var_9.GetComponent(var_8_3, "ScrollText")

		setActive = var_8_3

		var_8_3(var_8_2, false)

		setActive = var_8_3

		var_8_3(var_1_10008, true)
		...
		local function var_8_8()
			...
			var_9_1(var_9_0, var_2_10002.ON_DROP, var_8_1)
		...
		var_11(var_8_6, var_8_7, var_8_8, var_1_10015)
	end
