...
local var_0_0 = "HolidayVillaHotSpringMediator"
...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.UNLOCK_SLOT, function(arg_2_0, arg_2_1)
		...
		i18n = var_2_10006
		var_2_4.content = var_2_10006("jp6th_spring_tip1", var_2_2)
		...
		function var_2_4.onYes()
			...
			if var_0.GetCoins(var_3_0) < var_2_2 then
				...
				var_3_2(var_3_1, var_3_10003("jp6th_spring_tip2"))
	...
	arg_1_0:bind(var_0_1.OPEN_INFO, function()
		...
		NewYearHotSpringShipSelectMediator = var_2_10004
		var_5_3.mediator = var_2_10004
		NewYearHotSpringShipSelectLayer = var_2_10004
