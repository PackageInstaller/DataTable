...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_3 = var_4.Find(var_1_2, "window/panel/list")
	local var_1_4 = arg_1_0._tf

	arg_1_0.UIlist = var_1_1(var_1_3, var_5.Find(var_1_4, "window/panel/list/item"))
	...
	typeof = var_5
	Image = var_1_4
	arg_1_0.totalTitleIcon = var_1_14(var_1_13, var_5(var_1_4))
	...
	var_3(var_1_17, var_1_18, var_1_19, var_7)
	...
	var_3(var_1_20, var_1_21, var_1_22, var_7)
...
function var_0_0.UpdateList(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	var_5.make(var_4_0, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_6(arg_5_2:Find("title/Text"), "PHASE " .. arg_5_1 + 1)

			setText = var_6

			var_6(arg_5_2:Find("target/Text"), var_5_1)
			...
			local var_5_6 = arg_5_2:Find("award")
			...
			local function var_5_7()
				...
				var_6_1(var_6_0, var_3_10002.ON_DROP, var_5_4)
			...
			var_7(var_5_5, var_5_6, var_5_7, var_11)
			...
			if not var_7(arg_5_2:Find("mask")) then
				...
				if arg_4_4 then
					pg = var_5_8
					var_5_8 = var_5_8.TimeMgr.GetInstance()

					local var_5_9 = arg_4_4[arg_5_1 + 1]

					setActive = var_9

					var_9(arg_5_2:Find("mask"), var_5_9 > var_5_8:GetServerTime())

					local var_5_10 = var_5_8:STimeDescS(var_5_9, "%m")
					local var_5_11 = var_5_8
					local var_5_12 = var_5_8.STimeDescS(var_5_11, var_5_9, "%d")

					setText = var_5_11

					local var_5_13 = arg_5_2
					local var_5_14 = arg_5_2.Find(var_5_13, "mask/Text")

					i18n = var_5_13

					var_5_11(var_5_14, var_5_13("unlock_date_tip", var_5_10, var_5_12))
				else
					setActive = var_5_8

					var_5_8(arg_5_2:Find("mask"), false)
				end
			end
		end
...
function var_0_0.UpdateTitle(arg_8_0, arg_8_1)
	...
	if arg_8_1 == 2 then
		...
		i18n = var_1_10006
		arg_8_0.cntTitle = var_4(var_8_1, var_1_10006("pt_cosume", var_8_0))
	...
	elseif arg_8_1 == 6 then
		...
		i18n = var_4
		arg_8_0.cntTitle = var_4("pt_total_count", var_8_0)
