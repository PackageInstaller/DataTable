...
function var_0_1.InitLocalText(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10003("doa3_activityPageUI_2"))
	...
	var_1_10001(var_3_1, var_3("doa3_activityPageUI_3"))
	...
	var_1_10001(var_3_2, var_3("doa3_activityPageUI_4"))
	...
	var_1_10001(var_3_3, var_3("doa3_activityPageUI_5"))
...
function var_0_1.OnShowFlush(arg_4_0)
	if arg_4_0.tabs and arg_4_0.config_data then
		...
		var_1(var_2.Find(var_4_0, "1"), true)
		arg_4_0:OnUpdata(1)
	end
...
function var_0_1.OnUpdateFlush(arg_5_0)
	...
	for iter_5_0 = 1, #arg_5_0.config_data do
		...
		if var_5_3 == 2 then
			...
			if not var_8.IsPlayed(var_5_5, arg_5_0.config_client[iter_5_0][1]) then
				...
				callback = var_15
				var_5_11.callback = var_15

				var_5_10(var_5_9, var_1_10013, var_5_11)
			end
		end
	end
	...
	for iter_5_1 = 0, arg_5_0.tabsListCount - 1 do
		...
		local var_5_15 = var_8.GetChild(var_5_14, iter_5_1)
		...
		var_1_10006(var_5_13, var_5_15, var_5_16, var_10)
	end
...
function var_0_1.UpdataAward(arg_9_0, arg_9_1)
	...
	local function var_9_4()
		...
		var_10_1(var_10_0, var_2_10002.ON_DROP, var_9_1)
	...
	var_4(var_9_2, var_9_3, var_9_4, var_1_10008)
...
function var_0_1.UpdataBtnInv(arg_11_0, arg_11_1, arg_11_2)
	...
	local function var_11_2()
		...
		var_0.Play(var_12_0, arg_11_0.config_client[arg_11_1][1], function()
			...
			var_13_1(var_13_0, var_3_10002.ON_TASK_SUBMIT, arg_11_2, function(arg_14_0)
				if arg_14_0 then
...
function var_0_1.UpdateUI(arg_16_0, arg_16_1, arg_16_2)
	...
	var_6(var_16_5, var_8("ui/DOADailyStoryPage_atlas", "page_img" .. arg_16_1), true)
	...
	local var_16_7 = var_7.format
	local var_16_8 = "%s<icon name=%s /> %d/%d"

	i18n = var_9
	var_16_6.text = var_16_7(var_16_8, var_9("doa3_activityPageUI_1"), var_0_2, var_16_3, var_16_4)
	setActive = var_16_6
	...
	var_16_9(arg_16_0.playShowBtn, var_16_0 == 1)

	setActive = var_16_9

	var_16_9(arg_16_0.playClose, var_16_0 == 0)

	setText = var_16_9

	var_16_9(arg_16_0.titleTxt1, "0" .. arg_16_1 .. arg_16_2:getConfig("name"))

	setActive = var_16_9

	var_16_9(arg_16_0.gotAward, var_16_0 == 2 or var_16_10)

	setActive = var_16_9

	var_16_9(arg_16_0.lockAward, var_16_0 == 0)
