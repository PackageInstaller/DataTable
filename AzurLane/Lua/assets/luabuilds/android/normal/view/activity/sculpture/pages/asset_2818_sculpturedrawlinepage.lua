...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.cg = var_1_10001(var_2_0, var_1_10003(var_1_10004))
	...
	arg_2_0.eventTrigger = var_2_6(var_2_5, var_3(var_1_10004))
	pg = var_1
	...
	local var_2_11 = var_2.Find(var_2_10, "tip")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("sculpture_drawline_tip"))
...
function var_0_1.InitOneKey(arg_10_0, arg_10_1)
	...
	ResourceMgr = var_10_0

	local var_10_2 = var_10_0.Inst
	...
	var_10_3(var_10_2, var_10_4, var_10_5, var_7.Events.UnityAction_UnityEngine_Object(function(arg_11_0)
		Object = var_2_10001
...
function var_0_1.OnPointDown(arg_16_0, arg_16_1)
	...
	arg_16_0.pen = var_16_1(var_16_2, var_16_3, var_1_10006.New(0, 0, 0, 0), arg_16_0.frame)
	setActive = var_3
...
function var_0_1.OnPass(arg_18_0)
	...
	i18n = var_1_10005
	var_18_3.content = var_1_10005("sculpture_drawline_done")

	function var_18_3.onYes()
		local var_19_0 = arg_18_0
		local var_19_1 = var_0.emit

		SculptureMediator = var_2_10002

		var_19_1(var_19_0, var_2_10002.ON_DRAW_SCULPTURE, arg_18_0.id)
...
function var_0_1.AddPoint(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_21_0(var_21_1.x, var_21_1.y, -1)

	table = var_4

	var_4.insert(arg_21_0.points, var_21_2)
...
function var_0_1.RegisterEvent(arg_22_0, arg_22_1)
	...
	local function var_22_2()
		...
		i18n = var_2_10004
		var_23_3.content = var_2_10004("sculpture_drawline_exit")
	...
	local function var_22_8()
		...
		pg = var_2_10003
		var_26_2.helps = var_2_10003.gametip.gift_act_help.tip
	...
	var_1_10002(var_22_6, var_22_7, var_22_8, var_1_10006)
...
function var_0_1.OnOneKey(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1(var_2.ToTable(var_27_0)) do
		var_1_10007 = arg_27_0.tracker

		local var_27_1 = var_6.TransformPoint(var_1_10007, iter_27_1)

		Vector3 = var_1_10007
		var_1_10007 = var_1_10007(var_27_1.x, var_27_1.y, -1)
		table = var_8

		var_8.insert(arg_27_0.points, var_1_10007)
	end
	...
	local function var_27_2(arg_28_0)
		if not arg_27_0.pen then
			...
			Quaternion = var_2_10005
			var_28_0.pen = var_28_1(var_28_2, var_28_3, var_2_10005.New(0, 0, 0, 0), arg_27_0.frame)
		else
	...
	for iter_27_2 = 1, #arg_27_0.points do
		...
		var_1_10007.insert(var_27_3, function(arg_29_0)
	...
	local var_27_4 = arg_27_0.cg

	var_27_4.blocksRaycasts = false
	seriesAsync = var_27_4

	var_27_4(var_27_3, function()
