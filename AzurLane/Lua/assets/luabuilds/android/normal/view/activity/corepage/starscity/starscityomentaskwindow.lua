...
function var_0_1.UpdateListItem(arg_9_0, arg_9_1, arg_9_2)
	...
	for iter_9_0 = 0, var_9_2.childCount - 1 do
		...
		local var_9_8 = var_9_2.GetChild(var_1_10016, iter_9_0)

		arg_9_0:UpdateTaskItem(var_9_7, iter_9_0, var_9_8)
	end

	local var_9_9 = arg_9_0:isTaskLock(var_9_7) ~= 0

	setActive = var_13

	var_13(var_9_3, var_9_9)

	GetOrAddComponent = var_13

	local var_9_10 = var_9_0

	typeof = var_15
	CanvasGroup = var_1_10016

	local var_9_11 = var_13(var_9_10, var_15(var_1_10016))

	var_9_11.alpha = var_9_9 and 0.5 or 1
	switch = var_9_11
	...
	var_9_11(var_11, {
		function()
			...
			var_2(var_10_4, var_10_3("OutPostOmenPage_task_tip1", var_10_1, var_10_2))

			setText = var_2

			local var_10_5 = var_9_6
			local var_10_6 = var_3.Find(var_10_5, "Text")

			i18n = var_10_5

			var_2(var_10_6, var_10_5("OutPostOmenPage_task_tip1", var_10_1, var_10_2))
...
function var_0_1.UpdateTaskItem(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_6 = arg_12_3
	local var_12_7 = arg_12_3.Find(var_12_6, "got_mask")

	Drop = var_12_6

	local var_12_8 = var_12_6.Create(var_12_5.award_display[1])

	updateDrop = var_11

	var_11(var_12_1, var_12_8)
	...
	local function var_12_11()
		...
		var_13_1(var_13_0, var_2_10002.ON_DROP, var_12_8)
	...
	var_11(var_12_9, var_12_10, var_12_11, var_1_10015)
	...
	local var_12_13 = var_12_5.target_num

	setText = var_12_10

	var_12_10(arg_12_3:Find("description"), var_12_5.desc)

	setSlider = var_12_10

	var_12_10(arg_12_3:Find("progress"), 0, var_12_13, var_12_12)

	local var_12_14, var_12_15 = arg_12_0:GetProgressColor()

	setColorStr = var_15

	local var_12_16 = var_15(var_12_12, var_12_14)

	setColorStr = var_16

	local var_12_17 = var_16("/" .. var_12_13, var_12_15)

	setText = var_17

	var_17(arg_12_3:Find("progressText"), var_12_16 .. var_12_17)

	if var_12_4:getTaskStatus() == 2 then
		setActive = var_17

		var_17(var_12_7, true)
	end
