...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	var_1(var_2_4, var_3("pac_game_rule_btn"))
	...
	local function var_2_7()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.sort_minigame_help.tip
	...
	for iter_2_0 = 1, 7 do
		...
		var_1_10008(var_2_13, var_1_10010(arg_2_0._tf, "ad/awards/Viewport/Content"))

		var_1_10008 = iter_2_0
		setText = var_2_13
		findTF = var_1_10010

		var_2_13(var_1_10010(var_1_10007, "ad/desc"), "DAY" .. var_1_10008)

		findTF = var_2_13

		local var_2_14 = var_2_13(var_1_10007, "ad/iconMask/icon")
		...
		var_11(var_2_14, var_1_10010)

		onButton = var_11

		local var_2_15 = arg_2_0
		local var_2_16 = var_2_14
		...
		local function var_2_17()
			...
			var_7_1(var_7_0, var_2_10002.ON_DROP, var_1_10010)
		...
		var_11(var_2_15, var_2_16, var_2_17, var_1_10015)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	for iter_8_0 = 1, 7 do
		...
		local var_8_0 = var_6(arg_8_0.battleItems[iter_8_0], "ad/got")
	...
	local var_8_1 = var_1(var_2)

	if var_1.GetHighScore(var_8_1, var_0_2) then
		local var_8_2 = #var_1
		local var_8_3

		if not (0 < var_8_2) or not var_1[1] then
			var_8_3 = 0
		end

		setText = var_3

		local var_8_4 = arg_8_0.highScoreText

		tostring = var_1_10005

		var_3(var_8_4, var_1_10005(var_8_3))

		local var_8_5 = arg_8_0.coreActivityUI

		if var_3.GetActivityIdByPageClass(var_8_5, "AnniversaryNineInvitationPage") then
			::label_8_0::
			...
			var_8_5 = var_8_5.getActivityById(var_8_6, var_3)
		end
...
function var_0_1.initRankUI(arg_9_0)
	...
	local var_9_1 = var_3(arg_9_0.rankUI, "ad/close")
	...
	var_1(var_9_0, var_9_1, var_9_2, var_5)
	...
	var_1(var_9_3, var_9_4, var_9_5, var_5)
	...
	var_1(var_9_7, var_3("series_enemy_reward_tip4"))
...
function var_0_1.UpdateRankData(arg_12_0, arg_12_1)
	for iter_12_0 = 1, #arg_12_1 do
		...
		if #arg_12_0._rankItems < iter_12_0 then
			...
			local var_12_0 = var_7(var_1_10008(arg_12_0._rankItemTpl))
		...
		arg_12_0.SetRankItemData(var_1_10008, var_1_10006, arg_12_1[iter_12_0], iter_12_0)
...
function var_0_1.SetRankItemData(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_5 = var_1_10009(var_1_10010)
	local var_13_6 = var_9.isSelf(var_13_5, var_13_1)

	setText = var_13_5
	findTF = var_11

	var_13_5(var_11(arg_13_1, "nameText"), var_13_0)
	...
	var_13_8(var_13_7, var_12(arg_13_1, "bg"), false)
	...
	var_13_10(var_13_9, var_12(arg_13_1, "rank"), false)
	...
	var_10(var_13_11, var_12(arg_13_3))
	...
	var_10(var_13_12, var_12(var_13_3))
...
function var_0_1.getRankData(arg_15_0, arg_15_1, arg_15_2)
	...
	var_15_1(var_15_0, var_1_10005.MINI_GAME_FRIEND_RANK, {
		id = arg_15_1,
...
function var_0_1.setChildVisible(arg_18_0, arg_18_1, arg_18_2)
	for iter_18_0 = 1, arg_18_1.childCount do
		...
		local var_18_1 = arg_18_1.GetChild(var_18_0, iter_18_0 - 1)

		setActive = var_18_0

		var_18_0(var_18_1, arg_18_2)
	end
