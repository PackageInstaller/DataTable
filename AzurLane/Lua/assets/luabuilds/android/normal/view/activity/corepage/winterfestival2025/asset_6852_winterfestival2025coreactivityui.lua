...
function var_0_1.GetButtonNameText(arg_2_0, arg_2_1)
	...
	local var_2_1 = arg_2_1.getConfig(var_2_0, "type")

	ActivityConst = var_2_0

	if var_2_1 ~= var_2_0.ACTIVITY_TYPE_TASK_POOL then
		ActivityConst = var_3

		if var_2_1 == var_3.ACTIVITY_TYPE_SHRINE then
			i18n = var_3
		...
		if var_2_1 == var_3.ACTIVITY_TYPE_PT_HEI5 then
			i18n = var_3
...
function var_0_1.CustomInit(arg_4_0)
	...
	local var_4_1 = var_2.Find(var_4_0, "adapt/TopPage/top/deco/Text")

	i18n = var_4_0

	var_1_10001(var_4_1, var_4_0("HelenaCoreActivity_title"))

	setText = var_1_10001

	local var_4_2 = arg_4_0._tf
	local var_4_3 = var_2.Find(var_4_2, "adapt/TopPage/top/deco/Text/Text_1")

	i18n = var_4_2

	var_1_10001(var_4_3, var_4_2("HelenaCoreActivity_title2"))
...
function var_0_1.selectActivity(arg_5_0, arg_5_1)
	...
	local var_5_2 = var_5_1 == var_5_0.ACTIVITY_TYPE_SHRINE

	SetActive = var_4

	local var_5_3 = arg_5_0._tf

	var_4(var_5.Find(var_5_3, "adapt/bg"), not var_5_2)

	SetActive = var_4

	local var_5_4 = arg_5_0._tf

	var_4(var_5.Find(var_5_4, "adapt/bg_1"), not var_5_2)

	SetActive = var_4

	local var_5_5 = arg_5_0._tf

	var_4(var_5.Find(var_5_5, "adapt/bg_shrine"), var_5_2)

	SetActive = var_4

	local var_5_6 = arg_5_0._tf

	var_4(var_5.Find(var_5_6, "adapt/bg_shrine_1"), var_5_2)
