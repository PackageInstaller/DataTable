...
function var_0_1.handleNotification(arg_2_0, arg_2_1)
	...
	if var_2_0 == var_2_1.ACTIVITY_SHOW_RED_PACKET_AWARDS then
		...
		var_4.playAni(var_2_3, function()
			...
			var_3_1(var_3_0, var_2_10002.ON_ACHIEVE, var_2_2.awards, var_2_2.callback)
		...
		if var_2_0 == var_4.ACTIVITY_UPDATED and var_2_2.id == arg_2_0.viewComponent.activityID then
