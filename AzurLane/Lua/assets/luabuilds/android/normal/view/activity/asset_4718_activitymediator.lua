...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.GO_MONOPOLY2024, function(arg_2_0, arg_2_1, arg_2_2)
		...
		MonopolyCar2024Mediator = var_2_10007
		var_2_3.mediator = var_2_10007
		MonopolyCar2024Scene = var_2_10007
	...
	arg_1_0:bind(var_0_1.GO_MONOPOLY2026, function(arg_3_0, arg_3_1, arg_3_2)
		...
		MonopolyCar2026Scene = var_2_10007
	...
	arg_1_0:bind(var_0_1.GO_Activity_level, function(arg_6_0)
		...
		if var_6_1 then
			var_2_10005 = var_1
			var_2_10005 = var_1.getMapById(var_2_10005, var_6_1)

			if not var_2_10004.isUnlock(var_2_10005) then
				getProxy = var_2_10004
				ChapterProxy = var_2_10005
				var_2_10006 = var_2_10004(var_2_10005)

				if var_2_10004.getActiveChapter(var_2_10006) then
					::label_6_0::

					var_2_10007 = var_5
					var_6_1 = var_5.getConfig(var_2_10007, "map")
				end

				if not var_5 then
					var_2_10007 = var_2_10004
					var_6_1 = var_2_10004.GetLastNormalMap(var_2_10007)
				end

				pg = var_2_10006
				var_2_10007 = var_2_10006.m02
				var_2_10006 = var_2_10006.sendNotification
				GAME = var_2_10008

				local var_6_3 = var_2_10008.GO_SCENE

				SCENE = var_2_10009

				var_2_10006(var_2_10007, var_6_3, var_2_10009.LEVEL, {
				...
				local var_6_4 = var_2_10004.m02
				local var_6_5 = var_4.sendNotification

				GAME = var_2_10006

				local var_6_6 = var_2_10006.GO_SCENE

				SCENE = var_2_10007

				var_6_5(var_6_4, var_6_6, var_2_10007.LEVEL, {
					chapterId = var_6_2,
					mapIdx = var_6_1
				})
			end
	...
	arg_1_0:bind(var_0_1.ON_COLLAB_BOSSRUSH_MAP, function()
		...
		var_7_1(var_7_0, var_7_2, var_2_10003.BOSSRUSH_DAL_COLLAB)
	...
	arg_1_0:bind(var_0_1.GO_DECODE_MINI_GAME, function(arg_9_0)
		...
		local var_9_2 = var_2_10003.REQUEST_MINI_GAME
		local var_9_3 = {}

		MiniGameRequestCommand = var_2_10005
		var_9_3.type = var_2_10005.REQUEST_HUB_DATA
		...
		function var_9_3.callback()
			...
			var_10_1(var_10_0, var_3_10002.GO_MINI_GAME, 11)
	...
	arg_1_0:bind(var_0_1.GO_MINI_GAME, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10004.GO_MINI_GAME, arg_11_1)
	...
	arg_1_0:bind(var_0_1.GO_SUBMARINE_RUN, function(arg_12_0, arg_12_1)
		...
		local var_12_2 = var_2_10004.BEGIN_STAGE
		local var_12_3 = {}

		SYSTEM_SUBMARINE_RUN = var_2_10006
		var_12_3.system = var_2_10006
	...
	arg_1_0:bind(var_0_1.GO_DODGEM, function(arg_13_0)
		...
		local var_13_2 = var_13_0[var_13_1(#var_2_10003.Battle.BattleConfig.BATTLE_DODGEM_STAGES)]
		local var_13_3 = arg_1_0
		local var_13_4 = var_2.sendNotification

		GAME = var_2_10004

		local var_13_5 = var_2_10004.BEGIN_STAGE
		local var_13_6 = {}

		SYSTEM_DODGEM = var_2_10006
		var_13_6.system = var_2_10006
	...
	arg_1_0:bind(var_0_1.ON_AIRFIGHT_COMBAT, function(arg_15_0, arg_15_1, arg_15_2)
		...
		local var_15_2 = var_2_10005.BEGIN_STAGE
		local var_15_3 = {}

		SYSTEM_AIRFIGHT = var_2_10007
		var_15_3.system = var_2_10007
	...
	arg_1_0:bind(var_0_1.RETURN_AWARD_OP, function(arg_16_0, arg_16_1)
		...
		if var_16_0 == var_2_10003.RETURN_AWARD_OP_SHOW_AWARD_OVERVIEW then
			var_16_1 = arg_1_0.viewComponent

			local var_16_2 = var_2.ShowWindow

			ReturnerAwardWindow = var_2_10004

			var_16_2(var_16_1, var_2_10004, arg_16_1.arg1)
		else
			local var_16_3 = arg_16_1.cmd

			ActivityConst = var_16_1

			if var_16_3 == var_16_1.RETURN_AWARD_OP_SHOW_RETURNER_AWARD_OVERVIEW then
				local var_16_4 = arg_1_0.viewComponent
				local var_16_5 = var_2.ShowWindow

				TaskAwardWindow = var_2_10004

				var_16_5(var_16_4, var_2_10004, arg_16_1.arg1)
			else
				...
				var_16_7(var_16_6, var_2_10004.RETURN_AWARD_OP, arg_16_1)
			end
		end
	...
	arg_1_0:bind(var_0_1.EVENT_PT_OPERATION, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10004.ACT_NEW_PT, arg_18_1)
	...
	arg_1_0:bind(var_0_1.OPEN_RED_PACKET_LAYER, function(arg_20_0)
		...
		var_20_3.mediator = var_2_10005
		RedPacketLayer = var_2_10005
		var_20_3.viewComponent = var_2_10005
	...
	arg_1_0:bind(var_0_1.CLOSE_LAYER, function(arg_21_0, arg_21_1)
		...
		local var_21_0 = var_2_10002(var_2_10003)
		...
		if var_3.getContextByMediator(var_21_1, arg_21_1) then
			...
			var_21_3(var_21_2, var_2_10007.REMOVE_LAYERS, {
				context = var_4
			})
		end
	...
	arg_1_0:bind(var_0_1.EVENT_OPERATION, function(arg_22_0, arg_22_1)
		...
		var_22_1(var_22_0, var_2_10004.ACTIVITY_OPERATION, arg_22_1)
	...
	arg_1_0:bind(var_0_1.EVENT_GO_SCENE, function(arg_23_0, arg_23_1, arg_23_2)
		...
		if arg_23_1 == var_2_10003.SUMMER_FEAST then
			...
			var_3.Play(var_23_0, "TIANHOUYUYI1", function()
				...
				local var_24_2 = var_3_10002.GO_SCENE

				SCENE = var_3_10003

				var_24_1(var_24_0, var_24_2, var_3_10003.SUMMER_FEAST)
			...
			var_23_2(var_23_1, var_2_10005.GO_SCENE, arg_23_1, arg_23_2)
		end
	...
	arg_1_0:bind(var_0_1.BLACKWHITEGRID, function()
		...
		if not var_25_1(var_25_0, var_2_10002.ACTIVITY_TYPE_BLACKWHITE) then
			pg = var_25_0

			local var_25_2 = var_25_0.TipsMgr.GetInstance()
			local var_25_3 = var_1.ShowTips

			i18n = var_2_10003

			var_25_3(var_25_2, var_2_10003("common_activity_end"))
		...
		local var_25_6 = var_2_10003.New
		local var_25_7 = {}

		BlackWhiteGridLayer = var_2_10005
		var_25_7.viewComponent = var_2_10005
		BlackWhiteGridMediator = var_2_10005
		var_25_7.mediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.MEMORYBOOK, function()
		...
		if not var_26_1(var_26_0, var_2_10002.ACTIVITY_TYPE_PUZZLA) then
			pg = var_26_0

			local var_26_2 = var_26_0.TipsMgr.GetInstance()
			local var_26_3 = var_1.ShowTips

			i18n = var_2_10003

			var_26_3(var_26_2, var_2_10003("common_activity_end"))
		...
		local var_26_6 = var_2_10003.New
		local var_26_7 = {}

		MemoryBookLayer = var_2_10005
		var_26_7.viewComponent = var_2_10005
		MemoryBookMediator = var_2_10005
		var_26_7.mediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.GO_SHOPS_LAYER, function(arg_27_0, arg_27_1)
		...
		local var_27_0 = var_2_10002(var_2_10003)

		if not var_2.getActivityById(var_27_0, arg_27_1.actId) then
			pg = var_27_0

			local var_27_1 = var_27_0.TipsMgr.GetInstance()
			local var_27_2 = var_3.ShowTips

			i18n = var_2_10005

			var_27_2(var_27_1, var_2_10005("common_activity_end"))
		...
		local var_27_5 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		local var_27_6 = var_2_10006.SHOP
		...
		var_27_4(var_27_3, var_27_5, var_27_6, var_2_10007)
	...
	arg_1_0:bind(var_0_1.GO_SHOPS_LAYER_STEEET, function(arg_28_0, arg_28_1)
		...
		local var_28_2 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		local var_28_3 = var_2_10005.SHOP
		...
		if not arg_28_1 then
			...
			var_2_10006.warp = var_2_10007.TYPE_SHOP_STREET
		end

		var_28_1(var_28_0, var_28_2, var_28_3, var_2_10006)
	...
	arg_1_0:bind(var_0_1.BATTLE_OPERA, function()
		...
		local var_29_0 = var_2_10000(var_2_10001)
		local var_29_1, var_29_2 = var_0.getLastMapForActivity(var_29_0)

		if var_29_1 then
			local var_29_3 = var_0:getMapById(var_29_1)

			if not var_2_10003.isUnlock(var_29_3) then
				pg = var_2_10003

				local var_29_4 = var_2_10003.TipsMgr.GetInstance()

				var_2_10003 = var_2_10003.ShowTips
				i18n = var_2_10005

				var_2_10003(var_29_4, var_2_10005("common_activity_end"))
			else
				pg = var_2_10003

				local var_29_5 = var_2_10003.m02
				local var_29_6 = var_3.sendNotification

				GAME = var_2_10005

				local var_29_7 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_29_6(var_29_5, var_29_7, var_2_10006.LEVEL, {
					chapterId = var_29_2,
					mapIdx = var_29_1
				})
			end
	...
	arg_1_0:bind(var_0_1.SKIP_ACTIVITY_MAP, function(arg_30_0, arg_30_1)
		...
		local var_30_0 = var_2_10002(var_2_10003)
		local var_30_1, var_30_2 = var_2.getLastMapForActivity(var_30_0, arg_30_1)

		if var_30_1 then
			local var_30_3 = var_2:getMapById(var_30_1)

			if not var_5.isUnlock(var_30_3) then
				pg = var_5

				local var_30_4 = var_5.TipsMgr.GetInstance()
				local var_30_5 = var_5.ShowTips

				i18n = var_2_10007

				var_30_5(var_30_4, var_2_10007("common_activity_end"))
			else
				...
				local var_30_8 = var_2_10007.GO_SCENE

				SCENE = var_2_10008

				var_30_7(var_30_6, var_30_8, var_2_10008.LEVEL, {
					chapterId = var_30_2,
					mapIdx = var_30_1
				})
			end
	...
	arg_1_0:bind(var_0_1.OPEN_CULTIVATING_PLANT, function(arg_32_0)
		...
		local var_32_2 = var_2_10003.New
		local var_32_3 = {}

		CultivatingPlantMediator = var_2_10005
		var_32_3.mediator = var_2_10005
		CultivatingPlantScene = var_2_10005
		var_32_3.viewComponent = var_2_10005
	...
	arg_1_0:bind(var_0_1.GO_SPECIAL_EXERCISE, function()
		...
		local var_33_2 = var_2_10002.GO_SCENE

		SCENE = var_2_10003

		var_33_1(var_33_0, var_33_2, var_2_10003.ACT_BOSS_BATTLE)
	...
	arg_1_0:bind(var_0_1.SPECIAL_BATTLE_OPERA, function()
		...
		local var_34_0 = var_2_10000(var_2_10001)
		local var_34_1, var_34_2 = var_0.getLastMapForActivity(var_34_0)

		if var_34_1 then
			var_2_10004 = var_0
			var_2_10004 = var_0.getMapById(var_2_10004, var_34_1)

			if not var_2_10003.isUnlock(var_2_10004) then
				getProxy = var_2_10003
				ChapterProxy = var_2_10004
				var_2_10005 = var_2_10003(var_2_10004)

				if var_2_10003.getActiveChapter(var_2_10005) then
					::label_34_0::

					var_2_10006 = var_4
					var_34_1 = var_4.getConfig(var_2_10006, "map")
				end

				if not var_4 then
					var_2_10006 = var_2_10003
					var_34_1 = var_2_10003.GetLastNormalMap(var_2_10006)
				end

				pg = var_2_10005
				var_2_10006 = var_2_10005.m02
				var_2_10005 = var_2_10005.sendNotification
				GAME = var_2_10007

				local var_34_3 = var_2_10007.GO_SCENE

				SCENE = var_2_10008

				var_2_10005(var_2_10006, var_34_3, var_2_10008.LEVEL, {
				...
				local var_34_4 = var_2_10003.m02
				local var_34_5 = var_3.sendNotification

				GAME = var_2_10005

				local var_34_6 = var_2_10005.GO_SCENE

				SCENE = var_2_10006

				var_34_5(var_34_4, var_34_6, var_2_10006.LEVEL, {
					chapterId = var_34_2,
					mapIdx = var_34_1
				})
			end
	...
	arg_1_0:bind(var_0_1.GO_LOTTERY, function(arg_36_0)
		...
		local var_36_0 = var_2_10001(var_2_10002)
		local var_36_1 = var_1.getActivityByType

		ActivityConst = var_2_10003

		local var_36_2 = var_36_1(var_36_0, var_2_10003.ACTIVITY_TYPE_LOTTERY)
		local var_36_3 = arg_1_0
		local var_36_4 = var_2.addSubLayers

		Context = var_2_10004

		local var_36_5 = var_2_10004.New
		local var_36_6 = {}

		LotteryMediator = var_2_10006
		var_36_6.mediator = var_2_10006
		LotteryLayer = var_2_10006
		var_36_6.viewComponent = var_2_10006
		var_36_6.data = {
	...
	arg_1_0:bind(var_0_1.GO_BACKYARD, function(arg_37_0)
		...
		local var_37_2 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_37_1(var_37_0, var_37_2, var_2_10004.COURTYARD)
	...
	arg_1_0:bind(var_0_1.EVENT_COLORING_ACHIEVE, function(arg_38_0, arg_38_1)
		...
		var_38_1(var_38_0, var_2_10004.COLORING_ACHIEVE, arg_38_1)
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT, function(arg_39_0, arg_39_1, arg_39_2)
		...
		var_39_1(var_39_0, var_2_10005.SUBMIT_TASK, arg_39_1.id, arg_39_2)
	...
	arg_1_0:bind(var_0_1.ON_TASK_SUBMIT_ONESTEP, function(arg_40_0, arg_40_1)
		...
		var_40_1(var_40_0, var_2_10004.SUBMIT_TASK_ONESTEP, {
			resultList = arg_40_1
		})
	...
	arg_1_0:bind(var_0_1.ON_TASK_GO, function(arg_41_0, arg_41_1)
		...
		var_41_1(var_41_0, var_2_10004.TASK_GO, {
			taskVO = arg_41_1
		})
	...
	arg_1_0:bind(var_0_1.GO_PRAY_POOL, function(arg_42_0)
		...
		local var_42_2 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_42_1(var_42_0, var_42_2, var_2_10004.GETBOAT, {
			goToPray = true
		})
	...
	arg_1_0:bind(var_0_1.FETCH_INSTARGRAM, function(arg_43_0, ...)
		...
		var_43_1(var_43_0, var_2_10003.ACT_INSTAGRAM_FETCH, ...)
	...
	arg_1_0:bind(var_0_1.MUSIC_GAME_OPERATOR, function(arg_44_0, ...)
		...
		var_44_1(var_44_0, var_2_10003.SEND_MINI_GAME_OP, ...)
	...
	arg_1_0:bind(var_0_1.ACTIVITY_PERMANENT, function(arg_47_0, arg_47_1)
		...
		if var_47_0 ~= var_3.gameset.permanent_mark.description then
			PlayerPrefs = var_47_0
			var_47_0 = var_47_0.SetString
			var_47_1 = "permanent_time"
			pg = var_4

			var_47_0(var_47_1, var_4.gameset.permanent_mark.description)
		...
		if var_47_3(var_47_2, var_4.TYPE_NORMAL_ACTIVITY) then
			pg = var_47_2

			local var_47_4 = var_47_2.TipsMgr.GetInstance()
			local var_47_5 = var_3.ShowTips

			i18n = var_2_10005

			var_47_5(var_47_4, var_2_10005("activity_permanent_tips3"))
			...
			local var_47_9 = var_2_10005.New
			local var_47_10 = {}

			ActivityPermanentMediator = var_2_10007
			var_47_10.mediator = var_2_10007
			ActivityPermanentLayer = var_2_10007
			var_47_10.viewComponent = var_2_10007
			var_47_10.data = {
				finishId = arg_47_1
			}
	...
	arg_1_0:bind(var_0_1.FINISH_ACTIVITY_PERMANENT, function(arg_48_0)
		...
		local var_48_2 = var_48_1(var_48_0, var_2_10003.TYPE_NORMAL_ACTIVITY)

		assert = var_48_0

		var_48_0(var_48_2:canPermanentFinish(), "error permanent activity finish")
		...
		var_48_4(var_48_3, var_4.ACTIVITY_PERMANENT_FINISH, {
	...
	arg_1_0:bind(var_0_1.GO_PERFORM_COMBAT, function(arg_49_0, arg_49_1, arg_49_2)
		...
		local var_49_2 = var_2_10005.BEGIN_STAGE
		local var_49_3 = {}

		SYSTEM_PERFORM = var_2_10007
		var_49_3.system = var_2_10007
	...
	arg_1_0:bind(var_0_1.GO_CARDPUZZLE_COMBAT, function(arg_51_0, arg_51_1)
		...
		local var_51_2 = var_2_10004.BEGIN_STAGE
		local var_51_3 = {}

		SYSTEM_CARDPUZZLE = var_2_10006
		var_51_3.system = var_2_10006
	...
	arg_1_0:bind(var_0_1.CHARGE, function(arg_52_0, arg_52_1)
		...
		var_52_1(var_52_0, var_2_10004.CHARGE_OPERATION, {
			shopId = arg_52_1
		})
	...
	arg_1_0:bind(var_0_1.BUY_ITEM, function(arg_53_0, arg_53_1, arg_53_2)
		...
		var_53_1(var_53_0, var_2_10005.SHOPPING, {
			id = arg_53_1,
			count = arg_53_2
		})
	...
	arg_1_0:bind(var_0_1.OPEN_CHARGE_ITEM_PANEL, function(arg_54_0, arg_54_1)
		...
		local var_54_2 = var_2_10004.New
		local var_54_3 = {}

		ChargeItemPanelMediator = var_2_10006
		var_54_3.mediator = var_2_10006
		ChargeItemPanelLayer = var_2_10006
		var_54_3.viewComponent = var_2_10006
		var_54_3.data = {
	...
	arg_1_0:bind(var_0_1.OPEN_CHARGE_BIRTHDAY, function(arg_55_0, arg_55_1)
		...
		local var_55_2 = var_2_10004.New
		local var_55_3 = {}

		ChargeBirthdayMediator = var_2_10006
		var_55_3.mediator = var_2_10006
		ChargeBirthdayLayer = var_2_10006
		var_55_3.viewComponent = var_2_10006
		var_55_3.data = {}
	...
	arg_1_0:bind(var_0_1.STORE_DATE, function(arg_56_0, arg_56_1)
		...
		local var_56_2 = var_2_10004.ACTIVITY_STORE_DATE
		local var_56_3 = {
	...
	arg_1_0:bind(var_0_1.ON_ACT_SHOPPING, function(arg_57_0, arg_57_1, arg_57_2, arg_57_3, arg_57_4, arg_57_5)
		...
		var_57_1(var_57_0, var_2_10008.ACTIVITY_OPERATION, {
	...
	arg_1_0:bind(var_0_1.ON_ACTIVITY_TASK_SUBMIT, function(arg_58_0, arg_58_1)
		...
		var_58_1(var_58_0, var_2_10004.SUBMIT_ACTIVITY_TASK, {
	...
	arg_1_0:bind(var_0_1.ON_ACTIVITY_TASK_LIST_SUBMIT, function(arg_59_0, arg_59_1)
		...
		var_59_1(var_59_0, var_2_10004.SUBMIT_ACTIVITY_TASK, {
	...
	arg_1_0:bind(var_0_1.GO_SINGLE_PRECOMBAT, function(arg_60_0, arg_60_1)
		...
		local var_60_2 = var_2_10004.New
		local var_60_3 = {}

		BossSinglePreCombatLiteMediator = var_2_10006
		var_60_3.mediator = var_2_10006
		BossSinglePreCombatLiteLayer = var_2_10006
		var_60_3.viewComponent = var_2_10006
		var_60_3.data = {
...
function var_0_1.initNotificationHandleDic(arg_62_0)
	...
	var_62_0[var_2.ACTIVITY_ADDED] = function(arg_64_0, arg_64_1)
		...
		local var_64_1 = var_2.getConfig(var_64_0, "type")

		ActivityConst = var_64_0

		if var_64_1 == var_64_0.ACTIVITY_TYPE_LOTTERY then
			return
		end

		local var_64_2 = arg_64_0.viewComponent

		var_3.updateActivity(var_64_2, var_2)
		...
		if var_3.AOERLIANG_TASK_ID == var_2.id then
			...
			var_3.update_task_list_auto_aoerliang(var_64_3, var_2)
		end
	...
	var_62_0[var_2.ACTIVITY_OPERATION_DONE] = function(arg_67_0, arg_67_1)
		...
		local var_67_1 = arg_67_1.getBody(var_67_0)

		getProxy = var_67_0
		ActivityProxy = var_2_10004

		local var_67_2 = var_67_0(var_2_10004)
		local var_67_3 = var_3.getActivityById(var_67_2, var_67_1)
		local var_67_4 = var_3.getConfig(var_67_3, "type")

		ActivityConst = var_67_3

		if var_67_4 == var_67_3.ACTIVITY_TYPE_HOTSPRING_2 then
			local var_67_5 = arg_67_0.viewComponent

			var_67_4.updateActivity(var_67_5)
		end

		MonthSignPage = var_67_4

		if var_67_4.ShouldPlaySpEffect(var_3) and arg_67_0.viewComponent.pageDic[var_3.id] then
			var_4:ActionInvoke("TryShowSpEffect", function()
				...
				var_68_1(var_68_0, var_2.getConfig(var_68_2, "page_core"))
		...
		if var_4.AOERLIANG_TASK_ID == var_67_1 then
			return
		end
	...
	var_62_0[var_2.ACTIVITY_SHOW_AWARDS] = function(arg_69_0, arg_69_1)
		...
		var_69_2(var_69_1, var_2_10006.ON_ACHIEVE, var_69_0, var_2.callback)
	...
	var_62_0[var_2.ACTIVITY_SHOW_BB_RESULT] = function(arg_70_0, arg_70_1)
		...
		var_70_2(var_70_1, var_2_10005.ON_BOBING_RESULT, var_70_0)
	...
	var_62_0[var_2.ACTIVITY_SHOW_SHAKE_BEADS_RESULT] = function(arg_72_0, arg_72_1)
		...
		var_72_2(var_72_1, var_2_10005.ON_SHAKE_BEADS_RESULT, var_72_0)
	...
	var_62_0[var_2.SUBMIT_TASK_DONE] = function(arg_73_0, arg_73_1)
		...
		var_73_2(var_73_1, var_2_10005.ON_ACHIEVE, var_73_0, function()
	...
	var_62_0[var_2.SUBMIT_ACTIVITY_TASK_DONE] = function(arg_75_0, arg_75_1)
		...
		var_75_2(var_75_1, var_2_10005.ON_ACHIEVE, var_75_0.awards, function()
	...
	var_62_0[var_2.ACT_NEW_PT_DONE] = function(arg_77_0, arg_77_1)
		...
		var_77_2(var_77_1, var_2_10005.ON_ACHIEVE, var_77_0.awards, function()
	...
	var_62_0[var_2.BEGIN_STAGE_DONE] = function(arg_79_0, arg_79_1)
		...
		local var_79_3 = var_2_10005.GO_SCENE

		SCENE = var_2_10006

		var_79_2(var_79_1, var_79_3, var_2_10006.COMBATLOAD, var_79_0)
	...
	var_62_0[var_2.RETURN_AWARD_OP_DONE] = function(arg_80_0, arg_80_1)
		...
		var_80_2(var_80_1, var_2_10005.ON_ACHIEVE, var_80_0.awards)
	...
	var_62_0[var_2.REMOVE_LAYERS] = function(arg_83_0, arg_83_1)
		local var_83_0 = arg_83_1:getBody().context.mediator

		VoteFameHallMediator = var_2_10004

		if var_83_0 == var_2_10004 then
			local var_83_1 = arg_83_0.viewComponent

			var_3.updateEntrances(var_83_1)
		end
	...
	var_62_0[var_2.MONOPOLY_AWARD_DONE] = function(arg_84_0, arg_84_1)
		...
		if arg_84_0.viewComponent.pageDic[arg_84_0.viewComponent.activity.id] then
			...
			ActivityConst = var_84_1

			if var_84_2 == var_84_1.ACTIVITY_TYPE_MONOPOLY and var_3.onAward then
		...
		if var_84_0.autoFlag then
			...
			var_84_4(var_84_3, var_2_10006.ON_ACHIEVE_AUTO, var_84_0.awards, 1, var_84_0.callback)
		else
			...
			var_84_6(var_84_5, var_2_10006.ON_ACHIEVE, var_84_0.awards, var_84_0.callback)
		end
			...
			function(arg_86_0)
				if #var_85_0.awards > 0 then
					if arg_85_0.viewComponent then
						...
						var_86_1(var_86_0, var_3_10004.ON_ACHIEVE, var_1, arg_86_0)
					else
						...
						var_86_3(var_86_2, var_3_10004.ON_ACHIEVE, var_1, arg_86_0)
					end
				else
					arg_86_0()
				end
	...
	var_62_0[var_2.ACTIVITY_PERMANENT_START_DONE] = function(arg_88_0, arg_88_1)
		...
		local var_88_1 = arg_88_1.getBody(var_88_0)

		getProxy = var_88_0
		ActivityPermanentProxy = var_2_10004

		local var_88_2 = var_88_0(var_2_10004)

		if not var_3.IsNormalActivityId(var_88_2, var_88_1.id) then
			return
		end

		local var_88_3 = arg_88_0.viewComponent

		var_3.verifyTabs(var_88_3, var_88_1.id)
	...
	var_62_0[var_2.ACTIVITY_PERMANENT_FINISH_DONE] = function(arg_89_0, arg_89_1)
		...
		local var_89_1 = arg_89_1.getBody(var_89_0)

		getProxy = var_89_0
		ActivityPermanentProxy = var_2_10004

		local var_89_2 = var_89_0(var_2_10004)

		if not var_3.IsNormalActivityId(var_89_2, var_89_1.activity_id) then
			return
		end

		local var_89_3 = arg_89_0.viewComponent
		local var_89_4 = var_3.emit

		ActivityMediator = var_5

		var_89_4(var_89_3, var_5.ACTIVITY_PERMANENT, var_89_1.activity_id)
	...
	var_62_0[var_2.MEMORYBOOK_UNLOCK_AWARD_DONE] = function(arg_90_0, arg_90_1)
		...
		var_90_2(var_90_1, var_2_10005.ON_ACHIEVE, var_90_0.awards)
	...
	var_62_0[var_2.CHARGE_SUCCESS] = function(arg_91_0, arg_91_1)
		...
		local var_91_4 = var_91_2(var_91_3, var_5.TYPE_CHARGE)
	...
	var_62_0[var_2.SHOPPING_DONE] = function(arg_92_0, arg_92_1)
		...
		local var_92_1 = arg_92_1.getBody(var_92_0)

		warning = var_92_0

		var_92_0("yzh")

		local var_92_2 = arg_92_0.viewComponent
		local var_92_3 = var_3.emit

		BaseUI = var_2_10005

		var_92_3(var_92_2, var_2_10005.ON_ACHIEVE, var_92_1.awards, function()
	...
	var_62_0[var_2.ACT_MANUAL_SIGN_DONE] = function(arg_94_0, arg_94_1)
		...
		var_94_2(var_94_1, var_2_10005.ON_ACHIEVE, var_94_0.awards)
	...
	var_62_0[var_2.ACTIVITY_SHOP_SHOW_AWARDS] = function(arg_95_0, arg_95_1)
		...
		var_95_2(var_95_1, var_2_10005.ON_ACHIEVE, var_95_0.awards, function()
			getProxy = var_3_10000
			ActivityProxy = var_3_10001

			local var_96_0 = var_3_10000(var_3_10001)
			local var_96_1 = var_0.getActivityByType

			ActivityConst = var_3_10002

			if var_96_1(var_96_0, var_3_10002.ACTIVITY_TYPE_UR_EXCHANGE) and not var_0:isShow() and var_0:isCorePage(arg_95_0.contextData.coreName) then
...
function var_0_1.showNextActivity(arg_97_0, arg_97_1)
	...
	if var_2:findNextAutoActivity(arg_97_1) then
		local var_97_0 = var_3.id

		ActivityConst = var_5

		if var_97_0 == var_5.BLACK_FRIDAY_SIGNIN_ACT_ID then
			arg_97_0.contextData.showByNextAct = true

			local var_97_1 = arg_97_0.viewComponent
			local var_97_2 = var_4.verifyTabs

			ActivityConst = var_1_10006

			var_97_2(var_97_1, var_1_10006.BLACK_FRIDAY_ACT_ID)
		else
			local var_97_3 = arg_97_0.viewComponent

			var_4.verifyTabs(var_97_3, var_3.id)
		end

		local var_97_4 = var_3
		local var_97_5 = var_3.getConfig(var_97_4, "type")

		ActivityConst = var_97_4

		local var_97_6

		if var_97_5 == var_97_4.ACTIVITY_TYPE_7DAYSLOGIN then
			var_1_10006 = arg_97_0
			var_97_6 = arg_97_0.sendNotification
			GAME = var_1_10007

			var_97_6(var_1_10006, var_1_10007.ACTIVITY_OPERATION, {
				cmd = 1,
				activity_id = var_3.id
			})
		else
			ActivityConst = var_97_6

			local var_97_7

			if var_97_5 == var_97_6.ACTIVITY_TYPE_MONTHSIGN then
				var_1_10006 = var_3
				var_97_7 = var_3.getSpecialData(var_1_10006, "reMonthSignDay") ~= nil and 3 or 1
				var_1_10007 = arg_97_0
				var_1_10006 = arg_97_0.sendNotification
				GAME = var_1_10008

				var_1_10006(var_1_10007, var_1_10008.ACTIVITY_OPERATION, {
					activity_id = var_3.id,
					cmd = var_97_7,
				...
				if var_97_5 == var_97_7.ACTIVITY_TYPE_PROGRESSLOGIN then
					var_1_10006 = arg_97_0

					local var_97_8 = arg_97_0.sendNotification

					GAME = var_1_10007

					var_97_8(var_1_10006, var_1_10007.ACTIVITY_OPERATION, {
						activity_id = var_3.id,
						cmd = var_3.data1 < 7 and 1 or 2
					})
				else
					local var_97_9 = var_3.id

					ActivityConst = var_1_10006

					if var_97_9 == var_1_10006.SHADOW_PLAY_ID then
						var_3.clientData1 = 1
						var_1_10006 = arg_97_0

						arg_97_0.showNextActivity(var_1_10006, arg_97_1)
					end
				end
			end
		end
	...
	if not arg_97_0.viewComponent.activity then
		local var_97_10 = arg_97_0:getDisplayActivity()

		if not arg_97_0.contextData.id then
			if arg_97_0.contextData.type then
				checkExist = var_97_11
				_ = var_1_10006

				do
					local var_97_11

					if not var_97_11(var_1_10006.detect(var_97_10, function(arg_98_0)
					...
					local var_97_12 = arg_97_0.viewComponent

					var_6.verifyTabs(var_97_12, var_97_11)
				end
