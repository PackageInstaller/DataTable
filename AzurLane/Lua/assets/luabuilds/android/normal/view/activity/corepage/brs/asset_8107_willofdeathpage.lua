...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.rtTask = var_1.Find(var_1_1, "task")

	local var_1_2 = arg_1_0.rtTask
	...
	local var_1_6 = arg_1_0.rtTask

	arg_1_0.awardTF = var_1.Find(var_1_6, "award")

	local var_1_7 = arg_1_0.rtTask
...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local var_3_0 = arg_3_0.rtTask
	local var_3_1 = var_2.Find(var_3_0, "taskDesc")

	i18n = var_3_0

	var_1_10001(var_3_1, var_3_0("brs_dmact_tip"))

	onButton = var_1_10001

	local var_3_2 = arg_3_0
	local var_3_3 = arg_3_0.displayBtn
	...
	var_1_10001(var_3_2, var_3_3, var_3_4, var_1_10005)

	onButton = var_1_10001

	local var_3_5 = arg_3_0
	local var_3_6 = arg_3_0.battleBtn
	...
	local function var_3_7()
		...
		if var_2.getConfig(var_5_2, "config_client") ~= "" then
			...
			if var_5_2.getConfig(var_5_3, "config_client").linkActID then
				getProxy = var_5_2
				ActivityProxy = var_5_3

				local var_5_4 = var_5_2(var_5_3)

				var_5_1 = var_5_2.getActivityById(var_5_4, var_5_0)
			end
		end
		...
		if not var_5_0 then
			...
			var_5_2(var_5_5, var_2_10005.BATTLE_OPERA)
		elseif var_5_1 and not var_5_1:isEnd() then
			...
			var_5_2(var_5_6, var_2_10005.BATTLE_OPERA)
		else
			pg = var_5_2

			local var_5_7 = var_5_2.TipsMgr.GetInstance()
			local var_5_8 = var_3.ShowTips

			i18n = var_2_10005

			var_5_8(var_5_7, var_2_10005("common_activity_end"))
		end
	...
	var_1_10001(var_3_5, var_3_6, var_3_7, var_1_10005)
	...
	local function var_3_10()
		...
		var_8(var_6_0, function()
			...
			local var_8_5 = var_3_10004.EVENT_PT_OPERATION
			local var_8_6 = {
				cmd = 1
			}
	...
	var_1_10001(var_3_8, var_3_9, var_3_10, var_1_10005)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	if arg_9_0.step then
		...
		local var_9_9 = arg_9_0.step

		string = var_1_10008

		var_6(var_9_9, var_1_10008.format("<size=52>%s</size><size=32><color=#ffffff33>/%s</color></size>", var_9_6, var_9_7))
	end

	local var_9_10 = arg_9_0.ptData
	local var_9_11, var_9_12, var_9_13 = var_3.GetResProgress(var_9_10)

	setText = var_6

	local var_9_14 = arg_9_0.progress

	string = var_1_10008

	local var_9_15 = var_1_10008.format
	local var_9_16 = "%s<color=#ffffff33>/%s</color>"

	if 1 <= var_9_13 then
		setColorStr = var_10

		local var_9_17 = var_9_11

		COLOR_GREEN = var_1_10012

		local var_9_18

		if not var_10(var_9_17, var_1_10012) then
			var_9_18 = var_9_11
		end

		var_6(var_9_14, var_9_15(var_9_16, var_9_18, var_9_12))

		setSlider = var_6

		var_6(arg_9_0.slider, 0, 1, var_9_13)

		local var_9_19 = arg_9_0.ptData
		local var_9_20 = var_6.CanGetAward(var_9_19)
		local var_9_21 = arg_9_0.ptData
		local var_9_22 = var_7.CanGetNextAward(var_9_21)
		local var_9_23 = arg_9_0.ptData
		local var_9_24 = var_8.CanGetMorePt(var_9_23)

		setActive = var_9_23

		var_9_23(arg_9_0.battleBtn, var_9_24 and not var_9_20 and var_9_22)

		setActive = var_9_23

		var_9_23(arg_9_0.getBtn, var_9_20)

		setActive = var_9_23

		var_9_23(arg_9_0.gotBtn, not var_9_22)

		local var_9_25 = arg_9_0.ptData
		local var_9_26 = var_9.GetAward(var_9_25)

		updateDrop = var_9_25

		var_9_25(arg_9_0.awardTF, var_9_26)

		onButton = var_9_25

		local var_9_27 = arg_9_0
		local var_9_28 = arg_9_0.awardTF
		...
		local function var_9_29()
			...
			var_10_1(var_10_0, var_2_10002.ON_DROP, var_9_26)
		...
		var_9_25(var_9_27, var_9_28, var_9_29, var_1_10014)
...
function var_0_1.GetWorldPtData(arg_12_0, arg_12_1)
	...
	ActivityMainScene = var_12_0

	local var_12_2

	if not var_12_0.Data2Time then
		var_12_2 = 0
	end
	...
	if arg_12_1 <= var_12_1 - var_12_2 then
		...
		var_12_7.activity_id = var_6.GetId(var_12_8)
