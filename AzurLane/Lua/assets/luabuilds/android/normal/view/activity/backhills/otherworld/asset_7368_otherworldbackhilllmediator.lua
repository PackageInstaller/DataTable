...
function var_0_1.BindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.MINI_GAME_OPERATOR, function(arg_6_0, ...)
		...
		var_6_1(var_6_0, var_2_10003.SEND_MINI_GAME_OP, ...)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.SEND_MINI_GAME_OP_DONE then
		var_8_3 = {
			function(arg_9_0)
				if #var_8_2.awards > 0 then
					...
					var_9_1(var_9_0, var_2_10004.ON_ACHIEVE, var_1, arg_9_0)
				else
					arg_9_0()
				end
		...
		if var_8_0 == var_8_3.ACTIVITY_UPDATED then
