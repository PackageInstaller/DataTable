...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.mapContent = var_1.Find(var_2_6, "bg/area/content")

	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_1.Find(var_2_7, "bg/area/content/name")
	local var_2_9 = var_1.GetComponent

	typeof = var_3
	Text = iter_2_0
	arg_2_0.mapNameTxt = var_2_9(var_2_8, var_3(iter_2_0))

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_1.Find(var_2_10, "bg/area/content/scrollrect/desc")
	local var_2_12 = var_1.GetComponent

	typeof = var_3
	Text = iter_2_0
	arg_2_0.mapDescTxt = var_2_12(var_2_11, var_3(iter_2_0))

	local var_2_13 = arg_2_0._tf

	arg_2_0.mapGoBtn = var_1.Find(var_2_13, "bg/area/content/btn_go")

	local var_2_14 = arg_2_0._tf

	arg_2_0.mapGetBtn = var_1.Find(var_2_14, "bg/area/content/btn_get")

	local var_2_15 = arg_2_0._tf

	arg_2_0.mapGotBtn = var_1.Find(var_2_15, "bg/area/content/btn_got")
	UIItemList = var_1

	local var_2_16 = var_1.New
	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_2.Find(var_2_17, "bg/area/content/awards/list")
	local var_2_19 = arg_2_0._tf

	arg_2_0.mapAwardList = var_2_16(var_2_18, var_3.Find(var_2_19, "bg/area/content/awards/list/award"))
	UIItemList = var_1

	local var_2_20 = var_1.New
	local var_2_21 = arg_2_0._tf
	local var_2_22 = var_2.Find(var_2_21, "bg/area/content/scrollrect/desc/lines")
	local var_2_23 = arg_2_0._tf

	arg_2_0.lineUIList = var_2_20(var_2_22, var_3.Find(var_2_23, "bg/area/content/scrollrect/desc/lines/tpl"))

	local var_2_24 = arg_2_0._tf

	arg_2_0.exGoBtn = var_1.Find(var_2_24, "bg/ex/content/btn_go")

	local var_2_25 = arg_2_0._tf

	arg_2_0.exGetBtn = var_1.Find(var_2_25, "bg/ex/content/btn_get")

	local var_2_26 = arg_2_0._tf

	arg_2_0.exGotBtn = var_1.Find(var_2_26, "bg/ex/content/btn_got")
	UIItemList = var_1

	local var_2_27 = var_1.New
	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_2.Find(var_2_28, "bg/ex/content/awards/list")
	local var_2_30 = arg_2_0._tf

	arg_2_0.exAwardList = var_2_27(var_2_29, var_3.Find(var_2_30, "bg/ex/content/awards/list/award"))
	UIItemList = var_1

	local var_2_31 = var_1.New
	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_2.Find(var_2_32, "bg/ex/content/scrollrect/content")
	local var_2_34 = arg_2_0._tf

	arg_2_0.exContentList = var_2_31(var_2_33, var_3.Find(var_2_34, "bg/ex/content/scrollrect/content/tpl"))

	local var_2_35 = arg_2_0._tf

	arg_2_0.exContent = var_1.Find(var_2_35, "bg/ex/content")
	UIItemList = var_1

	local var_2_36 = var_1.New
	local var_2_37 = arg_2_0._tf
	local var_2_38 = var_2.Find(var_2_37, "bg/area/list")
	local var_2_39 = arg_2_0._tf

	arg_2_0.areaList = var_2_36(var_2_38, var_3.Find(var_2_39, "bg/area/list/1"))
	UIItemList = var_1

	local var_2_40 = var_1.New
	local var_2_41 = arg_2_0._tf
	local var_2_42 = var_2.Find(var_2_41, "bg/ex/list")
	local var_2_43 = arg_2_0._tf

	arg_2_0.exploreList = var_2_40(var_2_42, var_3.Find(var_2_43, "bg/ex/list/tpl"))
	setText = var_1

	local var_2_44 = arg_2_0._tf
	local var_2_45 = var_2.Find(var_2_44, "bg/tags/area/Text")

	i18n = var_2_44

	var_1(var_2_45, var_2_44("dreamland_label_area"))

	setText = var_1

	local var_2_46 = arg_2_0._tf
	local var_2_47 = var_2.Find(var_2_46, "bg/tags/ex/Text")

	i18n = var_2_46

	var_1(var_2_47, var_2_46("dreamland_label_explore"))

	setText = var_1

	local var_2_48 = arg_2_0._tf
	local var_2_49 = var_2.Find(var_2_48, "bg/ex/content/award_desc")

	i18n = var_2_48

	var_1(var_2_49, var_2_48("dreamland_label_explore_award_tip"))

	local var_2_50 = arg_2_0._tf

	arg_2_0.tipTr = var_1.Find(var_2_50, "tip")

	local var_2_51 = arg_2_0.tipTr
	local var_2_52 = var_1.Find(var_2_51, "Text")
	local var_2_53 = var_1.GetComponent

	typeof = var_3
	Text = var_4
	arg_2_0.tipTxt = var_2_53(var_2_52, var_3(var_4))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_7 = var_2.New(1, 1, 1, 1)
	...
	local function var_3_8(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_6_1(var_6_0, var_4(var_2_10005))
		...
		local var_6_5 = var_6_4(var_6_3, var_5(var_2_10006))
		local var_6_6
	...
	for iter_3_0, iter_3_1 in var_4(arg_3_0.tags) do
		...
		var_1_10009(var_3_9, var_3_10, var_3_11, var_1_10013)
	...
	DreamlandScene = var_6

	var_3_13(var_3_12, var_6.ON_DATA_UPDATE, function(arg_8_0, arg_8_1)
...
function var_0_1.OnDataUpdate(arg_9_0, arg_9_1)
	...
	if not arg_9_0.isShowing(var_9_0) then
		return
	end

	local var_9_1 = arg_9_1.cmd

	DreamlandData = var_9_0

	local var_9_2

	if var_9_1 == var_9_0.OP_GET_MAP_AWARD then
		var_9_2 = arg_9_0

		arg_9_0.UpdateAreaPage(var_9_2)
	else
		local var_9_3 = arg_9_1.cmd

		DreamlandData = var_9_2

		if var_9_3 == var_9_2.OP_GET_EXPLORE_AWARD then
...
function var_0_1.UpdateTip(arg_11_0)
	...
	var_1_10001(var_11_0, var_3.ExistAnyMapAward(var_11_1))
	...
	var_1_10001(var_11_2, var_3.ExistAnyExploreAward(var_11_3))
...
function var_0_1.InitArea(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_3 = var_14_2(var_14_1, var_6(var_1_10007))
	...
	local var_14_5 = arg_14_2.Find(var_14_4, "selected")
	...
	local function var_14_8(arg_15_0)
		if arg_15_0 then
			var_2_10002 = arg_14_0

			var_1.UpdateArea(var_2_10002, arg_14_1)
		end
		...
		if arg_15_0 then
			...
			var_2_10002 = arg_14_0.gameData
			var_15_0 = not var_1.IsUnlockMap(var_2_10002, arg_14_1)
		end
		...
		if var_15_0 and not arg_14_0.initFlag then
			...
			var_2_10002(var_15_1, var_2_10004("dreamland_area_lock_tip"))
		end

		if var_15_0 then
			setActive = var_2_10002

			var_2_10002(var_14_5, false)
		end
	...
	var_14_4(var_14_6, var_14_7, var_14_8, var_1_10010)
...
function var_0_1.GetLineCunt(arg_16_0, arg_16_1)
	...
	local var_16_3 = var_16_2(var_16_1, var_1_10005(var_1_10006)).spacing

	math = var_5

	local var_16_4 = var_5.max

	math = var_1_10006

	return var_16_4(var_1_10006.ceil(var_16_0 / var_16_3), 4)
end
...
function var_0_1.UpdateArea(arg_17_0, arg_17_1)
	...
	if not var_2.IsUnlockMap(var_17_0, arg_17_1) then
		...
		var_17_0(arg_17_0.mapContent, false)
	...
	var_17_0(arg_17_0.mapContent, true)
	...
	var_17_4(arg_17_0.mapGoBtn, not var_2)

	setActive = var_17_4

	var_17_4(arg_17_0.mapGetBtn, var_2 and not var_17_5)

	setActive = var_17_4

	var_17_4(arg_17_0.mapGotBtn, var_2 and var_17_5)
	...
	local function var_17_11()
		if var_0 and not var_17_5 then
			...
			var_0.CheckAwardOverflow(var_20_0, var_17_6, function()
				...
				DreamlandMediator = var_3_10002

				local var_21_2 = var_3_10002.GET_MAP_AWARD
				local var_21_3 = arg_17_0.gameData

				var_21_1(var_21_0, var_21_2, var_3.GetActivityId(var_21_3), arg_17_1)
	...
	var_6(var_17_9, var_17_10, var_17_11, var_1_10010)
...
function var_0_1.UpdateAreaPage(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1(arg_24_0.areaTrs) do
		...
		if var_24_1 then
			...
			var_24_4 = not var_9.IsReceiveMapAward(var_24_3, iter_24_0)
		end
		...
		var_24_0(iter_24_1:Find("mask"), not var_24_1)
	end
...
function var_0_1.InitExplore(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_2 = var_25_0("ui/DlHandBookUI_atlas", "ex_print" .. arg_25_2)
	...
	local var_25_5 = var_25_4(var_25_3, var_7(var_1_10008))
	...
	local var_25_8 = var_25_7(var_25_6, var_8(var_1_10009))

	Color = var_25_6

	local var_25_9 = var_25_6.New(0.3058824, 0.3058824, 0.3607843)

	Color = var_8

	local var_25_10 = var_8.New(0.145098, 0.3215686, 0.9254902)
	...
	local function var_25_13(arg_26_0)
		...
		if arg_26_0 then
			...
			if not var_1.IsUnlockMap(var_26_1, arg_25_2) then
				...
				var_1(var_2.Find(var_26_2, "selected"), false)
			end
		end
	...
	var_9(var_25_11, var_25_12, var_25_13, var_1_10013)

	onButton = var_9

	local var_25_14 = arg_25_0
	local var_25_15 = arg_25_1:Find("lock")

	local function var_25_16(arg_27_0)
		local var_27_0 = arg_25_0
		local var_27_1 = var_1.ShowTip

		i18n = var_2_10003

		var_27_1(var_27_0, var_2_10003("dreamland_area_lock_tip"))
	...
	var_9(var_25_14, var_25_15, var_25_16, var_13)
...
function var_0_1.UpdateExplore(arg_28_0, arg_28_1)
	...
	var_28_5(arg_28_0.exGoBtn, not var_28_4)

	setActive = var_28_5

	var_28_5(arg_28_0.exGetBtn, var_28_4 and not var_28_6)

	setActive = var_28_5

	var_28_5(arg_28_0.exGotBtn, var_28_4 and var_28_6)
	...
	local function var_28_16(arg_31_0)
		if var_28_4 and not var_28_6 then
			...
			var_1.CheckAwardOverflow(var_31_0, var_28_7, function()
				...
				local var_32_2 = var_3_10002.GET_EXPLORE_AWARD
				local var_32_3 = arg_28_0.gameData

				var_32_1(var_32_0, var_32_2, var_3.GetActivityId(var_32_3), arg_28_1)
	...
	var_7(var_28_14, var_28_15, var_28_16, var_1_10011)
...
function var_0_1.UpdateExploreObj(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	local var_33_3 = arg_33_1:Find("2")
	local var_33_4 = arg_33_2 % 2 == 0 and var_33_3 or var_33_2

	setActive = var_8

	var_8(var_33_2, var_33_4 == var_33_2)

	setActive = var_8

	var_8(var_33_3, var_33_4 == var_33_3)

	local var_33_5 = var_33_4:Find("icon")
	local var_33_6 = var_8.GetComponent

	typeof = var_10
	Image = var_1_10011

	local var_33_7 = var_33_6(var_33_5, var_10(var_1_10011))

	LoadSpriteAsync = var_33_5

	var_33_5("exploreObj/" .. var_33_1.pic, function(arg_34_0)
		var_33_7.sprite = arg_34_0

		return
	end)

	local var_33_8 = var_33_4:Find("tip")
	local var_33_9 = var_9.GetComponent

	typeof = var_11
	Text = var_1_10012

	local var_33_10 = var_33_9(var_33_8, var_11(var_1_10012))
	local var_33_11 = var_33_4:Find("scrollrect/desc")
	local var_33_12 = var_10.GetComponent

	typeof = var_12
	Text = var_1_10013

	local var_33_13 = var_33_12(var_33_11, var_12(var_1_10013))
	local var_33_14 = arg_33_0.gameData
	local var_33_15 = var_11.IsRecordExplore(var_33_14, arg_33_3)

	setActive = var_33_14

	var_33_14(var_33_4:Find("tipbg"), not var_33_15)

	HXSet = var_33_14

	local var_33_16 = var_33_14.hxLan
	local var_33_17

	if not var_33_15 or not var_33_1.dispaly_desc then
		var_33_17 = ""
	end

	var_33_13.text = var_33_16(var_33_17)
	HXSet = var_12
	var_33_10.text = var_12.hxLan(var_33_15 and "" or var_33_1.tip_desc)
	setActive = var_33_18

	var_33_18(var_33_4:Find("lock"), not var_33_15)
	...
	if var_33_15 then
		...
		if not var_33_18.New(1, 1, 1, 1) then
			Color = var_33_18
			var_33_18 = var_33_18.New(1, 1, 1, 0.25)
		end

		var_33_7.color = var_33_18
...
function var_0_1.UpdateExplorePage(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1(arg_37_0.exploreTrs) do
		...
		if var_37_1 then
			...
			if not var_9.FindMap(var_37_3, iter_37_0).name then
				var_37_4 = ""
			end

			var_37_0(var_37_2, var_37_4)

			setActive = var_37_0

			var_37_0(iter_37_1:Find("lock"), not var_37_1)

			setToggleEnabled = var_37_0

			var_37_0(iter_37_1, var_37_1)

			local var_37_5 = iter_37_1:Find("Text")
			local var_37_6 = var_7.GetComponent

			typeof = var_9
			Text = var_10

			local var_37_7 = var_37_6(var_37_5, var_9(var_10))

			Color = var_37_5
			var_37_7.color = var_37_5.New(0.3058824, 0.3058824, 0.3607843)
			setActive = var_8

			local var_37_8 = iter_37_1:Find("tip")
			local var_37_9 = arg_37_0.gameData
			local var_37_11

			if var_10.IsFinishMapExplore(var_37_9, iter_37_0) then
				local var_37_10 = arg_37_0.gameData

				var_37_11 = not var_10.IsReceiveExploreAward(var_37_10, iter_37_0)
			end

			var_8(var_37_8, var_37_11)
		end
	end
...
function var_0_1.CheckAwardOverflow(arg_38_0, arg_38_1, arg_38_2)
	...
	if var_38_0 then
		...
		MSGBOX_TYPE_ITEM_BOX = var_8
		var_38_4.type = var_8
		i18n = var_8
		var_38_4.content = var_8("award_max_warning")
...
function var_0_1.UpdateDrop(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	var_5(arg_39_1:Find("mask_1"), var_39_0)
	...
	local function var_39_3()
		...
		var_40_1(var_40_0, var_2_10002.ON_DROP, var_39_0)
	...
	var_5(var_39_1, var_39_2, var_39_3, var_1_10009)

	setActive = var_5

	var_5(arg_39_1:Find("mask"), arg_39_3)
