...
local var_0_6 = var_0_10005(49, -436.12)
...
function var_0_1.getUIName(arg_1_0)
	...
	if var_1_1(var_1_0, var_1_10003.ACTIVITY_TYPE_COLORING_ALPHA) then
		AcessWithinNull = var_1_0

		if var_1_0(var_1:getConfig("config_client"), "ui") then
			return var_2
		end
	end
	...
	if not var_1 or not var_1.id then
		var_1_2 = 0
	end

	assert = var_3

	var_3(false, "Not Set PixelDraw Activity config_client ID: " .. var_1_2)
...
function var_0_1.init(arg_5_0)
	local var_5_0 = arg_5_0.rtAdapt

	arg_5_0.topPanel = var_1.Find(var_5_0, "top")

	local var_5_1 = arg_5_0.rtAdapt

	arg_5_0.btnBack = var_1.Find(var_5_1, "top/btnBack")

	local var_5_2 = arg_5_0.rtAdapt

	arg_5_0.title = var_1.Find(var_5_2, "center/title_bar/text")

	local var_5_3 = arg_5_0.rtAdapt

	arg_5_0.bg = var_1.Find(var_5_3, "center/board/container/bg")

	local var_5_4 = arg_5_0.rtAdapt

	arg_5_0.painting = var_1.Find(var_5_4, "center/painting")

	local var_5_5 = arg_5_0.rtAdapt

	arg_5_0.paintingCompleted = var_1.Find(var_5_5, "center/painting_completed")

	local var_5_6 = arg_5_0.bg

	arg_5_0.zoom = var_1.GetComponent(var_5_6, "Zoom")
	arg_5_0.zoom.maxZoom = 3

	local var_5_7 = arg_5_0.bg

	arg_5_0.cells = var_1.Find(var_5_7, "cells")

	local var_5_8 = arg_5_0.bg

	arg_5_0.cell = var_1.Find(var_5_8, "cell")

	local var_5_9 = arg_5_0.bg

	arg_5_0.lines = var_1.Find(var_5_9, "lines")

	local var_5_10 = arg_5_0.bg

	arg_5_0.line = var_1.Find(var_5_10, "line")

	local var_5_11 = arg_5_0.rtAdapt

	arg_5_0.btnHelp = var_1.Find(var_5_11, "top/btnHelp")

	local var_5_12 = arg_5_0.rtAdapt

	arg_5_0.btnShare = var_1.Find(var_5_12, "top/btnShare")

	local var_5_13 = arg_5_0.rtAdapt

	arg_5_0.colorgroupfront = var_1.Find(var_5_13, "center/colorgroupfront")

	local var_5_14 = arg_5_0.rtAdapt

	arg_5_0.scrollColor = var_1.Find(var_5_14, "color_bar/scroll")

	local var_5_15 = arg_5_0.rtAdapt

	arg_5_0.barExtra = var_1.Find(var_5_15, "color_bar/extra")

	local var_5_16 = arg_5_0.barExtra

	arg_5_0.toggleEraser = var_1.Find(var_5_16, "eraser")

	local var_5_17 = arg_5_0.barExtra

	arg_5_0.btnEraserAll = var_1.Find(var_5_17, "eraser_all")

	local var_5_18 = arg_5_0.barExtra

	arg_5_0.arrowDown = var_1.Find(var_5_18, "arrow")
	setActive = var_1
...
function var_0_1.DidMediatorRegisterDone(arg_6_0)
	...
	CustomIndexLayer = var_6_0

	local var_6_2 = var_6_0.Clone2Full
	local var_6_3 = arg_6_0.scrollColor

	arg_6_0.colorPlates = var_6_2(var_3.Find(var_6_3, "content"), #var_6_1)
	...
	var_3.GetUI(var_6_5, arg_6_0.coloringUIGroupName, false, function(arg_7_0)
		...
		var_2_10001(var_7_0, var_3.Find(var_7_1, "center"))
		...
		tf = var_2
		var_7_3.colorgroupbehind = var_2(arg_7_0)
		arg_6_0.paintsgroup = {}
		...
		for iter_7_0 = arg_6_0.colorgroupbehind.childCount - 1, 0, -1 do
			...
			var_7_4.insert(arg_6_0.paintsgroup, var_7_5)
		end
	...
	var_6_5(arg_6_0.btnShare, var_6_6)
...
function var_0_1.didEnter(arg_9_0)
	...
	local function var_9_2()
		...
		var_0.emit(var_10_1, var_0_1.ON_BACK, nil, 0.3)
	...
	local function var_9_5()
		...
		i18n = var_2_10003
		var_11_2.helps = var_2_10003("coloring_help_tip")
	...
	local function var_9_8()
		...
		var_12_1(var_12_0, var_2_10002.ShareMgr.TypeColoring)
...
function var_0_1.initColoring(arg_16_0)
	...
	local function var_16_2()
		...
		i18n = var_2_10003
		var_17_2.content = var_2_10003("coloring_erase_all_warning")
		...
		function var_17_2.onYes()
			...
			if var_0.canBeCustomised(var_18_0) then
				...
				ColoringMediator = var_3_10003

				var_18_2(var_18_1, var_3_10003.EVENT_COLORING_CLEAR, {
	...
	local function var_16_5()
		...
		var_19_1(var_19_0, var_2_10002(var_2_10003)).verticalNormalizedPosition = 0
	...
	var_1_10001(var_16_3, var_16_4, var_16_5, var_1_10005)
	...
	for iter_16_0 = 1, #arg_16_0.colorGroups do
		...
		if var_16_8 == var_16_7.StateColoring then
			var_16_6 = iter_16_0
...
function var_0_1.initInteractive(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10001(arg_20_0.paintsgroup) do
		...
		local function var_20_3()
			...
			if arg_20_0.selectedIndex ~= var_20_0 then
				...
				if var_21_1 ~= var_1.StateLock then
					if arg_20_0.paintsgroup[arg_20_0.selectedIndex] then
						...
						var_1.SetParent(var_2_10003, arg_20_0.colorgroupbehind)
					end

					arg_20_0.selectedIndex = var_20_0
					var_2_10003 = iter_20_1

					var_2.SetParent(var_2_10003, arg_20_0.colorgroupfront)

					var_2_10003 = arg_20_0

					var_2.SelectColoBar(var_2_10003, 0)

					var_2_10003 = arg_20_0

					var_2.updateSelectedColoring(var_2_10003)
			...
			if var_21_1 == var_1.StateLock then
				...
				var_21_3(var_21_2, var_2_10003("coloring_lock"))
			end
		...
		var_1_10008(var_20_2, var_1_10010, var_20_3, var_1_10012)
	end

	for iter_20_2 = 0, #arg_20_0.colorPlates - 1 do
		iter_20_1 = arg_20_0.colorPlates[iter_20_2 + 1]
		onButton = var_6
		...
		local function var_20_6()
			...
			if var_22_2 == var_22_1.StateColoring and not var_0:canBeCustomised() then
				...
				if var_22_4 ~= 0 then
					...
					if var_3.SearchValidDiagonalColoringCells(var_22_5, var_0, arg_20_0.selectedColorIndex, var_22_4) and #var_3 > 0 then
						...
						ColoringMediator = var_6

						var_22_7(var_22_6, var_6.EVENT_COLORING_CELL, {
				...
				elseif not var_0:isAllFill(arg_20_0.selectedColorIndex) then
					...
					var_22_9(var_22_8, var_5("coloring_color_not_enough"))
				end
			end
		...
		var_6(var_20_4, var_20_5, var_20_6, var_1_10010)
	end
	...
	var_1(var_20_7, var_20_8, var_20_9, iter_20_1)
...
function var_0_1.updatePage(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_1_10001(arg_25_0.paintsgroup) do
		...
		local var_25_3 = iter_25_1.Find(var_25_2, "lock")

		ColorGroup = var_25_2

		var_25_0(var_25_3, var_25_1 == var_25_2.StateLock)

		setActive = var_25_0

		local var_25_4 = iter_25_1
		local var_25_5 = iter_25_1.Find(var_25_4, "get")

		ColorGroup = var_25_4

		var_25_0(var_25_5, var_25_1 == var_25_4.StateAchieved)
	end

	local var_25_6 = #arg_25_0.paintsgroup
	local var_25_7 = 0

	for iter_25_2 = var_25_6, 1, -1 do
		if iter_25_2 ~= arg_25_0.selectedIndex then
			local var_25_8 = arg_25_0.paintsgroup[iter_25_2]

			var_7.SetSiblingIndex(var_25_8, var_25_7)
	...
	local var_25_9 = var_3(var_4)

	if var_3.IsALLAchieve(var_25_9) then
		IsNil = var_25_9

		if not var_25_9(arg_25_0.paintingCompleted) then
			setActive = var_4
...
function var_0_1.updateSelectedColoring(arg_26_0)
	...
	for iter_26_0 = 1, #arg_26_0.colorPlates do
		...
		local var_26_3 = var_26_2:Find("icon/x/nums")
		local var_26_4
		...
		var_1_10008(var_26_3, var_26_4)
	end

	local var_26_5 = var_1
	local var_26_6 = var_1.getConfig(var_26_5, "name")

	setText = var_26_5

	var_26_5(arg_26_0.title, var_26_6)

	setActive = var_26_5

	var_26_5(arg_26_0.title.parent, var_26_6 ~= nil)

	setActive = var_26_5

	local var_26_7 = arg_26_0.barExtra
	local var_26_8 = var_1

	var_26_5(var_26_7, var_1.canBeCustomised(var_26_8))

	local var_26_9 = arg_26_0.scrollColor.sizeDelta
	local var_26_10
	...
	var_26_9.y = var_26_10
	arg_26_0.scrollColor.sizeDelta = var_26_9

	local var_26_11 = arg_26_0.scrollColor
	local var_26_12 = var_5.GetComponent

	typeof = var_26_8
	ScrollRect = var_1_10008

	local var_26_13 = var_26_12(var_26_11, var_26_8(var_1_10008))

	var_26_13.verticalNormalizedPosition = 1
	setActive = var_26_13

	var_26_13(arg_26_0.scrollColor, false)

	setActive = var_26_13

	var_26_13(arg_26_0.scrollColor, true)

	arg_26_0.cellSize = arg_26_0:calcCellSize()

	arg_26_0:updateCells()

	local var_26_14 = arg_26_0

	arg_26_0.updateLines(var_26_14)

	getProxy = var_5
	ColoringProxy = var_26_14

	local var_26_15 = var_5(var_26_14)
	local var_26_16 = var_5.SetViewedPage
	local var_26_17
...
function var_0_1.updateCells(arg_27_0)
	...
	var_4:AddPointClickFunc(function(arg_28_0, arg_28_1)
		...
		GameObject = var_2_10005

		local var_28_4 = var_2_10005.Find("UICamera")
		local var_28_5 = var_5.GetComponent

		typeof = var_2_10007
		Camera = var_2_10008

		local var_28_6 = var_28_1(var_28_2, var_28_3, var_28_5(var_28_4, var_2_10007(var_2_10008)))

		math = var_28_2

		local var_28_7 = var_28_2.floor(-var_28_6.y / arg_27_0.cellSize.y)

		math = var_4

		local var_28_8 = var_4.floor(var_28_6.x / arg_27_0.cellSize.x)
		local var_28_9 = var_27_0
		local var_28_10 = var_5.getState(var_28_9)

		ColorGroup = var_28_9

		if var_28_10 == var_28_9.StateColoring then
			local function var_28_11()
				local var_29_0 = arg_27_0
				local var_29_1 = var_0.emit

				ColoringMediator = var_3_10002

				local var_29_2 = var_3_10002.EVENT_COLORING_CELL
				local var_29_3 = {
				...
				var_29_3.cells = var_4.searchColoringCells(var_29_4, var_27_0, var_28_7, var_28_8, arg_27_0.selectedColorIndex)
	...
	local var_27_8 = var_27_7 / var_8.Screen.width
	local var_27_9 = arg_27_0.bg.rect.height

	UnityEngine = var_1_10009

	local var_27_10 = var_27_6(var_27_8, var_27_9 / var_1_10009.Screen.height)
...
function var_0_1.updateCell(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_2 = var_3:getFill(arg_33_1, arg_33_2)
	local var_33_3 = var_3
	local var_33_4 = var_3.getState(var_33_3)

	ColorGroup = var_33_3

	if var_33_4 ~= var_33_3.StateFinish then
		ColorGroup = var_7
		...
		if var_33_1 or var_33_2 then
			if not var_33_7 then
				cloneTplTo = var_33_6
				var_33_7 = var_33_6(arg_33_0.cell, arg_33_0.cells, var_33_5)
			end

			var_33_7.sizeDelta = arg_33_0.cellSize
			Vector2 = var_33_6
			var_33_7.anchoredPosition = var_33_6((var_33_2 or var_33_1).column * arg_33_0.cellSize.x, -((var_33_2 or var_33_1).row * arg_33_0.cellSize.y))
			var_33_6 = var_33_7:Find("image")

			local var_33_8 = var_33_7
			local var_33_9 = var_33_7.Find(var_33_8, "text")

			if var_33_2 then
				setImageColor = var_33_8

				var_33_8(var_33_6, var_3.colors[var_33_2.type])
			else
				setText = var_33_8

				local var_33_10 = var_33_9

				string = var_1_10013

				local var_33_11 = var_1_10013.char

				string = var_1_10014

				var_33_8(var_33_10, var_33_11(var_1_10014.byte("A") + var_33_1.type - 1))
			end

			setActive = var_33_8

			var_33_8(var_33_6, var_33_2)

			setActive = var_33_8

			var_33_8(var_33_9, not var_33_2)
...
function var_0_1.calcCellSize(arg_34_0)
	...
	return (var_5.New(var_34_3.width / var_34_2, var_34_3.height / var_34_1))
end
...
function var_0_1.updateLines(arg_35_0)
	...
	for iter_35_0 = 1, var_35_2 - 1 do
		...
		if not var_9.Find(var_35_4, var_35_3) then
			cloneTplTo = var_35_4
			var_35_5 = var_35_4(arg_35_0.line, arg_35_0.lines, var_35_3)
		end

		Vector2 = var_35_4
		var_35_5.sizeDelta = var_35_4.New(1, arg_35_0.lines.rect.height)
		Vector2 = var_10
		var_35_5.anchoredPosition = var_10.New(iter_35_0 * arg_35_0.cellSize.x - 0.5, 0)
	end
	...
	for iter_35_1 = 1, var_35_1 - 1 do
		...
		if not var_9.Find(var_35_7, var_35_6) then
			cloneTplTo = var_35_7
			var_35_8 = var_35_7(arg_35_0.line, arg_35_0.lines, var_35_6)
		end

		Vector2 = var_35_7
		var_35_8.sizeDelta = var_35_7.New(arg_35_0.lines.rect.width, 1)
		Vector2 = var_10
		var_35_8.anchoredPosition = var_10.New(0, -(iter_35_1 * arg_35_0.cellSize.y - 0.5))
	end
			...
			if not arg_36_1:hasFill(var_36_7.row, var_36_7.column) and var_36_7.color == arg_36_4 then
				...
				var_13.each(var_36_6, function(arg_37_0)
					...
					if var_1.getCell(var_37_0, arg_37_0.row + var_36_7.row, arg_37_0.column + var_36_7.column) then
						...
						if not var_37_0.any(var_36_5, function(arg_38_0)
...
function var_0_1.SearchValidDiagonalColoringCells(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	local var_40_2 = arg_40_1.getState(var_40_1)

	ColorGroup = var_40_1

	if var_40_2 ~= var_40_1.StateColoring or arg_40_1:canBeCustomised() or arg_40_3 == 0 then
		return var_40_0
	else
		local var_40_3, var_40_4 = arg_40_1:GetAABB()
		local var_40_5 = var_40_4.x - var_40_3.x
		local var_40_6 = var_40_4.y - var_40_3.y

		;(function()
			local var_41_0 = var_40_5 + var_40_6
			...
			for iter_41_0 = 0, var_41_0 do
				for iter_41_1 = 0, iter_41_0 do
					...
					if var_41_1 <= var_40_5 and var_41_2 <= var_40_6 then
						local var_41_3 = var_41_2 + var_40_3.y
						local var_41_4 = var_41_1 + var_40_3.x
						local var_41_5 = arg_40_1
						local var_41_6, var_41_7
