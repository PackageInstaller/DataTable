...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_SINGLE_CLUE_GROUP, function(arg_3_0, arg_3_1)
		...
		ClueGroupSingleView = var_2_10006
		var_3_3.viewComponent = var_2_10006
		ClueGroupSingleMediator = var_2_10006
	...
	arg_1_0:bind(var_0_1.OPEN_CLUE_JUMP, function(arg_4_0, arg_4_1)
		...
		ClueMapMediator = var_2_10004

		var_4_1(var_4_0, var_2_10004.OPEN_CLUE_JUMP, {
			jumpID = arg_4_1
		})
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.SUBMIT_ACTIVITY_TASK_DONE then
		if #var_6_2.awards > 0 then
			...
			var_6_4(var_6_3, var_1_10006.ON_ACHIEVE, var_6_2.awards)
		end
