...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Camera = var_1_10005
	arg_1_0._uiCamera = var_1_1(var_1_0, var_4(var_1_10005))
	...
	for iter_1_0 = 0, var_1_2 - 1 do
		...
		var_10.insert(arg_1_0._grids, arg_1_0:createGrid(var_1_4, var_1_10009))
	end
	...
	local var_1_9 = var_1_8 + var_6.item_spacing / 2

	PuzzleConnectConst = var_6

	local var_1_10 = var_6.item_bound[2] / 2

	PuzzleConnectConst = var_7
	arg_1_0._rangeOffset = var_4(var_1_9, var_1_10 + var_7.item_spacing / 2)
	Vector2 = var_4
	...
	local var_1_12 = var_1_11 + var_6.item_spacing

	PuzzleConnectConst = var_6

	local var_1_13 = var_6.item_bound[2]

	PuzzleConnectConst = var_7
	arg_1_0._boundData = var_4(var_1_12, var_1_13 + var_7.item_spacing)
...
function var_0_0.setData(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_2 = var_4(arg_3_0._tf, "ad/bg/lineTip")
	local var_3_3
	...
	if arg_3_0._state == var_0_0.game_state_connect then
		...
		var_5(var_3_3, var_1_10007("tolovegame_puzzle_line_tip"))
		...
		var_5(var_3_3, var_1_10007("tolovegame_puzzle_puzzle_tip"))

		Vector2 = var_5
		var_3_2.anchoredPosition = var_5(156, 454)
	end

	local var_3_4 = arg_3_0._arrowIn

	Vector2 = var_3_3
	var_3_4.anchoredPosition = var_3_3((arg_3_0._arrowData[1][2] - 1) * arg_3_0._boundData.x, -(arg_3_0._arrowData[1][1] - 1) * arg_3_0._boundData.y)
	findTF = var_3_4

	local var_3_5 = var_3_4(arg_3_0._arrowIn, "ad")

	Vector3 = var_6
	var_3_5.localEulerAngles = var_6(0, 0, arg_3_0._arrowData[1][3])

	local var_3_6 = arg_3_0._arrowOut

	Vector2 = var_6
	var_3_6.anchoredPosition = var_6((arg_3_0._arrowData[2][2] - 1) * arg_3_0._boundData.x, -(arg_3_0._arrowData[2][1] - 1) * arg_3_0._boundData.y)
	findTF = var_3_6

	local var_3_7 = var_3_6(arg_3_0._arrowOut, "ad")

	Vector3 = var_6
	var_3_7.localEulerAngles = var_6(0, 0, arg_3_0._arrowData[2][3])
	...
	for iter_3_0 = 1, var_3_8 do
		...
		if iter_3_0 > #arg_3_0._items then
			var_3_9 = arg_3_0:createItem()
			table = var_11

			var_11.insert(arg_3_0._items, var_3_9)
		else
			var_3_9 = arg_3_0._items[iter_3_0]
		end

		if iter_3_0 > #arg_3_0._itemData then
			var_3_9:setActive(false)
		else
			var_3_9:setData(arg_3_0._itemData[iter_3_0])
			var_3_9:setActive(true)
		end
	end
...
function var_0_0.updateStateUI(arg_5_0)
	...
	if var_5_0 == var_1_10002.game_state_connect then
		...
		var_5_0(var_2(arg_5_0._ad, "bg/puzzle"), false)

		setActive = var_5_0
		findTF = var_2

		var_5_0(var_2(arg_5_0._ad, "bg/connect"), true)

		setActive = var_5_0
		findTF = var_2

		var_5_0(var_2(arg_5_0._ad, "list"), false)

		setActive = var_5_0
		findTF = var_2

		var_5_0(var_2(arg_5_0._ad, "dragContent"), false)
		...
		if var_5_2 == var_2.game_state_puzzle then
			...
			var_5_2(var_2(arg_5_0._ad, "bg/puzzle"), true)

			setActive = var_5_2
			findTF = var_2

			var_5_2(var_2(arg_5_0._ad, "bg/connect"), false)

			setActive = var_5_2
			findTF = var_2

			var_5_2(var_2(arg_5_0._ad, "list"), true)

			setActive = var_5_2
			findTF = var_2

			var_5_2(var_2(arg_5_0._ad, "dragContent"), true)
...
function var_0_0.createItem(arg_6_0)
	...
	local var_6_0 = var_1_10001(var_1_10002(arg_6_0.itemTpl))

	PuzzleConnectItem = var_2

	local var_6_1 = var_2.New(var_6_0, arg_6_0._iconTpl)
...
function var_0_0.createGrid(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_0 = var_1_10003(var_1_10004(arg_10_0.gridTpl))

	PuzzleConnectGrid = var_4

	local var_10_1 = var_4.New(var_10_0, arg_10_1, arg_10_2, arg_10_0._iconTpl)
			...
			for iter_17_2 = #arg_17_0._lineGrids, 1, -1 do
				...
				elseif arg_17_0._lineGrids[iter_17_2] == arg_17_1 then
					...
					if iter_17_2 > 1 then
						...
						var_17_3(var_17_2, var_8.getPoint(var_17_4), nil)
			...
			for iter_18_0 = #arg_18_0._lineGrids, 1, -1 do
				...
				elseif arg_18_0._lineGrids[iter_18_0] == arg_18_1 then
					...
					if iter_18_0 > 1 then
						...
						var_18_3(var_18_2, var_8.getPoint(var_18_4), nil)
...
function var_0_0.checkGridLineAble(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_2 = arg_20_2.getPoint(var_20_1)

	math = var_20_1

	if var_20_1.abs(var_20_0.h - var_20_2.h) > 1 then
		return false
	end

	math = var_5

	if var_5.abs(var_20_0.v - var_20_2.v) > 1 then
		return false
	end
...
function var_0_0.clearFillItem(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_1 = arg_22_1.getId(var_22_0)

	ipairs = var_22_0

	for iter_22_0, iter_22_1 in var_22_0(arg_22_0._grids) do
		local var_22_2, var_22_3, var_22_4 = iter_22_1:getFillItem()

		if var_22_2 and var_22_1 == var_22_2:getId() and arg_22_2 == var_22_4 then
...
function var_0_0.onDragBeginFunc(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	local var_23_10 = arg_23_1
	local var_23_11 = arg_23_1.getPosition(var_23_10)

	arg_23_0._dragItemStartPosition = var_23_2
	arg_23_0._dragItemContentPosition = var_23_7
	Vector2 = var_23_10
	arg_23_0._dragItemOffsetPosition = var_23_10(var_23_9.x - var_23_11.x, var_23_9.y - var_23_11.y)

	local var_23_12 = arg_23_0._moveItem
	local var_23_13 = var_10.setData
	local var_23_14 = arg_23_0._dragItem

	var_23_13(var_23_12, var_12.getData(var_23_14))

	local var_23_15 = arg_23_0._moveItem

	var_10.setActive(var_23_15, true)
...
function var_0_0.onDragEndFunc(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	if arg_25_0._dragItem then
		if arg_25_0._fillAll then
			var_1_10005 = arg_25_0._dragItem

			var_4.changeCount(var_1_10005, -1)

			var_1_10005 = arg_25_0

			local var_25_0 = arg_25_0.getFillId(var_1_10005)
		...
		var_4.setDraging(var_1_10005, false)

		arg_25_0._dragItem = nil
		var_1_10005 = arg_25_0._moveItem

		var_4.setActive(var_1_10005, false)

		var_1_10005 = arg_25_0

		arg_25_0.clearGridPrepare(var_1_10005)
	end
...
function var_0_0.checkMoveItemPuzzle(arg_27_0)
	...
	for iter_27_0 = 1, #var_27_1 do
		...
		for iter_27_1, iter_27_2 in var_27_6(arg_27_0._grids) do
			if not iter_27_2:getPrepare() then
				local var_27_8 = iter_27_2
				local var_27_9 = iter_27_2.getPosition(var_27_8)

				Vector2 = var_27_8
				math = var_1_10017
				var_1_10017 = var_1_10017.abs(var_27_7.x + arg_27_0._gridOffsetX - var_27_9.x)
				math = var_18

				local var_27_10 = var_27_8(var_1_10017, var_18.abs(var_27_7.y - var_27_9.y))

				var_1_10017 = false

				if var_27_10.x <= arg_27_0._rangeOffset.x and var_27_10.y <= arg_27_0._rangeOffset.y then
					var_1_10017 = true
				end
				...
				if var_1_10017 then
					...
					if not iter_27_2:getFill() then
						...
						var_18.insert(arg_27_0._prepareGrids, iter_27_2)
					end
	...
	for iter_27_3 = 1, #arg_27_0._prepareGrids do
		if arg_27_0._fillSuccess then
			local var_27_11 = arg_27_0._prepareGrids[iter_27_3]
			local var_27_12 = var_9.setPrepareAlpha

			PuzzleConnectConst = var_1_10011

			var_27_12(var_27_11, var_1_10011.color_green)
		else
			local var_27_13 = arg_27_0._prepareGrids[iter_27_3]
			local var_27_14 = var_9.setPrepareAlpha

			PuzzleConnectConst = var_1_10011

			var_27_14(var_27_13, var_1_10011.color_red)
		end
	end
...
function var_0_0.getScreentScaleRate(arg_32_0)
	...
	local var_32_2 = var_1_10003(var_1_10004.Find("UICamera/Canvas")).sizeDelta.x
