...
local var_0_0 = "MaoxiV2framePage"
...
function var_0_1.Switch(arg_4_0, arg_4_1)
	...
	var_5(var_6(arg_4_0.phases[1]), var_4_3)

	setActive = var_5

	local var_4_6 = arg_4_0.phases[1]

	var_5(var_6.Find(var_4_6, "label"), true)
	...
	local var_4_8 = var_4_7(var_6(arg_4_0.phases[1]), 0, 1, 0.4)
	local var_4_9 = var_5.setOnUpdate

	System = var_7

	var_4_9(var_4_8, var_7.Action_float(function(arg_5_0)
	...
	var_4_9(var_6.Find(var_4_10, "Image"), true)
	...
	local var_4_12 = var_4_9(var_4_11, var_7(var_8))

	LeanTween = var_4_11

	local var_4_13 = var_4_11.value

	go = var_7

	local var_4_14 = var_4_13(var_7(arg_4_0.phases[2]), 0, 1, 0.4)
	local var_4_15 = var_6.setOnUpdate

	System = var_8

	var_4_15(var_4_14, var_8.Action_float(function(arg_6_0)
	...
	var_4_15(var_7.Find(var_4_16, "label"), false)

	setLocalPosition = var_4_15
	go = var_7

	var_4_15(var_7(arg_4_0.phases[2]), var_4_2)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if var_1_10006(arg_8_0.battleBtn) then
		var_8_5 = var_8_3
	end

	var_8_2(var_8_4, var_8_5)
	...
	if 1 <= var_8_9 then
		...
		if not var_9(var_8_7, "#74b9ff") then
			var_8_11 = var_8_7
		end
		...
		var_7(arg_8_0.progress, "/" .. var_8_8)

		setFillAmount = var_7

		var_7(arg_8_0.bar, var_8_7 / var_8_8)
