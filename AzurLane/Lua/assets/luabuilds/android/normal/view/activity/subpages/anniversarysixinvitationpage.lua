...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_6()
		...
		if var_3_0(var_3_2(var_3_1, var_2_10003.ACTIVITY_TYPE_SHOP), function(arg_4_0)
			...
			if var_3_6(var_3_5, var_3.ACTIVITY_TYPE_ISLAND) and not var_1:isEnd() then
				...
				var_2_10004 = var_2_10004.EVENT_GO_SCENE
				SCENE = var_2_10005
				var_2_10005 = var_2_10005.ANNIVERSARY_ISLAND_SEA

				local var_3_9 = {}

				SixthAnniversaryIslandScene = var_2_10007
				var_3_9.wraps = var_2_10007.SHOP

				var_3_8(var_3_7, var_2_10004, var_2_10005, var_3_9)
			else
				...
				local var_3_12 = var_2_10004.OPEN_LAYER

				Context = var_2_10005

				local var_3_13 = var_2_10005.New
				local var_3_14 = {}

				SixthAnniversaryIslandShopMediator = var_2_10007
				var_3_14.mediator = var_2_10007
				SixthAnniversaryIslandShopLayer = var_2_10007
				var_3_14.viewComponent = var_2_10007
	...
	var_2_2(var_2_4, var_2_5, var_2_6, var_6)

	onButton = var_2_2

	local var_2_7 = arg_2_0
	local var_2_8 = var_2_3:Find("get")
	...
	var_2_2(var_2_7, var_2_8, var_2_9, var_6)
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	var_6_7(var_6_8:Find("get"), var_6_4)

	setActive = var_6_7

	var_6_7(var_6_8:Find("got"), not var_6_6)

	setActive = var_6_7

	var_6_7(var_6_8:Find("go"), not var_6_4 and var_6_6)

	if var_6_6 then
		math = var_6_7
		var_6_1 = var_6_7.min(var_6_1, var_6_2)
	else
		var_6_1 = var_6_2 + 1
	end
	...
	for iter_6_0 = 1, var_6_9 do
		...
		var_6_10(var_6_11:Find("mark"), iter_6_0 < var_6_1)

		setActive = var_6_10

		var_6_10(var_6_11:Find("icon"), iter_6_0 == var_6_1)
	end
	...
	var_7(var_8.Find(var_6_12, "Image"), not var_6_6)

	setActive = var_7

	local var_6_13 = arg_6_0.rtFinish

	var_7(var_8.Find(var_6_13, "got"), not var_6_6)
