...
function var_0_1.init(arg_2_0, ...)
	...
	var_1(var_2.Find(var_2_0, "adapt/TopPage/top"), "Anim_SecretsAbyssCoreActivityUI_top_In")
	...
	var_1(var_2_2, var_2_1("masaina_main_title"))
	...
	var_1(var_2_4, var_2_3("masaina_main_title_en"))
	...
	var_2.make(var_2_6, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			elseif not arg_2_0.pageDic[var_3.id] then
				...
				local var_3_1 = arg_3_2.Find(var_3_0, "off/name")

				i18n = var_3_0

				var_4(var_3_1, var_3_0("masaina_main_sheet" .. var_3:getConfig("is_show")))

				setText = var_4

				local var_3_2 = arg_3_2
				local var_3_3 = arg_3_2.Find(var_3_2, "on/name")

				i18n = var_3_2

				local var_3_4 = "masaina_main_sheet"
				local var_3_5 = var_3
	...
	pg = var_4
	arg_2_0.camEventId = var_2_8(var_2_7, var_4.CameraFixMgr.ASPECT_RATIO_UPDATE, function(arg_6_0, arg_6_1)
	...
	local var_2_11 = var_4.Find(var_2_10, "adapt/TopPage/top/btn_back")
	...
	var_2(var_2_9, var_2_11, var_2_12, var_6)
