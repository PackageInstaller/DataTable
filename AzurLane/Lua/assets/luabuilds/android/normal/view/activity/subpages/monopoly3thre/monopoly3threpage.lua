...
function var_0_1.getLeftRpCount()
	...
	local var_8_2 = var_8_1(var_8_0, var_1_10002.ACTIVITY_TYPE_MONOPOLY).data2_list[2]
...
function var_0_1.onAward(arg_9_0, arg_9_1, arg_9_2)
	for iter_9_0 = 1, #arg_9_1 do
		...
		Monopoly3thRePage = var_1_10008

		var_1_10007(var_1_10008.AWARDS, arg_9_1[iter_9_0])
	end
	...
	if arg_9_0.gameUI.autoFlag then
		...
		local var_9_3 = var_5.ON_ACHIEVE

		Monopoly3thRePage = iter_9_0

		var_9_2(var_9_1, var_9_3, iter_9_0.AWARDS, arg_9_2)
...
function var_0_1.updateGameUI(arg_11_0)
	...
	if arg_11_0.gameUI then
		...
		findTF = var_1_10003
		arg_11_0.gameUI = var_11_1(var_11_2, var_1_10003(arg_11_0._tf, "AD"), arg_11_0.event, 4)
		...
		if not arg_11_0.gameUI.autoFlag then
			...
			if #var_1.AWARDS > 0 then
				...
				local var_11_6 = var_3.ON_ACHIEVE

				Monopoly3thRePage = var_4

				var_11_5(var_11_4, var_11_6, var_4.AWARDS, function()
					return
				end)
