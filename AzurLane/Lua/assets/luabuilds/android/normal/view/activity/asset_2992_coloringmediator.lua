...
local var_0_0 = "ColoringMediator"
...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.EVENT_GO_SCENE, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.GO_SCENE, arg_2_1, arg_2_2)
	...
	arg_1_0:bind(var_0_1.EVENT_COLORING_CELL, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.COLORING_CELL, arg_3_1)
	...
	arg_1_0.bind(var_1_0, var_0_1.EVENT_COLORING_CLEAR, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.COLORING_CLEAR, arg_4_1)
	...
	local var_1_3 = var_1_2(var_1_1, var_4.ACTIVITY_TYPE_COLORING_ALPHA)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.COLORING_CELL_DONE then
		_ = var_4
		...
		if var_6_0 == var_4.COLORING_CLEAR_DONE then
			...
			if var_6_0 == var_4.COLORING_ACHIEVE_DONE then
				local var_6_6 = arg_6_0.viewComponent
				local var_6_7 = var_4.emit

				BaseUI = var_1_10006

				var_6_7(var_6_6, var_1_10006.ON_ACHIEVE, var_6_2.drops, function()
...
function var_0_1.tryColoringAchieve(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_9_0(var_9_1) do
		...
		local var_9_3 = iter_9_1.getState(var_9_2)

		ColorGroup = var_9_2

		if var_9_3 == var_9_2.StateFinish and iter_9_1:getHasAward() then
			local var_9_4 = arg_9_0
			local var_9_5 = arg_9_0.sendNotification

			GAME = var_1_10010

			var_9_5(var_9_4, var_1_10010.COLORING_ACHIEVE, {
