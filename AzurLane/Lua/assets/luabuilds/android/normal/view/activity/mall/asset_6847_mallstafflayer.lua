...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.floorsUIList = var_2_9(var_2_10, var_3.Find(var_2_11, "tpl"))
	...
	arg_2_0.targetUIList = var_2_13(var_2_14, var_3.Find(var_2_15, "tpl"))
	...
	var_2_18(var_2_19, var_3("mall_title"))
	...
	var_2_18(var_2_20, var_3("mall_title_en"))

	setText = var_2_18

	local var_2_21 = arg_2_0.uiFloorsTF
	local var_2_22 = var_2.Find(var_2_21, "tpl/lock/Text")

	i18n = var_2_21

	var_2_18(var_2_22, var_2_21("mall_floor_lock"))

	eachChild = var_2_18

	local var_2_23 = arg_2_0.uiRankTF

	var_2_18(var_2.Find(var_2_23, "open"), function(arg_10_0)
		setText = var_2_10001

		local var_10_0 = arg_10_0

		MallUtil = var_2_10003

		local var_10_1 = var_2_10003.RANK2NAME

		tonumber = var_2_10004

		var_2_10001(var_10_0, var_10_1[var_2_10004(arg_10_0.name)])
...
function var_0_1.UpdateData(arg_12_0)
	...
	arg_12_0.activity = var_12_1(var_12_0, var_1_10003.ACTIVITY_TYPE_MALL)
...
function var_0_1.UpdateView(arg_13_0)
	...
	local var_13_2 = var_2.Find

	tostring = var_1_10004

	var_1(var_13_2(var_13_1, var_1_10004(arg_13_0.curFloorId)))
...
function var_0_1.UpdateFloorTpl(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_3 = var_15_0.GetStaffList(var_15_2)

	UIItemList = var_15_2

	var_15_2.StaticAlign(arg_15_2:Find("staffs"), arg_15_2:Find("staffs/tpl"), #var_15_3, function(arg_16_0, arg_16_1, arg_16_2)
		UIItemList = var_2_10003
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			var_16_1(arg_16_2:Find("icon"), var_16_2)

			if var_16_2 then
				MallStaffCard = var_16_1

				var_16_1.StaticUpdateIcon(arg_16_2:Find("icon"), var_16_2.tid)
			end

			onButton = var_16_1

			var_16_1(arg_15_0, arg_16_2, function()
...
function var_0_1.UpdataRight(arg_21_0)
	...
	local var_21_2 = var_2.GetFloor(var_21_1, arg_21_0.curFloorId)

	arg_21_0.selIds = var_21_0(var_2.GetStaffList(var_21_2), function(arg_22_0)
		return arg_22_0 ~= 0
	end)
	...
	for iter_21_0, iter_21_1 in var_21_3(var_21_4:GetTargetInfos(arg_21_0.level)) do
		table = var_1_10007

		var_1_10007.insert(arg_21_0.allAttrDatas, {
			cur = 0,
			id = iter_21_0,
			base = iter_21_1[1],
			max = iter_21_1[2]
	...
	for iter_21_2, iter_21_3 in var_2(var_21_4:GetStaffList()) do
		if iter_21_3 ~= 0 then
			...
			for iter_21_4, iter_21_5 in var_21_5(var_21_6:GetAttrList()) do
	...
	var_6(var_7.Find(var_21_13, "open"), var_21_12)

	setActive = var_6

	local var_21_14 = arg_21_0.uiRankTF

	var_6(var_7.Find(var_21_14, "close"), not var_21_12)
	...
	if var_21_12 then
		...
		var_6(var_7.Find(var_21_15, "open"), function(arg_27_0)
			...
			var_2_10001(var_27_0, var_2_10003(arg_27_0.name) == var_21_11)
...
function var_0_1.SortList(arg_28_0)
	...
	var_28_0(var_28_1, var_1_10003({
		function(arg_29_0)
			local var_29_0, var_29_1 = arg_29_0:GetStatusInfos()

			MallStaff = var_2_10003

			return var_29_0 == var_2_10003.STATUS.ORDER and 1 or 0
		end,
		function(arg_30_0)
			...
			return var_30_0 == var_2_10003.STATUS.FLOOR and var_30_1.floorId ~= arg_28_0.curFloorId and 1 or 0
		end,
		function(arg_31_0)
			return -arg_31_0.id
		end
...
function var_0_1.UpdateTargetTpl(arg_32_0, arg_32_1, arg_32_2)
	...
	local var_32_2 = arg_32_0.GetAttrInfos(var_32_1, var_3)

	GetImageSpriteFromAtlasAsync = var_32_1

	var_32_1("ui/mallstaffui_atlas", var_32_2[1], arg_32_2:Find("ring/v"), true)

	setFillAmount = var_32_1

	var_32_1(arg_32_2:Find("ring/r"), var_3.base / var_3.max)

	setFillAmount = var_32_1

	var_32_1(arg_32_2:Find("ring/v"), var_3.cur / var_3.max)

	setText = var_32_1

	local var_32_3 = arg_32_2
	local var_32_4 = arg_32_2.Find(var_32_3, "bg/Text")

	setColorStr = var_32_3

	local var_32_5

	if not var_32_3(var_3.cur, var_32_2[2]) then
		var_32_5 = var_3.cur
	end

	var_32_1(var_32_4, var_32_5 .. "/" .. var_3.max)
...
function var_0_1.OnInitStaffItem(arg_34_0, arg_34_1)
	...
	local function var_34_3()
		...
		if not var_0.GetEmptyIdx(var_35_1) then
			...
			local var_35_2 = var_35_1.TipsMgr.GetInstance()
			local var_35_3 = var_1.ShowTips

			i18n = var_2_10003

			var_35_3(var_35_2, var_2_10003("mall_staff_position_full_tip"))
		...
		if var_35_5 == var_2_10003.STATUS.ORDER then
			return
		end
		...
		var_3({
			function(arg_36_0)
				...
				if var_36_0 == var_3_10002.STATUS.FLOOR then
					...
					i18n = var_3_10004
					var_36_3.content = var_3_10004("mall_change_floor_sure")
...
function var_0_1.CheckUpdateFloorStaffs(arg_42_0, arg_42_1)
	if arg_42_0:NeedUpdateFloorStaff() then
		...
		local var_42_2 = var_1_10004.ACTIVITY_MALL_OP
		local var_42_3 = {
			activity_id = arg_42_0.id
		}

		ActivityMallOPCommand = var_6
		var_42_3.cmd = var_6.CMD.SET_FLOOR_STAFF
