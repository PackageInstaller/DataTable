...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_FLEET_SELECT, function(arg_4_0, arg_4_1)
		...
		BossRushEscapeManorFleetSelectView = var_2_10006
	...
	arg_1_0:bind(var_0_1.ON_EXTRA_RANK, function(arg_5_0)
		...
		local var_5_3 = var_2_10004.BILLBOARD
		local var_5_4 = {}

		PowerRank = var_2_10006
		var_5_4.page = var_2_10006.TYPE_BOSSRUSH
	...
	arg_1_0:bind(var_0_1.ON_PERFORM_COMBAT, function(arg_6_0, arg_6_1, arg_6_2)
		...
		local var_6_2 = var_2_10005.BEGIN_STAGE
		local var_6_3 = {}

		SYSTEM_PERFORM = var_2_10007
		var_6_3.system = var_2_10007
	...
	local var_1_6 = var_3.getActivityById

	ActivityConst = var_5

	local var_1_7 = var_1_6(var_1_5, var_5.ESCAPE_BOSS_RUSH_PT_ID)
	local var_1_8 = arg_1_0.viewComponent

	var_4.SetPtActivity(var_1_8, var_1_7)

	local var_1_9 = arg_1_0.viewComponent

	var_4.addbubbleMsgBox(var_1_9, function(arg_8_0)
		...
		if var_8_2(var_8_1, var_2_10003) then
			return
		end
	...
	var_4.addbubbleMsgBox(var_1_10, function(arg_9_0)
		pg = var_2_10001
...
function var_0_1.handleNotification(arg_11_0, arg_11_1)
	...
	local var_11_3 = arg_11_1.getType(var_11_2)
	...
	if var_11_0 == nil then
		...
		if var_11_0 == var_11_2.BEGIN_STAGE_DONE then
			getProxy = var_11_5
			ContextProxy = var_1_10006

			local var_11_4 = var_11_5(var_1_10006)

			var_11_5 = var_11_5.getContextByMediator
			BossRushPreCombatMediator = var_1_10007

			if not var_11_5(var_11_4, var_1_10007) then
				local var_11_6 = arg_11_0
				local var_11_7 = arg_11_0.sendNotification

				GAME = var_1_10008

				local var_11_8 = var_1_10008.GO_SCENE

				SCENE = var_1_10009

				var_11_7(var_11_6, var_11_8, var_1_10009.COMBATLOAD, var_11_1)
			end
		else
			...
			if var_11_0 == var_11_5.ACTIVITY_UPDATED then
				if var_11_1 then
					...
					local var_11_10 = var_5.getConfig(var_11_9, "type")

					ActivityConst = var_11_9

					local var_11_11

					if var_11_10 == var_11_9.ACTIVITY_TYPE_BOSSRUSH then
						var_11_11 = arg_11_0.viewComponent

						var_6.SetActivity(var_11_11, var_5)

						var_11_11 = arg_11_0.viewComponent

						var_6.UpdateView(var_11_11)
					else
						local var_11_12 = var_5.id

						ActivityConst = var_11_11

						if var_11_12 == var_11_11.ESCAPE_BOSS_RUSH_PT_ID then
							local var_11_13 = arg_11_0.viewComponent

							var_6.SetPtActivity(var_11_13, var_5)

							local var_11_14 = arg_11_0.viewComponent

							var_6.UpdateView(var_11_14)
						end
					end
				end
			else
				...
				if var_11_0 == var_5.SUBMIT_TASK_AWARD_DOWN then
					...
					if #var_11_1.awards > 0 then
						...
						var_6.insert(var_11_15, function(arg_12_0)
							local var_12_0 = arg_11_0.viewComponent
							local var_12_1 = var_1.emit

							BaseUI = var_2_10003

							var_12_1(var_12_0, var_2_10003.ON_ACHIEVE, var_11_1.awards, arg_12_0)
					...
					BossRushTotalRewardPanelMediator = var_11_15

					if var_11_0 == var_11_15.ON_WILL_EXIT then
						local var_11_16 = arg_11_0.viewComponent

						var_5.resumeBubble(var_11_16)

						local var_11_17 = arg_11_0.viewComponent

						var_5.UpdateView(var_11_17)
					end
				end
			end
		end
