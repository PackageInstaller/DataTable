...
function var_0_1.init(arg_2_0)
	...
	import = var_2
	arg_2_0.graphPath = var_2_10(var_2("GameCfg.BackHillGraphs.IdolMasterStageGraph"))
	AutoLoader = var_1
...
function var_0_1.didEnter(arg_3_0)
	...
	var_1_10001(var_3_4, var_3.Find(var_3_5, "top/help_btn"), function()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.idolmaster_main.tip
	...
	local var_3_8 = var_3_7(var_3_6, var_3.ACTIVITY_TYPE_MINIGAME)
	...
	arg_3_0.InitFacilityCross(var_3_9, arg_3_0._map, arg_3_0._upper, "jiujiuwoshouhui", function()
		...
		var_7_1(var_7_0, var_2_10002.GO_MINI_GAME, 24)
	...
	local var_3_12 = var_3_11(var_3_10, var_4.IDOL_MASTER_PT_ID)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "jinianzhang", function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10003.IDOLMASTER_MEDAL_COLLECTION_SCENE)
...
function var_0_1.UpdateView(arg_10_0)
	...
	local var_10_4 = var_10_3(var_10_2, var_1_10005.ACTIVITY_TYPE_MINIGAME)

	getProxy = var_10_2
	MiniGameProxy = var_5

	local var_10_5 = var_10_2(var_5)
	local var_10_6

	if not (var_10_4 and var_10_5:GetHubByHubId(var_10_4:getConfig("config_id")) and var_5.count > 0) then
		var_10_6 = var_5.usedtime >= var_5:getConfig("reward_need") and var_5.ultimate == 0
	end

	local var_10_7 = arg_10_0.upper_jiujiuwoshouhui
	local var_10_8 = var_6.Find(var_10_7, "tip")

	setActive = var_10_7

	var_10_7(var_10_8, var_10_6)

	local var_10_9 = var_10_0
	local var_10_10 = var_10_0.getActivityById

	ActivityConst = var_9

	local var_10_11 = var_10_10(var_10_9, var_9.IDOL_MASTER_PT_ID)
	local var_10_12 = arg_10_0.upper_leijijiangli
	local var_10_13 = var_8.Find(var_10_12, "tip")
	local var_10_14 = var_10_11 and var_10_11:readyToAchieve()

	setActive = var_10_12

	var_10_12(var_10_13, var_10_14)

	local var_10_15 = arg_10_0.upper_jinianzhang
	local var_10_16 = var_9.Find(var_10_15, "tip")
	local var_10_17 = var_0_1.MedalTip()

	setActive = var_10

	var_10(var_10_16, var_10_17)
...
function var_0_1.MedalTip()
	...
	local var_11_2 = var_11_1(var_11_0, var_1_10002.ACTIVITY_TYPE_PUZZLA)

	Activity = var_11_0

	return var_11_0.IsActivityReady(var_11_2)
end
