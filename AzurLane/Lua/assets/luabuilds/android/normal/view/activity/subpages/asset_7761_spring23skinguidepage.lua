...
local var_0_0 = "Spring23SkinGuidePage"

import = var_0_10002

local var_0_1 = var_0_10000(var_0_0, var_0_10002("...base.BaseActivityPage"))
local var_0_2 = "ui/activityuipage/spring23skinguidepage_atlas"
	...
	var_1.make(var_3_7, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_4_1.EventInit then
			...
			local function var_4_8()
				...
				var_5_1(var_5_0, var_3_10002.ON_DROP, var_4_5)
			...
			var_8(var_4_6, var_4_7, var_4_8, var_2_10012)
		else
			UIItemList = var_4_3

			if arg_4_0 == var_4_3.EventUpdate then
				local var_4_9 = var_4_2:getTaskStatus()
				local var_4_10 = arg_4_2:Find("got")
				local var_4_11 = arg_4_2
				local var_4_12 = arg_4_2.Find(var_4_11, "get")

				setActive = var_4_11

				var_4_11(var_4_12, var_4_9 == 1 and arg_3_0.remainCnt > 0)

				setActive = var_4_11

				var_4_11(var_4_10, var_4_9 == 2)
				...
				var_4_11(var_4_13, var_4_14, var_4_15, var_2_10012)
			end
		end
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	arg_7_0.unlockCnt = var_7_5(var_7_4, var_7_7, var_5.GetServerTime(var_7_8)) + 1

	local var_7_9

	if not (arg_7_0.unlockCnt > arg_7_0.totalCnt) or not arg_7_0.totalCnt then
		var_7_9 = arg_7_0.unlockCnt
	end

	arg_7_0.unlockCnt = var_7_9
	...
	var_2(var_7_10, var_7_7.format("%02d", arg_7_0.remainCnt))

	setImageSprite = var_2

	local var_7_11 = arg_7_0.countImg

	GetSpriteFromAtlas = var_4

	local var_7_12 = var_0_2

	tostring = var_6

	var_2(var_7_11, var_4(var_7_12, var_6(arg_7_0.remainCnt)), true)
