...
function var_0_1.OnOpenCell(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	arg_4_0:DoAnimtion("picture_faguang", var_4_0, function()
		...
		var_5_8(var_5_7, var_3(arg_4_1, arg_4_2), not var_5_6)
		...
		if arg_4_3 then
			...
			if var_5_10 then
				...
				if not var_5_14.FindNextTravelable(var_5_12) then
					...
					var_5_14(var_5_13, var_4.RESULT_ONEKEY_AWARD)
...
function var_0_1.RpAnim(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_4 = var_9_3(var_9_2, var_7.Action_float(function(arg_10_0)
	...
	var_9_5(var_9_4, var_7.Action(function()
...
function var_0_1.OnDrawArea(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	arg_14_0:CreateAnimal(arg_14_1, arg_14_2, false, function(arg_15_0)
		...
		var_5.DoAnimtion(var_15_5, "picture_bichu", var_15_4, function()
			...
			var_16_1(var_16_0, var_2.Action_float(function(arg_17_0)
				...
				var_17_1(var_17_0, var_4_10003(var_4_10004)).alpha = arg_17_0
			...
			if arg_14_3 then
				...
				if var_16_3 then
					...
					if not var_1.FindNextDrawableAreaHead(var_16_5) then
						...
						WorldInPictureMediator = var_3

						var_16_7(var_16_6, var_3.RESULT_ONEKEY_AWARD)
...
function var_0_1.init(arg_20_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_20_0.travelPointTxt = var_20_12(var_20_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_20_0.drawPointTxt = var_20_15(var_20_14, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_20_0.travelProgressTxt = var_20_18(var_20_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_20_0.drawProgressTxt = var_20_21(var_20_20, var_3(var_1_10004))
	...
	arg_20_0.selectorContainer = var_20_33(var_20_32, var_3(var_1_10004))
	...
	typeof = var_3
	CanvasGroup = var_1_10004
	arg_20_0.drawableAreaContainer = var_20_36(var_20_35, var_3(var_1_10004))
...
function var_0_1.didEnter(arg_21_0)
	...
	local function var_21_5()
		...
		pg = var_2_10003
		var_23_2.helps = var_2_10003.gametip.worldinpicture_help.tip
	...
	var_1_10001(var_21_3, var_21_4, var_21_5, var_1_10005)
	...
	local function var_21_8()
		...
		if var_0.GetTravelPoint(var_24_1) <= 0 then
			...
			var_24_3(var_24_2, var_2_10002("worldinpicture_tavel_point_tip"))
		...
		if var_24_6 and var_24_7 then
			...
			WorldInPictureMediator = var_2_10004

			var_24_10(var_24_9, var_2_10004.ON_AUTO_TRAVEL, var_24_6.x, var_24_6.y, var_24_7)
		end
	...
	var_1_10001(var_21_6, var_21_7, var_21_8, var_1_10005)
	...
	local function var_21_11()
		...
		if var_0.GetDrawPoint(var_25_1) <= 0 then
			...
			var_25_3(var_25_2, var_2_10002("worldinpicture_draw_point_tip"))
		...
		if var_25_6 and var_25_7 then
			...
			var_25_10(var_25_9, var_2_10004.ON_AUTO_DRAW, var_25_6.x, var_25_6.y, var_25_7)
		end
	...
	var_1_10001(var_21_9, var_21_10, var_21_11, var_1_10005)
	...
	local function var_21_14()
		...
		var_26_1(var_26_0, var_2_10002("worldinpicture_not_area_can_draw"))
	...
	var_1(var_21_12, var_21_13, var_21_14, var_1_10005)
	...
	var_1(var_21_15, var_21_16, var_21_17, var_1_10005)
	...
	var_1(var_21_18, var_21_19, var_21_20, var_1_10005)
...
function var_0_1.GetRecordCharPos(arg_31_0)
	...
	local var_31_2 = var_31_0.GetString("WorldInPictureScene_1" .. var_31_1, "0#0")

	string = var_3

	local var_31_3 = var_3.split(var_31_2, "#")

	Vector2 = var_4
	tonumber = var_5

	local var_31_4 = var_5(var_31_3[1])

	tonumber = var_6

	return var_4(var_31_4, var_6(var_31_3[2]))
end
...
function var_0_1.SaveCharPosition(arg_32_0, arg_32_1, arg_32_2)
	...
	PlayerPrefs = var_32_0

	var_32_0.SetString("WorldInPictureScene_1" .. var_32_1, arg_32_1 .. "#" .. arg_32_2)
...
function var_0_1.moveChar(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	if var_33_0(var_1_10005(arg_33_0.char)) then
		LeanTween = var_33_1
		var_33_1 = var_33_1.cancel
		go = var_5

		var_33_1(var_5(arg_33_0.char))
	end
...
function var_0_1.showChar(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local var_35_2 = var_35_1(var_5(arg_35_0.char), 0, 1, 0.2)
	local var_35_3 = var_4.setOnUpdate

	System = var_6

	var_35_3(var_35_2, var_6.Action_float(function(arg_36_0)
		...
		var_2_10001(var_36_0, var_2_10003(var_2_10004)).alpha = arg_36_0
	...
	local var_35_6 = var_35_4(var_35_5, var_6(arg_35_1, arg_35_2, 0), 0.2)
	local var_35_7 = var_4.setOnComplete

	System = var_6

	var_35_7(var_35_6, var_6.Action(function()
		if arg_35_3 then
			arg_35_3()
		end
...
function var_0_1.hideChar(arg_38_0, arg_38_1)
	...
	local var_38_1 = var_38_0(var_1_10003(arg_38_0.char), 1, 0, 0.2)
	local var_38_2 = var_2.setOnUpdate

	System = var_4

	var_38_2(var_38_1, var_4.Action_float(function(arg_39_0)
		GetOrAddComponent = var_2_10001
		...
		typeof = var_2_10003
		CanvasGroup = var_2_10004
		var_2_10001(var_39_0, var_2_10003(var_2_10004)).alpha = arg_39_0
	...
	local var_38_4 = var_38_1.moveLocal

	go = var_4

	local var_38_5 = var_4(arg_38_0.char)

	Vector3 = var_5

	local var_38_6 = var_38_4(var_38_5, var_5(var_38_3.x, var_38_3.y + 50, 0), 0.2)
	local var_38_7 = var_3.setOnComplete

	System = var_5

	var_38_7(var_38_6, var_5.Action(function()
...
function var_0_1.UpdateSwitcherState(arg_43_0)
	...
	var_43_1(arg_43_0.btnOff, var_43_0)

	setActive = var_43_1

	var_43_1(arg_43_0.onDisable, not var_43_0 and not var_43_2)

	setActive = var_43_1

	var_43_1(arg_43_0.btnOn, not var_43_0 and var_43_2)

	setActive = var_43_1

	var_43_1(arg_43_0.onekeyTravelBtn, not var_43_0)

	setActive = var_43_1

	var_43_1(arg_43_0.onekeyDrawBtn, var_43_0)
	...
	if not var_43_0 then
		...
		var_43_5 = not var_5.IsTravelAll(var_43_4)
	else
		var_43_5 = false
	end
...
function var_0_1.InitView(arg_44_0)
	...
	var_4(var_44_3, function()
		...
		var_46_2(var_46_1, var_2.GetRecordCharPos(var_46_3))
...
function var_0_1.CreateCell(arg_48_0, arg_48_1, arg_48_2, arg_48_3)
	...
	var_7("ui/WorldInPicture_atlas", "view_" .. arg_48_3 - 1, function(arg_49_0)
		...
		local var_49_2 = var_49_1(var_49_0, var_2_10003(var_2_10004))

		var_49_2.sprite = arg_49_0

		local var_49_3 = var_49_2

		var_49_2.SetNativeSize(var_49_3)

		local var_49_4 = var_48_0

		Vector2 = var_49_3
		var_49_4.anchoredPosition = var_49_3(var_48_1, var_48_2)

		local var_49_5 = arg_48_0

		var_2.CreateSelector(var_49_5, arg_48_1, arg_48_2)

		local var_49_6 = arg_48_0

		var_2.CreateBox(var_49_6, arg_48_1, arg_48_2)

		local var_49_7 = arg_48_0

		var_2.CreateDrawableArea(var_49_7, arg_48_1, arg_48_2)

		local var_49_8 = arg_48_0

		var_2.CreateAnimal(var_49_8, arg_48_1, arg_48_2, true)
	...
	local function var_48_6()
		if arg_48_0.opType == var_0_2 then
			...
			if var_0.GetTravelPoint(var_50_2) <= 0 then
				...
				var_50_4(var_50_3, var_2_10002("worldinpicture_tavel_point_tip"))
			...
			if var_0.CanSelect(var_50_5, arg_48_1, arg_48_2) then
				...
				WorldInPictureMediator = var_2_10002

				var_50_7(var_50_6, var_2_10002.ON_TRAVEL, arg_48_1, arg_48_2, arg_48_3)
			end
		elseif arg_48_0.opType == var_0_3 then
			...
			if var_0.GetDrawPoint(var_50_10) <= 0 then
				...
				var_50_12(var_50_11, var_2_10002("worldinpicture_draw_point_tip"))
			...
			if var_0.CanDraw(var_50_13, arg_48_1, arg_48_2) then
				...
				var_50_19(var_50_18, var_2_10005.ON_DRAW, var_50_15, var_50_16, var_50_17)
			end
		end
	...
	var_48_3(var_48_4, var_48_5, var_48_6, var_1_10011)

	local var_48_7 = var_48_0
	local var_48_8 = var_48_0.GetComponent

	typeof = var_48_5
	CanvasGroup = var_48_6

	local var_48_9 = var_48_8(var_48_7, var_48_5(var_48_6))
...
function var_0_1.CreateSelector(arg_51_0, arg_51_1, arg_51_2)
	...
	if var_51_0.getCount(arg_51_0.selectors) ~= 0 or not arg_51_0.selectorTpl then
		Object = var_51_1
	...
	Vector2 = var_1_10007
	var_51_1.anchoredPosition = var_51_2 + var_1_10007(-5, -4.8)
	...
	local var_51_5 = var_51_4(var_51_3, var_8(var_9))
...
function var_0_1.CreateBox(arg_52_0, arg_52_1, arg_52_2)
	...
	if var_3.ExistBox(var_52_0, arg_52_1, arg_52_2) then
		...
		if var_52_0.IsOpened(var_52_1, arg_52_1, arg_52_2) then
			return
		end
		...
		if var_52_0.getCount(arg_52_0.boxes) ~= 0 or not arg_52_0.boxTpl then
			Object = var_52_2
		...
		local var_52_5 = var_52_4(var_52_3, var_1_10007(var_1_10008))
...
function var_0_1.CreateDrawableArea(arg_53_0, arg_53_1, arg_53_2)
	...
	if var_3.GetDrawableArea(var_53_0, arg_53_1, arg_53_2) then
		...
		if var_53_0.IsDrawed(var_53_1, arg_53_1, arg_53_2) then
			return
		end
		...
		if var_53_0.getCount(arg_53_0.drawableAare) ~= 0 or not arg_53_0.areaTpl then
			Object = var_53_2
		...
		Vector2 = var_1_10009
		var_53_2.anchoredPosition = var_53_7 - var_1_10009(var_53_6.x, -var_53_6.y)
		...
		local var_53_10 = var_53_9(var_53_8, var_10(var_11))
...
function var_0_1.UpdateDrawableAreas(arg_54_0)
	...
	for iter_54_0, iter_54_1 in var_54_0(var_54_1) do
...
function var_0_1.CreateAnimal(arg_55_0, arg_55_1, arg_55_2, arg_55_3, arg_55_4)
	...
	if var_5.GetDrawableArea(var_55_0, arg_55_1, arg_55_2) then
		...
		if not var_55_0.IsDrawed(var_55_1, arg_55_1, arg_55_2) then
			return
		end
		...
		if var_55_0.getCount(arg_55_0.animals) ~= 0 or not arg_55_0.animalTpl then
			Object = var_55_2
		...
		local var_55_5 = var_55_3(var_55_4[2], var_55_4[3])

		LoadSpriteAtlasAsync = var_9

		var_9("ui/WorldInPicture_atlas", var_55_4[1], function(arg_56_0)
			...
			local var_56_2 = var_56_1(var_56_0, var_2_10003(var_2_10004))

			var_56_2.sprite = arg_56_0

			local var_56_3 = var_56_2

			var_56_2.SetNativeSize(var_56_3)

			local var_56_4 = var_55_2
			...
			var_56_4.localScale = var_56_3(var_56_5, var_56_6, 1)
		...
		Vector3 = var_9
		var_55_2.localScale = var_9.zero
		...
		local var_55_8 = var_55_7(var_55_6, var_11(var_12))
...
function var_0_1.UpdatePoints(arg_58_0)
	...
	local var_58_7 = var_3.GetTravelProgress(var_58_6)
	local var_58_8 = arg_58_0.data

	var_58_4.text = var_58_5(var_58_7, var_4.GetMaxTravelCnt(var_58_8))

	local var_58_9 = arg_58_0.drawProgressTxt
	local var_58_10 = var_0_4
	local var_58_11 = arg_58_0.data
	local var_58_12 = var_3.GetDrawProgress(var_58_11)
	local var_58_13 = arg_58_0.data

	var_58_9.text = var_58_10(var_58_12, var_4.GetMaxDrawCnt(var_58_13))
...
function var_0_1.LoadEffect(arg_63_0, arg_63_1, arg_63_2)
	...
	var_63_1(var_63_0, var_63_2, var_63_3, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_64_0)
		...
		var_64_0(var_2_10002.Instantiate(arg_64_0, arg_63_0._tf).transform)
