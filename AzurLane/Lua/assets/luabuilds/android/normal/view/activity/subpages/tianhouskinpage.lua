...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_3()
		...
		i18n = var_2_10003
		var_4_2.helps = var_2_10003("help_summer_feast")
	...
	local function var_3_6()
		...
		var_5_1(var_5_0, var_2_10002.GO_MINI_GAME, 26)
	...
	local function var_3_9()
		...
		var_6_1(var_6_0, var_2_10002.GO_MINI_GAME, 27)
	...
	local function var_3_12()
		...
		var_7_1(var_7_0, var_2_10002.GO_MINI_GAME, 25)
	...
	var_3_15 = var_1.GetRuntimeData(var_3_14, "elements") and #var_2 >= 4 and var_2[4] == arg_3_0.GetCurrentDay()
	arg_3_0.ishow = var_3_15
	onButton = var_3_15

	local var_3_16 = arg_3_0
	local var_3_17 = arg_3_0.playEffectBtn
	...
	var_3_15(var_3_16, var_3_17, var_3_18, var_1_10007)

	blinkAni = var_3_15

	local var_3_19 = arg_3_0.playEffectBtn

	var_3_15(var_4.Find(var_3_19, "light"), 0.5)
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	var_9_1(arg_9_0.ticketText, var_2.count)

	setText = var_9_1

	var_9_1(arg_9_0.medalText, var_2.usedtime .. "/" .. var_9_2)

	setActive = var_9_1

	var_9_1(arg_9_0.gotTag, var_2.ultimate ~= 0)
	...
	if var_2.ultimate == 0 and var_9_2 <= var_2.usedtime then
		...
		local var_9_5 = var_6.SEND_MINI_GAME_OP
		local var_9_6 = {
			hubid = arg_9_0.hubID
		}

		MiniGameOPCommand = var_8
		var_9_6.cmd = var_8.CMD_ULTIMATE
		var_9_6.args1 = {}
...
function var_0_1.TransformColor(arg_10_0)
	...
	local var_10_0 = var_1_10001(var_1_10002.sub(arg_10_0, 1, 2), 16)

	tonumber = var_2
	string = var_3

	local var_10_1 = var_2(var_3.sub(arg_10_0, 3, 4), 16)

	tonumber = var_3
	string = var_4

	local var_10_2 = var_3(var_4.sub(arg_10_0, 5, 6), 16)
