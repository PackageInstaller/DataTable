...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_3()
		...
		local var_3_2 = var_2_10002.OPEN_LAYER
		...
		WinterFestival2025Mediator = var_2_10005
		var_3_4.mediator = var_2_10005
		WinterFestival2025Scene = var_2_10005
	...
	var_2_5, setText = var_1.Find(var_2_4, "btn/Text"), var_2_4
	i18n = var_2_3

	var_2_4(var_2_5, var_2_3("winter_battlepass_proceed"))
	...
	var_2(var_2_6, #var_4.GetHei5UnreceiveAward(var_2_7) > 0)
...
function var_0_1.OnUpdateFlush(arg_4_0)
	...
	var_1.make(var_4_0, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventInit then
			...
			var_5(var_5_1:Find("mask"), var_5_2)
			...
			local function var_5_5()
				...
				var_6_1(var_6_0, var_3_10002.ON_DROP, var_5_2)
			...
			var_5(var_5_3, var_5_4, var_5_5, var_2_10009)
		end
