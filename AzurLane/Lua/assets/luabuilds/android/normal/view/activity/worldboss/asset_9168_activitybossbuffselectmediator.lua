...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_START, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_1(var_2_0, var_2_10004.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2)

		getProxy = var_2_0
		ActivityProxy = var_4

		local var_2_3 = var_2_0(var_4)
		local var_2_4 = var_3.GetActivityBossRuntime(var_2_3, var_2_2.id)

		_ = var_2_3
		var_2_4.buffIds = var_2_3.map(arg_2_1, function(arg_3_0)
	...
	arg_1_0:bind(var_0_1.SHOW_REWARDS, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
		...
		ActivityBossScoreAwardMediator = var_2_10008
		var_4_3.mediator = var_2_10008
		ActivityBossScoreAwardLayer = var_2_10008
