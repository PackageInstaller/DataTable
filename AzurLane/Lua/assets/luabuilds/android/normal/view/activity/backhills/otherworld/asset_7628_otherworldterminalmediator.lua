...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_GET_PT_ALL_AWARD, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.ACT_NEW_PT, {
			cmd = 4,
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.ACTIVITY_UPDATED then
		...
		if var_5_3 == var_1_10006.BIND_PT_ACT_ID then
			...
			var_5.UpdateAdventurePtAct(var_1_10006, var_4)
		else
			local var_5_4 = var_4.id

			TerminalAdventurePage = var_1_10006

			if var_5_4 == var_1_10006.BIND_TASK_ACT_ID then
				var_1_10006 = arg_5_0.viewComponent

				var_5.UpdateAdventureTaskAct(var_1_10006, var_4)
			else
				local var_5_5 = var_4.id

				ActivityConst = var_1_10006

				if var_5_5 == var_1_10006.OTHER_WORLD_TERMINAL_LOTTERY_ID then
					var_1_10006 = arg_5_0.viewComponent

					var_5.UpdateGuardianAct(var_1_10006, var_4)
				end
			end
		end
	else
		...
		if var_5_0 == var_4.ACT_NEW_PT_DONE then
			local var_5_6 = arg_5_0.viewComponent
			local var_5_7 = var_4.emit

			BaseUI = var_1_10006

			var_5_7(var_5_6, var_1_10006.ON_ACHIEVE, var_5_2.awards)
