...
function var_0_1.OnDataSetting(arg_3_0)
	...
	arg_3_0.activityProxy = var_1_10001(var_1_10002)
...
function var_0_1.findUI(arg_4_0)
	...
	var_4_9(var_4_10, var_3.Find(var_4_11, "BG/Container/Award"))
	...
	var_4_12(var_4_13, var_3.Find(var_4_14, "BG/Container/Award2"))
...
function var_0_1.OnFirstFlush(arg_5_0)
	...
	local function var_5_2()
		...
		var_6_1(var_6_0, var_2_10002.ACTIVITY_OPERATION, {
			cmd = 1,
	...
	local function var_5_5()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.help_chunjie_jiulou_2026.tip
	...
	for iter_5_0, iter_5_1 in var_1_10001(arg_5_0.awardBtnList) do
		if iter_5_1 then
			...
			var_1_10006(var_5_6, var_5_7, var_5_8, var_1_10010)
		end
	end
