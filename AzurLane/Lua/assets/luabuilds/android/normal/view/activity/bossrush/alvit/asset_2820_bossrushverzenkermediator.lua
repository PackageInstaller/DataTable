...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_FLEET_SELECT, function(arg_4_0, arg_4_1)
		...
		BossRushVerZenkerFleetSelectView = var_2_10006
	...
	var_3(var_1_2, "activityID is required by BossRushVerZenkerMediator")
	...
	local var_1_7 = var_1_6(var_1_5, var_6.ZENGKEHAIJUNSHANGJIANG_PT_ACT_ID)
			...
			if var_11_0 == var_11_5.ACTIVITY_UPDATED then
				if var_11_1 then
					...
					if var_5.id == arg_11_0.contextData.activityID then
						...
						var_6.UpdateView(var_11_9)
					else
						local var_11_10 = var_5.id

						ActivityConst = var_11_9

						if var_11_10 == var_11_9.ZENGKEHAIJUNSHANGJIANG_PT_ACT_ID then
							local var_11_11 = arg_11_0.viewComponent

							var_6.SetPtActivity(var_11_11, var_5)

							local var_11_12 = arg_11_0.viewComponent

							var_6.UpdateView(var_11_12)
						end
					end
				end
			else
				...
				if var_11_0 == var_5.SUBMIT_TASK_AWARD_DOWN then
					...
					if #var_11_1.awards > 0 then
						...
						var_6.insert(var_11_13, function(arg_12_0)
					...
					BossRushTotalRewardPanelMediator = var_11_13

					if var_11_0 == var_11_13.ON_WILL_EXIT then
						local var_11_14 = arg_11_0.viewComponent

						var_5.resumeBubble(var_11_14)

						local var_11_15 = arg_11_0.viewComponent

						var_5.UpdateView(var_11_15)
					end
				end
			end
		end
