...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	local var_1_5 = var_3.Find(var_1_4, "sdBtn")
	...
	local function var_1_13()
		...
		function var_4_6.callback()
			...
			var_5_1(var_5_0, var_3_10002("sofmapsd_3"))
	...
	var_1(var_1_11, var_1_12, var_1_13, var_5)
	...
	local function var_1_16()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.sofmap_attention.tip
	...
	var_1(var_1_14, var_1_15, var_1_16, var_5)
	...
	var_2(var_1_18, var_1_19, var_1_20, var_1_10006)
...
function var_0_1.OnUpdateFlush(arg_8_0)
	...
	if 1 <= var_8_3 then
		...
		if not var_6(var_8_1, "#68E9F4FF") then
			var_8_5 = var_8_1
		end
...
function var_0_1.OnDestroy(arg_9_0)
	...
	if arg_9_0.spine then
		local var_9_0 = arg_9_0.spine.transform

		Vector3 = var_1_10002
		var_9_0.localScale = var_1_10002.one
		pg = var_9_0

		local var_9_1 = var_9_0.PoolMgr.GetInstance()

		var_1.ReturnSpineChar(var_9_1, "mingshi_5", arg_9_0.spine)
...
function var_0_1.showBubble(arg_10_0, arg_10_1)
	...
	local function var_10_1(arg_11_0)
		...
		var_11_0(var_11_1, var_2_10003.one * arg_11_0)
	...
	local function var_10_2()
		...
		local var_12_1 = var_12_0(var_2_10001(arg_10_0.bubble), 1, 0, var_0_1.FADE_OUT_TIME)
		local var_12_2 = var_0.setOnUpdate

		System = var_2

		local var_12_3 = var_12_2(var_12_1, var_2.Action_float(var_10_1))
		local var_12_4 = var_0.setOnComplete

		System = var_2

		var_12_4(var_12_3, var_2.Action(function()
	...
	var_10_3(var_1_10006(arg_10_0.bubble))
	...
	local var_10_5 = var_10_4(var_6(arg_10_0.bubble), 0, 1, var_0_1.FADE_TIME)
	local var_10_6 = var_5.setOnUpdate

	System = var_7

	local var_10_7 = var_10_6(var_10_5, var_7.Action_float(var_10_1))
	local var_10_8 = var_5.setOnComplete

	System = var_7

	var_10_8(var_10_7, var_7.Action(function()
		LeanTween = var_2_10000
		...
		local var_14_1 = var_2_10001(arg_10_0.bubble)
		local var_14_2 = var_0_1.SHOW_TIME

		System = var_2_10003

		var_14_0(var_14_1, var_14_2, var_2_10003.Action(var_10_2))
