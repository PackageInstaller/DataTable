...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	local function var_2_1()
		...
		CruiseShop = var_2_10003
		var_3_4.shop = var_2_10003.New(var_3_1, var_3_3)
...
function var_0_1.init(arg_7_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_7_0.gemValue = var_7_6(var_7_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_7_0.ticketValue = var_7_10(var_7_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_7_0.dayTxt = var_7_13(var_7_12, var_3(var_1_10004))
	...
	local var_7_16 = var_2.Find(var_7_15, "progress")

	i18n = var_7_15

	var_1(var_7_16, var_7_15("cruise_phase_title"))

	local var_7_17 = {}
	local var_7_18 = var_0_1.PAGE_AWARD

	WorldCruiseAwardPage = var_3

	local var_7_19 = var_3.New
	local var_7_20 = arg_7_0._tf

	var_7_17[var_7_18] = var_7_19(var_4.Find(var_7_20, "frame/award_container"), arg_7_0.event, arg_7_0.contextData)
	...
	var_7_17[var_7_21] = var_7_22(var_4.Find(var_7_23, "frame/task_container"), arg_7_0.event, arg_7_0.contextData)
	...
	var_7_17[var_7_24] = var_7_25(var_4.Find(var_7_26, "frame/shop_container"), arg_7_0.event, arg_7_0.contextData)
	...
	if var_7_29 then
		...
		local function var_7_34()
			...
			var_10_1(var_10_0, var_2_10002("cruise_shop_no_open"))
		...
		var_7_30(var_7_32, var_7_33, var_7_34, var_1_10007)
	end

	setActive = var_7_30

	var_7_30(var_7_31:Find("lock"), var_7_29)

	setText = var_7_30

	local var_7_35 = var_7_31
	local var_7_36 = var_7_31.Find(var_7_35, "lock/Text")

	i18n = var_7_35

	var_7_30(var_7_36, var_7_35("cruise_shop_no_open"))

	local var_7_37 = arg_7_0.contextData

	WorldCruiseChargePage = var_7_36
	var_7_37.windowForCharge = var_7_36.New(arg_7_0._tf, arg_7_0.event)
...
function var_0_1.didEnter(arg_11_0)
	...
	var_2(var_11_1, var_11_2, var_5.Find(var_11_3, "bg/bg_1"), true)
	...
	local var_11_8 = var_5.Find(var_11_7, "back")
	...
	var_3(var_11_6, var_11_8, var_11_9, var_7)
	...
	local function var_11_12()
		...
		local var_13_2 = var_2_10002.NewStyleMsgboxMgr.TYPE_COMMON_HELP
		local var_13_3 = {}
		...
		pg = var_2_10006
		var_13_3.helps = var_2_10004(var_13_4 .. var_2_10006.battlepass_event_pt[arg_11_0.activity.id].map_name)
	...
	var_3(var_11_10, var_11_11, var_11_12, var_7)
	...
	var_3(var_11_13, var_11_14, var_11_15, var_7)
	...
	local function var_11_18()
		...
		local var_15_0 = var_2_10001.CRUISE_QUICK_TASK_TICKET_ID
		local var_15_1 = {}

		Item = var_2_10003
		var_15_1.id = var_2_10003.QUICK_TASK_PASS_TICKET_ID
	...
	var_3(var_11_16, var_11_17, var_11_18, var_7)

	local var_11_19 = arg_11_0.activity.stopTime

	pg = var_11_16

	local var_11_20 = var_11_16.TimeMgr.GetInstance()
	local var_11_21 = var_11_19 - var_4.GetServerTime(var_11_20)
	local var_11_22 = arg_11_0.dayTxt

	i18n = var_11_20

	local var_11_23 = var_11_20("battlepass_main_time_title")
	...
	local var_11_25 = var_1_10008.floor(var_11_21 / 0)

	math = var_9
	var_11_22.text = var_11_23 .. var_6(var_11_24, var_11_25, var_9.floor(var_11_21 % 0 / 16))
...
function var_0_1.UpdateRes(arg_16_0)
	...
	Item = var_1_10004
	var_16_2.text = var_16_4(var_16_3, var_1_10004.QUICK_TASK_PASS_TICKET_ID)
...
function var_0_1.UpdatePhase(arg_17_0)
	...
	var_1_10001(var_2.Find(var_17_0, "Text"), "<size=27>lv.</size>" .. arg_17_0.phase)
	...
	if arg_17_0.phase < #arg_17_0.awardList then
		...
		var_4(var_5.Find(var_17_4, "slider"), 0, var_17_3, var_17_2)

		setText = var_4

		local var_17_5 = arg_17_0.phaseTF

		var_4(var_5.Find(var_17_5, "progress/Text"), var_17_2 .. "/" .. var_17_3)
	else
		setSlider = var_17_1

		local var_17_6 = arg_17_0.phaseTF

		var_17_1(var_2.Find(var_17_6, "slider"), 0, 1, 1)

		setText = var_17_1

		local var_17_7 = arg_17_0.phaseTF

		var_17_1(var_2.Find(var_17_7, "progress/Text"), "MAX")
	end
...
function var_0_1.UpdateAwardTip(arg_19_0)
	...
	local var_19_1 = var_2.Find(var_19_0, "award/tip")
	local var_19_2 = arg_19_0.activity

	var_1_10001(var_19_1, #var_3.GetCrusingUnreceiveAward(var_19_2) > 0)
...
function var_0_1.SwitchPage(arg_20_0)
	...
	var_2(var_3.Find(var_20_1, "shop_bg"), var_20_0)
	...
	if var_20_0 then
		...
		if not var_20_4("cruise_shop_title") then
			i18n = var_20_4
			var_20_4 = var_20_4("cruise_title_" .. var_20_2)
		end

		var_3(var_20_3, var_20_4)
...
function var_0_1.Hx4Channel(arg_29_0)
	...
	if not var_2(var_29_0) then
		...
		var_2(var_29_1, var_1_10004.isHx())
	end
