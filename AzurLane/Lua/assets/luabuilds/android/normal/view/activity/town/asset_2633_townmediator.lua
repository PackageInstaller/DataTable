...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.UPGRADE_TOWN, function(arg_3_0)
		...
		local var_3_2 = var_2_10003.ACTIVITY_TOWN_OP
		local var_3_3 = {
			activity_id = arg_1_0.activity.id
		}

		TownActivity = var_5
		var_3_3.cmd = var_5.OPERATION.UPGRADE_TOWN
	...
	arg_1_0:bind(var_0_1.UPGRADE_WORKPLACE, function(arg_4_0, arg_4_1)
		...
		TownActivity = var_6
		var_4_3.cmd = var_6.OPERATION.UPGRADE_PLACE
	...
	arg_1_0.bind(var_1_0, var_0_1.CLICK_BUBBLE, function(arg_5_0, arg_5_1)
		...
		local var_5_2 = var_2_10004.ACTIVITY_TOWN_OP
		local var_5_3 = {
			activity_id = arg_1_0.activity.id
		}

		TownActivity = var_6
		var_5_3.cmd = var_6.OPERATION.CLICK_BUBBLE
...
function var_0_1.ChangeShips(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_1_10004.ACTIVITY_TOWN_OP
	local var_6_3 = {
		activity_id = arg_6_0.activity.id
	}

	TownActivity = var_6
	var_6_3.cmd = var_6.OPERATION.CHANGE_SHIPS
...
function var_0_1.OnSelShips(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_1.priorEquipUpShipIDList = var_7_4(var_6.GetShipIds(var_7_5), function(arg_9_0)
		return arg_9_0 > 0
	end)
	i18n = var_5
	...
	local var_7_8 = var_7.New
	local var_7_9 = {}

	DockyardScene = var_1_10009
	var_7_9.viewComponent = var_1_10009
	DockyardMediator = var_1_10009
	var_7_9.mediator = var_1_10009
...
function var_0_1.OnSelected(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_1 = var_1_10004(var_5.GetShipIds(var_10_0))
	local var_10_2 = {}
	local var_10_3 = {}
...
function var_0_1.handleNotification(arg_13_0, arg_13_1)
	...
	if var_13_0 == var_13_1.ACTIVITY_TOWN_OP_DONE then
		switch = var_4

		local var_13_3 = var_13_2.cmd
		local var_13_4 = {}

		TownActivity = var_1_10007
		var_13_4[var_1_10007.OPERATION.UPGRADE_TOWN] = function()
			pg = var_2_10000
			...
			var_1({
				...
				function(arg_17_0)
					if #var_14_2.unlock_work[1] > 0 or #var_1[2] > 0 then
						...
						local var_17_2 = var_3_10004.New
						local var_17_3 = {}

						TownUnlockMediator = var_3_10006
						var_17_3.mediator = var_3_10006
						TownUnlockLayer = var_3_10006
						var_17_3.viewComponent = var_3_10006
						var_17_3.data = {
							newIds = var_1[1],
							limitIds = var_1[2],
							removeFunc = arg_17_0
		...
		TownActivity = var_7
		var_13_4[var_7.OPERATION.UPGRADE_PLACE] = function()
			...
			var_2_10000({
				...
				function(arg_21_0)
					...
					var_21_1(var_21_0, var_3_10003.ON_ACHIEVE, var_13_2.awards)
		...
		TownActivity = var_7
		var_13_4[var_7.OPERATION.CHANGE_SHIPS] = function()
		...
		TownActivity = var_7
		var_13_4[var_7.OPERATION.CLICK_BUBBLE] = function()
			...
			var_24_2(var_24_1, var_2_10002.ON_ACHIEVE, var_13_2.awards)

			return
		end

		var_4(var_13_3, var_13_4)
	else
		ActivityProxy = var_4

		if var_13_0 == var_4.ACTIVITY_UPDATED then
			local var_13_5 = var_13_2
			local var_13_6 = var_13_2.getConfig(var_13_5, "type")

			ActivityConst = var_13_5

			if var_13_6 == var_13_5.ACTIVITY_TYPE_TOWN then
				getProxy = var_13_6
				ActivityProxy = var_5

				local var_13_7 = var_13_6(var_5)
				local var_13_8 = var_4.getActivityByType

				ActivityConst = var_6
				arg_13_0.activity = var_13_8(var_13_7, var_6.ACTIVITY_TYPE_TOWN)

				local var_13_9 = arg_13_0.viewComponent

				var_4.SetActivity(var_13_9, arg_13_0.activity)

				local var_13_10 = arg_13_0.viewComponent

				var_4.UpdateGold(var_13_10)

				local var_13_11 = arg_13_0.viewComponent

				var_4.OnExpUpdate(var_13_11)
			end
		end
	end
