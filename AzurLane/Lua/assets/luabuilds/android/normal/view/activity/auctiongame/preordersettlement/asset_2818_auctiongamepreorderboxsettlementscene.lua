...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_9, var_3("auction_settlement_quick"))
	...
	var_1(var_2_10, var_3("auction_settlement_value"))
	...
	var_1(var_2_11, var_3("auction_settlement_revenue"))
...
function var_0_1.didEnter(arg_6_0)
	...
	setPaintingPrefabAsync = var_6_2

	local var_6_4 = arg_6_0.uiPaintingTf

	pg = var_5

	var_6_2(var_6_4, var_5.ship_skin_template[900284].painting, "chuanwu", nil, {
		skinID = 900284
	})

	setText = var_6_2

	var_6_2(arg_6_0.uiStoreHouseText, 0)
	...
	local var_6_6 = var_5.format
	local var_6_7 = "<color=#B13535>%s</color>"

	StringHelper = var_7

	local var_6_8 = var_7.ForamtNumber

	AuctionGameTools = var_8

	var_6_2(var_6_5, var_6_6(var_6_7, var_6_8(-1 * var_8.GetPreorderCurrentyCnt())))
	...
	handler = var_7
	var_6_9[1] = var_6_11(var_6_10, var_6_12, var_7(arg_6_0, arg_6_0.OnRefreshText))
	...
	handler = var_7
	var_6_9[2] = var_6_14(var_6_13, var_6_15, var_7(arg_6_0, arg_6_0.OnRefreshOver))
	...
	LoadSpriteAsync = var_6_19
	Drop = var_7

	local var_6_21 = var_7.New
	local var_6_22 = {}
	...
	var_6_19(var_7.getIcon(var_6_23), function(arg_7_0)
		IsNil = var_2_10001
...
function var_0_1.OnRefreshText(arg_9_0, arg_9_1, arg_9_2)
	...
	AuctionGameTools = var_9_0

	local var_9_2 = var_9_1 - var_9_0.GetPreorderCurrentyCnt()
	...
	local var_9_4 = var_6.format
	local var_9_5 = "<color=%s>%s</color>"
	local var_9_6 = var_9_2 > 0 and "#03825F" or "#B13535"

	StringHelper = var_9

	var_4(var_9_3, var_9_4(var_9_5, var_9_6, var_9.ForamtNumber(var_9_2)))
...
function var_0_1.OnRefreshOver(arg_10_0)
	...
	getProxy = var_2
	AuctionGameBaseProxy = var_3

	local var_10_1 = var_2(var_3)
	...
	var_10_3(var_10_2, var_5.BuildPreorder(1, var_10_0))
...
function var_0_1.willExit(arg_11_0)
	...
	var_1(var_11_0, var_3.ship_skin_template[900284].painting)
