...
function var_0_1.Init(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("LiquorFloorTaskUI_go"))
	...
	var_1_10001(var_2_1, var_3("LiquorFloorTaskUI_get"))
	...
	var_1_10001(var_2_2, var_3("LiquorFloorTaskUI_got"))
	...
	local function var_2_5()
		...
		LiquorFloorTaskMediator = var_2_10002

		var_3_1(var_3_0, var_2_10002.ON_TASK_GO, arg_2_0.taskVO)
...
function var_0_1.SetData(arg_9_0, arg_9_1)
	...
	if var_9_0 < arg_9_1.getProgress(var_9_1) then
		var_9_2 = var_9_0
	end

	setText = var_9_1

	local var_9_3 = arg_9_0.uiProgressText

	string = var_6

	var_9_1(var_9_3, var_6.format("%s/%s", var_9_2, var_9_0))

	arg_9_0.uiSlider.value = var_9_2 / var_9_0
	...
	local var_9_4 = arg_9_1:getConfig("award_display")
	local var_9_5 = arg_9_0.rewardList

	var_5.align(var_9_5, #var_9_4)
