...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.Atelier.Store.AtelierStoreBaseScene"))
...
function var_0_1.InitCustom(arg_2_0)
	...
	local var_2_1 = var_2.Find(var_2_0, "Window/Text")

	i18n = var_2_0

	var_1_10001(var_2_1, var_2_0("yumia_atelier_tip13"))

	setText = var_1_10001

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_2.Find(var_2_2, "Window/textBg/Name")

	i18n = var_2_2

	var_1_10001(var_2_3, var_2_2("yumia_atelier_tip16"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "Window/textBg/closeBtn")
...
function var_0_1.PlayCloseAni(arg_6_0)
	...
	local var_6_1 = var_1_10001(var_6_0, var_1_10003(var_1_10004))
...
function var_0_1.ShowStoreHouseWindow(arg_9_0)
	...
	local var_9_5 = var_9_2(var_9_3(var_4.GetItems(var_9_4)), function(arg_10_0)
		return arg_10_0.count > 0 and arg_10_0:GetVersion() == var_9_0 and arg_10_0:IsShow() ~= 0
	end)

	table = var_3

	var_3.sort(var_9_5, function(arg_11_0, arg_11_1)
	...
	var_3(var_4.Find(var_9_6, "Window/Empty"), #var_9_5 == 0)

	setActive = var_3

	local var_9_7 = arg_9_0._tf

	var_3(var_4.Find(var_9_7, "Window/ScrollView"), #var_9_5 > 0)
	...
	function arg_9_0.storehouseRect.onUpdateItem(arg_12_0, arg_12_1)
		...
		var_4(var_12_3, var_12_4, var_12_5, var_2_10008)
...
function var_0_1.ShowItemDetail(arg_15_0, arg_15_1)
	...
	var_15_1(var_15_0, var_1_10004.SHOW_DETAIL, arg_15_1)
...
function var_0_1.AddTimer(arg_16_0, arg_16_1)
	...
	FrameTimer = var_16_1
	arg_16_0.timer = var_16_1.New(function()
		math = var_2_10000
...
function var_0_1.AddTimer2(arg_18_0)
	...
	var_3(var_4.Find(var_18_2, "Window/ScrollView"), "LScrollRect", false)

	for iter_18_0 = 0, var_18_1 - 1 do
		SetComponentEnabled = var_1_10007

		local var_18_3 = var_1
		local var_18_4 = var_1.GetChild(var_18_3, iter_18_0)

		typeof = var_18_3
		Animation = var_10

		var_1_10007(var_18_4, var_18_3(var_10), false)

		GetComponent = var_1_10007

		local var_18_5 = var_1
		local var_18_6 = var_1.GetChild(var_18_5, iter_18_0)

		typeof = var_18_5
		CanvasGroup = var_10
		var_1_10007 = var_1_10007(var_18_6, var_18_5(var_10))
		var_1_10007.alpha = 0
	end
	...
	arg_18_0.timer = var_4.New(function()
		if var_18_7 >= var_18_1 then
			...
			var_0(var_1.Find(var_19_1, "Window/ScrollView"), "LScrollRect", true)
		...
		local var_19_3 = var_1.GetChild(var_19_2, var_18_7)

		typeof = var_19_2
		Animation = var_3

		local var_19_4 = var_0(var_19_3, var_19_2(var_3))
	...
	local var_18_8 = arg_18_0.timer

	var_4.Start(var_18_8)
