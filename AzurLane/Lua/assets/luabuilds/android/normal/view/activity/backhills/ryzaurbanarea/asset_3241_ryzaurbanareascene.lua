...
function var_0_1.init(arg_2_0)
	...
	import = var_2
	arg_2_0.graphPath = var_2_10(var_2("GameCfg.BackHillGraphs.RyzaUrbanAreaGraph"))

	local var_2_11 = arg_2_0.top

	arg_2_0.minigameCount = var_1.Find(var_2_11, "minigame/count")

	local var_2_12 = arg_2_0._map
	local var_2_13 = var_1.Find(var_2_12, "huodongye/puni")

	arg_2_0.puniAnim = var_1.GetComponent(var_2_13, "SpineAnimUI")
...
function var_0_1.didEnter(arg_3_0)
	...
	var_1_10001(var_3_4, var_3.Find(var_3_5, "top/help_btn"), function()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.ryza_tip_main.tip
	...
	arg_3_0.InitFacilityCross(var_3_10, arg_3_0._map, arg_3_0._upper, "xiaoyouxi", function()
		...
		var_7_1(var_7_0, var_2_10002.GO_MINI_GAME, 43)
	...
	local var_3_13 = var_3_12(var_3_11, var_4.RYZA_PT)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "lianjingongfang", function()
		...
		var_9_1(var_9_0, var_9_2, var_2_10003.ATELIER_COMPOSITE)
	...
	arg_3_0:InitFacilityCross(arg_3_0._map, arg_3_0._upper, "weituoban", function()
		...
		var_10_1(var_10_0, var_10_2, var_2_10003.RYZA_TASK)
...
function var_0_1.UpdateView(arg_11_0)
	...
	local var_11_5 = var_11_4(var_11_3, var_1_10006.ACTIVITY_TYPE_MINIGAME)
	...
	if var_11_5 then
		...
		getProxy = var_11_7
		MiniGameProxy = var_11_9
		var_11_9 = var_11_7(var_11_9)
		var_11_7 = var_11_7.GetHubByHubId(var_11_9, var_11_5:getConfig("config_id"))
	end

	setText = var_11_9

	var_11_9(arg_11_0.minigameCount, var_11_7.usedtime .. "/" .. var_11_7:getConfig("reward_need"))
	...
	local var_11_12 = var_11_11(var_11_10, var_9.RYZA_PT)
	...
	local var_11_18 = var_11_17(var_11_16, var_11.RYZA_TASK)
	local var_11_19 = arg_11_0.upper_weituoban
	local var_11_20 = var_9.Find(var_11_19, "tip")

	setActive = var_11_19

	var_11_19(var_11_20, var_11_18)
...
function var_0_1.UpdatePuniAnim(arg_12_0, arg_12_1)
	if not arg_12_1 then
		...
		var_12_1(var_12_0, var_12_2 .. var_1_10005.random(9), 0)
	else
		local var_12_3 = arg_12_1
		local var_12_4 = arg_12_1.getConfig(var_12_3, "config_client").puni_phase

		ActivityPtData = var_12_3

		local var_12_5 = var_12_3.New(arg_12_1)
		local var_12_6 = var_3.GetLevelProgress(var_12_5)
		local var_12_7 = 1

		ipairs = var_1_10006

		for iter_12_0, iter_12_1 in var_1_10006(var_12_4) do
		...
		if var_12_7 == #var_12_4 then
			math = var_6
			var_12_7 = var_6.random(#var_12_4)
		end

		local var_12_8 = arg_12_0.puniAnim

		var_6.SetAction(var_12_8, "normal_" .. var_12_7, 0)
	end
...
function var_0_1.IsShowMainTip(arg_13_0)
	local function var_13_0()
		...
		return var_14_0(var_2_10001.MINIGAME_RYZA)
	end
	...
	local function var_13_1()
		...
		local var_15_2 = var_15_1(var_15_0, var_2_10002.RYZA_PT)
	...
	local function var_13_2()
		...
		return var_16_1(var_16_0, var_2_10002.RYZA_TASK)
	end
