...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	arg_1_0._eventTrigger = var_1_0(var_1_1, var_1_10007(var_1_10008))
	findTF = var_5
	...
	tf = var_5
	instantiate = var_6
	arg_1_0._iconTf = var_5(var_6(arg_1_4))
	setActive = var_5
	...
	Vector2 = var_6
	var_1_2.anchoredPosition = var_6(0, 0)
	...
	typeof = var_7
	CanvasGroup = var_8
	arg_1_0._iconCanvasGroup = var_1_2(var_1_3, var_7(var_8))
	...
	arg_1_0._lineEventTrigger = var_5(var_1_5, var_7(var_8))
...
function var_0_0.setPrepare(arg_6_0, arg_6_1)
	...
	var_2(var_6_0(var_6_1, var_5(arg_6_1)), true)
...
function var_0_0.clearPrepare(arg_8_0)
	if arg_8_0._prepareColor then
		...
		if 0 < var_8_0 then
			...
			local var_8_1 = var_2(arg_8_0._iconTf, arg_8_0._prepareColor)

			typeof = var_3
			Image = var_4

			local var_8_2 = var_8_0(var_8_1, var_3(var_4))

			Color = var_8_1
			var_8_2.color = var_8_1.New(1, 1, 1, 1)
...
function var_0_0.setLine(arg_9_0, arg_9_1, arg_9_2)
	if arg_9_1 then
		...
		if arg_9_0.getLineStrByGrid(var_9_0, arg_9_1) then
			setActive = var_9_0
			findTF = var_5

			var_9_0(var_5(arg_9_0._lineTf, var_3), true)
		end
	end
	...
	if arg_9_2 then
		...
		if arg_9_0.getLineStrByGrid(var_9_1, arg_9_2) then
			setActive = var_9_1
			findTF = var_5

			var_9_1(var_5(arg_9_0._lineTf, var_3), true)
		end
	end
...
function var_0_0.setChildVisible(arg_12_0, arg_12_1, arg_12_2)
	for iter_12_0 = 1, arg_12_1.childCount do
		...
		local var_12_1 = arg_12_1.GetChild(var_12_0, iter_12_0 - 1)
...
function var_0_0.updateGrid(arg_14_0)
	...
	if var_14_0 == var_2.game_state_puzzle then
		setActive = var_14_0
		...
		var_14_1(var_2(arg_14_0._iconTf, "lineBound"), false)

		setActive = var_14_1
		findTF = var_2

		var_14_1(var_2(arg_14_0._unLockTf, "whiteImg"), false)
	else
		...
		if var_14_2 == var_2.game_state_connect then
			...
			if arg_14_0._mapIndex then
				local var_14_3 = arg_14_0._mapIndex

				if 0 < var_14_3 then
					setActive = var_14_3
					findTF = var_2

					var_14_3(var_2(arg_14_0._iconTf, arg_14_0._mapIndex), true)

					setActive = var_14_3
					findTF = var_2

					var_14_3(var_2(arg_14_0._iconTf, "lineBound"), true)

					setActive = var_14_3

					var_14_3(arg_14_0._unLockTf, true)

					setActive = var_14_3
					findTF = var_2

					var_14_3(var_2(arg_14_0._unLockTf, "whiteImg"), true)
				end
			end
		end
	end
...
function var_0_0.setFillItem(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	var_20_0(var_1_10006(var_20_2, var_1_10008(var_20_1)), true)

	local var_20_3

	if arg_20_0._mapIndex then
		var_20_3 = arg_20_0._mapIndex

		if 0 < var_20_3 then
			setActive = var_20_3
			findTF = var_6

			var_20_3(var_6(arg_20_0._unLockTf, "whiteImg"), true)
	...
	var_20_3(var_6(arg_20_0._unLockTf, "whiteImg"), false)
...
function var_0_0.clearFillItem(arg_22_0)
	...
	if arg_22_0._mapIndex then
		local var_22_0 = arg_22_0._mapIndex

		if 0 < var_22_0 then
			setActive = var_22_0
			findTF = var_2

			var_22_0(var_2(arg_22_0._unLockTf, "whiteImg"), false)
		end
	end
...
function var_0_0.setPrepareAlpha(arg_24_0, arg_24_1)
	if arg_24_0._prepareColor and arg_24_0._prepareColor > 0 then
		...
		var_24_0, GetComponent = var_2(arg_24_0._iconTf, arg_24_0._prepareColor), var_3
		typeof = var_1_10005
		Image = var_1_10006
		var_3(var_24_0, var_1_10005(var_1_10006)).color = arg_24_1
	end
