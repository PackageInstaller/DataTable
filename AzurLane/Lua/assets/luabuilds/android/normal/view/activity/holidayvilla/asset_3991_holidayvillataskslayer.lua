...
function var_0_1.GetAllAward(arg_11_0)
	...
	HolidayVillaTasksMediator = var_5

	var_11_6(var_11_5, var_5.ON_TASK_SUBMIT_ONESTEP, arg_11_0.taskActivityId, var_11_1)
...
function var_0_1.UpdateList(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	local var_14_5 = arg_14_2.Find(var_14_4, "desc")

	setText = var_14_4

	var_14_4(var_14_5, var_14_3:getConfig("desc"))

	local var_14_6 = var_14_3:getProgress()
	local var_14_7 = var_14_3
	local var_14_8 = var_14_3.getConfig(var_14_7, "target_num")

	setText = var_14_7

	var_14_7(arg_14_2:Find("progress"), var_14_6 .. "/" .. var_14_8)

	setSlider = var_14_7

	var_14_7(arg_14_2:Find("slider"), 0, var_14_8, var_14_6)

	local var_14_9 = arg_14_2:GetChild(0)
	local var_14_10 = arg_14_2:Find("awards")

	arg_14_0:updateAwards(var_14_3:getConfig("award_display"), var_14_10, var_14_9)

	local var_14_11 = arg_14_2:Find("go_btn")
	local var_14_12 = arg_14_2:Find("get_btn")
	...
	local var_14_16 = arg_14_2.Find(var_14_15, "go_btn/text")

	i18n = var_14_15

	var_14_13(var_14_16, var_14_15("other_world_task_go"))

	setText = var_14_13

	local var_14_17 = arg_14_2
	local var_14_18 = arg_14_2.Find(var_14_17, "get_btn/text")

	i18n = var_14_17

	var_14_13(var_14_18, var_14_17("other_world_task_get"))

	setText = var_14_13

	local var_14_19 = arg_14_2
	local var_14_20 = arg_14_2.Find(var_14_19, "got_btn/text")

	i18n = var_14_19

	var_14_13(var_14_20, var_14_19("other_world_task_got"))

	local var_14_21 = var_14_3
	local var_14_22 = var_14_3.getTaskStatus(var_14_21)

	setActive = var_14_21

	var_14_21(var_14_11, var_14_22 == 0)

	setActive = var_14_21

	var_14_21(var_14_12, var_14_22 == 1)

	setActive = var_14_21

	var_14_21(var_14_14, var_14_22 == 2)

	SetActive = var_14_21

	var_14_21(arg_14_2:Find("tip"), var_14_22 == 1)

	onButton = var_14_21

	local var_14_23 = arg_14_0
	local var_14_24 = var_14_12

	local function var_14_25()
		local var_15_0 = arg_14_0
		local var_15_1 = var_0.emit

		HolidayVillaTasksMediator = var_2_10002

		var_15_1(var_15_0, var_2_10002.ON_TASK_SUBMIT_ONESTEP, arg_14_0.taskActivityId, {
			var_14_3.id
		})
	...
	var_14_21(var_14_23, var_14_24, var_14_25, var_1_10020)

	onButton = var_14_21

	local var_14_26 = arg_14_0
	local var_14_27 = var_14_11
	...
	local function var_14_28()
		...
		var_16_1(var_16_0, var_2_10002.ON_TASK_GO, var_14_3)
	...
	var_14_21(var_14_26, var_14_27, var_14_28, var_1_10020)
...
function var_0_1.updateAwards(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	for iter_17_1 = 1, var_17_1 do
		...
		if var_17_3 then
			...
			var_14(var_1_10015(var_17_2, "mask"), var_17_5)

			onButton = var_14
			var_1_10015 = arg_17_0

			local var_17_6 = var_17_2:Find("mask")
			...
			local function var_17_7()
				...
				var_18_1(var_18_0, var_2_10002.ON_ITEM, var_17_5)
			...
			var_14(var_1_10015, var_17_6, var_17_7, var_18)
		end
	end
