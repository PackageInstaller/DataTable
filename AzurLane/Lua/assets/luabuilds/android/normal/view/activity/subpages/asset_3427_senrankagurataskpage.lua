...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.taskProxy = var_1_10001(var_1_10002)
	getProxy = var_1
	ActivityProxy = var_1_10002
	arg_1_0.activityProxy = var_1(var_1_10002)
...
function var_0_1.findUI(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_2(arg_6_0.nameList) do
		...
		local var_6_3 = var_6_1.Find(var_6_2, iter_6_1)

		getImageSprite = var_6_2

		local var_6_4 = var_6_2(var_6_3)

		arg_6_0.iconSpriteDict[iter_6_0] = var_6_4
		arg_6_0.iconSpriteDict[iter_6_1] = var_6_4
	end

	local var_6_5 = arg_6_0._tf
	local var_6_6 = var_2.Find(var_6_5, "HXList")
	local var_6_7 = {
		"feiniao",
		"yan",
		"xuequan",
	...
	for iter_6_2, iter_6_3 in var_4(var_6_7) do
		local var_6_8 = var_6_6
		local var_6_9 = var_6_6.Find(var_6_8, iter_6_3)

		getImageSprite = var_6_8

		local var_6_10 = var_6_8(var_6_9)

		arg_6_0.hxSpriteDict[iter_6_3] = var_6_10
	end
	...
	arg_6_0.posPanel = var_4.Find(var_6_11, "PosPanel")

	local var_6_12 = arg_6_0.posPanel

	arg_6_0.finalLockTF = var_4.Find(var_6_12, "FinalAward/Lock")

	local var_6_13 = arg_6_0.posPanel

	arg_6_0.finalGotTF = var_4.Find(var_6_13, "FinalAward/Got")
	arg_6_0.posTFList = {}

	local var_6_14 = arg_6_0.posPanel
	local var_6_15 = var_4.Find(var_6_14, "PosList")

	for iter_6_4 = 1, #arg_6_0.nameList do
		local var_6_16 = var_6_15
		local var_6_17 = var_6_15.Find(var_6_16, iter_6_4)

		table = var_6_16

		var_6_16.insert(arg_6_0.posTFList, var_6_17)

		local var_6_18 = var_6_17
		local var_6_19 = var_6_17.Find(var_6_18, "Get")
		...
		var_6_18(var_6_20, var_6_21, var_6_22, var_1_10015)
	end

	local var_6_23 = arg_6_0._tf

	arg_6_0.taskPanel = var_5.Find(var_6_23, "TaskPanel")

	local var_6_24 = arg_6_0.taskPanel

	arg_6_0.paintingTF = var_5.Find(var_6_24, "PaintingPanel/Main/Painting")

	local var_6_25 = arg_6_0.taskPanel

	arg_6_0.paintingHXTF = var_5.Find(var_6_25, "PaintingPanel/Main/HX")
	arg_6_0.progressTFList = {}

	local var_6_26 = arg_6_0.taskPanel
	local var_6_27 = var_5.Find(var_6_26, "Progress")

	for iter_6_5 = 1, #arg_6_0.nameList do
		local var_6_28 = var_6_27:Find(iter_6_5)

		arg_6_0.progressTFList[iter_6_5] = var_6_28
	end

	arg_6_0.taskTFList = {}

	local var_6_29 = arg_6_0.taskTFList
	local var_6_30 = arg_6_0.taskPanel

	var_6_29[1] = var_7.Find(var_6_30, "Task1")

	local var_6_31 = arg_6_0.taskTFList
	local var_6_32 = arg_6_0.taskPanel

	var_6_31[2] = var_7.Find(var_6_32, "Task2")

	local var_6_33 = arg_6_0._tf

	arg_6_0.logText = var_6.Find(var_6_33, "LogText")
...
function var_0_1.updatePosPanel(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10003(var_8_0) do
		...
		var_1_10013(var_8_4, var_8_6, true)

		setActive = var_1_10013

		var_1_10013(var_9, var_8_2)
	end

	local var_8_7 = arg_8_0
	local var_8_8 = arg_8_0.isGotFinalAward(var_8_7)

	setActive = var_8_7

	var_8_7(arg_8_0.finalGotTF, var_8_8)

	setActive = var_8_7

	var_8_7(arg_8_0.finalLockTF, not var_8_8)
...
function var_0_1.updateTaskList(arg_10_0)
	...
	local var_10_1 = arg_10_0.getCurTaskIDList(var_10_0)

	ipairs = var_10_0

	for iter_10_0, iter_10_1 in var_10_0(arg_10_0.taskTFList) do
		local var_10_2 = var_10_1[iter_10_0]
		local var_10_3 = arg_10_0.taskProxy
		local var_10_4 = var_8.getTaskVO(var_10_3, var_10_2)
		local var_10_5 = iter_10_1
		local var_10_6 = iter_10_1.Find(var_10_5, "Desc")

		setText = var_10_5

		var_10_5(var_10_6, var_10_4:getConfig("desc"))

		local var_10_7 = var_10_4:getProgress()
		local var_10_8 = var_10_4:getConfig("target_num")
		local var_10_9 = iter_10_1:Find("ProgressText")
		local var_10_10 = iter_10_1
		local var_10_11 = iter_10_1.Find(var_10_10, "ProgressBar")

		setText = var_10_10

		var_10_10(var_10_9, var_10_7 .. "/" .. var_10_8)

		setSlider = var_10_10

		var_10_10(var_10_11, 0, var_10_8, var_10_7)

		local var_10_12 = var_10_4:getTaskStatus()
		local var_10_13 = iter_10_1:Find("GetBtn")
		local var_10_14 = iter_10_1:Find("GotBtn")
		local var_10_15 = iter_10_1
		local var_10_16 = iter_10_1.Find(var_10_15, "GoBtn")

		setActive = var_10_15

		var_10_15(var_10_16, var_10_12 == 0)

		setActive = var_10_15

		var_10_15(var_10_13, var_10_12 == 1)

		setActive = var_10_15

		var_10_15(var_10_14, var_10_12 == 2)
		...
		local function var_10_19()
			...
			var_11_1(var_11_0, var_2_10002.ON_TASK_GO, var_10_4)
		...
		var_10_15(var_10_17, var_10_18, var_10_19, var_1_10022)

		onButton = var_10_15

		local var_10_20 = arg_10_0
		local var_10_21 = var_10_13
		...
		local function var_10_22()
			...
			var_12_1(var_12_0, var_2_10002.ON_TASK_SUBMIT, var_10_4)
		...
		var_10_15(var_10_20, var_10_21, var_10_22, var_1_10022)

		local var_10_23 = var_10_4:getConfig("award_display")[1]
		local var_10_24 = {
			type = var_10_23[1],
			id = var_10_23[2],
			count = var_10_23[3]
		}
		local var_10_25 = iter_10_1
		local var_10_26 = iter_10_1.Find(var_10_25, "Icon")

		updateDrop = var_10_25

		var_10_25(var_10_26, var_10_24)

		onButton = var_10_25
		var_1_10022 = arg_10_0

		local var_10_27 = var_10_26
		...
		local function var_10_28()
			...
			var_13_1(var_13_0, var_2_10002.ON_DROP, var_10_24)
		...
		var_10_25(var_1_10022, var_10_27, var_10_28, var_1_10025)

		var_1_10022 = arg_10_0

		if arg_10_0.isFinishedCurTaskList(var_1_10022) then
			var_1_10022 = arg_10_0:getStep()

			local var_10_29 = arg_10_0.configData.story_task[var_1_10022][1]

			print = var_10_28
			var_1_10025 = "story"
			tostring = var_1_10026

			var_10_28(var_1_10025, var_1_10026(var_10_29))

			if var_10_29 then
				pg = var_10_28
				var_1_10025 = var_10_28.NewStoryMgr.GetInstance()

				var_24.Play(var_1_10025, var_10_29, nil)
			end
		end
	end
...
function var_0_1.updateProgress(arg_14_0)
	...
	local var_14_1 = arg_14_0.getStep(var_14_0)

	ipairs = var_14_0

	for iter_14_0, iter_14_1 in var_14_0(arg_14_0.progressTFList) do
		local var_14_2 = iter_14_1:Find("Get")
		local var_14_3 = iter_14_1:Find("Got")
		local var_14_4 = iter_14_1
		local var_14_5 = iter_14_1.Find(var_14_4, "Doing")

		setActive = var_14_4

		var_14_4(var_14_3, iter_14_0 < var_14_1)

		setActive = var_14_4

		var_14_4(var_14_2, var_14_1 < iter_14_0)

		setActive = var_14_4

		var_14_4(var_14_5, iter_14_0 == var_14_1)
	end
...
function var_0_1.updatePainting(arg_15_0)
	...
	var_5(arg_15_0.paintingTF, var_15_3, true)
...
function var_0_1.openTaskAni(arg_16_0)
	...
	local var_16_2 = var_1_10003.indexof(var_16_1, var_16_0, 1)
	local var_16_3 = arg_16_0.posTFList[var_16_2]
	local var_16_4 = var_4.Find(var_16_3, "Get")
	local var_16_5 = var_4
	local var_16_6 = var_4.Find(var_16_5, "Got")

	setImageAlpha = var_16_5
	...
	local var_16_8 = var_16_6.Find(var_16_7, "Icon")

	setActive = var_16_7

	var_16_7(var_16_8, false)

	System = var_16_7

	local var_16_9 = var_16_7.Action_float(function(arg_17_0)
		setImageAlpha = var_2_10001

		var_2_10001(var_16_4, 1 - arg_17_0)

		setImageAlpha = var_2_10001

		var_2_10001(var_16_6, arg_17_0)
	...
	local var_16_10 = var_9.Action(function()
	...
	local var_16_12 = arg_16_0.managedTween

	LeanTween = var_1_10012

	local var_16_13 = var_1_10012.value
	local var_16_14

	go = var_1_10014

	local var_16_15 = var_16_12(var_16_11, var_16_13, var_16_14, var_1_10014(var_4), var_16_9, 0, 1, 0.5)

	var_10.setOnComplete(var_16_15, var_16_10)
...
function var_0_1.check(arg_20_0)
	if not arg_20_0:isGotFinalAward() then
		if arg_20_0:getStep() <= arg_20_0.groupNum and arg_20_0:getCurTaskIDList() then
			local var_20_0 = arg_20_0

			if arg_20_0.isFinishedCurTaskList(var_20_0) then
				print = var_20_0
		...
		if var_2 == arg_20_0.groupNum then
			local var_20_1 = arg_20_0

			if not arg_20_0.getCurTaskIDList(var_20_1) then
				print = var_20_1
...
function var_0_1.isFinishedCurTaskList(arg_25_0)
	...
	local var_25_1 = arg_25_0.getCurTaskIDList(var_25_0)

	_ = var_25_0

	return var_25_0.all(var_25_1, function(arg_26_0)
...
function var_0_1.getCurDayCount(arg_27_0)
	...
	local var_27_3 = var_27_1.TimeMgr.GetInstance()
...
function var_0_1.getMaxDayCount(arg_28_0)
	...
	local var_28_1 = arg_28_0.getCurDayCount(var_28_0)

	math = var_28_0

	return (var_28_0.clamp(var_28_1, 1, arg_28_0.configData.total_num))
end
...
function var_0_1.selectPos(arg_30_0, arg_30_1)
	...
	var_30_1(var_30_0, var_1_10004.EVENT_OPERATION, {
		cmd = 1,
...
function var_0_1.getFinalAward(arg_31_0)
	...
	var_31_1(var_31_0, var_1_10003.EVENT_OPERATION, {
		cmd = 1,
...
function var_0_1.updateLogText(arg_32_0)
	...
	local var_32_7 = var_32_5.activity_event_turning[var_32_6].total_num

	pg = var_8

	local var_32_8 = var_8.activity_event_turning[var_32_6].groupid_list

	pg = var_1_10009

	local var_32_9 = var_1_10009.TimeMgr.GetInstance()
	local var_32_10 = var_9.DiffDay
	local var_32_11 = var_32_0

	pg = var_1_10012

	local var_32_12 = var_1_10012.TimeMgr.GetInstance()
	local var_32_13 = var_32_10(var_32_9, var_32_11, var_12.GetServerTime(var_32_12)) + 1

	math = var_32_9

	local var_32_14 = var_32_9.clamp(var_32_13, 1, var_32_7)
	local var_32_15 = ""
	...
	var_32_16(var_32_17 .. var_1_10015(var_32_0))
	...
	var_32_18(var_32_19 .. var_15(var_32_1))
	...
	var_32_20(var_32_21 .. var_15(var_32_2))
	...
	var_32_22(var_32_23 .. var_15(var_32_3))
	...
	var_32_24(var_32_25 .. var_15.concat(var_32_4, "-"))
	...
	var_32_26(var_32_27 .. var_15(var_32_13))
	...
	var_32_28(var_32_29 .. var_15(var_32_14))
	...
	var_32_30(var_32_31 .. var_15(var_32_7))
	...
	var_32_32(var_32_33 .. var_15.concat(var_32_8, "-"))
	...
	if 0 < var_32_3 then
		...
		var_32_37(var_32_38 .. var_1_10018(var_32_34))
		...
		var_32_39(var_32_40 .. var_18.concat(var_32_35, "-"))
		...
		var_32_41(var_32_42 .. var_18(var_32_36))
	end
