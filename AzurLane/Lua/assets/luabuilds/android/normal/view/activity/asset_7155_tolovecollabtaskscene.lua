...
function var_0_1.UpdateList(arg_8_0, arg_8_1)
	...
	var_2.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			local var_9_7 = var_8.min(var_9_2, var_9_5)

			setText = var_8

			local var_9_8 = arg_9_2:Find("frame/desc")
			local var_9_9 = var_9_0:getConfig("desc")
			local var_9_10 = " ("

			tostring = var_12

			var_8(var_9_8, var_9_9 .. var_9_10 .. var_12(var_9_7) .. "/" .. var_9_6 .. ")")

			local var_9_11 = arg_9_2:Find("frame/slider")
			local var_9_12 = var_8.GetComponent

			typeof = var_10
			Slider = var_9_10
			var_9_12(var_9_11, var_10(var_9_10)).value = var_9_7 / var_9_5

			local var_9_13 = arg_9_2:Find("frame/awards")
			local var_9_14 = var_9.GetChild(var_9_13, 0)
			local var_9_15 = arg_8_0

			var_11.updateAwards(var_9_15, var_9_0:getConfig("award_display"), var_9, var_9_14)

			local var_9_16 = arg_9_2:Find("frame/go_btn")
			local var_9_17 = arg_9_2:Find("frame/get_btn")
			local var_9_18 = arg_9_2:Find("frame/got_btn")
			local var_9_19 = arg_9_2:Find("frame/bg_go")
			local var_9_20 = arg_9_2:Find("frame/bg_get")
			local var_9_21 = arg_9_2
			local var_9_22 = arg_9_2.Find(var_9_21, "frame/bg_got")

			setActive = var_9_21

			var_9_21(var_9_16, var_9_0:getTaskStatus() == 0)

			setActive = var_9_21

			var_9_21(var_9_19, var_9_0:getTaskStatus() == 0)

			setActive = var_9_21

			var_9_21(var_9_17, var_9_0:getTaskStatus() == 1)

			setActive = var_9_21

			var_9_21(var_9_20, var_9_0:getTaskStatus() == 1)

			setActive = var_9_21

			var_9_21(var_9_18, var_9_0:getTaskStatus() == 2)

			setActive = var_9_21

			var_9_21(var_9_22, var_9_0:getTaskStatus() == 2)

			onButton = var_9_21

			local var_9_23 = arg_8_0
			local var_9_24 = var_9_16

			local function var_9_25()
				local var_10_0 = arg_8_0
				local var_10_1 = var_0.emit

				ToLoveCollabTaskMediator = var_3_10002

				var_10_1(var_10_0, var_3_10002.ON_TASK_GO, var_9_0)
			...
			var_9_21(var_9_23, var_9_24, var_9_25, var_2_10021)
			...
			local function var_9_28()
				...
				var_0.checkAwardOverFlow(var_11_0, {
					...
					ToLoveCollabTaskMediator = var_4_10002

					var_12_1(var_12_0, var_4_10002.ON_TASK_SUBMIT, var_9_0)
			...
			var_9_21(var_9_26, var_9_27, var_9_28, var_2_10021)
		end
	...
	if arg_8_0.canGetAward then
		...
		local function var_8_4()
			...
			var_0.checkAwardOverFlow(var_13_0, arg_8_0.canGetTaskVOs, function()
				...
				var_14_1(var_14_0, var_3_10002.ON_TASK_SUBMIT_ONESTEP, arg_8_0.canGetTaskIds)
...
function var_0_1.checkAwardOverFlow(arg_15_0, arg_15_1, arg_15_2)
	...
	for iter_15_0, iter_15_1 in var_1_10005(arg_15_1) do
		...
		local var_15_3 = iter_15_1.getConfig(var_15_2, "award_display")

		ipairs = var_15_2

		for iter_15_2, iter_15_3 in var_15_2(var_15_3) do
			local var_15_4 = iter_15_3
			local var_15_5 = false

			pairs = var_1_10018

			for iter_15_4, iter_15_5 in var_1_10018(var_15_1) do
				if iter_15_5[1] == var_15_4[1] and iter_15_5[2] == var_15_4[2] then
					var_15_5 = true
					iter_15_5[3] = iter_15_5[3] + var_15_4[3]
	...
	local var_15_6 = var_5(var_6)
	local var_15_7 = var_5.getRawData(var_15_6)

	pg = var_15_6

	local var_15_8 = var_15_6.gameset.urpt_chapter_max.description[1]

	LOCK_UR_SHIP = iter_15_0
	...
	if iter_15_0 then
		...
		getProxy = iter_15_0
		BagProxy = iter_15_1
		iter_15_1 = iter_15_0(iter_15_1)
		iter_15_0 = iter_15_0.GetLimitCntById(iter_15_1, var_15_8)
	end

	Task = iter_15_1

	local var_15_9, var_15_10 = iter_15_1.StaticJudgeOverflow(var_15_7.gold, var_15_7.oil, iter_15_0, true, true, var_15_1)
...
function var_0_1.updateAwards(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	for iter_17_1 = 1, var_17_1 do
		...
		if var_17_3 then
			...
			var_14(var_17_2:Find("mask"), var_17_5)

			local var_17_6 = var_17_5.type

			DROP_TYPE_EQUIPMENT_SKIN = var_15

			if var_17_6 == var_15 then
				setActive = var_17_6

				var_17_6(var_17_2:Find("specialFrame"), true)
			else
				setActive = var_17_6

				var_17_6(var_17_2:Find("specialFrame"), false)
			end
			...
			local function var_17_9()
				...
				var_18_1(var_18_0, var_2_10002.ON_DROP, var_17_5)
			...
			var_17_6(var_17_7, var_17_8, var_17_9, var_1_10018)
		end
	end
...
function var_0_1.UpdateTaskData(arg_19_0)
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10003.TOLOVE_TASK_ID)

	arg_19_0.taskVOs = {}

	if var_19_2 and not var_19_2:isEnd() then
		local var_19_3 = var_19_2
		local var_19_4 = var_19_2.getConfig(var_19_3, "config_data")
		...
		for iter_19_0, iter_19_1 in var_19_3(var_19_4) do
			...
			local var_19_5 = arg_19_0.taskVOs

			getProxy = var_1_10010
			TaskProxy = var_1_10011
			var_1_10011 = var_1_10010(var_1_10011)

			var_1_10008(var_19_5, var_1_10010.getTaskVO(var_1_10011, iter_19_1))
		end
	end
...
function var_0_1.getTaskProgress(arg_20_0, arg_20_1)
	...
	for iter_20_0, iter_20_1 in var_1_10002(var_0_2) do
		if iter_20_1[1] == arg_20_1:getConfig("type") and iter_20_1[2] == arg_20_1:getConfig("sub_type") then
			...
			local var_20_1 = arg_20_1.getProgress(var_20_0) / 1000

			string = var_20_0

			local var_20_2 = var_20_0.format("%.2d", arg_20_1:getProgress() / 1000)
	...
	local var_20_4 = arg_20_1.getProgress(var_20_3)

	tostring = var_20_3

	local var_20_5 = var_20_3(arg_20_1:getProgress())
end
...
function var_0_1.getTaskTarget(arg_21_0, arg_21_1)
	...
	for iter_21_0, iter_21_1 in var_1_10002(var_0_2) do
		if iter_21_1[1] == arg_21_1:getConfig("type") and iter_21_1[2] == arg_21_1:getConfig("sub_type") then
			...
			local var_21_1 = arg_21_1.getConfig(var_21_0, "target_num") / 1000

			string = var_21_0

			local var_21_2 = var_21_0.format("%.2d", arg_21_1:getConfig("target_num") / 1000)
	...
	local var_21_4 = arg_21_1.getConfig(var_21_3, "target_num")

	tostring = var_21_3

	local var_21_5 = var_21_3(arg_21_1:getConfig("target_num"))
end
