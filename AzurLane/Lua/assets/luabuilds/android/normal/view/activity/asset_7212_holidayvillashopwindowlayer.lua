...
function var_0_1.setGoods(arg_2_0, arg_2_1)
	...
	if arg_2_1:getConfig("num_limit") ~= 0 then
		...
		math = var_4
		arg_2_0.max = var_2_0(var_2_1, var_4.max(arg_2_1:GetPurchasableCnt(), 0))
	end
...
function var_0_1.init(arg_3_0)
	...
	local var_3_4 = var_3_2.Find(var_3_3, "cost/Text_cost")
	...
	local function var_3_31()
		...
		HolidayVillaShopWindowMediator = var_2_10002
