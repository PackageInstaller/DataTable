...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_2()
		...
		local var_5_3 = var_5_1(var_2_10003)
		local var_5_4 = var_2.getData(var_5_3)
		local var_5_5 = var_5_2.type

		DROP_TYPE_RESOURCE = var_2_10005

		if var_5_5 == var_2_10005 then
			var_5_5 = var_5_2.id
			PlayerConst = var_2_10005

			if var_5_5 == var_2_10005.ResGold and var_5_4:GoldMax(var_5_2.count) then
				table = var_5_5
				...
				var_5_5.insert(var_5_0, function(arg_6_0)
					...
					local var_6_3 = var_3_10004("gold_max_tip_title")

					i18n = var_5
					var_6_2.content = var_6_3 .. var_5("award_max_warning")
	...
	local function var_4_5()
		...
		if not var_8_0 then
			...
			var_8_6(var_8_5, var_2_10005.BATTLE_OPERA)
		elseif var_8_1 and not var_8_1:isEnd() then
			...
			var_8_8(var_8_7, var_2_10005.BATTLE_OPERA)
		else
			...
			var_8_10(var_8_9, var_2_10005("common_activity_end"))
		end
	...
	for iter_4_0, iter_4_1 in var_1(arg_4_0.skillBtns) do
		...
		local function var_4_11()
			...
			for iter_10_0, iter_10_1 in var_2_10000(var_1.GetCurBuffInfos(var_10_0)) do
		...
		var_1_10006(var_4_9, var_4_10, var_4_11, var_1_10010)
	end

	local var_4_12, var_4_13 = arg_4_0:getRandomName()

	pg = var_3

	local var_4_14 = var_3.UIMgr.GetInstance()

	var_3.LoadingOn(var_4_14)

	PoolMgr = var_3

	local var_4_15 = var_3.GetInstance()

	var_3.GetSpineChar(var_4_15, var_4_12, true, function(arg_11_0)
		pg = var_2_10001
	...
	local var_4_16 = var_3.UIMgr.GetInstance()

	var_3.LoadingOn(var_4_16)

	PoolMgr = var_3

	local var_4_17 = var_3.GetInstance()

	var_3.GetSpineChar(var_4_17, var_4_13, true, function(arg_12_0)
		pg = var_2_10001
...
function var_0_1.OnUpdateFlush(arg_13_0)
	...
	var_1_10008(var_13_9, var_1_10010(var_13_10, var_12) .. var_13_3)
	...
	if 1 <= var_13_8 then
		...
		if not var_10(var_13_12, var_12) then
			var_13_13 = var_13_6 .. "/"
		end
		...
		var_13_20(arg_13_0.battleBtn, var_13_19 and not var_13_15 and var_13_17)

		setActive = var_13_20

		var_13_20(arg_13_0.getBtn, var_13_15)

		setActive = var_13_20

		var_13_20(arg_13_0.getGreyBtn, not var_13_15)

		setActive = var_13_20

		var_13_20(arg_13_0.gotBtn, not var_13_17 and not var_13_21)

		local var_13_22 = arg_13_0.ptData
		local var_13_23 = var_12.GetAward(var_13_22)

		updateDrop = var_13_22

		var_13_22(arg_13_0.awardTF, var_13_23)
		...
		local function var_13_26()
			...
			var_14_1(var_14_0, var_2_10002.ON_DROP, var_13_23)
		...
		var_13_22(var_13_24, var_13_25, var_13_26, var_1_10017)

		ipairs = var_13_22

		local var_13_27 = arg_13_0.ptData

		for iter_13_0, iter_13_1 in var_13_22(var_14.GetCurBuffInfos(var_13_27)) do
			setActive = var_1_10018

			local var_13_28 = arg_13_0.skillBtns[iter_13_1.group]

			var_1_10018(var_19.Find(var_13_28, "lv1"), false)

			setActive = var_1_10018

			local var_13_29 = arg_13_0.skillBtns[iter_13_1.group]

			var_1_10018(var_19.Find(var_13_29, "lv2"), false)

			setActive = var_1_10018

			local var_13_30 = arg_13_0.skillBtns[iter_13_1.group]

			var_1_10018(var_19.Find(var_13_30, "lv3"), false)
			...
			if iter_13_1.next then
				...
				var_1_10018(var_19.Find(var_13_31, "lv" .. iter_13_1.lv), true)
			else
				setActive = var_1_10018

				local var_13_32 = arg_13_0.skillBtns[iter_13_1.group]

				var_1_10018(var_19.Find(var_13_32, "lv3"), true)
			end
			...
			local var_13_34 = var_20.Find(var_13_33, "icon")

			LoadSprite = var_13_33

			var_19(var_13_34, var_13_33(var_1_10018))
		end
		...
		local function var_13_37()
			...
			i18n = var_2_10003
			var_15_2.helps = var_2_10003("practise_idol_help")
		...
		var_13(var_13_35, var_13_36, var_13_37, iter_13_1)
...
function var_0_1.showTrianPanel(arg_16_0)
	...
	var_1_10001(var_16_0, var_3("upgrade_idol_tip"))
	...
	for iter_16_0, iter_16_1 in var_2(arg_16_0.trainSkillBtns) do
		...
		var_1_10007(var_16_3, var_16_4, var_16_5, var_1_10011)
	end
	...
	var_2(var_16_6, var_16_7, var_16_8, iter_16_1)
...
function var_0_1.flushTrainPanel(arg_20_0)
	...
	if var_1.GetCurBuffInfos(var_20_0) then
		...
		for iter_20_0, iter_20_1 in var_20_0(var_1) do
			setActive = var_1_10007

			local var_20_1 = arg_20_0.trainSkillBtns[iter_20_1.group]

			var_1_10007(var_8.Find(var_20_1, "lv1"), false)

			setActive = var_1_10007

			local var_20_2 = arg_20_0.trainSkillBtns[iter_20_1.group]

			var_1_10007(var_8.Find(var_20_2, "lv2"), false)

			setActive = var_1_10007

			local var_20_3 = arg_20_0.trainSkillBtns[iter_20_1.group]

			var_1_10007(var_8.Find(var_20_3, "lv3"), false)
			...
			if iter_20_1.next then
				...
				var_1_10007(var_8.Find(var_20_4, "lv" .. iter_20_1.lv), true)
			else
				setActive = var_1_10007

				local var_20_5 = arg_20_0.trainSkillBtns[iter_20_1.group]

				var_1_10007(var_8.Find(var_20_5, "lv3"), true)
			end
			...
			local var_20_7 = var_9.Find(var_20_6, "icon")

			LoadSprite = var_20_6

			var_8(var_20_7, var_20_6(var_1_10007))

			setText = var_8

			local var_20_8 = arg_20_0.trainSkillBtns[iter_20_1.group]
			local var_20_9 = var_9.Find(var_20_8, "name")

			shortenString = var_20_8
			pg = var_11

			var_8(var_20_9, var_20_8(var_11.benefit_buff_template[iter_20_1.id].name, 7))
		end
	end

	ipairs = var_20_0

	for iter_20_2, iter_20_3 in var_20_0(arg_20_0.trainSkillBtns) do
		if iter_20_2 == arg_20_0.selectIndex then
			setActive = var_7

			var_7(iter_20_3:Find("selected"), true)

			setActive = var_7

			var_7(iter_20_3:Find("name"), true)
		else
			setActive = var_7

			var_7(iter_20_3:Find("selected"), false)

			setActive = var_7

			var_7(iter_20_3:Find("name"), false)
		end
	end
	...
	if arg_20_0.selectIndex then
		...
		var_2(var_20_10, var_20_11 .. var_20_12 .. iter_20_3.benefit_buff_template[arg_20_0.selectBuffId].desc)
		...
		var_2(var_20_13, var_20_14 .. var_20_15 .. var_6.benefit_buff_template[arg_20_0.selectNewBuffId].desc)
	else
		setActive = var_2
...
function var_0_1.showBuffInfoBox(arg_21_0, arg_21_1)
	...
	var_3(var_21_1, var_5.benefit_buff_template[arg_21_1.id].desc)
	...
	var_3(var_21_2, var_5("upgrade_introduce_tip", var_21_0))
	...
	var_4(var_21_4, var_6(var_21_3))

	local var_21_5 = arg_21_1.award

	updateDrop = var_21_4

	var_21_4(arg_21_0.buffAwardTF, var_21_5)
	...
	local function var_21_8()
		...
		var_22_1(var_22_0, var_2_10002.ON_DROP, var_21_5)
	...
	var_21_4(var_21_6, var_21_7, var_21_8, var_1_10009)
	...
	if arg_21_1.next then
		...
		var_5(var_6.Find(var_21_9, "icon_bg/got_mask"), false)
	else
		setText = var_5
		...
		var_5(var_6.Find(var_21_10, "icon_bg/got_mask"), true)
...
function var_0_1.getRandomName(arg_25_0)
	...
	while var_25_1 == var_25_0 or not var_25_1 do
		math = var_1_10003
		var_25_1 = var_1_10003.random(#var_0_2)
	end
...
function var_0_1.showMsgBox(arg_27_0)
	if arg_27_0.selectBuffId then
		...
		var_2(var_27_1, var_1_10004(var_27_0))
		...
		var_3(var_27_3, var_5("practise_idol_tip", var_27_2))
		...
		var_3(var_27_4, var_27_5, var_27_6, var_7)
		...
		var_3(var_27_7, var_27_8, var_27_9, var_7)
		...
		local function var_27_12()
			...
			local var_30_3 = var_2_10002.EVENT_PT_OPERATION
			local var_30_4 = {
				cmd = 3
			}
			local var_30_5 = arg_27_0.ptData

			var_30_4.activity_id = var_4.GetId(var_30_5)

			local var_30_6 = arg_27_0.ptData

			var_30_4.arg1 = var_4.CanTrain(var_30_6)
		...
		var_3(var_27_10, var_27_11, var_27_12, var_7)
	end
...
function var_0_1.showTip(arg_32_0, arg_32_1)
	...
	var_3(var_32_0:Find("Text"), arg_32_1)
	...
	local var_32_4 = var_32_2(var_32_3, var_5(1.8, 0.1, 1), 0.1)
	...
	local var_32_7 = var_32_5(var_32_6, var_5(1.1, 1.1, 1), 0.1)
	...
	local var_32_10 = var_4.New(function()
		...
		local var_33_2 = var_33_0(var_33_1, var_2_10002(0.1, 1.5, 1), 0.1)
		local var_33_3 = var_0.setUseEstimatedTime(var_33_2, true)
		local var_33_4 = var_0.setOnComplete

		System = var_2

		var_33_4(var_33_3, var_2.Action(function()
			...
			local var_34_2 = var_34_0(var_34_1, var_3_10002.zero, 0.1)
