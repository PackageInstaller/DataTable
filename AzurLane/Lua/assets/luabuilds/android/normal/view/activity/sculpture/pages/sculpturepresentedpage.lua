...
function var_0_1.LoadSculpture(arg_7_0, arg_7_1)
	...
	var_4.GetSpineChar(var_7_3, var_7_2, true, function(arg_8_0)
		...
		Vector3 = var_8_0
		var_8_1.localScale = var_8_0.one
		...
		local var_8_5 = var_8_4(var_8_3, var_3(var_4))
...
function var_0_1.RegisterEvent(arg_9_0)
	...
	local function var_9_2()
		...
		SculptureScene = var_2_10002

		var_10_1(var_10_0, var_2_10002.OPEN_GRATITUDE_PAGE, arg_9_0.id)
