...
local var_0_0 = "DOAYearHotSpringScene"
...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.scrollContent = var_2_2(var_2_1, var_3(var_1_10004)).content
	_ = var_1
	...
	local var_2_5 = var_2.range
	local var_2_6 = arg_2_0.scrollRect

	arg_2_0.poolItems = var_2_4(var_2_5(var_3.Find(var_2_6, "Pool").childCount), function(arg_6_0)
	...
	arg_2_0.scrollBGs = var_1.map({
		...
		var_7_3(var_7_2, var_7_4, var_2_10005(var_7_0))
	...
	var_1.ViewUtils.SetSortingOrder(arg_2_0._tf, 4)
	...
	local var_2_9 = var_2.ShaderMgr.GetInstance()

	arg_2_0.washMaterial = var_2_8(var_2.GetShader(var_2_9, "M02/Unlit_Colored_Semitransparent"))
	...
	var_1_10003.Foreach(var_8_0:GetShipIds(), function(arg_9_0, arg_9_1)
		if arg_9_1 > 0 then
			...
			if var_9_1 == 0 then
				...
				Clone = var_2_10004
				var_9_2[arg_9_0] = var_2_10004(arg_8_0.slotOriginalPos[arg_9_0])
			end
		end
...
function var_0_1.didEnter(arg_10_0)
	...
	local var_10_2 = var_3.Find(var_10_1, "Top/Back")
	...
	var_1_10001(var_10_0, var_10_2, var_10_3, var_5)

	onButton = var_1_10001

	local var_10_4 = arg_10_0
	local var_10_5 = arg_10_0._tf
	local var_10_6 = var_3.Find(var_10_5, "Top/Help")
	...
	local function var_10_7()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip.hotspring_help.tip
	...
	var_1_10001(var_10_4, var_10_6, var_10_7, var_5)

	onButton = var_1_10001

	local var_10_8 = arg_10_0
	local var_10_9 = arg_10_0._tf
	local var_10_10 = var_3.Find(var_10_9, "Top/Manage")

	local function var_10_11()
		local var_13_0 = arg_10_0
		local var_13_1 = var_0.emit

		DOAYearHotSpringMediator = var_2_10002

		var_13_1(var_13_0, var_2_10002.OPEN_INFO)
	...
	var_1_10001(var_10_8, var_10_10, var_10_11, var_5)
	...
	local var_10_16 = var_4.Find(var_10_15, "Top/Buff")
	...
	var_2(var_10_14, var_10_16, var_10_17, var_6)

	onScroll = var_2

	var_2(arg_10_0, arg_10_0.scrollRect, function(arg_15_0)
		_ = var_2_10001
		...
		var_2_10001.each(arg_10_0.scrollBGs, function(arg_16_0)
			...
			var_16_1(var_16_0, var_16_2, var_3_10004(arg_16_0))
	...
	arg_10_0.timer = var_2.New(function()
		...
		local var_17_1 = var_2_10001.range
		local var_17_2 = arg_10_0.scrollRect
		local var_17_3 = var_17_0(var_17_1(var_2.Find(var_17_2, "Pool").childCount), function(arg_18_0)
		...
		var_1(var_17_3, function(arg_19_0, arg_19_1)
			return arg_19_0.anchoredPosition.y >= arg_19_1.anchoredPosition.y
		end)

		table = var_1

		var_1.Foreach(var_17_3, function(arg_20_0, arg_20_1)
	...
	var_2(function()
		...
		if var_0.GetSlotCount(var_21_0) + 1 <= #arg_10_0.slotTFs then
			...
			var_7(arg_10_0.scrollContent, {
				x = var_21_5
			})

			_ = var_7

			var_7.each(arg_10_0.scrollBGs, function(arg_22_0)
				...
				var_22_1(var_22_0, var_22_2, var_3_10004(arg_22_0))
...
function var_0_1.InitSlots(arg_24_0)
	...
	var_1.Foreach(arg_24_0.slotTFs, function(arg_25_0, arg_25_1)
		...
		local var_25_1 = arg_25_1:Find("Usable")

		local function var_25_2()
			local var_26_0 = arg_24_0
			local var_26_1 = var_0.emit

			DOAYearHotSpringMediator = var_3_10002

			var_26_1(var_26_0, var_3_10002.UNLOCK_SLOT, arg_24_0.activity.id)
		...
		var_2_10002(var_25_0, var_25_1, var_25_2, var_6)
		...
		local function var_25_3()
			...
			if 0 < var_27_1 then
				...
				local var_27_2 = var_1(var_3_10002)
			...
			DOAYearHotSpringMediator = var_3_10004

			var_27_5(var_27_4, var_3_10004.OPEN_CHUANWU, arg_25_0, var_27_3)
		...
		local var_25_5 = arg_25_1:Find("Enter")
		local var_25_6 = var_25_3

		SFX_PANEL = var_7

		var_25_0(var_25_4, var_25_5, var_25_6, var_7)

		onButton = var_25_0

		local var_25_7 = arg_24_0
		local var_25_8 = arg_25_1:Find("Ship/Click")
		...
		var_25_0(var_25_7, var_25_8, var_25_9, var_7)

		pg = var_25_0

		local var_25_10 = var_25_0.UIMgr.GetInstance().uiCamera
		local var_25_11 = var_3.GetComponent

		typeof = var_25_8
		Camera = var_25_9

		local var_25_12 = var_25_11(var_25_10, var_25_8(var_25_9))
		local var_25_13 = arg_24_0.scrollRect
		local var_25_14 = var_4.Find(var_25_13, "Pool")

		GetComponent = var_25_13

		local var_25_15 = var_25_13(arg_25_1:Find("Ship/Click"), "EventTriggerListener")

		var_5.AddBeginDragFunc(var_25_15, function()
			if arg_24_0._modelDrag then
				return
			end
			...
			var_1(var_2.Find(var_29_2, "wenquan_bowen"), false)
		...
		var_5:AddDragFunc(function(arg_30_0, arg_30_1)
			...
			local var_30_0 = var_2.ScreenToLocal(arg_24_0._tf, arg_30_1.position, var_25_12)
		...
		var_5:AddDragEndFunc(function(arg_31_0, arg_31_1)
			...
			local var_31_3 = var_25_14.rect.center
			...
			var_7(var_8.Find(var_31_8, "wenquan_bowen"), true)
			...
			SFX_UI_HOME_PUT = var_9

			var_31_10(var_31_9, var_9)
...
function var_0_1.UpdateView(arg_33_0)
	...
	local var_33_1 = var_2.Find(var_33_0, "Ticket/Text")
	local var_33_2 = arg_33_0.activity

	var_1(var_33_1, var_3.GetCoins(var_33_2))
...
function var_0_1.UpdateSlot(arg_37_0, arg_37_1, arg_37_2)
	...
	local var_37_2 = var_37_0(arg_37_1 - var_4.GetSlotCount(var_37_1), 0, 2)

	setActive = var_4

	var_4(arg_37_2:Find("Lock"), var_37_2 == 2)

	setActive = var_4

	var_4(arg_37_2:Find("Usable"), var_37_2 == 1)

	local var_37_3 = arg_37_0.activity
	local var_37_4

	if not var_4.GetShipIds(var_37_3)[arg_37_1] then
		var_37_4 = 0
	end

	local var_37_5 = var_37_2 == 0
	local var_37_7
	...
	if 0 < var_37_4 then
		...
		local var_37_6 = var_6(var_7)

		var_37_7 = var_6.RawGetShipById(var_37_6, var_37_4)
	else
		var_37_7 = false
	end
	...
	var_37_8(arg_37_2:Find("Enter"), var_37_5 and not var_37_7)

	setActive = var_37_8

	var_37_8(var_37_9, var_37_5 and var_37_7 and true)
	...
	var_9(arg_37_2, var_37_11)

	if var_37_7 then
		SpineRole = var_9

		local var_37_12 = var_9.New()
		...
		var_9:Load(function()
			...
			var_38_1(var_38_0, var_2.Find(var_38_2, "Model"))
...
function var_0_1.SetSpineWash(arg_39_0, arg_39_1)
	...
	var_39_1(var_39_0, var_4.Instantiate(arg_39_0.washMaterial))
...
function var_0_1.GetRecordPos(arg_43_0)
	...
	local var_43_1 = var_2.map

	string = var_3

	local var_43_2 = var_43_1(var_3.split(var_43_0, ";"), function(arg_44_0)
	...
	for iter_43_0 = 1, #var_43_2, 2 do
		...
		var_1_10008(var_43_4, var_1_10010.New(var_43_2[iter_43_0], var_43_2[iter_43_0 + 1]))
	end
...
function var_0_1.RecordPos(arg_45_0, arg_45_1)
	...
	local var_45_1 = var_45_0(var_1_10003.reduce(arg_45_1, {}, function(arg_46_0, arg_46_1)
		table = var_2_10002
	...
	var_3.SetString("hotspring_ship_pos", var_45_1)
