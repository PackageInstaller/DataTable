...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BuildingUpgradeLayer"))
local var_0_2 = {
	17,
	18
}
...
function var_0_1.Set(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_10016(var_17.Find(var_1_12, "window/top/name"), var_1_0.name)

	setText = var_1_10016

	local var_1_13 = arg_1_0._tf

	var_1_10016(var_17.Find(var_1_13, "window/top/name/lv"), "Lv." .. var_1_2)

	setScrollText = var_1_10016

	local var_1_14 = arg_1_0._tf

	var_1_10016(var_17.Find(var_1_14, "window/frame/describe/text"), var_1_0.desc)

	setText = var_1_10016

	local var_1_15 = arg_1_0._tf

	var_1_10016(var_17.Find(var_1_15, "window/frame/content/title/lv/current"), "Lv." .. var_1_2)

	setActive = var_1_10016

	local var_1_16 = arg_1_0._tf

	var_1_10016(var_17.Find(var_1_16, "window/frame/content/title/lv/next"), not var_9)

	local var_1_17

	if not var_9 then
		setText = var_1_10016
		var_1_17 = arg_1_0._tf

		var_1_10016(var_17.Find(var_1_17, "window/frame/content/title/lv/next"), "Lv." .. var_1_2 + 1)
	end
	...
	local var_1_19 = var_17.benefit_buff_template[var_1_18]

	assert = var_1_17

	var_1_17(var_1_19, "Can't Find benefit_buff_template Config ID: " .. var_1_18)

	setText = var_1_17

	local var_1_20 = arg_1_0._tf

	var_1_17(var_19.Find(var_1_20, "window/frame/content/preview/current"), var_1_19.desc)

	setActive = var_1_17

	local var_1_21 = arg_1_0._tf

	var_1_17(var_19.Find(var_1_21, "window/frame/content/preview/arrow"), not var_9)

	setActive = var_1_17

	local var_1_22 = arg_1_0._tf

	var_1_17(var_19.Find(var_1_22, "window/frame/content/preview/next"), not var_9)
	...
	if not var_9 then
		...
		var_19(var_20.Find(var_1_25, "window/frame/content/preview/next"), var_1_24.desc)
	end
	...
	local var_1_28 = var_20.getConfigData(var_1_4).icon
	local var_1_29 = ""
	local var_1_30 = arg_1_0._tf

	var_1_27(var_1_26, var_1_28, var_1_29, var_22.Find(var_1_30, "window/frame/costback/icon"))

	setText = var_1_27

	local var_1_31 = arg_1_0._tf
	local var_1_32 = var_19.Find(var_1_31, "window/frame/costback/cost")
	local var_1_33
	...
	var_1_27(arg_1_0, arg_1_0.btnUpgrade, function()
		...
		if not var_1_10 then
			...
			var_2_2(var_2_1, var_2_10003("backhill_cantupbuilding", var_2_0))
		...
		i18n = var_2_10003
		var_2_5.content = var_2_10003("building_upgrade_tip")
		...
		function var_2_5.onYes()
			...
			elseif var_1_6 then
				...
				var_3_1(var_3_0, var_3_10002.ACTIVITY_OPERATION, {
					cmd = 1,
				...
				if var_1_11 < 8 then
					...
					var_3_3(var_3_2, var_3_10002("backhill_notenoughbuilding"))
				else
					pg = var_3_3
					...
					var_3_5(var_3_4, var_3_10002("building_tip"))
				end
			end
