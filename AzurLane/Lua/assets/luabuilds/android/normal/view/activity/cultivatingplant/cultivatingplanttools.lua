local var_0_0 = {
	GetTaskIDList = function()
		...
		for iter_1_0, iter_1_1 in var_1_10001(var_1_10002.task_data_template.get_id_list_by_sub_type[1070]) do
			table = var_1_10006
			var_1_10006 = var_1_10006.keyof
			pg = var_1_10007

			if var_1_10006(var_1_10007.task_data_template.get_id_list_by_type[6], iter_1_1) then
				table = var_1_10006
		...
		for iter_1_2, iter_1_3 in var_1(var_2.task_data_template.get_id_list_by_sub_type[1071]) do
			table = var_1_10006
			var_1_10006 = var_1_10006.keyof
			pg = var_1_10007

			if var_1_10006(var_1_10007.task_data_template.get_id_list_by_type[6], iter_1_3) then
				table = var_1_10006
...
function var_0_0.IsPopActivity(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10003(var_4_0) do
		...
		if var_4_1.getTaskVO(var_4_2, iter_4_1) then
			tonumber = var_4_2

			if var_4_2(var_8:getConfig("target_id")) == arg_4_0 then
				local var_4_3 = var_8:isReceive()

				if var_8:isFinish() and not var_4_3 then
					return true
				end
			end
		end
