...
function var_0_1.init(arg_1_0)
	...
	import = var_2
	arg_1_0.graphPath = var_1_6(var_2("GameCfg.BackHillGraphs.AmusementParkGraph2"))
	...
	PLATFORM_CODE = var_1
	PLATFORM_JP = var_1_15

	if var_1 ~= var_1_15 then
		setActive = var_1
		...
		local var_1_17 = arg_1_0.map_jinianchengbao

		typeof = var_3
		Button = iter_1_1
		var_1(var_1_17, var_3(iter_1_1)).enabled = false
	end
...
function var_0_1.didEnter(arg_7_0)
	...
	var_1_10001(var_7_4, var_3.Find(var_7_5, "Help"), function()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.activity_event_building.tip
	...
	var_1_10001(var_7_6, var_3.Find(var_7_7, "Invitation"), function()
		...
		if var_11_1(var_11_0, var_2_10002.JP_CEREMONY_INVITATION_ID) and not var_0:isEnd() then
	...
	arg_7_0:InitFacilityCross(arg_7_0._map, arg_7_0._upper, "jiujiudalaotuan", function()
		...
		var_13_1(var_13_0, var_2_10002.GO_MINI_GAME, 30)
