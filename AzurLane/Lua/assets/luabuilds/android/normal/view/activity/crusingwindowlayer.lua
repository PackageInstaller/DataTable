...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	GetSpriteFromAtlasAsync = var_2_0

	local var_2_3 = "crusingwindow/map_20"

	pg = var_1_10005

	var_2_0(var_2_3 .. var_1_10005.battlepass_event_pt[var_2_2.id].map_name, "", function(arg_3_0)
...
function var_0_1.init(arg_4_0)
	...
	var_1_10001(var_2.Find(var_4_0, "panel"), arg_4_0.windowSprite, true)
	...
	local var_4_7 = var_4_6(var_4_5, var_3.ACTIVITY_TYPE_PT_CRUSING)

	pg = var_4_5

	local var_4_8

	if not var_4_5.battlepass_event_pt[var_4_7.id].equip_skin then
		var_4_8 = {}
	end
	...
	arg_4_0.itemList = var_4_9(var_4_10, var_5.GetChild(var_4_11, 0))
	...
	var_3.make(var_4_12, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_5_1(var_5_4, var_5_5, var_5_6, var_2_10008)
		end
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_9()
		...
		var_10_1(var_10_0, var_2_10002.GO_CRUSING)
