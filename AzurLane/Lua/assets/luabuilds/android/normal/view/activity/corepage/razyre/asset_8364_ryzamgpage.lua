...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	arg_2_0.awardsRect = var_1(var_2_0, var_3(var_1_10004))
	findTF = var_1
	...
	for iter_2_0 = 1, #arg_2_0.drops do
		...
		local var_2_2 = var_8(var_1_10005, "ad/IconTpl")

		updateDrop = var_9

		var_9(var_2_2, var_2_1)

		onButton = var_9

		local var_2_3 = arg_2_0
		local var_2_4 = var_1_10005
		...
		local function var_2_5()
			...
			var_3_1(var_3_0, var_2_10002.ON_DROP, var_2_1)
		...
		var_9(var_2_3, var_2_4, var_2_5, var_1_10013)
		...
		var_9("ui/ryzamgpage_atlas", "day_" .. iter_2_0, function(arg_4_0)
			...
			var_2_10001(var_2_10002(var_1_10005, "ad/complete"), arg_4_0, true)
		...
		var_9("ui/ryzamgpage_atlas", "day_c_" .. iter_2_0, function(arg_5_0)
			...
			var_2_10001(var_2_10002(var_1_10005, "ad/open"), arg_5_0, true)
		...
		var_9(var_10(var_1_10005, "ad/open"), iter_2_0 > arg_2_0.useTimes)

		setActive = var_9
		findTF = var_10

		var_9(var_10(var_1_10005, "ad/complete"), iter_2_0 <= arg_2_0.useTimes)
	...
	local function var_2_8()
		...
		var_6_1(var_6_0, var_2_10002.GO_MINI_GAME, var_0_2)
	...
	local var_2_10 = arg_2_0.btnRule
	...
	local function var_2_11()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.ryza_mini_game.tip
	...
	local var_2_13 = arg_2_0.moveRight
	...
	local var_2_16 = arg_2_0.moveLeft
	...
	local var_2_18 = arg_2_0.totalTimes - 4 < 0 and 0 or arg_2_0.totalTimes - 4

	scrollTo = var_2

	var_2(arg_2_0.awardsRect, 1 - var_2_18 / (arg_2_0.totalTimes - 4), 0)
