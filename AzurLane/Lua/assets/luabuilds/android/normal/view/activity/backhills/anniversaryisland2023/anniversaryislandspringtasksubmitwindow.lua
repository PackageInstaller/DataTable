...
function var_0_1.init(arg_2_0)
	...
	local var_2_1 = var_2.Find(var_2_0, "Content/Tips")

	i18n = var_2_0

	var_1_10001(var_2_1, var_2_0("sub_item_warning"))
...
function var_0_1.didEnter(arg_3_0)
	...
	var_1_10001(var_3_0, var_3.Find(var_3_1, "BG"), function()
	...
	local var_3_4 = var_3.Find(var_3_3, "Content/Cancel")
	...
	local var_3_8 = var_3.Find(var_3_7, "Content/Submit")
	...
	local function var_3_9()
		...
		var_6_1(var_6_0, var_2_10002.SUBMIT_TASK)
	...
	tonumber = var_3_9
	var_3_12.type = var_3_9(var_3_10:getConfig("target_id"))
	tonumber = var_4
	...
	local var_3_15 = var_4.Find(var_3_14, "Content/Icons")
	local var_3_16 = arg_3_0._tf
	local var_3_17 = var_5.Find(var_3_16, "Content/Icons")

	var_3_13(var_3_15, var_5.GetChild(var_3_17, 0), #var_3_11, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_4(arg_3_0, arg_7_2, function()
			...
			if var_8_0 == var_3_10001 then
				...
				var_8_2(var_8_1, var_3_10002, var_3_10003.New({
					configId = var_7_0.id,
					count = var_7_0.count
				}))
			else
				...
				var_8_4(var_8_3, var_3_10002.ON_DROP, var_7_0)
			end
