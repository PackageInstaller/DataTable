...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.actid = var_2_1(var_2_0, var_1_10003.LiquorFloor_ACT_ID)
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_2.Find(var_3_1, "bg/title_bg/title")

	i18n = var_3_1

	var_1(var_3_2, var_3_1("LiquorFloor_story_title_4"))

	onButton = var_1

	local var_3_3 = arg_3_0
	local var_3_4 = arg_3_0._tf
	local var_3_5 = var_3.Find(var_3_4, "ad/close")
	...
	local var_3_9 = var_3.Find(var_3_8, "ad/buttom")
	...
	var_1(var_3_7, var_3_9, var_3_10, var_5)
	...
	local var_3_24 = var_4.Find(var_3_23, "btnGet")

	local function var_3_25()
		local var_7_0 = arg_3_0
		local var_7_1 = var_0.emit

		LiquorFloorBookMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.ON_GET_TASK, arg_3_0.taskIds[arg_3_0.selectTagIndex])
	...
	var_2(var_3_22, var_3_24, var_3_25, var_6)
	arg_3_0:selectTag(1)
	...
	local var_3_28 = var_3.Find(var_3_27, "tag/1/off/text")

	i18n = var_3_27

	var_2(var_3_28, var_3_27("LiquorFloor_story_title_1"))

	setText = var_2

	local var_3_29 = arg_3_0._ad
	local var_3_30 = var_3.Find(var_3_29, "tag/1/on/text")

	i18n = var_3_29

	var_2(var_3_30, var_3_29("LiquorFloor_story_title_1"))

	setText = var_2

	local var_3_31 = arg_3_0._ad
	local var_3_32 = var_3.Find(var_3_31, "tag/2/off/text")

	i18n = var_3_31

	var_2(var_3_32, var_3_31("LiquorFloor_story_title_2"))

	setText = var_2

	local var_3_33 = arg_3_0._ad
	local var_3_34 = var_3.Find(var_3_33, "tag/2/on/text")

	i18n = var_3_33

	var_2(var_3_34, var_3_33("LiquorFloor_story_title_2"))

	setText = var_2

	local var_3_35 = arg_3_0._ad
	local var_3_36 = var_3.Find(var_3_35, "tag/3/off/text")

	i18n = var_3_35

	var_2(var_3_36, var_3_35("LiquorFloor_story_title_3"))

	setText = var_2

	local var_3_37 = arg_3_0._ad
	local var_3_38 = var_3.Find(var_3_37, "tag/3/on/text")

	i18n = var_3_37

	var_2(var_3_38, var_3_37("LiquorFloor_story_title_3"))
...
function var_0_1.updateTag(arg_9_0)
	for iter_9_0 = 1, #arg_9_0.taskIds do
		...
		if var_1_10006.getTaskById(var_1_10007, var_9_0) and var_1_10006:getTaskStatus() == 1 then
			setActive = var_1_10007

			local var_9_1 = arg_9_0._ad

			var_1_10007(var_8.Find(var_9_1, "tag/" .. iter_9_0 .. "/tip"), true)
		else
			setActive = var_1_10007

			local var_9_2 = arg_9_0._ad

			var_1_10007(var_8.Find(var_9_2, "tag/" .. iter_9_0 .. "/tip"), false)
		end
	end
...
function var_0_1.updatePage2(arg_11_0, arg_11_1, arg_11_2)
	if not arg_11_0.page2Items then
		...
		for iter_11_0 = 1, #arg_11_2 do
			...
			var_11_6, setImageSprite = var_11_4.Find(var_11_5, "bg/icon"), var_11_5
			LoadSprite = var_1_10014

			var_11_5(var_11_6, var_1_10014("ui/LiquorFloorUI_atlas", var_11_3.icon), true)

			local var_11_7 = var_11_4
			local var_11_8 = var_11_4.Find(var_11_7, "bg/GameObject/name")

			setScrollText = var_11_7

			var_11_7(var_11_8, var_11_3.name)

			var_1_10014 = var_11_4

			local var_11_9 = var_11_4.Find(var_1_10014, "bg/lock/name")

			setText = var_1_10014

			var_1_10014(var_11_9, "???????")

			local var_11_10 = var_11_4

			var_1_10014 = var_11_4.Find(var_11_10, "bg/lock/Text")
			setText = var_11_10

			var_11_10(var_1_10014, var_11_3.unlock_desc)

			table = var_11_10

			var_11_10.insert(arg_11_0.page2Items, {
				tf = var_11_4,
				index = iter_11_0
			})
		end
	...
	for iter_11_1 = 1, #arg_11_0.page2Items do
		local var_11_11 = arg_11_0.page2Items[iter_11_1].tf
		local var_11_12 = arg_11_0:getCollectDataBySiteId(arg_11_2[iter_11_1]).unlock[2]
		local var_11_13 = arg_11_0.Placeac[var_8.unlock[1]]
		local var_11_14 = var_11_12 <= var_10.GetLevel(var_11_13)
		local var_11_15 = var_11_11
		local var_11_16 = var_11_11.Find(var_11_15, "bg/icon")

		setActive = var_11_15

		var_11_15(var_11_16, var_11_14)

		local var_11_17 = var_11_11
		local var_11_18 = var_11_11.Find(var_11_17, "bg/lock")

		setActive = var_11_17

		var_11_17(var_11_18, not var_11_14)

		local var_11_19 = var_11_11:Find("bg/GameObject/name")
		local var_11_20 = var_11_11
		local var_11_21 = var_11_11.Find(var_11_20, "bg/lock")

		setActive = var_11_20

		var_11_20(var_11_19, var_11_14)

		setActive = var_11_20

		var_11_20(var_11_21, not var_11_14)
	end
...
function var_0_1.updatePage1(arg_12_0, arg_12_1, arg_12_2)
	if not arg_12_0.page1Items then
		...
		local var_12_2 = arg_12_1.Find(var_12_1, "list/content")

		setActive = var_12_1

		var_12_1(var_12_0, false)
		...
		for iter_12_0 = 1, #arg_12_2 do
			...
			local var_12_5 = var_12_3(var_11(var_12_0))

			setParent = var_11

			var_11(var_12_5, var_12_2)

			setActive = var_11

			var_11(var_12_5, true)

			local var_12_6 = var_12_5
			local var_12_7 = var_12_5.Find(var_12_6, "icon")

			LoadImageSpriteAsync = var_12_6

			var_12_6("bg/" .. var_12_4.icon, var_12_7)

			local var_12_8 = var_12_5
			local var_12_9 = var_12_5.Find(var_12_8, "desc_bg/desc")

			SetActive = var_12_8

			local var_12_10 = var_12_5
			local var_12_11 = var_12_5.Find(var_12_10, "desc_bg")

			memoryData = var_12_10

			var_12_8(var_12_11, var_12_10)

			if var_12_4.name then
				setText = var_13

				var_13(var_12_9, var_12_4.name)
			end
	...
	for iter_12_1 = 1, #arg_12_0.page1Items do
		local var_12_12 = arg_12_0.page1Items[iter_12_1].tf
		local var_12_13 = arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock[2]
		local var_12_14 = arg_12_0.actid
		local var_12_15 = var_12_13 <= var_9.GetTownLevel(var_12_14)
		local var_12_16 = arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock[2]
		local var_12_17 = var_12_12:Find("lock")
		local var_12_18 = var_12_12:Find("bg2")
		local var_12_19 = var_12_12:Find("desc_bg")
		local var_12_20 = var_12_12:Find("icon")
		local var_12_21 = var_12_12
		local var_12_22 = var_12_12.Find(var_12_21, "lock/Text")

		setText = var_12_21

		var_12_21(var_12_22, arg_12_0:getCollectDataBySiteId(arg_12_2[iter_12_1]).unlock_desc)

		setActive = var_12_21

		var_12_21(var_12_20, var_12_15)

		setActive = var_12_21

		var_12_21(var_12_19, var_12_15)

		setActive = var_12_21

		var_12_21(var_12_17, not var_12_15)

		setActive = var_12_21

		var_12_21(var_12_18, not var_12_15)
	end
...
function var_0_1.updatePage3(arg_13_0, arg_13_1, arg_13_2)
	if not arg_13_0.page3Items then
		...
		local var_13_1 = var_4(arg_13_1, "list/content")
		...
		for iter_13_0 = 1, #arg_13_2 do
			...
			local var_13_4 = var_13_2(var_11(var_13_0))

			setParent = var_11

			var_11(var_13_4, var_13_1)

			setActive = var_11

			var_11(var_13_4, true)

			local var_13_5 = var_13_4
			local var_13_6 = var_13_4.Find(var_13_5, "ad/mask/icon")

			tonumber = var_13_5

			local var_13_7 = var_13_5(var_13_3.icon)

			pg = var_13

			local var_13_8 = var_13.ship_skin_template[var_13_7]
			local var_13_9 = ""

			if var_13_8 then
				HXSet = var_1_10015
				var_13_9 = var_1_10015.hxLan(var_13_3.name)
				var_1_10015 = var_13_8.painting

				local var_13_10 = var_0_1.StaticGetPaintingName(var_1_10015)

				LoadPaintingPrefabAsync = var_17

				var_17(var_13_6, var_1_10015, var_13_10, "biandui", function()
					return
				end)
			else
				print = var_1_10015

				var_1_10015("skin_id no exist" .. var_13_7)
			end

			onButton = var_1_10015

			local var_13_11 = arg_13_0
			local var_13_12 = var_13_4
			...
			local function var_13_13()
				...
				if var_0.getSiteOpen(var_15_0, var_13_3.site_id) then
					...
					local var_15_1 = var_15_0.NewStoryMgr.GetInstance()
			...
			var_1_10015(var_13_11, var_13_12, var_13_13, var_1_10019)

			var_1_10015 = var_13_4:Find("ad")

			local var_13_14 = var_13_4
			local var_13_15 = var_13_4.Find(var_13_14, "ad/name_bg/name")

			setText = var_13_14

			var_13_14(var_13_15, var_13_9)

			local var_13_16 = var_13_4:Find("ad/lock")

			var_1_10019 = var_13_4

			local var_13_17 = var_13_4.Find(var_1_10019, "ad/lock/Text")

			setText = var_1_10019

			var_1_10019(var_13_17, var_13_3.unlock_desc)

			table = var_1_10019

			var_1_10019.insert(arg_13_0.page3Items, {
				tf = var_13_4,
				index = iter_13_0
			})
		end
	...
	for iter_13_1 = 1, #arg_13_0.page3Items do
		...
		local var_13_24 = var_13_18:Find("ad/name_bg")
		local var_13_25 = var_13_18
		local var_13_26 = var_13_18.Find(var_13_25, "ad/lock")

		setActive = var_13_25

		var_13_25(var_13_23, var_13_22)

		setActive = var_13_25

		var_13_25(var_13_24, var_13_22)

		setActive = var_13_25

		var_13_25(var_13_26, not var_13_22)
	end
...
function var_0_1.getCollectDataBySiteId(arg_18_0, arg_18_1)
	...
	for iter_18_0, iter_18_1 in var_1_10002(var_1_10003.activity_town_collection_2.all) do
		pg = var_1_10007
...
function var_0_1.StaticGetPaintingName(arg_19_0)
	...
	if var_2.GetMainPaintingVariantFlag(var_19_1, arg_19_0) == var_0_1.PAINTING_VARIANT_EX then
		...
		if not var_4("painting/" .. var_19_0 .. "_ex") then
			return var_19_0
		end
	end
...
function var_0_1.updateAwardPanel(arg_20_0)
	...
	local var_20_1 = var_2(var_1_10003)
	...
	var_6(var_20_7, var_20_8, var_20_9, var_1_10010)
	...
	local var_20_16 = var_13(var_20_13, "text")

	i18n = var_14

	var_12(var_20_16, var_14("LiquorFloor_story_get"))
	...
	var_12(var_20_17, var_14("LiquorFloor_story_got"))
	...
	var_12(var_20_18, var_14("LiquorFloor_story_go"))
	...
	var_12(var_20_19, var_20_20, var_20_21, var_1_10016)
