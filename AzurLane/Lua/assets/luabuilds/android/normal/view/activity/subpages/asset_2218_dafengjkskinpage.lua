...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_3()
		if arg_3_0.submitVO then
			...
			var_6_1(var_6_0, var_2_10002.ON_TASK_SUBMIT, arg_3_0.submitVO)
		end
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10003(arg_7_0.taskList) do
		...
		if not var_8.getTaskById(var_7_2, iter_7_1) then
			var_7_2 = arg_7_0.taskProxy
			var_7_3 = var_8.getFinishTaskById(var_7_2, iter_7_1)
		end

		assert = var_7_2

		var_7_2(var_7_3, "without this task by id: " .. iter_7_1)

		if var_7_3:getTaskStatus() == 1 then
			var_7_0 = var_7_0 + 1

			if not arg_7_0.submitVO then
				arg_7_0.submitVO = var_7_3
			end
		end

		if var_7_3:getTaskStatus() == 2 then
			var_7_1 = var_7_1 + 1
		end
	end
	...
	var_3(arg_7_0.phaseTF, function(arg_8_0)
		...
		var_2_10001(var_8_0, var_2_10003(arg_8_0.name) <= var_7_0 + var_7_1)

		return
	end)

	local var_7_4 = arg_7_0.itemList

	var_3.align(var_7_4, #arg_7_0.taskList)
