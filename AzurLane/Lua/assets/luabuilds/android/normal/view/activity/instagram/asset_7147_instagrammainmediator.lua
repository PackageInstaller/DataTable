...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_CHAT, function(arg_2_0)
		...
		InstagramChatLayer = var_2_10005
		var_2_3.viewComponent = var_2_10005
		InstagramChatMediator = var_2_10005
		var_2_3.mediator = var_2_10005

		local var_2_4 = {}
		local var_2_5 = arg_1_0.viewComponent

		var_2_4.groupName = var_6.getGroupName(var_2_5)
	...
	arg_1_0:bind(var_0_1.OPEN_JUUS, function(arg_3_0)
		...
		var_3_4.groupName = var_6.getGroupName(var_3_5)
	...
	arg_1_0:bind(var_0_1.CLOSE_CHAT, function(arg_4_0)
		...
		InstagramChatMediator = var_2_10003

		var_4_1(var_4_0, var_2_10003)
	...
	arg_1_0:bind(var_0_1.CLOSE_JUUS_DETAIL, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10003.CLOSE_DETAIL)
	...
	arg_1_0:bind(var_0_1.JUUS_BACK_PRESSED, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10003.BACK_PRESSED)
	...
	arg_1_0:bind(var_0_1.INS_BACK_PRESSED, function(arg_8_0)
		...
		var_8_1(var_8_0, var_2_10003.BACK_PRESSED)
