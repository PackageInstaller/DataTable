...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2_1(var_2_6, var_2_5("dreamland_label_day"))
	...
	var_2_1(var_2_8, var_2_7("dreamland_label_dusk"))

	setText = var_2_1

	local var_2_9 = arg_2_0.times[3]
	local var_2_10 = var_2.Find(var_2_9, "title")

	i18n = var_2_9

	var_2_1(var_2_10, var_2_9("dreamland_label_night"))
...
function var_0_1.OnInit(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(arg_3_0.times) do
		...
		var_1_10006(var_3_0, var_3_1, var_3_2, var_1_10010)
	end
	...
	local function var_3_5()
		...
		DreamlandScene = var_2_10002

		var_5_1(var_5_0, var_2_10002.EVENT_SWITCH_TIME, arg_3_0.selected)
	...
	var_1(var_3_3, var_3_4, var_3_5, iter_3_1)
	...
	var_1(var_3_6, var_3_7, var_3_8, iter_3_1)
...
function var_0_1.UpdateToggleStyle(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_2 = var_9_1(var_9_0, var_5(var_1_10006))
	...
	local var_9_8 = var_9_7(var_9_6, var_7(var_1_10008))

	Color = var_9_6

	local var_9_9 = var_9_6.New(1, 1, 1, 1)

	Color = var_7

	local var_9_10 = var_7.New(0.4235294, 0.4313726, 0.5137255, 1)
