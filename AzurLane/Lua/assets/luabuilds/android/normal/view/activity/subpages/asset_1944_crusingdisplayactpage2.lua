...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_4, var_1_3("cruise_tip_skin"))
	...
	var_1(var_1_10, var_1_9("cruise_btn_pay"))
	...
	local function var_1_13()
		...
		var_3_4.warp = var_2_10005.TYPE_PICK
	...
	local var_1_17 = var_3.Find(var_1_16, "Text")

	i18n = var_1_16

	var_2(var_1_17, var_1_16("cruise_tip_base"))
	...
	local function var_1_20(arg_4_0)
		...
		var_2_10001(var_2.Find(var_4_0, "Text"), arg_4_0 and 1 or 0.3)
		...
		LeanTween = var_2
		var_4_1.LTBase = var_2.alpha(arg_1_0.bgBase, arg_4_0 and 1 or 0, 0.5).uniqueId
	...
	var_2(var_1_22, var_1_21("cruise_tip_upgrade"))
	...
	local function var_1_25(arg_5_0)
		...
		var_2_10001(var_2.Find(var_5_0, "Text"), arg_5_0 and 1 or 0.3)
		...
		LeanTween = var_2
		var_5_1.LTPay = var_2.alpha(arg_1_0.bgPay, arg_5_0 and 1 or 0, 0.5).uniqueId
	...
	var_2(var_1_23, var_1_24, var_1_25, var_1_10006)
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	var_1_10001(var_2.Find(var_7_0, "before"), not arg_7_0.isPay)

	setActive = var_1_10001

	local var_7_1 = arg_7_0.textPay

	var_1_10001(var_2.Find(var_7_1, "after"), arg_7_0.isPay)
	...
	local var_7_3 = var_2.Find(var_7_2, "tip")
	local var_7_4 = arg_7_0.activity

	var_1_10001(var_7_3, #var_3.GetCrusingUnreceiveAward(var_7_4) > 0)
	...
	if arg_7_0.isPay then
		...
		if var_1.GetInt("first_crusing_page_display:" .. arg_7_0.activity.id, 0) == 0 then
			...
			System = var_3
			arg_7_0.LTFirst = var_7_5(var_7_6, var_3.Action(function()
				...
				System = var_2_10003
				var_8_0.LTFirst = var_8_1(var_8_2, var_2_10003.Action(function()
