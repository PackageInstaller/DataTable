...
function var_0_1.OnInit(arg_1_0)
	...
	local function var_1_24()
		...
		var_2_1(var_2_0, var_2_10002.ON_DROP, var_1_19)
	...
	var_1_20(var_1_22, var_1_23, var_1_24, var_1_10008)
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_2()
		...
		var_5_1(var_5_0, var_2_10002.GO_MINI_GAME, var_0_3)
	...
	local function var_4_5()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.eatgame_tips.tip
...
function var_0_1.CheckGet(arg_8_0)
	if arg_8_0.ultimate == 0 then
		...
		local var_8_1 = var_3.m02
		local var_8_2 = var_3.sendNotification

		GAME = var_1_10005

		local var_8_3 = var_1_10005.SEND_MINI_GAME_OP
		local var_8_4 = {
			hubid = var_0_2
		}

		MiniGameOPCommand = var_7
		var_8_4.cmd = var_7.CMD_ULTIMATE
		var_8_4.args1 = {}
