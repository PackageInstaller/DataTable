...
function var_0_1.OnFirstFlush(arg_1_0)
	...
	var_1.make(var_1_0, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if arg_2_0 == var_2_10003.EventUpdate then
			...
			local var_2_12 = var_2_4:getConfig("desc")
			local var_2_13 = "(" .. var_2_10 .. "/" .. var_2_11 .. ")"

			setText = var_13

			var_13(arg_2_2:Find("description"), var_2_12 .. " " .. var_2_13)

			setSlider = var_13

			var_13(arg_2_2:Find("progress"), 0, var_2_11, var_2_10)

			local var_2_14 = arg_2_2:Find("go_btn")
			local var_2_15 = arg_2_2:Find("get_btn")
			local var_2_16 = arg_2_2:Find("got_btn")
			local var_2_17 = var_2_4
			local var_2_18 = var_2_4.getTaskStatus(var_2_17)

			setActive = var_2_17

			var_2_17(var_2_14, var_2_18 == 0)

			setActive = var_2_17

			var_2_17(var_2_15, var_2_18 == 1)

			setActive = var_2_17

			var_2_17(var_2_16, var_2_18 == 2)
			...
			var_2_17(var_2_19, var_2_20, var_2_21, var_2_10021)

			onButton = var_2_17

			local var_2_22 = arg_1_0
			local var_2_23 = var_2_15
			...
			var_2_17(var_2_22, var_2_23, var_2_24, var_2_10021)
		end
...
function var_0_1.OnUpdateFlush(arg_6_0)
	...
	var_1(arg_6_0.items, function(arg_7_0)
		...
		local var_7_2 = arg_7_0.Find(var_7_1, "got_btn")
