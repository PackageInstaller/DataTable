...
function var_0_1.initData(arg_3_0)
	...
	arg_3_0.activity = var_3_2(var_3_1, var_1_10003.ACTIVITY_TYPE_GIFT_UP)
...
function var_0_1.initUI(arg_4_0)
	...
	var_1(var_4_3, var_4_2("newserver_soldout"))
	...
	local var_4_8 = var_2.Find(var_4_7, "pagefooter/dailyPacks/Text")

	i18n = var_4_7

	var_4_4(var_4_8, var_4_7("blackfriday_dailypack"))

	setText = var_4_4

	local var_4_9 = arg_4_0._tf
	local var_4_10 = var_2.Find(var_4_9, "pagefooter/dailyPacks/mark")

	i18n = var_4_9

	var_4_4(var_4_10, var_4_9("blackfriday_dailypack"))

	setText = var_4_4

	local var_4_11 = arg_4_0._tf
	local var_4_12 = var_2.Find(var_4_11, "pagefooter/specialPacks/Text")

	i18n = var_4_11

	var_4_4(var_4_12, var_4_11("blackfriday_specialpack"))

	setText = var_4_4

	local var_4_13 = arg_4_0._tf
	local var_4_14 = var_2.Find(var_4_13, "pagefooter/specialPacks/mark")

	i18n = var_4_13

	var_4_4(var_4_14, var_4_13("blackfriday_specialpack"))
	...
	arg_4_0.giftItemList = var_4_15(var_4_16, var_3.Find(var_4_17, "gift_tpl"))
	...
	var_1.make(var_4_18, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventInit then
			...
			var_5_1(var_5_0, var_2_10005(arg_5_2))
		else
			UIItemList = var_5_1
			...
			if arg_5_0 == var_5_1.EventUpdate then
				...
				var_5_3(var_5_2, var_2_10005(arg_5_2), arg_5_1)
			end
		end
...
function var_0_1.OnSwitch(arg_9_0, arg_9_1, arg_9_2)
	...
	local function var_9_1()
		...
		var_10_0.markTr = var_9_0
		setActive = var_10_0

		var_10_0(var_9_0, true)
	...
	var_5(var_9_2, var_9_3, var_9_4, var_1_10009)
...
function var_0_1.initGift(arg_13_0, arg_13_1)
	...
	var_3(var_13_1, var_13_2, var_13_3, var_1_10007)
...
function var_0_1.confirm(arg_16_0, arg_16_1)
	...
	if arg_16_1.isChargeType(var_16_0) then
		...
		local var_16_1 = not var_2.contains(arg_16_0.firstChargeIds, arg_16_1.id) and arg_16_1:firstPayDouble() and 4 or arg_16_1:getConfig("tag")

		var_1_10006 = arg_16_1

		local var_16_2 = arg_16_1.GetExtraServiceItem(var_1_10006)

		var_1_10006 = arg_16_1:GetExtraDrop()
		...
		if arg_16_1.isPassItem(var_1_10011) then
			i18n = var_10
			var_16_4 = var_10("battlepass_pay_tip")
		else
			var_1_10011 = arg_16_1

			if arg_16_1.isMonthCard(var_1_10011) then
				i18n = var_10
		...
		local var_16_6 = {
			...
			onYes = function()
				...
				if var_2_10000.isNeedSetBirth() then
					...
					var_17_1(var_17_0, var_2_10002.OPEN_CHARGE_BIRTHDAY)
				else
					...
					var_17_3(var_17_2, var_2_10002.CHARGE, arg_16_1.id)
				end
		...
		BlackFridaySalesMediator = var_13

		var_1_10011(var_16_7, var_13.GIFT_OPEN_ITEM_PANEL, var_16_6)
	else
		local var_16_8 = {}
		local var_16_9 = arg_16_1
		local var_16_10 = arg_16_1.getConfig(var_16_9, "effect_args")

		Item = var_16_9

		local var_16_11 = var_16_9.getConfigData(var_16_10[1]).display_icon

		type = var_1_10006

		if var_1_10006(var_16_11) == "table" then
			ipairs = var_6

			for iter_16_0, iter_16_1 in var_6(var_16_11) do
				table = var_1_10011
		...
		i18n = var_7
		var_16_12.tipExtra = var_7("charge_title_getitem")
		var_16_12.extraItems = var_16_8
		var_16_12.price = arg_16_1:getConfig("resource_num")
		var_16_12.tagType = arg_16_1:getConfig("tag")

		function var_16_12.onYes()
			pg = var_2_10000
			...
			var_18_2.content = var_2_10003(var_18_3, var_5.getConfig(var_18_4, "resource_num"), var_0.name)

			function var_18_2.onYes()
				local var_19_0 = arg_16_0
				local var_19_1 = var_0.emit

				BlackFridaySalesMediator = var_3_10002

				var_19_1(var_19_0, var_3_10002.GIFT_BUY_ITEM, arg_16_1.id, 1)
		...
		local var_16_14 = arg_16_0.emit

		BlackFridaySalesMediator = var_9

		var_16_14(var_16_13, var_9.GIFT_OPEN_ITEM_PANEL, var_16_12)
	end
...
function var_0_1.initGiftGoods(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_22_2(var_22_1.gifts[1]) do
		Goods = var_1_10008
		...
		Goods = var_1_10010
		var_1_10008 = var_1_10008(var_22_4, var_1_10010.TYPE_CHARGE)
		table = var_22_4

		var_22_4.insert(arg_22_0.giftList[1], var_1_10008)
	end
	...
	for iter_22_2, iter_22_3 in var_3(var_22_1.gifts[2]) do
		...
		Goods = var_1_10010
		var_1_10008 = var_1_10008(var_22_5, var_1_10010.TYPE_NEW_SERVER)
		table = var_22_5

		var_22_5.insert(arg_22_0.giftList[1], var_1_10008)
	end
	...
	for iter_22_4, iter_22_5 in var_3(var_22_1.gifts_2) do
		...
		Goods = var_1_10010
		var_1_10008 = var_1_10008(var_22_6, var_1_10010.TYPE_CHARGE)
		ChargeConst = var_22_6

		local var_22_7 = var_22_6.getBuyCount(var_22_3, iter_22_5)

		var_1_10008:updateBuyCount(var_22_7)

		table = var_1_10010

		var_1_10010.insert(arg_22_0.giftList[2], var_1_10008)
	end
...
function var_0_1.updateGiftGoodsVOList(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in var_23_1(arg_23_0.giftGoodsVOList) do
		local var_23_3
...
function var_0_1.isTip(arg_25_0)
	...
	if not (function(arg_26_0)
		...
		for iter_26_0, iter_26_1 in var_3(var_26_1) do
			local var_26_2
