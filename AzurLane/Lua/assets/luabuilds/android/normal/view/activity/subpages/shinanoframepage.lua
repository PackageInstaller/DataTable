...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_8()
		...
		var_2_10000(var_6_0, not var_2_10002(arg_3_0.phaseTF_1))
		...
		var_2_10000(var_6_1, not var_2(arg_3_0.phaseTF_2))
	...
	local var_3_10 = var_3_7(var_3_9)

	LoadAndInstantiateSync = var_4

	local var_3_11 = var_4("IconFrame", var_3_10)
...
function var_0_1.OnUpdateFlush(arg_7_0)
	...
	if not var_7_1(var_7_0, var_1_10003.SHINANO_EXP_ACT_ID) or var_1:isEnd() then
		setActive = var_7_0

		var_7_0(arg_7_0.phaseTF_1, false)

		setActive = var_7_0

		var_7_0(arg_7_0.phaseTF_2, true)

		local var_7_2 = arg_7_0.ptData
		local var_7_3, var_7_4

		var_7_0, var_7_3, var_7_4 = var_7_0.GetResProgress(var_7_2)
		setText = var_1_10005

		var_1_10005(arg_7_0.progressText, var_7_0 .. "/" .. var_7_3)

		setSlider = var_1_10005

		var_1_10005(arg_7_0.progressBar, 0, 1, var_7_4)

		setActive = var_1_10005

		var_1_10005(arg_7_0.progressBar, true)

		setActive = var_1_10005

		var_1_10005(arg_7_0.progressText, true)

		local var_7_5 = arg_7_0.ptData

		var_1_10005 = var_1_10005.CanGetAward(var_7_5)

		local var_7_6 = arg_7_0.ptData
		local var_7_7 = var_6.CanGetNextAward(var_7_6)
		local var_7_8 = arg_7_0.ptData
		local var_7_9 = var_7.CanGetMorePt(var_7_8)

		setActive = var_7_8

		var_7_8(arg_7_0.goBtn, var_7_9 and not var_1_10005 and var_7_7)

		setActive = var_7_8

		var_7_8(arg_7_0.getBtn, var_1_10005)

		setActive = var_7_8

		var_7_8(arg_7_0.gotBtn, not var_7_7)

		setActive = var_7_8

		var_7_8(arg_7_0.gotTag, not var_7_7)
	else
		setActive = var_7_0

		var_7_0(arg_7_0.phaseTF_1, true)

		setActive = var_7_0

		var_7_0(arg_7_0.phaseTF_2, false)

		local var_7_10 = arg_7_0.ptData
		local var_7_11, var_7_12, var_7_13 = var_2.GetResProgress(var_7_10)

		setText = var_1_10005

		var_1_10005(arg_7_0.progressText, var_7_11 .. "/" .. var_7_12)

		setSlider = var_1_10005

		var_1_10005(arg_7_0.progressBar, 0, 1, var_7_13)
