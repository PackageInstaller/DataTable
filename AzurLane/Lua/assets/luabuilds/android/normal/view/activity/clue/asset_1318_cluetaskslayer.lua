...
function var_0_1.ShouldShowTip()
	...
	local var_3_1 = var_1_10001(var_1_10002)

	getProxy = var_1_10002
	ActivityProxy = var_1_10003

	local var_3_2 = var_1_10002(var_1_10003)
...
function var_0_1.didEnter(arg_4_0)
	...
	var_1(var_4_7, var_4_6("other_world_task_get_all"))
...
function var_0_1.GetAllAward(arg_10_0)
	...
	ClueTasksMediator = var_5

	var_10_6(var_10_5, var_5.ON_TASK_SUBMIT_ONESTEP, arg_10_0.taskActivityId, var_10_1)
...
function var_0_1.UpdateList(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	var_12_4(var_12_5, var_12_3:getConfig("desc"))

	local var_12_6 = var_12_3:getProgress()
	local var_12_7 = var_12_3
	local var_12_8 = var_12_3.getConfig(var_12_7, "target_num")

	setText = var_12_7

	var_12_7(arg_12_2:Find("progress"), var_12_6 .. "/" .. var_12_8)

	setSlider = var_12_7

	var_12_7(arg_12_2:Find("slider"), 0, var_12_8, var_12_6)

	local var_12_9 = arg_12_2:GetChild(0)
	local var_12_10 = arg_12_2:Find("awards")

	arg_12_0:updateAwards(var_12_3:getConfig("award_display"), var_12_10, var_12_9)

	local var_12_11 = arg_12_2:Find("go_btn")
	local var_12_12 = arg_12_2:Find("get_btn")
	local var_12_13 = arg_12_2:Find("got_btn")
	local var_12_14 = var_12_3
	local var_12_15 = var_12_3.getTaskStatus(var_12_14)

	setActive = var_12_14

	var_12_14(var_12_11, var_12_15 == 0)

	setActive = var_12_14

	var_12_14(var_12_12, var_12_15 == 1)

	setActive = var_12_14

	var_12_14(var_12_13, var_12_15 == 2)

	SetActive = var_12_14

	var_12_14(arg_12_2:Find("tip"), var_12_15 == 1)

	onButton = var_12_14

	local var_12_16 = arg_12_0
	local var_12_17 = var_12_12

	local function var_12_18()
		local var_13_0 = arg_12_0
		local var_13_1 = var_0.emit

		ClueTasksMediator = var_2_10002

		var_13_1(var_13_0, var_2_10002.ON_TASK_SUBMIT_ONESTEP, arg_12_0.taskActivityId, {
			var_12_3.id
		})
	...
	var_12_14(var_12_16, var_12_17, var_12_18, var_1_10020)

	onButton = var_12_14

	local var_12_19 = arg_12_0
	local var_12_20 = var_12_11
	...
	local function var_12_21()
		...
		var_14_1(var_14_0, var_2_10002.ON_TASK_GO, var_12_3)
	...
	var_12_14(var_12_19, var_12_20, var_12_21, var_1_10020)
...
function var_0_1.updateAwards(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	for iter_15_1 = 1, var_15_1 do
		...
		if var_15_3 then
			...
			var_14(var_1_10015(var_15_2, "mask"), var_15_5)

			onButton = var_14
			var_1_10015 = arg_15_0

			local var_15_6 = var_15_2:Find("mask")
			...
			local function var_15_7()
				...
				var_16_1(var_16_0, var_2_10002.ON_DROP, var_15_5)
			...
			var_14(var_1_10015, var_15_6, var_15_7, var_18)
		end
	end
