...
function var_0_1.init(arg_2_0, ...)
	...
	var_1(var_2_1, var_2_0("yumia_main_tip_5"))
	...
	var_2.make(var_2_5, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			elseif not arg_2_0.pageDic[var_3.id] then
				...
				var_4.OnToggleName(var_3_0, arg_3_2, var_3:getConfig("is_show"))
				...
				if arg_2_0.pageDic[var_3.id] ~= nil then
					...
					var_5(var_3_1, var_3_2, var_3_3, var_9)
				end
			end
		end
...
function var_0_1.UpdateAdapt(arg_8_0)
	...
	var_8_6(var_6.Find(var_8_7, "adapt"), {
		x = 0,
		y = 0
	})
	...
	local var_8_9 = var_6.clamp

	NotchAdapt = var_7

	local var_8_10 = var_8_8 == var_8_9(var_7.CheckNotchRatio, var_8_0, var_8_1)

	SetComponentEnabled = var_6

	local var_8_11 = arg_8_0._tf

	var_6(var_7.Find(var_8_11, "adapt"), "NotchAdapt", var_8_10)
...
function var_0_1.OnToggleName(arg_9_0, arg_9_1, arg_9_2)
	...
	var_1_10003(var_9_1, var_9_0("general_activity_side_bar" .. arg_9_2))
	...
	var_1_10003(var_9_3, var_9_2("general_activity_side_bar" .. arg_9_2))
...
function var_0_1.OnAnimations(arg_10_0, arg_10_1, arg_10_2)
	...
	var_1_10003(var_4.Find(var_10_0, "adapt/l"), arg_10_2 == 50234)

	SetActive = var_1_10003

	local var_10_1 = arg_10_0._tf

	var_1_10003(var_4.Find(var_10_1, "adapt/r"), arg_10_2 == 50234)

	SetActive = var_1_10003

	local var_10_2 = arg_10_0._tf

	var_1_10003(var_4.Find(var_10_2, "adapt/below"), arg_10_2 == 50234)
