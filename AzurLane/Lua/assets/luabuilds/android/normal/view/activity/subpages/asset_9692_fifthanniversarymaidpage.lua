	...
	for iter_7_2, iter_7_3 in var_7_11(arg_7_0.taskList) do
		...
		if var_8.getFinishTaskById(var_7_13, iter_7_3) then
			...
			if var_7_13(var_7_12, {
				...
				local var_7_14 = var_9.NewStoryMgr.GetInstance()

				var_9.Play(var_7_14, var_7_12[iter_7_2][1])
			end
		end
	end
