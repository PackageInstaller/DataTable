...
function var_0_1.UpdateView(arg_10_0)
	for iter_10_0 = 1, #arg_10_0.table_Top do
		...
		var_1_10005(var_6.Find(var_10_0, "Label"), arg_10_0:OnGetCount(iter_10_0) .. "/" .. arg_10_0:OnCount(iter_10_0))
	end
...
function var_0_1.ShowSitePage(arg_16_0)
	...
	var_14(var_16_4:Find("Text"), var_16_12)
	...
	var_27(var_16_20:Find("Text"), var_16_29)
