...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.MAKE_FURNITURE, function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_2 = var_2_10005.ACTIVITY_OPERATION
		local var_2_3 = {
			cmd = 1
		}

		ActivityConst = var_2_10007
		var_2_3.activity_id = var_2_10007.YUMIA_BASE_ACT_ID
	...
	arg_1_0:bind(var_0_1.GET_AWARD, function(arg_3_0, arg_3_1, arg_3_2)
		...
		local var_3_2 = var_2_10005.ACTIVITY_OPERATION
		local var_3_3 = {
			cmd = 2
		}

		ActivityConst = var_2_10007
		var_3_3.activity_id = var_2_10007.YUMIA_BASE_ACT_ID
	...
	arg_1_0:bind(var_0_1.YOUMIA_GO_SCENE, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10005.GO_SCENE, arg_4_1, arg_4_2)
