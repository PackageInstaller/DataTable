...
function var_0_1.init(arg_2_0)
	...
	for iter_2_4, iter_2_5 in var_1(var_2.guardian_template.all) do
		pg = var_1_10006
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_1 = var_2(arg_3_0._tf, "pop")
	...
	local var_3_3 = var_5(var_3_0, "btnBack")
	...
	var_3(var_3_2, var_3_3, var_3_4, var_7)
	...
	local function var_3_7()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.other_world_temple_tip.tip
	...
	var_3(var_3_5, var_3_6, var_3_7, var_3_8)
	...
	for iter_3_0 = 1, var_0_2 do
		...
		local var_3_8 = var_3_8(var_3_0, "pageToggle/bg/" .. iter_3_0)

		table = var_8

		var_8.insert(arg_3_0.pageToggles, var_3_8)
		...
		var_8(var_3_9, var_3_10, var_3_11, var_1_10012)
	end
	...
	local var_3_13 = var_5(var_3_0, "btnDetail")

	local function var_3_14()
		local var_7_0 = arg_3_0
		local var_7_1 = var_0.emit

		OtherWorldTempleMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.OPEN_TERMINAL)
	...
	var_3(var_3_12, var_3_13, var_3_14, var_7)
	...
	local var_3_16 = var_3_13(var_3_0, "btnAward")
	...
	var_3(var_3_15, var_3_16, var_3_17, var_7)
	...
	local var_3_19 = var_3_16(var_3_0, "btnPay")
	...
	local function var_3_20()
		...
		if 0 < var_9_1 and var_9_5 <= var_9_3 then
			if arg_3_0.activity.data1 ~= arg_3_0.templeIds[arg_3_0._selectIndex] then
				...
				GAME = var_2_10006
				var_2_10006 = var_2_10006.ACTIVITY_OPERATION
				...
				var_9_8.activity_id = var_2_10008.OTHER_WORLD_TERMINAL_LOTTERY_ID
				var_9_8.arg1 = arg_3_0.templeIds[arg_3_0._selectIndex]

				var_9_7(var_9_6, var_2_10006, var_9_8)
		...
		elseif var_9_3 < var_9_5 then
			...
			var_9_11(var_9_10, var_2_10006(var_0_14))
		end
	...
	var_3(var_3_18, var_3_19, var_3_20, var_7)
	...
	local var_3_22 = var_3_19(var_3_0, "btnChars")
	...
	var_3(var_3_21, var_3_22, var_3_23, var_7)
	...
	local var_3_25 = var_3_22(var_3_0, "btnMain")
	...
	var_3(var_3_24, var_3_25, var_3_26, var_7)

	findTF = var_3
	arg_3_0._coinText = var_3(var_3_0, "coin/text")
	OtherWorldTempleChars = var_3

	local var_3_27 = var_3.New

	findTF = var_4
	arg_3_0._charPage = var_3_27(var_4(arg_3_0._tf, "pop/charPage"), arg_3_0)

	local var_3_28 = arg_3_0._charPage

	var_3.setData(var_3_28, arg_3_0.charIds)

	OtherWorldTempleAward = var_3

	local var_3_29 = var_3.New

	findTF = var_3_28
	arg_3_0._awardPage = var_3_29(var_3_28(arg_3_0._tf, "pop/awardPage"), arg_3_0)

	local var_3_30 = arg_3_0._awardPage

	var_3.setData(var_3_30, arg_3_0.templeIds, arg_3_0.shopDatas)

	local var_3_31 = arg_3_0._charPage

	var_3.setActive(var_3_31, false)

	local var_3_32 = arg_3_0._awardPage

	var_3.setActive(var_3_32, false)

	setText = var_3
	findTF = var_3_32

	local var_3_33 = var_3_32(var_3_0, "pageToggle/bg/1/unSelect/text")

	i18n = var_5

	var_3(var_3_33, var_5(var_0_3))

	setText = var_3
	findTF = var_3_33

	local var_3_34 = var_3_33(var_3_0, "pageToggle/bg/2/unSelect/text")

	i18n = var_5

	var_3(var_3_34, var_5(var_0_4))

	setText = var_3
	findTF = var_3_34

	local var_3_35 = var_3_34(var_3_0, "pageToggle/bg/3/unSelect/text")

	i18n = var_5

	var_3(var_3_35, var_5(var_0_5))

	setText = var_3
	findTF = var_3_35

	local var_3_36 = var_3_35(var_3_0, "btnChars/img/text")

	i18n = var_5

	var_3(var_3_36, var_5(var_0_6))

	setText = var_3
	findTF = var_3_36

	local var_3_37 = var_3_36(var_3_0, "btnAward/img/text")

	i18n = var_5

	var_3(var_3_37, var_5(var_0_7))

	setText = var_3
	findTF = var_3_37

	local var_3_38 = var_3_37(var_3_0, "desc/text")

	i18n = var_5

	var_3(var_3_38, var_5(var_0_12))

	setText = var_3
	findTF = var_3_38

	local var_3_39 = var_3_38(var_3_0, "btnComplete/img/text")

	i18n = var_5

	var_3(var_3_39, var_5(var_0_11))
...
function var_0_1.payToLottery(arg_13_0, arg_13_1)
	...
	local var_13_3 = var_4.ACTIVITY_OPERATION
	local var_13_4 = {
		cmd = 1
	}

	ActivityConst = var_1_10006
	var_13_4.activity_id = var_1_10006.OTHER_WORLD_TERMINAL_LOTTERY_ID
...
function var_0_1.selectPage(arg_14_0, arg_14_1)
	...
	for iter_14_0 = 1, var_0_2 do
		...
		var_1_10007(var_1_10008(var_14_0, "select"), iter_14_0 == arg_14_0._selectIndex)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(var_14_0, "unSelect"), iter_14_0 ~= arg_14_0._selectIndex)
		...
		if not arg_14_0._lastSelectIndex then
			...
			local var_14_1 = var_9(arg_14_0.picTf, "img/" .. iter_14_0)

			typeof = var_10
			Animator = var_11

			local var_14_2 = var_1_10008(var_14_1, var_10(var_11))

			var_1_10008.SetTrigger(var_14_2, var_1_10007)
		elseif arg_14_0._selectIndex ~= arg_14_0._lastSelectIndex then
			if arg_14_0._lastSelectIndex < arg_14_0._selectIndex then
				...
				findTF = var_1_10008
				var_1_10008 = var_1_10008(arg_14_0.picTf, "img/" .. arg_14_0._lastSelectIndex)
				typeof = var_9
				Animator = var_10
				var_1_10008 = var_1_10007(var_1_10008, var_9(var_10))

				var_1_10007.SetTrigger(var_1_10008, "leftOut")

				GetComponent = var_1_10007
				findTF = var_1_10008
				var_1_10008 = var_1_10008(arg_14_0.picTf, "img/" .. arg_14_0._selectIndex)
				typeof = var_9
				Animator = var_10
				var_1_10008 = var_1_10007(var_1_10008, var_9(var_10))

				var_1_10007.SetTrigger(var_1_10008, "rightIn")
			else
				GetComponent = var_1_10007
				findTF = var_1_10008
				var_1_10008 = var_1_10008(arg_14_0.picTf, "img/" .. arg_14_0._lastSelectIndex)
				...
				var_1_10007.SetTrigger(var_1_10008, "rightOut")
				...
				var_1_10007.SetTrigger(var_1_10008, "leftIn")
			end
		end
	end

	local var_14_3 = arg_14_0
	local var_14_4 = arg_14_0.getResIconPath(var_14_3)

	LoadImageSpriteAsync = var_14_3

	local var_14_5 = var_14_4

	findTF = iter_14_0

	var_14_3(var_14_5, iter_14_0(arg_14_0._tf, "ad/pt/img/icon"), false)
	...
	var_14_3(var_14_6, var_5(arg_14_0._tf, "ad/btnPay/img/icon"), false)
...
function var_0_1.updateUI(arg_15_0)
	...
	local var_15_4 = var_15_2.min(var_15_3, var_0_15)

	math = var_5

	local var_15_5 = var_5.floor(var_15_1 / var_15_0)
	...
	var_7(var_8(arg_15_0._tf, "ad/btnPay/img/text"), var_15_6)

	setText = var_7
	findTF = var_8

	local var_15_7 = var_8(arg_15_0._tf, "ad/btnPay/img/desc")

	i18n = var_9

	var_7(var_15_7, var_9(var_0_13, arg_15_0.lotteryCount))
	...
	var_7(var_8(arg_15_0._tf, "ad/btnPay"), var_15_3 > 0)

	setActive = var_7
	findTF = var_8

	var_7(var_8(arg_15_0._tf, "ad/btnComplete"), var_15_3 <= 0)

	GetComponent = var_7
	findTF = var_8

	local var_15_8 = var_8(arg_15_0._tf, "ad/btnComplete/img/bg")

	typeof = var_9
	arg_15_0.grayComponent = var_7(var_15_8, var_9("UIGrayScale"))
...
function var_0_1.getResCount(arg_17_0)
	...
	local var_17_2 = var_17_0.activity_random_award_template[arg_17_0.templeIds[arg_17_0._selectIndex]].resource_type
	local var_17_3
...
function var_0_1.getResIconPath(arg_19_0)
	...
	pg = var_1_10003
	var_19_1.id = var_1_10003.activity_random_award_template[arg_19_0.templeIds[arg_19_0._selectIndex]].resource_type
...
function var_0_1.updateActivity(arg_20_0)
	...
	arg_20_0.activity = var_20_1(var_20_0, var_1_10003.OTHER_WORLD_TERMINAL_LOTTERY_ID)
			...
			if 0 < var_21_1 then
				...
				for iter_21_0, iter_21_1 in var_4(var_2) do
					...
					for iter_21_2, iter_21_3 in var_1_10010(var_1_10009) do
						...
						var_1_10015(var_21_3, var_1_10017.New({
							type = iter_21_3[1],
							id = iter_21_3[2],
							count = iter_21_3[3]
						}))
				...
				OtherWorldTempleMediator = var_6

				var_21_5(var_21_4, var_6.SHOW_CHAR_AWARDS, var_21_2)
			end
		end
	end
