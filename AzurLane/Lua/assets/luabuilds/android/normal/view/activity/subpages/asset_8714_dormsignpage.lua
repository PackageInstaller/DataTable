...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_7_4(var_3.Find(var_7_8, "tip"), var_0_1.IsShowGoRed())

	PlayerPrefs = var_7_4

	var_7_4.SetString("DormSignPage", var_0_1.GetDate())
...
function var_0_1.IsShowAwardRed()
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10002.DORM_SIGN_ID)
