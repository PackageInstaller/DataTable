...
function var_0_1.OnInit(arg_1_0)
	...
	var_1(var_1_14, var_1_13("Outpost_20250904_Progress"))

	setText = var_1

	local var_1_15 = arg_1_0.task_bg
	local var_1_16 = var_2.Find(var_1_15, "display_btn/Text")

	i18n = var_1_15

	var_1(var_1_16, var_1_15("other_world_temple_award"))
...
function var_0_1.OnFirstFlush(arg_4_0)
	...
	local function var_4_2()
		...
		local var_5_2 = var_2_10002.SHOW_AWARD_WINDOW
		...
		var_5_3.unlockStamps = var_5.GetDayUnlockStamps(var_5_4)

		var_5_1(var_5_0, var_5_2, var_2_10003, var_5_3)
	...
	local function var_4_5()
		...
		var_6_1(var_6_0, var_2_10002.SPECIAL_BATTLE_OPERA)
...
function var_0_1.OnAddUI(arg_8_0)
	...
	local var_8_4 = var_2.Find(var_8_3, "red")
	local var_8_5 = arg_8_0.scenario

	var_1_10001(var_8_4, var_3.IsShowRed(var_8_5, arg_8_0.activity))
...
function var_0_1.SwitchBG(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	var_10_1.insert(arg_10_0.mapGroup, var_10_2)
...
function var_0_1.ShowScenarioLayer(arg_12_0, arg_12_1)
	if arg_12_1 then
		...
		local var_12_4 = var_3.Find(var_12_3, "red")
		local var_12_5 = arg_12_0.scenario

		var_2(var_12_4, var_4.IsShowRed(var_12_5, arg_12_0.activity))
...
function var_0_1.GetAllAward(arg_15_0)
	...
	if var_1_10006 then
		...
		var_1_10006 = var_1_10006.GetLimitCntById(var_1_10007, var_15_5)
	end

	Task = var_1_10007

	local var_15_6, var_15_7 = var_1_10007.StaticJudgeOverflow(var_15_4.gold, var_15_4.oil, var_1_10006, true, true, {
		{
			var_15_2.type,
			var_15_2.id,
			var_15_2.count
	...
	if var_15_6 then
		...
		var_9.insert(var_15_0, function(arg_16_0)
			...
			i18n = var_2_10004
			var_16_2.content = var_2_10004("award_max_warning")
	...
	var_9(var_15_0, function()
		...
		local var_17_5 = var_2_10004.EVENT_PT_OPERATION
		local var_17_6 = {
			cmd = 1
		}
		local var_17_7 = arg_15_0.ptData

		var_17_6.activity_id = var_6.GetId(var_17_7)
...
function var_0_1.OnUpdateFlush(arg_18_0)
	...
	local var_18_12 = var_1_10010(var_18_8, "#3f93d4")

	setColorStr = var_11

	var_8(var_18_11, var_18_12 .. var_11("/" .. var_18_9, "#747c88"))
	...
	var_18_17(arg_18_0.battleBtn, var_18_18 and not var_18_14 and var_18_16)

	setActive = var_18_17

	var_18_17(arg_18_0.getBtn, var_18_14)

	setActive = var_18_17

	var_18_17(arg_18_0.gotBtn, not var_18_16)

	local var_18_19 = arg_18_0.ptData
	local var_18_20 = var_11.GetAward(var_18_19)

	updateDrop = var_18_19

	var_18_19(arg_18_0.awardTF, var_18_20)
	...
	local function var_18_23()
		...
		var_19_1(var_19_0, var_2_10002.ON_DROP, var_18_20)
	...
	var_18_19(var_18_21, var_18_22, var_18_23, var_1_10016)
...
function var_0_1.GetWorldPtData(arg_21_0, arg_21_1)
	...
	ActivityMainScene = var_21_0

	local var_21_2

	if not var_21_0.Data2Time then
		var_21_2 = 0
	end
	...
	if arg_21_1 <= var_21_1 - var_21_2 then
		...
		var_21_7.activity_id = var_6.GetId(var_21_8)
