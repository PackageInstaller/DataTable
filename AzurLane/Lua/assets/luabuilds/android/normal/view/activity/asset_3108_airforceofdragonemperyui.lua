...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0 = var_2_0, var_2.Find(var_2_1, "List").childCount - 1 do
		...
		setImageAlpha = var_2_3

		var_2_3(var_2_4:Find("Button"), 0.5)

		table = var_2_3

		var_2_3.insert(arg_2_0.itemList, var_2_4)
	end
...
function var_0_1.GetActivityProgress(arg_5_0)
	...
	local var_5_11 = var_5_9.min(var_5_10 * var_5_3, var_5_1)
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_2 = var_3.Find(var_6_1, "Back")
	...
	local var_6_6 = var_3.Find(var_6_5, "Help")
	...
	local function var_6_7()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip.fighterplane_help.tip
	...
	local var_6_10 = var_3.Find(var_6_9, "Battle")
	...
	local function var_6_11()
		...
		local function var_9_3()
			...
			local var_10_4 = var_10_2.floor(#var_10_3 / var_10_1) * (var_9_0 - 1) + 1

			math = var_3_10004

			local var_10_5 = var_3_10004.min(var_10_4 + var_2 - 1, #var_10_3)

			math = var_5

			local var_10_6 = var_10_3[var_5.random(var_10_4, var_10_5)]
			local var_10_7 = arg_6_0
			local var_10_8 = var_6.emit

			AirForceOfDragonEmperyMediator = var_3_10008

			var_10_8(var_10_7, var_3_10008.ON_BATTLE, var_10_6)
		...
		if var_3.GetPerLevelProgress(var_9_4) <= var_9_2 then
			...
			i18n = var_2_10006
			var_9_7.content = var_2_10006("fighterplane_complete_tip")
	...
	SFX_FIGHTER_BATTLE = var_5

	var_1_10001(var_6_8, var_6_10, var_6_11, var_5)
	...
	for iter_6_0, iter_6_1 in var_1_10001(arg_6_0.itemList) do
		...
		SFX_FIGHTER_SWITCH = var_1_10010

		var_1_10006(var_6_12, var_6_13, var_6_14, var_1_10010)
	end

	getProxy = var_1
	PlayerProxy = var_2

	local var_6_15 = var_1(var_2)
...
function var_0_1.willExit(arg_12_0)
	...
	var_12_0.SetInt("AirFightIndex_" .. var_12_1.id, arg_12_0.contextData.index)
	...
	var_12_2(var_3(arg_12_0.currentNameImage))
	...
	var_12_3(var_3(arg_12_0.currentFighterImage))
	...
	var_12_4(var_3(var_4.Find(var_12_5, "Desc/Text")))
	...
	var_12_6(var_3(var_4.Find(var_12_7, "Progress")))
...
function var_0_1.UpdateView(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10001(arg_13_0.itemList) do
		...
		var_1_10009 = var_1_10009.StaticAlign

		local var_13_3 = var_13_2:Find("Progress")
		local var_13_4 = var_13_2:Find("Progress")

		var_1_10009(var_13_3, var_11.GetChild(var_13_4, 0), var_13_0)
	end

	arg_13_0:UpdateFighter(arg_13_0.contextData.index)

	local var_13_5, var_13_6 = arg_13_0:GetActivityProgress()

	setText = var_3

	var_3(arg_13_0.BattleTimes, var_13_6 - var_13_5)
...
function var_0_1.SwitchIndex(arg_14_0, arg_14_1)
	...
	;(function()
		...
		local var_15_3 = var_15_2(var_15_1, var_2_10003(var_2_10004))

		tf = var_15_1

		local var_15_4 = var_15_1(arg_14_0.currentFighterImage)

		LeanTween = var_3

		local var_15_5 = var_3.cancel

		go = var_2_10004

		var_15_5(var_2_10004(arg_14_0.currentFighterImage))
		...
		local var_15_9 = var_15_8(var_15_7, var_2_10006(var_2_10007))

		tf = var_15_7

		local var_15_10 = var_15_7(arg_14_0.currentNameImage)

		LeanTween = var_6

		local var_15_11 = var_6.cancel

		go = var_2_10007

		var_15_11(var_2_10007(arg_14_0.currentNameImage))
		...
		var_15_11({
			function(arg_16_0)
				...
				var_16_1(var_16_0, var_4.Action(arg_16_0))
			...
			function(arg_17_0)
				...
				var_17_1(var_17_0, var_4.Action(arg_17_0))
	...
	;(function()
		...
		var_23_3(var_23_2, var_3(var_0_3[arg_14_1]))
	...
	var_14_6.StaticAlign(var_14_5, var_14_5:GetChild(0), var_14_7, function(arg_24_0, arg_24_1, arg_24_2)
		...
		local var_24_2 = arg_24_2.GetChild(var_24_1, 0)

		Vector3 = var_24_1
		var_24_2.localScale = var_24_1(0, 1, 1)
	...
	local var_14_10 = var_14_9(var_10(var_14_5), 0, 1, var_14_7 * 0.2)
	local var_14_11 = var_9.setOnUpdate

	System = var_11

	var_14_11(var_14_10, var_11.Action_float(function(arg_25_0)
		for iter_25_0 = 0, 2 do
			...
			local var_25_2 = var_25_0.clamp(var_14_7 * arg_25_0 - iter_25_0, 0, 1)
			local var_25_3 = var_25_1
			local var_25_4 = var_25_1.GetChild(var_25_3, 0)

			Vector3 = var_25_3
			var_25_4.localScale = var_25_3(var_25_2, 1, 1)
		end
	...
	var_14_13(var_14_12, var_14_14, var_14_15, var_13.Find(var_14_16, "Name"), true)
...
function var_0_1.UpdateFighter(arg_26_0, arg_26_1)
	...
	local var_26_3 = var_1_10005.StaticAlign
	local var_26_4 = var_26_2:Find("Progress")
	local var_26_5 = var_26_2:Find("Progress")

	var_26_3(var_26_4, var_7.GetChild(var_26_5, 0), var_26_0)
	...
	local var_26_11 = var_26_6:Find("Item")
	...
	local function var_26_12()
		...
		var_27_1(var_27_0, var_2_10002.ON_DROP, var_26_9)
	...
	var_8(var_26_10, var_26_11, var_26_12, var_12)
...
function var_0_1.CheckActivityUpdate(arg_28_0)
	...
	for iter_28_0 = 1, var_28_3 do
		...
		if var_28_1 <= var_28_4 and not var_28_5 then
			...
			AirForceOfDragonEmperyMediator = var_1_10011

			var_28_7(var_28_6, var_1_10011.ON_ACTIVITY_OPREATION, {
				cmd = 2,
