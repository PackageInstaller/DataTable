...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local function var_3_5()
		...
		if var_2.getConfig(var_5_2, "config_client") ~= "" then
			var_5_3 = arg_3_0.activity

			if var_3.getConfig(var_5_3, "config_client").linkActID then
				getProxy = var_3
				ActivityProxy = var_5_3
				var_5_3 = var_3(var_5_3)
				var_5_1 = var_3.getActivityById(var_5_3, var_5_0)
			end
		end
		...
		if var_2.fightLinkActID then
			...
			local var_5_4 = var_5_3(var_2_10005)

			if var_5_3.getActivityById(var_5_4, var_3) then
				local var_5_5 = arg_3_0

				var_5_3 = var_5_3.emit
				ActivityMediator = var_2_10006

				var_5_3(var_5_5, var_2_10006.SKIP_ACTIVITY_MAP, var_3)
		...
		if not var_5_0 then
			...
			var_5_3(var_5_6, var_2_10006.BATTLE_OPERA)
		elseif var_5_1 and not var_5_1:isEnd() then
			...
			var_5_3(var_5_7, var_2_10006.BATTLE_OPERA)
		else
			pg = var_5_3

			local var_5_8 = var_5_3.TipsMgr.GetInstance()
			local var_5_9 = var_4.ShowTips

			i18n = var_2_10006

			var_5_9(var_5_8, var_2_10006("common_activity_end"))
		end
...
function var_0_1.OnUpdateFlush(arg_9_0)
	...
	if 1 <= var_9_12 then
		...
		if not var_8(var_9_14, var_1_10010) then
			var_9_15 = var_9_10
		end
		...
		var_9_20(arg_9_0.battleBtn, var_9_21 and not var_9_17 and var_9_19)

		setActive = var_9_20

		var_9_20(arg_9_0.getBtn, var_9_17)

		setActive = var_9_20

		var_9_20(arg_9_0.gotBtn, not var_9_19)
		...
		var_9_22(arg_9_0.awardTF, var_9_23)
		...
		local function var_9_26()
			...
			var_10_1(var_10_0, var_2_10002.ON_DROP, var_9_23)
		...
		var_9_22(var_9_24, var_9_25, var_9_26, var_1_10014)
