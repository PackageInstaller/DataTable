...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.ActivityMainScene"))
...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.tabsList = var_3_4(var_3_5, var_3.GetChild(var_3_6, 0))
	...
	var_1.make(var_3_7, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			if not var_3.detect(arg_3_0.activities, function(arg_5_0)
			...
			elseif not arg_3_0.pageDic[var_3.id] then
				...
				local var_4_0 = arg_3_0.pageDic[var_3.id]
				local var_4_1 = arg_4_2:Find("tip")
				local var_4_2 = var_4_0

				if var_4_0.IsShowReminder(var_4_2) == nil then
					setActive = var_4_2

					var_4_2(var_4_1, var_3:readyToAchieve())
				else
					setActive = var_4_2

					var_4_2(var_4_1, var_6)
				end
				...
				var_4_2(var_4_3, var_4_4, var_4_5, var_2_10011)
			end
		end
...
function var_0_1.didEnter(arg_7_0)
	...
	if arg_7_0.btnSkin then
		...
		local function var_7_4()
			...
			var_12_1(var_12_0, var_2_10002.GO_CHANGE_SHOP)
		...
		var_1(var_7_3, var_7_1, var_7_4, var_1_10005)
	end
...
function var_0_1.updateActivity(arg_17_0, arg_17_1)
	...
	if var_1_10002.PageIdLink[arg_17_1.id] then
		...
		local var_17_0 = var_2(var_3)
		local var_17_1 = var_2.getActivityById

		ActivityConst = var_1_10004
		arg_17_1 = var_17_1(var_17_0, var_1_10004.PageIdLink[arg_17_1.id])
	end
...
function var_0_1.OnToggleName(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_1 = arg_24_2.getConfig(var_24_0, "title_res_tag")

	setText = var_24_0

	local var_24_2 = arg_24_1
	local var_24_3 = arg_24_1.Find(var_24_2, "on/name")

	i18n = var_24_2

	var_24_0(var_24_3, var_24_2(var_24_1))

	setText = var_24_0

	local var_24_4 = arg_24_1
	local var_24_5 = arg_24_1.Find(var_24_4, "off/name")

	i18n = var_24_4

	var_24_0(var_24_5, var_24_4(var_24_1))

	if arg_24_0:IsImageTgName() then
		string = var_4

		local var_24_6 = var_4.lower(var_24_1)

		checkABExist = var_4

		if var_4("coreactivityuitable/" .. var_24_6 .. "_text") then
			setImageSprite = var_4

			local var_24_7 = arg_24_1
			local var_24_8 = arg_24_1.Find(var_24_7, "off/imgName")

			GetSpriteFromAtlas = var_24_7

			var_4(var_24_8, var_24_7("coreactivityuitable/" .. var_24_6 .. "_text", ""), true)
		end

		checkABExist = var_4

		if var_4("coreactivityuitable/" .. var_24_6 .. "_text_selected") then
			setImageSprite = var_4

			local var_24_9 = arg_24_1
			local var_24_10 = arg_24_1.Find(var_24_9, "on/imgName")

			GetSpriteFromAtlas = var_24_9

			var_4(var_24_10, var_24_9("coreactivityuitable/" .. var_24_6 .. "_text_selected", ""), true)
		end
	end
...
function var_0_1.verifyTabs(arg_31_0, arg_31_1)
	...
	if not arg_31_0:getActivityIndex(arg_31_1) then
		local var_31_1 = arg_31_0
		local var_31_2 = arg_31_0.getActivityIndex

		var_1_10006 = arg_31_0

		if not var_31_2(var_31_1, arg_31_0.GetActiveActivity(var_1_10006)) then
			var_31_3 = 1
		end
	end

	if var_31_0[var_31_3] == nil then
		return
	end

	local var_31_4 = var_2:getConfig("is_show")
	local var_31_5 = arg_31_0.tabs
	local var_31_6 = var_4.Find

	tostring = var_1_10006

	if var_31_6(var_31_5, var_1_10006(var_31_4)) then
		triggerToggle = var_31_5
