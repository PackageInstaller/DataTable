...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.wordTxt = var_2_8(var_2_7, var_3(var_1_10004))
	...
	arg_2_0.typer = var_2_11(var_2_10, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_12 = var_1.New
	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_2.Find(var_2_13, "frame/awards")
	local var_2_15 = arg_2_0._tf

	arg_2_0.uilist = var_2_12(var_2_14, var_3.Find(var_2_15, "frame/awards/tpl"))
...
function var_0_1.Show(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_1 = var_5.Find(var_4_0, "tip")

	i18n = var_4_0

	var_4(var_4_1, var_4_0("sculpture_gratitude_tip"))
...
function var_0_1.Flush(arg_8_0, arg_8_1)
	...
	SculptureActivity = var_8_0

	if var_8_1 == var_8_0.STATE_FINSIH then
		arg_8_0:Clear()
...
function var_0_1.SetScrollTxt(arg_9_0, arg_9_1)
	...
	HXSet = var_9_0
	var_9_1.text = var_9_0.hxLan(arg_9_1)
	...
	var_2.make(var_13_2, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			local function var_14_4()
				...
				var_15_1(var_15_0, var_3_10002.ON_DROP, var_14_1)
			...
			var_5(var_14_2, var_14_3, var_14_4, var_2_10009)
		end
...
function var_0_1.State2CharNameAndActionName(arg_17_0, arg_17_1)
	...
	if arg_17_1 == var_17_0.STATE_FINSIH then
...
function var_0_1.LoadSculpture(arg_18_0, arg_18_1)
	...
	ResourceMgr = var_18_0

	local var_18_2 = var_18_0.Inst
	...
	var_18_3(var_18_2, var_18_4, var_18_5, var_7.Events.UnityAction_UnityEngine_Object(function(arg_19_0)
		Object = var_2_10001
...
function var_0_1.InitSculpture(arg_20_0, arg_20_1)
	...
	local var_20_1 = var_1_10002(var_20_0, var_1_10004(var_1_10005))
	local var_20_2
	...
	var_20_1:AddDragEndFunc(function(arg_23_0, arg_23_1)
		...
		local var_23_2 = var_4(arg_20_1)
		local var_23_3 = var_23_1

		if var_23_1.Intersects(var_23_3, var_23_2) then
			local var_23_4 = arg_20_1

			TrPosition2LocalPos = var_23_3
			var_23_4.localPosition = var_23_3(var_23_0.parent, arg_20_1.parent, var_23_0.localPosition)

			local var_23_5 = arg_20_0
			local var_23_6 = var_5.emit

			SculptureMediator = var_7

			var_23_6(var_23_5, var_7.ON_FINSIH_SCULPTURE, arg_20_0.id)
		else
...
function var_0_1.UpdateRole(arg_24_0, arg_24_1, arg_24_2, arg_24_3, arg_24_4)
	...
	var_5.GetSpineChar(var_24_0, "takegift_" .. arg_24_1, true, function(arg_25_0)
		...
		Vector3 = var_25_0
		var_25_1.localScale = var_25_0(1, 1, 0)
		...
		local var_25_5 = var_25_4(var_25_3, var_3(var_4))
...
function var_0_1.Clear(arg_30_0)
	if arg_30_0.puzzle then
		...
		var_30_0.Destroy(arg_30_0.puzzle.gameObject)
