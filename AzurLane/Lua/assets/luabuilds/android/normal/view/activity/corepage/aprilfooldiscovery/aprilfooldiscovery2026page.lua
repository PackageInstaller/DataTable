...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.activity.CorePage.CoreActivityAprilFoolDiscoveryPage"))
...
function var_0_1.OnInit(arg_1_0)
	...
	arg_1_0.items = var_1_1.Clone2Full(var_1_2, 9)
	...
	for iter_1_0 = 1, #var_0_2 do
		...
		var_1_13(var_1_12, var_1_14, var_1_10009, var_10.Find(var_1_15, "Character"), true)
	end
	...
	local var_1_17 = var_3.Find(var_1_16, "timetext")

	i18n = var_1_16

	var_2(var_1_17, var_1_16("aprilfool_2026_cd"))
	...
	if #arg_7_0.activity.data2_list ~= #arg_7_0.keyList then
		...
		arg_7_0.CDTimer = var_1.New(function()
			...
			if var_8_0 <= var_1.GetServerTime(var_8_1) then
				...
				var_8_1(arg_7_0.slider, false)

				setActive = var_8_1

				var_8_1(arg_7_0.sliderbg, false)

				var_2_10003 = arg_7_0

				var_2.RemoveCDTimer(var_2_10003)

				return
			end

			local var_8_2 = var_8_0 - var_1

			math = var_2_10003

			local var_8_3 = var_2_10003.floor(var_8_2 / 60)
			local var_8_4 = var_8_2 % 60

			setText = var_2_10005

			local var_8_5 = arg_7_0.leftTime

			string = var_2_10007

			var_2_10005(var_8_5, var_2_10007.format("%d:%02d", var_8_3, var_8_4))

			local var_8_6 = arg_7_0.puzzleConfig.cd

			setSlider = var_8_5

			var_8_5(arg_7_0.slider, 0, 1, var_8_2 / var_8_6)
...
function var_0_1.OnFirstFlush(arg_9_0)
	...
	var_2(var_9_1, var_4.format("keyList has {0}, but items has {1}", #arg_9_0.keyList, #arg_9_0.items))
	...
	local function var_9_4()
		...
		pg = var_2_10003
		var_10_2.helps = var_2_10003.gametip.SuperBulin2_help.tip
	...
	var_2(var_9_2, var_9_3, var_9_4, var_6)
	...
	local function var_9_8()
		if #arg_9_0.activity.data2_list < #arg_9_0.keyList then
			...
			var_11_1(var_11_0, var_2_10002("caibulin_lock_tip"))
		...
		var_11_4(var_11_3, var_2_10003.ON_SIMULATION_COMBAT, {
			...
			if not var_12_1(var_12_0, var_3_10002(var_11_2), true) then
				pg = var_12_2
				var_12_0 = var_12_2.m02
				var_12_2 = var_12_2.sendNotification
				GAME = var_2

				local var_12_3 = var_2.STORY_UPDATE
				local var_12_4 = {}

				tostring = var_3_10004
				var_12_4.storyId = var_3_10004(var_11_2)
	...
	var_9_2(var_9_6, var_9_7, var_9_8, var_7)
...
function var_0_1.OnUpdateFlush(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10005(arg_14_0.items) do
		...
		var_12(arg_14_0, iter_14_1, function()
			...
			if var_1_10011 == 2 then
				...
				var_2_10002 = iter_14_1

				return var_0(var_1.Find(var_2_10002, "Unlock"), "im_AprilFoolDiscovery2026Page_Unlock")
			elseif var_1_10011 == 1 then
				...
				if var_0.GetServerTime(var_15_1) < arg_14_0.activity.data2 then
					...
					var_15_3(var_15_2, var_2_10002("bulin_tip_other2"))
				...
				i18n = var_2_10003
				var_15_6.content = var_2_10003("bulin_tip_other1")
				...
				function var_15_6.onYes()
					...
					var_16_1(var_16_0, var_3_10002.PUZZLE_PIECE_OP, {
						cmd = 3,
		...
		var_12(iter_14_1:Find("Character"), var_1_10011 == 3)

		if var_1_10011 == 3 then
			quickPlayAnimation = var_12

			var_12(iter_14_1, "anim_AprilFoolDiscovery2026Page_open")
		end

		setActive = var_12

		var_12(iter_14_1:Find("Selected"), var_1_10011 == 2)

		if var_1_10011 == 2 then
			setActive = var_12

			var_12(iter_14_1:Find("Unlock"), true)
		end

		setActive = var_12

		var_12(iter_14_1:Find("Locked"), var_1_10011 == 1)
	end
...
function var_0_1.UpdateSelection(arg_18_0)
	...
	if var_18_1 then
		...
		if not var_1_10005("SuperBulin2_tip" .. arg_18_0.selectIndex) then
			var_18_3 = false
		end

		var_3(var_18_2, var_18_3)
