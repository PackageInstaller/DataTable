...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.GET_PLAYER_SUMMARY_INFO, function(arg_2_0)
		...
		if var_2_1(var_2_0, var_2_10003.ACTIVITY_TYPE_SUMMARY) and not var_1:isEnd() then
			local var_2_2 = arg_1_0
			local var_2_3 = var_2.sendNotification

			GAME = var_2_10004

			var_2_3(var_2_2, var_2_10004.GET_PLAYER_SUMMARY_INFO, {
				activityId = var_1.id
			})
		end
	...
	local var_1_3 = var_1_2(var_1_1, var_4.ACTIVITY_TYPE_SUMMARY)
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.GET_PLAYER_SUMMARY_INFO_DONE then
