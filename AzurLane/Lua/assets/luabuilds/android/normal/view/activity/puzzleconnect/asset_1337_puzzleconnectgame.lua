...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._animation = var_3(var_1_0, var_5(var_1_10006))
	...
	var_3(var_1_1, var_5("tolovegame_puzzle_pop_finish"))
	...
	var_3(var_1_2, var_5("tolovegame_puzzle_pop_next"))
	...
	var_3(var_1_3, var_5("tolovegame_puzzle_pop_save"))
	...
	local var_1_5 = var_5(arg_1_0._tf, "ad/back")
	...
	local function var_1_6()
		...
		var_2_1(var_2_0, var_2_10002.OPEN_DETAIL)
	...
	local function var_1_9()
		...
		if arg_1_0.cheatCount >= 5 then
			...
			PuzzleConnectPlaying = var_3_0

			if var_3_1 == var_3_0.game_state_connect then
				pg = var_3_1
				...
				var_3_3(var_3_2, var_2_10002("tolovegame_puzzle_cheat"))
				...
				PuzzleConnectPlaying = var_3_6

				if var_3_7 == var_3_6.game_state_puzzle then
					pg = var_3_7
					...
					var_3_9(var_3_8, var_2_10002("tolovegame_puzzle_cheat"))
					...
					var_3_13(var_3_12, var_2.CMD_ACTIVITY, {
						index = 2,
	...
	local function var_1_12()
		...
		var_4_1(var_4_0, var_2_10002.ON_HOME)
	...
	local function var_1_18()
		...
		var_6_1(var_6_0, var_2.getState(var_6_2))
	...
	local function var_1_21()
		if arg_1_0._configData.after_story then
			...
			var_0.Play(var_7_0, arg_1_0._configData.after_story, function()
				...
				PuzzleConnectMediator = var_3_10002

				var_8_1(var_8_0, var_3_10002.CMD_ACTIVITY, {
					index = 3,
					config_id = arg_1_0._configData.id
				})
			...
			PuzzleConnectMediator = var_2_10002

			var_7_2(var_7_1, var_2_10002.CMD_ACTIVITY, {
				index = 3,
				config_id = arg_1_0._configData.id
			})
		end
		...
		var_7_4(var_7_3, var_2_10002.OPEN_MENU)
	...
	var_3.addCallback(var_1_23, function()
		...
		var_9_3(var_9_2, var_2.CMD_ACTIVITY, {
			index = 2,
			config_id = arg_1_0._configData.id
		})
...
function var_0_0.openComplete(arg_15_0, arg_15_1)
	...
	if arg_15_1 == var_0_1 then
		...
		var_2(var_3(arg_15_0._pop, "bgConnect"), false)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "bgPuzzle"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "btnNext"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "btnOver"), false)
		...
		var_2(var_3(arg_15_0._pop, "progress/success/line_2"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "progress/success/line_3"), false)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "progress/success/3"), false)
	elseif arg_15_1 == var_0_2 then
		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "bgConnect"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "bgPuzzle"), false)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "btnNext"), false)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "btnOver"), true)
		...
		var_2(var_3(arg_15_0._pop, "progress/success/line_3"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_15_0._pop, "progress/success/3"), true)
	end
...
function var_0_0.openPlayUI(arg_16_0, arg_16_1)
	...
	var_16_1(var_16_0, var_4.chapter_data[arg_16_0._configData.id], arg_16_1)
