...
function var_0_1.CommonInit(arg_5_0)
	...
	local var_5_4 = var_1:Find("middle")

	arg_5_0._autoToggle = var_1:Find("auto_toggle")
	arg_5_0._autoSubToggle = var_1:Find("sub_toggle_container/sub_toggle")
	arg_5_0._fleetInfo = var_5_4:Find("fleet_info")
	arg_5_0._fleetNameText = var_5_4:Find("fleet_info/fleet_name/Text")
	arg_5_0._fleetNumText = var_5_4:Find("fleet_info/fleet_number")
	setActive = var_3

	local var_5_5 = arg_5_0._fleetInfo
	local var_5_6 = arg_5_0.contextData.system

	SYSTEM_DUEL = var_1_10006

	var_3(var_5_5, var_5_6 ~= var_1_10006)

	arg_5_0._mainGS = var_5_4:Find("gear_score/main/Text")
	arg_5_0._vanguardGS = var_5_4:Find("gear_score/vanguard/Text")
	arg_5_0._subGS = var_5_4:Find("gear_score/submarine/Text")
	arg_5_0._bgFleet = var_5_4:Find("mask/grid_bg")

	local var_5_7 = var_5_4

	arg_5_0._bgSub = var_5_4.Find(var_5_7, "mask/bg_sub")

	local var_5_8 = {}

	TeamType = var_5_7
	var_5_8[var_5_7.Vanguard] = {}
	TeamType = var_4
	var_5_8[var_4.Main] = {}
	TeamType = var_4
	var_5_8[var_4.Submarine] = {}
	arg_5_0._gridTFs = var_5_8
	arg_5_0._gridFrame = var_5_4:Find("mask/GridFrame")
	...
	arg_5_0._heroContainer = var_5_4:Find("HeroContainer")
	arg_5_0._checkBtn = var_5_4:Find("checkBtn")
	...
	var_3(var_5_23, var_5("pre_combat_vanguard"))
	...
	var_3(var_5_24, var_5("pre_combat_main"))
	...
	var_3(var_5_25, var_5("pre_combat_submarine"))

	setText = var_3

	local var_5_26 = arg_5_0._costContainer
	local var_5_27 = var_4.Find(var_5_26, "title")

	i18n = var_5_26

	var_3(var_5_27, var_5_26("pre_combat_consume"))
	...
	var_3(var_5_28, var_5("pre_combat_targets"))
	...
	var_3(var_5_29, var_5("pre_combat_atlasloot"))

	setText = var_3

	local var_5_30 = arg_5_0._startBtn
	local var_5_31 = var_4.Find(var_5_30, "text")

	i18n = var_5_30

	var_3(var_5_31, var_5_30("pre_combat_start"))

	setText = var_3

	local var_5_32 = arg_5_0._startBtn
	local var_5_33 = var_4.Find(var_5_32, "text_en")

	i18n = var_5_32

	var_3(var_5_33, var_5_32("pre_combat_start_en"))
	...
	local var_5_37 = var_4.Find(var_5_36, "text")

	i18n = var_5_36

	var_3(var_5_37, var_5_36("multiple_sorties_title"))

	setText = var_3

	local var_5_38 = arg_5_0._continuousBtn
	local var_5_39 = var_4.Find(var_5_38, "text_en")

	i18n = var_5_38

	var_3(var_5_39, var_5_38("multiple_sorties_title_eng"))
...
function var_0_1.Register(arg_6_0)
	...
	var_1.AddHeroInfoModify(var_6_1, function(arg_8_0, arg_8_1)
		...
		local var_8_1 = var_3(var_8_0, "stars")
		...
		if var_8_3 then
			...
			var_8_5, var_8_6 = arg_8_1:getEnergyPrint()
			GetSpriteFromAtlas = var_2_10008

			if not var_2_10008("energy", var_8_5) then
				warning = var_2_10009
			...
			var_2_10009(var_8_4, var_2_10008)
		end
		...
		if var_8_3 then
			...
			var_2_10008 = arg_6_0.contextData.system
			SYSTEM_DUEL = var_2_10009
			var_2_10008 = var_2_10008 ~= var_2_10009
		end

		var_8_5(var_8_7, var_2_10008)

		local var_8_8 = arg_8_1:getStar()
		...
		local var_8_9 = "shiptype"

		shipType2print = var_9

		if not var_7(var_8_9, var_9(arg_8_1:getShipType())) then
			warning = var_8_9

			var_8_9("找不到船形, shipConfigId: " .. arg_8_1.configId)
		end

		setImageSprite = var_8_9
		findTF = var_9

		var_8_9(var_9(var_8_0, "type"), var_7, true)

		setText = var_8_9
		findTF = var_9

		var_8_9(var_9(var_8_0, "frame/lv_contain/lv"), arg_8_1.level)

		local var_8_10 = var_8_0
		local var_8_11 = var_8_0.Find(var_8_10, "expbuff")
	...
	var_1.AddLongPress(var_6_2, function(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
		...
		var_9_1(var_9_0, var_2_10006.OPEN_SHIP_INFO, arg_9_1.id, arg_9_2)
	...
	var_1.AddClick(var_6_5, function(arg_12_0, arg_12_1, arg_12_2)
		...
		var_12_3(var_12_2, var_2_10005.CHANGE_FLEET_SHIP, arg_12_0, arg_12_2, arg_12_1)
	...
	var_1.AddShiftOnly(var_6_6, function(arg_13_0)
		...
		var_13_1(var_13_0, var_2_10003.CHANGE_FLEET_SHIPS_ORDER, arg_13_0)
	...
	var_1.AddRemoveShip(var_6_7, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.REMOVE_SHIP, arg_14_0, arg_14_1)
	...
	var_1.AddCheckRemove(var_6_8, function(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
		...
		if not arg_15_3:canRemove(arg_15_2) then
			...
			var_15_0, var_15_1 = arg_15_3:getShipPos(arg_15_2)
			pg = var_7
			var_2_10008 = var_7.TipsMgr.GetInstance()

			local var_15_2 = var_7.ShowTips

			i18n = var_2_10009

			local var_15_3 = "ship_formationUI_removeError_onlyShip"
			local var_15_4 = arg_15_2:getConfigTable().name
			local var_15_5
			...
			var_15_2(var_2_10008, var_2_10009(var_15_3, var_15_4, var_15_5, var_2_10013.C_TEAM_NAME[var_15_1]))
			arg_15_0()
		else
			pg = var_15_0

			local var_15_6 = var_15_0.MsgboxMgr.GetInstance()
			local var_15_7 = var_5.ShowMsgBox
			local var_15_8 = {
				hideNo = false,
				zIndex = -100
			}
			...
			i18n = var_2_10008
			var_15_8.content = var_2_10008("battle_preCombatLayer_quest_leaveFleet", arg_15_2:getConfigTable().name)
			var_15_8.onYes = arg_15_1
			var_15_8.onNo = arg_15_0

			var_15_7(var_15_6, var_15_8)
		end
	...
	var_1.AddGridTipClick(var_6_12, function(arg_19_0, arg_19_1)
		...
		var_19_1(var_19_0, var_2_10004.CHANGE_FLEET_SHIP, nil, arg_6_0._currentFleetVO, arg_19_0)
...
function var_0_1.SetStageIds(arg_23_0, arg_23_1)
	...
	var_3.Foreach(arg_23_1, function(arg_24_0, arg_24_1)
		pg = var_2_10002
		...
		if var_4(var_2_10005.expedition_activity_template[arg_24_1], {
			"pt_drop_display"
		}) then
			type = var_24_2
			...
			if var_24_2(var_4) == "table" then
				...
				for iter_24_0 = #var_4, 1, -1 do
					if var_24_2:getActivityById(var_4[iter_24_0][1]) and not var_10:isEnd() then
						...
						id2ItemId = var_2_10015
						var_2_10014[2] = var_2_10015(var_4[iter_24_0][2])

						var_24_3(var_24_4, var_24_5, var_2_10014)
					end
				end
			end
		end
		...
		local function var_24_6(arg_25_0, arg_25_1)
			...
			if var_3_10002(arg_25_0) == "table" then
				...
				var_25_0 = var_25_0(var_3.ObjectiveList[arg_25_0[1]], arg_25_0[2])
				setWidgetText = var_3

				var_3(arg_25_1, var_25_0)
			else
				setActive = var_25_0
	...
	for iter_23_2, iter_23_3 in var_4(var_23_0) do
		...
		var_11(var_23_3, var_23_4, var_23_5, var_1_10015)
	end
...
function var_0_1.UpdateFleetView(arg_32_0, arg_32_1)
	...
	var_32_2(var_32_1, var_1_10004.Vanguard, false)
	...
	var_32_4(var_32_3, var_4.Main, false)
	...
	var_32_6(var_32_5, var_4.Submarine, false)
...
function var_0_1.updateFleetBg(arg_33_0)
	...
	var_33_0(var_33_2, var_33_1 == var_1_10004.Normal)
	...
	var_33_0(var_33_3, var_33_1 == var_4.Submarine)
...
function var_0_1.resetFormationComponent(arg_34_0)
	...
	local var_34_1 = var_2.Find(var_34_0, "flag")
	local var_34_2 = arg_34_0._currentFleetVO
	local var_34_3 = var_3.getTeamByName

	TeamType = var_1_10005

	var_1_10001(var_34_1, #var_34_3(var_34_2, var_1_10005.Main) ~= 0)

	SetActive = var_1_10001

	local var_34_4 = arg_34_0._gridTFs.submarine[1]
	local var_34_5 = var_2.Find(var_34_4, "flag")
	local var_34_6 = arg_34_0._currentFleetVO
	local var_34_7 = var_3.getTeamByName

	TeamType = var_5

	var_1_10001(var_34_5, #var_34_7(var_34_6, var_5.Submarine) ~= 0)
...
function var_0_1.didEnter(arg_37_0)
	...
	local function var_37_2()
		...
		var_2_10000(var_38_0, var_2_10002(var_2_10003)).interactable = false
		...
		var_38_2(var_38_3, var_2_10003.Action(function()
		...
		BossRushPreCombatMediator = var_3

		var_38_5(var_38_4, var_3.ON_UPDATE_CUSTOM_FLEET)
	...
	var_1_10001(var_37_0, var_37_1, var_37_2, var_1_10005)

	onButton = var_1_10001

	local var_37_3 = arg_37_0
	local var_37_4 = arg_37_0._tf
	local var_37_5 = var_3.Find(var_37_4, "blur_panel/top/option")
	...
	local function var_37_6()
		...
		BossRushPreCombatMediator = var_2_10002

		var_40_2(var_40_1, var_2_10002.ON_UPDATE_CUSTOM_FLEET)
	...
	var_1_10001(var_37_3, var_37_5, var_37_6, var_5)
	...
	local function var_37_9()
		...
		var_41_1(var_41_0, var_2_10002.ON_START)

		return
	end

	SFX_UI_WEIGHANCHOR = var_5

	var_1_10001(var_37_7, var_37_8, var_37_9, var_5)
	...
	local function var_37_12()
		...
		var_42_1(var_42_0, var_2_10002.ON_CHANGE_FLEET, arg_37_0._legalFleetIdList[arg_37_0._curFleetIndex + 1])
	...
	var_1_10001(var_37_10, var_37_11, var_37_12, var_5)
	...
	local function var_37_15()
		...
		var_43_1(var_43_0, var_2_10002.ON_CHANGE_FLEET, arg_37_0._legalFleetIdList[arg_37_0._curFleetIndex - 1])
	...
	var_1_10001(var_37_13, var_37_14, var_37_15, var_5)
	...
	typeof = var_3
	CanvasGroup = var_37_15

	local var_37_18 = var_1(var_37_17, var_3(var_37_15))
	...
	local function var_37_21(arg_44_0)
		...
		var_44_1(var_44_0, var_2_10003.ON_AUTO, {
			isOn = not arg_44_0,
	...
	var_37_18(var_37_19, var_37_20, var_37_21, var_5, var_1_10006)
	...
	local function var_37_24(arg_45_0)
		...
		var_45_1(var_45_0, var_2_10003.ON_SUB_AUTO, {
			isOn = not arg_45_0,
	...
	var_37_18(var_37_22, var_37_23, var_37_24, var_5, var_1_10006)
	...
	local var_37_26 = var_37_18(var_2)
	...
	;(function()
		...
		BossRushSeriesData = var_47_0

		local var_47_2 = var_47_1 == var_47_0.TYPE.NORMAL
		...
		ActivityConst = var_47_4

		if var_47_5 == var_47_4.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB then
		...
		var_47_5(var_3.Find(var_47_8, "lock"), not var_47_3)
		...
		if var_47_3 then
			...
			var_3(var_4.Find(var_47_9, "text"), var_47_5)

			setTextColor = var_3

			local var_47_10 = arg_37_0._continuousBtn

			var_3(var_4.Find(var_47_10, "text_en"), var_47_5)
			...
			local function var_47_13()
				...
				if var_47_3 then
					...
					BossRushPreCombatMediator = var_3_10002

					var_48_1(var_48_0, var_3_10002.SHOW_CONTINUOUS_OPERATION_WINDOW, arg_37_0._currentFleetVO.id)
				else
					pg = var_48_1
					...
					var_48_3(var_48_2, var_3_10002("multiple_sorties_locked_tip"))
				end
			...
			var_3(var_47_11, var_47_12, var_47_13, var_2_10007)
	...
	local var_37_30 = var_37_28:GetBossIcons()
	local var_37_31 = arg_37_0._tf
	local var_37_32 = var_6.Find(var_37_31, "adapt/middle/Boss")

	UIItemList = var_37_31

	var_37_31.StaticAlign(var_37_32, var_37_32:GetChild(0), #var_37_29, function(arg_49_0, arg_49_1, arg_49_2)
		...
		local var_49_1 = var_37_30[arg_49_1 + 1][1]
		...
		local var_49_5 = var_49_3(var_49_4, "icon_bg")

		findTF = var_9

		local var_49_6 = var_9(var_49_4, "icon_bg/frame")
		...
		GetImageSpriteFromAtlasAsync = var_49_7

		var_49_7("SquareIcon/" .. var_49_1, "", var_49_8)

		findTF = var_49_7

		if var_49_7(var_49_4, "ship_type") then
			setActive = var_12
			...
			var_12(var_49_9, var_14(var_49_10, var_2_10016(var_37_30[arg_49_1 + 1][2])))
		end
...
function var_0_1.UpdateSubToggle(arg_50_0)
	if arg_50_0.autoFlag and arg_50_0._subUseable == true then
		...
		var_1(var_50_0, var_3.Battle.BattleState.IsAutoSubActive())
	else
		setActive = var_1
...
function var_0_1.displayFleetInfo(arg_51_0)
	...
	var_51_0(var_51_2, var_51_1 == var_1_10004.Normal)
	...
	var_51_0(var_51_3, var_51_1 == var_4.Normal)

	math = var_51_0

	local var_51_4 = var_51_0.floor
	local var_51_5 = arg_51_0._currentFleetVO
	local var_51_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_51_7 = var_51_4(var_51_6(var_51_5, var_1_10005.Vanguard))

	math = var_3

	local var_51_8 = var_3.floor
	local var_51_9 = arg_51_0._currentFleetVO
	local var_51_10 = var_4.GetGearScoreSum

	TeamType = var_1_10006

	local var_51_11 = var_51_8(var_51_10(var_51_9, var_1_10006.Main))
	...
	var_4(var_51_12, var_51_1 == var_6.Submarine)

	math = var_4

	local var_51_13 = var_4.floor
	local var_51_14 = arg_51_0._currentFleetVO
	local var_51_15 = var_5.GetGearScoreSum

	TeamType = var_1_10007

	local var_51_16 = var_51_13(var_51_15(var_51_14, var_1_10007.Submarine))
	...
	var_51_14(var_51_18, var_51_17 ~= var_1_10008)
	...
	var_6(var_51_19, var_8.DEFAULT_NAME[arg_51_0._curFleetIndex])
	...
	UIItemList = var_51_22

	var_51_22.StaticAlign(var_51_23, var_51_23:GetChild(0), #var_51_21, function(arg_52_0, arg_52_1, arg_52_2)
		UIItemList = var_2_10003
	...
	local var_51_25 = var_10.to_array(arg_51_0.contextData.fleets)
	...
	if var_51_27 then
		...
		var_17(arg_51_0, arg_51_0._costTip, function()
			...
			i18n = var_2_10003
			var_57_2.content = var_2_10003("use_oil_limit_help", var_51_30, var_51_28)
