...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_2 = var_2.Find(var_1_1, "AD/signIn")
	local var_1_3 = arg_1_0._tf

	arg_1_0.signInUIlist = var_1_0(var_1_2, var_3.Find(var_1_3, "AD/signIn/award"))
...
function var_0_1.OnFirstFlush(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_1(var_3_0, var_2_10002("common_activity_end"))
...
function var_0_1.ClientSignInActIsEnd(arg_5_0)
	...
	local var_5_3 = var_5_1.TimeMgr.GetInstance()
...
function var_0_1.FlushSignInInfo(arg_6_0)
	...
	if arg_6_0:GetSignInAct() then
		::label_6_0::

		var_1_10003 = var_1
		var_6_0 = not var_1.isEnd(var_1_10003)
	end

	pg = var_1_10003

	local var_6_1 = var_1_10003.activity_template[arg_6_0.signInActId]
	local var_6_2 = arg_6_0:ClientSignInActIsEnd()

	if not var_6_0 and var_6_2 then
		triggerToggle = var_1_10006

		var_1_10006(arg_6_0.toggles[1], true)

		setToggleEnabled = var_1_10006

		var_1_10006(arg_6_0.toggles[2], false)
	end

	setActive = var_1_10006

	var_1_10006(arg_6_0.lockSignBtn, var_5)

	local var_6_3 = var_6_1.config_id

	pg = var_7

	local var_6_4 = var_7.activity_7_day_sign[var_6_3].front_drops
	local var_6_5 = arg_6_0.signInUIlist

	var_8.make(var_6_5, function(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_6_6 = arg_6_0.signInUIlist

	var_8.align(var_6_6, #var_6_4)
