...
function var_0_1.init(arg_2_0)
	...
	findTF = var_3
	arg_2_0.historyPage = var_2_5(var_3(var_2_0, "pages/historyPage"), arg_2_0)
	...
	local var_2_10 = var_4(arg_2_0.submitPanel, "btnComfirm/text")

	i18n = var_5

	var_3(var_2_10, var_5(var_0_1.ryza_task_confirm))
	...
	var_3(var_2_11, var_5(var_0_1.ryza_task_cancel))
	...
	var_3(var_2_12, var_5(var_0_1.sub_item_warning))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_5(arg_5_0)
		...
		var_1(var_2(arg_3_0.btnBuild, "bg_selected"), arg_5_0)
	...
	local function var_3_8(arg_6_0)
		...
		var_1(var_2(arg_3_0.btnTask, "bg_selected"), arg_6_0)
	...
	local function var_3_11(arg_7_0)
		...
		var_1(var_2(arg_3_0.btnHistory, "bg_selected"), arg_7_0)
	...
	local function var_3_14()
		...
		IslandTaskMediator = var_2_10002

		var_8_1(var_8_0, var_2_10002.SUBMIT_TASK, {
...
function var_0_1.clearTagBtn(arg_11_0)
	...
	var_1_10001(var_1_10002(arg_11_0.btnBuild, "bg"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_11_0.btnBuild, "bg_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_11_0.btnTask, "bg"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_11_0.btnTask, "bg_selected"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_11_0.btnHistory, "bg"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_11_0.btnHistory, "bg_selected"), false)
...
function var_0_1.openSubmitPanel(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_1_10002(arg_13_1.getConfig(var_13_0, "target_id_2"))

	pg = var_3

	local var_13_2 = var_3.activity_ryza_item[var_13_1].name

	updateDrop = var_13_0

	local var_13_3 = arg_13_0.subimtItem
	local var_13_4 = {}

	DROP_TYPE_RYZA_DROP = var_1_10007
	var_13_4.type = var_1_10007
	tonumber = var_1_10007
	var_13_4.id = var_1_10007(var_13_1)
	var_13_4.count = arg_13_1:getConfig("target_num")

	var_13_0(var_13_3, var_13_4)

	setText = var_13_0

	var_13_0(arg_13_0.submitItemDesc, var_13_2)
