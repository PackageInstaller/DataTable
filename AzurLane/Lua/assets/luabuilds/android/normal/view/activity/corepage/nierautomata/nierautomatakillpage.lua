...
function var_0_1.LocalInit(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10003("nier_core_award_check"))
	...
	var_1_10001(var_3_1, var_3("nier_core_task_desc"))
...
function var_0_1.InitBtn(arg_5_0)
	...
	local function var_5_2()
		...
		var_6_3.unlockStamps = var_5.GetDayUnlockStamps(var_6_4)

		var_6_1(var_6_0, var_6_2, var_2_10003, var_6_3)
	...
	local function var_5_5()
		...
		var_7_1(var_7_0, var_2_10002.GO_Activity_level)
	...
	local function var_5_8()
		...
		local var_8_6, var_8_7 = var_2_10006.StaticJudgeOverflow(var_8_4.gold, var_8_4.oil, var_2_10005, true, true, {
			{
				var_8_2.type,
				var_8_2.id,
				var_8_2.count
...
function var_0_1.InvalidateWriter(arg_12_0)
	...
	if arg_12_0.desc1 then
		...
		var_1(var_12_1, var_1_10003(var_1_10004)).endFunc = nil
	end
	...
	if arg_12_0.desc2 then
		...
		typeof = var_1_10003
		Typewriter = var_1_10004
		var_1(var_12_2, var_1_10003(var_1_10004)).endFunc = nil
	end
...
function var_0_1.Playwriter(arg_13_0)
	...
	if not arg_13_0.finishAll then
		...
		var_13_4.insert(var_13_2, function(arg_15_0)
			...
			local var_15_1 = var_2_10002(var_15_0, var_2_10004(var_2_10005))
			...
			var_15_3(var_15_2, var_5.GetTypewriterSpeed(var_15_4))
			var_15_1:Play()
		...
		var_1_10007.insert(var_13_2, function(arg_17_0)
			...
			if var_17_0(var_17_1, {
				...
				local var_17_2 = var_3.NewStoryMgr.GetInstance()
	...
	var_13_4.insert(var_13_2, function(arg_19_0)
		...
		local var_19_2 = var_2_10002(var_19_1, var_4(var_2_10005))
		...
		var_19_4(var_19_3, var_5.GetTypewriterSpeed(var_19_5))
		var_19_2:Play()
...
function var_0_1.OnUpdateFlush(arg_22_0)
	...
	var_1_10005(var_22_6, var_1_10007.format("%s", var_22_3))
	...
	var_1_10005(var_22_7, var_7.format("/%s", var_22_4))
	arg_22_0:LocalFresh()
	...
	local var_22_13 = var_1_10010.format
	...
	if 1 <= var_22_11 then
		...
		if not var_12(var_22_15, var_1_10014) then
			var_22_16 = var_22_9
		end
		...
		var_22_21(arg_22_0.battleBtn, var_22_22 and not var_22_18 and var_22_20)

		setActive = var_22_21

		var_22_21(arg_22_0.getBtn, var_22_18)

		setActive = var_22_21

		var_22_21(arg_22_0.gotBtn, not var_22_20)

		local var_22_23 = arg_22_0.ptData
		local var_22_24 = var_11.GetAward(var_22_23)

		updateDrop = var_22_23

		var_22_23(arg_22_0.awardTF, var_22_24)
		...
		local function var_22_27()
			...
			var_23_1(var_23_0, var_2_10002.ON_DROP, var_22_24)
		...
		var_22_23(var_22_25, var_22_26, var_22_27, var_1_10016)
...
function var_0_1.GetWorldPtData(arg_25_0, arg_25_1)
	...
	ActivityMainScene = var_25_0

	local var_25_2

	if not var_25_0.Data2Time then
		var_25_2 = 0
	end
	...
	if arg_25_1 <= var_25_1 - var_25_2 then
		...
		var_25_7.activity_id = var_6.GetId(var_25_8)
...
function var_0_1.Hx4Channel(arg_27_0)
	...
	if not var_2(var_27_0) then
		...
		var_2(var_27_1, var_1_10004.isHx())
	end
