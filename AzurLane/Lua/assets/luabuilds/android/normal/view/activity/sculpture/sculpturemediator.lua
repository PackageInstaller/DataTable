...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_FINSIH_SCULPTURE, function(arg_2_0, arg_2_1)
		...
		local var_2_2 = var_2_10004.SCULPTURE_ACT_OP
		local var_2_3 = {
			id = arg_2_1
		}

		SculptureActivity = var_2_10006
		var_2_3.state = var_2_10006.STATE_FINSIH
	...
	arg_1_0:bind(var_0_1.ON_JOINT_SCULPTURE, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10004.SCULPTURE_ACT_OP
		local var_3_3 = {
			id = arg_3_1
		}

		SculptureActivity = var_2_10006
		var_3_3.state = var_2_10006.STATE_JOINT
	...
	arg_1_0:bind(var_0_1.ON_UNLOCK_SCULPTURE, function(arg_4_0, arg_4_1)
		...
		local var_4_2 = var_2_10004.SCULPTURE_ACT_OP
		local var_4_3 = {
			id = arg_4_1
		}

		SculptureActivity = var_2_10006
		var_4_3.state = var_2_10006.STATE_UNLOCK
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_DRAW_SCULPTURE, function(arg_5_0, arg_5_1)
		...
		local var_5_2 = var_2_10004.SCULPTURE_ACT_OP
		local var_5_3 = {
			id = arg_5_1
		}

		SculptureActivity = var_2_10006
		var_5_3.state = var_2_10006.STATE_DRAW
	...
	local var_1_3 = var_1_2(var_1_1, var_3.ACTIVITY_TYPE_SCULPTURE)
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_7_1.SCULPTURE_ACT_OP_DONE then
		...
		if #var_7_2.awards > 0 then
			...
			var_7_5(var_7_4, var_6.ON_ACHIEVE, var_7_2.awards)
		end
	end
