...
function var_0_1.OnUpdateFlush(arg_1_0)
	...
	if arg_1_0.step then
		...
		var_6(var_1_9, var_1_10008(var_1_6, var_0_2) .. "/" .. var_1_7)
	end
	...
	if 1 <= var_1_13 then
		...
		if not var_8(var_1_11, var_0_2) then
			var_1_15 = var_1_11
		end
		...
		var_1_20(arg_1_0.battleBtn, var_1_21 and not var_1_17 and var_1_19)

		setActive = var_1_20

		var_1_20(arg_1_0.getBtn, var_1_17)

		setActive = var_1_20

		var_1_20(arg_1_0.gotBtn, not var_1_19)
		...
		var_1_22(arg_1_0.awardTF, var_1_23)
		...
		local function var_1_26()
			...
			var_2_1(var_2_0, var_2_10002.ON_DROP, var_1_23)
