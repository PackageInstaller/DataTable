...
function var_0_1.init(arg_6_0)
	...
	local var_6_3 = var_3.Find(var_6_2, "confirmBtn/Text")

	i18n = var_6_2

	var_2(var_6_3, var_6_2("text_confirm"))

	setText = var_2

	local var_6_4 = arg_6_0.resultList
	local var_6_5 = var_3.Find(var_6_4, "Result/BG/Ships/resulttpl/result/Statistics/kill_count_label")

	i18n = var_6_4

	var_2(var_6_5, var_6_4("battle_result_kill_count"))

	setText = var_2

	local var_6_6 = arg_6_0.resultList
	local var_6_7 = var_3.Find(var_6_6, "Result/BG/Ships/resulttpl/result/Statistics/dmg_count_label")

	i18n = var_6_6

	var_2(var_6_7, var_6_6("battle_result_dmg"))

	setText = var_2

	local var_6_8 = arg_6_0.resultList
	local var_6_9 = var_3.Find(var_6_8, "Result/BG/commanderExp/commander_container")
	local var_6_10 = var_3.GetChild(var_6_9, 0)
	local var_6_11 = var_3.Find(var_6_10, "empty/add/Text")

	i18n = var_6_10

	var_2(var_6_11, var_6_10("series_enemy_empty_commander_main"))

	setText = var_2

	local var_6_12 = arg_6_0.resultList
	local var_6_13 = var_3.Find(var_6_12, "Result/BG/commanderExp/commander_container")
	local var_6_14 = var_3.GetChild(var_6_13, 1)
	local var_6_15 = var_3.Find(var_6_14, "empty/add/Text")

	i18n = var_6_14

	var_2(var_6_15, var_6_14("series_enemy_empty_commander_assistant"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local var_7_9 = var_7_8(var_7_7, var_1_10011.Submarine)
	...
	for iter_7_0 = 1, #var_7_3 do
		...
		var_21.Foreach(var_7_13:getShipIds(), function(arg_8_0, arg_8_1)
			local var_8_0
			...
			if iter_7_0 <= #var_7_2 then
				...
				local var_8_1 = var_2(var_8_0)
				local var_8_2 = var_2.getShipById(var_8_1, arg_8_1)

				table = var_8_1

				var_8_1.insert(var_7_15.ships, var_8_2)
		...
		var_21.Foreach(var_7_9, function(arg_9_0, arg_9_1)
		...
		local var_7_19 = var_7_13.GetRawCommanderIds(var_7_18)
		...
		var_7_18.each({
			...
			if var_10_0 then
				...
				if iter_7_0 <= #var_7_2 then
					...
					CommanderProxy = var_10_1

					local var_10_2 = var_2_10002(var_10_1)

					var_2_10002 = var_2_10002.getCommanderById(var_10_2, var_10_0)
					table = var_10_2

					var_10_2.insert(var_7_15.cmds, var_2_10002)
	...
	local function var_7_22(arg_12_0, arg_12_1, arg_12_2)
		...
		var_2_10003.StaticAlign(arg_12_0, arg_12_0:GetChild(0), 2, function(arg_13_0, arg_13_1, arg_13_2)
			...
			var_13_4(arg_13_2:Find("exp/exp_text"), "+" .. var_13_6)
			...
			typeof = var_11
			Image = var_12
			var_13_10(var_13_9, var_11(var_12)).fillAmount = var_13_8
	...
	local function var_7_23(arg_14_0, arg_14_1, arg_14_2)
	...
	local function var_7_24(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
		...
		var_2_10004.StaticAlign(arg_15_0, arg_15_0:GetChild(0), #arg_15_1, function(arg_16_0, arg_16_1, arg_16_2)
			...
			var_7_23(arg_16_2, var_16_0.id, arg_15_3)

			local var_16_2 = arg_16_2:Find("result/mask/icon")
			local var_16_3 = arg_16_2
			local var_16_4 = arg_16_2.Find(var_16_3, "result/type")

			GetSpriteFromAtlas = var_16_3

			local var_16_5 = "shiptype"

			shipType2print = var_3_10009

			local var_16_6 = var_16_3(var_16_5, var_3_10009(var_16_1:getShipType()))

			setImageSprite = var_16_5

			var_16_5(var_16_4, var_16_6, true)
			...
			var_16_5(var_16_7, var_10("herohrzicon/" .. var_16_1:getPainting()))

			findTF = var_16_5

			local var_16_8 = var_16_5(arg_16_2, "result/stars")

			findTF = var_9

			local var_16_9 = var_9(arg_16_2, "result/stars/star_tpl")
			local var_16_10 = var_16_1:getStar()
			local var_16_11 = var_16_1
			local var_16_12 = var_16_1.getMaxStar(var_16_11)

			UIItemList = var_16_11

			var_16_11.StaticAlign(var_16_8, var_16_9, var_16_12, function(arg_17_0, arg_17_1, arg_17_2)
				...
				local var_17_0 = var_16_12 - arg_17_1

				SetActive = var_4_10004

				var_4_10004(arg_17_2:Find("empty"), var_17_0 > var_16_10)

				SetActive = var_4_10004

				var_4_10004(arg_17_2:Find("star"), var_17_0 <= var_16_10)
			...
			local var_16_13 = arg_16_2:Find("result/Exp/exp_text")
			local var_16_14 = var_16_1:getConfig("rarity")
			local var_16_15
			...
			if var_16_1.level < var_16_0.level then
				...
				for iter_16_0 = var_16_1.level, var_16_0.level - 1 do
					...
					var_16_15 = var_16_15 + var_3_10019(var_16_14, iter_16_0)
				end

				setText = var_15

				local var_16_16 = var_16_13
				local var_16_17 = "+"

				var_3_10019 = var_16_0

				var_15(var_16_16, var_16_17 .. var_16_15 + var_16_0.getExp(var_3_10019) - var_16_1:getExp())
			else
				setText = var_16_15

				local var_16_18 = var_16_13
				local var_16_19 = "+"
				local var_16_20
				...
				var_16_15(var_16_18, var_16_19 .. var_16_20)
			end

			local var_16_21 = arg_16_2:Find("result/Progress/progress_bar")
			local var_16_22 = var_16_0
			local var_16_23 = var_16_0.getExp(var_16_22)

			getExpByRarityFromLv1 = var_16_22

			local var_16_24 = var_16_23 / var_16_22(var_16_14, var_16_0.level)
			local var_16_25 = var_16_21
			local var_16_26 = var_16_21.GetComponent

			typeof = var_18
			Image = var_3_10019
			var_16_26(var_16_25, var_18(var_3_10019)).fillAmount = var_16_24
	...
	local function var_7_25(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
		...
		var_2_10006.StaticAlign(arg_18_0, arg_18_0:GetChild(0), #arg_18_1, function(arg_19_0, arg_19_1, arg_19_2)
			...
			var_7_23(arg_19_2, var_19_0.id, arg_18_3)

			local var_19_2 = arg_19_2:Find("result/mask/icon")
			local var_19_3 = arg_19_2
			local var_19_4 = arg_19_2.Find(var_19_3, "result/type")

			GetSpriteFromAtlas = var_19_3

			local var_19_5 = "shiptype"

			shipType2print = var_3_10009

			local var_19_6 = var_19_3(var_19_5, var_3_10009(var_19_1:getShipType()))

			setImageSprite = var_19_5

			var_19_5(var_19_4, var_19_6, true)

			setImageSprite = var_19_5

			local var_19_7 = var_19_2

			LoadSprite = var_10

			var_19_5(var_19_7, var_10("herohrzicon/" .. var_19_1:getPainting()))

			findTF = var_19_5

			local var_19_8 = var_19_5(arg_19_2, "result/stars")

			findTF = var_9

			local var_19_9 = var_9(arg_19_2, "result/stars/star_tpl")
			local var_19_10 = var_19_1:getStar()
			local var_19_11 = var_19_1
			local var_19_12 = var_19_1.getMaxStar(var_19_11)

			UIItemList = var_19_11

			var_19_11.StaticAlign(var_19_8, var_19_9, var_19_12, function(arg_20_0, arg_20_1, arg_20_2)
				UIItemList = var_4_10003
				...
				local var_20_0 = var_19_12 - arg_20_1

				SetActive = var_4_10004

				var_4_10004(arg_20_2:Find("empty"), var_20_0 > var_19_10)

				SetActive = var_4_10004

				var_4_10004(arg_20_2:Find("star"), var_20_0 <= var_19_10)
			...
			local var_19_16 = arg_19_2.Find(var_19_15, "result/Statistics/atk")

			setText = var_19_15

			var_19_15(var_19_16, 0)

			setText = var_19_15

			var_19_15(var_19_16, var_19_13)

			local var_19_17 = arg_19_2
			local var_19_18 = arg_19_2.Find(var_19_17, "result/Statistics/killCount")

			setText = var_19_17

			var_19_17(var_19_18, 0)

			setText = var_19_17

			var_19_17(var_19_18, var_19_14)
			...
			typeof = var_3_10019
			Image = var_3_10020
			var_19_20(var_19_19, var_3_10019(var_3_10020)).fillAmount = 0

			local var_19_21 = var_19_13 / var_18_0
			local var_19_22 = var_16
			local var_19_23 = var_16.GetComponent

			typeof = var_3_10020
			Image = var_3_10021
			var_19_23(var_19_22, var_3_10020(var_3_10021)).fillAmount = var_19_21
	...
	local function var_7_26(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
		...
		var_21_14(var_21_13, var_16.GetAtalsName(var_21_15), var_21_12, arg_21_0:Find("Title"))

		local var_21_16 = var_0_3[var_21_10]

		setImageColor = var_21_13

		local var_21_17 = arg_21_0
		local var_21_18 = arg_21_0.Find(var_21_17, "BG")

		SummerFeastScene = var_21_17

		var_21_13(var_21_18, var_21_17.TransformColor(var_21_16))

		pg = var_21_13

		local var_21_19 = var_21_13.expedition_data_template[var_7_3[arg_21_3]]

		setText = var_16

		var_16(arg_21_0:Find("Title/Name"), var_21_19.name)

		setText = var_16

		local var_21_20 = arg_21_0
		local var_21_21 = arg_21_0.Find(var_21_20, "BG/FleetName/Text")

		i18n = var_21_20

		local var_21_22 = "series_enemy_fleet_prefix"

		GetRomanDigit = var_20

		var_16(var_21_21, var_21_20(var_21_22, var_20(arg_21_1.index)))
		var_7_22(arg_21_0:Find("BG/commanderExp/commander_container"), arg_21_1.oldCmds, arg_21_1.cmds)
	...
	local function var_7_27()
		...
		if not (var_7_21 == 1) or not var_7_12 then
			var_24_0 = var_7_11
		end
		...
		var_24_1(var_24_2, var_4.GetChild(var_24_3, 0), #var_24_0, function(arg_25_0, arg_25_1, arg_25_2)
			UIItemList = var_3_10003
			...
			var_7_26(arg_25_2, var_25_0, var_25_1, var_25_0.index)
			var_7_24(arg_25_2:Find("BG/Ships"), var_25_0.ships, var_25_0.oldShips, var_25_0.mvp)
	...
	local function var_7_28()
		...
		var_26_1(var_26_2, var_4.GetChild(var_26_3, 0), #var_26_0, function(arg_27_0, arg_27_1, arg_27_2)
			UIItemList = var_3_10003
			...
			var_7_26(arg_27_2, var_27_0, var_27_1, var_27_0.index)
			var_7_25(arg_27_2:Find("BG/Ships"), var_27_0.ships, var_27_0.oldShips, var_27_0.mvp, var_27_1)
	...
	local var_7_30 = var_22.Find(var_7_29, "submarine")
	local var_7_31 = arg_7_0.rightBottomPanel
	local var_7_32 = var_23.Find(var_7_31, "main")

	setActive = var_7_31

	var_7_31(var_7_30, #var_7_12 > 0)
	;(function()
		setActive = var_2_10000

		var_2_10000(var_7_32, var_7_21 == 1)

		setActive = var_2_10000

		var_2_10000(var_7_30, var_7_21 == 0 and #var_7_12 > 0)

		if var_7_20 == 0 then
			var_7_27()
		elseif var_7_20 == 1 then
			var_7_28()
		end
	...
	;(function()
		...
		local var_29_2 = var_29_0.reduce(var_7_2, 0, function(arg_30_0, arg_30_1)
		...
		var_2(var_3.Find(var_29_3, "main/Series/playerExp/name_text"), var_29_1.name)

		setText = var_2

		local var_29_4 = arg_7_0._tf

		var_2(var_3.Find(var_29_4, "main/Series/playerExp/lv_text"), "Lv." .. var_29_1.level)

		setText = var_2

		local var_29_5 = arg_7_0._tf

		var_2(var_3.Find(var_29_5, "main/Series/playerExp/exp_text"), "+" .. var_29_2)

		local var_29_6 = arg_7_0._tf
		local var_29_7 = var_2.Find(var_29_6, "main/Series/playerExp/exp_progress")

		getConfigFromLevel1 = var_29_6
		pg = var_4

		local var_29_8 = var_29_6(var_4.user_level, var_29_1.level)
		local var_29_9 = var_29_7
		local var_29_10 = var_29_7.GetComponent

		typeof = var_2_10006
		Image = var_2_10007
		var_29_10(var_29_9, var_2_10006(var_2_10007)).fillAmount = var_29_1.exp / var_29_8.exp_interval
	...
	local var_7_34 = arg_7_0.rightBottomPanel
	local var_7_35 = var_28.Find(var_7_34, "statisticsBtn")
	...
	var_26(var_7_33, var_7_35, var_7_36, var_30)

	onButton = var_26

	local var_7_37 = arg_7_0
	local var_7_38 = var_7_30
	...
	var_26(var_7_37, var_7_38, var_7_39, var_30)

	onButton = var_26

	local var_7_40 = arg_7_0
	local var_7_41 = var_7_32
	...
	var_26(var_7_40, var_7_41, var_7_42, var_30)

	onButton = var_26

	local var_7_43 = arg_7_0
	local var_7_44 = arg_7_0.rightBottomPanel
	local var_7_45 = var_28.Find(var_7_44, "confirmBtn")
	...
	local function var_7_46()
		...
		var_34_1(var_34_0, var_2_10002.ON_SETTLE)
	...
	var_26(var_7_43, var_7_45, var_7_46, var_30)

	local var_7_47 = arg_7_0._tf
	local var_7_48 = var_26.Find(var_7_47, "main/Series/ArrowLeft")
	local var_7_49 = arg_7_0._tf
	local var_7_50 = var_27.Find(var_7_49, "main/Series/ArrowRight")

	Canvas = var_7_49

	var_7_49.ForceUpdateCanvases()
	...
	if arg_7_0.resultScroll.rect.width >= arg_7_0.resultList.rect.width then
		...
		var_30(arg_7_0, arg_7_0.resultScroll, function(arg_35_0)
			...
			var_2_10001(var_7_48, arg_35_0.x > 0.01)

			setActive = var_2_10001

			var_2_10001(var_7_50, arg_35_0.x < 0.99)
...
function var_0_1.HideConfirmPanel(arg_36_0)
	...
	var_1_10001(var_2.Find(var_36_0, "confirmBtn"), false)
...
function var_0_1.onBackPressed(arg_37_0)
	...
	var_1_10001(var_2.Find(var_37_0, "confirmBtn"))
