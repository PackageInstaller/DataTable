...
local var_0_1 = var_1("AuctionGameEntranceMediator", var_0_0)
...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.CLICK_PREORDER_BOX, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.AUCTION_GAME_PREORDER_BOX)
	...
	arg_1_0:bind(var_0_1.CLICK_OPEN_BOX, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.AUCTION_GAME_OPEN_BOX)
	...
	arg_1_0:bind(var_0_1.SHOW_WARNING_TIP, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.AUCTION_GAME_SHOW_MATCH_WARNING_TIP)
	...
	arg_1_0:bind(var_0_1.CLICK_GET_RELIEF, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.AUCTION_GAME_GET_RELIEF)
...
function var_0_1.initNotificationHandleDic(arg_6_0)
	...
	var_6_0[var_1_10002.AUCTION_GAME_PREORDER_BOX_DONE] = function(arg_7_0, arg_7_1)
		...
		local var_7_2 = var_2_10004.BuildPreorder
		local var_7_3 = 0

		AuctionGameTools = var_2_10006

		var_7_1(var_7_0, var_7_2(var_7_3, var_2_10006.GetPreorderCurrentyCnt()))
	...
	var_6_0[var_2.AUCTION_GAME_OPEN_BOX_DONE] = function(arg_8_0, arg_8_1)
		...
		local var_8_3 = var_5.GO_SCENE

		SCENE = var_2_10006

		var_8_2(var_8_1, var_8_3, var_2_10006.AUCTION_GAME_PREORDER_BOX_SETTLEMENT)
	...
	var_6_0[var_2.ADD_ITEM] = function(arg_9_0, arg_9_1)
		...
		AuctionGamePlayerPanel = var_2_10004

		var_9_3(var_9_2, var_2_10004.REFRESH_CURRENCY)
	...
	var_6_0[var_2.AUCTION_GAME_GET_RELIEF_DONE] = function(arg_12_0, arg_12_1)
		if #arg_12_1:getBody() > 0 then
			...
			var_12_1(var_12_0, var_2_10005.ON_ACHIEVE, var_2)
		end
	...
	var_6_0[var_2.ON_RECONNECTION] = function(arg_14_0, arg_14_1)
		...
		var_2_10003.insert(var_14_0, function(arg_15_0)
			...
			var_15_2(var_15_1, var_3.AUCTION_GAME_INIT, {
				callback = arg_15_0
			})
		...
		var_3(var_14_0, function()
			...
			if var_0.IsQuickMatch(var_16_0) then
				...
				var_16_2(var_16_1, var_3_10002.AUCTION_GAME_MATCHING_RECONNECT, {})
			end
