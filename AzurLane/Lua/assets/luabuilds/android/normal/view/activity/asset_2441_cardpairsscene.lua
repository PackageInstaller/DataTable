...
function var_0_1.setActivityData(arg_3_0, arg_3_1)
	...
	if not arg_3_0.config_init then
		...
		if var_2.getConfig(var_3_0, "config_client")[2] then
			...
			arg_3_0.cardEffectTimesMax = var_3_0.getConfig(var_3_1, "config_data")[4]
		else
		...
		CardPairsCard = var_3_0
		var_3_0.ANI_TIME = arg_3_0.aniTime
...
function var_0_1.init(arg_5_0)
	...
	var_5_11(var_5_10, var_3.Find(var_5_12, "res"))
...
function var_0_1.didEnter(arg_6_0)
	...
	local function var_6_5()
		...
		i18n = var_2_10003
		var_8_2.helps = var_2_10003("card_pairs_help_tip")
	...
	local function var_6_8()
		if arg_6_0.lastTimes > 0 then
			...
			i18n = var_2_10003
			var_9_3.content = var_2_10003("card_pairs_tips")
	...
	var_1.make(var_6_10, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			if arg_6_0.cardList[arg_12_1 + 1] ~= nil then
				...
				CardPairsCard = var_2_10007

				var_12_0(var_12_1, var_12_2, var_2_10007.New(arg_12_2, arg_6_0.pics, arg_6_0.cardIndexList[arg_12_1 + 1][1], function(arg_13_0)
					if arg_6_0.gameState == arg_6_0.GAME_STATE_GAMING then
						if arg_6_0.isFrist then
							...
							var_13_1.countTimer = var_2.New(function()
								...
								local var_14_1 = var_14_0((var_4_10001.realtimeSinceStartup - arg_6_0.beginTime) * 1000)
						...
						if arg_13_0.canClick and arg_13_0.enable and #arg_6_0.showCards < 2 then
							...
							CardPairsCard = var_3_10004

							var_13_4(var_13_3, var_13_5 == var_3_10004.CARD_STATE_BACK)
						end
					end
					...
					if arg_6_0.gameState == arg_6_0.GAME_STATE_GAMING then
						...
						if arg_16_1 then
							...
							if #arg_6_0.showingCards % 2 == 0 then
								...
								var_3_10006.remove(arg_6_0.showingCards, var_16_0)
...
function var_0_1.updateTimes(arg_20_0)
	...
	local var_20_1 = var_1_10002.TimeMgr.GetInstance()
	local var_20_2 = var_20_0(var_2.GetServerTime(var_20_1), arg_20_0.activityData.data3)

	math = var_2

	local var_20_3 = var_2.ceil(var_20_2 / 0) < 0 and 0 or var_20_3
...
function var_0_1.gameInit(arg_21_0)
	...
	for iter_21_0 = 1, arg_21_0.CARD_NUM / 2 do
		...
		math = var_1_10009
		var_21_2[2] = var_1_10009.random(0, 100)
		...
		math = var_1_10009
		var_21_5[2] = var_1_10009.random(0, 100)
...
function var_0_1.gameEndHandler(arg_24_0)
	...
	local var_24_1 = var_24_0((var_2.realtimeSinceStartup - arg_24_0.beginTime) * 1000) < 0 and 9 * arg_24_0.aniTime or var_24_1
	...
	if arg_24_0.lastTimes > 0 or var_24_1 < arg_24_0.activityData.data4 then
		...
		CardPairsMediator = var_1_10005

		var_24_4(var_24_3, var_1_10005.EVENT_OPERATION, {
			cmd = 1,
...
function var_0_1.hideChild(arg_30_0, arg_30_1)
	...
	for iter_30_0 = 0, var_30_0 - 1 do
		...
		local var_30_2 = arg_30_1.GetChild(var_30_1, iter_30_0)

		setActive = var_30_1

		var_30_1(var_30_2, false)
	end
...
function var_0_1.tryFirstPlayStory(arg_31_0)
	...
	if var_1.getConfig(var_31_0, "config_client")[1] then
		...
		if var_1.getConfig(var_31_1, "config_client")[1][1] ~= nil then
			...
			local var_31_2 = var_31_1.NewStoryMgr.GetInstance()
