...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_LAUNCH, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
		...
		var_2_2(var_2_1, var_2_10008.ACTIVITY_OPERATION, {
			cmd = 1,
			activity_id = arg_2_1,
			arg1 = arg_2_3,
			arg2 = arg_2_2,
	...
	arg_1_0:bind(var_0_1.ON_SWITCH, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_2(var_3_1, var_2_10006.ACTIVITY_OPERATION, {
			cmd = 2,
			arg2 = 0,
			activity_id = arg_3_1,
			arg1 = arg_3_2
	...
	local var_1_3 = var_1_0.getActivityById(var_1_2, var_1_1)

	getProxy = var_1_2
	PlayerProxy = var_5

	local var_1_4 = var_1_2(var_5)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.ACTIVITY_UPDATED then
		...
		if var_5_4 == var_5_3.ACTIVITY_TYPE_LOTTERY then
			local var_5_5 = arg_5_0.viewComponent

			var_5_4.onActivityUpdated(var_5_5, var_5_2)
		end
	else
		PlayerProxy = var_5_4
		...
		if var_5_0 == var_5_4.UPDATED then
			...
			var_4.setPlayerVO(var_5_6, var_5_2)
		else
			ActivityProxy = var_4

			if var_5_0 == var_4.ACTIVITY_LOTTERY_SHOW_AWARDS then
				local var_5_7 = arg_5_0.viewComponent
				local var_5_8 = var_4.emit

				BaseUI = var_1_10006

				var_5_8(var_5_7, var_1_10006.ON_ACHIEVE, var_5_2.awards, var_5_2.callback)
			end
		end
	end
