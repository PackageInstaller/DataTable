	...
	var_2.make(var_2_6, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			elseif not arg_2_0.pageDic[var_3.id] then
				...
				local var_3_0 = arg_3_2:Find("off/name")
				local var_3_1 = arg_2_0

				var_4(var_3_0, var_6.GetButtonNameText(var_3_1, var_3))
				...
				var_4(var_3_2, var_6.GetButtonNameText(var_3_3, var_3))

				if arg_2_0.pageDic[var_3.id] ~= nil then
					local var_3_4 = arg_2_0.pageDic[var_3.id]
					local var_3_5 = arg_3_2:Find("tip")
					local var_3_6 = var_3_4
					local var_3_7 = var_3_4.IsShowReminder(var_3_6)

					setActive = var_3_6

					var_3_6(var_3_5, var_3:readyToAchieve())
					...
					local function var_3_10(arg_5_0)
						if arg_5_0 then
					...
					var_3_6(var_3_8, var_3_9, var_3_10, var_2_10012)
				end
			end
		end
...
function var_0_1.GetActivityClassName(arg_7_0, arg_7_1)
	...
	local var_7_1 = arg_7_1.getConfig(var_7_0, "page_info")

	type = var_7_0

	if var_7_0(var_7_1) == "table" then
		return var_7_1.class_name
	end
...
function var_0_1.GetButtonNameText(arg_8_0, arg_8_1)
	...
	return var_1_10002(var_1_10003.format(arg_8_1:getConfig("title_res_tag")))
end
