...
function var_0_0.bindBattleEvents(arg_6_0)
	...
	local var_6_6 = var_6_5(var_1_10006)
	...
	var_6.bind(var_6_10, arg_6_0._target_.GO_SCENE, function(arg_7_0, arg_7_1, ...)
		...
		var_7_1(var_7_0, var_2_10004.GO_SCENE, arg_7_1, ...)
	...
	var_6_13(var_6_12, var_8.EVENT_PT_OPERATION, function(arg_9_0, arg_9_1)
		local var_9_0 = arg_6_0._target_
		local var_9_1 = var_2.sendNotification

		GAME = var_2_10004

		var_9_1(var_9_0, var_2_10004.ACT_NEW_PT, arg_9_1)
	...
	var_6.bind(var_6_14, arg_6_0._target_.ON_PRECOMBAT, function(arg_10_0, arg_10_1)
		...
		if not var_2.getActivityFleets(var_10_0)[arg_6_0._target_.contextData.activityID] then
			...
			var_10_2(var_10_1, var_2_10005("elite_disable_no_fleet"))
		...
		if var_3.isLegalToFight(var_10_4) ~= true then
			...
			var_10_6(var_10_5, var_2_10005("elite_disable_formation_unsatisfied"))
		...
		if var_2_10005.any(var_10_8, function(arg_11_0)
			local var_11_0, var_11_1 = arg_11_0:HaveShipsInEvent()

			if var_11_0 then
				pg = var_3_10003

				local var_11_2 = var_3_10003.TipsMgr.GetInstance()

				var_3_10003.ShowTips(var_11_2, var_11_1)
			...
			return var_3_10003.any(arg_11_0:getShipIds(), function(arg_12_0)
				...
				local var_12_1, var_12_2 = var_12_0.ShipStatusCheck("inActivity", var_1, nil, {
					inActivity = var_10_9
				})
		...
		local var_10_17 = var_2_10010.GO_SCENE

		SCENE = var_2_10011

		var_10_16(var_10_15, var_10_17, var_2_10011.BOSS_SINGLE_PRECOMBAT, {
			system = var_10_12,
			stageId = var_10_13,
	...
	var_6.bind(var_6_18, arg_6_0._target_.ON_OPEN_DOCK, function(arg_16_0, arg_16_1)
		...
		local var_16_10 = var_2_10012.GO_SCENE

		SCENE = var_2_10013

		local var_16_11 = var_2_10013.DOCKYARD
		local var_16_12 = {
			selectedMin = 0,
			useBlackBlock = true,
			selectedMax = 1
		...
		i18n = var_2_10015
		var_16_12.leastLimitMsg = var_2_10015("ship_formationMediator_leastLimit")
		var_16_12.quitTeam = var_16_1 ~= nil
		var_16_12.teamFilter = var_16_3
		i18n = var_15
		var_16_12.leftTopInfo = var_15("word_formation")
		...
		var_16_14.__index = var_2_10018.TAG_HIDE_ACTIVITY_BOSS
		var_16_12.hideTagFlags = var_15(var_16_13, var_16_14)
		var_16_12.otherSelectedIds = var_16_2
		pg = var_15

		local var_16_15 = var_15.ShipFlagMgr.GetInstance()

		var_16_12.ignoredIds = var_15.FilterShips(var_16_15, {
			isActivityNpc = true
		})
	...
	var_6.bind(var_6_19, arg_6_0._target_.ON_FLEET_SHIPINFO, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_17_2, var_2_10005.SHIPINFO, {
	...
	var_6.bind(var_6_20, arg_6_0._target_.COMMANDER_FORMATION_OP, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10004.COMMANDER_FORMATION_OP, {
			data = arg_18_1
		})
	...
	var_6.bind(var_6_21, arg_6_0._target_.ON_COMMANDER_SKILL, function(arg_19_0, arg_19_1)
		...
		var_19_3.mediator = var_2_10006
		CommanderSkillLayer = var_2_10006
		var_19_3.viewComponent = var_2_10006
		var_19_3.data = {
			skill = arg_19_1
		}
	...
	var_6.bind(var_6_22, arg_6_0._target_.ON_SELECT_COMMANDER, function(arg_20_0, arg_20_1, arg_20_2)
		...
		local var_20_5 = var_2_10008.GO_SCENE

		SCENE = var_2_10009

		local var_20_6 = var_2_10009.COMMANDERCAT
		local var_20_7 = {
			maxCount = 1
		}

		CommanderCatScene = var_2_10011
		var_20_7.mode = var_2_10011.MODE_SELECT
		var_20_7.activeCommander = var_20_2[arg_20_2]
		CommanderCatScene = var_11
		var_20_7.fleetType = var_11.FLEET_TYPE_BOSSSINGLE_VARIABLE
		var_20_7.ignoredIds = {}
		...
		function var_20_7.onSelected(arg_22_0, arg_22_1)
			...
			local var_22_1 = var_3_10003(var_3_10004)
			local var_22_2 = var_3.getCommanderById(var_22_1, var_22_0)

			pairs = var_22_1

			for iter_22_0, iter_22_1 in var_22_1(var_0) do
				if iter_22_0 == arg_20_1 then
					...
					for iter_22_2, iter_22_3 in var_10(var_20_2) do
						if iter_22_3.groupId == var_22_2.groupId and iter_22_2 ~= arg_20_2 then
							...
							var_22_4(var_22_3, var_3_10017("commander_can_not_select_same_group"))

							return
						end
					end
				elseif iter_22_0 == var_0_0.GetPairedFleetIndex(arg_20_1, arg_6_0._subFleetOffset) then
					local var_22_5 = iter_22_1
					local var_22_6 = iter_22_1.getCommanders(var_22_5)

					pairs = var_22_5

					for iter_22_4, iter_22_5 in var_22_5(var_22_6) do
						if var_22_0 == iter_22_5.id then
							pg = var_16
							var_3_10017 = var_16.TipsMgr.GetInstance()

							local var_22_7 = var_16.ShowTips

							i18n = var_3_10018

							var_22_7(var_3_10017, var_3_10018("commander_is_in_fleet_already"))
			...
			local var_22_8 = var_0

			var_5.updateCommanderByPos(var_22_8, arg_20_2, var_22_2)

			local var_22_9 = var_6_1

			var_5.updateActivityFleet(var_22_9, arg_6_0._target_.contextData.activityID, arg_20_1, var_0)
			arg_22_1()
	...
	var_6_24(var_6_23, var_8.BEGIN_STAGE_PROXY, function(arg_24_0, arg_24_1)
		local var_24_0 = arg_6_0._target_
		local var_24_1 = var_2.sendNotification

		PreCombatMediator = var_2_10004

		var_24_1(var_24_0, var_2_10004.BEGIN_STAGE_PROXY, {
			curFleetId = arg_24_1
		})
	...
	var_6.bind(var_6_25, arg_6_0._target_.ON_PERFORM_COMBAT, function(arg_25_0, arg_25_1, arg_25_2)
		...
		local var_25_2 = var_2_10005.BEGIN_STAGE
		local var_25_3 = {}

		SYSTEM_PERFORM = var_2_10007
		var_25_3.system = var_2_10007
...
function var_0_0.getDockCallbackFuncs4ActicityFleet(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	local var_27_0 = var_1_10004(var_1_10005)

	getProxy = var_1_10005
	FleetProxy = var_1_10006

	local var_27_1 = var_1_10005(var_1_10006)

	getProxy = var_1_10006
	ActivityProxy = var_1_10007

	local var_27_2 = var_1_10006(var_1_10007)
