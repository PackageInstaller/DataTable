...
function var_0_1.register(arg_1_0)
	...
	local var_1_2 = var_1_1(var_1_0, var_1_10003.ACTIVITY_TYPE_ISLAND)
	...
	local var_1_6 = var_4(var_1_10005)

	var_1_5(var_1_4, var_4.GetNodeIds(var_1_6))
	...
	local var_1_9 = var_4(var_1_6)

	var_1_8(var_1_7, var_4.getData(var_1_9))
	...
	local var_1_12 = var_1_11(var_1_10, var_4.ISLAND_GAME_ID)
	...
	local var_1_17 = var_1_10006(var_1_10007)
	local var_1_18 = var_6.getActivityById

	ActivityConst = var_1_10008

	local var_1_19 = var_1_18(var_1_17, var_1_10008.ISLAND_GAME_ID)

	var_1_16.id = var_6.getConfig(var_1_19, "config_client").item_id
	getProxy = var_6
	MiniGameProxy = var_1_19

	local var_1_20 = var_6(var_1_19)

	var_1_16.count = var_6.GetHubByHubId(var_1_20, var_1_13).count
	pg = var_6

	var_1_15(var_1_14, var_1_16, var_6.mini_game_hub[var_1_13].reborn_times)
	arg_1_0:bind(var_0_1.TRIGGER_NODE_EVENT, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.ISLAND_EVENT_TRIGGER, {
			act_id = var_1_2.id,
			node_id = arg_2_1,
			op = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.OPEN_QTE_GAME, function(arg_3_0, arg_3_1, arg_3_2)
		...
		IslandQTEMiniGameMediator = var_2_10007
		var_3_3.mediator = var_2_10007
		IslandQTEMiniGameLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.OPEN_RES, function(arg_5_0, arg_5_1, arg_5_2)
		...
		SixthAnniversaryIslandItemWindowMediator = var_2_10007
		var_5_3.mediator = var_2_10007
		SixthAnniversaryIslandItemWindowLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.INTO_ENTRANCE, function(arg_6_0, arg_6_1)
		...
		var_2_10002(arg_6_1, {
			flowerfield = function()
				...
				local var_7_2 = var_3_10002.New
				local var_7_3 = {}

				IslandFlowerFieldMediator = var_3_10004
				var_7_3.mediator = var_3_10004
				IslandFlowerFieldLayer = var_3_10004
				var_7_3.viewComponent = var_3_10004
				var_7_3.data = {}
			...
			minigame1 = function()
				...
				var_8_1(var_8_0, var_3_10002.GO_MINI_GAME, 52)
			...
			minigame2 = function()
				...
				var_9_1(var_9_0, var_3_10002.GO_MINI_GAME, 53)
			...
			minigame3 = function()
				...
				var_10_1(var_10_0, var_3_10002.GO_MINI_GAME, 54)
			...
			hotspringtask = function()
				...
				local var_12_2 = var_3_10002.GO_SCENE

				SCENE = var_3_10003

				var_12_1(var_12_0, var_12_2, var_3_10003.ANNIVERSARY_ISLAND_SPRING_TASK)
			...
			hotspring = function()
				...
				local var_13_2 = var_3_10002.GO_SCENE

				SCENE = var_3_10003

				var_13_1(var_13_0, var_13_2, var_3_10003.ANNIVERSARY_ISLAND_SPRING)
	...
	arg_1_0:bind(var_0_1.MARK_NODE_AFTER_NEW, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.ISLAND_NODE_MARK, {
			act_id = var_1_2.id,
			node_id = arg_14_1
		})
	...
	arg_1_0:bind(var_0_1.GO_SHOP, function(arg_15_0)
		...
		SixthAnniversaryIslandShopMediator = var_2_10005
		var_15_3.mediator = var_2_10005
		SixthAnniversaryIslandShopLayer = var_2_10005
...
function var_0_1.initNotificationHandleDic(arg_16_0)
	...
	var_16_0[var_1_10002.ISLAND_EVENT_TRIGGER_DONE] = function(arg_17_0, arg_17_1)
		...
		if #var_17_0.awards > 0 then
			...
			var_4.insert(var_17_1, function(arg_18_0)
				...
				var_18_1(var_18_0, var_3_10003.ON_ACHIEVE, var_17_0.awards, arg_18_0)
	...
	var_16_0[var_2.ON_HUB_DATA_UPDATE] = function(arg_24_0, arg_24_1)
		...
		local var_24_1 = arg_24_1.getBody(var_24_0)

		getProxy = var_24_0
		ActivityProxy = var_2_10004

		local var_24_2 = var_24_0(var_2_10004)
		local var_24_3 = var_3.getActivityById

		ActivityConst = var_2_10005

		local var_24_4 = var_24_3(var_24_2, var_2_10005.ISLAND_GAME_ID)
		local var_24_5 = var_3.getConfig(var_24_4, "config_id")

		if var_24_1.id == var_24_5 then
			local var_24_6 = arg_24_0.viewComponent
			local var_24_7 = var_4.setResDrop
			local var_24_8 = {
				type = 2
			}
			...
			local var_24_9 = var_2_10007(var_2_10008)
			local var_24_10 = var_7.getActivityById

			ActivityConst = var_2_10009

			local var_24_11 = var_24_10(var_24_9, var_2_10009.ISLAND_GAME_ID)

			var_24_8.id = var_7.getConfig(var_24_11, "config_client").item_id
			getProxy = var_7
			MiniGameProxy = var_24_11

			local var_24_12 = var_7(var_24_11)

			var_24_8.count = var_7.GetHubByHubId(var_24_12, var_24_5).count
			pg = var_7

			var_24_7(var_24_6, var_24_8, var_7.mini_game_hub[var_24_5].reborn_times)
		end
	...
	var_16_0[var_0_1.DISPLAY_NODES] = function(arg_25_0, arg_25_1)
		if arg_25_1:getBody() and #var_2 > 0 then
			...
			if not var_25_1(var_25_0, var_25_2, var_2_10006.easeInOutSine) then
				pg = var_3
	...
	var_16_0[var_0_1.DISPLAY_SHOP] = function(arg_26_0, arg_26_1)
		...
		local var_26_2 = var_2_10004.New
		local var_26_3 = {}

		SixthAnniversaryIslandShopMediator = var_2_10006
		var_26_3.mediator = var_2_10006
		SixthAnniversaryIslandShopLayer = var_2_10006
		var_26_3.viewComponent = var_2_10006
	...
	var_16_0[var_2.ISLAND_FLOWER_GET_DONE] = function(arg_27_0, arg_27_1)
		...
		local var_27_0 = var_2_10003(var_2_10004)

		for iter_27_0, iter_27_1 in var_2_10002(var_3.GetNodeDic(var_27_0)) do
	...
	var_16_0[var_2.ACTIVITY_UPDATED] = function(arg_28_0, arg_28_1)
		local var_28_0 = arg_28_1:getBody().id

		ActivityConst = var_2_10004

		if var_28_0 == var_2_10004.ISLAND_TASK_ID then
			local var_28_1 = arg_28_0.viewComponent

			var_3.updateTaskTip(var_28_1)
		end
