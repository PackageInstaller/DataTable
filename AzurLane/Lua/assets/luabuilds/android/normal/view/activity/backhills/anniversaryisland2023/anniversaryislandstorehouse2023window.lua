...
function var_0_1.init(arg_5_0)
	...
	var_1(var_2.Find(var_5_2, "Window/ScrollView/Item"), false)
...
function var_0_1.SetActivity(arg_6_0, arg_6_1)
	...
	var_2.Foreach(arg_6_0.items, function(arg_7_0, arg_7_1)
		...
		WorkBenchItem = var_2_10004

		var_7_0(var_7_1, var_2_10004.New({
			configId = arg_7_0,
			count = arg_7_1
		}))
...
function var_0_1.didEnter(arg_9_0)
	...
	function var_9_0.onUpdateItem(arg_10_0, arg_10_1)
		...
		local function var_10_5()
			...
			var_11_1(var_11_0, var_3_10002.SHOW_DETAIL, var_10_1)
	...
	local var_9_3 = var_3.Find(var_9_2, "Window/Close")
	...
	var_9_0(var_9_1, var_9_3, var_9_4, var_5)
	...
	var_9_0(var_9_5, var_3.Find(var_9_6, "BG"), function()
...
function var_0_1.UpdateView(arg_14_0)
	...
	var_1_10002(var_3.Find(var_14_1, "Window/Empty"), #var_14_0 == 0)

	setActive = var_1_10002

	local var_14_2 = arg_14_0._tf

	var_1_10002(var_3.Find(var_14_2, "Window/ScrollView"), #var_14_0 > 0)
