...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_5 = var_1.New("beierfasite_4", function(arg_3_0)
		...
		var_2_10001(var_3_0, var_3.Find(var_3_1, "ship"))
		...
		Vector3 = var_3_0
		var_3_2.localScale = var_3_0.one
	...
	PlayerPrefs = var_2_6
	arg_2_0.startDay = var_2_6.GetInt("PockySkinSignDay" .. (var_2_7 or "-1"), 0)
	arg_2_0.usmLRQ = nil
...
function var_0_1.OnDataSetting(arg_4_0)
	...
	arg_4_0.taskProxy = var_4(var_1_10005)
...
function var_0_1.OnFirstFlush(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "display_btn")
	...
	local function var_5_3()
		...
		local var_6_2 = var_2_10002.SHOW_AWARD_WINDOW

		PtAwardWindow = var_2_10003

		var_6_1(var_6_0, var_6_2, var_2_10003, {
	...
	local var_5_6 = var_3.Find(var_5_5, "battle_btn")
	...
	local var_5_10 = var_3.Find(var_5_9, "get_btn")
	...
	local function var_5_11()
		...
		local var_8_5 = var_2_10004.EVENT_PT_OPERATION
		local var_8_6 = {
			cmd = 1
		}
		local var_8_7 = arg_5_0.ptData

		var_8_6.activity_id = var_6.GetId(var_8_7)
	...
	local var_5_14 = var_3.Find(var_5_13, "help")
	...
	local function var_5_15()
		...
		pg = var_2_10003
		var_9_2.helps = var_2_10003.gametip.pocky_help.tip
	...
	var_1_10001(var_5_12, var_5_14, var_5_15, var_5)
...
function var_0_1.OnUpdateFlush(arg_11_0)
	...
	if arg_11_0.usmName ~= var_11_2 then
		...
		local var_11_4 = var_4.New(var_11_1 .. "/" .. var_11_2, var_11_2, function(arg_12_0)
			...
			var_12_0(var_12_1, var_3.Find(var_12_2, "usm"))
...
function var_0_1.UpdateTaskList(arg_13_0)
	...
	local var_13_18 = var_13_16(var_9)
	...
	if var_13_28 and arg_13_0.startDay < var_13_29 then
		...
		PlayerProxy = var_1_10021

		local var_13_30 = var_1_10020(var_1_10021)

		var_1_10020 = var_1_10020.getRawData(var_13_30).id
		PlayerPrefs = var_13_30

		var_13_30.SetInt("PockySkinSignDay" .. (var_1_10020 or "-1"), arg_13_0.startDay)
	end
	...
	if var_13_27 == 2 then
		...
		local var_13_32 = var_21.Find(var_13_31, "title")

		i18n = var_13_31

		var_1_10020(var_13_32, var_13_31("pocky_jiujiu"))

		setText = var_1_10020

		local var_13_33 = arg_13_0.signDesc
		local var_13_34 = var_21.Find(var_13_33, "desc")

		i18n = var_13_33

		var_1_10020(var_13_34, var_13_33("pocky_jiujiu_desc"))
		...
		local function var_13_37()
			if arg_13_0.GetCurrentDay() > arg_13_0.startDay then
				...
				local var_14_1 = var_14_0(var_2_10002)
				local var_14_2 = var_1.getRawData(var_14_1).id

				PlayerPrefs = var_14_1

				var_14_1.SetInt("PockySkinSignDay" .. (var_14_2 or "-1"), arg_13_0.startDay)
		...
		var_1_10020(var_13_35, var_13_36, var_13_37, var_1_10024)
	...
	local function var_13_45()
		...
		var_15_1(var_15_0, var_2_10002.ON_DROP, var_13_42)
	...
	var_25(var_13_43, var_13_44, var_13_45, var_1_10029)
	...
	local var_13_46 = var_13_39:getProgress()
	local var_13_47 = var_13_39
	local var_13_48 = var_13_39.getConfig(var_13_47, "target_num")

	setText = var_13_47

	local var_13_49 = arg_13_0.taskDesc

	var_13_47(var_28.Find(var_13_49, "title"), var_13_39:getConfig("name"))

	setText = var_13_47

	local var_13_50 = arg_13_0.taskDesc

	var_13_47(var_28.Find(var_13_50, "desc"), var_13_39:getConfig("desc"))

	setSlider = var_13_47

	var_13_47(var_13_17, 0, var_13_48, var_13_46)

	local var_13_51 = var_13_39
	local var_13_52 = var_13_39.getTaskStatus(var_13_51)

	setActive = var_13_51

	var_13_51(var_13_7, var_13_52 == 0)

	setActive = var_13_51

	var_13_51(var_13_38, var_13_52 == 1)

	setActive = var_13_51

	var_13_51(var_13_13, var_13_52 == 2)
	...
	local function var_13_55()
		...
		var_16_1(var_16_0, var_2_10002.ON_TASK_GO, var_13_39)
	...
	var_13_51(var_13_53, var_13_54, var_13_55, var_1_10032)
	...
	local function var_13_58()
		...
		var_17_1(var_17_0, var_2_10002.ON_TASK_SUBMIT, var_13_39)
	...
	var_13_51(var_13_56, var_13_57, var_13_58, var_1_10032)
...
function var_0_1.UpdatePTList(arg_18_0)
	...
	var_18_11, setSlider = var_6.Find(var_18_10, "slider"), var_18_10
	...
	var_18_10(var_18_11, var_18_12, var_18_13, var_1_10011.min(var_18_6, var_18_7) / var_18_9)
	...
	var_18_16(var_18_17, 0, 1, var_18_15 / var_18_9)
	...
	var_18_22(var_13.Find(var_18_24, "battle_btn"), var_18_23 and not var_18_19 and var_18_21)

	setActive = var_18_22

	local var_18_25 = arg_18_0.rightStage

	var_18_22(var_13.Find(var_18_25, "get_btn"), var_18_19)

	setActive = var_18_22

	local var_18_26 = arg_18_0.rightStage

	var_18_22(var_13.Find(var_18_26, "got_btn"), not var_18_21)
...
function var_0_1.OnDestroy(arg_19_0)
	...
	if arg_19_0.spine then
		local var_19_0 = arg_19_0.spine.transform

		Vector3 = var_1_10002
		var_19_0.localScale = var_1_10002.one
		pg = var_19_0

		local var_19_1 = var_19_0.PoolMgr.GetInstance()

		var_1.ReturnSpineChar(var_19_1, "beierfasite_4", arg_19_0.spine)
