...
function var_0_1.didEnter(arg_3_0)
	...
	var_3_9(var_6.range(#var_3_7), function(arg_5_0)
		...
		local var_5_7 = var_5_2:Find("content/desc")
		local var_5_8 = var_5_5
		local var_5_9 = var_5_5.Find(var_5_8, "mask/painting")

		setActive = var_5_8

		var_5_8(var_5_2, arg_5_0 <= #var_3_7)

		setActive = var_5_8

		var_5_8(var_5_5, arg_5_0 <= #var_3_7)
		...
		local var_5_10 = var_5_7

		i18n = var_8

		var_6(var_5_10, var_8("series_enemy_score") .. " ")
	...
	var_3_9(var_6.Find(var_3_10, "TotalScore/Text"), var_3_8)
	arg_3_0:loadUI()
...
function var_0_1.onBackPressed(arg_11_0)
	...
	var_1_10001(var_2.Find(var_11_0, "Confirm"))
...
function var_0_1.loadUI(arg_13_0)
	...
	var_1.GetUI(var_13_0, "ShareUI", false, function(arg_14_0)
		...
		var_14_4(var_14_1, false)

		setActive = var_14_4

		var_14_4(var_14_3, false)

		local var_14_6 = var_1
		local var_14_7 = var_1.Find(var_14_6, "deck/logo")

		GetComponent = var_14_6

		local var_14_8 = var_14_6(var_14_7, "Image")
		...
		local var_14_10 = var_14_9[var_14_8.ShareMgr.TypeBossRushEX]
		...
		var_7(var_14_11, var_14_12 .. var_2_10010.ShareMgr.TypeBossRushEX)
		...
		local var_14_15 = var_14_13(var_9)
		local var_14_16 = var_8.getRawData(var_14_15)

		getProxy = var_14_15
		ServerProxy = var_10

		local var_14_17 = var_14_15(var_10)
