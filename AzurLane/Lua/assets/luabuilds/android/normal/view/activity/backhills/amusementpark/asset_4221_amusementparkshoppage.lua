...
function var_0_1.init(arg_2_0)
	...
	i18n = var_2_6
	var_2_7[1] = var_2_6("amusementpark_shop_carousel1")
	i18n = var_2
	...
	math = var_3
	arg_2_0.pollIndex = var_2_8(var_2_9, var_3.max(0, #arg_2_0.pollText - 1))
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_6 = var_3.Find(var_5_5, "Top/Help")
	...
	local function var_5_7()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.amusementpark_shop_help.tip
	...
	var_1_10001(var_5_8, var_3.Find(var_5_9, "BG"), function()
	...
	local var_5_12 = var_3.Find(var_5_11, "window/button_container/Button1")
	...
	var_1_10001(var_5_10, var_5_12, var_5_13, var_5)
	...
	var_5_21(var_5_20, var_5_22, var_1_10006(var_5_19, ""))
	arg_5_0:UpdateView()
...
function var_0_1.ShowEnterMsg(arg_11_0)
	...
	if var_11_0(var_1_10002.values(arg_11_0.shop.goods), function(arg_12_0)
		...
		var_11_2(var_11_1, var_1_10004("amusementpark_shop_end"))
	...
	var_11_4(var_11_3, var_1_10004("amusementpark_shop_enter"))
...
function var_0_1.UpdateView(arg_13_0)
	...
	if not var_13_3[var_13_2(var_13_1)] then
		var_13_4 = 0
	end
	...
	var_4(var_5.Find(var_13_5, "Box/TicketText"), "X" .. var_13_4)
...
function var_0_1.UpdateGoods(arg_14_0)
	...
	var_14_1(var_14_2, var_4.GetChild(var_14_3, 0), #var_14_0, function(arg_16_0, arg_16_1, arg_16_2)
		...
		var_16_0(arg_16_2:Find("mask"), not var_16_1)
		...
		var_8(arg_16_2:Find("Price"), var_3:getConfig("resource_num"))
	...
	var_14_4(var_14_5, var_4.GetChild(var_14_6, 0), 3, function(arg_19_0, arg_19_1, arg_19_2)
		UIItemList = var_2_10003
		...
		local function var_19_3()
			...
			var_20_1(var_20_0, var_3_10002.ON_DROP, var_19_0)
		...
		var_4(var_19_1, var_19_2, var_19_3, var_2_10008)
...
function var_0_1.CheckRes(arg_21_0, arg_21_1, arg_21_2)
	...
	if not arg_21_1:canPurchase() then
		...
		var_21_1(var_21_0, var_1_10005("buy_countLimit"))
	...
	if var_3.getOwnedCount(var_21_2) < arg_21_1:getConfig("resource_num") * arg_21_2 then
		...
		i18n = var_7
		var_21_5.content = var_7("amusementpark_shop_exchange")

		function var_21_5.onYes()
			local var_22_0 = arg_21_0
			local var_22_1 = var_0.emit

			AmusementParkShopMediator = var_2_10002

			local var_22_2 = var_2_10002.GO_SCENE

			SCENE = var_2_10003

			var_22_1(var_22_0, var_22_2, var_2_10003.TASK)
...
function var_0_1.Purchase(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	i18n = var_1_10008
	var_23_2.content = var_1_10008("amusementpark_shop_exchange2", arg_23_1:getConfig("resource_num") * arg_23_2, arg_23_1:getConfig("num") * arg_23_2, arg_23_3)
...
function var_0_1.OnPurchase(arg_26_0, arg_26_1, arg_26_2)
	...
	AmusementParkShopMediator = var_1_10006

	var_26_2(var_26_1, var_1_10006.ON_ACT_SHOPPING, var_26_0, 1, arg_26_1.id, arg_26_2)
...
function var_0_1.ShowMsgbox(arg_27_0, arg_27_1)
	...
	var_6(var_27_6, var_27_7, var_27_8, var_1_10010)
...
function var_0_1.SetActiveBubble(arg_29_0, arg_29_1, arg_29_2)
	...
	if arg_29_1 then
		...
		local var_29_5 = var_29_3(var_29_4, var_6.New(1, 1, 1), var_29_2)

		var_29_3 = var_29_3.setFrom
		Vector3 = var_6

		local var_29_6 = var_29_3(var_29_5, var_6.New(0, 0, 0))

		var_29_3 = var_29_3.setEase
		LeanTweenType = var_6

		var_29_3(var_29_6, var_6.easeOutBack)
	else
		setActive = var_29_3
		...
		local var_29_9 = var_29_7(var_29_8, var_6.New(0, 0, 0), var_29_2)
		local var_29_10 = var_4.setFrom

		Vector3 = var_6

		local var_29_11 = var_29_10(var_29_9, var_6.New(1, 1, 1))
		local var_29_12 = var_4.setEase

		LeanTweenType = var_6

		local var_29_13 = var_29_12(var_29_11, var_6.easeOutBack)
		local var_29_14 = var_4.setOnComplete

		System = var_6

		var_29_14(var_29_13, var_6.Action(function()
			setActive = var_2_10000
...
function var_0_1.StopChat(arg_35_0)
	...
	if var_35_0(var_1_10002(arg_35_0.chat)) then
		LeanTween = var_35_1
		var_35_1 = var_35_1.cancel
		go = var_2

		var_35_1(var_2(arg_35_0.chat))
	end
...
function var_0_1.GetActivityShopTip()
	...
	if var_37_1(var_37_0, var_1_10003.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD) then
		local var_37_2 = var_1

		if var_1.isEnd(var_37_2) then
			return
		end

		pg = var_37_0

		local var_37_3 = var_37_0.activity_shop_template

		ipairs = var_37_2

		for iter_37_0, iter_37_1 in var_37_2(var_37_3.all) do
			if var_1.id == var_37_3[iter_37_1].activity then
				table = var_8
				...
				local var_37_5 = var_37_3[iter_37_1].num_limit == 0 or var_37_4 < var_10.num_limit

				Drop = var_1_10012

				local var_37_6 = var_1_10012.New({
					type = var_10.resource_category,
					id = var_10.resource_type
				})

				var_1_10012 = var_1_10012.getOwnedCount(var_37_6) >= var_10.resource_num

				if var_37_5 and var_1_10012 then
					return true
				end
			end
		end
