...
function var_0_1.initSkin(arg_2_0)
	...
	var_1(var_2_2, var_3(arg_2_0.skinTf, "leftGo/left"), function()
		if arg_2_0.clickTime then
			Time = var_0
		...
		if arg_2_0.skinIndex > 1 then
			...
			var_1.StartTimer(var_4_3, function()
				...
				var_3_10000(var_3_10001(arg_2_0.skinTf, "skins/skin" .. var_4_1), false)
			...
			local var_4_6 = var_4_5(var_4_4, var_3(var_4))
	...
	var_1(var_2_3, var_3(arg_2_0.skinTf, "rightGo/right"), function()
		if arg_2_0.clickTime then
			Time = var_0
		...
		if arg_2_0.displayDayList[arg_2_0.skinIndex] < arg_2_0.showItemNum then
			...
			var_1.StartTimer(var_6_3, function()
				...
				var_3_10000(var_3_10001(arg_2_0.skinTf, "skins/skin" .. var_6_1), false)
			...
			local var_6_6 = var_6_5(var_6_4, var_3(var_4))
	...
	for iter_2_0 = 1, #arg_2_0.displayDayList do
		...
		var_1_10006(var_2_5, var_1_10008(arg_2_0.skinTf, "page/" .. var_2_4), function()
			if arg_2_0.clickTime then
				Time = var_0
			...
			if arg_2_0.skinIndex ~= iter_2_0 then
				...
				if arg_2_0.skinIndex < iter_2_0 then
					...
					var_2.StartTimer(var_8_3, function()
						...
						var_3_10000(var_3_10001(arg_2_0.skinTf, "skins/skin" .. var_8_1), false)
					...
					local var_8_6 = var_8_5(var_8_4, var_4(var_5))
				...
				elseif arg_2_0.skinIndex > 1 then
					...
					local var_8_11 = var_8_10(var_8_9, var_4(var_5))
		...
		var_1_10008 = var_2_4 <= arg_2_0.showItemNum
...
function var_0_1.UpdateTask(arg_11_0, arg_11_1, arg_11_2)
	...
	if not var_5.getTaskById(var_11_2, var_11_1) then
		...
		var_11_4 = var_5.getFinishTaskById(var_11_3, var_11_1)
	end

	local var_11_5 = arg_11_2
	local var_11_6 = arg_11_2.Find(var_11_5, "get_btn")
	...
	local function var_11_9()
		if arg_11_0.nday <= arg_11_0.itmeNum then
			function arg_11_0.playHandle()
				...
				var_13_1(var_13_0, var_3_10002.ON_TASK_SUBMIT, var_11_4)
			...
			if var_0.GetDayIndex(var_12_0, arg_11_0.displayDayList, arg_11_0.nday) then
				...
				var_2_10002 = arg_11_0
				var_12_1.skinIndex = var_1.GetNextDayIndex(var_2_10002, arg_11_0.displayDayList, arg_11_0.nday)
			...
			var_12_4(var_12_3, var_2_10002.ON_TASK_SUBMIT, var_11_4)
		end
	...
	var_11_5(var_11_7, var_11_8, var_11_9, var_1_10011)

	local var_11_10 = arg_11_2
	local var_11_11 = arg_11_2.Find(var_11_10, "got_btn")
	...
	var_11_10(var_11_12, var_11_13, var_11_14, var_1_10012)

	local var_11_15 = arg_11_0.bg
	local var_11_16 = var_8.Find(var_11_15, "review_btn")
	...
	var_11_15(var_11_17, var_11_18, var_11_19, var_1_10013)
...
function var_0_1.pageUpdate(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1_10001(arg_19_0.displayDayList) do
		...
		var_1_10006(var_1_10007(arg_19_0.skinTf, "page/" .. iter_19_1), iter_19_1 <= arg_19_0.showItemNum)

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(arg_19_0.skinTf, "page/" .. iter_19_1 .. "/selected"), arg_19_0.skinIndex == iter_19_0)

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(arg_19_0.skinTf, "skins/skin" .. iter_19_1), arg_19_0.skinIndex == iter_19_0)

		findTF = var_1_10006
		var_1_10007 = var_1_10006(arg_19_0.skinTf, "skins/skin" .. iter_19_1)
...
function var_0_1.updateSkinUI(arg_22_0)
	if arg_22_0.playHandle then
		...
		var_1(var_1_10002(arg_22_0.skinTf, "leftGo"), false)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_22_0.skinTf, "rightGo"), false)

		setActive = var_1
		findTF = var_2

		var_1(var_2(arg_22_0.skinTf, "page"), false)
	else
		local var_22_1
		...
		if arg_22_0.skinIndex > 1 then
			...
			local var_22_0 = var_22_1(arg_22_0.skinTf, "leftGo/left")

			var_22_1 = var_22_1.GetComponent
			typeof = var_3
			CanvasGroup = var_1_10004
			var_22_1 = var_22_1(var_22_0, var_3(var_1_10004))
			var_22_1.alpha = 1
		else
			findTF = var_22_1

			local var_22_2 = var_22_1(arg_22_0.skinTf, "leftGo/left")
			local var_22_3 = var_1.GetComponent

			typeof = var_3
			CanvasGroup = var_1_10004
			var_22_3(var_22_2, var_3(var_1_10004)).alpha = 0.2
		end
		...
		if arg_22_0.displayDayList[arg_22_0.skinIndex] < arg_22_0.showItemNum then
			findTF = var_22_5
			var_22_4 = var_22_5(arg_22_0.skinTf, "rightGo/right")
			var_22_5 = var_22_5.GetComponent
			typeof = var_3
			CanvasGroup = var_1_10004
			var_22_5 = var_22_5(var_22_4, var_3(var_1_10004))
			var_22_5.alpha = 1
		else
			findTF = var_22_5
			var_22_4 = var_22_5(arg_22_0.skinTf, "rightGo/right")
		...
		var_22_5(var_22_4(arg_22_0.skinTf, "page"), true)
	end
...
function var_0_1.displayWindow(arg_23_0, arg_23_1)
	...
	if arg_23_1 then
		...
		local var_23_2 = var_23_1(var_23_0, var_4(var_1_10005))
		...
		var_1_10005 = var_23_6

		local var_23_7 = var_23_6.getTaskStatus(var_1_10005)

		if not (arg_23_0.activity.data3 < arg_23_0.itmeNum) or not arg_23_0.activity.data3 then
			var_1_10005 = arg_23_0.itmeNum
		end

		arg_23_0.showItemNum = var_1_10005
		...
		if arg_23_0.playHandle then
			...
			var_1_10005 = arg_23_0.GetLastDay(var_23_8, arg_23_0.displayDayList, arg_23_0.nday)
			setActive = var_23_8
			findTF = var_7

			var_23_8(var_7(arg_23_0.skinTf, "skins/skin" .. var_1_10005), true)
			arg_23_0:StartTimer(function()
				setActive = var_2_10000
				findTF = var_2_10001

				var_2_10000(var_2_10001(arg_23_0.skinTf, "skins/skin" .. var_1_10005), false)
			...
			local var_23_9 = var_6(arg_23_0.skinTf, "skins/skin" .. arg_23_0.displayDayList[arg_23_0.skinIndex])
			local var_23_10 = var_6.GetComponent

			typeof = var_8
			Animation = var_9

			local var_23_11 = var_23_10(var_23_9, var_8(var_9))

			var_6.Play(var_23_11, "anim_zhenhaimuseum_skin_right")
		end
	else
		pg = var_23_1

		local var_23_12 = var_23_1.UIMgr.GetInstance()

		var_2.UnOverlayPanel(var_23_12, arg_23_0.skinTf)

		local var_23_13 = arg_23_0.skinTf
		local var_23_14 = var_2.GetComponent

		typeof = var_4
		Animation = var_1_10005

		local var_23_15 = var_23_14(var_23_13, var_4(var_1_10005))

		var_2.Play(var_23_15, "anim_plantNaximofu_out")
		arg_23_0:StartTimer(function()
			setActive = var_2_10000
