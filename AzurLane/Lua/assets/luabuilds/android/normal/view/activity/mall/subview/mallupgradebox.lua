...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("mall_upgrade_title"))
	...
	var_1_10001(var_2_1, var_3("text_confirm"))
	...
	var_1_10001(var_2_2, var_3("mall_level_header"))
...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.unlockUIList = var_3_6(var_3_7, var_3.Find(var_3_8, "tpl"))
	...
	var_1.make(var_3_9, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			local var_6_1 = arg_6_2.Find(var_6_0, "header")

			i18n = var_6_0

			var_3(var_6_1, var_6_0("word_unlock"))
	...
	for iter_3_0, iter_3_1 in var_1(var_3_9.activity_mall_template.all) do
		pg = var_1_10006
		var_1_10006 = var_1_10006.activity_mall_template[iter_3_1].need_mall_level

		local var_3_10

		if not arg_3_0.lv2FloorIds[var_1_10006] then
			var_3_10 = arg_3_0.lv2FloorIds
			var_3_10[var_1_10006] = {}
		end

		table = var_3_10

		var_3_10.insert(arg_3_0.lv2FloorIds[var_1_10006], iter_3_1)
	end
