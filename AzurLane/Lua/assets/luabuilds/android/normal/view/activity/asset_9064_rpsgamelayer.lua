...
local function var_0_22(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	local var_1_0 = {
		Ctor = function(arg_2_0)
			...
			local var_2_0 = var_2(arg_2_0._tf, "top/bg/desc/img")

			typeof = var_3
			Image = var_4

			local var_2_1 = var_1(var_2_0, var_3(var_4))
			...
			local var_2_3 = var_1(var_2_2, var_3(var_4))
			...
			for iter_2_0 = 1, var_0_9 do
				...
				var_2_10005 = var_2_10005(var_2_10006(arg_2_0._topCardTpl))
				tf = var_2_10006
				instantiate = var_7
				var_2_10006 = var_2_10006(var_7(arg_2_0._bottomCardTpl))
				SetParent = var_7

				var_7(var_2_10005, arg_2_0._topContent)

				SetParent = var_7

				var_7(var_2_10006, arg_2_0._bottomContent)

				setActive = var_7

				var_7(var_2_10005, true)

				setActive = var_7

				var_7(var_2_10006, true)

				table = var_7

				var_7.insert(arg_2_0.topCards, var_2_10005)

				table = var_7

				var_7.insert(arg_2_0.bottomCards, var_2_10006)
			end
		...
		setCardData = function(arg_3_0, arg_3_1)
			...
			for iter_3_0 = 1, var_0_9 do
				...
				var_3_3(var_3_2, var_2_10010(arg_3_0.topCards[iter_3_0], "ad"), false)
				...
				var_3_5(var_3_4, var_2_10010(arg_3_0.bottomCards[iter_3_0], "ad"), false)
				...
				var_3_5(var_9(arg_3_0.bottomCards[iter_3_0], "ad/" .. var_3_1[iter_3_0]), true)
			end
...
local function var_0_23(arg_8_0, arg_8_1)
	local var_8_0 = {
		Ctor = function(arg_9_0)
			...
			local var_9_0 = var_2(arg_9_0.btnTake, "txt")

			i18n = var_3

			var_1(var_9_0, var_3("rps_game_take_card"))
			...
			var_1(var_9_1, var_9_2, var_9_3, var_2_10005)

			arg_9_0.myCardTfs = {}

			for iter_9_0 = 1, var_0_9 do
				findTF = var_2_10005
				var_2_10005 = var_2_10005(arg_9_0._tf, "bottomCard/cardContent/" .. iter_9_0)
				table = var_6

				var_6.insert(arg_9_0.myCardTfs, var_2_10005)

				onButton = var_6
				var_2_10007 = arg_9_0._event

				local var_9_4 = var_2_10005
				...
				SFX_CONFIRM = var_2_10010

				var_6(var_2_10007, var_9_4, var_9_5, var_2_10010)
			end
			...
			for iter_9_1 = 1, var_0_9 do
				...
				var_2_10005(var_9_6, var_2_10007(arg_9_0._tf, "topCard/cardContent/" .. iter_9_1))
			end
			...
			for iter_9_2 = 1, var_0_11 do
				...
				var_2_10005(var_9_7, var_2_10007(arg_9_0._tf, "bottomStatus/heart/" .. iter_9_2))
				...
				var_2_10005(var_9_8, var_2_10007(arg_9_0._tf, "topStatus/heart/" .. iter_9_2))
			end
			...
			typeof = var_3
			SpineAnimUI = iter_9_2
			arg_9_0.spineAnim = var_1(var_9_9, var_3(iter_9_2))
		...
		updateSelectCard = function(arg_12_0)
			for iter_12_0 = 1, #arg_12_0.myCardTfs do
				...
				if arg_12_0.cardSelectIndex and arg_12_0.cardSelectIndex == iter_12_0 then
					...
					var_12_1(var_2_10007(arg_12_0.myCardTfs[iter_12_0], "AD/select"), true)
				else
					...
					var_12_2(var_2_10007(arg_12_0.myCardTfs[iter_12_0], "AD/select"), false)
				end
			end
		...
		updateCardCount = function(arg_14_0, arg_14_1, arg_14_2)
			...
			local var_14_0 = var_2_10004(arg_14_1, "text")

			tostring = var_5

			var_2_10003(var_14_0, var_5(arg_14_2))
		...
		updateCardIndex = function(arg_15_0, arg_15_1, arg_15_2)
			...
			var_15_1(var_15_0, var_2_10005(arg_15_1, "AD"), false)
		...
		step = function(arg_18_0, arg_18_1)
			...
			if arg_18_0.myCardTime then
				...
				var_2(var_18_1, var_2_10004(var_2_10005.ceil(arg_18_0.myCardTime)))
			else
				setText = var_2
...
function var_0_1.sendGamingNotice(arg_36_0, arg_36_1)
	...
	var_36_1(var_36_0, var_1_10004.GAME_OPERATION, {
...
function var_0_1.initData(arg_37_0)
	...
	if var_1_10001.targetFrameRate <= 60 then
		...
		arg_37_0.timer = var_2.New(function()
			...
			if var_2_10000.realtimeSinceStartup - arg_37_0.realTimeStartUp > arg_37_0.stepCount then
				local var_38_0 = arg_37_0

				var_0.onTimer(var_38_0)

				local var_38_1 = arg_37_0

				Time = var_38_0
				var_38_1.realTimeStartUp = var_38_0.realtimeSinceStartup
			end
...
function var_0_1.initUI(arg_39_0)
	...
	local var_39_1 = var_3(arg_39_0.settlementUI, "btnOver")
	...
	var_1(var_39_0, var_39_1, var_39_2, var_5)
...
function var_0_1.initGameUI(arg_41_0)
	...
	var_1(var_41_0, var_3(arg_41_0.gameUI, "btnLeave"), function()
	...
	local var_41_5 = var_4(arg_41_0.sceneTf, "tpls/card_1")

	findTF = var_5
	arg_41_0.showPanel = var_41_2(var_41_3, var_41_4, var_41_5, var_5(arg_41_0.sceneTf, "tpls/card_2"))
...
function var_0_1.gameStart(arg_47_0)
	...
	var_1_10001(var_1_10002(arg_47_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_47_0.bgTf, "on"), false)
...
function var_0_1.createGameData(arg_48_0)
	...
	for iter_48_0 = 4, var_0_9 do
		...
		var_1_10007(var_48_2, var_1_10009.random(1, 3))
		...
		var_1_10007(var_48_3, var_1_10009.random(1, 3))
	end
...
function var_0_1.transformColor(arg_51_0, arg_51_1)
	...
	local var_51_0 = var_1_10002(var_1_10003.sub(arg_51_1, 1, 2), 16)

	tonumber = var_3
	string = var_4

	local var_51_1 = var_3(var_4.sub(arg_51_1, 3, 4), 16)

	tonumber = var_4
	string = var_5

	local var_51_2 = var_4(var_5.sub(arg_51_1, 5, 6), 16)
	...
	if arg_54_0.gameState == var_0_6 or arg_54_0.gameState == var_0_7 then
		...
		if arg_54_0.otherTakeTime and arg_54_0.otherTakeTime > 0 then
			...
			if arg_54_0.otherTakeTime <= 0 then
				...
				math = var_1_10003
				arg_54_0.otherTakeCard = var_54_0(var_54_1, var_1_10003.random(1, #arg_54_0.gameData.other_cards))
...
function var_0_1.onGameOver(arg_58_0, arg_58_1)
	...
	var_2(var_3(arg_58_0._tf, "scene_container"), false)
	...
	local var_58_1 = var_3(arg_58_0._tf)
	local var_58_2 = arg_58_1

	System = var_5

	var_58_0(var_58_1, var_58_2, var_5.Action(function()
...
function var_0_1.showSettlement(arg_60_0)
	...
	var_3(var_1_10004(arg_60_0.settlementUI, "ad/score/score_1"), var_60_0)

	setText = var_3
	findTF = var_4

	var_3(var_4(arg_60_0.settlementUI, "ad/score/score_2"), var_60_1)

	setActive = var_3
	findTF = var_4

	var_3(var_4(arg_60_0.settlementUI, "ad/win"), var_60_1 <= var_60_0)

	setActive = var_3
	findTF = var_4

	var_3(var_4(arg_60_0.settlementUI, "ad/defeat"), var_60_0 < var_60_1)
	...
	local var_60_5 = var_60_3.GetInt
	...
	if not var_60_5(var_60_6 .. var_6(var_60_4) .. "_" .. var_0_4) then
		var_60_7 = 0
	end
	...
	if var_60_7 <= var_60_0 then
		...
		local var_60_8 = var_5.SetInt
		local var_60_9 = "mg_score_"

		tostring = var_7

		var_60_8(var_60_9 .. var_7(var_60_4) .. "_" .. var_0_4, var_60_7)
	end

	local var_60_10 = arg_60_0
	local var_60_11 = arg_60_0.emit

	Dorm3dMiniGameMediator = var_7

	var_60_11(var_60_10, var_7.GAME_OPERATION, {
...
function var_0_1.getMiniGameData(arg_63_0)
	if not arg_63_0._mgData then
		...
		local var_63_0 = var_1(var_1_10002)
...
function var_0_1.checkGameExit(arg_65_0)
	if not arg_65_0.gameStartFlag then
		...
		var_65_1(var_65_0, var_1_10003.GAME_OPERATION, {
		...
		if arg_65_0.contextData.isDorm3d then
			...
			local var_65_4 = var_1_10003.NewStyleMsgboxMgr.TYPE_MSGBOX
			...
			function var_1_10004.onConfirm()
				...
				var_66_1(var_66_0, var_2_10002.GAME_OPERATION, {
					operationCode = "GAME_CLOSE",
					doTrack = false,
					miniGameId = var_0_4
				})
			...
			var_65_3(var_65_2, var_65_4, var_1_10004)
		else
			pg = var_65_3
			...
			i18n = var_1_10004
			var_65_7.content = var_1_10004("mini_game_leave")
			...
			function var_65_7.onYes()
				...
				var_68_1(var_68_0, var_2_10002.GAME_OPERATION, {
					operationCode = "GAME_CLOSE",
					doTrack = false,
					miniGameId = var_0_4
				})
...
function var_0_1.willExit(arg_70_0)
	if arg_70_0.detailPanel then
		var_1_10002 = arg_70_0.detailPanel
	...
	if arg_70_0._tf then
		...
		if var_70_0(var_1_10002(arg_70_0._tf)) then
			LeanTween = var_1
