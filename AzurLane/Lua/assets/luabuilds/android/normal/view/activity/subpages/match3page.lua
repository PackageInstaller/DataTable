...
function var_0_1.OnFirstFlush(arg_3_0)
	...
	local var_3_3 = var_3_1(var_3_0, var_4.getConfig(var_3_2, "config_id"))

	setActive = var_3_0

	var_3_0(arg_3_0.item, false)
	...
	var_3.make(var_3_4, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventInit then
			...
			if arg_4_0 == var_4_0.EventUpdate then
				...
				local var_4_8 = arg_4_2.Find(var_4_7, "mask")

				setActive = var_4_7

				var_4_7(var_4_6, arg_4_1 < var_3_3.usedtime)

				setActive = var_4_7

				var_4_7(var_4_8, arg_4_1 >= var_3_3.usedtime + var_3_3.count)
			end
		end
	...
	var_3(arg_3_0, arg_3_0.goBtn, function()
		...
		var_6_1(var_6_0, var_2_10002.GO_MINI_GAME, arg_3_0.id)
