...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	typeof = var_6
	Camera = var_1_10007
	arg_1_0._uiCamera = var_1_1(var_1_0, var_6(var_1_10007))
	onButton = var_4
	...
	var_4(var_1_2, var_6(arg_1_0.gameUI, "ad/topRight/btnStop"), function()
		local var_2_0 = arg_1_0._event
		local var_2_1 = var_0.emit

		BeachGuardGameView = var_2_10002

		var_2_1(var_2_0, var_2_10002.OPEN_PAUSE_UI)

		local var_2_2 = arg_1_0._event
		local var_2_3 = var_0.emit

		BeachGuardGameView = var_2

		var_2_3(var_2_2, var_2.PAUSE_GAME, true)
	...
	var_4(var_1_3, var_6(arg_1_0.gameUI, "ad/btnLeave"), function()
		local var_3_0 = arg_1_0._event
		local var_3_1 = var_0.emit

		BeachGuardGameView = var_2_10002

		var_3_1(var_3_0, var_2_10002.OPEN_LEVEL_UI)
		...
		var_3_3(var_3_2, var_2.PAUSE_GAME, true)
	...
	var_4(arg_1_0._event, arg_1_0.btnRecycle, function()
		...
		var_4_2(var_4_1, var_2.RECYCLES_CHAR, true)
...
function var_0_0.cancelRecycle(arg_6_0)
	...
	var_6_1(var_6_0, var_3.RECYCLES_CHAR, false)
...
function var_0_0.update(arg_9_0)
	...
	for iter_9_0 = 1, #arg_9_0.cards do
		...
		var_1_10012 = var_1_10012(var_9_7, var_1_10014(var_1_10015))
		...
		if var_9_0 < var_9_4 then
			...
			var_9_7(var_1_10014(var_9_3, "mask"), true)
		else
			if var_9_5 then
				table = var_9_7

				if var_9_7.contains(var_9_1, var_9_6) then
					var_1_10012.blocksRaycasts = false
					var_1_10012.interactable = false
					setActive = var_13
					findTF = var_1_10014

					var_13(var_1_10014(var_9_3, "mask"), true)
			...
			var_13(var_1_10014(var_9_3, "mask"), false)
		end
	...
	var_3(var_9_8, var_5.ceil(arg_9_0.runningData.gameTime))
...
function var_0_0.updateGoods(arg_10_0, arg_10_1, arg_10_2)
	if arg_10_1 and 0 < arg_10_1 then
		...
		local var_10_0 = var_4(arg_10_0.goodsAdd, "text")
		local var_10_1 = "+"

		tostring = var_6

		var_3(var_10_0, var_10_1 .. var_6(arg_10_1))
...
function var_0_0.createCharCard(arg_11_0)
	for iter_11_0 = 1, #arg_11_0.showCards do
		...
		local var_11_1 = arg_11_0:getCardFromPool(var_1_10006.id)
		local var_11_2

		if not var_11_1 then
			tf = var_9
			instantiate = var_1_10010
			var_11_2 = var_9(var_1_10010(arg_11_0.cardTpl))
			SetParent = var_9

			var_9(var_11_2, arg_11_0.charContent)
			...
			var_11_2 = var_11_1.tf
		end

		table = var_9

		var_9.insert(arg_11_0.cards, var_11_1)
		...
		GetComponent = var_9
		findTF = var_1_10010
		var_1_10010 = var_1_10010(var_11_2, "icon")
		typeof = var_11
		Image = var_12

		local var_11_3 = var_9(var_1_10010, var_11(var_12))

		BeachGuardAsset = var_1_10010
		var_11_3.sprite = var_1_10010.getCardQIcon(var_1_10006.icon)

		var_11_3:SetNativeSize()
		...
		var_1_10010 = var_1_10010(var_11_4, var_12(var_1_10013))
		ClearEventTrigger = var_11_4

		var_11_4(var_1_10010)
		var_1_10010:AddBeginDragFunc(function(arg_12_0, arg_12_1)
			...
			local var_12_0 = var_3(arg_11_0.dragChar, "icon")

			typeof = var_4
			Image = var_5

			local var_12_1 = var_2(var_12_0, var_4(var_5))

			BeachGuardAsset = var_12_0
			var_12_1.sprite = var_12_0.getCardIcon(var_1_10006.icon)
			...
			var_12_3(var_12_2, var_5.DRAG_CHAR, arg_11_0.dragData)

			return
		end)
		var_1_10010:AddDragFunc(function(arg_13_0, arg_13_1)
			if arg_11_0.recycleFlag then
				return
			end
		...
		var_1_10010.AddDragEndFunc(var_11_5, function(arg_14_0, arg_14_1)
			if arg_11_0.recycleFlag then
				return
			end
			...
			var_14_1(var_14_0, var_4.DRAG_CHAR, arg_11_0.dragData)
		...
		local var_11_6 = var_11_5(var_11_2, "cost")

		tostring = var_1_10013

		var_11(var_11_6, var_1_10013(var_1_10006.cost))
	end
...
function var_0_0.resetChaCard(arg_16_0)
	for iter_16_0 = 1, #arg_16_0.cards do
		...
		var_1_10006(var_1_10007(var_1_10005, "mask"), false)

		GetComponent = var_1_10006
		findTF = var_1_10007
		var_1_10007 = var_1_10007(var_1_10005, "icon")
		typeof = var_8
		Image = var_9
		var_1_10006 = var_1_10006(var_1_10007, var_8(var_9))
		var_1_10006.sprite = nil
		setText = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(var_1_10005, "cost"), "0")
	...
	for iter_16_1 = #arg_16_0.cards, 1, -1 do
		...
		var_6.insert(arg_16_0.cardPool, var_1_10005)
	end
