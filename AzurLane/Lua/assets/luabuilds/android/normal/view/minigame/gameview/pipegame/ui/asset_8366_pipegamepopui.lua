...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_10(var_16_13, var_12(var_16_4))
...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	local var_19_3 = var_19_1.floor(var_0_1.gameDragTime)
	...
	if var_4 then
		...
		if 0 < var_19_2 and var_19_5 < var_19_2 then
			...
			var_19_9(var_19_8, var_9.STORE_SERVER, {
				var_19_2,
				var_19_3
			})
		elseif 0 < var_19_2 and var_19_2 == var_19_5 and var_19_7 < var_19_3 then
			...
			var_19_9(var_19_10, var_9.STORE_SERVER, {
				var_19_2,
				var_19_3
			})
		end
		...
		local var_19_12 = var_8(arg_19_0.settlementUI, "ad/currentText")
		...
		PipeGameEvent = var_11

		var_19_14(var_19_13, var_11.SUBMIT_GAME_SUCCESS)
