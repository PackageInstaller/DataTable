...
local var_0_3 = var_0_2(var_0_10003.pi / 8)
...
function var_0_0.GetDestroyPoint(arg_31_0)
	...
	if var_31_1 == var_1_10003 then
		...
		TargetObject = var_1_10004

		if var_31_1(var_31_2, var_1_10004) then
			switch = var_2

			local var_31_3 = arg_31_0.class

			var_1_10004 = {}
			ObjectBreakable = var_1_10005
			var_1_10004[var_1_10005] = function()
				var_31_0 = 20

				return
			end
			ObjectRockB = var_1_10005
			var_1_10004[var_1_10005] = function()
				var_31_0 = 50

				return
			end
			ObjectTreasureN = var_1_10005
			var_1_10004[var_1_10005] = function()
				var_31_0 = 200

				return
			end
			ObjectTreasureR = var_1_10005
			var_1_10004[var_1_10005] = function()
				var_31_0 = 500
			...
			var_2(var_31_3, var_1_10004)
		else
			isa = var_2

			local var_31_4 = arg_31_0

			MoveEnemy = var_1_10004

			if var_2(var_31_4, var_1_10004) then
				switch = var_2

				local var_31_5 = arg_31_0.class
				local var_31_6 = {}

				EnemyScavenger = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 100

					return
				end
				EnemyBossScavenger = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 300

					return
				end
				EnemyChaser = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 100

					return
				end
				EnemyBossChaser = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 500

					return
				end
				EnemyNavigator = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 22

					return
				end
				EnemyBossNavigator = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 600

					return
				end
				EnemySmasher = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 22

					return
				end
				EnemyBossSmasher = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 500

					return
				end
				EnemyConductor = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 200

					return
				end
				EnemyBossConductor = var_1_10005
				var_31_6[var_1_10005] = function()
					var_31_0 = 600
...
function var_0_0.GetPassGamePoint(arg_52_0)
	...
	return var_52_0(16 / var_1_10002.log(arg_52_0))
end
...
function var_0_0.ReSetDir(arg_53_0)
	if arg_53_0.x ~= 0 and arg_53_0.y ~= 0 then
		...
		local var_53_1 = var_2.sign(arg_53_0.y)
