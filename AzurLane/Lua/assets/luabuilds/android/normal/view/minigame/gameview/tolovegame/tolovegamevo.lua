...
function var_0_0.Prepare()
	...
	if var_0_0.buffIndex == 3 or var_0_0.buffIndex == 6 or var_0_0.buffIndex == 7 then
		...
		var_4_2.gameTime = var_4_3 + var_2.addTime
	end
...
function var_0_0.GetArrowNum()
	...
	for iter_6_0, iter_6_1 in var_1_10001(var_1_10002.remainingTimeToArrowNumber) do
...
function var_0_0.SetRandomArrawList(arg_8_0)
	...
	for iter_8_0 = 1, arg_8_0 do
		...
		if 4 * var_1_10005.random() < 1 then
			...
			ToLoveGameConst = var_1_10008

			var_8_0(var_8_1, var_1_10008.arrowUp)
		elseif var_1_10005 < 2 then
			...
			var_8_2(var_8_3, var_1_10008.arrowDown)
		else
			local var_8_4
			...
			if var_1_10005 < 3 then
				...
				var_8_4(var_8_5, var_1_10008.arrowLeft)
			else
				table = var_8_4
				...
				var_8_6(var_8_7, var_1_10008.arrowRight)
			end
		end
	end
...
function var_0_0.GetBuffList(arg_10_0)
	...
	local var_10_0 = var_1_10001(var_1_10002.buffList)[1]

	i18n = var_1_10003
	var_10_0[1] = var_1_10003("tolovegame_buff_name_1")
	...
	var_10_7(var_10_8, var_4("tolovegame_buff_desc_1"))
	...
	var_10_9(var_10_10, var_4("tolovegame_buff_desc_2"))
	...
	var_10_11(var_10_12, var_4("tolovegame_buff_desc_3"))
	...
	var_10_13(var_10_14, var_4("tolovegame_buff_desc_4"))
	...
	var_10_15(var_10_16, var_4("tolovegame_buff_desc_5"))
	...
	var_10_17(var_10_18, var_4("tolovegame_buff_desc_6"))
	...
	var_10_19(var_10_20, var_4("tolovegame_buff_desc_7"))
	...
	local var_10_23 = var_10_21.activity_template[var_10_22].time

	type = var_4

	if var_4(var_10_23) == "table" then
		pg = var_4
		...
		local var_10_26 = var_10_24.TimeMgr.GetInstance()
		...
		for iter_10_0 = 1, #var_1 do
			...
			local var_10_30 = var_13.floor((var_10_27 + (iter_10_0 - 1) * var_10_29 - var_10_25) % var_10_29 / var_10_28)
			local var_10_31

			if var_10_27 + (iter_10_0 - 1) * var_10_29 - var_10_25 > 0 then
				if 0 < var_1_10012 then
					table = var_10_31
					var_10_31 = var_10_31.insert

					local var_10_32 = var_1[iter_10_0]

					i18n = var_1_10016

					var_10_31(var_10_32, var_1_10016("tolovegame_lock_1", var_1_10012, var_10_30))
				else
					table = var_10_31
					var_10_31 = var_10_31.insert

					local var_10_33 = var_1[iter_10_0]

					i18n = var_1_10016

					var_10_31(var_10_33, var_1_10016("tolovegame_lock_2", var_10_30))
				end
			else
				table = var_10_31

				var_10_31.insert(var_1[iter_10_0], "")
			end
		end
	else
...
function var_0_0.GetScoreMultiplyRate()
	...
	for iter_11_0, iter_11_1 in var_1_10001(var_1_10002.scoreMultiplyRate) do
...
function var_0_0.ShouldShowTip()
	...
	for iter_12_0, iter_12_1 in var_5(var_12_4) do
		if iter_12_1[3] == "" then
			var_12_3 = var_12_3 + 1
		end
	end
	...
	getProxy = var_7
	ActivityProxy = iter_12_0

	local var_12_6 = var_7(iter_12_0)
	local var_12_7 = var_7.getActivityById

	ActivityConst = iter_12_1

	local var_12_8 = var_12_7(var_12_6, iter_12_1.TOLOVE_MINIGAME_TASK_ID)
	local var_12_9 = var_7.getConfig(var_12_8, "config_client").task_ids

	pairs = var_12_8

	for iter_12_2, iter_12_3 in var_12_8(var_12_9) do
		getProxy = var_1_10014
		TaskProxy = var_1_10015
		var_1_10015 = var_1_10014(var_1_10015)

		local var_12_10 = var_1_10014.getTaskVO(var_1_10015, iter_12_3)
