...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0 = 0, var_1_1 - 1 do
		...
		var_1_10008 = var_1_10008(var_1_10009(arg_1_0._tpl))
		...
		var_1_2, setImageSprite = var_10(var_1_10008, "zPos/floor/img"), var_11
		CastleGameVo = var_1_10013

		var_11(var_1_2, var_1_10013.getFloorImage(iter_1_0 + 1), true)
		...
		var_1_4, GetComponent = var_1_2(var_1_10008, "zPos/collider"), var_1_10013
		typeof = var_1_10015
		var_1_10013 = var_1_10013(var_1_4, var_1_10015("UnityEngine.PolygonCollider2D"))
		GetComponent = var_1_4
		findTF = var_1_10015
		var_1_10015 = var_1_10015(var_1_10008, "zPos/floor")
		typeof = var_16
		Animator = var_17

		local var_1_5 = var_1_4(var_1_10015, var_16(var_17))

		CastleGameVo = var_1_10015
		var_1_10015 = iter_1_0 % var_1_10015.h_count
		math = var_16

		local var_1_6 = var_16.floor

		CastleGameVo = var_17

		local var_1_7 = var_1_6(iter_1_0 / var_17.w_count)

		table = var_17

		var_17.insert(arg_1_0.colliders, var_1_10013)

		table = var_17

		var_17.insert(arg_1_0.floorTfs, var_1_10008)

		table = var_17

		var_17.insert(arg_1_0.floors, {
			fall = false,
			tf = var_1_10008,
			zPos = var_1_10009,
			anim = var_1_5,
			index = iter_1_0,
			collider = var_1_10013,
			w = var_1_10015,
			h = var_1_7
		})
	end
...
function var_0_0.updateBounds(arg_5_0)
	for iter_5_0 = 1, #arg_5_0.floors do
		...
		for iter_5_1, iter_5_2 in var_1_10008(var_9.ToTable(var_5_3)) do
			Vector2 = var_1_10013
			var_1_10013 = var_1_10013(var_5_1.x + iter_5_2.x, var_5_1.y + iter_5_2.y)
			table = var_14

			var_14.insert(var_5_2, var_1_10013)
		end
...
function var_0_0.removeFloorByFallData(arg_11_0, arg_11_1)
	...
	local var_11_2 = var_11_0(var_11_1, var_1_10004.random(1, #arg_11_1.rule_id))

	CastleGameVo = var_11_1

	local var_11_3 = var_11_1.floor_rule[var_11_2]
...
function var_0_0.setFloorFallTime(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	for iter_19_0 = 1, #arg_19_1 do
		...
		if not arg_19_1[iter_19_0].fall then
			...
			var_1_10009 = arg_19_0

			arg_19_0.removeActiveFloor(var_1_10009, arg_19_1[iter_19_0])
		else
			print = var_19_1
...
function var_0_0.updateFloorPos(arg_21_0)
	for iter_21_0 = 1, #arg_21_0.floors do
		...
		var_1_10007 = var_1_10007(var_21_0 / var_1_10008.h_count)
		var_1_10008 = arg_21_0.floors[iter_21_0].tf
		CastleGameVo = var_1_10009
		var_1_10008.anchoredPosition = var_1_10009.GetRotationPosByWH(var_1_10006, var_1_10007)
	end
