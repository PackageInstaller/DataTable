...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..BaseMiniGameMediator"))
...
function var_0_1.OnMiniGameOPeration(arg_2_0, arg_2_1, arg_2_2)
	...
	var_2_3(var_2_2, var_1_10006.SEND_MINI_GAME_OP, {
		hubid = var_2_1.id,
		cmd = arg_2_1,
		args1 = arg_2_2
	})
...
function var_0_1.OnMiniGameSuccess(arg_3_0, arg_3_1)
	if arg_3_0.gameRoomData then
		...
		var_3_3(var_1_10006, var_1_10007.GAME_ROOM_SUCCESS, {
			roomId = var_3_2,
			times = var_3_1,
			score = var_3_0
		})
		...
		local var_3_8 = var_1_10006.SEND_MINI_GAME_OP
		local var_3_9 = {
			hubid = var_2.id
		}

		MiniGameOPCommand = var_8
		var_3_9.cmd = var_8.CMD_COMPLETE
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.SUBMIT_ACTIVITY_TASK_DONE then
		...
		if var_6_0 == var_6_4.SEND_MINI_GAME_OP_DONE and arg_6_0.viewComponent.OnSendMiniGameOPDoneShrine then
