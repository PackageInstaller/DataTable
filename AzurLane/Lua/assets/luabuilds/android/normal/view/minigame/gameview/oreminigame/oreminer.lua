...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0.animator = var_1_1(var_1_0, var_6(var_1_10007))
...
function var_0_0.AddListener(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10003.EVENT_ORE_EF_MINED, function(arg_3_0, arg_3_1)
...
function var_0_0.AddDftAniEvent(arg_4_0)
	...
	var_1.SetTriggerEvent(var_4_2, function()
		...
		var_5_1(var_5_0, var_2_10002.EVENT_ORE_NEW, {
			index = arg_4_0.index,
	...
	local var_4_5 = var_4_4(var_4_3, var_3(var_1_10004))

	var_1.SetEndEvent(var_4_5, function()
		setActive = var_2_10000
		findTF = var_2_10001

		var_2_10000(var_2_10001(arg_4_0._tf, "EF"), false)
...
function var_0_0.PlayEFMined(arg_9_0, arg_9_1)
	if arg_9_0.index == arg_9_1 then
		...
		var_2(var_1_10003(arg_9_0._tf, "EF"), true)
	end
