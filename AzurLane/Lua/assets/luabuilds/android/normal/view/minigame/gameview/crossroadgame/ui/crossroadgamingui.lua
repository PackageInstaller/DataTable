...
function var_0_0.initUI(arg_2_0)
	...
	local function var_2_8()
		if not arg_2_0._gameVo.startSettlement then
			...
			CrossRoadGameView = var_2

			var_3_3(var_3_2, var_2.OPEN_LEAVEL_UI)
		end
...
function var_0_0.Start(arg_9_0)
	...
	if var_9_2(var_9_1, var_3.GetGameId(var_9_3)) then
		local var_9_4 = #var_1
		...
		var_3(arg_9_0.scoreTF, 0)

		if arg_9_0._editorFlag then
			setActive = var_3
			findTF = var_4

			var_3(var_4(arg_9_0._gameUI, "joyStick"), false)

			setActive = var_3
			findTF = var_4

			var_3(var_4(arg_9_0._gameUI, "top"), false)

			setActive = var_3
			findTF = var_4

			var_3(var_4(arg_9_0._gameUI, "bg_top"), false)
		end
...
function var_0_0.AddDebugInput(arg_11_0)
	...
	if var_1_10001 then
		...
		if var_11_0(var_1_10002.A) then
			var_11_1 = arg_11_0
