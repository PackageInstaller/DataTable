...
function var_0_0.onSceneEventCall(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_1 == var_1_10004.EVENT_ACTION_PROP then
		...
		var_1_10008 = var_4.data.score

		local var_3_3 = arg_3_0.charController
		local var_3_4 = var_9.getDirect(var_3_3)

		if var_4.direct == var_3_4 then
			if arg_3_3 then
				arg_3_3(true)
			end

			if var_1_10008 and var_1_10008 >= 0 then
				local var_3_5 = arg_3_0:getScore(var_1_10008, var_0_5.comboNum)
				local var_3_6 = arg_3_0._event
				local var_3_7 = var_11.emit

				TouchCakeGameEvent = var_13

				var_3_7(var_3_6, var_13.ADD_SCORE, var_3_5)
			end

			if var_3_1 and 0 < var_3_1 then
				pg = var_10

				local var_3_8 = var_10.CriMgr.GetInstance()

				var_10.PlaySoundEffect_V3(var_3_8, var_0_5.SFX_COUNT_PERFECT)

				local var_3_9 = arg_3_0.charController

				var_10.guard(var_3_9, var_3_1)
			end

			if var_3_0 and var_3_0 > 0 then
				local var_3_10 = arg_3_0.charController

				if var_10.dizzi(var_3_10, var_3_0) then
					pg = var_3_10

					local var_3_11 = var_3_10.CriMgr.GetInstance()

					var_11.PlaySoundEffect_V3(var_3_11, var_0_5.SFX_COUNT_STEP)

					local var_3_12 = arg_3_0._event
					local var_3_13 = var_11.emit

					TouchCakeGameEvent = var_13

					var_3_13(var_3_12, var_13.PLAYER_DIZZI, var_1_10008)
				end
			end

			if var_3_2 and var_3_2 > 0 then
				local var_3_14 = arg_3_0.charController

				if not var_10.getGuard(var_3_14) then
					local var_3_15 = arg_3_0.effectController

					var_10.showBoom(var_3_15, var_3_2, 0.1)

					local var_3_16 = arg_3_0._event
					local var_3_17 = var_10.emit

					TouchCakeGameEvent = var_12

					var_3_17(var_3_16, var_12.PLAYER_BOOM)
				end
			end
		elseif arg_3_3 then
			arg_3_3(false)
		...
		if arg_3_1 == var_4.EVENT_ACTION_WIELD then
			...
			local var_3_18 = var_4.CriMgr.GetInstance()

			var_4.PlaySoundEffect_V3(var_3_18, var_0_5.SFX_COUNT_THROW)

			local var_3_19 = arg_3_0.cakeController

			var_4.touchBottomCake(var_3_19, arg_3_2, arg_3_3)
		else
			TouchCakeScene = var_4

			if arg_3_1 == var_4.EVENT_ACTION_CAKE and arg_3_2.cake.score and var_5 >= 0 then
				local var_3_20 = arg_3_0._event
				local var_3_21 = var_6.emit

				TouchCakeGameEvent = var_1_10008

				var_3_21(var_3_20, var_1_10008.ADD_COMBO)

				local var_3_22 = arg_3_0:getScore(var_5, var_0_5.comboNum)
				local var_3_23 = arg_3_0._event
				local var_3_24 = var_7.emit

				TouchCakeGameEvent = var_9

				var_3_24(var_3_23, var_9.ADD_SCORE, var_3_22)
			end
		end
	end
