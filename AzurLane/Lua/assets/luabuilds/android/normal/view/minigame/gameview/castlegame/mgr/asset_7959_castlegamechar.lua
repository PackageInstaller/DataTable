...
function var_0_0.initChar(arg_2_0)
	...
	arg_2_0.charTf = var_1(var_1_10002(arg_2_0._charTpl))
	Vector3 = var_1
	...
	typeof = var_3
	BoxCollider2D = var_4
	arg_2_0.collider = var_1(var_2_0, var_3(var_4))
	findTF = var_1
	...
	for iter_2_0 = 1, var_0_3 do
		...
		local var_2_1 = arg_2_0.raycastPoints

		Vector3 = var_1_10007

		var_1_10005(var_2_1, var_1_10007(0, 0, 0))
	end
	...
	var_1.LoadSkeletonData(var_0_2, function(arg_3_0)
		...
		var_1(var_3_3, var_3(arg_2_0.charTf, "zPos/char"))
		...
		typeof = var_4
		SpineAnimUI = var_5
		var_3_4.anim = var_3_6(var_3_5, var_4(var_5))
...
function var_0_0.setInGround(arg_4_0, arg_4_1)
	...
	if arg_4_0.char.floor then
		...
		var_4_2(var_4_1, var_1_10005(var_4_0, "zPos/top"))
	end
...
function var_0_0.setOutLandPoint(arg_5_0, arg_5_1)
	...
	local var_5_6 = var_8(var_5_1.x, var_5_1.y - var_5_4)
	...
	if arg_6_0.timeToOver then
		...
		if 0 < var_6_0 then
			...
			if arg_6_0.timeToOver <= 0 then
				...
				CastleGameView = var_1_10003

				var_6_3(var_6_2, var_1_10003.GAME_OVER)
			end
		end
	end
...
function var_0_0.updateAnim(arg_12_0)
	...
	elseif arg_12_0.fail then
		...
		local var_12_2 = var_1_10003.abs(arg_12_0.speed.x)

		math = var_4

		if var_12_1(var_12_2, var_4.abs(arg_12_0.speed.y)) > 120 then
			var_12_0 = var_0_4
		elseif var_2 > 0 then
			var_12_0 = var_0_5
		else
...
function var_0_0.setContent(arg_15_0, arg_15_1, arg_15_2)
	...
	Vector3 = var_4
	var_15_0.localScale = var_4(1, 1, 1)
...
function var_0_0.checkPlayerOutScreen(arg_19_0)
	...
	if var_1_10001.abs(arg_19_0.zPos.anchoredPosition.y) > 2000 then
		...
		var_19_1(var_19_0, var_1_10003.GAME_OVER)
	end
