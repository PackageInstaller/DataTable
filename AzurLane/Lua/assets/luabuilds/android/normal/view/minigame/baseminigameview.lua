...
function var_0_1.SendSuccess(arg_9_0, ...)
	...
	BaseMiniGameMediator = var_1_10003

	var_9_1(var_9_0, var_1_10003.MINI_GAME_SUCCESS, ...)
...
function var_0_1.SendFailure(arg_10_0, ...)
	...
	var_10_1(var_10_0, var_1_10003.MINI_GAME_FAILURE, ...)
...
function var_0_1.StoreDataToServer(arg_11_0, arg_11_1)
	...
	MiniGameConst = var_11_0

	if var_11_1 == var_11_0.MG_TYPE_2 then
		local var_11_2 = {
			arg_11_0.mg_data.id,
			2
		}
		...
		local var_11_6 = var_6.MINI_GAME_OPERATOR

		MiniGameOPCommand = var_7

		var_11_5(var_11_4, var_11_6, var_7.CMD_SPECIAL_GAME, var_11_2)
	end
...
function var_0_1.SendOperator(arg_12_0, arg_12_1, arg_12_2)
	...
	var_12_1(var_12_0, var_1_10005.MINI_GAME_OPERATOR, arg_12_1, arg_12_2)
...
function var_0_1.loadCoinLayer(arg_15_0)
	if not arg_15_0.coinLayer then
		...
		var_15_1(var_15_0, var_1_10003.MINI_GAME_COIN)
	end
...
function var_0_1.openCoinLayer(arg_17_0, arg_17_1)
	...
	var_17_1(var_17_0, var_1_10004.COIN_WINDOW_CHANGE, arg_17_1)
...
function var_0_1.checkTicktRemind(arg_18_0)
	...
	if var_1.ticketMaxTip(var_18_0) then
		GameRoomProxy = var_18_0

		if not var_18_0.ticket_remind then
			GameRoomProxy = var_2
