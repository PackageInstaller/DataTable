...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = arg_2_0.GetMGHubData(var_2_1)

	findTF = var_2_1
	arg_2_0.tplScoreTip = var_2_1(arg_2_0._tf, "tplScoreTip")
	findTF = var_3
	...
	local var_2_3 = var_3(arg_2_0.rollingUI, "dragAlphaGrid")

	RollingBallGrid = var_4
	arg_2_0.dragAlphaGrid = var_4.New(var_2_3)
	setActive = var_4

	local var_2_4 = arg_2_0.dragAlphaGrid

	var_4(var_5.getTf(var_2_4), false)
	...
	for iter_2_0 = var_2_5, var_5.horizontal do
		...
		for iter_2_1 = var_2_6, var_9.vertical do
			table = var_1_10012
	...
	arg_2_0.goodEffect = var_4.Find(var_2_7, "sanxiaoGood")

	local var_2_8 = arg_2_0._tf

	arg_2_0.greatEffect = var_4.Find(var_2_8, "sanxiaoGreat")

	local var_2_9 = arg_2_0._tf

	arg_2_0.perfectEffect = var_4.Find(var_2_9, "sanxiaoPerfect")
	findTF = var_4
	...
	local var_2_11 = var_6(arg_2_0.startUI, "btnStart")
	...
	var_4(var_2_10, var_2_11, var_2_12, var_8)
	...
	local var_2_14 = var_2_11(arg_2_0.startUI, "btnRule")
	...
	local function var_2_15()
		...
		pg = var_2_10003
		var_5_2.helps = var_2_10003.gametip.help_rollingBallGame.tip
	...
	var_4(var_2_13, var_2_14, var_2_15, var_8)
	...
	local var_2_17 = var_6(arg_2_0.scoreUI, "btnEnd")
	...
	var_4(var_2_16, var_2_17, var_2_18, var_8)
	...
	local var_2_19 = var_4(arg_2_0.downProgress, "Slider")
	local var_2_20 = var_4.GetComponent

	typeof = var_6
	Slider = var_2_18
	arg_2_0.downTimeSlider = var_2_20(var_2_19, var_6(var_2_18))
	findTF = var_4
	...
	local var_2_22 = var_6(arg_2_0.closeUI, "btnOk")
	...
	var_4(var_2_21, var_2_22, var_2_23, var_8)
	...
	local var_2_25 = var_2_22(arg_2_0.closeUI, "btnCancel")
	...
	var_4(var_2_24, var_2_25, var_2_26, var_8)
	...
	local var_2_28 = var_6(arg_2_0._tf, "btnClose")
	...
	var_4(var_2_27, var_2_28, var_2_29, var_8)
...
function var_0_1.showScoreUI(arg_11_0, arg_11_1)
	...
	if var_2.GetRuntimeData(var_11_0, "elements") then
		...
		if var_11_2 < arg_11_1 then
			...
			var_4(arg_11_0.scoreNew, true)
		else
			setActive = var_4

			var_4(arg_11_0.scoreNew, false)
		end

		var_11_2 = arg_11_1 < var_11_2 and var_11_2 or arg_11_1
		setActive = var_4

		var_4(arg_11_0.scoreUI, true)

		setText = var_4

		var_4(arg_11_0.labelCurScore, arg_11_1)

		setText = var_4

		var_4(arg_11_0.labelHigh, var_11_2)
...
function var_0_1.showCountStart(arg_12_0, arg_12_1)
	...
	local function var_12_2(arg_13_0)
		...
		local var_13_4 = var_3(var_13_3, var_2_10005(var_2_10006))

		seriesAsync = var_13_3

		var_13_3({
			function(arg_14_0)
				GetSpriteFromAtlasAsync = var_3_10001
				RollingBallConst = var_3_10002

				var_3_10001(var_3_10002.ui_atlas, "count_" .. var_13_0, function(arg_15_0)
				...
				local var_14_1 = var_14_0(var_2(var_13_2), 0, 1, 0.5)
				local var_14_2 = var_1.setOnUpdate

				System = var_3

				local var_14_3 = var_14_2(var_14_1, var_3.Action_float(function(arg_16_0)
				...
				var_14_4(var_14_3, var_3.Action(function()
					arg_14_0()
			...
			function(arg_18_0)
				...
				local var_18_1 = var_18_0(var_3_10002(var_13_2), 1, 0, 0.5)
				local var_18_2 = var_1.setOnUpdate

				System = var_3

				local var_18_3 = var_18_2(var_18_1, var_3.Action_float(function(arg_19_0)
				...
				var_18_4(var_18_3, var_3.Action(function()
					arg_18_0()
...
function var_0_1.gameStop(arg_25_0)
	...
	for iter_25_0 = #arg_25_0.effectDatas, 1, -1 do
		var_1_10006 = arg_25_0

		arg_25_0.returnEffect(var_1_10006, arg_25_0.effectDatas[iter_25_0].tf)
			...
			if not arg_30_0.gridDic[iter_30_0][iter_30_1] then
				...
				if iter_30_0 > 2 then
					...
					if var_30_4 == var_11.getType(var_30_5) then
						...
						var_30_6(var_30_7, var_12.getType(var_30_8))
					end
				end
				...
				if iter_30_1 > 2 then
					...
					if var_30_10 == var_11.getType(var_30_11) then
						...
						var_30_12(var_30_13, var_12.getType(var_30_14))
					end
				end
...
function var_0_1.onTimer(arg_33_0)
	for iter_33_0 = #arg_33_0.moveDatas, 1, -1 do
		...
		local var_33_3 = var_5.endX
		local var_33_4 = var_5.endY

		if var_33_1 == var_33_3 and var_33_2 == var_33_4 then
			var_6:setEventActive(true)
			...
			RollingBallConst = var_14

			if var_1_10013 < var_14.moveSpeed or var_33_3 == var_33_1 then
			...
			if var_1_10013 < var_14.moveSpeed or var_33_2 == var_33_4 then
				var_33_6 = 0
				var_33_2 = var_33_4
	...
	for iter_33_1 = #arg_33_0.effectDatas, 1, -1 do
		...
		var_5.ax = (arg_33_0.effectTargetPosition.x - var_33_7.x) * 0.002
		var_5.ay = (arg_33_0.effectTargetPosition.y - var_33_7.y) * 0.002
		var_5.vx = var_5.vx + var_5.ax
		var_5.vy = var_5.vy + var_5.ay
		var_33_7.x = var_33_7.x + var_5.vx
		var_33_7.y = var_33_7.y + var_5.vy
		var_5.tf.localPosition = var_33_7

		if var_33_7.x < arg_33_0.effectTargetPosition.x then
			arg_33_0:returnEffect(var_5.tf)
	...
	if arg_33_0.onBeginDragTime and arg_33_0.downTime > 0 then
		...
		if arg_33_0.downTime <= 0 then
			...
			if arg_33_0.selectGrid then
				iter_33_1 = arg_33_0.selectGrid

				var_2.onEndDrag(iter_33_1)

				iter_33_1 = arg_33_0

				arg_33_0.onGridUp(iter_33_1, var_2)

				iter_33_1 = var_2

				var_2.addUpCallback(iter_33_1, function(arg_34_0, arg_34_1)
				...
				var_2.addDragCallback(iter_33_1, function(arg_35_0, arg_35_1)
	...
	local var_33_15 = var_33_14(iter_33_1.floor(arg_33_0.gameTime % 1000) / 10) < 10 and "0" .. var_33_15 or var_33_15
...
function var_0_1.moveGridToPos(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	local var_38_2 = arg_38_2 - 1

	RollingBallConst = var_1_10007

	local var_38_3 = var_38_2 * var_1_10007.grid_width
	local var_38_4 = arg_38_3 - 1

	RollingBallConst = var_1_10008

	local var_38_5 = var_38_4 * var_1_10008.grid_height

	math = var_8

	local var_38_6 = var_8.floor(var_38_3)

	math = var_9

	if var_38_6 == var_9.floor(arg_38_2) then
		math = var_38_6

		local var_38_7 = var_38_6.floor(var_38_5)

		math = var_9

		if var_38_7 == var_9.floor(arg_38_3) then
			return
		end
	end
	...
	arg_38_1.setEventActive(var_38_8, false)
	...
	var_38_8.insert(arg_38_0.moveDatas, var_38_9)
	...
	local function var_40_1(arg_41_0, arg_41_1)
		for iter_41_0 = 1, #var_40_0 do
			...
			if var_41_1 == arg_41_0 and var_41_2 == arg_41_1 then
				...
				return var_2_10008.remove(var_40_0, iter_41_0)
			end
		end
	...
	for iter_40_2 = 1, #arg_40_0.gridDic do
		for iter_40_3 = 1, #arg_40_0.gridDic[iter_40_2] do
			if arg_40_0.gridDic[iter_40_2][iter_40_3] == false then
				...
				var_12(var_40_4 ~= nil, "异常，位置x:" .. iter_40_2 .. "y:" .. iter_40_3 .. "处珠子不存在，考虑是否在交换位置时设置了错误的格子数据")
...
function var_0_1.checkSuccessGrid(arg_42_0)
	...
	arg_42_0.updateRemoveFlag(var_42_1)
	...
	var_42_1({
			...
			for iter_43_0 = var_43_0, var_2_10002.horizontal do
				...
				for iter_43_1 = var_43_1, var_2_10006.vertical do
					...
					if var_9:getRemoveFlagV() or var_9:getRemoveFlagH() then
						...
						local var_43_6 = var_42_2[var_43_3]

						var_43_6.amount = var_42_2[var_43_3].amount + 1
						table = var_43_6

						var_43_6.insert(var_42_2[var_43_3].posList, {
							x = var_43_4,
							y = var_43_5
						})
		...
		function(arg_44_0)
			if var_42_0 then
				...
				local var_44_1 = var_2_10002(arg_42_0.rollingUI)
				local var_44_2 = 0.7

				System = var_2_10004

				var_44_0(var_44_1, var_44_2, var_2_10004.Action(function()
					arg_44_0()
				...
				var_1.updateScore(var_44_3, var_42_2)
...
function var_0_1.updateCombo(arg_48_0)
	...
	if arg_48_0.comboAmount == 2 then
		...
		local var_48_0 = var_1.CriMgr.GetInstance()
	...
	elseif arg_48_0.comboAmount == 3 then
		...
		local var_48_1 = var_1.CriMgr.GetInstance()

		var_1.PlaySoundEffect_V3(var_48_1, var_0_5)
	elseif arg_48_0.comboAmount >= 4 then
		...
		var_1.PlaySoundEffect_V3(var_48_2, var_0_6)
	end

	local var_48_3 = arg_48_0.comboAmount

	if 1 < var_48_3 then
		LeanTween = var_48_3

		local var_48_4 = var_48_3.isTweening

		go = var_2

		local var_48_5

		if var_48_4(var_2(arg_48_0.caidaiTf)) then
			LeanTween = var_48_5
			var_48_5 = var_48_5.cancel
			go = var_2

			var_48_5(var_2(arg_48_0.caidaiTf))
		end

		LeanTween = var_48_5

		local var_48_6 = var_48_5.delayedCall

		go = var_2

		local var_48_7 = var_2(arg_48_0.caidaiTf)
		local var_48_8 = 3

		System = var_1_10004

		var_48_6(var_48_7, var_48_8, var_1_10004.Action(function()
			setActive = var_2_10000
		...
		var_48_6(arg_48_0.caidaiTf, true)
	end
...
function var_0_1.updateScore(arg_50_0, arg_50_1)
	...
	local var_50_5 = var_5(arg_50_0.labelGameScore)
	local var_50_6 = 0.7

	System = iter_50_2

	var_50_4(var_50_5, var_50_6, iter_50_2.Action(function()
		...
		if var_51_0(var_2_10001(arg_50_0.labelGameScore)) then
			LeanTween = var_0
			...
			var_51_1(var_1(arg_50_0.labelGameScore))
		end
		...
		local var_51_5 = var_51_4(var_2_10003(arg_50_0.labelGameScore), var_51_2, var_51_3, 1.7)
		local var_51_6 = var_2.setOnUpdate

		System = var_4

		local var_51_7 = var_51_6(var_51_5, var_4.Action_float(function(arg_52_0)
			setText = var_3_10001
			...
			var_3_10001(var_52_0, var_3_10003.floor(arg_52_0))
		...
		var_51_8(var_51_7, var_4.Action(function()
			setText = var_3_10000
		...
		if arg_55_2 < var_4.horizontal - 1 then
			...
			if var_55_0 and var_55_0 >= 3 then
				if not var_55_2 then
					var_1_10009 = arg_55_0
					var_55_2 = arg_55_0.getGridRemoveId(var_1_10009)
				end
...
function var_0_1.onGridDrag(arg_60_0, arg_60_1, arg_60_2, arg_60_3)
	...
	RollingBallConst = var_7

	local var_60_5 = var_60_4 - var_7.grid_width / 2
	local var_60_6 = var_5.y

	RollingBallConst = var_1_10008

	local var_60_7 = var_60_6 - var_1_10008.grid_height / 2
	...
	if var_60_14(var_60_13, var_10.getPosition(var_60_15)) and var_8 ~= arg_60_0.selectGrid then
		...
		if var_60_23 + var_16.abs(var_60_22) == 1 then
...
function var_0_1.updateMove(arg_61_0, arg_61_1, arg_61_2)
	...
	if not (var_1_10003.horizontal < arg_61_1) then
		...
		var_61_1(var_61_0, var_61_2, var_61_3, var_7.getType(var_61_4))
...
function var_0_1.getGridByPosition(arg_62_0, arg_62_1)
	...
	local var_62_2 = var_62_1 + var_1_10004.grid_width / 2

	RollingBallConst = var_4

	local var_62_3 = var_62_0(var_62_2 / var_4.grid_width) + 1

	math = var_3

	local var_62_4 = var_3.floor
	local var_62_5 = arg_62_1.y

	RollingBallConst = var_1_10005

	local var_62_6 = var_62_5 + var_1_10005.grid_height / 2

	RollingBallConst = var_5

	local var_62_7 = var_62_4(var_62_6 / var_5.grid_height) + 1
...
function var_0_1.createGrid(arg_65_0, arg_65_1, arg_65_2, arg_65_3)
	...
	local var_65_2 = #arg_65_0.gridsPool

	if 0 < var_65_2 then
		table = var_65_2
		var_65_0 = var_65_2.remove(arg_65_0.gridsPool, 1)
	else
		RollingBallGrid = var_65_2

		local var_65_3 = var_65_2.New

		tf = var_7
		Instantiate = var_1_10008

		local var_65_4 = var_65_3(var_7(var_1_10008(arg_65_0.tplGrid)))

		var_65_0.addDownCallback(var_65_4, function(arg_66_0, arg_66_1)
...
function var_0_1.setDragAlpha(arg_70_0, arg_70_1, arg_70_2, arg_70_3)
	...
	var_6(var_7.getTf(var_70_6), true)
...
function var_0_1.clearDragAlpha(arg_71_0)
	...
	var_1_10001(var_2.getTf(var_71_0), false)
...
function var_0_1.getRandomType(arg_74_0, arg_74_1)
	...
	return var_74_1(var_74_2, var_1_10004.grid_type_amount)
end
...
function var_0_1.addGridScoreTip(arg_75_0, arg_75_1, arg_75_2)
	...
	local var_75_3 = var_75_0 - 1

	RollingBallConst = var_1_10007

	local var_75_4 = var_75_3 * var_1_10007.grid_width
	local var_75_5 = var_75_1 - 1

	RollingBallConst = var_1_10008

	local var_75_6 = var_75_5 * var_1_10008.grid_height

	Vector3 = var_8
	var_75_2.localPosition = var_8(var_75_4, var_75_6, 0)
	setText = var_8
	findTF = var_9

	var_8(var_9(var_75_2, "text"), "+" .. arg_75_2)

	LeanTween = var_8

	local var_75_7 = var_8.moveLocalY

	go = var_9

	local var_75_8 = var_75_7(var_9(var_75_2), var_75_6 + 30, 0.5)
	local var_75_9 = var_8.setOnComplete

	System = var_10

	var_75_9(var_75_8, var_10.Action(function()
		local var_76_0 = arg_75_0

		var_0.returnScoreTip(var_76_0, var_75_2)
...
function var_0_1.addRemoveEffect(arg_77_0, arg_77_1)
	...
	local var_77_3 = var_77_0 - 1

	RollingBallConst = var_1_10006

	local var_77_4 = var_77_3 * var_1_10006.grid_width
	local var_77_5 = var_77_1 - 1

	RollingBallConst = var_1_10007

	local var_77_6 = var_77_5 * var_1_10007.grid_height

	Vector3 = var_7
	var_77_2.localPosition = var_7(var_77_4 + 50, var_77_6 + 50, -350)
	LeanTween = var_7

	local var_77_7 = var_7.delayedCall

	go = var_8

	local var_77_8 = var_8(var_77_2)
	local var_77_9 = 0.7

	System = var_10

	var_77_7(var_77_8, var_77_9, var_10.Action(function()
		local var_78_0 = arg_77_0

		var_0.returnRemoveEffect(var_78_0, var_77_2)
...
function var_0_1.getRemoveEffect(arg_79_0)
	...
	local var_79_0
	local var_79_1 = #arg_79_0.removeEffectPool

	if 1 < var_79_1 then
		table = var_79_1
		var_79_0 = var_79_1.remove(arg_79_0.removeEffectPool, #arg_79_0.removeEffectPool)
	else
		tf = var_79_1
		Instantiate = var_3
		var_79_0 = var_79_1(var_3(arg_79_0.tplRemoveEffect))
		setParent = var_79_1

		var_79_1(var_79_0, arg_79_0.rollingEffectUI, false)

		table = var_79_1

		var_79_1.insert(arg_79_0.removeEffects, var_79_0)
	end

	setActive = var_79_1

	var_79_1(var_79_0, true)
...
function var_0_1.getScoreTip(arg_81_0)
	...
	local var_81_0
	local var_81_1 = #arg_81_0.scoreTipPool

	if 1 < var_81_1 then
		table = var_81_1
		var_81_0 = var_81_1.remove(arg_81_0.scoreTipPool, #arg_81_0.scoreTipPool)
	else
		tf = var_81_1
		Instantiate = var_3
		var_81_0 = var_81_1(var_3(arg_81_0.tplScoreTip))
		setParent = var_81_1

		var_81_1(var_81_0, arg_81_0.rollingEffectUI, false)

		table = var_81_1

		var_81_1.insert(arg_81_0.scoreTips, var_81_0)
	end

	setActive = var_81_1

	var_81_1(var_81_0, true)
...
function var_0_1.addEffect(arg_83_0, arg_83_1)
	...
	local var_83_2 = arg_83_0
	local var_83_3 = arg_83_0.getEffect(var_83_2)

	setParent = var_83_2

	var_83_2(var_83_3, arg_83_0.effectUI, false)

	setActive = var_83_2

	var_83_2(var_83_3, true)

	var_83_3.localPosition = var_83_1
	table = var_83_2

	var_83_2.insert(arg_83_0.effectDatas, {
		vx = 2,
		ax = 0,
		ay = 0,
		vy = 2,
...
function var_0_1.getEffect(arg_85_0)
	local var_85_0 = #arg_85_0.effectPool

	if 0 < var_85_0 then
		table = var_85_0

		return var_85_0.remove(arg_85_0.effectPool, #arg_85_0.effectPool)
	end

	tf = var_85_0
	Instantiate = var_2

	return (var_85_0(var_2(arg_85_0.tplEffect)))
end
...
function var_0_1.willExit(arg_89_0)
	...
	if var_89_0(var_1_10002(arg_89_0.caidaiTf)) then
		LeanTween = var_89_1
		var_89_1 = var_89_1.cancel
		go = var_2

		var_89_1(var_2(arg_89_0.caidaiTf))
	end
	...
	if var_89_2(var_2(arg_89_0.labelGameScore)) then
		LeanTween = var_89_3
		var_89_3 = var_89_3.cancel
		go = var_2

		var_89_3(var_2(arg_89_0.labelGameScore))
	end
	...
	if var_89_4(var_2(arg_89_0.rollingUI)) then
		LeanTween = var_1
		...
		var_89_5(var_2(arg_89_0.rollingUI))
	end
	...
	if arg_89_0.scoreTips then
		for iter_89_0 = 1, #arg_89_0.scoreTips do
			...
			if var_1_10005(var_1_10006(arg_89_0.scoreTips[iter_89_0])) then
				LeanTween = var_1_10005
				var_1_10005 = var_1_10005.cancel
				go = var_1_10006

				var_1_10005(var_1_10006(arg_89_0.scoreTips[iter_89_0]))
			end
		end
	end
	...
	if arg_89_0.removeEffects then
		for iter_89_1 = 1, #arg_89_0.removeEffects do
			...
			if var_1_10005(var_1_10006(arg_89_0.removeEffects[iter_89_1])) then
				LeanTween = var_1_10005
				var_1_10005 = var_1_10005.cancel
				go = var_1_10006

				var_1_10005(var_1_10006(arg_89_0.removeEffects[iter_89_1]))
			end
		end
	end
