...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.sceneRoadTF = var_1_1(var_1_0, var_1_10005.SCENE_ROAD_NAME)

	local var_1_2 = arg_1_1
	local var_1_3 = arg_1_1.GetRoadList

	CrossRoadGameConst = var_5
	arg_1_0.sceneRoadList = var_1_3(var_1_2, var_5.SCENE_ROAD_NAME)
...
function var_0_0.Step(arg_2_0, arg_2_1)
	...
	CrossRoadGameConst = var_2_0

	for iter_2_0 = var_2_1, var_2_0.GAME_TRACK_COUNT do
		ipairs = var_1_10006
...
function var_0_0.UpdateCarRunningState(arg_3_0, arg_3_1)
	...
	local var_3_1 = arg_3_1.GetTrack(var_3_0)

	CrossRoadGameConst = var_3_0

	if var_3_1 == var_3_0.BACK_ROAD_NAME then
		arg_3_0:SetCarInSceneTrack(arg_3_1)
	else
		CrossRoadGameConst = var_3

		if var_3_1 == var_3.SCENE_ROAD_NAME then
			arg_3_0:SetCarInFrontTrack(arg_3_1)
		else
			CrossRoadGameConst = var_3

			if var_3_1 == var_3.FRONT_ROAD_NAME then
				arg_3_1:SetDispose(true)
			else
				CrossRoadGameConst = var_3

				if var_3_1 == var_3.SP_ROAD_NAME then
...
function var_0_0.SetSpCarState(arg_4_0, arg_4_1)
	if arg_4_1:GetState() == arg_4_0.spCarState.start then
		local var_4_0 = arg_4_1
		local var_4_1 = arg_4_1.GetId(var_4_0)
...
function var_0_0.SetCarInSceneTrack(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_6_2(var_6_1, var_1_10005(var_6_0))
	...
	if var_6:CheckIsSPCar(arg_6_1:GetId()) then
		...
		var_6_7(var_6_6, var_8.SP_ROAD_NAME)
		...
		var_6_9(var_6_8, var_8.SCENE_ROAD_NAME)
	end
...
function var_0_0.SetCarInFrontTrack(arg_7_0, arg_7_1)
	...
	local var_7_1 = arg_7_1.GetTrackID(var_7_0)

	CrossRoadGameHelper = var_7_0

	if var_7_0:CheckIsSPCar(arg_7_1:GetId()) then
		var_7_1 = arg_7_1:GetSpTrackId()
	end

	local var_7_2 = arg_7_0.sceneRoadList[var_7_1].midTF.anchoredPosition
	local var_7_3 = arg_7_0.sceneRoadList[var_7_1].endTF.anchoredPosition

	arg_7_1:SetPosition(var_7_2)
	arg_7_1:SetTarget(var_7_3)
	arg_7_1:SetDirect({
		0,
		-1
	})
	...
	local var_7_5 = arg_7_1.SetTrack

	CrossRoadGameConst = var_7

	var_7_5(var_7_4, var_7.FRONT_ROAD_NAME)
...
function var_0_0.UpdateCarMove(arg_8_0, arg_8_1, arg_8_2)
	...
	CrossRoadGameConst = var_1_10011

	local var_8_9

	if var_8_5 == var_1_10011.SCENE_ROAD_NAME then
		var_8_7 = arg_8_0:GetCarNowAddScale(var_8_0, var_8_4)

		local var_8_8 = arg_8_1

		var_8_9 = arg_8_1.SetScale
		Vector3 = var_13

		var_8_9(var_8_8, var_13(var_8_7, var_8_7, 1))

		var_8_2 = arg_8_0:GetNorCarDirct(var_8_0, var_8_4)
	else
		CrossRoadGameConst = var_8_9

		if var_8_5 == var_8_9.FRONT_ROAD_NAME then
			...
			if var_8_5 == var_11.SP_ROAD_NAME then
				...
				local var_8_11 = arg_8_1.SetScale

				Vector3 = var_13

				var_8_11(var_8_10, var_13(var_8_7, var_8_7, 1))
	...
	local var_8_12 = var_8_7 * arg_8_0:GetCarSpeed(arg_8_1, var_8_2)
	local var_8_13 = {
		var_8_12 * var_8_2[1] * arg_8_2,
		var_8_12 * var_8_2[2] * arg_8_2
	}

	Vector2 = var_12

	local var_8_14 = var_12(var_8_0.x + var_8_13[1], var_8_0.y + var_8_13[2])

	CrossRoadGameConst = var_13

	if var_8_5 == var_13.FRONT_ROAD_NAME then
		arg_8_0:SpCarCheckAndMakeItem(arg_8_1, var_8_14, var_8_0)
	...
	if var_13:OnSeg(var_8_14, var_8_3, var_8_0) then
		arg_8_0:UpdateCarRunningState(arg_8_1)
	else
		arg_8_1:SetPosition(var_8_14)
	end
...
function var_0_0.SpCarCheckAndMakeItem(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	if var_4:isMiddle(arg_9_3.y, arg_9_0.itemLine, arg_9_2.y) and arg_9_0:CanSpCarMakeItem(arg_9_1) then
		...
		local var_9_2 = arg_9_1.GetId(var_9_1)

		CrossRoadGameConst = var_9_1

		local var_9_3

		if var_9_2 == var_9_1.XINZEXI then
			var_9_3 = arg_9_1

			arg_9_1.SetSpCarAction(var_9_3, function()
				local var_10_0 = arg_9_0._event

				CrossRoadGameConst = var_2_10001

				var_10_0(var_2_10001.MAKE_BING_MIAN, var_9_0)
			...
			CrossRoadGameConst = var_9_3

			var_9_4(var_9_3.MAKE_XUAN_WO, var_9_0)
		end
	end
...
function var_0_0.CanSpCarMakeItem(arg_12_0, arg_12_1)
	...
	local var_12_3 = arg_12_1.GetId(var_12_2)

	CrossRoadGameConst = var_12_2

	if var_12_3 == var_12_2.XINZEXI then
		CrossRoadGameConst = var_12_3
		var_12_1 = var_12_3.BINGMIAN_MAKE_PROBABILITY
	else
		CrossRoadGameConst = var_12_3
		var_12_1 = var_12_3.XUANWO_MAKE_PROBABILITY
	end
...
function var_0_0.GetCarSpeed(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_1 = arg_20_1.GetSpeed(var_20_0)

	math = var_20_0

	return var_20_1 / var_20_0.abs(arg_20_2[2])
end

function var_0_0.GetSpCarDirct(arg_21_0, arg_21_1)
	local var_21_0 = arg_21_1:GetTarget()
	local var_21_1 = arg_21_1
	local var_21_2 = arg_21_1.GetPosition(var_21_1)

	CrossRoadGameHelper = var_21_1

	local var_21_3 = var_21_1:GetPosDis(var_21_0, var_21_2)

	return {
		(var_21_0.x - var_21_2.x) / var_21_3,
		(var_21_0.y - var_21_2.y) / var_21_3
	}
end
