...
function var_0_1.initData(arg_23_0)
	...
	var_23_0(var_1_10002.night_type)
...
function var_0_1.initUI(arg_27_0)
	...
	local function var_27_30()
		...
		var_37_2.helps = var_3.getGameRoomData(var_37_3).game_help
...
function var_0_1.showSettlement(arg_67_0)
	...
	local var_67_3 = var_67_1(var_4)
	local var_67_4 = var_3.getRoomScore(var_67_3, arg_67_0:getGameRoomData().id)

	setActive = var_67_3
	findTF = var_5

	var_67_3(var_5(arg_67_0.settlementUI, "ad/new"), var_67_4 < var_67_2)
	...
	local var_67_5 = var_67_3(arg_67_0.settlementUI, "ad/highText")

	findTF = var_5

	local var_67_6 = var_5(arg_67_0.settlementUI, "ad/currentText")
