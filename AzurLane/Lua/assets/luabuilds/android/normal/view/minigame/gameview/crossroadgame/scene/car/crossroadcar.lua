...
function var_0_0.SetCarCrashList(arg_8_0, arg_8_1)
	...
	var_8_2(var_8_1, var_1_10005(-1 / var_8_0, 1 / var_8_0, 1))
	...
	var_8_6(var_8_5, var_7(var_8_3.x - var_8_4.x, 0))
...
function var_0_0.GetSpeed(arg_17_0)
	...
	if var_17_2(var_17_3, #var_1_10004.CAR_SPEED_SCALE) < 1 then
		var_17_4 = 0
	else
