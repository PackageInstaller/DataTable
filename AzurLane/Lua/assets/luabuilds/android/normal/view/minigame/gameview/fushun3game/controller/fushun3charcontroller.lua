...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5)
	...
	arg_1_0._dftEvent = var_6(var_1_0, var_8(var_1_10009))
	findTF = var_6
	...
	LayerMask = var_7
	var_1_1.layer = var_7.NameToLayer("Character")
	...
	var_6.SetTriggerEvent(var_1_2, function()
		...
		if var_1.GetCurrentAnimatorClipInfo(var_2_1, 0) then
			local var_2_2 = var_1.Length

			if 0 < var_2_2 then
				ReflectionHelp = var_2_2

				local var_2_3 = var_2_2.RefGetProperty

				typeof = var_3
				var_2_0 = var_2_3(var_3("UnityEngine.AnimatorClipInfo"), "clip", var_1[0])
			end
		end

		if var_2_0 then
			local var_2_4 = arg_1_0._event
			local var_2_5 = var_2.emit

			Fushun3GameEvent = var_2_10004

			var_2_5(var_2_4, var_2_10004.add_anim_effect_call, {
	...
	local var_1_3 = var_7(arg_1_0._charItemCatchTf, "catch")

	typeof = var_8
	Animator = var_9
	arg_1_0._charItemCatch = var_6(var_1_3, var_8(var_9))
	findTF = var_6
	...
	typeof = var_8
	Animator = var_9
	arg_1_0._animator = var_6(var_1_4, var_8(var_9))

	local var_1_5 = arg_1_0._rectCollider
	local var_1_6 = var_6.getScript

	FuShunPowerSpeedScript = var_8
	arg_1_0._powerScript = var_1_6(var_1_5, var_8)

	local var_1_7 = arg_1_0._rectCollider
	local var_1_8 = var_6.getScript

	FuShunJumpScript = var_8
	arg_1_0._jumpScript = var_1_8(var_1_7, var_8)

	local var_1_9 = arg_1_0._rectCollider
	local var_1_10 = var_6.getScript

	FuShunDamageScript = var_8
	arg_1_0._damageScript = var_1_10(var_1_9, var_8)

	local var_1_11 = arg_1_0._rectCollider
	local var_1_12 = var_6.getScript

	FuShunAttakeScript = var_8
	arg_1_0._attackScript = var_1_12(var_1_11, var_8)
	LayerMask = var_6
	...
	typeof = var_8
	BoxCollider2D = var_9
	arg_1_0._damageCollider = var_6(var_1_13, var_8(var_9))
	arg_1_0._attackCd = nil

	local var_1_14 = arg_1_0._event
	local var_1_15 = var_6.bind

	Fushun3GameEvent = var_8

	var_1_15(var_1_14, var_8.script_jump_event, function()
	...
	var_1_17(var_1_16, var_8.script_attack_event, function()
		if arg_1_0._attackCd == 0 and arg_1_0.damageCd == 0 then
			...
			Fushun3GameConst = var_4_0
			var_4_1._attackCd = var_4_0.attack_cd
			...
			if var_4_3(var_4_2, var_2.buff_weapon) then
				math = var_4_4
				...
				Fushun3GameEvent = var_2_10003

				var_4_6(var_4_5, var_2_10003.create_item_call, {
					name = var_4_4,
				...
				var_1.SetTrigger(var_4_5, "attack")
			else
				pg = var_4_4
				...
				Fushun3GameConst = var_4_7
				var_4_9._attackTime = var_4_7.attack_time
			end
		end
	...
	var_1_19(var_1_18, var_8.script_power_event, function(arg_5_0, arg_5_1, arg_5_2)
	...
	if var_6.isEditor then
		if not arg_1_0.handle then
			...
			arg_1_0.handle = var_6:CreateListener(function()
				...
				if var_6_0(var_2_10001.Y) then
					var_6_1 = 1

					local var_6_2 = arg_1_0

					var_6_3 = var_6_3.getBuffById
					Fushun3GameConst = var_2_10003

					if var_6_3(var_6_2, var_2_10003.buff_data[var_6_1].id) then
						local var_6_4 = arg_1_0

						var_6_3 = var_6_3.removeBuff
						Clone = var_2_10003
						Fushun3GameConst = var_2_10004

						var_6_3(var_6_4, var_2_10003(var_2_10004.buff_data[var_6_1]))
					else
						local var_6_5 = arg_1_0

						var_6_3 = var_6_3.addBuff
						Clone = var_2_10003
						Fushun3GameConst = var_2_10004

						var_6_3(var_6_5, var_2_10003(var_2_10004.buff_data[var_6_1]))
					end
				else
					Input = var_6_1

					local var_6_6 = var_6_1.GetKeyDown

					KeyCode = var_6_3

					local var_6_7, var_6_8

					if var_6_6(var_6_3.U) then
						var_6_7 = 2
						Fushun3GameConst = var_6_8
						var_6_8 = var_6_8.buff_data[var_6_7]
						var_2_10003 = arg_1_0

						if var_2.getBuffById(var_2_10003, var_6_8.id) then
							var_2_10003 = arg_1_0

							local var_6_9 = var_2.removeBuff

							Clone = var_2_10004
							Fushun3GameConst = var_2_10005

							var_6_9(var_2_10003, var_2_10004(var_2_10005.buff_data[var_6_7]))
						else
							var_2_10003 = arg_1_0

							local var_6_10 = var_2.addBuff

							Clone = var_2_10004
							Fushun3GameConst = var_2_10005

							var_6_10(var_2_10003, var_2_10004(var_2_10005.buff_data[var_6_7]))
						end
					else
						Input = var_6_7

						local var_6_11 = var_6_7.GetKeyDown

						KeyCode = var_6_8

						local var_6_12, var_6_14

						if var_6_11(var_6_8.I) then
							var_6_12 = 4

							local var_6_13 = arg_1_0

							var_6_14 = var_6_14.getBuffById
							Fushun3GameConst = var_2_10003

							if var_6_14(var_6_13, var_2_10003.buff_data[var_6_12].id) then
								local var_6_15 = arg_1_0

								var_6_14 = var_6_14.removeBuff
								Clone = var_2_10003
								Fushun3GameConst = var_2_10004

								var_6_14(var_6_15, var_2_10003(var_2_10004.buff_data[var_6_12]))
							else
								local var_6_16 = arg_1_0

								var_6_14 = var_6_14.addBuff
								Clone = var_2_10003
								Fushun3GameConst = var_2_10004

								var_6_14(var_6_16, var_2_10003(var_2_10004.buff_data[var_6_12]))
							end
						else
							Input = var_6_12

							local var_6_17 = var_6_12.GetKeyDown

							KeyCode = var_6_14

							if var_6_17(var_6_14.O) then
								local var_6_18 = 5
								...
								var_6_20(var_6_19, var_2_10003(var_2_10004.buff_data[var_6_18]))
							end
						end
					end
				end
...
function var_0_0.start(arg_7_0)
	...
	Fushun3GameConst = var_7_2
	var_7_3.anchoredPosition = var_7_2.char_init_pos
	arg_7_0.buffList = {}
	...
	var_7_5(var_7_4, var_3.buff_shield)
...
function var_0_0.step(arg_8_0)
	if arg_8_0._charTf.anchoredPosition.y >= 1200 or arg_8_0._charTf.anchoredPosition.y <= -200 then
		...
		if 0 < var_8_0 then
			...
			local var_8_3 = var_1.emit

			Fushun3GameEvent = var_1_10003

			var_8_3(var_8_2, var_1_10003.game_over_call)
		end

		return
	end

	local var_8_4 = arg_8_0._powerSlider
	local var_8_5 = arg_8_0.power

	Fushun3GameConst = var_1_10003
	var_8_4.value = var_8_5 / var_1_10003.power_max_num

	local var_8_6 = arg_8_0._animator

	var_1.SetBool(var_8_6, "below", arg_8_0._collisionInfo.below)

	local var_8_7 = arg_8_0._collisionInfo
	local var_8_8 = var_1.getVelocity(var_8_7)
	local var_8_9 = arg_8_0._animator

	var_2.SetFloat(var_8_9, "moveAmountX", var_8_8.x)

	local var_8_10 = arg_8_0._animator

	var_2.SetFloat(var_8_10, "moveAmountY", var_8_8.y)

	local var_8_11 = arg_8_0._attackCd

	if 0 < var_8_11 then
		local var_8_12 = arg_8_0._attackCd

		Time = var_3
		arg_8_0._attackCd = var_8_12 - var_3.deltaTime
	...
	if 0 < var_8_13 then
		local var_8_14 = arg_8_0._powerTime

		Time = var_3
		arg_8_0._powerTime = var_8_14 - var_3.deltaTime
	...
	for iter_8_0 = #arg_8_0.buffList, 1, -1 do
		if arg_8_0.buffList[iter_8_0].time then
			local var_8_15 = var_6.time

			Time = var_1_10008
			var_6.time = var_8_15 - var_1_10008.deltaTime

			if var_6.time <= 0 then
				var_1_10008 = arg_8_0

				arg_8_0.removeBuff(var_1_10008, var_6)
			end
		end
	end
	...
	for iter_8_1, iter_8_2 in var_3(arg_8_0._collisionInfo.horizontalLeftTfs) do
		...
		var_1_10008.insert(var_8_16, iter_8_2)
	end
	...
	for iter_8_3, iter_8_4 in var_3(arg_8_0._collisionInfo.horizontalRightTfs) do
		...
		var_1_10008.insert(var_8_16, iter_8_4)
	end
	...
	for iter_8_5, iter_8_6 in var_4(arg_8_0._collisionInfo.verticalBottomTfs) do
		table = var_1_10009

		var_1_10009.insert(var_8_17, iter_8_6)
	end

	if #var_8_16 > 0 then
		local var_8_18 = arg_8_0
		local var_8_19 = arg_8_0.getBuff

		Fushun3GameConst = var_6

		if var_8_19(var_8_18, var_6.buff_power_speed) then
			for iter_8_7 = 1, #var_8_16 do
				go = iter_8_6

				if iter_8_6(var_8_16[iter_8_7]).layer == arg_8_0._monsterLayer then
					var_1_10009 = arg_8_0._event
					iter_8_6 = iter_8_6.emit
					Fushun3GameEvent = var_1_10010

					iter_8_6(var_1_10009, var_1_10010.power_damage_monster_call, {
						tf = var_8_16[iter_8_7]
					})
				end
			end
		else
			for iter_8_8 = 1, #var_8_16 do
				if arg_8_0._powerTime == 0 then
					go = iter_8_6

					if iter_8_6(var_8_16[iter_8_8]).layer == arg_8_0._monsterLayer and arg_8_0.damageCd == 0 then
						var_1_10009 = arg_8_0._event
						iter_8_6 = iter_8_6.emit
						Fushun3GameEvent = var_1_10010

						iter_8_6(var_1_10009, var_1_10010.check_player_damage, {
							tf = var_8_16[iter_8_8],
				...
				if iter_8_6(var_8_16[iter_8_8], "high_roof") then
					setActive = var_1_10009
					findTF = var_1_10010

					var_1_10009(var_1_10010(var_8_16[iter_8_8], "high_roof"), false)

					var_1_10010 = arg_8_0._collisionInfo

					var_1_10009.changeVelocity(var_1_10010, 0, arg_8_0._collisionInfo.config.minJumpVelocity, nil)

					if arg_8_0._powerTime == 0 and arg_8_0.damageCd == 0 then
						var_1_10010 = arg_8_0

						arg_8_0.damageChar(var_1_10010)
					end
				end
	...
	elseif var_8_17 and #var_8_17 > 0 then
		for iter_8_9 = 1, #var_8_17 do
			go = iter_8_6

			if iter_8_6(var_8_17[iter_8_9]).layer == arg_8_0._monsterLayer then
				var_1_10009 = arg_8_0
				iter_8_6 = arg_8_0.getBuff
				Fushun3GameConst = var_1_10010

				if iter_8_6(var_1_10009, var_1_10010.buff_speed) then
					var_1_10009 = arg_8_0._event
					iter_8_6 = iter_8_6.emit
					Fushun3GameEvent = var_1_10010

					iter_8_6(var_1_10009, var_1_10010.kick_damage_monster_call, {
						tf = var_8_17[iter_8_9],
	...
	if 0 < var_8_22 then
		var_8_23 = arg_8_0._event

		local var_8_24 = var_4.emit

		Fushun3GameEvent = var_6

		var_8_24(var_8_23, var_6.player_attack_call, {
			...
			callback = function(arg_12_0)
				if arg_12_0 then
					...
					var_12_1(var_12_0, var_2_10003.add_effect_call, {
		...
		local var_8_25 = arg_8_0._attackTime

		Time = var_8_23
		arg_8_0._attackTime = var_8_25 - var_8_23.deltaTime
		arg_8_0._attackTime = arg_8_0._attackTime <= 0 and 0 or arg_8_0._attackTime
	end

	local var_8_26 = arg_8_0.power

	Fushun3GameConst = var_8_23

	local var_8_28

	if var_8_26 == var_8_23.power_max_num and not arg_8_0.powerFlag then
		local var_8_27 = arg_8_0._charTf.anchoredPosition.y

		if 200 <= var_8_27 then
			arg_8_0.powerFlag = true
			var_8_28 = arg_8_0._event

			local var_8_29 = var_4.emit

			Fushun3GameEvent = var_6

			var_8_29(var_8_28, var_6.power_speed_call)

			if not arg_8_0.powerBuff then
				local var_8_30 = 1

				Fushun3GameConst = var_8_28

				for iter_8_10 = var_8_30, #var_8_28.buff_data do
					...
					if iter_8_6 == var_1_10009.buff_power_speed then
						Clone = iter_8_6
						Fushun3GameConst = var_1_10009
						arg_8_0.powerBuff = iter_8_6(var_1_10009.buff_data[iter_8_10])
					end
				end
			end
			...
			local var_8_31 = arg_8_0.addBuff

			Clone = var_6

			var_8_31(var_8_28, var_6(arg_8_0.powerBuff))
		end
	end

	if arg_8_0.powerFlag then
		local var_8_32 = arg_8_0.power

		Fushun3GameConst = var_8_28
		var_8_28 = var_8_28.power_sub_time
		Time = var_6
		arg_8_0.power = var_8_32 - var_8_28 * var_6.deltaTime
		...
		if arg_8_0.power <= 0 then
			...
			var_8_33(var_8_28, var_6(arg_8_0.powerBuff))
		end
	else
		...
		if var_8_34 >= var_8_28.power_max_num then
		...
		if arg_15_0.damageCd == 0 then
			...
			if arg_15_0.shieldNum > 0 then
				...
				elseif #arg_15_0.buffList > 0 then
					...
					var_15_4(var_15_7, var_15_8[var_1_10004.random(1, #arg_15_0.buffList)], true)
...
function var_0_0.setBuff(arg_19_0, arg_19_1)
	...
	if var_19_1 then
		...
		var_19_4(var_19_3, var_6(var_19_1))
	end
...
function var_0_0.addBuff(arg_20_0, arg_20_1)
	for iter_20_0 = 1, #arg_20_0.buffList do
		if arg_20_0.buffList[iter_20_0].id == arg_20_1.id then
			local var_20_0 = arg_20_1.buff

			Fushun3GameConst = var_7

			if var_20_0 == var_7.buff_shield then
	...
	local var_20_1 = arg_20_0:getItemTriggerFlag()
	...
	if var_20_2 == var_4.buff_speed then
		var_20_3 = arg_20_0._animator

		var_20_2.SetBool(var_20_3, "s", true)

		var_20_2 = arg_20_0._collisionInfo.config
		Fushun3GameConst = var_20_3
		var_20_2.moveSpeed = var_20_3.move_speed_shoose

		if not var_20_1 then
			var_20_3 = arg_20_0._animator

			var_20_2.SetTrigger(var_20_3, "item")
		end
	else
		...
		if var_20_2 == var_20_3.buff_power_speed then
			var_20_4 = arg_20_0._powerScript

			if var_20_2.checkScirptApply(var_20_4) then
				var_20_4 = arg_20_0._powerScript

				var_20_2.active(var_20_4, true)

				var_20_4 = arg_20_0._animator

				var_20_2.SetTrigger(var_20_4, "ex_on")

				var_20_4 = arg_20_0._charItemCatch

				var_20_2.SetTrigger(var_20_4, "ex_on")
			end
		else
			var_20_2 = arg_20_1.buff
			Fushun3GameConst = var_20_4

			local var_20_5

			if var_20_2 == var_20_4.buff_weapon then
				var_20_5 = arg_20_0._animator

				var_20_2.SetBool(var_20_5, "la", true)

				if not var_20_1 then
					var_20_5 = arg_20_0._animator

					var_20_2.SetTrigger(var_20_5, "item")
				end
			else
				var_20_2 = arg_20_1.buff
				Fushun3GameConst = var_20_5

				local var_20_6

				if var_20_2 == var_20_5.buff_catch then
					setActive = var_20_2

					var_20_2(arg_20_0._charItemCatchTf, true)

					var_20_6 = arg_20_0._charItemCatch

					var_20_2.SetTrigger(var_20_6, "ride")
				else
					var_20_2 = arg_20_1.buff
					Fushun3GameConst = var_20_6

					if var_20_2 == var_20_6.buff_shield then
						...
						Fushun3GameConst = iter_20_0

						var_20_2(var_20_7, iter_20_0.buff_shield)

						local var_20_8 = arg_20_0._event

						var_20_2 = var_20_2.emit
						Fushun3GameEvent = var_5

						var_20_2(var_20_8, var_5.add_effect_call, {
...
function var_0_0.updateBuffShow(arg_21_0, arg_21_1)
	...
	if arg_21_1 == var_1_10002.buff_shield then
		for iter_21_0 = 1, var_0_1 do
			...
			var_1_10007 = var_1_10007(var_21_1, var_1_10009(var_21_0))
			setActive = var_21_1

			var_21_1(var_1_10007, var_21_0 <= arg_21_0.shieldNum)
			...
			var_21_1(var_1_10009(var_21_2, var_21_3 .. var_1_10012(var_21_0)), arg_21_0.shieldNum == var_21_0)
			...
			var_21_1(var_1_10009(var_21_4, var_21_5 .. var_1_10012(var_21_0)), arg_21_0.shieldNum == var_21_0)
		end
...
function var_0_0.removeBuff(arg_22_0, arg_22_1, arg_22_2)
	for iter_22_0 = 1, #arg_22_0.buffList do
		if arg_22_0.buffList[iter_22_0].buff == arg_22_1.buff then
			local var_22_0 = arg_22_0:getItemTriggerFlag()
			local var_22_1 = var_7.buff

			Fushun3GameConst = var_1_10010

			if var_22_1 == var_1_10010.buff_speed then
				var_1_10010 = arg_22_0._animator

				var_22_1.SetBool(var_1_10010, "s", false)

				var_22_1 = arg_22_0._collisionInfo.config
				Fushun3GameConst = var_1_10010
				var_22_1.moveSpeed = var_1_10010.move_speed

				if not var_22_0 and not arg_22_2 then
					var_1_10010 = arg_22_0._animator

					var_22_1.SetTrigger(var_1_10010, "item")
				end
			else
				var_22_1 = var_7.buff
				Fushun3GameConst = var_1_10010

				if var_22_1 == var_1_10010.buff_power_speed then
					var_1_10010 = arg_22_0._powerScript

					var_22_1.active(var_1_10010, false)

					var_1_10010 = arg_22_0._animator

					var_22_1.SetTrigger(var_1_10010, "ex_off")

					var_1_10010 = arg_22_0._charItemCatch

					var_22_1.SetTrigger(var_1_10010, "ex_off")

					Fushun3GameConst = var_22_1
					arg_22_0._powerTime = var_22_1.power_time
				else
					var_22_1 = var_7.buff
					Fushun3GameConst = var_1_10010

					if var_22_1 == var_1_10010.buff_weapon then
						var_1_10010 = arg_22_0._animator

						var_22_1.SetBool(var_1_10010, "la", false)
						...
						if var_22_1 == var_1_10010.buff_catch then
							setActive = var_22_1

							var_22_1(arg_22_0._charItemCatchTf, false)
						end
					end
				end
			end
			...
			var_22_1.remove(arg_22_0.buffList, iter_22_0)
			...
			if var_23_1 == var_1_10007.buff_power_speed then
				...
				if var_23_2 == var_1_10007.buff_weapon then
					...
					if var_23_3 == var_1_10007.buff_catch then
						...
						var_1_10007(var_23_4, var_1_10009.item_follow_call, {
							anchoredPos = var_6
						})
					end
				end
