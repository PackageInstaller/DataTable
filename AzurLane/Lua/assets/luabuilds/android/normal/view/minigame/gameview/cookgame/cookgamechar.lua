...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = var_5(arg_1_0._tf, "mask/anim")

	typeof = var_6
	Animator = var_7
	arg_1_0._animator = var_4(var_1_0, var_6(var_7))
	GetComponent = var_4
	findTF = var_1_0
	...
	typeof = var_6
	Image = var_7
	arg_1_0._animImage = var_4(var_1_1, var_6(var_7))
	GetComponent = var_4
	findTF = var_1_1
	...
	typeof = var_6
	DftAniEvent = var_7
	arg_1_0._dftEvent = var_4(var_1_2, var_6(var_7))
	...
	var_4.SetStartEvent(var_1_3, function(arg_2_0)
		if arg_1_0._serveFunc then
			...
			CookGameConst = var_2_10003

			var_2_2(var_2_1, var_2_10003.sound_serve)
		end
...
function var_0_0.endEventHandle(arg_4_0)
	...
	if arg_4_0.timeToEventHandle then
		local var_4_0 = arg_4_0.timeToEventHandle
	...
	if arg_4_0._serveSpeed then
		if arg_4_0.directX == -1 then
			...
			var_1(var_1_10002(arg_4_0._tf, "effectW"), false)

			setActive = var_1
			findTF = var_1_10002

			var_1(var_1_10002(arg_4_0._tf, "effectW"), true)
		else
			setActive = var_1
			findTF = var_1_10002

			var_1(var_1_10002(arg_4_0._tf, "effectE"), false)

			setActive = var_1
			findTF = var_2

			var_1(var_2(arg_4_0._tf, "effectE"), true)
		end
	...
	elseif arg_4_0.sendExtend then
		...
		local var_4_1 = arg_4_0._event
		local var_4_2 = var_1.emit

		CookGameView = var_1_10003

		var_4_2(var_4_1, var_1_10003.EXTEND_EVENT)
	end
...
function var_0_0.clearCake(arg_14_0)
	if arg_14_0._cakeData then
		...
		var_1(var_1_10002(arg_14_0._cakeData.tf, "select"), false)
...
function var_0_0.clearJudge(arg_16_0)
	if arg_16_0._judgeData then
		...
		var_1(var_1_10002(arg_16_0._judgeData.tf, "select"), false)
...
function var_0_0.readyServeCake(arg_22_0)
	...
	local var_22_6 = var_1:getPuzzleCamp()

	arg_22_0.puzzleDouble = false
	arg_22_0.puzzleReject = false

	if var_22_6 then
		if arg_22_0._camp == var_22_6 then
			arg_22_0.serveRight = true
	...
	if arg_22_0._speedAble and arg_22_0.serveRight then
		...
		pg = var_8
		var_1_10009 = var_8.CriMgr.GetInstance()

		local var_22_7 = var_8.PlaySoundEffect_V3

		CookGameConst = var_1_10010

		var_22_7(var_1_10009, var_1_10010.sound_speed_up)
	end
	...
	if arg_22_0.serveRight then
		...
		local var_22_8 = arg_22_0.seriesRightIndex

		CookGameConst = var_1_10009

		if var_22_8 > var_1_10009.added_max then
			CookGameConst = var_22_8
			arg_22_0.seriesRightIndex = var_22_8.added_max
		end
	else
	...
	if arg_22_0._charData.battleData.puzzle and arg_22_0.serveRight then
		...
		local var_22_9 = var_8.random(1, 100)

		CookGameConst = var_9
		arg_22_0.triggerPuzzle = var_22_9 <= var_9.puzzle_rate
	end
	...
	var_1:readyServe(var_22_10)

	if arg_22_0._acAble then
		local var_22_11 = arg_22_0:getAcCakeData(var_1)

		function arg_22_0._serveFunc()
			local var_23_0 = arg_22_0._event
			local var_23_1 = var_0.emit

			CookGameView = var_2_10002

			var_23_1(var_23_0, var_2_10002.AC_CAKE_EVENT, var_22_11)
		...
		local var_22_12 = var_10.CriMgr.GetInstance()
		local var_22_13 = var_10.PlaySoundEffect_V3

		CookGameConst = var_1_10012

		var_22_13(var_22_12, var_1_10012.sound_ac)
	else
		function arg_22_0._serveFunc()
...
function var_0_0.getAcCakeData(arg_25_0, arg_25_1)
	...
	if arg_25_0.directX == 1 then
		...
		findTF = var_1_10007
		var_25_3 = var_25_5(var_25_4, var_1_10007(arg_25_0._tf, "acR").position)
	else
		local var_25_6 = arg_25_0._tf.parent
		local var_25_7 = var_5.InverseTransformPoint

		findTF = var_1_10007
		var_25_3 = var_25_7(var_25_6, var_1_10007(arg_25_0._tf, "acL").position)
	end
...
function var_0_0.checkEffectInServe(arg_28_0)
	...
	if var_28_1 then
		...
		local var_28_6 = var_6(var_28_5, var_1_10008(var_1_10009))
...
function var_0_0.move(arg_45_0)
	...
	if arg_45_0._velocity then
		if arg_45_0._targetPos then
			...
			local var_45_5 = arg_45_0:getPos()

			if var_45_1 == var_45_3 then
				var_45_5.x = var_45_5.x + arg_45_0._velocity.x * arg_45_0.deltaTime
			else
				var_45_5.x = arg_45_0._targetPos.x
			end

			if var_45_2 == var_45_4 then
				var_45_5.y = var_45_5.y + arg_45_0._velocity.y * arg_45_0.deltaTime
			else
				var_45_5.y = arg_45_0._targetPos.y
			end

			if arg_45_0._acAble and arg_45_0._judgeData then
				math = var_8

				local var_45_6 = var_8.sqrt

				math = var_1_10009

				local var_45_7 = var_1_10009.pow(arg_45_0._targetPos.x - var_45_5.x, 2)

				math = var_10

				local var_45_8 = var_45_6(var_45_7 + var_10.pow(arg_45_0._targetPos.y - var_45_5.y, 2))

				CookGameConst = var_9

				if var_45_8 <= var_9.ac_dictance then
					arg_45_0:stopMove()
					arg_45_0:clearJudge()
			...
			local var_45_9 = arg_45_0._tf

			var_45_9.anchoredPosition = var_45_5
			...
			if var_45_1 ~= var_45_3 and var_45_1 ~= var_45_3 then
				...
				if var_45_9.abs(arg_45_0._targetPos.x - var_45_5.x) < 5 then
					math = var_8

					if var_8.abs(arg_45_0._targetPos.y - var_45_5.y) < 5 then
						arg_45_0:stopMove()
					end
				end
			end
		else
			local var_45_10 = arg_45_0:getPos()
...
function var_0_0.extend(arg_46_0)
	if not arg_46_0.activing and not arg_46_0.clearing then
		...
		var_46_1(var_46_0, var_1_10003.sound_marcopolo_skill)
...
function var_0_0.pickup(arg_50_0)
	...
	var_50_1(var_50_0, var_1_10003.sound_pickup)
...
function var_0_0.isPlayer(arg_55_0, arg_55_1)
	...
	var_1_10002(var_1_10003(arg_55_0._tf, "player"), arg_55_1)
...
function var_0_0.clear(arg_61_0)
	...
	var_1(var_2(arg_61_0._tf, "effectE"), false)
