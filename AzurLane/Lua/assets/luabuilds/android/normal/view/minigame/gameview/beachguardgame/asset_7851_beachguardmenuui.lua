...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = var_5(arg_1_0.menuUI, "ad/battList")
	...
	local var_1_4 = var_7(arg_1_0.menuUI, "ad/rightPanelBg/arrowUp")
	...
	var_5(var_1_3, var_1_4, var_1_5, var_9)
	...
	var_5(var_1_6, var_1_7, var_1_8, var_9)
	...
	var_5(var_1_9, var_1_10, var_1_11, var_9)
	...
	var_5(var_1_12, var_1_13, var_1_14, var_9)
	...
	var_5(var_1_15, var_1_16, var_1_17, var_9)
	...
	local function var_1_20()
		...
		if var_2_10000(arg_1_0.bookUI) then
			...
			var_7_1(var_7_0, var_2_10002.OPEN_BOOK, false)
		else
			...
			var_7_3(var_7_2, var_2_10002.OPEN_BOOK, true)
	...
	var_5(var_1_18, var_1_19, var_1_20, var_9)
	...
	for iter_1_0 = 1, 7 do
		...
		var_1_10011 = var_1_10011(var_1_10012(var_1_21))
		var_1_10011.name = "battleItem_" .. iter_1_0
		setParent = var_1_10012
		var_1_10013 = var_1_10011
		findTF = var_1_10014

		var_1_10012(var_1_10013, var_1_10014(arg_1_0.menuUI, "ad/battList/Viewport/Content"))

		var_1_10012 = iter_1_0
		GetSpriteFromAtlasAsync = var_1_10013

		var_1_10013(arg_1_0._gameData.path, "battleDesc" .. var_1_10012, function(arg_8_0)
			if arg_8_0 then
				setImageSprite = var_2_10001
				findTF = var_2_10002

				var_2_10001(var_2_10002(var_1_10011, "state_open/desc"), arg_8_0, true)

				setImageSprite = var_2_10001
				findTF = var_2

				var_2_10001(var_2(var_1_10011, "state_clear/desc"), arg_8_0, true)

				setImageSprite = var_2_10001
				findTF = var_2

				var_2_10001(var_2(var_1_10011, "state_current/desc"), arg_8_0, true)

				setImageSprite = var_2_10001
				findTF = var_2

				var_2_10001(var_2(var_1_10011, "state_closed/desc"), arg_8_0, true)
			end
		...
		function var_1_10018()
			...
			var_9_1(var_9_0, var_2_10002.ON_DROP, var_1_10014)
		...
		var_1_10015(var_1_23, var_1_24, var_1_10018, var_1_10019)
		...
		var_1_10015(var_1_10011, true)

		table = var_1_10015

		var_1_10015.insert(arg_1_0.battleItems, var_1_10011)
	end
	...
	local var_1_26 = var_9(arg_1_0.bookUI, "bottom")
	...
	var_7(var_1_25, var_1_26, var_1_27, var_11)
	...
	for iter_1_1 = 1, 3 do
		local var_1_29 = iter_1_1

		findTF = var_1_10013
		var_1_10013 = var_1_10013(arg_1_0.bookUI, "bg/tag" .. iter_1_1)

		if iter_1_1 == 3 then
			setActive = var_1_10014

			var_1_10014(var_1_10013, false)
		end

		onButton = var_1_10014
		var_1_10015 = arg_1_0._event

		local var_1_30 = var_1_10013

		local function var_1_31()
			local var_11_0 = arg_1_0

			var_0.selectBookTag(var_11_0, var_1_29)
		...
		var_1_10014(var_1_10015, var_1_30, var_1_31, var_1_10018)

		table = var_1_10014

		var_1_10014.insert(arg_1_0.bookUITags, var_1_10013)
	end

	findTF = var_8

	local var_1_32 = var_8(arg_1_0.bookUI, "bg/gridTpl")

	for iter_1_2 = 1, var_1_28 do
		local var_1_33 = iter_1_2

		tf = var_1_10014
		instantiate = var_1_10015
		var_1_10014 = var_1_10014(var_1_10015(var_1_32))
		setActive = var_1_10015
		...
		local var_1_34 = var_1_10014

		findTF = var_17

		var_1_10015(var_1_34, var_17(arg_1_0.bookUI, "container/Viewport/Content"))

		onButton = var_1_10015

		local var_1_35 = arg_1_0._event
		local var_1_36 = var_1_10014

		local function var_1_37()
			local var_12_0 = arg_1_0

			var_0.selectGrid(var_12_0, var_1_33)
		...
		var_1_10015(var_1_35, var_1_36, var_1_37, var_19)
	...
	if arg_13_0.selectTagIndex ~= arg_13_1 then
		...
		for iter_13_0 = 1, #arg_13_0.bookUITags do
			if arg_13_1 == iter_13_0 then
				...
				var_1_10006(var_1_10007(arg_13_0.bookUITags[iter_13_0], "select"), true)
			else
				setActive = var_1_10006
				findTF = var_1_10007

				var_1_10006(var_1_10007(arg_13_0.bookUITags[iter_13_0], "select"), false)
			end
		end
		...
		for iter_13_1 = 1, #arg_13_0.grids do
			...
			if iter_13_1 <= #arg_13_0.bookDatas then
				...
				var_10(var_1_10011(var_13_0, "name"), var_13_2)

				setImageSprite = var_10
				findTF = var_1_10011

				var_10(var_1_10011(var_13_0, "icon"), var_1_10008, true)
	...
	if arg_14_0.selectGridIndex ~= arg_14_1 then
		...
		for iter_14_0 = 1, #arg_14_0.grids do
			...
			if iter_14_0 == arg_14_1 then
				...
				var_1_10008(var_1_10009(var_14_1, "select"), true)
			else
				setActive = var_1_10008
				findTF = var_1_10009

				var_1_10008(var_1_10009(var_14_1, "select"), false)
			end
		end
...
function var_0_0.update(arg_17_0, arg_17_1)
	...
	for iter_17_0 = 1, #arg_17_0.battleItems do
		...
		var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_open"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_closed"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_clear"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_current"), false)

		if iter_17_0 <= var_17_0 then
			SetParent = var_1_10008
			var_1_10009 = arg_17_0.dropItems[iter_17_0]
			findTF = var_10

			var_1_10008(var_1_10009, var_10(arg_17_0.battleItems[iter_17_0], "state_clear/icon"))
			...
			var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_clear"), true)
		elseif iter_17_0 == var_17_0 + 1 and 1 <= var_17_1 then
			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_current"), true)

			SetParent = var_1_10008
			var_1_10009 = arg_17_0.dropItems[iter_17_0]
			findTF = var_10

			var_1_10008(var_1_10009, var_10(arg_17_0.battleItems[iter_17_0], "state_current/icon"))
		...
		elseif var_17_0 < iter_17_0 and iter_17_0 <= var_17_0 + var_17_1 then
			...
			var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_open"), true)

			SetParent = var_1_10008
			var_1_10009 = arg_17_0.dropItems[iter_17_0]
			findTF = var_10

			var_1_10008(var_1_10009, var_10(arg_17_0.battleItems[iter_17_0], "state_open/icon"))
			...
			var_1_10008(var_1_10009(arg_17_0.battleItems[iter_17_0], "state_closed"), true)

			SetParent = var_1_10008
			var_1_10009 = arg_17_0.dropItems[iter_17_0]
			findTF = var_10

			var_1_10008(var_1_10009, var_10(arg_17_0.battleItems[iter_17_0], "state_closed/icon"))
	...
	var_6(var_7(arg_17_0.menuUI, "btnStart/tip"), var_17_1 > 0)
...
function var_0_0.CheckGet(arg_18_0, arg_18_1)
	...
	var_1_10002(var_1_10003(arg_18_0.menuUI, "got"), false)

	local var_18_0 = arg_18_0

	if arg_18_0.getUltimate(var_18_0, arg_18_1) and var_2 ~= 0 then
		setActive = var_18_0
		findTF = var_4

		var_18_0(var_4(arg_18_0.menuUI, "got"), true)
	end

	if var_2 == 0 then
		local var_18_1 = arg_18_0._gameData.total_times
		local var_18_2 = arg_18_0

		if var_18_1 > arg_18_0.getGameUsedTimes(var_18_2, arg_18_1) then
			return
		end

		pg = var_18_2

		local var_18_3 = var_18_2.m02
		local var_18_4 = var_5.sendNotification

		GAME = var_1_10007

		local var_18_5 = var_1_10007.SEND_MINI_GAME_OP
		local var_18_6 = {
			hubid = arg_18_1.id
		}

		MiniGameOPCommand = var_9
		var_18_6.cmd = var_9.CMD_ULTIMATE
		var_18_6.args1 = {}
		...
		var_18_4(var_18_3(arg_18_0.menuUI, "got"), true)
	end
