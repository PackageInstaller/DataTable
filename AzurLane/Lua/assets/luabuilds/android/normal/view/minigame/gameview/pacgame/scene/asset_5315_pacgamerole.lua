...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	GetComponent = var_3
	findTF = var_4
	arg_1_0._spineAnimUI = var_3(var_4(arg_1_0._tf, "spine"), "SpineAnimUI")
	arg_1_0._direct = {
		0,
		0
	}
...
function var_0_0.GetGridIndexNext(arg_14_0)
	if arg_14_0:HasTarget() then
		...
		if var_14_0 + var_2.abs(arg_14_0._target.y - arg_14_0._tf.anchoredPosition.y) >= arg_14_0._halfBound[1] then
...
function var_0_0.setDirectArrow(arg_41_0, arg_41_1)
	...
	var_1_10002(var_1_10003(arg_41_0._tf, "bg/L"), false)

	setActive = var_1_10002
	findTF = var_3

	var_1_10002(var_3(arg_41_0._tf, "bg/R"), false)

	setActive = var_1_10002
	findTF = var_3

	var_1_10002(var_3(arg_41_0._tf, "bg/T"), false)

	setActive = var_1_10002
	findTF = var_3

	var_1_10002(var_3(arg_41_0._tf, "bg/B"), false)

	if arg_41_1[1] == 1 then
		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_41_0._tf, "bg/R"), true)
	elseif arg_41_1[1] == -1 then
		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_41_0._tf, "bg/L"), true)
	elseif arg_41_1[2] == 1 then
		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_41_0._tf, "bg/T"), true)
	elseif arg_41_1[2] == -1 then
		setActive = var_2
		findTF = var_3

		var_2(var_3(arg_41_0._tf, "bg/B"), true)
	end
