...
function var_0_0.GetCarryOreTarget(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_14_6(arg_14_0.oreMap) do
		local var_14_8 = iter_14_1:GetCollisionInfo().pos

		if var_0_2(var_14_5, var_14_7, var_14_8) then
			Vector2 = var_13

			if var_13.Distance(var_14_7, var_14_8) <= var_14_3 and (not var_14_1 or var_13 <= var_14_1) then
				var_14_0, var_14_1 = iter_14_0, var_13
			end
		end
	end
	...
	for iter_14_2, iter_14_3 in var_7(arg_14_0.oreMap) do
		local var_14_9 = iter_14_3
		local var_14_10 = iter_14_3.GetCollisionInfo(var_14_9).pos

		Vector2 = var_14_9

		if var_14_9.Distance(var_14_7, var_14_10) <= var_14_2 and (not var_14_1 or var_13 <= var_14_1) then
			var_14_0, var_14_1 = iter_14_2, var_13
		end
	end
...
function var_0_0.UpdateOreStatus(arg_15_0)
	...
	if arg_15_0.oreTarget ~= var_15_0 then
		...
		var_15_2(var_15_1, var_1_10004.EVENT_UPDATE_ORE_TARGET, {
...
function var_0_0.UpdateAkashiCollision(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_16_1(arg_16_0.enemyMap) do
		pairs = var_1_10007
		...
		for iter_16_2, iter_16_3 in var_1_10007(iter_16_1) do
			...
			if var_0_1(var_16_2, var_16_3) then
				...
				OreGameConfig = var_15

				var_16_5(var_16_4, var_15.EVENT_AKASHI_COLLISION, {
...
function var_0_0.UpdateEnemyCollision(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10001(arg_17_0.enemyMap) do
		...
		for iter_17_2, iter_17_3 in var_1_10007(iter_17_1) do
			...
			local var_17_1 = iter_17_3
			local var_17_2 = iter_17_3.GetCollisionInfo(var_17_1)

			pairs = var_17_1

			for iter_17_4, iter_17_5 in var_17_1(iter_17_1) do
				...
				if iter_17_4 ~= iter_17_2 and not var_17_0[iter_17_2][iter_17_4] and not var_17_0[iter_17_4][iter_17_2] then
					local var_17_3 = iter_17_5:GetCollisionInfo()

					if var_0_1(var_17_2, var_17_3) then
						local var_17_4 = arg_17_0.binder
						local var_17_5 = var_19.emit

						OreGameConfig = var_21

						var_17_5(var_17_4, var_21.EVENT_ENEMY_COLLISION, {
							a = iter_17_3,
							b = iter_17_5
						})
					end
