...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.miniGame.gameView.RyzaMiniGame.character.MoveEnemy"))
...
function var_0_1.InitUI(arg_1_0, arg_1_1)
	...
	var_1_1(var_3.Find(var_1_2, "front"), function(arg_2_0)
		...
		local var_2_2 = var_2_1(var_2_0, var_2_10003(var_2_10004))
	...
	local var_1_5 = var_1_4(var_1_3, var_4(var_5))
	...
	var_2.SetTriggerEvent(var_1_5, function()
		...
		var_4_0(arg_1_0.triggerCount, {
			function()
				...
				var_3_10000(var_1.Find(var_5_0, "front/EF_Bullet_UP"), true)
			...
			function()
				...
				var_3_10000(var_1.Find(var_6_0, "front/EF_Bullet_UP_High"), true)
