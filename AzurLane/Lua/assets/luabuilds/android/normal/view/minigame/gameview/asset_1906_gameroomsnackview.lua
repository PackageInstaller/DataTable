...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".GameRoomBaseSnackView"))
...
function var_0_1.updateSelectedList(arg_8_0, arg_8_1)
	...
	for iter_8_0 = 1, var_0_1.Order_Num do
		...
		var_11(var_8, var_8_5)

		setActive = var_11

		var_11(var_8_2, not var_8_5)
		...
		if var_8_5 then
			...
			var_11(var_8_6, var_13("ui/minigameui/newyearsnackui_atlas", "snack_" .. var_8_5))
		end
	end
...
function var_0_1.updateSnackList(arg_9_0, arg_9_1)
	for iter_9_0 = 1, var_0_1.Snack_Num do
		...
		var_9(var_9_4, var_1_10011("ui/minigameui/newyearsnackui_atlas", "snack_" .. var_9_3))

		local var_9_5 = var_6
		local var_9_6 = var_6.Find(var_9_5, "SelectedTag")

		setActive = var_9_5

		var_9_5(var_9_6, false)
...
function var_0_1.updateSelectedOrderTag(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in var_1_10002(arg_10_0.selectedSnackTFList) do
		...
		if arg_10_1 then
			...
			local var_10_2 = var_10_0.indexof(arg_10_0.selectedIDList, iter_10_0, 1)
			...
			var_9(var_10_3, var_11("ui/minigameui/newyearsnackui_atlas", "order_" .. var_10_2))
		end
	end
