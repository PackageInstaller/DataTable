...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "overview/back")
	...
	local var_4_6 = var_3.Find(var_4_5, "overview/collection")

	local function var_4_7()
		local var_6_0 = arg_4_0
		local var_6_1 = var_0.emit

		TowerClimbingMediator = var_2_10002

		var_6_1(var_6_0, var_2_10002.ON_COLLECTION)
	...
	if var_1_10001 then
		...
		var_1_10001(var_2.Find(var_4_8, "overview/collection"), false)
	end
...
function var_0_1.UpdateTip(arg_7_0)
	...
	local var_7_1 = arg_7_0.GetMGData(var_7_0)

	TowerClimbingCollectionLayer = var_7_0

	local var_7_2 = var_7_0.New()

	var_2.SetData(var_7_2, var_7_1)

	_ = var_3

	local var_7_3 = var_3.any({
		1,
		2,
		3
	}, function(arg_8_0)
	...
	var_4(var_5.Find(var_7_4, "overview/collection/tip"), var_7_3)
...
function var_0_1.Start(arg_9_0)
	...
	local function var_9_1(arg_10_0, arg_10_1, arg_10_2)
		...
		TowerClimbingMediator = var_2_10005

		var_10_1(var_10_0, var_2_10005.ON_FINISH, arg_10_0, arg_10_2, arg_10_1)
	...
	local function var_9_2(arg_11_0, arg_11_1)
		...
		TowerClimbingMediator = var_4

		var_11_1(var_11_0, var_4.ON_RECORD_MAP_SCORE, arg_11_0, arg_11_1)
...
function var_0_1.GetTowerClimbingPageAndScore(arg_13_0)
	...
	for iter_13_1, iter_13_2 in iter_13_0(var_13_0) do
