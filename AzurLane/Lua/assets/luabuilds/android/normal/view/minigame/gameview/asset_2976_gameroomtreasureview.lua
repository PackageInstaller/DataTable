...
local var_0_0 = "GameRoomTreasureView"
...
local var_0_8 = 60
local var_0_9 = "ui/minigameui/islandcatchtreasuregameui_atlas"
...
function var_0_1.initUI(arg_70_0)
	...
	local var_70_5 = var_3(arg_70_0.leaveUI, "ad/btnOk")
	...
	var_1(var_70_4, var_70_5, var_70_6, var_5)
	...
	var_1(var_70_7, var_70_8, var_70_9, var_5)
	...
	local var_70_11 = var_3(arg_70_0.pauseUI, "ad/btnOk")
	...
	var_1(var_70_10, var_70_11, var_70_12, var_5)
	...
	local var_70_14 = var_3(arg_70_0.settlementUI, "ad/btnOver")
	...
	var_1(var_70_13, var_70_14, var_70_15, var_5)
	...
	local var_70_16 = arg_70_0

	findTF = var_3

	local var_70_17 = var_3(arg_70_0.menuUI, "btnBack")

	local function var_70_18()
		local var_77_0 = arg_70_0

		var_0.closeView(var_77_0)
	...
	var_1(var_70_16, var_70_17, var_70_18, var_5)
	...
	local var_70_20 = var_70_17(arg_70_0.menuUI, "btnStart")
	...
	local function var_70_21()
		...
		var_0.openCoinLayer(var_78_0, false)

		local var_78_1 = arg_70_0

		var_0.readyStart(var_78_1)
	...
	var_1(var_70_19, var_70_20, var_70_21, var_5)
	...
	local var_70_23 = var_70_20(arg_70_0.menuUI, "btnRule")

	local function var_70_24()
		pg = var_2_10000

		local var_79_0 = var_2_10000.MsgboxMgr.GetInstance()
		local var_79_1 = var_0.ShowMsgBox
		local var_79_2 = {}

		MSGBOX_TYPE_HELP = var_2_10003
		var_79_2.type = var_2_10003

		local var_79_3 = arg_70_0

		var_79_2.helps = var_3.getGameRoomData(var_79_3).game_help
	...
	var_1(var_70_22, var_70_23, var_70_24, var_5)

	if not arg_70_0.handle then
		UpdateBeat = var_1
		arg_70_0.handle = var_1:CreateListener(arg_70_0.Update, arg_70_0)
	end

	UpdateBeat = var_1

	var_1:AddListener(arg_70_0.handle)

	return
end

function var_0_1.initGameUI(arg_80_0)
	findTF = var_1_10001
	arg_80_0.gameUI = var_1_10001(arg_80_0._tf, "ui/gameUI")
	onButton = var_1
	...
	var_1(var_80_0, var_3(arg_80_0.gameUI, "topRight/btnStop"), function()
		local var_81_0 = arg_80_0

		var_0.stopGame(var_81_0)

		setActive = var_0

		var_0(arg_80_0.pauseUI, true)
	...
	var_1(var_80_1, var_3(arg_80_0.gameUI, "btnLeave"), function()
		...
		var_0(arg_80_0.leaveUI, true)

		return
	end)

	GetOrAddComponent = var_1
	arg_80_0.dragDelegate = var_1(arg_80_0.sceneTf, "EventTriggerListener")
	arg_80_0.dragDelegate.enabled = true

	local var_80_2 = arg_80_0.dragDelegate

	var_1.AddPointDownFunc(var_80_2, function(arg_83_0, arg_83_1)
		if arg_80_0.boatController then
			local var_83_0 = arg_80_0.boatController

			var_2.throw(var_83_0)
		end
	...
	findTF = var_1
	arg_80_0.gameTimeS = var_1(arg_80_0.gameUI, "top/time/s")
	findTF = var_1
	arg_80_0.scoreTf = var_1(arg_80_0.gameUI, "top/score")
	arg_80_0.boatController = var_0_57(arg_80_0.sceneTf, arg_80_0)
	arg_80_0.itemController = var_0_58(arg_80_0.sceneTf, arg_80_0.backSceneTf, arg_80_0:getGameUsedTimes(), arg_80_0)
	arg_80_0.catchController = var_0_59(arg_80_0.boatController, arg_80_0.itemController)
	arg_80_0.charController = var_0_60(arg_80_0.backSceneTf, arg_80_0)
	findTF = var_1
	arg_80_0.sceneScoreTf = var_1(arg_80_0.sceneTf, "scoreTf")
	setActive = var_1
...
function var_0_1.Update(arg_84_0)
	arg_84_0:AddDebugInput()

	return
end

function var_0_1.AddDebugInput(arg_85_0)
	if arg_85_0.gameStop or arg_85_0.settlementFlag then
		return
	end
...
function var_0_1.updateMenuUI(arg_86_0)
	return
end

function var_0_1.openMenuUI(arg_87_0)
	setActive = var_1_10001
	findTF = var_1_10002

	var_1_10001(var_1_10002(arg_87_0._tf, "scene_container"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_87_0.bgTf, "on"), true)

	setActive = var_1_10001

	var_1_10001(arg_87_0.gameUI, false)

	setActive = var_1_10001

	var_1_10001(arg_87_0.menuUI, true)
	arg_87_0:openCoinLayer(true)
	arg_87_0:updateMenuUI()

	return
end

function var_0_1.clearUI(arg_88_0)
	setActive = var_1_10001

	var_1_10001(arg_88_0.sceneTf, false)

	setActive = var_1_10001

	var_1_10001(arg_88_0.settlementUI, false)

	setActive = var_1_10001

	var_1_10001(arg_88_0.countUI, false)

	setActive = var_1_10001

	var_1_10001(arg_88_0.menuUI, false)
...
function var_0_1.readyStart(arg_89_0)
	setActive = var_1_10001

	var_1_10001(arg_89_0.countUI, true)

	local var_89_0 = arg_89_0.countAnimator

	var_1.Play(var_89_0, "count")

	pg = var_1

	local var_89_1 = var_1.CriMgr.GetInstance()

	var_1.PlaySoundEffect_V3(var_89_1, var_0_3)

	return
end

function var_0_1.getGameTimes(arg_90_0)
	return arg_90_0:GetMGHubData().count
end

function var_0_1.getGameUsedTimes(arg_91_0)
	return arg_91_0:GetMGHubData().usedtime
end

function var_0_1.getUltimate(arg_92_0)
	return arg_92_0:GetMGHubData().ultimate
end

function var_0_1.gameStart(arg_93_0)
	setActive = var_1_10001
	findTF = var_1_10002

	var_1_10001(var_1_10002(arg_93_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_93_0.bgTf, "on"), false)

	setActive = var_1_10001

	var_1_10001(arg_93_0.gameUI, true)

	arg_93_0.gameStartFlag = true
	arg_93_0.scoreNum = 0
	arg_93_0.playerPosIndex = 2
	arg_93_0.gameStepTime = 0
	arg_93_0.heart = 3
	arg_93_0.gameTime = var_0_8
	SetActive = var_1

	var_1(arg_93_0.sceneScoreTf, false)

	if arg_93_0.boatController then
		local var_93_0 = arg_93_0.boatController

		var_1.start(var_93_0)
	end

	if arg_93_0.itemController then
		local var_93_1 = arg_93_0.itemController

		var_1.start(var_93_1)
	end

	if arg_93_0.catchController then
		local var_93_2 = arg_93_0.catchController

		var_1.start(var_93_2)
	end

	if arg_93_0.charController then
		local var_93_3 = arg_93_0.charController

		var_1.start(var_93_3)
	end

	arg_93_0:updateGameUI()
	arg_93_0:timerStart()

	return
end

function var_0_1.transformColor(arg_94_0, arg_94_1)
	tonumber = var_1_10002
	string = var_1_10003

	local var_94_0 = var_1_10002(var_1_10003.sub(arg_94_1, 1, 2), 16)

	tonumber = var_3
	string = var_4

	local var_94_1 = var_3(var_4.sub(arg_94_1, 3, 4), 16)

	tonumber = var_4
	string = var_5

	local var_94_2 = var_4(var_5.sub(arg_94_1, 5, 6), 16)

	Color = var_5

	return var_5.New(var_94_0 / 255, var_94_1 / 255, var_94_2 / 255)
end

function var_0_1.addScore(arg_95_0, arg_95_1, arg_95_2)
	if arg_95_1 and 0 < arg_95_1 or arg_95_2 and 0 < arg_95_2 then
		pg = var_1_10003

		local var_95_0 = var_1_10003.CriMgr.GetInstance()

		var_1_10003.PlaySoundEffect_V3(var_95_0, var_0_6)
	elseif arg_95_1 and arg_95_1 < 0 then
		pg = var_1_10003

		local var_95_1 = var_1_10003.CriMgr.GetInstance()

		var_1_10003.PlaySoundEffect_V3(var_95_1, var_0_7)
	end

	setActive = var_1_10003

	var_1_10003(arg_95_0.sceneScoreTf, false)

	findTF = var_1_10003

	local var_95_2 = var_1_10003(arg_95_0.sceneScoreTf, "img")
	...
	local var_95_4 = var_4(var_95_3, var_1_10006(var_1_10007))
	local var_95_5 = "6f1807"
	local var_95_6

	if arg_95_1 then
		var_95_6 = nil

		for iter_95_0 = 1, #var_0_48 do
			if arg_95_1 and arg_95_1 >= var_0_48[iter_95_0].score then
				var_95_5 = var_0_48[iter_95_0].color
				var_95_6 = var_0_48[iter_95_0].font

				break
			end
		end

		local var_95_7 = arg_95_0
		local var_95_8 = arg_95_0.transformColor(var_95_7, var_95_5)

		arg_95_0.scoreNum = arg_95_0.scoreNum + arg_95_1

		local var_95_9 = arg_95_1 >= 0 and "+" or ""

		setText = var_95_7

		var_95_7(var_95_2, var_95_9 .. arg_95_1)

		var_95_4.fontSize = var_95_6 or 40
		setTextColor = var_8

		var_8(var_95_2, var_95_8)
	elseif arg_95_2 then
		local var_95_10 = arg_95_0:transformColor("66f2fb")

		var_95_4.fontSize = 40
		setTextColor = var_95_6

		var_95_6(var_95_2, var_95_10)

		var_95_6 = arg_95_0.gameTime

		if 0 < var_95_6 then
			arg_95_0.gameTime = arg_95_0.gameTime + arg_95_2
		end

		var_95_6 = 0 < arg_95_2 and "+" or ""
		setText = var_7

		var_7(var_95_2, var_95_6 .. arg_95_2 .. "s")
	end

	setActive = var_95_6

	var_95_6(arg_95_0.sceneScoreTf, true)

	return
end

function var_0_1.onTimer(arg_96_0)
	arg_96_0:gameStep()

	return
end

function var_0_1.gameStep(arg_97_0)
	local var_97_0 = arg_97_0.gameTime

	Time = var_1_10002
	arg_97_0.gameTime = var_97_0 - var_1_10002.deltaTime

	local var_97_1 = arg_97_0.gameStepTime

	Time = var_2
	arg_97_0.gameStepTime = var_97_1 + var_2.deltaTime

	if arg_97_0.boatController then
		local var_97_2 = arg_97_0.boatController

		var_1.step(var_97_2)
	end

	if arg_97_0.itemController then
		local var_97_3 = arg_97_0.itemController

		var_1.step(var_97_3)
	end

	if arg_97_0.catchController then
		local var_97_4 = arg_97_0.catchController

		var_1.step(var_97_4)
	end

	if arg_97_0.charController then
		local var_97_5 = arg_97_0.charController

		var_1.step(var_97_5)
	end

	if arg_97_0.gameTime < 0 then
		arg_97_0.gameTime = 0
	end

	arg_97_0:updateGameUI()
...
function var_0_1.timerStart(arg_98_0)
	if not arg_98_0.timer.running then
		local var_98_0 = arg_98_0.timer

		var_1.Start(var_98_0)
	end

	return
end

function var_0_1.timerStop(arg_99_0)
	if arg_99_0.timer.running then
...
function var_0_1.updateGameUI(arg_100_0)
	setText = var_1_10001

	var_1_10001(arg_100_0.scoreTf, arg_100_0.scoreNum)

	setText = var_1_10001

	local var_100_0 = arg_100_0.gameTimeS

	math = var_3

	var_1_10001(var_100_0, var_3.ceil(arg_100_0.gameTime))

	return
end

function var_0_1.onGameOver(arg_101_0)
	if arg_101_0.settlementFlag then
		return
	end

	arg_101_0:timerStop()

	arg_101_0.settlementFlag = true
	setActive = var_1

	var_1(arg_101_0.clickMask, true)

	local var_101_0

	if arg_101_0.boatController then
		var_101_0 = arg_101_0.boatController

		var_1.gameOver(var_101_0)
	end

	LeanTween = var_1

	local var_101_1 = var_1.delayedCall

	go = var_101_0

	local var_101_2 = var_101_0(arg_101_0._tf)
	local var_101_3 = 2

	System = var_1_10004

	var_101_1(var_101_2, var_101_3, var_1_10004.Action(function()
		arg_101_0.settlementFlag = false

		local var_102_0 = arg_101_0

		var_102_0.gameStartFlag = false
		setActive = var_102_0

		var_102_0(arg_101_0.clickMask, false)

		local var_102_1 = arg_101_0

		var_0.showSettlement(var_102_1)
...
function var_0_1.showSettlement(arg_103_0)
	setActive = var_1_10001

	var_1_10001(arg_103_0.settlementUI, true)

	GetComponent = var_1_10001
	findTF = var_2

	local var_103_0 = var_2(arg_103_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_103_1 = var_1_10001(var_103_0, var_3(var_4))

	var_1.Play(var_103_1, "settlement", -1, 0)

	local var_103_2 = arg_103_0:GetMGData()
	local var_103_3 = var_2.GetRuntimeData(var_103_2, "elements")
	local var_103_4 = arg_103_0.scoreNum

	if var_103_3 then
		local var_103_5 = #var_103_3
		local var_103_6

		if not (0 < var_103_5) or not var_103_3[1] then
			var_103_6 = 0
		end
		...
		var_5(var_6(arg_103_0.settlementUI, "ad/new"), var_103_6 < var_103_4)

		if var_103_6 <= var_103_4 then
			var_103_6 = var_103_4

			arg_103_0:StoreDataToServer({
				var_103_6
			})
		end
		...
		local var_103_7 = var_5(arg_103_0.settlementUI, "ad/highText")

		findTF = var_6

		local var_103_8 = var_6(arg_103_0.settlementUI, "ad/currentText")

		setText = var_7

		var_7(var_103_7, var_103_6)

		setText = var_7

		var_7(var_103_8, var_103_4)

		if arg_103_0:getGameTimes() and arg_103_0:getGameTimes() > 0 then
			arg_103_0.sendSuccessFlag = true

			arg_103_0:SendSuccess(0)
		end
...
function var_0_1.resumeGame(arg_104_0)
	arg_104_0.gameStop = false
	setActive = var_1

	var_1(arg_104_0.leaveUI, false)
	arg_104_0:timerStart()

	return
end

function var_0_1.stopGame(arg_105_0)
	arg_105_0.gameStop = true
...
function var_0_1.onBackPressed(arg_106_0)
	if not arg_106_0.gameStartFlag then
		arg_106_0:emit(var_0_1.ON_BACK_PRESSED)
	else
		if arg_106_0.settlementFlag then
			return
		end

		isActive = var_1

		if var_1(arg_106_0.pauseUI) then
			setActive = var_1

			var_1(arg_106_0.pauseUI, false)
		end
		...
		var_1(arg_106_0.leaveUI, true)
	end

	return
end

function var_0_1.willExit(arg_107_0)
	if arg_107_0.handle then
		UpdateBeat = var_1
		var_1_10002 = var_1

		var_1.RemoveListener(var_1_10002, arg_107_0.handle)
	end

	if arg_107_0._tf then
		LeanTween = var_1

		local var_107_0 = var_1.isTweening

		go = var_1_10002

		if var_107_0(var_1_10002(arg_107_0._tf)) then
			LeanTween = var_1

			local var_107_1 = var_1.cancel

			go = var_2

			var_107_1(var_2(arg_107_0._tf))
		end
	end

	if arg_107_0.timer and arg_107_0.timer.running then
		local var_107_2 = arg_107_0.timer

		var_1.Stop(var_107_2)
	end
