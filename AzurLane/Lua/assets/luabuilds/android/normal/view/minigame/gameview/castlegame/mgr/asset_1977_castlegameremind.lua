...
function var_0_0.addRemind(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	CastleGameVo = var_5_0
	var_5_1.removeTime = var_5_0.item_ready_time
	CastleGameVo = var_5
	...
	var_6(var_5_1.tf, false)

	setActive = var_6

	var_6(var_5_1.tf, true)
	...
	if not var_6_0 then
		for iter_6_1 = 1, #var_0_1 do
			if arg_6_1 == var_0_1[iter_6_1].type then
				...
				local var_6_1 = var_7(var_1_10008(var_1_10009(arg_6_0._tplContent, var_0_1[iter_6_1].tpl)))
				...
				findTF = var_1_10009
				var_1_10009 = var_1_10009(var_6_1, "zPos")
				typeof = var_10
				DftAniEvent = var_11
				var_1_10008 = var_1_10008(var_1_10009, var_10(var_11))
