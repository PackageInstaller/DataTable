...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".Shrine2022SelectShipView"))
...
function var_0_1.setUIData(arg_2_0)
	...
	for iter_2_0 = 1, 7 do
		...
		var_7.insert(arg_2_0.shipCardSpriteList, var_1_10006)
	end
	...
	for iter_2_1 = 1, 7 do
		...
		var_7.insert(arg_2_0.shipNameSpriteList, var_1_10006)
	end
...
function var_0_1.updateShipCardUI(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3_0(var_3_1, false)

	local var_3_2 = arg_3_1
	local var_3_3 = arg_3_1.Find(var_3_2, "NameMask/Name_Text")

	setScrollText = var_3_2

	var_3_2(var_3_3, arg_3_0.shipNameTextList[arg_3_2])

	setLocalPosition = var_3_2

	var_3_2(arg_3_1, arg_3_0.cardPosList[arg_3_2])

	local var_3_4 = arg_3_1:Find("Selected")
	local var_3_5 = arg_3_0
	local var_3_6 = arg_3_0.isSelected(var_3_5, arg_3_2)
	...
	var_3_5(var_3_3, not var_3_6)

	GetComponent = var_3_5
	var_3_5(arg_3_1, "Toggle").enabled = not var_3_6
