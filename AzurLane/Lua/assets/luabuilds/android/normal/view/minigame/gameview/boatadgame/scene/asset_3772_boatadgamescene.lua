...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_3(var_4(arg_1_0._tf, "tpl"), false)
	...
	local var_1_1 = var_4(arg_1_0.sceneContent, "scene_background/content/leftBottom").anchoredPosition
		...
		if arg_2_0 == var_2_10002.CREATE_ITEM then
			...
			if arg_2_0 == var_2.CREATE_ENEMY then
				...
				if arg_2_0 == var_2.PLAYER_DEAD then
					...
					var_2_3(var_2_2, var_2_10004.GAME_OVER, arg_2_1)
					...
					if arg_2_0 == var_2_3.PLAY_AD then
						...
						BoatAdGameEvent = var_2_10004

						var_2_6(var_2_5, var_2_10004.OPEN_AD_WINDOW)
					else
						...
						if arg_2_0 == var_2_6.ADD_SCORE then
							...
							var_2_8(var_2_7, var_2_10004.ADD_SCORE, arg_2_1)
						else
...
function var_0_0.destroyEnemy(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_1_10004.ADD_SCORE, {
		num = arg_7_1.score
	})
...
function var_0_0.sortItems(arg_8_0, arg_8_1)
	...
	var_1_10002.sort(arg_8_1, function(arg_9_0, arg_9_1)
		...
		local var_9_4 = arg_9_1.getMoveCount(var_9_3)

		math = var_9_3

		local var_9_5 = var_9_3.abs(var_9_1.x - var_9_0.x)

		math = var_7

		if var_7.abs(var_9_1.y - var_9_0.y) > 1 then
		...
		if var_9_4 == 3 and var_9_2 ~= 3 then
			return false
		elseif var_9_2 == 3 and var_9_4 ~= 3 then
			return true
		end
