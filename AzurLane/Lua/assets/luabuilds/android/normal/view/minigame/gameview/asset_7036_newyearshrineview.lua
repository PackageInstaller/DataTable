...
function var_0_1.findUI(arg_11_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_11_0.bgImg = var_11_7(var_11_6, var_3(var_1_10004))

	local var_11_8 = arg_11_0.bgImg

	Color = var_11_6
	var_11_8.color = var_11_6.New(1, 1, 1)
...
function var_0_1.addListener(arg_12_0)
	...
	local function var_12_5()
		...
		pg = var_2_10003
		var_14_2.helps = var_2_10003.gametip.help_xinnian2021__qiaozhong.tip
...
function var_0_1.updateBuff(arg_23_0, arg_23_1)
	if arg_23_1 then
		...
		var_1_10002(var_1_10003, var_1_10004("ui/newyearshrineui_atlas", "buff_type_" .. arg_23_1))

		setImageSprite = var_1_10002
		var_1_10003 = arg_23_0.buffRope
		GetSpriteFromAtlas = var_4

		var_1_10002(var_1_10003, var_4("ui/newyearshrineui_atlas", "buff_rope_" .. arg_23_1))
		...
		for iter_23_0, iter_23_1 in var_5(var_23_1.buff_list) do
			...
			if var_1_10010.indexof(var_23_3, iter_23_1.id, 1) then
				...
				if var_1_10010.GetServerTime(var_23_5) < iter_23_1.timestamp then
					...
					var_12(var_23_6, var_1_10014("ui/newyearshrineui_atlas", "buff_type_" .. var_23_4))
					...
					var_12(var_23_7, var_1_10014("ui/newyearshrineui_atlas", "buff_rope_" .. var_23_4))
...
function var_0_1.IsNeedShowTipWithoutActivityFinalReward()
	...
	if var_28_1(var_28_0, var_1_10002.NEWYEAR_SNOWBALL_FIGHT) then
		...
		MiniGameDataCreator = var_28_2

		local var_28_4 = var_28_2.NewYearShrineGameID

		getProxy = var_1_10003
		MiniGameProxy = var_1_10004

		local var_28_5 = var_1_10003(var_1_10004)

		if var_3.GetMiniGameData(var_28_5, var_28_4) then
			local var_28_6

			if not var_3:GetRuntimeData("count") then
				var_28_6 = 0
			end
		...
		if var_3 then
			...
			local var_28_9 = var_1_10006(var_1_10007)
			local var_28_10 = var_6.getData(var_28_9)
			local var_28_11 = var_3
			local var_28_12 = var_3.getConfig(var_28_11, "config_data")[2]

			ipairs = var_28_11

			for iter_28_0, iter_28_1 in var_28_11(var_28_10.buff_list) do
				table = var_1_10013
		...
		return var_28_3 and not var_28_7
	end
end
