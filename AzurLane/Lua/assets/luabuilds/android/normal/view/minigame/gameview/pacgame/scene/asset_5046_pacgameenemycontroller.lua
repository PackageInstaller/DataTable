...
function var_0_0.setEnemyAutoData(arg_9_0, arg_9_1, arg_9_2)
	...
	elseif var_3 == 1 then
		...
		if var_9_7(var_9_6, var_9_8, var_8.GetGridIndex(var_9_9)) and var_5[var_9_0] then
...
function var_0_0.checkEnemyHit(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_2 = arg_10_2.GetPosition(var_10_1)

	math = var_10_1

	if var_10_1.abs(var_10_0.x - var_10_2.x) <= 30 then
		math = var_5

		if var_5.abs(var_10_0.y - var_10_2.y) <= 30 then
			if not arg_10_2:GetRush() then
				local var_10_3 = arg_10_0._event

				PacGameScene = var_7

				var_10_3(var_7.HIT_PLAYER, nil, nil)
			else
				...
				if arg_10_0:getEnemyTargetRoad(arg_10_1, arg_10_1:GetStartIndex()) and var_7[arg_10_1:GetGridIndex()] then
					...
					var_10_7(var_10_6, var_10.GetPosition(var_10_8))
					arg_10_1:SetBackStart(true)
...
function var_0_0.getTargetRoadByCount(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	...
	for iter_14_0, iter_14_1 in var_1_10006(arg_14_1) do
		...
		for iter_14_2 = 1, #var_14_2 do
			...
			if arg_14_0.getLastIndexWithFrom(var_14_6, var_14_2[iter_14_2], arg_14_2) and #var_19 > 0 then
				var_14_5 = false
			end
			...
			if var_14_5 then
				...
				local var_14_7 = var_14_6(var_14_3)

				table = var_21

				var_21.insert(var_14_7, var_14_4)

				arg_14_2[var_14_4] = var_14_7
				table = var_21
...
function var_0_0.calcRoad(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	for iter_15_0, iter_15_1 in var_1_10006(arg_15_1) do
		...
		for iter_15_2 = 1, #var_15_2 do
			...
			if arg_15_0.getLastIndexWithFrom(var_15_6, var_15_2[iter_15_2], arg_15_3) and #var_19 > 0 then
				var_15_5 = false
			end
			...
			if var_15_5 then
				...
				local var_15_7 = var_15_6(var_15_3)

				table = var_21

				var_21.insert(var_15_7, var_15_4)

				arg_15_3[var_15_4] = var_15_7
				table = var_21
