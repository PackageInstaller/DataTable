...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	findTF = var_5
	arg_1_0._gridController = var_1_0(var_5(arg_1_0._sceneContainer, "scene/content"), arg_1_0._event, arg_1_0._sortGameRunningData)
...
function var_0_0.Prepare(arg_5_0)
	...
	local var_5_7 = var_5.UPDATE_PLAYER
	local var_5_8 = arg_5_0._sortGameRunningData

	var_5_6(var_5_5, var_5_7, var_6.GetPlayerPrefab(var_5_8))
...
function var_0_0.Step(arg_7_0)
	...
	SortGameConst = var_7_2

	if var_7_3 <= var_7_2.last_speak_time and not arg_7_0._gameTimeSpeak then
		local var_7_4 = arg_7_0._event
		local var_7_5 = var_3.emit

		SortGameView = var_1_10005

		local var_7_6 = var_1_10005.PLAYER_SPEAK
		local var_7_7 = arg_7_0._sortGameRunningData
		local var_7_8 = var_6.GetSpeakData

		SortGameConst = var_1_10008

		var_7_5(var_7_4, var_7_6, var_7_8(var_7_7, var_1_10008.sort_conifg_type_time))
