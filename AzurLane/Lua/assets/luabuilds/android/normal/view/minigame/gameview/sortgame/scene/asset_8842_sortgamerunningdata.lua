...
function var_0_0.GetPlayerIdByItem(arg_5_0, arg_5_1)
	for iter_5_0 = 1, #arg_5_0._playerIds do
		...
		if var_1_10007(var_1_10008.player_data[var_5_0].items, arg_5_1) then
			return var_5_0
		end
	end
...
function var_0_0.GetBoundConfig(arg_7_0)
	...
	return var_1_10001(var_1_10002.bounds_data[arg_7_0._chapter.bound])
end
...
function var_0_0.GetOffsetConfig(arg_8_0)
	...
	return var_1_10001(var_1_10002.grid_offset[arg_8_0._chapter.offset])
end
...
function var_0_0.GetComonItems(arg_13_0)
	local var_13_0 = {}
	local var_13_1 = arg_13_0:GetPlayersItems(arg_13_0._playerIds)
	local var_13_2 = 1

	SortGameConst = var_4

	for iter_13_0 = var_13_2, #var_4.common_item_id do
		SortGameConst = var_1_10007
		var_1_10007 = var_1_10007.common_item_id[iter_13_0]
		table = var_1_10008

		if not var_1_10008.contains(var_13_1, var_1_10007) then
			table = var_1_10008
...
function var_0_0.GetPlayerPrefab(arg_15_0, arg_15_1)
	...
	return var_1_10002(var_1_10003.player_data[arg_15_1].prefab)
end
...
function var_0_0.GetChatConfig(arg_19_0, arg_19_1, arg_19_2)
	...
	if not arg_19_2 then
		...
		var_19_1 = arg_19_0.GetPlayerName
		var_1_10005 = arg_19_0._playerIds
		math = var_1_10006
		var_19_1 = var_19_1(var_19_0, var_1_10005[var_1_10006.random(1, #arg_19_0._playerIds)])
	end
	...
	for iter_19_0 = var_19_2, #var_1_10005.activity_event_sortgame_chat.all do
		...
		if var_1_10009.activity_event_sortgame_chat[var_1_10008].sculpture == var_19_1 and var_1_10009.type == arg_19_1 then
			return var_1_10009
		end
	end
