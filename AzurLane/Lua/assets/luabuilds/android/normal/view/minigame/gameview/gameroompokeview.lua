...
local function var_0_22(arg_1_0, arg_1_1)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			arg_2_0._animator = var_1(var_2_0, var_2_10003(var_2_10004))
			...
			typeof = var_3
			BoxCollider2D = var_4
			arg_2_0.atkCollider = var_1(var_2_1, var_3(var_4))
			GetComponent = var_1
			findTF = var_2_1
			...
			typeof = var_3
			BoxCollider2D = var_4
			arg_2_0.specialCollider = var_1(var_2_2, var_3(var_4))
			GetComponent = var_1
	...
	local var_25_0 = {
		...
		createPlayer = function(arg_28_0)
			if arg_28_0.player == nil then
				...
				arg_28_0.player = var_28_0(var_2_10002(var_2_10003(arg_28_0.playerTpl)), function(arg_29_0)
...
local function var_0_24(arg_38_0, arg_38_1)
	local var_38_0 = {
		ctor = function(arg_39_0)
			...
			typeof = var_2_10003
			Animator = var_2_10004
			arg_39_0._animator = var_1(var_39_0, var_2_10003(var_2_10004))
			GetComponent = var_1
			...
			local var_39_2 = var_1(var_39_1, var_3(var_2_10004))
		...
		move = function(arg_51_0, arg_51_1, arg_51_2)
			...
			Mathf = var_6
			var_51_0.x = var_51_1 * var_6.Sign(arg_51_1)
		...
		moveTo = function(arg_52_0, arg_52_1)
			...
			Mathf = var_4
			var_52_0.x = var_52_1 * var_4.Sign(arg_52_0._tf.localPosition.x)
...
local function var_0_25(arg_64_0, arg_64_1, arg_64_2, arg_64_3)
	local var_64_0 = {
		ctor = function(arg_65_0)
			...
			local var_65_3 = var_2(arg_65_0.cakeTf, "image")

			typeof = var_3
			Animator = var_4
			arg_65_0.cakeAniamtor = var_1(var_65_3, var_3(var_4))

			local var_65_4 = arg_65_0.cakeAniamtor
			local var_65_5 = var_1.SetInteger
			local var_65_6 = "life"
			local var_65_7 = arg_65_0

			var_65_5(var_65_4, var_65_6, arg_65_0.getCakeLifeIndex(var_65_7))

			GetComponent = var_65_5
			arg_65_0.cakeBox = var_65_5(arg_65_0.cakeTf, "BoxCollider2D")
			...
			for iter_65_2 = 0, arg_65_0.createPos.childCount - 1 do
				table = var_65_7
				var_65_7 = var_65_7.insert

				local var_65_8 = arg_65_0.createBounds
				local var_65_9 = arg_65_0.createPos

				var_65_7(var_65_8, var_7.GetChild(var_65_9, iter_65_2))
			end
		...
		step = function(arg_66_0)
			...
			if arg_66_0.apearTime == 0 then
				...
				for iter_66_1 = 1, var_66_0 do
					if #arg_66_0.enemys < var_0_17.enemy_max[arg_66_0.level] then
						...
						if not arg_66_0.getEnemyFromPool(var_66_3, var_66_2.type) then
							var_66_4 = arg_66_0:createEnemy(var_66_2)
						end

						table = var_66_3

						var_66_3.insert(arg_66_0.enemys, var_66_4)
						var_66_4:setActive(true)
						var_66_4:moveTo(arg_66_0:getRandApearPosition())
						var_66_4:apear()
					end
				end
			...
			for iter_66_2 = #arg_66_0.enemys, 1, -1 do
				local var_66_6 = arg_66_0.enemys[iter_66_2]

				if arg_66_0.cakeTf.localPosition.y <= var_66_6:getPosition().y then
					var_66_5 = var_66_5 + 1
				end

				var_66_6:SetSiblingIndex(iter_66_2)
				var_66_6:step()

				if var_66_6:getMoveAble() then
					local var_66_7 = var_66_6:getPosition()
					local var_66_8 = arg_66_0

					if arg_66_0.checkEnemySteal(var_66_8, var_66_6) then
						var_66_8 = var_66_6

						var_66_6.steal(var_66_8)
					else
						Mathf = var_8

						local var_66_9 = var_8.Atan2

						Mathf = var_66_8

						local var_66_10 = var_66_8.Abs(var_66_7.y)

						Mathf = var_10

						local var_66_11 = var_66_9(var_66_10, var_10.Abs(var_66_7.x))
						local var_66_12 = var_66_6
						local var_66_13 = var_66_6.getSpeed(var_66_12)

						Mathf = var_66_12

						local var_66_14 = var_66_13 * var_66_12.Cos(var_66_11)

						Mathf = var_10

						local var_66_15 = var_66_14 * -var_10.Sign(var_66_7.x)
						local var_66_16 = var_66_6
						local var_66_17 = var_66_6.getSpeed(var_66_16)

						Mathf = var_66_16

						local var_66_18 = var_66_17 * var_66_16.Sin(var_66_11)

						Mathf = var_11

						local var_66_19 = var_66_18 * -var_11.Sign(var_66_7.y)
						local var_66_20 = var_66_6
						local var_66_21 = var_66_6.move

						Time = var_2_10013
						var_2_10013 = var_66_15 * var_2_10013.deltaTime
						Time = var_2_10014

						var_66_21(var_66_20, var_2_10013, var_66_19 * var_2_10014.deltaTime)
					end
				end
			end

			local var_66_22 = arg_66_0.cakeTf

			var_2.SetSiblingIndex(var_66_22, var_66_5)

			local var_66_23 = arg_66_0.apearTime

			Time = var_66_22
			arg_66_0.apearTime = var_66_23 - var_66_22.deltaTime

			if arg_66_0.apearTime < 0 then
				arg_66_0.apearTime = 0
			end

			local var_66_24 = arg_66_0.stepTime

			Time = var_3
			arg_66_0.stepTime = var_66_24 + var_3.deltaTime

			local var_66_25 = arg_66_0.cakeAniamtor

			var_2.SetInteger(var_66_25, "life", arg_66_0:getCakeLifeIndex())
		...
		createEnemy = function(arg_71_0, arg_71_1)
			...
			local var_71_0 = var_2_10002(var_2_10003(arg_71_0.enemysTpl[arg_71_1.type]))
	...
	local var_85_0 = {
		ctor = function(arg_86_0)
			...
			for iter_86_0 = 1, #arg_86_0.roleTfs do
				...
				var_86_0.animator = var_2_10006(var_86_1, var_2_10008(var_2_10009))
			...
			for iter_87_0 = 1, #arg_87_0.roleDatas do
				if arg_87_0.roleDatas[iter_87_0].type == var_0_27 then
					...
					if var_6.time == 0 then
						...
						Time = var_87_2
						var_6.time = var_87_3 - var_87_2.deltaTime
...
function var_0_1.initUI(arg_96_0)
	...
	local var_96_0 = var_2(arg_96_0.countUI, "count")

	typeof = var_3
	Animator = var_4
	arg_96_0.countAnimator = var_1(var_96_0, var_3(var_4))
	GetComponent = var_1
	findTF = var_96_0
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_96_0.countDft = var_1(var_96_1, var_3(var_4))
	...
	local var_96_5 = var_3(arg_96_0.leaveUI, "ad/btnOk")
	...
	var_1(var_96_4, var_96_5, var_96_6, var_5)
	...
	var_1(var_96_7, var_96_8, var_96_9, var_5)
	...
	local var_96_11 = var_3(arg_96_0.pauseUI, "ad/btnOk")
	...
	var_1(var_96_10, var_96_11, var_96_12, var_5)
	...
	local var_96_14 = var_3(arg_96_0.settlementUI, "ad/btnOver")
	...
	var_1(var_96_13, var_96_14, var_96_15, var_5)
	...
	local var_96_17 = var_3(arg_96_0.menuUI, "btnBack")
	...
	var_1(var_96_16, var_96_17, var_96_18, var_5)
	...
	local function var_96_21()
		...
		var_104_2.type = var_2_10003

		local var_104_3 = arg_96_0

		var_104_2.helps = var_3.getGameRoomData(var_104_3).game_help
	...
	var_1(var_96_19, var_96_20, var_96_21, var_5)
	...
	var_1(var_96_22, var_96_23, var_96_24, var_5)
	...
	for iter_96_0 = 1, var_96_25 do
		findTF = var_1_10006
		var_1_10006 = var_1_10006(arg_96_0.gameUI, "heart" .. iter_96_0 .. "/img")
		table = var_7

		var_7.insert(arg_96_0.hearts, var_1_10006)
	end

	onButton = var_2

	local var_96_26 = arg_96_0

	findTF = var_4

	var_2(var_96_26, var_4(arg_96_0.gameUI, "btnStop"), function()
	...
	var_2(var_96_27, var_4(arg_96_0.gameUI, "btnLeave"), function()
	...
	local var_96_28 = var_96_27(arg_96_0.gameUI, "btnSpecial/Slider")

	typeof = var_4
	Slider = var_5
	arg_96_0.specialSlider = var_2(var_96_28, var_4(var_5))
	findTF = var_2
	...
	local var_96_29 = arg_96_0

	findTF = var_4

	var_2(var_96_29, var_4(arg_96_0.gameUI, "btnSpecial"), function()
	...
	for iter_96_1 = 1, 4 do
		...
		local var_96_30 = var_96_30.insert
		local var_96_31 = arg_96_0.enemyTpls

		findTF = var_1_10008

		var_96_30(var_96_31, var_1_10008(arg_96_0._tf, "enemy" .. iter_96_1 .. "Tpl"))
	end
	...
	for iter_96_2 = 1, var_96_33 do
		table = var_1_10008
		var_1_10008 = var_1_10008.insert

		local var_96_34 = var_96_32

		findTF = var_1_10010

		var_1_10008(var_96_34, var_1_10010(arg_96_0._tf, "bg_background/role/role" .. iter_96_2))
	end

	arg_96_0.bgRoleController = var_0_29(var_96_32, arg_96_0.playerController)
...
function var_0_1.updateMenuUI(arg_112_0)
	...
	local var_112_2 = arg_112_0.getGameTimes(var_112_1)

	setActive = var_112_1
	findTF = var_1_10004

	var_112_1(var_1_10004(arg_112_0.menuUI, "btnStart/tip"), var_112_2 > 0)
	arg_112_0:CheckGet()
...
function var_0_1.openMenuUI(arg_113_0)
	...
	var_1_10001(var_1_10002(arg_113_0._tf, "scene_front"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_113_0._tf, "scene_background"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_113_0._tf, "scene"), false)
...
function var_0_1.showSettlement(arg_114_0)
	...
	local var_114_0 = var_2(arg_114_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_114_1 = var_1_10001(var_114_0, var_3(var_4))
	...
	if var_114_3 then
		...
		local var_114_8 = var_5(arg_114_0.settlementUI, "ad/highText")
...
function var_0_1.AddDebugInput(arg_116_0)
	...
	if var_1 then
		...
		if var_116_0(var_1_10002.Space) and arg_116_0.playerController then
...
function var_0_1.CheckGet(arg_117_0)
	...
	var_1_10001(var_1_10002(arg_117_0.menuUI, "got"), false)
	...
	if arg_117_0:getUltimate() == 0 then
		local var_117_1 = arg_117_0:getGameTotalTime()
		local var_117_2 = arg_117_0

		if var_117_1 > arg_117_0.getGameUsedTimes(var_117_2) then
			return
		end

		pg = var_117_2

		local var_117_3 = var_117_2.m02
		local var_117_4 = var_3.sendNotification

		GAME = var_1_10005

		local var_117_5 = var_1_10005.SEND_MINI_GAME_OP
		local var_117_6 = {
			hubid = arg_117_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_7
		var_117_6.cmd = var_7.CMD_ULTIMATE
		var_117_6.args1 = {}

		var_117_4(var_117_3, var_117_5, var_117_6)

		setActive = var_117_4
		findTF = var_117_3

		var_117_4(var_117_3(arg_117_0.menuUI, "got"), true)
	end
...
function var_0_1.gameStart(arg_120_0)
	...
	var_1(var_1_10002(arg_120_0._tf, "scene_front"), true)

	setActive = var_1
	findTF = var_2

	var_1(var_2(arg_120_0._tf, "scene_background"), true)

	setActive = var_1
	findTF = var_2

	var_1(var_2(arg_120_0._tf, "scene"), true)
...
function var_0_1.gameStep(arg_122_0)
	...
	Time = var_122_2
	arg_122_0.gameLastTime = var_122_3 - var_122_2.deltaTime
	setText = var_1

	local var_122_4 = arg_122_0.textScore
	local var_122_5 = arg_122_0.enemyController

	var_1(var_122_4, var_3.getScore(var_122_5))
	...
	var_1(var_122_6, var_3.ceil(arg_122_0.gameLastTime) .. "")
...
function var_0_1.gameUIUpdate(arg_123_0)
	...
	var_1(var_123_1, var_3.getScore(var_123_2))
...
function var_0_1.onGameOver(arg_126_0)
	...
	local var_126_1 = var_2(arg_126_0._tf)
	local var_126_2 = 1

	System = var_1_10004

	var_126_0(var_126_1, var_126_2, var_1_10004.Action(function()
