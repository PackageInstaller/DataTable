...
function var_0_0.initSelectUI(arg_2_0)
	local function var_2_0(arg_3_0)
		...
		if arg_2_0.selectChar then
			local var_3_0 = arg_2_0.selectChar

			if 0 < var_3_0 then
				setActive = var_3_0
				findTF = var_2

				var_3_0(var_2(arg_2_0.selectGridList[arg_2_0.selectChar], "ad/use"), false)
			end
		end
		...
		if 0 < arg_3_0 then
			...
			var_1(var_2(arg_2_0.selectGridList[arg_3_0], "ad/use"), true)
		end

		GetSpriteFromAtlasAsync = var_1
		CutFruitGameConst = var_2

		var_1(var_2.ui_atlas, "char_" .. arg_3_0, function(arg_4_0)
	...
	local var_2_2 = var_3(arg_2_0.selectUI, "ad/select_list")
	...
	for iter_2_0 = var_2_3, var_5.character_num do
		...
		var_1_10009 = var_1_10009(var_1_10010(var_2_1))
		...
		var_1_10010(var_2_4, var_2_5, var_2_6, var_1_10014)

		GetSpriteFromAtlasAsync = var_1_10010
		CutFruitGameConst = var_2_4

		var_1_10010(var_2_4.ui_atlas, "char_grid_" .. var_1_10008, function(arg_6_0)
			setImageSprite = var_2_10001
			findTF = var_2_10002

			var_2_10001(var_2_10002(var_1_10009, "ad/char"), arg_6_0, true)
	...
	local var_2_8 = arg_2_0.selectStartTF
	...
	var_4(var_2_7, var_2_8, var_2_9, var_1_10008)

	onButton = var_4

	local var_2_10 = arg_2_0._event
	local var_2_11 = arg_2_0.selectCloseTF
	...
	local function var_2_12()
		...
		var_8_1(var_8_0, var_2_10002.CLOSE_GAME)
	...
	var_4(var_2_10, var_2_11, var_2_12, var_1_10008)

	CutFruitGameConst = var_4

	local var_2_13 = var_4.chapter_data
	local var_2_14 = arg_2_0._gameVo
	local var_2_15

	if var_2_13[var_5.GetGameRound(var_2_14)].char == 0 or not var_4.char then
		math = var_2_15
		var_2_15 = var_2_15.random

		local var_2_16 = 1

		CutFruitGameConst = var_2_12
		var_2_15 = var_2_15(var_2_16, var_2_12.character_num)
	end

	arg_2_0.selectChar = var_2_15

	local var_2_17

	if not (#var_4.npc > 0) or not var_4.npc then
		var_2_17 = arg_2_0:GetNpcRandom(arg_2_0.selectChar)
	end

	arg_2_0.selectNpc = var_2_17
...
function var_0_0.updateSelectUI(arg_9_0)
	for iter_9_0 = 1, #arg_9_0.selectGridList do
		...
		if arg_9_0.selectChar and arg_9_0.selectChar == var_9_1 then
			...
			var_7(var_1_10008(var_9_0, "ad/use"), true)

			GetSpriteFromAtlasAsync = var_7
			CutFruitGameConst = var_1_10008

			var_7(var_1_10008.ui_atlas, "char_" .. var_9_1, function(arg_10_0)
				setImageSprite = var_2_10001
			...
			var_7(var_1_10008(var_9_0, "ad/use"), false)
		end
		...
		if var_7.contains(arg_9_0.selectNpc, var_9_1) then
			...
			var_7(var_1_10008(var_9_0, "ad/npc"), true)
		else
			setActive = var_7
			findTF = var_1_10008

			var_7(var_1_10008(var_9_0, "ad/npc"), false)
		end
	end
...
function var_0_0.GetNpcRandom(arg_11_0, arg_11_1)
	...
	for iter_11_1 = 1, 2 do
		...
		table = var_1_10010
		var_1_10010 = var_1_10010.remove

		local var_11_4 = var_11_1

		math = var_1_10012

		var_1_10008(var_11_3, var_1_10010(var_11_4, var_1_10012.random(1, #var_11_1)))
	end
...
function var_0_0.initCountUI(arg_12_0)
	...
	local var_12_0 = var_2(arg_12_0.countUI, "count")

	typeof = var_3
	Animator = var_4
	arg_12_0.countAnimator = var_1(var_12_0, var_3(var_4))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_12_0.countDft = var_1(var_12_1, var_3(var_4))
	...
	var_1.SetEndEvent(var_12_3, function()
		...
		var_14_1(var_14_0, var_2_10002.COUNT_DOWN)
...
function var_0_0.initLeavelUI(arg_15_0)
	...
	local var_15_1 = var_3(arg_15_0.leaveUI, "ad/btnConfirm")
	...
	local function var_15_2()
		...
		var_16_2(var_16_1, var_2_10002.LEVEL_GAME, true)
	...
	var_1(var_15_0, var_15_1, var_15_2, var_5)
	...
	local function var_15_5()
		...
		var_17_2(var_17_1, var_2_10002.LEVEL_GAME, false)
	...
	var_1(var_15_3, var_15_4, var_15_5, var_5)
...
function var_0_0.initPauseUI(arg_18_0)
	...
	local var_18_1 = var_3(arg_18_0.pauseUI, "ad/btnOk")
	...
	local function var_18_2()
		...
		var_19_2(var_19_1, var_2_10002.PAUSE_GAME, false)
...
function var_0_0.initSettlementUI(arg_20_0)
	...
	local var_20_1 = var_3(arg_20_0.settlementUI, "ad/btnOver")
	...
	local function var_20_2()
		...
		var_21_2(var_21_1, var_2_10002.BACK_MENU)
	...
	var_1(var_20_0, var_20_1, var_20_2, var_5)
	...
	local function var_20_5()
		...
		var_22_2(var_22_1, var_2_10002.BACK_MENU, {
			restart = true
		})
	...
	var_1(var_20_3, var_20_4, var_20_5, var_5)
...
function var_0_0.setChildVisible(arg_23_0, arg_23_1, arg_23_2)
	for iter_23_0 = 1, arg_23_1.childCount do
		...
		local var_23_1 = arg_23_1.GetChild(var_23_0, iter_23_0 - 1)
...
function var_0_0.UpdateSettlementUI(arg_29_0)
	...
	if var_2.GetSuccess(var_29_2) then
		...
		var_29_2(var_1_10004(arg_29_0.settlementUI, "ad/1"), true)

		setActive = var_29_2
		findTF = var_1_10004

		var_29_2(var_1_10004(arg_29_0.settlementUI, "ad/2"), false)

		setActive = var_29_2
		findTF = var_1_10004

		var_29_2(var_1_10004(arg_29_0.settlementUI, "ad/currentText"), true)
	else
		setActive = var_29_2
		findTF = var_1_10004

		var_29_2(var_1_10004(arg_29_0.settlementUI, "ad/1"), false)

		setActive = var_29_2
		findTF = var_4

		var_29_2(var_4(arg_29_0.settlementUI, "ad/2"), true)

		setActive = var_29_2
		findTF = var_4

		var_29_2(var_4(arg_29_0.settlementUI, "ad/currentText"), false)
	end

	findTF = var_29_2

	local var_29_3 = var_29_2(arg_29_0.settlementUI, "ad/currentText")
	...
	var_29_5(var_29_4, var_6.SUBMIT_GAME_SUCCESS, var_29_1)
...
function var_0_0.BackPressed(arg_30_0)
	...
	if var_1_10001(arg_30_0.pauseUI) then
		...
		var_30_1(var_30_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_30_1
		...
		if var_30_1(arg_30_0.leaveUI) then
			...
			var_30_3(var_30_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_30_3
			...
			if not var_30_3(arg_30_0.pauseUI) then
				...
				if not var_1(arg_30_0.pauseUI) then
					...
					if not var_1.IsSettlement(var_30_4) then
						...
						var_30_6(var_30_5, var_1_10003.PAUSE_GAME, true)
					end
...
function var_0_0.UpdateGameUI(arg_32_0, arg_32_1)
	...
	var_1_10002(var_32_0, var_4.ceil(arg_32_1.gameTime))
...
function var_0_0.ReadyStart(arg_33_0)
	...
	var_33_2(var_33_1, var_3.SFX_COUNT_DOWN)
