...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	local var_1_0 = var_1_10006(arg_1_0._charTf, "collider")

	typeof = var_7
	BoxCollider2D = var_8
	arg_1_0._charCollider = var_1_10005(var_1_0, var_7(var_8))
	findTF = var_5
	...
	for iter_1_0 = var_1_1, #var_6.item_instance_data do
		Fushun3GameConst = var_1_10009
		var_1_10009 = var_1_10009.item_instance_data[iter_1_0]
		arg_1_0.weightTotal = arg_1_0.weightTotal + var_1_10009.weight

		local var_1_2 = arg_1_0.weightTotal
		local var_1_3 = var_1_10009.id
		local var_1_4 = var_1_10009.map
		local var_1_5 = {
			id = var_1_3,
			weight = var_1_2,
			map = var_1_4
		...
		var_1_10014.insert(arg_1_0.weightItems, var_1_5)
	end
...
function var_0_0.start(arg_3_0)
	...
	local var_3_1 = var_2.create_time[1]

	Fushun3GameConst = var_3
	arg_3_0.createTime = var_3_0(var_3_1, var_3.create_time[2])
	Vector2 = var_1
...
function var_0_0.step(arg_4_0)
	...
	for iter_4_0 = #arg_4_0.items, 1, -1 do
			...
			if var_4_2 ~= var_1_10009.item_type_damage then
				...
				if var_1_10009.CheckBoxCollider(var_4_0.min, var_4_3.min, var_4_0.size, var_4_3.size) then
					...
					if var_1_10009.remove(arg_4_0.items, iter_4_0).data.effect then
						var_1_10011 = arg_4_0._event
						var_1_10010 = var_1_10010.emit
						Fushun3GameEvent = var_12

						var_1_10010(var_1_10011, var_12.add_effect_call, {
					...
					if arg_4_0._callback then
						var_1_10010 = arg_4_0._callback
						Fushun3GameEvent = var_1_10011

						var_1_10010(var_1_10011.catch_item_call, {
					...
					arg_4_0.returnItemToPool(var_1_10011, var_1_10009)
				end
			end
		end
		...
		if var_7.data.speed then
			...
			var_1_10010 = var_7.data.speed
			Time = var_1_10011
			var_8.x = var_1_10009 + var_1_10010 * var_1_10011.deltaTime
			var_1_10009 = var_7.tf
			var_1_10009.anchoredPosition = var_8
		end

		local var_4_4 = var_7.data.type

		Fushun3GameConst = var_1_10009

		if var_4_4 == var_1_10009.item_type_damage then
			table = var_4_4

			var_4_4.insert(var_4_1, var_7)
		end
	end

	for iter_4_1 = #var_4_1, 1, -1 do
		local var_4_5 = var_4_1[iter_4_1]
		local var_4_6 = arg_4_0._event
		local var_4_7 = var_8.emit

		Fushun3GameEvent = var_1_10010

		var_4_7(var_4_6, var_1_10010.check_item_damage, {
			collider = var_4_5.collider,
			callback = function(arg_5_0)
				if arg_5_0 then
					...
					local var_5_4 = var_2_10003.add_effect_call
					local var_5_5 = {
						effectName = "EF_fr_Hit_LA"
					}

					findTF = var_2_10005
					var_5_5.targetTf = var_2_10005(var_4_5.tf, "effectPos")

					var_5_3(var_5_2, var_5_4, var_5_5)

					local var_5_6 = arg_4_0

					var_1.removeItem(var_5_6, var_4_5)
				end
...
function var_0_0.createPlatformItem(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_0.getWeightItemsMap(var_7_1) then
		Fushun3GameConst = var_7_1
		var_7_0 = var_7_1.item_map[var_4]
	end

	if var_7_0 then
		local var_7_2 = var_7_0.list
		local var_7_3 = arg_7_0._itemPos
		local var_7_4 = var_6.InverseTransformPoint(var_7_3, arg_7_1)
		local var_7_5 = 0
		local var_7_6 = 0
		...
		for iter_7_0 = #var_7_2, 1, -1 do
			...
			for iter_7_1, iter_7_2 in var_1_10014(var_7_7) do
				if iter_7_2 and 0 < iter_7_2 then
					local var_7_8 = arg_7_0

					var_1_10019 = arg_7_0.createItemById

					local var_7_9 = iter_7_2

					Vector2 = var_1_10022

					var_1_10019(var_7_8, var_7_9, var_1_10022(var_7_4.x + var_7_6, var_7_4.y + var_7_5))
				end

				Fushun3GameConst = var_1_10019
				var_7_6 = var_7_6 + var_1_10019.item_h
			end

			var_7_6 = 0
			Fushun3GameConst = var_1_10014
			var_7_5 = var_7_5 + var_1_10014.item_v
		end
	end
...
function var_0_0.createItemById(arg_8_0, arg_8_1, arg_8_2)
	...
	if arg_8_0.getOrCreateItem(var_8_2, var_8_0) then
		setActive = var_8_2

		var_8_2(var_4.tf, true)

		local var_8_3 = var_4.tf

		var_8_3.anchoredPosition = arg_8_2
		table = var_8_3

		var_8_3.insert(arg_8_0.items, var_4)
	end
...
function var_0_0.getOrCreateItem(arg_11_0, arg_11_1)
	for iter_11_0 = 1, #arg_11_0.itemPools do
		if arg_11_0.itemPools[iter_11_0].data.name == arg_11_1 then
			...
			return var_1_10007.remove(arg_11_0.itemPools, iter_11_0)
		end
	end
	...
	for iter_11_1 = var_11_0, #var_3.item_data do
		...
		if var_1_10006(var_1_10007.item_data[iter_11_1]).name == arg_11_1 then
			tf = var_1_10007
			instantiate = var_1_10008
			findTF = var_1_10009
			var_1_10007 = var_1_10007(var_1_10008(var_1_10009(arg_11_0._itemTpls, arg_11_1)))
			Fushun3GameConst = var_1_10008
			var_1_10007.localScale = var_1_10008.game_scale_v3
			findTF = var_1_10008
			var_1_10008 = var_1_10008(var_1_10007, "collider").gameObject
			LayerMask = var_1_10009
			var_1_10008.layer = var_1_10009.NameToLayer("Collider")
			GetComponent = var_1_10008
			findTF = var_1_10009
			var_1_10009 = var_1_10009(var_1_10007, "collider")
			typeof = var_10
			BoxCollider2D = var_11
			var_1_10008 = var_1_10008(var_1_10009, var_10(var_11))
			setParent = var_1_10009

			var_1_10009(var_1_10007, arg_11_0._itemPos)
		...
		if var_1.random(1, arg_12_0.itemTime) == arg_12_0.itemTime then
			...
			if not arg_12_0.itemsMap then
				...
				for iter_12_0 = 1, #arg_12_0.weightItems do
					...
					if var_1_10007(var_1_10008.item_map_ids, var_12_0.map) then
						table = var_1_10007
