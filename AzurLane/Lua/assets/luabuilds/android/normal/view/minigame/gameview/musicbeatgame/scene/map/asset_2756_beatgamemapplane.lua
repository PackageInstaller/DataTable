...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BeatGameMapBase"))
local var_0_2 = 500
local var_0_3 = 0.1
local var_0_4 = 20
...
function var_0_1.onInit(arg_1_0)
	...
	arg_1_0.touchTrigger = var_1(var_1_0, var_3(var_1_10004))
	GetOrAddComponent = var_1
	...
	typeof = var_3
	EventTriggerListener = var_1_10004
	arg_1_0.flapTrigger = var_1(var_1_1, var_3(var_1_10004))
	...
	var_1_5(var_1_4, var_3.KEY_CODE_DOWN, function(arg_4_0, arg_4_1, arg_4_2)
		KeyCode = var_2_10003
	...
	typeof = var_3
	SpineAnimUI = var_4
	arg_1_0.leftSpine = var_1_5(var_1_6, var_3(var_4))
	findTF = var_1
	...
	typeof = var_3
	SpineAnimUI = var_4
	arg_1_0.rightSpine = var_1(var_1_8, var_3(var_4))
	findTF = var_1
...
function var_0_1.createDymItem(arg_8_0, arg_8_1)
	...
	local var_8_4 = arg_8_0.createItemTf(var_8_3, var_8_2.prefab)

	GetComponent = var_8_3
	...
	local var_8_6 = var_8_3(var_8_5, var_1_10008(var_1_10009))
...
function var_0_1.createItemTf(arg_10_0, arg_10_1)
	...
	local var_10_0 = var_1_10002(var_1_10003(var_1_10004(arg_10_0._tf, arg_10_1)))

	setParent = var_3

	var_3(var_10_0, arg_10_0.content)

	setActive = var_3

	var_3(var_10_0, false)
...
function var_0_1.keyTrigger(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	arg_11_0:setCharAnimation(arg_11_0.leftSpine, arg_11_1, 0, function()
		...
		var_12_2(var_12_1, var_2.deltaTime)
		...
		if var_0.getCheckDymItem(var_13_0) then
			...
			var_13_2(var_13_1, var_2_10003.TRACK_EVENT_MATCH, var_0.track, function(arg_14_0, arg_14_1)
				if arg_14_0 then
					var_0.trigger = true
					var_0.anim.speed = 1
					...
					if var_0.data.act == arg_11_3 then
						...
						var_14_2(var_14_1, var_4.ADD_SCORE, {
		...
		for iter_23_0 = #arg_23_0.dymItems, 1, -1 do
			if arg_23_0.dymItems[iter_23_0] then
					...
					if var_6.check and not var_6.trigger then
						...
						if var_1_10011.beat_offset < var_23_3 then
							...
							if not var_6.trigger then
								var_1_10011 = arg_23_0

								arg_23_0.setEmoji(var_1_10011, "miss")

								if var_6.data.act == "flap" then
									var_1_10011 = arg_23_0

									arg_23_0.changeLife(var_1_10011, -1)
								end
							end
						end
					end
				...
				elseif var_23_1 > 0 and var_23_1 <= var_1_10007 then
					...
					arg_23_0.activeDymItem(var_1_10011, var_6)
				elseif not var_6.throw and var_23_1 > 0 and var_23_1 <= var_1_10007 + 100 then
					var_6.throw = true
					var_1_10011 = arg_23_0

					arg_23_0.setCharAnimation(var_1_10011, arg_23_0.rightSpine, "throw", 0, function()
...
function var_0_1.changeLife(arg_29_0, arg_29_1)
	...
	if arg_29_0.lifeCount <= 0 then
		var_29_0 = arg_29_0._event
		var_29_1 = var_29_1.emit
		MusicBeatGameEvent = var_1_10004

		var_29_1(var_29_0, var_1_10004.GAME_OVER)
	end

	setText = var_29_1
	findTF = var_29_0

	var_29_1(var_29_0(arg_29_0.beatCount, "text"), arg_29_0.lifeCount)
...
function var_0_1.setEmoji(arg_30_0, arg_30_1)
	...
	var_30_1(var_30_0, var_4(arg_30_0.emojiTf, "ad"), false)
	...
	if arg_30_1 then
		...
		var_30_1(var_3(arg_30_0.emojiTf, "ad/" .. arg_30_1), true)
	end
...
function var_0_1.setChildVisible(arg_31_0, arg_31_1, arg_31_2)
	for iter_31_0 = 1, arg_31_1.childCount do
		...
		local var_31_1 = arg_31_1.GetChild(var_31_0, iter_31_0 - 1)

		setActive = var_31_0

		var_31_0(var_31_1, arg_31_2)
	end
