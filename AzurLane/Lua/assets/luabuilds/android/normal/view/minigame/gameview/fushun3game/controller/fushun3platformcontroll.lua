...
function var_0_0.start(arg_2_0)
	...
	for iter_2_1 = var_2_0, #var_2.platform_data do
		...
		var_1_10005 = var_1_10005(var_1_10006.platform_data[iter_2_1])
		arg_2_0._weightTotal = arg_2_0._weightTotal + var_1_10005.weight
		table = var_1_10006

		var_1_10006.insert(arg_2_0.createDatas, {
			config = var_1_10005,
...
function var_0_0.updateCreateData(arg_3_0)
	...
	for iter_3_0 = var_3_0, #var_1_10002.platform_data do
		Clone = var_1_10005
		Fushun3GameConst = var_1_10006
		var_1_10005 = var_1_10005(var_1_10006.platform_data[iter_3_0])
		arg_3_0._weightTotal = arg_3_0._weightTotal + var_1_10005.weight + var_1_10005.diff * arg_3_0.level
		table = var_1_10006

		var_1_10006.insert(arg_3_0.createDatas, {
			config = var_1_10005,
...
function var_0_0.fillPlatform(arg_4_0)
	...
	if var_4_0 < var_4_1 + var_1_10003.platform_distance then
		if arg_4_0:getPlatform().high then
			setActive = var_2
			findTF = var_3

			var_2(var_3(var_1.tf, "high_roof"), true)
		end
		...
		local var_4_2 = var_1.tf

		Vector2 = var_3
		var_4_2.anchoredPosition = var_3(arg_4_0.fillDistance, 0)
		setActive = var_4_2

		var_4_2(var_1.tf, true)

		GetComponent = var_4_2
		...
		local var_4_4 = var_4_2(var_4_3, var_4(var_5))

		Fushun3GameVo = var_4_3

		local var_4_5 = var_4_3.GetTimeFlag() and "day_no_fade" or "night_no_fade"

		var_4_4:SetTrigger(var_4_5)

		if var_1.monster then
			findTF = var_4

			local var_4_6 = var_4(var_1.tf, "monster")
			local var_4_7 = arg_4_0._event
			local var_4_8 = var_5.emit

			Fushun3GameEvent = var_1_10007

			var_4_8(var_4_7, var_1_10007.create_monster_call, {
				pos = var_4_6.position
			})
		end
		...
		if var_1.item then
			...
			local var_4_9 = var_4(var_1.tf, "item")
			local var_4_10 = 0
			local var_4_11 = arg_4_0._event
			local var_4_12 = var_6.emit

			Fushun3GameEvent = var_1_10008

			var_4_12(var_4_11, var_1_10008.create_platform_item_call, {
				pos = var_4_9.position,
				id = var_4_10
			})
		end
...
function var_0_0.getPlatform(arg_5_0)
	...
	if not arg_5_0.getPlatformFromPool(var_5_6, var_5_1) then
		...
		local var_5_7 = var_5_6(var_9(var_1_10010(arg_5_0._tplTf, var_5_1)))

		Fushun3GameConst = var_9
		var_5_7.localScale = var_9.game_scale_v3
		...
		for iter_5_0 = 0, 5 do
			...
			if var_1_10014(var_5_7, "collider" .. var_5_8) then
				local var_5_9 = var_1_10014.gameObject
...
function var_0_0.removePlatform(arg_9_0)
	for iter_9_0 = #arg_9_0._platforms, 1, -1 do
		...
		if var_9_0 < var_9_1 - var_1_10008.platform_remove then
			...
			local var_9_3 = arg_9_0._platformPool

			table = var_1_10008

			var_9_2(var_9_3, var_1_10008.remove(arg_9_0._platforms, iter_9_0))
		end
	end
...
function var_0_0.changePlatformShow(arg_13_0, arg_13_1)
	for iter_13_0 = #arg_13_0._platforms, 1, -1 do
		...
		if arg_13_1 then
			...
			var_1_10008 = var_13_0
			typeof = var_1_10009
			Animator = var_1_10010
			var_1_10007 = var_1_10007(var_1_10008, var_1_10009(var_1_10010))
			Fushun3GameVo = var_1_10008
			var_1_10008 = var_1_10008.GetTimeFlag() and "day" or "night"
			var_1_10010 = var_1_10007

			var_1_10007.SetTrigger(var_1_10010, var_1_10008)
		else
			GetComponent = var_1_10007
			findTF = var_1_10008
			var_1_10008 = var_1_10008(var_13_0, "day")
			typeof = var_1_10009
			...
			GetComponent = var_1_10007
			findTF = var_1_10008
			var_1_10008 = var_1_10008(var_13_0, "night")
			typeof = var_1_10009
			CanvasGroup = var_1_10010
			var_1_10007 = var_1_10007(var_1_10008, var_1_10009(var_1_10010))
			Fushun3GameVo = var_1_10008
