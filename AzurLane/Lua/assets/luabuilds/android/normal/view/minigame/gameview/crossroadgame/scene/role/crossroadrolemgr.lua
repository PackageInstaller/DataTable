...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0.frontRoadList = var_1_1(var_1_0, var_1_10006.FRONT_ROAD_NAME)
	...
	local var_1_4 = var_1_3(var_1_2, var_6.FRONT_ROAD_NAME)
...
function var_0_0.Prepare(arg_2_0)
	...
	for iter_2_0 = 1, #var_2_1 do
		...
		var_8.insert(arg_2_0.roleList, var_1_10007)
	end
	...
	CrossRoadGameHelper = iter_2_0

	local var_2_7 = iter_2_0.GetAddNum

	CrossRoadGameConst = var_1_10006

	var_2(var_2_5, var_2_6 .. var_2_7(var_1_10006.SCORE_GROUP))
	...
	arg_2_0.finishAnimator = var_4(var_2_12, var_6(var_1_10007))
	...
	arg_2_0.finishDft = var_4(var_2_13, var_6(var_1_10007))
...
function var_0_0.Step(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_2(arg_5_0.roleList) do
		if iter_5_1:GetRunState() == arg_5_0._roleState.crash then
			...
			local var_5_2, var_5_3 = arg_5_0:CheckCanMoveRole(iter_5_1)

			if var_5_2 then
				if iter_5_1:GetID() == iter_5_1:GetFatherID() then
					local var_5_4 = arg_5_0._runningData

					var_9.TryUpdateUnion(var_5_4, iter_5_1)
				end
				...
				if var_5_3 then
					...
					var_9.InRoleUnion(var_5_5, iter_5_1, arg_5_0.roleList[var_5_3])

					local var_5_6 = iter_5_1
					local var_5_7 = iter_5_1.GetTrack(var_5_6)

					CrossRoadGameConst = var_5_6

					if var_5_7 ~= var_5_6.BACK_ROAD_NAME then
	...
	if var_2.CanRefreshRound(var_5_8) then
		var_5_8 = arg_5_0._runningData

		var_2.RefreshRound(var_5_8)

		var_5_8 = arg_5_0._runningData

		local var_5_9 = var_2.GetRoundCnt(var_5_8)

		var_5_8 = arg_5_0._event
		CrossRoadGameConst = var_4

		var_5_8(var_4.NEW_ROUND, var_5_9)

		if 0 <= var_5_9 then
			arg_5_0.lastFinishShowTime = arg_5_0.time
			setActive = var_5_8

			var_5_8(arg_5_0.allFinishTF, true)

			setActive = var_5_8

			var_5_8(arg_5_0.addScoreTF, false)

			local var_5_10 = arg_5_0.finishAnimator

			var_5_8.Play(var_5_10, "anim_CrossRoadGameUI_pac_allFinish_in")

			var_5_8 = arg_5_0._event
			CrossRoadGameConst = var_5_10

			local var_5_11 = var_5_10.GET_SCORE
			local var_5_12 = {}

			CrossRoadGameConst = iter_5_1
			var_5_12[1] = iter_5_1.SCORE_GROUP

			var_5_8(var_5_11, var_5_12)
		end

		arg_5_0:ReStatrGroup()
	end

	local var_5_13 = arg_5_0.lastFinishShowTime

	CrossRoadGameConst = var_5_8

	if var_5_13 + var_5_8.SHOW_GROUP_TIME < arg_5_0.time then
		local var_5_14 = arg_5_0.time

		CrossRoadGameConst = var_3
		arg_5_0.lastFinishShowTime = var_5_14 + var_3.GAME_TIME

		local var_5_15 = arg_5_0.finishAnimator

		var_2.Play(var_5_15, "anim_CrossRoadGameUI_pac_allFinish_out")
	end
...
function var_0_0.UpdateSelect(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_6_2(arg_6_0.roleList) do
		if iter_6_1:GetRunState() == arg_6_0._roleState.crash then
			...
			if var_6_6.abs(var_6_3 - var_6_7) < var_6_0 then
				math = var_12
	...
	if var_6_1 ~= -1 then
		var_6_8 = arg_6_0.roleList[var_6_1]

		var_4.SetSelectTime(var_6_8, arg_6_0.time)

		var_6_8 = arg_6_0.roleList[var_6_1]

		var_4.SetAngryActive(var_6_8, false)
	end

	if arg_6_0.selectRoleId ~= var_6_1 then
		local var_6_9 = arg_6_0.lastSelectTime

		CrossRoadGameConst = var_6_8

		if var_6_9 + var_6_8.PLAYER_SELECT_TIME < arg_6_0.time then
			if arg_6_0.selectRoleId ~= -1 then
				local var_6_10 = arg_6_0.roleList[arg_6_0.selectRoleId]

				var_4.SetSelectActive(var_6_10, false)
			end
...
function var_0_0.CheckCanMoveRole(arg_8_0, arg_8_1)
	...
	local var_8_1 = arg_8_1.GetTrack(var_8_0)
...
function var_0_0.UpdateRoleMove(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_5 = arg_10_1.GetDirect(var_10_4)

	CrossRoadGameConst = var_10_4

	if var_10_3 == var_10_4.SCENE_ROAD_NAME then
		for iter_10_0 = 1, 6 do
			if arg_10_0.itemList[iter_10_0] ~= nil then
				CrossRoadGameHelper = var_1_10013

				local var_10_6 = var_1_10013

				if var_1_10013.CheckRoleInItem(var_10_6, arg_10_1, var_12) then
					var_1_10013 = var_12.id
					CrossRoadGameConst = var_10_6

					if var_1_10013 == var_10_6.BING_MIAN then
	...
	local var_10_8 = var_9(var_10_0.x + var_10_7[1], var_10_0.y + var_10_7[2])
	local var_10_9 = arg_10_1
	local var_10_10 = arg_10_1.SetAction

	CrossRoadGameConst = var_12

	var_10_10(var_10_9, var_12.SHIP_STATE_ACTION.walk, 0)

	CrossRoadGameHelper = var_10_10

	if var_10_10:isMiddle(var_10_8.x, var_10_2.x, var_10_0.x) or var_10_0.x < var_10_2.x then
		CrossRoadGameConst = var_10

		if var_10_3 == var_10.BACK_ROAD_NAME then
			arg_10_0:SetRoleSceneTaget(arg_10_1)
		else
			CrossRoadGameConst = var_10

			if var_10_3 == var_10.SCENE_ROAD_NAME then
				arg_10_0:SetRoleEndTarget(arg_10_1)
			else
				CrossRoadGameConst = var_10

				if var_10_3 == var_10.FRONT_ROAD_NAME then
...
function var_0_0.SetRoleSceneTaget(arg_11_0, arg_11_1)
	...
	var_11_1(var_11_0, var_4.SCENE_ROAD_NAME)
...
function var_0_0.SetRoleEndTarget(arg_12_0, arg_12_1)
	...
	var_12_3(var_12_2, var_12_4, var_6.SCORE_ONE * arg_12_0.comboCnt)
	...
	var_12_6(var_4.ADD_ROLE, nil, nil)
	...
	var_12_8(var_12_7, var_5.FRONT_ROAD_NAME)
...
function var_0_0.ReStatrGroup(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1(arg_15_0.roleList) do
		...
		var_15_3(var_15_2, var_15_4 + var_9.WALKER_GO_AGIN_TIME * (iter_15_0 - 1))
		...
		var_15_6(var_15_5, var_8.BACK_ROAD_NAME)
...
function var_0_0.ShowCombo(arg_16_0, arg_16_1, arg_16_2)
	...
	if var_16_0 then
		...
		local var_16_5 = var_16_4(var_16_3, var_6(iter_16_0))
		...
		var_5(var_6.Find(var_16_6, "combocnt"), "X " .. arg_16_1)

		setText = var_5

		local var_16_7 = arg_16_0.lastComboTF

		var_5(var_6.Find(var_16_7, "addScore"), "+" .. arg_16_2)
...
function var_0_0.xuanWoStop(arg_17_0, arg_17_1)
	...
	local var_17_1 = arg_17_1.GetXuanWoRollTime(var_17_0)

	CrossRoadGameConst = var_17_0

	if var_17_1 + var_17_0.XUANWO_LIFE_TIME > arg_17_0.time then
		return false
	end
...
function var_0_0.SetImageNumber(arg_18_0, arg_18_1, arg_18_2)
	...
	var_1_10005(arg_18_1:Find("wei2/0_" .. var_3), true)

	setActive = var_1_10005

	var_1_10005(arg_18_1:Find("wei2/0_" .. var_18_0), false)
	...
	for iter_18_0 = 0, 9 do
		...
		var_1_10010(arg_18_1:Find("wei1/0_" .. iter_18_0), false)
	end
