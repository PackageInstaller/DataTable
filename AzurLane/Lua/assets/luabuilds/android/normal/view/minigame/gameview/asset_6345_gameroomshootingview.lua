...
function var_0_1.init(arg_2_0)
	...
	var_2(var_2_21, var_4("game_room_shooting_tip"))
...
function var_0_1.didEnter(arg_9_0)
	...
	var_1_10001(var_9_0, var_3(arg_9_0.startMaskTF, "startGame"), function()
	...
	var_1(var_9_1, var_3(arg_9_0.startMaskTF, "ruleGame"), function()
		pg = var_2_10000
...
local function var_0_2(arg_17_0, arg_17_1)
	...
	local var_17_0 = var_1_10003.clamp(arg_17_0.x, -arg_17_1.x, arg_17_1.x)

	math = var_4

	return var_1_10002(var_17_0, var_4.clamp(arg_17_0.y, -arg_17_1.y, arg_17_1.y))
end
	...
	if not arg_18_0.isStopped then
		if arg_18_0.isAfterCount and arg_18_0.sightTimeMark then
			...
			if not arg_18_0.moveRect then
				...
				Vector2 = var_3
				arg_18_0.moveRect = var_3(var_18_1.rect.width - arg_18_0.sightTF.rect.width, var_18_1.rect.height - arg_18_0.sightTF.rect.height) / 2
			end
...
function var_0_1.resetTime(arg_19_0)
	...
	var_1(var_1_10002(arg_19_0.countdownTF, "count"), arg_19_0.countdown)
...
function var_0_1.gameStart(arg_20_0)
	...
	;(function(arg_21_0)
		...
		var_1.addTimer(var_21_0, "start countdown", 1, function()
			...
			var_22_0(var_1(arg_20_0.countdownTF, "count"), arg_20_0.countdown)
		...
		for iter_26_0 = 1, 3 do
			for iter_26_1 = 1, 6 do
				if arg_26_0.cell[iter_26_0][iter_26_1] then
					...
					local var_26_6 = var_26_5(var_26_4, var_12(var_13))
...
function var_0_1.showResultPanel(arg_29_0, arg_29_1, arg_29_2)
	...
	var_1_10004(var_29_1, var_6.Find(var_29_2, "bg"), var_29_0)
	...
	var_1_10004(var_29_3, var_6.Find(var_29_4, "main/btn_confirm"), var_29_0)
...
function var_0_1.updateCount(arg_33_0)
	...
	local var_33_0 = var_1_10001(var_2)
...
function var_0_1.initFireFunc(arg_34_0)
	...
	local function var_34_6()
		...
		local var_35_2 = var_35_0(var_35_1, var_2(1.95, 1.95, 1), 0.1)
		local var_35_3 = var_0.setOnComplete

		System = var_2

		var_35_3(var_35_2, var_2.Action(function()
	...
	local function var_34_7()
		...
		var_37_1(var_37_0, var_2.Action(function()
			LeanTween = var_3_10000
			...
			var_38_0(var_38_1, var_3_10002.one, 0.1)
	...
	function arg_34_0._upFunc()
		...
		local var_40_2 = var_40_0(var_40_1, var_2_10002(2, 2, 2), 0.03)
		local var_40_3 = var_0.setOnComplete

		System = var_2

		var_40_3(var_40_2, var_2.Action(function()
			LeanTween = var_3_10000
			...
			local var_41_2 = var_41_0(var_41_1, var_3_10002.one, 0.07)
		...
		if var_40_5 then
			...
			local var_40_15 = var_40_14(var_40_13, var_6(var_7))
		...
		if arg_47_0._downFunc ~= nil then
			...
			var_2.AddPointDownFunc(var_47_0, function()
				...
				if arg_47_0._main_cannon_sound then
					var_48_0 = arg_47_0._main_cannon_sound
				...
				local var_48_2 = var_48_0.CriMgr.GetInstance()
...
function var_0_1.flushTarget(arg_51_0, arg_51_1)
	...
	for iter_51_0 = 1, 3 do
		for iter_51_1 = 1, 6 do
			...
			var_1_10012 = arg_51_0.targetPanel
			var_1_10012 = var_11.Find(var_1_10012, "line_" .. iter_51_0)

			var_1_10010(var_11.GetChild(var_1_10012, iter_51_1 - 1))
		end
	end
	...
	for iter_51_2, iter_51_3 in var_3(arg_51_0.targetCount) do
		for iter_51_4 = 1, iter_51_3 do
			...
			local var_51_1 = var_13.random(6)

			while arg_51_0.cell[var_1_10012][var_51_1] or arg_51_1 and var_51_0[var_1_10012] >= 4 do
				math = var_51_2

				local var_51_2 = var_51_2.random(3)

				math = var_15
				var_51_1 = var_15.random(6)
				var_1_10012 = var_51_2
			end

			var_51_0[var_1_10012] = var_51_0[var_1_10012] + 1

			local var_51_3 = arg_51_0.cell[var_1_10012]

			var_51_3[var_51_1] = iter_51_2
			cloneTplTo = var_51_3

			local var_51_4 = arg_51_0.targetTpl[iter_51_2]
			local var_51_5 = arg_51_0.targetPanel
			local var_51_6 = var_16.Find(var_51_5, "line_" .. var_1_10012)

			var_51_3(var_51_4, var_16.GetChild(var_51_6, var_51_1 - 1))
		end
	end
