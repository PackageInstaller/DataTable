	...
	local var_1_0 = {
		...
		selectGift = function(arg_7_0, arg_7_1)
			...
			if #arg_7_0.selectedGifts >= var_0_17 then
				...
				var_7_4(var_7_3, var_7_5, iter_7_2(arg_7_0.selectedGifts), function(arg_8_0)
					if not arg_8_0 then
		...
		moveJiujiu = function(arg_11_0, arg_11_1)
			if arg_11_1 == -1 then
				...
				Vector3 = var_5
				var_11_4.localScale = var_5.New(1, 1, 1)
			end
...
local function var_0_35(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	local var_13_0 = {
		...
		createFans = function(arg_19_0, arg_19_1)
			...
			var_2_10002(var_19_0, var_4(arg_19_0._groupTf, "fansPos"))
			...
			math = var_5
			var_19_4.speed = var_5.random() + 2.5
			...
			local var_19_7 = var_19_6 .. var_19_4.random(1, 4)
			...
			var_4.GetSpineChar(var_19_8, var_19_7, true, function(arg_20_0)
				...
				var_20_3(var_20_2, var_3_10003(var_19_5.tf, "spinePos"), false)
		...
		step = function(arg_26_0, arg_26_1)
			...
			for iter_26_0 = #arg_26_0.fans, 1, -1 do
				...
				if var_6.tf.anchoredPosition.x > (iter_26_0 - 1) * var_0_33 then
				...
				elseif iter_26_0 == 1 and not var_6.leave then
					if var_6.gifts == nil then
						...
						local var_26_1 = var_9("ui/minigameui/idolmasterui_atlas", "pack" .. var_6.gifts[1])

						setImageSprite = var_10
						findTF = var_11

						var_10(var_11(var_6.tf, "score/pack"), var_26_1)
			...
			if #arg_26_0.fans > 0 then
				...
				local var_26_2 = var_2.tf

				var_3.SetSiblingIndex(var_26_2, #arg_26_0.fans - 1)
			end
		...
		showFansWanted = function(arg_28_0, arg_28_1)
			...
			var_2_10006(var_2_10007(arg_28_1.tf, "wanted"), true)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/bg1"), not var_28_2)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/bgTime1"), not var_28_2)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/time1"), not var_28_2)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/bg2"), var_28_2)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/bgTime2"), var_28_2)

			setActive = var_2_10006
			findTF = var_7

			var_2_10006(var_7(arg_28_1.tf, "wanted/time1"), var_28_2)
			...
			local var_28_3 = var_7(arg_28_1.tf, "wanted/time1")

			math = var_8

			local var_28_4 = var_8.abs

			math = var_9

			var_6(var_28_3, var_28_4(var_9.ceil(var_28_0)) .. "S")
			...
			local var_28_6 = var_8.abs

			math = var_9

			var_6(var_28_5, var_28_6(var_9.ceil(var_28_0)) .. "S")
			...
			for iter_28_0 = 1, #var_28_1 do
				...
				var_11(var_12(arg_28_1.tf, "wanted/item" .. iter_28_0), var_28_7)
			end
		...
		createWantedGifts = function(arg_31_0)
			...
			local var_31_2 = var_2_10003.insert
			local var_31_3 = var_31_1
			local var_31_4 = var_0_15

			math = var_2_10006

			var_31_2(var_31_3, var_31_4[var_2_10006.random(1, #var_0_15)])
			...
			for iter_31_0 = 1, 2 do
				...
				math = var_2_10009
				var_31_5 = var_31_5(var_31_6, var_2_10009.random(1, #var_31_0))
				table = var_31_6

				var_31_6.insert(var_31_1, var_31_5)
			end
		...
		fanLeave = function(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
			...
			var_2_10004(var_2_10005(arg_32_1.tf, "wanted"), false)
			...
			elseif var_0_30 then
				...
				var_5(var_6(arg_32_1.tf, "score"), "+" .. var_0_7)

				setActive = var_5
				findTF = var_6

				var_5(var_6(arg_32_1.tf, "score"), true)
			end
	...
	local var_36_0 = {
		Ctor = function(arg_37_0)
			...
			for iter_37_0 = 1, var_0_31 do
				...
				var_2_10006 = var_2_10006(var_2_10007(arg_37_0._tplGroup))
				...
				var_8.insert(arg_37_0.groups, var_2_10007)
			end
		...
		getRandomIdols = function(arg_39_0)
			...
			for iter_39_0 = 1, var_0_31 do
				...
				if var_39_2 then
					...
					var_2_10010 = var_0_11
					math = iter_39_1

					var_39_3(var_39_4, var_2_10010[iter_39_1.random(1, #var_0_11)])
				else
					table = var_39_3
					...
					var_39_5(var_39_6, var_2_10010(iter_39_1, iter_39_2.random(1, #var_39_1)))
				end
			end
		...
		start = function(arg_41_0)
			...
			for iter_41_0 = 1, 3 do
				...
				var_41_1(var_41_0, var_2_10008(var_2_10009(arg_41_0._tplFans)))
			end
		...
		step = function(arg_42_0, arg_42_1)
			...
			local var_42_1 = arg_42_0:getApearTime()

			if not arg_42_0.createFansTime then
				local var_42_2 = arg_42_1 + var_42_1

				math = var_2_10004
				arg_42_0.createFansTime = var_42_2 + var_2_10004.random() * 1
			elseif arg_42_0.createFansTime < arg_42_1 then
				math = var_3

				local var_42_3 = var_3.random(1, #arg_42_0.groups)
				local var_42_4 = arg_42_0.groups[var_42_3]
				local var_42_5 = var_4.createFans

				tf = var_2_10006
				instantiate = var_2_10007

				var_42_5(var_42_4, var_2_10006(var_2_10007(arg_42_0._tplFans)))

				local var_42_6 = arg_42_1 + var_42_1

				math = var_42_4
				arg_42_0.createFansTime = var_42_6 + var_42_4.random() * 1
			end

			for iter_42_0 = 1, #arg_42_0.groups do
				local var_42_7 = arg_42_0.groups[iter_42_0]

				var_7.step(var_42_7, arg_42_1)
			end
...
function var_0_1.initUI(arg_53_0)
	...
	local var_53_0 = var_2(arg_53_0.countUI, "count")

	typeof = var_3
	Animator = var_4
	arg_53_0.countAnimator = var_1(var_53_0, var_3(var_4))
	GetComponent = var_1
	findTF = var_53_0
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_53_0.countDft = var_1(var_53_1, var_3(var_4))
	...
	local var_53_5 = var_3(arg_53_0.leaveUI, "ad/btnOk")
	...
	var_1(var_53_4, var_53_5, var_53_6, var_5)
	...
	var_1(var_53_7, var_53_8, var_53_9, var_5)
	...
	local var_53_11 = var_3(arg_53_0.pauseUI, "ad/btnOk")
	...
	var_1(var_53_10, var_53_11, var_53_12, var_5)
	...
	local var_53_14 = var_3(arg_53_0.settlementUI, "ad/btnOver")
	...
	var_1(var_53_13, var_53_14, var_53_15, var_5)
	...
	local var_53_16 = var_2(arg_53_0.menuUI, "battList")

	typeof = var_3
	ScrollRect = var_4
	arg_53_0.battleScrollRect = var_1(var_53_16, var_3(var_4))
	arg_53_0.totalTimes = arg_53_0:getGameTotalTime()

	local var_53_17, var_53_18

	if arg_53_0:getGameUsedTimes() - 4 < 0 then
		var_53_17 = 0
	else
		var_53_18 = arg_53_0
		var_53_17 = arg_53_0.getGameUsedTimes(var_53_18) - 4
	end

	scrollTo = var_53_18

	var_53_18(arg_53_0.battleScrollRect, 0, 1 - var_53_17 / (arg_53_0.totalTimes - 4))

	onButton = var_53_18

	local var_53_19 = arg_53_0

	findTF = var_4

	local var_53_20 = var_4(arg_53_0.menuUI, "rightPanelBg/arrowUp")

	local function var_53_21()
	...
	var_53_18(var_53_19, var_53_20, var_53_21, var_6)

	onButton = var_53_18

	local var_53_22 = arg_53_0

	findTF = var_53_20

	local var_53_23 = var_53_20(arg_53_0.menuUI, "rightPanelBg/arrowDown")

	local function var_53_24()
		local var_61_0
	...
	var_53_18(var_53_22, var_53_23, var_53_24, var_6)

	onButton = var_53_18

	local var_53_25 = arg_53_0

	findTF = var_53_23

	local var_53_26 = var_53_23(arg_53_0.menuUI, "btnBack")

	local function var_53_27()
	...
	var_53_18(var_53_25, var_53_26, var_53_27, var_6)

	onButton = var_53_18

	local var_53_28 = arg_53_0

	findTF = var_53_26

	local var_53_29 = var_53_26(arg_53_0.menuUI, "btnRule")

	local function var_53_30()
		pg = var_2_10000
		...
		var_63_2.type = var_2_10003
		pg = var_2_10003
		var_63_2.helps = var_2_10003.gametip.cowboy_tips.tip
	...
	var_53_18(var_53_28, var_53_29, var_53_30, var_6)

	onButton = var_53_18

	local var_53_31 = arg_53_0

	findTF = var_53_29

	local var_53_32 = var_53_29(arg_53_0.menuUI, "btnStart")

	local function var_53_33()
		setActive = var_2_10000
	...
	var_53_18(var_53_31, var_53_32, var_53_33, var_6)

	findTF = var_53_18

	local var_53_34 = var_53_18(arg_53_0.menuUI, "tplBattleItem")
	...
	for iter_53_0 = 1, arg_53_0.totalTimes do
		...
		var_1_10007 = var_1_10007(var_1_10008(var_53_34))
		var_1_10007.name = "battleItem_" .. iter_53_0
		setParent = var_1_10008

		local var_53_35 = var_1_10007

		findTF = var_1_10010

		var_1_10008(var_53_35, var_1_10010(arg_53_0.menuUI, "battList/Viewport/Content"))

		var_1_10008 = iter_53_0
		GetSpriteFromAtlasAsync = var_53_35

		var_53_35("ui/minigameui/idolmasterui_atlas", "tx_" .. var_1_10008, function(arg_65_0)
			setImageSprite = var_2_10001
			findTF = var_2_10002

			var_2_10001(var_2_10002(var_1_10007, "state_open/icon"), arg_65_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10007, "state_clear/icon"), arg_65_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10007, "state_current/icon"), arg_65_0, true)
		...
		var_53_35("ui/minigameui/idolmasterui_atlas", "battleDesc" .. var_1_10008, function(arg_66_0)
			setImageSprite = var_2_10001
			findTF = var_2_10002

			var_2_10001(var_2_10002(var_1_10007, "state_open/buttomDesc"), arg_66_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10007, "state_clear/buttomDesc"), arg_66_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10007, "state_current/buttomDesc"), arg_66_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10007, "state_closed/buttomDesc"), arg_66_0, true)
		...
		var_53_35(var_1_10007, true)

		table = var_53_35

		var_53_35.insert(arg_53_0.battleItems, var_1_10007)
	end
...
function var_0_1.initGameUI(arg_67_0)
	...
	var_1(var_67_0, var_3(arg_67_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_67_1, var_3(arg_67_0.gameUI, "btnLeave"), function()
	...
	for iter_67_0 = 1, var_0_28 do
		...
		var_67_2(var_67_3, var_1_10007(arg_67_0.gameUI, "top/heart" .. iter_67_0 .. "/full"))
	end
	...
	local var_67_5 = var_2(arg_67_0._tf, "scene/gift")

	findTF = var_3
	arg_67_0.giftUI = var_67_4(var_67_5, var_3(arg_67_0._tf, "scene/jiujiuWorker"), arg_67_0)
	findTF = var_1
...
function var_0_1.updateMenuUI(arg_72_0)
	...
	for iter_72_0 = 1, #arg_72_0.battleItems do
		...
		var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_open"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_closed"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_clear"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_current"), false)

		if iter_72_0 <= var_72_0 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_clear"), true)
		elseif iter_72_0 == var_72_0 + 1 and 1 <= var_72_1 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_current"), true)
		elseif var_72_0 < iter_72_0 and iter_72_0 <= var_72_0 + var_72_1 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_open"), true)
		else
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_72_0.battleItems[iter_72_0], "state_closed"), true)
		end
	end
	...
	var_5(var_6(arg_72_0.menuUI, "btnStart/tip"), var_72_1 > 0)
	arg_72_0:CheckGet()
...
function var_0_1.CheckGet(arg_73_0)
	...
	var_1_10001(var_1_10002(arg_73_0.menuUI, "got"), false)
	...
	if arg_73_0:getUltimate() == 0 then
		local var_73_1 = arg_73_0:getGameTotalTime()
		local var_73_2 = arg_73_0

		if var_73_1 > arg_73_0.getGameUsedTimes(var_73_2) then
			return
		end

		pg = var_73_2

		local var_73_3 = var_73_2.m02
		local var_73_4 = var_3.sendNotification

		GAME = var_1_10005

		local var_73_5 = var_1_10005.SEND_MINI_GAME_OP
		local var_73_6 = {
			hubid = arg_73_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_7
		var_73_6.cmd = var_7.CMD_ULTIMATE
		var_73_6.args1 = {}

		var_73_4(var_73_3, var_73_5, var_73_6)

		setActive = var_73_4
		findTF = var_73_3

		var_73_4(var_73_3(arg_73_0.menuUI, "got"), true)
	end
...
function var_0_1.openMenuUI(arg_74_0)
	...
	var_1_10001(var_1_10002(arg_74_0._tf, "scene_front"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_74_0._tf, "scene_background"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_74_0._tf, "scene"), false)
...
function var_0_1.gameStart(arg_77_0)
	...
	var_1_10001(var_1_10002(arg_77_0._tf, "scene_front"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_77_0._tf, "scene_background"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_77_0._tf, "scene"), true)
...
function var_0_1.updateGameUI(arg_87_0)
	...
	if var_87_0(var_2.ceil(arg_87_0.gameTime) / 60) < 10 then
		var_87_1 = "0" .. var_87_1
	end
	...
	if var_87_2(var_3.ceil(arg_87_0.gameTime) % 60) < 10 then
		var_87_3 = "0" .. var_87_3
	end
...
function var_0_1.onGameOver(arg_90_0)
	...
	local var_90_1 = var_2(arg_90_0._tf)
	local var_90_2 = 2

	System = var_1_10004

	var_90_0(var_90_1, var_90_2, var_1_10004.Action(function()
...
function var_0_1.showSettlement(arg_92_0)
	...
	local var_92_0 = var_2(arg_92_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_92_1 = var_1_10001(var_92_0, var_3(var_4))
	...
	if var_92_3 then
		...
		var_5(var_6(arg_92_0.settlementUI, "ad/new"), var_92_6 < var_92_4)
		...
		if arg_92_0:getGameTimes() and arg_92_0:getGameTimes() > 0 then
			local var_92_9 = arg_92_0
			local var_92_10 = arg_92_0.getGameUsedTimes(var_92_9) + 1

			pg = var_92_9

			local var_92_11 = var_92_9.NewStoryMgr.GetInstance()
			local var_92_12
...
function var_0_1.willExit(arg_96_0)
	if arg_96_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_96_0.handle)
	end
	...
	if arg_96_0._tf then
		...
		if var_96_0(var_1_10002(arg_96_0._tf)) then
			LeanTween = var_1
