...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.scrollrect = var_2_3(var_2_2, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_2.Find(var_2_5, "overview/levels/mask/content")
	local var_2_7 = arg_2_0._tf

	arg_2_0.levelUIlist = var_2_4(var_2_6, var_3.Find(var_2_7, "overview/levels/mask/content/1"))
...
function var_0_1.UpdateLevelTr(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_0 = var_1_10003(var_1_10004)
	local var_9_1 = var_3.GetHubByHubId(var_9_0, var_0_1.MINIGAME_HUB_ID)
	local var_9_2 = arg_9_2:Find("clear")
	local var_9_3 = arg_9_2:Find("unopen")
	local var_9_4 = arg_9_2
	local var_9_5 = arg_9_2.Find(var_9_4, "award")

	setActive = var_9_4

	var_9_4(var_9_2, arg_9_1 <= var_9_1.usedtime)

	local var_9_6 = arg_9_1 > var_9_1.count + var_9_1.usedtime

	setActive = var_9

	var_9(var_9_3, var_9_6)
	...
	if not var_9_6 then
		...
		local var_9_7 = var_9.mini_game[var_0_1.MINIGAME_ID].simple_config_data.drop[arg_9_1]
		local var_9_8 = {
			type = var_9_7[1],
			id = var_9_7[2],
			count = var_9_7[3]
		...
		updateDrop = var_1_10012

		var_1_10012(var_9_5, var_9_8)
		...
		local function var_9_11()
			...
			var_10_1(var_10_0, var_2_10002.ON_DROP, var_9_8)
		...
		var_1_10012(var_9_9, var_9_10, var_9_11, var_1_10016)
	end

	local var_9_12 = arg_9_2:Find("Text")
	local var_9_13 = var_9.GetComponent

	typeof = var_11
	Image = var_1_10012

	local var_9_14 = var_9_13(var_9_12, var_11(var_1_10012))

	LoadSprite = var_9_12
	var_9_14.sprite = var_9_12("ui/minigameui/pile_atlas", "level" .. arg_9_1)
...
function var_0_1.PackData(arg_11_0)
	...
	Vector2 = var_1_10004
	var_11_2.screen = var_1_10004(arg_11_0._tf.rect.width, arg_11_0._tf.rect.height)
