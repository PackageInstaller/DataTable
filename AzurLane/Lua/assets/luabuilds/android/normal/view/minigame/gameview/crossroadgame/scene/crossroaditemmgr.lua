...
function var_0_0.MakeHongcha(arg_5_0)
	...
	if var_2.HONGCHA_PERCENT < var_5_0 then
		return
	end
...
function var_0_0.MakeXuanWo(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_7_2, var_1_10005.XUAN_WO)
...
function var_0_0.MakeBingMain(arg_8_0, arg_8_1)
	...
	var_8_3(var_8_2, var_8_4, var_1_10007.BING_MIAN)
	...
	var_8_6(var_8_5, var_8_7, var_7.BING_MIAN)
...
function var_0_0.MakeItemInList(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = var_1_10004(var_1_10005(var_9_0))

	CrossRoadGameConst = var_5

	local var_9_3

	if arg_9_2 == var_5.BING_MIAN then
		...
		local var_9_4 = var_9_3(var_9_2, var_1_10007(var_1_10008)).sizeDelta

		CrossRoadGameConst = var_7
		var_9_4.x = var_7.BINGMIAN_DISTANCE
...
function var_0_0.Clear(arg_12_0)
	...
	arg_12_0.ClearHongcha(var_12_0)
