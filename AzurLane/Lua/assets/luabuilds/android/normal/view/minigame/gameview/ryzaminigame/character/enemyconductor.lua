...
function var_0_1.InitUI(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_1_0({
		...
		var_1_10007(var_8.Find(var_1_5, iter_1_1), function(arg_2_0)
			...
			local var_2_2 = var_2_1(var_2_0, var_3(var_2_10004))
			...
			var_1.SetEndEvent(var_2_2, function()
				...
				var_3_10000(var_1.Find(var_3_0, "Image"), false)
			...
			local var_2_5 = var_2_4(var_2_3, var_3(var_2_10004))
			...
			var_1.SetEndEvent(var_2_5, function()
				...
				var_3_10000(var_1.Find(var_4_0, "Protect"), false)
				...
				local var_4_3 = var_4_1(var_4_2, var_2.split(arg_2_0.name, "_")[2])

				table = var_4_2

				local var_4_4 = (var_4_3 - var_4_2.indexof(var_0_2, arg_1_0.statusMark) + 4) % 4 + 1
				...
				if arg_1_0.shieldCount[var_4_4] <= 0 then
					...
					var_1(var_2.Find(var_4_5, "Image"), true)
				end
		...
		if var_4.clamp(arg_7_0.pos.y - arg_7_1.y, -arg_7_2[3], arg_7_2[1]) ~= arg_7_0.pos.y - arg_7_1.y then
			if arg_7_0.pos.y == arg_7_1.y then
				...
				if var_4.clamp(arg_7_0.pos.x - arg_7_1.x, -arg_7_2[4], arg_7_2[2]) == arg_7_0.pos.x - arg_7_1.x then
					...
					local var_7_1 = var_5.indexof(var_0_2, var_7_0)

					table = var_6

					local var_7_2 = (var_7_1 - var_6.indexof(var_0_2, arg_7_0.statusMark) + 4) % 4 + 1

					if arg_7_0.shieldCount[var_7_2] > 0 then
						table = var_6

						local var_7_3 = (var_6.indexof(var_0_2, var_7_0) + 1) % 4 + 1

						math = var_7

						local var_7_4 = var_7.max

						math = var_8

						local var_7_5 = var_8.max

						math = var_1_10009

						local var_7_6 = var_1_10009.abs(arg_7_0.pos.x - arg_7_1.x)

						math = var_10
						arg_7_2[var_7_3] = var_7_4(var_7_5(var_7_6, var_10.abs(arg_7_0.pos.y - arg_7_1.y)) - arg_7_0.BlockRange, 0)
						arg_7_3[var_7_3] = {
							arg_7_0,
							var_7_2
						}
...
function var_0_1.PlayAnim(arg_8_0, arg_8_1)
	...
	if var_8_0 ~= var_3.split(arg_8_0.status, "_")[2] then
		string = var_8_0
