...
local function var_0_14(arg_1_0)
	...
	function var_1_0.stepUpdate(arg_3_0, arg_3_1)
		...
		Vector3 = var_2_10004
		var_3_1.localPosition = var_2_10004(var_3_0, 0, 0)

		if arg_3_0.longFlag then
			local var_3_2

			if var_3_0 == 0 then
				var_3_2 = (arg_3_0.endTime - arg_3_1) * arg_3_0.speedOffsetX

				if not arg_3_0.triggerDown and not arg_3_0.removeTime then
					arg_3_0.removeTime = arg_3_1 + var_0_12
				end
			else
				var_3_2 = (arg_3_0.endTime - arg_3_0.beginTime) * arg_3_0.speedOffsetX
			end
			...
			local var_3_3 = arg_3_0.longTf

			Vector2 = var_5
			var_3_3.sizeDelta = var_5(var_3_2, arg_3_0.longTf.sizeDelta.y)

			if var_3_2 == 0 and not arg_3_0.triggerUp and not arg_3_0.removeTime then
				arg_3_0.removeTime = arg_3_1 + var_0_12
			end
	...
	function var_1_0.setNoteData(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
		...
		if arg_4_1.key_flag == "K_BOTH" then
			...
			arg_4_0.imgType = arg_4_0.getImageType(var_4_1)

			local var_4_2 = arg_4_0._tf

			Vector3 = var_4_1
			var_4_2.localPosition = var_4_1(0, 0, 0)
	...
	function var_1_0.updateNoteTf(arg_5_0)
		...
		var_2_10001(var_2_10002(arg_5_0._tf, "singleNote"), false)

		setActive = var_2_10001
		findTF = var_2

		var_2_10001(var_2(arg_5_0._tf, "longNote"), false)

		if arg_5_0.longFlag then
			setActive = var_1
			findTF = var_2

			var_1(var_2(arg_5_0._tf, "longNote"), true)

			for iter_5_0 = 1, var_0_5 do
				setActive = var_2_10005
				findTF = var_2_10006

				var_2_10005(var_2_10006(arg_5_0._tf, "longNote/note/img" .. iter_5_0), iter_5_0 == arg_5_0.imgType)

				setActive = var_2_10005
				findTF = var_2_10006

				var_2_10005(var_2_10006(arg_5_0._tf, "longNote/long/img" .. iter_5_0), iter_5_0 == arg_5_0.imgType)
			end
		else
			setActive = var_1
			findTF = var_2

			var_1(var_2(arg_5_0._tf, "singleNote"), true)

			for iter_5_1 = 1, var_0_5 do
				setActive = var_2_10005
				findTF = var_2_10006

				var_2_10005(var_2_10006(arg_5_0._tf, "singleNote/note/img" .. iter_5_1), iter_5_1 == arg_5_0.imgType)
			end
		end
...
function var_0_0.step(arg_15_0, arg_15_1)
	...
	if #arg_15_0.noteList > 0 then
		...
		if arg_15_0:checkScoreType(var_15_0) then
			...
			if not var_15_0.longFlag or var_3 == var_0_6 then
				...
				var_15_2(var_15_1, var_1_10006.remove(arg_15_0.noteList, 1))
			elseif var_15_0.longFlag and var_15_0.triggerUp then
				...
				var_15_4(var_15_3, var_1_10006.remove(arg_15_0.noteList, 1))
	...
	for iter_15_0 = #arg_15_0.noteList, 1, -1 do
		if arg_15_0.noteList[iter_15_0].fixedScoreType and arg_15_0.noteStateCallback then
			...
			var_15_6(var_15_5, var_1_10010.remove(arg_15_0.noteList, iter_15_0))
		end
	end
	...
	for iter_15_1 = #arg_15_0.noteList, 1, -1 do
		...
		if var_9.getRemoveTime(var_15_9) and var_9 < arg_15_0.stepTime then
			...
			var_15_11(var_15_10, var_1_10012.remove(arg_15_0.noteList, iter_15_1))
		end
	end
...
function var_0_0.checkScoreType(arg_16_0, arg_16_1)
	...
	if not arg_16_1.longFlag then
		...
		if arg_16_0.keyDownStepTime and not arg_16_0.keyDownTrigger then
			...
			MusicGameNote = var_1_10007

			if var_16_7 == var_1_10007.type_pu_both then
				if arg_16_0.keyBothDown then
					var_1_10007 = arg_16_0
					var_16_2 = arg_16_0.getScoreType(var_1_10007, var_16_6)
				end
			else
				var_1_10007 = arg_16_0
				var_16_2 = arg_16_0.getScoreType(var_1_10007, var_16_6)
			...
			if var_16_2 then
				...
				if var_16_8 == var_1_10007.type_dgree_easy then
	...
	elseif not arg_16_1.triggerDown then
		...
		if arg_16_0.keyDownStepTime and not arg_16_0.keyDownTrigger then
			...
			if var_16_11 == var_1_10007.type_pu_both then
				if arg_16_0.keyBothDown then
		...
		if not arg_16_0.keyDown and var_16_13 then
			...
			if not var_16_15(var_16_14, var_1_10008.abs(arg_16_0.stepTime - arg_16_1.endTime)) then
				var_16_16 = var_0_7
			end
		...
		elseif arg_16_0.keyUpStepTime and not arg_16_0.keyUpTrigger then
			...
			MusicGameNote = var_1_10008

			if var_16_18 == var_1_10008.type_pu_both then
...
function var_0_0.getNote(arg_23_0, arg_23_1)
	...
	if #arg_23_0.notePool == 0 then
		...
		var_23_1 = arg_23_0.createNote(var_23_0)
		table = var_23_0

		var_23_0.insert(arg_23_0.notePool, var_23_1)
	end

	table = var_23_1

	local var_23_2 = var_23_1.remove(arg_23_0.notePool, 1)

	var_2.setNoteData(var_23_2, arg_23_1, arg_23_0.speedOffsetX, arg_23_0.dgree, arg_23_0.directType)
...
function var_0_0.createNote(arg_25_0)
	...
	local var_25_0 = var_1_10001(var_1_10002(arg_25_0.tplNote))

	setActive = var_2

	var_2(var_25_0, false)
