...
function var_0_0.initUI(arg_2_0)
	...
	for iter_2_0 = 1, 7 do
		...
		var_1_10010(var_1_10008, var_2_26)

		onButton = var_1_10010

		local var_2_27 = arg_2_0._event
		local var_2_28 = var_1_10008
		...
		local function var_2_29()
			...
			var_10_1(var_10_0, var_2_10002.ON_DROP, var_2_26)
		...
		var_1_10010(var_2_27, var_2_28, var_2_29, var_1_10014)
...
function var_0_0.Update(arg_13_0)
	...
	if not var_13_7(var_13_6, var_7.GetGameId(var_13_8)) or not (#var_5 > 0) or not var_5[1] then
		local var_13_9 = 0
	end
