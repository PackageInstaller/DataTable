	...
	if arg_1_0.x ~= 0 then
		...
		for iter_1_0 = 1, arg_1_2.horizontalRayCount do
			...
			if var_1_7 then
				...
				if var_1_10(var_1_11, var_1_10019(var_1_9).layer) then
					var_1_8 = true
				end
			...
			if not var_1_8 and var_1_6 and var_1_7.distance ~= 0 then
				...
				if not arg_1_1.climbingSlope or var_1_12 > arg_1_1.config.maxSlopeAngle then
					...
					if arg_1_1.climbingSlope then
						...
						local var_1_16 = var_1_14(var_1_15 * var_1_10019.Deg2Rad)
...
function var_0_0.ClimbSlope(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_1 = var_5.Sin

	Mathf = var_1_10006

	local var_2_2 = var_2_1(arg_2_2 * var_1_10006.Deg2Rad) * var_2_0
	...
	if arg_2_0.y <= var_2_2 then
		...
		local var_2_4 = var_2_3(arg_2_2 * var_1_10007.Deg2Rad) * var_2_0
