...
local var_0_0 = "GameRoomSnowballView"
...
function var_0_1.initUI(arg_116_0)
	...
	local function var_116_40()
		...
		local var_134_3 = arg_116_0

		var_134_2.helps = var_3.getGameRoomData(var_134_3).game_help
	...
	local function var_116_43()
		...
		var_0.openCoinLayer(var_135_0, false)

		local var_135_1 = arg_116_0

		var_0.readyStart(var_135_1)
...
function var_0_1.showSettlement(arg_177_0)
	...
	local var_177_2 = arg_177_0.scoreNum

	getProxy = var_177_1
	GameRoomProxy = var_4

	local var_177_3 = var_177_1(var_4)
	local var_177_4

	if var_3.getRoomScore(var_177_3, arg_177_0:getGameRoomData().id) <= var_177_2 then
		var_177_4 = var_177_2
	...
	local var_177_5 = var_177_3(arg_177_0.settlementUI, "ad/highText")

	findTF = var_5

	local var_177_6 = var_5(arg_177_0.settlementUI, "ad/currentText")

	setText = var_6

	var_6(var_177_5, var_177_4)

	setText = var_6

	var_6(var_177_6, var_177_2)

	arg_177_0.sendSuccessFlag = true

	arg_177_0:SendSuccess(var_177_2 or 0)
