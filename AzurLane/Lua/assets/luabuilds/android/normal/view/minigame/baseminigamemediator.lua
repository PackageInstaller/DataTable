...
function var_0_1.register(arg_1_0)
	...
	arg_1_0.miniGameProxy = var_1(var_1_10002)
	...
	var_1_9(var_1_8, var_5.MINI_GAME_SUCCESS, function(arg_2_0, ...)
		table = var_2_10001

		local var_2_0 = var_2_10001.contains

		getGameset = var_2_10002

		if var_2_0(var_2_10002("live_streaming26_data1")[2], arg_1_0.miniGameId) then
			pg = var_1
			...
			var_2_2(var_2_1, var_3.BuildFushunAdventure())
		end
	...
	var_1_11(var_1_10, var_5.MINI_GAME_FAILURE, function(arg_3_0, ...)
		table = var_2_10001
		...
		if var_3_0(var_2_10002("live_streaming26_data1")[2], arg_1_0.miniGameId) then
			pg = var_1
			...
			var_3_2(var_3_1, var_3.BuildFushunAdventure())
		end
	...
	var_1_13(var_1_12, var_5.MINI_GAME_OPERATOR, function(arg_4_0, ...)
	...
	var_1_15(var_1_14, var_5.OPEN_SUB_LAYER, function(arg_5_0, arg_5_1)
		Context = var_2_10002
	...
	var_1_17(var_1_16, var_5.MINI_GAME_COIN, function(arg_6_0, ...)
	...
	var_1_19(var_1_18, var_5.COIN_WINDOW_CHANGE, function(arg_7_0, arg_7_1)
		local var_7_0 = arg_1_0
		local var_7_1 = var_2.sendNotification

		GameRoomCoinMediator = var_2_10004

		var_7_1(var_7_0, var_2_10004.CHANGE_VISIBLE, arg_7_1)
	...
	var_1_21(var_1_20, var_5.GAME_FINISH_TRACKING, function(arg_8_0, arg_8_1)
		local var_8_0 = arg_1_0
		local var_8_1 = var_2.sendNotification

		GAME = var_2_10004

		local var_8_2 = var_2_10004.SEND_MINI_GAME_OP
		local var_8_3 = {
			hubid = arg_8_1.hub_id
		}

		MiniGameOPCommand = var_6
		var_8_3.cmd = var_6.CMD_PLAY
		var_8_3.args1 = {
			arg_8_1.game_id,
			arg_8_1.isComplete
		}
...
function var_0_1.loadCoinLayer(arg_10_0)
	...
	local var_10_3 = var_1_10003.New
	local var_10_4 = {}

	GameRoomCoinMediator = var_1_10005
	var_10_4.mediator = var_1_10005
	GameRoomCoinLayer = var_1_10005
	var_10_4.viewComponent = var_1_10005
...
function var_0_1.handleNotification(arg_15_0, arg_15_1)
	...
	MiniGameProxy = var_15_1

	if var_15_0 == var_15_1.ON_HUB_DATA_UPDATE then
		var_1_10005 = arg_15_0.viewComponent

		var_4.SetMGHubData(var_1_10005, var_15_2)
	else
		GAME = var_4

		local var_15_3

		if var_15_0 == var_4.SEND_MINI_GAME_OP_DONE then
			var_15_3 = {
				function(arg_16_0)
					if #var_15_2.awards > 0 then
						...
						var_16_1(var_16_0, var_2_10004.ON_ACHIEVE, var_1, arg_16_0)
					else
						arg_16_0()
					end
			...
			var_1_10005(var_15_3)

			var_1_10006 = arg_15_0.viewComponent

			var_1_10005.OnSendMiniGameOPDone(var_1_10006, var_15_2)
		else
			GAME = var_15_3

			if var_15_0 == var_15_3.MODIFY_MINI_GAME_DATA_DONE then
				var_1_10005 = arg_15_0.viewComponent

				var_4.OnModifyMiniGameDataDone(var_1_10005, var_15_2)
			else
				GAME = var_4

				if var_15_0 == var_4.ON_APPLICATION_PAUSE then
					var_1_10005 = arg_15_0.viewComponent

					var_4.OnApplicationPaused(var_1_10005, var_15_2)
				else
					GAME = var_4

					if var_15_0 == var_4.GAME_COIN_COUNT_CHANGE then
						...
						if var_15_0 == var_4.GAME_ROOM_AWARD_DONE then
							var_15_4 = #var_15_2
							...
							if 0 < var_15_4 then
								...
								var_15_4(var_1_10005, var_1_10006.ON_ACHIEVE, var_15_2)

								var_1_10005 = arg_15_0.viewComponent

								var_15_4.OnGetAwardDone(var_1_10005, var_15_2)
							end
						else
							ActivityProxy = var_15_4

							if var_15_0 == var_15_4.ACTIVITY_SHOW_AWARDS then
								getProxy = var_4
								ContextProxy = var_1_10005

								local var_15_5 = var_4(var_1_10005)
								local var_15_6 = var_4.getContextByMediator

								ActivityMediator = var_1_10006

								if var_15_6(var_15_5, var_1_10006) then
									return
								end
								...
								var_15_8(var_15_7, var_1_10007.ON_ACHIEVE, var_15_2.awards, var_15_2.callback)
							end
						end
					end
				end
