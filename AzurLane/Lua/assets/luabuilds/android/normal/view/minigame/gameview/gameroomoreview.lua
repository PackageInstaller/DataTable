...
function var_0_1.initOpenUISwich(arg_7_0)
	arg_7_0.openSwitchDic = {
		...
		result = function()
			...
			local var_11_4 = var_2(var_2_10003)
			local var_11_5 = var_2.getRoomScore
			local var_11_6 = arg_7_0
			local var_11_7 = var_11_5(var_11_4, var_4.getGameRoomData(var_11_6).id)
			local var_11_8 = arg_7_0.rtTitlePage
			local var_11_9 = var_3.Find(var_11_8, "result")

			setActive = var_11_8

			var_11_8(var_11_9:Find("window/now/new"), var_11_7 < var_11_3)
...
function var_0_1.openUI(arg_12_0, arg_12_1)
	...
	if arg_12_0.status then
		...
		var_2(var_3.Find(var_12_0, arg_12_0.status), false)
	end
	...
	if arg_12_1 then
		...
		var_2(var_3.Find(var_12_1, arg_12_1), true)
	end
