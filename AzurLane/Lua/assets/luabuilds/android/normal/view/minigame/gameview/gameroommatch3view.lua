...
local var_0_0 = "GameRoomMatch3View"
...
function var_0_1.didEnter(arg_5_0)
	...
	var_1_10001(arg_5_0, arg_5_0.startBtn, function()
		...
		if var_0_8 then
			...
			var_0.startGame(var_7_1)
		else
			local var_7_2 = arg_5_0.mainPage

			var_0.GetComponent(var_7_2, "CanvasGroup").blocksRaycasts = false

			local var_7_3 = arg_5_0
			local var_7_4 = var_0.managedTween

			LeanTween = var_2

			local var_7_5 = var_2.value
			...
			local var_7_7 = var_7_4(var_7_3, var_7_5, var_7_6, var_2_10004(arg_5_0.mainPage), 1, 0, var_0_21)
			local var_7_8 = var_0.setOnUpdate

			System = var_7_5

			var_7_8(var_7_7, var_7_5.Action_float(function(arg_9_0)
	...
	local function var_5_5()
		...
		var_10_2.helps = arg_5_0.gameHelpTip
	...
	local var_5_8 = var_5_7(var_5_6, var_5_4(var_5_5))
	...
	var_2(arg_5_0, arg_5_0.endBtn, function()
		...
		local var_12_5 = var_12_2(var_12_1, var_12_3, var_12_4, var_2_10004(arg_5_0.endPage), 0, 1, var_0_21)
		...
		local var_12_7 = arg_5_0

		var_0.openCoinLayer(var_12_7, true)
	...
	var_3.AddPointClickFunc(var_5_10, function(arg_17_0, arg_17_1)
		...
		local var_17_3 = var_2_10005.Find("UICamera")
		local var_17_4 = var_5.GetComponent

		typeof = var_2_10007
		Camera = var_2_10008

		local var_17_5 = var_17_0(var_17_1, var_17_2, var_17_4(var_17_3, var_2_10007(var_2_10008)))
	...
	var_3.AddListener(var_5_11, function()
		...
		local var_18_2 = var_2_10002.mousePosition

		GameObject = var_2_10003

		local var_18_3 = var_2_10003.Find("UICamera")
		local var_18_4 = var_3.GetComponent

		typeof = var_2_10005
		Camera = var_2_10006

		local var_18_5 = var_18_0(var_18_1, var_18_2, var_18_4(var_18_3, var_2_10005(var_2_10006)))
	...
	var_3.AddBeginDragFunc(var_5_12, function(arg_19_0, arg_19_1)
		...
		local var_19_4 = var_2_10006.Find("UICamera")
		local var_19_5 = var_6.GetComponent

		typeof = var_2_10008
		Camera = var_2_10009

		local var_19_6 = var_19_1(var_19_2, var_19_3, var_19_5(var_19_4, var_2_10008(var_2_10009)))
...
function var_0_1.updateData(arg_20_0)
	...
	local var_20_1 = var_2.GetRuntimeData(var_20_0, "elements")

	getProxy = var_20_0
	GameRoomProxy = var_4

	local var_20_2 = var_20_0(var_4)

	arg_20_0.best = var_3.getRoomScore(var_20_2, arg_20_0:getGameRoomData().id)
...
function var_0_1.pos2index(arg_22_0, arg_22_1)
	...
	local var_22_3 = var_5.ceil((arg_22_1.x - var_22_0) / var_0_6)
end
...
function var_0_1.tryMoveTo(arg_28_0, arg_28_1)
	...
	if arg_28_0:moveValid(arg_28_0.selectedIndex, arg_28_1) then
		...
		var_28_4(var_28_3, var_5.delayedCall, function()
		...
		local var_28_11 = var_28_10(var_28_9, var_8.move, nil, var_28_5, var_28_8, var_0_14)
		...
		local var_28_14 = var_28_13(var_28_12, var_8.move, nil, var_28_6, var_28_7, var_0_14)
		...
		var_28_16(var_28_15, var_8.delayedCall, function()
...
function var_0_1.moveTile(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	local var_33_3 = var_33_2(var_33_1, var_7.move, nil, arg_33_1, var_33_0, arg_33_3 or 0)
	local var_33_4 = var_5.setEase

	LeanTweenType = var_7

	var_33_4(var_33_3, var_7.easeInQuad)
...
function var_0_1.startGame(arg_37_0)
	...
	local var_37_0 = var_1.New(function()
		...
		local var_38_4 = var_38_1(var_38_0, var_38_2, var_38_3, var_2_10004(arg_37_0.gamePage), 1, 0, var_0_11)
	...
	UpdateBeat = var_2
	arg_37_0.handle = var_2:CreateListener(function()
		setText = var_2_10000
		...
		var_2_10000(var_41_0, var_2_10002.floor(var_37_0.time))

		if var_37_0.time <= var_0_18 then
			isActive = var_0
	...
	function arg_37_0.hintFunc()
		...
		local var_42_9 = var_5.New
		local var_42_10 = 0
		local var_42_11 = 0

		dir2Angle = var_2_10008
		var_42_8.localEulerAngles = var_42_9(var_42_10, var_42_11, var_2_10008(var_42_3))
	...
	local var_37_1 = arg_37_0.hintTimer

	var_2.Start(var_37_1)
	...
	for iter_48_0 = 1, var_0_3 do
		...
		for iter_48_2 = 1, var_0_2 do
			if not arg_48_0.tileTfs[iter_48_2][iter_48_0] then
				...
				local var_48_2 = var_12(var_1_10013(arg_48_0.tiles[arg_48_0.tileIndicies[iter_48_2][iter_48_0]], arg_48_0.tilesRoot))
				...
				var_1_10013 = arg_48_0.tileTfs[iter_48_2]
				var_1_10013[iter_48_0] = var_48_2
			end
		end
	end
...
function var_0_1.stopGame(arg_50_0)
	...
	var_1(var_50_3, var_3.max(arg_50_0.best, arg_50_0.score))
	...
	local function var_50_8()
		...
		local function var_51_6()
			...
			var_0.SendSuccess(var_52_1, arg_50_0.score)
		...
		local var_51_7 = var_51_4(var_51_3, var_51_5, var_51_6, var_2_10004(arg_50_0.endBtn), 0, 1, var_0_20)
	...
	local var_50_9 = var_5(arg_50_0.endScore)
	local var_50_10 = 0
	...
	var_50_14(var_50_13, var_50_7.Action_float(function(arg_54_0)
		...
		var_2_10001(var_54_0, var_2_10003.floor(arg_54_0))
...
function var_0_1.formatScore(arg_55_0, arg_55_1, arg_55_2)
	...
	while 0 < arg_55_2 do
		...
		var_55_1(var_55_2, var_1_10006.fmod(arg_55_2, 10))
...
function var_0_1.update(arg_56_0)
	...
	if var_56_2(var_56_3) ~= nil then
		...
		for iter_56_0, iter_56_1 in var_56_4(var_56_3) do
			if #iter_56_1 == 3 then
			...
			var_10.each(iter_56_1, function(arg_57_0)
				...
				if arg_56_0.tileTfs[arg_57_0[1]][arg_57_0[2]] then
					...
					local var_57_5 = var_2_10006.value
					...
					local var_57_7 = var_57_4(var_57_3, var_57_5, var_57_6, var_2_10008(var_57_0), 1, 0, var_0_11)
					...
					var_57_8(var_57_7, var_57_5.Action_float(function(arg_59_0)
						...
						var_3_10001(var_59_0, var_3.one * arg_59_0 * 2.7)
			...
			local var_56_7 = var_10(var_11(arg_56_0.floatText, arg_56_0.tilesRoot))

			var_56_7.anchoredPosition = var_56_6

			arg_56_0:formatScore(var_56_7, var_56_5)
			...
			var_56_9(var_56_8, var_13.moveY, function()
				Destroy = var_2_10000

				var_2_10000(var_56_7)

				return
			end, var_56_7, var_56_6.y + var_0_13, var_0_12)
		end

		local var_56_10 = arg_56_0
		local var_56_11 = arg_56_0.managedTween

		LeanTween = var_6

		var_56_11(var_56_10, var_6.delayedCall, function()
			...
			if arg_56_0.combo > 1 then
				...
				if var_61_7(var_61_6) == nil then
					...
					var_61_13(var_61_12, var_2_10006.delayedCall, function()
						Destroy = var_3_10000
			...
			local var_61_16 = var_61_14(var_3.fillTiles(var_61_15), var_61_0)
			local var_61_17 = arg_56_0
			local var_61_18 = var_2.managedTween

			LeanTween = var_4

			local var_61_19 = var_4.delayedCall
			...
			var_61_18(var_61_17, var_61_19, var_61_20, var_2_10006.max(var_0_15, arg_56_0.dropTime(var_61_16)), nil)
	...
	if arg_56_0.inGame then
		...
		var_3.Reset(var_56_12, arg_56_0.hintFunc, var_0_22)

		local var_56_13 = arg_56_0.hintTimer

		var_3.Start(var_56_13)
	end
		...
		for iter_65_1 = 1, var_0_3 do
			if not arg_65_1[iter_65_0][iter_65_1] then
				if not arg_65_0:isConnected({
					...
					if var_1_10014(var_65_1) ~= nil then
						repeat
							unpack = var_1_10014
							table = var_65_4
							...
							var_1_10014, var_65_4 = var_1_10014(var_65_4.remove(var_65_1))

							local var_65_5 = arg_65_1[var_1_10014]

							var_65_5[var_65_4] = true
							pairs = var_65_5

							for iter_65_2, iter_65_3 in var_65_5(var_0_30) do
								local var_65_6 = var_1_10014 + iter_65_3[1]
								local var_65_7 = var_65_4 + iter_65_3[2]
					...
					if #var_65_2 >= 3 then
						...
						var_1_10014.insert(var_65_0, var_65_2)
					end
				end
			end
		end
