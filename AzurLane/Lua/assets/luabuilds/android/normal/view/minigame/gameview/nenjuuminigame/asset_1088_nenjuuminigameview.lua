...
function var_0_1.openUI(arg_2_0, arg_2_1)
	if arg_2_0.status then
		...
		var_2(var_3.Find(var_2_0, arg_2_0.status), false)
	end
	...
	if arg_2_1 then
		...
		var_2(var_3.Find(var_2_1, arg_2_1), true)
	end
	...
	var_2(arg_2_1, {
		...
		result = function()
			...
			local var_6_2 = var_1.GetMGData(var_6_1)
			local var_6_3

			if not var_1.GetRuntimeData(var_6_2, "elements") then
				var_6_3 = {}
			end
			...
			var_6_7(var_6_8:Find("window/now/new"), var_6_6 < var_6_5)
...
function var_0_1.updateMainUI(arg_7_0)
	...
	local var_7_3 = var_1_10005.min(var_1.usedtime + 1, var_7_2)
	...
	for iter_7_0 = 1, var_7_4 do
		...
		local var_7_6 = var_6
		local var_7_7 = var_6.GetChild(var_7_6, iter_7_0 - 1)

		setActive = var_7_6

		var_7_6(var_7_7:Find("finish"), var_7_5.finish)

		setActive = var_7_6

		var_7_6(var_7_7:Find("lock"), var_7_5.lock)

		setToggleEnabled = var_7_6

		var_7_6(var_7_7, iter_7_0 <= var_7_3)

		triggerToggle = var_7_6
...
function var_0_1.checkGet(arg_8_0)
	if arg_8_0:GetMGHubData().ultimate == 0 then
		...
		var_8_5.cmd = var_6.CMD_ULTIMATE
		var_8_5.args1 = {}
...
function var_0_1.initPageUI(arg_9_0)
	...
	local var_9_4 = var_9_2:Find("btn_back")
	...
	var_9_1(var_9_3, var_9_4, var_9_5, var_6)

	onButton = var_9_1

	local var_9_6 = arg_9_0
	local var_9_7 = var_9_2:Find("btn_home")
	...
	var_9_1(var_9_6, var_9_7, var_9_8, var_6)

	onButton = var_9_1

	local var_9_9 = arg_9_0
	local var_9_10 = var_9_2:Find("btn_help")
	...
	local function var_9_11()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip["2023spring_minigame_help"].tip
	...
	var_9_1(var_9_9, var_9_10, var_9_11, var_6)

	onButton = var_9_1

	local var_9_12 = arg_9_0
	local var_9_13 = var_9_2:Find("btn_opreation")
	...
	local function var_9_14()
		...
		var_2_10000(var_1.Find(var_13_0, "Opreation"), true)
	...
	var_9_1(var_9_12, var_9_13, var_9_14, var_6)

	local var_9_15 = arg_9_0:GetMGData()
	local var_9_16 = var_2.GetSimpleValue(var_9_15, "story")

	onButton = var_9_15

	local var_9_17 = arg_9_0
	local var_9_18 = var_9_2:Find("btn_start")
	...
	var_9_15(var_9_17, var_9_18, var_9_19, var_7)

	arg_9_0.stageIndex = 0
	pg = var_3

	local var_9_20 = var_3.mini_game[arg_9_0:GetMGData().id].simple_config_data.drop
	local var_9_21 = var_9_2
	local var_9_22 = var_9_2.Find(var_9_21, "side_panel/award/content")

	UIItemList = var_9_21
	arg_9_0.itemList = var_9_21.New(var_9_22, var_9_22:GetChild(0))

	local var_9_23 = arg_9_0.itemList

	var_5.make(var_9_23, function(arg_17_0, arg_17_1, arg_17_2)
		arg_17_1 = arg_17_1 + 1
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			local var_17_2, var_17_3, var_17_4 = var_5(var_9_20[arg_17_1])

			var_17_1.count = var_17_4
			var_17_1.id = var_17_3
			var_17_1.type = var_17_2
			updateDrop = var_17_2
			...
			var_17_2(var_17_5, var_17_6, var_17_7, var_2_10009)

			onToggle = var_17_2

			var_17_2(arg_9_0, arg_17_2, function(arg_19_0)
				if arg_19_0 then
	...
	local var_9_24 = arg_9_0.itemList

	var_5.align(var_9_24, #var_9_20)

	local var_9_25 = arg_9_0.rtTitlePage
	local var_9_26 = var_5.Find(var_9_25, "countdown")
	local var_9_27 = var_5.Find(var_9_26, "bg/Image")
	local var_9_28 = var_6.GetComponent

	typeof = var_8
	DftAniEvent = var_9

	local var_9_29 = var_9_28(var_9_27, var_8(var_9))

	var_6.SetEndEvent(var_9_29, function()
	...
	local var_9_30 = arg_9_0.rtTitlePage
	local var_9_31 = var_6.Find(var_9_30, "pause")

	onButton = var_9_30

	local var_9_32 = arg_9_0
	local var_9_33 = var_9_31:Find("window/btn_confirm")
	...
	var_9_30(var_9_32, var_9_33, var_9_34, var_11)

	local var_9_35 = arg_9_0.rtTitlePage
	local var_9_36 = var_7.Find(var_9_35, "exit")

	onButton = var_9_35

	local var_9_37 = arg_9_0
	local var_9_38 = var_9_36:Find("window/btn_cancel")
	...
	var_9_35(var_9_37, var_9_38, var_9_39, var_12)

	onButton = var_9_35

	local var_9_40 = arg_9_0
	local var_9_41 = var_9_36:Find("window/btn_confirm")
	...
	var_9_35(var_9_40, var_9_41, var_9_42, var_12)

	local var_9_43 = arg_9_0.rtTitlePage
	local var_9_44 = var_8.Find(var_9_43, "result")

	onButton = var_9_43

	local var_9_45 = arg_9_0
	local var_9_46 = var_9_44:Find("window/btn_finish")
	...
	var_9_43(var_9_45, var_9_46, var_9_47, var_13)
...
function var_0_1.initLeveUI(arg_25_0)
	...
	local var_25_4 = var_25_2:Find("btn_back")
	...
	var_25_1(var_25_3, var_25_4, var_25_5, var_6)
...
function var_0_1.UpdateOpreationPage(arg_27_0, arg_27_1)
	...
	NenjuuGameConfig = var_27_0

	local var_27_2 = var_27_0.ParsingElements
	local var_27_3 = arg_27_0:GetMGData()
	local var_27_4

	if not var_4.GetRuntimeData(var_27_3, "elements") then
		var_27_4 = {}
	end
	...
	var_27_4(var_27_1:Find("point/Text"), var_27_5.count)
	...
	local var_27_7
	local var_27_8 = var_27_1
	local var_27_9 = var_27_1.Find(var_27_8, "main/view/content")

	UIItemList = var_27_8

	local var_27_10 = var_27_8.New(var_27_9, var_27_9:Find("tpl"))

	var_7.make(var_27_10, function(arg_28_0, arg_28_1, arg_28_2)
		arg_28_1 = arg_28_1 + 1
		UIItemList = var_2_10003
		...
		if arg_28_0 == var_2_10003.EventUpdate then
			...
			if var_28_0 then
				...
				var_28_1(var_28_2:Find("icon"), function(arg_29_0)
				...
				local var_28_3 = var_28_1.split

				i18n = var_6

				local var_28_4 = var_28_3(var_6(var_0_2[var_28_0][1]), "|")

				setText = var_6

				var_6(var_28_2:Find("name/Text"), var_28_4[1])

				setText = var_6

				var_6(var_28_2:Find("desc"), var_28_4[2])

				setActive = var_6

				var_6(var_28_2:Find("level"), var_0_2[var_28_0][2])
				...
				if var_0_2[var_28_0][2] then
					...
					i18n = var_7
					var_28_5 = var_28_5(var_7(var_0_2[var_28_0][2]), "|")

					for iter_28_0 = 1, 3 do
						local var_28_6 = var_28_2
						local var_28_7 = var_28_2.Find(var_28_6, "level/" .. iter_28_0)

						setActive = var_28_6

						var_28_6(var_28_7, var_28_5[iter_28_0])

						if var_28_5[iter_28_0] then
							setTextColor = var_12

							local var_28_8 = var_28_7
							local var_28_9 = var_28_7.Find(var_28_8, "Text")

							Color = var_28_8

							var_12(var_28_9, var_28_8.NewHex(iter_28_0 > var_27_5.level[var_28_0] and "8D90AFFF" or "535885FF"))

							changeToScrollText = var_12

							local var_28_10 = var_28_7
							local var_28_11 = var_28_7.Find(var_28_10, "info")

							setColorStr = var_28_10

							var_12(var_28_11, var_28_10(var_28_5[iter_28_0], iter_28_0 > var_27_5.level[var_28_0] and "#8D90AFFF" or "#535885FF"))
						end
					end
				end
				...
				local var_28_12 = arg_27_0
				local var_28_13 = var_28_2:Find("status/btn_equip")
				...
				var_28_5(var_28_12, var_28_13, var_28_14, var_10)

				onButton = var_28_5

				local var_28_15 = arg_27_0
				local var_28_16 = var_28_2:Find("status/btn_unlock")
				...
				local function var_28_17()
					...
					if var_27_5.level[var_28_0] > 1 then
						...
						var_32_3(var_32_2, var_2("2023spring_minigame_tip7", var_28_4[1]))
					else
						pg = var_32_3
						...
						var_32_5(var_32_4, var_2("2023spring_minigame_tip6", var_28_4[1]))
					end
				...
				var_28_5(var_28_15, var_28_16, var_28_17, var_10)

				local var_28_18 = var_27_5.level[var_28_0]

				NenjuuGameConfig = var_28_15

				if var_28_18 < #var_28_15.SKILL_LEVEL_CONFIG[var_28_0].cost then
					NenjuuGameConfig = var_28_18
					var_28_18 = var_28_18.SKILL_LEVEL_CONFIG[var_28_0].cost[var_27_5.level[var_28_0] + 1]

					if var_27_5.count < var_28_18 then
						setText = var_7

						var_7(var_28_2:Find("status/btn_lock/point"), var_28_18)

						setText = var_7

						local var_28_19 = var_28_2
						local var_28_20 = var_28_2.Find(var_28_19, "status/btn_lock/Text")

						i18n = var_28_19

						var_7(var_28_20, var_28_19("2023spring_minigame_tip3"))
						...
						var_7(var_28_2:Find("status/btn_unlock/point"), var_28_18)

						setText = var_7

						local var_28_21 = var_28_2
						local var_28_22 = var_28_2.Find(var_28_21, "status/btn_unlock/Text")

						i18n = var_28_21

						var_7(var_28_22, var_28_21("2023spring_minigame_tip3"))
				...
				elseif var_28_0 == "bomb" or var_28_0 == "lantern" then
					...
					local var_28_23 = var_28_2
					local var_28_24 = var_28_2.Find(var_28_23, "status/btn_equip/Text")

					i18n = var_28_23

					var_28_18(var_28_24, var_28_23("2023spring_minigame_tip1"))

					setActive = var_28_18

					var_28_18(var_28_2:Find("status/btn_equip"), var_27_5.item ~= var_28_0)

					setText = var_28_18

					local var_28_25 = var_28_2
					local var_28_26 = var_28_2.Find(var_28_25, "status/btn_in/Text")

					i18n = var_28_25

					var_28_18(var_28_26, var_28_25("2023spring_minigame_tip2"))

					setActive = var_28_18

					var_28_18(var_28_2:Find("status/btn_in"), var_27_5.item == var_28_0)
				else
					setActive = var_28_18

					var_28_18(var_28_2:Find("status/unlock"), true)
				end
			end
		end
	...
	for iter_27_0, iter_27_1 in var_8(var_27_6) do
		onToggle = var_1_10013

		local var_27_11 = arg_27_0
		local var_27_12 = var_27_1:Find("toggles/" .. iter_27_0)
		...
		local function var_27_13(arg_33_0)
			...
			var_1(var_2.Find(var_33_1, "main/tip"), iter_27_0 == 1)
		...
		var_1_10013(var_27_11, var_27_12, var_27_13, var_17)
	end
...
local function var_0_3(arg_34_0, arg_34_1, arg_34_2)
	...
	for iter_34_0, iter_34_1 in var_1_10003(var_1_10004.ABILITY_LIST) do
...
function var_0_1.openReadyPage(arg_35_0)
	...
	if not var_2.GetRuntimeData(var_35_1, "elements") then
		var_35_2 = {}
	end

	local var_35_3 = var_35_0(var_35_2)

	NenjuuGameConfig = var_35_2

	local var_35_4 = var_35_2.GetStageConfig("Spring23Level_" .. arg_35_0.stageIndex)
	local var_35_5

	if not arg_35_0.abilityCache[arg_35_0.stageIndex] then
		var_35_5 = arg_35_0.abilityCache

		local var_35_6 = arg_35_0.stageIndex

		setmetatable = var_1_10005
		var_35_5[var_35_6] = var_1_10005({}, {
	...
	var_35_5(var_4.Find(var_35_7, "Ready"), true)

	onButton = var_35_5

	local var_35_8 = arg_35_0
	local var_35_9 = arg_35_0.rtLevel
	local var_35_10 = var_5.Find(var_35_9, "Ready/bg")
	...
	local function var_35_11()
		...
		var_2_10000(var_1.Find(var_36_0, "Ready"), false)
	...
	var_35_5(var_35_8, var_35_10, var_35_11, var_7)
	...
	var_35_12(var_35_13:Find("title"), function(arg_37_0)
		...
		var_2_10001(var_37_0, var_37_1 == var_2_10004(arg_35_0.stageIndex))
	...
	var_35_12(var_35_13:Find("rate/Image/Text"), var_0_3(arg_35_0.abilityCache[arg_35_0.stageIndex], var_35_4.base_rate, var_35_4.ability_rate))

	setText = var_35_12

	var_35_12(var_35_13:Find("high/Image/Text"), var_35_3["stage_" .. arg_35_0.stageIndex])

	setText = var_35_12

	local var_35_14 = var_35_13
	local var_35_15 = var_35_13.Find(var_35_14, "ability_text/Text")

	i18n = var_35_14

	var_35_12(var_35_15, var_35_14("2023spring_minigame_tip5"))

	underscore = var_35_12

	local var_35_16 = var_35_12.filter

	NenjuuGameConfig = var_35_15

	local var_35_17 = var_35_16(var_35_15.ABILITY_LIST, function(arg_38_0)
		return arg_35_0.abilityCache[arg_35_0.stageIndex][arg_38_0]
	end)

	UIItemList = var_5

	local var_35_18 = var_5.New(var_35_13:Find("abilitys"), var_35_13:Find("abilitys/tpl"))

	var_5.make(var_35_18, function(arg_39_0, arg_39_1, arg_39_2)
		arg_39_1 = arg_39_1 + 1
		UIItemList = var_2_10003
		...
		if arg_39_0 == var_2_10003.EventUpdate then
			...
			var_3(arg_39_2:Find("empty"), not var_35_17[arg_39_1])

			setActive = var_3

			var_3(arg_39_2:Find("enable"), var_35_17[arg_39_1])

			if var_35_17[arg_39_1] then
				eachChild = var_3

				var_3(arg_39_2:Find("enable"), function(arg_40_0)
					setActive = var_3_10001

					var_3_10001(arg_40_0, arg_40_0.name == var_35_17[arg_39_1])
	...
	local var_35_19 = var_5
	local var_35_20 = var_5.align

	NenjuuGameConfig = var_8

	var_35_20(var_35_19, #var_8.ABILITY_LIST)

	onButton = var_35_20

	local var_35_21 = arg_35_0
	local var_35_22 = var_35_13:Find("btn_rate")
	...
	local function var_35_23()
		...
		var_2_10000(var_1.Find(var_41_0, "Ready"), false)
	...
	var_35_20(var_35_21, var_35_22, var_35_23, var_10)

	onButton = var_35_20

	local var_35_24 = arg_35_0
	local var_35_25 = var_35_13:Find("btn_continue")

	local function var_35_26()
		setActive = var_2_10000

		local var_42_0 = arg_35_0.rtLevel

		var_2_10000(var_1.Find(var_42_0, "Ready"), false)
		...
		local var_42_5 = var_3.ParsingElements
		local var_42_6 = arg_35_0
		local var_42_7 = var_4.GetMGData(var_42_6)
		local var_42_8

		if not var_4.GetRuntimeData(var_42_7, "elements") then
			var_42_8 = {}
		end
	...
	var_35_20(var_35_24, var_35_25, var_35_26, var_10)
...
function var_0_1.openRatePage(arg_43_0)
	...
	if not var_2.GetRuntimeData(var_43_1, "elements") then
		var_43_2 = {}
	end

	local var_43_3 = var_43_0(var_43_2)

	NenjuuGameConfig = var_43_2

	local var_43_4 = var_43_2.GetStageConfig("Spring23Level_" .. arg_43_0.stageIndex)
	local var_43_5
	...
	var_43_5(var_4.Find(var_43_7, "Rate"), true)

	onButton = var_43_5

	local var_43_8 = arg_43_0
	local var_43_9 = arg_43_0.rtLevel
	local var_43_10 = var_5.Find(var_43_9, "Rate/bg")
	...
	local function var_43_11()
		...
		var_2_10000(var_1.Find(var_44_0, "Rate"), false)
	...
	var_43_5(var_43_8, var_43_10, var_43_11, var_7)
	...
	var_5(var_43_13:Find("info/rate/Text"), var_43_14)

	underscore = var_5

	local var_43_15 = var_5.filter

	NenjuuGameConfig = var_6

	local var_43_16 = var_43_15(var_6.ABILITY_LIST, function(arg_45_0)
		return arg_43_0.abilityCache[arg_43_0.stageIndex][arg_45_0] ~= nil
	end)
	local var_43_17 = var_43_13
	local var_43_18 = var_43_13.Find(var_43_17, "view/content")

	UIItemList = var_43_17

	local var_43_19 = var_43_17.New(var_43_18, var_43_18:Find("tpl"))

	var_7.make(var_43_19, function(arg_46_0, arg_46_1, arg_46_2)
		arg_46_1 = arg_46_1 + 1
		UIItemList = var_2_10003
		...
		if arg_46_0 == var_2_10003.EventUpdate then
			...
			if var_46_0 then
				...
				var_46_1(var_46_2:Find("icon"), function(arg_47_0)
					setActive = var_3_10001
				...
				local var_46_5 = var_8.indexof

				NenjuuGameConfig = var_2_10009

				local var_46_6 = var_46_3(var_6(var_46_4 .. var_46_5(var_2_10009.ABILITY_LIST, var_46_0)), "|")

				setText = var_6

				var_6(var_46_2:Find("name/Text"), var_46_6[1])

				setText = var_6

				var_6(var_46_2:Find("desc"), var_46_6[2])

				onToggle = var_6

				var_6(arg_43_0, var_46_2:Find("toggle"), function(arg_48_0)
					...
					var_2(var_3.Find(var_48_1, "info/delta"), (var_48_0 < 0 and "" or "+") .. var_48_0)
				...
				var_6(var_46_2:Find("toggle"), arg_43_0.abilityCache[arg_43_0.stageIndex][var_46_0])
			end
		end
	...
	local var_43_20 = var_7
	local var_43_21 = var_7.align

	math = var_10

	local var_43_22 = var_10.min
	local var_43_23 = #var_43_16 + 1

	NenjuuGameConfig = var_1_10012

	var_43_21(var_43_20, var_43_22(var_43_23, #var_1_10012.ABILITY_LIST))
...
function var_0_1.initControllerUI(arg_49_0)
	...
	local var_49_3 = var_49_1:Find("btn_back")
	...
	var_49_0(var_49_2, var_49_3, var_49_4, var_6)

	onButton = var_49_0

	var_49_0(arg_49_0, var_49_1:Find("btn_pause"), function()
...
function var_0_1.SaveDataChange(arg_52_0, arg_52_1)
	...
	if arg_52_1.item then
		...
		local var_52_3 = var_5.indexof

		NenjuuGameConfig = var_1_10006

		local var_52_4

		if not var_52_3(var_1_10006.ITEM_LIST, arg_52_1.item) then
			var_52_4 = 0
		end
...
function var_0_1.onBackPressed(arg_54_0)
	...
	var_1_10001(arg_54_0.status, {
		main = function()
			...
			if var_2_10000(var_1.Find(var_55_0, "Opreation")) then
				triggerButton = var_0

				local var_55_1 = arg_54_0.rtLevel

				var_0(var_1.Find(var_55_1, "Opreation/btn_back"))
			...
			if var_0(var_1.Find(var_55_2, "Ready")) then
				triggerButton = var_0

				local var_55_3 = arg_54_0.rtLevel

				var_0(var_1.Find(var_55_3, "Ready/bg"))
			...
			if var_0(var_1.Find(var_55_4, "Rate")) then
				triggerButton = var_0

				local var_55_5 = arg_54_0.rtLevel

				var_0(var_1.Find(var_55_5, "Rate/bg"))
