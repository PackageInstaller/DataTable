...
function var_0_1.OnGetAwardDone(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_1_10003.CMD_COMPLETE then
		...
		local var_8_3 = var_2
		local var_8_4 = var_2.getConfig(var_8_3, "reward_need")

		if var_8_1 == 0 and var_8_4 <= var_8_2 then
			pg = var_8_3

			local var_8_5 = var_8_3.m02
			local var_8_6 = var_6.sendNotification

			GAME = var_1_10008

			local var_8_7 = var_1_10008.SEND_MINI_GAME_OP
			local var_8_8 = {
				hubid = var_2.id
			}

			MiniGameOPCommand = var_10
			var_8_8.cmd = var_10.CMD_ULTIMATE
			var_8_8.args1 = {}
