...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	tf = var_5
	instantiate = var_6
	arg_1_0.playerChar = var_1_0(var_5(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	...
	tf = var_1_1
	instantiate = var_6
	arg_1_0.partnerChar = var_1_2(var_1_1(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	...
	tf = var_1_3
	instantiate = var_6
	arg_1_0.partnerPet = var_1_4(var_1_3(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	...
	tf = var_1_5
	instantiate = var_6
	arg_1_0.enemy1Char = var_1_6(var_1_5(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	CookGameChar = var_4
	...
	tf = var_5
	instantiate = var_6
	arg_1_0.enemy2Char = var_1_7(var_5(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	CookGameChar = var_4
	...
	tf = var_5
	instantiate = var_6
	arg_1_0.enemyPet = var_1_8(var_5(var_6(arg_1_0._tpl)), arg_1_0._gameData, arg_1_0._event)
	...
	local var_1_12 = var_7.char_instiate_data

	CookGameConst = var_1_10008

	var_1_10(var_1_9, var_1_11, var_1_12[var_1_10008.player_char])
	...
	local var_1_16 = var_7.char_instiate_data

	CookGameConst = var_8

	var_1_14(var_1_13, var_1_15, var_1_16[var_8.parter_char])
	...
	local var_1_20 = var_7.char_instiate_data

	CookGameConst = var_8

	var_1_18(var_1_17, var_1_19, var_1_20[var_8.parter_pet])
	...
	local var_1_24 = var_7.char_instiate_data

	CookGameConst = var_8

	var_1_22(var_1_21, var_1_23, var_1_24[var_8.enemy1_char])
	...
	local var_1_28 = var_7.char_instiate_data

	CookGameConst = var_8

	var_1_26(var_1_25, var_1_27, var_1_28[var_8.enemy2_char])
	...
	local var_1_32 = var_7.char_instiate_data

	CookGameConst = var_8

	var_1_30(var_1_29, var_1_31, var_1_32[var_8.enemy_pet])
	...
	arg_1_0._playerColliderEvenet = var_4(var_1_37, var_6(var_7))
	...
	for iter_1_0 = 1, arg_1_0._gameData.cake_num do
		...
		findTF = var_1_10009
		var_1_10009 = var_1_10009(arg_1_0._playerBox, "table/cake/" .. iter_1_0)
		findTF = var_10

		local var_1_40 = var_10(var_1_10009, "pos")

		GetComponent = var_11
		findTF = var_12

		local var_1_41 = var_12(var_1_10009, "collider")

		typeof = var_13
		EventTriggerListener = var_14

		local var_1_42 = var_11(var_1_41, var_13(var_14))

		var_11.AddPointDownFunc(var_1_42, function(arg_3_0, arg_3_1)
	...
	for iter_1_1 = 1, arg_1_0._gameData.cake_num do
		...
		findTF = var_1_10009
		var_1_10009 = var_1_10009(arg_1_0._enemyBox, "table/cake/" .. iter_1_1)
		findTF = var_10

		local var_1_44 = var_10(var_1_10009, "pos")
...
function var_0_0.onPickupCake(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	for iter_5_0 = 1, #arg_5_3 do
		...
		if var_9.id == arg_5_2 then
			...
			var_9.cakePos = var_1_10012.InverseTransformPoint(var_5_2, var_5_1.position)
			...
			if arg_5_4 then
				...
				var_13(var_5_3(var_5_0, "select"), true)
			end
		else
			setActive = var_5_1
			findTF = var_1_10012

			var_5_1(var_1_10012(var_5_0, "select"), false)
		end
	end
...
function var_0_0.step(arg_8_0, arg_8_1)
	for iter_8_0 = 1, #arg_8_0.chars do
		...
		if var_6.getCharActive(var_8_0) then
			local var_8_1 = var_6:getTargetPos()
			local var_8_2 = var_6:getVelocity()

			if var_8_1 then
				local var_8_3 = var_6
				local var_8_4 = var_6.getPos(var_8_3)

				if not var_8_2 then
					math = var_8_3

					if var_8_3.abs(var_8_1.y - var_8_4.y) ~= 0 then
						math = var_10

						local var_8_5 = var_10.atan

						math = var_11

						local var_8_6 = var_11.abs(var_8_1.y - var_8_4.y)

						math = var_12

						local var_8_7 = var_8_5(var_8_6 / var_12.abs(var_8_1.x - var_8_4.x))
						local var_8_8 = var_8_1.x > var_8_4.x and 1 or -1
						local var_8_9 = var_8_1.y
						local var_8_10 = var_8_4.y < var_8_9 and 1 or -1

						math = var_13

						local var_8_11 = var_13.cos(var_8_7) * var_8_8

						math = var_14

						local var_8_12 = var_14.sin(var_8_7) * var_8_10

						var_1_10016 = var_6

						var_6.setVelocity(var_1_10016, var_8_11, var_8_12, var_8_7)
					else
						var_6:stopMove()
					end
				end
	...
	if not arg_8_0.sceneTfs then
		...
		local var_8_14 = arg_8_0._scene.childCount

		arg_8_0.judgeNum = 0

		for iter_8_1 = 0, var_8_14 - 1 do
			local var_8_15 = arg_8_0._scene
			local var_8_16 = var_8.GetChild(var_8_15, iter_8_1)

			string = var_8_15

			if var_8_15.match(var_8_16.name, "judge") then
				arg_8_0.judgeNum = arg_8_0.judgeNum + 1
				table = var_9

				var_9.insert(var_8_13, var_8_16)
			else
				table = var_9

				var_9.insert(arg_8_0.sceneTfs, {
					tf = var_8_16,
					offset = arg_8_0:getTfOffset(var_8_16.name)
				})
			end
		end
		...
		var_4.sort(var_8_13, function(arg_9_0, arg_9_1)
	...
	var_8_13.sort(arg_8_0.sceneTfs, function(arg_10_0, arg_10_1)
	...
	local var_8_22 = arg_8_0:getFillterWanted({
		arg_8_0.enemy1Char,
		arg_8_0.enemyPet
	})
	local var_8_23 = arg_8_0
	local var_8_24 = arg_8_0.getFillterWanted(var_8_23, {
		arg_8_0.enemy1Char,
		arg_8_0.enemy2Char
	})

	CookGameConst = var_8_23

	if var_8_23.player_use_ai then
	...
	if arg_8_0._gameData.gameTime and arg_8_0._gameData.gameTime > 0 then
		...
		arg_8_0:setCharAction(arg_8_0.enemy2Char, var_8_22, arg_8_0.enemyCakes)
	...
	for iter_8_3 = #arg_8_0.acCakes, 1, -1 do
		...
		math = var_1_10016
		var_1_10016 = var_1_10016.abs(var_8_27.y - var_8_26.y)
		math = var_17
		var_1_10015 = var_1_10015(var_1_10016 / var_17.abs(var_8_27.x - var_8_26.x))
		var_1_10016 = var_8_27.x > var_8_26.x and 1 or -1

		local var_8_28 = var_8_27.y
		local var_8_29 = var_8_26.y < var_8_28 and 1 or -1

		math = var_18

		local var_8_30 = var_18.cos(var_1_10015) * var_1_10016 * 600 * arg_8_1

		math = var_19

		local var_8_31 = var_19.sin(var_1_10015) * var_8_29 * 600 * arg_8_1

		Vector2 = var_20

		local var_8_32 = var_20(var_8_26.x + var_8_30, var_8_26.y + var_8_31)
		local var_8_33 = arg_8_0.acCakes[iter_8_3].tf.anchoredPosition

		if var_8_26.x < var_8_27.x and var_8_32.x < var_8_27.x then
			var_8_33.x = var_8_32.x
		elseif var_8_26.x > var_8_27.x and var_8_32.x > var_8_27.x then
			var_8_33.x = var_8_32.x
		else
			var_8_33.x = var_8_27.x
		end

		if var_8_26.y < var_8_27.y and var_8_32.y < var_8_27.y then
			var_8_33.y = var_8_32.y
		elseif var_8_26.y > var_8_27.y and var_8_32.y > var_8_27.y then
			var_8_33.y = var_8_32.y
		else
			var_8_33.y = var_8_27.y
		end

		local var_8_34 = arg_8_0.acCakes[iter_8_3].tf

		var_8_34.anchoredPosition = var_8_33
		math = var_8_34

		if var_8_34.abs(var_8_33.y - var_8_27.y) < 3 then
			math = var_22

			if var_22.abs(var_8_33.x - var_8_27.x) < 3 then
				table = var_22
		...
		for iter_15_0 = 0, var_15_5 do
			for iter_15_1 = 0, var_15_5 do
				...
				if iter_15_0 == 0 and iter_15_1 == 0 or iter_15_0 ~= 0 then
					var_1_10018 = var_15_6 .. "_L" .. iter_15_0 .. "_R" .. iter_15_1
				end
				...
				if var_1_10018 then
					...
					local var_15_9 = var_1_10018

					typeof = var_1_10022
					RuntimeAnimatorController = var_1_10023
					var_1_10019 = var_1_10019(var_15_8, var_15_9, var_1_10022(var_1_10023))
					table = var_15_8

					var_15_8.insert(var_15_2, {
	...
	elseif var_15_4 then
		for iter_15_2 = 0, var_15_5 do
			for iter_15_3 = 0, arg_15_0._gameData.speed_num do
				var_1_10018 = var_15_6 .. "_L" .. iter_15_2 .. "_" .. iter_15_3
				LoadAny = var_1_10019

				local var_15_10 = var_15_7
				local var_15_11 = var_1_10018

				typeof = var_22
				RuntimeAnimatorController = var_1_10023
				var_1_10019 = var_1_10019(var_15_10, var_15_11, var_22(var_1_10023))
				table = var_15_10

				var_15_10.insert(var_15_2, {
					runtimeAnimator = var_1_10019,
					name = var_1_10018
				})
			end
		...
		for iter_15_4 = 0, var_15_5 do
			...
			typeof = var_1_10018
			RuntimeAnimatorController = var_1_10019

			local var_15_15 = var_15(var_15_13, var_15_14, var_1_10018(var_1_10019))

			table = var_15_13

			var_15_13.insert(var_15_2, {
...
function var_0_0.createAcCake(arg_16_0, arg_16_1)
	...
	local var_16_4 = var_1_10006(var_1_10007(arg_16_0._cakeTpl))

	GetSpriteFromAtlasAsync = var_7

	var_7(arg_16_0._gameData.path, "cake_" .. var_16_0, function(arg_17_0)
		setImageSprite = var_2_10001
		findTF = var_2_10002

		var_2_10001(var_2_10002(var_16_4, "img"), arg_17_0, true)
	...
	var_7(var_16_4, arg_16_0._scene)
...
function var_0_0.getBattleData(arg_19_0, arg_19_1)
	...
	for iter_19_0 = var_19_0, #var_1_10003.char_battle_data do
		...
		if var_1_10006.char_battle_data[iter_19_0].id == arg_19_1 then
			...
			return var_1_10006(var_1_10007.char_battle_data[iter_19_0])
		end
	end
