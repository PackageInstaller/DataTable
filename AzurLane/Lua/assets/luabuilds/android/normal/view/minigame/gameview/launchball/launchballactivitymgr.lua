...
function var_0_0.GetRemainCount(arg_5_0)
	...
	LaunchBallActivityMgr = var_2

	return var_5_0 - var_2.GetRoundCount(arg_5_0)
end
...
function var_0_0.GetInvitationAble(arg_7_0)
	...
	local var_7_0 = var_2.GetRoundCount(arg_7_0)
...
function var_0_0.GetInvitation(arg_8_0)
	...
	if var_1_10001.GetInvitationAble(arg_8_0) then
		...
		local var_8_0 = var_2.m02
		local var_8_1 = var_2.sendNotification

		GAME = var_1_10004

		var_8_1(var_8_0, var_1_10004.ACTIVITY_OPERATION, {
			cmd = 2,
			activity_id = arg_8_0
		})
	end
...
function var_0_0.IsFinishZhuanShu(arg_13_0, arg_13_1)
	...
	if var_3.GetZhuanShuCount(arg_13_0) then
		::label_13_0::
...
function var_0_0.CheckZhuanShuAble(arg_14_0, arg_14_1)
	...
	if var_14_0 then
		...
		local var_14_2 = var_4(var_1_10005)
...
function var_0_0.OpenGame(arg_17_0, arg_17_1)
	...
	var_17_1(var_17_0, var_4.GO_MINI_GAME, 57)
...
function var_0_0.GetGameAward(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	LaunchBallActivityMgr = var_5

	local var_18_0 = var_5.GetRoundCount(arg_18_0)
	...
	local var_18_4 = var_1_10009.GetGameScores(arg_18_0)

	LaunchBallGameConst = var_10

	local var_18_6

	if arg_18_1 == var_10.round_type_juqing then
		...
		local var_18_7 = var_1_10012.ACTIVITY_OPERATION
		...
		local var_18_8 = var_1_10014.floor

		LaunchBallGameVo = var_1_10015
		var_1_10013.arg3 = var_18_8(var_1_10015.gameStepTime)

		var_18_6(var_18_5, var_18_7, var_1_10013)
	else
		...
		if arg_18_1 == var_18_6.round_type_wuxian then
			...
			for iter_18_0 = 1, #var_18_4 do
				if not var_18_9 and var_18_4[iter_18_0][1] <= arg_18_3 and var_18_3 < var_18_4[iter_18_0][1] then
					var_18_9 = true
				end
			end
			...
			if var_18_9 then
				...
				local var_18_10 = var_11.m02
				local var_18_11 = var_11.sendNotification
				...
				math = var_1_10015
				var_1_10015 = var_1_10015.floor
				LaunchBallGameVo = var_1_10016
				var_18_12.arg3 = var_1_10015(var_1_10016.gameStepTime)

				var_18_11(var_18_10, var_1_10013, var_18_12)
			end
		else
			...
			local var_18_13 = var_11.m02
			local var_18_14 = var_11.sendNotification

			GAME = var_1_10013

			local var_18_15 = var_1_10013.ACTIVITY_OPERATION
			local var_18_16 = {
				cmd = 1,
				activity_id = arg_18_0,
				arg1 = arg_18_1,
			...
			local var_18_17 = var_1_10015.floor

			LaunchBallGameVo = var_1_10016
			var_18_16.arg3 = var_18_17(var_1_10016.gameStepTime)
