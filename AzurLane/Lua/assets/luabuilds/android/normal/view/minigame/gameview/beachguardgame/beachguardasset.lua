...
function var_0_0.getCardIcon(arg_2_0)
	...
	BeachGuardAsset = var_1_10002

	return var_1_10001(var_1_10002.card_asset_path, arg_2_0)
end
...
function var_0_0.getCardQIcon(arg_3_0)
	...
	return var_1_10001(var_1_10002.cardQ_asset_path, arg_3_0)
end
...
function var_0_0.getBeachMap(arg_4_0)
	...
	return var_1_10001(var_1_10002.map_asset_path, arg_4_0)
end
...
function var_0_0.getChar(arg_5_0)
	...
	BeachGuardAsset = var_1_10004

	var_5_2(var_5_1, var_1_10004.char_asset_path, arg_5_0, false, function(arg_6_0)
		var_5_0 = arg_6_0
		table = var_2_10001
...
function var_0_0.getBullet(arg_7_0)
	...
	var_7_2(var_7_1, var_1_10004.bullet_asset_path, arg_7_0, false, function(arg_8_0)
		var_7_0 = arg_8_0
		table = var_2_10001
		...
		var_1(var_8_0, var_3(var_2_10004)).blocksRaycasts = false
...
function var_0_0.getEffect(arg_9_0)
	...
	var_9_2(var_9_1, var_1_10004.effect_asset_path, arg_9_0, false, function(arg_10_0)
		var_9_0 = arg_10_0
		table = var_2_10001
		...
		typeof = var_3
		CanvasGroup = var_2_10004
		var_1(var_10_0, var_3(var_2_10004)).blocksRaycasts = false
...
function var_0_0.clear()
	for iter_11_0 = 1, #var_0_0.clearName do
		...
		BeachGuardAsset = var_1_10006

		var_1_10004(var_11_0, var_1_10006.char_asset_path, var_0_0.clearName[iter_11_0])
	end
