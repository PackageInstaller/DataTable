	...
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			for iter_2_0 = 1, var_0_25 do
				...
				var_2_10005 = var_2_10005(var_2_10006(arg_2_0._gridEffect))
				...
				Vector2 = var_2_10006
				var_2_10005.anchoredPosition = var_2_10006(var_0_27.x * iter_2_0 - var_0_27.x / 2, var_0_27.y / 2)
				table = var_2_10006
			...
			for iter_5_0 = 1, #arg_5_0.grids do
				...
				if not var_5_3.moveAble then
					...
					if (iter_5_0 - 1) * var_0_27.x < var_5_3.tf.anchoredPosition.x then
						...
						Vector2 = var_2_10010
						var_2_10011 = var_5_3.tf.anchoredPosition.x

						local var_5_6 = var_5_3.speed

						Time = var_2_10013
						var_5_5.anchoredPosition = var_2_10010(var_2_10011 - var_5_6 * var_2_10013.deltaTime, 0)
				...
				if not var_5_3.eventAble then
					...
					local var_5_8 = var_5_3.tf

					typeof = var_2_10010
					EventTriggerListener = var_2_10011
					var_2_10010 = var_8(var_5_8, var_2_10010(var_2_10011))

					var_8.AddPointDownFunc(var_2_10010, function()
			...
			if not var_5_2 and arg_5_0.comboCheck then
				if #arg_5_0:getSeriesGrids() > 0 then
					...
					for iter_5_1 = 1, #var_2 do
						local var_5_10 = var_2[iter_5_1].series
						local var_5_11 = var_2[iter_5_1].index
						local var_5_12 = var_2[iter_5_1].double

						for iter_5_2 = 1, #var_5_10 do
							table = var_2_10015

							var_2_10015.insert(var_5_9, var_5_10[iter_5_2])
						end

						local var_5_13 = arg_5_0:getGridDouble(var_5_10)
						local var_5_14 = arg_5_0._event

						var_12.emit(var_5_14, var_0_15, {
							series = #var_5_10,
							combo = arg_5_0.combo,
							index = var_5_11,
							double = var_5_13
		...
		insertGrids = function(arg_12_0)
			...
			for iter_12_0 = 1, var_12_0 do
				...
				local var_12_2 = arg_12_0.createGridData(var_12_1)

				table = var_12_1

				var_12_1.insert(arg_12_0.grids, var_12_2)
			end
		...
		takeAwayGrid = function(arg_14_0, arg_14_1)
			...
			for iter_14_0 = #arg_14_1, 1, -1 do
				...
				var_2_10008(var_14_4, var_2_10010.remove(arg_14_0.grids, arg_14_1[iter_14_0]))

				setActive = var_2_10008

				var_2_10008(arg_14_0.effects[arg_14_1[iter_14_0]], false)

				setActive = var_2_10008

				var_2_10008(arg_14_0.effects[arg_14_1[iter_14_0]], true)
			end

			for iter_14_1 = 1, #var_14_0 do
				destroy = var_2_10008

				var_2_10008(var_14_0[iter_14_1].tf)
		...
		triggerDownGrid = function(arg_16_0, arg_16_1)
			...
			elseif var_16_0.rule == var_0_31 then
				...
				for iter_16_8 = arg_16_1 + 1, #arg_16_0.grids do
					if var_16_17 then
						if arg_16_0.grids[iter_16_8].rule == var_0_32 then
							...
							var_2_10020.insert(var_16_18, iter_16_8)
				...
				for iter_16_9 = 1, #var_16_15 do
					...
					var_2_10020.insert(var_16_3, var_16_15[iter_16_9])
				end

				for iter_16_10 = 1, #var_16_18 do
					table = var_2_10020

					var_2_10020.insert(var_16_3, var_16_18[iter_16_10])
				end
			else
		...
		initGrids = function(arg_19_0, arg_19_1)
			...
			for iter_19_0 = 1, var_0_25 do
				...
				local var_19_1 = arg_19_0.createGridData(var_19_0)

				table = var_19_0

				var_19_0.insert(arg_19_0.grids, var_19_1)
			end
		...
		instiateGrids = function(arg_20_0, arg_20_1)
			for iter_20_0 = 1, #arg_20_0.grids do
				if not arg_20_0.grids[iter_20_0].tf then
					...
					local var_20_0 = var_7(var_2_10008(arg_20_0.tplGrid))
					...
					var_2_10008(var_9(var_20_0, var_6.name), true)
					...
					if var_6.rule ~= var_0_32 then
						...
						var_9(var_10(var_20_0, var_6.name .. "/boom"), var_6.rule == var_0_31)

						setActive = var_9
						findTF = var_10

						var_9(var_10(var_20_0, var_6.name .. "/thunder"), var_6.rule == var_0_33)
					end

					Vector2 = var_9
					var_20_0.anchoredPosition = var_9(var_2_10008, 0)
	...
	local var_23_0 = {
		ctor = function(arg_24_0)
			...
			var_1.bind(var_24_0, var_0_15, function(arg_25_0, arg_25_1, arg_25_2)
				...
				var_25_5(var_25_4, var_25_6, var_10.getPowerAmount(var_25_7, var_25_0, var_25_1, var_25_3))
			...
			for iter_24_0 = 1, #var_0_37 do
				findTF = var_2_10005
				var_2_10005 = var_2_10005(arg_24_0._specialTf, var_0_37[iter_24_0].name)

				local var_24_1 = var_0_37[iter_24_0].index
				local var_24_2 = var_0_37[iter_24_0].max
				local var_24_3 = var_0_37[iter_24_0].cur

				findTF = var_2_10009
				var_2_10009 = var_2_10009(arg_24_0._specialTf, var_0_37[iter_24_0].name .. "/text")
				setActive = var_10

				var_10(var_2_10009, var_0_2)
				...
				var_11.insert(arg_24_0.powers, var_24_4)
			end
			...
			local var_24_8 = var_3(arg_24_0._successTf, "box")

			typeof = var_4
			Slider = var_5
			var_24_7.slider = var_2(var_24_8, var_4(var_5))
		...
		step = function(arg_29_0)
			for iter_29_0 = 1, #arg_29_0.powers do
				...
				local var_29_2 = var_5.tf

				typeof = var_2_10008
				Slider = var_2_10009

				local var_29_3 = var_29_0(var_29_2, var_2_10008(var_2_10009))
				local var_29_4 = var_5.cur
				local var_29_5

				if not (0 < var_29_4) or not (var_5.cur / var_5.max) then
					var_29_5 = 0
				end

				var_29_3.value = var_29_5
				setText = var_29_3

				local var_29_6 = var_5.text_tf

				math = var_2_10008

				var_29_3(var_29_6, var_2_10008.floor(var_5.cur))
			end

			setText = var_1

			local var_29_7 = arg_29_0.successText

			math = var_3

			var_1(var_29_7, var_3.floor(arg_29_0.success.cur))

			if arg_29_0.success.active and arg_29_0.success.cur > 0 and var_0_24.special_complete and not arg_29_0.inCameraFlag then
				local var_29_8 = arg_29_0.inCameraFadeTime

				if 0 < var_29_8 then
					local var_29_9 = arg_29_0.inCameraFadeTime

					Time = var_2
					arg_29_0.inCameraFadeTime = var_29_9 - var_2.deltaTime * 1000
				else
					local var_29_10 = arg_29_0.success
					local var_29_11 = arg_29_0.success.cur
					local var_29_12 = var_0_44

					Time = var_4
					var_29_10.cur = var_29_11 - var_29_12 * var_4.deltaTime

					if arg_29_0.success.cur <= 0 then
						arg_29_0.success.active = false
						arg_29_0.success.cur = 0

						local var_29_13 = arg_29_0._event

						var_1.emit(var_29_13, var_0_20)
					end
				end
			end
			...
			local var_29_14 = arg_29_0.success.slider
			local var_29_15
		...
		getPowerAmount = function(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
			...
			var_2_10006(var_36_1 .. var_36_2 .. var_36_3 .. var_36_4 .. var_36_5 .. var_2_10012(arg_36_3) .. "，变身倍率: " .. var_36_0)
...
local function var_0_197(arg_37_0, arg_37_1, arg_37_2)
	local var_37_0 = {
		ctor = function(arg_38_0)
			...
			local var_38_2 = var_2(arg_38_0._sceneTf, "scene_background")

			typeof = var_3
			CanvasGroup = var_4
			arg_38_0._bgBackCanvas = var_1(var_38_2, var_3(var_4))
			GetComponent = var_1
			findTF = var_38_2
			...
			typeof = var_3
			CanvasGroup = var_4
			arg_38_0._bgFrontCanvas = var_1(var_38_3, var_3(var_4))
			GetComponent = var_1
			findTF = var_38_3
			...
			typeof = var_3
			CanvasGroup = var_4
			arg_38_0._bgBeamCanvas = var_1(var_38_4, var_3(var_4))
			...
			var_1.bind(var_38_5, var_0_17, function(arg_39_0, arg_39_1, arg_39_2)
				...
				if not arg_38_0.inCamera then
					...
					var_39_4(var_39_3, var_3_10008(var_39_1 * var_39_0.x / 10, var_39_1 * var_39_0.y / 10), var_39_2)
				end
			...
			var_1.bind(var_38_7, var_0_22, function(arg_41_0, arg_41_1, arg_41_2)
				...
				var_41_1(var_41_0, var_3_10005(0, 0), function()
					return
				end, true)
		...
		clear = function(arg_44_0)
			...
			if var_44_0(var_2_10002(arg_44_0._sceneTf)) then
				LeanTween = var_1
				...
				var_44_1(var_2(arg_44_0._sceneTf), false)
			end
		...
		setBeam = function(arg_48_0, arg_48_1, arg_48_2)
			...
			if var_48_0(var_2_10004(arg_48_0._sceneTf)) then
				LeanTween = var_48_1
				var_48_1 = var_48_1.cancel
				go = var_4

				var_48_1(var_4(arg_48_0._sceneTf), false)
			end
			...
			local var_48_3 = var_48_2(var_4(arg_48_0._sceneTf), 0, 1, 0.2)
			local var_48_4 = var_3.setOnUpdate

			System = var_5

			local var_48_5 = var_48_4(var_48_3, var_5.Action_float(function(arg_49_0)
				if arg_48_1 then
			...
			var_48_6(var_48_5, var_5.Action(function()
				if arg_48_2 then
					arg_48_2()
				end
	...
	local var_51_0 = {
		...
		getRoleEmptySkill = function(arg_61_0, arg_61_1)
			...
			if 0 < var_61_2 then
				...
				return var_61_2(var_61_0[var_4.random(1, #var_61_0)])
			end
		...
		onRoleSpecial = function(arg_62_0, arg_62_1)
			...
			for iter_62_0 = 1, #arg_62_0.leftRole.skill do
				if arg_62_0.leftRole.skill[iter_62_0].special_trigger then
					...
					var_62_1(var_62_0, var_62_2, var_2_10010(var_6))
				end
			end
		...
		clear = function(arg_64_0)
			...
			if var_64_0(var_2_10002(arg_64_0._leftRolePos)) then
				LeanTween = var_64_1
				var_64_1 = var_64_1.cancel
				go = var_2

				var_64_1(var_2(arg_64_0._leftRolePos))
			end
			...
			if var_64_2(var_2(arg_64_0._rightRolePos)) then
				LeanTween = var_64_3
				var_64_3 = var_64_3.cancel
				go = var_2

				var_64_3(var_2(arg_64_0._rightRolePos))
			end
			...
			if var_64_4(var_2(arg_64_0.rightRole.tf)) then
				LeanTween = var_64_5
				var_64_5 = var_64_5.cancel
				go = var_2

				var_64_5(var_2(arg_64_0.rightRole.tf))
			end
			...
			if var_64_6(var_2(arg_64_0.leftRole.tf)) then
				LeanTween = var_1
				...
				var_64_7(var_2(arg_64_0.leftRole.tf))
			end
		...
		onGridTrigger = function(arg_65_0)
			...
			for iter_65_0 = 1, #arg_65_0.leftRole.skill do
				...
				if var_2_10009 == var_10(arg_65_0.leftRole.specialTime) and var_65_3.power_index == var_65_1 then
					table = var_2_10009
					...
					if var_2_10009.contains(var_65_3.grid_index, var_65_0) and var_65_3.atk_index then
						...
						var_2_10009(var_65_4, var_65_5, var_2_10012(var_65_3))
					end
				end
			end
		...
		createRole = function(arg_66_0, arg_66_1, arg_66_2, arg_66_3)
			if not arg_66_0:getRoleData(arg_66_1) then
				return nil
			end
			...
			local var_66_1 = var_6(var_2_10007(var_2_10008(arg_66_0._tpl, var_4.name)))

			SetParent = var_7

			var_7(var_66_1, arg_66_3)

			Vector2 = var_7
			var_66_1.anchoredPosition = var_7(0, 0)
			Vector3 = var_7
			var_66_1.localScale = var_7(1, 1, 1)
			setActive = var_7
			...
			if var_4.anim_init_pos then
				findTF = var_66_2
				var_66_2 = var_66_2(var_66_1, "body/anim")
				var_66_2.anchoredPosition = var_4.anim_init_pos
			end

			findTF = var_66_2

			local var_66_3 = var_66_2(var_66_1, "body")

			findTF = var_8

			local var_66_4 = var_8(var_66_3, "anim")

			GetComponent = var_9

			local var_66_5 = var_66_4

			typeof = var_2_10011
			Animator = var_2_10012

			local var_66_6 = var_9(var_66_5, var_2_10011(var_2_10012))

			GetComponent = var_66_5

			local var_66_7 = var_66_4

			typeof = var_2_10012
			DftAniEvent = var_2_10013

			local var_66_8 = var_66_5(var_66_7, var_2_10012(var_2_10013))

			var_10.SetStartEvent(var_66_8, function()
				if var_66_0.startCallback then
					var_66_0.startCallback()
				end

				return
			end)
			var_10:SetTriggerEvent(function()
				if var_66_0.triggerCallback then
					var_66_0.triggerCallback()
				end

				return
			end)
			var_10:SetEndEvent(function()
				if var_66_0.endCallback then
					var_66_0.endCallback()
				end

				return
			end)

			var_66_0.name = var_4.name
			var_66_0.tf = var_66_1
			GetComponent = var_11

			local var_66_9 = var_66_1

			typeof = var_13
			CanvasGroup = var_2_10014
			var_66_0.canvasGroup = var_11(var_66_9, var_13(var_2_10014))
			var_66_0.body = var_66_3
			var_66_0.animTf = var_66_4
			var_66_0.animator = var_66_6
			var_66_0.dftEvent = var_10
			var_66_0.startCallback = nil
			var_66_0.triggerCallback = nil
			var_66_0.endCallback = nil
			var_66_0.skill = var_4.skill
			var_66_0.name = var_4.name
			var_66_0.index = var_4.index
			var_66_0.actions = var_4.actions
		...
		applyOrAddSkillData = function(arg_74_0, arg_74_1, arg_74_2)
			...
			if var_74_1.anim_bool then
				var_2_10007 = var_74_0.animator

				var_6.SetBool(var_2_10007, var_5, true)
			end

			if var_74_0 == arg_74_0.leftRole and not var_74_1.dmg_index then
				var_2_10007 = arg_74_0._leftRolePos

				var_6.SetSiblingIndex(var_2_10007, 1)
			elseif var_74_0 == arg_74_0.rightRole and not var_74_1.dmg_index then
				var_2_10007 = arg_74_0._rightRolePos
		...
		checkAction = function(arg_76_0, arg_76_1, arg_76_2)
			if arg_76_1.actions and arg_76_1.actionIndex <= #arg_76_1.actions then
				...
				if var_76_8 or var_76_9 and var_76_10 and 2 <= var_76_10 then
					local var_76_11 = arg_76_0._event

					var_2_10014.emit(var_76_11, var_0_23, true)
				end

				if var_76_1 and 0 < var_76_1 then
					-- block empty
				else
					function var_2_10014()
						if var_76_5 then
							pg = var_0
					...
					local function var_76_12()
						if var_76_6 then
							pg = var_0
							var_3_10001 = var_0.CriMgr.GetInstance()

							var_0.PlaySoundEffect_V3(var_3_10001, "event:/ui/" .. var_76_6)
						end

						if var_76_4 then
							var_76_4 = false
							arg_76_1.role.targetRole.canvasGroup.alpha = 1
							var_3_10001 = arg_76_0._event

							var_0.emit(var_3_10001, var_0_22)
						else
							...
							if arg_76_1.currentSkill.atk_index then
								...
								local var_78_1 = var_2.getRoleDmgData(var_78_0, arg_76_1.role.targetRole, var_1)
								local var_78_2 = arg_76_1.role.targetRole.name

								if var_78_1 then
									pairs = var_4

									for iter_78_0, iter_78_1 in var_4(arg_76_0.playingDatas) do
										if iter_78_0 == var_78_2 then
											local var_78_3 = arg_76_0
											local var_78_4 = var_9.applyOrAddSkillData
											local var_78_5 = iter_78_1

											Clone = var_3_10012

											var_78_4(var_78_3, var_78_5, var_3_10012(var_78_1), true)
										end
									end
								end

								if arg_76_1.currentSkill.score and arg_76_1.role == arg_76_0.leftRole then
									local var_78_6 = arg_76_0._event
									local var_78_7 = var_5.emit
									local var_78_8 = var_0_18

									math = iter_78_1

									var_78_7(var_78_6, var_78_8, iter_78_1.random(var_4[1] + arg_76_0.addScore[1], var_4[2] + arg_76_0.addScore[2]))
					...
					local function var_76_13()
						if var_76_7 then
							...
							var_0.PlaySoundEffect_V3(var_3_10001, "event:/ui/" .. var_76_7)
						end
						...
						if var_79_0(var_3_10001(arg_76_1.role.tf)) then
							LeanTween = var_0
							...
							var_79_1(var_1(arg_76_1.role.tf))
						end

						if arg_76_1.currentSkill.anim_end_pos then
							findTF = var_1
							var_1(arg_76_1.role.tf, "body/anim").anchoredPosition = var_0
						end
						...
						if var_76_3 then
							...
							Vector2 = var_79_2
							var_79_3.anchoredPosition = var_79_2(arg_76_1.role.tf.anchoredPosition.x + var_76_3.x, arg_76_1.role.tf.anchoredPosition.y + var_76_3.y)
						end
					...
					arg_76_0:setDftHandle(arg_76_1.role, var_2_10014, var_76_12, var_76_13)
					arg_76_0:playAnimation(arg_76_1.role, var_76_0)
				end
			else
				if arg_76_1.currentSkill.atk_index == 3 then
					local var_76_14 = arg_76_0:getRoleDmgBack(arg_76_1.role.targetRole, var_3)
					local var_76_15 = arg_76_1.role.targetRole.name

					if var_76_14 then
						pairs = var_6

						for iter_76_0, iter_76_1 in var_6(arg_76_0.playingDatas) do
							if iter_76_0 == var_76_15 then
								local var_76_16 = arg_76_0
								local var_76_17 = arg_76_0.applyOrAddSkillData
								local var_76_18 = iter_76_1

								Clone = var_2_10014

								var_76_17(var_76_16, var_76_18, var_2_10014(var_76_14))
							end
						end
					end
				end
		...
		moveRole = function(arg_80_0, arg_80_1, arg_80_2)
			...
			if var_80_0(var_2_10004(arg_80_1.tf)) then
				LeanTween = var_3
			...
			if arg_80_2.distance then
				...
				local var_80_5 = var_80_3(var_80_4, var_5(arg_80_2.distance.x, arg_80_2.distance.y, 0), arg_80_2.time)
			...
			elseif arg_80_2.distance_m then
				...
				local var_80_12 = var_80_10(var_80_11, var_6(var_80_8.x, var_80_8.y, 0), arg_80_2.time)
...
function var_0_1.initUI(arg_91_0)
	...
	local var_91_0 = var_2(arg_91_0._tf, "ui/gameUI/top/time")

	i18n = var_3

	var_1(var_91_0, var_3("mini_game_time"))
	...
	var_1(var_91_1, var_3("mini_game_score"))
	...
	var_1(var_91_2, var_3("mini_game_leave"))
	...
	var_1(var_91_3, var_3("mini_game_pause"))
	...
	var_1(var_91_4, var_3("mini_game_cur_score"))
	...
	var_1(var_91_5, var_3("mini_game_high_score"))
	...
	local var_91_6 = var_2(arg_91_0.countUI, "count")

	typeof = var_3
	Animator = var_4
	arg_91_0.countAnimator = var_1(var_91_6, var_3(var_4))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_91_0.countDft = var_1(var_91_7, var_3(var_4))
	...
	local var_91_11 = var_3(arg_91_0.leaveUI, "ad/btnOk")
	...
	var_1(var_91_10, var_91_11, var_91_12, var_5)
	...
	var_1(var_91_13, var_91_14, var_91_15, var_5)
	...
	local var_91_17 = var_3(arg_91_0.pauseUI, "ad/btnOk")
	...
	var_1(var_91_16, var_91_17, var_91_18, var_5)
	...
	local var_91_20 = var_3(arg_91_0.settlementUI, "ad/btnOver")
	...
	for iter_91_0 = 1, #var_0_51 do
		...
		local var_91_22 = var_91_22(arg_91_0.selectedUI, "ad/leftRole/role" .. var_0_51[iter_91_0])

		setActive = var_1_10006

		var_1_10006(var_91_22, true)

		var_1_10006 = var_0_51[iter_91_0]
		onButton = var_7
		var_1_10008 = arg_91_0
		var_1_10009 = var_91_22

		local function var_91_23()
			local var_98_0 = arg_91_0

			var_0_47, var_0_48 = var_0.checkRoleId(var_98_0, var_1_10006, var_0_48, var_0_52)
		...
		var_7(var_1_10008, var_1_10009, var_91_23, var_1_10011)
	...
	local var_91_24 = arg_91_0

	findTF = var_3

	local var_91_25 = var_3(arg_91_0.selectedUI, "close")
	...
	SFX_CANCEL = var_91_27

	var_1(var_91_24, var_91_25, var_91_26, var_91_27)
	...
	for iter_91_1 = 1, #var_0_52 do
		...
		local var_91_27 = var_91_27(arg_91_0.selectedUI, "ad/rightRole/role" .. var_0_52[iter_91_1])

		setActive = var_1_10006

		var_1_10006(var_91_27, true)

		var_1_10006 = var_0_52[iter_91_1]
		onButton = var_7
		var_1_10008 = arg_91_0
		var_1_10009 = var_91_27

		local function var_91_28()
			local var_100_0 = arg_91_0

			var_0_48, var_0_47 = var_0.checkRoleId(var_100_0, var_1_10006, var_0_47, var_0_51)
		...
		var_7(var_1_10008, var_1_10009, var_91_28, var_1_10011)
	...
	local var_91_30 = var_3(arg_91_0.selectedUI, "ad/btnOk")
	...
	var_1(var_91_29, var_91_30, var_91_31, var_5)
	...
	if not var_0_54[var_91_32 + 1] or not var_0_54[var_91_32 + 1] then
		var_91_33 = var_0_70
	end
	...
	var_91_33(var_3(arg_91_0.btnDay, "on"), var_0_71 == var_0_69)

	setActive = var_91_33
	findTF = var_3

	var_91_33(var_3(arg_91_0.btnNight, "on"), var_0_71 == var_0_70)

	onButton = var_91_33

	local var_91_34 = arg_91_0
	local var_91_35 = arg_91_0.btnDay
	...
	local function var_91_36()
		...
		var_0(var_2_10001(arg_91_0.btnDay, "on"), true)

		setActive = var_0
		findTF = var_1

		var_0(var_1(arg_91_0.btnNight, "on"), false)
	...
	var_91_33(var_91_34, var_91_35, var_91_36, var_1_10006)

	onButton = var_91_33

	local var_91_37 = arg_91_0
	local var_91_38 = arg_91_0.btnNight

	local function var_91_39()
		var_0_71 = var_0_70
		setActive = var_0
		findTF = var_2_10001

		var_0(var_2_10001(arg_91_0.btnDay, "on"), false)

		setActive = var_0
		findTF = var_1

		var_0(var_1(arg_91_0.btnNight, "on"), true)
	...
	var_91_33(var_91_37, var_91_38, var_91_39, var_1_10006)

	setActive = var_91_33

	var_91_33(arg_91_0.selectedUI, false)

	findTF = var_91_33
	arg_91_0.menuUI = var_91_33(arg_91_0._tf, "pop/menuUI")
	GetComponent = var_2
	findTF = var_3

	local var_91_40 = var_3(arg_91_0.menuUI, "battList")

	typeof = var_4
	ScrollRect = var_5
	arg_91_0.battleScrollRect = var_2(var_91_40, var_4(var_5))
	arg_91_0.totalTimes = arg_91_0:getGameTotalTime()

	local var_91_41, var_91_42

	if arg_91_0:getGameUsedTimes() - 4 < 0 then
		var_91_41 = 0
	else
		var_91_42 = arg_91_0
		var_91_41 = arg_91_0.getGameUsedTimes(var_91_42) - 4
	end

	scrollTo = var_91_42

	var_91_42(arg_91_0.battleScrollRect, 0, 1 - var_91_41 / (arg_91_0.totalTimes - 4))

	onButton = var_91_42

	local var_91_43 = arg_91_0

	findTF = var_5

	local var_91_44 = var_5(arg_91_0.menuUI, "rightPanelBg/arrowUp")

	local function var_91_45()
	...
	var_91_42(var_91_43, var_91_44, var_91_45, var_7)

	onButton = var_91_42

	local var_91_46 = arg_91_0

	findTF = var_91_44

	local var_91_47 = var_91_44(arg_91_0.menuUI, "rightPanelBg/arrowDown")
	...
	var_91_42(var_91_46, var_91_47, var_91_48, var_7)
	...
	local var_91_50 = var_91_47(arg_91_0.menuUI, "btnBack")

	local function var_91_51()
	...
	var_91_42(var_91_49, var_91_50, var_91_51, var_7)

	onButton = var_91_42

	local var_91_52 = arg_91_0

	findTF = var_91_50

	local var_91_53 = var_91_50(arg_91_0.menuUI, "btnRule")

	local function var_91_54()
		pg = var_2_10000
		...
		pg = var_2_10003
		var_107_2.helps = var_2_10003.gametip.ssss_game_tip.tip
	...
	var_91_42(var_91_52, var_91_53, var_91_54, var_7)

	onButton = var_91_42

	local var_91_55 = arg_91_0

	findTF = var_91_53

	local var_91_56 = var_91_53(arg_91_0.menuUI, "btnStart")
	...
	var_91_42(var_91_55, var_91_56, var_91_57, var_7)

	findTF = var_91_42

	local var_91_58 = var_91_42(arg_91_0.menuUI, "tplBattleItem")
	...
	for iter_91_2 = 1, 7 do
		...
		var_1_10008 = var_1_10008(var_1_10009(var_91_58))
		var_1_10008.name = "battleItem_" .. iter_91_2
		setParent = var_1_10009

		local var_91_59 = var_1_10008

		findTF = var_1_10011

		var_1_10009(var_91_59, var_1_10011(arg_91_0.menuUI, "battList/Viewport/Content"))

		var_1_10009 = iter_91_2
		GetSpriteFromAtlasAsync = var_91_59

		var_91_59(var_0_7, "battleDesc" .. var_1_10009, function(arg_109_0)
			setImageSprite = var_2_10001
			findTF = var_2_10002

			var_2_10001(var_2_10002(var_1_10008, "state_open/buttomDesc"), arg_109_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10008, "state_clear/buttomDesc"), arg_109_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10008, "state_current/buttomDesc"), arg_109_0, true)

			setImageSprite = var_2_10001
			findTF = var_2

			var_2_10001(var_2(var_1_10008, "state_closed/buttomDesc"), arg_109_0, true)
		...
		var_91_59(var_1_10008, true)

		table = var_91_59

		var_91_59.insert(arg_91_0.battleItems, var_1_10008)
	end
...
function var_0_1.initGameUI(arg_112_0)
	...
	var_1(var_112_0, var_3(arg_112_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_112_1, var_3(arg_112_0.gameUI, "btnLeave"), function()
...
function var_0_1.updateSelectedUI(arg_118_0)
	for iter_118_0 = 1, #arg_118_0.leftSelectRole do
		...
		if var_0_47 == var_118_0.id then
			...
			var_1_10006(var_7(var_118_0.tf, "selected"), true)

			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_0.tf, "unSelected"), false)
		else
			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_0.tf, "selected"), false)

			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_0.tf, "unSelected"), true)
		end
	end
	...
	for iter_118_1 = 1, #arg_118_0.rightSelectRole do
		...
		if var_0_48 == var_118_1.id then
			...
			var_1_10006(var_7(var_118_1.tf, "selected"), true)

			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_1.tf, "unSelected"), false)
		else
			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_1.tf, "selected"), false)

			setActive = var_1_10006
			findTF = var_7

			var_1_10006(var_7(var_118_1.tf, "unSelected"), true)
		end
	end
...
function var_0_1.updateMenuUI(arg_119_0)
	...
	if arg_119_0.getGameUsedTimes(var_119_0) and 7 <= var_1 then
		setActive = var_119_0
		findTF = var_1_10003

		var_119_0(var_1_10003(arg_119_0.menuUI, "btnStart/free"), true)
	else
		setActive = var_119_0
		findTF = var_1_10003

		var_119_0(var_1_10003(arg_119_0.menuUI, "btnStart/free"), false)
	end
	...
	for iter_119_0 = 1, #arg_119_0.battleItems do
		...
		var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_open"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_closed"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_clear"), false)

		setActive = var_1_10007
		findTF = var_1_10008

		var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_current"), false)

		if iter_119_0 <= var_1 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_clear"), true)
		elseif iter_119_0 == var_1 + 1 and 1 <= var_119_1 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_current"), true)
		elseif var_1 < iter_119_0 and iter_119_0 <= var_1 + var_119_1 then
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_open"), true)
		else
			setActive = var_1_10007
			findTF = var_1_10008

			var_1_10007(var_1_10008(arg_119_0.battleItems[iter_119_0], "state_closed"), true)
		end
	end
	...
	var_5(arg_119_0.battleScrollRect, 0, var_119_2)

	setActive = var_5
	findTF = var_6

	var_5(var_6(arg_119_0.menuUI, "btnStart/tip"), var_119_1 > 0)
	...
	for iter_119_1, iter_119_2 in var_6(var_0_65) do
		...
		local var_119_4 = var_1_10011

		table = var_14

		var_12(var_119_4, var_14.contains(var_119_3, iter_119_2))
	end

	setActive = var_6
	findTF = var_7

	var_6(var_7(arg_119_0.menuUI, "bg/title_day"), var_0_71 == var_0_69)

	setActive = var_6
	findTF = var_7

	var_6(var_7(arg_119_0.menuUI, "bg/title_night"), var_0_71 ~= var_0_69)
	arg_119_0:CheckGet()
...
function var_0_1.CheckGet(arg_120_0)
	...
	var_1_10001(var_1_10002(arg_120_0.menuUI, "got"), false)
	...
	if arg_120_0:getUltimate() == 0 then
		local var_120_1 = arg_120_0:getGameTotalTime()
		local var_120_2 = arg_120_0

		if var_120_1 > arg_120_0.getGameUsedTimes(var_120_2) then
			return
		end

		pg = var_120_2

		local var_120_3 = var_120_2.m02
		local var_120_4 = var_3.sendNotification

		GAME = var_1_10005

		local var_120_5 = var_1_10005.SEND_MINI_GAME_OP
		local var_120_6 = {
			hubid = arg_120_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_7
		var_120_6.cmd = var_7.CMD_ULTIMATE
		var_120_6.args1 = {}

		var_120_4(var_120_3, var_120_5, var_120_6)

		setActive = var_120_4
		findTF = var_120_3

		var_120_4(var_120_3(arg_120_0.menuUI, "got"), true)
	end
...
function var_0_1.openMenuUI(arg_121_0)
	...
	var_1_10001(var_1_10002(arg_121_0._tf, "sceneContainer/scene_front"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_121_0._tf, "sceneContainer/scene_background"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_121_0._tf, "sceneContainer/scene"), false)
	...
	if not arg_121_0.getBGM(var_121_0) then
		pg = var_121_0

		local var_121_1 = var_121_0.CriMgr.GetInstance()

		if var_2.IsDefaultBGM(var_121_1) then
			pg = var_2
			var_121_2 = var_2.voice_bgm.NewMainScene.default_bgm
		else
			pg = var_2
			var_121_2 = var_2.voice_bgm.NewMainScene.bgm
		end
	end

	if arg_121_0.bgm ~= var_121_2 then
		arg_121_0.bgm = var_121_2
		pg = var_2

		local var_121_3 = var_2.BgmMgr.GetInstance()

		var_2.Push(var_121_3, arg_121_0.__cname, var_121_2)
	end
...
function var_0_1.gameStart(arg_124_0)
	...
	var_1_10001(var_1_10002(arg_124_0._tf, "sceneContainer/scene_front"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_124_0._tf, "sceneContainer/scene_background"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_124_0._tf, "sceneContainer/scene"), true)
...
function var_0_1.updateGameUI(arg_134_0)
	...
	var_1_10001(var_134_0, var_3.ceil(arg_134_0.gameTime))
...
function var_0_1.addScore(arg_135_0, arg_135_1)
	...
	var_1_10002(var_135_0, var_135_1 .. var_1_10005(arg_135_1))
...
function var_0_1.onGameOver(arg_136_0)
	...
	var_136_1(var_136_2, var_136_3, var_1_10004.Action(function()
...
function var_0_1.showSettlement(arg_138_0)
	...
	local var_138_0 = var_2(arg_138_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_138_1 = var_1_10001(var_138_0, var_3(var_4))
	...
	if var_138_3 then
		...
		var_5(var_6(arg_138_0.settlementUI, "ad/new"), var_138_6 < var_138_4)
...
function var_0_1.willExit(arg_142_0)
	if arg_142_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_142_0.handle)
	end
	...
	if arg_142_0._tf then
		...
		if var_142_0(var_1_10002(arg_142_0._tf)) then
			LeanTween = var_1
