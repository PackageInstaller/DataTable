...
function var_0_0.initSettlementUI(arg_10_0)
	...
	local var_10_1 = var_3(arg_10_0.settlementUI, "ad/btnOver")
	...
	var_1(var_10_0, var_10_1, var_10_2, var_5)
...
function var_0_0.initAdWindow(arg_12_0)
	...
	local var_12_1 = var_3(arg_12_0.adUI, "ad/bottom")
	...
	local function var_12_2()
		...
		var_13_2(var_13_1, var_2.CLOSE_AD_UI)
	...
	local function var_12_5()
		...
		var_14_2(var_14_1, var_2.CLOSE_AD_UI)
...
function var_0_0.loadMv(arg_17_0)
	...
	var_2.GetUI(var_17_1, var_17_0, true, function(arg_18_0)
		...
		local var_18_1 = var_2_10003(arg_17_0.mvGo, "video/cpk")

		typeof = var_4
		CriManaCpkUI = var_5
		var_18_0.mvManaCpkUI = var_2(var_18_1, var_4(var_5))
		...
		DEFAULT_BGMVOLUME = var_3

		local var_18_7

		if not var_18_5(var_18_6, var_3) then
			var_18_7 = 1
		end
...
function var_0_0.updateSettlementUI(arg_25_0)
	...
	local var_25_0 = var_1_10002(arg_25_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_25_1 = var_1_10001(var_25_0, var_3(var_4))
	...
	if 0 < var_25_5 then
		getProxy = var_25_5
		GameRoomProxy = var_25_6
		var_25_6 = var_25_5(var_25_6)
		var_25_5 = var_25_5.getRoomScore

		local var_25_7 = var_0_1.GetMiniGameData()

		var_25_3 = var_25_5(var_25_6, var_6.getConfig(var_25_7, "game_room"))
	else
		var_25_6 = var_0_1.GetMiniGameData()
		var_25_3 = var_25_5.GetRuntimeData(var_25_6, "elements") and #var_25_5 > 0 and var_25_5[1] or 0
	end

	setActive = var_25_5
	findTF = var_25_6

	var_25_5(var_25_6(arg_25_0.settlementUI, "ad/new"), var_25_3 < var_25_2)
	...
	if var_25_3 < var_25_2 then
		...
		var_25_5(var_25_8, var_6.STORE_SERVER, var_25_3)
	end
	...
	local var_25_10 = var_5(arg_25_0.settlementUI, "ad/currentText")
	...
	var_25_12(var_25_11, var_8.SUBMIT_GAME_SUCCESS, var_25_2)
...
function var_0_0.backPressed(arg_26_0)
	...
	if var_1_10001(arg_26_0.pauseUI) then
		...
		var_26_1(var_26_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_26_1
		...
		if var_26_1(arg_26_0.leaveUI) then
			...
			var_26_3(var_26_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_26_3
			...
			if not var_26_3(arg_26_0.pauseUI) then
				...
				if not var_1(arg_26_0.pauseUI) then
					...
					var_26_5(var_26_4, var_1_10003.PAUSE_GAME, true)
...
function var_0_0.updateGameUI(arg_30_0, arg_30_1)
	...
	var_1_10002(var_30_0, var_4.ceil(arg_30_1.gameTime))
