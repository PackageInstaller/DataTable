...
local var_0_0 = "GameRoomIceCreamView"
...
function var_0_1.initUI(arg_7_0)
	...
	local function var_7_12()
		...
		var_9_2.helps = var_3.getGameRoomData(var_9_3).game_help
...
local function var_0_19(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	...
	local function var_36_1(arg_37_0, arg_37_1)
		...
		for iter_37_0 = var_2_10002.max(#arg_37_1[1], 2), 1, -1 do
			...
			if arg_37_1[1][iter_37_0] then
				...
				var_37_0("ui/minigameui/icecreamgameui_atlas", var_0_15[arg_37_1[1][iter_37_0]], var_2_10006:Find("Scoop"), true)
				...
				if var_37_1 then
					...
					var_8("ui/minigameui/icecreamgameui_atlas", var_0_16[var_37_1], var_2_10006:Find("Topping"), true)
				end
			end
		end
	...
	function var_36_0.Ctor(arg_38_0)
		...
		local var_38_5 = "bubble_" .. #arg_36_2[1]
...
function var_0_1.showEndUI(arg_82_0)
	...
	local var_82_2 = var_2(var_3)
	local var_82_3 = var_2.getRoomScore(var_82_2, arg_82_0:getGameRoomData().id)

	setActive = var_82_2

	local var_82_4 = arg_82_0.endUI

	var_82_2(var_4.Find(var_82_4, "panel/now/Text/new"), var_82_3 < var_82_1)

	if var_82_3 <= var_82_1 then
		var_82_3 = var_82_1
	...
	local var_82_5 = arg_82_0.endUI
	local var_82_6 = var_3.Find(var_82_5, "panel/max/Text")
	local var_82_7 = arg_82_0.endUI
	local var_82_8 = var_4.Find(var_82_7, "panel/now/Text")

	setText = var_82_7

	var_82_7(var_82_6, var_82_3)

	setText = var_82_7

	var_82_7(var_82_8, var_82_1)
	arg_82_0:SendSuccess(var_82_1)
