...
function var_0_0.UpdateSettlementUI(arg_17_0)
	...
	local var_17_0 = var_1_10002(arg_17_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_17_1 = var_1_10001(var_17_0, var_3(var_4))
	...
	if 0 < var_17_6 then
		getProxy = var_17_6
		GameRoomProxy = var_17_7
		var_17_7 = var_17_6(var_17_7)
		var_17_6 = var_17_6.getRoomScore

		local var_17_8 = arg_17_0._gameVo

		var_17_4 = var_17_6(var_17_7, var_6.GetConfig(var_17_8, "game_room"))
	else
		getProxy = var_17_6
		MiniGameProxy = var_17_7
		var_17_7 = var_17_6(var_17_7)
		var_17_6 = var_17_6.GetHighScore

		local var_17_9 = arg_17_0._gameVo

		var_17_4 = var_17_6(var_17_7, var_6.GetGameId(var_17_9)) and #var_17_6 > 0 and var_17_6[1] or 0
	end

	setActive = var_17_6
	findTF = var_17_7

	var_17_6(var_17_7(arg_17_0.settlementUI, "ad/new"), var_17_4 < var_17_3)
	...
	if 0 < var_17_3 and var_17_4 < var_17_3 then
		...
		var_17_11(var_17_10, var_6.STORE_SERVER, {
			var_17_3,
			1
		})
	end
	...
	local var_17_13 = var_5(arg_17_0.settlementUI, "ad/currentText")
	...
	var_17_15(var_17_14, var_8.SUBMIT_GAME_SUCCESS, var_17_3)
...
function var_0_0.BackPressed(arg_18_0)
	...
	if var_1_10001(arg_18_0.pauseUI) then
		...
		var_18_1(var_18_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_18_1
		...
		if var_18_1(arg_18_0.leaveUI) then
			...
			var_18_3(var_18_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_18_3
			...
			if not var_18_3(arg_18_0.pauseUI) then
				...
				if not var_1(arg_18_0.pauseUI) then
					...
					if not var_1.IsSettlement(var_18_4) then
						...
						var_18_6(var_18_5, var_1_10003.PAUSE_GAME, true)
					end
...
function var_0_0.UpdateGameUI(arg_20_0, arg_20_1)
	...
	var_1_10002(var_20_0, var_4.ceil(arg_20_1.gameTime))
...
function var_0_0.ReadyStart(arg_21_0)
	...
	var_21_2(var_21_1, var_3.SFX_COUNT_DOWN)
