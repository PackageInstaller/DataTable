...
function var_0_1.PackData(arg_7_0)
	...
	if arg_7_0.getGameRoomData(var_7_2) then
		var_7_2 = arg_7_0
		arg_7_0.gameHelpTip = arg_7_0.getGameRoomData(var_7_2).game_help
	end
	...
	Vector2 = var_7_2
	var_7_3.screen = var_7_2(arg_7_0._tf.rect.width, arg_7_0._tf.rect.height)
	var_7_3.tip = arg_7_0.gameHelpTip
