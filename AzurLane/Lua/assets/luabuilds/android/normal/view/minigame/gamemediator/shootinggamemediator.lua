		...
		if var_1_3 == var_1_10005.CMD_COMPLETE then
			local var_1_4 = {
				...
				function(arg_3_0)
					...
					var_1.OnGetAwardDone(var_3_0, var_1_2)
					arg_3_0()
			...
			var_5.updateAfterFinish(var_1_5)

			local var_1_6 = arg_1_0.viewComponent

			var_5.showResultPanel(var_1_6, var_1_2.awards, function()
				...
				var_0.OnSendMiniGameOPDone(var_4_0, var_1_2)
