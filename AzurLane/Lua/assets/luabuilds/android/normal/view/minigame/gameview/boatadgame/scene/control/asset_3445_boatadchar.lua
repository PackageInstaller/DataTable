...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_1 = var_4(arg_1_0.imgTf, "char")

	typeof = var_5
	SpineAnimUI = var_6
	arg_1_0._charSpineAnim = var_3(var_1_1, var_5(var_6))
	findTF = var_3
	...
	typeof = var_5
	SpineAnimUI = var_6
	arg_1_0._yanwuAnimUI = var_3(var_1_2, var_5(var_6))
	findTF = var_3
	...
	typeof = var_5
	Animator = var_6
	arg_1_0._playerAnimator = var_3(var_1_3, var_5(var_6))
	findTF = var_3
	arg_1_0.battleEffectTf = var_3(arg_1_0._tf, "battleEffect")
	GetComponent = var_3
	findTF = var_4

	local var_1_4 = var_4(arg_1_0.battleEffectTf, "spine1")

	typeof = var_5
	SpineAnimUI = var_6
	arg_1_0.battleEffectSpine1 = var_3(var_1_4, var_5(var_6))
	GetComponent = var_3
	findTF = var_1_4
	...
	typeof = var_5
	SpineAnimUI = var_6
	arg_1_0.battleEffectSpine2 = var_3(var_1_5, var_5(var_6))
	findTF = var_3
...
function var_0_0.step(arg_7_0, arg_7_1)
	...
	if arg_7_0._battleHp > 0 then
		...
		if not (arg_7_0._battleHp > arg_7_0._battleSubHp) or not arg_7_0._battleSubHp then
			var_7_1 = arg_7_0._battleHp
		end
		...
		if arg_7_0.stepSound <= 0 then
			...
			local var_7_3 = var_4.CriMgr.GetInstance()

			var_4.PlaySoundEffect_V3(var_7_3, var_0_1.SFX_SOUND_BATTLE)
	...
	if arg_7_0:getLife() and arg_7_0._battleHp == 0 then
		...
		local var_7_5 = arg_7_0.getNextPosition(var_7_4, arg_7_0._directX, arg_7_0._directY)

		math = var_7_4

		if not (var_7_4.abs(var_7_5.x) > var_0_2.player_width / 2 + 50) then
			math = var_4

			if var_4.abs(var_7_5.y) > var_0_2.player_height / 2 + 50 then
				-- block empty
			else
				arg_7_0._tf.anchoredPosition = var_7_5
...
function var_0_0.updateCharMoveCount(arg_18_0)
	...
	ipairs = var_1_10004
	BoatAdGameConst = var_1_10005

	for iter_18_0, iter_18_1 in var_1_10004(var_1_10005.move_line_width) do
...
function var_0_0.getColliderData(arg_28_0)
	...
	if not arg_28_0._boundData then
		...
		math = var_4
		var_28_4.width = var_4.floor(var_28_3.x - var_28_1.x)
		math = var_4
...
function var_0_0.getBoundData(arg_34_0)
	...
	if not arg_34_0._boundData then
		...
		math = var_4
		var_34_4.width = var_4.floor(var_34_3.x - var_34_1.x)
		math = var_4
