...
function var_0_0.initLeavelUI(arg_5_0)
	...
	var_2(var_5_2, var_5_3, var_5_4, var_6)
	...
	var_2(var_5_5, var_5_6, var_5_7, var_6)
...
function var_0_0.initPauseUI(arg_8_0)
	...
	var_2(var_8_2, var_8_3, var_8_4, var_6)
...
function var_0_0.updateSettlementUI(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_0 = var_1_10005(arg_12_0.settlementUI, "ad")

	typeof = var_6
	Animator = var_7

	local var_12_1 = var_1_10004(var_12_0, var_6(var_7))
	...
	if var_12_2 then
		...
		var_12_7(var_9(arg_12_0.settlementUI, "ad/new"), var_12_5 < var_12_3)
		...
		if var_12_5 < var_12_3 then
			...
			BeachGuardGameView = var_10

			var_12_7(var_12_6, var_10.STORE_SERVER, var_12_5)
		end
		...
		if arg_12_0:getGameTimes(arg_12_2) and var_10 > 0 and not arg_12_0.sendSuccessFlag then
			...
			BeachGuardGameView = var_1_10013

			var_12_11(var_12_10, var_1_10013.SUBMIT_GAME_SUCCESS)
		end
