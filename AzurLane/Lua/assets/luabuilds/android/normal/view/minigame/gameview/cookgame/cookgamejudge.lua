...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5)
	...
	local var_1_0 = var_7(arg_1_0._tf, "mask/anim")

	typeof = var_8
	DftAniEvent = var_9
	arg_1_0.dftEvent = var_6(var_1_0, var_8(var_9))
	...
	typeof = var_8
	Animator = var_9
	arg_1_0.animator = var_6(var_1_2, var_8(var_9))
	onButton = var_6
	...
	local var_1_4 = var_8(arg_1_0._tf, "collider")
	...
	var_6(var_1_3, var_1_4, var_1_5, var_10)
...
function var_0_0.start(arg_5_0)
	...
	var_5_1(var_5_0, var_3.random(1, arg_5_0._gameData.cake_num))
...
function var_0_0.step(arg_6_0, arg_6_1)
	if arg_6_0.wantedCakeTime and arg_6_0.wantedCakeTime > 0 then
		...
		if arg_6_0.wantedCakeTime <= 0 then
			...
			var_6_1(var_6_0, var_1_10004.random(1, arg_6_0._gameData.cake_num))
		end
	end
...
function var_0_0.onAniEnd(arg_9_0)
	...
	if arg_9_0.freshWanted then
		...
		var_9_1(var_9_0, var_1_10003.random(1, arg_9_0._gameData.cake_num))
	end
...
function var_0_0.trigger(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	local var_12_2 = arg_12_0.animator

	var_6.SetBool(var_12_2, "AC", arg_12_3 or false)

	local var_12_3 = arg_12_0.animator

	var_6.SetBool(var_12_3, "right", arg_12_2 or false)

	local var_12_4 = arg_12_0.animator

	var_6.SetBool(var_12_4, "bk", arg_12_4 or false)

	local var_12_5 = arg_12_0.animator

	var_6.SetBool(var_12_5, "reject", arg_12_0._puzzleCamp and true or false)

	local var_12_6

	if arg_12_0._puzzleCamp and not arg_12_2 then
		var_12_6 = arg_12_0._puzzleCamp
		CookGameConst = var_12_5

		if var_12_6 == var_12_5.camp_player then
			Vector3 = var_12_6
			var_12_0 = var_12_6(-1, 1, 1)
		else
			Vector3 = var_12_6
			var_12_0 = var_12_6(1, 1, 1)
		end
	...
	findTF = var_12_6
	var_12_6(arg_12_0._tf, "mask").localScale = var_12_0

	local var_12_7 = arg_12_0.animator

	var_6.SetTrigger(var_12_7, "trigger")
...
function var_0_0.serve(arg_15_0)
	...
	var_15_14(var_15_13, var_16.SERVE_EVENT, {
...
function var_0_0.showCard(arg_17_0, arg_17_1)
	...
	var_1_10002(var_1_10003(arg_17_0.wantedTf, "Card"), arg_17_1)
...
function var_0_0.showCake(arg_23_0, arg_23_1)
	...
	for iter_23_0 = 1, arg_23_0._gameData.cake_num do
		...
		var_1_10006(var_1_10007(arg_23_0.wantedTf, "cake_" .. iter_23_0), not arg_23_0._puzzleTime and iter_23_0 == arg_23_1)
	end
...
function var_0_0.select(arg_28_0, arg_28_1)
	...
	var_1_10002(var_1_10003(arg_28_0._tf, "select"), arg_28_1)
