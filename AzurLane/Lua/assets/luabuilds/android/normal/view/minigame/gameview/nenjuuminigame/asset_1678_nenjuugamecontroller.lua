...
function var_0_0.InitGameUI(arg_5_0, arg_5_1)
	...
	arg_5_0.rtJoyStick = arg_5_1.Find(var_5_1, "Controller/bottom/joy_stick")
	...
	for iter_5_0, iter_5_1 in var_5_1({
		"right",
		"down",
		"left",
		"up"
	}) do
		local var_5_3 = arg_5_0.rtJoyStick
		local var_5_4 = var_8.Find(var_5_3, iter_5_1)
		local var_5_5 = var_8.GetComponent

		typeof = var_10
		EventTriggerListener = var_1_10011

		local var_5_6 = var_5_5(var_5_4, var_10(var_1_10011))

		var_8.AddPointDownFunc(var_5_6, function()
			arg_5_0.cacheInput = var_5_2[iter_5_0]

			return
		end)
		var_8:AddPointEnterFunc(function()
			if arg_5_0.cacheInput and arg_5_0.cacheInput ~= var_5_2[iter_5_0] then
				arg_5_0.cacheInput = var_5_2[iter_5_0]
			end
	...
	for iter_5_2 = 0, 3 do
		local var_5_7 = "Skill_" .. iter_5_2
		local var_5_8 = arg_5_0.rtSkillButton
		local var_5_9 = var_8.Find(var_5_8, var_5_7)
		local var_5_10 = var_8.GetComponent

		typeof = var_10
		EventTriggerListener = var_1_10011

		local var_5_11 = var_5_10(var_5_9, var_10(var_1_10011))

		var_8.AddPointDownFunc(var_5_11, function()
			arg_5_0.inPress[var_5_7] = true

			return
		end)
		var_8:AddPointUpFunc(function()
			arg_5_0.inPress[var_5_7] = false
...
function var_0_0.AddDebugInput(arg_12_0)
	...
	if var_1_10001 then
		...
		for iter_12_0, iter_12_1 in var_1_10003(var_12_1) do
			...
			if var_1_10008(var_1_10009[iter_12_1]) then
			...
			if var_1_10008(var_1_10009[iter_12_1]) and arg_12_0.cacheInput == var_12_0[iter_12_0] then
...
function var_0_0.InitMapConfig(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_4.MiniGameTileMgr.GetInstance()

	for iter_13_0, iter_13_1 in var_3(var_4.getDataLayers(var_13_1, "Spring23Game", "Spring23Level_" .. arg_13_1.index)) do
	...
	local var_13_5 = iter_13_1.floor(arg_13_0.timeCount / 60)

	math = var_8

	var_3(var_13_2, var_13_3(var_13_4, var_13_5, var_8.floor(arg_13_0.timeCount % 60)))
	...
	local var_13_8 = var_13_4.max(var_13_7.width + 192 - var_13_6.width, 0)

	math = var_7
	arg_13_0.buffer = var_5(var_13_8, var_7.max(var_13_7.height + 160 - var_13_6.height, 0)) * 0.5
	ipairs = var_5

	for iter_13_2, iter_13_3 in var_5(var_13_0.floor.layer) do
		NewPos = var_1_10010
		var_1_10011 = (iter_13_3.index - 1) % arg_13_0.mapSize.x
		math = var_12
		var_1_10010 = var_1_10010(var_1_10011, var_12.floor((iter_13_3.index - 1) / arg_13_0.mapSize.x))
		var_1_10011 = arg_13_0.plane
		tostring = var_12
		var_1_10011[var_12(var_1_10010)] = iter_13_3.item
	end
	...
	for iter_13_4 = 0, arg_13_0.mapSize.y - 1 do
		for iter_13_5 = 0, arg_13_0.mapSize.x - 1 do
			...
			local var_13_11 = arg_13_0.rtResource
			local var_13_15

			if not var_15.Find(var_13_11, "plane/" .. var_13_10) then
				cloneTplTo = var_13_11

				local var_13_12 = arg_13_0.rtResource
				local var_13_13 = var_17.Find(var_13_12, "plane/Road")
				local var_13_14 = arg_13_0.rtMainContent

				var_13_15 = var_13_11(var_13_13, var_18.Find(var_13_14, "plane"))
				setImageSprite = var_13_11

				local var_13_16 = var_13_15
				local var_13_17 = var_13_15.Find(var_13_16, "scale/Image")

				getImageSprite = var_13_16

				local var_13_18 = arg_13_0.rtResource

				var_13_11(var_13_17, var_13_16(var_19.Find(var_13_18, "plane_sprite/" .. var_13_10)))
			else
				cloneTplTo = var_13_11

				local var_13_19 = var_13_15
				local var_13_20 = arg_13_0.rtMainContent

				var_13_15 = var_13_11(var_13_19, var_18.Find(var_13_20, "plane"))
			end

			if var_13_15:Find("scale/Snow") then
				local function var_13_21(arg_15_0, arg_15_1)
					local var_15_0 = arg_13_0
					local var_15_1 = var_2.InRange

					NewPos = var_2_10004

					return not var_15_1(var_15_0, var_2_10004(arg_15_0, arg_15_1)) or not arg_13_0.plane[arg_15_0 .. "_" .. arg_15_1] or arg_13_0.plane[arg_15_0 .. "_" .. arg_15_1] == "Snow"
				end

				for iter_13_6 = -1, 1 do
					for iter_13_7 = -1, 1 do
						if var_13_21(iter_13_5 + iter_13_6, iter_13_4 + iter_13_7) and (iter_13_6 == 0 or iter_13_7 == 0 or not var_13_21(iter_13_5, iter_13_4 + iter_13_7) and not var_13_21(iter_13_5 + iter_13_6, iter_13_4)) then
							setActive = var_25

							var_25(var_13_15:Find("scale/Snow/" .. var_13_9[iter_13_6 .. "_" .. iter_13_7]), true)
						end
					end
				end
			end
	...
	for iter_13_8, iter_13_9 in var_6(var_13_0.item.layer) do
		...
		local var_13_22 = (iter_13_9.index - 1) % arg_13_0.mapSize.x

		math = var_13
		var_1_10011 = var_1_10011(var_13_22, var_13.floor((iter_13_9.index - 1) / arg_13_0.mapSize.x))

		local var_13_23 = arg_13_0:CreateTarget({
			name = iter_13_9.item,
			pos = var_1_10011
		})
	end
	...
	for iter_13_10, iter_13_11 in var_6(var_13_0.character.layer) do
		...
		local var_13_24 = (iter_13_11.index - 1) % arg_13_0.mapSize.x

		math = var_13
		var_1_10011 = var_1_10011(var_13_24, var_13.floor((iter_13_11.index - 1) / arg_13_0.mapSize.x))
		...
		var_13(var_13_25.name, {
			FuShun = function()
				var_13_25.level = arg_13_1.FuShun.level
				var_13_25.itemType = arg_13_1.FuShun.item

				local var_16_0 = arg_13_0
				local var_16_1 = arg_13_0

				var_16_0.moveFuShun = var_1.CreateTarget(var_16_1, var_13_25)

				return
			end,
			Nenjuu = function()
				var_13_25.abilitys = arg_13_1.Nenjuu

				local var_17_0 = arg_13_0
				local var_17_1 = arg_13_0

				var_17_0.moveNenjuu = var_1.CreateTarget(var_17_1, var_13_25)
	...
	if arg_18_0.wave < #arg_18_0.config.wave then
		...
		for iter_18_0 = 0, arg_18_0.mapSize.x - 1 do
			for iter_18_1 = 0, arg_18_0.mapSize.y - 1 do
				...
				if arg_18_0.Moveable(var_18_4, var_1_10013, true) then
					local var_18_5 = arg_18_0.hideMap

					tostring = var_18_4

					if not var_18_5[var_18_4(var_1_10013)] then
						table = var_14
		...
		for iter_18_2 = 1, arg_18_0.itemCount do
			...
			repeat
				math = var_1_10010
				var_18_6 = var_1_10010.random(#var_18_3)
				var_1_10010 = 0

				for iter_18_3 = -1, 1 do
					for iter_18_4 = -1, 1 do
						local var_18_7 = var_18_3[var_18_6]

						NewPos = var_1_10020

						local var_18_8 = var_18_7 + var_1_10020(iter_18_3, iter_18_4)

						if arg_18_0:InRange(var_18_8) then
							underscore = var_1_10020
							var_1_10020 = var_1_10020.any

							local var_18_9 = arg_18_0.map

							tostring = var_22

							if var_1_10020(var_18_9[var_22(var_18_8)], function(arg_19_0)
			...
			table = var_1_10010
			var_1_10010 = var_1_10010.remove(var_18_3, var_18_6)
...
function var_0_0.Moveable(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	if not arg_22_0:InRange(arg_22_1) then
		...
		return var_22_0(var_22_1[var_6(arg_22_1)], function(arg_23_0)
			local var_23_1
			...
			if not arg_23_0:Moveable() and (not arg_22_2 or not arg_23_0:BreakMoveable()) and arg_22_3 then
				...
				NenjuuGameNameSpace = var_2_10003
				var_23_1 = var_23_1(var_23_0, var_2_10003.TargetMove)
			end
...
function var_0_0.CreateTarget(arg_24_0, arg_24_1)
	...
	if arg_24_1.parent then
		...
		var_24_3 = var_6(var_7.Find(var_24_4, var_24_1), arg_24_1.parent)
	else
		cloneTplTo = var_6

		local var_24_5 = arg_24_0.rtResource
		local var_24_6 = var_7.Find(var_24_5, var_24_1)
		local var_24_7 = arg_24_0.rtMainContent

		var_24_3 = var_6(var_24_6, var_8.Find(var_24_7, var_24_2))
	end
...
function var_0_0.DestoryTarget(arg_25_0, arg_25_1)
	...
	var_25_0(var_25_1[var_1_10004(arg_25_1.pos)], arg_25_1)
...
function var_0_0.ResetGame(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10001({
		...
		var_1_10006(var_7.Find(var_26_0, iter_26_1), function(arg_27_0)
			Destroy = var_2_10001
...
function var_0_0.OnTimer(arg_34_0, arg_34_1)
	...
	local var_34_1 = var_1_10004.format
	local var_34_2 = "%02d:%02ds"

	math = var_1_10006

	local var_34_3 = var_1_10006.floor(arg_34_0.timeCount / 60)

	math = var_7

	var_2(var_34_0, var_34_1(var_34_2, var_34_3, var_7.floor(arg_34_0.timeCount % 60)))
...
function var_0_0.UpdateSkillButtons(arg_36_0)
	...
	for iter_36_0, iter_36_1 in var_1_10001(var_2.CalcSkillCDs(var_36_0)) do
		local var_36_1 = arg_36_0.rtSkillButton
		local var_36_2 = var_6.Find(var_36_1, "Skill_" .. iter_36_0 - 1)

		eachChild = var_36_1

		var_36_1(var_36_2:Find("icon"), function(arg_37_0)
			setActive = var_2_10001
		...
		if not iter_36_1.cd then
			...
			var_7(var_36_2:Find("cd"), false)

			setActive = var_7

			var_7(var_36_2:Find("lock"), true)
		elseif iter_36_1.cd == true then
			setActive = var_7

			var_7(var_36_2:Find("cd"), true)

			setFillAmount = var_7

			var_7(var_36_2:Find("cd"), 1)

			setText = var_7

			var_7(var_36_2:Find("cd/Text"), "")

			setActive = var_7

			var_7(var_36_2:Find("lock"), false)
		elseif iter_36_1.cd > 0 then
			...
			var_7(var_36_2:Find("cd"), iter_36_1.rate)

			setText = var_7

			local var_36_3 = var_36_2
			local var_36_4 = var_36_2.Find(var_36_3, "cd/Text")

			math = var_36_3

			var_7(var_36_4, var_36_3.ceil(iter_36_1.cd) .. "s")
...
function var_0_0.UpdateTargetPos(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	for iter_40_0 = 0, var_40_0.x - 1 do
		for iter_40_1 = 0, var_40_0.y - 1 do
			...
			if arg_40_2 then
				table = var_40_1
				var_40_1 = var_40_1.removebyvalue

				local var_40_2 = arg_40_0.map

				tostring = var_1_10016

				var_40_1(var_40_2[var_1_10016(arg_40_2 + var_1_10013)], arg_40_1)
			end

			table = var_40_1

			local var_40_3 = var_40_1.insert
			local var_40_4 = arg_40_0.map

			tostring = var_1_10016

			var_40_3(var_40_4[var_1_10016(arg_40_3 + var_1_10013)], arg_40_1)
		end
	end
	...
	if arg_40_1.canHide then
		for iter_40_2 = 0, var_40_0.x - 1 do
			...
			if arg_40_0.InRange(var_40_5, var_1_10009) then
				local var_40_6 = arg_40_0.hideMap

				tostring = var_40_5
				var_40_6[var_40_5(var_1_10009)] = true
			end
		end
	end
...
function var_0_0.WindowFocrus(arg_41_0, arg_41_1)
	...
	math = var_1_10005
	var_41_1.x = var_1_10005.clamp(-arg_41_1.x, -arg_41_0.buffer.x, arg_41_0.buffer.x)
	math = var_5
	var_41_1.y = var_5.clamp(-arg_41_1.y, -arg_41_0.buffer.y - 16, arg_41_0.buffer.y - 16)
...
function var_0_0.CheckIce(arg_42_0, arg_42_1)
	if not arg_42_0:InRange(arg_42_1) then
		...
		return var_42_0(var_42_1[var_4(arg_42_1)], function(arg_43_0)
...
function var_0_0.CheckMelt(arg_51_0, arg_51_1)
	...
	return var_51_0(var_51_1[var_1_10004(arg_51_1)], "_")[2] == "warm"
end
...
function var_0_0.ScareEnemy(arg_52_0, arg_52_1)
	...
	for iter_52_0, iter_52_1 in var_1_10002({
		...
		if var_52_1 + var_9.abs(var_52_0.y) <= arg_52_1.range then
			iter_52_1:BeScare()
		end
	end
...
function var_0_0.GetWayfindingMap(arg_57_0, arg_57_1, arg_57_2)
	...
	if arg_57_2 then
		...
		if arg_57_0.InRange(var_57_2, var_57_3) then
			table = var_5
	...
	while var_57_5 < #var_57_0 do
		...
		for iter_57_0, iter_57_1 in var_9(var_0_4) do
			NewPos = var_1_10014
			unpack = var_1_10015

			if var_57_6 + var_1_10014(var_1_10015(iter_57_1)) ~= arg_57_1 then
				var_1_10016 = arg_57_0

				if arg_57_0.Moveable(var_1_10016, var_1_10014, not arg_57_2) then
	...
	if arg_57_0.moveFuShun.inLantern then
		...
		for iter_57_2 = -var_7.LANTERN_RANGE, var_7 do
			for iter_57_3 = -var_7, var_7 do
				...
				if var_57_4[var_1_10016(var_57_8 + var_1_10018(iter_57_2, iter_57_3))] then
...
function var_0_0.GetTeleportTargetPos(arg_58_0, arg_58_1, arg_58_2)
	...
	for iter_58_0, iter_58_1 in var_1_10006(arg_58_1) do
		...
		local var_58_6 = var_15.abs(var_58_3.x)

		math = var_16
		var_58_5.mDis = var_58_6 + var_16.abs(var_58_3.y)
...
function var_0_0.StealthCheck(arg_61_0, arg_61_1)
	...
	return var_61_1 + var_4.abs(var_61_0.y) < 10
end
...
function var_0_0.InBlackHoleRange(arg_65_0, arg_65_1, arg_65_2)
	if arg_65_2 then
		if arg_65_0:InRange(arg_65_1) then
			...
			tostring = var_5
			var_1_10003 = var_1_10003(var_65_0[var_5(arg_65_1)], function(arg_66_0)
		...
		for iter_65_0 = -var_1_10003.BLACK_HOLE_RANGE, var_3 do
			for iter_65_1 = -var_3, var_3 do
				...
				if arg_65_0:InRange(var_1_10012) then
					...
					if var_65_1(var_65_2[var_15(var_1_10012)], function(arg_67_0)
...
function var_0_0.EatItem(arg_69_0, arg_69_1)
	...
	for iter_69_0, iter_69_1 in var_1_10002(var_69_0[var_1_10004(arg_69_1)]) do
		local var_69_1 = iter_69_1.class

		NenjuuGameNameSpace = var_1_10008

		if var_69_1 == var_1_10008.TargetItem then
			var_1_10008 = arg_69_0

			arg_69_0.DestoryTarget(var_1_10008, iter_69_1)
			...
			var_1_10008 = arg_69_0.moveFuShun

			var_7.PopPoint(var_1_10008, iter_69_1.point * arg_69_0.pointRate)

			if arg_69_0.itemCount == 0 then
				var_1_10008 = arg_69_0

				arg_69_0.CheckWave(var_1_10008)
			end
		end
	end
