...
function var_0_1.initUI(arg_91_0)
	...
	local function var_91_18()
		...
		local var_95_2 = var_95_0.MsgboxMgr.GetInstance()
		local var_95_3 = var_1.ShowMsgBox
		local var_95_4 = {}

		MSGBOX_TYPE_HELP = var_2_10004
		var_95_4.type = var_2_10004

		local var_95_5 = arg_91_0

		var_95_4.helps = var_4.getGameRoomData(var_95_5).game_help
	...
	local var_91_37 = arg_91_0._tf

	arg_91_0.countUI = var_2.Find(var_91_37, "ui/count_ui")
	GetComponent = var_2

	local var_91_38 = arg_91_0.countUI
	local var_91_39 = var_3.Find(var_91_38, "count")

	typeof = var_91_38
	Animator = var_5
	arg_91_0.countAnimator = var_2(var_91_39, var_91_38(var_5))
	GetOrAddComponent = var_2

	local var_91_40 = arg_91_0.countUI
	local var_91_41 = var_3.Find(var_91_40, "count")

	typeof = var_91_40
	DftAniEvent = var_5
	arg_91_0.countDft = var_2(var_91_41, var_91_40(var_5))

	local var_91_42 = arg_91_0.countDft

	var_2.SetTriggerEvent(var_91_42, function()
		return
	end)

	local var_91_43 = arg_91_0.countDft

	var_2.SetEndEvent(var_91_43, function()
	...
	local var_91_44 = arg_91_0._tf

	arg_91_0.pauseUI = var_2.Find(var_91_44, "ui/pause_ui")
	onButton = var_2

	local var_91_45 = arg_91_0
	local var_91_46 = arg_91_0.pauseUI
	local var_91_47 = var_4.Find(var_91_46, "ad/panel/sure_btn")

	local function var_91_48()
		setActive = var_2_10000
	...
	var_2(var_91_45, var_91_47, var_91_48, var_6)

	local var_91_49 = arg_91_0._tf

	arg_91_0.returnUI = var_2.Find(var_91_49, "ui/return_ui")
	onButton = var_2

	local var_91_50 = arg_91_0
	local var_91_51 = arg_91_0.returnUI
	local var_91_52 = var_4.Find(var_91_51, "ad/panel/sure_btn")
	...
	var_2(var_91_50, var_91_52, var_91_53, var_6)

	onButton = var_2

	local var_91_54 = arg_91_0
	local var_91_55 = arg_91_0.returnUI
	local var_91_56 = var_4.Find(var_91_55, "ad/panel/cancel_btn")

	local function var_91_57()
		setActive = var_2_10000
	...
	var_2(var_91_54, var_91_56, var_91_57, var_6)

	local var_91_58 = arg_91_0._tf

	arg_91_0.endUI = var_2.Find(var_91_58, "ui/end_ui")
	onButton = var_2

	local var_91_59 = arg_91_0
	local var_91_60 = arg_91_0.endUI
	local var_91_61 = var_4.Find(var_91_60, "ad/panel/end_btn")

	local function var_91_62()
		setActive = var_2_10000
	...
	var_2(var_91_59, var_91_61, var_91_62, var_6)
...
function var_0_1.initGameUI(arg_106_0)
	...
	var_1(var_106_3, var_3.Find(var_106_4, "pause_btn"), function()
	...
	var_1(var_106_5, var_3.Find(var_106_6, "return_btn"), function()
	...
	var_1(var_2.Find(var_106_8, "bg_front/wall"), var_0_40)
...
function var_0_1.initController(arg_109_0)
	...
	arg_109_0.player = var_109_2(var_2.Find(var_109_3, "player"), arg_109_0)
	...
	arg_109_0.ofunya = var_109_7(var_2.Find(var_109_8, "bg_back/07_Ofunya"), arg_109_0)

	local var_109_9 = var_0_52
	local var_109_10 = arg_109_0._tf

	arg_109_0.manjuu = var_109_9(var_2.Find(var_109_10, "bg_back/08_Manjuu"), arg_109_0)

	local var_109_11 = var_0_54
	local var_109_12 = arg_109_0.scene

	arg_109_0.walker = var_109_11(var_2.Find(var_109_12, "obstacle/walker"), arg_109_0)
	...
	typeof = var_3
	CanvasGroup = var_4
	arg_109_0.obsCanvas = var_1(var_109_14, var_3(var_4))
...
function var_0_1.staticObsStart(arg_115_0)
	...
	if var_1.random() <= var_0_38.walker.appear then
		...
		var_115_2(var_115_1, var_5(var_0_39.walker, var_0_39.walker))

		var_115_2 = var_2.path
		math = var_115_1
		var_115_2 = var_115_2[var_115_1.random(1, #var_2.path)]
	...
	for iter_115_2, iter_115_3 in var_115_2(var_0_38.oil) do
		...
		if var_1_10008.random() <= iter_115_3.appear then
			for iter_115_4 = 1, iter_115_3.num do
				...
				local var_115_7 = arg_115_0.obsTpl

				var_1_10013 = var_1_10013(var_14.Find(var_115_7, "oil_Tpl"), arg_115_0.oilGroups, "oil")
				setActive = var_14
				...
				local var_115_8 = var_14.random(1, #arg_115_0.grids)
				...
				var_15(var_115_9, var_1_10017(arg_115_0.grids[var_115_8].x, arg_115_0.grids[var_115_8].y))
				...
				var_15(var_115_10, var_1_10017(var_0_39.oil, var_0_39.oil))

				table = var_15

				var_15.remove(arg_115_0.grids, var_115_8)
			end
		end
	end
	...
	for iter_115_5, iter_115_6 in var_3(var_0_38.cube) do
		...
		if var_1_10008.random() <= iter_115_6.appear then
			for iter_115_7 = 1, iter_115_6.num do
				...
				var_1_10013 = var_1_10013(var_14.Find(var_115_11, "cube_Tpl"), arg_115_0.cubeGroups, "cube")
				setActive = var_14
				...
				local var_115_12 = var_14.random(1, #arg_115_0.grids)
				...
				var_15(var_115_13, var_1_10017(arg_115_0.grids[var_115_12].x, arg_115_0.grids[var_115_12].y))

				setLocalScale = var_15

				local var_115_14 = var_1_10013

				Vector2 = var_1_10017

				var_15(var_115_14, var_1_10017(var_0_39.cube, var_0_39.cube))

				table = var_15

				var_15.remove(arg_115_0.grids, var_115_12)
			end
		end
	end
	...
	for iter_115_8, iter_115_9 in var_3(var_0_38.miner) do
		...
		if var_1_10008.random() <= iter_115_9.appear then
			for iter_115_10 = 1, iter_115_9.num do
				...
				local var_115_15 = arg_115_0.obsTpl

				var_1_10013 = var_1_10013(var_14.Find(var_115_15, "miner_Tpl"), arg_115_0.minerGroups, "miner")
				setActive = var_14

				var_14(var_1_10013, true)

				local var_115_16 = var_0_53(var_1_10013, arg_115_0)

				table = var_15

				var_15.insert(arg_115_0.minerControls, var_115_16)

				math = var_15

				local var_115_17 = var_15.random(1, #arg_115_0.grids)

				setLocalPosition = var_16

				local var_115_18 = var_1_10013

				Vector2 = var_1_10018

				var_16(var_115_18, var_1_10018(arg_115_0.grids[var_115_17].x, arg_115_0.grids[var_115_17].y))

				setLocalScale = var_16

				local var_115_19 = var_1_10013

				Vector2 = var_1_10018

				var_16(var_115_19, var_1_10018(var_0_39.miner, var_0_39.miner))

				table = var_16

				var_16.remove(arg_115_0.grids, var_115_17)
			end
		end
	end
...
function var_0_1.obsFadeOut(arg_117_0)
	...
	local var_117_2 = var_1_10003.value
	...
	local var_117_4 = var_117_1(var_117_0, var_117_2, var_117_3, var_1_10005(arg_117_0.obsTF), 1, 0, 0.5)
...
function var_0_1.addScore(arg_127_0, arg_127_1, arg_127_2)
	...
	local var_127_1 = var_1_10003(var_4.Find(var_127_0, "score_tf"), arg_127_0.scoreGroup)

	if arg_127_2 then
		setLocalPosition = var_4

		var_4(var_127_1, arg_127_2)
	else
		setLocalPosition = var_4
		...
		var_4(var_127_2, var_6(432, 144))
	end

	setActive = var_4

	var_4(var_127_1, false)

	setActive = var_4

	var_4(var_127_1, true)

	setText = var_4

	var_4(var_127_1, "+" .. arg_127_1)
...
function var_0_1.endGame(arg_131_0)
	...
	var_131_1(var_131_0, var_3.delayedCall, function()
...
function var_0_1.showEndUI(arg_133_0)
	...
	local var_133_1 = var_2(var_3)
	local var_133_2 = var_2.GetHighScore
	local var_133_3 = arg_133_0
	local var_133_4

	if not var_133_2(var_133_1, arg_133_0.GetMGData(var_133_3).id) or not (#var_2 > 0) or not var_2[1] then
		var_133_4 = 0
	end

	if var_2 then
		local var_133_5 = #var_2

		if not (1 < var_133_5) or not var_2[2] then
			local var_133_6 = 0
		end

		setActive = var_133_3

		local var_133_7 = arg_133_0.endUI

		var_133_3(var_6.Find(var_133_7, "ad/panel/cur_score/new"), var_133_4 < var_133_0)

		if var_133_4 <= var_133_0 then
			var_133_4 = var_133_0
		...
		local var_133_9 = var_5.Find(var_133_8, "ad/panel/highest_score")
		local var_133_10 = arg_133_0.endUI
		local var_133_11 = var_6.Find(var_133_10, "ad/panel/cur_score")

		setText = var_133_10

		var_133_10(var_133_9, var_133_4)

		setText = var_133_10

		var_133_10(var_133_11, var_133_0)
...
function var_0_1.CoordinateGrid(arg_134_0, arg_134_1)
	...
	local var_134_3 = var_1_10005(arg_134_1.anchoredPosition.x - var_134_1 / 2, arg_134_1.anchoredPosition.y - var_134_2 / 2)

	math = var_6

	local var_134_4 = var_6.modf(var_134_2 / var_134_0.y)
	...
	for iter_134_0 = 1, var_134_6 do
		for iter_134_1 = 1, var_134_4 do
			...
			var_134_10(var_134_11, var_1_10022(var_134_8, var_134_9))
		end
	end
