...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	for iter_1_0 = var_1_0, #var_1_10006.monster_data do
		...
		var_1_10009(var_1_1, var_1_10011(var_1_10012.monster_data[iter_1_0]))
	end
...
function var_0_0.removeOutMonster(arg_5_0)
	for iter_5_0 = #arg_5_0.monsters, 1, -1 do
		...
		if var_5_0 <= var_1_10007.abs(arg_5_0._sceneTf.anchoredPosition.x) - 0 then
			...
			local var_5_1 = arg_5_0.returnMonsterToPool

			table = var_8

			var_5_1(var_1_10007, var_8.remove(arg_5_0.monsters, iter_5_0))
		end
	end
...
function var_0_0.getOrCreateMonster(arg_7_0, arg_7_1)
	...
	if var_7_1 then
		...
		local var_7_3 = var_5(var_6(iter_7_1(arg_7_0._tpl, var_7_2)))
		...
		FuShunMonsterScript = var_9

		var_7_5(var_7_4, var_9.New())
		...
		local var_7_8 = var_7_6.random

		Fushun3GameConst = var_9

		local var_7_9 = var_9.monster_speed[1]

		Fushun3GameConst = var_1_10010
		var_7_7.moveSpeed = var_7_8(var_7_9, var_1_10010.monster_speed[2])
		GetComponent = var_7_7
		findTF = var_8

		local var_7_10 = var_8(var_7_3, "anim")

		typeof = var_9
		Animator = var_10

		local var_7_11 = var_7_7(var_7_10, var_9(var_10))

		setParent = var_7_10

		var_7_10(var_7_3, arg_7_0._parent)

		GetComponent = var_7_10
		findTF = var_9

		local var_7_12 = var_9(var_7_3, "collider")

		typeof = var_10
		BoxCollider2D = var_11

		local var_7_13 = var_7_10(var_7_12, var_10(var_11))

		findTF = var_7_12

		local var_7_14 = var_7_12(var_7_3, "collider").gameObject

		LayerMask = var_10
		var_7_14.layer = var_10.NameToLayer("Character")
		findTF = var_7_14
		...
		local var_7_17 = var_10(var_7_3, "anim")

		typeof = var_11
		DftAniEvent = var_12

		local var_7_18 = var_9(var_7_17, var_11(var_12))
	...
	for iter_11_0 = #arg_11_0.monsters, 1, -1 do
		if arg_11_0.monsters[iter_11_0].tf == arg_11_1 then
			if not arg_11_0.monsters[iter_11_0].damage then
				...
				var_11_5(var_11_4, var_1_10011.add_monster_score_call)
...
function var_0_0.removeMonster(arg_12_0, arg_12_1)
	for iter_12_0 = 1, #arg_12_0.monsters do
		if arg_12_0.monsters[iter_12_0] == arg_12_1 then
			...
			var_12_1(var_12_0, var_1_10008.remove(arg_12_0.monsters, iter_12_0))
...
function var_0_0.clearMonster(arg_14_0)
	for iter_14_0 = #arg_14_0.monsters, 1, -1 do
		...
		var_14_1(var_14_0, var_1_10007.remove(arg_14_0.monsters, iter_14_0))
	end
