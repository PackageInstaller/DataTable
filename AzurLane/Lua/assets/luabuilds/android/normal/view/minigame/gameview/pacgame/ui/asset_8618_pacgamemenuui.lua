...
function var_0_0.initUI(arg_2_0)
	...
	local var_2_10 = var_2(arg_2_0.btnRule, "text")

	i18n = var_3

	var_1(var_2_10, var_3("pac_game_rule_btn"))
	...
	local var_2_14 = var_2(arg_2_0.btnStart, "text")

	i18n = var_3

	var_1(var_2_14, var_3("pac_game_start_btn"))
	...
	for iter_2_0 = 1, 7 do
		...
		local var_2_27 = var_1_10007

		findTF = var_1_10010

		var_1_10008(var_2_27, var_1_10010(arg_2_0.menuUI, "battList/Viewport/Content"))
		...
		var_2_27(var_1_10010, var_11("which_day_2", var_1_10008))

		findTF = var_2_27

		local var_2_28 = var_2_27(var_1_10007, "ad/iconMask/icon")
		...
		var_11(var_2_28, var_1_10010)

		onButton = var_11

		local var_2_29 = arg_2_0._event
		local var_2_30 = var_2_28
		...
		local function var_2_31()
			...
			var_10_1(var_10_0, var_2_10002.ON_DROP, var_1_10010)
		...
		var_11(var_2_29, var_2_30, var_2_31, var_1_10015)
	...
	local var_2_32 = var_3(arg_2_0.menuUI, "editor")

	PacGameConst = var_4

	var_2(var_2_32, var_4.editor_mode and true or false)
	...
	if var_2.editor_mode then
		...
		local var_2_33 = arg_2_0._event

		findTF = var_4

		var_2(var_2_33, var_4(arg_2_0.menuUI, "editor"), function()
			local var_11_0 = arg_2_0._event
			local var_11_1 = var_0.emit

			SimpleMGEvent = var_2_10002

			var_11_1(var_11_0, var_2_10002.READY_START, {
				editor = true
			})
...
function var_0_0.Update(arg_14_0)
	...
	for iter_14_0 = 1, 7 do
		...
		local var_14_4 = var_8(arg_14_0.battleItems[iter_14_0], "ad/got")
		...
		var_1_10009(var_14_4, false)

		if iter_14_0 <= var_14_1 then
			setActive = var_1_10009

			var_1_10009(var_14_4, true)
	...
	local var_14_5 = 1 - (var_14_1 - 3 < 0 and 0 or var_14_1 - 3) / (arg_14_0.totalTimes - 4)
	...
	var_5(arg_14_0.battleScrollRect, 0, var_14_5)

	getProxy = var_5
	MiniGameProxy = var_6

	local var_14_6 = var_5(var_6)
	local var_14_7 = var_5.GetHighScore
	local var_14_8 = arg_14_0._gameVo

	if var_14_7(var_14_6, var_7.GetGameId(var_14_8)) then
		local var_14_9 = #var_5
		local var_14_10

		if not (0 < var_14_9) or not var_5[1] then
			var_14_10 = 0
		end

		setText = var_7

		local var_14_11 = arg_14_0.highScore

		i18n = var_1_10009

		var_7(var_14_11, var_1_10009("pac_game_high_score_tip", var_14_10))
...
function var_0_0.CheckGet(arg_15_0)
	...
	var_1_10001(var_1_10002(arg_15_0.menuUI, "got"), false)
	...
	if var_1.GetUltimate(var_15_0) and var_1 ~= 0 then
		...
		var_15_0(var_3(arg_15_0.menuUI, "got"), true)
	end

	if var_1 == 0 then
		local var_15_1 = arg_15_0._gameVo
		local var_15_2 = var_2.GetTotalTimes(var_15_1)
		local var_15_3 = arg_15_0

		if var_15_2 > arg_15_0.getGameUsedTimes(var_15_3) then
			return
		end
		...
		local var_15_5 = var_4.sendNotification

		GAME = var_1_10006

		local var_15_6 = var_1_10006.SEND_MINI_GAME_OP
		local var_15_7 = {}
		local var_15_8 = arg_15_0._gameVo

		var_15_7.hubid = var_8.GetHubId(var_15_8)
		MiniGameOPCommand = var_8
		var_15_7.cmd = var_8.CMD_ULTIMATE
		var_15_7.args1 = {}
