...
function var_0_1.handleNotification(arg_2_0, arg_2_1)
	...
	if var_2_0 == var_2_1.ACTIVITY_UPDATED then
		...
		if var_2_0 == var_4.ACTIVITY_SHOW_AWARDS then
			local var_2_4 = arg_2_0.viewComponent

			var_2_5 = var_2_5.emit
			BaseUI = var_1_10006

			var_2_5(var_2_4, var_1_10006.ON_ACHIEVE, var_2_2.awards, var_2_2.callback)
		else
			GAME = var_2_5

			if var_2_0 == var_2_5.BEGIN_STAGE_DONE then
				local var_2_6 = arg_2_0
				local var_2_7 = arg_2_0.sendNotification

				GAME = var_1_10006

				local var_2_8 = var_1_10006.GO_SCENE

				SCENE = var_1_10007

				var_2_7(var_2_6, var_2_8, var_1_10007.COMBATLOAD, var_2_2)
			end
		end
	end
