...
function var_0_1.OnGetAwardDone(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_1_10003.CMD_COMPLETE then
		...
		if arg_4_0.GetMGHubData(var_4_1).ultimate == 0 then
			...
			if var_4_1 >= var_2.getConfig(var_4_2, "reward_need") then
				...
				var_4_5.cmd = var_7.CMD_ULTIMATE
				var_4_5.args1 = {}
...
function var_0_1.OnSendMiniGameOPDone(arg_5_0)
	...
	local var_5_3 = var_5_2(var_5_1, var_1_10003.ShrineGameID)
	local var_5_4
	...
	local var_5_8 = var_1_10006.MODIFY_MINI_GAME_DATA
	local var_5_9 = {}

	MiniGameDataCreator = var_1_10008
	var_5_9.id = var_1_10008.ShrineGameID
	var_5_9.map = {
		count = var_5_5
	}
...
function var_0_1.onBackPressed(arg_6_0)
	...
	i18n = var_1_10004
	var_6_3.content = var_1_10004("tips_summergame_exit")
...
function var_0_1.addListener(arg_16_0)
	...
	local function var_16_5()
		...
		pg = var_2_10003
		var_18_2.helps = var_2_10003.gametip.help_summer_food.tip
	...
	var_1_10001(var_16_6, var_16_7, var_16_8, var_1_10005)
	...
	for iter_16_0 = 1, var_0_1.Snack_Num do
		...
		local function var_16_13()
			...
			if var_20_1(var_20_2) == true then
				table = var_20_4

				var_20_4.removebyvalue(arg_16_0.selectedIDList, var_20_0)

				local var_20_3 = arg_16_0

				var_20_4.updateSelectedList(var_20_3, arg_16_0.selectedIDList)

				var_20_4 = arg_16_0.selectedSnackTFList
				var_20_4[var_20_0] = nil
				setActive = var_20_4

				var_20_4(var_20_2, false)

				local var_20_5 = arg_16_0

				var_20_4.updateSelectedOrderTag(var_20_5)
			else
				table = var_20_4

				var_20_4.insert(arg_16_0.selectedIDList, var_20_0)

				local var_20_6 = arg_16_0

				var_3.updateSelectedList(var_20_6, arg_16_0.selectedIDList)

				local var_20_7 = arg_16_0.selectedSnackTFList

				var_20_7[var_20_0] = var_16_10
				setActive = var_20_7

				var_20_7(var_20_2, true)

				local var_20_8 = arg_16_0

				var_3.updateSelectedOrderTag(var_20_8)

				if #arg_16_0.selectedIDList == var_0_1.Order_Num then
					local var_20_9 = arg_16_0.timer

					var_3.Stop(var_20_9)

					local var_20_10 = arg_16_0

					var_3.setState(var_20_10, var_0_1.States_Finished)
				end
			end
		...
		var_16_9(var_16_11, var_16_12, var_16_13, var_1_10010)
	end
...
function var_0_1.updateSDModel(arg_21_0)
	...
	local var_21_5 = var_21_3.UIMgr.GetInstance()
...
function var_0_1.updateSelectedList(arg_23_0, arg_23_1)
	...
	for iter_23_0 = 1, var_0_1.Order_Num do
		...
		var_11(var_8, var_23_5)

		setActive = var_11

		var_11(var_23_2, not var_23_5)
		...
		if var_23_5 then
			...
			var_11(var_23_6, var_13("ui/snackui_atlas", "snack_" .. var_23_5))
		end
	end
...
function var_0_1.updateSnackList(arg_24_0, arg_24_1)
	for iter_24_0 = 1, var_0_1.Snack_Num do
		...
		var_9(var_24_4, var_1_10011("ui/snackui_atlas", "snack_" .. var_24_3))

		local var_24_5 = var_6
		local var_24_6 = var_6.Find(var_24_5, "SelectedTag")

		setActive = var_24_5

		var_24_5(var_24_6, false)
...
function var_0_1.updateSelectedOrderTag(arg_26_0, arg_26_1)
	...
	for iter_26_0, iter_26_1 in var_1_10002(arg_26_0.selectedSnackTFList) do
		...
		if arg_26_1 then
			...
			var_26_0(var_26_1, false)
		else
			table = var_26_0

			local var_26_2 = var_26_0.indexof(arg_26_0.selectedIDList, iter_26_0, 1)
			...
			var_9(var_26_3, var_11("ui/snackui_atlas", "order_" .. var_26_2))
		end
	end
...
function var_0_1.onStateChange(arg_28_0)
	...
	elseif arg_28_0.state == var_0_1.States_Memory then
		...
		arg_28_0.updateSnackInteractable(var_28_0, false)
		...
		local var_28_2 = var_28_0.value

		go = var_3

		local var_28_3 = var_28_2(var_3(arg_28_0.selectedContainer), 0, 1, var_0_1.Bubble_Fade_Time)
		local var_28_4 = var_2.setOnUpdate

		System = var_4

		local var_28_5 = var_28_4(var_28_3, var_4.Action_float(function(arg_30_0)
			arg_28_0.selectedContainerCG.alpha = arg_30_0

			return
		end))
		local var_28_6 = var_2.setOnComplete

		System = var_4

		var_28_6(var_28_5, var_4.Action(function()
			...
			var_0.initTimer(var_31_0, var_28_1)
	...
	elseif arg_28_0.state == var_0_1.States_Finished then
		...
		arg_28_0.updateSnackInteractable(var_28_8, false)

		LeanTween = var_1

		local var_28_9 = var_1.value

		go = var_28_8

		local var_28_10 = var_28_9(var_28_8(arg_28_0.selectedContainer), 1, 0, var_0_1.Bubble_Fade_Time)
		local var_28_11 = var_1.setOnUpdate

		System = var_3

		local var_28_12 = var_28_11(var_28_10, var_3.Action_float(function(arg_33_0)
			arg_28_0.selectedContainerCG.alpha = arg_33_0

			return
		end))
		local var_28_13 = var_1.setOnComplete

		System = var_3

		var_28_13(var_28_12, var_3.Action(function()
