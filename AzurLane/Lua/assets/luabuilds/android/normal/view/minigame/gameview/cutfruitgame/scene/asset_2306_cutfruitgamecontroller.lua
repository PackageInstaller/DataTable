...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = var_5(arg_1_0._tf, "direct")

	typeof = var_6
	Animator = var_7
	arg_1_0._directPanelAniamtor = var_4(var_1_0, var_6(var_7))
	GetComponent = var_4
	findTF = var_1_0
	...
	typeof = var_6
	DftAniEvent = var_7
	arg_1_0._directPanelDftEvent = var_4(var_1_1, var_6(var_7))
	...
	for iter_1_0 = 1, var_0_4 do
		...
		var_1_10008 = var_1_10008(var_1_10009(arg_1_0._directGridTpl))
		SetParent = var_1_10009

		var_1_10009(var_1_10008, arg_1_0._directContent)
		...
		var_1_10009.insert(arg_1_0._directGrids, var_1_10008)
	end

	local var_1_3 = {}

	CutFruitGameConst = var_5
	var_1_3[1] = var_5.DIRECT_UP
	CutFruitGameConst = var_5
	var_1_3[2] = var_5.DIRECT_DOWN
	CutFruitGameConst = var_5
	var_1_3[3] = var_5.DIRECT_LEFT
	CutFruitGameConst = var_5
	var_1_3[4] = var_5.DIRECT_RIGHT
	arg_1_0._directRandomList = var_1_3
	setActive = var_1_3

	var_1_3(arg_1_0._directPanel, false)

	findTF = var_1_3
	arg_1_0.watermelonTF = var_1_3(arg_1_0._tf, "watermelon")
	GetComponent = var_4
	findTF = var_5

	local var_1_4 = var_5(arg_1_0.watermelonTF, "ad/spine")

	typeof = var_6
	SpineAnimUI = var_7
	arg_1_0.watermelonAnimUI = var_4(var_1_4, var_6(var_7))
...
function var_0_0.Prepare(arg_3_0)
	...
	for iter_3_0 = 1, #arg_3_0._npcConfig do
		...
		var_3_8(var_3_7, var_3_9, var_1_10009(arg_3_0._npcContent, var_3_6), function(arg_5_0)
			table = var_2_10001
...
function var_0_0.Step(arg_7_0, arg_7_1)
	if arg_7_0._gameOverStep and arg_7_0._gameOverStep > 0 then
		...
		if arg_7_0._gameOverStep <= 0 then
			...
			var_7_1(var_7_0, var_1_10004.GAME_OVER, true)
		end
	...
	if arg_7_0._currrentPosition < arg_7_0._targetPosition then
		...
		local var_7_3 = arg_7_0._currrentPosition

		if arg_7_0._targetPosition < var_7_3 then
			arg_7_0._currrentPosition = arg_7_0._targetPosition
			var_1_10004 = arg_7_0

			arg_7_0.setCharAniamtion(var_1_10004, arg_7_0._spineChar, "stand", true)
		else
			var_1_10004 = arg_7_0

			arg_7_0.setCharAniamtion(var_1_10004, arg_7_0._spineChar, "walk", true)
		end

		var_1_10004 = arg_7_0._spineChar
		var_3.x = var_3.GetAnchoredPosition(var_1_10004).x + var_7_2

		local var_7_4 = arg_7_0._spineChar

		var_1_10004.SetAnchoredPosition(var_7_4, var_3)
	end
	...
	if arg_7_0._currrentPosition >= arg_7_0._targetConfig then
		...
		var_7_6(var_7_5, var_1_10004.STOP_TIME_STEP, true)
		...
		if not arg_7_0._gameOverFlag then
			...
			var_2.SetActionCallBack(var_7_7, function(arg_9_0)
			...
			local var_7_8 = arg_7_0.watermelonAnimUI

			var_2.SetAction(var_7_8, "action1", 0)
		end
	end
...
function var_0_0.SetDirectData(arg_22_0, arg_22_1)
	...
	for iter_22_0 = 1, #arg_22_0._directGrids do
		...
		if iter_22_0 <= #arg_22_1 then
			...
			CutFruitGameConst = var_8
			var_22_1.localEulerAngles = var_8.DIRECT_ROTATION[arg_22_1[iter_22_0]].rotation
			setActive = var_22_1
...
function var_0_0.updateDirect(arg_23_0)
	for iter_23_0 = 1, #arg_23_0._inputList do
		...
		var_1_10006(var_1_10007(var_23_0, "ad/" .. var_0_1), false)

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(var_23_0, "ad/" .. var_0_2), false)

		setActive = var_1_10006
		findTF = var_1_10007

		var_1_10006(var_1_10007(var_23_0, "ad/" .. var_0_3), false)

		if #arg_23_0._passList < iter_23_0 then
			setActive = var_1_10006
			findTF = var_1_10007

			var_1_10006(var_1_10007(var_23_0, "ad/" .. var_0_1), true)
		else
			setActive = var_1_10006
			findTF = var_1_10007

			var_1_10006(var_1_10007(var_23_0, "ad/" .. arg_23_0._passList[iter_23_0]), true)
		end
	end
...
function var_0_0.getRandomDirect(arg_25_0)
	...
	for iter_25_0 = 1, var_0_4 do
		...
		var_1_10006(var_25_1, var_25_2[var_1_10009.random(1, #arg_25_0._directRandomList)])
	end
