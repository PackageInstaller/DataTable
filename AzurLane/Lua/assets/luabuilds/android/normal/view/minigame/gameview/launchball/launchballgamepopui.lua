...
local var_0_0 = var_0_10000("LaunchBallGamePopUI")
...
function var_0_0.initLeavelUI(arg_5_0)
	...
	local var_5_1 = var_3(arg_5_0.leaveUI, "ad/btnOk")
	...
	var_1(var_5_0, var_5_1, var_5_2, var_5)
...
function var_0_0.initPauseUI(arg_8_0)
	...
	local var_8_1 = var_3(arg_8_0.pauseUI, "ad/btnOk")
...
function var_0_0.updateSettlementUI(arg_12_0)
	...
	local var_12_0 = var_1_10002(arg_12_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_12_1 = var_1_10001(var_12_0, var_3(var_4))

	var_1.Play(var_12_1, "settlement", -1, 0)

	LaunchBallGameVo = var_2

	local var_12_2 = var_2.GetMiniGameData()
	local var_12_3 = var_2.GetRuntimeData(var_12_2, "elements")

	LaunchBallGameVo = var_12_2

	local var_12_4 = var_12_2.scoreNum
	...
	if var_12_3 then
		...
		var_12_8(var_6(arg_12_0.settlementUI, "ad/new"), var_12_6 < var_12_4)
		...
		if var_12_6 < var_12_4 then
			...
			LaunchBallGameView = var_7

			var_12_8(var_12_7, var_7.STORE_SERVER, var_12_6)
		end
		...
		LaunchBallGameView = var_9

		var_12_12(var_12_11, var_9.SUBMIT_GAME_SUCCESS)
...
function var_0_0.backPressed(arg_13_0)
	...
	if var_1_10001(arg_13_0.pauseUI) then
		...
		LaunchBallGameView = var_1_10003

		var_13_1(var_13_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_13_1
		...
		if var_13_1(arg_13_0.leaveUI) then
			...
			var_13_3(var_13_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_13_3
			...
			if not var_13_3(arg_13_0.pauseUI) then
				...
				if not var_1(arg_13_0.pauseUI) then
					...
					var_13_5(var_13_4, var_1_10003.PAUSE_GAME, true)
...
function var_0_0.updateGameUI(arg_17_0, arg_17_1)
	...
	var_1_10002(var_17_0, var_4.ceil(arg_17_1.gameTime))
...
function var_0_0.readyStart(arg_18_0)
	...
	local var_18_2 = var_1.PlaySoundEffect_V3

	LaunchBallGameVo = var_3

	var_18_2(var_18_1, var_3.SFX_COUNT_DOWN)
