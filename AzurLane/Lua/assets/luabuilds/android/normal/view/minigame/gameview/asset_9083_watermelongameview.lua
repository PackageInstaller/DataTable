...
function var_0_1.initEvent(arg_5_0)
	...
	var_5_19(var_5_18, var_3.SHOW_RULE, function(arg_15_0, arg_15_1, arg_15_2)
		...
		WatermelonGameConst = var_2_10007
	...
	var_5_31(var_5_30, var_3.UPDATE_NEXT_BALL, function(arg_21_0, arg_21_1, arg_21_2)
...
function var_0_1.initUI(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10003(arg_22_0._tf, "tpl"))
...
function var_0_1.gameStep(arg_28_0)
	if arg_28_0.gameStartFlag and not arg_28_0.gameStop then
		...
		var_1.step(var_1_10002, var_0_2.deltaTime)
	...
	if var_1 then
		...
		if var_28_12(var_28_10.J) then
			...
			var_28_14(var_28_13, var_1_10003.J, true)
		end
	end
...
function var_0_1.getRankData(arg_32_0)
	...
	var_32_1(var_32_0, var_1_10003.MINI_GAME_FRIEND_RANK, {
		id = var_0_2.gameId,
...
function var_0_1.onGameOver(arg_37_0, arg_37_1)
	...
	var_37_5(var_37_4, var_5.GAME_FINISH_TRACKING, {
