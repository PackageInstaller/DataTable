...
function var_0_0.start(arg_3_0)
	...
	for iter_3_0 = 1, #var_3_0 do
		...
		var_8.insert(arg_3_0.stoneDatas, {
			time = var_1_10006,
			indexs = var_1_10007
		})
	end
	...
	for iter_3_5 = var_3_1, #var_3.roundData.boom do
		...
		var_8.insert(arg_3_0.boomTimes, {
			time = var_1_10007
		})
	end
...
function var_0_0.step(arg_4_0)
	for iter_4_0 = #arg_4_0.carriageTime, 1, -1 do
		...
		if arg_4_0.carriageTime[iter_4_0] < var_1_10005 then
			...
			arg_4_0.appearCarriage(var_1_10006)
		end
	end
	...
	for iter_4_1 = #arg_4_0.bubbleTime, 1, -1 do
		...
		if arg_4_0.bubbleTime[iter_4_1].time < var_1_10005 then
			...
			arg_4_0:appearBubble(var_1_10005.num)
		end
	end
	...
	for iter_4_3 = #arg_4_0.carriages, 1, -1 do
		...
		do
			...
			local var_4_6 = var_4_4 + var_4_5 * var_1_10012.deltaTime * var_0_2
			local var_4_7 = var_1_10008.y

			var_1_10012 = var_1_10005.speed.y
			CastleGameVo = var_1_10013
			var_4_2.anchoredPosition = var_1_10009(var_4_6, var_4_7 + var_1_10012 * var_1_10013.deltaTime * var_0_2)
		...
		if var_1_10005.brokenTime then
			...
			if 0 < var_4_10 then
				...
				if var_1_10005.brokenTime < 0 then
					...
					arg_4_0:changeAnimAction(var_1_10005.anims, var_0_6, 1, var_0_7, function()
					...
					arg_4_0:returnItem(var_1_10005, arg_4_0.bubblePool)
	...
	for iter_4_5 = #arg_4_0.stoneDatas, 1, -1 do
		...
		if var_1_10005.gameStepTime > arg_4_0.stoneDatas[iter_4_5].time then
			...
			arg_4_0.appearStone(var_1_10008, var_4_12)
		end
	end
		...
		if var_5.brokenTime then
			...
			if 0 < var_4_15 then
				...
				if var_5.brokenTime <= 0 then
					...
					arg_4_0:returnItem(var_5, arg_4_0.stonePool)
				end
			end
		end
	...
	for iter_4_7 = #arg_4_0.booms, 1, -1 do
		...
		for iter_4_8, iter_4_9 in var_1_10008(var_9.ToTable(var_4_20)) do
			findTF = var_1_10013
			var_1_10013 = var_1_10013(var_4_17.tf, "zPos/" .. iter_4_8 + 1)
			Vector2 = var_14
			var_1_10013.anchoredPosition = var_14(iter_4_9.x, iter_4_9.y)
			Vector2 = var_1_10013
			var_1_10013 = var_1_10013(var_4_18.x + iter_4_9.x, var_4_18.y + iter_4_9.y)
			table = var_14

			var_14.insert(var_4_19, var_1_10013)
		end
...
function var_0_0.appearStone(arg_6_0, arg_6_1)
	...
	if 0 < var_6_3 then
		...
		tf = var_6_3
		instantiate = var_6
		var_6_3 = var_6_3(var_6(arg_6_0._stoneTpl))
		setParent = var_6
		...
		local var_6_4 = var_7(var_6_3, "zPos/anim/collider")

		typeof = var_8
		BoxCollider2D = var_9

		local var_6_5 = var_6(var_6_4, var_8(var_9))
	...
	local var_6_11 = var_6_10(var_6_8 / iter_6_1.w_count)
	local var_6_12 = var_6_0.tf

	CastleGameVo = var_1_10012
	var_6_12.anchoredPosition = var_1_10012.GetRotationPosByWH(var_6_9, var_6_11)
	setActive = var_6_12
	...
	if arg_6_0.itemRemindCallback then
		...
		CastleGameRemind = var_14
		var_6_15.type = var_14.remind_type_1
		var_6_14[1] = var_6_15
...
function var_0_0.appearBubble(arg_8_0, arg_8_1)
	for iter_8_0 = 1, arg_8_1 do
		...
		if 0 < var_8_1 then
			...
			tf = var_8_1
			instantiate = var_9
			var_8_1 = var_8_1(var_9(arg_8_0._bubbleTpl))
			findTF = var_9

			local var_8_2 = var_9(var_8_1, "zPos/pos")

			GetComponent = var_10
			findTF = var_1_10011
			var_1_10011 = var_1_10011(var_8_1, "zPos/spine1")
			typeof = var_12
			SpineAnimUI = var_13

			local var_8_3 = var_10(var_1_10011, var_12(var_13))

			GetComponent = var_1_10011
			findTF = var_12

			local var_8_4 = var_12(var_8_1, "zPos/spine2")

			typeof = var_13
			SpineAnimUI = var_14
			var_1_10011 = var_1_10011(var_8_4, var_13(var_14))
			GetComponent = var_8_4
			findTF = var_13

			local var_8_5 = var_13(var_8_1, "zPos/collider")

			typeof = var_14
			BoxCollider2D = var_15

			local var_8_6 = var_8_4(var_8_5, var_14(var_15))
			local var_8_7 = var_8_1:InverseTransformPoint(var_8_6.bounds.min)
			local var_8_8 = var_8_1
			local var_8_9 = var_8_1.InverseTransformPoint(var_8_8, var_8_6.bounds.max)

			setParent = var_8_8

			var_8_8(var_8_1, arg_8_0._content)
		...
		local var_8_10 = var_7[var_8_1.random(1, #var_7)]

		CastleGameVo = var_9

		local var_8_11 = var_8_10 % var_9.w_count

		math = var_10

		local var_8_12 = var_10.floor

		CastleGameVo = var_1_10011

		local var_8_13 = var_8_12(var_8_10 / var_1_10011.w_count)

		CastleGameVo = var_1_10011
		var_8_0.start = var_1_10011.GetRotationPosByWH(var_8_11, var_8_13)
		var_1_10011 = var_8_0.start
		var_1_10011.y = var_8_0.start.y + var_0_5
		var_1_10011 = var_8_0.tf
		var_1_10011.anchoredPosition = var_8_0.start
		setActive = var_1_10011

		var_1_10011(var_8_0.tf, false)

		CastleGameVo = var_1_10011
		var_8_0.ready = var_1_10011.bubble_ready_time
		var_8_0.broken = false
		CastleGameVo = var_1_10011
		var_8_0.brokenTime = var_1_10011.bubble_broken_time
		var_8_0.useIndex = {
			var_8_10
		}
		var_8_0.index = var_8_10
		...
		var_1_10011.insert(arg_8_0.bubbles, var_8_0)
...
function var_0_0.appearBoom(arg_9_0)
	...
	if 0 < var_9_6 then
		...
		tf = var_9_6
		instantiate = var_9_7
		var_9_6 = var_9_6(var_9_7(arg_9_0._boomTpl))
		GetComponent = var_9_7
		findTF = var_1_10007
		var_1_10007 = var_1_10007(var_9_6, "zPos/collider")
		typeof = var_8
		var_9_7 = var_9_7(var_1_10007, var_8("UnityEngine.PolygonCollider2D"))
	...
	local var_9_10 = var_9_9(var_9_4 / var_1_10007.w_count)

	CastleGameVo = var_7
	var_7.x = var_7.GetRotationPosByWH(var_9_8, var_9_10).x + var_0_9
	...
	if arg_9_0.itemRemindCallback then
		...
		CastleGameRemind = var_1_10011
		var_9_15.type = var_1_10011.remind_type_2
		var_9_14[1] = var_9_15
...
function var_0_0.appearCarriage(arg_15_0)
	...
	if 0 < var_15_1 then
		...
		local var_15_2 = var_15_1(var_3(arg_15_0._carriageTpl))

		GetComponent = var_3
		findTF = var_4

		local var_15_3 = var_4(var_15_2, "zPos/spine")

		typeof = var_5
		SpineAnimUI = var_6

		local var_15_4 = var_3(var_15_3, var_5(var_6))

		GetComponent = var_15_3
		findTF = var_5

		local var_15_5 = var_5(var_15_2, "zPos/collider")

		typeof = var_6
		BoxCollider2D = var_7

		local var_15_6 = var_15_3(var_15_5, var_6(var_7))
		local var_15_7 = var_15_2:InverseTransformPoint(var_15_6.bounds.min)
		local var_15_8 = var_15_2
		local var_15_9 = var_15_2.InverseTransformPoint(var_15_8, var_15_6.bounds.max)

		setParent = var_15_8

		var_15_8(var_15_2, arg_15_0._content)
...
function var_0_0.getCarriageRoadlist(arg_16_0)
	...
	for iter_16_0 = var_16_1, var_1_10003.w_count - 1 do
		...
		if var_16_2 then
			...
			CastleGameVo = iter_16_1
			var_16_5.target_h = iter_16_1.h_count
			Vector3 = var_10
			var_16_5.scale = var_10(-1, 1, 1)

			var_16_4(var_1_10008, var_16_5)
		end
	end
	...
	for iter_16_2 = var_16_6, var_3.h_count - 1 do
		local var_16_7 = true
		local var_16_8 = 0

		CastleGameVo = var_1_10008

		for iter_16_3 = var_16_8, var_1_10008.w_count - 1 do
			CastleGameVo = var_1_10011
		...
		if var_16_7 then
			...
			local var_16_9 = var_16_8.insert
			...
			CastleGameVo = iter_16_3
			var_16_10.target_w = iter_16_3.w_count
			var_16_10.target_h = iter_16_2
			Vector3 = var_10
			var_16_10.scale = var_10(1, 1, 1)

			var_16_9(var_1_10008, var_16_10)
		end
	end
...
function var_0_0.countSpeed(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = var_1_10004.abs(arg_18_2.y - arg_18_1.y)

	math = var_5

	local var_18_2 = var_18_0(var_18_1 / var_5.abs(arg_18_2.x - arg_18_1.x))
