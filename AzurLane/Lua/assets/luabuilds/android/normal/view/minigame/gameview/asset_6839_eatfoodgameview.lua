...
local function var_0_34(arg_1_0, arg_1_1)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			Vector2 = var_2
			var_2_0.anchoredPosition = var_2(var_0_16, 0)
		...
		touch = function(arg_7_0, arg_7_1)
			...
			if var_4.abs(arg_7_0.sliderTouchPos.x - var_0_16) < arg_7_0.sliderWidth / 2 then
				var_7_1 = arg_7_0:getScore(var_4)
			...
			if var_7_2 then
				...
				local var_7_3 = var_5.CriMgr.GetInstance()

				var_5.PlaySoundEffect_V3(var_7_3, var_0_6)
			else
				pg = var_5

				local var_7_4 = var_5.CriMgr.GetInstance()

				var_5.PlaySoundEffect_V3(var_7_4, var_0_7)
			end

			if arg_7_1 then
				local var_7_5 = arg_7_0._event

				var_5.emit(var_7_5, var_0_18, {
					flag = var_7_2,
					score = var_7_1
				}, function()
					return
...
local function var_0_35(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	local var_12_0 = {
				...
				if not arg_15_0.chars[iter_15_0].nextTime then
					...
					if var_5.nextTime <= 0 then
						...
						if var_6.contains(var_0_30, var_5.stepIndex) then
							var_2_10007 = var_5.tfAnimator

							var_6.SetTrigger(var_2_10007, "next")
						end

						if var_5.stepIndex == var_0_31 then
							var_2_10007 = var_5.tfAnimator

							var_6.SetBool(var_2_10007, "eat", false)

							var_2_10007 = var_5.tfAnimator

							var_6.SetBool(var_2_10007, "bite", true)
						end

						local var_15_1 = var_5.stepIndex

						if var_0_29 <= var_15_1 then
							var_2_10007 = arg_15_0

							arg_15_0.setWinChar(var_2_10007, var_5)
						end
					end
				end
			end
		...
		create = function(arg_19_0)
			...
			local var_19_1 = var_2.remove
			local var_19_2 = var_19_0

			math = var_2_10004

			local var_19_3 = var_19_1(var_19_2, var_2_10004.random(1, #var_19_0))
			...
			for iter_19_0 = 1, #var_0_28 do
				table = var_2_10008
				var_2_10008 = var_2_10008.remove

				local var_19_5 = var_19_4

				math = var_2_10010
				var_2_10008 = var_2_10008(var_19_5, var_2_10010.random(1, #var_19_4))
				var_2_10010 = arg_19_0

				local var_19_6 = arg_19_0.getCharById(var_2_10010, var_2_10008, var_0_28[iter_19_0])

				table = var_2_10010

				var_2_10010.insert(arg_19_0.chars, var_19_6)
			end
		...
		getCharById = function(arg_20_0, arg_20_1, arg_20_2)
			...
			local var_20_1 = var_2_10004(var_2_10005(var_2_10006(arg_20_0._charTpls, "char" .. arg_20_1.id)))

			tf = var_5
			instantiate = var_6

			local var_20_2 = var_5(var_6(arg_20_0._foodTpl))
			...
			var_6(var_20_3, var_8(var_20_4, var_2_10010(arg_20_2)))
			...
			var_6(var_20_5, var_8(var_20_6, var_10(arg_20_2)))
			...
			local var_20_7 = var_7(var_20_1, "anim")

			typeof = var_8
			Animator = var_9
			var_20_0.tfAnimator = var_6(var_20_7, var_8(var_9))
			...
			local var_20_9 = var_7(var_20_2, "anim")

			typeof = var_8
			Animator = var_9
			var_20_0.foodTfAnimator = var_20_8(var_20_9, var_8(var_9))
			...
			local var_20_10 = var_7(var_20_1, "anim")

			typeof = var_8
			DftAniEvent = var_9

			local var_20_11 = var_6(var_20_10, var_8(var_9))
...
function var_0_1.initUI(arg_38_0)
	...
	local var_38_0 = var_2(arg_38_0.countUI, "count")

	typeof = var_3
	Animator = var_4
	arg_38_0.countAnimator = var_1(var_38_0, var_3(var_4))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_38_0.countDft = var_1(var_38_1, var_3(var_4))
	...
	local var_38_5 = var_3(arg_38_0.leaveUI, "ad/btnOk")
	...
	var_1(var_38_4, var_38_5, var_38_6, var_5)
	...
	var_1(var_38_7, var_38_8, var_38_9, var_5)
	...
	local var_38_11 = var_3(arg_38_0.pauseUI, "ad/btnOk")
	...
	var_1(var_38_10, var_38_11, var_38_12, var_5)
	...
	local var_38_14 = var_3(arg_38_0.settlementUI, "ad/btnOver")
	...
	var_1(var_38_13, var_38_14, var_38_15, var_5)
...
function var_0_1.initGameUI(arg_45_0)
	...
	var_1(var_45_0, var_3(arg_45_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_45_1, var_3(arg_45_0.gameUI, "btnLeave"), function()
	...
	findTF = var_2
	arg_45_0.sliderController = var_45_3(var_2(arg_45_0.sceneTf, "collider"), arg_45_0)

	local var_45_4 = var_0_35

	findTF = var_2

	local var_45_5 = var_2(arg_45_0.sceneTf, "tpls")

	findTF = var_3

	local var_45_6 = var_3(arg_45_0.sceneTf, "food")

	findTF = var_4
	arg_45_0.charController = var_45_4(var_45_5, var_45_6, var_4(arg_45_0.sceneTf, "container"), arg_45_0)
...
function var_0_1.CheckGet(arg_52_0)
	if arg_52_0:getUltimate() == 0 then
		local var_52_0 = arg_52_0:getGameTotalTime()
		local var_52_1 = arg_52_0

		if var_52_0 > arg_52_0.getGameUsedTimes(var_52_1) then
			return
		end

		pg = var_52_1

		local var_52_2 = var_52_1.m02
		local var_52_3 = var_3.sendNotification

		GAME = var_1_10005

		local var_52_4 = var_1_10005.SEND_MINI_GAME_OP
		local var_52_5 = {
			hubid = arg_52_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_7
		var_52_5.cmd = var_7.CMD_ULTIMATE
		var_52_5.args1 = {}

		var_52_3(var_52_2, var_52_4, var_52_5)
	end
...
function var_0_1.openMenuUI(arg_53_0)
	...
	var_1_10001(var_1_10002(arg_53_0._tf, "scene_container"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_53_0.bgTf, "on"), true)
...
function var_0_1.gameStart(arg_60_0)
	...
	var_1_10001(var_1_10002(arg_60_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_60_0.bgTf, "on"), false)
...
function var_0_1.transformColor(arg_61_0, arg_61_1)
	...
	local var_61_0 = var_1_10002(var_1_10003.sub(arg_61_1, 1, 2), 16)

	tonumber = var_3
	string = var_4

	local var_61_1 = var_3(var_4.sub(arg_61_1, 3, 4), 16)

	tonumber = var_4
	string = var_5

	local var_61_2 = var_4(var_5.sub(arg_61_1, 5, 6), 16)
...
function var_0_1.addScore(arg_62_0, arg_62_1, arg_62_2)
	...
	if arg_62_1 then
		...
		var_4(var_5(arg_62_0.sceneScoreTf, "img"), var_62_0)

		setActive = var_4

		var_4(arg_62_0.sceneScoreTf, true)
	end
...
function var_0_1.updateGameUI(arg_67_0)
	...
	var_1_10001(var_67_0, var_3.ceil(arg_67_0.gameTime))
...
function var_0_1.setGameOver(arg_68_0, arg_68_1)
	...
	Application = var_68_0

	local var_68_2

	if not var_68_0.targetFrameRate then
		var_68_2 = 60
	end
	...
	var_4({
		...
		function(arg_71_0)
			if var_68_1 then
				var_2_10002 = var_68_1

				var_1.Stop(var_2_10002)
			...
			if arg_68_1 then
				pg = var_1
				var_2_10002 = var_1.CriMgr.GetInstance()

				var_1.PlaySoundEffect_V3(var_2_10002, var_0_4)
			else
				pg = var_1
				var_2_10002 = var_1.CriMgr.GetInstance()

				var_1.PlaySoundEffect_V3(var_2_10002, var_0_5)
			end

			setActive = var_1
			findTF = var_2_10002

			var_1(var_2_10002(arg_68_0.resultUI, "ad/victory"), arg_68_1)

			setActive = var_1
			findTF = var_2

			var_1(var_2(arg_68_0.resultUI, "ad/defeat"), not arg_68_1)
			...
			local var_71_0 = var_2(arg_68_0.resultUI, "ad")

			typeof = var_3
			Animator = var_4

			local var_71_1 = var_1(var_71_0, var_3(var_4))
			...
			Timer = var_71_1
			var_68_1 = var_71_1.New(function()
...
function var_0_1.onGameOver(arg_74_0, arg_74_1)
	...
	local var_74_1 = var_3(arg_74_0._tf)
	local var_74_2 = arg_74_1

	System = var_1_10005

	var_74_0(var_74_1, var_74_2, var_1_10005.Action(function()
...
function var_0_1.showSettlement(arg_76_0)
	...
	local var_76_0 = var_2(arg_76_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_76_1 = var_1_10001(var_76_0, var_3(var_4))
	...
	if var_76_3 then
		...
		var_5(var_6(arg_76_0.settlementUI, "ad/new"), var_76_6 < var_76_4)
...
function var_0_1.willExit(arg_80_0)
	if arg_80_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_80_0.handle)
	end
	...
	if arg_80_0._tf then
		...
		if var_80_0(var_1_10002(arg_80_0._tf)) then
			LeanTween = var_1
