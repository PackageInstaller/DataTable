...
function var_0_0.DescendSlope(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_3 = var_6.Abs(arg_1_0.y) + arg_1_2.skinWidth
	...
	local var_1_7, var_1_8 = var_1_5(var_1_6, var_1_10010.down, nil, var_1_3, var_1_4)

	Physics = var_10

	local var_1_9 = var_10.Raycast
	local var_1_10 = arg_1_2.bottomRight

	Vector3 = var_12

	local var_1_11, var_1_12 = var_1_9(var_1_10, var_12.down, nil, var_1_3, var_1_4)
	local var_1_15
	...
	if var_1_7 or var_1_11 then
		...
		if var_1_7 and not var_1_11 or not var_1_7 and var_1_11 then
			...
			var_1_15 = var_1_8.normal
			Vector3 = var_15

			local var_1_16 = var_1_14(var_1_15, var_15.up)

			Vector3 = var_1_15
			var_1_15 = var_1_15.Angle

			local var_1_17 = var_1_12.normal

			Vector3 = var_1_10016
			var_1_15 = var_1_15(var_1_17, var_1_10016.up)

			if var_1_16 <= arg_1_1.config.maxSlopeAngle and var_1_15 > arg_1_1.config.maxSlopeAngle then
				var_1_13 = true
			elseif var_1_16 > arg_1_1.config.maxSlopeAngle and var_1_15 <= arg_1_1.config.maxSlopeAngle then
				var_1_13 = true
			end
		end
	...
	if not arg_1_1.slidingDownMaxSlope then
		...
		if var_12.Sign(arg_1_0.x) ~= -1 or not arg_1_2.bottomRight then
			var_1_18 = arg_1_2.bottomLeft
		end

		Physics = var_1_15

		local var_1_19 = var_1_15.Raycast
		local var_1_20 = var_1_18
		local var_1_21 = var_0_0.directDown
		local var_1_22

		Mathf = var_1_10018

		local var_1_23, var_1_24 = var_1_19(var_1_20, var_1_21, var_1_22, var_1_10018.Infinity, var_1_4)

		if var_1_23 then
			Vector3 = var_1_21

			if var_1_21.Angle(var_1_24.normal, var_0_0.directUp) ~= 0 and var_16 <= arg_1_1.config.maxSlopeAngle then
				Mathf = var_17

				if var_17.Sign(var_1_24.normal.x) == var_12 then
					local var_1_25 = var_1_24.distance - arg_1_2.skinWidth

					Mathf = var_18

					local var_1_26 = var_18.Tan

					Mathf = var_19

					local var_1_27 = var_1_26(var_16 * var_19.Deg2Rad)

					Mathf = var_19

					if var_1_25 <= var_1_27 * var_19.Abs(arg_1_0.x) then
						Mathf = var_1_25

						local var_1_28 = var_1_25.Abs(arg_1_0.x)

						Mathf = var_18

						local var_1_29 = var_18.Sin

						Mathf = var_19

						local var_1_30 = var_1_29(var_16 * var_19.Deg2Rad) * var_1_28

						Mathf = var_19

						local var_1_31 = var_19.Cos

						Mathf = var_20

						local var_1_32 = var_1_31(var_16 * var_20.Deg2Rad) * var_1_28

						Mathf = var_20
						arg_1_0.x = var_1_32 * var_20.Sign(arg_1_0.x)
						arg_1_0.y = arg_1_0.y - var_1_30
						arg_1_1.slopeAngle = var_16
						arg_1_1.descendingSlope = true
						arg_1_1.below = true
						arg_1_1.slopeNormal = var_1_24.normal
					end
				end
			end
		end
...
function var_0_0.slideDownMaxSlope(arg_2_0, arg_2_1, arg_2_2)
	if arg_2_0 and arg_2_1.y ~= 0 then
		...
		local var_2_2 = var_2_0(var_2_1, var_1_10005.up)
		...
		if arg_2_2.config.maxSlopeAngle < var_2_2 then
			...
			local var_2_4 = var_5.Abs(arg_2_1.y)
			local var_2_5 = arg_2_2.config.downMaxSlopeSpeed

			Time = var_1_10007

			if var_2_5 * var_1_10007.deltaTime < var_2_4 then
			...
			local var_2_8 = var_2_6 / var_2_7(var_2_2 * var_7.Deg2Rad)
...
function var_0_0.VerticalCollisions(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_1 = var_1_10005.Abs(arg_3_0.y) + arg_3_2.skinWidth * 2
	...
	for iter_3_0 = 1, arg_3_2.verticalRayCount do
		...
		if var_3_5 then
			...
			if var_3_9(var_3_10, var_1_10019(var_3_8).layer) then
				var_3_7 = true
			end
		...
		if not var_3_7 and var_3_4 then
			...
			if not var_3_6 then
				...
				if arg_3_1.climbingSlope then
					...
					var_1_10019 = arg_3_1.slopeAngle
					Mathf = var_1_10020

					local var_3_14 = var_3_12 / var_3_13(var_1_10019 * var_1_10020.Deg2Rad)
