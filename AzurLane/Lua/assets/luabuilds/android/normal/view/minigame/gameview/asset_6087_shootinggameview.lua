...
function var_0_1.init(arg_2_0)
	...
	var_2(var_3.Find(var_2_19, "block"), false)
...
function var_0_1.didEnter(arg_9_0)
	...
	var_1_10001(arg_9_0, arg_9_0.backBtn, function()
		if arg_9_0.isPlaying then
			...
			i18n = var_2_10003
			var_10_3.content = var_2_10003("tips_summergame_exit")
	...
	local function var_9_2()
		...
		pg = var_2_10003
		var_13_2.helps = var_2_10003.gametip.help_summer_shooting.tip
...
local function var_0_2(arg_16_0, arg_16_1)
	...
	local var_16_0 = var_1_10003.clamp(arg_16_0.x, -arg_16_1.x, arg_16_1.x)

	math = var_4

	return var_1_10002(var_16_0, var_4.clamp(arg_16_0.y, -arg_16_1.y, arg_16_1.y))
end
	...
	if not arg_17_0.isStopped then
		if arg_17_0.isAfterCount and arg_17_0.sightTimeMark then
			...
			if not arg_17_0.moveRect then
				...
				Vector2 = var_3
				arg_17_0.moveRect = var_3(var_17_1.rect.width - arg_17_0.sightTF.rect.width, var_17_1.rect.height - arg_17_0.sightTF.rect.height) / 2
			end
...
function var_0_1.gameStart(arg_19_0)
	...
	var_1(var_2.Find(var_19_0, "word"), false)
	;(function(arg_20_0)
...
function var_0_1.gameFinish(arg_25_0, arg_25_1)
	...
	if not arg_25_1 then
		for iter_25_0 = 1, 3 do
			for iter_25_1 = 1, 6 do
				if arg_25_0.cell[iter_25_0][iter_25_1] then
					...
					local var_25_6 = var_25_5(var_25_4, var_12(var_13))
		...
		local var_25_7 = var_2.New(function()
			...
			var_2_10000(var_1.Find(var_26_0, "word"), true)
...
function var_0_1.showResultPanel(arg_28_0, arg_28_1, arg_28_2)
	...
	var_1_10004(var_28_1, var_6.Find(var_28_2, "bg"), var_28_0)
	...
	var_1_10004(var_28_3, var_6.Find(var_28_4, "main/btn_confirm"), var_28_0)
...
function var_0_1.updateAfterFinish(arg_31_0)
	...
	local var_31_2 = var_31_1(var_31_0, var_1_10003.ShrineGameID)
	local var_31_3
	...
	local var_31_5 = var_4.m02
	local var_31_6 = var_4.sendNotification

	GAME = var_1_10006

	local var_31_7 = var_1_10006.MODIFY_MINI_GAME_DATA
	local var_31_8 = {}

	MiniGameDataCreator = var_1_10008
	var_31_8.id = var_1_10008.ShrineGameID
	var_31_8.map = {
		count = var_31_4
	}
...
function var_0_1.OnGetAwardDone(arg_32_0, arg_32_1)
	...
	if var_32_0 == var_1_10003.CMD_COMPLETE then
		...
		if arg_32_0.GetMGHubData(var_32_1).ultimate == 0 then
			...
			if var_32_1 >= var_2.getConfig(var_32_2, "reward_need") then
				...
				var_32_5.cmd = var_7.CMD_ULTIMATE
				var_32_5.args1 = {}
...
function var_0_1.updateCount(arg_34_0)
	...
	if not var_1_10001(var_2.GetRuntimeData(var_34_0, "elements"), {
		1
	}) then
		var_34_1 = 0
	end
...
function var_0_1.initFireFunc(arg_35_0)
	...
	local function var_35_6()
		...
		local var_36_2 = var_36_0(var_36_1, var_2(1.95, 1.95, 1), 0.1)
		local var_36_3 = var_0.setOnComplete

		System = var_2

		var_36_3(var_36_2, var_2.Action(function()
	...
	local function var_35_7()
		...
		var_38_1(var_38_0, var_2.Action(function()
			LeanTween = var_3_10000
			...
			var_39_0(var_39_1, var_3_10002.one, 0.1)
	...
	function arg_35_0._upFunc()
		...
		local var_41_2 = var_41_0(var_41_1, var_2_10002(2, 2, 2), 0.03)
		local var_41_3 = var_0.setOnComplete

		System = var_2

		var_41_3(var_41_2, var_2.Action(function()
			LeanTween = var_3_10000
			...
			local var_42_2 = var_42_0(var_42_1, var_3_10002.one, 0.07)
			local var_42_3 = var_0.setOnComplete

			System = var_2

			var_42_3(var_42_2, var_2.Action(function()
				var_35_7()
		...
		if var_41_5 then
			...
			local var_41_15 = var_41_14(var_41_13, var_6(var_7))
		...
		if arg_48_0._downFunc ~= nil then
			...
			var_2.AddPointDownFunc(var_48_0, function()
				...
				if arg_48_0._main_cannon_sound then
					var_49_0 = arg_48_0._main_cannon_sound
				...
				local var_49_2 = var_49_0.CriMgr.GetInstance()
...
function var_0_1.flushTarget(arg_52_0, arg_52_1)
	...
	for iter_52_0 = 1, 3 do
		for iter_52_1 = 1, 6 do
			...
			var_1_10012 = arg_52_0.targetPanel
			var_1_10012 = var_11.Find(var_1_10012, "line_" .. iter_52_0)

			var_1_10010(var_11.GetChild(var_1_10012, iter_52_1 - 1))
		end
	end
	...
	for iter_52_2, iter_52_3 in var_3(arg_52_0.targetCount) do
		for iter_52_4 = 1, iter_52_3 do
			...
			local var_52_1 = var_13.random(6)

			while arg_52_0.cell[var_1_10012][var_52_1] or arg_52_1 and var_52_0[var_1_10012] >= 4 do
				math = var_52_2

				local var_52_2 = var_52_2.random(3)

				math = var_15
				var_52_1 = var_15.random(6)
				var_1_10012 = var_52_2
			end

			var_52_0[var_1_10012] = var_52_0[var_1_10012] + 1

			local var_52_3 = arg_52_0.cell[var_1_10012]

			var_52_3[var_52_1] = iter_52_2
			cloneTplTo = var_52_3

			local var_52_4 = arg_52_0.targetTpl[iter_52_2]
			local var_52_5 = arg_52_0.targetPanel
			local var_52_6 = var_16.Find(var_52_5, "line_" .. var_1_10012)

			var_52_3(var_52_4, var_16.GetChild(var_52_6, var_52_1 - 1))
		end
	end
