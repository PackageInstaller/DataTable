...
function var_0_1.Ctor(arg_1_0)
	...
	MusicBeatGameConst = var_2
	arg_1_0._gameVo = var_1_0(var_2.mini_game_id)
...
function var_0_1.initEvent(arg_5_0)
	...
	MusicBeatGameEvent = var_1_10003
	...
	var_5_13(var_5_12, var_3.BACK_MENU, function(arg_12_0, arg_12_1, arg_12_2)
		...
		MusicBeatGameConst = var_5

		var_12_7(var_12_6, var_5.bgm_type_menu)
	...
	var_5_19(var_5_18, var_3.SHOW_RULE, function(arg_15_0, arg_15_1, arg_15_2)
		...
		MusicBeatGameConst = var_2_10007
	...
	var_5_23(var_5_22, var_3.READY_START, function(arg_17_0, arg_17_1, arg_17_2)
	...
	var_5_25(var_5_24, var_3.STORE_SERVER, function(arg_18_0, arg_18_1, arg_18_2)
		getProxy = var_2_10003
		MiniGameProxy = var_2_10004

		local var_18_0 = var_2_10003(var_2_10004)
	...
	var_5_27(var_5_26, var_3.SUBMIT_GAME_SUCCESS, function(arg_19_0, arg_19_1, arg_19_2)
	...
	var_5_29(var_5_28, var_3.ADD_SCORE, function(arg_20_0, arg_20_1, arg_20_2)
...
function var_0_1.initUI(arg_21_0)
	...
	var_21_1(var_21_0, var_1_10003(arg_21_0._tf, "tpl"))
...
function var_0_1.gameStep(arg_26_0)
	if arg_26_0.gameStartFlag and not arg_26_0.gameStop then
		var_1_10002 = arg_26_0

		arg_26_0.stepRunTimeData(var_1_10002)

		var_1_10002 = arg_26_0.gameUI

		var_1.step(var_1_10002, arg_26_0._gameVo.deltaTime)

		var_1_10002 = arg_26_0.gameScene
	...
	if var_1 then
		...
		if var_26_0(var_1_10002.A) then
			var_26_1 = arg_26_0
			var_26_2 = arg_26_0.emit
			MusicBeatGameEvent = var_1_10003
			var_1_10003 = var_1_10003.KEY_CODE_DOWN
			KeyCode = var_1_10004

			var_26_2(var_26_1, var_1_10003, var_1_10004.A)
		end
		...
		if var_26_3(var_26_1.D) then
			...
			local var_26_6 = var_1_10003.KEY_CODE_DOWN

			KeyCode = var_1_10004

			var_26_5(var_26_4, var_26_6, var_1_10004.D)
		end
	end
...
function var_0_1.getRankData(arg_30_0)
	...
	var_30_1(var_30_0, var_1_10003.MINI_GAME_FRIEND_RANK, {
...
function var_0_1.onGameOver(arg_35_0, arg_35_1)
	...
	var_35_0(var_35_1, var_35_2, var_1_10005.Action(function()
	...
	var_35_5(var_35_4, var_5.GAME_FINISH_TRACKING, {
