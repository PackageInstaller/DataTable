...
function var_0_1.PlayGuider(arg_3_0, arg_3_1)
	...
	if not var_2.IsPlayed(var_3_0, arg_3_1) then
		...
		var_3_3(var_3_2, var_4.STORY_UPDATE, {
			storyId = arg_3_1
		})
	end
...
function var_0_1.initEvent(arg_6_0)
	...
	BeachGuardGameView = var_1_10003
	...
	var_6_5(var_6_4, var_3.OPEN_PAUSE_UI, function(arg_9_0, arg_9_1, arg_9_2)
	...
	var_6_7(var_6_6, var_3.OPEN_LEVEL_UI, function(arg_10_0, arg_10_1, arg_10_2)
	...
	var_6_9(var_6_8, var_3.PAUSE_GAME, function(arg_11_0, arg_11_1, arg_11_2)
		if arg_11_1 then
	...
	var_6_11(var_6_10, var_3.BACK_MENU, function(arg_12_0, arg_12_1, arg_12_2)
	...
	var_6_13(var_6_12, var_3.CLOSE_GAME, function(arg_13_0, arg_13_1, arg_13_2)
	...
	var_6_15(var_6_14, var_3.ENEMY_COMMING, function(arg_14_0, arg_14_1, arg_14_2)
	...
	var_6_19(var_6_18, var_3.SHOW_RULE, function(arg_16_0, arg_16_1, arg_16_2)
		...
		var_16_2.helps = var_6.getGameRoomData(var_16_3).game_help
	...
	var_6_21(var_6_20, var_3.READY_START, function(arg_17_0, arg_17_1, arg_17_2)
	...
	var_6_23(var_6_22, var_3.STORE_SERVER, function(arg_18_0, arg_18_1, arg_18_2)
	...
	var_6_25(var_6_24, var_3.SUBMIT_GAME_SUCCESS, function(arg_19_0, arg_19_1, arg_19_2)
	...
	var_6_27(var_6_26, var_3.OPEN_BOOK, function(arg_20_0, arg_20_1, arg_20_2)
	...
	var_6_29(var_6_28, var_3.RECYCLES_CHAR, function(arg_21_0, arg_21_1, arg_21_2)
	...
	var_6_31(var_6_30, var_3.RECYCLES_CHAR_CANCEL, function(arg_22_0, arg_22_1, arg_22_2)
	...
	var_6_33(var_6_32, var_3.DRAG_CHAR, function(arg_23_0, arg_23_1, arg_23_2)
	...
	var_6_35(var_6_34, var_3.PULL_CHAR, function(arg_24_0, arg_24_1, arg_24_2)
		...
		if var_12.pullChar(var_24_8, var_24_3, var_24_1, var_24_2) then
			...
			var_24_10(var_24_9, -1 * var_15.abs(var_24_4))
	...
	var_6_37(var_6_36, var_3.USE_SKILL, function(arg_25_0, arg_25_1, arg_25_2)
	...
	var_6_39(var_6_38, var_3.ADD_CRAFT, function(arg_26_0, arg_26_1, arg_26_2)
	...
	var_6_41(var_6_40, var_3.ADD_ENEMY, function(arg_27_0, arg_27_1, arg_27_2)
	...
	var_6_43(var_6_42, var_3.CREATE_CHAR_DAMAGE, function(arg_28_0, arg_28_1, arg_28_2)
	...
	var_6_45(var_6_44, var_3.REMOVE_CHAR, function(arg_29_0, arg_29_1, arg_29_2)
	...
	var_6_47(var_6_46, var_3.BULLET_DAMAGE, function(arg_30_0, arg_30_1, arg_30_2)
...
function var_0_1.Update(arg_34_0)
	...
	if var_1 then
		...
		if var_34_0(var_1_10002.S) then
			-- block empty
		end
	end
...
function var_0_1.readyStart(arg_35_0)
	...
	local var_35_5 = var_35_3.chapater_enemy[var_35_4].init_goods

	BeachGuardConst = var_3

	if var_3.chapter_data[var_35_4].fog then
...
function var_0_1.onGameOver(arg_51_0)
	...
	local var_51_1 = var_2(arg_51_0._tf)
	local var_51_2 = 0.1

	System = var_1_10004

	var_51_0(var_51_1, var_51_2, var_1_10004.Action(function()
		...
		local var_52_4 = var_2.GetMGData(var_52_3)
		local var_52_5 = arg_51_0

		var_52_2(var_52_1, var_52_4, var_3.GetMGHubData(var_52_5), arg_51_0.runningData)
...
function var_0_1.willExit(arg_59_0)
	if arg_59_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_59_0.handle)
	end
	...
	if arg_59_0._tf then
		...
		if var_59_0(var_1_10002(arg_59_0._tf)) then
			LeanTween = var_1
