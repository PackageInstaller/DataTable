...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	for iter_1_0 = 1, var_0_1 do
		...
		var_10.insert(arg_1_0._itemsTF, var_1_10009)

		GetOrAddComponent = var_10
		findTF = var_11

		local var_1_0 = var_11(var_1_10009, "trigger")

		typeof = var_12
		EventTriggerListener = var_13

		local var_1_1 = var_10(var_1_0, var_12(var_13))

		table = var_1_0

		var_1_0.insert(arg_1_0._gridEventTriggerList, var_1_1)

		GetOrAddComponent = var_11

		local var_1_2 = var_1_10009

		typeof = var_13
		Animator = var_1_10014

		local var_1_3 = var_11(var_1_2, var_13(var_1_10014))

		table = var_1_2

		var_1_2.insert(arg_1_0._itemsAnimator, var_1_3)

		GetOrAddComponent = var_12

		local var_1_4 = var_1_10009

		typeof = var_1_10014
		DftAniEvent = var_1_10015
		var_1_10014 = var_12(var_1_4, var_1_10014(var_1_10015))

		var_12.SetEndEvent(var_1_10014, function()
		...
		arg_1_0.SetItemSelect(var_1_10014, var_1_10008, false)

		var_1_10014 = arg_1_0

		arg_1_0.SetItemLock(var_1_10014, var_1_10008, false)
	end
...
function var_0_0.HasInputEmptyLayer(arg_9_0)
	...
	local var_9_2 = arg_9_0.GetInputEmptyLayer(var_9_1)

	SortGameConst = var_9_1

	return var_9_2 <= var_9_1.grid_max_layer
end
...
function var_0_0.UpdateUI(arg_11_0)
	...
	for iter_11_0 = 1, var_0_1 do
		...
		if var_11_1 == var_1_10006.grid_type_out then
			...
			arg_11_0.SetItemLock(var_1_10006, iter_11_0, iter_11_0 ~= 2)
		else
			var_1_10006 = arg_11_0

			arg_11_0.SetItemLock(var_1_10006, iter_11_0, false)
		end
	end
...
function var_0_0.SetItemLock(arg_12_0, arg_12_1, arg_12_2)
	...
	var_1_10004(var_1_10005(var_12_0, "lock"), arg_12_2)
...
function var_0_0.SetOffset(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_21_1 * var_1_10005.grid_bound[1]
	local var_21_3 = arg_21_1[2]

	SortGameConst = var_1_10006
	var_21_0.anchoredPosition = var_1_10003(var_21_2, var_21_3 * var_1_10006.grid_bound[2])
...
function var_0_0.checkItemPass(arg_22_0)
	...
	if var_22_0 ~= var_1_10002.grid_type_empty then
		...
		if var_22_2 and var_22_3 and var_22_4 and var_22_2 ~= 0 and var_22_3 ~= 0 and var_22_4 ~= 0 and var_22_2 == var_22_3 and var_22_3 == var_22_4 then
			...
			var_22_6(var_22_5, var_1_10006.SFX_PASS)
			arg_22_0:PassItem()
		end
...
function var_0_0.InputIds(arg_23_0, arg_23_1)
	...
	local var_23_1 = arg_23_0.GetInputEmptyLayer(var_23_0)

	SortGameConst = var_23_0

	if var_23_1 <= var_23_0.grid_max_layer then
		print = var_3

		var_3("插入层数 = " .. var_23_1)

		for iter_23_0 = 1, var_0_1 do
			arg_23_0._itemIdDic[iter_23_0][var_23_1] = arg_23_1[iter_23_0]
...
function var_0_0.UpdateItem(arg_25_0, arg_25_1)
	if arg_25_0._itemIdDic[arg_25_1][1] ~= 0 then
		var_1_10003 = arg_25_0

		arg_25_0.SetItemIcon(var_1_10003, arg_25_1, arg_25_0._itemIdDic[arg_25_1][1], "top")
	end

	if arg_25_0._itemIdDic[arg_25_1][2] ~= 0 then
		var_1_10003 = arg_25_0

		arg_25_0.SetItemIcon(var_1_10003, arg_25_1, arg_25_0._itemIdDic[arg_25_1][2], "bottom")
	end

	setActive = var_2
	findTF = var_1_10003

	var_2(var_1_10003(arg_25_0._itemsTF[arg_25_1], "top"), arg_25_0._itemIdDic[arg_25_1][1] ~= 0)

	setActive = var_2
	findTF = var_3

	var_2(var_3(arg_25_0._itemsTF[arg_25_1], "bottom"), arg_25_0._itemIdDic[arg_25_1][2] ~= 0)
...
function var_0_0.SetItemAlpha(arg_31_0, arg_31_1, arg_31_2)
	...
	var_5(var_31_3 .. var_31_4 .. var_31_5 .. var_1_10009(arg_31_2))
...
function var_0_0.SetItemSelect(arg_32_0, arg_32_1, arg_32_2)
	...
	var_1_10004(var_1_10005(var_32_0, "select"), arg_32_2)
...
function var_0_0.SetItemIcon(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	var_6(var_33_1, false)

	GetSpriteFromAtlasAsync = var_6
	SortGameConst = var_7

	var_6(var_7.ui_atlas, "item_" .. arg_33_2, function(arg_34_0)
		if var_33_1 then
...
function var_0_0.ClearItems(arg_40_0)
	...
	for iter_40_0 = 1, var_0_1 do
		...
		var_1_10006 = arg_40_0

		arg_40_0.UpdateItem(var_1_10006, iter_40_0)
	end
...
function var_0_0.Clear(arg_44_0)
	...
	for iter_44_1 = 1, var_0_1 do
		...
		arg_44_0.SetItemSelect(var_1_10006, iter_44_1, false)
	end
