...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	arg_1_0.touchEvent = var_4(var_1_0, var_6(var_1_10007))
	GameObject = var_4
	...
	var_4.AddPointDownFunc(var_1_2, function(arg_2_0, arg_2_1)
		...
		WatermelonGameEvent = var_2_10005

		var_2_3(var_2_2, var_2_10005.CLICK_MOVE, {
			pos = var_2_1,
	...
	var_4.AddPointUpFunc(var_1_3, function(arg_4_0, arg_4_1)
		...
		if arg_1_0.startDrag then
			...
			var_4_3(var_4_2, var_2_10005.CLICK_DOWN, var_4_1)
		end
	...
	var_4.AddDragFunc(var_1_4, function(arg_5_0, arg_5_1)
		if arg_1_0.startDrag then
			...
			var_5_3(var_5_2, var_2_10005.CLICK_MOVE, {
				pos = var_5_1
			})
		end
	...
	local function var_1_7()
		if not arg_1_0._gameVo.startSettlement then
			...
			var_6_1(var_6_0, var_2_10002.PAUSE_GAME, true)

			local var_6_2 = arg_1_0._event
			local var_6_3 = var_0.emit

			WatermelonGameEvent = var_2

			var_6_3(var_6_2, var_2.OPEN_LEVEL_UI)
		end
	...
	var_4(var_1_5, var_1_6, var_1_7, var_1_10008)
	...
	local function var_1_10()
		if not arg_1_0._gameVo.startSettlement then
			...
			var_7_1(var_7_0, var_2_10002.PAUSE_GAME, true)
			...
			var_7_3(var_7_2, var_2.OPEN_PAUSE_UI)
		end
	...
	var_4(var_1_8, var_1_9, var_1_10, var_1_10008)
	...
	findTF = var_5
	arg_1_0.joyStick = var_1_11(var_5(arg_1_0._gameUI, "joyStick"))
	...
	local function var_1_15()
		...
		var_9_1(var_9_0, var_2_10002.CLICK_DOWN)
	...
	var_4(var_1_13, var_1_14, var_1_15, var_1_10008)
...
function var_0_0.start(arg_12_0)
	...
	if var_1.GetHighScore(var_12_1, arg_12_0._gameVo.gameId) then
		...
		var_3(arg_12_0.scoreHigh, var_12_3)

		setText = var_3

		var_3(arg_12_0.scoreCurrent, 0)
...
function var_0_0.step(arg_14_0, arg_14_1)
	...
	var_1_10003(var_14_1, var_1_10005.floor(var_14_0))
	...
	var_14_5(var_14_4, var_5.getValue(var_14_6))
...
function var_0_0.setChildVisible(arg_16_0, arg_16_1, arg_16_2)
	for iter_16_0 = 1, arg_16_1.childCount do
		...
		local var_16_1 = arg_16_1.GetChild(var_16_0, iter_16_0 - 1)
	...
	if arg_17_1 == var_1_10003.A then
		...
		if arg_17_1 == var_17_0.D then
			...
			if arg_17_1 == var_17_1.J then
				...
				var_17_3(var_17_2, var_1_10005.CLICK_DOWN)
			end
		end
	end
