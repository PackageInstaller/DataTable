...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".SnackResultView"))
...
function var_0_1.updateView(arg_2_0)
	...
	if arg_2_0.contextData.countTime > 0 then
		...
		var_2(var_2_1, var_2_2 .. var_2_3 .. var_1_10006(var_2_0 .. "s", "#3068E6FF"))
	else
		setText = var_2
	...
	var_2(var_2_4, var_2_5 .. var_2_6 .. var_1_10006(var_2_0, "#3068E6FF"))
	...
	var_2.make(var_2_7, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			var_3_2, setImageSprite = arg_3_2.Find(var_3_1, "SnackImg"), var_3_1
			GetSpriteFromAtlas = var_2_10007

			var_3_1(var_3_2, var_2_10007("ui/minigameui/newyearsnackui_atlas", "snack_" .. var_3_0))
		end
	...
	var_2.make(var_2_9, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			var_4_2, setImageSprite = arg_4_2.Find(var_4_1, "SnackImg"), var_4_1
			GetSpriteFromAtlas = var_2_10007

			var_4_1(var_4_2, var_2_10007("ui/minigameui/newyearsnackui_atlas", "snack_" .. var_4_0))

			local var_4_3 = arg_2_0.contextData.orderIDList[arg_4_1 + 1]
			local var_4_4 = arg_4_2:Find("ErrorImg")
			local var_4_5 = arg_4_2
			local var_4_6 = arg_4_2.Find(var_4_5, "CorrectImg")

			setActive = var_4_5

			var_4_5(var_4_6, var_4_0 == var_4_3)

			setActive = var_4_5

			var_4_5(var_4_4, var_4_0 ~= var_4_3)
		end
