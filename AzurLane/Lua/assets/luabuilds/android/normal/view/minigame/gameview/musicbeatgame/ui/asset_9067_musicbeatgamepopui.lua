...
function var_0_0.initLeavelUI(arg_5_0)
	...
	local var_5_0 = var_2(arg_5_0.leaveUI, "ad/btnCancel/text")

	i18n = var_3

	var_1(var_5_0, var_3("event_ui_giveup"))
	...
	var_1(var_5_1, var_3("word_exist"))
	...
	var_1(var_5_2, var_3("beat_game_exit_desc"))
	...
	local var_5_4 = var_1(var_5_3, var_3(var_4))
	...
	var_1(var_5_5, var_3("word_exist"))
	...
	var_1(var_5_6, var_3("word_cancel"))
	...
	local var_5_8 = var_3(arg_5_0.leaveUI, "ad/btnOk")
	...
	var_1(var_5_7, var_5_8, var_5_9, var_5)
...
function var_0_0.initPauseUI(arg_8_0)
	...
	local var_8_0 = var_2(arg_8_0.pauseUI, "ad/img_2")
	...
	var_1(var_8_2, var_3("child2_replay_continue"))
	...
	local var_8_4 = var_3(arg_8_0.pauseUI, "ad/btnOk")
...
function var_0_0.initSettlementUI(arg_10_0)
	...
	var_1(var_10_0, var_3("ryza_task_confirm"))
	...
	var_1(var_10_1, var_3("beat_game_high_score"))
	...
	var_1(var_10_2, var_3("beat_game_current_score"))
...
function var_0_0.initRankUI(arg_12_0)
	...
	var_1(var_12_13, var_3("beat_game_rank"))
	...
	var_1(var_12_14, var_3("beat_game_my_record"))
	...
	var_1(var_12_15, var_3("beat_game_my_record"))
...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if 0 < arg_16_3 and arg_16_3 <= 3 then
		...
		var_11(var_16_12, var_13(var_16_3, var_0_1[arg_16_3]))
	elseif var_16_6 then
		...
		var_11(var_16_12, var_13(var_16_3, var_0_2))
	else
		setActive = var_11
		findTF = var_16_12
...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	if var_3.GetHighScore(var_19_3, arg_19_0._gameVo.gameId) then
		...
		var_5(var_6(arg_19_0.settlementUI, "ad/new"), var_19_5 < var_19_2)
		...
		if 0 < var_19_2 and var_19_5 < var_19_2 then
			...
			MusicBeatGameEvent = var_7

			var_19_7(var_19_6, var_7.STORE_SERVER, {
				var_19_2,
				1
			})
		end
		...
		MusicBeatGameEvent = var_9

		var_19_11(var_19_10, var_9.SUBMIT_GAME_SUCCESS)
...
function var_0_0.backPressed(arg_20_0)
	...
	if var_1_10001(arg_20_0.pauseUI) then
		...
		var_20_1(var_20_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_20_1
		...
		if var_20_1(arg_20_0.leaveUI) then
			...
			var_20_3(var_20_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_20_3
			...
			if not var_20_3(arg_20_0.pauseUI) then
				...
				if not var_1(arg_20_0.pauseUI) then
					if not arg_20_0._gameVo.startSettlement then
						...
						var_20_5(var_20_4, var_1_10003.PAUSE_GAME, true)
					end
