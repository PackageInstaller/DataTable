...
function var_0_1.initUI(arg_42_0)
	...
	local function var_42_30()
		...
		var_52_2.helps = var_3.getGameRoomData(var_52_3).game_help
...
function var_0_1.initGameUI(arg_54_0)
	...
	var_1(var_54_0, var_3(arg_54_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_54_1, var_3(arg_54_0.gameUI, "btnLeave"), function()
	...
	for iter_54_0 = 1, var_0_13 do
		findTF = var_1_10007
		var_1_10007 = var_1_10007(arg_54_0.sceneTf, "cow" .. iter_54_0)
		table = var_8

		var_8.insert(var_54_4, var_1_10007)
	end

	findTF = var_3
	arg_54_0.sceneScoreTf = var_3(arg_54_0.sceneTf, "score")

	local var_54_5 = var_0_33

	findTF = var_4
	arg_54_0._playerController = var_54_5(var_4(arg_54_0.sceneTf, "player"), arg_54_0)
...
function var_0_1.AddDebugInput(arg_59_0)
	...
	if var_1 then
		...
		if var_59_0(var_1_10002.S) and arg_59_0._playerController then
...
function var_0_1.CheckGet(arg_61_0)
	...
	var_1_10001(var_1_10002(arg_61_0.menuUI, "got"), false)
	...
	if arg_61_0:getUltimate() == 0 then
		local var_61_1 = arg_61_0:getGameTotalTime()
		local var_61_2 = arg_61_0

		if var_61_1 > arg_61_0.getGameUsedTimes(var_61_2) then
			return
		end

		pg = var_61_2

		local var_61_3 = var_61_2.m02
		local var_61_4 = var_3.sendNotification

		GAME = var_1_10005

		local var_61_5 = var_1_10005.SEND_MINI_GAME_OP
		local var_61_6 = {
			hubid = arg_61_0:GetMGHubData().id
		}

		MiniGameOPCommand = var_7
		var_61_6.cmd = var_7.CMD_ULTIMATE
		var_61_6.args1 = {}

		var_61_4(var_61_3, var_61_5, var_61_6)

		setActive = var_61_4
		findTF = var_61_3

		var_61_4(var_61_3(arg_61_0.menuUI, "got"), true)
	end
...
function var_0_1.openMenuUI(arg_62_0)
	...
	var_1_10001(var_1_10002(arg_62_0._tf, "scene_front"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_62_0._tf, "scene_background"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_62_0._tf, "scene"), false)
...
function var_0_1.gameStart(arg_65_0)
	...
	var_1_10001(var_1_10002(arg_65_0._tf, "scene_front"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_65_0._tf, "scene_background"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_65_0._tf, "scene"), true)
...
function var_0_1.updateGameUI(arg_75_0)
	...
	var_1_10001(var_75_0, var_3.ceil(arg_75_0.gameTime))
	...
	if not arg_75_0.captureCdMaskImg then
		...
		typeof = var_3
		Image = var_4
		arg_75_0.captureCdMaskImg = var_1(var_75_1, var_3(var_4))
	end
...
function var_0_1.addScore(arg_76_0, arg_76_1)
	...
	for iter_76_0 = 0, arg_76_0.sceneScoreTf.childCount - 1 do
		...
		if var_76_1 == var_8(arg_76_1) then
			setActive = var_76_1
...
function var_0_1.onGameOver(arg_77_0)
	...
	var_77_1(var_77_2, var_77_3, var_1_10004.Action(function()
...
function var_0_1.showSettlement(arg_79_0)
	...
	var_79_3(var_5(arg_79_0.settlementUI, "ad/new"), var_79_4 < var_79_2)
	...
	local var_79_5 = var_79_3(arg_79_0.settlementUI, "ad/highText")

	findTF = var_5

	local var_79_6 = var_5(arg_79_0.settlementUI, "ad/currentText")
...
function var_0_1.checkOverflow(arg_82_0, arg_82_1, arg_82_2)
	...
	local var_82_0 = var_1_10003(var_1_10004)
	local var_82_1 = var_3.getRawData(var_82_0)

	pg = var_82_0

	local var_82_2 = var_82_0.gameset.urpt_chapter_max.description[1]
	...
	if var_1_10006 then
		...
		var_1_10006 = var_1_10006.GetLimitCntById(var_1_10007, var_82_2)
	end

	Task = var_1_10007

	local var_82_3, var_82_4 = var_1_10007.StaticJudgeOverflow(var_82_1.gold, var_82_1.oil, var_1_10006, true, true, {
		arg_82_1
	})
	...
	if var_82_3 then
		...
		local var_82_5 = var_9.MsgboxMgr.GetInstance()
		local var_82_6 = var_9.ShowMsgBox
		local var_82_7 = {}

		MSGBOX_TYPE_ITEM_BOX = var_12
		var_82_7.type = var_12
		i18n = var_12
		var_82_7.content = var_12("award_max_warning_minigame")
		var_82_7.items = var_82_4
		var_82_7.onYes = arg_82_2

		var_82_6(var_82_5, var_82_7)
	else
		arg_82_2()
	end
...
function var_0_1.willExit(arg_84_0)
	if arg_84_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_84_0.handle)
	end
	...
	if arg_84_0._tf then
		...
		if var_84_0(var_1_10002(arg_84_0._tf)) then
			LeanTween = var_1
