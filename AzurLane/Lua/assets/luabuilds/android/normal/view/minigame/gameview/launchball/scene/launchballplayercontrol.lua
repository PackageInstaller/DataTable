...
local function var_0_17(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = {
		ctor = function(arg_2_0)
			...
			local var_2_0 = var_2_10002(arg_2_0.playerTf, "ad/anim")

			typeof = var_3
			Animator = var_4
			arg_2_0.animator = var_1(var_2_0, var_3(var_4))
			...
			for iter_2_0 = 1, #arg_1_1.skill do
				var_2_10005 = var_0_0.player_skill[arg_1_1.skill[iter_2_0]]
				table = var_6

				var_6.insert(arg_2_0.skills, {
					data = var_2_10005,
					time = var_2_10005.cd_time
				})
			end
			...
			var_2_1, GetOrAddComponent = var_1(arg_2_0.playerTf, "ad/change"), var_2
			typeof = iter_2_0
			EventTriggerListener = var_2_10005
			arg_2_0.changeListener = var_2(var_2_1, iter_2_0(var_2_10005))

			local var_2_2 = arg_2_0.changeListener

			var_2.AddPointDownFunc(var_2_2, function(arg_3_0, arg_3_1)
				local var_3_0 = arg_2_0.eventCall

				LaunchBallGameScene = var_3_10003

				var_3_0(var_3_10003.CHANGE_AMULET)
		...
		step = function(arg_6_0)
			...
			if arg_6_0.randomFireTime then
				...
				if 0 < var_6_2 then
					...
					if arg_6_0.randomFireTime <= 0 then
						...
						local var_6_5 = var_2.RANDOM_FIRE
						local var_6_6 = {
							num = 3
						}
						local var_6_7 = {}

						LaunchBallGameConst = var_2_10005
						var_6_7[var_2_10005.amulet_buff_back] = true
						var_6_6.data = var_6_7
			...
			if arg_6_0.sleepTimeTrigger then
				local var_6_8 = arg_6_0.sleepTimeTrigger

				if 0 < var_6_8 then
					local var_6_9 = arg_6_0.sleepTimeTrigger

					LaunchBallGameVo = var_2
					arg_6_0.sleepTimeTrigger = var_6_9 - var_2.deltaTime

					if arg_6_0.sleepTimeTrigger <= 0 then
						arg_6_0.sleepTimeTrigger = nil

						local var_6_10 = arg_6_0.eventCall

						LaunchBallGameScene = var_2

						var_6_10(var_2.SLEEP_TIME_TRIGGER)
					end
				end
			end

			if not arg_6_0.isPlaying then
				local var_6_11 = arg_6_0:getIdleName()

				if arg_6_0.idleAnimName ~= var_6_11 then
					arg_6_0:playAnim(var_6_11)

					arg_6_0.idleAnimName = var_6_11
				end
			end

			for iter_6_0 = 1, #arg_6_0.skills do
				if arg_6_0.skills[iter_6_0].time > 0 then
					local var_6_12 = arg_6_0.skills[iter_6_0]
					local var_6_13 = arg_6_0.skills[iter_6_0].time

					LaunchBallGameVo = var_2_10007
					var_6_12.time = var_6_13 - var_2_10007.deltaTime
			...
			for iter_6_1 = #arg_6_0.buffs, 1, -1 do
				local var_6_14 = arg_6_0.buffs[iter_6_1].time

				if 0 < var_6_14 then
					local var_6_15 = var_5.time

					LaunchBallGameVo = var_7
					var_5.time = var_6_15 - var_7.deltaTime

					if var_5.time <= 0 then
						table = var_6
			...
			for iter_6_2 = #arg_6_0.buffs, 1, -1 do
				if arg_6_0.buffs[iter_6_2].data.type == var_0_0.buff_panic then
					...
					if var_7.enemyToEndRate then
						...
						for iter_6_3 = var_6_17, #var_2_10008.enemyToEndRate do
					...
					var_5.active = var_6_16

					if var_5.active then
						var_2_10008 = arg_6_0
						var_2_10008 = arg_6_0.getSkillByType(var_2_10008, var_0_5).time
				...
				elseif var_5.data.type == var_0_0.buff_neglect then
					arg_6_0:updateBuffStopTime(var_5)
				elseif var_5.data.type == var_0_0.buff_sleep then
					arg_6_0:updateBuffStopTime(var_5)
				else
					var_5.active = true
				end
			...
			local var_6_19 = arg_6_0.changePlayerStopTime
			local var_6_20 = arg_6_0.playerStopTime

			LaunchBallGameVo = iter_6_2

			var_6_19(var_6_18, var_6_20 + iter_6_2.deltaTime)
		...
		updateBuffStopTime = function(arg_8_0, arg_8_1)
			if not arg_8_1.active then
				local var_8_0 = arg_8_0.playerStopTime

				if arg_8_1.data.active_rule.time < var_8_0 then
					arg_8_1.active = true
					LaunchBallGameVo = var_2

					local var_8_1 = var_2.AddGameResultData

					LaunchBallGameVo = var_3

					var_8_1(var_3.result_use_pass_skill, 1)
					...
					elseif arg_8_1.data.type == var_0_0.buff_sleep then
						local var_8_2 = "Trans_Sleep_" .. arg_8_0:getDirectName(arg_8_0.angle)

						arg_8_0:playAnim(var_8_2)
					end
				end
			end
		...
		changePlaying = function(arg_10_0, arg_10_1, arg_10_2)
			if arg_10_1 then
				...
				arg_10_0.setPlayTime(var_2_10004, arg_10_2.data.play_time)

				arg_10_0.weight = arg_10_2.data.weight
			else
				var_2_10004 = arg_10_0

				arg_10_0.setPlayTime(var_2_10004, 0)
			...
			if arg_10_0.eventCall then
				...
				LaunchBallGameScene = var_2_10004

				var_10_0(var_2_10004.PLAYING_CHANGE, arg_10_1)
			end
		...
		appearSkill = function(arg_14_0, arg_14_1)
			...
			if arg_14_1.data.type == var_0_5 then
				...
				arg_14_0.playAnim(var_14_2, var_14_1)

				local var_14_3 = arg_14_0.eventCall

				LaunchBallGameScene = var_14_2

				var_14_3(var_14_2.FIRE_AMULET)
			elseif arg_14_1.data.type == var_0_6 then
				print = var_2

				var_2("使用了主动技能")

				local var_14_4 = arg_14_0:getSkillAnimName(arg_14_1)

				arg_14_0:playAnim(var_14_4)
				...
				if arg_14_0.useSkillTime then
					LaunchBallGameVo = var_14_5
					var_14_5 = var_14_5.gameStepTime - arg_14_0.useSkillTime
					LaunchBallGameVo = var_4

					local var_14_6 = var_4.UpdateGameResultData

					LaunchBallGameVo = var_5

					var_14_6(var_5.reuslt_double_skill_time, var_14_5)
				else
					LaunchBallGameVo = var_14_5
					arg_14_0.useSkillTime = var_14_5.gameStepTime
				end

				pg = var_14_5

				local var_14_7 = var_14_5.CriMgr.GetInstance()
				local var_14_8 = var_3.PlaySoundEffect_V3

				LaunchBallGameVo = var_5

				var_14_8(var_14_7, var_5.SFX_PRESS_SKILL)

				LaunchBallGameVo = var_14_8

				local var_14_9 = var_14_8.AddGameResultData

				LaunchBallGameVo = var_14_7

				var_14_9(var_14_7.result_use_skill, 1)
			end
			...
			if arg_14_1.data.script then
				if arg_14_1.data.script == var_0_0.script_remove_all_enemys then
					...
					LaunchBallGameScene = var_4

					var_14_11(var_4.SPLIT_ALL_ENEMYS, {
						time = 1.3,
						effect = true
					})
				elseif arg_14_1.data.script == var_0_0.script_stop_enemy then
					...
					var_14_12(var_4.STOP_ENEMY_TIME, {
				...
				elseif arg_14_1.data.script == var_0_0.script_slash then
					...
					var_14_14(var_4.PLAYER_EFFECT, arg_14_1.data.effect)
				end
			end
		...
		setContent = function(arg_25_0, arg_25_1, arg_25_2)
			...
			if arg_25_2 then
				...
				Vector2 = var_4
				var_25_0.anchoredPosition = var_4(0, 0)
			end
...
function var_0_0.createPlayer(arg_29_0, arg_29_1)
	...
	local var_29_0 = var_1_10002(var_1_10003(var_1_10004(arg_29_0._tpl, arg_29_1.tpl)))
	...
	if var_1_10001.joyStickData then
		...
		if var_1.joyStickData.active then
			...
			if var_1.joyStickData.angle then
				...
				var_31_1(var_31_0, var_1_10003.joyStickData.angle)
			end
		end
	end
	...
	if arg_32_1 == var_1_10003.CHANGE_AMULET then
		...
		if arg_32_1 == var_3.PLAYER_EFFECT then
			if arg_32_2 then
				...
				local var_32_3 = var_8(var_32_2, "ad/anim")

				typeof = var_9
				Animator = var_10

				local var_32_4 = var_7(var_32_3, var_9(var_10))
