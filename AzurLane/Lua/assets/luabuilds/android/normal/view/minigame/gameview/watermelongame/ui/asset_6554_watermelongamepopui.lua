...
function var_0_0.initRankUI(arg_12_0)
	...
	local var_12_6 = var_3(arg_12_0.rankUI, "ad/close")
	...
	var_1(var_12_5, var_12_6, var_12_7, var_5)
	...
	var_1(var_12_8, var_12_9, var_12_10, var_5)
	...
	i18n = var_12_9
	WatermelonGameConst = var_12_10

	var_1(var_12_11, var_12_9(var_12_10.rank_tip))
...
function var_0_0.updateRankData(arg_15_0, arg_15_1)
	for iter_15_0 = 1, #arg_15_1 do
		...
		if #arg_15_0._rankItems < iter_15_0 then
			...
			local var_15_0 = var_7(var_1_10008(arg_15_0._rankItemTpl))
		...
		var_1_10008 = arg_15_0

		arg_15_0.setRankItemData(var_1_10008, var_1_10006, arg_15_1[iter_15_0], iter_15_0)
...
function var_0_0.setRankItemData(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_10(var_16_11, var_12(arg_16_3))
	...
	var_10(var_16_12, var_12(var_16_3))
...
function var_0_0.initRankUI(arg_18_0)
	...
	local var_18_2 = var_1(var_18_1, var_3(var_4))
	...
	local var_18_4 = var_1(var_18_3, var_3(var_4))
	...
	local var_18_6 = var_3(arg_18_0.rankUI, "ad/close")
	...
	var_1(var_18_5, var_18_6, var_18_7, var_5)
	...
	var_1(var_18_8, var_18_9, var_18_10, var_5)
	...
	i18n = var_18_9
	WatermelonGameConst = var_18_10

	var_1(var_18_11, var_18_9(var_18_10.rank_tip))
...
function var_0_0.updateSettlementUI(arg_22_0)
	...
	local var_22_0 = var_1_10002(arg_22_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_22_1 = var_1_10001(var_22_0, var_3(var_4))
	...
	if 0 < var_22_5 then
		getProxy = var_22_5
		GameRoomProxy = var_22_6
		var_22_6 = var_22_5(var_22_6)
		var_22_5 = var_22_5.getRoomScore

		local var_22_7 = arg_22_0._gameVo.mgData

		var_22_3 = var_22_5(var_22_6, var_6.getConfig(var_22_7, "game_room"))
	else
		getProxy = var_22_5
		MiniGameProxy = var_22_6
		var_22_6 = var_22_5(var_22_6)
		var_22_3 = var_22_5.GetHighScore(var_22_6, arg_22_0._gameVo.gameId) and #var_22_5 > 0 and var_22_5[1] or 0
	end

	setActive = var_22_5
	findTF = var_22_6

	var_22_5(var_22_6(arg_22_0.settlementUI, "ad/new"), var_22_3 < var_22_2)
	...
	if 0 < var_22_2 and var_22_3 < var_22_2 then
		...
		WatermelonGameEvent = var_6

		var_22_9(var_22_8, var_6.STORE_SERVER, {
			var_22_2,
			1
		})
	end
	...
	local var_22_11 = var_5(arg_22_0.settlementUI, "ad/currentText")
	...
	WatermelonGameEvent = var_8

	var_22_13(var_22_12, var_8.SUBMIT_GAME_SUCCESS, var_22_2)
...
function var_0_0.backPressed(arg_23_0)
	...
	if var_1_10001(arg_23_0.pauseUI) then
		...
		WatermelonGameEvent = var_1_10003

		var_23_1(var_23_0, var_1_10003.PAUSE_GAME, false)
	else
		isActive = var_23_1
		...
		if var_23_1(arg_23_0.leaveUI) then
			...
			var_23_3(var_23_2, var_1_10003.LEVEL_GAME, false)
		else
			isActive = var_23_3
			...
			if not var_23_3(arg_23_0.pauseUI) then
				...
				if not var_1(arg_23_0.pauseUI) then
					if not arg_23_0._gameVo.startSettlement then
						...
						var_23_5(var_23_4, var_1_10003.PAUSE_GAME, true)
					end
...
function var_0_0.updateGameUI(arg_27_0, arg_27_1)
	...
	var_1_10002(var_27_0, var_4.ceil(arg_27_1.gameTime))
...
function var_0_0.readyStart(arg_28_0)
	...
	var_28_2(var_28_1, var_3.SFX_COUNT_DOWN)
