...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_0 = var_5(arg_1_0.jiujiuTf, "anim")

	typeof = var_6
	Animator = var_7
	arg_1_0.jiujiuAnim = var_4(var_1_0, var_6(var_7))
	setActive = var_4
...
function var_0_0.init(arg_2_0)
	...
	for iter_2_0 = var_2_0, #var_1_10002.judge_data do
		...
		LoadAny = var_1_10006
		var_1_10007 = arg_2_0._gameData.path

		local var_2_1 = var_1_10005.name

		typeof = var_1_10009
		RuntimeAnimatorController = var_1_10010
		var_1_10006 = var_1_10006(var_1_10007, var_2_1, var_1_10009(var_1_10010))
		table = var_1_10007
		...
		var_1_10009 = {}
		Clone = var_1_10010
		var_1_10009.data = var_1_10010(var_1_10005)
		var_1_10009.runtimeAnimator = var_1_10006

		var_1_10007(var_2_2, var_1_10009)
	end
	...
	for iter_2_1 = var_2_3, var_2.judge_num do
		...
		var_1_10006 = var_1_10006(var_1_10007(arg_2_0._tpl))
		findTF = var_1_10007
		var_1_10007 = var_1_10007(arg_2_0._sceneBackground, "judgesPos" .. iter_2_1).anchoredPosition
		setParent = var_8

		var_8(var_1_10006, arg_2_0._sceneTf)

		setActive = var_8

		var_8(var_1_10006, true)

		var_1_10006.anchoredPosition = var_1_10007
		CookGameJudge = var_8

		local var_2_5 = var_8.New(var_1_10006, var_2_4, arg_2_0._judgeDatas, arg_2_0._gameData, arg_2_0._event)

		var_8.setFrontContainer(var_2_5, arg_2_0._sceneFrontTf)
		var_8:setClickCallback(function()
		...
		var_9.insert(arg_2_0.judges, var_8)
	end
...
function var_0_0.onJudgeClick(arg_6_0, arg_6_1)
	for iter_6_0 = 1, #arg_6_0.judges do
		if iter_6_0 == arg_6_1 then
			...
			var_6_2(var_6_1, var_8.CLICK_JUDGE_EVENT, arg_6_0.judges[arg_6_1], function(arg_7_0)
				if not arg_7_0 then
