...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_4 = var_5(arg_1_0.animChar, "anim")

	typeof = var_6
	Animator = var_7
	arg_1_0.animator = var_4(var_1_4, var_6(var_7))
	findTF = var_4
	...
	var_5(var_1_6, var_7(arg_1_0._tf, "click"), function()
		if arg_1_0.recycle then
			...
			var_2_3(var_2_2, var_2_10002.RECYCLES_CHAR_CANCEL)
		end
	...
	typeof = var_7
	CanvasGroup = var_8
	var_5(var_1_7, var_7(var_8)).blocksRaycasts = false
...
function var_0_0.step(arg_10_0, arg_10_1)
	if arg_10_0.timeToPool > 0 then
		...
		if arg_10_0.timeToPool <= 0 then
			...
			var_10_1(var_10_0, var_1_10004.REMOVE_CHAR, arg_10_0)
		end
	end
	...
	if arg_10_0:isAlife() then
		...
		for iter_10_5 = 1, #arg_10_0.skillDatas do
			...
			if var_10_3 == 0 then
				...
				if var_10_5 == iter_10_4.skill_bullet and var_10_4 and arg_10_0.targetChar then
					...
					arg_10_0.useSkill(iter_10_4, var_6)
				else
		...
		if arg_10_0.damageTime ~= 0 then
			...
			Time = iter_10_6
			arg_10_0.damageTime = var_10_11 - iter_10_6.deltaTime
			var_10_9 = 0
			var_10_10 = 0
...
function var_0_0.addCraft(arg_11_0)
	...
	for iter_11_0 = 1, 3 do
		...
		if var_1_10005(var_11_0, var_11_1 .. var_1_10008(iter_11_0)) then
			setActive = var_11_0

			local var_11_2 = var_1_10005

			var_1_10008 = iter_11_0 <= arg_11_0.craftNum

			var_11_0(var_11_2, var_1_10008)
		end
	end
...
function var_0_0.useSkill(arg_20_0, arg_20_1)
	...
	if var_20_0.ignore_enemy_skill and arg_20_0.camp == 2 then
	...
	if var_20_2 == var_1_10004.anim_atk then
	...
	local var_20_6 = arg_20_0.createUseData(var_20_5, var_20_1)

	table = var_20_5

	local var_20_7 = var_20_5.insert
	local var_20_8 = arg_20_0.triggerData
	local var_20_9 = {
		data = var_20_6,
		time = var_20_1.time
	}

	BeachGuardGameView = var_8
	var_20_9.event = var_8.USE_SKILL

	var_20_7(var_20_8, var_20_9)
...
function var_0_0.createUseData(arg_29_0, arg_29_1)
	...
	local var_29_3 = arg_29_0.getSkillDistance(var_29_2)

	BeachGuardConst = var_29_2
	var_29_0.distanceVec = var_29_1(var_29_3 * var_29_2.part_width, 0)
...
function var_0_0.setRaycast(arg_43_0, arg_43_1)
	...
	local var_43_0 = var_1_10003(arg_43_0._tf, "click")

	typeof = var_4
	Image = var_5
	var_1_10002(var_43_0, var_4(var_5)).raycastTarget = arg_43_1
