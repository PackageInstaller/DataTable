...
function var_0_1.initUI(arg_70_0)
	...
	local var_70_17 = var_2.activity_template[var_70_16].config_client.item_id
	...
	var_3(var_70_18, var_5(arg_70_0.menuUI, "item/img"), true)
	...
	local var_70_20 = var_5(arg_70_0.menuUI, "item")
	...
	local function var_70_21()
		...
		var_77_3(var_77_2, var_2_10003.OPEN_SUB_LAYER, var_77_0)
	...
	var_3(var_70_19, var_70_20, var_70_21, var_7)
	...
	var_3(var_70_22, var_70_23, var_70_24, var_7)
	...
	var_3(var_70_25, var_70_26, var_70_27, var_7)
	...
	var_3(var_70_28, var_70_29, var_70_30, var_7)
...
function var_0_1.initGameUI(arg_81_0)
	...
	var_1(var_81_0, var_3(arg_81_0.gameUI, "topRight/btnStop"), function()
	...
	var_1(var_81_1, var_3(arg_81_0.gameUI, "btnLeave"), function()
...
function var_0_1.openMenuUI(arg_88_0)
	...
	var_1_10001(var_1_10002(arg_88_0._tf, "scene_container"), false)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_88_0.bgTf, "on"), true)
...
function var_0_1.gameStart(arg_94_0)
	...
	var_1_10001(var_1_10002(arg_94_0._tf, "scene_container"), true)

	setActive = var_1_10001
	findTF = var_2

	var_1_10001(var_2(arg_94_0.bgTf, "on"), false)
...
function var_0_1.transformColor(arg_95_0, arg_95_1)
	...
	local var_95_0 = var_1_10002(var_1_10003.sub(arg_95_1, 1, 2), 16)

	tonumber = var_3
	string = var_4

	local var_95_1 = var_3(var_4.sub(arg_95_1, 3, 4), 16)

	tonumber = var_4
	string = var_5

	local var_95_2 = var_4(var_5.sub(arg_95_1, 5, 6), 16)
...
function var_0_1.addScore(arg_96_0, arg_96_1, arg_96_2)
	...
	local var_96_4 = var_4(var_96_3, var_1_10006(var_1_10007))
	...
	if arg_96_1 then
		...
		for iter_96_0 = 1, #var_0_48 do
			if arg_96_1 and arg_96_1 >= var_0_48[iter_96_0].score then
				...
				var_96_6 = var_0_48[iter_96_0].font
		...
		local var_96_8 = arg_96_0.transformColor(var_96_7, var_96_5)

		arg_96_0.scoreNum = arg_96_0.scoreNum + arg_96_1

		local var_96_9 = arg_96_1 >= 0 and "+" or ""

		setText = var_96_7

		var_96_7(var_96_2, var_96_9 .. arg_96_1)

		var_96_4.fontSize = var_96_6 or 40
		setTextColor = var_8

		var_8(var_96_2, var_96_8)
	elseif arg_96_2 then
		local var_96_10 = arg_96_0:transformColor("66f2fb")

		var_96_4.fontSize = 40
		setTextColor = var_96_6

		var_96_6(var_96_2, var_96_10)

		var_96_6 = arg_96_0.gameTime

		if 0 < var_96_6 then
			arg_96_0.gameTime = arg_96_0.gameTime + arg_96_2
		end

		var_96_6 = 0 < arg_96_2 and "+" or ""
		setText = var_7

		var_7(var_96_2, var_96_6 .. arg_96_2 .. "s")
	end

	setActive = var_96_6

	var_96_6(arg_96_0.sceneScoreTf, true)
...
function var_0_1.updateGameUI(arg_101_0)
	...
	var_1_10001(var_101_0, var_3.ceil(arg_101_0.gameTime))
...
function var_0_1.onGameOver(arg_102_0)
	...
	var_102_1(var_102_2, var_102_3, var_1_10004.Action(function()
...
function var_0_1.showSettlement(arg_104_0)
	...
	local var_104_0 = var_2(arg_104_0.settlementUI, "ad")

	typeof = var_3
	Animator = var_4

	local var_104_1 = var_1_10001(var_104_0, var_3(var_4))
	...
	if var_104_3 then
		...
		var_5(var_6(arg_104_0.settlementUI, "ad/new"), var_104_6 < var_104_4)
...
function var_0_1.willExit(arg_108_0)
	if arg_108_0.handle then
		...
		var_1.RemoveListener(var_1_10002, arg_108_0.handle)
	end
	...
	if arg_108_0._tf then
		...
		if var_108_0(var_1_10002(arg_108_0._tf)) then
			LeanTween = var_1
