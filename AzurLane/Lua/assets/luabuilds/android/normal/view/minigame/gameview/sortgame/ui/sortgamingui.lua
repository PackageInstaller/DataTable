...
function var_0_0.initUI(arg_2_0)
	...
	var_1(var_2_6, var_3("pac_game_gaming_time_desc"))
	...
	var_1(var_2_7, var_3("pac_game_gaming_score"))
	...
	var_1(var_2(arg_2_0._gameUI, "combo"), false)

	GetComponent = var_1
	findTF = var_2

	local var_2_8 = var_2(arg_2_0._gameUI, "combo/ad/progress")

	typeof = var_3
	Slider = var_4
	arg_2_0._comboProgressSlider = var_1(var_2_8, var_3(var_4))
	findTF = var_1
	arg_2_0._wantedTF = var_1(arg_2_0._gameUI, "wanted")
	GetComponent = var_1
	findTF = var_2

	local var_2_9 = var_2(arg_2_0._gameUI, "wanted/ad/Slider")

	typeof = var_3
	Slider = var_4
	arg_2_0._wantedProgressSlider = var_1(var_2_9, var_3(var_4))
	findTF = var_1
	...
	findTF = var_2
	var_2_10[1] = var_2(arg_2_0._comboTF, "ad/vx_combo01")
	findTF = var_2
	...
	for iter_2_0 = 1, #arg_2_0.comboEffectTf do
		...
		var_1_10005(arg_2_0.comboEffectTf[iter_2_0], false)
	end
...
function var_0_0.CreateScoreTF(arg_5_0, arg_5_1, arg_5_2)
	...
	if 0 < var_5_1 then
		...
		tf = var_5_1
		Instantiate = var_5
		var_5_0 = var_5_1(var_5(arg_5_0._scoreTpl))
		GetComponent = var_5_1
		findTF = var_5

		local var_5_2 = var_5(var_5_0, "ad")

		typeof = var_6
		DftAniEvent = var_7
		var_5_1 = var_5_1(var_5_2, var_6(var_7))
		setParent = var_5_2

		var_5_2(var_5_0, arg_5_0._scoreContent)

		setActive = var_5_2

		var_5_2(var_5_0, true)
...
function var_0_0.SetScoreText(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	for iter_7_0 = 0, 9 do
		...
		var_1_10009(var_1_10010(var_7_1, var_7_2 .. var_1_10013(iter_7_0)), iter_7_0 == arg_7_3)
	end
...
function var_0_0.Start(arg_13_0)
	...
	if var_13_2(var_13_1, var_3.GetGameId(var_13_3)) then
...
function var_0_0.Step(arg_14_0, arg_14_1)
	...
	if var_14_0 ~= var_3.GetTimeInteger(var_14_1) then
		...
		arg_14_0._time = var_2.GetTimeInteger(var_14_2)
		...
		local var_14_3 = var_2.floor(arg_14_0._time / 60)

		math = var_3

		local var_14_4 = var_3.floor(arg_14_0._time % 60)

		setText = var_14_1

		local var_14_5 = arg_14_0.timeTF

		string = var_1_10006

		var_14_1(var_14_5, var_1_10006.format("%02d : %02d", var_14_3, var_14_4))
	end
	...
	if arg_14_0._comboTime and arg_14_0._comboTime >= 0 then
		...
		if arg_14_0._comboTime and arg_14_0._comboTime <= 0 then
			...
			var_2(var_3(arg_14_0._gameUI, "combo"), false)
		else
			local var_14_6 = arg_14_0._comboProgressSlider
			local var_14_7 = arg_14_0._comboTime

			SortGameConst = var_14_1
			var_14_6.value = var_14_7 / var_14_1.combo_time
		end
	end
	...
	if arg_14_0._wantedStepTime and arg_14_0._wantedStepTime >= 0 then
		...
		if arg_14_0._wantedStepTime and arg_14_0._wantedStepTime <= 0 then
			...
			local var_14_8 = arg_14_0._wantedProgressSlider
			local var_14_9 = arg_14_0._wantedStepTime

			SortGameConst = var_14_1
			var_14_8.value = var_14_9 / var_14_1.wanted_step_time
		end
	end
			...
			if var_6.show and var_6.show > 0 then
				...
				if var_15_2 then
					...
					if var_6.tf then
						...
						local var_15_4 = var_12(var_6.tf, "ad")

						typeof = var_13
						Animator = var_14

						local var_15_5 = var_11(var_15_4, var_13(var_14))
...
function var_0_0.RefreshWantedItem(arg_18_0, arg_18_1, arg_18_2)
	if arg_18_1 then
		...
		var_1_10003(var_4.ui_atlas, "item_" .. arg_18_1, function(arg_19_0)
			if arg_19_0 then
...
function var_0_0.SetCombo(arg_20_0, arg_20_1)
	if arg_20_1 == 0 then
		...
		var_1_10002(var_1_10003(arg_20_0._gameUI, "combo"), false)
	...
	var_2(var_3(arg_20_0._gameUI, "combo"), false)

	setActive = var_2
	findTF = var_3

	var_2(var_3(arg_20_0._gameUI, "combo"), true)

	setText = var_2
	findTF = var_3

	var_2(var_3(arg_20_0._gameUI, "combo/ad/combo_img/combo_desc"), "X " .. arg_20_1)
...
function var_0_0.StepTimeToScore(arg_22_0)
	...
	SortGameConst = var_22_4
	arg_22_0._timeToScoreStep = var_22_3 * var_22_4.time_trans_score
	Timer = var_4
	arg_22_0._timeToScoreTimer = var_4.New(function()
		...
		if var_22_5 <= 0 then
			...
			var_23_2(var_23_1, var_2_10002.ADD_SCORE, {
				combo = 0,
				num = var_22_2
			})
			...
			var_23_2(var_23_3, var_2.format("%02d : %02d", 0, 0))

			setText = var_23_2

			local var_23_4 = arg_22_0.scoreTextTf
			local var_23_5 = arg_22_0._gameVo

			var_23_2(var_23_4, var_2.GetScore(var_23_5))

			local var_23_6 = arg_22_0._event
			local var_23_7 = var_0.emit

			SimpleMGEvent = var_2

			var_23_7(var_23_6, var_2.GAME_OVER)
		...
		var_23_8._time = arg_22_0._time - var_22_3
		math = var_23_8

		local var_23_9 = var_23_8.floor(arg_22_0._time / 60)

		math = var_1

		local var_23_10 = var_1.floor(arg_22_0._time % 60)

		setText = var_2

		local var_23_11 = arg_22_0.timeTF

		string = var_2_10004

		var_2(var_23_11, var_2_10004.format("%02d : %02d", var_23_9, var_23_10))

		local var_23_12 = arg_22_0

		var_23_12._score = arg_22_0._score + arg_22_0._timeToScoreStep
		setText = var_23_12

		var_23_12(arg_22_0.scoreTextTf, arg_22_0._score)

		local var_23_13 = arg_22_0

		var_2.StepScoreTween(var_23_13, 0.05)
...
function var_0_0.SetChildVisible(arg_24_0, arg_24_1, arg_24_2)
	for iter_24_0 = 1, arg_24_1.childCount do
		...
		local var_24_1 = arg_24_1.GetChild(var_24_0, iter_24_0 - 1)
...
function var_0_0.Dispose(arg_27_0)
	for iter_27_0 = 1, #arg_27_0._scoreTfPool do
		...
		findTF = var_1_10006
		var_1_10006 = var_1_10006(arg_27_0._scoreTfPool[iter_27_0], "ad")
		typeof = var_7
		DftAniEvent = var_8

		local var_27_0 = var_1_10005(var_1_10006, var_7(var_8))

		var_1_10005.SetEndEvent(var_27_0, nil)
	end
...
function var_0_0.GetSmoothOffset(arg_28_0, arg_28_1, arg_28_2, arg_28_3, arg_28_4, arg_28_5)
	...
	local var_28_9 = var_15.cos

	math = var_16

	local var_28_10 = 0.5 - 0.5 * var_28_9(var_16.pi * var_28_8)
	local var_28_11 = {
