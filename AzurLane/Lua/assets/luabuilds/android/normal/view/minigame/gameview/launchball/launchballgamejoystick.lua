...
local var_0_0 = var_0_10000("LaunchBallGameJoyStick")
...
function var_0_0.step(arg_8_0)
	...
	if var_1.abs(arg_8_0.currentY - arg_8_0.startPos.y) <= 1 then
		math = var_1

		if var_1.abs(arg_8_0.currentX - arg_8_0.startPos.x) <= 1 then
			arg_8_0.angle = nil
			arg_8_0.rad = nil
	...
	math = var_1
	arg_8_0.rad = var_1.atan2(arg_8_0.currentY - arg_8_0.startPos.y, arg_8_0.currentX - arg_8_0.startPos.x)

	do
		local var_8_5 = arg_8_0.rad

		math = var_2
		arg_8_0.angle = var_8_5 * var_2.rad2Deg
	end
...
function var_0_0.setActiveCallback(arg_11_0, arg_11_1)
	arg_11_0.activeCallback = arg_11_1

	return
end

function var_0_0.getValue(arg_12_0)
	return {
