...
function var_0_0.Step(arg_4_0, arg_4_1)
	...
	local var_4_2 = var_4_0.max

	math = var_1_10004

	local var_4_3 = var_1_10004.min
	local var_4_4 = var_4_1

	CrossRoadGameConst = var_1_10006

	local var_4_5 = var_4_2(var_4_3(var_4_4, #var_1_10006.MAKE_CAR_TIME), 1)

	CrossRoadGameConst = var_4
	arg_4_0.makedelayTime = var_4.MAKE_CAR_TIME[var_4_5]
