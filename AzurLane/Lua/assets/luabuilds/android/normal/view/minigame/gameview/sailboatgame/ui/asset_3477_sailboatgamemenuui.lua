...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_15()
		...
		var_6_1(var_6_0, var_2_10002.OPEN_EQUIP_UI)
	...
	for iter_1_0 = 1, 7 do
		...
		var_1_10010 = var_1_10010(var_1_10011(var_1_16))
		...
		var_1_10011(var_1_19, var_1_10013(arg_1_0.menuUI, "battList/Viewport/Content"))

		var_1_10011 = iter_1_0
		findTF = var_1_19

		local var_1_20 = var_1_19(var_1_10010, "icon")
		...
		local function var_1_23()
			...
			var_7_1(var_7_0, var_2_10002.ON_DROP, var_1_10013)
		...
		var_14(var_1_21, var_1_22, var_1_23, var_1_10018)

		table = var_14

		var_14.insert(arg_1_0.dropItems, var_1_20)
		...
		local var_1_24 = var_0_1.GetGameUseTimes()
		local var_1_25 = var_0_1.GetGameTimes()

		findTF = var_16

		local var_1_26 = var_16(arg_1_0.menuUI, "chapter/" .. iter_1_0 .. "/icon_bg/icon")
		local var_1_27 = {
			type = var_1_17[iter_1_0][1],
			id = var_1_17[iter_1_0][2],
			amount = var_1_17[iter_1_0][3]
		...
		var_1_10018(var_1_26, var_1_27)

		onButton = var_1_10018

		local var_1_28 = arg_1_0._event
		local var_1_29 = var_1_26
		...
		local function var_1_30()
			...
			var_8_1(var_8_0, var_2_10002.ON_DROP, var_1_27)
		...
		var_1_10018(var_1_28, var_1_29, var_1_30, var_1_10022)

		findTF = var_1_10018
		var_1_10018 = var_1_10018(arg_1_0.menuUI, "chapter/" .. iter_1_0)
		onButton = var_19

		local var_1_31 = arg_1_0._event
		local var_1_32 = var_1_10018

		function var_1_10022()
			if var_1_24 == 7 and var_1_25 == 0 then
				var_0_1.selectRound = var_1_10011
		...
		var_19(var_1_31, var_1_32, var_1_10022, var_1_10023)

		table = var_19

		var_19.insert(arg_1_0._chapters, var_1_10018)
	end
...
function var_0_0.update(arg_11_0, arg_11_1)
	...
	for iter_11_0 = 1, 7 do
		...
		var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "close"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "got"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "active"), false)

		setActive = var_1_10008
		findTF = var_1_10009

		var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "icon_bg"), false)

		if iter_11_0 <= var_11_0 then
			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "got"), true)
		elseif iter_11_0 == var_11_0 + 1 and 1 <= var_11_1 then
			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "active"), true)

			setActive = var_1_10008
			findTF = var_1_10009

			var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "icon_bg"), true)
		elseif var_11_0 < iter_11_0 and iter_11_0 <= var_11_0 + var_11_1 then
			-- block empty
		else
			setActive = var_1_10008
			...
			var_1_10008(var_1_10009(arg_11_0._chapters[iter_11_0], "close"), true)
		end
