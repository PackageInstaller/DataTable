...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_1(var_1_0, var_1_10005.TRACK_EVENT_MATCH, function(arg_2_0, arg_2_1, arg_2_2)
		if arg_2_1 then
			...
			for iter_2_0 = 1, #arg_1_0.prepareTracks do
				if arg_1_0.prepareTracks[iter_2_0].id == var_2_0 then
					...
					var_11(var_2_5 .. var_2_10013(var_2_3) .. " subtime is " .. var_2_4)
		...
		if arg_6_0.trackData then
			...
			if 0 <= var_6_3 then
				...
				if var_6_3 <= var_4.beat_prepare then
					...
					var_6_5(var_6_4, var_1_10006.TRACK_TRIGGER, {
			...
			if var_6_3 <= 0 and arg_6_0.trackData.begin_time == arg_6_0.trackData.end_time then
				...
				if var_4.abs(var_6_3) >= arg_6_0.beatOffset then
					...
					var_6_7(var_6_6, var_1_10006.TRACK_REMOVE, arg_6_0.trackData)
...
function var_0_0.createTrackList(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_2(var_12_0) do
		...
		local var_12_3 = var_10.floor

		tonumber = var_1_10011
		var_12_2.begin_time = var_12_3(var_1_10011(iter_12_1.begin_time) * 1000)
		math = var_10

		local var_12_4 = var_10.floor

		tonumber = var_1_10011
		var_12_2.end_time = var_12_4(var_1_10011(iter_12_1.end_time) * 1000)
