...
local function var_0_2(arg_3_0, arg_3_1)
	...
	typeof = var_1_10004
	SpineAnimUI = var_1_10005

	local var_3_2 = var_3_1(var_3_0, var_1_10004(var_1_10005), true)
	local var_3_3 = var_2.ToTable(var_3_2)

	ipairs = var_3_2

	for iter_3_0, iter_3_1 in var_3_2(var_3_3) do
		IsNil = var_1_10008
...
function var_0_0.InitTimer(arg_4_0)
	...
	local function var_4_1()
		...
		RacingMiniGameConfig = var_2_10002

		var_5_1(var_5_0, var_2_10002.TIME_INTERVAL)

		return
	end

	RacingMiniGameConfig = var_1_10003
	arg_4_0.timer = var_4_0(var_4_1, var_1_10003.TIME_INTERVAL, -1)
	IsUnityEditor = var_1
...
function var_0_0.InitGameUI(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in var_2({
		...
		local var_7_3 = var_8.Find(var_7_2, "bottom/btn_" .. iter_7_1)

		typeof = var_7_2
		EventTriggerListener = var_10

		local var_7_4 = var_1_10007(var_7_3, var_7_2(var_10))

		var_1_10007.AddPointDownFunc(var_7_4, function()
			arg_7_0[iter_7_1] = true

			return
		end)
		var_1_10007:AddPointUpFunc(function()
	...
	if var_2.BOOST_BUTTON_TYPE_CHANGE then
		...
		local var_7_5 = arg_7_0.rtController
		local var_7_6 = var_3.Find(var_7_5, "bottom/btn_boost")

		typeof = var_7_5
		EventTriggerListener = var_5

		var_2(var_7_6, var_7_5(var_5))
		...
		var_2(var_7_7, var_4.Find(var_7_8, "bottom/btn_boost"), function()
			if not arg_7_0.target.isBlock then
				...
				RacingMiniGameConfig = var_2_10005
				var_10_2.enginePower = var_10_3(var_10_4 + var_2_10005.BOOST_RATE[2], var_10_0[1], var_10_0[#var_10_0])
	...
	local var_7_9 = arg_7_0.rtController

	arg_7_0.rtTime = var_2.Find(var_7_9, "top/time")
	setText = var_2

	local var_7_10 = arg_7_0.rtTime
	local var_7_11 = var_3.Find(var_7_10, "Text/plus")
	local var_7_12 = "+"

	RacingMiniGameConfig = var_5

	var_2(var_7_11, var_7_12 .. var_5.ITEM_ADD_TIME .. "s")

	local var_7_13 = arg_7_0.rtTime
	local var_7_14 = var_2.Find(var_7_13, "Text/plus")
	local var_7_15 = var_2.GetComponent

	typeof = var_4
	DftAniEvent = var_5

	local var_7_16 = var_7_15(var_7_14, var_4(var_5))

	var_2.SetEndEvent(var_7_16, function()
		setActive = var_2_10000

		local var_11_0 = arg_7_0.rtTime

		var_2_10000(var_1.Find(var_11_0, "Text/plus"), false)
	...
	arg_7_0.rtDis = var_2.Find(var_7_17, "top/dis")

	local var_7_18 = arg_7_0.rtController

	arg_7_0.rtPower = var_2.Find(var_7_18, "bottom/speed")

	local var_7_19 = arg_7_0.rtController

	arg_7_0.rtFriend = var_2.Find(var_7_19, "top/friend")
	arg_7_0.queue = {}
...
function var_0_0.ReadyGame(arg_13_0, arg_13_1)
	...
	underscore = var_13_0
	arg_13_0.rankData = var_13_0.filter(arg_13_1, function(arg_14_0)
	...
	local var_13_6 = var_5.Find(var_13_5, "qiye_minigame")
	local var_13_7 = arg_13_0.rtMainContent
	local var_13_8 = var_13_3(var_13_6, var_6.Find(var_13_7, -2))

	NewPos = var_13_6
	arg_13_0.target = var_13_4(var_13_8, var_13_6(0, 0), arg_13_0)
	table = var_3

	local var_13_9 = var_3.insert
	local var_13_10 = arg_13_0.queue

	RacingMiniNameSpace = var_5

	local var_13_11 = var_5.StartMark.New

	cloneTplTo = var_6

	local var_13_12 = arg_13_0.rtRes
	local var_13_13 = var_7.Find(var_13_12, "start_mark")
	local var_13_14 = arg_13_0.rtMainContent
	local var_13_15 = var_6(var_13_13, var_8.Find(var_13_14, -2))

	NewPos = var_13_13

	var_13_9(var_13_10, var_13_11(var_13_15, var_13_13(550, 0), arg_13_0))
...
function var_0_0.OnTimer(arg_22_0, arg_22_1)
	...
	RacingMiniGameConfig = var_1_10005
	var_22_1.x = var_22_3(var_22_2, var_1_10005.BOOST_RATE[not arg_22_0.target.isBlock and arg_22_0.boost and 2 or 1] * arg_22_1) * arg_22_1
	...
	if not arg_22_0.target.isBlock then
		if var_3 > 0 then
			...
			if arg_22_0.target.isVertigo then
				...
				var_22_10(var_22_9, var_22_1 * var_6(0, 1), arg_22_0.singleHeight)

				setParent = var_22_10

				local var_22_11 = arg_22_0.target.rt
				local var_22_12 = arg_22_0.rtMainContent
				local var_22_13 = var_6.Find

				math = var_8

				local var_22_14 = var_8.clamp

				math = var_1_10009

				var_22_10(var_22_11, var_22_13(var_22_12, var_22_14(var_1_10009.floor((arg_22_0.target.pos.y + arg_22_0.singleHeight) * 3 / 2 / arg_22_0.singleHeight) - 1, -1, 1) - 1))
				...
				while var_22_15 <= #arg_22_0.queue do
					...
					var_22_17(var_22_16, var_22_1 * var_8(-1, 0))
...
function var_0_0.UpdateDisplay(arg_23_0)
	...
	local var_23_2 = var_3.Find(var_23_1, "Text")

	string = var_23_1

	local var_23_3 = var_23_1.format
	local var_23_4 = "%02d:%02ds"

	math = var_1_10006

	local var_23_5 = var_1_10006.floor(var_23_0)

	math = var_7

	local var_23_6 = var_7.floor

	math = var_1_10008

	var_2(var_23_2, var_23_3(var_23_4, var_23_5, var_23_6((var_23_0 - var_1_10008.floor(var_23_0)) * 100)))
	...
	var_23_2(var_23_8, var_23_4.format("%.2fm", var_23_7 - var_23_7 % 0.01))

	RacingMiniGameConfig = var_23_2

	local var_23_9 = var_23_2.BUOY_POWER_LIST

	RacingMiniGameConfig = var_23_8

	local var_23_10 = var_23_8.BUOY_POS_LIST
	local var_23_11

	ipairs = var_6

	for iter_23_0, iter_23_1 in var_6(var_23_9) do
		if arg_23_0.enginePower <= iter_23_1 then
			var_23_11 = iter_23_0
	...
	local var_23_13 = var_7.Find(var_23_12, "range/buoy")
	local var_23_14 = {}
	local var_23_15
	...
	for iter_23_2, iter_23_3 in var_6(arg_23_0.target.effectList) do
		...
		var_1_10011(iter_23_3, var_23_11 - 1 == iter_23_2)
	end
	...
	if arg_23_0.friendDirty then
		...
		if arg_23_0.friendInfo then
			...
			var_8(var_9.Find(var_23_20, "Text"), arg_23_0.friendInfo.name)

			setText = var_8

			local var_23_21 = arg_23_0.rtFriend
			local var_23_22 = var_9.Find(var_23_21, "point")

			string = var_23_21

			var_8(var_23_22, var_23_21.format("%.2fm", arg_23_0.friendInfo.score / 100))
		end
	end
...
function var_0_0.CreateNewObject(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1_10002(var_1_10003.FIELD_CONFIG) do
	...
	for iter_24_3 = -1, 1 do
		...
		ipairs = var_1_10010
		classCfg = var_1_10011

		for iter_24_4, iter_24_5 in var_1_10010(var_1_10011) do
		...
		for iter_24_6, iter_24_7 in var_1_10011(var_12) do
		...
		if var_1_10010 then
			...
			RacingMiniNameSpace = var_13

			if var_1_10011(var_24_10, var_13.Item) then
				defaultValue = var_1_10011
				var_1_10011 = var_1_10011(arg_24_0.itemCountDic[var_1_10010], 0)
				defaultValue = var_24_10

				if var_1_10011 < var_24_10(var_24_0.item_create_limit[var_1_10010], 0) then
					var_1_10011 = arg_24_0.itemCountDic
					defaultValue = var_24_10
					var_1_10011[var_1_10010] = var_24_10(arg_24_0.itemCountDic[var_1_10010], 0) + 1
				else
					var_1_10010 = nil
				end
			end
		...
		if var_1_10010 then
			RacingMiniNameSpace = var_1_10011
			var_1_10011 = var_1_10011[var_1_10010].New
			cloneTplTo = var_24_10

			local var_24_11 = arg_24_0.rtRes
			local var_24_12 = var_13.Find(var_24_11, var_0_4[var_1_10010])
			local var_24_13 = arg_24_0.rtMainContent
			local var_24_14 = var_24_10(var_24_12, var_14.Find(var_24_13, iter_24_3))

			NewPos = var_24_12
			var_1_10011 = var_1_10011(var_24_14, var_24_12(arg_24_0.bgSingleSize * 1.5 + arg_24_0.chargeDis, iter_24_3 * arg_24_0.singleHeight), arg_24_0)
			table = var_24_14

			var_24_14.insert(arg_24_0.queue, var_1_10011)

			arg_24_0.rateDic[iter_24_3] = arg_24_0.rateDic[iter_24_3] * var_24_0.continue_reduce
		else
			var_1_10011 = arg_24_0.rateDic
			var_1_10011[iter_24_3] = arg_24_0.rateDic[iter_24_3] + var_24_0.bye_plus
		end
	end
...
function var_0_0.AddTime(arg_26_0, arg_26_1)
	...
	var_2(var_3.Find(var_26_0, "Text/plus"), true)
