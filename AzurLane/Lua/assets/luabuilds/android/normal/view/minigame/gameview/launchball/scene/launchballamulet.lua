...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5)
	...
	for iter_1_0, iter_1_1 in var_6(var_0_26) do
		...
		var_1_10015 = var_1_10015.ui_atlas

		local var_1_3 = var_1_2 .. "L"

		typeof = var_17
		RuntimeAnimatorController = var_1_10018
		var_1_10014 = var_1_10014(var_1_10015, var_1_3, var_17(var_1_10018))
		LoadAny = var_1_10015
		...
		var_1_10015 = var_1_10015(var_1_4, var_1_5, var_1_10018(var_1_10019))
		LoadAny = var_1_4
		LaunchBallGameVo = var_1_5

		local var_1_6 = var_1_5.ui_atlas

		var_1_10018 = var_1_2 .. "EF"
		typeof = var_1_10019
		RuntimeAnimatorController = var_1_10020

		local var_1_7 = var_1_4(var_1_6, var_1_10018, var_1_10019(var_1_10020))

		table = var_1_6

		var_1_6.insert(arg_1_0.amuletLAnimators, {
...
function var_0_0.start(arg_2_0)
	...
	local var_2_2 = var_1_10003(var_2_1, var_1_10005(var_2_0))

	typeof = var_2_1
	BoxCollider2D = var_5
	arg_2_0.lifeBound = var_1_10002(var_2_2, var_2_1(var_5))
	...
	math = var_3
	arg_2_0.rad = var_2_5 * var_3.deg2Rad
...
function var_0_0.step(arg_3_0)
	if not arg_3_0.isPlaying then
		...
		if arg_3_0.amuletL then
			...
			arg_3_0.setAmuletL(var_1_10002, arg_3_0:getAmulete(var_0_10, arg_3_0.amuletNextType))

			var_1_10002 = arg_3_0

			arg_3_0.returnAmulete(var_1_10002, arg_3_0.amuletS, arg_3_0.amuletSPool)

			var_1_10002 = arg_3_0
			arg_3_0.amuletNextType = arg_3_0.getRandomAmuletType(var_1_10002)
			arg_3_0.amuletS = nil
			var_1_10002 = arg_3_0
			arg_3_0.amuletS = arg_3_0.getAmulete(var_1_10002, var_0_9, arg_3_0.amuletNextType)
		end
		...
		if arg_3_0.amuletS then
			...
			local var_3_3 = var_1_10003.cos(arg_3_0.rad) * var_0_19

			math = var_4
			var_3_2.anchoredPosition = var_1_10002(var_3_3, var_4.sin(arg_3_0.rad) * var_0_19)
		end
	end
		...
		for iter_3_0 = #arg_3_0._amuletFires, 1, -1 do
			...
			if not (var_3_8.abs(var_6.x) > var_0_23) then
				...
				if var_7.abs(var_6.y) > var_0_23 then
					...
					arg_3_0:returnAmulete(var_5, arg_3_0.amuletLPool)
...
function var_0_0.getAmulete(arg_6_0, arg_6_1, arg_6_2)
	...
	if not var_6_0 then
		...
		local var_6_5 = var_8(var_9(var_6_2))
		...
		local var_6_7 = var_11(var_6_5, "ad/anim")

		typeof = var_12
		Animator = var_13

		local var_6_8 = var_10(var_6_7, var_12(var_13))

		setParent = var_6_7

		var_6_7(var_6_5, var_6_4)
...
function var_0_0.fireAmulet(arg_9_0)
	if arg_9_0.amuletL then
		...
		var_9_1(var_9_0, var_1_10003.SFX_FIRE)

		local var_9_2 = arg_9_0.amuletPos

		math = var_9_0
		var_9_2.x = var_9_0.cos(arg_9_0.rad) * var_0_18
		...
		local var_9_5 = var_3.cos(arg_9_0.amuletL.rad) * var_0_20

		math = var_4
		var_9_4.speed = var_2(var_9_5, var_4.sin(arg_9_0.amuletL.rad) * var_0_20)
...
function var_0_0.randomFireAmulet(arg_10_0, arg_10_1)
	...
	var_10_1(var_10_0, var_1_10004.SFX_FIRE)

	local var_10_2 = arg_10_0
	local var_10_3 = arg_10_0.getAmulete(var_10_2, var_0_10, arg_10_0:getRandomAmuletType())

	pairs = var_10_2

	for iter_10_0, iter_10_1 in var_10_2(arg_10_1) do
		var_10_3[iter_10_0] = iter_10_1
	end

	math = var_3

	local var_10_4 = var_3.random(1, 360)

	math = var_4

	local var_10_5 = var_4.deg2Rad * var_10_4
	local var_10_6 = var_10_3.tf

	Vector2 = iter_10_0
	var_10_6.anchoredPosition = iter_10_0(0, 0)
	var_10_3.rad = arg_10_0.rad
	Vector2 = var_5
	math = var_6

	local var_10_7 = var_6.cos(var_10_5) * var_0_20

	math = var_7
	var_10_3.speed = var_5(var_10_7, var_7.sin(var_10_5) * var_0_20)

	local var_10_8 = var_10_3.anim

	var_5.Play(var_10_8, "L_Fire")

	findTF = var_6

	local var_10_9 = var_6(var_10_3.tf, "ad")

	Vector3 = var_7
	var_10_9.localEulerAngles = var_7(0, 0, var_10_4 + var_0_21)
	table = var_10_9

	var_10_9.insert(arg_10_0._amuletFires, var_10_3)
...
function var_0_0.createEF(arg_12_0, arg_12_1)
	...
	local var_12_5 = var_7.sin(arg_12_1.rad)
	...
	Vector2 = var_13
	var_12_10.anchoredPosition = var_13(var_12_8, var_12_9)
...
function var_0_0.getRandomAmuletType(arg_13_0)
	...
	if var_1_10001.enemyColors then
		...
		if #var_13_0.enemyColors == 0 then
			...
			return var_13_1[var_13_2(var_13_3, #var_1_10004.enemyColors)]
		end
...
function var_0_0.getAmuletPos(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_1 = var_4.sin(arg_15_2)
...
function var_0_0.createButterfly(arg_19_0)
	...
	local var_19_0 = var_1_10001(var_1_10002(arg_19_0._butterflyTpl))

	GetComponent = var_2
	findTF = var_3

	local var_19_1 = var_3(var_19_0, "ad/anim")

	typeof = var_4
	Animator = var_5

	local var_19_2 = var_2(var_19_1, var_4(var_5))

	Vector2 = var_19_1
	math = var_4

	local var_19_3 = var_4.random(1, 20)

	math = var_5
	var_19_0.anchoredPosition = var_19_1(var_19_3, var_5.random(1, 20))
	math = var_3
	...
	local var_19_5 = var_4.deg2Rad * var_19_4

	Vector2 = var_5
	math = var_6

	local var_19_6 = var_6.cos(var_19_5) * var_0_17

	math = var_7

	local var_19_7 = var_5(var_19_6, var_7.sin(var_19_5) * var_0_17)
	local var_19_8 = 3
