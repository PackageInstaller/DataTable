...
function var_0_1.initUI(arg_57_0)
	...
	local function var_57_30()
		...
		var_67_2.helps = var_3.getGameRoomData(var_67_3).game_help
...
function var_0_1.showSettlement(arg_100_0)
	...
	local var_100_3 = var_100_1(var_4)
	local var_100_4 = var_3.getRoomScore(var_100_3, arg_100_0:getGameRoomData().id)

	setActive = var_100_3
	findTF = var_5

	var_100_3(var_5(arg_100_0.settlementUI, "ad/new"), var_100_4 < var_100_2)
	...
	local var_100_5 = var_100_3(arg_100_0.settlementUI, "ad/highText")

	findTF = var_5

	local var_100_6 = var_5(arg_100_0.settlementUI, "ad/currentText")
