...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.replaceList = var_2_0(var_2_2, var_3.Find(var_2_3, "bg/frame/bg/talents/content/talent"))
	...
	var_1(var_2.Find(var_2_9, "bg/frame/consume"), false)

	setText = var_1

	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_2.Find(var_2_10, "bg/frame/bg/title/Text")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("commander_choice_talent_3"))

	setText = var_1

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_2.Find(var_2_12, "bg/frame/bg/talents/title/Text")

	i18n = var_2_12

	var_1(var_2_13, var_2_12("commander_choice_talent_2"))
...
function var_0_1.UpdateList(arg_8_0, arg_8_1)
	...
	var_4.make(var_8_2, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			local function var_9_3()
				if arg_8_0.prevToggle ~= arg_9_2 then
					...
					if arg_8_0.prevToggle then
						...
						var_0(var_1.Find(var_10_1, "mark"), false)
					end
					...
					var_10_2(var_1.Find(var_10_3, "mark"), true)
				end
			...
			var_4(var_9_1, var_9_2, var_9_3, var_2_10008)
...
function var_0_1.UpdateTalents(arg_11_0, arg_11_1, arg_11_2)
	...
	local function var_11_3()
		if arg_11_2 and arg_11_1 and var_11_0 then
			...
			if var_0.getConfig(var_12_0, "worth") > 1 then
				...
				var_12_3 = {}
				i18n = var_2_10003
				var_12_3.content = var_2_10003("commander_ability_replace_warning")
				...
				function var_12_3.onYes()
					...
					var_13_1(var_13_0, var_3_10002.LEARN_TALENT, var_11_0.id, arg_11_1.id, arg_11_2.id)
	...
	var_4(var_11_1, var_11_2, var_11_3, var_1_10008)
...
function var_0_1.UpdateTalentCard(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_2 = arg_14_1.Find(var_14_1, "lock")

	if arg_14_2 then
		GetImageSpriteFromAtlasAsync = var_14_1

		var_14_1("CommanderTalentIcon/" .. arg_14_2:getConfig("icon"), "", var_14_0:Find("icon"))

		local var_14_3 = var_14_0

		if var_14_0.Find(var_14_3, "tree_btn") then
			onButton = var_14_3
			...
			var_14_3(var_14_4, var_14_5, var_14_6, var_10)
		end

		setText = var_14_3

		var_14_3(var_14_0:Find("name_bg/Text"), arg_14_2:getConfig("name"))

		setScrollText = var_14_3

		var_14_3(var_14_0:Find("desc/Text"), arg_14_2:getConfig("desc"))
	end

	setActive = var_14_1

	var_14_1(var_14_0, arg_14_2)

	if var_14_2 then
		setActive = var_14_1

		var_14_1(var_14_2, not arg_14_2)
	end
...
function var_0_1.Hide(arg_16_0)
	...
	if arg_16_0.prevToggle then
		...
		var_1(var_2.Find(var_16_0, "mark"), false)
