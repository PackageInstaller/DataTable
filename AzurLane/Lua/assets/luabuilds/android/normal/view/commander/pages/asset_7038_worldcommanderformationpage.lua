...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_5 = var_2.Find(var_2_4, "text_bg/Text")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("world_catsearch_help_4"))
	...
	local var_2_10 = var_2.Find(var_2_9, "text_bg/Text")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("world_catsearch_help_5"))
	...
	local var_2_17 = var_2.Find(var_2_16, "atttr_panel/abilitys/mask/content")
	local var_2_18 = arg_2_0.descFrameTF

	arg_2_0.abilitysTF = var_2_15(var_2_17, var_3.Find(var_2_18, "atttr_panel/abilitys/mask/content/attr"))
	UIItemList = var_1

	local var_2_19 = var_1.New
	local var_2_20 = arg_2_0.descFrameTF
	local var_2_21 = var_2.Find(var_2_20, "atttr_panel/talents/mask/content")
	local var_2_22 = arg_2_0.descFrameTF

	arg_2_0.talentsTF = var_2_19(var_2_21, var_3.Find(var_2_22, "atttr_panel/talents/mask/content/attr"))
	...
	var_1(var_2_27, var_2_28, var_2_29, var_5)
	...
	var_1(var_2_30, var_2_31, var_2_32, var_5)

	setText = var_1

	local var_2_33 = arg_2_0.rtAdapt
	local var_2_34 = var_2.Find(var_2_33, "desc/frame/atttr_panel/abilitys/title/Text")

	i18n = var_2_33

	var_1(var_2_34, var_2_33("commander_subtile_ablity"))

	setText = var_1

	local var_2_35 = arg_2_0.rtAdapt
	local var_2_36 = var_2.Find(var_2_35, "desc/frame/atttr_panel/talents/title/Text")

	i18n = var_2_35

	var_1(var_2_36, var_2_35("commander_subtile_talent"))
...
function var_0_1.Update(arg_5_0, arg_5_1)
	...
	for iter_5_0 = var_5_2, var_1_10004.MAX_FORMATION_POS do
	...
	var_3(var_5_4, var_5.IsCatSalvage(var_5_5))
	...
	var_3(var_5_6, var_5.IsCatSalvage(var_5_7))
...
function var_0_1.updateSkillTF(arg_14_0, arg_14_1, arg_14_2)
	...
	if arg_14_1 then
		...
		local function var_14_6()
			...
			WorldDetailMediator = var_2_10002

			var_15_1(var_15_0, var_2_10002.OnCmdSkill, var_1_10003)
...
function var_0_1.updateCommander(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	...
	if arg_16_3 then
		...
		if arg_16_1.Find(var_16_5, "info/name") then
			...
			local var_16_6 = var_9

			var_1_10013 = arg_16_3

			var_16_5(var_16_6, arg_16_3.getName(var_1_10013))
		end

		Commander = var_16_5

		local var_16_7 = var_16_5.rarity2Frame(arg_16_3:getRarity())
		...
		var_11(var_16_8, var_1_10013("weaponframes", "commander_" .. var_16_7))
	end
...
function var_0_1.OnDestroy(arg_17_0)
	...
	if arg_17_0.isShowing(var_17_0) then
		...
		var_17_2(var_2(arg_17_0.descFrameTF))
