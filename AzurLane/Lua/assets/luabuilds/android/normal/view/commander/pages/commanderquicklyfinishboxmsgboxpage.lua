...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".CommanderMsgBoxPage"))
...
function var_0_1.Show(arg_3_0, arg_3_1)
	...
	i18n = var_3
	var_3_0.text = var_3("acceleration_tips_3")
	onButton = var_3_0
	...
	local function var_3_3()
		...
		if var_4_1 <= 0 then
			...
			var_4_6(var_4_5, var_2_10006("noacceleration_tips"))
...
function var_0_1.UpdateContent(arg_5_0)
	...
	local var_5_6 = var_6("acceleration_tips_2", var_5_4[1], var_5_4[2], var_5_4[3])
...
function var_0_1.InitToggle(arg_6_0)
	...
	local var_6_10 = arg_6_0.GetConfig(var_6_9)

	triggerToggle = var_6_9

	var_6_9(arg_6_0.ssrToggle, var_6_10[1])

	triggerToggle = var_6_9

	var_6_9(arg_6_0.srToggle, var_6_10[2])

	triggerToggle = var_6_9

	var_6_9(arg_6_0.rToggle, var_6_10[3])
