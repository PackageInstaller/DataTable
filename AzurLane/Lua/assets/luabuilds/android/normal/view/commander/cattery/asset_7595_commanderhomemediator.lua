...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_CLEAN, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.COMMANDER_CATTERY_OP, {
			op = 1
		})
	...
	arg_1_0:bind(var_0_1.ON_FEED, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.COMMANDER_CATTERY_OP, {
			op = 2
		})
	...
	arg_1_0:bind(var_0_1.ON_PLAY, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.COMMANDER_CATTERY_OP, {
			op = 3
		})
	...
	arg_1_0:bind(var_0_1.ON_SEL_COMMANDER, function(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
		...
		var_5_1(var_5_0, var_7.PUT_COMMANDER_IN_CATTERY, {
			id = arg_5_1,
			commanderId = arg_5_2,
			tip = arg_5_3,
			callback = arg_5_4
	...
	arg_1_0:bind(var_0_1.ON_CHANGE_STYLE, function(arg_6_0, arg_6_1, arg_6_2)
		...
		var_6_1(var_6_0, var_2_10005.COMMANDER_CHANGE_CATTERY_STYLE, {
			id = arg_6_1,
			styleId = arg_6_2
		})
	...
	var_1_1(var_1_0, var_3.GetCommanderHome(var_1_2))
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.PUT_COMMANDER_IN_CATTERY_DONE then
		...
		if var_8_0 == var_4.COMMANDER_CHANGE_CATTERY_STYLE_DONE then
			...
			if var_8_0 == var_4.COMMANDER_CATTERY_OP_DONE then
				...
				var_8_5({
					...
					function(arg_10_0)
						...
						var_10_1(var_10_0, var_2_10003.ON_ACHIEVE, var_8_2.awards, arg_10_0)
				...
				if var_8_0 == var_8_5.ZERO_HOUR_OP_DONE then
					...
					if var_8_0 == var_4.CALC_CATTERY_EXP_DONE then
