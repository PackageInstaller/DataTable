...
function var_0_0.selectedAnim(arg_3_0)
	...
	local var_3_1 = var_2.moveY

	rtf = var_1_10003

	local var_3_2 = var_3_1(var_1_10003(arg_3_0.infoTF), var_3_0, 0.1)
	local var_3_3 = var_2.setOnComplete

	System = var_4

	var_3_3(var_3_2, var_4.Action(function()
		...
		var_4_0(var_2_10001(arg_3_0.infoTF), 0, 0.1)
...
function var_0_0.ShortenString(arg_8_0, arg_8_1, arg_8_2)
	...
	while var_8_1 <= var_8_4 do
		...
		if var_1_10012.ceil(var_8_2) == arg_8_2 - 1 then
			var_8_3 = var_8_1
		elseif arg_8_2 < var_1_10012 then
			var_8_5 = true
