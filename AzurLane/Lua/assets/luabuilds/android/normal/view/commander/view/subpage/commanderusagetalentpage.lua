...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "bg/frame/bg/talents/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.usageList = var_2_0(var_2_2, var_3.Find(var_2_3, "bg/frame/bg/talents/content/talent"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.usageCostTxt = var_2_12(var_2_11, var_3(var_2_3))
	...
	local var_2_15 = var_2.Find(var_2_14, "bg/frame/bg/title/Text")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("commander_choice_talent_1"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "bg/frame/bg/talents/title/Text")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("commander_choice_talent_2"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_2.Find(var_2_18, "bg/frame/consume/label")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("word_consume"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_11()
		...
		elseif arg_3_0.talent then
			...
			var_7_3(var_7_2, var_2_10003.LEARN_TALENT, var_7_0.id, arg_3_0.talent.id, 0)
		end
...
function var_0_1.RegisterEvent(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10003.MSG_FETCH_TALENT_LIST, function(arg_9_0)
		if arg_8_0.commanderVO then
			getProxy = var_1
			CommanderProxy = var_2_10002

			local var_9_0 = var_1(var_2_10002)
	...
	var_8_3(var_8_2, var_3.MSG_LEARN_TALENT, function(arg_10_0)
		if arg_8_0.commanderVO then
			getProxy = var_1
			CommanderProxy = var_2_10002

			local var_10_0 = var_1(var_2_10002)
...
function var_0_1.FetchList(arg_14_0)
	...
	CommanderCatMediator = var_1_10003

	var_14_1(var_14_0, var_1_10003.FETCH_NOT_LEARNED_TALENT, arg_14_0.commanderVO.id)
...
function var_0_1.UpdateCard(arg_17_0, arg_17_1, arg_17_2)
	...
	var_17_0(arg_17_2:Find("up"), var_17_1)

	GetImageSpriteFromAtlasAsync = var_17_0

	var_17_0("CommanderTalentIcon/" .. arg_17_1:getConfig("icon"), "", arg_17_2)
	...
	local function var_17_4(arg_18_0)
		if arg_18_0 and (not arg_17_0.talent or arg_17_0.talent.id ~= arg_17_1.id) then
			...
			var_18_1(arg_17_0.usageCostIconTF, var_18_2 > 0)

			setActive = var_18_1

			var_18_1(arg_17_0.usageCostTxtTF, var_18_2 > 0)
			...
			var_18_3(var_18_4, var_4.hasTalent(var_18_5, arg_17_1))
			...
			var_18_3(var_18_6, not var_4.hasTalent(var_18_7, arg_17_1))
		end
	...
	var_17_0(var_17_2, var_17_3, var_17_4, var_9)
...
function var_0_1.UpdateTalentCard(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_2 = arg_19_1.Find(var_19_1, "lock")

	if arg_19_2 then
		GetImageSpriteFromAtlasAsync = var_19_1

		var_19_1("CommanderTalentIcon/" .. arg_19_2:getConfig("icon"), "", var_19_0:Find("icon"))

		local var_19_3 = var_19_0

		if var_19_0.Find(var_19_3, "tree_btn") then
			onButton = var_19_3
			...
			var_19_3(var_19_4, var_19_5, var_19_6, var_10)
		end

		setText = var_19_3

		var_19_3(var_19_0:Find("name_bg/Text"), arg_19_2:getConfig("name"))

		setScrollText = var_19_3

		var_19_3(var_19_0:Find("desc/Text"), arg_19_2:getConfig("desc"))
	end

	setActive = var_19_1

	var_19_1(var_19_0, arg_19_2)

	if var_19_2 then
		setActive = var_19_1

		var_19_1(var_19_2, not arg_19_2)
	end
