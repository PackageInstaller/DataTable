...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		if arg_3_0.selectedID >= 0 then
			...
			var_4_1(var_4_0, var_2_10002.ON_SEL_COMMANDER, arg_3_0.cattery.id, arg_3_0.selectedID)
		end
	...
	if arg_5_1.commanderVO then
		...
		if var_5_1 then
			...
			if arg_5_0.selectedID == var_5_0 then
				...
				var_5_4 = arg_5_0.emit
				CatteryDescPage = var_1_10007

				var_5_4(var_5_3, var_1_10007.CHANGE_COMMANDER, nil)
			else
				setActive = var_5_4

				var_5_4(arg_5_1.mark2, true)
				...
				var_5_4 = arg_5_0.emit
				CatteryDescPage = var_7

				var_5_4(var_5_5, var_7.CHANGE_COMMANDER, arg_5_1.commanderVO)
			end
		else
			pg = var_5_4

			local var_5_6 = var_5_4.TipsMgr.GetInstance()

			var_5.ShowTips(var_5_6, var_5_2)
		end
	end
...
function var_0_1.OnUpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_8_1 then
		...
		local var_8_5 = arg_8_0.CheckIncludeSelf(var_8_4, var_8_1.id)

		setActive = var_8_4

		local var_8_6 = var_8_2._tf

		var_8_4(var_9.Find(var_8_6, "info/home"), not var_8_5)
	end
