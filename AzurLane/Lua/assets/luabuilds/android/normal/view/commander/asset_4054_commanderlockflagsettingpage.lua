...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_10 = var_2.Find(var_2_9, "frame/toggles/scrollrect/content/talent")
	local var_2_11 = arg_2_0._tf

	arg_2_0.talentUIlist = var_2_8(var_2_10, var_3.Find(var_2_11, "frame/toggles/scrollrect/content/talent/tpl"))
	...
	typeof = var_3
	Text = var_2_11
	arg_2_0.descTxt = var_2_14(var_2_13, var_3(var_2_11))
	setText = var_1

	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_2.Find(var_2_15, "frame/title/rarity")

	i18n = var_2_15

	var_1(var_2_16, var_2_15("word_rarity") .. ": ")

	setText = var_1

	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_2.Find(var_2_17, "frame/title/talent")

	i18n = var_2_17

	var_1(var_2_18, var_2_17("word_talent") .. ": ")

	setText = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_2.Find(var_2_19, "frame/desc/Text")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("commander_lock_setting_title"))
	...
	local function var_3_11()
		...
		if not var_0.UnselAnyTalent(var_7_0) then
			...
			if var_0.UnselAnyRarity(var_7_1) then
				...
				i18n = var_2_10004
				var_7_5.content = var_2_10004("commander_unsel_lock_flag_tip")
...
function var_0_1.InitRarity(arg_13_0)
	...
	var_2(var_13_1, var_13_2, var_13_3, var_1_10006)
	...
	var_2(var_13_4, var_13_5, var_13_6, var_1_10006)
	...
	var_2(var_13_7, var_13_8, var_13_9, var_1_10006)
...
function var_0_1.InitTalent(arg_17_0)
	...
	var_3.make(var_17_2, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			var_5(var_18_2, var_18_3, var_18_4, var_2_10009)
	...
	for iter_17_0, iter_17_1 in var_3(var_17_0) do
		if arg_17_0.talentCards[iter_17_0] then
			...
			var_8(arg_17_0.talentCards[iter_17_0], iter_17_1)
		end
	end
	...
	var_3(var_17_4, var_17_5, var_17_6, iter_17_1)
...
function var_0_1.AnyCardUnSelected(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10001(arg_22_0.talentCards) do
		...
		if not var_22_1(var_22_0, var_1_10008(var_1_10009)).isOn then
			return true
		end
	end
