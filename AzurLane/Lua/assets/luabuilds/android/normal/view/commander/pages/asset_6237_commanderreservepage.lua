...
function var_0_1.OnInit(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.countTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.totalTxt = var_2_11(var_2_10, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.box1 = var_2_18(var_2_17, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.box2 = var_2_21(var_2_20, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.box3 = var_2_24(var_2_23, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.box4 = var_2_27(var_2_26, var_3(var_1_10004))
	...
	arg_2_0.animtion = var_2_30(var_2_29, var_3(var_1_10004))
	...
	arg_2_0.aniEvt = var_2_32(var_2_31, var_3(var_1_10004))
	...
	var_1(var_2_37, var_2_38, var_2_39, var_1_10005)
	...
	var_1(var_2_40, var_2_41, var_2_42, var_2_43, var_2_44, var_2_45, var_2_46, var_1_10009)
	...
	var_1(var_2_47, var_2_48, var_2_49, var_2_50, var_2_51, var_2_52, var_2_53, var_1_10009)
	...
	local function var_2_59()
		...
		local var_7_1 = var_1(var_2_10002)
	...
	local var_2_64 = var_2.Find(var_2_63, "frame/bg1/tip")

	i18n = var_2_63

	var_1(var_2_64, var_2_63("commander_build_rate_tip"))

	setText = var_1

	local var_2_65 = arg_2_0._tf
	local var_2_66 = var_2.Find(var_2_65, "frame/bg1/label")

	i18n = var_2_65

	var_1(var_2_66, var_2_65("commander_get_box_tip"))

	setText = var_1

	local var_2_67 = arg_2_0._tf
	local var_2_68 = var_2.Find(var_2_67, "frame/bg1/label1")

	i18n = var_2_67

	var_1(var_2_68, var_2_67("commander_total_gold"))

	setText = var_1

	local var_2_69 = arg_2_0._tf
	local var_2_70 = var_2.Find(var_2_69, "frame/bg1/Text")

	i18n = var_2_69

	var_1(var_2_70, var_2_69("commander_get_box_tip_1"))
...
function var_0_1.OnConfirm(arg_9_0, arg_9_1, arg_9_2)
	...
	if arg_9_1 > var_3.getRawData(var_9_0).gold then
		...
		local var_9_4 = var_1_10006(var_9_3, var_1_10008("word_gold"))

		ChargeScene = var_9_3

		var_9_2(var_9_1, var_9_4, var_9_3.TYPE_ITEM, {
			{
				59001,
				arg_9_1 - var_3.gold,
				arg_9_1
	...
	i18n = var_1_10009
	var_9_9.content = var_1_10009(var_9_5, arg_9_1, arg_9_2)
	...
	function var_9_9.onYes()
		...
		var_10_1(var_10_0, var_2_10002.RESERVE_BOX, arg_9_2)
...
function var_0_1.GoShoppingMsgBox(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	if arg_11_3 then
		...
		for iter_11_0, iter_11_1 in var_1_10005(arg_11_3) do
			...
			i18n = var_1_10012
			var_1_10004 = var_11_0 .. var_1_10012(iter_11_1[1] == 59001 and "text_noRes_info_tip" or "text_noRes_info_tip2", var_1_10010, iter_11_1[2])

			if iter_11_0 < #arg_11_3 then
				local var_11_1 = var_1_10004

				i18n = var_1_10012
				var_1_10004 = var_11_1 .. var_1_10012("text_noRes_info_tip_link")
			end
		end
		...
		if var_1_10004 ~= "" then
			...
			i18n = var_1_10007
			arg_11_1 = var_11_2 .. var_11_3 .. var_1_10007("text_noRes_tip", var_1_10004)
		end
	end
	...
	rtf = var_1_10007
	pg = iter_11_0
	var_11_6.parent = var_1_10007(iter_11_0.UIMgr.GetInstance().OverlayToast)
...
function var_0_1.OnLoaded(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10003.MSG_RESERVE_BOX, function(arg_14_0, arg_14_1)
...
function var_0_1.OnReserveDone(arg_15_0, arg_15_1)
	...
	var_2({
		...
		function(arg_17_0)
			...
			var_17_2(var_17_1, var_2_10003.ON_AWARD, {
				items = arg_15_1
			})
			arg_17_0()
...
function var_0_1.endAnim(arg_21_0)
	...
	for iter_21_0 = 0, arg_21_0.boxMove.childCount - 1 do
		var_1_10006 = arg_21_0.boxMove

		local var_21_0 = var_5.GetChild(var_1_10006, iter_21_0)
		...
		var_5.SetTriggerEvent(var_22_3, function(arg_23_0)
			...
			for iter_23_2, iter_23_3 in var_1(arg_22_1) do
				for iter_23_4 = 1, iter_23_3.count do
					...
					System = var_12
					var_2_10010 = var_2_10010(var_23_0, var_12.Action(function()
					...
					var_23_0.insert(arg_22_0.tweenList, var_2_10010)
				end
			...
			local var_23_3 = var_3.delayedCall
			local var_23_4 = 0.2 + 1 * (var_22_2 - 1)

			System = iter_23_3

			var_23_1(var_23_2, var_23_3(var_23_4, iter_23_3.Action(function()
			...
			local var_23_7 = var_3.delayedCall
			local var_23_8 = 0.2 + 1 * (var_22_2 - 1) + 2

			System = var_5

			var_23_5(var_23_6, var_23_7(var_23_8, var_5.Action(function()
...
function var_0_1.playBoxMove(arg_29_0, arg_29_1)
	...
	if arg_29_1.id == 20011 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_29_2(var_29_1, var_1_10005(var_1_10006)).sprite = arg_29_0.box1.sprite
	elseif arg_29_1.id == 20012 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_29_4(var_29_3, var_1_10005(var_1_10006)).sprite = arg_29_0.box2.sprite
	elseif arg_29_1.id == 20013 then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_29_6(var_29_5, var_1_10005(var_1_10006)).sprite = arg_29_0.box3.sprite
	end
	...
	local var_29_9 = var_29_8(var_29_7, var_1_10005(var_1_10006))

	var_3.SetEndEvent(var_29_9, function()
		Destroy = var_2_10000
		go = var_2_10001

		var_2_10000(var_2_10001(var_29_0))
