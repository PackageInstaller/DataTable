...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "bg/frame/bg/talents")
	local var_2_3 = arg_2_0.treePanel

	arg_2_0.treeList = var_2_0(var_2_2, var_3.Find(var_2_3, "bg/frame/bg/talents/telent"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.treeTalentDesTxt = var_2_6(var_2_5, var_3(var_2_3))
	...
	var_1(var_2_15, var_2_14("commander_choice_talent_4"))
...
function var_0_1.Show(arg_5_0, arg_5_1)
	...
	var_4.make(var_5_3, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			var_4(arg_7_2:Find("name"), var_7_0:getConfig("name"))

			triggerToggle = var_4

			var_4(arg_7_2, arg_5_1.id == var_7_0.id)

			setActive = var_4

			var_4(arg_7_2:Find("curr"), arg_5_1.id == var_7_0.id)

			setActive = var_4

			var_4(arg_7_2:Find("arr"), arg_7_1 ~= #var_5_2 - 1)

			GetImageSpriteFromAtlasAsync = var_4

			var_4("CommanderTalentIcon/" .. var_7_0:getConfig("icon"), "", arg_7_2)
		end
