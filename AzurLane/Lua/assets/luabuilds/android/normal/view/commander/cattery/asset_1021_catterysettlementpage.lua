...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_2.Find(var_2_2, "frame/commanders")
	local var_2_4 = arg_2_0._tf

	arg_2_0.uilist = var_2_1(var_2_3, var_3.Find(var_2_4, "frame/commanders/tpl"))
	setText = var_1

	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_2.Find(var_2_5, "dialogue/label/Text1")

	i18n = var_2_5

	var_1(var_2_6, var_2_5("cattery_settlement_dialogue_1"))

	setText = var_1

	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_2.Find(var_2_7, "dialogue/label/Text3")

	i18n = var_2_7

	var_1(var_2_8, var_2_7("cattery_settlement_dialogue_2"))

	setText = var_1

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "dialogue/label1/Text1")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("cattery_settlement_dialogue_3"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_2.Find(var_2_11, "dialogue/label1/Text3")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("cattery_settlement_dialogue_4"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.timeTxt = var_2_15(var_2_14, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.expTxt = var_2_18(var_2_17, var_3(var_4))
...
function var_0_1.Hide(arg_7_0)
	...
	var_7_1(var_7_0, var_7_2, var_1_10004.UIMgr.GetInstance()._normalUIMain)
...
function var_0_1.SetPainting(arg_9_0)
	...
	local var_9_0 = arg_9_0:GetFlagShip()

	arg_9_0.paintingName = var_1.getPainting(var_9_0)
