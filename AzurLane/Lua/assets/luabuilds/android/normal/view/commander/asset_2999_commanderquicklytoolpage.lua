...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.valueTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.time1Txt = var_2_10(var_2_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.maxTxt = var_2_13(var_2_12, var_3(var_1_10004))
	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_2.Find(var_2_14, "frame/content/label1")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("commander_box_quickly_tool_tip_1"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "frame/content/label2")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("commander_box_quickly_tool_tip_2"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_2.Find(var_2_18, "frame/content/time/label")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("commander_box_quickly_tool_tip_3"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_11()
		...
		var_7_1(var_7_0, var_2_10002.min(arg_3_0.value + 1, arg_3_0.maxCnt))
	...
	local function var_3_14()
		...
		var_8_1(var_8_0, var_2_10002.max(1, arg_3_0.value - 1))
	...
	local function var_3_17()
		if arg_3_0.value <= 0 then
			...
			var_9_1(var_9_0, var_2_10002("cat_accelfrate_notenough"))
		...
		if var_0.CalcMaxUsageCnt(var_9_2) <= 0 then
			...
			var_9_4(var_9_3, var_2_10003("commander_box_was_finished"))
		...
		if var_0 < arg_3_0.value then
			...
			var_9_7(var_9_6, var_2_10003("comander_tool_cnt_is_reclac"))
		...
		var_9_9(var_9_8, var_2_10003.USE_QUICKLY_TOOL, arg_3_0.itemId, arg_3_0.value, arg_3_0.boxId)
...
function var_0_1.Show(arg_10_0, arg_10_1, arg_10_2)
	...
	var_1_10003(var_10_0, var_1_10005.UIMgr.GetInstance().OverlayMain)
	...
	local var_10_1 = var_3(var_4)
	local var_10_2 = var_3.getItemCountById(var_10_1, arg_10_2)
	local var_10_3 = arg_10_0
	local var_10_4 = arg_10_0.CalcMaxUsageCnt(var_10_3)

	math = var_10_3
	arg_10_0.maxCnt = var_10_3.min(var_10_4, var_10_2)
