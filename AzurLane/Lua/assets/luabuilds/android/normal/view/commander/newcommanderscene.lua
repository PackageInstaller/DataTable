...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.paintTFCG = var_2_4(var_2_3, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.nameTF = var_2_12(var_2_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.nationTF = var_2_15(var_2_14, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.rarityTF = var_2_18(var_2_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.skillTF = var_2_21(var_2_20, var_3(var_1_10004))
	...
	arg_2_0.talentsList = var_2_24(var_2_25, var_3.Find(var_2_26, "talent"))
	...
	typeof = var_3
	Animator = var_2_26
	arg_2_0.antor = var_2_29(var_2_28, var_3(var_2_26))
	...
	local var_2_35 = var_2.Find(var_2_34, "main/info/content/abilitys/attrs/command/name/Text")

	i18n = var_2_34

	var_1(var_2_35, var_2_34("commander_command_ability"))

	setText = var_1

	local var_2_36 = arg_2_0._tf
	local var_2_37 = var_2.Find(var_2_36, "main/info/content/abilitys/attrs/tactic/name/Text")

	i18n = var_2_36

	var_1(var_2_37, var_2_36("commander_tactical_ability"))

	setText = var_1

	local var_2_38 = arg_2_0._tf
	local var_2_39 = var_2.Find(var_2_38, "main/info/content/abilitys/attrs/support/name/Text")

	i18n = var_2_38

	var_1(var_2_39, var_2_38("commander_logistics_ability"))

	setText = var_1

	local var_2_40 = arg_2_0._tf
	local var_2_41 = var_2.Find(var_2_40, "main/info/content/copyright/title")

	i18n = var_2_40

	var_1(var_2_41, var_2_40("commander_get_commander_coptyright"))
...
function var_0_1.onUIAnimEnd(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_6_2(var_6_1, var_4(var_5))
...
function var_0_1.didEnter(arg_14_0)
	...
	local function var_14_2()
		...
		local var_15_2 = var_2_10002.ShareMgr.TypeCommander

		pg = var_2_10003

		var_15_1(var_15_0, var_15_2, var_2_10003.ShareMgr.PANEL_TYPE_PINK)
	...
	local function var_14_5(arg_16_0)
		...
		var_1(var_2_10002).hasSkipFlag = true
	...
	local function var_14_8()
		...
		NewCommanderMediator = var_2_10004

		var_17_4(var_17_3, var_2_10004.ON_LOCK, arg_14_0.contextData.commander.id, 1 - var_17_2)
	...
	local function var_14_11()
		...
		var_18_4(var_18_3, var_2_10004.ON_LOCK, arg_14_0.contextData.commander.id, 1 - var_18_2)
	...
	var_1(var_14_12, var_14_13, var_14_14, var_1_10005)
...
function var_0_1.DoExit(arg_20_0)
	...
	if var_1.ShouldTipLock(var_20_0) then
		...
		i18n = var_1_10004
		var_20_3.content = var_1_10004("commander_lock_tip")

		function var_20_3.onYes()
			local var_21_0 = arg_20_0
			local var_21_1 = var_0.emit

			NewCommanderMediator = var_2_10002

			var_21_1(var_21_0, var_2_10002.ON_LOCK, arg_20_0.contextData.commander.id, 1)
...
function var_0_1.updateLockState(arg_23_0)
	...
	var_23_1(arg_23_0.lockBtn, var_23_2 ~= 0)

	setActive = var_23_1

	var_23_1(arg_23_0.unlockBtn, var_23_2 == 0)
...
function var_0_1.updateInfo(arg_24_0, arg_24_1)
	...
	local var_24_6 = var_8.TimeMgr.GetInstance()

	var_6(var_24_5, var_8.CurrentSTimeDesc(var_24_6, "%y%m%d"))
...
function var_0_1.updateAbilitys(arg_25_0)
	...
	var_25_0(arg_25_0.abilitysTF, function(arg_26_0)
		go = var_2_10001
		...
		var_2_10003(arg_26_0:Find("slider/point"), var_26_1.value)
		...
		local var_26_4 = var_26_3(var_26_2, var_5(var_6))
		local var_26_5 = var_26_1.value

		CommanderConst = var_5
		var_26_4.value = var_26_5 / var_5.MAX_ABILITY
	...
	var_3.make(var_27_2, function(arg_28_0, arg_28_1, arg_28_2)
		...
		if arg_28_0 == var_2_10003.EventUpdate then
			...
			if var_28_0 then
				...
				local var_28_1 = "CommanderTalentIcon/" .. var_28_0:getConfig("icon")
				local var_28_2 = ""

				var_2_10008 = arg_28_2

				var_4(var_28_1, var_28_2, arg_28_2.Find(var_2_10008, "icon"))
			end
			...
			var_4(var_28_3, var_28_4, var_28_5, var_2_10008)
		end
...
function var_0_1.willExit(arg_31_0)
	...
	var_31_1(var_31_0, var_31_2, var_1_10004.UIMgr.GetInstance().UIMain)
	...
	var_1(var_31_5, var_3.getPainting(var_31_6))
