...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.descLevelTxt = var_2_9(var_2_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.descTxt = var_2_12(var_2_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.expTxt = var_2_15(var_2_14, var_3(var_1_10004))
	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "bg/frame/level/label")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("commander_home_level_label"))
...
function var_0_1.InitMainView(arg_12_0)
	...
	local var_12_3 = var_12_0.bindConfigTable(var_12_2)
	...
	for iter_12_0, iter_12_1 in var_12_2(var_12_1) do
		...
		local var_12_6 = var_12_0.GetTargetExpForLevel(var_12_5, iter_12_1)

		table = var_12_5

		var_12_5.insert(arg_12_0.displays, {
	...
	local var_12_7 = arg_12_0.scrollrect

	var_4.SetTotalCount(var_12_7, #arg_12_0.displays)
