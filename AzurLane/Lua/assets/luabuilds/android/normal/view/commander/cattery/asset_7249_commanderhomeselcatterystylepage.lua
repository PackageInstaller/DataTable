...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_3()
		if arg_5_0.selectedID then
			...
			var_8_1(var_8_0, var_2_10002.ON_CHANGE_STYLE, arg_5_0.cattery.id, arg_5_0.selectedID)
		end
...
function var_0_1.OnInitItem(arg_9_0, arg_9_1)
	...
	local function var_9_3()
		...
		if not var_0.IsOwn(var_10_0) then
			...
			var_10_2(var_10_1, var_2_10002("cathome_style_unlock"))
		...
		CatteryDescPage = var_2_10003

		var_10_5(var_10_4, var_2_10003.CHANGE_STYLE, var_10_3)
...
function var_0_1.Update(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = arg_12_1.GetOwnStyles(var_12_0)

	ipairs = var_12_0
	pg = var_1_10005

	for iter_12_0, iter_12_1 in var_12_0(var_1_10005.commander_home_style.all) do
		table = var_1_10009
		var_1_10009 = var_1_10009.contains(var_12_1, iter_12_1)
		CatteryStyle = var_10

		local var_12_2 = var_10.New({
			id = iter_12_1,
			own = var_1_10009
		})
		...
		var_11.insert(arg_12_0.displays, var_12_2)
	end

	local var_12_3 = arg_12_0.scrollrect

	var_4.SetTotalCount(var_12_3, #arg_12_0.displays)
