...
function var_0_1.RegisterEvent(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.EVENT_CLOSE_DESC, function(arg_4_0)
	...
	var_3_3(var_3_2, var_3.EVENT_FOLD, function(arg_5_0, arg_5_1)
		...
		if arg_5_1 then
			...
			var_2_10002(var_3(arg_3_0.commanderInfo), -400, 0.5)
		else
			LeanTween = var_2_10002
			...
			var_5_0(var_3(arg_3_0.commanderInfo), 71, 0.5)
		end
	...
	var_3_5(var_3_4, var_3.EVENT_PREVIEW, function(arg_6_0, arg_6_1)
	...
	var_3_7(var_3_6, var_3.EVENT_PREVIEW_REVERSE, function(arg_7_0, arg_7_1, arg_7_2)
	...
	var_3_9(var_3_8, var_3.EVENT_PREVIEW_PLAY, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_4(arg_3_0.otherBtn, not var_8_0)

		triggerToggle = var_4

		var_4(arg_3_0.additionBtn, false)
	...
	var_3_11(var_3_10, var_3.EVENT_PREVIEW_ADDITION, function(arg_9_0, arg_9_1)
		triggerToggle = var_2_10002
	...
	var_3_13(var_3_12, var_3.ON_SORT, function(arg_10_0, arg_10_1)
...
function var_0_1.OnLoaded(arg_11_0)
	...
	Vector3 = var_11_0
	var_11_1.localScale = var_11_0(1, 0, 1)
	...
	UIItemList = var_11_3
	arg_11_0.talentList = var_11_3.New(var_11_4, var_11_4:GetChild(0))
	...
	arg_11_0.talentAdditionList = var_11_7(var_11_8, var_4.GetChild(var_11_9, 0))
	...
	typeof = var_4
	Text = var_11_9
	arg_11_0.commanderLevelTxt = var_11_16(var_11_15, var_4(var_11_9))
	...
	typeof = var_4
	Image = var_11_9
	arg_11_0.commanderExpImg = var_11_19(var_11_18, var_4(var_11_9))
	...
	var_11_22(arg_11_0.modifyNameBtn, var_11_23)
	...
	typeof = var_5
	Image = var_6
	arg_11_0.rarityImg = var_11_32(var_11_31, var_5(var_6))
	...
	typeof = var_5
	Text = var_6
	arg_11_0.otherCommanderNameTxt = var_11_39(var_11_38, var_5(var_6))
	...
	local var_11_43 = var_4.Find(var_11_42, "detail/other/talent")
	local var_11_44 = arg_11_0._tf

	arg_11_0.otherCommanderTalentList = var_11_41(var_11_43, var_5.Find(var_11_44, "detail/other/talent/tpl"))
	...
	arg_11_0.otherCommanderDescTxt = var_11_47(var_11_46, var_5(var_11_44))
	...
	local var_11_50 = var_4.Find(var_11_49, "detail/statement/atttrs/title/Text")

	i18n = var_11_49

	var_3(var_11_50, var_11_49("commander_subtile_ablity"))

	setText = var_3

	local var_11_51 = arg_11_0._tf
	local var_11_52 = var_4.Find(var_11_51, "detail/statement/talents/title/Text")

	i18n = var_11_51

	var_3(var_11_52, var_11_51("commander_subtile_talent"))
...
function var_0_1.OnInit(arg_12_0)
	...
	local function var_12_2(arg_13_0)
		...
		if arg_13_0 then
			...
			var_13_2(var_13_1, var_2_10003.EVENT_OPEN_DESC)
		end
	...
	local function var_12_5(arg_14_0)
		...
		if arg_14_0 then
			...
			if arg_14_0 then
				...
				var_14_3(var_14_2, var_2_10003.EVENT_OPEN_DESC)
			end
	...
	var_1(var_12_3, var_12_4, var_12_5, var_1_10005)
	...
	local function var_12_8(arg_15_0)
		...
		if arg_15_0 then
			...
			var_15_2(var_15_1, var_2_10003.EVENT_OPEN_DESC)
		end
	...
	var_1(var_12_6, var_12_7, var_12_8, var_1_10005)
	...
	local function var_12_11()
		...
		if not var_0.canModifyName(var_16_0) then
			...
			i18n = var_2_10006
			var_16_5.content = var_2_10006("commander_rename_coldtime_tip", var_16_1)
	...
	var_1(var_12_9, var_12_10, var_12_11, var_1_10005)
...
function var_0_1.UpdateLockState(arg_18_0)
	...
	var_18_0(var_3.Find(var_18_2, "image"), var_18_1 == 0)
	...
	local function var_18_5()
		...
		var_19_2(var_19_1, var_2_10003.LOCK, arg_18_0.commanderVO.id, var_19_0)
	...
	var_18_0(var_18_3, var_18_4, var_18_5, var_1_10006)
...
function var_0_1.UpdateInfo(arg_21_0)
	...
	var_3(arg_21_0.fleetnums, function(arg_22_0)
		...
		local var_22_1 = var_2_10003(arg_22_0).name
		...
		var_2_10001(var_22_0, var_22_1 == var_4(var_22_2))
	...
	Vector2 = var_1_10006
	var_21_4.sizeDelta = var_1_10006(var_21_3, arg_21_0.line.sizeDelta.y)
	setActive = var_21_4
...
function var_0_1.UpdatePreViewWithOther(arg_26_0, arg_26_1)
	...
	CommanderCatUtil = var_3

	local var_26_1 = var_3.GetSkillExpAndCommanderExp(var_26_0, arg_26_1)
	local var_26_2 = var_26_0

	var_26_0.addExp(var_26_2, var_26_1)

	local var_26_3 = arg_26_1[#arg_26_1]

	getProxy = var_26_2
	CommanderProxy = var_6

	local var_26_4 = var_26_2(var_6)
	local var_26_5 = var_5.getCommanderById(var_26_4, var_26_3)

	arg_26_0:UpdateOtherCommander(var_26_5)
...
function var_0_1.UpdateOtherCommander(arg_28_0, arg_28_1)
	...
	local var_28_2 = arg_28_1.GetDisplayTalents(var_28_1)

	GetImageSpriteFromAtlasAsync = var_28_1

	var_28_1("commanderskillicon/" .. var_28_0:getConfig("icon"), "", arg_28_0.otherCommanderSkillImg)

	local var_28_3 = arg_28_0.otherCommanderTalentList

	var_5.make(var_28_3, function(arg_29_0, arg_29_1, arg_29_2)
		...
		if arg_29_0 == var_2_10003.EventUpdate then
			...
			if var_28_2[arg_29_1 + 1] then
				...
				local function var_29_3(arg_30_0)
					if arg_30_0 then
						...
						var_30_1(var_30_0, var_3.getConfig(var_30_2, "desc"))
					end
				...
				var_4(var_29_1, var_29_2, var_29_3, var_8)
			...
			local var_29_6 = var_29_5(var_29_4, var_6(var_7))
			...
			if var_3 then
				...
				var_29_9 = not var_6.IsLearnedTalent(var_29_8, var_3.id)
			end
...
function var_0_1._UpdateAbilitys(arg_33_0, arg_33_1, arg_33_2)
	...
	for iter_33_0, iter_33_1 in var_1_10005(var_33_0) do
		local var_33_2 = arg_33_0.abilityTF
		local var_33_3 = var_10.Find(var_33_2, iter_33_0)
		local var_33_4

		if var_33_1 and var_33_1[iter_33_0].value - iter_33_1.value <= 0 then
			var_33_4 = nil
		end
		...
		if var_33_4 then
			...
			local var_33_5 = "+" .. var_33_4

			COLOR_GREEN = var_14

			local var_33_6

			if not var_12(var_33_5, var_14) then
				var_33_6 = " "
			end

			local var_33_7 = var_33_3
			local var_33_8 = var_33_3.Find(var_33_7, "add/base")

			setText = var_33_7

			var_33_7(var_33_8, iter_33_1.value)

			local var_33_9 = var_33_3
			local var_33_10 = var_33_3.Find(var_33_9, "add")

			setText = var_33_9

			var_33_9(var_33_10, var_33_6)
		end
	end
...
function var_0_1._UpdateAbilityAddition(arg_35_0, arg_35_1, arg_35_2)
	...
	if arg_35_2 then
		var_1_10006 = arg_35_2
		var_35_1 = arg_35_2.getAbilitysAddition(var_1_10006)
	end
	...
	for iter_35_0, iter_35_1 in var_1_10006(var_35_0) do
		if iter_35_1 > 0 then
			...
			GetImageSpriteFromAtlasAsync = var_35_3

			var_35_3("attricon", iter_35_0, var_35_4:Find("bg/icon"), false)

			setText = var_35_3

			local var_35_5 = var_35_4
			local var_35_6 = var_35_4.Find(var_35_5, "bg/name")

			AttributeType = var_35_5

			var_35_3(var_35_6, var_35_5.Type2Name(iter_35_0))

			string = var_35_3

			local var_35_7 = var_35_3.format("%0.3f", iter_35_1)

			setText = var_13

			local var_35_8 = var_35_4:Find("bg/value")
			local var_35_9 = "+"

			math = var_16

			var_13(var_35_8, (var_35_9 .. var_16.floor(iter_35_1 * 1000) / 1000) .. "%")
			...
			var_35_8(var_35_4:Find("up"), var_35_10 < iter_35_1)

			setActive = var_35_8

			var_35_8(var_35_4:Find("down"), iter_35_1 < var_35_10)
...
function var_0_1.UpdateTalent(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	var_1_10004("CommanderTalentIcon/" .. arg_38_2:getConfig("icon"), "", arg_38_3)

	local var_38_0 = arg_38_3
	local var_38_1 = arg_38_3.GetComponent

	typeof = var_6
	Button = var_7

	if var_38_1(var_38_0, var_6(var_7)) then
		onButton = var_4

		local var_38_2 = arg_38_0
		local var_38_3 = arg_38_3
		...
		var_4(var_38_2, var_38_3, var_38_4, var_8)
	end
...
function var_0_1._UpdateTalentAddition(arg_41_0, arg_41_1)
	...
	var_4.make(var_41_2, function(arg_42_0, arg_42_1, arg_42_2)
		...
		if arg_42_0 == var_2_10003.EventUpdate then
			...
			var_4(var_2_10005(arg_42_2, "bg/name_mask/name"), var_42_0.name)

			local var_42_1 = var_42_0.type

			CommanderConst = var_5

			local var_42_2 = var_42_1 == var_5.TALENT_ADDITION_RATIO and "%" or ""
			...
			typeof = var_7
			Image = var_8
			var_42_4(var_42_3, var_7(var_8)).enabled = arg_42_1 % 2 ~= 0
		end
...
function var_0_1.UpdateSkills(arg_43_0)
	...
	var_1_10004("commanderskillicon/" .. var_43_1:getConfig("icon"), "", arg_43_0.skillIcon)

	onButton = var_1_10004

	local var_43_2 = arg_43_0
	local var_43_3 = arg_43_0.skillIcon
	...
	local function var_43_4()
		...
		var_44_1(var_44_0, var_2_10002.SKILL_INFO, var_43_1)
	...
	var_1_10004(var_43_2, var_43_3, var_43_4, var_8)
