...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "frame/close_btn")
	...
	var_1_10001(var_2_4, var_2_5, var_2_6, var_5)

	onButton = var_1_10001

	local var_2_7 = arg_2_0
	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_3.Find(var_2_8, "frame/cancel_btn")
	...
	var_1_10001(var_2_7, var_2_9, var_2_10, var_5)
	...
	local var_2_13 = var_2.Find(var_2_12, "frame/bg/content/label")

	i18n = var_2_12

	var_1(var_2_13, var_2_12("commander_rename_tip"))
...
function var_0_1.Show(arg_6_0, arg_6_1)
	...
	local function var_6_3()
		...
		var_7_1(var_7_0, var_2_10003.RENAME, arg_6_1.id, var_0)
