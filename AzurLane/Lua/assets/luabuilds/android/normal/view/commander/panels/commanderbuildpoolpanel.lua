...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame/bg/content/list")
	local var_2_3 = arg_2_0._tf

	arg_2_0.buildPoolList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/bg/content/list/1"))
	...
	local var_2_6 = var_2_4.New
	local var_2_7 = arg_2_0._tf

	arg_2_0.posListTop = var_2_6(var_3.Find(var_2_7, "frame/bg/content/queue/list1"), var_2_5)
	UIItemList = var_2

	local var_2_8 = var_2.New
	local var_2_9 = arg_2_0._tf

	arg_2_0.posListBottom = var_2_8(var_3.Find(var_2_9, "frame/bg/content/queue/list2"), var_2_5)
	...
	typeof = var_4
	Text = var_5
	arg_2_0.selectedTxt = var_2_14(var_2_13, var_4(var_5))
	...
	typeof = var_5
	Image = var_1_10006
	var_2_15[1] = var_2_18(var_2_17, var_5(var_1_10006)).sprite
	...
	typeof = var_5
	Image = var_1_10006
	var_2_15[2] = var_2_21(var_2_20, var_5(var_1_10006)).sprite
	...
	typeof = var_5
	Image = var_1_10006
	var_2_15[3] = var_2_24(var_2_23, var_5(var_1_10006)).sprite
	arg_2_0.sprites = var_2_15
	setText = var_2_15

	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_3.Find(var_2_25, "frame/bg/content/Text")

	i18n = var_2_25

	var_2_15(var_2_26, var_2_25("commander_use_box_tip"))

	setText = var_2_15

	local var_2_27 = arg_2_0._tf
	local var_2_28 = var_3.Find(var_2_27, "frame/bg/content/queue/title/Text")

	i18n = var_2_27

	var_2_15(var_2_28, var_2_27("commander_use_box_queue"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_5 = var_3.Find(var_3_4, "frame/bg/close_btn")
	...
	local function var_3_12()
		...
		i18n = var_2_10004
		var_7_3.content = var_2_10004("commander_select_box_tip", #arg_3_0.selected)
		...
		function var_7_3.onYes()
			...
			var_8_1(var_8_0, var_3_10002.BATCH_BUILD, arg_3_0.selected)
...
function var_0_1.Show(arg_11_0, arg_11_1, arg_11_2)
	...
	var_4.make(var_11_1, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			var_4(var_13_1, var_13_2, var_13_3, var_13_4, var_13_5, var_13_6, var_13_7, var_2_10012)
...
function var_0_1.UpdatePos(arg_17_0)
	local function var_17_0(arg_18_0, arg_18_1)
		...
		local var_18_2 = arg_18_1.Find(var_18_1, "icon")

		if var_18_0 then
			local var_18_3 = var_18_2

			var_18_1 = var_18_2.GetComponent
			typeof = var_2_10006
			Image = var_2_10007
			var_18_1 = var_18_1(var_18_3, var_2_10006(var_2_10007))

			local var_18_4 = arg_17_0

			var_18_1.sprite = var_5.poolId2Sprite(var_18_4, var_18_0)
			onButton = var_18_1
			...
			var_18_1(var_18_5, var_18_6, var_18_7, var_2_10008)
		else
			setText = var_18_1

			var_18_1(arg_18_1:Find("empty/Text"), arg_18_0)
		end

		setActive = var_18_1

		var_18_1(arg_18_1:Find("empty"), not var_18_0)

		setActive = var_18_1

		var_18_1(var_18_2, var_18_0)
	...
	var_17_3(var_17_2, var_4.min(5, var_0_2))
	...
	local var_17_7 = var_4.max
	local var_17_8 = 0

	math = var_6

	var_17_6(var_17_5, var_17_7(var_17_8, var_6.min(5, var_0_2 - 5)))
