...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_7 = var_2.Find(var_2_6, "frame/boxes/mask/content")
	local var_2_8 = arg_2_0._tf

	arg_2_0.boxesList = var_2_5(var_2_7, var_3.Find(var_2_8, "frame/boxes/mask/content/frame"))
	...
	typeof = var_3
	Text = var_2_8
	arg_2_0.traningCnt = var_2_12(var_2_11, var_3(var_2_8))
	...
	typeof = var_3
	Text = var_2_8
	arg_2_0.waitCnt = var_2_15(var_2_14, var_3(var_2_8))
	...
	typeof = var_3
	Text = var_2_8
	arg_2_0.itemCnt = var_2_18(var_2_17, var_3(var_2_8))
	setActive = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_2.Find(var_2_19, "frame/item")

	LOCK_CATTERY = var_2_19

	var_1(var_2_20, not var_2_19)
	...
	var_1(var_2.Find(var_2_22, "frame"), true)
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		...
		for iter_6_0, iter_6_1 in var_2_10001(arg_3_0.boxes) do
			...
			local var_6_2 = iter_6_1.getState(var_6_1)

			CommanderBox = var_6_1

			if var_6_2 == var_6_1.STATE_EMPTY then
				var_6_0 = var_6_0 + 1
			end
		end
		...
		if var_6_0 == 0 then
			...
			local var_6_3 = var_1.TipsMgr.GetInstance()
			local var_6_4 = var_1.ShowTips

			i18n = var_3

			var_6_4(var_6_3, var_3("commander_build_solt_deficiency"))

			return
		end

		local var_6_5 = arg_3_0.buildPoolPanel

		var_1.ExecuteAction(var_6_5, "Show", arg_3_0.pools, var_6_0)
	...
	local function var_3_11()
		...
		CommanderCatMediator = var_3

		var_7_5(var_7_4, var_3.BATCH_GET, arg_3_0.boxes)
	...
	local function var_3_17()
		...
		local var_9_1 = var_2_10001(var_2_10002)
		...
		if var_1.getItemCountById(var_9_1, var_9_0) <= 0 then
			...
			var_9_3(var_9_2, var_2_10004("cat_accelfrate_notenough"))
		...
		if var_9_5 <= 0 then
			...
			var_9_10(var_9_9, var_2_10008("noacceleration_tips"))
		...
		i18n = var_2_10010
		var_9_14.content = var_2_10010("acceleration_tips_1", var_9_5, var_9_6)
		i18n = var_10
		var_9_14.content1 = var_10("acceleration_tips_2", var_9_8[1], var_9_8[2], var_9_8[3])
		...
		function var_9_14.onYes()
			...
			var_10_1(var_10_0, var_3_10002.ONE_KEY, var_9_5, var_9_6, var_9_7)
...
function var_0_1.RegisterEvent(arg_11_0)
	...
	var_11_1(var_11_0, var_1_10003.MSG_QUICKLY_FINISH_TOOL_ERROR, function(arg_12_0)
		pg = var_2_10001
		...
		var_12_1(var_12_0, var_2_10003("comander_tool_cnt_is_reclac"))
	...
	var_11_3(var_11_2, var_3.MSG_BUILD, function(arg_13_0)
	...
	var_11_5(var_11_4, var_3.MSG_BATCH_BUILD, function(arg_14_0, arg_14_1)
		print = var_2_10002
	...
	var_11_7(var_11_6, var_3.EVENT_QUICKLY_TOOL, function(arg_15_0, arg_15_1)
		Item = var_2_10002
	...
	var_11_9(var_11_8, var_3.MSG_OPEN_BOX, function(arg_16_0, arg_16_1, arg_16_2)
...
function var_0_1.updateCntLabel(arg_23_0)
	...
	var_1_10003.each(arg_23_0.boxes, function(arg_24_0)
		...
		arg_24_0.state = arg_24_0.getState(var_24_0)

		local var_24_1 = arg_24_0.state

		CommanderBox = var_24_0

		if var_24_1 == var_24_0.STATE_WAITING then
			var_23_1 = var_23_1 + 1
		else
			local var_24_2 = arg_24_0.state

			CommanderBox = var_2

			if var_24_2 == var_2.STATE_STARTING then
				var_23_0 = var_23_0 + 1
			end
		end
	...
	var_23_2.text = var_23_3 .. var_23_4 .. var_1_10006.MAX_WORK_COUNT
...
function var_0_1.UpdateItem(arg_30_0)
	...
	local var_30_1 = var_1_10002(var_1_10003)
	local var_30_2 = var_2.getItemCountById

	Item = var_1_10004
	var_30_0.text = var_30_2(var_30_1, var_1_10004.COMMANDER_QUICKLY_TOOL_ID)
