...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.skillLvTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.skillAdditionTxt = var_2_10(var_2_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.expTxt = var_2_13(var_2_12, var_3(var_1_10004))
	...
	local var_2_20 = var_2.Find(var_2_19, "content/list")
	local var_2_21 = arg_2_0.descPage

	arg_2_0.skillDescList = var_2_18(var_2_20, var_3.Find(var_2_21, "content/list/tpl"))
	setActive = var_1
	...
	typeof = var_3
	Text = var_2_21
	arg_2_0.commanderLvTxt = var_2_24(var_2_23, var_3(var_2_21))
	...
	typeof = var_3
	Text = var_2_21
	arg_2_0.levelAdditionTxt = var_2_27(var_2_26, var_3(var_2_21))
	...
	typeof = var_3
	Slider = var_2_21
	arg_2_0.preExpSlider = var_2_30(var_2_29, var_3(var_2_21))
	...
	typeof = var_3
	Slider = var_2_21
	arg_2_0.expSlider = var_2_33(var_2_32, var_3(var_2_21))
	...
	typeof = var_3
	Text = var_2_21
	arg_2_0.sliderExpTxt = var_2_36(var_2_35, var_3(var_2_21))
	UIItemList = var_1

	local var_2_37 = var_1.New
	local var_2_38 = arg_2_0._tf
	local var_2_39 = var_2.Find(var_2_38, "select_panel/frame/list")
	local var_2_40 = arg_2_0._tf

	arg_2_0.uilist = var_2_37(var_2_39, var_3.Find(var_2_40, "select_panel/frame/list/commandeTF"))
	...
	typeof = var_3
	Text = var_2_40
	arg_2_0.consumeTxt = var_2_43(var_2_42, var_3(var_2_40))
	...
	local var_2_46 = var_2.Find(var_2_45, "select_panel/title")

	i18n = var_2_45

	var_1(var_2_46, var_2_45("commander_confirm_tip"))

	setText = var_1

	local var_2_47 = arg_2_0._tf
	local var_2_48 = var_2.Find(var_2_47, "skill_desc/title")

	i18n = var_2_47

	var_1(var_2_48, var_2_47("commander_skill_effect"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		if arg_3_0.isOpenDescPage then
			...
			var_4_1(var_4_3, var_2_10002.EVENT_CLOSE_DESC)
		end
		...
		var_4_1(var_1.Find(var_4_4, "sel"), arg_3_0.isOpenDescPage)
	...
	var_1(var_2.Find(var_3_3, "sel"), false)
...
function var_0_1.RegisterEvent(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.EVENT_OPEN_DESC, function(arg_7_0)
	...
	var_6_3(var_6_2, var_3.MSG_UPGRADE, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_3.Action(var_8_2, arg_8_1, arg_8_2, function()
			...
			var_9_3(var_9_2, var_2.EVENT_UPGRADE)
	...
	var_6_5(var_6_4, var_3.EVENT_FOLD, function(arg_10_0, arg_10_1)
		if arg_10_1 then
			...
			var_10_0(var_2_10003(arg_6_0._tf), -410, 0.5)
		end
	...
	var_6_7(var_6_6, var_3.EVENT_SWITCH_PAGE, function(arg_11_0, arg_11_1)
		CommanderCatScene = var_2_10002
	...
	var_6_9(var_6_8, var_3.EVENT_SELECTED, function(arg_12_0, arg_12_1)
...
function var_0_1.UpdateMaterials(arg_15_0)
	...
	CommanderConst = var_3

	var_15_2(var_15_1, var_3.PLAY_MAX_COUNT)
...
function var_0_1.UpdateMainView(arg_17_0)
	...
	var_4(var_5(arg_17_0.levelAdditionTxt), #var_17_0 > 0)
...
function var_0_1.SimulateAddSkillExp(arg_22_0, arg_22_1)
	...
	local var_22_2 = var_1_10004(var_22_1)
...
function var_0_1.UpdateSkillTF(arg_23_0, arg_23_1)
	...
	local var_23_3 = var_23_1.getConfig(var_23_2, "lv")

	GetImageSpriteFromAtlasAsync = var_23_2

	var_23_2("CommanderSkillIcon/" .. var_23_1:getConfig("icon"), "", arg_23_0.skillIcon)
...
function var_0_1.UpdateCommanderTF(arg_25_0, arg_25_1)
	...
	var_25_3(var_25_2, var_1_10006.EVENT_PREVIEW_REVERSE, var_25_1, var_25_0)
...
function var_0_1.UpdateConsume(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_0 = var_1_10003(var_1_10004)
	local var_26_1 = var_3.getRawData(var_26_0)

	CommanderCatUtil = var_26_0
	arg_26_0.total = var_26_0.CalcCommanderConsume(arg_26_1)
	...
	if var_26_1.gold < arg_26_0.total then
		...
		local function var_26_5()
			if var_26_1.gold < arg_26_0.total then
				...
				local var_27_1 = var_1(var_27_0, var_2_10003("word_gold"))

				ChargeScene = var_27_0

				var_0(var_27_1, var_27_0.TYPE_ITEM, {
					{
						59001,
			...
			var_27_5(var_27_4, var_2_10004.UPGRADE, arg_26_0.commander.id, arg_26_1, var_27_3.id)
...
function var_0_1.CheckTip(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	if var_1_10005.AnySSRCommander(arg_29_1) then
		...
		var_5.insert(var_29_0, function(arg_30_0)
			...
			i18n = var_2_10005
			var_30_3.content = var_2_10005("commander_material_is_rarity")
	...
	if var_29_1.isMaxLevel(var_29_3) then
		local var_29_4 = var_29_1.exp
		local var_29_5

		if 0 < var_29_4 then
			var_29_3 = var_29_2
			var_29_5 = not var_29_2.isMaxLevel(var_29_3)
		else
			var_29_5 = false
		end
	end
	...
	if var_29_5 then
		...
		var_29_3.insert(var_29_0, function(arg_31_0)
			...
			i18n = var_2_10005
			var_31_3.content = var_2_10005("commander_exp_overflow_tip")
	...
	local var_29_6 = arg_29_0.commander

	if var_8.isMaxLevel(var_29_6) then
		table = var_8
		...
		var_8.insert(var_29_0, function(arg_32_0)
			...
			i18n = var_2_10005
			var_32_3.content = var_2_10005("commander_material_is_maxLevel")
...
function var_0_1.UpdateCard(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_4 = arg_33_2.Find(var_33_3, "icon")

	if var_33_1 then
		onButton = var_33_3

		local var_33_5 = arg_33_0
		local var_33_6 = var_33_4
		...
		local function var_33_7()
			...
			var_1.remove(var_33_0, var_34_0)
		...
		var_33_3(var_33_5, var_33_6, var_33_7, var_1_10011)

		getProxy = var_33_3
		CommanderProxy = var_33_5

		local var_33_8 = var_33_3(var_33_5)

		var_33_3 = var_33_3.getCommanderById(var_33_8, var_33_1)
		GetImageSpriteFromAtlasAsync = var_33_8

		local var_33_9 = "commandericon/"

		var_1_10011 = var_33_3

		var_33_8(var_33_9 .. var_33_3.getPainting(var_1_10011), "", var_33_4)

		setActive = var_33_8

		local var_33_10 = var_33_4:Find("up")

		var_1_10011 = arg_33_0.commander

		var_33_8(var_33_10, var_10.isSameGroup(var_1_10011, var_33_3.groupId))

		setActive = var_33_8

		var_33_8(var_33_4:Find("formation"), var_33_3.inFleet)

		setText = var_33_8

		var_33_8(var_33_4:Find("level_bg/Text"), var_33_3.level)
	else
		onButton = var_33_3
		...
		local function var_33_13()
			...
			local var_35_1 = var_2_10001(var_2_10002)

			if var_35_0(var_1.getRawData(var_35_1)) == 1 then
				pg = var_0
				...
				var_35_3(var_35_2, var_35_1("commander_material_noenough"))
			...
			if var_1.isMaxLevel(var_35_5) then
				...
				if not var_2.isMaxLevel(var_35_6) then
					...
					local var_35_9 = var_2_10004.ON_SELECT
					local var_35_10 = arg_33_0

					var_35_8(var_35_7, var_35_9, var_5.GenSelectData(var_35_10))
				end
		...
		var_33_3(var_33_11, var_33_12, var_33_13, var_1_10011)
	end
