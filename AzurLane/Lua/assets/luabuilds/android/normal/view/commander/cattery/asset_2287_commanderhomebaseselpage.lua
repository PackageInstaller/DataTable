...
function var_0_1.OnUpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	var_6(var_7.Find(var_7_3, "line"), var_7_1 % 4 == 1)
...
function var_0_1.Update(arg_8_0)
	...
	local var_8_3 = var_2(var_3)
	local var_8_4 = var_2.getCommandersInFleet(var_8_3)

	table = var_8_3

	var_8_3.sort(arg_8_0.displays, function(arg_9_0, arg_9_1)
		table = var_2_10002
		...
		if var_9_0 == (var_3.contains(var_8_4, arg_9_1.id) and 1 or 0) then
