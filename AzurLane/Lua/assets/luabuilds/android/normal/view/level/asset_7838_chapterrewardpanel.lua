...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_1 = var_2.Find(var_2_0, "window/bg/text")

	i18n = var_2_0

	var_1_10001(var_2_1, var_2_0("desc_defense_reward"))

	UIItemList = var_1_10001

	local var_2_2 = var_1_10001.New
	local var_2_3 = arg_2_0._tf
	local var_2_4 = var_2.Find(var_2_3, "window/bg/panel/list")
	local var_2_5 = arg_2_0._tf

	arg_2_0.UIlist = var_2_2(var_2_4, var_3.Find(var_2_5, "window/bg/panel/list/item"))
...
local function var_0_3(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	var_4.make(var_6_0, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_2 = arg_7_2.Find(var_7_1, "target/title")

			i18n = var_7_1

			var_4(var_7_2, var_7_1("text_rest_HP") .. "：")

			setText = var_4

			var_4(arg_7_2:Find("target/Text"), var_7_0)

			local var_7_3 = arg_6_3[arg_7_1 + 1]

			updateDrop = var_5

			var_5(arg_7_2:Find("award"), var_7_3, {
				hideName = true
			})
			...
			local var_7_5 = arg_7_2:Find("award")
			...
			var_5(var_7_4, var_7_5, var_7_6, var_9)
...
function var_0_1.Enter(arg_11_0, arg_11_1)
	...
	var_5.insert(var_11_2, 1, var_11_1.port_hp + 1)
