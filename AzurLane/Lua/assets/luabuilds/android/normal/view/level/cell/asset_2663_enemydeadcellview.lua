	...
	if var_1_10003(arg_3_0.go) then
		...
		var_3.GetPrefab(var_3_2, "leveluiview/Tpl_Dead", "Tpl_Dead", function(arg_4_0)
			...
			if var_3_1.icon_type == 1 then
				...
				local var_4_7 = var_6(arg_4_0)

				var_4_4(var_4_3, var_4_5, var_4_6, var_6.Find(var_4_7, "icon"))
			end
			...
			var_4_4(var_3(arg_3_0.tf, "effect_open"), false)

			setActive = var_4_4
			findTF = var_3

			var_4_4(var_3(arg_3_0.tf, "huoqiubaozha"), false)
