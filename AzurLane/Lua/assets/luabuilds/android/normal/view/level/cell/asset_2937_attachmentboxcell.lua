...
function var_0_1.Update(arg_2_0)
	...
	if var_1_10002(arg_2_0.go) then
		...
		var_2_2(var_2_1, "box_data_template not exist: " .. var_2_0.attachmentId)

		var_2_2 = "box_" .. var_2_0.attachmentId
		var_1_10005 = arg_2_0

		arg_2_0.PrepareBase(var_1_10005, var_2_2)
		...
		var_6({
			...
			function(arg_5_0)
				...
				var_1.GetPrefab(var_5_1, "leveluiview/tpl_box", "tpl_box", function(arg_6_0)
					...
					var_3_10001(var_3_10002(var_2_3), arg_2_0.tf)

					tf = var_3_10001

					local var_6_0 = var_3_10001(var_2_3)

					Vector3 = var_2
					var_6_0.anchoredPosition3D = var_2(0, 30, 0)
					...
					if var_6_1 ~= var_2.BoxTorpedo then
						...
						local var_6_3 = var_2(var_2_3)

						Vector3 = var_3

						local var_6_4 = var_6_2(var_6_3, var_3(0, 40, 0), 1.5)
						local var_6_5 = var_1.setEase

						LeanTweenType = var_3

						local var_6_6 = var_6_5(var_6_4, var_3.easeInOutSine)
			...
			local var_7_0 = var_1_10005

			tf = var_2_10002

			local var_7_1 = var_2_10002(var_2_3)

			var_2_10000(var_7_0, var_2.Find(var_7_1, "icon"))
	...
	if arg_2_0.box then
		...
		ChapterConst = var_2_2

		if var_2_4 == var_2_2.CellFlagActive then
			setActive = var_2_4
			findTF = var_3

			local var_2_5 = var_3(arg_2_0.box, "effect_found")
			local var_2_6 = var_2_0.trait

			ChapterConst = var_1_10005

			var_2_4(var_2_5, var_2_6 == var_1_10005.TraitVirgin)

			var_2_4 = var_2_0.trait
			ChapterConst = var_2_5

			if var_2_4 == var_2_5.TraitVirgin then
				pg = var_2_4

				local var_2_7 = var_2_4.CriMgr.GetInstance()

				var_2_4 = var_2_4.PlaySoundEffect_V3
				SFX_UI_WEIGHANCHOR_ENEMY = var_4

				var_2_4(var_2_7, var_4)
			end
		end
	end
	...
	var_2_4(var_2_8, var_2_9 == var_1_10005.CellFlagActive)
