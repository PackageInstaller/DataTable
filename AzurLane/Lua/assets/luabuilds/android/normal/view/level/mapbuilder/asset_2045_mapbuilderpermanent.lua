...
function var_0_1.UpdateMapItems(arg_5_0)
	...
	if var_1.getConfig(var_5_0, "cloud_suffix") == "" then
		...
		var_5_0(arg_5_0.sceneParent.clouds, false)
	else
		setActive = var_5_0

		var_5_0(arg_5_0.sceneParent.clouds, true)

		ipairs = var_5_0

		for iter_5_0, iter_5_1 in var_5_0(var_1:getConfig("clouds_pos")) do
			...
			local var_5_3 = var_5_2(var_5_1, var_1_10011(var_1_10012))
