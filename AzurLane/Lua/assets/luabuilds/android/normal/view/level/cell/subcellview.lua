...
function var_0_3.OverrideCanvas(arg_3_0)
	...
	local var_3_1 = var_2.Find(var_3_0, "mark")

	typeof = var_3_0
	Canvas = var_4
	arg_3_0.markCanvas = var_1(var_3_1, var_3_0(var_4))
...
function var_0_3.ResetCanvasOrder(arg_4_0)
	...
	local var_4_1 = var_4_0 * var_2.PriorityPerRow
...
function var_0_3.LoadEffectShuihua(arg_5_0)
	...
	var_2.GetPrefab(var_5_1, "Effect/" .. var_5_0, var_5_0, function(arg_6_0)
		...
		Vector3 = var_2
		var_6_2.localPosition = var_2.zero
		setActive = var_6_2
