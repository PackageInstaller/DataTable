...
function var_0_1.InitUI(arg_7_0)
	...
	typeof = var_3
	Toggle = var_1_10004
	arg_7_0.toggleQuickPlay = var_7_26(var_7_25, var_3(var_1_10004))
	...
	local var_7_29 = var_2.Find(var_7_28, "LoopGroup/view")

	typeof = var_7_28
	LayoutElement = var_4
	arg_7_0.layoutView = var_1(var_7_29, var_7_28(var_4))
	...
	local var_7_32 = var_2.Find(var_7_31, "LoopGroup/Loop/Text")

	i18n = var_7_31

	var_1(var_7_32, var_7_31("autofight_farm"))
	...
	local var_7_40 = var_2.Find(var_7_39, "Text")

	i18n = var_7_39

	var_1(var_7_40, var_7_39("autofight"))
...
function var_0_1.set(arg_9_0, arg_9_1, arg_9_2)
	...
	if not arg_9_2 then
		...
		Vector3 = var_9_1
		var_9_1 = var_9_1(0, 0, 0)
	end

	arg_9_0.posStart = var_9_1
	getProxy = var_9_1
	ChapterProxy = var_5

	local var_9_2 = var_9_1(var_5)
	local var_9_3 = var_4.getMapById(var_9_2, var_3:getConfig("map"))
	local var_9_4 = var_3
	local var_9_5 = var_3.getConfigTable(var_9_4)

	string = var_9_4

	local var_9_6 = var_9_4.split(var_9_5.name, "|")
	local var_9_7 = var_3
	local var_9_8 = var_3.getPlayType(var_9_7)

	ChapterConst = var_9_7

	local var_9_9 = var_9_8 == var_9_7.TypeDefence

	GetSpriteFromAtlasAsync = var_8

	var_8("ui/levelstageinfoview_atlas", var_9_9 and "title_print_defense" or "title_print", function(arg_10_0)
		IsNil = var_2_10001
		...
		if not var_2_10001(arg_9_0.titleBGDecoration) then
			...
			typeof = var_2_10003
			Image = var_2_10004
			var_10_1(var_10_0, var_2_10003(var_2_10004)).sprite = arg_10_0
		end
	...
	var_8("ui/levelstageinfoview_atlas", var_9_9 and "titlebar_bg_defense" or "titlebar_bg", function(arg_11_0)
		IsNil = var_2_10001
		...
		if not var_2_10001(arg_9_0.titleBG) then
			...
			typeof = var_2_10003
			Image = var_2_10004
			var_11_1(var_11_0, var_2_10003(var_2_10004)).sprite = arg_11_0
		end
	...
	var_8(arg_9_0.titleIcon, var_9_9)

	local var_9_10 = arg_9_0.progressBar.sizeDelta
	local var_9_11

	if not var_9_9 or not var_0_3 then
		var_9_11 = var_0_2
	end

	var_9_10.x = var_9_11

	local var_9_12 = arg_9_0.progressBar

	var_9_12.sizeDelta = var_9_10
	setText = var_9_12

	local var_9_13 = arg_9_0.txTitle

	var_9_12(var_10.Find(var_9_13, "title_index"), var_9_5.chapter_name .. "  ")

	setText = var_9_12

	local var_9_14 = arg_9_0.txTitle

	var_9_12(var_10.Find(var_9_14, "title"), var_9_6[1])

	setText = var_9_12

	local var_9_15 = arg_9_0.txTitle
	local var_9_16 = var_10.Find(var_9_15, "title_en")
	local var_9_17

	if not var_9_6[2] then
		var_9_17 = ""
	end

	var_9_12(var_9_16, var_9_17)

	setActive = var_9_12

	local var_9_18 = arg_9_0.txTitleHead
	local var_9_19

	if var_9_6[3] then
		var_9_19 = #var_9_6[3] > 0
	end

	var_9_12(var_9_18, var_9_19)

	if var_9_6[3] then
		local var_9_20 = #var_9_6[3]
		local var_9_21

		if not (0 < var_9_20) or not arg_9_0.txTitleOriginPosY then
			var_9_21 = arg_9_0.txTitleOriginPosY + 8
		end

		setAnchoredPosition = var_9_18

		var_9_18(arg_9_0.txTitle, {
			y = var_9_21
		})

		setText = var_9_18

		local var_9_22 = arg_9_0.txTitleHead
		local var_9_23

		if not var_9_6[3] then
			var_9_23 = ""
		end

		var_9_18(var_9_22, var_9_23)

		setText = var_9_18

		local var_9_24 = arg_9_0.winCondDesc

		i18n = var_9_23

		local var_9_25 = var_9_23("text_win_condition")
		local var_9_26 = "："

		i18n = var_1_10014

		var_9_18(var_9_24, var_9_25 .. var_9_26 .. var_1_10014(var_3:getConfig("win_condition_display")))

		setText = var_9_18

		local var_9_27 = arg_9_0.loseCondDesc

		i18n = var_12

		local var_9_28 = var_12("text_lose_condition")
		local var_9_29 = "："

		i18n = var_14

		local var_9_30 = var_3

		var_9_18(var_9_27, var_9_28 .. var_9_29 .. var_14(var_3.getConfig(var_9_30, "lose_condition_display")))

		setActive = var_9_18

		local var_9_31 = arg_9_0.winCondAwardBtn
		local var_9_32 = var_3
		local var_9_33 = var_3.getPlayType(var_9_32)

		ChapterConst = var_9_32

		var_9_18(var_9_31, var_9_33 == var_9_32.TypeDefence)
		...
		if not var_3:existAchieve() then
			...
			var_9_34(arg_9_0.passState, false)

			setActive = var_9_34

			var_9_34(arg_9_0.progress, false)

			setActive = var_9_34

			var_9_34(arg_9_0.trAchieves, false)
		else
			setActive = var_9_34

			var_9_34(arg_9_0.passState, true)

			setActive = var_9_34

			var_9_34(arg_9_0.progress, true)

			setActive = var_9_34

			var_9_34(arg_9_0.trAchieves, true)

			var_9_34 = arg_9_0.passState
			Vector3 = var_11
			var_9_34.localPosition = var_11(-arg_9_0.passState.rect.width, 0, 0)

			local var_9_35 = var_3

			var_9_34 = var_3.hasMitigation(var_9_35)
			setActive = var_9_35

			var_9_35(arg_9_0.passState, var_9_34)

			local var_9_37

			if var_9_34 then
				local var_9_36 = var_3

				var_9_35 = var_3.getRiskLevel(var_9_36)
				setImageSprite = var_9_36
				var_9_37 = arg_9_0.passState
				GetSpriteFromAtlas = var_14

				var_9_36(var_9_37, var_14("passstate", var_9_35), true)
			end

			setWidgetText = var_9_35

			local var_9_38 = arg_9_0.progress

			i18n = var_9_37

			var_9_35(var_9_38, var_9_37("levelScene_threat_to_rule_out", ": "))

			table = var_9_35

			local var_9_39 = var_9_35.insert
			local var_9_40 = arg_9_0.delayTween

			LeanTween = var_13

			local var_9_41 = var_13.value

			go = var_14

			local var_9_42 = var_9_41(var_14(arg_9_0.progress), 0, var_3.progress, 0.5)
			local var_9_43 = var_13.setDelay(var_9_42, 0.15)
			local var_9_44 = var_13.setOnUpdate

			System = var_9_53

			var_9_39(var_9_40, var_9_44(var_9_43, var_9_53.Action_float(function(arg_12_0)
				...
				var_2_10001(var_12_0, var_3.floor(arg_12_0) .. "%")

				return
			end)).uniqueId)

			local var_9_45 = arg_9_0.achieveList

			var_11.align(var_9_45, #var_3.achieves)

			local var_9_46 = arg_9_0.achieveList

			var_11.each(var_9_46, function(arg_13_0, arg_13_1)
				...
				var_4(var_13_2, var_2_10006.GetAchieveDesc(var_13_0.type, var_0))
				...
				var_4(var_13_3, var_6.white)

				setActive = var_4
				findTF = var_13_3

				var_4(var_13_3(arg_13_1, "star"), false)

				setActive = var_4
				findTF = var_5

				var_4(var_5(arg_13_1, "star_empty"), true)

				ChapterConst = var_4

				local var_13_4 = var_4.IsAchieved(var_13_0)
				...
				local var_13_7 = var_7.delayedCall
				local var_13_8 = 0.15 + (arg_13_0 + 1) * 0.15

				System = var_2_10009

				var_13_5(var_13_6, var_13_7(var_13_8, var_2_10009.Action(function()
					IsNil = var_3_10000
					...
					if not var_3_10000(arg_13_1) then
						...
						var_14_0, setTextColor = var_0(arg_13_1, "desc"), var_1
						...
						if var_13_4 then
							...
							var_1(var_14_0, var_14_1)

							setActive = var_1
							findTF = var_14_0

							var_1(var_14_0(arg_13_1, "star"), var_13_4)

							setActive = var_1
							findTF = var_2

							var_1(var_2(arg_13_1, "star_empty"), not var_13_4)
		...
		var_9_34(arg_9_0.txIntro, var_9_5.profiles)

		setText = var_9_34

		var_9_34(arg_9_0.txCost, var_9_5.oil)

		if var_9_5.icon and var_9_5.icon[1] then
			setActive = var_10
			...
			local var_9_47 = arg_9_0.head

			LoadSprite = var_12

			var_10(var_9_47, var_12("qicon/" .. var_9_5.icon[1]))
		else
			setActive = var_10
		...
		local var_9_48 = arg_9_0.dropList

		var_10.align(var_9_48, #arg_9_0.awards)

		local var_9_49 = var_3
		local var_9_50 = var_3.existLoop(var_9_49)

		setActive = var_9_49

		var_9_49(arg_9_0.bottomExtra, var_9_50)

		local var_9_53

		if var_9_50 then
			var_9_49 = var_3:canActivateLoop()

			local var_9_51 = "chapter_loop_flag_" .. var_3.id

			PlayerPrefs = var_13

			local var_9_52 = (var_13.GetInt(var_9_51, -1) == 1 or var_13 == -1) and var_9_49

			var_9_30 = var_3
			var_9_53 = #var_3.getConfig(var_9_30, "use_oil_limit")
			var_9_53 = 0 < var_9_53
			setActive = var_9_30

			var_9_30(arg_9_0.loopOn, var_9_52)

			setActive = var_9_30

			var_9_30(arg_9_0.loopOff, not var_9_52)

			setActive = var_9_30

			var_9_30(arg_9_0.costLimitTip, var_9_53)
			...
			var_9_30(function()
				...
				if not var_9_52 or not arg_9_0.rtViewContainer.rect.width then
					var_15_1 = 0
				end
			...
			var_1_10018 = arg_9_0.loopToggle

			function var_1_10019()
				if not var_9_49 then
					pg = var_0
					var_2_10001 = var_0.TipsMgr.GetInstance()

					local var_16_0 = var_0.ShowTips

					i18n = var_2_10002

					var_16_0(var_2_10001, var_2_10002("levelScene_activate_loop_mode_failed"))

					return
				end

				local var_16_1 = not arg_9_0.loopOn.gameObject.activeSelf

				PlayerPrefs = var_2_10001

				var_2_10001.SetInt(var_9_51, var_16_1 and 1 or 0)
				...
				var_1(arg_9_0.loopOn, var_16_1)

				setActive = var_1

				var_1(arg_9_0.loopOff, not var_16_1)
				...
				local var_16_4 = arg_9_0

				LeanTween = var_2_10004

				local var_16_5 = var_2_10004.value(var_16_2, var_16_3, 0.3)
				local var_16_6 = var_4.setOnUpdate

				System = var_6

				local var_16_7 = var_16_6(var_16_5, var_6.Action_float(function(arg_17_0)
					arg_9_0.layoutView.preferredWidth = arg_17_0

					return
				end))
				local var_16_8 = var_4.setOnComplete

				System = var_6
				var_16_4.LTid = var_16_8(var_16_7, var_6.Action(function()
					arg_9_0.LTid = nil
			...
			var_9_30(var_9_54, var_1_10018, var_1_10019, var_1_10020)

			onButton = var_9_30

			var_9_30(arg_9_0, arg_9_0.loopHelp, function()
				pg = var_2_10000
				...
				i18n = var_2_10003
				var_19_2.helps = var_2_10003("levelScene_loop_help_tip")
			...
			AutoBotCommand = var_9_30
			var_9_30 = var_9_30.autoBotSatisfied()

			local var_9_55 = "chapter_autofight_flag_" .. var_3.id

			if var_9_30 then
				::label_9_1::

				PlayerPrefs = var_1_10018
				var_1_10018 = var_1_10018.GetInt(var_9_55, 1) == 1
			end

			onToggle = var_1_10019

			local var_9_56 = arg_9_0
			local var_9_57 = arg_9_0.autoFightToggle

			local function var_9_58(arg_20_0)
				if arg_20_0 ~= var_1_10018 then
					var_1_10018 = arg_20_0
					PlayerPrefs = var_1

					var_1.SetInt(var_9_55, var_1_10018 and 1 or 0)
			...
			SFX_UI_TAG = var_1_10023

			var_1_10019(var_9_56, var_9_57, var_9_58, var_1_10023)

			triggerToggle = var_1_10019

			var_1_10019(arg_9_0.autoFightToggle, var_1_10018)

			setActive = var_1_10019

			var_1_10019(arg_9_0.autoFightToggle, var_9_30)
		end

		onButton = var_9_49

		local var_9_59 = arg_9_0
		local var_9_60 = arg_9_0.btnConfirm
		...
		local function var_9_61()
			...
			local var_21_2 = var_21_0(var_2_10003)
			...
			if var_2.getMaxShipBag(var_21_3) <= var_21_1 then
				...
				openDockyardClear = var_5
				gotoChargeScene = var_2_10006
				openDockyardIntensify = var_2_10007

				var_3(var_21_4, var_5, var_2_10006, var_2_10007)
		...
		SFX_UI_WEIGHANCHOR_GO = var_9_53

		var_9_49(var_9_59, var_9_60, var_9_61, var_9_53)

		onButton = var_9_49

		local var_9_62 = arg_9_0
		local var_9_63 = arg_9_0.btnCancel
		...
		var_9_49(var_9_62, var_9_63, var_9_64, var_9_53)

		onButton = var_9_49

		local var_9_65 = arg_9_0
		local var_9_66 = arg_9_0._tf
		local var_9_67 = var_13.Find(var_9_66, "bg")
		...
		var_9_49(var_9_65, var_9_67, var_9_68, var_15)

		local var_9_69 = var_3

		if not var_3.getConfig(var_9_69, "risk_levels") then
			local var_9_70 = {}
		end

		onButton = var_9_69

		local var_9_71 = arg_9_0
		local var_9_72 = arg_9_0.passState
		...
		local function var_9_73()
			...
			local var_24_3 = var_0(var_24_1, var_2.getChapterState(var_24_2))

			i18n = var_24_1

			local var_24_4 = "level_risk_level_mitigation_rate"
			local var_24_5 = var_0
			local var_24_6 = var_3.getRemainPassCount(var_24_5)
			local var_24_7 = var_0
			local var_24_8 = var_24_3 .. var_24_1(var_24_4, var_24_6, var_4.getMitigationRate(var_24_7))
			local var_24_9 = var_9_3
			local var_24_10 = var_1.getMapType(var_24_9)

			Map = var_24_9

			if var_24_10 == var_24_9.ELITE then
				var_24_10 = var_24_8

				local var_24_11 = "\n"

				i18n = var_24_6
				var_24_8 = var_24_10 .. var_24_11 .. var_24_6("level_diffcult_chapter_state_safety")
			end
		...
		var_9_69(var_9_71, var_9_72, var_9_73, var_9_30)

		onButton = var_9_69

		local var_9_74 = arg_9_0
		local var_9_75 = arg_9_0.head
		...
		var_9_69(var_9_74, var_9_75, var_9_76, var_9_30)

		onButton = var_9_69

		var_9_69(arg_9_0, arg_9_0.winCondAwardBtn, function()
		...
		local var_9_77 = arg_9_0.descQuickPlay

		i18n = var_14

		var_9_69(var_9_77, var_14("desc_quick_play"))

		local var_9_78 = var_3
		local var_9_79 = var_3.CanQuickPlay(var_9_78)

		setActive = var_9_78

		var_9_78(arg_9_0.quickPlayGroup, var_9_79)

		if var_9_79 then
			local var_9_80 = "chapter_quickPlay_flag_" .. var_3.id

			PlayerPrefs = var_14

			local var_9_81 = var_14.GetInt(var_9_80, 1)

			onToggle = var_15
			var_9_30 = arg_9_0

			local var_9_82 = arg_9_0.toggleQuickPlay

			function var_1_10018(arg_27_0)
				PlayerPrefs = var_2_10001

				var_2_10001.SetInt(var_9_80, arg_27_0 and 1 or 0)
			...
			var_15(var_9_30, var_9_82, var_1_10018, var_1_10019)

			triggerToggle = var_15

			var_15(arg_9_0.toggleQuickPlay, var_9_81 == 1)
		end

		if arg_9_0.doEaseIn then
			local var_9_83 = arg_9_0._tf
			local var_9_84 = var_13.Find(var_9_83, "panel").transform

			var_9_84.localPosition = arg_9_0.posStart
			table = var_9_84

			local var_9_85 = var_9_84.insert
			local var_9_86 = arg_9_0.delayTween

			LeanTween = var_9_30

			local var_9_87 = var_9_30.move
			local var_9_88 = var_13

			Vector3 = var_1_10018

			var_9_85(var_9_86, var_9_87(var_9_88, var_1_10018.zero, 0.2).uniqueId)

			Vector3 = var_9_85
			var_13.localScale = var_9_85.zero
			table = var_14

			local var_9_89 = var_14.insert
			local var_9_90 = arg_9_0.delayTween

			LeanTween = var_16

			local var_9_91 = var_16.scale
			local var_9_92 = var_13

			Vector3 = var_18

			var_9_89(var_9_90, var_9_91(var_9_92, var_18(1, 1, 1), 0.2).uniqueId)

			table = var_9_89

			local var_9_93 = var_9_89.insert
			local var_9_94 = arg_9_0.delayTween

			LeanTween = var_16

			local var_9_95 = var_16.moveX(arg_9_0.passState, 0, 0.35)
			local var_9_96 = var_16.setEase

			LeanTweenType = var_18

			local var_9_97 = var_9_96(var_9_95, var_18.easeInOutSine)

			var_9_93(var_9_94, var_16.setDelay(var_9_97, 0.3).uniqueId)
		end
...
function var_0_1.updateDrop(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	if arg_30_1 == var_1_10004.EventUpdate then
		...
		local function var_30_4()
			...
			if var_31_0[var_1.getConfig(var_31_1, "type")] then
				local function var_31_2(arg_32_0)
					...
					local var_32_7 = var_5.ON_DROP_LIST
					local var_32_8 = {
						item2Row = true,
						itemList = var_32_2
					}
					...
					var_32_8.content = var_7.getConfig(var_32_9, "display")
				...
				var_31_4(var_31_3, var_2_10004.GET_CHAPTER_DROP_SHIP_LIST, arg_30_0.chapter.id, var_31_2)
			else
		...
		var_6(var_30_2, var_30_3, var_30_4, var_1_10010)
	end
...
function var_0_1.getChapterAwards(arg_33_0)
	...
	local var_33_1 = var_1_10002(var_33_0:getConfig("awards"))

	if var_33_0:getStageExtraAwards() then
		for iter_33_0 = #var_3, 1, -1 do
			table = var_1_10008

			var_1_10008.insert(var_33_1, 1, var_3[iter_33_0])
		end
	end
	...
	local var_33_4 = var_33_0.getPlayType(var_33_3)

	ChapterConst = var_33_3

	if var_33_4 == var_33_3.TypeMultiStageBoss then
		table = var_33_4
		...
		var_33_4(var_33_5, var_7.chapter_model_multistageboss[var_33_0.id].boss_expedition_id)
	end

	_ = var_33_4

	local var_33_6 = var_33_4.flatten(var_33_2)
	local var_33_7 = {}
	local var_33_8 = {}
	...
	for iter_33_1, iter_33_2 in var_1_10010(var_33_6) do
		...
		if var_1_10015(var_1_10016.expedition_activity_template[iter_33_2], {
			"pt_drop_display"
		}) then
			type = var_1_10016
	...
	for iter_33_5 = #var_33_7, 1, -1 do
		...
		for iter_33_6, iter_33_7 in var_1_10015(var_33_8[var_33_7[iter_33_5]]) do
			if var_33_15:getActivityById(iter_33_6) and not var_20:isEnd() then
				...
				DROP_TYPE_ITEM = var_1_10025
				var_33_19[1] = var_1_10025
				id2ItemId = var_1_10025
				var_33_19[2] = var_1_10025(var_33_7[iter_33_5])
...
function var_0_1.initTestShowDrop(arg_35_0, arg_35_1, arg_35_2)
	...
	if var_1_10003 then
		...
		if var_35_0(var_35_1) then
			...
			var_35_3(var_35_2, var_1_10007(var_1_10008))
			...
			var_35_5(var_35_4, var_1_10007(var_1_10008))
			...
			var_35_7(var_35_6, var_1_10007(var_1_10008))
		end
		...
		local var_35_10 = var_35_9(var_35_8, var_1_10007(var_1_10008))
		...
		var_6(arg_35_0, var_5, function()
			...
			local var_36_2 = var_2.ON_DROP_LIST
			local var_36_3 = {
				item2Row = true,
				itemList = arg_35_2
			}
			...
			var_36_3.content = var_4.getConfig(var_36_4, "display")
