...
local var_0_1 = var_1(".EggCellView")
...
function var_0_3.Update(arg_3_0)
	...
	if var_4.IsEnemyAttach(var_3_0.attachment) then
		...
		if var_3_4 == var_5.CellFlagActive then
			local var_3_5 = arg_3_0.chapter

			var_3_4 = var_3_4.existFleet
			FleetType = var_1_10006

			if var_3_4(var_3_5, var_1_10006.Transport, var_3_0.row, var_3_0.column) then
				var_3_3 = false
			end
		end
	end
	...
	if var_4.IsFogStage(var_3_7) then
		...
		defaultValue = var_3_9

		if var_3_9(arg_3_0.visible, true) ~= var_3_10 then
	...
	if var_4.isHuntingRangeVisible(var_3_11) then
		...
		var_3_12 = var_3_12.any(arg_3_0.chapter.fleets, function(arg_5_0)
			...
			local var_5_1 = arg_5_0.getFleetType(var_5_0)

			FleetType = var_5_0

			local var_5_2

			if var_5_1 == var_5_0.Submarine then
				if arg_5_0:isValid() then
					var_5_2 = arg_5_0:inHuntingRange(var_3_0.row, var_3_0.column)
				end
			else
				var_5_2 = false
			end
...
function var_0_3.TweenBlink(arg_6_0)
	...
	local var_6_2 = var_6_0.color

	tf = var_4

	local var_6_3 = var_4(var_1)

	Color = var_5

	local var_6_4 = var_6_2(var_6_3, var_5.New(1, 0.6, 0.6), 1)
	local var_6_5 = var_3.setFromColor

	Color = var_5

	local var_6_6 = var_6_5(var_6_4, var_5.white)
	local var_6_7 = var_3.setEase

	LeanTweenType = var_5

	local var_6_8 = var_6_7(var_6_6, var_5.easeInOutSine)
	local var_6_9 = var_3.setLoopPingPong(var_6_8)
	local var_6_10 = var_3.setOnComplete

	System = var_5
	arg_6_0.tweenId = var_6_10(var_6_9, var_5.Action(function()
		IsNil = var_2_10000
...
function var_0_3.TweenShining(arg_8_0, arg_8_1)
	...
	local var_8_2 = var_8_0.ShaderMgr.GetInstance()
	local var_8_3 = var_4.GetShader(var_8_2, "Spine/SkeletonGraphic (Additive)")

	Material = var_8_2
	var_8_1.material = var_8_2.New(var_8_3)
	LeanTween = var_6

	local var_8_4 = var_6.value

	go = var_1_10007

	local var_8_5 = var_8_4(var_1_10007(var_2), 0, 1, 0.5)
	local var_8_6 = var_6.setEase

	LeanTweenType = var_8

	local var_8_7 = var_8_6(var_8_5, var_8.easeInOutSine)
	local var_8_8 = var_6.setLoopPingPong(var_8_7, arg_8_1)
	local var_8_9 = var_6.setOnUpdate

	System = var_8

	local var_8_10 = var_8_9(var_8_8, var_8.Action_float(function(arg_9_0)
		local var_9_0 = var_0
		...
		local var_9_3 = var_2_10004.Lerp

		Color = var_2_10005

		local var_9_4 = var_2_10005.black

		Color = var_2_10006

		var_9_1(var_9_0, var_9_2, var_9_3(var_9_4, var_2_10006.gray, arg_9_0))
	...
	System = var_8
	arg_8_0.tweenId = var_8_11(var_8_10, var_8.Action(function()
		IsNil = var_2_10000
