...
function var_0_1.Update(arg_2_0)
	...
	local var_2_2 = var_2_0.flag

	ChapterConst = var_1_10004

	local var_2_3

	if var_2_2 == var_1_10004.CellFlagActive and arg_2_0.state ~= var_0_1.StateLive then
		arg_2_0.state = var_0_1.StateLive
		arg_2_0.dead = nil
		var_2_3 = arg_2_0

		arg_2_0.ClearLoader(var_2_3)
		...
		var_2_3(var_2_4, "land_based_template not exist: " .. var_2_0.attachmentId)

		var_1_10005 = arg_2_0
		var_1_10005 = arg_2_0.GetLoader(var_1_10005)

		var_2_3.GetPrefab(var_1_10005, "leveluiview/Tpl_Enemy", "Tpl_Enemy", function(arg_3_0)
			...
			Vector2 = var_2
			var_3_0.anchoredPosition = var_2(0, 10)
			...
			var_3_3(var_3_2, var_3_4, var_3_5, var_2_10005(arg_3_0, "icon"))
			...
			var_3_3(var_2(arg_3_0, "titleContain/bg_boss"), false)

			setActive = var_3_3
			findTF = var_2

			var_3_3(var_2(arg_3_0, "damage_count"), false)

			setActive = var_3_3
			findTF = var_2

			var_3_3(var_2(arg_3_0, "fighting"), false)
		...
		ChapterConst = var_2_3

		if var_2_5 == var_2_3.CellFlagDisabled and arg_2_0.state ~= var_0_1.StateDead then
			...
			if not var_3(arg_2_0.enemy) then
				...
				var_2_3(var_1_10005(var_2_6, "lv"), true)

				setActive = var_2_3
				findTF = var_5

				var_2_3(var_5(var_2_6, "titleContain"), true)

				setActive = var_2_3
				findTF = var_5

				var_2_3(var_5(var_2_6, "damage_count"), true)

				setActive = var_2_3
				findTF = var_5

				var_2_3(var_5(var_2_6, "fighting"), true)
			end
			...
			var_2_3(var_2_7, "land_based_template not exist: " .. var_2_0.attachmentId)

			local var_2_8 = arg_2_0:GetLoader()

			var_2_3.GetPrefab(var_2_8, "leveluiview/Tpl_Dead", "Tpl_Dead", function(arg_4_0)
				setParent = var_2_10001
				...
				Vector2 = var_2
				var_4_0.anchoredPosition = var_2(0, 10)
				...
				var_4_3(var_4_2, var_4_4, var_4_5, var_5(arg_4_0, "icon"))
				...
				var_4_3(var_2(arg_4_0, "effect_open"), false)

				setActive = var_4_3
				findTF = var_2

				var_4_3(var_2(arg_4_0, "huoqiubaozha"), var_2_1 == var_0_1.StateLive)
	...
	if var_2_9 == var_2_3.CellFlagActive and arg_2_0.enemy then
		setActive = var_3
		findTF = var_4

		local var_2_10 = var_4(arg_2_0.enemy, "effect_found")
		local var_2_11 = var_2_0.trait

		ChapterConst = var_6

		var_3(var_2_10, var_2_11 == var_6.TraitVirgin)

		local var_2_12 = var_2_0.trait

		ChapterConst = var_2_10

		if var_2_12 == var_2_10.TraitVirgin then
			pg = var_2_12
...
function var_0_1.DestroyGO(arg_5_0)
	...
	if not var_1_10001(arg_5_0.enemy) then
		...
		var_2(var_1_10003(var_5_0, "lv"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(var_5_0, "titleContain"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(var_5_0, "damage_count"), true)

		setActive = var_2
		findTF = var_3

		var_2(var_3(var_5_0, "fighting"), true)
	end
