...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_3, var_3("text_win_condition"))
	...
	var_1(var_2_6, var_3("text_lose_condition"))
	...
	var_1(var_2_10, var_3("desc_defense_reward"))
	...
	var_1(var_2_12, var_3("word_reward"))
	...
	var_1(var_2_14, var_3("text_rest_HP"))
...
function var_0_1.UpdateList(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	for iter_5_0 = 1, #arg_5_3 do
		...
		local var_5_22 = var_5_20(arg_5_2[iter_5_0] - 1)

		if arg_5_2[iter_5_0] - 1 ~= arg_5_2[iter_5_0 + 1] then
			tostring = var_13
			var_5_22 = var_13(arg_5_2[iter_5_0 + 1]) .. "-" .. var_5_22
		end

		setText = var_13

		var_13(var_5_21:Find("text"), var_5_22)

		local var_5_23 = arg_5_3[iter_5_0]

		updateDrop = var_14

		var_14(var_5_21:Find("award"), var_5_23, {
			hideName = true
		})
		...
		local var_5_25 = var_5_21:Find("award")
		...
		local function var_5_26()
			...
			var_6_1(var_6_0, var_2_10002.ON_DROP, var_5_23)
		...
		var_14(var_5_24, var_5_25, var_5_26, var_18)
		...
		var_5_24(var_5_21:Find("mask"), not var_5_27)
	end
...
function var_0_1.Enter(arg_7_0, arg_7_1)
	...
	var_1_10002(var_7_0, var_1_10004(arg_7_1:getConfig("win_condition_display")))
	...
	var_1_10002(var_7_1, var_4(arg_7_1:getConfig("lose_condition_display")))

	local var_7_2 = arg_7_1
	local var_7_3 = arg_7_1.getPlayType(var_7_2)

	ChapterConst = var_7_2

	local var_7_4 = var_7_3 == var_7_2.TypeDefence

	setActive = var_3

	var_3(arg_7_0.rewardList, var_7_4)
...
function var_0_1.UpdateRewardList(arg_8_0, arg_8_1)
	...
	var_5.insert(var_8_1, 1, var_3.port_hp + 1)
