...
function var_0_1.OnInit(arg_2_0)
	...
	local function var_2_8()
		...
		local var_4_3 = var_2_10002.SWITCH_ACT_MAP

		Map = var_2_10003

		var_4_2(var_4_1, var_4_3, var_2_10003.ACTIVITY_HARD)
	...
	local function var_2_11()
		...
		local var_5_3 = var_2_10002.ON_GO_TO_TASK_SCENE
		local var_5_4 = {}

		TaskScene = var_2_10004
		var_5_4.page = var_2_10004.PAGE_TYPE_ACT
...
function var_0_1.UpdateButtons(arg_8_0)
	...
	var_8_0(arg_8_0.sceneParent.actEliteBtn, false)
	...
	var_8_0(var_8_2, var_8_1 ~= var_4.ACTIVITY_HARD)
	...
	var_8_0(var_8_3, var_8_1 == var_4.ACTIVITY_HARD)

	Map = var_8_0

	if var_8_1 == var_8_0.ACTIVITY_HARD then
		_ = var_2
		...
		var_3(arg_8_0.missionBtn, var_8_4)

		if var_8_4 then
			setActive = var_3

			local var_8_5 = arg_8_0.missionBtn
			local var_8_6 = var_4.Find(var_8_5, "Tip")

			_ = var_8_5

			var_3(var_8_6, var_8_5.any(var_0_3, function(arg_10_0)
				getProxy = var_2_10001
				TaskProxy = var_2_10002
				...
				var_10_1 = var_1.getTaskById(var_10_0, arg_10_0) and var_1:isFinish()
