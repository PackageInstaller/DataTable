...
function var_0_1.Update(arg_3_0)
	...
	if var_1_10002(arg_3_0.go) then
		...
		var_3_2 = var_3_0.column

		local var_3_3 = var_3_0.data

		pg = var_1_10005

		local var_3_4 = var_1_10005.map_event_template[var_3_0.attachmentId].icon
		...
		local var_3_6 = arg_3_0.tf

		Vector2 = var_10

		var_8(var_3_6, var_10(0, 30))

		LeanTween = var_8

		local var_3_7 = var_8.moveY

		rtf = var_3_6

		local var_3_8 = var_3_7(var_3_6(arg_3_0.go), 40, 1.5)
		local var_3_9 = var_8.setEase

		LeanTweenType = var_10

		local var_3_10 = var_3_9(var_3_8, var_10.easeInOutSine)

		arg_3_0.attachTw = var_8.setLoopPingPong(var_3_10)

		local var_3_11 = arg_3_0:GetLoader()

		var_8.GetPrefab(var_3_11, "leveluiview/tpl_box", "tpl_box", function(arg_4_0)
			...
			var_1(var_4_0, var_3.zero)

			local var_4_1 = arg_3_0
			local var_4_2 = var_1.GetLoader(var_4_1)

			var_1.GetPrefab(var_4_2, "boxprefab/" .. var_3_4, var_3_4, function(arg_5_0)
				...
				local var_5_1 = var_3_10003(arg_4_0)

				var_3_10001(var_5_0, var_3.Find(var_5_1, "icon"))
	...
	local var_3_12 = var_3_0.flag

	ChapterConst = var_3_2

	local var_3_13 = var_3_12 == var_3_2.CellFlagActive

	setActive = var_3

	var_3(arg_3_0.tf, var_3_13)
