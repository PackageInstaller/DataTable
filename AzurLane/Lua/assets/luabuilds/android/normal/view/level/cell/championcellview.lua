...
local var_0_1 = var_1(".SpineCellView")
...
function var_0_3.InitChampionCellTransform(arg_2_0)
	...
	var_1(var_2_2, var_3("ui_word_levelui2_inevent"))
...
function var_0_3.UpdateChampionCell(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if var_3_0 ~= var_1_10005.TraitLurk then
		...
		if var_3_1 == var_5.CellFlagActive then
			...
			local var_3_3 = arg_3_1.existFleet

			FleetType = var_1_10006
			var_3_4 = not var_3_3(var_3_2, var_1_10006.Transport, arg_3_2.row, arg_3_2.column)
	...
	local var_3_6 = arg_3_1.existEnemy

	ChapterConst = var_1_10007

	local var_3_7 = var_3_6(var_3_5, var_1_10007.SubjectChampion, arg_3_2.row, arg_3_2.column)

	setActive = var_3_5

	var_3_5(arg_3_0.tfFighting, var_3_4 and var_3_7)

	setActive = var_3_5

	local var_3_8 = arg_3_0.tfEffectFound
	local var_3_9

	if var_3_4 then
		::label_3_1::

		var_3_9 = arg_3_2.trait
		ChapterConst = var_9
		var_3_9 = var_3_9 == var_9.TraitVirgin
	end

	var_3_5(var_3_8, var_3_9)

	setActive = var_3_5

	var_3_5(arg_3_0.tfDamageCount, var_3_4 and arg_3_2.data > 0)

	setActive = var_3_5

	local var_3_10 = arg_3_0.tf

	var_3_5(var_7.Find(var_3_10, "huoqiubaozha"), false)
	...
	if var_3_11 == var_7.TraitVirgin then
		pg = var_3_11
		var_3_12 = var_3_11.CriMgr.GetInstance()

		local var_3_13 = var_6.PlaySoundEffect_V3

		SFX_UI_WEIGHANCHOR_ENEMY = var_8

		var_3_13(var_3_12, var_8)
	end

	local var_3_14 = arg_3_0.tfShadow

	Vector3 = var_3_12
	var_3_14.localEulerAngles = var_3_12(arg_3_1.theme.angle, 0, 0)

	if var_3_4 then
		var_0_0.RefreshEnemyTplIcons(arg_3_0, arg_3_2:getConfigTable(), arg_3_1)
	end

	arg_3_0:SetActive(var_3_4)
