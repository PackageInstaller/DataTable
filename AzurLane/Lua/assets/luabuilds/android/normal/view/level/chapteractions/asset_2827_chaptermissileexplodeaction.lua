...
function var_0_0.applyTo(arg_7_0, arg_7_1, arg_7_2)
	if not arg_7_2 then
		...
		if #arg_7_0.cellUpdates > 0 then
			...
			ChapterConst = var_7
			var_7_1 = var_7_5(var_7_6, var_7.DirtyAutoAction)
		end
		...
		if #arg_7_0.shipUpdate > 0 then
			...
			ChapterConst = var_7
			var_7_0 = var_7_7(var_7_8, var_7.DirtyFleet)
		end
	...
	if arg_11_0.targetLine then
		...
		function var_11_1(arg_12_0)
			...
			if var_1.GetRawChapterCell(var_12_0, arg_12_0.row, arg_12_0.column) then
				...
				table = var_12_0
				var_12_0 = var_12_0.contains

				local var_12_1 = var_1
				local var_12_2 = var_1.GetFlagList(var_12_1)

				ChapterConst = var_12_1

				if var_12_0(var_12_2, var_12_1.FlagMissleAiming) then
					table = var_12_0
					var_12_0 = var_12_0.contains

					local var_12_3 = arg_12_0.flag_list

					ChapterConst = var_4
					var_12_0 = not var_12_0(var_12_3, var_4.FlagMissleAiming)
				end
			end
