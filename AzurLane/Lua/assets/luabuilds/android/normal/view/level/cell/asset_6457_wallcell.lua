...
function var_0_1.OverrideCanvas(arg_3_0)
	...
	local var_3_1 = var_1_10002(arg_3_0.go)

	Layer = var_3

	var_3_0(var_3_1, var_3.UI)
...
function var_0_1.ResetCanvasOrder(arg_4_0)
	...
	local var_4_2 = var_1_10003.floor(arg_4_0.line.row * 0.5)

	ChapterConst = var_4

	var_4_0(var_4_1, var_4_2 * var_4.PriorityPerRow + arg_4_0:GetOrder())
...
function var_0_1.RefreshDirection(arg_5_0)
	...
	Quaternion = var_2
	var_5_0.localRotation = var_2.Euler(arg_5_0.direction and 0.1 or -90, 90, -90)
