...
function var_0_1.Play(arg_4_0, arg_4_1)
	...
	var_1_10003(var_4.Find(var_4_1, "Title"), var_4_0.title)
	...
	local var_4_5 = var_4_2(var_4_4, var_6(var_1_10007))

	WorldMediaCollectionFileDetailLayer = var_4_4

	local var_4_6 = var_4_4.getTextPreferredHeight(var_4_5, var_4_3.rect.width, var_4_0.desc)
	local var_4_7 = 2
	...
	var_4_8(var_8.Find(var_4_9, "Lines"), var_4_7 + 1)
	...
	math = var_1_10011
	var_4_11.y = var_4_12 + var_1_10011.max(var_4_7 - 2, 0) * var_0_3
	...
	if var_4_0.icon then
		...
		var_8(var_4_14, var_4_15, var_11.Find(var_4_16, "Image"))
	...
	local var_4_22 = var_4_20(var_4_21, var_9(var_10))
