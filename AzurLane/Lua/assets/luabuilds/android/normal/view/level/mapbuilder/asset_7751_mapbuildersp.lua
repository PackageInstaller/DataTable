...
function var_0_1.OnInit(arg_4_0)
	...
	go = var_1_10004
	var_4_20[var_4_21] = var_4_22(var_1_10004(arg_4_0.storyNodeTpl), 0)

	local var_4_23 = arg_4_0.oneLineTpl
	local var_4_24 = var_0_2.New

	go = var_4
	var_4_20[var_4_23] = var_4_24(var_4(arg_4_0.oneLineTpl), 0)

	local var_4_25 = arg_4_0.branchHeadTpl
	local var_4_26 = var_0_2.New

	go = var_4
	var_4_20[var_4_25] = var_4_26(var_4(arg_4_0.branchHeadTpl), 0)

	local var_4_27 = arg_4_0.branchCenterTpl
	local var_4_28 = var_0_2.New

	go = var_4
	var_4_20[var_4_27] = var_4_28(var_4(arg_4_0.branchCenterTpl), 0)

	local var_4_29 = arg_4_0.branchUpTpl
	local var_4_30 = var_0_2.New

	go = var_4
	var_4_20[var_4_29] = var_4_30(var_4(arg_4_0.branchUpTpl), 0)

	local var_4_31 = arg_4_0.branchDownTpl
	local var_4_32 = var_0_2.New

	go = var_4
	var_4_20[var_4_31] = var_4_32(var_4(arg_4_0.branchDownTpl), 0)

	local var_4_33 = arg_4_0.unionTailTpl
	local var_4_34 = var_0_2.New

	go = var_4
	var_4_20[var_4_33] = var_4_34(var_4(arg_4_0.unionTailTpl), 0)

	local var_4_35 = arg_4_0.unionCenterTpl
	local var_4_36 = var_0_2.New

	go = var_4
	var_4_20[var_4_35] = var_4_36(var_4(arg_4_0.unionCenterTpl), 0)

	local var_4_37 = arg_4_0.unionUpTpl
	local var_4_38 = var_0_2.New

	go = var_4
	var_4_20[var_4_37] = var_4_38(var_4(arg_4_0.unionUpTpl), 0)

	local var_4_39 = arg_4_0.unionDownTpl
	local var_4_40 = var_0_2.New

	go = var_4
	var_4_20[var_4_39] = var_4_40(var_4(arg_4_0.unionDownTpl), 0)
	...
	var_4_42(var_4_41, var_3.SWITCH_SPCHAPTER_DIFFICULTY, function(arg_5_0, arg_5_1)
	...
	local var_4_45 = var_3.Find(var_4_44, "Mask/Story/Switch")
	...
	var_4_42(var_4_43, var_4_45, var_4_46, var_5)

	onButton = var_4_42

	local var_4_47 = arg_4_0
	local var_4_48 = arg_4_0.storyLayer
	local var_4_49 = var_3.Find(var_4_48, "Battle/Switch")
	...
	var_4_42(var_4_47, var_4_49, var_4_50, var_5)

	setText = var_4_42

	local var_4_51 = arg_4_0.storyLayer
	local var_4_52 = var_2.Find(var_4_51, "Desc/Desc")

	i18n = var_4_51

	var_4_42(var_4_52, var_4_51("series_enemy_storyreward"))
		...
		if var_9_5 then
			...
			if not var_3 then
				...
				if arg_9_0.contextData.map then
					...
					local var_9_19 = arg_9_0.sceneParent.rightChapter

					var_9_15(var_8.Find(var_9_19, "event_btns/tickets"), var_3)

					local var_9_20 = arg_9_0.sceneParent

					var_7.updateRemasterTicket(var_9_20)

					setActive = var_7

					local var_9_21 = arg_9_0.sceneParent.ptTotal

					ActivityConst = var_9

					if not var_9.HIDE_PT_PANELS and not var_3 then
						local var_9_23

						if var_9_2 and arg_9_0.sceneParent.ptActivity then
							local var_9_22 = arg_9_0.sceneParent.ptActivity

							if not var_9.isEnd(var_9_22) then
								var_9_23 = var_9_5
...
function var_0_1.BuildStoryTree(arg_19_0)
	...
	var_19_0.each(arg_19_0.spStoryIDs, function(arg_20_0)
		...
		ActivitySpStoryNode = var_20_0

		if var_20_1 ~= var_20_0.NODE_TYPE.UNRELEASED then
	...
	local function var_19_3()
		...
		tailList = var_2_10002

		var_21_3(var_2_10002, function(arg_22_0)
			table = var_3_10001
...
function var_0_1.UpdateView(arg_26_0)
	...
	if arg_26_0.contextData.displayMode == var_0_1.DISPLAY.STORY then
		...
		var_3(var_26_2, var_26_3 .. var_1_10006("levelscene_title_story"))
	else
		setText = var_3
	...
	var_5(var_6.Find(var_26_9, "Battle"), var_26_8)

	setActive = var_5

	local var_26_10 = arg_26_0._tf

	var_5(var_6.Find(var_26_10, "Story"), not var_26_8)

	getProxy = var_5
	ChapterProxy = var_6

	local var_26_11 = var_5(var_6)
	local var_26_12
	...
	var_26_11(var_7.Find(var_26_13, "Mask/Story/BattleTip"), false)

	setActive = var_26_11

	local var_26_14 = arg_26_0.storyLayer

	var_26_11(var_7.Find(var_26_14, "Battle/BattleTip"), var_26_12)
	...
	local var_26_18 = var_26_17(var_26_16, var_8(var_9))

	type = var_26_16

	if var_26_16(arg_26_0.spStoryIDs) ~= "table" or #arg_26_0.spStoryIDs == 0 then
		local var_26_19 = var_26_0

		if var_26_0.isRemaster(var_26_19) then
			setActive = var_26_19

			local var_26_20 = arg_26_0.battleLayer

			var_26_19(var_9.Find(var_26_20, "Mask"), false)

			local var_26_21, var_26_22 = var_26_0:isActivity()
			local var_26_23 = var_26_0:isSkirmish()
			local var_26_24 = var_26_0
			local var_26_25 = var_26_0.isEscort(var_26_24)

			setActive = var_26_24

			local var_26_26 = arg_26_0.sceneParent.remasterBtn

			OPEN_REMASTER = var_1_10014
			var_1_10014 = var_1_10014 and (var_7 or not var_26_21 and not var_26_25 and not var_26_23)

			var_26_24(var_26_26, var_1_10014)
		else
	...
	if var_26_8 then
		...
		var_7.SwitchMapBG(var_26_27, arg_26_0.contextData.map)

		local var_26_28 = arg_26_0.sceneParent

		var_7.PlayBGM(var_26_28)
	else
...
function var_0_1.UpdateBattle(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10004(var_27_1) do
		...
		local var_27_4 = var_27_0.getChapterById(var_27_3, iter_27_1)

		table = var_27_3

		var_27_3.insert(var_27_2, var_27_4)
	end
...
function var_0_1.UpdateMapItem(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_2 = var_31_0(arg_31_1, "main")
	...
	local var_31_3 = var_5(var_31_2, "circle/fordark")
	...
	if arg_31_2:isUnlock() then
		...
		if #var_31_5.list > 1 then
			table = var_10
			var_31_7 = var_10.indexof(var_31_5.list, arg_31_2.id) + 1
		elseif arg_31_2:IsSpChapter() or arg_31_2:IsEXChapter() then
			var_31_7 = 3
		else
			local var_31_8 = arg_31_0.contextData.map

			if var_10.isHardMap(var_31_8) then
				var_31_7 = 3
			end
		end
	end
	...
	local var_31_9 = var_10(var_31_2, "circle/bk")

	ipairs = var_11

	for iter_31_0, iter_31_1 in var_11(var_31_6) do
		setActive = var_1_10016

		var_1_10016(var_31_9:Find(iter_31_1), iter_31_0 == var_31_7)
	end

	findTF = var_11

	local var_31_10 = var_11(var_31_2, "circle/clear_flag")

	findTF = var_12

	local var_31_11 = var_12(var_31_2, "circle/lock")

	findTF = var_13

	local var_31_12 = var_13(var_31_2, "circle/progress")

	findTF = var_14

	local var_31_13 = var_14(var_31_2, "circle/progress_text")

	findTF = var_15

	local var_31_14 = var_15(var_31_2, "circle/stars")

	string = var_16

	local var_31_15 = var_16.split(var_31_1.name, "|")

	setText = var_17
	findTF = var_18

	var_17(var_18(var_31_2, "info/bk/title_form/title_index"), var_31_1.chapter_name .. "  ")

	setText = var_17
	findTF = var_18

	var_17(var_18(var_31_2, "info/bk/title_form/title"), var_31_15[1])

	setText = var_17
	findTF = var_18

	local var_31_16 = var_18(var_31_2, "info/bk/title_form/title_en")
	local var_31_17

	if not var_31_15[2] then
		var_31_17 = ""
	end

	var_17(var_31_16, var_31_17)

	setFillAmount = var_17

	var_17(var_31_12, arg_31_2.progress / 100)

	setText = var_17

	local var_31_18 = var_31_13

	string = var_19

	var_17(var_31_18, var_19.format("%d%%", arg_31_2.progress))

	setActive = var_17

	var_17(var_31_14, arg_31_2:existAchieve())
	...
	if arg_31_2:existAchieve() then
		...
		for iter_31_2, iter_31_3 in var_17(arg_31_2.achieves) do
			...
			var_1_10022 = var_1_10022.IsAchieved(iter_31_3)

			local var_31_19 = var_31_14:GetChild(iter_31_2 - 1)

			var_1_10023 = var_1_10023.Find(var_31_19, "light")
			setActive = var_31_19

			var_31_19(var_1_10023, var_1_10022)

			ipairs = var_31_19

			for iter_31_4, iter_31_5 in var_31_19(var_31_6) do
				if iter_31_5 ~= "Lock" then
					setActive = var_1_10029

					var_1_10029(var_1_10023:Find(iter_31_5), iter_31_4 == var_31_7)
				end
			end
		end
	end
	...
	local var_31_20 = var_17(var_31_2, "info/bk/BG")
	...
	for iter_31_6, iter_31_7 in var_18(var_31_6) do
		...
		var_1_10023(var_31_20:Find(iter_31_7), iter_31_6 == var_31_7)
	end

	setActive = var_18
	findTF = var_19

	var_18(var_19(var_31_2, "HardEffect"), var_31_7 == 3)

	local var_31_21 = not arg_31_2.active and arg_31_2:isClear()
	local var_31_22, var_31_23

	if not arg_31_2.active then
		var_31_22 = arg_31_2
		var_31_23 = not arg_31_2.isUnlock(var_31_22)
	else
		var_31_23 = false
	end
	...
	var_31_22(var_31_10, var_31_21)

	setActive = var_31_22

	var_31_22(var_31_11, var_31_23)

	setActive = var_31_22

	var_31_22(var_31_13, not var_31_21 and not var_31_23)
	arg_31_0:DeleteTween("fighting" .. arg_31_2.id)

	findTF = var_20

	local var_31_24 = var_20(var_31_2, "circle/fighting")

	setText = var_21
	findTF = var_22

	local var_31_25 = var_22(var_31_24, "Text")

	i18n = var_23

	var_21(var_31_25, var_23("tag_level_fighting"))

	findTF = var_21

	local var_31_26 = var_21(var_31_2, "circle/oni")

	setText = var_22
	findTF = var_23

	local var_31_27 = var_23(var_31_26, "Text")

	i18n = var_24

	var_22(var_31_27, var_24("tag_level_oni"))

	findTF = var_22

	local var_31_28 = var_22(var_31_2, "circle/narrative")

	setText = var_23
	findTF = var_24

	local var_31_29 = var_24(var_31_28, "Text")

	i18n = var_25

	var_23(var_31_29, var_25("tag_level_narrative"))

	setActive = var_23

	var_23(var_31_24, false)

	setActive = var_23

	var_23(var_31_26, false)

	setActive = var_23

	var_23(var_31_28, false)
	...
	if arg_31_2.active then
		var_31_30 = arg_31_2:existOni() and var_31_26 or var_31_24
	end
	...
	if var_31_30 then
		...
		var_31_34(var_31_30, true)

		GetOrAddComponent = var_31_34

		local var_31_32 = var_31_34(var_31_30, "CanvasGroup")

		var_31_32.alpha = 1

		local var_31_33 = arg_31_0

		var_31_34 = arg_31_0.RecordTween

		local var_31_35 = "fighting" .. arg_31_2.id

		LeanTween = var_28

		local var_31_36 = var_28.alphaCanvas(var_31_32, 0, 0.5)
		local var_31_37 = var_28.setFrom(var_31_36, 1)
		local var_31_38 = var_28.setEase

		LeanTweenType = var_30

		local var_31_39 = var_31_38(var_31_37, var_30.easeInOutSine)

		var_31_34(var_31_33, var_31_35, var_28.setLoopPingPong(var_31_39).uniqueId)
	end

	findTF = var_31_34

	local var_31_40 = var_31_34(var_31_2, "triesLimit")
	local var_31_41 = arg_31_2
	local var_31_42 = arg_31_2.isTriesLimit(var_31_41)

	setActive = var_31_41

	var_31_41(var_31_40, var_31_42)

	if var_31_42 then
		local var_31_43 = arg_31_2:getConfig("count") - arg_31_2:getTodayDefeatCount() .. "/" .. var_27

		setText = var_29

		local var_31_44 = var_31_40
		local var_31_45 = var_31_40.Find(var_31_44, "label")

		i18n = var_31_44

		var_29(var_31_45, var_31_44("levelScene_chapter_count_tip"))

		setText = var_29

		local var_31_46 = var_31_40
		local var_31_47 = var_31_40.Find(var_31_46, "Text")

		setColorStr = var_31_46

		local var_31_48 = var_31_43

		if var_27 <= arg_31_2:getTodayDefeatCount() then
			COLOR_RED = var_33
			...
			var_29(var_31_47, var_31_46(var_31_48, var_33))

			pg = var_29

			local var_31_49 = var_29.expedition_data_by_map
			local var_31_50 = arg_31_2
			local var_31_51 = var_31_49[arg_31_2.getConfig(var_31_50, "map")].on_activity

			getProxy = var_30
			ChapterProxy = var_31_50

			local var_31_52 = var_30(var_31_50)
			local var_31_53

			if var_30.IsActivitySPChapterActive(var_31_52, var_31_51) then
				SettingsProxy = var_31_53
				var_31_53 = var_31_53.IsShowActivityMapSPTip()
			end

			setActive = var_31_52

			var_31_52(var_31_40:Find("TipRect"), var_31_53)

			local var_31_54 = arg_31_2
			local var_31_55 = arg_31_2.GetDailyBonusQuota(var_31_54)

			findTF = var_31_54

			local var_31_56 = var_31_54(var_31_2, "mark")
			local var_31_57 = var_28.Find(var_31_56, "bonus")
			local var_31_58 = var_29.Find(var_31_57, "icon")

			findTF = var_31_57

			local var_31_59 = var_31_57(var_29, "icon/Image")

			setActive = var_32

			var_32(var_29, var_31_55)

			setActive = var_32

			var_32(var_28, var_31_55)

			local var_31_60, var_31_61

			if var_31_58 then
				setActive = var_32
				var_31_60 = var_31_58
				var_31_61 = var_31_55 and arg_31_0.bonusPtIconPath

				var_32(var_31_60, var_31_61)
			end

			if var_31_55 then
				var_31_60 = var_28

				local var_31_62 = var_28.GetComponent

				typeof = var_31_61
				CanvasGroup = var_1_10035

				local var_31_63 = var_31_62(var_31_60, var_31_61(var_1_10035))

				var_31_60 = arg_31_2:GetDailyBonusIconName()

				local var_31_64 = arg_31_0.sceneParent.loader

				var_34.GetSprite(var_31_64, "ui/levelmainscene_atlas", var_31_60, var_29)

				if var_31_58 and arg_31_0.bonusPtIconPath then
					if var_31_59 then
						GetImageSpriteFromAtlasAsync = var_34

						var_34(arg_31_0.bonusPtIconPath, "", var_31_59, true)
					else
						GetImageSpriteFromAtlasAsync = var_34

						var_34(arg_31_0.bonusPtIconPath, "", var_31_58, true)
					end
				end

				LeanTween = var_34

				local var_31_65 = var_34.cancel

				go = var_31_64

				var_31_65(var_31_64(var_28), true)

				local var_31_66 = var_28.anchoredPosition.y

				var_31_63.alpha = 0
				LeanTween = var_35

				local var_31_67 = var_35.value

				go = var_36

				local var_31_68 = var_31_67(var_36(var_28), 0, 1, 0.2)
				local var_31_69 = var_35.setOnUpdate

				System = var_1_10037

				local var_31_70 = var_31_69(var_31_68, var_1_10037.Action_float(function(arg_32_0)
					var_31_63.alpha = arg_32_0

					local var_32_0 = var_0.anchoredPosition

					var_32_0.y = var_31_66 * arg_32_0
					var_0.anchoredPosition = var_32_0

					return
				end))
				local var_31_71 = var_35.setOnComplete

				System = var_1_10037

				local var_31_72 = var_31_71(var_31_70, var_1_10037.Action(function()
					var_31_63.alpha = 1

					local var_33_0 = var_0.anchoredPosition

					var_33_0.y = var_31_66
					var_0.anchoredPosition = var_33_0

					return
				end))
				local var_31_73 = var_35.setEase

				LeanTweenType = var_1_10037

				local var_31_74 = var_31_73(var_31_72, var_1_10037.easeOutSine)

				var_35.setDelay(var_31_74, 0.7)
			end

			local var_31_75 = arg_31_2.id

			onButton = var_31_60

			local var_31_76 = arg_31_0
			local var_31_77 = var_31_2

			local function var_31_78()
				local var_34_0 = arg_31_0

				var_0.TryOpenChapterInfo(var_34_0, var_31_75, nil, var_31_5.list)
			...
			var_31_60(var_31_76, var_31_77, var_31_78, var_1_10037)
...
function var_0_1.SwitchChapter(arg_35_0, arg_35_1)
	...
	local var_35_1 = var_6(var_1_10007)
	local var_35_2 = var_6.getRawData(var_35_1).id

	PlayerPrefs = var_35_1

	var_35_1.SetInt("spchapter_selected_" .. var_35_2 .. "_" .. var_35_0, var_4)
...
function var_0_1.UpdateChapterTF(arg_36_0, arg_36_1)
	...
	if arg_36_0.chapterTFsById[arg_36_1] then
		...
		local var_36_0 = var_1_10004(var_1_10005)
...
function var_0_1.UpdateStoryNodeStatus(arg_38_0)
	...
	for iter_38_0 = 1, #var_38_4 do
		...
		if var_38_11 and var_38_11 ~= "" then
			var_1_10018 = var_38_2
			var_38_0 = var_38_0 + (var_38_2.IsPlayed(var_1_10018, var_38_11) and 1 or 0)
			var_38_1 = var_38_1 + 1
		end
		...
		if not var_38_12 and var_38_9 then
			...
			var_1_10018.each(var_10:GetUnlockConditions(), function(arg_40_0)
				...
				if var_40_1 == var_2_10003.CONDITION.TIME then
					pg = var_40_1
					var_40_2 = var_40_1.TimeMgr.GetInstance()
					var_40_1 = var_40_1.parseTimeFromConfig(var_40_2, arg_40_0[2])
					pg = var_40_2

					local var_40_3 = var_40_2.TimeMgr.GetInstance()

					var_40_0 = var_40_1 <= var_40_2.GetServerTime(var_40_3)
				else
					var_40_1 = arg_40_0[1]
					ActivitySpStoryNode = var_40_2

					if var_40_1 == var_40_2.CONDITION.PASSCHAPTER then
						var_40_1 = arg_40_0[2]
						_ = var_3
						var_40_0 = var_3.all(var_40_1, function(arg_41_0)
							...
							local var_41_0 = var_3_10001(var_3_10002)
						...
						if var_40_1 == var_3.CONDITION.PT then
							...
							if var_40_1 == var_2_10006 then
								...
								var_2_10007 = var_2_10006(var_2_10007)
								var_2_10007 = var_2_10006.getRawData(var_2_10007)
								var_40_6 = var_2_10006.getResource(var_2_10007, arg_40_0[2])
							else
								...
								if var_40_1 == var_2_10006 then
									...
									local var_40_7 = var_2_10006(var_2_10007)
...
function var_0_1.UpdateStory(arg_42_0)
	...
	local function var_42_16()
		...
		;(function()
			...
			tf = var_3_10004
			var_44_4.nodeTF = var_3_10004(var_44_1)
		...
		elseif #var_43_2 == 1 then
			var_2_10007 = var_43_2[1]

			local var_43_3 = var_43_14.GetConfigID(var_2_10007)
			local var_43_4 = arg_42_0

			var_2_10007 = var_2_10007.DequeItem(var_43_4, arg_42_0.oneLineTpl)
			string = var_43_4
			var_2_10007.name = var_43_4.format("Line%s_%s", var_43_1, var_43_3)
			setAnchoredPosition = var_8

			local var_43_5 = var_2_10007
			local var_43_6 = var_0.nodePos

			Vector2 = var_11

			var_8(var_43_5, var_43_6 + var_11.New(var_42_7 + var_42_15, 0))

			tf = var_8

			local var_43_7 = var_8(var_2_10007).anchoredPosition

			Vector2 = var_9

			local var_43_8 = var_43_7 + var_9.New(var_42_8 + var_42_13, 0)
			local var_43_9 = nextPos
			local var_43_10 = arg_42_0.storyNodeStatus[var_43_3].status
			...
			var_9(var_2_10007, function(arg_45_0)
				...
				var_3_10001(var_45_0, var_3_10003.NewHex(var_42_0[var_43_10]))
			...
			local var_43_11 = var_9.insert
			local var_43_12 = var_42_5
			local var_43_13 = {
				node = var_43_14
			}

			nextPos = var_12
			var_43_13.nodePos = var_12

			var_43_11(var_43_12, var_43_13)
		elseif #var_43_2 > 1 then
			var_43_14 = {}
			...
			local var_43_16 = var_7.max(var_43_14) * (var_42_7 + var_42_13 + var_42_15) + (var_7 - 1) * var_42_8
			local var_43_17 = var_0.nodePos

			Vector2 = var_10

			local var_43_18 = var_43_17 + var_10.New(var_42_7 + var_42_15, 0)

			;(function()
				local var_48_0 = arg_42_0
				local var_48_1 = var_0.DequeItem(var_48_0, arg_42_0.branchHeadTpl)

				setAnchoredPosition = var_48_0

				var_48_0(var_48_1, var_43_18)

				local var_48_2 = var_43_18

				Vector2 = var_2
				var_43_18 = var_48_2 + var_2.New(var_42_9, 0)
				...
				var_2(var_48_1, function(arg_49_0)
					...
					var_4_10001(var_49_0, var_4_10003.NewHex(var_42_0[var_48_5]))
			...
			var_11.Ipairs(var_43_2, function(arg_50_0, arg_50_1)
				...
				if var_43_14[arg_50_0] < var_0 then
					local var_50_1 = var_43_14[arg_50_0]

					var_50_0 = (var_43_16 - var_50_1 * (var_42_7 + var_42_13 + var_42_15)) / (var_50_1 + 1)
				end

				local var_50_2 = arg_50_1:GetConfigID()
				local var_50_3 = var_43_18
				...
				;(function()
					...
					if arg_50_0 == 1 then
						...
						var_51_2 = var_50_3
						Vector2 = var_2
						var_50_3 = var_51_2 + var_2.New(var_42_10, var_42_11)
						...
						if var_43_14[arg_50_0] < var_0 then
							...
							local var_51_4 = var_3(var_51_0)

							var_2(var_3.Find(var_51_4, "Line_1"), var_51_2)

							local var_51_5 = var_50_3

							Vector2 = var_3
							var_50_3 = var_51_5 + var_3.New(var_50_0, 0)
						end
					else
						if arg_50_0 == 3 or arg_50_0 == 2 and #var_43_2 == 2 then
							var_51_2 = arg_42_0.storyTree.childDict

							local var_51_6 = var_43_2[1]

							if var_51_2[var_2.GetConfigID(var_51_6)] then
								local var_51_7 = arg_42_0

								var_51_0 = var_51_2.DequeItem(var_51_7, arg_42_0.branchDownTpl)
								setAnchoredPosition = var_51_2
								...
								if var_43_14[arg_50_0] < var_0 then
									...
									local var_51_8 = var_51_2(var_51_0)

									var_51_2.x = var_51_2.Find(var_51_8, "Line_1").sizeDelta.x + var_50_0
									setSizeDelta = var_2
									tf = var_3

									local var_51_9 = var_3(var_51_0)

									var_2(var_3.Find(var_51_9, "Line_1"), var_51_2)
						...
						local var_51_11 = arg_42_0

						var_51_0 = var_51_2.DequeItem(var_51_11, arg_42_0.branchCenterTpl)
						setAnchoredPosition = var_51_2
						...
						var_51_2 = var_50_3
						Vector2 = var_2
						var_50_3 = var_51_2 + var_2.New(var_42_10, 0)
						...
						if var_43_14[arg_50_0] < var_0 then
							...
							local var_51_12 = var_50_3

							Vector2 = var_3
							var_50_3 = var_51_12 + var_3.New(var_50_0, 0)
						end
					end
					...
					local var_51_13 = arg_42_0.storyNodeStatus[var_50_2].status
					...
					var_2(var_51_0, function(arg_52_0)
						...
						var_5_10001(var_52_0, var_5_10003.NewHex(var_42_0[var_51_13]))
				...
				setAnchoredPosition = var_50_4

				var_50_4(var_50_5, var_50_3)
				...
				if arg_42_0.storyTree.childDict[var_50_2] then
					...
					function var_50_10()
						if not var_50_9 or var_50_9 == var_43_15 then
							return
						end
						...
						local var_53_2 = var_53_0.format
						local var_53_3 = "Line%s_%s"
						local var_53_4 = var_50_8
						local var_53_5 = var_3.GetConfigID(var_53_4)
						local var_53_6 = var_50_9

						var_53_1.name = var_53_2(var_53_3, var_53_5, var_4.GetConfigID(var_53_6))
						setAnchoredPosition = var_1
						...
						Vector2 = var_2
						var_50_3 = var_53_7 + var_2.New(var_50_0 + var_42_13, 0)
						setSizeDelta = var_1
						...
						var_2(var_53_1, function(arg_54_0)
							...
							var_5_10001(var_54_0, var_5_10003.NewHex(var_42_0[var_53_10]))
						...
						tf = var_4_10006
						var_53_17.nodeTF = var_4_10006(var_53_12)
				...
				if var_43_15 then
					...
					if arg_50_0 == 1 then
						...
						if var_43_14[arg_50_0] < var_0 then
							...
							local var_50_14 = var_11(var_50_11)

							var_10(var_11.Find(var_50_14, "Line_1"), var_50_10)
					...
					elseif arg_50_0 == 3 or arg_50_0 == 2 and #var_43_2 == 2 then
						...
						if var_43_14[arg_50_0] < var_0 then
							...
							local var_50_17 = var_11(var_50_11)

							var_10(var_11.Find(var_50_17, "Line_1"), var_50_10)
					...
					local var_50_22 = var_43_15

					var_50_11.name = var_50_19(var_50_20, var_50_21, var_12.GetConfigID(var_50_22))

					local var_50_23 = arg_42_0.storyNodeStatus
					local var_50_24 = var_43_15
					...
					var_10(var_50_11, function(arg_55_0)
						...
						var_4_10001(var_55_0, var_4_10003.NewHex(var_42_0[var_50_25]))
			...
			Vector2 = var_11
			var_43_18 = var_43_18 + var_11.New(var_43_16 + var_42_10, 0)

			if var_43_15 then
				(function()
					local var_56_0 = var_43_18

					Vector2 = var_3_10001
					var_43_18 = var_56_0 + var_3_10001.New(var_42_10, 0)
					...
					var_56_1(var_56_2, var_43_18)

					local var_56_3 = var_43_18

					Vector2 = var_2
					var_43_18 = var_56_3 + var_2.New(var_42_12 + var_42_14, 0)

					local var_56_4 = arg_42_0.storyNodeStatus
					local var_56_5 = var_43_15
					...
					var_2(var_56_2, function(arg_57_0)
						...
						var_4_10001(var_57_0, var_4_10003.NewHex(var_42_0[var_56_6]))
				...
				var_42_2 = var_43_18.x + var_42_4
			end
		end

		next = var_43_14

		return var_43_14(var_42_5)
	end
	...
	if arg_42_0.spStoryUnreleasedNode then
		...
		var_18(var_42_18, var_20.GetDisplayName(var_42_19))

		ResourceMgr = var_18

		local var_42_20 = var_18.Inst
		local var_42_21 = var_18.getAssetAsync
		local var_42_22 = "ui/"
		local var_42_23 = arg_42_0.spStoryUnreleasedNode
		local var_42_24 = var_42_22 .. var_21.GetCleanAnimator(var_42_23)
		local var_42_25 = ""

		UnityEngine = var_42_23

		var_42_21(var_42_20, var_42_24, var_42_25, var_42_23.Events.UnityAction_UnityEngine_Object(function(arg_58_0)
			...
			local var_58_1 = var_2.New(-525, 0, 380)
	...
	for iter_42_0 = 1, #var_42_26 do
		...
		if var_42_29 == var_0_3 then
			var_42_32 = var_22:GetUnlockDesc()

			local var_42_33 = ""

			type = var_1_10029

			if var_1_10029(var_42_32) == "table" then
				if not arg_42_0.storyNodeStatus[var_42_28].conditionFinishedList then
					var_1_10029 = {}
				end

				var_42_33 = var_42_32[1] or ""
				ipairs = var_30

				for iter_42_1, iter_42_2 in var_30(var_42_32) do
					if not var_1_10029[iter_42_1] then
						var_42_33 = iter_42_2 or ""

						break
					end
				end
			else
				var_42_33 = var_42_32 or ""
			end

			setScrollText = var_1_10029

			local var_42_34 = var_42_31

			HXSet = var_1_10031

			var_1_10029(var_42_34, var_1_10031.hxLan(var_42_33))

			setTextAlpha = var_1_10029

			var_1_10029(var_42_31, 0.5)
		else
			setScrollText = var_42_32

			local var_42_35 = var_42_31

			HXSet = var_1_10029
			var_1_10029 = var_1_10029.hxLan
			var_1_10031 = var_22

			var_42_32(var_42_35, var_1_10029(var_22.GetDisplayName(var_1_10031)))

			setTextAlpha = var_42_32

			var_42_32(var_42_31, 1)
		end

		local var_42_36 = var_22
		local var_42_37 = var_22.GetType(var_42_36)

		setActive = var_42_36

		var_42_36(var_25:Find("circle/lock"), var_42_29 == var_0_3)

		if var_42_29 == var_0_3 then
			setActive = var_28

			var_28(var_25:Find("circle/Story"), false)

			setActive = var_28

			var_28(var_25:Find("circle/Battle"), false)

			setActive = var_28

			var_28(var_25:Find("circle/Option"), false)
			...
			if var_42_37 == var_28.NODE_TYPE.STORY then
				setActive = var_28
				...
				var_28(var_25:Find("circle/Story"), true)
				...
				var_28(var_25:Find("circle/Story/Done"), var_42_29 == var_0_5)
			else
				ActivitySpStoryNode = var_28

				if var_42_37 == var_28.NODE_TYPE.OPTION_BRANCH then
					setActive = var_28

					var_28(var_25:Find("circle/Option"), true)
					...
					var_28(var_25:Find("circle/Option/Done"), var_42_29 == var_0_5)
				else
					ActivitySpStoryNode = var_28

					if var_42_37 == var_28.NODE_TYPE.BATTLE then
						setActive = var_28
						...
						local var_42_38 = var_25

						var_1_10029 = var_25.Find(var_42_38, "circle/Battle")
						ActivitySpStoryNode = var_42_38

						var_28(var_1_10029, var_42_37 == var_42_38.NODE_TYPE.BATTLE)

						setActive = var_28

						var_28(var_25:Find("circle/Battle/Done"), var_42_29 == var_0_5)
					end
				end
			end
		end
		...
		var_1_10029(var_25.Find(var_1_10031, "circle/progress"), var_42_39)

		local var_42_40 = var_22

		if var_22.IsRecrew(var_42_40) == nil then
			setActive = var_42_40

			var_42_40(var_25:Find("recrew"), false)
		else
			setActive = var_42_40

			var_42_40(var_25:Find("recrew"), true)

			setActive = var_42_40

			var_42_40(var_25:Find("recrew/recrewed"), var_1_10029)

			setActive = var_42_40

			var_42_40(var_25:Find("recrew/not_recrew"), not var_1_10029)

			setText = var_42_40

			local var_42_41 = var_25

			var_1_10031 = var_25.Find(var_42_41, "recrew/recrewed/label")
			i18n = var_42_41

			var_42_40(var_1_10031, var_42_41("story_recrewed"))

			setText = var_42_40

			local var_42_42 = var_25

			var_1_10031 = var_25.Find(var_42_42, "recrew/not_recrew/label")
			i18n = var_42_42

			var_42_40(var_1_10031, var_42_42("story_not_recrew"))
		end

		onButton = var_42_40

		var_42_40(arg_42_0, var_25, function()
			if var_42_29 == var_0_3 then
				return
			end
	...
	local var_42_43 = arg_42_0.storyReadCount
	local var_42_44 = arg_42_0.storyReadMax

	setText = var_20

	var_20(arg_42_0.progressText, var_42_43 .. "/" .. var_42_44)

	setActive = var_20

	local var_42_45 = arg_42_0.storyAward

	tobool = var_22

	var_20(var_42_45, var_22(arg_42_0.storyTask))

	if arg_42_0.storyTask then
		local var_42_46 = arg_42_0.storyTask
		local var_42_47 = var_20.getConfig(var_42_46, "award_display")

		Drop = var_42_46

		local var_42_48 = var_42_46.New({
			type = var_42_47[1][1],
			id = var_42_47[1][2],
			count = var_42_47[1][3]
		})
		...
		var_22(var_23.GetChild(var_42_49, 0), var_42_48)

		local var_42_50 = arg_42_0.storyTask
		local var_42_51 = var_22.getTaskStatus(var_42_50)

		setActive = var_42_50

		local var_42_52 = arg_42_0.storyAward

		var_42_50(var_24.Find(var_42_52, "get"), var_42_51 == 1)

		setActive = var_42_50

		local var_42_53 = arg_42_0.storyAward

		var_42_50(var_24.Find(var_42_53, "got"), var_42_51 == 2)

		onButton = var_42_50

		var_42_50(arg_42_0, arg_42_0.storyAward, function()
			local var_61_0 = arg_42_0
			local var_61_1 = var_0.emit

			BaseUI = var_2_10002

			var_61_1(var_61_0, var_2_10002.ON_DROP, var_42_48)
...
function var_0_1.DequeItem(arg_62_0, arg_62_1)
	...
	var_62_0.insert(arg_62_0.activeItems, {
		template = arg_62_1,
		active = var_62_1
	})
...
function var_0_1.Move2UnlockStory(arg_63_0)
	...
	for iter_63_0 = #var_63_0, 1, -1 do
		var_1_10009 = var_63_0[iter_63_0]

		local var_63_2 = var_7.GetConfigID(var_1_10009)

		if arg_63_0.storyNodeStatus[var_63_2].status > var_0_3 then
			var_63_1 = var_63_2
	...
	local var_63_6 = var_6.clamp
	local var_63_7 = var_63_5
	local var_63_8 = 0

	math = var_1_10009

	local var_63_9 = var_63_6(var_63_7, var_63_8, var_1_10009.max(0, arg_63_0.storyContainer.rect.width - arg_63_0.storyContainer.parent.rect.width))
...
function var_0_1.TrySubmitTask(arg_65_0)
	...
	for iter_65_0, iter_65_1 in var_1_10002(arg_65_0.spStoryNodes) do
		local var_65_1 = iter_65_1

		if iter_65_1.GetStoryName(var_65_1) and var_7 ~= "" and var_65_0 then
			pg = var_65_1

			local var_65_2 = var_65_1.NewStoryMgr.GetInstance()

			var_65_0 = var_8.IsPlayed(var_65_2, var_7)
		end
	...
	if var_65_0 and arg_65_0.storyTask then
		local var_65_3 = arg_65_0.storyTask

		if var_2.getTaskStatus(var_65_3) == 1 then
			local var_65_4 = arg_65_0
			local var_65_5 = arg_65_0.emit

			LevelMediator2 = var_4

			var_65_5(var_65_4, var_4.ON_SUBMIT_TASK, arg_65_0.storyTask.id)
	...
	var_66_0({
		function(arg_67_0)
			...
			if var_1(arg_66_1) and var_1 > 0 then
				...
				var_67_1(var_67_0, var_2_10004.ON_PERFORM_COMBAT, var_1, nil, var_66_1)
			else
...
function var_0_1.UpdateStoryTask(arg_69_0)
	...
	if arg_69_0.activity then
		var_1_10002 = arg_69_0.activity
		var_69_0 = var_1.getConfig(var_1_10002, "config_client").task_id
	end
	...
	local var_69_1 = var_1_10002(var_1_10003)
	local var_69_2

	if not var_2.getTaskVO(var_69_1, var_69_0) then
		Task = var_69_2
		var_69_2 = var_69_2.New({
			submit_time = 1,
			id = var_69_0
		})
	end

	arg_69_0.storyTask = var_69_2
