...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_3, var_3("autofight_rewards_none"))

	setText = var_1

	local var_2_4 = arg_2_0.window

	var_1(var_2.Find(var_2_4, "Fixed/top/bg/obtain/title"), arg_2_0.contextData.title)

	setText = var_1

	local var_2_5 = arg_2_0.window

	var_1(var_2.Find(var_2_5, "Fixed/top/bg/obtain/title/title_en"), arg_2_0.contextData.subTitle)

	setText = var_1

	local var_2_6 = arg_2_0.window
	local var_2_7 = var_2.Find(var_2_6, "Fixed/ButtonGO/pic")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("autofight_onceagain"))

	setText = var_1

	local var_2_8 = arg_2_0.window
	local var_2_9 = var_2.Find(var_2_8, "Fixed/ButtonExit/pic")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("autofight_leave"))
