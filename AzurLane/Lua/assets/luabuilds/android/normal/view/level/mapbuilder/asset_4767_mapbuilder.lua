...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_2(var_1_1, var_6.ON_FROZEN, function()
	...
	var_1_4(var_1_3, var_6.ON_UNFROZEN, function()
		arg_1_0.isFrozen = nil
...
function var_0_1.TryOpenChapterInfo(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	if not var_4.isUnlock(var_28_3) then
		...
		if #var_4.GetPrevChapterNames(var_28_3) == 1 then
			...
			local var_28_4 = var_28_3.TipsMgr.GetInstance()

			var_28_3 = var_28_3.ShowTips
			i18n = var_1_10008

			var_28_3(var_28_4, var_1_10008("levelScene_tracking_error_pre", var_5[1]))
		else
			pg = var_28_3

			local var_28_5 = var_28_3.TipsMgr.GetInstance()

			var_28_3 = var_28_3.ShowTips
			i18n = var_1_10008

			var_28_3(var_28_5, var_1_10008("levelScene_tracking_error_pre_2", var_5[1], var_5[2]))
		end
	...
	local var_28_6 = var_5(var_28_3)
	local var_28_7 = var_5.getMapById
	local var_28_8 = var_4
	local var_28_9 = var_28_7(var_28_6, var_4.getConfig(var_28_8, "map"))

	if not var_5.isRemaster(var_28_9) and not var_4:inActTime() then
		pg = var_6

		local var_28_10 = var_6.TipsMgr.GetInstance()
		local var_28_11 = var_6.ShowTips

		i18n = var_28_8

		var_28_11(var_28_10, var_28_8("battle_levelScene_close"))

		return
	end

	local var_28_12 = var_4
	local var_28_13 = var_4.getConfig(var_28_12, "unlocklevel")

	getProxy = var_28_12
	PlayerProxy = var_8

	local var_28_14 = var_28_12(var_8)
	local var_28_15, var_28_16

	if var_7.getRawData(var_28_14).level < var_28_13 then
		pg = var_28_16
		var_28_15 = var_28_16.TipsMgr.GetInstance()
		var_28_16 = var_28_16.ShowTips
		i18n = var_1_10010

		var_28_16(var_28_15, var_1_10010("levelScene_chapter_level_limit", var_28_13))

		return
	end

	getProxy = var_28_16
	ChapterProxy = var_28_15

	local var_28_17 = var_28_16(var_28_15)
	...
	if var_8.getActiveChapter(var_28_17, true) and var_8.id ~= arg_28_1 then
		...
		var_28_19(var_28_18, var_1_10011.ON_STRATEGYING_CHAPTER)
