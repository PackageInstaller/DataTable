...
function var_0_1.InitUI(arg_6_0)
	...
	local var_6_7 = var_2.Find(var_6_6, "atttr_panel/abilitys/mask/content")
	local var_6_8 = arg_6_0.descFrameTF

	arg_6_0.abilitysTF = var_6_5(var_6_7, var_3.Find(var_6_8, "atttr_panel/abilitys/mask/content/attr"))
	UIItemList = var_1

	local var_6_9 = var_1.New
	local var_6_10 = arg_6_0.descFrameTF
	local var_6_11 = var_2.Find(var_6_10, "atttr_panel/talents/mask/content")
	local var_6_12 = arg_6_0.descFrameTF

	arg_6_0.talentsTF = var_6_9(var_6_11, var_3.Find(var_6_12, "atttr_panel/talents/mask/content/attr"))
	...
	local var_6_26 = var_2.Find(var_6_25, "record/content")
	local var_6_27 = arg_6_0.recordPanel

	arg_6_0.recordList = var_6_24(var_6_26, var_3.Find(var_6_27, "record/content/commanders"))
	onButton = var_1
	...
	local function var_6_30()
		...
		var_7_1.type = var_2_10002.COMMANDER_OP_REST_ALL
	...
	var_1(var_6_28, var_6_29, var_6_30, var_5)
	...
	var_1(var_6_31, var_6_32, var_6_33, var_5)

	onButton = var_1

	local var_6_34 = arg_6_0
	local var_6_35 = arg_6_0.recordPanel
	local var_6_36 = var_3.Find(var_6_35, "back")
	...
	var_1(var_6_34, var_6_36, var_6_37, var_5)

	onButton = var_1

	local var_6_38 = arg_6_0
	local var_6_39 = arg_6_0._tf
	local var_6_40 = var_3.Find(var_6_39, "bg")
	...
	var_1(var_6_38, var_6_40, var_6_41, var_5)
...
function var_0_1.updateRecordFleet(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_15_0(arg_15_0.recordCommanders) do
...
function var_0_1.UpdatePrefabFleet(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_2 = arg_18_1.getName(var_18_1)

	onInputEndEdit = var_18_1

	var_18_1(arg_18_0, var_18_0, function()
		getInputText = var_2_10000

		local var_19_0 = var_2_10000(var_18_0)
		local var_19_1 = arg_18_0.callback
		local var_19_2 = {}

		LevelUIConst = var_2_10003
		var_19_2.type = var_2_10003.COMMANDER_OP_RENAME
	...
	local var_18_4 = arg_18_2:Find("use_btn")
	...
	local function var_18_5()
		...
		LevelUIConst = var_2_10002
		var_21_1.type = var_2_10002.COMMANDER_OP_USE_PREFAB
	...
	local var_18_7 = arg_18_2:Find("record_btn")
	...
	local function var_18_8()
		...
		LevelUIConst = var_2_10002
		var_22_1.type = var_2_10002.COMMANDER_OP_RECORD_PREFAB
	...
	var_18_1(var_18_6, var_18_7, var_18_8, var_10)
	...
	for iter_18_0, iter_18_1 in var_8(var_18_9) do
		local var_18_11 = arg_18_1:getCommanderByPos(iter_18_0)

		arg_18_0:updateCommander(iter_18_1, iter_18_0, var_18_11)
		arg_18_0:updateSkillTF(var_18_11, var_18_10[iter_18_0])
	end
...
function var_0_1.updateDesc(arg_23_0)
	...
	for iter_23_0 = var_23_2, var_1_10003.MAX_FORMATION_POS do
...
function var_0_1.updateAdditions(arg_24_0)
	...
	var_5.make(var_24_4, function(arg_25_0, arg_25_1, arg_25_2)
		...
		if arg_25_0 == var_2_10003.EventUpdate then
			...
			local var_25_2 = arg_25_2.Find(var_25_1, "name")

			AttributeType = var_25_1

			var_4(var_25_2, var_25_1.Type2Name(var_25_0.attrName))

			setText = var_4

			local var_25_3 = arg_25_2
			local var_25_4 = arg_25_2.Find(var_25_3, "Text")

			string = var_25_3

			var_4(var_25_4, var_25_3.format("%0.3f", var_25_0.value) .. "%")
	...
	var_5.make(var_24_6, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if arg_26_0 == var_2_10003.EventUpdate then
			...
			var_4(var_2_10005(arg_26_2, "name_mask/name"), var_26_0.name)

			local var_26_1 = var_26_0.type

			CommanderConst = var_5

			local var_26_2 = var_26_1 == var_5.TALENT_ADDITION_RATIO and "%" or ""
...
function var_0_1.updateSkillTF(arg_27_0, arg_27_1, arg_27_2)
	...
	if arg_27_1 then
		...
		var_1_10003 = arg_27_1.getSkills(var_27_0)[1]
		GetImageSpriteFromAtlasAsync = var_27_0

		var_27_0("CommanderSkillIcon/" .. var_1_10003:getConfig("icon"), "", arg_27_2:Find("icon"))

		setText = var_27_0

		local var_27_1 = arg_27_2:Find("level")
		local var_27_2 = "Lv."
		local var_27_3 = var_1_10003

		var_27_0(var_27_1, var_27_2 .. var_1_10003.getLevel(var_27_3))
		...
		local function var_27_6()
			...
			LevelUIConst = var_2_10002
			var_28_1.type = var_2_10002.COMMANDER_OP_SHOW_SKILL
		...
		var_27_0(var_27_4, var_27_5, var_27_6, var_27_3)
	else
...
function var_0_1.updateCommander(arg_29_0, arg_29_1, arg_29_2, arg_29_3, arg_29_4)
	...
	local var_29_2 = arg_29_1.Find(var_29_1, "info")

	if arg_29_3 then
		var_29_1 = arg_29_1:Find("info/mask/icon")

		local var_29_3 = arg_29_1
		local var_29_4 = arg_29_1.Find(var_29_3, "info/frame")

		GetImageSpriteFromAtlasAsync = var_29_3

		var_29_3("CommanderHrz/" .. arg_29_3:getPainting(), "", var_29_1)

		local var_29_5 = arg_29_1

		if arg_29_1.Find(var_29_5, "info/name") then
			setText = var_29_5
			var_1_10011 = var_9
			var_1_10013 = arg_29_3

			var_29_5(var_1_10011, arg_29_3.getName(var_1_10013))
		end

		Commander = var_29_5

		local var_29_6 = var_29_5.rarity2Frame(arg_29_3:getRarity())
		...
		var_1_10011(var_29_7, var_1_10013("weaponframes", "commander_" .. var_29_6))
	end
	...
	if arg_29_4 then
		...
		local function var_29_10()
			...
			LevelUIConst = var_2_10002
			var_30_1.type = var_2_10002.COMMANDER_OP_ADD
		...
		var_29_1(var_29_8, var_29_9, var_29_10, var_1_10011)

		onButton = var_29_1

		local var_29_11 = arg_29_0
		local var_29_12 = var_29_0
		...
		local function var_29_13()
			...
			LevelUIConst = var_2_10002
			var_31_1.type = var_2_10002.COMMANDER_OP_ADD
		...
		var_29_1(var_29_11, var_29_12, var_29_13, var_1_10011)
	end

	setActive = var_29_1

	var_29_1(var_29_0, not arg_29_3)

	setActive = var_29_1

	var_29_1(var_29_2, arg_29_3)
