...
function var_0_0.applyTo(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_1(var_4_0, var_1_10005.Submarine, arg_4_0.line.row, arg_4_0.line.column) then
...
function var_0_0.applyToFleet(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_0.target then
		...
		if not arg_5_3 then
			...
			if var_6(var_5_1, var_1_10008) then
				...
				var_5_0 = var_5_2(var_5_3, var_1_10008.DirtyChampion)
			else
				...
				ChapterConst = var_1_10008
				var_5_0 = var_5_4(var_5_5, var_1_10008.DirtyAttachment)
			end
			...
			ChapterConst = var_1_10008
			var_5_0 = var_5_6(var_5_7, var_1_10008.DirtyFleet)
		end
	elseif #arg_5_0.movePath > 0 then
		...
		if not arg_5_3 then
			...
			ChapterConst = var_1_10008
			var_5_0 = var_5_9(var_5_10, var_1_10008.DirtyFleet)
		end
	end
...
function var_0_0.PlayAIAction(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if var_8_1(var_8_0, var_1_10006.Submarine, arg_8_0.line.row, arg_8_0.line.column) then
		if arg_8_0.target then
			local var_8_2 = arg_8_1.fleets[var_4]

			_ = var_6

			local var_8_3 = var_6.detect(arg_8_0.cellUpdates, function(arg_9_0)
