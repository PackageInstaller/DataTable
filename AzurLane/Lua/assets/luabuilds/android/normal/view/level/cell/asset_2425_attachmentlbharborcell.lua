...
function var_0_1.Update(arg_2_0)
	...
	if var_1_10002(arg_2_0.go) then
		...
		var_2.GetPrefab(var_2_1, "leveluiview/Tpl_Box", "Tpl_Box", function(arg_3_0)
			...
			var_1.GetPrefab(var_3_2, "boxprefab/gangkou", "gangkou", function(arg_4_0)
				...
				local var_4_2 = var_3_10003(arg_3_0)

				var_4_1(var_4_0, var_3.Find(var_4_2, "icon"), false)
	...
	if arg_2_0.box then
		...
		var_2_4(var_2_2, var_2_3 == var_1_10005.TraitVirgin)

		var_2_4 = var_2_0.trait
		ChapterConst = var_2_2

		if var_2_4 == var_2_2.TraitVirgin then
			pg = var_2_4
	...
	var_2_4(var_2_6, var_2_7 == var_1_10005.CellFlagActive)
