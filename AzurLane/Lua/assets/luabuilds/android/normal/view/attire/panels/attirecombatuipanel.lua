...
local function var_0_2(arg_1_0, arg_1_1)
	...
	local function var_1_1(arg_2_0)
		...
		findTF = var_2
		var_2_0[1] = var_2(arg_2_0._go, "info/tags/new")
		findTF = var_2
		...
		findTF = var_2
		arg_2_0.toggleList = var_2_1(var_2(arg_2_0._go, "info/elementList"), arg_2_0.toggleItem)
		...
		var_1.make(var_2_2, function(arg_3_0, arg_3_1, arg_3_2)
			...
			if arg_3_0 == var_3_10003.EventUpdate then
				...
				CombatSkinConst = var_3_10008

				local var_3_5 = var_3_10008.TYPE_ICON_NAME[var_3_1]

				findTF = var_3_10009

				var_3_3(var_3_2, var_3_4, var_3_5, var_3_10009(arg_3_2, "on"))
				...
				CombatSkinConst = var_10

				local var_3_11 = var_3_9(var_3_10, var_10.TYPE_ICON_NAME[var_3_1])

				findTF = var_3_10

				var_3_7(var_3_6, var_3_8, var_3_11, var_3_10(arg_3_2, "off"))
				...
				var_3_7(arg_2_0, arg_3_2, function(arg_4_0)
					...
					var_4_10001(var_4_0, var_4_10003("battleui_display" .. var_0[arg_3_1 + 1]))
					...
					setLocalPosition = var_4_1

					local var_4_3 = arg_2_0.tipsGo

					Vector3 = var_4

					var_4_1(var_4_3, var_4_2 + var_4(24, 46, 0))
	...
	function var_1_0.Update(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5)
		...
		local var_7_1 = arg_7_2.getAttireByType(var_7_0, arg_7_1:getType())

		setActive = var_7_0

		local var_7_2 = arg_7_0.tags[2]
		local var_7_3

		if arg_7_1:isOwned() then
			var_7_3 = var_7_1 == arg_7_1.id
		end

		var_7_0(var_7_2, var_7_3)

		setActive = var_7_0

		var_7_0(arg_7_0.tags[1], arg_7_1:isNew())

		setActive = var_7_0

		local var_7_4 = arg_7_0.crossPrint
		...
		if not arg_7_3 then
			...
			if var_9.fmod(arg_7_4 + 1, arg_7_5) == 0 then
				var_7_5 = false
			else
				var_7_5 = true
			end
			...
			var_7_0(arg_7_0.notOwn, not arg_7_1:isOwned())

			local var_7_6 = arg_7_1:getConfig("rare")
			local var_7_7 = arg_1_1
			local var_7_8 = var_8.GetSpriteQuiet
			local var_7_9 = "ui/combatskinrare"

			string = var_2_10011

			local var_7_10 = var_2_10011.format("rare_%s", var_7_6)

			findTF = var_12

			var_7_8(var_7_7, var_7_9, var_7_10, var_12(arg_7_0._go, "info/rareImage"))

			local var_7_11 = arg_7_1:getConfig("rare_display")
			local var_7_12 = arg_7_0.toggleList

			var_9.align(var_7_12, #var_7_11)
	...
	function var_1_0.UpdateClick(arg_8_0)
		...
		if var_2_10001.Input.GetMouseButtonDown(0) then
			...
			var_1.each(var_8_0, function(arg_9_0, arg_9_1)
				...
				typeof = var_3_10004
				Toggle = var_3_10005
				var_3_10002(var_9_0, var_3_10004(var_3_10005)).isOn = false
...
function var_0_1.OnInit(arg_13_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_13_0.totalCount = var_13_8(var_13_7, var_3(var_1_10004))
	...
	local var_13_14 = var_2.Find(var_13_13, "bg/title/Image")

	i18n = var_13_13

	var_1(var_13_14, var_13_13("word_preview"))

	setText = var_1

	local var_13_15 = arg_13_0.confirmBtn
	local var_13_16 = var_2.Find(var_13_15, "Text")

	i18n = var_13_15

	var_1(var_13_16, var_13_15("attire_combatui_confirm"))

	setText = var_1

	local var_13_17 = arg_13_0.previewBtn
	local var_13_18 = var_2.Find(var_13_17, "Text")

	i18n = var_13_17

	var_1(var_13_18, var_13_17("attire_combatui_preview"))

	setText = var_1

	local var_13_19 = arg_13_0.lockBtn
	local var_13_20 = var_2.Find(var_13_19, "Text")

	i18n = var_13_19

	var_1(var_13_20, var_13_19("index_not_obtained"))
...
function var_0_1.OnUpdateItem(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_2 = var_24_1(var_24_0, var_5.TYPE_COMBAT_UI_STYLE)
...
function var_0_1.GetDisplayVOs(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_1_10003(arg_25_0:GetData()) do
		...
		var_1_10008 = iter_25_1.getState(var_25_2)
		AttireFrame = var_25_2

		if var_1_10008 == var_25_2.STATE_UNLOCK and iter_25_1.id >= 0 then
			var_25_1 = var_25_1 + 1
		end
	end
...
function var_0_1.UpdateDesc(arg_26_0, arg_26_1)
	...
	local function var_26_2()
		...
		AttireMediator = var_2_10003

		var_27_3(var_27_2, var_2_10003.ON_APPLY, var_27_1, arg_26_1.uiStyle.id)
	...
	local function var_26_9()
		...
		pg = var_2_10002
		var_28_0.combatPreview = var_28_1(var_2_10002.UIMgr.GetInstance().OverlayMain)
		...
		var_28_3(var_28_2, var_28_4, var_3.getConfig(var_28_5, "id"), function()
	...
	var_26_5(var_26_7, var_26_8, var_26_9, var_1_10009)
