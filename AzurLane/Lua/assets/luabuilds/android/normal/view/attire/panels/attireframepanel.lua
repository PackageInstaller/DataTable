...
function var_0_1.Card(arg_1_0)
	...
	local function var_1_2(arg_4_0, arg_4_1, arg_4_2)
		...
		AttireFrame = var_2_10006

		var_3(var_4_0, var_4_1 == var_2_10006.STATE_LOCK)

		local var_4_2 = arg_4_2
		local var_4_3 = arg_4_2.getAttireByType(var_4_2, arg_4_1:getType())

		setActive = var_4_2

		local var_4_4 = arg_4_0.tags[1]
		local var_4_5 = arg_4_0.state

		AttireFrame = var_2_10007

		var_4_2(var_4_4, var_4_5 == var_2_10007.STATE_UNLOCK and var_4_3 == arg_4_1.id)

		setActive = var_4_2

		local var_4_6 = arg_4_0.tags[2]
		local var_4_7 = arg_4_0.state

		AttireFrame = var_7

		var_4_2(var_4_6, var_4_7 == var_7.STATE_UNLOCK and arg_4_1:isNew())
	...
	function var_1_0.Update(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		var_6_0(arg_6_0.infoTF, not var_4)

		setActive = var_6_0

		var_6_0(arg_6_0.emptyTF, var_4)

		setActive = var_6_0

		var_6_0(arg_6_0.print5, not arg_6_3)

		setActive = var_6_0

		var_6_0(arg_6_0.print6, not arg_6_3)
	...
	function var_1_0.LoadPrefab(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_3 = arg_7_1.getPrefabName(var_7_2)

		PoolMgr = var_7_2

		local var_7_4 = var_7_2.GetInstance()

		var_6.GetPrefab(var_7_4, var_7_1, var_7_3, true, function(arg_8_0)
			if not arg_7_0.icon then
				...
				if var_8_1 == var_3_10003.TYPE_ICON_FRAME then
					IconFrame = var_8_1
					var_8_0 = var_8_1.GetIcon(var_7_3)
				else
					var_8_1 = var_7_0
					AttireConst = var_3

					if var_8_1 == var_3.TYPE_CHAT_FRAME then
						ChatFrame = var_8_1
						var_8_0 = var_8_1.GetIcon(var_7_3)
					end
				end
				...
				local var_8_2 = var_8_1.GetInstance()

				var_2.ReturnPrefab(var_8_2, var_8_0, var_7_3, arg_8_0)
			else
				...
				local var_8_3 = arg_7_1
				local var_8_4 = var_1.getState(var_8_3)

				AttireFrame = var_8_3

				local var_8_5

				var_8_5 = var_8_4 == var_8_3.STATE_LOCK
...
function var_0_1.OnInit(arg_15_0)
	...
	AttireDescPanel = var_15_3
	arg_15_0.descPanel = var_15_3.New(var_15_4)
	...
	typeof = var_4
	Text = var_1_10005
	arg_15_0.totalCount = var_15_7(var_15_6, var_4(var_1_10005))
...
function var_0_1.OnUpdateItem(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_4 = arg_20_1 < var_20_3(var_20_2, var_1_10007(var_1_10008)).constraintCount
...
function var_0_1.GetDisplayVOs(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10003(arg_23_0:GetData()) do
		...
		var_1_10008 = iter_23_1.getState(var_23_2)
		AttireFrame = var_23_2

		if var_1_10008 == var_23_2.STATE_UNLOCK and iter_23_1.id > 0 then
			var_23_1 = var_23_1 + 1
		end
	end
...
function var_0_1.Filter(arg_24_0)
	...
	local var_24_3 = var_24_1(var_24_0, var_3.getType(var_24_2))

	table = var_24_0

	var_24_0.sort(arg_24_0.displayVOs, function(arg_25_0, arg_25_1)
	...
	if var_24_5(var_24_4, var_4(var_1_10005)).constraintCount - #arg_24_0.displayVOs % var_3 == var_3 then
		var_24_6 = 0
	end
...
function var_0_1.UpdateDesc(arg_26_0, arg_26_1)
	...
	local function var_26_3()
		...
		var_27_3(var_27_2, var_2_10003.ON_APPLY, var_27_1, arg_26_1.attireFrame.id)
	...
	var_2(var_26_1, var_26_2, var_26_3, var_1_10006)
