...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_APPLY, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.ATTIRE_APPLY, {
			id = arg_2_2,
			type = arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UNLOCK, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.GET_ATTIRE, {
			id = arg_3_2,
			type = arg_3_1
		})
	...
	arg_1_0.bind(var_1_0, var_0_1.ON_CHANGE_MEDAL_DISPLAY, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.CHANGE_PLAYER_MEDAL_DISPLAY, {
			medalList = arg_4_1
		})
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_7_1.ATTIREFRAME_EXPIRED then
		local var_7_3 = arg_7_0.viewComponent.page

		AttireScene = var_1_10005

		if var_7_3 ~= var_1_10005.PAGE_ICONFRAME then
			var_7_3 = arg_7_0.viewComponent.page
			AttireScene = var_5

			if var_7_3 == var_5.PAGE_CHATFRAME then
				...
				if var_7_0 == var_7_3.ATTIRE_APPLY_DONE then
					arg_7_0:updateCurrPage()
					...
					var_7_5(var_7_4, var_1_10006("dress_up_success"))
				...
				if var_7_0 ~= var_7_5.UPDATED then
					GAME = var_7_7

					do
						local var_7_7

						if var_7_0 == var_7_7.CHANGE_PLAYER_MEDAL_DISPLAY_DONE then
							local var_7_6 = arg_7_0.viewComponent

							var_7_7 = var_7_7.setPlayer
							getProxy = var_1_10006
							PlayerProxy = var_1_10007

							local var_7_8 = var_1_10006(var_1_10007)

							var_7_7(var_7_6, var_6.getData(var_7_8))
							arg_7_0:updateCurrPage()
						else
							GAME = var_7_7

							if var_7_0 == var_7_7.GET_ATTIRE_DONE then
								arg_7_0:updateCurrPage()
							end
						end
					end
