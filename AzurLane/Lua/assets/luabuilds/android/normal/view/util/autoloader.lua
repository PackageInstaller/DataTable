...
local var_0_4 = var_4("view.util.RequestPackages.LoadReferenceRequestPackage")
...
function var_0_0.ReturnPrefab(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_8_2[var_1_10005(arg_8_1)])
...
function var_0_0.ReturnSpine(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_12_2[var_1_10005(arg_12_1)])
...
function var_0_0.GetSprite(arg_13_0, arg_13_1, arg_13_2, arg_13_3, arg_13_4)
	...
	typeof = var_1_10007
	Image = var_1_10008
	var_13_1(var_13_0, var_1_10007(var_1_10008)).enabled = false
...
function var_0_0.GetSpriteQuiet(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	...
	arg_14_0:GetSpriteDirect(arg_14_1, arg_14_2, function(arg_15_0)
		...
		local var_15_2 = var_15_1(var_15_0, var_2_10003(var_2_10004))
...
function var_0_0.LoadSprite(arg_23_0, arg_23_1, arg_23_2, arg_23_3, arg_23_4)
	...
	local var_23_2 = var_23_1(var_23_0, var_1_10007(var_1_10008))
	...
	local var_23_8 = var_23_5(var_23_6, var_23_7, var_1_10011(var_1_10012), function(arg_24_0)
	...
	if arg_32_2 then
		...
		if 0 < var_1_10003 then
			if arg_32_0._loadingRequest[arg_32_1] then
				...
				var_1_10004 = arg_32_0._loadingRequest[arg_32_1]

				var_1_10003.Stop(var_1_10004)
		...
		if arg_32_2 then
			...
			local var_32_0 = var_1_10003.band(arg_32_2, var_0_0.PartLoaded)
			...
			if 0 < var_32_0 then
				if arg_32_0._returnRequest[arg_32_1] then
					if var_0_2 then
						...
						if var_1_10004(var_32_1, var_0_11) then
							warning = var_4

							var_4("AutoLoader Unload Spine: " .. var_32_1.name .. " ;")
						else
							isa = var_4

							if var_4(var_32_1, var_0_13) then
								warning = var_4

								var_4("AutoLoader Unload Atlas: " .. var_32_1.path .. " ;")
							else
								isa = var_4

								if var_4(var_32_1, var_0_12) then
									warning = var_4

									var_4("AutoLoader Unload Bundle: " .. var_32_1.path .. " ;")
								else
									isa = var_4

									if var_4(var_32_1, var_0_10) then
										warning = var_4

										var_4("AutoLoader Unload Path: " .. var_32_1.path .. " Name: " .. var_32_1.name .. " ;")
									else
										warning = var_4

										local var_32_2 = "Not Handle "
										local var_32_3 = var_32_1.__cname
										local var_32_4 = " "
										local var_32_5

										if not var_32_1.name then
											var_32_5 = "NIL"
										end

										var_4(var_32_2 .. var_32_3 .. var_32_4 .. var_32_5)
									end
								end
							end
						end
					...
					local var_32_6 = arg_32_0._returnRequest[arg_32_1]

					var_3.Start(var_32_6)
