...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	if var_3_0 == var_3_1.TACTICS_META_INFO_REQUEST_DONE then
		var_3_3 = var_3_2
		...
		if var_3_0 == var_3_3.TACTICS_META_UNLOCK_SKILL_DONE then
			...
			if var_3_0 == var_3_10.TACTICS_META_SWITCH_SKILL_DONE then
				...
				if var_3_0 == var_3_16.TACTICS_META_LEVELUP_SKILL_DONE then
					...
					if var_3_0 == var_3_22.META_QUICK_TACTICS_DONE then
...
function var_0_1.bindEvent(arg_4_0)
	arg_4_0:bind(var_0_1.ON_QUICK, function(arg_5_0, arg_5_1, arg_5_2)
		...
		MetaQuickTacticsMediator = var_2_10007
		var_5_3.mediator = var_2_10007
		MetaQuickTacticsLayer = var_2_10007
...
function var_0_1.requestTacticsData(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.TACTICS_META_INFO_REQUEST, {
