...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_PT_PREVIEW_LAYER, function(arg_2_0, arg_2_1)
		...
		MetaPTAwardPreviewLayer = var_2_10006
		var_2_3.viewComponent = var_2_10006
		MetaPTAwardPreviewMediator = var_2_10006
	...
	arg_1_0:bind(var_0_1.ON_REPAIR, function(arg_5_0, arg_5_1, arg_5_2)
		...
		MetaCharacterRepairLayer = var_2_10007
		var_5_3.viewComponent = var_2_10007
		MetaCharacterRepairMediator = var_2_10007
		...
		var_5_4.groupName = var_8.getGroupName(var_5_5)
	...
	arg_1_0:bind(var_0_1.ON_ENERGY, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_3 = var_2_10006.New
		local var_7_4 = {}

		MetaCharacterEnergyLayer = var_2_10008
		var_7_4.viewComponent = var_2_10008
		MetaCharacterEnergyMediator = var_2_10008
		...
		var_7_5.groupName = var_9.getGroupName(var_7_6)
	...
	arg_1_0:bind(var_0_1.ON_TACTICS, function(arg_9_0, arg_9_1, arg_9_2)
		...
		MetaCharacterTacticsLayer = var_2_10008
		var_9_4.viewComponent = var_2_10008
		MetaCharacterTacticsMediator = var_2_10008
		var_9_4.mediator = var_2_10008
		...
		var_9_5.groupName = var_9.getGroupName(var_9_6)
	...
	arg_1_0:bind(var_0_1.ON_SYN, function(arg_11_0, arg_11_1, arg_11_2)
		...
		MetaCharacterSynLayer = var_2_10008
		var_11_4.viewComponent = var_2_10008
		MetaCharacterSynMediator = var_2_10008
		var_11_4.mediator = var_2_10008
		...
		var_11_5.groupName = var_9.getGroupName(var_11_6)
...
function var_0_1.enbalePage(arg_13_0, arg_13_1, arg_13_2)
	if arg_13_2 then
		...
		arg_13_0.addSubLayers(var_1_10004, arg_13_1)
	else
		...
		if var_3.getContextByMediator(var_13_0, arg_13_1.mediator) then
			...
			var_13_2(var_13_1, var_1_10007.REMOVE_LAYERS, {
				context = var_4
			})
		end
	end
...
function var_0_1.handleNotification(arg_15_0, arg_15_1)
	...
	if var_15_0 == var_15_1.SHIP_ADDED then
		...
		if var_15_0 == var_4.GET_META_PT_AWARD_DONE then
			...
			var_15_9(var_15_8, var_1_10007.ON_ACHIEVE, var_15_2.awards, var_15_7)
		end
	end
