...
if var_1 then
	...
	var_0_3 = var_0_0.NationOrder
	Nation = var_0_10003

	var_0_2(var_0_3, var_0_10003.NL)
...
AttributeType = var_0_3
var_0_4[1] = var_0_3.Durability
AttributeType = var_2
var_0_4[2] = var_2.Cannon
AttributeType = var_2
var_0_4[3] = var_2.Torpedo
AttributeType = var_2
var_0_4[4] = var_2.AntiAircraft
AttributeType = var_2
var_0_4[5] = var_2.Air
AttributeType = var_2
var_0_4[6] = var_2.Reload
AttributeType = var_2
var_0_4[7] = var_2.Armor
AttributeType = var_2
var_0_4[8] = var_2.Hit
AttributeType = var_2
var_0_4[9] = var_2.Dodge
AttributeType = var_2
var_0_4[10] = var_2.Speed
AttributeType = var_2
var_0_4[11] = var_2.Luck
AttributeType = var_2
var_0_4[12] = var_2.AntiSub
var_0_0.TECH_NATION_ATTRS = var_0_4
...
function var_0_0.GetNationSpriteByIndex(arg_1_0)
	...
	local var_1_1 = var_2(var_0_0.AtlasName, var_0_0.NationResName[arg_1_0] .. "02")
...
var_0_6[1] = var_0_10003.QuZhu
var_0_5[1] = var_0_6

local var_0_7 = {}

ShipType = var_3
var_0_7[1] = var_3.QingXun
var_0_5[2] = var_0_7

local var_0_8 = {}

ShipType = var_3
var_0_8[1] = var_3.ZhongXun
ShipType = var_3
var_0_8[2] = var_3.ChaoXun
var_0_5[3] = var_0_8

local var_0_9 = {}

ShipType = var_3
var_0_9[1] = var_3.QingHang
ShipType = var_3
var_0_9[2] = var_3.ZhengHang
var_0_5[4] = var_0_9

local var_0_10 = {}

ShipType = var_3
var_0_10[1] = var_3.ZhanXun
ShipType = var_3
var_0_10[2] = var_3.ZhanLie
var_0_5[5] = var_0_10

local var_0_11 = {}

ShipType = var_3
var_0_11[1] = var_3.QianTing
ShipType = var_3
var_0_11[2] = var_3.QianMu
var_0_5[6] = var_0_11

local var_0_12 = {}

ShipType = var_3
var_0_12[1] = var_3.WeiXiu
ShipType = var_3
var_0_12[2] = var_3.ZhongPao
ShipType = var_3
var_0_12[3] = var_3.Yunshu
ShipType = var_3
var_0_12[4] = var_3.HangZhan
ShipType = var_3
var_0_12[5] = var_3.FengFanS
ShipType = var_3
var_0_12[6] = var_3.FengFanV
ShipType = var_3
var_0_12[7] = var_3.FengFanM
var_0_5[7] = var_0_12
var_0_0.TypeOrder = var_0_5
var_0_0.TypeResName = {
	"type_qvzhu_",
	"type_qingxun_",
	"type_zhongxun_",
...
function var_0_0.GetTypeSpriteByIndex(arg_2_0)
	...
	local var_2_1 = var_2(var_0_0.AtlasName, var_0_0.TypeResName[arg_2_0] .. "02")
...
function var_0_0.ClassToGroupIDList()
	...
	for iter_3_0, iter_3_1 in var_1_10001(var_1_10002.fleet_tech_ship_template.all) do
		pg = var_1_10006
...
function var_0_0.GetOrderClassList()
	...
	for iter_4_0, iter_4_1 in var_1_10001(var_1_10002.fleet_tech_ship_class.all) do
		pg = var_1_10006
...
function var_0_0.CreateMetaClassConfig()
	...
	for iter_6_0, iter_6_1 in var_0(var_1_10001.fleet_tech_ship_class.all) do
		pg = var_1_10005
	...
	for iter_9_4, iter_9_5 in var_4(var_9_2) do
		...
		if not arg_9_0 or #arg_9_0 == 0 then
			...
			var_9_4 = var_1_10011.select(var_9_3, function(arg_10_0)
				...
				return var_2.contains(arg_9_0, var_10_0)
			end)
		end
	...
	for iter_11_4, iter_11_5 in var_4(var_11_2) do
		...
		if not arg_11_0 or #arg_11_0 == 0 then
			...
			var_11_4 = var_1_10011.select(var_11_3, function(arg_12_0)
				...
				return var_2.contains(arg_11_0, var_12_0)
			end)
		end
...
function var_0_0.GetMetaClassConfig(arg_13_0, arg_13_1)
	...
	if not arg_13_1 or #arg_13_1 == 0 then
		...
		var_13_1 = var_1_10005.select(var_13_0, function(arg_14_0)
			...
			return var_2.contains(arg_13_1, var_14_0)
		end)
	end
...
function var_0_0.GetMotClassConfig(arg_15_0, arg_15_1)
	...
	if not arg_15_1 or #arg_15_1 == 0 then
		...
		var_15_1 = var_1_10005.select(var_15_0, function(arg_16_0)
			...
			return var_2.contains(arg_15_1, var_16_0)
		end)
	end
...
function var_0_0.isNormalActOn()
	...
	var_18_2 = var_18_1(var_18_0, var_1_10002.ACTIVITY_TYPE_GUIDE_TASKS) and not var_0:isEnd()
	...
	if var_18_2 then
		...
		local var_18_7 = var_18_5(var_6)

		var_18_3 = var_5.getChapterById(var_18_7, var_18_6) and var_5:isClear()
		_ = var_18_7

		local var_18_8 = var_18_7.flatten
		local var_18_9 = var_0
		local var_18_10 = var_18_8(var_0.getConfig(var_18_9, "config_data")[3])

		getProxy = var_7
		TaskProxy = var_18_9

		local var_18_11 = var_7(var_18_9)

		_ = var_18_9
		var_18_4 = var_18_9.any(var_18_10, function(arg_19_0)
			local var_19_0 = var_18_11
			local var_19_1
...
function var_0_0.isTecActOn()
	...
	local var_20_2 = var_20_0.SystemOpenMgr.GetInstance()
	...
	var_20_5 = var_20_4(var_20_3, var_5.ACTIVITY_TYPE_FRESH_TEC_CATCHUP) and not var_3:isEnd()

	if not var_20_5 then
		return false
	end

	local var_20_6 = var_3
	local var_20_7 = var_3.getConfig(var_20_6, "config_data")[1]

	getProxy = var_20_6
	ChapterProxy = var_7

	local var_20_8 = var_20_6(var_7)
	local var_20_9, var_20_10

	if var_6.getChapterById(var_20_8, var_20_7) then
		::label_20_0::

		var_20_9 = var_6
		var_20_10 = var_6.isClear(var_20_9)
	end
	...
	local var_20_11 = var_20_9(var_1_10009)

	if var_3.data1 ~= 0 and var_3.data2 ~= 0 then
		local var_20_12 = var_3:getConfig("config_data")[3][var_3.data1]

		if var_20_11:getTaskById(var_20_12[2]) and var_10:isReceive() and #var_3.data1_list + var_3.data2 + 1 == #var_3:getConfig("config_data")[3] + 1 then
			return false
		end
	end
	...
	if var_3.data1 == 0 then
		...
		local var_20_14 = var_3:getConfig("config_data")[3][var_3.data1]

		underscore = var_11
		var_20_13 = var_11.any({
			function()
				underscore = var_2_10000

				return var_2_10000.any(var_20_14[1], function(arg_22_0)
					local var_22_0 = var_20_11
					local var_22_1

					var_22_1 = var_1.getTaskVO(var_22_0, arg_22_0) and var_1:getTaskStatus() == 1

					return var_22_1
				end)
			end,
			function()
				local var_23_0 = var_20_11
				local var_23_1

				var_23_1 = var_0.getTaskVO(var_23_0, var_20_14[2]) and var_0:getTaskStatus() == 1

				return var_23_1
			end,
			function()
				local var_24_0 = var_20_11

				if var_0.getTaskVO(var_24_0, var_20_14[2]) and var_0:isReceive() then
