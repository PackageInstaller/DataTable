...
function var_0_1.initUITextTips(arg_7_0)
	...
	var_7_1, setText = var_1.Find(var_7_0, "Content/SkillInfo/UseTip"), var_7_0
	i18n = var_1_10004

	var_7_0(var_7_1, var_1_10004("metaskill_up"))
...
function var_0_1.initData(arg_8_0)
	...
	arg_8_0.metaProxy = var_1_10001(var_1_10002)
	getProxy = var_1
	BagProxy = var_1_10002
	arg_8_0.bagProxy = var_1(var_1_10002)
	getProxy = var_1
	BayProxy = var_1_10002
	arg_8_0.bayProxy = var_1(var_1_10002)
	...
	arg_8_0.resetUseData(var_8_1)

	local var_8_2 = {}

	ItemRarity = var_8_1
	var_8_2[var_8_1.Blue] = "#70D4FAFF"
	ItemRarity = var_2
	var_8_2[var_2.Purple] = "#C380FBFF"
	ItemRarity = var_2
	var_8_2[var_2.Gold] = "#FFCC4DFF"
	arg_8_0.colorDict = var_8_2
	arg_8_0.expDict = {}
	ipairs = var_1

	for iter_8_0, iter_8_1 in var_1(arg_8_0.bookIDList) do
		local var_8_3 = arg_8_0.expDict

		tonumber = var_1_10007
		Item = var_1_10008
		var_8_3[iter_8_1] = var_1_10007(var_1_10008.getConfigData(iter_8_1).usage_arg)
	end
...
function var_0_1.addListener(arg_10_0)
	...
	var_1_10002(var_10_10, var_10_11, var_10_12, var_1_10006)
	...
	local function var_10_15()
		...
		if var_14_0 <= 0 then
			...
			var_14_2(var_14_1, var_3("word_materal_no_enough"))
		else
			...
			if var_14_4 then
				...
				MetaQuickTacticsMediator = iter_14_1

				var_14_7(var_14_6, iter_14_1.OPEN_OVERFLOW_LAYER, arg_10_0.shipID, arg_10_0.skillID, arg_10_0.useCountDict, var_14_5)
			else
				...
				var_14_9(var_14_8, iter_14_1.USE_TACTICS_BOOK, arg_10_0.shipID, arg_10_0.skillID, arg_10_0.useCountDict)
			end
		end
	...
	var_1_10002(var_10_13, var_10_14, var_10_15, var_1_10006)
...
function var_0_1.initSkillInfoPanel(arg_16_0)
	...
	getSkillConfig = var_16_2

	local var_16_4 = var_16_2(var_16_0)

	getSkillName = var_5

	local var_16_5 = var_5(var_16_4.id)
	...
	MetaCharacterConst = var_16_7

	local var_16_9 = var_16_7.getMetaSkillTacticsConfig(var_16_0, var_16_3).need_exp
...
function var_0_1.updateTpl(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_9 = arg_20_0.bagProxy
	local var_20_10

	if var_12.getItemCountById(var_20_9, var_20_7) == 0 then
		var_20_10 = "0"
	end

	Drop = var_20_9

	local var_20_11 = var_20_9.New
	local var_20_12 = {
		id = var_20_7
	}

	DROP_TYPE_ITEM = var_1_10015
	var_20_12.type = var_1_10015
	var_20_12.count = var_20_10

	local var_20_13 = var_20_11(var_20_12)

	updateDrop = var_20_12

	var_20_12(var_20_0, var_20_13)

	local var_20_14 = var_20_8:getConfig("name")
	local var_20_15 = var_20_8
	local var_20_16 = var_20_8.getConfig(var_20_15, "rarity")

	setColorStr = var_20_15

	local var_20_17 = var_20_15(var_20_14, arg_20_0.colorDict[var_20_16])

	setText = var_16

	var_16(var_20_1, var_20_17)

	local var_20_18 = arg_20_0.useCountTextDict

	var_20_18[var_20_7] = var_20_6
	onButton = var_20_18

	local var_20_19 = arg_20_0
	local var_20_20 = var_20_2
	...
	var_20_18(var_20_19, var_20_20, var_20_21, var_1_10020)

	onButton = var_20_18

	local var_20_22 = arg_20_0
	local var_20_23 = var_20_3

	local function var_20_24()
	...
	var_20_18(var_20_22, var_20_23, var_20_24, var_1_10020)
	...
	var_20_18(var_20_25, var_20_26, var_20_27, var_1_10020)

	onButton = var_20_18

	local var_20_28 = arg_20_0
	local var_20_29 = var_20_5

	local function var_20_30()
	...
	var_20_18(var_20_28, var_20_29, var_20_30, var_1_10020)
...
function var_0_1.updateAfterModifyUseCount(arg_25_0)
	...
	var_8(var_25_9, var_1_10010.format("[+%d]", var_25_7))
	...
	if var_8.getMetaSkillTacticsConfig(var_25_3, var_25_6) then
		...
		var_25_12(arg_25_0.curExpText, var_25_13)

		setText = var_25_12

		var_25_12(arg_25_0.totalExpText, var_25_10)

		setSlider = var_25_12

		var_25_12(arg_25_0.progressBar, 0, var_25_10, var_25_13 + var_25_7)
	end
...
function var_0_1.updateAfterUse(arg_26_0)
	...
	var_26_3(arg_26_0.skillLevelText, "LEVEL:" .. var_26_4)
...
function var_0_1.getBookItem(arg_27_0, arg_27_1)
	...
	if not var_2.getItemById(var_27_0, arg_27_1) then
		...
		local var_27_1 = var_27_0.New
		local var_27_2 = {
			count = 0
		}

		DROP_TYPE_ITEM = var_1_10005
		var_27_2.type = var_1_10005
...
function var_0_1.getLevelTotalExp(arg_30_0, arg_30_1)
	...
	local var_30_3 = var_30_1.skill_data_template[var_30_0].max_level

	pg = var_5

	local var_30_4 = var_5.ship_meta_skilltask.get_id_list_by_skill_ID[var_30_0]
	local var_30_5 = 0
...
function var_0_1.oneStep(arg_36_0)
	...
	arg_36_0.resetUseData(var_36_0)

	local var_36_1 = {}

	ipairs = var_36_0

	for iter_36_0, iter_36_1 in var_36_0(arg_36_0.bookIDList) do
		local var_36_2 = arg_36_0:getBookItem(iter_36_1).count

		if 0 < var_36_2 then
			table = var_8

			var_8.insert(var_36_1, iter_36_1)
		end
	end

	table = var_2

	var_2.sort(var_36_1, function(arg_37_0, arg_37_1)
		return arg_37_1 < arg_37_0
	end)

	ipairs = var_2

	for iter_36_2, iter_36_3 in var_2(var_36_1) do
		local var_36_3 = arg_36_0:getBookItem(iter_36_3)
		local var_36_4 = arg_36_0.expDict[iter_36_3]
		local var_36_5 = iter_36_2 + 1 > #var_36_1 and 0 or arg_36_0.expDict[var_36_1[iter_36_2 + 1]]

		for iter_36_4 = 1, var_36_3.count do
			if iter_36_2 < #var_36_1 and arg_36_0:preCalcExpOverFlow(var_36_4, var_36_5) then
				break
			else
