...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.OPEN_SHIP_BUFF_DETAIL, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		SingleBuffDetailMediator = var_2_10008
		var_2_3.mediator = var_2_10008
		SingleBuffDetailLayer = var_2_10008
	...
	var_1_3(var_1_2, var_3.CLOSE_TECHNOLOGY_NATION_LAYER, function(arg_3_0)
		local var_3_0 = arg_1_0
		local var_3_1 = var_1.sendNotification

		TechnologyConst = var_2_10003

		var_3_1(var_3_0, var_2_10003.CLOSE_TECHNOLOGY_NATION_LAYER_NOTIFICATION)
	...
	var_1_5(var_1_4, var_3.OPEN_TECHNOLOGY_NATION_LAYER, function(arg_4_0)
		...
		TechnologyTreeNationMediator = var_2_10005
		var_4_3.mediator = var_2_10005
		TechnologyTreeNationScene = var_2_10005
	...
	var_1_7(var_1_6, var_3.OPEN_ALL_BUFF_DETAIL, function(arg_5_0)
		...
		AllBuffDetailMediator = var_2_10005
		var_5_3.mediator = var_2_10005
		AllBuffDetailLayer = var_2_10005
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	TechnologyConst = var_7_1

	if var_7_0 == var_7_1.UPDATE_REDPOINT_ON_TOP then
		local var_7_3 = arg_7_0.viewComponent
		local var_7_4 = var_4.updateRedPoint

		getProxy = var_1_10006
		TechnologyNationProxy = var_1_10007

		local var_7_5 = var_1_10006(var_1_10007)

		var_7_4(var_7_3, var_6.getShowRedPointTag(var_7_5))
	end
