...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_7 = var_2.Find(var_2_6, "Text")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("blueprint_exchange_empty_tip"))

	local var_2_8 = arg_2_0.rtPreview
	local var_2_9 = var_1.Find(var_2_8, "list")

	UIItemList = var_2_8
	arg_2_0.itemList = var_2_8.New(var_2_9, var_2_9:Find("item"))
	...
	var_2.make(var_2_10, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_3 = arg_4_2:Find("icon")
			...
			local function var_4_4()
				...
				var_5_1(var_5_0, var_3_10002.ON_DROP, var_4_0)
			...
			var_2_10005(var_4_2, var_4_3, var_4_4, var_9)
			...
			local var_4_6 = arg_4_2.Find(var_4_5, "kc")

			i18n = var_4_5

			var_2_10005(var_4_6, var_4_5("tec_tip_material_stock") .. ":" .. var_4_0.count)
			...
			local function var_4_9()
				if var_4_0.count > arg_2_0.countList[arg_4_1] and arg_2_0.count + var_4_1 <= arg_2_0.need then
					...
					var_6_0(var_1.Find(var_6_1, "calc/value"), arg_2_0.countList[arg_4_1])
					...
					local var_6_4 = var_1.Find(var_6_3, "bg/count")

					setColorStr = var_6_3

					var_6_2(var_6_4, var_6_3(arg_2_0.count, "#FFEC6E") .. "/" .. arg_2_0.need)
				end
			...
			var_2_10005(var_4_7, var_4_8, var_4_9, var_4_10, var_4_11, var_4_12, var_4_13, var_2_10013)
			...
			local function var_4_16()
				if arg_2_0.countList[arg_4_1] > 0 then
					...
					var_7_0(var_1.Find(var_7_1, "calc/value"), arg_2_0.countList[arg_4_1])
					...
					local var_7_4 = var_1.Find(var_7_3, "bg/count")

					setColorStr = var_7_3

					var_7_2(var_7_4, var_7_3(arg_2_0.count, "#FFEC6E") .. "/" .. arg_2_0.need)
				end
			...
			var_2_10005(var_4_14, var_4_15, var_4_16, var_4_17, var_4_18, var_4_19, var_4_20, var_2_10013)
			...
			var_2_10005(arg_2_0, arg_4_2:Find("calc/max"), function()
				if var_4_0.count > arg_2_0.countList[arg_4_1] and arg_2_0.count + var_4_1 <= arg_2_0.need then
					...
					var_8_2(var_2.Find(var_8_3, "calc/value"), arg_2_0.countList[arg_4_1])
					...
					local var_8_6 = var_2.Find(var_8_5, "bg/count")

					setColorStr = var_8_5

					var_8_4(var_8_6, var_8_5(arg_2_0.count, "#FFEC6E") .. "/" .. arg_2_0.need)
				end
	...
	local var_2_12 = var_3.Find(var_2_11, "window/cancel_button/label")

	i18n = var_2_11

	var_2(var_2_12, var_2_11("word_cancel"))

	onButton = var_2

	local var_2_13 = arg_2_0
	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_4.Find(var_2_14, "window/cancel_button")
	...
	var_2(var_2_13, var_2_15, var_2_16, var_6)

	onButton = var_2

	local var_2_17 = arg_2_0
	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_4.Find(var_2_18, "window/confirm_button")
		...
		if arg_2_0.isSwitch then
			...
			if not var_1.IsFate(var_10_1) then
				...
				var_1.insert(var_10_0, function(arg_11_0)
					...
					i18n = var_3_10004
					var_11_2.content = var_3_10004("blueprint_lab_exchange_fate_unlock")
		...
		var_1(var_10_0, function()
			...
			for iter_12_0, iter_12_1 in var_3_10001(arg_2_0.displayList) do
				if arg_2_0.countList[iter_12_0] > 0 then
					...
					Item = var_9
					var_12_3.arg = var_9.getConfigData(iter_12_1.id).usage_arg[arg_2_0.awardList[iter_12_0].index]
			...
			var_12_5(var_12_4, var_3.QUICK_EXCHAGE_BLUEPRINT, var_12_0)
	...
	var_2(var_2_17, var_2_19, var_2_20, var_6)
	...
	local var_2_27 = var_3.Find(var_2_26, "bg/title")

	i18n = var_2_26

	var_2(var_2_27, var_2_26("blueprint_exchange_select_display"))
	...
	local var_2_30 = var_3.Find(var_2_29, "front/Text_off")

	i18n = var_2_29

	var_2(var_2_30, var_2_29("show_fate_demand_count"))

	setText = var_2

	local var_2_31 = arg_2_0.toggleSwitch
	local var_2_32 = var_3.Find(var_2_31, "front/Text_on")

	i18n = var_2_31

	var_2(var_2_32, var_2_31("show_design_demand_count"))
...
function var_0_1.UpdateBlueprint(arg_16_0, arg_16_1)
	...
	var_16_1.type = var_1_10004
	var_16_1.id = arg_16_1:getItemId()

	local var_16_2 = var_16_0(var_16_1)

	changeToScrollText = var_16_1

	local var_16_3 = arg_16_0.rtResult

	var_16_1(var_4.Find(var_16_3, "title/Text"), var_16_2:getName())
	...
	for iter_16_0, iter_16_1 in var_4(var_5.gameset.general_blueprint_list.description) do
		if var_16_4:getItemCountById(iter_16_1) > 0 then
			local var_16_5
			...
			DROP_TYPE_ITEM = iter_16_2
			var_16_6.type = iter_16_2
			var_16_6.id = iter_16_1

			local var_16_7 = var_1_10012(var_16_6)

			for iter_16_2, iter_16_3 in var_11(var_1_10012.getConfig(var_16_7, "display_icon")) do
				local var_16_8 = iter_16_3[1]

				DROP_TYPE_ITEM = var_1_10017

				if var_16_8 == var_1_10017 and iter_16_3[2] == var_16_2.id then
					var_16_5 = {
						index = iter_16_2,
						count = iter_16_3[3]
					}
			...
			if var_16_5 then
				...
				var_1_10012 = arg_16_0.displayList

				local var_16_10 = {}

				DROP_TYPE_ITEM = iter_16_2
				var_16_10.type = iter_16_2
				var_16_10.id = iter_16_1
				var_16_10.count = var_9

				var_16_9(var_1_10012, var_16_10)

				table = var_16_9

				var_16_9.insert(arg_16_0.awardList, var_16_5)
			end
		end
	end
	...
	var_4(var_5.Find(var_16_11, "target/IconTpl"), var_16_2)
	...
	local var_16_14 = var_16_13 .. var_7.Rarity2Print(var_16_2:getConfig("rarity"))
	local var_16_15 = arg_16_0.rtResult

	var_4(var_16_12, var_16_14, var_7.Find(var_16_15, "target/bg"))
...
function var_0_1.UpdateResult(arg_18_0)
	...
	local var_18_3 = var_2.getUseageMaxItem(var_18_2)

	if arg_18_0.isSwitch then
		local var_18_4 = arg_18_0.blueprintVO
		local var_18_5

		if not var_3.getFateMaxLeftOver(var_18_4) then
			var_18_5 = 0
		end

		local var_18_6 = var_18_3 + var_18_5
		local var_18_7 = arg_18_0.bagProxy
		local var_18_8 = var_3.getItemCountById
		local var_18_9 = arg_18_0.blueprintVO

		arg_18_0.need = var_18_1(var_18_6 - var_18_8(var_18_7, var_5.getItemId(var_18_9)), 0)
		...
		while 0 < var_18_10 and arg_18_0.count > arg_18_0.need do
			...
			if 0 < var_18_11 then
				...
				local var_18_15 = var_5.GetChild(var_18_14, var_18_10 - 1)

				var_18_13(var_5.Find(var_18_15, "calc/value"), arg_18_0.countList[var_18_10])
			end
		...
		local var_18_17 = var_3.Find(var_18_16, "bg/count")

		setColorStr = var_18_16

		var_18_11(var_18_17, var_18_16(arg_18_0.count, "#FFEC6E") .. "/" .. arg_18_0.need)
