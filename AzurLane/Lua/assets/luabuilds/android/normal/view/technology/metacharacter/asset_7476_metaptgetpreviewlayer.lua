...
function var_0_1.initUITextTips(arg_5_0)
	...
	var_5_1, setText = var_1.Find(var_5_0, "Panel/BG/TitleText"), var_5_0
	i18n = var_1_10004

	var_5_0(var_5_1, var_1_10004("meta_pt_get_way"))
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_6()
		...
		local var_11_2 = var_11_1(var_11_0, var_2_10002)

		pg = var_11_0

		local var_11_3 = var_11_0.m02
		...
		local var_11_8 = var_2_10004.GO_SCENE

		SCENE = var_2_10005

		var_11_7(var_11_6, var_11_8, var_2_10005.WORLDBOSS)
	...
	var_8_3(var_8_7, var_8_8, var_8_9, var_1_10006)
	...
	var_8_3(var_8_10, var_8_11, var_8_12, var_1_10006)
	...
	var_8_3(var_8_13, var_8_14, var_8_15, var_1_10006)
