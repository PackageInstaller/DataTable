...
function var_0_1.init(arg_7_0)
	...
	arg_7_0.srcollViewCG = var_7_4(var_7_3, var_3(var_1_10004))
	...
	local var_7_8 = var_2.Find(var_7_7, "Text")

	i18n = var_7_7

	var_1(var_7_8, var_7_7("technology_daily_refresh"))
	...
	local var_7_12 = var_2.Find(var_7_11, "consume_panel/bg/label/Text")

	i18n = var_7_11

	var_1(var_7_12, var_7_11("technology_consume"))

	setText = var_1

	local var_7_13 = arg_7_0.selectetPanel
	local var_7_14 = var_2.Find(var_7_13, "consume_panel/bg/task_panel/label/Text")

	i18n = var_7_13

	var_1(var_7_14, var_7_13("technology_request"))
	...
	typeof = var_3
	Text = var_4
	arg_7_0.descTxt = var_7_20(var_7_19, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_7_0.timerTxt = var_7_23(var_7_22, var_3(var_4))
	...
	typeof = var_3
	Slider = var_4
	arg_7_0.taskSlider = var_7_30(var_7_29, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_7_0.taskDesc = var_7_33(var_7_32, var_3(var_4))
	...
	typeof = var_3
	Image = var_4
	arg_7_0.descBG = var_7_36(var_7_35, var_3(var_4))
	...
	local var_7_42 = var_3.Find(var_7_41, "Text")

	i18n = var_7_41

	var_2(var_7_42, var_7_41("technology_queue_getaward"))

	arg_7_0.btnAwardQueueDisable = var_1:Find("btn_award_disable")
	setText = var_2

	local var_7_43 = arg_7_0.btnAwardQueueDisable
	local var_7_44 = var_3.Find(var_7_43, "Text")

	i18n = var_7_43

	var_2(var_7_44, var_7_43("technology_queue_getaward"))
...
function var_0_1.updateSettingsBtn(arg_8_0)
	...
	var_8_3, setText = var_2.Find(var_8_2, "TipText"), var_8_2
	i18n = var_1_10005

	var_8_2(var_8_3, var_1_10005("tec_settings_btn_word"))
	...
	local var_8_11 = var_8_9(var_1_10008)
	local var_8_12 = var_7.getActivityByType

	ActivityConst = var_1_10009

	if var_8_12(var_8_11, var_1_10009.ACTIVITY_TYPE_BLUEPRINT_CATCHUP) and not var_7:isEnd() then
		var_8_11 = var_7.data1

		local var_8_13 = var_7
		local var_8_14 = var_7.getConfig(var_8_13, "config_id")

		pg = var_8_13

		local var_8_15 = var_8_13.activity_event_blueprint_catchup[var_8_14].char_choice

		pg = var_11

		if var_8_11 < var_11.activity_event_blueprint_catchup[var_8_14].obtain_max then
			local var_8_16 = var_8_8
			local var_8_17

			var_8_17, setImageSprite = var_8_8.Find(var_8_16, "Selected/CharImg"), var_8_16
			LoadSprite = var_1_10015

			local var_8_18 = "TecCatchup/QChar" .. var_8_15

			tostring = var_17

			var_8_16(var_8_17, var_1_10015(var_8_18, var_17(var_8_15)))

			local var_8_19 = var_8_8
			local var_8_20 = var_8_8.Find(var_8_19, "Selected/ProgressText")

			setText = var_8_19

			var_8_19(var_8_20, var_8_11 .. "/" .. var_11)

			local var_8_21 = var_7.stopTime

			pg = var_15

			local var_8_22 = var_15.TimeMgr.GetInstance()
			local var_8_23 = var_8_21 - var_15.GetServerTime(var_8_22)

			if arg_8_0.actCatchupTimer then
				local var_8_24 = arg_8_0.actCatchupTimer

				var_15.Stop(var_8_24)

				arg_8_0.actCatchupTimer = nil
			end

			local var_8_25 = var_8_8:Find("TimeLeft/Day")
			local var_8_26 = var_8_8:Find("TimeLeft/Hour")
			local var_8_27 = var_8_8:Find("TimeLeft/Min")

			var_1_10019 = var_8_8

			local var_8_28 = var_8_8.Find(var_1_10019, "TimeLeft/NumText")

			function var_1_10019()
				pg = var_2_10000

				local var_9_0 = var_2_10000.TimeMgr.GetInstance()
				local var_9_1, var_9_2, var_9_3, var_9_4 = var_0.parseTimeFrom(var_9_0, var_8_23)
				...
				if 1 <= var_9_1 then
					...
					var_4(var_8_28, var_9_1)
				elseif var_9_1 <= 0 and 0 < var_9_2 then
					setActive = var_4

					var_4(var_8_25, false)
				...
				elseif var_9_1 <= 0 and var_9_2 <= 0 and (0 < var_9_3 or 0 < var_9_4) then
					...
					local var_9_5 = var_8_28

					math = var_6

					var_4(var_9_5, var_6.max(var_9_3, 1))
			...
			Timer = var_20
			arg_8_0.actCatchupTimer = var_20.New(var_1_10019, 1, -1, 1)

			local var_8_29 = arg_8_0.actCatchupTimer

			var_20.Start(var_8_29)
	...
	getProxy = var_8_11
	TechnologyProxy = var_9

	local var_8_30 = var_8_11(var_9)
	local var_8_31 = var_8.isOpenTargetCatchup(var_8_30)
	local var_8_32 = var_8
	local var_8_33 = var_8.isOnCatchup(var_8_32)

	if var_8_31 then
		if not var_8_33 then
			setActive = var_8_32
		...
		local var_8_34 = var_8:getCurCatchupTecInfo().tecID
		local var_8_35 = var_8_32.groupID
		local var_8_36 = var_8_32.printNum
		local var_8_37 = var_8:getCatchupData(var_8_34)

		if var_15.isUr(var_8_37, var_8_35) then
			pg = var_8_37

			if not var_8_37.technology_catchup_template[var_8_34].obtain_max_per_ur then
				pg = var_8_37
				var_8_37 = var_8_37.technology_catchup_template[var_8_34].obtain_max
			end

			if var_8_37 <= var_8_36 then
				setActive = var_1_10019

				var_1_10019(var_8_6, false)

				setActive = var_1_10019

				var_1_10019(var_8_1, false)
			else
				setActive = var_1_10019

				var_1_10019(var_8_6, true)

				setActive = var_1_10019

				var_1_10019(var_8_1, false)

				local var_8_38 = var_8_6
				local var_8_39

				var_8_39, setImageSprite = var_8_6.Find(var_8_38, "CharImg"), var_8_38
				LoadSprite = var_1_10022

				local var_8_40 = "TecCatchup/QChar" .. var_8_35

				tostring = var_24

				var_8_38(var_8_39, var_1_10022(var_8_40, var_24(var_8_35)))

				local var_8_41 = var_8_6
				local var_8_42 = var_8_6.Find(var_8_41, "ProgressText")

				setText = var_8_41

				var_8_41(var_8_42, var_8_36 .. "/" .. var_8_37)
			end
...
function var_0_1.setPage(arg_11_0, arg_11_1)
	...
	var_11_0(var_3.Find(var_11_1, "blur_panel/adapt/top/title"), arg_11_1 == var_0_1.PageBase)

	setActive = var_11_0

	local var_11_2 = arg_11_0._tf

	var_11_0(var_3.Find(var_11_2, "blur_panel/adapt/left"), arg_11_1 == var_0_1.PageBase)

	setActive = var_11_0

	local var_11_3 = arg_11_0._tf

	var_11_0(var_3.Find(var_11_3, "blur_panel/adapt/top/title_queue"), arg_11_1 == var_0_1.PageQueue)

	setActive = var_11_0

	local var_11_4 = arg_11_0._tf

	var_11_0(var_3.Find(var_11_4, "blur_panel/adapt/right"), arg_11_1 == var_0_1.PageQueue)
		...
		for iter_11_0, iter_11_1 in var_2(arg_11_0.technologyVOs) do
			if iter_11_1:isActivate() then
				...
				arg_11_0.enhancelTimer = var_7.New(function()
					...
					var_12_2(var_12_1, var_2.GetComponent(var_12_3, "EnhanceItem").scrollViewItemIndex)
...
function var_0_1.didEnter(arg_13_0)
	...
	local function var_13_5()
		...
		pg = var_2_10003
		var_14_2.helps = var_2_10003.gametip.technology_help_text.tip
	...
	var_13_1(var_13_3, var_13_4, var_13_5, var_1_10005)
	...
	local function var_13_8()
		...
		local var_15_0 = var_2_10001(var_2_10002)
		local var_15_2

		if var_2_10000(var_1.getActivateTechnology(var_15_0)) then
			pg = var_15_2
			...
			i18n = var_2_10003
			var_15_3.content = var_2_10003("technology_canot_refresh")
		...
		i18n = var_2_10003
		var_15_6.content = var_2_10003("technology_refresh_tip")

		function var_15_6.onYes()
			local var_16_0 = arg_13_0
			local var_16_1 = var_0.emit

			TechnologyMediator = var_3_10002

			var_16_1(var_16_0, var_3_10002.ON_REFRESH)
	...
	var_13_1(var_13_6, var_13_7, var_13_8, var_1_10005)
	...
	local function var_13_13()
		...
		TechnologyMediator = var_2_10002

		var_17_1(var_17_0, var_2_10002.ON_CLICK_SETTINGS_BTN)
	...
	var_13_9(var_13_11, var_13_12, var_13_13, var_1_10006)
	...
	var_13_9(var_13_14, var_13_15, var_13_16, var_1_10006)
	...
	var_13_9(var_13_17, var_13_18, var_13_19, var_1_10006)
...
function var_0_1.initTechnologys(arg_20_0)
	...
	if not arg_20_0.itemList then
		...
		arg_20_0.itemList = var_20_1(var_20_2, var_3.GetChild(var_20_3, 0))
		...
		var_1.make(var_20_4, function(arg_21_0, arg_21_1, arg_21_2)
			...
			if arg_21_0 == var_2_10003.EventUpdate then
				...
				local var_21_2 = var_3(var_21_1, var_5(var_6)).onClick
				...
				arg_20_0.lastButtonListener[arg_21_2] = function()
					...
					SFX_PANEL = var_3_10002

					var_22_1(var_22_0, var_3_10002)
					...
					if var_0.isCompleted(var_22_2) then
						...
						var_22_4(var_22_3, var_3_10002.ON_FINISHED, {
...
function var_0_1.initQueue(arg_23_0)
	if not arg_23_0.queueItemList then
		...
		local var_23_2 = arg_23_0.btnQueue

		arg_23_0.queueItemList = var_23_0(var_23_1, var_1_10003.GetChild(var_23_2, 0))

		local var_23_3 = arg_23_0.queueItemList

		var_1.make(var_23_3, function(arg_24_0, arg_24_1, arg_24_2)
			arg_24_1 = arg_24_1 + 1
			UIItemList = var_2_10003
			...
			if arg_24_0 == var_2_10003.EventUpdate then
				...
				if arg_23_0.queueTimer[arg_24_1] then
					local var_24_0 = arg_23_0.queueTimer[arg_24_1]
				...
				if not arg_23_0.technologyQueue[arg_24_1] then
					...
					local var_24_2 = var_2_10005.TimeMgr.GetInstance()

					if var_2_10005.GetServerTime(var_24_2) < var_4.time - var_4:getConfig("time") then
						var_24_1.waiting = true
					elseif var_2_10005 < var_6 then
						var_24_1.doing = true

						local var_24_3 = arg_23_0.queueTimer

						Timer = var_9
						var_24_3[arg_24_1] = var_9.New(function()
							pg = var_3_10000

							local var_25_0 = var_3_10000.TimeMgr.GetInstance()

							if var_0.GetServerTime(var_25_0) < var_0 then
								setSlider = var_1

								local var_25_1 = arg_24_2

								var_1(var_2.Find(var_25_1, "doing"), 0, var_0, var_0 - var_0 + var_0)
							else
						...
						local var_24_4 = arg_23_0.queueTimer[arg_24_1]

						var_8.Start(var_24_4)
						arg_23_0.queueTimer[arg_24_1].func()
					else
						var_24_1.complete = true
					end
				end
				...
				var_2_10005(arg_24_2, function(arg_26_0)
					...
					var_3_10001(arg_26_0, var_24_1[arg_26_0.name])
	...
	local var_23_4 = arg_23_0.queueItemList
	local var_23_5 = var_1.align

	TechnologyConst = var_1_10003

	var_23_5(var_23_4, var_1_10003.QUEUE_TOTAL_COUNT)

	onButton = var_23_5

	local var_23_6 = arg_23_0
	local var_23_7 = arg_23_0.btnQueue
	...
	var_23_5(var_23_6, var_23_7, var_23_8, var_1_10005)

	if not arg_23_0.queueCardItemList then
		UIItemList = var_1

		local var_23_9 = var_1.New
		local var_23_10 = arg_23_0.queueView
		local var_23_11 = arg_23_0.queueView

		arg_23_0.queueCardItemList = var_23_9(var_23_10, var_23_7.GetChild(var_23_11, 0))

		local var_23_12 = arg_23_0.queueCardItemList

		var_1.make(var_23_12, function(arg_28_0, arg_28_1, arg_28_2)
			arg_28_1 = arg_28_1 + 1
			UIItemList = var_2_10003
	...
	local var_23_13 = arg_23_0.queueCardItemList
	local var_23_14 = var_1.align

	TechnologyConst = var_23_7

	var_23_14(var_23_13, var_23_7.QUEUE_TOTAL_COUNT)
	...
	local function var_23_17()
		if arg_23_0.technologyQueue[1] then
			...
			if var_0.isCompleted(var_29_0) then
				...
				var_29_2(var_29_1, var_2_10002.ON_FINISH_QUEUE)
			end
		end
	...
	var_23_14(var_23_15, var_23_16, var_23_17, var_1_10005)

	setActive = var_23_14

	local var_23_18 = arg_23_0.btnAwardQueue
	local var_23_20

	if arg_23_0.technologyQueue[1] then
		local var_23_19 = arg_23_0.technologyQueue[1]

		var_23_20 = var_3.isCompleted(var_23_19)
	end

	var_23_14(var_23_18, var_23_20)

	setActive = var_23_14

	local var_23_21 = arg_23_0.btnAwardQueueDisable

	isActive = var_23_20

	var_23_14(var_23_21, not var_23_20(arg_23_0.btnAwardQueue))
...
function var_0_1.onSelected(arg_31_0, arg_31_1, arg_31_2)
	...
	var_5(var_31_3, var_31_4, var_31_5, var_1_10009)
	...
	var_5(var_31_6, var_31_7, var_31_8, var_1_10009)
...
function var_0_1.updateQueueChange(arg_39_0)
	...
	var_39_2(var_39_1, var_3.QUEUE_TOTAL_COUNT)
	...
	if arg_39_0.technologyQueue[1] then
		...
		var_39_5 = var_3.isCompleted(var_39_4)
	end
...
function var_0_1.updateTechnologyTF(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	if arg_40_3 == "queue" then
		...
		var_6(arg_40_1:Find("frame"), not var_40_1)

		setActive = var_6

		var_6(arg_40_1:Find("empty"), var_40_1)
	...
	local var_40_3 = var_40_0.getConfig(var_40_2, "time")

	pg = var_40_2

	local var_40_4 = var_40_2.TimeMgr.GetInstance()
	local var_40_5 = var_6.GetServerTime(var_40_4)
	local var_40_6 = var_40_0.time
	...
	var_8(arg_40_3, {
		base = function()
			...
			unpack = var_5
			var_41_8.effectColor = var_41_9(var_5(var_41_7[2]))
			...
			if var_40_6 <= 0 then
				...
				setColorStr = var_2_10007
				i18n = var_2_10008

				var_41_19(var_41_11, var_2_10007(var_2_10008("technology_detail"), var_41_7[1]))
				...
				pg = var_7
				var_2_10008 = var_7.TimeMgr.GetInstance()

				local var_41_13 = var_7.DescCDTime
				local var_41_14 = var_40_0

				var_41_19(var_41_12, var_41_13(var_2_10008, var_9.getConfig(var_41_14, "time")))
			else
				local var_41_17

				if var_40_5 < var_40_6 - var_40_3 then
					var_41_10.blue = true
					setText = var_41_19
					...
					var_41_19(var_41_15, var_41_17(var_2_10008("technology_queue_waiting"), var_41_7[1]))
					...
					pg = var_41_17
					var_2_10008 = var_41_17.TimeMgr.GetInstance()
					var_41_17 = var_41_17.DescCDTime

					local var_41_18 = var_40_0

					var_41_19(var_41_16, var_41_17(var_2_10008, var_9.getConfig(var_41_18, "time")))

					var_41_19 = arg_40_0.cardtimer

					local var_41_20 = arg_40_2

					Timer = var_41_17
					var_41_19[var_41_20] = var_41_17.New(function()
						local var_42_0 = arg_40_0

						var_0.updateTechnology(var_42_0, var_40_0)

						return
					end, var_40_6 - var_40_3 - var_40_5)

					local var_41_21 = arg_40_0.cardtimer[arg_40_2]

					var_41_19.Start(var_41_21)
				elseif var_40_5 < var_40_6 then
					var_41_10.blue = true
					setText = var_41_19

					local var_41_22 = var_41_4

					setColorStr = var_41_17
					i18n = var_2_10008

					var_41_19(var_41_22, var_41_17(var_2_10008("technology_queue_processing"), var_41_7[1]))

					var_41_19 = arg_40_0.cardtimer

					local var_41_23 = arg_40_2

					Timer = var_41_17
					var_41_19[var_41_23] = var_41_17.New(function()
						...
						if var_1.GetServerTime(var_43_1) < var_43_0 then
							...
							local var_43_3 = var_3_10004.TimeMgr.GetInstance()

							var_43_1(var_43_2, var_4.DescCDTime(var_43_3, var_43_0 - var_1))
						else
					...
					local var_41_24 = arg_40_0.cardtimer[arg_40_2]

					var_41_19.Start(var_41_24)
					arg_40_0.cardtimer[arg_40_2].func()
				else
					var_41_10.green = true

					local var_41_25 = var_40_0

					if var_41_19.isCompleted(var_41_25) then
						setText = var_41_19
						...
						var_41_19(var_41_26, var_41_17(var_2_10008("technology_queue_complete"), var_41_7[1]))
					else
						setText = var_41_19

						local var_41_27 = var_41_4

						setColorStr = var_41_17
						i18n = var_2_10008

						var_41_19(var_41_27, var_41_17(var_2_10008("technology_mission_unfinish"), var_41_7[1]))
					end

					setText = var_41_19

					var_41_19(var_41_2, "00:00:00")
				end
			end

			eachChild = var_41_19

			local var_41_28 = arg_40_1

			var_41_19(var_6.Find(var_41_28, "frame/marks/line"), function(arg_44_0)
				setActive = var_3_10001
		...
		queue = function()
			...
			unpack = var_5
			var_45_8.effectColor = var_45_9(var_5(var_45_7[2]))
			...
			if var_40_6 <= 0 then
				...
				if var_40_5 < var_40_6 - var_40_3 then
					...
					var_45_16(var_45_11, var_45_13(var_2_10008("technology_queue_waiting"), var_45_7[1]))
					...
					pg = var_45_13
					var_2_10008 = var_45_13.TimeMgr.GetInstance()
					var_45_13 = var_45_13.DescCDTime

					local var_45_14 = var_40_0

					var_45_16(var_45_12, var_45_13(var_2_10008, var_9.getConfig(var_45_14, "time")))
				elseif var_40_5 < var_40_6 then
					var_45_10.blue = true
					setText = var_45_16
					...
					var_45_16(var_45_15, var_45_13(var_2_10008("technology_queue_processing"), var_45_7[1]))
					...
					Timer = var_45_13
					var_45_16[var_45_17] = var_45_13.New(function()
						...
						if var_1.GetServerTime(var_46_1) < var_46_0 then
							...
							local var_46_3 = var_3_10004.TimeMgr.GetInstance()

							var_46_1(var_46_2, var_4.DescCDTime(var_46_3, var_46_0 - var_1))
						end
					...
					var_45_16(var_45_19, var_45_13(var_2_10008("technology_queue_complete"), var_45_7[1]))
			...
			var_45_16(var_6.Find(var_45_20, "frame/marks/line"), function(arg_47_0)
				setActive = var_3_10001
			...
			var_45_16(var_6.Find(var_45_21, "frame/mask"), var_40_6 > 0 and var_40_5 < var_40_6 - var_40_3)
		...
		desc = function()
			...
			var_48_2.sprite = var_1(var_48_3, var_3.getConfig(var_48_4, "rarity"))
			...
			local var_48_7 = var_48_5.New(arg_40_0.itemContainer, arg_40_0.itemTpl)
			...
			var_1.make(var_48_7, function(arg_49_0, arg_49_1, arg_49_2)
				...
				if arg_49_0 == var_3_10003.EventUpdate then
					...
					var_3(var_49_1, var_5.isActivate(var_49_2))
					...
					var_3(var_49_3, not var_5.isActivate(var_49_4))
				end
			...
			if 0 < var_48_9 then
				...
				var_48_10 = arg_40_0.taskSlider
				var_48_10.value = var_48_11.progress / var_48_11:getConfig("target_num")
				var_48_10 = arg_40_0.taskDesc
				...
				var_2_10010 = var_48_11
				var_48_10.text = var_48_12 .. var_48_13 .. var_48_14 .. var_48_15 .. var_48_11.getConfig(var_2_10010, "target_num") .. ")"
			else
				local var_48_16 = arg_40_0.taskDesc

				i18n = var_48_10
				var_48_16.text = var_48_10("technology_task_none_tip")
			...
			if var_40_6 <= 0 then
				...
				var_48_19.text = var_5.DescCDTime(var_48_20, var_40_3)
			elseif var_40_5 < var_40_6 - var_40_3 then
				...
				local var_48_22 = var_48_21.TimeMgr.GetInstance()

				var_48_19.text = var_5.DescCDTime(var_48_22, var_40_3)
			elseif var_40_5 < var_40_6 then
				var_48_18.stop_btn = true
				...
				var_48_19 = arg_40_0
				Timer = var_48_23
				var_48_19.extraTimer = var_48_23.New(function()
					pg = var_3_10000

					local var_50_0 = var_3_10000.TimeMgr.GetInstance()

					if var_0.GetServerTime(var_50_0) < var_40_6 then
						local var_50_1 = arg_40_0.timerTxt

						pg = var_3_10002

						local var_50_2 = var_3_10002.TimeMgr.GetInstance()

						var_50_1.text = var_2.DescCDTime(var_50_2, var_40_6 - var_0)
					end
			...
			var_48_19(var_5.Find(var_48_26, "frame/btns"), function(arg_51_0)
				setActive = var_3_10001
			...
			local function var_48_31()
				...
				TechnologyProxy = var_3_10001

				local var_52_0 = var_3_10000(var_3_10001)
				...
				if var_0.getActivateTechnology(var_52_0) then
					...
					var_52_2(var_52_1, var_3_10002("technology_is_actived"))
				...
				if #var_0.getConfig(var_52_3, "consume") > 0 then
					getDropInfo = var_1

					local var_52_4 = var_1(var_0)

					pg = var_2
					var_3_10003 = var_2.MsgboxMgr.GetInstance()

					local var_52_5 = var_2.ShowMsgBox
					local var_52_6 = {}

					i18n = var_3_10005
					var_52_6.content = var_3_10005("technology_task_build_tip", var_52_4)

					function var_52_6.onYes()
						local var_53_0 = arg_40_0
						local var_53_1 = var_0.emit

						TechnologyMediator = var_4_10002

						var_53_1(var_53_0, var_4_10002.ON_START, {
							id = var_40_0.id,
					...
					var_52_5(var_3_10003, var_52_6)
				else
					local var_52_7 = arg_40_0
					local var_52_8 = var_1.emit

					TechnologyMediator = var_3_10003

					var_52_8(var_52_7, var_3_10003.ON_START, {
						id = var_40_0.id,
						pool_id = var_40_0.poolId
					})
				end
			...
			var_48_27(var_48_29, var_48_30, var_48_31, var_2_10009)

			setButtonEnabled = var_48_27

			local var_48_32 = var_48_28
			local var_48_33 = var_40_0

			var_48_27(var_48_32, var_7.hasResToStart(var_48_33))
			...
			local function var_48_38()
				...
				i18n = var_3_10003
				var_54_3.content = var_3_10003("technology_stop_tip")
				...
				function var_54_3.onYes()
					...
					var_55_1(var_55_0, var_4_10002.ON_STOP, {
						id = var_40_0.id,
						pool_id = var_40_0.poolId
					})
			...
			var_48_34(var_48_36, var_48_37, var_48_38, var_2_10010)
			...
			local function var_48_43()
				...
				if var_56_0 == var_3_10001.QUEUE_TOTAL_COUNT then
					...
					var_56_0(var_56_1, var_3_10002("technology_queue_full"))
				...
				i18n = var_3_10003
				var_56_4.content = var_3_10003("technology_queue_in_doublecheck")
				...
				function var_56_4.onYes()
					...
					var_57_1(var_57_0, var_4_10002.ON_JOIN_QUEUE, {
						id = var_40_0.id,
						pool_id = var_40_0.poolId
					})
			...
			var_48_39(var_48_41, var_48_42, var_48_43, var_2_10011)
			...
			local function var_48_48()
				...
				var_58_1(var_58_0, var_3_10002("technology_queue_in_mission_incomplete"))
			...
			var_48_44(var_48_46, var_48_47, var_48_48, var_2_10012)
			...
			local function var_48_53()
				...
				var_59_1(var_59_0, var_3_10002.ON_FINISHED, {
					id = var_40_0.id,
					pool_id = var_40_0.poolId
				})
			...
			var_48_49(var_48_51, var_48_52, var_48_53, var_2_10013)
...
function var_0_1.updateInfo(arg_61_0, arg_61_1, arg_61_2, arg_61_3)
	...
	local var_61_1 = arg_61_1.Find(var_61_0, "frame")

	GetSpriteFromAtlas = var_61_0

	var_1_10004(var_61_1, var_61_0("technologycard", arg_61_2:getConfig("bg") .. (arg_61_3 == "desc" and "_l" or "")))

	setImageSprite = var_1_10004

	local var_61_2 = arg_61_1
	local var_61_3 = arg_61_1.Find(var_61_2, "frame/icon_mask/icon")

	GetSpriteFromAtlas = var_61_2

	var_1_10004(var_61_3, var_61_2("technologyshipicon/" .. arg_61_2:getConfig("bg_icon"), arg_61_2:getConfig("bg_icon")), true)

	setImageSprite = var_1_10004

	local var_61_4 = arg_61_1
	local var_61_5 = arg_61_1.Find(var_61_4, "frame/top/label")

	GetSpriteFromAtlas = var_61_4

	var_1_10004(var_61_5, var_61_4("technologycard", arg_61_2:getConfig("label")))

	setImageSprite = var_1_10004

	local var_61_6 = arg_61_1
	local var_61_7 = arg_61_1.Find(var_61_6, "frame/top/label/text")

	GetSpriteFromAtlas = var_61_6

	var_1_10004(var_61_7, var_61_6("technologycard", arg_61_2:getConfig("label_color")), true)

	setImageSprite = var_1_10004

	local var_61_8 = arg_61_1
	local var_61_9 = arg_61_1.Find(var_61_8, "frame/top/label/version")

	GetSpriteFromAtlas = var_61_8

	var_1_10004(var_61_9, var_61_8("technologycard", "version_" .. arg_61_2:getConfig("blueprint_version")), true)

	setImageColor = var_1_10004

	local var_61_10 = arg_61_1
	local var_61_11 = arg_61_1.Find(var_61_10, "frame/top/pick_up")

	Color = var_61_10

	var_1_10004(var_61_11, var_61_10.NewHex(var_0_2[arg_61_2:getConfig("label")]))
	...
	local var_61_12 = arg_61_1:Find("frame/sub_name")
	local var_61_13
	...
	var_1_10004(var_61_12, var_61_13)

	local var_61_14 = arg_61_2:getConfig("drop_client")
	local var_61_15 = arg_61_1:Find("frame/item_container")
	local var_61_16 = 0

	arg_61_0:dfs(var_61_15, function(arg_62_0)
		var_61_16 = var_61_16 + 1
		setActive = var_1

		var_1(arg_62_0, var_61_16 <= #var_61_14)

		if var_61_16 <= #var_61_14 then
			local var_62_0 = arg_61_0

			var_1.updateItem(var_62_0, arg_62_0, arg_61_2, var_61_14[var_61_16])
		end
	...
	var_7(arg_61_3, {
		...
		local var_64_0 = var_61_15

		var_2_10000(var_1.GetChild(var_64_0, 1), #var_61_14 > 2)

		local var_64_1 = var_61_15
		local var_64_2 = var_0.GetChild(var_64_1, 0)

		var_0.GetComponent(var_64_2, "HorizontalLayoutGroup").padding.right = #var_61_14 == 4 and 25 or 0

		local var_64_3 = var_61_15
		local var_64_4 = var_0.GetChild(var_64_3, 1)

		var_0.GetComponent(var_64_4, "HorizontalLayoutGroup").padding.left = #var_61_14 == 4 and 25 or 0
...
function var_0_1.updateInfoVersionPickUp(arg_65_0, arg_65_1, arg_65_2)
	...
	local var_65_0 = var_1_10003(var_1_10004)
	local var_65_1 = var_3.getTendency(var_65_0, 2)

	setActive = var_65_0

	var_65_0(arg_65_1:Find("frame/top/pick_up"), var_65_1 == arg_65_2:getConfig("blueprint_version"))
...
function var_0_1.updateItem(arg_66_0, arg_66_1, arg_66_2, arg_66_3)
	...
	local var_66_3 = arg_66_1.Find(var_66_2, "icon_bg/count")

	IsNil = var_66_2

	if not var_66_2(var_66_3) then
		setColorCount = var_6

		var_6(var_66_3, var_66_0:getOwnedCount(), var_66_0.count)
	end

	onButton = var_6

	local var_66_4 = arg_66_0
	local var_66_5 = arg_66_1
	...
	var_6(var_66_4, var_66_5, var_66_6, var_1_10010)
...
function var_0_1.updatePickUpVersionChange(arg_71_0)
	...
	for iter_71_2, iter_71_3 in var_1(arg_71_0.technologyQueue) do
		...
		var_71_1(var_71_0, var_8.GetChild(var_71_2, iter_71_2 - 1), iter_71_3)
	end
