...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.technologyProxy = var_1(var_1_10002)
	getProxy = var_1
...
function var_0_1.initUI(arg_6_0)
	...
	UIItemList = var_6_3
	arg_6_0.selectedImgUIItemList = var_6_3.New(var_6_4, var_6_2)
	...
	var_3.make(var_6_5, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_1 = arg_7_2.Find(var_7_0, "Selected")

			setActive = var_7_0

			var_7_0(var_7_1, arg_7_1 == arg_6_0.curSelectedIndex)
			...
			if arg_7_1 == arg_6_0.curSelectedIndex then
				...
				var_4.updateProgress(var_7_2, arg_6_0.charIDList[arg_6_0.curSelectedIndex])

				local var_7_3 = arg_6_0
				local var_7_4 = var_4.managedTween

				LeanTween = var_6

				local var_7_5 = var_6.alpha
				local var_7_6

				rtf = var_2_10008

				local var_7_7 = var_7_4(var_7_3, var_7_5, var_7_6, var_2_10008(var_7_1), 1, var_0_1.SELECT_CHAR_LIGHT_FADE_TIME)

				var_4.setFrom(var_7_7, 0)
			end
		end
	...
	UIItemList = var_6_9
	arg_6_0.charUIItemList = var_6_9.New(var_6_10, var_6_8)
	...
	var_5.make(var_6_11, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			var_3(var_8_1, var_8_2, var_8_3, var_2_10007)
		end
	...
	local function var_6_16()
		if arg_6_0.curSelectedIndex and arg_6_0.curSelectedIndex ~= 0 then
			...
			var_10_3.content = var_2_10004(var_10_4, var_2_10006.getDefaultShipNameByGroupID(var_10_0))
			...
			function var_10_3.onYes()
				...
				var_11_1(var_11_0, var_3_10002.SELECT_TEC_TARGET_CATCHUP, {
					tecID = arg_6_0.tecID,
					charID = var_10_0
				})
	...
	var_5(var_6_14, var_6_15, var_6_16, var_1_10009)
	...
	var_5(var_6_18, var_7("tec_target_catchup_progress"))
	...
	var_5(var_6_26, var_7("tec_target_catchup_progress"))
	...
	local function var_6_33()
		...
		pg = var_2_10003
		var_12_2.helps = var_2_10003.gametip.tec_target_catchup_help_tip.tip
	...
	var_5(var_6_31, var_6_32, var_6_33, var_1_10009)

	setText = var_5

	local var_6_34 = arg_6_0.choosePanel
	local var_6_35 = var_6.Find(var_6_34, "FinishAll/BG/Text")

	i18n = var_6_34

	var_5(var_6_35, var_6_34("tec_target_catchup_all_finish_tip"))

	setText = var_5

	local var_6_36 = arg_6_0.choosePanel
	local var_6_37 = var_6.Find(var_6_36, "CharListBG/SSRTag/Text")

	i18n = var_6_36

	var_5(var_6_37, var_6_36("tec_target_catchup_pry_char"))

	if #arg_6_0.urList > 0 then
		setText = var_5

		local var_6_38 = arg_6_0.choosePanel
		local var_6_39 = var_6.Find(var_6_38, "FinishPart/BG/Text")

		i18n = var_6_38

		var_5(var_6_39, var_6_38("tec_target_catchup_dr_finish_tip"))

		setText = var_5

		local var_6_40 = arg_6_0.choosePanel
		local var_6_41 = var_6.Find(var_6_40, "CharListBG/URTag/Text")

		i18n = var_6_40

		var_5(var_6_41, var_6_40("tec_target_catchup_dr_char"))
	end
	...
	for iter_6_0, iter_6_1 in var_5(arg_6_0.urList) do
		...
		local var_6_43 = var_11.Find(var_6_42, "Finish_" .. iter_6_1 .. "/BG/Text")

		i18n = var_6_42

		var_1_10010(var_6_43, var_6_42("tec_target_catchup_dr_finish_tip"))
	end
...
function var_0_1.updateTargetCatchupPage(arg_13_0)
	...
	TechnologyCatchup = var_13_0

	if var_13_1 == var_13_0.STATE_CATCHUPING then
...
function var_0_1.updateCharTpl(arg_14_0, arg_14_1, arg_14_2)
	...
	var_14_1, setText = arg_14_2.Find(var_14_0, "PrintNum/Text"), var_14_0
	i18n = var_1_10006

	var_14_0(var_14_1, var_1_10006("tec_target_need_print"))

	local var_14_2 = arg_14_2:Find("PrintNum/NumText")
	local var_14_3 = arg_14_2:Find("NameText")
	local var_14_4 = arg_14_2:Find("LevelText")
	local var_14_5 = arg_14_2:Find("NotGetTag")
	local var_14_6 = arg_14_0.charIDList[arg_14_1]
	local var_14_7 = arg_14_0.bayProxy
	local var_14_8 = var_9.findShipByGroup(var_14_7, var_14_6)
	local var_14_9 = arg_14_0.technologyProxy
	local var_14_10 = var_10.getBluePrintVOByGroupID(var_14_9, var_14_6)

	pg = var_14_9

	local var_14_11 = var_14_9.ship_data_blueprint[var_14_6].strengthen_item

	if var_14_8 then
		math = var_12

		local var_14_12 = var_12.floor
		local var_14_13 = arg_14_0
		local var_14_14 = arg_14_0.getShipBluePrintCurExp(var_14_13, var_14_10)

		Item = var_14_13

		local var_14_15

		if not var_14_12(var_14_14 / var_14_13.getConfigData(var_14_11).usage_arg[1]) then
			var_14_15 = 0
		end

		local var_14_16 = arg_14_0.configCatchup[arg_14_0.tecID].blueprint_max[arg_14_1]
		local var_14_17 = arg_14_0.bagProxy
		local var_14_18 = var_14.getItemCountById(var_14_17, var_14_11)

		math = var_14_17

		local var_14_19 = var_14_17.max(var_14_16 - var_14_15 - var_14_18, 0)

		setText = var_16

		var_16(var_14_2, var_14_19)

		ShipGroup = var_16

		local var_14_20 = var_16.getDefaultShipNameByGroupID(var_14_6)

		setText = var_17

		var_17(var_14_3, var_14_20)

		setActive = var_17

		var_17(var_14_4, var_14_8)

		setActive = var_17

		var_17(var_14_5, not var_14_8)

		if var_14_8 then
			local var_14_21 = arg_14_0.technologyProxy
			local var_14_22 = var_17.getBluePrintVOByGroupID(var_14_21, var_14_6)

			setText = var_14_21

			var_14_21(var_14_4, "Lv. " .. var_14_22.level .. "/" .. var_14_22:getMaxLevel())
		end
...
function var_0_1.updateShowPanel(arg_15_0)
	...
	var_1_10005(var_15_4, var_1_10007("TecCatchup/selbg" .. var_15_2, var_15_2))
	...
	var_6(arg_15_0.nameText, var_15_5)

	setText = var_6

	local var_15_6 = arg_15_0.progressText
	local var_15_7 = var_15_3
	local var_15_8 = "/"
	local var_15_9 = arg_15_0

	var_6(var_15_6, var_15_7 .. var_15_8 .. arg_15_0.getMaxNum(var_15_9, var_15_2))

	local var_15_10 = arg_15_0.state

	TechnologyCatchup = var_15_6

	local var_15_11 = var_15_10 == var_15_6.STATE_FINISHED_ALL

	setActive = var_7

	var_7(arg_15_0.finishedImg, var_15_11)

	setActive = var_7

	var_7(arg_15_0.selectedImg, not var_15_11)

	onButton = var_7

	local var_15_12 = arg_15_0
	local var_15_13 = arg_15_0.selectedImg
	...
	local function var_15_14()
		...
		var_0(var_1.Find(var_16_1, "ProgressTitle"), false)
	...
	var_7(var_15_12, var_15_13, var_15_14, var_15_9)
...
function var_0_1.updateChoosePanel(arg_17_0)
	...
	TechnologyCatchup = var_3

	if var_17_2 == var_3.STATE_FINISHED_ALL then
		setActive = var_3

		local var_17_3 = arg_17_0.choosePanel

		var_3(var_4.Find(var_17_3, "FinishAll"), true)

		setActive = var_3

		local var_17_4 = arg_17_0.choosePanel

		var_3(var_4.Find(var_17_4, "ProgressTitle"), false)
	elseif #arg_17_0.urList > 0 then
		setActive = var_3

		local var_17_5 = arg_17_0.choosePanel

		var_3(var_4.Find(var_17_5, "FinishAll"), false)

		local var_17_6 = var_17_1
		local var_17_7 = var_17_1.isFinishSSR(var_17_6)

		setActive = var_17_6

		local var_17_8 = arg_17_0.choosePanel

		var_17_6(var_5.Find(var_17_8, "FinishPart"), var_17_7)

		ipairs = var_17_6

		for iter_17_0, iter_17_1 in var_17_6(arg_17_0.urList) do
			local var_17_9 = var_17_1
			local var_17_10 = var_17_1.isFinish(var_17_9, iter_17_1)

			setActive = var_17_9

			local var_17_11 = arg_17_0.choosePanel

			var_17_9(var_11.Find(var_17_11, "Finish_" .. iter_17_1), var_17_10)
		end
	end
...
function var_0_1.updateProgress(arg_18_0, arg_18_1)
	...
	var_1_10002(var_3.Find(var_18_0, "ProgressTitle"), true)
	...
	if arg_18_0:isUR(arg_18_1) then
		...
		var_5(var_6.Find(var_18_5, "Text"), var_18_3 .. "/" .. var_18_4)
	else
		setActive = var_5
		...
		var_5(var_6.Find(var_18_6, "Text"), var_18_3 .. "/" .. var_18_4)
	end
