...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.technologyNationProxy = var_1_10001(var_1_10002)
...
function var_0_1.addListener(arg_8_0)
	...
	local function var_8_5()
		...
		if var_0.getActiveChapter(var_10_0, true) then
			...
			var_10_2(var_10_1, var_2_10003("attrset_disable"))
		else
			local var_10_3 = arg_8_0
			local var_10_4 = var_1.emit

			AllBuffDetailMediator = var_2_10003

			var_10_4(var_10_3, var_2_10003.OPEN_SET_VALUE_LAYER)
		end
...
function var_0_1.updateDetail(arg_11_0)
	...
	var_1.make(var_11_0, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			...
			var_7(var_12_4, var_2_10009("ShipType", "ch_title_" .. var_12_3))
			...
			var_7(var_12_5, var_9("ShipType", "buffitem_tec_" .. var_12_3), true)
...
function var_0_1.updateBuffList(arg_13_0, arg_13_1, arg_13_2)
	...
	var_13_0:make(function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			local var_14_7 = var_10.Type2Name

			pg = var_2_10011

			var_14_4(var_14_6, var_14_7(var_2_10011.attribute_info_by_type[var_14_2].name))
			...
			var_14_6(var_14_9, var_11("+" .. var_14_5, var_14_8))
		end
