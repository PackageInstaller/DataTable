...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_2 = var_3(var_1_10004)

	var_3_1(var_3_0, var_3.getShowRedPointTag(var_3_2))
...
function var_0_1.initData(arg_6_0)
	...
	arg_6_0.collectionProxy = var_1(var_1_10002)
	getProxy = var_1
	TechnologyNationProxy = var_1_10002
	arg_6_0.nationProxy = var_1(var_1_10002)
...
function var_0_1.findUI(arg_7_0)
	...
	arg_7_0.emptyPage = var_7_20(var_2.Find(var_7_21, "Adapt/Right/ViewPort"), arg_7_0.event)
...
function var_0_1.addBtnListener(arg_9_0)
	...
	var_1_10001(arg_9_0, arg_9_0.additionDetailBtn, function()
		...
		var_11_1(var_11_0, var_2_10002.OPEN_ALL_BUFF_DETAIL)
	...
	local function var_9_5(arg_12_0)
		if arg_12_0 then
			...
			var_2_10001(var_12_1, var_3.OPEN_TECHNOLOGY_NATION_LAYER)
		else
			setActive = var_2_10001
			...
			var_12_4(var_12_3, var_3.CLOSE_TECHNOLOGY_NATION_LAYER)
		end
	...
	local function var_9_8()
		...
		if var_2_10000.gametip.help_technologytree then
			...
			pg = var_2_10003
			var_13_2.helps = var_2_10003.gametip.help_technologytree.tip
...
function var_0_1.initNationToggleUIList(arg_14_0)
	...
	if var_14_4 then
		...
		Vector2 = var_14_3
		var_14_4.offsetMin = var_14_3.New(var_14_4.offsetMin.x, 0)
	end
	...
	var_1.make(var_14_5, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			local var_15_4, var_15_5 = var_15_2.GetNationSpriteByIndex(arg_15_1 + 1)
	...
	var_14_7(var_14_6, #var_4.NationResName)
	...
	var_14_7(var_14_9, var_14_10, var_14_11, var_1_10006)
	...
	var_14_7(var_14_12, var_14_13, var_14_14, var_1_10006)
	...
	var_14_7(var_14_15, var_14_16, var_14_17, var_1_10006)
	...
	for iter_14_0, iter_14_1 in var_14_7(arg_14_0.nationToggleList) do
		...
		local function var_14_20(arg_19_0)
			if arg_19_0 == true then
				...
				var_19_1(var_19_2, var_2_10003.NationOrder[iter_14_0])
			...
			elseif arg_14_0.nationSelectedCount > 0 then
				...
				if var_19_7(var_19_8, var_2_10003.NationOrder[iter_14_0], 1) then
					table = var_19_8

					var_19_8.remove(arg_14_0.nationSelectedList, var_1)
				end
		...
		var_1_10007(var_14_18, var_14_19, var_14_20, var_1_10011)
	end
...
function var_0_1.initTypeToggleUIList(arg_25_0)
	...
	var_1.make(var_25_0, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if arg_26_0 == var_2_10003.EventUpdate then
			...
			TechnologyConst = var_26_2

			local var_26_4, var_26_5 = var_26_2.GetTypeSpriteByIndex(arg_26_1 + 1)
	...
	var_25_2(var_25_1, #var_4.TypeResName)
	...
	for iter_25_0, iter_25_1 in var_25_2(arg_25_0.typeToggleList) do
		...
		local function var_25_5(arg_28_0)
			...
			if arg_28_0 == true then
				...
				for iter_28_0, iter_28_1 in var_28_0(var_2.TypeOrder[iter_25_0]) do
					table = var_2_10006
				...
				if arg_25_0.typeSelectedCount < #arg_25_0.typeToggleList then
					...
					var_1.updateTypeToggleUIList(var_28_1)

					local var_28_2 = arg_25_0

					var_1.updateTecItemList(var_28_2)
				elseif arg_25_0.typeSelectedCount == #arg_25_0.typeToggleList then
					local var_28_3 = arg_25_0

					var_1.updateTypeToggleUIList(var_28_3)
				end
			elseif arg_25_0.typeSelectedCount > 0 then
				local var_28_4 = arg_25_0

				var_28_4.typeSelectedCount = arg_25_0.typeSelectedCount - 1
				ipairs = var_28_4
				TechnologyConst = var_2

				for iter_28_2, iter_28_3 in var_28_4(var_2.TypeOrder[iter_25_0]) do
					table = var_2_10006

					if var_2_10006.indexof(arg_25_0.typeSelectedList, iter_28_3, 1) then
						table = var_7

						var_7.remove(arg_25_0.typeSelectedList, var_2_10006)
					end
				end
				...
				if arg_25_0.typeSelectedCount > 0 then
					...
					var_1.updateTypeToggleUIList(var_28_5)

					local var_28_6 = arg_25_0

					var_1.updateTecItemList(var_28_6)
				elseif arg_25_0.typeSelectedCount == 0 then
					local var_28_7 = arg_25_0

					var_1.updateTypeToggleUIList(var_28_7)
				end
			end
		...
		var_1_10007(var_25_3, var_25_4, var_25_5, var_1_10011)
	end
...
function var_0_1.onClassItemUpdate(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_16 = arg_33_0:isMetaOn()
	local var_33_17 = arg_33_0
	local var_33_18 = arg_33_0.isMotOn(var_33_17)

	setText = var_33_17

	var_33_17(var_33_1, var_33_11)

	local var_33_19

	if var_33_16 or var_33_18 then
		setActive = var_18

		var_18(var_33_5, false)

		setActive = var_18

		var_18(var_33_7, false)

		if var_33_16 then
			GetSpriteFromAtlas = var_18
			var_33_19 = var_18("TecNation", "bg_nation_meta")
		elseif var_33_18 then
			GetSpriteFromAtlas = var_18
			var_33_19 = var_18("TecNation", "bg_nation_mot")
		end
	else
		setImageSprite = var_18

		local var_33_20 = var_33_5

		GetSpriteFromAtlas = var_1_10020

		var_18(var_33_20, var_1_10020("TecClassLevelIcon", "T" .. var_33_14), true)

		setImageSprite = var_18

		local var_33_21 = var_33_7

		GetSpriteFromAtlas = var_20

		var_18(var_33_21, var_20("ShipType", "ch_title_" .. var_33_13), true)

		setActive = var_18

		var_18(var_33_5, true)

		setActive = var_18

		var_18(var_33_7, true)

		GetSpriteFromAtlas = var_18
		var_33_19 = var_18("TecNation", "bg_nation_" .. var_33_12)
	end

	setImageSprite = var_18

	var_18(var_33_3, var_33_19)

	tf = var_18

	local var_33_22 = var_18(arg_33_2)
	local var_33_23 = var_18.Find(var_33_22, "ClickBtn/ArrowBtn")

	setLocalRotation = var_33_22
	...
	local var_33_24 = var_33_22(arg_33_2)
	local var_33_25 = var_19.Find(var_33_24, "ShipScrollView/ShipContainer")

	arg_33_0:updateShipItemList(var_33_15, var_33_25)
	...
	local var_33_26 = arg_33_0
	local var_33_27 = var_7

	local function var_33_28()
		defaultValue = var_2_10000

		if var_2_10000(arg_33_0.expanded[arg_33_1], 0) > 0 then
			arg_33_0.expanded[arg_33_1] = 0
		else
			arg_33_0.expanded[arg_33_1] = var_33_25.rect.height - arg_33_0.rowHeight
		end
	...
	var_20(var_33_26, var_33_27, var_33_28, var_1_10024)
...
function var_0_1.updateTecItemList(arg_39_0)
	...
	if #var_39_0 <= 0 then
		...
		var_39_7(var_39_6, var_39_8, var_6("technology_filter_placeholder"))
	elseif var_2 > 0 then
...
function var_0_1.updateShipItemList(arg_40_0, arg_40_1, arg_40_2)
	...
	var_3.make(var_40_0, function(arg_41_0, arg_41_1, arg_41_2)
		...
		if arg_41_0 == var_2_10003.EventUpdate then
			...
			shortenString = var_2_10029
			ShipGroup = var_2_10030

			var_27(var_41_24, var_2_10029(var_2_10030.getDefaultShipNameByGroupID(var_41_23), 6))

			local var_41_25 = var_41_23 * 10 + 1

			setImageSprite = var_41_24
			...
			var_41_24(var_41_26, var_30(var_41_27, var_41_28 .. var_2_10033.ship_data_statistics[var_41_25].rarity))

			LoadSpriteAsync = var_41_24

			local var_41_29 = "shipmodels/"

			Ship = var_30

			var_41_24(var_41_29 .. var_30.getPaintingName(var_41_25), function(arg_42_0)
			...
			local var_41_30, var_41_32

			if var_41_24.indexof(arg_40_0.groupIDGotList, var_41_23, 1) then
				pg = var_41_30
				var_41_30 = var_41_30.fleet_tech_ship_template[var_41_23].add_get_shiptype[1]
				pg = var_29

				local var_41_31 = var_29.fleet_tech_ship_template[var_41_23].add_get_attr

				pg = var_41_32
				var_41_32 = var_41_32.fleet_tech_ship_template[var_41_23].add_get_value
				...
				var_31(var_41_33, var_33("ui/technologytreeui_atlas", "label_" .. var_41_30))
				...
				var_31(var_41_34, var_33(var_41_35, var_35.attribute_info_by_type[var_41_31].name))
				...
				TechnologyConst = var_33

				local var_41_38, var_41_39, var_41_40

				if var_41_37 < var_33.SHIP_LEVEL_FOR_BUFF then
					setActive = var_41_37
					...
					if var_41_37 == var_41_38.fleet_tech_ship_template[var_41_23].max_star then
						setText = var_41_37
						var_41_38 = var_41_8
						var_41_39 = "+"
						pg = var_41_40
						var_41_40 = var_41_40.fleet_tech_ship_template[var_41_23].pt_get
						pg = var_36

						var_41_37(var_41_38, var_41_39 .. var_41_40 + var_36.fleet_tech_ship_template[var_41_23].pt_upgrage)
					else
						setText = var_41_37
						var_41_38 = var_41_8
						var_41_39 = "+"
						...
						var_41_37(var_41_38, var_41_39 .. var_41_40.fleet_tech_ship_template[var_41_23].pt_get)
					end
				else
					pg = var_41_37
					...
					local var_41_41 = var_41_38.fleet_tech_ship_template[var_41_23].add_level_attr

					pg = var_41_39
					var_41_39 = var_41_39.fleet_tech_ship_template[var_41_23].add_level_value
					setImageSprite = var_41_40

					local var_41_42 = var_18

					GetSpriteFromAtlas = var_2_10037

					var_41_40(var_41_42, var_2_10037("ui/technologytreeui_atlas", "label_" .. var_41_37))

					setImageSprite = var_41_40

					local var_41_43 = var_41_16

					GetSpriteFromAtlas = var_37

					local var_41_44 = "attricon"

					pg = var_39

					var_41_40(var_41_43, var_37(var_41_44, var_39.attribute_info_by_type[var_41_41].name))

					setText = var_41_40

					var_41_40(var_41_17, "+" .. var_41_39)

					setActive = var_41_40

					var_41_40(var_17, true)

					local var_41_45 = var_31.star

					pg = var_36

					local var_41_48

					if var_41_45 == var_36.fleet_tech_ship_template[var_41_23].max_star then
						setText = var_41_45

						local var_41_46 = var_41_8
						local var_41_47 = "+"

						pg = var_41_48
						var_41_48 = var_41_48.fleet_tech_ship_template[var_41_23].pt_get
						pg = var_39
						var_41_48 = var_41_48 + var_39.fleet_tech_ship_template[var_41_23].pt_level
						pg = var_39

						var_41_45(var_41_46, var_41_47 .. var_41_48 + var_39.fleet_tech_ship_template[var_41_23].pt_upgrage)

						setImageSprite = var_41_45

						local var_41_49 = var_41_4

						GetSpriteFromAtlas = var_37

						var_41_45(var_41_49, var_37("ui/technologytreeui_atlas", "card_bg_finished"))

						setActive = var_41_45

						var_41_45(var_41_18, false)

						setActive = var_41_45

						var_41_45(var_41_21, false)

						setActive = var_41_45

						var_41_45(var_41_20, false)

						setActive = var_41_45

						var_41_45(var_41_19, false)

						setActive = var_41_45

						var_41_45(var_41_22, true)
					else
						setText = var_41_45

						local var_41_50 = var_41_8
						local var_41_51 = "+"

						pg = var_41_48

						local var_41_52 = var_41_48.fleet_tech_ship_template[var_41_23].pt_get

						pg = var_39

						var_41_45(var_41_50, var_41_51 .. var_41_52 + var_39.fleet_tech_ship_template[var_41_23].pt_level)

						setImageSprite = var_41_45

						local var_41_53 = var_41_4

						GetSpriteFromAtlas = var_37

						var_41_45(var_41_53, var_37("ui/technologytreeui_atlas", "card_bg_normal"))

						setActive = var_41_45

						var_41_45(var_41_18, true)

						setActive = var_41_45

						var_41_45(var_41_21, true)

						setActive = var_41_45

						var_41_45(var_41_20, true)
						...
						var_41_45(var_41_22, false)
					end

					setActive = var_41_45

					var_41_45(var_41_13, false)
				end

				setImageColor = var_41_37

				local var_41_54 = var_41_1

				Color = var_41_39

				var_41_37(var_41_54, var_41_39.New(1, 1, 1, 1))
				...
				local var_41_55 = var_31.star

				pg = var_33

				if var_41_55 == var_33.fleet_tech_ship_template[var_41_23].max_star then
					setActive = var_41_55

					var_41_55(var_41_6, true)
				else
					setActive = var_41_55

					var_41_55(var_41_6, false)
				end

				onButton = var_41_55

				var_41_55(arg_40_0, arg_41_2, function()
					local var_43_0 = arg_40_0
					local var_43_1 = var_0.emit

					TechnologyConst = var_3_10002

					var_43_1(var_43_0, var_3_10002.OPEN_SHIP_BUFF_DETAIL, var_41_23, var_0.maxLV, var_0.star)
				...
				local var_41_56 = var_41_4

				GetSpriteFromAtlas = var_41_32

				var_41_30(var_41_56, var_41_32("ui/technologytreeui_atlas", "card_bg_normal"))

				setImageColor = var_41_30

				local var_41_57 = var_41_1

				Color = var_30

				var_41_30(var_41_57, var_30.New(0, 0, 0, 0.4))
...
function var_0_1.getClassIDListForShow(arg_44_0, arg_44_1, arg_44_2)
	...
	local var_44_2 = arg_44_0.isMotOn(var_44_1)

	if not var_44_0 and not var_44_2 then
		TechnologyConst = var_44_1
		var_44_1 = var_44_1.GetOrderClassList()
		...
		if #arg_44_1 == 0 then
			...
			do
				...
				_ = var_1_10008
				var_44_3 = var_1_10008.select(var_44_1, function(arg_45_0)
					pg = var_2_10001
					...
					if var_2_10002.contains(var_44_4, var_45_0) then
						if #arg_44_0.typeSelectedList == 0 then
							...
							return var_3.contains(arg_44_0.typeSelectedList, var_45_1)
						end
					else
						return false
					end
			...
			if false then
				if var_44_0 then
					TechnologyConst = var_44_1
					arg_44_0.curMetaClassIDList = var_44_1.GetOrderMetaClassList(arg_44_2)

					return arg_44_0.curMetaClassIDList
				elseif var_44_2 then
					TechnologyConst = var_44_1
					arg_44_0.curMotClassIDList = var_44_1.GetOrderMotClassList(arg_44_2)
...
function var_0_1.getClassConfigForShow(arg_46_0, arg_46_1)
	...
	if not var_46_0 and not var_46_1 then
		...
		return var_1_10005.fleet_tech_ship_class[var_46_2]
	elseif var_46_0 then
		local var_46_3 = arg_46_0.curMetaClassIDList[arg_46_1]

		TechnologyConst = var_1_10005

		return var_1_10005.GetMetaClassConfig(var_46_3, arg_46_0.typeSelectedList)
	elseif var_46_1 then
		local var_46_4 = arg_46_0.curMotClassIDList[arg_46_1]

		TechnologyConst = var_1_10005

		return var_1_10005.GetMotClassConfig(var_46_4, arg_46_0.typeSelectedList)
	end
