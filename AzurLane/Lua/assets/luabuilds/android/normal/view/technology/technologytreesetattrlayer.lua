...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_2.GetChild(var_3_0, 0), true)
...
function var_0_1.initData(arg_6_0)
	...
	arg_6_0.tecNationProxy = var_1_10001(var_1_10002)
...
function var_0_1.initUITips(arg_7_0)
	...
	var_7_2(var_7_4, var_1_10005("attrset_reset"))
	...
	var_7_2(var_7_5, var_5("attrset_save"))
...
function var_0_1.addListener(arg_9_0)
	...
	var_1(var_9_11, var_9_12, var_9_13, var_1_10005)
...
function var_0_1.updateTypeTF(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_4 = var_7.Type2Name(var_25_3)

	setText = var_8

	var_8(var_25_0, var_25_4)

	setText = var_8

	var_8(var_25_1, var_25_4)

	local var_25_5 = arg_25_0.resLoader

	var_8.GetSprite(var_25_5, "ShipType", "buffitem_tec_" .. var_25_3, var_25_2, false)
	...
	var_8(var_25_6, var_25_7, var_25_8, var_12)
...
function var_0_1.updateAttrTF(arg_32_0, arg_32_1, arg_32_2)
	...
	local var_32_9 = var_1_10013.Type2Name

	pg = var_1_10014

	local var_32_10 = var_32_9(var_1_10014.attribute_info_by_type[var_32_8].name)
	local var_32_11 = arg_32_0.maxAdditionMap[arg_32_0.curType][var_32_8]
	local var_32_12 = arg_32_0
	local var_32_13 = arg_32_0.getAddValueForShow(var_32_12, arg_32_0.curType, var_32_8)

	setText = var_32_12

	var_32_12(var_32_0, var_32_10)

	setText = var_32_12

	var_32_12(var_32_1, var_32_13)

	setText = var_32_12

	var_32_12(var_32_2, var_32_11)

	onButton = var_32_12

	local var_32_14 = arg_32_0
	local var_32_15 = var_32_4

	local function var_32_16()
	...
	var_32_12(var_32_14, var_32_15, var_32_16, var_1_10020)

	onButton = var_32_12

	local var_32_17 = arg_32_0
	local var_32_18 = var_32_6

	local function var_32_19()
	...
	var_32_12(var_32_17, var_32_18, var_32_19, var_1_10020)

	onButton = var_32_12

	local var_32_20 = arg_32_0
	local var_32_21 = var_32_5

	local function var_32_22()
	...
	var_32_12(var_32_20, var_32_21, var_32_22, var_1_10020)

	onInputEndEdit = var_32_12

	var_32_12(arg_32_0, var_32_7, function(arg_36_0)
		...
		if var_2_10001(arg_36_0) then
			if var_36_0 < 0 then
				...
				if var_36_3.floor(var_36_0) == var_36_0 then
					var_36_0 = var_36_3
				else
					var_36_0 = nil
				end
		...
		if var_36_0 then
			math = var_36_3
			var_36_0 = var_36_3.min(var_36_0, var_32_11)

			local var_36_1 = arg_32_0

			var_36_3.setAttrValue(var_36_1, arg_32_0.curType, var_32_8, var_36_0)

			setText = var_36_3

			var_36_3(var_32_1, var_36_0)
		elseif not var_36_0 then
			pg = var_36_3

			local var_36_2 = var_36_3.TipsMgr.GetInstance()

			var_36_3 = var_36_3.ShowTips
			i18n = var_2_10004

			var_36_3(var_36_2, var_2_10004("attrset_input_ill"))
		end

		setInputText = var_36_3
...
function var_0_1.setAttrTFValue(arg_38_0, arg_38_1, arg_38_2)
	...
	local var_38_1 = arg_38_1.Find(var_38_0, "Attr/Value/CurValue")

	setText = var_38_0

	var_38_0(var_38_1, arg_38_2)
...
function var_0_1.openSaveBox(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	i18n = var_1_10007
	var_39_2.content = var_1_10007("attrset_ask_save")
...
function var_0_1.save(arg_44_0, arg_44_1)
	...
	var_44_4(var_44_3, var_6.SET_TEC_ATTR_ADDITION, {
		sendList = var_44_1,
		onSuccess = arg_44_1
	})
...
function var_0_1.reset(arg_45_0)
	...
	var_45_4(var_45_3, var_5.SET_TEC_ATTR_ADDITION, {
		sendList = var_45_1
	})
