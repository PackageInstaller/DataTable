...
function var_0_1.initData(arg_5_0)
	...
	Color = var_1_10003
	var_5_0[var_5_1] = var_1_10003.New(0.25882352941176473, 0.9215686274509803, 1, 1)
	ShipType = var_5_1
...
function var_0_1.findUI(arg_6_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_6_0.modelImgCom = var_6_5(var_6_4, var_3(var_1_10004))
...
function var_0_1.updateDetail(arg_10_0)
	...
	var_10_0(var_10_1, var_3("shipraritybaseicon", "base_" .. arg_10_0.rarity))
	...
	var_10_0(var_10_2, var_3("ShipType", "ch_title_" .. arg_10_0.shipType), true)
	...
	var_10_0(var_10_3, var_3.getDefaultShipNameByGroupID(arg_10_0.groupID))
	...
	if not var_10_0.IsMetaGroup(arg_10_0.groupID) then
		...
		if var_1.IsMotGroup(arg_10_0.groupID) then
			...
			var_1(var_10_4, var_3("TecClassLevelIcon", "T" .. arg_10_0.classLevel), true)
		...
		var_3(var_10_7, var_10_8 .. var_6.fleet_tech_ship_template[arg_10_0.groupID].pt_upgrage)
		...
		if var_10_7.fleet_tech_ship_template[arg_10_0.groupID].max_star <= var_10_9 then
			setImageColor = var_10_9
			var_10_10 = arg_10_0.allStarStatusImg
			Color = var_5

			var_10_9(var_10_10, var_5.New(1, 0.9137254901960784, 0.4470588235294118, 1))
		end

		local var_10_11 = arg_10_0.maxLV

		TechnologyConst = var_10_10

		if var_10_11 >= var_10_10.SHIP_LEVEL_FOR_BUFF then
			...
			var_10_11(var_10_12, var_5.New(1, 0.9137254901960784, 0.4470588235294118, 1))
		end
		...
		local var_10_15 = var_10_14(var_10_13, var_5.fleet_tech_ship_template[arg_10_0.groupID].add_get_shiptype)

		pg = var_10_13

		local var_10_16 = var_10_13.fleet_tech_ship_template[arg_10_0.groupID].add_get_attr
		...
		var_6.make(var_10_18, function(arg_12_0, arg_12_1, arg_12_2)
			...
			if arg_12_0 == var_2_10003.EventUpdate then
				...
				setTextColor = var_2_10010

				var_2_10010(var_12_0, var_12_6)

				setTextColor = var_2_10010

				var_2_10010(var_12_1, var_12_6)
				...
				var_2_10010(var_12_7, var_12.Type2Name(var_12_5))

				setTextColor = var_2_10010

				var_2_10010(var_12_2, var_12_6)
				...
				local var_12_9 = var_12.Type2Name

				pg = var_13

				var_2_10010(var_12_8, var_12_9(var_13.attribute_info_by_type[var_10_16].name))

				setText = var_2_10010

				var_2_10010(var_12_4, "+" .. var_10_17)

				setActive = var_2_10010

				var_2_10010(arg_12_2, true)
			end
		...
		local var_10_21 = var_10_20(var_10_19, var_9.fleet_tech_ship_template[arg_10_0.groupID].add_level_shiptype)

		pg = var_10_19

		local var_10_22 = var_10_19.fleet_tech_ship_template[arg_10_0.groupID].add_level_attr
		...
		var_10.make(var_10_24, function(arg_13_0, arg_13_1, arg_13_2)
			...
			if arg_13_0 == var_2_10003.EventUpdate then
				...
				var_13_8(var_13_9, var_13.Type2Name(var_13_6))
				...
				local var_13_11 = var_13.Type2Name

				pg = var_14

				var_13_8(var_13_10, var_13_11(var_14.attribute_info_by_type[var_10_22].name))
...
function var_0_1.getSpecialTypeList(arg_14_0, arg_14_1)
	...
	return (var_3.FilterOverFengFanType(var_14_0))
end
