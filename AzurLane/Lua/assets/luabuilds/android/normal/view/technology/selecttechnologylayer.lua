...
function var_0_1.init(arg_4_0)
	...
	LOCK_EQUIPMENT_TRANSFORM = var_3

	var_1(var_4_10, not var_3)
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_2()
		...
		var_6_1(var_6_0, var_2_10002.OPEN_TECHNOLOGY_TREE_SCENE)
	...
	local function var_5_5()
		...
		SelectTechnologyMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.ON_BLUEPRINT)
	...
	local function var_5_8()
		...
		var_8_1(var_8_0, var_2_10002.ON_TECHNOLOGY)
	...
	local function var_5_11()
		...
		var_9_1(var_9_0, var_2_10002.ON_TRANSFORM_EQUIPMENT)
	...
	local function var_5_14()
		...
		if var_2_10000(var_1.Find(var_10_0, "word")) then
			local var_10_1 = arg_5_0

			var_10_2 = var_10_2.emit
			SelectTechnologyMediator = var_3

			var_10_2(var_10_1, var_3.ON_META)
		else
			pg = var_10_2
			...
			var_10_4(var_10_3, var_3("meta_sys_lock_tip"))
		end
	...
	local function var_5_20()
		...
		if var_2.gametip[var_12_1] then
			pg = var_2
			...
			pg = var_2_10005
			var_12_4.helps = var_2_10005.gametip[var_12_1].tip
	...
	var_1(var_5_18, var_5_19, var_5_20, var_1_10005)
...
function var_0_1.checkSystemOpen(arg_13_0, arg_13_1, arg_13_2)
	if arg_13_1 == "MetaCharacterMediator" then
		...
		local var_13_2 = var_13_1(var_13_0, var_6(var_7))

		Color = var_13_0
		var_13_2.color = var_13_0.New(1, 1, 1, var_1_10003 and 1 or 0.7)

		local var_13_3 = arg_13_2

		if arg_13_2.Find(var_13_3, "locked") then
			setActive = var_13_3

			var_13_3(var_13_4, false)
		end
		...
		if not var_1_10003 then
			...
			if var_13_3(var_13_4) then
				cloneTplTo = var_5
				var_13_4 = var_5(arg_13_0.lockedTpl, arg_13_2)
				Vector3 = var_5
				var_13_4.localPosition = var_5.zero
			end
	...
	local var_13_5 = var_1_10003.SystemOpenMgr.GetInstance()
	local var_13_6 = var_3.isOpenSystem(var_13_5, arg_13_0.playerVO.level, arg_13_1)

	setActive = var_13_5

	var_13_5(arg_13_2:Find("word"), var_13_6)

	setGray = var_13_5

	var_13_5(arg_13_2, not var_13_6)

	local var_13_7 = arg_13_2
	local var_13_8 = arg_13_2.GetComponent

	typeof = var_6
	Image = var_7

	local var_13_9 = var_13_8(var_13_7, var_6(var_7))

	Color = var_13_7
	var_13_9.color = var_13_7.New(1, 1, 1, var_13_6 and 1 or 0.7)

	local var_13_10 = arg_13_2

	if arg_13_2.Find(var_13_10, "locked") then
		setActive = var_13_10
	...
	if not var_13_6 then
		...
		if var_13_10(var_13_11) then
			cloneTplTo = var_5
			var_13_11 = var_5(arg_13_0.lockedTpl, arg_13_2)
			Vector3 = var_5
			var_13_11.localPosition = var_5.zero
		end

		setActive = var_5

		var_5(var_13_11, true)
	end
