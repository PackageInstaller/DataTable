...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_3(var_1_1, var_5.gametip.event_ui_recommend.tip)
	...
	var_3(var_1_2, var_5.gametip.event_ui_recommend.tip)
	...
	var_3(var_1_3, var_5.gametip.event_ui_consume.tip)
	...
	var_3(var_1_4, var_5.gametip.event_ui_start.tip)
	...
	var_3(var_1_5, var_5.gametip.event_ui_start.tip)
	...
	var_3(var_1_6, var_5.gametip.event_ui_giveup.tip)
	...
	var_3(var_1_7, var_5.gametip.event_ui_finish.tip)
	...
	var_3(var_1_15, var_1_16, var_1_17, var_1_10007)
	...
	var_3(arg_1_0, arg_1_0.recommentBtn, function()
		...
		elseif #var_0:getDelegationRecommendShipsLV1(arg_1_0.event) > 0 then
			...
			var_2_10005 = {}
			i18n = var_2_10006
			var_2_10005.content = var_2_10006("event_recommend_level1")
			...
			if not var_3.reachNum(var_5_4) then
				...
				var_5_6(var_5_5, var_2_10005("event_recommend_fail"))
			end
		end
	...
	var_3(var_1_18, var_1_19, var_1_20, var_1_10007)
...
function var_0_1.UsePrevFormation(arg_9_0)
	if arg_9_0.event then
		...
		if var_1.ExistPrevFormation(var_9_0) then
			...
			local var_9_6 = var_1_10006(var_1_10007)

			for iter_9_0, iter_9_1 in var_1_10005(var_6.getShipList(var_9_6, var_9_2)) do
				if iter_9_1 then
					ShipStatus = var_1_10010

					local var_9_7

					var_1_10010, var_9_7 = var_1_10010.ShipStatusConflict("inEvent", iter_9_1)
					ShipStatus = var_12

					if var_1_10010 == var_12.STATE_CHANGE_FAIL then
						var_9_4 = true
					else
						ShipStatus = var_12

						if var_1_10010 == var_12.STATE_CHANGE_CHECK then
							var_9_5 = true
						else
							table = var_12
			...
			if var_9_4 then
				...
				local var_9_8 = var_9_9.TipsMgr.GetInstance()

				var_9_9 = var_9_9.ShowTips
				i18n = var_7

				var_9_9(var_9_8, var_7("collect_tip"))
			end

			if var_9_5 then
				pg = var_9_9

				local var_9_10 = var_9_9.TipsMgr.GetInstance()
				local var_9_11 = var_5.ShowTips

				i18n = var_7

				var_9_11(var_9_10, var_7("collect_tip2"))
			end

			local var_9_12 = arg_9_0.event

			var_5.setShipIds(var_9_12, var_9_3)
			arg_9_0:Flush()
		end
	end
...
function var_0_1.Flush(arg_10_0)
	...
	if var_3.ExistPrevFormation(var_10_1) then
		local var_10_2 = arg_10_0.event
		local var_10_3 = var_10_3.GetState(var_10_2)

		EventInfo = var_10_2

		if var_10_3 == var_10_2.StateNone then
	...
	var_1_10001(arg_10_0.btn, function(arg_11_0)
		...
		if var_11_1 == var_11_0.StateNone and arg_11_0.name == "start" then
			SetActive = var_2
	...
	var_10_9(arg_10_0.disabeleBtn, not var_10_6 or not var_10_8 or not var_10_10)
	...
	local var_10_16 = var_10_15(var_10_14, var_1_10008("event_condition_ship_level", var_10_13.ship_lv), var_10_6)

	setScrollText = var_10_14

	var_10_14(arg_10_0.condition1, var_10_16)

	setActive = var_10_14
	findTF = var_8

	var_10_14(var_8(arg_10_0.conditions, "condition_1/mark"), var_10_6)

	setActive = var_10_14
	findTF = var_8

	var_10_14(var_8(arg_10_0.conditions, "condition_1/mark1"), not var_10_6)
	...
	local var_10_19 = var_10_18(var_10_17, var_9("event_condition_ship_count", var_10_13.ship_num), var_10_8)

	setScrollText = var_10_17

	var_10_17(arg_10_0.condition2, var_10_19)

	setActive = var_10_17
	findTF = var_9

	var_10_17(var_9(arg_10_0.conditions, "condition_2/mark"), var_10_8)

	setActive = var_10_17
	findTF = var_9

	var_10_17(var_9(arg_10_0.conditions, "condition_2/mark1"), not var_10_8)
	...
	var_9(var_10(arg_10_0.conditions, "condition_3/mark"), var_10_10)

	setActive = var_9
	findTF = var_10

	var_9(var_10(arg_10_0.conditions, "condition_3/mark1"), not var_10_10)
	...
	var_9(var_10_23, var_11.getOilConsume(var_10_24))

	ipairs = var_9

	for iter_10_0, iter_10_1 in var_9(arg_10_0.shipItems) do
		local var_10_25 = iter_10_1:Find("shiptpl")
		local var_10_26 = iter_10_1:Find("emptytpl")
		local var_10_27 = iter_10_0 <= #var_10_12

		SetActive = var_17

		var_17(var_10_25, var_10_27)

		SetActive = var_17

		var_17(var_10_26, not var_10_27)

		if var_10_27 then
			updateShip = var_17

			var_17(var_10_25, var_10_12[iter_10_0], {
				initStar = true
			})
			...
			var_17(var_18(var_10_25, "icon_bg/lv/Text"), var_10_12[iter_10_0].level)

			onButton = var_17

			local var_10_28 = arg_10_0
			local var_10_29 = var_10_25:Find("icon_bg")
			...
			var_17(var_10_28, var_10_29, var_10_30, var_21)
		else
			onButton = var_17

			var_17(arg_10_0, var_10_26, function()
	...
	local var_10_31 = arg_10_0.event
	local var_10_32 = var_9.GetState(var_10_31)

	EventInfo = var_10_31

	if var_10_32 == var_10_31.StateNone then
		SetActive = var_10
...
function var_0_1.setConditionStr(arg_14_0, arg_14_1, arg_14_2)
	if arg_14_2 then
		...
		if not var_1_10003(var_14_0, var_1_10005) then
			setColorStr = var_1_10003
...
function var_0_1.onChangeClick(arg_16_0)
	...
	if var_16_1 == var_16_0.StateNone then
		local var_16_2 = arg_16_0.dispatch

		EventConst = var_2

		var_16_2(var_2.EVENT_OPEN_DOCK, arg_16_0.event)
	end
...
function var_0_1.onRemoveClick(arg_17_0, arg_17_1)
	...
	if var_17_1 == var_17_0.StateNone then
		table = var_17_1
...
function var_0_1.onFuncClick(arg_18_0)
	...
	if var_18_1 == var_18_0.StateNone then
		var_18_2 = arg_18_0.dispatch
		EventConst = var_1_10003

		var_18_2(var_1_10003.EVENT_START, arg_18_0.event)
	else
		EventInfo = var_18_2
		...
		if var_18_1 == var_18_2.StateActive then
			...
			var_18_3(var_1_10003.EVENT_GIVEUP, arg_18_0.event)
		else
			EventInfo = var_18_3
			...
			if var_18_1 == var_18_3.StateFinish then
				...
				var_18_4(var_1_10003.EVENT_FINISH, arg_18_0.event)
			end
		end
	end
