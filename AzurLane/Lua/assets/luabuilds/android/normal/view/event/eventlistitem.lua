...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Image = var_1_10006
	arg_1_0.shadow = var_1_11(var_1_10, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	arg_1_0.timerBg = var_1_14(var_1_13, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.label = var_1_17(var_1_16, var_5(var_1_10006))
	...
	arg_1_0.ptBonus = var_1_29(var_4.Find(var_1_30, "bonusPt"))
...
function var_0_1.UpdateTime(arg_3_0)
	...
	if var_3_3 == var_3_2.StateNone then
		...
		local var_3_6 = var_3_4.TimeMgr.GetInstance()

		var_3_5.text = var_4.DescCDTime(var_3_6, arg_3_0.event.template.collect_time)
	else
		EventInfo = var_3_5
		...
		if var_3_3 == var_3_5.StateActive then
			...
			if var_3_1 <= arg_3_0.event.finishTime then
				...
				local var_3_9 = var_3_7.TimeMgr.GetInstance()

				var_3_8.text = var_4.DescCDTime(var_3_9, arg_3_0.event.finishTime - var_3_1)
			else
				var_3_8 = arg_3_0.labelTime
	...
	if var_3.GetCountDownTime(var_3_11) and 0 <= var_3 then
		...
		var_3_11.SetActive(var_3_12, true)

		var_3_11 = arg_3_0.labelLimitTime
		pg = var_3_12
		var_1_10006 = var_3_12.TimeMgr.GetInstance()
		var_3_11.text = var_5.DescCDTime(var_1_10006, var_3)
	else
		local var_3_13 = arg_3_0.timeLimit

		var_3_11.SetActive(var_3_13, false)
	end
	...
	EventInfo = var_1_10006

	var_3_11(var_3_14, var_3_3 == var_1_10006.StateFinish)
...
function var_0_1.Flush(arg_4_0)
	...
	if var_4_3 == var_4_2.StateFinish then
	...
	if var_4_7 then
		...
		if not var_4_9.one then
			Vector3 = var_4_9
			var_4_9 = var_4_9(1.5, 1.5, 1.5)
		end

		var_4_8.localScale = var_4_9
		setActive = var_4_8
		...
		local var_4_10 = arg_4_0.timerBg
		...
		if var_4_7 then
			...
			if not var_4_11.New(0, 0, 0, 0) then
				Color = var_4_11
				var_4_11 = var_4_11.New(1, 1, 1, 1)
			end

			var_4_10.color = var_4_11

			local var_4_12 = arg_4_0.label

			if var_4_7 then
				Color = var_4_11

				if not var_4_11.New(0.9411764705882353, 0.803921568627451, 1, 1) then
					Color = var_4_11
					var_4_11 = var_4_11.New(0.6431372549019608, 0.8117647058823529, 0.9725490196078431, 1)
				end

				var_4_12.color = var_4_11
				eachChild = var_4_12

				var_4_12(arg_4_0.iconState, function(arg_5_0)
					...
					var_2_10001(var_5_0, var_5_1 == var_2_10004(var_5.GetState(var_5_2)))
				...
				local var_4_13 = arg_4_0.event.template.drop_display

				for iter_4_0 = arg_4_0.awardsTr.childCount, #var_4_13 - 1 do
					Object = var_1_10008

					local var_4_14 = var_1_10008.Instantiate(arg_4_0.awardItem).transform

					var_9.SetParent(var_4_14, arg_4_0.awardsTr, false)
				end

				local var_4_15 = arg_4_0.awardsTr.childCount

				for iter_4_1 = 0, var_4_15 - 1 do
					local var_4_16 = arg_4_0.awardsTr
					local var_4_17 = var_8.GetChild(var_4_16, iter_4_1)

					if iter_4_1 < #var_4_13 then
						local var_4_18 = var_4_17.gameObject

						var_9.SetActive(var_4_18, true)

						local var_4_19 = var_4_13[iter_4_1 + 1]
						...
						local var_4_20 = var_4_17.gameObject

						var_9.SetActive(var_4_20, false)
					end
				end

				table = var_4

				local var_4_21 = var_4.getCount(arg_4_0.event.template.special_drop) ~= 0

				SetActive = var_5

				var_5(arg_4_0.specialAward, var_4_21)
