...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".ShamShopPage"))
...
function var_0_1.GetResDataList(arg_9_0)
	...
	var_9_1.cnt = var_9_3(var_9_2, var_1_10005.ResBlueprintFragment)
	var_9_0[1] = var_9_1
	...
	if not var_9_1 and arg_9_0.items then
		...
		local var_9_6 = var_5.insert
		local var_9_7 = var_9_0
		local var_9_8 = {}

		DROP_TYPE_ITEM = var_1_10008
		var_9_8.type = var_1_10008
...
function var_0_1.OnPurchase(arg_16_0, arg_16_1, arg_16_2)
	...
	var_16_1(var_16_0, var_1_10005.ON_FRAGMENT_SHOPPING, arg_16_1.id, arg_16_2)
