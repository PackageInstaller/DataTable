...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".NewServerGoodsCard"))
...
function var_0_1.Flush(arg_1_0)
	...
	var_1_0(var_1_5, not var_3.CanPurchase(var_1_6))
	...
	if var_3.GetDiscount(var_1_8) ~= 0 then
		local var_1_9 = arg_1_0.commodity

		var_1_10 = var_3.CanPurchase(var_1_9)
	else
		var_1_10 = false
	end
...
function var_0_1.Init(arg_2_0)
	...
	if var_1.GetDiscount(var_2_0) ~= 0 then
		...
		if var_1.CanPurchase(var_2_1) then
			...
			var_2_2(var_2_5, var_3.GetOffPercent(var_2_6) .. "%")
		end
	end
