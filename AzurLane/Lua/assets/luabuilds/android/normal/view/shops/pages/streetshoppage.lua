...
function var_0_1.GenTipForMultiAct(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10005.all(arg_2_1, function(arg_3_0)
		return arg_3_0:getStartTime() == var_2_1
	end)

	_ = var_6

	local var_2_4 = var_6.all(arg_2_1, function(arg_4_0)
...
function var_0_1.GenHelpContent(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_1 = arg_7_2.getConfig(var_7_0, "config_data")
	...
	for iter_7_0, iter_7_1 in var_7_0(var_7_1) do
		...
		pg = var_1_10010
		var_1_10010 = var_1_10010.shop_template[var_7_2].effect_args[1]
		Item = var_1_10011
		var_1_10011 = var_1_10011.getConfigData(var_1_10010).name

		local var_7_3 = arg_7_2
		local var_7_4 = arg_7_2.GetShopTime(var_7_3)

		table = var_7_3

		local var_7_5 = var_7_3.insert
		local var_7_6 = arg_7_1

		i18n = var_1_10015

		var_7_5(var_7_6, var_1_10015("shop_street_Equipment_skin_box_help", var_1_10011, var_7_4))
	end
...
function var_0_1.GetResDataList(arg_9_0)
	...
	local var_9_3 = var_9_2(var_9_1, var_1_10004.ResGold)

	table = var_9_1

	local var_9_4 = var_9_1.insert
	local var_9_5 = var_9_0
	local var_9_6 = {}

	DROP_TYPE_RESOURCE = var_1_10006
	var_9_6.type = var_1_10006
	PlayerConst = var_1_10006
	var_9_6.resID = var_1_10006.ResGold
	var_9_6.cnt = var_9_3
...
function var_0_1.RefreshUI(arg_14_0)
	...
	local var_14_2 = var_14_1(var_14_0, var_1_10003.ACTIVITY_TYPE_SHOP_STREET)

	_ = var_14_0

	local var_14_3 = var_14_0.select(var_14_2, function(arg_15_0)
		return arg_15_0 and not arg_15_0:isEnd()
	end)

	setActive = var_3

	var_3(arg_14_0.tipTextGo, #var_14_3 > 0)
	...
	local function var_14_7()
		...
		local var_16_2 = var_2.MsgboxMgr.GetInstance()
	...
	local function var_14_10()
		...
		local var_19_1, var_19_2

		if not var_19_0(var_2_10001.ShoppingStreetUpgrade, arg_14_0.shop.flashCount) then
			pg = var_19_2
			var_19_1 = var_19_2.TipsMgr.GetInstance()
			var_19_2 = var_19_2.ShowTips
			i18n = var_2_10003

			var_19_2(var_19_1, var_2_10003("shopStreet_refresh_max_count"))
		...
		local var_19_3 = var_19_2.shop_template[var_0]

		pg = var_19_1

		local var_19_4 = var_19_1.MsgboxMgr.GetInstance()
		local var_19_5 = var_2.ShowMsgBox
		local var_19_6 = {
		...
		local var_19_7 = "refresh_shopStreet_question"

		i18n = var_2_10007

		local var_19_8 = "word_"

		id2res = var_2_10009
		var_19_6.content = var_2_10005(var_19_7, var_2_10007(var_19_8 .. var_2_10009(var_19_3.resource_type) .. "_icon"), var_19_3.resource_num, arg_14_0.shop.flashCount)

		function var_19_6.onYes()
			local var_20_0 = arg_14_0
			local var_20_1 = var_0.emit

			NewShopMainMediator = var_3_10002

			var_20_1(var_20_0, var_3_10002.REFRESH_STREET_SHOP, var_0)
...
function var_0_1.OnInitItem(arg_21_0, arg_21_1)
	...
	local function var_21_3()
		...
		if not var_0.canPurchase(var_22_0) then
			...
			var_22_2(var_22_1, var_2_10003("buy_countLimit"))
	...
	var_3(var_21_1, var_21_2, var_21_3, var_1_10007)
...
function var_0_1.Purchase(arg_25_0, arg_25_1)
	if arg_25_1:getConfig("resource_type") == 4 or var_2 == 14 then
		local var_25_0 = arg_25_0.player
		local var_25_1 = var_3.getResById(var_25_0, var_2)

		Item = var_25_0

		local var_25_2 = var_25_0.New({
			id = arg_25_1:getConfig("effect_args")[1]
		})

		var_1_10005 = arg_25_1:getConfig("resource_num") * (arg_25_1.discount / 100)
		pg = var_6

		local var_25_3 = var_6.MsgboxMgr.GetInstance()
		local var_25_4 = var_6.ShowMsgBox
		local var_25_5 = {}

		i18n = var_1_10009
		var_25_5.content = var_1_10009("charge_scene_buy_confirm", var_1_10005, var_25_2:getConfig("name"))

		function var_25_5.onYes()
			local var_26_0 = arg_25_0
			local var_26_1 = var_0.emit

			NewShopMainMediator = var_2_10002

			var_26_1(var_26_0, var_2_10002.BUY_ITEM, arg_25_1.id, 1)
		...
		var_25_7(var_25_6, var_1_10005.BUY_ITEM, arg_25_1.id, 1)
	end
...
function var_0_1.AddTimer(arg_28_0)
	...
	arg_28_0.timer = var_1_10002.New(function()
		...
		if var_0.isUpdateGoods(var_29_0) then
			...
			var_29_3(var_29_2, var_2_10002.REFRESH_STREET_SHOP)
		else
			pg = var_29_3
			...
			local var_29_9 = var_2_10005.TimeMgr.GetInstance()

			var_29_7.text = var_2_10003(var_29_8, var_5.DescCDTime(var_29_9, var_29_6))
		end
