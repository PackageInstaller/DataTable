...
function var_0_1.GetResDataList(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_5_1(var_5_2) do
		...
		var_1_10008 = var_1_10008.getTicket(var_1_10009)
		table = var_1_10009
...
function var_0_1.RefreshUI(arg_8_0)
	...
	var_8_1(var_8_3, var_1_10005("game_ticket_current_month") .. var_8_2 .. "/" .. var_8_0)
...
function var_0_1.OnInitItem(arg_9_0, arg_9_1)
	...
	local function var_9_3()
		...
		if not var_0.CanPurchase(var_10_0) then
			...
			var_10_2(var_10_1, var_2_10002("buy_countLimit"))
	...
	var_3(var_9_1, var_9_2, var_9_3, var_1_10007)
	...
	if var_2.Selectable(var_12_0) then
		...
		var_3.ExecuteAction(var_12_1, "Show", {
			...
			confirm = function(arg_13_0, arg_13_1)
				...
				var_13_1(var_13_0, var_2_10004.ON_MINI_GAME_SHOP_BUY, {
					id = arg_13_0,
					list = arg_13_1
				})
		...
		if 1 < var_12_2 then
			...
			var_4.ExecuteAction(var_12_3, "Show", var_2, function(arg_14_0)
				...
				if not var_1.CanPurchaseCnt(var_14_0, arg_14_0) then
					...
					var_14_2(var_14_1, var_3("buy_countLimit"))
				...
				local var_14_5 = var_2.getConfig(var_14_4, "goods")[1]

				table = var_14_4

				var_14_4.insert(var_14_3, {
					num = arg_14_0,
					id = var_14_5
				})
				...
				var_14_7(var_14_6, var_5.ON_MINI_GAME_SHOP_BUY, {
					id = var_0.id,
					list = var_14_3
				})
			...
			i18n = var_1_10007
			var_12_6.content = var_1_10007("guild_shop_exchange_tip")
			...
			function var_12_6.onYes()
				...
				if not var_0.CanPurchase(var_15_0) then
					...
					var_15_2(var_15_1, var_2_10002("buy_countLimit"))
				...
				var_15_7(var_15_6, var_4.ON_MINI_GAME_SHOP_BUY, {
					id = var_0.id,
					list = var_15_3
				})
...
function var_0_1.AddTimer(arg_16_0)
	...
	arg_16_0.timer = var_1_10001.New(function()
		...
		local var_17_0 = var_2_10001.date
		local var_17_1 = "%d"

		pg = var_2_10003

		local var_17_2 = var_2_10003.TimeMgr.GetInstance()
		local var_17_3 = var_2_10000(var_17_0(var_17_1, var_3.GetServerTime(var_17_2)))
		...
		if not arg_16_0.flush and arg_16_0.day and arg_16_0.day == var_17_3 then
			...
			var_17_5(var_17_4, var_3.ON_MINI_GAME_SHOP_FLUSH)
