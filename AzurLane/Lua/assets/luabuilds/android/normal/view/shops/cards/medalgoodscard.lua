...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.limitCountLabelTF = var_1_1(var_1_0, var_4(var_1_10005))
...
function var_0_1.Init(arg_3_0)
	...
	var_3_2("props/medal", "", arg_3_0.resIconTF)
	...
	if not var_5.Selectable(var_3_8) then
		local var_3_9 = arg_3_0.itemTF

		var_3_10 = var_5.Find(var_3_9, "group_locked").gameObject.activeSelf
	else
		var_3_10 = false
	end
