...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_ITEM_PURCHASE, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.USE_ITEM, {
			count = 1,
			id = arg_3_1,
			arg = {
				arg_3_2
	...
	arg_1_0:bind(var_0_1.ON_RECORD_ANIM_PREVIEW_BTN, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.RECORD_SKIN_ANIM_PREVIEW, {
			isOpen = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SHOPPING_BY_ACT, function(arg_6_0, arg_6_1, arg_6_2)
		...
		var_6_1(var_6_0, var_2_10005.SKIN_COUPON_SHOPPING, {
			shopId = arg_6_1,
			cnt = arg_6_2
		})
	...
	arg_1_0:bind(var_0_1.ON_ATLAS, function(arg_11_0)
		...
		var_11_1(var_11_0, var_11_2, var_2_10004.SKINATALAS)
...
function var_0_1.handleNotification(arg_14_0, arg_14_1)
	...
	local var_14_3 = arg_14_1.getType(var_14_2)

	GAME = var_14_2

	if var_14_0 ~= var_14_2.SKIN_SHOPPIGN_DONE then
		GAME = var_5

		if var_14_0 == var_5.SKIN_COUPON_SHOPPING_DONE then
			pg = var_5

			if var_5.shop_template[var_14_1.id] then
				var_1_10006 = var_5.genre
				ShopArgs = var_1_10007

				if var_1_10006 ~= var_1_10007.SkinShop then
					var_1_10006 = var_5.genre
					ShopArgs = var_1_10007

					if var_1_10006 == var_1_10007.SkinShopTimeLimit then
						var_1_10006 = var_5.effect_args[1]
						pg = var_1_10007
						var_1_10007 = var_1_10007.ship_skin_template[var_1_10006].skin_type
						ShipSkin = var_1_10008

						local var_14_4

						if var_1_10007 == var_1_10008.SKIN_TYPE_TB then
							var_14_4 = arg_14_0
							var_1_10007 = arg_14_0.addSubLayers
							Context = var_1_10009

							local var_14_5 = var_1_10009.New

							var_1_10010 = {}
							NewSkinTBMediator = var_1_10011
							var_1_10010.mediator = var_1_10011
							NewSkinTBLayer = var_1_10011
							var_1_10010.viewComponent = var_1_10011

							local var_14_6 = {
								skinId = var_5.effect_args[1]
							}

							var_1_10012 = var_5.genre
							ShopArgs = var_1_10013
							var_1_10012 = var_1_10012 == var_1_10013.SkinShopTimeLimit
							var_14_6.timeLimit = var_1_10012
							var_1_10010.data = var_14_6

							var_1_10007(var_14_4, var_14_5(var_1_10010))
						else
							function var_1_10007()
								local var_15_0 = arg_14_0
								local var_15_1 = var_0.addSubLayers

								Context = var_2_10002

								local var_15_2 = var_2_10002.New
								local var_15_3 = {}

								NewSkinMediator = var_2_10004
								var_15_3.mediator = var_2_10004
								NewSkinLayer = var_2_10004
								var_15_3.viewComponent = var_2_10004
								...
								ShopArgs = var_2_10006
								var_15_4.timeLimit = var_15_5 == var_2_10006.SkinShopTimeLimit
							...
							PaintingShowScene = var_14_4

							if var_14_4.GetSkinShowAble(var_1_10006) then
								local var_14_7 = arg_14_0
								local var_14_8 = arg_14_0.addSubLayers

								Context = var_1_10010

								local var_14_9 = var_1_10010.New
								local var_14_10 = {}

								PaintingShowMediator = var_1_10012
								var_14_10.mediator = var_1_10012
								PaintingShowScene = var_1_10012
								var_14_10.viewComponent = var_1_10012
								var_14_10.data = {
									is_shop = true,
									skinId = var_1_10006,
									callback = var_1_10007
								}
						...
						local var_14_11 = arg_14_0.viewComponent

						var_1_10007.OnShopping(var_14_11, var_14_1.id)
					end
					...
					if var_14_0 == var_5.BUY_FURNITURE_DONE then
						...
						var_5.OnFurnitureUpdate(var_1_10006, var_14_3[1])
					else
						GAME = var_5
						...
						if var_14_0 == var_5.LOAD_LAYERS then
							var_14_12 = var_14_1.context.mediator
							NewBackYardShopMediator = var_1_10006

							if var_14_12 == var_1_10006 then
								var_1_10006 = arg_14_0
								var_14_12 = arg_14_0.sendNotification
								PlayerResUI = var_1_10007

								var_14_12(var_1_10006, var_1_10007.HIDE)
							end
						else
							GAME = var_14_12

							if var_14_0 == var_14_12.REMOVE_LAYERS then
								local var_14_13 = var_14_1.context.mediator

								NewBackYardShopMediator = var_1_10006

								if var_14_13 == var_1_10006 then
									local var_14_14 = arg_14_0
									local var_14_15 = arg_14_0.sendNotification

									PlayerResUI = var_1_10007

									var_14_15(var_14_14, var_1_10007.SHOW)
								end
							end
						end
					end
