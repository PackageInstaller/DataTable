...
function var_0_1.init(arg_10_0)
	...
	if var_10_6 then
		...
		var_10_5 = var_10_6(var_10_5)
		var_10_6 = var_10_6.getData(var_10_5).level
		LOCK_SKIN_SHOP_ENTER_LEVEL = var_10_5
		var_10_6 = var_10_6 < var_10_5
	end

	setActive = var_10_5

	var_10_5(arg_10_0.skinBtn, not var_10_6)

	local var_10_7 = arg_10_0._tf
	local var_10_8 = var_2.Find(var_10_7, "frame/bg/pages/scrollrect")
	local var_10_9 = var_2.GetComponent(var_10_8, "LScrollRect")
	local var_10_10 = arg_10_0._tf
	local var_10_11 = var_3.Find(var_10_10, "frame/bg/pages/scrollRectSpecial")

	setActive = var_10_10
	go = var_5

	var_10_10(var_5(var_10_9), true)

	setActive = var_10_10

	var_10_10(var_10_11, false)

	local var_10_12 = {}
	local var_10_13 = var_0_1.TYPE_ACTIVITY

	ActivityShopPage = var_6
	var_10_12[var_10_13] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9, var_10_11)

	local var_10_14 = var_0_1.TYPE_SHOP_STREET

	StreetShopPage = var_6
	var_10_12[var_10_14] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_15 = var_0_1.TYPE_MILITARY_SHOP

	MilitaryShopPage = var_6
	var_10_12[var_10_15] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_16 = var_0_1.TYPE_GUILD

	GuildShopPage = var_6
	var_10_12[var_10_16] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_17 = var_0_1.TYPE_SHAM_SHOP

	ShamShopPage = var_6
	var_10_12[var_10_17] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_18 = var_0_1.TYPE_FRAGMENT

	FragmentShopPage = var_6
	var_10_12[var_10_18] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_19 = var_0_1.TYPE_META

	MetaShopPage = var_6
	var_10_12[var_10_19] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_20 = var_0_1.TYPE_MEDAL

	MedalShopPage = var_6
	var_10_12[var_10_20] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_21 = var_0_1.TYPE_QUOTA

	QuotaShopPage = var_6
	var_10_12[var_10_21] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)

	local var_10_22 = var_0_1.TYPE_MINI_GAME

	MiniGameShopPage = var_6
	var_10_12[var_10_22] = var_6.New(arg_10_0.pageContainer, arg_10_0.event, arg_10_0.contextData, var_10_9)
	arg_10_0.pages = var_10_12

	local var_10_23 = arg_10_0.contextData

	ShopSingleWindow = var_10_22
	var_10_23.singleWindow = var_10_22.New(arg_10_0._tf, arg_10_0.event)

	local var_10_24 = arg_10_0.contextData

	ShopMultiWindow = var_5
	var_10_24.multiWindow = var_5.New(arg_10_0._tf, arg_10_0.event)

	local var_10_25 = arg_10_0.contextData

	EquipmentSkinInfoUIForShopWindow = var_5
	var_10_25.singleWindowForESkin = var_5.New(arg_10_0._tf, arg_10_0.event)

	local var_10_26 = arg_10_0.contextData

	ShopPaintingView = var_5

	local var_10_27 = var_5.New
	local var_10_28 = arg_10_0._tf
	local var_10_29 = var_6.Find(var_10_28, "paint/paint")
	local var_10_30 = arg_10_0._tf

	var_10_26.paintingView = var_10_27(var_10_29, var_7.Find(var_10_30, "frame/chat"))

	local var_10_31 = arg_10_0.contextData.paintingView
	local var_10_32 = var_4.setSecretaryPos
	local var_10_33 = arg_10_0._tf

	var_10_32(var_10_31, var_6.Find(var_10_33, "paint/secretaryPos"))

	local var_10_34 = arg_10_0.contextData

	ShopBgView = var_10_31

	local var_10_35 = var_10_31.New
	local var_10_36 = arg_10_0._tf

	var_10_34.bgView = var_10_35(var_6.Find(var_10_36, "bg"))
	arg_10_0.recorder = {
	...
	arg_10_0.frameTr = var_4.Find(var_10_37, "frame")
	UIItemList = var_4

	local var_10_38 = var_4.New
	local var_10_39 = arg_10_0._tf
	local var_10_40 = var_5.Find(var_10_39, "frame/bg/types")
	local var_10_41 = arg_10_0._tf

	arg_10_0.categoryUIList = var_10_38(var_10_40, var_6.Find(var_10_41, "frame/bg/types/tpl"))
	UIItemList = var_4

	local var_10_42 = var_4.New
	local var_10_43 = arg_10_0._tf
	local var_10_44 = var_5.Find(var_10_43, "frame/bg/shops")
	local var_10_45 = arg_10_0._tf

	arg_10_0.shopUIList = var_10_42(var_10_44, var_6.Find(var_10_45, "frame/bg/shops/tpl"))
...
function var_0_1.didEnter(arg_11_0)
	...
	var_1_10001(var_11_3, var_3.mingshiTouchFlagEnabled(var_11_4))
	...
	var_1_10001(var_11_5, var_11_6, var_11_7, var_1_10005)
	...
	local function var_11_10()
		...
		var_14_2(var_14_1, var_2_10003.GO_MALL, var_14_0)
	...
	var_1_10001(var_11_8, var_11_9, var_11_10, var_1_10005)
	...
	local function var_11_13()
		...
		NewShopsMediator = var_2_10002

		var_15_1(var_15_0, var_2_10002.ON_SKIN_SHOP)
	...
	var_1_10001(var_11_11, var_11_12, var_11_13, var_1_10005)
...
local function var_0_15(arg_19_0, arg_19_1)
	...
	local var_19_5 = var_19_1.GetComponent

	typeof = var_1_10008
	Image = var_1_10009

	local var_19_6 = var_19_5(var_19_4, var_1_10008(var_1_10009))

	GetSpriteFromAtlas = var_19_4
	var_19_6.sprite = var_19_4("ui/ShopsUI_atlas", var_19_0 .. "_lock")

	var_19_6:SetNativeSize()

	local var_19_7 = var_19_2
	local var_19_8 = var_19_2.GetComponent

	typeof = var_9
	Image = var_10

	local var_19_9 = var_19_8(var_19_7, var_9(var_10))

	GetSpriteFromAtlas = var_19_7
	var_19_9.sprite = var_19_7("ui/ShopsUI_atlas", var_19_0)

	var_19_9:SetNativeSize()

	local var_19_10 = var_19_2:Find("en")
	local var_19_11 = var_8.GetComponent

	typeof = var_10
	Image = var_1_10011

	local var_19_12 = var_19_11(var_19_10, var_10(var_1_10011))

	GetSpriteFromAtlas = var_19_10
	var_19_12.sprite = var_19_10("ui/ShopsUI_atlas", var_19_0 .. "_label")

	var_19_12:SetNativeSize()

	local var_19_13 = var_19_3
	local var_19_14 = var_19_3.GetComponent

	typeof = var_11
	Image = var_12

	local var_19_15 = var_19_14(var_19_13, var_11(var_12))

	GetSpriteFromAtlas = var_19_13
	var_19_15.sprite = var_19_13("ui/ShopsUI_atlas", var_19_0 .. "_selected")

	var_19_15:SetNativeSize()

	local var_19_16 = var_19_3.parent
	local var_19_17 = var_10.Find(var_19_16, "en")
	local var_19_18 = var_10.GetComponent

	typeof = var_12
	Image = var_13

	local var_19_19 = var_19_18(var_19_17, var_12(var_13))

	GetSpriteFromAtlas = var_19_17
	var_19_19.sprite = var_19_17("ui/ShopsUI_atlas", var_19_0 .. "_label_selected")

	var_19_19:SetNativeSize()
...
function var_0_1.UpdateCategory(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local function var_20_2(arg_21_0)
		...
		var_2_10001(var_2.Find(var_21_2, "label"), not arg_20_3 and not arg_21_0)

		setActive = var_2_10001

		local var_21_3 = arg_20_1

		var_2_10001(var_2.Find(var_21_3, "selected"), not arg_20_3 and arg_21_0)
	...
	var_4(var_20_0, var_20_1, var_20_2, var_1_10008)
...
function var_0_1.InitShops(arg_22_0, arg_22_1)
	...
	var_4.make(var_22_3, function(arg_23_0, arg_23_1, arg_23_2)
		...
		if arg_23_0 == var_2_10003.EventUpdate then
			...
			var_23_1(arg_23_2:Find("unsel/lock"), not var_23_2)

			GetOrAddComponent = var_23_1
			var_23_1(arg_23_2:Find("unsel/label"), "CanvasGroup").alpha = var_23_2 and 1 or 0.4
...
local function var_0_17(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_2 = arg_25_1.Find(var_25_1, "selected")
	...
	local function var_25_5()
		...
		if arg_25_2() then
			if arg_25_0.prevBtn then
				...
				var_1(var_2.Find(var_26_0, "unsel"), true)

				setActive = var_1

				local var_26_1 = arg_25_0.prevBtn

				var_1(var_2.Find(var_26_1, "selected"), false)
			end

			setActive = var_1

			var_1(var_25_0, false)
	...
	var_25_1(var_25_3, var_25_4, var_25_5, var_1_10009)
	...
	var_0_17(arg_27_0, arg_27_1, function()
		...
		if var_28_2 then
			if arg_27_0.page then
				...
				if not var_28_7.GetLoaded(var_28_4) then
					return
				end
			end
			...
			if arg_27_0.page then
				...
				var_28_7.Hide(var_28_5)
			end

			local var_28_6 = arg_27_0.contextData.bgView

			var_28_7.Init(var_28_6, var_1:GetBg(var_28_0))
			var_1:ExecuteAction("SetUp", var_28_0, arg_27_0.player, arg_27_0.items)

			var_28_7 = arg_27_0
			var_28_7.page = var_1
			var_28_7 = arg_27_0.contextData
			var_28_7.activeShop = arg_27_2.type
			var_28_7 = arg_27_0.recorder
			var_28_7[arg_27_0.category] = arg_27_2

			return true
		else
			pg = var_28_7

			local var_28_8 = var_28_7.TipsMgr.GetInstance()

			var_4.ShowTips(var_28_8, var_28_3)
		end
...
function var_0_1.ActiveDefaultCategory(arg_29_0)
	...
	if var_1_10002(var_29_0) == "string" then
		...
		defaultValue = var_3
		var_29_0 = var_3(var_29_1, var_0_1.TYPE_ACTIVITY)
	end
	...
	if var_29_0 == var_0_1.TYPE_ACTIVITY and arg_29_0.contextData.actId then
		...
		for iter_29_0, iter_29_1 in var_3(var_1_10004) do
	...
	if var_29_0 == var_0_1.TYPE_ACTIVITY then
		if arg_29_0.shops[var_0_1.TYPE_ACTIVITY] then
			do
				...
				if var_29_0 == var_0_1.TYPE_ACTIVITY and arg_29_0.shops[var_0_1.TYPE_ACTIVITY] then
					...
					if 0 < var_29_5 and not arg_29_0.contextData.actId then
						...
						var_1_10004 = arg_29_0.shops[var_29_0][var_29_6].activityId
						ipairs = var_1_10005
						...
						for iter_29_2, iter_29_3 in var_1_10005(var_29_7) do
							if var_1_10004 < iter_29_3.activityId then
								local var_29_8 = iter_29_2
							end
						end
					end
				end
			...
			for iter_29_4, iter_29_5 in var_1_10004(var_0_13) do
				table = iter_29_3
			...
			var_4(var_29_9 and arg_29_0.categoryTrs[var_29_9])

			arg_29_0.shopType = var_29_0
			arg_29_0.shopIndex = var_29_2
			triggerToggle = var_4

			var_4(arg_29_0.categoryTrs[var_29_9], true)
...
function var_0_1.ActiveDefaultShop(arg_30_0)
	...
	if var_30_4 and arg_30_0.displayShops[var_30_0] and arg_30_0.displayShops[var_30_0][var_30_1] then
		...
		var_6(arg_30_0.displayShops[var_30_0][var_30_1])
	else
		if not var_30_4 then
			pg = var_6

			local var_30_6 = var_6.TipsMgr.GetInstance()
...
function var_0_1.BlurView(arg_33_0)
	...
	local var_33_2 = var_33_0.UIMgr.GetInstance()
	...
	var_33_6[1] = var_7.Find(var_33_7, "bg")
	var_33_6[2] = var_33_1
