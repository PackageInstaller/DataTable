...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".MilitaryShopPage"))
...
function var_0_1.OnInitItem(arg_8_0, arg_8_1)
	...
	local function var_8_3()
		...
		if not var_0.CanPurchase(var_9_0) then
			...
			var_9_2(var_9_1, var_2_10002("buy_countLimit"))
...
function var_0_1.OnCardClick(arg_10_0, arg_10_1)
	...
	if var_2.Selectable(var_10_0) then
		...
		var_1_10005.count = var_6.GetMaxCnt(var_10_4)

		local var_10_5 = arg_10_1.goods

		var_1_10005.type = var_6.getConfig(var_10_5, "type")

		local var_10_6 = arg_10_1.goods

		var_1_10005.price = var_6.getConfig(var_10_6, "price")

		local var_10_7 = arg_10_1.goods

		var_1_10005.displays = var_6.getConfig(var_10_7, "goods")

		local var_10_8 = arg_10_1.goods

		var_1_10005.num = var_6.getConfig(var_10_8, "num")

		var_10_2(var_10_1, var_10_3, var_1_10005)
	else
			...
			if var_2.GetLimit(var_10_10) > 1 then
				...
				var_2.ExecuteAction(var_10_11, "Show", arg_10_1.goods, function(arg_11_0)
					...
					if not var_1.CanPurchaseCnt(var_11_0, arg_11_0) then
						...
						var_11_2(var_11_1, var_3("buy_countLimit"))
					...
					var_11_7(var_11_6, var_5.ON_MEDAL_SHOPPING, arg_10_1.goods.id, var_11_3)
		...
		i18n = var_1_10005
		var_10_14.content = var_1_10005("guild_shop_exchange_tip")
		...
		function var_10_14.onYes()
			...
			if not var_0.CanPurchase(var_12_0) then
				...
				var_12_2(var_12_1, var_2_10002("buy_countLimit"))
			...
			local var_12_5 = var_2_10002.ON_MEDAL_SHOPPING
			local var_12_6 = arg_10_1.goods.id
			local var_12_7 = arg_10_1.goods

			var_12_4(var_12_3, var_12_5, var_12_6, var_4.GetFirstDropId(var_12_7))
...
function var_0_1.AddTimer(arg_13_0)
	...
	arg_13_0.timer = var_1_10002.New(function()
		...
		if var_14_0 - var_1.GetServerTime(var_14_1) <= 0 then
			...
			local var_14_6 = var_14_4(var_14_5, 1 + var_2_10003.floor((var_0 - 1) / 0))
			...
			local var_14_8 = var_4("title_limit_time")

			i18n = var_5

			local var_14_9 = var_5("shops_rest_day")
			local var_14_10 = var_14_6

			i18n = var_2_10007

			var_14_5(var_14_7, var_14_8 .. var_14_9 .. var_14_10 .. var_2_10007("word_date"))
		end
...
function var_0_1.OnTimeOut(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.REFRESH_MEDAL_SHOP, false)
