...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".ActivityShopPage"))
...
function var_0_1.OnInitItem(arg_4_0, arg_4_1)
	...
	local function var_4_3()
		...
		if var_0.Selectable(var_5_0) then
			...
			var_5_4.count = var_4.getConfig(var_5_5, "num_limit")

			local var_5_6 = var_4_0.goodsVO

			var_5_4.type = var_4.getConfig(var_5_6, "commodity_type")

			local var_5_7 = var_4_0.goodsVO

			var_5_4.price = var_4.getConfig(var_5_7, "resource_num")

			local var_5_8 = var_4_0.goodsVO

			var_5_4.displays = var_4.getConfig(var_5_8, "commodity_id_list")

			local var_5_9 = var_4_0.goodsVO

			var_5_4.num = var_4.getConfig(var_5_9, "num")
	...
	var_3(var_4_1, var_4_2, var_4_3, var_1_10007)
