...
function var_0_1.UpdateRes(arg_3_0)
	...
	if not arg_3_0.isInitResIcon then
		...
		var_4(var_5.getIcon(var_3_7), "", arg_3_0.resIcon)
	end
...
function var_0_1.OnClickCard(arg_9_0, arg_9_1)
	...
	local var_9_3, var_9_4 = var_9_1(var_9_0, var_5.GetStartTime(var_9_2))
	...
	if not var_9_3 then
		...
		if 0 < var_9_5 then
			...
			local var_9_10 = var_9_8 .. var_9_9 .. var_1_10008("word_hour")
			...
			var_9_12(var_9_11, var_9("newserver_shop_timelimit", var_9_10))
			...
			if var_2:Selectable() then
				...
				var_9_14:ExecuteAction("Open", var_2, function(arg_10_0, arg_10_1, arg_10_2)
					...
					var_10_3(var_10_2, var_2_10005.NEW_SERVER_SHOP_SHOPPING, {
						id = arg_10_0.id,
...
function var_0_1.FetchShop(arg_12_0, arg_12_1)
	...
	if not var_12_1(var_12_0, var_1_10004.ACTIVITY_TYPE_NEWSERVER_SHOP) then
		pg = var_12_0
...
function var_0_1.UpdatePageFooter(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_4 = var_18_3(var_18_2, var_7(var_1_10008))
	...
	typeof = var_8
	Image = var_9
	var_18_7(var_18_6, var_8(var_9)).sprite = var_18_5

	local var_18_8 = arg_18_1
	local var_18_9 = arg_18_1.Find(var_18_8, "lock")

	if arg_18_2 ~= 1 then
		GetSpriteFromAtlas = var_18_8
		var_18_8 = var_18_8("ui/newservershopui_atlas", "p" .. arg_18_2 .. "_l")

		local var_18_10 = var_18_9
		local var_18_11 = var_18_9.GetComponent

		typeof = var_10
		Image = var_11
		var_18_11(var_18_10, var_10(var_11)).sprite = var_18_8
	end
	...
	var_18_8(var_18_12, not var_9.IsOpenPhase(var_18_13, arg_18_2))

	setActive = var_18_8

	var_18_8(arg_18_1:Find("tip"), arg_18_0:isPhaseTip(arg_18_2))
	arg_18_0:OnSwitch(arg_18_1, function()
		...
		local var_20_2 = var_1.Find(var_20_1, "tip")
		local var_20_3 = arg_18_0

		var_0(var_20_2, var_2.isPhaseTip(var_20_3, arg_18_2))
...
function var_0_1.OnSwitch(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	local function var_21_1()
		...
		var_22_0.markTr = var_21_0
		setActive = var_22_0

		var_22_0(var_21_0, true)
	...
	var_6(var_21_2, var_21_3, var_21_4, var_1_10010)
...
function var_0_1.SwitchPhase(arg_24_0, arg_24_1)
	...
	local var_24_2 = var_2

	arg_24_0.displays = var_2.GetOpeningGoodsList(var_24_2, var_24_1)
	table = var_24_2

	var_24_2.sort(arg_24_0.displays, function(arg_25_0, arg_25_1)
	...
	local var_24_3 = arg_24_0.scrollrect

	var_6.SetTotalCount(var_24_3, #arg_24_0.displays)
...
function var_0_1.isPhaseTip(arg_27_0, arg_27_1)
	if not arg_27_0.playerId then
		...
		local var_27_0 = var_27_2(var_1_10003)
...
function var_0_1.updateLocalRedDotData(arg_28_0, arg_28_1)
	if arg_28_0:isPhaseTip(arg_28_1) then
		...
		var_28_1(var_28_0, var_4.UPDATE_SHOP_RED_DOT)
	end
...
function var_0_1.isTip(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1(var_2.GetPhases(var_29_1)) do
