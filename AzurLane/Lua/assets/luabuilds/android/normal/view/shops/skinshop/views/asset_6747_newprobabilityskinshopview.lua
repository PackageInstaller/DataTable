...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.tipTxt = var_2_3(var_2_2, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.tag = var_2_9(var_2_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.priceTxt = var_2_15(var_2_14, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.descTxt = var_2_18(var_2_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.limitTxt = var_2_21(var_2_20, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_22 = var_1.New
	local var_2_23 = arg_2_0._tf
	local var_2_24 = var_2.Find(var_2_23, "frame/awards")
	local var_2_25 = arg_2_0._tf

	arg_2_0.uiList = var_2_22(var_2_24, var_3.Find(var_2_25, "frame/awards/award"))
...
function var_0_1.UpdateCommodity(arg_8_0, arg_8_1)
	...
	local var_8_1 = arg_8_0.icon

	LoadSprite = var_4
	var_8_1.sprite = var_4("ChargeIcon/" .. var_8_0)

	local var_8_2 = arg_8_0.icon

	var_3.SetNativeSize(var_8_2)

	arg_8_0.nameTxt.text = arg_8_1:getConfig("name_display")

	local var_8_3 = arg_8_0.priceTxt

	GetMoneySymbol = var_4
	var_8_3.text = var_4() .. arg_8_1:getConfig("money")
	...
	local var_8_5 = arg_8_0.tag

	LoadSprite = var_5
	var_8_5.sprite = var_5("chargeTag", var_0_2(var_8_4))

	local var_8_6 = arg_8_0.tag

	var_4.SetNativeSize(var_8_6)
	var_0_3(arg_8_0, arg_8_1)

	onButton = var_4

	local var_8_7 = arg_8_0
	local var_8_8 = arg_8_0.purchaseBtn
	...
	local function var_8_9()
		...
		if var_0.canPurchase(var_9_0) then
			...
			var_9_3(var_9_2, var_2_10002("buy_countLimit"))
		end
	...
	var_4(var_8_7, var_8_8, var_8_9, var_8)
...
function var_0_1.OnCharge(arg_10_0, arg_10_1)
	...
	function var_10_2.onYes()
		...
		if var_2_10000.isNeedSetBirth() then
			...
			NewProbabilitySkinShopMediator = var_2_10002

			var_11_1(var_11_0, var_2_10002.OPEN_CHARGE_BIRTHDAY)
		else
			...
			var_11_3(var_11_2, var_2_10002.CHARGE, var_0.id)
		end
	...
	NewProbabilitySkinShopMediator = var_7

	var_10_4(var_10_3, var_7.OPEN_CHARGE_ITEM_PANEL, var_10_2)
