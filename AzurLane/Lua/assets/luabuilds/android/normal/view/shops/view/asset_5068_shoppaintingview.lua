...
function var_0_0.Init(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	...
	if arg_3_5 then
		...
		var_6(var_3_0, var_3_1, var_3_2, var_1_10010)
	end
...
function var_0_0.ShowShipWord(arg_10_0, arg_10_1)
	...
	if var_10_0(var_1_10003(arg_10_0.chat)) then
		LeanTween = var_2
	...
	local var_10_6 = var_10_4(var_10_5, var_6.New(1, 1, 1), var_10_2)
	local var_10_7 = var_4.setFrom

	Vector3 = var_6

	local var_10_8 = var_10_7(var_10_6, var_6.New(0, 0, 0))
	local var_10_9 = var_4.setEase

	LeanTweenType = var_6

	local var_10_10 = var_10_9(var_10_8, var_6.easeOutBack)
	local var_10_11 = var_4.setOnComplete

	System = var_6

	var_10_11(var_10_10, var_6.Action(function()
		IsNil = var_2_10000
		...
		local var_11_2 = var_11_0(var_11_1, var_2_10002.New(0, 0, 1), var_10_2)
		local var_11_3 = var_0.setFrom

		Vector3 = var_2

		local var_11_4 = var_11_3(var_11_2, var_2.New(1, 1, 1))
		local var_11_5 = var_0.setEase

		LeanTweenType = var_2

		local var_11_6 = var_11_5(var_11_4, var_2.easeInBack)
		local var_11_7 = var_0.setDelay(var_11_6, var_10_3)
		local var_11_8 = var_0.setOnComplete

		System = var_2

		var_11_8(var_11_7, var_2.Action(function()
			IsNil = var_3_10000
...
function var_0_0.StopChat(arg_13_0)
	...
	if var_13_0(var_1_10002(arg_13_0.chat)) then
		LeanTween = var_13_1
		var_13_1 = var_13_1.cancel
		go = var_2

		var_13_1(var_2(arg_13_0.chat))
	end
