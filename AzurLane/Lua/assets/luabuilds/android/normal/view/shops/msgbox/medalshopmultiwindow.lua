...
function var_0_1.InitWindow(arg_8_0, arg_8_1, arg_8_2)
	...
	ITEM_ID_SILVER_HOOK = var_1_10006

	local var_8_4 = var_8_3(var_8_2, var_1_10006)

	math = var_8_2

	local var_8_5 = var_8_2.max

	math = var_1_10006

	local var_8_6 = var_8_5(var_1_10006.floor(var_8_4 / arg_8_1:getConfig("price")), 1)
	local var_8_7 = arg_8_1

	if arg_8_1.GetLimit(var_8_7) ~= 0 then
		math = var_8_7
		var_8_6 = var_8_7.min(var_8_6, arg_8_1:GetMaxCnt())
	end
	...
	local var_8_8 = arg_8_0.topItem

	var_8(var_9.Find(var_8_8, "left/IconTpl"), var_8_1)
	...
	local var_8_9 = arg_8_0.descTF
	local var_8_10

	if not var_8_1.desc then
		var_8_10 = var_8_1:getConfig("desc")
	end

	var_8_9.text = var_8_10
	updateDrop = var_8_9

	var_8_9(arg_8_0.bottomItem, var_8_1)

	onButton = var_8_9

	local var_8_11 = arg_8_0
	local var_8_12 = arg_8_0.confirmBtn
	...
	var_8_9(var_8_11, var_8_12, var_8_13, var_1_10012)

	onButton = var_8_9

	var_8_9(arg_8_0, arg_8_0.leftBtn, function()
	...
	var_8_9(arg_8_0, arg_8_0.rightBtn, function()
		var_0(arg_8_0.curCount + 1)
	...
	var_8_9(arg_8_0, arg_8_0.maxBtn, function()
		var_0(var_8_6)
