...
function var_0_1.GetResDataList(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_5_1(var_5_2) do
		...
		local var_5_5 = var_5_4(var_5_3, var_1_10010.ResGuildCoin)

		table = var_5_3

		local var_5_6 = var_5_3.insert
		...
		var_5_7.type = var_1_10012
		var_5_7.resID = iter_5_1
		var_5_7.cnt = var_5_5

		var_5_6(var_1_10010, var_5_7)
	end
...
function var_0_1.UpdateRefreshBtn(arg_7_0)
	...
	var_1_10001(var_7_0, var_3.CanRefresh(var_7_1))
...
function var_0_1.RefreshUI(arg_8_0)
	...
	local function var_8_2()
		...
		i18n = var_2_10007
		var_9_4.content = var_2_10004(var_9_5, var_9_6, var_2_10007("word_guildgold"))

		function var_9_4.onYes()
			local var_10_0 = arg_8_0.player
			local var_10_1 = var_0.getResource

			PlayerConst = var_3_10002

			if var_10_1(var_10_0, var_3_10002.ResGuildCoin) < var_9_1 then
				pg = var_0
				...
				var_10_3(var_10_2, var_2("common_no_resource"))
				...
				var_10_5(var_10_4, var_2.REFRESH_GUILD_SHOP, true)
			end
	...
	var_1_10001(var_8_3, var_3.CanRefresh(var_8_4))
...
function var_0_1.OnCardClick(arg_13_0, arg_13_1)
	...
	if var_2.Selectable(var_13_0) then
		...
		var_1_10005.count = var_6.GetMaxCnt(var_13_4)

		local var_13_5 = arg_13_1.goodsVO

		var_1_10005.type = var_6.getConfig(var_13_5, "type")

		local var_13_6 = arg_13_1.goodsVO

		var_1_10005.price = var_6.getConfig(var_13_6, "price")

		local var_13_7 = arg_13_1.goodsVO

		var_1_10005.displays = var_6.getConfig(var_13_7, "goods")

		local var_13_8 = arg_13_1.goodsVO

		var_1_10005.num = var_6.getConfig(var_13_8, "num")

		var_13_2(var_13_1, var_13_3, var_1_10005)
	else
		pg = var_13_2
		...
		i18n = var_1_10005
		var_13_11.content = var_1_10005("guild_shop_exchange_tip")
		...
		function var_13_11.onYes()
			...
			if not var_0.CanPurchase(var_14_0) then
				...
				var_14_2(var_14_1, var_2_10002("buy_countLimit"))
			...
			local var_14_5 = var_2_10002.ON_GUILD_SHOPPING
			local var_14_6 = arg_13_1.goodsVO.id
			local var_14_7 = arg_13_1.goodsVO

			var_14_4(var_14_3, var_14_5, var_14_6, var_4.GetFirstDropId(var_14_7))
...
function var_0_1.OnTimeOut(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.REFRESH_GUILD_SHOP, false)
