...
function var_0_1.update(arg_5_0, arg_5_1)
	...
	local var_5_6 = ""
	local var_5_7 = arg_5_1:getConfig("price")
	local var_5_8 = arg_5_1:GetMaxCnt()
	local var_5_9 = arg_5_1
	local var_5_10 = arg_5_1.getConfig(var_5_9, "goods_purchase_limit")

	setText = var_5_9

	local var_5_11 = arg_5_0.limitCountLabelTF

	i18n = var_1_10011

	var_5_9(var_5_11, var_1_10011("activity_shop_exchange_count") .. var_5_8 .. "/" .. var_5_10)

	setActive = var_5_9

	var_5_9(arg_5_0.limitCountLabelTF, true)
	...
	local var_5_12 = arg_5_0.countTF

	math = var_11

	var_5_9(var_5_12, var_11.ceil(var_5_7))

	GetSpriteFromAtlasAsync = var_5_9

	var_5_9("ui/ShopsUI_atlas", "minigameRes", function(arg_6_0)
		local var_6_0 = arg_5_0.resIconTF
		local var_6_1 = var_1.GetComponent

		typeof = var_2_10003
		Image = var_2_10004
		var_6_1(var_6_0, var_2_10003(var_2_10004)).sprite = arg_6_0
	...
	local var_5_13 = arg_5_0.groupLocked
	local var_5_14 = arg_5_0.itemTF

	var_5_9(var_5_13, var_11.Find(var_5_14, "group_locked").gameObject.activeSelf)
