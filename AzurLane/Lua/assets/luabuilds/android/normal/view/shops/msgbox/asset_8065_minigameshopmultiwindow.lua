...
function var_0_1.InitWindow(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_2 = var_8_0(var_1_10005)
	local var_8_3 = var_4.getTicket(var_8_2)

	math = var_8_2

	local var_8_4 = var_8_2.max

	math = var_1_10006

	local var_8_5 = var_8_4(var_1_10006.floor(var_8_3 / arg_8_1:getConfig("price")), 1)
	local var_8_6 = arg_8_1

	if arg_8_1.GetMaxCnt(var_8_6) ~= 0 then
		math = var_8_6
		var_8_5 = var_8_6.min(var_8_5, arg_8_1:GetMaxCnt())
	end
	...
	var_8(var_9.Find(var_8_7, "left/IconTpl"), var_8_1)
	...
	var_8_8(var_8_10, var_8_11, var_8_12, var_1_10012)
