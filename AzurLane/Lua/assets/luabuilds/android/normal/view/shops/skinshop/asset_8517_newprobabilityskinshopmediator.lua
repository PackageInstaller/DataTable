...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".NewSkinShopMediator"))
...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.CHARGE, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.CHARGE_OPERATION, {
			shopId = arg_3_1
		})
...
function var_0_1.listNotificationInterests(arg_5_0)
	...
	local var_5_1 = var_2.insert
	local var_5_2 = var_5_0

	GAME = var_1_10004

	var_5_1(var_5_2, var_1_10004.CHARGE_SUCCESS)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.CHARGE_SUCCESS then
