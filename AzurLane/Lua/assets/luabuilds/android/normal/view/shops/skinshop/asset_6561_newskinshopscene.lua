...
function var_0_1.GetAllCommodity(arg_4_0)
	...
	LOCK_SKIN_US = var_4_0

	if var_4_0 then
		pg = var_4_0

		local var_4_2 = var_4_0.gameset.levellimit_skintype.key_value

		pg = var_1_10003

		local var_4_3 = var_1_10003.gameset.levellimit_skintype.description

		getProxy = var_1_10004
		PlayerProxy = var_1_10005

		local var_4_4 = var_1_10004(var_1_10005)

		if var_4_2 >= var_4.getData(var_4_4).level then
			_ = var_4_4
			var_4_1 = var_4_4.filter(var_4_1, function(arg_5_0)
				pg = var_2_10001
...
function var_0_1.GetSkinClassify(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_4, iter_8_5 in var_6(var_7.skin_page_template.all) do
...
function var_0_1.GetReturnSkinMap(arg_11_0)
	if not arg_11_0.encoreSkinMap then
		...
		local var_11_1 = arg_11_0.GetReturnSkins(var_11_0)
...
function var_0_1.OnShopping(arg_13_0, arg_13_1)
	...
	if arg_13_0.mainView.commodity.id == arg_13_1 then
		...
		local var_13_2 = arg_13_0.GetAllCommodity(var_13_1)

		_ = var_13_1

		if var_13_1.detect(var_13_2, function(arg_14_0)
			return arg_14_0.id == arg_13_1
		end) then
			local var_13_3 = arg_13_0.mainView

			var_4.Flush(var_13_3, var_3)
		end

		arg_13_0:UpdateCouponBtn()
		arg_13_0:UpdateVoucherBtn()
		arg_13_0:UpdateCommodities(var_13_2, false)

		arg_13_0.commodities = var_13_2
	end
...
function var_0_1.init(arg_15_0)
	...
	arg_15_0.cgGroup = var_15_1(var_15_0, var_1_10003(var_1_10004))
	...
	local var_15_13 = var_2.Find(var_15_12, "holder")

	i18n = var_15_12

	var_1(var_15_13, var_15_12("skinatlas_search_holder"))
	...
	local var_15_20 = var_2.Find(var_15_19, "overlay/left/mask/content/0")
	local var_15_21 = arg_15_0._tf

	arg_15_0.rollingCircleRect = var_15_18(var_15_20, var_3.Find(var_15_21, "overlay/left"))
	...
	typeof = var_3
	Image = var_4
	arg_15_0.title = var_15_26(var_15_25, var_3(var_4))
	...
	typeof = var_3
	Image = var_4
	arg_15_0.titleEn = var_15_29(var_15_28, var_3(var_4))
	...
	ShipIndexConst = var_15_32
	var_15_33.typeIndex = var_15_32.TypeAll
...
function var_0_1.didEnter(arg_18_0)
	...
	local function var_18_5()
		...
		var_20_1(var_20_0, var_2_10002.ON_ATLAS)
	...
	local function var_18_14()
		...
		var_23_1(var_23_0, var_2_10002.ON_INDEX, {
	...
	var_1_10001(var_18_18, var_18_19, var_18_20, var_1_10005)
	...
	local function var_18_23()
		...
		if not var_2_10000.StaticExistActivityAndCoupon() then
			...
			var_28_2(var_28_1, var_2_10002("common_activity_end"))
...
function var_0_1.UpdateCouponBtn(arg_30_0)
	...
	if var_30_0 then
		...
		if not var_30_3(1, 1, 1) then
			Vector3 = var_30_3
			var_30_3 = var_30_3(0, 0, 0)
		end

		var_30_2.localScale = var_30_3
...
function var_0_1.UpdateVoucherBtn(arg_31_0)
	...
	if var_31_2 then
		...
		if not var_31_5(1, 1, 1) then
			Vector3 = var_31_5
			var_31_5 = var_31_5(0, 0, 0)
		end

		var_31_4.localScale = var_31_5
...
function var_0_1.OnSelectSkinPage(arg_32_0, arg_32_1)
	if arg_32_0.selectedSkinPageItem then
		...
		var_2(var_3.Find(var_32_0, "selected"), false)

		setActive = var_2

		local var_32_1 = arg_32_0.selectedSkinPageItem._tr

		var_2(var_3.Find(var_32_1, "name"), true)
	end
	...
	var_2(var_3.Find(var_32_2, "selected"), true)

	setActive = var_2

	local var_32_3 = arg_32_1._tr

	var_2(var_3.Find(var_32_3, "name"), false)
...
function var_0_1.OnFilter(arg_34_0, arg_34_1)
	...
	SkinIndexLayer = var_1_10005

	var_2(var_34_0, var_34_1 == var_1_10005.ExtraL2D)
	...
	if var_34_3 == var_5.TypeAll then
		local var_34_4 = arg_34_1.campIndex

		ShipIndexConst = var_5

		if var_34_4 == var_5.CampAll then
			local var_34_5 = arg_34_1.rarityIndex

			ShipIndexConst = var_5

			if var_34_5 == var_5.RarityAll then
				local var_34_6 = arg_34_1.extraIndex

				SkinIndexLayer = var_5

				if var_34_6 == var_5.ExtraALL then
					var_34_7 = false
...
function var_0_1.UpdateTitle(arg_43_0, arg_43_1)
	...
	var_43_4.sprite = var_5("ui/SkinShopUI_atlas", var_43_3[arg_43_1])
...
local function var_0_9(arg_44_0, arg_44_1)
	...
	var_44_4("SkinClassified", var_44_2 .. "01", function(arg_45_0)
		...
		local var_45_3 = var_45_2(var_45_1, var_3(var_2_10004))
	...
	var_44_4("SkinClassified", var_44_2, function(arg_46_0)
		...
		local var_46_3 = var_46_2(var_46_1, var_3(var_2_10004))
	...
	var_44_4(var_7.Find(var_44_5, "eng"), var_44_3)
...
function var_0_1.InitSkinClassify(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	for iter_47_0, iter_47_1 in var_6(var_47_0) do
		table = var_1_10011

		var_1_10011.insert(var_47_1, function(arg_48_0)
...
local function var_0_10(arg_50_0)
	...
	if not var_0_1.cacheSkinExperienceItems then
		...
		local var_50_1 = var_1_10002(var_1_10003)
...
function var_0_1.IsType(arg_52_0, arg_52_1, arg_52_2)
	...
	local var_52_1 = arg_52_2.getConfig(var_52_0, "genre")

	ShopArgs = var_52_0

	if var_52_1 == var_52_0.SkinShopTimeLimit then
...
function var_0_1.IsFilterType(arg_59_0, arg_59_1, arg_59_2)
	...
	local var_59_1 = arg_59_2.getSkinId(var_59_0)

	ShipSkin = var_59_0

	local var_59_2 = var_59_0.New({
		id = var_59_1
	})

	if not var_4.GetDefaultShipConfig(var_59_2) then
		return false
	end

	local var_59_3 = arg_59_0
	local var_59_4 = arg_59_0.ToVShip(var_59_3, var_5)

	ShipIndexConst = var_59_3

	local var_59_5 = var_59_3.filterByType(var_59_4, arg_59_1.typeIndex)

	ShipIndexConst = var_8

	local var_59_6 = var_8.filterByCamp(var_59_4, arg_59_1.campIndex)

	ShipIndexConst = var_9

	local var_59_7 = var_9.filterByRarity(var_59_4, arg_59_1.rarityIndex)

	SkinIndexLayer = var_10

	local var_59_8 = var_10.filterByExtra(var_4, arg_59_1.extraIndex)

	return var_59_5 and var_59_6 and var_59_7 and var_59_8
end
...
function var_0_1.IsSearchType(arg_60_0, arg_60_1, arg_60_2)
	...
	local var_60_1 = arg_60_2.getSkinId(var_60_0)

	ShipSkin = var_60_0

	local var_60_2 = var_60_0.New({
		id = var_60_1
	})

	return var_4.IsMatchKey(var_60_2, arg_60_1)
end
...
function var_0_1.UpdateCommodities(arg_65_0, arg_65_1, arg_65_2, arg_65_3)
	...
	local var_65_1 = var_5(var_1_10006)
	local var_65_2 = var_5.GetSkinShopDiscountItemList(var_65_1)

	ipairs = var_65_1

	for iter_65_0, iter_65_1 in var_65_1(arg_65_1) do
		local var_65_3 = iter_65_1:StaticCanUseVoucherType(var_65_2)

		var_1_10013 = arg_65_0

		if arg_65_0.IsType(var_1_10013, arg_65_0.skinPageID, iter_65_1) then
			var_1_10013 = arg_65_0

			if arg_65_0.IsFilterType(var_1_10013, arg_65_0.defaultIndex, iter_65_1) then
				var_1_10013 = arg_65_0

				if arg_65_0.IsSearchType(var_1_10013, var_65_0, iter_65_1) then
					var_1_10013 = arg_65_0

					if arg_65_0.IsCouponType(var_1_10013, arg_65_0.isFilterCoupon, iter_65_1) then
						var_1_10013 = arg_65_0

						if arg_65_0.IsVoucherType(var_1_10013, arg_65_0.isFilterVoucher, var_65_3) then
							table = var_12
...
function var_0_1.OnInitItem(arg_67_0, arg_67_1)
	...
	var_3(var_67_1, var_67_2, var_67_3, var_1_10007)
...
function var_0_1.CheckCardBound(arg_75_0, arg_75_1, arg_75_2, arg_75_3, arg_75_4)
	...
	if arg_75_3 then
		getBounds = var_75_1
		var_75_1 = var_75_1(arg_75_2._tf)
		getBounds = var_7

		local var_75_2 = var_7(arg_75_1._tf)

		math = var_8

		if var_8.ceil(var_75_2:GetMax().x - var_75_0:GetMax().x) > var_75_1.size.x then
			local var_75_3 = arg_75_0.scrollrect
			local var_75_4 = var_8.HeadIndexToValue(var_75_3, arg_75_4 - 1)
			local var_75_5 = arg_75_0.scrollrect
			local var_75_6 = var_75_4 - var_9.HeadIndexToValue(var_75_5, arg_75_4)
			local var_75_7 = arg_75_0.scrollrect.value - var_75_6
			local var_75_8 = arg_75_0.scrollrect

			var_10.SetNormalizedPosition(var_75_8, var_75_7, 0)
		end
	else
		getBounds = var_75_1

		local var_75_9 = var_75_1(arg_75_1._tf)

		getBounds = var_7

		local var_75_10 = var_7(arg_75_1._tf.parent)

		if var_7.GetMin(var_75_10).x < var_75_0:GetMin().x and var_75_9:GetMin().x < var_75_0:GetMin().x then
			local var_75_11 = arg_75_0.scrollrect
			local var_75_12 = var_8.HeadIndexToValue(var_75_11, arg_75_4 - 1)
			local var_75_13 = arg_75_0.scrollrect

			var_9.SetNormalizedPosition(var_75_13, var_75_12, 0)
		end
	end
