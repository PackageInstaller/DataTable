...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..msgbox.ShopSingleWindow"))
...
function var_0_1.InitWindow(arg_1_0, arg_1_1, arg_1_2)
	...
	local function var_1_3()
		if arg_1_2 then
			...
			var_2_0(var_2_1, var_2_2, var_3.getConfig(var_2_3, "name"))
		end
	...
	var_4(var_1_1, var_1_2, var_1_3, var_1_10008)

	updateDrop = var_4

	local var_1_4 = arg_1_0.itemTF

	var_4(var_5.Find(var_1_4, "left/IconTpl"), var_1_0)
	...
	if var_1_6 then
		...
		local var_1_9 = var_7(var_8)
		local var_1_10 = var_7.getShipGroup

		pg = var_1_10009

		local var_1_11 = var_1_7(var_1_10(var_1_9, var_1_10009.ship_data_template[var_1_0.id].group_type))

		SetActive = var_7

		var_7(var_1_8:Find("unlocked"), var_1_11)

		SetActive = var_7

		var_7(var_1_8:Find("locked"), not var_1_11)
	end
