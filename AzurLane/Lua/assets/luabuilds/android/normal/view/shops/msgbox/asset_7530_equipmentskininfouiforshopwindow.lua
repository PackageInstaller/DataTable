...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.displayNameTxt = var_2_4(var_2_3, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.displayDescTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	local var_2_11 = var_2.Find(var_2_10, "display/top/bg/infomation/title")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("words_information"))

	setText = var_1

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_2.Find(var_2_12, "display/actions/cancel/upgrade")

	i18n = var_2_12

	var_1(var_2_13, var_2_12("msgbox_text_cancel"))

	setText = var_1

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_2.Find(var_2_14, "display/actions/confirm/change")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("shop_word_exchange"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_5 = var_3.Find(var_3_4, "display/top/btnBack")
	...
	local var_3_9 = var_3.Find(var_3_8, "display/actions/cancel")
	...
	var_1_10001(var_3_7, var_3_9, var_3_10, var_5)
...
function var_0_1.Open(arg_8_0, arg_8_1, arg_8_2)
	...
	if not arg_8_1.getConfig(var_8_0, "commodity_id") then
		var_8_0 = arg_8_1
		var_8_1 = arg_8_1.getConfig(var_8_0, "effect_args")[1]
	end

	onButton = var_8_0

	local var_8_2 = arg_8_0
	local var_8_3 = arg_8_0.confirmBtn

	local function var_8_4()
		pg = var_2_10000

		local var_9_0 = var_2_10000.equip_skin_template[var_8_1].name
	...
	var_8_0(var_8_2, var_8_3, var_8_4, var_1_10008)
	arg_8_0:Show(var_8_1)
...
function var_0_1.UpdateSkinView(arg_10_0, arg_10_1)
	...
	local var_10_5 = var_10_0.Find(var_10_4, "info/display_panel/equip_type/mask/Text")

	table = var_10_4

	var_5(var_10_5, var_10_4.concat(var_10_3, ","))

	onButton = var_5

	local var_10_6 = arg_10_0
	local var_10_7 = arg_10_0.playBtn
	...
	local function var_10_8()
		...
		var_12_1(var_12_0, var_2_10002.ON_ESKIN_PREVIEW, arg_10_1)
	...
	var_5(var_10_6, var_10_7, var_10_8, var_9)

	updateDrop = var_5

	local var_10_9 = var_10_0:Find("info/equip")
	local var_10_10 = {}

	DROP_TYPE_EQUIPMENT_SKIN = var_8
	var_10_10.type = var_8
