...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.resIconTF = var_1_1(var_1_0, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.itemIconTF = var_1_3(var_1_2, var_4(var_1_10005))
	findTF = var_2
	...
	var_2(var_3.Find(var_1_4, "group_locked"), false)
	...
	local var_1_5 = var_3(arg_1_0.tf, "group_locked/Text")

	i18n = var_4

	var_2(var_1_5, var_4("shop_item_unobtained"))

	setActive = var_2

	local var_1_6 = arg_1_0.tf

	var_2(var_3.Find(var_1_6, "limit_time_sell"), false)

	setActive = var_2

	local var_1_7 = arg_1_0.tf

	var_2(var_3.Find(var_1_7, "itemBg/item/icon_bg/slv"), false)

	eachChild = var_2

	local var_1_8 = arg_1_0.tf

	var_2(var_3.Find(var_1_8, "mask/tag"), function(arg_2_0)
	...
	local var_1_10 = var_3.Find(var_1_9, "mask/tag/limit_tag/TextGo/Text")

	i18n = var_1_9

	var_2(var_1_10, var_1_9("quota_shop_good_limit"))

	setScrollText = var_2

	local var_1_11 = arg_1_0.tf
	local var_1_12 = var_3.Find(var_1_11, "mask/tag/sellout_tag/TextGo/Text")

	i18n = var_1_11

	var_2(var_1_12, var_1_11("word_sell_out"))

	setScrollText = var_2

	local var_1_13 = arg_1_0.tf
	local var_1_14 = var_3.Find(var_1_13, "mask/tag/unexchange_tag/TextGo/Text")

	i18n = var_1_13

	var_2(var_1_14, var_1_13("meta_shop_exchange_limit"))

	setScrollText = var_2

	local var_1_15 = arg_1_0.sellEndTag
	local var_1_16 = var_3.Find(var_1_15, "TextGo/Text")

	i18n = var_1_15

	var_2(var_1_16, var_1_15("shop_sell_ended"))

	setScrollText = var_2

	local var_1_17 = arg_1_0.selloutTag
	local var_1_18 = var_3.Find(var_1_17, "TextGo/Text")

	i18n = var_1_17

	var_2(var_1_18, var_1_17("common_sale_out"))

	setScrollText = var_2

	local var_1_19 = arg_1_0.levelTag
	local var_1_20 = var_3.Find(var_1_19, "TextGo/Text")

	i18n = var_1_19

	var_2(var_1_20, var_1_19("shop_charge_level_limit"))
	...
	Vector2 = var_1_21
	var_1_22.offsetMin = var_1_21(2, 2)
	Vector2 = var_3
	...
	Vector2 = var_1_23
	var_1_24.offsetMin = var_1_23(0, 0)
	Vector2 = var_4
