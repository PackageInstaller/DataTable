				...
				if var_1_10006 ~= var_1_10007.SkinShop then
					...
					if var_1_10006 == var_1_10007.SkinShopTimeLimit then
						...
						if var_1_10007 == var_1_10008.SKIN_TYPE_TB then
							...
							var_14_5.mediator = var_1_10011
							NewSkinTBLayer = var_1_10011
							var_14_5.viewComponent = var_1_10011
							var_1_10011 = {
								skinId = var_5.effect_args[1]
							}

							local var_14_6 = var_5.genre

							ShopArgs = var_1_10013
							var_1_10011.timeLimit = var_14_6 == var_1_10013.SkinShopTimeLimit
							var_14_5.data = var_1_10011

							var_1_10007(var_14_4, var_1_10009(var_14_5))
						else
							PaintingShowScene = var_1_10007

							if var_1_10007.GetSkinShowAble(var_1_10006) then
								...
								PaintingShowMediator = var_1_10011
								var_14_8.mediator = var_1_10011
								PaintingShowNewSkinScene = var_1_10011
								var_14_8.viewComponent = var_1_10011
								var_1_10011 = {
									is_shop = true,
									skinId = var_1_10006
								}

								local var_14_9 = var_5.genre

								ShopArgs = var_1_10013
								var_1_10011.timeLimit = var_14_9 == var_1_10013.SkinShopTimeLimit
								var_14_8.data = var_1_10011

								var_1_10007(var_14_7, var_1_10009(var_14_8))
							else
								...
								local var_14_11 = var_1_10009.New
								local var_14_12 = {}

								NewSkinMediator = var_1_10011
								var_14_12.mediator = var_1_10011
								NewSkinLayer = var_1_10011
								var_14_12.viewComponent = var_1_10011

								local var_14_13 = {
									skinId = var_5.effect_args[1]
								}
								local var_14_14 = var_5.genre

								ShopArgs = var_1_10013
								var_14_13.timeLimit = var_14_14 == var_1_10013.SkinShopTimeLimit
								var_14_12.data = var_14_13

								var_1_10007(var_14_10, var_14_11(var_14_12))
							end
						end

						local var_14_15 = arg_14_0.viewComponent

						var_1_10007.OnShopping(var_14_15, var_14_1.id)
						...
						if var_14_0 == var_5.BUY_FURNITURE_DONE then
							...
							if var_14_0 == var_5.LOAD_LAYERS then
								var_14_16 = var_14_1.context.mediator
								NewBackYardShopMediator = var_1_10006

								if var_14_16 == var_1_10006 then
									var_1_10006 = arg_14_0
									var_14_16 = arg_14_0.sendNotification
									PlayerResUI = var_1_10007

									var_14_16(var_1_10006, var_1_10007.HIDE)
								end
							else
								GAME = var_14_16

								if var_14_0 == var_14_16.REMOVE_LAYERS then
									local var_14_17 = var_14_1.context.mediator

									NewBackYardShopMediator = var_1_10006

									if var_14_17 == var_1_10006 then
										local var_14_18 = arg_14_0
										local var_14_19 = arg_14_0.sendNotification

										PlayerResUI = var_1_10007

										var_14_19(var_14_18, var_1_10007.SHOW)
									end
								end
							end
						end
