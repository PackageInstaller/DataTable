...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "got/bottom/scroll/list")
	local var_2_3 = arg_2_0._tf

	arg_2_0.list = var_2_0(var_2_2, var_3.Find(var_2_3, "got/bottom/scroll/list/tpl"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.descTxt = var_2_7(var_2_6, var_3(var_2_3))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.exchagneCnt = var_2_10(var_2_9, var_3(var_2_3))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.consumeCnt = var_2_13(var_2_12, var_3(var_2_3))
	...
	local var_2_16 = var_2.Find(var_2_15, "got/top/exchange/label")

	i18n = var_2_15

	var_1(var_2_16, var_2_15("guild_shop_label_2"))

	setText = var_1

	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_2.Find(var_2_17, "confirm/Text")

	i18n = var_2_17

	var_1(var_2_18, var_2_17("guild_shop_label_3"))

	setText = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_2.Find(var_2_19, "confirm/consume/label")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("guild_shop_label_4"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		if #arg_3_0.selectedList == 0 then
			...
			var_4_1(var_4_0, var_2_10002("guild_shop_must_select_goods"))
...
function var_0_1.OnConfirm(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.ON_GUILD_SHOPPING, arg_6_0.data.id, arg_6_0.selectedList)
...
function var_0_1.Show(arg_7_0, arg_7_1)
	...
	if arg_7_1.type == 4 then
		...
		var_2(var_7_1, var_4("guild_shop_label_5"))
	else
		setText = var_2
		...
		var_2(var_7_2, var_4("guild_shop_label_1"))
	end
...
function var_0_1.UpdateValue(arg_8_0)
	...
	var_8_1(var_4.Find(var_8_2, "got/top/exchange"), arg_8_0.maxCnt ~= 0)
...
function var_0_1.UpdateItem(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_7 = var_11_6(var_11_5, var_10(var_1_10011))
	...
	var_10(var_11_9, var_11_10, var_11_11, var_1_10014)

	pressPersistTrigger = var_10
	...
	var_10(var_11_12, var_11_13, var_11_14, var_11_15, var_11_16, var_11_17, var_11_18, var_1_10018)
	...
	var_10(var_11_19, var_11_20, var_11_21, var_11_22, var_11_23, var_11_24, var_11_25, var_1_10018)

	local var_11_26 = arg_11_3
	local var_11_27 = arg_11_3.Find(var_11_26, "mask")

	setActive = var_11_26

	var_11_26(var_11_27, false)
	var_11_8()
