...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.dailyTaskTxt = var_2_4(var_2_3, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.timeTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.totalCntTxt = var_2_11(var_2_10, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_12 = var_1.New
	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_2.Find(var_2_13, "right/view/content")
	local var_2_15 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_12(var_2_14, var_3.Find(var_2_15, "right/view/content/tpl"))
	...
	local var_2_19 = var_2.Find(var_2_18, "left/bg/Text")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("vote_lable_daily_task_title"))
	...
	var_2(var_3.Find(var_2_22, "left/task/desc/label1"), var_2_21[1])

	setText = var_2

	local var_2_23 = arg_2_0._tf

	var_2(var_3.Find(var_2_23, "left/task/desc/labe2"), var_2_21[2])

	setText = var_2

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "right/title/Text")

	i18n = var_2_24

	var_2(var_2_25, var_2_24("vote_lable_task_title"))

	setText = var_2

	local var_2_26 = arg_2_0.emptyTr
	local var_2_27 = var_3.Find(var_2_26, "Image/Text")

	i18n = var_2_26

	var_2(var_2_27, var_2_26("vote_lable_task_list_is_empty"))
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_2()
		...
		VoteExchangeMediator = var_2_10002

		var_4_1(var_4_0, var_2_10002.GO_TASK)
...
function var_0_1.GetActivity(arg_8_0)
	...
	local var_8_2 = var_8_1(var_8_0, var_1_10003.ACTIVITY_TYPE_VOTE)
	local var_8_3

	ipairs = var_3

	for iter_8_0, iter_8_1 in var_3(var_8_2) do
...
function var_0_1.GetTaskList(arg_10_0)
	...
	if arg_10_0.GetActivity(var_10_0) then
		var_10_0 = var_1.data3

		local var_10_1 = arg_10_0.contextData.voteGroup

		if var_10_0 >= var_3.getConfig(var_10_1, "ticket_period") then
			return {}
		end
	end
	...
	local var_10_2 = arg_10_0.contextData.voteGroup
	local var_10_3 = var_10_0(var_3.getConfig(var_10_2, "task_period"))

	getProxy = var_3
	TaskProxy = var_10_2

	local var_10_4 = var_3(var_10_2)

	for iter_10_0 = #var_10_3, 1, -1 do
		for iter_10_1 = #var_10_3[iter_10_0], 1, -1 do
			local var_10_5 = var_8[iter_10_1]
			local var_10_6 = var_10_4
			local var_10_7

			if not var_10_4.getTaskById(var_10_6, var_10_5) then
				var_10_6 = var_10_4
				var_10_7 = var_10_4.getFinishTaskById(var_10_6, var_10_5)
			end

			if not var_10_7 or var_10_7:isFinish() and var_10_7:isReceive() then
				table = var_10_6

				var_10_6.remove(var_8, iter_10_1)
			end
		end
		...
		if #var_8 <= 0 then
			...
			var_9.remove(var_10_3, iter_10_0)
		end
	end
...
function var_0_1.UpdateTaskDesc(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_0 = var_1_10003(var_1_10004)
	local var_17_1

	if not var_3.getTaskById(var_17_0, arg_17_1) then
		getProxy = var_17_1
		TaskProxy = var_17_0
		var_17_0 = var_17_1(var_17_0)
		var_17_1 = var_17_1.getFinishTaskById(var_17_0, arg_17_1)
	end

	assert = var_17_0

	var_17_0(var_17_1, arg_17_1)

	local var_17_2 = var_17_1:isFinish()
	local var_17_3 = var_17_1:isReceive()
	local var_17_4 = arg_17_2:Find("go")
	local var_17_5 = arg_17_2
	local var_17_6 = arg_17_2.Find(var_17_5, "get")

	setActive = var_17_5

	var_17_5(var_17_4, not var_17_2)

	setActive = var_17_5

	var_17_5(arg_17_2:Find("got"), var_17_2 and var_17_3)

	setActive = var_17_5

	var_17_5(var_17_6, var_17_2 and not var_17_3)

	local var_17_7 = var_17_1
	local var_17_8 = var_17_1.getConfig(var_17_7, "award_display")
	...
	local var_17_9 = var_17_1:getProgress()
	local var_17_10 = var_17_1
	local var_17_11 = var_17_1.getConfig(var_17_10, "target_num")

	setText = var_17_10

	var_17_10(arg_17_2:Find("Text"), var_17_9 .. "/" .. var_17_11)

	setText = var_17_10

	var_17_10(arg_17_2:Find("desc"), var_17_1:getConfig("desc"))

	setFillAmount = var_17_10

	var_17_10(arg_17_2:Find("Slider/Fill"), var_17_9 / var_17_11)
	...
	local function var_17_14()
		...
		var_18_1(var_18_0, var_2_10002.SKIP_TASK, var_17_1)
	...
	var_17_10(var_17_12, var_17_13, var_17_14, var_15)
	...
	local function var_17_17()
		...
		var_19_1(var_19_0, var_2_10002.SUBMIT_TASK, var_17_1.id)
	...
	var_17_10(var_17_15, var_17_16, var_17_17, var_15)
