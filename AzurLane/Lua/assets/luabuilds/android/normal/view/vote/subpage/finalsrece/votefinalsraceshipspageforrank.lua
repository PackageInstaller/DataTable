...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".VoteFinalsRaceShipsPage"))
...
function var_0_1.UpdateTop3(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	local var_3_1 = var_5.Find(var_3_0, "Text")
	...
	if arg_3_1 then
		...
		if not var_8.GetVotes(var_3_3, arg_3_1) then
			var_3_4 = 0
		end

		var_4(var_3_1, var_3_0(var_3_2, var_3_4))
