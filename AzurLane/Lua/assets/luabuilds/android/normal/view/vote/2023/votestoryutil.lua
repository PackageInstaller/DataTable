...
function var_0_0.GetStoryNameByType(arg_1_0)
	...
	if not var_1_1(var_1_0, var_1_10003.VOTE_ENTRANCE_ACT_ID) or var_1:isEnd() then
		return nil
	end
...
function var_0_0.FinalRaceIsEnd()
	...
	for iter_2_0 = #var_1_10000.activity_vote.all, 1, -1 do
		...
		if var_2_1 == var_1_10008.RACE_TYPE_FINAL then
			pg = var_2_1
			var_1_10008 = var_2_1.TimeMgr.GetInstance()

			local var_2_2 = var_7.GetServerTime(var_1_10008)

			pg = var_1_10008

			local var_2_3 = var_1_10008.TimeMgr.GetInstance()

			var_1_10008 = var_1_10008.parseTimeFromConfig(var_2_3, var_1_10006.time_vote[2]) <= var_2_2
...
function var_0_0.AllPreheatStoriesPlayed()
	...
	return var_2.all(var_3_1, function(arg_5_0)
		pg = var_2_10001
...
function var_0_0.Notify(arg_6_0)
	...
	if not var_6_1(var_6_0, var_1_10003.ACTIVITY_TYPE_VOTE) or var_1:isEnd() then
	...
	local var_6_2 = var_1
	local var_6_3 = var_1.getConfig(var_6_2, "config_id")

	pg = var_6_2

	local var_6_4 = var_6_2.activity_vote[var_6_3].type

	VoteConst = var_1_10005

	local var_6_5 = var_6_4 == var_1_10005.RACE_TYPE_PRE
	local var_6_6 = {}
	local var_6_7 = {}

	if arg_6_0 == var_0_0.ENTER_SCENE then
		var_0_0.CollectEnterStory(var_6_5, var_6_6)
		var_0_0.CollectEnterGuide(var_6_5, var_6_7)
	elseif var_6_5 and arg_6_0 == var_0_0.ENTER_MAIN_STAGE then
		var_0_0.CollectEnterMainStory(var_6_6)
	elseif var_6_5 and arg_6_0 == var_0_0.ENTER_SUB_STAGE then
		var_0_0.CollectEnterSubStory(var_6_6)
	elseif var_6_5 and arg_6_0 == var_0_0.ENTER_SCHEDULE then
		var_0_0.CollectEnterScheduleStory(var_6_6)
	elseif var_6_5 and arg_6_0 == var_0_0.ENTER_HALL then
		var_0_0.CollectEnterHallStory(var_6_6)
	elseif var_6_5 and arg_6_0 == var_0_0.ENTER_EXCHANGE then
		var_0_0.CollectEnterExchangeStory(var_6_6)
	end
	...
	var_7({
		...
		function(arg_9_0)
			var_0_0.HandleGuide(var_6_7, arg_9_0)
...
function var_0_0.PreRaceIsEnd()
	...
	for iter_13_0, iter_13_1 in var_1_10001(var_1_10002.activity_vote.all) do
		pg = var_1_10006
...
function var_0_0.CollectEnterGuide(arg_16_0, arg_16_1)
	if arg_16_0 then
		...
		local var_16_1 = var_3.NewStoryMgr.GetInstance()
...
function var_0_0.CollectEnterStory(arg_17_0, arg_17_1)
	if arg_17_0 then
		...
		var_3.insert(arg_17_1, var_17_0)
	else
		local var_17_1 = {
			var_0_0.ENTER_SCENE,
			var_0_0.ENTER_MAIN_STAGE,
		...
		for iter_17_0, iter_17_1 in var_4(var_17_2) do
			table = var_1_10009
...
function var_0_0.GetPrevRaceStories()
	...
	for iter_19_0, iter_19_1 in var_19_1(var_1_10003.activity_template.all) do
		pg = var_1_10007
		...
		if var_19_3 == var_1_10009.ACTIVITY_TYPE_VOTE then
			pg = var_19_3
			var_1_10009 = var_19_3.TimeMgr.GetInstance()

			if var_8.parseTimeFromConfig(var_1_10009, var_1_10007.time[3]) < var_19_2 then
				table = var_8
...
function var_0_0.CollectEnterMainStory(arg_20_0)
	...
	var_2.insert(arg_20_0, var_20_0)
...
function var_0_0.CollectEnterSubStory(arg_21_0)
	...
	var_2.insert(arg_21_0, var_21_0)
...
function var_0_0.CollectEnterScheduleStory(arg_22_0)
	...
	var_2.insert(arg_22_0, var_22_0)
...
function var_0_0.CollectEnterHallStory(arg_23_0)
	...
	var_2.insert(arg_23_0, var_23_0)
...
function var_0_0.CollectEnterExchangeStory(arg_24_0)
	...
	var_2.insert(arg_24_0, var_24_0)
