...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiitemlist = var_2_0(var_2_2, var_3.Find(var_2_3, "content/tpl"))
	...
	local var_2_17 = var_2.Find(var_2_16, "titles/rank_title")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("vote_label_rank"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_2.Find(var_2_18, "tip")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("vote_label_rank_fresh_time_tip"))
...
function var_0_1.UpdateShipInfo(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_3 = arg_7_1.Find(var_7_2, "Text")

	setColorStr = var_7_2
	shortenString = var_9

	var_7_0(var_7_3, var_7_2(var_9(arg_7_2, 9), var_7_1))

	setText = var_7_0

	local var_7_4 = arg_7_1
	local var_7_5 = arg_7_1.Find(var_7_4, "number")

	setColorStr = var_7_4

	var_7_0(var_7_5, var_7_4(arg_7_3, var_7_1))
...
function var_0_1.UpdateTitle(arg_8_0)
	...
	var_8_0(arg_8_0.rankTitle, true)
...
function var_0_1.Update(arg_9_0, arg_9_1)
	...
	var_2(var_9_0, var_9_1 == var_1_10005.VOTE_STAGE)
	...
	var_2(var_9_2, var_9_3 ~= var_5.VOTE_STAGE)
	...
	var_2(var_9_4, var_9_5 == var_5.VOTE_STAGE)
	arg_9_0:UpdateTitle()
