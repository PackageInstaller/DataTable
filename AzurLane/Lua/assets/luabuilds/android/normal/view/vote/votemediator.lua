...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_VOTE, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_1(var_2_0, var_2_10006.ON_NEW_VOTE, {
			voteId = arg_2_1,
			gid = arg_2_2,
			count = arg_2_3
		})
...
function var_0_1.handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_7_1.ON_NEW_VOTE_DONE then
		...
		var_7_5(var_7_4, var_6("vote_success"))
		arg_7_0:DisplayAwards(var_7_2.awards)
	else
		GAME = var_7_5

		if var_7_0 == var_7_5.ACT_NEW_PT_DONE then
			arg_7_0:DisplayAwards(var_7_2.awards)
		end
	end
...
function var_0_1.DisplayAwards(arg_8_0, arg_8_1)
	...
	local function var_8_1()
		...
		var_9_2(var_9_1, var_2_10003.ON_ACHIEVE, var_9_0, function()
			table = var_3_10000
