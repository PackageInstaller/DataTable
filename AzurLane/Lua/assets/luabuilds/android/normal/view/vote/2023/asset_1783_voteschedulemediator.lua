...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_VOTE, function()
		...
		if not var_0.GetOpeningNonFunVoteGroup(var_2_0) then
			...
			var_2_1 = var_2_1.GetOpeningFunVoteGroup(var_2_0)
		end
		...
		local var_2_6 = var_2_10003.GO_SCENE

		SCENE = var_2_10004

		var_2_5(var_2_4, var_2_6, var_2_10004.VOTE, {
			voteGroup = var_2_1
		})
	...
	arg_1_0:bind(var_0_1.FETCH_RANK, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.FETCH_VOTE_RANK, {
			voteId = arg_3_1,
			callback = arg_3_2
		})
	...
	arg_1_0:bind(var_0_1.GO_RANK, function(arg_4_0, arg_4_1)
		...
		var_2_10002({
			...
			ContextMediator = var_3_10004
			var_6_3.mediator = var_3_10004
			VoteRankScene = var_3_10004
