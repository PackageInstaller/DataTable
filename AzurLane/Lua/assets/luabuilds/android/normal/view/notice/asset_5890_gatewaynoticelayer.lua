...
function var_0_1.showNext(arg_6_0)
	...
	if #arg_6_0.notices > 0 then
		...
		local var_6_3 = var_6_1.cancel

		go = var_1_10003

		var_6_3(var_1_10003(arg_6_0.trFrame))
		...
		go = var_1_10003
		var_1_10003 = var_6_4(var_1_10003(arg_6_0.trFrame), 0, 1, 0.3)

		local var_6_5 = var_2.setEase

		LeanTweenType = var_4
		var_1_10003 = var_6_5(var_1_10003, var_4.easeOutBack)

		local var_6_6 = var_2.setOnUpdate

		System = var_4

		var_6_6(var_1_10003, var_4.Action_float(function(arg_7_0)
			...
			Vector3 = var_3
			var_7_0.localScale = var_7_1 + var_3(0.2, 0.2, 0) * arg_7_0

			return
		end))

		pg = var_6_6
		var_1_10003 = var_6_6.CriMgr.GetInstance()

		local var_6_7 = var_2.PlaySoundEffect_V3

		SFX_PANEL = var_4

		var_6_7(var_1_10003, var_4)
	else
		...
		var_6_9(var_6_8, var_1_10003.ON_CLOSE)
...
function var_0_1.willExit(arg_8_0)
	...
	var_8_0(var_1_10002(arg_8_0.trFrame))
