	...
	var_1(arg_2_0.contextData.drop.__cname, {
		Dorm3dGift = function()
			...
			if not var_2.Find(var_3_3, function(arg_4_0, arg_4_1)
				...
				table = var_3
				var_3_4 = var_3.Find(var_3_3, function(arg_5_0)
					if arg_5_0[1] == 0 then
						return true
					end
			...
			var_3_6(var_4.Find(var_3_8, "Window/Title/gift"), true)
		...
		Dorm3dFurniture = function()
			...
			var_6_5(var_1.Find(var_6_6, "Window/Title/furniture"), true)
		...
		Dorm3dSkin = function()
			...
			var_7_2(var_1.Find(var_7_4, "Window/Title/skin"), true)
...
function var_0_1.didEnter(arg_8_0)
	...
	local var_8_2 = var_3.Find(var_8_1, "Window/Confirm")
	...
	local var_8_6 = var_3.Find(var_8_5, "Window/Cancel")
	...
	var_1_10001(var_8_8, var_3.Find(var_8_9, "Mask"), function()
		...
		Dorm3dFurniture = function()
			if arg_8_0.contextData.endTime and var_0 > 0 then
				local function var_13_0(arg_14_0)
					...
					local var_14_2 = var_14_0.max(arg_14_0 - var_14_1, 0)

					math = var_3

					local var_14_3 = var_3.floor(var_14_2 / 0)
					local var_14_4
					...
					if 0 < var_14_3 then
						...
						return var_14_4 .. var_3_10005("word_date")
					else
						math = var_14_4
						...
						if 0 < var_14_5 then
							...
							return var_14_6 .. var_3_10006("word_hour")
						else
							math = var_14_6
							...
							if var_14_6.floor(var_14_2 / 60) > 0 then
								...
								return var_14_7 .. var_3_10007("word_minute")
							else
								local var_14_8 = var_14_2

								i18n = var_3_10007

								return var_14_8 .. var_3_10007("word_second")
							end
						end
					end
				...
				var_13_2.timerRefreshTime = var_2_10004.New(function()
					...
					local var_15_3 = var_15_0 .. var_15_1(var_15_2, var_3_10003("time_remaining_tip"), var_13_0(var_0))

					setText = var_1

					local var_15_4 = arg_8_0._tf

					var_1(var_2.Find(var_15_4, "Window/Content"), var_15_3)
				...
				local var_13_5 = var_13_3.format
				local var_13_6 = "\n<size=28><color=#7c7e81>%s</color><color=#169fff>%s</color></size>"

				i18n = var_6
				var_8_10 = var_13_4 .. var_13_5(var_13_6, var_6("time_remaining_tip"), var_13_0(var_0))
			end
	...
	var_2(var_3.Find(var_8_11, "Window/Content"), var_8_10)

	setText = var_2

	local var_8_12 = arg_8_0._tf
	local var_8_13 = var_3.Find(var_8_12, "Window/Confirm/Text")

	i18n = var_8_12

	var_2(var_8_13, var_8_12("msgbox_text_confirm"))

	setText = var_2

	local var_8_14 = arg_8_0._tf
	local var_8_15 = var_3.Find(var_8_14, "Window/Cancel/Text")

	i18n = var_8_14

	var_2(var_8_15, var_8_14("msgbox_text_cancel"))
...
function var_0_1.InitBanner(arg_16_0)
	for iter_16_0 = 1, #arg_16_0.unlockBanners do
		...
		LoadImageSpriteAsync = var_16_0

		var_16_0("dorm3dbanner/" .. arg_16_0.unlockBanners[iter_16_0], var_16_1)
	end
...
function var_0_1.InitUIList(arg_17_0)
	...
	var_1.make(var_17_0, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventInit then
			...
			local var_18_3 = arg_18_2.Find(var_18_2, "bubble/Text")

			i18n = var_18_2

			var_2_10005(var_18_3, var_18_2("dorm3d_shop_tag" .. var_18_1))
			...
			var_2_10005(arg_17_0, arg_18_2, function(arg_19_0)
				...
				var_3_10001(var_2.Find(var_19_0, "icon/select"), arg_19_0)

				setActive = var_3_10001

				local var_19_1 = arg_18_2

				var_3_10001(var_2.Find(var_19_1, "icon/unselect"), not arg_19_0)

				setActive = var_3_10001

				local var_19_2 = arg_18_2

				var_3_10001(var_2.Find(var_19_2, "bubble"), arg_19_0)
...
function var_0_1.InitDropIcon(arg_20_0)
	...
	local var_20_1 = var_2.GetIcon(var_20_0)
	local var_20_2 = ""
	local var_20_3 = arg_20_0._tf

	var_1_10001(var_20_1, var_20_2, var_4.Find(var_20_3, "Window/Item/Dorm3dIconTpl/icon"), true)
	...
	local var_20_6 = var_4.Rarity2Print
	local var_20_7 = arg_20_0.contextData.drop
	local var_20_8 = var_20_5 .. var_20_6(var_5.GetRarity(var_20_7))
	local var_20_9 = arg_20_0._tf

	var_1_10001(var_20_4, var_20_8, var_4.Find(var_20_9, "Window/Item/Dorm3dIconTpl"))

	setActive = var_1_10001

	local var_20_10 = arg_20_0._tf
	local var_20_11 = var_2.Find(var_20_10, "Window/Item/sp")
	local var_20_12
	...
	if arg_20_0.isSpecial then
		...
		local var_20_14 = var_2.Find(var_20_13, "Window/Item/sp/Text")

		i18n = var_20_13

		var_1(var_20_14, var_20_13("dorm3d_purchase_label_special"))
	elseif arg_20_0.isExclusive then
		setText = var_1

		local var_20_15 = arg_20_0._tf
		local var_20_16 = var_2.Find(var_20_15, "Window/Item/sp/Text")

		i18n = var_20_15

		var_1(var_20_16, var_20_15("dorm3d_purchase_confirm_tip"))
	end
	...
	if arg_20_0.addFavor then
		...
		var_1(var_2.Find(var_20_17, "Window/Item/gift"), true)

		setText = var_1

		local var_20_18 = arg_20_0._tf

		var_1(var_2.Find(var_20_18, "Window/Item/gift/Text"), "+" .. arg_20_0.addFavor)
	end
