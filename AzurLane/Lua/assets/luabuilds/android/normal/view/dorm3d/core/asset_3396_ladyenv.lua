...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.dorm3d.Core.BaseLadyEnv"))
...
function var_0_1.InitCharacterAimIK(arg_4_0)
	...
	typeof = var_1_10003
	HeadAimIK = var_1_10004
	arg_4_0.ladyHeadIKComp = var_4_1(var_4_0, var_1_10003(var_1_10004))
...
function var_0_1.InitCharacterAnimator(arg_5_0)
	...
	arg_5_0.ladyAnimator = var_5_1(var_5_0, var_1_10003(var_1_10004))
...
function var_0_1.InitCharacterHierarchy(arg_6_0)
	...
	DormConst = var_1_10003

	var_6_1(var_1_10003.boneMap, function(arg_7_0, arg_7_1)
	...
	local var_6_4 = var_6_3(var_6_2, var_4(var_1_10005), true)

	table = var_6_2

	var_6_2.IpairsCArray(var_6_4, function(arg_8_0, arg_8_1)
...
function var_0_1.InitCharacterCollider(arg_9_0)
	...
	local var_9_2 = var_2.GetComponentsInChildren

	typeof = var_1_10004
	UnityEngine = var_1_10005

	var_9_0(var_9_2(var_9_1, var_1_10004(var_1_10005.Collider), true), function(arg_10_0, arg_10_1)
		...
		if var_10_1(var_10_0, var_2_10004(var_2_10005.MeshCollider)) then
			return
		end
		...
		if var_2(arg_10_1).name then
			...
			if var_6.BONE_TO_TOUCH[var_10_3] == nil then
				return
			end
...
function var_0_1.InitCharacterCloth(arg_11_0)
	...
	local var_11_2 = var_2.GetComponentsInChildren

	typeof = var_1_10004

	var_11_0(var_11_2(var_11_1, var_1_10004("MagicaCloth2.MagicaCloth"), true), function(arg_12_0, arg_12_1)
		table = var_2_10002
	...
	local var_11_4 = var_2.IpairsCArray
	local var_11_5 = arg_11_0.lady

	var_11_4(var_3.GetComponentsInChildren(var_11_5, var_11_3, true), function(arg_13_0, arg_13_1)
...
function var_0_1.InitCharacterTouchEvent(arg_16_0, arg_16_1)
	...
	local var_16_1 = var_1_10002(var_16_0, var_1_10004(var_1_10005))
	...
	var_2.AddPointClickFunc(var_16_1, function(arg_17_0, arg_17_1)
		if arg_17_1.rawPointerPress.transform == arg_16_0.ladyCollider then
			...
			var_17_1(var_17_0, var_2_10004.CLICK_CHARACTER, arg_16_1)
		end
...
function var_0_1.InitCharacterAnimationEvent(arg_18_0)
	...
	var_1.SetCommonEvent(var_18_1, function(arg_19_0)
		if arg_18_0.nowState then
			...
			if var_1.IsName(var_2_10002, arg_18_0.nowState) then
				existCall = var_1
		...
		for iter_19_0, iter_19_1 in var_2_10002(arg_18_0.animCallbacks) do
			if var_19_0:IsName(iter_19_0) then
				...
				local var_19_1 = var_7.removebykey(arg_18_0.animCallbacks, iter_19_0)
		...
		if arg_19_0.stringParameter ~= "" then
			...
			var_2.Func(var_19_2, "OnAnimationEvent", arg_19_0)
		end
...
function var_0_1.InitCharacterLayer(arg_27_0)
	...
	var_27_0(var_27_1, var_1_10003.Character3D)
...
function var_0_1.InitCharacterController(arg_28_0)
	...
	typeof = var_1_10003
	CharacterController = var_1_10004
	arg_28_0.characterController = var_1_10001(var_28_0, var_1_10003(var_1_10004))
...
function var_0_1.InitCharacterTransparency(arg_29_0)
	...
	typeof = var_1_10003
	CharacterTransparency = var_1_10004
	arg_29_0.transparencyComp = var_1_10001(var_29_0, var_1_10003(var_1_10004))
...
function var_0_1.InitCharacterAnimationDispatcher(arg_30_0)
	...
	typeof = var_1_10003
	DormAnimationEventDispatcher = var_1_10004
	arg_30_0.animationEventDispatcher = var_1_10001(var_30_0, var_1_10003(var_1_10004))
...
function var_0_1.SwitchCharacterSkin(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	var_1_10005(var_1_10006.contains(var_32_0, arg_32_2))
...
function var_0_1.PlaySingleAction(arg_40_0, arg_40_1, arg_40_2, arg_40_3)
	...
	local var_40_7 = var_40_5.detect

	pg = var_8

	local var_40_8

	if not var_8.dorm3d_anim_extraitem.get_id_list_by_ship_id[var_40_6] then
		var_40_8 = {}
	end
	...
	if var_40_7(var_40_8, function(arg_41_0)
		...
		pg = var_40_8
		var_40_8 = var_40_8.dorm3d_anim_extraitem[var_7]
	end

	local var_40_9

	if not arg_40_3 then
		DormConst = var_1_10010
		arg_40_3 = var_1_10010.DEFAULT_ANIM_FADE_IN_TIME
	end
	...
	var_1_10010({
		function(arg_42_0)
			if not var_40_8 or var_40_8.item_prefab == "" then
				arg_42_0()
			...
			local var_42_0 = var_1.lower("dorm3d/furniture/item/" .. var_40_8.item_prefab)
			...
			var_2.GetPrefab(var_42_2, var_42_0, "", function(arg_43_0)
				...
				if var_40_8.item_shield ~= "" then
					var_40_9 = {}
					ipairs = var_1

					for iter_43_0, iter_43_1 in var_1(var_40_8.item_shield) do
						...
						if not var_6.Find(var_43_1, iter_43_1) then
							...
							var_43_1(var_8.format("dorm3d_anim_extraitem:%d without hide item:%s", var_40_8.id, iter_43_1))
						else
							local var_43_2 = var_40_9

							isActive = var_8
							var_43_2[iter_43_1] = var_8(var_6)
							setActive = var_43_2

							var_43_2(var_6, false)
						end
					end
				end
				...
				function arg_40_0.animExtraItemCallback()
					...
					if var_40_9 then
						...
						for iter_44_0, iter_44_1 in var_0(var_40_9) do
							...
							local var_44_3 = var_6.Get(var_44_2, "modelRoot")

							var_4_10005(var_6.Find(var_44_3, iter_44_0), iter_44_1)
						end
					end
		...
		function(arg_45_0)
			...
			if var_45_0 then
				...
				if not var_45_2(var_45_1, var_45_3, var_2_10004.StringToHash(arg_40_1)) then
					errorMsg = var_1
...
function var_0_1.PlayFaceAnim(arg_47_0, arg_47_1, arg_47_2)
	...
	if var_1_10003 then
		...
		if not var_47_1(var_47_0, var_47_2, var_1_10006.StringToHash(arg_47_1)) then
			errorMsg = var_3
...
function var_0_1.MoveToTarget(arg_55_0, arg_55_1, arg_55_2, arg_55_3)
	...
	if var_55_0 ~= var_5.zero then
		...
		local var_55_3 = var_1_10007.Slerp

		var_1_10008 = arg_55_0.lady.rotation

		local var_55_4 = var_55_1

		Time = var_1_10010
		var_55_2.rotation = var_55_3(var_1_10008, var_55_4, var_1_10010.deltaTime * arg_55_3)
	end
	...
	var_55_7(var_55_6, var_55_5 * var_1_10008.deltaTime)
...
function var_0_1.SetCollisible(arg_58_0, arg_58_1)
	...
	local var_58_2 = var_58_1(var_58_0, var_1_10004(var_1_10005.CapsuleCollider))

	if arg_58_1 then
		LayerMask = var_58_0
		var_58_2.excludeLayers = var_58_0.GetMask("Nothing")
		var_58_0 = arg_58_0.characterController
		LayerMask = var_4
		var_58_0.excludeLayers = var_4.GetMask("Nothing")
	else
		LayerMask = var_58_0
		var_58_2.excludeLayers = var_58_0.GetMask("Player")

		local var_58_3 = arg_58_0.characterController

		LayerMask = var_4
		var_58_3.excludeLayers = var_4.GetMask("Player")
	end
