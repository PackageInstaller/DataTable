...
function var_0_1.RegisterEvents(arg_2_0)
	...
	var_2_1(var_2_0, var_3.UPDATE_GAME_STATE, function(arg_8_0, arg_8_1)
		...
		if var_8_0 == var_2_10003.GAME_STATE.PHASE_1 then
			...
			if var_8_2 == var_8_1.GAME_STATE.PHASE_2 then
	...
	var_2_3(var_2_2, var_3.TIMELINE_SEQUENCE_BEGIN, function()
	...
	var_2_5(var_2_4, var_3.TIMELINE_SEQUENCE_END, function()
		setActive = var_2_10000
...
function var_0_1.InitSceneRefs(arg_13_0)
	...
	arg_13_0.characterController = var_13_1(var_13_0, var_1_10003(var_1_10004.CharacterController))
	assert = var_1
...
function var_0_1.InitCameras(arg_14_0)
	...
	for iter_14_0 = 0, arg_14_0.cameraRoot.childCount - 1 do
		...
		typeof = var_1_10011
		Cinemachine = var_1_10012
		var_14_4.virtualCamera = var_14_6(var_14_5, var_1_10011(var_1_10012.CinemachineVirtualCamera))
		...
		typeof = var_1_10011
		Cinemachine = var_1_10012
		var_14_4.freeLook = var_14_8(var_14_7, var_1_10011(var_1_10012.CinemachineFreeLook))
...
function var_0_1.SwitchCameraByName(arg_20_0, arg_20_1)
	...
	local var_20_1 = arg_20_0.GetCameraInfo(var_20_0, arg_20_1)

	assert = var_20_0

	local var_20_2 = var_20_1
	local var_20_3 = "CarWash camera not found: "

	tostring = var_1_10006

	var_20_0(var_20_2, var_20_3 .. var_1_10006(arg_20_1))

	pairs = var_20_0

	for iter_20_0, iter_20_1 in var_20_0(arg_20_0.cameras) do
		setActive = var_1_10008

		var_1_10008(iter_20_1.tf, iter_20_1 == var_20_1)
	end

	arg_20_0.currentCameraName = arg_20_1
	arg_20_0.currentCameraTF = var_20_1.tf

	local var_20_4

	if not var_20_1.virtualCamera then
		var_20_4 = var_20_1.freeLook
	end

	arg_20_0.currentCamera = var_20_4
	arg_20_0.povCamera = var_20_1.virtualCamera

	if arg_20_0.povCamera then
		local var_20_5 = arg_20_0.povCamera
		local var_20_6 = var_3.GetCinemachineComponent

		Cinemachine = var_5

		local var_20_7

		if not var_20_6(var_20_5, var_5.CinemachineCore.Stage.Aim) then
			var_20_7 = nil
		end

		arg_20_0.compPovAim = var_20_7
