...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.IN_ITAR_PHOTO, function()
		...
		Dorm3dPhotoARLayer = var_2_10004
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	Dorm3dPhotoShareLayerMediator = var_6_1

	if var_6_0 == var_6_1.EXIT_SHARE then
		...
		if var_6_0 == var_4.AR_PHOTO_INITED then
			...
			if var_6_0 == var_4.ACTIVE_AR_UI then
				...
				if var_6_0 == var_4.SCENE_CALL then
					local var_6_6 = arg_6_0.viewComponent[var_6_2.name]
					local var_6_7 = arg_6_0.viewComponent

					unpackEx = var_1_10006

					var_6_6(var_6_7, var_1_10006(var_6_2.args))
				end
			end
		end
	end
