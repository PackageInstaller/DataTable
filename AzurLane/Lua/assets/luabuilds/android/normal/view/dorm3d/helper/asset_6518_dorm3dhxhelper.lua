...
function var_0_0.GetTimelineMainCharacter()
	...
	local var_1_2 = var_1_10002.IpairsCArray
	local var_1_3 = var_1_0
	local var_1_4 = var_1_0.GetComponentsInChildren

	typeof = var_1_10005

	var_1_2(var_1_4(var_1_3, var_1_10005("BLHXCharacterPropertiesController")), function(arg_2_0, arg_2_1)
...
function var_0_0.GetSkinIdByModelName(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1(var_2.dorm3d_resource.all) do
		pg = var_1_10006
...
function var_0_0.ReplaceCharacterParts(arg_4_0)
	...
	if not var_2.dorm3d_resource[var_1].hx_component or var_2 == "" or #var_2 == 0 then
		return false
	end
	...
	var_1_10004.each(var_2, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10003(arg_4_0), arg_5_0)
...
function var_0_0.ShowHolyLight(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_1_10004(arg_6_0) do
		if iter_6_1 and var_0_0.GetSkinIdByModelName(iter_6_1.name) then
			...
			if not var_1_10011.dorm3d_holylight.get_id_list_by_skin_id[var_9] then
				var_1_10011 = {}
			end

			for iter_6_2, iter_6_3 in var_10(var_1_10011) do
				table = var_1_10015
				...
				pg = var_1_10018
				var_6_2[2] = var_1_10018.dorm3d_holylight[iter_6_3]
	...
	var_4.StaticAlign(arg_6_1, arg_6_1:GetChild(0), #var_6_0, function(arg_7_0, arg_7_1, arg_7_2)
		...
		typeof = var_2_10007
		HolyLightController = var_2_10008

		local var_7_4 = var_7_3(var_7_2, var_2_10007(var_2_10008))
		...
		Vector3 = var_6
		unpack = var_7
		var_7_4.rotationOffset = var_6(var_7(var_7_1.rotation_offset))
		...
		var_6(var_7_1.texture, "", function(arg_8_0)
			...
			local var_8_2 = var_8_1(var_8_0, var_3_10003(var_3_10004))

			var_8_2.sprite = arg_8_0
			Color = var_8_0

			local var_8_3 = var_8_0.New

			unpack = var_3
			var_8_2.color = var_8_3(var_3(var_7_1.color))
		...
		Vector2 = var_6
		unpack = var_7
		var_7_4.baseSize = var_6(var_7(var_7_1.base_size))
		...
		typeof = var_8
		DormAnimationEventDispatcher = var_9
		var_7_4.targetDispatcher = var_6(var_7_6, var_8(var_9))
	...
	if arg_9_0 then
		...
		if not var_3(arg_9_0) and arg_9_1 then
			...
			for iter_9_0 = 0, arg_9_1.childCount - 1 do
				...
				typeof = var_1_10011
				HolyLightController = var_1_10012

				local var_9_3

				var_9_3 = var_9_2(var_9_1, var_1_10011(var_1_10012)) and var_9.targetBone

				if var_9_3 then
					IsNil = var_1_10011

					if not var_1_10011(var_9_3) then
						var_1_10012 = var_9_3

						if var_9_3.IsChildOf(var_1_10012, arg_9_0) then
							setActive = var_1_10011

							var_1_10011(var_8, arg_9_2)
...
function var_0_0.GetHolyLightScreenShotInfo(arg_10_0)
	...
	for iter_10_0 = 0, arg_10_0.childCount - 1 do
		...
		local var_10_3 = arg_10_0.GetChild(var_10_2, iter_10_0).gameObject

		isActive = var_10_2

		if var_10_2(var_10_3) then
			local var_10_4 = var_10_3
			local var_10_5 = var_10_3.GetComponent

			typeof = var_1_10010
			HolyLightController = var_1_10011

			local var_10_6 = var_10_5(var_10_4, var_1_10010(var_1_10011))
			local var_10_7, var_10_8

			var_10_7, var_10_8, var_1_10010 = var_8.GetScreenShotInfo(var_10_6, nil, nil)

			if var_10_7 then
				table = var_1_10011

				var_1_10011.insert(var_10_0, var_10_8)

				table = var_1_10011

				var_1_10011.insert(var_10_1, var_1_10010)
			end
		end
	end
...
function var_0_0.HideCharacterPart(arg_11_0, arg_11_1, arg_11_2)
	...
	var_4("HideCharacterPart skinId", var_11_0)
	...
	local var_11_3 = var_11_1.GetGroupId(var_11_2)

	if not arg_11_1 then
		getProxy = var_11_2
		ApartmentProxy = var_1_10007

		local var_11_4 = var_11_2(var_1_10007)
		local var_11_5 = var_6.getApartment(var_11_4, var_11_3)

		arg_11_1 = var_6.GetHiddenParts(var_11_5, var_11_0)
	end

	local var_11_6, var_11_7 = var_11_1:GetActiveAndHiddenPartNames(arg_11_1)

	_ = var_8

	var_8.each(var_11_6, function(arg_12_0)
		setActive = var_2_10001

		local var_12_0 = arg_11_0

		var_2_10001(var_2.Find(var_12_0, arg_12_0), true)
	...
	var_8.each(var_11_7, function(arg_13_0)
		...
		var_2_10001(var_2.Find(var_13_0, arg_13_0), false)
