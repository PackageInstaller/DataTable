...
function var_0_1.OnLoaded(arg_2_0)
	...
	UIItemList = var_2_0
	arg_2_0.itemList = var_2_0.New(var_2_1, var_2_1:Find("tpl"))
	...
	var_2.make(var_2_2, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			for iter_3_0 = 1, 2 do
				...
				var_2_10012(var_2_10013.Find(var_3_5, "num_" .. var_3_4 % 10), arg_3_2:Find("num"))
			...
			local var_3_7 = arg_3_2.Find(var_3_6, "content/name")

			if not var_3_2 or not var_3_1.name then
				if var_3_3 then
					i18n = var_3_6

					local var_3_8 = "dorm3d_collect_not_found"

					i18n = var_2_10012

					if not var_3_6(var_3_8, var_2_10012(var_3_1.text)) then
						i18n = var_3_6
						var_3_6 = var_3_6("dorm3d_collect_locked", var_3_1.unlock[2])
					end

					var_8(var_3_7, var_3_6)

					local function var_3_9(arg_4_0)
						setTextColor = var_3_10001

						local var_4_0 = arg_3_2
						local var_4_1 = var_2.Find(var_4_0, "content/name")

						Color = var_4_0

						var_3_10001(var_4_1, var_4_0.NewHex(not var_3_2 and "a9a9a9" or arg_4_0 and "2d1dfc" or "393a3c"))

						eachChild = var_3_10001

						local var_4_2 = arg_3_2

						var_3_10001(var_2.Find(var_4_2, "num"), function(arg_5_0)
							...
							var_4_10001(var_5_0, var_4_10003.NewHex(arg_4_0 and "2d1dfd" or "393a3c"))
					...
					var_3_7(var_3_10, var_3_11, var_3_12, var_2_10013)
					var_3_9()
...
function var_0_1.OnInit(arg_7_0)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10003.__cname)
	...
	if not var_4.dorm3d_collection_template.get_id_list_by_room_id[var_2:GetConfigID()] then
		var_7_4 = {}
	end
	...
	var_7_5(var_7_6, var_5({
		...
		function(arg_9_0)
			...
			return var_9_0(var_2_10002.dorm3d_collection_template[arg_9_0].unlock) and 0 or 1
		end,
		function(arg_10_0)
			return arg_10_0
		end
	...
	local var_7_8 = var_4.Find(var_7_7, "count")

	string = var_7_7

	local var_7_9 = var_7_7.format
	local var_7_10 = "<color=#2d1dfc>%d</color>/%d"

	table = var_7

	var_7_5(var_7_8, var_7_9(var_7_10, var_7.getCount(arg_7_0.unlockDic), #arg_7_0.ids))
	...
	var_3(var_4.GetChild(var_7_12, 0), true)
...
function var_0_1.UpdateDisplay(arg_11_0, arg_11_1, arg_11_2)
	...
	var_1_10005(var_6.Find(var_11_2, "empty"), not var_11_1)
	...
	if not var_11_1 then
		...
		if not var_6.any(var_11_0.model, function(arg_12_0)
			local var_12_0
			...
			local var_11_7 = var_9.Find(var_11_6, "empty")

			i18n = var_11_6

			var_11_4(var_11_7, var_11_6("dorm3d_collect_block_by_furniture", var_11_5))
		else
			setText = var_11_5

			local var_11_8 = arg_11_0.rtInfo
			local var_11_9 = var_8.Find(var_11_8, "empty")

			i18n = var_11_8

			var_11_5(var_11_9, var_11_8("dorm3d_collect_nothing"))
		end
	end
	...
	var_11_10(var_11_11, var_11_1)

	if not var_11_1 then
		return
	end

	GetImageSpriteFromAtlasAsync = var_11_10

	var_11_10("dorm3dcollection/" .. var_11_0.icon, "", var_11_11:Find("icon"), true)

	setText = var_11_10

	var_11_10(var_11_11:Find("name/Text"), var_11_0.name)

	setText = var_11_10

	var_11_10(var_11_11:Find("desc"), var_11_0.desc)

	setActive = var_11_10

	var_11_10(var_11_11:Find("favor"), var_11_0.award > 0)

	if var_11_0.award > 0 then
		pg = var_6

		local var_11_12 = var_6.dorm3d_favor_trigger[var_11_0.award].num

		setText = var_7

		local var_11_13 = var_11_11
		local var_11_14 = var_11_11.Find(var_11_13, "favor/Text")

		i18n = var_11_13

		var_7(var_11_14, var_11_13("dorm3d_collect_favor_plus") .. var_11_12)
	end
