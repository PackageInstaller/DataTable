...
function var_0_0.UpdateDorm3dIcon(arg_1_0, arg_1_1)
	...
	var_3("weaponframes", var_1_0.frame, arg_1_0)

	local var_1_1 = arg_1_0
	local var_1_2 = arg_1_0.Find(var_1_1, "icon")

	GetImageSpriteFromAtlasAsync = var_1_1

	var_1_1(var_1_0.icon, "", var_1_2)

	setText = var_1_1

	var_1_1(arg_1_0:Find("count/Text"), "x" .. var_1_0.count)

	setText = var_1_1

	var_1_1(arg_1_0:Find("name/Text"), var_1_0.name)
