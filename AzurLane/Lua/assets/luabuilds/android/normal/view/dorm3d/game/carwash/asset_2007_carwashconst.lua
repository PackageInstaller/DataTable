...
bit = var_2
var_0_0.EFFECT_LAYER_MASK = var_0_1(var_2.bor(var_0_0.DECAL_LAYER_MASK, var_0_0.PLAYER_LAYER_MASK))
...
function var_0_0.GetDefaultSystemClasses()
	...
	CarWashGameFlowSystem = var_1_10002
	var_5_1[1] = var_1_10002
...
function var_0_0.InitGunConfig(arg_10_0)
	...
	var_10_2.onCar = var_1_10004.WATER
	DecalType = var_4
...
function var_0_0.InitDecalConfig(arg_11_0)
	...
	DecalType = var_1_10003

	if var_1_10001(var_11_0, var_1_10003.BUBBLE) then
		return
	end
...
function var_0_0.InitStainsConfig(arg_12_0)
	...
	if var_1_10001(var_12_0, var_1_10003.DIRT) then
		return
	end
