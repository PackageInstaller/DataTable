...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_6()
		if arg_3_0.frameDic[arg_3_0.selectFrameId] then
			...
			if var_5_1.dorm3d_camera_photo_frame[arg_3_0.selectFrameId].frameTfName == "WoodFrame" then
	...
	var_1_10002(var_3_7, var_4.Find(var_3_8, "Mask"), function()
	...
	local function var_3_11()
		...
		Dorm3dPhotoShareLayerMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.EXIT_SHARE)
	...
	var_1_10002(var_3_9, var_3_10, var_3_11, var_6)
	...
	var_1_10002(arg_3_0, arg_3_0.frameBtn, function()
		...
		var_8_1(var_8_0, var_2_10002.SELECTFRAME, arg_3_0.contextData.photoTex, arg_3_0.contextData.photoData)
...
function var_0_1.LoadFrame(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local function var_13_2(arg_14_0)
		...
		local var_14_2 = var_14_1(var_14_0, var_2_10004(var_2_10005))
		...
		if arg_13_3 then
			...
			for iter_14_0, iter_14_1 in var_7(var_14_4) do
				...
				local var_14_9 = var_14_8(var_14_7, var_2_10015(var_2_10016))

				var_14_9.texture = arg_13_0.contextData.photoTex
				GameObject = var_14
				var_2_10015 = var_14.Find("OverlayCamera").transform

				local var_14_10 = var_14.GetChild(var_2_10015, 0)

				if var_13_1 and iter_14_1 == "mask_up/realImage" then
					Vector2 = var_2_10015
					var_12.sizeDelta = var_2_10015(var_14_10.sizeDelta.x / 10, var_14_10.sizeDelta.y / 10)
				else
					var_12.sizeDelta = var_14_10.sizeDelta
				end

				var_2_10015 = var_14_5[iter_14_0]
				setAnchoredPosition = var_2_10016

				var_2_10016(var_14_9, {
					x = arg_13_3[var_2_10015].x,
					y = arg_13_3[var_2_10015].y
				})
	...
	var_13_5(var_13_4, var_13_6, var_13_7, var_1_10014.Events.UnityAction_UnityEngine_Object(function(arg_15_0)
		...
		var_15_3(var_15_2, var_4(var_2_10005)).enabled = false
		...
		var_15_5(var_15_4, var_5(var_2_10006)).enabled = false
		...
		if var_15_6 then
			...
			var_15_9(var_15_8, var_2_10008(var_2_10009)).enabled = false
		end
		...
		if var_15_7 then
			...
			typeof = var_2_10008
			PinchZoom = var_2_10009
			var_15_11(var_15_10, var_2_10008(var_2_10009)).enabled = false
		end
...
function var_0_1.TakePhoto(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	...
	var_1_10009.each(var_16_3.hidden_comps, function(arg_17_0)
		...
		if not var_2(var_17_0) and var_17_0.activeSelf then
			table = var_2
	...
	var_9.each(var_16_3.show_comps, function(arg_18_0)
		...
		if not var_2(var_18_0) and not var_18_0.activeSelf then
			table = var_2
	...
	local var_16_6 = var_16_5(var_16_4, var_11(var_12)).transform
	...
	local function var_16_8(arg_20_0)
		...
		local var_20_7 = arg_20_0:GetPixels(var_20_5, var_20_6, var_20_1, var_20_3)

		var_20_4:SetPixels(var_20_7)
		var_20_4:Apply()

		if not arg_16_4 then
			Tex2DExtension = var_7

			local var_20_8 = var_7.EncodeToPNG(var_20_4)

			YSNormalTool = var_8

			var_8.MediaTool.SaveImageWithBytes(var_20_8, function(arg_24_0, arg_24_1)
				if arg_24_0 then
					pg = var_3_10002
					...
					var_24_1(var_24_0, var_3_10004("word_save_ok"))
				end
		...
		local var_20_9 = arg_16_4.x / var_16_7.sizeDelta.x

		Screen = var_8

		local var_20_10 = var_20_9 * var_8.width
		local var_20_11 = arg_16_4.y / var_16_7.sizeDelta.y

		Screen = var_9

		local var_20_12 = var_20_11 * var_9.height
		local var_20_13 = var_20_1 - var_20_10
		local var_20_14 = var_20_3 - var_20_12
		local var_20_15 = var_20_4:GetPixels(var_20_13 / 2, var_20_14 / 2, var_20_10, var_20_12)
		local var_20_16 = arg_16_3

		var_12.SetPixels(var_20_16, var_20_13 / 2, var_20_14 / 2, var_20_10, var_20_12, var_20_15)

		Tex2DExtension = var_12

		local var_20_17 = var_12.EncodeToPNG(arg_16_3)

		YSNormalTool = var_13

		var_13.MediaTool.SaveImageWithBytes(var_20_17, function(arg_25_0, arg_25_1)
			if arg_25_0 then
				pg = var_3_10002
				...
				var_25_1(var_25_0, var_3_10004("word_save_ok"))
			end
	...
	var_12.Rendering.HotUpdate.ScreenShooterPass.TakePhoto(var_9, var_16_8)
