...
function var_0_1.init(arg_2_0)
	...
	local var_2_7 = var_2_5.Find(var_2_6, "Unfit/Icon/Text")

	i18n = var_2_6

	var_3(var_2_7, var_2_6("dorm3d_furniture_unfit"))

	setText = var_3

	local var_2_8 = var_2_5
	local var_2_9 = var_2_5.Find(var_2_8, "Lack/Icon/Text")

	i18n = var_2_8

	var_3(var_2_9, var_2_8("ryza_tip_control_buff_not_obtain"))
...
function var_0_1.didEnter(arg_5_0)
	...
	if var_3.GetAttachedFurnitureName(var_5_2) then
		...
		var_5_2.Ipairs(var_5_1, function(arg_8_0, arg_8_1)
	...
	local var_5_5 = var_6.Find(var_5_4, "Right/Panel/Container/Zone/ZoneContainer/Switch")
	...
	var_5_2(var_5_3, var_5_5, var_5_6, var_8)

	setActive = var_5_2

	local var_5_7 = arg_5_0._tf

	var_5_2(var_5.Find(var_5_7, "Right/Panel/Container/Zone/ZoneContainer/Switch/New"), false)
	...
	var_5_2(var_5_8, var_6.Find(var_5_9, "Mask"), function()
		setActive = var_2_10000
	...
	var_5_2(var_5_10, var_6.Find(var_5_11, "Top/Back"), function()
	...
	local var_5_14 = var_6.Find(var_5_13, "Right/Save")
	...
	var_5_2(var_5_12, var_5_14, var_5_15, var_8)
	...
	local function var_5_16(arg_13_0)
		...
		typeof = var_3
		Image = var_2_10004
		var_13_2(var_13_1, var_3(var_2_10004)).raycastTarget = not arg_13_0
		...
		local var_13_6 = var_13_5(var_13_4, var_3(var_2_10004))
	...
	typeof = var_7
	Image = var_8
	var_5_19(var_5_18, var_7(var_8)).raycastTarget = false
	...
	local var_5_23 = var_5_22(var_5_21, var_7(var_8))
	...
	local var_5_26 = var_7.Find(var_5_25, "Right/Popup")
	...
	var_5_23(var_5_24, var_5_26, var_5_27, var_9)

	onButton = var_5_23

	local var_5_28 = arg_5_0
	local var_5_29 = arg_5_0._tf
	local var_5_30 = var_7.Find(var_5_29, "Right/Collapse")
	...
	var_5_23(var_5_28, var_5_30, var_5_31, var_9)

	onButton = var_5_23

	local var_5_32 = arg_5_0
	local var_5_33 = arg_5_0._tf
	local var_5_34 = var_7.Find(var_5_33, "Right/Auto")
	...
	var_5_23(var_5_32, var_5_34, var_5_35, var_9)
...
function var_0_1.Update(arg_24_0)
	if arg_24_0.labelSettings then
		...
		setLocalPosition = var_24_4

		var_24_4(arg_24_0.lableTrans, var_24_5)
	end
...
function var_0_1.UpdateDataZone(arg_25_0)
	...
	if var_5.any(arg_25_0:GetDisplayFurnitures(nil), function(arg_28_0)
		...
		local var_25_4 = var_6.insert
		local var_25_5 = arg_25_0.activeFurnitureTypes

		Dorm3dFurniture = var_8

		var_25_4(var_25_5, var_8.TYPE.SPECIAL)
	end
...
function var_0_1.FilterDataFurnitures(arg_39_0)
	...
	var_39_1(var_39_2, var_1_10004(var_39_0))
...
function var_0_1.InitViewZoneList(arg_44_0)
	...
	local var_44_3 = var_3.Find(var_44_2, "List")
	local var_44_4 = arg_44_0.zoneList
	local var_44_5 = var_4.Find(var_44_4, "List")

	var_44_1(var_44_3, var_4.GetChild(var_44_5, 0), #var_44_0, function(arg_45_0, arg_45_1, arg_45_2)
		...
		var_4(arg_45_2:Find("Name"), var_3:GetName())
		...
		var_4(var_45_1, var_45_2, var_45_3, var_2_10008)
...
function var_0_1.InitViewTypeList(arg_47_0)
	...
	local var_47_2 = var_2.Find(var_47_1, "Right/Panel/Container/Types")
	local var_47_3 = arg_47_0._tf
	local var_47_4 = var_3.Find(var_47_3, "Right/Panel/Container/Types")

	var_47_0(var_47_2, var_3.GetChild(var_47_4, 0), #arg_47_0.activeFurnitureTypes, function(arg_48_0, arg_48_1, arg_48_2)
		UIItemList = var_2_10003
		...
		local var_48_2 = arg_48_2.Find(var_48_1, "Name")

		i18n = var_48_1
		Dorm3dFurniture = var_7

		var_2_10004(var_48_2, var_48_1(var_7.TYPE2NAME[var_48_0]))

		onButton = var_2_10004

		local var_48_3 = arg_47_0
		local var_48_4 = arg_48_2
		...
		var_2_10004(var_48_3, var_48_4, var_48_5, var_2_10008)
...
function var_0_1.UpdateView(arg_50_0)
	...
	var_1_10003(var_4.Find(var_50_1, "Right/Panel/Container/Zone/ZoneContainer/Name"), var_50_0:GetName())

	UIItemList = var_1_10003

	local var_50_2 = var_1_10003.StaticAlign
	local var_50_3 = arg_50_0.zoneList
	local var_50_4 = var_4.Find(var_50_3, "List")
	local var_50_5 = arg_50_0.zoneList
	local var_50_6 = var_5.Find(var_50_5, "List")

	var_50_2(var_50_4, var_5.GetChild(var_50_6, 0), #var_1, function(arg_51_0, arg_51_1, arg_51_2)
		UIItemList = var_2_10003
		...
		local var_51_2 = var_51_1(var_51_0, var_5(var_2_10006)).color
	...
	;(function()
		...
		var_2_10001.Ipairs(arg_50_0.normalZones, function(arg_53_0, arg_53_1)
			...
			local var_53_2 = var_4.Find(var_53_1, "List")
			local var_53_3 = var_4.GetChild(var_53_2, arg_53_0 - 1)

			var_3(var_4.Find(var_53_3, "New"), var_53_0)
		...
		var_1(var_2.Find(var_52_1, "Right/Panel/Container/Zone/ZoneContainer/Switch/New"), var_52_0)
	...
	var_5(var_6.Find(var_50_9, "Right/Panel/Container/Types"), #arg_50_0.activeFurnitureTypes > 1)

	UIItemList = var_5

	local var_50_10 = var_5.StaticAlign
	local var_50_11 = arg_50_0._tf
	local var_50_12 = var_6.Find(var_50_11, "Right/Panel/Container/Types")
	local var_50_13 = arg_50_0._tf
	local var_50_14 = var_7.Find(var_50_13, "Right/Panel/Container/Types")

	var_50_10(var_50_12, var_7.GetChild(var_50_14, 0), #arg_50_0.activeFurnitureTypes, function(arg_56_0, arg_56_1, arg_56_2)
		UIItemList = var_2_10003
		...
		local var_56_3 = var_56_1(var_5.GetSlots(var_56_2), function(arg_57_0)
			_ = var_3_10001
		...
		var_5(arg_56_2:Find("New"), var_56_3)
	...
	if arg_50_0.selectSlotId then
		...
		Dorm3dFurniture = var_50_24

		if var_50_25 ~= var_50_24.TYPE.DECORATION then
			local var_50_26 = var_10
			local var_50_27 = var_10.GetType(var_50_26)

			Dorm3dFurniture = var_50_26

			if var_50_27 == var_50_26.TYPE.SPECIAL then
				local var_50_28 = arg_50_0.room
				local var_50_29 = var_11.GetFurnitures(var_50_28)

				_ = var_50_28

				if var_50_28.detect(var_50_29, function(arg_64_0)
			...
			local var_50_30 = arg_50_0.scene
			local var_50_31 = var_10.DisplayFurnitureSlots

			_ = var_12

			var_50_31(var_50_30, var_12.map(var_50_22, function(arg_65_0)
				return arg_65_0:GetConfigID()
			end))

			local var_50_32 = arg_50_0.scene

			var_10.UpdateDisplaySlots(var_50_32, var_50_18)

			local var_50_33 = arg_50_0.scene

			var_10.RefreshSlots(var_50_33, arg_50_0.room)
...
function var_0_1.UpdateViewFurnitureItem(arg_66_0, arg_66_1)
	...
	local var_66_4 = var_66_2.Find(var_66_3, "Item/Dorm3dIconTpl")

	Drop = var_66_3

	local var_66_5 = var_66_3.New
	local var_66_6 = {}

	DROP_TYPE_DORM3D_FURNITURE = var_1_10009
	var_66_6.type = var_1_10009
	var_66_6.id = var_66_1.id
	var_66_6.count = var_66_1.count

	var_5(var_66_4, var_66_5(var_66_6))

	setText = var_5

	local var_66_7 = var_66_2:Find("Item/Name")
	local var_66_8 = var_66_1.template

	var_5(var_66_7, var_7.GetName(var_66_8))

	i18n = var_5

	local var_66_9 = var_5("dorm3d_furniture_count", var_66_1.useable .. "/" .. var_66_1.count)

	if var_66_1.useable < var_66_1.count then
		i18n = var_6
		var_66_9 = var_6("dorm3d_furniture_used") .. var_66_9
	elseif var_66_1.count == 0 then
		i18n = var_6
		var_66_9 = var_6("dorm3d_furniture_lack") .. var_66_9
	end

	setText = var_6

	var_6(var_66_2:Find("Item/Count"), var_66_9)
	...
	local var_66_10 = var_66_1.template
	local var_66_11 = var_6.IsValuable(var_66_10)
	local var_66_12 = var_66_1.template
	local var_66_13 = var_7.IsSpecial(var_66_12)
	local var_66_14 = 0

	if var_66_13 then
		var_66_14 = 2
	elseif var_66_11 then
		var_66_14 = 1
	end

	setActive = var_9

	var_9(var_66_2:Find("Item/BG/Pro"), var_66_14 == 1)

	setActive = var_9

	var_9(var_66_2:Find("Item/LabelPro"), var_66_14 == 1)

	setActive = var_9

	var_9(var_66_2:Find("Item/BG/SP"), var_66_14 == 2)

	setActive = var_9

	var_9(var_66_2:Find("Item/LabelSP"), var_66_14 == 2)

	setActive = var_9

	var_9(var_66_2:Find("Item/Action"), false)

	local var_66_15 = var_66_1.template
	local var_66_16 = var_9.GetEndTime(var_66_15)

	if var_66_1.count == 0 and 0 < var_66_16 then
		pg = var_10

		local var_66_17 = var_10.TimeMgr.GetInstance()
		local var_66_18

		if not (var_66_16 > var_10.GetServerTime(var_66_17)) then
			var_66_18 = false
		else
			var_66_18 = true
		end
		...
		var_66_17(var_66_2:Find("TimeLimit"), var_66_18)

		if var_66_18 then
			setText = var_66_17

			local var_66_19 = var_66_2
			local var_66_20 = var_66_2.Find(var_66_19, "TimeLimit/Text")

			skinCommdityTimeStamp = var_66_19

			var_66_17(var_66_20, var_66_19(var_66_16))
		end

		onButton = var_66_17

		local var_66_21 = arg_66_0
		local var_66_22 = var_66_2:Find("Item/Tip")

		local function var_66_23()
			local var_67_0 = arg_66_0
			local var_67_1 = var_0.emit

			Dorm3dFurnitureSelectMediator = var_2_10002

			local var_67_2 = var_2_10002.SHOW_FURNITURE_ACESSES
			local var_67_3 = {
				showGOBtn = true
			}

			i18n = var_2_10004
			var_67_3.title = var_2_10004("courtyard_label_detail")

			local var_67_4 = {}

			DROP_TYPE_DORM3D_FURNITURE = var_5
			var_67_4.type = var_5
			...
			var_67_3.list = var_4.GetAcesses(var_67_5)
		...
		var_66_17(var_66_21, var_66_22, var_66_23, var_15)

		local var_66_24 = var_66_1.count
		local var_66_25 = 0 < var_66_24 and not var_66_1.viewedFlag

		setActive = var_12

		var_12(var_66_2:Find("Item/New"), var_66_25)
		...
		var_12(arg_66_0, var_66_2, function()
			if var_66_1.count > 0 then
				...
				var_0(var_1.Find(var_68_0, "Item/New"), false)
		...
		if var_66_1.count == 0 then
			local var_66_26 = var_66_1.template
			local var_66_27

			if not var_12.GetShopID(var_66_26) then
				var_66_27 = 0
			end

			setActive = var_66_26

			var_66_26(var_66_2:Find("GO"), var_66_27 ~= 0)

			if var_66_27 ~= 0 then
				CommonCommodity = var_66_26

				local var_66_28 = var_66_26.New
				local var_66_29 = {
					id = var_66_27
				}
				...
				local var_66_30 = var_66_28(var_66_29, var_15.TYPE_SHOPSTREET)
				local var_66_31, var_66_32, var_66_33 = var_13.GetPrice(var_66_30)

				Drop = var_1_10017

				local var_66_34 = var_1_10017.New
				local var_66_35 = {}

				DROP_TYPE_RESOURCE = var_1_10019
				var_66_35.type = var_1_10019
				...
				local var_66_37 = var_66_35.shop_template[var_66_27]

				onButton = var_19

				local var_66_38 = arg_66_0
				local var_66_39 = var_66_2:Find("GO")

				local function var_66_40()
					...
					local var_69_4 = var_2_10003.SHOW_SHOPPING_CONFIRM_WINDOW
					local var_69_5 = {}
					local var_69_6 = {}
					local var_69_7 = "<icon name="
					local var_69_8 = var_0

					var_69_6.icon = var_69_7 .. var_7.GetResIcon(var_69_8) .. " w=1.1 h=1.1/>"
					...
					var_69_6.name = var_6.GetName(var_69_9)
					...
					function var_69_5.onYes()
						...
						if not var_0.InShopTime(var_70_0) then
							...
							var_70_2(var_70_1, var_3_10002("dorm3d_purchase_outtime"))
						...
						var_70_4(var_70_3, var_3_10002.SHOPPING, {
							silentTip = true,
							count = 1,
							shopId = var_66_27
						})
				...
				var_19(var_66_38, var_66_39, var_66_40, var_23)
			end
...
function var_0_1.AutoReplaceFurniture(arg_74_0)
	...
	var_74_0.each(var_74_1, function(arg_75_0)
		...
		local var_75_1 = arg_75_0.GetType(var_75_0)

		Dorm3dFurniture = var_75_0

		if var_75_1 ~= var_75_0.TYPE.FLOOR then
			local var_75_2 = arg_75_0
			local var_75_3 = arg_75_0.GetType(var_75_2)

			Dorm3dFurniture = var_75_2

			if var_75_3 == var_75_2.TYPE.WALLPAPER then
				return
			end

			local var_75_4 = arg_74_0.room
			local var_75_5 = var_1.GetFurnitures(var_75_4)

			_ = var_75_4

			if var_75_4.detect(var_75_5, function(arg_76_0)
			...
			local var_75_6 = var_3.shallowCopy(var_75_5)
			local var_75_7 = {
				function(arg_77_0)
					local var_77_1
			...
			local var_75_8 = var_4.sort
			local var_75_9 = var_75_6

			CompareFuncs = var_2_10006

			var_75_8(var_75_9, var_2_10006(var_75_7))

			if not var_75_6[1] or var_4:GetSlotID() ~= 0 or not arg_75_0:CanUseFurniture(var_4) then
				return
			end

			local var_75_10 = arg_74_0.room

			var_5.ReplaceFurniture(var_75_10, arg_75_0:GetConfigID(), var_4:GetConfigID())
...
function var_0_1.ShowReplaceWindow(arg_80_0, arg_80_1, arg_80_2)
	...
	Dorm3dFurnitureSelectMediator = var_1_10006

	local var_80_2 = var_1_10006.SHOW_CONFIRM_WINDOW
	local var_80_3 = {}

	i18n = var_1_10008
	var_80_3.title = var_1_10008("title_info")
	i18n = var_8
	var_80_3.content = var_8("dorm3d_furniture_sure_save")
	...
	function var_80_3.onYes()
		...
		local var_81_2 = var_2_10002.APARTMENT_REPLACE_FURNITURE
		local var_81_3 = {}
		local var_81_4 = arg_80_0.room

		var_81_3.roomId = var_4.GetConfigID(var_81_4)
...
function var_0_1.onBackPressed(arg_82_0)
	...
	var_1_10001({
		...
		function(arg_84_0)
			...
			var_2_10001(var_84_0, var_2_10003(var_2_10004)).alpha = 0
