...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OPEN_DETAIL, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		Dorm3dShopDetailWindow = var_2_10008
		var_2_3.viewComponent = var_2_10008
		Dorm3dShopDetailMediator = var_2_10008
	...
	var_1_1(var_1_0, var_3.SHOPPING, function(arg_5_0, arg_5_1)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.UPDATED then
		...
		var_4.ShowResUI(var_8_3)
	else
		GAME = var_4

		local var_8_5

		if var_8_0 == var_4.SHOPPING_DONE then
			local var_8_4 = arg_8_1

			var_8_5 = arg_8_1.getBody(var_8_4).awards
			ipairs = var_8_4
			...
			if var_8_0 == var_8_5.APARTMENT_ROOM_INVITE_UNLOCK_DONE then
