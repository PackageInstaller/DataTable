...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.CHANGE_CARE, function(arg_2_0, arg_2_1, arg_2_2)
		...
		local var_2_2 = var_2_10005.APARTMENT_CHAT_OP
		local var_2_3 = {}

		Dorm3dChatProxy = var_2_10007
		var_2_3.operation = var_2_10007.APARTMENT_CHAT_SET_CARE
	...
	arg_1_0:bind(var_0_1.REPLY, function(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
		...
		local var_3_2 = var_2_10007.APARTMENT_CHAT_OP
		local var_3_3 = {
			isRedPacket = false
		}

		Dorm3dChatProxy = var_2_10009
		var_3_3.operation = var_2_10009.APARTMENT_CHAT_REPLY
	...
	arg_1_0:bind(var_0_1.GET_REDPACKET, function(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
		...
		local var_4_2 = var_2_10007.APARTMENT_CHAT_OP
		local var_4_3 = {
			isRedPacket = true
		}

		Dorm3dChatProxy = var_2_10009
		var_4_3.operation = var_2_10009.APARTMENT_CHAT_REPLY
	...
	arg_1_0:bind(var_0_1.SET_CURRENT_TOPIC, function(arg_5_0, arg_5_1, arg_5_2)
		...
		local var_5_2 = var_2_10005.APARTMENT_CHAT_OP
		local var_5_3 = {}

		Dorm3dChatProxy = var_2_10007
		var_5_3.operation = var_2_10007.APARTMENT_CHAT_SET_TOPIC
	...
	arg_1_0:bind(var_0_1.SET_CURRENT_BACKGROUND, function(arg_6_0, arg_6_1, arg_6_2)
		...
		local var_6_2 = var_2_10005.APARTMENT_CHAT_OP
		local var_6_3 = {}

		Dorm3dChatProxy = var_2_10007
		var_6_3.operation = var_2_10007.APARTMENT_CHAT_SET_SKIN
	...
	arg_1_0:bind(var_0_1.SET_READED, function(arg_7_0, arg_7_1, arg_7_2)
		...
		local var_7_2 = var_2_10005.APARTMENT_CHAT_OP
		local var_7_3 = {}

		Dorm3dChatProxy = var_2_10007
		var_7_3.operation = var_2_10007.APARTMENT_CHAT_SET_READTIP
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.APARTMENT_CHAT_OP_DONE then
		getProxy = var_4
		Dorm3dChatProxy = var_1_10005

		local var_9_3 = var_4(var_1_10005)
		local var_9_4 = false
		local var_9_5 = false
		...
		if var_9_2.operation == var_9_3.APARTMENT_CHAT_REPLY then
			if var_9_2.awards ~= nil then
				...
				var_7.SetEndAniEvent(var_9_6, arg_9_0.viewComponent.redPacketGot, function()
					...
					var_10_1(var_10_0, var_2_10002.ON_ACHIEVE, var_9_2.awards)
		...
		if var_9_2.operation == var_9_3.APARTMENT_CHAT_REPLY then
			if var_9_2.awards ~= nil then
				...
				local var_9_12 = var_9_11(var_9_10, var_9(var_10))
