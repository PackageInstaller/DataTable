...
function var_0_1.didEnter(arg_7_0)
	...
	var_2(var_3.Find(var_7_1, "panel/name/Text"), var_7_0.name)

	setText = var_2

	local var_7_2 = arg_7_0._tf

	var_2(var_3.Find(var_7_2, "panel/desc/content/desc"), var_7_0.desc)
	...
	if var_7_0.award > 0 then
		...
		local var_7_5 = var_4.Find(var_7_4, "panel/favor/Text")

		i18n = var_7_4

		var_3(var_7_5, var_7_4("dorm3d_collect_favor_plus") .. var_7_3)

		setActive = var_3

		local var_7_6 = arg_7_0._tf

		var_3(var_4.Find(var_7_6, "panel/favor"), arg_7_0.contextData.isNew)
	else
		setActive = var_7_3

		local var_7_7 = arg_7_0._tf

		var_7_3(var_3.Find(var_7_7, "panel/favor"), false)
	end
	...
	var_7_3(var_3.Find(var_7_8, "panel/icon"), arg_7_0.iconSprite, true)
	...
	var_7_9(var_7_10, var_4.Action(function()
