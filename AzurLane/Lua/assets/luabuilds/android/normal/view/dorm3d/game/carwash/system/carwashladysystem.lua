...
function var_0_1.RegisterEvents(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10003.UPDATE_LADY_POS, function(arg_3_0, arg_3_1)
	...
	var_2_5(var_2_4, var_3.UPDATE_IS_SHOOTING, function(arg_5_0, arg_5_1)
	...
	var_2_7(var_2_6, var_3.UPDATE_COMMON_RAYCAST, function(arg_6_0, arg_6_1)
	...
	var_2_9(var_2_8, var_3.UPDATE_GAME_STATE, function(arg_7_0, arg_7_1)
	...
	var_2_11(var_2_10, var_3.TIMELINE_SEQUENCE_BEGIN, function()
		pg = var_2_10000
		...
		var_9_0(var_9_1, var_2_10002.UIHidden)
	...
	var_2_13(var_2_12, var_3.TIMELINE_SEQUENCE_END, function()
		pg = var_2_10000
		...
		var_10_0(var_10_1, var_2_10002.Character3D)
		...
		var_10_2(var_10_3, var_2.CameraRT)
...
function var_0_1.InitLady(arg_14_0)
	...
	arg_14_0.ladyAnimator = var_14_1(var_14_0, var_1_10003(var_1_10004))
	...
	var_14_5(var_14_6, var_3.Character3D)
	...
	var_14_7(var_14_8, var_3.CameraRT)
...
function var_0_1.InitColliderMap(arg_16_0)
	...
	local var_16_2 = var_16_1(var_16_0, var_1_10003(var_1_10004.Collider), true)
...
function var_0_1.OnLadyPosChanged(arg_18_0, arg_18_1)
	...
	var_18_0(var_18_1, "CarWash lady position node not found: " .. arg_18_0.posConfig.pos)

	setParent = var_18_0

	var_18_0(arg_18_0.ladyTransform, var_18_1)
	...
	if arg_18_0.posConfig.hit_reaction_layer and arg_18_0.posConfig.hit_reaction_layer ~= "" then
		...
		typeof = var_5
		BLHXHitReaction = var_6
		arg_18_0.hitReactionComp = var_18_4(var_18_3, var_5(var_6))
		setActive = var_18_4
...
function var_0_1.OnCharacterHit(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	if arg_25_3 and arg_25_0:CanTriggerReactionAnim() and arg_25_0:GetTriggerAnim(arg_25_3) ~= "" then
		arg_25_0:PlayReactionAnim(var_5, function()
			...
			var_26_1(var_26_0, var_2_10002.MODIFY_HEART_BEAT_VALUE, arg_25_3.mood_value_plus)

			local var_26_2 = arg_25_0
			local var_26_3 = var_0.Emit

			CarWashMainPage = var_2

			local var_26_4 = var_2.SHOW_EXPRESSION_HUD

			CarWashMainPage = var_3

			var_26_3(var_26_2, var_26_4, var_3.EXPRESSION_TYPE.LIKE)
...
function var_0_1.IsMainCameraOnLeftSide(arg_27_0)
	...
	var_3(var_1_10004.Dot(var_27_1, var_27_0) > 0 and "Camera is on the left side" or "Camera is on the right side")
...
function var_0_1.GetPhase2TipInfos(arg_29_0)
	...
	var_1_10001(var_29_0, var_29_1 .. var_1_10004(arg_29_0.posConfig.id))

	local var_29_2 = {}

	ipairs = var_29_0

	for iter_29_0, iter_29_1 in var_29_0(arg_29_0.posConfig.fury_anim) do
		pg = var_1_10007
		var_1_10007 = var_1_10007.dorm3d_carwash_animation[iter_29_1]
		assert = var_1_10008

		local var_29_3 = var_1_10007
		local var_29_4 = "CarWash phase2 animation config not found: "

		tostring = var_1_10011

		var_1_10008(var_29_3, var_29_4 .. var_1_10011(iter_29_1))

		assert = var_1_10008

		local var_29_5

		if var_1_10007.collider then
			var_29_5 = var_1_10007.collider[1]
		end

		local var_29_6 = "CarWash phase2 animation collider config is empty: "

		tostring = var_1_10011

		var_1_10008(var_29_5, var_29_6 .. var_1_10011(iter_29_1))

		var_1_10008 = var_1_10007.collider[1]

		local var_29_7 = arg_29_0.colliderMap[var_1_10008]

		assert = var_10
		var_1_10011 = var_29_7

		local var_29_8 = "CarWash phase2 collider not found: "

		tostring = var_1_10013

		var_10(var_1_10011, var_29_8 .. var_1_10013(var_1_10008))

		var_1_10011 = arg_29_0.mainCamera

		local var_29_9 = var_10.WorldToScreenPoint(var_1_10011, var_29_7.bounds.center)

		table = var_1_10011

		var_1_10011.insert(var_29_2, {
			index = iter_29_0,
			animId = iter_29_1,
			colliderName = var_1_10008,
			screenPosition = var_29_9,
			visible = var_29_9.z > 0 and arg_29_0:CanTriggerReactionAnim()
		})
	end
...
function var_0_1.OnPlayPhase2Reaction(arg_30_0, arg_30_1)
	...
	local var_30_1 = var_3.dorm3d_carwash_animation[var_30_0]
	...
	var_4(var_30_2, var_30_3 .. var_1_10007(var_30_0))

	local var_30_4 = arg_30_0
	local var_30_5 = arg_30_0.GetTriggerAnim(var_30_4, var_30_1)

	assert = var_30_4

	local var_30_6 = var_30_5 ~= ""
	local var_30_7 = "CarWash phase2 reaction animation not found: "

	tostring = var_8

	var_30_4(var_30_6, var_30_7 .. var_8(var_30_0))

	warning = var_30_4

	var_30_4("Play phase2 reaction anim: " .. var_30_5)
	arg_30_0:PlayReactionAnim(var_30_5, function()
...
function var_0_1.TryHandleHiddenReaction(arg_32_0, arg_32_1, arg_32_2)
	...
	if arg_32_0.hiddenReactionConfigId ~= var_32_0 then
		...
		CarWashMainPage = var_1_10006

		local var_32_3 = var_1_10006.SHOW_EXPRESSION_HUD

		CarWashMainPage = var_1_10007

		var_32_2(var_32_1, var_32_3, var_1_10007.EXPRESSION_TYPE.HATE)
	end
	...
	local var_32_4 = arg_32_0.hiddenReactionHitTime

	CarWashConst = var_32_1

	if var_32_4 >= var_32_1.HIDDEN_REACTION_TRIGGER_TIME then
...
function var_0_1.TriggerHiddenReaction(arg_34_0, arg_34_1)
	...
	var_34_1(var_34_0, var_1_10004.TRIGGER_HIDDEN_REACTION, arg_34_1)
...
function var_0_1.PlayAnim(arg_43_0, arg_43_1, arg_43_2)
	...
	if var_5 then
		...
		if not var_43_4(var_43_3, var_43_5, var_1_10008.StringToHash(arg_43_1)) then
			errorMsg = var_5
...
function var_0_1.PlayFaceAnim(arg_44_0, arg_44_1)
	...
	if var_1_10002 then
		...
		if not var_44_1(var_44_0, var_44_2, var_1_10005.StringToHash(arg_44_1)) then
			errorMsg = var_2
