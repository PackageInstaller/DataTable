...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.dorm3d.Core.Dorm3dBaseMediator"))
...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.TRIGGER_FAVOR, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.APARTMENT_TRIGGER_FAVOR, {
			groupId = arg_2_1,
			triggerId = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.FAVOR_LEVEL_UP, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.APARTMENT_LEVEL_UP, {
			groupId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_FURNITURE_SELECT, function(arg_5_0, arg_5_1, arg_5_2)
		...
		Dorm3dFurnitureSelectMediator = var_2_10007
		var_5_3.mediator = var_2_10007
		Dorm3dFurnitureSelectLayer = var_2_10007
		...
		function var_5_3.onRemoved()
			...
			SlideExtraSystem = var_3_10003
			var_6_2[1] = var_3_10003
	...
	arg_1_0:bind(var_0_1.OPEN_LEVEL_LAYER, function(arg_9_0, arg_9_1, arg_9_2)
		...
		Dorm3dLevelLayer = var_2_10007
		var_9_3.viewComponent = var_2_10007
		Dorm3dLevelMediator = var_2_10007
	...
	arg_1_0:bind(var_0_1.OPEN_GIFT_LAYER, function(arg_12_0, arg_12_1, arg_12_2)
		...
		Dorm3dGiftLayer = var_2_10007
		var_12_3.viewComponent = var_2_10007
		Dorm3dGiftMediator = var_2_10007
		var_12_3.mediator = var_2_10007
	...
	arg_1_0:bind(var_0_1.OPEN_CAMERA_LAYER, function(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
		...
		local var_15_2 = var_2_10006.New
		local var_15_3 = {}

		Dorm3dPhotoLayer = var_2_10008
		var_15_3.viewComponent = var_2_10008
		Dorm3dPhotoMediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.OPEN_COLLECTION_LAYER, function(arg_17_0, arg_17_1)
		...
		Dorm3dCollectionLayer = var_2_10006
		var_17_3.viewComponent = var_2_10006
		Dorm3dCollectionMediator = var_2_10006
	...
	arg_1_0:bind(var_0_1.OPEN_SKIN_SELECT_LAYER, function(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4, arg_21_5)
		...
		local var_21_2 = var_2_10008.New
		local var_21_3 = {}

		Dorm3dSkinSelectLayer = var_2_10010
		var_21_3.viewComponent = var_2_10010
		Dorm3dSkinSelectMediator = var_2_10010
	...
	arg_1_0:bind(var_0_1.OPEN_ACCOMPANY_WINDOW, function(arg_24_0, arg_24_1, arg_24_2)
		...
		Dorm3dAccompanyLayer = var_2_10007
		var_24_3.viewComponent = var_2_10007
		Dorm3dAccompanyMediator = var_2_10007
		var_24_3.mediator = var_2_10007
	...
	arg_1_0:bind(var_0_1.OPEN_MINIGAME_WINDOW, function(arg_27_0, arg_27_1, arg_27_2)
		...
		local var_27_3 = var_6.New
		local var_27_4 = {
			viewComponent = var_27_0
		}

		Dorm3dMiniGameMediator = var_2_10008
		var_27_4.mediator = var_2_10008
	...
	arg_1_0:bind(var_0_1.ADD_EXTRA_SYSTEM_FURNITURE_SLIDE, function(arg_32_0, arg_32_1)
		...
		FurnitureSlideExtraLayer = var_2_10006
		var_32_3.viewComponent = var_2_10006
		FurnitureSlideExtraMediator = var_2_10006
		var_32_3.mediator = var_2_10006
	...
	arg_1_0:bind(var_0_1.DO_TALK, function(arg_35_0, arg_35_1, arg_35_2)
		...
		var_35_1(var_35_0, var_2_10005.APARTMENT_DO_TALK, {
			talkId = arg_35_1,
			callback = arg_35_2
		})
	...
	arg_1_0:bind(var_0_1.COLLECTION_ITEM, function(arg_36_0, arg_36_1)
		...
		var_36_1(var_36_0, var_2_10004.APARTMENT_COLLECTION_ITEM, arg_36_1)
	...
	arg_1_0:bind(var_0_1.Camera_Pinch_Value_Change, function(arg_37_0, arg_37_1)
		...
		Dorm3dPhotoMediator = var_2_10004

		var_37_1(var_37_0, var_2_10004.Camera_Pinch_Value_Change, {
			value = arg_37_1
		})
	...
	var_1_1(var_1_0, var_3.CAMERA_LIFT_CHANGED, function(arg_38_0, arg_38_1)
		local var_38_0 = arg_1_0
		local var_38_1 = var_2.sendNotification

		Dorm3dPhotoMediator = var_2_10004

		var_38_1(var_38_0, var_2_10004.CAMERA_LIFT_CHANGED, {
			value = arg_38_1
		})
	...
	var_1_3(var_1_2, var_3.CAMERA_STICK_MOVE, function(arg_39_0, arg_39_1)
		local var_39_0 = arg_1_0
		local var_39_1 = var_2.sendNotification

		Dorm3dPhotoMediator = var_2_10004

		var_39_1(var_39_0, var_2_10004.CAMERA_STICK_MOVE, arg_39_1)
	...
	arg_1_0:bind(var_0_1.ENTER_VOLLEYBALL, function(arg_40_0, arg_40_1)
		...
		var_40_1(var_40_0, var_40_2, var_2_10005.DORM3D_VOLLEYBALL, {
			groupId = arg_40_1
		})
	...
	arg_1_0:bind(var_0_1.ENTER_DANCE, function(arg_41_0, arg_41_1)
		...
		var_41_1(var_41_0, var_41_2, var_2_10005.DORM3D_DANCE, {
			groupId = arg_41_1
		})
	...
	arg_1_0:bind(var_0_1.ENTER_CARWASH, function(arg_42_0, arg_42_1)
		...
		var_42_1(var_42_0, var_42_2, var_2_10005.DORM3D_CAR_WASH, {
			groupId = arg_42_1
		})
	...
	arg_1_0:bind(var_0_1.ON_DROP_CLIENT, function(arg_43_0, arg_43_1)
		...
		var_43_1(var_43_0, var_2_10004.NewStyleMsgboxMgr.TYPE_DROP_CLIENT, arg_43_1)
	...
	arg_1_0:bind(var_0_1.OPEN_SETTING_LAYER, function(arg_44_0)
		...
		local var_44_2 = var_2_10003.New
		local var_44_3 = {}

		Dorm3dSettingScene = var_2_10005
		var_44_3.viewComponent = var_2_10005
		NewSettingsMediator = var_2_10005
		var_44_3.mediator = var_2_10005
	...
	local var_1_6 = var_3(var_4)

	var_1_5(var_1_4, var_3.getRoom(var_1_6, arg_1_0.contextData.roomId))
...
function var_0_1.initNotificationHandleDic(arg_45_0)
	...
	var_45_0[var_2.APARTMENT_LEVEL_UP_DONE] = function(arg_47_0, arg_47_1)
		...
		local var_47_1 = arg_47_1.getBody(var_47_0)

		seriesAsync = var_47_0
		...
		var_47_0({
			function(arg_48_0)
				...
				var_1.PopFavorLevelUp(var_48_1, var_47_1.apartment, var_47_1.award, arg_48_0)
	...
	var_45_0[var_2.APARTMENT_COLLECTION_ITEM_DONE] = function(arg_56_0, arg_56_1)
		...
		local var_56_3 = var_2_10005.New
		local var_56_4 = {}

		Dorm3dCollectAwardLayer = var_2_10007
		var_56_4.viewComponent = var_2_10007
		Dorm3dCollectAwardMediator = var_2_10007
		var_56_4.mediator = var_2_10007
		var_56_4.data = {
	...
	var_45_0[var_2.ON_DORM] = function(arg_64_0, arg_64_1)
		...
		local var_64_3 = var_2_10005.CHANGE_SCENE

		SCENE = var_2_10006

		var_64_2(var_64_1, var_64_3, var_2_10006.DORM3D_ROOM, var_64_0)
	...
	var_45_0[var_2.OPERATION] = function(arg_65_0, arg_65_1)
		...
		Dorm3dMiniGameMediator = var_2_10005

		var_65_2(var_65_1, var_2_10005.OPERATION, var_65_0)
	...
	var_45_0[var_2.UPDATE_ROOM_INVITE_LIST] = function(arg_68_0, arg_68_1)
		...
		local var_68_1 = arg_68_1.getBody(var_68_0)

		ipairs = var_68_0

		for iter_68_0, iter_68_1 in var_68_0(var_68_1.addIds) do
			table = var_2_10008

			var_2_10008.insert(arg_68_0.contextData.groupIds, iter_68_1)
		end

		local var_68_2 = arg_68_0.viewComponent

		var_3.LoadCharacterAdditionally(var_68_2, var_68_1.addIds, var_68_1.callback)
