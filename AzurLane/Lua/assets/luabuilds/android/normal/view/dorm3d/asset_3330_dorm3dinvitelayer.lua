...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "window/Text")

	i18n = var_2_1

	var_1(var_2_2, var_2_1("dorm3d_invite_beach_tip"))

	setText = var_1

	local var_2_3 = arg_2_0.rtInvitePanel
	local var_2_4 = var_2.Find(var_2_3, "window/btn_confirm/Text")
	...
	local var_2_11 = var_3.Find(var_2_10, "window/btn_close")
	...
	local var_2_15 = var_2.Find(var_2_14, "window/character/title")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("dorm3d_select_tip"))

	onButton = var_1

	local var_2_16 = arg_2_0
	local var_2_17 = arg_2_0.rtSelectPanel
	local var_2_18 = var_3.Find(var_2_17, "bg")
	...
	var_1(var_2_16, var_2_18, var_2_19, var_5)

	setText = var_1

	local var_2_20 = arg_2_0.rtSelectPanel
	local var_2_21 = var_2.Find(var_2_20, "window/title/Text")

	i18n = var_2_20

	var_1(var_2_21, var_2_20("dorm3d_data_choose"))

	setText = var_1

	local var_2_22 = arg_2_0.rtSelectPanel
	local var_2_23 = var_2.Find(var_2_22, "window/bottom/container/btn_confirm/Text")

	i18n = var_2_22

	var_1(var_2_23, var_2_22("text_confirm"))
...
function var_0_1.ShowInvitePanel(arg_6_0)
	...
	local var_6_2 = var_6_0 .. var_3.getConfig(var_6_1, "assets_prefix")
	local var_6_3 = ""
	local var_6_4 = arg_6_0.rtInvitePanel

	var_1_10001(var_6_2, var_6_3, var_4.Find(var_6_4, "window/Image"))

	setText = var_1_10001

	local var_6_5 = arg_6_0.rtInvitePanel
	local var_6_6 = var_2.Find(var_6_5, "window/Text")
	...
	var_1_10001(var_6_6, var_6_5(var_6_7, var_5.getRoomName(var_6_8)))
	...
	var_6_12.StaticAlign(var_6_13, var_6_13:GetChild(0), var_6_11, function(arg_7_0, arg_7_1, arg_7_2)
		arg_7_1 = arg_7_1 + 1
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			if var_7_0 then
				...
				var_5(var_6.dorm3d_resource[var_2_10004].head_Icon, "", arg_7_2:Find("ship"), true)
			end
			...
			var_2_10004(var_7_1, var_7_2, var_7_3, var_2_10008)
			...
			if arg_7_1 == var_6_11 or not var_7_0 then
				...
				local var_7_7 = arg_7_2.Find(var_7_6, "tip")

				PlayerPrefs = var_7_6

				var_7_4(var_7_7, var_7_6.GetInt(var_7_5 .. "_dorm3dRoomInviteSuccess_" .. arg_6_0.room.id, 1) == 0)
			end
		end
	...
	local var_6_16 = var_6.Find(var_6_15, "window/btn_confirm")
	...
	local function var_6_17()
		if #arg_6_0.selectIds < var_6_10 or #arg_6_0.selectIds > var_6_11 then
			...
			var_9_1(var_9_0, var_2_10002("dorm3d_data_Invite_lack"))
		...
		if #arg_6_0.selectIds >= 3 then
			...
			if not var_1.CheckDeviceRAMEnough() then
				...
				var_1.insert(var_9_2, function(arg_10_0)
					...
					i18n = var_3_10004
					var_10_2.content = var_3_10004("drom3d_beach_memory_limit_tip")
		...
		var_1.insert(var_9_2, function(arg_11_0)
			...
			local var_11_0 = var_3_10001(var_3_10002)
		...
		var_1(var_9_2, function()
			...
			Dorm3dInviteMediator = var_3_10002

			local var_12_2 = var_3_10002.ON_DORM
			local var_12_3 = {
				roomId = arg_6_0.room.id
			}

			underscore = var_4
			var_12_3.groupIds = var_4.rest(arg_6_0.selectIds, 1)
	...
	var_4(var_6_14, var_6_16, var_6_17, var_8)
...
function var_0_1.ShowSelectPanel(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10006(var_14_1) do
		if not arg_14_0.room.unlockCharacter[iter_14_1] then
			...
			getProxy = var_11
			ApartmentProxy = var_1_10012
			var_1_10012 = var_11(var_1_10012)

			if not var_11.getApartment(var_1_10012, iter_14_1) then
				var_14_6[iter_14_1] = "room"
			else
				Apartment = var_11
				var_1_10012 = var_11.New({
					ship_group = iter_14_1
				})

				if var_11.needDownload(var_1_10012) then
	...
	var_14_9.StaticAlign(var_14_10, var_14_10:GetChild(0), #var_14_1, function(arg_15_0, arg_15_1, arg_15_2)
		arg_15_1 = arg_15_1 + 1
		UIItemList = var_2_10003
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			if not var_15_0 then
				...
				local var_15_2 = arg_15_2.Find(var_15_1, "empty/Text")

				i18n = var_15_1

				var_2_10004(var_15_2, var_15_1("dorm3d_waiting"))
			else
				...
				var_2_10004.UpdateSelectableCard(var_15_3, arg_15_2:Find("base"), var_15_0, function(arg_16_0)
					table = var_3_10001
					...
					var_1(var_2.Find(var_16_0, "window/bottom/title/Text"), arg_14_0.selectCountTip .. #var_14_5 .. "/" .. var_14_4)
				...
				local var_15_4 = arg_15_2
				local var_15_5 = arg_15_2.Find(var_15_4, "base")

				table = var_15_4

				var_2_10004(var_15_5, var_15_4.contains(arg_14_0.selectIds, var_15_0))
				...
				local var_15_6 = arg_14_0
				local var_15_7 = arg_15_2:Find("base/mask")
				...
				local function var_15_8()
					if var_14_6[var_15_0] == "lock" then
						...
						Dorm3dInviteMediator = var_3_10002
						var_3_10002 = var_3_10002.OPEN_ROOM_UNLOCK_WINDOW

						local var_17_3 = arg_14_0.room

						var_17_2(var_17_1, var_3_10002, var_3.GetConfigID(var_17_3), var_15_0)
					elseif var_14_6[var_15_0] == "room" then
						...
						var_17_5(var_17_4, var_3_10002("dorm3d_role_locked"))
					elseif var_14_6[var_15_0] == "download" then
						...
						var_17_7(var_17_6, var_3_10002("dorm3d_guide_beach_tip"))
					end
				...
				var_2_10004(var_15_6, var_15_7, var_15_8, var_8)
			...
			local var_15_10 = arg_15_2.Find(var_15_9, "tip")

			PlayerPrefs = var_15_9

			var_2_10004(var_15_10, var_15_9.GetInt(var_14_8 .. "_dorm3dRoomInviteSuccess_" .. arg_14_0.room.id .. "_" .. var_15_0, 1) == 0)
	...
	local var_14_13 = var_10.Find(var_14_12, "window/bottom/container/btn_confirm")
	...
	local function var_14_14()
		if #var_14_5 > var_14_4 then
			...
			var_19_1(var_19_0, var_2_10002("dorm3d_data_Invite_lack"))
	...
	var_8(var_14_11, var_14_13, var_14_14, var_12)
	...
	var_14_19[1] = var_13.Find(var_14_20, "window")
...
function var_0_1.UpdateSelectableCard(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local var_20_3 = var_20_1(var_20_0, var_6.getConfig(var_20_2, "tag"))

	GetImageSpriteFromAtlasAsync = var_20_0
	string = var_6

	var_20_0(var_6.format("dorm3dselect/room_card_apartment_%d", var_20_3), "", arg_20_1:Find("Image"))

	GetImageSpriteFromAtlasAsync = var_20_0
	string = var_6

	var_20_0(var_6.format("dorm3dselect/room_card_apartment_name_%d", arg_20_2), "", arg_20_1:Find("name"))

	getProxy = var_20_0
	ApartmentProxy = var_6

	local var_20_4 = var_20_0(var_6)
	local var_20_5, var_20_6

	if var_5.getApartment(var_20_4, arg_20_2) then
		var_20_5 = var_5
		var_20_6 = var_5.needDownload(var_20_5)
	...
	var_20_5(arg_20_1:Find("lock"), var_20_6)

	setActive = var_20_5

	var_20_5(arg_20_1:Find("mask"), var_20_6)

	setActive = var_20_5

	var_20_5(arg_20_1:Find("unlock"), not var_20_6)

	setActive = var_20_5

	var_20_5(arg_20_1:Find("favor_level"), var_5)

	if var_5 then
		setText = var_20_5

		var_20_5(arg_20_1:Find("favor_level/Text"), var_5.level)
	end
	...
	local function var_20_9(arg_21_0)
		arg_20_3(arg_21_0)
		...
		if arg_21_0 then
			if not var_0 then
				...
				var_21_1(var_21_0, var_2_10003.format("need unlock apartment{%d}", arg_20_2))
				...
				if var_1.needDownload(var_21_2) then
					...
					var_21_4(var_21_3, var_2_10003.format("need download resource{%d}", arg_20_2))
	...
	var_20_5(var_20_7, var_20_8, var_20_9, var_1_10011)
...
function var_0_1.didEnter(arg_24_0)
	...
	arg_24_0.selectIds = var_24_0(var_24_1, function(arg_25_0)
		...
		if arg_24_0.room.unlockCharacter[arg_25_0] then
			...
			local var_25_0 = var_2_10002(var_2_10003)

			if var_25_2(var_2.getApartment(var_25_0, arg_25_0)) then
				Apartment = var_25_2
