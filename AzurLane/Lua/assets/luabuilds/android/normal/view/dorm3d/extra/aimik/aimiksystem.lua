...
function var_0_1.EnterTimelineAimIKStatus(arg_12_0, arg_12_1)
	...
	var_2(var_12_0, var_12_1 .. var_1_10005(arg_12_1))
	...
	typeof = var_4
	CanvasRectDragTarget = var_5
	arg_12_0.dragComp = var_12_5(var_12_4, var_4(var_5))
	...
	typeof = var_4
	HeadAimIKHotfix = var_5
	arg_12_0.headAimIKComp = var_12_8(var_12_7, var_4(var_5))
	...
	typeof = var_4
	StickAim = var_5
	arg_12_0.stickAimComp = var_12_11(var_12_10, var_4(var_5))
	GameObject = var_2
	...
	arg_12_0:LerpAimWeight(0, 1, arg_12_0.config.fade_in, function()
		...
		Dorm3dAimIKView = var_2_10002

		var_13_1(var_13_0, var_2_10002.BIND_DRAG_AREA, arg_12_0.dragComp)

		local var_13_2 = arg_12_0
		local var_13_3 = var_0.Emit

		Dorm3dAimIKView = var_2

		var_13_3(var_13_2, var_2.SHOW_OR_HIDE, true)

		local var_13_4 = arg_12_0

		System = var_13_2
		var_13_4.triggerAction = var_13_2.Action(function()
			local var_14_0 = arg_12_0
			local var_14_1 = var_0.Emit

			Dorm3dRoomTemplateScene = var_3_10002

			var_14_1(var_14_0, var_3_10002.TRIGGER_TIMELINE_PLAYER_EVENT, {
...
function var_0_1.ExitTimelineAimIKStatus(arg_15_0, arg_15_1)
	...
	Dorm3dAimIKView = var_1_10004

	var_15_1(var_15_0, var_1_10004.SHOW_OR_HIDE, false)
	...
	if arg_15_1 then
		...
		arg_15_0.InvalidateExitProcess(var_15_4)

		arg_15_0.inExitProcessing = true

		local var_15_5 = arg_15_0.exitProcessToken

		seriesAsync = var_15_4

		var_15_4({
			function(arg_16_0)
				local var_16_0 = arg_15_0

				if not var_1.IsExitProcessValid(var_16_0, var_15_5) then
					return
				end
				...
				var_1.LerpAimWeight(var_16_1, var_15_3, var_15_3, arg_15_0.maxDampTime, function()
					...
					if not var_0.IsExitProcessValid(var_17_0, var_15_5) then
						return
					end
			...
			function(arg_18_0)
				...
				if not var_1.IsExitProcessValid(var_18_0, var_15_5) then
					return
				end
				...
				var_2.LerpAimWeight(var_18_3, var_18_2, 0, arg_15_0.config.fade_out, function()
					...
					if not var_0.IsExitProcessValid(var_19_0, var_15_5) then
						return
					end
			...
			function(arg_20_0)
				...
				if not var_1.IsExitProcessValid(var_20_0, var_15_5) then
					return
				end
			...
			if arg_15_0.exitProcessToken ~= var_15_5 then
				return
			end
...
function var_0_1.LerpAimWeight(arg_31_0, arg_31_1, arg_31_2, arg_31_3, arg_31_4)
	...
	local var_31_1 = var_31_0(var_7(arg_31_0.configRoot), arg_31_1, arg_31_2, arg_31_3)
	local var_31_2 = var_6.setEase

	LeanTweenType = var_8

	local var_31_3 = var_31_2(var_31_1, var_8.easeInOutSine)
	local var_31_4 = var_6.setOnUpdate

	System = var_8

	local var_31_5 = var_31_4(var_31_3, var_8.Action_float(function(arg_33_0)
		var_0(arg_33_0)
	...
	System = var_8
	arg_31_0.weightLerpTweenId = var_31_6(var_31_5, var_8.Action(function()
