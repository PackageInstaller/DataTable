...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2.make(var_2_2, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			local var_3_4 = arg_3_2.Find(var_3_3, "name")

			if not var_3_2 or not var_3_1.name then
				i18n = var_3_3
				var_3_3 = var_3_3("dorm3d_recall_locked")
			end

			var_6(var_3_4, var_3_3)

			GetImageSpriteFromAtlasAsync = var_6
			string = var_3_4

			local var_3_5 = var_3_4.format("dorm3dmemory/%s_list", var_3_1.image)
			local var_3_6 = ""
			local var_3_7 = arg_3_2

			var_6(var_3_5, var_3_6, arg_3_2.Find(var_3_7, "Image"))
			...
			var_6(var_3_8, var_3_9, var_3_10, var_3_7)
		end
...
function var_0_1.OnInit(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_4(arg_5_0.ids) do
		pg = var_1_10009
		...
		if var_5_2[var_1_10010.dorm3d_dialogue_group[var_1_10009].char_id] == nil then
			...
			if not var_11.getApartment(var_1_10012, var_1_10010) then
				var_5_4 = false
			end
		...
		var_5_5[var_1_10009] = var_1_10012
	...
	local var_5_6 = arg_5_0.rtInfo
	local var_5_7 = var_5.Find(var_5_6, "count")

	string = var_5_6

	var_4(var_5_7, var_5_6.format("<color=#285cfc>%d</color>/%d", var_5_3, #arg_5_0.ids))

	local var_5_8 = arg_5_0.itemList

	var_4.align(var_5_8, #arg_5_0.ids)

	triggerToggle = var_4

	local var_5_9 = arg_5_0.itemList.container

	var_4(var_5.GetChild(var_5_9, 0), true)
...
function var_0_1.UpdateDisplay(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_2 = var_6_0.dorm3d_recall[arg_6_2]
	local var_6_3 = arg_6_0.unlockDic[var_6_2.story_id]

	GetImageSpriteFromAtlasAsync = var_6
	string = var_1_10007

	var_6(var_1_10007.format("dorm3dmemory/%s_info", var_6_2.image), "", var_6_1:Find("icon"))
	...
	local var_6_5 = var_6_1.Find(var_6_4, "icon/lock/Text")

	i18n = var_6_4

	var_6(var_6_5, var_6_4("dorm3d_reload_unlock"))
	...
	local var_6_7 = var_6_1:Find("icon/play")

	local function var_6_8()
		local var_7_0 = arg_6_0
		local var_7_1 = var_0.emit

		Dorm3dCollectionMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.DO_TALK, var_6_2.story_id)
	...
	var_6(var_6_6, var_6_7, var_6_8, var_10)
	...
	if var_6_3 then
		...
		local var_6_10 = var_6_1.Find(var_6_9, "name/number")

		string = var_6_9

		var_6(var_6_10, var_6_9.format("%02d.", arg_6_1))
		...
		local var_6_11 = var_6_1
		local var_6_12 = var_6_1.Find(var_6_11, "name/Text/en")

		i18n = var_6_11

		var_6(var_6_12, var_6_11("dorm3d_collection_title_en"))
		...
		local var_6_13 = var_6_1
		local var_6_14 = var_6_1.Find(var_6_13, "name_lock")

		i18n = var_6_13

		var_6(var_6_14, var_6_13("dorm3d_reload_unlock_name"))
