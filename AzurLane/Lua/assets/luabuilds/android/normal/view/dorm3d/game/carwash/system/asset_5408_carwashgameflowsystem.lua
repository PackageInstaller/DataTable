...
function var_0_1.RegisterEvents(arg_2_0)
	...
	arg_2_0:Bind(var_0_1.SWITCH_LADY_POS, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.dorm3d_carwash_pos[arg_8_1])
	...
	var_2_1(var_2_0, var_3.TIMELINE_SEQUENCE_BEGIN, function(arg_16_0, arg_16_1)
	...
	var_2_3(var_2_2, var_3.TIMELINE_SEQUENCE_END, function(arg_17_0, arg_17_1)
	...
	var_2_5(var_2_4, var_3.TRANSITION_BEGIN, function(arg_18_0, arg_18_1)
	...
	var_2_7(var_2_6, var_3.TRANSITION_END, function(arg_19_0, arg_19_1)
...
function var_0_1.StartGame(arg_22_0, arg_22_1)
	...
	var_2({
		function(arg_23_0)
			...
			var_23_1(var_23_0, var_2_10003.GUN_TYPE.WASHER)
			...
			var_23_3(var_23_2, var_3.dorm3d_carwash_pos[arg_22_0.contextData.gameConfig.pos[1]])
			...
			var_23_5(var_23_4, var_3.GENERATE_DECALS)
			arg_23_0()
		...
		function(arg_24_0)
			...
			if var_2_10001.GetInt("CarWashGuideShown", 0) == 0 then
				...
				var_24_1(var_24_0, var_3.SHOW_HELP_BOX, arg_24_0)
			else
				arg_24_0()
			end
		...
		function(arg_25_0)
			...
			var_25_1(var_25_0, var_2_10003.GAME_STATE.PHASE_1)
			arg_25_0()
...
function var_0_1.EmitCountdown(arg_31_0)
	...
	local var_31_1 = var_1_10002.ceil
	local var_31_2
...
function var_0_1.UpdateGameStatus(arg_40_0, arg_40_1, arg_40_2)
	...
	local var_40_1 = arg_40_0.GetGameStatusEventName(var_40_0, arg_40_1)

	assert = var_40_0

	local var_40_2 = var_40_1
	local var_40_3 = "CarWash gameStatus key not found: "

	tostring = var_1_10007

	var_40_0(var_40_2, var_40_3 .. var_1_10007(arg_40_1))

	local var_40_4 = arg_40_0.contextData.gameStatus[arg_40_1]

	arg_40_0.contextData.gameStatus[arg_40_1] = arg_40_2

	arg_40_0:Emit(var_40_1, {
		key = arg_40_1,
		oldValue = var_40_4,
		newValue = arg_40_2
	})
...
function var_0_1.SetGameState(arg_41_0, arg_41_1)
	...
	if arg_41_1 == var_1_10003.GAME_STATE.PHASE_2 then
		...
		if var_41_0 ~= var_41_2.GAME_STATE.PHASE_2 then
			...
			var_41_2(var_41_1, var_1_10005.dorm3d_carwash_pos[arg_41_0.contextData.gameConfig.pos_phase2])
...
function var_0_1.ModifyHeartBeatValue(arg_44_0, arg_44_1)
	...
	local var_44_2 = var_44_1(var_1_10004.min(var_44_0 + arg_44_1, 100), 0)
...
function var_0_1.EnterPhase2WithTransition(arg_47_0)
	...
	CarWashTimelineSystem = var_1_10003

	local var_47_2 = var_1_10003.PLAY_TRANSITION
	local var_47_3 = {
		waitHold = true
	}

	CarWashTimelineSystem = var_1_10005
	var_47_3.type = var_1_10005.TRANSITION.WHITE
	...
	function var_47_3.onHold(arg_48_0, arg_48_1)
		...
		var_48_1(var_48_0, var_2_10004.GAME_STATE.PHASE_2)
		arg_48_0()
...
function var_0_1.DecreaseStainsCount(arg_53_0, arg_53_1)
	...
	var_53_2(var_53_1, var_1_10005.max(var_53_0 - arg_53_1, 0))
...
function var_0_1.PlayPhase2Reaction(arg_55_0, arg_55_1)
	...
	if var_55_0 ~= var_3.GAME_STATE.PHASE_2 then
		return
	end
	...
	var_55_2(var_55_1, var_4.PLAY_PHASE2_REACTION, {
...
function var_0_1.CheckAllPhase2TipsClicked(arg_57_0)
	...
	var_2(var_57_1, var_57_2 .. var_1_10005(arg_57_0.contextData.gameConfig.pos_phase2))
...
function var_0_1.ReturnToPhase1WithTransition(arg_58_0)
	...
	local var_58_2 = var_1_10003.PLAY_TRANSITION
	local var_58_3 = {
		waitHold = true
	}

	CarWashTimelineSystem = var_1_10005
	var_58_3.type = var_1_10005.TRANSITION.WHITE
	...
	function var_58_3.onHold(arg_59_0, arg_59_1)
		...
		var_59_2(var_59_1, var_4.GAME_STATE.PHASE_1)
		arg_59_0()
...
function var_0_1.FinishGame(arg_61_0)
	...
	var_61_2(var_61_1, var_1_10003.GAME_STATE.END)
...
function var_0_1.PlayEndArtTimeline(arg_62_0)
	...
	var_62_1(var_62_0, var_1_10003.PLAY_ART_TIMELINE, arg_62_0.contextData.gameConfig.end_timeline)
...
function var_0_1.RestartGame(arg_63_0)
	...
	var_63_2(var_63_1, var_1_10003.EXIT_ART_TIMELINE, {
...
function var_0_1.TriggerHiddenReaction(arg_66_0, arg_66_1)
	...
	var_66_1(var_66_0, var_4.PLAY_ART_TIMELINE, arg_66_1.hidden_reaction)
