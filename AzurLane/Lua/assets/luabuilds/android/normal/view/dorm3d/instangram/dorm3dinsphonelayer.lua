...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.voiceItemList = var_2_3(var_2_4, var_3.Find(var_2_5, "tpl"))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_1 = var_2.Find(var_4_0, "tpl/bg/uncheck/Text")

	i18n = var_4_0

	var_1_10001(var_4_1, var_4_0("dorm3d_privatechat_telephone_noviewed"))

	setText = var_1_10001

	local var_4_2 = arg_4_0.bg
	local var_4_3 = var_2.Find(var_4_2, "top/title")

	i18n = var_4_2

	var_1_10001(var_4_3, var_4_2("dorm3d_privatechat_telephone_calllog"))

	setText = var_1_10001

	local var_4_4 = arg_4_0.bg
	local var_4_5 = var_2.Find(var_4_4, "main/voice/title/Text")

	i18n = var_4_4

	var_1_10001(var_4_5, var_4_4("dorm3d_privatechat_telephone_call"))
	arg_4_0:Flush()
...
function var_0_1.UpdateVoiceItem(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_0(arg_7_2:Find("bg/name"), var_3:GetName())

	setActive = var_7_0

	var_7_0(arg_7_2:Find("bg/day"), not var_7_1)

	setActive = var_7_0

	var_7_0(arg_7_2:Find("bg/lock"), var_7_1)

	setActive = var_7_0

	var_7_0(arg_7_2:Find("bg/uncheck"), var_3:ShouldTip())

	if var_7_1 then
		setText = var_7_0

		var_7_0(arg_7_2:Find("bg/lock/info"), var_3:GetDesc())
	else
		setText = var_7_0

		var_7_0(arg_7_2:Find("bg/day"), var_3:GetDay())
	end

	onButton = var_7_0

	var_7_0(arg_7_0, arg_7_2, function()
		if var_7_1 then
			return
		end
		...
		if var_0.GetType(var_8_0) == 1 then
			...
			Dorm3dInsPhoneMediator = var_2_10002
			var_2_10002 = var_2_10002.ON_DORM

			local var_8_3 = var_0

			var_8_2(var_8_1, var_2_10002, var_2_10003.GetVideoData(var_8_3))
		else
			local var_8_4 = var_0
			...
			if var_0.GetType(var_8_4) == 2 then
				...
				var_8_6(var_8_5, var_2_10002, var_2_10003.GetContent(var_8_7))
			end
		end
		...
		if var_0.ShouldTip(var_8_8) then
			...
			var_8_10(var_8_9, var_2_10002.MARK_READ, {
		...
		local var_8_13 = var_2_10002.APARTMENT_TRACK

		Dorm3dTrackCommand = var_2_10003

		local var_8_14 = var_2_10003.BuildDataPhone
		local var_8_15 = arg_7_0.contextData.groupId
		local var_8_16 = var_0

		var_8_12(var_8_11, var_8_13, var_8_14(var_8_15, var_5.GetType(var_8_16), var_0.id))
