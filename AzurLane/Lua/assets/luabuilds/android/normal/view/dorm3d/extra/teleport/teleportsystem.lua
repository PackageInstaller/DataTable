...
function var_0_1.OnInit(arg_1_0)
	...
	local var_1_1 = arg_1_0.GetRoom(var_1_0).id

	warning = var_1_0

	var_1_0("TeleportSystem Init for room:", var_1_1)

	pg = var_1_0

	local var_1_2

	if not var_1_0.dorm3d_teleport.get_id_list_by_room_id[var_1_1] then
		var_1_2 = {}
	end

	arg_1_0.configs = var_1_2
...
function var_0_1.BindClickFunc(arg_2_0)
	...
	var_1_10001.each(arg_2_0.configs, function(arg_3_0)
		...
		if var_3_1.dorm3d_zone_template[var_3_0.teleport_zone] then
			pg = var_3_2
		...
		var_4(var_3_3, var_3_4 .. var_2_10007(var_3_0.teleport_zone))
		...
		local var_3_6 = var_4(var_3_5, var_6(var_7))
		...
		var_4.AddPointClickFunc(var_3_6, function(arg_4_0, arg_4_1)
			...
			local var_4_2 = var_4_0.instance
			local var_4_3 = var_3.Raycast
			local var_4_4 = arg_2_0
			local var_4_5 = var_4_3(var_4_2, var_5.Get(var_4_4, "sceneRaycaster"), var_4_1)
			...
			if #var_3.ToTable(var_4_5) > 0 then
				...
				if var_4_6.Distance(var_4_7.transform.position, var_0.transform.position) > var_0_1.MAX_DISTANCE then
					return
				end
				...
				Dorm3dRoomTemplateScene = var_3_10009

				var_4_9(var_4_8, var_3_10009.SHIFT_ZONE_SAFE, var_3_2)
			end
