...
function var_0_1.InitUI(arg_2_0)
	...
	var_1_10001(var_2_0, var_3.Find(var_2_1, "btn_back"), function()
		local var_3_0 = arg_2_0
		local var_3_1 = var_0.emit

		BaseUI = var_2_10002

		var_3_1(var_3_0, var_2_10002.ON_BACK)
	...
	var_1_10001(var_2_2, var_3.Find(var_2_3, "btn_help"), function()
...
function var_0_1.BindEvent(arg_5_0)
	...
	var_5_1(var_5_0, var_3.UPDATE_EXPRESSION_HUD_POSITION, function(arg_7_0, arg_7_1)
	...
	arg_5_0:bind(var_0_1.SHOW_EXPRESSION_HUD, function(arg_8_0, arg_8_1)
		...
		local var_8_0 = var_2_10002(arg_8_1, {
			...
			var_3_10000(var_11_0, var_11_1 .. var_3_10003(arg_8_1))
	...
	var_5_3(var_5_2, var_3.TIMELINE_SEQUENCE_BEGIN, function(arg_12_0, arg_12_1)
	...
	var_5_5(var_5_4, var_3.TIMELINE_SEQUENCE_END, function(arg_13_0, arg_13_1)
	...
	var_5_7(var_5_6, var_3.TRANSITION_BEGIN, function()
	...
	var_5_9(var_5_8, var_3.TRANSITION_END, function()
...
function var_0_1.UpdatePOV(arg_16_0)
	...
	local var_16_3 = var_16_2(var_16_1, var_3(var_1_10004))
	...
	var_1.AddBeginDragFunc(var_16_3, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_2_10004.ON_STICK_MOVE_BEGIN, arg_17_1)
	...
	var_1:SetStickFunc(function(arg_18_0)
		...
		CarWashPovControlSystem = var_2_10003

		var_18_1(var_18_0, var_2_10003.ON_STICK_MOVE, arg_18_0)
	...
	var_1:AddDragEndFunc(function(arg_19_0, arg_19_1)
		...
		var_19_1(var_19_0, var_2_10004.ON_STICK_MOVE_END, arg_19_1)
	...
	local var_16_7 = var_16_6(var_16_5, var_4(var_1_10005))
	...
	var_2.SetStickFunc(var_16_7, function(arg_20_0)
		...
		var_20_1(var_20_0, var_2_10003.ON_STICK_VIEW, arg_20_0)
...
function var_0_1.UpdateExpressionHUDPosition(arg_22_0, arg_22_1)
	...
	if arg_22_1.visible then
		...
		local var_22_1 = var_4.ScreenToLocal
		local var_22_2 = arg_22_0.expressionRoot.parent
		local var_22_3 = arg_22_1.screenPosition

		pg = var_1_10007

		var_2(var_22_0, var_22_1(var_22_2, var_22_3, var_1_10007.UIMgr.GetInstance().uiCameraComp))
	end
...
function var_0_1.ShowHelpBox(arg_23_0, arg_23_1)
	...
	local var_23_2 = var_1_10004.NewStyleMsgboxMgr.TYPE_MSGBOX
	local var_23_3 = {}

	i18n = var_1_10006
	var_23_3.title = var_1_10006("dorm3d_carwash_title")
	i18n = var_6
	var_23_3.contentText = var_6("dorm3d_carwash_tiiiiiip")
...
function var_0_1.ShowBlackScreen(arg_27_0, arg_27_1, arg_27_2)
	...
	var_4(var_27_1, var_1_10006.NewHex(var_27_0.color))
	...
	local var_27_4 = var_6.alphaCanvas
	...
	local var_27_7 = var_27_3(var_27_2, var_27_4, var_27_5, var_1_10008(var_27_6, var_1_10010(var_1_10011)), arg_27_1 and 1 or 0, var_27_0.time)
