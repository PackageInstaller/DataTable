...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.APARTMENT_REPLACE_FURNITURE, function(arg_2_0, arg_2_1)
		local var_2_0 = arg_1_0
		local var_2_1 = var_2.sendNotification

		GAME = var_2_10004

		var_2_1(var_2_0, var_2_10004.APARTMENT_REPLACE_FURNITURE, arg_2_1)
	...
	arg_1_0:bind(var_0_1.SHOW_CONFIRM_WINDOW, function(arg_3_0, arg_3_1)
		...
		Dorm3dFurnitureConfirmWindowMediator = var_2_10006
		var_3_3.mediator = var_2_10006
		Dorm3dFurnitureConfirmWindow = var_2_10006
	...
	arg_1_0:bind(var_0_1.SHOW_FURNITURE_ACESSES, function(arg_4_0, arg_4_1)
		...
		Dorm3dFurnitureAcessesWindowMediator = var_2_10006
		var_4_3.mediator = var_2_10006
		Dorm3dFurnitureAcessesWindow = var_2_10006
	...
	var_1_3(var_1_2, var_3.SHOPPING, function(arg_6_0, arg_6_1)
		local var_6_0 = arg_1_0
		local var_6_1 = var_2.sendNotification

		GAME = var_2_10004

		var_6_1(var_6_0, var_2_10004.SHOPPING, {
			id = arg_6_1.shopId,
			count = arg_6_1.count,
	...
	arg_1_0:bind(var_0_1.OPEN_DROP_LAYER, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_3.viewComponent = var_2_10007
		Dorm3dAwardInfoMediator = var_2_10007
		var_7_3.mediator = var_2_10007
		var_7_3.data = {
			items = arg_7_1
		}
	...
	local var_1_6 = var_1_5(var_1_4, var_3.__cname)
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	ApartmentProxy = var_9_1

	if var_9_0 == var_9_1.UPDATE_ROOM then
		-- block empty
	else
		Dorm3dRoomMediator = var_4

		if var_9_0 == var_4.ON_CLICK_FURNITURE_SLOT then
			-- block empty
		else
			GAME = var_4

			if var_9_0 == var_4.APARTMENT_REPLACE_FURNITURE_DONE then
				...
				if var_9_0 == var_4.APARTMENT_REPLACE_FURNITURE_ERROR then
					...
					if var_9_0 == var_4.SHOPPING_DONE and var_9_2.awards and #var_4 > 0 then
						...
						var_5.emit(var_9_5, var_0_1.OPEN_DROP_LAYER, var_4, function()
							...
							local var_10_2 = var_10_0.shop_template[var_10_1].effect_args[1]
