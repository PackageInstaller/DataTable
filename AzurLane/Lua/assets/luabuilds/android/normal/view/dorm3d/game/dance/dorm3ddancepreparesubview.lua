...
function var_0_1.Init(arg_1_0)
	...
	var_2(var_1_5, var_1_10004("dorm3d_cafe_minigame1", var_1_4))
	...
	var_2(var_1_6, var_4("dorm3d_cafe_minigame2", var_1_4))
...
function var_0_1.Flush(arg_2_0)
	for iter_2_0 = 1, #arg_2_0.contextData.cucoloris do
		...
		LoadImageSpriteAtlasAsync = var_2_0

		local var_2_2 = arg_2_0.contextData.cucoloris[iter_2_0]

		var_2_0(var_7.GetIcon(var_2_2), "", var_2_1:Find("Image"), true)
	end
