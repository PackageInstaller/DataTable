...
function var_0_1.init(arg_4_0)
	...
	var_4_4(var_4_5:Find("toggles"), function(arg_6_0)
		...
		var_2_10001(var_6_0, var_6_1, var_6_2, var_2_10005)

		return
	end)

	local var_4_6 = var_4_5
	local var_4_7 = var_4_5.Find(var_4_6, "content")

	Dorm3dMemorySubView = var_4_6
	arg_4_0.memoryView = var_4_6.New(var_4_7:Find("memory"), arg_4_0.event, arg_4_0.contextData)
	Dorm3dCollectionItemSubView = var_3
	arg_4_0.collectItemView = var_3.New(var_4_7:Find("item"), arg_4_0.event, arg_4_0.contextData)
	pg = var_3

	local var_4_8 = var_3.UIMgr.GetInstance()

	var_3.BlurPanel(var_4_8, arg_4_0._tf)
...
function var_0_1.didEnter(arg_9_0)
	...
	if var_1.isPersonalRoom(var_9_0) then
		...
		var_1(var_2.Find(var_9_1, "window/toggles/memory"), true)
	else
		triggerToggle = var_1

		local var_9_2 = arg_9_0._tf

		var_1(var_2.Find(var_9_2, "window/toggles/item"), true)

		setActive = var_1

		local var_9_3 = arg_9_0._tf

		var_1(var_2.Find(var_9_3, "window/toggles/memory"), false)
	end
