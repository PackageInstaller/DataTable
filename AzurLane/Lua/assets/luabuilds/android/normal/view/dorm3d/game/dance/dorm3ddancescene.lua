...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10005(var_1_10006)

	var_2_2(var_2_1, var_5.getApartment(var_2_3, var_2_0))
	...
	string = var_5
	var_2_5.path = var_5.lower("dorm3d/scenesres/scenes/" .. arg_2_0.sceneRootName .. "/" .. arg_2_0.sceneName .. "_scene")
	...
	var_2_4({
		function(arg_3_0)
			...
			var_3_1(var_3_0, var_3_2, var_3_3, var_2_10005.Additive, function(arg_4_0, arg_4_1)
		...
		function(arg_5_0)
			...
			var_5_1(var_5_0, var_5_2, var_5_3, var_2_10005.Additive, function(arg_6_0, arg_6_1)
				arg_5_0()
...
function var_0_1.init(arg_7_0)
	...
	typeof = var_1_10004
	Camera = var_1_10005
	arg_7_0.overlayCamera = var_7_2(var_7_1, var_1_10004(var_1_10005))
	...
	Dorm3dHxHelper = var_7_3

	var_7_3.ReplaceCharacterParts(var_7_4)
...
function var_0_1.InitUI(arg_8_0)
	...
	local var_8_3 = var_3.Find(var_8_2, "Base/BackBtn")
	...
	local function var_8_4()
		...
		var_9_1(var_9_0, var_2_10002.ON_BACK)
	...
	var_1(var_8_1, var_8_3, var_8_4, var_5)

	Dorm3dDancePrepareSubView = var_1

	local var_8_5 = var_1.New
	local var_8_6 = arg_8_0._tf
	local var_8_7 = var_2.Find(var_8_6, "Prepare")
	local var_8_8 = arg_8_0.event

	setmetatable = var_4
	arg_8_0.prepareView = var_8_5(var_8_7, var_8_8, var_4({}, {
	...
	local var_8_11 = var_2.Find(var_8_10, "Game")
	local var_8_12 = arg_8_0.event

	setmetatable = var_4
	arg_8_0.gameView = var_8_9(var_8_11, var_8_12, var_4({
	...
	local var_8_15 = var_2.Find(var_8_14, "Result")
	local var_8_16 = arg_8_0.event

	setmetatable = var_4
	arg_8_0.resultView = var_8_13(var_8_15, var_8_16, var_4({
		onAgain = function()
		...
		onExit = function()
			...
			var_17_1(var_17_0, var_2_10002.ON_BACK)
	...
	Dorm3dDanceConst = var_8_15
	var_8_17[var_8_15.VIEW_ENUM.PREPARE] = arg_8_0.prepareView
	...
	local var_8_20 = var_2.Find(var_8_19, "Photo")
	local var_8_21 = arg_8_0.event

	setmetatable = var_4
	arg_8_0.photoWindow = var_8_18(var_8_20, var_8_21, var_4({
		onHide = function()
...
function var_0_1.InitScene(arg_22_0)
	...
	var_22_0.IpairsCArray(var_22_1, function(arg_23_0, arg_23_1)
	...
	var_22_2.IpairsCArray(var_22_3, function(arg_24_0, arg_24_1)
		...
		elseif arg_24_1.name == "all_con" then
			...
			typeof = var_2_10005
			Camera = var_2_10006
			var_24_1.timelineCamera = var_24_3(var_24_2, var_2_10005(var_2_10006))
			setActive = var_24_1
	...
	TimelineHelper = var_4

	var_22_4(var_4.GetTimelineTracks(arg_22_0.timelinePlayer.comDirector), function(arg_25_0, arg_25_1)
		_ = var_2_10002
...
function var_0_1.InitData(arg_32_0)
	...
	for iter_32_0 = var_32_0, var_2.CUCOLORIS_COUNT do
		...
		local var_32_1 = var_6.insert
		local var_32_2 = arg_32_0.contextData.cucoloris

		Dorm3dDanceCucoloris = var_1_10008

		var_32_1(var_32_2, var_1_10008.New({
	...
	if var_32_0 then
		...
		for iter_32_1 = var_32_3, var_2.CUCOLORIS_COUNT do
			warning = var_1_10005

			local var_32_4 = "ID" .. arg_32_0.contextData.cucoloris[iter_32_1].configId
			local var_32_5 = "时间"
			local var_32_6 = arg_32_0.contextData.cucoloris[iter_32_1]
			local var_32_7 = var_32_5 .. var_8.GetTime(var_32_6)
			local var_32_8 = "相机"
			local var_32_9 = arg_32_0.contextData.cucoloris[iter_32_1]

			var_1_10005(var_32_4, var_32_7, var_32_8 .. var_9.GetCamera(var_32_9))
		end
	end
...
function var_0_1.PrepareGame(arg_33_0)
	...
	var_33_1(var_33_0, var_1_10003.VIEW_ENUM.PREPARE)
...
function var_0_1.StartGame(arg_34_0)
	...
	var_34_2(var_34_1, var_1_10003.VIEW_ENUM.GAME)
...
function var_0_1.EndGame(arg_35_0)
	...
	var_35_2(var_35_1, var_3.VIEW_ENUM.RESULT)
...
function var_0_1.CalcScore(arg_36_0)
	...
	for iter_36_1 = var_36_3, var_1_10003.CUCOLORIS_COUNT do
		var_1_10006 = arg_36_0.contextData.cucoloris[iter_36_1]

		local var_36_4 = 1

		Dorm3dDanceConst = var_1_10008

		for iter_36_2 = var_36_4, var_1_10008.PHOTO_TIMES do
			local var_36_5 = arg_36_0.contextData.photoData[iter_36_2]
			local var_36_6, var_36_7, var_36_8 = var_1_10006:CalcScore(var_36_5)

			table = var_1_10015

			var_1_10015.insert(var_36_2, {
				iter_36_1,
				iter_36_2,
				var_36_6 + 1000 - var_36_8
			})

			IsUnityEditor = var_1_10015

			if var_1_10015 then
				warning = var_1_10015

				var_1_10015("剪影ID " .. iter_36_1 .. " 照片ID " .. iter_36_2 .. " 分数 " .. var_36_6 .. " 时间差 " .. var_36_8)
			end
		end
	end
	...
	local var_36_10 = var_3.KM

	Dorm3dDanceConst = var_4

	local var_36_11, var_36_12 = var_36_10(var_4.PHOTO_TIMES, var_36_2)
	local var_36_13 = 1

	Dorm3dDanceConst = var_1_10006

	for iter_36_3 = var_36_13, var_1_10006.CUCOLORIS_COUNT do
		arg_36_0.contextData.match[iter_36_3] = var_36_12[iter_36_3]

		local var_36_14 = arg_36_0.contextData.cucoloris[iter_36_3]
		local var_36_15, var_36_16, var_36_17 = var_9.CalcScore(var_36_14, arg_36_0.contextData.photoData[var_36_12[iter_36_3]])

		var_36_9 = var_36_9 + var_36_15
		IsUnityEditor = var_12

		if var_12 then
			warning = var_12

			var_12("剪影ID " .. iter_36_3 .. " 匹配照片ID " .. var_36_12[iter_36_3])
		end
	end

	pg = var_36_13

	local var_36_18 = var_36_13.m02
	local var_36_19 = var_5.sendNotification

	GAME = var_7

	local var_36_20 = var_7.APARTMENT_TRACK

	Dorm3dTrackCommand = iter_36_3

	var_36_19(var_36_18, var_36_20, iter_36_3.BuildDataDance(arg_36_0.contextData.groupId, var_36_9))
...
function var_0_1.TakePhoto(arg_37_0)
	...
	arg_37_0.ShowOrHideUI(var_37_0, false)
	...
	local function var_37_1(arg_38_0)
		...
		var_38_2.time = var_4.GetTime(var_38_3)
	...
	Dorm3dHxHelper = var_37_0

	local var_37_2, var_37_3 = var_37_0.GetHolyLightScreenShotInfo(arg_37_0.holyLightRoot)

	GraphicsInterface = var_1_10004

	local var_37_4 = var_1_10004.Instance

	var_4.TakePhotoWithPost(var_37_4, arg_37_0.timelineCamera, var_37_2, var_37_3, var_37_1)
...
function var_0_1.SwtichCamera(arg_42_0, arg_42_1)
	...
	var_42_1(var_42_0, var_4.GetTime(var_42_2))
...
function var_0_1.ShowRealImage(arg_43_0, arg_43_1, arg_43_2, arg_43_3)
	...
	var_43_2(var_43_1, var_1_10007(var_1_10008)).texture = var_43_0
	...
	Vector3 = var_7
	arg_43_2.localScale = var_7(var_43_3, var_43_3, 1)
...
function var_0_1.SaveImage(arg_44_0, arg_44_1)
	local function var_44_0(arg_45_0)
		...
		local var_45_5 = (var_4.width - var_45_1) / 2

		Screen = var_5

		local var_45_6 = (var_5.height - var_45_3) / 2
		local var_45_7 = arg_45_0:GetPixels(var_45_5, var_45_6, var_45_1, var_45_3)

		var_45_4:SetPixels(var_45_7)
		var_45_4:Apply()

		Tex2DExtension = var_7

		local var_45_8 = var_7.EncodeToJPG(var_45_4)

		YSNormalTool = var_8

		var_8.MediaTool.SaveImageWithBytes(var_45_8, function(arg_46_0, arg_46_1)
			if arg_46_0 then
				pg = var_3_10002
				...
				var_46_1(var_46_0, var_3_10004("word_save_ok"))
			end
