...
function var_0_1.InitIKControlRoots(arg_2_0)
	...
	if not var_2(var_3.Find(var_2_3, "Click")) then
		IsNil = var_2

		local var_2_4 = arg_2_0.ikTouchTipTpl

		var_2_5 = not var_2(var_3.Find(var_2_4, "Hold"))
	else
		var_2_5 = false
	end
...
function var_0_1.InitButtons(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "btn_back/help")
	...
	local function var_5_3()
		...
		i18n = var_2_10003
		var_6_2.helps = var_2_10003("roll_gametip")
	...
	local var_5_6 = var_3.Find(var_5_5, "Right/btn_camera")
	...
	local function var_5_7()
		...
		var_7_1(var_7_0, var_2_10002.CYCLE_IK_CAMERA_GROUP)
	...
	local var_5_10 = var_3.Find(var_5_9, "Right/MenuSmall")
	...
	local function var_5_11()
		...
		var_2_10000(var_1.Find(var_8_0, "Right/MenuSmall"), false)

		setActive = var_2_10000

		local var_8_1 = arg_5_0.rtIKUI

		var_2_10000(var_1.Find(var_8_1, "Right/Menu"), true)
	...
	local var_5_14 = var_3.Find(var_5_13, "Right/Menu/Collapse")
	...
	local function var_5_15()
		...
		var_2_10000(var_1.Find(var_9_0, "Right/Menu"), false)

		setActive = var_2_10000

		local var_9_1 = arg_5_0.rtIKUI

		var_2_10000(var_1.Find(var_9_1, "Right/MenuSmall"), true)
	...
	local var_5_18 = var_3.Find(var_5_17, "Right/Menu")
	...
	local function var_5_19()
		...
		var_2_10000(var_1.Find(var_10_0, "Right"), false)
		...
		local var_10_3 = var_2.OPEN_SKIN_SELECT_LAYER
		local var_10_4 = arg_5_0.contextData.GetApartment()

		var_10_2(var_10_1, var_10_3, var_3.GetConfigID(var_10_4), arg_5_0.contextData.GetCurrentLadyEnv(), function(arg_11_0, arg_11_1, arg_11_2)
			local var_11_0 = arg_5_0
			local var_11_1 = var_3.emit

			RoomIKSystem = var_3_10005

			var_11_1(var_11_0, var_3_10005.SWITCH_IK_SKIN, arg_11_0, arg_11_1, arg_11_2)
			...
			var_3_10000(var_1.Find(var_12_0, "Right"), true)
	...
	var_1_10001(var_5_16, var_5_18, var_5_19, var_5)
...
function var_0_1.InitDragEvent(arg_13_0)
	...
	typeof = var_1_10004
	SlideController = var_1_10005

	if var_13_2(var_13_1, var_1_10004(var_1_10005)) then
		IsNil = var_13_1

		if not var_13_1(var_2) then
			var_2:ClearEvents()
	...
	GetOrAddComponent = var_13_1

	local var_13_3 = arg_13_0.controlLayer

	typeof = var_1_10005
	SlideControllerHotfix = var_1_10006

	local var_13_4 = var_13_1(var_13_3, var_1_10005(var_1_10006))
	...
	var_3:AddBeginDragFunc(function(arg_16_0, arg_16_1)
		...
		var_16_6(var_16_5, var_9.ON_BEGIN_DRAG_CHARACTER_BODY, var_2, var_16_4, var_16_0)
	...
	var_3:AddDragFunc(function(arg_17_0, arg_17_1)
		if arg_13_0.contextData.GetCurrentLadyEnv().ikHandler then
			...
			var_17_1(var_17_0, var_2_10005.ON_DRAG_CHARACTER_BODY, var_2, arg_17_1.position)
		...
		var_17_3(var_17_2, var_2_10005.ON_STICK_MOVE, arg_17_1.delta)
	...
	var_3:AddDragEndFunc(function(arg_18_0, arg_18_1)
		...
		if arg_13_0.contextData.GetCurrentLadyEnv().ikHandler then
			...
			var_18_1(var_18_0, var_2_10005.ON_RELEASE_CHARACTER_BODY, var_2)
		end
...
function var_0_1.EmitTouchPress(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	if arg_22_2.source == "body" then
		...
		if arg_22_1 then
			...
			if not var_1_10006.ON_TOUCH_CHARACTER_DOWN then
				RoomTouchSystem = var_1_10006
				var_1_10006 = var_1_10006.ON_TOUCH_CHARACTER_UP
			end

			var_22_1(var_22_0, var_1_10006, arg_22_2.target, arg_22_3)
			...
			if arg_22_2.source == "scene_item" then
				...
				if arg_22_1 then
					...
					if not var_1_10006.ON_TOUCH_SCENE_ITEM_DOWN then
						RoomTouchSystem = var_1_10006
						var_1_10006 = var_1_10006.ON_TOUCH_SCENE_ITEM_UP
					end

					var_22_3(var_22_2, var_1_10006, arg_22_2.target, arg_22_3)
...
function var_0_1.InitEvents(arg_23_0)
	...
	arg_23_0:bind(var_0_1.SET_CAMERA_BUTTON_ACTIVE, function(arg_25_0, arg_25_1)
		...
		var_2_10002(var_3.Find(var_25_0, "Right/btn_camera"), arg_25_1)
	...
	arg_23_0:bind(var_0_1.RESET_ENTRY_MENU, function(arg_26_0, arg_26_1)
		...
		var_2_10002(var_3.Find(var_26_0, "Right/MenuSmall"), arg_26_1)

		setActive = var_2_10002

		local var_26_1 = arg_23_0.rtIKUI

		var_2_10002(var_3.Find(var_26_1, "Right/Menu"), false)
	...
	arg_23_0:bind(var_0_1.SET_BACK_BUTTON_ACTIVE, function(arg_27_0, arg_27_1)
		...
		var_2_10002(var_3.Find(var_27_0, "btn_back"), arg_27_1)
...
function var_0_1.UpdateTextTips(arg_35_0, arg_35_1)
	...
	var_1_10002.each(arg_35_1 or {}, function(arg_37_0)
		if not arg_37_0:getConfig("tip_text") or #var_1 == 0 then
			return
		end

		local var_37_0 = arg_35_0.ikTextTipsRoot
		local var_37_1 = var_2.Find(var_37_0, var_1)

		IsNil = var_37_0

		if not var_37_0(var_37_1) then
			setActive = var_3
...
function var_0_1.UpdateHoldProgress(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	local var_39_1 = var_6.ScreenToLocal
	local var_39_2 = arg_39_0.holdProgressRoot
	local var_39_3 = arg_39_2

	pg = var_1_10009

	var_4(var_39_0, var_39_1(var_39_2, var_39_3, var_1_10009.UIMgr.GetInstance().uiCameraComp))
	...
	local var_39_7 = var_5(var_39_6, var_39_2(var_39_3))

	IsNil = var_39_6

	if not var_39_6(var_39_7) then
		math = var_6
...
function var_0_1.SetTouchTipType(arg_41_0, arg_41_1, arg_41_2)
	...
	local var_41_2 = arg_41_1.Find(var_41_1, "Hold")
	...
	if not var_6(var_41_0) then
		IsNil = var_6
		var_41_3 = not var_6(var_41_2)
	else
		var_41_3 = false
	end
	...
	var_41_1(var_41_3, "TouchTips/tpl item missing Click or Hold")
	...
	var_41_1(var_41_4, arg_41_2 == var_7.TRIGGER_CLICK)
	...
	var_41_1(var_41_5, arg_41_2 == var_7.TRIGGER_LONG_PRESS)
...
function var_0_1.UpdateTouchTips(arg_42_0, arg_42_1, arg_42_2)
	...
	var_1_10003.StaticAlign(arg_42_0.ikTouchTipsRoot, arg_42_0.ikTouchTipTpl, #arg_42_2, function(arg_43_0, arg_43_1, arg_43_2)
		...
		if var_43_0 then
			...
			if var_43_8(var_43_7, var_10(var_2_10011.Collider)) then
				var_43_6 = var_8.bounds.center
			end

			setLocalPosition = var_43_7

			var_43_7(arg_43_2, arg_42_0.contextData.GetLocalPosition(arg_42_0.contextData.GetScreenPosition(var_43_6, arg_42_1.IKSettings.CameraRaycaster.eventCamera), arg_42_0.ikTouchTipsRoot) + var_43_1)
		end
...
function var_0_1.PlayHandBegin(arg_44_0)
	...
	var_1(var_2.Find(var_44_0, "Begin"), true)
	...
	arg_44_0.handTimer = var_1.New(function()
		...
		var_2_10000(var_1.Find(var_46_0, "Begin"), false)

		setActive = var_2_10000

		local var_46_1 = arg_44_0.ikHand

		var_2_10000(var_1.Find(var_46_1, "Normal"), true)
...
function var_0_1.PlayHandEnd(arg_49_0)
	...
	var_1(var_2.Find(var_49_0, "Begin"), false)

	setActive = var_1

	local var_49_1 = arg_49_0.ikHand

	var_1(var_2.Find(var_49_1, "Normal"), false)

	setActive = var_1

	local var_49_2 = arg_49_0.ikHand

	var_1(var_2.Find(var_49_2, "End"), true)
	...
	arg_49_0.handTimer = var_1.New(function()
		...
		var_2_10000(var_1.Find(var_50_0, "End"), false)
...
function var_0_1.UpdateTips(arg_52_0, arg_52_1, arg_52_2)
	if arg_52_1 and arg_52_2 then
		...
		local var_52_3 = var_52_1.StaticAlign
		local var_52_4 = arg_52_0.ikTipsRoot
		local var_52_5 = arg_52_0.ikTipsRoot

		var_52_3(var_52_4, var_6.GetChild(var_52_5, 0), #var_52_2, function(arg_54_0, arg_54_1, arg_54_2)
			UIItemList = var_2_10003
			...
			if var_54_3 then
				...
				if var_54_7(var_54_6, var_2_10010(var_2_10011.Collider)) then
				...
				var_10(arg_54_2, var_54_8)

				local var_54_9 = var_5:GetTriggerRect()
				local var_54_10 = var_10.PointToNormalized

				Vector2 = var_2_10013

				local var_54_11 = var_54_10(var_54_9, var_2_10013.zero)

				Vector2 = var_54_9

				local var_54_12 = var_54_9.zero

				if var_54_11.x < 0.5 and var_54_11.y < 0.5 then
					var_54_12 = var_10.max
				else
					local var_54_13 = var_54_11.x

					if 0.5 <= var_54_13 and var_54_11.y < 0.5 then
						Vector2 = var_13
						var_54_12 = var_13.New(var_10.xMin, var_10.yMax)
					else
						if var_54_11.x < 0.5 then
							local var_54_14 = var_54_11.y

							if 0.5 <= var_54_14 then
								Vector2 = var_54_14
								var_54_12 = var_54_14.New(var_10.xMax, var_10.yMin)

								goto label_54_0
							end
						end

						local var_54_15 = var_54_11.x

						if 0.5 <= var_54_15 then
							local var_54_16 = var_54_11.y

							if 0.5 <= var_54_16 then
								var_54_12 = var_10.min
							end
						end
					end
				end
				...
				if var_54_11.x == 0.5 then
					if var_54_8.x < 0 then
						var_54_12.x = var_10.xMax
					else
						var_54_12.x = var_10.xMin
					end
				end

				if var_54_11.y == 0.5 then
					if var_54_8.y < 0 then
						var_54_12.y = var_10.yMax
					else
						var_54_12.y = var_10.yMin
					end
				end

				local var_54_17 = var_54_12 - var_10.center

				setLocalRotation = var_14

				local var_54_18 = arg_54_2

				Quaternion = var_2_10016

				local var_54_19 = var_2_10016.LookRotation

				Vector3 = var_2_10017

				local var_54_20 = var_2_10017.forward

				Vector3 = var_2_10018

				var_14(var_54_18, var_54_19(var_54_20, var_2_10018.New(var_54_17.x, var_54_17.y, 0)))
			end
