...
function var_0_1.init(arg_2_0)
	...
	local var_2_5 = var_2_3.dorm3d_camera_photo_frame.all
	...
	local function var_2_6()
		...
		var_3_0(var_3_1, var_2.GetChild(var_3_2, 0), #var_2_5, function(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_2_7 = var_1_10004.UIMgr.GetInstance()
	...
	var_4.StaticAlign(var_2_4, var_2_4:GetChild(0), #var_2_5, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_4(var_2_10005.format("Dorm3DPhoto/%s", var_5_0.farme_small_path), "", arg_5_2:Find("Icon"))
		...
		var_6(arg_2_0, arg_5_2, function()
			if not var_5_1 then
				...
				var_0.ShowTips(var_6_0, var_5_2)
			...
			local var_6_1 = var_5_0.frameTfName == "FilmFrame"
			local var_6_2 = var_5_0.frameTfName == "InsFrame"
			...
			local function var_6_3(arg_7_0)
				...
				typeof = var_4_10004
				RawImage = var_4_10005
				var_7_1(var_7_0, var_4_10004(var_4_10005)).texture = arg_2_0.contextData.photoTex
				GameObject = var_3
				...
				for iter_7_0, iter_7_1 in var_5(var_7_3) do
					...
					typeof = var_4_10013
					RawImage = var_4_10014
					var_7_5(var_7_4, var_4_10013(var_4_10014)).texture = arg_2_0.contextData.photoTex
					GameObject = var_12
					var_4_10013 = var_12.Find("OverlayCamera").transform

					local var_7_6 = var_12.GetChild(var_4_10013, 0)

					if var_6_2 and iter_7_1 == "mask_up/realImage" then
						Vector2 = var_4_10013
						var_10.sizeDelta = var_4_10013(var_7_6.sizeDelta.x / 10, var_7_6.sizeDelta.y / 10)
					else
						var_10.sizeDelta = var_7_6.sizeDelta
					end

					setAnchoredPosition = var_4_10013
					...
					Vector3 = var_4_10013
					var_10.localScale = var_4_10013(1, 1, 1)
				end
			...
			local var_6_4 = arg_2_0.loadingDic

			var_6_4[arg_5_1] = true
			ResourceMgr = var_6_4

			local var_6_5 = var_6_4.Inst
			local var_6_6 = var_4.getAssetAsync
			local var_6_7 = "ui/" .. var_5_0.frameTfName
			local var_6_8 = ""

			UnityEngine = var_3_10008

			var_6_6(var_6_5, var_6_7, var_6_8, var_3_10008.Events.UnityAction_UnityEngine_Object(function(arg_8_0)
				...
				;(function()
					...
					for iter_9_0, iter_9_1 in var_5_10000(var_8_2) do
						...
						local var_9_3 = var_9_0(var_7.Find(var_9_2, iter_9_1), "PinchZoom")

						GetOrAddComponent = var_7

						local var_9_4 = var_8_1
						local var_9_5 = var_7(var_8.Find(var_9_4, iter_9_1), "EventTriggerListener")
						local var_9_6 = true

						var_9_5:AddPointDownFunc(function(arg_10_0)
							Input = var_6_10001
						...
						var_9_5:AddPointUpFunc(function(arg_11_0)
							Input = var_6_10001
						...
						local var_9_7 = var_9.Find("OverlayCamera").transform
						local var_9_8 = var_9.GetChild(var_9_7, 0).sizeDelta

						if var_6_2 and iter_9_1 == "mask_up/realImage" then
							Vector2 = var_10
							var_9_8 = var_10(var_9_8.x / 10, var_9_8.y / 10)
						end

						local var_9_9 = var_8_1
						local var_9_10 = var_10.Find(var_9_9, var_8_3[iter_9_0]).sizeDelta

						var_9_5:AddBeginDragFunc(function(arg_12_0, arg_12_1)
						...
						local var_9_11 = var_11.max(var_9_10.x / var_9_8.x, var_9_10.y / var_9_8.y)

						LateUpdateBeat = var_12

						local var_9_12 = var_12
						local var_9_13 = var_12.CreateListener(var_9_12, function()
							if var_9_3.processing then
								local var_13_1

								if var_9_1.localScale.x < var_9_11 then
									local var_13_0 = var_9_1

									Vector3 = var_2
									var_13_0.localScale = var_2(var_9_11, var_9_11, var_13_1.z)
									var_13_1 = var_9_1.localScale
								end

								local var_13_2 = (var_9_8.x * var_13_1.x - var_9_10.x) / 2
								local var_13_3 = (var_9_8.y * var_13_1.x - var_9_10.y) / 2
								...
								local var_13_5 = var_4.clamp(var_9_1.localPosition.y, -var_13_3, var_13_3)
						...
						LateUpdateBeat = var_9_12

						var_9_12:AddListener(var_9_13)

						if var_6_1 or var_6_2 then
							table = var_13

							var_13.insert(arg_2_0.specialLateFuncDic, var_9_13)
						else
							arg_2_0.lateFuncDic[arg_5_1] = var_9_13
						end

						var_9_5:AddDragFunc(function(arg_14_0, arg_14_1)
							if var_9_3.processing then
								return
							end
							...
							if var_9_6 then
								...
								local var_14_1 = (var_9_8.x * var_14_0.x - var_9_10.x) / 2
								local var_14_2 = (var_9_8.y * var_14_0.x - var_9_10.y) / 2
								...
								touchOffsetX = var_6_10007

								local var_14_5 = var_14_3(var_14_4 - var_6_10007, -var_14_1, var_14_1)

								math = var_6

								local var_14_6 = var_6.clamp
								local var_14_7 = arg_14_1.position.y

								touchOffsetY = var_8

								local var_14_8 = var_14_6(var_14_7 - var_8, -var_14_2, var_14_2)
...
function var_0_1.SelectFrame(arg_18_0)
	...
	local var_18_3 = var_2:Find("mask/realImage").localScale
	local var_18_4

	pg = var_6

	if var_6.dorm3d_camera_photo_frame[var_18_0].frameTfName == "FilmFrame" or var_6 == "InsFrame" then
		var_18_4 = {
		...
		if var_2:Find("mask_down/realImage") then
			var_18_4.downPos = var_2:Find("mask_down/realImage").anchoredPosition
			var_18_4.downScale = var_2:Find("mask_up/realImage").localScale
		end
	end

	local var_18_5 = arg_18_0
	local var_18_6 = arg_18_0.emit

	Dorm3dPhotoSelectFrameMediator = var_1_10009

	var_18_6(var_18_5, var_1_10009.CONFIRMFRAME, var_18_0, var_18_2, var_18_3, var_18_4)
