...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SHARE_PANEL, function(arg_2_0, arg_2_1, arg_2_2)
		...
		Dorm3dPhotoShareLayerMediator = var_2_10007
		var_2_3.mediator = var_2_10007
		Dorm3dPhotoShareLayer = var_2_10007
	...
	arg_1_0:bind(var_0_1.GO_AR, function(arg_3_0, arg_3_1)
		...
		if var_2_10002 then
			...
			var_2_10002(var_3_0, var_2_10004("dorm3d_AR_switch"))
		...
		if var_2.IsYunPackage(var_3_1) then
			...
			var_2.ShowTips(var_3_2, "指挥官，当前平台不支持该功能哦")
		...
		local function var_3_5()
			...
			local var_4_3 = var_3_10003.DORM3D_AR
			local var_4_4 = {
				ARCheckState = arg_3_1
			}
			local var_4_5 = var_1_0.room

			var_4_4.roomId = var_5.GetConfigID(var_4_5)

			local var_4_6 = var_1_0.apartment

			var_4_4.groupId = var_5.GetConfigID(var_4_6)
		...
		local function var_3_6()
			...
			if var_3_10000.IsAndroid() then
				...
				i18n = var_3_10003
				var_5_2.content = var_3_10003("apply_permission_camera_tip3")

				function var_5_2.onYes()
					PermissionHelper = var_4_10000

					var_4_10000.RequestCamera(var_3_5, var_3_6)
				...
				if var_5_1.IsIOS() then
					...
					i18n = var_3_10003
					var_5_5.content = var_3_10003("apply_permission_camera_tip2")
		...
		local var_3_7 = var_2_10004.MsgboxMgr.GetInstance()
		local var_3_8 = var_4.ShowMsgBox
		local var_3_9 = {}

		i18n = var_2_10007
		var_3_9.content = var_2_10007("apply_permission_camera_tip1")

		function var_3_9.onYes()
			PermissionHelper = var_3_10000

			var_3_10000.RequestCamera(var_3_5, var_3_6)

			return
		end

		var_3_8(var_3_7, var_3_9)
	...
	arg_1_0:bind(var_0_1.OPEN_SKIN_SELECT_LAYER, function(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
		...
		Dorm3dSkinSelectLayer = var_2_10009
		var_8_3.viewComponent = var_2_10009
		Dorm3dSkinSelectMediator = var_2_10009
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	ApartmentProxy = var_10_1

	if var_10_0 == var_10_1.UPDATE_APARTMENT then
		-- block empty
	elseif var_10_0 == var_0_1.CAMERA_LIFT_CHANGED then
		local var_10_3 = arg_10_0.viewComponent

		var_4.SetPhotoCameraSliderValue(var_10_3, var_10_2.value)
	elseif var_10_0 == var_0_1.CAMERA_STICK_MOVE then
