...
function var_0_1.OnSwitchGun(arg_8_0, arg_8_1)
	...
	var_3(var_8_1, var_8_2 .. var_1_10006(arg_8_1))
	...
	var_3(var_8_3, var_8_4 .. var_6(arg_8_1))
	...
	var_8_5(var_8_6, "CarWash gun model not found: " .. var_8_0.name)
...
function var_0_1.UpdateCommonRaycast(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_1_10004.EFFECT_LAYER_MASK

	CarWashConst = var_1_10005

	local var_9_3, var_9_4 = var_9_1(var_9_0, var_9_2, var_1_10005.DEFAULT_RAY_DISTANCE)
...
function var_0_1.UpdateDecalRaycast(arg_10_0, arg_10_1)
	...
	local var_10_5 = var_1_10005.LAYER_MASK

	CarWashConst = var_1_10006

	local var_10_6, var_10_7 = var_10_4(var_10_3, var_10_5, var_1_10006.DEFAULT_RAY_DISTANCE)
	...
	CarWashDecalSystem = var_1_10011

	var_10_9(var_10_8, var_10_10, var_10_11, var_10_12, var_10_13, var_1_10011.ON_SHOOT_INTERVAL)
...
function var_0_1.GetScreenCenterPoint(arg_12_0)
	...
	local var_12_1 = var_1_10002.width * 0.5

	Screen = var_1_10003

	return var_12_0(var_12_1, var_1_10003.height * 0.5, 0)
end
...
function var_0_1.RaycastScreenCenter(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_1 = arg_15_0.GetScreenCenterRay(var_15_0)

	if not arg_15_2 then
		CarWashConst = var_15_0
		arg_15_2 = var_15_0.DEFAULT_RAY_DISTANCE
	end

	Physics = var_15_0

	return var_15_0.Raycast(var_15_1.origin, var_15_1.direction, nil, arg_15_2, arg_15_1)
end
