...
function var_0_1.InitConfig(arg_2_0)
	...
	var_1(var_2_0, var_2_1 .. var_1_10004(arg_2_0.contextData.gameConfig.pos_phase2))
...
function var_0_1.InitUI(arg_3_0)
	...
	arg_3_0.tipList = var_3_1(var_3_2, var_3.Find(var_3_3, "tips/tpl"))
	...
	var_1.make(var_3_4, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventInit then
			...
			var_3(arg_3_0, arg_4_2, function()
				...
				var_5_1(var_5_0, var_3_10003.PLAY_PHASE2_REACTION, {
					animId = var_0.animId
				})
...
function var_0_1.BindEvent(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.UPDATE_GAME_STATE, function(arg_7_0, arg_7_1)
		...
		local var_7_2 = arg_7_1.newValue

		CarWashConst = var_7_1

		if var_7_2 ~= var_7_1.GAME_STATE.PHASE_1 then
			do
				local var_7_3 = arg_7_1.newValue

				CarWashConst = var_3

				if var_7_3 == var_3.GAME_STATE.END then
	...
	CarWashLadySystem = var_3

	var_6_3(var_6_2, var_3.UPDATE_PHASE2_TIPS, function(arg_8_0, arg_8_1)
	...
	var_6_5(var_6_4, var_3.UPDATE_PHASE2_REACTION_PROGRESS, function(arg_9_0, arg_9_1)
...
function var_0_1.UpdateTipItem(arg_11_0, arg_11_1, arg_11_2)
	...
	var_1_10004(var_11_1, var_11_2 .. var_1_10007(arg_11_1))
	...
	if var_11_0.visible then
		...
		local var_11_4 = var_6.ScreenToLocal
		local var_11_5 = arg_11_0.tipContainer
		local var_11_6 = var_11_0.screenPosition

		pg = var_1_10009

		var_4(var_11_3, var_11_4(var_11_5, var_11_6, var_1_10009.UIMgr.GetInstance().uiCameraComp))
	end
