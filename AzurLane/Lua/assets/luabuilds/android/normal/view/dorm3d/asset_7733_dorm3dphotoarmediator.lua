...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.PLAY_SINGLE_ACTION, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.PLAY_SINGLE_ACTION, {
			name = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.SCENE_CALL, function(arg_4_0, arg_4_1, ...)
		...
		local var_4_2 = var_2_10004.SCENE_CALL
		local var_4_3 = {
			name = arg_4_1
		}

		packEx = var_2_10006
		var_4_3.args = var_2_10006(...)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	ApartmentProxy = var_8_1

	if var_8_0 == var_8_1.UPDATE_APARTMENT then
		-- block empty
	elseif var_8_0 == var_0_1.Camera_Pinch_Value_Change then
		...
		if var_8_0 == var_4.INIT_AR_PLANE then
			...
			if var_8_0 == var_4.AR_INIT_FINISH then
