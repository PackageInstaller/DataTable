...
function var_0_1.GetOrCreateTransitionDirector(arg_7_0)
	...
	arg_7_0.transitionDirector = var_1(var_7_0, var_1_10003(var_1_10004.Playables.PlayableDirector))
...
function var_0_1.SetTransitionAsset(arg_8_0, arg_8_1)
	...
	if not arg_8_0.transitionPlayer then
		...
		arg_8_0.transitionPlayer = var_8_1(var_8_2, var_1_10005.Playables.DirectorWrapMode.None)
	end
...
function var_0_1.PlayTransition(arg_10_0, arg_10_1)
	...
	var_1_10002(var_10_0, var_10_1 .. var_1_10005(arg_10_1.type))
	...
	var_1_10002(var_10_2, var_10_3 .. var_5(arg_10_1.type))
...
function var_0_1.LoadTransitionAsset(arg_12_0, arg_12_1, arg_12_2)
	...
	var_5(var_12_2, var_12_3 .. var_1_10008(arg_12_1.type))
	...
	var_12_5(var_12_4, var_12_6, var_12_7, var_9(var_1_10010.Playables.PlayableAsset), function(arg_13_0)
		assert = var_2_10001
		...
		var_2_10001(var_13_0, var_13_1 .. var_2_10004(var_12_1))
...
function var_0_1.OnTransitionSignal(arg_14_0, arg_14_1)
	...
	elseif var_2 == var_0_1.SIGNAL.TIMELINE_END then
		...
		var_3(var_14_0, var_14_1 .. var_1_10006(var_2))
	end
...
function var_0_1.LoadArtScene(arg_22_0, arg_22_1, arg_22_2)
	...
	var_22_1(var_22_0, var_22_2, var_22_3, var_1_10007.Additive, function(arg_23_0, arg_23_1)
		assert = var_2_10002
...
function var_0_1.StartArtPlayer(arg_24_0, arg_24_1)
	...
	local var_24_1 = arg_24_0.FindArtDirector(var_24_0, arg_24_1)

	assert = var_24_0

	var_24_0(var_24_1, "CarWash art timeline director not found")

	arg_24_0.artDirector = var_24_1

	local var_24_2 = arg_24_0.artDirector

	var_24_2.playOnAwake = false
	TimelineSupport = var_24_2

	var_24_2.DisablePlayOnAwake(arg_24_0.artDirector)

	TimelinePlayer = var_3

	local var_24_3 = var_3.New
	local var_24_4 = arg_24_0.artDirector.transform

	UnityEngine = var_5
	arg_24_0.artPlayer = var_24_3(var_24_4, var_5.Playables.DirectorWrapMode.Loop)

	local var_24_5 = arg_24_0.artPlayer

	var_3.Register(var_24_5, nil, function(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_24_6 = arg_24_0.artPlayer
	local var_24_7 = var_3.SetTime
	local var_24_8
	...
	var_24_7(var_24_6, var_24_8)

	local var_24_9 = arg_24_0.artPlayer.comDirector

	var_3.Evaluate(var_24_9)

	local var_24_10 = arg_24_0.artPlayer

	var_3.Start(var_24_10)
...
function var_0_1.FindArtDirector(arg_26_0, arg_26_1)
	...
	var_1_10007.IpairsCArray(var_26_3, function(arg_27_0, arg_27_1)
		if var_26_4 then
			return
		end
		...
		if var_2(arg_27_1).name == var_26_1 and var_2 or var_2:Find(var_26_1) then
			...
			var_26_4 = var_27_1(var_27_0, var_2_10006(var_2_10007.Playables.PlayableDirector))
		end
...
function var_0_1.OnArtTimelineSignal(arg_28_0, arg_28_1)
	...
	if var_28_1 == var_0_1.SIGNAL.EXIT_TRANSITION then
		...
		var_4(var_28_2, var_28_3 .. var_7(var_28_1))
	end
