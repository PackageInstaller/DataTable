...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_2({
		...
		local var_2_8 = var_9.Find(var_2_7, "content/toggles/" .. iter_2_1)
		...
		var_1_10007(var_2_6, var_2_8, var_2_9, var_11)
	end
	...
	UIItemList = var_2_10
	arg_2_0.giftItemList = var_2_10.New(var_2_11, var_2_11:Find("tpl"))

	local var_2_12 = arg_2_0.giftItemList

	var_3.make(var_2_12, function(arg_5_0, arg_5_1, arg_5_2)
		arg_5_1 = arg_5_1 + 1
	...
	local var_2_13 = arg_2_0.rtGiftPanel

	arg_2_0.btnConfirm = var_3.Find(var_2_13, "bottom/btn_confirm")
	onButton = var_3

	local var_2_14 = arg_2_0
	local var_2_15 = arg_2_0.btnConfirm
	...
	var_3(var_2_14, var_2_15, var_2_16, var_7)

	local var_2_17 = arg_2_0._tf

	arg_2_0.rtInfoWindow = var_3.Find(var_2_17, "info_window")
	onButton = var_3

	local var_2_18 = arg_2_0
	local var_2_19 = arg_2_0.rtInfoWindow
	local var_2_20 = var_5.Find(var_2_19, "bg")
	...
	var_3(var_2_18, var_2_20, var_2_21, var_7)

	onButton = var_3

	local var_2_22 = arg_2_0
	local var_2_23 = arg_2_0.rtInfoWindow
	local var_2_24 = var_5.Find(var_2_23, "panel/title/btn_close")
	...
	var_3(var_2_22, var_2_24, var_2_25, var_7)

	local var_2_26 = arg_2_0._tf

	arg_2_0.rtLackWindow = var_3.Find(var_2_26, "lack_window")
	onButton = var_3

	local var_2_27 = arg_2_0
	local var_2_28 = arg_2_0.rtLackWindow
	local var_2_29 = var_5.Find(var_2_28, "bg")
	...
	var_3(var_2_27, var_2_29, var_2_30, var_7)

	onButton = var_3

	local var_2_31 = arg_2_0
	local var_2_32 = arg_2_0.rtLackWindow
	local var_2_33 = var_5.Find(var_2_32, "panel/title/btn_close")
	...
	var_3(var_2_31, var_2_33, var_2_34, var_7)
...
function var_0_1.didEnter(arg_13_0)
	...
	var_1_10001(var_2.Find(var_13_0, "content/toggles/all"), true)
...
function var_0_1.UpdateGift(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local var_20_2 = var_20_0.New
	local var_20_3 = {}

	DROP_TYPE_DORM3D_GIFT = var_1_10007
	var_20_3.type = var_1_10007
	var_20_3.id = arg_20_2

	local var_20_4 = arg_20_0.proxy

	var_20_3.count = var_7.getGiftCount(var_20_4, arg_20_2)

	local var_20_5 = var_20_2(var_20_3)

	updateCustomDrop = var_20_3

	var_20_3(var_20_1:Find("Dorm3dIconTpl"), var_20_5)

	setText = var_20_3

	var_20_3(var_20_1:Find("info/name"), var_20_5:getName())
	...
	var_20_6(var_20_1:Find("mark"), var_20_7)

	setActive = var_20_6

	var_20_6(var_20_1:Find("bg/normal"), not var_20_7)

	setActive = var_20_6

	var_20_6(var_20_1:Find("bg/pro"), var_20_7)
	...
	local var_20_10 = var_20_8("dorm3d_gift_owner_num")

	string = var_10

	var_20_6(var_20_9, var_20_10 .. var_10.format("%d", var_20_5.count))

	setActive = var_20_6

	local var_20_11 = var_20_1
	local var_20_12 = var_20_1.Find(var_20_11, "info/overtime")

	Dorm3dGift = var_20_11

	var_20_6(var_20_12, var_20_11.IsExpireSoon(arg_20_2))

	local var_20_13 = var_20_1
	local var_20_14 = var_20_1.Find(var_20_13, "info/effect")

	setActive = var_20_13

	var_20_13(var_20_14:Find("favor"), true)

	pg = var_20_13

	local var_20_15 = var_20_13.dorm3d_favor_trigger[var_20_5.cfg.favor_trigger_id].num

	setText = var_9

	var_9(var_20_14:Find("favor/number"), "+" .. var_20_15)

	setActive = var_9

	local var_20_16 = var_20_14
	local var_20_17 = var_20_14.Find(var_20_16, "story")

	pg = var_20_16

	var_9(var_20_17, var_20_16.dorm3d_gift[arg_20_2].unlock_dialogue_id ~= 0)

	onButton = var_9

	local var_20_18 = arg_20_0
	local var_20_19 = var_20_1:Find("info/btn_info")
	...
	var_9(var_20_18, var_20_19, var_20_20, var_13)

	Dorm3dGift = var_9

	local var_20_21 = var_9.New({
		configId = arg_20_2
	})
	...
	if var_10.IsSingleGiveGift(arg_20_2) then
		local var_20_22 = arg_20_0.proxy

		var_20_23 = var_10.isGiveGiftDone(var_20_22, arg_20_2)
	end

	local var_20_24 = var_20_21
	local var_20_25 = var_20_21.GetShopID(var_20_24)

	setActive = var_20_24

	var_20_24(var_20_1:Find("info/lack"), var_20_25 ~= 0)

	if var_20_25 ~= 0 then
		CommonCommodity = var_20_24
		var_20_24 = var_20_24.New
		...
		local var_20_27 = var_20_24(var_20_26, var_14.TYPE_SHOPSTREET)
		local var_20_28, var_20_29, var_20_30 = var_20_24.GetPrice(var_20_27)

		Drop = var_1_10016

		local var_20_31 = var_1_10016.New
		local var_20_32 = {}

		DROP_TYPE_RESOURCE = var_1_10018
		var_20_32.type = var_1_10018
		var_20_32.id = var_20_24:GetResType()
		var_20_32.count = var_20_28

		local var_20_33 = var_20_31(var_20_32)

		setActive = var_20_32

		local var_20_34 = var_20_1

		var_1_10018 = var_20_1.Find(var_20_34, "info/lack/tip")

		if var_20_7 then
			::label_20_0::

			if not var_20_23 then
				Dorm3dGift = var_20_34

				if var_20_34.GetViewedFlag(arg_20_2) ~= 0 then
					var_20_34 = false
				else
					var_20_34 = true
				end

				var_20_32(var_1_10018, var_20_34)
				...
				var_20_34.each(var_20_21:getConfig("shop_id"), function(arg_22_0)
					pg = var_2_10001

					if var_2_10001.shop_template[arg_22_0].group_type == 2 then
						math = var_2
						var_1_10018 = var_2.max(var_1.group_limit, var_1_10018)
					end
				...
				if 0 < var_1_10018 then
					var_20_36 = {}
					getProxy = var_20
					ApartmentProxy = var_21

					local var_20_37 = var_20(var_21)

					var_20_36[1] = var_20.GetGiftShopCount(var_20_37, var_20_21:GetConfigID())
					var_20_36[2] = var_1_10018
					var_20_35 = var_20_36
				end
				...
				local var_20_39 = var_20_1:Find("info/lack")

				local function var_20_40()
					...
					var_0(var_1.Find(var_23_0, "info/lack/tip"), false)

					local var_23_1 = var_20_21
					...
					if not var_0.CheckBuyLimit(var_23_1) then
						...
						var_23_3(var_23_2, var_2("dorm3d_shop_gift_owned"))
					...
					Dorm3dGiftMediator = var_2

					local var_23_6 = var_2.SHOW_SHOPPING_CONFIRM_WINDOW
					local var_23_7 = {}
					local var_23_8 = {}
					local var_23_9 = "<icon name="
					local var_23_10 = var_20_24

					var_23_8.icon = var_23_9 .. var_6.GetResIcon(var_23_10) .. " w=1.1 h=1.1/>"
					var_23_8.off = var_20_29
					var_23_8.cost = var_20_33.count
					var_23_8.old = var_20_30

					local var_23_11 = var_20_5

					var_23_8.name = var_5.getConfig(var_23_11, "name")
					var_23_8.weekLimit = var_20_35
					var_23_7.content = var_23_8
					i18n = var_23_8
					var_23_7.tip = var_23_8("dorm3d_shop_gift_tip")
					var_23_7.drop = var_20_21

					local var_23_12 = arg_20_0.apartment

					var_23_7.groupId = var_4.GetConfigID(var_23_12)
					...
					function var_23_7.onYes()
						...
						var_24_1(var_24_0, var_3_10002.SHOPPING, {
							silentTip = true,
							count = 1,
							shopId = var_20_25
						})
				...
				var_20_36(var_20_38, var_20_39, var_20_40, var_23)

				setActive = var_20_24

				var_20_24(arg_20_1:Find("mask"), var_20_23)

				setText = var_20_24

				local var_20_41 = arg_20_1
				local var_20_42 = arg_20_1.Find(var_20_41, "mask/Image/Text")

				i18n = var_20_41

				var_20_24(var_20_42, var_20_41("dorm3d_already_gifted"))

				local function var_20_43(arg_25_0)
					...
					var_25_0(var_2.Find(var_25_1, "base/PageUtil/Text"), arg_25_0)

					setGray = var_25_0

					local var_25_2 = arg_20_1
					local var_25_3 = var_2.Find(var_25_2, "base/PageUtil/Add")

					math = var_25_2

					var_25_0(var_25_3, arg_25_0 >= var_25_2.min(20, var_20_5.count))

					setGray = var_25_0

					local var_25_4 = arg_20_1

					var_25_0(var_2.Find(var_25_4, "base/PageUtil/Minus"), arg_25_0 <= 1)
				...
				;(function()
					...
					local var_26_2 = var_2.Find(var_26_1, "base/PageUtil/Minus")
					local var_26_3 = 0.5
					...
					var_1(var_26_2, var_26_3, var_26_4, var_26_5, var_26_6, var_26_7, var_26_8, var_2_10009)

					pressPersistTrigger = var_1

					local var_26_9 = arg_20_1
					local var_26_10 = var_2.Find(var_26_9, "base/PageUtil/Add")
					local var_26_11 = 0.5
					...
					var_1(var_26_10, var_26_11, var_26_12, var_26_13, var_26_14, var_26_15, var_26_16, var_2_10009)
				...
				local var_20_45 = arg_20_1

				local function var_20_46(arg_29_0)
					if arg_29_0 then
					...
					var_2_10001(var_2.Find(var_29_2, "base/PageUtil"), arg_29_0)
				...
				var_14(var_20_44, var_20_45, var_20_46, var_1_10018)

				setToggleEnabled = var_14

				var_14(arg_20_1, not var_20_23)
...
function var_0_1.SingleUpdateGift(arg_30_0, arg_30_1)
	...
	if var_2.indexof(arg_30_0.filterGiftIds, arg_30_1) then
		...
		var_30_2(var_30_1, var_5.GetChild(var_30_3, var_2 - 1), arg_30_1, true)
	end
...
function var_0_1.OnGiftListScroll(arg_31_0, arg_31_1)
	...
	local var_31_3 = var_31_0(var_31_2, var_1_10005(var_1_10006))
	...
	local var_31_8 = var_10.ceil((var_31_6 - var_31_3.padding.top) / var_31_5)
...
function var_0_1.UpdateConfirmBtn(arg_32_0)
	...
	var_1_10001(var_32_0, var_1_10003(arg_32_0.selectGiftId))
...
function var_0_1.ConfirmGiveGifts(arg_33_0)
	...
	if var_1.getGiftCount(var_33_0, arg_33_0.selectGiftId) == 0 then
		...
		if var_1.IsSingleGiveGift(arg_33_0.selectGiftId) then
			...
			if var_33_3.isGiveGiftDone(var_33_1, arg_33_0.selectGiftId) then
				...
				var_33_3(var_33_2, var_3("dorm3d_shop_gift_already_given"))
		...
		do
			...
			var_33_5(var_33_4, var_3("dorm3d_shop_gift_not_owned"))
		end
	...
	if var_2.isMaxFavor(var_33_7) then
		...
		var_33_8.insert(var_33_6, function(arg_34_0)
			...
			local var_34_2 = var_2_10003.NewStyleMsgboxMgr.TYPE_MSGBOX
			local var_34_3 = {}

			i18n = var_2_10005
			var_34_3.contentText = var_2_10005("dorm3d_gift_favor_max")
		...
		if 0 < var_33_12 then
			...
			var_5.insert(var_33_6, function(arg_35_0)
				...
				local var_35_2 = var_2_10003.NewStyleMsgboxMgr.TYPE_MSGBOX
				local var_35_3 = {}

				i18n = var_2_10005
				var_35_3.contentText = var_2_10005("dorm3d_gift_favor_exceed", var_33_12)
	...
	var_33_8(var_33_6, function()
		...
		Dorm3dGiftMediator = var_2_10002

		var_36_1(var_36_0, var_2_10002.GIVE_GIFT, arg_33_0.selectGiftId, arg_33_0.selectGiftCount)
...
function var_0_1.AfterGiveGift(arg_37_0, arg_37_1)
	...
	if var_1_10003.indexof(arg_37_0.filterGiftIds, var_37_0) then
		local var_37_1 = arg_37_0.giftItemList.container

		var_37_2 = var_37_2.GetChild(var_37_1, var_3 - 1)
		quickPlayAnimation = var_37_1

		var_37_1(var_37_2, "anim_dorm3d_giftui_Select")
	end

	pg = var_37_2

	local var_37_3 = var_37_2.dorm3d_gift[var_37_0]
	local var_37_4 = {}

	Apartment = var_1_10006

	if var_1_10006.getGroupConfig(arg_37_0.apartment.configId, var_37_3.reply_dialogue_id) then
		ApartmentProxy = var_7

		local var_37_5 = var_7.CheckUnlockConfig

		pg = var_8

		if var_37_5(var_8.dorm3d_dialogue_group[var_6].unlock) then
			table = var_7

			var_7.insert(var_37_4, function(arg_38_0)
				local var_38_0 = arg_37_0
				local var_38_1 = var_1.emit

				Dorm3dGiftMediator = var_2_10003

				var_38_1(var_38_0, var_2_10003.DO_TALK, var_0, arg_38_0)
	...
	if var_37_3.unlock_dialogue_id > 0 then
		table = var_7

		var_7.insert(var_37_4, function(arg_39_0)
			pg = var_2_10001
			...
			var_39_1(var_39_0, var_2_10003("dorm3d_gift_story_unlock"))
			arg_39_0()
...
function var_0_1.CheckLevelUp(arg_41_0)
	...
	if var_1.canLevelUp(var_41_0) then
		...
		var_41_2(var_41_1, var_1_10003.FAVOR_LEVEL_UP, arg_41_0.apartment.configId)
	end
...
function var_0_1.OpenInfoWindow(arg_42_0, arg_42_1)
	...
	local var_42_2 = var_42_1
	local var_42_3 = var_42_1.Find(var_42_2, "title/Text")

	i18n = var_42_2

	var_42_0(var_42_3, var_42_2("words_information"))

	updateCustomDrop = var_42_0

	var_42_0(var_42_1:Find("middle/Dorm3dIconTpl"), arg_42_1)

	local var_42_4 = arg_42_1
	local var_42_5 = arg_42_1.getConfig(var_42_4, "ship_group_id") ~= 0

	setActive = var_42_4

	var_42_4(var_42_1:Find("middle/Dorm3dIconTpl/mark"), var_42_5)

	setText = var_42_4

	var_42_4(var_42_1:Find("middle/Text"), "???")

	onButton = var_42_4

	local var_42_6 = arg_42_0
	local var_42_7 = var_42_1:Find("bottom/btn_buy")
	...
	var_42_4(var_42_6, var_42_7, var_42_8, var_8)

	setActive = var_42_4

	var_42_4(arg_42_0.rtInfoWindow, true)
...
function var_0_1.OpenLackWindow(arg_45_0, arg_45_1)
	...
	local var_45_2 = var_45_1
	local var_45_3 = var_45_1.Find(var_45_2, "title/Text")

	i18n = var_45_2

	var_45_0(var_45_3, var_45_2("child_msg_title_detail"))

	updateCustomDrop = var_45_0

	var_45_0(var_45_1:Find("middle/Dorm3dIconTpl"), arg_45_1)

	local var_45_4 = arg_45_1
	local var_45_5 = arg_45_1.getConfig(var_45_4, "ship_group_id") ~= 0

	setActive = var_45_4

	var_45_4(var_45_1:Find("middle/Dorm3dIconTpl/mark"), var_45_5)

	setText = var_45_4

	var_45_4(var_45_1:Find("middle/info/name"), arg_45_1:getName())

	setText = var_45_4

	local var_45_6 = var_45_1
	local var_45_7 = var_45_1.Find(var_45_6, "middle/info/count")

	string = var_45_6

	var_45_4(var_45_7, var_45_6.format("count:<color=#39bfff>%d</color>", arg_45_1.count))

	setText = var_45_4

	var_45_4(var_45_1:Find("middle/info/desc"), arg_45_1:getConfig("display"))

	setText = var_45_4

	var_45_4(var_45_1:Find("line/lack/Text"), "lack")

	ItemTipPanel = var_45_4

	local var_45_8

	if not var_45_4.GetDropLackConfig(arg_45_1) or not var_4.description then
		var_45_8 = {}
	end

	local var_45_9 = var_45_1
	local var_45_10 = var_45_1.Find(var_45_9, "bottom/container")

	UIItemList = var_45_9

	var_45_9.StaticAlign(var_45_10, var_45_10:Find("tpl"), #var_45_8, function(arg_46_0, arg_46_1, arg_46_2)
		arg_46_1 = arg_46_1 + 1
		UIItemList = var_2_10003

		if arg_46_0 == var_2_10003.EventUpdate then
			local var_46_0 = var_45_8[arg_46_1]
			...
			local var_46_5 = arg_46_2.Find(var_46_4, "btn_go/Text")

			i18n = var_46_4

			var_2_10007(var_46_5, var_46_4("feast_res_window_go_label"))

			unpack = var_2_10007

			local var_46_6, var_46_7, var_46_8 = var_2_10007(var_0)

			unpack = var_10

			local var_46_9, var_46_10 = var_10(var_46_7)
			local var_46_11 = #var_46_9
			local var_46_12 = 0 < var_46_11

			if var_46_8 and var_46_8 ~= 0 and var_46_12 then
				getProxy = var_13
				ActivityProxy = var_2_10014

				local var_46_13 = var_13(var_2_10014)

				var_46_12 = var_13.IsActivityNotEnd(var_46_13, var_46_8)
			end

			setActive = var_13

			var_13(arg_46_2:Find("btn_go"), var_46_12)

			onButton = var_13

			local var_46_14 = arg_45_0
			local var_46_15 = arg_46_2:Find("btn_go")

			local function var_46_16()
				ItemTipPanel = var_3_10000

				var_3_10000.ConfigGoScene(var_46_9, var_46_10, function()
			...
			var_13(var_46_14, var_46_15, var_46_16, var_17)
		end
