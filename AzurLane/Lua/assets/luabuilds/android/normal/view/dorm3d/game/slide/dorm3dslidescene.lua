...
function var_0_1.init(arg_7_0)
	...
	arg_7_0.InitUI(var_7_0)

	Dorm3dHxHelper = var_1

	local var_7_1 = var_1.GetTimelineMainCharacter()

	Dorm3dHxHelper = var_7_0

	var_7_0.ReplaceCharacterParts(var_7_1)

	Dorm3dHxHelper = var_2

	var_2.HideCharacterPart(var_7_1, nil, true)
...
function var_0_1.InitUI(arg_8_0)
	...
	local var_8_2 = var_3.Find(var_8_1, "GameUI/Title/BackBtn")
	...
	local var_8_8 = var_8_7(var_8_6, var_3(var_8_3))
	...
	local var_8_11 = var_2.Find(var_8_10, "GameUI/Title/Text")

	i18n = var_8_10

	var_1(var_8_11, var_8_10("3ddorm_beach_slide_tip7"))
...
function var_0_1.InitScene(arg_11_0)
	...
	var_11_0.IpairsCArray(var_11_1, function(arg_12_0, arg_12_1)
		return
	end)
	...
	var_11_2.IpairsCArray(var_11_3, function(arg_13_0, arg_13_1)
		...
		if var_2.Find(var_13_0, "[sequence]") then
			...
			local var_13_3 = var_13_2(var_13_1, var_2_10005(var_2_10006.Playables.PlayableDirector))
	...
	typeof = var_5
	TimelineSpeed = var_1_10006
	arg_11_0.speedComp = var_3(var_11_4, var_5(var_1_10006))
...
function var_0_1.StartQTE(arg_16_0)
	...
	for iter_16_0 = var_16_1, var_1_10003.QTE_COUNT do
		...
		var_1_10006.insert(var_16_0, function(arg_17_0)
			...
			local var_17_2 = var_2_10001(var_17_0, var_3.Find(var_17_1, "GameUI"))
			local var_17_3 = var_1.Find(var_17_2, "animroot/Perfect")

			SlideConst = var_17_2

			local var_17_4 = var_17_2.QTE_TIME

			SlideConst = var_4

			local var_17_5 = var_17_4 - var_4.QTE_SUCCESS_RANGE[1]
			...
			var_4(var_17_7, var_2_10006(var_17_6, var_17_6, var_17_6))
			...
			local var_17_10 = var_17_8.QTE_TIME

			SlideConst = var_6

			local var_17_11 = var_17_10 - var_6.QTE_SUCCESS_RANGE[2]
			...
			var_6(var_17_13, var_8(var_17_12, var_17_12, var_17_12))
			...
			local var_17_14 = var_1:Find("animroot/Trigger")
			local var_17_15 = 0

			Timer = var_8

			local var_17_16 = var_8.New(function()
				local var_18_0 = var_17_15
				...
				if var_3_10001.QTE_TIME <= var_18_0 then
					var_18_1 = arg_16_0.timerList[iter_16_0]
				...
				var_17_15 = var_17_15 + 0.016666666666666666

				local var_18_2 = var_17_14

				Vector3 = var_18_1

				local var_18_3 = var_18_1.Lerp

				Vector3 = var_3_10002

				local var_18_4 = var_3_10002(1, 1, 1)

				Vector3 = var_3

				local var_18_5 = var_3(0, 0, 0)
				local var_18_6 = var_17_15

				SlideConst = var_5
				var_18_2.localScale = var_18_3(var_18_4, var_18_5, var_18_6 / var_5.QTE_TIME)

				return
			end, 0.016666666666666666, -1)

			var_8.Start(var_17_16)

			local var_17_17 = arg_16_0.timerList

			var_17_17[iter_16_0] = var_8
			onButton = var_17_17

			var_17_17(arg_16_0, var_1, function()
				local var_19_0 = arg_16_0.timerList[iter_16_0]

				var_0.Stop(var_19_0)

				local var_19_1 = var_17_15

				SlideConst = var_19_0

				if var_19_0.QTE_SUCCESS_RANGE[1] <= var_19_1 then
					local var_19_2 = var_17_15
					...
					if var_19_2 <= var_1.QTE_SUCCESS_RANGE[2] then
						...
						var_19_3(var_1.Find(var_19_4, "animroot/Result/Hit"), true)
				...
				do
					...
					var_19_5(var_1.Find(var_19_6, "animroot/Result/Miss"), true)
				end
			...
			local var_17_18 = var_17_17.insert
			local var_17_19 = arg_16_0.ltList

			LeanTween = var_11

			local var_17_20 = var_11.delayedCall
			local var_17_21 = iter_16_0

			SlideConst = var_2_10013

			if var_17_21 == var_2_10013.QTE_COUNT then
				SlideConst = var_17_21

				if not var_17_21.QTE_TIME then
					SlideConst = var_17_21
					var_17_21 = var_17_21.QTE_INTERVAL
				end

				System = var_13

				var_17_18(var_17_19, var_17_20(var_17_21, var_13.Action(arg_17_0)).uniqueId)
	...
	var_16_3(var_16_2, var_4.QTE_SLOW_SPEED)
...
function var_0_1.EndQTE(arg_21_0)
	...
	for iter_21_0 = var_21_1, var_21_0.QTE_COUNT do
	...
	var_21_1(var_2.Find(var_21_2, "Title/Victory"), arg_21_0.catchSuccess)

	setActive = var_21_1

	local var_21_3 = arg_21_0.endUI

	var_21_1(var_2.Find(var_21_3, "Title/Defeat"), not arg_21_0.catchSuccess)
