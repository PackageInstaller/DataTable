...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_DISCUSS, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		local var_2_2 = var_2_10006.APARTMENT_INS_OP
		local var_2_3 = {
			shipId = arg_1_0.contextData.apartmentGroupId
		}

		Instagram3Dorm = var_8
		var_2_3.op = var_8.OP_DISCUSS
		var_2_3.id = arg_2_1
	...
	arg_1_0:bind(var_0_1.ON_READ, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10004.APARTMENT_INS_OP
		local var_3_3 = {
			shipId = arg_1_0.contextData.apartmentGroupId
		}

		Instagram3Dorm = var_6
		var_3_3.op = var_6.OP_READ
		var_3_3.id = arg_3_1
	...
	arg_1_0:bind(var_0_1.ON_LIKE, function(arg_4_0, arg_4_1)
		...
		local var_4_2 = var_2_10004.APARTMENT_INS_OP
		local var_4_3 = {
			shipId = arg_1_0.contextData.apartmentGroupId
		}

		Instagram3Dorm = var_6
		var_4_3.op = var_6.OP_LIKE
		var_4_3.id = arg_4_1
	...
	arg_1_0:bind(var_0_1.ON_SHARE, function(arg_5_0, arg_5_1)
		...
		local var_5_2 = var_2_10004.APARTMENT_INS_OP
		local var_5_3 = {
			shipId = arg_1_0.contextData.apartmentGroupId
		}

		Instagram3Dorm = var_6
		var_5_3.op = var_6.OP_SHARE
		var_5_3.id = arg_5_1
	...
	arg_1_0:bind(var_0_1.ON_EXIT, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10004.APARTMENT_INS_OP
		local var_6_3 = {
			shipId = arg_1_0.contextData.apartmentGroupId
		}

		Instagram3Dorm = var_6
		var_6_3.op = var_6.OP_EXIT
		var_6_3.id = arg_6_1
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.APARTMENT_INS_OP_DONE then
		local var_8_3 = var_8_2.op

		Instagram3Dorm = var_1_10005

		local var_8_4

		if var_8_3 == var_1_10005.OP_DISCUSS then
			var_8_4 = arg_8_0.viewComponent

			var_4.UpdateCommentList(var_8_4)
		else
			local var_8_5 = var_8_2.op

			Instagram3Dorm = var_8_4

			if var_8_5 == var_8_4.OP_READ then
				-- block empty
			else
				local var_8_6 = var_8_2.op

				Instagram3Dorm = var_5

				local var_8_7

				if var_8_6 == var_5.OP_LIKE then
					var_8_7 = arg_8_0.viewComponent

					var_4.OnLikeInstagram(var_8_7)
				else
					local var_8_8 = var_8_2.op

					Instagram3Dorm = var_8_7

					if var_8_8 == var_8_7.OP_SHARE then
						-- block empty
					else
						local var_8_9 = var_8_2.op

						Instagram3Dorm = var_5

						if var_8_9 == var_5.OP_EXIT then
							-- block empty
						end
					end
				end
	...
	elseif var_8_0 == var_0_1.BACK_PRESSED then
		local var_8_10 = arg_8_0.viewComponent

		var_4.onBackPressed(var_8_10)
	end
