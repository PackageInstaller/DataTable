...
function var_0_1.OnInit(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.ADD_EXTRA_SYSTEM_FURNITURE_SLIDE)
	...
	SlideConst = var_3
	arg_1_0.pickTimer = var_1_2(var_1_3, var_3.TIMER_INTERVAL, -1)
...
function var_0_1.OnDispose(arg_4_0)
	...
	local var_4_8 = var_3.REMOVE_EXTRA_SYSTEM

	FurnitureSlideExtraMediator = iter_4_0

	var_4_7(var_4_6, var_4_8, iter_4_0)
...
function var_0_1.IsOpen(arg_7_0)
	...
	local var_7_1 = arg_7_0.GetConfigID(var_7_0)

	SlideConst = var_7_0

	local var_7_4

	if var_7_1 == var_7_0.ROOM_ID then
		local var_7_2 = arg_7_0
		local var_7_3 = arg_7_0.IsFurnitureSetIn

		SlideConst = var_1_10003
		var_7_4 = var_7_3(var_7_2, var_1_10003.FURNITURE_ID)
	else
		var_7_4 = false
	end
...
function var_0_1.InitSlide(arg_14_0)
	...
	typeof = var_3
	NodeCanvas = var_1_10004
	arg_14_0.slideTreeOwner = var_1(var_14_0, var_3(var_1_10004.BehaviourTrees.BehaviourTreeOwner))
	...
	var_14_2(var_14_1, var_14_3, var_4(arg_14_0:Get("player")))
	...
	local var_14_6 = var_2.Find(var_14_5, "performance_interact_point")

	typeof = var_14_5
	NodeCanvas = var_4
	arg_14_0.performanceTreeOwner = var_14_4(var_14_6, var_14_5(var_4.BehaviourTrees.BehaviourTreeOwner))
	...
	var_14_8(var_14_7, var_14_9, var_4(arg_14_0:Get("player")))
...
function var_0_1.InitData(arg_15_0)
	...
	var_15_0(var_1_10002.dorm3d_minigame_slide.all, function(arg_16_0)
		...
		var_16_1(var_2.dorm3d_minigame_slide[arg_16_0].slide_command, function(arg_17_0)
			table = var_3_10001
			...
			var_17_0(var_17_1, var_3.New(arg_17_0, arg_15_0.movePointsRoot))
		...
		local var_16_4 = var_16_3(var_16_2, var_3.dorm3d_minigame_slide[arg_16_0].slide_zone)
...
function var_0_1.AddLadySlide(arg_19_0, arg_19_1)
	local var_19_0 = arg_19_0:Get("ladyDict")[arg_19_1]
	local var_19_1 = arg_19_0.ladyDic

	LadySlide = var_4
	var_19_1[arg_19_1] = var_4.New(arg_19_1, var_19_0, arg_19_0.commandConfigDic[arg_19_1], arg_19_0.defaultPoints[arg_19_1], function(arg_20_0)
	...
	local var_19_2 = arg_19_0.ladyDic[arg_19_1]

	var_3.Reset(var_19_2)
...
function var_0_1.RemoveLadySlide(arg_21_0, arg_21_1)
	if arg_21_0.ladyDic[arg_21_1] then
		...
		var_21_1(var_21_0, var_4.IDLE_ANIM)
