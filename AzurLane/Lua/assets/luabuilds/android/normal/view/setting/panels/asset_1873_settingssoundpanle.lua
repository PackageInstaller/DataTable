...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(var_4_6, var_4_7, var_4_8, var_1_10005, var_1_10006)
	...
	local function var_4_11()
		...
		i18n = var_2_10003
		var_6_2.content = var_2_10003("sure_resume_volume")
		...
		function var_6_2.onYes()
			...
			DEFAULT_BGMVOLUME = var_3_10004

			var_3_10000(var_7_0, var_7_1, var_7_2, var_3_10004)
			...
			DEFAULT_SEVOLUME = var_3_10004

			var_3_10000(var_7_3, var_7_4, var_7_5, var_3_10004)
			...
			DEFAULT_CVVOLUME = var_3_10004

			var_3_10000(var_7_6, var_7_7, var_7_8, var_3_10004)
	...
	local var_4_13 = var_2.Find(var_4_12, "settings/buttons/soundswitch/Text")

	i18n = var_4_12

	var_1(var_4_13, var_4_12("voice_control"))

	setText = var_1

	local var_4_14 = arg_4_0._tf
	local var_4_15 = var_2.Find(var_4_14, "settings/bgm/icon/Text")

	i18n = var_4_14

	var_1(var_4_15, var_4_14("settings_sound_title_bgm"))

	setText = var_1

	local var_4_16 = arg_4_0._tf
	local var_4_17 = var_2.Find(var_4_16, "settings/sfx/icon/Text")

	i18n = var_4_16

	var_1(var_4_17, var_4_16("settings_sound_title_effct"))

	setText = var_1

	local var_4_18 = arg_4_0._tf
	local var_4_19 = var_2.Find(var_4_18, "settings/cv/icon/Text")

	i18n = var_4_18

	var_1(var_4_19, var_4_18("settings_sound_title_cv"))
...
function var_0_1.OnVolumeSwitch(arg_8_0, arg_8_1)
	if not arg_8_1 then
		...
		local var_8_1 = var_1_10004.CriMgr.GetInstance()

		var_1_10002(var_8_0, var_1_10004.getBGMVolume(var_8_1))
		...
		local var_8_3 = var_1_10004.CriMgr.GetInstance()

		var_1_10002(var_8_2, var_1_10004.getSEVolume(var_8_3))
		...
		local var_8_5 = var_1_10004.CriMgr.GetInstance()

		var_1_10002(var_8_4, var_1_10004.getCVVolume(var_8_5))
		...
		local var_8_11 = var_1_10004.GetFloat
		local var_8_12 = "bgm_vol_mute_setting"

		DEFAULT_BGMVOLUME = var_1_10006

		var_8_10(var_8_9, var_8_11(var_8_12, var_1_10006))
		...
		local var_8_15 = var_4.GetFloat
		local var_8_16 = "se_vol_mute_setting"

		DEFAULT_SEVOLUME = var_1_10006

		var_8_14(var_8_13, var_8_15(var_8_16, var_1_10006))
		...
		local var_8_19 = var_4.GetFloat
		local var_8_20 = "cv_vol_mute_setting"

		DEFAULT_CVVOLUME = var_1_10006

		var_8_18(var_8_17, var_8_19(var_8_20, var_1_10006))
...
function var_0_1.InitBgmSlider(arg_9_0)
	...
	if arg_9_0.isMute then
		...
		var_9_1 = var_9_2(var_9_3, var_1_10004)
	end
...
function var_0_1.InitEffectSlider(arg_11_0)
	...
	if arg_11_0.isMute then
		...
		var_11_1 = var_11_2(var_11_3, var_1_10004)
	end
...
function var_0_1.InitMainSlider(arg_13_0)
	...
	if arg_13_0.isMute then
		...
		var_13_1 = var_13_2(var_13_3, var_1_10004)
	end
...
function var_0_1.SetSliderEnable(arg_17_0, arg_17_1, arg_17_2)
	...
	arg_17_1.GetComponent(var_17_0, "Slider").interactable = arg_17_2
	setButtonEnabled = var_17_0

	var_17_0(arg_17_1:Find("up"), arg_17_2)

	setButtonEnabled = var_17_0

	var_17_0(arg_17_1:Find("down"), arg_17_2)
