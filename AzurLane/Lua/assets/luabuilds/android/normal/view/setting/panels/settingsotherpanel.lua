...
function var_0_1.OnInit(arg_4_0, ...)
	...
	if var_4_6 and not var_4_8 then
		...
		var_4_7.SetInt("AUTOFIGHT_BATTERY_SAVEMODE", 0)
...
function var_0_1.UpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_4 = arg_7_2:Find("mask/Text")
	...
	local function var_7_5()
		...
		var_8_1(var_8_0, var_2_10002.SHOW_DESC, var_7_0)
	...
	local var_7_7 = arg_7_2:Find("on")

	local function var_7_8(arg_9_0)
	...
	var_5(var_7_6, var_7_7, var_7_8, var_9, var_1_10010)
...
function var_0_1.OnItemSwitch(arg_10_0, arg_10_1, arg_10_2)
	if arg_10_1.id == 1 then
		pg = var_3
		var_1_10004 = var_3.PushNotificationMgr.GetInstance()

		var_3.setSwitchShipName(var_1_10004, arg_10_2)
	elseif arg_10_1.id == 5 then
		var_1_10004 = arg_10_0

		arg_10_0.OnClickEffectItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	elseif arg_10_1.id == 9 then
		var_1_10004 = arg_10_0

		arg_10_0.OnAutoFightBatterySaveModeItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	elseif arg_10_1.id == 10 then
		var_1_10004 = arg_10_0

		arg_10_0.OnAutoFightDownFrameItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	elseif arg_10_1.type == 0 then
		var_1_10004 = arg_10_0

		arg_10_0.OnCommonLocalItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	elseif arg_10_1.type == 1 then
		var_1_10004 = arg_10_0

		arg_10_0.OnCommonServerItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	elseif arg_10_1.type == var_0_1.GRAPHI_API_SWITCH_OPTION_TYPE then
		var_1_10004 = arg_10_0

		arg_10_0.OnGraphApiItemSwitch(var_1_10004, arg_10_1, arg_10_2)
	end
	...
	if arg_10_1.id == 19 then
		...
		local var_10_1 = var_1_10004.GameTrackerMgr.GetInstance()
		local var_10_2 = var_4.Record

		GameTrackerBuilder = var_1_10006

		var_10_2(var_10_1, var_1_10006.BuildNewMainUI({
			isLogin = 0,
...
function var_0_1.OnCommonServerItemSwitch(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = var_4(var_1_10005)
	...
	if var_12_4 then
		...
		var_12_6(var_12_5, var_1_10008.CANCEL_COMMON_FLAG, {
			flagID = var_12_0
		})
	else
		pg = var_12_6
		...
		var_12_8(var_12_7, var_1_10008.COMMON_FLAG, {
			flagID = var_12_0
		})
	end
...
function var_0_1.OnAutoFightBatterySaveModeItemSwitch(arg_13_0, arg_13_1, arg_13_2)
	local function var_13_0()
		...
		var_14_0(var_14_1:Find("off"), true)
	...
	var_1_10005({
		function(arg_15_0)
			if arg_13_2 then
				...
				i18n = var_2_10004
				var_15_3.content = var_2_10004("words_autoFight_right")
		...
		function(arg_18_0)
			...
			triggerToggle = var_18_1

			var_18_1(var_18_2:Find(arg_13_2 and "on" or "off"), true)
...
function var_0_1.OnAutoFightDownFrameItemSwitch(arg_19_0, arg_19_1, arg_19_2)
	...
	if not arg_19_0.GetDefaultValue(var_19_0, arg_19_0.list[9]) and arg_19_2 then
		...
		var_19_0(var_19_1, var_1_10006("words_autoFight_tips"))

		local var_19_2 = arg_19_0.uilist.container

		var_19_0 = var_19_0.GetChild(var_19_2, arg_19_1.id - 1)
		triggerToggle = var_19_2

		var_19_2(var_19_0:Find("off"), true)
	...
	local var_19_3 = var_19_0[arg_19_1.name]
...
function var_0_1.OnGraphApiItemSwitch(arg_22_0, arg_22_1, arg_22_2)
	local function var_22_0()
		...
		var_23_0(var_23_1:Find("off"), true)

		GraphApiHelper = var_23_0

		local var_23_2 = var_23_0.SetForceGraphApi

		GraphApiHelper = var_2

		var_23_2(var_2.Api.Force_OpenGLES)
	...
	local function var_22_1()
		...
		var_24_0(var_24_1:Find("on"), true)

		GraphApiHelper = var_24_0

		local var_24_2 = var_24_0.SetForceGraphApi

		GraphApiHelper = var_2

		var_24_2(var_2.Api.Force_Vulkan)
	...
	if arg_22_2 == false then
		...
		if var_1_10005.IsUsingVulkan() then
			...
			if arg_22_2 then
				...
				i18n = var_1_10008
				var_22_3.content = var_1_10008("graphi_api_switch_vulkan")
				...
				i18n = var_1_10008
				var_22_6.content = var_1_10008("graphi_api_switch_opengl")
...
function var_0_1.OnUpdateItemWithTr(arg_28_0, arg_28_1, arg_28_2)
	...
	if arg_28_1.id == 18 then
		...
		local function var_28_3()
			...
			var_29_1(var_29_0, var_2_10002.SHOW_DESC, arg_28_1)
		...
		var_4(var_28_1, var_28_2, var_28_3, var_1_10008)
...
function var_0_1.GetDefaultValue(arg_30_0, arg_30_1)
	if arg_30_1.id == 1 then
		pg = var_2
		var_1_10003 = var_2.PushNotificationMgr.GetInstance()

		return var_2.isEnableShipName(var_1_10003)
	elseif arg_30_1.id == 17 then
		getProxy = var_2
		SettingsProxy = var_1_10003
		var_1_10003 = var_2(var_1_10003)

		return var_2.IsDisplayResultPainting(var_1_10003)
	elseif arg_30_1.type == 0 then
		...
		_G = var_1_10003
		var_1_10003 = var_1_10003[arg_30_1.name]

		if not arg_30_1.default then
			var_1_10004 = 0
		end

		local var_30_1 = var_30_0(var_1_10003, var_1_10004)
	...
	elseif arg_30_1.type == 1 then
		...
		local var_30_2 = var_2(var_1_10003)
		local var_30_3 = var_2.getRawData(var_30_2)
		local var_30_4 = var_2.GetCommonFlag

		_G = var_1_10004

		local var_30_5 = var_30_4(var_30_3, var_1_10004[arg_30_1.name])
...
function var_0_1.GetList(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1_10003(var_1_10004.settings_other_template.all) do
		...
		if var_1_10008 and (iter_31_1 == 9 or iter_31_1 == 10) then
			...
			if var_1_10008 and iter_31_1 == 15 then
				...
				if var_1_10008.settings_other_template[iter_31_1].type == var_0_1.GRAPHI_API_SWITCH_OPTION_TYPE then
					...
					var_1_10008(var_31_2, var_1_10010.settings_other_template[iter_31_1])
				end
			end
		end
	end
