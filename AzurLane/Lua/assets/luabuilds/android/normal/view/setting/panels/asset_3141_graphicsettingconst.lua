...
function var_0.InitDefautQuality(arg_1_0)
	...
	if var_1_10002.GetInt(var_1_0, 0) == 0 then
		DevicePerformanceUtil = var_3

		local var_1_1 = var_3.GetDevicePerformanceLevel()

		PLATFORM = var_1_2
		PLATFORM_IPHONEPLAYER = var_1_10005
		...
		if var_1_2 == var_1_10005 then
			...
			local function var_1_3(arg_2_0)
				...
				if var_2(var_2_0) and var_2 >= 8 then
					return true
				end
			...
			local function var_1_4(arg_3_0)
				...
				if var_2(var_3_0) and var_2 >= 13 then
					return true
				end
...
function var_0.SettingQuality(arg_4_0)
	...
	if var_1_10002.GetInt(var_4_0, 4) ~= 4 then
		...
		for iter_4_0, iter_4_1 in var_3(var_0.settings) do
	...
	for iter_4_2, iter_4_3 in var_3(var_0.settings) do
