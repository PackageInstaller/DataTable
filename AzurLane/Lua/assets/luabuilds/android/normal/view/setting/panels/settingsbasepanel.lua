...
function var_0_0.Load(arg_4_0, arg_4_1)
	...
	var_2.GetUI(var_4_0, arg_4_0:GetUIName(), true, function(arg_5_0)
		if arg_4_0.exited then
			...
			var_5_1(var_5_0, var_3.GetUIName(var_5_2), arg_5_0)
...
function var_0_0.InitTitle(arg_6_0)
	...
	var_1_10001(var_2.Find(var_6_0, "title"), arg_6_0:GetTitle())

	setText = var_1_10001

	local var_6_1 = arg_6_0._tf

	var_1_10001(var_2.Find(var_6_1, "title/title_text"), arg_6_0:GetTitleEn())
