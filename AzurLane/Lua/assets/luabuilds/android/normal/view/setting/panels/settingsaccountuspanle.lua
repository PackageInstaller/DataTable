...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_2 = var_3(var_4_1, "btn_layout/twitter_con")
	...
	PLATFORM_CODE = var_7
	PLATFORM_US = var_1_10008

	if var_7 == var_1_10008 then
		pg = var_7

		local var_4_5 = var_7.SdkMgr.GetInstance()
		local var_4_6

		if var_7.GetChannelUID(var_4_5) == "3" then
			var_4_6 = false
		else
			var_4_6 = true
		end
		...
		if var_9 == var_1_10010 then
			pg = var_9

			local var_4_10 = var_9.SdkMgr.GetInstance()
			local var_4_11

			if var_9.GetChannelUID(var_4_10) ~= "1" then
				var_4_11 = false
			else
				var_4_11 = true
			end

			var_7(var_4_9, var_4_11)

			findTF = var_7

			local var_4_12 = var_7(var_4_1, "btn_layout/amazon_con")

			findTF = var_8
			arg_4_0.btnBindAmazon = var_8(var_4_12, "bind_amazon")
			findTF = var_8
			arg_4_0.btnUnlinkAmazon = var_8(var_4_12, "unlink_amazon")
			findTF = var_8
			arg_4_0.amazonStatus = var_8(var_4_12, "amazon_status")
			setActive = var_8
			...
			if var_10 == var_1_10011 then
				...
				local var_4_14 = var_10.SdkMgr.GetInstance()
				local var_4_15

				if var_10.GetChannelUID(var_4_14) ~= "3" then
					var_4_15 = false
				else
					var_4_15 = true
				end

				var_8(var_4_13, var_4_15)
...
function var_0_1.RegisterEvent(arg_5_0)
	...
	var_1_10001(arg_5_0, arg_5_0.yostarGenCodeBtn, function()
		...
		if var_2_10000(arg_5_0.yostarEmailTxt) ~= "" then
			...
			var_1.VerificationCodeReq(var_16_0, var_0)

			local var_16_1 = arg_5_0

			var_1.checkAiriGenCodeCounter_US(var_16_1)
		else
			pg = var_1

			local var_16_2 = var_1.TipsMgr.GetInstance()
			local var_16_3 = var_1.ShowTips

			i18n = var_2_10003

			var_16_3(var_16_2, var_2_10003("verification_code_req_tip1"))
		end
	...
	var_1_10001(arg_5_0, arg_5_0.yostarSureBtn, function()
		...
		local var_17_1 = var_1(arg_5_0.yostarCodeTxt)
		local var_17_4
		...
		if var_17_0 ~= "" and var_17_1 ~= "" then
			...
			AIRI_PLATFORM_YOSTAR = var_2_10004

			var_17_4(var_17_3, var_2_10004, var_17_0, var_17_1)
		else
			pg = var_17_4
			...
			var_17_4(var_17_5, var_2_10004("verification_code_req_tip3"))
		end
	...
	var_1_10001(arg_5_0, arg_5_0.btnUnlinkPGS, function()
		...
		i18n = var_2_10003
		var_18_2.content = var_2_10003("pgs_unbind_tip1")
		...
		function var_18_2.onYes()
			...
			AIRI_PLATFORM_GPS = var_3_10002

			var_19_1(var_19_0, var_3_10002)
...
function var_0_1.checkAccountTwitterView_US(arg_22_0)
	...
	AIRI_PLATFORM_TWITTER = var_1_10003

	local var_22_2 = var_22_1(var_22_0, var_1_10003)

	setActive = var_22_0

	var_22_0(arg_22_0.btnUnlinkTwitter, var_22_2)

	setActive = var_22_0

	var_22_0(arg_22_0.twitterStatus, var_22_2)

	setActive = var_22_0

	var_22_0(arg_22_0.btnBindTwitter, not var_22_2)
	...
	if var_22_2 then
		...
		local var_22_5 = var_1_10006.SdkMgr.GetInstance()
		local var_22_6 = var_6.GetSocialName

		AIRI_PLATFORM_TWITTER = var_1_10008

		var_22_0(var_22_3, var_4(var_22_4, var_22_6(var_22_5, var_1_10008)))
	end
...
function var_0_1.checkAccountFacebookView_US(arg_23_0)
	...
	if var_1_10001 == var_1_10002 then
		...
		if var_1.GetChannelUID(var_23_0) ~= "3" then
			...
			AIRI_PLATFORM_FACEBOOK = var_1_10003

			local var_23_3 = var_23_2(var_23_1, var_1_10003)

			setActive = var_23_1

			var_23_1(arg_23_0.btnUnlinkFacebook, var_23_3)

			setActive = var_23_1

			var_23_1(arg_23_0.facebookStatus, var_23_3)

			setActive = var_23_1

			var_23_1(arg_23_0.btnBindFacebook, not var_23_3)
			...
			if var_23_3 then
				...
				local var_23_6 = var_1_10006.SdkMgr.GetInstance()
				local var_23_7 = var_6.GetSocialName

				AIRI_PLATFORM_FACEBOOK = var_1_10008

				var_23_1(var_23_4, var_4(var_23_5, var_23_7(var_23_6, var_1_10008)))
			end
		end
	end
...
function var_0_1.checkAccountAppleView_US(arg_24_0)
	...
	AIRI_PLATFORM_APPLE = var_1_10003

	local var_24_2 = var_24_1(var_24_0, var_1_10003)

	setActive = var_24_0

	var_24_0(arg_24_0.btnUnlinkApple, var_24_2)

	setActive = var_24_0

	var_24_0(arg_24_0.appleStatus, var_24_2)

	setActive = var_24_0

	var_24_0(arg_24_0.btnBindApple, not var_24_2)
	...
	if var_24_2 then
		...
		local var_24_5 = var_1_10006.SdkMgr.GetInstance()
		local var_24_6 = var_6.GetSocialName

		AIRI_PLATFORM_APPLE = var_1_10008

		var_24_0(var_24_3, var_4(var_24_4, var_24_6(var_24_5, var_1_10008)))
	end
...
function var_0_1.checkAccountAmazonView_US(arg_25_0)
	...
	if var_1.GetChannelUID(var_25_0) == "3" then
		...
		AIRI_PLATFORM_AMAZON = var_1_10003

		local var_25_3 = var_25_2(var_25_1, var_1_10003)

		setActive = var_25_1

		var_25_1(arg_25_0.btnUnlinkAmazon, var_25_3)

		setActive = var_25_1

		var_25_1(arg_25_0.amazonStatus, var_25_3)

		setActive = var_25_1

		var_25_1(arg_25_0.btnBindAmazon, not var_25_3)
		...
		if var_25_3 then
			...
			local var_25_6 = var_1_10006.SdkMgr.GetInstance()
			local var_25_7 = var_6.GetSocialName

			AIRI_PLATFORM_AMAZON = var_1_10008

			var_25_1(var_25_4, var_4(var_25_5, var_25_7(var_25_6, var_1_10008)))
		end
	end
...
function var_0_1.checkAccountYostarView_US(arg_26_0)
	...
	AIRI_PLATFORM_YOSTAR = var_1_10003

	local var_26_2 = var_26_1(var_26_0, var_1_10003)

	setActive = var_26_0

	var_26_0(arg_26_0.btnUnlinkYostar, var_26_2)

	setActive = var_26_0

	var_26_0(arg_26_0.yostarStatus, var_26_2)

	setActive = var_26_0

	var_26_0(arg_26_0.btnBindYostar, not var_26_2)
	...
	if var_26_2 then
		...
		local var_26_5 = var_1_10006.SdkMgr.GetInstance()
		local var_26_6 = var_6.GetSocialName

		AIRI_PLATFORM_YOSTAR = var_1_10008

		var_26_0(var_26_3, var_4(var_26_4, var_26_6(var_26_5, var_1_10008)))
	end
...
function var_0_1.checkAccountPGSView_US(arg_27_0)
	...
	AIRI_PLATFORM_GPS = var_1_10003

	local var_27_2 = var_27_1(var_27_0, var_1_10003)

	setActive = var_27_0

	var_27_0(arg_27_0.pgsCon, var_27_2)

	setActive = var_27_0

	var_27_0(arg_27_0.btnUnlinkPGS, var_27_2)

	setActive = var_27_0

	var_27_0(arg_27_0.pgsStatus, var_27_2)

	setActive = var_27_0

	var_27_0(arg_27_0.btnBindPGS, false)
	...
	if var_27_2 then
		...
		local var_27_5 = var_1_10006.SdkMgr.GetInstance()
		local var_27_6 = var_6.GetSocialName

		AIRI_PLATFORM_GPS = var_1_10008

		var_27_0(var_27_3, var_4(var_27_4, var_27_6(var_27_5, var_1_10008)))
	end
