...
function var_0_1.OnInit(arg_4_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0.subTitleTxt = var_4_2(var_4_1, var_3(var_1_10004))
...
function var_0_1.InitToggles(arg_5_0)
	...
	local function var_5_5()
		...
		var_7_1(var_7_0, var_7_2, var_2_10003.RANDOM_DOCKYARD)
	...
	var_1(var_5_3, var_5_4, var_5_5, iter_5_1)
...
function var_0_1.UpdateShipRandomMode(arg_8_0, arg_8_1)
	if arg_8_1 == var_0_1.COUSTOM and not arg_8_0.refreshFlag then
		...
		local var_8_0 = var_2(var_1_10003)

		if #var_2.getRandomFlagShipPhantomMarks(var_8_0) == 0 then
			pg = var_3
			var_1_10004 = var_3.TipsMgr.GetInstance()

			local var_8_1 = var_3.ShowTips

			i18n = var_1_10005

			var_8_1(var_1_10004, var_1_10005("random_ship_custom_mode_empty"))
		end
	end
	...
	if arg_8_0.randomFlagShipMode ~= arg_8_1 then
		...
		var_8_3(var_8_2, var_1_10004.CHANGE_RANDOM_SHIP_MODE, {
			mode = arg_8_1
		})
	end
...
function var_0_1.UpdateSelected(arg_9_0)
	...
	var_9_1(arg_9_0.shipToggles[var_1], true)
