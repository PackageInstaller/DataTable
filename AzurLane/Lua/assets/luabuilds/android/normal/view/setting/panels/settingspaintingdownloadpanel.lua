...
function var_0_1.OnInit(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_2(var_4_0) do
		local function var_4_3(arg_5_0)
			if arg_5_0 then
				...
				if iter_4_0 == var_5_1 then
					...
					local var_5_2 = var_2(var_2_10003)
					...
					var_5_4(var_5_3, var_4("painting_prefs_switch_succ"))
				end
			end
		...
		var_1_10008(var_4_4, var_4_5, var_4_6, var_1_10012)

		setText = var_1_10008

		local var_4_7 = iter_4_1
		local var_4_8 = iter_4_1.Find(var_4_7, "Text")

		i18n = var_4_7

		var_1_10008(var_4_8, var_4_7("painting_prefs_setting_" .. iter_4_0))
...
function var_0_1.OnUpdate(arg_6_0)
	...
	IsUnityEditor = var_6_0

	if var_6_0 and var_6_1 == var_0_1.None then
		var_6_1 = var_0_1.Max
	...
	var_6_0(arg_6_0.btns[var_6_1], true)
