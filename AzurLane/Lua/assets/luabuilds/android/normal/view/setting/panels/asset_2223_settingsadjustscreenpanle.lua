...
function var_0_1.OnUpdate(arg_5_0)
	...
	local var_5_2 = var_1_10003.width

	Screen = var_1_10004

	local var_5_3 = var_5_1(var_5_2 / var_1_10004.height - 0.001, 1.3333333333333333, 2.3333333333333335)
	...
	var_3(var_5_4, var_5, var_5_3, var_5_0:GetScreenRatio())

	OnSliderWithButton = var_3

	var_3(arg_5_0, arg_5_0.notchSlider, function(arg_6_0)
