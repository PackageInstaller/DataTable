...
function var_0_1.UpdateItem(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_4 = arg_6_2:Find("mask/Text")
	...
	local function var_6_5()
		...
		var_7_1(var_7_0, var_2_10002.SHOW_DESC, var_6_0)
	...
	var_5(var_6_3, var_6_4, var_6_5, var_9)
	...
	local var_6_7 = arg_6_2:Find("on")

	local function var_6_8(arg_8_0)
	...
	var_5(var_6_6, var_6_7, var_6_8, var_9, var_1_10010)
...
function var_0_1.DisplayWorldBossProgressTipSettings(arg_12_0)
	...
	var_12_0(arg_12_0.worldbossProgressTip, var_12_1)
...
function var_0_1.InitWorldBossProgressTipSettings(arg_13_0)
	...
	local var_13_2 = arg_13_0.GetWorldBossProgressTipConfig(var_13_1)

	getProxy = var_13_1
	SettingsProxy = var_1_10004

	local var_13_3 = var_13_1(var_1_10004)
	local var_13_4 = var_3.GetWorldBossProgressTipFlag(var_13_3)

	local function var_13_5(arg_14_0, arg_14_1)
		tostring = var_2_10002

		local var_14_0 = var_2_10002(var_13_2[arg_14_0])
		...
		var_3(var_14_1, var_14_2, var_14_3, var_2_10007)

		if var_14_0 == var_13_4 then
			triggerToggle = var_3
	...
	local var_13_6 = var_13_0:Find("notify_tpl")
	local var_13_7 = var_5.Find(var_13_6, "mask/Text")
	local var_13_8 = var_6.GetComponent(var_13_7, "ScrollText")
	local var_13_9 = var_6.SetText

	i18n = var_1_10009

	var_13_9(var_13_8, var_1_10009("world_boss_progress_tip_title"))

	for iter_13_0 = 1, #var_13_2 do
		local var_13_10 = var_13_5
		local var_13_11 = iter_13_0
		local var_13_12 = var_5
		local var_13_13 = var_5.Find

		tostring = var_1_10015

		var_13_10(var_13_11, var_13_13(var_13_12, var_1_10015(iter_13_0)))
	end

	onButton = var_7

	local var_13_14 = arg_13_0
	local var_13_15 = var_5:Find("mask/Text")
	...
	local function var_13_16()
		...
		local var_16_2 = var_2_10002.SHOW_DESC
		local var_16_3 = {}

		i18n = var_2_10004
		var_16_3.desc = var_2_10004("world_boss_progress_tip_desc")
	...
	var_7(var_13_14, var_13_15, var_13_16, var_11)
