...
function var_0_0.InitTpl(arg_1_0, arg_1_1)
	...
	var_5(var_6.Find(var_1_3, "icon"), var_1_2)
...
function var_0_0.Ctor(arg_2_0, arg_2_1)
	...
	var_2(var_3.Find(var_2_0, "title"), arg_2_0:GetTitle())
	...
	findTF = var_3
	arg_2_0.delBtn = var_3(arg_2_0._tf, "DelBtn")
	setActive = var_3

	var_3(arg_2_0.delBtn, var_2_1)

	local var_2_2 = arg_2_0.delBtn
	local var_2_3

	var_2_3, setText = var_3.Find(var_2_2, "Text"), var_2_2
	i18n = var_1_10006

	var_2_2(var_2_3, var_1_10006("resource_clear_generaltext"))

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_4.Find(var_2_4, "BG")
	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_5.Find(var_2_6, "BGDel")

	setActive = var_2_6

	var_2_6(var_2_5, not var_2_1)

	setActive = var_2_6

	var_2_6(var_2_7, var_2_1)

	local var_2_8 = arg_2_0._tf
	local var_2_9 = var_6.Find(var_2_8, "status")
	local var_2_10 = arg_2_0._tf
	local var_2_11 = var_7.Find(var_2_10, "version")
...
function var_0_0.Init(arg_3_0)
	...
	local function var_3_2()
		...
		local var_4_2 = var_4_0.SettingsGroupMgr.GetInstance()
		...
		if var_2.isNeedUpdate(var_4_4) then
			...
			if var_4_3 ~= var_2.SettingsGroupMgr.State.Updating then
				...
				local var_4_6 = var_4_4.SettingsGroupMgr.GetInstance()
				local var_4_7 = var_3.GetTotalSize(var_4_6, var_4_5)

				HashUtil = var_4_6

				local var_4_8 = var_4_6.BytesToString(var_4_7)

				pg = var_5

				local var_4_9 = var_5.MsgboxMgr.GetInstance()
				local var_4_10 = var_5.ShowMsgBox
				local var_4_11 = {}

				MSGBOX_TYPE_NORMAL = var_2_10008
				var_4_11.type = var_2_10008
				string = var_2_10008

				local var_4_12 = var_2_10008.format

				i18n = var_2_10009
				var_4_11.content = var_4_12(var_2_10009("group_download_tip", var_4_8))
	...
	if var_1_10001(arg_3_0.delBtn) then
		...
		local function var_3_5()
			...
			local var_6_2 = var_6_0.GetGroupMgrByName(var_6_1)

			HashUtil = var_2

			local var_6_3 = var_2.BytesToString(var_6_2:GetAllCacheFileSize())
			...
			local var_6_7 = var_5.MsgboxMgr.GetInstance()
			local var_6_8 = var_5.ShowMsgBox
			local var_6_9 = {}

			MSGBOX_TYPE_CONFIRM = var_2_10008
			var_6_9.type = var_2_10008
			...
			function var_6_9.onYes()
				...
				var_7_0(var_7_1, var_3_10002.Prefs.Min)
...
function var_0_0.InitPrefsBar(arg_8_0)
	...
	local var_8_0 = var_2(arg_8_0.prefsBar, "Text")

	i18n = var_3

	var_1(var_8_0, var_3("setting_group_prefs_tip"))
	...
	local function var_8_4(arg_9_0)
		...
		if arg_9_0 == true then
			...
			DMFileChecker = var_2_10003

			var_9_0(var_9_1, var_2_10003.Prefs.Max)
		else
			GroupHelper = var_9_0
			...
			var_9_2(var_9_3, var_2_10003.Prefs.Min)
		end
		...
		if not arg_8_0.hideTip then
			...
			var_9_5(var_9_4, var_2_10003("group_prefs_switch_tip"))
		end
	...
	var_2(var_8_2, var_8_3, var_8_4, var_1_10006)
	...
	var_2(var_8_5, var_8_6 == var_5.Prefs.Max)
...
function var_0_0.UpdateDownLoadState(arg_12_0)
	...
	local var_12_1 = arg_12_0.GetDownloadGroup(var_12_0)

	BundleWizard = var_12_0

	local var_12_2 = var_12_0.Inst
	local var_12_3 = var_2.GetGroupMgr(var_12_2, var_12_1)
	local var_12_4
	local var_12_5
	local var_12_6
	local var_12_7
	...
	local var_12_10 = var_1_10009.SettingsGroupMgr.GetInstance()
	local var_12_11 = var_9.GetState(var_12_10, var_12_1)
	local var_12_12
	local var_12_13

	IsUnityEditor = var_1_10012
	...
	if var_1_10012 then
		...
		var_12_12 = var_1_10012(var_12_3.localVersion.Build)
		tonumber = var_1_10012
		var_12_13 = var_1_10012(var_12_3.serverVersion.Build)
	end
	...
	if var_12_11 == var_1_10012.SettingsGroupMgr.State.None then
		if var_12_12 < var_12_13 then
			i18n = var_12_15
			var_12_5 = var_12_15("word_maingroup_checktoupdate")
			string = var_12_15
			var_12_6 = var_12_15.format("V.%d > V.%d", var_12_12, var_12_13)
			var_12_8 = true
		else
			i18n = var_12_15
			var_12_5 = var_12_15("word_maingroup_updatesuccess")
			string = var_12_15
			var_12_6 = var_12_15.format("V.%d", var_12_3.CurrentVersion.Build)
			var_12_8 = false
		end
		...
		if var_12_11 == var_12_15.SettingsGroupMgr.State.Updating then
			pg = var_12_15

			local var_12_14 = var_12_15.SettingsGroupMgr.GetInstance()
			local var_12_16

			var_12_15, var_12_16 = var_12_15.GetCountProgress(var_12_14, var_12_1)
			i18n = var_14
			var_12_5 = var_14("word_maingroup_updating")
			string = var_14
			var_12_6 = var_14.format("(%d/%d)", var_12_15, var_12_16)
			math = var_14
			var_12_7 = var_12_15 / var_14.max(var_12_16, 1)
			var_12_8 = false
			var_12_9 = true
		else
			pg = var_12_15

			if var_12_11 == var_12_15.SettingsGroupMgr.State.Success then
				i18n = var_12_15
				var_12_5 = var_12_15("word_maingroup_updatesuccess")
				var_12_6 = "V." .. var_12_3.CurrentVersion.Build
				var_12_7 = 1
				var_12_8 = false
				var_12_9 = false
			else
				...
				if var_12_11 == var_12_15.SettingsGroupMgr.State.Fail then
					i18n = var_12_15
					var_12_5 = var_12_15("word_maingroup_updatefailure")
	...
	var_12_15(arg_12_0.loadInfo1, var_12_5)

	setText = var_12_15

	var_12_15(arg_12_0.loadInfo2, var_12_6)

	setSlider = var_12_15

	var_12_15(arg_12_0.loadProgress, 0, 1, var_12_7)

	setActive = var_12_15

	var_12_15(arg_12_0.loadProgressHandle, var_12_7 ~= 0 and var_12_7 ~= 1)

	setActive = var_12_15

	var_12_15(arg_12_0.loadDot, var_12_8)

	setActive = var_12_15

	var_12_15(arg_12_0.loadLoading, var_12_9)

	setActive = var_12_15

	var_12_15(arg_12_0.loadLabelNew, var_12_12 < var_12_13)
...
function var_0_0.isNeedUpdate(arg_16_0)
	...
	BundleWizard = var_16_0

	local var_16_2 = var_16_0.Inst
	local var_16_3 = var_2.GetGroupMgr(var_16_2, var_16_1)

	tonumber = var_16_2

	local var_16_4 = var_16_2(var_16_3.localVersion.Build)

	tonumber = var_4

	return var_16_4 < var_4(var_16_3.serverVersion.Build)
end
