...
function var_0_0.findUI(arg_4_0, arg_4_1)
	...
	findTF = var_3
	arg_4_0.titleText = var_3(var_4_0, "Title")
	findTF = var_3
	...
	var_3(var_4_1, var_5("setting_resdownload_title_main_group"))
...
function var_0_0.addListener(arg_5_0)
	...
	local function var_5_2()
		...
		if var_6_1 ~= var_6_0.SettingsGroupMgr.State.Updating then
			local var_6_2 = arg_5_0.mgr
			local var_6_3 = var_1.GetTotalSize(var_6_2, arg_5_0.groupNameList)

			HashUtil = var_6_2

			local var_6_4 = var_6_2.BytesToString(var_6_3)

			pg = var_3

			local var_6_5 = var_3.MsgboxMgr.GetInstance()
			local var_6_6 = var_3.ShowMsgBox
			local var_6_7 = {}

			MSGBOX_TYPE_NORMAL = var_2_10006
			var_6_7.type = var_2_10006
			string = var_2_10006

			local var_6_8 = var_2_10006.format

			i18n = var_2_10007
			var_6_7.content = var_6_8(var_2_10007("main_group_msgbox_content", var_6_4))
			...
			function var_6_7.onYes()
				...
				DMFileChecker = var_3_10001

				var_7_0(var_3_10001.Prefs.Max)
...
function var_0_0.updateUI(arg_10_0)
	...
	if var_10_1 == var_10_0.SettingsGroupMgr.State.None then
		setText = var_2
		...
		var_2(var_10_2, var_1_10004("word_maingroup_checktoupdate"))
		...
		if var_10_1 == var_2.SettingsGroupMgr.State.Updating then
			...
			var_10_5(var_10_3, var_1_10004("word_maingroup_updating"))
			...
			var_1_10004(arg_10_0.progressBar, 0, var_10_6, var_10_5)

			setText = var_1_10004

			var_1_10004(arg_10_0.btnText, var_10_5 .. "/" .. var_10_6)
		else
			pg = var_10_5
			...
			if var_10_1 == var_10_5.SettingsGroupMgr.State.Success then
				...
				var_2(var_10_7, var_1_10004("word_maingroup_updatesuccess"))
				...
				if var_10_1 == var_2.SettingsGroupMgr.State.Fail then
					...
					var_2(var_10_8, var_1_10004("word_maingroup_updatefailure"))
