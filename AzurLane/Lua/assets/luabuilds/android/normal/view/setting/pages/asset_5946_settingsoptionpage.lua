...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	ScrollRect = iter_2_0
	arg_2_0.scrollrect = var_2_8(var_2_7, var_4(iter_2_0))
...
function var_0_1.OnBindEvent(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.EVT_UPDTAE, function()
		...
		SettingsRandomFlagShipAndSkinPanel = var_2_10002
	...
	SettingsNotificationPanel = var_3

	var_3_3(var_3_2, var_3.UPDATE_ALARM_PANEL, function()
		local var_5_0 = arg_3_0
		local var_5_1 = var_0.GetPanel

		SettingsNotificationPanel = var_2_10002

		if var_5_1(var_5_0, var_2_10002) then
...
function var_0_1.GetPanels(arg_6_0)
	...
	if arg_6_0:NeedAdjustScreen() then
		...
		var_6_1(var_6_2, var_6_3, var_1_10005)
	end
	...
	if var_2.IsGatewayPackage(var_6_4) then
		...
		SettingsDebugPanel = var_1_10005

		var_6_5(var_6_6, var_6_7, var_1_10005)
	end
...
function var_0_1.InitPanels(arg_10_0)
	...
	local var_10_2 = var_1_10002(var_10_1, var_1_10004(var_1_10005))
...
function var_0_1.OnInitPanle(arg_15_0)
	if arg_15_0.contextData.scroll then
		...
		if arg_15_0.contextData.scroll == "world_settings" then
			...
			local var_15_3 = var_15_2(var_15_1, var_1_10004)
		else
...
function var_0_1.ScrollToPanel(arg_16_0, arg_16_1)
	...
	setAnchoredPosition = var_16_0

	var_16_0(arg_16_0.panelContainer, {
		y = -var_16_1.y
	})
