...
function var_0_1.Flush(arg_2_0)
	...
	local function var_2_2()
		...
		var_3_1(var_3_0, var_2_10002.ON_SEL_EDUCATE_CHAR)
	...
	VirtualEducateCharShip = var_2_3

	local var_2_5 = var_2_3.New(var_2_4:GetEducateCharacter())

	setPaintingPrefabAsync = var_3

	var_3(arg_2_0.paintingTr, var_2_5:getPainting(), "biandui")
...
function var_0_1.Clear(arg_4_0)
	if arg_4_0.ship then
		...
		var_1(var_4_0, var_3.getPainting(var_4_1))
	end
