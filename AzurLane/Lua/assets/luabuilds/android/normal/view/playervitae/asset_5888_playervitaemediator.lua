...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_SEL_EDUCATE_CHAR, function(arg_2_0)
		...
		EducateCharDockScene = var_2_10005
	...
	arg_1_0:bind(var_0_1.ON_GET_LOVE_LETTER_MAIL, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.ACCEPT_LOVE_LETTER_MAIL, {
			activity_id = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_CRYPTOLALIA, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_5_2, var_2_10005.CRYPTOLALIA, {
			groupId = arg_5_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SWITCH_RANDOM_FLAG_SHIP_BTN, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.RANDOM_FLAG_SHIP, {
			isOn = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.GO_SCENE, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10005.GO_SCENE, arg_7_1, arg_7_2)
	...
	arg_1_0:bind(var_0_1.CHANGE_RANDOM_SETTING, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.CHANGE_RANDOM_SHIP_AND_SKIN_SETTING, arg_8_1)
	...
	arg_1_0:bind(var_0_1.CHANGE_PAINTS, function(arg_10_0, arg_10_1, arg_10_2)
		...
		var_10_1(var_10_0, var_2_10005.CHANGE_PLAYER_ICON, {
			after = arg_10_1,
			callback = arg_10_2
		})
	...
	arg_1_0:bind(var_0_1.ON_CHANGE_PLAYER_NAME, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10004.CHANGE_PLAYER_NAME, {
			name = arg_11_1
		})
	...
	arg_1_0:bind(var_0_1.ON_ATTIRE, function()
		...
		var_12_1(var_12_0, var_12_2, var_2_10003.ATTIRE)
	...
	arg_1_0:bind(var_0_1.CHANGE_MANIFESTO, function(arg_13_0, arg_13_1)
		...
		var_13_1(var_13_0, var_2_10004.CHANGE_PLAYER_MANIFESTO, {
			manifesto = arg_13_1
		})
	...
	arg_1_0:bind(var_0_1.CHANGE_PAINT, function(arg_14_0, arg_14_1)
		...
		local var_14_1 = var_2_10003(var_2_10004)
		...
		if arg_14_1 then
			...
			local var_14_4 = var_14_2.removebyvalue
			local var_14_5 = var_14_3

			var_2_10008 = arg_14_1

			var_14_4(var_14_5, arg_14_1.GetShipPhantomMark(var_2_10008))
		end

		local var_14_6 = arg_1_0.contextData

		var_14_6.showSelectCharacters = true
		PlayerVitaeShipsPage = var_14_6

		local var_14_7, var_14_8 = var_14_6.GetSlotMaxCnt()
		local var_14_9 = {
			callbackQuit = true,
			selectedMax = var_14_8
		}

		ShipStatus = var_2_10008
		var_14_9.hideTagFlags = var_2_10008.TAG_HIDE_ADMIRAL
		var_14_9.selectedIds = var_14_0
		var_14_9.selectedMarks = var_14_3
		pg = var_8

		local var_14_10 = var_8.ShipFlagMgr.GetInstance()

		var_14_9.ignoredIds = var_8.FilterShips(var_14_10, {
			isActivityNpc = true
		})

		function var_14_9.onSelected(arg_15_0, arg_15_1)
			local var_15_0 = arg_1_0
			local var_15_1 = var_2.ReSortShipIds
			local var_15_2 = var_0
			local var_15_3 = var_15_1(var_15_0, var_4.GetShipPhantomMarks(var_15_2), arg_15_0)
			...
			var_15_5(var_15_4, var_5.CHANGE_PLAYER_ICON, {
				after = var_15_3,
				callback = arg_15_1
			})
		...
		local var_14_11 = arg_1_0
		local var_14_12 = var_8.addSubLayers

		Context = var_10

		local var_14_13 = var_10.New
		local var_14_14 = {}

		PlayerVitaeDockyardScene = var_2_10012
		var_14_14.viewComponent = var_2_10012
		DockyardMediator = var_2_10012
		var_14_14.mediator = var_2_10012
		var_14_14.data = var_14_9

		var_14_12(var_14_11, var_14_13(var_14_14))
...
function var_0_1.ReSortShipIds(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_0, iter_16_1 in var_1_10004({
		...
		for iter_16_2, iter_16_3 in var_1_10011(var_1_10009) do
...
function var_0_1.handleNotification(arg_18_0, arg_18_1)
	...
	if var_18_0 == var_18_1.CHANGE_PLAYER_NAME_DONE then
		...
		if var_18_0 == var_4.SKIN_UPDATED then
			...
			var_18_5(var_18_4, var_6.GetShipPhantomMark(var_18_6))
		else
			GAME = var_18_5

			if var_18_0 == var_18_5.UPDATE_SKINCONFIG then
				...
				if var_18_0 == var_4.CHANGE_PLAYER_ICON_DONE then
					...
					if var_18_0 == var_4.NotifyPaintingDownloadFinish then
						...
						if var_18_0 == var_4.CHANGE_EDUCATE_DONE then
							...
							if var_18_0 == var_4.CLEAR_EDUCATE_TIP then
								if arg_18_0.viewComponent.shipsPage then
								...
								if var_18_0 == var_4.CHANGE_SKIN_UPDATE then
									...
									if var_18_0 == var_4.ACCEPT_LOVE_LETTER_MAIL_DONE and arg_18_0.viewComponent.shipsPage then
