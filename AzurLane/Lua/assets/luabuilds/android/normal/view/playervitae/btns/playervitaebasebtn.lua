...
function var_0_0.NewGo(arg_3_0)
	...
	local var_3_4 = var_3_3(var_3_2, var_1_10005(var_1_10006))

	LoadSprite = var_3_2
	var_3_4.sprite = var_3_2("ui/" .. var_3_0, var_3_1)
...
local function var_0_1(arg_12_0, arg_12_1)
	...
	if arg_12_0.IsHrzType(var_12_0) then
		local var_12_1 = arg_12_0.block

		if arg_12_1 then
			Vector2 = var_12_0

			if not var_12_0(-33, 0) then
				Vector2 = var_12_0
				var_12_0 = var_12_0(-96, 0)
			end

			var_12_1.anchoredPosition = var_12_0

			if false then
				setActive = var_12_1

				var_12_1(arg_12_0.off, not arg_12_1)

				setActive = var_12_1

				var_12_1(arg_12_0.on, arg_12_1)

				local var_12_2 = arg_12_1 and "#FFFFFFFF" or "#5A6177"
				local var_12_3 = arg_12_1 and "#5A6177" or "#FFFFFFFF"
				local var_12_4 = arg_12_0.onTxt
				local var_12_5 = var_4.GetComponent

				typeof = var_1_10006
				Text = var_1_10007
				var_12_5(var_12_4, var_1_10006(var_1_10007)).text = "<color=" .. var_12_2 .. ">ON</color>"

				local var_12_6 = arg_12_0.offTxt
				local var_12_7 = var_4.GetComponent

				typeof = var_6
				Text = var_7
				var_12_7(var_12_6, var_6(var_7)).text = "<color=" .. var_12_3 .. ">OFF</color>"
			end
