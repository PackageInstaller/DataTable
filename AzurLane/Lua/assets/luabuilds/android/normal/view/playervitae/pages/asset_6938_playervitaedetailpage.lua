...
function var_0_1.OnLoaded(arg_3_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.emblemIcon = var_3_3(var_3_2, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_3_0.emblemTxt = var_3_6(var_3_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.highestEmblem = var_3_9(var_3_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.powerTxt = var_3_12(var_3_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.collectionTxt = var_3_15(var_3_14, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.nameTxt = var_3_19(var_3_18, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.idTxt = var_3_22(var_3_21, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.levelTxt = var_3_25(var_3_24, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.expTxt = var_3_28(var_3_27, var_3(var_1_10004))
	...
	local var_3_42 = var_2.Find(var_3_41, "power/collection_label")

	i18n = var_3_41

	var_3_36(var_3_42, var_3_41("friend_resume_collection_rate"))

	setText = var_3_36

	local var_3_43 = arg_3_0._tf
	local var_3_44 = var_2.Find(var_3_43, "power/power_label")

	i18n = var_3_43

	var_3_36(var_3_44, var_3_43("friend_resume_fleet_gs"))

	setText = var_3_36

	local var_3_45 = arg_3_0._tf
	local var_3_46 = var_2.Find(var_3_45, "info/title_name")

	i18n = var_3_45

	var_3_36(var_3_46, var_3_45("friend_resume_title"))

	setText = var_3_36

	local var_3_47 = arg_3_0._tf
	local var_3_48 = var_2.Find(var_3_47, "statistics/title_name")

	i18n = var_3_47

	var_3_36(var_3_48, var_3_47("friend_resume_data_title"))

	setText = var_3_36

	local var_3_49 = arg_3_0._tf
	local var_3_50 = var_2.Find(var_3_49, "greet/InputField/Placeholder")

	i18n = var_3_49

	var_3_36(var_3_50, var_3_49("player_manifesto_placeholder"))
...
function var_0_1.OnInit(arg_6_0)
	...
	local function var_6_2()
		...
		if not var_7_1 then
			...
			local var_7_3 = var_2_10002.TipsMgr.GetInstance()
	...
	local function var_6_11()
		...
		var_10_1(var_10_0, var_2_10002.ShareMgr.TypeAdmira)
	...
	local function var_6_14()
		...
		var_11_1(var_11_0, var_2_10002.ON_ATTIRE)
	...
	local var_6_17 = var_6_14(var_1_10005)

	var_1_10001(var_6_15, var_6_16(var_4.needTip(var_6_17), function(arg_12_0)
	...
	var_1_10001(arg_6_0, arg_6_0.inputField, function(arg_13_0)
		...
		if 0 < var_13_0 then
			...
			var_13_2(var_13_1, var_2_10004("playerinfo_mask_word"))
		...
		var_13_4(var_13_3, var_2_10004.CHANGE_MANIFESTO, arg_13_0)
...
function var_0_1.DoEnterAnimation(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10001(arg_15_0.animPanels) do
		...
		var_1_10009(var_15_4, var_11.easeInOutSine)
	end
...
function var_0_1.UpdateMedals(arg_16_0)
	...
	var_1_10005.StaticAlign(arg_16_0.medalTpl.parent, arg_16_0.medalTpl, var_16_1, function(arg_17_0, arg_17_1, arg_17_2)
		arg_17_1 = arg_17_1 + 1
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			if 0 < var_17_0 then
				...
				local var_17_5 = var_17_1.isLoverLetter(var_17_4)

				setActive = var_17_4

				var_17_4(var_17_2, not var_17_5)

				setActive = var_17_4

				var_17_4(var_17_3, var_17_5)

				if var_17_5 then
					setLoveLetterMedal = var_17_4

					var_17_4(var_17_3:Find("medal"), var_17_1, {
						hideMark = true
					})
				else
					LoadImageSpriteAsync = var_17_4

					var_17_4("medal/s_" .. var_17_1:getConfig("icon"), var_17_2, true)
				end
...
function var_0_1.UpdatePower(arg_18_0)
	...
	local var_18_2 = var_18_0.getEmblem(var_18_1.score, var_18_1.rank)

	LoadSpriteAsync = var_3

	var_3("emblem/" .. var_18_2, function(arg_19_0)
	...
	var_3("emblem/n_" .. var_18_2, function(arg_20_0)
	...
	local var_18_3 = var_3.max(arg_18_0.player.maxRank, 1)
...
function var_0_1.UpdateInfo(arg_22_0)
	...
	local var_22_1 = var_22_0(var_2.user_level, arg_22_0.player.level).exp
	...
	setInputText = var_22_2

	var_22_2(arg_22_0.inputField, var_22_3)
...
function var_0_1.UpdateStatistics(arg_23_0)
	...
	local var_23_2 = var_1_10003(355, 25)
	...
	for iter_23_0 = 1, #var_23_0, var_23_1 do
		...
		for iter_23_1 = 1, var_23_1 do
			...
			local var_23_7 = var_1_10015

			i18n = var_1_10019

			var_1_10017(var_23_7, var_1_10019(var_23_6[1]))

			setText = var_1_10017
			var_1_10019 = var_1_10015

			var_1_10017(var_1_10015.Find(var_1_10019, "value"), var_23_6[2])

			var_1_10017 = var_23_3.x + (iter_23_1 - 1) * var_23_2.x
			Vector2 = var_18
			var_1_10015.anchoredPosition = var_18(var_1_10017, var_23_5)
		end
	end
...
function var_0_1.GetDisplayStatisticsData(arg_24_0)
	...
	local var_24_4 = var_24_1(var_24_2, var_24_3 / var_1_10005.max(var_24_0.attackCount, 1) * 100) .. "%"
	...
	local var_24_8 = var_24_5(var_24_6, var_24_7 / var_6.max(var_24_0.pvp_attack_count, 1) * 100) .. "%"
...
function var_0_1.OnDestroy(arg_25_0)
	...
	var_1(arg_25_0.medalTpl.parent, function(arg_26_0, arg_26_1)
		if arg_26_0:Find("now/medal").childCount > 0 then
			...
			var_2(var_3.GetChild(var_26_0, 0))
		end
