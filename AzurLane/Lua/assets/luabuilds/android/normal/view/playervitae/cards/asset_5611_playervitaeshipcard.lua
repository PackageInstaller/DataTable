...
function var_0_1.OnInit(arg_1_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_1_0.bgImage = var_1_2(var_1_1, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_1_0.lvTxt = var_1_7(var_1_6, var_3(var_1_10004))
	...
	local var_1_14 = var_2.Find(var_1_13, "front/stars")
	local var_1_15 = arg_1_0._tf

	arg_1_0.UIlist = var_1_12(var_1_14, var_3.Find(var_1_15, "front/stars/star_tpl"))
	...
	var_1_26(arg_1_0.editTr, function(arg_2_0)
		string = var_2_10001
	...
	PlayerVitaeBaseBtn = var_5
	var_1_28[2] = var_1_31(var_1_32, var_5.VEC_TYPE)
	...
	PlayerVitaeBaseBtn = var_5
	var_1_28[3] = var_1_33(var_1_34, var_5.VEC_TYPE)
	...
	local function var_1_37()
		...
		var_3_1(var_3_0, var_2_10002.CHANGE_SKIN, arg_1_0.displayShip)
	...
	var_1_28(var_1_35, var_1_36, var_1_37, var_1_10006)
	...
	local function var_1_40()
		...
		if not arg_1_0.canClick then
			...
			if var_0.ShouldTip(var_4_0) then
				...
				var_4_3(var_4_2, var_2_10002("random_ship_forbidden"))
			end
		...
		var_4_5(var_4_4, var_2_10002.CHANGE_PAINT, arg_1_0.displayShip)
	...
	var_1_28(var_1_38, var_1_39, var_1_40, var_1_10006)
	...
	arg_1_0.eventTrigger = var_1_28(var_1_41, var_1_39(var_1_40))
	...
	local var_1_43 = var_3.Find(var_1_42, "Text")

	i18n = var_1_42

	var_2(var_1_43, var_1_42("random_ship_skin_label"))

	setText = var_2

	local var_1_44 = arg_1_0.randomShipBtn
	local var_1_45 = var_3.Find(var_1_44, "Text")

	i18n = var_1_44

	var_2(var_1_45, var_1_44("random_ship_label"))

	setText = var_2

	local var_1_46 = arg_1_0.changskinBtn
	local var_1_47 = var_3.Find(var_1_46, "Text")

	i18n = var_1_46

	var_2(var_1_47, var_1_46("random_flag_ship_changskinBtn_label"))
...
function var_0_1.RegisterEvent(arg_10_0)
	...
	var_10_0:AddBeginDragFunc(function()
		...
		if not arg_10_0.canClick then
			...
			if var_11_4.ShouldTip(var_11_1) then
				...
				var_11_4(var_11_3, var_2_10002("random_ship_forbidden"))
			end
		...
		var_11_5(var_11_6, var_2_10002(1.1, 1.1, 0), 0.3)
		...
		var_11_9(var_11_8, var_2.ON_BEGIN_DRAG_CARD, arg_10_0.slotIndex)
	...
	var_10_0:AddDragFunc(function(arg_12_0, arg_12_1)
		...
		Vector3 = var_4
		var_12_3.localPosition = var_4(var_12_2.x, arg_10_0._tf.localPosition.y, 0)
		...
		var_12_5(var_12_4, var_5.ON_DRAGING_CARD, var_12_2)
	...
	var_10_0:AddDragEndFunc(function(arg_13_0, arg_13_1)
		...
		var_13_1(var_13_2, var_2_10004(1, 1, 0), 0.3)
		...
		var_13_4(var_13_3, var_4.ON_DRAG_END_CARD)
...
function var_0_1.Change2RectPos(arg_14_0, arg_14_1, arg_14_2)
	...
	return (var_14_0.ScreenToLocal(arg_14_1, arg_14_2, var_14_1))
end
...
function var_0_1.OnUpdate(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4, arg_15_5)
	...
	local var_15_1 = var_1_10007(var_1_10008)
	...
	if not var_8.isHxSkin() then
		...
		var_15_3 = var_8(var_15_3)
		var_15_4 = var_8.HasFashion(var_15_3, var_15_2)
	else
		var_15_4 = false
	end
	...
	var_15_3(arg_15_0.changskinBtn, var_15_4)

	setActive = var_15_3

	local var_15_5 = arg_15_0.nativeTr
	local var_15_6

	if arg_15_0.canClick then
		var_15_6 = arg_15_0.native
	end

	var_15_3(var_15_5, var_15_6)
...
function var_0_1.UpdateShip(arg_17_0, arg_17_1)
	...
	local var_17_2 = arg_17_0.UIlist

	var_4.make(var_17_2, function(arg_18_0, arg_18_1, arg_18_2)
		UIItemList = var_2_10003

		if arg_18_0 == var_2_10003.EventUpdate then
			setActive = var_3

			var_3(arg_18_2:Find("star"), arg_18_1 < var_17_1)
		end
	...
	local var_17_4 = arg_17_1
	local var_17_5 = arg_17_1.rarity2bgPrint(var_17_4)

	GetImageSpriteFromAtlasAsync = var_17_4

	var_17_4("bg/star_level_card_" .. var_17_5, "", arg_17_0.bgImage)

	local var_17_6 = arg_17_1
	local var_17_7 = arg_17_1.getShipType(var_17_6)

	setImageSprite = var_17_6
	...
	var_17_6(var_17_8, var_8(var_17_9, var_10(var_17_7)))

	local var_17_10, var_17_11 = arg_17_1:GetFrameAndEffect(true)

	setRectShipCardFrame = var_8

	var_8(arg_17_0.frame, var_17_5, var_17_10)

	setFrameEffect = var_8

	var_8(arg_17_0.otherBg, var_17_11)

	setProposeMarkIcon = var_8

	var_8(arg_17_0.proposeMark, arg_17_1)
...
function var_0_1.updatePaintingTag(arg_19_0)
	if arg_19_0.displayShip then
		...
		var_1_10002(var_19_0, #var_1_10004.GetPaintingNameListByShipVO(var_1) > 0)
	end
...
local function var_0_2(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	local var_24_2 = arg_24_1.Find(var_24_1, "off")
	...
	var_24_1(var_24_3, var_24_4, var_24_5, var_1_10010)

	setActive = var_24_1

	var_24_1(var_24_0, arg_24_2)

	setActive = var_24_1

	var_24_1(var_24_2, not arg_24_2)
...
function var_0_1.UpdateRandomBtns(arg_26_0)
	...
	local var_26_2 = var_1_10003(var_1_10004)
