...
function var_0_1.StartCheckUpdate(arg_7_0, arg_7_1)
	...
	DownloadState = var_7_1

	if var_7_2 ~= var_7_1.CheckToUpdate then
		DownloadState = var_4
		...
		if var_7_2 == var_4.UpdateFailure then
			...
			local function var_7_5()
				...
				local var_8_4 = var_4.BytesToString(var_8_3)
				...
				var_8_7.type = var_2_10008
				string = var_2_10008

				local var_8_8 = var_2_10008.format

				i18n = var_2_10009
				var_8_7.content = var_8_8(var_2_10009("group_download_tip", var_8_4))
				...
				function var_8_7.onYes()
					...
					local var_9_3 = var_9_1.Inst
					local var_9_4 = var_2.CreateListInfo(var_9_3, var_8_2, var_9_2, nil, var_9_0, nil)

					BundleWizardUpdater = var_9_3

					local var_9_5 = var_9_3.Inst
			...
			var_4(var_7_3, var_7_4, var_7_5, var_1_10008)
		else
			checkABExist = var_4
...
function var_0_1.GetDefaultValue(arg_11_0)
	...
	SHIP_FLAG_L2D = var_1_10004

	local var_11_3 = var_11_1(var_11_0, var_11_2, var_1_10004)

	Live2dConst = var_11_0

	if var_11_0.GetLive2DArm32MatchAble() then
		if var_11_3 then
			var_11_2 = arg_11_0
	...
	return var_11_5(var_11_4, var_11_6, var_1_10005)
end
...
function var_0_1.OnSwitch(arg_12_0, arg_12_1)
	...
	if var_12_0(var_3.getSkinId(var_12_1)) and true or false then
		getProxy = var_12_2
		SettingsProxy = var_12_1
		var_12_1 = var_12_2(var_12_1)
		var_12_2 = var_12_2.setCharacterSetting

		local var_12_3 = arg_12_0.ship.id
	...
	local var_12_5 = var_3.setCharacterSetting
	local var_12_6 = arg_12_0.ship.id

	SHIP_FLAG_L2D = var_1_10006

	var_12_5(var_12_4, var_12_6, var_1_10006, arg_12_1)
...
function var_0_1.Load(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_14_1(var_14_0, var_4(var_1_10005))
