...
function var_0_1.GetSlotMaxCnt()
	...
	for iter_3_0, iter_3_1 in var_1_10003(var_0) do
		...
		if var_1_10008.isClear(var_1_10009, iter_3_1[1]) then
			var_3_1 = iter_3_1[2]
		end
	end
...
function var_0_1.OnLoaded(arg_8_0)
	...
	local var_8_17 = var_2.Find(var_8_16, "educate_char/shipCard/settings/panel")
	local var_8_18 = arg_8_0._tf

	arg_8_0.educateCharSettingList = var_8_15(var_8_17, var_3.Find(var_8_18, "educate_char/shipCard/settings/panel/tpl"))
	...
	if var_1 then
		...
		setAnchoredPosition = var_1
		var_8_21 = arg_8_0._tf

		var_1(var_2.Find(var_8_21, "flagship"), {
			x = -720
		})
		...
		var_1(var_2.Find(var_8_21, "line"), {
			x = 740
		})
	end

	local var_8_22 = {}
	local var_8_23 = var_0_2

	PlayerVitaeEducateShipCard = var_8_21

	local var_8_24 = var_8_21.New
	local var_8_25 = arg_8_0._tf

	var_8_22[var_8_23] = var_8_24(var_4.Find(var_8_25, "educate_char/shipCard"), arg_8_0.event)

	local var_8_26 = var_0_3

	PlayerVitaeEducateAddCard = var_3

	local var_8_27 = var_3.New
	local var_8_28 = arg_8_0._tf

	var_8_22[var_8_26] = var_8_27(var_4.Find(var_8_28, "educate_char/addCard"), arg_8_0.event)

	local var_8_29 = var_0_4

	PlayerVitaeEducateLockCard = var_3

	local var_8_30 = var_3.New
	local var_8_31 = arg_8_0._tf

	var_8_22[var_8_29] = var_8_30(var_4.Find(var_8_31, "educate_char/lockCard"), arg_8_0.event)
	arg_8_0.educateCharCards = var_8_22

	local var_8_32 = arg_8_0._tf
	local var_8_33 = var_1.Find(var_8_32, "tip")
	local var_8_34 = var_1.GetComponent

	typeof = var_3
	Text = var_4
	arg_8_0.tip = var_8_34(var_8_33, var_3(var_4))

	local var_8_35 = arg_8_0._tf

	arg_8_0.flagShipMark = var_1.Find(var_8_35, "flagship")
	...
	local var_8_36 = arg_8_0.nativeBtnOn
	local var_8_37 = var_2.Find(var_8_36, "Text")

	i18n = var_8_36

	var_1(var_8_37, var_8_36("random_ship_before"))

	setText = var_1

	local var_8_38 = arg_8_0.nativeBtnOff
	local var_8_39 = var_2.Find(var_8_38, "Text")

	i18n = var_8_38

	var_1(var_8_39, var_8_38("random_ship_now"))

	setText = var_1

	local var_8_40 = arg_8_0.settingBtn
	local var_8_41 = var_2.Find(var_8_40, "Text")

	i18n = var_8_40

	var_1(var_8_41, var_8_40("player_vitae_skin_setting"))

	setText = var_1

	local var_8_42 = arg_8_0.randomBtn
	local var_8_43 = var_2.Find(var_8_42, "Text")

	i18n = var_8_42

	var_1(var_8_43, var_8_42("random_ship_label"))

	setText = var_1

	local var_8_44 = arg_8_0.settingSeceneBtn
	local var_8_45 = var_2.Find(var_8_44, "Text")

	i18n = var_8_44

	var_1(var_8_45, var_8_44("playervtae_setting_btn_label"))

	setText = var_1

	local var_8_46 = arg_8_0.getMailBtn
	local var_8_47 = var_2.Find(var_8_46, "Text")

	i18n = var_8_46

	var_1(var_8_47, var_8_46("spring_present_tips_btn"))

	setText = var_1

	local var_8_48 = arg_8_0.getMailBtn
	local var_8_49 = var_2.Find(var_8_48, "time")

	i18n = var_8_48

	var_1(var_8_49, var_8_48("spring_present_tips_time"))

	GetOrAddComponent = var_1

	local var_8_50 = arg_8_0.cardContainer

	typeof = var_3
	CanvasGroup = var_4
	arg_8_0.cardContainerCG = var_1(var_8_50, var_3(var_4))
...
function var_0_1.OnEndDragCard(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10007(arg_16_0.displayCards) do
		...
		var_16_6(var_16_7, var_14.GetShipPhantomMark(var_16_8))
	...
	if var_16_5 then
		...
		PlayerVitaeMediator = var_9

		var_16_10(var_16_9, var_9.CHANGE_PAINTS, var_16_1, function()
			Timer = var_2_10000
...
function var_0_1.OnInit(arg_19_0)
	...
	local function var_19_2()
		...
		i18n = var_2_10003
		var_20_2.helps = var_2_10003("secretary_help")
	...
	var_19_1(var_19_5, var_19_6, var_19_7, var_1_10007)
	var_19_4()
	...
	local function var_19_13()
		...
		if arg_19_0.randomFlag then
			...
			if not var_0.Random(var_25_0) or #var_0 <= 0 then
				...
				local var_25_1 = var_25_0.TipsMgr.GetInstance()
				local var_25_2 = var_1.ShowTips

				i18n = var_2_10003

				var_25_2(var_25_1, var_2_10003("random_ship_off_0"))
			...
			var_1.UpdateRandomFlagShipList(var_25_3, var_0)
		else
		...
		if arg_19_0.randomFlag then
			...
			local var_25_9 = var_25_5.TipsMgr.GetInstance()
			...
			PlayerVitaeMediator = var_3

			var_25_11(var_25_10, var_3.ON_SWITCH_RANDOM_FLAG_SHIP_BTN, arg_19_0.randomFlag)
	...
	var_19_7(var_19_11, var_19_12, var_19_13, var_1_10010)
	var_19_9()
	...
	var_6(var_19_14, var_19_15, var_19_16, var_1_10010)
	var_19_10()
	...
	var_6(arg_19_0, arg_19_0.getMailBtn, function()
		...
		if arg_19_0.randomFlag then
			...
			var_27_1(var_27_0, var_2_10002("spring_present_tips0"))
		...
		i18n = var_2_10003
		var_27_4.content = var_2_10003("spring_present_tips1")
		...
		function var_27_4.onYes()
			...
			if not var_28_1(var_28_0, var_3_10002.ACTIVITY_TYPE_LOVE_LETTER_MAIL) then
				setActive = var_28_0

				var_28_0(arg_19_0.getMailBtn, false)

				pg = var_28_0

				local var_28_2 = var_28_0.TipsMgr.GetInstance()
				local var_28_3 = var_1.ShowTips

				i18n = var_3_10003

				var_28_3(var_28_2, var_3_10003("challenge_end_tip"))
			...
			PlayerVitaeMediator = var_3_10003

			var_28_5(var_28_4, var_3_10003.ON_GET_LOVE_LETTER_MAIL, var_0.id)
	...
	local function var_19_19()
		...
		var_1(arg_19_0.educateCharSettingList.container, not var_29_0)
	...
	var_6(var_19_17, var_19_18, var_19_19, var_1_10010)
	...
	local function var_19_22()
		...
		local var_30_3 = var_2_10003.SETTINGS
		local var_30_4 = {}

		NewSettingsScene = var_2_10005
		var_30_4.page = var_2_10005.PAGE_OPTION
		SettingsRandomFlagShipAndSkinPanel = var_5
		var_30_4.scroll = var_5
	...
	var_6(var_19_20, var_19_21, var_19_22, var_1_10010)
	...
	PlayerVitaeShipCard = var_8

	var_19_23(var_19_24, var_8.New(arg_19_0.shipTpl, arg_19_0.event))
	...
	PlayerVitaeAddCard = var_8

	var_19_25(var_19_26, var_8.New(arg_19_0.emptyTpl, arg_19_0.event))
	...
	PlayerVitaeLockCard = var_8

	var_19_27(var_19_28, var_8.New(arg_19_0.lockTpl, arg_19_0.event))
...
function var_0_1.UpdateGetMailBtn(arg_31_0)
	...
	local var_31_2 = var_31_1(var_31_0, var_1_10003.ACTIVITY_TYPE_LOVE_LETTER_MAIL)

	setActive = var_31_0

	var_31_0(arg_31_0.getMailBtn, var_31_2 and not var_31_2:isEnd() and var_31_2:readyToAchieve())
...
function var_0_1.UpdateEducateCharTrTip(arg_34_0)
	...
	var_1_10001(var_34_0, var_3.ShouldEducateCharTip(var_34_1))
...
function var_0_1.UpdateEducateCharSettings(arg_37_0)
	...
	local function var_37_1()
		...
		local var_38_3 = var_2.Find(var_38_2, "Text")

		i18n = var_38_2

		var_38_0(var_38_3, var_38_2("flagship_display_mode_" .. var_38_1))
	...
	var_4.make(var_37_3, function(arg_39_0, arg_39_1, arg_39_2)
		...
		if arg_39_0 == var_2_10003.EventUpdate then
			...
			local var_39_2 = arg_39_2.Find(var_39_1, "Text")

			i18n = var_39_1

			var_4(var_39_2, var_39_1("flagship_display_mode_" .. var_39_0))

			onButton = var_4

			local var_39_3 = arg_37_0
			local var_39_4 = arg_39_2
			...
			var_4(var_39_3, var_39_4, var_39_5, var_8)
...
function var_0_1.SwitchToPage(arg_41_0, arg_41_1)
	...
	if arg_41_1 == var_0 then
		...
		local var_41_2 = var_1_10004(var_1_10005)

		var_41_0 = var_41_1(var_1_10004.GetRandomFlagShipList(var_41_2), function(arg_42_0)
			getProxy = var_2_10001
			BayProxy = var_2_10002

			local var_42_0 = var_2_10001(var_2_10002)

			return var_1.GetShipPhantom(var_42_0, arg_42_0) ~= nil
		end)

		local var_41_3 = arg_41_0.tip

		i18n = var_1_10004
		var_41_3.text = var_1_10004("random_ship_tips1")
		var_1_10004 = arg_41_0

		local var_41_4 = arg_41_0.emit

		PlayerVitaeScene = var_5

		local var_41_5 = var_5.ON_PAGE_SWTICH

		PlayerVitaeScene = var_1_10006

		var_41_4(var_1_10004, var_41_5, var_1_10006.PAGE_RANDOM_SHIPS)
	elseif arg_41_1 == var_0_5 then
		getProxy = var_3
		PlayerProxy = var_1_10004

		local var_41_6 = var_3(var_1_10004)
		local var_41_7 = var_3.getRawData(var_41_6)

		var_41_0 = var_3.GetShipPhantomMarks(var_41_7)

		local var_41_8 = arg_41_0.tip

		i18n = var_41_7
		var_41_8.text = var_41_7("random_ship_tips2")

		local var_41_9 = arg_41_0
		local var_41_10 = arg_41_0.emit

		PlayerVitaeScene = var_5

		local var_41_11 = var_5.ON_PAGE_SWTICH

		PlayerVitaeScene = var_1_10006

		var_41_10(var_41_9, var_41_11, var_1_10006.PAGE_NATIVE_SHIPS)
	end
...
function var_0_1.EditCardsForRandom(arg_51_0, arg_51_1)
	...
	for iter_51_0, iter_51_1 in var_4(var_51_1) do
		...
		if var_1_10009(iter_51_1._tf) then
			...
			var_1_10010 = iter_51_1

			iter_51_1.EditCardForRandom(var_1_10010, arg_51_1)
		end
	end
...
function var_0_1.SaveRandomSettings(arg_52_0, arg_52_1)
	...
	PlayerVitaeMediator = var_5

	var_52_3(var_52_2, var_5.CHANGE_RANDOM_SETTING, arg_52_1)
...
function var_0_1.Hide(arg_54_0)
	...
	PlayerVitaeScene = var_1_10003

	local var_54_2 = var_1_10003.ON_PAGE_SWTICH

	PlayerVitaeScene = var_1_10004

	var_54_1(var_54_0, var_54_2, var_1_10004.PAGE_DEFAULT)
