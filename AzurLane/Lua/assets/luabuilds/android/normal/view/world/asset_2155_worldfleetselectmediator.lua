...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OnSelectShip, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		for iter_2_0, iter_2_1 in var_2_10006(arg_1_0.contextData.fleets) do
			ipairs = var_2_10011
		...
		local var_2_8 = var_2_10011.GO_SCENE

		SCENE = var_2_10012

		local var_2_9 = var_2_10012.DOCKYARD
		local var_2_10 = {
			selectedMin = 0,
			useBlackBlock = true,
			selectedMax = 1
		...
		i18n = iter_2_2
		var_2_10.leastLimitMsg = iter_2_2("ship_formationMediator_leastLimit")
		var_2_10.quitTeam = var_2_0
		var_2_10.teamFilter = arg_2_1
		i18n = var_14
		var_2_10.leftTopInfo = var_14("word_formation")
		var_2_10.onShip = var_2_3
		var_2_10.confirmSelect = var_2_4
		var_2_10.onSelected = var_2_5
		ShipStatus = var_14
		var_2_10.hideTagFlags = var_14.TAG_HIDE_WORLD
	...
	arg_1_0:bind(var_0_1.OnGO, function(arg_3_0)
		...
		if arg_1_0.contextData.mapId then
			...
			var_3_3(var_3_2, var_2_10005.WORLD_ACTIVATE, {
			...
			if not var_3_0:CompareRedeploy(var_3_1) then
				...
				var_4.insert(var_3_4, function(arg_4_0)
					...
					i18n = var_3_10004
					var_4_2.content = var_3_10004("world_redeploy_not_change")
			...
			var_4.insert(var_3_4, function(arg_5_0)
				...
				local var_5_2 = var_5_1(var_5_0, var_3_10003.OpReqRedeploy)
				local var_5_3 = var_3_0.staminaMgr
				local var_5_4 = var_2.GetTotalStamina(var_5_3)

				pg = var_5_3

				local var_5_5 = var_5_3.MsgboxMgr.GetInstance()
				...
				setColorStr = var_3_10008

				local var_5_9 = var_5_2

				COLOR_GREEN = var_3_10010

				local var_5_10 = var_3_10008(var_5_9, var_3_10010)
				...
				if var_5_2 <= var_5_4 then
					COLOR_GREEN = var_3_10011

					if not var_3_10011 then
						COLOR_RED = var_3_10011
					end

					var_5_7.content = var_3_10006(var_5_8, var_5_10, var_5_9(var_5_11, var_3_10011))
			...
			var_4(var_3_4, function()
				...
				local var_7_2 = var_3_10002.WORLD_FLEET_REDEPLOY
				local var_7_3 = {}
				local var_7_4 = var_3_0

				var_7_3.elite_fleet_list = var_4.FormationIds2NetIds(var_7_4, var_3_1)
	...
	arg_1_0:bind(var_0_1.OnShipDetail, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_8_2, var_2_10005.SHIPINFO, {
	...
	arg_1_0:bind(var_0_1.OnCommanderFormationOp, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10004.COMMANDER_FORMATION_OP, {
			data = arg_9_1
		})
	...
	arg_1_0.bind(var_1_0, var_0_1.OnSelectEliteCommander, function(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
		...
		local var_11_5 = var_2_10009.GO_SCENE

		SCENE = var_2_10010

		local var_11_6 = var_2_10010.COMMANDERCAT
		local var_11_7 = {
			maxCount = 1
		}

		CommanderCatScene = var_2_10012
		var_11_7.mode = var_2_10012.MODE_SELECT
		CommanderCatScene = var_12
		var_11_7.fleetType = var_12.FLEET_TYPE_WORLD
		...
		function var_11_7.onSelected(arg_13_0, arg_13_1)
			...
			local var_13_1 = var_3_10003(var_3_10004)
			local var_13_2 = var_3.getCommanderById(var_13_1, var_13_0)

			pairs = var_13_1

			for iter_13_0, iter_13_1 in var_13_1(arg_1_0.contextData.fleets) do
				ipairs = var_3_10010
					...
					if iter_13_0 == arg_11_1 and iter_13_2 == arg_11_2 then
						...
						for iter_13_4, iter_13_5 in var_15(var_11_2) do
							if iter_13_5.groupId == var_13_2.groupId and iter_13_4 ~= arg_11_3 then
								...
								var_13_4(var_13_3, var_3_10022("commander_can_not_select_same_group"))
						...
						for iter_13_6, iter_13_7 in var_15(iter_13_3.commanders) do
							if var_13_0 == iter_13_7.id then
								...
								var_13_6(var_13_5, var_3_10022("commander_is_in_fleet_already"))
...
function var_0_1.handleNotification(arg_16_0, arg_16_1)
	...
	if var_16_0 == var_16_1.WORLD_ACTIVATE_DONE then
		nowWorld = var_16_3
		var_16_3 = var_16_3()
		var_1_10005 = {}

		local var_16_4 = var_16_3
		local var_16_5 = var_16_3.IsSystemOpen

		WorldConst = var_1_10008

		if var_16_5(var_16_4, var_1_10008.SystemDailyTask) then
			table = var_6

			var_6.insert(var_1_10005, function(arg_17_0)
		...
		if var_16_0 == var_16_3.WORLD_FLEET_REDEPLOY_DONE then
			var_1_10005 = arg_16_0

			arg_16_0.SetFleetSuccess(var_1_10005)
		else
			CommanderProxy = var_4

			local var_16_7

			if var_16_0 == var_4.PREFAB_FLEET_UPDATE then
				getProxy = var_16_7
				CommanderProxy = var_1_10005

				local var_16_6 = var_16_7(var_1_10005)
				...
				if var_16_0 == var_16_7.COMMANDER_WORLD_FORMATION_OP_DONE then
...
function var_0_1.GetDockCallbackFuncs(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	local var_19_0 = var_1_10004(var_1_10005)
	...
	local function var_19_1(arg_20_0, arg_20_1)
		...
		for iter_20_0, iter_20_1 in var_4(arg_19_3) do
			if arg_20_0.id ~= iter_20_1 then
				...
				if var_20_3(var_20_2, var_11.getShipById(var_20_4, iter_20_1)) then
					local var_20_5 = false

					i18n = var_20_2

					local var_20_6 = var_20_2("event_same_type_not_allowed")
...
function var_0_1.SetFleetSuccess(arg_23_0)
	...
	if arg_23_0.contextData.mapId then
		...
		if var_2.IsReseted(var_1_10003) then
			var_23_0 = {
				inShop = true
			}
		end
	...
	if var_23_2(var_23_1, var_1_10004) then
		...
		local var_23_6 = var_1_10005.CHANGE_SCENE

		SCENE = var_1_10006

		var_23_5(var_23_4, var_23_6, var_1_10006.WORLD, var_23_0)
	end
