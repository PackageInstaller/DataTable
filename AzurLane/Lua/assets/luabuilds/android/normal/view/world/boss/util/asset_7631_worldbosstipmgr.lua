...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	var_2.GetUI(var_1_0, "WorldBossTipUI", true, function(arg_2_0)
		...
		var_2_3.tipTFCG = var_2_5(var_2_4, var_4(var_2_10005))
...
function var_0_1.Show(arg_3_0, arg_3_1)
	if var_0_3 then
		local function var_3_0()
			...
			if var_4_1(var_4_0, var_2.GetType(var_4_2)) then
				table = var_0
	...
	if var_0_2 and arg_3_0:IsEnableNotify(arg_3_1:GetType()) then
		...
		if var_1_10006.SUPPORT_TYPE_FRIEND == var_3_2 then
			ChatConst = var_6
			var_3_3 = var_6.ChannelFriend
			i18n = var_6
			var_3_4 = var_6("world_word_friend")
		else
			WorldBoss = var_6

			if var_6.SUPPORT_TYPE_GUILD == var_3_2 then
				ChatConst = var_6
				var_3_3 = var_6.ChannelGuild
				i18n = var_6
				var_3_4 = var_6("world_word_guild_member")
			else
				ChatConst = var_6
				var_3_3 = var_6.ChannelWorldBoss
				i18n = var_6
				var_3_4 = var_6("world_word_guild_player")
			end
		end
		...
		local var_3_6 = arg_3_1.GetPlayer(var_3_5)

		getProxy = var_3_5
		PlayerProxy = var_1_10008

		local var_3_7 = var_3_5(var_1_10008)
		local var_3_8 = var_7.getData(var_3_7)
		local var_3_9 = {
			id = 4
		}
		...
		local var_3_10 = var_1_10009.TimeMgr.GetInstance()

		var_3_9.timestamp = var_9.GetServerTime(var_3_10)
		var_3_9.args = {
			isDeath = false,
			supportType = var_3_4,
			playerName = var_3_1,
		...
		var_3_9.player = var_3_6 or var_3_8
		var_3_9.uniqueId = arg_3_1.id .. "_" .. arg_3_1.lastTime
		ChatConst = var_9

		local var_3_11

		if var_3_3 == var_9.ChannelGuild then
			var_3_11 = arg_3_0

			arg_3_0.AddGuildMsg(var_3_11, var_3_3, var_3_9)
		else
			getProxy = var_9
			ChatProxy = var_3_11

			local var_3_12 = var_9(var_3_11)
			local var_3_13 = var_9.addNewMsg

			ChatMsg = var_11

			var_3_13(var_3_12, var_11.New(var_3_3, var_3_9))
		end
	end
...
function var_0_1.AddGuildMsg(arg_5_0, arg_5_1, arg_5_2)
	...
	if not var_3.getMemberById(var_5_1, arg_5_2.player.id) then
		return
	end
	...
	local var_5_2 = var_5_1(var_6)
	local var_5_3 = var_5.AddNewMsg

	ChatMsg = var_1_10007

	var_5_3(var_5_2, var_1_10007.New(arg_5_1, arg_5_2))
...
function var_0_1.IsEnable(arg_7_0, arg_7_1)
	...
	local var_7_1 = (function()
		...
		return var_8_0.any(var_0_4, function(arg_9_0)
...
function var_0_1.BuildClickableTxt(arg_11_0, arg_11_1)
	...
	local var_11_1 = arg_11_1.BuildTipText(var_11_0)

	string = var_11_0

	return var_11_0.format("<material=underline c=#FFFFFF h=1 event=onClick args=" .. arg_11_1.id .. ">%s</material>", var_11_1)
end
...
function var_0_1.AddTimer(arg_12_0)
	...
	local var_12_5 = var_12_4(var_12_3, var_4.Action_float(function(arg_13_0)
	...
	local var_12_7 = var_12_6(var_12_5, var_4.Action(function()
...
function var_0_1.OnClick(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4)
	...
	if not var_1_10005() or not var_5:IsActivate() then
		...
		var_17_1(var_17_0, var_1_10008("world_boss_unactivated"))
	...
	local function var_17_2(arg_18_0)
		...
		local var_18_0 = var_2_10001(var_2_10002)
		...
		local function var_18_2()
			local function var_19_0()
				...
				CombatLoadMediator = var_4_10002

				if var_20_2(var_20_1, var_4_10002) then
					return
				end
				...
				var_20_4(var_20_3, var_4_10002.GO_WORLD_BOSS_SCENE)
				...
				local var_20_7 = var_2.GO_SCENE

				SCENE = var_4_10003

				local var_20_8 = var_4_10003.WORLDBOSS
				local var_20_9 = {}

				tonumber = var_4_10005
				var_20_9.worldBossId = var_4_10005(arg_17_2)
			...
			local var_19_3 = var_3_10003.CHECK_WORLD_BOSS_STATE
			local var_19_4 = {}

			tonumber = var_3_10005
			var_19_4.bossId = var_3_10005(arg_17_2)
		...
		if var_18_1.mediator.__cname == "BattleMediator" then
			...
			i18n = var_2_10007
			var_18_5.content = var_2_10007("world_joint_exit_battle_tip")
			...
			function var_18_5.onYes()
				...
				var_21_1(var_21_0, var_3_10002.QUIT_BATTLE)
				var_18_2()
	...
	if var_6.isSetup then
		...
		if var_17_4(var_17_3, var_1_10010(arg_17_2)) then
			...
			if var_8.isDeath(var_17_5) then
				...
				local var_17_10 = var_17_9(var_17_8, var_1_10013(arg_17_2) .. "_" .. var_17_7)

				ipairs = var_17_8

				for iter_17_0, iter_17_1 in var_17_8(var_17_10) do
				...
				local var_17_11 = var_12(var_13)
				local var_17_12 = var_12.GetMessagesByUniqueId

				tonumber = iter_17_0

				local var_17_13 = var_17_12(var_17_11, iter_17_0(arg_17_2) .. "_" .. var_17_7)

				ipairs = var_17_11

				for iter_17_2, iter_17_3 in var_17_11(var_17_13) do
				...
				var_17_15(var_17_14, var_16("world_boss_none"))
...
function var_0_1.RemoveTimer(arg_22_0)
	...
	if var_22_0(var_1_10002(arg_22_0.tipTF)) then
		LeanTween = var_1
