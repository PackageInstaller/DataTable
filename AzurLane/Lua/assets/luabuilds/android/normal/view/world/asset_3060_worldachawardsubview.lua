...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.itemList = var_3_3(var_3_4, var_3.Find(var_3_5, "item"))
	...
	var_1.make(var_3_6, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventUpdate then
			...
			local var_4_5 = arg_4_2.Find(var_4_4, "award")

			setActive = var_4_4

			var_4_4(var_4_5, true)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("lock_award"), false)

			updateDrop = var_4_4

			var_4_4(var_4_5, var_4_0.drop)

			setGray = var_4_4

			var_4_4(var_4_5:Find("icon_bg"), var_4_1 or var_4_3)
			...
			var_4_4(var_4_6, var_4_7, var_4_8, var_2_10012)

			setText = var_4_4

			var_4_4(arg_4_2:Find("star/count"), var_4_0.star)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("star/bg_on"), var_4_2)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("star/bg_off"), not var_4_2)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("star/lock"), var_4_3)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("ready_mark"), var_4_2 and not var_4_1 and not arg_3_0.hasAward)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("get_mark"), var_4_2 and arg_3_0.hasAward)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("got_mark"), var_4_1)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("lock_mark"), var_4_3)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("mark/on"), var_4_1)

			setActive = var_4_4

			var_4_4(arg_4_2:Find("mark/off"), not var_4_1)
		end
...
function var_0_1.Setup(arg_11_0, arg_11_1)
	...
	local var_11_6 = var_5.Find(var_11_5, "title/Text")
	local var_11_7 = arg_11_1:GetBaseMap()

	var_4(var_11_6, var_6.GetName(var_11_7))
