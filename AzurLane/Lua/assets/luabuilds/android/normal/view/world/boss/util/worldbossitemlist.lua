...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.trigger = var_1_1(var_1_0, var_1_10005(var_1_10006))
	...
	math = var_1_10006
	arg_1_0.hrzOffset = var_1_2 / var_1_3(var_1_4 * var_1_10006.rad(1))
	math = var_3
...
function var_0_0.InitList(arg_5_0)
	for iter_5_0 = 1, arg_5_0.capacity do
		...
		Vector3 = var_5_0
		var_5_1.localScale = var_5_0.one
	...
	for iter_11_0 = 1, #arg_11_0.childs do
		...
		if not var_1_10008(var_11_1) then
			...
			if iter_11_0 == var_11_0 or iter_11_0 == var_11_0 + 1 then
				...
				math = var_1_10010
				arg_11_0.padding = var_11_2 + var_1_10010.abs(arg_11_0.space) * 2
			end
			...
			math = var_1_10010
			var_1_10010 = var_1_10010.tan

			local var_11_4 = 90 - arg_11_0.angle

			math = var_1_10012

			local var_11_5 = var_11_3 / var_1_10010(var_11_4 * var_1_10012.rad(1))

			Vector3 = var_1_10010

			local var_11_6 = var_1_10010(-arg_11_0.hrzOffset * var_1_10008 - var_11_5, -1 * (arg_11_0.tplHeight + arg_11_0.space) * var_1_10008 - arg_11_0.padding, 0)

			if arg_11_1 and var_1_10010.y < var_11_1.localPosition.y then
				Vector3 = var_1_10012
				var_11_6 = var_1_10012(arg_11_0.hrzOffset, arg_11_0.tplHeight + arg_11_0.space, 0)
			elseif not arg_11_1 and var_1_10010.y > var_11_1.localPosition.y then
				Vector3 = var_1_10012
				var_11_1.localPosition = var_1_10012(arg_11_0.hrzOffset, arg_11_0.tplHeight + arg_11_0.space, 0)
			end

			if iter_11_0 == var_11_0 or arg_11_0.animTime <= 0 then
				var_11_1:SetAsLastSibling()

				var_11_1.localPosition = var_1_10010
			end

			table = var_1_10012

			var_1_10012.insert(arg_11_0.tweens, var_11_1.gameObject)

			LeanTween = var_1_10012

			local var_11_7 = var_1_10012.moveLocal(var_11_1.gameObject, var_11_6, arg_11_0.animTime)

			var_1_10012 = var_1_10012.setOnComplete
			System = var_14

			var_1_10012(var_11_7, var_14.Action(function()
				IsNil = var_2_10000
