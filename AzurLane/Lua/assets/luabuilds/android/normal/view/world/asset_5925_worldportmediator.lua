...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.OnOpenBay, function()
		...
		local var_2_3 = var_2_10003.DOCKYARD
		local var_2_4 = {
			selectedMax = 1,
			selectedMin = 0
		}

		DockyardScene = var_2_10005
		var_2_4.mode = var_2_10005.MODE_WORLD
		ShipStatus = var_5
		var_2_4.hideTagFlags = var_5.TAG_HIDE_WORLD
	...
	arg_1_0:bind(var_0_1.OnTaskGoto, function(arg_3_0, arg_3_1)
		...
		var_3_2(var_3_1, var_2_10004.OnTriggerTaskGo, {
			taskId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.OnAccepetTask, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10005.WORLD_TRIGGER_TASK, {
			taskId = arg_4_1.id,
			portId = arg_4_2
		})
	...
	arg_1_0:bind(var_0_1.OnSubmitTask, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.WORLD_SUMBMIT_TASK, {
			taskId = arg_5_1.id
		})
	...
	arg_1_0:bind(var_0_1.OnReqPort, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.WORLD_PORT_REQ, {
			mapId = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.OnBuyGoods, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_2_10004.WORLD_PORT_SHOPPING, {
			goods = arg_7_1
		})
	...
	arg_1_0:bind(var_0_1.OnBuyNShopGoods, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_8_1(var_8_0, var_2_10005.WORLD_PORT_NEW_SHOPPING, {
			goods = arg_8_1,
			count = arg_8_2
		})
	...
	var_1_6(var_1_5, var_4.GetPort(var_1_7))
...
function var_0_1.initNotificationHandleDic(arg_9_0)
	...
	var_9_0[var_1_10002.UPDATED] = function(arg_10_0, arg_10_1)
		...
		local var_10_2 = var_2_10004(var_2_10005)

		var_10_1(var_10_0, var_4.getRawData(var_10_2))
	...
	var_9_0[var_2.WORLD_PORT_SHOPPING_DONE] = function(arg_11_0, arg_11_1)
		...
		var_11_2(var_11_1, var_2_10005.ON_ACHIEVE, var_11_0.drops)
	...
	var_9_0[var_2.WORLD_PORT_NEW_SHOPPING_DONE] = function(arg_12_0, arg_12_1)
		...
		var_12_2(var_12_1, var_2_10005.ON_ACHIEVE, var_12_0.drops)
...
function var_0_1.CheckTaskNotify(arg_13_0, arg_13_1)
	...
	local var_13_1 = arg_13_1.getTasks(var_13_0)

	pairs = var_13_0

	for iter_13_0, iter_13_1 in var_13_0(var_13_1) do
		local var_13_2 = iter_13_1
		local var_13_3 = iter_13_1.getState(var_13_2)

		WorldTask = var_13_2

		if var_13_3 == var_13_2.STATE_ONGOING then
			local var_13_4 = iter_13_1.config.complete_condition

			WorldConst = var_9

			if var_13_4 == var_9.TaskTypeArrivePort then
				WBank = var_13_4

				local var_13_5 = var_13_4
				local var_13_6 = var_13_4.Fetch

				WorldMapOp = var_1_10010

				local var_13_7 = var_13_6(var_13_5, var_1_10010)

				WorldConst = var_13_5
				var_13_7.op = var_13_5.OpReqTask
				var_1_10010 = arg_13_0

				local var_13_8 = arg_13_0.sendNotification

				GAME = var_1_10011

				var_13_8(var_1_10010, var_1_10011.WORLD_MAP_OP, var_13_7)
			end
		end
	end
