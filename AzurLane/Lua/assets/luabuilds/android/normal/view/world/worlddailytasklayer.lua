...
function var_0_1.init(arg_2_0)
	...
	local var_2_4 = var_2.Find(var_2_3, "frame/empty/Text")

	i18n = var_2_3

	var_1(var_2_4, var_2_3("world_daily_task_none"))

	setText = var_1

	local var_2_5 = arg_2_0.rtTasks
	local var_2_6 = var_2.Find(var_2_5, "frame/empty/Text_en")

	i18n = var_2_5

	var_1(var_2_6, var_2_5("world_daily_task_none_2"))
	...
	UIItemList = var_2_16
	arg_2_0.taskItemList = var_2_16.New(var_1, var_2_17)
			...
			if not arg_2_0.wsTasks[arg_4_1] then
				...
				local function var_4_3()
					...
					if var_5_0 then
						...
						var_3_10002(var_5_2, var_3_10004.OnAccepetTask, {
							var_4_0.task.id
						})
					else
						pg = var_3_10002

						local var_5_3 = var_3_10002.TipsMgr.GetInstance()

						var_2.ShowTips(var_5_3, var_5_1)
					end
				...
				var_4(var_4_1, var_4_2, var_4_3, var_2_10008)
				...
				local function var_4_9()
					...
					WorldDailyTaskMediator = var_3_10002

					var_7_1(var_7_0, var_3_10002.OnSubmitTask, var_4_0.task)
				...
				var_4(var_4_7, var_4_8, var_4_9, var_2_10008)
...
function var_0_1.didEnter(arg_9_0)
	...
	var_1(var_9_0, var_9_1, var_9_2, var_1_10005)
	...
	local function var_9_5()
		...
		WorldDailyTaskMediator = var_2_10002

		local var_11_2 = var_2_10002.OnAccepetTask

		underscore = var_2_10003

		var_11_1(var_11_0, var_11_2, var_2_10003.map(arg_9_0.taskVOs, function(arg_12_0)
			return arg_12_0.id
		end))
	...
	var_1(var_9_3, var_9_4, var_9_5, var_1_10005)
...
function var_0_1.willExit(arg_14_0)
	...
	var_14_1(var_14_0, var_3.EventUpdateDailyTaskIds, arg_14_0.onUpdateTasks)
...
function var_0_1.SetTaskProxy(arg_15_0, arg_15_1)
	...
	var_15_1(var_15_0, var_1_10004.EventUpdateDailyTaskIds, arg_15_0.onUpdateTasks)
...
function var_0_1.OnUpdateTasks(arg_16_0)
	...
	arg_16_0.taskVOs = var_16_0(var_2.getDailyTaskIds(var_16_1), function(arg_17_0)
	...
	var_16_2(var_16_3, var_3(var_1_10004.sortDic))
	...
	var_16_5(var_16_6, #arg_16_0.taskVOs == 0)
	...
	var_16_5(var_16_7, var_4.canAcceptDailyTask(var_16_8))
...
function var_0_1.showTaskWindow(arg_20_0, arg_20_1)
	...
	var_20_1(var_20_2:Find("bg"), arg_20_1:IsSpecialType())

	if #var_20_0 > 0 then
		GetImageSpriteFromAtlasAsync = var_4

		var_4("shipyardicon/" .. var_20_0, "", var_20_2:Find("card"), true)
	else
		GetImageSpriteFromAtlasAsync = var_4

		var_4("ui/worldportui_atlas", "nobody", var_20_2:Find("card"), true)
	end

	local var_20_3 = arg_20_0.rtTaskWindow
	local var_20_4 = var_4.Find(var_20_3, "main_window/right_panel")

	setText = var_20_3

	var_20_3(var_20_4:Find("title/Text"), arg_20_1.config.name)

	setText = var_20_3

	var_20_3(var_20_4:Find("content/desc"), arg_20_1.config.rare_task_text)

	setText = var_20_3

	var_20_3(var_20_4:Find("content/slider_progress/Text"), arg_20_1:getProgress() .. "/" .. arg_20_1:getMaxProgress())

	setSlider = var_20_3

	var_20_3(var_20_4:Find("content/slider"), 0, arg_20_1:getMaxProgress(), arg_20_1:getProgress())

	local var_20_5 = var_20_4:Find("content/item_tpl")
	local var_20_6 = var_20_4:Find("content/award_bg/panel/content")
	local var_20_7 = arg_20_1.config.show
	...
	for iter_20_0, iter_20_1 in var_8(var_20_7) do
		cloneTplTo = var_1_10013
		var_1_10013 = var_1_10013(var_20_5, var_20_6)
		...
		var_15(var_1_10013, var_20_8)

		onButton = var_15

		local var_20_9 = arg_20_0
		local var_20_10 = var_1_10013

		local function var_20_11()
			local var_21_0 = arg_20_0

			var_0.emit(var_21_0, var_0_1.ON_DROP, var_20_8)
		...
		var_15(var_20_9, var_20_10, var_20_11, var_1_10019)
	...
	var_8(var_20_5, false)

	setActive = var_8

	var_8(var_20_4:Find("content/award_bg/arror"), #var_20_7 > 3)

	onButton = var_8

	local var_20_12 = arg_20_0
	local var_20_13 = var_20_4:Find("btn_close")
	...
	var_8(var_20_12, var_20_13, var_20_14, var_12)

	onButton = var_8

	local var_20_15 = arg_20_0
	local var_20_16 = arg_20_0.rtTaskWindow
	local var_20_17 = var_10.Find(var_20_16, "bg")
	...
	var_8(var_20_15, var_20_17, var_20_18, var_12)

	onButton = var_8

	local var_20_19 = arg_20_0
	local var_20_20 = var_20_4:Find("btn_go")
	...
	local function var_20_21()
		...
		var_24_2(var_24_1, var_2_10002.OnTaskGoto, arg_20_1.id)
	...
	var_8(var_20_19, var_20_20, var_20_21, var_12)

	setButtonEnabled = var_8

	local var_20_22 = var_20_4:Find("btn_go")
	local var_20_23

	if not arg_20_1:GetFollowingAreaId() then
		var_20_23 = arg_20_1:GetFollowingEntrance()
	end

	var_8(var_20_22, var_20_23)
	...
	local var_20_24 = var_8.UIMgr.GetInstance()

	var_8.BlurPanel(var_20_24, arg_20_0.rtTaskWindow)
