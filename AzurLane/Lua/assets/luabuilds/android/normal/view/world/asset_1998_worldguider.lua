...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("....Mod.Experiment.BaseEntity"))
...
function var_0_1.SetTempGridPos2(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_2 = var_3_1(var_3_0, var_1_10005(var_1_10006))
	local var_3_3 = var_3.WorldToScreenPoint(var_3_2, arg_3_1)

	GameObject = var_3_2

	local var_3_4 = var_3_2.Find("OverlayCamera")
	local var_3_5 = var_5.GetComponent

	typeof = var_1_10007
	Camera = var_1_10008

	local var_3_6 = var_3_5(var_3_4, var_1_10007(var_1_10008))
		...
		if not arg_10_2 then
			...
			if not var_1_10005.IsPlayed(var_10_1, arg_10_1) then
				...
				if not var_1_10005.any(var_0_1.interruptReplayList, function(arg_11_0)
					...
					var_10_3(var_10_2, var_7.STORY_UPDATE, {
						storyId = arg_10_1
					})
				end
...
local var_0_2 = {
	...
	[var_0_1.WORLD_HELP_EVENT] = function(arg_26_0, arg_26_1, arg_26_2)
		...
		local var_26_2 = var_1_10005.OnOpenLayer

		Context = var_1_10006

		local var_26_3 = var_1_10006.New
		local var_26_4 = {}

		WorldHelpMediator = var_1_10008
		var_26_4.mediator = var_1_10008
		WorldHelpLayer = var_1_10008
		var_26_4.viewComponent = var_1_10008
		var_26_4.data = {
