...
function var_0_0.GetCurrBossLeftDay()
	...
	local var_7_6 = var_5.TimeMgr.GetInstance()
...
function var_0_0.GetCurrBossItemInfo()
	...
	local var_22_5 = var_5.split(var_22_4, "|")[2]
...
function var_0_0.GetAchieveBossItemInfo()
	...
	local var_23_5 = var_5.split(var_23_4, "|")[2]
...
function var_0_0.IsClearAllAchieveBoss()
	...
	return var_1_10001.all(var_24_0, function(arg_25_0)
		...
		local var_25_0 = var_2_10001(var_2_10002)
...
function var_0_0.GetHighestDamage()
	...
	return var_31_0.max(var_31_1:GetHighestDamage(), 1)
end
...
function var_0_0.GetAutoBattleCnt()
	...
	return var_1_10003.ceil(var_32_2.hp / var_32_3)
end
...
function var_0_0.GetAutoBattleLeftTime()
	...
	local var_35_3 = var_35_1.TimeMgr.GetInstance()
...
function var_0_0.MetaId2BossId(arg_38_0)
	...
	for iter_38_0, iter_38_1 in var_1_10001(var_1_10002.world_joint_boss_template.all) do
...
function var_0_0.GetCommissionSceneMetaBossBtnState()
	...
	if not var_0.GetBossProxy(var_41_0) or not var_1.isSetup or not var_1:IsOpen() then
		CommissionMetaBossBtn = var_41_0

		return var_41_0.STATE_LOCK
	end
	...
	if var_1.GetSelfBoss(var_41_1) then
		...
		local var_41_2 = var_41_1.GetAutoBattleState(var_2)

		WorldBossConst = var_4

		if var_41_2 == var_4.AUTO_BATTLE_STATE_STARTING then
			WorldBossConst = var_41_2

			if var_41_2.GetAutoBattleLeftTime() > 0 then
				CommissionMetaBossBtn = var_3

				return var_3.STATE_AUTO_BATTLE
			else
				CommissionMetaBossBtn = var_3

				return var_3.STATE_FINSH_BATTLE
			end
		end
	end

	local var_41_3 = var_1
	local var_41_4

	if not var_1.NeedTip(var_41_3) then
	...
	if var_41_4 then
		...
		return var_41_3.STATE_GET_AWARDS
	end

	CommissionMetaBossBtn = var_41_3

	return var_41_3.STATE_NORMAL
end
