...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.friendSupportTimeTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.guildSupportTimeTxt = var_2_11(var_2_10, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.worldSupportTimeTxt = var_2_17(var_2_16, var_3(var_1_10004))
	arg_2_0.timers = {}
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_5 = var_3.Find(var_3_4, "cancel_btn")
	...
	var_1_10001(var_3_11, var_3_12, var_3_13, var_5)
	...
	var_1_10001(var_3_14, var_3_15, var_3_16, var_5)
	...
	local function var_3_19()
		...
		if var_0.WorldSupported(var_9_1) then
			...
			var_9_3(var_9_2, var_2_10004("world_boss_ask_help"))
	...
	var_1_10001(var_3_17, var_3_18, var_3_19, var_5)

	onButton = var_1_10001

	local var_3_20 = arg_3_0
	local var_3_21 = arg_3_0._tf
	local var_3_22 = var_3.Find(var_3_21, "confirm_btn")
	...
	local function var_3_23()
		...
		var_10_1(var_10_0, var_2_10002.ON_SURPPORT, {
			arg_3_0.friendFlag,
			arg_3_0.guildFlag,
			arg_3_0.worldFlag
		})
...
function var_0_1.UpdateFriendRequestItem(arg_13_0)
	...
	setButtonEnabled = var_13_2

	var_13_2(arg_13_0.friendBtn, not var_13_3)

	setActive = var_13_2

	var_13_2(arg_13_0.friendRequested, var_13_3)

	setActive = var_13_2

	var_13_2(arg_13_0.friendMark, false)
...
function var_0_1.UpdateGuildRequetItem(arg_15_0)
	...
	setButtonEnabled = var_15_2

	var_15_2(arg_15_0.guildBtn, not var_15_3)

	setActive = var_15_2

	var_15_2(arg_15_0.guildRequested, var_15_3)

	setActive = var_15_2

	var_15_2(arg_15_0.guildMark, false)
...
function var_0_1.UpdateWorldRequetItem(arg_17_0)
	...
	var_17_1(arg_17_0.worldRequested, var_17_2)

	setActive = var_17_1

	var_17_1(arg_17_0.worldMark, false)
...
function var_0_1.AddRequestTimer(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	Timer = var_1_10006
	var_19_2[arg_19_2] = var_1_10006.New(function()
		pg = var_2_10000
