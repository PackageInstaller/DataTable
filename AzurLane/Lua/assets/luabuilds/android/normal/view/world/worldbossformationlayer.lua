...
function var_0_1.init(arg_4_0)
	...
	var_2(var_4_10, var_4_11 ~= var_1_10005)
...
function var_0_1.Register(arg_5_0)
	...
	var_1.AddHeroInfoModify(var_5_1, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10005(0.65, 0.65, 1))
		...
		local var_7_5 = var_7_4 <= var_6.ENERGY_MID
		local var_7_6 = var_3
		local var_7_7 = var_3.Find(var_7_6, "energy")

		if var_7_5 then
			local var_7_8

			var_7_6, var_7_8 = arg_7_1:getEnergyPrint()
			GetSpriteFromAtlas = var_2_10009

			if not var_2_10009("energy", var_7_6) then
				warning = var_10
			...
			var_10(var_7_7, var_9)
		end

		setActive = var_7_6

		var_7_6(var_7_7, false)

		setActive = var_7_6

		var_7_6(var_3:Find("expbuff"), false)
		...
		for iter_7_0 = 1, var_7_9 do
			...
			var_2_10012(arg_5_0._starTpl, var_7_3)
		end
		...
		if not var_8(var_7_10, var_10(arg_7_1:getShipType())) then
			warning = var_7_10
		...
		var_7_10(var_3:Find("type"), var_8, true)

		setText = var_7_10

		var_7_10(var_3:Find("frame/lv_contain/lv"), arg_7_1.level)
	...
	var_1.AddLongPress(var_5_2, function(arg_8_0, arg_8_1, arg_8_2)
		...
		var_8_1(var_8_0, var_2_10005.OPEN_SHIP_INFO, arg_8_1.id, arg_8_2)
	...
	var_1.AddClick(var_5_3, function(arg_9_0, arg_9_1, arg_9_2)
		...
		var_9_3(var_9_2, var_2_10005.CHANGE_FLEET_SHIP, arg_9_0, arg_9_2, arg_9_1)
	...
	var_1.AddBeginDrag(var_5_4, function(arg_10_0)
		...
		local var_10_1 = arg_10_0.Find(var_10_0, "info")
	...
	var_1.AddEndDrag(var_5_5, function(arg_11_0)
		...
		local var_11_1 = arg_11_0.Find(var_11_0, "info")
	...
	var_1.AddShiftOnly(var_5_6, function(arg_12_0)
		...
		var_12_1(var_12_0, var_2_10003.CHANGE_FLEET_SHIPS_ORDER)
	...
	var_1.AddSwitchToDisplayMode(var_5_9, function()
		...
		var_15_1(var_1.Find(var_15_2, "save"), true)

		setActive = var_15_1

		local var_15_3 = arg_5_0._checkBtn

		var_15_1(var_1.Find(var_15_3, "edit"), false)
	...
	var_1.AddSwitchToPreviewMode(var_5_11, function()
		...
		var_17_1(var_1.Find(var_17_2, "save"), false)

		setActive = var_17_1

		local var_17_3 = arg_5_0._checkBtn

		var_17_1(var_1.Find(var_17_3, "edit"), true)
	...
	var_1.AddGridTipClick(var_5_12, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10004.CHANGE_FLEET_SHIP, nil, arg_18_1, arg_18_0)
...
function var_0_1.SetStageID(arg_21_0, arg_21_1)
	...
	local var_21_4 = arg_21_0._goals
	local var_21_5 = var_7.Find(var_21_4, "goal_tpl")
	local var_21_6 = arg_21_0._goals
	local var_21_7 = var_8.Find(var_21_6, "goal_sink")
	local var_21_8 = arg_21_0._goals
	local var_21_9 = var_9.Find(var_21_8, "goal_time")
	local var_21_12
	...
	if var_21_0 == 1 then
		...
		if var_21_2 < 2 then
			i18n = var_21_12
			var_21_8 = var_21_12("battle_preCombatLayer_undefeated")
		else
			i18n = var_21_12
			var_21_8 = var_21_12("battle_preCombatLayer_sink_limit", var_21_2)
		end

		setWidgetText = var_21_12

		local var_21_10 = var_21_5

		i18n = var_1_10013

		var_21_12(var_21_10, var_1_10013("battle_preCombatLayer_victory"))

		setWidgetText = var_21_12

		var_21_12(var_21_7, var_21_8)

		setWidgetText = var_21_12

		local var_21_11 = var_21_9

		i18n = var_13

		var_21_12(var_21_11, var_13("battle_preCombatLayer_time_limit", var_21_1))
	elseif var_21_0 == 2 then
		setActive = var_21_8

		var_21_8(var_21_7, false)

		setActive = var_21_8

		var_21_8(var_21_9, false)

		setWidgetText = var_21_8
		var_21_12 = var_21_5
		i18n = var_12

		var_21_8(var_21_12, var_12("battle_preCombatLayer_time_hold", var_21_1))
	elseif var_21_0 == 3 then
		...
		var_21_8(var_21_12, var_12("battle_result_defeat_all_enemys", var_21_1))
	end

	local var_21_14

	if var_2.guide_desc then
		local var_21_13 = #var_2.guide_desc

		var_21_14 = 0 < var_21_13
	end

	setActive = var_21_12

	var_21_12(arg_21_0.guideDesc, var_21_14)

	if var_21_14 then
		setText = var_21_12

		var_21_12(arg_21_0.guideDesc, var_2.guide_desc)
	end
...
function var_0_1.UpdateFleetView(arg_23_0, arg_23_1)
	...
	var_23_1(var_23_0, var_1_10004.Vanguard, arg_23_0._currentForm ~= var_0_1.FORM_EDIT)
	...
	var_23_3(var_23_2, var_4.Main, arg_23_0._currentForm ~= var_0_1.FORM_EDIT)
...
function var_0_1.didEnter(arg_26_0)
	...
	local function var_26_2()
		...
		if arg_26_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_27_0, function(arg_28_0)
				...
				i18n = var_3_10004
				var_28_2.content = var_3_10004("battle_preCombatLayer_save_confirm")

				function var_28_2.onYes()
					local var_29_0 = arg_26_0
					local var_29_1 = var_0.emit

					WorldBossFormationMediator = var_4_10002

					var_29_1(var_29_0, var_4_10002.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_30_1(var_30_0, var_5_10002("battle_preCombatLayer_save_success"))
						arg_28_0()
		...
		var_1(var_27_0, function()
			...
			var_3_10000(var_31_0, var_3_10002(var_3_10003)).interactable = false
			...
			var_31_2(var_31_3, var_3_10003.Action(function()
	...
	local function var_26_5()
		...
		if arg_26_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_33_0, function(arg_34_0)
				...
				i18n = var_3_10004
				var_34_2.content = var_3_10004("battle_preCombatLayer_save_march")
				...
				function var_34_2.onYes()
					...
					var_35_1(var_35_0, var_4_10002.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_36_1(var_36_0, var_5_10002("battle_preCombatLayer_save_success"))
						arg_34_0()
		...
		var_1(var_33_0, function()
			...
			WorldBossFormationMediator = var_3_10002

			var_37_1(var_37_0, var_3_10002.ON_START, arg_26_0._currentFleetVO.id)
	...
	var_1_10001(var_26_3, var_26_4, var_26_5, var_1_10005)
	...
	local function var_26_8()
		if arg_26_0._currentForm == var_0_1.FORM_EDIT then
			...
			WorldBossFormationMediator = var_2_10002

			var_38_1(var_38_0, var_2_10002.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_39_1(var_39_0, var_3_10002("battle_preCombatLayer_save_success"))
	...
	var_1_10001(var_26_6, var_26_7, var_26_8, var_1_10005)
	...
	SYSTEM_DUEL = var_26_11

	if var_26_12 == var_26_11 then
		setActive = var_26_12
		...
		local function var_26_15(arg_40_0)
			...
			var_40_1(var_40_0, var_2_10003.ON_AUTO, {
				isOn = not arg_40_0,
		...
		var_26_12(var_26_13, var_26_14, var_26_15, var_1_10005, var_1_10006)
		...
		SYSTEM_WORLD = var_26_15

		var_26_12(var_26_16, var_26_17(var_26_15))
	end
...
function var_0_1.displayFleetInfo(arg_43_0)
	...
	local var_43_4 = var_43_3(var_43_2, var_1_10004.Vanguard)
	local var_43_5 = arg_43_0._currentFleetVO
	local var_43_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_43_7 = var_43_6(var_43_5, var_1_10005.Main)
	local var_43_8 = 0
	...
	var_5(var_43_12, var_43_13 ~= var_1_10008)
...
function var_0_1.UpdateBuffContainer(arg_46_0)
	...
	var_46_2(var_46_3, var_5.GetChild(var_46_4, 0), #var_1, function(arg_47_0, arg_47_1, arg_47_2)
		...
		local function var_47_3()
			...
			var_48_2.type = var_3_10003

			local var_48_3 = {}

			DROP_TYPE_STRATEGY = var_3_10004
			var_48_3.type = var_3_10004
		...
		var_4(var_47_1, var_47_2, var_47_3, var_2_10008)
