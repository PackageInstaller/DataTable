...
function var_0_1.UpdateRankList(arg_6_0)
	...
	if var_2.GetRank(var_6_1, var_6_0) == nil then
		...
		var_6_3(var_6_2, var_1_10006.ON_RANK_LIST, var_6_0)
	else
...
function var_0_1.UpdateRanks(arg_7_0, arg_7_1)
	...
	local var_7_2 = var_2(var_3)
	local var_7_3 = var_2.getRawData(var_7_2).id
	local var_7_4

	ipairs = var_4

	for iter_7_1, iter_7_2 in var_4(arg_7_1) do
...
function var_0_1.UpdateRank(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = arg_8_1:Find("view")
	local var_8_1 = arg_8_2.id

	getProxy = var_6
	PlayerProxy = var_1_10007

	local var_8_2 = var_6(var_1_10007)

	var_1_10003(var_8_0, var_8_1 ~= var_6.getRawData(var_8_2).id)

	onButton = var_1_10003

	local var_8_3 = arg_8_0
	local var_8_4 = arg_8_1:Find("view")
	...
	local function var_8_5()
		...
		var_9_1(var_9_0, var_2_10002.FETCH_RANK_FORMATION, arg_8_2.id, arg_8_0.bossId)
	...
	var_1_10003(var_8_3, var_8_4, var_8_5, var_7)
