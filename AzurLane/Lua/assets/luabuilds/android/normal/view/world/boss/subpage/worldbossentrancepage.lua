...
function var_0_1.OnLoaded(arg_3_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.currTimeTxt = var_3_4(var_3_3, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.currConsumeTxt = var_3_7(var_3_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.currAccTxt = var_3_10(var_3_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.pastConsumeTxt = var_3_13(var_3_12, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.pastAccTxt = var_3_16(var_3_15, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.currProgressTxt = var_3_21(var_3_20, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_3_0.pastProgressTxt = var_3_24(var_3_23, var_3(var_1_10004))
	...
	local var_3_30 = var_3_29(var_3_28, var_4(var_1_10005))

	GetSpriteFromAtlas = var_3_28
	var_3_30.sprite = var_3_28("MetaWorldboss/" .. var_3_26, "cur")
	...
	local var_3_32 = var_4.Find(var_3_31, "tip/Text")

	i18n = var_3_31

	var_3(var_3_32, var_3_31("world_boss_item_usage_tip"))

	setText = var_3

	local var_3_33 = arg_3_0.currentTr
	local var_3_34 = var_4.Find(var_3_33, "label")

	i18n = var_3_33

	var_3(var_3_34, var_3_33("world_boss_current_boss_label"))

	setText = var_3

	local var_3_35 = arg_3_0.currentTr
	local var_3_36 = var_4.Find(var_3_35, "label1")

	i18n = var_3_35

	var_3(var_3_36, var_3_35("world_boss_current_boss_label1"))

	setText = var_3

	local var_3_37 = arg_3_0.pastTr
	local var_3_38 = var_4.Find(var_3_37, "label")

	i18n = var_3_37

	var_3(var_3_38, var_3_37("world_boss_current_boss_label"))

	setText = var_3

	local var_3_39 = arg_3_0.pastTr
	local var_3_40 = var_4.Find(var_3_39, "label1")

	i18n = var_3_39

	var_3(var_3_40, var_3_39("world_boss_current_boss_label1"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_2()
		...
		var_5_1(var_5_0, var_2_10002.ON_BACK)
	...
	local function var_4_5()
		...
		local var_6_2 = var_2_10002.ON_SWITCH

		WorldBossScene = var_2_10003

		var_6_1(var_6_0, var_6_2, var_2_10003.PAGE_CURRENT)
	...
	local function var_4_8()
		...
		var_7_1(var_7_0, var_7_2, var_2_10003.PAGE_ARCHIVES)
...
function var_0_1.UpdatePast(arg_14_0)
	...
	local var_14_9 = var_14_8(var_14_7, var_1_10009(var_1_10010))
	local var_14_10
	local var_14_11 = ""

	WorldBossConst = var_1_10010

	local var_14_12

	if var_1_10010.ACHIEVE_STATE_STARTING == var_14_6 then
		...
		WorldBossConst = var_12

		local var_14_14 = var_14_12 .. var_14_13(var_12.GetArchivesId())
	...
	for iter_14_0, iter_14_1 in var_14_12(arg_14_0.pastLabels) do
		...
		WorldBossConst = var_1_10017
		var_1_10017 = var_1_10017.ACHIEVE_STATE_STARTING == var_14_6

		var_1_10015(var_14_15, var_1_10017)
	end
