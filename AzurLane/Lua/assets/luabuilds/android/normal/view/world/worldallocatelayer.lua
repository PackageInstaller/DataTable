...
function var_0_1.init(arg_2_0)
	...
	local var_2_7 = var_2.Find(var_2_6, "top/Text")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("world_ship_repair"))
	...
	local var_2_11 = var_2.Find(var_2_10, "tip/Text")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("world_battle_damage"))
	...
	local function var_2_22()
		if arg_2_0.itemVO.count == 0 then
			...
			var_4_1(var_4_0, var_2_10002("common_no_item_1"))
		...
		if #arg_2_0._selectedShipList > 0 then
			...
			if var_4_5 == var_4_4.UsageBuff then
				local var_4_6 = arg_2_0.itemVO

				var_4_7 = var_4_7.getItemBuffID(var_4_6)
				_ = var_4_6
				var_4_3 = var_4_6.any(arg_2_0._selectedShipList, function(arg_6_0)
			...
			if var_4_5 ~= var_4_7.UsageHPRegenerate then
				...
				if var_4_3 then
					...
					i18n = var_2_10006
					var_4_10.content = var_2_10006("world_ship_healthy")
	...
	var_1(var_2_26, var_2_27, var_2_28, var_1_10005)
	...
	var_1(var_2_29, var_3.Find(var_2_30, "item/reset_btn"), function()
		assert = var_2_10000
		...
		DROP_TYPE_WORLD_ITEM = var_2_10003
...
function var_0_1.flush(arg_17_0, arg_17_1)
	...
	if var_17_1 == var_17_0.UsageBuff then
...
function var_0_1.updateToggleList(arg_18_0, arg_18_1, arg_18_2)
	...
	for iter_18_0 = 1, arg_18_0.fleetToggleList.childCount do
		...
		var_18_1(var_18_2, arg_18_1[iter_18_0])

		if arg_18_1[iter_18_0] then
			setActive = var_9

			var_9(var_18_2:Find("lock"), false)

			setText = var_9

			local var_18_3 = var_18_2
			local var_18_4 = var_18_2.Find(var_18_3, "on/mask/text")

			i18n = var_18_3

			var_9(var_18_4, var_18_3("world_fleetName" .. iter_18_0))

			setText = var_9

			var_9(var_18_2:Find("on/mask/en"), var_0_1.TeamNum[iter_18_0] .. " FLEET")

			setText = var_9

			var_9(var_18_2:Find("on/mask/number"), iter_18_0)

			setText = var_9

			local var_18_5 = var_18_2
			local var_18_6 = var_18_2.Find(var_18_5, "off/mask/text")

			i18n = var_18_5

			var_9(var_18_6, var_18_5("world_fleetName" .. iter_18_0))

			setText = var_9

			var_9(var_18_2:Find("off/mask/en"), var_0_1.TeamNum[iter_18_0] .. " FLEET")

			setText = var_9

			var_9(var_18_2:Find("off/mask/number"), iter_18_0)

			onToggle = var_9

			local var_18_7 = arg_18_0
			local var_18_8 = var_18_2

			local function var_18_9(arg_19_0)
				if arg_19_0 then
			...
			var_9(var_18_7, var_18_8, var_18_9, var_13)
...
function var_0_1.updateFleetButton(arg_20_0, arg_20_1)
	...
	local var_20_1 = var_3.Find(var_20_0, "fleet/CnFleet")

	i18n = var_20_0

	var_1_10002(var_20_1, var_20_0("world_fleetName" .. arg_20_1))

	setText = var_1_10002

	local var_20_2 = arg_20_0.btnFleet

	var_1_10002(var_3.Find(var_20_2, "fleet/enFleet"), var_0_1.TeamNum[arg_20_1] .. " FLEET")

	setText = var_1_10002

	local var_20_3 = arg_20_0.btnFleet

	var_1_10002(var_3.Find(var_20_3, "fleet/num"), arg_20_1)
...
function var_0_1.tweenTabArrow(arg_21_0, arg_21_1)
	...
	var_21_0(var_21_1, arg_21_1)

	local var_21_2

	if arg_21_1 then
		LeanTween = var_21_0
		var_21_0 = var_21_0.moveLocalY
		go = var_21_2
		var_21_2 = var_21_0(var_21_2(var_21_1), var_21_1.localPosition.y + 8, 0.8)
		var_21_0 = var_21_0.setEase
		LeanTweenType = var_5
		var_21_2 = var_21_0(var_21_2, var_5.easeInOutSine)

		var_21_0.setLoopPingPong(var_21_2, -1)
	else
		LeanTween = var_21_0

		local var_21_3 = var_21_0.cancel
...
function var_0_1.setFleet(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in var_22_0(arg_22_0._shipTFList) do
		local var_22_2 = iter_22_1
		local var_22_3 = iter_22_1.Find(var_22_2, "buff/bg/levelup(Clone)")

		IsNil = var_22_2

		if not var_22_2(var_22_3) then
			PoolMgr = var_9

			local var_22_4 = var_9.GetInstance()

			var_9.ReturnUI(var_22_4, "levelup", var_22_3)
		end
	end
	...
	local var_22_5 = arg_22_0.fleetList[arg_22_0.currentFleetIndex]
	local var_22_6 = var_3.GetShips(var_22_5, true)

	underscore = var_22_5

	local var_22_7 = var_22_5.map(var_22_6, function(arg_23_0)
		WorldConst = var_2_10001

		return var_2_10001.FetchShipVO(arg_23_0.id)
	end)
	local var_22_8 = arg_22_0.quota

	for iter_22_2 = 1, 6 do
		local var_22_9 = var_22_6[iter_22_2]
		local var_22_10 = var_22_7[iter_22_2]

		if var_22_6[iter_22_2] then
			cloneTplTo = var_22_11

			local var_22_11 = var_22_11(arg_22_0.shipTpl, arg_22_0.shipsContainer)

			arg_22_0._shipTFList[var_22_9.id] = var_22_11

			local var_22_12 = arg_22_0._shipVOList

			var_22_12[var_22_10.id] = var_22_10
			updateShip = var_22_12

			var_22_12(var_22_11, var_22_10, {
				initStar = true
			})
			...
			if var_22_1 == var_15.UsageBuff then
				var_22_13 = arg_22_0:initBuff(var_22_11, var_22_9)
			...
			if var_22_1 ~= var_15.UsageHPRegenerate then
				...
				if var_22_1 == var_15.UsageHPRegenerateValue then
					var_22_13 = arg_22_0:initHP(var_22_11, var_22_9)
				end

				::label_22_0::

				if 0 < var_22_8 and var_22_13 then
				...
				if false then
					...
					local var_22_14 = var_22_11(arg_22_0.emptyTpl, arg_22_0.shipsContainer)
				end
			end
		end
	end
	...
	local var_22_15 = arg_22_0.fleetInfo
	local var_22_16 = var_8.Find(var_22_15, "tip")

	underscore = var_22_15

	var_7(var_22_16, var_22_15.any(var_22_6, function(arg_24_0)
...
function var_0_1.OnUpdateShipHP(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_25_1(arg_25_0._shipTFList) do
		if arg_25_0._preSelectedList[iter_25_0] then
			local var_25_3 = var_25_0:GetShip(iter_25_0)
			local var_25_4 = iter_25_1:Find("hp")
			local var_25_5 = var_9.Find(var_25_4, "progress_bg/bar")
			...
			if var_25_3.IsHpSafe(var_25_7) then
				Color = var_25_8

				local var_25_8

				if not var_25_8.New(0.615686274509804, 0.9176470588235294, 0.23529411764705882) then
					Color = var_25_8
					var_25_8 = var_25_8.New(0.615686274509804, 0.9176470588235294, 0.23529411764705882)
				end

				var_25_4(var_25_6, var_25_8)

				local var_25_9 = var_25_5
				local var_25_10 = var_25_5.GetComponent
				...
				if var_25_10(var_25_9, var_25_8(var_25_7)).fillAmount < var_25_3.hpRant / 16 then
					LeanTween = var_25_11
					var_25_11 = var_25_11.value
					go = var_25_7

					local var_25_12 = var_25_11(var_25_7(var_25_5), var_11, var_12, var_12 - var_11)

					var_25_11 = var_25_11.setOnUpdate
					System = var_15

					var_25_11(var_25_12, var_15.Action_float(function(arg_26_0)
						local var_26_0 = var_25_5
						local var_26_1 = var_1.GetComponent

						typeof = var_2_10003
						Image = var_2_10004
						var_26_1(var_26_0, var_2_10003(var_2_10004)).fillAmount = arg_26_0
				...
				var_25_11(var_9:Find("broken"), var_25_3:IsBroken())

				if var_25_3:IsHpFull() then
					triggerButton = var_13

					var_13(iter_25_1)
				else
					arg_25_0:updateSelectShipHP(iter_25_1, true, var_25_3)
				end
			end
		end
	end
...
function var_0_1.OnUpdateShipBuff(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_27_1(arg_27_0._shipTFList) do
		if arg_27_0._preSelectedList[iter_27_0] then
			...
			var_27_7(var_27_3, var_27_8 and "Lv.MAX" or "Lv." .. var_27_6)

			if var_27_8 then
				triggerButton = var_27_7
			...
			local var_27_9 = iter_27_1
			local var_27_10 = iter_27_1.Find(var_27_9, "buff/bg/levelup(Clone)")

			IsNil = var_27_9

			if var_27_9(var_27_10) then
				PoolMgr = var_13

				local var_27_11 = var_13.GetInstance()

				var_13.GetUI(var_27_11, "levelup", true, function(arg_28_0)
					IsNil = var_2_10001
					...
					if var_2_10001(arg_27_0._tf) then
						...
						var_1(var_28_1, var_3.Find(var_28_2, "buff/bg"))
				...
				var_13(var_27_10, false)

				setActive = var_13

				var_13(var_27_10, true)
			end
		end
	end
...
function var_0_1.updateSelectShipHP(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	local var_29_3 = arg_29_1.Find(var_29_2, "hp/hp_text")

	setActive = var_29_2

	var_29_2(var_29_3, arg_29_2)

	if arg_29_2 then
		WPool = var_29_2

		local var_29_4 = var_29_2
		local var_29_5 = var_29_2.Get

		WorldMapShip = var_8

		local var_29_6 = var_29_5(var_29_4, var_8)

		var_29_6.id = arg_29_3.id
		var_29_6.hpRant = arg_29_3.hpRant
		var_29_6.buffs = arg_29_3.buffs

		local var_29_7 = arg_29_0.itemVO
		local var_29_8 = var_7.getWorldItemType(var_29_7)

		WorldItem = var_29_7

		local var_29_10

		if var_29_8 == var_29_7.UsageHPRegenerate then
			local var_29_9 = var_29_6

			var_29_10 = var_29_6.Regenerate

			local var_29_11 = arg_29_0.itemVO

			var_29_10(var_29_9, var_10.getItemRegenerate(var_29_11))
		else
			WorldItem = var_29_10

			if var_29_8 == var_29_10.UsageHPRegenerateValue then
				local var_29_12 = var_29_6

				var_29_10 = var_29_6.RegenerateValue

				local var_29_13 = arg_29_0.itemVO

				var_29_10(var_29_12, var_10.getItemRegenerate(var_29_13))
			else
				assert = var_29_10

				var_29_10(false, "world item type error:" .. arg_29_0.itemVO.id)
			end
		end

		setImageColor = var_29_10

		local var_29_14 = var_29_1
		local var_29_15 = var_29_6

		if var_29_6.IsHpSafe(var_29_15) then
			Color = var_29_16

			local var_29_16

			if not var_29_16.New(0.615686274509804, 0.9176470588235294, 0.23529411764705882, 0.6) then
				Color = var_29_16
				var_29_16 = var_29_16.New(0.9254901960784314, 0, 0, 0.6)
			end

			var_29_10(var_29_14, var_29_16)

			local var_29_17 = var_29_1
			local var_29_18 = var_29_1.GetComponent

			typeof = var_29_16
			Image = var_29_15

			local var_29_19 = var_29_18(var_29_17, var_29_16(var_29_15))

			var_29_19.fillAmount = var_29_6.hpRant / 16
			setText = var_29_19

			local var_29_20 = var_29_3

			math = var_10

			local var_29_21 = var_10.floor(arg_29_3.hpRant / 100)
			local var_29_22 = "%"
			...
			local var_29_24 = var_29_23 .. var_1_10014.floor(var_29_6.hpRant / 100) .. "%"

			COLOR_GREEN = var_14

			var_29_19(var_29_20, var_29_21 .. var_29_22 .. var_1_10012(var_29_24, var_14))

			WPool = var_29_19

			var_29_19:Return(var_29_6)
...
function var_0_1.initHP(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_2 = arg_31_1.Find(var_31_1, "hp")

	setActive = var_31_1

	var_31_1(var_31_2, true)

	setActive = var_31_1

	var_31_1(var_31_0, false)
	arg_31_0:updateSelectShipHP(arg_31_1, false)

	local var_31_3 = var_31_2
	local var_31_4 = var_31_2.Find(var_31_3, "progress_bg/bar")

	setImageColor = var_31_3
	...
	if arg_31_2.IsHpSafe(var_31_6) then
		...
		var_31_10(var_31_2:Find("broken"), arg_31_2:IsBroken())
...
function var_0_1.initBuff(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_7 = var_33_5.GetTemplate(var_33_6).buff_attr[1]
