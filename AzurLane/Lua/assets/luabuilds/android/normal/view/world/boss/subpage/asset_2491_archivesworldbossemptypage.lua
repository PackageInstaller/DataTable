...
function var_0_1.OnInit(arg_2_0)
	...
	local function var_2_2()
		...
		pg = var_2_10003
		var_3_2.helps = var_2_10003.gametip.world_archives_boss_help.tip
	...
	local var_2_5 = var_3.Find(var_2_4, "list_btn")
	...
	local function var_2_6()
		...
		var_4_1(var_4_0, var_4_2, var_2_10003.PAGE_ARCHIVES_CHALLENGE)
	...
	local function var_2_9()
		...
		if var_5_0 == var_2_10001.ACHIEVE_STATE_NOSTART then
			...
			var_5_2(var_5_1, var_2_10003("world_boss_no_select_archives"))
		else
			...
			if var_5_0 == var_5_2.ACHIEVE_STATE_STARTING then
				...
				if var_5_4.CanUnlockArchivesBoss() then
					...
					var_5_4(var_5_3, var_2_10003.ON_ACTIVE_ARCHIVES_BOSS)
				else
					pg = var_5_4
					...
					var_5_4(var_5_5, var_2_10003("world_boss_archives_item_count_noenough"))
				end
			else
				WorldBossConst = var_5_4
				...
				if var_5_0 == var_5_4.ACHIEVE_STATE_CLEAR then
					...
					var_5_7(var_5_6, var_2_10003("world_boss_archives_are_clear"))
				end
			end
		end
...
function var_0_1.OnUpdate(arg_7_0)
	...
	if not arg_7_0.archivesWorldbossBtn then
		...
		var_7_0 = var_7_0.New
		var_1_10003 = arg_7_0._tf
		var_7_0 = var_7_0(var_2.Find(var_1_10003, "archives_btn"), arg_7_0.event)
	end
	...
	if var_7_2 then
		var_1_10004 = arg_7_0.noItem
		var_7_3 = var_7_3.GetComponent
		typeof = var_1_10005
		Image = var_1_10006
		var_7_3 = var_7_3(var_1_10004, var_1_10005(var_1_10006))
		...
		var_7_3.SetNativeSize(var_1_10005)
	end
