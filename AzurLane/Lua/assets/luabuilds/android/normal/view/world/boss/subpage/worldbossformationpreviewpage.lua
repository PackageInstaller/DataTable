...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_8 = var_3.Find(var_3_7, "frame/toggles/main")
	...
	local var_3_12 = var_3.Find(var_3_11, "frame/toggles/vanguard")
...
function var_0_1.Show(arg_9_0, arg_9_1)
	...
	var_2(var_9_0, var_1_10004.UIMgr.GetInstance().UIMain)
	...
	for iter_9_0, iter_9_1 in var_4(arg_9_1) do
		local var_9_3 = iter_9_1
		local var_9_4 = iter_9_1.getTeamType(var_9_3)

		TeamType = var_9_3

		if var_9_4 == var_9_3.Vanguard then
			table = var_10

			var_10.insert(var_9_2, iter_9_1)
		else
			TeamType = var_10

			if var_9_4 == var_10.Main then
				table = var_10

				var_10.insert(var_9_1, iter_9_1)
			end
		end
	end
	...
	var_4(var_5.Find(var_9_5, "frame/toggles/main"), true)
...
function var_0_1.UpdateShip(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_2 then
		...
		local var_11_4 = var_11_3(var_11_2, var_6(var_1_10007))
		local var_11_5 = var_11_1:Find("ship_type")
		local var_11_6 = var_5.GetComponent

		typeof = var_7
		Image = var_1_10008

		local var_11_7 = var_11_6(var_11_5, var_7(var_1_10008))

		UIItemList = var_11_5

		local var_11_8 = var_11_5.New(var_11_1:Find("stars"), var_11_1:Find("stars/star_tpl"))
		local var_11_9 = var_11_1:Find("lv")
		local var_11_10 = var_7.GetComponent

		typeof = var_9
		Text = var_10

		local var_11_11 = var_11_10(var_11_9, var_9(var_10))

		shortenString = var_11_9
		var_11_4.text = var_11_9(arg_11_2:getName(), 6)
		pg = var_8

		local var_11_12 = var_8.ship_data_statistics[arg_11_2.configId]

		GetSpriteFromAtlas = var_9

		local var_11_13 = "shiptype"

		shipType2print = var_1_10011
		var_11_7.sprite = var_9(var_11_13, var_1_10011(var_11_12.type))

		local var_11_14 = arg_11_2:getMaxStar()
		local var_11_15 = arg_11_2:getStar()

		var_11_8:make(function(arg_12_0, arg_12_1, arg_12_2)
			UIItemList = var_2_10003

			if arg_12_0 == var_2_10003.EventUpdate then
				setActive = var_3

				var_3(arg_12_2:Find("star_tpl"), arg_12_1 <= var_11_15)
			end

			return
		end)
		var_11_8:align(var_11_14)

		var_11_11.text = "Lv." .. arg_11_2.level

		local var_11_16 = var_11_1:Find("mask/icon")
		local var_11_17 = var_11.GetComponent

		typeof = var_13
		Image = var_1_10014

		local var_11_18 = var_11_17(var_11_16, var_13(var_1_10014))

		LoadSprite = var_11_16
		var_11_18.sprite = var_11_16("HeroHrzIcon/" .. arg_11_2:getPainting())
	end

	local var_11_19 = arg_11_1
	local var_11_20 = arg_11_1.Find(var_11_19, "bg/line")

	if arg_11_2 then
		Vector2 = var_11_19

		if not var_11_19(235, 2) then
			Vector2 = var_11_19
			var_11_19 = var_11_19(461, 2)
		end

		var_11_20.sizeDelta = var_11_19
...
function var_0_1.UpdateEquipments(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_2 = var_4.Find(var_13_1, "equipemtns")
	local var_13_3 = arg_13_1.parent
	local var_13_4 = var_13_0(var_13_2, var_5.Find(var_13_3, "equipemtns/equipment_tpl"))
	local var_13_5
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			if var_14_0 then
				...
				local function var_14_3()
					...
					local var_15_2 = var_3_10002.ON_EQUIPMENT
					local var_15_3 = {}

					EquipmentInfoMediator = var_3_10004
					var_15_3.type = var_3_10004.TYPE_DISPLAY
				...
				var_4(var_14_1, var_14_2, var_14_3, var_2_10008)
			else
