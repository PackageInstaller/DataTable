...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_1_10005
	Image = var_1_10006
	arg_1_0.img = var_1_1(var_1_0, var_1_10005(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.iconText = var_1_4(var_1_3, var_5(var_1_10006))
	...
	local function var_1_8()
		...
		local var_2_2 = var_2_10002.ON_SWITCH

		WorldBossScene = var_2_10003

		var_2_1(var_2_0, var_2_2, var_2_10003.PAGE_ARCHIVES_LIST)
	...
	var_3(var_1_6, var_1_7, var_1_8, var_1_10007)
...
function var_0_0.Flush(arg_3_0)
	...
	if var_3_0 == var_1_10002.ACHIEVE_STATE_STARTING then
		...
		MetaCharacterProxy = var_1_10006

		local var_3_2 = var_1_10005(var_1_10006)
		local var_3_3 = var_1_10005.getMetaProgressVOByID(var_3_2, var_3_1).metaPtData
		local var_3_4, var_3_5 = var_6.GetResProgress(var_3_3), arg_3_0.iconText
		local var_3_6 = "/"
		local var_3_7 = var_1_10005.metaPtData

		var_3_5.text = var_3_4 .. var_3_6 .. var_10.GetTotalResRequire(var_3_7)
	...
	var_1_10003(var_3_9, var_1_10005.AnyArchivesBossCanGetAward())
