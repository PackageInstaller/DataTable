...
function var_0_1.AddListeners(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_4.EventPtUpdated, arg_5_0.onPtUpdated)
...
function var_0_1.RemoveListeners(arg_6_0, arg_6_1)
	...
	var_6_1(var_6_0, var_4.EventPtUpdated, arg_6_0.onPtUpdated)
...
function var_0_1.OnInit(arg_9_0)
	...
	local function var_9_2()
		...
		if var_0.GetSelfBoss(var_10_1) then
			WorldBossConst = var_10_1

			if not var_10_1._IsCurrBoss(var_0) then
				pg = var_1
				...
				var_10_3(var_10_2, var_2_10003("archives_boss_was_opened"))
		...
		do
			...
			local var_10_6 = var_2_10003.ON_SWITCH

			WorldBossScene = var_2_10004

			var_10_5(var_10_4, var_10_6, var_2_10004.PAGE_CURRENT)
		end
	...
	local function var_9_5()
		...
		local var_11_2 = var_2_10002.ON_SWITCH

		WorldBossScene = var_2_10003

		var_11_1(var_11_0, var_11_2, var_2_10003.PAGE_ARCHIVES_CHALLENGE)
	...
	local var_9_8 = var_3.Find(var_9_7, "list_panel/frame/filter/toggles/world")
	...
	var_1(var_9_6, var_9_8, var_9_9, var_5)

	onButton = var_1

	local var_9_10 = arg_9_0
	local var_9_11 = arg_9_0._tf
	local var_9_12 = var_3.Find(var_9_11, "point/help")
	...
	local function var_9_13()
		...
		pg = var_2_10003
		var_13_2.helps = var_2_10003.gametip.world_boss_help_meta.tip
	...
	var_1(var_9_10, var_9_12, var_9_13, var_5)
	...
	arg_9_0.ptBtn = var_9_14(var_2.Find(var_9_15, "point"))
...
function var_0_1.CheckToggle(arg_14_0)
	...
	if var_1.all(arg_14_0.filterFlags, function(arg_15_0)
		...
		var_1(var_2.Find(var_14_0, "list_panel/frame/filter/toggles/world"), true)
	end
...
function var_0_1.UpdateMainView(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_1 = arg_16_1.isDeath(var_16_0)

	setActive = var_16_0

	var_16_0(arg_16_0.awardBtn, not var_16_1)

	onButton = var_16_0

	local var_16_2 = arg_16_0
	local var_16_3 = arg_16_0.awardBtn
	...
	var_16_0(var_16_2, var_16_3, var_16_4, var_1_10008)
