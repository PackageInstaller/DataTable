...
function var_0_1.OnLoaded(arg_5_0)
	...
	typeof = var_3
	Text = var_5_4
	arg_5_0.ptTr = var_5_15(var_5_14, var_3(var_5_4))
	...
	local var_5_24 = var_2.Find(var_5_23, "main/award/pt/label")

	i18n = var_5_23

	var_1(var_5_24, var_5_23("meta_syn_value_label"))
...
function var_0_1.OnInit(arg_6_0)
	...
	local function var_6_2()
		...
		var_7_1(var_7_0, var_2_10002.ON_QUIT_ARCHIVES_LIST)
	...
	local var_6_5 = var_3.Find(var_6_4, "help")
	...
	local function var_6_6()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip.world_archives_boss_list_help.tip
	...
	var_1_10001(var_6_3, var_6_5, var_6_6, var_5)
	...
	for iter_6_0, iter_6_1 in var_1(arg_6_0.toggles) do
		...
		var_1_10006(var_6_8, var_6_9, var_6_10, var_1_10010)
	end
	...
	if var_1.Find(var_6_11, "empty_finsih") then
		...
		local var_6_13 = var_2.Find(var_6_12, "empty_finsih")

		typeof = var_6_12
		Image = var_4

		local var_6_14 = var_1(var_6_13, var_6_12(var_4))
...
function var_0_1.Filter(arg_15_0, arg_15_1)
	...
	for iter_15_0, iter_15_1 in var_1_10004(var_15_0) do
		...
		local var_15_2 = var_1_10009.getMetaProgressVOByID(var_1_10010, iter_15_1.meta_id)

		var_1_10010 = var_1_10009.getMetaProgressPTState(var_15_2)

		local var_15_3 = var_1_10009.metaPtData
		local var_15_4 = not var_11.CanGetNextAward(var_15_3)

		if arg_15_1 == var_0_3 and var_15_4 then
			table = var_12
		...
		elseif arg_15_1 == var_0_2 and not var_15_4 then
			table = var_12
		...
		var_15_1[iter_15_1.id] = var_1_10010
	end
...
function var_0_1.OnInitItem(arg_18_0, arg_18_1)
	...
	var_3(var_18_1, var_18_2, var_18_3, var_1_10007)
...
function var_0_1.UpdateMain(arg_22_0, arg_22_1)
	...
	var_6(arg_22_0.openTr, not var_22_4)
	...
	var_6(var_22_5, not var_8.CanGetNextAward(var_22_6))

	if var_22_4 then
		removeOnButton = var_6

		var_6(arg_22_0.openTr)
	else
		onButton = var_6
		...
		var_6(var_22_7, var_22_8, var_22_9, var_1_10010)
	end

	if var_22_3 then
		onButton = var_6

		var_6(arg_22_0, arg_22_0.simulateBtn, function()
...
function var_0_1.Switch(arg_25_0, arg_25_1)
	...
	if var_25_0 == var_1_10003.ACHIEVE_STATE_NOSTART then
		...
		var_25_1(var_1_10004, var_1_10005.ON_SWITCH_ARCHIVES, arg_25_1.id)
	else
		...
		if var_25_0 == var_25_1.ACHIEVE_STATE_STARTING then
			...
			local var_25_4 = var_5.ship_strengthen_meta[var_25_3].ship_id

			pg = var_1_10006

			local var_25_5 = var_1_10006.ship_data_statistics[var_25_4].name
			...
			i18n = var_1_10011
			var_25_9.content = var_1_10011("world_boss_switch_archives", var_25_5)
			...
			function var_25_9.onYes()
				...
				var_26_1(var_26_0, var_2_10002.ON_SWITCH_ARCHIVES, arg_25_1.id)
...
function var_0_1.Simulate(arg_27_0, arg_27_1)
	...
	i18n = var_1_10005
	var_27_2.content = var_1_10005("meta_reproduce_btn")
	...
	function var_27_2.onYes()
		...
		var_28_1(var_28_0, var_2_10002.ON_BATTLE, arg_27_1.id, false, 1, true)
...
function var_0_1.UpdateAwards(arg_29_0, arg_29_1)
	...
	var_1_10005(var_29_2, var_1_10007(var_8.getPtIconPath(var_29_3)))
	...
	var_29_4(arg_29_0.getAllBtn, var_29_5)

	if not var_29_5 then
		removeOnButton = var_29_4

		var_29_4(arg_29_0.getAllBtn)
	else
		onButton = var_29_4
		...
		local function var_29_8()
			...
			local var_30_3 = var_2.m02
			local var_30_4 = var_2.sendNotification

			GAME = var_2_10004

			var_30_4(var_30_3, var_2_10004.GET_META_PT_AWARD, {
		...
		var_29_4(var_29_6, var_29_7, var_29_8, var_1_10010)
	end
...
function var_0_1.OnInitAwardItem(arg_32_0, arg_32_1)
	...
	local function var_32_3()
		...
		var_33_1(var_33_0, var_2_10002.ON_DROP, var_32_0.dropInfo)
