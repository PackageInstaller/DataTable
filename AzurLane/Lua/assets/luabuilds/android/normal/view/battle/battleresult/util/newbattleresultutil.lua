...
function var_0_0.GetObjectives(arg_7_0)
	...
	local function var_7_2(arg_8_0)
		if arg_8_0 then
			...
			var_8_6.text = var_2_10008(var_8_0, var_8_3)
...
function var_0_0.HasSubShip(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_1_10001(arg_11_0) do
		...
		local var_11_0 = var_7.contains

		ShipType = var_1_10008

		if var_11_0(var_1_10008.SubShipType, var_1_10006) then
			return true
		end
	end
...
function var_0_0.HasSurfaceShip(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10001(arg_12_0) do
		...
		local var_12_0 = var_7.contains

		ShipType = var_1_10008

		if not var_12_0(var_1_10008.SubShipType, var_1_10006) then
			return true
		end
	end
...
function var_0_0.SeparateSurfaceAndSubShips(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10003(arg_13_0) do
		...
		local var_13_2 = var_9.contains

		ShipType = var_1_10010

		if var_13_2(var_1_10010.SubShipType, var_1_10008) then
			table = var_1_10010

			var_1_10010.insert(var_13_1, iter_13_1)
		else
			table = var_1_10010
...
function var_0_0.SeparateMvpShip(arg_14_0, arg_14_1, arg_14_2)
	...
	for iter_14_0, iter_14_1 in var_1_10007(arg_14_0) do
		if iter_14_1.id ~= arg_14_1 then
			...
			local var_14_5 = var_13.GetTeamFromShipType(var_14_4)

			TeamType = var_14

			if var_14_5 == var_14.Vanguard then
				table = var_14
				...
				if var_14_5 == var_14.Main then
					...
					if var_14_5 == var_14.Submarine then
						table = var_14
...
function var_0_0.GetShipExpOffset(arg_16_0, arg_16_1)
	...
	if arg_16_0.level < arg_16_1.level then
		...
		for iter_16_0 = arg_16_0.level, arg_16_1.level - 1 do
			...
			var_16_1 = var_16_1 + var_1_10008(var_16_0, iter_16_0)
		end
