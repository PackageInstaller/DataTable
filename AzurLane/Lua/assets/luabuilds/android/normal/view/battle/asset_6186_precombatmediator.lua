...
function var_0_1.bindEvent(arg_2_0)
	...
	arg_2_0:bind(var_0_1.OPEN_SHIP_INFO, function(arg_9_0, arg_9_1, arg_9_2)
		...
		local var_9_4 = var_6.GO_SCENE

		SCENE = iter_9_0

		var_9_3(var_9_2, var_9_4, iter_9_0.SHIPINFO, {
			shipId = arg_9_1,
			shipVOs = var_9_1
		})
	...
	arg_2_0:bind(var_0_1.CHANGE_FLEET_SHIP, function(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
		...
		var_2_10004(var_10_0 ~= var_2_10006.PVP_FLEET_ID, "fleet type error")

		local var_10_1 = arg_2_0.contextData

		PreCombatLayer = var_5
		var_10_1.form = var_5.FORM_EDIT
		...
		if var_10_2 == var_10_3 then
			...
			if var_4 then
				...
				FormationMediator = var_2_10007

				local var_10_5, var_10_6, var_10_7 = var_2_10007.getDockCallbackFuncs(arg_2_0, arg_10_1, arg_10_2, arg_10_3)
				local var_10_8 = {}
				...
				local var_10_11 = var_13.GO_SCENE

				SCENE = iter_10_0

				local var_10_12 = iter_10_0.DOCKYARD
				local var_10_13 = {
					selectedMin = 0,
					useBlackBlock = true,
					selectedMax = 1,
				...
				i18n = var_2_10016
				var_10_13.leastLimitMsg = var_2_10016("battle_preCombatMediator_leastLimit")
	...
	arg_2_0:bind(var_0_1.ON_START, function(arg_12_0, arg_12_1, arg_12_2)
		...
		var_2_10003({
			function(arg_13_0)
				...
				FleetProxy = var_3_10005

				local var_13_2 = var_3_10004(var_3_10005)
				local var_13_3 = var_4.getFleetById(var_13_2, arg_12_1)
				local var_13_4 = {}

				ipairs = var_13_2

				for iter_13_0, iter_13_1 in var_13_2(var_13_3.ships) do
					table = var_3_10010
					...
					var_3_10010(var_13_5, var_3_10012.getShipById(var_3_10013, iter_13_1))
				end

				local var_13_6 = var_13_3
				local var_13_7 = var_13_3.GetName(var_13_6)

				Fleet = var_13_6

				var_13_6.EnergyCheck(var_13_4, var_13_7, function(arg_14_0)
					if arg_14_0 then
						arg_13_0()
					end
	...
	arg_2_0:bind(var_0_1.BEGIN_STAGE_PROXY, function(arg_19_0, arg_19_1)
		...
		var_19_2(var_19_1, var_2_10005.BEGIN_STAGE, {
			stageId = var_19_0,
...
function var_0_1.changeFleet(arg_20_0, arg_20_1)
	...
	if var_20_0 == var_1_10003 then
		...
		var_20_0(var_1_10003).combatFleetId = arg_20_1
	end
...
function var_0_1.commitEdit(arg_22_0, arg_22_1)
	...
	if var_1_10002(var_1_10003).EdittingFleet == nil or var_3:isFirstFleet() or var_3:isLegalToFight() == true then
		...
		if #var_3.ships == 0 then
			local var_22_0 = var_2

			var_2.commitEdittingFleet(var_22_0, arg_22_1)

			var_22_1 = arg_22_0.contextData.system
			SYSTEM_SUB_ROUTINE = var_22_0
			...
			local var_22_2 = var_22_1.MsgboxMgr.GetInstance()
			local var_22_3 = var_4.ShowMsgBox
			local var_22_4 = {}

			i18n = var_1_10007
			var_22_4.content = var_1_10007("ship_formationMediaror_trash_warning", var_3.defaultName)
			...
			function var_22_4.onYes()
				...
				if var_23_3 == var_4.PVP_FLEET_ID then
					...
					var_23_6(var_23_5, var_5.PVP_FLEET_ID)
				else
...
function var_0_1.onAutoBtn(arg_24_0, arg_24_1)
	...
	var_24_3(var_24_2, var_1_10006.AUTO_BOT, {
...
function var_0_1.onAutoSubBtn(arg_25_0, arg_25_1)
	...
	var_25_3(var_25_2, var_1_10006.AUTO_SUB, {
...
function var_0_1.handleNotification(arg_27_0, arg_27_1)
	...
	if var_27_0 == var_27_1.BEGIN_STAGE_DONE then
		...
		var_27_4(var_27_3, var_1_10006, var_1_10007.COMBATLOAD, var_27_2)
	else
		PlayerProxy = var_27_4

		local var_27_6

		if var_27_0 == var_27_4.UPDATED then
			...
			var_27_6(var_27_5, var_1_10006.getData(var_1_10007))
		else
			GAME = var_27_6

			local var_27_8

			if var_27_0 == var_27_6.BEGIN_STAGE_ERRO then
				if var_27_2 == 3 then
					pg = var_27_8

					local var_27_7 = var_27_8.MsgboxMgr.GetInstance()

					var_27_8 = var_27_8.ShowMsgBox
					var_1_10006 = {
						hideNo = true
					}
					i18n = var_1_10007
					...
					function var_1_10006.onYes()
						...
						var_28_1(var_28_0, var_2_10002.ON_CLOSE)

						return
					end

					var_27_8(var_27_7, var_1_10006)
				end
			else
				PreCombatMediator = var_27_8

				if var_27_0 == var_27_8.BEGIN_STAGE_PROXY then
					local var_27_9 = arg_27_0.viewComponent
					local var_27_10 = var_4.emit

					PreCombatMediator = var_1_10006

					var_27_10(var_27_9, var_1_10006.BEGIN_STAGE_PROXY, var_27_2)
				elseif var_27_0 == var_0_1.CONTINUOUS_OPERATION then
					local var_27_11 = arg_27_0.viewComponent
					local var_27_12 = var_4.emit

					PreCombatMediator = var_1_10006

					var_27_12(var_27_11, var_1_10006.ON_START, var_27_2.mainFleetId, var_27_2.battleTimes)
				end
			end
		end
	end
