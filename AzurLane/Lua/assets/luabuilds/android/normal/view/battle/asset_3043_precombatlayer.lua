...
function var_0_1.CommonInit(arg_4_0)
	...
	var_2(var_4_9, var_4_10 ~= var_1_10005)
	...
	local var_4_11 = var_4_6

	arg_4_0._bgSub = var_4_6.Find(var_4_11, "mask/bg_sub")

	local var_4_12 = {}

	TeamType = var_4_11
	var_4_12[var_4_11.Vanguard] = {}
	TeamType = var_3
	var_4_12[var_3.Main] = {}
	TeamType = var_3
	var_4_12[var_3.Submarine] = {}
	arg_4_0._gridTFs = var_4_12
	...
	for iter_4_0 = 1, 3 do
		...
		local var_4_14 = var_4_13[var_1_10007.Main]
		local var_4_15 = arg_4_0._gridFrame

		var_4_14[iter_4_0] = var_1_10007.Find(var_4_15, "main_" .. iter_4_0)

		local var_4_16 = arg_4_0._gridTFs

		TeamType = var_1_10007

		local var_4_17 = var_4_16[var_1_10007.Vanguard]
		local var_4_18 = arg_4_0._gridFrame

		var_4_17[iter_4_0] = var_1_10007.Find(var_4_18, "vanguard_" .. iter_4_0)

		local var_4_19 = arg_4_0._gridTFs

		TeamType = var_1_10007

		local var_4_20 = var_4_19[var_1_10007.Submarine]
		local var_4_21 = arg_4_0._gridFrame

		var_4_20[iter_4_0] = var_1_10007.Find(var_4_21, "submarine_" .. iter_4_0)
	end

	local var_4_22 = arg_4_0.rtAdapt

	arg_4_0._nextPage = var_2.Find(var_4_22, "middle/nextPage")

	local var_4_23 = arg_4_0.rtAdapt

	arg_4_0._prevPage = var_2.Find(var_4_23, "middle/prevPage")
	arg_4_0._heroContainer = var_4_6:Find("HeroContainer")
	arg_4_0._checkBtn = var_4_6:Find("checkBtn")

	local var_4_24 = arg_4_0._tf

	arg_4_0._blurPanel = var_2.Find(var_4_24, "blur_panel")

	local var_4_25 = arg_4_0._blurPanel

	arg_4_0.topPanel = var_2.Find(var_4_25, "top")

	local var_4_26 = arg_4_0._blurPanel

	arg_4_0.topPanelBg = var_2.Find(var_4_26, "top_bg")

	local var_4_27 = arg_4_0.topPanel

	arg_4_0._backBtn = var_2.Find(var_4_27, "back_btn")

	local var_4_28 = arg_4_0.rtAdapt

	arg_4_0._spoilsContainer = var_2.Find(var_4_28, "right/infomation/atlasloot/spoils/items/items_container")

	local var_4_29 = arg_4_0.rtAdapt

	arg_4_0._item = var_2.Find(var_4_29, "right/infomation/atlasloot/spoils/items/item_tpl")
	SetActive = var_2
	...
	arg_4_0._goals = var_2.Find(var_4_30, "right/infomation/target/goal")
	arg_4_0._heroInfo = arg_4_0:getTpl("heroInfo")
	arg_4_0._starTpl = arg_4_0:getTpl("star_tpl")
	setText = var_2

	local var_4_31 = arg_4_0.rtAdapt
	local var_4_32 = var_3.Find(var_4_31, "middle/gear_score/vanguard/line/Image/Text1")

	i18n = var_4_31

	var_2(var_4_32, var_4_31("pre_combat_vanguard"))

	setText = var_2

	local var_4_33 = arg_4_0.rtAdapt
	local var_4_34 = var_3.Find(var_4_33, "middle/gear_score/main/line/Image/Text1")

	i18n = var_4_33

	var_2(var_4_34, var_4_33("pre_combat_main"))

	setText = var_2

	local var_4_35 = arg_4_0.rtAdapt
	local var_4_36 = var_3.Find(var_4_35, "middle/gear_score/submarine/line/Image/text1")

	i18n = var_4_35

	var_2(var_4_36, var_4_35("pre_combat_submarine"))

	setText = var_2

	local var_4_37 = arg_4_0._costContainer
	local var_4_38 = var_3.Find(var_4_37, "title")

	i18n = var_4_37

	var_2(var_4_38, var_4_37("pre_combat_consume"))

	setText = var_2

	local var_4_39 = arg_4_0.rtAdapt
	local var_4_40 = var_3.Find(var_4_39, "right/infomation/target/title/GameObject")

	i18n = var_4_39

	var_2(var_4_40, var_4_39("pre_combat_targets"))

	setText = var_2

	local var_4_41 = arg_4_0.rtAdapt
	local var_4_42 = var_3.Find(var_4_41, "right/infomation/atlasloot/atlasloot/title/GameObject")

	i18n = var_4_41

	var_2(var_4_42, var_4_41("pre_combat_atlasloot"))

	setText = var_2

	local var_4_43 = arg_4_0._startBtn
	local var_4_44 = var_3.Find(var_4_43, "text")

	i18n = var_4_43

	var_2(var_4_44, var_4_43("pre_combat_start"))

	setText = var_2

	local var_4_45 = arg_4_0._startBtn
	local var_4_46 = var_3.Find(var_4_45, "text_en")

	i18n = var_4_45

	var_2(var_4_46, var_4_45("pre_combat_start_en"))

	local var_4_47 = arg_4_0.rtAdapt

	arg_4_0._middle = var_2.Find(var_4_47, "middle")

	local var_4_48 = arg_4_0.rtAdapt

	arg_4_0._right = var_2.Find(var_4_48, "right")
	...
	local var_4_49 = arg_4_0._middle

	arg_4_0.guideDesc = var_2.Find(var_4_49, "guideDesc")
...
function var_0_1.Register(arg_5_0)
	...
	var_1.AddHeroInfoModify(var_5_1, function(arg_7_0, arg_7_1)
		...
		local var_7_4 = var_2:Find("energy")
		local var_7_5
		...
		var_7_10(var_2:Find("type"), var_9, true)

		setText = var_7_10

		var_7_10(var_2:Find("frame/lv_contain/lv"), arg_7_1.level)
		...
		if 0 < var_7_11 then
			...
			local var_7_14 = var_2
			local var_7_15 = var_2.Find(var_7_14, "expbuff")
			...
			local var_7_23 = var_2
			local var_7_24 = var_2.Find(var_7_23, "expbuff")
	...
	var_1.AddBeginDrag(var_5_3, function(arg_9_0)
		...
		local var_9_1 = arg_9_0.Find(var_9_0, "info")
	...
	var_1.AddSwitchToDisplayMode(var_5_9, function()
		...
		var_0(var_1.Find(var_15_2, "save"), true)

		setActive = var_0

		local var_15_3 = arg_5_0._checkBtn

		var_0(var_1.Find(var_15_3, "edit"), false)
	...
	var_1.AddSwitchToPreviewMode(var_5_11, function()
		...
		var_0(var_1.Find(var_17_2, "save"), false)

		setActive = var_0

		local var_17_3 = arg_5_0._checkBtn

		var_0(var_1.Find(var_17_3, "edit"), true)
...
function var_0_1.SetStageID(arg_22_0, arg_22_1)
	...
	for iter_22_3, iter_22_4 in var_9(var_22_15) do
		type = var_1_10014
...
function var_0_1.UpdateFleetView(arg_30_0, arg_30_1)
	...
	var_30_2(var_30_1, var_1_10004.Vanguard, arg_30_0._currentForm ~= var_0_1.FORM_EDIT)
	...
	var_30_4(var_30_3, var_4.Main, arg_30_0._currentForm ~= var_0_1.FORM_EDIT)
	...
	var_30_6(var_30_5, var_4.Submarine, arg_30_0._currentForm ~= var_0_1.FORM_EDIT)
...
function var_0_1.quickExitFunc(arg_35_0)
	if arg_35_0._currentForm == var_0_1.FORM_EDIT then
		...
		var_35_1(var_35_0, var_1_10003.ON_ABORT_EDIT)
	end
...
function var_0_1.didEnter(arg_36_0)
	...
	local function var_36_8()
		...
		var_49_1(var_49_0, var_2_10002.ON_CHANGE_FLEET, arg_36_0._legalFleetIdList[arg_36_0._curFleetIndex + 1])
	...
	local function var_36_11()
		...
		var_50_1(var_50_0, var_2_10002.ON_CHANGE_FLEET, arg_36_0._legalFleetIdList[arg_36_0._curFleetIndex - 1])
	...
	var_1_10001(var_36_9, var_36_10, var_36_11, var_1_10005)
	...
	local function var_36_14()
		if arg_36_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_51_1(var_51_0, var_2_10002.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_52_1(var_52_0, var_3_10002("battle_preCombatLayer_save_success"))
	...
	var_1_10001(var_36_12, var_36_13, var_36_14, var_1_10005)
	...
	local function var_36_20(arg_53_0)
		...
		var_53_1(var_53_0, var_2_10003.ON_AUTO, {
			isOn = not arg_53_0,
		...
		if arg_53_0 and arg_36_0._subUseable == true then
			...
			local function var_53_4(arg_54_0)
				...
				var_54_1(var_54_0, var_3_10003.ON_SUB_AUTO, {
					isOn = not arg_54_0,
			...
			var_53_1(var_53_2, var_53_3, var_53_4, var_5, var_2_10006)
	...
	var_1(var_36_18, var_36_19, var_36_20, var_1_10005, var_1_10006)
...
function var_0_1.displayFleetInfo(arg_56_0)
	...
	var_56_0(var_56_2, var_56_1 == var_1_10004.Normal)
	...
	var_56_0(var_56_3, var_56_1 == var_4.Normal)

	math = var_56_0

	local var_56_4 = var_56_0.floor
	local var_56_5 = arg_56_0._currentFleetVO
	local var_56_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_56_7 = var_56_4(var_56_6(var_56_5, var_1_10005.Vanguard))

	math = var_3

	local var_56_8 = var_3.floor
	local var_56_9 = arg_56_0._currentFleetVO
	local var_56_10 = var_4.GetGearScoreSum

	TeamType = var_1_10006

	local var_56_11 = var_56_8(var_56_10(var_56_9, var_1_10006.Main))
	...
	var_4(var_56_12, var_56_1 == var_6.Submarine)

	math = var_4

	local var_56_13 = var_4.floor
	local var_56_14 = arg_56_0._currentFleetVO
	local var_56_15 = var_5.GetGearScoreSum

	TeamType = var_1_10007

	local var_56_16 = var_56_13(var_56_15(var_56_14, var_1_10007.Submarine))
	...
	local var_56_20 = var_7.battle_cost_template[var_56_19].oil_cost == 0 and 0 or var_56_18.oil
	...
	var_1_10009(var_56_21, var_56_19 ~= var_1_10011)
