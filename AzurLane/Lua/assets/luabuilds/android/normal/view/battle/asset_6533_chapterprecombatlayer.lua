...
function var_0_1.init(arg_3_0)
	...
	local var_3_21 = var_4.Find(var_3_20, "middle/gear_score/vanguard/line/Image/Text1")

	i18n = var_3_20

	var_3(var_3_21, var_3_20("pre_combat_vanguard"))

	setText = var_3

	local var_3_22 = arg_3_0.rtAdapt
	local var_3_23 = var_4.Find(var_3_22, "middle/gear_score/main/line/Image/Text1")

	i18n = var_3_22

	var_3(var_3_23, var_3_22("pre_combat_main"))
	...
	local var_3_26 = var_4.Find(var_3_25, "title_bg/Text")

	i18n = var_3_25

	var_3(var_3_26, var_3_25("pre_combat_team"))
...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_2()
		...
		var_8_2(var_8_3, var_2_10003.Action(function()
	...
	local function var_7_5()
		...
		ChapterPreCombatMediator = var_2_10002

		var_10_1(var_10_0, var_2_10002.ON_START)
	...
	local function var_7_8(arg_11_0)
		...
		var_11_1(var_11_0, var_2_10003.ON_AUTO, {
			isOn = not arg_11_0,
		...
		if arg_11_0 and arg_7_0.subUseable == true then
			...
			local function var_11_4(arg_12_0)
				...
				ChapterPreCombatMediator = var_3_10003

				var_12_1(var_12_0, var_3_10003.ON_SUB_AUTO, {
					isOn = not arg_12_0,
			...
			var_11_1(var_11_2, var_11_3, var_11_4, var_5, var_2_10006)
	...
	var_1_10001(var_7_6, var_7_7, var_7_8, var_1_10005, var_1_10006)
	...
	var_1(function()
		...
		var_0(var_13_0, var_2_10002.Battle.BattleState.IsAutoBotActive())
	...
	local var_7_12 = var_3.Find(var_7_11, "middle/gear_score/vanguard/SonarTip")
	...
	local function var_7_13()
		...
		pg = var_2_10003
		var_15_2.helps = var_2_10003.gametip.fleet_antisub_range_tip.tip
	...
	var_1(arg_7_0, arg_7_0._costTip, function()
		...
		i18n = var_2_10008
		var_16_9.content = var_2_10008("use_oil_limit_help", var_16_6, var_16_5)
...
function var_0_1.Register(arg_17_0)
	...
	var_1.AddHeroInfoModify(var_17_0, function(arg_18_0, arg_18_1, arg_18_2)
		...
		local var_18_4 = var_18_3 <= var_18_2.ENERGY_MID
		local var_18_5 = var_3
		local var_18_6 = var_3.Find(var_18_5, "energy")

		if var_18_4 then
			local var_18_7

			var_18_5, var_18_7 = arg_18_1:getEnergyPrint()
			GetSpriteFromAtlas = var_2_10009

			if not var_2_10009("energy", var_18_5) then
				warning = var_10
			...
			var_10(var_18_6, var_9)
		end

		setActive = var_18_5

		var_18_5(var_18_6, var_18_4)
		...
		if not var_8(var_18_9, var_10(arg_18_1:getShipType())) then
			warning = var_18_9

			var_18_9("找不到船形, shipConfigId: " .. arg_18_1.configId)
		end

		setImageSprite = var_18_9

		var_18_9(var_3:Find("type"), var_8, true)

		setText = var_18_9

		var_18_9(var_3:Find("frame/lv_contain/lv"), arg_18_1.level)
		...
		var_18_12(var_18_14, var_2_10015.HpGreen <= var_18_15)
		...
		var_18_12(var_18_16, var_18_17 < var_15.HpGreen)

		local var_18_18 = arg_18_1.hpRant

		ChapterConst = var_18_16

		local var_18_19 = var_18_18 >= var_18_16.HpGreen and var_18_11 or var_18_13
		...
		getProxy = var_13
		ActivityProxy = var_14

		local var_18_20 = var_13(var_14)
		local var_18_21 = var_13.getBuffShipList(var_18_20)[arg_18_1:getGroupId()]
		local var_18_22 = var_3
		local var_18_23 = var_3.Find(var_18_22, "expbuff")

		setActive = var_18_22

		var_18_22(var_18_23, var_18_21 ~= nil)

		if var_18_21 then
			local var_18_24 = var_18_21 / 100
			local var_18_25 = var_18_21 % 100

			tostring = var_18

			local var_18_26 = var_18(var_18_24)
			local var_18_27
			...
			if 0 < var_18_25 then
				...
				var_18_26 = var_18_27 .. var_18_28 .. var_2_10021(var_18_25)
			end

			setText = var_18_27

			local var_18_29 = var_18_23
			local var_18_30 = var_18_23.Find(var_18_29, "text")

			string = var_18_29

			var_18_27(var_18_30, var_18_29.format("EXP +%s%%", var_18_26))
		end
	...
	var_1.AddEndDrag(var_17_2, function()
		...
		var_20_1(var_20_0, var_2_10002.ON_SWITCH_SHIP, arg_17_0.chapter.fleet)
...
function var_0_1.updateView(arg_27_0, arg_27_1)
	...
	var_27_1(var_27_0, var_1_10004.Vanguard, true)
	...
	var_27_3(var_27_2, var_4.Main, true)
	...
	local var_27_5 = var_27_4[var_4.Main][1]

	var_27_3(var_3.Find(var_27_5, "flag"), true)
...
function var_0_1.updateStageView(arg_28_0, arg_28_1)
	...
	if var_7(var_1_10008.expedition_activity_template[arg_28_1], {
		"pt_drop_display"
	}) then
		type = var_28_5
		...
		if var_28_5(var_7) == "table" then
			...
			for iter_28_0 = #var_7, 1, -1 do
				if var_28_5:getActivityById(var_7[iter_28_0][1]) and not var_13:isEnd() then
					...
					id2ItemId = var_1_10018
					var_28_9[2] = var_1_10018(var_7[iter_28_0][2])

					var_28_6(var_28_7, var_28_8, var_28_9)
				end
			end
		end
	end
	...
	local var_28_10 = var_28_5.New(arg_28_0._spoilsContainer, arg_28_0._item)

	var_8.make(var_28_10, function(arg_29_0, arg_29_1, arg_29_2)
		...
		local function var_29_5()
			...
			if var_3_10000.getConfigData(var_29_1[2]) and var_0_3[var_0.type] then
				...
				var_30_2(var_30_1, var_3_10004.GET_CHAPTER_DROP_SHIP_LIST, arg_28_0.chapter.id, var_30_0)
			else
		...
		var_6(var_29_3, var_29_4, var_29_5, var_2_10010)

		return
	end)

	local var_28_11 = var_8
	local var_28_12 = var_8.align

	math = var_11

	var_28_12(var_28_11, var_11.min(#var_28_4, 6))

	local function var_28_13(arg_32_0, arg_32_1)
		type = var_2_10002
		...
		if var_2_10002(arg_32_0) == "table" then
			...
			var_32_0 = var_32_0(var_3.ObjectiveList[arg_32_0[1]], arg_32_0[2])
			setWidgetText = var_3

			var_3(arg_32_1, var_32_0)
		else
			setActive = var_32_0
	...
	var_28_14[1] = var_11.Find(var_28_15, "goal_tpl")

	local var_28_16 = arg_28_0._goals

	var_28_14[2] = var_11.Find(var_28_16, "goal_sink")

	local var_28_17 = arg_28_0._goals

	var_28_14[3] = var_11.Find(var_28_17, "goal_time")
	...
	for iter_28_1, iter_28_2 in var_13(var_28_18) do
		type = var_1_10018

		if var_1_10018(iter_28_2) ~= "string" then
			var_28_13(iter_28_2, var_28_14[var_28_19])

			var_28_19 = var_28_19 + 1
		end
	end

	for iter_28_3 = var_28_19, #var_28_14 do
		var_28_13("", var_28_14[iter_28_3])
	end
...
function var_0_1.updateBattleFleetView(arg_33_0)
	local function var_33_0(arg_34_0, arg_34_1)
		...
		for iter_34_0 = 1, 3 do
			if arg_34_1[iter_34_0] then
				...
				var_7(var_34_0, arg_34_1[iter_34_0])
				...
				local var_34_5 = var_34_0.Find(var_34_4, "blood/fillarea/red")

				setActive = var_34_4

				local var_34_6 = var_34_3

				ChapterConst = var_2_10013
				var_2_10013 = var_2_10013.HpGreen <= var_34_1

				var_34_4(var_34_6, var_2_10013)
				...
				ChapterConst = var_2_10013
				var_2_10013 = var_34_1 < var_2_10013.HpGreen

				var_34_4(var_34_7, var_2_10013)

				ChapterConst = var_34_4
				var_2_10013 = var_34_1 >= var_34_4.HpGreen and var_34_3 or var_34_5

				local var_34_8 = var_11.GetComponent(var_2_10013, "Image")

				var_34_8.fillAmount = var_34_1 * 0.0001
				setActive = var_34_8

				var_34_8(var_34_0:Find("broken"), var_34_1 == 0)
			end
		end
	...
	local var_33_4 = var_4.Find(var_33_3, "main")
	local var_33_5 = var_33_1
	local var_33_6 = var_33_1.getShipsByTeam

	TeamType = var_1_10007

	var_33_2(var_33_4, var_33_6(var_33_5, var_1_10007.Main, true))

	local var_33_7 = var_33_0
	local var_33_8 = arg_33_0._fleet
	local var_33_9 = var_4.Find(var_33_8, "vanguard")
	local var_33_10 = var_33_1
	local var_33_11 = var_33_1.getShipsByTeam

	TeamType = var_7

	var_33_7(var_33_9, var_33_11(var_33_10, var_7.Vanguard, true))
...
function var_0_1.displayFleetInfo(arg_35_0)
	...
	local var_35_5 = var_35_3.reduce
	local var_35_6 = var_35_0
	local var_35_7 = var_35_0.getShipsByTeam

	TeamType = var_1_10007

	local var_35_8 = var_35_5(var_35_7(var_35_6, var_1_10007.Vanguard, false), 0, function(arg_36_0, arg_36_1)
		return arg_36_0 + arg_36_1:getShipCombatPower(var_35_4)
	end)

	_ = var_5

	local var_35_9 = var_5.reduce
	local var_35_10 = var_35_0
	local var_35_11 = var_35_0.getShipsByTeam

	TeamType = var_8

	local var_35_12 = var_35_9(var_35_11(var_35_10, var_8.Main, false), 0, function(arg_37_0, arg_37_1)
	...
	var_35_14[1] = var_9.getFleetCost(var_35_15, var_35_0, var_35_2)
	...
	var_35_16(arg_35_0._popup, true)

	setActive = var_35_16

	var_35_16(arg_35_0._costTip, var_35_17)

	setTextColor = var_35_16
	...
	if var_35_17 then
		...
		var_10(arg_35_0._extraCostBuffIcon, #var_35_22 > 0)

		ipairs = var_10

		for iter_35_2, iter_35_3 in var_10(var_35_22) do
			...
			if var_35_23 == var_1_10016.OPERATION_BUFF_TYPE_COST then
				...
				var_1_10016 = var_1_10016.Find(var_35_24, "text_cost")
				tonumber = var_35_24

				var_35_23(var_1_10016, var_35_24(iter_35_3.benefit_effect) * 0.01 + 1)
			else
				local var_35_25 = iter_35_3.benefit_type

				Chapter = var_1_10016

				if var_35_25 == var_1_10016.OPERATION_BUFF_TYPE_EXP then
					setText = var_35_25

					local var_35_26 = arg_35_0._extraCostBuffIcon

					var_1_10016 = var_1_10016.Find(var_35_26, "text_reward")
					tonumber = var_35_26

					var_35_25(var_1_10016, var_35_26(iter_35_3.benefit_effect) * 0.01 + 1)
				else
					local var_35_27 = iter_35_3.benefit_type

					Chapter = var_1_10016

					if var_35_27 == var_1_10016.OPERATION_BUFF_TYPE_DESC then
						onButton = var_35_27

						var_35_27(arg_35_0, arg_35_0._extraCostBuffIcon, function()
		...
		local var_35_28 = arg_35_0.rtAdapt
		local var_35_29 = var_10.Find(var_35_28, "middle/gear_score/vanguard")

		ChapterFleet = var_35_28

		local var_35_30 = var_35_28.StaticTransformChapterFleet2Fleet(var_35_0)
		local var_35_31 = var_11.GetFleetSonarRange(var_35_30)

		setActive = var_35_30

		var_35_30(var_35_29:Find("SonarActive"), var_35_31 > 0)

		setActive = var_35_30

		var_35_30(var_35_29:Find("SonarInactive"), var_35_31 <= 0)

		if 0 < var_35_31 then
			setText = var_13

			local var_35_32 = var_35_29
			local var_35_33 = var_35_29.Find(var_35_32, "SonarActive/Text")

			math = var_35_32

			var_13(var_35_33, var_35_32.floor(var_35_31))
		end
...
function var_0_1.updateStrategyIcon(arg_39_0)
	...
	local var_39_2 = var_39_0.detect(var_39_1, function(arg_40_0)
	...
	local var_39_3 = var_3.strategy_data_template[var_39_2.id]
	...
	var_4(var_39_4, var_39_5, var_7.Find(var_39_6, "icon"))
	...
	var_4(var_39_7, var_39_8, var_39_9, var_39_6)

	setText = var_4

	local var_39_10 = arg_39_0._strategy

	var_4(var_5.Find(var_39_10, "nums"), var_39_2.count)

	setActive = var_4

	local var_39_11 = arg_39_0._strategy

	var_4(var_5.Find(var_39_11, "mask"), var_39_2.count == 0)

	setActive = var_4

	local var_39_12 = arg_39_0._strategy

	var_4(var_5.Find(var_39_12, "selected"), false)
	...
	var_39_14(var_39_15, false)

	ChapterConst = var_39_14

	local var_39_16 = var_39_14.StrategyForms
	local var_39_17 = {}
	...
	var_9.make(var_39_20, function(arg_42_0, arg_42_1, arg_42_2)
		...
		if arg_42_0 == var_2_10003.EventUpdate then
			...
			local var_42_2 = "strategyicon/" .. var_4.icon
			local var_42_3 = ""
			local var_42_4 = arg_42_2

			var_42_1(var_42_2, var_42_3, arg_42_2.Find(var_42_4, "icon"))

			onButton = var_42_1

			local var_42_5 = arg_39_0
			local var_42_6 = arg_42_2
			...
			local function var_42_7()
				...
				if var_43_0 == var_3_10001.StgTypeForm then
					...
					local var_43_3 = var_43_1.indexof(var_39_16, var_42_0.id)
					local var_43_4 = arg_39_0
					local var_43_5 = var_2.emit

					ChapterPreCombatMediator = var_3_10004

					local var_43_6 = var_3_10004.ON_OP
					local var_43_7 = {}

					ChapterConst = var_3_10006
					var_43_7.type = var_3_10006.OpStrategy
			...
			var_42_1(var_42_5, var_42_6, var_42_7, var_42_4)
...
function var_0_1.displayStrategyInfo(arg_44_0, arg_44_1)
	...
	function arg_44_0.strategyPanel.onConfirm()
		...
		local var_45_5 = var_2_10006.ON_OP
		local var_45_6 = {}

		ChapterConst = var_2_10008
		var_45_6.type = var_2_10008.OpStrategy
