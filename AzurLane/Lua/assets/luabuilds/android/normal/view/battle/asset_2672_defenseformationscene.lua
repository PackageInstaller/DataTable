...
function var_0_1.Register(arg_3_0)
	...
	var_1.AddHeroInfoModify(var_3_0, function(arg_4_0, arg_4_1)
		...
		local var_4_1 = arg_4_1.getConfigTable(var_4_0)

		pg = var_4_0

		local var_4_2 = var_4_0.ship_data_template[arg_4_1.configId]
		local var_4_3 = arg_4_0:Find("info")
		local var_4_4 = var_4.Find(var_4_3, "stars")
		local var_4_5 = arg_4_1:getStar()

		for iter_4_0 = 1, var_4_5 do
			cloneTplTo = var_2_10011

			var_2_10011(arg_3_0._starTpl, var_4_4)
		end

		GetSpriteFromAtlas = var_7

		local var_4_6 = "shiptype"

		shipType2print = var_9

		if not var_7(var_4_6, var_9(arg_4_1:getShipType())) then
			warning = var_4_6

			var_4_6("找不到船形, shipConfigId: " .. arg_4_1.configId)
		end

		setImageSprite = var_4_6

		var_4_6(var_4:Find("type"), var_7, true)

		setText = var_4_6

		var_4_6(var_4:Find("frame/lv_contain/lv"), arg_4_1.level)
	...
	var_1.AddLongPress(var_3_1, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10005.OPEN_SHIP_INFO, arg_5_1.id, arg_5_2, var_0_1.TOGGLE_FORMATION)
	...
	var_1.AddClick(var_3_2, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.CHANGE_FLEET_SHIP, arg_6_0, arg_6_1)
	...
	var_1.AddBeginDrag(var_3_3, function(arg_7_0)
		...
		local var_7_1 = arg_7_0.Find(var_7_0, "info")

		setButtonEnabled = var_7_0

		var_7_0(arg_3_0.backBtn, false)

		setToggleEnabled = var_7_0

		var_7_0(arg_3_0._detailToggle, false)

		SetActive = var_7_0

		var_7_0(var_7_1, false)
	...
	var_1.AddEndDrag(var_3_4, function(arg_8_0)
		...
		local var_8_1 = arg_8_0.Find(var_8_0, "info")

		setButtonEnabled = var_8_0

		var_8_0(arg_3_0.backBtn, true)

		setToggleEnabled = var_8_0

		var_8_0(arg_3_0._detailToggle, true)
	...
	var_1.AddShiftOnly(var_3_5, function(arg_9_0)
		...
		DefenseFormationMedator = var_2_10003

		var_9_1(var_9_0, var_2_10003.CHANGE_FLEET_SHIPS_ORDER, arg_9_0)
	...
	var_1.AddRemoveShip(var_3_6, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10004.REMOVE_SHIP, arg_10_0, arg_10_1)
	...
	local function var_3_7(arg_11_0)
		...
		i18n = var_2_10004
		var_11_2.content = var_2_10004("defense_formation_tip_npc")
	...
	var_2.AddCheckRemove(var_3_8, function(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
		...
		if not arg_12_3:canRemove(arg_12_2) then
			...
			i18n = var_7
			var_2_10008 = "ship_formationUI_removeError_onlyShip"

			local var_12_2 = arg_12_2:getName()
			local var_12_3 = ""

			Fleet = var_2_10011

			var_12_1(var_12_0, var_7(var_2_10008, var_12_2, var_12_3, var_2_10011.C_TEAM_NAME[arg_12_4]))
			arg_12_0()
		...
		if var_12_1.getCount(arg_12_3.mainShips) == 1 then
			...
			if arg_12_4 ~= var_12_5.Main then
				table = var_12_5

				do
					local var_12_5

					if var_12_5.getCount(arg_12_3.vanguardShips) == 1 then
						TeamType = var_12_5

						if arg_12_4 == var_12_5.Vanguard then
							pg = var_12_5

							local var_12_4 = var_12_5.MsgboxMgr.GetInstance()

							var_12_5 = var_12_5.ShowMsgBox

							local var_12_6 = {}

							i18n = var_2_10008
							var_12_6.content = var_2_10008("exercise_clear_fleet_tip")
					...
					local var_12_7 = var_12_5.MsgboxMgr.GetInstance()
					local var_12_8 = var_5.ShowMsgBox
					local var_12_9 = {
						hideNo = false,
						zIndex = -30
					}
					...
					i18n = var_2_10008
					var_12_9.content = var_2_10008("ship_formationUI_quest_remove", arg_12_2:getName())
					var_12_9.onYes = arg_12_1
					var_12_9.onNo = arg_12_0

					var_12_8(var_12_7, var_12_9)
				end
	...
	var_2.AddGridTipClick(var_3_9, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.CHANGE_FLEET_SHIP, nil, arg_14_0)
...
function var_0_1.UpdateFleetView(arg_17_0, arg_17_1)
	...
	var_17_1(var_17_0, var_1_10004.Vanguard)
...
function var_0_1.SetFleetNameLabel(arg_18_0)
	...
	var_1_10001(var_18_0, var_1_10003("exercise_formation_title"))
...
function var_0_1.didEnter(arg_19_0)
	...
	local function var_19_2()
		...
		if arg_19_0._attrFrame.gameObject.activeSelf then
			...
			var_20_2(var_20_1, var_2_10003.COMMIT_FLEET, var_20_0)
		end
	...
	var_1_10001(var_19_3, var_19_4, var_19_5, var_1_10005)
	...
	var_1_10001(var_19_6, var_19_7, var_19_8, var_1_10005)
	...
	var_1_10001(var_19_9, var_19_10, var_19_11, var_1_10005)
...
function var_0_1.resetFormationComponent(arg_25_0)
	...
	for iter_25_0, iter_25_1 in var_1_10002(var_25_0) do
		...
		local var_25_1 = var_8(var_1_10007)

		var_8.SetAsFirstSibling(var_25_1)

		SetActive = var_8

		var_8(var_1_10007:Find("dot_list/" .. iter_25_1.type), true)

		local var_25_2 = var_1_10007:Find("buff_describe")
		local var_25_3 = var_8.GetComponent

		typeof = var_10
		Text = var_11
		var_25_3(var_25_2, var_10(var_11)).text = iter_25_1.describe
	end

	SetActive = var_2

	local var_25_4 = arg_25_0._gridTFs.main[1]
	local var_25_5 = var_3.Find(var_25_4, "flag")
	local var_25_6 = arg_25_0._currentFleetVO
	local var_25_7 = var_4.getTeamByName

	TeamType = iter_25_1

	var_2(var_25_5, #var_25_7(var_25_6, iter_25_1.Main) ~= 0)
...
function var_0_1.displayFleetInfo(arg_28_0)
	...
	local var_28_4 = var_28_3(var_28_2, var_1_10004.Vanguard)
	local var_28_5 = arg_28_0._currentFleetVO
	local var_28_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_28_7 = var_28_6(var_28_5, var_1_10005.Main)
	...
	var_5(var_6.Find(var_28_10, "gear_score"), true)
	...
	for iter_31_0, iter_31_1 in var_4(var_31_1) do
		if #arg_31_0._cards[iter_31_0] == 0 then
			...
			for iter_31_2 = 1, 3 do
				...
				local var_31_5 = var_16.insert
				local var_31_6 = var_9

				FormationCard = var_1_10018

				var_31_5(var_31_6, var_1_10018.New(var_1_10015))
			end
...
function var_0_1.updateAttrFrame(arg_32_0)
		...
		if #arg_32_0._cards[iter_32_0] > 0 then
			for iter_32_2 = 1, 3 do
				if iter_32_2 <= #iter_32_1 then
					...
					local var_32_2 = var_7[iter_32_2]

					var_13.update(var_32_2, var_32_1)

					local var_32_3 = var_7[iter_32_2]

					var_13.updateProps(var_32_3, arg_32_0:getCardAttrProps(var_32_1))
				else
					local var_32_4 = var_7[iter_32_2]

					var_12.update(var_32_4, nil)
				end

				arg_32_0:attachOnCardButton(var_7[iter_32_2], iter_32_0)
			end
		end
	end
	...
	local var_32_6 = var_3.Find

	TeamType = iter_32_0

	var_2(var_32_6(var_32_5, iter_32_0.Submarine), false)
...
function var_0_1.getCardAttrProps(arg_34_0, arg_34_1)
	...
	tostring = var_7
	math = var_8
	var_34_4[2] = var_7(var_8.floor(var_34_0.durability))
	var_34_3[1] = var_34_4
	...
	tostring = var_8
	math = var_9
	var_34_5[2] = var_34_6 .. var_8(var_9.floor(var_34_2))
	var_34_3[2] = var_34_5
...
function var_0_1.attachOnCardButton(arg_35_0, arg_35_1, arg_35_2)
	...
	var_35_0:AddPointClickFunc(function(arg_36_0, arg_36_1)
		if not arg_35_0.carddrag and arg_36_0 == arg_35_1.go then
			...
			if arg_35_1.shipVO then
				...
				var_36_1(var_36_0, var_2_10004.OPEN_SHIP_INFO, arg_35_1.shipVO.id, arg_35_0._currentFleetVO, var_0_1.TOGGLE_DETAIL)
			else
				...
				var_36_1(var_36_2, var_2_10004.CHANGE_FLEET_SHIP, arg_35_1.shipVO, arg_35_2)
			end
	...
	if arg_35_1.shipVO then
		...
		var_35_0:AddBeginDragFunc(function()
			...
			var_39_2(var_39_3, var_2(1.1, 1.1, 0), 0.3)
		...
		var_35_0:AddDragFunc(function(arg_40_0, arg_40_1)
			...
			if var_40_2 > var_40_1.realtimeSinceStartup then
				var_35_7 = arg_40_1
		...
		var_35_0:AddDragEndFunc(function(arg_41_0, arg_41_1)
			...
			local var_41_2 = var_41_1(var_3.abs(arg_35_1.tr.anchoredPosition.x - var_35_9[arg_35_0._shiftIndex].x) / 200, 1) * 0.3
			...
			local var_41_5 = var_41_4(var_41_3, var_5.easeOutCubic)
			local var_41_6 = var_3.setOnUpdate

			System = var_5

			local var_41_7 = var_41_6(var_41_5, var_5.Action_float(function(arg_42_0)
			...
			var_41_8(var_41_7, var_5.Action(function()
				var_35_11()
				...
				DefenseFormationMedator = var_3_10002

				var_43_5(var_43_4, var_3_10002.CHANGE_FLEET_SHIPS_ORDER, arg_35_0._currentFleetVO)
				...
				var_43_6(var_43_7, var_2(1, 1, 0), 0.3)
...
function var_0_1.change2ScrPos(arg_44_0, arg_44_1, arg_44_2)
	...
	return (var_44_0.ScreenToLocal(arg_44_1, arg_44_2, var_44_1))
end
...
function var_0_1.tweenNumText(arg_45_0, arg_45_1, arg_45_2)
	...
	local var_45_1 = var_1_10004(arg_45_0)
	local var_45_2 = 0

	math = var_1_10006

	local var_45_3 = var_45_0(var_45_1, var_45_2, var_1_10006.floor(arg_45_1), arg_45_2 or 0.7)
	...
	var_45_4(var_45_3, var_45_2.Action_float(function(arg_46_0)
		...
		var_2_10001(var_46_0, var_2_10003.floor(arg_46_0))
