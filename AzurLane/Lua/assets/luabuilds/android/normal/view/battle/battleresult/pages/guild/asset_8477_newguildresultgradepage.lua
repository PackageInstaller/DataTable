...
function var_0_1.GetGetObjectives(arg_5_0)
	...
	setColorStr = var_5_5
	var_5_9.text = var_5_5(var_5_6, "#FFFFFFFF")
	setColorStr = var_7

	local var_5_10 = arg_5_0
	local var_5_11 = arg_5_0.GetContributionPoint(var_5_10)

	COLOR_YELLOW = var_5_10
	var_5_9.value = var_7(var_5_11, var_5_10)
