...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BattleActivityBossResultLayer"))
...
function var_0_1.rankAnimaFinish(arg_5_0)
	...
	local var_5_2 = var_3("battle_result_total_damage")
	...
	var_5_5(var_5_4, var_5_6, var_5_7, var_1_10005)
	...
	local var_5_10 = var_5_8(var_5_9, var_5_6.Action(function()
		...
		var_6_0(var_1.Find(var_6_1, "jieuan01/tips"), true)
	...
	var_5_9.insert(arg_5_0._delayLeanList, var_5_10.id)
...
function var_0_1.setCondition(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_4 = var_7_3(var_7_2, var_8(var_1_10009))

	setColorStr = var_7_2
	var_7_4.text = var_7_2(arg_7_1, "#FFFFFFFF")
	...
	local var_7_7 = var_7_6(var_7_5, var_9(var_1_10010))

	setColorStr = var_7_5
	var_7_7.text = var_7_5(arg_7_2, arg_7_3)
	...
	if 0 < var_7_8 then
		...
		System = var_1_10011
		var_7_9 = var_7_9(var_7_10, var_1_10011.Action(function()
		...
		var_7_10.insert(arg_7_0._delayLeanList, var_7_9.id)
	else
		setActive = var_7_9
