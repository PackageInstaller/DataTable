...
function var_0_1.showRightBottomPanel(arg_1_0)
	...
	local var_1_3 = var_1_1:Find("statisticsBtn")
	...
	var_1_0(var_1_2, var_1_3, var_1_4, var_6)

	setText = var_1_0

	local var_1_5 = var_1_1
	local var_1_6 = var_1_1.Find(var_1_5, "confirmBtn/Image")

	i18n = var_1_5

	var_1_0(var_1_6, var_1_5("text_confirm"))

	onButton = var_1_0

	local var_1_7 = arg_1_0
	local var_1_8 = var_1_1:Find("confirmBtn")
	...
	var_1_0(var_1_7, var_1_8, var_1_9, var_6)

	setText = var_1_0

	local var_1_10 = var_1_1
	local var_1_11 = var_1_1.Find(var_1_10, "confirmBtn/Image")

	i18n = var_1_10

	var_1_0(var_1_11, var_1_10("text_confirm"))
...
function var_0_1.rankAnimaFinish(arg_6_0)
	...
	local var_6_2 = var_3("battle_result_total_damage")
	local var_6_3 = arg_6_0.contextData.statistics.specificDamage

	COLOR_BLUE = var_1_10005

	var_6_1(var_6_0, var_6_2, var_6_3, var_1_10005)
	...
	COLOR_YELLOW = var_1_10005

	var_6_5(var_6_4, var_6_6, var_6_7, var_1_10005)
	...
	local var_6_10 = var_6_8(var_6_9, var_6_6.Action(function()
		...
		var_7_0(var_1.Find(var_7_1, "jieuan01/tips"), true)
	...
	var_6_9.insert(arg_6_0._delayLeanList, var_6_10.id)
...
function var_0_1.setCondition(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	local var_8_4 = var_8_3(var_8_2, var_8(var_1_10009))

	setColorStr = var_8_2
	var_8_4.text = var_8_2(arg_8_1, "#FFFFFFFF")
	...
	local var_8_7 = var_8_6(var_8_5, var_9(var_1_10010))

	setColorStr = var_8_5
	var_8_7.text = var_8_5(arg_8_2, arg_8_3)
	...
	if 0 < var_8_8 then
		...
		System = var_1_10011
		var_8_9 = var_8_9(var_8_10, var_1_10011.Action(function()
		...
		var_8_10.insert(arg_8_0._delayLeanList, var_8_9.id)
	else
		setActive = var_8_9
...
function var_0_1.showRewardInfo(arg_11_0)
	...
	var_1(var_2.Find(var_11_0, "jieuan01/tips"), false)
	arg_11_0:displayBG()
...
function var_0_1.setPoint(arg_12_0)
	...
	var_2(var_3.Find(var_12_1, "blur_container/activitybossConfirmPanel/playAgain"), false)
...
function var_0_1.displayShips(arg_13_0)
	...
	if #var_13_5 > 6 then
		...
		var_9(var_13_8, var_13_9, var_13_10, var_1_10013)
	end
	...
	for iter_13_4, iter_13_5 in var_13_9(var_13_5) do
		local var_13_13
		...
		if var_13_2[iter_13_5.id] then
			...
			local var_13_15 = var_18.contains

			ShipType = var_1_10019

			local var_13_16 = var_13_15(var_1_10019.SubShipType, var_13_14)
			...
			if 6 < iter_13_4 then
				var_13_17 = arg_13_0._atkContainerNext
				var_13_19 = 7
			else
				var_13_17 = arg_13_0._atkContainer
				var_13_19 = 1
			end

			cloneTplTo = var_22
			var_22.x = var_22(arg_13_0._atkTpl, var_13_17).localPosition.x + (iter_13_4 - var_13_19) * 74
			var_22.y = var_22.y + (iter_13_4 - var_13_19) * 4
			var_1_10019.localPosition = var_22
			findTF = var_23

			local var_13_20 = var_23(var_1_10019, "result/stars")

			findTF = var_24

			local var_13_21 = var_24(var_1_10019, "result/stars/star_tpl")
			local var_13_22 = iter_13_5:getStar()
			local var_13_23 = iter_13_5:getMaxStar()

			while 0 < var_13_23 do
				cloneTplTo = var_13_24

				local var_13_24 = var_13_24(var_13_21, var_13_20)

				SetActive = var_28

				var_28(var_13_24:Find("empty"), var_13_22 < var_13_23)

				SetActive = var_28

				var_28(var_13_24:Find("star"), var_13_23 <= var_13_22)

				var_13_23 = var_13_23 - 1
			end

			local var_13_25 = var_1_10019:Find("result/mask/icon")
			local var_13_26 = var_1_10019:Find("result/type")
			local var_13_27 = var_13_25
			local var_13_28 = var_13_25.GetComponent

			typeof = var_1_10031
			Image = var_1_10032

			local var_13_29 = var_13_28(var_13_27, var_1_10031(var_1_10032))

			LoadSprite = var_13_27
			var_13_29.sprite = var_13_27("herohrzicon/" .. iter_13_5:getPainting())
			...
			local var_13_31 = var_30(var_1_10031, var_1_10032(iter_13_5:getShipType()))

			setImageSprite = var_1_10031

			var_1_10031(var_13_26, var_13_31, true)

			var_1_10032 = arg_13_0

			arg_13_0.setAtkAnima(var_1_10032, var_1_10019, var_13_17, var_13_30, var_13_4, var_13_3 and iter_13_5.id == var_13_3.id, var_13_2[iter_13_5.id].output, var_13_2[iter_13_5.id].kill_count)
			...
			if var_13_3 and iter_13_5.id == var_13_3.id then
				...
				if 1 < var_13_35 then
					...
					var_13_35, var_13_36, var_13_37 = var_13_35(var_13_36, var_13_37, var_13_38, var_13_39, var_41.getCVIntimacy(var_13_40))

					local var_13_41 = var_13_37
					...
					local var_13_44, var_13_45

					var_13_44, var_13_36, var_13_45 = var_13_43(var_13_36, var_13_37.WORD_TYPE_LOSE)

					local var_13_46 = var_13_45

					var_13_34 = var_13_36

					local var_13_47 = var_13_44
				end
			...
			if arg_13_0.shipBuff then
				var_13_49 = arg_13_0.shipBuff[iter_13_5:getGroupId()]
			end
				...
				if arg_13_0.expBuff then
					...
					if not var_36.getConfig(var_13_36, "name") then
						...
						if var_13_49 then
							...
							i18n = var_36
							var_13_48 = var_36("Word_Ship_Exp_Buff")
						end
					end
					...
					if not var_13_16 then
						cloneTplTo = var_13_36
						var_13_36 = var_13_36(arg_13_0._extpl, arg_13_0._expContainer)
						BattleResultShipCard = var_38
						var_13_51 = var_38.New(var_13_36)
						table = var_38

						var_38.insert(arg_13_0._shipResultCardList, var_13_51)

						if var_13_7 then
							var_13_7:ConfigCallback(function()
								local var_16_0 = var_13_51
						...
						local var_13_52 = var_13_36(arg_13_0._extpl, arg_13_0._subExpContainer)

						BattleResultShipCard = var_38
						var_13_51 = var_38.New(var_13_52)
						table = var_38

						var_38.insert(arg_13_0._subShipResultCardList, var_13_51)

						if not var_13_6 then
							arg_13_0._subFirstExpCard = var_13_51
						else
							var_13_6:ConfigCallback(function()
								local var_17_0 = var_13_51
					...
					var_13_51:SetShipVO(iter_13_5, var_13_13, var_1_10032, var_13_48)
				end
			end
		end
	end
