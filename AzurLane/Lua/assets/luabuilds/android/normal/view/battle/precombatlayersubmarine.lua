...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".PreCombatLayer"))
...
function var_0_1.init(arg_1_0)
	...
	var_1_0(var_1_1:Find("gear_score/main"), false)

	SetActive = var_1_0

	var_1_0(var_1_1:Find("gear_score/vanguard"), false)

	SetActive = var_1_0

	var_1_0(var_1_1:Find("gear_score/submarine"), true)

	setActive = var_1_0

	var_1_0(arg_1_0._bgFleet, false)

	setActive = var_1_0

	var_1_0(arg_1_0._bgSub, true)

	BaseFormation = var_1_0
	arg_1_0._formationLogic = var_1_0.New(arg_1_0._tf, arg_1_0._heroContainer, arg_1_0._heroInfo, arg_1_0._gridTFs)
...
function var_0_1.SetFleets(arg_2_0, arg_2_1)
	...
	local var_2_1 = var_2_0(var_1_10003.values(arg_2_1), function(arg_3_0)
...
function var_0_1.UpdateFleetView(arg_7_0, arg_7_1)
	...
	var_7_2(var_7_1, var_1_10004.Submarine, arg_7_0._currentForm ~= var_0_1.FORM_EDIT)
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_2()
		...
		if arg_8_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_9_0, function(arg_10_0)
				...
				i18n = var_3_10004
				var_10_2.content = var_3_10004("battle_preCombatLayer_save_confirm")
				...
				function var_10_2.onYes()
					...
					var_11_1(var_11_0, var_4_10002.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_12_1(var_12_0, var_5_10002("battle_preCombatLayer_save_success"))
						arg_10_0()
				...
				function var_10_2.onNo()
					...
					var_13_1(var_13_0, var_4_10002.ON_ABORT_EDIT)
					arg_10_0()
		...
		var_1(var_9_0, function()
			...
			var_3_10000(var_14_0, var_3_10002(var_3_10003)).interactable = false
			...
			var_14_2(var_14_3, var_3_10003.Action(function()
	...
	local function var_8_5()
		...
		if arg_8_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_1.insert(var_16_0, function(arg_17_0)
				...
				i18n = var_3_10004
				var_17_2.content = var_3_10004("battle_preCombatLayer_save_march")
				...
				function var_17_2.onYes()
					...
					var_18_1(var_18_0, var_4_10002.ON_COMMIT_EDIT, function()
						pg = var_5_10000
						...
						var_19_1(var_19_0, var_5_10002("battle_preCombatLayer_save_success"))
						arg_17_0()
		...
		var_1(var_16_0, function()
			...
			var_20_1(var_20_0, var_3_10002.ON_START, arg_8_0._currentFleetVO.id)
	...
	local function var_8_8()
		...
		if var_0.getNextFleetID(var_21_0) then
			...
			var_21_2(var_21_1, var_2_10003.ON_CHANGE_FLEET, var_0, true)
		end
	...
	local function var_8_11()
		...
		if var_0.getPrevFleetID(var_22_0) then
			...
			var_22_2(var_22_1, var_2_10003.ON_CHANGE_FLEET, var_0, true)
		end
	...
	local function var_8_14()
		if arg_8_0._currentForm == var_0_1.FORM_EDIT then
			...
			var_23_1(var_23_0, var_2_10002.ON_COMMIT_EDIT, function()
				pg = var_3_10000
				...
				var_24_1(var_24_0, var_3_10002("battle_preCombatLayer_save_success"))
...
function var_0_1.displayFleetInfo(arg_28_0)
	...
	local var_28_2 = var_2.GetGearScoreSum

	TeamType = var_1_10004

	local var_28_3 = var_28_0(var_28_2(var_28_1, var_1_10004.Submarine))
	local var_28_4 = arg_28_0._currentFleetVO
	local var_28_5 = var_2.GetCostSum(var_28_4)

	setActive = var_28_4

	var_28_4(arg_28_0._popup, true)
