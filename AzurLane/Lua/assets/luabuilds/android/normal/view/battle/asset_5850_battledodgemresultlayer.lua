...
function var_0_1.didEnter(arg_1_0)
	...
	local var_1_2 = var_4(arg_1_0._conditions, "bg17")

	i18n = var_5

	var_1_10003(var_1_2, var_5("battle_result_targets"))
	...
	Vector3 = var_1_3
	var_1_4.localScale = var_1_3(1.5, 1.5, 0)
	LeanTween = var_1_4
	...
	local var_1_7 = var_1_5(var_1_6, var_6(0.88, 0.88, 1), var_0_1.DURATION_WIN_SCALE)
	local var_1_8 = var_4.setOnComplete

	System = var_6

	var_1_8(var_1_7, var_6.Action(function()
	...
	local var_1_11 = var_1_10(var_1_9, var_6(var_7))

	Color = var_1_9
	var_1_11.color = var_1_9.New(0, 0, 0, 0.5)
...
function var_0_1.rankAnimaFinish(arg_4_0)
	...
	var_4_0(arg_4_0._conditionBGNormal, false)

	SetActive = var_4_0

	var_4_0(arg_4_0._conditionBGContribute, true)
	...
	local var_4_5 = var_1_10005("battle_result_total_score")
	local var_4_6 = var_4_2.score

	COLOR_BLUE = var_1_10007

	var_4_4(var_4_3, var_4_5, var_4_6, var_1_10007)
	...
	COLOR_YELLOW = var_1_10007

	var_4_8(var_4_7, var_4_9, var_4_10, var_1_10007)
	...
	local var_4_13 = var_4_11(var_4_12, var_4_9.Action(function()
		...
		var_5_0(var_1.Find(var_5_1, "jieuan01/tips"), true)
	...
	var_4_12.insert(arg_4_0._delayLeanList, var_4_13.id)
...
function var_0_1.displayBG(arg_6_0)
	...
	local var_6_1 = var_2.moveX

	rtf = var_1_10003

	var_6_1(var_1_10003(arg_6_0._conditions), 1300, var_0_1.DURATION_MOVE)
	...
	var_6_2(var_6_3, var_4(0.6, 0.6, 0), var_0_1.DURATION_MOVE)
	...
	var_6_6(var_6_5, var_4.Action(function()
	...
	var_6_6(var_3.Find(var_6_7, "jieuan01/Bomb"), false)
...
function var_0_1.skip(arg_13_0)
	...
	if var_13_0 == var_1_10002.STATE_REPORTED then
		...
		arg_13_0.displayBG(var_13_1)
	else
		local var_13_2 = arg_13_0._stateFlag

		BattleResultLayer = var_13_1

		if var_13_2 == var_13_1.STATE_DISPLAYED then
			local var_13_3 = arg_13_0
			local var_13_4 = arg_13_0.emit

			BattleResultMediator = var_1_10003

			var_13_4(var_13_3, var_1_10003.ON_BACK_TO_LEVEL_SCENE)
		end
	end
