...
function var_0_1.Execute(arg_2_0)
	...
	if var_2_0 == var_1_10003 then
		...
		arg_2_0.ExitDuelSystem(var_1_10004, var_1)
	...
	if var_2_0 == var_1_10003 then
		...
		arg_2_0.ExitActBossSystem(var_1_10004, var_1)
	...
	if var_2_0 ~= var_1_10003 then
		...
		if var_2_0 == var_1_10003 then
			...
			arg_2_0.ExitRoutineSystem(var_1_10004, var_1)
		...
		if var_2_0 == var_1_10003 then
			...
			arg_2_0.ExitScenarioSystem(var_1_10004, var_1)
		...
		if var_2_0 == var_1_10003 then
			...
			arg_2_0.ExitChallengeSystem(var_1_10004, var_1)
		...
		if var_2_0 ~= var_1_10003 then
			...
			if var_2_0 ~= var_1_10003 then
				...
				if var_2_0 == var_1_10003 then
					...
					arg_2_0.ExitShareBossSystem(var_1_10004, var_1)
				...
				if var_2_0 == var_1_10003 then
					...
					arg_2_0.ExitWorldBossSystem(var_1_10004, var_1)
				...
				if var_2_0 == var_1_10003 then
					...
					arg_2_0.ExitWorldSystem(var_1_10004, var_1)
				...
				if var_2_0 ~= var_1_10003 then
					...
					if var_2_0 ~= var_1_10003 then
						...
						if var_2_0 == var_1_10003 then
							...
							if arg_2_0.CheckBossRushSystem(var_1_10004, var_1) then
								var_1_10004 = arg_2_0

								arg_2_0.ResultRushBossSystem(var_1_10004, var_1)
							end
						else
							...
							if var_2_0 == var_1_10003 then
								...
								arg_2_0.ExitLimitChallengeSystem(var_1_10004, var_1)
							else
								...
								if var_2_0 == var_1_10003 then
									...
									arg_2_0.ExitBossSingleSystem(var_1_10004, var_1)
								else
									...
									if var_2_0 == var_1_10003 then
										...
										arg_2_0.ExitBossSingleVariableSystem(var_1_10004, var_1)
									else
										...
										if var_2_0 == var_1_10003 then
											...
											arg_2_0.ExitRewardPerform(var_1_10004, var_1)
										else
											var_1_10004 = arg_2_0

											arg_2_0.ExitCommonSystem(var_1_10004, var_1)
										end
									end
								end
							end
...
function var_0_1.ExitDuelSystem(arg_3_0, arg_3_1)
	...
	if var_3_1(var_3_0, var_1_10005) then
		local var_3_2 = var_3

		var_3_0 = var_3.getContextByMediator
		ExercisePreCombatMediator = var_1_10006
		var_3_0 = var_3_0(var_3_2, var_1_10006)
		var_1_10006 = var_3

		var_3.removeChild(var_1_10006, var_3_0)
	end

	pg = var_3_0

	local var_3_3 = var_3_0.m02
	local var_3_4 = var_4.sendNotification

	GAME = var_1_10006

	var_3_4(var_3_3, var_1_10006.GO_BACK)
...
function var_0_1.ExitActBossSystem(arg_4_0, arg_4_1)
	...
	local var_4_2, var_4_3 = var_4_1(var_4_0, var_1_10005)

	if var_4_2 then
		var_1_10006 = var_4_3

		var_4_3.removeChild(var_1_10006, var_4_2)
	end

	getProxy = var_1_10005
	ContextProxy = var_1_10006

	local var_4_4 = var_1_10005(var_1_10006)
	local var_4_5 = var_5.getCurrentContext(var_4_4)
	local var_4_6 = var_5.getContextByMediator

	ContinuousOperationMediator = var_1_10007

	if var_4_6(var_4_5, var_1_10007) then
		...
		var_4_8(var_4_7, var_1_10007.GO_BACK)
	end
...
function var_0_1.ExitRoutineSystem(arg_5_0, arg_5_1)
	...
	if var_5_1(var_5_0, var_1_10005) then
		local var_5_2 = var_3

		var_5_0 = var_3.getContextByMediator
		PreCombatMediator = var_1_10006
		var_5_0 = var_5_0(var_5_2, var_1_10006)
		var_1_10006 = var_3

		var_3.removeChild(var_1_10006, var_5_0)
	end
	...
	var_5_4(var_5_3, var_1_10006.GO_BACK)
...
function var_0_1.ExitScenarioSystem(arg_6_0, arg_6_1)
	if not arg_6_1.needHelpMessage then
		...
		if var_6_0 == var_1_10003.Battle.BattleConst.BattleScore.C then
			...
			var_6_0(var_1_10003, var_1_10004.AUTOFIGHT_STOP_REASON.BATTLE_FAILED)
		end
		...
		if var_6_2(var_6_1, var_1_10005) then
			var_1_10005 = var_3
			...
			if var_6_3(var_1_10005, var_1_10006) then
				var_1_10006 = var_3

				var_3.removeChild(var_1_10006, var_4)
			end
		end
		...
		if var_1_10005.Battle.BattleConst.BattleScore.C < var_6_4 then
			var_6_5 = arg_6_0

			arg_6_0.ShowExtraChapterActSocre(var_6_5, arg_6_1)
		end

		getProxy = var_6_4
		ChapterProxy = var_6_5

		local var_6_6 = var_6_4(var_6_5)

		var_4.WriteBackOnExitBattleResult(var_6_6)

		pg = var_4

		local var_6_7 = var_4.m02
		local var_6_8 = var_4.sendNotification

		GAME = var_1_10006

		var_6_8(var_6_7, var_1_10006.GO_BACK)
...
function var_0_1.ExitChallengeSystem(arg_7_0, arg_7_1)
	...
	if not arg_7_1.goToNext then
		...
		ChallengeMainMediator = var_5

		if var_7_2(var_7_1, var_5) then
			local var_7_3 = var_3

			var_7_1 = var_3.getContextByMediator
			ChallengePreCombatMediator = var_1_10006
			var_7_1 = var_7_1(var_7_3, var_1_10006)

			var_3:removeChild(var_7_1)
		end
	end

	pg = var_2

	local var_7_4 = var_2.m02
	local var_7_5 = var_2.sendNotification

	GAME = var_7_1

	var_7_5(var_7_4, var_7_1.GO_BACK)
...
function var_0_1.ExitShareBossSystem(arg_8_0, arg_8_1)
	...
	local var_8_2, var_8_3 = var_8_1(var_8_0, var_1_10005)
	...
	local var_8_4 = var_1_10005.m02
	local var_8_5 = var_5.sendNotification

	GAME = var_1_10007

	var_8_5(var_8_4, var_1_10007.GO_BACK)
...
function var_0_1.ExitWorldBossSystem(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_9_1(var_9_0, var_1_10005)
	local var_9_3 = var_3.getContextByMediator

	WorldBossFormationMediator = var_1_10006

	if var_9_3(var_9_2, var_1_10006) and not arg_9_1.isSimulate then
		var_3:removeChild(var_4)
	end

	pg = var_9_2

	local var_9_4 = var_9_2.m02
	local var_9_5 = var_5.sendNotification

	GAME = var_1_10007

	var_9_5(var_9_4, var_1_10007.WORLD_BOSS_BATTLE_QUIT, {
		id = arg_9_1.bossId
	})
...
function var_0_1.ExitWorldSystem(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10005)
	local var_10_3 = var_3.getContextByMediator

	WorldPreCombatMediator = var_1_10006

	local var_10_4

	if not var_10_3(var_10_2, var_1_10006) then
		var_10_2 = var_3
		var_10_4 = var_3.getContextByMediator
		WorldBossInformationMediator = var_1_10006
		var_10_4 = var_10_4(var_10_2, var_1_10006)
	end

	if var_10_4 then
		var_3:removeChild(var_10_4)
	end

	pg = var_10_2

	local var_10_5 = var_10_2.m02
	local var_10_6 = var_5.sendNotification

	GAME = var_1_10007

	var_10_6(var_10_5, var_1_10007.GO_BACK)
...
function var_0_1.ResultRushBossSystem(arg_11_0, arg_11_1)
	...
	BossRushPreCombatMediator = var_1_10005

	local var_11_2, var_11_3 = var_11_1(var_11_0, var_1_10005)
	...
	BossRushFleetSelectMediator = var_1_10007

	local var_11_6, var_11_7 = var_11_5(var_11_4, var_1_10007)

	if var_11_6 then
		var_1_10008 = var_11_7

		var_11_7.removeChild(var_1_10008, var_11_6)
	end
	...
	if not (var_1_10008.Battle.BattleConst.BattleScore.C < var_11_8) then
		...
		if var_11_9 == var_1_10009 then
			...
			BattleFailTipMediator = var_1_10012
			var_11_11.mediator = var_1_10012
			BattleFailTipLayer = var_1_10012
			var_11_11.viewComponent = var_1_10012
			var_11_11.data = {
			...
			function var_11_11.onRemoved()
				...
				var_12_1(var_12_0, var_2_10002.GO_BACK)

				return
			end

			var_11_9(var_11_10, var_1_10010(var_11_11))
	...
	var_11_13(var_11_12, var_1_10010.BOSSRUSH_SETTLE, {
...
function var_0_1.ExitRushBossSystem(arg_13_0, arg_13_1, arg_13_2)
	...
	var_13_8(var_13_7, var_1_10011.New({
		mediator = var_13_5,
...
function var_0_1.ExitLimitChallengeSystem(arg_14_0, arg_14_1)
	...
	LimitChallengeMediator = var_1_10005

	if var_14_1(var_14_0, var_1_10005) then
		local var_14_2 = var_3

		var_14_0 = var_3.getContextByMediator
		LimitChallengePreCombatMediator = var_1_10006

		if var_14_0(var_14_2, var_1_10006) then
			var_1_10006 = var_3

			var_3.removeChild(var_1_10006, var_14_0)
		end
	end

	pg = var_14_0

	local var_14_3 = var_14_0.m02
	local var_14_4 = var_4.sendNotification

	GAME = var_1_10006

	var_14_4(var_14_3, var_1_10006.GO_BACK)
...
function var_0_1.ExitBossSingleSystem(arg_15_0, arg_15_1)
	...
	BossSinglePreCombatMediator = var_1_10005

	local var_15_2, var_15_3 = var_15_1(var_15_0, var_1_10005)

	if var_15_2 then
		var_1_10006 = var_15_3
		var_1_10005 = var_15_3.removeChild(var_1_10006, var_15_2)
	end

	getProxy = var_1_10005
	ContextProxy = var_1_10006

	local var_15_4 = var_1_10005(var_1_10006)
	local var_15_5 = var_5.getCurrentContext(var_15_4)
	local var_15_6 = var_5.getContextByMediator

	BossSingleContinuousOperationMediator = var_1_10007
	...
	if var_15_6(var_15_5, var_1_10007) then
		...
		var_15_8(var_15_7, var_1_10007.GO_BACK)
	end
...
function var_0_1.ExitBossSingleVariableSystem(arg_16_0, arg_16_1)
	...
	local var_16_2, var_16_3 = var_16_1(var_16_0, var_1_10005)

	if var_16_2 then
		var_1_10006 = var_16_3
		var_1_10005 = var_16_3.removeChild(var_1_10006, var_16_2)
	end

	getProxy = var_1_10005
	ContextProxy = var_1_10006

	local var_16_4 = var_1_10005(var_1_10006)
	local var_16_5 = var_5.getCurrentContext(var_16_4)
	local var_16_6 = var_5.getContextByMediator

	BossSingleContinuousOperationMediator = var_1_10007

	if var_16_6(var_16_5, var_1_10007) then
		...
		var_16_8(var_16_7, var_1_10007.GO_BACK)
	end
...
function var_0_1.ExitRewardPerform(arg_17_0, arg_17_1)
	...
	BossSinglePreCombatLiteMediator = var_1_10005

	local var_17_2, var_17_3 = var_17_1(var_17_0, var_1_10005)

	if var_17_2 then
		var_1_10005 = var_17_3:removeChild(var_17_2)
	end

	pg = var_1_10005

	local var_17_4 = var_1_10005.m02
	local var_17_5 = var_5.sendNotification

	GAME = var_1_10007

	var_17_5(var_17_4, var_1_10007.GO_BACK)
...
function var_0_1.ExitCommonSystem(arg_18_0, arg_18_1)
	...
	if var_18_1(var_18_0, var_1_10005) then
		local var_18_2 = var_3

		var_18_0 = var_3.getContextByMediator
		PreCombatMediator = var_1_10006

		if var_18_0(var_18_2, var_1_10006) then
			var_1_10006 = var_3

			var_3.removeChild(var_1_10006, var_18_0)
		end
	end

	pg = var_18_0

	local var_18_3 = var_18_0.m02
	local var_18_4 = var_4.sendNotification

	GAME = var_1_10006

	var_18_4(var_18_3, var_1_10006.GO_BACK)
...
local function var_0_2()
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10003.ACTIVITY_TYPE_EXTRA_CHAPTER_RANK)
	local var_19_3 = {}
...
function var_0_1.ShowExtraChapterActSocre(arg_20_0, arg_20_1)
	...
	local var_20_0 = var_1_10002(var_1_10003)
	local var_20_1 = var_2.getActiveChapter(var_20_0)
	local var_20_2 = var_0_2()

	ipairs = var_1_10005

	for iter_20_0, iter_20_1 in var_1_10005(var_20_2) do
		...
		if var_20_3[1] == var_20_4 and var_20_1:IsEXChapter() then
			...
			ActivityLevelConst = var_20_7

			local var_20_9, var_20_10 = var_20_7.getExtraChapterSocre(var_20_4, var_20_5, var_20_8, iter_20_1)
			...
			if var_20_10 < var_20_9 then
				...
				i18n = var_1_10020
				var_20_15.content = var_1_10020("extra_chapter_socre_tip", var_20_9, var_20_10, var_20_11)
...
local function var_0_3(arg_21_0)
	...
	local var_21_3 = var_21_1.activity_event_worldboss[var_21_2]
	local var_21_4 = var_1
	local var_21_5 = var_1.IsOilLimit(var_21_4, arg_21_0.stageId)

	getProxy = var_21_4
	FleetProxy = var_6

	local var_21_6 = var_21_4(var_6)
	local var_21_7 = var_5.getActivityFleets(var_21_6)[arg_21_0.actId]
	local var_21_8 = 0
	local var_21_9 = var_21_3.use_oil_limit[arg_21_0.mainFleetId]
	...
	local function var_21_10(arg_22_0, arg_22_1)
		...
		var_21_8 = var_21_8 + var_22_0

		return
	end

	local var_21_11 = var_21_7[arg_21_0.mainFleetId]
	local var_21_12

	if not var_21_5 or not var_21_9[1] then
		var_21_12 = 0
	end

	var_21_10(var_21_11, var_21_12)

	local var_21_13 = var_9
	local var_21_14 = var_21_7[arg_21_0.mainFleetId + 10]
	local var_21_15

	if not var_21_5 or not var_21_9[2] then
		var_21_15 = 0
	end
...
local function var_0_4(arg_23_0, arg_23_1)
	...
	if not var_23_2(var_23_1, var_1_10004) or not var_2.data.autoFlag then
		var_23_3 = nil
	end
	...
	local var_23_4 = var_1_10004(var_1_10005)
	local var_23_5 = var_4.PopActBossRewards(var_23_4)

	LoadContextCommand = var_23_4

	local var_23_6 = var_23_4.LoadLayerOnTopContext

	Context = var_1_10006

	local var_23_7 = var_1_10006.New
	local var_23_8 = {}

	ActivityBossTotalRewardPanelMediator = var_1_10008
	var_23_8.mediator = var_1_10008
	ActivityBossTotalRewardPanel = var_1_10008
	var_23_8.viewComponent = var_1_10008
	var_23_8.data = {
		onClose = function()
			pg = var_2_10000
			...
			var_24_1(var_24_0, var_2_10002.GO_BACK)
...
local function var_0_5(arg_25_0, arg_25_1)
	...
	local var_25_0 = var_1_10002(var_1_10003)
	...
	if not var_25_2(var_25_1, var_1_10004) or not var_2.data.autoFlag then
		var_25_3 = nil
	end
	...
	local var_25_4 = var_1_10004(var_1_10005)
	local var_25_5 = var_4.PopBossSingleRewards(var_25_4)

	LoadContextCommand = var_25_4

	local var_25_6 = var_25_4.LoadLayerOnTopContext

	Context = var_1_10006

	local var_25_7 = var_1_10006.New
	local var_25_8 = {}

	BossSingleTotalRewardPanelMediator = var_1_10008
	var_25_8.mediator = var_1_10008
	BossSingleTotalRewardPanel = var_1_10008
	var_25_8.viewComponent = var_1_10008
	var_25_8.data = {
		onConfirm = function()
			pg = var_2_10000
			...
			var_26_1(var_26_0, var_2_10002.GO_BACK)
		...
		onClose = function()
			...
			if var_27_1(var_27_0, var_2_10002) then
				var_0.cleanChild = true
				warning = var_27_0

				var_27_0("ClueMapMediator")
			end

			getProxy = var_27_0
			ContextProxy = var_2_10002

			local var_27_2 = var_27_0(var_2_10002)
			local var_27_3 = var_1.getContextByMediator

			BossSinglePreCombatMediator = var_2_10003

			if var_27_3(var_27_2, var_2_10003) then
				var_0.skipBack = true
				warning = var_1
...
local function var_0_6()
	...
	if var_0.GetShouldShowBattleTip(var_28_0) then
		...
		var_28_2 = var_1.getRawData(var_28_1) and var_1:getWeeklyTask()
...
function var_0_1.CheckActBossSystem(arg_30_0, arg_30_1)
	...
	var_30_1(var_30_0, var_1_10004.CONTINUE_OPERATION)
	...
	local var_30_7 = var_30_5(var_30_3)
	local var_30_8 = var_3.getRawData(var_30_7)
	local var_30_9

	if var_3.getMaxShipBag(var_30_8) <= var_30_6 then
		var_30_6 = var_0_4
		var_30_9 = arg_30_1
		i18n = var_30_8

		var_30_6(var_30_9, var_30_8("multiple_sorties_stop_reason3"))
	...
	local var_30_10 = var_30_6(var_30_9)
	local var_30_11 = var_2.getActivityFleets(var_30_10)[arg_30_1.actId][arg_30_1.mainFleetId]

	_ = var_1_10005

	local var_30_12 = var_1_10005.map

	_ = var_1_10006

	local var_30_13 = #var_30_12(var_1_10006.values(var_30_11.ships), function(arg_31_0)
		getProxy = var_2_10001
		BayProxy = var_2_10002

		local var_31_0 = var_2_10001(var_2_10002)
		...
		if var_1.getShipById(var_31_0, arg_31_0) then
			...
			if var_31_1 == var_3.ENERGY_LOW then
				return var_1
			end
		end
	...
	if 0 < var_30_13 then
		...
		local var_30_14 = var_30_13.DEFAULT_NAME_BOSS_ACT[arg_30_1.mainFleetId]

		_ = var_30_15
		var_30_15 = var_30_15.map(var_5, function(arg_32_0)
			return "「" .. arg_32_0:getConfig("name") .. "」"
		end)
		var_1_10008 = var_0_4
		var_1_10009 = arg_30_1
		i18n = var_1_10010
		...
		var_1_10008(var_1_10009, var_1_10010(var_30_16, var_30_17, var_1_10013.concat(var_30_15, "")))
	...
	if var_30_18 <= var_30_15.Battle.BattleConst.BattleScore.C then
		local var_30_19 = var_0_4

		var_30_20 = arg_30_1
		i18n = var_1_10008

		var_30_19(var_30_20, var_1_10008("multiple_sorties_stop_reason4"))
	...
	getProxy = var_6
	ContextProxy = var_30_20

	local var_30_21 = var_6(var_30_20)

	getProxy = var_30_20
	ContextProxy = var_1_10008

	local var_30_22 = var_30_20(var_1_10008)
	local var_30_23 = var_7.getCurrentContext(var_30_22)
	local var_30_24 = var_7.getContextByMediator

	ContinuousOperationMediator = var_1_10009

	if var_30_24(var_30_23, var_1_10009) and not var_7.data.autoFlag then
		var_0_4(arg_30_1)
	...
	local var_30_25 = var_8.m02
	local var_30_26 = var_8.sendNotification

	NewBattleResultMediator = var_1_10010

	var_30_26(var_30_25, var_1_10010.ON_COMPLETE_BATTLE_RESULT)
...
function var_0_1.ContinuousBossRush(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5, arg_33_6)
	...
	var_33_1(var_33_0, var_1_10009.BEGIN_STAGE, {
		system = arg_33_1,
		actId = arg_33_2,
...
function var_0_1.CheckBossRushSystem(arg_34_0, arg_34_1)
	...
	local var_34_0 = var_1_10002(var_1_10003)
	...
	local var_34_4 = var_1_10005(var_1_10006)
	...
	ContinuousOperationMediator = var_1_10011

	if var_34_10(var_34_9, var_1_10011) then
		var_0_6()
	end
	...
	local var_34_13 = not var_34_12(var_34_11, var_1_10011) or var_9.data.autoFlag
...
local function var_0_7(arg_35_0)
	...
	local var_35_4 = var_35_2(var_1_10005)
	...
	local var_35_10 = var_1
	local var_35_11 = var_1.getConfig(var_35_10, "type")

	ActivityConst = var_35_10

	if var_35_11 == var_35_10.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE then
		Fleet = var_35_11

		local var_35_12

		if not var_35_11.MEGA_SUBMARINE_FLEET_OFFSET then
			var_35_12 = 10
		end

		local var_35_13 = var_7
		local var_35_14 = var_35_5[arg_35_0.mainFleetId + var_35_12]
		local var_35_15
...
function var_0_1.CheckBossSingleSystem(arg_37_0, arg_37_1)
	...
	var_37_1(var_37_0, var_1_10004.CONTINUE_OPERATION)
	...
	local var_37_7 = var_37_5(var_37_3)
	local var_37_8 = var_3.getRawData(var_37_7)
	local var_37_9

	if var_3.getMaxShipBag(var_37_8) <= var_37_6 then
		var_37_6 = var_0_5
		var_37_9 = arg_37_1
		i18n = var_37_8

		var_37_6(var_37_9, var_37_8("multiple_sorties_stop_reason3"))
	...
	local var_37_10 = var_37_6(var_37_9)
	local var_37_11 = var_2.getActivityFleets(var_37_10)[arg_37_1.actId][arg_37_1.mainFleetId]

	_ = var_1_10005

	local var_37_12 = var_1_10005.map

	_ = var_1_10006

	local var_37_13 = #var_37_12(var_1_10006.values(var_37_11.ships), function(arg_38_0)
		getProxy = var_2_10001
		BayProxy = var_2_10002
		...
		if var_1.getShipById(var_38_0, arg_38_0) then
			...
			if var_38_1 == var_3.ENERGY_LOW then
				return var_1
			end
		end
	...
	if 0 < var_37_13 then
		...
		local var_37_14 = var_37_13.DEFAULT_NAME_BOSS_ACT[arg_37_1.mainFleetId]

		_ = var_37_15
		var_37_15 = var_37_15.map(var_5, function(arg_39_0)
			return "「" .. arg_39_0:getConfig("name") .. "」"
		end)
		var_1_10008 = var_0_5
		var_1_10009 = arg_37_1
		i18n = var_1_10010

		local var_37_16 = "multiple_sorties_stop_reason2"
		local var_37_17 = var_37_14

		table = var_1_10013

		var_1_10008(var_1_10009, var_1_10010(var_37_16, var_37_17, var_1_10013.concat(var_37_15, "")))
	...
	if var_37_18 <= var_37_15.Battle.BattleConst.BattleScore.C then
		local var_37_19 = var_0_5

		var_37_20 = arg_37_1
		i18n = var_1_10008

		var_37_19(var_37_20, var_1_10008("multiple_sorties_stop_reason4"))
	...
	getProxy = var_6
	ContextProxy = var_37_20

	local var_37_21 = var_6(var_37_20)

	getProxy = var_37_20
	ContextProxy = var_1_10008

	local var_37_22 = var_37_20(var_1_10008)
	local var_37_23 = var_7.getCurrentContext(var_37_22)
	local var_37_24 = var_7.getContextByMediator

	BossSingleContinuousOperationMediator = var_1_10009

	if var_37_24(var_37_23, var_1_10009) and not var_7.data.autoFlag then
		var_0_5(arg_37_1)
	...
	local var_37_25 = var_8.m02
	local var_37_26 = var_8.sendNotification

	NewBattleResultMediator = var_1_10010

	var_37_26(var_37_25, var_1_10010.ON_COMPLETE_BATTLE_RESULT)
...
local function var_0_8(arg_40_0, arg_40_1)
	...
	local var_40_3 = var_40_1.activity_event_worldboss[var_40_2].ticket

	getProxy = var_1_10006
	PlayerProxy = var_1_10007

	local var_40_4 = var_1_10006(var_1_10007)
	local var_40_5 = var_6.getRawData(var_40_4)
	local var_40_6 = var_6.getResource(var_40_5, var_40_3)
	local var_40_7 = var_2

	if var_2.GetStageBonus(var_40_7, arg_40_1) == 0 then
		getProxy = var_40_7
		SettingsProxy = var_9

		local var_40_8 = var_40_7(var_9)

		if var_8.isTipActBossExchangeTicket(var_40_8) == 1 and var_40_6 > 0 then
			return true
		end
	end
...
local function var_0_9(arg_41_0)
	...
	var_41_1(var_41_0, var_1_10003.BEGIN_STAGE, {
...
function var_0_1.handleNotification(arg_43_0, arg_43_1)
	...
	if var_43_0 == var_43_1.BOSSRUSH_SETTLE_DONE then
		...
		if var_43_0 == var_4.ON_REENTER then
			...
			if var_0_8(arg_43_0.contextData.actId, arg_43_0.contextData.stageId) then
				...
				var_43_4(var_43_3, var_6.ACT_BOSS_EXCHANGE_TICKET, {
			...
			if var_43_0 == var_43_4.ON_REENTER then
				if not var_43_2.autoFlag then
...
function var_0_1.addSubLayers(arg_44_0, arg_44_1, arg_44_2, arg_44_3)
	...
	var_1_10004(var_1_10005(var_44_0, var_1_10007), "should be an instance of Context")

	getProxy = var_1_10004
	ContextProxy = var_5

	local var_44_1 = var_1_10004(var_5)
	...
	local var_44_4 = var_44_3(var_44_2, var_1_10008)
	...
	var_44_6(var_44_5, var_1_10009.LOAD_LAYERS, {
