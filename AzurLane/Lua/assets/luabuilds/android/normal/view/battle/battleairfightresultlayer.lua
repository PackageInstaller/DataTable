...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_10, var_2_9("text_confirm"))
...
function var_0_1.setGradeLabel(arg_4_0)
	...
	var_1_10009(var_10.Find(var_4_10, "jieuan01/BG/bg_victory"), var_4_9)

	setActive = var_1_10009

	local var_4_11 = arg_4_0._bg

	var_1_10009(var_10.Find(var_4_11, "jieuan01/BG/bg_fail"), not var_4_9)
...
function var_0_1.didEnter(arg_5_0)
	...
	Vector3 = var_5_0
	var_5_1.localScale = var_5_0(1.5, 1.5, 0)
	LeanTween = var_5_1
	...
	local var_5_4 = var_5_2(var_5_3, var_4(0.88, 0.88, 1), var_0_1.DURATION_WIN_SCALE)
	...
	local var_5_8 = var_5_7(var_5_6, var_4(var_5))

	Color = var_5_6
	var_5_8.color = var_5_6.New(0, 0, 0, 0.5)
	...
	var_2(var_5_9, var_5_10, var_5_11, var_6)
...
function var_0_1.rankAnimaFinish(arg_8_0)
	...
	local var_8_5 = var_1_10005("fighterplane_destroy_tip") .. var_8_2.kill
	local var_8_6 = var_8_2.score

	COLOR_BLUE = var_1_10007

	var_8_4(var_8_3, var_8_5, var_8_6, var_1_10007)
	...
	var_8_8(var_8_7, var_8_9, var_8_10, var_1_10007)
	...
	var_8_12(var_8_11, var_8_13, var_8_14, var_1_10007)
	...
	local var_8_17 = var_8_15(var_8_16, var_8_13.Action(function()
		...
		var_9_0(var_1.Find(var_9_1, "jieuan01/tips"), true)
	...
	var_8_16.insert(arg_8_0._delayLeanList, var_8_17.id)
...
function var_0_1.setCondition(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_4 = var_10_3(var_10_2, var_8(var_1_10009))

	setColorStr = var_10_2
	var_10_4.text = var_10_2(arg_10_1, "#FFFFFFFF")
	...
	local var_10_7 = var_10_6(var_10_5, var_9(var_1_10010))

	setColorStr = var_10_5
	var_10_7.text = var_10_5(arg_10_2, arg_10_3)
	...
	if 0 < var_10_8 then
		...
		System = var_1_10011
		var_10_9 = var_10_9(var_10_10, var_1_10011.Action(function()
			setActive = var_2_10000
		...
		var_10_10.insert(arg_10_0._delayLeanList, var_10_9.id)
	else
		setActive = var_10_9
...
function var_0_1.displayBG(arg_12_0)
	...
	local var_12_1 = var_2.moveX

	rtf = var_1_10003

	var_12_1(var_1_10003(arg_12_0._conditions), 1300, var_0_1.DURATION_MOVE)
	...
	var_12_2(var_12_3, var_4(0.6, 0.6, 0), var_0_1.DURATION_MOVE)
	...
	var_12_6(var_12_5, var_4.Action(function()
	...
	var_12_6(var_3.Find(var_12_7, "jieuan01/Bomb"), false)
...
function var_0_1.showPainting(arg_14_0)
	...
	var_1(arg_14_0._painting, arg_14_0.paintingName, "jiesuan", function()
		...
		local var_15_0 = var_2_10000(arg_14_0._painting, "fitter").childCount

		if 0 < var_15_0 then
			ShipExpressionHelper = var_15_0

			local var_15_1 = var_15_0.SetExpression

			findTF = var_1

			local var_15_2 = var_1(arg_14_0._painting, "fitter")

			var_15_1(var_1.GetChild(var_15_2, 0), arg_14_0.paintingName, "win_mvp")
		end
	...
	if 1 < var_14_0 then
		...
		var_5(var_6.Find(var_14_4, "Text"), var_14_3)
		...
		local var_14_8 = #var_14_7(var_14_6, var_7(var_8)).text

		CHAT_POP_STR_LEN = var_7

		if var_7 < var_14_8 then
			TextAnchor = var_14_8
		...
		Vector3 = var_7
		var_14_9.localScale = var_7.New(0, 0, 0)
		LeanTween = var_14_9
		...
		local var_14_11 = var_14_10(var_7(arg_14_0._painting), 50, 0.1)
		local var_14_12 = var_6.setOnComplete

		System = var_8

		var_14_12(var_14_11, var_8.Action(function()
			...
			local var_16_1 = var_2_10001(arg_14_0._chat.gameObject)

			Vector3 = var_2

			local var_16_2 = var_16_0(var_16_1, var_2.New(1, 1, 1), 0.1)
			local var_16_3 = var_0.setEase

			LeanTweenType = var_2

			var_16_3(var_16_2, var_2.easeOutBack)
...
function var_0_1.skip(arg_17_0)
	...
	if var_17_0 == var_1_10002.STATE_REPORTED then
		...
		var_17_2(var_17_1, var_1_10003.ON_BACK_TO_LEVEL_SCENE)
	end
...
function var_0_1.showRightBottomPanel(arg_18_0)
	...
	local function var_18_2()
		...
		var_19_1(var_19_0, var_2_10002.ON_BACK_TO_LEVEL_SCENE)
...
function var_0_1.willExit(arg_21_0)
	...
	var_21_0(var_1_10002(arg_21_0._tf))
