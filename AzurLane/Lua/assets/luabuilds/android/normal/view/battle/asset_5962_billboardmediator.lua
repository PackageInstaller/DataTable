...
function var_0_1.register(arg_1_0)
	...
	if not arg_1_0.contextData.act_id then
		...
		var_1_2 = var_1_2(var_1_10004:getActivityByRankType(var_1_1), {
			"id"
		})
	end
	...
	arg_1_0:bind(var_0_1.FETCH_RANKS, function(arg_2_0, arg_2_1, arg_2_2)
		...
		if var_3.canFetch(var_2_0, arg_2_1, arg_2_2) then
			...
			var_2_2(var_2_1, var_5.GET_POWERRANK, {
				type = arg_2_1,
				activityId = arg_2_2
			})
		else
	...
	arg_1_0:bind(var_0_1.OPEN_RIVAL_INFO, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.GET_RIVAL_INFO, arg_3_1)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.GET_POWERRANK_DONE then
		...
		if var_5_0 == var_4.GET_RIVAL_INFO_DONE then
			local var_5_5 = arg_5_0
			local var_5_6 = arg_5_0.addSubLayers

			Context = var_1_10006

			local var_5_7 = var_1_10006.New
			local var_5_8 = {}

			RivalInfoLayer = var_1_10008
			var_5_8.viewComponent = var_1_10008
			RivalInfoMediator = var_1_10008
			var_5_8.mediator = var_1_10008

			local var_5_9 = {
				rival = var_5_2.rival
			}

			RivalInfoLayer = var_9
			var_5_9.type = var_9.TYPE_DISPLAY
