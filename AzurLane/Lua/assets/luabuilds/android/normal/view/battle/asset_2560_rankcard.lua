...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Image = var_1_10006
	arg_1_0.frameBgTF = var_1_1(var_1_0, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.numberTF = var_1_5(var_1_4, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.scoreTF = var_1_7(var_1_6, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Image = var_1_10006
	arg_1_0.scoreIconTF = var_1_9(var_1_8, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.levelTxt = var_1_11(var_1_10, var_5(var_1_10006))
...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_2_2 < 4 then
		...
		var_5(var_2_4, var_7("billboardframe", "bgn" .. var_2_2), true)
	end
	...
	var_5(var_2_5, var_7("billboardframe", "bg" .. var_2_2))

	local var_2_6 = var_0_1[var_2_2]
	local var_2_7 = arg_2_0.frameBgTF

	Color = var_7
	var_2_7.color = var_7.New(var_2_6[1], var_2_6[2], var_2_6[3])
	...
	if arg_2_0._type == var_0_0.TYPE_OTHER then
		...
		setColorStr = var_7
		var_2_8.text = var_7(arg_2_1:getPowerTxt(), var_0_0.COLORS[var_2_2])
	...
	local var_2_10 = var_2_8.getScoreIcon(var_2_9, arg_2_1.type)

	setActive = var_2_9

	var_2_9(arg_2_0.scoreIconTF, var_2_10)

	local var_2_14

	if var_2_10 then
		var_2_9 = arg_2_1.type
		PowerRank = var_8

		local var_2_12

		if var_2_9 == var_8.TYPE_PT then
			if arg_2_2 then
				getProxy = var_2_9
				ActivityProxy = var_8

				local var_2_11 = var_2_9(var_8)

				var_2_12 = var_2_9.getActivityById(var_2_11, arg_2_2)

				local var_2_13 = var_2_9.getConfig(var_2_12, "config_id")

				Drop = var_2_12
				var_2_12 = var_2_12.New
				var_2_14 = {}
				DROP_TYPE_RESOURCE = var_1_10011
				var_2_14.type = var_1_10011
				var_2_14.id = var_2_13
				var_2_14 = var_2_12(var_2_14)
				var_2_12 = var_2_12.getIcon(var_2_14)
				setImageSprite = var_2_14

				local var_2_15 = arg_2_0.scoreIconTF

				LoadSprite = var_1_10012

				var_2_14(var_2_15, var_1_10012(var_2_12))
			end
		else
			setImageSprite = var_2_9

			local var_2_16 = arg_2_0.scoreIconTF

			GetSpriteFromAtlas = var_2_12

			var_2_9(var_2_16, var_2_12(var_2_10[1], var_2_10[2]), true)
		end
	end

	LoadImageSpriteAsync = var_2_9

	var_2_9("emblem/" .. arg_2_1.arenaRank, arg_2_0.emblemTF)

	go = var_2_9

	if not var_2_9(arg_2_0.emblemTF).activeSelf then
		setActive = var_7
	...
	local var_2_17 = arg_2_0.iconTF
	local var_2_18 = {}

	DROP_TYPE_SHIP = var_2_14
	var_2_18.type = var_2_14
	var_2_18.id = arg_2_1.icon
	var_2_18.skinId = arg_2_1.skinId
	var_2_18.remoulded = arg_2_1.remoulded
	var_2_18.propose = arg_2_1.proposeTime

	var_7(var_2_17, var_2_18)
