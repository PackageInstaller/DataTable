...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.gradeTxtCG = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	CanvasGroup = var_1_10004
	arg_2_0.gradeChapterNameCG = var_2_9(var_2_8, var_3(var_1_10004))
	...
	Vector3 = var_2_11
	var_2_12.localPosition = var_2_11(2000, arg_2_0.objectiveContainer.localPosition.y, 0)
	setText = var_2_12

	local var_2_13 = arg_2_0.bgTr
	local var_2_14 = var_2.Find(var_2_13, "conditions/Text")

	i18n = var_2_13

	var_2_12(var_2_14, var_2_13("battle_result_targets"))
...
function var_0_1.RegisterEvent(arg_10_0, arg_10_1)
	...
	var_2(var_10_0, var_10_1, var_10_2, var_1_10006)
...
local function var_0_2(arg_12_0, arg_12_1)
	...
	local var_12_6 = var_12_5(var_12_4, var_7(var_1_10008))

	setActive = var_12_4

	var_12_4(var_12_6.gameObject, var_12_1)

	if var_12_1 then
		GetSpriteFromAtlas = var_12_4
		var_12_6.sprite = var_12_4("ui/battleresult_atlas", var_12_1)
	...
	var_12_4(var_7.Find(var_12_7, "text"), var_12_0)

	setText = var_12_4

	local var_12_8 = arg_12_0.transform

	var_12_4(var_7.Find(var_12_8, "value"), var_12_2)

	setActive = var_12_4

	var_12_4(arg_12_0:Find("fx"), true)
...
function var_0_1.UpdateObjectives(arg_14_0, arg_14_1)
	...
	var_14_3(var_14_2, var_7.Action_float(function(arg_16_0)
...
function var_0_1.UpdateChapterName(arg_17_0)
	...
	var_2(arg_17_0.gradeChapterName, var_17_0)
...
function var_0_1.LoadEffects(arg_18_0, arg_18_1)
	...
	var_1_10002("BattleResultItems/ResultEffect", "", nil, function(arg_19_0)
		if not arg_18_0.exited then
			...
			local var_19_2 = var_3.Find(var_19_1, "Tips/dianjijixu/bg20")

			i18n = var_19_1

			var_2(var_19_2, var_19_1("battle_result_continue"))
...
function var_0_1.PlayEnterAnimation(arg_20_0, arg_20_1)
	...
	local var_20_6 = var_20_5(var_20_4, var_4.Action_float(function(arg_22_0)
	...
	local var_20_14 = var_20_13(var_20_12, var_5.Action_float(function(arg_23_0)
	...
	local var_20_16 = var_20_15(var_20_14, var_5.Action(function()
	...
	local var_20_20 = var_20_19(var_20_18, var_5.Action_float(function(arg_25_0)
	...
	var_20_21(var_20_20, var_5.Action(arg_20_1))
...
function var_0_1.LoadBG(arg_29_0, arg_29_1)
	...
	var_3("BattleResultItems/" .. var_29_0, "", nil, function(arg_30_0)
