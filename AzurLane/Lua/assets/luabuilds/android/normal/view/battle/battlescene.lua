...
Vector3 = var_0_0
var_0_1.IN_VIEW_FRIEND_SKILL_OFFSET = var_0_0(-5, 0, 6)
Vector3 = var_1
...
function var_0_1.getBGM(arg_3_0)
	...
	SYSTEM_WORLD = var_1_10005

	if var_3_3 == var_1_10005 then
		checkExist = var_3_3
		pg = var_1_10005

		local var_3_4

		if not var_3_3(var_1_10005.world_expedition_data[arg_3_0.contextData.stageId], {
			"bgm"
		}) then
			var_3_4 = ""
		end
...
function var_0_1.init(arg_4_0)
	...
	local var_4_2 = var_4_0.Find("UICamera")

	findTF = var_3
	arg_4_0.uiCanvas = var_3(var_4_2, "Canvas/UIMain")
	...
	if not var_4_17(var_4_16, var_5(var_6.Canvas)) or not var_3.sortingOrder then
		var_4_18 = 0
	end
	...
	typeof = var_6
	AspectRatioFitter = var_7
	arg_4_0._ratioFitter = var_4_18(var_4_19, var_6(var_7))
...
function var_0_1.initPainting(arg_7_0)
	...
	var_7_0(var_7_1, arg_7_0.uiCanvas, false)
	...
	typeof = var_5
	Animator = var_6
	arg_7_0._paintingAnimator = var_7_3(var_7_2, var_5(var_6))
	...
	typeof = var_5
	ParticleSystem = var_6
	arg_7_0._paintingParticleSystem = var_7_6(var_7_5, var_5(var_6))
	...
	local var_7_11 = var_7_10(var_7_9, var_6(var_1_10007))
...
function var_0_1.SkillHrzPop(arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	...
	if arg_10_3 then
		...
		local var_10_4 = arg_10_2.GetUnitType(var_10_3)

		ys = var_10_3

		if var_10_4 == var_10_3.Battle.BattleConst.UnitType.PLAYER_UNIT then
			local var_10_5
			...
			if not arg_10_4 then
				...
				var_10_5 = arg_10_2
				var_10_4 = arg_10_2.GetTemplate(var_10_5).painting
			end

			ys = var_10_5

			if var_10_5.Battle.BattleState.GetCombatSkinKey() == "Standard" then
				var_1_10010 = var_10_0
				var_10_2 = var_10_0.GetCharacterIcon(var_1_10010, var_10_4)
			else
				var_1_10010 = var_10_0
				var_10_2 = var_10_0.GetCharacterSquareIcon(var_1_10010, var_10_4)
			end
		else
			ys = var_10_4

			if var_10_4.Battle.BattleState.GetCombatSkinKey() == "Standard" then
				local var_10_6 = var_10_0
				local var_10_7 = var_10_0.GetCharacterIcon

				pg = var_1_10010
				var_10_2 = var_10_7(var_10_6, var_1_10010.enemy_data_statistics[arg_10_2:GetTemplateID()].icon)
			else
				local var_10_8 = var_10_0
				local var_10_9 = var_10_0.GetCharacterSquareIcon

				pg = var_1_10010
				var_10_2 = var_10_9(var_10_8, var_1_10010.enemy_data_statistics[arg_10_2:GetTemplateID()].icon)
			end
		end
	end

	local var_10_10 = var_10_1:GetObject().transform

	var_10_10.localScale = var_0_1.SKILL_FLOAT_SCALE
	setText = var_10
	findTF = var_1_10011

	local var_10_11 = var_1_10011(var_10_10, "skill/skill_name/Text")

	SwitchSpecialChar = var_12
	HXSet = var_13

	var_10(var_10_11, var_12(var_13.hxLan(arg_10_1)))

	findTF = var_10

	local var_10_12 = var_10(var_10_10, "skill/icon_mask/icon")

	findTF = var_11

	local var_10_13 = var_11(var_10_10, "skill/skill_name")
	local var_10_14 = var_10_10
	local var_10_15 = var_10_10.GetComponent

	typeof = var_14
	Animation = var_1_10015

	if var_10_15(var_10_14, var_14(var_1_10015)) then
		local var_10_16 = 1
		...
		if var_12.GetClip(var_1_10015, "anim_skinui_skill_" .. var_10_16) then
			repeat
		...
		if var_10_16 > 1 then
			...
			local var_10_17 = var_12.Play

			var_1_10016 = "anim_skinui_skill_"
			math = var_1_10017

			var_10_17(var_1_10015, var_1_10016 .. var_1_10017.random(var_10_16 - 1))
		end
	end

	local var_10_18 = var_10_12
	local var_10_19 = var_10_12.GetComponent

	typeof = var_1_10015
	Image = var_1_10016
	var_10_19(var_10_18, var_1_10015(var_1_10016)).sprite = var_10_2

	local var_10_20, var_10_21 = arg_10_2:GetIFF()
	local var_10_22 = arg_10_2
	local var_10_23 = arg_10_2.GetIFF(var_10_22)

	ys = var_10_22

	if var_10_23 == var_10_22.Battle.BattleConfig.FRIENDLY_CODE then
		Color = var_10_23
		var_10_21 = var_10_23.New(1, 1, 1, 1)
	else
		Color = var_10_23
		var_10_21 = var_10_23.New(1, 0.33, 0.33, 1)
	end

	local var_10_24 = var_10_13
	local var_10_25 = var_10_13.GetComponent

	typeof = var_1_10017
	Image = var_1_10018

	local var_10_26 = var_10_25(var_10_24, var_1_10017(var_1_10018))

	var_10_26.color = var_10_21
	findTF = var_10_26

	local var_10_27 = var_10_26(var_10_10, "skill")
	local var_10_28 = var_15.GetComponent

	typeof = var_17
	Image = var_1_10018
	var_10_28(var_10_27, var_17(var_1_10018)).color = var_10_21

	if arg_10_3 then
		arg_10_0:commanderSkillFloat(arg_10_3, arg_10_1, var_8)
	else
		local var_10_29 = var_0_2.CameraPosToUICamera
		local var_10_30 = arg_10_2:GetPosition()
		local var_10_31 = var_10_29(var_16.Clone(var_10_30))

		ys = var_16

		local var_10_32 = var_16.Battle.BattleCameraUtil.GetInstance()
		local var_10_33 = var_16.GetCharacterArrowBarPosition(var_10_32, var_10_31)

		table = var_10_32

		local var_10_34 = var_10_32.contains

		ShipType = var_18

		local var_10_35 = var_10_34(var_18.SubShipType, arg_10_2:GetTemplate().type)
		local var_10_36 = arg_10_2
		local var_10_37 = arg_10_2.GetMainUnitIndex(var_10_36)

		if var_10_33 == nil or var_10_33 == nil and var_10_35 and not arg_10_2:IsMainFleetUnit() then
			ys = var_10_36

			local var_10_38

			if var_10_20 == var_10_36.Battle.BattleConfig.FRIENDLY_CODE then
				var_10_38 = var_0_2.CameraPosToUICamera

				local var_10_39 = arg_10_2:GetPosition()
				local var_10_40 = var_20.Clone(var_10_39)

				var_10_31 = var_10_38(var_20.Add(var_10_40, var_0_1.IN_VIEW_FRIEND_SKILL_OFFSET))
			else
				var_10_38 = var_0_2.CameraPosToUICamera

				local var_10_41 = arg_10_2:GetPosition()
				local var_10_42 = var_20.Clone(var_10_41)

				var_10_31 = var_10_38(var_20.Add(var_10_42, var_0_1.IN_VIEW_FOE_SKILL_OFFSET))
			end

			Vector3 = var_10_38
			var_10_10.position = var_10_38(var_10_31.x, var_10_31.y, -2)
			rtf = var_19

			local var_10_43 = var_19(var_10_10).rect.width * 0.5
			local var_10_44 = var_10_10.anchoredPosition.x

			Screen = var_22

			if var_22.width * 0.5 < var_10_43 + var_10_44 then
				rtf = var_23
				var_20.x = var_10_44 - var_23(var_10_10).rect.width
				var_10_10.anchoredPosition = var_20
			end

			if arg_10_0._preSkillTF then
				arg_10_0.handleSkillFloatCld(arg_10_0._preSkillTF, var_10_10)
			end

			arg_10_0._preSkillTF = var_10_10

			local var_10_45 = var_10_10
			local var_10_46 = var_10_10.GetComponent

			typeof = var_1_10025
			DftAniEvent = var_1_10026

			local var_10_47 = var_10_46(var_10_45, var_1_10025(var_1_10026))

			var_23.SetEndEvent(var_10_47, function(arg_11_0)
			...
			local var_10_48
			local var_10_49 = var_0_1.SIDE_ALIGNMENT[var_10_37]
			local var_10_50 = arg_10_0._sideSkillFloatStateList[var_10_20][var_10_37]

			for iter_10_0 = 1, #var_10_50 do
				if var_10_50[iter_10_0] then
					var_10_48 = iter_10_0
			...
			if var_10_48 == nil then
				var_10_48 = #var_10_50 + 1
			end

			var_10_50[var_10_48] = false
			Vector3 = var_22
			var_10_10.position = var_22(var_10_33.x, var_10_33.y, -2)

			local var_10_51 = var_10_10.anchoredPosition

			var_10_51.y = var_10_49[var_10_48]
			ys = var_23

			if var_10_20 == var_23.Battle.BattleConfig.FOE_CODE then
				var_10_51.x = var_0_1.FOE_SIDE_X_OFFSET
			end

			var_10_10.anchoredPosition = var_10_51

			local var_10_52 = var_10_10
			local var_10_53 = var_10_10.GetComponent

			typeof = var_25
			DftAniEvent = var_1_10026

			local var_10_54 = var_10_53(var_10_52, var_25(var_1_10026))

			var_23.SetEndEvent(var_10_54, function(arg_12_0)
				var_10_50[var_10_48] = true
...
function var_0_1.handleSkillFloatCld(arg_14_0, arg_14_1)
	...
	if var_14_2(var_1_10005.abs(var_14_0.y - var_14_1)) <= 112.5 then
...
function var_0_1.commanderSkillFloat(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if arg_16_0._preCommanderSkillTF then
		...
		if var_16_4(var_1_10008.abs(var_16_2.y - var_16_3)) <= 97.5 then
	...
	local var_16_7 = var_16_6(var_16_5, var_1_10008(var_1_10009))
...
function var_0_1.CutInPaintingDAL(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	...
	var_19_0(var_19_1, arg_19_0.uiCanvas, false)

	findTF = var_19_0

	local var_19_2 = var_19_0(var_19_1, "hero/fitter")
	...
	var_19_5(var_19_6, var_19_2, false)
	...
	local var_19_9 = var_19_8(var_19_7, var_13(var_14))
	...
	local var_19_12 = var_19_11(var_19_10, var_13(var_14))
...
function var_0_1.didEnter(arg_21_0)
	...
	local var_21_7 = var_4.Find(var_21_6, "PauseBtn")

	local function var_21_8()
		local var_23_0 = arg_21_0
		local var_23_1 = var_0.emit

		BattleMediator = var_2_10002

		var_23_1(var_23_0, var_2_10002.ON_PAUSE)
	...
	var_2(var_21_5, var_21_7, var_21_8, var_6)
	...
	local var_21_12 = var_21_11(var_21_10, var_4(var_21_8))

	onButton = var_21_10

	var_21_10(arg_21_0, arg_21_0._chatBtn, function()
		local var_24_0 = arg_21_0
		local var_24_1 = var_0.emit

		BattleMediator = var_2_10002

		local var_24_2 = var_2_10002.ON_CHAT
		local var_24_3 = arg_21_0._tf

		var_24_1(var_24_0, var_24_2, var_3.Find(var_24_3, "chatContainer"))
	...
	local var_21_15 = var_5.Find(var_21_14, "AutoBtn")
	...
	local function var_21_16(arg_25_0)
		...
		local var_25_4 = var_2_10004.ON_AUTO
		local var_25_5 = {
			isOn = not arg_25_0
		}
		local var_25_6 = arg_21_0._tf

		var_25_5.toggle = var_6.Find(var_25_6, "AutoBtn")
		...
		if var_2.ChatUseable(var_25_9) then
			...
			var_25_9(arg_21_0._chatBtn, true)
	...
	var_21_10(var_21_13, var_21_15, var_21_16, var_7, var_1_10008)

	onButton = var_21_10

	local var_21_17 = arg_21_0
	local var_21_18 = arg_21_0._tf
	local var_21_19 = var_5.Find(var_21_18, "CardPuzzleConsole/relic/bg")
	...
	local function var_21_20()
		...
		local var_26_2 = var_26_1(var_26_0, var_2_10002.Battle.BattleDataProxy.__name)
		local var_26_3 = var_0.GetFleetByIFF

		ys = var_2_10003

		local var_26_4 = var_26_3(var_26_2, var_2_10003.Battle.BattleConfig.FRIENDLY_CODE)
		...
		BattleMediator = var_2_10006

		var_26_8(var_26_7, var_2_10006.ON_PUZZLE_RELIC, {
			relicList = var_26_6
		})
	...
	var_21_10(var_21_17, var_21_19, var_21_20, var_7)

	onButton = var_21_10

	local var_21_21 = arg_21_0
	local var_21_22 = arg_21_0._tf
	local var_21_23 = var_5.Find(var_21_22, "CardPuzzleConsole/deck/bg")
	...
	local function var_21_24()
		...
		local var_27_2 = var_27_1(var_27_0, var_2_10002.Battle.BattleDataProxy.__name)
		local var_27_3 = var_0.GetFleetByIFF

		ys = var_2_10003

		local var_27_4 = var_27_3(var_27_2, var_2_10003.Battle.BattleConfig.FRIENDLY_CODE)
		...
		var_27_11(var_27_10, var_2_10007.ON_PUZZLE_CARD, {
			card = var_27_7,
			hand = var_27_9
		})
	...
	var_21_10(var_21_21, var_21_23, var_21_24, var_7)
	var_1:ConfigBattleEndFunc(function(arg_28_0)
		...
		var_28_2(var_28_1, var_2_10003.ON_BATTLE_RESULT, arg_28_0)
	...
	var_7.SetRecycleFuncs(var_21_29, function(arg_30_0)
		...
		local var_30_2 = var_30_1(var_30_0, var_2_10003(var_2_10004))
	...
	BattleMediator = var_9

	var_21_31(var_21_30, var_9.ENTER)
	...
	if arg_21_0.contextData.prePause then
		...
		var_7(var_8.Find(var_21_32, "PauseBtn"))
	end
...
function var_0_1.activeBotHelp(arg_32_0, arg_32_1)
	...
	local var_32_0 = var_1_10002(var_1_10003)
	...
	var_32_4.type = var_1_10006
	i18n = var_1_10006
	var_32_4.helps = var_1_10006("help_battle_auto")
...
function var_0_1.exitBattle(arg_34_0, arg_34_1)
	if not arg_34_1 then
		...
		var_34_1(var_34_0, var_1_10004.ON_QUIT_BATTLE_MANUALLY)
		...
		var_34_3(var_34_2, var_4.ON_BACK_PRE_SCENE)
...
function var_0_1.initPauseWindow(arg_37_0)
	...
	local var_37_4 = var_2.Find(var_37_3, "label")

	i18n = var_37_3

	var_1(var_37_4, var_37_3("battle_battleMediator_remainTime"))

	setText = var_1

	local var_37_5 = arg_37_0.pauseWindow
	local var_37_6 = var_2.Find(var_37_5, "window/van/power/title")

	i18n = var_37_5

	var_1(var_37_6, var_37_5("word_vanguard_fleet"))

	setText = var_1

	local var_37_7 = arg_37_0.pauseWindow
	local var_37_8 = var_2.Find(var_37_7, "window/main/power/title")

	i18n = var_37_7

	var_1(var_37_8, var_37_7("word_main_fleet"))

	local function var_37_9(arg_38_0, arg_38_1, arg_38_2)
		for iter_38_0 = 1, 3 do
			local var_38_0 = arg_38_1
			local var_38_1 = arg_38_1.Find(var_38_0, "ship_" .. iter_38_0)

			setActive = var_38_0

			var_38_0(var_38_1, arg_38_2 and iter_38_0 <= #arg_38_2)

			if arg_38_2 and iter_38_0 <= #arg_38_2 then
				updateShip = var_38_0

				var_38_0(var_38_1, arg_38_2[iter_38_0])
			end

			table = var_38_0

			var_38_0.insert(arg_38_0, var_38_1)
		end
		...
		if arg_38_2 then
			...
			for iter_38_1, iter_38_2 in var_4(arg_38_2) do
				var_38_2 = var_38_2 + iter_38_2:getShipCombatPower()
			end

			setText = var_4

			var_4(arg_38_1:Find("power/value"), var_38_2)
		end
	...
	local var_37_10 = var_37_8.Battle.BattleState.GetInstance()
	...
	if arg_37_0._mainShipVOs then
		...
		var_37_12(var_37_13, var_6.Find(var_37_14, "window/main"), arg_37_0._mainShipVOs)
		...
		var_37_12(var_37_15, var_6.Find(var_37_16, "window/van"), arg_37_0._vanShipVOs)
	else
		...
		if var_37_11 == var_37_12 then
			...
			var_37_17(var_6.Find(var_37_18, "window/van"), false)

			setActive = var_37_17

			local var_37_19 = arg_37_0.pauseWindow

			var_37_17(var_6.Find(var_37_19, "window/bg_fleet/Image (1)"), false)
			var_37_9(arg_37_0.subTFs, var_37_12, arg_37_0._subShipVOs)

			setText = var_5

			local var_37_20 = var_37_12
			local var_37_21 = var_37_12.Find(var_37_20, "power/title")

			i18n = var_37_20

			var_5(var_37_21, var_37_20("index_shipType_qianTing"))

			local var_37_22 = var_37_12.localPosition

			Vector3 = var_37_21
			var_37_12.localPosition = var_37_21(0, var_37_22.y, 0)
		end
	end

	findTF = var_37_12

	local var_37_23 = var_37_12(arg_37_0.pauseWindow, "window/Chapter")

	findTF = var_5

	local var_37_24 = var_5(arg_37_0.pauseWindow, "window/Chapter/Text")
	local var_37_25 = arg_37_0.pauseWindow

	arg_37_0.continueBtn = var_6.Find(var_37_25, "window/button_container/continue")

	local var_37_26 = arg_37_0.pauseWindow

	arg_37_0.leaveBtn = var_6.Find(var_37_26, "window/button_container/leave")
	setText = var_37_32

	local var_37_27 = arg_37_0.continueBtn
	local var_37_28 = var_7.Find(var_37_27, "pic")

	i18n = var_37_27

	var_37_32(var_37_28, var_37_27("battle_battleMediator_goOnFight"))

	setText = var_37_32

	local var_37_29 = arg_37_0.leaveBtn
	local var_37_30 = var_7.Find(var_37_29, "pic")

	i18n = var_37_29

	var_37_32(var_37_30, var_37_29("battle_battleMediator_existFight"))

	SYSTEM_SCENARIO = var_37_32

	if var_37_11 ~= var_37_32 then
		SYSTEM_SCENARIO_SUB_STRIKE = var_37_32

		local var_37_32, var_37_33

		if var_37_11 == var_37_32 then
			local var_37_31 = arg_37_0._chapter

			var_37_32 = var_37_32.getConfigTable(var_37_31)
			setText = var_37_31

			var_37_31(var_37_23, var_37_32.chapter_name)

			setText = var_37_31
			var_37_33 = var_37_24
			string = var_9

			var_37_31(var_37_33, var_9.split(var_37_32.name, "|")[1])

			goto label_37_0
		end

		SYSTEM_ROUTINE = var_37_32

		if var_37_11 ~= var_37_32 then
			SYSTEM_DUEL = var_37_32

			if var_37_11 ~= var_37_32 then
				SYSTEM_HP_SHARE_ACT_BOSS = var_37_32

				if var_37_11 ~= var_37_32 then
					SYSTEM_BOSS_EXPERIMENT = var_37_32

					if var_37_11 ~= var_37_32 then
						SYSTEM_ACT_BOSS = var_37_32

						if var_37_11 ~= var_37_32 then
							SYSTEM_ACT_BOSS_SP = var_37_32

							if var_37_11 ~= var_37_32 then
								SYSTEM_BOSS_RUSH = var_37_32

								if var_37_11 ~= var_37_32 then
									SYSTEM_BOSS_RUSH_EX = var_37_32

									if var_37_11 ~= var_37_32 then
										SYSTEM_BOSS_RUSH_COLLABRATE = var_37_32

										if var_37_11 ~= var_37_32 then
											SYSTEM_LIMIT_CHALLENGE = var_37_32

											if var_37_11 ~= var_37_32 then
												SYSTEM_BOSS_SINGLE = var_37_32

												if var_37_11 ~= var_37_32 then
													SYSTEM_BOSS_SINGLE_VARIABLE = var_37_32

													if var_37_11 == var_37_32 then
														setText = var_37_32

														var_37_32(var_37_23, "SP")

														local var_37_34 = var_2

														var_37_32 = var_2.GetProxyByName
														ys = var_37_33

														local var_37_35 = var_37_32(var_37_34, var_37_33.Battle.BattleDataProxy.__name)

														var_37_32 = var_37_32.GetInitData(var_37_35).StageTmpId
														pg = var_37_35

														local var_37_36 = var_37_35.expedition_data_template[var_37_32]

														setText = var_37_33

														var_37_33(var_37_24, var_37_36.name)

														goto label_37_0
													end

													SYSTEM_DEBUG = var_37_32
													...
													if var_37_11 == var_37_32 then
														...
														var_37_32(var_37_24, "碧蓝梦境")

														goto label_37_0
													end

													SYSTEM_CHALLENGE = var_37_32

													if var_37_11 == var_37_32 then
														local var_37_37 = arg_37_0._chapter

														var_37_32 = var_37_32.getNextExpedition(var_37_37)
														setText = var_37_37

														var_37_37(var_37_23, "SP")

														setText = var_37_37

														var_37_37(var_37_24, var_37_32.chapter_name[2])

														setActive = var_37_37

														var_37_37(arg_37_0.LeftTimeContainer, true)

														goto label_37_0
													end

													SYSTEM_WORLD_BOSS = var_37_32

													if var_37_11 ~= var_37_32 then
														SYSTEM_WORLD = var_37_32

														if var_37_11 == var_37_32 then
															setText = var_37_32

															local var_37_38 = var_37_23

															i18n = var_37_33

															var_37_32(var_37_38, var_37_33("world_battle_pause"))

															setText = var_37_32

															local var_37_39 = var_37_24

															i18n = var_37_33

															var_37_32(var_37_39, var_37_33("world_battle_pause2"))
															...
															if var_37_11 == var_37_32 then
																...
																var_37_32(arg_37_0.leaveBtn, false)
															end
														else
															SYSTEM_GUILD = var_37_32

															if var_37_11 == var_37_32 then
																local var_37_40 = var_2

																var_37_32 = var_2.GetProxyByName
																ys = var_37_33

																local var_37_41 = var_37_32(var_37_40, var_37_33.Battle.BattleDataProxy.__name)

																var_37_32 = var_37_32.GetInitData(var_37_41).ActID
																pg = var_37_41

																local var_37_42 = var_37_41.guild_boss_event[var_37_32]

																setText = var_8

																var_8(var_37_23, "BOSS")

																setText = var_8

																local var_37_43 = var_37_24
																local var_37_44

																if not var_37_42 or not var_37_42.name then
																	var_37_44 = ""
																end

																var_8(var_37_43, var_37_44)
															else
																SYSTEM_TEST = var_37_32

																if var_37_11 ~= var_37_32 then
																	SYSTEM_SUB_ROUTINE = var_37_32

																	if var_37_11 ~= var_37_32 then
																		SYSTEM_SCENARIO_SUB_STRIKE = var_37_32

																		if var_37_11 ~= var_37_32 then
																			SYSTEM_PERFORM = var_37_32

																			if var_37_11 ~= var_37_32 then
																				SYSTEM_PROLOGUE = var_37_32

																				if var_37_11 ~= var_37_32 then
																					SYSTEM_DODGEM = var_37_32

																					if var_37_11 ~= var_37_32 then
																						SYSTEM_SIMULATION = var_37_32

																						if var_37_11 ~= var_37_32 then
																							SYSTEM_SUBMARINE_RUN = var_37_32

																							if var_37_11 ~= var_37_32 then
																								SYSTEM_BOSS_EXPERIMENT = var_37_32

																								if var_37_11 ~= var_37_32 then
																									SYSTEM_REWARD_PERFORM = var_37_32

																									if var_37_11 ~= var_37_32 then
																										SYSTEM_AIRFIGHT = var_37_32

																										if var_37_11 == var_37_32 then
																											-- block empty
																										else
																											SYSTEM_CARDPUZZLE = var_37_32
																											...
																											if var_37_11 == var_37_32 then
																												...
																												var_37_32(false, "System not defined " .. (var_37_11 or "NIL"))
																											end
																										end
																									end
																								end
														...
														var_37_32(arg_37_0, arg_37_0.leaveBtn, function()
															local var_39_0 = arg_37_0
															local var_39_1 = var_0.emit

															BattleMediator = var_2_10002

															var_39_1(var_39_0, var_2_10002.ON_LEAVE)
															...
															if var_39_3(var_39_2, var_2(var_2_10003)) and var_0:GetClip("msgbox_btn_blink") then
														...
														var_37_32(arg_37_0, arg_37_0.continueBtn, function()
															...
															if var_40_1(var_40_0, var_2_10002(var_2_10003)) and var_0:GetClip("msgbox_btn_blink") then
																var_0:Play("msgbox_btn_blink")
															end
															...
															if var_40_3(var_40_2, var_2_10003(var_2_10004)) then
																if var_1:IsPlaying("msgbox_out") then
																	...
																	local var_40_6 = var_40_5(var_40_4, var_4(var_2_10005))
														...
														var_37_32(var_37_45, var_8.Find(var_37_46, "help"), function()
															...
															do
																...
																var_42_5.type = var_2_10003
																i18n = var_2_10003
																var_42_5.helps = var_2_10003("help_battle_rule")
														...
														local var_37_47 = arg_37_0
														local var_37_48 = arg_37_0.pauseWindow

														var_37_32(var_37_47, var_8.Find(var_37_48, "window/top/btnBack"), function()
														...
														var_37_32(arg_37_0, arg_37_0.pauseWindow, function()
															triggerButton = var_2_10000
														...
														var_37_32(arg_37_0, arg_37_0.pauseWindow, function()
															...
															if var_45_1(var_45_0, var_2_10002(var_2_10003)) and var_0:IsPlaying("msgbox_out") then
																-- block empty
															else
																triggerButton = var_45_0

																var_45_0(arg_37_0.continueBtn)
															end
														...
														var_37_32(arg_37_0.pauseWindow, false)
...
function var_0_1.updatePauseWindow(arg_46_0)
	...
	local var_46_3 = var_46_2(var_46_1, var_1_10004.Battle.BattleDataProxy.__name)
	local var_46_4 = var_2.GetFleetByIFF

	ys = var_1_10005

	local var_46_5 = var_46_4(var_46_3, var_1_10005.Battle.BattleConfig.FRIENDLY_CODE)
	...
	;(function(arg_47_0, arg_47_1)
		...
		for iter_47_0 = 1, #arg_47_0 do
			...
			if var_7.GetFreezeShipByID(var_47_1, var_47_0) then
				...
				var_47_2(var_9.Find(var_47_4, "blood"), 0, 1, var_47_3:GetHPRate())

				SetActive = var_47_2

				local var_47_5 = arg_47_1[iter_47_0]

				var_47_2(var_9.Find(var_47_5, "mask"), false)
			else
				...
				if var_7.GetShipByID(var_47_6, var_47_0) then
					...
					var_47_7(var_9.Find(var_47_9, "blood"), 0, 1, var_47_8:GetHPRate())

					SetActive = var_47_7

					local var_47_10 = arg_47_1[iter_47_0]

					var_47_7(var_9.Find(var_47_10, "mask"), false)
				else
					setSlider = var_47_8

					local var_47_11 = arg_47_1[iter_47_0]

					var_47_8(var_8.Find(var_47_11, "blood"), 0, 1, 0)

					SetActive = var_47_8

					local var_47_12 = arg_47_1[iter_47_0]

					var_47_8(var_8.Find(var_47_12, "mask"), true)
				end
			end
		end
	...
	local var_46_7 = var_7.Battle.BattleTimerView.formatTime

	math = var_1_10008

	var_5(var_46_6, var_46_7(var_1_10008.floor(var_2:GetCountDown())))
...
function var_0_1.OnCloseChat(arg_50_0)
	...
	local var_50_4 = var_50_3(var_50_2, var_1_10004(var_1_10005))

	if var_50_1 then
		setActive = var_50_2

		var_50_2(arg_50_0._chatBtn, true)
	...
	elseif var_50_4 then
		...
		var_50_2(arg_50_0._chatBtn, false)
	end
