...
function var_0_1.updatePlayer(arg_14_0, arg_14_1)
	...
	var_1_10002(var_1_10003(var_4.Find(var_14_0, "bottom/player_info"), "statistics_panel/exploit_bg/score"), arg_14_1.exploit)
...
function var_0_1.didEnter(arg_17_0)
	...
	local var_17_4 = var_2.Find(var_17_3, "stamp")

	getProxy = var_17_3
	TaskProxy = var_4

	local var_17_5 = var_17_3(var_4)

	var_1_10001(var_17_4, var_3.mingshiTouchFlagEnabled(var_17_5))
	...
	if var_1_10001 then
		...
		var_1_10001(var_2.Find(var_17_6, "stamp"), false)
	end
	...
	local var_17_9 = var_3.Find(var_17_8, "stamp")
	...
	var_1_10001(var_17_7, var_17_9, var_17_10, var_5)

	onButton = var_1_10001

	local var_17_11 = arg_17_0
	local var_17_12 = arg_17_0._tf
	local var_17_13 = var_3.Find(var_17_12, "bottom/buttons/rank_btn")

	local function var_17_14()
		local var_20_0 = arg_17_0
		local var_20_1 = var_0.emit

		MilitaryExerciseMediator = var_2_10002

		var_20_1(var_20_0, var_2_10002.OPEN_RANK)
	...
	var_1_10001(var_17_11, var_17_13, var_17_14, var_5)

	onButton = var_1_10001

	local var_17_15 = arg_17_0
	local var_17_16 = arg_17_0._tf
	local var_17_17 = var_3.Find(var_17_16, "bottom/buttons/shop_btn")
	...
	local function var_17_18()
		...
		var_21_1(var_21_0, var_2_10002.OPEN_SHOP)
	...
	var_1_10001(var_17_15, var_17_17, var_17_18, var_5)

	onButton = var_1_10001

	local var_17_19 = arg_17_0
	local var_17_20 = arg_17_0._tf
	local var_17_21 = var_3.Find(var_17_20, "bottom/buttons/award_btn")
	...
	var_1_10001(var_17_19, var_17_21, var_17_22, var_5)
	...
	local function var_17_25()
		...
		var_23_1(var_23_0, var_2_10002.REPLACE_RIVALS)
	...
	var_1_10001(var_17_23, var_17_24, var_17_25, var_5)
...
function var_0_1.updateExerciseCount(arg_25_0)
	...
	local var_25_0 = var_1_10002(arg_25_0.seasonInfoPanel, "count")

	math = var_3

	local var_25_1 = var_3.max
	local var_25_2
	...
	var_1_10001(var_25_0, var_25_3 .. var_25_4 .. var_5.MAX_FIGHTCOUNT)
...
function var_0_1.updateSeasonLeftTime(arg_26_0, arg_26_1)
	...
	local var_26_2 = var_3(arg_26_0.seasonInfoPanel, "left_time_container/time")
	...
	arg_26_0.leftTimeTimer = var_4.New(function()
		...
		if 0 < var_27_2 then
			...
			var_2_10005(var_27_8, var_7.format("%02d:%02d:%02d", var_27_5, var_27_6, var_27_7))
		else
			setText = var_27_4
			...
			var_27_4(var_27_9, var_3.format("%02d:%02d:%02d", 0, 0, 0))
...
function var_0_1.updateRecoverTime(arg_28_0, arg_28_1)
	...
	Timer = var_3
	arg_28_0.recoverTimer = var_3.New(function()
		...
		if 0 < var_29_2 then
			...
			local var_29_5 = var_2_10005.TimeMgr.GetInstance()

			var_1(var_29_3, var_2_10003(var_29_4, var_5.DescCDTime(var_29_5, var_29_2)))
		else
...
function var_0_1.initPlayerFleet(arg_30_0)
	local function var_30_0(arg_31_0, arg_31_1, arg_31_2)
		...
		updateShip = var_2_10006

		var_2_10006(var_31_0, arg_31_0, {
			initStar = true
		})
		...
		var_2_10006(var_7(var_31_0, "icon_bg/lv/Text"), arg_31_0.level)
		...
		local function var_31_5()
			...
			MilitaryExerciseMediator = var_3_10002

			var_32_1(var_32_0, var_3_10002.OPEN_DOCKYARD, arg_31_2, arg_31_0.id)
		...
		var_2_10006(var_31_3, var_31_4, var_31_5, var_2_10010)
	...
	for iter_30_0 = 1, 3 do
		if arg_30_0.fleet.mainShips[iter_30_0] then
			if arg_30_0.ships[var_6] then
				...
				local var_30_2 = var_1_10007

				var_1_10010 = arg_30_0.mainContainer
				TeamType = var_1_10011

				var_30_1(var_30_2, var_1_10010, var_1_10011.Main)
			end
		else
			...
			findTF = var_1_10010
			var_1_10010 = var_1_10010(var_1_10007, "icon_bg")
			...
			function var_1_10011()
				...
				local var_33_2 = var_2_10002.OPEN_DOCKYARD

				TeamType = var_2_10003

				var_33_1(var_33_0, var_33_2, var_2_10003.Main, 0)
			...
			var_8(var_30_3, var_1_10010, var_1_10011, var_12)
		end
	end
	...
	for iter_30_1 = 1, 3 do
		if arg_30_0.fleet.vanguardShips[iter_30_1] then
			if arg_30_0.ships[var_6] then
				...
				local var_30_5 = var_1_10007

				var_1_10010 = arg_30_0.vanguardContainer
				TeamType = var_1_10011

				var_30_4(var_30_5, var_1_10010, var_1_10011.Vanguard)
			end
		else
			cloneTplTo = var_1_10007
			...
			function var_1_10011()
				...
				local var_34_2 = var_2_10002.OPEN_DOCKYARD

				TeamType = var_2_10003

				var_34_1(var_34_0, var_34_2, var_2_10003.Vanguard, 0)
			...
			var_8(var_30_6, var_1_10010, var_1_10011, var_12)
		end
	end
...
function var_0_1.initPlayerInfo(arg_35_0)
	...
	var_35_1(var_4(var_35_2, "statistics_panel/score_bg/score"), var_35_0)

	setText = var_35_1
	findTF = var_4

	var_35_1(var_4(var_35_2, "statistics_panel/rank_bg/score"), arg_35_0.seasonInfo.rank)

	findTF = var_35_1

	local var_35_3 = var_35_1(var_35_2, "upgrade_tip/level")

	findTF = var_4

	local var_35_4 = var_4(var_35_2, "upgrade_rank_tip/level")
	...
	var_8(var_35_8, var_10(var_35_2, "medal_bg/medal"), true)
	...
	var_8(var_35_9, var_10(var_35_2, "medal_bg/Text"), true)
	...
	SeasonInfo = var_35_10

	local var_35_12, var_35_13, var_35_14 = var_35_10.getNextMilitaryRank(var_35_0, arg_35_0.seasonInfo.rank)
...
function var_0_1.updateRivals(arg_36_0)
	...
	for iter_36_0 = 1, 4 do
		...
		var_1_10006 = arg_36_0.rivalTFs

		local var_36_0 = arg_36_0.rivalList

		var_1_10005(var_1_10006, var_7.GetChild(var_36_0, iter_36_0 - 1))
	end

	for iter_36_1 = 1, 4 do
		local var_36_1 = arg_36_0.rivalTFs[iter_36_1]

		setActive = var_1_10006

		var_1_10006(var_36_1, iter_36_1 <= #arg_36_0.rivalVOs)
...
function var_0_1.updateRival(arg_37_0, arg_37_1)
	...
	var_5(var_37_2, ">>>" .. var_37_1.score .. "--" .. var_37_1.rank)

	findTF = var_5

	local var_37_3 = var_5(var_37_0, "shiptpl")
	...
	var_7(var_37_5, var_9(var_37_0, "medal"), true)
	...
	var_7(var_37_6, var_9(var_37_0, "Text"), true)
	...
	var_7(var_8(var_37_0, "rank_bg/rank_container/name"), var_37_1.rank)

	setText = var_7
	findTF = var_8

	var_7(var_8(var_37_0, "name_container/name"), var_37_1.name)

	setText = var_7
	findTF = var_8

	var_7(var_8(var_37_0, "name_container/lv"), "Lv." .. var_37_1.level)

	setText = var_7
	findTF = var_8

	local var_37_9 = var_8(var_37_0, "comprehensive_panel/comprehensive/main_fleet/value")
	local var_37_10 = var_37_1
	local var_37_11 = var_37_1.GetGearScoreSum

	TeamType = var_11

	var_7(var_37_9, var_37_11(var_37_10, var_11.Main))
	...
	var_7(var_37_12, var_37_14(var_37_13, var_11.Vanguard))
	...
	local function var_37_17()
		...
		var_38_1(var_38_0, var_2_10002.OPEN_RIVAL_INFO, var_37_1)
	...
	var_7(var_37_15, var_37_16, var_37_17, var_11)
...
function var_0_1.initAwards(arg_39_0)
	...
	local var_39_2 = var_3.Find(var_39_1, "top/btnBack")
	...
	var_1_10001(var_39_0, var_39_2, var_39_3, var_5)

	local var_39_4 = arg_39_0.awardPanel
	local var_39_5

	var_39_5, setText = var_1.Find(var_39_4, "bg/frame/content/time_panel/Text"), var_39_4
	i18n = var_39_3
	...
	local var_39_8 = var_1_10007.date("%Y.%m.%d", arg_39_0.activity.data1)
	local var_39_9 = " — "

	os = var_9

	var_39_4(var_39_5, var_39_3(var_39_6, var_39_7 .. var_39_8 .. var_39_9 .. var_9.date("%Y.%m.%d", arg_39_0.activity.stopTime)))

	local var_39_10 = arg_39_0.awardPanel
	local var_39_11

	var_39_11, setText = var_2.Find(var_39_10, "bg/frame/content/desc_panel/Text"), var_39_10
	i18n = var_39_6

	var_39_10(var_39_11, var_39_6("exercise_rule_tip"))
	...
	local var_39_16 = var_39_13:Find("linetpl")
	local var_39_17 = arg_39_0.awardPanel
	local var_39_18

	var_39_18, setText = var_7.Find(var_39_17, "bg/frame/content/award_panel/Text"), var_39_17
	i18n = var_10

	var_39_17(var_39_18, var_10("exercise_award_tip"))

	local function var_39_19(arg_41_0, arg_41_1)
		...
		var_4(var_2_10005(arg_41_0, "Text"), var_41_1.name .. ":")

		ipairs = var_4

		for iter_41_0, iter_41_1 in var_4(var_41_1.award_list) do
			cloneTplTo = var_2_10009
			var_2_10009 = var_2_10009(var_39_15, var_41_0)
			updateDrop = var_10
			...
			local var_41_3 = var_2_10009:Find("icon_bg")
			...
			local function var_41_4()
				...
				local var_42_2 = var_3_10002.ON_ITEM
			...
			var_10(var_41_2, var_41_3, var_41_4, var_14)
		end

		setText = var_4
		findTF = var_5

		var_4(var_5(arg_41_0, "upgrade_score_tip/level"), var_41_1.point)

		setText = var_4
		findTF = var_5

		local var_41_5 = var_5(arg_41_0, "upgrade_rank_tip/level")
		local var_41_6

		if not (var_41_1.order > 0) or not var_41_1.order then
			var_41_6 = "-"
		end

		var_4(var_41_5, var_41_6)

		return
	end

	for iter_39_0 = #arg_39_0.rankCfg.all, 1, -1 do
		local var_39_20 = arg_39_0.rankCfg.all[iter_39_0]
		local var_39_21 = #arg_39_0.rankCfg[var_39_20].award_list

		if 0 < var_39_21 then
			local var_39_22 = var_39_19

			cloneTplTo = var_15

			var_39_22(var_15(var_39_14, var_39_13), var_39_20)

			cloneTplTo = var_39_22

			var_39_22(var_39_16, var_39_13)
		end
	end
