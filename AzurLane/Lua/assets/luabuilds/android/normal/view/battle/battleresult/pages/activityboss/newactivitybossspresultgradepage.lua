...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".NewActivityBossResultGradePage"))
...
function var_0_1.LoadActivityBossSPRes(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_5_2, var_5_3, var_1_10006.Events.UnityAction_UnityEngine_Object(function(arg_6_0)
...
function var_0_1.InitActivityPanel(arg_7_0, arg_7_1)
	...
	local var_7_5 = arg_7_1.Find(var_7_4, "Score/Title")

	i18n = var_7_4

	var_5(var_7_5, var_7_4("activityboss_sp_score"))

	setText = var_5

	local var_7_6 = arg_7_1
	local var_7_7 = arg_7_1.Find(var_7_6, "Score/NewText")

	i18n = var_7_6

	var_5(var_7_7, var_7_6("activityboss_sp_score_update"))

	setText = var_5

	local var_7_8 = arg_7_1
	local var_7_9 = arg_7_1.Find(var_7_8, "Score/NotNewText")

	i18n = var_7_8

	var_5(var_7_9, var_7_8("activityboss_sp_score_not_update"))

	setText = var_5

	local var_7_10 = arg_7_1
	local var_7_11 = arg_7_1.Find(var_7_10, "Active/PTTitle")

	i18n = var_7_10

	var_5(var_7_11, var_7_10("activityboss_sp_score_bonus"))

	setText = var_5

	local var_7_12 = arg_7_1
	local var_7_13 = arg_7_1.Find(var_7_12, "Active/BuffTitle")

	i18n = var_7_12

	var_5(var_7_13, var_7_12("activityboss_sp_active_buff"))
...
function var_0_1.UpdateActiveBuffs(arg_8_0, arg_8_1, arg_8_2)
	...
	function var_8_2.onUpdateItem(arg_10_0, arg_10_1)
		...
		local var_10_3 = var_10_0.Find(var_10_2, "Icon")

		tobool = var_10_2

		var_2_10004(var_10_3, var_10_2(var_10_1))
		...
		var_2_10004(var_10_1:GetIconPath(), "", var_10_0:Find("Icon"))
