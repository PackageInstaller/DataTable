...
function var_0_0.NeedVibrate(arg_2_0)
	...
	AUTO_BATTLE_LABEL = var_1_10002

	local var_2_1 = var_2_0(var_1_10002, 0)
...
function var_0_0.GetAutoSkipFlag(arg_4_0, arg_4_1)
	...
	if arg_4_1 ~= var_1_10002 then
		...
		if arg_4_1 == var_1_10002 then
			...
			var_1_10002 = var_1_10002.getActiveChapter(var_1_10003)
			getProxy = var_1_10003
			ChapterProxy = var_1_10004

			local var_4_0 = var_1_10003(var_1_10004)

			var_1_10003 = var_1_10003.GetChapterAutoFlag(var_4_0, var_1_10002.id) == 1
						...
						if arg_5_0 ~= var_1_10002 then
							...
							if arg_5_0 ~= var_1_10002 then
								...
								if arg_5_0 == var_1_10002 then
									...
									BuffHelper = var_1_10003

									local var_5_2 = var_1_10003.GetBuffsByActivityType

									ActivityConst = var_1_10004
									var_5_0 = var_5_1(var_5_2(var_1_10004.ACTIVITY_TYPE_BUFF), function(arg_6_0)
						...
						if arg_7_0 ~= var_1_10002 then
							...
							if arg_7_0 ~= var_1_10002 then
								...
								if arg_7_0 == var_1_10002 then
									...
									local var_7_1 = var_1_10002(var_1_10003)
...
local function var_0_1()
	...
	local var_8_1 = var_1_10001(var_1_10002)
	local var_8_2 = var_1.getActiveChapter(var_8_1).fleet

	TeamType = var_1_10003

	local var_8_3 = var_8_2[var_1_10003.Main]
	...
	if var_5.detect(var_1.fleets, function(arg_9_0)
		...
		local var_9_1 = arg_9_0.getFleetType(var_9_0)

		FleetType = var_9_0

		return var_9_1 == var_9_0.Submarine
	end) then
		local var_8_5 = var_5
		...
		local var_8_7 = var_8_6(var_8_5, iter_8_2.Submarine, true)

		ipairs = var_8_5

		for iter_8_4, iter_8_5 in var_8_5(var_8_7) do
			table = var_1_10012
...
local function var_0_2()
	...
	local var_10_5 = var_10_4(var_10_3, var_1_10006.Main, true)
	local var_10_6 = var_3
	local var_10_7 = var_3.GetTeamShipVOs

	TeamType = var_7

	local var_10_8 = var_10_7(var_10_6, var_7.Vanguard, true)

	ipairs = var_10_6

	for iter_10_0, iter_10_1 in var_10_6(var_10_5) do
		table = var_1_10011
	...
	if var_2:GetSubmarineFleet() then
		local var_10_9 = var_6
		local var_10_10 = var_6.GetTeamShipVOs

		TeamType = iter_10_2

		local var_10_11 = var_10_10(var_10_9, iter_10_2.Submarine, true)

		ipairs = var_10_9

		for iter_10_4, iter_10_5 in var_10_9(var_10_11) do
			table = var_1_10013
...
local function var_0_4(arg_12_0)
	...
	local var_12_5 = var_5(var_1_10006)
	local var_12_6 = var_5.getShipsByFleet(var_12_5, var_12_4)

	ipairs = var_12_5

	for iter_12_0, iter_12_1 in var_12_5(var_12_6) do
		table = var_1_10011
...
local function var_0_5(arg_13_0)
	...
	local var_13_5 = var_5(var_1_10006)
...
local function var_0_6()
	...
	local var_14_1 = var_1_10001(var_1_10002)
	...
	for iter_14_0, iter_14_1 in var_14_4(var_14_5:GetShips()) do
		table = var_1_10010

		var_1_10010.insert(var_14_0, iter_14_1.ship)
	end

	local var_14_6 = var_3
	local var_14_7 = var_3.GetSubFleet(var_14_6)

	ipairs = var_14_6

	for iter_14_2, iter_14_3 in var_14_6(var_14_7:GetShips()) do
		table = var_1_10011
...
local function var_0_7(arg_15_0)
	...
	local var_15_4 = var_15_3:GetStaegLevel()
	local var_15_5 = var_15_3
	local var_15_6 = var_15_3.GetStageFleets(var_15_5, var_15_3:GetMode(), var_15_4)

	getProxy = var_15_5
	FleetProxy = var_7

	local var_15_7 = var_15_5(var_7)
	local var_15_8 = var_6.getActivityFleets(var_15_7)[var_15_0][var_15_6]

	getProxy = var_8
	BayProxy = var_1_10009

	local var_15_9 = var_8(var_1_10009)

	return (var_8.getShipsByFleet(var_15_9, var_15_8))
end
...
local function var_0_8(arg_16_0)
	...
	local var_16_3 = var_16_2(var_16_1, var_1_10004.CHALLENGE_FLEET_ID)

	table = var_16_1

	local var_16_4 = var_16_1.insertto
	local var_16_5 = var_16_0

	getProxy = var_1_10005
	BayProxy = var_1_10006

	local var_16_6 = var_1_10005(var_1_10006)

	var_16_4(var_16_5, var_5.getShipsByFleet(var_16_6, var_16_3))
	...
	local var_16_9 = var_16_8(var_16_7, var_5.CHALLENGE_SUB_FLEET_ID)

	table = var_16_7

	local var_16_10 = var_16_7.insertto
	local var_16_11 = var_16_0

	getProxy = var_16_6
	BayProxy = var_7

	local var_16_12 = var_16_6(var_7)

	var_16_10(var_16_11, var_6.getShipsByFleet(var_16_12, var_16_9))
