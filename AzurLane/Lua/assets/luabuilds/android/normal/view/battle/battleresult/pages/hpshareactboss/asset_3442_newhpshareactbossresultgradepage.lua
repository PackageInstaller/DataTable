...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..activityBoss.NewActivityBossResultGradePage"))
...
function var_0_1.GetGetObjectives(arg_3_0)
	...
	local var_3_4 = var_3_2("battle_result_total_damage")
	...
	var_3_7.text = var_1_10008(var_3_4, "#FFFFFFFF")
	setColorStr = var_8

	local var_3_8 = var_3_0.statistics.specificDamage

	COLOR_BLUE = var_10
	var_3_7.value = var_8(var_3_8, var_10)
	...
	setColorStr = var_3_8
	var_3_12.text = var_3_8(var_3_9, "#FFFFFFFF")
	setColorStr = var_9

	local var_3_13 = var_3_3

	COLOR_YELLOW = var_11
	var_3_12.value = var_9(var_3_13, var_11)
