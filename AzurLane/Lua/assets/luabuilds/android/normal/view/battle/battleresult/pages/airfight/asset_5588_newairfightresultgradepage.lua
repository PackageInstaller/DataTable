...
function var_0_1.GetGetObjectives(arg_2_0)
	...
	var_2_5.text = var_1_10007(var_2_2, "#FFFFFFFF")
	setColorStr = var_7

	local var_2_6 = var_2_1.score

	COLOR_BLUE = var_9
	var_2_5.value = var_7(var_2_6, var_9)
	...
	setColorStr = var_2_6
	var_2_10.text = var_2_6(var_2_7, "#FFFFFFFF")
	setColorStr = var_8

	local var_2_11 = -var_2_1.lose

	COLOR_BLUE = var_10
	var_2_10.value = var_8(var_2_11, var_10)
	...
	setColorStr = var_2_11
	var_2_15.text = var_2_11(var_2_12, "#FFFFFFFF")
	setColorStr = var_9

	local var_2_16 = var_2_1.total

	COLOR_YELLOW = var_11
	var_2_15.value = var_9(var_2_16, var_11)
