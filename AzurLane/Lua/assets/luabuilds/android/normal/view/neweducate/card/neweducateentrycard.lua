...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.levelText = var_1_3(var_1_2, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.nameText = var_1_6(var_1_5, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.descText = var_1_9(var_1_8, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.countText = var_1_12(var_1_11, var_4(var_1_10005))
...
function var_0_0.Update(arg_2_0, arg_2_1)
	...
	var_3(var_2_4, var_2_5, var_6.Find(var_2_6, "icon"))
...
function var_0_0.UpdateCountDesc(arg_4_0)
	...
	local var_4_3 = var_4_1(arg_4_0.config.count_desc)

	string = var_3

	local var_4_4 = var_3.gsub(var_4_3, "{(%d+),%$val}", function(arg_5_0)
	...
	if var_4_2.GetDisplayCounterData(var_4_5, arg_4_0.config.debuff_tag) then
		string = var_4_5
		var_4_4 = var_4_5.gsub(var_4_4, "{(%d+),(%d+),(%d+)}", function(arg_6_0, arg_6_1, arg_6_2)
			local var_6_0 = var_0
...
function var_0_0.StaticShow(arg_8_0, arg_8_1)
	...
	local var_8_2 = arg_8_0.Find(var_8_1, "level/Text")

	GetRomanDigitPlus = var_8_1

	var_1_10003(var_8_2, var_8_1(var_8_0.rare))
	...
	local var_8_3 = var_8_0.benefit_level
	local var_8_4 = 1 < var_8_3 and "bg_entry_2" or "bg_entry"

	LoadImageSpriteAtlasAsync = var_4

	var_4("ui/neweducateentrycard_atlas", var_8_4, arg_8_0:Find("icon"))
