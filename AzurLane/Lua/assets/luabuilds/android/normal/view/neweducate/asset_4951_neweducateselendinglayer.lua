...
local var_0_0 = "NewEducateSelEndingLayer"
...
function var_0_1.didEnter(arg_4_0)
	...
	local function var_4_2()
		...
		NewEducateSelEndingMediator = var_2_10002

		var_5_1(var_5_0, var_2_10002.ON_SELECT_ENDING, arg_4_0.endingList[arg_4_0.selectedIdx])
...
function var_0_1.InitItem(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_2 = var_1_10005.child2_ending[var_6_1]
	...
	var_1_10006("neweducateicon/" .. var_6_2.pic_preview, arg_6_2:Find("Image"))
...
function var_0_1.RefreshView(arg_8_0)
	local var_8_0 = arg_8_0.contextData.char
	local var_8_1 = var_1.GetFSM(var_8_0)
	local var_8_2 = var_1.GetState

	NewEducateFSM = var_1_10004

	local var_8_3 = var_8_2(var_8_1, var_1_10004.SYSTEM.ENDING)

	arg_8_0.endingList = var_2.GetEndings(var_8_3)

	local var_8_4 = arg_8_0.contextData.char
	local var_8_5 = var_3.GetPermanentData(var_8_4)

	arg_8_0.completeList = var_3.GetFinishedEndings(var_8_5)
	table = var_3

	local var_8_6 = var_3.sort
	local var_8_7 = arg_8_0.endingList

	CompareFuncs = var_1_10005

	var_8_6(var_8_7, var_1_10005({
		function(arg_9_0)
			table = var_2_10001
	...
	local var_8_8 = arg_8_0.uiList

	var_3.align(var_8_8, #arg_8_0.endingList)

	scrollTo = var_3

	var_3(arg_8_0.scrollrect, arg_8_0.uiList.container.rect.width / 2, 0)

	return
end

function var_0_1.OnSelDone(arg_11_0, arg_11_1)
	pg = var_1_10002

	local var_11_0 = var_1_10002.child2_ending[arg_11_1].performance

	NewEducateHelper = var_1_10003

	var_1_10003.PlaySpecialStory(var_11_0, function()
...
function var_0_1.willExit(arg_14_0)
	...
	var_1_10001(arg_14_0.contextData.onExit)
