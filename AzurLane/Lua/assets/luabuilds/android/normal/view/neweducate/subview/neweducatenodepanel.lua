...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Image = var_1_10004
	var_2_2(var_2_1, var_3(var_1_10004)).enabled = false
	...
	typeof = var_3
	CriManaCpkUI = var_1_10004
	arg_2_0.loopCpkPlayer = var_2_5(var_2_4, var_3(var_1_10004))
	...
	var_2_7(var_2_6, var_3.CriManaMovieMaterialBase.MaxFrameDrop.Infinite)
	...
	arg_2_0.cpkHandler = var_2_8(var_2.Find(var_2_9, "cpk"))
	NewEducatePictureHandler = var_1

	local var_2_10 = var_1.New
	local var_2_11 = arg_2_0._tf

	arg_2_0.pictureHandler = var_2_10(var_2.Find(var_2_11, "picture"))
	NewEducateWordHandler = var_1

	local var_2_12 = var_1.New
	local var_2_13 = arg_2_0._tf

	arg_2_0.wordHandler = var_2_12(var_2.Find(var_2_13, "dialogue"))
	NewEducateDropHandler = var_1

	local var_2_14 = var_1.New
	local var_2_15 = arg_2_0._tf

	arg_2_0.dropHandler = var_2_14(var_2.Find(var_2_15, "drop"))
	NewEducateSiteHandler = var_1

	local var_2_16 = var_1.New
	local var_2_17 = arg_2_0._tf

	arg_2_0.siteHandler = var_2_16(var_2.Find(var_2_17, "site"))
	NewEducateOptionsHandler = var_1

	local var_2_18 = var_1.New
	local var_2_19 = arg_2_0._tf

	arg_2_0.optionsHandler = var_2_18(var_2.Find(var_2_19, "options"))
	NewEducateMinigameHandler = var_1

	local var_2_20 = var_1.New
	local var_2_21 = arg_2_0._tf

	arg_2_0.minigameHandler = var_2_20(var_2.Find(var_2_21, "minigame"), arg_2_0.contextData.view)
	...
	local var_2_24 = var_2.Find(var_2_23, "root/window/left/title/Text")

	i18n = var_2_23

	var_1(var_2_24, var_2_23("child_plan_perform_title"))

	local var_2_25 = arg_2_0.scheduleTF
	local var_2_26 = var_1.Find(var_2_25, "root/window/left/content")

	UIItemList = var_2_25
	arg_2_0.planUIList = var_2_25.New(var_2_26, var_2_26:Find("tpl"))
	...
	var_1.make(var_4_1, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventInit then
			...
			if var_6_0 then
				...
				pg = var_5
				var_2_10004 = var_2_10004 .. var_5.child2_plan[var_6_0].replace_type_show
			...
			if arg_6_0 == var_6_0.EventUpdate then
				...
				if arg_4_0.plans[arg_6_1] then
					...
					shortenString = var_6_1
					pg = var_7

					var_2_10004(var_6_2, var_6_1(var_7.child2_plan[var_3].name_2, 4))
					...
					var_5(var_6_4, var_6_3.NewHex(var_2_10004))
					...
					local var_6_6 = arg_6_2.Find(var_6_5, "Text")

					i18n = var_6_5

					var_2_10004(var_6_6, var_6_5("child2_empty_plan"))
...
function var_0_1.PlayLoopCpk(arg_7_0, arg_7_1)
	...
	var_2.SetCpkTotalTimeCallback(var_7_3, function(arg_8_0)
		...
		typeof = var_2_10003
		Image = var_2_10004
		var_8_1(var_8_0, var_2_10003(var_2_10004)).enabled = true
...
function var_0_1.StopLoopCpk(arg_9_0)
	...
	typeof = var_3
	Image = var_1_10004
	var_9_1(var_9_0, var_3(var_1_10004)).enabled = false
...
function var_0_1.StartNode(arg_10_0, arg_10_1)
	...
	var_2(var_10_2, var_10_3 == var_1_10005.SYSTEM.PLAN)

	local var_10_4 = arg_10_0.stystemNo

	NewEducateFSM = var_10_2

	if var_10_4 == var_10_2.SYSTEM.MAP then
		...
		local var_10_8 = var_10_7(var_10_6, var_4.SYSTEM.MAP)
		...
		if var_10_11 == var_6.SITE_TYPE.WORK then
			...
			if var_10_11 == var_10_14.SITE_TYPE.TRAVEL then
				...
				NewEducateConst = var_1_10008
				var_10_12 = var_10_16(var_10_15, var_1_10008.SITE_NORMAL_TYPE.TRAVEL)
			end
		end
		...
		if var_10_12 ~= 0 then
			...
			var_10_21(var_10_20, var_1_10009.child2_site_normal[var_10_12].cpk[var_10_19])
		end
	end
...
function var_0_1.OnNodeChainEnd(arg_11_0)
	...
	if var_11_0 == var_2.SYSTEM.MAP then
		var_11_1 = arg_11_0.cpkHandler

		var_1.Reset(var_11_1)

		var_11_1 = arg_11_0.pictureHandler

		var_1.Reset(var_11_1)

		var_11_1 = arg_11_0.wordHandler

		var_1.Reset(var_11_1)

		var_11_1 = arg_11_0.dropHandler

		var_1.Reset(var_11_1)

		var_11_1 = arg_11_0.minigameHandler

		var_1.Reset(var_11_1)

		var_11_1 = arg_11_0.siteHandler

		var_1.OnEventEnd(var_11_1)
	else
		local var_11_2 = arg_11_0.stystemNo

		NewEducateFSM = var_11_1

		if var_11_2 == var_11_1.SYSTEM.PLAN then
			local var_11_3 = arg_11_0.contextData.char
			local var_11_4 = var_1.GetFSM(var_11_3)
			local var_11_5 = var_1.GetState

			NewEducateFSM = var_3

			local var_11_6 = var_11_5(var_11_4, var_3.SYSTEM.PLAN)

			if var_1.IsFinish(var_11_6) then
				arg_11_0:Hide()
			end
		else
			arg_11_0:Hide()
	...
	var_2(arg_12_1, {
		[var_0_1.NEXT_TYPE.NOMARL] = function()
			function arg_12_0.callback()
				...
				var_14_1(var_14_0, var_3_10002.NEW_EDUCATE_TRIGGER_NODE, {
		...
		[var_0_1.NEXT_TYPE.PROBABILITY] = function()
			function arg_12_0.callback()
				...
				var_16_1(var_16_0, var_3_10002.NEW_EDUCATE_TRIGGER_NODE, {
					id = arg_12_0.contextData.char.id
				})
		...
		[var_0_1.NEXT_TYPE.OPTION] = function()
			function arg_12_0.callback(arg_18_0, arg_18_1)
				...
				var_18_1(var_18_0, var_3_10004.NEW_EDUCATE_TRIGGER_NODE, {
					id = arg_12_0.contextData.char.id,
					branch = arg_18_0,
					costs = arg_18_1
				})
		...
		[var_0_1.NEXT_TYPE.STORY_FLAG] = function()
			function arg_12_0.callback(arg_20_0)
				...
				var_20_1(var_20_0, var_3_10003.NEW_EDUCATE_TRIGGER_NODE, {
					id = arg_12_0.contextData.char.id,
					branch = arg_20_0
				})
...
function var_0_1.CheckSchedule(arg_22_0)
	...
	if var_22_0 == var_1_10002.SYSTEM.PLAN then
		...
		local var_22_4 = var_22_3(var_22_2, var_1_10003.SYSTEM.PLAN)
...
function var_0_1.CheckLastDrops(arg_23_0, arg_23_1, arg_23_2)
	if not arg_23_0.curNodeId or not arg_23_1 or #arg_23_1 == 0 then
		...
		var_1_10005(var_23_0, {
			[var_0_1.DROP_TYPE.WORD_PERFORMANCE] = function()
				...
				if var_24_0 == var_2_10001.SYSTEM.PLAN then
					...
					local var_24_4 = var_24_3(var_24_2, var_2_10002.SYSTEM.PLAN)
				...
				var_2_10000({
					function(arg_27_0)
						...
						if #var_3_10001.select(arg_23_1, function(arg_28_0)
							...
							NewEducateBaseUI = var_3_10004

							var_27_1(var_27_0, var_3_10004.ON_DROP, {
								items = var_1,
								removeFunc = arg_27_0
							})
						else
			...
			[var_0_1.DROP_TYPE.POLAROID] = function()
				...
				for iter_30_0, iter_30_1 in var_30_2(arg_23_1) do
					assert = var_2_10006

					local var_30_4 = iter_30_1.type

					NewEducateConst = var_2_10008

					var_2_10006(var_30_4 == var_2_10008.DROP_TYPE.POLAROID, "drop_type_client4的掉落必须为大头贴")
				...
				var_1(var_30_3, function()
					...
					if #arg_23_1 > 0 then
						...
						var_33_1(var_33_0, var_3_10002("child_polaroid_get_tip"))
					end
			...
			[var_0_1.DROP_TYPE.DROP_LAYER] = function()
				...
				var_34_1(var_34_0, var_2_10002.ON_DROP, {
					items = arg_23_1,
					removeFunc = arg_23_2
				})
			...
			NewEducateBaseUI = var_2

			var_35_1(var_35_0, var_2.ON_DROP, {
				items = arg_23_1,
				removeFunc = arg_23_2
			})
		...
		if var_23_1 == var_6.SYSTEM.MAP and var_23_0 == var_0_1.DROP_TYPE.WORD_PERFORMANCE then
...
function var_0_1._ProceedNode(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	arg_39_0.CheckSchedule(var_39_0)

	pg = var_4

	local var_39_1 = var_4.child2_node[arg_39_1]

	originalPrint = var_39_0

	var_39_0("ProceedNode", arg_39_1)
	arg_39_0:InitCallback(var_39_1.next_type)
	...
	var_5(var_39_1.type, {
		[var_0_1.NODE_TYPE.PERFORMANCE] = function()
			...
			var_0.PlayPerformances(var_40_0, var_39_1.performance_type, var_39_1.performance_param, arg_39_0.callback)
		...
		[var_0_1.NODE_TYPE.STORY_BRANCH] = function()
			...
			var_0.PlayStoryBranch(var_42_0, var_39_1.performance_param, function(arg_43_0)
		...
		[var_0_1.NODE_TYPE.MAIN_TEXT] = function()
			...
			local var_46_1 = var_0._IsShowNextInMainText(var_46_0, var_39_1)

			if var_39_1.next_type == var_0_1.NEXT_TYPE.OPTION then
				local function var_46_2()
					local var_47_0 = arg_39_0.optionsHandler

					var_0.Play(var_47_0, var_39_1.next, arg_39_0.callback)

					return
				end

				var_2_10003 = arg_39_0.wordHandler

				local var_46_3 = var_2.Play

				tonumber = var_2_10004

				var_46_3(var_2_10003, var_2_10004(var_39_1.text), var_46_2, nil, var_46_1, true)
			else
				...
				var_46_5(var_46_4, var_2_10003(var_39_1.text), arg_39_0.callback, nil, var_46_1, true)
			end
		...
		var_2_10000(false, "node表非法type: " .. var_39_1.type)
...
function var_0_1.PlayPerformances(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	...
	var_51_1[var_1_10007.PERFORM_TYPE.CPK] = function()
		...
		if var_52_5 == var_2_10003.SYSTEM.PLAN then
		...
		var_52_8(var_52_7, var_52_9 == var_2_10005.SYSTEM.PLAN)
	...
	var_51_1[var_7.PERFORM_TYPE.PICTURE] = function()
	...
	NewEducateConst = var_7
	var_51_1[var_7.PERFORM_TYPE.WORD] = function()
		pg = var_2_10000
	...
	NewEducateConst = var_7
	var_51_1[var_7.PERFORM_TYPE.STORY] = function()
	...
	NewEducateConst = var_7
	var_51_1[var_7.PERFORM_TYPE.MINIGAME] = function()
		local var_57_0 = arg_51_0.minigameHandler
		local var_57_1 = var_0.Play

		tonumber = var_2_10002

		var_57_1(var_57_0, var_2_10002(arg_51_2), function(arg_58_0)
			arg_51_3(arg_58_0)
