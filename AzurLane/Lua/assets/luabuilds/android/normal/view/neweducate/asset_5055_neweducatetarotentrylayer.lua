...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.progressPart = var_2_0(var_2.Find(var_2_1, "progress"), arg_2_0)
	NewEducateTopRes = var_1

	local var_2_2 = var_1.New
	local var_2_3 = arg_2_0._tf

	arg_2_0.resPart = var_2_2(var_2.Find(var_2_3, "res"), arg_2_0)
	...
	var_1(var_2_6, var_2_5("child2_show_detail_desc"))
	...
	local var_2_9 = var_2.Find(var_2_8, "all/Text")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("child2_all_entry_title"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.allEntryCntText = var_2_12(var_2_11, var_3(var_4))
	...
	arg_2_0.detailEntryCard = var_2_16(var_2.Find(var_2_17, "entry"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.detailLevelText = var_2_20(var_2_19, var_3(var_4))
	...
	var_1(var_2_24, var_2_23("child2_word_upgrade"))
	...
	var_1(var_2_27, var_2_26("child2_word_giveup"))
	...
	local var_2_30 = var_2.Find(var_2_29, "Text")

	i18n = var_2_29

	var_1(var_2_30, var_2_29("child2_go_shop"))
	...
	local var_2_35 = var_2.Find(var_2_34, "list")
	local var_2_36 = arg_2_0.summaryTF

	arg_2_0.pctUIList = var_2_33(var_2_35, var_3.Find(var_2_36, "list/tpl"))
	getProxy = var_1
...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3_4, var_3_5, var_3_6, var_5)
	...
	local function var_3_9()
		...
		NewEducateTarotEntryMediator = var_2_10002

		var_6_1(var_6_0, var_2_10002.ON_GIVE_UP_ENTRY_UP)
	...
	var_1(var_3_7, var_3_8, var_3_9, var_5)
		...
		var_2_10000({
			function(arg_8_0)
				if arg_3_0.type == var_0_1.TYPE.SHOP then
					...
					NewEducateTarotEntryMediator = var_3_10003

					var_8_1(var_8_0, var_3_10003.ON_SHOPPING, arg_3_0.contextData.goodId, arg_8_0)
				else
					arg_8_0()
				end
			...
			var_9_1(var_9_0, var_3_10003.ON_UPGRADE_ENTRY, arg_3_0.selectId)
	...
	local function var_3_15()
		...
		var_10_5(var_10_4, var_10_6, var_2_10003.NEW_EDUCATE_MAP, {
			openShop = true
		})
	...
	local var_3_18 = var_3.Find(var_3_17, "tip")
	...
	local function var_3_19()
		...
		pg = var_2_10003
		var_11_2.helps = var_2_10003.gametip.child2_choose_help.tip
	...
	local function var_3_22(arg_12_0)
		if arg_12_0 then
			...
			var_2_10002(var_3.Find(var_12_0, "Text"), var_2_10001)
			...
			var_12_2(var_3.GetBenefitShowLocalKey(var_12_3), arg_12_0 and 1 or 0)
	...
	var_1(var_3_20, var_3_21, var_3_22, var_5)
	...
	var_1.make(var_3_23, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_5.EventInit then
			...
			if arg_13_0 == var_5.EventUpdate then
				...
				local var_13_4 = var_13_3(var_13_2, var_2_10007(var_2_10008)).isOn
				...
				var_8(arg_13_2:Find("info/content/name"), var_13_1.name)

				i18n = var_8

				local var_13_7 = var_8("child2_benefit_summary")
				...
				local var_13_11 = var_13_7 .. var_13_8 .. var_13_9 .. var_13_10 .. var_2_10012("child2_benefit_summary2") .. var_13_6 .. "%"

				setText = var_13_8

				var_13_8(arg_13_2:Find("info/content/desc"), var_13_11)

				local var_13_12 = arg_3_0.contextData.char
				local var_13_13 = var_9.GetOwnCnt(var_13_12, var_13_0)
				local var_13_14 = var_13_0.type

				NewEducateConst = var_11

				if var_13_14 == var_11.DROP_TYPE.ATTR then
					NewEducateInfoPanel = var_13_14

					local var_13_15

					var_13_14, var_13_15 = var_13_14.GetArrtInfo(var_13_1.rank, var_13_13)
					setText = var_12

					var_12(arg_13_2:Find("info/content/value"), var_13_15)
				else
					setText = var_13_14

					var_13_14(arg_13_2:Find("info/content/value"), var_13_13)
				end
			end
		end
	...
	var_1(var_3_25, var_3.IsShowTarotDeatilDesc())
...
function var_0_1.UpdateView(arg_17_0)
	...
	arg_17_0.entries = var_17_5(var_17_4, var_3.TYPE.ENTRY)
...
function var_0_1.UpdataUpgrade(arg_20_0)
	...
	var_1_10001(var_2.Find(var_20_0, "res"), arg_20_0.type == var_0_1.TYPE.SHOP)
	...
	if arg_20_0.type == var_0_1.TYPE.SHOP then
		...
		var_1(var_2.Find(var_20_1, "res/Text"), "-" .. arg_20_0.contextData.cost)
	end
	...
	var_2(var_3.Find(var_20_3, "name"), var_20_2.name)

	setText = var_2

	local var_20_4 = arg_20_0.upgradeTF

	var_2(var_3.Find(var_20_4, "before/level/Text"), "LV." .. var_20_2.benefit_level)

	setText = var_2

	local var_20_5 = arg_20_0.upgradeTF

	var_2(var_3.Find(var_20_5, "before/desc/Text"), var_20_2.desc)
	...
	var_3(var_4.Find(var_20_7, "after/level/Text"), "LV." .. arg_20_0.config[var_20_6].benefit_level)

	setText = var_3

	local var_20_8 = arg_20_0.upgradeTF

	var_3(var_4.Find(var_20_8, "after/desc/Text"), var_20_2.upgrade_desc)
...
function var_0_1.UpdataDetail(arg_21_0)
	...
	if arg_21_0.selectId then
		...
		local var_21_5 = var_3.GetComponent

		typeof = var_1_10005
		Toggle = var_1_10006

		var_21_3(var_21_2, var_21_5(var_21_4, var_1_10005(var_1_10006)).isOn)
	end
...
function var_0_1.UpdateSummary(arg_22_0)
	...
	local var_22_2 = var_2.GetPermanentData(var_22_1)
	local var_22_3 = var_22_0(var_2.GetAllBuffIds(var_22_2), function(arg_23_0)
	...
	ipairs = var_3
	NewEducateBenefit = var_4

	for iter_22_0, iter_22_1 in var_3(var_4.GetDisplayPctList(arg_22_0.contextData.char)) do
		local var_22_6, var_22_7 = var_22_5:GetDisplayPctByDrop(iter_22_1)

		table = var_10

		var_10.insert(arg_22_0.showPctList, {
			drop = iter_22_1,
			a = var_22_6,
			b = var_22_7
		})
	...
	local var_22_8 = var_3.GetInt(arg_22_0:GetBenefitShowLocalKey())

	triggerToggle = var_4

	var_4(arg_22_0.summaryToggleTF, var_22_8 == 1)
...
function var_0_1.GetGoBtnVisibility(arg_25_0)
	...
	NewEducateFSM = var_25_2

	if var_25_3 == var_25_2.SYSTEM.ENDING then
		return false
	end
	...
	NewEducateFSM = var_25_5

	if var_25_6 == var_25_5.SYSTEM.ENDING then
		return false
	end
...
function var_0_1.OnUpdateItem(arg_27_0, arg_27_1, arg_27_2)
	...
	var_5(var_6.Find(var_27_2, "sel"), false)
	...
	local function var_27_5()
		...
		for iter_28_0, iter_28_1 in var_2_10000(arg_27_0.cards) do
			...
			var_2_10005(var_6.Find(var_28_0, "sel"), false)
		end
		...
		var_28_1(var_1.Find(var_28_2, "sel"), true)
		...
		if not arg_27_0.triggerFirstCard then
			...
			var_0(var_1.Find(var_28_3, "sel"), true)
			...
			local var_28_7 = var_28_6(var_28_5, var_2(var_3))
	...
	var_5(var_27_3, var_27_4, var_27_5, var_1_10009)
...
function var_0_1.OnUpgradeDone(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10002(arg_30_0.cards) do
		if iter_30_1.id == arg_30_1.entryId then
			...
			local var_30_3 = var_30_2(var_30_1, var_9(var_1_10010))
	...
	var_2({
		...
		function(arg_32_0)
			if #arg_30_1.drops > 0 or #arg_30_0.showpDrops > 0 then
				...
				table = var_2_10005
				var_32_3.items = var_2_10005.mergeArray(arg_30_1.drops, arg_30_0.showpDrops)
