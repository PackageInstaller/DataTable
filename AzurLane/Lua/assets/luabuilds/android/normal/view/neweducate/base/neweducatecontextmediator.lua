...
function var_0_1.onRegister(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.GO_SCENE, function(arg_2_0, arg_2_1, ...)
	...
	var_1_3(var_1_2, var_3.CHANGE_SCENE, function(arg_3_0, arg_3_1, ...)
	...
	var_1_5(var_1_4, var_3.GO_SUBLAYER, function(arg_4_0, arg_4_1, arg_4_2)
	...
	var_1_7(var_1_6, var_3.ON_DROP, function(arg_5_0, arg_5_1)
		...
		NewEducateDropMediator = var_2_10006
		var_5_3.mediator = var_2_10006
		NewEducateDropLayer = var_2_10006
	...
	var_1_9(var_1_8, var_3.ON_ITEM, function(arg_6_0, arg_6_1)
		...
		var_6_4.type = var_2_10008.TYPE.ITEM
	...
	var_1_11(var_1_10, var_3.ON_BOX, function(arg_7_0, arg_7_1)
		...
		NewEducateMsgBoxLayer = var_2_10008
		var_7_4.type = var_2_10008.TYPE.BOX
	...
	var_1_13(var_1_12, var_3.ON_SHOP, function(arg_8_0, arg_8_1)
		...
		NewEducateMsgBoxLayer = var_2_10008
		var_8_4.type = var_2_10008.TYPE.SHOP
		var_8_3.data = var_2_10006(var_8_4, {
			__index = arg_8_1
		})
	...
	var_1_15(var_1_14, var_3.ON_PRIORITY_STATE, function(arg_9_0, arg_9_1)
...
function var_0_1.CheckPriorityState(arg_10_0, arg_10_1)
	...
	if not var_2.CheckPriorityStystem(var_10_1) then
		...
		var_10_3(var_10_2, var_1_10005.NEW_EDUCATE_CHECK_FSM)

		return
	end

	local var_10_4 = var_2
	local var_10_5 = var_2.GetPriorityState(var_10_4)

	switch = var_10_4

	local var_10_6 = var_10_5:GetSystemNo()
	local var_10_7 = {}

	NewEducatePriorityFSM = var_1_10007
	var_10_7[var_1_10007.SYSTEM.CHOOSE] = function()
	...
	NewEducatePriorityFSM = var_7
	var_10_7[var_7.SYSTEM.UPGRADE_ENTRY] = function()
	...
	NewEducatePriorityFSM = var_7
	var_10_7[var_7.SYSTEM.REPLACE_TAROT] = function()
	...
	var_10_4(var_10_6, var_10_7, function()
		assert = var_2_10000
...
function var_0_1.PriorityChooseHandler(arg_15_0, arg_15_1)
	...
	NewEducateChooseLayer = var_1_10006
	var_15_3.viewComponent = var_1_10006
	NewEducateChooseMediator = var_1_10006
...
function var_0_1.PriorityUpEntryHandler(arg_17_0, arg_17_1)
	...
	local var_17_2 = var_1_10004.New
	local var_17_3 = {}

	NewEducateTarotEntryLayer = var_1_10006
	var_17_3.viewComponent = var_1_10006
	NewEducateTarotEntryMediator = var_1_10006
	var_17_3.mediator = var_1_10006

	local var_17_4 = {}

	if not arg_17_1 or not arg_17_1.type then
		NewEducateTarotEntryLayer = var_1_10007
		var_1_10007 = var_1_10007.TYPE.DROP
	end

	var_17_4.type = var_1_10007
...
function var_0_1.PriorityReplaceTarotHandler(arg_19_0, arg_19_1)
	...
	local var_19_2 = var_1_10004.New
	local var_19_3 = {}

	NewEducateReplaceTarotLayer = var_1_10006
	var_19_3.viewComponent = var_1_10006
	NewEducateReplaceTarotMediator = var_1_10006
	var_19_3.mediator = var_1_10006
	var_19_3.data = {
		onExit = function()
