	...
	var_1_10001({
		function(arg_6_0)
			if arg_4_0.contextData.isFavor then
				...
				var_1(var_6_0, var_3.GetFavorInfo(var_6_1).lv)
				...
				var_6_3(var_6_2, var_3.delayedCall, arg_6_0, 1, nil)
			else
				arg_6_0()
			end
...
function var_0_1.ShowAwardWindow(arg_8_0)
	...
	var_8_0.insert(var_8_1, function(arg_9_0)
	...
	for iter_8_0 = 1, #arg_8_0.drops do
		...
		var_1_10006.insert(var_8_1, function(arg_11_0)
			...
			var_3.UpdateItem(var_11_1, var_11_0)
			...
			var_3(arg_8_0, var_11_1, function()
				...
				NewEducateBaseUI = var_3_10002

				var_12_1(var_12_0, var_3_10002.ON_ITEM, {
					drop = var_11_0
				})
			...
			var_11_3(var_11_2, var_5.delayedCall, function()
				arg_11_0()
	...
	var_2(var_8_1, function()
		...
		var_14_1(var_14_0, var_2_10002.delayedCall, function()
