...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_SELECT_MIND, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.NEW_EDUCATE_SEL_MIND, {
	...
	arg_1_0:bind(var_0_1.ON_UPGRADE_FAVOR, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.NEW_EDUCATE_UPGRADE_FAVOR, {
			id = arg_1_0.contextData.char.id,
			callback = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_TRIGGER_MAIN_EVENT, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10003.NEW_EDUCATE_MAIN_EVENT, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_REQ_TALENTS, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.NEW_EDUCATE_GET_TALENTS, {
			id = arg_1_0.contextData.char.id,
			callback = arg_6_1
		})
	...
	arg_1_0:bind(var_0_1.ON_REQ_CHOOSE, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_2_10004.NEW_EDUCATE_GET_CHOOSE, {
			id = arg_1_0.contextData.char.id,
			callback = arg_7_1
		})
	...
	arg_1_0:bind(var_0_1.ON_REQ_TOPICS, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.NEW_EDUCATE_GET_TOPICS, {
			id = arg_1_0.contextData.char.id,
			callback = arg_8_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SELECT_TOPIC, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10004.NEW_EDUCATE_SEL_TOPIC, {
			id = arg_1_0.contextData.char.id,
			topicId = arg_9_1
		})
	...
	arg_1_0:bind(var_0_1.ON_NEXT_PLAN, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10004.NEW_EDUCATE_NEXT_PLAN, {
			rePlay = true,
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_ENTER_ASSESS, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10004.NEW_EDUCATE_ENTER_ASSESS, {
			id = arg_1_0.contextData.char.id,
			callback = arg_11_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SET_ASSESS_RANK, function(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
		...
		var_12_1(var_12_0, var_2_10006.NEW_EDUCATE_ASSESS, {
			id = arg_1_0.contextData.char.id,
			rank = arg_12_1,
	...
	arg_1_0:bind(var_0_1.ON_STAGE_CHANGE, function(arg_13_0)
		...
		var_13_1(var_13_0, var_2_10003.NEW_EDUCATE_CHANGE_PHASE, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_REQ_MAP, function(arg_14_0)
		...
		var_14_1(var_14_0, var_2_10003.NEW_EDUCATE_GET_MAP, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_REQ_ENDINGS, function(arg_15_0, arg_15_1)
		...
		var_15_1(var_15_0, var_2_10004.NEW_EDUCATE_GET_ENDINGS, {
			id = arg_1_0.contextData.char.id,
			callback = arg_15_1
		})
	...
	arg_1_0:bind(var_0_1.ON_RESET, function(arg_16_0, arg_16_1)
		...
		var_16_1(var_16_0, var_2_10004.NEW_EDUCATE_RESET, {
			id = arg_1_0.contextData.char.id,
	...
	arg_1_0:bind(var_0_1.ON_SELECT_ENDING, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_2_10004.NEW_EDUCATE_SEL_ENDING, {
			isMain = true,
			id = arg_1_0.contextData.char.id,
			endingId = arg_17_1
		})
	...
	arg_1_0:bind(var_0_1.ON_START_ENDLESS, function(arg_18_0)
		...
		var_18_1(var_18_0, var_2_10003.NEW_EDUCATE_CHANGE_PHASE, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_CLEAR_NODE_CHAIN, function(arg_19_0)
		...
		var_19_1(var_19_0, var_2_10003.NEW_EDUCATE_CLEAR_NODE_CHAIN, {
			id = arg_1_0.contextData.char.id
		})
...
function var_0_1.handleNotification(arg_21_0, arg_21_1)
	...
	NewEducateProxy = var_21_1

	if var_21_0 == var_21_1.RESOURCE_UPDATED then
		...
		if var_21_0 == var_4.ATTR_UPDATED then
			...
			if var_21_0 == var_4.PERSONALITY_UPDATED then
				...
				if var_21_0 == var_4.TALENT_UPDATED then
					...
					if var_21_0 == var_4.STATUS_UPDATED then
						...
						if var_21_0 == var_4.TAROT_UPDATED then
							...
							if var_21_0 == var_4.NEXT_ROUND then
								...
								if var_21_0 == var_4.NEW_EDUCATE_NODE_START then
									...
									if var_21_0 == var_4.NEW_EDUCATE_NEXT_NODE then
										...
										if var_21_0 == var_4.NEW_EDUCATE_CHECK_FSM then
											...
											if var_21_0 == var_4.NEW_EDUCATE_CHECK_PRIORITY_FSM then
												...
												if var_21_0 == var_4.NEW_EDUCATE_GET_EXTRA_DROP_DONE then
													if #var_21_2.drops == 0 then
														...
														NewEducateBaseUI = var_1_10006

														var_21_14(var_21_13, var_1_10006.ON_DROP, {
													...
													if var_21_0 == var_21_14.NEW_EDUCATE_UPGRADE_FAVOR_DONE then
														...
														var_21_17(var_21_16, var_1_10006.ON_DROP, {
															isFavor = true,
															items = var_21_2.drops,
															removeFunc = function()
														...
														if var_21_0 == var_21_17.NEW_EDUCATE_REFRESH_DONE then
															...
															if var_21_0 == var_4.NEW_EDUCATE_SEL_TOPIC_DONE then
																...
																if var_21_0 == var_4.NEW_EDUCATE_ENTER_ASSESS_DONE then
																	if #var_21_2.drops == 0 then
																		existCall = var_21_20
																		...
																		var_21_20(var_21_19, var_1_10006.ON_DROP, {
																			items = var_21_2.drops,
																	...
																	if var_21_0 == var_21_20.NEW_EDUCATE_ASSESS_DONE then
																		seriesAsync = var_4
																		...
																		var_4({
																			function(arg_24_0)
																				if #var_21_2.drops == 0 then
																					...
																					var_24_1(var_24_0, var_2_10003.ON_DROP, {
																						items = var_21_2.drops,
																						removeFunc = arg_24_0
																					})
																				end
																		...
																		if var_21_0 == var_4.NEW_EDUCATE_CHANGE_PHASE_DONE then
																			...
																			if var_21_0 == var_4.NEW_EDUCATE_NEXT_PLAN_DONE then
																				function var_21_22()
																				...
																				if #var_21_2.drops == 0 then
																					...
																					var_21_23(var_1_10006, var_1_10007.ON_DROP, {
																						items = var_21_2.drops,
																				...
																				if var_21_0 == var_21_22.NEW_EDUCATE_GET_MAP_DONE then
																					if #var_21_2.drops == 0 then
																						...
																						var_21_26(var_21_25, var_1_10006.ON_DROP, {
																							items = var_21_2.drops,
																							removeFunc = function()
																					...
																					if var_21_0 == var_21_26.NEW_EDUCATE_SEL_MIND_DONE then
																						arg_21_0:StartNodeWithCheckDrops(var_21_2)
																					else
																						GAME = var_4

																						if var_21_0 == var_4.NEW_EDUCATE_SEL_ENDING_DONE then
																							...
																							if var_21_0 == var_4.NEW_EDUCATE_SET_CALL_DONE then
...
function var_0_1.StartNodeWithCheckDrops(arg_29_0, arg_29_1)
	if #arg_29_1.drops == 0 then
		...
		var_29_2(var_29_1, var_1_10004.ON_DROP, {
...
function var_0_1.AddResultLayer(arg_31_0, arg_31_1)
	if #arg_31_1.scheduleDrops > 0 then
		...
		local var_31_2 = var_1_10004.New
		local var_31_3 = {}

		NewEducateScheduleResultLayer = var_1_10006
		var_31_3.viewComponent = var_1_10006
		NewEducateScheduleResultMediator = var_1_10006
		var_31_3.mediator = var_1_10006
		var_31_3.data = {
