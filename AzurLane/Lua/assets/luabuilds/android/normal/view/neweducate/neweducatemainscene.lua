...
function var_0_1.PlayBGM(arg_2_0)
	...
	if var_1.GetBgm(var_2_0) then
		...
		local var_2_1 = var_2_0.BgmMgr.GetInstance()
...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.mainAnim = var_3_2(var_3_1, var_3(var_1_10004))
	...
	var_1(var_2.Find(var_3_7, "arrows"), false)
	...
	setmetatable = var_4
	arg_3_0.topPanel = var_3_20(var_3_21, var_3_22, var_4({
		hideBlurBg = true
	}, {
	...
	setmetatable = var_4
	arg_3_0.nodePanel = var_3_29(var_3_30, var_3_31, var_4({
		view = arg_3_0
	}, {
		__index = arg_3_0.contextData
	}))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_5 = var_4.Find(var_4_4, "fitter")
	...
	var_2(var_4_3, var_4_5, var_4_6, var_6)
	...
	local function var_4_9()
		...
		if var_0.CheckPriorityStystem(var_6_1) then
			...
			var_6_3(var_6_2, var_2_10002("child2_priority_tip"))
		...
		NewEducateMainMediator = var_2

		var_6_5(var_6_4, var_2.ON_SELECT_MIND, function()
	...
	var_2(var_4_7, var_4_8, var_4_9, var_6)
	...
	local function var_4_12()
		...
		if var_0.CheckPriorityStystem(var_8_1) then
			...
			var_8_3(var_8_2, var_2_10002("child2_priority_tip"))
	...
	var_2(var_4_10, var_4_11, var_4_12, var_6)
	...
	local function var_4_15()
		...
		if var_0.CheckPriorityStystem(var_9_1) then
			...
			var_9_3(var_9_2, var_2_10002("child2_priority_tip"))
		...
		var_9_5(var_9_4, var_9_6, var_2_10003.NEW_EDUCATE_SCHEDULE, {
	...
	var_2(var_4_13, var_4_14, var_4_15, var_6)
	...
	local function var_4_18()
		...
		if var_0.CheckPriorityStystem(var_10_1) then
			...
			var_10_3(var_10_2, var_2_10002("child2_priority_tip"))
		...
		var_10_6(var_10_5, var_10_7, var_2_10003.NEW_EDUCATE_MAP)
	...
	var_2(var_4_16, var_4_17, var_4_18, var_6)
	...
	var_2(var_4_19, var_4_20, var_4_21, var_6)
	...
	var_2(var_4_22, var_4_23, var_4_24, var_6)
	...
	var_2(var_4_25, var_4_26, var_4_27, var_6)
	...
	var_2(var_4_28, var_4_29, var_4_30, var_6)
	...
	local function var_4_33()
		...
		local var_15_3 = var_15_2(var_15_1, var_2.SYSTEM.TOPIC)
		...
		if var_0.GetTopics(var_15_3)[1] then
			...
			var_15_5(var_15_4, var_2_10003.ON_SELECT_TOPIC, var_0[1])
		end
	...
	var_2(var_4_31, var_4_32, var_4_33, var_6)
	...
	var_4_34({
		...
		if arg_4_0.contextData.scheduleDataTable.OnScheduleDone then
			...
			if #var_17_0.drops == 0 then
				...
				var_17_2(var_17_1, var_2_10003.ON_DROP, {
...
function var_0_1.UpdatePaintingUI(arg_22_0)
	...
	setImageSprite = var_22_1

	local var_22_3 = arg_22_0.bgTF

	LoadSprite = var_1_10004

	var_22_1(var_22_3, var_1_10004("bg/" .. var_22_2), false)
...
function var_0_1.UpdatePaintingFace(arg_25_0, arg_25_1)
	...
	local var_25_5 = var_25_3.child2_node[arg_25_1].type

	NewEducateNodePanel = var_1_10005

	if var_25_5 == var_1_10005.NODE_TYPE.MAIN_TEXT then
		local var_25_6 = var_3.text

		pg = var_5

		if var_5.child2_word[var_25_6].main_character_face == 0 then
			if var_25_4 then
			...
			local var_25_7 = var_1_10006("paintingface/" .. arg_25_0.paintingName, var_5)

			if var_25_4 and var_25_7 then
				setImageSprite = var_7

				var_7(var_25_4, var_25_7)
...
function var_0_1.ShowDialogue(arg_26_0)
	...
	local var_26_1 = var_2.child2_word[arg_26_0.wordList[var_26_0]].word
	...
	local var_26_6 = var_26_2(var_26_3, var_26_4, var_6.GetCallName(var_26_5))
	...
	if var_4.Find(var_26_10, "face") and var_26_7 then
		...
		var_26_10(var_4, var_26_7)

		setActive = var_26_10

		var_26_10(var_4, true)
	end

	local var_26_11 = arg_26_0.dialogueTF

	Vector3 = var_6
	var_26_11.localScale = var_6.zero
	setActive = var_26_11
	...
	local var_26_14 = var_26_12(var_26_13, var_7.one, 0.3)
	local var_26_15 = var_5.setEase

	LeanTweenType = var_7

	local var_26_16 = var_26_15(var_26_14, var_7.easeOutBack)
	local var_26_17 = var_5.setOnComplete

	System = var_7

	var_26_17(var_26_16, var_7.Action(function()
		...
		local var_27_2 = var_27_0(var_27_1, var_2_10002.zero, 0.3)
		local var_27_3 = var_0.setEase

		LeanTweenType = var_2

		local var_27_4 = var_27_3(var_27_2, var_2.easeInBack)
		local var_27_5 = var_0.setDelay(var_27_4, 3)
		local var_27_6 = var_0.setOnComplete

		System = var_2

		var_27_6(var_27_5, var_2.Action(function()
...
function var_0_1.UpdataTopicAndMind(arg_29_0)
	...
	local var_29_6 = var_29_5(var_29_4, var_1_10005.SYSTEM.TOPIC)
	...
	if var_29_3.getConfig(var_29_7, "main_event_chat_node_id") ~= "" and #var_4 > 0 and not var_29_3:IsTemp() then
		local var_29_8 = var_29_1

		var_29_7 = var_29_1.GetState
		NewEducateFSM = var_1_10007
		var_29_7 = var_29_7(var_29_8, var_1_10007.SYSTEM.MIND)
		setActive = var_29_8

		var_29_8(arg_29_0.mindBtn, not var_29_7)
	else
		setActive = var_29_7

		var_29_7(arg_29_0.mindBtn, false)
	end
...
function var_0_1.CheckNewChar(arg_30_0, arg_30_1)
	...
	if var_2.GetCallName(var_30_0) == "" then
		...
		var_4.insert(var_30_3, function(arg_31_0)
		...
		var_4.insert(var_30_3, function(arg_32_0)
			...
			local var_32_3 = var_2_10004.New
			local var_32_4 = {}

			NewEducateSetCallediator = var_2_10006
			var_32_4.mediator = var_2_10006
			NewEducateSetCallLayer = var_2_10006
			var_32_4.viewComponent = var_2_10006
			var_32_4.data = {
				callback = arg_32_0
			}
...
function var_0_1.UpdateFavorInfo(arg_35_0)
	...
	local var_35_1 = var_2.Find(var_35_0, "Text")
	local var_35_2 = "Lv"
	local var_35_3 = arg_35_0.contextData.char

	var_1_10001(var_35_1, var_35_2 .. var_4.GetFavorInfo(var_35_3).lv)
...
function var_0_1.CheckFavorUpgrade(arg_36_0, arg_36_1)
	...
	if var_2.CheckFavor(var_36_0) then
		...
		var_36_2(var_36_1, var_1_10004.ON_UPGRADE_FAVOR, arg_36_1)
	else
		existCall = var_36_2
...
function var_0_1.CheckGameFSM(arg_38_0)
	...
	var_38_1("CheckGameFSM", var_1:GetSystemNo() .. "->" .. var_38_2)
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.EVENT] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.TALENT] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.TOPIC] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.MAP] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.PLAN] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.ASSESS] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.PHASE] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.ENDING] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.MIND] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.CHOOSE] = function()
	...
	NewEducateFSM = var_6
	var_38_4[var_6.SYSTEM.FAIL] = function()
...
function var_0_1.OnReset(arg_51_0)
	...
	var_51_5(var_51_4, var_51_6, var_1_10004.SYSTEM.INIT)
...
function var_0_1.UpdateBtns(arg_55_0, arg_55_1)
	...
	var_55_0(arg_55_0.resetInEndlessBtn, var_55_1:IsEndless())
	...
	var_55_0(var_55_2, arg_55_1 ~= var_5.SYSTEM.ENDING and not var_55_1:IsEndlessFail())
	...
	local var_55_6 = var_55_5(var_55_4, var_5.SYSTEM.MAP)

	setActive = var_55_4

	local var_55_7 = arg_55_0.mapBtn

	var_55_4(var_5.Find(var_55_7, "tip"), var_55_6 and var_55_6:IsSpecial())
...
function var_0_1.ContinuePlayNode(arg_57_0)
	...
	var_1_10001({
		function(arg_58_0)
			...
			i18n = var_2_10005
			var_58_3.content = var_2_10005("child2_replay_tip")
			i18n = var_5
			var_58_3.noText = var_5("child2_replay_clear")
			i18n = var_5
			var_58_3.yesText = var_5("child2_replay_continue")
			...
			function var_58_3.onNo()
				...
				NewEducateMainMediator = var_3_10002

				var_59_1(var_59_0, var_3_10002.ON_CLEAR_NODE_CHAIN)
		...
		local var_60_3 = var_2.GetFSM(var_60_2)

		var_60_1(var_60_0, var_2.GetCurNode(var_60_3))
	...
	var_1({
		...
		function(arg_63_0)
			if #arg_61_0.newRoundDrops > 0 then
				...
				var_63_1(var_63_0, var_2_10003.ON_DROP, {
		...
		NewEducateMainMediator = var_2_10002

		var_64_1(var_64_0, var_2_10002.ON_TRIGGER_MAIN_EVENT)
...
function var_0_1.TalentHandler(arg_65_0)
	...
	local var_65_3 = var_65_2(var_65_1, var_1_10003.SYSTEM.TALENT)

	seriesAsync = var_65_1
	...
	var_65_1({
		function(arg_66_0)
			if not var_65_3 then
				...
				var_66_1(var_66_0, var_2_10003.ON_REQ_TALENTS, arg_66_0)
			else
				arg_66_0()
			end
		...
		function(arg_67_0)
			...
			if var_1.IsTalentRound(var_67_1) then
				...
				local var_67_5 = var_2_10004.New
				local var_67_6 = {}

				NewEducateTalentMediator = var_2_10006
				var_67_6.mediator = var_2_10006
				NewEducateTalentLayer = var_2_10006
				var_67_6.viewComponent = var_2_10006
				var_67_6.data = {
					onExit = arg_67_0
				}
...
function var_0_1.ReqParallelData(arg_69_0)
	...
	var_69_0({
		function(arg_70_0)
			...
			if not var_70_2(var_70_1, var_2_10003.SYSTEM.TOPIC) then
				local var_70_3 = arg_69_0
				local var_70_4 = var_2.emit

				NewEducateMainMediator = var_2_10004

				var_70_4(var_70_3, var_2_10004.ON_REQ_TOPICS, arg_70_0)
			else
				arg_70_0()
			end
		...
		function(arg_71_0)
			...
			if not var_71_2(var_71_1, var_2_10003.SYSTEM.MAP) then
				local var_71_3 = arg_69_0
				local var_71_4 = var_2.emit

				NewEducateMainMediator = var_2_10004

				var_71_4(var_71_3, var_2_10004.ON_REQ_MAP)
			else
				arg_71_0()
			end
...
function var_0_1.MapHandler(arg_75_0)
	...
	if var_1.GetCurNode(var_75_1) ~= 0 then
		...
		i18n = var_1_10005
		var_75_5.content = var_1_10005("child2_replay_tip")
		i18n = var_5
		var_75_5.noText = var_5("child2_replay_clear")
		i18n = var_5
		var_75_5.yesText = var_5("child2_replay_continue")
		...
		function var_75_5.onYes()
			...
			var_76_1(var_76_0, var_76_2, var_2_10003.NEW_EDUCATE_MAP)
		...
		function var_75_5.onNo()
			...
			var_77_1(var_77_0, var_2_10002.ON_CLEAR_NODE_CHAIN)
...
function var_0_1.PlanHandler(arg_78_0)
	...
	NewEducateMainMediator = var_1_10003

	var_78_3(var_78_2, var_1_10003.ON_NEXT_PLAN, true)
...
function var_0_1.AssessHandler(arg_79_0)
	...
	var_79_4({
		function(arg_80_0)
			...
			NewEducateFSM = var_80_1

			if not (var_80_2 == var_80_1.SYSTEM.ASSESS) then
				local var_80_3 = arg_79_0
				local var_80_4 = var_2.emit

				NewEducateMainMediator = var_2_10004

				var_80_4(var_80_3, var_2_10004.ON_ENTER_ASSESS, arg_80_0)
			else
				arg_80_0()
			end
		...
		function(arg_82_0)
			if var_79_5 ~= 0 then
				...
				local var_82_4 = var_82_3(var_82_2, var_2_10003.SYSTEM.ASSESS)
...
function var_0_1.StageHandler(arg_84_0)
	...
	var_84_5(var_84_4, var_1_10003.ON_STAGE_CHANGE)
...
function var_0_1.EndingHandler(arg_85_0)
	...
	if var_85_4(var_85_3, var_1_10003.SYSTEM.ENDING) then
		::label_85_0::
	...
	var_85_5(arg_85_0.resetBtns, var_85_6)

	setActive = var_85_5

	var_85_5(arg_85_0.resetBtn, var_85_6)
	...
	if var_85_6 then
		...
		local var_85_9 = var_5.GetRoundData(var_85_8)

		var_85_10 = var_5.ExistEndless(var_85_9)
	end

	var_85_5(var_85_7, var_85_10)

	setActive = var_85_5

	var_85_5(arg_85_0.endingBtn, not var_85_6)
	...
	if var_85_6 then
		...
		local var_85_13 = var_85_11.NewStoryMgr.GetInstance()

		if not var_4.IsPlayed(var_85_13, var_85_12) then
			NewEducateHelper = var_4

			var_4.PlaySpecialStory(var_85_12, function()
				getProxy = var_2_10000
				EducateProxy = var_2_10001

				local var_86_0 = var_2_10000(var_2_10001)
				...
				if var_0.GetSelectInfo(var_86_0).gameCnt == 1 then
					...
					if var_0.IsPopActivity(arg_85_0.contextData.char.id) then
						...
						local var_86_4 = var_2_10003.New
						local var_86_5 = {}

						CultivatingPlantMediator = var_2_10005
						var_86_5.mediator = var_2_10005
						CultivatingPlantScene = var_2_10005
						var_86_5.viewComponent = var_2_10005
						var_86_5.data = {
		...
		if var_3.getConfig(var_85_14, "special_memory").pre_ending ~= "" then
			NewEducateHelper = var_85_14

			var_85_14.PlaySpecialStory(var_3, function()
				return
			end)
		end
	end
...
function var_0_1.OnEndingClick(arg_88_0)
	...
	local var_88_3 = var_88_2(var_88_1, var_1_10003.SYSTEM.ENDING)
	...
	var_88_1({
		function(arg_89_0)
			if not var_88_3 then
				...
				var_89_1(var_89_0, var_2_10003.ON_REQ_ENDINGS, arg_89_0)
			else
				arg_89_0()
			end
		...
		local var_90_3 = var_90_2(var_90_1, var_2_10002.SYSTEM.ENDING)
		...
		if #var_0.GetEndings(var_90_3) == 1 then
			...
			var_90_5(var_90_4, var_2_10004.ON_SELECT_ENDING, var_1[1])
		else
			...
			local var_90_9 = var_2_10005.New
			local var_90_10 = {}

			NewEducateSelEndingMediator = var_2_10007
			var_90_10.mediator = var_2_10007
			NewEducateSelEndingLayer = var_2_10007
			var_90_10.viewComponent = var_2_10007
			var_90_10.data = {
				onExit = function()
...
function var_0_1.ChooseHandler(arg_92_0)
	...
	var_1_10001({
		function(arg_93_0)
			...
			var_93_1(var_93_0, var_2_10003.ON_REQ_CHOOSE, arg_93_0)
...
function var_0_1.OnClickResetBtn(arg_98_0)
	...
	var_1_10001({
		function(arg_99_0)
			...
			i18n = var_2_10005
			var_99_3.content = var_2_10005("child2_reset_sure_tip")
		...
		function(arg_100_0)
			...
			var_100_1(var_100_0, var_2_10003.ON_RESET, arg_100_0)
...
function var_0_1.OnClickResetInEndlessBtn(arg_102_0)
	...
	var_1_10001({
		function(arg_103_0)
			...
			local var_103_3 = var_2_10004.New
			local var_103_4 = {}

			NewEducateMsgBoxLayer = var_2_10006
			var_103_4.viewComponent = var_2_10006
			NewEducateMsgBoxMediator = var_2_10006
			var_103_4.mediator = var_2_10006

			local var_103_5 = {}

			NewEducateMsgBoxLayer = var_2_10007
			var_103_5.type = var_2_10007.TYPE.RESET
		...
		function(arg_104_0)
			...
			var_104_1(var_104_0, var_2_10003.ON_RESET, arg_104_0)
...
function var_0_1.OnClickEndlessBtn(arg_106_0)
	...
	var_1_10001({
		function(arg_107_0)
			...
			i18n = var_2_10005
			var_107_3.content = var_2_10005("child2_endless_sure_tip")
		...
		function(arg_108_0)
			...
			var_108_1(var_108_0, var_2_10003.ON_START_ENDLESS, arg_108_0)
...
function var_0_1.UpdateUnlockUI(arg_116_0)
	...
	local var_116_1 = var_2.Find(var_116_0, "lock")
	local var_116_2 = arg_116_0.contextData.char

	var_1_10001(var_116_1, not var_3.IsUnlock(var_116_2, "out"))
...
function var_0_1.OnNodeStart(arg_118_0, arg_118_1)
	...
	var_1_10002(var_1_10003.child2_node[arg_118_1], "child2_node缺少id:" .. arg_118_1)
	...
	NewEducateNodePanel = var_118_0

	if var_118_1 == var_118_0.NODE_TYPE.MAIN_TEXT then
...
function var_0_1.OnNextNode(arg_119_0, arg_119_1)
	...
	NewEducateFSM = var_119_2

	if var_119_3 ~= var_119_2.SYSTEM.PLAN then
