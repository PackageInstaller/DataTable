...
function var_0_1.OnLoaded(arg_2_0)
	...
	UIItemList = var_2_7
	arg_2_0.favorUIList = var_2_7.New(var_2_8, var_2_8:Find("tpl"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_2 = var_3.Find(var_4_1, "favor_panel")
...
function var_0_1.UpdateFavorPanel(arg_7_0)
	...
	var_7_0(var_3.Find(var_7_2, "lv"), var_7_1.lv)
	...
	local var_7_7 = var_5.Find(var_7_6, "progress")

	i18n = var_7_6

	var_4(var_7_7, var_7_6("child_favor_progress", var_7_5))

	setSlider = var_4

	local var_7_8 = arg_7_0.favorCurTF
	local var_7_9 = var_5.Find(var_7_8, "slider")
	local var_7_10 = 0
	local var_7_11 = 1
	local var_7_12
	...
	var_7_14(var_7_13, var_6.getConfig(var_7_15, "favor_level") - 1)
...
function var_0_1.UpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	var_6(arg_8_2:Find("award/got"), var_8_2)

	setText = var_6

	local var_8_3 = arg_8_2
	local var_8_4 = arg_8_2.Find(var_8_3, "Text")

	i18n = var_8_3

	var_6(var_8_4, var_8_3("child_favor_lock1", var_8_0 + 1))
	...
	var_6(var_8_6, var_8_5.NewHex(var_8_2 and "393A3C" or "F5F5F5"))

	setTextColor = var_6

	local var_8_7 = arg_8_2
	local var_8_8 = arg_8_2.Find(var_8_7, "lv")

	Color = var_8_7

	var_6(var_8_8, var_8_7.NewHex(var_8_2 and "FFFFFF" or "F5F5F5"))

	local var_8_9 = arg_8_0.contextData.char
	local var_8_10 = var_6.getConfig(var_8_9, "favor_result_display")[var_8_0]

	NewEducateHelper = var_8_9

	local var_8_11 = var_8_9.Config2Drop(var_8_10)

	NewEducateHelper = var_8

	var_8.UpdateItem(arg_8_2:Find("award/item"), var_8_11)

	onButton = var_8

	local var_8_12 = arg_8_0
	local var_8_13 = arg_8_2:Find("award")
	...
	local function var_8_14()
		...
		var_9_1(var_9_0, var_2_10002.ON_ITEM, {
			drop = var_8_11
		})
	...
	var_8(var_8_12, var_8_13, var_8_14, var_12)
