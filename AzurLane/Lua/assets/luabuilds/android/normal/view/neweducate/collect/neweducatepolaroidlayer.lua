...
function var_0_1.InitShowList(arg_5_0)
	...
	arg_5_0.showList = var_5_1(var_5_2, var_3.Find(var_5_3, "tpl"))
	...
	var_1.make(var_5_4, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			var_6_1(arg_6_2:Find("unlock/unselected/Text"), var_6_0)

			setText = var_6_1

			var_6_1(arg_6_2:Find("unlock/selected/Text"), var_6_0)
			...
			var_6_1(arg_6_2:Find("unlock"), var_6_2)

			setActive = var_6_1

			var_6_1(arg_6_2:Find("unlock/selected"), arg_5_0.selectedIndex == arg_6_1 + 1)

			setActive = var_6_1

			var_6_1(arg_6_2:Find("unlock/unselected"), arg_5_0.selectedIndex ~= arg_6_1 + 1)

			onButton = var_6_1

			var_6_1(arg_5_0, arg_6_2, function(arg_7_0)
				local var_7_0
				...
				if var_6_2 then
					...
					var_7_4(var_7_3, var_3_10003("child_polaroid_lock_tip"))
				end
...
function var_0_1.UpdateItem(arg_9_0, arg_9_1, arg_9_2)
	...
	var_6(arg_9_2:Find("lock"), not var_9_4)

	setActive = var_6

	var_6(arg_9_2:Find("unlock"), var_9_4)

	if var_9_4 then
		LoadImageSpriteAsync = var_6

		var_6("neweducateicon/" .. var_9_3.pic, arg_9_2:Find("unlock/mask/Image"), true)

		setText = var_6

		var_6(arg_9_2:Find("unlock/name"), var_9_3.title)
		...
		var_6(var_9_5, var_9_6, var_9_7, var_10)
	else
		...
		var_6(arg_9_2:Find("lock/Text"), var_9_3.condition)
	end
...
function var_0_1.ShowPerformWindow(arg_13_0, arg_13_1, arg_13_2)
	...
	var_3(var_4.GetChild(var_13_1, 0))
...
function var_0_1.UpdatePerform(arg_14_0, arg_14_1)
	...
	var_1_10003(var_14_1, var_5.Find(var_14_2, "bg/mask/Image"), true)

	setText = var_1_10003

	local var_14_3 = arg_14_0.performTF

	var_1_10003(var_4.Find(var_14_3, "bg/Text"), var_14_0.title)
