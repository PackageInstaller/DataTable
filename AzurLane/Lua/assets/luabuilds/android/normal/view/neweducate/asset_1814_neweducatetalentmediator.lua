...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_REFRESH_TALENT, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.NEW_EDUCATE_REFRESH_TALENT, {
	...
	arg_1_0:bind(var_0_1.ON_SELECT_TALENT, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.NEW_EDUCATE_SEL_TALENT, {
			id = arg_1_0.contextData.char.id,
			talentId = arg_3_1,
			idx = arg_3_2
		})
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.NEW_EDUCATE_REFRESH_TALENT_DONE then
		...
		if var_5_0 == var_4.NEW_EDUCATE_SEL_TALENT_DONE then
