...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_SITE_NORMAL, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.NEW_EDUCATE_MAP_NORMAL, {
	...
	arg_1_0:bind(var_0_1.ON_SITE_EVENT, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.NEW_EDUCATE_MAP_EVENT, {
			id = arg_1_0.contextData.char.id,
			eventId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SITE_SHIP, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.NEW_EDUCATE_MAP_SHIP, {
			id = arg_1_0.contextData.char.id,
			shipId = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SHOPPING, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10005.NEW_EDUCATE_SHOPPING, {
			id = arg_1_0.contextData.char.id,
			goodId = arg_5_1,
			num = arg_5_2 or 1
		})
	...
	arg_1_0:bind(var_0_1.ON_REFRESH_SHOP, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10003.NEW_EDUCATE_REFRESH_SHOP, {
			id = arg_1_0.contextData.char.id
		})
	...
	arg_1_0:bind(var_0_1.ON_UPGRADE_NORMAL, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_1(var_7_0, var_2_10005.NEW_EDUCATE_UPGRADE_NORMAL_SITE, {
			id = arg_1_0.contextData.char.id,
			normalId = arg_7_1,
			callback = arg_7_2
		})
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	NewEducateProxy = var_9_1

	if var_9_0 == var_9_1.RESOURCE_UPDATED then
		...
		if var_9_0 == var_4.ATTR_UPDATED then
			...
			if var_9_0 == var_4.PERSONALITY_UPDATED then
				...
				if var_9_0 == var_4.TALENT_UPDATED then
					...
					if var_9_0 == var_4.STATUS_UPDATED then
						...
						if var_9_0 == var_4.TAROT_UPDATED then
							...
							if var_9_0 == var_4.NEW_EDUCATE_NODE_START then
								...
								if var_9_0 == var_4.NEW_EDUCATE_NEXT_NODE then
									...
									if var_9_0 == var_4.NEW_EDUCATE_SHOPPING_DONE then
										seriesAsync = var_4
										...
										var_4({
											function(arg_10_0)
												if not var_9_2.isUpgradeEntry then
													...
													var_10_1(var_10_0, var_2_10003.ON_DROP, {
														items = var_9_2.drops,
														removeFunc = arg_10_0
													})
												else
										...
										if var_9_0 == var_4.NEW_EDUCATE_REFRESH_SHOP_DONE then
											...
											if var_9_0 == var_4.NEW_EDUCATE_REFRESH_DONE then
												local var_9_12 = arg_9_0.viewComponent

												var_9_13 = var_9_13.emit
												NewEducateBaseUI = var_1_10006

												local var_9_14 = var_1_10006.GO_SCENE

												SCENE = var_1_10007

												var_9_13(var_9_12, var_9_14, var_1_10007.NEW_EDUCATE, {
													id = var_9_2.id
												})
											else
												GAME = var_9_13

												if var_9_0 == var_9_13.NEW_EDUCATE_MAP_NORMAL_DONE then
													arg_9_0:StartNodeWithCheckDrops(var_9_2)
												else
													GAME = var_4

													if var_9_0 == var_4.NEW_EDUCATE_MAP_EVENT_DONE then
														arg_9_0:StartNodeWithCheckDrops(var_9_2)
													else
														GAME = var_4

														if var_9_0 == var_4.NEW_EDUCATE_MAP_SHIP_DONE then
															arg_9_0:StartNodeWithCheckDrops(var_9_2)
														elseif var_9_0 == var_0_1.ON_SHIP_UPGRADE_LEVEL then
															...
															if var_9_0 == var_4.NEW_EDUCATE_CHECK_PRIORITY_FSM then
...
function var_0_1.StartNodeWithCheckDrops(arg_12_0, arg_12_1)
	if #arg_12_1.drops == 0 then
		...
		var_12_2(var_12_1, var_1_10004.ON_DROP, {
