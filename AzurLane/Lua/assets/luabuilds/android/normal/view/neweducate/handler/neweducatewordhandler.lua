...
function var_0_0.Play(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	...
	if not var_2_5 then
		getProxy = var_9
		NewEducateProxy = var_10

		local var_2_6 = var_9(var_10)
		local var_2_7 = var_9.GetCurChar(var_2_6)
		local var_2_8 = var_9.GetPaintingName(var_2_7)

		setImageSprite = var_2_7
		var_2_9 = arg_2_0.image
		LoadSprite = var_1_10012

		var_2_7(var_2_9, var_1_10012("storyicon/" .. var_2_8), true)
	end

	local var_2_10

	if not var_2_5 or not arg_2_0.text2 then
		var_2_10 = arg_2_0.text
	end

	local var_2_11 = var_2_0.word

	string = var_2_9

	local var_2_12 = var_2_9.gsub(var_2_11, "$1", arg_2_0.callName)

	setText = var_11

	var_11(var_2_10, var_2_12)

	setActive = var_11

	local var_2_13 = arg_2_0.nameTF
	local var_2_14 = var_2_0.char_type

	NewEducateConst = var_14

	var_11(var_2_13, var_2_14 ~= var_14.WORD_TYPE.ASIDE)

	local var_2_15 = var_2_0.char_type

	NewEducateConst = var_2_13

	if var_2_15 ~= var_2_13.WORD_TYPE.ASIDE then
		var_2_15 = ""

		local var_2_16 = var_2_0.char_type

		NewEducateConst = var_13

		if var_2_16 ~= var_13.WORD_TYPE.CHILD then
			var_2_16 = var_2_0.char_type
			NewEducateConst = var_13

			if var_2_16 == var_13.WORD_TYPE.HIDE_IMAGE then
				var_2_15 = arg_2_0.name
			else
				var_2_16 = var_2_0.char_type
				NewEducateConst = var_13

				if var_2_16 == var_13.WORD_TYPE.PLAYER then
					var_2_15 = arg_2_0.playerName
				end
			end

			setText = var_2_16

			var_2_16(arg_2_0.nameText, var_2_15)

			GetComponent = var_2_15

			local var_2_17 = var_2_10

			typeof = var_13
			Typewriter = var_14

			local var_2_18 = var_2_15(var_2_17, var_13(var_14))

			function var_2_18.endFunc()
				...
				for iter_3_0 = 1, #arg_2_0.drops do
					...
					var_2_10005.insert(var_3_0, function(arg_4_0)
						...
						if iter_3_0 < arg_2_0.resultTF.childCount then
							local var_4_1 = arg_2_0.resultTF
							local var_4_2

							if not var_4_2.GetChild(var_4_1, iter_3_0 - 1) then
								cloneTplTo = var_4_2
								var_4_2 = var_4_2(arg_2_0.resultTpl, arg_2_0.resultTF)
							end

							local var_4_3 = var_4_0.type

							NewEducateConst = var_3_10004

							if var_4_3 == var_3_10004.DROP_TYPE.BUFF then
								setActive = var_4_3

								var_4_3(var_4_2:Find("icon"), false)

								setText = var_4_3

								local var_4_4 = var_4_2
								local var_4_5 = var_4_2.Find(var_4_4, "name")

								pg = var_4_4

								var_4_3(var_4_5, var_4_4.child2_benefit_list[var_4_0.id].name)

								setText = var_4_3

								var_4_3(var_4_2:Find("value"), "")
							else
								setActive = var_4_3

								var_4_3(var_4_2:Find("icon"), true)

								NewEducateHelper = var_4_3

								var_4_3.UpdateVectorItem(var_4_2, var_4_0)
							end

							setActive = var_4_3

							var_4_3(var_4_2, true)

							local var_4_6 = var_4_2
							local var_4_7 = var_4_2.GetComponent

							typeof = var_5
							Animation = var_3_10006

							local var_4_8 = var_4_7(var_4_6, var_5(var_3_10006))

							var_3.Play(var_4_8, "anim_educate_attr_in")
				...
				var_1(var_3_0, function()
					if not arg_2_0.needClick then
						...
						SFX_PANEL = var_3_10004

						var_0(var_6_0, var_6_1, var_6_2, var_3_10004)
					end
			...
			var_2_18:setSpeed(arg_2_0.speed)

			local var_2_19 = var_2_18

			var_2_18.Play(var_2_19)

			local var_2_20 = arg_2_0.speed

			NewEducateConst = var_2_19

			if var_2_20 ~= var_2_19.TYPEWRITE_SPEED_UP then
				onButton = var_2_20

				var_2_20(arg_2_0, arg_2_0.nextClickTF, function()
					...
					var_10_0.speed = var_1.TYPEWRITE_SPEED_UP

					local var_10_1 = var_2_18
...
function var_0_0.PlayWordIds(arg_11_0, arg_11_1, arg_11_2)
	...
	for iter_11_0, iter_11_1 in var_7(arg_11_1) do
		...
		var_1_10012.insert(var_11_4, function(arg_12_0)
			...
			local var_12_4 = var_2(var_12_3, var_4(var_5))
			...
			function var_12_4.endFunc()
				if not arg_11_0.needClick then
					...
					var_0(var_13_0, var_13_1, var_13_2, var_3_10004)
				end
			...
			var_12_4.Play(var_12_5)

			local var_12_6 = arg_11_0.speed

			NewEducateConst = var_12_5

			if var_12_6 ~= var_12_5.TYPEWRITE_SPEED_UP then
				onButton = var_12_6

				var_12_6(arg_11_0, arg_11_0.nextClickTF, function()
					...
					NewEducateConst = var_1
					var_16_0.speed = var_1.TYPEWRITE_SPEED_UP
...
function var_0_0.CheckName(arg_18_0)
	if not arg_18_0.callName then
		...
		var_1_10002 = var_1.GetCurChar(var_1_10002)
		arg_18_0.callName = var_1.GetCallName(var_1_10002)
	end
	...
	if not arg_18_0.name then
		...
		var_1_10002 = var_1(var_1_10002)
		var_1_10002 = var_1.GetCurChar(var_1_10002)
		arg_18_0.name = var_1.GetName(var_1_10002)
	end
