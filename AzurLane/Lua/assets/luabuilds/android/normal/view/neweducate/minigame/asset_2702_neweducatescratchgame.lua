...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	UIScratch = var_1_10004
	arg_2_0.scratchCom = var_2_2(var_2_1, var_3(var_1_10004))
	...
	arg_2_0.animDft = var_2_8(var_2_7, var_3(var_1_10004))
...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_9 = var_3.Find(var_4_8, "help")
	...
	local function var_4_10()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.child2_scratch_minigame_help.tip
	...
	function arg_4_0.scratchCom.onUpdateErase(arg_8_0)
		...
		string = var_2_10003
		var_8_0.progress = var_2_10002(var_2_10003.format("%.2f", arg_8_0))
...
function var_0_1.ResetGame(arg_11_0)
	...
	var_2(arg_11_0.resultTF, function(arg_12_0)
		...
		var_2_10001(var_12_0, var_2_10003(arg_12_0.name) == var_11_1)
	...
	var_2(arg_11_0.sureBtn, false)

	setActive = var_2

	var_2(arg_11_0.resultEffectTF, false)
	arg_11_0:ResetHand()
...
function var_0_1.StartGame(arg_14_0)
	...
	local var_14_2 = var_14_1(var_14_0, var_3.moveX, nil, arg_14_0.handTF, -220, var_0_1.HAND_MOVE_TIME)
