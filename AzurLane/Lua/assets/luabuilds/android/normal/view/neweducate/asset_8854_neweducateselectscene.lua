...
function var_0_1.init(arg_4_0)
	...
	local var_4_4 = var_2.Find(var_4_3, "Text")

	i18n = var_4_3

	var_1(var_4_4, var_4_3("child2_enter"))
	...
	local var_4_7 = var_2.Find(var_4_6, "Text")

	i18n = var_4_6

	var_1(var_4_7, var_4_6("child2_hard_enter"))
	...
	var_2(var_4_11, var_4_10("child2_hard"))
...
function var_0_1.InitData(arg_5_0)
	...
	if var_2.IsShowNewChildTip() then
		...
		pg = var_5_5
		arg_5_0.newId = var_5_6[#var_5_5.child2_data.all]
		NewEducateHelper = var_2
...
function var_0_1.didEnter(arg_6_0)
	...
	local var_6_2 = var_3.Find(var_6_1, "return_btn")
	...
	local var_6_6 = var_3.Find(var_6_5, "btns/collect")

	local function var_6_7()
		local var_8_0 = arg_6_0
		local var_8_1 = var_0.emit

		NewEducateSelectMediator = var_2_10002
	...
	var_1_10001(arg_6_0.contentTF, function(arg_11_0)
		...
		local function var_11_2(arg_12_0)
			...
			if arg_12_0 then
				...
				local var_12_1 = var_2.SetInt
				local var_12_2 = arg_6_0

				var_12_1(var_3.GetSelectedLocalKey(var_12_2), var_12_0)
	...
	local function var_6_16(arg_13_0)
		...
		var_2_10002(var_3.Find(var_13_1, "root/window"), var_13_0)
		...
		if arg_13_0 then
			...
			if not var_5("child2_hard") then
				var_13_4 = ""
			end

			i18n = var_2_10006

			var_3(var_13_3, var_13_4 .. var_2_10006("child2_game_cnt", var_13_2.gameCnt))
	...
	arg_6_0.InitData(var_6_17)

	local var_6_18

	if not arg_6_0.newId then
		PlayerPrefs = var_6_18

		if not var_6_18.GetInt(arg_6_0:GetSelectedLocalKey()) then
			var_6_18 = 0
		end
	end

	triggerToggle = var_6_17

	local var_6_19 = arg_6_0.contentTF
	local var_6_20 = var_3.Find

	tostring = var_5

	var_6_17(var_6_20(var_6_19, var_5(var_6_18)), true)
...
function var_0_1.UpdataInfo(arg_15_0)
	...
	var_2(var_15_1, var_4("bg/" .. var_15_0.bg), false)
...
function var_0_1.EnterEasyMode(arg_16_0)
	...
	if arg_16_0.infos[arg_16_0.selectedId].isHard then
		...
		var_2.insert(var_16_0, function(arg_17_0)
			...
			i18n = var_2_10005
			var_17_3.contentText = var_2_10005("child2_switch_sure")
		...
		var_2.insert(var_16_0, function(arg_18_0)
			...
			local var_18_2 = var_2_10003.SWITCH_DIFFICULTY
			local var_18_3 = {
				id = arg_16_0.selectedId
			}

			NewEducateChar = var_5
			var_18_3.difficulty = var_5.DIFFICULTY.EASY
...
function var_0_1.EnterHardMode(arg_20_0)
	...
	if not arg_20_0.infos[arg_20_0.selectedId].isHard then
		...
		var_2.insert(var_20_0, function(arg_21_0)
			...
			local var_21_2 = var_2_10003.NewStyleMsgboxMgr.TYPE_COMMON_MSGBOX
			local var_21_3 = {}

			i18n = var_2_10005
			var_21_3.contentText = var_2_10005("child2_switch_sure")
		...
		var_2.insert(var_20_0, function(arg_22_0)
			...
			local var_22_2 = var_2_10003.SWITCH_DIFFICULTY
			local var_22_3 = {
				id = arg_20_0.selectedId
			}

			NewEducateChar = var_5
			var_22_3.difficulty = var_5.DIFFICULTY.HARD
...
function var_0_1.EnterScene(arg_24_0)
	if arg_24_0.selectedId == 0 then
		...
		NewEducateSelectMediator = var_1_10003
		var_1_10003 = var_1_10003.GO_SCENE
		SCENE = var_1_10004

		var_24_1(var_24_0, var_1_10003, var_1_10004.EDUCATE, {
			isMainEnter = true
		})
	else
		...
		local var_24_4 = var_1_10003.GO_SCENE

		SCENE = var_1_10004

		var_24_3(var_24_2, var_24_4, var_1_10004.NEW_EDUCATE, {
			isMainEnter = true,
...
function var_0_1.CheckGuide(arg_25_0, arg_25_1)
	if arg_25_1 then
		...
		if not var_2.IsPlayed(var_25_0, "tb2_19") then
			...
			var_25_2(var_25_1, var_4.STORY_UPDATE, {
				storyId = "tb2_19"
			})
...
function var_0_1.onBackPressed(arg_26_0)
	if arg_26_0.contextData.isTb1 then
		...
		NewEducateBaseUI = var_1_10003

		var_26_1(var_26_0, var_1_10003.ON_HOME)
	else
