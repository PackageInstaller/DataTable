...
function var_0_1.initData(arg_3_0)
	...
	local var_3_0 = var_3_0 == var_2 and var_3_0
...
function var_0_1.findUI(arg_4_0)
	...
	local var_4_5 = var_2.Find(var_4_4, "Image")

	i18n = var_4_4

	var_1(var_4_5, var_4_4("word_ok"))

	setText = var_1

	local var_4_6 = arg_4_0.callInput
	local var_4_7 = var_2.Find(var_4_6, "Placeholder")

	i18n = var_4_6

	var_1(var_4_7, var_4_6("child_callname_tip"))
	...
	local var_4_10 = var_4_9(var_4_8, var_3(var_4))
	...
	var_4_10(var_2.Find(var_4_11, "bg/panel/input/pan"), not arg_4_0.lockNamed)
...
function var_0_1.addListener(arg_5_0)
	...
	local function var_5_2()
		...
		NewEducateSetCallediator = var_3

		var_6_1(var_6_0, var_3.ON_SET_CALL, var_0)
...
function var_0_1.didEnter(arg_7_0)
	...
	setImageSprite = var_7_0

	local var_7_2 = arg_7_0.bgTF

	LoadSprite = var_1_10004

	var_7_0(var_7_2, var_1_10004("bg/" .. var_7_1), false)
