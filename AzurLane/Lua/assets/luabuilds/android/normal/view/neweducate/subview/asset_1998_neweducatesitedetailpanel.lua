...
function var_0_1.OnLoaded(arg_2_0)
	...
	UIItemList = var_2_2
	arg_2_0.goodsUIList = var_2_2.New(var_2_3, var_2_3:Find("tpl"))
	...
	local var_2_12 = var_3.Find(var_2_11, "options/exit/mask/Text")

	i18n = var_2_11

	var_2(var_2_12, var_2_11("child2_site_exit"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_6 = var_3.Find(var_3_5, "close_btn")
	...
	local var_3_10 = var_3.Find(var_3_9, "close_btn")
	...
	local var_3_14 = var_3.Find(var_3_13, "options/exit")
	...
	local function var_3_18()
		...
		NewEducateMapMediator = var_2_10002

		var_8_1(var_8_0, var_2_10002.ON_REFRESH_SHOP)
...
function var_0_1.Flush(arg_11_0)
	...
	if var_11_0 == var_1_10003.SITE_TYPE.SHOP then
		...
		var_11_0(var_3.Find(var_11_1, "title"), var_1.title)

		setText = var_11_0

		local var_11_2 = arg_11_0.shopRefreshTF

		var_11_0(var_3.Find(var_11_2, "cost/Text"), arg_11_0.shopRefreshCost)
		arg_11_0:ShowShop()
	else
...
function var_0_1.UpdateCost(arg_12_0, arg_12_1, arg_12_2)
	...
	var_4("neweducateicon/" .. var_12_0, arg_12_1:Find("Image"))

	setText = var_4

	var_4(arg_12_1:Find("Text"), "-" .. arg_12_2.number)
...
function var_0_1.ShowNormal(arg_13_0, arg_13_1)
	...
	var_13_6[var_1_10010.SITE_TYPE.WORK] = function()
		local var_16_0 = arg_13_0.contextData.char
		local var_16_1 = var_0.GetNormalIdByType

		NewEducateConst = var_2_10002

		local var_16_2 = var_16_1(var_16_0, var_2_10002.SITE_NORMAL_TYPE.WORK)

		pg = var_16_0
		var_13_3 = var_16_0.child2_site_normal[var_16_2].title
		...
		function var_13_4()
			...
			NewEducateMapMediator = var_3_10002

			var_17_1(var_17_0, var_3_10002.ON_SITE_NORMAL, var_0.id)
	...
	var_13_6[var_10.SITE_TYPE.TRAVEL] = function()
		local var_18_0 = arg_13_0.contextData.char
		local var_18_1 = var_0.GetNormalIdByType

		NewEducateConst = var_2_10002

		local var_18_2 = var_18_1(var_18_0, var_2_10002.SITE_NORMAL_TYPE.TRAVEL)

		pg = var_18_0
		var_13_3 = var_18_0.child2_site_normal[var_18_2].title
		NewEducateHelper = var_2
		var_13_2 = var_2.Config2Drop(var_1.cost)
		...
		function var_13_4()
			...
			var_19_1(var_19_0, var_3_10002.ON_SITE_NORMAL, var_0.id)
	...
	NewEducateConst = var_10
	var_13_6[var_10.SITE_TYPE.SHIP] = function()
		pg = var_2_10000
		...
		function var_13_4()
			...
			var_21_1(var_21_0, var_3_10002.ON_SITE_SHIP, var_0.id)
	...
	NewEducateConst = var_10
	var_13_6[var_10.SITE_TYPE.EVENT] = function()
		pg = var_2_10000
		...
		function var_13_4()
			...
			var_23_1(var_23_0, var_3_10002.ON_SITE_EVENT, var_0.id)
	...
	var_1_10007(var_13_5, var_13_6)

	setScrollText = var_1_10007

	local var_13_7 = arg_13_0.enterTF

	var_1_10007(var_8.Find(var_13_7, "mask/Text"), var_13_3)

	local var_13_8 = arg_13_0
	local var_13_9 = arg_13_0.UpdateCost
	local var_13_10 = arg_13_0.enterTF

	var_13_9(var_13_8, var_9.Find(var_13_10, "cost"), var_13_2)
	...
	setImageColor = var_13_11

	local var_13_13 = arg_13_0.enterTF

	Color = var_10

	var_13_11(var_13_13, var_10.NewHex(var_13_12 and "C8CAD5" or "FFFFFF"))

	setTextColor = var_13_11

	local var_13_14 = arg_13_0.enterTF
	local var_13_15 = var_9.Find(var_13_14, "mask/Text")

	Color = var_13_14

	var_13_11(var_13_15, var_13_14.NewHex(var_13_12 and "717171" or "393A3C"))
	...
	if not var_13_12 then
		...
		var_13_11(var_13_16, var_13_17, var_13_18, var_1_10012)
	else
		removeOnButton = var_13_11

		var_13_11(arg_13_0.enterTF)
	end
...
function var_0_1.ShowShop(arg_25_0)
	...
	local var_25_4 = var_25_3(var_25_2, var_1_10003.SYSTEM.MAP)
...
function var_0_1.UpdateShopRefreshInfos(arg_29_0, arg_29_1)
	...
	local var_29_2 = var_29_1(var_29_0, var_1_10004.RES_TYPE.REFRESH_SHOP)

	setText = var_29_0

	local var_29_3 = arg_29_0.shopRefreshTF

	var_29_0(var_4.Find(var_29_3, "Text"), var_29_2)

	setActive = var_29_0

	var_29_0(arg_29_0.shopRefreshTF, var_29_2 > 0 or arg_29_1 < arg_29_0.shopRefreshSellCnt)

	setActive = var_29_0

	local var_29_4 = arg_29_0.shopRefreshTF

	var_29_0(var_4.Find(var_29_4, "Text"), var_29_2 > 0)

	setActive = var_29_0

	local var_29_5 = arg_29_0.shopRefreshTF

	var_29_0(var_4.Find(var_29_5, "cost"), var_29_2 <= 0 and arg_29_1 < arg_29_0.shopRefreshSellCnt)
...
function var_0_1.UpdateGoodsItem(arg_30_0, arg_30_1, arg_30_2)
	...
	if var_3:IsLimitCnt() then
		...
		local var_30_1 = arg_30_2.Find(var_30_0, "limit_cnt")

		i18n = var_30_0

		var_4(var_30_1, var_30_0("child2_shop_limit_cnt") .. var_3:GetRemainCnt() .. "/" .. var_3:GetLimitCnt())
	end

	local var_30_2 = var_3:GetRemainCnt() <= 0

	setActive = var_5

	var_5(arg_30_2:Find("sold_out"), var_30_2)

	local var_30_3 = var_3:GetCostCondition()
	local var_30_4

	if var_3:GetCostWithBenefit(arg_30_0.discountInfos).number == var_30_3.number or not ("(" .. var_6.number .. ")") then
		var_30_4 = ""
	end

	setText = var_8

	var_8(arg_30_2:Find("price"), var_30_3.number .. var_30_4)
	...
	if var_30_2 then
		...
		local function var_30_7()
			...
			var_31_1(var_31_0, var_2_10002.ON_SHOP, {
				shopId = var_0.id,
				price = var_0.number,
				onBuy = function()
		...
		var_8(var_30_5, var_30_6, var_30_7, var_1_10012)
	end
...
function var_0_1.SendBuyProto(arg_33_0, arg_33_1)
	...
	NewEducateMapMediator = var_1_10004

	var_33_1(var_33_0, var_1_10004.ON_SHOPPING, arg_33_1.id)
...
function var_0_1.OnClickBuy(arg_34_0, arg_34_1)
	...
	local var_34_1 = arg_34_1.getConfig(var_34_0, "goods_type")

	NewEducateGoods = var_34_0

	if var_34_1 == var_34_0.TYPE.BENEFIT then
		arg_34_0:ClickBenefitGood(arg_34_1)
	else
		NewEducateGoods = var_3

		if var_34_1 == var_3.TYPE.RES then
			arg_34_0:ClickResGood(arg_34_1)
		else
			NewEducateGoods = var_3

			if var_34_1 == var_3.TYPE.UP_ENTRY then
				existCall = var_3
...
function var_0_1.ClickBenefitGood(arg_35_0, arg_35_1)
	...
	local var_35_2 = arg_35_0.contextData.char

	if var_4.GetStatus(var_35_2, arg_35_1:getConfig("goods_id")) and var_4:getConfig("is_tip") == 0 then
		var_35_2 = var_4:GetEndRound()

		local var_35_3 = arg_35_0.contextData.char

		var_35_2 = var_35_2 - var_6.GetRoundData(var_35_3).round

		local var_35_4 = var_4
		local var_35_5 = var_4.getConfig(var_35_4, "during_time") == -1 and "child2_shop_benefit_sure2" or "child2_shop_benefit_sure"
		...
		var_35_4.insert(var_35_0, function(arg_36_0)
			...
			local var_36_2 = var_2_10003.ON_BOX
			local var_36_3 = {}

			i18n = var_2_10005
			var_36_3.content = var_2_10005(var_35_5, var_35_2)
	...
	seriesAsync = var_35_2

	var_35_2(var_35_0, function()
...
function var_0_1.ClickResGood(arg_38_0, arg_38_1)
	...
	local var_38_3 = var_38_2(var_38_1, var_1_10005.RES_TYPE.ACTION)
	local var_38_5

	if arg_38_1:getConfig("goods_id") == var_38_3 then
		local var_38_4 = arg_38_0.contextData.char

		var_38_5 = var_38_5.GetPoint(var_38_4, var_38_3)

		local var_38_6 = arg_38_1
		local var_38_7 = var_38_5 + arg_38_1.getConfig(var_38_6, "goods_num")

		pg = var_38_6

		if var_38_7 > var_38_6.child2_resource[var_38_3].max_value then
			table = var_38_7

			var_38_7.insert(var_38_0, function(arg_39_0)
				local var_39_0 = arg_38_0
				local var_39_1 = var_1.emit

				NewEducateBaseUI = var_2_10003

				local var_39_2 = var_2_10003.ON_BOX
				local var_39_3 = {}

				i18n = var_2_10005
				var_39_3.content = var_2_10005("child2_shop_point_sure")
	...
	seriesAsync = var_38_5

	var_38_5(var_38_0, function()
