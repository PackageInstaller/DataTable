...
function var_0_1.SetData(arg_2_0)
	...
	arg_2_0.moneyResId = var_2_2(var_2_1, var_1_10003.RES_TYPE.MONEY)

	local var_2_3 = arg_2_0.contextData.char
	local var_2_4 = var_1.GetResIdByType

	NewEducateChar = var_3
	arg_2_0.moodResId = var_2_4(var_2_3, var_3.RES_TYPE.MOOD)
	arg_2_0.resIds = {
		arg_2_0.moneyResId,
		arg_2_0.moodResId
	}
	...
	local var_2_10 = var_2_9(var_2_8, var_3.SYSTEM.PLAN)
...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.animEvent = var_3_4(var_3_3, var_3(var_1_10004))
	...
	arg_3_0.planUIList = var_3_7(var_3_8, var_3.Find(var_3_9, "tpl"))
	...
	arg_3_0.attrUIList = var_3_11(var_3_12, var_3.Find(var_3_13, "tpl"))
	...
	arg_3_0.resUIList = var_3_15(var_3_16, var_3.Find(var_3_17, "tpl"))
	setText = var_1

	local var_3_18 = arg_3_0.rootTF
	local var_3_19 = var_2.Find(var_3_18, "window/tip")

	i18n = var_3_18

	var_1(var_3_19, var_3_18("child_close_tip"))
	...
	local var_3_24 = var_2.Find(var_3_23, "right/Text")

	i18n = var_3_23

	var_1(var_3_24, var_3_23("child2_mood_benefit"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local var_5_6 = var_5_5(var_5_4, var_3.SYSTEM.PLAN)
	local var_5_7
...
function var_0_1.UpdataMood(arg_11_0)
	...
	var_1_10003(var_11_3, var_1_10005("child2_mood_stage" .. var_11_1))

	setText = var_1_10003

	var_1_10003(arg_11_0.moodEffectTF, var_11_2 / 100 .. "%")

	setActive = var_1_10003

	local var_11_4 = arg_11_0.moodTF

	var_1_10003(var_4.Find(var_11_4, "buff"), var_11_2 >= 0)

	setActive = var_1_10003

	local var_11_5 = arg_11_0.moodTF

	var_1_10003(var_4.Find(var_11_5, "debuff"), var_11_2 < 0)
...
function var_0_1.GetExtraStr(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if arg_12_3 ~= 0 then
		...
		var_12_0 = var_1_10006((arg_12_3 > 0 and "+" or "") .. arg_12_3, var_12_1)
	end
...
function var_0_1.UpdateAttr(arg_13_0, arg_13_1, arg_13_2)
	...
	NewEducateInfoPanel = var_13_3

	local var_13_5 = var_13_3.GetArrtInfo

	pg = var_8

	local var_13_6, var_13_7 = var_13_5(var_8.child2_attr[var_13_2].rank, var_13_4)
	...
	local var_13_10 = arg_13_2
	local var_13_11 = arg_13_2.Find(var_13_10, "gradient")

	Color = var_13_10

	var_11(var_13_11, var_13_10.NewHex(var_13_8))

	setImageColor = var_11

	local var_13_12 = arg_13_2
	local var_13_13 = arg_13_2.Find(var_13_12, "rank")

	Color = var_13_12

	var_11(var_13_13, var_13_12.NewHex(var_13_9))
	...
	local var_13_15 = var_13_4 - var_13_14 > 0 and "16CF99" or "FF6767"
	...
	local var_13_16 = arg_13_2
	local var_13_17 = arg_13_2.Find(var_13_16, "arrow")

	Color = var_13_16

	var_14(var_13_17, var_13_16.NewHex(var_13_15))

	setTextColor = var_14

	local var_13_18 = arg_13_2
	local var_13_19 = arg_13_2.Find(var_13_18, "value_new")

	Color = var_13_18

	var_14(var_13_19, var_13_18.NewHex(var_13_15))

	local var_13_20 = arg_13_0.benefit

	NewEducateConst = var_13_19

	local var_13_21

	if not var_13_20[var_13_19.DROP_TYPE.ATTR] or not var_14[var_13_2] then
		var_13_21 = 0
	end

	local var_13_22 = arg_13_0
	local var_13_23 = arg_13_0.GetExtraStr(var_13_22, var_13_14, var_13_4, var_13_21)

	setText = var_13_22

	local var_13_24 = arg_13_2
	local var_13_25 = arg_13_2.Find(var_13_24, "value_old")

	math = var_13_24

	var_13_22(var_13_25, var_13_24.max(var_13_14, 0) .. var_13_23)

	setActive = var_13_22

	var_13_22(arg_13_2:Find("VX"), var_13_14 ~= var_13_4)
...
function var_0_1.UpdateRes(arg_14_0, arg_14_1, arg_14_2)
	...
	var_4(var_14_1 .. var_1_10006.child2_resource[var_14_0].icon, arg_14_2:Find("icon"))
	...
	var_4(var_14_3, var_14_2.child2_resource[var_14_0].name)
	...
	var_8(arg_14_2:Find("value_new"), var_14_5)

	setImageColor = var_8

	local var_14_8 = arg_14_2
	local var_14_9 = arg_14_2.Find(var_14_8, "arrow")

	Color = var_14_8

	var_8(var_14_9, var_14_8.NewHex(var_14_7))

	setTextColor = var_8

	local var_14_10 = arg_14_2
	local var_14_11 = arg_14_2.Find(var_14_10, "value_new")

	Color = var_14_10

	var_8(var_14_11, var_14_10.NewHex(var_14_7))

	local var_14_12 = arg_14_0.benefit

	NewEducateConst = var_14_11

	local var_14_13

	if not var_14_12[var_14_11.DROP_TYPE.RES] or not var_8[var_14_0] then
		var_14_13 = 0
	end

	local var_14_14 = arg_14_0
	local var_14_15 = arg_14_0.GetExtraStr(var_14_14, var_14_6, var_14_5, var_14_13)

	setText = var_14_14

	local var_14_16 = arg_14_2
	local var_14_17 = arg_14_2.Find(var_14_16, "value_old")

	math = var_14_16

	var_14_14(var_14_17, var_14_16.max(var_14_6, 0) .. var_14_15)
...
function var_0_1.UpdatePlan(arg_15_0, arg_15_1, arg_15_2)
	...
	if var_15_0 then
		var_15_1 = "plan_type"
		pg = var_5
		var_15_1 = var_15_1 .. var_5.child2_plan[var_15_0].replace_type_show
