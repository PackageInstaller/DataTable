...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_2.Find(var_2_2, "tip/Text")

	i18n = var_2_2

	var_1(var_2_3, var_2_2("child2_nailing_game_tip"))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_2_0.countdownDft = var_2_6(var_2_5, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.scoreTextCom = var_2_10(var_2_9, var_3(var_4))
	setText = var_1

	local var_2_11 = arg_2_0.gameUI
	local var_2_12 = var_2.Find(var_2_11, "score/Text")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("child2_nailing_game_score"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.countTextCom = var_2_15(var_2_14, var_3(var_4))
	setText = var_1

	local var_2_16 = arg_2_0.gameUI
	local var_2_17 = var_2.Find(var_2_16, "count/Text")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("child2_nailing_game_count"))
	...
	typeof = var_3
	SpineAnimUI = var_4
	arg_2_0.hammerAnimUI = var_2_21(var_2_20, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.resultScoreTextCom = var_2_28(var_2_27, var_3(var_4))
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_2_0.animDft = var_2_31(var_2_30, var_3(var_4))
...
function var_0_1.OnInit(arg_4_0)
	...
	local var_4_3 = var_3.Find(var_4_2, "back")
	...
	local var_4_7 = var_3.Find(var_4_6, "box/menu/help")
	...
	local function var_4_8()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.child2_nailing_minigame_help.tip
	...
	local var_4_11 = var_3.Find(var_4_10, "start")
	...
	var_1(var_4_9, var_4_11, var_4_12, var_5)

	onButton = var_1

	local var_4_13 = arg_4_0
	local var_4_14 = arg_4_0.gameUI
	local var_4_15 = var_3.Find(var_4_14, "knock")
	...
	var_1(var_4_13, var_4_15, var_4_16, var_5)

	onButton = var_1

	local var_4_17 = arg_4_0
	local var_4_18 = arg_4_0.resultUI
	local var_4_19 = var_3.Find(var_4_18, "sure")
...
function var_0_1.LoadCharSD(arg_12_0)
	...
	local var_12_3 = var_12_1.GetInstance()
...
function var_0_1.StartCountDown(arg_15_0)
	...
	var_1_10001(var_2.Find(var_15_0, "count"), "countdown")
...
function var_0_1.RandomNails(arg_17_0)
	...
	for iter_17_0 = 1, arg_17_0.normalCnt + arg_17_0.invalidCnt do
		...
		math = var_1_10010
		var_17_3.x = var_17_2 + var_1_10010.random(0, var_0_9)
		setLocalPosition = var_1_10010

		var_1_10010(var_1_10007, var_17_3)

		var_1_10010 = arg_17_0.nails
...
function var_0_1.DownHammer(arg_28_0, arg_28_1, arg_28_2)
	...
	System = var_7
	arg_28_0.downTweenId = var_28_3(var_28_2, var_7.Action(arg_28_2)).uniqueId
...
function var_0_1.UpHammer(arg_30_0, arg_30_1)
	...
	System = var_5
	arg_30_0.upTweenId = var_30_2(var_30_1, var_5.Action(arg_30_1)).uniqueId
