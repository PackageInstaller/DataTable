...
function var_0_0.HandleDrops(arg_1_0)
	...
	for iter_1_4, iter_1_5 in var_3(var_1_0) do
		...
		var_1_7[var_1_10011.DROP_TYPE.ATTR] = function()
			if var_0_0.AddAttrDrop(iter_1_5) then
				table = var_1

				var_1.insert(var_1_5, var_0)
			end

			return
		end
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.RES] = function()
		...
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.POLAROID] = function()
		...
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.BUFF] = function()
		...
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.TAROT] = function()
		...
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.CHOOSE] = function()
			var_0_0.AddChooseState(iter_1_5)

			return
		end
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.UP_ENTRY] = function()
			var_0_0.AddUpEntryState(iter_1_5)

			return
		end
		NewEducateConst = var_1_10011
		var_1_7[var_1_10011.DROP_TYPE.TEMP_ROUND] = function()
...
function var_0_0.AddResDrop(arg_11_0)
	...
	local var_11_5 = var_11_3(var_11_4, var_11_2 - var_1_10005.child2_resource[arg_11_0.id].max_value)
	local var_11_6 = var_1

	var_1.UpdateRes(var_11_6, arg_11_0.id, arg_11_0.number)

	local var_11_7 = {}

	if var_11_5 then
		setmetatable = var_11_6
		var_11_7 = var_11_6({
			overflow = var_11_5
		}, {
			__index = arg_11_0
...
function var_0_0.AddReplaceTarotState(arg_17_0)
	...
	var_17_4(var_17_3, var_4.NEW_EDUCATE_CHECK_PRIORITY_FSM)
...
function var_0_0.AddChooseState(arg_18_0)
	...
	var_18_4(var_18_3, var_4.NEW_EDUCATE_CHECK_PRIORITY_FSM)
...
function var_0_0.AddUpEntryState(arg_19_0)
	...
	var_19_4(var_19_3, var_4.NEW_EDUCATE_CHECK_PRIORITY_FSM)
