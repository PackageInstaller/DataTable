...
function var_0_1.init(arg_2_0)
	...
	local var_2_1 = var_2.Find(var_2_0, "title")

	i18n = var_2_0

	var_1_10001(var_2_1, var_2_0("child2_replace_title"))

	setText = var_1_10001

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_2.Find(var_2_2, "tip")

	i18n = var_2_2

	var_1_10001(var_2_3, var_2_2("child2_replace_tip"))
	...
	var_1(var_2_11, var_2_10("child2_replace_cancel"))
	...
	var_1(var_2_14, var_2_13("child2_replace_sure"))
...
function var_0_1.UpdateView(arg_7_0)
	...
	var_7_7(var_7_6, var_7_8, var_1_10004.TYPE.CURRENT)

	local var_7_9 = arg_7_0.newCard
	local var_7_10 = var_1.Update
	local var_7_11 = arg_7_0.newId

	NewEducateTarotCard = var_4

	var_7_10(var_7_9, var_7_11, var_4.TYPE.REPLACE)
...
function var_0_1.CheckState(arg_8_0)
	...
	if var_1.IsFinish(var_8_1) then
		...
		NewEducateReplaceTarotMediator = var_1_10005

		var_8_8(var_8_7, var_1_10005.ON_REPLACE_TAROT, var_8_5)
	else
		arg_8_0:closeView()
	end
