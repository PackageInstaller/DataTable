	...
	NewEducateMainScene = {
		...
		},
		{
			...
			condition = function()
				...
				if var_0.GetRoundData(var_3_1).round == 1 then
					...
					var_3_6 = not var_3_5(var_3_4, var_1_10002.SYSTEM.TOPIC)
				else
					var_3_6 = false
				end
		...
		},
		{
			...
			condition = function()
				...
				NewEducateFSM = var_18_3

				if var_18_4 ~= var_18_3.SYSTEM.ENDING then
					return false
				end
				...
				var_18_7 = var_18_6(var_18_5, var_1_10004.SYSTEM.ENDING) and var_2:IsFinish()
...
function var_0_0.CheckGuide(arg_23_0, arg_23_1)
	...
	local var_23_1 = var_3(var_1_10004)
	local var_23_2 = var_3.GetCurChar(var_23_1)

	if var_3.GetGameCnt(var_23_2) == 1 then
		var_23_2 = var_3
		var_23_2 = var_3.GetRoundData(var_23_2)

		if var_4.IsTemp(var_23_2) then
			var_23_0()
		...
		if not var_23_2.detect(var_23_3, function(arg_25_0)
		...
		local var_23_6 = var_8.SeriesGuideMgr.GetInstance()

		if var_8.isRunning(var_23_6) then
			var_23_0()
		...
		local var_23_7 = var_8.NewGuideMgr.GetInstance()

		if not var_8.CanPlay(var_23_7) then
			var_23_0()
		...
		local var_23_8 = var_8.m02
		local var_23_9 = var_8.sendNotification

		GAME = var_1_10010

		var_23_9(var_23_8, var_1_10010.STORY_UPDATE, {
			storyId = var_23_4
		})

		pg = var_23_9

		local var_23_10 = var_23_9.NewGuideMgr.GetInstance()

		var_8.Play(var_23_10, var_23_4, var_23_5, function()
...
function var_0_0.PlayNextOne(arg_27_0, arg_27_1)
	...
	var_27_2(var_27_1, var_4.STORY_UPDATE, {
		storyId = arg_27_0
	})
