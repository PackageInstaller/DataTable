...
function var_0_1.init(arg_3_0)
	...
	arg_3_0.anim = var_3_2(var_3_1, var_3(var_1_10004))
	...
	arg_3_0.animEvent = var_3_5(var_3_4, var_3(var_1_10004))
	...
	Vector2 = var_3_7
	var_3_8.offsetMin = var_3_7(arg_3_0.contextData.isSelect and 208 or 0, 0)
	...
	pg = var_3
	arg_3_0.ids = var_3_18(var_3_19, var_3.child2_data.all)
	UIItemList = var_1
	...
	arg_3_0.toggleList = var_3_20(var_3_21, var_3.Find(var_3_22, "tpl"))
...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_5()
		if arg_5_0.contextData.id == 0 then
			...
			NewEducateCollectEntranceMediator = var_2_10002
			var_2_10002 = var_2_10002.GO_SUBLAYER
			Context = var_2_10003
			var_2_10003 = var_2_10003.New

			local var_7_2 = {}

			EducateCollectMediatorTemplate = var_2_10005
			var_7_2.mediator = var_2_10005
			EducateMemoryLayer = var_2_10005
			...
			local var_7_5 = var_2_10002.GO_SUBLAYER
			...
			NewEducateCollectMediatorTemplate = var_2_10005
			var_7_7.mediator = var_2_10005
			NewEducateMemoryLayer = var_2_10005
	...
	local function var_5_8()
		if arg_5_0.contextData.id == 0 then
			...
			EducateCollectMediatorTemplate = var_2_10005
			var_8_2.mediator = var_2_10005
			EducatePolaroidLayer = var_2_10005
			var_8_2.viewComponent = var_2_10005

			var_8_1(var_8_0, var_2_10002, var_2_10003(var_8_2))

			setActive = var_8_1
			var_2_10002 = arg_5_0.polaroidBtn

			var_8_1(var_1.Find(var_2_10002, "new"), false)
		else
			...
			local var_8_5 = var_2_10002.GO_SUBLAYER

			Context = var_2_10003

			local var_8_6 = var_2_10003.New
			local var_8_7 = {}

			NewEducateCollectMediatorTemplate = var_2_10005
			var_8_7.mediator = var_2_10005
			NewEducatePolaroidLayer = var_2_10005
			var_8_7.viewComponent = var_2_10005
			var_8_7.data = {
				permanentData = arg_5_0.permanentData
			}
	...
	var_1(var_5_6, var_5_7, var_5_8, var_1_10005)
	...
	var_1(var_5_9, var_5_10, var_5_11, var_1_10005)

	onButton = var_1

	local var_5_12 = arg_5_0
	local var_5_13 = arg_5_0.endingBtn
	local var_5_14 = var_3.Find(var_5_13, "unlock")

	local function var_5_15()
		if arg_5_0.contextData.id == 0 then
			isActive = var_0
			var_2_10002 = arg_5_0.endingBtn

			if var_0(var_1.Find(var_2_10002, "lock")) then
				return
			end
			...
			EducateCollectMediatorTemplate = var_2_10005
			var_10_2.mediator = var_2_10005
			EducateEndingLayer = var_2_10005
			var_10_2.viewComponent = var_2_10005

			var_10_1(var_10_0, var_2_10002, var_2_10003(var_10_2))
		else
			...
			local var_10_5 = var_2_10002.GO_SUBLAYER

			Context = var_2_10003

			local var_10_6 = var_2_10003.New
			local var_10_7 = {}

			NewEducateCollectMediatorTemplate = var_2_10005
			var_10_7.mediator = var_2_10005
			NewEducateEndingLayer = var_2_10005
			var_10_7.viewComponent = var_2_10005
			var_10_7.data = {
				permanentData = arg_5_0.permanentData
			}
	...
	var_1(var_5_12, var_5_14, var_5_15, var_5)
	...
	local function var_5_18()
		...
		if arg_5_0.contextData.id == 0 then
			...
			local var_11_3 = var_2.GO_SCENE

			SCENE = var_2_10003

			local var_11_4 = var_2_10003.WORLD_COLLECTION

			var_2_10004 = {}
			WorldMediaCollectionScene = var_2_10005
			var_2_10004.page = var_2_10005.PAGE_MEMORTY
			EducateConst = var_5
			var_2_10004.memoryGroup = var_5.REVIEW_GROUP_ID

			var_11_2(var_11_1, var_11_3, var_11_4, var_2_10004)
		else
			pg = var_11_2
			...
			local var_11_9 = var_3.GO_SCENE

			SCENE = var_2_10004

			local var_11_10 = var_2_10004.WORLD_COLLECTION
			local var_11_11 = {}

			WorldMediaCollectionScene = var_2_10006
			var_11_11.page = var_2_10006.PAGE_MEMORTY
	...
	var_1(var_5_16, var_5_17, var_5_18, var_5)
	...
	local function var_5_21()
		...
		NewEducateBuffLayer = var_2_10005
	...
	var_1(var_5_19, var_5_20, var_5_21, var_5)
	...
	var_1.make(var_5_22, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventInit then
			...
			var_2_10005("qicon/" .. var_13_0, arg_13_2:Find("icon"))
	...
	if arg_5_0.contextData.isSelect then
		...
		local var_5_25 = var_2.Find

		tostring = var_5_21

		var_1(var_5_25(var_5_24, var_5_21(arg_5_0.contextData.id)), true)
	else
...
function var_0_1.FlushView(arg_15_0, arg_15_1)
	...
	var_15_4(var_5.Find(var_15_6, "Text"), var_15_3 .. "/" .. var_15_5)

	setActive = var_15_4

	local var_15_7 = arg_15_0.memoryBtn

	var_15_4(var_5.Find(var_15_7, "new"), false)
	...
	var_15_12(var_8.Find(var_15_14, "Text"), var_15_11 .. "/" .. var_15_13)

	setText = var_15_12

	local var_15_15 = arg_15_0.polaroidBtn2

	var_15_12(var_8.Find(var_15_15, "Text"), var_15_11 .. "/" .. var_15_13)

	setActive = var_15_12

	local var_15_16 = arg_15_0.polaroidBtn

	var_15_12(var_8.Find(var_15_16, "new"), false)

	setActive = var_15_12

	local var_15_17 = arg_15_0.polaroidBtn2

	var_15_12(var_8.Find(var_15_17, "new"), false)

	setActive = var_15_12

	var_15_12(arg_15_0.polaroidBtn, not var_15_9)

	setActive = var_15_12

	var_15_12(arg_15_0.polaroidBtn2, var_15_9)

	setActive = var_15_12

	var_15_12(arg_15_0.buffBtn, var_15_9)
	...
	if var_15_9 then
		...
		var_15_20(var_10.Find(var_15_22, "Text"), var_15_21 .. "/" .. var_15_19)
	end
	...
	var_15_25(var_10.Find(var_15_27, "unlock/Text"), var_15_24 .. "/" .. var_15_26)

	NewEducateConst = var_15_25

	local var_15_28, var_15_29

	if var_15_25.LOCK_ENDING then
		var_15_28 = arg_15_0.permanentData
	...
	var_15_28(var_11.Find(var_15_30, "unlock"), not var_15_29)

	setActive = var_15_28

	local var_15_31 = arg_15_0.endingBtn

	var_15_28(var_11.Find(var_15_31, "lock"), var_15_29)
...
function var_0_1.FlushTBView(arg_16_0)
	...
	local var_16_4 = #var_16_2.child_memory.all

	setText = var_1_10005

	local var_16_5 = arg_16_0.memoryBtn

	var_1_10005(var_6.Find(var_16_5, "Text"), #var_16_1 .. "/" .. var_16_4)
	arg_16_0:UpdateMemoryTip()

	local var_16_6, var_16_7 = var_1:GetPolaroidGroupCnt()

	setText = var_7

	local var_16_8 = arg_16_0.polaroidBtn

	var_7(var_8.Find(var_16_8, "Text"), var_16_6 .. "/" .. var_16_7)

	setActive = var_7

	local var_16_9 = arg_16_0.polaroidBtn
	local var_16_10 = var_8.Find(var_16_9, "lock")

	EducateHelper = var_16_9

	local var_16_11 = var_16_9.IsSystemUnlock

	EducateConst = var_10

	var_7(var_16_10, not var_16_11(var_10.SYSTEM_POLAROID))

	setActive = var_7

	local var_16_12 = arg_16_0.polaroidBtn
	local var_16_13 = var_8.Find(var_16_12, "new")

	EducateTipHelper = var_16_12

	local var_16_14 = var_16_12.IsShowNewTip

	EducateTipHelper = var_10

	var_7(var_16_13, var_16_14(var_10.NEW_POLAROID))

	setActive = var_7

	var_7(arg_16_0.polaroidBtn, true)

	setActive = var_7

	var_7(arg_16_0.polaroidBtn2, false)

	setActive = var_7

	var_7(arg_16_0.buffBtn, false)

	pg = var_7

	local var_16_15 = #var_7.child_ending.all

	setText = var_8

	local var_16_16 = arg_16_0.endingBtn

	var_8(var_9.Find(var_16_16, "unlock/Text"), #var_16_3 .. "/" .. var_16_15)

	EducateHelper = var_8

	local var_16_17 = var_8.IsSystemUnlock

	EducateConst = var_9

	local var_16_19

	if not var_16_17(var_9.SYSTEM_ENDING) then
		local var_16_18 = #var_16_3

		var_16_19 = 0 < var_16_18
	end

	setActive = var_9

	local var_16_20 = arg_16_0.endingBtn

	var_9(var_10.Find(var_16_20, "unlock"), var_16_19)

	setActive = var_9

	local var_16_21 = arg_16_0.endingBtn

	var_9(var_10.Find(var_16_21, "lock"), not var_16_19)
...
function var_0_1.UpdateMemoryTip(arg_17_0)
	...
	local var_17_1 = var_17_0(var_1_10002.child_memory.all, function(arg_18_0)
		...
		return var_18_0(var_2_10002.NEW_MEMORY, arg_18_0)
	end)
	...
	var_2(var_3.Find(var_17_2, "new"), var_17_1)
