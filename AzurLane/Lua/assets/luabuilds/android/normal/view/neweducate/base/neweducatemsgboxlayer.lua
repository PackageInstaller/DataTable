...
i18n = var_4
var_0_7[var_0_8] = var_4("child_msg_title_tip")
...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_26, var_2_25("child2_endless_reset_tip"))
	...
	local var_2_30 = var_2.Find(var_2_29, "pic")

	i18n = var_2_29

	var_1(var_2_30, var_2_29("word_cancel"))
	...
	local var_2_33 = var_2.Find(var_2_32, "pic")

	i18n = var_2_32

	var_1(var_2_33, var_2_32("word_ok"))
	...
	local var_2_36 = var_2.Find(var_2_35, "pic")

	i18n = var_2_35

	var_1(var_2_36, var_2_35("word_ok"))
...
function var_0_1.commonSetting(arg_6_0, arg_6_1)
	...
	local var_6_10 = var_11.Find(var_6_9, "pic")
	local var_6_11
	...
	local var_6_13 = var_11.Find(var_6_12, "pic")
	local var_6_14
	...
	var_1_10010(var_6_15, var_6_16, var_6_17, var_1_10014)
	...
	var_1_10010(var_6_18, var_6_19, var_6_20, var_1_10014)
	...
	var_1_10010(var_6_21, var_6_22, var_6_23, var_1_10014)
	...
	var_1_10010(var_6_24, var_6_25, var_6_26, var_1_10014)
	...
	local var_6_29 = var_12.Find(var_6_28, "anim_root/bg")
	...
	var_1_10010(var_6_27, var_6_29, var_6_30, var_14)
...
function var_0_1.showSingleItemBox(arg_27_0)
	...
	var_2(var_27_1, var_27_2)

	getProxy = var_2
	NewEducateProxy = var_27_1

	local var_27_3 = var_2(var_27_1)
	...
	var_27_4(var_27_6, var_1_10006("child_msg_owned", var_27_5))

	local var_27_7 = arg_27_0.settings.drop.type

	NewEducateConst = var_27_6

	if var_27_7 == var_27_6.DROP_TYPE.RES then
		var_27_7 = var_27_0.type
		NewEducateChar = var_5

		if var_27_7 == var_5.RES_TYPE.MOOD then
			local var_27_8 = var_2

			var_27_7 = var_2.GetMoodStage(var_27_8)
			setText = var_27_8

			local var_27_9 = arg_27_0.singleItemDesc

			string = var_7

			local var_27_10 = var_7.gsub
			local var_27_11 = var_27_0.desc
			local var_27_12 = "$1"

			i18n = var_1_10010

			var_27_8(var_27_9, var_27_10(var_27_11, var_27_12, var_1_10010("child2_mood_desc" .. var_27_7)))
	...
	do
		local var_27_13 = arg_27_0.singleItemDesc
		local var_27_14
...
function var_0_1.showShopBuyBox(arg_28_0)
	...
	var_1_10001(var_2.Find(var_28_0, "price/Text"), arg_28_0.settings.price)
...
function var_0_1.showResetBox(arg_29_0)
	...
	local var_29_4 = var_1
	local var_29_5 = var_1.GetWave(var_29_4)

	setText = var_29_4

	local var_29_6 = arg_29_0._resetContent
	local var_29_7 = var_5.Find(var_29_6, "history")

	i18n = var_29_6

	var_29_4(var_29_7, var_29_6("child2_endless_history_wave", var_29_3))

	setText = var_29_4

	local var_29_8 = arg_29_0._resetContent
	local var_29_9 = var_5.Find(var_29_8, "current")

	i18n = var_29_8

	var_29_4(var_29_9, var_29_8("child2_endless_current_wave", var_29_5))

	setActive = var_29_4

	local var_29_10 = arg_29_0._resetContent

	var_29_4(var_5.Find(var_29_10, "current/new"), var_29_3 < var_29_5)
