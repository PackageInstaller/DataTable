...
function var_0_1.register(arg_1_0)
	...
	local var_1_5 = var_1_4(var_1_3, var_1_10006.ACTIVITY_TYPE_CHALLENGE)
	...
	arg_1_0:bind(var_0_1.ON_OPEN_RANK, function()
		...
		local var_2_3 = var_2_10003.BILLBOARD
		local var_2_4 = {}

		PowerRank = var_2_10005
		var_2_4.page = var_2_10005.TYPE_CHALLENGE
	...
	var_1_7(var_1_6, var_7.CLICK_GET_AWARD_BTN, function(arg_3_0, arg_3_1)
	...
	var_1_9(var_1_8, var_7.RESET_DATA_EVENT, function(arg_4_0, arg_4_1, arg_4_2)
		local var_4_0 = arg_1_0
		local var_4_1 = var_3.sendNotification

		GAME = var_2_10005

		var_4_1(var_4_0, var_2_10005.CHALLENGE2_RESET, {
			mode = arg_4_1,
	...
	ActivityFleetPanel = var_7

	var_1_11(var_1_10, var_7.ON_OPEN_DOCK, function(arg_5_0, arg_5_1)
		...
		local var_5_5 = var_2_10007(var_2_10008)
		...
		local var_5_13 = var_14.GO_SCENE

		SCENE = var_2_10015

		local var_5_14 = var_2_10015.DOCKYARD
		local var_5_15 = {
			selectedMin = 0,
			useBlackBlock = true,
			selectedMax = 1
		...
		i18n = var_2_10017
		var_5_15.leastLimitMsg = var_2_10017("ship_formationMediator_leastLimit")
		var_5_15.quitTeam = var_5_2 ~= nil
		var_5_15.teamFilter = var_5_4
		i18n = var_17
		var_5_15.leftTopInfo = var_17("word_formation")
		...
		var_5_17.__index = var_2_10020.TAG_HIDE_CHALLENGE
		var_5_15.hideTagFlags = var_17(var_5_16, var_5_17)
		var_5_15.otherSelectedIds = var_5_3
		pg = var_17

		local var_5_18 = var_17.ShipFlagMgr.GetInstance()

		var_5_15.ignoredIds = var_17.FilterShips(var_5_18, {
			isActivityNpc = true
		})
	...
	arg_1_0:bind(var_0_1.ON_FLEET_SHIPINFO, function(arg_7_0, arg_7_1)
		...
		var_7_1(var_7_0, var_7_2, var_2_10005.SHIPINFO, {
	...
	var_1_13(var_1_12, var_7.ON_FLEET_RECOMMEND, function(arg_8_0, arg_8_1)
	...
	var_1_15(var_1_14, var_7.ON_FLEET_CLEAR, function(arg_9_0, arg_9_1)
	...
	arg_1_0:bind(var_0_1.COMMANDER_FORMATION_OP, function(arg_10_0, arg_10_1)
		...
		var_10_1(var_10_0, var_2_10004.COMMANDER_FORMATION_OP, {
			data = arg_10_1
		})
	...
	arg_1_0:bind(var_0_1.ON_SELECT_ELITE_COMMANDER, function(arg_12_0, arg_12_1, arg_12_2)
		...
		local var_12_5 = var_2_10008.GO_SCENE

		SCENE = var_2_10009

		local var_12_6 = var_2_10009.COMMANDERCAT
		local var_12_7 = {
			maxCount = 1
		}

		CommanderCatScene = var_2_10011
		var_12_7.mode = var_2_10011.MODE_SELECT
		var_12_7.activeCommander = var_12_2[arg_12_2]
		var_12_7.ignoredIds = {}
		CommanderCatScene = var_11
		var_12_7.fleetType = var_11.FLEET_TYPE_CHALLENGE
		...
		function var_12_7.onSelected(arg_14_0, arg_14_1)
			...
			local var_14_1 = var_3_10003(var_3_10004)
			local var_14_2 = var_3.getCommanderById(var_14_1, var_14_0)

			pairs = var_14_1

			for iter_14_0, iter_14_1 in var_14_1(var_0) do
				if iter_14_0 == arg_12_1 then
					...
					for iter_14_2, iter_14_3 in var_10(var_12_2) do
						if iter_14_3.groupId == var_14_2.groupId and iter_14_2 ~= arg_12_2 then
							...
							var_14_4(var_14_3, var_3_10017("commander_can_not_select_same_group"))
					...
					local var_14_6 = iter_14_1.getCommanders(var_14_5)

					pairs = var_14_5

					for iter_14_4, iter_14_5 in var_14_5(var_14_6) do
						if var_14_0 == iter_14_5.id then
							pg = var_16
							var_3_10017 = var_16.TipsMgr.GetInstance()

							local var_14_7 = var_16.ShowTips

							i18n = var_3_10018

							var_14_7(var_3_10017, var_3_10018("commander_is_in_fleet_already"))
			...
			local var_14_8 = var_0

			var_5.updateCommanderByPos(var_14_8, arg_12_2, var_14_2)

			local var_14_9 = var_1_0

			var_5.updateActivityFleet(var_14_9, var_1_5.id, arg_12_1, var_0)
			arg_14_1()
	...
	arg_1_0:bind(var_0_1.ON_PRECOMBAT, function(arg_16_0, arg_16_1)
		...
		if var_2.checkActivityFleet(var_16_0, var_1_5.id) ~= true then
			...
			var_16_2(var_16_1, var_4("elite_disable_no_fleet"))
		...
		if var_16_5 == var_16_4.Vanguard then
			pg = var_16_7
			...
			var_16_7(var_16_6, var_2_10008("ship_vo_vanguardFleet_must_hasShip"))
			...
			if var_16_5 == var_16_7.Main then
				...
				var_16_9(var_16_8, var_2_10008("ship_vo_mainFleet_must_hasShip"))
		...
		if not var_6.getUserChallengeInfo(var_16_11, arg_16_1) then
			...
			var_16_13(var_16_12, var_2_10009.CHALLENGE2_INITIAL, {
				mode = arg_16_1
			})
		...
		local var_16_16 = var_2_10009.New
		local var_16_17 = {}

		ChallengePreCombatMediator = var_2_10011
		var_16_17.mediator = var_2_10011
		ChallengePreCombatLayer = var_2_10011
		var_16_17.viewComponent = var_2_10011

		local var_16_18 = {}

		SYSTEM_CHALLENGE = var_2_10012
		var_16_18.system = var_2_10012
...
function var_0_1.handleNotification(arg_19_0, arg_19_1)
	...
	local var_19_4 = var_1_10005(var_1_10006)

	getProxy = var_1_10006
	FleetProxy = var_1_10007

	local var_19_5 = var_1_10006(var_1_10007)

	GAME = var_1_10007

	local var_19_6

	if var_19_0 == var_1_10007.CHALLENGE2_INITIAL_DONE then
		var_19_6 = var_19_2.mode
		var_1_10009 = var_19_3
		var_1_10008 = var_19_3.getUserChallengeInfo(var_1_10009, var_19_6)

		local var_19_7 = var_19_4

		var_1_10009 = var_19_4.getActivityByType
		ActivityConst = var_1_10011
		var_1_10009 = var_1_10009(var_19_7, var_1_10011.ACTIVITY_TYPE_CHALLENGE)

		local var_19_8 = arg_19_0
		local var_19_9 = arg_19_0.addSubLayers
		...
		var_19_11.mediator = var_1_10014
		ChallengePreCombatLayer = var_1_10014
		var_19_11.viewComponent = var_1_10014

		local var_19_12 = {}

		SYSTEM_CHALLENGE = var_1_10015
		var_19_12.system = var_1_10015
		var_19_12.actId = var_1_10009.id
		var_19_12.mode = var_19_6
		...
		var_19_9(var_19_8, var_19_10(var_19_11))

		local var_19_13 = arg_19_0.viewComponent

		var_10.updateData(var_19_13)

		local var_19_14 = arg_19_0.viewComponent

		var_10.updatePaintingList(var_19_14)

		local var_19_15 = arg_19_0.viewComponent

		var_10.updateRoundText(var_19_15)

		local var_19_16 = arg_19_0.viewComponent

		var_10.updateSlider(var_19_16)

		local var_19_17 = arg_19_0.viewComponent

		var_10.updateFuncBtns(var_19_17)
	else
		GAME = var_19_6

		local var_19_18

		if var_19_0 == var_19_6.CHALLENGE2_RESET_DONE then
			...
			if var_19_18 == var_1_10008.MODE_INFINITE then
				...
				if not var_19_18.isFinishedCasualMode(var_1_10008) then
					var_1_10008 = var_19_3
					var_19_18 = var_19_3.setCurMode
					ChallengeProxy = var_1_10009

					var_19_18(var_1_10008, var_1_10009.MODE_CASUAL)
				end
			end

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updateData(var_1_10008)

			var_1_10008 = arg_19_0.viewComponent
			var_19_18 = var_19_18.updateGrade

			local var_19_19 = var_19_3:getChallengeInfo()

			var_19_18(var_1_10008, var_1_10009.getGradeList(var_19_19))

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updateSwitchModBtn(var_1_10008)

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updatePaintingList(var_1_10008)

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updateRoundText(var_1_10008)

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updateSlider(var_1_10008)

			var_1_10008 = arg_19_0.viewComponent

			var_19_18.updateFuncBtns(var_1_10008)
		else
			GAME = var_19_18

			local var_19_20

			if var_19_0 == var_19_18.CHALLENGE2_INFO_DONE then
				...
				if var_19_20 == var_1_10008.MODE_INFINITE then
					...
					if not var_19_20.isFinishedCasualMode(var_1_10008) then
						var_1_10008 = var_19_3
						var_19_20 = var_19_3.setCurMode
						ChallengeProxy = var_1_10009

						var_19_20(var_1_10008, var_1_10009.MODE_CASUAL)
					end
				end

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateData(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent
				var_19_20 = var_19_20.updateGrade

				local var_19_21 = var_19_3:getChallengeInfo()

				var_19_20(var_1_10008, var_1_10009.getGradeList(var_19_21))

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateTimePanel(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateSwitchModBtn(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updatePaintingList(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateRoundText(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateSlider(var_1_10008)

				var_1_10008 = arg_19_0.viewComponent

				var_19_20.updateFuncBtns(var_1_10008)
			else
				GAME = var_19_20

				local var_19_22

				if var_19_0 == var_19_20.SUBMIT_TASK_DONE then
					var_1_10008 = arg_19_0.viewComponent
					var_19_22 = var_19_22.emit
					BaseUI = var_1_10009

					var_19_22(var_1_10008, var_1_10009.ON_ACHIEVE, var_19_2, function()
					...
					if var_19_0 == var_19_22.PREFAB_FLEET_UPDATE then
						getProxy = var_19_24
						CommanderProxy = var_1_10008

						local var_19_23 = var_19_24(var_1_10008)
						...
						if var_19_0 == var_19_24.COMMANDER_ACTIVITY_FORMATION_OP_DONE then
							local var_19_27 = var_19_5:getActivityFleets()[var_19_2.actId]
							...
							var_8.updateCommanderFleet(var_19_30, var_19_27[var_19_2.fleetId])
						end
					end
				end
			end
...
function var_0_1.getDockCallbackFuncs(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4)
	...
	local var_22_0 = var_1_10005(var_1_10006)

	getProxy = var_1_10006
	FleetProxy = var_1_10007

	local var_22_1 = var_1_10006(var_1_10007)

	getProxy = var_1_10007
	ActivityProxy = var_1_10008

	local var_22_2 = var_1_10007(var_1_10008)
	local var_22_3 = var_7.getActivityByType

	ActivityConst = var_1_10010

	local var_22_4 = var_22_3(var_22_2, var_1_10010.ACTIVITY_TYPE_CHALLENGE)
	...
	local function var_22_5(arg_23_0, arg_23_1)
		...
		for iter_23_0, iter_23_1 in var_4(arg_22_1) do
			...
			if var_23_3(var_23_2, var_11.getShipById(var_23_4, iter_23_1)) then
				local var_23_5 = false

				i18n = var_23_2

				local var_23_6 = var_23_2("ship_formationMediator_changeNameError_sameShip")
	...
	local function var_22_7(arg_25_0)
		...
		local var_25_2 = var_25_1(var_25_0, var_2_10003.ACTIVITY_TYPE_CHALLENGE)
		...
		if #arg_25_0 > 0 then
			...
			var_25_6(var_25_5, var_7.getShipById(var_25_7, arg_25_0[1]), nil, arg_22_4)
		end
