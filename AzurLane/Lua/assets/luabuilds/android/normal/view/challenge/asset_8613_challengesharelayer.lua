			...
			var_3.insert(arg_6_0.funcs, function(arg_9_0)
				...
				var_3_10001("shipYardIcon/" .. arg_6_0.shipPaintList[arg_8_1 + 1], function(arg_10_0)
					...
					if not var_4_10001(arg_8_2) then
						...
						var_1(var_2.Find(var_10_0, "back/Image"), arg_10_0)
					end
...
function var_0_1.flush(arg_11_0)
	...
	var_1(arg_11_0.funcs, function()
		...
		var_13_2(var_13_1, var_2_10002.ShareMgr.TypeChallenge)
	...
	local var_11_2 = var_2.Find(var_11_1, "Text")

	i18n = var_11_1

	var_1(var_11_2, var_11_1("challenge_share_progress"))

	setText = var_1

	local var_11_3 = arg_11_0.wordTF

	var_1(var_2.Find(var_11_3, "number/Text"), arg_11_0.level)

	setText = var_1

	local var_11_4 = arg_11_0.wordTF
	local var_11_5 = var_2.Find(var_11_4, "Text2")

	i18n = var_11_4

	var_1(var_11_5, var_11_4("challenge_share"))
