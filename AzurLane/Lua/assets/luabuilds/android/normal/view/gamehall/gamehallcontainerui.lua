...
local var_0_2 = var_0_10002(0.7, 0.7, 0.7)
...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0 = 0, arg_1_0.pos.childCount - 1 do
		...
		var_1_10010 = arg_1_0.items
		var_1_10012 = arg_1_0.pos

		var_1_10009(var_1_10010, var_11.GetChild(var_1_10012, iter_1_0))
	end
	...
	for iter_1_1 = 1, #var_0_12 do
		...
		GetComponent = var_11
		findTF = var_1_10012
		var_1_10012 = var_1_10012(arg_1_0.pos, var_1_3.spine)
		typeof = var_1_10013
		SpineAnimUI = var_14

		local var_1_4 = var_11(var_1_10012, var_1_10013(var_14))

		GetComponent = var_1_10012
		findTF = var_1_10013
		var_1_10013 = var_1_10013(arg_1_0.pos, var_1_3.bound)
		typeof = var_14
		BoxCollider2D = var_1_10015
		var_1_10012 = var_1_10012(var_1_10013, var_14(var_1_10015))

		local var_1_5 = arg_1_0.pos

		var_1_10013 = var_1_10013.InverseTransformPoint(var_1_5, var_1_10012.bounds.min)
		var_1_10015 = arg_1_0.pos

		local var_1_6 = var_14.InverseTransformPoint(var_1_10015, var_1_10012.bounds.max)

		table = var_1_10015

		var_1_10015.insert(arg_1_0.sitItems, {
			sit = false,
			pos = var_1_10010,
			min = var_1_10013,
			max = var_1_6,
	...
	local var_1_7 = var_5(var_6)
	local var_1_8 = var_5.getShips(var_1_7)
	local var_1_9 = {}

	for iter_1_2 = 1, #var_1_8 do
		table = var_1_10012

		if not var_1_10012.contains(var_1_9, var_1_8[iter_1_2].name) then
			table = var_1_10012
			var_1_10012 = var_1_10012.insert
			var_1_10013 = var_1_9
			var_1_10015 = var_1_8[iter_1_2]

			var_1_10012(var_1_10013, var_14.getPrefab(var_1_10015))
		end
	end
	...
	for iter_1_3 = 1, var_0_1 do
		...
		math = var_1_10015
		var_1_10013 = var_1_10013(var_1_11, var_1_10015.random(1, #var_1_9))
		SpineAnimChar = var_1_11

		local var_1_12 = var_1_11.New()

		var_14.SetPaint(var_1_12, var_1_10013)
		var_14:Load(true, function(arg_2_0)
			...
			var_2_1, GetComponent = var_1(var_2_0, var_3(var_1_10)), var_2_0
			typeof = var_4
			BoxCollider2D = var_2_10005

			local var_2_2 = var_2_0(var_2_1, var_4(var_2_10005))
			...
			var_2_8(var_2_7, var_7.getTargetPos(var_2_9, var_2_4, var_2_6))
	...
	local var_1_13 = var_8.GetInstance()

	var_8.GetSpineChar(var_1_13, var_0_3, true, function(arg_3_0)
		...
		local var_3_3 = var_3_2(var_3_1, var_3(var_2_10004))
		...
		var_2(var_3_4, var_4(arg_1_0.bataiTf, "char"))
	...
	Vector2 = var_1_13
	var_1_14.anchoredPosition = var_1_13(0, 0)
	GetOrAddComponent = var_1_14
	...
	local var_1_16 = var_1_14(var_1_15, var_10(var_11))

	Vector2 = var_1_15
	arg_1_0.velocityXSmoothing = var_1_15(0, 0)
	arg_1_0.offsetPosition = arg_1_0.content.anchoredPosition

	var_1_16:AddBeginDragFunc(function(arg_4_0, arg_4_1)
	...
	var_1_16:AddDragFunc(function(arg_5_0, arg_5_1)
	...
	var_1_16:AddDragEndFunc(function(arg_6_0, arg_6_1)
		return
	end)
	...
	for iter_1_4 = 1, #var_0_11 do
		findTF = var_1_10013
		var_1_10013 = var_1_10013(arg_1_0.pos, var_0_11[iter_1_4][1])
		GetComponent = var_14
		findTF = var_15

		local var_1_17 = var_15(arg_1_0.pos, var_0_11[iter_1_4][2])

		typeof = var_16
		SpineAnimUI = var_17

		local var_1_18 = var_14(var_1_17, var_16(var_17))

		table = var_1_17

		var_1_17.insert(arg_1_0.clickItems, {
			time = 0,
			tf = var_1_10013,
			anim = var_1_18
		})
		...
		var_15(arg_1_0._event, var_1_10013, function()
			local var_7_0 = arg_1_0

			if var_0.checkClickTime(var_7_0, var_1_18) then
				local var_7_1 = arg_1_0

				var_0.setAnimAction(var_7_1, var_1_18, "action", 1, "normal")
			end
...
function var_0_0.step(arg_11_0)
	...
	for iter_11_0 = 1, #arg_11_0.chars do
		...
		if not var_11_1 or var_11_1 <= 0 then
			...
			if var_5.sitFlag then
				...
				if var_11_3.random(1, 10) > 5 then
					...
					var_5.vel, var_5.target = arg_11_0:getVel(var_11_2, var_11_3), var_11_3
				end
			end
		...
		if var_5.target and not var_5.sitFlag then
			...
			var_1_10011 = var_5.model

			var_10.SetAnchoredPosition(var_1_10011, var_5.pos)

			local var_11_10 = var_5.target
		...
		local var_11_11 = true
		local var_11_12 = var_5.sitFlag

		if var_5.vel.x == 0 and var_5.vel.y == 0 then
			local var_11_13 = var_5.time

			Time = var_1_10011
			var_5.time = var_11_13 - var_1_10011.deltaTime
			var_11_11 = false
		end

		if not var_11_11 and var_5.target then
			var_5.target = nil
		end

		if not var_5.sitFlag and not var_11_11 then
			var_5.ableSit = true
		end

		if var_5.vel.x ~= 0 then
			local var_11_14 = var_5.vel.x
			local var_11_15 = 0 < var_11_14 and 1 or -1

			math = var_1_10011

			if var_1_10011.sign(var_5.curScale.x) ~= var_11_15 then
				var_1_10011 = var_5.curScale
				var_1_10011.x = var_11_15 * var_0_2.x

				local var_11_16 = var_5.model

				var_1_10011.SetLocalScale(var_11_16, var_5.curScale)
			end
		end
		...
		if var_11_11 then
			if var_5.curAction ~= "walk" then
				...
				var_10.SetAction(var_1_10011, "walk", 0)
			end
		elseif var_11_12 then
			if var_5.curAction ~= "sit" then
				...
				var_10.SetAction(var_1_10011, "sit", 0)
			end
		elseif var_5.curAction ~= "stand2" then
			var_5.curAction = "stand2"
			var_1_10011 = var_5.model

			var_10.SetAction(var_1_10011, "stand2", 0)
		end

		if var_11_11 then
			var_1_10011 = arg_11_0

			arg_11_0.checkCharSit(var_1_10011, var_5)
		end
	end
...
function var_0_0.getVel(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_1 = var_1_10004.abs(arg_14_2.y - arg_14_1.y)

	math = var_5

	local var_14_2 = var_14_0(var_14_1 / var_5.abs(arg_14_2.x - arg_14_1.x))
...
function var_0_0.getTargetPos(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_1 = var_19_0 - var_4(arg_19_1.x)
	...
	local var_19_5 = var_19_4 + var_1_10007.random(1, var_19_1)
	local var_19_6 = arg_19_1.y

	math = var_8

	return var_5(var_19_5, var_19_6 + var_8.random(1, var_19_3))
end
...
function var_0_0.Dispose(arg_21_0)
	if arg_21_0.coinChar then
		...
		var_21_1(var_21_0, var_21_2, var_1_10004(arg_21_0.coinChar))
