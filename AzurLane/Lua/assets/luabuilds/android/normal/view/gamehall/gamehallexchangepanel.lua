...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_1_2, updateDrop = var_5(arg_1_0._tf, "window/single_item_panel/iconPos/icon"), var_6
	...
	var_6(var_1_2, var_1_3)

	setText = var_6
	findTF = var_1_2

	var_6(var_1_2(arg_1_0._tf, "window/single_item_panel/name_mode/name_mask/name"), arg_1_0.itemCfg.name)

	setText = var_6
	findTF = var_7

	local var_1_4 = var_7(arg_1_0._tf, "window/single_item_panel/own/label")

	i18n = var_8

	var_6(var_1_4, var_8("word_own1"))
	...
	var_6(var_1_5, var_8(arg_1_0._tf, "bg"), function()
	...
	var_6(var_1_6, var_8(arg_1_0._tf, "top/btnBack"), function()
	...
	var_6(var_1_7, var_8(arg_1_0._tf, "window/btnCancel"), function()
	...
	var_6(var_1_8, var_8(arg_1_0._tf, "window/btnConfirm"), function()
		...
		if arg_1_0.myGold < var_5_0 then
			...
			var_5_2(var_5_1, var_2_10003("ship_remould_no_gold"))
		else
	...
	findTF = var_6
	arg_1_0.disCount = var_6(arg_1_0._tf, "window/discount")
	findTF = var_6
	...
	var_6(var_1_9, var_8(arg_1_0._tf, "window/count_select/value_bg/left"), function()
	...
	var_6(var_1_10, var_8(arg_1_0._tf, "window/count_select/value_bg/right"), function()
		arg_1_0.coinCount = arg_1_0.coinCount + 1
	...
	var_6(var_1_11, var_8(arg_1_0._tf, "window/count_select/max"), function()
	...
	var_6(var_1_13, var_8("word_cancel"))
	...
	var_6(var_1_14, var_8("title_info"))
...
function var_0_0.exchangeCoin(arg_9_0)
	...
	GameHallMediator = var_1_10003

	var_9_1(var_9_0, var_1_10003.EXCHANGE_COIN, {
...
function var_0_0.coinCountChange(arg_10_0)
	...
	local var_10_3 = var_4(arg_10_0._tf, "window/count_select/desc_txt")

	i18n = var_5

	var_3(var_10_3, var_5("charge_game_room_coin_tip", var_10_0, arg_10_0.coinCount, var_10_2, arg_10_0.itemCfg.name))

	setText = var_3
	findTF = var_10_3

	var_3(var_10_3(arg_10_0._tf, "window/count_select/value_bg/value"), arg_10_0.coinCount)

	local var_10_4 = arg_10_0
	local var_10_5 = arg_10_0.getDiscount(var_10_4, arg_10_0.coinCount + arg_10_0.payCoinCount)

	setActive = var_10_4

	var_10_4(arg_10_0.disCount, var_10_5 ~= 0)

	setText = var_10_4

	var_10_4(arg_10_0.disCountText, var_10_5 .. "%OFF")
...
function var_0_0.getDiscount(arg_11_0, arg_11_1)
	...
	if arg_11_0.getPriceByCount(var_11_1, arg_11_1) ~= var_11_0 then
		tonumber = var_11_1

		return var_11_1((var_11_0 - var_3) * 100 / var_11_0)
	end
