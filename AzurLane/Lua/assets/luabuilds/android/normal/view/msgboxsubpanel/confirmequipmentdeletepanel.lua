...
function var_0_1.OnRefresh(arg_3_0, arg_3_1)
	...
	var_3_2(var_3_1, var_1_10005(937, 540))
	...
	var_3_7, setText = var_4.Find(var_3_6, "Placeholder"), var_3_6
	i18n = var_1_10008

	var_3_6(var_3_7, var_1_10008("box_equipment_del_click"))

	setText = var_3_6

	local var_3_8 = var_3_4

	SwitchSpecialChar = var_8
	i18n = var_9

	var_3_6(var_3_8, var_8(var_9("destory_important_equipment_tip", var_3_0.name)))
	...
	local function var_3_9()
		...
		if var_0 ~= var_3_0.name then
			...
			var_4_3(var_4_2, var_2_10003("destory_important_equipment_input_erro"))
