...
function var_0_1.UpdateView(arg_3_0, arg_3_1)
	...
	Vector2 = var_3
	var_3_0.sizeDelta = var_3.New(1000, 638)
...
function var_0_1.findUI(arg_4_0)
	...
	var_4_7(var_4_9, var_1_10005("word_cancel"))
	...
	var_4_7(var_4_10, var_5("word_ok"))
...
function var_0_1.addListener(arg_6_0)
	...
	local function var_6_2()
		...
		if not arg_6_0.curUnlockMaterialID then
			pg = var_7_0
			var_2_10001 = var_7_0.TipsMgr.GetInstance()
			var_7_0 = var_7_0.ShowTips
			i18n = var_2_10002

			var_7_0(var_2_10001, var_2_10002("meta_unlock_skill_select"))
			...
			if var_7_0.getItemCountById(var_7_1, arg_6_0.curUnlockMaterialID) < arg_6_0.curUnlockMaterialNeedCount then
				...
				local var_7_6 = var_2_10003.getMetaSkillTacticsConfig(arg_6_0.curUnlockSkillID, 1).skill_unlock
				...
				var_7_8(var_7_7, var_7.TACTICS_META_UNLOCK_SKILL, {
...
function var_0_1.updateContent(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_1_10005.getDefaultShipNameByGroupID(var_9_1.id)

	getSkillName = var_6

	local var_9_3 = var_6(var_4)
	...
	var_7(var_9_4, var_1_10009("meta_unlock_skill_tip", var_9_2, var_9_3))
	...
	var_9.make(var_9_7, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			var_10_4.type = var_8
			var_10_4.id = var_10_0[2]
			var_10_4.count = var_10_0[3]
			updateDrop = var_8

			var_8(var_10_1, var_10_4)
			...
			local var_10_7 = var_10(var_2_10011)

			if var_10.getItemCountById(var_10_7, var_10_5) < var_10_6 then
				setColorStr = var_10_7

				local var_10_8 = var_10

				COLOR_RED = var_2_10013

				if not var_10_7(var_10_8, var_2_10013) then
					setColorStr = var_10_7
					var_10_8 = var_10
					COLOR_GREEN = var_2_10013
					var_10_7 = var_10_7(var_10_8, var_2_10013)
				end

				setText = var_10_8

				var_10_8(var_10_3, var_10_7 .. "/" .. var_10_6)
