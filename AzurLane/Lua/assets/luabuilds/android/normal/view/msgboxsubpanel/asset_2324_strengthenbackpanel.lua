...
function var_0_1.UpdateView(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_2_1.getConfigData(var_0_1.ConfigData.equipID).name
	...
	var_4(var_2_4, var_1_10006(var_0_1.ConfigData.content, var_2_3))

	local var_2_5 = arg_2_0._tf
	local var_2_6

	var_2_6, setText = var_4.Find(var_2_5, "button_container/custom_button_1(Clone)/pic", arg_2_0._tf.parent), var_2_5
	i18n = var_7

	var_2_5(var_2_6, var_7(var_0_1.ConfigData.btnTxt))

	local var_2_7 = arg_2_0._tf
	local var_2_8

	var_2_8, setImageSprite = var_5.Find(var_2_7, "icon_bg/icon"), var_2_7
	LoadSprite = var_8

	var_2_7(var_2_8, var_8(var_0_1.ConfigData.icon))

	if arg_2_1.windowSize then
		local var_2_9 = arg_2_0._tf.parent

		Vector2 = var_2_8
		var_2_9.sizeDelta = var_2_8(arg_2_1.windowSize.x, arg_2_1.windowSize.y)
	end
