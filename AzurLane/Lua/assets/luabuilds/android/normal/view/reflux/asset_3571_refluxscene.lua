...
function var_0_1.preload(arg_2_0, arg_2_1)
	...
	if var_3.ShouldRefreshChargeList(var_2_1) then
		...
		var_2_3(var_2_2, var_1_10005.GET_CHARGE_LIST, {
			callback = var_2_0
		})
	else
		var_2_0()
...
function var_0_1.findUI(arg_8_0)
	...
	var_8_15, setText = var_2.Find(var_8_14, "time/icon"), var_8_14
	i18n = var_8_12

	var_8_14(var_8_15, var_8_12("reflux_word_1"))

	local var_8_16 = arg_8_0._tf
	local var_8_17

	var_8_17, setText = var_3.Find(var_8_16, "time/icon1"), var_8_16
	i18n = var_6

	var_8_16(var_8_17, var_6("word_date"))
...
function var_0_1.tryOpenLetterView(arg_17_0)
	...
	local var_17_0 = var_1_10001(var_1_10002).returnTimestamp
...
function var_0_1.updateDay(arg_23_0)
	...
	var_5(arg_23_0.dayText, var_23_2 - var_23_3)
