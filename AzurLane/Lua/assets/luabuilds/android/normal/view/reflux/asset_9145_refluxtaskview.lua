...
function var_0_1.initData(arg_5_0)
	...
	arg_5_0.refluxProxy = var_1(var_1_10002)
	pg = var_1
...
function var_0_1.initUI(arg_6_0)
	...
	for iter_6_0 = 0, arg_6_0.totalDayCount - 1 do
		...
		var_1_10008.insert(arg_6_0.daySpriteList, var_6_4)
	end

	local var_6_5 = arg_6_0._tf

	arg_6_0.itemTpl = var_2.Find(var_6_5, "ItemTpl")

	local var_6_6 = arg_6_0._tf
	local var_6_7 = var_2.Find(var_6_6, "TaskTpl")
	local var_6_8 = arg_6_0._tf
	local var_6_9 = var_3.Find(var_6_8, "ScrollRect/Container")

	UIItemList = var_6_8
	arg_6_0.taskUIList = var_6_8.New(var_6_9, var_6_7)

	local var_6_10 = arg_6_0.taskUIList

	var_4.make(var_6_10, function(arg_7_0, arg_7_1, arg_7_2)
	...
	arg_6_0.taskProgressText = var_4.Find(var_6_11, "BG/ProgressText")

	local var_6_12 = arg_6_0._tf

	arg_6_0.oneStepBtnDisable = var_4.Find(var_6_12, "OneStepDisable")

	local var_6_13 = arg_6_0._tf

	arg_6_0.oneStepBtn = var_4.Find(var_6_13, "OneStepBtn")
	onButton = var_4

	local var_6_14 = arg_6_0
	local var_6_15 = arg_6_0.oneStepBtn
	...
	local function var_6_16()
		...
		if var_0.isTaskListOverflow(var_8_0) then
			...
			local var_8_1 = var_8_0.TipsMgr.GetInstance()
			local var_8_2 = var_1.ShowTips

			i18n = var_2_10003

			var_8_2(var_8_1, var_2_10003("award_overflow_tip"))
			...
			if #var_8_3 > 0 then
				...
				var_8_14(var_8_13, var_6.SUBMIT_TASK_ONESTEP, {
					resultList = var_8_3
				})
			end
		end
...
function var_0_1.updateItem(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_2 = arg_12_1.Find(var_12_1, "Count")

	setText = var_12_1

	var_12_1(var_12_2, arg_12_2.count)

	local var_12_3 = arg_12_2.type

	DROP_TYPE_SHIP = var_6

	if var_12_3 ~= var_6 then
		setImageSprite = var_12_3

		local var_12_4 = var_12_0

		LoadSprite = var_7
		var_1_10009 = arg_12_2

		var_12_3(var_12_4, var_7(arg_12_2.getIcon(var_1_10009)))
	else
		Ship = var_12_3
		...
		local var_12_6 = var_5.getPainting(var_12_5)

		setImageSprite = var_12_5

		local var_12_7 = var_12_0

		LoadSprite = var_1_10009

		var_12_5(var_12_7, var_1_10009("QIcon/" .. var_12_6))
	end
...
function var_0_1.updateTask(arg_14_0, arg_14_1, arg_14_2)
	...
	local var_14_10 = arg_14_2.getTaskStatus(var_14_9)

	setActive = var_14_9

	var_14_9(var_3, var_14_10 == 0)

	setActive = var_14_9

	var_14_9(var_7, var_14_10 == 1)

	setActive = var_14_9

	var_14_9(var_14_8, var_14_10 == 2)

	local var_14_11 = arg_14_1:Find("DayImg")
	local var_14_12 = arg_14_0
	local var_14_13 = arg_14_0.getTaskUnlockSignCount(var_14_12, arg_14_2)

	setImageSprite = var_14_12

	var_14_12(var_14_11, arg_14_0.daySpriteList[var_14_13])

	local var_14_14 = arg_14_1
	local var_14_15 = arg_14_1.Find(var_14_14, "Lock")

	setActive = var_14_14

	var_14_14(var_14_15, not arg_14_0:isTaskUnlocked(arg_14_2))

	local var_14_16 = arg_14_1
	local var_14_17 = arg_14_1.Find(var_14_16, "DescText")

	setText = var_14_16

	var_14_16(var_14_17, arg_14_2:getConfig("desc"))

	local var_14_18 = arg_14_2:getProgress()
	local var_14_19 = arg_14_2
	local var_14_20 = arg_14_2.getConfig(var_14_19, "target_num")

	setSlider = var_14_19

	var_14_19(var_5, 0, var_14_20, var_14_18)

	setText = var_14_19

	var_14_19(var_14_3, var_14_18 .. "/" .. var_14_20)

	setSlider = var_14_19

	var_14_19(var_9, 0, var_14_20, var_14_18)

	setText = var_14_19

	var_14_19(var_14_7, var_14_18 .. "/" .. var_14_20)

	local var_14_21 = arg_14_1:Find("Drops")
	local var_14_22 = arg_14_0
	local var_14_23 = arg_14_0.getTaskAwardForShow(var_14_22, arg_14_2)

	UIItemList = var_14_22

	local var_14_24 = var_14_22.New(var_14_21, arg_14_0.itemTpl)
	...
	local function var_14_27()
		...
		var_16_1(var_16_0, var_2_10002.TASK_GO, {
			taskVO = arg_14_2
		})
	...
	var_22(var_14_25, var_14_26, var_14_27, var_1_10026)
	...
	local function var_14_30()
		local function var_17_0()
			...
			var_18_1(var_18_0, var_3_10002.SUBMIT_TASK, arg_14_2.id)
		...
		if var_17_2 then
			...
			i18n = var_2_10006
			var_17_6.content = var_2_10006("award_max_warning")
	...
	var_22(var_14_28, var_14_29, var_14_30, var_1_10026)
...
function var_0_1.updateOneStepBtn(arg_20_0)
	...
	local var_20_2 = arg_20_0.getTaskVOList(var_20_1)
...
function var_0_1.getTaskVOList(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(var_1_10003.return_task_template.all) do
		local var_21_1 = arg_21_0.taskProxy
		local var_21_2 = var_7.getTaskVO(var_21_1, iter_21_1)

		table = var_21_1

		var_21_1.insert(var_21_0, var_21_2)
	end
...
function var_0_1.isTaskOverflow(arg_27_0, arg_27_1)
	...
	local var_27_2 = var_27_0.gameset.urpt_chapter_max.description[1]

	LOCK_UR_SHIP = var_1_10004
	...
	if var_1_10004 then
		...
		local var_27_3 = var_1_10004(var_1_10005)
	...
	local var_27_8, var_27_9 = var_1_10008.StaticJudgeOverflow(false, false, false, true, true, var_27_7)
...
function var_0_1.isTaskListOverflow(arg_28_0)
	...
	local var_28_2 = arg_28_0.getTaskVOList(var_28_1)

	ipairs = var_28_1

	for iter_28_0, iter_28_1 in var_28_1(var_28_2) do
		var_1_10009 = iter_28_1

		if iter_28_1.getTaskStatus(var_1_10009) == 1 and arg_28_0:isTaskUnlocked(iter_28_1) then
			local var_28_3 = arg_28_0:getTaskAwardForShow(iter_28_1)[1].type
			local var_28_4 = var_1_10009[1].id
			local var_28_5 = var_1_10009[1].count
			local var_28_6

			if not var_28_0[var_28_4] then
				var_28_6 = {
					var_28_3,
					var_28_4,
					var_28_5
	...
	for iter_28_2, iter_28_3 in var_4(var_28_0) do
		...
		var_1_10009.insert(var_28_7, iter_28_3)
	end

	Task = var_4

	local var_28_8, var_28_9 = var_4.StaticJudgeOverflow(false, false, false, true, true, var_28_7)
...
function var_0_1.calcLastSubmitTaskPT(arg_31_0)
	...
	arg_31_0.clearLastSubmitTask(var_31_2)

	local var_31_3 = {}

	DROP_TYPE_ITEM = var_31_2
	var_31_3.type = var_31_2
	var_31_3.id = var_31_1
	var_31_3.count = var_31_0
...
function var_0_1.getTaskAwardForShow(arg_32_0, arg_32_1)
	...
	var_11.insert(var_32_6, var_32_8)
	...
	var_32_12.insert(var_32_6, var_32_13)
...
function var_0_1.isAnyTaskCanGetAward()
	...
	local var_33_0 = var_1_10000(var_1_10001)

	getProxy = var_1_10001
	RefluxProxy = var_1_10002

	local var_33_1 = var_1_10001(var_1_10002)
	local var_33_2 = {}

	ipairs = var_1_10003
	pg = var_1_10004

	for iter_33_0, iter_33_1 in var_1_10003(var_1_10004.return_task_template.all) do
		local var_33_3 = var_33_0
		local var_33_4 = var_33_0.getTaskVO(var_33_3, iter_33_1)

		table = var_33_3

		var_33_3.insert(var_33_2, var_33_4)
	end

	local function var_33_5(arg_34_0)
	...
	local function var_33_6(arg_35_0)
		return var_33_5(arg_35_0) <= var_33_1.signCount
	end

	ipairs = var_5

	for iter_33_2, iter_33_3 in var_5(var_33_2) do
		if iter_33_3:getTaskStatus() == 1 and var_33_6(iter_33_3) then
			return true
		end
	end
