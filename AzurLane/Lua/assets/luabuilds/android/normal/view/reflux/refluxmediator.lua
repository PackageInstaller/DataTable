...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.REFLUX_SIGN_DONE then
		if arg_8_0:isCanUpdateView(arg_8_0.viewComponent.signView) then
			...
			var_8_5(var_8_4, var_6.ON_ACHIEVE, var_8_2.awards)
		end
	...
	if var_8_0 == var_8_5.SUBMIT_TASK_DONE then
		if arg_8_0:isCanUpdateView(arg_8_0.viewComponent.taskView) and #var_8_2 > 0 then
			local var_8_7 = arg_8_0.viewComponent.taskView

			var_8_8 = var_8_8.calcLastSubmitTaskPT(var_8_7)
			table = var_8_7

			var_8_7.insert(var_8_2, var_8_8)
	...
	if var_8_0 ~= var_8_8.TASK_UPDATED then
		TaskProxy = var_4

		if var_8_0 ~= var_4.TASK_REMOVED then
			TaskProxy = var_4

			if var_8_0 == var_4.TASK_DELETE then
				...
				if var_8_0 == var_4.REFLUX_GET_PT_AWARD_DONE then
					if arg_8_0:isCanUpdateView(arg_8_0.viewComponent.ptView) then
						...
						var_8_16(var_8_15, var_6.ON_ACHIEVE, var_8_2.awards)
					...
					if var_8_0 == var_8_16.SHOPPING_DONE then
						if arg_8_0:isCanUpdateView(arg_8_0.viewComponent.shopView) then
							...
							var_8_20(var_8_19, var_6.ON_ACHIEVE, var_8_2.awards)
						...
						if var_8_0 == var_8_20.CHARGE_CONFIRM_FAILED then
							-- block empty
						else
							GAME = var_4

							if var_8_0 == var_4.CHARGED_LIST_UPDATED then
								if arg_8_0:isCanUpdateView(arg_8_0.viewComponent.shopView) then
								...
								if var_8_0 == var_4.ZERO_HOUR_OP_DONE then
