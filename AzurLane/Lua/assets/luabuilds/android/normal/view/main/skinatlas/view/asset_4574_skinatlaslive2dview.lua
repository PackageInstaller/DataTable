	...
	if arg_7_0.live2dChar then
		...
		if var_7_1 == var_1_10003.STATE_INITED then
			...
			if var_3.GetTouchPart(var_7_2) > 0 then
				...
				local var_7_4 = arg_7_0.GetTouchEvent(var_7_3, var_3)

				math = var_7_3

				local var_7_5 = var_7_3.ceil

				math = var_1_10006
				var_7_0 = var_7_4[var_7_5(var_1_10006.random(#var_7_4))]
			else
				local var_7_6 = arg_7_0
				local var_7_7 = arg_7_0.GetTouchEvent(var_7_6)

				math = var_7_6

				local var_7_8 = var_7_6.floor

				math = var_1_10006
				var_7_0 = var_7_7[var_7_8(var_1_10006.Random(0, #var_7_7)) + 1]
			end
		end
	end
...
function var_0_0.GetTouchEvent(arg_8_0, arg_8_1)
	...
	return (var_8_0(var_8_1, var_4.getSkinId(var_8_2), 0))
end
...
function var_0_0.TriggerEvent(arg_10_0, arg_10_1)
	...
	local var_10_2, var_10_3, var_10_4, var_10_5, var_10_6, var_10_7 = var_4.GetCvDataForShip(arg_10_0.ship, var_10_0.dialog)

	if not var_10_7 then
		local var_10_8 = arg_10_0.live2dChar

		var_10.TriggerAction(var_10_8, var_10_0.action)
		var_10_1()
	else
		local var_10_9 = arg_10_0.live2dChar

		var_10.TriggerAction(var_10_9, var_10_0.action, nil, nil, var_10_1)
	end
