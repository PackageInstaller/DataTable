...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SEND_FRIEND_MSG, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.FRIEND_SEND_MSG, {
			playerId = arg_2_1,
			msg = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.FETCH_FRIEND_MSG, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.FRIEND_FETCH_MSG, arg_3_1)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.FRIEND_NEW_MSG then
		...
		var_8_4(var_8_3, var_6.getAllCacheMsg(var_8_5))
		...
		if var_8_0 == var_8_4.FRIEND_UPDATED then
