...
function var_0_1.init(arg_2_0)
	...
	local var_2_19 = var_2.Find(var_2_18, "adapt/right/functionsAndTags/tags")
	local var_2_20 = arg_2_0._tf

	arg_2_0.tagList = var_2_17(var_2_19, var_3.Find(var_2_20, "adapt/right/functionsAndTags/tags/tag"))
	...
	local var_2_29 = var_2.Find(var_2_28, "bgs/empty/Text")

	i18n = var_2_28

	var_1(var_2_29, var_2_28("shop_new_unfound"))

	setText = var_1

	local var_2_30 = arg_2_0._tf
	local var_2_31 = var_2.Find(var_2_30, "adapt/top/title/Text")

	i18n = var_2_30

	var_1(var_2_31, var_2_30("shop_new_shop"))

	setText = var_1

	local var_2_32 = arg_2_0.equipBtn
	local var_2_33 = var_2.Find(var_2_32, "Text")

	i18n = var_2_32

	var_1(var_2_33, var_2_32("shop_new_wear"))
	...
	arg_2_0.changeSkinToggle = var_2_34(var_2.Find(var_2_35, "toggle_ui"))
	arg_2_0.downloads = {}
...
function var_0_1.didEnter(arg_3_0)
	...
	var_3_6(var_3_8, var_3_9, var_3_10, var_1_10006)

	PlayerPrefs = var_3_6

	local var_3_11 = var_3_6.GetInt("LatestSkinShopLayerSdTg" .. var_3_7, 0)

	triggerToggle = var_3

	var_3(arg_3_0.sdTg, var_3_11 == 1)
	...
	var_3(var_3_12, var_3_13, var_3_14, var_1_10007)
	...
	local function var_3_17(arg_8_0)
		...
		var_2_10001(var_2.Find(var_8_0, "adapt/top"), not arg_8_0)
	...
	var_3(var_3_15, var_3_16, var_3_17, var_1_10007)
	...
	local function var_3_20()
		...
		if var_0.CantUse(var_9_0) then
			...
			var_9_2(var_9_1, var_2_10002("without_ship_to_wear"))
	...
	var_3(var_3_18, var_3_19, var_3_20, var_1_10007)
	...
	local function var_3_23()
		...
		if var_2_10000.IsChangeSkin(arg_3_0.skinId) then
			...
			ShipSkin = var_1
			var_10_0.changeSkinId = var_1.GetChangeSkinNextId(arg_3_0.skinId)
	...
	var_3(var_3_21, var_3_22, var_3_23, var_1_10007)
...
function var_0_1.SetResource(arg_11_0)
	...
	var_11_0(var_3.Find(var_11_2, "gem/Text"), var_11_1:getTotalGem())

	onButton = var_11_0

	local var_11_3 = arg_11_0
	local var_11_4 = arg_11_0.resources
	local var_11_5 = var_4.Find(var_11_4, "gem")
	...
	var_11_0(var_11_3, var_11_5, var_11_6, var_6)
...
function var_0_1.UpdateMainView(arg_13_0)
	...
	var_2(arg_13_0.changeSkin, var_13_0)
...
function var_0_1.FlushChangeSkin(arg_14_0)
	...
	var_2(var_14_2, not var_4.IsAsmrSkin(var_14_3))
...
function var_0_1.FlushName(arg_15_0)
	...
	var_2(var_15_1, var_1_10004(var_15_0.name, true))

	local var_15_2 = var_15_0.skin_type

	ShipSkin = var_15_1

	if var_15_2 == var_15_1.SKIN_TYPE_TB then
		...
		local var_15_4 = var_4.GetShipNameBySecId

		NewEducateHelper = var_5

		var_15_2(var_15_3, var_15_4(var_5.GetSecIdBySkinId(arg_15_0.skinId)))
	else
		ShipGroup = var_15_2
...
function var_0_1.FlushChar(arg_17_0, arg_17_1, arg_17_2)
	...
	var_3.GetSpineChar(var_17_0, arg_17_1, true, function(arg_18_0)
		...
		if arg_17_0.prefabName ~= arg_17_1 then
			PoolMgr = var_1
			var_18_0 = var_1.GetInstance()

			var_1.ReturnSpineChar(var_18_0, arg_17_1, arg_18_0)
		...
		tf = var_18_0
		var_18_1.spineChar = var_18_0(arg_18_0)
		pg = var_18_1

		if var_18_1.skinshop_spine_scale[arg_17_2] then
			local var_18_2 = arg_17_0.spineChar

			Vector3 = var_3
			var_18_2.localScale = var_3(var_1.skinshop_scale, var_1.skinshop_scale, 1)
		else
			local var_18_3 = arg_17_0.spineChar

			Vector3 = var_3
			var_18_3.localScale = var_3(0.9, 0.9, 1)
		end

		local var_18_4 = arg_17_0.spineChar

		Vector3 = var_3
		var_18_4.localPosition = var_3(0, 0, 0)
		pg = var_18_4

		local var_18_5 = var_18_4.ViewUtils.SetLayer
		local var_18_6 = arg_17_0.spineChar

		Layer = var_4

		var_18_5(var_18_6, var_4.UI)

		setParent = var_18_5

		var_18_5(arg_17_0.spineChar, arg_17_0.charTf)

		local var_18_7 = arg_18_0:GetComponent("SpineAnimUI")

		var_2.SetAction(var_18_7, "normal", 0)
...
function var_0_1.FlushPaintingToggle(arg_19_0)
	...
	local var_19_2 = var_1_10001(var_19_0 .. var_3.getConfig(var_19_1, "painting") .. "_n")
	...
	if var_19_4 then
		...
		local var_19_5 = var_19_3.GetInt
		local var_19_6 = "skinShop#l2dPreViewToggle"

		getProxy = var_19_8
		PlayerProxy = var_1_10006
		var_1_10006 = var_19_8(var_1_10006)

		if var_19_5(var_19_6 .. var_19_8.getRawData(var_1_10006).id, 0) == 1 then
	...
	if var_19_4 then
		...
		var_19_8 = arg_19_0.shipSkin

		if var_4.IsSpine(var_19_8) then
			var_19_7 = 6
		else
			var_19_8 = arg_19_0.shipSkin

			if var_4.IsLive2d(var_19_8) then
				var_19_7 = 1
			else
				var_19_8 = arg_19_0.shipSkin

				if var_4.IsSpinePlus(var_19_8) then
					var_19_7 = 7
				else
					var_19_8 = arg_19_0.shipSkin

					if var_4.IsLive2dPlus(var_19_8) then
						var_19_7 = 9
					end
				end
			end
		...
		var_4(var_19_8, var_1_10006 .. var_1_10007.Tag2Name(var_19_7) .. "_off", arg_19_0.dynamicToggle)

		LoadImageSpriteAtlasAsync = var_4
		var_19_8 = "SkinIcon"
		var_1_10006 = "type_"
		ShipSkin = var_1_10007
		var_1_10006 = var_1_10006 .. var_1_10007.Tag2Name(var_19_7)

		local var_19_9 = arg_19_0.dynamicToggle

		var_4(var_19_8, var_1_10006, var_1_10007.Find(var_19_9, "select"))
	end

	if arg_19_0.isToggleDynamic and not var_19_4 then
		triggerToggle = var_19_11

		var_19_11(arg_19_0.dynamicToggle, false)
	...
	if arg_19_0.isToggleDynamic then
		local var_19_10 = arg_19_0.dynamicToggle
		local var_19_11 = var_19_11.GetComponent

		typeof = var_19_8
		Toggle = var_1_10006

		if not var_19_11(var_19_10, var_19_8(var_1_10006)).isOn then
			local var_19_12 = arg_19_0.shipSkin

			if not var_19_11.IsLive2d(var_19_12) then
				var_19_12 = arg_19_0.shipSkin

				if var_19_11.IsLive2dPlus(var_19_12) then
					Live2dConst = var_19_11

					if var_19_11.GetLive2DArm32MatchAble() then
						arg_19_0.isToggleDynamic = false
						getProxy = var_19_11
						PlayerProxy = var_19_12

						local var_19_13 = var_19_11(var_19_12)

						var_19_11 = var_19_11.getRawData(var_19_13).id
						PlayerPrefs = var_19_13

						var_19_13.SetInt("skinShop#l2dPreViewToggle" .. var_19_11, 0)
				...
				var_19_11(arg_19_0.dynamicToggle, true)
				...
				if var_19_2 then
					...
					local var_19_15 = arg_19_0.showBgToggle

					local function var_19_16(arg_20_0)
					...
					var_19_11(var_19_14, var_19_15, var_19_16, var_1_10007)
				end

				local var_19_17 = arg_19_0.shipSkin

				if not var_3.IsSpine(var_19_17) then
					local var_19_18 = arg_19_0.shipSkin

					if not var_3.IsLive2d(var_19_18) then
						local var_19_19 = arg_19_0.shipSkin

						if not var_3.IsSpinePlus(var_19_19) then
							local var_19_20 = arg_19_0.shipSkin

							if var_3.IsLive2dPlus(var_19_20) then
								onToggle = var_3

								local var_19_21 = arg_19_0
								local var_19_22 = arg_19_0.dynamicToggle

								local function var_19_23(arg_21_0)
									if arg_21_0 then
								...
								var_3(var_19_21, var_19_22, var_19_23, var_1_10007)
							end
...
function var_0_1.FlushPainting(arg_22_0)
	...
	local var_22_1 = arg_22_0.GetPaintingState(var_22_0)

	pg = var_22_0

	local var_22_2 = var_22_0.ship_skin_template[arg_22_0.skinId].painting

	ShipSkin = var_3

	local var_22_3 = var_3.GetChangeSkinData(arg_22_0.skinId) and true or false

	if var_22_1 == var_0_3 and not arg_22_0:ExistL2dRes(var_22_2) or var_22_1 == var_0_4 and not arg_22_0:ExistSpineRes(var_22_2) then
		var_22_1 = var_0_2
	end

	if arg_22_0.paintingState and arg_22_0.paintingState.state == var_22_1 and arg_22_0.paintingState.id == arg_22_0.skinId and arg_22_0.paintingState.showBg == arg_22_0.isToggleShowBg and not var_22_3 then
		return
	end

	arg_22_0:ClearPainting()

	if var_22_1 == var_0_2 then
		arg_22_0:LoadMeshPainting(arg_22_0.isToggleShowBg)
	elseif var_22_1 == var_0_3 then
		arg_22_0:LoadL2dPainting()
	elseif var_22_1 == var_0_4 then
...
function var_0_1.FlushBG(arg_26_0, arg_26_1)
	...
	if var_26_3 == var_1_10006.SKIN_TYPE_TB then
		...
		var_26_2 = var_26_3(var_6.GetSecIdBySkinId(var_26_0))
	else
		ShipGroup = var_26_3
	...
	local var_26_5 = var_26_2
	local var_26_6 = var_26_2.getShipBgPrint(var_26_5, true)

	pg = var_26_5

	local var_26_7 = var_26_5.ship_skin_template[var_26_0].painting

	if not arg_26_0.isToggleShowBg then
		checkABExist = var_7

		if not var_7("painting/" .. var_26_7 .. "_n") then
			if var_26_1.bg_sp ~= "" then
				var_26_6 = var_26_1.bg_sp
			end
		end

		local var_26_8 = var_26_2

		if var_26_6 ~= var_26_2.rarity2bgPrintForGet(var_26_8) then
			pg = var_26_8

			local var_26_9 = var_26_8.DynamicBgMgr.GetInstance()

			var_26_8 = var_26_8.LoadBg

			local var_26_10 = arg_26_0
			local var_26_11 = var_26_6
			local var_26_12 = arg_26_0.bgs
			local var_26_13 = var_12.Find(var_26_12, "diffBg")
			local var_26_14 = arg_26_0.bgs

			var_26_8(var_26_9, var_26_10, var_26_11, var_26_13, var_13.Find(var_26_14, "diffBg/bg"), function(arg_27_0)
				if arg_26_1 then
					arg_26_1()
				end
			...
			local var_26_15 = var_26_8.DynamicBgMgr.GetInstance()

			var_26_8.ClearBg(var_26_15, arg_26_0:getUIName())
		...
		var_26_8(var_9.Find(var_26_16, "diffBg"), var_7)

		setActive = var_26_8

		local var_26_17 = arg_26_0.bgs

		var_26_8(var_9.Find(var_26_17, "default"), not var_7)
...
function var_0_1.FlushDynamicPaintingResState(arg_29_0)
	...
	if not var_29_1 and var_29_2 ~= "" then
		...
		var_29_4(var_29_7, var_29_8, var_29_9, var_1_10009)
	end
...
function var_0_1.RecordFlag(arg_33_0, arg_33_1)
	...
	PlayerPrefs = var_33_0

	var_33_0.SetInt("skinShop#l2dPreViewToggle" .. var_33_1, arg_33_1 and 1 or 0)
	...
	var_33_3(var_33_2, var_5.ON_RECORD_ANIM_PREVIEW_BTN, arg_33_1)
...
function var_0_1.LoadMeshPainting(arg_34_0, arg_34_1)
	...
	local var_34_1 = var_3(var_34_0, "PaintingScaler")
	...
	if not arg_34_1 then
		...
		if var_1_10006("painting/" .. var_34_3 .. "_n") then
	...
	if not var_1_10006("painting/" .. var_34_3) then
		return
	end
	...
	var_6.GetPainting(var_34_5, var_34_3, true, function(arg_35_0)
		...
		var_35_1(var_2.GetChild(var_35_2, 0), var_34_2)
...
function var_0_1.ClearMeshPainting(arg_36_0)
	...
	if arg_36_0.paintingName and var_36_1.childCount > 0 then
		local var_36_2 = var_36_1
		local var_36_3 = var_36_1.GetChild(var_36_2, 0).gameObject

		PoolMgr = var_36_2

		local var_36_4 = var_36_2.GetInstance()
...
function var_0_1.LoadL2dPainting(arg_37_0)
	...
	if var_37_1 == var_1_10004.SKIN_TYPE_TB then
		...
		var_37_2 = var_37_3(var_1_10005.GetSecIdBySkinId(var_37_0))
	else
		pg = var_37_3
		var_37_3 = var_37_3.ship_skin_template[var_37_0].ship_group
		ShipGroup = var_1_10005

		local var_37_4 = var_1_10005.getDefaultShipConfig(var_37_3)
	...
	local var_37_5 = var_37_3.GenerateData
	local var_37_6 = {
		ship = var_37_2
	}

	Vector3 = var_1_10006
	var_37_6.position = var_1_10006(0, 0, -1)
	var_37_6.parent = arg_37_0.live2dContainer
	var_37_6.offset = var_37_2:GetSkinConfig().shop_offset

	local var_37_7 = var_37_5(var_37_6)

	pg = var_37_6

	local var_37_8 = var_37_6.UIMgr.GetInstance()

	var_5.LoadingOn(var_37_8)

	Live2DPainting = var_5
	arg_37_0.live2dChar = var_5.New(var_37_7, function(arg_38_0)
		...
		var_38_2(var_38_1, var_3.L2D_DEFAULT_LAYER)
...
function var_0_1.LoadSpinePainting(arg_40_0)
	...
	if var_40_1 == var_1_10004.SKIN_TYPE_TB then
		...
		NewEducateHelper = var_1_10005
		var_40_2 = var_40_3(var_1_10005.GetSecIdBySkinId(var_40_0))
	else
		pg = var_40_3
		var_40_3 = var_40_3.ship_skin_template[var_40_0].ship_group
		ShipGroup = var_1_10005

		local var_40_4 = var_1_10005.getDefaultShipConfig(var_40_3)
	...
	local var_40_5 = var_40_3.GenerateData
	local var_40_6 = {
		ship = var_40_2
	}

	Vector3 = var_1_10006
	var_40_6.position = var_1_10006(0, 0, 0)
	var_40_6.parent = arg_40_0.spTF
	var_40_6.effectParent = arg_40_0.spBg
	var_40_6.offset = var_40_2:GetSkinConfig().shop_offset

	local var_40_7 = var_40_5(var_40_6)

	pg = var_40_6

	local var_40_8 = var_40_6.UIMgr.GetInstance()

	var_5.LoadingOn(var_40_8)

	SpinePainting = var_5
	arg_40_0.spinePainting = var_5.New(var_40_7, function(arg_41_0)
...
function var_0_1.InitSpecialTouch(arg_43_0, arg_43_1, arg_43_2)
	...
	if not var_43_0(arg_43_2:GetChild(0), "hitArea") then
		return
	end

	eachChild = var_5

	var_5(var_4, function(arg_44_0)
		local var_44_0 = arg_43_0
		local var_44_1

		if var_1.getDragTouchAble(var_44_0, arg_44_0.name, var_43_1, false) then
			var_44_1 = arg_43_0
			GetOrAddComponent = var_44_0

			local var_44_2 = arg_44_0

			typeof = var_4
			EventTriggerListener = var_5
			var_44_1.dragEvent = var_44_0(var_44_2, var_4(var_5))
...
function var_0_1.FlushTag(arg_52_0)
	...
	local var_52_7 = var_5(var_52_5 .. var_7.getConfig(var_52_6, "painting") .. "_n")
	...
	var_6.make(var_52_8, function(arg_53_0, arg_53_1, arg_53_2)
		...
		if arg_53_0 == var_2_10003.EventUpdate then
			...
			var_4(var_53_1, var_53_2 .. var_2_10007.Tag2Name(var_52_2[arg_53_1 + 1]), function(arg_54_0)
				...
				typeof = var_3_10003
				Image = var_3_10004
				var_54_1(var_54_0, var_3_10003(var_3_10004)).sprite = arg_54_0
