...
function var_0_1.OnInit(arg_2_0)
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0._itemText = var_2_18(var_2_17, var_3(var_2_7))
	...
	function arg_2_0.rewardList.onUpdateItem(arg_5_0, arg_5_1)
		...
		local var_5_1 = var_2_10004(arg_5_1)

		var_2_10003(var_4.Find(var_5_1, "IconTpl"), var_5_0)
		...
		var_5_2(var_5_4, var_6(var_2_10007(var_5_3), 4))
	...
	function arg_2_0.lsrMailList.onUpdateItem(arg_6_0, arg_6_1)
		...
		local var_6_1 = var_2_10004(arg_6_1)
		local var_6_2 = var_4.Find(var_6_1, "Text")

		shortenString = var_6_1
		HXSet = var_6

		var_2_10003(var_6_2, var_6_1(var_6.hxLan(var_6_0.title), 10))
	...
	local function var_2_32()
		...
		var_7_1(var_7_0, var_2_10002.ON_GET_MAIL_TITLE, arg_2_0.mailids, function(arg_8_0)
			...
			var_3_10001(var_8_0, var_3("mail_getbox_title"))
	...
	var_1(var_2_34, var_2_33("mail_box_cancel"))
	...
	var_1(var_2_36, var_2_35("mail_box_confirm"))
	...
	var_1(var_2_37, var_3("mail_boxtitle_information"))
...
function var_0_1.showItemBox(arg_11_0, arg_11_1)
	...
	local var_11_3 = var_3.Find(var_11_2, "Text")

	i18n = var_11_2

	var_11_0(var_11_3, var_11_2("mail_take_maildetail_msgbox"))
...
function var_0_1.Show(arg_13_0, arg_13_1)
	...
	var_13_2[var_1_10005.MailMessageBoxType.ReceiveAward] = function()
	...
	MailProxy = var_5
	var_13_2[var_5.MailMessageBoxType.ShowTips] = function()
	...
	var_2(var_13_3, var_13_4, var_13_5, var_6)
	...
	var_2(var_13_6, var_13_7, var_13_8, var_6)
