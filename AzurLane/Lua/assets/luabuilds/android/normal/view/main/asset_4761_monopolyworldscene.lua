...
function var_0_1.init(arg_2_0)
	...
	arg_2_0.activity = var_2_1(var_2_0, var_1_10003.ACTIVITY_TYPE_MONOPOLY)
	...
	var_2_3(var_2_2, var_3.ON_START, function(arg_3_0, arg_3_1, arg_3_2)
		pg = var_2_10003
	...
	var_2_5(var_2_4, var_3.ON_MOVE, function(arg_4_0, arg_4_1, arg_4_2)
		pg = var_2_10003
	...
	var_2_7(var_2_6, var_3.ON_TRIGGER, function(arg_5_0, arg_5_1, arg_5_2)
		pg = var_2_10003
	...
	var_2_9(var_2_8, var_3.ON_AWARD, function(arg_6_0)
		pg = var_2_10001
		...
		local var_6_2 = var_2_10003.MONOPOLY_OP
		local var_6_3 = {
			activity_id = arg_2_0.activity.id
		}

		ActivityConst = var_5
		var_6_3.cmd = var_5.MONOPOLY_OP_AWARD
	...
	findTF = var_3
	arg_2_0.gameUI = var_2_10(var_2_11, var_3(arg_2_0._tf, "AD"), arg_2_0.event)
