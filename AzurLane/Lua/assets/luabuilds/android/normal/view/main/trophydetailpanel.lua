...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0._timeStamp = var_1_1(var_1_0, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0._desc = var_1_3(var_1_2, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0._rank = var_1_5(var_1_4, var_5(var_1_10006))
	findTF = var_3
	...
	var_3(var_1_9, var_5("world_collection_back"))
...
function var_0_0.UpdateTrophy(arg_6_0, arg_6_1)
	...
	local function var_6_2(arg_7_0, arg_7_1)
		...
		var_2_10002(var_2_10003(arg_7_0, "desc"), arg_7_1:getConfig("condition"))
		...
		if var_7_3 == var_7_2.INTAMACT_TYPE then
			setText = var_7_3
			findTF = var_7_4
			var_7_4 = var_7_4(arg_7_0, "progress")

			local var_7_5 = arg_7_1
			local var_7_6

			if arg_7_1.isDummy(var_7_5) then
				var_7_6 = ""
			else
				var_7_6 = "["
				math = var_7_5

				local var_7_7 = var_7_5.modf(var_7_0 / 100)
				local var_7_8 = "/"

				math = var_2_10009
				var_7_6 = var_7_6 .. var_7_7 .. var_7_8 .. var_2_10009.modf(var_7_1 / 100) .. "]"
			end
			...
			var_7_3(var_7_4(arg_7_0, "progress"), arg_7_1:isDummy() and "" or "[" .. var_7_0 .. "/" .. var_7_1 .. "]")
		end
	...
	if not arg_6_1:isComplexTrophy() then
		...
		for iter_6_0, iter_6_1 in var_6_3(arg_6_1.getSubTrophy(var_6_4)) do
			cloneTplTo = var_1_10008
			var_1_10008 = var_1_10008(arg_6_0._conditionTpl, arg_6_0._conditionList)

			var_6_2(var_1_10008, iter_6_1)
		end
	end
	...
	typeof = var_6_4
	Image = iter_6_0
	var_6_6(var_6_5, var_6_4(iter_6_0)).fillAmount = arg_6_1:getProgressRate()
...
function var_0_0.updateStepper(arg_8_0, arg_8_1)
	...
	var_8_2(arg_8_0._pageText, var_8_1 .. "/" .. var_8_3)
