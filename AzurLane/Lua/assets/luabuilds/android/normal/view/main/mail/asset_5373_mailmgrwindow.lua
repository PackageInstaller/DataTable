...
function var_0_1.OnInit(arg_2_0)
	...
	local function var_2_11()
		...
		local var_5_2 = var_2_10002.ON_OPERATION
		local var_5_3 = {
			cmd = "read"
		}
		local var_5_4 = arg_2_0

		var_5_3.filter = var_4.GetFilterData(var_5_4)
	...
	local function var_2_15()
		...
		local var_6_2 = var_2_10002.ON_OPERATION
		local var_6_3 = {
			cmd = "attachment"
		}
		local var_6_4 = arg_2_0

		var_6_3.filter = var_4.GetFilterData(var_6_4)
	...
	local function var_2_19()
		...
		var_2_10000({
			function(arg_8_0)
				...
				local var_8_2 = var_3_10003.MAIL_DOUBLE_CONFIREMATION_MSGBOX
				local var_8_3 = {}

				MailProxy = var_3_10005
				var_8_3.type = var_3_10005.MailMessageBoxType.ShowTips
				i18n = var_5
				var_8_3.content = var_5("main_mailLayer_quest_clear_choice")
			...
			local var_9_2 = var_3_10002.ON_OPERATION
			local var_9_3 = {
				cmd = "delete"
			}
			local var_9_4 = arg_2_0

			var_9_3.filter = var_4.GetFilterData(var_9_4)
	...
	var_2_22[1] = var_1_10006.ResGold
	PlayerConst = var_6
	var_2_22[2] = var_6.ResOil
	PlayerConst = var_6
	var_2_22[3] = var_6.ResExploit
	PlayerConst = var_6
	var_2_22[4] = var_6.ResDiamond
	...
	for iter_2_0, iter_2_1 in var_2_17(var_2_21) do
		ipairs = var_1_10007

		for iter_2_2, iter_2_3 in var_1_10007(iter_2_1) do
			table = var_1_10012
			...
			var_1_10012(var_2_24, var_1_10014.New({
				type = iter_2_0,
				id = iter_2_3
			}))
		end
	...
	if var_2 then
		...
		local var_2_27 = var_4.New
		local var_2_28 = {
			id = 50002
		}

		DROP_TYPE_ITEM = iter_2_1
		var_2_28.type = iter_2_1
	...
	var_2_30(var_2_31, var_4.Find(var_2_32, "toggle_tpl"), #var_2_20, function(arg_10_0, arg_10_1, arg_10_2)
		arg_10_1 = arg_10_1 + 1
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			local var_10_1 = var_10_0:getIcon()
			local var_10_2 = ""
			local var_10_3 = arg_10_2

			var_2_10004(var_10_1, var_10_2, arg_10_2.Find(var_10_3, "Image"))
			...
			local function var_10_6(arg_11_0)
				...
				if arg_11_0 then
					...
					var_11_0(var_2.Find(var_11_1, "window/frame/toggle_group/filter"), true)
				end
			...
			var_2_10004(var_10_4, var_10_5, var_10_6, var_10_3)
		end
	...
	var_2_30(var_3.Find(var_2_33, "window/frame/toggle_group"), function(arg_12_0)
	...
	local var_2_35 = var_3.Find(var_2_34, "window/top/bg/infomation/title")

	i18n = var_2_34

	var_2_30(var_2_35, var_2_34("mail_manager_title"))

	setText = var_2_30

	local var_2_36 = arg_2_0._tf
	local var_2_37 = var_3.Find(var_2_36, "window/frame/tip/Text")

	i18n = var_2_36

	var_2_30(var_2_37, var_2_36("mail_manage_tip_1"))

	setText = var_2_30

	local var_2_38 = arg_2_0._tf
	local var_2_39 = var_3.Find(var_2_38, "window/frame/tip_1/Text")

	i18n = var_2_38

	var_2_30(var_2_39, var_2_38("mail_manager_tips_2"))

	setText = var_2_30

	local var_2_40 = arg_2_0._tf
	local var_2_41 = var_3.Find(var_2_40, "window/frame/toggle_group/all/Text")

	i18n = var_2_40

	var_2_30(var_2_41, var_2_40("mail_manage_1"))

	setText = var_2_30

	local var_2_42 = arg_2_0._tf
	local var_2_43 = var_3.Find(var_2_42, "window/frame/toggle_group/filter/Text")

	i18n = var_2_42

	var_2_30(var_2_43, var_2_42("mail_manage_2"))

	setText = var_2_30

	local var_2_44 = arg_2_0.attachBtn
	local var_2_45 = var_3.Find(var_2_44, "Text")

	i18n = var_2_44

	var_2_30(var_2_45, var_2_44("mail_get_oneclick"))

	setText = var_2_30

	local var_2_46 = arg_2_0.readBtn
	local var_2_47 = var_3.Find(var_2_46, "Text")

	i18n = var_2_46

	var_2_30(var_2_47, var_2_46("mail_read_oneclick"))

	setText = var_2_30

	local var_2_48 = arg_2_0.deleteBtn
	local var_2_49 = var_3.Find(var_2_48, "Text")

	i18n = var_2_48

	var_2_30(var_2_49, var_2_48("mail_delete_oneclick"))
		...
		filter = function()
			...
			for iter_17_0, iter_17_1 in var_2_10001(arg_15_0.filterDic) do
				if iter_17_1 then
					unpack = var_2_10006
					string = var_2_10007
					var_2_10006, var_2_10007 = var_2_10006(var_2_10007.split(iter_17_0, "_"))
					table = var_8

					local var_17_1 = var_8.insert
					...
					var_17_3.type = var_2_10012(var_2_10006)
					tonumber = var_2_10012
					var_17_3.id = var_2_10012(var_2_10007)

					var_17_1(var_17_2, var_2_10010(var_17_3))
				end
			end
...
function var_0_1.Show(arg_19_0, arg_19_1)
	...
	var_2(var_3.Find(var_19_1, "window/frame/toggle_group/all"), true)
