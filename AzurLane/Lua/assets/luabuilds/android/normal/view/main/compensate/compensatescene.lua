...
function var_0_1.init(arg_4_0)
	...
	CompensateProxy = var_1_10002
	arg_4_0.proxy = var_1_10001(var_1_10002)
	...
	local var_4_2 = var_2.Find(var_4_1, "top/title")

	i18n = var_4_1

	var_1(var_4_2, var_4_1("compensate_ui_title1"))

	setText = var_1

	local var_4_3 = arg_4_0.rtAdapt
	local var_4_4 = var_2.Find(var_4_3, "top/title/Text")

	i18n = var_4_3

	var_1(var_4_4, var_4_3("compensate_ui_title2"))

	onButton = var_1

	local var_4_5 = arg_4_0
	local var_4_6 = arg_4_0.rtAdapt
	local var_4_7 = var_3.Find(var_4_6, "top/back_btn")
	...
	var_1(arg_4_0.rtLabels, function(arg_6_0)
		...
		local var_6_3 = arg_6_0.Find(var_6_2, "unSelect/Text")

		toggleName = var_6_2

		var_6_1(var_6_3, var_6_2)

		setText = var_6_1

		local var_6_4 = arg_6_0
		local var_6_5 = arg_6_0.Find(var_6_4, "selected/Text")
		...
		var_6_1(var_6_6, var_6_7, var_6_8, var_2_10006)
	...
	function arg_4_0.lsrMailList.onUpdateItem(arg_8_0, arg_8_1)
		...
		var_2_10004(var_8_2, var_8_3, var_8_4, var_2_10008)
	...
	local function var_4_17()
		...
		CompensateMediator = var_2_10002

		var_10_1(var_10_0, var_2_10002.ON_GET_REWARD, {
	...
	var_2(var_4_15, var_4_16, var_4_17, var_1_10006)

	arg_4_0.rtMailEmpty = var_1:Find("empty")
	setText = var_2

	local var_4_18 = arg_4_0.rtBtnRightGet
	local var_4_19 = var_3.Find(var_4_18, "Text")

	i18n = var_4_18

	var_2(var_4_19, var_4_18("mail_getone_button"))
	arg_4_0:InitResBar()
...
function var_0_1.didEnter(arg_12_0)
	...
	var_1_10001(function()
		...
		var_13_0(var_1.Find(var_13_1, "mail"), true)
...
function var_0_1.UpdateMailList(arg_14_0)
	...
	if #arg_14_0.filterMails == 0 then
		...
		local var_14_3 = arg_14_0.rtMailEmpty
		local var_14_4 = var_2.Find(var_14_3, "Text")

		i18n = var_14_3

		var_1(var_14_4, var_14_3("compensate_ui_nothing1"))

		setText = var_1

		local var_14_5 = arg_14_0.rtMailEmpty
		local var_14_6 = var_2.Find(var_14_5, "Text_en")

		i18n = var_14_5

		var_1(var_14_6, var_14_5("compensate_ui_nothing2"))
	else
		setActive = var_1
		...
		local var_14_7 = arg_14_0.lsrMailList
		local var_14_8 = var_1.SetTotalCount
		local var_14_9 = #arg_14_0.filterMails

		delta = var_14_10

		local var_14_10 = var_14_10 or -1

		var_14_8(var_14_7, var_14_9, var_14_10)
	end
...
function var_0_1.UpdateMailTpl(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = arg_17_1.Find(var_17_0, "content")

	setActive = var_17_0

	var_17_0(var_17_1:Find("icon/no_attachment"), #arg_17_2.attachments == 0)

	setActive = var_17_0

	var_17_0(var_17_1:Find("icon/IconTpl"), #arg_17_2.attachments > 0)

	if #arg_17_2.attachments > 0 then
		updateDrop = var_4

		var_4(var_17_1:Find("icon/IconTpl"), arg_17_2.attachments[1])
	end

	setText = var_4

	local var_17_2 = var_17_1
	local var_17_3 = var_17_1.Find(var_17_2, "info/title/Text")

	shortenString = var_17_2

	var_4(var_17_3, var_17_2(arg_17_2.title, 10))

	setText = var_4

	local var_17_4 = var_17_1
	local var_17_5 = var_17_1.Find(var_17_4, "info/time/Text")

	os = var_17_4

	var_4(var_17_5, var_17_4.date("%Y-%m-%d", arg_17_2.date))

	local var_17_6 = arg_17_2.timestamp

	pg = var_17_5

	local var_17_7 = var_17_5.TimeMgr.GetInstance()
	local var_17_8 = var_17_6 - var_5.GetServerTime(var_17_7)

	math = var_5

	local var_17_9 = var_5.floor(var_17_8 / 0)
	local var_17_11
	...
	if 1 <= var_17_9 then
		...
		var_17_11 = var_17_1.Find(var_17_10, "info/time/out_time/Text")
		i18n = var_17_10

		local var_17_12 = "compensate_ui_expiration_day"

		math = var_1_10009

		var_17_9(var_17_11, var_17_10(var_17_12, var_1_10009.floor(var_17_8 / 0)))
	else
		setText = var_17_9

		local var_17_13 = var_17_1

		var_17_11 = var_17_1.Find(var_17_13, "info/time/out_time/Text")
		i18n = var_17_13

		local var_17_14 = "compensate_ui_expiration_hour"

		math = var_1_10009

		var_17_9(var_17_11, var_17_13(var_17_14, var_1_10009.floor(var_17_8 / 16)))
	end

	local var_17_15 = arg_17_2.attachFlag

	setActive = var_17_11

	var_17_11(arg_17_1:Find("got_mark"), var_17_15)

	setText = var_17_11

	local var_17_16 = arg_17_1
	local var_17_17 = arg_17_1.Find(var_17_16, "got_mark/got_text")

	i18n = var_17_16

	var_17_11(var_17_17, var_17_16("mail_reward_got"))

	setActive = var_17_11

	var_17_11(arg_17_1:Find("hasread_bg"), true)

	setActive = var_17_11

	var_17_11(arg_17_1:Find("noread_bg"), false)

	SummerFeastScene = var_17_11

	local var_17_18 = var_17_11.TransformColor("FFFFFF")

	setTextColor = var_7

	var_7(var_17_1:Find("info/title/Text"), var_17_18)

	setTextColor = var_7

	var_7(var_17_1:Find("info/time/Text"), var_17_18)

	triggerToggle = var_7

	var_7(arg_17_1, arg_17_0.selectMailId == arg_17_2.id)
...
function var_0_1.UpdateMailContent(arg_18_0, arg_18_1)
	...
	var_1_10002(arg_18_0.rtMailRight, function(arg_19_0)
		...
		var_2_10001(var_19_0, var_2_10003(arg_18_1))
	...
	local var_18_1 = var_3.Find(var_18_0, "main/title/info/Text")

	i18n2 = var_18_0

	var_2(var_18_1, var_18_0(arg_18_1.title))

	setText = var_2

	local var_18_2 = arg_18_0.rtMailRight

	var_2(var_3.Find(var_18_2, "main/from/Text"), arg_18_1.sender)

	setText = var_2

	local var_18_3 = arg_18_0.rtMailRight
	local var_18_4 = var_3.Find(var_18_3, "main/time/Text")

	os = var_18_3

	var_2(var_18_4, var_18_3.date("%Y-%m-%d", arg_18_1.date))

	setText = var_2

	local var_18_5 = arg_18_0.rtMailRight

	var_2(var_3.Find(var_18_5, "main/view/content/text/Text"), arg_18_1.text)
	...
	local var_18_8 = var_18_7
	local var_18_9 = var_18_7.Find(var_18_8, "got/Text")

	i18n = var_18_8

	var_18_6(var_18_9, var_18_8("main_mailLayer_attachTaken"))

	setActive = var_18_6

	var_18_6(arg_18_0.rtBtnRightGet, not arg_18_1.attachFlag)

	setActive = var_18_6

	var_18_6(var_18_7, #arg_18_1.attachments > 0)
	...
	if #arg_18_1.attachments > 0 then
		...
		var_18_10.StaticAlign(var_18_11, var_18_11:Find("IconTpl"), #arg_18_1.attachments, function(arg_20_0, arg_20_1, arg_20_2)
			arg_20_1 = arg_20_1 + 1
			...
			if arg_20_0 == var_2_10003.EventUpdate then
				...
				var_2_10004(var_20_1, var_20_2, var_20_3, var_2_10008)
			end
		...
		var_5(var_18_11, var_18_12 and 0.5 or 1)

		setActive = var_5

		var_5(var_18_7:Find("got"), var_18_12)
	end
...
function var_0_1.onBackPressed(arg_22_0)
	...
	var_1_10001(var_2.Find(var_22_0, "top/back_btn"))
...
function var_0_1.UpdateOperationDeal(arg_24_0)
	...
	if arg_24_0.selectMailId then
		...
		var_24_1(var_24_0, var_1_10003.detect(arg_24_0.filterMails, function(arg_25_0)
...
function var_0_1.InitResBar(arg_26_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_26_0.goldMax = var_26_3(var_26_2, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_26_0.goldValue = var_26_6(var_26_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_26_0.oilMax = var_26_9(var_26_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_26_0.oilValue = var_26_12(var_26_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_26_0.gemValue = var_26_15(var_26_14, var_3(var_1_10004))
	onButton = var_1

	local var_26_16 = arg_26_0
	local var_26_17 = arg_26_0.resBar
	local var_26_18 = var_3.Find(var_26_17, "gold")
	...
	var_1(var_26_16, var_26_18, var_26_19, var_5)

	onButton = var_1

	local var_26_20 = arg_26_0
	local var_26_21 = arg_26_0.resBar
	local var_26_22 = var_3.Find(var_26_21, "oil")
	...
	var_1(var_26_20, var_26_22, var_26_23, var_5)

	onButton = var_1

	local var_26_24 = arg_26_0
	local var_26_25 = arg_26_0.resBar
	local var_26_26 = var_3.Find(var_26_25, "gem")
	...
	var_1(var_26_24, var_26_26, var_26_27, var_5)
	arg_26_0:UpdateRes()
...
function var_0_1.UpdateRes(arg_30_0)
	...
	var_30_0.StaticFlush(var_30_1, arg_30_0.goldMax, arg_30_0.goldValue, arg_30_0.oilMax, arg_30_0.oilValue, arg_30_0.gemValue)
