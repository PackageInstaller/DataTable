...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_6 = var_2.Find(var_2_5, "left/scrollrect/list")
	local var_2_7 = arg_2_0._tf

	arg_2_0.leftList = var_2_4(var_2_6, var_3.Find(var_2_7, "left/scrollrect/list/tpl"))
	UIItemList = var_1

	local var_2_8 = var_1.New
	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "right/scrollrect/list")
	local var_2_11 = arg_2_0._tf

	arg_2_0.rightList = var_2_8(var_2_10, var_3.Find(var_2_11, "left/scrollrect/list/tpl"))
	setText = var_1
	...
	var_1(var_2_12, var_3("skin_discount_item_tran_tip"))
...
function var_0_1.UpdateItem(arg_11_0, arg_11_1, arg_11_2)
	...
	var_4(arg_11_2, var_11_0)

	setScrollText = var_4

	var_4(arg_11_2:Find("name_bg/Text"), var_11_0:getName())
	...
	local function var_11_3()
		...
		var_12_1(var_12_0, var_2_10002.ON_DROP, var_11_0)
...
function var_0_1.OnDestroy(arg_13_0)
	...
	var_13_1(var_13_0, var_13_2, var_1_10004.UIMgr.GetInstance()._normalUIMain)
