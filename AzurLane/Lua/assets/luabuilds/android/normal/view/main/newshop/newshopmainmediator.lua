...
function var_0_1.register(arg_1_0)
	...
	arg_1_0.bind(var_1_0, var_0_1.OPEN_LAYER, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		...
		var_2_1(var_2_0, var_2_10006.New({
	...
	local var_1_7 = var_5(var_1_10006)

	var_1_6(var_1_5, var_5.getRawData(var_1_7))
	arg_1_0:bind(var_0_1.VIEW_SKIN_PROBABILITY, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_3_2, var_2_10006.PROBABILITY_SKINSHOP, {
			commodityId = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.GET_CHARGE_LIST, function(arg_4_0)
		...
		var_4_1(var_4_0, var_2_10003.GET_CHARGE_LIST)
	...
	arg_1_0:bind(var_0_1.REFRESH_STREET_SHOP, function(arg_15_0, arg_15_1)
		if not arg_15_1 then
			...
			var_15_1(var_15_0, var_2_10004.GET_SHOPSTREET)
		else
			...
			var_15_3(var_15_2, var_2_10004.SHOPPING, {
				count = 1,
				id = arg_15_1
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_SHAM_SHOPPING, function(arg_17_0, arg_17_1, arg_17_2)
		...
		var_17_1(var_17_0, var_2_10005.SHAM_SHOPPING, {
			id = arg_17_1,
			count = arg_17_2
		})
	...
	arg_1_0:bind(var_0_1.ON_FRAGMENT_SHOPPING, function(arg_18_0, arg_18_1, arg_18_2)
		...
		var_18_1(var_18_0, var_2_10005.FRAG_SHOPPING, {
			id = arg_18_1,
			count = arg_18_2
		})
	...
	arg_1_0:bind(var_0_1.ON_ACT_SHOPPING, function(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
		...
		var_19_1(var_19_0, var_2_10007.ACTIVITY_OPERATION, {
	...
	arg_1_0:bind(var_0_1.ON_ACT_OPERATION, function(arg_20_0, arg_20_1, arg_20_2)
		...
		local var_20_2 = var_2_10005.ACTIVITY_OPERATION

		setmetatable = var_2_10006

		var_20_1(var_20_0, var_20_2, var_2_10006({
	...
	arg_1_0:bind(var_0_1.SELL_BLUEPRINT, function(arg_21_0, arg_21_1)
		...
		var_21_1(var_21_0, var_2_10004.FRAG_SELL, arg_21_1)
	...
	arg_1_0:bind(var_0_1.SET_PLAYER_FLAG, function(arg_22_0, arg_22_1, arg_22_2)
		if arg_22_2 then
			...
			var_22_1(var_22_0, var_2_10005.COMMON_FLAG, {
				flagID = arg_22_1
			})
		else
			...
			var_22_3(var_22_2, var_2_10005.CANCEL_COMMON_FLAG, {
				flagID = arg_22_1
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_GUILD_SHOPPING, function(arg_23_0, arg_23_1, arg_23_2)
		...
		var_23_1(var_23_0, var_2_10005.ON_GUILD_SHOP_PURCHASE, {
			goodsId = arg_23_1,
			selectedId = arg_23_2
		})
	...
	arg_1_0:bind(var_0_1.ON_MEDAL_SHOPPING, function(arg_24_0, arg_24_1, arg_24_2)
		...
		var_24_1(var_24_0, var_2_10005.ON_MEDAL_SHOP_PURCHASE, {
			goodsId = arg_24_1,
			selectedId = arg_24_2
		})
	...
	arg_1_0:bind(var_0_1.REFRESH_GUILD_SHOP, function(arg_25_0, arg_25_1)
		if arg_25_1 then
			...
			var_25_1(var_25_0, var_2_10005.GET_GUILD_SHOP, {
				type = var_2_10002
			})
	...
	arg_1_0:bind(var_0_1.REFRESH_MEDAL_SHOP, function(arg_26_0)
		...
		var_26_1(var_26_0, var_2_10003.GET_MEDALSHOP, {})
	...
	arg_1_0:bind(var_0_1.ON_META_SHOP, function(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5)
		...
		var_27_1(var_27_0, var_2_10008.ON_META_SHOPPING, {
	...
	arg_1_0:bind(var_0_1.ON_ESKIN_PREVIEW, function(arg_28_0, arg_28_1)
		...
		if var_28_0.ship_skin_id ~= 0 then
			...
			Clone = var_2_10006
			var_28_3.weaponIds = var_2_10006(var_28_0.weapon_ids)
		...
		local var_28_6 = var_2_10007.New
		local var_28_7 = {}

		ShipPreviewLayer = var_2_10009
		var_28_7.viewComponent = var_2_10009
		ShipPreviewMediator = var_2_10009
		var_28_7.mediator = var_2_10009
	...
	arg_1_0:bind(var_0_1.ON_QUOTA_SHOPPING, function(arg_29_0, arg_29_1, arg_29_2)
		...
		var_29_1(var_29_0, var_2_10005.QUOTA_SHOPPING, {
			id = arg_29_1,
			count = arg_29_2
		})
	...
	arg_1_0:bind(var_0_1.ON_MINI_GAME_SHOP_BUY, function(arg_30_0, arg_30_1, arg_30_2)
		...
		var_30_1(var_30_0, var_2_10005.MINI_GAME_SHOP_BUY, arg_30_1)
	...
	arg_1_0:bind(var_0_1.ON_MINI_GAME_SHOP_FLUSH, function(arg_31_0, arg_31_1, arg_31_2)
		...
		var_31_1(var_31_0, var_2_10005.MINI_GAME_SHOP_FLUSH, arg_31_1)
	...
	arg_1_0:bind(var_0_1.UR_EXCHANGE_TRACKING, function(arg_32_0, arg_32_1)
		...
		local var_32_0 = var_2_10002(var_2_10003)
		local var_32_1 = var_2.getActivityByType

		ActivityConst = var_2_10004

		if var_32_1(var_32_0, var_2_10004.ACTIVITY_TYPE_UR_EXCHANGE) then
			...
			if not var_2.isEnd(var_32_2) then
				...
				if var_3.getConfig(var_32_5, "commodity_id") == arg_32_1 then
					...
					var_32_7(var_32_6, var_6.BuildUrRedeem(arg_32_1, 1))
				end
			end
		end
...
function var_0_1.OpenGiftActLayer(arg_34_0, arg_34_1)
	...
	local var_34_2 = var_34_1:getConfig("type")
	local var_34_3 = {}

	ActivityConst = var_6
	var_34_3[var_6.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
		local var_35_0 = arg_34_0.viewComponent
		local var_35_1 = var_0.emit

		NewShopMainMediator = var_2_10002

		local var_35_2 = var_2_10002.OPEN_LAYER

		ChargeActGiftLayer = var_2_10003
		ChargeActGiftMediator = var_2_10004

		var_35_1(var_35_0, var_35_2, var_2_10003, var_2_10004, {
			actId = var_34_1.id
		})
	...
	ActivityConst = var_6
	var_34_3[var_6.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
		pg = var_2_10000
		...
		local var_36_5 = var_36_3(var_36_4, var_3.TYPE_GIFT_PACKAGE_ACT)

		Drop = var_36_4

		local var_36_6 = var_36_4.New
		local var_36_7 = {
			count = 1
		}

		DROP_TYPE_ITEM = var_2_10004
		var_36_7.type = var_2_10004
		...
		local var_36_10 = var_36_5:GetPrice()
		local var_36_11 = {}

		getProxy = var_36_8
		ShipSkinProxy = var_6

		local var_36_12 = var_36_8(var_6)

		ipairs = var_6

		for iter_36_0, iter_36_1 in var_6(var_36_2.skin) do
			table = var_2_10011
			var_2_10011 = var_2_10011.insert

			local var_36_13 = var_36_11
			...
			var_36_14.type = var_2_10015
			var_36_14.id = iter_36_1
			var_36_14.got = var_36_12:hasNonLimitSkin(iter_36_1)
			underscore = var_2_10015
			var_36_14.special = var_2_10015.any(var_36_2.special_skin, function(arg_37_0)
				return iter_36_1 == arg_37_0
			end)

			var_2_10011(var_36_13, var_2_10013(var_36_14))
		end

		underscore = var_6

		local var_36_15 = var_6.all(var_36_2.special_skin, function(arg_38_0)
			local var_38_0 = var_36_12
		...
		i18n = var_8
		var_36_16.tipExtra = var_8("charge_title_getskin")
		var_36_16.extraItems = var_36_11
		var_36_16.descExtra = var_36_2[var_36_15 and "desc_2" or "desc_1"]
		var_36_16.price = var_36_10
		var_36_16.tagType = var_36_5:getConfig("tag")

		function var_36_16.onYes()
			pg = var_3_10000
			...
			local var_39_4 = var_36_10
			local var_39_5 = var_36_9

			var_39_2.content = var_3_10003(var_39_3, var_39_4, var_6.getName(var_39_5))
			...
			function var_39_2.onYes()
				...
				local var_40_2 = var_4_10002.ON_ACT_OPERATION
				...
				local var_40_5 = var_4_10005.New
				local var_40_6 = {}

				DROP_TYPE_RESOURCE = var_4_10007
				var_40_6.type = var_4_10007
				PlayerConst = var_4_10007
				var_40_6.id = var_4_10007.ResDiamond
				var_40_6.count = var_36_10
		...
		local var_36_17 = arg_34_0.viewComponent
		local var_36_18 = var_8.emit

		NewShopMainMediator = var_10

		var_36_18(var_36_17, var_10.OPEN_CHARGE_ITEM_PANEL, var_36_16)

		return
	end

	var_34_0(var_34_2, var_34_3, function()
		assert = var_2_10000
...
function var_0_1.initNotificationHandleDic(arg_42_0)
	...
	var_42_0[var_2.CHARGE_CONFIRM_FAILED] = function(arg_49_0, arg_49_1)
		...
		local var_49_1 = arg_49_1.getBody(var_49_0)

		getProxy = var_49_0
		ShopsProxy = var_2_10004

		local var_49_2 = var_49_0(var_2_10004)

		var_3.chargeFailed(var_49_2, var_49_1.payId, var_49_1.bsId)
	...
	var_42_0[var_2.SHOPPING_DONE] = function(arg_50_0, arg_50_1)
		...
		if var_50_2 == var_2_10005.ShopStreet then
			getProxy = var_50_2
			ShopsProxy = var_50_3
			var_50_3 = var_50_2(var_50_3)
			var_2_10006 = var_4.getShopStreet(var_50_3)

			local var_50_4 = var_4.getGoodsById(var_2_10006, var_50_0.id)

			var_2_10006 = arg_50_0.viewComponent
			var_50_3 = var_50_3.OnUpdateCommodity
			NewShopsScene = var_2_10007

			var_50_3(var_2_10006, var_2_10007.TYPE_SHOP_STREET, var_4, var_50_0.id)
		else
			local var_50_5 = var_50_0.shopType

			ShopArgs = var_50_3

			if var_50_5 == var_50_3.MilitaryShop then
				getProxy = var_50_5
				ShopsProxy = var_5

				local var_50_6 = var_50_5(var_5)
				local var_50_7 = var_4.getMeritorousShop(var_50_6).goods[var_50_0.id]

				var_2_10006 = arg_50_0.viewComponent

				local var_50_8 = var_5.OnUpdateCommodity

				NewShopsScene = var_2_10007

				var_50_8(var_2_10006, var_2_10007.TYPE_MILITARY_SHOP, var_4, var_50_0.id)
			end
		end

		if var_50_0.awards and #var_50_0.awards > 0 then
			local var_50_9 = arg_50_0.viewComponent

			var_4.unBlurView(var_50_9)

			local var_50_10 = arg_50_0.viewComponent
			local var_50_11 = var_4.emit

			BaseUI = var_2_10006

			var_50_11(var_50_10, var_2_10006.ON_ACHIEVE, var_50_0.awards)
		end

		local var_50_12 = var_50_0.normalList
		local var_50_13 = var_50_0.normalGroupList

		if var_50_12 then
			local var_50_14 = arg_50_0.viewComponent

			var_2_10006.setNormalList(var_50_14, var_50_12)
		end

		if var_50_13 then
			local var_50_15 = arg_50_0.viewComponent

			var_2_10006.setNormalGroupList(var_50_15, var_50_13)
		end

		pg = var_2_10006

		local var_50_16 = var_2_10006.shop_template[var_50_0.id]
		local var_50_17 = arg_50_0.viewComponent

		var_7.checkBuyDone(var_50_17, var_50_0.id)

		local var_50_18 = arg_50_0.viewComponent

		var_7.updateCurSubView(var_50_18)

		pg = var_7

		local var_50_19 = var_7.EasyRedDotMgr.GetInstance()

		var_7.TriggerMarks(var_50_19, "specialShop")
	...
	var_42_0[var_2.USE_ITEM_DONE] = function(arg_51_0, arg_51_1)
		if #arg_51_1:getBody().drops ~= 0 then
			...
			var_51_1(var_51_0, var_2_10005.ON_AWARD, {
				items = var_2.drops
			})
		end
	...
	var_42_0[var_2.GO_MALL] = function(arg_54_0, arg_54_1)
		...
		local var_54_1 = arg_54_1.getBody(var_54_0)

		ChargeScene = var_54_0

		local var_54_2 = var_54_0.TYPE_DIAMOND

		if var_54_1 and not var_54_1.type then
			::label_54_0::

			ChargeScene = var_4
			var_54_2 = var_4.TYPE_DIAMOND
		end

		local var_54_3 = arg_54_0.viewComponent

		var_4.switchSubViewByTogger(var_54_3, var_54_2)

		local var_54_4 = arg_54_0.viewComponent
		local var_54_5 = var_4.updateNoRes
		local var_54_6

		if not var_54_1 or not var_54_1.noRes then
			var_54_6 = nil
		end

		var_54_5(var_54_4, var_54_6)
	...
	var_42_0[var_2.CHARGE_SUCCESS] = function(arg_55_0, arg_55_1)
		...
		local var_55_4 = var_55_2(var_55_3, var_5.TYPE_CHARGE)
	...
	var_42_0[var_2.SHOPPINGSTREET_UPDATE] = function(arg_56_0, arg_56_1)
		...
		var_56_2(var_56_1, var_2_10005.TYPE_SHOP_STREET, var_56_0.shopStreet)
	...
	var_42_0[var_2.MERITOROUS_SHOP_UPDATED] = function(arg_57_0, arg_57_1)
		...
		var_57_1(var_57_0, var_2_10004.TYPE_MILITARY_SHOP, arg_57_1:getBody())
	...
	var_42_0[var_2.SHAM_SHOP_UPDATED] = function(arg_58_0, arg_58_1)
		...
		var_58_1(var_58_0, var_2_10004.TYPE_SHAM_SHOP, arg_58_1:getBody())
	...
	var_42_0[var_2.SHAM_SHOPPING_DONE] = function(arg_59_0, arg_59_1)
		...
		local var_59_1 = arg_59_1.getBody(var_59_0)

		getProxy = var_59_0
		ShopsProxy = var_2_10004

		local var_59_2 = var_59_0(var_2_10004)
		local var_59_3 = var_3.getShamShop(var_59_2)
		local var_59_4 = arg_59_0.viewComponent
		local var_59_5 = var_4.OnUpdateCommodity

		NewShopsScene = var_2_10006

		var_59_5(var_59_4, var_2_10006.TYPE_SHAM_SHOP, var_59_3, var_59_1.id)

		local var_59_6 = arg_59_0.viewComponent
		local var_59_7 = var_4.emit

		BaseUI = var_6

		var_59_7(var_59_6, var_6.ON_ACHIEVE, var_59_1.awards)
	...
	var_42_0[var_2.ITEM_UPDATED] = function(arg_60_0, arg_60_1)
		...
		local var_60_0 = var_2_10002(var_2_10003)
	...
	var_42_0[var_2.FRAG_SHOPPING_DONE] = function(arg_61_0, arg_61_1)
		...
		local var_61_1 = arg_61_1.getBody(var_61_0)

		getProxy = var_61_0
		ShopsProxy = var_2_10004

		local var_61_2 = var_61_0(var_2_10004)
		local var_61_3 = var_3.getFragmentShop(var_61_2)
		local var_61_4 = arg_61_0.viewComponent
		local var_61_5 = var_4.OnUpdateCommodity

		NewShopsScene = var_2_10006

		var_61_5(var_61_4, var_2_10006.TYPE_FRAGMENT, var_61_3, var_61_1.id)

		local var_61_6 = arg_61_0.viewComponent
		local var_61_7 = var_4.emit

		BaseUI = var_6

		var_61_7(var_61_6, var_6.ON_ACHIEVE, var_61_1.awards)
	...
	var_42_0[var_2.FRAGMENT_SHOP_UPDATED] = function(arg_62_0, arg_62_1)
		...
		var_62_1(var_62_0, var_2_10004.TYPE_FRAGMENT, arg_62_1:getBody())
	...
	var_42_0[var_2.ACTIVITY_SHOP_GOODS_UPDATED] = function(arg_63_0, arg_63_1)
		...
		local var_63_2 = var_63_0(var_2_10004)
		local var_63_3 = var_3.getActivityShopById(var_63_2, var_63_1.activityId)
		local var_63_4 = arg_63_0.viewComponent
		local var_63_5 = var_4.OnUpdateCommodity

		NewShopsScene = var_2_10006

		var_63_5(var_63_4, var_2_10006.TYPE_ACTIVITY, var_63_3, var_63_1.goodsId)
	...
	var_42_0[var_2.META_SHOP_GOODS_UPDATED] = function(arg_64_0, arg_64_1)
		...
		local var_64_2 = var_64_0(var_2_10004)
		local var_64_3 = var_3.GetMetaShop(var_64_2)
		local var_64_4 = arg_64_0.viewComponent
		local var_64_5 = var_4.OnUpdateCommodity

		NewShopsScene = var_2_10006

		var_64_5(var_64_4, var_2_10006.TYPE_META, var_64_3, var_64_1.goodsId)
	...
	var_42_0[var_2.ACTIVITY_SHOP_UPDATED] = function(arg_65_0, arg_65_1)
		...
		var_65_2(var_65_1, var_2_10005.TYPE_ACTIVITY, var_65_0.shop)
	...
	var_42_0[var_2.ACTIVITY_SHOP_SHOW_AWARDS] = function(arg_66_0, arg_66_1)
		...
		var_66_2(var_66_1, var_2_10005.ON_ACHIEVE, var_66_0.awards, var_66_0.callback)
	...
	var_42_0[var_2.FRAG_SELL_DONE] = function(arg_67_0, arg_67_1)
		...
		var_67_3(var_67_2, var_2_10005.ON_ACHIEVE, var_67_0.awards)
	...
	var_42_0[var_2.ON_GUILD_SHOP_PURCHASE_DONE] = function(arg_68_0, arg_68_1)
		...
		var_68_2(var_68_1, var_2_10005.ON_ACHIEVE, var_68_0.awards)
	...
	var_42_0[var_2.ON_MEDAL_SHOP_PURCHASE_DONE] = function(arg_69_0, arg_69_1)
		...
		var_69_2(var_69_1, var_2_10005.ON_ACHIEVE, var_69_0.awards)
	...
	var_42_0[var_2.GUILD_SHOP_UPDATED] = function(arg_70_0, arg_70_1)
		...
		var_70_2(var_70_1, var_2_10005.TYPE_GUILD, var_70_0.shop)
	...
	var_42_0[var_2.GUILD_SHOP_ADDED] = function(arg_71_0, arg_71_1)
		...
		var_71_2(var_71_1, var_2_10005.TYPE_GUILD, var_71_0.shop)
	...
	var_42_0[var_2.MEDAL_SHOP_UPDATED] = function(arg_72_0, arg_72_1)
		...
		var_72_1(var_72_0, var_2_10004.TYPE_MEDAL, arg_72_1:getBody())
	...
	var_42_0[var_2.ON_META_SHOPPING_DONE] = function(arg_73_0, arg_73_1)
		...
		var_73_2(var_73_1, var_2_10005.ON_ACHIEVE, var_73_0.awards)
	...
	var_42_0[var_2.QUOTA_SHOP_UPDATED] = function(arg_74_0, arg_74_1)
		...
		var_74_2(var_74_1, var_2_10005.TYPE_QUOTA, var_74_0.shop)
	...
	var_42_0[var_2.QUOTA_SHOPPING_DONE] = function(arg_75_0, arg_75_1)
		...
		local var_75_1 = arg_75_1.getBody(var_75_0)

		getProxy = var_75_0
		ShopsProxy = var_2_10004

		local var_75_2 = var_75_0(var_2_10004)
		local var_75_3 = var_3.getQuotaShop(var_75_2)
		local var_75_4 = arg_75_0.viewComponent
		local var_75_5 = var_4.OnUpdateCommodity

		NewShopsScene = var_2_10006

		var_75_5(var_75_4, var_2_10006.TYPE_QUOTA, var_75_3, var_75_1.id)

		local var_75_6 = arg_75_0.viewComponent
		local var_75_7 = var_4.emit

		BaseUI = var_6

		var_75_7(var_75_6, var_6.ON_ACHIEVE, var_75_1.awards)

		return
	end
	GAME = var_2
	var_42_0[var_2.MINI_GAME_SHOP_BUY_DONE] = function(arg_76_0, arg_76_1)
		if arg_76_1:getBody().list then
			var_2_10004 = #var_3

			if 0 < var_2_10004 then
				var_2_10005 = arg_76_0.viewComponent
				var_2_10004 = var_2_10004.emit
				BaseUI = var_2_10006

				var_2_10004(var_2_10005, var_2_10006.ON_ACHIEVE, var_3)
			end
		end
		...
		local var_76_0 = var_2_10004(var_2_10005)
		local var_76_1 = var_4.getMiniShop(var_76_0)
		local var_76_2 = arg_76_0.viewComponent
		local var_76_3 = var_5.OnUpdateShop

		NewShopsScene = var_2_10007

		var_76_3(var_76_2, var_2_10007.TYPE_MINI_GAME, var_76_1)
	...
	var_42_0[var_0_1.ON_SUBLAYER_EVENT] = function(arg_78_0, arg_78_1)
		...
		var_78_2(var_78_1, var_2_10005(var_78_0))
