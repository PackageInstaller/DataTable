...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.price = var_1_6(var_1_5, var_4(var_1_10005))
	...
	var_1_30(var_1_31, var_4.Find(var_1_32, "real_tpl/tag/hot"))
	...
	var_1_33(var_1_34, var_4.Find(var_1_35, "real_tpl/tag/new"))
	...
	var_1_36(var_1_37, var_4.Find(var_1_38, "real_tpl/tag/advice"))
	...
	var_1_39(var_1_40, var_4.Find(var_1_41, "real_tpl/tag/double"))
	...
	var_1_42(var_1_43, var_4.Find(var_1_44, "real_tpl/tag/activity"))
	...
	var_1_45(var_1_46, var_4.Find(var_1_47, "real_tpl/tag/time"))
	...
	var_1_48(var_1_49, var_4.Find(var_1_50, "real_tpl/tag/discount"))
...
function var_0_0.update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_6 = var_2_0.EasyRedDotMgr.GetInstance()
	...
	var_5.RegisterRedDot(var_2_6, arg_2_0.focusTip, {
		...
		var_2_10001(var_3_0, var_3.isTip(var_3_1))
	...
	if arg_2_0.packageTag then
		...
		local var_2_10 = arg_2_1.GetPackageTag(var_2_9)

		setActive = var_2_9

		var_2_9(arg_2_0.packageTag, var_2_10 ~= "")

		setText = var_2_9

		local var_2_11 = arg_2_0.packageTag

		var_2_9(var_7.Find(var_2_11, "Text"), var_2_10)
	end
...
function var_0_0.updateCharge(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if not var_1_10004.contains(arg_4_3, arg_4_1.id) and arg_4_1:firstPayDouble() then
		var_4_0 = 4
	else
		var_1_10007 = arg_4_1
		var_4_0 = arg_4_1.getConfig(var_1_10007, "tag")
	end

	setActive = var_1_10007

	var_1_10007(arg_4_0.tag, var_4_0 > 0)
	...
	if 0 < var_4_0 then
		...
		for iter_4_0, iter_4_1 in var_7(arg_4_0.tags) do
			...
			var_1_10012(iter_4_1, iter_4_0 == var_4_0)
		end
	end
	...
	local var_4_4 = arg_4_1.getConfig(var_4_3, "id")

	ActivityConst = var_4_3

	local var_4_5 = var_4_4 == var_4_3.FREE_PACKAGE_SHOW_TIME_ID
	local var_4_7

	if var_4_1 and (not arg_4_1:isFree() or var_4_5) and var_4_2 and 0 < var_4_2 then
		setActive = var_4_7

		var_4_7(arg_4_0.numLeftText, true)

		pg = var_4_7

		local var_4_6 = var_4_7.TimeMgr.GetInstance()
		local var_4_8, var_4_9

		var_4_7, var_4_8, var_4_9 = var_4_7.parseTimeFrom(var_4_6, var_4_2)

		if 0 < var_4_7 then
			setText = var_13

			local var_4_10 = arg_4_0.numLeftText

			i18n = var_1_10015

			var_13(var_4_10, var_1_10015("shop_goods_left_day", var_4_7))
		elseif 0 < var_4_8 then
			setText = var_13
			...
			var_13(var_4_11, var_1_10015("shop_goods_left_hour", var_4_8))
		elseif var_4_9 then
			setText = var_13
			...
			var_13(var_4_12, var_1_10015("shop_goods_left_minute", var_4_9 > 0 and var_4_9 or 1))
		end
		...
		if var_1_10015 <= var_4_2 then
			var_4_15 = var_4_2 % var_1_10015
		elseif var_4_14 <= var_4_2 then
			var_4_15 = var_4_2 % var_4_14
		elseif var_4_13 <= var_4_2 then
			var_4_15 = var_4_2 % var_4_13
		end

		if var_4_15 and var_4_15 > 0 then
			if arg_4_0.countDownTimer then
				local var_4_16 = arg_4_0.countDownTimer

				var_17.Stop(var_4_16)
			...
			local var_4_17 = arg_4_0.countDownTimer

			var_17.Start(var_4_17)
		end
	end

	setScrollText = var_4_7

	var_4_7(arg_4_0.name, arg_4_1:getConfig("name_display"))
	...
	local var_4_18 = arg_4_1:getConfig("limit_type")
	local var_4_19 = arg_4_1:getBuyCount()
	local var_4_20 = arg_4_1
	local var_4_21 = arg_4_1.getLimitCount(var_4_20)

	if var_4_18 == 2 then
		setText = var_4_20

		local var_4_22 = arg_4_0.limitText

		i18n = var_1_10015

		var_4_20(var_4_22, var_1_10015("charge_limit_all", var_4_21 - var_4_19, var_4_21))
	elseif var_4_18 == 4 then
		setText = var_4_20

		local var_4_23 = arg_4_0.limitText

		i18n = var_1_10015

		var_4_20(var_4_23, var_1_10015("charge_limit_daily", var_4_21 - var_4_19, var_4_21))
	else
		setText = var_4_20

		var_4_20(arg_4_0.limitText, "")
	end

	local var_4_24 = arg_4_0.price

	var_4_24.text = arg_4_1:getConfig("money")
	PLATFORM_CODE = var_4_24
	PLATFORM_CHT = var_4_25

	local var_4_25

	if var_4_24 == var_4_25 then
		var_4_25 = arg_4_1

		if arg_4_1.IsLocalPrice(var_4_25) then
			setActive = var_13
	...
	local var_4_26 = arg_4_0.iconTF

	GetSpriteFromAtlas = var_4_25
	var_4_26.sprite = var_4_25("chargeicon/1", "")
	LoadSpriteAsync = var_4_26

	var_4_26("chargeicon/" .. arg_4_1:getConfig("picture"), function(arg_6_0)
		if arg_6_0 then
			IsNil = var_2_10001
...
function var_0_0.UpdateShipIcon(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_7_2(var_7_1, var_4(var_1_10005))
	local var_7_4 = arg_7_1
	local var_7_5 = arg_7_1.getConfigTable(var_7_4).usage_arg[1][1]
	...
	local var_7_6 = var_7_4.shop_template[var_7_5].effect_args[1]
	...
	local var_7_7 = var_1_10006.ship_skin_template[var_7_6]

	LoadSpriteAsync = var_7

	var_7("qicon/" .. var_7_7.prefab, function(arg_8_0)
		if arg_8_0 then
			IsNil = var_2_10001
...
function var_0_0.updateGemItem(arg_9_0, arg_9_1, arg_9_2)
	...
	if 0 < var_9_0 then
		...
		var_5(var_9_2, var_1_10007("charge_limit_all", var_9_0 - var_9_1, var_9_0))
	end

	if arg_9_1:getConfig("group_limit") > 0 then
		local var_9_3 = arg_9_1
		local var_9_4

		if not arg_9_1.getConfig(var_9_3, "group_type") then
			var_9_4 = 0
		end
		...
		if var_9_4 == 1 then
			...
			var_9_3(var_9_5, var_1_10009("charge_limit_daily", var_5 - arg_9_1.groupCount, var_5))
		elseif var_9_4 == 2 then
			...
			var_9_3(var_9_6, var_1_10009("charge_limit_weekly", var_5 - arg_9_1.groupCount, var_5))
		elseif var_9_4 == 3 then
			...
			var_9_3(var_9_7, var_1_10009("charge_limit_monthly", var_5 - arg_9_1.groupCount, var_5))
		end
	end
	...
	local var_9_10 = arg_9_1.getConfig(var_9_9, "tag")

	setActive = var_9_9

	var_9_9(arg_9_0.tag, var_9_10 > 0)
	...
	if 0 < var_9_10 then
		...
		for iter_9_0, iter_9_1 in var_7(arg_9_0.tags) do
			...
			var_1_10012(iter_9_1, iter_9_0 == var_9_10)
		end
	end
	...
	local var_9_11, var_9_12 = arg_9_1:inTime()
	local var_9_13 = arg_9_1
	local var_9_14 = arg_9_1.getConfig(var_9_13, "id")

	ActivityConst = var_9_13

	local var_9_15 = var_9_14 == var_9_13.FREE_PACKAGE_SHOW_TIME_ID
	local var_9_17

	if var_9_11 and (not arg_9_1:isFree() or var_9_15) and var_9_12 and 0 < var_9_12 then
		setActive = var_9_17

		var_9_17(arg_9_0.numLeftText, true)

		pg = var_9_17

		local var_9_16 = var_9_17.TimeMgr.GetInstance()
		local var_9_18, var_9_19

		var_9_17, var_9_18, var_9_19 = var_9_17.parseTimeFrom(var_9_16, var_9_12)
		...
		if 0 < var_9_17 then
			...
			var_1_10013(var_9_20, var_1_10015("shop_goods_left_day", var_9_17))
		elseif 0 < var_9_18 then
			setText = var_1_10013

			local var_9_21 = arg_9_0.numLeftText

			i18n = var_1_10015

			var_1_10013(var_9_21, var_1_10015("shop_goods_left_hour", var_9_18))
		elseif var_9_19 then
			setText = var_1_10013

			local var_9_22 = arg_9_0.numLeftText

			i18n = var_1_10015

			var_1_10013(var_9_22, var_1_10015("shop_goods_left_minute", var_9_19 > 0 and var_9_19 or 1))
		end
		...
		if var_9_24 <= var_9_12 then
			var_9_25 = var_9_12 % var_9_24
		elseif var_9_23 <= var_9_12 then
			var_9_25 = var_9_12 % var_9_23
		elseif var_1_10013 <= var_9_12 then
			var_9_25 = var_9_12 % var_1_10013
		end

		if var_9_25 and var_9_25 > 0 then
			if arg_9_0.countDownTimer then
				local var_9_26 = arg_9_0.countDownTimer

				var_17.Stop(var_9_26)
			...
			local var_9_27 = arg_9_0.countDownTimer

			var_17.Start(var_9_27)
		end
	end

	setActive = var_9_17

	var_9_17(arg_9_0.name, true)

	if #arg_9_1:getConfig("effect_args") > 0 then
		Item = var_11

		if var_11.getConfigData(var_10[1]) then
			...
			arg_9_0.updateImport(var_1_10013, arg_9_0:GetShopDisplayItemData(arg_9_1))

			var_1_10013 = arg_9_0

			if arg_9_0.CheckSkinDiscounItem(var_1_10013, var_11.display_icon) then
		...
		var_9_28.sprite = var_1_10013("chargeicon/1", "")
...
function var_0_0.CheckSkinDiscounItem(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10002(arg_12_1) do
		...
		if var_1_10007.getConfigTable(var_12_0).usage then
			...
			if var_12_1 == var_1_10010.USAGE_SHOP_DISCOUNT then
				return var_1_10007
			end
		end
	end
...
local function var_0_1(arg_13_0)
	if arg_13_0:getConfigTable().usage then
		local var_13_0 = var_1.usage

		ItemUsage = var_1_10003

		if var_13_0 == var_1_10003.USAGE_SKIN_EXP then
			return false
		end
	end
...
function var_0_0.updateImport(arg_14_0, arg_14_1)
	...
	if var_14_1 then
		...
		for iter_14_0, iter_14_1 in var_4(arg_14_1[1].list) do
			table = var_1_10009
			var_1_10009 = var_1_10009.insert
			var_1_10010 = var_14_2
			Drop = var_1_10011

			var_1_10009(var_1_10010, var_1_10011.Create(iter_14_1))
		end

		for iter_14_2 = 1, arg_14_0.grid1.childCount do
			local var_14_3 = arg_14_0.grid
			local var_14_4 = var_8.GetChild(var_14_3, iter_14_2 - 1)

			if iter_14_2 <= #var_14_2 then
				setActive = var_9

				var_9(var_14_4, var_0_1(var_14_2[iter_14_2]))

				updateDrop = var_9
				var_1_10011 = var_14_4

				var_9(var_14_4.Find(var_1_10011, "itemBg/item"), var_14_2[iter_14_2])
			else
				setActive = var_9

				var_9(var_14_4, false)
			end
		end
		...
		for iter_14_3, iter_14_4 in var_14_10(arg_14_1[2].list) do
			table = var_1_10010
			var_1_10010 = var_1_10010.insert
			var_1_10011 = var_14_5
			Drop = var_1_10012

			var_1_10010(var_1_10011, var_1_10012.Create(iter_14_4))
		end

		for iter_14_5 = 1, arg_14_0.grid1.childCount do
			local var_14_6 = arg_14_0.grid1
			local var_14_7 = var_9.GetChild(var_14_6, iter_14_5 - 1)

			if iter_14_5 <= #var_14_5 then
				setActive = var_10

				var_10(var_14_7, var_0_1(var_14_5[iter_14_5]))

				updateDrop = var_10

				var_10(var_14_7:Find("itemBg/item"), var_14_5[iter_14_5])
			else
				setActive = var_10

				var_10(var_14_7, false)
			end
		end
	else
		local var_14_8 = arg_14_1[1].text == ""

		setActive = var_14_10

		var_14_10(arg_14_0.itemPanel2, not var_14_8)

		setActive = var_14_10

		var_14_10(arg_14_0.itemPanel3, var_14_8)

		local var_14_10

		if var_14_8 then
			setScrollText = var_14_10

			local var_14_9 = arg_14_0.firstTipText3

			i18n = var_7

			var_14_10(var_14_9, var_7("shop_item_unlock"))

			var_14_10 = {}
			ipairs = var_14_9

			for iter_14_6, iter_14_7 in var_14_9(arg_14_1[1].list) do
				table = var_1_10011
				...
				var_1_10011(var_14_11, var_1_10013.Create(iter_14_7))
			end

			for iter_14_8 = 1, arg_14_0.grid3.childCount do
				var_1_10011 = arg_14_0.grid3

				local var_14_12 = var_10.GetChild(var_1_10011, iter_14_8 - 1)

				if iter_14_8 <= #var_14_10 then
					setActive = var_1_10011

					var_1_10011(var_14_12, var_0_1(var_14_10[iter_14_8]))

					updateDrop = var_1_10011
					var_1_10013 = var_14_12

					var_1_10011(var_14_12.Find(var_1_10013, "itemBg/item"), var_14_10[iter_14_8])
				else
					setActive = var_1_10011
			...
			var_14_10(arg_14_0.firstTipText2, var_3)
			...
			for iter_14_9, iter_14_10 in var_6(arg_14_1[1].list) do
				...
				var_1_10011(var_14_14, var_1_10013.Create(iter_14_10))
			end
...
function var_0_0.GetPayDisplayItemData(arg_15_0, arg_15_1)
	...
	local var_15_3 = arg_15_1.getConfig(var_15_2, "second_text")

	table = var_15_2

	var_15_2.insert(var_15_0, {
		text = var_15_3,
...
function var_0_0.GetShopDisplayItemData(arg_16_0, arg_16_1)
	...
	if arg_16_1.getConfig(var_16_1, "first_text") ~= "" then
		table = var_16_1

		var_16_1.insert(var_16_0, {
			text = var_3,
			list = arg_16_1:getConfig("first_icon")
		})
	end

	local var_16_2 = arg_16_1:getConfig("second_text")
	local var_16_3 = arg_16_1
	local var_16_4 = arg_16_1.getConfig(var_16_3, "effect_args")

	Item = var_16_3

	local var_16_5 = var_16_3.getConfigData(var_16_4[1])

	table = var_7

	var_7.insert(var_16_0, {
		text = var_16_2,
