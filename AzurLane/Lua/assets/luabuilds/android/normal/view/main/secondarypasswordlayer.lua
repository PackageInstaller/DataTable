...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.textTitle = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.textTitleEn = var_2_10(var_2_9, var_3(var_1_10004))
	...
	var_1.each(arg_2_0.btngroup, function(arg_3_0)
		...
		local var_3_1 = (arg_3_0.GetSiblingIndex(var_3_0) + 1) % 10

		tostring = var_3_0
		arg_3_0.name = var_3_0(var_3_1)
		setText = var_2

		local var_3_2 = arg_3_0
		local var_3_3 = arg_3_0.Find(var_3_2, "text")

		tostring = var_3_2

		var_2(var_3_3, var_3_2(var_3_1))

		setText = var_2

		local var_3_4 = arg_3_0
		local var_3_5 = arg_3_0.Find(var_3_4, "highlight/text2")

		tostring = var_3_4

		var_2(var_3_5, var_3_4(var_3_1))
	...
	for iter_2_0 = 0, var_2_20 - 1 do
		...
		var_1_10007 = arg_2_0.setDigitGroup

		local var_2_21 = arg_2_0.setLine1Grid

		var_1_10006(var_1_10007, var_8.GetChild(var_2_21, iter_2_0))
	end
	...
	for iter_2_1 = 0, var_2_20 - 1 do
		...
		local var_2_22 = arg_2_0.setLine2Grid

		var_1_10006(var_1_10007, var_8.GetChild(var_2_22, iter_2_1))
	end

	local var_2_23 = arg_2_0.setView

	arg_2_0.btnhide = var_2.Find(var_2_23, "line1/hidebtn/hide")

	local var_2_24 = arg_2_0.setView

	arg_2_0.btnshow = var_2.Find(var_2_24, "line1/hidebtn/show")

	local var_2_25 = arg_2_0.setView

	arg_2_0.tipseterror = var_2.Find(var_2_25, "line2/tip")
	arg_2_0.inputDigitGroup = {}

	local var_2_26 = arg_2_0.inputView

	arg_2_0.inputLineGrid = var_2.Find(var_2_26, "line1/input/grid")
	CustomIndexLayer = var_2

	var_2.Clone2Full(arg_2_0.inputLineGrid, 6)

	local var_2_27 = arg_2_0.inputLineGrid.childCount

	for iter_2_2 = 0, var_2_27 - 1 do
		table = var_1_10007
		var_1_10007 = var_1_10007.insert

		local var_2_28 = arg_2_0.inputDigitGroup
		local var_2_29 = arg_2_0.inputLineGrid

		var_1_10007(var_2_28, var_9.GetChild(var_2_29, iter_2_2))
	end
...
function var_0_1.InitInteractable(arg_4_0)
	...
	var_1_10001.each(arg_4_0.btngroup, function(arg_5_0)
		...
		var_2_10001(arg_4_0, arg_5_0, function()
			...
			if 0 < var_6_2 and var_6_2 <= #arg_4_0.digitGroup then
				...
				var_6_5(var_6_3, var_6_1)

				setActive = var_6_5

				local var_6_6 = arg_4_0.digitGroup[var_6_2]

				var_6_5(var_4.Find(var_6_6, "filled"), false)

				setActive = var_6_5

				local var_6_7 = arg_4_0.digitGroup[var_6_2]

				var_6_5(var_4.Find(var_6_7, "space"), false)
				...
				local function var_6_8()
					...
					var_4_10000(var_1.Find(var_7_0, "filled"), true)
			...
			var_6_3(var_3.Find(var_6_14, "highlight"), true)
			...
			local function var_6_15()
				...
				var_4_10000(var_1.Find(var_8_0, "highlight"), false)
	...
	var_1(arg_4_0, arg_4_0.btndelete, function()
		...
		if 0 < var_9_0 and var_9_0 <= #arg_4_0.digitGroup then
			...
			var_9_1(var_2.Find(var_9_2, "text"), "")

			setActive = var_9_1

			local var_9_3 = arg_4_0.digitGroup[var_9_0]

			var_9_1(var_2.Find(var_9_3, "filled"), false)

			setActive = var_9_1

			local var_9_4 = arg_4_0.digitGroup[var_9_0]

			var_9_1(var_2.Find(var_9_4, "space"), not arg_4_0.inputMode)
		...
		var_9_1(var_2.Find(var_9_7, "highlight"), true)
		...
		local function var_9_8()
			...
			var_3_10000(var_1.Find(var_10_0, "highlight"), false)
		...
		if arg_4_0.timers.btndel then
			...
			Timer = var_9_9
			var_9_10.btndel = var_9_9.New(var_9_8, 0.3, 1)
		end
	...
	var_1(arg_4_0, arg_4_0.btnconfirm, function()
		if arg_4_0.mode == var_0_1.InputView then
			...
			SecondaryPasswordMediator = var_2_10002

			var_11_1(var_11_0, var_2_10002.CONFIRM_PASSWORD, arg_4_0.inputs)
		else
			arg_4_0.inputnone = false
			...
			function var_11_8.onYes()
				...
				i18n = var_3_10003
				var_12_1.content = var_12_2(var_3_10003("secondarypassword_confirm_tips"), var_12_0)
				...
				function var_12_1.onYes()
					...
					SecondaryPasswordMediator = var_4_10002

					var_14_1(var_14_0, var_4_10002.SET_PASSWORD, var_11_4, var_12_0)
	...
	local function var_4_2()
		if arg_4_0.mode == var_0_1.InputView then
			...
			var_19_1(var_19_0, var_2_10002.CANCEL_OPERATION)
		end
...
function var_0_1.didEnter(arg_21_0)
	if arg_21_0.contextData.parent then
		...
		var_1.BlurPanel(var_1_10002, arg_21_0._tf, {
			staticBlur = true
		})
	end
	...
	var_1_10002(arg_21_0.setView, var_21_0 == var_0_1.SetView)

	setActive = var_1_10002

	var_1_10002(arg_21_0.inputView, var_21_0 == var_0_1.InputView)
	...
	if var_21_0 ~= var_0_1.SetView or not arg_21_0.setDigitGroup then
		var_21_1 = arg_21_0.inputDigitGroup
	end

	arg_21_0.digitGroup = var_21_1

	local var_21_2 = arg_21_0.textTitle

	if var_21_0 == var_0_1.SetView then
		i18n = var_21_3

		local var_21_3

		if not var_21_3("words_set_password") then
			i18n = var_21_3
			var_21_3 = var_21_3("words_information")
		end

		var_21_2.text = var_21_3
		arg_21_0.textTitleEn.text = var_21_0 == var_0_1.SetView and "PASSWORD" or "INFORM"

		local var_21_4 = arg_21_0.informBg.sizeDelta

		var_21_4.x = arg_21_0.textTitle.preferredWidth + arg_21_0.textTitleEn.preferredWidth + var_0_2
		arg_21_0.informBg.sizeDelta = var_21_4
		arg_21_0.inputs = ""
...
function var_0_1.UpdateInputSlider(arg_22_0)
	...
	for iter_22_0 = 1, #arg_22_0.digitGroup do
		...
		if iter_22_0 <= #arg_22_0.inputs then
			...
			if not var_22_2(var_1_10008.byte(arg_22_0.inputs, iter_22_0)) then
				var_22_3 = nil
			end
	...
	if not var_0_3 then
		var_27_1 = {
			[var_27_0.UNLOCK_SHIP] = function(arg_28_0)
				...
				if var_3.getShipById(var_28_3, var_28_0) then
					string = var_28_3

					local var_28_4 = var_28_3.format

					i18n = var_7

					return var_28_4(var_7("words_desc_unlock"), var_5:getName())
				end
			...
			[var_27_0.UNLOCK_COMMANDER] = function(arg_29_0)
				...
				local var_29_1 = var_2_10002(var_2_10003)

				if var_2.getCommanderById(var_29_1, var_29_0) then
					string = var_29_1

					local var_29_2 = var_29_1.format

					i18n = var_5

					return var_29_2(var_5("words_desc_unlock"), var_3:getName())
				end
			...
			[var_27_0.RESOLVE_EQUIPMENT] = function(arg_30_0)
				...
				if var_2.getEquipmentById(var_30_1, var_30_0) then
					...
					if 0 < var_30_3 then
						...
						var_30_4 = "+"
						tostring = var_7
						var_30_2 = var_30_3 .. var_30_4 .. var_7(var_3:getConfig("id") % 20)
					end

					string = var_30_3

					local var_30_5 = var_30_3.format

					i18n = var_30_4

					return var_30_5(var_30_4("words_desc_resolve_equip"), var_30_2)
				end
...
function var_0_1.UpdateInputView(arg_34_0)
	...
	var_34_2(var_34_3, var_34_1.notice)

	setActive = var_34_2

	var_34_2(var_34_3, not arg_34_0.inputnone)
...
function var_0_1.UpdateConfirmButton(arg_35_0)
	...
	typeof = var_1_10003
	Button = var_1_10004
	var_35_1(var_35_0, var_1_10003(var_1_10004)).interactable = #arg_35_0.inputs == #arg_35_0.digitGroup
	setActive = var_2

	local var_35_2 = arg_35_0.btnconfirm

	var_2(var_3.Find(var_35_2, "gray"), #arg_35_0.inputs ~= #arg_35_0.digitGroup)
