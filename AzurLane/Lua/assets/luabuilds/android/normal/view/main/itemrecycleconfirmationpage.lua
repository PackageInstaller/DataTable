...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.itemName = var_2_8(var_2_7, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.resName = var_2_11(var_2_10, var_3(var_1_10004))
	setText = var_1

	local var_2_12 = arg_2_0._tf
	local var_2_13 = var_2.Find(var_2_12, "window/top/bg/infomation/title")
	...
	local var_2_15 = var_2.Find(var_2_14, "window/button_container/cancel/pic")
	...
	local var_2_17 = var_2.Find(var_2_16, "window/button_container/confirm/pic")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("word_ok"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_11()
		if arg_3_0.itemId then
			...
			var_7_1(var_7_0, var_2_10002.SELL_ITEM, {
				items = {
					{
						count = 1,
						id = arg_3_0.itemId
...
function var_0_1.UpdateItem(arg_11_0)
	...
	var_11_2(arg_11_0.itemTpl, var_11_3)

	local var_11_4 = arg_11_0.itemName

	shortenString = var_4
	var_11_4.text = var_4(var_11_3:getName(), 5)
...
function var_0_1.UpdateResource(arg_12_0)
	...
	local var_12_3 = var_12_1.Create
	local var_12_4 = {}

	DROP_TYPE_RESOURCE = var_1_10006
	var_12_4[1] = var_1_10006
	...
	var_12_4(arg_12_0.resTpl, var_12_5)

	local var_12_6 = arg_12_0.resName

	shortenString = var_6
	var_12_6.text = var_6(var_12_5:getName(), 5)
