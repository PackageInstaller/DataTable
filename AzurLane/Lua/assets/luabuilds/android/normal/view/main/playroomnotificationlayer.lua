...
function var_0_1.init(arg_2_0)
	...
	local var_2_3 = var_2.Find(var_2_2, "top/channels")
	local var_2_4 = arg_2_0.rtWindow

	arg_2_0.uiChannelList = var_2_1(var_2_3, var_3.Find(var_2_4, "top/channels/tpl"))
	...
	typeof = var_3
	Text = var_2_4
	arg_2_0.sendChanncelTxt = var_2_8(var_2_7, var_3(var_2_4))
	...
	typeof = var_3
	Text = var_2_4
	arg_2_0.roomNumTxt = var_2_11(var_2_10, var_3(var_2_4))
	...
	typeof = var_3
	InputField = var_2_4
	arg_2_0.inputField = var_2_18(var_2_17, var_3(var_2_4))
	UIItemList = var_1

	local var_2_19 = var_1.New
	local var_2_20 = arg_2_0.rtWindow
	local var_2_21 = var_2.Find(var_2_20, "send_panel/channel_sel_panel")
	local var_2_22 = arg_2_0.rtWindow

	arg_2_0.uiSendChanncelList = var_2_19(var_2_21, var_3.Find(var_2_22, "send_panel/channel_sel_panel/tpl"))
...
function var_0_1.RegisterEvent(arg_3_0)
	...
	local function var_3_5()
		...
		local var_5_2 = var_2_10002.ON_ADD_SUBLAYER
		...
		PlayRoomChatSettingsMsgboxMediator = var_2_10005
		var_5_4.mediator = var_2_10005
		PlayRoomChatSettingsMsgboxLayer = var_2_10005
		var_5_4.viewComponent = var_2_10005

		local var_5_5 = {}
		local var_5_6 = arg_3_0

		var_5_5.groupName = var_6.getGroupName(var_5_6)
		...
		i18n = var_7
		var_5_7.title = var_7("island_chat_settings")
	...
	local function var_3_8()
		local var_7_0 = {
			emojiIconCallback = function(arg_8_0)
				...
				var_8_0.text = var_8_1 .. var_8_2(var_3_10004.EmojiIconCode, "code", arg_8_0)
			...
			callback = function(arg_9_0)
				...
				PlayRoomNotificationMediator = var_3

				local var_9_2 = var_3.SEND_CHAT
				local var_9_3 = arg_3_0.sendChannelValue

				string = var_3_10005

				local var_9_4 = var_3_10005.gsub

				ChatConst = var_3_10006

				var_9_1(var_9_0, var_9_2, var_9_3, var_9_4(var_3_10006.EmojiCode, "code", arg_9_0))
		...
		PlayRoomNotificationMediator = var_2_10003

		var_7_3(var_7_2, var_2_10003.OPEN_EMOJI, var_7_0)
	...
	local function var_3_11()
		...
		var_10_2(var_10_1, var_3.SEND_CHAT, arg_3_0.sendChannelValue, var_10_0)
...
function var_0_1.OnSettingEnd(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	if arg_14_0.chatRoomId ~= arg_14_3 then
		...
		PlayRoomNotificationMediator = var_1_10006

		var_14_1(var_14_0, var_1_10006.CHANGE_CHAT_ROOM, arg_14_3)
	end
...
function var_0_1.InitSendChannel(arg_16_0)
	...
	var_2.make(var_16_1, function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			var_4(var_17_1, var_17_2, var_17_3, var_2_10008)
			...
			local var_17_6 = arg_17_2.Find(var_17_5, "Text")

			setColorStr = var_17_5

			var_5(var_17_6, var_17_5(var_17_4, var_17_0 == arg_16_0.sendChannelValue and "#5ccaff" or "#ffffff"))
		end
...
function var_0_1.InitChanncelToggles(arg_20_0)
	...
	var_20_4(var_20_3, var_4.CHANNEL_PLAYROOM)
	...
	var_2.eachActive(var_24_1, function(arg_25_0, arg_25_1)
		...
		if not (var_25_0 == var_4.CHANNEL_ALL) or not var_25_2 then
			...
			if not var_4 and not var_25_2 then
				...
				var_2_10006(arg_25_1:Find("sel"), var_2_10005)

				PlayRoomChatConst = var_2_10006

				local var_25_3 = var_2_10006.CHANNEL2CN(var_25_0)

				setText = var_7

				local var_25_4 = arg_25_1
				local var_25_5 = arg_25_1.Find(var_25_4, "Text")

				setColorStr = var_25_4

				var_7(var_25_5, var_25_4(var_25_3, var_2_10005 and "#393a3c" or "#FFFFFF"))
...
function var_0_1.InitChatMsg(arg_29_0, arg_29_1)
	...
	PlayRoomChatConst = var_1_10004

	if var_29_1(var_29_0, var_1_10004.CHANNEL_WORLD) then
		getProxy = var_2
		ChatProxy = var_29_0
		...
		var_29_0.each(var_29_2:getRawData(), function(arg_30_0)
	...
	if var_29_4(var_29_3, var_4.CHANNEL_GUILD) then
		getProxy = var_2
		GuildProxy = var_29_3
		...
		if var_2.getRawData(var_29_5) then
			...
			var_3.each(var_2:getChatMsgs(), function(arg_31_0)
	...
	if var_29_7(var_29_6, var_29_5.CHANNEL_FRIEND) then
		...
		var_29_6.each(var_29_8:getCacheMsgList(), function(arg_32_0)
	...
	if var_29_10(var_29_9, var_4.CHANNEL_PLAYROOM) then
		_ = var_29_11
		var_29_11 = var_29_11.each
		getProxy = var_29_9
		PlayRoomProxy = var_4

		local var_29_12 = var_29_9(var_4)

		var_29_11(var_3.GetChatMsgs(var_29_12), function(arg_33_0)
