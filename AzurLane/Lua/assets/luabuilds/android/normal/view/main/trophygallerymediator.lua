...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_TROPHY_CLAIM, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.TROPHY_CLAIM, {
			trophyID = arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.ON_GET_ALL_LOVE_LETTER_REWARD, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.GET_LOVE_LETTER_REWARD, {
			list = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_DISPLAY_WINDOW, function(arg_4_0, arg_4_1)
		...
		LoveLetterGiftLevelDisplayMediator = var_2_10006
		var_4_3.mediator = var_2_10006
		LoveLetterGiftLevelDisplayLayer = var_2_10006
...
function var_0_1.initNotificationHandleDic(arg_6_0)
	...
	var_6_0[var_1_10002.TROPHY_CLAIM_DONE] = function(arg_7_0, arg_7_1)
		...
		local var_7_1 = var_2_10004.medal_template[var_7_0].hide

		Trophy = var_2_10006

		if var_7_1 == var_2_10006.ALWAYS_HIDE then
			return
		end

		math = var_7_1

		local var_7_2 = var_7_1.floor(var_7_0 / 10)

		getProxy = var_6
		CollectionProxy = var_2_10007

		local var_7_3 = var_6(var_2_10007)
		local var_7_4 = var_6.getTrophyGroup(var_7_3)
		local var_7_5 = var_6:getTrophys()
		local var_7_6 = arg_7_0.viewComponent

		var_9.setTrophyGroups(var_7_6, var_7_4)

		local var_7_7 = arg_7_0.viewComponent

		var_9.setTrophyList(var_7_7, var_7_5)

		local var_7_8 = arg_7_0.viewComponent

		var_9.PlayTrophyClaim(var_7_8, var_7_2)
	...
	var_6_0[var_2.GET_LOVE_LETTER_REWARD_DONE] = function(arg_8_0, arg_8_1)
		...
		if #var_8_0.awards > 0 then
			...
			var_4.insert(var_8_1, function(arg_9_0)
				...
				var_9_1(var_9_0, var_3_10003.ON_ACHIEVE, var_8_0.awards, arg_9_0)
