...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.oilTF = var_2_4(var_2_3, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.goldTF = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.classTF = var_2_10(var_2_9, var_3(var_1_10004))
	...
	arg_2_0.oilbubbleCG = var_1(var_2_15, var_3(var_1_10004))
	GetOrAddComponent = var_1
	...
	typeof = var_3
	CanvasGroup = var_1_10004
	arg_2_0.goldbubbleCG = var_1(var_2_16, var_3(var_1_10004))
	GetOrAddComponent = var_1
	...
	typeof = var_3
	CanvasGroup = var_1_10004
	arg_2_0.classbubbleCG = var_1(var_2_17, var_3(var_1_10004))
	getProxy = var_1
	...
	local var_2_21 = var_2_19.getConfigData(var_2_20).icon
	...
	local var_2_25 = var_2_24(var_2_23, var_5(var_1_10006))

	LoadSprite = var_2_23
	var_2_25.sprite = var_2_23(var_2_21)
	...
	CommissionInfoEventItem = var_2_26

	local var_2_28 = var_2_26.New
	local var_2_29 = arg_2_0._tf

	var_2_27[1] = var_2_28(var_5.Find(var_2_29, "frame/main/content/event"), arg_2_0)
	CommissionInfoClassItem = var_4

	local var_2_30 = var_4.New
	local var_2_31 = arg_2_0._tf

	var_2_27[2] = var_2_30(var_5.Find(var_2_31, "frame/main/content/class"), arg_2_0)
	CommissionInfoTechnologyItem = var_4

	local var_2_32 = var_4.New
	local var_2_33 = arg_2_0._tf

	var_2_27[3] = var_2_32(var_5.Find(var_2_33, "frame/main/content/technology"), arg_2_0)
	...
	typeof = var_5
	Text = var_6
	arg_2_0.activtyUrExchangeTxt = var_2_39(var_2_38, var_5(var_6))
	...
	typeof = var_5
	CanvasGroup = var_6
	arg_2_0.activtyUrExchangeCG = var_2_41(var_2_40, var_5(var_6))
	...
	arg_2_0.metaBossBtn = var_2_44(var_4.Find(var_2_45, "frame/link_btns/btns/meta_boss"), arg_2_0.event)
...
function var_0_1.UpdataClassUnlock(arg_5_0)
	...
	var_5_0(arg_5_0.classLockTF, not var_5_1)
...
function var_0_1.UpdateUrItemEntrance(arg_6_0)
	...
	if var_1.isOpenSystem(var_6_0, arg_6_0.playerVO.level, "FragmentShop") then
		LOCK_UR_SHIP = var_6_0

		if not var_6_0 then
			pg = var_6_0

			local var_6_1 = var_6_0.gameset.urpt_chapter_max.description[1]
			local var_6_2 = var_6_0[2]

			getProxy = var_1_10005
			BagProxy = var_1_10006

			local var_6_3 = var_1_10005(var_1_10006)
			...
			NotifyTipHelper = var_9

			var_6_6(var_6_7, var_9.ShouldShowUrTip())
			...
			local function var_6_10()
				...
				var_7_1(var_7_0, var_2_10002.ON_UR_ACTIVITY)
			...
			var_6_6(var_6_8, var_6_9, var_6_10, var_1_10011)
	...
	var_6_0(arg_6_0.activtyUrExchangeBtn, false)
...
function var_0_1.updateCrusingEntrance(arg_8_0)
	...
	if var_8_1(var_8_0, var_1_10003.ACTIVITY_TYPE_PT_CRUSING) and not var_1:isEnd() then
		setActive = var_8_0

		var_8_0(arg_8_0.activityCrusingBtn, true)

		var_8_0 = var_1:GetCrusingInfo()

		local var_8_2 = var_1.stopTime

		pg = var_4

		local var_8_3 = var_4.TimeMgr.GetInstance()
		local var_8_4 = var_8_2 - var_4.GetServerTime(var_8_3)

		math = var_4

		local var_8_5 = var_4.floor(var_8_4 / 0)

		pg = var_5

		if var_8_5 <= var_5.gameset.world_cruise_due_days.key_value then
			setActive = var_5

			local var_8_6 = arg_8_0.activityCrusingBtn

			var_5(var_1_10006.Find(var_8_6, "LastDay"), true)

			setText = var_5

			local var_8_7 = arg_8_0.activityCrusingBtn

			var_1_10006 = var_1_10006.Find(var_8_7, "LastDay/text")
			i18n = var_8_7

			var_5(var_1_10006, var_8_7("guild_left_supply_day", var_8_5))
		else
			setActive = var_5

			local var_8_8 = arg_8_0.activityCrusingBtn

			var_5(var_1_10006.Find(var_8_8, "LastDay"), false)
		end
		...
		var_5(var_1_10006.Find(var_8_9, "Text"), var_8_0.phase .. "/" .. #var_8_0.awardList)

		setActive = var_5

		local var_8_10 = arg_8_0.activityCrusingBtn

		var_5(var_1_10006.Find(var_8_10, "tip"), #var_1:GetCrusingUnreceiveAward() > 0)
	else
		setActive = var_8_0

		var_8_0(arg_8_0.activityCrusingBtn, false)
	end

	onButton = var_8_0

	local var_8_11 = arg_8_0
	local var_8_12 = arg_8_0.activityCrusingBtn
	...
	local function var_8_13()
		...
		var_9_1(var_9_0, var_2_10002.ON_CRUSING)
	...
	var_8_0(var_8_11, var_8_12, var_8_13, var_1_10006)
...
function var_0_1.UpdateLinkPanel(arg_11_0)
	...
	for iter_11_0 = 1, arg_11_0.linkBtnPanel.childCount do
		...
		if var_1_10006(var_7.GetChild(var_11_1, iter_11_0 - 1)) then
			var_11_0 = true
...
function var_0_1.didEnter(arg_12_0)
	...
	local function var_12_2()
		...
		if not var_13_2(var_13_1, var_2_10002.ResOil) then
			pg = var_0
			...
			var_13_4(var_13_3, var_2("player_harvestResource_error_fullBag"))
		...
		var_0.PlayGetResAnimation(var_13_5, arg_12_0.oilbubbleTF, function()
			...
			CommissionInfoMediator = var_3_10002

			var_14_1(var_14_0, var_3_10002.GET_OIL_RES)
	...
	local function var_12_5()
		...
		if not var_15_2(var_15_1, var_2_10002.ResGold) then
			pg = var_0
			...
			var_15_4(var_15_3, var_2("player_harvestResource_error_fullBag"))
		...
		var_0.PlayGetResAnimation(var_15_5, arg_12_0.goldbubbleTF, function()
			...
			var_16_1(var_16_0, var_3_10002.GET_GOLD_RES)
	...
	local function var_12_8()
		...
		if not var_0.CanGetRes(var_17_1) then
			...
			var_17_3(var_17_2, var_2_10002("player_harvestResource_error_fullBag"))
		...
		var_0.PlayGetResAnimation(var_17_4, arg_12_0.classbubbleTF, function()
			...
			var_18_1(var_18_0, var_3_10002.GET_CLASS_RES)
	...
	var_1_10001(var_12_9, var_12_10, var_12_11, var_1_10005)
	...
	local function var_12_14()
		...
		var_21_2(var_21_1, var_2_10003("no_open_system_tip", var_21_0.name, var_21_0.level))
	...
	var_1_10001(var_12_12, var_12_13, var_12_14, var_1_10005)
	arg_12_0:InitItems()
...
function var_0_1.PlayGetResAnimation(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_2 = var_22_1(var_22_0, var_1_10005(var_1_10006))
	...
	local var_22_5 = var_22_4(var_22_3, var_1_10006(var_1_10007))
