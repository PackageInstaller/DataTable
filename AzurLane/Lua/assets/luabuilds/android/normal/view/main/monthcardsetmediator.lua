...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_SET_RATIO, function(arg_2_0, arg_2_1)
		...
		if var_2_1(var_2_0, var_2_10004.MONTH).data ~= arg_2_1 then
			local var_2_2 = arg_1_0

			var_2_3 = var_2_3.sendNotification
			GAME = var_2_10005

			var_2_3(var_2_2, var_2_10005.MONTH_CARD_SET_RATIO, arg_2_1)
		else
			pg = var_2_3
			...
			var_2_5(var_2_4, var_2_10005("month_card_set_ratio_not_change"))
		end
	...
	local var_1_5 = var_1_4(var_1_3, var_5.MONTH)
