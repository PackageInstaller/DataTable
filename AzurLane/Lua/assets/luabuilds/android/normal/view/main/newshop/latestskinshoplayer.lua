...
function var_0_1.init(arg_4_0)
	...
	local var_4_121 = var_2.Find(var_4_120, "panelMask/panel/bottom/ok/Text")

	i18n = var_4_120

	var_1(var_4_121, var_4_120("shop_new_confirm"))
	arg_4_0:Overlay()
...
function var_0_1.GetAllCommodities(arg_21_0)
	...
	if arg_21_0.type == var_0_1.TYPE_NEW_SKIN then
		getProxy = var_1
		ShipSkinProxy = var_21_0
		var_21_0 = var_1(var_21_0)
		arg_21_0.commodities = var_1.GetInTimeSkins(var_21_0)
	elseif arg_21_0.type == var_0_1.TYPE_PERMANANT_SKIN then
		getProxy = var_1
		ShipSkinProxy = var_21_0
		var_21_0 = var_1(var_21_0)
		arg_21_0.commodities = var_1.GetPermanentSkins(var_21_0)
	end
	...
	if var_1 then
		...
		local var_21_1 = var_1.gameset.levellimit_skintype.key_value

		pg = var_21_0

		local var_21_2 = var_21_0.gameset.levellimit_skintype.description

		getProxy = var_1_10003
		PlayerProxy = var_1_10004

		local var_21_3 = var_1_10003(var_1_10004)

		if var_21_1 >= var_3.getData(var_21_3).level then
			_ = var_21_3
			arg_21_0.commodities = var_21_3.filter(arg_21_0.commodities, function(arg_22_0)
				pg = var_2_10001
	...
	if arg_21_0.mode == var_0_1.MODE_OVERVIEW then
		for iter_21_0 = #arg_21_0.commodities, 1, -1 do
			local var_21_4 = arg_21_0.commodities[iter_21_0]
			local var_21_5 = var_5.getConfig(var_21_4, "genre")

			ShopArgs = var_21_4

			if var_21_5 == var_21_4.SkinShopTimeLimit then
				table = var_21_5

				var_21_5.remove(arg_21_0.commodities, iter_21_0)
			end
		end
	end
...
function var_0_1.filterOk(arg_32_0, arg_32_1)
	...
	local var_32_7 = arg_32_1
	local var_32_8 = arg_32_1.getSkinId(var_32_7)

	ShipSkin = var_32_7

	local var_32_9 = var_32_7.New({
		id = var_32_8
	})
	local var_32_10 = var_10.GetDefaultShipConfig(var_32_9)
	...
	if var_32_0 ~= 0 then
		...
		local var_32_13 = var_32_14(var_1_10015)

		var_32_14 = var_32_14.hasSkin(var_32_13, var_32_8)

		local var_32_15 = var_10:NoUse()

		if var_32_0 == 1 and var_32_14 then
			var_32_12 = true
		end

		if var_32_0 == 2 and not var_32_14 then
			var_32_12 = true
		end

		if var_32_0 == 3 and var_32_14 and var_32_15 then
			var_32_12 = true
		end
	...
	if var_32_1[1] ~= 0 then
		...
		for iter_32_0, iter_32_1 in var_32_14(var_32_1) do
			if iter_32_1 == 1 then
				var_1_10020 = var_10

				if not var_10.IsLive2d(var_1_10020) then
					var_1_10020 = var_10

					if var_10.IsLive2dPlus(var_1_10020) then
						var_32_16 = true
					end
					...
					if iter_32_1 == 2 then
						...
						if not var_10.IsLive2d(var_1_10020) then
							...
							if not var_10.IsLive2dPlus(var_1_10020) then
								var_1_10020 = var_10

								if not var_10.IsSpine(var_1_10020) then
									var_1_10020 = var_10

									if not var_10.IsSpinePlus(var_1_10020) then
										var_32_16 = true
									end
								end
							end
					...
					if iter_32_1 == 3 then
						...
						if not var_10.IsSpine(var_1_10020) then
							...
							if var_10.IsSpinePlus(var_1_10020) then
								var_32_16 = true
							end
							...
							if iter_32_1 == 4 then
								...
								if var_10.IsBG(var_1_10020) then
									var_32_16 = true
								end
							end
							...
							if iter_32_1 == 5 then
								...
								if var_10.IsDbg(var_1_10020) then
									var_32_16 = true
								end
							end
							...
							if iter_32_1 == 6 then
								...
								if var_10.isBgm(var_1_10020) then
									var_32_16 = true
								end
							end
	...
	if var_32_2 ~= 0 then
		...
		var_32_14 = var_10:CantUse()

		if var_32_2 == 1 and not var_32_14 then
			var_32_17 = true
		end

		if var_32_2 == 2 and var_32_14 then
			var_32_17 = true
		end
	...
	if var_32_3[1] ~= 0 then
		...
		for iter_32_2, iter_32_3 in var_32_14(var_32_3) do
			...
			for iter_32_4, iter_32_5 in var_1_10020(var_1_10019[iter_32_3 + 1].types) do
				...
				if iter_32_5 == var_1_10025.LINK then
					local var_32_19 = var_32_11

					var_1_10025 = var_32_11.getNation(var_32_19)
					Nation = var_32_19

					if var_1_10025 >= var_32_19.LINK then
						var_32_18 = true
					end
	...
	if var_32_4[1] ~= 0 then
		...
		for iter_32_6, iter_32_7 in var_32_14(var_32_4) do
			ShipIndexCfg = var_1_10019
	...
	if var_32_5[1] ~= 0 then
		...
		for iter_32_8, iter_32_9 in var_32_14(var_32_5) do
			ShipIndexCfg = var_1_10019

			local var_32_22 = var_1_10019.type[iter_32_9 + 1].types
			local var_32_23

			if iter_32_9 + 1 < 4 then
				var_32_23 = var_1_10019[iter_32_9].shipTypes
				table = var_22

				if var_22.contains(var_32_22, var_32_11:getShipType()) then
					var_32_21 = true
				end

				table = var_22

				if var_22.contains(var_32_22, var_32_11:getTeamType()) then
					var_32_21 = true
				end
			else
				table = var_32_23

				if var_32_23.contains(var_32_22, var_32_11:getShipType()) then
					var_32_21 = true
				end
			end
	...
	if var_32_6[1] ~= 0 then
		local var_32_24 = false

		ipairs = var_32_14

		for iter_32_10, iter_32_11 in var_32_14(var_32_6) do
			local var_32_25 = arg_32_0.classifyIds[iter_32_11 + 1]
			local var_32_26 = arg_32_1
			local var_32_27 = arg_32_1.getConfig(var_32_26, "genre")

			ShopArgs = var_32_26

			if var_32_27 == var_32_26.SkinShopTimeLimit then
				if arg_32_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
					var_32_24 = var_32_25 == var_0_16 and arg_32_0:ExitSkinExperienceItem(arg_32_1.id)
				else
					var_32_24 = var_32_25 == var_0_14
				end
			elseif var_32_25 == var_0_13 then
				var_32_24 = true
			else
				if var_32_25 == var_0_15 then
					table = var_20
...
function var_0_1.SetFilterPanel(arg_127_0)
	...
	var_127_15(var_127_14, var_127_16, var_1_10011.CampNames, true)
	...
	var_127_18(var_127_17, var_127_19, var_11.RarityNames, true)
	...
	var_127_21(var_127_20, var_127_22, var_11.TypeNames, true)
	...
	local var_127_25 = var_10.Find(var_127_24, "bg")
	...
	var_8(var_127_23, var_127_25, var_127_26, var_12)

	onButton = var_8

	local var_127_27 = arg_127_0
	local var_127_28 = arg_127_0.filterUI
	local var_127_29 = var_10.Find(var_127_28, "panelMask/panel/closeBtn")
	...
	var_8(var_127_27, var_127_29, var_127_30, var_12)

	onButton = var_8

	local var_127_31 = arg_127_0
	local var_127_32 = arg_127_0.filterUI
	local var_127_33 = var_10.Find(var_127_32, "panelMask/panel/bottom/ok")
	...
	var_8(var_127_31, var_127_33, var_127_34, var_12)
			...
			local function var_136_7()
				...
				if iter_136_0 == 0 then
					...
					for iter_137_2 = 0, arg_136_1.childCount - 1 do
						...
						local var_137_7 = var_7.GetChild(var_137_6, iter_137_2)

						table = var_137_6

						var_137_5(var_137_4, var_137_7, var_137_6.contains(arg_136_0.filterValuesTemp[arg_136_2], iter_137_2))
					end
				end
...
function var_0_1.GetSkinClassify(arg_139_0)
	...
	for iter_139_0, iter_139_1 in var_1_10003(arg_139_0.commodities) do
		...
		local var_139_3 = arg_139_0.GetShopTypeIdBySkinId

		var_1_10011 = iter_139_1

		local var_139_4

		if var_139_3(var_139_2, iter_139_1.getSkinId(var_1_10011)) ~= 0 or not var_0_17 then
			var_139_4 = var_8
		end

		local var_139_5

		if not var_139_1[var_139_4] then
			var_139_5 = 0
		end

		var_139_1[var_139_4] = var_139_5 + 1
	end
	...
	for iter_139_2, iter_139_3 in var_4(arg_139_0.returnSkins) do
		var_139_6[iter_139_3] = true
	end

	underscore = var_4

	if var_4.any(arg_139_0.commodities, function(arg_140_0)
		return var_139_6[arg_140_0.id]
	end) then
		table = var_4
	...
	for iter_139_4, iter_139_5 in var_4(var_5.skin_page_template.all) do
		if iter_139_5 ~= var_0_18 and iter_139_5 ~= var_0_19 then
			...
			if var_139_7 > 0 then
				...
				var_139_7.insert(var_139_0, iter_139_5)
			end
		end
	end
	...
	for iter_139_6, iter_139_7 in var_4(arg_139_0.classifyIds) do
		if iter_139_7 == var_0_13 then
			...
			var_139_8(var_139_9, var_1_10011("shop_filter_all"))
		elseif iter_139_7 == var_0_14 or iter_139_7 == var_0_16 then
			table = var_9

			local var_139_10 = var_9.insert
			local var_139_11 = arg_139_0.classifyNames

			i18n = var_1_10011

			var_139_10(var_139_11, var_1_10011("shop_filter_trial"))
		else
			local var_139_12

			if iter_139_7 == var_0_15 then
				table = var_139_12
				var_139_12 = var_139_12.insert

				local var_139_13 = arg_139_0.classifyNames

				i18n = var_1_10011

				var_139_12(var_139_13, var_1_10011("shop_filter_retro"))
			else
				table = var_139_12

				local var_139_14 = var_139_12.insert
				local var_139_15 = arg_139_0.classifyNames

				pg = var_1_10011

				var_139_14(var_139_15, var_1_10011.skin_page_template[iter_139_7].name)
			end
		end
	end
...
function var_0_1.onBackPressed(arg_146_0)
	...
	var_146_1(var_146_0, var_1_10003.CLOSE_VIEW)
