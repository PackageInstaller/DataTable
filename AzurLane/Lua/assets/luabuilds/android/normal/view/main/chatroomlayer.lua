...
function var_0_1.didEnter(arg_7_0)
	...
	local function var_7_4()
		...
		ChatRoomMediator = var_2_10003

		local var_8_3 = var_2_10003.OPEN_EMOJI

		Vector3 = var_2_10004

		var_8_2(var_8_1, var_8_3, var_2_10004(var_8_0.x, var_8_0.y, 0), function(arg_9_0)
			...
			var_9_1(var_9_0, var_9_2(var_3_10004.EmojiCode, "code", arg_9_0))
	...
	var_7_0(var_7_2, var_7_3, var_7_4, var_1_10006)
	...
	var_7_0(var_7_5, var_7_6, var_7_7, var_1_10006)
	...
	var_7_0(var_7_8, var_7_9, var_7_10, var_1_10006)
	arg_7_0:initFriends()
...
function var_0_1.createFriendItem(arg_15_0, arg_15_1)
	...
	typeof = var_5
	Text = var_1_10006
	var_15_0.nameTF = var_15_3(var_15_2, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	var_15_0.iconTF = var_15_6(var_15_5, var_5(var_1_10006))
	...
	typeof = var_5
	Toggle = var_1_10006
	var_15_0.toggle = var_15_9(var_15_8, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	var_15_0.dateTF = var_15_13(var_15_12, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	var_15_0.levelTF = var_15_17(var_15_16, var_5(var_1_10006))
	...
	function var_15_0.update(arg_16_0, arg_16_1, arg_16_2)
		...
		local var_16_3 = "qicon/"
		local var_16_4 = var_16_2

		var_5(var_16_3 .. var_16_2.getPainting(var_16_4), function(arg_17_0)
		...
		local var_16_5 = var_5.attireFrameRes
		...
		local var_16_8 = var_16_4(var_2_10009)
		local var_16_9 = var_16_7 == var_8.getRawData(var_16_8).id

		AttireConst = var_8

		local var_16_10 = var_16_5(var_16_6, var_16_9, var_8.TYPE_ICON_FRAME, arg_16_1.propose)

		PoolMgr = var_16_6

		local var_16_11 = var_16_6.GetInstance()

		var_6.GetPrefab(var_16_11, "IconFrame/" .. var_16_10, var_16_10, true, function(arg_18_0)
			if arg_16_0.circle then
				arg_18_0.name = var_16_10
				findTF = var_1
				...
				typeof = var_3_10004
				Image = var_3_10005
				var_18_1(var_18_0, var_3_10004(var_3_10005)).raycastTarget = false
				setParent = var_3
				...
				var_1.ReturnPrefab(var_18_2, "IconFrame/" .. var_16_10, var_16_10, arg_18_0)
			end
		...
		local var_16_12 = arg_16_0.onlineTF
		local var_16_13 = arg_16_1.online

		Friend = var_9

		var_6(var_16_12, var_16_13 == var_9.ONLINE)

		setActive = var_6

		local var_16_14 = var_15_0.dateTF
		local var_16_15 = arg_16_1.online

		Friend = var_9

		var_6(var_16_14, var_16_15 == var_9.OFFLINE)

		local var_16_16 = var_15_0.dateTF

		pg = var_16_14

		local var_16_17 = var_16_14.TimeMgr.GetInstance()

		var_16_16.text = var_7.STimeDescC(var_16_17, arg_16_1.preOnLineTime, "%Y/%m/%d")
	...
	function var_15_0.clear(arg_19_0)
		if arg_19_0.circle.childCount > 0 then
			local var_19_0 = arg_19_0.circle
			local var_19_1 = var_1.GetChild(var_19_0, 0).gameObject

			PoolMgr = var_19_0

			local var_19_2 = var_19_0.GetInstance()

			var_2.ReturnPrefab(var_19_2, "IconFrame/" .. var_19_1.name, var_19_1.name, var_19_1)
		end
...
function var_0_1.initFriend(arg_22_0, arg_22_1)
	...
	local var_22_1 = arg_22_0.createFriendItem(var_22_0, arg_22_1)

	onToggle = var_22_0

	var_22_0(arg_22_0, var_22_1.tf, function(arg_23_0)
		if arg_23_0 and var_22_1.friendVO then
			local var_23_0 = arg_22_0

			var_1.openChatPanel(var_23_0, var_22_1.friendVO)

			arg_22_0.contextData.friendVO = var_22_1.friendVO

			local var_23_1 = arg_22_0

			var_1.setFriendVO(var_23_1, var_22_1.friendVO)

			local var_23_2 = arg_22_0
			local var_23_3 = var_1.emit

			ChatRoomMediator = var_3

			var_23_3(var_23_2, var_3.CLEAR_UNREADCOUNT, var_22_1.friendVO.id)
		end

		return
	end)

	arg_22_0.friendItems[arg_22_1] = var_22_1
...
function var_0_1.sendMessage(arg_29_0, arg_29_1)
	if arg_29_1 == "" then
		...
		var_29_1(var_29_0, var_1_10004("friend_send_msg_null_tip"))
	...
	ChatRoomMediator = var_1_10004

	var_29_3(var_29_2, var_1_10004.SEND_FRIEND_MSG, arg_29_0.friendVO.id, arg_29_1)
...
function var_0_1.appendMsg(arg_31_0, arg_31_1)
	...
	var_31_1(var_31_0, var_1_10004.CLEAR_UNREADCOUNT, arg_31_0.friendVO.id)
	...
	if arg_31_1.playerId == arg_31_0.playerVO.id then
		...
		setmetatable = var_4
		Clone = var_5
		arg_31_1.player = var_4(var_5(arg_31_0.playerVO), {
			__index = var_31_3
		})
...
function var_0_1.willExit(arg_33_0)
	...
	var_1(arg_33_0.chatsContainer, function(arg_34_0)
		if arg_34_0:Find("face").childCount > 0 then
			local var_34_0 = var_1
			local var_34_1 = var_1.GetChild(var_34_0, 0).gameObject

			PoolMgr = var_34_0

			local var_34_2 = var_34_0.GetInstance()
...
function var_0_1.insertEmojiToInputText(arg_35_0, arg_35_1)
	...
	getInputText = var_1_10004

	local var_35_1 = var_1_10004(arg_35_0.inputTF)

	string = var_5

	local var_35_2 = var_5.gsub

	ChatConst = var_1_10006

	var_1_10002(var_35_0, var_35_1 .. var_35_2(var_1_10006.EmojiIconCode, "code", arg_35_1))
