...
function var_0_1.initToggleList(arg_10_0)
	...
	var_3.make(var_10_4, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventInit then
			...
			local var_11_2 = arg_11_2.Find(var_11_1, "selected/Label")

			i18n = var_11_1
			ShopConst = var_2_10007

			var_4(var_11_2, var_11_1(var_2_10007.TYPE2NAME[var_11_0]))

			setText = var_4

			local var_11_3 = arg_11_2
			local var_11_4 = arg_11_2.Find(var_11_3, "selected/enText")

			i18n = var_11_3
			ShopConst = var_2_10007

			var_4(var_11_4, var_11_3(var_2_10007.TYPE2NAME[var_11_0] .. "en"))

			setText = var_4

			local var_11_5 = arg_11_2
			local var_11_6 = arg_11_2.Find(var_11_5, "unselected/Label")

			i18n = var_11_5
			ShopConst = var_2_10007

			var_4(var_11_6, var_11_5(var_2_10007.TYPE2NAME[var_11_0]))

			local var_11_7 = arg_10_0.packageSortList[arg_11_1 + 1].index
			local var_11_8 = arg_10_0.allShopList[var_11_0][1]
			local var_11_9 = arg_10_0.pages[var_11_0]
			local var_11_10

			var_2_10007, var_11_10 = var_6.CanOpen(var_11_9, var_11_8, arg_10_0.player)

			if var_2_10007 == false then
				setActive = var_9

				var_9(arg_11_2:Find("unselected/Label/lock"), true)
			else
				setActive = var_9

				var_9(arg_11_2:Find("unselected/Label/lock"), false)
			end

			setActive = var_9

			var_9(arg_11_2:Find("unselected"), true)

			setActive = var_9

			var_9(arg_11_2:Find("selected"), false)
		else
			UIItemList = var_11_0
			...
			if arg_11_0 == var_11_0.EventUpdate then
				...
				var_3(var_11_11, var_11_12, var_11_13, var_2_10007)
			end
		end
