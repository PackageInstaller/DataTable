...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.DO_PAY, function(arg_2_0)
		...
		local var_2_4 = var_2_10004.ACTIVITY_OPERATION
		local var_2_5 = {
			cmd = 1,
		...
		local var_2_6 = var_6.New
		local var_2_7 = {}

		DROP_TYPE_RESOURCE = var_2_10008
		var_2_7.type = var_2_10008
		PlayerConst = var_2_10008
		var_2_7.id = var_2_10008.ResDiamond
		GiftActCommodity = var_8
		var_2_7.count = var_8.CalcPrice(var_2_1)
	...
	arg_1_0:bind(var_0_1.GO_SHOP, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_3_2, var_2_10005.SKINSHOP)
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.ACTIVITY_OPERATION_DONE and var_5_2 == arg_5_0.contextData.actId then
