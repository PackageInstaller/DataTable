...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.finishedCounter = var_1_9(var_1_8, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.ongoingCounter = var_1_12(var_1_11, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.leisureCounter = var_1_15(var_1_14, var_5(var_1_10006))
	...
	UIItemList = var_1_17
	arg_1_0.uilist = var_1_17.New(var_3, var_1_18)
	setActive = var_5
	...
	local var_1_19 = var_5(var_6)

	if var_5.IsMellowStyle(var_1_19) then
		setText = var_5

		local var_1_20 = arg_1_0.goBtn
		local var_1_21 = var_6.Find(var_1_20, "Image")

		i18n = var_1_20

		var_5(var_1_21, var_1_20("commission_label_go_mellow"))

		setText = var_5

		local var_1_22 = arg_1_0.finishedBtn
		local var_1_23 = var_6.Find(var_1_22, "Image")

		i18n = var_1_22

		var_5(var_1_23, var_1_22("commission_label_finish_mellow"))

		setText = var_5

		local var_1_24 = var_1_18
		local var_1_25 = var_1_18.Find(var_1_24, "unlock/leisure/go_btn/Image")

		i18n = var_1_24

		var_5(var_1_25, var_1_24("commission_label_go_mellow"))

		setText = var_5

		local var_1_26 = var_1_18
		local var_1_27 = var_1_18.Find(var_1_26, "unlock/finished/finish_btn/Image")

		i18n = var_1_26

		var_5(var_1_27, var_1_26("commission_label_finish_mellow"))
	else
		setText = var_5

		local var_1_28 = arg_1_0.goBtn
		local var_1_29 = var_6.Find(var_1_28, "Image")

		i18n = var_1_28

		var_5(var_1_29, var_1_28("commission_label_go"))

		setText = var_5

		local var_1_30 = arg_1_0.finishedBtn
		local var_1_31 = var_6.Find(var_1_30, "Image")

		i18n = var_1_30

		var_5(var_1_31, var_1_30("commission_label_finish"))

		setText = var_5

		local var_1_32 = var_1_18
		local var_1_33 = var_1_18.Find(var_1_32, "unlock/leisure/go_btn/Image")

		i18n = var_1_32

		var_5(var_1_33, var_1_32("commission_label_go"))

		setText = var_5

		local var_1_34 = var_1_18
		local var_1_35 = var_1_18.Find(var_1_34, "unlock/finished/finish_btn/Image")

		i18n = var_1_34

		var_5(var_1_35, var_1_34("commission_label_finish"))
	end
...
function var_0_0.Init(arg_2_0)
	...
	local function var_2_2(arg_3_0)
		...
		if not var_3_2 then
			...
			local var_3_4 = var_3.TipsMgr.GetInstance()
...
function var_0_0.Adpater(arg_7_0)
	...
	local var_7_1 = var_1_10002(var_7_0, var_1_10004.abs(arg_7_0._tf.localPosition.y), 0)
