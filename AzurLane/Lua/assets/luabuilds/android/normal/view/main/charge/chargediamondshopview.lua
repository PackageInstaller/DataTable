...
function var_0_1.initData(arg_4_0)
	...
	if var_1_10001 ~= var_1_10002 then
		...
		if var_1_10001 == var_1_10002 then
			...
			var_4_0 = var_1.CheckAudit(var_1_10002)
		else
			var_4_0 = false
		end
		...
		local var_4_1 = var_1(var_1_10002)
...
function var_0_1.initUIItemList(arg_6_0)
	...
	var_1.make(var_6_0, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_1 = var_7_0(var_2_10004(arg_7_2), arg_6_0.monthCardTF, arg_6_0)
			...
			var_5(var_7_3, var_7_4, var_7_5, var_9)
		end
...
function var_0_1.confirm(arg_11_0, arg_11_1)
	...
	if arg_11_1.isChargeType(var_11_0) then
		...
		local var_11_1 = not var_2.contains(arg_11_0.firstChargeIds, arg_11_1.id) and arg_11_1:firstPayDouble() and 4 or arg_11_1:getConfig("tag")

		var_1_10006 = arg_11_1

		if not arg_11_1.isMonthCard(var_1_10006) then
			var_1_10006 = arg_11_1

			if not arg_11_1.isGiftBox(var_1_10006) then
				var_1_10006 = arg_11_1

				if not arg_11_1.isItemBox(var_1_10006) then
					var_1_10006 = arg_11_1

					if arg_11_1.isPassItem(var_1_10006) then
						var_1_10006 = arg_11_1

						local var_11_2 = arg_11_1.GetExtraServiceItem(var_1_10006)

						var_1_10006 = arg_11_1:GetExtraDrop()
						...
						if arg_11_1.isPassItem(var_1_10011) then
							i18n = var_10
							var_11_4 = var_10("battlepass_pay_tip")
						else
							var_1_10011 = arg_11_1

							if arg_11_1.isMonthCard(var_1_10011) then
								i18n = var_10
						...
						local var_11_6 = {
							...
							onYes = function()
								...
								if var_2_10000.isNeedSetBirth() then
									...
									var_12_1(var_12_0, var_2_10002.OPEN_CHARGE_BIRTHDAY)
								else
									...
									var_12_3(var_12_2, var_2_10002.CHARGE, arg_11_1.id)
								end
						...
						NewShopMainMediator = var_13

						var_1_10011(var_11_7, var_13.OPEN_CHARGE_ITEM_PANEL, var_11_6)
					else
						var_1_10006 = arg_11_1

						if arg_11_1.isGem(var_1_10006) then
							var_1_10006 = arg_11_1

							local var_11_8 = arg_11_1.getConfig(var_1_10006, "money")

							var_1_10006 = arg_11_1:getConfig("gem")

							if var_3 then
								var_1_10006 = var_1_10006 + arg_11_1:getConfig("gem")
							else
								var_1_10006 = var_1_10006 + arg_11_1:getConfig("extra_gem")
							end
							...
							i18n = var_8
							var_11_9.normalTip = var_8("charge_start_tip", var_11_8, var_1_10006)

							function var_11_9.onYes()
								ChargeConst = var_2_10000
								...
								if var_2_10000.isNeedSetBirth() then
									...
									var_13_3(var_13_2, var_2_10002.CHARGE, arg_11_1.id)
								end
							...
							local var_11_11 = arg_11_0.emit

							NewShopMainMediator = var_10

							var_11_11(var_11_10, var_10.OPEN_CHARGE_ITEM_BOX, var_11_9)
						end
					end
					...
					do
						...
						local var_11_14 = arg_11_1.getConfig(var_11_13, "effect_args")

						Item = var_11_13

						local var_11_15 = var_11_13.getConfigData(var_11_14[1]).display_icon

						type = var_1_10006

						if var_1_10006(var_11_15) == "table" then
							ipairs = var_6

							for iter_11_0, iter_11_1 in var_6(var_11_15) do
								table = var_1_10011

								var_1_10011.insert(var_11_12, {
									type = iter_11_1[1],
									id = iter_11_1[2],
									count = iter_11_1[3]
								})
						...
						i18n = var_7
						var_11_16.tipExtra = var_7("charge_title_getitem")
						var_11_16.extraItems = var_11_12
						var_11_16.price = arg_11_1:getConfig("resource_num")
						var_11_16.tagType = arg_11_1:getConfig("tag")

						function var_11_16.onYes()
							pg = var_2_10000
							...
							var_14_2.content = var_2_10003(var_14_3, var_5.getConfig(var_14_4, "resource_num"), var_0.name)
							...
							function var_14_2.onYes()
								...
								var_15_1(var_15_0, var_3_10002.BUY_ITEM, arg_11_1.id, 1)
						...
						local var_11_18 = arg_11_0.emit

						NewShopMainMediator = var_9

						var_11_18(var_11_17, var_9.OPEN_CHARGE_ITEM_PANEL, var_11_16)
					end
		...
		if var_16_1 ~= var_9.MONTH_CARD then
			...
			if var_16_1 ~= var_9.GEM then
				...
				if var_16_1 == var_9.GIFT_BOX then
					...
					local var_16_5 = var_16_3(var_16_4, var_11.TYPE_CHARGE)

					table = var_16_4

					var_16_4.insert(arg_16_0.diamondGoodsVOList, var_16_5)
				end
	...
	var_17_0(var_17_1, var_3({
		...
		function(arg_19_0)
			if arg_19_0:isChargeType() and arg_19_0:isMonthCard() then
				...
				if var_19_1(var_19_0, var_2_10003.MONTH) then
					local var_19_2 = var_1
					local var_19_3 = var_1.getLeftDate(var_19_2)

					pg = var_19_2

					local var_19_4 = var_19_2.TimeMgr.GetInstance()
					local var_19_5 = var_3.GetServerTime(var_19_4)

					math = var_19_4

					local var_19_6 = var_19_4.floor((var_19_3 - var_19_5) / 0)
					local var_19_7
