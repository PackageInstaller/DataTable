...
function var_0_1.Show(arg_6_0, arg_6_1, arg_6_2)
	...
	var_6_2(var_6_1, var_5(var_1_10006)).verticalNormalizedPosition = 1
...
function var_0_1.UpdateLayout(arg_7_0, arg_7_1)
	...
	local var_7_1 = var_3.MiddleCenter
	...
	local var_7_4 = var_7_3(var_7_2, var_1_10006(var_1_10007)).preferredWidth

	setAnchoredPosition = var_7_2

	var_7_2(arg_7_0.textTr, {
