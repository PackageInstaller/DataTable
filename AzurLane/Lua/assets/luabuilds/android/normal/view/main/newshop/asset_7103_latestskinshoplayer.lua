...
function var_0_1.init(arg_4_0)
	...
	local var_4_30 = var_2.Find(var_4_29, "right/functionsAndTags/tags")
	local var_4_31 = arg_4_0.adapt

	arg_4_0.tagList = var_4_28(var_4_30, var_3.Find(var_4_31, "right/functionsAndTags/tags/tag"))
	...
	Vector3 = var_3
	arg_4_0.interactionPreview = var_4_46(var_4_47, var_3(0, 0, 0))
	...
	var_1(var_2.Find(var_4_49, "yigoumai_button"), true, true)

	setText = var_1

	local var_4_50 = arg_4_0._tf
	local var_4_51 = var_2.Find(var_4_50, "bgs/empty/Text")

	i18n = var_4_50

	var_1(var_4_51, var_4_50("shop_new_unfound"))

	setText = var_1

	local var_4_52 = arg_4_0.adapt
	local var_4_53 = var_2.Find(var_4_52, "top/mainTitle/Text")

	i18n = var_4_52

	var_1(var_4_53, var_4_52("shop_new_shop"))

	setText = var_1

	local var_4_54 = arg_4_0.filterBtn
	local var_4_55 = var_2.Find(var_4_54, "Text")

	i18n = var_4_54

	var_1(var_4_55, var_4_54("shop_new_sort"))

	setText = var_1

	local var_4_56 = arg_4_0.search
	local var_4_57 = var_2.Find(var_4_56, "holder")

	i18n = var_4_56

	var_1(var_4_57, var_4_56("shop_new_search"))

	setText = var_1

	local var_4_58 = arg_4_0.btns
	local var_4_59 = var_2.Find(var_4_58, "yigoumai_button/Text")

	i18n = var_4_58

	var_1(var_4_59, var_4_58("shop_new_purchased"))

	setText = var_1

	local var_4_60 = arg_4_0.btns
	local var_4_61 = var_2.Find(var_4_60, "goumai_button/Text")

	i18n = var_4_60

	var_1(var_4_61, var_4_60("shop_new_purchase"))

	setText = var_1

	local var_4_62 = arg_4_0.btns
	local var_4_63 = var_2.Find(var_4_62, "qianwanghuoqu_button/Text")

	i18n = var_4_62

	var_1(var_4_63, var_4_62("shop_new_claim"))

	setText = var_1

	local var_4_64 = arg_4_0.btns
	local var_4_65 = var_2.Find(var_4_64, "furniture_shop/Text")

	i18n = var_4_64

	var_1(var_4_65, var_4_64("shop_new_furniture"))

	setText = var_1

	local var_4_66 = arg_4_0.btns
	local var_4_67 = var_2.Find(var_4_66, "item_buy/Text")

	i18n = var_4_66

	var_1(var_4_67, var_4_66("shop_new_discount"))

	setText = var_1

	local var_4_68 = arg_4_0.btns
	local var_4_69 = var_2.Find(var_4_68, "tiyan_btn/Text")

	i18n = var_4_68

	var_1(var_4_69, var_4_68("shop_new_try"))

	setText = var_1

	local var_4_70 = arg_4_0.btns
	local var_4_71 = var_2.Find(var_4_70, "buy_with_gift/Text")

	i18n = var_4_70

	var_1(var_4_71, var_4_70("shop_new_purchase"))

	setText = var_1

	local var_4_72 = arg_4_0.price
	local var_4_73 = var_2.Find(var_4_72, "btn/tag/Text")

	i18n = var_4_72

	var_1(var_4_73, var_4_72("shop_new_gift"))

	setText = var_1

	local var_4_74 = arg_4_0.giftPack
	local var_4_75 = var_2.Find(var_4_74, "panel/desc")

	i18n = var_4_74

	var_1(var_4_75, var_4_74("shop_new_gem_transform"))

	setText = var_1

	local var_4_76 = arg_4_0.giftPack
	local var_4_77 = var_2.Find(var_4_76, "price/btns/yigoumai_button/Text")

	i18n = var_4_76

	var_1(var_4_77, var_4_76("shop_new_purchased"))

	setText = var_1

	local var_4_78 = arg_4_0.filterUI
	local var_4_79 = var_2.Find(var_4_78, "panelMask/panel/title")

	i18n = var_4_78

	var_1(var_4_79, var_4_78("shop_new_sort"))

	setText = var_1

	local var_4_80 = arg_4_0.filterUI
	local var_4_81 = var_2.Find(var_4_80, "panelMask/panel/filterScroll/Viewport/Content/own/subTitleFrame/subTitle")

	i18n = var_4_80

	var_1(var_4_81, var_4_80("shop_new_review"))

	setText = var_1

	local var_4_82 = arg_4_0.filterUI
	local var_4_83 = var_2.Find(var_4_82, "panelMask/panel/filterScroll/Viewport/Content/own/options/0/Text")

	i18n = var_4_82

	var_1(var_4_83, var_4_82("shop_new_all"))

	setText = var_1

	local var_4_84 = arg_4_0.filterUI
	local var_4_85 = var_2.Find(var_4_84, "panelMask/panel/filterScroll/Viewport/Content/own/options/1/Text")

	i18n = var_4_84

	var_1(var_4_85, var_4_84("shop_new_owned"))

	setText = var_1

	local var_4_86 = arg_4_0.filterUI
	local var_4_87 = var_2.Find(var_4_86, "panelMask/panel/filterScroll/Viewport/Content/own/options/2/Text")

	i18n = var_4_86

	var_1(var_4_87, var_4_86("shop_new_havent_own"))

	setScrollText = var_1

	local var_4_88 = arg_4_0.filterUI
	local var_4_89 = var_2.Find(var_4_88, "panelMask/panel/filterScroll/Viewport/Content/own/options/3/mask/Text")

	i18n = var_4_88

	var_1(var_4_89, var_4_88("shop_new_unused"))

	setText = var_1

	local var_4_90 = arg_4_0.filterUI
	local var_4_91 = var_2.Find(var_4_90, "panelMask/panel/filterScroll/Viewport/Content/type/subTitleFrame/subTitle")

	i18n = var_4_90

	var_1(var_4_91, var_4_90("shop_new_type"))

	setText = var_1

	local var_4_92 = arg_4_0.filterUI
	local var_4_93 = var_2.Find(var_4_92, "panelMask/panel/filterScroll/Viewport/Content/type/options/0/Text")

	i18n = var_4_92

	var_1(var_4_93, var_4_92("shop_new_all"))

	setText = var_1

	local var_4_94 = arg_4_0.filterUI
	local var_4_95 = var_2.Find(var_4_94, "panelMask/panel/filterScroll/Viewport/Content/type/options/2/Text")

	i18n = var_4_94

	var_1(var_4_95, var_4_94("shop_new_static"))

	setText = var_1

	local var_4_96 = arg_4_0.filterUI
	local var_4_97 = var_2.Find(var_4_96, "panelMask/panel/filterScroll/Viewport/Content/type/options/3/Text")

	i18n = var_4_96

	var_1(var_4_97, var_4_96("shop_new_dynamic"))

	setText = var_1

	local var_4_98 = arg_4_0.filterUI
	local var_4_99 = var_2.Find(var_4_98, "panelMask/panel/filterScroll/Viewport/Content/type/options/4/Text")

	i18n = var_4_98

	var_1(var_4_99, var_4_98("shop_new_static_bg"))

	setText = var_1

	local var_4_100 = arg_4_0.filterUI
	local var_4_101 = var_2.Find(var_4_100, "panelMask/panel/filterScroll/Viewport/Content/type/options/5/Text")

	i18n = var_4_100

	var_1(var_4_101, var_4_100("shop_new_dynamic_bg"))

	setText = var_1

	local var_4_102 = arg_4_0.filterUI
	local var_4_103 = var_2.Find(var_4_102, "panelMask/panel/filterScroll/Viewport/Content/type/options/6/Text")

	i18n = var_4_102

	var_1(var_4_103, var_4_102("shop_new_bgm"))

	setText = var_1

	local var_4_104 = arg_4_0.filterUI
	local var_4_105 = var_2.Find(var_4_104, "panelMask/panel/filterScroll/Viewport/Content/shipHave/subTitleFrame/subTitle")

	i18n = var_4_104

	var_1(var_4_105, var_4_104("shop_new_index"))

	setText = var_1

	local var_4_106 = arg_4_0.filterUI
	local var_4_107 = var_2.Find(var_4_106, "panelMask/panel/filterScroll/Viewport/Content/shipHave/options/0/Text")

	i18n = var_4_106

	var_1(var_4_107, var_4_106("shop_new_all"))

	setText = var_1

	local var_4_108 = arg_4_0.filterUI
	local var_4_109 = var_2.Find(var_4_108, "panelMask/panel/filterScroll/Viewport/Content/shipHave/options/1/Text")

	i18n = var_4_108

	var_1(var_4_109, var_4_108("shop_new_ship_owned"))

	setText = var_1

	local var_4_110 = arg_4_0.filterUI
	local var_4_111 = var_2.Find(var_4_110, "panelMask/panel/filterScroll/Viewport/Content/shipHave/options/2/Text")

	i18n = var_4_110

	var_1(var_4_111, var_4_110("shop_new_ship_havent_owned"))

	setText = var_1

	local var_4_112 = arg_4_0.filterUI
	local var_4_113 = var_2.Find(var_4_112, "panelMask/panel/filterScroll/Viewport/Content/camp/subTitleFrame/subTitle")

	i18n = var_4_112

	var_1(var_4_113, var_4_112("shop_new_nation"))

	setText = var_1

	local var_4_114 = arg_4_0.filterUI
	local var_4_115 = var_2.Find(var_4_114, "panelMask/panel/filterScroll/Viewport/Content/rarity/subTitleFrame/subTitle")

	i18n = var_4_114

	var_1(var_4_115, var_4_114("shop_new_rarity"))

	setText = var_1

	local var_4_116 = arg_4_0.filterUI
	local var_4_117 = var_2.Find(var_4_116, "panelMask/panel/filterScroll/Viewport/Content/shipType/subTitleFrame/subTitle")

	i18n = var_4_116

	var_1(var_4_117, var_4_116("shop_new_category"))

	setText = var_1

	local var_4_118 = arg_4_0.filterUI
	local var_4_119 = var_2.Find(var_4_118, "panelMask/panel/filterScroll/Viewport/Content/themeType/subTitleFrame/subTitle")

	i18n = var_4_118

	var_1(var_4_119, var_4_118("shop_new_skin_theme"))

	setText = var_1

	local var_4_120 = arg_4_0.filterUI
	local var_4_121 = var_2.Find(var_4_120, "panelMask/panel/filterScroll/Viewport/Content/tag/subTitleFrame/subTitle")

	i18n = var_4_120

	var_1(var_4_121, var_4_120("skin_shop_tag"))

	setText = var_1

	local var_4_122 = arg_4_0.filterUI
	local var_4_123 = var_2.Find(var_4_122, "panelMask/panel/filterScroll/Viewport/Content/tag/options/0/Text")

	i18n = var_4_122

	var_1(var_4_123, var_4_122("skin_shop_tag_0"))

	setText = var_1

	local var_4_124 = arg_4_0.filterUI
	local var_4_125 = var_2.Find(var_4_124, "panelMask/panel/filterScroll/Viewport/Content/tag/options/1/Text")

	i18n = var_4_124

	var_1(var_4_125, var_4_124("skin_shop_tag_1"))

	setText = var_1

	local var_4_126 = arg_4_0.filterUI
	local var_4_127 = var_2.Find(var_4_126, "panelMask/panel/filterScroll/Viewport/Content/tag/options/2/Text")

	i18n = var_4_126

	var_1(var_4_127, var_4_126("skin_shop_tag_2"))

	setText = var_1

	local var_4_128 = arg_4_0.filterUI
	local var_4_129 = var_2.Find(var_4_128, "panelMask/panel/filterScroll/Viewport/Content/tag/options/3/Text")

	i18n = var_4_128

	var_1(var_4_129, var_4_128("skin_shop_tag_3"))

	setText = var_1

	local var_4_130 = arg_4_0.filterUI
	local var_4_131 = var_2.Find(var_4_130, "panelMask/panel/filterScroll/Viewport/Content/tag/options/4/Text")

	i18n = var_4_130

	var_1(var_4_131, var_4_130("skin_shop_tag_4"))

	setText = var_1

	local var_4_132 = arg_4_0.filterUI
	local var_4_133 = var_2.Find(var_4_132, "panelMask/panel/filterScroll/Viewport/Content/tag/options/5/Text")

	i18n = var_4_132

	var_1(var_4_133, var_4_132("skin_shop_tag_5"))

	setText = var_1

	local var_4_134 = arg_4_0.filterUI
	local var_4_135 = var_2.Find(var_4_134, "panelMask/panel/filterScroll/Viewport/Content/tag/options/6/Text")

	i18n = var_4_134

	var_1(var_4_135, var_4_134("skin_shop_tag_6"))

	setText = var_1

	local var_4_136 = arg_4_0.filterUI
	local var_4_137 = var_2.Find(var_4_136, "panelMask/panel/bottom/ok/Text")

	i18n = var_4_136

	var_1(var_4_137, var_4_136("shop_new_confirm"))
...
function var_0_1.Overlay(arg_5_0)
	...
	var_5_4[1] = var_6.Find(var_5_5, "title")

	local var_5_6 = arg_5_0.top

	var_5_4[2] = var_6.Find(var_5_6, "title/limit_time")

	local var_5_7 = arg_5_0.top

	var_5_4[3] = var_6.Find(var_5_7, "title/charaNameBg")
	...
	var_5_4[7] = var_6.Find(var_5_8, "bg")

	local var_5_9 = arg_5_0.price

	var_5_4[8] = var_6.Find(var_5_9, "consume")

	local var_5_10 = arg_5_0.filterUI

	var_5_4[9] = var_6.Find(var_5_10, "panelMask/panel")
...
function var_0_1.didEnter(arg_7_0)
	...
	if arg_7_0.mode == var_0_1.MODE_EXPERIENCE or arg_7_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
		...
		NewShopMainScene = var_1_10003

		var_7_1(var_7_0, var_1_10003.SHOW_OR_HIDE_UI_2, false)
	...
	var_1(var_7_20, var_7_21, var_7_22, var_1_10005)

	local var_7_23

	if arg_7_0.mode == var_0_1.MODE_EXPERIENCE or arg_7_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
		getProxy = var_1
		SettingsProxy = var_7_23
		var_7_23 = var_1(var_7_23)

		var_1.SetNextTipTimeLimitSkinShop(var_7_23)
	end

	getProxy = var_1
	PlayerProxy = var_7_23

	local var_7_24 = var_1(var_7_23)
	local var_7_25 = var_1.getRawData(var_7_24).id

	onToggle = var_7_24

	local var_7_26 = arg_7_0
	local var_7_27 = arg_7_0.sdTg

	local function var_7_28(arg_14_0)
		...
		var_2_10001.SetInt("LatestSkinShopLayerSdTg" .. var_7_25, arg_14_0 and 1 or 0)
	...
	var_7_24(var_7_26, var_7_27, var_7_28, var_1_10006)

	PlayerPrefs = var_7_24

	local var_7_29 = var_7_24.GetInt("LatestSkinShopLayerSdTg" .. var_7_25, 0)

	triggerToggle = var_3

	var_3(arg_7_0.sdTg, var_7_29 == 1)

	onToggle = var_3

	local var_7_30 = arg_7_0
	local var_7_31 = arg_7_0.hideUITg

	local function var_7_32(arg_15_0)
		setActive = var_2_10001
		...
		NewShopMainScene = var_3

		var_15_1(var_15_0, var_3.SHOW_OR_HIDE_UI, not arg_15_0)
	...
	var_3(var_7_30, var_7_31, var_7_32, var_1_10007)

	onInputChanged = var_3

	var_3(arg_7_0, arg_7_0.search, function()
		...
		var_1(var_2.Find(var_16_2, "holder"), var_16_1 == "")
	...
	local var_7_34 = arg_7_0.showOwnBtn

	local function var_7_35()
		local var_17_0 = arg_7_0
		local var_17_1 = var_0.emit

		LatestSkinShopMediator = var_2_10002

		var_17_1(var_17_0, var_2_10002.OPEN_OWN_SKIN_LAYER)
	...
	var_3(var_7_33, var_7_34, var_7_35, var_1_10007)

	getProxy = var_3
	CommanderManualProxy = var_7_33

	local var_7_36 = var_3(var_7_33)

	var_3.TaskProgressAdd(var_7_36, 2021, 1)
...
function var_0_1.SetResource(arg_18_0)
	...
	var_18_0(var_3.Find(var_18_2, "gem/Text"), var_18_1:getTotalGem())

	onButton = var_18_0

	local var_18_3 = arg_18_0
	local var_18_4 = arg_18_0.resources
	local var_18_5 = var_4.Find(var_18_4, "gem")
	...
	var_18_0(var_18_3, var_18_5, var_18_6, var_6)
...
function var_0_1.GetAllCommodities(arg_21_0)
	...
	if var_21_0 == var_1_10002.NEW_SKIN_SHOP_ID then
		getProxy = var_21_0
		ShipSkinProxy = var_21_1
		var_21_1 = var_21_0(var_21_1)
		arg_21_0.commodities = var_21_0.GetInTimeSkins(var_21_1)
	else
		var_21_0 = arg_21_0.type
		ShopConst = var_21_1

		if var_21_0 == var_21_1.PERMANANT_SKIN_SHOP_ID then
			getProxy = var_21_0
			ShipSkinProxy = var_21_1
			var_21_1 = var_21_0(var_21_1)
			arg_21_0.commodities = var_21_0.GetPermanentSkins(var_21_1)
		else
			arg_21_0.commodities = {}
			getProxy = var_21_0
			ShipSkinProxy = var_21_1
			var_21_1 = var_21_0(var_21_1)
			var_21_0 = var_21_0.GetAllSkins(var_21_1)
			ipairs = var_21_1

			for iter_21_0, iter_21_1 in var_21_1(var_21_0) do
				table = var_1_10007
				var_1_10007 = var_1_10007.keyof
				pg = var_1_10008

				if var_1_10007(var_1_10008.shop_skin_subsheet[arg_21_0.type].param, iter_21_1.id) then
					table = var_1_10007
	...
	if var_21_0 then
		...
		local var_21_2 = var_21_0.gameset.levellimit_skintype.key_value

		pg = var_21_1

		local var_21_3 = var_21_1.gameset.levellimit_skintype.description

		getProxy = var_1_10003
		PlayerProxy = var_1_10004

		local var_21_4 = var_1_10003(var_1_10004)

		if var_21_2 >= var_3.getData(var_21_4).level then
			_ = var_21_4
			arg_21_0.commodities = var_21_4.filter(arg_21_0.commodities, function(arg_22_0)
				pg = var_2_10001
				...
				return var_2.contains(var_21_3, var_22_0)
			end)
		end
	end
	...
	if arg_21_0.mode == var_0_1.MODE_OVERVIEW then
		for iter_21_2 = #arg_21_0.commodities, 1, -1 do
			local var_21_5 = arg_21_0.commodities[iter_21_2]
			local var_21_6 = var_5.getConfig(var_21_5, "genre")

			ShopArgs = var_21_5

			if var_21_6 == var_21_5.SkinShopTimeLimit then
				table = var_21_6

				var_21_6.remove(arg_21_0.commodities, iter_21_2)
			end
		end
	end
...
function var_0_1.GetGiftPackCommodities(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1(var_1_10002.pay_data_display.all) do
		pg = var_1_10006
		...
		if var_1_10006.pay_data_display[iter_23_1].skin_inquire_relation ~= 0 then
			...
			if var_7.inTime(var_23_0, var_1_10006.time) then
				...
				local var_23_4 = var_23_2(var_23_1, var_23_3, var_1_10010.TYPE_CHARGE)

				arg_23_0.giftPackCommodities[iter_23_1] = var_23_4

				local var_23_5 = var_23_4:GetSkinProbability()
				local var_23_6 = arg_23_0.giftSkinCommodities

				getProxy = var_1_10010
				ShipSkinProxy = var_1_10011
				var_1_10011 = var_1_10010(var_1_10011)
				var_23_6[iter_23_1] = var_1_10010.GetProbabilitySkins(var_1_10011, var_23_5)

				local var_23_7 = arg_23_0.giftSkinProbabilitys

				getProxy = var_1_10010
				ShipSkinProxy = var_1_10011
				var_1_10011 = var_1_10010(var_1_10011)
				var_23_7[iter_23_1] = var_1_10010.GetSkinProbabilitys(var_1_10011, var_23_5)
			end
		end
	end
...
function var_0_1.Refresh(arg_27_0, arg_27_1)
	...
	for iter_27_0, iter_27_1 in var_3(arg_27_0.commodities) do
	...
	var_5(var_6.Find(var_27_6, "default"), var_27_5)

	setActive = var_5

	local var_27_7 = arg_27_0.bgs

	var_5(var_6.Find(var_27_7, "diffBg"), not var_27_5)

	setActive = var_5

	local var_27_8 = arg_27_0.bgs

	var_5(var_6.Find(var_27_8, "empty"), var_27_5)

	setActive = var_5

	local var_27_9 = arg_27_0._tf

	var_5(var_6.Find(var_27_9, "leftMask"), not var_27_5)

	setActive = var_5

	local var_27_10 = arg_27_0._tf

	var_5(var_6.Find(var_27_10, "bottomMask"), not var_27_5)
	...
	var_5(var_6.Find(var_27_11, "title"), not var_27_5)
	...
	var_5(var_6.Find(var_27_12, "scroll"), not var_27_5)
...
function var_0_1.IsSearchType(arg_29_0, arg_29_1, arg_29_2)
	...
	local var_29_1 = arg_29_2.getSkinId(var_29_0)

	ShipSkin = var_29_0

	local var_29_2 = var_29_0.New({
		id = var_29_1
	})

	return var_4.IsMatchKey(var_29_2, arg_29_1)
end
...
function var_0_1.filterOk(arg_32_0, arg_32_1)
	...
	local var_32_8 = arg_32_1
	local var_32_9 = arg_32_1.getSkinId(var_32_8)

	ShipSkin = var_32_8

	local var_32_10 = var_32_8.New({
		id = var_32_9
	})
	local var_32_11 = var_11.GetDefaultShipConfig(var_32_10)
	local var_32_12 = arg_32_0:ToVShip(var_32_11)
	local var_32_15
	...
	if var_32_0 ~= 0 then
		...
		getProxy = var_32_15
		ShipSkinProxy = var_1_10016

		local var_32_14 = var_32_15(var_1_10016)

		var_32_15 = var_32_15.hasSkin(var_32_14, var_32_9)

		local var_32_16 = var_11:NoUse()

		if var_32_0 == 1 and var_32_15 then
			var_32_13 = true
		end

		if var_32_0 == 2 and not var_32_15 then
			var_32_13 = true
		end

		if var_32_0 == 3 and var_32_15 and var_32_16 then
			var_32_13 = true
		end
	...
	if var_32_1[1] ~= 0 then
		...
		for iter_32_0, iter_32_1 in var_32_15(var_32_1) do
			if iter_32_1 == 1 then
				var_1_10021 = var_11

				if not var_11.IsLive2d(var_1_10021) then
					var_1_10021 = var_11

					if var_11.IsLive2dPlus(var_1_10021) then
						var_32_17 = true
					end
					...
					if iter_32_1 == 2 then
						...
						if not var_11.IsLive2d(var_1_10021) then
							...
							if not var_11.IsLive2dPlus(var_1_10021) then
								var_1_10021 = var_11

								if not var_11.IsSpine(var_1_10021) then
									var_1_10021 = var_11

									if not var_11.IsSpinePlus(var_1_10021) then
										var_32_17 = true
									end
								end
							end
					...
					if iter_32_1 == 3 then
						...
						if not var_11.IsSpine(var_1_10021) then
							...
							if var_11.IsSpinePlus(var_1_10021) then
								var_32_17 = true
							end
							...
							if iter_32_1 == 4 then
								...
								if var_11.IsBG(var_1_10021) then
									var_32_17 = true
								end
							end
							...
							if iter_32_1 == 5 then
								...
								if var_11.IsDbg(var_1_10021) then
									var_32_17 = true
								end
							end
							...
							if iter_32_1 == 6 then
								...
								if var_11.isBgm(var_1_10021) then
									var_32_17 = true
								end
							end
	...
	if var_32_2 ~= 0 then
		...
		var_32_15 = var_11:CantUse()

		if var_32_2 == 1 and not var_32_15 then
			var_32_18 = true
		end

		if var_32_2 == 2 and var_32_15 then
			var_32_18 = true
		end
	...
	if var_32_3[1] ~= 0 then
		...
		for iter_32_2, iter_32_3 in var_32_15(var_32_3) do
			...
			for iter_32_4, iter_32_5 in var_1_10021(var_1_10020[iter_32_3 + 1].types) do
				...
				if iter_32_5 == var_1_10026.LINK then
					local var_32_20 = var_32_12

					var_1_10026 = var_32_12.getNation(var_32_20)
					Nation = var_32_20

					if var_1_10026 >= var_32_20.LINK then
						var_32_19 = true
					end
	...
	if var_32_4[1] ~= 0 then
		...
		for iter_32_6, iter_32_7 in var_32_15(var_32_4) do
			ShipIndexCfg = var_1_10020
	...
	if var_32_5[1] ~= 0 then
		...
		for iter_32_8, iter_32_9 in var_32_15(var_32_5) do
			ShipIndexCfg = var_1_10020

			local var_32_23 = var_1_10020.type[iter_32_9 + 1].types
			local var_32_24

			if iter_32_9 + 1 < 4 then
				var_32_24 = var_1_10020[iter_32_9].shipTypes
				table = var_23

				if var_23.contains(var_32_23, var_32_12:getShipType()) then
					var_32_22 = true
				end

				table = var_23

				if var_23.contains(var_32_23, var_32_12:getTeamType()) then
					var_32_22 = true
				end
			else
				table = var_32_24

				if var_32_24.contains(var_32_23, var_32_12:getShipType()) then
					var_32_22 = true
				end
			end
	...
	if var_32_6[1] ~= 0 then
		...
		for iter_32_10, iter_32_11 in var_32_15(var_32_6) do
			local var_32_26 = arg_32_0.classifyIds[iter_32_11 + 1]
			local var_32_27 = arg_32_1
			local var_32_28 = arg_32_1.getConfig(var_32_27, "genre")

			ShopArgs = var_32_27

			if var_32_28 == var_32_27.SkinShopTimeLimit then
				if arg_32_0.mode == var_0_1.MODE_EXPERIENCE_FOR_ITEM then
					var_32_25 = var_32_26 == var_0_16 and arg_32_0:ExitSkinExperienceItem(arg_32_1.id)
				else
					var_32_25 = var_32_26 == var_0_14
				end
			elseif var_32_26 == var_0_13 then
				var_32_25 = true
			else
				if var_32_26 == var_0_15 then
					table = var_21
				...
				if arg_32_0:GetShopTypeIdBySkinId(var_32_9) ~= 0 or not var_0_17 then
					var_32_29 = var_21
				end

				var_32_25 = var_32_29 == var_32_26
			end
	...
	if var_32_7[1] ~= 0 then
		local var_32_30 = false

		table = var_32_15

		local var_32_31 = var_32_15.contains(arg_32_0.returnSkins, arg_32_1.id)

		NewShopSkinCard = var_16

		local var_32_32 = var_16.GetTagId(arg_32_1, var_32_31)

		table = var_17

		if var_17.keyof(var_32_7, var_32_32) then
			return true
		else
			return false
		end
...
function var_0_1.RegisterEvent(arg_40_0)
	arg_40_0:bind(var_0_1.EVT_SHOW_OR_HIDE_PURCHASE_VIEW, function(arg_41_0, arg_41_1)
		...
		local var_41_3, var_41_8

		if arg_40_0.spineChar then
			if arg_41_1 then
				pg = var_41_8

				if var_41_8.ship_skin_template[arg_40_0.skinId].purchase_offset then
					local var_41_2 = #var_41_8

					if 3 <= var_41_2 then
						var_41_3 = arg_40_0.spineChar

						local var_41_4 = var_3.SetLocalPosition

						Vector3 = var_2_10005

						var_41_4(var_41_3, var_2_10005(var_41_8[1], var_41_8[2], var_41_8[3]))
					end
				end

				if var_41_8 then
					local var_41_5 = #var_41_8

					if 4 <= var_41_5 then
						var_41_3 = arg_40_0.spineChar

						local var_41_6 = var_3.SetLocalScale

						Vector3 = var_2_10005

						var_41_6(var_41_3, var_2_10005(var_41_8[4], var_41_8[4], var_41_8[4]))
					end
				end
			else
				local var_41_7 = arg_40_0.spineChar

				var_41_8 = var_41_8.SetLocalScale
				Vector3 = var_41_3

				var_41_8(var_41_7, var_41_3(0.9, 0.9, 1))

				local var_41_9 = arg_40_0.spineChar

				var_41_8 = var_41_8.SetLocalPosition
				Vector3 = var_41_3

				var_41_8(var_41_9, var_41_3(0, 0, 0))
			end
		end

		pg = var_41_8

		local var_41_10 = var_41_8.m02
		local var_41_11 = var_2.sendNotification

		NewShopMainScene = var_41_3

		var_41_11(var_41_10, var_41_3.SHOW_OR_HIDE_UI, not arg_41_1)
	...
	local function var_40_2()
		...
		if var_2_10000.IsChangeSkin(arg_40_0.skinId) then
			...
			ShipSkin = var_1
			var_43_0.changeSkinId = var_1.GetChangeSkinNextId(arg_40_0.skinId)
	...
	var_1(var_40_0, var_40_1, var_40_2, var_1_10005)
...
function var_0_1.OnInitItem(arg_44_0, arg_44_1)
	...
	var_3(var_44_1, var_44_2, var_44_3, var_1_10007)
...
function var_0_1.UpdateMainView(arg_47_0, arg_47_1)
	...
	var_3(arg_47_0.changeSkin, var_47_0)
...
function var_0_1.FlushChangeSkin(arg_48_0, arg_48_1)
	...
	local var_48_1 = var_3.GetChangeSkinCustomDataId(arg_48_0.skinId, "hide_shop")
	...
	if var_48_2 and var_48_2.description then
		...
		if var_1_10009.contains(var_48_7, var_48_0) then
			HXSet = var_9
...
function var_0_1.FlushName(arg_50_0)
	...
	SwitchSpecialChar = var_1_10004

	var_2(var_50_1, var_1_10004(var_50_0.name, true))

	local var_50_2 = var_50_0.skin_type

	ShipSkin = var_50_1

	if var_50_2 == var_50_1.SKIN_TYPE_TB then
		...
		local var_50_4 = var_4.GetShipNameBySecId

		NewEducateHelper = var_5

		var_50_2(var_50_3, var_50_4(var_5.GetSecIdBySkinId(arg_50_0.skinId)))
	else
		ShipGroup = var_50_2
...
function var_0_1.FlushPreviewBtn(arg_51_0, arg_51_1)
	...
	var_3(arg_51_0.switchPreviewBtn)
	...
	var_3(arg_51_0.switchPreviewBtn, var_51_0)
	...
	if var_51_0 then
		...
		var_3(var_51_1, var_51_2, var_51_3, var_1_10007)
	end
...
function var_0_1.SwitchPreview(arg_53_0, arg_53_1, arg_53_2)
	...
	var_53_2(var_53_4, var_1_10007.GetInt("LatestSkinShopLayerSdTg" .. var_53_3, 0) == 1)

	setActive = var_53_2

	var_53_2(arg_53_0.charTf, not arg_53_2)

	setActive = var_53_2

	var_53_2(arg_53_0.furnitureContainer, arg_53_2)

	if not arg_53_2 then
		pg = var_53_2
		var_53_2 = var_53_2.ship_skin_template[var_53_0]

		arg_53_0:FlushChar(var_53_2.prefab, var_53_2.id)

		GetImageSpriteFromAtlasAsync = var_6

		var_6("qicon/" .. var_53_2.painting, "", arg_53_0.backChara)
	else
		Goods = var_53_2

		local var_53_5 = var_53_2.Id2FurnitureId(arg_53_1.id)

		Goods = var_6

		local var_53_6 = var_6.GetFurnitureConfig(arg_53_1.id)
		local var_53_7 = arg_53_0.interactionPreview
		local var_53_8 = var_7.Flush
		local var_53_9 = var_53_0
		local var_53_10 = var_53_5
		local var_53_11

		if not var_53_6.scale[2] then
			var_53_11 = 1
		end

		var_53_8(var_53_7, var_53_9, var_53_10, var_53_11, var_53_6.position[2])
	end
...
function var_0_1.FlushChar(arg_54_0, arg_54_1, arg_54_2)
	...
	var_3:Load(true, function(arg_55_0)
		...
		if var_55_0.skinshop_spine_scale[arg_54_2] then
			...
			var_55_2(var_55_1, var_2_10004(var_1.skinshop_scale, var_1.skinshop_scale, 1))
		else
			...
			var_55_4(var_55_3, var_2_10004(0.9, 0.9, 1))
		end
		...
		var_55_6(var_55_5, var_2_10004(0, 0, 0))
...
function var_0_1.FlushTimeLimit(arg_58_0, arg_58_1)
	...
	if arg_58_1:IsActivityExtra() and arg_58_1:ShowMaintenanceTime() then
		...
		var_58_3, var_58_4 = arg_58_1:GetMaintenanceMonthAndDay()

		function var_58_2()
			i18n = var_2_10000

			return var_2_10000("limit_skin_time_before_maintenance", var_58_3, var_58_4)
		end

		var_58_1 = true
	else
		local var_58_5 = arg_58_1

		var_58_3 = arg_58_1.getConfig(var_58_5, "genre")
		ShopArgs = var_58_5

		if var_58_3 == var_58_5.SkinShopTimeLimit then
			getProxy = var_58_3
			ShipSkinProxy = var_6

			local var_58_6 = var_58_3(var_6)

			var_58_1 = var_58_3.getSkinById(var_58_6, var_58_0) and var_58_3:isExpireType() and not var_58_3:isExpired()
			...
			if var_58_1 then
				function var_58_2()
					...
					return var_2_10000(var_1.getRemainTime(var_60_0))
				end
			end
		else
			pg = var_58_3

			local var_58_7 = var_58_3.TimeMgr.GetInstance()
			local var_58_8

			var_58_3, var_58_8 = var_58_3.inTime(var_58_7, arg_58_1:getConfig("time"))

			if var_58_8 then
				pg = var_7

				local var_58_9 = var_7.TimeMgr.GetInstance()
				local var_58_10 = var_7.Table2ServerTime(var_58_9, var_58_8)

				function var_58_2()
					skinCommdityTimeStamp = var_2_10000

					return var_2_10000(var_58_10)
				end
			end
		end
	end
	...
	local var_58_11 = arg_58_0.top

	var_58_3(var_6.Find(var_58_11, "title/limit_time"), var_58_1)
	arg_58_0:ClearTimer()
...
function var_0_1.FlushPaintingToggle(arg_65_0, arg_65_1)
	...
	local var_65_2 = var_1_10002(var_65_0 .. var_4.getConfig(var_65_1, "painting") .. "_n")
	...
	if not var_3.IsSpine(var_65_3) then
		local var_65_4 = arg_65_0.shipSkin

		if not var_3.IsLive2d(var_65_4) then
			local var_65_5 = arg_65_0.shipSkin

			if not var_3.IsSpinePlus(var_65_5) then
				local var_65_6 = arg_65_0.shipSkin

				var_65_7 = var_3.IsLive2dPlus(var_65_6)
			end
		end
	end

	local var_65_8 = arg_65_0.shipSkin
	local var_65_9 = var_4.IsHxDynamicPreview(var_65_8)

	if var_65_7 and not var_65_9 then
		PlayerPrefs = var_65_8

		local var_65_10 = var_65_8.GetInt
		local var_65_11 = "skinShop#l2dPreViewToggle"

		getProxy = var_1_10007
		PlayerProxy = var_1_10008
		var_1_10008 = var_1_10007(var_1_10008)

		if var_65_10(var_65_11 .. var_1_10007.getRawData(var_1_10008).id, 0) == 1 then
	...
	if var_65_7 then
		...
		var_1_10007 = arg_65_0.shipSkin

		if var_6.IsSpine(var_1_10007) then
			var_65_12 = 6
		else
			var_1_10007 = arg_65_0.shipSkin

			if var_6.IsLive2d(var_1_10007) then
				var_65_12 = 1
			else
				var_1_10007 = arg_65_0.shipSkin

				if var_6.IsSpinePlus(var_1_10007) then
					var_65_12 = 7
				else
					var_1_10007 = arg_65_0.shipSkin

					if var_6.IsLive2dPlus(var_1_10007) then
						var_65_12 = 9
					end
				end
			end
		...
		LoadImageSpriteAtlasAsync = var_6
		var_1_10007 = "SkinIcon"
		var_1_10008 = "type_"
		ShipSkin = var_1_10009

		var_6(var_1_10007, var_1_10008 .. var_1_10009.Tag2Name(var_65_12) .. "_off", arg_65_0.dynamicToggle)

		LoadImageSpriteAtlasAsync = var_6
		var_1_10007 = "SkinIcon"
		var_1_10008 = "type_"
		ShipSkin = var_1_10009
		var_1_10008 = var_1_10008 .. var_1_10009.Tag2Name(var_65_12)

		local var_65_13 = arg_65_0.dynamicToggle

		var_6(var_1_10007, var_1_10008, var_1_10009.Find(var_65_13, "select"))
	end

	if var_65_9 and arg_65_0.isToggleDynamic then
		triggerToggle = var_5
	...
	if arg_65_0.isToggleDynamic and not var_65_7 then
		triggerToggle = var_65_15

		var_65_15(arg_65_0.dynamicToggle, false)
	...
	if arg_65_0.isToggleDynamic then
		...
		local var_65_15 = var_65_15.GetComponent

		typeof = var_1_10007
		Toggle = var_1_10008

		if not var_65_15(var_65_14, var_1_10007(var_1_10008)).isOn then
			local var_65_16 = arg_65_0.shipSkin

			if not var_65_15.IsLive2d(var_65_16) then
				var_65_16 = arg_65_0.shipSkin

				if var_65_15.IsLive2dPlus(var_65_16) then
					Live2dConst = var_65_15

					if var_65_15.GetLive2DArm32MatchAble() then
						arg_65_0.isToggleDynamic = false
						getProxy = var_65_15
						PlayerProxy = var_65_16

						local var_65_17 = var_65_15(var_65_16)

						var_65_15 = var_65_15.getRawData(var_65_17).id
						PlayerPrefs = var_65_17

						var_65_17.SetInt("skinShop#l2dPreViewToggle" .. var_65_15, 0)
				...
				var_65_15(arg_65_0.dynamicToggle, true)
				...
				if var_65_2 then
					...
					local var_65_18 = arg_65_0
					local var_65_19 = arg_65_0.showBgToggle

					local function var_65_20(arg_66_0)
					...
					var_65_15(var_65_18, var_65_19, var_65_20, var_1_10009)
				end

				local var_65_21 = arg_65_0.shipSkin

				if not var_5.IsSpine(var_65_21) then
					local var_65_22 = arg_65_0.shipSkin

					if not var_5.IsLive2d(var_65_22) then
						local var_65_23 = arg_65_0.shipSkin

						if not var_5.IsSpinePlus(var_65_23) then
							local var_65_24 = arg_65_0.shipSkin

							if var_5.IsLive2dPlus(var_65_24) then
								onToggle = var_5

								local var_65_25 = arg_65_0
								local var_65_26 = arg_65_0.dynamicToggle

								local function var_65_27(arg_67_0)
									...
									if arg_67_0 and var_67_1 then
										...
										local var_67_2 = var_67_0.TipsMgr.GetInstance()

										var_67_0 = var_67_0.ShowTips
										i18n = var_2_10004

										var_67_0(var_67_2, var_2_10004("shop_tag_control_tip"))

										triggerToggle = var_67_0

										var_67_0(arg_65_0.dynamicToggle, false)

										setActive = var_67_0

										var_67_0(arg_65_0.dynamicResToggle, false)

										return
									end

									if arg_67_0 then
										Live2dConst = var_67_0

										if var_67_0.GetLive2DArm32MatchAble() then
								...
								var_5(var_65_25, var_65_26, var_65_27, var_1_10009)
							end
							...
							var_5(arg_65_0.dynamicToggle, var_65_7)
...
function var_0_1.FlushTag(arg_68_0)
	...
	local var_68_7 = var_5(var_68_5 .. var_7.getConfig(var_68_6, "painting") .. "_n")
	...
	var_6.make(var_68_8, function(arg_69_0, arg_69_1, arg_69_2)
		...
		if arg_69_0 == var_2_10003.EventUpdate then
			...
			ShipSkin = var_2_10007

			var_4(var_69_1, var_69_2 .. var_2_10007.Tag2Name(var_68_2[arg_69_1 + 1]), function(arg_70_0)
				...
				typeof = var_3_10003
				Image = var_3_10004
				var_70_1(var_70_0, var_3_10003(var_3_10004)).sprite = arg_70_0
...
function var_0_1.FlushPainting(arg_71_0, arg_71_1)
	...
	local var_71_1 = arg_71_0.GetPaintingState(var_71_0, arg_71_1)

	pg = var_71_0

	local var_71_2 = var_71_0.ship_skin_template[arg_71_0.skinId].painting

	ShipSkin = var_4

	local var_71_3 = var_4.GetChangeSkinData(arg_71_0.skinId) and true or false

	if var_71_1 == var_0_3 and not arg_71_0:ExistL2dRes(var_71_2) or var_71_1 == var_0_4 and not arg_71_0:ExistSpineRes(var_71_2) then
		var_71_1 = var_0_2
	end

	if arg_71_0.paintingState and arg_71_0.paintingState.state == var_71_1 and arg_71_0.paintingState.id == arg_71_1.id and arg_71_0.paintingState.showBg == arg_71_0.isToggleShowBg and arg_71_0.paintingState.purchaseFlag == arg_71_1.buyCount and not var_71_3 then
		return
	end

	arg_71_0:ClearPainting()

	if var_71_1 == var_0_2 then
		arg_71_0:LoadMeshPainting(arg_71_1, arg_71_0.isToggleShowBg)
	elseif var_71_1 == var_0_3 then
		arg_71_0:LoadL2dPainting(arg_71_1)
	elseif var_71_1 == var_0_4 then
...
function var_0_1.LoadMeshPainting(arg_73_0, arg_73_1, arg_73_2)
	...
	local var_73_1 = var_4(var_73_0, "PaintingScaler")
	...
	if not arg_73_2 then
		...
		if var_1_10007("painting/" .. var_73_3 .. "_n") then
	...
	if not var_1_10007("painting/" .. var_73_3) then
		return
	end
	...
	var_7.GetPainting(var_73_5, var_73_3, true, function(arg_74_0)
		...
		var_74_1(var_2.GetChild(var_74_2, 0), var_73_2)
...
function var_0_1.LoadL2dPainting(arg_76_0, arg_76_1)
	...
	if var_76_1 == var_1_10005.SKIN_TYPE_TB then
		...
		var_76_2 = var_76_3(var_1_10006.GetSecIdBySkinId(var_76_0))
	else
		pg = var_76_3
	...
	Vector3 = var_1_10007
	var_76_6.position = var_1_10007(0, 0, -1)
	...
	arg_76_0.live2dChar = var_6.New(var_76_7, function(arg_77_0)
		...
		var_77_3(var_77_2, var_3.L2D_DEFAULT_LAYER)
...
function var_0_1.LoadSpinePainting(arg_79_0, arg_79_1)
	...
	if var_79_1 == var_1_10005.SKIN_TYPE_TB then
		...
		NewEducateHelper = var_1_10006
		var_79_2 = var_79_3(var_1_10006.GetSecIdBySkinId(var_79_0))
	else
		pg = var_79_3
		var_79_3 = var_79_3.ship_skin_template[var_79_0].ship_group
		ShipGroup = var_1_10006

		local var_79_4 = var_1_10006.getDefaultShipConfig(var_79_3)
	...
	local var_79_5 = var_79_3.GenerateData
	local var_79_6 = {
		ship = var_79_2
	}

	Vector3 = var_1_10007
	var_79_6.position = var_1_10007(0, 0, 0)
	var_79_6.parent = arg_79_0.spTF
	var_79_6.effectParent = arg_79_0.spBg
	var_79_6.offset = var_79_2:GetSkinConfig().shop_offset

	local var_79_7 = var_79_5(var_79_6)

	pg = var_79_6

	local var_79_8 = var_79_6.UIMgr.GetInstance()

	var_6.LoadingOn(var_79_8)

	SpinePainting = var_6
	arg_79_0.spinePainting = var_6.New(var_79_7, function(arg_80_0)
...
function var_0_1.FlushBG(arg_87_0, arg_87_1, arg_87_2)
	...
	if var_87_3 == var_1_10007.SKIN_TYPE_TB then
		...
		var_87_2 = var_87_3(var_7.GetSecIdBySkinId(var_87_0))
	else
		ShipGroup = var_87_3
	...
	local var_87_6 = var_87_2.getShipBgPrint(var_87_5, true)

	pg = var_87_5

	local var_87_7 = var_87_5.ship_skin_template[var_87_0].painting

	if not arg_87_0.isToggleShowBg then
		checkABExist = var_8

		if not var_8("painting/" .. var_87_7 .. "_n") then
			if var_87_1.bg_sp ~= "" then
				var_87_6 = var_87_1.bg_sp
			end
		end

		local var_87_8 = var_87_2

		if var_87_6 ~= var_87_2.rarity2bgPrintForGet(var_87_8) then
			pg = var_87_8

			local var_87_9 = var_87_8.DynamicBgMgr.GetInstance()

			var_87_8 = var_87_8.LoadBg

			local var_87_10 = arg_87_0
			local var_87_11 = var_87_6
			local var_87_12 = arg_87_0.bgs
			local var_87_13 = var_13.Find(var_87_12, "diffBg")
			local var_87_14 = arg_87_0.bgs

			var_87_8(var_87_9, var_87_10, var_87_11, var_87_13, var_14.Find(var_87_14, "diffBg/bg"), function(arg_88_0)
				if arg_87_2 then
					arg_87_2()
				end
			...
			local var_87_15 = var_87_8.DynamicBgMgr.GetInstance()

			var_87_8.ClearBg(var_87_15, arg_87_0:getUIName())
		...
		var_87_8(var_10.Find(var_87_16, "diffBg"), var_8)

		setActive = var_87_8

		local var_87_17 = arg_87_0.bgs

		var_87_8(var_10.Find(var_87_17, "default"), not var_8)
...
function var_0_1.FlushDynamicPaintingResState(arg_90_0, arg_90_1)
	...
	local var_90_3 = var_1_10005.ship_skin_template[arg_90_0.skinId].painting
	local var_90_4
	...
	if not var_90_1 and var_90_2 ~= "" then
		...
		var_90_4(var_90_7, var_90_8, var_90_9, var_1_10010)
	end
...
function var_0_1.RecordFlag(arg_97_0, arg_97_1)
	...
	local var_97_0 = var_1_10002(var_1_10003)
	local var_97_1 = var_2.getRawData(var_97_0).id

	PlayerPrefs = var_97_0

	var_97_0.SetInt("skinShop#l2dPreViewToggle" .. var_97_1, arg_97_1 and 1 or 0)
	...
	LatestSkinShopMediator = var_5

	var_97_3(var_97_2, var_5.ON_RECORD_ANIM_PREVIEW_BTN, arg_97_1)
...
function var_0_1.FlushPrice(arg_98_0, arg_98_1)
	...
	local var_98_2 = var_98_1 == var_98_0.SkinShopTimeLimit
	...
	if var_98_3 ~= var_4.TYPE_ACTIVITY then
	...
	if var_98_2 then
		...
		if var_98_6 == var_1_10005.MODE_EXPERIENCE_FOR_ITEM then
			var_1_10005 = arg_98_0

			arg_98_0.UpdateExperiencePrice4Item(var_1_10005, arg_98_1)
		else
			var_1_10005 = arg_98_0

			arg_98_0.UpdateExperiencePrice(var_1_10005, arg_98_1)
		end
	elseif arg_98_0.isPreviewFurniture then
		var_1_10005 = arg_98_0

		arg_98_0.UpdateFurniturePrice(var_1_10005, arg_98_1)
	elseif var_98_5 then
		-- block empty
	else
		var_1_10005 = arg_98_0

		arg_98_0.UpdateCommodityPrice(var_1_10005, arg_98_1)
	end
	...
	local var_98_8 = var_98_7 == var_1_10005.TYPE_SKIN

	setActive = var_5

	local var_98_9 = arg_98_0.price

	var_5(var_6.Find(var_98_9, "timeLimit"), var_98_2 and not var_98_5)

	setActive = var_5

	local var_98_10 = arg_98_0.price

	var_5(var_6.Find(var_98_10, "consume"), var_98_8 and not var_98_2 and not var_98_5)
...
function var_0_1.UpdateExperiencePrice4Item(arg_99_0, arg_99_1)
	...
	if not var_99_2.detect(var_99_3, function(arg_100_0)
	...
	if var_99_4 < var_99_1 then
		...
		if not (var_99_5 .. var_1_10007 .. ">") then
			var_99_6 = ""
		end
		...
		var_7(var_8.Find(var_99_8, "timeLimit/consume/Text"), var_99_7 .. "/" .. var_99_1)
...
function var_0_1.UpdateExperiencePrice(arg_101_0, arg_101_1)
	...
	local var_101_1 = arg_101_1.getConfig(var_101_0, "resource_num")

	getProxy = var_101_0
	PlayerProxy = var_4

	local var_101_2 = var_101_0(var_4)
	local var_101_3 = var_3.getRawData(var_101_2)

	if var_3.getSkinTicket(var_101_3) < var_101_1 then
		local var_101_4 = "<color="

		COLOR_RED = var_1_10005

		local var_101_5

		if not (var_101_4 .. var_1_10005 .. ">") then
			var_101_5 = ""
		end

		local var_101_6 = var_101_5 .. var_3 .. (var_3 < var_101_1 and "</color>" or "")

		setText = var_5

		local var_101_7 = arg_101_0.price

		var_5(var_6.Find(var_101_7, "timeLimit/consume/Text"), var_101_6 .. "/" .. var_101_1)
...
function var_0_1.UpdateCommodityPrice(arg_102_0, arg_102_1)
	...
	local var_102_1 = arg_102_1
	local var_102_2 = arg_102_1.getConfig(var_102_1, "resource_num")

	setText = var_102_1

	local var_102_3 = arg_102_0.price

	var_102_1(var_5.Find(var_102_3, "consume/Text"), var_102_0)

	setText = var_102_1

	local var_102_4 = arg_102_0.price

	var_102_1(var_5.Find(var_102_4, "consume/originalprice/Text"), var_102_2)

	setActive = var_102_1

	local var_102_5 = arg_102_0.price

	var_102_1(var_5.Find(var_102_5, "consume/originalprice"), var_102_0 ~= var_102_2)
...
function var_0_1.UpdateFurniturePrice(arg_103_0, arg_103_1)
	...
	var_103_1(var_6.Find(var_103_3, "consume/originalprice/Text"), var_103_2)
	...
	local var_103_6 = var_103_5(var_103_4, var_7.ResDiamond)

	setText = var_103_4

	local var_103_7 = arg_103_0.price

	var_103_4(var_7.Find(var_103_7, "consume/Text"), var_103_6)

	setActive = var_103_4

	local var_103_8 = arg_103_0.price

	var_103_4(var_7.Find(var_103_8, "consume/originalprice"), var_103_2 ~= var_103_6)
...
function var_0_1.FlushObtainBtn(arg_104_0, arg_104_1)
	...
	for iter_104_0 = 0, arg_104_0.btns.childCount - 1 do
		...
		var_104_2(var_104_3, var_104_3.name == var_104_1)
	end
	...
	var_4(var_5.Find(var_104_4, "btn/item"), var_104_0 == var_0_12)

	setActive = var_4

	local var_104_5 = arg_104_0.price

	var_4(var_5.Find(var_104_5, "btn/tag"), var_104_0 == var_0_12)
	...
	local var_104_8 = var_6.Find(var_104_7, "btn")
	...
	local function var_104_9()
		...
		if var_2(var_105_1) then
			...
			var_2.insert(var_105_0, function(arg_106_0)
				...
				i18n = var_3_10004
				var_106_2.content = var_3_10004("SkinDiscount_Hint")
				...
				function var_106_2.onYes()
					if var_105_1 then
						...
						if not var_0.isEnd(var_107_0) then
							...
							LatestSkinShopMediator = var_4_10002

							var_107_2(var_107_1, var_4_10002.OPEN_ACTIVITY, var_105_1.id)
						end
					end
		...
		if var_105_3 == var_105_2.SkinShop then
			...
			if not var_105_3.IsItemDiscountType(var_105_4) then
				...
				if #var_105_3.GetOvercountEncoreActs(arg_104_1.id) > 0 then
					...
					var_3.insert(var_105_0, function(arg_108_0)
						...
						i18n = var_3_10004
						var_108_2.content = var_3_10004("SkinDiscount_Last_Coupon")
	...
	var_4(var_104_6, var_104_8, var_104_9, var_8)
...
function var_0_1.GetObtainBtnState(arg_110_0, arg_110_1)
	...
	if var_110_1 == var_110_0.SkinShopTimeLimit then
	...
	if arg_110_0.isPreviewFurniture then
		getProxy = var_2
		DormProxy = var_110_2
		var_110_2 = var_2(var_110_2)
		var_110_2 = var_2.getRawData(var_110_2)

		local var_110_3 = var_2.HasFurniture

		Goods = var_4

		if var_110_3(var_110_2, var_4.Id2FurnitureId(arg_110_1.id)) then
			return var_0_5
		else
			return var_0_9
		end
	...
	local var_110_4 = arg_110_1.type

	Goods = var_110_2

	if var_110_4 ~= var_110_2.TYPE_ACTIVITY then
		do
			local var_110_5 = arg_110_1.type

			Goods = var_3

			if var_110_5 == var_3.TYPE_ACTIVITY_EXTRA then
				return var_0_7
...
function var_0_1.FlushGift(arg_111_0, arg_111_1)
	...
	local var_111_1 = arg_111_0.price

	var_1_10004(var_5.Find(var_111_1, "btn/item/mask/item"), {
		type = var_111_0.type,
		id = var_111_0.id,
...
function var_0_1.OnClickBtn(arg_112_0, arg_112_1, arg_112_2)
	if arg_112_1 == var_0_6 or arg_112_1 == var_0_8 or arg_112_1 == var_0_12 then
		var_1_10004 = arg_112_0

		arg_112_0.OnPurchase(var_1_10004, arg_112_2)
	elseif arg_112_1 == var_0_11 then
		var_1_10004 = arg_112_0

		arg_112_0.OnItemPurchase(var_1_10004, arg_112_2)
	elseif arg_112_1 == var_0_7 then
		var_1_10004 = arg_112_0

		arg_112_0.OnActivity(var_1_10004, arg_112_2)
	elseif arg_112_1 == var_0_9 then
		var_1_10004 = arg_112_0

		arg_112_0.OnBackyard(var_1_10004, arg_112_2)
...
function var_0_1.FlushGifgPackBtn(arg_113_0, arg_113_1)
	...
	if var_113_0 then
		...
		var_6(var_113_5, var_113_4("skinshop_on_sale_tip_2"))
		...
		local function var_113_7()
			...
			local var_114_3 = var_114_1(var_2_10002)
			...
			if #var_114_2 <= 0 or #var_114_2 ~= #var_114_4 then
				...
				var_2_10004 = var_2_10004.OPEN_SCENE

				local var_114_7 = {}

				SCENE = var_2_10006
				var_114_7[1] = var_2_10006.CHARGE

				local var_114_8 = {}

				ChargeScene = var_2_10007
				var_114_8.wrap = var_2_10007.TYPE_PICK
				var_114_7[2] = var_114_8

				var_114_6(var_114_5, var_2_10004, var_114_7)
			else
				...
				var_114_10(var_114_9, var_2_10004.OPEN_GIFT_PACK_LAYER, var_113_1, var_113_2, var_113_3)
			end

			return
		end

		SFX_PANEL = iter_113_1

		var_6(var_113_5, var_113_6, var_113_7, iter_113_1)
	else
		getProxy = var_6
		...
		if var_6.GetFakeGiftPackActivity(var_113_8, arg_113_1) then
			...
			local var_113_10 = var_7.Find(var_113_9, "title")

			i18n = var_113_9

			var_6(var_113_10, var_113_9("skinshop_on_sale_tip"))
			...
			local function var_113_13()
				...
				var_115_1(var_115_0, var_2_10002.OPEN_GIFT_ACT_LAYER, var_113_0.id)
			...
			var_6(var_113_11, var_113_12, var_113_13, iter_113_1)
		end
	end
...
function var_0_1.OnPurchase(arg_117_0, arg_117_1)
	...
	if arg_117_1:isDisCount() and arg_117_1:IsItemDiscountType() then
		...
		LatestSkinShopMediator = var_1_10004

		var_117_2(var_117_1, var_1_10004.ON_SHOPPING_BY_ACT, arg_117_1.id, 1)
	else
		...
		var_117_4(var_117_3, var_1_10004.ON_SHOPPING, arg_117_1.id, 1)
	end
...
function var_0_1.OnItemPurchase(arg_118_0, arg_118_1)
	...
	local var_118_2 = arg_118_1.GetVoucherIdList(var_118_1)

	getProxy = var_118_1
	BagProxy = var_1_10004

	local var_118_3 = var_118_1(var_1_10004)
	local var_118_4 = var_3.GetExclusiveDiscountItem4Shop(var_118_3, arg_118_1.id)

	if #var_118_2 <= 0 and #var_118_4 <= 0 then
		return
	end
	...
	for iter_118_0, iter_118_1 in var_5(var_118_2) do
		table = var_1_10010

		var_1_10010.insert(var_118_5, iter_118_1)
	end

	ipairs = var_5

	for iter_118_2, iter_118_3 in var_5(var_118_4) do
		table = var_1_10010

		var_1_10010.insert(var_118_5, iter_118_3.id)
	end

	local var_118_6 = arg_118_0.skinId

	pg = var_6

	local var_118_7 = var_6.ship_skin_template[var_118_6]

	SwitchSpecialChar = var_7

	local var_118_8 = var_7(var_118_7.name, true)
	local var_118_9 = arg_118_0.voucherMsgBox

	var_8.ExecuteAction(var_118_9, "Show", {
		itemList = var_118_5,
		skinId = var_118_6,
		skinName = var_118_8,
		...
		onYes = function(arg_119_0)
			if arg_119_0 then
				...
				var_119_1(var_119_0, var_2_10003.ON_ITEM_PURCHASE, arg_119_0, arg_118_1.id)
			else
				...
				var_119_3(var_119_2, var_2_10003.ON_SHOPPING, arg_118_1.id, 1)
			end
...
function var_0_1.OnActivity(arg_120_0, arg_120_1)
	...
	local var_120_1 = arg_120_1
	local var_120_2 = arg_120_1.getConfig(var_120_1, "activity")

	getProxy = var_120_1
	ActivityProxy = var_5

	local var_120_3 = var_120_1(var_5)
	local var_120_4 = var_4.getActivityById(var_120_3, var_120_2)

	if var_120_2 == 0 then
		pg = var_120_3

		local var_120_5 = var_120_3.TimeMgr.GetInstance()

		if not var_120_3.inTime(var_120_5, var_120_0) then
			if var_120_4 then
				var_120_5 = var_120_4

				if not var_120_4.isEnd(var_120_5) then
					var_120_3 = arg_120_1.type
					Goods = var_120_5

					local var_120_6

					if var_120_3 == var_120_5.TYPE_ACTIVITY then
						var_120_6 = arg_120_0
						var_120_3 = arg_120_0.emit
						LatestSkinShopMediator = var_1_10007

						var_120_3(var_120_6, var_1_10007.GO_SHOPS_LAYER, arg_120_1:getConfig("activity"))
					else
						var_120_3 = arg_120_1.type
						Goods = var_120_6

						if var_120_3 == var_120_6.TYPE_ACTIVITY_EXTRA then
							if arg_120_1:getConfig("scene") then
								local var_120_7 = #var_120_3

								if 0 < var_120_7 then
									var_1_10007 = arg_120_0

									local var_120_8 = arg_120_0.emit

									LatestSkinShopMediator = var_1_10008

									var_120_8(var_1_10007, var_1_10008.OPEN_SCENE, var_120_3)
							...
							var_120_9(var_1_10007, var_1_10008.OPEN_ACTIVITY, var_120_2)
						end
					end
			...
			do
				local var_120_10 = var_120_3.TipsMgr.GetInstance()
				local var_120_11 = var_5.ShowTips

				i18n = var_1_10007

				var_120_11(var_120_10, var_1_10007("common_activity_not_start"))
			end
...
function var_0_1.OnBackyard(arg_121_0, arg_121_1)
	...
	local var_121_2 = var_1_10004(var_1_10005)
	local var_121_4

	if not var_121_1(var_121_0, var_4.getRawData(var_121_2).level, "BackYardMediator") then
		pg = var_2

		local var_121_3 = var_2.open_systems_limited[1]

		pg = var_121_0
		var_121_4 = var_121_0.TipsMgr.GetInstance()

		local var_121_5 = var_3.ShowTips

		i18n = var_5

		var_121_5(var_121_4, var_5("no_open_system_tip", var_121_3.name, var_121_3.level))
...
function var_0_1.OnExperience(arg_122_0, arg_122_1)
	...
	local var_122_1 = var_1_10003(var_1_10004)
	...
	if var_3.getSkinById(var_122_1, var_122_0) and not var_3:isExpireType() then
		...
		var_122_3(var_122_2, var_1_10006("already_have_the_skin"))

		return
	end

	local var_122_4 = arg_122_1:getConfig("resource_num")
	local var_122_5 = arg_122_1
	local var_122_6 = arg_122_1.getConfig(var_122_5, "time_second") * var_122_4

	pg = var_122_5

	local var_122_7 = var_122_5.TimeMgr.GetInstance()
	...
	i18n = var_1_10014
	var_122_15.content = var_1_10014("exchange_limit_skin_tip", var_122_4, var_122_12, var_122_8, var_122_9)

	function var_122_15.onYes()
		getProxy = var_2_10000
		PlayerProxy = var_2_10001

		local var_123_0 = var_2_10000(var_2_10001)
		local var_123_1 = var_0.getRawData(var_123_0)

		if var_0.getSkinTicket(var_123_1) < var_122_4 then
			pg = var_0
			...
			var_123_3(var_123_2, var_2_10002("common_no_item_1"))
		...
		var_123_5(var_123_4, var_2_10002.ON_SHOPPING, arg_122_1.id, 1)
...
function var_0_1.OnExperience4Item(arg_124_0, arg_124_1)
	...
	local var_124_1 = var_1_10003(var_1_10004)
	...
	if var_3.getSkinById(var_124_1, var_124_0) and not var_3:isExpireType() then
		...
		var_124_3(var_124_2, var_1_10006("already_have_the_skin"))

		return
	end

	local var_124_4 = arg_124_1:getConfig("resource_num")
	local var_124_5 = arg_124_1
	local var_124_6 = arg_124_1.getConfig(var_124_5, "time_second") * var_124_4

	pg = var_124_5

	local var_124_7 = var_124_5.TimeMgr.GetInstance()
	...
	local var_124_13 = var_11(var_1_10012)
	local var_124_14 = var_11.GetSkinExperienceItems(var_124_13)

	_ = var_124_13

	local var_124_15 = var_124_13.detect(var_124_14, function(arg_125_0)
		return arg_125_0:CanUseForShop(arg_124_1.id)
	end)

	pg = var_13

	local var_124_16 = var_13.MsgboxMgr.GetInstance()
	local var_124_17 = var_13.ShowMsgBox
	local var_124_18 = {}

	i18n = var_1_10016
	var_124_18.content = var_1_10016("exchange_limit_skin_tip", var_124_4, var_124_12, var_124_8, var_124_9)

	function var_124_18.onYes()
		if not var_124_15 or var_124_15.count < var_124_4 then
			pg = var_0
			...
			var_126_1(var_126_0, var_2_10002("common_no_item_1"))
		...
		var_126_3(var_126_2, var_2_10002.ON_ITEM_EXPERIENCE, var_124_15.id, arg_124_1.id, 1)
...
function var_0_1.SetFilterPanel(arg_127_0)
	...
	var_127_17(var_127_16, var_127_18, var_1_10012.CampNames, true)
	...
	var_127_20(var_127_19, var_127_21, var_12.RarityNames, true)
	...
	var_127_23(var_127_22, var_127_24, var_12.TypeNames, true)
	...
	local var_127_27 = var_11.Find(var_127_26, "bg")
	...
	var_9(var_127_25, var_127_27, var_127_28, var_13)

	onButton = var_9

	local var_127_29 = arg_127_0
	local var_127_30 = arg_127_0.filterUI
	local var_127_31 = var_11.Find(var_127_30, "panelMask/panel/closeBtn")
	...
	var_9(var_127_29, var_127_31, var_127_32, var_13)

	onButton = var_9

	local var_127_33 = arg_127_0
	local var_127_34 = arg_127_0.filterUI
	local var_127_35 = var_11.Find(var_127_34, "panelMask/panel/bottom/ok")
	...
	var_9(var_127_33, var_127_35, var_127_36, var_13)
		...
		if not arg_134_3 then
			...
			local function var_134_3()
				...
				for iter_135_0 = 0, arg_134_1.childCount - 1 do
					...
					var_135_1(var_135_0, var_6.GetChild(var_135_2, iter_135_0), iter_135_0 == iter_134_0)
				end
			...
			var_9(var_134_1, var_134_2, var_134_3, var_13)
		end
	end
...
function var_0_1.SetMultiOptions(arg_136_0, arg_136_1, arg_136_2, arg_136_3)
	for iter_136_0 = 0, arg_136_1.childCount - 1 do
		...
		var_136_2(var_136_1, var_136_4, var_136_3.contains(arg_136_0.filterValuesTemp[arg_136_2], iter_136_0))
		...
		if not arg_136_3 then
			...
			local function var_136_7()
				...
				if iter_136_0 == 0 then
					...
					for iter_137_0 = 0, arg_136_1.childCount - 1 do
						var_2_10005 = arg_136_0

						local var_137_1 = var_4.SetOptionSelect
						local var_137_2 = arg_136_1

						var_137_1(var_2_10005, var_6.GetChild(var_137_2, iter_137_0), iter_137_0 == 0)
					end
				else
					table = var_137_0
					...
					for iter_137_2 = 0, arg_136_1.childCount - 1 do
						...
						local var_137_8 = var_7.GetChild(var_137_7, iter_137_2)

						table = var_137_7

						var_137_6(var_137_5, var_137_8, var_137_7.contains(arg_136_0.filterValuesTemp[arg_136_2], iter_137_2))
					end
				end
			...
			var_136_2(var_136_5, var_136_6, var_136_7, var_13)
		end
	end
...
function var_0_1.SetOptionSelect(arg_138_0, arg_138_1, arg_138_2)
	...
	if var_4(arg_138_1:Find("Text")) then
		local var_138_1 = arg_138_1:Find("mask/Text")

		var_138_2 = var_138_2.GetComponent
		typeof = var_6
		Text = var_7
		var_138_0 = var_138_2(var_138_1, var_6(var_7))
	else
		...
		typeof = var_6
		Text = var_7
		var_138_0 = var_138_2(var_138_3, var_6(var_7))
	end
...
function var_0_1.HideEmptyOptions(arg_139_0, arg_139_1, arg_139_2)
	...
	for iter_139_0, iter_139_1 in var_4(arg_139_0.commodities) do
		local var_139_1 = iter_139_1

		var_1_10009 = iter_139_1.getSkinId(var_139_1)
		ShipSkin = var_139_1

		local var_139_2 = var_139_1.New({
			id = var_1_10009
		})
		local var_139_3 = arg_139_0
		local var_139_4 = arg_139_0.GetSkinType(var_139_3, var_139_2)

		ipairs = var_139_3

		for iter_139_2, iter_139_3 in var_139_3(var_139_4) do
			table = var_1_10017
		...
		local var_139_6 = arg_139_0.GetShipHave(var_139_5, var_139_2)

		table = var_139_5

		if not var_139_5.keyof(var_139_0.shipHaveType, var_139_6) then
			table = var_13

			var_13.insert(var_139_0.shipHaveType, var_139_6)
		end

		local var_139_7 = arg_139_0
		local var_139_8 = arg_139_0.GetCampType(var_139_7, var_139_2)

		table = var_139_7

		if not var_139_7.keyof(var_139_0.campType, var_139_8) then
			table = var_14

			var_14.insert(var_139_0.campType, var_139_8)
		end

		local var_139_9 = arg_139_0
		local var_139_10 = arg_139_0.GetRarityType(var_139_9, var_139_2)

		table = var_139_9

		if not var_139_9.keyof(var_139_0.rarityType, var_139_10) then
			table = var_15

			var_15.insert(var_139_0.rarityType, var_139_10)
		end

		local var_139_11 = arg_139_0
		local var_139_12 = arg_139_0.GetShipType(var_139_11, var_139_2)

		table = var_139_11

		if not var_139_11.keyof(var_139_0.shipType, var_139_12) then
			table = var_16

			var_16.insert(var_139_0.shipType, var_139_12)
		end

		var_1_10017 = arg_139_0

		local var_139_13 = arg_139_0.GetTagType(var_1_10017, iter_139_1)

		table = var_1_10017

		if not var_1_10017.keyof(var_139_0.tagType, var_139_13) then
			table = var_1_10017

			var_1_10017.insert(var_139_0.tagType, var_139_13)
		end
	end
	...
	for iter_139_6 = 1, arg_139_0.uiTypeOptions.childCount - 1 do
		...
		local var_139_14 = arg_139_0.uiTypeOptions
		local var_139_15 = var_9.GetChild(var_139_14, iter_139_6)

		table = var_139_14

		iter_139_5(var_139_15, var_139_14.contains(var_139_0.typeType, iter_139_6))
	end

	for iter_139_7 = 1, arg_139_0.uiShipHaveOptions.childCount - 1 do
		setActive = iter_139_5

		local var_139_16 = arg_139_0.uiShipHaveOptions
		local var_139_17 = var_9.GetChild(var_139_16, iter_139_7)

		table = var_139_16

		iter_139_5(var_139_17, var_139_16.contains(var_139_0.shipHaveType, iter_139_7))
	end

	for iter_139_8 = 1, arg_139_0.uiCampOptions.childCount - 1 do
		setActive = iter_139_5

		local var_139_18 = arg_139_0.uiCampOptions
		local var_139_19 = var_9.GetChild(var_139_18, iter_139_8)

		table = var_139_18

		iter_139_5(var_139_19, var_139_18.contains(var_139_0.campType, iter_139_8))
	end

	for iter_139_9 = 1, arg_139_0.uiRrarityOptions.childCount - 1 do
		setActive = iter_139_5

		local var_139_20 = arg_139_0.uiRrarityOptions
		local var_139_21 = var_9.GetChild(var_139_20, iter_139_9)

		table = var_139_20

		iter_139_5(var_139_21, var_139_20.contains(var_139_0.rarityType, iter_139_9))
	end

	for iter_139_10 = 1, arg_139_0.uiShipTypeOptions.childCount - 1 do
		setActive = iter_139_5

		local var_139_22 = arg_139_0.uiShipTypeOptions
		local var_139_23 = var_9.GetChild(var_139_22, iter_139_10)

		table = var_139_22

		iter_139_5(var_139_23, var_139_22.contains(var_139_0.shipType, iter_139_10))
	end

	for iter_139_11 = 1, arg_139_0.uiTagTypeOptions.childCount - 1 do
		setActive = iter_139_5

		local var_139_24 = arg_139_0.uiTagTypeOptions
		local var_139_25 = var_9.GetChild(var_139_24, iter_139_11)

		table = var_139_24

		iter_139_5(var_139_25, var_139_24.contains(var_139_0.tagType, iter_139_11))
	end
...
function var_0_1.GetCampType(arg_143_0, arg_143_1)
	...
	local var_143_0 = arg_143_0:ToVShip(var_2)
	local var_143_1 = var_3.getNation(var_143_0)

	ShipIndexCfg = var_143_0

	local var_143_2 = var_143_0.camp

	ipairs = var_1_10006

	for iter_143_0, iter_143_1 in var_1_10006(var_143_2) do
		ipairs = var_1_10011
		...
		for iter_143_2, iter_143_3 in var_1_10011(iter_143_1.types) do
			...
			if iter_143_3 == var_1_10016.LINK then
				...
				if var_1_10016.LINK <= var_143_1 then
					return iter_143_0 - 1
				end
...
function var_0_1.GetRarityType(arg_144_0, arg_144_1)
	...
	local var_144_0 = arg_144_0:ToVShip(var_2)
	local var_144_1 = var_3.getRarity(var_144_0)

	ShipIndexCfg = var_144_0

	local var_144_2 = var_144_0.rarity

	ipairs = var_1_10006

	for iter_144_0, iter_144_1 in var_1_10006(var_144_2) do
		table = var_1_10011

		if var_1_10011.contains(iter_144_1.types, var_144_1) then
			return iter_144_0 - 1
		end
	end
...
function var_0_1.GetShipType(arg_145_0, arg_145_1)
	...
	local var_145_0 = arg_145_0:ToVShip(var_2)
	local var_145_1 = var_3.getShipType(var_145_0)

	ShipIndexCfg = var_145_0

	local var_145_2 = var_145_0.type

	ipairs = var_1_10006

	for iter_145_0, iter_145_1 in var_1_10006(var_145_2) do
		pairs = var_1_10011

		for iter_145_2, iter_145_3 in var_1_10011(iter_145_1) do
			table = var_1_10016

			if var_1_10016.keyof(iter_145_3, var_145_1) then
				return iter_145_0 - 1
			end
		end
	end
...
function var_0_1.GetTagType(arg_146_0, arg_146_1)
	...
	NewShopSkinCard = var_3

	if var_3.GetTagId(arg_146_1, var_146_0) > 0 then
		return var_3
	else
		return 0
	end
...
function var_0_1.GetSkinClassify(arg_147_0)
	...
	for iter_147_0, iter_147_1 in var_1_10003(arg_147_0.commodities) do
		...
		local var_147_3 = arg_147_0.GetShopTypeIdBySkinId

		var_1_10011 = iter_147_1

		local var_147_4

		if var_147_3(var_147_2, iter_147_1.getSkinId(var_1_10011)) ~= 0 or not var_0_17 then
			var_147_4 = var_8
		end

		local var_147_5

		if not var_147_1[var_147_4] then
			var_147_5 = 0
		end

		var_147_1[var_147_4] = var_147_5 + 1
	end
	...
	for iter_147_2, iter_147_3 in var_4(arg_147_0.returnSkins) do
		var_147_6[iter_147_3] = true
	end

	underscore = var_4

	if var_4.any(arg_147_0.commodities, function(arg_148_0)
		return var_147_6[arg_148_0.id]
	end) then
		table = var_4
	...
	for iter_147_4, iter_147_5 in var_4(var_5.skin_page_template.all) do
		if iter_147_5 ~= var_0_18 and iter_147_5 ~= var_0_19 then
			...
			if var_147_7 > 0 then
				...
				var_147_7.insert(var_147_0, iter_147_5)
			end
		end
	end
	...
	for iter_147_6, iter_147_7 in var_4(arg_147_0.classifyIds) do
		if iter_147_7 == var_0_13 then
			...
			var_147_8(var_147_9, var_1_10011("shop_filter_all"))
		elseif iter_147_7 == var_0_14 or iter_147_7 == var_0_16 then
			table = var_9

			local var_147_10 = var_9.insert
			local var_147_11 = arg_147_0.classifyNames

			i18n = var_1_10011

			var_147_10(var_147_11, var_1_10011("shop_filter_trial"))
		else
			local var_147_12

			if iter_147_7 == var_0_15 then
				table = var_147_12
				var_147_12 = var_147_12.insert

				local var_147_13 = arg_147_0.classifyNames

				i18n = var_1_10011

				var_147_12(var_147_13, var_1_10011("shop_filter_retro"))
			else
				table = var_147_12

				local var_147_14 = var_147_12.insert
				local var_147_15 = arg_147_0.classifyNames

				pg = var_1_10011

				var_147_14(var_147_15, var_1_10011.skin_page_template[iter_147_7].name)
			end
		end
	end
...
function var_0_1.onBackPressed(arg_154_0)
	...
	var_154_1(var_154_0, var_1_10003.CLOSE_VIEW)
