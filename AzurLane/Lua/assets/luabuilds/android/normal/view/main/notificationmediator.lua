...
function var_0_1.register(arg_1_0)
		...
		if arg_2_2 == "$ force gc" then
			...
			if arg_2_2:match("%$ rndskin print %d+") then
				...
				if var_3.isEditor then
					...
					MainRandomFlagShipSequence = var_4

					local var_2_1 = var_4.CalcRatio

					tonumber = var_5

					var_2_1(var_5(var_2_0()), function(arg_3_0)
						local var_3_0 = {
							richText = true
						}
						...
						local var_3_1 = var_3_10002(var_3_10003)
						...
						local var_3_5 = var_3_10004.New

						ChatConst = var_3_10005

						var_3_4(var_3_3, var_3_5(var_3_10005.ChannelWorld, var_3_0))
			...
			if arg_2_2:match("^%$ battletest") then
				...
				NewMainMediator = var_5

				var_2_3(var_2_2, var_5.DEBUG_BATTLE_LOOP, arg_2_2)
			else
				...
				if arg_2_2.match(var_2_4, "^%$ %S+") then
					...
					var_2_4(var_2_6, var_2_10006.SEND_CMD, {
						cmd = var_2_5[1],
						arg1 = var_2_5[2],
						arg2 = var_2_5[3],
						arg3 = var_2_5[4],
				...
				elseif arg_2_2 == "world battle skip" then
					...
					if arg_2_2 == var_2_5.gameset.code_switch.description then
						...
						local var_2_7 = var_3(var_2_4)
						local var_2_8 = var_3.getRawData(var_2_7).level

						if 9 <= var_2_8 then
							HXSet = var_2_8

							var_2_8.switchCodeMode()
						end
					else
						getProxy = var_3
						PlayerProxy = var_2_4
						...
						getProxy = var_2_9
						ChatProxy = var_2_10006

						local var_2_11 = var_2_9(var_2_10006)
						...
						if var_8.GetServerTime(var_2_14) < var_2_10.chatMsgBanTime then
							...
							pg = var_2_16
							iter_2_2 = var_2_16.MsgboxMgr.GetInstance()
							var_2_16 = var_2_16.ShowMsgBox
							var_2_10012 = {
								hideNo = true
							}
							i18n = var_2_10013
							var_2_10012.content = var_2_10013("chat_msg_ban", var_2_15)

							var_2_16(iter_2_2, var_2_10012)
						else
							PLATFORM_CODE = var_2_15
							PLATFORM_CH = var_2_16

							if var_2_15 == var_2_16 then
								LuaHelper = var_2_15

								local var_2_17 = var_2_15.GetCHPackageType()

								PACKAGE_TYPE_BILI = var_2_16

								if var_2_17 ~= var_2_16 and var_2_10.level < 70 then
									pg = var_9

									local var_2_18 = var_9.TipsMgr.GetInstance()
									local var_2_19 = var_9.ShowTips

									i18n = iter_2_2

									var_2_19(var_2_18, iter_2_2("chat_level_not_enough", 70))
							...
							if var_2_10.level < 10 then
								...
								local var_2_20 = var_9.TipsMgr.GetInstance()
								local var_2_21 = var_9.ShowTips

								i18n = iter_2_2

								var_2_21(var_2_20, iter_2_2("chat_level_not_enough", 10))
							else
								local var_2_22

								if var_8 - var_2_13 < 10 then
									var_2_22 = 10 - (var_8 - var_2_13)
									pg = var_10

									local var_2_23 = var_10.TipsMgr.GetInstance()
									local var_2_24 = var_10.ShowTips

									i18n = var_2_10012

									var_2_24(var_2_23, var_2_10012("dont_send_message_frequently", var_2_22))
								else
									wordVer = var_2_22

									local var_2_25, var_2_26 = var_2_22(arg_2_2, {
										isReplace = true
									})
									...
									if arg_2_1 == var_11.ChannelWorld then
										...
										var_2_28 = var_2_28.sendNotification
										GAME = var_2_10013

										var_2_28(var_2_27, var_2_10013.SEND_MSG, var_2_26)
									else
										ChatConst = var_2_28

										if arg_2_1 == var_2_28.ChannelGuild then
											local var_2_29 = arg_1_0

											var_2_28 = var_2_28.sendNotification
											GAME = var_2_10013

											var_2_28(var_2_29, var_2_10013.GUILD_SEND_MSG, var_2_26)
										end
									end

									pg = var_2_28

									local var_2_30 = var_2_28.GameTrackerMgr.GetInstance()
									local var_2_31 = var_11.Record

									GameTrackerBuilder = var_2_10013

									var_2_31(var_2_30, var_2_10013.BuildEmoji(var_2_26))
								end
							end
						end
					end
	...
	arg_1_0:bind(var_0_1.CHANGE_ROOM, function(arg_4_0, arg_4_1)
		...
		if arg_4_1 == var_2.getRawData(var_4_0).chatRoomId then
			...
			var_4_3(var_4_2, var_2_10006.CHANGE_CHAT_ROOM, arg_4_1)
		end
	...
	arg_1_0:bind(var_0_1.BATTLE_CHAT_CLOSE, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10003.CLOSE_CHAT)
	...
	arg_1_0:bind(var_0_1.OPEN_INFO, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		local var_6_2 = var_2_10006.FRIEND_SEARCH
		local var_6_3 = {}

		SearchFriendCommand = var_2_10008
		var_6_3.type = var_2_10008.SEARCH_TYPE_RESUME
	...
	arg_1_0:bind(var_0_1.OPEN_EMOJI, function(arg_7_0, arg_7_1, arg_7_2)
		...
		var_7_4.groupName = var_8.getGroupName(var_7_5)
...
function var_0_1.handleNotification(arg_10_0, arg_10_1)
	...
	if var_10_0 ~= var_10_1.NEW_MSG then
		FriendProxy = var_10_3

		if var_10_0 ~= var_10_3.FRIEND_NEW_MSG then
			GuildProxy = var_10_3

			if var_10_0 == var_10_3.NEW_MSG_ADDED then
				local var_10_3 = arg_10_0.viewComponent.messages

				table = var_1_10005

				var_1_10005.insert(var_10_3, var_10_2)

				var_1_10006 = arg_10_0.viewComponent

				var_5.setMessages(var_1_10006, var_10_3)

				getProxy = var_5
				PlayerProxy = var_1_10006

				local var_10_4 = var_5(var_1_10006)

				var_1_10006 = var_5.getRawData(var_10_4)
				NotificationLayer = var_10_4

				local var_10_5 = var_10_4.ChannelBits.recv

				bit = var_1_10008
				var_1_10008 = var_1_10008.lshift

				local var_10_6 = 1

				ChatConst = var_1_10010

				if var_10_5 ~= var_1_10008(var_10_6, var_1_10010.ChannelAll) then
					bit = var_1_10008
					var_1_10008 = var_1_10008.band

					local var_10_7 = var_10_5

					bit = var_10

					if var_1_10008(var_10_7, var_10.lshift(1, var_10_2.type)) > 0 then
						table = var_1_10008

						var_1_10008.insert(arg_10_0.viewComponent.filteredMessages, var_10_2)

						local var_10_8 = arg_10_0.viewComponent

						var_1_10008.append(var_10_8, var_10_2, -1, true)
					elseif var_10_2.player and var_10_2.player.id == var_1_10006.id then
						local var_10_9 = arg_10_0.viewComponent.recvTypes

						var_1_10008.each(var_10_9, function(arg_11_0, arg_11_1)
							ChatConst = var_2_10002

							if var_2_10002.RecvChannels[arg_11_0 + 1] == var_10_2.type then
								triggerButton = var_2
					...
					if false then
						...
						if var_10_0 == var_10_3.SEND_CMD_DONE then
							string = var_4

							if var_4.find(var_10_2, "CMD:into") then
								local var_10_10 = arg_10_0.viewComponent

								var_4.closeView(var_10_10)
							end
						else
							GAME = var_4

							if var_10_0 == var_4.CHANGE_CHAT_ROOM_DONE then
								arg_10_0:onChangeChatRoomDone(var_10_2)
							else
								GAME = var_4

								local var_10_12

								if var_10_0 == var_4.CHAT_ROOM_MAX_NUMBER then
									pg = var_10_12

									local var_10_11 = var_10_12.TipsMgr.GetInstance()

									var_10_12 = var_10_12.ShowTips
									i18n = var_1_10006

									var_10_12(var_10_11, var_1_10006("main_notificationMediator_room_max_number"))
								else
									GAME = var_10_12

									local var_10_14

									if var_10_0 == var_10_12.FRIEND_SEARCH_DONE then
										if var_10_2.list[1] then
											local var_10_13 = arg_10_0

											var_10_14 = arg_10_0.addSubLayers
											Context = var_1_10006

											local var_10_15 = var_1_10006.New
											local var_10_16 = {}

											FriendInfoLayer = var_1_10008
											var_10_16.viewComponent = var_1_10008
											FriendInfoMediator = var_1_10008
											var_10_16.mediator = var_1_10008

											local var_10_17 = {
												friend = var_10_2.list[1],
											...
											var_10_17.groupName = var_9.getGroupName(var_10_18)
											var_10_16.data = var_10_17

											var_10_14(var_10_13, var_10_15(var_10_16))

											var_10_14 = arg_10_0.contextData
											var_10_14.pos = nil
											var_10_14 = arg_10_0.contextData
											var_10_14.msg = nil
										end
										...
										if var_10_0 == var_10_14.FINISH_STAGE then
											...
											if var_10_0 == var_4.GO_WORLD_BOSS_SCENE then
												local var_10_20 = arg_10_0.viewComponent

												var_4.closeView(var_10_20)
											end
										end
									end
								end
