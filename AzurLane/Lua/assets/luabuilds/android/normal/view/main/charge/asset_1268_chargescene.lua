...
function var_0_1.preload(arg_3_0, arg_3_1)
	...
	if var_3_0:ShouldRefreshChargeList() then
		...
		var_3_3(var_3_2, var_1_10006.GET_CHARGE_LIST, {
			callback = var_3_1
		})
	else
		var_3_1()
...
function var_0_1.init(arg_11_0)
	...
	LOCK_SKIN_SHOP_ENTER = var_11_10
	...
	if var_11_10 then
		...
		var_11_9 = var_11_10(var_11_9)
		var_11_10 = var_11_10.getData(var_11_9).level
		LOCK_SKIN_SHOP_ENTER_LEVEL = var_11_9
		var_11_10 = var_11_10 < var_11_9
	end

	setActive = var_11_9

	var_11_9(arg_11_0.skinShopBtn, not var_11_10)

	local var_11_11 = arg_11_0.viewContainer

	arg_11_0.itemToggle = var_2.Find(var_11_11, "toggle_list/item_toggle")

	local var_11_12 = arg_11_0.viewContainer

	arg_11_0.giftToggle = var_2.Find(var_11_12, "toggle_list/gift_toggle")

	local var_11_13 = arg_11_0.viewContainer

	arg_11_0.diamondToggle = var_2.Find(var_11_13, "toggle_list/diamond_toggle")

	local var_11_14 = arg_11_0.giftToggle

	arg_11_0.giftTip = var_2.Find(var_11_14, "tip")

	local var_11_15 = arg_11_0.viewContainer

	arg_11_0.pickToggle = var_2.Find(var_11_15, "toggle_list/pick_toggle")

	local var_11_16 = arg_11_0.pickToggle

	arg_11_0.pickTip = var_2.Find(var_11_16, "tip")
	ChargeTipWindow = var_2
	arg_11_0.chargeTipWindow = var_2.New(arg_11_0._tf, arg_11_0.event)

	local var_11_17 = arg_11_0.diamondToggle
	local var_11_18 = var_2.Find(var_11_17, "light/title")
	local var_11_19 = arg_11_0.diamondToggle
	local var_11_20 = var_3.Find(var_11_19, "dark/title")
	local var_11_21 = arg_11_0.giftToggle
	local var_11_22 = var_4.Find(var_11_21, "light/title")
	local var_11_23 = arg_11_0.giftToggle
	local var_11_24 = var_5.Find(var_11_23, "dark/title")
	local var_11_25 = arg_11_0.itemToggle
	local var_11_26 = var_6.Find(var_11_25, "light/title")
	local var_11_27 = arg_11_0.itemToggle
	local var_11_28 = var_7.Find(var_11_27, "dark/title")
	local var_11_29 = arg_11_0.pickToggle
	local var_11_30 = var_8.Find(var_11_29, "light/title")
	local var_11_31 = arg_11_0.pickToggle
	local var_11_32 = var_9.Find(var_11_31, "dark/title")

	setText = var_11_31

	local var_11_33 = var_11_18

	i18n = var_1_10012

	var_11_31(var_11_33, var_1_10012("shop_diamond_title"))

	setText = var_11_31

	local var_11_34 = var_11_20

	i18n = var_12

	var_11_31(var_11_34, var_12("shop_diamond_title"))

	setText = var_11_31

	local var_11_35 = var_11_22

	i18n = var_12

	var_11_31(var_11_35, var_12("shop_gift_title"))

	setText = var_11_31

	local var_11_36 = var_11_24

	i18n = var_12

	var_11_31(var_11_36, var_12("shop_gift_title"))

	setText = var_11_31

	local var_11_37 = var_11_26

	i18n = var_12

	var_11_31(var_11_37, var_12("shop_item_title"))

	setText = var_11_31

	local var_11_38 = var_11_28

	i18n = var_12

	var_11_31(var_11_38, var_12("shop_item_title"))

	setText = var_11_31

	local var_11_39 = var_11_30

	i18n = var_12

	var_11_31(var_11_39, var_12("shop_akashi_pick_title"))

	setText = var_11_31

	local var_11_40 = var_11_32

	i18n = var_12

	var_11_31(var_11_40, var_12("shop_akashi_pick_title"))

	local var_11_41 = {}
	local var_11_42 = arg_11_0.top

	var_11_41[1] = var_11.Find(var_11_42, "title/title_diamond")

	local var_11_43 = arg_11_0.top

	var_11_41[2] = var_11.Find(var_11_43, "title/title_gift")

	local var_11_44 = arg_11_0.top

	var_11_41[3] = var_11.Find(var_11_44, "title/title_item")

	local var_11_45 = arg_11_0.top

	var_11_41[4] = var_11.Find(var_11_45, "title/title_pick")
	arg_11_0.linkTitle = var_11_41
	arg_11_0.toggleList = {
	...
	if var_10.GetLive2DArm32MatchAble() then
		...
		local var_11_46 = var_10.New({
			configId = 312011
		})
		local var_11_47 = var_10.getPainting(var_11_46)

		LoadPaintingPrefabAsync = var_11_46

		var_11_46(arg_11_0.painting, var_11_47, var_11_47, "mainNormal", function()
	...
	local var_11_48 = arg_11_0.live2dTimer

	var_10.Start(var_11_48)
	arg_11_0:jpUIInit()
	arg_11_0:blurView()
...
function var_0_1.didEnter(arg_14_0)
	...
	local var_14_2 = var_3.Find(var_14_1, "back_button")
	...
	var_1_10001(var_14_0, var_14_2, var_14_3, var_14_7)
	...
	local function var_14_6()
		...
		ChargeMediator = var_2_10002

		var_16_2(var_16_1, var_2_10002.CLICK_MING_SHI)
	...
	var_1_10001(var_14_4, var_14_5, var_14_6, var_14_7)
	...
	for iter_14_0 = 1, #arg_14_0.toggleList do
		...
		local function var_14_10(arg_17_0)
			...
			var_17_0(var_17_1, not arg_17_0)
		...
		var_1_10006(var_14_8, var_14_9, var_14_10, var_1_10010)
	end
	...
	local function var_14_13()
		...
		local var_18_2 = var_2_10002.SWITCH_TO_SHOP
		local var_18_3 = {}

		NewShopsScene = var_2_10004
		var_18_3.warp = var_2_10004.TYPE_SHOP_STREET
	...
	var_1(var_14_11, var_14_12, var_14_13, var_14_7)
	...
	local function var_14_16()
		...
		var_19_1(var_19_0, var_2_10002.ON_SKIN_SHOP)
	...
	var_1(var_14_14, var_14_15, var_14_16, var_14_7)
...
function var_0_1.initSubView(arg_22_0)
	...
	ChargeScene = var_2
	var_22_1[var_2.TYPE_DIAMOND] = arg_22_0.diamondShopView
	ChargeScene = var_2
...
function var_0_1.switchSubView(arg_23_0, arg_23_1)
	...
	if arg_23_0.subViewList[arg_23_0.curSubViewNum] then
		...
		var_2.Destroy(var_23_3)
	end

	arg_23_0.curSubViewNum = arg_23_1
	PLATFORM_CODE = var_3
	PLATFORM_JP = var_23_3

	if var_3 == var_23_3 then
		setActive = var_3
	...
	for iter_23_0, iter_23_1 in var_3(arg_23_0.linkTitle) do
		...
		var_1_10008(iter_23_1, iter_23_0 == arg_23_1)
	end
...
function var_0_1.updateNoRes(arg_26_0, arg_26_1)
	...
	local var_26_1 = var_26_0(var_3)
	local var_26_2 = var_2.getData(var_26_1)
	local var_26_3 = ""

	ipairs = var_1_10005

	for iter_26_0, iter_26_1 in var_1_10005(arg_26_1) do
		if iter_26_1[2] > 0 then
			if iter_26_1[1] == 59001 then
				...
				var_1_10010[2] = var_26_4 - var_1_10012
			end
		end
	...
	for iter_26_2, iter_26_3 in var_5(arg_26_0.contextData.noRes) do
		...
		i18n = var_1_10012
		var_26_3 = var_26_5 .. var_1_10012(iter_26_3[1] == 59001 and "text_noRes_info_tip" or "text_noRes_info_tip2", var_1_10010, iter_26_3[2])

		if iter_26_2 < #arg_26_0.contextData.noRes then
			local var_26_6 = var_26_3

			i18n = var_1_10012
			var_26_3 = var_26_6 .. var_1_10012("text_noRes_info_tip_link")
		end
	end

	if var_26_3 == "" then
		local var_26_7 = arg_26_0
		local var_26_8 = arg_26_0.displayShipWord

		i18n = var_7

		var_26_8(var_26_7, var_7("text_shop_enoughRes_tip"), false)
	else
		local var_26_9 = arg_26_0
		local var_26_10 = arg_26_0.displayShipWord

		i18n = var_7

		var_26_10(var_26_9, var_7("text_shop_noRes_tip", var_26_3), true)
	end
...
function var_0_1.displayShipWord(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	if not arg_27_0.chatFlag then
		if not arg_27_1 and arg_27_0.contextData.noRes and #arg_27_0.contextData.noRes > 0 then
			...
			var_4(arg_27_0.chat, false)

			local var_27_0 = arg_27_0.chat.transform

			Vector3 = var_5
			var_27_0.localScale = var_5(0, 0, 1)
		end
		...
		local var_27_2 = var_4.getChargeLevel(var_27_1)

		if not arg_27_3 then
			::label_27_0::

			math = var_27_1
			var_27_1 = var_27_1.random(1, var_27_2)
		end
		...
		if arg_27_3 then
			pg = var_1_10007
			var_27_3 = var_1_10007.pay_level_award[var_27_1].dialog
		...
		var_1_10007(arg_27_0.chatText, var_27_3)

		local var_27_4 = arg_27_0.chatText
		local var_27_5 = var_7.GetComponent

		typeof = var_9
		Text = var_1_10010

		local var_27_6 = #var_27_5(var_27_4, var_9(var_1_10010)).text

		CHAT_POP_STR_LEN_SHORT = var_9

		if var_9 < var_27_6 then
			TextAnchor = var_27_6
			var_7.alignment = var_27_6.MiddleLeft
		else
			TextAnchor = var_27_6
			var_7.alignment = var_27_6.MiddleCenter
		end
		...
		;(function()
			...
			local var_28_3 = var_2_10003(arg_27_0.chat.gameObject)

			Vector3 = var_4

			local var_28_4 = var_28_2(var_28_3, var_4.New(1, 1, 1), var_28_1)
			local var_28_5 = var_2.setFrom

			Vector3 = var_4

			local var_28_6 = var_28_5(var_28_4, var_4.New(0, 0, 0))
			local var_28_7 = var_2.setEase

			LeanTweenType = var_4

			local var_28_8 = var_28_7(var_28_6, var_4.easeOutBack)
			local var_28_9 = var_2.setOnComplete

			System = var_4

			var_28_9(var_28_8, var_4.Action(function()
				if not arg_27_2 then
					...
					local var_29_1 = var_3_10001(arg_27_0.chat.gameObject)

					Vector3 = var_2

					local var_29_2 = var_29_0(var_29_1, var_2.New(0, 0, 1), var_28_1)
					local var_29_3 = var_0.setEase

					LeanTweenType = var_2

					local var_29_4 = var_29_3(var_29_2, var_2.easeInBack)
					local var_29_5 = var_0.setDelay(var_29_4, var_28_1 + var_28_0)
					local var_29_6 = var_0.setOnComplete

					System = var_2

					var_29_6(var_29_5, var_2.Action(function()
...
function var_0_1.InitChatPosition(arg_31_0)
	...
	Vector3 = var_5
	var_31_6.localPosition = var_5(var_31_5.x, var_31_5.y, 0)
...
function var_0_1.playHeartEffect(arg_32_0)
	...
	Timer = var_32_1
	arg_32_0.heartsTimer = var_32_1.New(function()
...
function var_0_1.createLive2D(arg_34_0)
	...
	Vector3 = var_3
	var_34_1.position = var_3(0, 0, 0)

	local var_34_2 = arg_34_0._tf

	var_34_1.parent = var_3.Find(var_34_2, "frame/painting/live2d")

	local var_34_3 = var_34_0(var_34_1)

	Live2DPainting = var_34_1
	arg_34_0.live2dChar = var_34_1.New(var_34_3, function(arg_35_0)
		local var_35_0 = arg_35_0
		local var_35_1 = arg_35_0.setSortingLayer

		LayerWeightConst = var_2_10003

		var_35_1(var_35_0, var_2_10003.L2D_DEFAULT_LAYER)
...
function var_0_1.checkBuyDone(arg_36_0, arg_36_1)
	if arg_36_0.live2dChar then
		var_1_10003 = arg_36_0.live2dChar
		...
		local var_36_1 = arg_36_0.preAniName == "gold" or arg_36_0.preAniName == "diamond"
		local var_36_2 = var_36_0 == "gold" or var_36_0 == "diamond"
		local var_36_3 = var_36_1 and var_36_2 or not var_36_1

		var_36_3 = var_36_0 and arg_36_0.preAniName ~= var_36_0 and var_36_3

		if var_36_3 then
			arg_36_0.preAniName = var_36_0

			local var_36_4 = arg_36_0.live2dChar

			var_6.TriggerAction(var_36_4, var_36_0, nil, true)
		end
...
function var_0_1.blurView(arg_39_0)
	...
	var_39_4[1] = var_6.Find(var_39_5, "blurBg")
...
function var_0_1.jpUIEnter(arg_42_0)
	...
	local function var_42_2()
		...
		var_43_2(var_43_1, var_2_10003.OPEN_USER_AGREE, var_43_0 or "")
	...
	local function var_42_5()
		...
		var_44_2(var_44_1, var_2_10003.OPEN_USER_AGREE, var_44_0 or "")
...
function var_0_1.addRefreshTimer(arg_45_0, arg_45_1)
	...
	arg_45_0.refreshTimer = var_3.New(function()
		...
		if var_47_0 - var_1.GetServerTime(var_47_1) <= 0 then
			...
			var_47_3(var_47_2, var_2_10003.GET_CHARGE_LIST)
		else
			pg = var_47_3
