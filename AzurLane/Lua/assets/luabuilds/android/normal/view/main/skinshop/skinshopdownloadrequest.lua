...
function var_0_0.CalcListSize(arg_1_0)
	...
	local var_1_1 = var_2.CalcSizeWithFileArr(var_0_0.Live2DGroupName, var_1_0)
...
function var_0_0.Start(arg_3_0, arg_3_1, arg_3_2)
	...
	if var_3_0 > 0 then
		...
		MSGBOX_TYPE_NORMAL = var_1_10010
		var_3_6.type = var_1_10010
		string = var_1_10010

		local var_3_7 = var_1_10010.format

		i18n = var_1_10011
		var_3_6.content = var_3_7(var_1_10011("group_download_tip", var_3_1))
...
function var_0_0.success(arg_8_0)
	if arg_8_0.onSuccess then
		...
		var_8_0(var_1_10002(arg_8_0.filePath))
	end
...
function var_0_0.error(arg_9_0, arg_9_1, arg_9_2)
	...
	i18n = var_1_10008
	var_9_4.content = var_1_10008("file_down_mgr_error", arg_9_1, arg_9_2)
...
function var_0_0.Refresh(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if var_12_1 ~= var_6.None then
		...
		local var_12_5 = var_4.CheckF(var_12_4, arg_12_2)

		DownloadState = var_12_4

		if var_12_5 == var_12_4.None then
			-- block empty
		else
			DownloadState = var_9

			if var_12_5 == var_9.Checking then
				-- block empty
			else
				DownloadState = var_9

				if var_12_5 == var_9.CheckToUpdate and arg_12_1 then
					VersionMgr = var_9

					local var_12_6 = var_9.Inst

					var_9.RequestUIForUpdateF(var_12_6, "L2D", arg_12_2, true)
				else
					DownloadState = var_9

					if var_12_5 == var_9.CheckToUpdate then
						isActive = var_9
					...
					if var_12_5 == var_9.CheckOver then
						-- block empty
					else
						DownloadState = var_9

						if var_12_5 == var_9.CheckFailure then
							var_12_3 = true
						else
							DownloadState = var_9

							if var_12_5 == var_9.Updating then
								-- block empty
							else
								DownloadState = var_9

								if var_12_5 == var_9.UpdateFailure then
									var_12_3 = true
								else
									DownloadState = var_9

									if var_12_5 == var_9.UpdateSuccess then
										var_12_3 = true
										checkABExist = var_9
		...
		if var_12_5 ~= var_9.CheckToUpdate then
			...
			if var_12_5 ~= var_9.UpdateFailure then
				...
				if var_12_5 == var_9.Updating then
					...
					local var_12_8 = arg_12_0.live2dTimer

					var_9.Start(var_12_8)
				end
