...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_8()
		...
		MonthCardSetMediator = var_2_10002

		var_8_1(var_8_0, var_2_10002.ON_SET_RATIO, arg_5_0.ratio)
...
function var_0_1.updateView(arg_10_0)
	...
	local var_10_2 = var_10_1(var_10_0, var_1_10003.MONTH)

	math = var_10_0

	local var_10_3 = var_10_0.floor
	...
	local var_10_7 = var_10_3((var_10_5 - var_4.GetServerTime(var_10_6)) / 0)
	...
	var_3(var_10_8, var_10_6.format("贸易许可证（剩余%s天）", var_10_7))

	setText = var_3

	var_3(arg_10_0.rate, "1 : 5")
