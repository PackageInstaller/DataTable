...
function var_0_1.Init(arg_6_0, arg_6_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_6_0.goldMax = var_6_1(var_6_0, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_6_0.goldValue = var_6_3(var_6_2, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_6_0.oilMax = var_6_5(var_6_4, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_6_0.oilValue = var_6_7(var_6_6, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_6_0.gemValue = var_6_9(var_6_8, var_4(var_1_10005))
	...
	arg_6_0.animation = var_6_11(var_6_10, var_4(var_1_10005))
	...
	Vector2 = var_4
	arg_6_0.foldableHelper = var_6_12(var_6_13, var_4(0, 1))
	onButton = var_2
	...
	var_2(var_6_14, var_6_15, var_6_16, var_6)
	...
	var_2(var_6_17, var_6_18, var_6_19, var_6)
	...
	var_2(var_6_20, var_6_21, var_6_22, var_6)
...
function var_0_1.Enable(arg_14_0, arg_14_1)
	if not arg_14_0:IsLoaded() then
		arg_14_0:Load(function(arg_15_0)
			...
			var_15_1(var_15_0, var_3.Find(var_15_2, "frame").gameObject)
...
function var_0_1.CustomSetting(arg_17_0, arg_17_1)
	...
	var_1_10003(var_17_1, var_1_10005.band(var_17_0, var_0_1.TYPE_OIL) > 0)
	...
	var_1_10003(var_17_2, var_5.band(var_17_0, var_0_1.TYPE_GOLD) > 0)
	...
	var_1_10003(var_17_3, var_5.band(var_17_0, var_0_1.TYPE_GEM) > 0)
	...
	Vector3 = var_5
	var_17_5.anchoredPosition3D = var_5(arg_17_0.gemPos.x + var_17_4, arg_17_0.gemPos.y, 1)
...
function var_0_1.ClickGem(arg_19_0)
	...
	local function var_19_1()
		...
		if not var_20_1(var_20_0, var_2_10002.__cname) then
			pg = var_20_3
			...
			local var_20_4 = var_2.GO_SCENE

			SCENE = var_2_10003

			local var_20_5 = var_2_10003.CHARGE
			local var_20_6 = {}

			ChargeScene = var_2_10005
			var_20_6.wrap = var_2_10005.TYPE_DIAMOND
	...
	if var_1_10003 == var_1_10004 then
		...
		local var_19_2 = var_1_10003.MsgboxMgr.GetInstance()
		local var_19_3 = var_3.ShowMsgBox
		local var_19_4 = {
			fontSize = 23,
			yesText = "text_buy"
		}
		...
		i18n = var_1_10006
		var_19_4.content = var_1_10006("word_diamond_tip", var_19_0:getFreeGem(), var_19_0:getChargeGem(), var_19_0:getTotalGem())
		var_19_4.onYes = var_19_1
		TextAnchor = var_6
		var_19_4.alignment = var_6.UpperLeft

		var_19_3(var_19_2, var_19_4)
	else
		var_19_1()
	end
...
function var_0_1.ClickOil(arg_22_0)
	...
	local var_22_2 = var_22_0.shop_template

	ShoppingStreet = var_1_10003

	local var_22_3 = var_1_10003.getRiseShopId

	ShopArgs = var_1_10004

	local var_22_5

	if not var_22_3(var_1_10004.BuyOil, var_22_1.buyOilCount) then
		pg = var_22_5

		local var_22_4 = var_22_5.TipsMgr.GetInstance()

		var_22_5 = var_22_5.ShowTips
		i18n = var_1_10006

		var_22_5(var_22_4, var_1_10006("common_today_buy_limit"))
	...
	local var_22_6 = var_22_5.shop_template[var_3].num
	local var_22_7

	if var_4.num == -1 then
		var_22_7 = var_4.genre
		ShopArgs = var_1_10007

		if var_22_7 == var_1_10007.BuyOil then
			ShopArgs = var_22_7
			var_22_6 = var_22_7.getOilByLevel(var_22_1.level)
		end
	end

	pg = var_22_7

	local var_22_8 = var_22_7.gameset.buy_oil_limit.key_value
	local var_22_10

	if var_22_1.buyOilCount < var_22_8 then
		pg = var_22_10

		local var_22_9 = var_22_10.MsgboxMgr.GetInstance()

		var_22_10 = var_22_10.ShowMsgBox

		local var_22_11 = {}

		MSGBOX_TYPE_SINGLE_ITEM = var_1_10010
		var_22_11.type = var_1_10010
		var_22_11.windowSize = {
			y = 570
		}
		i18n = var_1_10010
		var_22_11.content = var_1_10010("oil_buy_tip", var_4.resource_num, var_22_6, var_22_1.buyOilCount)
		var_1_10010 = {
			id = 2
		}
		DROP_TYPE_RESOURCE = var_11
		var_1_10010.type = var_11
		var_1_10010.count = var_22_6
		var_22_11.drop = var_1_10010

		function var_22_11.onYes()
			pg = var_2_10000
			...
			var_23_1(var_23_0, var_2_10002.SHOPPING, {
			...
			var_23_3(var_23_2, var_2)

			return
		end

		var_22_10(var_22_9, var_22_11)
	else
		pg = var_22_10

		local var_22_12 = var_22_10.MsgboxMgr.GetInstance()
		local var_22_13 = var_7.ShowMsgBox
		local var_22_14 = {}

		MSGBOX_TYPE_HELP = var_1_10010
		var_22_14.type = var_1_10010
		i18n = var_1_10010
		var_22_14.helps = var_1_10010("help_oil_buy_limit")
		...
		var_22_16.sound = var_1_10012
		var_22_15[1] = var_22_16
		var_22_14.custom = var_22_15

		var_22_13(var_22_12, var_22_14)
	end
...
function var_0_1.handleNotification(arg_31_0, arg_31_1)
	...
	PlayerResUI = var_31_0

	if var_31_1 == var_31_0.CHANGE_TOUCH_ABLE then
		local var_31_2 = arg_31_1
		local var_31_3 = arg_31_1.getBody(var_31_2)

		GetComponent = var_31_2
		tf = var_1_10005

		local var_31_4 = var_1_10005(arg_31_0._go)

		typeof = var_6
		CanvasGroup = var_1_10007

		local var_31_5 = var_31_2(var_31_4, var_6(var_1_10007))

		var_31_5.interactable = var_31_3
		var_31_5.blocksRaycasts = var_31_3
