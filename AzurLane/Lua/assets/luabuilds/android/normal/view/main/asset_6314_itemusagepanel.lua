...
function var_0_0.Update(arg_6_0, arg_6_1)
	...
	DROP_TYPE_WORLD_ITEM = var_1_10004
	var_6_1.type = var_1_10004
	...
	var_6_1(var_4.Find(var_6_3, "left/IconTpl"), var_6_2)

	UpdateOwnDisplay = var_6_1

	local var_6_4 = arg_6_0.itemTF

	var_6_1(var_4.Find(var_6_4, "left/own"), var_6_2)

	RegisterDetailButton = var_6_1

	local var_6_5 = arg_6_0
	local var_6_6 = arg_6_0.itemTF

	var_6_1(var_6_5, var_5.Find(var_6_6, "left/detail"), var_6_2)

	setText = var_6_1

	var_6_1(arg_6_0.itemIntro, arg_6_1:getConfig("display"))

	setText = var_6_1

	var_6_1(arg_6_0.itemName, arg_6_1:getConfig("name"))

	onButton = var_6_1

	local var_6_7 = arg_6_0
	local var_6_8 = arg_6_0.resetBtn
	...
	var_6_1(var_6_7, var_6_8, var_6_9, var_7)
...
function var_0_0.UpdateAction(arg_8_0, arg_8_1)
	...
	if var_8_1 == var_0_0.SINGLE then
		...
		var_4(var_8_2, var_8_3, var_8_4, var_1_10008)
	elseif var_8_1 == var_0_0.BATCH then
		...
		var_5(arg_8_0.batchText, var_8_5)
		...
		var_5(var_8_6, var_8_7, var_1_10008, var_1_10009)
		...
		var_5(var_8_8, var_8_9, var_1_10008, var_1_10009)

		setActive = var_5

		var_5(arg_8_0.batchUseBtn, var_8_5 > 1)
	elseif var_8_1 == var_0_0.INFO then
		...
		var_4(var_8_10, var_8_11, var_8_12, var_1_10008)
	elseif var_8_1 == var_0_0.SEE then
		...
		var_4(var_8_13, var_8_14, var_8_15, var_1_10008)
	end
