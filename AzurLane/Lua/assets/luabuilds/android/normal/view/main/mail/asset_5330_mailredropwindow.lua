...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_21, var_2_20("mail_box_cancel"))
	...
	var_1(var_2_23, var_2_22("mail_box_confirm"))
	...
	var_1(var_2_24, var_3("mail_boxtitle_information"))
	...
	var_1(var_2_25, var_3("mail_search"))
...
function var_0_1.Updatelayout(arg_5_0)
	if not arg_5_0.key then
		...
		var_1(var_5_0, var_3("mail_storeroom_max_2", arg_5_0.key))
	else
		setText = var_1
...
function var_0_1.showConformMsgBox(arg_6_0, arg_6_1)
	...
	local function var_6_6()
		if arg_6_0.key then
			...
			if var_8_1 ~= var_2_10002(var_8_0) then
				pg = var_8_1
				...
				var_8_3(var_8_2, var_3("mail_input_erro"))
	...
	var_3.make(var_6_7, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			local var_9_4 = arg_9_2.Find(var_9_3, "name_bg/name")

			updateDrop = var_9_3

			var_9_3(var_9_0, var_9_2)

			setScrollText = var_9_3

			var_9_3(var_9_4, var_9_1:getName())
		end
...
function var_0_1.refrshContent(arg_10_0, arg_10_1, arg_10_2)
	...
	for iter_10_0, iter_10_1 in var_1_10005(arg_10_1) do
		...
		if arg_10_0.dropIdCache[var_10_2][2] and not arg_10_0.imgCache[var_13] then
			...
			local var_10_5 = var_14.getConfigData(var_13).icon

			GetSpriteFromAtlas = var_15

			local var_10_6 = var_15(var_10_5, "")

			arg_10_0.imgCache[var_13] = var_10_5

			local var_10_7 = arg_10_0._itemConfireText

			var_16.AddSprite(var_10_7, var_10_5, var_10_6)
		end
	...
	local var_10_9 = var_5(var_10_8, var_7.format("<icon name=%s w=0.7 h=0.7/>%d", var_10_1, var_10_0))
