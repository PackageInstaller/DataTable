			...
			if var_22_2 ~= var_2_10005.SkinShop then
				...
				if var_22_3 == var_5.SkinShopTimeLimit then
					...
					if var_22_5 == var_2_10006.SKIN_TYPE_TB then
						...
						var_22_5 = arg_22_0.addSubLayers
						Context = var_2_10007
						...
						var_22_7.mediator = var_2_10009
						NewSkinTBLayer = var_2_10009
						var_22_7.viewComponent = var_2_10009
						var_2_10009 = {
							skinId = var_3.effect_args[1]
						}

						local var_22_8 = var_3.genre

						ShopArgs = var_2_10011
						var_2_10009.timeLimit = var_22_8 == var_2_10011.SkinShopTimeLimit
						var_22_7.data = var_2_10009

						var_22_5(var_22_6, var_2_10007(var_22_7))
					else
						PaintingShowScene = var_22_5

						if var_22_5.GetSkinShowAble(var_22_4) then
							local var_22_9 = arg_22_0
							local var_22_10 = arg_22_0.addSubLayers
							...
							var_22_11.mediator = var_2_10009
							PaintingShowNewSkinScene = var_2_10009
							var_22_11.viewComponent = var_2_10009
							var_2_10009 = {
								is_shop = true,
								skinId = var_22_4
							}

							local var_22_12 = var_3.genre

							ShopArgs = var_2_10011
							var_2_10009.timeLimit = var_22_12 == var_2_10011.SkinShopTimeLimit
							var_22_11.data = var_2_10009

							var_22_10(var_22_9, var_2_10007(var_22_11))
						else
							local var_22_13 = arg_22_0
							local var_22_14 = arg_22_0.addSubLayers

							Context = var_2_10007

							local var_22_15 = var_2_10007.New
							local var_22_16 = {}

							NewSkinMediator = var_2_10009
							var_22_16.mediator = var_2_10009
							NewSkinLayer = var_2_10009
							var_22_16.viewComponent = var_2_10009

							local var_22_17 = {
								skinId = var_3.effect_args[1]
							}
							local var_22_18 = var_3.genre

							ShopArgs = var_2_10011
							var_22_17.timeLimit = var_22_18 == var_2_10011.SkinShopTimeLimit
							var_22_16.data = var_22_17

							var_22_14(var_22_13, var_22_15(var_22_16))
						end
					end

					local var_22_19 = arg_22_0.viewComponent

					var_5.OnShopping(var_22_19, var_22_1.id)

					pg = var_5

					local var_22_20 = var_5.EasyRedDotMgr.GetInstance()

					var_5.TriggerMarks(var_22_20, "specialShop")
				end
