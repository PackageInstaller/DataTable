...
function var_0_0.updateStudent(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0.shipVO == nil or arg_6_0.shipVO.configId ~= arg_6_1.configId then
		...
		local var_6_3 = var_6_2[var_6_1.random(1, #var_6_2)]
		...
		Vector2 = var_6_4
		var_6_5.anchoredPosition = var_6_4.New(arg_6_0.currentPoint.x, arg_6_0.currentPoint.y)
...
function var_0_0.updateLogic(arg_13_0)
	...
	if arg_13_0.state == var_0_0.ShipState.Walk then
		...
		var_1_10003 = arg_13_0.normalSpeed
		Vector3 = var_4

		local var_13_2 = var_4.Distance(var_13_0, var_13_1) / var_1_10003

		LeanTween = var_5

		local var_13_3 = var_5.value(arg_13_0._go, 0, 1, var_13_2)
		local var_13_4 = var_5.setOnUpdate

		System = var_7

		local var_13_5 = var_13_4(var_13_3, var_7.Action_float(function(arg_14_0)
		...
		var_13_6(var_13_5, var_7.Action(function()
	...
	elseif arg_13_0.state == var_0_0.ShipState.Idle then
		...
		math = var_1_10003
		arg_13_0.idleTimer = var_13_7(var_13_8, var_1_10003.random(10, 20), 1)
