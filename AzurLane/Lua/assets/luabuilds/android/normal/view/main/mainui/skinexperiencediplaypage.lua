...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "window/list/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uilist = var_2_0(var_2_2, var_3.Find(var_2_3, "window/list/content/tpl"))
	arg_2_0.skinTimers = {}
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "window/top/btnBack")
	...
	local var_3_9 = var_3.Find(var_3_8, "window/button_container/confirm_btn")
...
function var_0_1.Hide(arg_8_0)
	...
	var_8_1(var_8_0, var_8_2, var_1_10004.UIMgr.GetInstance()._normalUIMain)
	...
	var_2.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			if arg_9_0.skinTimers[var_10_0.id] then
				local var_10_1 = arg_9_0.skinTimers[var_10_0.id]
			...
			Timer = var_6
			var_10_2[var_10_3] = var_6.New(function()
				skinTimeStamp = var_3_10000

				local var_11_0 = var_10_0
				local var_11_1 = var_3_10000(var_1.getRemainTime(var_11_0))

				setText = var_1

				local var_11_2 = arg_10_2

				var_1(var_2.Find(var_11_2, "time/Text"), var_11_1)
			...
			local var_10_6 = arg_10_2.Find(var_10_5, "icon_bg/icon")

			LoadSpriteAsync = var_10_5

			var_10_5("qicon/" .. var_10_0:getIcon(), function(arg_12_0)
				IsNil = var_3_10001
				...
				if not var_3_10001(arg_9_0._tf) then
					...
					typeof = var_3_10003
					Image = var_3_10004
					var_12_1(var_12_0, var_3_10003(var_3_10004)).sprite = arg_12_0
				end
