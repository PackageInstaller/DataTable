...
function var_0_0.init(arg_4_0)
	...
	local var_4_2 = var_2.Find(var_4_1, "got/bottom/scroll/list")
	local var_4_3 = arg_4_0._tf

	arg_4_0.ulist = var_4_0(var_4_2, var_3.Find(var_4_3, "got/bottom/scroll/list/tpl"))
	...
	var_1(var_4_18, var_4_19, var_4_20, var_5)
	...
	var_1(var_4_21, var_4_22, var_4_23, var_5)
	...
	local function var_4_26()
		...
		var_9_1(var_9_0, var_2_10002.ON_USE_ITEM, arg_4_0.itemVO.id, arg_4_0.count, arg_4_0.selectedVO)
	...
	var_1(var_4_24, var_4_25, var_4_26, var_5)
...
function var_0_0.update(arg_12_0, arg_12_1)
	...
	var_3.make(var_12_1, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			local var_13_3 = arg_13_2.Find(var_13_2, "item/bg/icon_bg/count")
			...
			local function var_13_6(arg_14_0)
				if arg_14_0 then
					...
					var_14_0(var_13_3, arg_12_0.count * var_13_0[3])
			...
			var_13_2(var_13_4, var_13_5, var_13_6, var_2_10010)

			setScrollText = var_13_2

			var_13_2(arg_13_2:Find("name_bg/Text"), var_13_1:getConfig("name"))
		end
	...
	local var_12_4 = var_4.Find(var_12_3, "bg")
	local var_12_5 = {}
