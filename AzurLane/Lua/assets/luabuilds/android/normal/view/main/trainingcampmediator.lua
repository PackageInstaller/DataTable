...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_UPDATE, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.UPDATE_TASK_PROGRESS, {
			taskId = arg_2_1.id
		})
		...
		if arg_5_1:getConfig("scene") and #var_2 > 0 then
			if var_2[1] == "LEVEL" and var_2[2] and var_2[2].chapterid then
				...
				if var_3[var_2[1]] then
					...
					var_5_2(var_5_1, var_2_10005, var_2_10006[var_2[1]], var_2[2])
				end
			end
		else
			...
			var_5_4(var_5_3, var_2_10005.TASK_GO, {
				taskVO = arg_5_1
			})
		end
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 ~= var_8_1.TASK_UPDATED then
		TaskProxy = var_4
		...
		if var_8_0 ~= var_4.TASK_REMOVED then
			...
			if var_8_0 == var_4.TASK_DELETE then
				...
				if var_8_0 == var_4.SUBMIT_TASK_DONE then
					local var_8_5 = arg_8_0.viewComponent

					var_8_6 = var_8_6.emit
					BaseUI = var_1_10006

					var_8_6(var_8_5, var_1_10006.ON_ACHIEVE, var_8_2)
					...
					if var_8_0 == var_8_6.ACTIVITY_OPERATION_DONE then
