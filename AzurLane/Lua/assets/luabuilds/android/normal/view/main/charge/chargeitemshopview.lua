...
function var_0_1.initUI(arg_5_0)
	...
	typeof = var_3
	RectTransform = var_1_10004
	arg_5_0.scrollRectTF = var_1(var_5_2, var_3(var_1_10004))
	GetComponent = var_1
	...
	arg_5_0.layoutGroup = var_1(var_5_3, var_3(var_1_10004))
	...
	local var_5_6 = var_3.floor(var_5_4 / var_5_5)
	local var_5_7
	...
	local var_5_10 = var_7.Find(var_5_9, "toggleGroup")

	var_6(var_7.GetChild(var_5_10, 0))
	arg_5_0:blurView()
...
function var_0_1.initScrollRect(arg_6_0)
	...
	local function var_6_0(arg_7_0)
		...
		var_2.insert(arg_6_0.cardList, var_7_0)
		...
		var_2(arg_6_0, var_7_0.tf, function()
			...
			if var_0.isLevelLimit(var_8_0, arg_6_0.player.level) then
				...
				var_8_2(var_8_1, var_2("charge_level_limit"))
			...
			if var_8_4 == "ship_bag_size" then
				var_3_10004 = arg_6_0.player
				var_3_10003 = var_3_10003.getMaxShipBagExcludeGuild(var_3_10004)
				Player = var_3_10004

				if var_3_10004.MAX_SHIP_BAG <= var_3_10003 then
					pg = var_3_10003
					var_3_10004 = var_3_10003.TipsMgr.GetInstance()
					var_3_10003 = var_3_10003.ShowTips
					i18n = var_3_10005

					var_3_10003(var_3_10004, var_3_10005("charge_ship_bag_max"))
				...
				var_3_10003.type = var_3_10004
				Goods = var_3_10004
				var_3_10003.id = var_3_10004.SHIP_BAG_SIZE_ITEM
				var_8_6 = var_3_10003.id
			elseif var_8_4 == "equip_bag_size" then
				var_3_10004 = arg_6_0.player
				var_3_10003 = var_3_10003.getMaxEquipmentBagExcludeGuild(var_3_10004)
				Player = var_3_10004

				if var_3_10004.MAX_EQUIP_BAG <= var_3_10003 then
					pg = var_3_10003
					var_3_10004 = var_3_10003.TipsMgr.GetInstance()
					var_3_10003 = var_3_10003.ShowTips
					i18n = var_3_10005

					var_3_10003(var_3_10004, var_3_10005("charge_equip_bag_max"))
				...
				var_3_10003.type = var_3_10004
				Goods = var_3_10004
				var_3_10003.id = var_3_10004.EQUIP_BAG_SIZE_ITEM
				var_8_6 = var_3_10003.id
			elseif var_8_4 == "commander_bag_size" then
				var_3_10003 = arg_6_0.player.commanderBagMax
				Player = var_3_10004

				if var_3_10004.MAX_COMMANDER_BAG <= var_3_10003 then
					pg = var_3_10003
					var_3_10004 = var_3_10003.TipsMgr.GetInstance()
					var_3_10003 = var_3_10003.ShowTips
					i18n = var_3_10005

					var_3_10003(var_3_10004, var_3_10005("charge_commander_bag_max"))
				...
				var_3_10003.type = var_3_10004
				Goods = var_3_10004
				var_3_10003.id = var_3_10004.COMMANDER_BAG_SIZE_ITEM
				var_8_6 = var_3_10003.id
			elseif var_8_4 == "spweapon_bag_size" then
				getProxy = var_3_10003
				EquipmentProxy = var_3_10004

				local var_8_7 = var_3_10003(var_3_10004)

				var_3_10003 = var_3_10003.GetSpWeaponCapacity(var_8_7)
				EquipmentProxy = var_8_7

				local var_8_8

				if var_8_7.MAX_SPWEAPON_BAG <= var_3_10003 then
					pg = var_3_10003
					var_8_8 = var_3_10003.TipsMgr.GetInstance()
					var_3_10003 = var_3_10003.ShowTips
					i18n = var_3_10005

					var_3_10003(var_8_8, var_3_10005("charge_equip_bag_max"))
				...
				DROP_TYPE_ITEM = var_8_8
				var_3_10003.type = var_8_8
				Goods = var_8_8
				var_3_10003.id = var_8_8.SPWEAPON_BAG_SIZE_ITEM
				var_8_6 = var_3_10003.id
			else
				var_3_10003 = {}

				local var_8_9 = var_7_0.goodsVO

				var_3_10003.id = var_4.getConfig(var_8_9, "effect_args")[1]

				local var_8_10 = var_7_0.goodsVO

				var_3_10003.type = var_4.getConfig(var_8_10, "type")

				local var_8_11 = var_7_0.goodsVO

				var_3_10003.count = var_4.getConfig(var_8_11, "num")
				var_8_5 = var_3_10003

				local var_8_12 = var_7_0.goodsVO

				var_3_10003 = var_3_10003.getConfig(var_8_12, "type")
				DROP_TYPE_RESOURCE = var_8_12

				if var_3_10003 == var_8_12 then
					id2ItemId = var_3_10003
					var_8_6 = var_3_10003(var_8_5.id)
				else
					var_8_6 = var_8_5.id
				end
			end

			ChargeConst = var_3_10003

			local var_8_13 = var_3_10003.getGroupLimit
			local var_8_14 = arg_6_0.normalGroupList
			local var_8_15 = var_7_0.goodsVO
			local var_8_16 = var_8_13(var_8_14, var_5.getConfig(var_8_15, "group"))
			local var_8_17 = var_7_0.goodsVO

			if var_4.IsGroupSale(var_8_17) then
				i18n = var_4

				local var_8_18

				if not var_4("gem_shop_xinzhi_tip", var_8_16) then
					var_8_18 = ""
				end

				pg = var_8_17

				local var_8_19 = var_8_17.MsgboxMgr.GetInstance()
				local var_8_20 = var_5.ShowMsgBox
				local var_8_21 = {
					yesText = "text_buy"
				}

				MSGBOX_TYPE_SINGLE_ITEM = var_3_10008
				var_8_21.type = var_3_10008
				var_8_21.drop = var_8_5
				var_8_21.subIntro = var_8_18

				function var_8_21.onYes()
					if var_8_6 then
						...
						local var_9_4 = var_9_2.MsgboxMgr.GetInstance()
						local var_9_5 = var_2.ShowMsgBox
						local var_9_6 = {}

						i18n = var_4_10005
						var_9_6.content = var_4_10005("charge_scene_buy_confirm", var_9_1, var_9_3)

						function var_9_6.onYes()
							local var_10_0 = arg_6_0
							local var_10_1 = var_0.emit

							NewShopMainMediator = var_5_10002

							var_10_1(var_10_0, var_5_10002.BUY_ITEM, var_7_0.goodsVO.id, 1)
...
function var_0_1.initToggleList(arg_14_0)
	...
	local var_14_2 = var_2.Find(var_14_1, "toggleGroup")
	local var_14_3 = arg_14_0._tf

	arg_14_0.uiToggleList = var_14_0(var_14_2, var_3.Find(var_14_3, "toggleGroup/Toggle"))
	...
	var_1.make(var_14_4, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventInit then
			...
			local var_15_2 = arg_15_2.Find(var_15_1, "selected/Label")

			i18n = var_15_1
			string = var_2_10007

			var_4(var_15_2, var_15_1(var_2_10007.format("shop_package_sort_%s", var_15_0)))

			setText = var_4

			local var_15_3 = arg_15_2
			local var_15_4 = arg_15_2.Find(var_15_3, "selected/enText")

			i18n = var_15_3
			string = var_2_10007

			var_4(var_15_4, var_15_3(var_2_10007.format("shop_package_sort_en_%s", var_15_0)))

			setText = var_4

			local var_15_5 = arg_15_2
			local var_15_6 = arg_15_2.Find(var_15_5, "unselected/Label")

			i18n = var_15_5
			string = var_2_10007

			var_4(var_15_6, var_15_5(var_2_10007.format("shop_package_sort_%s", var_15_0)))

			setActive = var_4

			var_4(arg_15_2:Find("unselected"), true)

			setActive = var_4

			var_4(arg_15_2:Find("selected"), false)
		else
			UIItemList = var_15_0
			...
			if arg_15_0 == var_15_0.EventUpdate then
				...
				local function var_15_9()
					...
					var_1(var_2.Find(var_16_1, "unselected"), false)

					setActive = var_1

					local var_16_2 = arg_15_2

					var_1(var_2.Find(var_16_2, "selected"), true)
					...
					if arg_14_0.prevBtn then
						...
						var_1(var_2.Find(var_16_3, "unselected"), true)

						setActive = var_1

						local var_16_4 = arg_14_0.prevBtn

						var_1(var_2.Find(var_16_4, "selected"), false)
					end
				...
				var_3(var_15_7, var_15_8, var_15_9, var_2_10007)
			end
		end
	...
	for iter_17_0, iter_17_1 in var_1_10002(var_17_0.all) do
		if var_17_0[iter_17_1].genre == "gem_shop" then
			...
			if var_17_3 == true then
				...
				Goods = var_1_10015
				var_1_10013 = var_1_10013(var_17_6, var_1_10015.TYPE_MILITARY)
				table = var_17_6

				var_17_6.insert(arg_17_0.itemGoodsVOList, var_1_10013)
			end
		end
	end
...
function var_0_1.blurView(arg_25_0)
	...
	var_25_4[1] = var_6.Find(var_25_5, "bg")
