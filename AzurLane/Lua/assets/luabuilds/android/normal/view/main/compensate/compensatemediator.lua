...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_GET_REWARD, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.GET_COMPENSATE_REWARD, arg_2_1)
...
function var_0_1.ShowAndCheckDrops(arg_7_0, arg_7_1)
	...
	if #arg_7_1 > 0 then
		...
		var_3.insert(var_7_0, function(arg_8_0)
			local var_8_0 = arg_7_0.viewComponent
			local var_8_1 = var_1.emit

			BaseUI = var_2_10003

			var_8_1(var_8_0, var_2_10003.ON_ACHIEVE, arg_7_1, arg_8_0)
	...
	if var_3.detect(arg_7_1, function(arg_9_0)
		...
		if var_9_0 == var_2_10002 then
			...
			local var_9_2 = arg_9_0.getConfig(var_9_1, "type")

			Item = var_9_1

			if var_9_2 == var_9_1.SKIN_ASSIGNED_TYPE then
				Item = var_9_2
				var_9_3 = var_9_2.InTimeLimitSkinAssigned(arg_9_0.id)
		...
		var_4.insert(var_7_0, function(arg_10_0)
			...
			var_10_2.content = var_2_10004(var_10_3, var_6.getName(var_10_4))
	...
	var_4(var_7_0, function()
		...
		if var_11_0 then
			...
			MSGBOX_TYPE_HELP = iter_11_0
			var_11_5.type = iter_11_0
			i18n = iter_11_0
			var_11_5.helps = iter_11_0("help_research_package")
