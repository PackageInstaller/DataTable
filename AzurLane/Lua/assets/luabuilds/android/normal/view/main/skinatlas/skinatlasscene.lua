...
function var_0_1.init(arg_2_0)
	...
	RollingCircleRect = var_2_10
	arg_2_0.rollingCircleRect = var_2_10.New(var_2_9, var_2_11)
	...
	local var_2_16 = var_4.Find(var_2_15, "adapt/main_panel/empty/Text1")

	i18n = var_2_15

	var_3(var_2_16, var_2_15("skinatlas_search_result_is_empty"))

	setText = var_3

	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_4.Find(var_2_17, "adapt/top_panel/search/holder")

	i18n = var_2_17

	var_3(var_2_18, var_2_17("skinatlas_search_holder"))

	local var_2_19 = {}

	ShipIndexConst = var_2_18
	var_2_19.typeIndex = var_2_18.TypeAll
...
function var_0_1.didEnter(arg_3_0)
	...
	local function var_3_8()
		...
		SkinAtlasMediator = var_2_10002

		var_6_1(var_6_0, var_2_10002.OPEN_INDEX, {
...
local function var_0_2(arg_14_0)
	...
	local var_14_1 = arg_14_0:GetID() == var_0_1.PAGE_ALL and "text_all" or "text_" .. var_14_0[var_2].res

	LoadSpriteAtlasAsync = var_1_10004

	var_1_10004("SkinClassified", var_14_1 .. "01", function(arg_15_0)
		...
		local var_15_3 = var_15_2(var_15_1, var_3(var_2_10004))
	...
	var_1_10004("SkinClassified", var_14_1, function(arg_16_0)
		...
		local var_16_3 = var_16_2(var_16_1, var_3(var_2_10004))
	...
	local var_14_2 = arg_14_0._tr

	var_1_10004(var_5.Find(var_14_2, "eng"), var_2 == var_0_1.PAGE_ALL and "ALL" or var_14_0[var_2].english_name)
...
function var_0_1.InitSkinPages(arg_17_0, arg_17_1)
	...
	local var_17_0 = var_1_10002(var_1_10003.skin_page_template.all)

	table = var_3

	var_3.insert(var_17_0, 1, var_0_1.PAGE_ALL)
...
function var_0_1.OnSelectSkinPage(arg_20_0, arg_20_1)
	if arg_20_0.selectedSkinPageItem then
		...
		var_2(var_3.Find(var_20_0, "selected"), false)

		setActive = var_2

		local var_20_1 = arg_20_0.selectedSkinPageItem._tr

		var_2(var_3.Find(var_20_1, "name"), true)
	end
	...
	var_2(var_3.Find(var_20_2, "selected"), true)

	setActive = var_2

	local var_20_3 = arg_20_1._tr

	var_2(var_3.Find(var_20_3, "name"), false)
...
function var_0_1.OnFilter(arg_23_0, arg_23_1)
	...
	if var_23_1 == var_1_10005.TypeAll then
		local var_23_2 = arg_23_1.campIndex

		ShipIndexConst = var_5

		if var_23_2 == var_5.CampAll then
			local var_23_3 = arg_23_1.rarityIndex

			ShipIndexConst = var_5

			if var_23_3 == var_5.RarityAll then
				local var_23_4 = arg_23_1.extraIndex

				SkinAtlasIndexLayer = var_5

				if var_23_4 == var_5.ExtraALL then
					var_23_5 = false
...
function var_0_1.MatchIndex(arg_29_0, arg_29_1)
	if not arg_29_1:GetDefaultShipConfig() then
		return false
	end

	local var_29_0 = arg_29_0
	local var_29_1 = arg_29_0.ToVShip(var_29_0, var_2)

	ShipIndexConst = var_29_0

	local var_29_2 = var_29_0.filterByType(var_29_1, arg_29_0.defaultIndex.typeIndex)

	ShipIndexConst = var_5

	local var_29_3 = var_5.filterByCamp(var_29_1, arg_29_0.defaultIndex.campIndex)

	ShipIndexConst = var_6

	local var_29_4 = var_6.filterByRarity(var_29_1, arg_29_0.defaultIndex.rarityIndex)

	SkinAtlasIndexLayer = var_7

	local var_29_5 = var_7.filterByExtra(arg_29_1, arg_29_0.defaultIndex.extraIndex)
...
function var_0_1.GetSkinList(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_1 = var_1_10004(var_1_10005)
	local var_30_2 = var_4.GetOwnSkins(var_30_1)

	pairs = var_30_1

	for iter_30_0, iter_30_1 in var_30_1(var_30_2) do
...
function var_0_1.OnInitItem(arg_34_0, arg_34_1)
	...
	var_3(var_34_1, var_34_2, var_34_3, var_1_10007)
	...
	var_3(var_34_4, var_34_5, var_34_6, var_1_10007)
