...
function var_0_1.didEnter(arg_3_0)
	...
	var_1(var_3_2, var_3("Supplement_pay2"))
	...
	var_1(var_3_3, var_3("Supplement_pay5"))
	arg_3_0:initDamonds()
...
function var_0_1.refundUpdate(arg_4_0)
	...
	if #arg_4_0.tempDamondVOs <= 0 then
		...
		i18n = var_1_10004
		var_4_2.content = var_1_10004("Supplement_pay3")
...
function var_0_1.confirm(arg_9_0, arg_9_1)
	...
	BackChargeMediator = var_1_10004

	var_9_1(var_9_0, var_1_10004.CHARGE, arg_9_1.id)
...
function var_0_1.initDiamondList(arg_10_0, arg_10_1)
	...
	local function var_10_2(arg_11_0)
		...
		var_2(var_11_1, var_11_2, var_11_3, var_2_10006)
	...
	local var_10_4 = var_1_10006.New(var_10_0, var_10_1)
	...
	var_6.make(var_10_4, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventInit then
			...
			if arg_14_0 == var_14_0.EventUpdate then
				...
				var_14_1(var_14_2, var_2_10005(arg_14_2))
			end
		end
...
function var_0_1.updateDamondsData(arg_15_0)
	...
	local var_15_1 = var_2(var_1_10003)
	local var_15_2 = var_2.getData(var_15_1)

	getProxy = var_15_1
	ServerProxy = var_1_10005

	local var_15_3 = var_15_1(var_1_10005)
	...
	for iter_15_0 = 1, #var_15_5 do
		...
		Goods = var_14
		var_1_10012 = var_1_10012(var_15_7, var_14.TYPE_CHARGE)
...
function var_0_1.sortDamondItems(arg_16_0)
	...
	var_1.sort(arg_16_0.tempDamondVOs, function(arg_17_0, arg_17_1)
		...
		if not var_2_10002.contains(arg_16_0.firstChargeIds, arg_17_0.id) then
			var_17_0 = arg_17_0

			if arg_17_0.firstPayDouble(var_17_0) then
				var_17_1 = 1
		...
		local var_17_2 = not var_17_0.contains(arg_16_0.firstChargeIds, arg_17_1.id) and arg_17_1:firstPayDouble() and 1 or 0
		local var_17_3 = 0
		local var_17_4 = 0
		local var_17_5
		...
		local var_17_6 = arg_17_0:getConfig("tag") == 2 and 1 or 0
		local var_17_7 = arg_17_1:getConfig("tag") == 2 and 1 or 0

		if var_17_1 == var_17_2 and var_17_6 == var_17_7 then
			return arg_17_0.id < arg_17_1.id
		else
			return var_17_2 < var_17_1 or var_17_1 == var_17_2 and var_17_7 < var_17_6
		end
...
function var_0_1.showItemDetail(arg_19_0, arg_19_1)
	...
	var_1_10013(var_14.Find(var_19_11, "window2"), var_19_10)

	setActive = var_1_10013

	local var_19_12 = arg_19_0.detail

	var_1_10013(var_14.Find(var_19_12, "window"), not var_19_10)
	...
	if var_19_10 then
		...
		if not var_15.Find(var_19_15, "window2") then
			local var_19_16 = arg_19_0.detail

			var_19_17 = var_15.Find(var_19_16, "window")
		end

		var_19_14(var_19_13, var_19_17)
		...
		if var_19_10 then
			local var_19_18 = arg_19_0.detailNormalTip

			if var_13.GetComponent(var_19_18, "Text") then
				setText = var_13
		...
		if 0 < var_19_9 then
			...
			for iter_19_0, iter_19_1 in var_13(arg_19_0.detailTags) do
				...
				var_1_10018(iter_19_1, iter_19_0 == var_19_9)
			end
		end

		local var_19_19 = arg_19_0.detailIconTF

		GetSpriteFromAtlas = var_14
		var_19_19.sprite = var_14("chargeicon/1", "")
		LoadSpriteAsync = var_19_19

		var_19_19(var_19_0, function(arg_20_0)
			if arg_20_0 then
		...
		var_19_19(arg_19_0.detailName, var_19_1)

		setActive = var_19_19

		var_19_19(arg_19_0.detailRmb, var_19_7)

		setActive = var_19_19

		var_19_19(arg_19_0.detailGem, not var_19_7)

		setText = var_19_19

		var_19_19(arg_19_0.detailPrice, var_19_6)

		if arg_19_0.detailDescExtra ~= nil then
			setActive = var_13

			local var_19_20 = arg_19_0.detailDescExtra
			local var_19_21

			if arg_19_1.descExtra then
				var_19_21 = arg_19_1.descExtra ~= ""
			end

			var_13(var_19_20, var_19_21)

			setText = var_13

			local var_19_22 = arg_19_0.detailDescExtra
			local var_19_23
		...
		if arg_19_0.detailContain then
			...
			var_19_27(arg_19_0.normal, var_19_8)

			if var_19_8 then
				updateDrop = var_19_27

				var_19_27(arg_19_0.detailItem, var_19_3)

				onButton = var_19_27

				local var_19_24 = arg_19_0
				local var_19_25 = arg_19_0.detailItem

				local function var_19_26()
				...
				var_19_27(var_19_24, var_19_25, var_19_26, iter_19_1)

				contentWrap = var_19_27

				local var_19_28

				var_19_27, var_19_28 = var_19_27(var_19_3:getConfig("name"), 10, 2)
				...
				setText = var_15
				iter_19_1 = arg_19_0.detailItem

				var_15(var_16.Find(iter_19_1, "name"), var_19_28)
			...
			var_19_27(arg_19_0.detailTip2, var_19_4)
			...
			for iter_19_2 = #var_19_5, arg_19_0.detailItemList.childCount - 1 do
				...
				iter_19_1(var_18.GetChild(var_19_29, iter_19_2))
			end

			for iter_19_3 = arg_19_0.detailItemList.childCount, #var_19_5 - 1 do
				cloneTplTo = iter_19_1

				iter_19_1(arg_19_0.detailItem, arg_19_0.detailItemList)
			end
			...
			for iter_19_4 = 1, #var_19_5 do
				...
				updateDrop = var_19_30

				var_19_30(var_19_31, var_19_5[iter_19_4])

				contentWrap = var_19_30

				local var_19_32 = var_19_5[iter_19_4]
				local var_19_33, var_19_34 = var_19_30(var_19.getConfig(var_19_32, "name"), 8, 2)
				...
				var_20(var_19_31:Find("name"), var_19_34)

				onButton = var_20

				local var_19_35 = arg_19_0
				local var_19_36 = var_19_31
				...
				var_20(var_19_35, var_19_36, var_19_37, var_1_10024)
			end
		end
		...
		local var_19_39 = arg_19_0.detail
		local var_19_40 = var_15.Find(var_19_39, "back_sign")
		...
		var_19_27(var_19_38, var_19_40, var_19_41, var_17)

		onButton = var_19_27

		local var_19_42 = arg_19_0
		local var_19_43 = arg_19_0.detailWindow
		local var_19_44 = var_15.Find(var_19_43, "button_container/button_cancel")
		...
		var_19_27(var_19_42, var_19_44, var_19_45, var_17)

		onButton = var_19_27

		local var_19_46 = arg_19_0
		local var_19_47 = arg_19_0.detailWindow
		local var_19_48 = var_15.Find(var_19_47, "button_container/button_ok")
		local var_19_49
		...
		var_19_27(var_19_46, var_19_48, var_19_49, var_17)

		setActive = var_19_27

		var_19_27(arg_19_0.detail, true)

		pg = var_19_27

		local var_19_50 = var_19_27.UIMgr.GetInstance()

		var_13.BlurPanel(var_19_50, arg_19_0.blurPanel)
...
function var_0_1.bindDetailTF(arg_26_0, arg_26_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_26_0.detailIconTF = var_26_3(var_26_2, var_4(var_1_10005))
	...
	var_26_8(var_26_9, var_4.Find(var_26_10, "hot"))
	...
	var_26_11(var_26_12, var_4.Find(var_26_13, "new"))
	...
	var_26_14(var_26_15, var_4.Find(var_26_16, "advice"))
	...
	var_26_17(var_26_18, var_4.Find(var_26_19, "double"))
	...
	var_26_20(var_26_21, var_4.Find(var_26_22, "discount"))
