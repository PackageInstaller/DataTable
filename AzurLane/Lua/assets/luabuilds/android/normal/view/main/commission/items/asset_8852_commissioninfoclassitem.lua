...
function var_0_1.OnFlush(arg_1_0)
	...
	local var_1_2 = var_1_0(var_1_10003)
	local var_1_3 = var_2.getSkillClassNum(var_1_2)

	table = var_1_2

	local var_1_4 = var_1_2.getCount(var_1_1)
	local var_1_5 = 0

	_ = var_1_10005

	local var_1_6 = var_1_10005.each

	_ = var_1_10006

	var_1_6(var_1_10006.values(var_1_1), function(arg_2_0)
		local var_2_0 = arg_2_0
		local var_2_1 = arg_2_0.getFinishTime(var_2_0)

		pg = var_2_0

		local var_2_2 = var_2_0.TimeMgr.GetInstance()

		if var_2_1 <= var_2.GetServerTime(var_2_2) then
			var_1_5 = var_1_5 + 1
		end
...
function var_0_1.UpdateListItem(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if var_3_0 then
		...
		arg_3_0.UpdateStudent(var_3_3, var_3_0, arg_3_3)

		Vector2 = var_3_1
		var_3_2.sizeDelta = var_3_1(267, 45)
	else
		var_3_3 = arg_3_0

		arg_3_0.UpdateEmpty(var_3_3, arg_3_3)

		Vector2 = var_3_1
		var_3_2.sizeDelta = var_3_1(400, 45)
	end
	...
	if var_3_0 then
		...
		var_3_3 = var_3_0
		var_3_1 = var_3_0.getFinishTime(var_3_3)
		pg = var_3_3

		local var_3_4 = var_3_3.TimeMgr.GetInstance()

		var_3_1 = var_3_1 <= var_3_3.GetServerTime(var_3_4)
	end

	setActive = var_3_3

	var_3_3(arg_3_3:Find("unlock"), true)

	setActive = var_3_3

	var_3_3(arg_3_3:Find("lock"), false)

	setActive = var_3_3

	var_3_3(arg_3_3:Find("unlock/leisure"), not var_3_0)

	setActive = var_3_3

	var_3_3(arg_3_3:Find("unlock/ongoging"), var_3_0 and not var_3_1)

	setActive = var_3_3

	var_3_3(arg_3_3:Find("unlock/finished"), var_3_0 and var_3_1)
...
function var_0_1.UpdateStudent(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = arg_4_1.getFinishTime(var_4_0)

	pg = var_4_0

	local var_4_2 = var_4_0.TimeMgr.GetInstance()
	local var_4_3 = var_4.GetServerTime(var_4_2)
	local var_4_4 = arg_4_1:getShipVO()
	local var_4_5

	setText = var_1_10007

	local var_4_6 = arg_4_2
	local var_4_7 = arg_4_2.Find(var_4_6, "unlock/name_bg/Text")

	shortenString = var_4_6

	var_1_10007(var_4_7, var_4_6(arg_4_1:getSkillName(), 7))
	...
	if var_4_3 < var_4_1 then
		...
		local var_4_9 = arg_4_2:Find("unlock/finished/finish_btn")
		...
		local function var_4_10()
			...
			local var_5_2 = var_2_10002.FINISH_CLASS
			local var_5_3 = arg_4_1.id

			Student = var_2_10004

			var_5_1(var_5_0, var_5_2, var_5_3, var_2_10004.CANCEL_TYPE_AUTO)
		...
		var_1_10007(var_4_8, var_4_9, var_4_10, var_11)
		...
		local function var_4_13()
			...
			var_2_10000(var_1.Find(var_6_0, "unlock/finished/finish_btn"))
		...
		var_1_10007(var_4_11, var_4_12, var_4_13, var_11)

		var_4_5 = arg_4_2:Find("unlock/finished/shipicon")
	end

	updateShip = var_1_10007

	var_1_10007(var_4_5, var_4_4)
...
function var_0_1.AddTimer(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_2 = var_7_1(var_7_0, var_5(var_1_10006))
	...
	var_7_4[var_7_5] = var_1_10007.New(function()
		...
		if var_8_0 - var_1.GetServerTime(var_8_1) <= 0 then
			...
			var_1.RemoveTimer(var_8_1, arg_7_1)

			var_8_1 = arg_7_0

			var_1.Update(var_8_1)
		else
			local var_8_2 = var_7_2

			pg = var_8_1

			local var_8_3 = var_8_1.TimeMgr.GetInstance()

			var_8_2.text = var_2.DescCDTime(var_8_3, var_0)
		end
...
function var_0_1.UpdateEmpty(arg_10_0, arg_10_1)
	...
	local var_10_1 = arg_10_1.Find(var_10_0, "unlock/name_bg/Text")

	i18n = var_10_0

	var_1_10002(var_10_1, var_10_0("commission_idle"))

	onButton = var_1_10002

	local var_10_2 = arg_10_0
	local var_10_3 = arg_10_1:Find("unlock/leisure/go_btn")
	...
	local function var_10_4()
		...
		var_11_1(var_11_0, var_2_10002.ON_ACTIVE_CLASS)
	...
	var_1_10002(var_10_2, var_10_3, var_10_4, var_6)
	...
	var_1_10002(var_10_5, var_10_6, var_10_7, var_6)
...
function var_0_1.OnSkip(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.ON_ACTIVE_CLASS)
...
function var_0_1.OnFinishAll(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.FINISH_CLASS_ALL)
