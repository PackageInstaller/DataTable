...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "window/list/scrollrect/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uilist = var_2_0(var_2_2, var_3.Find(var_2_3, "window/list/scrollrect/content/tpl"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "window/button_container/confirm_btn")
	...
	local var_3_9 = var_3.Find(var_3_8, "window/top/btnBack")
...
function var_0_1.Display(arg_8_0, arg_8_1)
	...
	var_2.make(var_8_0, function(arg_9_0, arg_9_1, arg_9_2)
		...
		if arg_9_0 == var_2_10003.EventUpdate then
			...
			local var_9_2 = arg_9_2.Find(var_9_1, "icon_bg/icon")

			LoadSpriteAsync = var_9_1

			var_9_1("qicon/" .. var_9_0:getIcon(), function(arg_10_0)
				IsNil = var_3_10001
				...
				if not var_3_10001(arg_8_0._tf) then
					...
					typeof = var_3_10003
					Image = var_3_10004
					var_10_1(var_10_0, var_3_10003(var_3_10004)).sprite = arg_10_0
				end
...
function var_0_1.OnDestroy(arg_11_0)
	...
	var_11_1(var_11_0, var_11_2, var_1_10004.UIMgr.GetInstance()._normalUIMain)
