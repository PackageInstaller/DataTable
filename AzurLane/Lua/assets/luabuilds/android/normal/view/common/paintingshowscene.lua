...
function var_0_1.didEnter(arg_2_0)
	...
	local var_2_1 = var_1_10003.width

	Screen = var_1_10004
	var_2_0.sizeDelta = var_1_10002(var_2_1, var_1_10004.height)
	findTF = var_2_0
	...
	local var_2_2 = var_2(arg_2_0.ad, "flush")

	typeof = var_3
	Animator = var_4
	arg_2_0.flushAnimator = var_1(var_2_2, var_3(var_4))
	GetComponent = var_1
	findTF = var_2_2
	...
	typeof = var_3
	DftAniEvent = var_4
	arg_2_0.flushEevent = var_1(var_2_3, var_3(var_4))
	findTF = var_1
...
function var_0_1.movePaint(arg_12_0, arg_12_1)
	...
	if var_12_0 and var_12_1 then
		...
		local var_12_3 = var_12_2(var_1_10005(arg_12_0.paintTf), var_12_0, var_12_1)
		local var_12_4 = var_4.setOnComplete

		System = var_6

		var_12_4(var_12_3, var_6.Action(function()
			if arg_12_1 then
				arg_12_1()
			end
...
function var_0_1.loadShowPaint(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	local var_14_1 = var_5.GetAssistantStatus(var_14_0)
	local var_14_2 = var_14_0
	local var_14_3 = var_14_0.GetSkinConfig(var_14_2).tag

	pg = var_14_2

	local var_14_4 = var_14_2.ship_skin_template[arg_14_0.skinId]
	...
	if var_14_1 == var_8.STATE_SPINE_PAINTING then
		SpinePainting = var_14_5
		var_14_5 = var_14_5.GenerateData
		...
		Vector3 = var_1_10010
		var_14_6.position = var_1_10010(0, 0, 0)
		var_14_6.parent = arg_14_0.spineContainer
		var_14_6.effectParent = arg_14_0.effectContainer
		var_14_5 = var_14_5(var_14_6)
		SpinePainting = var_14_6
		arg_14_0.spinePainting = var_14_6.New(var_14_5, function(arg_15_0)
			local var_15_0 = arg_15_0:GetSpineTransform()
			local var_15_1 = var_1.GetComponent

			typeof = var_2_10003
			ItemList = var_2_10004

			local var_15_2 = var_15_1(var_15_0, var_2_10003(var_2_10004)).prefabItem
			...
			for iter_15_0, iter_15_1 in var_15_2(var_15_3) do
				...
				if var_2_10007(var_15_4, var_2_10009(var_2_10010)) then
					RemoveComponent = var_15_4
					var_2_10009 = var_2_10007
					typeof = var_2_10010
					Canvas = var_2_10011

					var_15_4(var_2_10009, var_2_10010(var_2_10011))
				end
			end
			...
			if arg_15_0:getAnimationExist("get") then
				arg_15_0:SetOnceAction("get", nil, function()
					...
					var_16_1(var_16_0, var_2.getIdleName(var_16_2), 0)
	...
	MainPaintingView = var_14_5

	if var_14_1 == var_14_5.STATE_PAINTING then
		local var_14_7

		if not var_14_4.get_showing.paint_offset or not var_14_4.get_showing.paint_offset then
			var_14_7 = nil
		end

		arg_14_0.paintOffset = var_14_7
		table = var_14_7
		var_14_7 = var_14_7.contains

		local var_14_8 = var_14_3

		ShipSkin = var_1_10010

		if not var_14_7(var_14_8, var_1_10010.WITH_LIVE2D) then
			table = var_14_7
			var_14_7 = var_14_7.contains
			var_14_8 = var_14_3
			ShipSkin = var_1_10010

			if var_14_7(var_14_8, var_1_10010.WITH_SPINE) then
				if not arg_14_0.paintOffset then
					var_14_7 = arg_14_0.paintingFitter
					Vector3 = var_14_8
					var_14_7.localScale = var_14_8(1.1, 1.1, 1.1)
				end
			end

			local var_14_9 = var_14_0

			var_14_7 = var_14_0.getPainting(var_14_9)
			LoadPaintingPrefabAsync = var_14_9

			var_14_9(arg_14_0.paintTf, var_14_7, var_14_7, "mainNormal", function(arg_17_0)
				...
				if not var_2(var_17_1) and arg_14_0.isShop then
					...
					var_2(var_17_2, var_2_10004.isHx())
				end
			...
			MainPaintingView = var_14_7

			if var_14_1 == var_14_7.STATE_L2D then
				isActive = var_8
				...
				local var_14_10 = var_8.GenerateData
				local var_14_11 = {
					ship = var_14_0
				}

				Vector3 = var_1_10010
				var_14_11.position = var_1_10010(0, 0, -1)
				var_14_11.parent = arg_14_0.l2dContainner
				var_14_11.shopPreView = arg_14_0.isShop

				local var_14_12 = var_14_10(var_14_11)

				Live2DPainting = var_14_11
				arg_14_0.live2dChar = var_14_11.New(var_14_12, function(arg_18_0)
			...
			arg_14_0.paintOffset = var_14_13
			table = var_14_13

			local var_14_14 = var_14_13.contains
			local var_14_15 = var_14_3

			ShipSkin = var_1_10010

			if not var_14_14(var_14_15, var_1_10010.WITH_LIVE2D) then
				table = var_8

				do
					local var_14_16 = var_8.contains

					var_14_15 = var_14_3
					ShipSkin = var_10

					if var_14_16(var_14_15, var_10.WITH_SPINE) then
						if not arg_14_0.paintOffset then
							local var_14_17 = arg_14_0.paintingFitter

							Vector3 = var_14_15
							var_14_17.localScale = var_14_15(1.1, 1.1, 1.1)
						end
					end

					local var_14_18 = var_14_0
					local var_14_19 = var_14_0.getPainting(var_14_18)

					LoadPaintingPrefabAsync = var_14_18

					var_14_18(arg_14_0.paintTf, var_14_19, var_14_19, "mainNormal", function()
						arg_14_0.loading = false
...
function var_0_1.updateL2dSortMode(arg_20_0, arg_20_1)
	...
	local var_20_2 = var_20_1(var_20_0, var_1_10004(var_1_10005))

	CubismSortingMode = var_20_0
	var_20_2.SortingMode = var_20_0.BackToFrontOrder
...
function var_0_1.willExit(arg_25_0)
	...
	if var_25_2(var_25_1(arg_25_0.paintTf)) then
		...
		var_25_3(var_2(arg_25_0.paintTf))
	end
