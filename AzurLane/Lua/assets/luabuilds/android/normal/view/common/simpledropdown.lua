...
function var_0_1.UpdateVirtualBtn(arg_3_0)
	...
	var_3_1(var_3_2, var_4(arg_3_0.names[arg_3_0.preIndex]))
...
function var_0_1.OnInit(arg_4_0)
	...
	Vector3 = var_4_2
	var_4_3.localEulerAngles = var_4_2.New(0, 0, 0)
	onButton = var_4_3
	...
	var_4_4(arg_4_0, var_4_5, function()
	...
	var_2(var_4_7, var_4(var_5)).constraintCount = 1
	...
	for iter_4_0 = 1, #arg_4_0.options do
		...
		if iter_4_0 == 1 then
			...
			local var_4_9 = var_1_10008(var_1_10009(arg_4_0.btnTpl))

			var_1_10009 = var_1_10008.Find(var_4_9, "Image")
			go = var_4_9

			local var_4_10 = var_4_9(var_1_10008)

			i18n = var_11
			var_4_10.name = var_11(arg_4_0.names[iter_4_0])
			setActive = var_4_10

			var_4_10(var_1_10008, true)

			setActive = var_4_10

			var_4_10(var_1_10008:Find("dropdown"), false)

			setText = var_4_10

			local var_4_11 = var_1_10009

			i18n = var_12

			var_4_10(var_4_11, var_12(arg_4_0.names[iter_4_0]))

			setParent = var_4_10

			var_4_10(var_1_10008, arg_4_0.attrs)
			...
			var_4_10(var_4_12, var_4_13, var_4_14, var_1_10014)

			table = var_4_10

			var_4_10.insert(arg_4_0.btnList, var_1_10008)
		end
	end
