...
function var_0_1.init(arg_2_0)
	...
	for iter_2_0 = 1, #var_0_1.panelNames do
		...
		local var_2_11 = var_6.Find(var_2_10, "title1/Image")

		i18n = var_2_10

		var_1_10005(var_2_11, var_2_10(var_0_1.panelNames[iter_2_0][1]))

		setText = var_1_10005

		local var_2_12 = arg_2_0.displayTFs[iter_2_0]
		local var_2_13 = var_6.Find(var_2_12, "title1/Image_en")

		i18n = var_2_12

		var_1_10005(var_2_13, var_2_12(var_0_1.panelNames[iter_2_0][2]))
	end
	...
	typeof = var_3
	Image = iter_2_0
	arg_2_0.greySprite = var_2_18(var_2_17, var_3(iter_2_0)).sprite
	...
	typeof = var_3
	Image = iter_2_0
	arg_2_0.blueSprite = var_2_21(var_2_20, var_3(iter_2_0)).sprite
	...
	typeof = var_3
	Image = iter_2_0
	arg_2_0.yellowSprite = var_2_24(var_2_23, var_3(iter_2_0)).sprite
...
function var_0_1.didEnter(arg_4_0)
	...
	local function var_4_2()
		if arg_4_0.contextData.callback then
			...
			Clone = var_2_10002
			var_5_1.sort = var_2_10002(arg_4_0.contextData.sort)
			Clone = var_2
			var_5_1.index = var_2(arg_4_0.contextData.index)
			Clone = var_2
			var_5_1.camp = var_2(arg_4_0.contextData.camp)
			Clone = var_2
			var_5_1.rarity = var_2(arg_4_0.contextData.rarity)
			Clone = var_2
			var_5_1.extra = var_2(arg_4_0.contextData.extra)
			Clone = var_2
			var_5_1.equipSkinSort = var_2(arg_4_0.contextData.equipSkinSort)
			Clone = var_2
			var_5_1.equipSkinIndex = var_2(arg_4_0.contextData.equipSkinIndex)
			Clone = var_2
			var_5_1.equipSkinTheme = var_2(arg_4_0.contextData.equipSkinTheme)
	...
	Vector3 = var_4_6
	var_4_10.localScale = var_4_6.zero
	LeanTween = var_4_10
...
function var_0_1.initDisplays(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_0.displayTFs) do
		...
		var_8(iter_8_1, var_1_10007)

		if var_1_10007 then
			IndexConst = var_8

			if iter_8_0 == var_8.DisplayEquipSkinSort then
				arg_8_0:initEquipSkinSort()
				arg_8_0:updateEquipSkinSort()
			else
				IndexConst = var_8

				if iter_8_0 == var_8.DisplayEquipSkinIndex then
					arg_8_0:initEquipSkinIndex()
					arg_8_0:updateEquipSkinIndex()
				else
					IndexConst = var_8

					if iter_8_0 == var_8.DisplayEquipSkinTheme then
...
function var_0_1.initEquipSkinSort(arg_9_0)
	...
	var_9_1(var_1_10003.EquipSkinSortTypes, function(arg_10_0)
		bit = var_2_10001
		...
		if var_2.band(arg_9_0.contextData.display.equipSkinSort, var_10_0) > 0 then
			table = var_2
	...
	IndexConst = var_3
	var_9_2[var_3.DisplayEquipSkinSort] = var_9_0
	...
	var_3.make(var_9_5, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_2 = var_11_1(var_2_10005.EquipSkinSortTypes, var_11_0)

			IndexConst = var_5

			local var_11_3 = var_5.EquipSkinSortNames[var_11_2]
			...
			var_7(var_11_5, var_9(var_2_10010))
			...
			SFX_UI_TAG = var_2_10011

			var_7(var_11_6, var_11_7, var_11_8, var_2_10011)
		end
	...
	var_3.align(var_9_6, #var_9_0)

	local var_9_7 = arg_9_0.displayList

	IndexConst = var_9_6
	var_9_7[var_9_6.DisplayEquipSkinSort] = var_3
...
function var_0_1.initEquipSkinIndex(arg_15_0)
	...
	var_15_1(var_1_10003.EquipSkinIndexTypes, function(arg_16_0)
		bit = var_2_10001
		...
		if var_2.band(arg_15_0.contextData.display.equipSkinIndex, var_16_0) > 0 then
			table = var_2
	...
	IndexConst = var_3
	var_15_2[var_3.DisplayEquipSkinIndex] = var_15_0
	...
	var_3.make(var_15_5, function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == var_2_10003.EventUpdate then
			...
			local var_17_2 = var_17_1(var_2_10005.EquipSkinIndexTypes, var_17_0)

			IndexConst = var_5

			local var_17_3 = var_5.EquipSkinIndexNames[var_17_2]
			...
			var_7(var_17_5, var_9(var_2_10010))
			...
			local function var_17_8()
				...
				var_18_0.equipSkinIndex = var_18_1(var_18_2, var_18_3, var_3_10004.EquipSkinIndexAll, var_17_0)
			...
			var_7(var_17_6, var_17_7, var_17_8, var_2_10011)
		end

		return
	end)

	local var_15_6 = var_3

	var_3.align(var_15_6, #var_15_0)

	local var_15_7 = arg_15_0.displayList

	IndexConst = var_15_6
	var_15_7[var_15_6.DisplayEquipSkinIndex] = var_3
...
function var_0_1.updateEquipSkinIndex(arg_19_0)
	...
	var_19_1:each(function(arg_20_0, arg_20_1)
		...
		local var_20_3 = var_20_1(var_20_2, var_2_10005.lshift(1, var_20_0))
...
function var_0_1.initEquipSkinTheme(arg_21_0)
	...
	var_21_1(var_1_10003.EquipSkinThemeTypes, function(arg_22_0)
		...
		local var_22_1 = var_2.find

		IndexConst = var_3

		if var_22_1(var_3.StrAnd(arg_21_0.contextData.display.equipSkinTheme, var_22_0), "1") ~= nil then
			table = var_2
	...
	IndexConst = var_3
	var_21_2[var_3.DisplayEquipSkinTheme] = var_21_0
	...
	var_3.make(var_21_5, function(arg_23_0, arg_23_1, arg_23_2)
		...
		if arg_23_0 == var_2_10003.EventUpdate then
			...
			local var_23_2 = var_23_1(var_2_10005.EquipSkinThemeTypes, var_23_0)

			IndexConst = var_5

			local var_23_3 = var_5.EquipSkinThemeNames[var_23_2]
			...
			var_7(var_23_5, var_9(var_2_10010))
			...
			local function var_23_8()
				...
				IndexConst = var_3_10004
				var_24_0.equipSkinTheme = var_24_1(var_24_2, var_24_3, var_3_10004.EquipSkinThemeAll, var_23_0)
			...
			var_7(var_23_6, var_23_7, var_23_8, var_2_10011)
		end
	...
	var_3.align(var_21_6, #var_21_0)

	local var_21_7 = arg_21_0.displayList

	IndexConst = var_21_6
	var_21_7[var_21_6.DisplayEquipSkinTheme] = var_3
...
function var_0_1.updateEquipSkinTheme(arg_25_0)
	...
	var_25_1:each(function(arg_26_0, arg_26_1)
		...
		local var_26_2 = var_4.find

		IndexConst = var_5

		local var_26_3 = var_26_2(var_5.StrAnd(arg_25_0.contextData.equipSkinTheme, var_26_1), "1") ~= nil
...
function var_0_1.willExit(arg_27_0)
	...
	var_27_0(var_1_10002(arg_27_0.panel))
