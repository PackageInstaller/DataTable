...
function var_0_1.init(arg_2_0)
	...
	local var_2_7 = var_2.Find(var_2_6, "Image")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("text_confirm"))

	setText = var_1

	local var_2_8 = arg_2_0.btnCancel
	local var_2_9 = var_2.Find(var_2_8, "Image")

	i18n = var_2_8

	var_1(var_2_9, var_2_8("text_cancel"))
	...
	typeof = var_3
	Image = var_4
	arg_2_0.greySprite = var_2_12(var_2_11, var_3(var_4)).sprite
	...
	typeof = var_3
	Image = var_4
	arg_2_0.blueSprite = var_2_15(var_2_14, var_3(var_4)).sprite
	...
	typeof = var_3
	Image = var_4
	arg_2_0.yellowSprite = var_2_18(var_2_17, var_3(var_4)).sprite
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_8 = var_3.Find(var_4_7, "btn")
	...
	local var_4_11 = var_2.Find(var_4_10, "layout/tip")
	local var_4_12
...
function var_0_1.DoEnterAnimation(arg_8_0)
	...
	var_8_1(var_8_2, var_1_10003(1, 1, 1), 0.2)
...
function var_0_1.InitGroup(arg_10_0)
	...
	if arg_10_0.contextData.customPanels.minHeight then
		...
		typeof = var_3
		LayoutElement = iter_10_2
		var_1(var_10_2, var_3(iter_10_2)).minHeight = arg_10_0.contextData.customPanels.minHeight
	end
...
function var_0_1.InitDropdown(arg_11_0, arg_11_1)
	...
	local var_11_1 = var_1_10003(var_1_10004(arg_11_0.panelTemplate))

	setParent = var_4

	var_4(var_11_1, arg_11_0.contianer, false)

	setActive = var_4

	var_4(var_11_1, true)

	local var_11_2 = var_0_1.Clone2Full(var_11_1:Find("bg"), #var_11_0)

	go = var_5

	local var_11_3 = var_5(var_11_1)

	var_11_3.name = arg_11_1.titleTxt
	setText = var_11_3

	local var_11_4 = var_11_1
	local var_11_5 = var_11_1.Find(var_11_4, "title/Image")

	i18n = var_11_4

	var_11_3(var_11_5, var_11_4(arg_11_1.titleTxt))

	setText = var_11_3

	local var_11_6 = var_11_1
	local var_11_7 = var_11_1.Find(var_11_6, "title/Image/Image_en")

	i18n = var_11_6

	var_11_3(var_11_7, var_11_6(arg_11_1.titleENTxt))
	...
	typeof = var_7
	ScrollRect = var_8
	var_11_9(var_11_8, var_7(var_8)).enabled = false
	ipairs = var_6
	...
	for iter_11_0, iter_11_1 in var_6(var_11_0) do
		...
		var_13(arg_11_0, var_11_10, function()
		...
		arg_11_0.dropdownDic[iter_11_1] = var_1_10012
	end
...
function var_0_1.InitCustoms(arg_13_0, arg_13_1)
	...
	local var_13_2 = var_1_10004(var_1_10005(arg_13_0.panelTemplate))

	setParent = var_5

	var_5(var_13_2, arg_13_0.contianer, false)
	...
	local var_13_3 = var_5(var_13_2)

	var_13_3.name = arg_13_1.titleTxt
	setText = var_13_3

	local var_13_4 = var_13_2
	local var_13_5 = var_13_2.Find(var_13_4, "title/Image")

	i18n = var_13_4

	var_13_3(var_13_5, var_13_4(arg_13_1.titleTxt))

	setText = var_13_3

	local var_13_6 = var_13_2
	local var_13_7 = var_13_2.Find(var_13_6, "title/Image/Image_en")

	i18n = var_13_6

	var_13_3(var_13_7, var_13_6(arg_13_1.titleENTxt))

	local var_13_8 = var_13_2:Find("bg")
	local var_13_9 = var_5.GetComponent

	typeof = var_7
	ScrollRect = var_8
	var_13_9(var_13_8, var_7(var_8)).enabled = false

	local var_13_10 = var_13_1.options
	local var_13_11

	if not var_13_1.mode then
		var_13_11 = var_0_1.Mode.OR
	end
	...
	if not var_13_1.blueSeleted or not arg_13_0.blueSprite then
		var_13_13 = arg_13_0.yellowSprite
	end

	ipairs = var_1_10010

	for iter_13_0, iter_13_1 in var_1_10010(var_13_10) do
		bit = var_1_10015
		var_13_12 = var_1_10015.bor(iter_13_1, var_13_12)
	end

	local var_13_14 = arg_13_0.contextData.indexDatas
	local var_13_15

	if not arg_13_0.contextData.indexDatas[var_13_0] then
		var_13_15 = var_13_10[1]
	end

	var_13_14[var_13_0] = var_13_15

	local var_13_16
	local var_13_17 = var_0_1.Clone2Full(var_13_2:Find("bg"), #var_13_10)

	ipairs = var_12

	for iter_13_2, iter_13_3 in var_12(var_13_17) do
		local var_13_18 = var_13_10[iter_13_2]

		setText = var_1_10018
		findTF = var_1_10019
		var_1_10019 = var_1_10019(iter_13_3, "Image")
		i18n = var_20

		var_1_10018(var_1_10019, var_20(var_13_1.names[iter_13_2]))

		var_1_10019 = arg_13_0

		arg_13_0.UpdateBtnStyle(var_1_10019, iter_13_3, arg_13_0.greySprite)

		onButton = var_1_10018
		var_1_10019 = arg_13_0

		local var_13_19 = iter_13_3

		local function var_13_20()
			switch = var_2_10000

			var_2_10000(var_13_11, {
				[var_0_1.Mode.AND] = function()
					if iter_13_2 == 1 or arg_13_0.contextData.indexDatas[var_13_0] == var_13_10[1] then
						arg_13_0.contextData.indexDatas[var_13_0] = var_13_18
					else
						local var_15_0 = arg_13_0.contextData.indexDatas
						local var_15_1 = var_13_0

						bit = var_3_10002
						var_15_0[var_15_1] = var_3_10002.bxor(arg_13_0.contextData.indexDatas[var_13_0], var_13_18)
					end

					if arg_13_0.contextData.indexDatas[var_13_0] == 0 or arg_13_0.contextData.indexDatas[var_13_0] == var_13_12 then
						arg_13_0.contextData.indexDatas[var_13_0] = var_13_10[1]
					end
				...
				[var_0_1.Mode.OR] = function()
					if var_13_1.isSort then
						...
						if var_13_18 ~= var_16_0 or not var_13_10[1] then
							var_16_3 = var_13_18
						end
				...
				[var_0_1.Mode.NUM] = function()
					...
					if not (var_17_1 < var_13_1.num) then
						...
						if var_17_2.band(arg_13_0.contextData.indexDatas[var_13_0], var_13_18) > 0 then
							var_17_2 = arg_13_0.contextData.indexDatas

							local var_17_3 = var_13_0

							bit = var_3_10004
							var_17_2[var_17_3] = var_3_10004.bxor(arg_13_0.contextData.indexDatas[var_13_0], var_13_18)
						else
							pg = var_17_2
							...
							var_17_5(var_17_4, var_3_10004("equipcode_share_exceedlimit"))
						end
		...
		SFX_UI_TAG = var_1_10022

		var_1_10018(var_1_10019, var_13_19, var_13_20, var_1_10022)
	end
	...
	function var_13_16()
		...
		var_2_10000(var_13_11, {
			[var_0_1.Mode.AND] = function()
				if arg_13_0.contextData.indexDatas[var_13_0] == var_13_10[1] then
					ipairs = var_0

					for iter_19_0, iter_19_1 in var_0(var_13_17) do
						local var_19_0 = var_13_10[iter_19_0] == var_13_10[1]
						...
						if not var_19_0 or not var_13_13 then
					...
					for iter_19_2, iter_19_3 in var_0(var_13_17) do
						if var_13_10[iter_19_2] ~= var_13_10[1] then
							bit = var_5

							local var_19_6 = var_5.band(arg_13_0.contextData.indexDatas[var_13_0], var_13_10[iter_19_2])
							local var_19_7
							...
							if not var_19_7 or not var_13_13 then
			...
			[var_0_1.Mode.OR] = function()
				...
				for iter_20_0, iter_20_1 in var_3_10000(var_13_17) do
					local var_20_0 = var_13_10[iter_20_0] == arg_13_0.contextData.indexDatas[var_13_0]
					...
					if not var_20_0 or not var_13_13 then
			...
			[var_0_1.Mode.NUM] = function()
				...
				for iter_21_0, iter_21_1 in var_3_10000(var_13_17) do
					bit = var_3_10005
					var_3_10005 = var_3_10005.band(arg_13_0.contextData.indexDatas[var_13_0], var_13_10[iter_21_0])
					...
					if not var_3_10005 or not var_13_13 then
	...
	var_12.insert(arg_13_0.updateList, var_13_16)

	if arg_13_1.simpleDropdown then
		assert = var_12

		var_12(var_13_11 == var_0_1.Mode.OR, "simpleDropdown目前只支持OR模式")

		local var_13_21 = var_13_2:Find("bg")
		local var_13_22 = var_12.GetChild(var_13_21, 0)

		ipairs = var_13_21

		for iter_13_4, iter_13_5 in var_13_21(arg_13_1.simpleDropdown) do
			local var_13_23 = arg_13_0.contextData.customPanels[iter_13_5]

			cloneTplTo = var_1_10019
			var_1_10019 = var_1_10019(var_13_22, var_13_2:Find("bg"))
			var_1_10019.name = iter_13_5 .. "_simple"
			SimpleDropdown = var_20

			local var_13_24 = var_20.New(arg_13_0.panel, arg_13_0.event, arg_13_0.contextData, var_13_0, var_1_10019, var_13_23, var_13_16, arg_13_0.greySprite, arg_13_0.yellowSprite)
			...
			var_21(arg_13_0, var_1_10019, function()
				...
				local var_22_2 = var_13_24

				if not var_1.GetLoaded(var_22_2) then
					local var_22_3 = var_13_24

					var_1.Load(var_22_3)
				end

				local var_22_4 = var_13_24
			...
			local var_13_25 = arg_13_0.simpleDropdownDic
			local var_13_26
			...
			var_13_25[var_13_0] = var_13_26
			arg_13_0.simpleDropdownDic[var_13_0][iter_13_5] = var_13_24
		end
	end
...
function var_0_1.willExit(arg_25_0)
	...
	var_25_0(var_1_10002(arg_25_0.panel))
...
function var_0_1.Clone2Full(arg_26_0, arg_26_1)
	...
	for iter_26_0 = 0, var_26_2 - 1 do
		...
		var_1_10012 = arg_26_0

		var_1_10009(var_26_3, arg_26_0.GetChild(var_1_10012, iter_26_0))
	end
	...
	for iter_26_1 = var_26_2, arg_26_1 - 1 do
		...
		local var_26_4 = var_10.insert
		local var_26_5 = var_26_0

		tf = var_1_10012

		var_26_4(var_26_5, var_1_10012(var_1_10009))
	end

	local var_26_6 = arg_26_0.childCount

	for iter_26_2 = 0, var_26_6 - 1 do
		setActive = var_1_10009

		var_1_10009(arg_26_0:GetChild(iter_26_2), iter_26_2 < arg_26_1)
	end

	for iter_26_3 = var_26_6, arg_26_1 + 1, -1 do
		table = var_1_10009
