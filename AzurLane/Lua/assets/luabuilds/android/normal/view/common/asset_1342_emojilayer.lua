...
function var_0_1.init(arg_2_0)
	...
	local var_2_12 = var_2.Find(var_2_11, "null_tpl/Text")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("recently_sticker_placeholder"))
...
function var_0_1.display(arg_5_0)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			local function var_6_5(arg_7_0)
				if arg_7_0 then
					...
					var_3_10001(var_7_0, var_7_1 ~= var_3_10004.EmojiIcon)
					...
					var_3_10001(var_7_2, var_7_3 == var_4.EmojiIcon)
					...
					var_3_10001(var_7_4, var_7_5 ~= var_4.EmojiIcon)
					...
					var_3_10001(var_7_6, var_7_7 == var_4.EmojiIcon)
					...
					if var_7_8 ~= var_7_6.EmojiIcon then
						var_7_9 = arg_5_0
						...
						if var_7_10 == var_7_9.EmojiIcon then
					...
					var_7_13(var_7_12, #var_3.EmojiTypes)
				end
			...
			var_5(var_6_3, var_6_4, var_6_5, var_2_10009)
		end
	...
	var_5_2(var_5_1, #var_4.EmojiTypes)

	triggerToggle = var_5_2

	local var_5_3 = arg_5_0.emojiGroup

	var_5_2(var_3.GetChild(var_5_3, 0), true)
...
function var_0_1.SetTagText(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_1.Find(var_8_0, "Text")

	i18n = var_8_0

	var_1_10003(var_8_1, var_8_0("emoji_type_" .. arg_8_2))
...
function var_0_1.filter(arg_9_0, arg_9_1)
	...
	local var_9_1 = var_9_0(var_1_10003.emoji_template.all, function(arg_10_0)
		pg = var_2_10001
	...
	for iter_9_0, iter_9_1 in var_9_6(var_9_7) do
		table = var_1_10011
	...
	if arg_9_1 == var_6.EmojiCommon then
		...
		local var_9_8 = var_6(var_7)
		local var_9_9 = var_6.getUsedEmoji(var_9_8)
		local var_9_10 = {}

		pairs = iter_9_0

		for iter_9_2, iter_9_3 in iter_9_0(var_9_9) do
			table = var_1_10014
	...
	var_7(var_8.Find(var_9_13, "null_tpl"), var_9_12 == 0)
	...
	for iter_9_6 = arg_9_0.emojiContent.childCount - 1, var_9_12, -1 do
		...
		var_1_10011(var_12.GetChild(var_9_14, iter_9_6))

		local var_9_15 = arg_9_0.emojiSnap
		local var_9_16 = var_1_10011.RemoveChild(var_9_15, iter_9_6).transform

		Vector3 = var_13
		var_9_16.localScale = var_13.one

		local var_9_17 = var_1_10011.transform

		var_12.SetParent(var_9_17, arg_9_0._tf, false)

		setActive = var_12

		var_12(var_1_10011, false)
		arg_9_0:clearItem(var_1_10011)

		table = var_12

		var_12.insert(arg_9_0.tplCaches, var_1_10011)
	end
	...
	for iter_9_8 = 0, arg_9_0.emojiContent.childCount - 1 do
		...
		typeof = var_15
		GridLayoutGroup = var_1_10016

		local var_9_25 = var_13(var_9_24, var_15(var_1_10016))

		UIItemList = var_9_24
		var_1_10016 = var_9_24.New(var_9_22, var_9_22:Find("face"))

		var_14.make(var_1_10016, function(arg_15_0, arg_15_1, arg_15_2)
			...
			if arg_15_0 == var_4.EventUpdate then
				...
				var_4.GetPrefab(var_15_1, "emoji/" .. var_15_0.pic, var_15_0.pic, true, function(arg_16_0)
					...
					if not var_3_10001(arg_15_2) then
						...
						if var_16_1(var_16_0, var_3_10003(var_3_10004)) then
							var_16_1.preserveAspect = true
						end

						tf = var_16_0

						local var_16_2 = var_16_0(arg_16_0)

						Vector2 = var_3
						var_16_2.sizeDelta = var_3(var_9_25.cellSize.x, var_9_25.cellSize.y)
						tf = var_16_2
				...
				var_4(var_15_2, var_15_3, var_15_4, var_8)
			end
		...
		var_14.align(var_1_10016, #var_9_23)
	end
...
function var_0_1.emojiIconFliter(arg_18_0)
	...
	local var_18_1 = var_18_0(var_1_10002.emoji_small_template.all, function(arg_19_0)
		pg = var_2_10001
	...
	local var_18_3 = var_3(var_1_10004)
	...
	for iter_18_3 = arg_18_0.emojiIconContent.childCount + 1, var_18_6 do
		...
		local var_18_7 = var_12(var_1_10011)
		local var_18_8 = var_12.Find(var_18_7, "TitleCommom")
		local var_18_9 = var_12:Find("TitleAll")
		local var_18_10 = var_12:Find("CommomIconContainer")
		local var_18_11 = var_12
		local var_18_12 = var_12.Find(var_18_11, "AllIconContainer")

		GetComponent = var_18_11

		local var_18_13 = var_18_11(var_18_12, "GridLayoutGroup")
		local var_18_15

		if iter_18_3 == 1 then
			local var_18_14 = var_18_10

			var_18_15 = var_18_10.Find(var_18_14, "Icon")
			UIItemList = var_18_14

			local var_18_16 = var_18_14.New(var_18_10, var_18_15)

			var_19.make(var_18_16, function(arg_20_0, arg_20_1, arg_20_2)
						...
						if not var_3_10001(arg_20_2) then
							...
							local function var_21_2()
								if arg_18_0.contextData.emojiIconCallback then
									getProxy = var_0
									ChatProxy = var_4_10001

									local var_22_0 = var_0(var_4_10001)
							...
							var_1(var_21_0, var_21_1, var_21_2, var_3_10005)
						end
			...
			var_18_13.padding.left = 20

			local var_18_17 = var_18_12
			local var_18_18 = var_18_12.Find(var_18_17, "Icon")

			UIItemList = var_18_17

			local var_18_19 = var_18_17.New(var_18_12, var_18_18)

			var_21.make(var_18_19, function(arg_23_0, arg_23_1, arg_23_2)
						...
						if not var_3_10001(arg_23_2) then
							...
							local function var_24_2()
								if arg_18_0.contextData.emojiIconCallback then
									...
									local var_25_0 = var_0(var_4_10001)
							...
							var_1(var_24_0, var_24_1, var_24_2, var_3_10005)
						end
			...
			var_18_15 = var_0_1.True_Emoji_Num_Of_Page - var_0_1.Frequently_Used_Emoji_Num
			_ = var_19

			local var_18_20 = var_19.slice(var_18_1, (iter_18_3 - 2) * var_0_1.True_Emoji_Num_Of_Page + var_18_5 + 1, var_0_1.True_Emoji_Num_Of_Page)

			var_18_13.padding.left = 60

			local var_18_21 = var_18_12
			local var_18_22 = var_18_12.Find(var_18_21, "Icon")

			UIItemList = var_18_21

			local var_18_23 = var_18_21.New(var_18_12, var_18_22)

			var_21.make(var_18_23, function(arg_26_0, arg_26_1, arg_26_2)
				local var_26_0 = var_18_20[arg_26_1 + 1]
						...
						if not var_3_10001(arg_26_2) then
							...
							local function var_27_2()
								if arg_18_0.contextData.emojiIconCallback then
									...
									local var_28_0 = var_0(var_4_10001)
							...
							var_1(var_27_0, var_27_1, var_27_2, var_3_10005)
						end
			...
			var_21:align(#var_18_20)
		end

		setActive = var_18_15

		var_18_15(var_18_8, iter_18_3 == 1)

		setActive = var_18_15

		var_18_15(var_18_9, iter_18_3 == 1)

		setActive = var_18_15

		var_18_15(var_18_10, iter_18_3 == 1)

		setActive = var_18_15

		var_18_15(var_1_10011, true)

		local var_18_24 = arg_18_0.emojiIconSnap

		var_18.AddChild(var_18_24, var_1_10011)
	end
...
function var_0_1.clearItem(arg_30_0, arg_30_1)
	...
	var_1_10002(arg_30_1, function(arg_31_0)
		if arg_31_0.childCount > 0 then
			...
			if arg_31_0.Find(var_31_0, "newtag") then
				Destroy = var_31_0
			...
			local var_31_2 = arg_31_0.GetChild(var_31_1, 0).gameObject
