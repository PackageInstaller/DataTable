...
function var_0_0.load(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	local var_6_3 = arg_6_2.getShipType(var_6_2)

	ShipType = var_6_2

	if var_6_3 ~= var_6_2.WeiXiu then
		ipairs = var_6_3

		for iter_6_0, iter_6_1 in var_6_3(arg_6_3) do
			if iter_6_1 ~= 0 then
				ys = var_1_10011
				var_1_10011 = var_1_10011.Battle.BattleDataFunction.GetWeaponDataFromID(iter_6_1).weapon_id
				ipairs = var_12

				for iter_6_2, iter_6_3 in var_12(var_1_10011) do
	...
	local function var_6_4()
		...
		local function var_7_1(arg_8_0)
			...
			Vector3 = var_3
			var_8_4.localScale = var_3(var_8_3, var_8_3, var_8_3)
			...
			for iter_8_0, iter_8_1 in var_7(var_3_10008.Battle.BattleConst.FXContainerIndex) do
				var_3_10012 = var_8_9[iter_8_0]
				Vector3 = var_3_10013
				var_8_10[iter_8_0] = var_3_10013(var_3_10012[1], var_3_10012[2], var_3_10012[3])
			end
			...
			if arg_6_0.equipSkinId > 0 then
				...
				var_7.attachOrbit(var_8_11)
			end

			ys = var_7

			local var_8_12 = var_7.Battle.BattleFXPool.GetInstance()
			local var_8_13 = var_7.GetCharacterFX(var_8_12, "movewave", arg_6_0)

			pg = var_8_12

			local var_8_14 = var_8_12.EffectMgr.GetInstance()
			local var_8_15 = var_9.PlayBattleEffect
			local var_8_16 = var_8_13

			Vector3 = var_3_10012

			var_8_15(var_8_14, var_8_16, var_3_10012.zero, true)

			arg_6_0.seaFXPool = var_7

			local var_8_17 = arg_6_2
			local var_8_18 = var_9.getShipType(var_8_17)

			ShipType = var_8_17

			if var_8_18 ~= var_8_17.WeiXiu then
				var_8_18 = arg_6_0
				var_8_18.boneList = {}
				var_8_18 = var_8_4.localToWorldMatrix
				pg = var_10

				local var_8_19 = var_10.ship_skin_template[arg_6_2.skinId]

				pairs = var_11

				for iter_8_2, iter_8_3 in var_11(var_8_19.bound_bone) do
					local var_8_20 = {}
					...
					for iter_8_4, iter_8_5 in var_3_10017(iter_8_3) do
						...
						if var_3_10022(iter_8_5) == "table" then
							var_3_10022 = #var_8_20 + 1
							Vector3 = var_23
							var_8_20[var_3_10022] = var_23(iter_8_5[1], iter_8_5[2], iter_8_5[3])
						else
							var_3_10022 = #var_8_20 + 1
							Vector3 = var_23
							var_8_20[var_3_10022] = var_23.zero
						end
					end

					var_3_10017 = arg_6_0.boneList
					var_3_10017[iter_8_2] = var_8_18:MultiplyPoint3x4(var_8_20[1])
				end

				local var_8_21 = arg_6_0

				var_11.SeaUpdate(var_8_21)
			end

			setActive = var_8_18

			var_8_18(arg_6_0.rawImage, true)

			pg = var_8_18

			local var_8_22 = var_8_18.TimeMgr.GetInstance()

			var_9.ResumeBattleTimer(var_8_22)

			local var_8_23 = arg_6_0

			var_9.onWeaponUpdate(var_8_23)
			arg_6_4()
		...
		var_7_3(var_7_2, var_3.getPrefab(var_7_4), function(arg_9_0)
			var_7_1(arg_9_0)
	...
	var_5:StartPreload(var_6_4, nil)

	pg = var_7

	local var_6_5 = var_7.UIMgr.GetInstance()

	var_7.LoadingOn(var_6_5)
...
function var_0_0.attachOrbit(arg_10_0)
	...
	if var_1_10001.equip_skin_template[arg_10_0.equipSkinId].orbit_combat ~= "" then
		...
		var_10_2(var_10_1, var_10_3, var_10_4, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_11_0)
			if arg_10_0.seaCharacter then
				...
				var_2.insert(arg_10_0.orbitList, var_11_0)
				...
				Vector3 = var_2_10005
				var_11_3.localPosition = var_2_10005(var_11_2[1], var_11_2[2], var_11_2[3])
				SpineAnim = var_11_3
...
function var_0_0.playShipAnims(arg_13_0)
	if arg_13_0.loaded and arg_13_0.seaAnimator then
		...
		arg_13_0.palyAnimTimer = var_3.New(function()
			...
			var_16_0(var_2_10001.random(1, #var_13_0))
...
function var_0_0.onWeaponUpdate(arg_17_0)
	if arg_17_0.loaded and arg_17_0.weaponIds then
		if arg_17_0.seaAnimator then
			local var_17_0 = arg_17_0.seaAnimator
		...
		if #arg_17_0.weaponIds == 0 and arg_17_0.playRandomAnims then
			if arg_17_0._fireTimer then
				local var_17_2 = arg_17_0._fireTimer

				var_2.Stop(var_17_2)
			end

			if arg_17_0._delayTimer then
				local var_17_3 = arg_17_0._delayTimer

				var_2.Stop(var_17_3)
			end

			local var_17_4 = arg_17_0.shipVO
			local var_17_5 = var_2.getShipType(var_17_4)

			ShipType = var_17_4

			if var_17_5 ~= var_17_4.WeiXiu then
				var_17_1()
			elseif arg_17_0.buffTimer then
				pg = var_2

				local var_17_6 = var_2.TimeMgr.GetInstance()

				var_2.RemoveBattleTimer(var_17_6, arg_17_0.buffTimer)
			...
			local var_17_7 = arg_17_0.shipVO
			local var_17_8 = var_2.getShipType(var_17_7)

			ShipType = var_17_7

			local var_17_9

			if var_17_8 ~= var_17_7.WeiXiu then
				var_17_1()

				var_17_9 = arg_17_0

				arg_17_0.MakeWeapon(var_17_9, arg_17_0.weaponIds)

				var_17_9 = arg_17_0

				arg_17_0.SeaFire(var_17_9)
			elseif arg_17_0.weaponIds[1] then
				Equipment = var_17_9

				local var_17_10 = var_17_9.getConfigData(var_2).skill_id[1] and var_3[1]

				arg_17_0:MakeBuff(var_17_10)
			end
		end
	end
...
function var_0_0.SeaFire(arg_19_0)
	...
	if arg_19_0._fireTimer then
		var_1_10003 = arg_19_0._delayTimer

		var_2.Stop(var_1_10003)

		var_1_10003 = arg_19_0._fireTimer

		var_2.Stop(var_1_10003)

		var_1_10003 = arg_19_0._fireTimer

		var_2.Start(var_1_10003)
	else
...
function var_0_0.MakeBuff(arg_25_0, arg_25_1)
	...
	arg_25_0.buffTimer = var_6.AddBattleTimer(var_25_4, "buffTimer", -1, var_25_1, function()
		...
		var_2_10000(var_1.Find(var_26_0, "text"), var_25_2.effect_list[1].arg_list.number)
...
function var_0_0.MakeWeapon(arg_27_0, arg_27_1)
	...
	for iter_27_0, iter_27_1 in var_1_10004(arg_27_1) do
		...
		for iter_27_2, iter_27_3 in var_10(var_1_10009) do
			if iter_27_3 <= 0 then
				break
			end
...
function var_0_0.getEmitterHost(arg_28_0)
	if not arg_28_0._emitterHost then
		...
		ys = var_1_10003
		arg_28_0._emitterHost = var_28_0(var_28_1, var_1_10003.Battle.BattleConfig.FRIENDLY_CODE)
...
function var_0_0.createEmitterCannon(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	local function var_29_1(arg_30_0, arg_30_1, arg_30_2, arg_30_3, arg_30_4)
		...
		if arg_29_0.equipSkinId > 0 then
			...
			local var_30_2 = var_7.equip_skin_template[arg_29_0.equipSkinId]

			ys = var_8

			local var_30_3, var_30_4, var_30_5, var_30_6, var_30_7, var_30_8 = var_8.Battle.BattleDataFunction.GetEquipSkin(arg_29_0.equipSkinId)
			local var_30_9 = var_6
			local var_30_10 = var_6.GetType(var_30_9)

			ys = var_30_9

			local var_30_11 = var_30_9.Battle.BattleConst.BulletType
			local var_30_12
			...
			if var_30_10 == var_30_11.CANNON or var_30_10 == var_30_11.BOMB then
				...
				EquipType = var_2_10018

				if var_30_13(var_2_10018.CannonEquipTypes, function(arg_31_0)
					table = var_3_10001

					return var_3_10001.contains(var_30_2.equip_type, arg_31_0)
				end) then
					var_6:SetModleID(var_30_3)
				elseif var_30_4 and #var_30_4 > 0 then
					var_6:SetModleID(var_30_4, nil, var_30_8)
				elseif var_30_6 and #var_30_6 > 0 then
					var_6:SetModleID(var_30_6, nil, var_30_8)
				end
			elseif var_30_10 == var_30_11.TORPEDO then
				table = var_17

				local var_30_14 = var_17.contains
				local var_30_15 = var_30_2.equip_type

				EquipType = var_2_10019

				if var_30_14(var_30_15, var_2_10019.Torpedo) then
					var_6:SetModleID(var_30_3)
				elseif var_30_5 and #var_30_5 > 0 then
					var_6:SetModleID(var_30_5, nil, var_30_8)
				end
			end
		end

		local var_30_16 = var_6
		local var_30_17 = var_6.GetType(var_30_16)

		ys = var_30_16

		local var_30_18 = var_30_16.Battle.BattleConst.BulletType
		local var_30_19

		if var_30_17 == var_30_18.CANNON then
			ys = var_10
			var_30_19 = var_10.Battle.BattleCannonBullet.New()
		elseif var_30_17 == var_30_18.BOMB then
			ys = var_10
			var_30_19 = var_10.Battle.BattleBombBullet.New()
		elseif var_30_17 == var_30_18.TORPEDO then
			ys = var_10
			var_30_19 = var_10.Battle.BattleTorpedoBullet.New()
		else
			ys = var_10
			var_30_19 = var_10.Battle.BattleBullet.New()
		end

		local var_30_20 = var_30_19

		var_30_19.SetBulletData(var_30_20, var_6)

		local function var_30_21(arg_32_0)
			local var_32_0 = var_30_19

			var_1.AddModel(var_32_0, arg_32_0)

			local var_32_1 = var_30_19
			...
			if var_1:Find("bullet_random") then
				local var_32_2 = var_2
				local var_32_3 = var_2.GetComponent

				typeof = var_3_10005
				SpineAnim = var_3_10006

				if var_32_3(var_32_2, var_3_10005(var_3_10006)) then
					local var_32_4 = var_2
					local var_32_5 = var_2.GetComponent

					typeof = var_5
					SpineAnim = var_3_10006

					local var_32_6 = var_32_5(var_32_4, var_5(var_3_10006))

					tostring = var_32_4
					math = var_5

					local var_32_7 = var_32_4(var_5.random(3))

					var_32_6:SetAction(var_32_7, 0, false)
				end
			end

			local var_32_8 = var_30_19

			var_3.SetSpawn(var_32_8, arg_29_0.boneList[arg_29_3])

			if arg_29_0.bulletList then
				table = var_3

				var_3.insert(arg_29_0.bulletList, var_30_19)

				if arg_29_0.equipSkinId > 0 then
					pg = var_3

					local var_32_9 = var_3.equip_skin_template[arg_29_0.equipSkinId]
					local var_32_10 = var_0
					local var_32_11 = var_4.GetType(var_32_10)

					ys = var_32_10

					if var_32_11 == var_32_10.Battle.BattleConst.BulletType.CANNON then
						_ = var_6

						local var_32_12 = var_6.any

						EquipType = var_3_10007

						if var_32_12(var_3_10007.CannonEquipTypes, function(arg_33_0)
							table = var_4_10001

							return var_4_10001.contains(var_32_9.equip_type, arg_33_0)
						end) and var_32_9.preview_hit_distance > 0 then
							local var_32_13 = arg_29_0

							var_6.AddSelfDestroyBullet(var_32_13, var_30_19, var_32_9.preview_hit_distance)
						end
					elseif var_32_11 == var_5.TORPEDO then
						table = var_6

						local var_32_14 = var_6.contains
						local var_32_15 = var_32_9.equip_type

						EquipType = var_3_10008

						if var_32_14(var_32_15, var_3_10008.Torpedo) and var_32_9.preview_hit_distance > 0 then
							local var_32_16 = arg_29_0

							var_6.AddSelfDestroyBullet(var_32_16, var_30_19, var_32_9.preview_hit_distance)
						end
					end
				end
			end
		...
		local var_30_22 = var_30_20.Battle.BattleResourceManager.GetInstance()

		var_11.InstBullet(var_30_22, var_30_19:GetModleID(), function(arg_34_0)
			var_30_21(arg_34_0)
...
function var_0_0.createEmitterAir(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	local function var_36_0(arg_37_0, arg_37_1, arg_37_2, arg_37_3, arg_37_4)
		...
		local var_37_2 = var_2_10009.cos(var_37_1)
		local var_37_3 = 0

		math = var_2_10011

		local var_37_4 = var_2_10008(var_37_2, var_37_3, var_2_10011.sin(var_37_1))
		...
		if arg_36_0.equipSkinId > 0 then
			...
			EquipType = var_2_10014

			if var_37_8(var_37_9, var_2_10014.AirProtoEquipTypes[var_6.type]) then
				ys = var_12
...
function var_0_0.RemoveBullet(arg_43_0, arg_43_1, arg_43_2)
	...
	if arg_43_2 then
		...
		if var_43_1 and var_43_1 ~= "" then
			...
			local var_43_5 = var_7.EffectMgr.GetInstance()
	...
	local function var_44_7()
		for iter_45_0 = #arg_44_0.bulletList, 1, -1 do
			...
			if var_4:GetPosition().x > var_44_2 and var_45_1.x > 0 or var_6.z < var_44_3 and var_45_1.z < 0 then
				...
				var_7.RemoveBullet(var_45_2, iter_45_0, false)

				goto label_45_0
			end

			if var_6.x < var_44_1 and var_45_1.x < 0 and var_4:GetType() ~= var_44_6.BulletType.BOMB then
				local var_45_3 = arg_44_0

				var_7.RemoveBullet(var_45_3, iter_45_0, false)
			...
			local var_45_4 = var_7.TimeMgr.GetInstance()
			local var_45_5 = var_7.GetCombatTime(var_45_4)

			var_2_10009 = var_4._bulletData

			var_8.Update(var_2_10009, var_45_5)

			var_2_10009 = var_4

			var_4.Update(var_2_10009, var_44_0)

			local var_45_6 = var_6.z

			if var_44_4 < var_45_6 then
				local var_45_7 = var_45_1.z

				if not (0 < var_45_7) then
					var_2_10009 = var_4._bulletData

					if var_8.IsOutRange(var_2_10009, var_44_0) then
						var_2_10009 = arg_44_0

						var_8.RemoveBullet(var_2_10009, iter_45_0, true)
					end
