...
function var_0_0.addListener(arg_7_0)
	...
	local function var_7_8()
		...
		if var_10_1(var_10_0, var_2_10003) then
			local var_10_2 = arg_7_0

			var_10_0.exit(var_10_2)
		else
			pg = var_10_0
			...
			local var_10_5 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			local var_10_6 = var_2_10005.CHARGE
			local var_10_7 = {}

			ChargeScene = var_2_10007
			var_10_7.wrap = var_2_10007.TYPE_ITEM
	...
	local function var_7_11()
		...
		var_11_2(var_11_1, var_2_10003.SHOPPING, {
	...
	for iter_7_0 = 1, 2 do
		...
		var_1_10005(var_7_12, var_7_13, var_7_14, var_1_10009)
		...
		var_1_10005(var_7_15, var_7_16, var_7_17, var_1_10009)
	end
