...
local var_0_2 = var_0_0("Mgr.const.MsgboxBtnNameMap")
...
function var_0_1.init(arg_2_0)
	...
	local var_2_5 = var_2.Find(var_2_4, "infomation/title")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("words_information"))

	setText = var_1

	local var_2_6 = arg_2_0._titleList
	local var_2_7 = var_2.Find(var_2_6, "cadpa/title")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("cadpa_tip1"))
	...
	local var_2_16 = var_4.Find(var_2_15, "diamond")
	local var_2_17 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_13(var_2_12, var_2_14, var_2_17(var_2_16, var_6(var_1_10007)).sprite)

	local var_2_18 = arg_2_0.contentText
	local var_2_19 = var_1.AddSprite
	local var_2_20 = "gold"
	local var_2_21 = arg_2_0._res
	local var_2_22 = var_4.Find(var_2_21, "gold")
	local var_2_23 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_19(var_2_18, var_2_20, var_2_23(var_2_22, var_6(var_1_10007)).sprite)

	local var_2_24 = arg_2_0.contentText
	local var_2_25 = var_1.AddSprite
	local var_2_26 = "oil"
	local var_2_27 = arg_2_0._res
	local var_2_28 = var_4.Find(var_2_27, "oil")
	local var_2_29 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_25(var_2_24, var_2_26, var_2_29(var_2_28, var_6(var_1_10007)).sprite)

	local var_2_30 = arg_2_0.contentText
	local var_2_31 = var_1.AddSprite
	local var_2_32 = "world_money"
	local var_2_33 = arg_2_0._res
	local var_2_34 = var_4.Find(var_2_33, "world_money")
	local var_2_35 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_31(var_2_30, var_2_32, var_2_35(var_2_34, var_6(var_1_10007)).sprite)

	local var_2_36 = arg_2_0.contentText
	local var_2_37 = var_1.AddSprite
	local var_2_38 = "port_money"
	local var_2_39 = arg_2_0._res
	local var_2_40 = var_4.Find(var_2_39, "port_money")
	local var_2_41 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_37(var_2_36, var_2_38, var_2_41(var_2_40, var_6(var_1_10007)).sprite)

	local var_2_42 = arg_2_0.contentText
	local var_2_43 = var_1.AddSprite
	local var_2_44 = "guildicon"
	local var_2_45 = arg_2_0._res
	local var_2_46 = var_4.Find(var_2_45, "guildicon")
	local var_2_47 = var_4.GetComponent

	typeof = var_6
	Image = var_1_10007

	var_2_43(var_2_42, var_2_44, var_2_47(var_2_46, var_6(var_1_10007)).sprite)
	...
	typeof = var_3
	Text = var_4
	arg_2_0._itemText = var_2_52(var_2_51, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0._eskinText = var_2_58(var_2_57, var_3(var_4))
	...
	local var_2_69 = var_5.Find(var_2_68, "diamond")
	local var_2_70 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_66(var_2_65, var_2_67, var_2_70(var_2_69, var_7(var_1_10008)).sprite)

	local var_2_71 = var_1
	local var_2_72 = var_1.AddSprite
	local var_2_73 = "gold"
	local var_2_74 = arg_2_0._res
	local var_2_75 = var_5.Find(var_2_74, "gold")
	local var_2_76 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_72(var_2_71, var_2_73, var_2_76(var_2_75, var_7(var_1_10008)).sprite)

	local var_2_77 = var_1
	local var_2_78 = var_1.AddSprite
	local var_2_79 = "oil"
	local var_2_80 = arg_2_0._res
	local var_2_81 = var_5.Find(var_2_80, "oil")
	local var_2_82 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_78(var_2_77, var_2_79, var_2_82(var_2_81, var_7(var_1_10008)).sprite)

	local var_2_83 = var_1
	local var_2_84 = var_1.AddSprite
	local var_2_85 = "world_money"
	local var_2_86 = arg_2_0._res
	local var_2_87 = var_5.Find(var_2_86, "world_money")
	local var_2_88 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_84(var_2_83, var_2_85, var_2_88(var_2_87, var_7(var_1_10008)).sprite)

	local var_2_89 = var_1
	local var_2_90 = var_1.AddSprite
	local var_2_91 = "port_money"
	local var_2_92 = arg_2_0._res
	local var_2_93 = var_5.Find(var_2_92, "port_money")
	local var_2_94 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_90(var_2_89, var_2_91, var_2_94(var_2_93, var_7(var_1_10008)).sprite)

	local var_2_95 = var_1
	local var_2_96 = var_1.AddSprite
	local var_2_97 = "world_boss"
	local var_2_98 = arg_2_0._res
	local var_2_99 = var_5.Find(var_2_98, "world_boss")
	local var_2_100 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008

	var_2_96(var_2_95, var_2_97, var_2_100(var_2_99, var_7(var_1_10008)).sprite)
	...
	local var_2_103 = var_3.Find(var_2_102, "ship_group/locked/Text")

	i18n = var_2_102

	var_2(var_2_103, var_2_102("tag_ship_locked"))

	setText = var_2

	local var_2_104 = arg_2_0._sigleItemPanel
	local var_2_105 = var_3.Find(var_2_104, "ship_group/unlocked/Text")

	i18n = var_2_104

	var_2(var_2_105, var_2_104("tag_ship_unlocked"))
	...
	typeof = var_4
	Text = var_5
	arg_2_0._inputTitle = var_2_109(var_2_108, var_4(var_5))
	...
	typeof = var_4
	InputField = var_5
	arg_2_0._inputField = var_2_112(var_2_111, var_4(var_5))
	...
	typeof = var_4
	Text = var_5
	arg_2_0._placeholderTF = var_2_115(var_2_114, var_4(var_5))
	...
	local var_2_130 = var_3.Find(var_2_129, "value_bg/left")
	local var_2_131 = arg_2_0._countSelect
	local var_2_132 = var_4.Find(var_2_131, "value_bg/right")
	local var_2_133 = arg_2_0._countSelect
	local var_2_134 = var_5.Find(var_2_133, "max")
	local var_2_135 = arg_2_0._countSelect

	arg_2_0._pageUtil = var_2_128(var_2_130, var_2_132, var_2_134, var_6.Find(var_2_135, "value_bg/value"))
	...
	typeof = var_4
	Toggle = var_2_134
	arg_2_0.stopRemindToggle = var_2_144(var_2_143, var_4(var_2_134))
	tf = var_2
	...
	typeof = var_4
	Text = var_2_134
	arg_2_0.stopRemindText = var_2_147(var_2_146, var_4(var_2_134))
...
function var_0_1.showHelpWindow(arg_8_0, arg_8_1)
	...
	var_2(var_3.Find(var_8_1, "btn_blueprint"), arg_8_1.show_blueprint)
	...
	if arg_8_1.show_blueprint then
		...
		local var_8_3 = arg_8_0._helpPanel
		local var_8_4 = var_4.Find(var_8_3, "btn_blueprint")
		...
		local function var_8_5()
			...
			local var_9_3 = var_2_10002.GO_SCENE

			SCENE = var_2_10003

			var_9_2(var_9_1, var_9_3, var_2_10003.SHIPBLUEPRINT, {
		...
		var_2(var_8_2, var_8_4, var_8_5, var_6)
	end

	if arg_8_1.helps.helpSize then
		local var_8_6 = arg_8_0._helpPanel
		...
		if not arg_8_1.helps.helpSize.x then
			var_8_7 = arg_8_0._defaultHelpSize.x
		end

		local var_8_8

		if not arg_8_1.helps.helpSize.y then
			var_8_8 = arg_8_0._defaultHelpSize.y
		end

		var_8_6.sizeDelta = var_8_2(var_8_7, var_8_8)
	end

	if arg_8_1.helps.helpPos then
		setAnchoredPosition = var_2
		var_8_2 = arg_8_0._helpPanel

		local var_8_9 = {}
		local var_8_10

		if not arg_8_1.helps.helpPos.x then
			var_8_10 = arg_8_0._defaultHelpPos.x
		end
		...
		if not arg_8_1.helps.helpPos.y then
			var_8_11 = arg_8_0._defaultHelpPos.y
		end

		var_8_9.y = var_8_11

		var_2(var_8_2, var_8_9)
	end

	if arg_8_1.helps.windowSize then
		local var_8_12 = arg_8_0._window
		...
		if not arg_8_1.helps.windowSize.x then
			var_8_13 = arg_8_0._defaultSize.x
		end

		local var_8_14

		if not arg_8_1.helps.windowSize.y then
			var_8_14 = arg_8_0._defaultSize.y
		end

		var_8_12.sizeDelta = var_8_2(var_8_13, var_8_14)
	end

	local var_8_15

	if arg_8_1.helps.windowPos then
		var_8_15 = arg_8_0._window
		Vector2 = var_8_2

		local var_8_16

		if not arg_8_1.helps.windowSize.x then
			var_8_16 = arg_8_0._defaultSize.x
		end

		local var_8_17

		if not arg_8_1.helps.windowSize.y then
			var_8_17 = arg_8_0._defaultSize.y
		end

		var_8_15.sizeDelta = var_8_2(var_8_16, var_8_17)
		setAnchoredPosition = var_8_15

		local var_8_18 = arg_8_0._window
		local var_8_19 = {}
		local var_8_20
	...
	if arg_8_1.helps.disableScroll then
		local var_8_22 = arg_8_0._helpPanel
		local var_8_23 = var_2.Find(var_8_22, "list")

		SetCompomentEnabled = var_8_22

		local var_8_24 = arg_8_0._helpPanel
		local var_8_25 = var_4.Find(var_8_24, "list")

		typeof = var_8_24
		ScrollRect = var_6

		var_8_22(var_8_25, var_8_24(var_6), not arg_8_1.helps.disableScroll)

		setAnchoredPosition = var_8_22

		local var_8_26 = var_8_23

		Vector2 = var_5

		var_8_22(var_8_26, var_5.zero)

		setActive = var_8_22
		findTF = var_8_26

		var_8_22(var_8_26(arg_8_0._helpPanel, "Scrollbar"), false)
	end
	...
	if arg_8_1.helps.ImageMode then
		...
		var_2(var_3(arg_8_0._window, "bg"), false)
	end

	for iter_8_0 = #arg_8_0.settings.helps, arg_8_0._helpList.childCount - 1 do
		Destroy = var_1_10007

		local var_8_27 = arg_8_0._helpList

		var_1_10007(var_8.GetChild(var_8_27, iter_8_0))
	end

	for iter_8_1 = arg_8_0._helpList.childCount, #var_2 - 1 do
		cloneTplTo = var_1_10007

		var_1_10007(arg_8_0._helpTpl, arg_8_0._helpList)
	end

	ipairs = var_3

	for iter_8_2, iter_8_3 in var_3(var_2) do
		local var_8_28 = arg_8_0._helpList
		local var_8_29 = var_8.GetChild(var_8_28, iter_8_2 - 1)

		setActive = var_8_28

		var_8_28(var_8_29, true)

		local var_8_30 = var_8_29
		local var_8_31 = var_8_29.Find(var_8_30, "icon")

		setActive = var_8_30

		var_8_30(var_8_31, iter_8_3.icon)

		setActive = var_8_30
		findTF = var_11

		var_8_30(var_11(var_8_29, "line"), iter_8_3.line)
		...
		if iter_8_3.icon then
			...
			local var_8_33 = var_8_31.transform
			...
			var_8_33.localScale = var_12(var_8_34, var_8_35)

			local var_8_36 = iter_8_3.icon.path
			local var_8_37
			...
			local var_8_38 = var_8_35(iter_8_3.icon.atlas, iter_8_3.icon.path)

			setImageSprite = var_1_10015

			local var_8_39 = var_8_31
			local var_8_40 = var_8_31.GetComponent

			typeof = var_1_10018
			Image = var_1_10019

			var_1_10015(var_8_40(var_8_39, var_1_10018(var_1_10019)), var_8_38, true)

			setAnchoredPosition = var_1_10015

			var_1_10015(var_8_31, {
				x = var_8_37,
				y = var_8_34
			})
			...
			var_1_10015(var_8_31:Find("corner"), arg_8_1.helps.pageMode)
		end

		local var_8_41 = var_8_29:Find("richText")
		local var_8_42 = var_10.GetComponent(var_8_41, "RichText")
		local var_8_43

		if iter_8_3.rawIcon then
			var_8_43 = iter_8_3.rawIcon.name
			var_8_34 = var_8_42

			local var_8_44 = var_8_42.AddSprite
			local var_8_45 = var_8_43

			GetSpriteFromAtlas = var_1_10015

			var_8_44(var_8_34, var_8_45, var_1_10015(iter_8_3.rawIcon.atlas, var_8_43))

			HXSet = var_8_44

			local var_8_46 = var_8_44.hxLan

			if not iter_8_3.info then
				var_8_34 = ""
			end

			local var_8_47 = var_8_46(var_8_34)
			...
			string = var_8_34
			var_8_42.text = var_8_34.format("<icon name=%s w=0.7 h=0.7/>%s", var_8_43, var_8_47)
		...
		local var_8_48 = var_8_29

		HXSet = var_8_34

		local var_8_49 = var_8_34.hxLan
		...
		if iter_8_3.info then
			...
			do
				...
				if not var_14(iter_8_3.info, true) then
					var_8_50 = ""
				end

				var_8_43(var_8_48, var_8_49(var_8_50))
			end
			...
			var_8_43(var_8_42.gameObject, iter_8_3.rawIcon)
		end
	end
...
function var_0_1.switchHelpPage(arg_10_0, arg_10_1)
	for iter_10_0 = 1, arg_10_0._helpList.childCount do
		...
		var_10_0(var_10_1, arg_10_1 == iter_10_0)

		setText = var_10_0

		var_10_0(var_10_1:Find("icon/corner/Text"), iter_10_0)
	end
...
function var_0_1.commonSetting(arg_11_0, arg_11_1)
	...
	var_11_2(var_11_3(arg_11_0.stopRemindToggle), arg_11_1.showStopRemind)
	...
	var_3(arg_11_0._countSelect, var_11_6)
	...
	if arg_11_0.settings.discount then
		...
		typeof = var_9
		Text = var_1_10010
		var_11_16 = var_11_16(var_11_15, var_9(var_1_10010))
		...
		typeof = var_9
		Text = var_1_10010
		var_11_16 = var_11_16(var_11_17, var_9(var_1_10010))
	...
	if arg_11_0.settings.remaster then
		...
		local var_11_19 = arg_11_0._remasterPanel

		var_8(var_9.Find(var_11_19, "content/Text"), var_11_18.word)

		setText = var_8

		local var_11_20 = arg_11_0._remasterPanel
		local var_11_21 = var_9.Find(var_11_20, "content/count")
		local var_11_22
		...
		var_8(var_11_21, var_11_22)

		setText = var_8

		local var_11_23 = arg_11_0._remasterPanel

		var_8(var_9.Find(var_11_23, "btn/pic"), var_11_18.btn_text)

		onButton = var_8

		local var_11_24 = arg_11_0
		local var_11_25 = arg_11_0._remasterPanel

		var_8(var_11_24, var_10.Find(var_11_25, "btn"), function()
	...
	local var_11_32 = var_1_10014(arg_11_0._go)
	...
	var_1_10012(var_11_31, var_11_33, var_11_34, var_16)

	SetCompomentEnabled = var_1_10012
	tf = var_11_31

	local var_11_35 = var_11_31(arg_11_0._go)
	local var_11_36 = var_13.Find(var_11_35, "bg")

	typeof = var_11_35
	Button = var_15

	var_1_10012(var_11_36, var_11_35(var_15), not var_11_28)

	local var_11_37
	local var_11_38

	if not var_11_26 then
		local var_11_39 = arg_11_0
		local var_11_40 = arg_11_0.createBtn
		local var_11_41 = {}
		local var_11_42

		if not arg_11_0.settings.noText then
			var_11_42 = var_0_1.TEXT_CANCEL
		end

		var_11_41.text = var_11_42

		local var_11_43

		if not arg_11_0.settings.noBtnType then
			var_11_43 = var_0_1.BUTTON_GRAY
		end

		var_11_41.btnType = var_11_43
		var_11_41.onCallback = var_11_30

		if not arg_11_1.noSound then
			SFX_CANCEL = var_17
		end

		var_11_41.sound = var_17

		local var_11_44 = var_11_40(var_11_39, var_11_41)
	end

	if not var_11_27 then
		local var_11_45 = arg_11_0
		local var_11_46 = arg_11_0.createBtn
		local var_11_47 = {}
		local var_11_48

		if not arg_11_0.settings.yesText then
			var_11_48 = var_0_1.TEXT_CONFIRM
		end

		var_11_47.text = var_11_48

		local var_11_49

		if not arg_11_0.settings.yesBtnType then
			var_11_49 = var_0_1.BUTTON_BLUE
		end

		var_11_47.btnType = var_11_49
		var_11_47.onCallback = var_11_29

		if not arg_11_1.yesSound then
			SFX_CONFIRM = var_17
		end

		var_11_47.sound = var_17

		local var_11_50

		if arg_11_0.settings.yesSize then
			TextAnchor = var_11_50
			var_11_50 = var_11_50.MiddleCenter
		end

		var_11_47.alignment = var_11_50
		var_11_38 = var_11_46(var_11_45, var_11_47)

		if arg_11_0.settings.yesSize then
			var_11_38.sizeDelta = arg_11_0.settings.yesSize
		end

		setGray = var_14

		var_14(var_11_38, arg_11_0.settings.yesGray, true)
	end

	if arg_11_0.settings.yseBtnLetf then
		var_11_38:SetAsFirstSibling()
	end
	...
	local var_11_52 = arg_11_0._closeBtn
	...
	SFX_CANCEL = iter_11_3

	var_14(var_11_51, var_11_52, var_11_53, iter_11_3)

	local var_11_54

	if not arg_11_0.settings.title then
		var_11_54 = var_0_1.TITLE_INFORMATION
	end

	local var_11_55 = 0
	local var_11_56 = arg_11_0._titleList.transform.childCount

	while var_11_55 < var_11_56 do
		local var_11_57 = arg_11_0._titleList.transform
		local var_11_58 = var_17.GetChild(var_11_57, var_11_55)

		SetActive = var_11_57

		var_11_57(var_11_58, var_11_58.name == var_11_54)

		var_11_55 = var_11_55 + 1
	end

	local var_11_59 = arg_11_0._go.transform.localPosition
	local var_11_60 = arg_11_0._go.transform

	Vector3 = var_1_10019

	local var_11_61 = var_11_59.x
	local var_11_62 = var_11_59.y
	local var_11_63
	...
	var_11_60.localPosition = var_1_10019(var_11_61, var_11_62, var_11_63)
...
function var_0_1.AddSprites(arg_18_0)
	...
	var_18_1(var_18_2, function(arg_19_0, arg_19_1)
		...
		LoadSprite = var_2_10005

		var_19_1(var_19_0, var_19_2, var_2_10005(arg_19_1.path, arg_19_1.name))
...
function var_0_1.createBtn(arg_20_0, arg_20_1)
	...
	local var_20_4 = var_20_2(var_20_3, arg_20_0._btnContainer)
	local var_20_5
	...
	if var_20_0 == var_0_1.BUTTON_MEDAL then
		...
		var_6(var_20_4:Find("text"), arg_20_1.text)
	...
	if var_20_0 == var_0_1.BUTTON_BLUE_WITH_ICON and arg_20_1.iconName then
		...
		var_20_9, setImageSprite = var_20_4.Find(var_20_8, "ticket/icon"), var_20_8
		LoadSprite = var_1_10009

		var_20_8(var_20_9, var_1_10009(arg_20_1.iconName[1], arg_20_1.iconName[2]))
	end
	...
	if not arg_20_1.hideEvent then
		...
		var_6(var_20_10, var_20_11, var_20_12, var_10)
	end
...
function var_0_1.updateButton(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	local var_22_2 = arg_22_1.Find(var_22_1, "pic")
	...
	if var_22_0 then
		...
		var_6(var_22_3, var_1_10008(var_22_0))
	else
		string = var_6
		...
		if var_6.len(arg_22_2) > 12 then
			GetComponent = var_22_5

			local var_22_4 = var_22_2

			typeof = var_1_10008
			Text = var_1_10009
			var_22_5 = var_22_5(var_22_4, var_1_10008(var_1_10009))
			var_22_5.resizeTextForBestFit = true
		end

		setText = var_22_5

		var_22_5(var_22_2, arg_22_2)
	end

	if arg_22_3 then
		local var_22_6 = var_22_2
		local var_22_7 = var_22_2.GetComponent

		typeof = var_1_10008
		Text = var_1_10009
		var_22_7(var_22_6, var_1_10008(var_1_10009)).alignment = arg_22_3
	end
...
function var_0_1.Loaded(arg_23_0, arg_23_1)
	...
	var_23_2(var_23_1, var_4.OPEN_MSGBOX_DONE)
...
function var_0_1.Clear(arg_24_0)
	...
	local var_24_3 = var_2.Find(var_24_2, "list")

	typeof = var_24_2
	ScrollRect = var_4

	var_24_1(var_24_3, var_24_2(var_4), true)
	...
	var_24_1(var_2(arg_24_0._window, "bg"), true)

	setActive = var_24_1

	local var_24_4 = arg_24_0._sigleItemPanel

	var_24_1(var_2.Find(var_24_4, "left/own"), false)

	local var_24_5 = arg_24_0._sigleItemPanel
	local var_24_6 = var_1.Find(var_24_5, "left/IconTpl")

	SetCompomentEnabled = var_24_5

	local var_24_7 = var_24_6
	local var_24_8 = var_24_6.Find(var_24_7, "icon_bg")

	typeof = var_24_7
	Image = var_5

	var_24_5(var_24_8, var_24_7(var_5), true)

	SetCompomentEnabled = var_24_5

	local var_24_9 = var_24_6
	local var_24_10 = var_24_6.Find(var_24_9, "icon_bg/frame")

	typeof = var_24_9
	Image = var_5

	var_24_5(var_24_10, var_24_9(var_5), true)

	setActive = var_24_5

	var_24_5(var_24_6:Find("icon_bg/slv"), false)

	findTF = var_24_5

	local var_24_11 = var_24_5(var_24_6, "icon_bg/icon")

	Vector2 = var_3
	var_24_11.pivot = var_3(0.5, 0.5)
	Vector2 = var_3
	var_24_11.sizeDelta = var_3(-4, -4)
	Vector2 = var_3
	var_24_11.anchoredPosition = var_3(0, 0)
	setActive = var_3
	...
	for iter_24_2 = 0, arg_24_0._helpList.childCount - 1 do
		var_1_10008 = arg_24_0._helpList
		var_1_10008 = var_7.GetChild(var_1_10008, iter_24_2)
		var_1_10008 = var_7.Find(var_1_10008, "icon")

		local var_24_12 = var_7.GetComponent

		typeof = var_9
		Image = var_1_10010
		var_24_12(var_1_10008, var_9(var_1_10010)).sprite = nil
	end
	...
	for iter_24_3, iter_24_4 in var_3(arg_24_0.pools) do
		if iter_24_4 then
			...
			local var_24_13 = var_1_10008.GetInstance()

			var_1_10008.ReturnUI(var_24_13, iter_24_4.name, iter_24_4)
		end
	end
	...
	local var_24_14 = arg_24_0.contentText

	var_3.RemoveAllListeners(var_24_14)
...
function var_0_1.hide(arg_26_0)
	...
	var_26_1(var_26_0, var_1_10003.CLOSE_MSGBOX_DONE)
