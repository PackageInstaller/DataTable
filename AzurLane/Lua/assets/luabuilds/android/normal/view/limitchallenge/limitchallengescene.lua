...
function var_0_1.initData(arg_6_0)
	...
	LimitChallengeProxy = var_1_10002
	...
	arg_6_0.curMonth = var_0_0.GetCurMonth()
	arg_6_0.descList = {}
...
function var_0_1.findUI(arg_7_0)
	...
	var_2(var_7_15, var_4("time_remaining_tip"))
	...
	var_2(var_7_16, var_4("word_date"))
...
function var_0_1.addListener(arg_8_0)
	...
	var_1_10001(var_8_4, var_8_5, var_8_6, var_1_10005)
	...
	local function var_8_9()
		...
		pg = var_2_10003
		var_11_2.helps = var_2_10003.gametip.challenge_help.tip
	...
	var_1_10001(var_8_7, var_8_8, var_8_9, var_1_10005)
	...
	local function var_8_12()
		...
		var_12_1(var_12_0, var_2_10002.ShareMgr.TypeChallenge)
	...
	var_1_10001(var_8_10, var_8_11, var_8_12, var_1_10005)
	...
	for iter_8_0, iter_8_1 in var_1_10001(arg_8_0.levelToggleList) do
		...
		var_1_10006(var_8_13, var_8_14, var_8_15, var_1_10010, var_1_10011)
	end
	...
	local function var_8_18()
		local var_14_0 = var_0_0.GetStageIDByLevel(arg_8_0.curLevel)
		local var_14_1 = arg_8_0

		var_1.emit(var_14_1, var_0_0.OPEN_PRE_COMBAT_LAYER, {
			stageID = var_14_0
		})
	...
	var_1(var_8_16, var_8_17, var_8_18, iter_8_1)
	...
	var_1.make(var_8_19, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			if arg_8_0.descList[arg_15_1] ~= false then
				local var_15_1 = var_0_0.GetChallengeIDByLevel(arg_8_0.curLevel)
				...
				var_7(var_15_5, var_2_10009(var_15_3, var_15_4))
				...
				var_10(var_15_9, var_15_10, var_15_11, var_2_10014)
			end
		end
...
function var_0_1.updateDebug(arg_17_0)
	...
	local var_17_2 = var_0_0.GetChallengeIDByLevel(arg_17_0.curLevel)
	local var_17_3 = var_0_0.GetStageIDByLevel(arg_17_0.curLevel)
	...
	local var_17_6 = var_1_10007(var_17_0)

	tostring = var_8

	local var_17_7 = var_8(var_17_1)

	tostring = var_9

	local var_17_8 = var_9(var_17_2)

	tostring = var_10

	local var_17_9 = var_17_4(var_17_5, var_17_6, var_17_7, var_17_8, var_10(var_17_3))

	ipairs = var_17_5

	for iter_17_0, iter_17_1 in var_17_5(arg_17_0.levelList) do
...
function var_0_1.updateToggleList(arg_18_0)
	...
	local var_18_1 = arg_18_0.getHigestUnlockLevel(var_18_0)

	ipairs = var_18_0

	for iter_18_0, iter_18_1 in var_18_0(arg_18_0.levelToggleLockList) do
		local var_18_2 = var_18_1 < iter_18_0

		setActive = var_1_10008

		var_1_10008(iter_18_1, var_18_2)

		var_1_10008 = arg_18_0.levelToggleList[iter_18_0]
		setActive = var_9

		var_9(var_1_10008, not var_18_2)
	end
...
function var_0_1.updateLeftTime(arg_19_0)
	...
	if arg_19_0.nextMonthTS - var_19_2 > 0 then
		if arg_19_0.leftTimer then
			var_1_10005 = arg_19_0.leftTimer
		...
		local function var_19_3()
			...
			var_2_10004(var_20_7, var_6.format("%02d:%02d:%02d", var_20_4, var_20_5, var_20_6))
		...
		Timer = var_1_10005
		arg_19_0.leftTimer = var_1_10005.New(var_19_3, 1, -1)

		local var_19_4 = arg_19_0.leftTimer

		var_5.Start(var_19_4)
		var_19_3()
	end
...
function var_0_1.updateBossImg(arg_21_0)
	local var_21_0 = var_0_0.GetChallengeIDByLevel(arg_21_0.curLevel)

	pg = var_2

	local var_21_1 = var_2.expedition_constellation_challenge_template[var_21_0].painting
	...
	var_6(var_21_4, var_1_10008(var_21_3, var_21_1))
	...
	var_7(var_21_6, var_9(var_21_5, var_21_2), true)
	...
	var_9(var_21_9, var_11(var_21_8, var_21_7), true)

	local var_21_10 = "%d_level_%d_selected"

	ipairs = var_21_9

	for iter_21_0, iter_21_1 in var_21_9(arg_21_0.levelList) do
		string = var_1_10015
		var_1_10015 = var_1_10015.format(var_21_10, var_2.button_style, iter_21_1)

		local var_21_11 = "limitchallenge/btn/" .. var_1_10015
		local var_21_12 = arg_21_0.levelToggleList[iter_21_1]
		local var_21_13

		var_21_13, setImageSprite = var_17.Find(var_21_12, "Selected"), var_21_12
		LoadSprite = var_1_10020

		var_21_12(var_21_13, var_1_10020(var_21_11, var_1_10015), true)
	end
...
function var_0_1.updateDescPanel(arg_22_0)
	...
	local var_22_0 = var_0_0.GetChallengeIDByLevel(arg_22_0.curLevel)

	pg = var_2
	arg_22_0.descList = var_2.expedition_constellation_challenge_template[var_22_0].description
...
function var_0_1.updatePassTime(arg_23_0)
	...
	local var_23_3 = var_23_1.floor(var_23_2 / 60)

	math = var_4

	local var_23_4 = var_4.floor(var_23_2 % 60)
...
function var_0_1.updateAward(arg_24_0)
	...
	local var_24_1 = var_2.expedition_constellation_challenge_template[var_24_0].award_display[1]
	local var_24_2 = arg_24_0.proxy
	local var_24_3 = var_3.isAwardedByChallengeID(var_24_2, var_24_0)

	setActive = var_24_2

	var_24_2(arg_24_0.awardGotTF, var_24_3)
	...
	if var_24_1 and #var_24_1 > 0 then
		...
		var_24_2.count = var_24_4
		updateDrop = var_24_4

		var_24_4(arg_24_0.awardIconTF, var_24_2)
		...
		local function var_24_7()
			...
			var_25_1(var_25_0, var_2_10002.ON_DROP, var_24_2)
		...
		var_24_4(var_24_5, var_24_6, var_24_7, var_1_10009)
		...
		var_24_2(arg_24_0.awardIconTF, false)
	end
...
function var_0_1.trigeHigestUnlockLevel(arg_26_0)
	...
	local var_26_1 = arg_26_0.getHigestUnlockLevel(var_26_0)

	triggerToggle = var_26_0

	var_26_0(arg_26_0.levelToggleList[var_26_1], true)
