...
function var_0_1.CommonInit(arg_4_0)
	...
	local var_4_11 = var_2.Find(var_4_10, "vanguard/line/Image/Text1")

	i18n = var_4_10

	var_1(var_4_11, var_4_10("pre_combat_vanguard"))

	setText = var_1

	local var_4_12 = arg_4_0._gearScore
	local var_4_13 = var_2.Find(var_4_12, "main/line/Image/Text1")

	i18n = var_4_12

	var_1(var_4_13, var_4_12("pre_combat_main"))

	setText = var_1

	local var_4_14 = arg_4_0._gearScore
	local var_4_15 = var_2.Find(var_4_14, "submarine/line/Image/text1")

	i18n = var_4_14

	var_1(var_4_15, var_4_14("pre_combat_submarine"))

	setText = var_1

	local var_4_16 = arg_4_0._costContainer
	local var_4_17 = var_2.Find(var_4_16, "title")

	i18n = var_4_16

	var_1(var_4_17, var_4_16("pre_combat_consume"))

	setText = var_1

	local var_4_18 = arg_4_0._infomation
	local var_4_19 = var_2.Find(var_4_18, "target/title/GameObject")

	i18n = var_4_18

	var_1(var_4_19, var_4_18("pre_combat_targets"))

	setText = var_1

	local var_4_20 = arg_4_0._infomation
	local var_4_21 = var_2.Find(var_4_20, "atlasloot/atlasloot/title/GameObject")

	i18n = var_4_20

	var_1(var_4_21, var_4_20("pre_combat_atlasloot"))
	...
	var_1(var_4_23, var_4_22("pre_combat_start"))

	setText = var_1

	local var_4_24 = arg_4_0._startBtn
	local var_4_25 = var_2.Find(var_4_24, "text_en")

	i18n = var_4_24

	var_1(var_4_25, var_4_24("pre_combat_start_en"))

	setText = var_1

	local var_4_26 = arg_4_0.btnRegular
	local var_4_27 = var_2.Find(var_4_26, "fleet/CnFleet")

	Fleet = var_4_26

	var_1(var_4_27, var_4_26.DEFAULT_NAME[1])

	setText = var_1

	local var_4_28 = arg_4_0.btnSub
	local var_4_29 = var_2.Find(var_4_28, "fleet/CnFleet")

	Fleet = var_4_28

	var_1(var_4_29, var_4_28.DEFAULT_NAME[1])
...
function var_0_1.Register(arg_5_0)
	...
	var_1.AddHeroInfoModify(var_5_1, function(arg_7_0, arg_7_1)
		...
		if var_7_3 then
			...
			var_7_5, var_7_6 = arg_7_1:getEnergyPrint()
			GetSpriteFromAtlas = var_2_10008

			if not var_2_10008("energy", var_7_5) then
				warning = var_2_10009
			...
			var_2_10009(var_7_4, var_2_10008)
		end
		...
		if var_7_3 then
			...
			var_2_10008 = arg_5_0.contextData.system
			SYSTEM_DUEL = var_2_10009
			var_2_10008 = var_2_10008 ~= var_2_10009
		end

		var_7_5(var_7_7, var_2_10008)

		local var_7_8 = arg_7_1:getStar()
		...
		local var_7_9 = "shiptype"

		shipType2print = var_9

		if not var_7(var_7_9, var_9(arg_7_1:getShipType())) then
			warning = var_7_9

			var_7_9("找不到船形, shipConfigId: " .. arg_7_1.configId)
		end

		setImageSprite = var_7_9
		findTF = var_9

		var_7_9(var_9(var_7_0, "type"), var_7, true)

		setText = var_7_9
		findTF = var_9

		var_7_9(var_9(var_7_0, "frame/lv_contain/lv"), arg_7_1.level)

		local var_7_10 = var_7_0
		local var_7_11 = var_7_0.Find(var_7_10, "expbuff")
	...
	var_1.AddClick(var_5_5, function(arg_11_0, arg_11_1, arg_11_2)
		...
		var_11_3(var_11_2, var_2_10005.CHANGE_FLEET_SHIP, arg_11_0, arg_11_2, arg_11_1)
	...
	var_1.AddRemoveShip(var_5_7, function(arg_13_0, arg_13_1)
		...
		var_13_1(var_13_0, var_2_10004.REMOVE_SHIP, arg_13_0, arg_13_1)
	...
	var_1.AddCheckRemove(var_5_8, function(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
		...
		if not arg_14_3:canRemove(arg_14_2) then
			...
			var_14_0, var_14_1 = arg_14_3:getShipPos(arg_14_2)
			pg = var_7
			var_2_10008 = var_7.TipsMgr.GetInstance()

			local var_14_2 = var_7.ShowTips

			i18n = var_2_10009

			local var_14_3 = "ship_formationUI_removeError_onlyShip"
			local var_14_4 = arg_14_2:getConfigTable().name
			local var_14_5 = arg_14_3.name

			Fleet = var_2_10013

			var_14_2(var_2_10008, var_2_10009(var_14_3, var_14_4, var_14_5, var_2_10013.C_TEAM_NAME[var_14_1]))
			arg_14_0()
		else
			pg = var_14_0

			local var_14_6 = var_14_0.MsgboxMgr.GetInstance()
			local var_14_7 = var_5.ShowMsgBox
			local var_14_8 = {
				hideNo = false,
				zIndex = -100
			}
			...
			i18n = var_2_10008
			var_14_8.content = var_2_10008("battle_preCombatLayer_quest_leaveFleet", arg_14_2:getConfigTable().name)
			var_14_8.onYes = arg_14_1
			var_14_8.onNo = arg_14_0

			var_14_7(var_14_6, var_14_8)
		end
	...
	var_1.AddGridTipClick(var_5_12, function(arg_18_0, arg_18_1)
		...
		var_18_1(var_18_0, var_2_10004.CHANGE_FLEET_SHIP, nil, arg_5_0._currentFleetVO, arg_18_0)
...
function var_0_1.SetStageID(arg_22_0, arg_22_1)
	...
	for iter_22_1, iter_22_2 in var_22_2(var_22_1) do
		...
		var_12(var_22_7, var_1_10014, var_22_8, var_1_10016)
	end
...
function var_0_1.UpdateFleetView(arg_30_0, arg_30_1)
	...
	var_30_2(var_30_1, var_1_10004.Vanguard)
	...
	var_30_6(var_30_5, var_4.Submarine)
	...
	local var_30_12 = var_4.Find(var_30_11, "on")

	FleetType = var_30_11

	var_30_9(var_30_12, var_30_10 == var_30_11.Normal)

	setActive = var_30_9

	local var_30_13 = arg_30_0.btnRegular
	local var_30_14 = var_4.Find(var_30_13, "off")

	FleetType = var_30_13

	var_30_9(var_30_14, var_30_10 ~= var_30_13.Normal)

	setActive = var_30_9

	local var_30_15 = arg_30_0.btnSub
	local var_30_16 = var_4.Find(var_30_15, "on")

	FleetType = var_30_15

	var_30_9(var_30_16, var_30_10 == var_30_15.Submarine)

	setActive = var_30_9

	local var_30_17 = arg_30_0.btnSub
	local var_30_18 = var_4.Find(var_30_17, "off")

	FleetType = var_30_17

	var_30_9(var_30_18, var_30_10 ~= var_30_17.Submarine)
...
function var_0_1.didEnter(arg_35_0)
	...
	var_1_10001(var_35_0, var_1_10003(var_1_10004)).interactable = true
	onButton = var_2
	...
	local function var_35_3()
		...
		var_36_1(var_36_0, var_2_10002.ON_UPDATE_CUSTOM_FLEET)
		...
		var_36_1(var_36_2, var_2(var_2_10003)).interactable = false
		...
		var_36_4(var_36_5, var_2_10003.Action(function()
	...
	var_2(var_35_1, var_35_2, var_35_3, var_1_10006)
	...
	local function var_35_6()
		...
		var_38_1(var_38_0, var_2_10002.ON_UPDATE_CUSTOM_FLEET)
	...
	var_2(var_35_4, var_35_5, var_35_6, var_1_10006)
	...
	local function var_35_9()
		...
		var_39_1(var_39_0, var_2_10002.ON_START)
	...
	var_2(var_35_7, var_35_8, var_35_9, var_1_10006)
	...
	local function var_35_12()
		...
		var_40_1(var_40_0, var_2_10002.ON_CHANGE_FLEET, arg_35_0._legalFleetIdList[arg_35_0._curFleetIndex + 1])
	...
	var_2(var_35_10, var_35_11, var_35_12, var_1_10006)
	...
	local function var_35_15()
		...
		var_41_1(var_41_0, var_2_10002.ON_CHANGE_FLEET, arg_35_0._legalFleetIdList[arg_35_0._curFleetIndex - 1])
	...
	var_2(var_35_13, var_35_14, var_35_15, var_1_10006)
	...
	local function var_35_18(arg_42_0)
		...
		var_42_1(var_42_0, var_2_10003.ON_AUTO, {
			isOn = not arg_42_0,
	...
	var_2(var_35_16, var_35_17, var_35_18, var_1_10006, var_1_10007)
	...
	local function var_35_21(arg_43_0)
		...
		var_43_1(var_43_0, var_2_10003.ON_SUB_AUTO, {
			isOn = not arg_43_0,
	...
	var_2(var_35_19, var_35_20, var_35_21, var_1_10006, var_1_10007)
	...
	local function var_35_24()
		...
		local var_44_2 = var_2_10002.ON_CHANGE_FLEET

		FleetProxy = var_2_10003

		var_44_1(var_44_0, var_44_2, var_2_10003.CHALLENGE_FLEET_ID)
	...
	var_2(var_35_22, var_35_23, var_35_24, var_1_10006)
	...
	local function var_35_27()
		...
		local var_45_2 = var_2_10002.ON_CHANGE_FLEET

		FleetProxy = var_2_10003

		var_45_1(var_45_0, var_45_2, var_2_10003.CHALLENGE_SUB_FLEET_ID)
	...
	var_2(var_35_25, var_35_26, var_35_27, var_1_10006)
...
function var_0_1.UpdateSubToggle(arg_47_0)
	if arg_47_0.autoFlag and arg_47_0._subUseable == true then
		...
		var_1(var_47_0, var_3.Battle.BattleState.IsAutoSubActive())
	else
		setActive = var_1
...
function var_0_1.displayFleetInfo(arg_48_0)
	...
	var_48_0(var_48_2, var_48_1 == var_1_10004.Normal)
	...
	var_48_0(var_48_3, var_48_1 == var_4.Normal)

	math = var_48_0

	local var_48_4 = var_48_0.floor
	local var_48_5 = arg_48_0._currentFleetVO
	local var_48_6 = var_3.GetGearScoreSum

	TeamType = var_1_10005

	local var_48_7 = var_48_4(var_48_6(var_48_5, var_1_10005.Vanguard))

	math = var_3

	local var_48_8 = var_3.floor
	local var_48_9 = arg_48_0._currentFleetVO
	local var_48_10 = var_4.GetGearScoreSum

	TeamType = var_1_10006

	local var_48_11 = var_48_8(var_48_10(var_48_9, var_1_10006.Main))
	...
	var_4(var_48_12, var_48_1 == var_6.Submarine)

	math = var_4

	local var_48_13 = var_4.floor
	local var_48_14 = arg_48_0._currentFleetVO
	local var_48_15 = var_5.GetGearScoreSum

	TeamType = var_1_10007

	local var_48_16 = var_48_13(var_48_15(var_48_14, var_1_10007.Submarine))
	...
	var_48_14(var_48_18, var_48_17 ~= var_1_10008)
	...
	var_6(var_48_19, var_8.GetName(var_48_20))
