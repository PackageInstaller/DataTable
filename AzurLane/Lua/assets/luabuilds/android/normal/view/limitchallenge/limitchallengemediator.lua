...
function var_0_1.handleNotification(arg_3_0, arg_3_1)
	...
	LimitChallengeConst = var_3_1

	if var_3_0 == var_3_1.REQ_CHALLENGE_INFO_DONE then
		...
		if var_3_0 == var_4.GET_CHALLENGE_AWARD_DONE then
			local var_3_4 = arg_3_0.viewComponent

			var_3_5 = var_3_5.emit
			BaseUI = var_1_10006

			var_3_5(var_3_4, var_1_10006.ON_ACHIEVE, var_3_2.awards)
			...
			if var_3_0 == var_3_5.UPDATE_PASS_TIME then
...
function var_0_1.bindEvent(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.OPEN_PRE_COMBAT_LAYER, function(arg_5_0, arg_5_1)
		...
		var_5_2.mediator = var_2_10005
		LimitChallengePreCombatLayer = var_2_10005
		var_5_2.viewComponent = var_2_10005

		local var_5_3 = {
			stageId = var_5_0
		}

		SYSTEM_LIMIT_CHALLENGE = var_2_10006
...
function var_0_1.tryGetAward(arg_6_0)
	...
	if #var_1.getMissAwardChallengeIDLIst(var_6_0) > 0 then
		...
		var_6_2(var_6_1, var_1_10004.GET_CHALLENGE_AWARD, {
