...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.nameTxt = var_1_2(var_1_1, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.progressTxt = var_1_8(var_1_7, var_5(var_1_10006))
	...
	local var_1_12 = var_4.Find(var_1_11, "awards")
	local var_1_13 = arg_1_0._tf

	arg_1_0.uilist = var_1_10(var_1_12, var_5.Find(var_1_13, "awards/award"))
	...
	GetSpriteFromAtlas = var_1_16
	var_1_17[1] = var_1_16("ui/feasttask_atlas", "t_frame_1")
	...
	typeof = var_5
	Image = var_6
	arg_1_0.barImg = var_1_22(var_1_21, var_5(var_6))
	...
	typeof = var_5
	Image = var_6
	arg_1_0.bgImg = var_1_24(var_1_23, var_5(var_6))
...
function var_0_0.Flush(arg_2_0, arg_2_1)
	...
	var_8.make(var_2_7, function(arg_3_0, arg_3_1, arg_3_2)
		...
		if arg_3_0 == var_2_10003.EventUpdate then
			...
			var_5(var_3_2, var_3_3, var_3_4, var_2_10009)
		end
	...
	local var_2_9 = var_2_1:isFinish()
	local var_2_10 = var_2_1
	local var_2_11 = var_2_1.isReceive(var_2_10)

	setActive = var_2_10

	var_2_10(arg_2_0.getBtn, var_2_9 and not var_2_11)

	setActive = var_2_10

	var_2_10(arg_2_0.gotBtn, var_2_9 and var_2_11)

	setActive = var_2_10

	var_2_10(arg_2_0.goBtn, not var_2_9)
	...
	local function var_2_14()
		...
		var_5_1(var_5_0, var_2_10002.ON_SUBMIT, arg_2_1)
	...
	var_2_10(var_2_12, var_2_13, var_2_14, var_1_10014)
	...
	local function var_2_17()
		...
		var_6_1(var_6_0, var_2_10002.ON_GO, var_2_1)
	...
	var_2_10(var_2_15, var_2_16, var_2_17, var_1_10014)
