...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_2.Find(var_2_3, "left/scrollrect/conent")
	local var_2_5 = arg_2_0._tf

	arg_2_0.uilist = var_2_2(var_2_4, var_3.Find(var_2_5, "left/scrollrect/conent/tpl"))
	...
	typeof = var_3
	Text = var_2_5
	arg_2_0.resTicket = var_2_10(var_2_9, var_3(var_2_5))
	...
	typeof = var_3
	Text = var_2_5
	arg_2_0.resGift = var_2_13(var_2_12, var_3(var_2_5))
	...
	typeof = var_3
	Image = var_2_5
	arg_2_0.giftImg = var_2_19(var_2_18, var_3(var_2_5))
	...
	typeof = var_3
	Text = var_2_5
	arg_2_0.ticketTxt = var_2_23(var_2_22, var_3(var_2_5))
	setText = var_1

	local var_2_24 = arg_2_0.giftTr
	local var_2_25 = var_2.Find(var_2_24, "make/Text")

	i18n = var_2_24

	var_1(var_2_25, var_2_24("feast_label_give_gift"))

	setText = var_1

	local var_2_26 = arg_2_0.ticketTr
	local var_2_27 = var_2.Find(var_2_26, "finish/frame/label")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("feast_label_give_invitation_finish"))

	setText = var_1

	local var_2_28 = arg_2_0.giftTr
	local var_2_29 = var_2.Find(var_2_28, "finish/frame/label")

	i18n = var_2_28

	var_1(var_2_29, var_2_28("feast_label_give_gift_finish"))
	...
	typeof = var_3
	Image = var_4
	arg_2_0.painting = var_2_32(var_2_31, var_3(var_4))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.ON_SKIP_GIVE_GIFT, function(arg_4_0, arg_4_1)
	...
	var_3_3(var_3_2, var_3.ON_MAKE_TICKET, function(arg_5_0)
	...
	var_3_5(var_3_4, var_3.ON_GOT_TICKET, function(arg_6_0)
	...
	var_3_7(var_3_6, var_3.ON_GOT_GIFT, function(arg_7_0)
	...
	var_3_7(var_3_8, var_3_9, var_3_10, var_1_10005)
	...
	var_3_7(var_3_11, var_3_12, var_3_13, var_1_10005)
...
function var_0_1.OnFlush(arg_10_0)
	if arg_10_0.feastShip then
		var_1_10002 = arg_10_0

		arg_10_0.UpdateMain(var_1_10002, arg_10_0.feastShip)
	end
...
function var_0_1.UpdateRes(arg_12_0)
	...
	local var_12_3 = var_1_10003(var_1_10004)
	local var_12_4 = var_3.getActivityByType

	ActivityConst = var_1_10005

	local var_12_5 = var_12_4(var_12_3, var_1_10005.ACTIVITY_TYPE_VIRTUAL_BAG)
	...
	var_12_6(var_12_7, var_12_8, var_12_9, var_1_10008)
	...
	var_12_6(var_12_10, var_12_11, var_12_12, var_1_10008)
...
function var_0_1.UpdateFeastShips(arg_15_0, arg_15_1)
	...
	var_2.make(var_15_0, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			LoadSpriteAsync = var_16_0

			var_16_0("FeastIcon/" .. var_16_1, function(arg_17_0)
				...
				local var_17_3 = var_17_2(var_17_1, var_3(var_3_10004))
			...
			if var_3:GotGift() then
				var_16_3 = var_3:GotTicket()
			end
			...
			var_16_0(var_16_4, var_16_5, var_16_6, var_2_10009)

			table = var_16_0

			var_16_0.insert(arg_15_0.toggles, arg_16_2)
		end
...
i18n = var_2
var_0_2[0] = var_2("feast_label_make_invitation")
i18n = var_2
...
function var_0_1.UpdateMain(arg_19_0, arg_19_1)
	...
	local var_19_1 = arg_19_1.GetPrefab(var_19_0)

	LoadSpriteAsync = var_19_0

	var_19_0("FeastPainting/" .. var_19_1, function(arg_20_0)
	...
	var_19_0("FeastCharGift/" .. var_19_1, function(arg_21_0)
	...
	local var_19_3 = arg_19_0.ticketTr
		...
		if var_0.HasTicket(var_22_0) then
			...
			if not var_0.GotTicket(var_22_2) then
				if arg_19_0.ticketCnt <= 0 then
					...
					var_22_4(var_22_3, var_2_10002("feast_no_invitation"))
	...
	var_19_0(var_19_2, var_19_3, var_19_4, var_1_10007)

	onButton = var_19_0

	local var_19_5 = arg_19_0
	local var_19_6 = arg_19_0.giftTr
	...
	local function var_19_7()
		...
		if not var_0.GotTicket(var_23_0) then
			...
			var_23_2(var_23_1, var_2_10002("feast_cant_give_gift_tip"))
		...
		if arg_19_0.giftCnt <= 0 then
			...
			var_23_4(var_23_3, var_2_10002("feast_no_gift"))
	...
	var_19_0(var_19_5, var_19_6, var_19_7, var_1_10007)
