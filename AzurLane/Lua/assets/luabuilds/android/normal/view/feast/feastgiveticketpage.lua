...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".FeastGiveGiftPage"))
...
function var_0_1.BindEvents(arg_1_0)
	...
	arg_1_0.eventId = var_1_1(var_1_0, var_1_10003.ON_GOT_TICKET, function(arg_2_0, arg_2_1)
	...
	if arg_3_0.feastShip then
		...
		var_2({
			...
			function(arg_5_0)
				...
				var_5_1(var_5_0, var_2_10003.ON_ACHIEVE, arg_3_1, arg_5_0)
			...
			function(arg_6_0)
				...
				local var_6_2 = var_6_0.NewStoryMgr.GetInstance()
			...
			FeastMediator = var_2_10002

			var_7_1(var_7_0, var_2_10002.ON_SHIP_ENTER_FEAST, arg_3_0.feastShip.id)
			...
			var_7_3(var_7_2, var_2.ON_BACK_FEAST)
...
function var_0_1.UpdateGiftState(arg_11_0, arg_11_1, arg_11_2)
	...
	var_3({
		function(arg_12_0)
			...
			var_12_1(var_12_0, var_3.GetDialogueForTicket(var_12_2), 3, arg_12_0)
...
function var_0_1.Send(arg_16_0)
	...
	var_16_2(var_16_1, var_1_10004.GIVE_TICKET, var_16_0.tid)
