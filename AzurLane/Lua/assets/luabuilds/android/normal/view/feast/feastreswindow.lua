...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.outPut = var_2_11(var_2_10, var_3(var_1_10004))
	...
	var_1(var_2_14, var_2_13("feast_res_window_go_label"))

	setText = var_1

	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_2.Find(var_2_15, "frame/title")

	i18n = var_2_15

	var_1(var_2_16, var_2_15("feast_res_window_title"))
...
function var_0_1.UpdateView(arg_6_0)
	...
	local function var_6_6()
		...
		var_7_1(var_7_0, var_2_10002.WORKBENCH_ITEM_GO, arg_6_0.id)
	...
	var_6_3(var_6_4, var_6_5, var_6_6, var_1_10006)
