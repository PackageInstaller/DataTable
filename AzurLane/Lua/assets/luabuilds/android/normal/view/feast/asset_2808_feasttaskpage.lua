...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.progressTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.lastAwardLvTxt = var_2_12(var_2_11, var_3(var_1_10004))
	setText = var_1

	local var_2_13 = arg_2_0.lastAwardItem
	local var_2_14 = var_2.Find(var_2_13, "get")

	i18n = var_2_13

	var_1(var_2_14, var_2_13("feast_task_pt_get"))

	setText = var_1

	local var_2_15 = arg_2_0.lastAwardItem
	local var_2_16 = var_2.Find(var_2_15, "got")

	i18n = var_2_15

	var_1(var_2_16, var_2_15("feast_task_pt_got"))

	setText = var_1

	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_2.Find(var_2_17, "main/tip")

	i18n = var_2_17

	var_1(var_2_18, var_2_17("feast_click_to_close"))

	setText = var_1

	local var_2_19 = arg_2_0._tf
	local var_2_20 = var_2.Find(var_2_19, "main/level/value/label")

	i18n = var_2_19

	var_1(var_2_20, var_2_19("feast_task_pt_label"))
...
function var_0_1.AddListener(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.ON_TASK_UPDATE, function(arg_4_0)
	...
	var_3_3(var_3_2, var_3.ON_ACT_UPDATE, function(arg_5_0)
...
function var_0_1.OnInit(arg_6_0)
	...
	var_1(var_6_3, var_6_4, var_6_5, iter_6_3)
	...
	var_1(var_6_6, var_6_7, var_6_8, iter_6_3)
...
function var_0_1.GetAllForTask(arg_13_0)
	...
	if #var_13_0 <= 0 then
		...
		var_13_3(var_13_2, var_5("faest_nothing_to_get"))
	...
	var_13_5(var_13_4, var_5.ON_SUBMIT_ONE_KEY, var_13_0)
...
function var_0_1.GetAllForPt(arg_14_0)
	...
	if not var_1.CanGetAward(var_14_0) then
		...
		var_14_2(var_14_1, var_1_10003("faest_nothing_to_get"))
	...
	local var_14_7 = var_1_10004.EVENT_PT_OPERATION
	local var_14_8 = {
		cmd = 4
	}
	local var_14_9 = arg_14_0.ptActData

	var_14_8.activity_id = var_6.GetId(var_14_9)
...
function var_0_1.UpdateLastAward(arg_17_0)
	...
	i18n = var_6
	var_17_7.text = var_6("feast_task_pt_level", #var_17_4)
	setActive = var_17_7

	local var_17_8 = arg_17_0.lastAwardItem
	local var_17_9 = var_6.Find(var_17_8, "lock")

	ActivityPtData = var_17_8

	var_17_7(var_17_9, var_17_6 == var_17_8.STATE_LOCK)

	setActive = var_17_7

	local var_17_10 = arg_17_0.lastAwardItem
	local var_17_11 = var_6.Find(var_17_10, "get")

	ActivityPtData = var_17_10

	var_17_7(var_17_11, var_17_6 == var_17_10.STATE_CAN_GET)

	setActive = var_17_7

	local var_17_12 = arg_17_0.lastAwardItem
	local var_17_13 = var_6.Find(var_17_12, "got")

	ActivityPtData = var_17_12

	var_17_7(var_17_13, var_17_6 == var_17_12.STATE_GOT)
	...
	local function var_17_16()
		...
		if var_18_0 == var_2_10001.STATE_CAN_GET then
			...
			var_2_10002 = arg_17_0

			local var_18_3 = var_1.emit

			FeastMediator = var_2_10003

			local var_18_4 = var_2_10003.EVENT_PT_OPERATION
			local var_18_5 = {
				cmd = 1
			}
			local var_18_6 = arg_17_0.ptActData

			var_18_5.activity_id = var_5.GetId(var_18_6)
			var_18_5.arg1 = var_18_2

			var_18_3(var_2_10002, var_18_4, var_18_5)
		else
			...
			var_18_8(var_18_7, var_2_10002.ON_DROP, var_17_3)
		end
	...
	var_17_7(var_17_14, var_17_15, var_17_16, var_1_10009)
...
function var_0_1.GenTaskData(arg_21_0)
	...
	var_21_0.sort(arg_21_0.taskList, function(arg_22_0, arg_22_1)
