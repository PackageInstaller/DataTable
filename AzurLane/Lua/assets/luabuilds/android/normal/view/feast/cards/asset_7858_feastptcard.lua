...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.indexTxt = var_1_2(var_1_1, var_5(var_1_10006))
	...
	var_3(var_1_8, var_1_7("feast_task_pt_get"))
	...
	var_3(var_1_10, var_1_9("feast_task_pt_got"))
...
function var_0_0.Flush(arg_2_0, arg_2_1, arg_2_2)
	...
	local function var_2_5()
		...
		var_3_1(var_3_0, var_2_10002.ON_DROP, var_2_2)
	...
	var_2_1(var_2_3, var_2_4, var_2_5, var_1_10008)

	local var_2_6 = arg_2_1
	local var_2_7 = arg_2_1.GetDroptItemState(var_2_6, arg_2_2)

	setActive = var_2_6

	local var_2_8 = arg_2_0.lockBtn

	ActivityPtData = var_2_5

	var_2_6(var_2_8, var_2_7 == var_2_5.STATE_LOCK)
	...
	var_2_6(var_2_9, var_2_7 == var_7.STATE_CAN_GET)

	setActive = var_2_6

	local var_2_10 = arg_2_0.gotBtn

	ActivityPtData = var_7

	var_2_6(var_2_10, var_2_7 == var_7.STATE_GOT)

	onButton = var_2_6

	local var_2_11 = arg_2_0.binder
	local var_2_12 = arg_2_0._tf

	local function var_2_13()
		local var_4_0 = var_2_7
		...
		if var_4_0 == var_2_10001.STATE_CAN_GET then
			...
			local var_4_5 = var_2_10003.EVENT_PT_OPERATION
			local var_4_6 = {
				cmd = 1
			}
			local var_4_7 = arg_2_1

			var_4_6.activity_id = var_5.GetId(var_4_7)
	...
	var_2_6(var_2_11, var_2_12, var_2_13, var_1_10009)
