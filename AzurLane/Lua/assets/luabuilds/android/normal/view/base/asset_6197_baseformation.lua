...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	UnityEngine = var_6
	arg_1_0._widthRate = var_1_0 / var_6.Screen.width
	rtf = var_5
...
function var_0_0.ClearHeroContainer(arg_22_0)
	...
	if arg_22_0._characterList then
		...
		local var_22_3 = var_3.getTeamByName

		TeamType = var_1_10005

		local var_22_4 = var_22_3(var_22_2, var_1_10005.Main)
		local var_22_5 = arg_22_0._characterList

		TeamType = var_5

		var_22_1(var_22_0, var_22_4, var_22_5[var_5.Main])
		...
		local var_22_8 = var_3.getTeamByName

		TeamType = var_5

		local var_22_9 = var_22_8(var_22_7, var_5.Vanguard)
		local var_22_10 = arg_22_0._characterList

		TeamType = var_5

		var_22_1(var_22_6, var_22_9, var_22_10[var_5.Vanguard])
		...
		local var_22_13 = var_3.getTeamByName

		TeamType = var_5

		local var_22_14 = var_22_13(var_22_12, var_5.Submarine)
		local var_22_15 = arg_22_0._characterList

		TeamType = var_5

		var_22_1(var_22_11, var_22_14, var_22_15[var_5.Submarine])
	end
...
function var_0_0.LoadAllCharacter(arg_23_0)
	...
	arg_23_0.ClearHeroContainer(var_23_0)

	local var_23_1 = {}

	TeamType = var_23_0
	var_23_1[var_23_0.Vanguard] = {}
	TeamType = var_2
	var_23_1[var_2.Main] = {}
	TeamType = var_2
	var_23_1[var_2.Submarine] = {}
	arg_23_0._characterList = var_23_1

	local function var_23_2(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
		...
		local var_24_1 = var_2_10005(var_2_10006(arg_23_0._heroInfoTpl))
		...
		var_24_3(var_24_2, var_8(0.8, 0.8, 1))
			...
			if not (var_29_9 < var_8.Screen.width * 0.15) then
				...
				if not (var_8.Screen.width * 0.87 < var_29_10) then
					...
					if not (var_29_11 < var_8.Screen.height * 0.18) then
						...
						SFX_UI_HOME_PUT = var_3_10009

						var_29_14(var_29_13, var_3_10009)
	...
	local var_23_5 = arg_23_0._currentFleetVO
	local var_23_6 = var_4.getFleetType(var_23_5)

	FleetType = var_23_5

	local var_23_7

	if var_23_6 == var_23_5.Normal then
		var_23_7 = var_23_4

		local var_23_8 = arg_23_0._currentFleetVO
		local var_23_9 = var_6.getTeamByName

		TeamType = var_1_10008

		local var_23_10 = var_23_9(var_23_8, var_1_10008.Vanguard)

		TeamType = var_23_8

		var_23_7(var_23_10, var_23_8.Vanguard)

		var_23_7 = var_23_4

		local var_23_11 = arg_23_0._currentFleetVO
		local var_23_12 = var_6.getTeamByName

		TeamType = var_1_10008

		local var_23_13 = var_23_12(var_23_11, var_1_10008.Main)

		TeamType = var_23_11

		var_23_7(var_23_13, var_23_11.Main)
	else
		FleetType = var_23_7

		if var_23_6 == var_23_7.Submarine then
			var_23_7 = var_23_4

			local var_23_14 = arg_23_0._currentFleetVO
			local var_23_15 = var_6.getTeamByName

			TeamType = var_1_10008

			local var_23_16 = var_23_15(var_23_14, var_1_10008.Submarine)

			TeamType = var_23_14

			var_23_7(var_23_16, var_23_14.Submarine)
		end
	end

	pg = var_23_7

	local var_23_17 = var_23_7.UIMgr.GetInstance()

	var_5.LoadingOn(var_23_17)

	parallelAsync = var_5

	var_5(var_23_3, function(arg_35_0)
		pg = var_2_10001
...
function var_0_0.GetShipPos(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_2 = arg_36_1.getTeamByName(var_36_1, var_36_0)

	table = var_36_1

	local var_36_3

	if not var_36_1.indexof(var_36_2, arg_36_2.id) then
		var_36_3 = -1
	end

	return var_36_3, var_36_0
end
...
function var_0_0.SetCharacterPos(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	var_1_10004(var_39_0, var_39_1 .. var_1_10007(arg_39_1))
	...
	local var_39_8 = var_39_7(var_10(var_39_4), 0, 0.5)
...
function var_0_0.ResetGrid(arg_40_0, arg_40_1, arg_40_2)
	...
	var_40_0(var_40_1, arg_40_1)

	local var_40_2 = arg_40_0._gridTFs[arg_40_1]

	ipairs = var_5

	for iter_40_0, iter_40_1 in var_5(var_40_2) do
		SetActive = var_1_10010
		var_1_10012 = iter_40_1

		var_1_10010(iter_40_1.Find(var_1_10012, "shadow"), false)

		SetActive = var_1_10010
		var_1_10012 = iter_40_1

		var_1_10010(iter_40_1.Find(var_1_10012, "tip"), false)
	end
	...
	if arg_40_1 == var_5.Main then
		...
		if #var_40_4(var_40_3, var_7.Vanguard) == 0 then
			return
		end
	end
	...
	if #var_40_1 < 3 then
		...
		var_40_7(var_40_8, var_40_9, var_40_10, var_1_10012)
		...
		local var_40_12 = var_40_11(var_9(var_7), 0, 1, 1)
		local var_40_13 = var_8.setOnUpdate

		System = var_10

		local var_40_14 = var_40_13(var_40_12, var_10.Action_float(function(arg_42_0)
		...
		var_40_15(var_40_14, var_10.easeOutBack)
	end
...
function var_0_0.SwitchToShiftMode(arg_43_0, arg_43_1, arg_43_2)
	...
	var_1_10003(var_43_0, var_43_1 .. var_1_10006(arg_43_2))
	...
	for iter_43_0 = 1, 3 do
		...
		var_1_10008.each(var_43_2, function(arg_44_0)
			if arg_43_0._gridTFs[arg_44_0] and arg_43_0._gridTFs[arg_44_0][iter_43_0] then
				...
				var_1(var_2.Find(var_44_0, "tip"), false)
			end
		...
		local var_43_3 = arg_43_0._gridTFs[arg_43_2][iter_43_0]

		var_1_10008(var_9.Find(var_43_3, "shadow"), false)
	end

	local var_43_4 = arg_43_0._characterList[arg_43_2]

	ipairs = var_4

	for iter_43_1, iter_43_2 in var_4(var_43_4) do
		local var_43_5 = iter_43_2.heroInfoTF
		local var_43_6 = iter_43_2.spineRole
		local var_43_7 = var_10.GetRootModel(var_43_6)

		if var_43_5 ~= arg_43_1 then
			LeanTween = var_43_6

			local var_43_8 = var_43_6.moveY

			rtf = var_1_10013

			var_43_8(var_1_10013(var_43_7), var_43_7.transform.localPosition.y + 20, 0.5)

			var_1_10013 = var_10

			local var_43_9, var_43_10

			var_43_9, var_1_10013, var_43_10 = var_10.GetInterface(var_1_10013)
			arg_43_0._eventTriggers[var_43_10] = true

			var_43_10:AddPointEnterFunc(function()
				ipairs = var_2_10000

				for iter_45_0, iter_45_1 in var_2_10000(var_43_4) do
					if iter_45_1.heroInfoTF == var_43_5 then
						seriesAsync = var_5
			...
			var_10.DisableInterface(var_1_10013)
		end

		var_1_10013 = var_10

		var_10.SetAction(var_1_10013, "normal")
	end
...
function var_0_0.SwitchToDisplayMode(arg_48_0)
	...
	var_48_1(var_48_2[var_1_10004.Vanguard])
	...
	var_48_5(var_48_6[var_4.Submarine])
...
function var_0_0.SwitchToPreviewMode(arg_50_0)
	...
	var_50_1(var_50_0, var_1_10003.Vanguard, true)
	...
	var_50_3(var_50_2, var_3.Main, true)
	...
	var_50_5(var_50_4, var_3.Submarine, true)
...
function var_0_0.TurnOffPreviewMode(arg_51_0)
	...
	var_51_1(var_51_0, var_1_10003.Vanguard)
	...
	var_51_5(var_51_4, var_3.Submarine)
...
function var_0_0.Shift(arg_54_0, arg_54_1, arg_54_2, arg_54_3)
	...
	var_1_10004(var_54_0, var_54_1 .. var_1_10007(arg_54_3))
...
function var_0_0.UpdateGridVisibility(arg_56_0)
	...
	local var_56_2 = var_56_0.each
	local var_56_3 = arg_56_0._gridTFs

	TeamType = var_1_10004

	var_56_2(var_56_3[var_1_10004.Main], function(arg_57_0)
		...
		var_2_10001(var_57_0, var_57_1 == var_2_10004.Normal)
	...
	var_56_4(var_56_5[var_4.Vanguard], function(arg_58_0)
		setActive = var_2_10001
		...
		var_2_10001(var_58_0, var_58_1 == var_2_10004.Normal)
	...
	var_56_6(var_56_7[var_4.Submarine], function(arg_59_0)
		setActive = var_2_10001
		...
		var_2_10001(var_59_0, var_59_1 == var_2_10004.Submarine)
...
function var_0_0.Destroy(arg_61_0)
	...
	local var_61_3 = var_3.getTeamByName

	TeamType = var_1_10005

	local var_61_4 = var_61_3(var_61_2, var_1_10005.Main)
	local var_61_5 = arg_61_0._characterList

	TeamType = var_5

	var_61_1(var_61_0, var_61_4, var_61_5[var_5.Main])

	local var_61_6 = arg_61_0
	local var_61_7 = arg_61_0.RecycleCharacterList
	local var_61_8 = arg_61_0._currentFleetVO
	local var_61_9 = var_3.getTeamByName

	TeamType = var_5

	local var_61_10 = var_61_9(var_61_8, var_5.Vanguard)
	local var_61_11 = arg_61_0._characterList

	TeamType = var_5

	var_61_7(var_61_6, var_61_10, var_61_11[var_5.Vanguard])

	local var_61_12 = arg_61_0
	local var_61_13 = arg_61_0.RecycleCharacterList
	local var_61_14 = arg_61_0._currentFleetVO
	local var_61_15 = var_3.getTeamByName

	TeamType = var_5

	local var_61_16 = var_61_15(var_61_14, var_5.Submarine)
	local var_61_17 = arg_61_0._characterList

	TeamType = var_5

	var_61_13(var_61_12, var_61_16, var_61_17[var_5.Submarine])
