	...
	var_4_0({
		function(arg_5_0)
			if arg_4_1 then
				...
				var_5_1(var_5_0, var_3.getUIName(var_5_2), true, arg_5_0)
			end
		...
		if arg_4_0._state == var_0_1.STATES.DESTROY and not arg_4_0.noReturnPrefab then
			...
			var_6_2(var_6_1, var_3.getUIName(var_6_3), arg_6_0)
		else
...
function var_0_1.PlayBGM(arg_22_0)
	...
	if arg_22_0.getBGM(var_22_0) then
		pg = var_22_0

		local var_22_1 = var_22_0.BgmMgr.GetInstance()

		var_2.Push(var_22_1, arg_22_0.__cname, var_1)
	end
...
function var_0_1.ShowOrHideResUI(arg_30_0, arg_30_1)
	if not arg_30_0:ResUISettings() then
		return
	end

	local var_30_1

	if var_30_1 == true then
		local var_30_0 = {
			anim = true
		}

		PlayerResUI = var_1_10004
		var_30_0.showType = var_1_10004.TYPE_ALL
		var_30_1 = var_30_0
	end

	local var_30_2 = arg_30_0
	local var_30_3 = arg_30_0.getGroupName(var_30_2)

	if arg_30_1 then
		pg = var_30_2

		local var_30_4 = var_30_2.playerResUI

		var_30_2 = var_30_2.SetSettings

		local var_30_5 = var_30_3

		setmetatable = var_1_10007

		var_30_2(var_30_4, var_30_5, var_1_10007({
			groupName = var_30_3
		}, {
			__index = var_30_1
		}))
		...
		local var_30_6 = var_30_2.playerResUI
