...
local var_0_2 = var_0_0("view.util.FuncBuffer")

import = var_2

local var_0_3 = var_2("view.util.AutoLoader")
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	if arg_1_1 then
		...
		BaseEventLogic = var_1_10005

		local var_1_2

		if not var_3(var_1_1, var_1_10005) or not arg_1_1.event then
			var_1_2 = nil
		end
