...
function var_0_1.setLayerMgrRegister(arg_13_0, arg_13_1)
	...
	local var_13_1 = arg_13_0.getGroupName(var_13_0)

	if arg_13_1 then
		pg = var_13_0

		local var_13_2 = var_13_0.LayerWeightMgr.GetInstance()

		var_13_0.RegisterGroupWeight(var_13_2, var_13_1)
	else
		pg = var_13_0

		local var_13_3 = var_13_0.LayerWeightMgr.GetInstance()

		var_3.RemoveGroupWeight(var_13_3, var_13_1)
	end
...
function var_0_1.loadUISync(arg_15_0, arg_15_1)
	...
	local var_15_1 = var_3.UIMgr.GetInstance().UIMain
...
function var_0_1.load(arg_17_0)
	...
	arg_17_0.setLayerMgrRegister(var_17_0, true)

	local var_17_1

	Time = var_17_0

	local var_17_2 = var_17_0.realtimeSinceStartup
	local var_17_3 = arg_17_0
	local var_17_4 = arg_17_0.getUIName(var_17_3)

	seriesAsync = var_17_3
	...
	var_17_3({
		...
		function(arg_19_0)
			...
			var_1.LoadUIFromPool(var_19_0, var_17_4, function(arg_20_0)
				print = var_3_10001

				var_3_10001("Loaded " .. var_17_4)
		...
		local var_21_0 = "load "
		local var_21_1 = var_17_1.name
		local var_21_2 = " time cost: "

		Time = var_2_10004

		var_2_10000(var_21_0 .. var_21_1 .. var_21_2 .. var_2_10004.realtimeSinceStartup - var_17_2)

		local var_21_3 = arg_17_0

		var_0.SetUIParent(var_21_3, var_17_1)
		...
		if var_0.CheckTempCache(var_21_4) then
			...
			var_0.KeepUICache(var_21_5, var_17_4, true)
		end

		local var_21_6 = arg_17_0

		var_0.onUILoaded(var_21_6, var_17_1)
...
function var_0_1.PlayBGM(arg_25_0)
	...
	if arg_25_0.getBGM(var_25_0) then
		pg = var_25_0

		local var_25_1 = var_25_0.BgmMgr.GetInstance()

		var_2.Push(var_25_1, arg_25_0.__cname, var_1)
	end
...
function var_0_1.onUILoaded(arg_37_0, arg_37_1)
	...
	local var_37_2 = arg_37_0:getDefaultUI()
	local var_37_3 = {}

	LayerWeightConst = var_1_10006
	var_37_3.type = var_1_10006.UI_TYPE_SYSTEM

	var_37_1(var_37_0, var_37_2, var_37_3)

	pg = var_37_1

	local var_37_4 = var_37_1.SeriesGuideMgr.GetInstance()

	var_2.dispatch(var_37_4, {
		view = arg_37_0.__cname
	})

	pg = var_2

	local var_37_5 = var_2.NewStoryMgr.GetInstance()

	var_2.OnSceneEnter(var_37_5, {
		view = arg_37_0.__cname
	})
	...
	for iter_37_0, iter_37_1 in var_2(arg_37_0.optionsPath) do
		...
		local var_37_6 = arg_37_0.optionBtns
		local var_37_7 = arg_37_0._tf

		var_1_10007(var_37_6, var_9.Find(var_37_7, iter_37_1))
	end
...
function var_0_1.ShowOrHideResUI(arg_39_0, arg_39_1)
	if not arg_39_0:ResUISettings() then
		return
	end

	local var_39_1

	if var_39_1 == true then
		local var_39_0 = {
			anim = true
		}

		PlayerResUI = var_1_10004
		var_39_0.showType = var_1_10004.TYPE_ALL
		var_39_1 = var_39_0
	end

	local var_39_2 = arg_39_0
	local var_39_3 = arg_39_0.getGroupName(var_39_2)

	if arg_39_1 then
		pg = var_39_2

		local var_39_4 = var_39_2.playerResUI

		var_39_2 = var_39_2.SetSettings

		local var_39_5 = var_39_3

		setmetatable = var_1_10007

		var_39_2(var_39_4, var_39_5, var_1_10007({
			groupName = var_39_3
		}, {
			__index = var_39_1
		}))
		...
		local var_39_6 = var_39_2.playerResUI
...
function var_0_1.quickExit(arg_43_0)
	...
	for iter_43_0, iter_43_1 in var_1_10001(arg_43_0.optionBtns) do
		...
		var_1_10006(var_43_0, var_43_1, var_43_2, var_1_10010)
	end
...
function var_0_1.enter(arg_45_0)
	...
	arg_45_0:onUIAnimEnd(function()
		...
		pg = var_2_10004
		var_46_3[1] = var_2_10004.SeriesGuideMgr.CODES.MAINUI
...
function var_0_1.PlayUIAnimation(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	...
	typeof = var_1_10007
	UIEventTrigger = var_1_10008

	local var_51_5 = var_51_4(var_51_3, var_1_10007(var_1_10008)).didExit
...
function var_0_1.setSpriteTo(arg_57_0, arg_57_1, arg_57_2, arg_57_3)
	...
	local var_57_2 = var_57_1(var_57_0, var_1_10006(var_1_10007))
	...
	typeof = var_7
	Image = var_1_10008
	var_57_2.sprite = var_57_5(var_57_4, var_7(var_1_10008)).sprite
...
function var_0_1.setImageAmount(arg_58_0, arg_58_1, arg_58_2)
	...
	typeof = var_1_10005
	Image = var_1_10006
	var_58_1(var_58_0, var_1_10005(var_1_10006)).fillAmount = arg_58_2
