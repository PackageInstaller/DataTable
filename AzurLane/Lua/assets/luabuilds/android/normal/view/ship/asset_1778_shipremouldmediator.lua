...
function var_0_1.register(arg_1_0)
	...
	var_1_7(var_1_6, var_7.getData(var_1_8))
	arg_1_0:bind(var_0_1.REMOULD_SHIP, function(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
		if arg_1_0.contextData.materialShipIds and #arg_1_0.contextData.materialShipIds > 1 then
			...
			var_2_1(var_2_0, var_2_10006("remould_ship_count_more"))
		...
		local var_2_4 = var_2_10006.REMOULD_SHIP
		local var_2_5 = {
			shipId = arg_2_1,
			remouldId = arg_2_2
		}
	...
	arg_1_0:bind(var_0_1.ON_SELECTE_SHIP, function(arg_3_0, arg_3_1)
		...
		local var_3_4 = var_2_10005.FILTER_SHIPS_FLAGS_3

		underscore = var_2_10006

		local var_3_5 = var_3_3(var_3_2, var_3_4, var_2_10006.map(var_3_1, function(arg_4_0)
			return arg_4_0.id
		end))
		...
		local var_3_8 = var_6.GO_SCENE

		SCENE = var_7

		local var_3_9 = var_7.DOCKYARD
		local var_3_10 = {
			destroyCheck = true,
			selectedMin = 1,
			selectedMax = 1,
		...
		DockyardScene = var_9
		var_3_10.mode = var_9.MODE_REMOULD
		ShipStatus = var_9
		var_3_10.hideTagFlags = var_9.TAG_HIDE_DESTROY
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.REMOULD_SHIP_DONE then
		...
		if #var_9_2.awards ~= 0 then
			...
			var_9_8.mediator = var_1_10008
			NewShipLayer = var_1_10008
			var_9_8.viewComponent = var_1_10008
			var_9_8.data = {
				fromRemould = true,
				ship = var_9_2.ship
			}
		...
		if var_9_0 == var_9_6.UPDATED then
			...
			if var_9_0 == var_4.ITEM_UPDATED then
				...
				var_9_13(var_9_12, var_6.getData(var_9_14))
			end
		end
	end
