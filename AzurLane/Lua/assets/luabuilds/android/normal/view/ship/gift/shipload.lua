...
function var_0_0.LoadShip(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_2_0.spineCallback then
		...
		if var_7.Live2dIsDownload(var_2_1) then
			...
			if var_7(var_2_1) then
				...
				arg_2_0.live2dClass = var_8.New(var_2_4, function(arg_3_0)
	...
	if arg_2_0.l2dCallback then
		...
		if var_7(var_2_2) then
			...
			SpinePainting = var_8
			arg_2_0.spinePaintingClass = var_8.New(var_2_6, function(arg_4_0)
...
function var_0_0.LoadMeshShip(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = arg_5_0.GetShipPaintingName(var_5_0, arg_5_1)

	PoolMgr = var_5_0

	local var_5_2 = var_5_0:GetInstance()

	var_4.GetPainting(var_5_2, var_5_1, true, function(arg_6_0)
		...
		arg_5_0.meshImageList[var_5_1] = arg_6_0
...
function var_0_0.ReturnPainting(arg_7_0, arg_7_1)
	...
	local var_7_1 = arg_7_0.GetShipPaintingName(var_7_0, arg_7_1)

	PoolMgr = var_7_0

	local var_7_2 = var_7_0.GetInstance()

	var_3.ReturnPainting(var_7_2, arg_7_0.paintingName, arg_7_0.actorPainting)
...
function var_0_0.GetShipPaintingName(arg_10_0, arg_10_1)
	...
	local var_10_5 = var_10_4(var_6.format("spinepainting/%s", var_10_3))

	HXSet = var_6

	local var_10_6 = var_6.autoHxShiftPath

	string = var_7

	local var_10_7 = var_10_6(var_7.format("live2d/%s", var_10_3))
...
function var_0_0.IsHideMeshBg(arg_11_0, arg_11_1)
	...
	if var_1_10002(var_1_10003.format("painting/%s_n", arg_11_1)) then
		PlayerPrefs = var_11_0
		var_11_0 = var_11_0.GetInt
		string = var_3
		var_11_0 = var_11_0(var_3.format("paint_hide_other_obj_%s", arg_11_1), 0) ~= 0
	end
