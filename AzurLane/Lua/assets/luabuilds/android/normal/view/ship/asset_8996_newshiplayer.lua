...
function var_0_1.init(arg_4_0)
	...
	arg_4_0._canvasGroup = var_1(var_4_0, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0._shipName = var_4_10(var_4_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0._shipType = var_4_13(var_4_12, var_3(var_1_10004))
...
function var_0_1.setShip(arg_8_0, arg_8_1)
	...
	local var_8_2 = arg_8_1.isMetaShip(var_8_1)

	setImageSprite = var_8_1

	var_8_1(arg_8_0._bg, arg_8_0.bgSprite)

	setActive = var_8_1

	var_8_1(arg_8_0.metaDarkTF, arg_8_1:isMetaShip())
	...
	if var_8_0 then
		...
		if not arg_8_0.designBg then
			...
			local var_8_4 = var_4.GetInstance()

			var_4.GetUI(var_8_4, "raritydesign" .. arg_8_1:getRarity(), true, function(arg_9_0)
				...
				Vector3 = var_9_3
				var_9_4.localPosition = var_9_3(1, 1, 1)
	...
	elseif var_8_2 then
		...
		if arg_8_0.metaBg and arg_8_0.metaName ~= "raritymeta" .. arg_8_1:getRarity() then
			...
			local var_8_5 = var_4.GetInstance()

			var_4.ReturnUI(var_8_5, arg_8_0.metaName, arg_8_0.metaBg)
		...
		if not arg_8_0.metaBg then
			...
			local var_8_6 = var_4.GetInstance()

			var_4.GetUI(var_8_6, "raritymeta" .. arg_8_1:getRarity(), true, function(arg_10_0)
				...
				Vector3 = var_10_3
				var_10_4.localPosition = var_10_3(1, 1, 1)
	...
	if arg_8_1.virgin and not arg_8_0.isRemoulded and not arg_8_1:isActivityNpc() then
		...
		var_8_7(arg_8_0.newTF, true)

		LoadImageSpriteAsync = var_8_7

		var_8_7("clutter/new", arg_8_0.newTF)

		OPEN_TEC_TREE_SYSTEM = var_8_7

		if var_8_7 then
			table = var_8_7
			var_8_7 = var_8_7.indexof
			pg = var_5

			if var_8_7(var_5.fleet_tech_ship_template.all, arg_8_0._shipVO.groupId, 1) then
				pg = var_8_7
				var_8_7 = var_8_7.fleet_tech_ship_template[arg_8_0._shipVO.groupId].pt_get
				ShipType = var_5

				local var_8_8 = var_5.FilterOverQuZhuType

				pg = var_6

				local var_8_9 = var_8_8(var_6.fleet_tech_ship_template[arg_8_0._shipVO.groupId].add_get_shiptype)

				pg = var_6

				local var_8_10 = var_6.fleet_tech_ship_template[arg_8_0._shipVO.groupId].add_get_attr

				pg = var_7

				local var_8_11 = var_7.fleet_tech_ship_template[arg_8_0._shipVO.groupId].add_get_value

				pg = var_8
				var_1_10009 = var_8.ToastMgr.GetInstance()

				local var_8_12 = var_8.ShowToast

				pg = var_1_10010

				var_8_12(var_1_10009, var_1_10010.ToastMgr.TYPE_TECPOINT, {
					point = var_8_7,
					typeList = var_8_9,
					attr = var_8_10,
					value = var_8_11
		...
		var_8_7(arg_8_0.newTF, false)

		var_8_7 = arg_8_1:getReMetaSpecialItemVO()

		arg_8_0:updateLockTF(var_8_7 ~= nil)

		local var_8_14

		if var_8_7 then
			local var_8_13 = arg_8_0.metaRepeatTF

			var_8_14 = var_8_14.Find(var_8_13, "Icon")

			local var_8_15 = arg_8_0.metaRepeatTF
			local var_8_16 = var_6.Find(var_8_15, "Count")

			setImageSprite = var_8_15

			local var_8_17 = var_8_14

			LoadSprite = var_1_10009

			var_8_15(var_8_17, var_1_10009(var_8_7:getConfig("icon")))

			GetImageSpriteFromAtlasAsync = var_8_15
			var_1_10009 = var_8_7

			var_8_15(var_8_7.getConfig(var_1_10009, "icon"), "", var_8_14)

			setText = var_8_15

			var_8_15(var_8_16, var_8_7.count)

			pg = var_8_15

			local var_8_18 = var_8_15.ship_transform[arg_8_0._shipVO.groupId].exclusive_item[1][2]

			pg = var_8

			local var_8_19 = var_8.ship_transform[arg_8_0._shipVO.groupId].common_item[1][2]
			local var_8_20 = arg_8_0.metaRepeatTF

			var_1_10009 = var_1_10009.Find(var_8_20, "Special")

			local var_8_21 = arg_8_0.metaRepeatTF
			local var_8_22 = var_10.Find(var_8_21, "Commom")

			setActive = var_8_21

			var_8_21(var_1_10009, var_8_7.id == var_8_18)

			setActive = var_8_21

			var_8_21(var_8_22, var_8_7.id == var_8_19)
		else
			setActive = var_8_14

			var_8_14(arg_8_0.metaRepeatTF, false)
		end
	end

	setActive = var_8_7

	var_8_7(arg_8_0.audioBtn, not arg_8_0.isRemoulded)

	local var_8_23 = arg_8_0
	local var_8_24 = arg_8_0.UpdateLockButton
	local var_8_25 = arg_8_0._shipVO

	var_8_24(var_8_23, var_6.GetLockState(var_8_25))

	local var_8_26 = arg_8_0._shipVO
	local var_8_27 = var_4.getConfigTable(var_8_26)
	local var_8_28

	if arg_8_0.isRemoulded then
		setPaintingPrefabAsync = var_5
		var_8_28 = arg_8_0._paintingTF

		local var_8_29 = arg_8_0._shipVO

		var_5(var_8_28, var_7.getRemouldPainting(var_8_29), "huode")

		setPaintingPrefabAsync = var_5
		var_8_28 = arg_8_0._paintingShadowTF

		local var_8_30 = arg_8_0._shipVO

		var_5(var_8_28, var_7.getRemouldPainting(var_8_30), "huode")
	else
		setPaintingPrefabAsync = var_5
		var_8_28 = arg_8_0._paintingTF
		...
		var_5(var_8_28, var_7.getPainting(var_8_31), "huode")

		setPaintingPrefabAsync = var_5
		var_8_28 = arg_8_0._paintingShadowTF

		local var_8_32 = arg_8_0._shipVO

		var_5(var_8_28, var_7.getPainting(var_8_32), "huode")
	end

	local var_8_33 = arg_8_0._shipType

	pg = var_8_28

	local var_8_34 = var_8_28.ship_data_by_type
	local var_8_35 = arg_8_0._shipVO

	var_8_33.text = var_8_34[var_7.getShipType(var_8_35)].type_name
	arg_8_0._shipName.text = arg_8_1:getName()

	local var_8_36 = arg_8_1
	local var_8_37 = arg_8_1.getRarity(var_8_36)

	pg = var_8_36

	local var_8_38 = var_8_36.ship_data_template[var_8_27.id].star_max
	local var_8_39 = arg_8_0._shipVO
	local var_8_40 = var_7.getStar(var_8_39)

	if not (var_8_38 % 2 == 0) or not (var_8_38 / 2) then
		math = var_1_10009

		local var_8_41 = var_1_10009.floor(var_8_38 / 2) + 1
	end

	local var_8_42 = 15

	for iter_8_0 = 1, 6 do
		local var_8_43 = arg_8_0.starsTF
		local var_8_44 = var_15.Find(var_8_43, "content/star_" .. iter_8_0)
		local var_8_45 = var_15.Find(var_8_44, "star_empty")
		local var_8_46 = var_15
		local var_8_47 = var_15.Find(var_8_46, "star")

		setActive = var_8_46

		var_8_46(var_8_47, iter_8_0 <= var_8_40)

		setActive = var_8_46

		var_8_46(var_8_45, var_8_40 < iter_8_0)

		if var_8_38 < iter_8_0 then
			setActive = var_8_46

			var_8_46(var_15, false)
		end
	end

	local var_8_48 = arg_8_0._shake
	local var_8_49 = var_11.Find(var_8_48, "rarity/nation")

	LoadSprite = var_8_48

	local var_8_50 = "prints/"

	nation2print = iter_8_0

	if not var_8_48(var_8_50 .. iter_8_0(var_8_27.nationality) .. "_0") then
		warning = var_13

		var_13("找不到印花, shipConfigId: " .. arg_8_1.configId)

		setActive = var_13

		var_13(var_8_49, false)
	else
		setImageSprite = var_13

		var_13(var_8_49, var_12, false)
	end

	local var_8_51 = arg_8_0._shake
	local var_8_52 = var_13.Find(var_8_51, "rarity/type")
	local var_8_53 = arg_8_0._shake
	local var_8_54 = var_14.Find(var_8_53, "rarity/type/rarLogo")

	if arg_8_1:isMetaShip() then
		LoadImageSpriteAsync = var_15

		var_15("shiprarity/1" .. var_8_37 .. "m", var_8_52, true)

		LoadImageSpriteAsync = var_15

		var_15("shiprarity/1" .. var_8_37 .. "s", var_8_54, true)
	else
		LoadImageSpriteAsync = var_15

		var_15("shiprarity/" .. (var_8_0 and "0" or "") .. var_8_37 .. "m", var_8_52, true)

		LoadImageSpriteAsync = var_15

		var_15("shiprarity/" .. (var_8_0 and "0" or "") .. var_8_37 .. "s", var_8_54, true)
	end

	setActive = var_15

	var_15(var_8_49, false)
	...
	arg_8_0:AddLeanTween(function()
		...
		return var_11_0(var_11_1, var_2_10002.Action(function()
			setActive = var_3_10000

			var_3_10000(var_8_49, true)
	...
	local var_8_55 = arg_8_0._shake
	local var_8_56 = var_15.Find(var_8_55, "ship_type")
	local var_8_57 = var_15.Find(var_8_56, "stars")
	local var_8_58 = var_15:Find("stars/startpl")
	local var_8_59 = var_15
	local var_8_60

	var_8_60, setText = var_15.Find(var_8_59, "english_name"), var_8_59

	local var_8_61 = arg_8_0._shipVO

	var_8_59(var_8_60, var_21.getConfig(var_8_61, "english_name"))

	local var_8_62 = var_8_57.childCount
	local var_8_63 = arg_8_0._shipVO
	local var_8_64 = var_20.getStar(var_8_63)
	local var_8_65 = arg_8_0._shipVO
	local var_8_66 = var_21.getMaxStar(var_8_65)

	for iter_8_1 = var_8_62, var_8_66 - 1 do
		cloneTplTo = var_1_10026

		var_1_10026(var_8_58, var_8_57)
	end

	local var_8_67 = var_8_57.childCount

	for iter_8_2 = 0, var_8_67 - 1 do
		local var_8_68 = var_8_57:GetChild(iter_8_2).gameObject

		var_27.SetActive(var_8_68, iter_8_2 < var_8_66)

		setActive = var_27

		var_27(var_1_10026:Find("star"), iter_8_2 < var_8_64)

		setActive = var_27

		var_27(var_1_10026:Find("empty"), var_8_64 <= iter_8_2)
	end

	local var_8_69 = arg_8_0._shipVO
	local var_8_70 = var_22.getConfigTable(var_8_69)

	findTF = var_8_69

	local var_8_71 = var_8_69(var_15, "type_bg/type")
	local var_8_72 = var_23.GetComponent

	typeof = var_25
	Image = var_1_10026

	local var_8_73 = var_8_72(var_8_71, var_25(var_1_10026))

	GetSpriteFromAtlas = var_8_71

	local var_8_74 = "shiptype"

	tostring = var_1_10026

	local var_8_75 = arg_8_0._shipVO

	var_8_73.sprite = var_8_71(var_8_74, var_1_10026(var_27.getShipType(var_8_75)))
	setScrollText = var_24

	local var_8_76 = var_15:Find("name_bg/mask/Text")
	local var_8_77 = arg_8_0._shipVO

	var_24(var_8_76, var_26.getName(var_8_77))

	if var_8_0 then
		var_8_37 = var_8_37 .. "_1"
	elseif arg_8_1:isMetaShip() then
		var_8_37 = var_8_37 .. "_2"
	end

	if not arg_8_0.rarityEffect[var_8_37] then
		PoolMgr = var_24

		local var_8_78 = var_24.GetInstance()

		var_24.GetUI(var_8_78, "getrole_" .. var_8_37, true, function(arg_13_0)
			IsNil = var_2_10001
			...
			arg_8_0.rarityEffect[var_8_37] = arg_13_0
			...
			if var_1.isMetaShip(var_13_4) then
				...
				local var_13_8 = var_13_7(var_13_6, var_4(var_5))

				var_2.SetEndEvent(var_13_8, function(arg_14_0)
					setActive = var_3_10001

					var_3_10001(var_8_49, true)
		...
		arg_8_0.effectObj = arg_8_0.rarityEffect[var_8_37]
		setActive = var_24
...
function var_0_1.DisplayWord(arg_18_0)
	...
	if arg_18_0.isRemoulded then
		...
		ShipWordHelper = var_18_3

		local var_18_5 = var_18_3.RawGetWord

		var_1_10006 = var_18_4
		ShipWordHelper = var_1_10007

		local var_18_6, var_18_7

		if var_18_5(var_1_10006, var_1_10007.WORD_TYPE_UNLOCK) == "" then
			ShipWordHelper = var_18_6
			var_18_6 = var_18_6.GetWordAndCV
			var_1_10006 = var_18_4
			ShipWordHelper = var_18_7
			var_18_6, var_1_10006, var_18_7 = var_18_6(var_1_10006, var_18_7.WORD_TYPE_DROP)
			var_18_1 = var_18_7
			var_18_2 = var_1_10006

			local var_18_8 = var_18_6
		else
			ShipWordHelper = var_18_6

			local var_18_9 = var_18_6.GetWordAndCV

			var_1_10006 = var_18_4
			ShipWordHelper = var_18_7

			local var_18_10, var_18_11

			var_18_10, var_1_10006, var_18_11 = var_18_9(var_1_10006, var_18_7.WORD_TYPE_UNLOCK)
			var_18_1 = var_18_11
			var_18_2 = var_1_10006

			local var_18_12 = var_18_10
		end
	else
		ShipWordHelper = var_18_4
		var_18_4 = var_18_4.GetWordAndCV
		var_1_10006 = arg_18_0._shipVO

		local var_18_13 = var_5.getSkinId(var_1_10006)

		ShipWordHelper = var_1_10006

		local var_18_14

		var_18_4, var_18_14, var_1_10006 = var_18_4(var_18_13, var_1_10006.WORD_TYPE_UNLOCK)
		var_18_1 = var_1_10006
		var_18_2 = var_18_14

		local var_18_15 = var_18_4
	end

	setWidgetText = var_18_4

	local var_18_16 = arg_18_0._dialogue

	SwitchSpecialChar = var_1_10006

	var_18_4(var_18_16, var_1_10006(var_18_1, true), "Text")

	local var_18_17 = arg_18_0._dialogue.transform

	Vector3 = var_18_16
	var_18_17.localScale = var_18_16(0, 1, 1)
	SetActive = var_18_17

	var_18_17(arg_18_0._dialogue, false)
	arg_18_0:AddLeanTween(function()
		...
		return var_19_0(var_19_1, var_2_10002.Action(function()
			SetActive = var_3_10000
			...
			var_0.AddLeanTween(var_20_0, function()
				...
				return var_21_0(var_21_1, var_4_10002(1, 1, 1), 0.1)
			end)
...
function var_0_1.switch2Property(arg_23_0)
	...
	var_1_10001(var_2.Find(var_23_0, "rarity/nation"), false)
	...
	arg_23_0:AddLeanTween(function()
		...
		local var_24_1 = var_2_10001(var_23_2)

		Vector3 = var_2

		return var_24_0(var_24_1, var_2(0, -149.55, 0), 0.3)
	end)
	arg_23_0:AddLeanTween(function()
		LeanTween = var_2_10000
		...
		local var_25_1 = var_2_10001(arg_23_0._paintingTF)

		Vector3 = var_2

		return var_25_0(var_25_1, var_2(-59, 21, 0), 0.2)
	end)
...
function var_0_1.showExitTip(arg_26_0, arg_26_1)
	...
	local var_26_2 = var_26_0.settings_other_template[22]

	getProxy = var_1_10004
	PlayerProxy = var_1_10005

	local var_26_3 = var_1_10004(var_1_10005)
	local var_26_4 = var_4.getRawData(var_26_3)
	local var_26_5 = var_4.GetCommonFlag

	_G = var_1_10006

	local var_26_6 = var_26_5(var_26_4, var_1_10006[var_26_2.name])
	...
	if arg_26_0._shipVO.virgin then
		...
		if var_26_1 == var_5.LOCK_STATE_UNLOCK and not var_26_6 then
			...
			i18n = var_1_10008
			var_26_9.content = var_1_10008("ship_lock_tip")
			...
			function var_26_9.onYes()
				...
				if arg_26_1 then
					...
					var_27_1(var_27_0, var_2_10002.ON_EXIT)
				end
			...
			function var_26_9.onNo()
				if arg_26_1 then
					...
					var_28_1(var_28_0, var_2_10002.ON_EXIT)
				end
...
function var_0_1.UpdateLockButton(arg_29_0, arg_29_1)
	...
	var_1_10002(var_29_0, arg_29_1 ~= var_1_10004.LOCK_STATE_LOCK)
	...
	var_1_10002(var_29_1, arg_29_1 ~= var_4.LOCK_STATE_UNLOCK)
...
function var_0_1.didEnter(arg_31_0)
	...
	local function var_31_2()
		...
		local var_32_3 = var_2_10002.ON_LOCK
		local var_32_4 = {
			arg_31_0._shipVO.id
		}
		...
		var_32_2(var_32_1, var_32_3, var_32_4, var_4.LOCK_STATE_LOCK)
	...
	var_1_10001(var_31_0, var_31_1, var_31_2, var_1_10005)
	...
	local function var_31_5()
		...
		local var_33_3 = var_2_10002.ON_LOCK
		local var_33_4 = {
			arg_31_0._shipVO.id
		}
		...
		var_33_2(var_33_1, var_33_3, var_33_4, var_4.LOCK_STATE_UNLOCK)
	...
	var_1_10001(var_31_3, var_31_4, var_31_5, var_1_10005)
	...
	var_1_10001(var_31_6, var_31_7, var_31_8, var_1_10005)
	...
	local function var_31_11()
		...
		local var_35_3 = var_2_10002.ON_EVALIATION
		local var_35_4 = arg_31_0._shipVO

		var_35_2(var_35_1, var_35_3, var_3.getGroupId(var_35_4))
	...
	var_1_10001(var_31_9, var_31_10, var_31_11, var_1_10005)
	...
	local function var_31_14()
		...
		var_36_2(var_36_1, var_2_10002.ShareMgr.TypeNewShip)
	...
	var_1_10001(var_31_12, var_31_13, var_31_14, var_1_10005)
	...
	var_1_10001(var_31_15, var_31_16, var_31_17, var_1_10005)
	...
	var_1_10001(var_31_18, var_31_19, var_31_20, var_1_10005)
	...
	local function var_31_23()
		...
		var_0.showExitTip(var_39_0, function()
			...
			NewShipMediator = var_3_10002

			var_40_1(var_40_0, var_3_10002.ON_SKIP_BATCH)
	...
	var_1_10001(var_31_21, var_31_22, var_31_23, var_1_10005)
...
function var_0_1.paintView(arg_42_0)
	...
	if not var_42_16(var_1_10016(var_4)) then
		arg_42_0:AddLeanTween(function()
			...
			local var_43_1 = var_43_0(var_2_10001(var_0), 150, 0.5)
			local var_43_2 = var_0.setEase

			LeanTweenType = var_2

			return var_43_2(var_43_1, var_2.easeInOutSine)
		end)
	end
	...
	var_16:AddDragFunc(function(arg_47_0, arg_47_1)
		if var_42_18 then
			...
			local var_47_1 = var_3(arg_42_0._paintingTF)
	...
	var_19(var_42_20, var_42_21, var_42_22, var_1_10023)
	...
	function var_0_1.hidePaintView(arg_49_0, arg_49_1)
		...
		var_49_1(var_3(arg_49_0._paintingTF))
...
function var_0_1.recyclePainting(arg_50_0)
	if arg_50_0._shipVO then
		...
		var_1(var_50_0, var_3.getPainting(var_50_1))
		...
		var_1(var_50_2, var_3.getPainting(var_50_3))
...
function var_0_1.starsAnimation(arg_51_0)
	...
	if 6 <= var_51_1 then
		...
		RARE_SHIP_VIBRATE = var_1_10003

		if var_51_2(var_1_10003, 1) > 0 then
			LuaHelper = var_51_2
	...
	local var_51_5 = var_51_4(var_51_3, var_4(var_1_10005))
	...
	var_2.SetTriggerEvent(var_51_5, function(arg_52_0)
		...
		var_1.AddLeanTween(var_52_0, function()
			...
			local var_53_1 = var_3_10001(arg_51_0.starsCont)

			Vector3 = var_2

			local var_53_2 = var_53_0(var_53_1, var_2.one, 0)
			local var_53_3 = var_0.setOnComplete

			System = var_2

			return var_53_3(var_53_2, var_2.Action(function()
		...
		for iter_52_0 = 0, arg_51_0.starsCont.childCount - 1 do
			...
			local var_52_5 = var_6
			local var_52_6 = var_6.Find(var_52_5, "star")

			setActive = var_52_5

			var_52_5(var_52_4, false)

			setActive = var_52_5

			var_52_5(var_52_6, false)

			local var_52_7 = iter_52_0 * var_52_1
			local var_52_8 = arg_51_0

			var_10.AddLeanTween(var_52_8, function()
				LeanTween = var_3_10000
				...
				local var_55_1 = var_3_10001(var_52_4)

				Vector3 = var_2

				local var_55_2 = var_55_0(var_55_1, var_2(1.8, 1.8, 1.8), 0)
				local var_55_3 = var_0.setDelay(var_55_2, var_52_7)
				local var_55_4 = var_0.setOnComplete

				System = var_2

				return var_55_4(var_55_3, var_2.Action(function()
					setActive = var_4_10000
					...
					var_0.AddLeanTween(var_56_0, function()
						...
						local var_57_1 = var_5_10001(var_52_4)

						Vector3 = var_2

						return var_57_0(var_57_1, var_2(1, 1, 1), var_52_1)
					end)
		...
		local var_52_9 = arg_51_0._shipVO
		local var_52_10 = var_2.getStar(var_52_9)
		local var_52_11 = arg_51_0.STAR_ANIMATION_DUR2
		local var_52_12 = arg_51_0.STAR_ANIMATION_DUR3

		for iter_52_1 = 0, var_52_10 - 1 do
			local var_52_13 = arg_51_0.starsCont
			local var_52_14 = var_9.GetChild(var_52_13, iter_52_1)
			local var_52_15 = var_9.Find(var_52_14, "star_empty")
			local var_52_16 = var_9:Find("star")
			local var_52_17 = var_52_1 * arg_51_0.starsCont.childCount + iter_52_1 * var_52_11
			local var_52_18 = arg_51_0

			var_13.AddLeanTween(var_52_18, function()
				LeanTween = var_3_10000
				...
				local var_58_1 = var_3_10001(var_52_16)

				Vector3 = var_2

				local var_58_2 = var_58_0(var_58_1, var_2(1.8, 1.8, 1.8), 0)
				local var_58_3 = var_0.setDelay(var_58_2, var_52_17)
				local var_58_4 = var_0.setOnStart

				System = var_2

				local var_58_5 = var_58_4(var_58_3, var_2.Action(function()
					pg = var_4_10000

					local var_59_0 = var_4_10000.CriMgr.GetInstance()
					local var_59_1 = var_0.PlaySoundEffect_V3

					SFX_UI_DOCKYARD_STAR = var_4_10002

					var_59_1(var_59_0, var_4_10002)
				...
				return var_58_6(var_58_5, var_2.Action(function()
					setActive = var_4_10000

					var_4_10000(var_52_15, false)

					setActive = var_4_10000

					var_4_10000(var_52_16, true)
					...
					var_0.AddLeanTween(var_60_0, function()
						...
						local var_61_1 = var_5_10001(var_52_16)

						Vector3 = var_2

						return var_61_0(var_61_1, var_2(1, 1, 1), var_52_11)
					end)
			...
			if var_9:Find("light") then
				...
				var_14.AddLeanTween(var_52_19, function()
					...
					local var_62_1 = var_52_17

					System = var_3_10002

					return var_62_0(var_62_1, var_3_10002.Action(function()
				...
				var_14.AddLeanTween(var_52_20, function()
					...
					local var_64_1 = var_64_0(var_3_10001(var_0), 0, var_52_12)
					local var_64_2 = var_0.setDelay(var_64_1, var_52_17)
					local var_64_3 = var_0.setOnComplete

					System = var_2

					return var_64_3(var_64_2, var_2.Action(function()
						SetActive = var_4_10000
				...
				Vector3 = var_52_20
				var_52_21.localScale = var_52_20(1, 1, 1)
				...
				var_14.AddLeanTween(var_52_22, function()
					...
					local var_66_1 = var_3_10001(var_0)

					Vector3 = var_2

					local var_66_2 = var_66_0(var_66_1, var_2(0.5, 1, 1), arg_51_0.STAR_ANIMATION_DUR4)

					return var_0.setDelay(var_66_2, var_52_17 + var_52_12 * 1 / 3)
				end)
			end
		end
	...
	var_2:SetEndEvent(function(arg_67_0)
		...
		if var_1.getReMetaSpecialItemVO(var_67_0) then
			GetComponent = var_67_0
			var_67_0(arg_51_0.metaRepeatTF, "CanvasGroup").alpha = 1
			...
			local var_67_3 = var_2_10005.value
			...
			local function var_67_4()
				...
				var_68_0(var_68_1, var_2.isActivityNpc(var_68_2))
			...
			local var_67_5 = var_67_2(var_67_1, var_67_3, var_67_4, var_2_10007(arg_51_0.metaRepeatTF), arg_51_0.metaRepeatTF.rect.width, 0, 1)
			...
			var_67_7(var_67_8, var_4.isActivityNpc(var_67_9))
...
function var_0_1.playOpening(arg_70_0, arg_70_1)
	...
	if var_2.isMetaShip(var_70_0) then
		...
		BuildShipMediator = var_1_10004

		if not var_70_2(var_70_1, var_1_10004) then
			if arg_70_1 then
				arg_70_1()
			end
	...
	if var_3.isRemoulded(var_70_4) then
		...
		var_70_3 = var_70_5(var_4.getGroupId(var_70_6)).trans_skin
	else
		ShipGroup = var_70_5
		...
		var_70_3 = var_70_7(var_4.getGroupId(var_70_8)).id
	end
	...
	if var_4("ui/skinunlockanim/" .. var_70_9) then
		...
		local var_70_10 = var_5.CpkPlayMgr.GetInstance()
...
function var_0_1.willExit(arg_74_0)
	...
	if not arg_74_0.isRemoulded then
		...
		local var_74_7 = iter_74_1.ship_data_by_type
		local var_74_8 = arg_74_0._shipVO
		local var_74_9 = var_74_7[var_6.getShipType(var_74_8)].type_name
		local var_74_10 = arg_74_0._shipVO
		local var_74_11 = var_3(var_74_6, var_74_9, var_6.getName(var_74_10))

		COLOR_GREEN = var_74_6

		var_74_5(var_74_4, var_74_11, var_74_6)
	end
	...
	if var_74_14(var_74_13(arg_74_0.rarityTF)) then
		...
		var_74_15(var_2(arg_74_0.rarityTF))
	end
...
function var_0_1.DisplayNewShipDocumentView(arg_75_0)
	...
	arg_75_0.newShipDocumentView = var_75_0(var_2.Find(var_75_1, "ForNotch"), arg_75_0.event, arg_75_0.contextData)
...
function var_0_1.DestroyNewShipDocumentView(arg_77_0)
	if arg_77_0.newShipDocumentView then
		...
		if var_77_1(var_77_0, var_1_10003.STATES.INITED) then
