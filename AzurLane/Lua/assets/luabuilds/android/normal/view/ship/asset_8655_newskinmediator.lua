...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.SET_SKIN, function(arg_2_0, arg_2_1, arg_2_2)
		...
		for iter_2_0, iter_2_1 in var_2_10003(arg_2_1) do
			...
			var_2_2(var_2_1, var_2_10012.SET_SHIP_SKIN, {
				shipId = var_2_10008,
				phantomId = var_2_0,
		...
		if arg_2_2 then
			...
			var_2_5(var_2_7, iter_2_1.CHANGE_PLAYER_ICON, {
				skinPage = true,
				after = var_2_6
			})
		end
		...
		local var_2_9 = var_3.emit

		BaseUI = var_2_5

		var_2_9(var_2_8, var_2_5.ON_CLOSE)
