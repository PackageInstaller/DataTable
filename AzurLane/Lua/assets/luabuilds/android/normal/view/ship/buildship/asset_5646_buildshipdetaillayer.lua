...
function var_0_1.init(arg_6_0)
	...
	typeof = var_3
	Toggle = var_1_10004
	arg_6_0.autoLockShipToggle = var_6_14(var_6_13, var_3(var_1_10004))
	...
	arg_6_0.canvasgroup = var_1(var_6_15, var_3(var_1_10004))
	setText = var_1

	local var_6_16 = arg_6_0._tf
	local var_6_17 = var_2.Find(var_6_16, "title/text")

	i18n = var_6_16

	var_1(var_6_17, var_6_16("build_detail_intro"))

	setText = var_1

	local var_6_18 = arg_6_0._tf
	local var_6_19 = var_2.Find(var_6_18, "autolockship/Text")

	i18n = var_6_18

	var_1(var_6_19, var_6_18("lock_new_ship"))
...
function var_0_1.didEnter(arg_8_0)
	...
	local function var_8_6()
		...
		if var_0.getNeedCount(var_11_0) > 0 and not arg_8_0.isStopSpeedUpRemind then
			pg = var_1
			var_2_10003 = var_1.MsgboxMgr.GetInstance()
			...
			if arg_8_0.itemVO.count == 0 then
				...
				var_11_2.content = var_2_10005(var_11_3, var_11_4, var_8, arg_8_0.itemVO.count)
				i18n = var_5
				var_11_2.stopRamindContent = var_5("common_dont_remind_dur_login")

				function var_11_2.onYes()
					local var_12_0 = arg_8_0
					local var_12_1 = var_0.emit

					BuildShipDetailMediator = var_3_10002

					var_12_1(var_12_0, var_3_10002.LAUNCH_ALL, var_0.stopRemindToggle.isOn)

					return
				end

				var_11_1(var_2_10003, var_11_2)
				...
				if false then
					...
					if #arg_8_0.projectList > 0 then
						...
						var_11_6(var_11_5, var_2_10003.LAUNCH_ALL)
					else
						pg = var_11_6
						...
						var_11_8(var_11_7, var_2_10003("ship_getShip_error_noShip"))
					end
				end
	...
	SFX_UI_BUILDING_FASTBUILDING = var_1_10006

	var_2(var_8_4, var_8_5, var_8_6, var_1_10006)
	...
	local var_8_8 = var_3(var_4)
	local var_8_9 = var_3.getRawData(var_8_8)
	local var_8_10 = var_3.GetCommonFlag

	_G = var_5

	local var_8_11 = var_8_10(var_8_9, var_5[var_8_7.name])
	...
	local var_8_14 = var_6(arg_8_0.autoLockShipToggle)
	...
	var_8_12(var_8_13, var_8_14, var_8_15, var_1_10008)
...
function var_0_1.updateProject(arg_22_0, arg_22_1, arg_22_2)
	...
	var_1_10003(var_1_10004(var_22_0, var_1_10006), "必须是实例BuildShip")

	local var_22_1 = arg_22_0.projectTFs[arg_22_1]

	IsNil = var_4

	if var_4(var_22_1) then
		return
	end

	local var_22_2 = var_22_1:Find("frame/buiding")
	local var_22_3 = var_22_1:Find("frame/finished")
	local var_22_4 = var_22_1
	local var_22_5 = var_22_1.Find(var_22_4, "frame/waiting")

	setActive = var_22_4

	var_22_4(var_22_5, false)
	...
	BuildShip = var_1_10010

	var_22_4(var_22_6, var_22_7 == var_1_10010.ACTIVE)

	setActive = var_22_4

	local var_22_8 = var_22_3
	local var_22_9 = arg_22_2.state

	BuildShip = var_10

	var_22_4(var_22_8, var_22_9 == var_10.FINISH)

	local var_22_10 = var_22_1:GetComponent("CanvasGroup")
	local var_22_11 = arg_22_2.state

	BuildShip = var_9
	var_22_10.alpha = var_22_11 == var_9.INACTIVE and 0.6 or 1
	pg = var_8

	local var_22_12 = var_8.ship_data_create_material[arg_22_2.type]

	tonumber = var_9

	local var_22_13 = var_9(var_22_12.ship_icon)
	local var_22_14 = var_22_2:Find("ship_modal")

	for iter_22_0 = 0, var_22_14.childCount - 1 do
		var_1_10016 = var_22_14

		local var_22_15 = var_22_14.GetChild(var_1_10016, iter_22_0)

		setActive = var_1_10016

		var_1_10016(var_22_15, false)
	end

	local var_22_16 = arg_22_2.state

	BuildShip = var_12

	local var_22_17, var_22_18

	if var_22_16 == var_12.ACTIVE then
		GetComponent = var_22_16
		var_22_17 = var_22_2
		typeof = var_22_18
		CanvasGroup = iter_22_0

		if var_22_16(var_22_17, var_22_18(iter_22_0)) then
			var_11.alpha = 1
		end

		var_22_18 = var_22_14

		if not var_22_14.Find(var_22_18, "shipModelBuliding" .. var_22_13) then
			PoolMgr = var_22_18
			iter_22_0 = var_22_18.GetInstance()

			var_22_18.GetUI(iter_22_0, "shipModelBuliding" .. var_22_13, true, function(arg_23_0)
				local var_23_0 = arg_23_0.transform

				var_1.SetParent(var_23_0, var_22_14, false)

				local var_23_1 = arg_23_0.transform

				Vector3 = var_23_0
				var_23_1.localPosition = var_23_0(1, 1, 1)
			...
			var_22_18(var_22_17, true)
		end

		iter_22_0 = var_22_2
		var_22_18 = var_22_2.Find(iter_22_0, "timer/Text")
		onButton = iter_22_0

		local var_22_19 = arg_22_0

		var_1_10016 = var_22_2:Find("quick_btn")
		...
		local function var_22_20()
			...
			if not var_24_0 then
				if var_24_2 then
					...
					local var_24_3 = var_2_10004("switch_to_shop_tip_1")

					ChargeScene = var_2_10005

					var_2_10003(var_24_3, var_2_10005.TYPE_ITEM, var_24_2)
				else
					pg = var_2_10003
			...
			if arg_22_0.isStopSpeedUpRemind then
				...
				BuildShipDetailMediator = var_2_10005

				var_24_6(var_24_5, var_2_10005.ON_QUICK, arg_22_1)
			...
			if arg_22_0.itemVO.count == 0 then
				...
				var_24_9.content = var_2_10007(var_24_10, var_24_11, var_10, arg_22_0.itemVO.count)
				i18n = var_7
				var_24_9.stopRamindContent = var_7("dont_remind_session")
				...
				function var_24_9.onYes()
					...
					var_25_1(var_25_0, var_3_10002.ON_QUICK, arg_22_1, var_0.stopRemindToggle.isOn)
		...
		SFX_UI_BUILDING_FASTBUILDING = var_18

		iter_22_0(var_22_19, var_1_10016, var_22_20, var_18)
		...
		function iter_22_0()
			...
			var_26_1(var_22_3, true)

			return
		end

		local function var_22_21(arg_27_0)
			pg = var_2_10001
		...
		if arg_22_0.buildTimers[arg_22_1] then
			pg = var_1_10016
			var_22_20 = var_1_10016.TimeMgr.GetInstance()

			var_1_10016.RemoveTimer(var_22_20, arg_22_0.buildTimers[arg_22_1])
		...
		local var_22_22 = var_22_20.TimeMgr.GetInstance()

		var_1_10016[arg_22_1] = var_17.AddTimer(var_22_22, "timer" .. arg_22_1, 0, 1, function()
		...
		local var_22_23 = arg_22_2.state

		BuildShip = var_22_17

		local var_22_24

		if var_22_23 == var_22_17.FINISH then
			GetOrAddComponent = var_22_23
			var_22_24 = var_22_2
			typeof = var_22_18
			CanvasGroup = iter_22_0
			var_22_23(var_22_24, var_22_18(iter_22_0)).alpha = 0
			setActive = var_22_24

			var_22_24(var_22_2, true)

			local var_22_25 = var_22_14

			if var_22_14.Find(var_22_25, "shipModelBuliding" .. var_22_13) then
				setActive = var_22_25

				var_22_25(var_22_24, true)
			end

			local var_22_26 = arg_22_0
			local var_22_27 = arg_22_0.setSpriteTo
			local var_22_28 = var_0_6

			tonumber = var_1_10016

			var_22_27(var_22_26, var_22_28[var_1_10016(var_22_12.ship_icon)], var_22_3:Find("ship_modal"), false)

			findTF = var_22_27

			local var_22_29 = var_22_27(var_22_3, "launched_btn")

			onButton = var_14

			local var_22_30 = arg_22_0
			local var_22_31 = var_22_29

			local function var_22_32()
				local var_29_0 = arg_22_0
				local var_29_1 = var_0.emit

				BuildShipDetailMediator = var_2_10002

				var_29_1(var_29_0, var_2_10002.ON_LAUNCHED, arg_22_1)
			...
			var_14(var_22_30, var_22_31, var_22_32, var_18)

			onButton = var_14

			local var_22_33 = arg_22_0
			local var_22_34 = var_22_1

			local function var_22_35()
				triggerButton = var_2_10000

				var_2_10000(var_22_29)
			...
			var_14(var_22_33, var_22_34, var_22_35, var_18)
		else
			local var_22_36 = arg_22_2.state

			BuildShip = var_22_24

			if var_22_36 == var_22_24.INACTIVE then
				setActive = var_22_36

				var_22_36(var_22_5, true)

				setActive = var_22_36

				var_22_36(var_22_2, false)

				setActive = var_22_36

				var_22_36(var_22_3, false)
			end
		end
	end
...
function var_0_1.playGetShipAnimate(arg_31_0, arg_31_1, arg_31_2)
	...
	local function var_31_4()
		...
		var_0(var_32_1, var_2_10002.CpkPlayMgr.GetInstance()._ratioFitter.enabled)
...
function var_0_1.willExit(arg_34_0)
	...
	var_1.each(var_34_2, function(arg_35_0, arg_35_1)
		...
		local var_35_1 = arg_35_1.Find(var_35_0, "frame/buiding/ship_modal")

		eachChild = var_35_0

		var_35_0(var_35_1, function(arg_36_0)
			PoolMgr = var_3_10001
	...
	var_1.each(var_34_3, function(arg_37_0, arg_37_1)
		...
		local var_37_1 = arg_37_1.Find(var_37_0, "frame/buiding/ship_modal")

		eachChild = var_37_0

		var_37_0(var_37_1, function(arg_38_0)
			PoolMgr = var_3_10001
...
function var_0_1.ChangeAutoLockShip(arg_41_0, arg_41_1, arg_41_2)
	...
	local var_41_1 = var_4(var_1_10005)
	...
	if var_41_4 then
		...
		var_41_6(var_41_5, var_1_10008.CANCEL_COMMON_FLAG, {
			flagID = var_41_0
		})
	else
		pg = var_41_6
		...
		var_41_8(var_41_7, var_1_10008.COMMON_FLAG, {
			flagID = var_41_0
		})
	end
