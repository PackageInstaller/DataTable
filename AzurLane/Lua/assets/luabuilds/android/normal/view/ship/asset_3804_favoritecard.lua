...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.nameTF = var_1_3(var_1_2, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.starCount = var_1_11(var_1_10, var_5(var_1_10006))
...
local function var_0_1(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10005
	var_2_0.iconImg = var_2_3(var_2_2, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	var_2_0.name = var_2_5(var_2_4, var_4(var_1_10005))
	findTF = var_2
	...
	function var_2_0.update(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_0(var_3_2 .. var_3_1.getPaintingName(arg_3_1.configId), function(arg_4_0)
			if arg_4_0 then
				...
				getSpritePivot = var_2
				var_4_0.pivot = var_2(arg_4_0)
				...
				Vector3 = var_4_1
				var_4_2.localPosition = var_4_1(0, -85, 0)
				setActive = var_4_2
		...
		if arg_3_2 then
			...
			var_3_0(var_3_3, var_3_6.New(1, 1, 1, 1))
			...
			for iter_3_1 = 1, 6 do
				...
				var_2_10010(var_3_5, iter_3_1 <= var_3_0)

				setActive = var_2_10010

				var_2_10010(var_3_5:Find("startpl"), false)
			end

			var_3_6 = var_3_4[var_3_0]

			for iter_3_2 = 1, var_3_0 do
				findTF = var_2_10010
				var_2_10010 = var_2_10010(var_2_0.stars, "star_" .. var_3_6[iter_3_2])
				setActive = var_11

				var_11(var_2_10010:Find("startpl"), iter_3_2 <= arg_3_2.star)
			end
		else
			setImageColor = var_3_0

			local var_3_7 = arg_3_0.icon

			Color = var_3_6

			var_3_0(var_3_7, var_3_6.New(0, 0, 0, 0.7))
		end
...
function var_0_0.update(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	for iter_5_1 = 0, arg_5_0.charContainer.childCount - 1 do
		...
		var_5_2(var_5_3, iter_5_1 < #var_5_1)

		local var_5_4 = var_5_1[iter_5_1 + 1]

		if iter_5_1 < #var_5_1 then
			var_5_0[var_5_4] = var_0_1(var_5_3)
		end
	end
...
function var_0_0.updateBound(arg_6_0)
	...
	var_1(var_6_1, var_6_2 == var_4.STATE_WAIT)
	...
	var_1(var_6_3, var_6_4 == var_4.STATE_AWARD)
	...
	var_1(var_6_5, var_6_6 == var_4.STATE_FETCHED)
	...
	var_1(var_6_7, var_6_8 == var_4.STATE_LOCK)
	...
	var_1(var_6_9, var_6_10 == var_4.STATE_AWARD)
