...
function var_0_1.init(arg_3_0)
	...
	Vector3 = var_2
	var_3_10.localScale = var_2.New(0, 0, 1)
	...
	typeof = var_3
	Text = var_4
	arg_3_0.initfontSize = var_3_12(var_3_11, var_3(var_4)).fontSize
	...
	local var_3_22 = var_2.Find(var_3_21, "adapt/intimacy/addValue")

	typeof = var_3_21
	RectTransform = var_4
	arg_3_0.intimacyAddValueText = var_1(var_3_22, var_3_21(var_4))
	...
	arg_3_0.scrollRect = var_1(var_2.Find(var_3_28, "adapt/right/scrollRect"), "LScrollRect")
	...
	local var_3_31 = var_2.Find(var_3_30, "adapt/right/titlePanel/title/text")

	i18n = var_3_30

	var_1(var_3_31, var_3_30("ship_gift"))

	setText = var_1

	local var_3_32 = arg_3_0.giftBtn
	local var_3_33 = var_2.Find(var_3_32, "label")

	i18n = var_3_32

	var_1(var_3_33, var_3_32("ship_gift2"))
	...
	typeof = var_3
	Animation = var_4
	arg_3_0.anim = var_3_35(var_3_34, var_3(var_4))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10003(var_1_10004))
	...
	local function var_4_11()
		...
		if arg_4_0.selectIndex == nil then
			...
			var_8_1(var_8_0, var_2_10002("shipyard_gift_non_existent"))
		...
		if var_8_1.GetShipNeedIntimacyValue(arg_4_0.shipVO) == 0 then
			...
			if arg_4_0.shipVO.propose then
				...
				var_8_3(var_8_2, var_2_10003("shipyard_favorability_max"))
			else
				pg = var_8_3
				...
				var_8_5(var_8_4, var_2_10003("shipyard_favorability_threshold"))
			end
		...
		if arg_4_0.selectCnt == 0 then
			...
			var_8_7(var_8_6, var_2_10003("shipyard_gift_non_existent"))
		...
		if 0 < var_8_10 then
			...
			math = var_2_10011
			var_2_10008.content = var_2_10009(var_8_13, var_2_10011.floor(var_8_10 / 100))

			function var_2_10008.onYes()
				local var_9_0 = arg_4_0
				local var_9_1 = var_0.emit

				ShipGiftMediator = var_3_10002

				var_9_1(var_9_0, var_3_10002.SHIP_GIFT, var_8_9, var_8_8, arg_4_0.shipVO.id)

				return
			end

			var_8_12(var_8_11, var_2_10008)
		else
			local var_8_14 = arg_4_0
			local var_8_15 = var_6.emit

			ShipGiftMediator = var_2_10008

			var_8_15(var_8_14, var_2_10008.SHIP_GIFT, var_8_9, var_8_8, arg_4_0.shipVO.id)
		end
	...
	handler = var_4_9
	var_4_12.onInitItem = var_4_9(arg_4_0, arg_4_0.ScrollInit)
	...
	local var_4_21 = var_6.SELECT_ITEM

	handler = var_7
	var_4_18[1] = var_4_20(var_4_19, var_4_21, var_7(arg_4_0, arg_4_0.OnSelectItem))
	...
	handler = var_7
	var_4_18[2] = var_4_23(var_4_22, var_4_24, var_7(arg_4_0, arg_4_0.OnRefreshUseItemCnt))
...
function var_0_1.RefreshUI(arg_16_0)
	...
	var_1_10001(var_16_0, var_1_10003(var_16_1, var_5.getIntimacyIcon(var_16_2)), true)
	...
	var_3(arg_16_0.intimacyValueText, var_16_5)
...
function var_0_1.updatePreference(arg_17_0)
	...
	var_17_2(arg_17_0.shipName, var_17_3)

	setText = var_17_2

	var_17_2(arg_17_0.shipNameEn, var_17_1.english_name)

	local var_17_4 = arg_17_0.starts

	removeAllChildren = var_5
	...
	for iter_17_0 = 1, var_17_6 do
		...
		var_12(var_1_10011:Find("star_tpl"), iter_17_0 <= var_17_5)

		setActive = var_12

		var_12(var_1_10011:Find("empty_star_tpl"), true)
	end
...
function var_0_1.OnGiftSuccess(arg_18_0, arg_18_1)
	...
	if var_18_1 == var_5.GIFT_FAVORITE_STATE.HATE then
		...
		arg_18_0.displayShipWord(var_1_10006, "gift_dislike", true)
		...
		var_1_10006 = var_1_10006.GetChild(var_18_4, 0)

		local var_18_5 = arg_18_0.shipVO

		var_18_3(var_1_10006, var_7.getPainting(var_18_5), "gift_dislike")
	else
		var_1_10006 = arg_18_0

		arg_18_0.displayShipWord(var_1_10006, "gift_prefer", true)
		...
		var_1_10006 = var_1_10006.GetChild(var_18_7, 0)

		local var_18_8 = arg_18_0.shipVO

		var_18_6(var_1_10006, var_7.getPainting(var_18_8), "gift_prefer")
	end

	local var_18_9 = arg_18_0.selectCnt - arg_18_1

	ShipGiftTools = var_1_10006

	local var_18_10 = var_18_9 * var_1_10006.GetItemIntimacyValue(arg_18_0.shipVO, var_18_0)
	...
	if 0 < var_18_10 then
		...
		var_6(var_18_11, var_8.format("+%s", var_18_10 / 100))
	...
	if var_18_10 > 0 then
		...
		local var_18_14 = arg_18_0.emit

		ShipGiftMediator = var_8

		var_18_14(var_18_13, var_8.ADD_SHIP_INTIMACY, arg_18_0.shipVO, var_18_10)
	end

	local var_18_15 = arg_18_0.contextData.shipID

	getProxy = var_18_13
	BayProxy = var_8

	local var_18_16 = var_18_13(var_8)

	arg_18_0.shipVO = var_7.getShipById(var_18_16, var_18_15)
	ShipGiftTools = var_8
	...
	var_18_17(var_10.Find(var_18_19, "VX"), function(arg_21_0, arg_21_1)
...
function var_0_1.displayShipWord(arg_22_0, arg_22_1, arg_22_2)
	if arg_22_2 or not arg_22_0.chatFlag then
		...
		ShipWordHelper = var_22_1

		local var_22_3 = var_22_1.GetWordAndCV
		local var_22_4 = arg_22_0.shipVO
		local var_22_5, var_22_6, var_22_7 = var_22_3(var_5.getSkinId(var_22_4), arg_22_1, nil, nil, var_22_2)
		...
		if var_22_7 == "" then
			if arg_22_1 == "gift_dislike" then
				...
				i18n = var_22_8
				var_22_7 = var_22_9 .. var_22_8("gift_giving_dislike")
			else
				local var_22_10 = arg_22_0.shipVO
				local var_22_11 = var_7.getName(var_22_10)

				i18n = var_22_10
				var_22_7 = var_22_11 .. var_22_10("gift_giving_prefer")
			end
		end
		...
		local var_22_14 = var_22_13(var_22_12, var_9(var_1_10010))

		PLATFORM_CODE = var_22_12
		PLATFORM_US = var_22_15
		...
		if var_22_12 ~= var_22_15 then
			...
			var_22_12(var_22_15, var_1_10010(var_22_7))
		else
		...
		CHAT_POP_STR_LEN = var_22_15

		if var_22_15 < var_22_17 then
		...
		if var_22_14.preferredHeight + 120 > arg_22_0.initChatBgH then
			...
			Vector2 = var_1_10010
			var_22_18.sizeDelta = var_1_10010.New(arg_22_0.chatBg.sizeDelta.x, var_8)
		else
			local var_22_19 = arg_22_0.chatBg

			Vector2 = var_1_10010
			var_22_19.sizeDelta = var_1_10010.New(arg_22_0.chatBg.sizeDelta.x, arg_22_0.initChatBgH)
		end
		...
		local function var_22_21()
			...
			local var_23_2 = var_2_10002(arg_22_0.chat.gameObject)

			Vector3 = var_3

			local var_23_3 = var_23_1(var_23_2, var_3.New(1, 1, 1), var_0_2)
			local var_23_4 = var_1.setEase

			LeanTweenType = var_3

			local var_23_5 = var_23_4(var_23_3, var_3.easeOutBack)
			local var_23_6 = var_1.setOnComplete

			System = var_3
			var_23_0.chatani1Id = var_23_6(var_23_5, var_3.Action(function()
				...
				local var_24_2 = var_3_10002(arg_22_0.chat.gameObject)

				Vector3 = var_3

				local var_24_3 = var_24_1(var_24_2, var_3.New(0, 0, 1), var_0_2)
				local var_24_4 = var_1.setEase

				LeanTweenType = var_3

				local var_24_5 = var_24_4(var_24_3, var_3.easeInBack)
				local var_24_6 = var_1.setDelay(var_24_5, var_0_2 + var_22_20)
				local var_24_7 = var_1.setOnComplete

				System = var_3
				var_24_0.chatani2Id = var_24_7(var_24_6, var_3.Action(function()
...
function var_0_1.PlayAddValueAnimation(arg_29_0)
	...
	Vector2 = var_2
	var_29_0.localPosition = var_2(arg_29_0.intimacyAddValuePos.x, arg_29_0.intimacyAddValuePos.y)
	...
	local var_29_3 = var_29_2(var_29_1, var_3.moveY, nil, arg_29_0.intimacyAddValueText, arg_29_0.intimacyAddValuePos.y + 20, 0.35)
...
function var_0_1.ClickBackGift(arg_31_0)
	...
	local var_31_2 = var_2.GetChild(var_31_1, 0)
	local var_31_3 = arg_31_0.shipVO

	var_31_0(var_31_2, var_3.getPainting(var_31_3))
