...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.timelimitTxt = var_1_7(var_1_6, var_4(var_1_10005))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if var_2_2 ~= var_2_1.SKIN_TYPE_DEFAULT then
		if not arg_2_3 then
			::label_2_0::
...
function var_0_0.AddTimer(arg_3_0, arg_3_1)
	...
	if var_2.getSkinById(var_3_0, arg_3_1.id) then
		::label_3_0::

		var_3_1 = var_2

		if var_2.isExpireType(var_3_1) then
			var_3_1 = var_2
			var_3_2 = not var_2.isExpired(var_3_1)
		end
	end

	setActive = var_3_1

	var_3_1(arg_3_0.timelimitTF, var_3_2)
	arg_3_0:RemoveTimer()
	...
	if var_3_2 then
		...
		arg_3_0.timer = var_4.New(function()
			...
			var_4_0.text = var_2_10001(var_2.getRemainTime(var_4_1))
