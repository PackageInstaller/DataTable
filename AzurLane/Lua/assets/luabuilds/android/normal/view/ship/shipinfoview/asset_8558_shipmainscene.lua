...
function var_0_1.preload(arg_3_0, arg_3_1)
	...
	var_3_0({
		function(arg_4_0)
			...
			var_2_10001(var_4_0 .. var_3.rarity2bgPrintForGet(var_4_1), "", arg_4_0)
...
function var_0_1.setShip(arg_8_0, arg_8_1)
	...
	if var_8_1 then
		...
		if not var_8_9(var_8_8, var_6.currentPage) then
			triggerToggle = var_4
...
function var_0_1.setToggleEnable(arg_10_0)
	...
	var_1(var_10_0, var_3.isBluePrintShip(var_10_1))
	...
	var_1(var_10_2, var_3.isMetaShip(var_10_3))
					...
					if arg_11_1 == var_11_7.PAGE.REMOULD then
						...
						if arg_11_1 == var_11_11.PAGE.FASHION then
							if not arg_11_0:hasFashion() then
								...
								if not var_1_10004.IsPaintingNeedCheck() then
									var_11_12 = false
								else
									PaintingGroupConst = var_4

									local var_11_13 = var_4.GetPaintingNameListByShipVO(arg_11_0.shipVO)

									PaintingGroupConst = var_5
									var_11_12 = var_5.CalcPaintingListSize(var_11_13) > 0
								end

								return not var_11_12
							end
						else
							return false
						end
...
function var_0_1.init(arg_24_0)
	...
	arg_24_0.mainCanvasGroup = var_24_1(var_24_0, var_1_10003(var_1_10004))
	...
	typeof = var_3
	CanvasGroup = var_1_10004
	arg_24_0.commonCanvasGroup = var_24_4(var_24_3, var_3(var_1_10004))
	Input = var_1
...
function var_0_1.initShip(arg_25_0)
	...
	typeof = var_3
	Text = var_4
	arg_25_0.initfontSize = var_25_19(var_25_18, var_3(var_4)).fontSize
...
function var_0_1.initPages(arg_26_0)
	...
	typeof = var_3
	RectMask2D = var_1_10004
	arg_26_0.mainMask = var_26_3(var_26_2, var_3(var_1_10004))
	...
	ShipViewConst = var_26_11
	var_26_12[var_26_11.PAGE.DETAIL] = arg_26_0.detailToggle
		...
		if arg_26_0.shipVO.propose then
			...
			if not var_0.IsXIdol(var_27_0) then
				...
				if not var_0.isEnableShipName(var_27_1) then
					pg = var_0
					var_27_1 = var_0.TipsMgr.GetInstance()

					local var_27_2 = var_0.ShowTips

					i18n = var_2_10002

					var_27_2(var_27_1, var_2_10002("word_rename_switch_tip"))

					return
				end

				local var_27_3 = arg_26_0.shipVO.renameTime + 0

				pg = var_27_1

				local var_27_4 = var_27_1.TimeMgr.GetInstance()
				local var_27_5 = var_27_3 - var_1.GetServerTime(var_27_4)
				...
				if 0 < var_27_5 then
					...
					if var_1.floor(var_27_5 / 60 / 60 / 24) < 1 then
						var_27_6 = 1
					end

					pg = var_2

					local var_27_7 = var_2.TipsMgr.GetInstance()
					local var_27_8 = var_2.ShowTips

					i18n = var_2_10004

					var_27_8(var_27_7, var_2_10004("word_rename_time_tip", var_27_6))
				else
					local var_27_9 = arg_26_0

					var_1.DisplayRenamePanel(var_27_9, true)
				end
			end
		end
	...
	var_26_25(var_26_26, var_26_27, var_26_28, iter_26_1)
...
function var_0_1.initEvents(arg_28_0)
	...
	var_28_1(var_28_0, var_1_10003.SWITCH_TO_PAGE, function(arg_29_0, arg_29_1)
	...
	var_28_3(var_28_2, var_3.LOAD_PAINTING, function(arg_30_0, arg_30_1, arg_30_2)
	...
	var_28_5(var_28_4, var_3.LOAD_PAINTING_BG, function(arg_31_0, arg_31_1, arg_31_2, arg_31_3)
	...
	var_28_7(var_28_6, var_3.HIDE_SHIP_WORD, function(arg_32_0)
	...
	var_28_9(var_28_8, var_3.SET_CLICK_ENABLE, function(arg_33_0, arg_33_1)
	...
	var_28_11(var_28_10, var_3.SHOW_CUSTOM_MSG, function(arg_34_0, arg_34_1)
	...
	var_28_13(var_28_12, var_3.HIDE_CUSTOM_MSG, function(arg_35_0)
	...
	var_28_15(var_28_14, var_3.DISPLAY_HUNTING_RANGE, function(arg_36_0, arg_36_1)
		if arg_36_1 then
	...
	var_28_17(var_28_16, var_3.PAINT_VIEW, function(arg_37_0, arg_37_1)
		if arg_37_1 then
	...
	var_28_19(var_28_18, var_3.SHOW_EXP_ITEM_USAGE, function(arg_38_0, arg_38_1)
...
function var_0_1.didEnter(arg_39_0)
	...
	local var_39_2 = var_3.Find(var_39_1, "top/back_btn")
	...
	local function var_39_3()
		...
		var_2_10000(var_40_0, var_2_10002(var_2_10003)).interactable = false
		...
		if not arg_39_0.everTriggerBack then
			...
			var_40_1(var_40_2, var_2_10003.Action(function()
	...
	var_1(var_39_0, var_39_2, var_39_3, var_5)
	...
	local function var_39_6()
		...
		var_42_2.type = var_2_10003
		pg = var_2_10003
		var_42_2.helps = var_2_10003.gametip.help_shipinfo_actnpc.tip
	...
	var_1(var_39_4, var_39_5, var_39_6, var_5)
	...
	local function var_39_10()
		...
		var_43_1(var_43_0, var_2_10002.currentPage)
	...
	var_1(var_39_8, var_39_9, var_39_10, var_5)
		...
		if iter_39_1 == arg_39_0.upgradeToggle or iter_39_1 == arg_39_0.remouldToggle or iter_39_1 == arg_39_0.equipmentToggle then
			...
			local function var_39_13(arg_44_0)
				if arg_44_0 then
					...
					if var_44_0(var_2_10002(arg_39_0.chat)) then
						LeanTween = var_44_1
						var_44_1 = var_44_1.cancel
						go = var_2

						var_44_1(var_2(arg_39_0.chat))
					end
					...
					Vector3 = var_2
					var_44_2.localScale = var_2.New(0, 0, 1)
			...
			var_6(var_39_11, var_39_12, var_39_13, var_1_10010)
		else
			onToggle = var_6
			...
			var_6(var_39_14, var_39_15, var_39_16, var_1_10010)
		end
	end
	...
	local function var_39_19()
		...
		var_46_1(var_46_0, var_2_10002.ON_TECHNOLOGY, arg_39_0.shipVO)
	...
	var_1(var_39_17, var_39_18, var_39_19, iter_39_1)
	...
	local function var_39_22()
		...
		var_47_1(var_47_0, var_2_10002.ON_META, arg_39_0.shipVO)
	...
	var_1(var_39_20, var_39_21, var_39_22, iter_39_1)
	...
	if not arg_39_0:checkToggleActive(arg_39_0.contextData.page) or not arg_39_0.contextData.page then
		ShipViewConst = var_39_24
		var_39_24 = var_39_24.PAGE.DETAIL
	end

	local var_39_25 = arg_39_0

	arg_39_0.gotoPage(var_39_25, var_39_24)
	...
	if var_39_26 ~= var_39_25.PAGE.DETAIL then
		ShipViewConst = var_39_26

		if var_39_24 == var_39_26.PAGE.DETAIL then
...
function var_0_1.openHelpPage(arg_50_0, arg_50_1)
	...
	if arg_50_1 == var_1_10002.PAGE.EQUIPMENT then
		...
		var_50_2.type = var_1_10005
		pg = var_1_10005
		var_50_2.helps = var_1_10005.gametip.help_shipinfo_equip.tip
		...
		if arg_50_1 == var_50_1.PAGE.DETAIL then
			...
			MSGBOX_TYPE_HELP = var_1_10005
			var_50_5.type = var_1_10005
			pg = var_1_10005
			var_50_5.helps = var_1_10005.gametip.help_shipinfo_detail.tip
			...
			if arg_50_1 == var_50_4.PAGE.INTENSIFY then
				...
				MSGBOX_TYPE_HELP = var_1_10005
				var_50_8.type = var_1_10005
				pg = var_1_10005
				var_50_8.helps = var_1_10005.gametip.help_shipinfo_intensify.tip
				...
				if arg_50_1 == var_50_7.PAGE.UPGRADE then
					...
					MSGBOX_TYPE_HELP = var_1_10005
					var_50_11.type = var_1_10005
					pg = var_1_10005
					var_50_11.helps = var_1_10005.gametip.help_shipinfo_upgrate.tip
					...
					if arg_50_1 == var_50_10.PAGE.FASHION then
						...
						MSGBOX_TYPE_HELP = var_1_10005
						var_50_14.type = var_1_10005
						pg = var_1_10005
						var_50_14.helps = var_1_10005.gametip.help_shipinfo_fashion.tip
						...
						MSGBOX_TYPE_HELP = var_1_10005
						var_50_17.type = var_1_10005
						pg = var_1_10005
						var_50_17.helps = var_1_10005.gametip.help_shipinfo_maxlevel.tip
...
function var_0_1.showAwakenCompleteAni(arg_51_0, arg_51_1)
	...
	if var_3.Find(var_51_1, "AwakenCompleteWindows(Clone)") then
		go = var_51_1
		arg_51_0.awakenAni = var_51_1(var_3)
	end
...
function var_0_1.updatePreference(arg_56_0, arg_56_1)
	local var_56_0 = arg_56_1:getConfigTable()
	local var_56_1 = arg_56_0.shipVO
	local var_56_2 = var_3.getName(var_56_1)

	setScrollText = var_56_1

	local var_56_3 = arg_56_0.shipName

	var_56_1(var_5.Find(var_56_3, "nameRect/name_mask/Text"), var_56_2)

	setText = var_56_1

	local var_56_4 = arg_56_0.shipName

	var_56_1(var_5.Find(var_56_4, "english_name"), var_56_0.english_name)

	setActive = var_56_1

	local var_56_5 = arg_56_0.nameEditFlag
	local var_56_6

	if arg_56_1.propose then
		var_56_6 = not arg_56_1:IsXIdol()
	end

	var_56_1(var_56_5, var_56_6)

	GetSpriteFromAtlas = var_56_1

	if not var_56_1("energy", arg_56_1:getEnergyPrint()) then
		warning = var_5
	...
	var_5(arg_56_0.energyTF, var_4, true)

	setActive = var_5

	var_5(arg_56_0.energyTF, true)

	local var_56_7 = arg_56_0.shipName
	local var_56_8 = var_5.Find(var_56_7, "stars")

	removeAllChildren = var_56_7

	var_56_7(var_56_8)

	local var_56_9 = arg_56_1:getStar()
	local var_56_10 = arg_56_1:getMaxStar()

	for iter_56_0 = 1, var_56_10 do
		cloneTplTo = var_1_10012
		var_1_10012 = var_1_10012(arg_56_0.shipInfoStarTpl, var_56_8, "star_" .. iter_56_0)
		setActive = var_13

		var_13(var_1_10012:Find("star_tpl"), iter_56_0 <= var_56_9)

		setActive = var_13

		var_13(var_1_10012:Find("empty_star_tpl"), true)
	end

	ShipViewConst = var_8

	local var_56_11 = var_8.currentPage

	ShipViewConst = var_9

	if var_56_11 ~= var_9.PAGE.FASHION then
		local var_56_12 = arg_56_0

		var_56_11 = arg_56_0.loadPainting

		local var_56_13 = arg_56_0.shipVO

		var_56_11(var_56_12, var_10.getPainting(var_56_13))

		local var_56_14 = arg_56_0

		var_56_11 = arg_56_0.loadSkinBg

		local var_56_15 = arg_56_0.shipVO
		local var_56_16 = var_10.rarity2bgPrintForGet(var_56_15)
		local var_56_17 = arg_56_0.shipVO
		local var_56_18 = var_11.isBluePrintShip(var_56_17)
		local var_56_19 = arg_56_0.shipVO

		var_56_11(var_56_14, var_56_16, var_56_18, var_12.isMetaShip(var_56_19), arg_56_0.isSpBg)
	end

	GetSpriteFromAtlas = var_56_11

	if not var_56_11("shiptype", arg_56_1:getShipType()) then
		warning = var_9
	...
	local var_56_20 = arg_56_0.shipName

	var_9(var_10.Find(var_56_20, "type"), var_8, true)
		...
		if not arg_59_0.inPaintingView then
			if var_59_2 < -50 then
				if not arg_59_0.isLoading then
					...
					var_62_1(var_62_0, var_2_10004.NEXTSHIP, -1)
				end
			elseif var_59_2 > 50 and not arg_59_0.isLoading then
				...
				var_62_3(var_62_2, var_2_10004.NEXTSHIP)
			end
		end
...
function var_0_1.showEnergyDesc(arg_63_0)
	...
	var_3(var_63_3, var_1_10005(var_63_2))

	Timer = var_3
	arg_63_0.energyTimer = var_3.New(function()
...
function var_0_1.displayShipWord(arg_65_0, arg_65_1, arg_65_2)
	...
	if var_65_0 ~= var_1_10004.PAGE.EQUIPMENT then
		...
		if arg_65_2 or not arg_65_0.chatFlag then
			...
			local var_65_6 = var_65_4(arg_65_0.nowPainting, "fitter").childCount
			...
			if 0 < var_65_6 then
				...
				local var_65_7 = var_5(arg_65_0.nowPainting, "fitter")

				var_65_6(var_5.GetChild(var_65_7, 0), arg_65_0.paintingCode, arg_65_1, var_65_5)
			end
			...
			local var_65_10, var_65_11, var_65_12 = var_65_8(var_5.getSkinId(var_65_9), arg_65_1, nil, nil, var_65_5)
			...
			local var_65_15 = var_65_14(var_65_13, var_9(var_1_10010))

			PLATFORM_CODE = var_65_13
			PLATFORM_US = var_65_16

			local var_65_16

			if var_65_13 ~= var_65_16 then
				setText = var_65_13
				var_65_16 = arg_65_0.chatText
				SwitchSpecialChar = var_1_10010

				var_65_13(var_65_16, var_1_10010(var_65_12))
			else
			...
			CHAT_POP_STR_LEN = var_65_16

			if var_65_16 < var_65_18 then
			...
			if var_65_15.preferredHeight + 120 > arg_65_0.initChatBgH then
				...
				Vector2 = var_1_10010
				var_65_19.sizeDelta = var_1_10010.New(arg_65_0.chatBg.sizeDelta.x, var_8)
			else
				local var_65_20 = arg_65_0.chatBg

				Vector2 = var_1_10010
				var_65_20.sizeDelta = var_1_10010.New(arg_65_0.chatBg.sizeDelta.x, arg_65_0.initChatBgH)
			end
			...
			local function var_65_22()
				...
				local var_66_2 = var_2_10002(arg_65_0.chat.gameObject)

				Vector3 = var_3

				local var_66_3 = var_66_1(var_66_2, var_3.New(1, 1, 1), var_0_4)
				local var_66_4 = var_1.setEase

				LeanTweenType = var_3

				local var_66_5 = var_66_4(var_66_3, var_3.easeOutBack)
				local var_66_6 = var_1.setOnComplete

				System = var_3
				var_66_0.chatani1Id = var_66_6(var_66_5, var_3.Action(function()
					...
					local var_67_2 = var_3_10002(arg_65_0.chat.gameObject)

					Vector3 = var_3

					local var_67_3 = var_67_1(var_67_2, var_3.New(0, 0, 1), var_0_4)
					local var_67_4 = var_1.setEase

					LeanTweenType = var_3

					local var_67_5 = var_67_4(var_67_3, var_3.easeInBack)
					local var_67_6 = var_1.setDelay(var_67_5, var_0_4 + var_65_21)
					local var_67_7 = var_1.setOnComplete

					System = var_3
					var_67_0.chatani2Id = var_67_7(var_67_6, var_3.Action(function()
...
function var_0_1.startChatTimer(arg_71_0)
	...
	arg_71_0.chatTimer = var_1.New(function()
		...
		var_72_1(var_72_0, var_2.getInitmacyWords(var_72_2))
...
function var_0_1.hideShipWord(arg_73_0)
	if arg_73_0.chatFlag then
		...
		local var_73_1 = var_1_10002(arg_73_0.chat.gameObject)

		Vector3 = var_3

		local var_73_2 = var_73_0(var_73_1, var_3.New(0, 0, 1), var_0_4)
		...
		var_73_5(var_73_4, var_3.Action(function()
...
function var_0_1.switchToPage(arg_77_0, arg_77_1, arg_77_2)
	local function var_77_0(arg_78_0, arg_78_1)
		...
		if arg_78_0 == var_2_10002.PAGE.DETAIL then
			...
			shiftPanel = var_78_3
			var_78_1 = var_78_3(arg_77_0.detailContainer, var_78_0[2], 0, var_0_3, 0)

			var_78_3.setFrom(var_78_1, var_78_0[1])
		else
			ShipViewConst = var_78_0

			local var_78_2, var_78_3
			...
			if arg_78_0 == var_78_0.PAGE.EQUIPMENT then
				...
				var_2_10006 = arg_78_1 and 2 or 1
				shiftPanel = var_2_10007

				local var_78_5 = var_2_10007(arg_77_0.equipLCon, var_78_2[var_2_10006], 0, var_0_3, 0)

				var_7.setFrom(var_78_5, var_78_2[var_78_4])

				shiftPanel = var_7

				local var_78_6 = var_7(arg_77_0.equipRCon, var_78_3[var_2_10006], 0, var_0_3, 0)

				var_7.setFrom(var_78_6, var_78_3[var_78_4])

				shiftPanel = var_7

				local var_78_7 = var_7(arg_77_0.equipBCon, 0, var_78_1[var_2_10006], var_0_3, 0)

				var_7.setFrom(var_78_7, var_78_1[var_78_4])
			else
				...
				if arg_78_0 == var_78_2.PAGE.FASHION then
					...
					shiftPanel = var_78_3
					var_78_1 = var_78_3(arg_77_0.fashionContainer, var_78_8[2], 0, var_0_3, 0)
		...
		if arg_78_0 ~= var_2.PAGE.FASHION then
			...
			local var_78_23 = arg_77_0.shipVO

			var_78_20(var_78_22, var_4.getPainting(var_78_23))
		end

		ShipViewConst = var_78_20

		local var_78_24 = not var_78_20.IsSubLayerPage(arg_78_0)
		local var_78_25 = arg_77_0.bgEffect
		local var_78_26 = arg_77_0.shipVO

		if var_78_25[var_4.getRarity(var_78_26)] then
			setActive = var_4

			local var_78_27 = var_3

			ShipViewConst = var_2_10006

			if arg_78_0 ~= var_2_10006.PAGE.REMOULD then
				local var_78_28
				...
				var_4(var_78_27, var_78_28)

				local var_78_29 = arg_77_0

				var_4.changePaintingSortLayer(var_78_29, true)

				setActive = var_4

				var_4(arg_77_0.helpBtn, var_78_24)
		...
		if var_79_0 == var_2_10001.currentPage and arg_77_2 then
			...
			if var_79_1 ~= var_1.currentPage then
				...
				if var_79_1.currentPage then
					...
					var_79_2(var_1.currentPage, false)
				end
	...
	if arg_77_0.viewList[arg_77_1] ~= nil then
		...
		if not var_4.GetLoaded(var_77_3) then
			...
			switchHandler = var_1_10007

			var_77_5(var_77_4, var_1_10007)
		else
...
function var_0_1.switchPainting(arg_81_0)
	...
	local var_81_1 = var_1_10003.IsSubLayerPage

	ShipViewConst = var_1_10004

	var_1_10001(var_81_0, not var_81_1(var_1_10004.currentPage))
	...
	local var_81_3 = var_3.IsSubLayerPage

	ShipViewConst = var_4

	var_1_10001(var_81_2, not var_81_3(var_4.currentPage))

	ShipViewConst = var_1_10001

	local var_81_4 = var_1_10001.currentPage

	ShipViewConst = var_81_2

	if var_81_4 == var_81_2.PAGE.EQUIPMENT then
		shiftPanel = var_81_4
	...
	local var_81_5 = var_81_4(var_2(arg_81_0.nowPainting, "fitter"), "PaintingScaler")
	...
	local var_81_9 = var_81_8(var_81_7, var_4.Action_float(function(arg_82_0)
	...
	local var_81_11 = var_81_10(var_81_9, var_4.easeInOutSine)
...
function var_0_1.loadPainting(arg_84_0, arg_84_1, arg_84_2)
	...
	if var_84_3 then
		...
		iter_84_1.insert(var_84_5, function(arg_85_0)
			local var_85_0 = var_84_3
			local var_85_1 = var_1.GetComponent

			typeof = var_2_10003
			RectTransform = var_2_10004

			local var_85_2 = var_85_1(var_85_0, var_2_10003(var_2_10004))
			...
			local var_85_5 = var_85_4(var_85_3, var_2_10004(var_2_10005))

			LeanTween = var_85_3

			local var_85_6 = var_85_3.cancel

			go = var_4

			var_85_6(var_4(var_85_5))
			...
			var_85_11(var_85_10, var_5.Action(function()
	...
	local var_84_6 = arg_84_0:getPaintingFromTable(true)

	arg_84_0.paintingCode = arg_84_1

	local var_84_8

	if arg_84_0.paintingCode and var_84_6 then
		local var_84_7 = var_84_6

		var_84_8 = var_84_6.GetComponent
		typeof = var_1_10011
		RectTransform = var_1_10012
		var_84_8 = var_84_8(var_84_7, var_1_10011(var_1_10012))
		table = var_84_7

		var_84_7.insert(var_84_5, function(arg_87_0)
			local var_87_0 = arg_84_0

			var_87_0.nowPainting = var_84_6
			LoadPaintingPrefabAsync = var_87_0

			local var_87_1 = var_84_6
			...
			var_87_0(var_87_1, var_87_2, var_87_3, var_87_4, function()
				...
				ShipExpressionHelper = var_88_2

				local var_88_4 = var_88_2.SetExpression

				findTF = var_3_10003

				local var_88_5 = var_3_10003(var_84_6, "fitter")

				var_88_4(var_3.GetChild(var_88_5, 0), arg_84_0.paintingCode, var_88_3, var_88_1)
				arg_87_0()
		...
		var_10.insert(var_84_5, function(arg_89_0)
			...
			var_89_0(var_2_10002(var_84_8))

			LeanTween = var_89_0

			local var_89_1 = var_89_0.moveX(var_84_8, 0, 0.3)
			local var_89_2 = var_1.setFrom(var_89_1, var_84_2)
			local var_89_3 = var_1.setOnComplete

			System = var_3

			var_89_3(var_89_2, var_3.Action(arg_89_0))

			local var_89_4 = var_84_6
			local var_89_5 = var_1.GetComponent

			typeof = var_3
			CanvasGroup = var_4

			local var_89_6 = var_89_5(var_89_4, var_3(var_4))

			LeanTween = var_89_4

			local var_89_7 = var_89_4.alphaCanvas(var_89_6, 1, 0.3)
	...
	parallelAsync = var_84_8

	var_84_8(var_84_5, function()
	...
	if arg_92_0.shipSkinBg ~= arg_92_1 or arg_92_0.isDesign ~= arg_92_2 or arg_92_0.isMeta ~= arg_92_3 then
		...
		if arg_92_0.isDesign then
			...
			if not arg_92_0.designBg then
				...
				var_92_0(var_92_4, var_92_5 .. var_8.getRarity(var_92_6), true, function(arg_93_0)
					...
					Vector3 = var_93_3
					var_93_4.localPosition = var_93_3(1, 1, 1)
		...
		elseif arg_92_0.isMeta then
			...
			if not arg_92_0.metaBg then
				...
				var_92_0(var_92_10, var_92_11 .. var_8.getRarity(var_92_12), true, function(arg_94_0)
					...
					Vector3 = var_94_3
					var_94_4.localPosition = var_94_3(1, 1, 1)
			...
			for iter_92_2 = 1, 5 do
				...
				if arg_92_0.bgEffect[iter_92_2] then
					...
					if iter_92_2 == var_92_14 then
						ShipViewConst = var_1_10012
						var_1_10012 = var_1_10012.currentPage
						ShipViewConst = var_1_10013

						if var_1_10012 ~= var_1_10013.PAGE.REMOULD then
							var_1_10012 = not arg_92_4
				...
				elseif 2 < var_92_14 and var_92_14 == iter_92_2 and not arg_92_4 then
					...
					var_10.GetUI(var_92_16, "al_bg02_" .. var_92_14 - 1, true, function(arg_95_0)
						...
						Vector3 = var_95_0
						var_95_1.localPosition = var_95_0(0, 0, 0)
						...
						local var_95_5 = var_3.IsSubLayerPage

						ShipViewConst = var_4

						var_1(var_95_4, not var_95_5(var_4.currentPage))
...
function var_0_1.changePaintingSortLayer(arg_97_0, arg_97_1)
	...
	for iter_97_0, iter_97_1 in var_1_10003(arg_97_0.tablePainting) do
		...
		typeof = var_1_10010
		Canvas = var_1_10011
		var_1_10008 = var_1_10008(var_97_2, var_1_10010(var_1_10011))
...
function var_0_1.getInitmacyWords(arg_98_0)
	...
	local var_98_2 = var_98_0.Clamp(var_98_1, 1, 5)
...
function var_0_1.paintView(arg_99_0)
	...
	if var_1_10001.isTweening(arg_99_0.chat.gameObject) then
		...
		Vector3 = var_2
		var_99_0.localScale = var_2(0, 0, 0)
	...
	var_4(var_5.playerResUI._go, false)
	...
	local var_99_24 = var_16(arg_99_0.background, "EventTriggerListener")
	...
	var_99_24:AddDragFunc(function(arg_103_0, arg_103_1)
		...
		if var_99_25 then
			...
			local var_103_1 = var_3(arg_99_0.nowPainting)
	...
	var_19(var_99_27, var_99_28, var_99_29, var_1_10023)
	...
	function var_99_30.hidePaintView(arg_105_0, arg_105_1)
		...
		var_2(var_3.playerResUI._go, true)
	...
	var_99_32(var_99_31, var_22.Action(function()
...
function var_0_1.onBackPressed(arg_107_0)
	...
	var_107_7(var_107_6, var_1_10003)

	triggerButton = var_107_7

	local var_107_8 = arg_107_0.common

	var_107_7(var_2.Find(var_107_8, "top/back_btn"))
...
function var_0_1.willExit(arg_108_0)
	...
	var_108_1(var_108_0, var_3.currentPage)
	...
	if arg_108_0.paintingCode then
		for iter_108_0 = 1, #arg_108_0.tablePainting do
			go = var_1_10005
			var_1_10005 = var_1_10005(arg_108_0.tablePainting[iter_108_0])
			LeanTween = var_6

			if var_6.isTweening(var_1_10005) then
				LeanTween = var_6

				local var_108_8 = var_6.cancel

				go = var_7

				var_108_8(var_7(var_1_10005))
			end
		end
...
function var_0_1.checkPaintingRes(arg_111_0, arg_111_1)
	...
	var_1_10004.PaintingDownload(var_111_1)
