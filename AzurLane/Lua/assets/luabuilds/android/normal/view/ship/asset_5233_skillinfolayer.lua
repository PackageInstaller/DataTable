...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_12, var_2_11("meta_skillbtn_tactics"))

	setText = var_1

	local var_2_13 = arg_2_0._tf
	local var_2_14 = var_2.Find(var_2_13, "panel/top/title_list/infomation/title")

	i18n = var_2_13

	var_1(var_2_14, var_2_13("words_information"))

	setText = var_1

	local var_2_15 = arg_2_0.buttonList
	local var_2_16 = var_2.Find(var_2_15, "ok_button/Image")

	i18n = var_2_15

	var_1(var_2_16, var_2_15("text_confirm"))

	PLATFORM_CODE = var_1
	PLATFORM_JP = var_2_16

	if var_1 == var_2_16 then
		setText = var_1

		local var_2_17 = arg_2_0.buttonList
		local var_2_18 = var_2.Find(var_2_17, "level_button/Image")

		i18n = var_2_17

		var_1(var_2_18, var_2_17("msgbox_text_noPos_intensify"))
	else
		setText = var_1

		local var_2_19 = arg_2_0.buttonList
		local var_2_20 = var_2.Find(var_2_19, "level_button/Image")

		i18n = var_2_19

		var_1(var_2_20, var_2_19("msgbox_text_upgrade"))
	end
...
function var_0_1.didEnter(arg_3_0)
	...
	local var_3_8 = var_3.Find(var_3_7, "panel/buttonList/ok_button")
	...
	local function var_3_12()
		...
		SkillInfoMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.WARP_TO_TACTIC)
	...
	local function var_3_15()
		...
		if var_8_0 then
			...
			local var_8_3 = var_2_10003(var_2_10004)
		...
		if var_8_1 then
			...
			SkillInfoMediator = var_2_10005

			var_8_6(var_8_5, var_2_10005.WARP_TO_META_TACTICS, var_8_2.configId)
		end
	...
	var_1_10001(var_3_19, var_3_20, var_3_21, var_5)
...
function var_0_1.showBase(arg_12_0)
	...
	var_1_10003(var_12_2, var_1_10005(var_12_0))
	...
	var_4("skillicon/" .. var_12_3.icon, arg_12_0.skillInfoIcon)
	...
	if var_12_5 then
		...
		local var_12_8 = var_1_10008(var_1_10009)
		local var_12_9 = var_1_10008.getShipById(var_12_8, arg_12_0.contextData.shipId)
	...
	local var_12_10 = var_1_10008.isMetaTaskSkillID(var_12_0)

	setActive = var_9

	var_9(arg_12_0.metaBtn, var_12_6 and var_12_10)

	if var_12_6 then
		setActive = var_9

		var_9(arg_12_0.upgradeBtn, false)
	end
...
function var_0_1.showInfo(arg_13_0, arg_13_1)
	...
	if arg_13_0.contextData.fromNewShip then
		...
		getSkillDescGet = var_7

		var_5(var_13_2, var_7(var_13_0, arg_13_1))
	else
		setText = var_5
		...
		var_5(var_13_3, var_7(var_13_0, var_13_1, arg_13_1))
	end
...
function var_0_1.inOutAnim(arg_16_0, arg_16_1, arg_16_2)
	if arg_16_1 then
		...
		local var_16_3 = var_16_2(var_16_1, var_1_10006(var_1_10007))
		...
		local var_16_11 = var_16_10(var_16_9, var_1_10010(var_1_10011))
		...
		local var_16_15 = var_16_14(var_16_13, var_1_10012(var_1_10013))
		...
		local var_16_19 = var_16_18(var_16_17, var_1_10014(var_1_10015))
