...
function var_0_1.InitDetail(arg_3_0)
	...
	local var_3_30 = var_2.Find(var_3_29, "fillter/on/text2")

	i18n = var_3_29

	var_1(var_3_30, var_3_29("quick_equip_tip2"))

	setText = var_1

	local var_3_31 = arg_3_0.quickPanel
	local var_3_32 = var_2.Find(var_3_31, "fillter/off/text2")

	i18n = var_3_31

	var_1(var_3_32, var_3_31("quick_equip_tip2"))

	setText = var_1

	local var_3_33 = arg_3_0.quickPanel
	local var_3_34 = var_2.Find(var_3_33, "equiping/on/text2")

	i18n = var_3_33

	var_1(var_3_34, var_3_33("quick_equip_tip1"))

	setText = var_1

	local var_3_35 = arg_3_0.quickPanel
	local var_3_36 = var_2.Find(var_3_35, "equiping/off/text2")

	i18n = var_3_35

	var_1(var_3_36, var_3_35("quick_equip_tip1"))

	setText = var_1

	local var_3_37 = arg_3_0.quickPanel
	local var_3_38 = var_2.Find(var_3_37, "title/text")

	i18n = var_3_37

	var_1(var_3_38, var_3_37("quick_equip_tip3"))

	setText = var_1

	local var_3_39 = arg_3_0.quickPanel
	local var_3_40 = var_2.Find(var_3_39, "frame/emptyTitle/text")

	i18n = var_3_39

	var_1(var_3_40, var_3_39("quick_equip_tip4"))

	setText = var_1

	local var_3_41 = arg_3_0.quickPanel
	local var_3_42 = var_2.Find(var_3_41, "frame/selectTitle/text")

	i18n = var_3_41

	var_1(var_3_42, var_3_41("quick_equip_tip5"))

	setText = var_1

	local var_3_43 = arg_3_0.randomFlagToggle
	local var_3_44 = var_2.Find(var_3_43, "bg/Text")

	i18n = var_3_43

	var_1(var_3_44, var_3_43("ship_random_secretary_tag"))
	...
	local var_3_60 = var_2.CreateData
	local var_3_61 = {
		uiName = "RecordableSearchBarUI4ShipDetailView"
	}

	i18n = var_4
	var_3_61.holder = var_4("search_equipment")
	...
	Vector3 = var_4
	var_3_61.anchoredPosition = var_4(-623, -34, 0)
...
function var_0_1.InitEvent(arg_6_0)
	...
	local function var_6_2()
		...
		local var_7_2 = var_2_10002.SWITCH_TO_PAGE

		ShipViewConst = var_2_10003

		var_7_1(var_7_0, var_7_2, var_2_10003.PAGE.FASHION)
	...
	var_1_10001(arg_6_0, arg_6_0.propertyIcons, function()
		...
		pg = var_2_10003
		var_8_2.helps = var_2_10003.gametip.help_shipinfo_attr.tip
	...
	local function var_6_5(arg_10_0)
		...
		if var_10_1 == var_10_0.PREFERENCE_TAG_COMMON ~= arg_10_0 then
			Ship = var_2_10003

			local var_10_2

			if var_10_1 == var_2_10003.PREFERENCE_TAG_COMMON then
				Ship = var_3
			...
			local var_10_5 = var_2_10005.ON_TAG
			local var_10_6 = arg_6_0

			var_10_4(var_10_3, var_10_5, var_6.GetShipVO(var_10_6).id, var_10_2)
		end
	...
	local function var_6_8(arg_11_0)
		...
		if var_1.getRandomFlag(var_11_1) ~= arg_11_0 then
			...
			local var_11_4 = var_2_10004.CHANGE_RANDOM_FLAG
			local var_11_5 = arg_6_0
			local var_11_6 = var_5.GetShipVO(var_11_5)

			var_11_3(var_11_2, var_11_4, var_5.GetShipPhantomMark(var_11_6), arg_11_0)
		end
	...
	local function var_6_11()
		...
		local var_12_2 = var_2_10002.ON_LOCK
		local var_12_3 = {}
		local var_12_4 = arg_6_0

		var_12_3[1] = var_4.GetShipVO(var_12_4).id

		local var_12_5 = arg_6_0

		var_12_1(var_12_0, var_12_2, var_12_3, var_4.GetShipVO(var_12_5).LOCK_STATE_LOCK)
	...
	local function var_6_14()
		...
		local var_13_2 = var_2_10002.ON_LOCK
		local var_13_3 = {}
		local var_13_4 = arg_6_0

		var_13_3[1] = var_4.GetShipVO(var_13_4).id

		local var_13_5 = arg_6_0

		var_13_1(var_13_0, var_13_2, var_13_3, var_4.GetShipVO(var_13_5).LOCK_STATE_UNLOCK)
	...
	local function var_6_17()
		...
		var_14_1(var_14_0, var_2_10002.PAINT_VIEW, true)
	...
	local function var_6_20()
		...
		local var_15_2 = var_2_10002.OPEN_EVALUATION
		local var_15_3 = arg_6_0
		local var_15_4 = var_3.GetShipVO(var_15_3)
		local var_15_5 = var_3.getGroupId(var_15_4)
		local var_15_6 = arg_6_0
		local var_15_7 = var_4.GetShipVO(var_15_6)

		var_15_1(var_15_0, var_15_2, var_15_5, var_4.isActivityNpc(var_15_7))
	...
	var_1_10001(var_6_18, var_6_19, var_6_20, var_1_10005)
	...
	local function var_6_23()
		...
		local var_16_2 = var_2_10002.OPEN_SHIPPROFILE
		local var_16_3 = arg_6_0
		local var_16_4 = var_3.GetShipVO(var_16_3)
		local var_16_5 = var_3.getGroupId(var_16_4)
		local var_16_6 = arg_6_0
		local var_16_7 = var_4.GetShipVO(var_16_6)

		var_16_1(var_16_0, var_16_2, var_16_5, var_4.isRemoulded(var_16_7))
	...
	var_1_10001(var_6_21, var_6_22, var_6_23, var_1_10005)
	...
	var_1_10001(arg_6_0, arg_6_0.intimacyTF, function()
		...
		if var_0.isActivityNpc(var_17_1) then
			...
			var_17_3(var_17_2, var_2_10002("npc_propse_tip"))
		...
		local var_17_6 = var_2_10002.PROPOSE
		local var_17_7 = arg_6_0

		var_17_5(var_17_4, var_17_6, var_3.GetShipVO(var_17_7).id, function()
			return
		end)
	...
	local function var_6_26(arg_19_0)
		...
		local var_19_3, var_19_4 = var_19_0(var_19_1, var_3.GetShipVO(var_19_2))

		if not var_19_3 then
			if arg_19_0 then
				pg = var_3

				local var_19_5 = var_3.TipsMgr.GetInstance()
	...
	var_1_10001(var_6_24, var_6_25, var_6_26, var_1_10005)
	...
	local function var_6_29(arg_21_0)
		...
		local var_21_3, var_21_4 = var_21_0(var_21_1, var_3.GetShipVO(var_21_2))

		if not var_21_3 then
			if arg_21_0 then
				pg = var_3

				local var_21_5 = var_3.TipsMgr.GetInstance()
	...
	var_1_10001(var_6_27, var_6_28, var_6_29, var_1_10005)
	...
	local function var_6_32()
		...
		var_23_1(var_23_0, var_2_10002.OPEN_EQUIP_CODE, {})
	...
	var_1_10001(var_6_30, var_6_31, var_6_32, var_1_10005)
	...
	local function var_6_35()
		...
		var_24_3(var_24_2, var_2_10003.OPEN_EQUIP_CODE_SHARE, var_24_1.id, var_24_1:getGroupId())
	...
	var_1_10001(var_6_33, var_6_34, var_6_35, var_1_10005)
	...
	local function var_6_38()
		...
		local var_25_3, var_25_4 = var_25_0(var_25_1, var_2.GetShipVO(var_25_2))

		if not var_25_3 then
			pg = var_2

			local var_25_5 = var_2.TipsMgr.GetInstance()

			var_2.ShowTips(var_25_5, var_25_4)
		else
			pg = var_2

			local var_25_6 = var_2.MsgboxMgr.GetInstance()
			local var_25_7 = var_2.ShowMsgBox
			local var_25_8 = {}

			i18n = var_2_10005
			var_25_8.content = var_2_10005("ship_unequip_all_tip")
			...
			function var_25_8.onYes()
				...
				local var_26_2 = var_3_10002.UNEQUIP_FROM_SHIP_ALL
				local var_26_3 = arg_6_0

				var_26_1(var_26_0, var_26_2, var_3.GetShipVO(var_26_3).id)
	...
	var_1_10001(var_6_36, var_6_37, var_6_38, var_1_10005)
	...
	function var_6_39.onUpdateItem(arg_29_0, arg_29_1)
		...
		var_2_10002(var_2_10003(var_2_10004(arg_29_1), "IconTpl/icon_bg/icon"), false)

		TweenItemAlphaAndWhite = var_2_10002

		var_2_10002(arg_29_1)

		local var_29_0, var_29_1
		...
		if arg_29_0 == 0 and not arg_6_0.selectedEquip.empty then
			...
			var_2_10002(var_29_0(var_29_1(arg_29_1), "unEquip"), true)

			setActive = var_2_10002
			findTF = var_29_0
			tf = var_29_1

			var_2_10002(var_29_0(var_29_1(arg_29_1), "bg"), false)

			setActive = var_2_10002
			findTF = var_29_0
			tf = var_29_1

			var_2_10002(var_29_0(var_29_1(arg_29_1), "IconTpl"), false)
			...
			local function var_29_2()
				...
				ShipMainMediator = var_3_10007

				var_30_7(var_30_6, var_3_10007.UNEQUIP_FROM_SHIP, {
					shipId = var_1.id,
					pos = var_30_0
				})
			...
			var_2_10002(var_29_0, var_29_1, var_29_2, var_2_10006)
		else
			setActive = var_2_10002
			findTF = var_29_0
			tf = var_29_1

			var_2_10002(var_29_0(var_29_1(arg_29_1), "unEquip"), false)

			setActive = var_2_10002
			findTF = var_3
			tf = var_4

			var_2_10002(var_3(var_4(arg_29_1), "bg"), true)

			setActive = var_2_10002
			findTF = var_3
			tf = var_4

			var_2_10002(var_3(var_4(arg_29_1), "IconTpl"), true)
			...
			var_4(var_5(var_2_10006(arg_29_1), "IconTpl/icon_bg/icon"), true)

			updateEquipment = var_4
			findTF = var_5
			tf = var_6

			var_4(var_5(var_6(arg_29_1), "IconTpl"), var_3)

			local var_29_4, var_29_5, var_29_6
			...
			if var_3.shipId then
				...
				setImageSprite = var_29_4
				findTF = var_29_6
				tf = var_7
				var_29_6 = var_29_6(var_7(arg_29_1), "IconTpl/icon_bg/equip_flag/Image")
				LoadSprite = var_7

				var_29_4(var_29_6, var_7("qicon/" .. var_29_5:getPainting()))
			end
			...
			local var_29_7 = var_29_4(var_29_6(arg_29_1), "IconTpl/icon_bg/equip_flag")
			local var_29_8

			if var_3.shipId then
				var_29_8 = var_3.shipId > 0
			end
			...
			var_29_5(var_29_7(var_29_8(arg_29_1), "IconTpl/mask"), var_3.mask)

			onButton = var_29_5

			local var_29_9 = arg_6_0

			tf = var_6

			local var_29_10 = var_6(arg_29_1)
			...
			var_29_5(var_29_9, var_29_10, var_29_11, var_2_10008)
		end
	...
	var_6_39(var_6_40, var_6_41, var_6_42, var_1_10005)
	...
	local function var_6_45()
		...
		if not var_0_1.EQUIPMENT_INDEX then
			...
			var_33_2.EQUIPMENT_INDEX = var_33_1(var_2_10002.EQUIPMENT_INDEX_COMMON)
			table = var_33_2
			...
			var_33_2(var_33_3, var_2_10002.EquipmentExtraEquiping)
		...
		Clone = var_2_10002
		var_33_4.indexDatas = var_2_10002(arg_6_0.indexData)
		...
		function var_33_4.callback(arg_34_0)
			...
			var_34_4(var_3(arg_6_0.fillter, "on"), not var_34_5)

			setActive = var_34_4
			findTF = var_3

			var_34_4(var_3(arg_6_0.fillter, "off"), var_34_5)
		...
		var_33_7(var_33_6, var_3.OPEN_EQUIPMENT_INDEX, var_33_5)
	...
	var_6_39(var_6_43, var_6_44, var_6_45, var_1_10005)
...
function var_0_1.changeEquip(arg_36_0, arg_36_1)
	...
	local var_36_1 = arg_36_0:GetShipVO()
	local var_36_2 = {
		quickFlag = true
	}

	EquipmentInfoMediator = var_1_10005
	var_36_2.type = var_1_10005.TYPE_REPLACE
	var_36_2.equipmentId = arg_36_1.id
	var_36_2.shipId = var_36_1.id
	var_36_2.pos = var_36_0
	var_36_2.oldShipId = arg_36_1.shipId
	var_36_2.oldPos = arg_36_1.shipPos
	...
	if var_36_2 then
		...
		if var_5.GetInt("QUICK_CHANGE_EQUIP", 1) == 1 then
			...
			local var_36_4 = arg_36_0.emit

			BaseUI = var_7

			var_36_4(var_36_3, var_7.ON_EQUIPMENT, var_36_2)
		else
			local var_36_5, var_36_6 = var_36_1:canEquipAtPos(arg_36_1, var_36_0)
			local var_36_7

			if not var_36_5 then
				pg = var_7
				var_36_7 = var_7.TipsMgr.GetInstance()

				local var_36_8 = var_7.ShowTips

				i18n = var_1_10009

				var_36_8(var_36_7, var_1_10009("equipment_equipmentInfoLayer_error_canNotEquip", var_36_6))
			...
			if arg_36_1.shipId then
				getProxy = var_7
				BayProxy = var_36_7
				var_1_10009 = var_7(var_36_7)

				local var_36_9 = var_7.getShipById(var_1_10009, arg_36_1.shipId)

				ShipStatus = var_1_10009

				local var_36_10

				var_1_10009, var_36_10 = var_1_10009.ShipStatusCheck("onModify", var_36_9)

				if not var_1_10009 then
					pg = var_1_10011

					local var_36_11 = var_1_10011.TipsMgr.GetInstance()

					var_1_10011.ShowTips(var_36_11, var_36_10)
				else
					local var_36_12 = arg_36_0

					var_1_10011 = arg_36_0.emit
					ShipMainMediator = var_1_10013

					local var_36_13 = var_1_10013.EQUIP_CHANGE_NOTICE
					local var_36_14 = {}

					GAME = var_1_10015
					var_36_14.notice = var_1_10015.EQUIP_FROM_SHIP
					var_36_14.data = var_36_2

					var_1_10011(var_36_12, var_36_13, var_36_14)
				end
			else
				local var_36_15 = arg_36_0
				local var_36_16 = arg_36_0.emit

				ShipMainMediator = var_1_10009

				local var_36_17 = var_1_10009.EQUIP_CHANGE_NOTICE
				local var_36_18 = {}

				GAME = var_1_10011
				var_36_18.notice = var_1_10011.EQUIP_TO_SHIP
				var_36_18.data = var_36_2

				var_36_16(var_36_15, var_36_17, var_36_18)
			end
		end
	end
...
function var_0_1.OnSelected(arg_39_0, arg_39_1)
	if arg_39_1 then
		...
		var_39_4[1] = var_7.Find(var_39_5, "attrs")

		local var_39_6 = arg_39_0.detailPanel

		var_39_4[2] = var_7.Find(var_39_6, "equipments")

		local var_39_7 = arg_39_0.detailPanel

		var_39_4[3] = var_7.Find(var_39_7, "quick_panel")
...
function var_0_1.UpdateIntimacy(arg_41_0, arg_41_1)
	...
	LOCK_PROPOSE = var_1_10004

	var_1_10002(var_41_0, not var_1_10004)
...
function var_0_1.UpdateDetail(arg_42_0, arg_42_1)
	...
	removeOnButton = var_42_1

	var_42_1(var_42_2)

	table = var_42_1

	local var_42_3 = var_42_1.contains

	ShipType = var_4

	if var_42_3(var_4.SubShipType, arg_42_1:getShipType()) then
		onButton = var_3
		...
		local function var_42_6()
			...
			var_43_1(var_43_0, var_2_10002.DISPLAY_HUNTING_RANGE, true)
		...
		var_3(var_42_4, var_42_5, var_42_6, var_1_10007)
	end
	...
	if not var_3.isHxSkin() then
		...
		local var_42_7 = arg_42_0.fashionToggle
		local var_42_8 = arg_42_0.shareData

		var_3(var_42_7, var_5.HasFashion(var_42_8))
	else
		setActive = var_3
...
function var_0_1.UpdateFashionTag(arg_44_0)
	...
	local var_44_1 = arg_44_0.GetShipVO(var_44_0)

	setActive = var_44_0

	local var_44_2 = arg_44_0.fashionTag

	PaintingGroupConst = var_1_10004

	var_44_0(var_44_2, #var_1_10004.GetPaintingNameListByShipVO(var_44_1) > 0)
...
function var_0_1.UpdateEquipments(arg_45_0, arg_45_1)
	...
	for iter_45_0, iter_45_1 in var_3(arg_45_1.equipments) do
		...
		if iter_45_1 then
			...
			var_1_10014 = var_45_2

			var_1_10012(var_45_2.Find(var_1_10014, "IconTpl"), iter_45_1)
			...
			function var_1_10015()
				if arg_45_0.isShowQuick then
					...
					local var_46_3 = var_2_10002.ON_EQUIPMENT
					local var_46_4 = {}

					EquipmentInfoMediator = var_2_10004
					var_46_4.type = var_2_10004.TYPE_SHIP

					local var_46_5 = arg_45_0

					var_46_4.shipId = var_4.GetShipVO(var_46_5).id
			...
			var_1_10012(var_45_5, var_1_10014, var_1_10015, var_1_10016)
		else
			cloneTplTo = var_1_10012
			...
			function var_1_10015()
				if arg_45_0.isShowQuick then
					...
					local var_47_3 = var_2_10002.SWITCH_TO_PAGE

					ShipViewConst = var_2_10003

					var_47_2(var_47_1, var_47_3, var_2_10003.PAGE.EQUIPMENT)
				end
			...
			var_1_10012(var_45_6, var_1_10014, var_1_10015, var_1_10016)
		end

		GetOrAddComponent = var_1_10012

		local var_45_7 = var_45_2

		typeof = var_1_10014
		EventTriggerListener = var_1_10015
		var_1_10014 = var_1_10012(var_45_7, var_1_10014(var_1_10015))

		var_1_10012.AddPointDownFunc(var_1_10014, function()
			if var_45_2 and not arg_45_0.isShowQuick then
				...
				local var_48_1 = var_2_10001(var_45_2)
				local var_48_2 = 1

				System = var_2_10003

				var_48_0(var_48_1, var_48_2, var_2_10003.Action(function()
		...
		var_1_10014 = var_1_10012

		var_1_10012.AddPointUpFunc(var_1_10014, function()
			if var_45_2 then
				LeanTween = var_0
				...
				if var_50_0(var_2_10001(var_45_2)) then
					LeanTween = var_0
	...
	local var_45_8, var_45_9 = var_3.ShipStatusCheck("onModify", arg_45_0:GetShipVO())

	if not var_45_8 then
		triggerToggle = var_5

		var_5(arg_45_0.showQuickBtn, false)
	...
	elseif arg_45_0.selectedEquip and arg_45_0.isShowQuick then
		local var_45_10 = arg_45_0.selectedEquip.index

		iter_45_1 = arg_45_0

		arg_45_0.selectedEquipItem(iter_45_1, nil)

		iter_45_1 = arg_45_0

		arg_45_0.selectedEquipItem(iter_45_1, var_45_10)
	end

	arg_45_0.lastShipVo = arg_45_1.id

	local var_45_11, var_45_12 = arg_45_1:IsSpweaponUnlock()

	setActive = iter_45_1

	local var_45_13 = arg_45_0.spWeaponSlot

	iter_45_1(var_8.Find(var_45_13, "Lock"), not var_45_11)

	local var_45_14 = arg_45_1
	local var_45_15 = arg_45_1.GetSpWeapon(var_45_14)

	setActive = var_45_14

	local var_45_16 = arg_45_0.spWeaponSlot

	var_45_14(var_9.Find(var_45_16, "Icon"), var_45_15)

	setActive = var_45_14

	local var_45_17 = arg_45_0.spWeaponSlot

	var_45_14(var_9.Find(var_45_17, "IconShadow"), var_45_15)

	if var_45_15 then
		UpdateSpWeaponSlot = var_45_14

		var_45_14(arg_45_0.spWeaponSlot, var_45_15)
	end
	...
	local function var_45_20()
		if not var_45_11 then
			...
			var_52_1(var_52_0, var_2_10002(var_45_12))

			return
		elseif var_45_15 then
			local var_52_2 = arg_45_0
			local var_52_3 = var_0.emit

			BaseUI = var_2_10002
			var_2_10002 = var_2_10002.ON_SPWEAPON
			var_2_10003 = {}
			EquipmentInfoMediator = var_2_10004
			var_2_10003.type = var_2_10004.TYPE_SHIP

			local var_52_4 = arg_45_0

			var_2_10003.shipId = var_4.GetShipVO(var_52_4).id

			var_52_3(var_52_2, var_2_10002, var_2_10003)
		else
			...
			local var_52_7 = var_2_10002.SWITCH_TO_PAGE

			ShipViewConst = var_2_10003

			var_52_6(var_52_5, var_52_7, var_2_10003.PAGE.EQUIPMENT)
		end
	...
	var_45_14(var_45_18, var_45_19, var_45_20, var_1_10012)
	...
	if arg_54_0.equipItems then
		for iter_54_0 = 1, #arg_54_0.equipItems do
			if arg_54_0.selectedEquip and arg_54_0.selectedEquip.index == iter_54_0 then
				...
				var_6(var_1_10007(arg_54_0.equipItems[iter_54_0].tf, "selected"), true)
			else
				setActive = var_6
				findTF = var_1_10007

				var_6(var_1_10007(arg_54_0.equipItems[iter_54_0].tf, "selected"), false)
			end
		end
	end
...
function var_0_1.getEquipments(arg_57_0)
	...
	local var_57_3 = var_57_1(var_1_10004)

	pg = var_1_10004

	local var_57_4 = var_1_10004.ship_data_template[var_57_2.configId]["equip_" .. arg_57_0.selectedEquip.index]
	...
	if arg_57_0.equipingFlag then
		...
		for iter_57_0, iter_57_1 in var_8(var_57_0:getEquipsInShips(function(arg_58_0, arg_58_1)
			...
			if var_57_8 == "" or iter_57_1:IsMatchKey(var_57_8) then
				...
				var_1_10013.insert(var_57_6, iter_57_1)
			end
		end
	end
	...
	var_57_11(var_57_12, var_12(var_0_2.sortFunc(var_0_2.sort[1], false)))
...
function var_0_1.displayRecordPanel(arg_66_0)
	...
	for iter_66_0, iter_66_1 in var_1(arg_66_0.recordBtns) do
		...
		local function var_66_2()
			...
			local var_67_2 = var_2_10002.ON_RECORD_EQUIPMENT
			local var_67_3 = arg_66_0

			var_67_1(var_67_0, var_67_2, var_3.GetShipVO(var_67_3).id, iter_66_0, 1)
		...
		var_1_10006(var_66_0, var_66_1, var_66_2, var_1_10010)
	end
	...
	for iter_66_2, iter_66_3 in var_1(arg_66_0.equipRecordBtns) do
		...
		local function var_66_5()
			...
			local var_68_2 = var_2_10002.ON_RECORD_EQUIPMENT
			local var_68_3 = arg_66_0

			var_68_1(var_68_0, var_68_2, var_3.GetShipVO(var_68_3).id, iter_66_2, 2)
		...
		var_1_10006(var_66_3, var_66_4, var_66_5, var_1_10010)
	end
...
function var_0_1.UpdateRecordEquipments(arg_71_0, arg_71_1)
	...
	for iter_71_0 = 1, 5 do
		...
		local var_71_6 = var_11
		local var_71_7 = var_11.Find(var_71_6, "info")

		setActive = var_71_6

		var_71_6(var_71_7, var_71_3)

		setActive = var_71_6

		var_71_6(var_71_5, not var_71_3)

		if var_71_3 then
			local var_71_8 = arg_71_0.equipmentProxy

			var_71_6 = var_71_6.getEquipmentById(var_71_8, var_1_10009)

			if not (arg_71_0:GetShipVO().equipments[iter_71_0] and var_15.id == var_1_10009 or false) then
				local var_71_10

				if var_71_6 then
					local var_71_9 = var_71_6.count
				...
				var_1_10018(var_71_7:Find("tip"), var_71_10)

				updateEquipment = var_1_10018

				local var_71_11 = var_71_7
				local var_71_12 = var_71_7.Find(var_71_11, "IconTpl")

				Equipment = var_71_11

				var_1_10018(var_71_12, var_71_11.New({
					id = var_1_10009
				}))
				...
				if var_71_10 then
					...
					local var_71_13 = arg_71_0
					local var_71_14 = var_71_7

					local function var_71_15()
						pg = var_2_10000
						...
						var_72_1(var_72_0, var_2_10002("ship_quick_change_nofreeequip"))
					...
					var_1_10018(var_71_13, var_71_14, var_71_15, var_1_10022)
				end

				if false then
					removeOnButton = var_71_6
...
function var_0_1.UpdateRecordSpWeapons(arg_73_0, arg_73_1)
	...
	var_73_0.Foreach(arg_73_0.recordBars, function(arg_74_0, arg_74_1)
		...
		local var_74_2 = arg_73_0
		local var_74_3 = var_4.GetShipVO(var_74_2)
		local var_74_4 = var_4.IsSpweaponUnlock(var_74_3)

		setActive = var_74_3

		var_74_3(var_74_1:Find("Lock"), not var_74_4)

		setActive = var_74_3

		var_74_3(var_74_1:Find("Icon"), var_74_0)

		setActive = var_74_3

		var_74_3(var_74_1:Find("IconShadow"), var_74_0)

		if var_74_0 then
			UpdateSpWeaponSlot = var_74_3

			var_74_3(var_74_1, var_74_0)

			local var_74_5 = arg_73_0
			local var_74_6 = var_74_3.GetShipVO(var_74_5)
			local var_74_7

			if not var_74_3.GetSpWeapon(var_74_6) or not var_74_3:GetConfigID() then
				var_74_7 = 0
			end
			...
			if var_74_0.GetConfigID(var_74_8) ~= var_74_7 then
				getProxy = var_74_8
				EquipmentProxy = var_2_10009

				local var_74_9 = var_74_8(var_2_10009)

				if var_74_8.GetSameTypeSpWeapon(var_74_9, var_74_0) and var_74_8:GetConfigID() == var_74_0:GetConfigID() then
					var_74_10 = false
				end
			end
			...
			var_74_8(var_74_1:Find("Icon/tip"), var_74_10)

			if var_74_10 then
				onButton = var_74_8

				local var_74_11 = arg_73_0
				local var_74_12 = var_74_1

				local function var_74_13()
					pg = var_3_10000
					...
					var_75_1(var_75_0, var_3_10002("ship_quick_change_nofreeequip"))
				...
				var_74_8(var_74_11, var_74_12, var_74_13, var_2_10012)
			else
...
function var_0_1.UpdatePreferenceTag(arg_76_0)
	...
	local var_76_2 = arg_76_0.GetShipVO(var_76_1).preferenceTag

	Ship = var_76_1

	var_1_10001(var_76_0, var_76_2 == var_76_1.PREFERENCE_TAG_COMMON)
	...
	if arg_78_0.equipItems then
		for iter_78_0 = 1, #arg_78_0.equipItems do
			if arg_78_0.equipItems[iter_78_0].tf then
				...
				go = var_1_10008
				var_1_10008 = var_1_10008(var_5)
				typeof = var_9
				EventTriggerListener = var_1_10010

				var_1_10006(var_1_10007(var_1_10008, var_9(var_1_10010)))

				removeOnButton = var_1_10006
				go = var_1_10007

				var_1_10006(var_1_10007(var_5))
			end
		end
	end
...
function var_0_1.OnDestroy(arg_79_0)
	...
	if arg_79_0.recordPanel then
		...
		if var_79_1(var_79_0(arg_79_0.recordPanel)) then
			...
			var_79_2(var_2(arg_79_0.recordPanel))
		end
