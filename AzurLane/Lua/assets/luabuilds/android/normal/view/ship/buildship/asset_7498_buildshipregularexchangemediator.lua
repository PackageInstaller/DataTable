...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.EXCHAGNE_SHIP, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.REGULAR_BUILD_POOL_EXCHANGE, {
			id = arg_2_1
		})
	...
	var_1_1(var_1_0, var_3.getRegularExchangeCount(var_1_2))
...
function var_0_1.handleNotification(arg_4_0, arg_4_1)
	...
	if var_4_0 == var_4_1.REGULAR_BUILD_POOL_EXCHANGE_DONE then
