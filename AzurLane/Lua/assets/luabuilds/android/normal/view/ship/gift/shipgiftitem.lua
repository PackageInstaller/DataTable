...
function var_0_1.Init(arg_2_0)
	...
	local var_2_11 = var_2.Find(var_2_10, "numberTitle")

	i18n = var_2_10

	var_1(var_2_11, var_2_10("ship_gift_cnt"))
	...
	local function var_2_14(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10003.REFRESH_USE_ITEM_CNT, arg_2_0.selectCnt)
	...
	var_1(var_2_12, var_2_13, var_2_14, var_2_15, var_2_16, var_2_17, var_2_18, var_1_10009)
	...
	local function var_2_21(arg_4_0)
		local var_4_0 = arg_2_0.selectCnt
		local var_4_1 = arg_2_0.itemVO.count

		if var_4_0 <= (0 < var_4_1 and 1 or 0) then
			return
		end
		...
		var_4_3(var_4_2, var_3.REFRESH_USE_ITEM_CNT, arg_2_0.selectCnt)

		local var_4_4 = arg_2_0

		var_1.RefreshUseCnt(var_4_4)
	...
	var_1(var_2_19, var_2_20, var_2_21, var_2_22, var_2_23, var_2_24, var_2_25, var_1_10009)
	...
	local function var_2_28()
		...
		ShipGiftItem = var_2_10002

		var_5_1(var_5_0, var_2_10002.REFRESH_USE_ITEM_CNT, arg_2_0.selectCnt)
	...
	local function var_2_31()
		...
		var_6_1(var_6_0, var_2_10002.ON_ITEM, arg_2_0.itemVO.id)
	...
	local function var_2_34()
		...
		var_7_1(var_7_0, var_2_10002.SELECT_ITEM, arg_2_0.index)
...
function var_0_1.didEnter(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5)
	...
	local var_8_4 = var_7(var_8_3, var_9.GetItemIntimacySpriteName(arg_8_1, arg_8_2))

	setImageSprite = var_8_3

	var_8_3(arg_8_0.favoriteTF, var_8_4)
