...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.valueTxt = var_2_1(var_2_0, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.text = var_2_3(var_2_2, var_3(var_1_10004))
	setText = var_1

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_2.Find(var_2_4, "window/btns/cancel_btn/Image/Image (1)")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("text_cancel"))

	setText = var_1

	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_2.Find(var_2_6, "window/btns/confirm_btn/Image/Image (1)")
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_17()
		if arg_3_0.buildType == "ticket" then
			...
			if arg_3_0.itemVO.count <= var_9_0 then
				pg = var_9_0
				var_2_10001 = var_9_0.TipsMgr.GetInstance()

				local var_9_1 = var_0.ShowTips

				i18n = var_2_10002

				local var_9_2 = "tip_build_ticket_not_enough"
				local var_9_3 = arg_3_0.itemVO

				var_9_1(var_2_10001, var_2_10002(var_9_2, var_2_10004.getConfig(var_9_3, "name")))
		...
		MAX_BUILD_WORK_COUNT = var_2_10004
		var_9_4.count = var_9_5(var_9_6, var_9_7, var_2_10004)
	...
	local function var_3_20()
		...
		if arg_3_0.buildType == "ticket" then
			...
			MAX_BUILD_WORK_COUNT = var_2_10004
			var_10_1.count = var_10_2(var_10_3, var_10_4, var_2_10004)
		end
	...
	var_1_10003(arg_12_0.buildType, {
		base = function()
			...
			if arg_12_1 <= arg_12_0.max and arg_12_0.player.gold >= arg_12_1 * var_13_0.use_gold and arg_12_0.itemVO.count >= arg_12_1 * var_13_0.number_1 then
				...
				COLOR_GREEN = var_7
				var_12_0 = var_1(var_13_1, var_13_2, var_13_3, var_13_4, var_13_5, var_7)
			else
				i18n = var_1
				...
				COLOR_RED = var_7
				var_12_0 = var_1(var_13_6, var_13_7, var_13_8, var_13_9, var_13_10, var_7)
			end
		...
		ticket = function()
			if arg_12_1 <= arg_12_0.max and arg_12_0.itemVO.count >= arg_12_1 then
				...
				local var_14_5 = var_5.getConfig(var_14_4, "name")

				COLOR_GREEN = var_14_4
				var_12_0 = var_0(var_14_0, var_14_1, var_14_2, var_14_3, var_14_5, var_14_4)
			else
				i18n = var_0
				...
				local var_14_11 = var_5.getConfig(var_14_10, "name")

				COLOR_RED = var_14_10
				var_12_0 = var_0(var_14_6, var_14_7, var_14_8, var_14_9, var_14_11, var_14_10)
			end
		...
		medal = function()
			if arg_12_1 <= arg_12_0.max and arg_12_0.itemVO.count >= arg_12_1 * arg_12_0.cost then
				...
				COLOR_GREEN = var_4
				var_12_0 = var_0(var_15_0, var_15_1, var_15_2, var_4)
			else
				i18n = var_0
				...
				COLOR_RED = var_4
				var_12_0 = var_0(var_15_3, var_15_4, var_15_5, var_4)
			end
...
function var_0_1.Show(arg_16_0, arg_16_1)
	...
	local var_16_1 = var_3.Find(var_16_0, "window/content/title")

	i18n = var_16_0

	var_2(var_16_1, var_16_0(arg_16_0.buildType == "medal" and "support_times_tip" or "build_times_tip"))
