...
function var_0_0.Start(arg_4_0)
	...
	local var_4_2 = var_4_1(var_4_0, var_3.easeInOutSine)
	local var_4_3 = var_1.setOnComplete

	System = var_3

	var_4_3(var_4_2, var_3.Action(function()
...
function var_0_0.TweenObjects(arg_8_0)
	...
	var_8_4:AddDragFunc(function(arg_12_0, arg_12_1)
		if var_8_0 then
			...
			local var_12_1 = var_3(arg_8_0.painting)
	...
	var_8_5(var_8_6, var_8_7, var_8_8, var_1_10009)
...
function var_0_0.Finish(arg_15_0, arg_15_1)
	...
	arg_15_0.EnableObjects(var_15_1, true)

	local var_15_2 = arg_15_0.painting

	Vector3 = var_15_1
	var_15_2.localScale = var_15_1(1, 1, 1)
	setAnchoredPosition = var_15_2

	var_15_2(arg_15_0.painting, {
