...
function var_0_0.GetGiftList(arg_1_0)
	...
	local var_1_2 = var_1_10004.item_data_statistics.get_id_list_by_type

	Item = var_1_10005

	for iter_1_0, iter_1_1 in var_1_10003(var_1_2[var_1_10005.SHIP_GIFT]) do
		getProxy = var_1_10008
		BagProxy = var_1_10009
		var_1_10009 = var_1_10008(var_1_10009)

		if var_1_10008.getItemById(var_1_10009, iter_1_1) and var_1_10008.count > 0 then
			table = var_1_10009
			...
			var_1_10009(var_1_3, var_1_10011.New({
				id = iter_1_1,
			...
			var_1_10009(var_1_4, var_1_10011.New({
				count = 0,
				id = iter_1_1
			}))
		end
...
function var_0_0.GetItemFavoriteState(arg_4_0, arg_4_1)
	...
	local var_4_1 = arg_4_0.getConfig(var_4_0, "gift_dislike")

	type = var_4_0
	var_4_1 = var_4_0(var_4_1) ~= "table" and {} or var_4_1
	table = var_3

	if var_3.contains(var_4_1, arg_4_1.id) then
		ShipGiftConst = var_3
...
function var_0_0.GetItemIntimacyValue(arg_5_0, arg_5_1)
	...
	if var_5_0 ~= var_3.GIFT_FAVORITE_STATE.LIKE or not arg_5_1:getConfig("usage_arg")[2] then
		var_5_1 = 0
	end
...
function var_0_0.GetItemIntimacySpriteName(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_3.GIFT_FAVORITE_STATE.LIKE then
		return "express_3"
	else
		ShipGiftConst = var_3
