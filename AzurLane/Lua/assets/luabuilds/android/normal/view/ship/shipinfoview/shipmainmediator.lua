...
function var_0_1.register(arg_1_0)
	...
	arg_1_0.bayProxy = var_1_10001(var_1_10002)
	...
	if var_1_2 then
		...
		if not var_4.indexof(arg_1_0.contextData.shipVOs, var_1_2) then
			var_1_6 = 1
		end
		...
		local var_1_10 = var_5(var_1_10006)

		var_1_9(var_1_8, var_5.getSkinList(var_1_10))
		...
		arg_1_0:bind(var_0_1.ON_ADD_SHIP_EXP, function(arg_3_0, arg_3_1, arg_3_2)
			...
			var_3_1(var_3_0, var_2_10005.USE_ADD_SHIPEXP_ITEM, {
				id = arg_3_1,
				items = arg_3_2
			})
		...
		arg_1_0:bind(var_0_1.OPEN_SHIPPROFILE, function(arg_5_0, arg_5_1, arg_5_2)
			...
			var_5_1(var_5_0, var_5_2, var_2_10006.SHIP_PROFILE, {
				showTrans = arg_5_2,
				groupId = arg_5_1
			})
		...
		arg_1_0:bind(var_0_1.ON_SKIN_INFO, function(arg_8_0, arg_8_1, arg_8_2)
			...
			EquipmentSkinLayer = var_2_10007
			var_8_3.viewComponent = var_2_10007
			EquipmentSkinMediator = var_2_10007
			...
			EquipmentSkinLayer = var_8
			var_8_4.mode = var_8.DISPLAY
		...
		arg_1_0:bind(var_0_1.ON_RECORD_EQUIPMENT, function(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
			...
			var_9_1(var_9_0, var_2_10006.RECORD_SHIP_EQUIPMENT, {
				shipId = arg_9_1,
				index = arg_9_2,
				type = arg_9_3
			})
		...
		arg_1_0:bind(var_0_1.OPEN_EVALUATION, function(arg_10_0, arg_10_1, arg_10_2)
			if arg_10_2 then
				...
				var_10_1(var_10_0, var_2_10005("npc_evaluation_tip"))
			...
			var_10_3(var_10_2, var_2_10005.FETCH_EVALUATION, arg_10_1)
		...
		arg_1_0:bind(var_0_1.ON_SELECT_EQUIPMENT_SKIN, function(arg_11_0, arg_11_1)
			...
			local var_11_4 = var_5.GO_SCENE

			SCENE = var_2_10006

			local var_11_5 = var_2_10006.EQUIPSCENE
			local var_11_6 = {
			...
			var_11_6.warp = var_8.WARP_TO_WEAPON
			StoreHouseConst = var_8
			var_11_6.mode = var_8.SKIN
		...
		arg_1_0:bind(var_0_1.ON_SELECT_EQUIPMENT, function(arg_12_0, arg_12_1)
			...
			local var_12_2 = var_12_0(var_5)
			local var_12_3 = var_4.getShipById(var_12_2, arg_1_0.contextData.shipId)
			local var_12_4 = var_4
			local var_12_5 = var_4.getEquipsInShips(var_12_4, function(arg_13_0, arg_13_1)
				local var_13_1
			...
			for iter_12_0, iter_12_1 in var_12_4(var_12_1) do
				if not var_12_3:isForbiddenAtPos(iter_12_1, arg_12_1) then
					...
					var_12.insert(var_12_5, iter_12_1)
				end
			end

			_ = var_7

			var_7.each(var_12_5, function(arg_14_0)
			...
			local var_12_7 = var_7.sendNotification

			GAME = var_9

			local var_12_8 = var_9.GO_SCENE

			SCENE = iter_12_0

			local var_12_9 = iter_12_0.EQUIPSCENE
			local var_12_10 = {
				lock = true,
				equipmentVOs = var_12_5,
				shipId = arg_1_0.contextData.shipId,
				pos = arg_12_1
			}

			StoreHouseConst = var_12
			var_12_10.warp = var_12.WARP_TO_WEAPON
			StoreHouseConst = var_12
			var_12_10.mode = var_12.EQUIPMENT
		...
		arg_1_0:bind(var_0_1.ON_SELECT_SPWEAPON, function(arg_15_0)
			...
			local var_15_3 = var_2_10004.SPWEAPON_STOREHOUSE
			local var_15_4 = {
				lock = true,
				shipId = arg_1_0.contextData.shipId
			}
			...
			var_15_4.warp = var_6.WARP_TO_WEAPON
			StoreHouseConst = var_6
			var_15_4.mode = var_6.EQUIPMENT
		...
		arg_1_0:bind(var_0_1.ON_LOCK, function(arg_20_0, arg_20_1, arg_20_2)
			...
			var_20_1(var_20_0, var_2_10005.UPDATE_LOCK, {
		...
		arg_1_0:bind(var_0_1.ON_TAG, function(arg_21_0, arg_21_1, arg_21_2)
			...
			var_21_1(var_21_0, var_2_10005.UPDATE_PREFERENCE, {
				shipId = arg_21_1,
				tag = arg_21_2
			})
		...
		arg_1_0:bind(var_0_1.ON_SKILL, function(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
			...
			local var_22_2 = var_2_10006.New
			local var_22_3 = {}

			SkillInfoMediator = var_2_10008
			var_22_3.mediator = var_2_10008
			SkillInfoLayer = var_2_10008
			var_22_3.viewComponent = var_2_10008
			var_22_3.data = {
		...
		arg_1_0:bind(var_0_1.CHANGE_SKIN, function(arg_23_0, arg_23_1, arg_23_2)
			...
			var_23_1(var_23_0, var_2_10005.SET_SHIP_SKIN, {
				phantomId = 0,
				shipId = arg_23_1,
				skinId = arg_23_2
			})
		...
		arg_1_0:bind(var_0_1.BUY_ITEM, function(arg_24_0, arg_24_1, arg_24_2)
			...
			var_24_1(var_24_0, var_2_10005.SKIN_SHOPPIGN, {
				id = arg_24_1,
				count = arg_24_2
			})
		...
		arg_1_0:bind(var_0_1.UNEQUIP_FROM_SHIP_ALL, function(arg_25_0, arg_25_1)
			...
			var_25_1(var_25_0, var_2_10004.UNEQUIP_FROM_SHIP_ALL, {
				shipId = arg_25_1
			})
		...
		arg_1_0:bind(var_0_1.UNEQUIP_FROM_SHIP, function(arg_26_0, arg_26_1)
			...
			var_26_1(var_26_0, var_2_10004.UNEQUIP_FROM_SHIP, arg_26_1)
		...
		arg_1_0:bind(var_0_1.OPEN_ACTIVITY, function(arg_28_0, arg_28_1)
			...
			var_28_1(var_28_0, var_28_2, var_2_10005.ACTIVITY, {
				id = arg_28_1
			})
		...
		arg_1_0:bind(var_0_1.PROPOSE, function(arg_31_0, arg_31_1, arg_31_2)
			...
			local var_31_2 = var_2_10005.New
			local var_31_3 = {}

			ProposeMediator = var_2_10007
			var_31_3.mediator = var_2_10007
			ProposeUI = var_2_10007
		...
		arg_1_0:bind(var_0_1.RENAME_SHIP, function(arg_32_0, arg_32_1, arg_32_2)
			...
			var_32_1(var_32_0, var_2_10005.RENAME_SHIP, {
				shipId = arg_32_1,
				name = arg_32_2
			})
		...
		arg_1_0:bind(var_0_1.ON_SEL_COMMANDER, function(arg_33_0)
			...
			local var_33_4 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			local var_33_5 = var_2_10005.COMMANDPOST
			local var_33_6 = {
				selectedMin = 1,
				selectedMax = 1
			}
			...
			var_33_6.mode = var_2_10007.MODE_SELECT
		...
		arg_1_0:bind(var_0_1.ON_UPGRADE_MAX_LEVEL, function(arg_36_0, arg_36_1)
			...
			var_36_1(var_36_0, var_2_10004.UPGRADE_MAX_LEVEL, {
				shipId = arg_36_1
			})
		...
		arg_1_0:bind(var_0_1.ON_TECHNOLOGY, function(arg_37_0, arg_37_1)
			...
			var_37_1(var_37_0, var_37_2, var_2_10005.SHIPBLUEPRINT, {
				shipId = arg_37_1.id
			})
		...
		arg_1_0:bind(var_0_1.OPEN_EQUIP_UPGRADE, function(arg_38_0, arg_38_1)
			...
			local var_38_2 = var_2_10004.New
			local var_38_3 = {}

			EquipUpgradeMediator = var_2_10006
			var_38_3.mediator = var_2_10006
			EquipUpgradeLayer = var_2_10006
			var_38_3.viewComponent = var_2_10006
			var_38_3.data = {
				shipId = arg_38_1
			}
		...
		arg_1_0:bind(var_0_1.ON_META, function(arg_39_0, arg_39_1)
			...
			local var_39_2 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			var_39_1(var_39_0, var_39_2, var_2_10005.METACHARACTER, {
		...
		arg_1_0:bind(var_0_1.OPEN_EQUIP_CODE, function(arg_40_0, arg_40_1)
			...
			local var_40_2 = var_2_10004.GO_SCENE

			SCENE = var_2_10005

			var_40_1(var_40_0, var_40_2, var_2_10005.EQUIP_CODE, {
				shipId = arg_1_0.contextData.shipId,
				code = arg_40_1.code
			})
		...
		arg_1_0:bind(var_0_1.OPEN_EQUIP_CODE_SHARE, function(arg_41_0, arg_41_1, arg_41_2)
			...
			local var_41_2 = var_2_10005.New
			local var_41_3 = {}

			EquipCodeShareMediator = var_2_10007
			var_41_3.mediator = var_2_10007
			EquipCodeShareLayer = var_2_10007
			var_41_3.viewComponent = var_2_10007
			var_41_3.data = {
				shipId = arg_41_1,
		...
		arg_1_0:bind(var_0_1.CHANGE_RANDOM_FLAG, function(arg_42_0, arg_42_1, arg_42_2)
			...
			local var_42_2 = var_2_10005.CHANGE_RANDOM_SHIPS
			local var_42_3 = {}
			local var_42_4
		...
		arg_1_0.bind(var_1_17, var_0_1.OPEN_PHANTOM_LAYER, function(arg_43_0, arg_43_1)
			...
			local var_43_2 = var_2_10004.New
			local var_43_3 = {}

			DockyardMediator = var_2_10006
			var_43_3.mediator = var_2_10006
			DockyardScene = var_2_10006
			var_43_3.viewComponent = var_2_10006

			local var_43_4 = {}

			DockyardScene = var_2_10007
			var_43_4.mode = var_2_10007.MODE_SHIP_PHANTOM
		...
		if arg_1_0.contextData.selectedId then
			...
			var_1_18(var_1_17, var_8.COMMANDER_EQUIP_TO_SHIP, {
				shipId = arg_1_0.contextData.shipId,
...
function var_0_1.getEquipmentSkins(arg_45_0, arg_45_1, arg_45_2)
	...
	if arg_45_1:getEquip(arg_45_2) then
		local var_45_0 = {}

		var_1_10006 = var_3
		var_45_0[1] = var_3.getType(var_1_10006)

		local var_45_1

		if not var_45_0 then
			var_45_1 = arg_45_1
			var_45_0 = arg_45_1.getSkinTypes(var_45_1, arg_45_2)
		end

		getProxy = var_45_1
		EquipmentProxy = var_1_10006

		local var_45_2 = var_45_1(var_1_10006)
		local var_45_3 = var_5.getSkinsByTypes(var_45_2, var_45_0)

		getProxy = var_45_2
		BayProxy = var_7

		local var_45_4 = var_45_2(var_7)
		local var_45_5 = var_6.getEquipmentSkinInShips(var_45_4, arg_45_1, var_45_0)

		_ = var_45_4

		local var_45_6 = var_45_4.map(var_45_5, function(arg_46_0)
			return {
				isSkin = true,
				count = 1,
				id = arg_46_0.id,
		...
		local var_45_7 = var_8.map(var_45_3, function(arg_47_0)
			return {
				isSkin = true,
				id = arg_47_0.id,
		...
		for iter_45_0, iter_45_1 in var_9(var_45_6 or {}) do
			table = var_1_10014

			var_1_10014.insert(var_45_7, iter_45_1)
		end
...
function var_0_1.nextPage(arg_48_0, arg_48_1, arg_48_2)
	...
	if var_48_3 then
		...
		ShipViewConst = var_48_12

		if var_48_13 == var_48_12.PAGE.UPGRADE then
...
function var_0_1.openRemould(arg_49_0)
	...
	ShipRemouldMediator = var_1_10005

	if var_49_2(var_49_1, var_1_10005) then
		return
	end
	...
	local var_49_5 = var_1_10006.New
	local var_49_6 = {}

	ShipRemouldLayer = var_1_10008
	var_49_6.viewComponent = var_1_10008
	ShipRemouldMediator = var_1_10008
	var_49_6.mediator = var_1_10008
	var_49_6.data = {
...
function var_0_1.closeRemould(arg_50_0)
	...
	if var_50_2(var_50_1, var_1_10005) then
		local var_50_3 = arg_50_0
		local var_50_4 = arg_50_0.sendNotification

		GAME = var_1_10006

		var_50_4(var_50_3, var_1_10006.REMOVE_LAYERS, {
			context = var_3
		})
	end
...
function var_0_1.openUpgrade(arg_51_0)
	...
	local var_51_0 = var_1_10001(var_1_10002)
	local var_51_1 = var_1.getCurrentContext(var_51_0)
	local var_51_2 = var_1.getContextByMediator

	ShipUpgradeMediator2 = var_1_10004

	if var_51_2(var_51_1, var_1_10004) then
		return
	end
	...
	local var_51_5 = var_1_10005.New
	local var_51_6 = {}

	ShipUpgradeMediator2 = var_1_10007
	var_51_6.mediator = var_1_10007
	ShipUpgradeLayer2 = var_1_10007
	var_51_6.viewComponent = var_1_10007
	var_51_6.data = {
...
function var_0_1.closeUpgrade(arg_52_0)
	...
	if var_52_2(var_52_1, var_1_10004) then
		local var_52_3 = arg_52_0
		local var_52_4 = arg_52_0.sendNotification

		GAME = var_1_10005

		var_52_4(var_52_3, var_1_10005.REMOVE_LAYERS, {
			context = var_2
		})
	end
...
function var_0_1.openIntensify(arg_53_0)
	...
	local var_53_1 = var_53_0(var_1_10002)
	local var_53_2 = var_1.getCurrentContext(var_53_1)
	local var_53_3 = var_2.getContextByMediator

	ShipModMediator = var_1_10005

	if var_53_3(var_53_2, var_1_10005) then
		return
	end

	Context = var_53_2

	local var_53_4 = var_53_2.New
	local var_53_5 = {}

	ShipModMediator = var_1_10006
	var_53_5.mediator = var_1_10006
	ShipModLayer = var_1_10006
	var_53_5.viewComponent = var_1_10006
	var_53_5.data = {
...
function var_0_1.closeIntensify(arg_55_0)
	...
	if var_55_2(var_55_1, var_1_10005) then
		local var_55_3 = arg_55_0
		local var_55_4 = arg_55_0.sendNotification

		GAME = var_1_10006

		var_55_4(var_55_3, var_1_10006.REMOVE_LAYERS, {
			context = var_3
		})
	end
...
function var_0_1.handleNotification(arg_57_0, arg_57_1)
	...
	local var_57_2 = arg_57_1.getBody(var_57_1)

	BayProxy = var_57_1

	if var_57_0 == var_57_1.SHIP_UPDATED then
		if var_57_2.id == arg_57_0.contextData.shipId then
			var_1_10005 = var_57_2
			arg_57_0.showTrans = var_57_2.isRemoulded(var_1_10005)
			var_1_10005 = arg_57_0.viewComponent

			var_4.setShip(var_1_10005, var_57_2)
		end
	...
	if var_57_0 == var_4.CHANGE_RANDOM_SHIPS_DONE then
		var_1_10005 = arg_57_0.viewComponent
		var_57_3 = var_57_3.setShip
		var_1_10007 = arg_57_0.bayProxy

		var_57_3(var_1_10005, var_1_10006.getShipById(var_1_10007, arg_57_0.contextData.shipId))
	...
	if var_57_0 == var_57_3.CHANGE_SKIN_UPDATE then
		ShipPhantom = var_57_4
		var_57_4, var_1_10005 = var_57_4.UnpackMark(var_57_2)

		if var_57_4 == arg_57_0.contextData.shipId then
			var_1_10007 = arg_57_0.bayProxy
			var_1_10008 = var_1_10006.getShipById(var_1_10007, var_57_4)
			arg_57_0.showTrans = var_1_10006.isRemoulded(var_1_10008)
			var_1_10008 = arg_57_0.viewComponent

			var_1_10007.setShip(var_1_10008, var_1_10006)
		end
	...
	if var_57_0 == var_57_4.DESTROY_SHIP_DONE then
		pg = var_57_5
		var_1_10005 = var_57_5.TipsMgr.GetInstance()
		var_57_5 = var_57_5.ShowTips
		i18n = var_1_10006

		var_57_5(var_1_10005, var_1_10006("ship_shipInfoMediator_destory"))

		var_1_10005 = arg_57_0.viewComponent.event
		var_57_5 = var_57_5.emit
		BaseUI = var_1_10006

		var_57_5(var_1_10005, var_1_10006.ON_CLOSE)
	...
	if var_57_0 == var_57_5.UPDATE_LOCK_DONE then
		if var_57_2.id == arg_57_0.contextData.shipId then
			var_1_10005 = arg_57_0.viewComponent

			var_4.updateLock(var_1_10005)
		end
	...
	if var_57_0 == var_4.UPDATE_PREFERENCE_DONE then
		if var_57_2.id == arg_57_0.contextData.shipId then
			var_1_10005 = arg_57_0.viewComponent

			var_4.updatePreferenceTag(var_1_10005)
		end
	...
	if var_57_0 == var_4.MOD_SHIP_DONE then
		var_1_10005 = arg_57_0.viewComponent

		var_4.displayShipWord(var_1_10005, "upgrade", true)
	...
	if var_57_0 == var_4.UPDATED then
		getProxy = var_4
		PlayerProxy = var_1_10005
		var_1_10006 = var_4(var_1_10005)
		var_1_10005 = var_4.getData(var_1_10006)
		var_1_10007 = arg_57_0.viewComponent

		var_1_10006.setPlayer(var_1_10007, var_1_10005)
	...
	if var_57_0 == var_4.FETCH_EVALUATION_DONE then
		var_1_10005 = arg_57_0
		var_57_6 = arg_57_0.addSubLayers
		Context = var_1_10006
		...
		var_57_6(var_1_10005, var_1_10006(var_1_10007))

		goto label_57_0
	end

	ShipSkinProxy = var_57_6

	local var_57_7

	if var_57_0 == var_57_6.SHIP_SKINS_UPDATE then
		getProxy = var_57_7
		ShipSkinProxy = var_1_10005
		var_57_7 = var_57_7(var_1_10005)
		var_1_10006 = arg_57_0.viewComponent

		var_5.setSkinList(var_1_10006, var_57_7:getSkinList())

		arg_57_0.viewComponent.fashionGroup = 0
		var_1_10006 = arg_57_0.viewComponent.shipFashionView

		var_5.UpdateFashion(var_1_10006, true)

		goto label_57_0
	end

	ShipUpgradeMediator2 = var_57_7

	local var_57_8

	if var_57_0 == var_57_7.NEXTSHIP then
		var_57_8 = arg_57_0:nextPage(var_57_2, 3)

		goto label_57_0
	end

	ShipModMediator = var_57_8

	if var_57_0 == var_57_8.LOADEND then
		local var_57_9 = arg_57_0.viewComponent

		var_4.setModPanel(var_57_9, var_57_2)
	...
	if var_57_0 == var_4.RENAME_SHIP_DONE then
		local var_57_10 = arg_57_0.viewComponent

		var_4.DisplayRenamePanel(var_57_10, false)
	...
	if var_57_0 == var_4.RECORD_SHIP_EQUIPMENT_DONE then
		if var_57_2.shipId == arg_57_0.contextData.shipId and var_57_2.type == 1 then
			local var_57_11 = arg_57_0.viewComponent

			var_4.updateRecordEquipments(var_57_11, var_57_2.index)
		end
	...
	if var_57_0 ~= var_4.SKIN_SHOPPIGN_DONE then
		GAME = var_4

		if var_57_0 == var_4.SKIN_COUPON_SHOPPING_DONE then
			pg = var_4

			if var_4.shop_template[var_57_2.id] then
				local var_57_12 = var_4.genre

				ShopArgs = var_1_10006

				if var_57_12 == var_1_10006.SkinShop then
					var_1_10006 = arg_57_0.viewComponent

					var_5.StopPreVoice(var_1_10006)

					var_1_10006 = arg_57_0

					local var_57_13 = arg_57_0.addSubLayers

					Context = var_1_10007

					local var_57_14 = var_1_10007.New
					local var_57_15 = {}

					NewSkinMediator = var_1_10009
					var_57_15.mediator = var_1_10009
					NewSkinLayer = var_1_10009
					var_57_15.viewComponent = var_1_10009
					var_57_15.data = {
						skinId = var_4.effect_args[1]
					}

					var_57_13(var_1_10006, var_57_14(var_57_15))
				end
			end
		else
			GAME = var_4
			...
			if var_57_0 == var_4.UPGRADE_MAX_LEVEL_DONE then
				local var_57_16 = arg_57_0

				var_57_17 = arg_57_0.sendNotification
				PlayerResUI = var_1_10006

				var_57_17(var_57_16, var_1_10006.CHANGE_TOUCH_ABLE, false)

				arg_57_0.maxLevelCallback = var_57_2.callback

				local var_57_18 = arg_57_0.viewComponent

				var_57_17.doUpgradeMaxLeveAnim(var_57_18, var_57_2.oldShip, var_57_2.newShip, function()
					...
					PlayerResUI = var_2_10002

					var_58_1(var_58_0, var_2_10002.CHANGE_TOUCH_ABLE, true)
					...
					var_58_3(var_58_2, var_2(var_58_4, var_4.getMaxLevel(var_58_5)))
				...
				if var_57_0 == var_57_17.HIDE_Ship_MAIN_SCENE_WORD then
					local var_57_19 = arg_57_0.viewComponent

					var_4.hideShipWord(var_57_19)
				else
					GAME = var_4

					if var_57_0 == var_4.PROPOSE_SHIP_DONE then
						if arg_57_0.viewComponent.shipFashionView then
							var_1_10006 = var_4

							if var_4.GetLoaded(var_1_10006) then
								var_1_10006 = var_4

								var_4.UpdateAllFashion(var_1_10006, true)
							end
						end
					else
						GAME = var_4
						...
						if var_57_0 == var_4.USE_ADD_SHIPEXP_ITEM_DONE then
							pg = var_57_21

							local var_57_20 = var_57_21.TipsMgr.GetInstance()

							var_57_21 = var_57_21.ShowTips
							i18n = var_1_10006

							var_57_21(var_57_20, var_1_10006("ship_shipModLayer_modSuccess"))

							local var_57_22 = arg_57_0.viewComponent

							var_57_21.RefreshShipExpItemUsagePage(var_57_22)
						else
							EquipmentProxy = var_57_21

							if var_57_0 == var_57_21.EQUIPMENT_UPDATED then
								local var_57_23 = arg_57_0.viewComponent

								var_4.equipmentChange(var_57_23)
							else
								GAME = var_4

								if var_57_0 == var_4.WILL_LOGOUT then
									local var_57_24 = arg_57_0.viewComponent

									var_4.OnWillLogout(var_57_24)
								else
									PaintingGroupConst = var_4

									if var_57_0 == var_4.NotifyPaintingDownloadFinish then
										local var_57_25 = arg_57_0.viewComponent

										var_4.updateFashionTag(var_57_25)
									end
								end
							end
						end
...
function var_0_1.remove(arg_59_0)
	if arg_59_0.maxLevelCallback then
		...
		var_59_1(var_59_0, var_1_10003.CHANGE_TOUCH_ABLE, true)
	end
