...
function var_0_0.SetAction(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_12_1 then
		...
		local var_12_3 = var_1_10006.abs(arg_12_0.modelScale.x)

		tf = var_1_10006
		var_1_10006 = var_1_10006(arg_12_0._model)
		Vector3 = var_7
		var_1_10006.localScale = var_7(var_12_3, arg_12_0.modelScale.y, arg_12_0.modelScale.z)
	else
		math = var_1_10006

		local var_12_4 = var_1_10006.sign(arg_12_0.modelScale.x)

		tf = var_6
		var_6(arg_12_0._model).localScale = arg_12_0.modelScale
	end

	local var_12_5 = arg_12_0._animUI

	var_6.SetAction(var_12_5, var_12_0, arg_12_2)
...
function var_0_0.start(arg_30_0, arg_30_1)
	...
	arg_30_0._animUI = var_30_1(var_30_0, var_1_10004(var_1_10005))
...
function var_0_0.getDirectActonName(arg_33_0, arg_33_1)
	if not arg_33_0.direct then
		...
		tf = var_1_10003
		arg_33_0.direct = var_33_0(var_1_10003(arg_33_0._model).localScale.x)
	end
