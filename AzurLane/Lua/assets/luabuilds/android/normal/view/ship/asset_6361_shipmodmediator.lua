...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.ON_SELECT_MATERIAL_SHIPS, function(arg_2_0)
		...
		local var_2_2 = var_2_1(var_2_0, var_2_10003.FILTER_SHIPS_FLAGS_1)

		table = var_2_0

		var_2_0.insert(var_2_2, 1, arg_1_0.contextData.shipId)
		...
		local var_2_5 = var_4.GO_SCENE

		SCENE = var_5

		local var_2_6 = var_5.DOCKYARD
		local var_2_7 = {
			selectedMin = 0,
			blockLock = true,
			destroyCheck = true,
		...
		i18n = var_2_10007
		var_2_7.leftTopInfo = var_2_10007("word_equipment_intensify")
		DockyardScene = var_7
		var_2_7.mode = var_7.MODE_MOD
		ShipStatus = var_7
		var_2_7.onShip = var_7.canDestroyShip
		...
		ShipStatus = var_7
		var_2_7.hideTagFlags = var_7.TAG_HIDE_DESTROY
	...
	arg_1_0:bind(var_0_1.MOD_SHIP, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.MOD_SHIP, {
			shipId = arg_5_1,
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.MOD_SHIP_DONE then
		...
		var_9_6(var_9_5, var_6("ship_shipModLayer_modSuccess"))
		...
		if 0 < var_9_7 then
			...
			local var_9_11 = var_7.New
			local var_9_12 = {}

			ResolveEquipmentLayer = iter_9_1
			var_9_12.viewComponent = iter_9_1
			ResolveEquipmentMediator = iter_9_1
			var_9_12.mediator = iter_9_1
			var_9_12.data = {
				Equipments = var_9_8
			}
