...
function var_0_1.EnterAnim(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = var_4_0(var_1_10004(arg_4_0._tf), 0, arg_4_1)
	local var_4_2 = var_3.setEase

	LeanTweenType = var_5

	local var_4_3 = var_4_2(var_4_1, var_5.easeInOutSine)
	local var_4_4 = var_3.setOnComplete

	System = var_5

	var_4_4(var_4_3, var_5.Action(function()
		if arg_4_2 then
			arg_4_2()
		end
...
function var_0_1.ExistAnim(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_1 = var_6_0(var_1_10004(arg_6_0._tf), 1000, arg_6_1)
	local var_6_2 = var_3.setEase

	LeanTweenType = var_5

	local var_6_3 = var_6_2(var_6_1, var_5.easeInOutSine)
...
function var_0_1.InitSkills(arg_10_0)
	...
	local var_10_4 = var_10_1(var_10_2.buff_list_display)
	...
	for iter_10_1 = 1, var_10_7 do
		...
		if iter_10_1 <= #var_10_4 then
			var_10_10 = var_10_4[iter_10_1]

			arg_10_0:UpdateSkill(var_10_9, var_10_10)
		else
			setActive = var_10_10

			var_10_10(var_10_9:Find("icon"), false)

			setActive = var_10_10

			var_10_10(var_10_9:Find("add"), true)
		end

		setActive = var_10_10

		var_10_10(var_10_9, iter_10_1 <= var_10_6)
	end
	...
	local var_10_11 = arg_10_0.skillArrRight
	local var_10_12 = #var_10_4

	var_6(var_10_11, 3 < var_10_12)
	...
	if #var_10_4 > 3 then
		...
		local var_10_13 = arg_10_0.skillRect

		typeof = var_8
		ScrollRect = var_9

		local var_10_14 = var_6(var_10_13, var_8(var_9)).onValueChanged

		var_6.RemoveAllListeners(var_10_14)
	end
...
function var_0_1.UpdateSkill(arg_13_0, arg_13_1, arg_13_2)
	...
	if var_3.isBluePrintGroup(var_13_0) then
		...
		for iter_13_0, iter_13_1 in var_3(var_4.getBluePrintChangeSkillList(var_13_1)) do
	...
	local function var_13_6()
		...
		local var_14_2 = var_2_10002.SHOW_SKILL_INFO
		...
		pg = var_5
		var_14_4.level = var_5.skill_data_template[var_13_3.id].max_level
	...
	var_5(var_13_4, var_13_5, var_13_6, var_1_10009)
