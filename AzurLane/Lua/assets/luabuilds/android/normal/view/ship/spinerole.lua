...
function var_0_0.Load(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	var_4.GetSpineChar(var_3_0, arg_3_0.prefabName, arg_3_2, function(arg_4_0)
		...
		if arg_3_0.state == var_0_0.STATE_DISPOSE then
			...
			GameObject = var_4_0
			var_4_1._modelRoot = var_4_0.New(arg_3_0.prefabName .. "_root")
			...
			Vector3 = var_4_9
			var_4_10.localPosition = var_4_9.zero
			setActive = var_4_10
...
function var_0_0.LoadLite(arg_5_0, arg_5_1, arg_5_2)
	...
	var_3.GetSpineChar(var_5_0, arg_5_0.prefabName, arg_5_2, function(arg_6_0)
		...
		if arg_5_0.state == var_0_0.STATE_DISPOSE then
			...
			var_6_5(var_6_4, var_3.one)

			local var_6_6 = arg_5_0._model.transform

			Vector3 = var_6_4
			var_6_6.localPosition = var_6_4.zero
...
function var_0_0.AttachOrbit(arg_8_0, arg_8_1)
	...
	local var_8_2 = arg_8_0.GetAttachmentList(var_8_1)

	pairs = var_8_1

	for iter_8_0, iter_8_1 in var_8_1(var_8_2) do
		local var_8_3 = iter_8_1.config
		local var_8_4 = iter_8_1.index
		local var_8_5 = var_8_3[var_8_0]

		if var_8_0 ~= var_0_0.ORBIT_KEY_UI and var_8_5 == "" then
			var_8_5 = var_8_3.orbit_ui
			var_8_0 = var_0_0.ORBIT_KEY_UI
		end

		if var_8_5 ~= "" then
			local var_8_6 = var_8_3.orbit_ui_bound[1]
			local var_8_8

			if arg_8_0.ship then
				local var_8_7 = arg_8_0.ship

				if var_13.IsDoubleSkin(var_8_7) then
					var_8_8 = true
			...
			local var_8_9 = arg_8_0._modleGraphic.Skeleton
			local var_8_10 = var_14.FindBoneIndex(var_8_9, "char1_" .. var_8_6)
			local var_8_11 = arg_8_0._modleGraphic.Skeleton
			local var_8_12 = var_15.FindBoneIndex(var_8_11, "char2_" .. var_8_6)
			local var_8_13 = var_8_3.double_char_bone

			ys = var_17

			local var_8_14 = var_17.Battle.BattleResourceManager.GetOrbitPath(var_8_5)

			if var_8_8 and (var_8_10 >= 0 or var_8_12 > 0) or var_8_10 >= 0 and var_8_12 > 0 then
				if var_8_12 >= 0 and var_8_13 and #var_8_13 > 0 and var_8_13[1] == 1 then
					arg_8_0:loadOrbitUI(var_8_14, var_8_0, var_8_5, "char2" .. "_" .. var_8_6, var_8_4, var_8_3)
				end

				if var_8_13 and #var_8_13 > 0 and var_8_13[2] == 1 then
					arg_8_0:loadOrbitUI(var_8_14, var_8_0, var_8_5, var_8_6, var_8_4, var_8_3)
				end

				if var_8_10 >= 0 and var_8_13 and #var_8_13 > 0 and var_8_13[3] == 1 then
					arg_8_0:loadOrbitUI(var_8_14, var_8_0, var_8_5, "char1" .. "_" .. var_8_6, var_8_4, var_8_3)
				end
			else
				arg_8_0:loadOrbitUI(var_8_14, var_8_0, var_8_5, var_8_6, var_8_4, var_8_3)
			end
...
function var_0_0.loadOrbitUI(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6)
	...
	var_9_1(var_9_0, var_9_2, var_9_3, var_1_10011.Events.UnityAction_UnityEngine_Object(function(arg_10_0)
		tf = var_2_10001
...
function var_0_0.CreateOrbitUI(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5, arg_11_6, arg_11_7)
	...
	if arg_11_1 ~= 0 then
		for iter_11_0 = var_11_2.transform.childCount, 1, -1 do
			...
			local var_11_5 = var_18.GetChild(var_11_4, iter_11_0 - 1)

			if iter_11_0 ~= arg_11_1 then
				Destroy = var_11_4

				var_11_4(var_11_5.gameObject)
			else
				local var_11_6 = var_11_5
				local var_11_7 = var_11_5.GetComponent

				typeof = var_1_10021
				Canvas = var_1_10022

				if var_11_7(var_11_6, var_1_10021(var_1_10022)) then
					var_11_3 = var_19.sortingOrder
					RemoveComponent = var_11_6

					var_11_6(var_11_5.transform, "Canvas")
				end
			end
		end
	else
		local var_11_8 = var_11_2.transform

		var_1_10015 = var_13.GetChild(var_11_8, 0)

		local var_11_9 = var_13.GetComponent

		typeof = var_1_10016
		Canvas = iter_11_0

		if var_11_9(var_1_10015, var_1_10016(iter_11_0)) then
			RemoveComponent = var_1_10015

			var_1_10015(var_13.transform, "Canvas")
		end
	end

	local var_11_10 = var_11_2
	local var_11_11 = var_11_2.GetComponentsInChildren

	typeof = var_1_10015
	Spine = var_1_10016

	local var_11_12 = var_11_11(var_11_10, var_1_10015(var_1_10016.Unity.SkeletonGraphic))
	local var_11_13 = var_13.ToTable(var_11_12)

	ipairs = var_11_12

	for iter_11_1, iter_11_2 in var_11_12(var_11_13) do
		iter_11_2.raycastTarget = false
	end

	local var_11_14 = var_11_2.transform

	Vector2 = var_15
	var_11_14.localPosition = var_15(var_11_1[1], var_11_1[2])

	local var_11_15 = var_11_2.transform

	Vector3 = var_15
	var_11_15.localScale = var_15.one
	SpineAnimUI = var_11_15

	local var_11_16 = var_11_15.AddFollower(arg_11_5, arg_11_0._model.transform, var_11_2.transform)

	arg_11_0._attachmentList[var_11_16] = {
	...
	local var_11_17 = var_11_16:GetComponent("Spine.Unity.BoneFollowerGraphic")

	var_11_17.followSkeletonFlip = false

	local var_11_18

	if arg_11_7.orbit_rotate_ui ~= "" and arg_11_7.orbit_rotate_ui == true then
		var_11_17.followBoneRotation = true
		var_11_18 = var_11_2.transform.localEulerAngles

		local var_11_19 = var_11_2.transform

		Vector3 = iter_11_2
		var_11_19.localEulerAngles = iter_11_2(var_11_18.x, var_11_18.y, var_11_18.z - 90)
	else
		var_11_17.followBoneRotation = false
	end

	if var_11_3 and var_11_3 < 0 then
		var_11_16:SetParent(arg_11_0._modelRoot.transform, false)
		var_11_16:SetAsFirstSibling()
	elseif var_11_3 and 0 < var_11_3 then
		var_11_16:SetParent(arg_11_0._modelRoot.transform, false)
		var_11_16:SetAsLastSibling()
	...
	var_11_18(var_11_16, false)

	onNextTick = var_11_18

	var_11_18(function()
		SetActive = var_2_10000

		var_2_10000(var_11_16, arg_11_0._visible)
...
function var_0_0.SetParent(arg_23_0, arg_23_1, arg_23_2)
	...
	if arg_23_0.CheckInited(var_23_0) then
		...
		var_3(var_23_1, var_5(arg_23_1), arg_23_2 and true or false)
	end
...
function var_0_0.SetVisible(arg_28_0, arg_28_1)
	...
	if arg_28_0.CheckInited(var_28_0) then
		arg_28_0._visible = arg_28_1
		arg_28_0._orbitVisible = arg_28_1

		local var_28_1 = arg_28_0._modleGraphic

		Color = var_28_0
		var_28_1.color = var_28_0.New(1, 1, 1, arg_28_1 and 1 or 0)
		pairs = var_28_1

		for iter_28_0, iter_28_1 in var_28_1(arg_28_0._attachmentList) do
			SetActive = var_7
...
function var_0_0.SetAction(arg_30_0, arg_30_1)
	...
	local var_30_1, var_30_2 = var_3.GetCharAnimationDirect(arg_30_0._modleGraphic, var_30_0, arg_30_1)
	...
	if var_30_2 then
		...
		Vector3 = var_6
		math = var_1_10007
		var_30_3.localScale = var_6(var_30_0 * var_1_10007.abs(arg_30_0._modelScale.x), arg_30_0._modelScale.y, arg_30_0._modelScale.z)
	else
...
function var_0_0.HiddenAttachmentByAction(arg_35_0, arg_35_1)
	...
	for iter_35_0, iter_35_1 in var_1_10002(arg_35_0._attachmentList) do
		...
		table = var_1_10009
		var_1_10009 = not var_1_10009.contains(iter_35_1.hiddenActionList, arg_35_1) and arg_35_0._orbitVisible

		var_1_10007(var_35_0, var_1_10009)
	end
...
function var_0_0.TweenShining(arg_43_0, arg_43_1, arg_43_2, arg_43_3, arg_43_4, arg_43_5, arg_43_6, arg_43_7, arg_43_8, arg_43_9, arg_43_10)
	if arg_43_0:CheckInited() then
		...
		arg_43_0.StopTweenShining(var_43_0)

		local var_43_1 = arg_43_0._modleGraphic.material

		LeanTween = var_43_0

		local var_43_2 = var_43_0.value(arg_43_0._modelRoot, arg_43_3, arg_43_4, arg_43_1)
		local var_43_3 = var_12.setEase

		LeanTweenType = var_14

		local var_43_4 = var_43_3(var_43_2, var_14.easeInOutSine)
		local var_43_5 = var_12.setOnUpdate

		System = var_14

		local var_43_6 = var_43_5(var_43_4, var_14.Action_float(function(arg_44_0)
			local var_44_0

			if arg_43_7 then
				var_2_10002 = var_43_1
				var_44_0 = var_44_0.SetColor

				local var_44_1 = "_Color"

				Color = var_2_10004

				var_44_0(var_2_10002, var_44_1, var_2_10004.Lerp(arg_43_5, arg_43_6, arg_44_0))
			else
				var_44_0 = arg_43_0._modleGraphic
				Color = var_2_10002
				var_44_0.color = var_2_10002.Lerp(arg_43_5, arg_43_6, arg_44_0)
			end

			existCall = var_44_0

			var_44_0(arg_43_9, arg_44_0)

			return
		end))
		local var_43_7 = var_12.setOnComplete

		System = var_14

		local var_43_8 = var_43_7(var_43_6, var_14.Action(function()
		...
		if arg_43_2 then
			var_43_8:setLoopPingPong(arg_43_2)
		end

		arg_43_0._tweenShiningId = var_43_8.uniqueId
	end
...
function var_0_0.CreateInterface(arg_49_0)
	...
	Vector3 = var_49_0
	var_49_1.localPosition = var_49_0.zero
	...
	local var_49_4 = var_1(var_49_3, var_3(var_4))

	Vector2 = var_49_3
	var_49_4.pivot = var_49_3(0.5, 0)
	Vector2 = var_2
...
function var_0_0.EnableInterface(arg_52_0)
	...
	typeof = var_1_10003
	Image = var_1_10004
	var_52_1(var_52_0, var_1_10003(var_1_10004)).enabled = true
...
function var_0_0.DisableInterface(arg_53_0)
	...
	typeof = var_1_10003
	Image = var_1_10004
	var_53_1(var_53_0, var_1_10003(var_1_10004)).enabled = false
...
function var_0_0.Dispose(arg_54_0)
	if arg_54_0.state == var_0_0.STATE_INITED then
		...
		var_54_3(var_54_2, var_54_4, var_4.New(0, 0, 0, 0))

		local var_54_5 = arg_54_0._modleGraphic

		Color = var_54_2
		var_54_5.color = var_54_2.New(1, 1, 1, 1)
		pairs = var_54_5
