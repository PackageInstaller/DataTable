...
function var_0_1.init(arg_2_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.iconType = var_2_14(var_2_13, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.imageBg = var_2_16(var_2_15, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.iconShip = var_2_18(var_2_17, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.labelName = var_2_20(var_2_19, var_3(var_1_10004))
	findTF = var_1
	...
	arg_2_0.scrollText = var_2_22(var_2_21, var_3(var_1_10004))
	findTF = var_1
	...
	local var_2_26 = var_3(var_1_10004)
	local var_2_27 = var_3.getRawData(var_2_26)

	var_1(var_2_25, var_3.IsOpenShipEvaluationImpeach(var_2_27))
...
function var_0_1.didEnter(arg_4_0)
	...
	local var_4_5 = var_3.Find(var_4_4, "mainPanel/bg/top_panel/btnBack")
	...
	local function var_4_9()
		...
		i18n = var_2_10003
		var_7_2.helps = var_2_10003("report_sent_help")
	...
	local function var_4_15()
		...
		if var_1.len(var_9_0) > 0 then
			...
			var_9_3(var_9_2, var_2_10003("eva_comment_send_null"))
		end
	...
	var_1_10001(var_4_13, var_4_14, var_4_15, var_5)
	...
	var_1_10001(arg_4_0, arg_4_0.input, function()
		...
		if var_10_1 then
			...
			var_10_3(var_10_4, var_2_10005.red)
			...
			var_10_3(var_10_6, var_2_10005.white)
...
function var_0_1.flushShip(arg_14_0)
	...
	setShipCardFrame = var_14_3

	var_14_3(arg_14_0.imageFrame, var_14_4, nil)

	GetImageSpriteFromAtlasAsync = var_14_3

	var_14_3("bg/star_level_card_" .. var_14_4, "", arg_14_0.imageBg)

	local var_14_5 = arg_14_0.iconShip

	GetSpriteFromAtlas = var_5
	var_14_5.sprite = var_5("shipYardIcon/unknown", "")
	...
	if not var_14_9(var_14_11, var_14_7(var_7.getShipType(var_14_12, arg_14_0.showTrans))) then
		warning = var_14_11

		var_14_11("找不到船形, shipConfigId: " .. var_14_0.id)
	end
	...
	for iter_14_0 = arg_14_0.stars.childCount, var_14_14 - 1 do
		...
		var_1_10011 = var_1_10011(arg_14_0.star, arg_14_0.stars)
	end
...
function var_0_1.flushEva(arg_16_0)
	...
	for iter_16_0 = 1, arg_16_0.hotContent.childCount do
		...
		if var_1_10007(var_8.GetChild(var_16_2, iter_16_0 - 1)).name ~= "tag" then
			Destroy = var_8
	...
	for iter_16_1 = 1, arg_16_0.commonContent.childCount do
		...
		if var_1_10007(var_8.GetChild(var_16_3, iter_16_1 - 1)).name ~= "tag" then
			Destroy = var_8
	...
	for iter_16_2 = 1, #var_16_1 do
		...
		if var_16_1[iter_16_2].hot then
			cloneTplTo = var_10
			var_16_7 = var_10(arg_16_0.hotTpl, arg_16_0.hotContent)
		else
			cloneTplTo = var_10
			var_16_7 = var_10(arg_16_0.commonTpl, arg_16_0.commonContent)
		end

		local var_16_8 = var_16_7:Find("bg/evaluation")
		local var_16_9 = var_10.GetComponent

		typeof = var_12
		Text = var_1_10013

		local var_16_10 = var_16_9(var_16_8, var_12(var_1_10013))
		local var_16_11 = var_16_7:Find("bg/name")

		var_1_10013 = var_16_7

		local var_16_12 = var_16_7.Find(var_1_10013, "bg/zan_bg/Text")

		setText = var_1_10013

		var_1_10013(var_16_11, var_9.nick_name .. ":")

		setText = var_1_10013

		var_1_10013(var_16_12, var_9.good_count - var_9.bad_count)

		var_16_10.supportRichText = false
		var_16_10.text = var_9.context

		function var_1_10013(arg_17_0)
			if not var_0.izan then
				...
				var_17_2(var_17_1, var_2_10003("zan_ship_eva_error_7"))
			end
		...
		local var_16_14 = var_16_7:Find("bg/zan_bg/up")
		...
		var_14(var_16_13, var_16_14, var_16_15, var_18)

		onButton = var_14

		local var_16_16 = arg_16_0
		local var_16_17 = var_16_7:Find("bg/zan_bg/down")
		...
		var_14(var_16_16, var_16_17, var_16_18, var_18)

		onButton = var_14

		local var_16_19 = arg_16_0
		local var_16_20 = var_16_7:Find("bg/zan_bg/impeach")
		...
		var_14(var_16_19, var_16_20, var_16_21, var_18)

		SetActive = var_14

		local var_16_22 = var_16_7
		local var_16_23 = var_16_7.Find(var_16_22, "bg/zan_bg/down")

		defaultValue = var_16_22
		LOCK_DOWNVOTE = var_17

		var_14(var_16_23, not var_16_22(var_17, true))

		setActive = var_14

		var_14(var_16_7:Find("bg/zan_bg/impeach"), var_16_6)
	end

	local var_16_24 = 1

	for iter_16_3 = 1, arg_16_0.hotContent.childCount do
		local var_16_25 = arg_16_0.hotContent
		local var_16_26 = var_9.GetChild(var_16_25, iter_16_3 - 1)

		go = var_16_25

		if var_16_25(var_16_26).name ~= "tag" then
			setActive = var_10

			var_10(var_16_26:Find("print1"), var_16_24 % 2 ~= 0)

			setActive = var_10

			var_10(var_16_26:Find("print2"), var_16_24 % 2 == 0)
	...
	local var_16_27 = arg_16_0.hotContent

	var_5(var_6.Find(var_16_27, "tag"), arg_16_0.hotContent.childCount > 1)

	setActive = var_5

	local var_16_28 = arg_16_0.commonContent

	var_5(var_6.Find(var_16_28, "tag"), arg_16_0.commonContent.childCount > 1)

	local var_16_29 = arg_16_0.hotContent
	local var_16_30 = var_5.Find(var_16_29, "tag")

	var_5.SetAsLastSibling(var_16_30)

	local var_16_31 = arg_16_0.commonContent
	local var_16_32 = var_5.Find(var_16_31, "tag")

	var_5.SetAsLastSibling(var_16_32)
...
function var_0_1.initImpeachPanel(arg_21_0)
	...
	local var_21_2 = var_2.Find(var_21_1, "window/top/bg/impeach/title")

	i18n = var_21_1

	var_1(var_21_2, var_21_1("report_sent_title"))

	onButton = var_1

	local var_21_3 = arg_21_0
	local var_21_4 = arg_21_0.impackPanel
	local var_21_5 = var_3.Find(var_21_4, "window/top/btnBack")
	...
	var_1(var_21_3, var_21_5, var_21_6, var_5)
	...
	local var_21_10 = var_21_8.Find(var_21_9, "title")

	i18n = var_21_9

	var_21_7(var_21_10, var_21_9("report_sent_desc"))

	UIItemList = var_21_7

	local var_21_11 = var_21_7.New(var_21_8:Find("options"), var_21_8:Find("options/tpl"))

	var_2.make(var_21_11, function(arg_23_0, arg_23_1, arg_23_2)
		arg_23_1 = arg_23_1 + 1
		...
		if arg_23_0 == var_2_10003.EventUpdate then
			...
			local var_23_1 = arg_23_2.Find(var_23_0, "Text")

			i18n = var_23_0

			var_3(var_23_1, var_23_0("report_type_" .. arg_23_1))

			setText = var_3

			local var_23_2 = arg_23_2
			local var_23_3 = arg_23_2.Find(var_23_2, "Text_2")

			i18n = var_23_2

			var_3(var_23_3, var_23_2("report_type_" .. arg_23_1 .. "_1"))
	...
	local var_21_12 = var_21_8
	local var_21_13 = var_21_8.Find(var_21_12, "other/field/Text")

	i18n = var_21_12

	var_3(var_21_13, var_21_12("report_type_other"))

	setText = var_3

	local var_21_14 = var_21_8
	local var_21_15 = var_21_8.Find(var_21_14, "other/field/input/Placeholder")

	i18n = var_21_14

	var_3(var_21_15, var_21_14("report_type_other_1"))
	...
	var_3(arg_21_0, var_21_8:Find("other"), function(arg_25_0)
		...
		var_25_0(var_2.Find(var_25_1, "other/field/input"), arg_25_0)

		return
	end)

	local var_21_16 = var_21_8
	local var_21_17 = var_21_8.Find(var_21_16, "other/field/input")

	onInputChanged = var_21_16

	var_21_16(arg_21_0, var_21_17, function()
		Canvas = var_2_10000
	...
	local var_21_19 = arg_21_0.impackPanel
	local var_21_20 = var_6.Find(var_21_19, "window/button_container/button")

	local function var_21_21()
		if arg_21_0.impeachOption == "other" then
			getInputText = var_0

			local var_27_0 = var_0(var_21_17)

			string = var_1

			local var_27_2

			if var_1.len(var_27_0) > 0 then
				local var_27_1 = arg_21_0

				var_27_2 = var_27_2.emit
				var_2_10003 = var_0_1.EVENT_IMPEACH
				var_2_10004 = arg_21_0.targetEvaId
				i18n = var_2_10005

				var_27_2(var_27_1, var_2_10003, var_2_10004, var_2_10005("report_type_other") .. ":" .. var_27_0)
			else
				pg = var_27_2
				...
				var_27_4(var_27_3, var_2_10003("report_type_other_2"))
			...
			var_27_6(var_27_5, var_27_7, var_27_8, var_2_10004("report_type_" .. arg_21_0.impeachOption))
		end
	...
	var_21_16(var_21_18, var_21_20, var_21_21, var_8)
...
function var_0_1.openImpeachPanel(arg_28_0, arg_28_1)
	...
	var_1_10002(var_3.Find(var_28_0, "window/msg_panel/content/other"), true)

	triggerToggle = var_1_10002

	local var_28_1 = arg_28_0.impackPanel

	var_1_10002(var_3.Find(var_28_1, "window/msg_panel/content/options/tpl"), true)
