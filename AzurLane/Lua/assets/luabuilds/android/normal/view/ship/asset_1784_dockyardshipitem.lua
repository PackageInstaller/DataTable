...
COLOR_RED = var_0_10002
var_0_1[1] = var_0_10002
COLOR_BLUE = var_0_10002
var_0_1[2] = var_0_10002
COLOR_YELLOW = var_0_10002
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_4(var_5(arg_1_0.content, "dockyard"), true)

	setActive = var_4
	findTF = var_5

	var_4(var_5(arg_1_0.content, "collection"), false)
	...
	typeof = var_6
	RectMask2D = var_7
	arg_1_0.iconStatusMask = var_1_3(var_1_2, var_6(var_7))
	findTF = var_4
	...
	if arg_1_0.userTF then
		...
		typeof = var_6
		Image = var_7
		arg_1_0.userIconTF = var_1_9(var_1_8, var_6(var_7))
		...
		typeof = var_6
		Text = var_7
		arg_1_0.userNameTF = var_1_9(var_1_11, var_6(var_7))
		findTF = var_1_9
...
function var_0_0.update(arg_2_0, arg_2_1)
	...
	if arg_2_0.proposeModel then
		...
		local var_2_1 = var_2_0(var_3(arg_2_0.proposeModel), 0, 1, 0.4)
		local var_2_2 = var_2.setOnUpdate

		System = var_4

		var_2_2(var_2_1, var_4.Action_float(function(arg_3_0)
...
function var_0_0.updateSelected(arg_5_0, arg_5_1)
	...
	if arg_5_0.selected then
		if not arg_5_0.selectedTwId then
			...
			local var_5_4 = var_5_3(var_5_2, var_4.easeInOutSine)
...
function var_0_0.flush(arg_6_0)
	...
	if var_1_10002(var_6_0) then
		...
		flushShipCard = var_6_1

		var_6_1(arg_6_0.tr, var_6_0)
		...
		if arg_6_0.lock then
			...
			local var_6_7 = var_6_0.GetLockState(var_6_6)

			Ship = var_6_6

			var_6_5(var_6_4, var_6_7 == var_6_6.LOCK_STATE_LOCK)
		end

		local var_6_8 = var_6_0.energy

		Ship = var_6_4

		if var_6_8 <= var_6_4.ENERGY_MID then
		...
		local var_6_9 = arg_6_0.nameTF
		local var_6_10 = var_6_0
		local var_6_11 = var_6_0.GetColorName

		shortenString = var_1_10010

		local var_6_12 = var_6_0
		local var_6_13 = var_6_0.getName(var_6_12)

		PLATFORM_CODE = var_6_12
		PLATFORM_US = var_1_10013

		var_6(var_6_9, var_6_11(var_6_10, var_1_10010(var_6_13, var_6_12 == var_1_10013 and 6 or 7)))
		...
		if var_6_0.user then
			Clone = var_6_15
			var_6_15 = var_6_15(var_6_0)
			GuildAssaultFleet = var_8
			var_6_15.id = var_8.GetRealId(var_6_15.id)
			ShipStatus = var_8
			var_6_14 = var_8.ShipStatusToTag(var_6_15, arg_6_0.hideTagFlags)
		else
			ShipStatus = var_6_15
			var_6_14 = var_6_15.ShipStatusToTag(var_6_0, arg_6_0.hideTagFlags)
		end

		if var_6_14 then
			var_6_15 = arg_6_0.iconStatusTxt
			var_6_15.text = var_6_14[3]
			GetSpriteFromAtlasAsync = var_6_15

			var_6_15(var_6_14[1], var_6_14[2], function(arg_7_0)
				...
				if var_6_14[1] == "shipstatus" then
					local var_7_0 = arg_6_0.iconStatus

					Vector2 = var_2
					var_7_0.sizeDelta = var_2(195, 36)
			...
			var_6_15(arg_6_0.iconStatus, false)
		end

		LOCK_PROPOSE = var_6_15
		...
		if not var_6_15 then
			...
			elseif arg_6_0:CheckHeartState() and not arg_6_0.heartLoading then
				...
				local var_6_16 = var_7.PoolMgr.GetInstance()

				var_7.GetUI(var_6_16, "heartShipCard", false, function(arg_8_0)
					if arg_6_0.isClear or arg_6_0.proposeModel then
						pg = var_1
						var_2_10002 = var_1.PoolMgr.GetInstance()

						var_1.ReturnUI(var_2_10002, "heartShipCard", arg_8_0)
					else
						...
						var_8_0.sg = var_2_10002(arg_6_0.proposeModel, "SkeletonGraphic")

						local var_8_1 = arg_6_0.proposeModel.transform

						var_1.SetParent(var_8_1, arg_6_0.proposeTF, false)

						local var_8_2 = arg_6_0.sg
						local var_8_3 = arg_6_0

						var_8_2.enabled = var_2.CheckHeartState(var_8_3)
	...
	local var_6_17 = arg_6_0.content

	var_3.SetActive(var_6_17, var_2)

	local var_6_18 = arg_6_0.quit

	var_3.SetActive(var_6_18, not var_2)

	local var_6_19 = arg_6_0.btn
	local var_6_20

	if not var_2 or not arg_6_0.imageFrame then
		var_6_20 = arg_6_0.imageQuit
	end

	var_6_19.targetGraphic = var_6_20
...
function var_0_0.updateNpcTfPosY(arg_10_0)
	...
	if var_1_10001(arg_10_0.npc) then
		...
		local var_10_1 = var_2(arg_10_0.tr, "content/energy")
...
function var_0_0.UpdateUser(arg_11_0, arg_11_1)
	...
	if arg_11_0.userIconFrame.childCount > 0 then
		local var_11_0 = arg_11_0.userIconFrame

		var_11_1 = var_11_1.GetChild(var_11_0, 0).gameObject
		PoolMgr = var_11_0
		var_1_10004 = var_11_0.GetInstance()

		var_3.ReturnPrefab(var_1_10004, "IconFrame/" .. var_11_1.name, var_11_1.name, var_11_1)
	end
	...
	var_1_10004(arg_11_0.userTF, var_11_3 and arg_11_0.detailType == var_0_0.DetailType0)

	setActive = var_1_10004

	var_1_10004(arg_11_0.userNameTF.gameObject.transform.parent, var_11_3)
	...
	if var_11_3 and var_11_2 ~= arg_11_0.user then
		...
		local var_11_4 = "qicon/"
		local var_11_5 = var_1_10004

		var_5(var_11_4 .. var_1_10004.getPrefab(var_11_5), function(arg_12_0)
		...
		local var_11_6 = var_5.attireFrameRes
		local var_11_7 = var_11_2
		local var_11_8 = false

		AttireConst = var_11_5

		local var_11_9 = var_11_6(var_11_7, var_11_8, var_11_5.TYPE_ICON_FRAME, var_11_2.propose)

		PoolMgr = var_11_7

		local var_11_10 = var_11_7.GetInstance()

		var_6.GetPrefab(var_11_10, "IconFrame/" .. var_11_9, var_11_9, true, function(arg_13_0)
			IsNil = var_2_10001
			...
			if arg_11_0.userIconFrame then
				...
				var_1.ReturnPrefab(var_13_0, "IconFrame/" .. var_11_9, var_11_9, arg_13_0)
			end

			return
		end)

		local var_11_11 = arg_11_0.userNameTF

		var_11_11.text = var_11_2.name
		arg_11_0.user = var_11_2
		setAnchoredPosition = var_11_11

		var_11_11(arg_11_0.levelTF, {
			x = -108
		})
	else
		setAnchoredPosition = var_1_10004

		var_1_10004(arg_11_0.levelTF, {
			x = -16
		})
	end
...
function var_0_0.flushDetail(arg_14_0)
	...
	if var_1_10002(var_14_0) and arg_14_0.detailType > var_0_0.DetailType0 then
		...
		for iter_14_0 = 1, 6 do
			...
			TextAnchor = var_14_13
			var_14_12.alignment = var_14_13.MiddleLeft
			TextAnchor = var_16
			...
			if arg_14_0.detailType == var_0_0.DetailType1 then
				if iter_14_0 == 6 then
					...
					var_14_17, var_14_16 = var_14_17.getIntimacyDetail(var_14_16)
					AttributeType = var_1_10019
					var_14_12.text = var_1_10019.Type2Name(var_14_15)
					setColorStr = var_1_10019
					var_1_10020 = var_14_16

					if var_14_17 <= var_14_16 then
						COLOR_GREEN = var_1_10021

						if not var_1_10021 then
							COLOR_WHITE = var_1_10021
						end

						var_14_14.text = var_1_10019(var_1_10020, var_1_10021)

						goto label_14_0

						tostring = var_14_17
						math = var_14_16
						var_14_17 = var_14_17(var_14_16.floor(var_14_1[var_14_15]))
						AttributeType = var_18
						var_14_12.text = var_18.Type2Name(var_14_15)
						setColorStr = var_18
						var_1_10019 = var_14_17
						var_1_10021 = arg_14_0

						if arg_14_0.canModAttr(var_1_10021, var_14_0, var_14_15, var_14_1) then
							...
							var_14_14.text = var_18(var_1_10019, var_1_10020)
							...
							if arg_14_0.detailType == var_0_0.DetailType2 then
								...
								if iter_14_0 == 1 then
									TextAnchor = var_14_17
									var_14_12.alignment = var_14_17.MiddleCenter
									var_14_18 = var_14_0
									var_14_12.text = var_14_0.getShipArmorName(var_14_18)
									var_14_14.text = ""
								elseif iter_14_0 == 5 then
									var_14_18 = var_14_0
									var_14_17 = var_14_0.getBattleTotalExpend(var_14_18)
									AttributeType = var_14_18
									var_14_18 = var_14_18.Type2Name
									AttributeType = var_1_10019
									var_14_12.text = var_14_18(var_1_10019.Expend)
									tostring = var_14_18
									math = var_1_10019
									var_14_14.text = var_14_18(var_1_10019.floor(var_14_17))
								elseif iter_14_0 == 6 then
									setColorStr = var_14_17
									i18n = var_14_18

									local var_14_19 = var_14_18("word_synthesize_power")

									COLOR_GREEN = var_1_10019
									var_14_12.text = var_14_17(var_14_19, var_1_10019)
									tostring = var_14_17
									var_14_14.text = var_14_17(var_14_5)
								else
									AttributeType = var_14_17
									var_14_12.text = var_14_17.Type2Name(var_14_15)
									tostring = var_14_17
									math = var_18
									var_14_14.text = var_14_17(var_18.floor(var_14_1[var_14_15]))
								end
							elseif arg_14_0.detailType == var_0_0.DetailType3 then
								if var_14_6[iter_14_0] and var_14_0.skills[var_14_17] and var_14_7[var_14_17].max_level ~= 1 then
									local var_14_20 = var_14_0.skills[var_14_17]
									...
									i18n = var_1_10021
									var_14_12.text = var_1_10020(var_1_10021("skill") .. iter_14_0, var_1_10019)
									var_1_10020 = var_14_20.level == var_14_7[var_14_17].max_level and "Lv.Max" or "Lv." .. var_14_20.level
									setColorStr = var_1_10021
									var_14_14.text = var_1_10021(var_1_10020, var_1_10019)
								else
									var_14_10 = false
								end
							end
...
function var_0_0.UpdateRecommandTag(arg_15_0, arg_15_1)
	if arg_15_1 and arg_15_0.tagRecommand then
		...
		var_3(arg_15_0.tagRecommand, var_15_0)
	end
...
function var_0_0.updateWorld(arg_18_0)
	...
	if var_1.getFlag(var_18_0, "inWorld") then
		...
		var_18_4(var_18_3, var_18_1:IsHpSafe())
		...
		var_18_4(var_18_6, not var_18_1.IsHpSafe(var_18_7))
		...
		local var_18_10 = var_18_9(var_18_8, var_7(var_18_7))
		...
		var_18_10(var_6.Find(var_18_11, "broken"), var_18_1:IsBroken())
...
function var_0_0.UpdateExpBuff(arg_19_0)
	...
	local var_19_2 = var_2.getBuffShipList(var_19_1)
	local var_19_3 = var_19_0
	local var_19_4 = var_19_2[var_19_0.getGroupId(var_19_3)]

	setActive = var_19_3

	var_19_3(arg_19_0.expBuff, false)

	setActive = var_19_3

	var_19_3(arg_19_0.expBuff, var_19_4 ~= nil)

	if var_19_4 then
		local var_19_5 = var_19_4 / 100
		local var_19_6 = var_19_4 % 100

		tostring = var_6

		local var_19_7 = var_6(var_19_5)
		local var_19_8
		...
		if 0 < var_19_6 then
			...
			var_19_7 = var_19_8 .. var_19_9 .. var_1_10009(var_19_6)
		end

		setText = var_19_8

		local var_19_10 = arg_19_0.expBuff
		local var_19_11 = var_8.Find(var_19_10, "text")

		string = var_19_10

		var_19_8(var_19_11, var_19_10.format("EXP +%s%%", var_19_7))
	end
...
function var_0_0.updateIntimacy(arg_21_0, arg_21_1)
	...
	if var_4(var_21_0) then
		findTF = var_4
		arg_21_0.intimacyTF = var_4(arg_21_0.tr, "content/intimacy_with_energy")
		setActive = var_4
		findTF = var_5

		var_4(var_5(arg_21_0.tr, "content/intimacy"), false)
	else
		findTF = var_4
		...
		var_4(var_5(arg_21_0.tr, "content/intimacy_with_energy"), false)
	end

	local var_21_1, var_21_2 = var_2:getIntimacyDetail()

	setText = var_1_10006
	findTF = var_1_10007

	var_1_10006(var_1_10007(arg_21_0.intimacyTF, "Text"), var_21_2)

	if var_21_2 == 100 or var_21_2 == 200 then
		setText = var_1_10006
		findTF = var_7

		local var_21_3 = var_7(arg_21_0.intimacyTF, "Text")

		setColorStr = var_8

		var_1_10006(var_21_3, var_8(var_21_2, "#ff8d8d"))
	end

	setActive = var_1_10006

	var_1_10006(arg_21_0.intimacyTF, arg_21_1)
...
function var_0_0.updateIntimacyEnergy(arg_22_0, arg_22_1)
	...
	var_4(var_5.Find(var_22_3, "content/energy"), var_22_2 and arg_22_1)

	if arg_22_1 then
		tobool = var_4

		if var_4(var_22_2) then
