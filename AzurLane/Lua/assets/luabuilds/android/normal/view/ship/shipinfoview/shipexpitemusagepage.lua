...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.expTxt = var_2_9(var_2_8, var_3(var_1_10004))
	...
	typeof = var_3
	Slider = var_1_10004
	arg_2_0.currentProgress = var_2_12(var_2_11, var_3(var_1_10004))
	...
	typeof = var_3
	Slider = var_1_10004
	arg_2_0.tipProgress = var_2_15(var_2_14, var_3(var_1_10004))
	...
	typeof = var_3
	Slider = var_1_10004
	arg_2_0.previewProgress = var_2_18(var_2_17, var_3(var_1_10004))
	...
	if #arg_2_0.itemIds <= 3 then
		...
		local var_2_21 = var_3.Find(var_2_20, "frame/content/items")
		local var_2_22 = arg_2_0._tf

		arg_2_0.uiItemList = var_2_19(var_2_21, var_4.Find(var_2_22, "frame/content/items/tpl"))
	else
		UIItemList = var_2_19
		var_2_19 = var_2_19.New

		local var_2_23 = arg_2_0._tf
		local var_2_24 = var_3.Find(var_2_23, "frame/content/scrollrect/content")
		local var_2_25 = arg_2_0._tf

		arg_2_0.uiItemList = var_2_19(var_2_24, var_4.Find(var_2_25, "frame/content/items/tpl"))
	end
	...
	var_2_19(var_3.Find(var_2_26, "frame/content/items"), var_1)

	setActive = var_2_19

	local var_2_27 = arg_2_0._tf

	var_2_19(var_3.Find(var_2_27, "frame/content/scrollrect"), not var_1)

	setText = var_2_19

	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_3.Find(var_2_28, "frame/top/bg/infomation/title")

	i18n = var_2_28

	var_2_19(var_2_29, var_2_28("ship_exp_item_title"))

	setText = var_2_19

	local var_2_30 = arg_2_0._tf
	local var_2_31 = var_3.Find(var_2_30, "frame/content/label")

	i18n = var_2_30

	var_2_19(var_2_31, var_2_30("coures_level_tip"))
	...
	var_2_19(var_2_33, var_2_32("ship_exp_item_label_confirm"))

	setText = var_2_19

	local var_2_34 = arg_2_0.recomBtn
	local var_2_35 = var_3.Find(var_2_34, "pic")

	i18n = var_2_34

	var_2_19(var_2_35, var_2_34("ship_exp_item_label_recom"))

	setText = var_2_19

	local var_2_36 = arg_2_0.clearBtn
	local var_2_37 = var_3.Find(var_2_36, "pic")

	i18n = var_2_36

	var_2_19(var_2_37, var_2_36("ship_exp_item_label_clear"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		...
		for iter_6_0, iter_6_1 in var_6_0(arg_3_0.cards) do
			local var_6_2
	...
	local function var_3_14()
		...
		if var_8_0(var_2_10001.values(arg_3_0.itemCnts), function(arg_9_0)
			return arg_9_0 == 0
		end) then
			pg = var_0
			...
			var_8_2(var_8_1, var_2("ship_remould_no_material"))
		...
		local function var_8_3(arg_10_0)
			...
			var_10_1(var_10_0, var_3_10003.ON_ADD_SHIP_EXP, arg_3_0.shipVO.id, arg_3_0.itemCnts)
		...
		local var_8_6 = var_8_4(arg_3_0.shipVO)
		...
		if var_8_8 and (var_2.maxLevel == var_2.level and var_2.exp > 0 or var_2.maxLevel < var_2.level) then
			...
			i18n = var_2_10009
			var_8_12.content = var_2_10009("coures_exp_overflow_tip", var_2.exp)
...
function var_0_1.Recommand(arg_14_0)
	...
	local var_14_2 = var_3.map(arg_14_0:GetAllItemIDs(), function(arg_15_0)
	...
	local var_14_3 = var_4.sort
	local var_14_4 = var_14_2

	CompareFuncs = var_1_10006

	var_14_3(var_14_4, var_1_10006({
		function(arg_16_0)
			return -arg_16_0.id
		end
	}))
	...
	for iter_14_0, iter_14_1 in var_14_3(var_14_2) do
		var_14_0[iter_14_1.id] = 0

		local var_14_5 = iter_14_1:getConfig("usage_arg")

		if iter_14_0 < #var_14_2 then
			local var_14_6 = var_14_2[iter_14_0 + 1]
			local var_14_7

			if not var_10.getConfig(var_14_6, "usage_arg") then
				var_14_7 = 0
			end
			...
			for iter_14_2 = 1, iter_14_1.count do
				if iter_14_0 ~= #var_14_2 then
					...
					local var_14_9 = arg_14_0.PreCalcExpOverFlow

					var_1_10017 = var_14_1
					tonumber = var_1_10018
					var_1_10018 = var_1_10018(var_14_5)
					tonumber = var_19

					if var_14_9(var_14_8, var_1_10017, var_1_10018, var_19(var_14_7)) then
						do break end
						goto label_14_0
					end
				end
				...
				do
					local var_14_10 = var_14_1
					local var_14_11 = var_14_1.addExp

					tonumber = var_1_10017

					var_14_11(var_14_10, var_1_10017(var_14_5))
...
function var_0_1.GetAllItemIDs(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10003(var_18_0) do
		...
		if var_1_10008.getConfigData(iter_18_1) then
			...
			var_9.insert(var_18_1, iter_18_1)
		end
	end
...
function var_0_1.OnAddItem(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	if arg_26_0.shipVO.maxLevel == arg_26_0.shipVO.level then
		...
		var_26_1(var_26_0, var_1_10007("coures_tip_exceeded_lv"))
	...
	for iter_26_0, iter_26_1 in var_1_10007(arg_26_0.itemCnts) do
		if iter_26_0 ~= arg_26_2 then
			Item = var_1_10012
			var_1_10012 = var_1_10012.getConfigData(iter_26_0).usage_arg
			tonumber = var_13
			var_26_3 = var_26_3 + var_13(var_1_10012) * iter_26_1
		end
	end
	...
	elseif var_26_2.level ~= var_26_2.maxLevel then
		for iter_26_2 = 1, arg_26_3 do
			...
			var_26_7(var_26_6, var_1_10015(var_26_4))
...
function var_0_1.GetAdditionExp(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_1_10002(arg_28_0.itemCnts) do
		...
		tonumber = var_8
		var_28_0 = var_28_0 + var_8(var_1_10007) * iter_28_1
	end
...
function var_0_1.UpdateLevelInfo(arg_29_0)
	...
	var_29_4.text = var_29_5(var_29_6, var_29_7, var_1_10012, var_29_1, var_29_3)
