...
function var_0_1.register(arg_1_0)
	...
	pg = var_1_2
	arg_1_0.useItem = var_1_2.ship_data_create_material[1].use_item
	...
	var_1_12(var_1_11, var_1_10011.getCount(var_1_10))
	arg_1_0:bind(var_0_1.ON_SUPPORT_SHOP, function()
		...
		var_2_4.warp = var_2_10005.TYPE_MEDAL
	...
	arg_1_0:bind(var_0_1.OPEN_DESTROY, function(arg_3_0)
		...
		local var_3_3 = var_2_10004.DOCKYARD
		local var_3_4 = {
			blockLock = true
		}

		DockyardScene = var_2_10006
		var_3_4.mode = var_2_10006.MODE_DESTROY
		getGameset = var_6
		var_3_4.selectedMax = var_6("ship_select_limit")[1]
		i18n = var_6
		var_3_4.leftTopInfo = var_6("word_destroy")
		ShipStatus = var_6
		var_3_4.onShip = var_6.canDestroyShip
		pg = var_6

		local var_3_5 = var_6.ShipFlagMgr.GetInstance()

		var_3_4.ignoredIds = var_6.FilterShips(var_3_5, {
			isActivityNpc = true
		})
	...
	arg_1_0:bind(var_0_1.OPEN_PROJECT_LIST, function(arg_4_0)
		...
		if var_4_1(var_4_0, var_2_10003.__cname) then
			return
		end
		...
		local var_4_4 = var_3.New
		local var_4_5 = {}

		BuildShipDetailMediator = var_2_10005
		var_4_5.mediator = var_2_10005
		BuildShipDetailLayer = var_2_10005
		var_4_5.viewComponent = var_2_10005

		local var_4_6 = {}
		local var_4_7 = arg_1_0.viewComponent

		var_4_6.groupName = var_6.getGroupName(var_4_7)
	...
	arg_1_0:bind(var_0_1.REMOVE_PROJECT_LIST, function(arg_5_0)
		...
		if var_5_2(var_5_1, var_2_10005) then
			local var_5_3 = arg_1_0
			local var_5_4 = var_4.sendNotification

			GAME = var_2_10006

			var_5_4(var_5_3, var_2_10006.REMOVE_LAYERS, {
				context = var_3
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_BUILD, function(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
		...
		var_6_1(var_6_0, var_2_10006.BUILD_SHIP, {
			buildId = arg_6_1,
			count = arg_6_2,
			isTicket = arg_6_3
		})
	...
	arg_1_0:bind(var_0_1.ACT_ON_BUILD, function(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
		...
		var_7_1(var_7_0, var_2_10007.ACTIVITY_OPERATION, {
			cmd = 1,
			activity_id = arg_7_1,
			arg1 = arg_7_3,
	...
	arg_1_0:bind(var_0_1.ON_SUPPORT_EXCHANGE, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.SUPPORT_SHIP, {
			count = arg_8_1
		})
	...
	arg_1_0:bind(var_0_1.ON_UPDATE_ACT, function(arg_9_0)
		...
		local var_9_2 = var_2_10003(var_2_10004)

		var_9_1(var_9_0, var_3.GetPools(var_9_2))
	...
	arg_1_0:bind(var_0_1.OPEN_PRAY_PAGE, function(arg_10_0)
		...
		PrayPoolMediator = var_2_10005
		var_10_3.mediator = var_2_10005
		PrayPoolScene = var_2_10005
		var_10_3.viewComponent = var_2_10005

		local var_10_4 = {}
		local var_10_5 = arg_1_0.viewComponent

		var_10_4.groupName = var_6.getGroupName(var_10_5)
	...
	arg_1_0:bind(var_0_1.CLOSE_PRAY_PAGE, function(arg_11_0)
		...
		if var_11_2(var_11_1, var_2_10005) then
			local var_11_3 = arg_1_0
			local var_11_4 = var_4.sendNotification

			GAME = var_2_10006

			var_11_4(var_11_3, var_2_10006.REMOVE_LAYERS, {
				context = var_3
			})
		end
	...
	arg_1_0:bind(var_0_1.ON_BUILDPOOL_EXCHANGE, function(arg_13_0, arg_13_1)
		...
		var_13_1(var_13_0, var_2_10004.ACTIVITY_BUILD_POOL_EXCHANGE, {
	...
	arg_1_0:bind(var_0_1.ON_BUILDPOOL_UR_EXCHANGE, function(arg_14_0)
		...
		local var_14_2 = var_2_10003.New
		local var_14_3 = {}

		BuildShipRegularExchangeLayer = var_2_10005
		var_14_3.viewComponent = var_2_10005
		BuildShipRegularExchangeMediator = var_2_10005
		var_14_3.mediator = var_2_10005
	...
	getProxy = var_12
	BuildShipProxy = var_1_10013

	local var_1_17 = var_12(var_1_10013)

	var_1_16(var_1_15, var_12.GetPools(var_1_17))
...
function var_0_1.buildFinishComeback(arg_15_0)
	...
	if var_1_10002.getCount(var_15_0:getData()) == 0 and arg_15_0.viewComponent then
		...
		BuildShipScene = var_3

		local var_15_5

		if var_15_3 == var_3.PAGE_PRAY then
			getProxy = var_15_5
			ActivityProxy = var_15_2

			local var_15_4 = var_15_5(var_15_2)

			var_15_5 = var_15_5.getActivityById
			ActivityConst = var_1_10005

			if not var_15_5(var_15_4, var_1_10005.ACTIVITY_PRAY_POOL) or var_15_5:isEnd() then
				BuildShipScene = var_15_4
				var_15_3 = var_15_4.PAGE_BUILD
			end
		end
...
function var_0_1.handleNotification(arg_17_0, arg_17_1)
	...
	PlayerProxy = var_17_1

	if var_17_0 == var_17_1.UPDATED then
		var_1_10005 = arg_17_0.viewComponent

		var_4.setPlayer(var_1_10005, var_17_2)
	...
	if var_17_0 == var_4.CONFIRM_GET_SHIP then
		getProxy = var_4
		BuildShipProxy = var_1_10005
		var_1_10006 = var_4(var_1_10005)
		var_1_10005 = var_4.getFinishCount(var_1_10006)
		var_1_10007 = arg_17_0.viewComponent

		var_1_10006.updateQueueTip(var_1_10007, var_1_10005)

		var_1_10006 = {}

		if var_17_2.isBatch then
			local var_17_3 = var_4

			var_4.setSkipBatchBuildFlag(var_17_3, false)

			var_1_10007 = {}
			ipairs = var_17_3

			for iter_17_0, iter_17_1 in var_17_3(var_17_2.ships) do
				local var_17_4 = {}
			...
			local var_17_5 = #var_1_10007

			if 0 < var_17_5 then
				table = var_17_5

				var_17_5.insert(var_1_10006, function(arg_18_0)
					local var_18_0 = arg_17_0.viewComponent
					local var_18_1 = var_1.emit

					BaseUI = var_2_10003

					local var_18_2 = var_2_10003.ON_AWARD
					local var_18_3 = {
						items = var_1_10007
					}

					AwardInfoLayer = var_5
					var_18_3.title = var_5.TITLE.SHIP
		...
		var_1_10007(var_1_10006, function()
			if var_17_2.isBatch then
				local var_19_0 = var_1_10005

				if 0 < var_19_0 then
					NoPosMsgBox = var_19_0
					i18n = var_1

					local var_19_1 = var_1("switch_to_shop_tip_noDockyard")

					openDockyardClear = var_2
					gotoChargeScene = var_2_10003
					openDockyardIntensify = var_2_10004

					var_19_0(var_19_1, var_2, var_2_10003, var_2_10004)
			...
			do
				...
				var_0.buildFinishComeback(var_19_2)
			end
	...
	if var_17_0 == var_4.BUILD_SHIP_DONE then
		triggerToggle = var_4
		var_1_10005 = arg_17_0.viewComponent.toggles
		BuildShipScene = var_1_10006

		var_4(var_1_10005[var_1_10006.PAGE_QUEUE], true)
	...
	if var_17_0 == var_4.ITEM_UPDATED then
		getProxy = var_4
		BagProxy = var_1_10005
		var_1_10006 = var_4(var_1_10005)
		var_1_10005 = var_4.getItemById(var_1_10006, arg_17_0.useItem)
		var_1_10007 = arg_17_0.viewComponent

		var_1_10006.setUseItem(var_1_10007, var_1_10005)
	...
	if var_17_0 ~= var_4.ADDED then
		BuildShipProxy = var_17_6

		local var_17_6

		if var_17_0 == var_17_6.REMOVED then
			getProxy = var_17_6
			BuildShipProxy = var_1_10005
			var_1_10005 = var_17_6(var_1_10005)
			var_17_6 = var_17_6.getRawData(var_1_10005)
			var_1_10006 = arg_17_0.viewComponent
			var_1_10005 = var_1_10005.setStartCount
			table = var_1_10007

			var_1_10005(var_1_10006, var_1_10007.getCount(var_17_6))
		...
		if var_17_0 == var_17_6.SUPPORT_SHIP_DONE then
			var_17_7 = {}
			ipairs = var_1_10005

			for iter_17_2, iter_17_3 in var_1_10005(var_17_2.ships) do
				if iter_17_3.virgin or iter_17_3:getRarity() >= 4 then
					table = var_1_10010

					var_1_10010.insert(var_17_7, function(arg_20_0)
						...
						NewShipMediator = var_2_10005
						var_20_3.mediator = var_2_10005
						NewShipLayer = var_2_10005
			...
			var_5(var_17_7, function()
				local var_21_0 = arg_17_0.viewComponent
				local var_21_1 = var_0.emit

				BaseUI = var_2_10002

				local var_21_2 = var_2_10002.ON_AWARD
				local var_21_3 = {}

				underscore = var_2_10004
				var_21_3.items = var_2_10004.map(var_17_2.ships, function(arg_22_0)
					Drop = var_3_10001
					...
					DROP_TYPE_SHIP = var_3_10003
					var_22_1.type = var_3_10003
				...
				AwardInfoLayer = var_4
				var_21_3.title = var_4.TITLE.SHIP
		...
		if var_17_0 == var_17_7.BEGIN_STAGE_DONE then
			local var_17_8 = arg_17_0

			var_17_9 = arg_17_0.sendNotification
			GAME = var_1_10006
			var_1_10006 = var_1_10006.GO_SCENE
			SCENE = var_1_10007

			var_17_9(var_17_8, var_1_10006, var_1_10007.COMBATLOAD, var_17_2)

			goto label_17_0
		end

		ActivityProxy = var_17_9

		if var_17_0 == var_17_9.ACTIVITY_UPDATED then
			if var_17_2 then
				var_1_10006 = var_4

				local var_17_10 = var_4.getConfig(var_1_10006, "type")

				ActivityConst = var_1_10006

				if var_17_10 == var_1_10006.ACTIVITY_TYPE_BUILDSHIP_1 then
					local var_17_11 = arg_17_0.viewComponent

					var_1_10006.RefreshActivityBuildPool(var_17_11, var_4)
				else
					ActivityConst = var_1_10006

					if var_17_10 == var_1_10006.ACTIVITY_TYPE_NEWSERVER_BUILD then
						pg = var_1_10006

						if not var_1_10006.ship_data_create_exchange[var_4.id] then
							var_1_10006 = {}
						end

						local var_17_12 = var_4.data2
						local var_17_13

						if not var_1_10006.exchange_available_times then
							var_17_13 = 0
						end

						if var_17_12 < var_17_13 then
							local var_17_14 = arg_17_0.viewComponent

							var_7.RefreshActivityBuildPool(var_17_14, var_4)
						else
							local var_17_15 = arg_17_0.viewComponent
							local var_17_16 = var_7.setPools

							getProxy = iter_17_3
							BuildShipProxy = var_1_10010

							local var_17_17 = iter_17_3(var_1_10010)

							var_17_16(var_17_15, var_9.GetPools(var_17_17))

							local var_17_18 = arg_17_0.viewComponent

							var_7.checkPage(var_17_18)
						end
					else
						ActivityConst = var_1_10006

						if var_17_10 == var_1_10006.ACTIVITY_TYPE_BUILD_FREE then
							local var_17_19 = arg_17_0.viewComponent

							var_1_10006.RefreshFreeBuildActivity(var_17_19)
						end
					end
				end
			end
		...
		if var_17_0 == var_4.REGULAR_BUILD_POOL_COUNT_UPDATE then
			local var_17_20 = arg_17_0.viewComponent

			var_4.RefreshRegularExchangeCount(var_17_20)
		...
		if var_17_0 ~= var_4.ACTIVITY_BUILD_POOL_EXCHANGE_DONE then
			GAME = var_4

			if var_17_0 == var_4.REGULAR_BUILD_POOL_EXCHANGE_DONE then
				local var_17_21 = arg_17_0.viewComponent
				local var_17_22 = var_4.emit

				BaseUI = var_1_10006

				var_17_22(var_17_21, var_1_10006.ON_ACHIEVE, var_17_2.awards)
			end
