...
local var_0_1 = var_1("Mgr/Pool/PoolUtil")
...
function var_0_0.Ctor(arg_7_0, arg_7_1, arg_7_2)
	...
	var_3({
		function(arg_8_0)
			...
			local var_8_2, var_8_3 = var_8_0.autoHxShift("spinepainting/", var_8_1)
...
function var_0_0.init(arg_13_0, arg_13_1)
	...
	var_13_0(var_13_1, var_1_10004.NameToLayer("UI"))
	...
	local var_13_5 = var_13_4(var_13_3, var_4(var_5)).prefabItem
	...
	var_4(var_13_10, var_13_11 .. var_7.GetShipName(var_13_12))
...
function var_0_0.initBgEffect(arg_16_0, arg_16_1)
	...
	var_16_0(var_16_1, var_1_10004.NameToLayer("UI"))
...
function var_0_0.updateLink(arg_19_0)
	...
	ChangeSkinLink = var_19_0

	if var_19_0.CHANGE_SKIN_LINK_DATA[var_19_1] then
		...
		if var_19_4 == var_1_10006.L2D_TYPE then
			...
			LIVE2D_STATUS_SAVE = var_1_10008

			if var_19_6(var_1_10008, 1) == 1 then
...
function var_0_0.SetVisible(arg_22_0, arg_22_1)
	...
	if arg_22_1 then
		...
		if not var_1_10004.UI then
			Layer = var_1_10004
			var_1_10004 = var_1_10004.UIHidden
		end

		var_22_0(var_22_1, var_1_10004)
		...
		if not arg_22_1 then
			...
			var_22_6(var_22_5, var_4.deltaTime)
		end
...
function var_0_0.playPaintingInitIdle(arg_23_0)
	...
	if var_23_0 then
		...
		local var_23_3 = var_23_1.GetInt

		LIVE2D_STATUS_SAVE = var_1_10004

		local var_23_4 = var_23_3(var_1_10004, 1)

		PlayerPrefs = var_1_10004

		local var_23_5 = var_1_10004.GetInt

		LIVE2D_STATUS_SAVE = var_5

		if var_23_5(var_5, 1) == 1 and arg_23_0._idleName ~= var_23_0 then
			var_23_2 = var_23_0
		else
			PlayerPrefs = var_4
			...
			if var_23_6(var_5, 1) ~= 1 and arg_23_0._idleName ~= arg_23_0:getNormalIdleName() then
...
function var_0_0.playPaintingInitSkin(arg_24_0)
	...
	local var_24_2 = arg_24_0.GetDefaultSkeletonSkin(var_24_1)

	if var_24_0 then
		PlayerPrefs = var_24_1

		local var_24_3 = var_24_1.GetInt

		LIVE2D_STATUS_SAVE = var_1_10004

		if var_24_3(var_1_10004, 1) == 1 then
			var_1_10004 = arg_24_0

			if arg_24_0.GetDefaultSkeletonSkin(var_1_10004) ~= var_24_0 then
				var_24_2 = var_24_0
		...
		local var_24_4 = var_3.GetInt

		LIVE2D_STATUS_SAVE = var_1_10004

		if var_24_4(var_1_10004, 1) ~= 1 and arg_24_0._skeletonSkin ~= arg_24_0:GetDefaultSkeletonSkin() then
			var_24_2 = arg_24_0:GetDefaultSkeletonSkin()
		end
	else
		var_24_2 = arg_24_0:GetDefaultSkeletonSkin()
	end
	...
	if var_24_2 and arg_24_0._skeletonGraphic and arg_24_0._skeletonGraphic.SkeletonData then
		local var_24_5 = arg_24_0._skeletonGraphic.SkeletonData

		if var_3.FindSkin(var_24_5, var_24_2) ~= nil then
			arg_24_0:SetSkeletonSkin(var_24_2)
		else
			local var_24_6 = arg_24_0._skeletonGraphic.SkeletonData

			if var_3.FindSkin(var_24_6, "default") ~= nil then
					...
					if var_1_10010(arg_28_0._tf, "hitArea/" .. var_28_2) then
						...
						if var_7.idle then
							...
							if var_13(var_7.idle) == "string" then
								var_28_4 = var_7.idle == arg_28_0._idleName
						...
						if var_7.idle then
							...
							if var_13(var_7.idle) == "table" then
								table = var_13
								var_28_4 = var_13.contains(var_7.idle, arg_28_0._idleName)
							end
						end
						...
						if var_7.skin then
							...
							if var_13(var_7.skin) == "string" then
								var_28_5 = var_7.skin == arg_28_0._skeletonSkin
						...
						if var_7.skin then
							...
							if var_13(var_7.skin) == "table" then
								table = var_13
								var_28_5 = var_13.contains(var_7.skin, arg_28_0._skeletonSkin)
							end
						end
						...
						var_13(var_1_10010, var_28_4 and var_28_5)
					else
						print = var_28_4

						var_28_4("hit area " .. var_28_2 .. "is not exist")
					end
				end
			end
		end
...
function var_0_0.doDragAction(arg_40_0, arg_40_1, arg_40_2, arg_40_3, arg_40_4)
	...
	if var_1_10020(var_40_8) == "table" then
		...
		if var_40_15(var_40_9) == "table" then
			math = var_40_15
			var_40_12 = var_40_9[var_40_15.random(1, #var_40_9)]
	...
	do
		...
		if var_40_15(var_40_7) == "table" then
			type = var_40_15

			if var_40_15(var_40_9) == "table" then
				table = var_40_15
				var_40_15 = var_40_15.indexof

				local var_40_16 = var_40_7

				var_1_10023 = arg_40_0
				var_40_12 = var_40_9[var_40_15(var_40_16, arg_40_0.getIdleName(var_1_10023))]
				type = var_40_16

				if var_40_16(var_40_8) == "table" then
					var_40_14 = var_40_8[var_40_15]
				end
			end
		end
	...
	if not var_40_12 then
		...
		if var_40_15(var_40_9) == "string" then
			var_40_12 = var_40_9
		else
			type = var_40_15
	...
	if not var_40_14 then
		...
		if var_40_15(var_40_8) == "string" then
			var_40_14 = var_40_8
		else
			type = var_40_15

			if var_40_15(var_40_8) == "table" then
				math = var_40_15
				var_40_14 = var_40_8[var_40_15.random(1, #var_40_8)]
			end
		end
	end
	...
	if not var_40_13 then
		...
		if var_40_15(var_40_10) == "string" then
			var_40_13 = var_40_10
		else
			type = var_40_15

			if var_40_15(var_40_10) == "table" then
				math = var_40_15
				var_40_13 = var_40_10[var_40_15.random(1, #var_40_10)]
			end
		end
	end

	SpinePaintingConst = var_40_15

	if arg_40_1 == var_40_15.drag_type_normal then
		...
		if var_40_17 then
			...
			var_1_10022 = var_1_10022.isTweening
			go = var_1_10023

			if var_1_10022(var_1_10023(arg_40_0._tf)) then
				return false
			end
			...
			arg_40_0:getSpineMaterial(var_40_17, function(arg_41_0)
				...
				if var_40_18 then
					...
					local var_41_1 = var_2_10002(arg_40_0._tf)
					local var_41_2 = var_40_18

					System = var_2_10004

					var_41_0(var_41_1, var_41_2, var_2_10004.Action(function()
		...
		if var_40_6 and #var_40_6 > 0 then
			...
			for iter_40_0, iter_40_1 in var_1_10022(var_40_6) do
		...
		if var_40_12 and var_40_12 ~= "" and arg_40_0:checkActionPlayAble(var_40_12, false, 0) then
			...
			var_1_10022("播放动作 .." .. var_40_12 .. "下一个待机动作 .. " .. var_40_14)

			if var_40_0 then
				pg = var_1_10022

				local var_40_19 = var_1_10022.m02

				var_1_10022 = var_1_10022.sendNotification
				NewMainMediator = var_24

				var_1_10022(var_40_19, var_24.HIDE_PANEL, true)
			end
			...
			arg_40_0:SetActionWithFinishCallback(var_40_12, 0, function()
				...
				if var_40_0 then
					...
					var_43_2(var_43_1, var_2_10002.HIDE_PANEL, false)
				end
				...
				if not var_40_14 or not var_40_14 then
					...
					var_43_6 = var_2.getIdleName(var_43_5)
				end
		...
		if not var_40_12 or var_40_12 == "" then
			...
			if var_40_13 then
				...
				if var_1_10022(var_40_13) == "string" and arg_40_0._eventTriggerCall then
					arg_40_0._eventTriggerCall(var_40_13)
				end
			end
...
function var_0_0.SetAlphaData(arg_45_0, arg_45_1)
	...
	for iter_45_0, iter_45_1 in var_1_10002(arg_45_1) do
		...
		if not arg_45_0:getStepSlotAlha(var_45_0) and var_45_3 then
			local var_45_4
			local var_45_5

			ipairs = var_13

			for iter_45_2, iter_45_3 in var_13(var_45_1) do
				math = var_1_10018
...
function var_0_0.PlayCv(arg_46_0, arg_46_1)
	...
	local var_46_2 = var_46_0.CriMgr.GetCVBankName

	ShipWordHelper = var_1_10004

	local var_46_3 = var_46_2(var_1_10004.RawGetCVKey(var_46_1))

	pg = var_4

	local var_46_4 = var_4.ship_skin_template[var_46_1].group_index
...
function var_0_0.matchDragFlag(arg_50_0, arg_50_1, arg_50_2, arg_50_3)
	...
	if arg_50_2.idle then
		...
		if var_1_10007(var_6) == "string" and arg_50_0:getIdleName() ~= var_6 then
			do return false end
	...
	if arg_50_2.favor and var_7 >= 0 then
		var_1_10009 = arg_50_0._spinePaintingData.ship

		if var_8.getCVIntimacy(var_1_10009) and var_8 < var_7 then
			return false
		end
	end

	if arg_50_2.click then
		local var_50_0 = arg_50_2.click

		tobool = var_1_10009

		if var_50_0 == var_1_10009(arg_50_3) then
			return false
		end
	end
...
function var_0_0.getSpineMaterial(arg_52_0, arg_52_1, arg_52_2)
	...
	if arg_52_0._materialDic[arg_52_1] then
		...
		typeof = var_1_10007
		Material = var_1_10008
		var_52_0[arg_52_1] = var_1_10004(var_52_1, var_52_2, var_1_10007(var_1_10008))
	...
	if arg_54_1 then
		...
		if var_1_10002.isHx() then
			if arg_54_0:getAnimationExist("shop_hx") then
				...
				local var_54_1 = arg_54_0._tf

				Vector2 = var_4
				var_54_1.anchoredPosition = var_4(100000, 0)
...
function var_0_0.SetAction(arg_56_0, arg_56_1, arg_56_2, arg_56_3)
	...
	local var_56_2 = var_56_0.ship_skin_template[var_56_1].voice_lang
	...
	if var_6.isHx() and arg_56_0:getAnimationExist(arg_56_1 .. "_hx") then
	...
	for iter_56_0, iter_56_1 in var_6(arg_56_0.spineAnimList) do
		...
		local var_56_6 = iter_56_1

		if iter_56_1.GetAnimationState(var_56_6) then
			GetComponent = var_56_6

			local var_56_7 = var_56_6(iter_56_1.transform, "SkeletonGraphic")
			local var_56_8 = var_12.Update

			Time = var_14

			var_56_8(var_56_7, var_14.deltaTime)
		end
	end
...
function var_0_0.getSlotAlpha(arg_60_0, arg_60_1)
	...
	if var_2.FindSlot(var_60_0, arg_60_1) then
		ReflectionHelp = var_60_0

		local var_60_1 = var_60_0.RefGetProperty

		typeof = var_4

		return var_60_1(var_4("Spine.Slot"), "A", var_2)
	end
...
function var_0_0.setSlotAlpha(arg_61_0, arg_61_1, arg_61_2)
	...
	var_61_0(var_1_10004("Spine.Slot"), "A", arg_61_1, arg_61_2)
...
function var_0_0.setStepSlotAlpha(arg_62_0, arg_62_1, arg_62_2, arg_62_3)
	if not arg_62_0.slotDic[arg_62_1] then
		...
		var_62_0[arg_62_1] = var_5.FindSlot(var_62_1, arg_62_1)
	end
	...
	if arg_62_0.slotDic[arg_62_1] then
		if not arg_62_3 or arg_62_3 <= 0 then
			...
			local var_62_3 = arg_62_0.getSlotAlpha(var_62_2, arg_62_1)

			table = var_62_2

			var_62_2.insert(arg_62_0.stepSlotAlpha, {
				smooth = 0,
				name = arg_62_1,
			...
			if not var_2_10001.match(arg_68_0, "^bgm_") then
				...
				if var_1.match(arg_68_0, "^bgmsingle_") then
					if arg_67_0._visible then
						...
						local var_68_2 = var_2.split(var_68_1, "_")
						...
						if var_68_2[3] then
							...
							do
								...
								Live2dConst = var_2_10013

								local var_68_13 = var_2_10013.GetPaintingBgmVolume
								local var_68_14 = arg_67_0._spinePaintingData.ship

								var_68_8(var_68_7, var_68_9, var_68_10, var_68_11, var_68_12, var_68_13(var_14.getSkinId(var_68_14)))
							end
...
function var_0_0.SetOnceAction(arg_69_0, arg_69_1, arg_69_2, arg_69_3, arg_69_4)
	...
	arg_69_0:SetActionWithFinishCallback(arg_69_1, 0, function()
		...
		var_70_1(var_70_0, var_2.getIdleName(var_70_2), 0)
...
function var_0_0.SetEmptyAction(arg_74_0, arg_74_1)
	...
	for iter_74_0, iter_74_1 in var_2(arg_74_0.spineAnimList) do
		if iter_74_1:GetAnimationState() then
			...
			var_74_1(var_74_0, var_10.deltaTime)
		end
	end
...
function var_0_0.updateSkeletonGraphicTime(arg_77_0)
	if arg_77_0._skeletonGraphic then
		...
		var_77_1(var_77_0, var_1_10003.deltaTime)
	end
