...
function var_0_1.init(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_2(var_9_25.all) do
		...
		var_8.insert(arg_9_0.favoriteVOs, var_1_10007)
	end
	...
	pg = var_3
	arg_9_0.memoryGroups = var_9_26(var_3.memory_group.all, function(arg_13_0)
		pg = var_2_10001
	...
	typeof = var_4
	GridLayoutGroup = iter_9_0
	arg_9_0.memoriesGrid = var_9_32(var_9_31, var_4(iter_9_0))
	arg_9_0.memoryItems = {}
	tf = var_2
...
function var_0_1.didEnter(arg_17_0)
	...
	var_1_10001(var_17_0, var_17_1, var_17_2, var_1_10005)
	...
	local function var_17_6()
		...
		if arg_17_0.contextData.toggle == var_0_1.MUSIC_INDEX then
			...
			pg = var_2_10003
			var_19_2.helps = var_2_10003.gametip.NewMusic_help.tip
			...
			MSGBOX_TYPE_HELP = var_2_10003
			var_19_5.type = var_2_10003
			pg = var_2_10003
			var_19_5.helps = var_2_10003.gametip.collection_help.tip
	...
	var_1(var_17_4, var_17_5, var_17_6, var_1_10005)
	...
	local var_17_10 = var_17_6(var_1_10005)

	var_17_7(var_17_9, var_4.mingshiTouchFlagEnabled(var_17_10))
	...
	var_17_7(var_17_11, var_17_12, var_17_13, var_1_10006)

	ipairs = var_17_7

	for iter_17_0, iter_17_1 in var_17_7(arg_17_0.toggles) do
		PLATFORM_CODE = var_1_10007
		PLATFORM_CH = var_1_10008

		if var_1_10007 == var_1_10008 and (iter_17_0 == 1 or iter_17_0 == 3) then
			LOCK_COLLECTION = var_1_10007
		...
		var_1_10008 = arg_17_0
		var_1_10009 = iter_17_1

		do
			local function var_17_14(arg_21_0)
				if arg_21_0 then
					...
					if iter_17_0 == var_0_1.SHIPCOLLECTION_INDEX then
						...
						if not var_1.IsShowCollectionHelp(var_2_10003) then
							triggerButton = var_2
							...
							var_1.SetCollectionHelpFlag(var_2_10003, true)
						end

						if arg_17_0.bulinTip then
							var_2_10003 = arg_17_0.bulinTip.buffer

							var_2.Show(var_2_10003)
						else
							local var_21_2 = arg_17_0

							AprilFoolBulinSubView = var_2_10003
							var_2_10003 = var_2_10003.ShowAprilFoolBulin

							local var_21_3 = arg_17_0
							local var_21_4 = arg_17_0._tf

							var_21_2.bulinTip = var_2_10003(var_21_3, var_5.Find(var_21_4, "main"))
						end
					end
					...
					if iter_17_0 ~= var_0_1.MUSIC_INDEX then
						...
						if arg_17_0.musicView then
							local var_21_5 = arg_17_0.musicView

							var_21_6 = var_21_6.CheckState
							BaseSubView = var_2_10003

							if var_21_6(var_21_5, var_2_10003.STATES.INITED) then
								local var_21_7 = arg_17_0.musicView

								var_21_6.tryPauseMusic(var_21_7)

								local var_21_8 = arg_17_0.musicView

								var_21_6.closeAlbumListPanel(var_21_8)
							end
						end

						pg = var_21_6

						local var_21_9 = var_21_6.BgmMgr.GetInstance()

						var_1.ContinuePlay(var_21_9)
					elseif iter_17_0 == var_0_1.MUSIC_INDEX then
						pg = var_1

						local var_21_10 = var_1.BgmMgr.GetInstance()

						var_1.StopPlay(var_21_10)

						if arg_17_0.musicView then
							local var_21_11 = arg_17_0.musicView
							local var_21_12 = var_1.CheckState

							BaseSubView = var_2_10003

							if var_21_12(var_21_11, var_2_10003.STATES.INITED) then
								local var_21_13 = arg_17_0.musicView

								var_1.tryPlayMusic(var_21_13)
							end
						end
					end
				end
			...
			var_1_10007(var_1_10008, var_1_10009, var_17_14, var_1_10011)
		end
	...
	for iter_17_2, iter_17_3 in var_2(arg_17_0.memoryToggles) do
		...
		var_1_10009 = iter_17_3

		local function var_17_16(arg_22_0)
			if arg_22_0 then
				local var_22_0
		...
		var_1_10007(var_17_15, var_1_10009, var_17_16, var_1_10011)
	end

	local var_17_17 = arg_17_0.contextData.toggle
	local var_17_18 = arg_17_0.contextData

	var_17_18.toggle = -1
	triggerToggle = var_17_18

	var_17_18(arg_17_0.toggles[var_17_17], true)
	...
	if arg_17_0.contextData.memoryGroup then
		...
		if var_17_20.memory_group[var_3] then
			local var_17_19 = arg_17_0

			var_17_20 = arg_17_0.showSubMemories
			pg = iter_17_3

			var_17_20(var_17_19, iter_17_3.memory_group[var_3])

			goto label_17_1
		end
	end

	triggerToggle = var_17_20

	var_17_20(arg_17_0.memoryToggles[1], true)

	::label_17_1::

	ipairs = var_17_20

	for iter_17_4, iter_17_5 in var_17_20(arg_17_0.cardToggles) do
	...
	local var_17_22 = arg_17_0.bonusPanel
	...
	var_4(var_17_21, var_17_22, var_17_23, iter_17_5)
...
function var_0_1.updateCollectNotices(arg_25_0, arg_25_1)
	...
	local var_25_1 = var_3.Find(var_25_0, "tip")

	getProxy = var_25_0
	AppreciateProxy = var_5

	local var_25_2 = var_25_0(var_5)

	var_1_10002(var_25_1, var_4.isGalleryHaveNewRes(var_25_2))

	setActive = var_1_10002

	local var_25_3 = arg_25_0.toggles[var_0_1.MUSIC_INDEX]
	local var_25_4 = var_3.Find(var_25_3, "tip")

	getProxy = var_25_3
	AppreciateProxy = var_5

	local var_25_5 = var_25_3(var_5)

	var_1_10002(var_25_4, var_4.isMusicHaveNewRes(var_25_5))

	setActive = var_1_10002

	local var_25_6 = arg_25_0.toggles[var_0_1.MANGA_INDEX]
	local var_25_7 = var_3.Find(var_25_6, "tip")

	getProxy = var_25_6
	AppreciateProxy = var_5

	local var_25_8 = var_25_6(var_5)

	var_1_10002(var_25_7, var_4.isMangaHaveNewRes(var_25_8))
...
function var_0_1.calFavoriteRate(arg_26_0)
	...
	var_1_10002(var_3.Find(var_26_1, "total/char"), not var_26_0)

	setActive = var_1_10002

	local var_26_2 = arg_26_0.top

	var_1_10002(var_3.Find(var_26_2, "total/link"), var_26_0)

	setText = var_1_10002

	local var_26_3 = arg_26_0.top

	var_1_10002(var_3.Find(var_26_3, "total/char/rate/Text"), arg_26_0.rate * 100 .. "%")

	setText = var_1_10002

	local var_26_4 = arg_26_0.top

	var_1_10002(var_3.Find(var_26_4, "total/char/count/Text"), arg_26_0.count .. "/" .. arg_26_0.totalCount)

	setText = var_1_10002

	local var_26_5 = arg_26_0.top

	var_1_10002(var_3.Find(var_26_5, "total/link/count/Text"), arg_26_0.linkCount)
...
function var_0_1.initCardPanel(arg_27_0)
	...
	local var_27_1 = arg_27_0.isDefaultStatus(var_27_0) and "shaixuan_off" or "shaixuan_on"

	GetSpriteFromAtlasAsync = var_27_0

	var_27_0("ui/share/index_atlas", var_27_1, function(arg_28_0)
	...
	local var_27_2 = arg_27_0.cardList
	local var_27_3 = var_2.SetTotalCount
	local var_27_4 = #arg_27_0.codeShips
	local var_27_5
...
function var_0_1.initIndexPanel(arg_30_0)
	...
	var_1(var_30_1, var_30_2, var_30_3, var_1_10005)
...
function var_0_1.onInitCard(arg_33_0, arg_33_1)
	...
	local function var_33_3()
		if not arg_33_0.isClicked then
			...
			var_34_1(var_34_2, var_2_10002.Action(function()
				...
				if var_35_1 == var_35_0.STATE_UNLOCK then
					...
					if var_35_3 == var_35_2.STATE_NOTGET then
						...
						if var_33_0.config then
							...
							var_35_5(var_35_4, var_35_6, var_3.getShipConfigId(var_35_7))
						end
					end
				end
	...
	var_3(var_33_1, var_33_2, var_33_3, var_1_10007)
...
function var_0_1.cardFilter(arg_40_0)
	...
	local var_40_1 = var_40_0(var_1_10002.ship_data_group.all, function(arg_41_0)
		pg = var_2_10001
		...
		if var_9.filterByType(var_40_2, var_0_1.ShipIndex.typeIndex) then
			if arg_40_0.contextData.cardToggle ~= 2 then
				...
				if var_9.filterByCamp(var_40_2, var_0_1.ShipIndex.campIndex) then
					...
					local var_40_4 = var_10.IsMeta

					ShipGroup = var_11

					if var_40_3 == var_40_4(var_11.getDefaultShipConfig(var_1_10007.group_type).nationality) then
...
function var_0_1.transFilter(arg_42_0)
	...
	local var_42_1 = var_42_0(var_1_10002.ship_data_group.all, function(arg_43_0)
		pg = var_2_10001
...
function var_0_1.sortDisplay(arg_44_0)
	...
	var_44_3(var_44_2, var_44_4, var_6.HeadIndexToValue(var_44_5, var_44_0 - 1))
...
function var_0_1.initFavoriteCard(arg_49_0, arg_49_1)
	...
	local function var_49_3()
		...
		if var_50_0 == var_2_10001.STATE_AWARD then
			...
			var_2_10002 = var_0_1.GET_AWARD

			local var_50_3 = var_49_0.favoriteVO.id
			local var_50_4 = var_49_0.favoriteVO

			var_50_2(var_50_1, var_2_10002, var_50_3, var_4.getNextAwardIndex(var_50_4, var_49_0.awards))
		else
			...
			if var_50_5 == var_50_1.STATE_LOCK then
				pg = var_50_5
				var_50_6 = var_50_5.TipsMgr.GetInstance()

				local var_50_7 = var_0.ShowTips

				i18n = var_2_10002

				var_50_7(var_50_6, var_2_10002("collection_lock"))
			else
				...
				if var_50_8 == var_50_6.STATE_FETCHED then
					pg = var_50_8
					var_50_9 = var_50_8.TipsMgr.GetInstance()

					local var_50_10 = var_0.ShowTips

					i18n = var_2_10002

					var_50_10(var_50_9, var_2_10002("collection_fetched"))
				else
					local var_50_11 = var_49_0.state

					Favorite = var_50_9

					if var_50_11 == var_50_9.STATE_STATE_WAIT then
						pg = var_50_11
						...
						var_50_13(var_50_12, var_2_10002("collection_nostar"))
					end
				end
			end
		end
	...
	var_3(var_49_4, var_49_5, var_49_6, var_1_10007)
...
function var_0_1.openBonus(arg_53_0, arg_53_1)
	...
	if not arg_53_0.isInitBound then
		...
		typeof = var_4
		Text = var_1_10005
		arg_53_0.boundName = var_53_1(var_53_0, var_4(var_1_10005))
		findTF = var_53_1
		...
		typeof = var_4
		Slider = var_1_10005
		arg_53_0.progressSlider = var_53_1(var_53_2, var_4(var_1_10005))
	end
	...
	local var_53_4 = arg_53_1:getConfig("award_display")
	local var_53_5 = arg_53_1
	local var_53_6 = arg_53_1.getConfig(var_53_5, "level")

	ipairs = var_53_5

	for iter_53_0, iter_53_1 in var_53_5(var_53_6) do
		local var_53_7 = var_53_4[iter_53_0]
		...
		var_11(var_12(var_1_10010, "process"), iter_53_1)

		local var_53_8 = arg_53_1
		local var_53_9 = arg_53_1.getAwardState(var_53_8, arg_53_0.shipGroups, arg_53_0.awards, iter_53_0)

		setActive = var_53_8
		findTF = var_13

		local var_53_10 = var_13(var_1_10010, "item_tpl/unfinish")

		Favorite = var_14

		var_53_8(var_53_10, var_53_9 == var_14.STATE_WAIT)

		setActive = var_53_8
		findTF = var_53_10

		local var_53_11 = var_53_10(var_1_10010, "item_tpl/get")

		Favorite = var_14

		var_53_8(var_53_11, var_53_9 == var_14.STATE_AWARD)

		setActive = var_53_8
		findTF = var_53_11

		local var_53_12 = var_53_11(var_1_10010, "item_tpl/got")

		Favorite = var_14

		var_53_8(var_53_12, var_53_9 == var_14.STATE_FETCHED)

		setActive = var_53_8
		findTF = var_53_12

		local var_53_13 = var_53_12(var_1_10010, "item_tpl/lock")

		Favorite = var_14

		var_53_8(var_53_13, var_53_9 == var_14.STATE_LOCK)

		setActive = var_53_8
		findTF = var_53_13

		local var_53_14 = var_53_13(var_1_10010, "item_tpl/icon_bg")

		Favorite = var_14

		var_53_8(var_53_14, var_53_9 ~= var_14.STATE_LOCK)

		setActive = var_53_8
		findTF = var_53_14

		local var_53_15 = var_53_14(var_1_10010, "item_tpl/bg")

		Favorite = var_14

		var_53_8(var_53_15, var_53_9 ~= var_14.STATE_LOCK)

		local var_53_16, var_53_17
		...
		if var_53_7 then
			...
			var_13(var_53_16(var_1_10010, "item_tpl"), var_53_8)

			var_53_8.count = var_53_7[3]
			onButton = var_13
			var_53_16 = arg_53_0
			var_53_17 = var_1_10010

			local function var_53_18()
				local var_54_0 = arg_53_0

				var_0.emit(var_54_0, var_0_1.ON_DROP, var_53_8)
			...
			var_13(var_53_16, var_53_17, var_53_18, var_1_10017)
		else
			GetOrAddComponent = var_53_8

			local var_53_19 = var_1_10010

			typeof = var_53_16
			Button = var_53_17

			local var_53_20 = var_53_8(var_53_19, var_53_16(var_53_17)).onClick

			var_13.RemoveAllListeners(var_53_20)
		end
	end

	local var_53_21 = arg_53_1:getStarCount(arg_53_0.shipGroups)

	arg_53_0.progressSlider.value = var_53_21 / var_53_6[#var_53_6]
...
function var_0_1.showSubMemories(arg_56_0, arg_56_1)
	...
	var_2(var_3.Find(var_56_2, "memory"), false)
...
function var_0_1.return2MemoryGroup(arg_58_0)
	...
	if var_58_0 then
		...
		if var_58_2 >= 0 then
			...
			math = var_7
			var_58_1 = (var_58_4 * var_7.floor((var_58_2 - 1) / var_0_9) + var_58_3.paddingFront) / (var_58_5 - arg_58_0.memoryViewport.rect.height)
			Mathf = var_7
	...
	var_3(var_4.Find(var_58_7, "memory"), true)
...
function var_0_1.initMemoryPanel(arg_59_0)
	...
	if var_59_1(var_59_0, var_1_10004.QIXI_ACTIVITY_ID) and not var_2:isEnd() then
		local var_59_2 = var_2
		local var_59_3 = var_2.getConfig(var_59_2, "config_data")

		_ = var_59_2

		local var_59_4 = var_4[#var_59_2.flatten(var_59_3)]

		getProxy = var_1_10006
		TaskProxy = var_1_10007

		local var_59_5 = var_1_10006(var_1_10007)

		if var_6.getTaskById(var_59_5, var_59_4) and not var_7:isFinish() then
			pg = var_8

			local var_59_6 = var_8.NewStoryMgr.GetInstance()

			var_8.Play(var_59_6, "HOSHO8", function()
				local var_60_0 = arg_59_0
				local var_60_1 = var_0.emit

				CollectionScene = var_2_10002

				var_60_1(var_60_0, var_2_10002.ACTIVITY_OP, {
					cmd = 2,
...
function var_0_1.onInitMemory(arg_61_0, arg_61_1)
	...
	var_3(var_61_1, var_61_2, var_61_3, var_1_10007)
...
function var_0_1.onUpdateMemory(arg_63_0, arg_63_1, arg_63_2)
	...
	var_5.any(var_63_1, function(arg_64_0)
		...
		if var_2_10001(arg_64_0) then
			...
			local var_64_2 = var_64_1(var_64_0, var_2_10004(var_2_10005))
			local var_64_3 = arg_64_0
			local var_64_4 = arg_64_0.GetComponent

			typeof = var_2_10005
			Image = var_2_10006
			var_64_2.targetGraphic = var_64_4(var_64_3, var_2_10005(var_2_10006))
		end
...
function var_0_1.playMemory(arg_66_0, arg_66_1)
	if arg_66_1.type == 1 then
		...
		if var_3.len(arg_66_1.mask) > 0 then
			setActive = var_66_2

			var_66_2(var_66_0, true)

			local var_66_1 = var_66_0

			var_66_2 = var_66_0.GetComponent
			typeof = var_5
			Image = var_1_10006
			var_66_2 = var_66_2(var_66_1, var_5(var_1_10006))
			LoadSprite = var_66_1
			var_66_2.sprite = var_66_1(arg_66_1.mask)
		else
			setActive = var_66_2

			var_66_2(var_66_0, false)
		end

		setActive = var_66_2

		var_66_2(arg_66_0.memoryMask, true)

		pg = var_66_2

		local var_66_3 = var_66_2.NewStoryMgr.GetInstance()
...
function var_0_1.memoryFilter(arg_68_0)
	...
	for iter_68_0, iter_68_1 in var_1(var_1_10002.memory_group.all) do
		pg = var_1_10006
