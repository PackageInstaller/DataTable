...
function var_0_0.initProperty(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_1 = var_4.GetGroupConfig(var_2_0).property_hexagon
...
function var_0_0.initRadar(arg_3_0, arg_3_1)
	...
	var_3_2(var_3_3, var_1_10006(0, 0, 0))
	...
	for iter_3_0, iter_3_1 in var_3_2(var_0_2) do
		...
		if var_11(var_3_5, "Text") then
			...
			if var_3_12(var_3_11, var_13(var_3_9)) then
				setText = var_11
				findTF = var_3_11
				...
				var_11(var_3_13, var_13("word_attr_" .. iter_3_1))
			end
		end
	end
...
function var_0_0.getGradeCoordinate1(arg_5_0, arg_5_1, arg_5_2)
	...
	elseif arg_5_2 == var_0_9 then
		...
		local var_5_4 = var_5_3(var_1_10007.rad(var_5_1)) * var_5_2

		math = var_7

		local var_5_5 = var_7.cos

		math = var_8

		local var_5_6 = var_5_5(var_8.rad(var_5_1)) * var_5_2
...
function var_0_0.setSpriteTo(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	local var_6_2 = var_6_1(var_6_0, var_1_10006(var_1_10007))

	findTF = var_6_0

	local var_6_3 = var_6_0(arg_6_0.tf, arg_6_1)
	local var_6_4 = var_5.GetComponent

	typeof = var_7
	Image = var_1_10008
	var_6_2.sprite = var_6_4(var_6_3, var_7(var_1_10008)).sprite
