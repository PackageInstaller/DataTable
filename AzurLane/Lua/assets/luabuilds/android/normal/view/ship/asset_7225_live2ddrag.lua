		...
		if arg_2_0.listenerApply and #arg_2_0.listenerApply > 0 then
			...
			if var_2_14 == var_0_8 and var_2_6 then
				...
				if var_2_17 and arg_2_0.l2dIdleIndex ~= var_2_17 then
					...
					var_2_19(var_2_18, var_16.EVENT_CHANGE_IDLE_INDEX, {
						id = arg_2_0.id,
						idle = var_2_17,
...
function var_0_0.onEventCallback(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	...
	if arg_22_1 == var_1_10004.EVENT_ACTION_APPLY then
		...
		local var_22_13 = var_1_10016(var_22_1)
		local var_22_14 = " active idle is "

		tostring = var_1_10018

		var_12(var_22_10 .. var_22_11 .. var_22_12 .. var_22_13 .. var_22_14 .. var_1_10018(var_22_0.idle))
		...
		if var_37_1 == var_2.DRAG_RELATION_IDLE then
			if not arg_37_0._parameterUpdateFlag then
				if not arg_37_0.l2dIsPlaying then
					...
					arg_37_0.changeParameComAble(var_37_2, true)
				else
					table = var_1
			...
			elseif arg_37_0._parameterUpdateFlag == true and arg_37_0.l2dIsPlaying then
				...
				if var_1.contains(arg_37_0.actionTrigger.remove_com_list, arg_37_0.l2dPlayActionName) then
					...
					arg_37_0.changeParameComAble(var_37_2, false)
				end
			end
		else
			local var_37_3 = arg_37_0.actionTrigger.type

			Live2DPainting = var_37_2

			if var_37_3 == var_37_2.DRAG_DOWN_TOUCH then
				arg_37_0._parameterUpdateFlag = true
			else
				...
				if var_37_4 == var_2.DRAG_LISTENER_EVENT then
					arg_37_0._parameterUpdateFlag = true
				else
					...
					if var_37_5 == var_2.DRAG_ANIMATION_PLAY then
						arg_37_0._parameterUpdateFlag = true
					else
						...
						if var_37_6 == var_2.DRAG_WITH_PARAMETER_MOVE then
							arg_37_0._parameterUpdateFlag = true
						else
							...
							if var_37_7 == var_2.DRAG_MOVE_DOWN_UP then
								arg_37_0._parameterUpdateFlag = true
							else
								local var_37_8 = arg_37_0.actionTrigger.type

								Live2DPainting = var_2

								if var_37_8 == var_2.DRAG_GAME_XIAQI then
									arg_37_0._parameterUpdateFlag = true
								else
									arg_37_0._parameterUpdateFlag = false
								end
...
function var_0_0.changeParameComAble(arg_38_0, arg_38_1)
	...
	if arg_38_1 then
		...
		var_38_1(var_38_0, var_1_10004.EVENT_ADD_PARAMETER_COM, {
		...
		var_38_3(var_38_2, var_1_10004.EVENT_REMOVE_PARAMETER_COM, {
			com = arg_38_0._parameterCom,
			mode = arg_38_0.mode
		})
	end
...
function var_0_0.updateCircleDrag(arg_40_0)
	...
	if arg_40_0._active and arg_40_0.mouseWorld ~= nil then
		...
		if not arg_40_0.circleDragWorld then
			...
			var_40_1(var_40_0, var_1_10003.EVENT_GET_WORLD_POSITION, {
		...
		local var_40_3 = (var_40_2 * var_2.rad2Deg + 360 - arg_40_0.offsetCircleStart) % 360 / 360
...
function var_0_0.updateParameterValue(arg_44_0)
	...
	if arg_44_0._parameterUpdateFlag and arg_44_0.parameterValue ~= arg_44_0.parameterTargetValue then
		...
		elseif arg_44_0.parameterSmoothTime and arg_44_0.parameterSmoothTime > 0 then
			...
			local var_44_10, var_44_11 = var_44_5(var_44_6, var_44_7, var_44_8, var_44_9, var_1_10008.fixedDeltaTime)
...
function var_0_0.updateRelationValue(arg_46_0)
	...
	for iter_46_0, iter_46_1 in var_1_10001(arg_46_0._relationParameterList) do
		...
		if var_46_2 then
			...
			local var_46_6 = arg_46_0:fixRelationParameter(var_46_3, var_6)
			local var_46_7

			if not iter_46_1.value then
				var_46_7 = arg_46_0.startValue
			end

			math = var_16

			if var_16.abs(var_46_6 - var_46_7) <= 0.01 then
				var_1_10012 = var_46_6
			else
				local var_46_8
				...
				var_1_10018, var_46_10 = var_1_10018.SmoothDamp(var_46_7, var_46_6, var_46_8, var_46_9)
				var_46_5 = var_46_10
				var_1_10012 = var_1_10018
			end
		end
...
function var_0_0.updateTrigger(arg_52_0)
			...
			if var_52_3 then
				...
				if var_52_5 < var_1_10006.abs(var_52_3) * 0.25 then
					...
					if var_52_2 < arg_52_0.triggerActionTime and not arg_52_0.l2dIsPlaying then
						var_1_10006 = arg_52_0
						var_52_5 = arg_52_0.onEventCallback
						Live2DPainting = var_1_10007

						var_52_5(var_1_10006, var_1_10007.EVENT_ACTION_APPLY, nil, function(arg_53_0)
							if arg_53_0 then
								local var_53_0 = arg_52_0
								local var_53_1 = var_1.onEventNotice

								Live2DPainting = var_2_10003

								var_53_1(var_53_0, var_2_10003.ON_ACTION_DRAG_TRIGGER)
							end
	...
	if var_52_0 == var_52_5.DRAG_CLICK_ACTION then
		...
		if arg_52_0.checkClickAction(var_1_10006) then
			var_1_10007 = arg_52_0
			var_1_10006 = arg_52_0.onEventCallback
			Live2DPainting = iter_52_0

			var_1_10006(var_1_10007, iter_52_0.EVENT_ACTION_APPLY, nil, function(arg_54_0)
				local var_54_0 = arg_52_0
				local var_54_1 = var_1.onEventNotice

				Live2DPainting = var_2_10003

				var_54_1(var_54_0, var_2_10003.ON_ACTION_DRAG_CLICK)
	...
	if var_52_0 == var_5.DRAG_CLICK_RANGE then
		...
		if arg_52_0.checkClickAction(var_1_10006) then
			...
			iter_52_0(var_1_10009, var_1_10010.EVENT_GET_PARAMETER, {
				name = var_1_10006
			}, function(arg_55_0)
				print = var_2_10001
				...
				if arg_55_0 >= var_1_10007[1] and arg_55_0 < var_1_10007[2] then
					...
					var_1(var_55_0 .. var_3(arg_52_0.id))
					...
					var_55_2(var_55_1, var_3.EVENT_ACTION_APPLY, nil, function(arg_56_0)
						local var_56_0 = arg_52_0
						local var_56_1 = var_1.onEventNotice

						Live2DPainting = var_3_10003

						var_56_1(var_56_0, var_3_10003.ON_ACTION_DRAG_CLICK)
	...
	if var_52_0 == var_5.DRAG_DOWN_ACTION then
		if arg_52_0._active then
			...
			arg_52_0.setAbleWithFlag(var_1_10006, true)
			...
			if var_52_2 <= var_52_6.time - arg_52_0.mouseInputDownTime and not arg_52_0.l2dIsPlaying then
				...
				arg_52_0.setAbleWithFlag(var_1_10006, false)

				var_1_10006 = arg_52_0
				var_52_6 = arg_52_0.onEventCallback
				Live2DPainting = var_1_10007

				var_52_6(var_1_10006, var_1_10007.EVENT_ACTION_APPLY, nil, function(arg_57_0)
					if arg_57_0 then
						...
						var_57_1(var_57_0, var_2_10003.ON_ACTION_DOWN)
					end
				...
				if arg_52_0.actionListIndex ~= 1 then
					...
					arg_52_0.setTriggerActionFlag(var_1_10006, false)
				end
		...
		elseif arg_52_0.actionTrigger.last and arg_52_0.actionListIndex ~= 1 then
			...
			var_52_6(var_1_10006, var_1_10007.EVENT_ACTION_APPLY, nil, function(arg_58_0)
				return
			end)

			var_1_10006 = arg_52_0

			arg_52_0.resetNextTriggerTime(var_1_10006)
	...
	if var_52_0 == var_52_6.DRAG_RELATION_XY then
		if arg_52_0._active then
			var_1_10006 = arg_52_0
			var_52_7 = arg_52_0.fixParameterTargetValue(var_1_10006, arg_52_0.offsetDragX, arg_52_0.range, arg_52_0.rangeAbs, arg_52_0.dragDirect)
			var_1_10007 = arg_52_0
			var_1_10006 = arg_52_0.fixParameterTargetValue(var_1_10007, arg_52_0.offsetDragY, arg_52_0.range, arg_52_0.rangeAbs, arg_52_0.dragDirect)
			...
			if var_1_10009 <= var_1_10010.abs(var_1_10007) * 0.25 then
				...
				if var_1_10009 <= var_1_10010.abs(iter_52_0) * 0.25 then
					...
					if var_52_2 < arg_52_0.triggerActionTime and not arg_52_0.l2dIsPlaying then
						...
						Live2DPainting = var_11

						var_1_10009(var_1_10010, var_11.EVENT_ACTION_APPLY, nil, function(arg_59_0)
							if arg_59_0 then
								...
								var_59_1(var_59_0, var_2_10003.ON_ACTION_XY_TRIGGER)
							end
	...
	if var_52_0 == var_5.DRAG_CLICK_MANY then
		...
		if arg_52_0.checkClickAction(var_1_10006) then
			...
			var_1_10006(var_1_10007, iter_52_0.EVENT_ACTION_APPLY)
		end
	...
	if var_52_0 == var_5.DRAG_LISTENER_EVENT then
		if arg_52_0._listenerTrigger then
			...
			var_52_8(var_1_10006, var_1_10007.EVENT_ACTION_APPLY)
		end
	...
	if var_52_0 == var_52_8.DRAG_DOWN_TOUCH then
		...
		arg_52_0.setAbleWithFlag(var_1_10006, arg_52_0._active)
		...
		if arg_52_0._active then
			...
			iter_52_0 = arg_52_0
			var_1_10006 = arg_52_0.fixParameterTargetValue(iter_52_0, var_1_10006, arg_52_0.range, arg_52_0.rangeAbs, arg_52_0.dragDirect)
			iter_52_0 = arg_52_0

			arg_52_0.setTargetValue(iter_52_0, var_1_10006)
		end
		...
		if arg_52_0.checkClickAction(var_1_10006) then
			...
			iter_52_0(var_1_10009, var_1_10010.EVENT_GET_PARAMETER, {
				...
				if var_2_10001.abs(var_1_10006 - arg_60_0) <= 0.05 then
					...
					var_60_1(var_60_0, var_3.EVENT_ACTION_APPLY, nil, function(arg_61_0)
						local var_61_0 = arg_52_0
						local var_61_1 = var_1.onEventNotice

						Live2DPainting = var_3_10003

						var_61_1(var_61_0, var_3_10003.ON_ACTION_DRAG_CLICK)
	...
	if var_52_0 == var_5.DRAG_ANIMATION_PLAY then
		...
		var_1_10007 = arg_52_0.stateInfo

		if var_1_10006.IsName(var_1_10007, var_52_10) and arg_52_0.l2dIdleIndex == arg_52_0.actionTrigger.trigger_index then
			var_1_10006 = false
			...
			if arg_52_0.actionTrigger.parameter_range then
				...
				var_1_10010(var_52_11, var_1_10012.EVENT_GET_PARAMETER, {
					name = iter_52_0
				}, function(arg_62_0)
			...
			if var_1_10006 then
				...
				if arg_52_0.actionTrigger.trigger_rate <= iter_52_0 and not arg_52_0.animationPlayApply then
					...
					iter_52_0(var_1_10009, var_1_10010.EVENT_ACTION_APPLY, nil, function()
						return
					end)

					var_1_10009 = arg_52_0

					arg_52_0.setTriggerActionFlag(var_1_10009, false)
			...
			if var_52_3 then
				if var_52_3 then
					...
					if var_52_3 and var_52_12 <= var_1_10006 and not arg_52_0.parameterMoveTrigger then
						...
						var_1_10007(iter_52_0, var_1_10009.EVENT_ACTION_APPLY, nil, function(arg_64_0)
							return
						end)
					else
						...
						if arg_52_0.parameterMoveTrigger then
							...
							arg_52_0.setParameterValue(iter_52_0, arg_52_0.startValue)

							iter_52_0 = arg_52_0

							arg_52_0.setTargetValue(iter_52_0, arg_52_0.startValue)
						end
						...
						if arg_52_0.moveCheckStep <= 0 then
							...
							iter_52_0(var_52_13, var_1_10010.EVENT_GET_PARAMETER, {
								name = var_1_10007
							}, function(arg_65_0)
							...
							if arg_52_0.lastParameterMove and arg_52_0.parameterMove then
								...
								if iter_52_0.abs(arg_52_0.parameterMove - arg_52_0.lastParameterMove) ~= 0 then
									...
									local var_52_15 = arg_52_0.parameterTargetValue + iter_52_0 * var_52_14

									arg_52_0:setTargetValue(arg_52_0:fixParameterTargetValue(var_52_15, arg_52_0.range, arg_52_0.rangeAbs, arg_52_0.dragDirect))
					...
					do
						...
						if var_52_0 == var_52_12.DRAG_MOVE_DOWN_UP then
							var_52_16 = arg_52_0.actionTrigger.range
							...
							if arg_52_0._active and arg_52_0.actionTrigger.active == 1 then
								if not arg_52_0.dragMoveUp then
									...
									if var_52_16[1] < var_1_10006 and arg_52_0.parameterValue <= var_52_16[2] then
										arg_52_0.dragMoveUp = true
										var_1_10007 = arg_52_0
										var_1_10006 = arg_52_0.onEventCallback
										Live2DPainting = iter_52_0

										var_1_10006(var_1_10007, iter_52_0.EVENT_ACTION_APPLY, nil, function(arg_66_0)
											return
										end)
									end
								end
							elseif arg_52_0.firstStop and arg_52_0.actionTrigger.active == 0 then
								...
								var_1_10006(var_1_10007, iter_52_0.EVENT_GET_PARAMETER, {
									name = arg_52_0.actionTrigger.parameter
								}, function(arg_67_0)
									if arg_67_0 > var_52_16[1] and arg_67_0 <= var_52_16[2] then
										local var_67_0 = arg_52_0
										local var_67_1 = var_1.onEventCallback

										Live2DPainting = var_2_10003

										var_67_1(var_67_0, var_2_10003.EVENT_ACTION_APPLY, nil, function(arg_68_0)
											return
										end)
									end
							...
							if var_52_0 == var_52_16.DRAG_GAME_XIAQI then
								var_1_10006 = arg_52_0

								if arg_52_0.checkClickAction(var_1_10006) then
									var_1_10006 = arg_52_0
									var_52_17 = arg_52_0.onEventCallback
									Live2DPainting = var_1_10007

									var_52_17(var_1_10006, var_1_10007.EVENT_GAME_XIAQI, {
								...
								Live2DPainting = var_52_17

								if var_52_0 == var_52_17.DRAG_GAME_XIAQI_RESULT and arg_52_0.commonData then
									local var_52_18 = arg_52_0.commonData

									Live2DPainting = var_1_10006

									if var_52_18[var_1_10006.COMMON_XIAQI_RESULT] ~= nil then
										local var_52_19 = arg_52_0.actionTrigger.win == 1 and true or false
										local var_52_20 = arg_52_0.commonData

										Live2DPainting = var_1_10007

										if var_52_19 == var_52_20[var_1_10007.COMMON_XIAQI_RESULT] then
											local var_52_21 = arg_52_0
											local var_52_22 = arg_52_0.onEventCallback

											Live2DPainting = iter_52_0

											var_52_22(var_52_21, iter_52_0.EVENT_ACTION_APPLY, nil, function(arg_70_0)
												if arg_70_0 then
													...
													var_70_2(var_70_1, var_3.COMMON_XIAQI_RESULT, nil)
												end
...
function var_0_0.checkActionInExtendFlag(arg_74_0, arg_74_1)
	...
	var_74_6(var_74_5, var_1_10009.EVENT_GET_DRAG_PARAMETER, {
		name = var_74_2
	}, function(arg_75_0)
	...
	if var_74_7 then
		...
		if var_9.contains(var_74_7, arg_74_1) then
			var_74_0 = true
		end
	end
	...
	if var_74_8 then
		...
		if var_9.contains(var_74_8, arg_74_1) then
			var_74_1 = true
		end
	end
...
function var_0_0.setAbleWithFlag(arg_76_0, arg_76_1)
	if arg_76_0.ableFlag ~= arg_76_1 then
		...
		var_76_1(var_76_0, var_1_10004.EVENT_ACTION_ABLE, {
			ableFlag = arg_76_1
		})
	end
...
function var_0_0.loadData(arg_83_0)
	...
	if arg_83_0.revert == -1 and arg_83_0.saveParameterFlag then
		...
		var_1_10005 = arg_83_0.id

		local var_83_5 = arg_83_0.live2dData

		if var_83_4(var_1_10005, var_6.GetShipSkinConfig(var_83_5).id, arg_83_0.live2dData.ship.id) then
	...
	local var_83_6 = arg_83_0.actionTrigger.type

	Live2DPainting = var_1_10005

	if var_83_6 == var_1_10005.DRAG_CLICK_MANY then
		Live2dConst = var_83_6

		local var_83_7 = var_83_6.GetDragActionIndex
		local var_83_8 = arg_83_0.id
		local var_83_9 = arg_83_0.live2dData
		local var_83_10

		if not var_83_7(var_83_8, var_6.GetShipSkinConfig(var_83_9).id, arg_83_0.live2dData.ship.id) then
			var_83_10 = 1
		end

		arg_83_0.actionListIndex = var_83_10
	end
	...
	if arg_83_0._relationFlag then
		...
		if not var_4.GetRelationData(var_83_0, var_83_2, var_83_3).drag_x or not var_4.drag_x then
			var_83_11 = arg_83_0.startValue
		end

		arg_83_0.offsetDragX = var_83_11
		...
		arg_83_0.offsetDragY = var_83_12
	end
