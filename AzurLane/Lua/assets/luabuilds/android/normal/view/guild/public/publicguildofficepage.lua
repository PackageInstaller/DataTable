...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame/donate_panel/list")
	local var_2_3 = arg_2_0._tf

	arg_2_0.itemList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/donate_panel/list/tpl"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.cntTxt = var_2_6(var_2_5, var_3(var_2_3))
...
function var_0_1.Flush(arg_6_0)
	...
	var_6_3(var_6_2, var_6_4, var_1_10004(-737, -171, 0))
...
function var_0_1.UpdateDonateTask(arg_7_0, arg_7_1, arg_7_2)
	...
	if not arg_7_0.cards[arg_7_1] then
		GuildDonateCard = var_1_10006
		var_7_2 = var_1_10006.New(arg_7_1)
	...
	local function var_7_5()
		...
		local var_8_2 = var_8_0.Create(var_8_1)
		...
		i18n = var_2_10008
		var_8_7.content = var_2_10008("guild_donate_tip", var_8_2:getConfig("name"), var_8_1[3], var_3, var_8_4)

		function var_8_7.onYes()
			local var_9_0 = arg_7_0
			local var_9_1 = var_0.emit

			PublicGuildMainMediator = var_3_10002

			var_9_1(var_9_0, var_3_10002.ON_COMMIT, var_0.id)
	...
	i18n = var_7
	var_7_6.text = var_7("guild_left_donate_cnt", var_7_1)
