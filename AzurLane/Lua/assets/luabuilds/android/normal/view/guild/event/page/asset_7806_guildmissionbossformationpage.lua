...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.descTxt = var_2_3(var_2_2, var_3(var_1_10004))
	UIItemList = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_2.Find(var_2_5, "frame/bottom/award/list")
	local var_2_7 = arg_2_0._tf

	arg_2_0.awardList = var_2_4(var_2_6, var_3.Find(var_2_7, "frame/bottom/award/list/item"))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.titleTxt = var_2_10(var_2_9, var_3(var_2_7))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.consumeTxt = var_2_14(var_2_13, var_3(var_2_7))
	...
	arg_2_0.commanderPage = var_2_23(var_2.Find(var_2_24, "frame/commanders"), arg_2_0.event, arg_2_0.contextData)
	setText = var_1

	local var_2_25 = arg_2_0.goBtn
	local var_2_26 = var_2.Find(var_2_25, "oil/label")

	i18n = var_2_25

	var_1(var_2_26, var_2_25("text_consume"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_2()
		...
		GuildBossMission = var_2_10002

		var_6_1(var_6_0, var_2_10002.SUB_FLEET_ID)
	...
	local function var_5_5()
		...
		var_7_1(var_7_0, var_2_10002.MAIN_FLEET_ID)
	...
	local function var_5_8()
		if arg_5_0.contextData.editBossFleet then
			...
			var_8_1(var_8_0, var_2_10002.ON_SAVE_FORMATION, function()
	...
	local function var_5_11()
		...
		var_10_1(var_10_0, var_2_10002.ON_UPDATE_BOSS_FLEET)
	...
	local function var_5_14()
		...
		var_11_1(var_11_0, var_2_10002.ON_RECOMM_BOSS_BATTLE_SHIPS, arg_5_0.fleet.id)
...
function var_0_1.OnShow(arg_16_0)
	...
	local var_16_3 = var_16_1.guildset.use_oil.key_value
	local var_16_4 = var_16_2

	if var_16_3 <= var_16_2.getResource(var_16_4, 2) then
		COLOR_GREEN = var_16_4

		if not var_16_4 then
			COLOR_RED = var_16_4
		end

		local var_16_5 = arg_16_0.consumeTxt

		string = var_1_10006
		var_16_5.text = var_1_10006.format("<color=%s>%d</color>/%d", var_16_4, var_3, var_16_3)
		ys = var_16_5

		local var_16_6 = var_16_5.Battle.BattleState.IsAutoBotActive

		SYSTEM_GUILD = var_6
		arg_16_0.isOpenAuto = var_16_6(var_6)
		AutoBotCommand = var_5

		local var_16_7 = var_5.GetAutoBotMark

		SYSTEM_GUILD = var_6

		local var_16_8 = var_16_7(var_6)
		local var_16_9 = arg_16_0

		arg_16_0.OnSwitch(var_16_9, arg_16_0._autoToggle, arg_16_0.isOpenAuto, function(arg_17_0)
			...
			var_1.SetInt("autoBotIsAcitve" .. var_16_8, arg_17_0 and 1 or 0)
		...
		local var_16_10 = var_6.Battle.BattleState.IsAutoSubActive

		SYSTEM_GUILD = var_16_9

		local var_16_11 = var_16_10(var_16_9)

		AutoSubCommand = var_16_9

		local var_16_12 = var_16_9.GetAutoSubMark

		SYSTEM_GUILD = var_8

		local var_16_13 = var_16_12(var_8)

		arg_16_0:OnSwitch(arg_16_0._autoSubToggle, var_16_11, function(arg_18_0)
			PlayerPrefs = var_2_10001

			var_2_10001.SetInt("autoSubIsAcitve" .. var_16_13, arg_18_0 and 1 or 0)
...
function var_0_1.UpdateSubToggle(arg_20_0)
	...
	GuildBossMission = var_1_10003

	local var_20_2 = var_20_1(var_20_0, var_1_10003.SUB_FLEET_ID)
	local var_20_3 = arg_20_0
	local var_20_4 = arg_20_0.GetFleet

	GuildBossMission = var_1_10004

	local var_20_5 = var_20_4(var_20_3, var_1_10004.MAIN_FLEET_ID)
...
function var_0_1.OnSwitch(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	local function var_21_2(arg_22_0)
		...
		var_2_10001(var_21_1, not arg_22_0)

		return
	end

	removeOnToggle = var_7
	...
	local function var_21_5(arg_23_0)
		var_21_2(arg_23_0)
		arg_21_3(arg_23_0)
	...
	var_7(var_21_3, var_21_4, var_21_5, var_1_10011)
...
function var_0_1.UpdateFleet(arg_28_0, arg_28_1)
	...
	var_28_2(var_28_3, arg_28_1 == var_6.MAIN_FLEET_ID)
	...
	var_28_2(var_28_4, arg_28_1 == var_6.SUB_FLEET_ID)
...
function var_0_1.UpdateCommanders(arg_29_0, arg_29_1)
	if arg_29_0.isOpenCommander then
		...
		local var_29_0 = var_2(var_1_10003)
...
function var_0_1.UpdateShips(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10006(var_30_0) do
		if iter_30_1 and iter_30_1.ship then
			...
			if var_30_5 == var_30_4.Vanguard then
				table = var_12

				var_12.insert(var_30_2, iter_30_1)
			else
				TeamType = var_12

				if var_30_5 == var_12.Main then
					table = var_12
					...
					if var_30_5 == var_12.Submarine then
						table = var_12

						var_12.insert(var_30_3, iter_30_1)
					end
				end
			end
		end
	...
	if arg_30_1.IsMainFleet(var_30_6) then
	...
	var_30_6(arg_30_0.flag, var_6 and #var_30_1 > 0)

	setActive = var_30_6

	var_30_6(arg_30_0.subFlag, not var_6 and #var_30_3 > 0)

	setActive = var_30_6

	var_30_6(arg_30_0.grids, var_6)

	setActive = var_30_6

	var_30_6(arg_30_0.subGrids, not var_6)
...
function var_0_1.UpdateMainFleetShips(arg_31_0, arg_31_1, arg_31_2)
	for iter_31_0 = 1, 3 do
		...
		var_31_4(var_31_3, var_31_5, var_31_6, var_1_10013.Main, var_31_2)
	end
	...
	for iter_31_1 = 4, 6 do
		...
		var_31_11(var_31_10, var_31_12, var_31_13, var_1_10013.Vanguard, var_31_9)
	end
...
function var_0_1.UpdateSubFleetShips(arg_32_0, arg_32_1)
	for iter_32_0 = 1, 3 do
		...
		var_32_4(var_32_3, var_32_5, var_32_6, var_1_10012.Submarine, var_32_2)
	end
...
function var_0_1.UpdateShip(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4)
	...
	local var_33_1 = arg_33_2.Find(var_33_0, "Image")

	if arg_33_4 then
		local var_33_2 = arg_33_4.ship
		local var_33_3 = var_33_0.getPrefab(var_33_2)

		SpineAnimChar = var_33_2
		var_1_10010 = var_33_2.New()

		var_8.SetPaint(var_1_10010, var_33_3)

		var_1_10010 = var_8

		var_8.Load(var_1_10010, true, function(arg_34_0)
			arg_34_0:SetName(var_33_3)
			...
			var_1.Update(var_34_0, var_33_0, arg_33_1)
			...
			var_2.AddPointClickFunc(var_34_1, function(arg_35_0, arg_35_1)
				...
				var_35_1(var_35_0, var_3_10004.ON_SELECT_BOSS_SHIP, arg_33_3, arg_33_0.fleet.id, arg_33_4)
			...
			var_2:AddDragEndFunc(function(arg_38_0, arg_38_1)
				...
				var_38_1(var_38_0, var_4.GetSoltIndex(var_38_2), true)
		...
		local function var_33_6()
			...
			var_39_1(var_39_0, var_2_10002.ON_SELECT_BOSS_SHIP, arg_33_3, arg_33_0.fleet.id)
		...
		var_33_0(var_33_4, var_33_5, var_33_6, var_1_10010)
	end

	setActive = var_33_0

	var_33_0(var_33_1, not arg_33_4)
...
function var_0_1.Scr2Lpos(arg_46_0, arg_46_1)
	...
	local var_46_3 = arg_46_0.GetComponent(var_46_2, "RectTransform")

	LuaHelper = var_46_2

	return (var_46_2.ScreenToLocal(var_46_3, arg_46_1, var_46_1))
end
