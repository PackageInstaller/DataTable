...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "eventlist/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.eventList = var_2_0(var_2_2, var_3.Find(var_2_3, "eventlist/content/tpl"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.reportTipTxt = var_2_8(var_2_7, var_3(var_2_3))
	...
	typeof = var_3
	Image = var_4
	arg_2_0.bg = var_2_17(var_2_16, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.nameTxt = var_2_21(var_2_20, var_3(var_4))
	...
	typeof = var_3
	Image = var_4
	arg_2_0.descPanelTag = var_2_25(var_2_24, var_3(var_4))
	setText = var_1

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_2.Find(var_2_26, "title/timer/label")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("guild_time_remaining_tip"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.endEventTimerTxt = var_2_30(var_2_29, var_3(var_4))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10002.ON_OPEN_REPORT)
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10002.ON_OPEN_FORMATION)
...
function var_0_1.SwitchPage(arg_10_0)
	...
	if arg_10_0.activeEvent then
		...
		if var_1 then
			...
			var_1_10003 = var_1
			var_10_0 = not var_1.IsParticipant(var_1_10003)
		...
		if var_10_0 then
			...
			local var_10_1 = arg_10_0.timeView

			var_1_10003.Flush(var_10_1, arg_10_0.endEventTimerTxt, var_1)
		end

		setActive = var_1_10003

		var_1_10003(arg_10_0.eventList.container, var_10_0)

		setActive = var_1_10003

		var_1_10003(arg_10_0.missionList, not var_10_0)

		setActive = var_1_10003

		var_1_10003(arg_10_0.titleTF, not var_10_0)
...
function var_0_1.UpdateReportBtn(arg_11_0)
	...
	local var_11_1 = var_11_0(var_1_10002.values(arg_11_0.reports), function(arg_12_0)
	...
	if 0 < var_11_4 then
		var_11_5 = var_11_3
		var_11_6 = not var_11_3.IsRecruit(var_11_5)
	else
		var_11_6 = false
	end
	...
	var_11_5(arg_11_0.reportTip, var_11_6)
...
function var_0_1.UpdateEvent(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_4 = var_15_3(var_15_2, var_1_10007(var_1_10008))

	GetSpriteFromAtlas = var_15_2
	var_15_4.sprite = var_15_2("guildevent/" .. var_15_1, "")

	local var_15_5 = arg_15_1
	local var_15_6 = arg_15_1.Find(var_15_5, "tag")

	if arg_15_2 then
		var_15_5 = var_0_2[arg_15_2:getConfig("difficulty")]
		GetSpriteFromAtlas = var_7

		local var_15_7 = var_7("ui/GuildEventUI_atlas", "tag_" .. var_15_5)
		...
		local var_15_10 = var_15_9(var_15_8, var_10(var_1_10011))

		var_15_10.sprite = var_15_7
	...
	var_15_5(var_15_6, arg_15_2)

	local var_15_11 = var_15_0 and arg_15_2 and var_15_0.id == arg_15_2.id

	setActive = var_15_13

	var_15_13(arg_15_1:Find("state"), var_15_11)

	setActive = var_15_13

	var_15_13(arg_15_1:Find("consume"), arg_15_2 and not var_15_11)

	setActive = var_15_13

	var_15_13(arg_15_1:Find("timer"), var_15_11)
	...
	if var_15_11 then
		...
		var_15_13 = var_15_13.Flush

		local var_15_14 = arg_15_1:Find("timer/Text")
		local var_15_15 = var_9.GetComponent

		typeof = var_1_10011
		Text = var_1_10012

		var_15_13(var_15_12, var_15_15(var_15_14, var_1_10011(var_1_10012)), var_15_0)
	end

	setText = var_15_13

	local var_15_16 = arg_15_1
	local var_15_17 = arg_15_1.Find(var_15_16, "timer/label")
	...
	if var_15_11 then
		...
		if not var_15_16("guild_time_remaining_tip") then
			var_15_18 = ""
		end

		var_15_13(var_15_17, var_15_18)

		if not arg_15_2 then
			removeOnButton = var_15_13
		...
		local var_15_19 = arg_15_1
		local var_15_20 = arg_15_1.Find(var_15_19, "consume/label")

		i18n = var_15_19

		var_15_13(var_15_20, var_15_19("guild_word_consume_for_battle"))

		setText = var_15_13

		var_15_13(arg_15_1:Find("consume/Text"), arg_15_2:GetConsume())

		local var_15_21 = arg_15_2

		if not arg_15_2.IsUnlock(var_15_21, arg_15_0.guildVO.level) then
			local var_15_22 = arg_15_1:Find("mask")

			var_15_21 = var_15_21.GetComponent
			typeof = var_10
			Image = var_1_10011
			var_15_21 = var_15_21(var_15_22, var_10(var_1_10011))
			GetSpriteFromAtlas = var_15_22
			var_15_21.sprite = var_15_22("guildevent/" .. "0_0", "")
		end

		setActive = var_15_21

		var_15_21(arg_15_1:Find("mask"), not var_7)

		onButton = var_15_21

		local var_15_23 = arg_15_0
		local var_15_24 = arg_15_1
		...
		local function var_15_25()
			...
			if not var_0.IsUnlock(var_16_0, arg_15_0.guildVO.level) then
				...
				var_16_2(var_16_1, var_2("guild_level_no_enough"))
			...
			if var_15_0 and var_15_0.id ~= arg_15_2.id then
				...
				var_16_4(var_16_3, var_2(var_16_5, var_4.getConfig(var_16_6, "name")))
			...
			GuildEventLayer = var_2

			var_16_8(var_16_7, var_2.OPEN_EVENT_INFO, arg_15_2)
		...
		var_15_21(var_15_23, var_15_24, var_15_25, var_1_10012)
...
function var_0_1.EnterActiveNode(arg_18_0)
	if arg_18_0.contextData.mission then
		...
		GuildEventLayer = var_1_10003

		var_18_1(var_18_0, var_1_10003.ON_OPEN_MISSION, arg_18_0.contextData.mission)
	end
...
function var_0_1.CheckBossNode(arg_19_0)
	...
	if var_1.ParentIsFinishByServer(var_19_0) and not var_1:IsActive() then
		...
		var_19_2(var_19_1, var_1_10004.ON_GET_BOSS_INFO)
	elseif var_1:ParentIFinish() and not var_1:IsActive() then
		...
		var_19_4(var_19_3, var_1_10004.REFRESH_MISSION, var_1:GetParentId())
	end
...
function var_0_1.InitView(arg_20_0)
	...
	var_20_0.sprite = var_1_10002(var_20_1 .. var_4.GetTheme(var_20_2), "")
	...
	for iter_23_0, iter_23_1 in var_1_10005(var_23_4) do
		if not iter_23_1:IsBoss() then
			...
			var_10.insert(var_23_3, function(arg_24_0)
				...
				var_24_1(var_24_0, var_2_10003.REFRESH_MISSION, iter_23_1.id, arg_24_0)
...
function var_0_1.AddRefreshTime(arg_26_0)
	...
	arg_26_0.timer = var_26_1(var_26_2, var_1_10003.FORCE_REFRESH_MISSION_TREE_TIME, 1)
...
function var_0_1.GenTree(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_1(arg_28_0.missions) do
		...
		for iter_28_2, iter_28_3 in var_1_10006(iter_28_1) do
			...
			local var_28_1 = arg_28_0.CreateNode(var_28_0, var_1_10011, iter_28_0, iter_28_3)

			table = var_28_0

			var_28_0.insert(arg_28_0.nodes, var_28_1)
		end
	end
...
function var_0_1.CreateNode(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	local function var_30_4()
		...
		if not var_0.IsUnLock(var_31_0) then
			...
			var_31_2(var_31_1, var_2_10002("guild_event_is_lock"))
		...
		if var_0.IsFinish(var_31_3) then
			...
			var_31_5(var_31_4, var_2_10002("guild_event_is_finish"))
	...
	var_5(var_30_2, var_30_3, var_30_4, var_1_10009)
...
function var_0_1.InitTree(arg_32_0)
	...
	for iter_32_0, iter_32_1 in var_1_10003(arg_32_0.nodes) do
		...
		local var_32_4 = var_32_2.abs(var_32_3.x)

		math = var_10

		local var_32_5 = var_10.abs(var_32_3.y)

		if var_32_4 > var_32_0[1] then
			var_32_0[1] = var_32_4 + iter_32_1._tf.sizeDelta.x
		end

		if var_32_5 > var_32_0[2] then
			var_32_0[2] = var_32_5 + iter_32_1._tf.sizeDelta.y / 2
		end
	...
	arg_32_0.SetScrollRect(var_32_6, var_32_0)

	if var_32_1 then
		local var_32_7 = -var_32_1._tf.localPosition.x

		math = var_32_6

		local var_32_8 = var_32_6.max(var_32_7, -arg_32_0.pathContains.rect.width * 0.5)
...
function var_0_1.CreateLinkLine(arg_33_0, arg_33_1)
	...
	if arg_33_1:HasChild() then
		...
		GuildViewMissionNode = var_6

		var_33_2(var_33_1, var_33_3, var_6.LINE_RIGHT, arg_33_1)
	end
	...
	if arg_33_1:HasParent() then
		...
		var_33_5(var_33_4, var_33_6, var_6.LINE_LEFT, arg_33_1)
	end

	local var_33_7 = arg_33_1
	local var_33_8 = arg_33_1.GetChilds(var_33_7)

	ipairs = var_33_7

	for iter_33_0, iter_33_1 in var_33_7(var_33_8) do
		if iter_33_1:GetOffset() > 0 then
			local var_33_9 = arg_33_1
			local var_33_10 = arg_33_1.AddLine
			local var_33_11 = var_33_0(arg_33_0.line, "line")

			GuildViewMissionNode = var_13

			var_33_10(var_33_9, var_33_11, var_13.TOP_LINK, iter_33_1)

			local var_33_12 = arg_33_1
			local var_33_13 = arg_33_1.AddLine
			local var_33_14 = var_33_0(arg_33_0.line, "line")

			GuildViewMissionNode = var_13

			var_33_13(var_33_12, var_33_14, var_13.TOP_HRZ_LINK, iter_33_1)
		elseif var_9 < 0 then
			local var_33_15 = arg_33_1
			local var_33_16 = arg_33_1.AddLine
			local var_33_17 = var_33_0(arg_33_0.line, "line")

			GuildViewMissionNode = var_13

			var_33_16(var_33_15, var_33_17, var_13.BOTTOM_LINK, iter_33_1)

			local var_33_18 = arg_33_1
			local var_33_19 = arg_33_1.AddLine
			local var_33_20 = var_33_0(arg_33_0.line, "line")

			GuildViewMissionNode = var_13

			var_33_19(var_33_18, var_33_20, var_13.BOTTOM_HRZ_LINK, iter_33_1)
		elseif var_9 == 0 then
			local var_33_21 = arg_33_1
			local var_33_22 = arg_33_1.AddLine
			local var_33_23 = var_33_0(arg_33_0.line, "line")

			GuildViewMissionNode = var_13

			var_33_22(var_33_21, var_33_23, var_13.CENTER_LINK, iter_33_1)
		end
	end
...
function var_0_1.ShowDesc(arg_36_0, arg_36_1)
	...
	if not var_5.IsBoss(var_36_3) then
		...
		local var_36_6 = var_36_5(var_36_4, var_36_7(var_8))

		GetSpriteFromAtlas = var_36_4
		var_36_7 = "GuildMission/"

		local var_36_8 = arg_36_1.data

		var_36_6.sprite = var_36_4(var_36_7 .. var_8.GetIcon(var_36_8), "")
	else
		...
		local var_36_11 = var_36_10(var_36_9, var_36_7(var_8))

		GetSpriteFromAtlas = var_36_9
		var_36_7 = "GuildMission/boss_"

		local var_36_12 = arg_36_1.data

		var_36_11.sprite = var_36_9(var_36_7 .. var_8.GetIcon(var_36_12), "")
	end

	local var_36_13 = arg_36_1.data
	local var_36_14 = var_5.GetTag(var_36_13)
	local var_36_15 = arg_36_0.descPanelTag

	GetSpriteFromAtlas = var_36_7
	var_36_15.sprite = var_36_7("ui/GuildMissionUI_atlas", "tag" .. var_36_14)

	local function var_36_16(arg_37_0)
		if not arg_37_0:IsUnLock() then
			...
			var_37_1(var_37_0, var_2_10003("guild_event_is_lock"))
		...
		if arg_37_0:IsFinish() then
			...
			var_37_3(var_37_2, var_2_10003("guild_event_is_finish"))
	...
	local var_36_17 = arg_36_0
	local var_36_18 = arg_36_0.descPanel

	local function var_36_19()
		local var_38_0 = arg_36_1.data

		if var_0.IsBoss(var_38_0) then
			if not var_36_16(arg_36_1) then
				return
			end
			...
			var_38_2(var_38_1, var_2_10002.ON_OPEN_BOSS, arg_36_1.data)
		else
			...
			var_38_4(var_38_3, var_2_10002.REFRESH_MISSION, arg_36_1.data.id, function()
				if not var_36_16(arg_36_1) then
					return
				end
				...
				GuildEventLayer = var_3_10002

				var_39_1(var_39_0, var_3_10002.ON_OPEN_MISSION, arg_36_1.data)
	...
	var_7(var_36_17, var_36_18, var_36_19, var_1_10011)
