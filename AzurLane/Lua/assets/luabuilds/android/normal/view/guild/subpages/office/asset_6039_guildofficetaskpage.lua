...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.taskDescTxt = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.taskAwardTxt = var_2_10(var_2_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.taskProgressTxt = var_2_13(var_2_12, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.privateTaskDesc = var_2_17(var_2_16, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.privateTaskProgressTxt = var_2_22(var_2_21, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.privateTaskResTxt = var_2_26(var_2_25, var_3(var_1_10004))
	...
	local var_2_31 = var_2.Find(var_2_30, "TaskPanel/SubmitPanel/list")
	local var_2_32 = arg_2_0._tf

	arg_2_0.contributionList = var_2_29(var_2_31, var_3.Find(var_2_32, "TaskPanel/SubmitPanel/list/tpl"))
	...
	typeof = var_3
	Text = var_2_32
	arg_2_0.contributionCntTxt = var_2_35(var_2_34, var_3(var_2_32))
	...
	typeof = var_3
	Text = var_2_32
	arg_2_0.supplyOpenTimeTxt = var_2_40(var_2_39, var_3(var_2_32))
	...
	typeof = var_3
	Text = var_2_32
	arg_2_0.supplyOpenLetfCntTxt = var_2_43(var_2_42, var_3(var_2_32))
	...
	typeof = var_3
	Text = var_2_32
	arg_2_0.supplyUnOpenResTF = var_2_50(var_2_49, var_3(var_2_32))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_6()
		...
		local var_4_2 = var_4_0.MsgboxMgr.GetInstance()
		local var_4_3 = var_1.ShowMsgBox
		local var_4_4 = {}

		i18n = var_2_10004
		var_4_4.content = var_2_10004("guild_start_supply_consume_tip", var_4_1)

		function var_4_4.onYes()
			local var_5_0 = arg_3_0
			local var_5_1 = var_0.emit

			GuildOfficeMediator = var_3_10002

			var_5_1(var_5_0, var_3_10002.ON_PURCHASE_SUPPLY)
	...
	local function var_3_9()
		...
		var_6_1(var_6_0, var_2_10002.GET_SUPPLY_AWARD)
	...
	local function var_3_12()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.guild_supply_help_tip.tip
...
function var_0_1.UpdateTaskPanel(arg_13_0, arg_13_1)
	...
	if var_13_2 == var_13_1.STATE_EMPTY then
	...
	if var_13_2 ~= var_5.STATE_ONGOING then
		...
		var_5(var_13_3, var_13_2 ~= var_1_10007.STATE_EMPTY)
		...
		var_5(var_13_4, var_13_2 == var_7.STATE_EMPTY)

		if arg_13_1 or var_2:shouldRefreshWeeklyTaskProgress() then
			local var_13_5 = arg_13_0
			local var_13_6 = arg_13_0.emit

			GuildOfficeMediator = var_7

			var_13_6(var_13_5, var_7.UPDATE_WEEKLY_TASK)
		end
...
function var_0_1.UpdatePrivateTask(arg_16_0, arg_16_1)
	...
	local var_16_3 = arg_16_1.GetPresonTaskId(var_16_2)

	getProxy = var_16_2
	TaskProxy = var_1_10005

	local var_16_4 = var_16_2(var_1_10005)
	local var_16_5

	if not var_4.getTaskById(var_16_4, var_16_3) then
		var_16_5 = var_4:getFinishTaskById(var_16_3)
	end

	if not (var_16_5 ~= nil) then
		Task = var_7
		var_16_5 = var_7.New({
			id = var_16_3
		})
	...
	arg_16_0.privateTaskDesc.text = var_16_5:getConfig("desc")

	local var_16_6 = arg_16_0.privateTaskProgressTxt
	local var_16_7 = var_16_5.progress
	local var_16_8 = "/"
	local var_16_9 = var_16_5

	var_16_6.text = var_16_7 .. var_16_8 .. var_16_5.getConfig(var_16_9, "target_num")

	local var_16_10 = arg_16_0.privateTaskResTxt

	var_16_10.text = arg_16_1:GetPrivateAward()
	onButton = var_16_10

	local var_16_11 = arg_16_0
	local var_16_12 = arg_16_0.privateTaskAcceptBtn
	...
	local function var_16_13()
		...
		local var_17_5 = var_5.getConfig(var_17_4, "name")
		local var_17_6 = var_16_5
		local var_17_7 = var_6.getConfig(var_17_6, "name")
		local var_17_8 = var_16_5

		var_17_2.content = var_2_10003(var_17_3, var_17_5, var_17_7, var_7.getConfig(var_17_8, "name"))
		...
		function var_17_2.onYes()
			...
			var_18_1(var_18_0, var_3_10002.ON_ACCEPT_TASK, var_16_3)
	...
	var_16_10(var_16_11, var_16_12, var_16_13, var_16_9)

	onButton = var_16_10

	local var_16_14 = arg_16_0
	local var_16_15 = arg_16_0.privateTaskGetBtn
	...
	local function var_16_16()
		...
		var_19_1(var_19_0, var_2_10002.ON_SUBMIT_TASK, var_16_3)
	...
	var_16_10(var_16_14, var_16_15, var_16_16, var_16_9)

	if var_16_5:isFinish() and not var_16_5:isReceive() and not var_16_1 then
		local var_16_17 = arg_16_0
		local var_16_18 = arg_16_0.emit

		GuildOfficeMediator = var_16_15

		var_16_18(var_16_17, var_16_15.ON_SUBMIT_TASK, var_16_3)
	elseif not var_6 and var_16_1 then
		local var_16_19 = arg_16_0
		local var_16_20 = arg_16_0.emit

		GuildOfficeMediator = var_16_15

		var_16_20(var_16_19, var_16_15.ON_ACCEPT_TASK, var_16_3)
	end

	local var_16_21 = not var_16_1
	local var_16_22 = arg_16_1
	local var_16_23

	if arg_16_1.isFinished(var_16_22) then
		var_16_23 = not var_6 or not var_16_1
	end

	setActive = var_16_22

	var_16_22(arg_16_0.taskMaskAll, var_16_23)

	setActive = var_16_22

	var_16_22(arg_16_0.taskMaskTop, not var_16_23 and arg_16_1:isFinished())

	setActive = var_16_22

	var_16_22(arg_16_0.privateTaskReapeatFlag, var_16_21)

	setActive = var_16_22

	var_16_22(arg_16_0.privateTaskResTxt.gameObject.transform.parent, not var_16_21)

	setActive = var_16_22

	var_16_22(arg_16_0.privateTaskAcceptBtn, not var_6 or var_16_5:isReceive())

	setActive = var_16_22

	local var_16_24 = arg_16_0.privateTaskGetBtn
	local var_16_25

	if var_6 and var_16_5:isFinish() then
		var_16_25 = not var_16_5:isReceive()
	end

	var_16_22(var_16_24, var_16_25)

	setActive = var_16_22

	var_16_22(arg_16_0.privateTaskProgressTxt.gameObject.transform.parent, var_6 and not var_16_5:isFinish())
...
function var_0_1.UpdateContributionPanel(arg_21_0)
	...
	local var_21_2 = var_1:getRemainDonateCnt() + var_1:GetExtraDonateCnt()
	local var_21_3 = arg_21_0.contributionList

	var_4.make(var_21_3, function(arg_22_0, arg_22_1, arg_22_2)
		...
		if arg_22_0 == var_2_10003.EventUpdate then
			...
			local function var_22_4()
				...
				local var_23_5 = var_4.MsgboxMgr.GetInstance()
				local var_23_6 = var_4.ShowMsgBox
				local var_23_7 = {}

				i18n = var_3_10007
				var_23_7.content = var_3_10007("guild_donate_tip", var_23_2:getConfig("name"), var_23_1[3], var_2, var_23_4)

				function var_23_7.onYes()
					local var_24_0 = arg_21_0
					local var_24_1 = var_0.emit

					GuildOfficeMediator = var_4_10002

					var_24_1(var_24_0, var_4_10002.ON_COMMIT, var_22_0.id)
			...
			var_5(var_4.commitBtn, var_21_2 > 0)
		end
	...
	var_4.align(var_21_4, #var_21_1)

	local var_21_5 = arg_21_0.contributionCntTxt

	i18n = var_21_4
	var_21_5.text = var_21_4("guild_left_donate_cnt", var_21_2)
...
function var_0_1.UpdateSupplyPanel(arg_25_0)
	...
	var_25_0(arg_25_0.supplyOpenTF, var_25_1)

	setActive = var_25_0

	var_25_0(arg_25_0.supplyUnOpenTF, not var_25_1)

	if not var_25_1 then
		setActive = var_25_0

		var_25_0(arg_25_0.supplyUnOpenAdminTF, arg_25_0.isAdmin)

		setActive = var_25_0

		var_25_0(arg_25_0.supplyUnOpenLockTF, not arg_25_0.isAdmin)

		if arg_25_0.isAdmin then
			arg_25_0.supplyUnOpenResTF.text = var_1:getSupplyConsume()
		end
	else
		local var_25_2 = var_1:getSupplyCnt()
		local var_25_3 = var_1
		local var_25_4 = var_1.getSupplyLeftCnt(var_25_3)

		setActive = var_25_3

		var_25_3(arg_25_0.supplyOpenGetBtn, var_25_2 > 0)

		setActive = var_25_3

		var_25_3(arg_25_0.supplyOpenGotBtn, var_25_2 <= 0)

		if var_25_4 < 0 then
			local var_25_5 = arg_25_0.supplyOpenTimeTxt

			i18n = var_6
			var_25_5.text = var_6("guild_exist_unreceived_supply_award")
		else
			local var_25_6 = arg_25_0.supplyOpenTimeTxt

			i18n = var_6
			var_25_6.text = var_6("guild_left_supply_day", var_25_4)
		end

		local var_25_7 = arg_25_0.supplyOpenLetfCntTxt
		...
		var_25_7.text = var_6(var_25_8 .. var_25_9 .. var_1_10009.MAX_SUPPLY_CNT)
	end
