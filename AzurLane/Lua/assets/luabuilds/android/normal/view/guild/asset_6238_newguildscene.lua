...
function var_0_1.didEnter(arg_5_0)
	...
	local function var_5_5()
		...
		NewGuildMediator = var_2_10002

		var_7_1(var_7_0, var_2_10002.OPEN_GUILD_LIST)
	...
	local function var_5_11()
		...
		var_9_1(var_9_0, var_2_10002.OPEN_PUBLIC_GUILD)
...
function var_0_1.selectFaction(arg_14_0, arg_14_1, arg_14_2)
	local function var_14_0(arg_15_0, arg_15_1)
		...
		var_15_0(var_15_1, true)

		local var_15_2 = var_15_1
		local var_15_3 = var_15_1.GetComponent(var_15_2, "CanvasGroup")

		LeanTween = var_15_2

		local var_15_4 = var_15_2.value

		go = var_5

		local var_15_5 = var_15_4(var_5(var_15_1), 1, 3, 0.5)
		local var_15_6 = var_4.setOnUpdate

		System = var_6

		local var_15_7 = var_15_6(var_15_5, var_6.Action_float(function(arg_16_0)
			local var_16_0 = var_15_1

			Vector3 = var_3_10002
			var_16_0.localScale = var_3_10002(arg_16_0, arg_16_0, 1)
			var_15_3.alpha = 1 - arg_16_0 / 3

			return
		end))
		local var_15_8 = var_4.setOnComplete

		System = var_6

		var_15_8(var_15_7, var_6.Action(function()
			...
			Vector3 = var_1
			var_17_0.localScale = var_1(1, 1, 1)
	...
	if not arg_14_0.isInitFaction then
		...
		var_9(var_14_6, var_1_10011("commonbg/camp_bg", ""))

		setImageSprite = var_9

		local var_14_7 = var_14_3
		local var_14_8 = var_14_3.Find(var_14_7, "bg")

		GetSpriteFromAtlas = var_14_7

		var_9(var_14_8, var_14_7("clutter/blhx_icon", ""))

		setImageSprite = var_9

		local var_14_9 = var_14_4
		local var_14_10 = var_14_4.Find(var_14_9, "bg")

		GetSpriteFromAtlas = var_14_9

		var_9(var_14_10, var_14_9("clutter/cszz_icon", ""))
	...
	local function var_14_13()
		...
		var_18_1(var_18_0, var_2_10002.FACTION_TYPE_BLHX)
	...
	var_9(var_14_11, var_14_12, var_14_13, var_1_10013)
	...
	var_9(arg_14_0, var_14_4, function()
		...
		var_20_1(var_20_0, var_2_10002.FACTION_TYPE_CSZZ)
	...
	local var_14_15 = arg_14_0.backBtn
	...
	local function var_14_16()
		...
		SFX_CANCEL = var_2_10004

		var_22_0(var_22_1, var_22_2, var_22_3, var_2_10004)
	...
	var_9(var_14_14, var_14_15, var_14_16, var_1_10013)
...
function var_0_1.setDescInfo(arg_24_0, arg_24_1)
	...
	local var_24_1 = arg_24_1.getFaction(var_24_0)

	GuildConst = var_24_0

	if var_24_1 == var_24_0.FACTION_TYPE_BLHX then
		arg_24_0.mainPage = arg_24_0.mainBluePage
	else
		GuildConst = var_3

		if var_24_1 == var_3.FACTION_TYPE_CSZZ then
	...
	local var_24_3 = arg_24_0.mainPage

	var_4.ExecuteAction(var_24_3, "Show", arg_24_1, arg_24_0.playerVO, function()
		setActive = var_2_10000
	...
	local var_24_5 = arg_24_0.backBtn
	local var_24_6 = var_24_2

	SFX_CANCEL = var_8

	var_4(var_24_4, var_24_5, var_24_6, var_8)
