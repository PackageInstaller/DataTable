...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.chatBtnTipCnt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.battleEventTipCnt = var_2_13(var_2_12, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.battleReportCnt = var_2_18(var_2_17, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.nameTxt = var_2_22(var_2_21, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.levelImg = var_2_26(var_2_25, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.factionTxt = var_2_29(var_2_28, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.policyTxt = var_2_32(var_2_31, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.idTxt = var_2_35(var_2_34, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.numberTxt = var_2_38(var_2_37, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.levelTxt = var_2_42(var_2_41, var_3(var_1_10004))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_5()
		...
		var_5_1(var_5_0, var_2_10002.OPEN_EVENT_REPORT)
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10002.OPEN_SHOP)
...
function var_0_1.UpdateBattleBtn(arg_15_0)
	...
	var_15_0(var_15_2, var_4.GetActiveEvent(var_15_3) ~= nil)

	setActive = var_15_0

	var_15_0(arg_15_0.battleEventTip, false)
	...
	local var_15_6 = var_15_4.select

	_ = var_4

	local var_15_7 = #var_15_6(var_4.values(var_15_1), function(arg_16_0)
		return arg_16_0:CanSubmit()
	end)
	local var_15_8, var_15_9

	if 0 < var_15_7 then
		var_15_8 = var_15_5
		var_15_9 = not var_15_5.IsRecruit(var_15_8)
	else
		var_15_9 = false
	end
	...
	var_15_8(arg_15_0.battleReport, var_15_9)

	setActive = var_15_8

	var_15_8(arg_15_0.battleReportTip, var_15_9)
...
function var_0_1.UpdateChatBtn(arg_17_0)
	...
	var_1_10003(arg_17_0.chatBtnTip, var_17_1)
...
function var_0_1.InitChatWindow(arg_18_0)
	...
	arg_18_0.noticeTxt = var_18_2(var_18_1, var_3(var_1_10004))
	...
	arg_18_0.noticeScrollTxt = var_18_6(var_18_5, var_3(var_1_10004))
	...
	typeof = var_3
	InputField = var_4
	arg_18_0.msgInput = var_18_16(var_18_15, var_3(var_4))
	...
	local function var_18_21()
		...
		if 0 < var_19_1 then
			pg = var_19_1
			var_19_2 = var_19_1.TipsMgr.GetInstance()
			var_19_1 = var_19_1.ShowTips
			i18n = var_2_10003

			var_19_1(var_19_2, var_2_10003("playerinfo_mask_word"))
		...
		if var_19_0 == "" then
			...
			var_19_3(var_19_2, var_2_10003("guild_msg_is_null"))
		...
		if arg_18_0.chatTimer then
			pg = var_1
			var_19_2 = var_1.TimeMgr.GetInstance()

			if var_1.GetServerTime(var_19_2) - arg_18_0.chatTimer < 5 then
				pg = var_1
				var_19_2 = var_1.TipsMgr.GetInstance()

				local var_19_4 = var_1.ShowTips

				i18n = var_2_10003

				var_19_4(var_19_2, var_2_10003("dont_send_message_frequently"))
		...
		local var_19_6 = var_19_2.TimeMgr.GetInstance()

		var_19_5.chatTimer = var_2.GetServerTime(var_19_6)

		local var_19_7 = arg_18_0
		local var_19_8 = var_1.emit

		GuildMainMediator = var_19_6

		var_19_8(var_19_7, var_19_6.SEND_MSG, var_19_0)
	...
	var_1(var_18_19, var_18_20, var_18_21, var_1_10005)
	...
	local function var_18_24()
		...
		local var_20_3 = var_2_10003.OPEN_EMOJI

		Vector3 = var_2_10004

		var_20_2(var_20_1, var_20_3, var_2_10004(var_20_0.x, var_20_0.y, 0), function(arg_21_0)
			local var_21_0 = arg_18_0
			local var_21_1 = var_1.emit

			GuildMainMediator = var_3_10003

			local var_21_2 = var_3_10003.SEND_MSG

			string = var_3_10004

			local var_21_3 = var_3_10004.gsub

			ChatConst = var_3_10005

			var_21_1(var_21_0, var_21_2, var_21_3(var_3_10005.EmojiCode, "code", arg_21_0))
	...
	var_1(var_18_22, var_18_23, var_18_24, var_1_10005)
	...
	typeof = var_18_23
	EventTriggerListener = var_18_24

	local var_18_26 = var_1(var_18_25, var_18_23(var_18_24))
	...
	var_1.AddDragEndFunc(var_18_26, function(arg_22_0, arg_22_1)
		...
		if var_2_10002(var_22_0, var_2_10004(var_2_10005)).normalizedPosition.y <= 0.1 then
	...
	if arg_18_0.isAdmin then
		...
		var_2(arg_18_0, arg_18_0.noticeTxt.gameObject, function()
			...
			getInputText = var_23_0

			if var_23_0(arg_18_0.noticeTxt.gameObject) == "" or var_1 == var_23_1 then
				return
			end
			...
			if var_2(var_1) > 0 then
				...
				var_23_3(var_23_2, var_2_10004("playerinfo_mask_word"))
			...
			var_23_6(var_23_5, var_4.MODIFY, 5, 0, var_1)
...
function var_0_1.UpdateNotice(arg_25_0)
	...
	if not var_1.GetAnnounce(var_25_0) or var_2 == "" then
		...
		if not var_1_10004("guild_not_exist_notifycation") then
			var_25_1 = var_2
		end
...
function var_0_1.AppendLog(arg_27_0, arg_27_1, arg_27_2)
	...
	if arg_27_0.logContent.childCount >= 200 then
		...
		var_27_1(var_27_0, var_1_10005.ON_REBUILD_LOG_ALL)
	else
		cloneTplTo = var_27_1
		...
		local var_27_7 = var_27_6(var_27_5, var_7(var_1_10008))
...
function var_0_1.UpdateAllChat(arg_28_0, arg_28_1)
	...
	local var_28_2 = var_4.max
	local var_28_3 = 1
	local var_28_4 = #var_28_0

	GuildConst = var_1_10007
	arg_28_0.index = var_28_2(var_28_3, var_28_4 - var_1_10007.CHAT_LOG_MAX_COUNT)

	for iter_28_0 = arg_28_0.index, #var_28_0 do
		table = var_1_10008

		var_1_10008.insert(var_28_1, function(arg_29_0)
...
function var_0_1.Append(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	...
	arg_32_0.UpdateChatBtn(var_32_0)

	if not arg_32_0.isInitChatWindow then
		return
	end

	local var_32_1 = arg_32_0.chatContent.childCount

	GuildConst = var_32_0

	if var_32_1 >= var_32_0.CHAT_LOG_MAX_COUNT * 2 then
		local var_32_2 = arg_32_0
		local var_32_3 = arg_32_0.emit

		GuildMainMediator = var_1_10006

		var_32_3(var_32_2, var_1_10006.REBUILD_ALL)
...
function var_0_1.AddWorldBossMsg(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local var_35_1 = var_1_10006(arg_35_0.prefabWorldboss, arg_35_0.chatContent)

	ChatBubbleWorldBoss = var_7

	local var_35_2 = var_7.New(var_35_1)
...
function var_0_1.AppendWorld(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	...
	if var_36_0.id == arg_36_0.playerVO.id then
		...
		setmetatable = var_7
		Clone = var_8
		var_4.player = var_7(var_8(arg_36_0.playerVO), {
...
function var_0_1.UpdateMainInfo(arg_38_0)
	...
	var_38_1(var_38_2, var_38_3 / var_5.max(var_38_0:getLevelMaxExp(), 1))
...
function var_0_1.ShowOrHideChatWindow(arg_39_0, arg_39_1)
	...
	if var_39_0(var_1_10003(arg_39_0.chatPanel)) then
		return
	end
	...
	local function var_39_5()
		...
		if arg_39_1 then
			...
			var_40_1(var_40_0, var_2_10002.UIMgr.GetInstance().OverlayMain, true)
			...
			Vector3 = var_2
			var_40_2.localPosition = var_2(var_40_1.x, var_40_1.y, 0)
			pg = var_40_2
	...
	local var_39_7 = var_39_6(var_1_10008(arg_39_0.chatPanel), var_39_1, var_39_2, 0.3)
	local var_39_8 = var_7.setOnUpdate

	System = var_9

	local var_39_9 = var_39_8(var_39_7, var_9.Action_float(function(arg_41_0)
	...
	var_39_10(var_39_9, var_9.Action(var_39_5))
	...
	var_39_13(var_39_12, var_9.Action_float(function(arg_42_0)
		setAnchoredPosition = var_2_10001
...
function var_0_1.EnterOrExitPreView(arg_43_0, arg_43_1)
	...
	if not var_43_0(var_1_10003(arg_43_0.top)) then
		LeanTween = var_2
		...
		if not var_43_1(var_3(arg_43_0.bottomPanel)) then
			LeanTween = var_2
			...
			if not var_43_2(var_3(arg_43_0.chatPanel)) then
				LeanTween = var_2
				...
				if var_43_3(var_3(arg_43_0.chatBtn)) then
					return
				end
				...
				local var_43_5 = var_3.value

				go = var_4

				local var_43_6 = var_43_5(var_4(arg_43_0.top), var_43_4[1], var_43_4[2], 0.3)
				local var_43_7 = var_3.setOnUpdate

				System = var_5

				var_43_7(var_43_6, var_5.Action_float(function(arg_44_0)
					setAnchoredPosition = var_2_10001
				...
				local var_43_9 = var_43_6.value

				go = var_5

				local var_43_10 = var_43_9(var_5(arg_43_0.bottomPanel), var_43_8[1], var_43_8[2], 0.3)
				local var_43_11 = var_4.setOnUpdate

				System = var_6

				var_43_11(var_43_10, var_6.Action_float(function(arg_45_0)
					setAnchoredPosition = var_2_10001
				...
				if arg_43_0.isShowChatWindow then
					...
					if not arg_43_1 or not {
						...
						var_43_12[2] = var_43_10
					end

					LeanTween = var_43_10
					var_43_10 = var_43_10.value
					go = var_43_13
					var_43_13 = var_43_10(var_43_13(arg_43_0.chatPanel), var_43_12[1], var_43_12[2], 0.3)
					var_43_10 = var_43_10.setOnUpdate
					System = var_7

					var_43_10(var_43_13, var_7.Action_float(function(arg_46_0)
						setAnchoredPosition = var_2_10001
					...
					local var_43_15 = var_43_10.value
					...
					var_43_17(var_43_16, var_7.Action_float(function(arg_47_0)
						setAnchoredPosition = var_2_10001
...
function var_0_1.InsertEmojiToInputText(arg_48_0, arg_48_1)
	...
	var_48_0.text = var_48_1 .. var_48_2(var_1_10005.EmojiIconCode, "code", arg_48_1)
...
function var_0_1.OnDestroy(arg_49_0)
	if arg_49_0.isShowChatWindow then
		pg = var_1
		var_1_10002 = var_1.UIMgr.GetInstance()

		var_1.UnOverlayPanel(var_1_10002, arg_49_0.chatPanel, arg_49_0._tf)
	end
	...
	if var_49_0(var_1_10002(arg_49_0.chatPanel)) then
		LeanTween = var_49_1
		var_49_1 = var_49_1.cancel
		go = var_2

		var_49_1(var_2(arg_49_0.chatPanel))
	end
	...
	if var_49_2(var_2(arg_49_0.chatBtn)) then
		LeanTween = var_1
		...
		var_49_3(var_2(arg_49_0.chatBtn))
	end
