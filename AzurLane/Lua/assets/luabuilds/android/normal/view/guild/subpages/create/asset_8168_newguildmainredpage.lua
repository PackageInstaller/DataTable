...
function var_0_1.OnInit(arg_3_0)
	...
	var_3_1(arg_3_0, arg_3_0.nameInput, function()
		...
		local var_4_1, var_4_2 = var_1(var_4_0, {
			isReplace = true
		})
	...
	var_3_1(arg_3_0, arg_3_0.manifestoInput, function()
		...
		local var_5_1, var_5_2 = var_1(var_5_0, {
			isReplace = true
		})
	...
	local function var_3_13()
		...
		if not var_3.getName(var_9_5) or var_3 == "" then
			...
			local var_9_6 = var_9_5.TipsMgr.GetInstance()

			var_9_5 = var_9_5.ShowTips
			i18n = var_2_10006

			var_9_5(var_9_6, var_2_10006("guild_create_error_noname"))

			return
		end

		nameValidityCheck = var_9_5

		if not var_9_5(var_3, 0, 20, {
			"spece_illegal_tip",
		...
		local var_9_7 = arg_3_0.newGuildVO

		if not var_4.getFaction(var_9_7) then
			pg = var_4

			local var_9_8 = var_4.TipsMgr.GetInstance()
			local var_9_9 = var_4.ShowTips

			i18n = var_6

			var_9_9(var_9_8, var_6("guild_create_error_nofaction"))

			return
		end

		local var_9_10 = arg_3_0.newGuildVO

		if not var_4.getPolicy(var_9_10) then
			pg = var_4

			local var_9_11 = var_4.TipsMgr.GetInstance()
			local var_9_12 = var_4.ShowTips

			i18n = var_6

			var_9_12(var_9_11, var_6("guild_create_error_nopolicy"))

			return
		end

		local var_9_13 = arg_3_0.newGuildVO

		if not var_4.getManifesto(var_9_13) or var_4 == "" then
			pg = var_9_13

			local var_9_14 = var_9_13.TipsMgr.GetInstance()

			var_9_13 = var_9_13.ShowTips
			i18n = var_7

			var_9_13(var_9_14, var_7("guild_create_error_nomanifesto"))
		...
		local var_9_15 = var_9_13.MsgboxMgr.GetInstance()
		local var_9_16 = var_5.ShowMsgBox
		local var_9_17 = {}

		i18n = var_8
		var_9_17.content = var_8("guild_create_confirm", var_3_0)

		function var_9_17.onYes()
			local var_10_0 = arg_3_0.playerVO

			if var_0.getTotalGem(var_10_0) < var_3_0 then
				GoShoppingMsgBox = var_0
				i18n = var_1
				var_3_10002 = "switch_to_shop_tip_3"
				i18n = var_3_10003

				local var_10_1 = var_1(var_3_10002, var_3_10003("word_gem"))

				ChargeScene = var_3_10002

				var_0(var_10_1, var_3_10002.TYPE_DIAMOND)
			else
				local var_10_2 = arg_3_0
				local var_10_3 = var_0.emit

				NewGuildMediator = var_3_10002

				var_10_3(var_10_2, var_3_10002.CREATE, arg_3_0.newGuildVO)
			end
...
function var_0_1.Show(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	local var_11_3 = var_11_2(var_11_1, var_8.Action_float(function(arg_12_0)
	...
	local var_11_5 = var_11_4(var_11_3, var_8.Action(function()
