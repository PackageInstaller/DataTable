...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.firenameTF = var_2_4(var_2_3, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.fireiconTF = var_2_7(var_2_6, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.fireduty = var_2_10(var_2_9, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.firelevelTF = var_2_15(var_2_14, var_3(var_1_10004))
...
function var_0_1.OnShow(arg_6_0)
	...
	local var_6_15 = arg_6_0.firelevelTF

	var_6_15.text = "Lv." .. var_6_2.level
	onButton = var_6_15

	local var_6_16 = arg_6_0
	local var_6_17 = arg_6_0.fireconfirmBtn
	...
	local function var_6_18()
		...
		i18n = var_2_10003
		var_9_2.content = var_2_10003("guild_fire_tip")
		...
		function var_9_2.onYes()
			...
			var_10_1(var_10_0, var_3_10002.FIRE, var_6_2.id)
