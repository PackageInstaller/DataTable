...
function var_0_1.OnLoaded(arg_4_0)
	...
	arg_4_0.sea = var_4_3(var_4_2, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0.titleTxt = var_4_6(var_4_5, var_3(var_1_10004))
	...
	local var_4_14 = var_2.Find(var_4_13, "scrollrect/content")
	local var_4_15 = arg_4_0.logPanel

	arg_4_0.logList = var_4_12(var_4_14, var_3.Find(var_4_15, "scrollrect/content/tpl"))
	...
	typeof = var_3
	Text = var_4_15
	arg_4_0.peopleCnt = var_4_18(var_4_17, var_3(var_4_15))
	...
	typeof = var_3
	Text = var_4_15
	arg_4_0.effectCnt = var_4_21(var_4_20, var_3(var_4_15))
	setText = var_1

	local var_4_22 = arg_4_0._tf
	local var_4_23 = var_2.Find(var_4_22, "bottom/cnt")

	i18n = var_4_22

	var_1(var_4_23, var_4_22("guild_join_member_cnt"))

	setText = var_1

	local var_4_24 = arg_4_0._tf
	local var_4_25 = var_2.Find(var_4_24, "bottom/effect")

	i18n = var_4_24

	var_1(var_4_25, var_4_24("guild_total_effect"))
	...
	typeof = var_3
	Text = var_4
	arg_4_0.areaTxt = var_4_28(var_4_27, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_4_0.goalTxt = var_4_31(var_4_30, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_4_0.timeTxt = var_4_34(var_4_33, var_3(var_4))
	UIItemList = var_1

	local var_4_35 = var_1.New
	local var_4_36 = arg_4_0._tf
	local var_4_37 = var_2.Find(var_4_36, "bottom/progress/nodes")
	local var_4_38 = arg_4_0._tf

	arg_4_0.nodesUIlist = var_4_35(var_4_37, var_3.Find(var_4_38, "bottom/progress/nodes/tpl"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_5()
		...
		pg = var_2_10003
		var_7_2.helps = var_2_10003.gametip.guild_mission_info_tip.tip
	...
	local function var_5_14()
		...
		if var_0.IsFinish(var_10_0) then
			...
			var_10_2(var_10_1, var_2_10003("guild_event_is_finish"))
		...
		var_10_4(var_10_3, var_2_10003.OPEN_MISSION_FORAMTION, arg_5_0.mission)
...
function var_0_1.InitView(arg_16_0)
	...
	local var_16_6 = var_16_0
	local var_16_7 = var_16_0.GetNations(var_16_6)

	_ = var_16_6

	local var_16_8 = var_16_6.map(var_16_7, function(arg_17_0)
		local var_17_0 = var_16_0
		local var_17_1 = var_1.GetShipsByNation(var_17_0, arg_17_0)

		Nation = var_17_0

		local var_17_2 = var_17_0.Nation2Name(arg_17_0)

		i18n = var_3

		return var_3("guild_event_info_desc3", var_17_2, #var_17_1)
	end)
	local var_16_9 = arg_16_0.areaTxt

	i18n = var_6

	local var_16_10 = var_6("guild_word_battle_area")

	table = var_7
	var_16_9.text = var_16_10 .. var_7.concat(var_16_8, " 、")

	local var_16_11 = var_0_1.GetBattleTarget(var_16_0)

	table = var_6

	local var_16_12

	if var_6.concat(var_16_11, " 、") ~= "" then
		var_16_12 = arg_16_0.goalTxt
		i18n = var_8
		var_16_12.text = var_8("guild_wrod_battle_target") .. var_6
	end

	setActive = var_16_12

	var_16_12(arg_16_0.goalTxt.gameObject, var_6 ~= "")
...
function var_0_1.UpdateFormationBtn(arg_18_0)
	...
	var_18_0(arg_18_0.formationBtn, var_18_1)

	setActive = var_18_0

	var_18_0(arg_18_0.doingBtn, not var_18_1)
...
function var_0_1.GetBattleTarget(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1_10004(var_19_0) do
		...
		var_1_10009.insert(var_19_2, var_0_1.AttrCnt2Desc(iter_19_0, iter_19_1))
	end
	...
	for iter_19_2, iter_19_3 in var_4(var_19_1) do
		...
		var_1_10009.insert(var_19_2, var_0_1.AttrAcc2Desc(iter_19_2, iter_19_3))
	end
	...
	if not var_1:IsFinish() then
		...
		var_4.make(var_20_3, function(arg_21_0, arg_21_1, arg_21_2)
			...
			if arg_21_0 == var_2_10003.EventUpdate then
				...
				local var_21_5 = var_21_4(var_21_3, var_2_10008(var_2_10009))

				GetSpriteFromAtlas = var_21_3
				var_21_5.sprite = var_21_3("ui/GuildMissionInfoUI_atlas", var_21_1)
				...
				local var_21_6 = var_3:GetIcon()
				local var_21_7 = arg_21_2:Find("item")
				local var_21_8 = var_7.GetComponent

				typeof = var_9
				Image = var_2_10010

				local var_21_9 = var_21_8(var_21_7, var_9(var_2_10010))

				LoadSprite = var_21_7
				var_21_9.sprite = var_21_7("GuildNode/" .. var_21_6)
				table = var_21_9

				var_21_9.insert(arg_20_0.nodes, arg_21_2)
			end
...
function var_0_1.InitBattleSea(arg_22_0)
	...
	if var_22_3 then
		...
		local var_22_7 = var_1_10007(var_1_10008)
		...
		for iter_22_0 = 1, 4 do
			...
			for iter_22_1, iter_22_2 in var_14(var_1_10013) do
				table = var_1_10019
...
function var_0_1.CheckNodesState(arg_31_0)
	...
	if var_2.GetNewestSuccessNode(var_31_1) and var_2:GetNodeAnimPosistion() < var_3:GetPosition() then
		...
		GuildEventMediator = var_1_10008

		var_31_3(var_31_2, var_1_10008.ON_UPDATE_NODE_ANIM_FLAG, var_2.id, var_5)
	end
...
function var_0_1.AddRefreshProgressTimer(arg_33_0)
	...
	if not var_1.IsFinish(var_33_2) and var_33_1 > 0 then
		...
		var_33_2(var_33_1 > 900, var_33_1)

		var_33_2 = var_33_1 * 0.01
		Timer = var_5
		arg_33_0.refreshTimer = var_5.New(function()
			...
			var_34_2(var_34_1, var_2_10002.FORCE_REFRESH_MISSION, var_0.id)
		...
		if 0 < var_33_4 then
			...
			arg_33_0.cdTimer = var_6.New(function()
				...
				if var_33_4 <= 0 then
					...
					local var_35_2 = var_35_0.TimeMgr.GetInstance()
	...
	var_33_2(arg_33_0.timeTxt.gameObject.transform.parent, var_3)
...
function var_0_1.ShowOrHideLogPanel(arg_37_0, arg_37_1, arg_37_2)
	...
	local var_37_5 = var_37_4(var_37_3, var_8.Action_float(function(arg_38_0)
	...
	var_37_6(var_37_5, var_8.Action(function()
