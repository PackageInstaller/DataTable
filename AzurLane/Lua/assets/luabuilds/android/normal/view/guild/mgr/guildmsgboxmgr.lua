...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	var_2.GetUI(var_1_1, "GuildMsgBoxUI", true, function(arg_2_0)
		...
		findTF = var_2_2
		var_2_3.confirmBtn = var_2_2(arg_1_0._go, "frame/confirm_btn")
		...
		var_2_4(var_2_6, var_2_5("text_iknow"))
		...
		var_2_4(var_2_8, var_2_7("text_forward"))

		local var_2_9 = arg_1_0

		findTF = var_2_8

		local var_2_10 = var_2_8(arg_1_0._go, "frame/content/Text")
		local var_2_11 = var_2.GetComponent

		typeof = var_4
		Text = var_2_10005
		var_2_9.contextTxt = var_2_11(var_2_10, var_4(var_2_10005))
		pg = var_2_9
...
function var_0_1.RefreshView(arg_5_0, arg_5_1)
	...
	var_5_0(var_5_2, var_5_3, var_5_4, var_1_10006)
	...
	var_5_0(var_5_5, var_5_6, var_5_7, var_1_10006)
	...
	var_5_0(var_5_8, var_5_9, var_5_10, var_1_10006)
	...
	var_5_0(var_5_11, var_5_12, var_5_13, var_6)
		...
		if var_2:GetActiveWeeklyTask() and arg_13_1.id == var_3:GetPresonTaskId() then
			...
			local var_13_3 = {
				condition = function()
					...
					if var_14_1(var_14_0, var_2_10002.PRIVATE_TASK_TYPE_EVENT) then
			...
			i18n = var_7
			var_13_3.content = var_7("guild_mission_complate", var_3:GetPrivateTaskName())
			...
			function var_13_3.OnYes()
				...
				var_15_1(var_15_0, var_2_10002.SWITCH_TO_OFFICE)
...
function var_0_1.OnBeginBattle(arg_16_0)
	...
	if var_1.getRawData(var_16_0) then
		...
		if var_1.GetActiveWeeklyTask(var_16_1) and var_2:PrivateBeFinished() then
			local var_16_2 = var_2

			var_16_1 = var_2.SamePrivateTaskType
			GuildTask = var_1_10005
			var_16_1 = var_16_1(var_16_2, var_1_10005.PRIVATE_TASK_TYPE_BATTLE)
		end

		arg_16_0.taskFinished = var_16_1
		print = var_16_1

		var_16_1("taskFinished : ", arg_16_0.taskFinished)
	end
...
function var_0_1.OnFinishBattle(arg_17_0, arg_17_1)
	...
	local var_17_0 = var_2(var_1_10003)
	...
	if var_2.getRawData(var_17_0) and arg_17_1 then
		...
		if var_1_10004 <= var_17_1 then
			local var_17_2 = arg_17_1.system

			SYSTEM_WORLD = var_1_10004

			if var_17_2 <= var_1_10004 then
				local var_17_3 = var_2

				if var_2.GetActiveWeeklyTask(var_17_3) and var_3:PrivateBeFinished() then
					local var_17_4 = var_3

					var_17_3 = var_3.SamePrivateTaskType
					GuildTask = var_1_10006
					var_17_3 = var_17_3(var_17_4, var_1_10006.PRIVATE_TASK_TYPE_BATTLE)
				end

				if not arg_17_0.taskFinished and var_17_3 then
...
function var_0_1.NotificationForBattle(arg_18_0, arg_18_1)
	if arg_18_0.shouldShowBattleTip then
		...
		local var_18_0 = var_2(var_1_10003)
		local var_18_1

		var_18_1 = var_2.getRawData(var_18_0) and var_2:GetActiveWeeklyTask()
			...
			var_1_10005({
				...
				function(arg_21_0)
					if var_18_2 then
						...
						i18n = var_2_10002
						var_2_10003 = "guild_task_autoaccept_2"

						local var_21_1 = var_18_1
						local var_21_2

						if not (var_21_0 .. var_2_10002(var_2_10003, var_2_10004.GetPrivateTaskName(var_21_1))) then
							var_21_2 = ""
						end
						...
						local var_21_3 = var_2_10002(var_2_10003)
						local var_21_4 = var_2.getActiveChapter(var_21_3)
						local var_21_5 = {}

						pg = var_2_10004
						var_21_5[1] = var_2_10004.UIMgr.CameraLevel
						...
						var_21_8.content = var_7(var_21_9, var_9.GetPrivateTaskName(var_21_10)) .. var_21_2
						...
						function var_21_8.OnYes()
							...
							var_23_1(var_23_0, var_23_2, var_3_10003.GUILD, {
								page = "office"
							})
...
function var_0_1.NotificationForDailyBattle(arg_24_0)
	if arg_24_0.shouldShowBattleTip then
		...
		local var_24_0 = var_1(var_1_10002)
		local var_24_1

		var_24_1 = var_1.getRawData(var_24_0) and var_1:GetActiveWeeklyTask()
			...
			var_1_10004({
				...
				function()
					if var_24_2 then
						...
						if not (var_27_0 .. var_2_10001(var_27_1, var_3.GetPrivateTaskName(var_27_2))) then
							var_27_3 = ""
						end
						...
						var_27_6.content = var_4(var_27_7, var_6.GetPrivateTaskName(var_27_8)) .. var_27_3
						...
						function var_27_6.OnYes()
							...
							local var_29_2 = var_3_10002.GO_SCENE

							SCENE = var_3_10003

							var_29_1(var_29_0, var_29_2, var_3_10003.GUILD, {
								page = "office"
							})
...
function var_0_1.NotificationForWorld(arg_30_0, arg_30_1)
	if arg_30_0.shouldShowBattleTip then
		...
		var_30_1 = var_2.getRawData(var_30_0) and var_2:GetActiveWeeklyTask()
			...
			var_1_10005({
				...
				function()
					if var_30_2 then
						...
						if not (var_33_0 .. var_2_10001(var_33_1, var_3.GetPrivateTaskName(var_33_2))) then
							var_33_3 = ""
						end
						...
						var_33_6.content = var_4(var_33_7, var_6.GetPrivateTaskName(var_33_8)) .. var_33_3
						...
						function var_33_6.OnYes()
							...
							local var_35_2 = var_3_10002.GO_SCENE

							SCENE = var_3_10003

							var_35_1(var_35_0, var_35_2, var_3_10003.GUILD, {
								page = "office"
							})
...
function var_0_1.SubmitTask(arg_38_0, arg_38_1)
	...
	if not (var_2 and var_2:GetActiveWeeklyTask()) then
		arg_38_1()

		return
	end

	if var_3 and var_3:isFinished() then
		arg_38_1()

		return
	end

	local var_38_1 = var_3
	local var_38_2 = var_3.GetPresonTaskId(var_38_1)

	getProxy = var_38_1
	TaskProxy = var_1_10006

	local var_38_3 = var_38_1(var_1_10006)
	local var_38_4
	...
	if var_38_4 and var_38_4:isFinish() and not var_38_4:isReceive() then
		...
		var_1_10010.insert(var_38_6, function(arg_40_0)
			...
			var_40_1(var_40_0, var_2_10003.SUBMIT_TASK, var_38_2, function(arg_41_0)
				var_38_5 = arg_41_0
	...
	var_1_10010.insert(var_38_6, function(arg_42_0)
		...
		if var_0 then
			...
			if not var_2.isFinished(var_42_3) and (not var_42_2 or var_42_2 and var_42_2:isFinish() and var_42_2:isReceive()) then
				...
				var_42_5(var_42_4, var_2_10004.TRIGGER_TASK, var_38_2, arg_42_0)
