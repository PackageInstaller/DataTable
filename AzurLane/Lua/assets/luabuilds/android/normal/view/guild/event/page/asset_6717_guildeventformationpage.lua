...
function var_0_1.OnShow(arg_8_0)
	...
	if not var_1_10001(var_1_10002).isFetchAssaultFleet then
		local var_8_0 = arg_8_0
		local var_8_1 = arg_8_0.emit

		GuildEventMediator = var_1_10003

		var_8_1(var_8_0, var_1_10003.ON_GET_FORMATION)
	else
		arg_8_0:UpdateSlots()
	end
...
function var_0_1.UpdateSendBtn(arg_9_0)
	if arg_9_0.contextData.editFleet then
		if arg_9_0.contextData.editFleet then
			var_1_10002 = arg_9_0.extraData.fleet

			local var_9_0 = not var_1.AnyShipChanged(var_1_10002, arg_9_0.contextData.editFleet)
		end
	...
	var_1_10002(arg_9_0.sendBtnGray, var_9_0)
	...
	local function var_9_3()
		if arg_9_0.existBossBattle then
			...
			var_10_1(var_10_0, var_2_10002("guild_formation_erro_in_boss_battle"))
		...
		var_10_3(var_10_2, var_2_10002.UPDATE_FORMATION)
	...
	var_1_10002(var_9_1, var_9_2, var_9_3, var_1_10006)
...
function var_0_1.UpdateSlots(arg_11_0)
	...
	var_11_3 = var_2.GetActiveEvent(var_11_2) and var_3:GetBossMission()
	arg_11_0.existBossBattle = var_11_3 and var_11_3:IsActive()
	ipairs = var_5

	for iter_11_0, iter_11_1 in var_5(arg_11_0.slots) do
...
function var_0_1.UpdateSlot(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_3 = arg_13_2.Find(var_13_2, "tag/tag")
	local var_13_4

	if arg_13_3 then
		if not var_13_1 then
			cloneTplTo = var_13_2
			var_13_1 = var_13_2(arg_13_0.tpl, arg_13_2)
			setActive = var_13_2

			var_13_2(var_13_1, true)

			var_13_4 = var_13_1

			var_13_1.SetAsFirstSibling(var_13_4)
		end

		if not arg_13_0.items[arg_13_1] then
			DockyardShipItem = var_13_4
			var_13_2 = var_13_4.New(var_13_1)
		end

		local var_13_5 = var_13_2

		var_13_4 = var_13_2.update
		GuildAssaultShip = var_1_10010

		var_13_4(var_13_5, var_1_10010.ConverteFromShip(arg_13_3))

		var_13_4 = var_13_2.go
		var_13_4.name = "ship"
		setActive = var_13_4

		var_13_4(var_13_3, arg_13_0:ShipIsBattle(arg_13_3))
	elseif var_13_1 then
		setActive = var_13_2

		var_13_2(var_13_1, false)

		setActive = var_13_2

		var_13_2(var_13_3, false)
	else
		setActive = var_13_2
	...
	local var_13_6 = arg_13_3 and var_13_1 or arg_13_2
	...
	local function var_13_9()
		...
		if arg_13_0.existBossBattle then
			...
			var_14_2(var_14_1, var_2("guild_formation_erro_in_boss_battle"))
		...
		GuildEventMediator = var_2

		var_14_4(var_14_3, var_2.ON_SELECT_SHIP, arg_13_1, arg_13_3, arg_13_0.fleet)
	...
	var_13_4(var_13_7, var_13_8, var_13_9, var_1_10012)
...
function var_0_1.RefreshCdTimer(arg_15_0, arg_15_1)
	...
	local var_15_4 = var_15_3(var_15_2, var_6(var_1_10007))
	...
	var_15_7(var_3, false)

	local var_15_9 = arg_15_0

	arg_15_0.RemoveTimer(var_15_9, arg_15_1)

	local var_15_10

	if var_15_8 then
		var_15_10 = arg_15_0.cdTimer
		Timer = var_15_9
		var_15_10[arg_15_1] = var_15_9.New(function()
			getProxy = var_2_10000
			GuildProxy = var_2_10001
			...
			if 0 < var_16_3 then
				...
				local var_16_5 = var_2_10003.TimeMgr.GetInstance()
				...
				local var_16_7 = var_3.Find(var_16_6, "tag")

				isActive = var_16_6

				var_16_4(var_16_7, var_16_6(var_15_6))
			end

			return
		end, 1, -1)

		local var_15_11 = arg_15_0.cdTimer[arg_15_1]

		var_15_10.Start(var_15_11)
		arg_15_0.cdTimer[arg_15_1].func()

		setActive = var_15_10

		var_15_10(var_3, true)
	end

	setActive = var_15_10

	local var_15_12 = var_2
	local var_15_13 = var_2.Find(var_15_12, "tag")

	isActive = var_15_12

	local var_15_14

	if not var_15_12(var_15_6) then
		var_15_14 = var_15_8
	end

	var_15_10(var_15_13, var_15_14)
