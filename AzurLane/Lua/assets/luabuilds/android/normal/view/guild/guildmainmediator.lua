...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_SHOP, function()
		...
		local var_2_3 = var_2_10003.SHOP
		local var_2_4 = {}

		NewShopsScene = var_2_10005
		var_2_4.warp = var_2_10005.TYPE_GUILD
	...
	arg_1_0:bind(var_0_1.OPEN_EVENT, function(arg_4_0)
		...
		GuildMainScene = var_2_10003

		var_4_1(var_4_0, var_2_10003.TOGGLE_TAG[6])
	...
	arg_1_0:bind(var_0_1.OPEN_EVENT_REPORT, function(arg_5_0)
		...
		var_5_1(var_5_0, var_2_10003.GUILD_OPEN_EVENT_REPORT)
	...
	arg_1_0.bind(var_1_8, var_0_1.ON_FETCH_CAPITAL, function(arg_6_0)
		...
		var_6_1(var_6_0, var_2_10003.GUILD_REFRESH_CAPITAL)
	...
	arg_1_0:bind(var_0_1.ON_BACK, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10003.GO_BACK)
	...
	arg_1_0:bind(var_0_1.OPEN_MEMBER, function()
		...
		local var_9_4 = var_2_10002.New
		local var_9_5 = {}

		GuildMemberLayer = var_2_10004
		var_9_5.viewComponent = var_2_10004
		GuildMemberMediator = var_2_10004
		var_9_5.mediator = var_2_10004
	...
	arg_1_0:bind(var_0_1.CLOSE_MEMBER, function()
		...
		GuildMemberMediator = var_2_10002
	...
	arg_1_0:bind(var_0_1.OPEN_APPLY, function()
		...
		local var_11_4 = var_2_10002.New
		local var_11_5 = {}

		GuildRequestLayer = var_2_10004
		var_11_5.viewComponent = var_2_10004
		GuildRequestMediator = var_2_10004
		var_11_5.mediator = var_2_10004
	...
	arg_1_0:bind(var_0_1.MODIFY, function(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
		...
		var_13_1(var_13_0, var_2_10006.MODIFY_GUILD_INFO, {
			type = arg_13_1,
			int = arg_13_2,
			string = arg_13_3
		})
	...
	arg_1_0:bind(var_0_1.DISSOLVE, function(arg_14_0, arg_14_1)
		...
		var_14_1(var_14_0, var_2_10004.GUILD_DISSOLVE, arg_14_1)
	...
	arg_1_0:bind(var_0_1.QUIT, function(arg_15_0, arg_15_1)
		...
		var_15_1(var_15_0, var_2_10004.GUILD_QUIT, arg_15_1)
	...
	arg_1_0:bind(var_0_1.SEND_MSG, function(arg_17_0, arg_17_1)
		...
		var_17_1(var_17_0, var_2_10004.GUILD_SEND_MSG, arg_17_1)
	...
	arg_1_0:bind(var_0_1.OPEN_EMOJI, function(arg_18_0, arg_18_1, arg_18_2)
		...
		EmojiLayer = var_2_10007
		var_18_3.viewComponent = var_2_10007
		EmojiMediator = var_2_10007
		var_18_3.mediator = var_2_10007
		...
		var_18_4.groupName = var_8.getGroupName(var_18_5)
	...
	arg_1_0:bind(var_0_1.OPEN_OFFICE, function()
		...
		local var_20_4 = var_2_10002.New
		local var_20_5 = {}

		GuildOfficeLayer = var_2_10004
		var_20_5.viewComponent = var_2_10004
		GuildOfficeMediator = var_2_10004
		var_20_5.mediator = var_2_10004
	...
	arg_1_0:bind(var_0_1.CLOSE_OFFICE, function()
		...
		GuildOfficeMediator = var_2_10002
	...
	arg_1_0:bind(var_0_1.OPEN_TECH, function()
		...
		local var_22_4 = var_2_10002.New
		local var_22_5 = {}

		GuildTechnologyLayer = var_2_10004
		var_22_5.viewComponent = var_2_10004
		GuildTechnologyMediator = var_2_10004
		var_22_5.mediator = var_2_10004
	...
	arg_1_0:bind(var_0_1.ON_FETCH_CAPITAL_LOG, function(arg_24_0)
		...
		if var_1.shouldRequestCapitalLog(var_24_1) then
			...
			var_24_3(var_24_2, var_2_10004.GUILD_FETCH_CAPITAL_LOG)
		else
	...
	arg_1_0:bind(var_0_1.OPEN_BATTLE, function()
		...
		local var_25_4 = var_2_10002.New
		local var_25_5 = {}

		GuildEventLayer = var_2_10004
		var_25_5.viewComponent = var_2_10004
		GuildEventMediator = var_2_10004
		var_25_5.mediator = var_2_10004
...
function var_0_1.closePage(arg_27_0, arg_27_1)
	...
	if var_2.getContextByMediator(var_27_0, arg_27_1) then
		...
		var_27_2(var_27_1, var_1_10006.REMOVE_LAYERS, {
			context = var_3
		})
	end
...
function var_0_1.handleNotification(arg_29_0, arg_29_1)
	...
	local var_29_2 = arg_29_1.getBody(var_29_1)

	GuildProxy = var_29_1

	if var_29_0 == var_29_1.GUILD_UPDATED then
		var_1_10005 = arg_29_0.viewComponent

		var_4.setGuildVO(var_1_10005, var_29_2)
	...
	if var_29_0 == var_4.EXIT_GUILD then
		var_1_10005 = arg_29_0.viewComponent

		var_4.emit(var_1_10005, var_0_1.ON_BACK)
	...
	if var_29_0 == var_4.MODIFY_GUILD_INFO_DONE then
		var_1_10005 = arg_29_0.viewComponent

		var_4.initTheme(var_1_10005)
	...
	if var_29_0 == var_4.NEW_MSG_ADDED then
		var_1_10005 = arg_29_0.viewComponent

		var_4.Append(var_1_10005, var_29_2, -1)
	...
	if var_29_0 == var_4.LOG_ADDED then
		var_1_10005 = arg_29_0.viewComponent

		var_4.AppendLog(var_1_10005, var_29_2, true)
	...
	if var_29_0 ~= var_4.REQUEST_COUNT_UPDATED then
		GuildProxy = var_29_3

		if var_29_0 ~= var_29_3.REQUEST_DELETED then
			GAME = var_29_3

			local var_29_3

			if var_29_0 == var_29_3.GUILD_GET_REQUEST_LIST_DONE then
				getProxy = var_29_3
				GuildProxy = var_1_10005
				var_29_3 = var_29_3(var_1_10005)
				var_1_10006 = arg_29_0.viewComponent
				var_1_10005 = var_1_10005.UpdateNotices
				GuildMainScene = var_1_10007

				var_1_10005(var_1_10006, var_1_10007.NOTIFY_TYPE_APPLY)
			...
			if var_29_0 == var_29_3.GUILD_FETCH_CAPITAL_LOG_DONE then
				var_1_10005 = arg_29_0.viewComponent

				var_4.openResourceLog(var_1_10005)
			...
			if var_29_0 == var_4.UPDATED then
				var_1_10005 = arg_29_0.viewComponent

				var_4.setPlayerVO(var_1_10005, var_29_2)
			...
			if var_29_0 ~= var_4.GUILD_COMMIT_DONATE_DONE then
				GAME = var_29_4

				local var_29_4

				if var_29_0 == var_29_4.GUILD_GET_SUPPLY_AWARD_DONE then
					var_1_10005 = arg_29_0.viewComponent
					var_29_4 = var_29_4.UpdateNotices
					GuildMainScene = var_1_10006

					var_29_4(var_1_10005, var_1_10006.NOTIFY_TYPE_OFFICE)
				...
				if var_29_4.ON_DELETED_MEMBER == var_29_0 then
					var_1_10005 = arg_29_0.viewComponent

					var_4.OnDeleteMember(var_1_10005, var_29_2.member)
				...
				if var_4.ON_ADDED_MEMBER == var_29_0 then
					var_1_10005 = arg_29_0.viewComponent

					var_4.OnAddMember(var_1_10005, var_29_2.member)
				...
				if var_29_0 == var_4.GUILD_OPEN_EVENT_REPORT then
					var_1_10005 = arg_29_0
					var_29_5 = arg_29_0.addSubLayers
					Context = var_1_10006
					var_1_10006 = var_1_10006.New
					var_1_10007 = {}
					GuildEventReportLayer = var_1_10008
					var_1_10007.viewComponent = var_1_10008
					GuildEventReportMediator = var_1_10008
					var_1_10007.mediator = var_1_10008

					var_29_5(var_1_10005, var_1_10006(var_1_10007))
				...
				if var_29_0 == var_29_5.SUBMIT_GUILD_REPORT_DONE then
					var_1_10005 = arg_29_0.viewComponent
					var_29_6 = var_29_6.emit
					BaseUI = var_1_10006

					var_29_6(var_1_10005, var_1_10006.ON_ACHIEVE, var_29_2.awards, var_29_2.callback)

					var_1_10005 = arg_29_0.viewComponent

					var_29_6.OnReportUpdated(var_1_10005)

					var_1_10005 = arg_29_0.viewComponent
					var_29_6 = var_29_6.UpdateNotices
					GuildMainScene = var_1_10006

					var_29_6(var_1_10005, var_1_10006.NOTIFY_TYPE_BATTLE)

					var_1_10005 = arg_29_0.viewComponent
					var_29_6 = var_29_6.UpdateNotices
					GuildMainScene = var_1_10006

					var_29_6(var_1_10005, var_1_10006.NOTIFY_TYPE_MAIN)
				...
				if var_29_0 ~= var_29_6.BATTLE_BTN_FLAG_CHANGE then
					GAME = var_29_7

					if var_29_0 ~= var_29_7.ON_GUILD_JOIN_EVENT_DONE then
						GAME = var_29_7

						if var_29_0 ~= var_29_7.GUILD_ACTIVE_EVENT_DONE then
							GAME = var_29_7

							do
								local var_29_7

								if var_29_0 == var_29_7.GUILD_JOIN_MISSION_DONE then
									var_1_10005 = arg_29_0.viewComponent
									var_29_7 = var_29_7.UpdateNotices
									GuildMainScene = var_1_10006

									var_29_7(var_1_10005, var_1_10006.NOTIFY_TYPE_BATTLE)
								else
									GAME = var_29_7

									local var_29_8

									if var_29_0 == var_29_7.BEGIN_STAGE_DONE then
										var_1_10005 = arg_29_0
										var_29_8 = arg_29_0.sendNotification
										GAME = var_1_10006
										var_1_10006 = var_1_10006.GO_SCENE
										SCENE = var_1_10007

										var_29_8(var_1_10005, var_1_10006, var_1_10007.COMBATLOAD, var_29_2)
									else
										GuildTechnologyMediator = var_29_8

										local var_29_9

										if var_29_0 == var_29_8.ON_OPEN_OFFICE then
											var_29_9 = arg_29_0.contextData.toggles
											GuildMainScene = var_1_10005
											var_29_9 = var_29_9[var_1_10005.TOGGLE_TAG[4]]
											triggerToggle = var_1_10005

											var_1_10005(var_29_9, true)
										else
											GAME = var_29_9

											if var_29_0 == var_29_9.OPEN_MSGBOX_DONE then
												pg = var_4
												var_1_10005 = var_4.GuildLayerMgr.GetInstance()

												var_4.OnShowMsgBox(var_1_10005)
											else
												GuildProxy = var_4

												local var_29_10

												if var_29_0 == var_4.TECHNOLOGY_START then
													var_1_10005 = arg_29_0.viewComponent
													var_29_10 = var_29_10.UpdateNotices
													GuildMainScene = var_1_10006

													var_29_10(var_1_10005, var_1_10006.NOTIFY_TYPE_TECH)
												else
													GAME = var_29_10

													local var_29_11

													if var_29_0 == var_29_10.GUILD_START_TECH_DONE then
														getProxy = var_29_11
														PlayerProxy = var_1_10005
														var_1_10005 = var_29_11(var_1_10005)
														var_29_11 = var_29_11.getData(var_1_10005)

														local var_29_12 = arg_29_0.viewComponent

														var_1_10005.setPlayerVO(var_29_12, var_29_11)

														local var_29_13 = arg_29_0.viewComponent

														var_1_10005.UpdateRes(var_29_13)
													else
														GAME = var_29_11

														local var_29_14

														if var_29_0 == var_29_11.GO_WORLD_BOSS_SCENE then
															var_29_14 = arg_29_0.contextData
															var_29_14.page = nil
														else
															GuildMainMediator = var_29_14

															if var_29_0 == var_29_14.SWITCH_TO_OFFICE then
																var_1_10005 = arg_29_0.viewComponent

																var_4.TriggerOfficePage(var_1_10005)
															else
																GAME = var_4

																local var_29_15

																if var_29_0 == var_4.LOAD_LAYERS then
																	var_29_15 = var_29_2.context.mediator
																	AwardInfoMediator = var_1_10005

																	if var_29_15 == var_1_10005 then
																		pg = var_29_15
																		var_1_10005 = var_29_15.GuildLayerMgr.GetInstance()

																		var_29_15.UnBlurTopPanel(var_1_10005)
																	end
																else
																	GAME = var_29_15

																	if var_29_0 == var_29_15.REMOVE_LAYERS then
																		local var_29_16 = var_29_2.context.mediator

																		AwardInfoMediator = var_1_10005

																		if var_29_16 == var_1_10005 then
																			pg = var_29_16

																			local var_29_17 = var_29_16.GuildLayerMgr.GetInstance()

																			var_4._BlurTopPanel(var_29_17)
																		end
																	end
																end
															end
