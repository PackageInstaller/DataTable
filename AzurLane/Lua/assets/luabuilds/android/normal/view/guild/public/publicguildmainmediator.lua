...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.ON_COMMIT, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.PUBLIC_GUILD_COMMIT_DONATE, {
			id = arg_2_1
		})
	...
	arg_1_0.bind(var_1_0, var_0_1.UPGRADE_TECH, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.PULIC_GUILD_UPGRADE_TECH, {
			id = arg_3_1
		})
	...
	var_1_5(var_1_4, var_4.getData(var_1_6))
...
function var_0_1.handleNotification(arg_5_0, arg_5_1)
	...
	if var_5_0 == var_5_1.PUBLIC_GUILD_COMMIT_DONATE_DONE then
		var_1_10005 = arg_5_0.viewComponent
		var_5_3 = var_5_3.emit
		BaseUI = var_1_10006

		var_5_3(var_1_10005, var_1_10006.ON_ACHIEVE, var_5_2.awards)

		var_1_10005 = arg_5_0.viewComponent

		var_5_3.OnUpdateDonateList(var_1_10005)
	else
		GAME = var_5_3

		if var_5_0 == var_5_3.PUBLIC_GUILD_REFRESH_DONATE_LIST_DONE then
			var_1_10005 = arg_5_0.viewComponent

			var_4.OnUpdateDonateList(var_1_10005)
		else
			PlayerProxy = var_4

			if var_5_0 == var_4.UPDATED then
				var_1_10005 = arg_5_0.viewComponent

				var_4.OnPlayerUpdate(var_1_10005, var_5_2)
			else
				GAME = var_4

				if var_5_0 == var_4.PULIC_GUILD_UPGRADE_TECH_DONE then
					var_1_10005 = arg_5_0.viewComponent

					var_4.OnTechGroupUpdate(var_1_10005, var_5_2.id)
				else
					GAME = var_4

					if var_5_0 == var_4.GET_PUBLIC_GUILD_USER_DATA_DONE then
						getProxy = var_4
						GuildProxy = var_1_10005

						local var_5_4 = var_4(var_1_10005)
