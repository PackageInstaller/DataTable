...
function var_0_0.InitPath(arg_8_0)
	...
	local var_8_4 = var_5(var_0_3.gridStartPos[1], var_0_3.gridStartPos[2])
	...
	for iter_8_0 = 0, var_8_0 - 1 do
		...
		for iter_8_1 = 0, var_8_1 - 1 do
			...
			GuildDynamicBgPathGrid = var_15

			local var_8_5 = var_15.New
			local var_8_6 = {}

			Vector2 = var_1_10017
			var_8_6.position = var_1_10017(iter_8_0, iter_8_1)
			var_8_6.canWalk = not var_1_10014
			var_8_6.sizeDelta = var_8_3
			var_8_6.startPosOffset = var_8_4

			local var_8_7 = var_8_5(var_8_6)

			arg_8_0.path[iter_8_0][iter_8_1] = var_8_7
		end
	end
...
function var_0_0.InitFurnitures(arg_12_0, arg_12_1)
	local function var_12_0(arg_13_0, arg_13_1, arg_13_2)
		...
		local var_13_1 = var_2_10003(var_13_0, var_2_10005(var_2_10006))

		Vector2 = var_13_0
		var_13_1.pivot = var_13_0(0, 0)
		...
		GuildDynamicFurniture = var_13_2
		...
		Vector2 = var_7
		var_13_5.size = var_7(arg_13_0.size[1], arg_13_0.size[2])
		Vector2 = var_7
		var_13_5.offset = var_7(arg_13_0.offset[1], arg_13_0.offset[2])
		var_13_5.mode = arg_13_0.mode
		Vector2 = var_7
		var_13_5.interactionPosition = var_7(arg_13_0.interactionPosition[1], arg_13_0.interactionPosition[2])
		...
		var_13_5.insert(arg_12_0.furnitures, var_13_6)
		arg_13_2()
	...
	for iter_12_0, iter_12_1 in var_1_10005(var_12_2) do
		...
		var_1_10010.insert(var_12_1, function(arg_14_0)
			...
			local var_14_4 = var_2_10005(var_2_10006)

			UnityEngine = var_2_10006

			var_14_1(var_14_0, var_14_2, var_14_3, var_14_4, var_2_10006.Events.UnityAction_UnityEngine_Object(function(arg_15_0)
				Object = var_3_10001
...
function var_0_0.AddShip(arg_18_0, arg_18_1, arg_18_2)
	local function var_18_0(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
		...
		var_19_2(var_19_1, var_7(0.5, 0.5, 1))
...
function var_0_0.AddGridDebugView(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10002(arg_26_0.path) do
		...
		for iter_26_2, iter_26_3 in var_7(iter_26_1) do
			...
			typeof = var_15
			RectTransform = var_1_10016
			var_1_10013 = var_1_10013(var_26_1, var_15(var_1_10016))
			...
			local var_26_3 = var_26_1(var_26_2, var_1_10016(var_1_10017))
...
function var_0_0.AddDebugShip(arg_28_0, arg_28_1)
	...
	arg_28_0:InitShips(function()
		...
		local function var_29_2()
			...
			if var_30_0(var_3_10001.A) then
		...
		Time = var_2_10003
		var_29_0.timer1 = var_29_1(var_29_2, var_2_10003.deltaTime, -1)
