...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.iconTF = var_2_1(var_2_0, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.manifesto = var_2_3(var_2_2, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.levelTF = var_2_7(var_2_6, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.countTF = var_2_9(var_2_8, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.flagName = var_2_11(var_2_10, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.policyTF = var_2_13(var_2_12, var_3(var_1_10004))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		i18n = var_2_10003
		var_4_2.placeholder = var_2_10003("guild_request_msg_placeholder")
		i18n = var_3
		var_4_2.title = var_3("guild_request_msg_title")

		function var_4_2.onYes(arg_5_0)
			local var_5_0 = arg_3_0
			local var_5_1 = var_1.emit

			JoinGuildMediator = var_3_10003

			var_5_1(var_5_0, var_3_10003.APPLY, arg_3_0.guildVO.id, arg_5_0)
...
function var_0_1.UpdateApplyPanel(arg_8_0)
	...
	var_3("QIcon/" .. var_8_1:getPainting(), function(arg_9_0)
	...
	local var_8_2 = var_3.ship_data_statistics[var_8_1.configId]
	...
	for iter_8_1 = 1, var_4 do
		var_1_10010 = arg_8_0.starsTF

		local var_8_3 = var_9.GetChild(var_1_10010, iter_8_1 - 1)

		setActive = var_1_10010

		var_1_10010(var_8_3, iter_8_1 <= var_8_2.star)
	end

	arg_8_0.nameTF.text = var_8_0.name

	local var_8_4 = arg_8_0.levelTF
	local var_8_5

	if not (var_8_0.level < 9) or not ("0" .. var_8_0.level) then
		var_8_5 = var_8_0.level
	end

	var_8_4.text = var_8_5

	local var_8_6 = arg_8_0.countTF
	local var_8_7 = var_8_0.memberCount
	local var_8_8 = "/"
	local var_8_9 = var_8_0

	var_8_6.text = var_8_7 .. var_8_8 .. var_8_0.getMaxMember(var_8_9)
	arg_8_0.flagName.text = var_8_0:getCommader().name
	arg_8_0.policyTF.text = var_8_0:getPolicyName()

	local var_8_10 = var_8_0
	local var_8_11 = var_8_0.getCommader(var_8_10)

	AttireFrame = var_8_10

	local var_8_12 = var_8_10.attireFrameRes
	local var_8_13 = var_8_11
	local var_8_14 = var_8_11.id

	getProxy = var_8_9
	PlayerProxy = var_1_10010

	local var_8_15 = var_8_9(var_1_10010)
	local var_8_16 = var_8_14 == var_9.getRawData(var_8_15).id

	AttireConst = var_9

	local var_8_17 = var_8_12(var_8_13, var_8_16, var_9.TYPE_ICON_FRAME, var_8_11.propose)

	PoolMgr = var_8_13

	local var_8_18 = var_8_13.GetInstance()

	var_7.GetPrefab(var_8_18, "IconFrame/" .. var_8_17, var_8_17, true, function(arg_10_0)
		IsNil = var_2_10001
		...
		if arg_8_0.circle then
			...
			typeof = var_2_10004
			Image = var_2_10005
			var_10_1(var_10_0, var_2_10004(var_2_10005)).raycastTarget = false
			setParent = var_3
			...
			var_1.ReturnPrefab(var_10_2, "IconFrame/" .. var_8_17, var_8_17, arg_10_0)
		end
...
function var_0_1.Hide(arg_11_0)
	...
	if arg_11_0.circle.childCount > 0 then
		local var_11_1 = arg_11_0.circle
		local var_11_2 = var_1.GetChild(var_11_1, 0).gameObject

		PoolMgr = var_11_1

		local var_11_3 = var_11_1.GetInstance()

		var_2.ReturnPrefab(var_11_3, "IconFrame/" .. var_11_2.name, var_11_2.name, var_11_2)
	end
