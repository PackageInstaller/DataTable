...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.REFRESH_RECOMMAND_SHIPS, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.REFRESH_ALL_ASSULT_SHIP_RECOMMAND_STATE, {
			callback = arg_4_1
		})
	...
	arg_1_0:bind(var_0_1.ON_RECOMM_ASSULT_SHIP, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10005.GUILD_RECOMMAND_ASSULT_SHIP, {
			shipId = arg_5_1,
			cmd = arg_5_2
		})
	...
	arg_1_0:bind(var_0_1.ON_JOIN_EVENT, function()
		...
		var_6_1(var_6_0, var_2_10002.ON_GUILD_JOIN_EVENT)
	...
	arg_1_0:bind(var_0_1.ON_GET_ALL_ASSULT_FLEET, function(arg_8_0, arg_8_1)
		...
		var_8_1(var_8_0, var_2_10004.GUILD_GET_ASSAULT_FLEET, {
			callback = arg_8_1
		})
	...
	arg_1_0:bind(var_0_1.ON_RECOMM_BOSS_BATTLE_SHIPS, function(arg_9_0, arg_9_1)
		...
		var_9_1(var_9_0, var_2_10004.GUILD_GET_ASSAULT_FLEET, {
			callback = function()
	...
	arg_1_0:bind(var_0_1.ON_SAVE_FORMATION, function(arg_11_0, arg_11_1)
		...
		var_11_1(var_11_0, var_2_10004.GUILD_UPDATE_BOSS_FORMATION, {
	...
	arg_1_0:bind(var_0_1.ON_CLEAR_BOSS_FLEET_INVAILD_SHIP, function(arg_12_0)
		...
		var_12_1(var_12_0, var_2_10003.GUILD_UPDATE_BOSS_FORMATION, {
			force = true,
			editFleet = arg_1_0.contextData.editBossFleet
		})
	...
	arg_1_0:bind(var_0_1.ON_SELECT_BOSS_SHIP, function(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
		...
		var_15_1(var_15_0, var_2_10006.GUILD_GET_ASSAULT_FLEET, {
			callback = function()
	...
	arg_1_0:bind(var_0_1.ON_UPDATE_NODE_ANIM_FLAG, function(arg_17_0, arg_17_1, arg_17_2)
		...
		var_17_1(var_17_0, var_2_10005.GUILD_UPDATE_NODE_ANIM_FLAG, {
			id = arg_17_1,
			position = arg_17_2
		})
	...
	arg_1_0:bind(var_0_1.ON_REFRESH_BOSS_RANK, function(arg_18_0)
		...
		var_18_1(var_18_0, var_2_10003.GET_GUILD_BOSS_RANK, {})
	...
	arg_1_0:bind(var_0_1.ON_GET_BOSS_INFO, function(arg_19_0)
		...
		var_19_1(var_19_0, var_2_10003.GUILD_GET_BOSS_INFO)
	...
	arg_1_0:bind(var_0_1.JOIN_MISSION, function(arg_20_0, arg_20_1, arg_20_2)
		...
		var_20_1(var_20_0, var_2_10005.GUILD_JOIN_MISSION, {
			id = arg_20_1,
			shipIds = arg_20_2
		})
	...
	arg_1_0:bind(var_0_1.REFRESH_MISSION, function(arg_23_0, arg_23_1, arg_23_2)
		...
		var_23_1(var_23_0, var_2_10005.GUILD_REFRESH_MISSION, {
			force = false,
			id = arg_23_1,
			callback = arg_23_2
		})
	...
	arg_1_0:bind(var_0_1.FORCE_REFRESH_MISSION, function(arg_24_0, arg_24_1, arg_24_2)
		...
		var_24_1(var_24_0, var_2_10005.GUILD_REFRESH_MISSION, {
			force = true,
			id = arg_24_1,
			callback = arg_24_2
		})
	...
	arg_1_0:bind(var_0_1.ON_GET_FORMATION, function(arg_26_0, arg_26_1)
		...
		local var_26_0 = var_2_10002(var_2_10003)
		...
		if var_26_2 then
			...
			var_2_10005.insert(var_26_3, function(arg_27_0)
		...
		if not var_2_10005(var_2_10006).isFetchAssaultFleet then
			table = var_5
			...
			var_5.insert(var_26_3, function(arg_28_0)
				...
				var_28_1(var_28_0, var_3_10003.GUILD_GET_MY_ASSAULT_FLEET, {
					callback = arg_28_0
				})
	...
	arg_1_0:bind(var_0_1.UPDATE_FORMATION, function(arg_29_0)
		...
		var_29_1(var_29_0, var_2_10003.GUILD_UPDATE_MY_ASSAULT_FLEET, {
	...
	arg_1_0:bind(var_0_1.ON_ACTIVE_EVENT, function(arg_30_0, arg_30_1)
		...
		var_30_1(var_30_0, var_2_10004.GUILD_ACTIVE_EVENT, {
			eventId = arg_30_1
		})
	...
	arg_1_0:bind(var_0_1.ON_OPEN_REPORT, function(arg_31_0)
		...
		var_31_1(var_31_0, var_2_10003.GUILD_OPEN_EVENT_REPORT)
...
function var_0_1.StartBossBattle(arg_32_0)
	...
	if not var_1.GetActiveEvent(var_32_1) or var_2 and var_2:IsExpired() then
		...
		local var_32_2 = var_32_1.TipsMgr.GetInstance()
		local var_32_3 = var_3.ShowTips

		i18n = var_1_10005

		var_32_3(var_32_2, var_1_10005("guild_battle_is_end"))
	...
	if not var_32_5 then
		...
		local var_32_7 = var_1_10007.TipsMgr.GetInstance()
	...
	if not var_32_9 then
		...
		local var_32_11 = var_1_10009.TipsMgr.GetInstance()
	...
	local var_32_12 = var_4:GetDownloadResShips()
	local var_32_13 = {}

	ipairs = var_1_10011

	for iter_32_0, iter_32_1 in var_1_10011(var_32_12) do
		PaintingGroupConst = var_1_10016

		var_1_10016.AddPaintingNameWithFilteMap(var_32_13, iter_32_1)
	end

	local function var_32_14()
		local var_33_0 = arg_32_0
		local var_33_1 = var_0.sendNotification

		GAME = var_2_10002

		local var_33_2 = var_2_10002.BEGIN_STAGE
		local var_33_3 = {}

		SYSTEM_GUILD = var_2_10004
		var_33_3.system = var_2_10004
	...
	var_12.PaintingDownload({
		isShowBox = true,
		paintingNameList = var_32_13,
		finishFunc = var_32_14
	})
...
function var_0_1.SelectBossBattleCommander(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	local var_34_1 = var_34_0(var_1_10005)
	...
	local var_34_3 = var_5:GetBossMission()

	if not arg_34_0.contextData.editBossFleet[arg_34_1] then
		local var_34_4 = arg_34_0.contextData.editBossFleet

		Clone = var_1_10008
		var_1_10010 = var_34_3
		var_34_4[arg_34_1] = var_1_10008(var_34_3.GetFleetByIndex(var_1_10010, arg_34_1))
	end

	local var_34_5 = arg_34_0.contextData.editBossFleet[arg_34_1]
	local var_34_6 = var_7.getCommanders(var_34_5)
	local var_34_7 = {}

	if arg_34_3 then
		table = var_1_10010

		var_1_10010.insert(var_34_7, arg_34_3.id)
	end

	pg = var_1_10010

	local var_34_8 = var_1_10010.m02
	local var_34_9 = var_10.sendNotification

	GAME = var_1_10012

	local var_34_10 = var_1_10012.GO_SCENE

	SCENE = var_1_10013

	local var_34_11 = var_1_10013.COMMANDERCAT
	local var_34_12 = {
		maxCount = 1
	}

	CommanderCatScene = var_1_10015
	var_34_12.mode = var_1_10015.MODE_SELECT
	CommanderCatScene = var_15
	var_34_12.fleetType = var_15.FLEET_TYPE_GUILDBOSS
	var_34_12.activeCommander = arg_34_3
	var_34_12.ignoredIds = var_34_7
	var_34_12.fleets = arg_34_0.contextData.editBossFleet

	function var_34_12.onCommander(arg_35_0)
		return true
	end

	function var_34_12.onSelected(arg_36_0, arg_36_1)
		local var_36_0 = arg_34_0

		var_2.OnDockSelectCommander(var_36_0, true, var_0, arg_34_2, var_34_3, arg_36_0, arg_36_1)

		return
	end

	function var_34_12.onQuit(arg_37_0)
	...
	var_34_9(var_34_8, var_34_10, var_34_11, var_34_12)
...
function var_0_1.OnDockSelectCommander(arg_38_0, arg_38_1, arg_38_2, arg_38_3, arg_38_4, arg_38_5, arg_38_6)
	...
	local var_38_1 = var_1_10008(var_1_10009)
	...
	if arg_38_1 then
		...
		for iter_38_0, iter_38_1 in var_15(var_38_9) do
			if arg_38_3 ~= iter_38_0 and iter_38_1:isSameGroup(var_8.groupId) then
				...
				var_38_11(var_38_10, var_22("commander_can_not_select_same_group"))
...
function var_0_1.SwopCommanderForBossBattle(arg_39_0, arg_39_1, arg_39_2, arg_39_3, arg_39_4, arg_39_5, arg_39_6, arg_39_7)
	...
	if not arg_39_0.contextData.editBossFleet[arg_39_6.id] then
		...
		Clone = var_1_10010
		var_39_0[var_39_1] = var_1_10010(arg_39_1:GetFleetByIndex(arg_39_6.id))
	...
	if arg_39_4 == 1 then
		...
		local var_39_2 = arg_39_5
		local var_39_3 = arg_39_5.GetName(var_39_2)

		pg = var_39_2

		local var_39_4 = var_39_2.MsgboxMgr.GetInstance()
		local var_39_5 = var_10.ShowMsgBox
		local var_39_6 = {}

		i18n = var_1_10013
		var_39_6.content = var_1_10013("comander_repalce_tip", var_39_3, var_39_0)

		function var_39_6.onYes()
...
function var_0_1.RecommShipsForBossBattle(arg_41_0, arg_41_1)
	...
	local var_41_3 = var_1_10005(var_1_10006)
	local var_41_4 = var_5.getData(var_41_3)

	getProxy = var_41_3
	PlayerProxy = var_1_10007

	local var_41_5 = var_41_3(var_1_10007)
	...
	local var_41_7 = var_7:GetBossMission()

	if not arg_41_0.contextData.editBossFleet[arg_41_1] then
		local var_41_8 = arg_41_0.contextData.editBossFleet

		Clone = var_1_10010
		var_1_10012 = var_41_7
		var_41_8[arg_41_1] = var_1_10010(var_41_7.GetFleetByIndex(var_1_10012, arg_41_1))
	end

	local var_41_9 = arg_41_0.contextData.editBossFleet[arg_41_1]

	var_9.RemoveAll(var_41_9)

	local function var_41_10(arg_42_0, arg_42_1)
	...
	local var_41_11 = var_41_9(var_1_10012)
	local var_41_12 = var_11.getData(var_41_11)

	pairs = var_41_11

	for iter_41_0, iter_41_1 in var_41_11(var_41_12) do
		pg = var_1_10017

		local var_41_13 = var_1_10017.ShipFlagMgr.GetInstance()

		if not var_1_10017.GetShipFlag(var_41_13, iter_41_1.id, "inEvent") and not iter_41_1:isActivityNpc() then
			...
			var_41_10(iter_41_1:getTeamType(), {
				power = var_1_10017,
				id = iter_41_1.id
			})
		end
	...
	local function var_41_17(arg_43_0, arg_43_1)
		GuildAssaultFleet = var_2_10002

		local var_43_0 = var_2_10002.GetRealId(arg_43_0)
		local var_43_1 = var_41_12[var_43_0]
	...
	if var_9:IsMainFleet() then
		...
		for iter_41_2 = 1, #var_41_0 do
			...
			local var_41_18 = var_41_17
			local var_41_19 = var_41_0[iter_41_2].id

			TeamType = var_1_10022

			var_41_18(var_41_19, var_1_10022.Main)
		end
		...
		for iter_41_3 = 1, #var_41_1 do
			...
			local var_41_20 = var_41_17
			local var_41_21 = var_41_1[iter_41_3].id

			TeamType = var_1_10022

			var_41_20(var_41_21, var_1_10022.Vanguard)
		end
	else
		table = var_16
		...
		for iter_41_4 = 1, #var_41_2 do
			...
			local var_41_22 = var_41_17
			local var_41_23 = var_41_2[iter_41_4].id

			TeamType = var_1_10022

			var_41_22(var_41_23, var_1_10022.Submarine)
		end
	end
...
function var_0_1.SelectBossBattleShip(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	local var_47_1 = var_1_10005(var_1_10006)
	...
	local var_47_3 = var_6:GetBossMission()
	local var_47_4 = var_7.GetFleetByIndex(var_47_3, arg_47_2)

	assert = var_47_3

	var_47_3(var_47_4, arg_47_2)

	local var_47_5

	if not arg_47_0.contextData.editBossFleet[arg_47_2] then
		Clone = var_10
		var_47_5 = var_10(var_47_4)
	else
		Clone = var_10
		var_47_5 = var_10(arg_47_0.contextData.editBossFleet[arg_47_2])
	end
	...
	if arg_47_3 then
		var_47_7 = arg_47_3.member.id
		GuildAssaultFleet = var_1_10012
		var_1_10012 = var_1_10012.GetRealId(arg_47_3.ship.id)
		var_47_6 = var_47_5:RemoveUserShip(var_47_7, var_1_10012)
	end

	getProxy = var_47_7
	PlayerProxy = var_1_10012

	local var_47_8 = var_47_7(var_1_10012)
	local var_47_9 = var_11.getRawData(var_47_8)
	local var_47_10 = 0
	local var_47_11 = var_47_5

	if var_47_5.IsMainFleet(var_47_11) then
		local var_47_12 = arg_47_0.contextData.editBossFleet

		GuildBossMission = var_47_11

		local var_47_13

		if not var_47_12[var_47_11.SUB_FLEET_ID] then
			var_47_11 = var_7
			var_47_13 = var_7.GetFleetByIndex
			GuildBossMission = var_1_10015
			var_47_13 = var_47_13(var_47_11, var_1_10015.SUB_FLEET_ID)
		end

		var_1_10015 = var_47_13
		var_47_10 = var_47_13.GetOtherMemberShipCnt(var_1_10015, var_47_9.id)
	else
		local var_47_14 = arg_47_0.contextData.editBossFleet

		GuildBossMission = var_47_11

		local var_47_15

		if not var_47_14[var_47_11.MAIN_FLEET_ID] then
			var_47_11 = var_7
			var_47_15 = var_7.GetFleetByIndex
			GuildBossMission = var_1_10015
			var_47_15 = var_47_15(var_47_11, var_1_10015.MAIN_FLEET_ID)
		end

		var_47_10 = var_47_15:GetOtherMemberShipCnt(var_47_9.id)
	end
	...
	for iter_47_0, iter_47_1 in var_47_11(var_5.member) do
		local var_47_17 = iter_47_1:GetAssaultFleet()

		if var_47_9.id ~= iter_47_1.id then
			var_1_10021 = var_47_17

			local var_47_18 = var_47_17.GetShipList(var_1_10021)

			pairs = var_1_10021

			for iter_47_2, iter_47_3 in var_1_10021(var_47_18) do
	...
	local var_47_19 = var_14(var_15)
	local var_47_20 = var_14.getData(var_47_19)

	pairs = var_47_19

	for iter_47_4, iter_47_5 in var_47_19(var_47_20) do
		iter_47_5.user = var_47_9
		var_1_10021 = var_47_16

		local var_47_21 = var_47_16.GetShipByRealId(var_1_10021, var_47_9.id, iter_47_5.id)

		GuildAssaultFleet = var_1_10021
		iter_47_5.id = var_1_10021.GetVirtualId(var_47_9.id, iter_47_5.id)

		if var_47_21 then
			iter_47_5.guildRecommand = var_47_21.guildRecommand
		end

		table = var_1_10021
		var_1_10021 = var_1_10021.insert
		var_1_10022 = var_47_0
		GuildAssaultShip = var_1_10023

		var_1_10021(var_1_10022, var_1_10023.ConverteFromShip(iter_47_5))
	end
	...
	if arg_47_3 then
		...
		var_16.insert(var_47_22, arg_47_3.ship.id)
	end

	ipairs = var_16

	for iter_47_6, iter_47_7 in var_16(var_47_5:GetShipIds()) do
		if iter_47_7 then
			table = var_1_10021
			var_1_10021 = var_1_10021.insert
			var_1_10022 = var_47_22
			GuildAssaultFleet = var_1_10023

			var_1_10021(var_1_10022, var_1_10023.GetVirtualId(iter_47_7.uid, iter_47_7.id))
		end
	end

	local var_47_23 = var_47_5:GetShips()
	local var_47_24 = arg_47_0
	local var_47_25 = arg_47_0.sendNotification

	GAME = iter_47_6

	local var_47_26 = iter_47_6.GO_SCENE

	SCENE = iter_47_7

	local var_47_27 = iter_47_7.DOCKYARD
	local var_47_28 = {
		selectedMin = 1,
		selectedMax = 1,
		quitTeam = arg_47_3,
		ignoredIds = var_47_22,
		teamFilter = arg_47_1,
		shipVOs = var_47_0
	}

	DockyardScene = var_1_10022
	var_47_28.mode = var_1_10022.MODE_GUILD_BOSS
	ShipStatus = var_22
	var_47_28.hideTagFlags = var_22.TAG_HIDE_CHALLENGE

	function var_47_28.onShip(arg_48_0, arg_48_1, arg_48_2)
		local var_48_0 = var_47_5

		if var_3.GetOtherMemberShipCnt(var_48_0, var_47_9.id) + var_47_10 >= 3 and arg_48_0.user.id ~= var_47_9.id then
		...
		if arg_48_0.user.id ~= var_47_9.id then
			local var_48_3 = var_47_5
			...
			if var_4.ExistUserShip(var_48_3, arg_48_0.user.id) then
				...
				local var_48_5 = var_6("guild_boss_formation_2")
		...
		if var_4.any(var_47_23, function(arg_49_0)
			...
			local var_48_7 = var_5("guild_boss_formation_3")
		...
		local var_48_8 = var_48_6.GetRealId(arg_48_0.id)

		pg = var_5

		local var_48_9 = var_5.ShipFlagMgr.GetInstance()

		if var_5.GetShipFlag(var_48_9, var_48_8, "inEvent") then
			local var_48_10 = false

			i18n = var_48_9

			local var_48_11 = var_48_9("word_shipState_collect")
		...
		if arg_48_0.isActivityNpc(var_48_12) then
			local var_48_13 = false

			i18n = var_48_12

			local var_48_14 = var_48_12("common_npc_formation_tip")
	...
	function var_47_28.onSelected(arg_50_0, arg_50_1)
		if arg_50_0[1] then
			...
			local var_50_1 = var_4.GetUserId(var_2)
			local var_50_2 = var_47_5

			var_5.AddUserShip(var_50_2, var_50_1, var_50_0, var_47_6)
		end
	...
	var_47_25(var_47_24, var_47_26, var_47_27, var_47_28)
...
function var_0_1.OnSelectShips(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	...
	Clone = var_1_10006
	var_51_1.editFleet = var_1_10006(arg_51_3)
	getProxy = var_51_1
	BayProxy = var_6

	local var_51_2 = var_51_1(var_6)
	local var_51_3 = var_5.getData(var_51_2)
	local var_51_4 = {}

	if arg_51_2 then
		table = var_1_10008

		var_1_10008.insert(var_51_4, arg_51_2.id)
	end

	local var_51_5 = arg_51_0
	local var_51_6 = arg_51_0.sendNotification

	GAME = var_1_10010

	local var_51_7 = var_1_10010.GO_SCENE

	SCENE = var_1_10011

	var_51_6(var_51_5, var_51_7, var_1_10011.DOCKYARD, {
		selectedMin = 1,
		selectedMax = 1,
		ignoredIds = var_51_4,
		onShip = function(arg_52_0, arg_52_1, arg_52_2)
			...
			for iter_52_0, iter_52_1 in var_2_10003(var_51_0) do
				...
				if iter_52_0 ~= arg_51_1 and var_2_10008 == arg_52_0.id then
					...
					i18n = var_2_10010
					var_2_10010 = var_2_10010("guild_fleet_exist_same_kind_ship")
			...
			if arg_52_0.isActivityNpc(var_52_1) then
				local var_52_2 = false

				i18n = var_52_1

				local var_52_3 = var_52_1("common_npc_formation_tip")
		...
		onSelected = function(arg_53_0, arg_53_1)
			...
			local var_53_1 = var_51_3[var_53_0]
...
function var_0_1.OnCheckMissionShip(arg_54_0, arg_54_1, arg_54_2)
	...
	local var_54_0 = var_1_10003(var_1_10004)
	local var_54_1 = var_3.getData(var_54_0)

	getProxy = var_54_0
	PlayerProxy = var_1_10005

	local var_54_2 = var_54_0(var_1_10005)
	...
	local var_54_7 = var_54_1:GetActiveEvent()
	local var_54_8 = var_8.GetJoinShips(var_54_7)

	getProxy = var_54_7
	BayProxy = var_1_10011

	local var_54_9 = var_54_7(var_1_10011)
	local var_54_10 = var_10.getData(var_54_9)

	_ = var_54_9

	local var_54_11 = var_54_9.map(arg_54_1, function(arg_55_0)
		return var_54_10[arg_55_0]
	end)
	local var_54_12 = arg_54_2

	if arg_54_2.isActivityNpc(var_54_12) then
		local var_54_13 = false

		i18n = var_54_12

		local var_54_14 = var_54_12("common_npc_formation_tip")

		return
	end

	local var_54_15 = var_8:GetMissionById(arg_54_0)
	local var_54_16 = var_13.GetMyShips(var_54_15)

	_ = var_54_15

	local var_54_17

	if var_54_15.any(var_54_16, function(arg_56_0)
		local var_56_1

		if var_54_10[arg_56_0] then
			local var_56_0 = var_54_10[arg_56_0]
		...
		local var_54_18 = var_16("guild_event_exist_same_kind_ship")
	...
	if var_54_17.any(var_54_11, function(arg_57_0)
		return arg_57_0:isSameKind(arg_54_2)
	end) then
		var_54_19 = false
		i18n = var_16

		local var_54_20 = var_16("guild_event_exist_same_kind_ship")
	...
	local var_54_22 = var_54_5

	if var_54_5.ExistShip(var_54_22, var_54_21) then
		local var_54_23 = false

		i18n = var_54_22

		local var_54_24 = var_54_22("guild_event_exist_assult_ship")

		return
	end

	local var_54_25 = var_54_6
	local var_54_26

	if var_54_6.ExistShip(var_54_25, var_54_21) then
		var_54_26 = false
		i18n = var_54_25

		local var_54_27 = var_54_25("guild_event_exist_assult_ship")
	...
	if var_54_26.any(var_54_8, function(arg_58_0)
		return arg_54_2.id == arg_58_0
	end) then
		local var_54_28 = false

		i18n = var_17

		local var_54_29 = var_17("guidl_event_ship_in_event")
...
function var_0_1.OnSelectMissionShips(arg_59_0, arg_59_1, arg_59_2, arg_59_3)
	...
	local var_59_1 = var_59_0(var_1_10005)
	local var_59_2 = var_4.getData(var_59_1)

	getProxy = var_59_1
	PlayerProxy = var_1_10006

	local var_59_3 = var_59_1(var_1_10006)
	local var_59_4 = var_5.getRawData(var_59_3).id
	local var_59_5 = var_59_2:getMemberById(var_59_4)
	local var_59_6 = var_6.GetAssaultFleet(var_59_5)

	_ = var_59_5

	local var_59_7 = var_59_5.map(var_59_6:GetShipIds(), function(arg_60_0)
	...
	var_9.each(arg_59_3, function(arg_61_0)
		table = var_2_10001

		var_2_10001.insert(var_59_7, arg_61_0)

		return
	end)

	local var_59_8 = var_59_2:GetActiveEvent()
	local var_59_9 = var_9.GetJoinShips(var_59_8)

	_ = var_59_8

	var_59_8.each(var_59_9, function(arg_62_0)
		table = var_2_10001

		var_2_10001.insert(var_59_7, arg_62_0)

		return
	end)

	local var_59_10 = arg_59_0
	local var_59_11 = arg_59_0.sendNotification

	GAME = var_13

	local var_59_12 = var_13.GO_SCENE

	SCENE = var_1_10014

	var_59_11(var_59_10, var_59_12, var_1_10014.DOCKYARD, {
		selectedMin = 1,
		selectedMax = 1,
...
function var_0_1.OnComanderOP(arg_65_0, arg_65_1)
	...
	if var_65_0 == var_1_10004.COMMANDER_OP_RENAME then
		...
		var_1_10007 = arg_65_0

		local var_65_4 = arg_65_0.sendNotification

		GAME = var_1_10008

		var_65_4(var_1_10007, var_1_10008.SET_COMMANDER_PREFAB_NAME, {
			id = var_65_1,
			name = var_65_2,
			onFailed = var_65_3
		})
		...
		if var_65_5 == var_65_2.COMMANDER_OP_RECORD_PREFAB then
			...
			local var_65_7 = var_2.fleet
			local var_65_8 = var_4.getCommanders(var_65_7)

			var_1_10007 = arg_65_0

			local var_65_9 = arg_65_0.sendNotification

			GAME = var_1_10008

			local var_65_10 = var_1_10008.SET_COMMANDER_PREFAB
			local var_65_11 = {
				id = var_65_6
			}

			Clone = var_1_10010
			var_65_11.commanders = var_1_10010(var_65_8)

			var_65_9(var_1_10007, var_65_10, var_65_11)
		else
			local var_65_12 = var_2.id
			local var_65_13 = var_2.fleet

			if not arg_65_0.contextData.editBossFleet then
				arg_65_0.contextData.editBossFleet = {}
			end

			if not arg_65_0.contextData.editBossFleet[var_65_13.id] then
				local var_65_14 = arg_65_0.contextData.editBossFleet
				local var_65_15 = var_65_13.id

				Clone = var_1_10007
				var_65_14[var_65_15] = var_1_10007(var_65_13)
			end

			local var_65_16 = arg_65_0.contextData.editBossFleet[var_65_13.id]
			local var_65_17 = var_2.type

			LevelUIConst = var_1_10007

			local var_65_18

			if var_65_17 == var_1_10007.COMMANDER_OP_USE_PREFAB then
				getProxy = var_65_17
				GuildProxy = var_65_18
				var_65_18 = var_65_17(var_65_18)
				var_65_18 = var_6.getData(var_65_18)
				var_65_18 = var_6.GetActiveEvent(var_65_18)

				local var_65_19 = var_6.GetBossMission(var_65_18)
				local var_65_20 = var_65_16

				var_65_16.ClearCommanders(var_65_20)

				getProxy = var_65_18
				CommanderProxy = var_65_20

				local var_65_21 = var_65_18(var_65_20)
				local var_65_22 = var_65_18.getPrefabFleetById(var_65_21, var_65_12)
				local var_65_23 = var_65_18.getCommander(var_65_22)
				local var_65_24 = {}

				pairs = var_1_10010

				for iter_65_0, iter_65_1 in var_1_10010(var_65_23) do
					table = var_1_10015

					var_1_10015.insert(var_65_24, function(arg_66_0)
						local var_66_0 = arg_65_0

						var_1.OnDockSelectCommander(var_66_0, false, var_65_16, iter_65_0, var_65_19, {
							iter_65_1.id
						}, arg_66_0)
				...
				local var_65_25 = var_2.type

				LevelUIConst = var_65_18

				if var_65_25 == var_65_18.COMMANDER_OP_REST_ALL then
					var_65_16:ClearCommanders()

					local var_65_26 = arg_65_0.viewComponent

					var_6.OnBossCommanderFormationChange(var_65_26)
				end
			end
		end
	end
...
function var_0_1.handleNotification(arg_69_0, arg_69_1)
	...
	local var_69_2 = arg_69_1.getBody(var_69_1)

	PlayerProxy = var_69_1

	if var_69_0 == var_69_1.UPDATED then
		var_1_10005 = arg_69_0.viewComponent

		var_4.SetPlayer(var_1_10005, var_69_2)
	...
	if var_69_0 == var_4.GUILD_UPDATED then
		var_1_10005 = arg_69_0.viewComponent

		var_4.UpdateGuild(var_1_10005, var_69_2)
	...
	if var_69_0 == var_4.GUILD_ACTIVE_EVENT_DONE then
		var_1_10005 = arg_69_0
		var_69_3 = arg_69_0.sendNotification
		GAME = var_1_10006

		var_69_3(var_1_10005, var_1_10006.GUILD_GET_ACTIVATION_EVENT, {
			force = true,
			callback = function()
	...
	if var_69_0 == var_69_3.GUILD_UPDATE_MY_ASSAULT_FLEET_DONE then
		var_69_4 = arg_69_0.contextData
		var_69_4.editFleet = nil
		var_1_10005 = arg_69_0.viewComponent

		var_69_4.OnMyAssultFleetFormationDone(var_1_10005)

		pg = var_69_4
		var_1_10005 = var_69_4.TipsMgr.GetInstance()
		var_69_4 = var_69_4.ShowTips
		i18n = var_1_10006

		var_69_4(var_1_10005, var_1_10006("guild_event_start_done"))
	...
	if var_69_0 == var_69_4.GUILD_JOIN_MISSION_DONE then
		var_69_5 = arg_69_0.contextData
		var_69_5.missionShips = nil
		var_1_10005 = arg_69_0
		var_69_5 = arg_69_0.sendNotification
		GAME = var_1_10006

		var_69_5(var_1_10005, var_1_10006.GUILD_REFRESH_MISSION, {
			force = true,
			id = var_69_2.id
		})
		...
		var_69_5.OnMissionFormationDone(var_1_10005)
	...
	if var_69_0 == var_69_5.GUILD_REFRESH_MISSION_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.RefreshMission(var_1_10005, var_69_2.id)
	...
	if var_69_0 == var_4.GUILD_GET_BOSS_INFO_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.RefreshBossMission(var_1_10005)
	...
	if var_69_0 == var_4.GET_GUILD_BOSS_RANK_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.OnBossRankUpdate(var_1_10005)
	...
	if var_69_0 == var_4.GUILD_UPDATE_NODE_ANIM_FLAG_DONE then
		var_1_10005 = arg_69_0.viewComponent
	...
	if var_69_0 == var_4.GUILD_UPDATE_BOSS_FORMATION_DONE then
		var_69_6 = arg_69_0.contextData
		var_69_6.editBossFleet = nil
		pg = var_69_6
		var_1_10005 = var_69_6.TipsMgr.GetInstance()
		var_69_6 = var_69_6.ShowTips
		i18n = var_1_10006

		var_69_6(var_1_10005, var_1_10006("guild_fleet_update_done"))

		var_1_10005 = arg_69_0.viewComponent

		var_69_6.OnBossMissionFormationChanged(var_1_10005)
	...
	if var_69_0 == var_69_6.GUILD_GET_ASSAULT_FLEET_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.OnMemberAssultFleetUpdate(var_1_10005)
	...
	if var_69_0 == var_4.GUILD_GET_MY_ASSAULT_FLEET_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.OnMyAssultFleetUpdate(var_1_10005)
	...
	if var_69_0 == var_4.SUBMIT_GUILD_REPORT_DONE then
		var_1_10005 = arg_69_0.viewComponent

		var_4.OnReportUpdated(var_1_10005)
	...
	if var_69_0 == var_4.GUILD_BATTLE_STARTED then
		getProxy = var_69_9
		GuildProxy = var_1_10005

		local var_69_7 = var_69_9(var_1_10005)
		local var_69_8 = var_69_9.getRawData(var_69_7)

		var_69_9 = var_69_9.IsAdministrator(var_69_8)
		i18n = var_69_8

		local var_69_10 = var_69_8("guild_event_start_tip1")

		if var_69_9 and arg_69_0.viewComponent.eventInfoPage then
			local var_69_11 = arg_69_0.viewComponent.eventInfoPage

			if var_6.GetLoaded(var_69_11) then
				local var_69_12 = arg_69_0.viewComponent.eventInfoPage

				if var_6.isShowing(var_69_12) then
					i18n = var_6
					var_69_10 = var_6("guild_event_start_tip2")
				end
			end
		end
		...
		local var_69_13 = var_6.MsgboxMgr.GetInstance()

		var_6.ShowMsgBox(var_69_13, {
			hideNo = true,
			content = var_69_10,
			onYes = function()
				...
				var_71_1(var_71_0, var_2_10002.GUILD_GET_ACTIVATION_EVENT, {
					force = true,
					callback = function()
	...
	if var_69_0 == var_69_9.ON_GUILD_JOIN_EVENT_DONE then
		local var_69_14 = arg_69_0.viewComponent

		var_4.EnterEvent(var_69_14)
	...
	if var_69_0 == var_4.GUILD_END_BATTLE then
	...
	if var_69_0 == var_4.ON_EXIST_DELETED_MEMBER then
		local var_69_16 = arg_69_0.viewComponent

		var_4.OnMemberDeleted(var_69_16)
	...
	if var_69_0 == var_4.GUILD_RECOMMAND_ASSULT_SHIP_DONE then
		local var_69_17 = arg_69_0.viewComponent

		var_4.OnAssultShipBeRecommanded(var_69_17, var_69_2.shipId)
	...
	if var_69_0 == var_4.REFRESH_ALL_ASSULT_SHIP_RECOMMAND_STATE_DONE then
		local var_69_18 = arg_69_0.viewComponent

		var_4.OnRefreshAllAssultShipRecommandState(var_69_18)
	...
	if var_69_0 == var_4.TASK_PROGRESS_UPDATE then
		pg = var_4

		local var_69_19 = var_4.GuildMsgBoxMgr.GetInstance()

		var_4.NotificationForGuildEvent(var_69_19, var_69_2)
	...
	if var_69_0 ~= var_4.SET_COMMANDER_PREFAB_NAME_DONE then
		GAME = var_4

		if var_69_0 == var_4.SET_COMMANDER_PREFAB_DONE then
			local var_69_20 = arg_69_0.viewComponent

			var_4.OnBossCommanderPrefabFormationChange(var_69_20)
		else
			GAME = var_4

			if var_69_0 == var_4.ON_GUILD_EVENT_END then
				local var_69_21 = arg_69_0.viewComponent

				var_4.OnEventEnd(var_69_21)
			end
		end
