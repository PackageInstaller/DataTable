...
function var_0_1.OnLoaded(arg_2_0)
	...
	Vector3 = var_2_1
	arg_2_0.buttonPos = var_2_1(var_2_2.x, var_2_2.y, 0)
...
function var_0_1.Hide(arg_4_0)
	...
	if arg_4_0.circle.childCount > 0 then
		local var_4_1 = arg_4_0.circle
		local var_4_2 = var_1.GetChild(var_4_1, 0).gameObject

		PoolMgr = var_4_1

		local var_4_3 = var_4_1.GetInstance()

		var_2.ReturnPrefab(var_4_3, "IconFrame/" .. var_4_2.name, var_4_2.name, var_4_2)
	end
