...
function var_0_1.OnInit(arg_2_0)
	...
	local var_2_11 = var_2.Find(var_2_10, "atttr_panel/abilitys/mask/content")
	local var_2_12 = arg_2_0.descFrameTF

	arg_2_0.abilitysTF = var_2_9(var_2_11, var_3.Find(var_2_12, "atttr_panel/abilitys/mask/content/attr"))
	UIItemList = var_1

	local var_2_13 = var_1.New
	local var_2_14 = arg_2_0.descFrameTF
	local var_2_15 = var_2.Find(var_2_14, "atttr_panel/talents/mask/content")
	local var_2_16 = arg_2_0.descFrameTF

	arg_2_0.talentsTF = var_2_13(var_2_15, var_3.Find(var_2_16, "atttr_panel/talents/mask/content/attr"))
	...
	local var_2_30 = var_2.Find(var_2_29, "record/content")
	local var_2_31 = arg_2_0.recordPanel

	arg_2_0.recordList = var_2_28(var_2_30, var_3.Find(var_2_31, "record/content/commanders"))
	onButton = var_1
	...
	var_1(var_2_35, var_2_36, var_2_37, var_5)
	...
	local function var_2_40()
		...
		local var_5_3 = var_2_10002.COMMANDER_FORMATION_OP
		local var_5_4 = {}
		local var_5_5 = {
			fleet = arg_2_0.fleet
		}
		...
		LevelUIConst = var_5
		var_5_5.type = var_5.COMMANDER_OP_REST_ALL
	...
	var_1(var_2_38, var_2_39, var_2_40, var_5)
	...
	var_1(var_2_41, var_2_42, var_2_43, var_5)

	onButton = var_1

	local var_2_44 = arg_2_0
	local var_2_45 = arg_2_0.recordPanel
	local var_2_46 = var_3.Find(var_2_45, "back")
	...
	var_1(var_2_44, var_2_46, var_2_47, var_5)
	arg_2_0:Show()
...
function var_0_1.Update(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0 = var_8_2, var_1_10005.MAX_FORMATION_POS do
...
function var_0_1.openDescPanel(arg_9_0, arg_9_1)
	...
	if not var_9_1(var_1_10004(arg_9_0.samllTF)) then
		LeanTween = var_9_2
		...
		if var_9_2(var_4(arg_9_0.descFrameTF)) then
			return
		end
		...
		var_9_4(var_9_3, var_5.Action(function()
...
function var_0_1.closeDescPanel(arg_11_0, arg_11_1)
	...
	if not var_11_1(var_1_10004(arg_11_0.samllTF)) then
		LeanTween = var_11_2
		...
		if var_11_2(var_4(arg_11_0.descFrameTF)) then
			return
		end
...
function var_0_1.updateDesc(arg_13_0)
	...
	for iter_13_0 = var_13_2, var_1_10003.MAX_FORMATION_POS do
...
function var_0_1.updateAdditions(arg_14_0)
	...
	var_5.make(var_14_4, function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_0 == var_2_10003.EventUpdate then
			...
			local var_15_2 = arg_15_2.Find(var_15_1, "name")

			AttributeType = var_15_1

			var_4(var_15_2, var_15_1.Type2Name(var_15_0.attrName))

			setText = var_4

			local var_15_3 = arg_15_2:Find("Text")
			local var_15_4 = "+"

			math = var_7

			var_4(var_15_3, (var_15_4 .. var_7.floor(var_15_0.value * 1000) / 1000) .. "%")
	...
	var_5.make(var_14_6, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			var_4(var_2_10005(arg_16_2, "name_mask/name"), var_16_0.name)

			local var_16_1 = var_16_0.type

			CommanderConst = var_5

			local var_16_2 = var_16_1 == var_5.TALENT_ADDITION_RATIO and "%" or ""
...
function var_0_1.updateSkillTF(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_1 then
		...
		var_1_10003 = arg_17_1.getSkills(var_17_0)[1]
		GetImageSpriteFromAtlasAsync = var_17_0

		var_17_0("CommanderSkillIcon/" .. var_1_10003:getConfig("icon"), "", arg_17_2:Find("icon"))

		setText = var_17_0

		local var_17_1 = arg_17_2:Find("level")
		local var_17_2 = "Lv."
		local var_17_3 = var_1_10003

		var_17_0(var_17_1, var_17_2 .. var_1_10003.getLevel(var_17_3))
		...
		local function var_17_6()
			...
			var_18_1(var_18_0, var_2_10002.ON_CMD_SKILL, var_1_10003)
		...
		var_17_0(var_17_4, var_17_5, var_17_6, var_17_3)
	else
...
function var_0_1.updateCommander(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4)
	...
	local var_19_2 = arg_19_1.Find(var_19_1, "info")

	if arg_19_3 then
		var_19_1 = arg_19_1:Find("info/mask/icon")

		local var_19_3 = arg_19_1
		local var_19_4 = arg_19_1.Find(var_19_3, "info/frame")

		GetImageSpriteFromAtlasAsync = var_19_3

		var_19_3("CommanderHrz/" .. arg_19_3:getPainting(), "", var_19_1)

		local var_19_5 = arg_19_1

		if arg_19_1.Find(var_19_5, "info/name") then
			setText = var_19_5
			var_1_10011 = var_9
			var_1_10013 = arg_19_3

			var_19_5(var_1_10011, arg_19_3.getName(var_1_10013))
		end

		Commander = var_19_5

		local var_19_6 = var_19_5.rarity2Frame(arg_19_3:getRarity())
		...
		var_1_10011(var_19_7, var_1_10013("weaponframes", "commander_" .. var_19_6))
	end
	...
	if arg_19_4 then
		...
		local function var_19_10()
			...
			var_20_1(var_20_0, var_2_10002.ON_SELECT_COMMANDER, arg_19_0.fleet.id, arg_19_2, arg_19_3)
		...
		var_19_1(var_19_8, var_19_9, var_19_10, var_1_10011)
		...
		local function var_19_13()
			...
			var_21_1(var_21_0, var_2_10002.ON_SELECT_COMMANDER, arg_19_0.fleet.id, arg_19_2, arg_19_3)
		...
		var_19_1(var_19_11, var_19_12, var_19_13, var_1_10011)
	end

	setActive = var_19_1

	var_19_1(var_19_0, not arg_19_3)

	setActive = var_19_1

	var_19_1(var_19_2, arg_19_3)
...
function var_0_1.updateRecordPanel(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_23_0(arg_23_0.recordCommanders) do
...
function var_0_1.UpdatePrefabFleet(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	local var_25_2 = arg_25_1.getName(var_25_1)

	onInputEndEdit = var_25_1

	var_25_1(arg_25_0, var_25_0, function()
		getInputText = var_2_10000

		local var_26_0 = var_2_10000(var_25_0)
		local var_26_1 = arg_25_0
		local var_26_2 = var_1.emit

		GuildEventMediator = var_2_10003

		local var_26_3 = var_2_10003.COMMANDER_FORMATION_OP
		local var_26_4 = {}
		local var_26_5 = {
		...
		LevelUIConst = var_6
		var_26_5.type = var_6.COMMANDER_OP_RENAME
	...
	local var_25_4 = arg_25_2:Find("use_btn")
	...
	local function var_25_5()
		...
		LevelUIConst = var_5
		var_28_4.type = var_5.COMMANDER_OP_USE_PREFAB
	...
	var_25_1(var_25_3, var_25_4, var_25_5, var_10)

	onButton = var_25_1

	local var_25_6 = arg_25_0
	local var_25_7 = arg_25_2:Find("record_btn")
	...
	local function var_25_8()
		...
		local var_29_2 = var_2_10002.COMMANDER_FORMATION_OP
		local var_29_3 = {}
		local var_29_4 = {
			fleet = arg_25_0.fleet
		}
		...
		LevelUIConst = var_5
		var_29_4.type = var_5.COMMANDER_OP_RECORD_PREFAB
	...
	var_25_1(var_25_6, var_25_7, var_25_8, var_10)
	...
	for iter_25_0, iter_25_1 in var_8(var_25_9) do
		local var_25_11 = arg_25_1:getCommanderByPos(iter_25_0)

		arg_25_0:updateCommander(iter_25_1, iter_25_0, var_25_11)
		arg_25_0:updateSkillTF(var_25_11, var_25_10[iter_25_0])
	end
...
function var_0_1.OnDestroy(arg_31_0)
	...
	if arg_31_0.isShowing(var_31_0) then
		...
		var_31_2(var_2(arg_31_0.descFrameTF))
	end
