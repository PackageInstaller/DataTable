...
function var_0_0.Init(arg_2_0, arg_2_1)
	...
	Vector3 = var_2_0
	var_2_1.localScale = var_2_0(1 / arg_2_0.scale, 1 / arg_2_0.scale, 1)
	...
	if arg_2_0.isCommander then
		...
		Vector3 = var_2_3
		var_2_4.localScale = var_2_3(1 / arg_2_0.scale, 1 / arg_2_0.scale, 1)
...
function var_0_0.StartMove(arg_9_0)
	...
	if not var_9_0.select(var_9_1, function(arg_10_0)
...
function var_0_0.MoveNext(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local var_15_2 = arg_15_1.GetCenterPosition(var_15_1)

	LeanTween = var_15_1

	local var_15_3 = var_15_1.moveLocal
	local var_15_4 = arg_15_0._go

	Vector3 = var_1_10008

	local var_15_5 = var_15_3(var_15_4, var_1_10008(var_15_2.x, var_15_2.y, 0), 1 / arg_15_0.speed)
	local var_15_6 = var_6.setOnComplete

	System = var_8

	var_15_6(var_15_5, var_8.Action(function()
		if arg_15_0.exited then
			return
		end
...
function var_0_0.InterActionFurniture(arg_32_0, arg_32_1)
	...
	GuildDynamicFurniture = var_1_10006

	if var_1_10006.INTERACTION_MODE_SIT == var_32_2 then
		var_32_3 = "sit"
	end
...
function var_0_0.CancelInterAction(arg_33_0, arg_33_1)
	...
	Timer = var_3
	arg_33_0.interActionTimer = var_3.New(function()
...
function var_0_0.SearchPoint(arg_37_0, arg_37_1, arg_37_2)
	...
	local function var_37_1(arg_41_0)
		...
		var_41_1(var_41_2, var_2_10004(arg_41_0.x + 1, arg_41_0.y))
		...
		var_41_3(var_41_4, var_4(arg_41_0.x - 1, arg_41_0.y))
		...
		var_41_5(var_41_6, var_4(arg_41_0.x, arg_41_0.y + 1))
		...
		var_41_7(var_41_8, var_4(arg_41_0.x, arg_41_0.y - 1))
	...
	local function var_37_2(arg_42_0, arg_42_1, arg_42_2)
		...
		local var_42_1 = var_42_0 + var_4.abs(arg_42_2.y - arg_42_0.y)
...
function var_0_0.CanInterAction(arg_44_0, arg_44_1)
	...
	for iter_44_0, iter_44_1 in var_4(arg_44_0.furnitures) do
		var_1_10010 = iter_44_1

		if not iter_44_1.BeLock(var_1_10010) then
			table = var_9
	...
	for iter_44_2, iter_44_3 in var_1_10010(var_44_2) do
		...
		if var_1_10016 + var_17.abs(var_44_5.y - var_44_6.y) < var_44_3 then
