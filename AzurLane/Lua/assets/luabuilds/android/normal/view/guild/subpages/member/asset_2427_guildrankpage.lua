...
function var_0_1.OnLoaded(arg_5_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.rankLabel = var_5_5(var_5_4, var_3(var_1_10004))
	...
	var_5_8(var_2.Find(var_5_9, "month"), true)

	setActive = var_5_8

	local var_5_10 = arg_5_0.ranTypeTF

	var_5_8(var_2.Find(var_5_10, "total"), true)
...
function var_0_1.OnInit(arg_7_0)
	...
	local function var_7_6()
		...
		typeof = var_2
		Image = var_2_10003
		var_10_3(var_10_2, var_2(var_2_10003)).enabled = arg_7_0.ranType == 0
		...
		typeof = var_2
		Image = var_2_10003
		var_10_6(var_10_5, var_2(var_2_10003)).enabled = arg_7_0.ranType == 2
		...
		typeof = var_2
		Image = var_2_10003
		var_10_8(var_10_7, var_2(var_2_10003)).enabled = arg_7_0.ranType == 1
	...
	var_2(var_7_7, var_7_8, var_7_9, var_1_10006)
	arg_7_0:InitTags()
	var_7_6()
...
function var_0_1.InitTags(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10001(var_0_2) do
		...
		var_12_0(var_12_2, var_12_3, var_12_4, var_1_10011)
	end
...
function var_0_1.Flush(arg_14_0, arg_14_1)
	...
	var_2(var_3.Find(var_14_2, "commit"), true)
...
function var_0_1.SwitchPage(arg_15_0, arg_15_1)
	...
	if arg_15_0.GetRank(var_15_1, arg_15_1) then
		getProxy = var_15_1
		GuildProxy = var_4

		local var_15_2 = var_15_1(var_4)

		if var_15_1.ShouldRefreshRank(var_15_2, arg_15_1) then
			local var_15_3 = arg_15_0

			var_15_1 = arg_15_0.emit
			GuildMemberMediator = var_1_10005

			var_15_1(var_15_3, var_1_10005.GET_RANK, arg_15_1)
		else
			assert = var_15_1
...
function var_0_1.OnUpdateItem(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = var_1_10005(arg_18_2)

	var_4(var_5.Find(var_18_1, "number"), arg_18_1 + 1)

	setText = var_4
	tf = var_5

	local var_18_2 = var_5(arg_18_2)

	var_4(var_5.Find(var_18_2, "name"), var_18_0:GetName())

	setText = var_4
	tf = var_5

	local var_18_3 = var_5(arg_18_2)

	var_4(var_5.Find(var_18_3, "score"), var_18_0:GetScore(arg_18_0.ranType))
