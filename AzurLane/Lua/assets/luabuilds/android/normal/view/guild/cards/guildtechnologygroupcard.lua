...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".GuildTechnologyCard"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_6
	arg_1_0.devBtnTxt = var_1_4(var_1_3, var_5(var_6))
...
function var_0_1.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_5 = arg_2_1.GetState(var_2_4)

	setActive = var_2_4

	var_2_4(arg_2_0.maxTF, var_2_2 <= var_2_3)

	setActive = var_2_4

	var_2_4(arg_2_0.breakoutTF, var_2_3 < var_2_2)

	setActive = var_2_4

	local var_2_6 = arg_2_0.devBtn

	GuildTechnologyGroup = var_10

	var_2_4(var_2_6, var_2_5 == var_10.STATE_STOP and var_2_3 < var_2_2)

	setActive = var_2_4

	local var_2_7 = arg_2_0.breakoutSlider.gameObject

	GuildTechnologyGroup = var_10

	var_2_4(var_2_7, var_2_5 == var_10.STATE_START)

	setActive = var_2_4

	var_2_4(arg_2_0.cancelBtn, false)
	...
	if var_2_3 < var_2_2 then
		...
		local function var_2_10()
			...
			if not arg_2_3 then
				...
				var_3_1(var_3_0, var_2_10002("guild_tech_non_admin"))
			...
			var_3_4.content = var_2_10003(var_3_5, var_5.getConfig(var_3_6, "name"))
			...
			function var_3_4.onYes()
				...
				var_4_1(var_4_0, var_3_10002.ON_START, var_2_0)
		...
		var_2_4(var_2_8, var_2_9, var_2_10, var_1_10012)

		var_2_4 = arg_2_0.levelTxt
		var_2_4.text = "Lv." .. var_2_3 .. "/" .. var_2_2
	else
		var_2_4 = arg_2_0.levelTxt
		var_2_4.text = "Lv." .. var_2_2 .. "/" .. var_2_2
	end

	GuildTechnologyGroup = var_2_4

	local var_2_11

	if var_2_5 == var_2_4.STATE_START then
		var_2_11 = arg_2_1:GetTargetProgress()

		local var_2_12 = arg_2_1:GetProgress()

		arg_2_0.breakoutSlider.value = var_2_12 / var_2_11
		arg_2_0.breakoutTxt.text = var_2_12 .. "/" .. var_2_11
	end
	...
	local function var_2_15()
		...
		if not arg_2_3 then
			...
			var_5_1(var_5_0, var_2_10002("guild_tech_non_admin"))
		...
		var_5_4.content = var_2_10003(var_5_5, var_5.getConfig(var_5_6, "name"))
		...
		function var_5_4.onYes()
			...
			var_6_1(var_6_0, var_3_10002.ON_CANCEL_TECH, var_2_0)
	...
	var_2_11(var_2_13, var_2_14, var_2_15, var_1_10012)

	local var_2_16 = arg_2_0.devBtnTxt

	i18n = var_2_13
	var_2_16.text = var_2_13("guild_tech_donate_target", arg_2_1:GetTargetProgress())
