...
function var_0_0.Flush(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_2:GetLeftTime() < 0 then
		...
		arg_1_0.timer = var_4.New(function()
			...
			local var_2_5 = var_2_10004.TimeMgr.GetInstance()

			var_2_3(var_2_2, var_2_4 .. var_4.DescCDTime(var_2_5, var_2_1) .. "</color></size>")
		...
		local var_1_7 = var_1_10010("word_date")
		local var_1_8 = "%s"

		i18n = var_1_10012

		local var_1_9 = var_1_5(var_1_6 .. var_1_7 .. var_1_8 .. var_1_10012("word_hour"), var_1_1, var_1_2)

		if var_1_1 < 7 then
			var_1_9 = "<size=31><color=#FF3838>" .. var_1_9 .. "</color></size>"
		end

		arg_1_0:UpdateText(var_1_9)
		...
		local var_1_11 = var_10.min(var_3 - 0, var_1_10)

		Timer = var_11
		arg_1_0.timer = var_11.New(function()
	...
	local var_1_12 = arg_1_0.timer

	var_4.Start(var_1_12)
...
function var_0_0.OnOver(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.GUILD_GET_ACTIVATION_EVENT, {
		force = true
	})
