...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.GET_RANK, function(arg_2_0, arg_2_1)
		...
		var_2_1(var_2_0, var_2_10004.GUILD_GET_RANK, {
			id = arg_2_1
		})
	...
	arg_1_0:bind(var_0_1.OPEN_DESC_INFO, function(arg_3_0, arg_3_1)
		...
		local var_3_2 = var_2_10004.FRIEND_SEARCH
		local var_3_3 = {}

		SearchFriendCommand = var_2_10006
		var_3_3.type = var_2_10006.SEARCH_TYPE_RESUME
	...
	arg_1_0:bind(var_0_1.FIRE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.GUILD_FIRE, arg_4_1)
	...
	arg_1_0:bind(var_0_1.SET_DUTY, function(arg_5_0, arg_5_1, arg_5_2)
		...
		var_5_1(var_5_0, var_2_10005.SET_GUILD_DUTY, {
			playerId = arg_5_1,
			dutyId = arg_5_2
		})
	...
	arg_1_0.bind(var_1_5, var_0_1.IMPEACH, function(arg_6_0, arg_6_1)
		...
		var_6_1(var_6_0, var_2_10004.GUILD_IMPEACH, arg_6_1)
...
function var_0_1.handleNotification(arg_8_0, arg_8_1)
	...
	if var_8_0 == var_8_1.GUILD_UPDATED then
		...
		if var_8_0 == var_4.SET_GUILD_DUTY_DONE then
			...
			if var_8_0 == var_4.GUILD_FIRE_DONE then
				...
				if var_8_0 == var_4.FRIEND_SEARCH_DONE then
					...
					if var_8_0 == var_8_7.GUILD_GET_RANK_DONE then
