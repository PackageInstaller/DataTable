...
function var_0_1.init(arg_11_0)
	...
	var_11_2(var_11_1, var_3.Find(var_11_3, "painting"))
	...
	arg_11_0.dynamicBg = var_11_16(var_2.Find(var_11_17, "dynamic_bg"))
	Input = var_1
...
function var_0_1.preload(arg_12_0, arg_12_1)
	...
	var_1_10002({
		function(arg_13_0)
			...
			var_13_1(var_13_0, var_2_10003.GET_GUILD_REPORT, {
				callback = arg_13_0
			})
		...
		function(arg_14_0)
			...
			if not var_1.GetActiveEvent(var_14_1) then
				...
				var_14_3(var_14_2, var_2_10004.GUILD_GET_ACTIVATION_EVENT, {
					force = false,
					callback = arg_14_0
				})
			elseif var_1 and var_1:IsExpired() then
				...
				var_14_5(var_14_4, var_2_10004.GUILD_GET_ACTIVATION_EVENT, {
					force = true,
					callback = arg_14_0
				})
			else
...
function var_0_1.didEnter(arg_15_0)
	...
	local function var_15_2()
		...
		var_16_1(var_16_0, var_2_10002.ON_BACK)
	...
	if var_1.shouldRefreshCaptial(var_15_8) then
		...
		GuildMainMediator = var_3

		var_15_10(var_15_9, var_3.ON_FETCH_CAPITAL)
	end
	...
	local var_15_13 = var_15_12(var_15_11, var_3.MAX_DISPLAY_MEMBER_SHIP)
...
function var_0_1.EnterOrExitPreView(arg_21_0)
	...
	if not var_21_0(var_1_10002(arg_21_0._topPanel)) then
		LeanTween = var_1
		...
		if not var_21_1(var_21_3(arg_21_0._leftLength)) then
			...
			local var_21_5 = var_21_3.value

			go = var_3

			local var_21_6 = var_21_5(var_3(arg_21_0._topPanel), var_21_4[1], var_21_4[2], 0.3)
			local var_21_7 = var_2.setOnUpdate

			System = var_4

			var_21_7(var_21_6, var_4.Action_float(function(arg_22_0)
			...
			local var_21_9 = var_21_6.value

			go = var_4

			local var_21_10 = var_21_9(var_4(arg_21_0._leftLength), var_21_8[1], var_21_8[2], 0.3)
			local var_21_11 = var_3.setOnUpdate

			System = var_5

			var_21_11(var_21_10, var_5.Action_float(function(arg_23_0)
				setAnchoredPosition = var_2_10001
			...
			local var_21_13 = var_21_10.value

			go = var_5

			local var_21_14 = var_21_13(var_5(arg_21_0.topBg), var_21_12[1], var_21_12[2], 0.3)
			local var_21_15 = var_4.setOnUpdate

			System = var_6

			var_21_15(var_21_14, var_6.Action_float(function(arg_24_0)
				setAnchoredPosition = var_2_10001
...
function var_0_1.initToggles(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_30_0(var_0_1.TOGGLE_TAG) do
		...
		var_30_1(var_30_3, var_30_4, var_30_5, var_1_10010)
	end
	...
	if var_30_7 ~= var_4.DUTY_COMMANDER then
		GuildConst = var_4

		if var_30_7 ~= var_4.DUTY_DEPUTY_COMMANDER then
			var_30_9 = false
...
function var_0_1.openPage(arg_33_0, arg_33_1)
	...
	if arg_33_1 == var_0_2 then
		...
		var_33_6(var_33_5, var_4.OPEN_MAIN)
	elseif arg_33_1 == var_0_3 then
		...
		var_33_8(var_33_7, var_4.OPEN_MEMBER)
	elseif arg_33_1 == var_0_4 then
		...
		var_33_10(var_33_9, var_4.OPEN_APPLY)
	elseif arg_33_1 == var_0_5 then
		...
		var_33_12(var_33_11, var_4.OPEN_OFFICE)
	elseif arg_33_1 == var_0_6 then
		...
		var_33_14(var_33_13, var_4.OPEN_TECH)
	elseif arg_33_1 == var_0_7 then
		...
		var_33_16(var_33_15, var_4.OPEN_BATTLE)
	end
...
function var_0_1.closePage(arg_34_0, arg_34_1)
	...
	elseif arg_34_1 == var_0_3 then
		...
		GuildMainMediator = var_1_10004

		var_34_2(var_34_1, var_1_10004.CLOSE_MEMBER)
	elseif arg_34_1 == var_0_4 then
		...
		var_34_4(var_34_3, var_1_10004.CLOSE_APPLY)
	elseif arg_34_1 == var_0_5 then
		...
		var_34_6(var_34_5, var_1_10004.CLOSE_OFFICE)
	elseif arg_34_1 == var_0_6 then
		...
		var_34_8(var_34_7, var_1_10004.CLOSE_TECH)
	elseif arg_34_1 == var_0_7 then
		...
		var_34_10(var_34_9, var_1_10004.CLOSE_BATTLE)
	end
