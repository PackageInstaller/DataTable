...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:bind(var_0_1.OPEN_PUBLIC_GUILD, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_2, var_2_10004.PUBLIC_GUILD)
	...
	arg_1_0:bind(var_0_1.OPEN_GUILD_LIST, function(arg_3_0)
		...
		JoinGuildLayer = var_2_10005
		var_3_3.viewComponent = var_2_10005
		JoinGuildMediator = var_2_10005
	...
	arg_1_0:bind(var_0_1.CREATE, function(arg_4_0, arg_4_1)
		...
		var_4_1(var_4_0, var_2_10004.CREATE_GUILD, arg_4_1)
...
function var_0_1.handleNotification(arg_6_0, arg_6_1)
	...
	if var_6_0 == var_6_1.NEW_GUILD_ADDED then
		var_1_10005 = arg_6_0
		var_6_3 = arg_6_0.sendNotification
		GAME = var_1_10006

		local var_6_4 = var_1_10006.GO_SCENE

		SCENE = var_1_10007

		var_6_3(var_1_10005, var_6_4, var_1_10007.GUILD)
	else
		PlayerProxy = var_6_3
		...
		if var_6_0 == var_6_3.UPDATED then
			...
			var_4.setPlayer(var_1_10005, var_6_2)
		else
			GAME = var_4

			if var_6_0 == var_4.CREATE_GUILD_DONE then
				var_1_10005 = arg_6_0.viewComponent

				var_4.ClosePage(var_1_10005)
			else
				GAME = var_4

				if var_6_0 == var_4.REMOVE_LAYERS then
					local var_6_5 = var_6_2.context.mediator

					JoinGuildMediator = var_1_10005

					if var_6_5 == var_1_10005 then
						local var_6_6 = arg_6_0.viewComponent

						var_4.startCreate(var_6_6)
					end
				end
			end
		end
