...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame/bg/scrollrect/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uilist = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/bg/scrollrect/content/tpl"))
	...
	var_3.make(var_7_2, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			local function var_8_4()
				...
				var_9_2.content = var_3_10003(var_9_3, var_5.getConfig(var_9_4, "name"))
				...
				function var_9_2.onYes()
					...
					var_10_1(var_10_0, var_4_10002.ON_SELECT_TASK, var_8_0.task.id)
