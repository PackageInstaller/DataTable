...
local var_0_1 = var_5("protobuf.wire_format")
	...
	return function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_2 then
			...
			return function(arg_6_0)
				...
				return var_6_0 + var_0(var_6_0) + var_5_0
			end
		elseif arg_5_1 then
	...
	return function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_2 then
			...
			return function(arg_11_0)
				...
				return var_11_0 + var_0(var_11_0) + var_10_0
			end
	...
	return function(arg_15_0, arg_15_1, arg_15_2)
		...
		if arg_15_2 then
			...
			return function(arg_16_0)
				return #arg_16_0 * arg_14_0 + var_0(var_1) + var_15_0
			end
...
_SignedVarintSize = var_7

local var_0_13 = var_6(var_7)
...
local var_0_17 = var_6(var_7, var_0_1.ZigZagEncode32)
	...
	if arg_19_1 then
		return function(arg_20_0)
			...
			for iter_20_0, iter_20_1 in var_0_10002(arg_20_0) do
				...
				var_20_0 = var_20_0 + var_0(var_20_1) + var_20_1
			end
		...
		return function(arg_21_0)
			...
			return var_19_0 + var_0(var_21_0) + var_21_0
		end
	end
	...
	if arg_22_1 then
		return function(arg_23_0)
			...
			for iter_23_0, iter_23_1 in var_0_10002(arg_23_0) do
				...
				var_23_0 = var_23_0 + var_0(var_23_1) + var_23_1
			end
		...
		return function(arg_24_0)
			...
			return var_22_0 + var_0(var_24_0) + var_24_0
		end
	end
	...
	if arg_25_1 then
		return function(arg_26_0)
			...
			for iter_26_0, iter_26_1 in var_0_10002(arg_26_0) do
				...
				var_26_0 = var_26_0 + var_0(var_26_1) + var_26_1
			end
		...
		return function(arg_27_0)
			...
			return var_25_0 + var_0(var_27_0) + var_27_0
		end
	end
...
_SignedVarintSize = var_0_10013

local var_0_43 = var_10(var_0_41, var_0_42, var_0_10013)
...
local var_0_46 = var_10(var_0_44, var_0_45, var_0_10013)
...
_VarintSize = var_0_10013

local var_0_49 = var_10(var_0_47, var_0_48, var_0_10013)
...
local var_0_52 = var_10(var_0_50, var_0_51, var_0_10013)
...
local var_0_55 = var_10(var_0_53, var_0_54, var_0_10013, var_0_1.ZigZagEncode32)
...
local var_0_58 = var_10(var_0_56, var_0_57, var_0_10013, var_0_1.ZigZagEncode64)
