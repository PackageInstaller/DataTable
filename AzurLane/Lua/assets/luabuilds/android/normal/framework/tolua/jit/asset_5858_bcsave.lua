...
var_1(var_0_0.version_num == 4, "LuaJIT core/library version mismatch")

require = var_1

local var_0_1 = var_1("bit")
...
local function var_0_6(arg_4_0, arg_4_1)
	...
	return var_4_0(var_1_10003.open(arg_4_0, arg_4_1))
end
...
local function var_0_11(arg_6_0)
	...
	local var_6_1 = var_6_0(var_1_10002.lower(arg_6_0), "%.(%a+)$")
	local var_6_2
...
local function var_0_12(arg_7_0)
	...
	var_7_0(var_1_10002.match(arg_7_0, "^[%w_.%-]+$"), "bad module name")
...
local function var_0_16(arg_11_0, arg_11_1, arg_11_2)
	...
	if arg_11_0.type == "c" then
		...
		var_11_2(var_11_1, var_1_10006.format("#ifdef _cplusplus\nextern \"C\"\n#endif\n#ifdef _WIN32\n__declspec(dllexport)\n#endif\nconst unsigned char %s%s[] = {\n", var_0_2, arg_11_0.modname))
	else
	...
	for iter_11_0 = 1, #arg_11_2 do
		...
		string = var_1_10012
		var_11_7 = var_11_7 + #var_1_10011(var_1_10012.byte(arg_11_2, iter_11_0)) + 1

		if 78 < var_11_7 then
			local var_11_8 = var_11_0

			var_1_10012 = var_11_0.write
			table = var_14

			var_1_10012(var_11_8, var_14.concat(var_11_5, ",", 1, var_11_6), ",\n")

			var_1_10012 = 0
			var_11_7 = #var_1_10011 + 1
			var_11_6 = var_1_10012
		end

		var_11_5[var_11_6 + 1] = var_1_10011
	end

	local var_11_9 = var_0_14
	local var_11_10 = var_11_0
	local var_11_11 = arg_11_1

	table = iter_11_0

	var_11_9(var_11_10, var_11_11, iter_11_0.concat(var_11_5, ",", 1, var_11_6) .. "\n};\n")
...
local function var_0_17(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if arg_12_0.os == "bsd" or arg_12_0.os == "other" then
		...
		local var_12_8 = var_12(var_1_10013.open("/bin/ls", "rb"))
...
local function var_0_20(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_0, var_21_1 = var_1_10003(var_1_10004, "ffi")
...
local function var_0_21(arg_22_0, arg_22_1)
	...
	var_3("jit.bc").dump(var_22_0, var_0_6(arg_22_1, "w"), true)
...
local function var_0_22(arg_23_0, arg_23_1, arg_23_2)
	...
	local var_23_1 = var_4.dump(var_23_0, arg_23_0.strip)
...
local function var_0_23(...)
	...
	while var_24_1 <= #var_24_0 do
		...
		if var_5(var_24_4) == "string" then
			string = var_5

			if var_5.sub(var_24_4, 1, 1) == "-" and var_24_4 ~= "-" then
				table = var_5

				var_5.remove(var_24_0, var_24_1)
				...
				for iter_24_0 = 2, #var_24_4 do
					...
					if var_1_10009.sub(var_24_4, iter_24_0, iter_24_0) == "l" then
						var_24_2 = true
					elseif var_1_10009 == "s" then
						var_24_3.strip = true
					elseif var_1_10009 == "g" then
						...
						if var_1_10009 == "e" then
							...
							loadstring = var_11
							var_24_0[1] = var_24_5(var_11(var_24_0[1]))
						elseif var_1_10009 == "n" then
							local var_24_6 = var_0_12

							table = var_11
							var_24_3.modname = var_24_6(var_11.remove(var_24_0, var_24_1))
						elseif var_1_10009 == "t" then
							local var_24_7 = var_0_10

							table = var_11
							var_24_3.type = var_24_7(var_11.remove(var_24_0, var_24_1), var_0_7, "file type")
						elseif var_1_10009 == "a" then
							local var_24_8 = var_0_10

							table = var_11
							var_24_3.arch = var_24_8(var_11.remove(var_24_0, var_24_1), var_0_8, "architecture")
						elseif var_1_10009 == "o" then
							local var_24_9 = var_0_10

							table = var_11
							var_24_3.os = var_24_9(var_11.remove(var_24_0, var_24_1), var_0_9, "OS name")
						else
							var_0_3()
						end
					end
