...
local var_0_1 = var_1("jit.profile")
...
local function var_0_22(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	for iter_3_0 in var_0_10004(arg_3_0) do
...
local function var_0_23(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_0_10004(arg_5_0) do
		...
		if var_5_2 >= var_0_12 then
			...
			var_12[var_0_10006(var_5_4)] = var_0_13 and iter_5_1 or var_5_2
		end
	end
	...
	if var_0_13 then
		local var_5_7 = var_0.max(5, var_0.ceil(var_0.log10(var_5_1)))

		var_5_5 = "%" .. var_5_7 .. "d | %s\n"

		local var_5_8 = " "

		var_5_6 = var_7.rep(var_5_8, var_5_7) .. " | %s\n"
	end

	local var_5_9 = var_0_16

	for iter_5_2, iter_5_3 in var_0_10005(var_5_0) do
		local var_5_10 = iter_5_3

		if iter_5_3.byte(var_5_10) == 40 or var_12 == 91 then
			local var_5_11 = var_0_8

			var_5_10.write(var_5_11, var_0_5("\n====== %s ======\n[Cannot annotate non-file]\n", iter_5_3))
		...
		local var_5_12, var_5_13 = var_5_10.open(iter_5_3)

		if not var_5_12 then
			local var_5_14 = var_0_8

			var_15.write(var_5_14, var_0_5("====== ERROR: %s: %s\n", iter_5_3, var_5_13))

			break
		end

		local var_5_15 = var_0_8

		var_15.write(var_5_15, var_0_5("\n====== %s ======\n", iter_5_3))

		local var_5_16 = var_5_0[iter_5_3]
		local var_5_17 = 1
		local var_5_18 = false

		if var_5_9 ~= 0 then
			for iter_5_4 = 1, var_5_9 do
				if var_5_16[iter_5_4] then
					var_5_18 = true

					local var_5_19 = var_0_8

					var_22.write(var_5_19, "@@ 1 @@\n")
		...
		for iter_5_5 in var_5_12:lines() do
			if iter_5_5:byte() == 27 then
				local var_5_20 = var_0_8

				var_22.write(var_5_20, "[Cannot annotate bytecode file]\n")

				break
			end

			local var_5_21 = var_5_16[var_5_17]

			if var_5_9 ~= 0 then
				local var_5_22 = var_5_16[var_5_17 + var_5_9]

				if var_5_18 then
					if var_5_22 then
						var_5_18 = var_5_17 + var_5_9
					elseif var_5_21 then
						var_5_18 = var_5_17
					elseif var_5_17 > var_5_18 + var_5_9 then
						var_5_18 = false
					end
				elseif var_5_22 then
					var_5_18 = var_5_17 + var_5_9

					local var_5_23 = var_0_8

					var_24.write(var_5_23, var_0_5("@@ %d @@\n", var_5_17))
				end
			...
			if var_5_21 then
				...
				var_23.write(var_5_24, var_0_5(var_5_5, var_5_21, iter_5_5))
			else
				local var_5_25 = var_0_8

				var_23.write(var_5_25, var_0_5(var_5_6, iter_5_5))
			end
...
local function var_0_26(arg_11_0, arg_11_1)
	...
	if arg_11_1 then
		if arg_11_1 ~= "-" or not var_0_6 then
			assert = var_1_10002
			io = var_1_10003
			var_1_10002 = var_1_10002(var_1_10003.open(arg_11_1, "w"))
		end
