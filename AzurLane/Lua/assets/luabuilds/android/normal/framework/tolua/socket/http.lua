...
local var_0_1 = var_1("socket.url")
...
local var_0_6 = var_0_10007("table")
...
function var_0_11.__index.sendrequestline(arg_12_0, arg_12_1, arg_12_2)
	...
	return var_12_1(var_5.send(var_12_2, var_12_0))
end
...
function var_0_11.__index.sendheaders(arg_13_0, arg_13_1)
	...
	var_13_3(var_5.send(var_13_4, var_13_1))
...
function var_0_11.__index.receivestatusline(arg_15_0)
	...
	if var_15_0(var_2.receive(var_15_1, 5)) ~= "HTTP/" then
		return nil, var_1
	end

	local var_15_2 = arg_15_0.try
	local var_15_3 = arg_15_0.c
	local var_15_4 = var_15_2(var_3.receive(var_15_3, "*l", var_1))
