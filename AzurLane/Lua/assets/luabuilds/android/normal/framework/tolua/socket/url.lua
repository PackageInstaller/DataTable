...
local var_0_1 = var_0_10002("table")

require = var_3

local var_0_2 = var_3("socket")
...
local var_0_4 = (function(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_0.ipairs(arg_3_0) do
...
function var_0_3.unescape(arg_6_0)
	return (var_0_0.gsub(arg_6_0, "%%(%x%x)", function(arg_7_0)
		return var_0_0.char(var_0.tonumber(arg_7_0, 16))
	end))
end
...
function var_0_3.parse(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_0.pairs(arg_12_1 or var_12_0) do
...
function var_0_3.absolute(arg_22_0, arg_22_1)
	...
	if var_0.type(arg_22_0) == "table" then
		var_22_0 = arg_22_0
