...
local var_0_1 = var_12("protobuf.wire_format")

require = var_13

local var_0_2 = var_13("protobuf.type_checkers")

require = var_14

local var_0_3 = var_14("protobuf.encoder")

require = var_15

local var_0_4 = var_15("protobuf.decoder")

require = var_16

local var_0_5 = var_16("protobuf.listener")

require = var_17

local var_0_6 = var_17("protobuf.containers")

require = var_18

local var_0_7 = var_18("protobuf.descriptor").FieldDescriptor

require = var_0_10020

local var_0_8 = var_0_10020("protobuf.text_format")

module = var_21

var_21("protobuf.protobuf")
...
local function var_0_31(arg_32_0)
	function arg_32_0._member.RegisterExtension(arg_33_0)
		...
		if arg_32_0._extensions_by_number[arg_33_0.number] == nil then
			...
			actual_handle = var_2_10005

			var_33_0(var_33_1(var_33_2, var_33_3, var_2_10005.full_name, arg_32_0._descriptor.full_name, arg_33_0.number))
		end
...
local function var_0_37(arg_39_0, arg_39_1)
	function arg_39_1._member.ListFields(arg_40_0)
		return (function(arg_41_0)
			...
			sortFunc = var_3_10003

			local var_41_1, var_41_2, var_41_3 = var_3_10001(var_41_0, var_3_10003)
			...
			if iter_74_2.cpp_type == var_0_7.CPPTYPE_MESSAGE then
				...
				if iter_74_2.label == var_0_7.LABEL_REPEATED then
					for iter_74_4, iter_74_5 in var_0_10004(iter_74_3) do
						...
						local var_74_6 = var_74_5(var_2_10013, var_2_10014, iter_74_4)
						local var_74_7 = prefix

						var_2_10013 = iter_74_5

						local var_74_8 = iter_74_5.FindInitializationErrors(var_2_10013)
						local var_74_9 = sub_errors
						local var_74_10 = var_0_10004

						sub_errors = var_2_10013

						for iter_74_6, iter_74_7 in var_74_10(var_2_10013) do
							local var_74_11 = #var_74_0 + 1

							prefix = var_2_10018
							var_74_0[var_74_11] = var_2_10018 .. iter_74_7
						end
					end
				else
					name = var_7

					local var_74_12 = var_7 .. "."
					local var_74_13 = prefix
					local var_74_14 = iter_74_3
					local var_74_15 = iter_74_3.FindInitializationErrors(var_74_14)
					local var_74_16 = sub_errors
					local var_74_17 = var_0_10004

					sub_errors = var_74_14

					for iter_74_8, iter_74_9 in var_74_17(var_74_14) do
						local var_74_18 = #var_74_0 + 1

						prefix = var_2_10013
						var_74_0[var_74_18] = var_2_10013 .. iter_74_9
					end
				end
			end
		end
