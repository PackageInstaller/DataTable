...
function var_0_10011.start(arg_1_0, ...)
	...
	if var_0_1() == nil then
		...
		local function var_1_5()
			...
			local var_2_2, var_2_3 = var_2_0(var_2_1, var_2(var_1_3))

			table = var_2

			var_2.insert(var_0_5, var_1_4)
...
function var_0_10011.wait(arg_3_0, arg_3_1, ...)
	...
	local function var_3_2()
		...
		local var_4_2, var_4_3 = var_4_0(var_4_1, var_2(var_3_0))
...
function var_0_10011.step(arg_5_0, arg_5_1, ...)
	...
	local function var_5_2()
		...
		local var_6_2, var_6_3 = var_6_0(var_6_1, var_2(var_5_0))

		table = var_2

		var_2.insert(var_0_5, var_5_1)
