...
function var_0_0.NewHex(arg_13_0)
	...
	for iter_13_0 = 1, 4 do
		local var_13_1 = iter_13_0 + iter_13_0
		...
		if #arg_13_0 < var_13_1 then
			...
			tonumber = var_13_1
			string = var_7
			var_13_0[iter_13_0] = var_13_1(var_7.sub(arg_13_0, iter_13_0 + iter_13_0 - 1, iter_13_0 + iter_13_0), 16) / 255
		end
	end

	local var_13_2 = var_0_0.New

	unpack = var_3

	return var_13_2(var_3(var_13_0))
end
