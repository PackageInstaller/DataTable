local function var_0_0(arg_1_0, arg_1_1)
	...
	local var_1_0 = var_3(arg_1_0) == "table" and arg_1_0.__ctype == 2
	...
	for iter_1_0, iter_1_1 in var_4(arg_1_0) do
		if var_1_0 and iter_1_0 == "class" then
			...
			Clone_Copy = var_10
			var_2[var_1_10009] = var_10(iter_1_1, arg_1_1)
		end
	end
	...
	return var_4(var_1_1, var_6(arg_1_0))
end
...
local function var_0_4(arg_3_0, arg_3_1)
	...
	if var_3_0 == "function" or arg_3_1 and arg_3_1.__ctype == 1 then
		...
		function var_3_1.New(...)
			...
			for iter_5_0, iter_5_1 in var_1(var_3_1) do
...
local function var_0_6(arg_8_0, arg_8_1)
	...
	while var_8_0 ~= nil do
		if var_8_0 == arg_8_1 then
			...
			var_1_10004 = var_8_0 ~= var_1_10004(var_8_0)

			var_3(var_1_10004, "Loop metatable")

			getmetatable = var_3
			var_8_0 = var_3(var_8_0)
		end
	end
...
local function var_0_18(arg_16_0, arg_16_1)
	...
	if var_4(arg_16_0) == "table" then
		...
		if var_16_2 == "" then
			...
			var_1_10006 = var_16_0
			var_16_8 = "{ }\t("
			tostring = iter_16_0
			var_16_1 = var_16_7 .. var_1_10006 .. var_16_8 .. iter_16_0(arg_16_0) .. ")"
		else
			if arg_16_1 > 0 then
				local var_16_9 = var_16_1

				var_1_10006 = "\t("
				tostring = var_16_8
				var_16_1 = var_16_9 .. var_1_10006 .. var_16_8(arg_16_0) .. ")\n"
			end
		...
		local var_16_12 = var_1_10006(arg_16_0)
		local var_16_13 = "\t("

		type = iter_16_0
		var_16_1 = var_16_10 .. var_16_11 .. var_16_12 .. var_16_13 .. iter_16_0(arg_16_0) .. ")"
	end
