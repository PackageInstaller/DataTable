...
local function var_0_8(arg_5_0, arg_5_1)
	...
	local var_5_0 = var_1_10002(var_1_10003.ship_level, arg_5_1)

	ShipRarity = var_3

	if arg_5_0 >= var_3.SSR then
...
var_0(var_0_10001.user_level)

prepareLevelExpConfig = var_0
pg = var_1

var_0(var_1.ship_level)

prepareLevelExpConfig = var_0
pg = var_1

var_0(var_1.ship_level, "exp_ur")
