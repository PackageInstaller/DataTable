...
function var_0_0.InitFileMap(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10001(arg_5_0) do
		...
		var_7("count " .. var_5_0.Count)

		for iter_5_2 = 0, var_5_0.Count - 1 do
			local var_5_1 = var_5_0
			local var_5_2 = var_5_0.get_Item(var_5_1, iter_5_2)

			string = var_5_1

			if var_5_1.match(var_5_2, ".*\\(.[_a-zA-Z][_a-zA-Z0-9]*)%.lua") ~= nil then
				local var_5_3

				if var_0_0.FileMap[var_12] == nil then
					var_5_3 = var_0_0.FileMap
					var_5_3[var_12] = {}
				end

				string = var_5_3

				local var_5_4 = var_5_3.sub(var_5_2, #iter_5_1 + 2, #var_5_2 - 4)

				string = var_14

				local var_5_5 = var_14.gsub(var_5_4, "\\", ".")
				local var_5_6 = var_0_0.LuaPathToSysPath

				SysPath = var_15
				var_5_6[var_5_5] = var_15
				table = var_5_6

				var_5_6.insert(var_0_0.FileMap[var_12], {
					SysPath = var_5_2,
					LuaPath = var_5_5
				})
			end
		...
		local var_5_7 = var_0_0.NotifyFunc
		local var_5_8 = "load module count: "

		table = var_9

		var_5_7(var_5_8 .. var_9.getn(var_0_0.FileMap))
	end
...
function var_0_0.ErrorHandle(arg_29_0)
	...
	var_29_0(var_29_1 .. var_1_10003(arg_29_0))
			...
			if var_1(arg_33_0) == "table" then
				...
				if var_33_0(arg_33_0) == "function" then
					...
					if var_33_1(arg_33_0) == "table" then
						...
						var_33_3(var_2.getmetatable(arg_33_0))
...
function var_0_0.ReplaceOld(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4)
	...
	if var_34_0 == var_6(arg_34_1) then
		type = var_34_0
...
function var_0_0.HotUpdateCode(arg_35_0, arg_35_1)
	...
	if var_1_10002.loaded[arg_35_0] ~= nil then
		...
		if var_35_0 then
			...
			var_0_0.ReplaceOld(var_2, var_35_1, arg_35_0, "Main", "")
			...
			for iter_35_0, iter_35_1 in var_5(var_0_0.RequireMap) do
				...
				local var_35_2 = var_35_2.loaded[iter_35_0]

				var_0_0.ReplaceOld(var_35_2, iter_35_1, iter_35_0, "Main_require", "")
			end
	...
	elseif var_0_0.OldCode[arg_35_1] == nil then
		...
		local var_35_3 = var_0_0.OldCode

		io = var_4
		var_35_3[arg_35_1] = var_4.read("*all")
		io = var_35_3

		local var_35_4 = var_35_3.input()

		var_3.close(var_35_4)
	end
		...
		if var_37_0(arg_37_0) == "function" then
			...
			if var_2(arg_37_0) == "table" then
				...
				for iter_37_0, iter_37_1 in var_2(arg_37_0) do
					...
					var_37_1(var_37_2, var_2_10009(iter_37_0) .. "__key", " HU.ResetENV ", arg_36_3 .. "    ")
					...
					var_37_3(var_37_4, var_2_10009(iter_37_0), " HU.ResetENV ", arg_36_3 .. "    ")
				end
			end
		end
...
function var_0_0.UpdateUpvalue(arg_39_0, arg_39_1, arg_39_2, arg_39_3, arg_39_4)
	...
	for iter_39_1 = var_39_4, var_8.huge do
		...
		if var_39_1[var_1_10011] then
			...
			type = var_1_10014
			var_1_10014 = var_1_10014(var_39_6)
			type = var_15

			if var_1_10014 ~= var_15(var_39_5) then
				debug = var_1_10014

				var_1_10014.setupvalue(arg_39_1, iter_39_1, var_39_6)
			else
				type = var_1_10014

				if var_1_10014(var_39_6) == "function" then
					var_0_0.UpdateOneFunction(var_39_6, var_39_5, var_1_10011, nil, "HU.UpdateUpvalue", arg_39_4 .. "    ")
				else
					type = var_1_10014

					if var_1_10014(var_39_6) == "table" then
...
function var_0_0.UpdateOneFunction(arg_40_0, arg_40_1, arg_40_2, arg_40_3, arg_40_4, arg_40_5)
	...
	local var_40_1 = var_40_0 .. var_7(arg_40_1)
	...
	local var_40_2 = var_8.setfenv
	local var_40_3 = arg_40_1

	getfenv = var_10

	if var_7(var_40_2, var_40_3, var_10(arg_40_0)) then
...
function var_0_0.UpdateAllFunction(arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
	...
	local var_41_1 = var_41_0 .. var_6(arg_41_1)
	...
	for iter_41_0, iter_41_1 in var_6(arg_41_1) do
		...
		type = var_1_10012
		var_1_10012 = var_1_10012(iter_41_1)
		type = var_13

		if var_1_10012 == var_13(var_41_2) then
			type = var_1_10012

			if var_1_10012(iter_41_1) == "function" then
				var_0_0.UpdateOneFunction(var_41_2, iter_41_1, iter_41_0, arg_41_0, "HU.UpdateAllFunction", arg_41_4 .. "    ")
			else
				type = var_1_10012

				if var_1_10012(iter_41_1) == "table" then
		...
		elseif var_41_2 == nil then
			...
			if var_1_10012(iter_41_1) == "function" then
				...
				if var_1_10012(var_13, iter_41_1, var_0_0.ENV) then
	...
	local var_41_3 = var_6.getmetatable(arg_41_0)
	local var_41_4 = var_0_0.MetaMap[arg_41_1]

	type = var_8

	if var_8(var_41_3) == "table" then
		type = var_8

		if var_8(var_41_4) == "table" then
			var_0_0.UpdateAllFunction(var_41_3, var_41_4, arg_41_2 .. "'s Meta", "HU.UpdateAllFunction", arg_41_4 .. "    ")
		end
	end
