...
function var_0_1.notifyObservers(arg_5_0, arg_5_1)
	if arg_5_0.observerMap[arg_5_1:getName()] ~= nil then
		...
		for iter_5_0, iter_5_1 in var_4(var_5_0) do
			table = var_1_10009
...
function var_0_1.registerMediator(arg_7_0, arg_7_1)
	...
	if #arg_7_1:listNotificationInterests() > 0 then
		local var_7_0 = var_0_0.New(arg_7_1.handleNotification, arg_7_1)

		pairs = var_4

		for iter_7_0, iter_7_1 in var_4(var_2) do
			arg_7_0:registerObserver(iter_7_1, var_7_0)
		end
	end
...
function var_0_1.removeMediator(arg_9_0, arg_9_1)
	if arg_9_0.mediatorMap[arg_9_1] ~= nil then
		local var_9_0 = var_2
		local var_9_1 = var_2.listNotificationInterests(var_9_0)
