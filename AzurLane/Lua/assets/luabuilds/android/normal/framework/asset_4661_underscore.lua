...
function var_0.funcs.invoke(arg_19_0, arg_19_1, ...)
	...
	var_0.funcs.each(arg_19_0, function(arg_20_0)
		...
		var_20_0(var_20_1, var_2_10003(var_19_0))
...
function var_0.funcs.is_equal(arg_45_0, arg_45_1, arg_45_2)
	...
	if var_45_0 ~= var_4(arg_45_1) then
		return false
	end
	...
	for iter_45_0, iter_45_1 in var_1_10007(arg_45_0) do
...
function var_0.funcs.compose(...)
	local function var_46_0(arg_47_0, ...)
		if #arg_47_0 > 1 then
			...
			return var_47_0(var_47_1(var_2_10003.rest(arg_47_0), ...))
		else
			return arg_47_0[1](...)
		end
