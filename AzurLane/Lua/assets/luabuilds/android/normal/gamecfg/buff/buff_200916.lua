		...
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_12_0)
					...
					return var_1_10001(var_12_0, var_12_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 90, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_14_0)
					...
					return var_1_10001(var_14_0, var_14_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 7, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_16_0)
					...
					return var_1_10001(var_16_0, var_16_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 180, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_18_0)
					...
					return var_1_10001(var_18_0, var_18_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 225, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_20_0)
					...
					return var_1_10001(var_20_0, var_20_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 14, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_21_0)
					...
					local var_21_1 = var_1_10003.sin(var_21_0) * 5
					local var_21_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_21_1, var_21_2, var_1_10005.cos(var_21_0) * 5)
				end,
				rotationFun = function(arg_22_0)
					...
					return var_1_10001(var_22_0, var_22_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 315, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_23_0)
					...
					local var_23_1 = var_1_10003.sin(var_23_0) * 5
					local var_23_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_23_1, var_23_2, var_1_10005.cos(var_23_0) * 5)
				end,
				rotationFun = function(arg_24_0)
					...
					return var_1_10001(var_24_0, var_24_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_25_0)
					...
					local var_25_1 = var_1_10003.sin(var_25_0) * 5
					local var_25_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_25_1, var_25_2, var_1_10005.cos(var_25_0) * 5)
				end,
				rotationFun = function(arg_26_0)
					...
					return var_1_10001(var_26_0, var_26_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 45, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_27_0)
					...
					local var_27_1 = var_1_10003.sin(var_27_0) * 8
					local var_27_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_27_1, var_27_2, var_1_10005.cos(var_27_0) * 8)
				end,
				rotationFun = function(arg_28_0)
					...
					return var_1_10001(var_28_0, var_28_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 90, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_29_0)
					...
					local var_29_1 = var_1_10003.sin(var_29_0) * 8
					local var_29_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_29_1, var_29_2, var_1_10005.cos(var_29_0) * 8)
				end,
				rotationFun = function(arg_30_0)
					...
					return var_1_10001(var_30_0, var_30_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 22, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				rotationFun = function(arg_32_0)
					...
					return var_1_10001(var_32_0, var_32_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 210, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_33_0)
					...
					local var_33_1 = var_1_10003.sin(var_33_0) * 8
					local var_33_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_33_1, var_33_2, var_1_10005.cos(var_33_0) * 8)
				end,
				rotationFun = function(arg_34_0)
					...
					return var_1_10001(var_34_0, var_34_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 14, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_35_0)
					...
					local var_35_1 = var_1_10003.sin(var_35_0) * 8
					local var_35_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_35_1, var_35_2, var_1_10005.cos(var_35_0) * 8)
				end,
				rotationFun = function(arg_36_0)
					...
					return var_1_10001(var_36_0, var_36_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 330, 0)
				end
			}
		},
		{
			...
			arg_list = {
				...
				centerPosFun = function(arg_37_0)
					...
					local var_37_1 = var_1_10003.sin(var_37_0) * 8
					local var_37_2 = 0.75

					math = var_1_10005

					return var_1_10002(var_37_1, var_37_2, var_1_10005.cos(var_37_0) * 8)
				end,
				rotationFun = function(arg_38_0)
					...
					return var_1_10001(var_38_0, var_38_1 * var_1_10004.Battle.BattleConfig.SHIELD_ROTATE_CONST + 30, 0)
				end
			}
		}
	}
