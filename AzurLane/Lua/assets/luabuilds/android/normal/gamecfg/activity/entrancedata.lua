...
function var_0_1.isShow()
	...
	var_1_2 = var_1_1(var_1_0, var_1_10002.ACTIVITY_TYPE_SUMMARY) and not var_0:isEnd()
...
function var_0_3.isShow()
	...
	var_2_2 = var_2_1(var_2_0, var_1_10002.ACTIVITY_PRAY_POOL) and not var_0:isEnd()
...
function var_0_4.isShow()
	...
	var_3_2 = var_3_1(var_3_0, var_1_10002.BUILD_BISMARCK_ID) and not var_0:isEnd()
...
function var_0_7.isShow()
	...
	var_4_2 = var_4_1(var_4_0, var_1_10002.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2) and not var_0:isEnd()
...
function var_0_7.isTip()
	...
	if not var_5_1(var_5_0, var_1_10002.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2) then
		return
	end

	local var_5_2 = false

	if var_0:checkBattleTimeInBossAct() then
		var_5_2 = var_0.data2 ~= 1
	else
		local var_5_3 = var_0
		local var_5_4 = var_0.GetBindPtActID(var_5_3)

		getProxy = var_5_3
		ActivityProxy = var_1_10005

		local var_5_5 = var_5_3(var_1_10005)

		if var_4.getActivityById(var_5_5, var_5_4) then
			ActivityBossPtData = var_5_5

			local var_5_6 = var_5_5.New(var_4)

			var_5_2 = var_5.CanGetAward(var_5_6)
		end
	end
...
function var_0_9.isShow()
	...
	var_6_2 = var_6_1(var_6_0, var_1_10002.ACTIVITY_TYPE_COLORING_ALPHA) and not var_0:isEnd()
...
function var_0_11.isTip()
	...
	local var_10_1 = var_1_10001(var_1_10002)
	...
	if var_10_3.any(var_10_4, function(arg_11_0)
		local var_11_0 = arg_11_0
		local var_11_1 = arg_11_0.getConfig(var_11_0, "genre")

		ShopArgs = var_11_0

		local var_11_3

		if var_11_1 == var_11_0.SkinShopTimeLimit then
			local var_11_2 = var_0

			var_11_3 = not var_1.hasSkin(var_11_2, arg_11_0:getSkinId())
		else
			var_11_3 = false
		end
...
function var_0_14.isShow()
	...
	var_12_2 = var_12_1(var_12_0, var_1_10002.BISMARCK_PT_SHOP_ID) and not var_0:isEnd()
...
function var_0_17.isShow()
	...
	var_13_2 = var_13_1(var_13_0, var_1_10002.BILIBILI_PT_SHOP_ID) and not var_0:isEnd()
...
function var_0_20.isShow()
	...
	var_14_2 = var_14_1(var_14_0, var_1_10002.FRANCE_RE_BUILD) and not var_0:isEnd()
...
function var_0_23.isShow()
	...
	var_15_2 = var_15_1(var_15_0, var_1_10002.FRANCE_RE_PT_SHOP) and not var_0:isEnd()
...
function var_0_28.isShow()
	...
	var_17_2 = var_17_1(var_17_0, var_1_10002.SUMMER_FEAST_ID) and not var_0:isEnd()
...
function var_0_30.isShow()
	...
	var_18_2 = var_18_1(var_18_0, var_1_10002.NEWYEAR_ACTIVITY) and not var_0:isEnd()
...
var_0_32.data = var_2({}, {
	__index = function(arg_19_0, arg_19_1)
		if arg_19_1 == 1 then
			...
			if var_19_1(var_19_0, var_1_10004.LANTERNFESTIVAL) and not var_2:isEnd() then
...
function var_0_32.isShow()
	...
	var_20_2 = var_20_1(var_20_0, var_1_10002.LANTERNFESTIVAL) and not var_0:isEnd()
...
function var_0_32.isTip()
	...
	if var_21_1(var_21_0, var_1_10002.LANTERNFESTIVAL) then
...
function var_0_33.isShow()
	...
	local var_22_0 = var_1_10000(var_1_10001)
	local var_22_1 = var_0.getActivitiesByType

	ActivityConst = var_1_10002

	local var_22_2 = var_22_1(var_22_0, var_1_10002.ACTIVITY_TYPE_MINIGAME)

	_ = var_22_0

	return var_22_0.detect(var_22_2, function(arg_23_0)
...
function var_0_33.isTip()
	...
	local var_24_2 = var_24_1(var_24_0, var_1_10002.ACTIVITY_TYPE_MINIGAME)

	_ = var_24_0

	if var_24_0.detect(var_24_2, function(arg_25_0)
		...
		if not var_1.isEnd(var_24_3) then
			...
			var_24_5 = var_2.GetHubByHubId(var_24_4, var_1:getConfig("config_id")) and var_3.id == 7 and var_3.count > 0
...
function var_0_34.isShow()
	...
	local var_26_0 = var_0(var_1_10001)
	...
	var_26_2 = var_26_1(var_26_0, var_1_10002.ACTIVITY_TYPE_AIRFIGHT_BATTLE) and not var_0:isEnd()
...
function var_0_34.isTip()
	...
	if var_27_1(var_27_0, var_1_10002.ACTIVITY_TYPE_AIRFIGHT_BATTLE) and not var_0:isEnd() then
...
function var_0_36.isShow()
	...
	var_28_2 = var_28_1(var_28_0, var_1_10002.DOA_MEDAL_ACT_ID) and not var_0:isEnd()
...
function var_0_36.isTip()
	...
	local var_29_0 = var_1_10000(var_1_10001)
	local var_29_1 = var_0.getActivityById

	ActivityConst = var_1_10002

	local var_29_2 = var_29_1(var_29_0, var_1_10002.DOA_MEDAL_ACT_ID)

	Activity = var_29_0

	return var_29_0.IsActivityReady(var_29_2)
end
...
function var_0_38.isShow()
	...
	local var_30_1 = var_1_10001(var_1_10002)
	local var_30_2

	var_30_2 = var_1.getMetaProgressVOByID(var_30_1, var_30_0) and var_1:isInAct()
...
function var_0_38.isTip()
	...
	local var_31_1 = var_1_10001(var_1_10002)
	...
	if var_1.metaPtData then
		var_1_10004 = var_1.metaPtData
		var_31_3 = var_3.CanGetAward(var_1_10004)
	end
	...
	if var_31_3 == false then
		...
		local var_31_4 = var_3(var_1_10004)
...
function var_0_40.isTip()
	...
	return var_33_0 ~= var_1.gameset.permanent_mark.description
end
		...
		if var_1_10000.IsAndroid then
			...
			if var_1_10000.GetCHPackageType() ~= 1 then
				...
				if var_1_10000.IsIOS() then
					...
					var_1_10000 = var_1_10000(var_34_0, var_1_10002("WeChat_Mini_Program")[1])
...
function var_0_42.isShow()
	...
	var_36_2 = var_36_1(var_36_0, var_1_10002.OTHER_WORLD_TERMINAL_BATTLE_ID) and not var_0:isEnd()
...
function var_0_42.isTip()
	...
	local var_37_2 = var_37_1(var_37_0, var_1_10002.OTHER_WORLD_TERMINAL_BATTLE_ID)
...
function var_0_44.isShow()
	...
	local var_38_0 = var_1_10000(var_1_10001)
	...
	var_38_2 = var_38_1(var_38_0, var_1_10002.CULTIVATING_PLANT_ID) and not var_0:isEnd()
...
function var_0_45.isShow()
	...
	var_40_1 = var_0.getActivityById(var_40_0, 1) and not var_0:isEnd()
...
function var_0_45.isTip()
	...
	return var_41_0.IsActivityReady(var_41_1)
end
...
function var_0_47.isShow()
	...
	local var_42_0 = var_1_10000(var_1_10001)
	local var_42_1

	var_42_1 = var_0.getActivityById(var_42_0, 18) and not var_0:isEnd()
...
function var_0_47.isTip()
	...
	local var_43_0 = var_1_10000(var_1_10001)
	local var_43_1 = var_0.getActivityById(var_43_0, 18)

	getProxy = var_43_0
	ActivityProxy = var_2

	local var_43_2 = var_43_0(var_2)
	...
	if not var_43_2.IsActivityReady(var_43_1) then
		Activity = var_43_4
