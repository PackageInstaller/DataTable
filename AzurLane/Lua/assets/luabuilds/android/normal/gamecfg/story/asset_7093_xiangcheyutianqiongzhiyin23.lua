return {
	id = "XIANGCHEYUTIANQIONGZHIYIN23",
	mode = 2,
	fadeOut = 1.5,
	scripts = {
		{
		...
		},
		{
			...
			options = {
				{
					content = "确认，我接受海伦娜的提案",
					flag = 100
				},
				{
					content = "还是，拒绝这项提案比较好……",
					flag = 200
				}
			}
		},
		...
		{
			side = 2,
			jumpto = "XIANGCHEYUTIANQIONGZHIYIN23-1",
			blackBg = true,
			dir = 1,
			optionFlag = 100,
			say = "",
		...
		{
			side = 2,
			jumpto = "XIANGCHEYUTIANQIONGZHIYIN23-2",
			blackBg = true,
			dir = 1,
			optionFlag = 200,
			say = "",
