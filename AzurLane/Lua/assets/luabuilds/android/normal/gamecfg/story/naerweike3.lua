return {
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "而各位也知道，前天，萤火虫遭遇了铁血的{namecode:425}号，发现对方前往纳尔维克的舰队。昨天，我们也跟随声望小姐在纳尔维克附近和沙恩姐妹交手……这可能会是一次艰巨的任务。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = 1,
			actor = 201200,
			say = "不会的。{namecode:425}号被萤火虫重创，沙恩姐妹和声望小姐交手后逃离的方向也不是纳尔维克方向……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			dir = -1,
			actor = 201160,
			say = "唔，确实……萤火虫在和{namecode:425}号交手前也是先和两艘铁血驱逐级交手过，我们要面对的，恐怕也是她们吧。不愧是猎人，这样分析下来，感觉安心了很多呢！",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = -1,
			say = "不过…在和{namecode:425}号作战时，萤火虫以自己重伤的代价换来了对方的撤退……",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
