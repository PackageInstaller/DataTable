...
function var_0_1.GetRealId(arg_1_0)
	...
	local var_1_0 = var_1_10002.split

	tostring = var_1_10003

	return var_1_10001(var_1_0(var_1_10003(arg_1_0), "_")[1])
end
...
function var_0_1.GetUserId(arg_2_0)
	...
	local var_2_0 = var_1_10002.split

	tostring = var_1_10003

	return var_1_10001(var_2_0(var_1_10003(arg_2_0), "_")[2])
end
...
function var_0_1.SetRecommendList(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_0.ships) do
		...
		if var_8.any(arg_8_1, function(arg_9_0)
...
function var_0_1.GetShipByRealId(arg_19_0, arg_19_1, arg_19_2)
	...
	for iter_19_0, iter_19_1 in var_4(arg_19_0.ships) do
