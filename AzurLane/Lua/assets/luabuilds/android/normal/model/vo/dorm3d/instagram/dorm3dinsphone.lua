...
function var_0_1.GetDay(arg_13_0)
	...
	if var_13_0((var_2.GetServerTime(var_13_1) - arg_13_0.time) / 0) == 0 then
		i18n = var_13_2

		local var_13_2

		if not var_13_2("dorm3d_privatechat_visit_time_now") then
			i18n = var_13_2
			var_13_2 = var_13_2("dorm3d_privatechat_visit_time", var_1)
		end
