...
function var_0_1.IsFormualCanComposite(arg_15_0, arg_15_1, arg_15_2)
	...
	local function var_15_2(arg_16_0)
		...
		if not var_15_0[arg_16_0:GetConfigID()] then
			Clone = var_16_0
			var_16_0 = var_16_0(var_15_1[arg_16_0:GetConfigID()])
		end
	...
	local var_15_3 = var_1_10006.map(arg_15_0:GetCircleList(), function(arg_17_0)
	...
	if var_7.any(var_15_3, function(arg_18_0)
		if arg_18_0:GetLimitItemID() ~= 0 then
			local var_18_0

			if not var_15_0[var_1] then
				var_18_0 = var_15_1[var_1]
			end
	...
	local var_15_4 = var_7.bindConfigTable()

	local function var_15_5(arg_19_0)
		ipairs = var_2_10001

		for iter_19_0, iter_19_1 in var_2_10001(var_15_4.all) do
			local var_19_0

			if not var_15_0[iter_19_1] then
				var_19_0 = var_15_1[iter_19_1]
			end
	...
	AtelierFormulaCircle = var_1_10010
	var_15_6[1] = var_1_10010.TYPE.NORMAL
	AtelierFormulaCircle = var_10
	var_15_6[2] = var_10.TYPE.ANY
	AtelierFormulaCircle = var_10
	var_15_6[3] = var_10.TYPE.ELEMENT_CATEGORY
	AtelierFormulaCircle = var_10
	var_15_6[4] = var_10.TYPE.CATEGORY
	AtelierFormulaCircle = var_10
	var_15_6[5] = var_10.TYPE.ELEMENT
	AtelierFormulaCircle = var_10
	var_15_6[6] = var_10.TYPE.NONE
	ipairs = var_10

	for iter_15_0, iter_15_1 in var_10(var_15_6) do
		_ = var_1_10015

		if var_1_10015.any(var_15_3, function(arg_20_0)
