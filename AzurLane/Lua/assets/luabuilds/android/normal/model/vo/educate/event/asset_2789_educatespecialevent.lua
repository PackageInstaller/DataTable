...
function var_0_1.initTime(arg_8_0)
	...
	local var_8_1 = arg_8_0.getConfig(var_8_0, "date")

	EducateHelper = var_8_0
	arg_8_0.startTime, arg_8_0.endTime = var_8_0.CfgTime2Time(var_8_1)
...
function var_0_1.IsUnlockSite(arg_11_0)
	...
	local var_11_2 = arg_11_0.getConfig(var_11_1, "type_param")[1]

	getProxy = var_11_1
	EducateProxy = var_4

	local var_11_3 = var_11_1(var_4)

	return var_11_0(var_11_2, var_3.IsFirstGame(var_11_3))
end
...
function var_0_1.GetDiscountShopId(arg_21_0)
	...
	if arg_21_0:getConfig("type") == var_0_1.TYPE_BUBBLE_DISCOUNT then
		...
		var_21_1 = arg_21_0.getConfig(var_21_0, "type_param")[1]
		pg = var_21_0

		return var_21_0.child_site_option[var_21_1].param[1]
	end

	assert = var_21_1

	var_21_1(nil, "not discount type:" .. arg_21_0.id)
...
function var_0_1.InDiscountTime(arg_23_0, arg_23_1)
	...
	if arg_23_0:getConfig("type") == var_0_1.TYPE_BUBBLE_DISCOUNT then
		...
		local var_23_2 = var_23_0.GetTimeAfterWeeks(arg_23_1, var_23_1)

		EducateHelper = var_4

		return var_4.InTime(arg_23_1, arg_23_0.startTime, var_23_2)
	end
