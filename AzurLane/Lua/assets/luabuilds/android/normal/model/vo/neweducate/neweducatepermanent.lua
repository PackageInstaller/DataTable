...
function var_0_0.AddPolaroid(arg_17_0, arg_17_1)
	...
	if not var_3.contains(arg_17_0.unlockPolaroidGroups, var_17_0) then
		table = var_3
...
function var_0_0.InitSecretary(arg_45_0)
	...
	for iter_45_0, iter_45_1 in var_1(var_1_10002.secretary_special_ship.all) do
		pg = var_1_10006
...
function var_0_0.UpdateSecretaryIDs(arg_47_0, arg_47_1)
	...
	if arg_47_1 then
		...
		var_47_0 = var_1_10003(var_1_10004.GetAllUnlockSecretaryIds())
	end
	...
	if not var_1_10005.secretary_special_ship.get_id_list_by_tb_id[arg_47_0.id] then
		var_47_2 = {}
	end
	...
	for iter_47_0, iter_47_1 in var_1_10004(var_47_2) do
		...
		var_47_4[var_1_10014.SECRETARY_UNLCOK_TYPE_DEFAULT] = function()
			return
		end
		EducateConst = var_1_10014
		var_47_4[var_1_10014.SECRETARY_UNLCOK_TYPE_POLAROID] = function()
		...
		EducateConst = var_1_10014
		var_47_4[var_1_10014.SECRETARY_UNLCOK_TYPE_ENDING] = function()
		...
		EducateConst = var_1_10014
		var_47_4[var_1_10014.SECRETARY_UNLCOK_TYPE_SHOP] = function()
			if var_1_10010[1] then
				getProxy = var_0
				ShipSkinProxy = var_2_10001

				local var_51_0 = var_0(var_2_10001)
		...
		EducateConst = var_1_10014
		var_47_4[var_1_10014.SECRETARY_UNLCOK_TYPE_STORY] = function()
			if var_1_10010[1] then
				pg = var_0
				...
				local var_52_2 = var_2_10002.NewStoryMgr.GetInstance()

				if var_52_1(var_52_0, var_2.StoryId2StoryName(var_52_2, var_1_10010[1])) then
					table = var_0
