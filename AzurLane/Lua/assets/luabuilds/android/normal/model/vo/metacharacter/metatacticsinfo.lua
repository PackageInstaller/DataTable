...
function var_0_0.getTacticsStateForShow(arg_9_0)
	...
	local var_9_1 = arg_9_0.isAnyLearning(var_9_0)
	...
	if var_2.getShipById(var_9_2, arg_9_0.shipID) then
		local var_9_3 = var_2
		local var_9_4

		if not var_2.isAllMetaSkillLevelMax(var_9_3) then
			var_9_4 = false
		end

		if not var_9_1 and not var_9_4 then
			return var_0_0.States.LearnAble
		elseif var_9_1 then
			getProxy = var_9_3
			BayProxy = var_1_10005

			local var_9_5 = var_9_3(var_1_10005)
			local var_9_6 = var_4.getShipById(var_9_5, arg_9_0.shipID)

			if var_4.isSkillLevelMax(var_9_6, arg_9_0.curSkillID) then
				if not var_9_4 then
					getProxy = var_9_6
					BayProxy = var_6

					local var_9_7 = var_9_6(var_6)
					local var_9_8 = var_5.getShipById(var_9_7, arg_9_0.shipID)
					local var_9_9 = var_5.getGroupId(var_9_8)

					MetaCharacterConst = var_9_8

					if not var_9_8.isMetaTacticsRedTag(var_9_9) then
						return var_0_0.States.LearnAble
					end
				end
