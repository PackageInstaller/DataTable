...
local var_0_3 = var_2.activity_ins_chat_group
...
function var_0_1.SetBackgrounds(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_12_0(var_12_1) do
		...
		var_1_10007(var_12_2, var_1_10009.ship_skin_template[iter_12_1.id])
	end

	getProxy = var_2
	CollectionProxy = var_3

	local var_12_3 = var_2(var_3)
