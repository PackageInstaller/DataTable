...
function var_0_1.update(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_0.id and arg_2_0.id > 0 then
		...
		for iter_2_2, iter_2_3 in var_4(arg_2_0:getConfig("goods")) do
			...
			Goods = var_1_10013
			var_2_2[iter_2_3] = var_1_10011(var_2_3, var_1_10013.TYPE_SHAM_BATTLE)
		end
	end
...
function var_0_1.getRestDays(arg_4_0)
	...
	if arg_4_0:bindConfigTable()[arg_4_0.id] then
		pg = var_4_1
		var_4_1 = var_4_1.TimeMgr.GetInstance()
		pg = var_1_10004

		local var_4_2 = var_1_10004.TimeMgr.GetInstance()
		local var_4_3 = var_4.STimeDescS(var_4_2, var_4_1:GetServerTime(), "*t")

		var_4_0 = var_2.time[2] - var_4_3.day + 1
	end

	math = var_4_1

	return (var_4_1.max(var_4_0, 1))
end
