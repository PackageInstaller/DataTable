...
function var_0_1.IsUnlockByEnemyId(arg_16_0, arg_16_1)
	...
	if var_2.GetPreChapterId(var_16_0) ~= 0 then
		...
		var_16_4 = var_16_2(var_16_1, var_5.GetExpeditionId(var_16_3))
...
function var_0_1.CheckEntranceByIdx(arg_19_0, arg_19_1)
	if not arg_19_0:GetEnemyDataByFleetIdx(arg_19_1) then
		return false, "not exist enemy data, index: " .. arg_19_1
	end

	local var_19_0 = var_2
	...
	if not var_2.InTime(var_19_0) then
		...
		local var_19_2 = var_19_0("common_activity_end")
	...
	if not arg_19_0.IsUnlockByEnemyId(var_19_3, var_2.id) then
		local var_19_4 = false

		i18n = var_19_3

		local var_19_5 = var_19_3("adventure_unlock_tip")
