...
function var_0_1.getPowerTxt(arg_5_0)
	...
	elseif arg_5_0.type == var_0_1.TYPE_COLLECTION then
		...
		local var_5_0 = var_1(var_2)
		local var_5_1 = var_1.getCollectionTotal(var_5_0)

		string = var_5_0

		return var_5_0.format("%0.01f", arg_5_0.power / var_5_1 * 100) .. "%"
...
function var_0_1.getTitleWord(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0 = 1, 4 do
		...
		var_1_10008(var_6_1, var_1_10010("ranking_word_" .. var_0_1.typeInfo[arg_6_1].title_word[iter_6_0]))
	end
	...
	if arg_6_1 == var_0_1.TYPE_PT then
		...
		local var_6_2 = var_5(var_6)
		local var_6_3 = var_5.getActivityById(var_6_2, arg_6_2)
		local var_6_4 = var_4(var_5.getConfig(var_6_3, "config_id"))
...
function var_0_1.getActivityByRankType(arg_8_0, arg_8_1)
	...
	return var_8_0(var_3.getActivitiesByType(var_8_1, var_0_1.typeInfo[arg_8_1].act_type), function(arg_9_0)
