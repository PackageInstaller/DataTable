...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".VirtualBagActivity"))
...
function var_0_1.addVitemNumber(arg_15_0, arg_15_1, arg_15_2)
	...
	var_15_1(var_15_0, var_1_10005.New({
		configId = arg_15_1,
		count = arg_15_2
	}))
...
function var_0_1.InitAllFormulas(arg_19_0)
	...
	var_19_0(var_1_10002.activity_ryza_recipe.all, function(arg_20_0)
...
function var_0_1.AddFormulaUseCount(arg_23_0, arg_23_1, arg_23_2)
	...
	var_23_1(var_23_0, var_5.GetUsedCount(var_23_2) + arg_23_2)
...
function var_0_1.IsCompleteAllTools(arg_24_0, arg_24_1)
	...
	_ = var_1_10004
	var_24_0[arg_24_1] = var_24_1(var_1_10004.values(arg_24_0.formulas), function(arg_25_0)
		if arg_25_0:getConfig("version") == arg_24_1 then
			local var_25_0 = arg_25_0
			local var_25_1 = arg_25_0.GetType(var_25_0)

			AtelierFormula = var_25_0

			if var_25_1 ~= var_25_0.TYPE.TOOL then
				return true
			end
