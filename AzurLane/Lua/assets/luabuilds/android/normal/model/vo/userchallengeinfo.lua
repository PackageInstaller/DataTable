...
function var_0_1.UpdateChallengeInfo(arg_2_0, arg_2_1)
	...
	ChallengeProxy = var_2_2

	if var_2_3 == var_2_2.MODE_INFINITE then
...
function var_0_1.updateShipHP(arg_6_0, arg_6_1, arg_6_2)
	...
	if not var_3.updateShipsHP(var_6_0, arg_6_1, arg_6_2) then
		...
		var_6_2 = var_6_0.updateShipsHP(var_6_1, arg_6_1, arg_6_2)
	end

	if not var_6_2 then
		assert = var_6_0

		var_6_0(false, "challenge unit not exist")
	end
...
function var_0_1.setInfiniteDungeonIDListByLevel(arg_20_0)
	...
	local var_20_2 = var_20_1(var_20_0 / var_1_10003.BOSS_NUM) + 1

	pg = var_3

	local var_20_3

	if var_20_2 % #var_3.activity_event_challenge[arg_20_0._activityIndex].infinite_stage[arg_20_0._seasonIndex] == 0 then
		var_20_3 = var_3
	end
...
function var_0_1.getNextInfiniteDungeonIDList(arg_21_0)
	...
	local var_21_2 = var_21_1(var_21_0 / var_1_10003.BOSS_NUM) + 1

	pg = var_3

	local var_21_3 = var_21_2 % #var_3.activity_event_challenge[arg_21_0._activityIndex].infinite_stage[arg_21_0._seasonIndex] + 1
