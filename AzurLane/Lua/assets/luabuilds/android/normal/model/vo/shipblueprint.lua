...
local var_0_3 = var_2.ship_strengthen_blueprint
local var_0_4 = false
...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_0:getConfig("strengthen_effect")) do
		...
		if var_1_10007(var_0_3[iter_2_1]).special == 1 then
			arg_2_0:warpspecialEffect(var_1_10007)
		end

		arg_2_0.strengthenConfig[iter_2_0] = var_1_10007
	end
	...
	for iter_2_2, iter_2_3 in var_2(arg_2_0:getConfig("fate_strengthen")) do
		...
		if var_1_10007(var_0_3[iter_2_3]).special == 1 then
			arg_2_0:warpspecialEffect(var_1_10007)
		end

		arg_2_0.fateStrengthenConfig[iter_2_2] = var_1_10007
	end
...
function var_0_1.getBluePrintAddition(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_18_0(var_1_10003.BLUEPRINT_ATTRS, arg_18_1)
...
function var_0_1.getShipVO(arg_19_0)
	...
	var_19_1.configId = var_1_10003(arg_19_0.id .. "1")
...
function var_0_1.getTaskStateById(arg_37_0, arg_37_1)
	if arg_37_0:isLock() then
		...
		local var_37_1 = arg_37_0.getTaskOpenTimeStamp(var_37_0, arg_37_1)

		pg = var_37_0

		local var_37_2 = var_37_0.TimeMgr.GetInstance()

		if var_37_1 > var_3.GetServerTime(var_37_2) then
			return var_0_1.TASK_STATE_WAIT
		else
			getProxy = var_37_2
			TaskProxy = var_1_10005

			local var_37_3 = var_37_2(var_1_10005)

			if var_4.getTaskVO(var_37_3, arg_37_1) and var_5:isReceive() then
...
function var_0_1.getExpRetio(arg_38_0, arg_38_1)
	...
	local var_38_1 = arg_38_0.getConfig(var_38_0, "attr_exp")

	assert = var_38_0

	var_38_0(arg_38_1 > 0 and arg_38_1 <= #var_38_1, "invalid index" .. arg_38_1)
...
function var_0_1.specialStrengthens(arg_39_0)
	...
	for iter_39_0, iter_39_1 in var_3(arg_39_0.strengthenConfig) do
...
function var_0_1.getTopLimitAttrValue(arg_41_0, arg_41_1)
	if arg_41_0.level == 0 then
		...
		local var_41_2 = arg_41_0.getConfig(var_41_1, "attr_exp")[arg_41_1]

		math = var_41_1

		return var_41_1.floor(var_41_0 / var_41_2)
	end
...
function var_0_1.getItemExp(arg_42_0)
	...
	local var_42_1 = arg_42_0.getConfig(var_42_0, "strengthen_item")

	Item = var_42_0

	return var_42_0.getConfigData(var_42_1).usage_arg[1]
end
...
function var_0_1.getShipProperties(arg_43_0, arg_43_1, arg_43_2)
	...
	defaultValue = var_43_0
	arg_43_2 = var_43_0(arg_43_2, true)

	local var_43_2 = arg_43_0
	local var_43_3 = arg_43_0.getTotalAdditions(var_43_2)

	pairs = var_43_2

	for iter_43_0, iter_43_1 in var_43_2(var_43_1) do
		local var_43_4 = var_43_1[iter_43_0]

		if not var_43_3[iter_43_0] then
			var_1_10011 = 0
		end

		var_43_1[iter_43_0] = var_43_4 + var_1_10011
	end

	if arg_43_1:getIntimacyLevel() > 0 and arg_43_2 then
		pg = var_5

		local var_43_5 = var_5.intimacy_template[arg_43_1:getIntimacyLevel()].attr_bonus * 0.0001
									...
									if iter_43_2 ~= var_1_10011.Hit then
										...
										if iter_43_2 ~= var_1_10011.AntiSub then
											...
											if iter_43_2 == var_1_10011.Dodge then
												var_43_1[iter_43_2] = var_43_1[iter_43_2] * (var_43_5 + 1)
											end
										end
									end
								end
...
function var_0_1.getTotalAdditions(arg_44_0)
	...
	local var_44_2 = arg_44_0.attrSpecialAddition(var_44_1)

	ipairs = var_44_1
	Ship = var_1_10004

	for iter_44_0, iter_44_1 in var_44_1(var_1_10004.PROPERTIES) do
		local var_44_3, var_44_4 = arg_44_0:getBluePrintAddition(iter_44_1)
		local var_44_5

		if not var_44_2[iter_44_1] then
			var_44_5 = 0
		end

		var_44_0[iter_44_1] = var_44_3 + var_44_5
	end
...
function var_0_1.getUseageMaxItem(arg_46_0)
	...
	return var_46_1(var_3.ceil((var_46_0 - arg_46_0.exp) / arg_46_0:getItemExp()), 0)
end
...
function var_0_1.getFateUseageMaxItem(arg_47_0)
	...
	return var_47_1(var_3.ceil((var_47_0 - arg_47_0.exp) / arg_47_0:getItemExp()), 0)
end
...
function var_0_1.getUnlockVoices(arg_51_0)
	...
	for iter_51_0 = 1, arg_51_0.level do
		if arg_51_0:getStrengthenConfig(iter_51_0).special == 1 then
			local var_51_1 = var_6.special_effect

			type = var_8

			if var_8(var_51_1) == "table" then
				ipairs = var_8

				for iter_51_1, iter_51_2 in var_8(var_51_1) do
...
function var_0_1.getUnlockLevel(arg_52_0, arg_52_1)
	...
	for iter_52_0 = 1, var_52_0 do
		...
		if var_9(var_52_1) == "table" then
			ipairs = var_9

			for iter_52_1, iter_52_2 in var_9(var_52_1) do
...
function var_0_1.getBaseList(arg_53_0, arg_53_1)
	...
	for iter_53_0 = arg_53_0.level, 1, -1 do
		if arg_53_0:getStrengthenConfig(iter_53_0).special == 1 then
			local var_53_0 = var_6.special_effect

			ipairs = var_8

			for iter_53_1, iter_53_2 in var_8(var_53_0) do
...
function var_0_1.getPreLoadCount(arg_54_0, arg_54_1)
	...
	for iter_54_0 = arg_54_0.level, 1, -1 do
		if arg_54_0:getStrengthenConfig(iter_54_0).special == 1 then
			local var_54_0 = var_6.special_effect

			ipairs = var_8

			for iter_54_1, iter_54_2 in var_8(var_54_0) do
...
function var_0_1.getEquipProficiencyList(arg_55_0, arg_55_1)
	...
	for iter_55_0 = 1, arg_55_0.level do
		if arg_55_0:getStrengthenConfig(iter_55_0).special == 1 then
			local var_55_1 = var_7.special_effect

			ipairs = var_9

			for iter_55_1, iter_55_2 in var_9(var_55_1) do
				if iter_55_2[1] == var_0_1.STRENGTHEN_TYPE_EQUIPMENTPROFICIENCY then
					local var_55_2 = iter_55_2[2][1]
					local var_55_3 = iter_55_2[2][2]
					local var_55_4

					if not var_55_0[var_55_2] then
						var_55_4 = 0
					end

					var_55_0[var_55_2] = var_55_4 + var_55_3
				end
			end
		end
	end
	...
	local var_55_5 = var_3(arg_55_1:getConfig("equipment_proficiency"))
...
function var_0_1.isFinishPrevTask(arg_56_0)
	...
	for iter_56_0, iter_56_1 in var_1_10003(arg_56_0:getOpenTaskList()) do
		...
		if not var_1_10008.getTaskVO(var_1_10009, iter_56_1) or not var_1_10008:isFinish() then
			return false, false
		else
...
function var_0_1.isShipModMaxLevel(arg_57_0, arg_57_1)
	...
	local var_57_2 = var_57_1(var_57_0, var_4.min(arg_57_0.level + 1, arg_57_0:getMaxLevel()))
...
function var_0_1.isShipModMaxFateLevel(arg_58_0, arg_58_1)
	...
	local var_58_2 = var_58_1(var_58_0, var_4.min(arg_58_0.fateLevel + 1, arg_58_0:getMaxFateLevel()))
...
function var_0_1.getFateUseNum(arg_63_0)
	...
	if arg_63_0.isMaxLevel(var_63_1) then
		local var_63_2 = 0

		ipairs = var_63_1

		for iter_63_0, iter_63_1 in var_63_1(arg_63_0.fateStrengthenConfig) do
			if iter_63_1.lv <= 30 + arg_63_0.fateLevel then
				var_63_2 = var_63_2 + iter_63_1.need_exp
			end
		end

		local var_63_3 = var_63_2 + arg_63_0.exp
		local var_63_4 = arg_63_0
		local var_63_5 = arg_63_0.getItemExp(var_63_4)

		math = var_63_4
		var_63_0 = var_63_4.floor(var_63_3 / var_63_5)
	end
...
function var_0_1.getUnlockItem(arg_66_0)
	...
	local var_66_0 = var_1_10001(var_1_10002)
...
function var_0_1.isPursuingCostTip(arg_67_0)
	if arg_67_0:isPursuing() and arg_67_0:isUnlock() then
		if not arg_67_0:isMaxIntensifyLevel() then
			...
			local var_67_2 = var_1_10003(var_1_10004)

			if not var_67_1(var_67_0, var_3.getShipById(var_67_2, arg_67_0.shipId)) then
				getProxy = var_67_1
...
function var_0_1.getPhantomQuestCostDrop(arg_69_0)
	if arg_69_0.config.type == 5 then
		...
		var_69_1.type = var_1_10003
		PlayerConst = var_1_10003
		var_69_1.id = var_1_10003.ResDiamond
...
function var_0_1.getPhantomQuestProgress(arg_70_0, arg_70_1)
	...
	return var_1_10002(arg_70_1, {
		function()
			...
			local var_71_0 = var_2_10000(var_2_10001)
		...
		function()
			...
			local var_74_0 = var_2_10000(var_2_10001)
		...
		function()
			...
			var_75_1.type = var_2_10002
			PlayerConst = var_2_10002
			var_75_1.id = var_2_10002.ResDiamond
...
function var_0_1.getPhantomQuestInfo(arg_76_0, arg_76_1)
	...
	local var_76_3 = var_76_2(var_6)

	var_76_1.unlocked = var_4(var_5.getShipById(var_76_3, arg_76_0.shipId).phantomDic[arg_76_1])
...
function var_0_1.getAllPhantomQuestInfo(arg_77_0)
	...
	return var_77_0(var_1_10002.technology_shadow_unlock.all, function(arg_78_0)
