...
function var_0_0.Ctor(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10002(var_1_0) do
		...
		EducatePlan = var_1_10009

		var_1_10007(var_1_1, var_1_10009.New(iter_1_1))
	end
...
function var_0_0.SetUp(arg_3_0, arg_3_1)
	...
	local var_3_4 = #arg_3_0.selectedPlans
	local var_3_5

	if 0 < var_3_4 then
		var_3_5 = arg_3_0

		arg_3_0.initGridData(var_3_5)
	else
		arg_3_0.gridData = {}
	end
	...
	arg_3_0.playerId = var_2.getRawData(var_3_6).id
	...
	for iter_10_0, iter_10_1 in var_1(arg_10_0.selectedPlans) do
		...
		if iter_10_1.value[1] then
			...
			if var_10_0 and var_10_0 ~= 0 then
				...
				var_1_10009 = var_1_10008.GetEventProxy(var_1_10009)

				var_1_10008.AddFinishSpecEvent(var_1_10009, var_10_0)

				var_1_10008 = arg_10_0.gridData[iter_10_1.day]
				var_1_10009 = iter_10_1.index
				...
				var_10_2.type = var_1_10012.TYPE_EVENT
				var_1_10008[var_1_10009] = var_1_10010(var_10_2)
			elseif var_10_1 and var_10_1 ~= 0 then
				...
				EducateGrid = var_1_10012
				var_10_3.type = var_1_10012.TYPE_PLAN
				var_1_10008[var_1_10009] = var_1_10010(var_10_3)
			end
		end
	end
...
function var_0_0.GetShowPlans(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	return var_1_10004.select(arg_15_0.allPlans, function(arg_16_0)
		...
		if arg_16_0:IsShow(arg_15_1, arg_15_2, arg_15_3) then
			...
			var_16_4 = var_16_2(var_16_1, var_4.GetHistoryCntById(var_16_3, var_16_0))
		end
	...
	for iter_17_0 = 1, 6 do
		for iter_17_1 = 1, 3 do
			if iter_17_1 <= var_17_2 then
				...
				var_17_4(var_13.PLANS_DATA_KEY .. arg_17_0.playerId .. "_" .. iter_17_0 .. "_" .. iter_17_1, var_17_3)
			end
		end
	end
...
function var_0_0.GetRecommendPlan(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4, arg_18_5, arg_18_6, arg_18_7)
	...
	for iter_18_0, iter_18_1 in var_11(arg_18_7) do
		...
		CompareFuncs = var_1_10018

		var_1_10016(var_18_3, var_1_10018({
			function(arg_19_0)
