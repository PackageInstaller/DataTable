...
function var_0_1.InTime(arg_11_0, arg_11_1)
	...
	if not arg_11_1 then
		...
		var_1_10003 = var_11_0(var_1_10003)
		var_11_0 = var_11_0.GetCurTime(var_1_10003)
	end

	EducateHelper = var_1_10003

	return var_1_10003.InTime(var_11_0, arg_11_0.startTime, arg_11_0.endTime)
end
...
function var_0_1.GetRemainTime(arg_12_0, arg_12_1)
	...
	if not arg_12_1 then
		...
		getProxy = var_12_0
		EducateProxy = var_1_10003
		var_1_10003 = var_12_0(var_1_10003)
		var_12_0 = var_12_0.GetCurTime(var_1_10003)
	end

	EducateHelper = var_1_10003

	return var_1_10003.GetDaysBetweenTimes(var_12_0, arg_12_0.endTime)
end
