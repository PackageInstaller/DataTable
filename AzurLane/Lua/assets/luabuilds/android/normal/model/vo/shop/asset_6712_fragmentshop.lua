...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".MonthlyShop"))

Goods = var_0_0
var_0_1.GoodsType = var_0_0.TYPE_FRAGMENT
ShopArgs = var_1
...
function var_0_1.update(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	if arg_1_0.id and arg_1_0.id > 0 then
		...
		if arg_1_0.getConfigTable(var_1_1) then
			...
			for iter_1_4, iter_1_5 in var_1_1(arg_1_0:getConfig("blueprint_shop_goods")) do
				local var_1_3 = var_1_2
				local var_1_4 = iter_1_5

				Goods = var_1_10013

				var_1_3(var_1_4, var_1_10013.TYPE_FRAGMENT)
			end
			...
			for iter_1_6, iter_1_7 in var_6(arg_1_0:getConfig("blueprint_shop_limit_goods")) do
				...
				var_1_5(var_1_6, var_1_10013.TYPE_FRAGMENT_NORMAL)
			end
		end
	end
...
function var_0_1.IsSameKind(arg_4_0, arg_4_1)
	...
	FragmentShop = var_1_10004

	return var_1_10002(var_4_0, var_1_10004)
end
