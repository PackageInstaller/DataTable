...
function var_0_1.InitConfig(arg_5_0)
	...
	var_1(var_5_0, var_1_10003.format("without equip config from id_%d", arg_5_0.id))
...
function var_0_1.GetAttributes(arg_7_0)
	...
	for iter_7_0 = 1, 3 do
		...
		local var_7_3 = arg_7_0.getConfig(var_7_2, "value_" .. iter_7_0)
		...
		if var_7_1 ~= nil then
			...
			if var_9.match(var_7_3, "^[%d|\\.]+$") then
				tonumber = var_9

				local var_7_4

				if not var_9(var_7_3) then
					var_7_4 = var_7_3
				end

				var_7_2.value = var_7_4
...
function var_0_1.CanInBag(arg_9_0)
	...
	return var_1_10001(var_1_10002.equip_data_template[arg_9_0])
end
...
function var_0_1.CalcWeanponCD(arg_11_0, arg_11_1)
	...
	if arg_11_1 then
		var_1_10004 = arg_11_1

		local var_11_1

		if not arg_11_1.getProperties(var_1_10004).reload then
			var_11_1 = 100
		end
		...
		return var_11_2(var_11_3, var_1_10006.Battle.BattleFormulas.CalculateReloadTime(var_11_0, var_11_1))
	end
end
...
local function var_0_5(arg_12_0)
	if not var_0_4 then
		...
		for iter_12_0, iter_12_1 in var_1(var_0_3) do
			...
			i18n = var_8
			var_12_0[var_1_10007] = var_8(iter_12_1)
		end
	end
...
function var_0_1.GetInfoTrans(arg_13_0, arg_13_1)
	...
	if var_13_2 and arg_13_1 then
		...
		local var_13_7 = arg_13_1.getSpecificType(var_13_6)

		ShipType = var_13_6
		var_13_2 = var_13_5(var_13_7, var_13_6.SpecificTypeTable.auxiliary)
	end
...
local function var_0_6(arg_14_0)
	...
	string = var_3
	var_14_1[1] = var_3.match(arg_14_0, "~(%d+)")
...
function var_0_1.AlignAttrs(arg_15_0, arg_15_1)
	for iter_15_0 = 1, #arg_15_0 do
		if not arg_15_1[iter_15_0] or arg_15_0[iter_15_0].type ~= arg_15_1[iter_15_0].type then
			...
			var_1_10006(var_15_0, var_1_10008, iter_15_1(arg_15_0[iter_15_0]))
			...
			for iter_15_1 = iter_15_0 + 1, #arg_15_1 do
				if arg_15_1[iter_15_0].type == arg_15_1[iter_15_1].type then
					...
					var_15_1.value = arg_15_1[iter_15_1].value
					table = var_15_1

					var_15_1.remove(arg_15_1, iter_15_1)
	...
	for iter_15_2 = #arg_15_0 + 1, #arg_15_1 do
		...
		var_1_10006(var_15_2, var_1_10008(arg_15_1[iter_15_2]))
...
function var_0_1.GetPropertiesInfo(arg_19_0)
	...
	if var_19_2(var_19_1, var_1_10004.Damage) then
		table = var_2
		...
		var_19_5.type = var_1_10005.Damage

		local var_19_6 = arg_19_0

		var_1_10005 = arg_19_0.getConfig
		AttributeType = var_1_10007
		var_19_5.value = var_1_10005(var_19_6, var_1_10007.Damage)

		var_19_3(var_19_4, var_19_5)
	end

	local var_19_7 = arg_19_0
	local var_19_8 = arg_19_0.getConfig

	AttributeType = var_19_5

	local var_19_9

	if var_19_8(var_19_7, var_19_5.CD) then
		var_19_9 = {}
		AttributeType = var_19_7
		var_19_9.type = var_19_7.CD

		local var_19_10 = arg_19_0
		local var_19_11 = arg_19_0.getConfig

		AttributeType = var_1_10005
		var_19_9.value = var_19_11(var_19_10, var_1_10005.CD)
		table = var_3

		var_3.insert(var_19_0.attrs, var_19_9)

		if arg_19_0:isAircraftExtend() and arg_19_0:getConfig("weapon_id") then
			var_19_9.sub = {}
			ipairs = var_3

			for iter_19_0, iter_19_1 in var_3(arg_19_0:getConfig("weapon_id")) do
				pg = var_1_10008
				...
				if var_1_10008.weapon_property[iter_19_1].type == 11 then
					...
					local var_19_12 = var_19_9.sub
					local var_19_13 = {}

					i18n = var_1_10011
					var_19_13.name = var_1_10011("equip_info_34")
					AttributeType = var_1_10011
					var_19_13.type = var_1_10011.CD
					pg = var_1_10011
					var_19_13.value = var_1_10011.weapon_property[iter_19_1].reload_max

					var_1_10008(var_19_12, var_19_13)
				end
			end
		end
	end
	...
	for iter_19_2, iter_19_3 in var_19_9(arg_19_0:GetAttributes()) do
		if iter_19_3 then
			local var_19_14 = iter_19_3.type

			AttributeType = var_1_10008

			if var_19_14 ~= var_1_10008.OxyRaidDistance then
				table = var_19_14

				var_19_14.insert(var_19_0.attrs, iter_19_3)
			end
		end
	end
	...
	if arg_19_0:GetAntiSirenPower() then
		...
		local var_19_15 = var_2.insert
		local var_19_16 = var_19_0.attrs

		var_19_17 = {}
		AttributeType = iter_19_2
		var_19_17.type = iter_19_2.AntiSiren
		iter_19_3 = arg_19_0
		var_19_17.value = arg_19_0.GetAntiSirenPower(iter_19_3)

		var_19_15(var_19_16, var_19_17)
	end

	local var_19_18 = arg_19_0

	if arg_19_0.GetSonarProperty(var_19_18) then
		table = var_19_18

		local var_19_19 = var_19_18.insert

		var_19_17 = var_19_0.attrs

		local var_19_20 = {}

		AttributeType = iter_19_3
		var_19_20.type = iter_19_3.SonarRange
		AttributeType = var_6
		var_19_20.value = var_2[var_6.SonarRange]

		var_19_19(var_19_17, var_19_20)
	end
	...
	i18n = var_19_17
	var_19_21.name = var_19_17(arg_19_0:isAircraftExtend() and "equip_info_24" or "equip_info_5")
	var_19_21.sub = {}
	var_19_0.weapon = var_19_21
	ipairs = var_19_21

	for iter_19_4, iter_19_5 in var_19_21(arg_19_0:getConfig("ammo_info")) do
		table = var_1_10008

		var_1_10008.insert(var_19_0.weapon.sub, arg_19_0:GetWeaponPageInfo(iter_19_5[1], iter_19_5[2]))
	end

	local var_19_22 = {}

	i18n = var_4
	var_19_22.name = var_4("equip_info_14")
	var_19_22.sub = {}
	var_19_0.equipInfo = var_19_22
	ipairs = var_19_22

	for iter_19_6, iter_19_7 in var_19_22(arg_19_0:getConfig("equip_info")) do
		table = var_1_10008

		var_1_10008.insert(var_19_0.equipInfo.sub, arg_19_0:GetEquipAttrPageInfo(iter_19_7))
	end
	...
	if arg_21_3 then
		...
		return var_1_10005(arg_21_1, {
			function()
				...
				local var_22_3 = var_3.getConfig

				AttributeType = var_2_10005
				var_22_0.name = var_2_10001(var_22_1 .. var_22_3(var_22_2, var_2_10005.Ammo))
			...
			function()
				...
				if not var_2_10003.bullet_template[var_21_0].extra_param.randomOffsetZ then
					var_31_3 = "0"
				end
			...
			function()
				...
				var_32_0.value = var_32_2(var_32_1, var_2_10003.Speciality)
...
function var_0_1.GetEquipAttrPageInfo(arg_35_0, arg_35_1)
	...
	local var_35_3 = var_5(var_0_7[var_35_0])

	type = var_6

	var_35_2(var_35_3 == (var_6(arg_35_1) == "table"), "equip attr sid type error from equip:" .. arg_35_0.id)
...
function var_0_1.GetEquipAttrInfo(arg_36_0, arg_36_1, arg_36_2)
	...
	return var_1_10003(arg_36_1, {
		...
		function()
			...
			var_42_0.value = var_42_1(var_2.getConfig(var_42_2, "nationality"))
		...
		function()
			...
			if var_2_10000 ~= var_2_10001 then
				...
				if var_2_10000 == var_2_10001 then
					...
					local var_46_2 = var_2.getConfig(var_46_1, "rarity")
					local var_46_3 = arg_36_0

					var_46_0.value = var_2_10001(var_46_2, var_3.getConfig(var_46_3, "level"))
		...
		function()
			...
			if var_2_10000 ~= var_2_10001 then
				...
				if var_2_10000 == var_2_10001 then
					...
					pg = var_3
					var_47_1.value = var_47_2(var_47_0[var_3.weapon_property[arg_36_2].attack_attribute])
...
function var_0_1.GetGearScore(arg_50_0)
	...
	local var_50_2 = arg_50_0.getConfig(var_50_1, "level")

	assert = var_50_1
	pg = var_4

	var_50_1(var_4.equip_data_by_quality[var_50_0], "equip_data_by_quality not exist: " .. var_50_0)

	pg = var_50_1

	return var_50_1.equip_data_by_quality[var_50_0].gear_score + var_50_2 * var_3.gear_score_addition
end
...
function var_0_1.GetSkill(arg_51_0)
	...
	if arg_51_0.getConfig(var_51_1, "skill_id")[1] then
		var_51_1 = arg_51_0
		var_51_2 = arg_51_0.getConfig(var_51_1, "skill_id")[1][1]
	end

	if var_51_2 then
		getSkillConfig = var_51_1
		var_51_0 = var_51_1(var_51_2)
	end
...
function var_0_1.GetSonarProperty(arg_53_0)
	if arg_53_0:getConfig("equip_parameters").range then
		...
		AttributeType = var_1_10004
		var_53_0[var_1_10004.SonarRange] = var_2
...
function var_0_1.getRevertAwards(arg_57_0)
	...
	while var_57_2:hasPrevLevel() do
		...
		for iter_57_0, iter_57_1 in var_4(var_57_2.getConfig(var_1_10006, "trans_use_item")) do
			table = var_1_10009
			...
			var_57_4.type = var_1_10013
			var_57_4.id = iter_57_1[1]
			var_57_4.count = iter_57_1[2]

			var_1_10009(var_57_3, var_1_10011(var_57_4))
		end
	...
	local var_57_5 = var_4.MergeSameDrops(var_57_0)

	if 0 < var_57_1 then
		table = var_4

		local var_57_6 = var_4.insert
		local var_57_7 = var_57_5

		Drop = var_1_10006

		local var_57_8 = var_1_10006.New
		local var_57_9 = {}

		DROP_TYPE_RESOURCE = iter_57_1
		var_57_9.type = iter_57_1
		PlayerConst = iter_57_1
		var_57_9.id = iter_57_1.ResGold
		var_57_9.count = var_57_1

		var_57_6(var_57_7, var_57_8(var_57_9))
	end
...
function var_0_1.canEquipSkin(arg_58_0)
	...
	local var_58_1 = arg_58_0.getConfig(var_58_0, "type")

	pg = var_58_0

	return var_58_0.equip_data_by_type[var_58_1].equip_skin == 1
end
...
function var_0_1.isDevice(arg_67_0)
	...
	local var_67_1 = arg_67_0.getConfig(var_67_0, "type")

	underscore = var_67_0

	local var_67_2 = var_67_0.any

	EquipType = var_3

	return var_67_2(var_3.DeviceEquipTypes, function(arg_68_0)
		return arg_68_0 == var_67_1
	end)
end

function var_0_1.isAircraft(arg_69_0)
	local var_69_0 = arg_69_0
	local var_69_1 = arg_69_0.getConfig(var_69_0, "type")

	underscore = var_69_0

	local var_69_2 = var_69_0.any

	EquipType = var_3

	return var_69_2(var_3.AirEquipTypes, function(arg_70_0)
		return arg_70_0 == var_69_1
	end)
end

function var_0_1.isAircraftExtend(arg_71_0)
	local var_71_0 = arg_71_0
	local var_71_1 = arg_71_0.getConfig(var_71_0, "type")

	underscore = var_71_0

	local var_71_2 = var_71_0.any

	EquipType = var_3

	return var_71_2(var_3.AirExtendEquipTypes, function(arg_72_0)
		return arg_72_0 == var_71_1
	end)
end
