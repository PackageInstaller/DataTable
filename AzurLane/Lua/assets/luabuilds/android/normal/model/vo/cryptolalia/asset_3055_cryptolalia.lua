...
function var_0_1.GetAssetBundlePath(arg_1_0)
	...
	return var_2.getAssetBundle(var_1_0)
end
...
function var_0_1.GetSubtitleAssetBundlePath(arg_2_0)
	...
	return var_2.getAssetBundle(var_2_0)
end
...
function var_0_1.IsDownloadRes(arg_11_0, arg_11_1)
	...
	local var_11_1 = var_0_1.BuildCpkPath(var_11_0)

	pg = var_4

	local var_11_2 = var_4.CipherGroupMgr.GetInstance()

	return var_4.isCipherExist(var_11_2, var_11_1)
end
...
function var_0_1.GetShipName(arg_24_0)
	...
	local var_24_2 = var_24_0.getDefaultShipConfig(var_24_1)

	HXSet = var_3

	return (var_3.hxLan(var_24_2.name))
end
...
function var_0_1.ShipIcon(arg_25_0)
	...
	local var_25_2 = var_25_0.getDefaultShipConfig(var_25_1)

	pg = var_3

	return var_3.ship_skin_template[var_25_2.skin_id].prefab
end
...
function var_0_1.InTime(arg_41_0)
	...
	local var_41_1 = arg_41_0.getConfig(var_41_0, "time")

	pg = var_41_0

	local var_41_2 = var_41_0.TimeMgr.GetInstance()

	return var_2.inTime(var_41_2, var_41_1)
end
...
function var_0_1.IsForever(arg_44_0)
	...
	local var_44_1 = arg_44_0.getConfig(var_44_0, "time")

	type = var_44_0

	return var_44_0(var_44_1) == "string" and var_44_1 == "always"
end
...
function var_0_1.GetExpiredTimeStr(arg_45_0)
	if arg_45_0:InTime() and not arg_45_0:IsForever() then
		...
		local var_45_2 = arg_45_0:getConfig("time")[3]

		pg = var_4

		local var_45_3 = var_4.TimeMgr.GetInstance()
		local var_45_4

		if var_4.parseTimeFromConfig(var_45_3, var_45_2) - var_45_1 <= 0 then
			var_45_4 = ""
		else
			skinTimeStamp = var_45_4
			var_45_4 = var_45_4(var_5)
		end
...
function var_0_1.ExistLocalFile(arg_47_0, arg_47_1)
	...
	local var_47_1 = var_0_1.GetAssetBundlePath(var_47_0)

	PathMgr = var_4

	return var_4.FileExists(var_47_1)
end

function var_0_1.ExistLocalSubtitleFile(arg_48_0, arg_48_1)
	local var_48_0 = arg_48_0:GetCpkName(arg_48_1)
	local var_48_1 = var_0_1.GetSubtitleAssetBundlePath(var_48_0)

	PathMgr = var_4

	return var_4.FileExists(var_48_1)
end
...
function var_0_1.GetResSize(arg_49_0, arg_49_1)
	...
	if not arg_49_0.sizes[arg_49_1] and arg_49_0:ExistLocalFile(arg_49_1) then
		...
		if arg_49_0.ExistLocalSubtitleFile(var_49_4, arg_49_1) then
			local var_49_5 = var_0_1.GetSubtitleAssetBundlePath(var_49_0)

			var_49_3 = var_0_2(var_49_5)
		end

		local var_49_6 = arg_49_0.sizes

		HashUtil = var_49_4
		var_49_6[arg_49_1] = var_49_4.BytesToString(var_49_2 + var_49_3)
	end
