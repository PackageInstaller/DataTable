...
function var_0_1.GetCommonEnemyDatas(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10002(arg_7_0.enemyData) do
		...
		local var_7_2 = iter_7_1.GetType(var_7_1)

		BossSingleVariableEnemyData = var_7_1

		if var_7_2 ~= var_7_1.TYPE.EAST then
			local var_7_3 = iter_7_1

			var_7_2 = iter_7_1.GetType(var_7_3)
			BossSingleVariableEnemyData = var_7_3

			if var_7_2 ~= var_7_3.TYPE.NORMAL then
				local var_7_4 = iter_7_1

				var_7_2 = iter_7_1.GetType(var_7_4)
				BossSingleVariableEnemyData = var_7_4

				if var_7_2 == var_7_4.TYPE.HARD then
					table = var_7_2

					var_7_2.insert(var_7_0, iter_7_1)
				end
			end
		end
	end
...
function var_0_1.IsUnlockByEnemyId(arg_14_0, arg_14_1)
	...
	if var_2.GetPreChapterId(var_14_0) ~= 0 then
		...
		var_14_4 = var_14_2(var_14_1, var_5.GetExpeditionId(var_14_3))
...
function var_0_1.CheckEntranceByIdx(arg_16_0, arg_16_1)
	if not arg_16_0:GetEnemyDataByFleetIdx(arg_16_1) then
		return false, "not exist enemy data, index: " .. arg_16_1
	end

	local var_16_0 = var_2

	if not var_2.InTime(var_16_0) then
		local var_16_1 = false

		i18n = var_16_0

		local var_16_2 = var_16_0("common_activity_end")
	...
	if not arg_16_0.IsUnlockByEnemyId(var_16_3, var_2.id) then
		local var_16_4 = false

		i18n = var_16_3

		local var_16_5 = var_16_3("adventure_unlock_tip")
