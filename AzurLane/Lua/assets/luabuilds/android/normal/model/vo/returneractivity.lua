...
function var_0_1.ShouldAcceptTasksIfInviter(arg_6_0)
	if arg_6_0:IsPush() then
		...
		local var_6_2 = arg_6_0.getDayIndex(var_6_1)

		getProxy = var_6_1
		TaskProxy = var_1_10004

		local var_6_3 = var_6_1(var_1_10004)
		local var_6_4 = 0
		...
		if (not arg_6_0:GetTask(var_6_0[var_6_4]) or var_5:isReceive()) and var_6_4 < var_6_2 and (var_6_4 ~= #var_6_0 or not var_5 or not var_5:isReceive()) then
			return true
		end
	end
...
function var_0_1.ShouldAcceptTasksIfReturner(arg_8_0)
	...
	local var_8_3 = var_8_1(var_5)

	_ = var_5

	local var_8_4 = var_5.all(var_8_2[var_8_0], function(arg_9_0)
	...
	local function var_8_7()
		...
		return var_11_3(var_11_2, var_3.getStartTime(var_11_4), var_11_1) + 1 > var_8_0
	end
