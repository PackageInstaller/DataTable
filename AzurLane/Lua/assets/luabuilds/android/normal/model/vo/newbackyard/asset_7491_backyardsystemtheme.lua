...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BackYardSelfThemeTemplate"))
...
function var_0_1.GetRawPutList(arg_2_0)
	...
	if not arg_2_0.putInfo then
		...
		if not var_2_3 then
			require = var_1_10003
			var_2_3 = var_1_10003("GameCfg.backyardTheme.theme_empty")
		end
...
function var_0_1.IsOverTime(arg_10_0)
	...
	local var_10_2 = arg_10_0.getConfig(var_10_1, "ids")

	_ = var_10_1

	return var_10_1.all(var_10_2, function(arg_11_0)
		local var_11_1
...
function var_0_1.HasDiscount(arg_13_0)
	...
	local var_13_1 = arg_13_0.GetFurnitures(var_13_0)

	_ = var_13_0

	return var_13_0.any(var_13_1, function(arg_14_0)
		...
		return var_14_1 > var_14_3(var_14_2, var_2_10005.ResDormMoney)
	end)
end
...
function var_0_1.GetDiscount(arg_15_0)
	...
	local var_15_2 = var_15_0.map(var_15_1, function(arg_16_0)
		Furniture = var_2_10001
	...
	local var_15_3 = var_3.reduce(var_15_2, 0, function(arg_17_0, arg_17_1)
		local var_17_0 = arg_17_1
		local var_17_1 = arg_17_1.getPrice

		PlayerConst = var_2_10004

		return arg_17_0 + var_17_1(var_17_0, var_2_10004.ResDormMoney)
	end)
