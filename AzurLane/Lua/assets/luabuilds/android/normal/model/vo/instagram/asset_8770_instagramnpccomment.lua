...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	for iter_1_0, iter_1_1 in var_6(arg_1_1.npc_reply) do
		...
		var_1_10011(arg_1_0.allReply[iter_1_1], iter_1_1)

		table = var_1_10011
		var_1_10011 = var_1_10011.insert

		local var_1_1 = arg_1_0.replyList

		InstagramNpcComment = var_13

		var_1_10011(var_1_1, var_13.New(arg_1_0.allReply[iter_1_1], arg_1_2, var_1_0, arg_1_0))
	end
