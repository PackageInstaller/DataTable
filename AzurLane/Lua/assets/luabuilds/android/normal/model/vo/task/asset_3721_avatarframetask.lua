...
function var_0_1.IsActEnd(arg_2_0)
	...
	local var_2_1 = var_2(var_1_10003)
...
function var_0_1.getConfig(arg_17_0, arg_17_1)
	if not arg_17_0.configData then
		...
		if not arg_17_0.getTypeData(var_17_0, var_2, arg_17_0.id) then
			return
		end

		Clone = var_17_0
		var_17_0(var_2.award_display)[1][3] = var_3.award_num
		arg_17_0.configData = {
			sub_type = 0,
			level = 1,
			item_id = var_2.pt_id,
...
function var_0_1.createData(arg_21_0, arg_21_1, arg_21_2)
	...
	if arg_21_1 == var_0_1.type_task_level then
		...
		if var_21_3 > 0 and var_21_3 <= #var_0_4 then
			pg = var_11
			var_1_10010 = var_11.gametip[var_0_4[var_21_3]].tip
		end

		local var_21_6 = var_21_2 * 10 + 1

		pg = var_1_10012

		local var_21_7 = var_1_10012.ship_data_statistics[var_21_6].name
		local var_21_8
		local var_21_9
		...
		for iter_21_0, iter_21_1 in var_1_10015(var_21_4) do
			assert = var_1_10020
			pg = var_1_10021
			var_1_10021 = var_1_10021.chapter_template[iter_21_1] ~= nil

			var_1_10020(var_1_10021, "找不到chapterid = " .. iter_21_1)
			...
			if not var_21_9 then
				...
				var_1_10021 = {}
				pg = var_22
				var_1_10021[1] = var_22.chapter_template[iter_21_1].act_id
				var_1_10020[2] = var_1_10021
				var_21_9 = var_1_10020
			end

			if not var_21_8 then
				pg = var_1_10020
				var_21_8 = var_1_10020.chapter_template[iter_21_1].chapter_name
			else
				var_1_10020 = var_21_8
				var_1_10021 = ","
				pg = var_22
				var_21_8 = var_1_10020 .. var_1_10021 .. var_22.chapter_template[iter_21_1].chapter_name
			end
		end
		...
		i18n = var_16
		var_21_10.desc = var_16("avatar_task_level", var_1_10010, var_21_7, var_21_8, var_1_10008)
		var_21_0 = var_21_10
	elseif arg_21_1 == var_0_1.type_task_ship then
		unpack = var_21_1

		local var_21_11, var_21_12, var_21_13

		var_21_1, var_21_11, var_21_12, var_21_13 = var_21_1(arg_21_2)
		ShipGroup = var_1_10008

		local var_21_14 = var_1_10008.getDefaultShipNameByGroupID(var_21_11)
		...
		if var_21_12 == 1 then
			...
			i18n = var_1_10010
			var_21_15.desc = var_1_10010(var_0_5, var_21_14)
			var_21_0 = var_21_15
		elseif var_21_12 == 2 then
			local var_21_16 = {
				award_num = var_21_13
			}

			i18n = var_1_10010
			var_21_16.desc = var_1_10010(var_0_6, var_21_14)
			var_21_16.scene = {
				"DOCKYARD",
				{
					mode = "overview"
