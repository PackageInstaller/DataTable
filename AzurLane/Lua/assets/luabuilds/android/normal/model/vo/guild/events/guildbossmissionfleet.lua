...
function var_0_1.Flush(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_1.ships) do
		...
		if arg_2_0:IsValidShip(var_2_0) then
			table = var_8
	...
	for iter_2_2, iter_2_3 in var_4(arg_2_1.commanders) do
...
function var_0_1.ExistMember(arg_4_0, arg_4_1)
	...
	var_4_1 = var_2.getRawData(var_4_0) and var_2:getMemberById(arg_4_1)
...
function var_0_1.IsValidShip(arg_5_0, arg_5_1)
	local function var_5_0(arg_6_0)
		...
		if var_2.getRawData(var_6_2).id == arg_6_0.uid then
			...
			local var_6_3 = var_3(var_4)

			return var_3.getShipById(var_6_3, arg_6_0.id) ~= nil
		end

		local var_6_4 = var_6_1:getMemberById(arg_6_0.uid)
		local var_6_5 = var_3.GetAssaultFleet(var_6_4)

		GuildAssaultFleet = var_6_4

		local var_6_6 = var_6_4.GetVirtualId(arg_6_0.uid, arg_6_0.id)

		return (var_6_5:ExistShip(var_6_6))
	end
...
function var_0_1.GetMyShipIds(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_11_1(arg_11_0.userShips) do
...
function var_0_1.GetShips(arg_13_0)
	...
	local var_13_2 = var_13_0(var_1_10003)
	local var_13_3 = var_2.getData(var_13_2)

	getProxy = var_13_2
	BayProxy = var_1_10004

	local var_13_4 = var_13_2(var_1_10004)
	local var_13_5 = {}
	...
	for iter_13_0, iter_13_1 in var_1_10005(arg_13_0.userShips) do
		if var_13_1.id == iter_13_1.uid then
			...
			if var_13_4.getShipById(var_13_6, iter_13_1.id) then
				GuildAssaultFleet = var_13_6
				var_10.id = var_13_6.GetVirtualId(var_13_1.id, var_10.id)
			...
			if var_13_3:getMemberById(iter_13_1.uid) and var_10:GetAssaultFleet() then
				::label_13_0::

				var_1_10013 = var_11
				var_13_8 = var_11.GetShipByRealId(var_1_10013, iter_13_1.uid, iter_13_1.id)
			end

			if var_13_8 then
				GuildBossMissionShip = var_1_10013
				var_1_10013 = var_1_10013.New(var_13_8)
				table = var_14

				var_14.insert(var_13_5, {
					member = var_10,
					ship = var_1_10013
				})
			end
...
function var_0_1.GetDownloadResShips(arg_14_0)
	...
	local var_14_2 = arg_14_0:GetShips()
	local var_14_3 = {}
	...
	for iter_14_0, iter_14_1 in var_1_10004(var_14_2) do
		if iter_14_1.member.id ~= var_14_1.id then
			...
			local var_14_4 = var_9.insert
			local var_14_5 = var_14_3
			local var_14_6 = iter_14_1.ship

			var_14_4(var_14_5, var_11.getPainting(var_14_6))
		end
	end
...
function var_0_1.ExistSubShip(arg_16_0)
	...
	return #var_16_1(var_16_0, var_1_10003.Submarine) > 0
end
...
function var_0_1.ExistSameKindShip(arg_26_0, arg_26_1)
	...
	local var_26_1 = arg_26_0.GetShips(var_26_0)

	pairs = var_26_0

	for iter_26_0, iter_26_1 in var_26_0(var_26_1) do
		local var_26_2 = iter_26_1.ship

		if var_8.isSameKind(var_26_2, arg_26_1) then
			return true
		end
	end
...
function var_0_1.IsLegal(arg_27_0)
	...
	local var_27_7 = var_1_10008(var_1_10009)
	local var_27_8 = var_8.getRawData(var_27_7).id

	ipairs = var_27_7

	for iter_27_0, iter_27_1 in var_27_7(var_27_0) do
		if iter_27_1 then
			...
			if var_1_10014 == var_27_9.Main then
				var_27_1 = var_27_1 + 1
		...
		if iter_27_1 then
			...
			if var_1_10014 == var_27_10.Vanguard then
				var_27_2 = var_27_2 + 1
		...
		if iter_27_1 then
			...
			if var_1_10014 == var_27_11.Submarine then
				var_27_3 = var_27_3 + 1
		...
		local var_27_12 = var_15.ShipFlagMgr.GetInstance()

		if var_15.GetShipFlag(var_27_12, var_1_10014, "inEvent") then
			local var_27_13 = false

			i18n = var_27_12

			local var_27_14 = "guild_boss_formation_exist_event_ship"
			local var_27_15 = iter_27_1.ship
			local var_27_16 = var_27_12(var_27_14, var_18.getConfig(var_27_15, "name"))
	...
	if var_27_1 > 3 or var_27_2 > 3 or var_27_3 > 3 then
		local var_27_17 = false

		i18n = var_10

		local var_27_18 = var_10("guild_boss_fleet_cnt_invalid")

		return
	end

	local var_27_19 = var_27_5 > 0 and var_27_4 > 0
	local var_27_20

	if 0 < var_27_1 and 0 < var_27_2 and not var_27_19 then
		i18n = var_11
		var_27_20 = var_11("guild_boss_formation_not_exist_self_ship")
	else
		i18n = var_11
		var_27_20 = var_11("guild_fleet_is_legal")
	end

	if arg_27_0:IsMainFleet() then
		return var_27_1 > 0 and var_27_2 > 0 and var_27_19, var_27_20
	else
		return true
	end
...
function var_0_1.ResortShips(arg_28_0, arg_28_1)
	local function var_28_0(arg_29_0)
		...
		for iter_29_0, iter_29_1 in var_2(arg_28_1) do
...
function var_0_1.updateCommanderSkills(arg_37_0)
	...
	while var_37_0 > 0 do
		...
		if not arg_37_0:findCommanderBySkillId(var_37_1.id) then
			local var_37_2 = var_37_1
			local var_37_3 = var_37_1.GetSystem(var_37_2)
	...
	local var_37_5 = arg_37_0.getCommanders(var_37_4)
	...
	for iter_37_0, iter_37_1 in var_37_4(var_37_5) do
		...
		for iter_37_2, iter_37_3 in var_1_10008(iter_37_1:getSkills()) do
			...
			for iter_37_4, iter_37_5 in var_1_10013(iter_37_3:getTacticSkill()) do
				...
				local var_37_6 = arg_37_0.skills

				FleetSkill = var_1_10020
				var_1_10020 = var_1_10020.New
				FleetSkill = var_1_10021

				var_1_10018(var_37_6, var_1_10020(var_1_10021.SystemCommanderNeko, iter_37_5))
			end
		end
	end
...
function var_0_1.findCommanderBySkillId(arg_40_0, arg_40_1)
	...
	local var_40_1 = arg_40_0.getCommanders(var_40_0)
...
function var_0_1.BuildBattleBuffList(arg_45_0)
	...
	local var_45_3, var_45_4 = var_45_1(var_45_2, var_1_10004.TypeBattleBuff)
	...
	if var_45_3 then
		...
		if 0 < var_45_5 then
			...
			for iter_45_0, iter_45_1 in var_5(var_45_3) do
				...
				var_45_6[var_11] = var_45_7
				table = var_45_7

				var_45_7.insert(var_45_6[var_11], iter_45_1)
			end
	...
	local var_45_9 = arg_45_0.getCommanders(var_45_8)

	pairs = var_45_8

	for iter_45_4, iter_45_5 in var_45_8(var_45_9) do
		local var_45_10 = iter_45_5
		local var_45_11 = iter_45_5.getTalents(var_45_10)

		ipairs = var_45_10

		for iter_45_6, iter_45_7 in var_45_10(var_45_11) do
			local var_45_12 = #iter_45_7:getBuffsAddition()
			...
			if 0 < var_45_12 then
				...
				for iter_45_10, iter_45_11 in var_18(var_16) do
					...
					var_1_10023.insert(var_45_13, iter_45_11)
				end
			end
		end
	end
...
function var_0_1.ExistCommander(arg_46_0, arg_46_1)
	...
	local var_46_1 = arg_46_0.getCommanders(var_46_0)
...
function var_0_1.ExistInvalidCommanders(arg_47_0)
	...
	local var_47_1 = arg_47_0.getCommanders(var_47_0)

	getProxy = var_47_0
	CommanderProxy = var_1_10003

	local var_47_2 = var_47_0(var_1_10003)

	pairs = var_1_10003

	for iter_47_0, iter_47_1 in var_1_10003(var_47_1) do
		if not var_47_2:getCommanderById(iter_47_1.id) then
			return true
		end
	end
...
function var_0_1.getCommandersAddition(arg_49_0)
	...
	for iter_49_0, iter_49_1 in var_1_10002(var_1_10003.PROPERTIES) do
		local var_49_1 = 0
...
function var_0_1.getCommandersTalentDesc(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10002(arg_50_0:getCommanders()) do
		...
		local var_50_2 = iter_50_1.getTalentsDesc(var_50_1)

		pairs = var_50_1

		for iter_50_2, iter_50_3 in var_50_1(var_50_2) do
...
function var_0_1.ExistAnyCommander(arg_51_0)
	...
	local var_51_1 = arg_51_0.getCommanders(var_51_0)

	table = var_51_0

	return var_51_0.getCount(var_51_1) ~= 0
end
