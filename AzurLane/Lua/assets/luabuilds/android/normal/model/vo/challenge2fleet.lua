...
function var_0_1.getFleetType(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10001(arg_4_0.ships) do
		...
		local var_4_1 = iter_4_1.getTeamType(var_4_0)

		TeamType = var_4_0

		if var_4_1 == var_4_0.Submarine then
			FleetType = var_4_1

			return var_4_1.Submarine
		end
	end
...
function var_0_1.getShips(arg_5_0, arg_5_1)
	...
	local var_5_2 = arg_5_0.getFleetType(var_5_1)

	FleetType = var_5_1

	local var_5_3

	if var_5_2 == var_5_1.Normal then
		_ = var_5_3
		var_5_3 = var_5_3.each

		local var_5_4 = arg_5_0
		local var_5_5 = arg_5_0.getShipsByTeam

		TeamType = var_1_10007

		var_5_3(var_5_5(var_5_4, var_1_10007.Main, arg_5_1), function(arg_6_0)
			table = var_2_10001
		...
		local var_5_7 = arg_5_0.getShipsByTeam

		TeamType = var_1_10007

		var_5_3(var_5_7(var_5_6, var_1_10007.Vanguard, arg_5_1), function(arg_7_0)
			table = var_2_10001
		...
		if var_5_2 == var_5_3.Submarine then
			_ = var_4

			local var_5_8 = var_4.each
			local var_5_9 = arg_5_0
			local var_5_10 = arg_5_0.getShipsByTeam

			TeamType = var_1_10007

			var_5_8(var_5_10(var_5_9, var_1_10007.Submarine, arg_5_1), function(arg_8_0)
				table = var_2_10001
...
function var_0_1.buildBattleBuffList(arg_14_0)
	...
	local var_14_3, var_14_4 = var_14_1(var_14_2, var_1_10004.TypeBattleBuff)
	...
	if var_14_3 then
		...
		if 0 < var_14_5 then
			...
			for iter_14_0, iter_14_1 in var_5(var_14_3) do
				...
				var_14_6[var_11] = var_14_7
				table = var_14_7

				var_14_7.insert(var_14_6[var_11], iter_14_1)
			end
	...
	local var_14_9 = arg_14_0.getCommanders(var_14_8)

	pairs = var_14_8

	for iter_14_4, iter_14_5 in var_14_8(var_14_9) do
		local var_14_10 = iter_14_5
		local var_14_11 = iter_14_5.getTalents(var_14_10)

		ipairs = var_14_10

		for iter_14_6, iter_14_7 in var_14_10(var_14_11) do
			local var_14_12 = #iter_14_7:getBuffsAddition()
			...
			if 0 < var_14_12 then
				...
				for iter_14_10, iter_14_11 in var_18(var_16) do
					...
					var_1_10023.insert(var_14_13, iter_14_11)
				end
			end
		end
	end
