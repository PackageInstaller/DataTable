...
local var_0_6 = var_0_10005.ship_data_strengthen
...
function var_0_1.useSkin(arg_7_0, arg_7_1)
	...
	local var_7_1 = var_7_0.GetChangeSkinGroupId(var_2)

	ShipSkin = var_4

	local var_7_2 = var_4.GetChangeSkinGroupId(arg_7_1)
...
function var_0_1.getShipBgPrint(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_10_0.ship_skin_template[var_10_1]

	assert = var_1_10004

	var_1_10004(var_10_2, "ship_skin_template not exist: " .. var_10_1)
...
function var_0_1.getShipArmorName(arg_14_0)
	...
	local var_14_1 = arg_14_0.getShipArmor(var_14_0)

	ArmorType = var_14_0

	return var_14_0.Type2Name(var_14_1)
end
...
function var_0_1.getAircraftCount(arg_18_0)
	...
	for iter_18_0 = 1, 3 do
		...
		if arg_18_0.getEquip(var_18_3, iter_18_0) then
			...
			local var_18_5 = var_18_3.getConfigData(var_18_4).type

			table = var_10

			local var_18_6 = var_10.contains

			EquipType = var_1_10011

			if var_18_6(var_1_10011.AirDomainEquip, var_18_5) then
				defaultValue = var_10
				var_18_2[var_18_5] = var_10(var_18_2[var_18_5], 0) + var_18_0[iter_18_0]
			end
		end
	end
...
function var_0_1.getEnergeConfig(arg_21_0)
	...
	local var_21_1 = arg_21_0.getEnergy(var_21_0)

	ipairs = var_21_0
	pg = var_1_10003

	for iter_21_0, iter_21_1 in var_21_0(var_1_10003.energy_template.all) do
		pg = var_1_10007
		var_1_10007 = var_1_10007.energy_template[iter_21_1]
		type = var_1_10008

		if var_1_10008(iter_21_1) == "number" and var_1_10007.lower_bound <= var_21_1 and var_21_1 <= var_1_10007.upper_bound then
			return var_1_10007
		end
	end
...
function var_0_1.getIntimacyDetail(arg_29_0)
	...
	local var_29_1 = arg_29_0.getIntimacyMax(var_29_0)

	math = var_29_0

	local var_29_2 = var_29_0.floor(arg_29_0:getIntimacy() / 100)
end
...
function var_0_1.getIntimacyLevel(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_1_10002(var_1_10003.intimacy_template.all) do
		pg = var_1_10007
...
function var_0_1.getBaseList(arg_33_0)
	if arg_33_0:isBluePrintShip() then
		...
		local var_33_1 = arg_33_0.getBluePrint(var_33_0)

		assert = var_33_0

		var_33_0(var_33_1, "blueprint can not be nil" .. arg_33_0.configId)

		return var_33_1:getBaseList(arg_33_0)
	else
...
function var_0_1.getBreakOutLevel(arg_40_0)
	...
	var_1_10001(var_2.ship_data_statistics[arg_40_0], "必须存在配置" .. arg_40_0)
...
function var_0_1.Ctor(arg_41_0, arg_41_1)
	...
	if arg_41_1.propose then
		local var_41_1 = arg_41_1.propose

		var_41_2 = 0 < var_41_1
	end

	arg_41_0.propose = var_41_2
	arg_41_0.proposeTime = arg_41_1.propose

	if arg_41_0.intimacy then
		local var_41_3 = arg_41_0.intimacy

		if 10000 < var_41_3 and not arg_41_0.propose then
	...
	if arg_41_1.name and arg_41_1.name ~= "" then
		...
		var_2(var_1_10003.ship_data_statistics[arg_41_0.configId], "必须存在配置" .. arg_41_0.configId)
	...
	local var_41_4 = var_2.ship_data_group.get_id_list_by_group_type[arg_41_0.groupId][1]

	pg = var_3
	arg_41_0.bluePrintFlag = var_3.ship_data_group[var_41_4].handbook_type == 2
	...
	for iter_41_0, iter_41_1 in var_3(var_41_5) do
		local var_41_6

		if not arg_41_0:isBluePrintShip() then
			ShipModAttr = var_41_6
			var_41_6 = var_41_6.ID_TO_ATTR[iter_41_1.id]
			arg_41_0.strengthList[var_41_6] = iter_41_1.exp
		else
			table = var_41_6

			var_41_6.insert(arg_41_0.strengthList, {
				level = iter_41_1.id,
				exp = iter_41_1.exp
			})
		end
	...
	if arg_41_1.equip_info_list then
		...
		for iter_41_2, iter_41_3 in var_3(var_41_7) do
			local var_41_8 = arg_41_0.equipments
			...
			if iter_41_3.id > 0 then
				...
				local var_41_10 = arg_41_0.equipmentSkins
				local var_41_11
	...
	if arg_41_1.spweapon then
		...
		local var_41_13 = arg_41_0.UpdateSpWeapon

		SpWeapon = var_5

		var_41_13(var_41_12, var_5.CreateByNet(arg_41_1.spweapon))
	end
	...
	for iter_41_4, iter_41_5 in var_3(var_41_14) do
	...
	for iter_41_6, iter_41_7 in var_3(var_41_15) do
	...
	arg_41_0.createTime = var_41_16
	getProxy = var_41_16
	CollectionProxy = var_4

	local var_41_17

	var_41_17 = var_41_16(var_4) and var_3.shipGroups[arg_41_0.groupId] == nil
	arg_41_0.virgin = var_41_17

	local var_41_18 = {}

	pg = var_5
	var_41_18[1] = var_5.gameset.test_ship_config_1.key_value
	pg = var_5
	var_41_18[2] = var_5.gameset.test_ship_config_2.key_value
	pg = var_5
	var_41_18[3] = var_5.gameset.test_ship_config_3.key_value
	table = var_5

	if var_5.indexof(var_41_18, arg_41_0.configId) == 1 then
		arg_41_0.testShip = {
			2,
			3,
			4
	...
	local var_41_19 = var_6.intimacy_template

	pg = var_7
	arg_41_0.maxIntimacy = var_41_19[#var_7.intimacy_template.all].upper_bound
	...
	if not var_7.isHxSkin() then
		var_41_20 = arg_41_1.skin_id or 0
	end

	arg_41_0.phantomDic = {}

	arg_41_0:updateSkinId(var_41_20, 0)
	...
	for iter_41_8, iter_41_9 in var_7(var_41_21) do
	...
	arg_41_0.noChangeSkin = var_41_22
	...
	for iter_41_10, iter_41_11 in var_7(var_41_23) do
	...
	arg_41_0.proficiency = var_41_24
	...
	arg_41_0.commanderId = var_41_25
	...
	arg_41_0.activityNpc = var_41_26

	if var_0_1.isMetaShipByConfigID(arg_41_0.configId) then
		MetaCharacterConst = var_8

		local var_41_27 = var_8.GetMetaShipGroupIDByConfigID(arg_41_0.configId)
	...
	if not arg_50_0.noChangeSkin then
		...
		if var_3(arg_50_0.id) then
			...
			if var_3.IsChangeSkin(var_50_0) then
				...
				if var_50_1(var_4.GetChangeSkinGroupId(var_50_0), arg_50_0:GetShipPhantomMark()) then
					return var_3
				end
			end
		end
...
function var_0_1.RevertAsmrSkin(arg_51_0)
	...
	if not arg_51_0.noChangeSkin then
		...
		if var_2(arg_51_0.id) then
			...
			if var_2.IsChangeSkin(var_51_0) then
				ShipSkin = var_2

				local var_51_1 = var_2.GetChangeSkinCustomDataId(var_51_0, "asmr") == 1 and true or false

				ShipSkin = var_3

				local var_51_2 = var_3.GetChangeSkinCustomDataId(var_51_0, "index") == 1 and true or false

				if var_51_1 and not var_51_2 then
					ShipSkin = var_4

					local var_51_3 = var_4.GetChangeSkinMainId(var_51_0)

					ShipSkin = var_5

					var_5.SetStoreChangeSkinId(var_51_3, arg_51_0:GetShipPhantomMark())
				end
			end
		end
	end
...
function var_0_1.getAllShipPhantomMarks(arg_54_0)
	...
	for iter_54_0 = 0, var_54_0 do
		if iter_54_0 == 0 or arg_54_0.phantomDic[iter_54_0] then
			...
			var_1_10007(var_54_2, var_1_10009.PackMark(arg_54_0.id, iter_54_0))
		end
	end
...
function var_0_1.getAllShipPhantom(arg_55_0)
	...
	for iter_55_0 = 0, var_55_0 do
		if iter_55_0 == 0 or arg_55_0.phantomDic[iter_55_0] then
			...
			var_1_10007(var_55_2, var_1_10009.Create(arg_55_0, iter_55_0))
		end
	end
...
function var_0_1.getPrefab(arg_63_0, arg_63_1)
	...
	if arg_63_0.hasEquipmentSkinInPos(var_63_1, var_0_3) then
		var_63_1 = arg_63_0
		var_63_2 = arg_63_0.getEquip(var_63_1, var_0_3)
		var_63_0 = var_0_8[var_63_2:getSkinId()].ship_skin_id ~= 0 and var_63_1 or var_63_0
	end

	pg = var_63_2

	local var_63_3 = var_63_2.ship_skin_template[var_63_0]

	assert = var_63_1

	var_63_1(var_63_3, "ship_skin_template not exist: " .. arg_63_0.configId .. " " .. var_63_0)
...
function var_0_1.IsDoubleSkin(arg_64_0)
	...
	local var_64_2 = var_64_0.ship_skin_template[var_64_1]

	assert = var_1_10003

	var_1_10003(var_64_2, "ship_skin_template not exist: " .. arg_64_0.configId .. " " .. var_64_1)
...
function var_0_1.getPainting(arg_66_0)
	...
	local var_66_2 = var_66_0.ship_skin_template[var_66_1]

	assert = var_1_10003

	var_1_10003(var_66_2, "ship_skin_template not exist: " .. arg_66_0.configId .. " " .. var_66_1)
...
function var_0_1.GetSkinConfig(arg_67_0, arg_67_1)
	...
	local var_67_2 = var_67_0.ship_skin_template[var_67_1]

	assert = var_1_10004

	var_1_10004(var_67_2, "ship_skin_template not exist: " .. arg_67_0.configId .. " " .. var_67_1)
...
function var_0_1.getRemouldPainting(arg_68_0)
	...
	local var_68_2 = var_68_0.ship_skin_template[var_68_1]

	assert = var_1_10003

	var_1_10003(var_68_2, "ship_skin_template not exist: " .. arg_68_0.configId .. " " .. var_68_1)
...
function var_0_1.updateEquip(arg_71_0, arg_71_1, arg_71_2)
	...
	if arg_71_2 then
		...
		if not var_1_10005(arg_71_2) then
			var_71_2 = false
		end
		...
		if var_71_0 then
			...
			var_1_10006 = var_71_2(var_1_10006)

			var_71_2.OnShipEquipsRemove(var_1_10006, var_71_0, arg_71_0.id, arg_71_1)

			var_1_10006 = var_71_0

			var_71_0.setSkinId(var_1_10006, 0)

			pg = var_71_2
			var_1_10006 = var_71_2.m02
			var_71_2 = var_71_2.sendNotification
			BayProxy = var_7

			var_71_2(var_1_10006, var_7.SHIP_EQUIPMENT_REMOVED, var_71_3(var_71_0))
		end
		...
		if arg_71_2 then
			...
			local var_71_4 = var_71_2(var_1_10006)
			...
			var_71_6(var_71_5, var_7.SHIP_EQUIPMENT_ADDED, var_71_3(arg_71_2))
		end
...
function var_0_1.reletiveEquipSkin(arg_73_0, arg_73_1)
	if arg_73_0.equipments[arg_73_1] and arg_73_0.equipmentSkins[arg_73_1] ~= 0 then
		...
		if var_73_1.contains(var_73_0, var_73_2) then
...
function var_0_1.updateEquipmentSkin(arg_74_0, arg_74_1, arg_74_2)
	...
	if arg_74_2 and arg_74_2 > 0 then
		...
		local var_74_1 = arg_74_0.getSkinTypes(var_74_0, arg_74_1)

		pg = var_74_0

		local var_74_2 = var_74_0.equip_skin_template[arg_74_2].equip_type
		local var_74_3 = false

		ipairs = var_1_10006

		for iter_74_0, iter_74_1 in var_1_10006(var_74_1) do
			ipairs = var_1_10011

			for iter_74_2, iter_74_3 in var_1_10011(var_74_2) do
		...
		if not var_74_3 then
			assert = var_6

			var_6(var_74_3, "部位" .. arg_74_1 .. " 无法穿戴皮肤 " .. arg_74_2)

			return
		end

		if arg_74_0.equipments[arg_74_1] then
			local var_74_4 = arg_74_0.equipments[arg_74_1]
			local var_74_5

			if not var_6.getType(var_74_4) then
				var_74_5 = false
			end

			local var_74_6 = arg_74_0.equipmentSkins

			var_74_6[arg_74_1] = arg_74_2

			if var_74_5 then
				table = var_74_6

				if var_74_6.contains(var_74_2, var_74_5) then
					local var_74_7 = arg_74_0.equipments[arg_74_1]

					var_74_6.setSkinId(var_74_7, arg_74_0.equipmentSkins[arg_74_1])
			...
			if var_74_5 then
				...
				if not var_74_6.contains(var_74_2, var_74_5) then
					local var_74_8 = arg_74_0.equipments[arg_74_1]

					var_7.setSkinId(var_74_8, 0)
				end
			end
			...
			if false then
				...
				if arg_74_0.equipments[arg_74_1] then
					local var_74_9 = arg_74_0.equipments[arg_74_1]

					var_3.setSkinId(var_74_9, 0)
				end
			end
...
function var_0_1.checkCanEquipSkin(arg_79_0, arg_79_1, arg_79_2)
	...
	local var_79_2 = var_79_0.equip_skin_template[arg_79_2].equip_type

	ipairs = var_5

	for iter_79_0, iter_79_1 in var_5(var_79_1) do
		table = var_1_10010
...
function var_0_1.isAllMetaSkillLevelMax(arg_85_0)
	...
	for iter_85_0, iter_85_1 in var_3(var_85_1) do
...
function var_0_1.isAllMetaSkillLock(arg_86_0)
	...
	for iter_86_0, iter_86_1 in var_1_10003(var_86_0) do
...
function var_0_1.getShipProperties(arg_90_0)
	...
	if arg_90_0:isBluePrintShip() then
		...
		local var_90_2 = arg_90_0.getBluePrint(var_90_1)

		assert = var_90_1

		var_90_1(var_90_2, "blueprint can not be nil" .. arg_90_0.configId)

		var_1_10004 = var_90_2

		local var_90_3 = var_90_2.getTotalAdditions(var_1_10004)

		pairs = var_1_10004

		for iter_90_0, iter_90_1 in var_1_10004(var_90_3) do
			var_1_10009 = var_90_0[iter_90_0]
			calcFloor = var_1_10010
			var_90_0[iter_90_0] = var_1_10009 + var_1_10010(iter_90_1)
		end
	...
	elseif arg_90_0:isMetaShip() then
		...
		for iter_90_2, iter_90_3 in var_2(var_90_0) do
			local var_90_4 = var_90_0[iter_90_2]

			var_1_10009 = arg_90_0.metaCharacter
			var_90_0[iter_90_2] = var_90_4 + var_8.getAttrAddition(var_1_10009, iter_90_2)
		end
		...
		local var_90_5 = var_2.ship_data_template[arg_90_0.configId].strengthen_id
		local var_90_6 = var_0_6[var_90_5]

		pairs = var_1_10004

		for iter_90_4, iter_90_5 in var_1_10004(arg_90_0.strengthList) do
			ShipModAttr = var_1_10009
			var_1_10009 = var_1_10009.ATTR_TO_INDEX[iter_90_4]
			math = var_1_10010
			var_1_10010 = var_1_10010.min(iter_90_5, var_90_6.durability[var_1_10009] * var_90_6.level_exp[var_1_10009])
			math = var_11

			local var_90_7 = var_11.max(arg_90_0:getModExpRatio(iter_90_4), 1)
			local var_90_8 = var_90_0[iter_90_4]

			calcFloor = var_13
			var_90_0[iter_90_4] = var_90_8 + var_13(var_1_10010 / var_90_7)
		end
		...
		for iter_90_6, iter_90_7 in var_4(arg_90_0.transforms) do
			...
			for iter_90_8 = 1, iter_90_7.level do
				...
				for iter_90_9, iter_90_10 in var_1_10015(var_90_0) do
...
function var_0_1.getTechNationAddition(arg_91_0, arg_91_1)
	...
	local var_91_0 = var_1_10002(var_1_10003)
	local var_91_1 = arg_91_0
	local var_91_2 = arg_91_0.getConfig(var_91_1, "type")

	ShipType = var_91_1

	if var_91_2 ~= var_91_1.DaoQuV then
		ShipType = var_4

		if var_91_2 == var_4.DaoQuM then
			ShipType = var_4
			var_91_2 = var_4.QuZhu
		end

		return var_91_0:getShipAddition(var_91_2, arg_91_1)
	end
end
...
function var_0_1.getTechNationMaxAddition(arg_92_0, arg_92_1)
	...
	local var_92_0 = var_1_10002(var_1_10003)
...
function var_0_1.getEquipProficiencyList(arg_94_0)
	...
	local var_94_1 = arg_94_0.getConfigTable(var_94_0)

	Clone = var_94_0

	local var_94_2 = var_94_0(var_94_1.equipment_proficiency)
	local var_94_4

	if arg_94_0:isBluePrintShip() then
		local var_94_3 = arg_94_0

		var_94_4 = arg_94_0.getBluePrint(var_94_3)
		assert = var_94_3

		var_94_3(var_94_4, "blueprint can not be nil >>>" .. arg_94_0.groupId)

		var_94_2 = var_94_4:getEquipProficiencyList(arg_94_0)
	else
		ipairs = var_94_4

		for iter_94_0, iter_94_1 in var_94_4(var_94_2) do
			local var_94_5 = 0
			...
			for iter_94_2, iter_94_3 in var_1_10009(arg_94_0.transforms) do
				...
				for iter_94_4 = 1, iter_94_3.level do
					...
					if var_94_6["equipment_proficiency_" .. iter_94_0] then
						var_94_5 = var_94_5 + var_94_6["equipment_proficiency_" .. iter_94_0]
					end
				end
			end

			var_94_2[iter_94_0] = iter_94_1 + var_94_5
		end
	end
...
function var_0_1.getBaseProperties(arg_95_0)
	...
	local var_95_1 = arg_95_0.getConfigTable(var_95_0)

	assert = var_95_0

	var_95_0(var_95_1, "配置表没有这艘船" .. arg_95_0.configId)
	...
	for iter_95_0, iter_95_1 in var_4(var_0_1.PROPERTIES) do
		var_95_2[iter_95_1] = arg_95_0:getGrowthForAttr(iter_95_1)
		var_95_3[iter_95_1] = var_95_2[iter_95_1]
	end

	ipairs = var_4

	for iter_95_2, iter_95_3 in var_4(arg_95_0:getConfig("lock")) do
		var_95_3[iter_95_3] = var_95_2[iter_95_3]
	end

	ipairs = var_4

	for iter_95_4, iter_95_5 in var_4(var_0_1.DIVE_PROPERTIES) do
		var_95_3[iter_95_5] = var_95_1[iter_95_5]
	end

	ipairs = var_4

	for iter_95_6, iter_95_7 in var_4(var_0_1.SONAR_PROPERTIES) do
		var_95_3[iter_95_7] = 0
	end
...
function var_0_1.getGrowthForAttr(arg_96_0, arg_96_1)
	...
	local var_96_2 = var_96_0.indexof(var_0_1.PROPERTIES, arg_96_1)

	pg = var_4

	local var_96_3 = var_4.gameset.extra_attr_level_limit.key_value
...
function var_0_1.getNeedModExp(arg_102_0)
	...
	for iter_102_0, iter_102_1 in var_1_10002(var_1_10003.ID_TO_ATTR) do
...
function var_0_1.getEquipmentProperties(arg_104_0)
	...
	local var_104_3 = arg_104_0.getActiveEquipments(var_104_2)

	ipairs = var_104_2

	for iter_104_8, iter_104_9 in var_104_2(var_104_3) do
		if iter_104_9 then
			local var_104_4 = iter_104_9
			local var_104_5 = iter_104_9.GetAttributes(var_104_4)

			ipairs = var_104_4

			for iter_104_10, iter_104_11 in var_104_4(var_104_5) do
			...
			local var_104_6 = iter_104_9
			local var_104_7 = iter_104_9.GetPropertyRate(var_104_6)

			pairs = var_104_6

			for iter_104_12, iter_104_13 in var_104_6(var_104_7) do
				math = iter_104_15
				var_104_1[iter_104_12] = iter_104_15.max(var_104_1[iter_104_12], iter_104_13)
			end

			local var_104_8 = iter_104_9

			if iter_104_9.GetSonarProperty(var_104_8) then
				pairs = var_104_8

				for iter_104_14, iter_104_15 in var_104_8(var_11) do
					var_104_0[iter_104_14] = var_104_0[iter_104_14] + iter_104_15
				end
			end

			local var_104_9 = iter_104_9

			if iter_104_9.GetAntiSirenPower(var_104_9) then
				AttributeType = var_104_9

				local var_104_10 = var_104_9.AntiSiren

				AttributeType = iter_104_12
				var_104_0[var_104_10] = var_104_0[iter_104_12.AntiSiren] + var_12 / 16
			end
		end
	end
	...
	;(function()
		...
		local var_105_1 = var_0
		local var_105_2 = var_0.GetPropertiesInfo(var_105_1).attrs

		ipairs = var_105_1

		for iter_105_0, iter_105_1 in var_105_1(var_105_2) do
...
function var_0_1.getSkillEffects(arg_106_0)
	...
	local var_106_1 = arg_106_0.getShipSkillEffects(var_106_0)

	_ = var_106_0

	var_106_0.each(arg_106_0:getEquipmentSkillEffects(), function(arg_107_0)
		table = var_2_10001

		var_2_10001.insert(var_106_1, arg_107_0)
...
function var_0_1.getShipSkillEffects(arg_108_0)
	...
	local var_108_2 = arg_108_0.getSkillList(var_108_1)

	ipairs = var_108_1

	for iter_108_0, iter_108_1 in var_108_1(var_108_2) do
		local var_108_3 = arg_108_0
		local var_108_4 = arg_108_0.RemapSkillId(var_108_3, iter_108_1, true)

		pg = var_108_3

		local var_108_5 = var_108_3.buffCfg["buff_" .. var_108_4]

		arg_108_0:FilterActiveSkill(var_108_0, var_108_5, arg_108_0.skills[iter_108_1])
	end
...
function var_0_1.getEquipmentSkillEffects(arg_109_0)
	local var_109_0 = {}
	local var_109_1 = arg_109_0
	local var_109_2 = arg_109_0.getActiveEquipments(var_109_1)

	ipairs = var_109_1

	for iter_109_0, iter_109_1 in var_109_1(var_109_2) do
		local var_109_3
		local var_109_4
		...
		if iter_109_1 then
			...
			var_1_10010 = iter_109_1

			if iter_109_1.getConfig(var_1_10010, "skill_id")[1] then
				var_1_10010 = iter_109_1
				var_109_4 = iter_109_1.getConfig(var_1_10010, "skill_id")[1][1]
			end
		end

		if var_109_4 then
			pg = var_1_10010
			var_109_3 = var_1_10010.buffCfg["buff_" .. var_109_4]
		end

		arg_109_0:FilterActiveSkill(var_109_0, var_109_3)
	end
...
function var_0_1.getEquipmentGearScore(arg_112_0)
	...
	local var_112_2 = arg_112_0.getActiveEquipments(var_112_1)

	ipairs = var_112_1

	for iter_112_0, iter_112_1 in var_112_1(var_112_2) do
		if iter_112_1 then
...
function var_0_1.getProperties(arg_113_0, arg_113_1, arg_113_2, arg_113_3, arg_113_4)
	...
	for iter_113_0, iter_113_1 in var_1_10014(var_0_1.PROPERTIES) do
		...
		if iter_113_1 == iter_113_2.Speed then
			...
			calcFloor = var_24
			calcFloor = iter_113_3
			var_113_3[iter_113_1] = var_24(iter_113_3(var_113_3[iter_113_1]) * var_1_10021 * var_113_12) + var_113_11 + var_113_4[iter_113_1] + var_113_13
		end
	end
...
function var_0_1.getShipCombatPower(arg_115_0, arg_115_1)
	...
	local var_115_2 = var_115_1[var_115_0.Durability] / 5

	AttributeType = var_4

	local var_115_3 = var_115_2 + var_115_1[var_4.Cannon]
...
function var_0_1.cosumeEnergy(arg_116_0, arg_116_1)
	...
	var_116_1(var_116_0, var_1_10004.max(arg_116_0:getEnergy() - arg_116_1, 0))
...
function var_0_1.getLevelExpConfig(arg_122_0, arg_122_1)
	...
	ShipRarity = var_122_0

	if var_122_1 == var_122_0.SSR then
		Clone = var_122_1
		getConfigFromLevel1 = var_3
		var_122_1.exp = var_122_1(var_3(var_0_7, arg_122_1 or arg_122_0.level)).exp_ur
...
function var_0_1.addExp(arg_125_0, arg_125_1, arg_125_2)
	...
	if arg_125_0.level == var_125_0 then
		local var_125_1 = arg_125_0.exp

		pg = var_1_10005

		if var_125_1 >= var_1_10005.gameset.exp_overflow_max.key_value then
			return
		end

		LOCK_FULL_EXP = var_125_1

		if var_125_1 or not arg_125_2 or not arg_125_0:CanAccumulateExp() then
			arg_125_1 = 0
		end
	end
	...
	while arg_125_0:canLevelUp() do
		local var_125_3 = arg_125_0.exp

		var_1_10007 = arg_125_0
		arg_125_0.exp = var_125_3 - arg_125_0.getLevelExpConfig(var_1_10007).exp_interval
		math = var_5
		arg_125_0.level = var_5.min(arg_125_0.level + 1, var_125_0)
		var_125_2 = true
	end
	...
	if arg_125_0.level == var_125_0 then
		if arg_125_2 and arg_125_0:CanAccumulateExp() then
			...
			local var_125_4 = var_5.min
			local var_125_5 = arg_125_0.exp

			pg = var_1_10007
			arg_125_0.exp = var_125_4(var_125_5, var_1_10007.gameset.exp_overflow_max.key_value)
		elseif var_125_2 then
			arg_125_0.exp = 0
		end
	end
...
function var_0_1.updateMaxLevel(arg_130_0, arg_130_1)
	...
	local var_130_1 = arg_130_0.getConfigMaxLevel(var_130_0)

	math = var_130_0

	local var_130_2 = var_130_0.max

	math = var_1_10004
	arg_130_0.maxLevel = var_130_2(var_1_10004.min(var_130_1, arg_130_1), arg_130_0.maxLevel)
...
function var_0_1.canUpgradeMaxLevel(arg_139_0)
	...
	if not arg_139_0.isReachNextMaxLevel(var_139_0) then
		var_139_1 = false
		i18n = var_139_0
		var_139_0 = var_139_0("upgrade_to_next_maxlevel_failed")
		...
		local var_139_4 = var_139_2(var_1_10003)
		local var_139_5 = arg_139_0
		local var_139_6 = arg_139_0.getNextMaxLevelConsume(var_139_5)

		pairs = var_139_5

		for iter_139_0, iter_139_1 in var_139_5(var_139_6) do
			local var_139_7 = iter_139_1.type

			DROP_TYPE_RESOURCE = var_1_10010

			if var_139_7 == var_1_10010 then
				var_1_10010 = var_139_3

				if var_139_3.getResById(var_1_10010, iter_139_1.id) < iter_139_1.count then
				...
				local var_139_9 = iter_139_1.type

				DROP_TYPE_ITEM = var_1_10010

				if var_139_9 == var_1_10010 then
					var_1_10010 = var_139_4

					if var_139_4.getItemCountById(var_1_10010, iter_139_1.id) < iter_139_1.count then
						local var_139_10 = false
...
function var_0_1.getStartBattleExpend(arg_142_0)
	...
	if var_142_0(var_1_10002.SubShipType, arg_142_0:getShipType()) then
		return 0
	else
		pg = var_1
...
function var_0_1.getEndBattleExpend(arg_143_0)
	...
	local var_143_2 = arg_143_0.getLevelExpConfig(var_143_1)

	math = var_143_1

	return (var_143_1.floor(var_143_0.oil_at_end * var_143_2.fight_oil_ratio / 16))
end
...
function var_0_1.getShipAmmo(arg_145_0)
	...
	local var_145_2 = var_145_1(var_145_0, var_1_10003.Ammo)

	pairs = var_145_0

	for iter_145_0, iter_145_1 in var_145_0(arg_145_0:getAllSkills()) do
		tonumber = var_1_10007

		local var_145_3 = iter_145_0

		string = var_1_10009
		var_1_10007 = var_1_10007(var_145_3 .. var_1_10009.format("%.2d", iter_145_1.level))
		pg = var_8

		if var_8.skill_benefit_template[var_1_10007] and arg_145_0:IsBenefitSkillActive(var_8) and (var_8.type == var_0_1.BENEFIT_EQUIP or var_8.type == var_0_1.BENEFIT_SKILL) then
			defaultValue = var_1_10009
			var_145_2 = var_145_2 + var_1_10009(var_8.effect[1], 0)
		end
	end

	local var_145_4 = arg_145_0
	local var_145_5 = arg_145_0.getActiveEquipments(var_145_4)

	ipairs = var_145_4

	for iter_145_2, iter_145_3 in var_145_4(var_145_5) do
...
function var_0_1.getHuntingLv(arg_146_0)
	...
	local var_146_1 = arg_146_0.getConfig(var_146_0, "huntingrange_level")

	pairs = var_146_0

	for iter_146_0, iter_146_1 in var_146_0(arg_146_0:getAllSkills()) do
		tonumber = var_1_10007

		local var_146_2 = iter_146_0

		string = var_1_10009
		var_1_10007 = var_1_10007(var_146_2 .. var_1_10009.format("%.2d", iter_146_1.level))
		pg = var_8

		if var_8.skill_benefit_template[var_1_10007] and arg_146_0:IsBenefitSkillActive(var_8) and (var_8.type == var_0_1.BENEFIT_EQUIP or var_8.type == var_0_1.BENEFIT_SKILL) then
			defaultValue = var_1_10009
			var_146_1 = var_146_1 + var_1_10009(var_8.effect[2], 0)
		end
	end

	local var_146_3 = arg_146_0
	local var_146_4 = arg_146_0.getActiveEquipments(var_146_3)

	ipairs = var_146_3

	for iter_146_2, iter_146_3 in var_146_3(var_146_4) do
		if iter_146_3 and iter_146_3:getConfig("equip_parameters").hunting_lv then
			var_146_1 = var_146_1 + var_8
		end
	end

	math = var_3

	return (var_3.min(var_146_1, arg_146_0:getMaxHuntingLv()))
end
...
function var_0_1.getMapAuras(arg_147_0)
	...
	for iter_147_0, iter_147_1 in var_1_10002(arg_147_0:getAllSkills()) do
		...
		string = var_1_10009
		var_1_10007 = var_1_10007(var_147_1 .. var_1_10009.format("%.2d", iter_147_1.level))
		pg = var_8

		if var_8.skill_benefit_template[var_1_10007] and arg_147_0:IsBenefitSkillActive(var_8) and var_8.type == var_0_1.BENEFIT_MAP_AURA then
			var_1_10009 = {
				id = var_8.effect[1],
			...
			var_10.insert(var_147_0, var_1_10009)
		end
	end
...
function var_0_1.getMapAids(arg_148_0)
	...
	for iter_148_0, iter_148_1 in var_1_10002(arg_148_0:getAllSkills()) do
		...
		string = var_1_10009
		var_1_10007 = var_1_10007(var_148_1 .. var_1_10009.format("%.2d", iter_148_1.level))
		pg = var_8

		if var_8.skill_benefit_template[var_1_10007] and arg_148_0:IsBenefitSkillActive(var_8) and var_8.type == var_0_1.BENEFIT_AID then
			var_1_10009 = {
				id = var_8.effect[1],
			...
			var_10.insert(var_148_0, var_1_10009)
		end
	end
...
function var_0_1.IsBenefitSkillActive(arg_149_0, arg_149_1)
	...
	elseif arg_149_1.type == var_0_1.BENEFIT_EQUIP then
		...
		local var_149_2 = arg_149_0
		local var_149_3 = arg_149_0.getAllEquipments(var_149_2)

		ipairs = var_149_2

		for iter_149_0, iter_149_1 in var_149_2(var_149_3) do
			if iter_149_1 then
				table = var_1_10010
...
function var_0_1.getHuntingRange(arg_151_0, arg_151_1)
	local var_151_0 = arg_151_0
	local var_151_1 = arg_151_0.getConfig(var_151_0, "hunting_range")

	Clone = var_151_0

	local var_151_2 = var_151_0(var_151_1[1])
	local var_151_3

	if not arg_151_1 then
		::label_151_0::

		var_1_10005 = arg_151_0
		var_151_3 = arg_151_0.getHuntingLv(var_1_10005)
	end

	math = var_1_10005

	local var_151_4 = var_1_10005.min(var_151_3, arg_151_0:getMaxHuntingLv())

	for iter_151_0 = 2, var_151_4 do
		_ = var_1_10009

		var_1_10009.each(var_151_1[iter_151_0], function(arg_152_0)
			table = var_2_10001

			var_2_10001.insert(var_151_2, {
				arg_152_0[1],
				arg_152_0[2]
			})
...
function var_0_1.getTriggerSkills(arg_153_0)
	local var_153_0 = {}
	local var_153_1 = arg_153_0
	local var_153_2 = arg_153_0.getSkillEffects(var_153_1)

	_ = var_153_1

	var_153_1.each(var_153_2, function(arg_154_0)
...
function var_0_1.GetEquipmentSkills(arg_155_0)
	local var_155_0 = {}
	local var_155_1 = arg_155_0
	local var_155_2 = arg_155_0.getActiveEquipments(var_155_1)

	ipairs = var_155_1

	for iter_155_0, iter_155_1 in var_155_1(var_155_2) do
		if iter_155_1 and iter_155_1:getConfig("skill_id")[1] then
			unpack = var_8

			local var_155_3, var_155_4 = var_8(iter_155_1:getConfig("skill_id")[1])
...
function var_0_1.getAllSkills(arg_157_0)
	...
	for iter_157_0, iter_157_1 in var_2(arg_157_0:GetEquipmentSkills()) do
...
function var_0_1.calReturnRes(arg_165_0)
	...
	local var_165_0 = var_1_10001.ship_data_by_type[arg_165_0:getShipType()].distory_resource_gold_ratio
	local var_165_1 = var_1.distory_resource_oil_ratio

	pg = var_1_10004

	local var_165_2 = var_1_10004.ship_data_by_star[arg_165_0:getConfig("rarity")].destory_item

	return var_165_0, 0, var_165_2
end
...
function var_0_1.canEquipAtPos(arg_168_0, arg_168_1, arg_168_2)
	...
	for iter_168_0, iter_168_1 in var_5(arg_168_0.equipments) do
		if iter_168_1 and iter_168_0 ~= arg_168_2 and iter_168_1:getConfig("equip_limit") ~= 0 and arg_168_1:getConfig("equip_limit") == iter_168_1:getConfig("equip_limit") then
			...
			local var_168_3 = var_11("ship_equip_same_group_equipment")
...
function var_0_1.isForbiddenAtPos(arg_169_0, arg_169_1, arg_169_2)
	...
	if not var_5.contains(var_169_1, arg_169_1:getConfig("type")) then
		...
		local var_169_3 = var_6("common_limit_equip")
	...
	if var_169_2.contains(arg_169_1:getConfig("ship_type_forbidden"), arg_169_0:getShipType()) then
		...
		local var_169_5 = var_6("common_limit_equip")
...
function var_0_1.RemapSkillId(arg_180_0, arg_180_1, arg_180_2)
	...
	if arg_180_0.GetSpWeapon(var_180_0) then
		table = var_180_0

		local var_180_1 = var_180_0.contains

		pg = var_1_10005

		if var_180_1(var_1_10005.ship_data_template[arg_180_0.configId].hide_buff_list, arg_180_1) then
			return var_3:RemapHiddenSkillId(arg_180_1)
		elseif arg_180_2 then
			local var_180_2

			if var_3:RemapHiddenSkillId(arg_180_1) == arg_180_1 then
				var_180_2 = var_3:RemapSkillId(arg_180_1)
			end
...
function var_0_1.getSkillList(arg_181_0)
	...
	local var_181_2 = var_3(var_181_0.buff_list)
...
function var_0_1.getModAttrTopLimit(arg_182_0, arg_182_1)
	...
	return var_1_10005((3 + 7 * (var_1_10006.min(arg_182_0.level, 100) / 100)) * var_182_2 * 0.1)
end
...
function var_0_1.leftModAdditionPoint(arg_183_0, arg_183_1)
	...
	local var_183_2 = arg_183_0
	local var_183_3 = arg_183_0.getModAttrTopLimit(var_183_2, arg_183_1)

	calcFloor = var_183_2

	local var_183_4 = var_183_2(var_183_0 / var_183_1)

	math = var_6

	return var_6.max(0, var_183_3 - var_183_4)
end
...
function var_0_1.getModAttrBaseMax(arg_184_0, arg_184_1)
	...
	if not var_1_10002.contains(arg_184_0:getConfig("lock"), arg_184_1) then
		...
		local var_184_1 = arg_184_0
		local var_184_2 = arg_184_0.getShipProperties(var_184_1)

		calcFloor = var_184_1

		return var_184_1(var_184_2[arg_184_1] + var_184_0)
	else
		return 0
	end
...
function var_0_1.getModExpRatio(arg_185_0, arg_185_1)
	...
	if not var_1_10002.contains(arg_185_0:getConfig("lock"), arg_185_1) then
		pg = var_3

		local var_185_0 = var_3.ship_data_template[arg_185_0.configId].strengthen_id

		assert = var_4
		pg = var_5

		var_4(var_5.ship_data_strengthen[var_185_0], "ship_data_strengthen>>>>>>" .. var_185_0)

		math = var_4

		local var_185_1 = var_4.max

		pg = var_5

		local var_185_2 = var_5.ship_data_strengthen[var_185_0].level_exp

		ShipModAttr = var_6

		return var_185_1(var_185_2[var_6.ATTR_TO_INDEX[arg_185_1]], 1)
	else
		return 1
	end
...
function var_0_1.getProposeSkin(arg_188_0)
	...
	return var_188_0(var_188_1, var_1_10003.SKIN_TYPE_PROPOSE)
end
...
function var_0_1.getDisplaySkillIds(arg_189_0)
	...
	return var_189_0(var_1_10002.ship_data_template[arg_189_0.configId].buff_list_display, function(arg_190_0)
...
function var_0_1.setEquipmentRecord(arg_192_0, arg_192_1, arg_192_2)
	...
	local var_192_3 = var_6.concat

	_ = var_7

	var_192_1(var_192_2, var_192_3(var_7.flatten(arg_192_2), ":"))
...
function var_0_1.getEquipmentRecord(arg_193_0, arg_193_1)
	if not arg_193_0.equipmentRecords then
		...
		if not var_4.GetString(var_193_0) then
			var_193_2 = ""
		end
		...
		for iter_193_0 = 1, 3 do
			...
			_ = var_1_10010
			var_193_4[iter_193_0] = var_1_10009(var_1_10010.slice(var_193_3, 5 * iter_193_0 - 4, 5), function(arg_194_0)
...
function var_0_1.SetSpWeaponRecord(arg_195_0, arg_195_1, arg_195_2)
	...
	var_195_2(var_195_3, var_7.concat(var_195_1, ":"))
...
function var_0_1.GetSpWeaponRecord(arg_197_0, arg_197_1)
	...
	local var_197_2 = var_4.split

	PlayerPrefs = var_5

	return (var_197_1(var_197_2(var_5.GetString(var_197_0, ""), ":"), function(arg_198_0)
		string = var_2_10001
		...
		local var_198_1 = var_2(var_198_0[1])
...
function var_0_1.getSkillIndex(arg_203_0, arg_203_1)
	...
	local var_203_1 = arg_203_0.getSkillList(var_203_0)

	ipairs = var_203_0

	for iter_203_0, iter_203_1 in var_203_0(var_203_1) do
...
function var_0_1.IsBgmSkin(arg_205_0)
	local var_205_0 = arg_205_0
	local var_205_1 = arg_205_0.GetSkinConfig(var_205_0)

	table = var_205_0

	local var_205_2 = var_205_0.contains
	local var_205_3 = var_205_1.tag

	ShipSkin = var_1_10004

	return var_205_2(var_205_3, var_1_10004.WITH_BGM)
end
...
function var_0_1.hasAvailiableSkin(arg_211_0)
	...
	local var_211_0 = var_1_10001(var_1_10002)
	local var_211_1 = var_1.GetAllSkinForShip(var_211_0, arg_211_0)
	local var_211_2 = var_1:getRawData()
	local var_211_3 = 0

	ipairs = var_1_10005

	for iter_211_0, iter_211_1 in var_1_10005(var_211_1) do
		if arg_211_0:proposeSkinOwned(iter_211_1) or var_211_2[iter_211_1.id] or var_1:hasSkin(iter_211_1.id) then
...
function var_0_1.hasProposeSkin(arg_212_0)
	...
	local var_212_0 = var_1_10001(var_1_10002)
	...
	local var_212_3 = var_1
	local var_212_4 = var_1.GetShareSkinsForShip(var_212_3, arg_212_0)

	ipairs = var_212_3

	for iter_212_2, iter_212_3 in var_212_3(var_212_4) do
		local var_212_5 = iter_212_3.skin_type

		ShipSkin = var_1_10010

		if var_212_5 == var_1_10010.SKIN_TYPE_PROPOSE then
			return true
		end
	end
...
function var_0_1.HasUniqueSpWeapon(arg_213_0)
	...
	return var_1_10001(var_1_10002.spweapon_data_statistics.get_id_list_by_unique[arg_213_0:getGroupId()])
end
...
function var_0_1.getAircraftReloadCD(arg_214_0)
	...
	for iter_214_0 = 1, 3 do
		...
		if not arg_214_0:getEquip(iter_214_0) or not var_9.configId then
			var_214_4 = var_214_1[iter_214_0]
		end

		Equipment = var_11

		local var_214_5 = var_11.getConfigData(var_214_4).type

		underscore = var_12

		local var_214_6 = var_12.any

		EquipType = var_1_10013

		if var_214_6(var_1_10013.AirEquipTypes, function(arg_215_0)
			return var_214_5 == arg_215_0
		end) then
			Equipment = var_12
			var_214_2 = var_214_2 + var_12.GetEquipReloadStatic(var_214_4) * var_214_0[iter_214_0]
	...
	local var_214_7 = var_5.Battle.BattleConfig.AIR_ASSIST_RELOAD_RATIO

	pg = var_6

	local var_214_8 = var_214_7 * var_6.bfConsts.PERCENT
	local var_214_9 = {}

	i18n = var_7
	var_214_9.name = var_7("equip_info_31")
	AttributeType = var_7
	var_214_9.type = var_7.CD
	var_214_9.value = var_214_2 / var_214_3 * var_214_8
...
function var_0_1.IsTagShip(arg_216_0, arg_216_1)
	...
	local var_216_1 = arg_216_0.getConfig(var_216_0, "tag_list")

	table = var_216_0

	return var_216_0.contains(var_216_1, arg_216_1)
end
...
function var_0_1.IsXIdol(arg_220_0)
	...
	local var_220_1 = arg_220_0.getNation(var_220_0)

	Nation = var_220_0

	return var_220_1 == var_220_0.IDOL_LINK
end
...
function var_0_1.UpdateSpWeapon(arg_223_0, arg_223_1)
	...
	if arg_223_0.spWeapon then
		...
		if var_223_3 then
			...
			var_223_5(var_223_4, var_1_10005.SPWEAPONS_UPDATED)
		end
...
function var_0_1.IsSpWeaponForbidden(arg_225_0, arg_225_1)
	...
	local var_225_2 = arg_225_0.getShipType(var_225_1)

	table = var_225_1

	if not var_225_1.contains(var_225_0, var_225_2) then
		local var_225_3 = true

		i18n = var_5

		local var_225_4 = var_5("spweapon_tip_group_error")

		return
	end

	local var_225_5 = arg_225_1:GetUniqueGroup()
	local var_225_6 = arg_225_0:getGroupId()

	if var_225_5 ~= 0 and var_225_5 ~= var_225_6 then
		local var_225_7 = true

		i18n = var_1_10007

		local var_225_8 = var_1_10007("spweapon_tip_group_error")
...
function var_0_1.GetMapStrikeAnim(arg_226_0)
	local var_226_0
	local var_226_1 = arg_226_0
	local var_226_2 = arg_226_0.getShipType(var_226_1)

	switch = var_226_1
	ShipType = var_1_10004

	local var_226_3 = var_1_10004.GetTeamFromShipType(var_226_2)
	local var_226_4 = {}

	TeamType = var_1_10006
	var_226_4[var_1_10006.Main] = function()
		ShipType = var_2_10000

		if var_2_10000.IsTypeQuZhu(var_226_2) then
			...
			if var_227_0(var_1.BundleAircraftCarrier, var_226_2) then
				...
				if var_227_1(var_1.BundleBattleShip, var_226_2) then
					var_226_0 = "CannonUI"
				else
					var_226_0 = "CannonUI"
				end
	...
	TeamType = var_6
	var_226_4[var_6.Vanguard] = function()
		ShipType = var_2_10000
...
function var_0_1.IsMatchKey(arg_231_0, arg_231_1)
	...
	string = var_1_10003
	arg_231_1 = var_231_0(var_1_10003.gsub(arg_231_1, "%.", "%%."))
	pg = var_2
	...
	return var_5.any(var_231_3, function(arg_232_0)
		...
		return var_232_0(var_2_10002.lower(arg_232_0), arg_231_1)
	end)
end
	...
	if var_1.isHxPropose() then
		do
			...
			if arg_235_0:IsOwner() then
				local var_235_0 = arg_235_0

				var_235_1 = arg_235_0.GetUniqueId(var_235_0)
				getProxy = var_235_0
				PlayerProxy = var_1_10003

				local var_235_2 = var_235_0(var_1_10003)
				local var_235_3 = var_2.getRawData(var_235_2)

				if var_235_1 ~= var_2.GetProposeShipId(var_235_3) then
					var_235_1 = false
...
function var_0_1.GetColorName(arg_236_0, arg_236_1)
	...
	if var_236_0(var_236_1, var_1_10004 == var_1_10005 and 1 or 0) == 1 and arg_236_0.propose then
		setColorStr = var_2
...
function var_0_1.GetFrameAndEffect(arg_237_0, arg_237_1)
	...
	elseif arg_237_0:isMetaShip() then
		...
		local var_237_2 = arg_237_0
		local var_237_3 = arg_237_0.getRarity(var_237_2)

		ShipRarity = var_237_2

		if var_237_3 == var_237_2.SSR then
			string = var_237_3
			var_237_1 = var_237_3.format(var_0_24.effect[5])
		end
	end
