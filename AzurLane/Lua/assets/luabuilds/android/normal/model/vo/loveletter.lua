...
function var_0_1.GetLetterList(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_5_0(var_3.lover_letter_content.get_id_list_by_ship_group[arg_5_0.groupId]) do
		table = var_1_10007
...
function var_0_1.AddExp(arg_8_0, arg_8_1)
	...
	local var_8_0 = arg_8_0:getConfig("exp_upper_limit")
	local var_8_1 = arg_8_0.exp

	math = var_4
	arg_8_0.exp = var_4.min(arg_8_0.exp + arg_8_1, var_8_0)
	arg_8_1 = var_8_1
...
function var_0_1.CanUnlockLetter(arg_13_0, arg_13_1)
	...
	local var_13_2 = var_13_0.indexof(var_13_1, arg_13_1)
...
function var_0_1.GetDisplayExp(arg_18_0)
	if arg_18_0:IsLevelMax() then
		...
		local var_18_1 = arg_18_0.getConfig(var_18_0, "exp_up")

		math = var_18_0

		return var_18_0.min(arg_18_0.exp - arg_18_0.level * var_18_1, var_18_1), var_18_1
	end
...
function var_0_1.GetDisplayInfo(arg_24_0)
	...
	local var_24_2 = var_24_0.ship_skin_template[var_24_1]
...
function var_0_1.GetTrophyList(arg_26_0)
	...
	for iter_26_0 = 1, arg_26_0.level, 10 do
		...
		LoveLetterTrophy = var_1_10009

		var_1_10007(var_26_2, var_1_10009.New({
			id = var_26_1
		}))
	end
