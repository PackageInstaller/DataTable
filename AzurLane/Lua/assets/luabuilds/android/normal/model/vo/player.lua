...
local var_0_2 = var_0_0.player_resource.get_id_list_by_name
local var_0_3
local var_0_4
...
function var_0_1.isMetaShipNeedToTrans(arg_5_0)
	...
	local var_5_1 = var_2(var_1_10003)
	local var_5_2 = var_2.getMetaShipByGroupId(var_5_1, var_5_0)

	getProxy = var_5_1
	MetaCharacterProxy = var_4

	local var_5_3 = var_5_1(var_4)
	local var_5_4

	var_5_4 = var_3.getMetaIDMark(var_5_3, arg_5_0) and var_3 > 0
...
function var_0_1.metaShip2Res(arg_6_0)
	...
	local var_6_1 = var_2(var_1_10003)
	...
	if not var_6_2 then
		...
		var_1_10005 = var_6_2
		var_1_10006 = var_6_2.getMetaCharacter(var_1_10005)
		var_1_10006 = var_4.getSpecialMaterialInfoToMaxStar(var_1_10006).itemID

		local var_6_4 = var_1_10005.count
		...
		var_6_3 = var_6_4 <= var_8.getItemCountById(var_6_5, var_1_10006)
	end
	...
	if var_6_3 then
		pg = var_1_10005
		var_6_6 = var_1_10005.ship_transform[var_6_0].common_item
	else
		pg = var_1_10005
		var_6_6 = var_1_10005.ship_transform[var_6_0].exclusive_item
	end
	...
	for iter_6_0, iter_6_1 in var_1_10006(var_6_6) do
		local var_6_8 = {
			type = iter_6_1[1],
			id = iter_6_1[2],
			count = iter_6_1[3]
...
function var_0_1.Ctor(arg_8_0, arg_8_1)
	...
	getProxy = var_3
	AppreciateProxy = var_4

	local var_8_17 = var_3(var_4)
	...
	if arg_8_1.appreciation then
		...
		if var_4.getResultForVer(var_8_23) then
			...
			local var_8_24 = var_8_23.ConnectionMgr.GetInstance()
...
function var_0_1.canModifyName(arg_12_0)
	...
	if var_12_0.gameset.player_name_change_lv_limit.key_value > arg_12_0.level then
		local var_12_2 = false

		i18n = var_1_10004

		local var_12_3 = var_1_10004("player_name_change_time_lv_tip", var_2)
	...
	if var_12_1 < arg_12_0.getModifyNameTimestamp(var_12_4) then
		pg = var_12_4

		local var_12_5 = var_12_4.TimeMgr.GetInstance()
		local var_12_6, var_12_7, var_12_8, var_12_9 = var_4.parseTimeFrom(var_12_5, var_3 - var_12_1)
		local var_12_10
		...
		if var_12_6 == 0 then
			if var_12_7 == 0 then
				...
				local var_12_11 = var_1_10009.max(var_12_8, 1)

				i18n = var_1_10010
				var_12_10 = var_12_11 .. var_1_10010("word_minute")
			else
				local var_12_12 = var_12_7

				i18n = var_1_10010
				var_12_10 = var_12_12 .. var_1_10010("word_hour")
			end
		else
			local var_12_13 = var_12_6

			i18n = var_1_10010
			var_12_10 = var_12_13 .. var_1_10010("word_date")
		end
		...
		local var_12_15 = var_1_10010("player_name_change_time_limit_tip", var_12_10)
...
function var_0_1.getLevelMaxGold(arg_18_0)
	...
	local var_18_1 = arg_18_0.getConfig(var_18_0, "max_gold")

	getProxy = var_18_0
	GuildProxy = var_3

	local var_18_2 = var_18_0(var_3)
	local var_18_3

	if not var_2.GetAdditionGuild(var_18_2) or not (var_18_1 + var_2:getMaxGoldAddition()) then
		var_18_3 = var_18_1
	end
...
function var_0_1.getLevelMaxOil(arg_19_0)
	...
	local var_19_1 = arg_19_0.getConfig(var_19_0, "max_oil")
	...
	if not var_2.GetAdditionGuild(var_19_2) or not (var_19_1 + var_2:getMaxOilAddition()) then
		var_19_3 = var_19_1
	end
...
function var_0_1.updateResources(arg_21_0, arg_21_1)
	...
	for iter_21_2, iter_21_3 in var_2(arg_21_1 or {}) do
		...
		var_8(var_1_10007, "resource type erro>>>>>" .. iter_21_3.type)
...
function var_0_1.getPainting(arg_22_0)
	...
	if var_2(arg_22_0.character) then
		...
		if var_2.GetChangeSkinData(arg_22_0.skinId) then
			...
			if var_3.GetStoreChangeSkinId(var_22_1, arg_22_0:GetFlagShipPhantomMark()) then
				pg = var_4
...
function var_0_1.getMaxEquipmentBag(arg_41_0)
	...
	local var_41_2 = var_1_10003(var_1_10004)
...
function var_0_1.consume(arg_51_0, arg_51_1)
	...
	if 0 < var_51_2 then
		...
		var_51_4 = arg_51_0.getFreeGem(var_51_3)
		math = var_51_3
		arg_51_0.awardGem = var_51_4 - var_51_3.min(var_51_2, var_51_4)
		arg_51_0.chargeGem = arg_51_0.chargeGem - (var_51_2 - var_4)
	end

	pairs = var_51_4

	for iter_51_0, iter_51_1 in var_51_4(arg_51_1) do
...
function var_0_1.addResources(arg_52_0, arg_52_1)
	...
	for iter_52_0, iter_52_1 in var_1_10002(arg_52_1) do
		if iter_52_0 == "gold" then
			...
			var_1_10007 = arg_52_0.getMaxGold(var_1_10008)
			math = var_1_10008
			arg_52_0[iter_52_0] = var_1_10008.min(arg_52_0[iter_52_0] + iter_52_1, var_1_10007)
		elseif iter_52_0 == "oil" then
			var_1_10008 = arg_52_0
			var_1_10007 = arg_52_0.getMaxOil(var_1_10008)
			math = var_1_10008
			arg_52_0[iter_52_0] = var_1_10008.min(arg_52_0[iter_52_0] + iter_52_1, var_1_10007)
		elseif iter_52_0 == "gem" then
			var_1_10008 = arg_52_0
			arg_52_0.chargeGem = arg_52_0.getChargeGem(var_1_10008) + iter_52_1
		elseif iter_52_0 == "freeGem" then
			var_1_10008 = arg_52_0
			arg_52_0.awardGem = arg_52_0.getFreeGem(var_1_10008) + iter_52_1
		else
			id2res = var_1_10007
			WorldConst = var_1_10008

			if iter_52_0 == var_1_10007(var_1_10008.ResourceID) then
				pg = var_1_10007
...
function var_0_1.addExpToLevel(arg_55_0, arg_55_1)
	...
	local var_55_0 = var_1_10002(var_1_10003.user_level, arg_55_1)
...
function var_0_1.getLevelExpConfig(arg_57_0)
	...
	return var_1_10001(var_1_10002.user_level, arg_57_0.level)
end
...
function var_0_1.canLevelUp(arg_60_0)
	...
	local var_60_0 = var_1_10001(var_1_10002.user_level, arg_60_0.level + 1)
...
function var_0_1.OverStore(arg_66_0, arg_66_1, arg_66_2)
	...
	local var_66_1 = var_4.mail_storeroom[arg_66_0.mailStoreLevel]
	...
	var_66_3[var_1_10008.ResStoreGold] = function()
		return var_66_1.gold_store
	end
	PlayerConst = var_8
	var_66_3[var_8.ResStoreOil] = function()
...
function var_0_1.GetDaysFromRegister(arg_74_0)
	...
	local var_74_2 = var_74_0.TimeMgr.GetInstance()
...
function var_0_1.GetShipPhantomMarks(arg_80_0)
	...
	for iter_80_0, iter_80_1 in var_1_10002(arg_80_0.characters) do
		...
		var_1_10007(var_80_1, var_1_10009.PackMark(iter_80_1, arg_80_0.phantoms[iter_80_0]))
	end
...
function var_0_1.GetFlagShip(arg_81_0)
	...
	local var_81_0 = var_1_10001(var_1_10002)
...
local function var_0_13(arg_82_0)
	...
	local var_82_2 = var_1_10003(var_1_10004)
	local var_82_3 = var_3.GetFlagShipDisplayMode(var_82_2)

	getProxy = var_82_2
	PlayerProxy = var_1_10005

	local var_82_4 = var_82_2(var_1_10005)
	local var_82_5 = var_4.getRawData(var_82_4)
	local var_82_6 = var_4.ExistEducateChar(var_82_5)

	FlAG_SHIP_DISPLAY_ONLY_EDUCATECHAR = var_82_5

	if var_82_3 == var_82_5 and not var_82_6 then
		FlAG_SHIP_DISPLAY_ALL = var_82_3
		getProxy = var_82_5
		SettingsProxy = var_1_10006
		var_1_10006 = var_82_5(var_1_10006)

		var_82_5.SetFlagShipDisplayMode(var_1_10006, var_82_3)
	end

	FlAG_SHIP_DISPLAY_ONLY_EDUCATECHAR = var_82_5

	if var_82_3 ~= var_82_5 then
		getProxy = var_82_5
		BayProxy = var_1_10006
		var_82_5 = var_82_5(var_1_10006)
		ipairs = var_1_10006

		for iter_82_0, iter_82_1 in var_1_10006(arg_82_0) do
			var_82_0[iter_82_0] = false

			local var_82_7 = var_82_5

			if var_82_5.GetShipPhantom(var_82_7, iter_82_1) then
				var_82_0[iter_82_0] = var_11
			end

			table = var_82_7

			var_82_7.insert(var_82_1, iter_82_0)
		end
	end

	if var_82_6 then
		FlAG_SHIP_DISPLAY_ONLY_SHIP = var_82_5

		if var_82_3 ~= var_82_5 then
			table = var_82_5

			local var_82_8 = var_82_5.insert
			local var_82_9 = var_82_1

			PlayerVitaeShipsPage = var_1_10007

			var_82_8(var_82_9, var_1_10007.EDUCATE_CHAR_SLOT_ID)

			getProxy = var_82_8
			PlayerProxy = var_82_9

			local var_82_10 = var_82_8(var_82_9)
			local var_82_11 = var_5.getRawData(var_82_10)
			local var_82_12 = var_5.GetEducateCharacter(var_82_11)

			VirtualEducateCharShip = var_82_11

			local var_82_13 = var_82_11.New(var_82_12)

			PlayerVitaeShipsPage = var_7
			var_82_0[var_7.EDUCATE_CHAR_SLOT_ID] = var_82_13
		end
	end
...
function var_0_1.GetNativeFlagShip(arg_83_0, arg_83_1)
	...
	local var_83_4 = var_83_1(var_1_10005)

	getProxy = var_1_10005
	PlayerProxy = var_1_10006

	local var_83_5 = var_1_10005(var_1_10006)
	local var_83_6
	...
	if var_5.getFlag(var_83_5, "random_skin") then
		...
		var_83_6 = var_83_5(var_83_6)

		var_83_5.setFlag(var_83_6, "random_skin", false)
	end

	if not var_83_2[arg_83_1] then
		PlayerVitaeShipsPage = var_83_5

		local var_83_7 = var_83_5.GetSlotIndexList()

		table = var_83_6

		if var_83_6.indexof(var_83_7, arg_83_1) and var_7 > 0 then
			for iter_83_0 = var_7 + 1, #var_83_7 do
				if var_83_2[var_83_7[iter_83_0]] then
	...
	if not var_83_8 then
		arg_83_1 = 1

		var_83_4:setCurrentSecretaryIndex(arg_83_1)

		var_83_8 = var_83_2[arg_83_1]
	end
...
function var_0_1.GetRandomFlagShip(arg_84_0, arg_84_1)
	...
	local var_84_0 = var_1_10002(var_1_10003)
	...
	local var_84_5 = var_84_2(var_1_10006)
	local var_84_6
	...
	if var_5.getFlag(var_84_5, "random_skin") then
		...
		var_84_6 = var_84_5(var_84_6)

		var_84_5.setFlag(var_84_6, "random_skin", false)
	end

	if not var_84_3[arg_84_1] then
		PlayerVitaeShipsPage = var_84_5

		local var_84_7 = var_84_5.GetSlotIndexList()

		table = var_84_6

		if var_84_6.indexof(var_84_7, arg_84_1) and var_84_6 > 0 then
			for iter_84_0 = var_84_6 + 1, #var_84_7 do
				if var_84_3[var_84_7[iter_84_0]] then
	...
	if not var_84_9 then
		...
		for iter_84_1, iter_84_2 in var_84_6(var_84_3) do
			if iter_84_2 then
				table = var_1_10012

				var_1_10012.insert(var_84_8, iter_84_1)
			end
		end

		if #var_84_8 > 0 then
			math = var_7
			var_84_9 = var_84_3[var_84_8[var_7.random(1, #var_84_8)]]
			table = var_7
...
function var_0_1.GetNextFlagShip(arg_85_0)
	...
	local var_85_0 = var_1_10001(var_1_10002)
...
function var_0_1.ShouldCheckCustomName(arg_87_0)
	...
	REVERT_CUSTOM_NAME = var_1_10003

	return var_87_1(var_87_0, var_1_10003)
end
...
function var_0_1.WhetherServerModifiesName(arg_88_0)
	...
	ILLEGALITY_PLAYER_NAME = var_1_10003

	return var_88_1(var_88_0, var_1_10003)
end
...
function var_0_1.GetRandomFlagShipMode(arg_91_0)
	if arg_91_0.randomShipMode <= 0 then
		...
		RANDOM_FLAG_SHIP_MODE = var_1_10003

		if var_91_1(var_91_0, var_1_10003) then
			SettingsRandomFlagShipAndSkinPanel = var_91_0
			arg_91_0.randomShipMode = var_91_0.SHIP_LOCKED
		else
			SettingsRandomFlagShipAndSkinPanel = var_91_0
			arg_91_0.randomShipMode = var_91_0.SHIP_FREQUENTLYUSED
		end
	end
...
function var_0_1.GetCryptolaliaList(arg_95_0)
	...
	for iter_95_2, iter_95_3 in var_4(var_5.soundstory_template.all) do
...
function var_0_1.ExistCryptolalia(arg_97_0, arg_97_1)
	...
	local var_97_1 = arg_97_0.GetCryptolaliaList(var_97_0)
...
function var_0_1.GetExtendStoreCost(arg_102_0)
	...
	if var_102_0.upgrade_gem > 0 then
		...
		var_102_3.type = var_1_10005
		PlayerConst = var_1_10005
		var_102_3.id = var_1_10005.ResDiamond
	...
	if var_102_0.upgrade_gold > 0 then
		...
		DROP_TYPE_RESOURCE = var_1_10005
		var_102_5.type = var_1_10005
		PlayerConst = var_1_10005
		var_102_5.id = var_1_10005.ResGold
...
function var_0_1.GetDisplayShipList(arg_108_0)
	...
	local var_108_0 = var_1_10001(var_1_10002)
	local var_108_1
