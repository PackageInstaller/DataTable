...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in var_6(var_7.activity_mall_template.all) do
		local var_1_4 = var_1_1[iter_1_3]

		MallFloor = var_1_10012
		var_1_10012 = var_1_10012.New
		var_1_10013 = var_1_4 or {
			id = iter_1_3
		}

		local var_1_5 = var_1_10012(var_1_10013, var_1_4 ~= nil)
...
function var_0_1.GetStaffList(arg_15_0)
	...
	var_15_1(var_15_2, var_1_10004({
		function(arg_16_0)
			...
			local var_16_1 = arg_16_0.GetStatusInfos(var_16_0)

			MallStaff = var_16_0

			return var_16_1 == var_16_0.STATUS.ORDER and 1 or 0
		end,
		function(arg_17_0)
			return arg_17_0.id
		end
...
function var_0_1.InitStaffStatus(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10001(var_2.GetStaffList(var_20_0)) do
		local var_20_1 = arg_20_0.staffData[iter_20_1]

		var_1_10006 = var_1_10006.SetStatus
		MallStaff = var_1_10008

		var_1_10006(var_20_1, var_1_10008.STATUS.ORDER, {
	...
	for iter_20_2, iter_20_3 in var_1(arg_20_0.floorData) do
		...
		for iter_20_4, iter_20_5 in var_1_10006(iter_20_3:GetStaffList()) do
			if iter_20_5 ~= 0 then
				...
				var_20_3(var_20_2, var_1_10013.STATUS.FLOOR, {
...
function var_0_1.OnStartOrderDone(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	for iter_23_0, iter_23_1 in var_4(arg_23_3) do
		...
		MallStaff = var_1_10011

		var_23_2(var_23_1, var_1_10011.STATUS.ORDER, {
			orderId = iter_23_1
		})
	end
	...
	var_23_4(var_23_3, var_6.GetCostGold(arg_23_1))
...
function var_0_1.OnCompleteOrderDone(arg_24_0, arg_24_1)
	...
	for iter_24_0, iter_24_1 in var_1_10002(var_3.GetStaffList(var_24_0)) do
		local var_24_1 = arg_24_0.staffData[iter_24_1]
		local var_24_2 = var_7.SetStatus

		MallStaff = var_1_10009

		var_24_2(var_24_1, var_1_10009.STATUS.NORMAL, {})
	end
...
function var_0_1.GetFloorListAsc(arg_30_0)
	...
	local var_30_1 = var_2.sort
	local var_30_2 = var_30_0

	CompareFuncs = var_1_10004

	var_30_1(var_30_2, var_1_10004({
		function(arg_31_0)
			return arg_31_0.id
		end
	}))
...
function var_0_1._RemoveFloorStaff(arg_35_0, arg_35_1, arg_35_2)
	...
	var_35_3(var_35_2, var_7.STATUS.NORMAL, {})
...
function var_0_1._AddFloorStaff(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	...
	var_36_0(var_36_2, var_1_10007.format("%d楼的第%d个位置已有员工%d, 请先移除！", arg_36_1, arg_36_2, arg_36_3))
	...
	local var_36_6 = var_36_4 == var_8.STATUS.NORMAL

	string = var_9

	var_7(var_36_6, var_9.format("员工%d处于被占用状态！(%d)", arg_36_3, var_36_4))
	...
	var_36_9(var_36_8, var_9.STATUS.FLOOR, {
		floorId = arg_36_1,
		floorIdx = arg_36_2
	})
...
function var_0_1.IsStaffDrop(arg_37_0)
	...
	if not var_37_3(var_37_2, var_3.ACTIVITY_TYPE_MALL) then
		return false
	end
