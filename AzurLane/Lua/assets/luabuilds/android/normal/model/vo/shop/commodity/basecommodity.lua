...
function var_0_1.inTime(arg_26_0)
	...
	if var_26_0 == var_1_10002.TYPE_NEW_SERVER then
		...
		if var_26_2(var_26_1, var_1_10003.ACTIVITY_TYPE_NEWSERVER_GIFT) and not var_1:isEnd() then
			local var_26_3 = true
			local var_26_4 = var_1.stopTime

			pg = var_1_10004

			local var_26_5 = var_1_10004.TimeMgr.GetInstance()

			return var_26_3, var_26_4 - var_1_10004.GetServerTime(var_26_5)
		else
			return false
		end
	end
	...
	if not arg_26_0.getConfig(var_26_6, "time") then
		return true
	end

	type = var_26_6

	if var_26_6(var_1) == "string" then
		return var_1 == "always"
	else
		local var_26_7, var_26_8 = arg_26_0:getTimeStamp()

		if var_26_7 and var_26_8 then
			pg = var_1_10004

			local var_26_9 = var_1_10004.TimeMgr.GetInstance()

			return var_26_7 <= var_4.GetServerTime(var_26_9) and var_4 <= var_26_8, var_26_8 - var_4
		else
			return true
		end
	end
...
function var_0_1.getTimeStamp(arg_27_0)
	...
	if arg_27_0.getConfig(var_27_0, "time") then
		type = var_27_0

		if var_27_0(var_1) == "table" then
			local var_27_1
			local var_27_2

			if #var_1 > 0 then
				local var_27_3 = var_1[1][1][1] .. "-" .. var_1[1][1][2] .. "-" .. var_1[1][1][3] .. " " .. var_1[1][2][1] .. ":" .. var_1[1][2][2] .. ":" .. var_1[1][2][3]

				pg = var_5

				local var_27_4 = var_5.TimeMgr.GetInstance()

				var_27_1 = var_5.ParseTimeEx(var_27_4, var_27_3, nil, true)
			end

			if #var_1 > 1 then
				local var_27_5 = var_1[2][1][1] .. "-" .. var_1[2][1][2] .. "-" .. var_1[2][1][3] .. " " .. var_1[2][2][1] .. ":" .. var_1[2][2][2] .. ":" .. var_1[2][2][3]

				pg = var_5

				local var_27_6 = var_5.TimeMgr.GetInstance()

				var_27_2 = var_5.ParseTimeEx(var_27_6, var_27_5, nil, true)
			end
