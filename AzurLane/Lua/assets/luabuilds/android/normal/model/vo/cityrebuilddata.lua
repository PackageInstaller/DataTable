...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..vo.BaseVO"))

pg = var_0_0

local var_0_2 = var_0_0.activity_ninja_city

pg = var_2

local var_0_3 = var_2.activity_ninja_building
...
function var_0_1.UpgradeBuff(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_5(arg_6_0.buffs) do
...
function var_0_1.PtToShow(arg_17_0)
	...
	if arg_17_0 >= var_0_1.Billion then
		...
		local var_17_2 = var_17_1 - #var_1_10003(var_1_10004.floor(var_17_0))
	...
	elseif arg_17_0 >= var_0_1.Million then
		...
		local var_17_5 = var_17_4 - #var_1_10003(var_1_10004.floor(var_17_3))
	...
	elseif arg_17_0 >= var_0_1.Thousand then
		...
		local var_17_8 = var_17_7 - #var_1_10003(var_1_10004.floor(var_17_6))
