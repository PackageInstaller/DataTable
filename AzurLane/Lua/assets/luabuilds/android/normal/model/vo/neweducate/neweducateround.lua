...
function var_0_1.InitConfig(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_2(var_1_10003.child2_round.get_id_list_by_character[arg_3_1]) do
		pg = var_1_10007
...
function var_0_1.GetProgressInfo(arg_8_0)
	...
	local var_8_1 = var_2.child2_round[arg_8_0.round2Id[var_8_0]].target_id
...
function var_0_1.InitEndlessConfig(arg_17_0, arg_17_1)
	...
	for iter_17_0, iter_17_1 in var_2(var_1_10003.child2_round.get_id_list_by_character[arg_17_1]) do
		pg = var_1_10007
...
function var_0_1.GetExtraFactor(arg_24_0)
	...
	local var_24_1 = arg_24_0.difficulty

	NewEducateChar = var_3

	local var_24_2 = var_24_1 == var_3.DIFFICULTY.EASY and "child2_endless_loop_extra_factor" or "child2_endless_loop_extra_factor_hard"

	pg = var_3

	local var_24_3 = var_3.gameset[var_24_2].description

	ipairs = var_1_10004

	for iter_24_0, iter_24_1 in var_1_10004(var_24_3) do
	...
	local var_24_6 = var_24_3[#var_24_3][3]

	tonumber = var_5

	local var_24_7

	if not var_5(var_24_0) then
		var_24_7 = 1
	end
