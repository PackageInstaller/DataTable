...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_1_10003(arg_1_1.goods) do
		...
		Goods = var_1_10012
		var_1_1[var_1_2] = var_1_10010(var_1_10011, var_1_10012.TYPE_SHOPSTREET)
	end
	...
	local var_1_4 = var_3.getActivityById(var_1_3, arg_1_0.activityId)
	local var_1_5 = var_3.getConfig(var_1_4, "config_client").tabLabel

	pairs = var_1_4

	for iter_1_2, iter_1_3 in var_1_4(var_1_5) do
		...
		for iter_1_4, iter_1_5 in var_1_10011(iter_1_3) do
			...
			var_1_10016.insert(var_1_6, arg_1_0.goods[iter_1_5])
		end

		var_1_10011 = arg_1_0.tabList
		var_1_10011[iter_1_2] = var_1_6
	end
