...
local var_0_2 = var_0_0.activity_ins_chat_language
...
function var_0_1.GetLatestCharacterWord(arg_5_0)
	...
	for iter_5_0 = #arg_5_0.displayWordList, 1, -1 do
		if arg_5_0.displayWordList[iter_5_0].ship_group == 0 then
			...
			if arg_5_0.IsCompleted(var_1_10008) then
	...
	elseif var_5_0.type == 2 then
		...
		if var_5_0.type == 3 then
			...
			local var_5_6 = iter_5_0.activity_ins_redpackage
		...
		elseif var_5_0.type == 5 then
			...
			for iter_5_1 in var_5_4.gmatch(var_5_0.param, "'%d+'") do
				...
				local var_5_10 = var_9.gsub
				local var_5_11 = var_5_9
				local var_5_12 = iter_5_1
				local var_5_13 = "<color=#46d6ff>"

				pg = var_1_10013
				var_1_10013 = var_1_10013.activity_ins_ship_group_template
				tonumber = var_1_10014
				var_5_9 = var_5_10(var_5_11, var_5_12, var_5_13 .. var_1_10013[var_1_10014(var_1_10008)].name .. "</color>")
			end
	...
	if arg_5_0.isWaiting(var_5_14) and var_5_0.type ~= 2 and var_5_0.type ~= 3 then
		local var_5_15 = "<color=#ff6666>"

		i18n = var_5_14
		var_5_1 = var_5_15 .. var_5_14("juuschat_chattip3") .. "</color>" .. var_5_1
	end
