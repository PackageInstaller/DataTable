...
function var_0_1.getComfortable(arg_13_0, arg_13_1)
	...
	local var_13_5 = arg_13_0.getConfig(var_13_4, "comfortable_count")

	pairs = var_13_4

	for iter_13_5, iter_13_6 in var_13_4(var_13_5) do
		local var_13_6
		...
		var_1_10012.sort(var_13_6, function(arg_15_0, arg_15_1)
		...
		for iter_13_7 = 1, iter_13_6[2] do
			...
			if not var_13_6[iter_13_7] then
				var_13_7 = 0
			end

			var_13_0 = var_13_0 + var_13_7
		end
	end

	local var_13_8 = var_13_0 + arg_13_0:getConfig("comfortable")

	if arg_13_0:isUnlockFloor(2) then
		var_13_8 = var_13_8 + var_0_1.DORM_2_FLOOR_COMFORTABLE_ADDITION
	end
...
function var_0_1.getFoodLeftTime(arg_26_0)
	...
	local var_26_2 = arg_26_0.GetFloorShipCnt

	DormShip = var_1_10004

	if var_26_2(var_26_1, var_1_10004.FLOOR_1) == 0 then
		return 0
	end

	pg = var_26_1

	local var_26_3 = var_26_1.gameset["dorm_food_ratio_by_" .. var_2].key_value / 100 * var_26_0.consume
	local var_26_4 = arg_26_0.food - arg_26_0.food % var_26_3

	return arg_26_0.nextAddShipExpTime + (var_26_4 / var_26_3 - 1) * var_26_0.time
end
...
function var_0_1.IsLackOfFood(arg_28_0)
	...
	DormShip = var_1_10003

	if var_28_1(var_28_0, var_1_10003.FLOOR_1) == 0 then
		return false
	end
	...
	local var_28_3 = arg_28_0.getFoodLeftTime(var_28_2)

	pg = var_28_2

	local var_28_4 = var_28_2.TimeMgr.GetInstance()

	return var_28_3 - var_3.GetServerTime(var_28_4) <= 0
end
...
function var_0_1.AddShip(arg_41_0, arg_41_1, arg_41_2)
	...
	var_41_0(var_41_1, var_1_10005.New({
		id = arg_41_1,
		floor = arg_41_2
	}))
...
function var_0_1.GetDicBayShipOnFloor(arg_48_0, arg_48_1)
	...
	local var_48_2 = arg_48_0.GetBayShipOnFloor(var_48_1, arg_48_1)
...
function var_0_1.HarvestInimacyAndMoney(arg_49_0, arg_49_1)
	...
	local var_49_1 = var_2.ToBayShip(var_49_0)
	...
	if not var_49_0(var_49_2, var_1_10006) or not var_49_1 then
		return
	end
	...
	if var_2:HasIntimacy() then
		var_49_4 = var_2:GetIntimacy()

		local var_49_5 = var_49_1

		var_49_1.addLikability(var_49_5, var_49_4)

		getProxy = var_6
		BayProxy = var_49_5

		local var_49_6 = var_6(var_49_5)

		var_6.updateShip(var_49_6, var_49_1)
		var_2:ClearIntimacy()
	end

	local var_49_7 = var_2

	if var_2.HasMoney(var_49_7) then
		getProxy = var_6
		PlayerProxy = var_49_7

		local var_49_8 = var_6(var_49_7)
		local var_49_9 = var_6.getRawData(var_49_8)

		var_49_3 = var_2:GetMoney()

		var_49_9:addResources({
			dormMoney = var_49_3
		})

		local var_49_10 = var_2

		var_2.ClearMoney(var_49_10)

		getProxy = var_7
		PlayerProxy = var_49_10

		local var_49_11 = var_7(var_49_10)

		var_7.updatePlayer(var_49_11, var_49_9)
	end
...
function var_0_1.GetPutFurnitureList(arg_61_0, arg_61_1)
	...
	if arg_61_0:GetTheme(arg_61_1) then
		local var_61_1 = var_3
		local var_61_2

		if not var_3.GetAllFurniture(var_61_1) then
			var_61_2 = {}
		end
		...
		BackyardThemeFurniture = var_7

		var_61_3(var_61_4, var_7._LoadWeight)
...
function var_0_1.ClearNewFlag(arg_62_0)
	...
	local var_62_1 = arg_62_0.GetPurchasedFurnitures(var_62_0)

	pairs = var_62_0

	for iter_62_0, iter_62_1 in var_62_0(var_62_1) do
