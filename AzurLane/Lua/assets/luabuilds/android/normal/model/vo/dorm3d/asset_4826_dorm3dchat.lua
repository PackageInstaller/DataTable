...
local var_0_3 = var_2.dorm3d_ins_chat_group
...
function var_0_1.GetPainting(arg_13_0)
	...
	local var_13_1 = var_2.ship_skin_template[var_13_0]

	assert = var_1_10003

	var_1_10003(var_13_1, "ship_skin_template not exist: " .. var_13_0)
...
function var_0_1.getDisplayableSkinList(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10004(var_1_10005.ship_skin_template.all) do
		pg = var_1_10009
...
function var_0_1.GetTopicsSortByActivateTime(arg_18_0)
	...
	var_2.sort(var_18_0, function(arg_19_0, arg_19_1)
