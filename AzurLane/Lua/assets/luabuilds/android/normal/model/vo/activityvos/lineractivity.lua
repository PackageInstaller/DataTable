...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.eventGroupIds = arg_1_0.getConfig(var_1_2, "config_data")[3]
	arg_1_0.times = {}
	...
	for iter_1_2, iter_1_3 in var_1_2(arg_1_0.timeGroupIds) do
		ipairs = var_1_10008
		pg = var_1_10009

		for iter_1_4, iter_1_5 in var_1_10008(var_1_10009.activity_liner_time_group[iter_1_3].ids) do
			arg_1_0.timeMaxIdx = var_1_3

			local var_1_4 = arg_1_0.times

			LinerTime = var_1_10014
			var_1_4[var_1_3] = var_1_10014.New(iter_1_5)
			arg_1_0.timeIdx2Day[var_1_3] = iter_1_2
			var_1_3 = var_1_3 + 1
		end
	end
...
function var_0_1.CheckTimeFinish(arg_15_0, arg_15_1)
	...
	if not arg_15_1 then
		...
		var_1_10003 = arg_15_0
		var_15_0 = arg_15_0.GetCurTime(var_1_10003)
	end

	switch = var_1_10003

	local var_15_1 = var_15_0:GetType()
	local var_15_2 = {}

	LinerTime = var_1_10006
	var_15_2[var_1_10006.TYPE.TARGET] = function()
		pg = var_2_10000
		...
		return var_16_1(var_16_0, var_2.GetStory(var_16_2))
	end
	LinerTime = var_6
	var_15_2[var_6.TYPE.EXPLORE] = function()
		local var_17_0 = arg_15_0

		return var_0.GetRemainExploreCnt(var_17_0) == 0
	end
	LinerTime = var_6
	var_15_2[var_6.TYPE.EVENT] = function()
	...
	LinerTime = var_6
	var_15_2[var_6.TYPE.STORY] = function()
		pg = var_2_10000
		...
		return var_19_1(var_19_0, var_2.GetStory(var_19_2))
	end

	return var_1_10003(var_15_1, var_15_2, function()
		return false
	end)
end
...
function var_0_1.CheckRoomFinish(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_2.GetType(var_21_0)

	LinerTime = var_21_0

	if var_21_1 ~= var_21_0.TYPE.EVENT then
		return false
	end

	local var_21_2 = var_2:GetParamInfo()[arg_21_0:GetRoomIdx()][2]

	LinerTime = var_1_10006

	local var_21_3

	if var_21_2 == var_1_10006.EVENT_SUB_TYPE.CLUE then
		var_21_3 = arg_21_0

		local var_21_4 = arg_21_0.GetCurEventInfo(var_21_3)

		underscore = var_21_3

		return var_21_3.all(var_4[4], function(arg_22_0)
			local var_22_0 = var_0[1]

			if not var_21_4[var_22_0] then
				return false
			end

			table = var_2

			return var_2.contains(var_21_4[var_22_0], arg_22_0)
		end)
	else
		local var_21_5 = var_4[2]

		LinerTime = var_21_3

		if var_21_5 == var_21_3.EVENT_SUB_TYPE.STORY then
			pg = var_21_5

			local var_21_6 = var_21_5.NewStoryMgr.GetInstance()

			return var_5.IsPlayed(var_21_6, var_4[3])
		end
	end
...
function var_0_1.GetTimeId2ExploredIds(arg_24_0)
	...
	for iter_24_0 = 1, arg_24_0:GetCurIdx() do
		...
		if var_24_4 == var_24_3.TYPE.EXPLORE then
			var_24_0[var_8.id] = {}

			local var_24_5 = var_8:GetExploreCnt()
			local var_24_6 = var_24_1

			math = var_1_10011

			for iter_24_1 = var_24_6, var_1_10011.min(var_24_1 + var_24_5 - 1, #var_24_2) do
				table = var_1_10014

				var_1_10014.insert(var_24_0[var_8.id], var_24_2[iter_24_1])
			end

			var_24_1 = var_24_1 + var_24_5
		end
	end
...
function var_0_1.GetAllExploreRoomIds(arg_38_0)
	...
	for iter_38_0, iter_38_1 in var_1_10002(arg_38_0.roomGroupIds) do
		...
		pg = var_1_10009
		var_38_0 = var_1_10007(var_38_1, var_1_10009.activity_liner_room_group[iter_38_1].ids, true)
	end
...
function var_0_1.GetBgmName(arg_39_0)
	...
	if arg_39_0.IsFinishAllTime(var_39_1) then
		pg = var_39_2
		var_39_1 = var_39_2.NewStoryMgr.GetInstance()
		var_39_2 = var_39_2.IsPlayed(var_39_1, var_39_0)
	end

	if var_39_2 then
		os = var_39_1

		local var_39_3 = var_39_1.date
		local var_39_4 = "*t"

		os = var_1_10005

		local var_39_5 = var_39_3(var_39_4, var_1_10005.time()).hour
		local var_39_6 = arg_39_0:GetReallyTimeType(var_39_5)
		local var_39_7 = arg_39_0:GetCurTime()

		return var_5.GetBgm(var_39_7, var_39_6)
	else
		local var_39_8 = arg_39_0:GetCurTime()

		return var_3.GetBgm(var_39_8)
	end
...
function var_0_1.GetReallyTimeType(arg_40_0, arg_40_1)
	...
	local var_40_1 = arg_40_0.getConfig(var_40_0, "config_client").endingtime
