...
function var_0_1.initTime(arg_4_0)
	if not arg_4_0:IsAlwaysTime() then
		...
		local var_4_1 = arg_4_0.getConfig(var_4_0, "time")

		EducateHelper = var_4_0
		arg_4_0.startTime, arg_4_0.endTime = var_4_0.CfgTime2Time(var_4_1)
	end
...
function var_0_1.GetPrice(arg_9_0, arg_9_1)
	...
	local var_9_1 = arg_9_0.getConfig(var_9_0, "resource_num")
	...
	return var_9_0.floor(var_9_1 * (1 - arg_9_1 / 16))
end
