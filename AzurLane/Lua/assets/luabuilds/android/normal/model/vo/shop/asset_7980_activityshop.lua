...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in var_1_1(var_1_2.all) do
		if arg_1_1.id == var_1_2[iter_1_3].activity then
			...
			Goods = var_1_10013
			var_1_4[iter_1_3] = var_1_10011(var_1_5, var_1_10013.TYPE_ACTIVITY)
		end
	end
...
function var_0_1.getBgPath(arg_18_0)
	...
	local var_18_4 = var_6.New(var_18_1[1], var_18_1[2], var_18_1[3], var_18_1[4])
end
...
function var_0_1.GetResList(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0.goods) do
		var_1_10008 = iter_21_1
		var_21_0[iter_21_1.getConfig(var_1_10008, "resource_type")] = true
	end
