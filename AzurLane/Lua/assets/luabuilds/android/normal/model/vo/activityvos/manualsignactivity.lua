...
function var_0_1.TodayIsSigned(arg_6_0)
	...
	local var_6_2 = arg_6_0.GetIndexByToday(var_6_1)

	table = var_6_1

	return var_6_1.contains(var_6_0, var_6_2)
end

function var_0_1.Signed(arg_7_0)
	local var_7_0 = arg_7_0
	local var_7_1 = arg_7_0.GetIndexByToday(var_7_0)

	table = var_7_0

	if not var_7_0.contains(arg_7_0.data1_list, var_7_1) then
		arg_7_0.data1 = arg_7_0.data1 + 1
		table = var_2

		var_2.insert(arg_7_0.data1_list, var_7_1)
	end
...
function var_0_1.GetCanGetAwardIndexList(arg_11_0)
	...
	local var_11_1 = arg_11_0.GetGetAwardCnt(var_11_0)

	math = var_11_0

	if var_11_0.max(arg_11_0:GetSignedDayCnt() - var_11_1, 0) <= 0 then
		return {}
	end
	...
	local var_11_2 = var_11_1 == 0 and 0 or arg_11_0.data2_list[var_11_1]
	local var_11_3 = arg_11_0
	local var_11_4 = arg_11_0.GetTotalDayCnt(var_11_3)

	math = var_11_3

	local var_11_5 = var_11_3.min(var_11_2 + var_2, var_11_4)
	local var_11_6 = {}

	for iter_11_0 = var_11_2 + 1, var_11_5 do
		table = var_1_10011

		var_1_10011.insert(var_11_6, iter_11_0)
	end
...
function var_0_1.GetAwardState(arg_12_0, arg_12_1)
	...
	local var_12_1 = arg_12_0.GetCanGetAwardIndexList(var_12_0)

	table = var_12_0

	if var_12_0.contains(var_12_1, arg_12_1) then
...
function var_0_1.GetAllAwards(arg_14_0)
	...
	local var_14_1 = arg_14_0.GetCanGetAwardIndexList(var_14_0)
...
function var_0_1.IsManualSignActAndAnyAwardCanGet(arg_16_0)
	...
	ManualSignActivity = var_1_10004

	if not var_16_0(var_16_1, var_1_10004) then
		return false
	end
