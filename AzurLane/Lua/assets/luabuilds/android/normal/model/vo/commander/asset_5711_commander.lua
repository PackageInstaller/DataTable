...
local var_0_2 = var_0_0.commander_level

pg = var_2

local var_0_3 = var_2.commander_attribute_template
local var_0_4 = 0
local var_0_5 = 1
...
function var_0_1.Ctor(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_3(arg_3_1.ability_origin) do
		...
		var_9.insert(arg_3_0.talentOrigins, var_1_10008)
	end
	...
	for iter_3_4, iter_3_5 in var_3(arg_3_1.skill) do
		...
		var_9.insert(arg_3_0.skills, var_1_10008)
	end
...
function var_0_1.getRenameTimeDesc(arg_8_0)
	...
	local var_8_3 = var_1_10003.TimeMgr.GetInstance()
...
function var_0_1.setLock(arg_9_0, arg_9_1)
	...
	var_1_10002(var_1_10003(arg_9_1) == "number")
...
function var_0_1.GetDisplayTalents(arg_18_0)
	...
	if arg_18_0.IsRegularTalent(var_18_0) then
		local var_18_1 = {}

		ipairs = var_18_0

		for iter_18_0, iter_18_1 in var_18_0(arg_18_0:getConfig("ability_show")) do
			CommanderTalent = var_1_10007

			if not var_18_1[var_1_10007.New({
				id = iter_18_1
			}).groupId] then
				var_18_1[var_1_10007.groupId] = {}
			end

			table = var_8

			var_8.insert(var_18_1[var_1_10007.groupId], var_1_10007)
		end
		...
		for iter_18_2, iter_18_3 in var_4(var_18_1) do
			local var_18_4 = var_0_6(arg_18_0, iter_18_3)

			table = var_10

			var_10.insert(var_18_2, var_18_4)
		...
		var_4.sort(var_18_2, function(arg_19_0, arg_19_1)
...
function var_0_1.getTotalPoint(arg_31_0)
	...
	local var_31_2 = var_31_0(var_31_1 / var_1_10003.TALENT_POINT_LEVEL)

	CommanderConst = var_2

	return var_31_2 * var_2.TALENT_POINT
end
...
function var_0_1.getTalentsDesc(arg_38_0)
	...
	local var_38_2 = arg_38_0.getTalents(var_38_1)

	ipairs = var_38_1

	for iter_38_0, iter_38_1 in var_38_1(var_38_2) do
		pairs = var_1_10008
...
function var_0_1.updateAbilitys(arg_40_0)
	...
	local function var_40_2(arg_41_0)
		...
		return var_41_0.floor(var_41_1 + var_41_1 * (arg_40_0.level - 1) * var_40_0 / var_40_1)
	end
...
function var_0_1.getAbilitysAddition(arg_42_0)
	...
	local function var_42_4(arg_43_0)
		...
		return var_2(var_3.format("%0.3f", (var_42_0 - var_42_1 / (var_43_0 + var_42_2)) * var_42_3))
	end
	...
	for iter_42_0, iter_42_1 in var_1_10007(var_1_10008.PROPERTIES) do
...
function var_0_1.getTalentsAddition(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4)
	...
	local var_44_2 = arg_44_0.getTalents(var_44_1)

	pairs = var_44_1

	for iter_44_0, iter_44_1 in var_44_1(var_44_2) do
		local var_44_3, var_44_4 = iter_44_1:getAttrsAddition()
		local var_44_5
...
function var_0_1.getAttrRatioAddition(arg_45_0, arg_45_1, arg_45_2, arg_45_3)
	...
	if var_45_0(var_1_10005.PROPERTIES, arg_45_1) then
		...
		return var_45_1 + var_45_3(var_45_2, var_1_10008.TALENT_ADDITION_RATIO, arg_45_1, arg_45_2, arg_45_3) / 100
	else
		return 0
	end
...
function var_0_1.getAttrValueAddition(arg_46_0, arg_46_1, arg_46_2, arg_46_3)
	...
	if var_46_0(var_1_10005.PROPERTIES, arg_46_1) then
		local var_46_1 = arg_46_0
		local var_46_2 = arg_46_0.getTalentsAddition

		CommanderConst = var_6

		return (var_46_2(var_46_1, var_6.TALENT_ADDITION_NUMBER, arg_46_1, arg_46_2, arg_46_3))
	else
		return 0
	end
...
function var_0_1.updateLevel(arg_52_0)
	...
	arg_52_0.updateAbilitys(var_52_0)

	local var_52_1 = arg_52_0.level

	CommanderConst = var_52_0

	if var_52_1 % var_52_0.TALENT_POINT_LEVEL == 0 then
...
function var_0_1.GetNextResetAbilityTime(arg_68_0)
	...
	if var_1_10001.gameset.commander_ability_reset_time.key_value == 1 then
		...
		return var_1.GetNextTimeByTimeStamp(var_1_10002, arg_68_0.abilityTime) + 0
	else
		local var_68_0 = arg_68_0.abilityTime

		pg = var_1_10002

		return var_68_0 + var_1_10002.gameset.commander_ability_reset_coldtime.key_value
	end
...
function var_0_1.canEquipToEliteChapter(arg_72_0, arg_72_1, arg_72_2, arg_72_3)
	...
	local var_72_0 = var_1_10004(var_1_10005)
...
function var_0_1.canEquipToFleetList(arg_73_0, arg_73_1, arg_73_2, arg_73_3)
	...
	local var_73_0 = var_1_10004(var_1_10005)

	if not var_4.getCommanderById(var_73_0, arg_73_3) then
		var_73_0 = false
		i18n = var_7

		local var_73_1 = var_7("commander_not_found")
	...
	for iter_73_0, iter_73_1 in var_73_0(arg_73_0) do
		if iter_73_0 == arg_73_1 then
			...
			for iter_73_2, iter_73_3 in var_1_10011(iter_73_1) do
				...
				if var_4.getCommanderById(var_1_10017, iter_73_3) and var_16.groupId == var_5.groupId and iter_73_2 ~= arg_73_2 then
					var_1_10017 = false
					i18n = var_18
...
function var_0_1.ExitFeedFlag(arg_75_0)
	...
	local var_75_2 = var_75_0.TimeMgr.GetInstance()
...
function var_0_1.ExitPlayFlag(arg_76_0)
	...
	local var_76_2 = var_76_0.TimeMgr.GetInstance()
...
function var_0_1.CanReset(arg_81_0)
	...
	local var_81_1 = arg_81_0.GetNextResetAbilityTime(var_81_0)

	pg = var_81_0

	local var_81_2 = var_81_0.TimeMgr.GetInstance()

	return var_81_1 <= var_2.GetServerTime(var_81_2)
end
