...
function var_0_1.canBuildShipByBuildId(arg_10_0, arg_10_1, arg_10_2)
	...
	if not var_1_10003.ship_data_create_material[arg_10_0] then
		var_1_10004 = false
		i18n = var_1_10005
		var_1_10005 = var_1_10005("ship_buildShip_error_noTemplate", arg_10_0)
	...
	local var_10_0 = var_1_10004(var_1_10005)
	local var_10_1 = var_4.getData(var_10_0)

	table = var_10_0

	local var_10_2 = var_10_0.getCount(var_10_1) + arg_10_1

	MAX_BUILD_WORK_COUNT = var_10_3
	...
	if var_10_3 < var_10_2 then
		var_10_2 = false
		i18n = var_10_3
		var_10_3 = var_10_3("ship_buildShip_not_position")
	...
	if arg_10_2 then
		getProxy = var_10_2
		ActivityProxy = var_10_3
		var_10_3 = var_10_2(var_10_3)
		var_1_10008 = var_6.getBuildFreeActivityByBuildId(var_10_3, arg_10_0)
		var_10_3 = var_6.getConfig(var_1_10008, "config_client")[1]
		Drop = var_1_10008
		...
		var_10_4.type = var_1_10010
		var_10_4.id = var_10_3

		local var_10_5 = var_1_10008(var_10_4)

		var_1_10008 = var_1_10008.getName(var_10_5)

		if var_6 then
			var_1_10010 = var_6

			if var_6.isEnd(var_1_10010) then
				local var_10_6 = false

				i18n = var_1_10010
				var_1_10010 = var_1_10010("tip_build_ticket_expired", var_1_10008)

				return
			elseif arg_10_1 > var_6.data1 then
				local var_10_7 = false

				i18n = var_1_10010

				local var_10_8 = var_1_10010("tip_build_ticket_not_enough", var_1_10008)
			...
			if false then
				...
				local var_10_10 = var_10_3(var_1_10008)

				if var_7.getData(var_10_10).gold < var_3.use_gold * arg_10_1 then
					table = var_9

					var_9.insert(var_10_9, {
						59001,
				...
				local var_10_11 = var_9(var_10)

				if not var_9.getData(var_10_11)[var_3.use_item] or var_10[var_3.use_item].count < var_3.number_1 * arg_10_1 then
					local var_10_12 = var_3.number_1 * arg_10_1
					local var_10_13 = var_3.use_item

					if var_10[var_3.use_item] then
						var_10_12 = var_3.number_1 * arg_10_1 - var_10[var_10_13].count
					end

					table = var_13

					var_13.insert(var_10_9, {
						var_10_13,
						var_10_12,
				...
				if 0 < var_10_14 then
					...
					return var_10_15, var_12("ship_buildShip_error_notEnoughItem"), var_10_9
				end
			end
...
function var_0_1.canQuickBuildShip(arg_11_0)
	...
	if not var_1.getBuildShip(var_11_0, arg_11_0) then
		...
		local var_11_2 = var_4("ship_buildShipImmediately_error_noSHip")
	...
	if var_2.isFinish(var_11_3) then
		var_11_4 = false
		i18n = var_11_3
		var_11_3 = var_11_3("ship_buildShipImmediately_error_finished")
	...
	ITEM_ID_EQUIP_QUICK_FINISH = var_1_10006

	local var_11_7

	if not var_11_6(var_11_5, var_1_10006) then
		var_11_7 = {
			count = 0
		}
	end
