...
function var_0_1.Ctor(arg_2_0, arg_2_1, arg_2_2)
	...
	for iter_2_0, iter_2_1 in var_3(var_2_0.REPAIR_ATTRS) do
		var_1_10008 = arg_2_0.attrs
		MetaCharacterAttr = var_1_10009
		var_1_10008[iter_2_1] = var_1_10009.New({
			attr = iter_2_1,
	...
	for iter_2_2, iter_2_3 in var_3(var_2_1) do
		pairs = var_1_10008

		for iter_2_4, iter_2_5 in var_1_10008(arg_2_0.attrs) do
			if iter_2_5:hasItemId(iter_2_3) then
				local var_2_2 = iter_2_5:getLevelByItemId(iter_2_3)

				iter_2_5:updateCount(var_2_2)
			end
		end
	end
...
function var_0_1.getPercentageAddition(arg_11_0, arg_11_1)
	...
	local var_11_2 = arg_11_0.getRepairRate(var_11_1) * 100

	ipairs = var_11_1

	for iter_11_0, iter_11_1 in var_11_1(arg_11_0.effects) do
		if var_11_2 >= iter_11_1.progress then
...
function var_0_1.getTotalMaxAddition(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10002(arg_13_0.attrs) do
		...
		if iter_13_1 and iter_13_1:isLock() then
			...
			local var_13_3 = var_1_10009(iter_13_1)

			var_1_10009.level = var_1_10009.getItemCount(var_13_3) + 1
			var_13_2 = var_13_2 + var_1_10009:getAddition()
		end
	...
	for iter_13_2, iter_13_3 in var_2(arg_13_0.effects) do
		...
		local var_13_5 = iter_13_3.getAttrAdditionList(var_13_4)

		ipairs = var_13_4

		for iter_13_4, iter_13_5 in var_13_4(var_13_5) do
			local var_13_6 = iter_13_5[1]
			local var_13_7 = iter_13_5[2]

			if var_13_0[var_13_6] then
				var_13_0[var_13_6] = var_13_0[var_13_6] + var_13_7
			else
				var_13_0[var_13_6] = var_13_7
			end
		end
	end
...
function var_0_1.getFinalAddition(arg_14_0, arg_14_1)
	...
	local var_14_2 = arg_14_0.getTotalMaxAddition(var_14_1)

	pairs = var_14_1

	for iter_14_0, iter_14_1 in var_14_1(var_14_0) do
		...
		var_14_0[iter_14_0] = var_14_3 + var_14_4
	end
...
function var_0_1.getUnlockedVoiceList(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10004(var_18_0) do
		if var_18_1 >= iter_18_1.progress and iter_18_1.words ~= "" then
			...
			for iter_18_2, iter_18_3 in var_10(iter_18_1.words) do
				...
				var_1_10015.insert(var_18_2, iter_18_3)
			end
		end
	end
