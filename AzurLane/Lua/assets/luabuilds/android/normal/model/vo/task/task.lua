...
function var_0_1.isFinish(arg_14_0)
	...
	local var_14_2 = arg_14_0.getConfig(var_14_1, "sub_type")

	TASK_SUB_TYPE_REPEATABLE = var_14_1
...
function var_0_1.getProgress(arg_15_0)
	...
	local var_15_0 = arg_15_0:getConfig("sub_type")
	local var_15_1 = {}

	TASK_SUB_TYPE_GIVE_ITEM = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_16_0 = arg_15_0
		local var_16_1 = var_2_10000(var_1.getConfig(var_16_0, "target_id"))

		getProxy = var_1
		BagProxy = var_16_0

		local var_16_2 = var_1(var_16_0)
		local var_16_3 = var_1.getItemCountById

		tonumber = var_3

		return var_16_3(var_16_2, var_3(var_16_1))
	end
	TASK_SUB_TYPE_PT = var_4
	var_15_1[var_4] = function()
		...
		if not var_17_1(var_17_0, var_2_10002(var_3.getConfig(var_17_2, "target_id_2"))) or not var_0.data1 then
			var_17_3 = 0
		end

		return var_17_3
	end
	TASK_SUB_TYPE_PLAYER_RES = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_18_0 = arg_15_0
		local var_18_1 = var_2_10000(var_1.getConfig(var_18_0, "target_id"))

		getProxy = var_1
		PlayerProxy = var_18_0

		local var_18_2 = var_1(var_18_0)
		local var_18_3 = var_1.getData(var_18_2)

		return var_1.getResById(var_18_3, var_18_1)
	end
	TASK_SUB_TYPE_GIVE_VIRTUAL_ITEM = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_19_0 = arg_15_0
		local var_19_1 = var_2_10000(var_1.getConfig(var_19_0, "target_id"))

		getProxy = var_1
		ActivityProxy = var_19_0

		local var_19_2 = var_1(var_19_0)

		return var_1.getVirtualItemNumber(var_19_2, var_19_1)
	end
	TASK_SUB_TYPE_BOSS_PT = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_20_0 = arg_15_0
		local var_20_1 = var_2_10000(var_1.getConfig(var_20_0, "target_id"))

		getProxy = var_1
		PlayerProxy = var_20_0

		local var_20_2 = var_1(var_20_0)
		local var_20_3 = var_1.getData(var_20_2)

		return var_1.getResById(var_20_3, var_20_1)
	end
	TASK_SUB_STROY = var_4
	var_15_1[var_4] = function()
		...
		var_2.each(var_21_1, function(arg_22_0)
			pg = var_3_10001
	...
	TASK_SUB_TYPE_TECHNOLOGY_POINT = var_4
	var_15_1[var_4] = function()
		math = var_2_10000
		...
		local var_23_1 = var_2_10001(var_2_10002)
		local var_23_2 = var_1.getNationPoint

		tonumber = var_2_10003

		local var_23_3 = arg_15_0
		local var_23_4 = var_23_2(var_23_1, var_2_10003(var_4.getConfig(var_23_3, "target_id")))
		local var_23_5 = arg_15_0

		return var_23_0(var_23_4, var_2.getConfig(var_23_5, "target_num"))
	end
	TASK_SUB_TYPE_VITEM = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_24_0 = arg_15_0
		local var_24_1 = var_2_10000(var_1.getConfig(var_24_0, "target_id"))

		tonumber = var_1

		local var_24_2 = arg_15_0
		local var_24_3 = var_1(var_2.getConfig(var_24_2, "target_id_2"))
	...
	TASK_SUB_TYPE_VITEMS = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_25_0 = arg_15_0
		local var_25_1 = var_2_10000(var_1.getConfig(var_25_0, "target_id"))

		underscore = var_1

		local var_25_2 = var_1.all
		local var_25_3 = arg_15_0

		if var_25_2(var_2.getConfig(var_25_3, "target_id_2"), function(arg_26_0)
			Drop = var_3_10001
	...
	TASK_SUB_TYPE_JOIN_GUILD = var_4
	var_15_1[var_4] = function()
		getProxy = var_2_10000
	...
	TASK_SUB_TYPE_COLLAB_BOSS_RUSH_DEFEAT = var_4
	var_15_1[var_4] = function()
		tonumber = var_2_10000

		local var_28_0 = arg_15_0
		local var_28_1 = var_2_10000(var_1.getConfig(var_28_0, "target_id"))

		getProxy = var_1
		ActivityProxy = var_28_0

		local var_28_2 = var_1(var_28_0)
		local var_28_3 = var_1.getActivityByType

		ActivityConst = var_3

		if not var_28_3(var_28_2, var_3.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB) then
			return 0
		end

		local var_28_4 = var_1
		local var_28_5 = var_1.GetCollabSeriesDataList(var_28_4)

		pairs = var_28_4

		for iter_28_0, iter_28_1 in var_28_4(var_28_5) do
	...
	TASK_SUB_TYPE_REPEATABLE = var_4
	var_15_1[var_4] = function()
	...
	if not var_1_10001(var_15_0, var_15_1, function()
...
function var_0_1.onAdded(arg_36_0)
	local function var_36_0()
		...
		if var_0.getConfig(var_37_0, "sub_type") == 29 then
			...
			if var_37_1.any(var_37_2, function(arg_38_0)
			...
			var_37_4(var_37_3, var_3.TASK_GO, {
				taskVO = arg_36_0
			})
		else
			...
			if 0 < var_37_6 then
				...
				if var_37_9 ~= var_2_10004.__cname then
					function var_37_7()
						...
						local var_39_2 = var_3_10002.GO_SCENE

						SCENE = var_3_10003

						local var_39_3 = var_3_10003.TASK
						local var_39_4 = {}
						local var_39_5 = var_0_2
						local var_39_6 = arg_36_0

						var_39_4.page = var_39_5[var_6.GetRealType(var_39_6)]
				...
				var_37_12.content = var_2_10006(var_37_13, var_8.getConfig(var_37_14, "name"))
...
function var_0_1.isSelectable(arg_42_0)
	...
	if arg_42_0.getConfig(var_42_0, "award_choice") ~= nil then
		type = var_42_0

		local var_42_1

		if var_42_0(var_1) ~= "table" or not (#var_1 > 0) then
			var_42_1 = false
		else
			var_42_1 = true
		end
...
function var_0_1.StaticJudgeOverflow(arg_44_0, arg_44_1, arg_44_2, arg_44_3, arg_44_4, arg_44_5)
	if arg_44_3 and arg_44_4 then
		...
		local var_44_0 = var_1_10006(var_1_10007)
		local var_44_1 = var_6.getData(var_44_0)

		pg = var_44_0

		local var_44_2 = var_44_0.gameset.urpt_chapter_max.description[1]
		...
		if not arg_44_2 then
			...
			if not var_1_10010 then
				...
				if not var_1_10010.GetLimitCntById(var_1_10011, var_44_2) then
					var_1_10010 = 0
				end
					...
					for iter_44_0, iter_44_1 in var_1_10021(var_44_14) do
						...
						if var_1_10026 == var_1_10029 then
							...
							if var_44_15 == var_1_10029.ResGold then
								if var_44_3 + var_44_16 - var_44_5 > 0 then
									var_44_8 = true

									local var_44_17 = {}

									DROP_TYPE_RESOURCE = var_1_10031
									var_44_17.type = var_1_10031
									PlayerConst = var_1_10031
									var_44_17.id = var_1_10031.ResGold
									setColorStr = var_1_10031
									var_1_10032 = var_1_10029
									COLOR_RED = var_1_10033
									var_44_17.count = var_1_10031(var_1_10032, var_1_10033)
									table = var_1_10031

									var_1_10031.insert(var_44_13, var_44_17)
								end
							else
								PlayerConst = var_1_10029

								if var_44_15 == var_1_10029.ResOil and var_44_4 + var_44_16 - var_44_6 > 0 then
									var_44_9 = true

									local var_44_18 = {}

									DROP_TYPE_RESOURCE = var_1_10031
									var_44_18.type = var_1_10031
									PlayerConst = var_1_10031
									var_44_18.id = var_1_10031.ResOil
									setColorStr = var_1_10031
									var_1_10032 = var_1_10029
									COLOR_RED = var_1_10033
									var_44_18.count = var_1_10031(var_1_10032, var_1_10033)
									table = var_1_10031

									var_1_10031.insert(var_44_13, var_44_18)
								end
							end
						else
							...
							if not var_1_10029 then
								...
								if var_1_10026 == var_1_10029 then
									...
									if var_1_10029.getConfigData(var_44_15).virtual_type == 20 then
										local var_44_19 = var_1_10010 + var_44_16 - var_44_7
										...
										if 0 < var_44_19 then
											...
											var_1_10033 = var_44_19
											COLOR_RED = var_1_10034
											var_1_10031.count = var_1_10032(var_1_10033, var_1_10034)
											table = var_1_10032
							...
							if var_1_10026 == var_1_10029 then
								...
								if var_1_10029 == var_30.EXP_BOOK_TYPE then
									getProxy = var_1_10029
									BagProxy = var_30

									local var_44_20 = var_1_10029(var_30)

									var_1_10029 = var_1_10029.getItemCountById(var_44_20, var_44_15) + var_44_16
									Item = var_44_20

									if var_44_20.getConfigData(var_44_15).max_num < var_1_10029 then
										var_44_11 = true
										var_1_10031 = {}
										...
										setColorStr = var_1_10032
										math = var_1_10033
										var_1_10033 = var_1_10033.min(var_44_16, var_1_10029 - var_30)
										COLOR_RED = var_1_10034
										var_1_10031.count = var_1_10032(var_1_10033, var_1_10034)
										table = var_1_10032
...
function var_0_1.IsOverflowShipExpItem(arg_48_0)
	local function var_48_0(arg_49_0, arg_49_1)
		...
		local var_49_0 = var_2_10002(var_2_10003)
		local var_49_1 = var_2.getItemCountById(var_49_0, arg_49_0) + arg_49_1

		Item = var_49_0

		return var_49_1 > var_49_0.getConfigData(arg_49_0).max_num
	end

	local var_48_1 = arg_48_0
	local var_48_2 = arg_48_0.getConfig(var_48_1, "award_display")

	ipairs = var_48_1

	for iter_48_0, iter_48_1 in var_48_1(var_48_2) do
		local var_48_3 = iter_48_1[1]
		local var_48_4 = iter_48_1[2]
		local var_48_5 = iter_48_1[3]

		DROP_TYPE_ITEM = var_1_10011

		if var_48_3 == var_1_10011 then
			Item = var_1_10011
			var_1_10011 = var_1_10011.getConfigData(var_48_4).type
			Item = var_12

			if var_1_10011 == var_12.EXP_BOOK_TYPE and var_48_0(var_48_4, var_48_5) then
				return true
			end
		end
	end
...
function var_0_1.ShowOnTaskScene(arg_50_0)
	...
	if arg_50_0.id == 17268 then
		...
		local var_50_1 = var_2(var_3)
		local var_50_2 = var_2.getActivityById

		ActivityConst = var_1_10004

		if var_50_2(var_50_1, var_1_10004.BUILDING_NEWYEAR_2022) and not var_2:isEnd() then
			local var_50_3
...
function var_0_1.getGiveDrops(arg_58_0)
	...
	local var_58_2 = arg_58_0.getConfig(var_58_1, "sub_type")

	TASK_SUB_TYPE_VITEMS = var_58_1

	if var_58_2 == var_58_1 then
		tonumber = var_58_2

		local var_58_3 = var_58_2(arg_58_0:getConfig("target_id"))

		ipairs = var_3

		for iter_58_0, iter_58_1 in var_3(arg_58_0:getConfig("target_id_2")) do
			table = var_1_10008
			...
			var_1_10008(var_58_4, var_1_10010.New({
				type = var_58_3,
				id = iter_58_1[1],
				count = iter_58_1[2]
			}))
...
function var_0_1.OwnSpAward(arg_59_0)
	local function var_59_0(arg_60_0)
		...
		local var_60_0 = var_2_10001(var_2_10002)
	...
	local function var_59_1(arg_61_0)
		...
		local var_61_0 = var_2_10001(var_2_10002)
		local var_61_1
