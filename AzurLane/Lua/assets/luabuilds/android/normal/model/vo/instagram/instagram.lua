...
function var_0_1.InitByServer(arg_2_0, arg_2_1)
	...
	for iter_2_4, iter_2_5 in var_2(arg_2_1.player_discuss) do
		if iter_2_5.text == "" then
			...
			InstagramPlayerComment = var_1_10009

			var_1_10007(var_2_0, var_1_10009.New(iter_2_5, arg_2_0, 1))
		end
	end
	...
	for iter_2_8, iter_2_9 in var_2(arg_2_1.npc_discuss) do
		...
		InstagramNpcComment = var_1_10009

		var_1_10007(var_2_1, var_1_10009.New(iter_2_9, arg_2_0, 1))
	end
...
function var_0_1.InitByConfig(arg_3_0, arg_3_1)
	...
	local var_3_1 = arg_3_0.getConfig(var_3_0, "message_persist")

	assert = var_3_0

	var_3_0(var_0_2[var_3_1], var_3_1)

	arg_3_0.text = var_0_2[var_3_1].value
	arg_3_0.picture = arg_3_0:getConfig("picture_persist")
	pg = var_3

	local var_3_2 = var_3.TimeMgr.GetInstance()

	arg_3_0.time = var_3.parseTimeFromConfig(var_3_2, arg_3_0:getConfig("time_persist"))

	local var_3_3 = arg_3_0

	arg_3_0.oaListPic = arg_3_0.getConfig(var_3_3, "oalist_pic_persist")
	arg_3_0.optionDiscuss = {}
	arg_3_0.discussList = {}
	getProxy = var_3
	InstagramProxy = var_3_3

	local var_3_4 = var_3(var_3_3)

	arg_3_0.allReply = var_3.GetAllReply(var_3_4)
	ipairs = var_3
	...
	for iter_3_0, iter_3_1 in var_3(arg_3_1.player_discuss) do
		if iter_3_1.text == "" then
			...
			local var_3_5 = var_8.insert
			local var_3_6 = arg_3_0.discussList

			InstagramPlayerComment = var_1_10010

			var_3_5(var_3_6, var_1_10010.New(iter_3_1, arg_3_0, 1))
		end
	end

	local var_3_7 = arg_3_0
	local var_3_8 = arg_3_0.getConfig(var_3_7, "npc_discuss_persist")

	type = var_3_7

	if var_3_7(var_3_8) == "table" then
		ipairs = var_4

		for iter_3_4, iter_3_5 in var_4(var_3_8) do
			local var_3_9 = arg_3_0.allReply[iter_3_5]

			table = var_1_10010
			var_1_10010 = var_1_10010.insert

			local var_3_10 = arg_3_0.discussList

			InstagramNpcComment = iter_3_3

			var_1_10010(var_3_10, iter_3_3.New(var_3_9, arg_3_0, 1))
		end
	end
...
function var_0_1.GetLasterUpdateTime(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10002(arg_4_0.discussList) do
		...
		local var_4_2 = iter_4_1.GetLasterUpdateTime(var_4_1)

		table = var_4_1

		var_4_1.insert(var_4_0, var_4_2)
	end
...
function var_0_1.GetFastestRefreshTime(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0.discussList) do
		...
		if iter_21_1.GetFasterRefreshTime(var_21_1) then
			table = var_21_1
