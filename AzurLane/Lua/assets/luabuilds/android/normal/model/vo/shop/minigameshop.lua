...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_2(var_1_10003.gameroom_shop_template.all) do
		Goods = var_1_10007
		var_1_10007 = var_1_10007.Create
		pg = var_1_10008
		var_1_10008 = var_1_10008.gameroom_shop_template[iter_1_1]
		Goods = var_1_10009
		var_1_10007 = var_1_10007(var_1_10008, var_1_10009.TYPE_MINI_GAME)
		var_1_10009 = arg_1_0

		if not arg_1_0.getGoodData(var_1_10009, iter_1_1) then
			var_1_10008 = 0
		end

		var_1_10007:UpdateCnt(var_1_10008)
...
function var_0_1.setNextTime(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10002(arg_2_0.goodsData) do
		...
		if var_1_10009.gameroom_shop_template[var_2_0] then
			...
			var_1_10009(var_2_2 .. var_1_10011(var_2_0) .. "的物品")
		end
...
function var_0_1.IsSameKind(arg_6_0, arg_6_1)
	...
	MiniGameShop = var_1_10004

	return var_1_10002(var_6_0, var_1_10004)
end
