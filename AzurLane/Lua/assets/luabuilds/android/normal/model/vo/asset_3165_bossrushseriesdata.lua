...
function var_0_1.CopyFleetsByOther(arg_13_0, arg_13_1)
	...
	for iter_13_0 = 1, #var_13_0 - 1 do
		...
		var_13_3.__index = var_12.SeparateOut(var_13_4)
		var_1_10008 = var_1_10008(var_1_10009(var_13_2, var_13_3))

		if iter_13_0 == 1 then
			var_13_2 = arg_13_0

			if not arg_13_0.IsSingleFight(var_13_2) then
				var_13_2 = var_1_10008

				var_1_10008.allClear(var_13_2)
			end
		end
		...
		local var_13_5 = var_1_10009(var_13_2)

		var_1_10009.updateActivityFleet(var_13_5, arg_13_0.actId, var_13_1[iter_13_0], var_1_10008)
	end

	getProxy = var_4
	FleetProxy = var_5

	local var_13_6 = var_4(var_5)
	local var_13_7 = var_4.updateActivityFleet
	local var_13_8 = arg_13_0.actId
	local var_13_9 = var_13_1[#var_13_1]

	TypedFleet = var_1_10008

	local var_13_10 = var_1_10008.New
	...
	local var_13_12 = {}
	local var_13_13 = var_13_0[#var_13_0]

	var_13_12.__index = var_12.SeparateOut(var_13_13)

	var_13_7(var_13_6, var_13_8, var_13_9, var_13_10(var_1_10009(var_13_11, var_13_12)))

	getProxy = var_13_7
	FleetProxy = var_13_6

	local var_13_14 = var_13_7(var_13_6)

	var_4.commitActivityFleet(var_13_14, arg_13_0.actId)
...
function var_0_1.GetModeFleetIDs(arg_17_0, arg_17_1)
	...
	if arg_17_1 == var_0_1.MODE.SINGLE then
		...
		if arg_17_1 == var_0_1.MODE.MULTIPLE then
			...
			var_17_3 = {}
			table = var_6
			var_17_3[1] = var_6.remove(var_17_1)
			var_17_2 = var_17_3
		else
			assert = var_17_3
...
function var_0_1.StaticCalculateFleetIds(arg_36_0, arg_36_1)
	...
	return var_36_0(var_3.range(0, arg_36_1 + 1), function(arg_37_0)
