...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_2(var_1_10003.gameset.child_target_set_date.description) do
...
function var_0_0.CheckTargetSet(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_13_0(arg_13_0.targetSetDays) do
...
function var_0_0.GetMainTasksForShow(arg_15_0)
	...
	for iter_15_0, iter_15_1 in var_1_10002(var_1_10003.child_task.all) do
		pg = var_1_10007
...
function var_0_0.FilterByGroup(arg_16_0, arg_16_1, arg_16_2)
	...
	for iter_16_0, iter_16_1 in var_1_10004(arg_16_1) do
		var_1_10010 = iter_16_1

		if not var_16_0[iter_16_1.getConfig(var_1_10010, "group")] then
			var_16_0[var_9] = {}
		end
	...
	for iter_16_2, iter_16_3 in var_5(var_16_0) do
		...
		var_1_10010(var_16_2, var_1_10012({
			function(arg_17_0)
		...
		if arg_16_2 then
			...
			if var_1_10010.any(iter_16_3, function(arg_20_0)
				...
				var_11.insert(var_16_1, iter_16_3[1])
			end
		else
			table = var_1_10010
...
function var_0_0.GetMainTargetTaskProgress(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10003(var_1_10004.child_task.all) do
		pg = var_1_10008
...
function var_0_0.GetShowTargetTasks(arg_28_0)
	...
	local var_28_1 = arg_28_0.FilterByGroup
	local var_28_2 = arg_28_0
	local var_28_3 = var_28_1(var_28_0, arg_28_0.GetTargetTasksForShow(var_28_2))

	table = var_28_0

	local var_28_4 = var_28_0.sort
	local var_28_5 = var_28_3

	CompareFuncs = var_28_2

	var_28_4(var_28_5, var_28_2({
		function(arg_29_0)
