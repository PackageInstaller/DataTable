...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	for iter_1_0, iter_1_1 in var_1_0(var_1_5) do
...
function var_0_1.SetSiteState(arg_2_0, arg_2_1)
	...
	if var_2_3 == var_5.SITE_STATE_TYPE.EVENT then
		var_2_4 = var_2_2

		local var_2_5 = var_2_2.GetSiteId

		NewEducateConst = var_1_10006
		arg_2_0.curSiteId = var_2_5(var_2_4, var_1_10006.SITE_TYPE.EVENT, arg_2_1.value)
	else
		local var_2_6 = arg_2_1.key

		NewEducateConst = var_2_4

		local var_2_8

		if var_2_6 == var_2_4.SITE_STATE_TYPE.NORMAL then
			pg = var_2_6
			...
			if var_2_9 == var_2_8.SITE_STATE_TYPE.SHIP then
				...
				NewEducateConst = var_1_10006
				arg_2_0.curSiteId = var_2_11(var_2_10, var_1_10006.SITE_TYPE.SHIP, arg_2_1.value)
			else
				local var_2_12 = arg_2_1.key

				NewEducateConst = var_2_10

				if var_2_12 == var_2_10.SITE_STATE_TYPE.SHOP then
					local var_2_13 = var_2_2
					local var_2_14 = var_2_2.GetSiteId

					NewEducateConst = var_1_10006
					arg_2_0.curSiteId = var_2_14(var_2_13, var_1_10006.SITE_TYPE.SHOP)
				end
			end
		end
	end
...
function var_0_1.IsSpecial(arg_10_0)
	...
	return var_1_10001.any(arg_10_0.events, function(arg_11_0)
		...
		var_2_10001(var_2_10002.child2_site_event_group[arg_11_0], "child2_site_event_group不存在id" .. arg_11_0)
