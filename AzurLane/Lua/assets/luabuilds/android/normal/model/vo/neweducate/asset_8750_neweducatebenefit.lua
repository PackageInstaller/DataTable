...
function var_0_0.GetDisplayPctList(arg_15_0)
	...
	var_15_3.type = var_1_10005.DROP_TYPE.RES

	local var_15_4 = arg_15_0
	local var_15_5 = arg_15_0.GetResIdByType

	NewEducateChar = var_1_10007
	var_15_3.id = var_15_5(var_15_4, var_1_10007.RES_TYPE.MONEY)
	...
	for iter_15_0, iter_15_1 in var_15_1(arg_15_0:GetAttrIds()) do
		...
		local var_15_6 = var_15_6.insert
		local var_15_7 = var_15_0
		local var_15_8 = {}

		NewEducateConst = var_1_10010
		var_15_8.type = var_1_10010.DROP_TYPE.ATTR
		var_15_8.id = iter_15_1

		var_15_6(var_15_7, var_15_8)
	end
...
function var_0_0.GetDisplayPctByDrop(arg_18_0, arg_18_1)
	...
	for iter_18_0, iter_18_1 in var_1_10006(arg_18_0.buffs) do
		...
		for iter_18_2, iter_18_3 in var_1_10011(var_1_10012.child2_benefit_list[iter_18_0].content) do
...
function var_0_0.GetDisplayPctByBenefitId(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_8(var_6.effect) do
		...
		NewEducateConst = var_1_10016
		var_19_7[var_1_10016.EFFECT_TYPE.ADD_PPT] = function()
		...
		NewEducateConst = var_1_10016
		var_19_7[var_1_10016.EFFECT_TYPE.MULT_PPT] = function()
			if iter_19_1[2][1] == arg_19_1.type and var_0[2] == arg_19_1.id then
				table = var_1
	...
	for iter_27_0, iter_27_1 in var_1_10004(arg_27_0.buffs) do
		if #iter_27_1:GetBenefitIdsByEffectType(arg_27_2) > 0 then
			...
			for iter_27_2, iter_27_3 in var_10(var_9) do
				...
				if var_27_2(var_27_1, var_1_10017.child2_benefit[iter_27_3].condition) then
					ipairs = var_15
					pg = var_27_1
...
function var_0_0.GetExtraPlan(arg_28_0, arg_28_1)
	...
	local var_28_4 = var_28_2(var_28_1, var_28_3, var_1_10006.EFFECT_TYPE.EXTRA_PLAN)

	underscore = var_28_1

	var_28_1.each(var_28_4, function(arg_29_0)
		table = var_2_10001
...
function var_0_0.GetGoodsDiscountInfos(arg_30_0, arg_30_1)
	...
	local var_30_3 = var_30_1(var_30_0, var_30_2, var_1_10005.EFFECT_TYPE.REDUCE_GOODS_COST)
...
function var_0_0.GetActivePlanDiscountEffects(arg_33_0, arg_33_1)
	...
	for iter_33_0, iter_33_1 in var_1_10003(arg_33_0.buffs) do
		...
		local var_33_3 = #var_33_2(var_33_1, var_1_10010.EFFECT_TYPE.REDUCE_PLAN_COST)

		if 0 < var_33_3 then
			ipairs = var_33_3

			for iter_33_2, iter_33_3 in var_33_3(var_8) do
				pg = var_1_10014
				var_1_10014 = var_1_10014.child2_benefit[iter_33_3].condition

				local var_33_4 = arg_33_1
				local var_33_5 = arg_33_1.GetConditionIdsFromComplex(var_33_4, var_1_10014)

				ipairs = var_33_4

				for iter_33_4, iter_33_5 in var_33_4(var_33_5) do
					pg = var_1_10021
					...
					if var_1_10021.child2_condition[iter_33_5].type == 8 or var_1_10021.type == 15 then
						...
						for iter_33_6, iter_33_7 in var_1_10023(var_1_10024.child2_benefit[iter_33_3].effect) do
							local var_33_7 = iter_33_7[1]

							NewEducateConst = var_1_10029

							if var_33_7 == var_1_10029.EFFECT_TYPE.REDUCE_PLAN_COST then
								table = var_33_7

								var_33_7.insert(var_33_6, iter_33_7)
							end
						end
						...
						for iter_33_8, iter_33_9 in var_1_10023(var_1_10021.param[1]) do
							...
							table = var_28
							var_33_0[iter_33_9] = var_28.mergeArray(var_33_0[iter_33_9], var_33_6)
						end
					end
				end
			end
...
function var_0_0.GetPlanDiscountInfos(arg_34_0, arg_34_1)
	...
	local var_34_2 = arg_34_0.GetActivePlanDiscountEffects(var_34_1, arg_34_1)

	pairs = var_34_1

	for iter_34_0, iter_34_1 in var_34_1(var_34_2) do
