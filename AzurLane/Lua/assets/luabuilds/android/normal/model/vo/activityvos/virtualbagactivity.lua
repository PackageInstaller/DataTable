...
function var_0_1.subVitemNumber(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_1 = arg_4_0.data1KeyValueList[1]

	math = var_5
	var_4_1[arg_4_1] = var_5.max(0, var_4_0 - arg_4_2)
...
function var_0_1.GetDropCfgByType(arg_6_0)
	...
	if arg_6_0 then
		...
		pg = var_1_10002
		var_6_0 = var_6_0(var_1_10002.activity_drop_type[arg_6_0], "activity_id")
	end
	...
	if var_6_0 then
		...
		pg = var_1_10003
		var_1_10002 = var_1_10002(var_1_10003.activity_template[var_6_0], "type")
	end
