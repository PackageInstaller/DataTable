...
function var_0_1.FindFeastConfigIdByGroupId(arg_2_0, arg_2_1)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10004.ACTIVITY_TYPE_FEAST)
	...
	local var_2_4 = var_2_2.getConfig(var_2_3, "config_data")

	ipairs = var_2_3

	local var_2_5

	if not var_2_4[3] then
		var_2_5 = {}
	end

	for iter_2_0, iter_2_1 in var_2_3(var_2_5) do
		pg = var_1_10009
...
function var_0_1.GetPrefab(arg_11_0)
	...
	local var_11_1 = arg_11_0.GetSkinId(var_11_0)

	pg = var_11_0

	return var_11_0.ship_skin_template[var_11_1].prefab
end
