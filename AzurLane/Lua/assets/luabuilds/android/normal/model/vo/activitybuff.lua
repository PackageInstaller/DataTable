...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".CommonBuff"))
...
function var_0_1.isActivate(arg_4_0)
	...
	local var_4_1 = var_1:getActivityById(arg_4_0.activityId)
	local var_4_2 = var_2.getConfig(var_4_1, "type")

	ActivityConst = var_4_1

	if var_4_2 == var_4_1.ACTIVITY_TYPE_PT_BUFF then
		ActivityPtData = var_4_2

		local var_4_3 = var_4_2.New(var_2)

		if not var_3.isInBuffTime(var_4_3) then
			return false
		end
	end
	...
	return var_4(var_3[1], {
		pt = function()
			...
			local var_5_5 = var_2_10005(var_2_10006)
			local var_5_6
		...
		activity = function()
			...
			ActivityConst = var_7_1

			if var_7_2 ~= var_7_1.ACTIVITY_TYPE_BUILDING_BUFF then
				local var_7_3 = var_0
				local var_7_4 = var_0.getConfig(var_7_3, "type")

				ActivityConst = var_7_3

				if var_7_4 == var_7_3.ACTIVITY_TYPE_BUILDING_BUFF_2 then
					if var_0[3] ~= 0 then
						return true
					end
...
function var_0_1.checkChaper(arg_11_0, arg_11_1)
	if not var_0_1.GetBenefitCondition(arg_11_0:getConfig("benefit_condition")) or var_2[1] ~= "chapter" then
		...
		return var_3.contains(var_2[2], arg_11_1)
	end
...
function var_0_1.checkDungeon(arg_12_0, arg_12_1)
	if not var_0_1.GetBenefitCondition(arg_12_0:getConfig("benefit_condition")) or var_2[1] ~= "dungeon" then
		...
		return var_3.contains(var_2[2], arg_12_1)
	end
