...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".Fleet"))
...
function var_0_1.isSubmarineFleet(arg_4_0)
	...
	local var_4_1 = arg_4_0.getFleetType(var_4_0)

	FleetType = var_4_0

	return var_1_10001(var_4_1 == var_4_0.Submarine)
end
...
function var_0_1.getFleetType(arg_7_0)
	...
	if arg_7_0.fleetType then
		...
		var_7_0 = var_7_0 ~= var_1_10003.Unknown
	end
	...
	if var_7_1 == var_7_0.Unknown then
		FleetType = var_7_1
...
function var_0_1.IsTeamMatch(arg_8_0, arg_8_1)
	...
	local var_8_1 = arg_8_0.getFleetType(var_8_0)

	FleetType = var_8_0

	local var_8_2

	if var_8_1 == var_8_0.Submarine then
		TeamType = var_8_2
		var_8_2 = arg_8_1 == var_8_2.Submarine

		return var_8_2
	else
		FleetType = var_8_2

		if var_8_1 == var_8_2.Normal then
			TeamType = var_8_2

			if arg_8_1 ~= var_8_2.Vanguard then
				TeamType = var_8_2

				if arg_8_1 ~= var_8_2.Main then
					var_8_2 = false
