...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	if arg_2_0:isPtType() then
		...
		for iter_2_0, iter_2_1 in var_3(var_4.world_joint_boss_template.all) do
			pg = var_1_10008
...
function var_0_1.isFinishCurLevelStory(arg_7_0)
	...
	if var_7_0 == 0 then
		...
		local var_7_2 = var_1_10003.NewStoryMgr.GetInstance()
		local var_7_3 = var_3.StoryName2StoryId(var_7_2, var_7_0)

		if var_3:IsPlayed(var_7_3) then
			var_7_1 = true
		end
	end
...
function var_0_1.getCurLevelStoryName(arg_8_0)
	...
	local var_8_1 = arg_8_0.getCurLevelStoryIndex(var_8_0)

	pg = var_8_0

	return var_8_0.memory_template[var_8_1].title
end

function var_0_1.isCanGetAward(arg_9_0)
	local var_9_0 = arg_9_0.metaPtData
	local var_9_1 = var_1.CanGetAward(var_9_0)
	local var_9_2 = arg_9_0:getCurLevelStoryIndex()
	local var_9_3 = false
	...
	if var_9_2 == 0 then
		...
		local var_9_4 = var_1_10004.NewStoryMgr.GetInstance()
		local var_9_5 = var_4.GetStoryByName(var_9_4, "index")[var_9_2]

		if var_4:IsPlayed(var_9_2) then
			var_9_3 = true
		end
	end

	return var_9_1 and var_9_3
end
...
function var_0_1.getRepairRateFromMetaCharacter(arg_12_0)
	...
	var_2(var_12_0, "metaCharacterVO is null")
...
function var_0_1.isInAct(arg_16_0)
	...
	elseif arg_16_0:isPassType() or arg_16_0:isBuildType() then
		...
		local var_16_1 = arg_16_0.getConfig(var_16_0, "activity_id")
		...
		var_16_3 = var_2.getActivityById(var_16_2, var_16_1) and not var_2:isEnd()
...
function var_0_1.setDataBeforeGet(arg_23_0)
	...
	if arg_23_0.isPtType(var_23_0) and arg_23_0.metaPtData and not arg_23_0.unlockPTLevel then
		local var_23_1 = arg_23_0.metaPtData.targets
	...
	if (arg_23_0:isPassType() or arg_23_0:isBuildType()) and not arg_23_0.timeConfig then
		...
		local var_23_3 = arg_23_0.getConfig(var_23_2, "activity_id")

		getProxy = var_23_2
		ActivityProxy = var_3

		local var_23_4 = var_23_2(var_3)

		if var_2.getActivityById(var_23_4, var_23_3) then
			arg_23_0.timeConfig = {
...
function var_0_1.getPaintPathAndName(arg_27_0)
	...
	local var_27_1 = arg_27_0.isUnlocked(var_27_0)

	MetaCharacterConst = var_27_0

	local var_27_2, var_27_3 = var_27_0.GetMetaCharacterPaintPath(arg_27_0.configId, var_27_1)
