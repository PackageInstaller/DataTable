...
function var_0_1.GetShipAttrAddition(arg_3_0, arg_3_1, arg_3_2)
	...
	if var_3_0 == arg_3_1 then
		...
		if var_1_10006.contains(var_3_1, arg_3_2) then
...
function var_0_1.GetTargetLivness(arg_4_0)
	...
	if arg_4_0.GetNextLevelId(var_4_0) == 0 then
		return 0
	else
		pg = var_4_0

		return var_4_0.guild_technology_template[var_1].need_guild_active
	end
...
function var_0_1.GetDesc(arg_17_0)
	...
	local var_17_2 = arg_17_0.getConfig(var_17_1, "num")

	GuildConst = var_17_1

	return var_17_1.GET_TECHNOLOGY_DESC(var_17_0, var_17_2)
end
