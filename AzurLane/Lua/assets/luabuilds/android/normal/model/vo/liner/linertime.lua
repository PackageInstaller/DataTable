...
function var_0_1.GetTargetRoomIds(arg_11_0)
	...
	var_1_10002(arg_11_0:GetType(), {
		[var_0_1.TYPE.TARGET] = function()
			...
			var_12_0(var_12_1, var_2_10002(var_3.GetParamInfo(var_12_2)[1]))
		...
		[var_0_1.TYPE.EVENT] = function()
			...
			for iter_14_0, iter_14_1 in var_2_10000(var_1.GetParamInfo(var_14_0)) do
				table = var_2_10005
		...
		[var_0_1.TYPE.STORY] = function()
			...
			var_15_0(var_15_1, var_2_10002(var_3.GetParamInfo(var_15_2)[1]))
...
function var_0_1.GetStory(arg_18_0, arg_18_1)
	...
	var_1_10003(arg_18_0:GetType(), {
		...
		[var_0_1.TYPE.EVENT] = function()
			...
			if var_21_0(var_1.GetParamInfo(var_21_1), function(arg_22_0)
...
function var_0_1.GetBeforDesc(arg_24_0, arg_24_1)
	...
	local var_24_1 = arg_24_0.getConfig(var_24_0, "desc_before")

	type = var_24_0

	if var_24_0(var_24_1) == "table" then
		HXSet = var_3

		return var_3.hxLan(var_24_1[arg_24_1][1])
	else
		HXSet = var_3

		return var_3.hxLan(var_24_1)
	end
...
function var_0_1.GetAfterDesc(arg_25_0, arg_25_1)
	...
	local var_25_1 = arg_25_0.getConfig(var_25_0, "desc_after")

	type = var_25_0

	if var_25_0(var_25_1) == "table" then
		HXSet = var_3

		return var_3.hxLan(var_25_1[arg_25_1][1])
	else
		HXSet = var_3

		return var_3.hxLan(var_25_1)
	end
