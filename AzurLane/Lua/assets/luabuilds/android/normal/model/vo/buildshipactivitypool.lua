...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".BuildShipPool"))
...
function var_0_1.IsNewServerBuild(arg_7_0)
	...
	local var_7_1 = var_1.getConfig(var_7_0, "type")

	ActivityConst = var_7_0

	return var_7_1 == var_7_0.ACTIVITY_TYPE_NEWSERVER_BUILD
end
