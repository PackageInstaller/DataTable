...
function var_0_1.triggerSkill(arg_7_0, arg_7_1)
	...
	local var_7_0 = var_1_10002.filter(arg_7_0:findSkills(arg_7_1), function(arg_8_0)
		...
		local var_8_1 = arg_8_0.GetTriggers(var_8_0)

		_ = var_8_0

		local var_8_2 = var_8_0.any(var_8_1, function(arg_9_0)
		...
		local var_8_4 = var_3.getFleetType(var_8_3)

		FleetType = var_8_3

		local var_8_5

		if var_8_2 == (var_8_4 == var_8_3.Submarine) then
			_ = var_4
			var_8_5 = var_4.all(arg_8_0:GetTriggers(), function(arg_10_0)
	...
	return var_3.reduce(var_7_0, nil, function(arg_11_0, arg_11_1)
		local var_11_0 = arg_11_1:GetType()
		local var_11_1 = arg_11_1
		local var_11_2 = arg_11_1.GetArgs(var_11_1)

		FleetSkill = var_11_1

		if var_11_0 == var_11_1.TypeBattleBuff then
...
function var_0_1.NoneChapterFleetCheck(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_12_0 == var_1_10005.TriggerDDHead then
		...
		if #var_12_3(var_12_2, var_12_4, var_1_10008.Vanguard) > 0 then
			ShipType = var_6

			local var_12_5 = var_6.IsTypeQuZhu

			var_1_10008 = var_12_3[1]
			var_12_6 = var_12_5(var_7.getShipType(var_1_10008))
		else
			var_12_6 = false
		end
		...
		if var_12_0 == var_12_3.TriggerVanCount then
			...
			var_12_8 = var_12_1.getShipByTeam

			local var_12_9 = arg_12_0

			TeamType = var_1_10008

			return #var_12_8(var_12_7, var_12_9, var_1_10008.Vanguard) >= arg_12_2[2] and #var_12_8 <= arg_12_2[3]
		else
			FleetSkill = var_12_8

			if var_12_0 == var_12_8.TriggerShipCount then
				_ = var_5

				return #var_5.filter(var_12_1:getShipsByFleet(arg_12_0), function(arg_13_0)
					table = var_2_10001
				...
				if var_12_0 == var_5.TriggerNekoPos then
					...
					var_12_11 = arg_12_0.findCommanderBySkillId(var_12_10, arg_12_1.id)
					pairs = var_12_10

					for iter_12_0, iter_12_1 in var_12_10(arg_12_0:getCommanders()) do
						if var_12_11.id == iter_12_1.id and iter_12_0 == arg_12_2[2] then
							return true
						end
					end
				else
					FleetSkill = var_12_11

					if var_12_0 == var_12_11.TriggerInSubTeam then
						return true
					else
						return false
					end
...
function var_0_1.triggerMirrorSkill(arg_14_0, arg_14_1)
	...
	local var_14_0 = var_1_10002.filter(arg_14_0:findSkills(arg_14_1), function(arg_15_0)
		...
		local var_15_1 = arg_15_0.GetTriggers(var_15_0)

		_ = var_15_0

		local var_15_2 = var_15_0.any(var_15_1, function(arg_16_0)
		...
		local var_15_4 = var_3.getFleetType(var_15_3)

		FleetType = var_15_3

		local var_15_5

		if var_15_2 == (var_15_4 == var_15_3.Submarine) then
			_ = var_4
			var_15_5 = var_4.all(arg_15_0:GetTriggers(), function(arg_17_0)
	...
	return var_3.reduce(var_14_0, nil, function(arg_18_0, arg_18_1)
		local var_18_0 = arg_18_1:GetType()
		local var_18_1 = arg_18_1
		local var_18_2 = arg_18_1.GetArgs(var_18_1)

		FleetSkill = var_18_1

		if var_18_0 == var_18_1.TypeBattleBuff then
...
function var_0_1.MirrorFleetCheck(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_19_0 == var_1_10005.TriggerDDHead then
		...
		local var_19_4 = #var_19_3(var_19_2, var_1_10007.Vanguard, false)
		local var_19_7

		if 0 < var_19_4 then
			ShipType = var_19_4

			local var_19_5 = var_19_4.IsTypeQuZhu
			local var_19_6 = var_19_3[1]

			var_19_7 = var_19_5(var_1_10007.getShipType(var_19_6))
		else
			var_19_7 = false
		end
		...
		if var_19_0 == var_19_3.TriggerVanCount then
			...
			var_19_9 = arg_19_0.getShipsByTeam
			TeamType = var_1_10007

			return #var_19_9(var_19_8, var_1_10007.Vanguard, false) >= arg_19_2[2] and #var_19_9 <= arg_19_2[3]
		else
			FleetSkill = var_19_9

			if var_19_0 == var_19_9.TriggerShipCount then
				_ = var_5

				return #var_5.filter(arg_19_0:getShips(false), function(arg_20_0)
					table = var_2_10001
				...
				if var_19_0 == var_5.TriggerNekoPos then
					...
					var_19_11 = arg_19_0.findCommanderBySkillId(var_19_10, arg_19_1.id)
					pairs = var_19_10

					for iter_19_0, iter_19_1 in var_19_10(arg_19_0:getCommanders()) do
						if var_19_11.id == iter_19_1.id and iter_19_0 == arg_19_2[2] then
							return true
						end
					end
				else
					FleetSkill = var_19_11

					if var_19_0 == var_19_11.TriggerInSubTeam then
						return true
					else
						return false
					end
...
function var_0_1.GuildBossTriggerSkill(arg_21_0, arg_21_1)
	...
	local var_21_0 = var_1_10002.filter(arg_21_0:findSkills(arg_21_1), function(arg_22_0)
		...
		local var_22_1 = arg_22_0.GetTriggers(var_22_0)

		_ = var_22_0

		local var_22_2 = var_22_0.any(var_22_1, function(arg_23_0)
		...
		local var_22_4 = var_3.getFleetType(var_22_3)

		FleetType = var_22_3

		local var_22_5

		if var_22_2 == (var_22_4 == var_22_3.Submarine) then
			_ = var_4
			var_22_5 = var_4.all(arg_22_0:GetTriggers(), function(arg_24_0)
	...
	return var_3.reduce(var_21_0, nil, function(arg_25_0, arg_25_1)
		local var_25_0 = arg_25_1:GetType()
		local var_25_1 = arg_25_1
		local var_25_2 = arg_25_1.GetArgs(var_25_1)

		FleetSkill = var_25_1

		if var_25_0 == var_25_1.TypeBattleBuff then
...
function var_0_1.GuildBossFleetCheck(arg_26_0, arg_26_1, arg_26_2)
	...
	if var_26_0 == var_1_10004.TriggerDDHead then
		...
		local var_26_3 = #var_26_2(var_26_1, var_1_10006.Vanguard)
		local var_26_6

		if 0 < var_26_3 then
			ShipType = var_26_3

			local var_26_4 = var_26_3.IsTypeQuZhu
			local var_26_5 = var_26_2[1]

			var_26_6 = var_26_4(var_1_10006.getShipType(var_26_5))
		else
			var_26_6 = false
		end
		...
		if var_26_0 == var_26_2.TriggerVanCount then
			...
			var_26_8 = arg_26_0.GetTeamTypeShips
			TeamType = var_1_10006

			return #var_26_8(var_26_7, var_1_10006.Vanguard) >= arg_26_2[2] and #var_26_8 <= arg_26_2[3]
		else
			FleetSkill = var_26_8

			if var_26_0 == var_26_8.TriggerShipCount then
				_ = var_4

				return #var_4.filter(arg_26_0:GetShips(), function(arg_27_0)
				...
				if var_26_0 == var_4.TriggerNekoPos then
					...
					var_26_10 = arg_26_0.findCommanderBySkillId(var_26_9, arg_26_1.id)
					pairs = var_26_9

					for iter_26_0, iter_26_1 in var_26_9(arg_26_0:getCommanders()) do
						if var_26_10.id == iter_26_1.id and iter_26_0 == arg_26_2[2] then
							return true
						end
					end
				else
					FleetSkill = var_26_10

					if var_26_0 == var_26_10.TriggerInSubTeam then
						return true
					else
						return false
					end
