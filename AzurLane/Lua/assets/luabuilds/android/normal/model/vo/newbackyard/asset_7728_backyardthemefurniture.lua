...
function var_0_0.GetChildIdList(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10002(arg_9_0.child) do
		...
		var_1_10007(var_9_1, var_1_10009)
	end
...
function var_0_0.isPaper(arg_18_0)
	...
	if var_18_1 ~= var_18_0.TYPE_WALLPAPER then
		Furniture = var_2

		if var_18_1 == var_2.TYPE_FLOORPAPER then
			return true
		end
...
function var_0_0.IsWall(arg_20_0)
	...
	local var_20_1 = arg_20_0.getConfig(var_20_0, "type")

	Furniture = var_20_0

	local var_20_2

	if var_20_1 ~= var_20_0.TYPE_WALL then
		Furniture = var_2

		if var_20_1 ~= var_2.TYPE_WALL_MAT then
			var_20_2 = false
