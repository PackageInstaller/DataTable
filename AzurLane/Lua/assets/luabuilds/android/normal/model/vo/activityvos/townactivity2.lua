...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	for iter_1_0 = 1, #arg_1_0.listLVList do
		...
		local var_1_1 = arg_1_0.OnSettleGold2(var_1_0, iter_1_0)

		table = var_1_0

		var_1_0.insert(arg_1_0.listLVList2, var_1_1)
	end
	...
	for iter_1_1, iter_1_2 in var_2(arg_1_1.date1_key_value_list) do
		if iter_1_2.key == 1 then
			...
			for iter_1_3, iter_1_4 in var_7(iter_1_2.value_list) do
				...
				local var_1_2 = var_1_10012.New(iter_1_4.key, iter_1_4.value)

				if var_1_10012.GetGroup(var_1_2) ~= -1 then
...
function var_0_1.GetLimitGold(arg_13_0)
	...
	for iter_13_0 = 1, #arg_13_0.placeData do
		...
		TownWorkplace2 = var_13_1

		if var_13_2 == var_13_1.TYPE.RATIO then
...
function var_0_1.GetUnlockSlotCnt(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10001(arg_18_0.placeData) do
		...
		local var_18_1 = iter_18_1.GetType(var_18_0)

		TownWorkplace2 = var_18_0

		if var_18_1 == var_18_0.TYPE.ROLE then
...
function var_0_1.UpdateTime(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_21_0(arg_21_0.slotData) do
...
function var_0_1.OnResetIdPlace(arg_27_0, arg_27_1, arg_27_2)
	...
	for iter_27_0, iter_27_1 in var_1_10004(arg_27_0.placeData) do
		if iter_27_1:GetId() == arg_27_2 then
			...
			local var_27_2 = iter_27_1.ResetStartTime(var_27_1, arg_27_1)

			math = var_27_1
			var_27_0 = var_27_0 + var_27_1.floor(var_27_2)
		end
	end
...
function var_0_1.OnGatherPlaceGold(arg_28_0, arg_28_1, arg_28_2)
	...
	arg_28_0.OnResetIdPlace(var_28_2, arg_28_2, arg_28_1)

	local var_28_3 = arg_28_0.placeData

	TownWorkplace2 = var_28_2
	var_28_3[var_28_0] = var_28_2.New(var_28_1:GetId(), arg_28_2)
...
function var_0_1.OnAllGatherPlaceGold(arg_29_0, arg_29_1)
	...
	for iter_29_2 = 1, #var_29_0 do
		...
		arg_29_0.OnResetIdPlace(var_29_3, var_29_1[iter_29_2], var_29_0)

		local var_29_4 = arg_29_0.placeData

		TownWorkplace2 = var_29_3
		var_29_4[iter_29_1] = var_29_3.New(var_29_2:GetId(), var_29_1[iter_29_2])
...
function var_0_1.getVitemNumber(arg_39_0, arg_39_1)
	...
	var_1_10002(var_1_10003.item_virtual_data_statistics[arg_39_1].link_id == arg_39_0.id)
...
function var_0_1.subVitemNumber(arg_40_0, arg_40_1, arg_40_2)
	...
	var_1_10003(var_1_10004.item_virtual_data_statistics[arg_40_1].link_id == arg_40_0.id)
