...
function var_0_1.finishCondition(arg_10_0)
	...
	if arg_10_0.getConfig(var_10_0, "condition") ~= 0 then
		getProxy = var_10_0
		TaskProxy = var_3

		local var_10_1 = var_10_0(var_3)
		local var_10_2 = var_2.getTaskVO(var_10_1, var_1)

		var_10_3 = var_2.isFinish(var_10_2)
...
function var_0_1.hasResToStart(arg_11_0)
	...
	local var_11_4 = var_11_2(var_1_10004)
	...
	for iter_11_0, iter_11_1 in var_1_10004(var_11_1) do
		...
		if var_11_5 == var_1_10010 then
			var_1_10010 = var_11_3

			if var_11_3.getResById(var_1_10010, iter_11_1[2]) < iter_11_1[3] then
		...
		do
			...
			if var_11_7 == var_1_10010 then
				var_1_10010 = var_11_4

				if var_11_4.getItemCountById(var_1_10010, iter_11_1[2]) < iter_11_1[3] then
