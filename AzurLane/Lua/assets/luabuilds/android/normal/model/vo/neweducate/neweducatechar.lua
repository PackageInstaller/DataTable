...
function var_0_1.InitSiteData(arg_8_0, arg_8_1)
	...
	for iter_8_2, iter_8_3 in var_3(var_4.SITE_NORMAL_TYPE) do
...
function var_0_1.GetSelectInfo(arg_10_0)
	...
	if var_2.IsEndless(var_10_2) then
		...
		if not var_10_5(var_10_3, var_4.GetWave(var_10_4)) then
			i18n = var_10_5
...
function var_0_1.BuildSiteIdMap(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1(var_1_10002.SITE_TYPE) do
		pg = var_1_10006
		...
		var_14_2[var_1_10010.SITE_TYPE.SHIP] = function()
		...
		NewEducateConst = var_1_10010
		var_14_2[var_1_10010.SITE_TYPE.SHOP] = function()
		...
		NewEducateConst = var_1_10010
		var_14_2[var_1_10010.SITE_TYPE.WORK] = function()
		...
		NewEducateConst = var_1_10010
		var_14_2[var_1_10010.SITE_TYPE.TRAVEL] = function()
		...
		NewEducateConst = var_1_10010
		var_14_2[var_1_10010.SITE_TYPE.EVENT] = function()
			underscore = var_2_10000
...
function var_0_1.SetResources(arg_37_0, arg_37_1)
	...
	for iter_37_0, iter_37_1 in var_2(arg_37_1) do
		...
		pg = var_1_10010
		var_37_0[var_37_1] = var_37_2(var_1_10010.child2_resource[iter_37_1.key].min_value, arg_37_0.resources[iter_37_1.key])
		...
		pg = var_1_10010
		var_37_3[var_37_4] = var_37_5(var_1_10010.child2_resource[iter_37_1.key].max_value, arg_37_0.resources[iter_37_1.key])
	end
...
function var_0_1.GetResIdByType(arg_41_0, arg_41_1)
	...
	return var_41_0(var_1_10003.keys(arg_41_0.resources), function(arg_42_0)
		pg = var_2_10001
...
function var_0_1.UpdateRes(arg_43_0, arg_43_1, arg_43_2)
	...
	pg = var_1_10005
	var_43_0[arg_43_1] = var_43_1(var_1_10005.child2_resource[arg_43_1].min_value, arg_43_0.resources[arg_43_1])
	...
	pg = var_5
	var_43_2[arg_43_1] = var_43_3(var_5.child2_resource[arg_43_1].max_value, arg_43_0.resources[arg_43_1])
...
function var_0_1.GetFavorInfo(arg_47_0)
	...
	local var_47_1 = arg_47_0.GetResByType(var_47_0, var_0_1.RES_TYPE.FAVOR)

	math = var_47_0

	local var_47_2 = var_47_0.min(arg_47_0.gotFavorLv + 1, arg_47_0:getConfig("favor_level"))
	local var_47_3 = 0

	if arg_47_0.gotFavorLv > 0 then
		for iter_47_0 = 1, arg_47_0.gotFavorLv do
			var_47_3 = var_47_3 + arg_47_0:getConfig("favor_exp")[iter_47_0]
		end
	end

	return {
		lv = var_47_2,
		value = var_47_1 - var_47_3
	}
end
...
function var_0_1.SetAttrs(arg_49_0, arg_49_1)
	...
	for iter_49_0, iter_49_1 in var_2(arg_49_1) do
		...
		pg = var_1_10010
		var_49_0[var_49_1] = var_49_2(var_1_10010.child2_attr[iter_49_1.key].min_value, arg_49_0.attrs[iter_49_1.key])
		...
		pg = var_1_10010
		var_49_3[var_49_4] = var_49_5(var_1_10010.child2_attr[iter_49_1.key].max_value, arg_49_0.attrs[iter_49_1.key])
	end
...
function var_0_1.GetAttrIds(arg_51_0)
	...
	local var_51_1 = var_51_0(var_1_10002.keys(arg_51_0.attrs), function(arg_52_0)
		pg = var_2_10001
...
function var_0_1.GetPersonalityId(arg_55_0)
	...
	return var_55_0(var_1_10002.keys(arg_55_0.attrs), function(arg_56_0)
		pg = var_2_10001
...
function var_0_1.GetPersonalityMiddle(arg_58_0)
	...
	local var_58_2 = var_58_0.child2_attr[var_58_1]

	math = var_1_10003

	return var_1_10003.floor((var_58_2.min_value + var_58_2.max_value) / 2)
end
...
function var_0_1.GetPersonalityTag(arg_59_0, arg_59_1)
	...
	if not arg_59_1 then
		...
		var_59_0 = arg_59_0.GetPersonality(var_1_10003)
	end
	...
	return (var_1_10003(arg_59_0:getConfig("personality_type"), {
		function()
			...
			for iter_60_0, iter_60_1 in var_2_10000(var_1.getConfig(var_60_0, "personality_param")) do
...
function var_0_1.GetPersonalityTagOptionBg(arg_63_0, arg_63_1)
	...
	local var_63_1 = arg_63_0.getConfig(var_63_0, "personality_tag_icon")

	underscore = var_63_0

	return var_63_0.detect(var_63_1, function(arg_64_0)
...
function var_0_1.UpdateAttr(arg_65_0, arg_65_1, arg_65_2)
	...
	pg = var_1_10005
	var_65_0[arg_65_1] = var_65_1(var_1_10005.child2_attr[arg_65_1].min_value, arg_65_0.attrs[arg_65_1])
	...
	pg = var_5
	var_65_2[arg_65_1] = var_65_3(var_5.child2_attr[arg_65_1].max_value, arg_65_0.attrs[arg_65_1])
...
function var_0_1.GetAssessRankIdx(arg_66_0)
	...
	if var_1.getConfig(var_66_0, "target_id") ~= 0 then
		...
		local var_66_5 = arg_66_0.GetAttrSum(var_66_4)

		pg = var_66_4

		for iter_66_0 = #var_66_4.child2_target[var_1].attr_sum_level, 1, -1 do
			if var_66_5 >= var_4[iter_66_0] * var_66_3 then
				return iter_66_0
			end
		end
...
function var_0_1.GetAssessPreStory(arg_67_0)
	...
	return var_67_0.child2_target[var_1].pre_perform
end
...
function var_0_1.GetBgm(arg_70_0)
	...
	local var_70_1 = arg_70_0.GetPersonalityTag(var_70_0)

	underscore = var_70_0

	return var_70_0.detect(arg_70_0:getConfig("bgm"), function(arg_71_0)
		return arg_71_0[1] == var_70_1
	end)[2]
end

function var_0_1.GetPaintingName(arg_72_0)
	local var_72_0 = arg_72_0
	local var_72_1 = arg_72_0.GetPersonalityTag(var_72_0)

	underscore = var_72_0

	local var_72_2 = var_72_0.detect
	local var_72_3 = arg_72_0.roundData

	return var_72_2(var_3.getConfig(var_72_3, "main_painting"), function(arg_73_0)
		return arg_73_0[1] == var_72_1
	end)[2]
end
...
function var_0_1.GetMainDialogueInfo(arg_75_0)
	...
	local var_75_2 = var_75_0.detect
	local var_75_3 = arg_75_0.roundData
	local var_75_4 = var_75_2(var_3.getConfig(var_75_3, "main_word"), function(arg_76_0)
		return arg_76_0[1] == var_75_1
	end)

	underscore = var_3

	local var_75_5 = var_3.detect
	local var_75_6 = arg_75_0.roundData
	local var_75_7 = var_75_5(var_4.getConfig(var_75_6, "main_word_expression"), function(arg_77_0)
...
function var_0_1.GetPlanList(arg_79_0)
	...
	for iter_79_0, iter_79_1 in var_79_1(var_79_2) do
		pg = var_1_10008
		...
		if #var_1_10008.child2_plan.get_id_list_by_group_id[iter_79_1] == 1 then
			...
			var_1_10010 = var_79_0
			NewEducatePlan = var_1_10011

			var_79_3(var_1_10010, var_1_10011.New(var_1_10008[1]))
		else
			local var_79_4
			...
			if arg_79_0.group2Plan[iter_79_1] then
				...
				var_79_4(var_1_10010, var_1_10011.New(arg_79_0.group2Plan[iter_79_1]))
			else
				table = var_79_4
				...
				var_79_5(var_1_10010, var_1_10011.New(var_1_10008[1]))
			end
		end
	end
	...
	for iter_79_2, iter_79_3 in var_3(var_4.GetExtraPlan(var_79_6, arg_79_0)) do
		table = var_1_10008
		var_1_10008 = var_1_10008.insert

		local var_79_7 = var_79_0

		NewEducatePlan = var_1_10010

		var_1_10008(var_79_7, var_1_10010.New(iter_79_3, true))
	end
...
function var_0_1.OnNextRound(arg_81_0)
	...
	local var_81_5 = var_81_4(var_81_3, var_1_10004.RES_TYPE.ACTION)
	...
	if var_81_7[var_81_9(var_81_8, var_81_6.RES_TYPE.REFRESH_SHOP)] then
		...
		local var_81_13 = var_81_12(var_81_11, var_4.RES_TYPE.REFRESH_SHOP)
...
function var_0_1.GetTalentList(arg_84_0)
	...
	NewEducateBuff = var_1_10003

	return var_84_1(var_84_0, var_1_10003.TYPE.TALENT)
end
...
function var_0_1.GetStatusList(arg_86_0)
	...
	return var_86_1(var_86_0, var_1_10003.TYPE.STATUS)
end
...
function var_0_1.GetTarotId(arg_88_0)
	...
	var_88_2 = var_88_1(var_88_0, var_1_10003.TYPE.TAROT)[1] and var_1.id
...
function var_0_1.IsMatchCondition(arg_101_0, arg_101_1)
	...
	var_101_2[var_1_10006.CONDITION_TYPE.DROP] = function()
		local var_102_0 = {
		...
		return var_1(var_2.GetOwnCnt(var_102_1, var_102_0), var_101_0.param[3], var_101_0.param[4])
	end
	NewEducateConst = var_6
	var_101_2[var_6.CONDITION_TYPE.ATTR_SUM] = function()
		compareNumber = var_2_10000

		local var_103_0 = arg_101_0

		return var_2_10000(var_1.GetAttrSum(var_103_0), var_101_0.param[1], var_101_0.param[2])
	end
	NewEducateConst = var_6
	var_101_2[var_6.CONDITION_TYPE.EVENT_SITE_CNT] = function()
		compareNumber = var_2_10000

		local var_104_0 = arg_101_0

		return var_2_10000(var_1.GetEventCnt(var_104_0, var_101_0.param[1]), var_101_0.param[2], var_101_0.param[3])
	end
	NewEducateConst = var_6
	var_101_2[var_6.CONDITION_TYPE.ROUND] = function()
		compareNumber = var_2_10000

		return var_2_10000(arg_101_0.roundData.round, var_101_0.param[1], var_101_0.param[2])
	end
	NewEducateConst = var_6
	var_101_2[var_6.CONDITION_TYPE.NORMAL_SITE_CNT] = function()
		underscore = var_2_10000
		...
		return var_1(var_106_0, var_101_0.param[2], var_101_0.param[3])
	end
