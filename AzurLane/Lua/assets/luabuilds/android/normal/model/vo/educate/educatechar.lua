...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	pg = var_3
	arg_2_0.addExtraAttrTime = var_2_6(var_3.gameset.child_attr_2_add.description)
...
function var_0_1.GetAttrSortIds(arg_21_0)
	...
	local var_21_1 = var_2.mergeArray(var_21_0, arg_21_0:getConfig("attr_3_list"))
...
function var_0_1.GetPersonalityId(arg_27_0)
	local var_27_0 = arg_27_0:getConfig("attr_2_list")[1]

	ipairs = var_3

	for iter_27_0, iter_27_1 in var_3(var_1) do
		if arg_27_0.attrs[iter_27_1] > arg_27_0.attrs[var_27_0] then
			var_27_0 = iter_27_1
		end
	end
...
function var_0_1.UpdateRes(arg_31_0, arg_31_1, arg_31_2)
	if arg_31_1 ~= var_0_1.RES_FAVOR_ID then
		...
		pg = var_1_10005
		arg_31_0[var_31_0] = var_31_1(var_1_10005.child_resource[arg_31_1].min_value, arg_31_0[var_0_1.RES_ID_2_NAME[arg_31_1]])
		...
		pg = var_5
		arg_31_0[var_31_2] = var_31_3(var_5.child_resource[arg_31_1].max_value, arg_31_0[var_0_1.RES_ID_2_NAME[arg_31_1]])
	else
...
function var_0_1.GetPerformByReplace(arg_36_0, arg_36_1)
	if arg_36_0.favorReplaceCfg[arg_36_1] then
		...
		local var_36_1 = arg_36_0.GetPersonalityId(var_36_0)

		ipairs = var_36_0

		for iter_36_0, iter_36_1 in var_36_0(arg_36_0.favorReplaceCfg[arg_36_1]) do
			if iter_36_1[1] == 1 and var_36_1 == iter_36_1[2] then
				return iter_36_1[3]
			end
		end
	end
...
function var_0_1.CheckEndCondition(arg_41_0, arg_41_1)
	...
	for iter_41_0, iter_41_1 in var_1_10004(arg_41_1) do
		local var_41_2 = iter_41_1[1]

		EducateConst = var_1_10010

		if var_41_2 == var_1_10010.DROP_TYPE_ATTR then
			...
			if var_41_2 == var_1_10010.DROP_TYPE_RES and arg_41_0[var_0_1.RES_ID_2_NAME[iter_41_1[2]]] < iter_41_1[3] then
				return false
			end
		end
	end
...
function var_0_1.getCurMainIndex(arg_42_0, arg_42_1)
	...
	local var_42_2 = arg_42_0.GetPersonalityId(var_42_1)

	ipairs = var_42_1

	for iter_42_0, iter_42_1 in var_42_1(arg_42_0:getConfig("char_prefab")) do
		EducateHelper = var_1_10009

		local var_42_3

		var_1_10009, var_42_3 = var_1_10009.CfgTime2Time(iter_42_1[1])
		EducateHelper = var_1_10011

		if var_1_10011.InTime(var_42_0, var_1_10009, var_42_3) then
			if iter_42_1[2] == 0 then
				return iter_42_0
			elseif iter_42_1[2] == var_42_2 then
				return iter_42_0
			end
		end
	end
...
function var_0_1.getBgmByStage(arg_45_0, arg_45_1)
	...
	if var_45_0(var_45_1) == "string" then
		return var_45_1
	else
		type = var_3
		...
		if var_3(var_45_1) == "table" then
			...
			local var_45_3 = arg_45_0.GetPersonalityId(var_45_2)

			ipairs = var_45_2

			for iter_45_0, iter_45_1 in var_45_2(var_45_1) do
				if iter_45_1[1] == var_45_3 then
					return iter_45_1[2]
				end
			end
		end
