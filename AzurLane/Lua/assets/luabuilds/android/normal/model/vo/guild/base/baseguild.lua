...
function var_0_1.getMaxOilAddition(arg_3_0)
	...
	return var_3_1(var_3_0, var_1_10003.TYPE_OIL_MAX)
end
...
function var_0_1.getMaxGoldAddition(arg_4_0)
	...
	return var_4_1(var_4_0, var_1_10003.TYPE_GOLD_MAX)
end
...
function var_0_1.getCatBoxGoldAddition(arg_5_0)
	...
	return var_5_1(var_5_0, var_1_10003.TYPE_CATBOX_GOLD_COST)
end
...
function var_0_1.getEquipmentBagAddition(arg_6_0)
	...
	return var_6_1(var_6_0, var_1_10003.TYPE_EQUIPMENT_BAG)
end
...
function var_0_1.getShipBagAddition(arg_7_0)
	...
	return var_7_1(var_7_0, var_1_10003.TYPE_SHIP_BAG)
end

function var_0_1.getShipAddition(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = 0
	local var_8_1 = arg_8_0
	local var_8_2 = arg_8_0.GetTechnologys(var_8_1)
...
function var_0_1.GetGuildMemberCntAddition(arg_9_0)
	...
	return var_9_1(var_9_0, var_1_10003.TYPE_GUILD_MEMBER_CNT)
end
