...
i18n = var_2
var_0_2[1] = var_2("level_chapter_state_high_risk")
i18n = var_2
...
function var_0_1.Ctor(arg_2_0, arg_2_1)
	...
	defaultValue = var_3
	var_2_3[1] = var_3(arg_2_1.kill_boss_count, 0)
	defaultValue = var_3
...
function var_0_1.getConfigMiscArg(arg_3_0, arg_3_1)
	...
	if not var_1_10003(arg_3_0:getConfig("misc_arg")) then
		var_3_0 = {}
	end
...
function var_0_1.PackEliteFleetInfo(arg_7_0)
	...
	var_7_0.main_team = var_7_1(arg_7_0[var_1_10003.Normal], function(arg_8_0)
	...
	FleetType = var_3
	var_7_0.submarine_team = var_7_2(arg_7_0[var_3.Submarine], function(arg_9_0)
	...
	FleetType = var_3
	var_7_0.support_team = var_7_3(arg_7_0[var_3.Support], function(arg_10_0)
...
function var_0_1.PackEliteTeamInfo(arg_11_0)
	...
	var_11_0.ship_list = var_11_2(arg_11_0[var_1_10003.FormShips])
	TeamType = var_2
...
function var_0_1.getRemainPassCount(arg_14_0)
	...
	local var_14_1 = arg_14_0.getMaxCount(var_14_0)

	math = var_14_0

	return var_14_0.max(var_14_1 - arg_14_0.passCount, 0)
end

function var_0_1.getRiskLevel(arg_15_0)
	local var_15_0 = arg_15_0:getRemainPassCount()
	local var_15_1 = arg_15_0
	local var_15_2 = arg_15_0.getConfig(var_15_1, "risk_levels")

	ipairs = var_15_1

	for iter_15_0, iter_15_1 in var_15_1(var_15_2) do
...
function var_0_1.getMitigationRate(arg_16_0)
	...
	if var_16_0 then
		...
		var_1_10003 = arg_16_0
		var_16_2 = arg_16_0.getConfig(var_1_10003, "mitigation_rate")
	end

	math = var_1_10003

	return var_1_10003.min(arg_16_0.passCount, var_16_1) * var_16_2
end
...
function var_0_1.getChapterState(arg_18_0)
	...
	local var_18_1 = arg_18_0.getRiskLevel(var_18_0)

	assert = var_18_0

	var_18_0(var_0_1.CHAPTER_STATE[var_18_1], "state desc is nil")

	return var_0_1.CHAPTER_STATE[var_18_1]
end
...
function var_0_1.isTypeDefence(arg_20_0)
	...
	local var_20_1 = arg_20_0.getPlayType(var_20_0)

	ChapterConst = var_20_0

	return var_20_1 == var_20_0.TypeDefence
end
...
function var_0_1.IsEXChapter(arg_22_0)
	...
	local var_22_1 = arg_22_0.getPlayType(var_22_0)

	ChapterConst = var_22_0

	return var_22_1 == var_22_0.TypeExtra
end
...
function var_0_1.getConfig(arg_23_0, arg_23_1)
	if arg_23_0:isLoop() then
		...
		if (arg_23_1 == "air_dominance" or arg_23_1 == "best_air_dominance") and var_23_0.air_dominance_loop_rate ~= nil then
			...
			return var_5.floor(var_23_1[arg_23_1] * var_23_2)
		end
	end
...
function var_0_1.IsCleanPrevChapter(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10001(arg_29_0:getConfig("pre_chapter")) do
		...
		if var_1_10006.all(iter_29_1, function(arg_30_0)
			if arg_30_0 == 0 then
				return true
			end
			...
			local var_30_0 = var_2_10001(var_2_10002)
...
function var_0_1.IsCleanPrevStory(arg_31_0)
	...
	if arg_31_0.getConfig(var_31_0, "pre_story") == 0 then
		return true
	end
	...
	local var_31_1 = var_31_0(var_3)
	local var_31_2 = var_2.GetChapterItemById(var_31_1, var_1)

	return var_2.isClear(var_31_2)
end
...
function var_0_1.ifNeedHide(arg_34_0)
	...
	if var_34_0(var_1_10002.chapter_setting.all, arg_34_0.id) then
		pg = var_1
...
function var_0_1.setEliteFleetByIndex(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_1 = arg_43_0.getEliteTeamByIndex(var_43_0, arg_43_1)

	ipairs = var_43_0

	for iter_43_0, iter_43_1 in var_43_0(arg_43_2) do
		unpack = var_1_10009

		local var_43_2

		var_1_10009, var_43_2 = var_1_10009(iter_43_1)
		TeamType = var_1_10011

		if var_1_10009 == var_1_10011.FormCommander then
			var_1_10011 = var_43_1[var_1_10009]
			var_1_10011[var_43_2.pos] = var_43_2.id
		else
			var_43_1[var_1_10009] = var_43_2
		end
	end
...
function var_0_1.clearEliterFleetByIndex(arg_44_0, arg_44_1)
	...
	var_44_4[1] = var_1_10007.FormShips
	var_44_4[2] = {}
	var_44_3[1] = var_44_4
...
function var_0_1.wrapEliteFleet(arg_45_0, arg_45_1)
	...
	for iter_45_0, iter_45_1 in var_1_10005(var_45_0[var_1_10006.FormCommander]) do
		if iter_45_1 ~= 0 then
			table = var_1_10010
	...
	local var_45_5 = var_7.to_array

	TeamType = iter_45_0
	var_45_4.ship_list = var_45_5(var_45_0[iter_45_0.FormShips])
...
function var_0_1.getEliteFleetCommanders(arg_46_0)
	...
	arg_46_0.EliteCommanderFilter(var_46_0)

	local var_46_1 = {}

	ipairs = var_46_0

	for iter_46_0, iter_46_1 in var_46_0({
		{
		...
		var_1_10007, var_46_2 = var_1_10007(iter_46_1)

		for iter_46_2 = 1, var_1_10007 do
			local var_46_3 = var_46_2 + iter_46_2
			local var_46_4 = arg_46_0
			local var_46_5 = arg_46_0.getEliteTeamByIndex(var_46_4, var_46_3)

			underscore = var_46_4

			local var_46_6 = var_46_4.to_array

			TeamType = var_16
			var_46_1[var_46_3] = var_46_6(var_46_5[var_16.FormCommander])
		end
	end
...
function var_0_1.updateCommander(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	var_47_4[1] = var_1_10009.FormCommander
	var_47_4[2] = {
		pos = arg_47_2,
		id = arg_47_3
	}
...
function var_0_1.getEliteFleetList(arg_48_0)
	...
	arg_48_0.EliteShipTypeFilter(var_48_0)

	local var_48_1 = {}

	ipairs = var_48_0

	for iter_48_0, iter_48_1 in var_48_0({
		{
		...
		var_1_10007, var_48_2 = var_1_10007(iter_48_1)

		for iter_48_2 = 1, var_1_10007 do
			local var_48_3 = var_48_2 + iter_48_2
			local var_48_4 = arg_48_0
			local var_48_5 = arg_48_0.getEliteTeamByIndex(var_48_4, var_48_3)

			underscore = var_48_4

			local var_48_6 = var_48_4.to_array

			TeamType = var_16
			var_48_1[var_48_3] = var_48_6(var_48_5[var_16.FormShips])
		end
	end
...
function var_0_1.IsEliteFleetLegal(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10002(var_50_1) do
		...
		for iter_50_2 = 1, var_1_10007 do
			...
			local var_50_8, var_50_9 = arg_50_0:singleEliteFleetVertify(var_50_7)

			if var_50_8 then
				defaultValue = var_17
				var_50_0[var_50_6] = var_17(var_50_0[var_50_6], 0) + 1
			elseif var_50_9 == "empty" then
				-- block empty
			else
				local var_50_10 = false

				switch = var_1_10018
				var_1_10018 = var_1_10018(var_50_9, {
					inEvent = function()
						i18n = var_2_10000
					...
					teamCount = function()
						...
						return var_2_10000(var_52_0, var_2_10002.DEFAULT_ELITE_NAME[var_50_7])
					end,
	...
	if var_50_0 == 0 then
		...
		local var_50_12 = var_3("elite_disable_no_fleet")

		return
	end

	local var_50_13 = arg_50_0:IsPropertyLimitationSatisfy()
	local var_50_14 = 1

	ipairs = var_4

	for iter_50_3, iter_50_4 in var_4(var_50_13) do
		var_50_14 = var_50_14 * iter_50_4
	end

	if var_50_14 ~= 1 then
		local var_50_15 = false

		i18n = var_5

		local var_50_16 = var_5("elite_disable_property_unsatisfied")
...
function var_0_1.IsPropertyLimitationSatisfy(arg_54_0)
	...
	local var_54_0 = var_1_10001(var_1_10002)
	local var_54_1 = var_1.getRawData(var_54_0)
	local var_54_2 = arg_54_0:getConfig("property_limitation")
	local var_54_3 = {}

	ipairs = var_4

	for iter_54_0, iter_54_1 in var_4(var_54_2) do
		var_54_3[iter_54_1[1]] = 0
	end

	local var_54_4 = arg_54_0:getEliteFleetList()
	local var_54_5 = 0
	...
	for iter_54_2 = 1, 2 do
		if not arg_54_0:singleEliteFleetVertify(iter_54_2) then
			...
			for iter_54_3, iter_54_4 in var_1_10012(var_54_2) do
				unpack = iter_54_10

				local var_54_8, var_54_9

				iter_54_10, var_54_8, var_1_10019, var_54_9 = iter_54_10(iter_54_4)
				string = var_1_10021

				if var_1_10021.sub(iter_54_10, 1, 5) == "fleet" then
					var_54_6[iter_54_10] = 0
					var_54_7[iter_54_10] = var_54_9
				end
			end

			var_1_10012 = var_54_4[iter_54_2]
			ipairs = var_13
			...
			for iter_54_5, iter_54_10 in var_13(var_1_10012) do
				...
				var_1_10021 = var_54_10
				var_1_10019 = var_1_10019(var_54_10.getProperties(var_1_10021))
				pairs = var_20

				for iter_54_7, iter_54_8 in var_20(var_54_3) do
					string = var_1_10025

					if var_1_10025.sub(iter_54_7, 1, 5) == "fleet" then
						if iter_54_7 == "fleet_totle_level" then
							var_54_6[iter_54_7] = var_54_6[iter_54_7] + var_54_10.level
						end
					elseif iter_54_7 == "level" then
						var_54_3[iter_54_7] = iter_54_8 + var_54_10.level
					else
						var_54_3[iter_54_7] = iter_54_8 + var_1_10019[iter_54_7]
					end
				end
			end
			...
			for iter_54_9, iter_54_10 in var_13(var_54_6) do
				if iter_54_9 == "fleet_totle_level" and iter_54_10 > var_54_7[iter_54_9] then
					var_54_3[iter_54_9] = var_54_3[iter_54_9] + 1
				end
			end
		end
	end
	...
	for iter_54_11, iter_54_12 in var_7(var_54_2) do
		unpack = var_1_10012
		...
		if var_1_10012 == "level" and 0 < var_54_5 then
			math = iter_54_3
			var_54_3[var_1_10012] = iter_54_3.ceil(var_54_3[var_1_10012] / var_54_5)
		end

		AttributeType = iter_54_3
		iter_54_3 = iter_54_3.EliteConditionCompare(var_54_12, var_54_3[var_1_10012], var_54_13) and 1 or 0
		var_54_11[iter_54_11] = iter_54_3
	end

	return var_54_11, var_54_3
end
...
function var_0_1.EliteShipTypeFilter(arg_58_0)
	...
	if var_58_1 == var_58_0.SelectFleet then
		local var_58_2 = arg_58_0.eliteFleetList

		FleetType = var_2
		var_58_2[var_2.Normal] = {}

		local var_58_3 = arg_58_0.eliteFleetList

		FleetType = var_2
		var_58_3[var_2.Submarine] = {}
	else
		local var_58_4 = arg_58_0:GetNomralFleetMaxCount() + 1
		local var_58_5 = arg_58_0.eliteFleetList

		FleetType = var_3

		for iter_58_0 = var_58_4, #var_58_5[var_3.Normal] do
		...
		local var_58_7 = arg_58_0:GetSubmarineFleetMaxCount() + 1
		local var_58_8 = arg_58_0.eliteFleetList

		FleetType = var_3

		for iter_58_1 = var_58_7, #var_58_8[var_3.Submarine] do
			local var_58_9 = arg_58_0.eliteFleetList

			FleetType = var_1_10006
			var_58_9[var_1_10006.Submarine][iter_58_1] = nil
		end
	end

	local var_58_10 = arg_58_0:GetSupportFleetMaxCount() + 1
	local var_58_11 = arg_58_0.eliteFleetList

	FleetType = var_3

	for iter_58_2 = var_58_10, #var_58_11[var_3.Support] do
		local var_58_12 = arg_58_0.eliteFleetList

		FleetType = var_1_10006
		var_58_12[var_1_10006.Support][iter_58_2] = nil
	end

	getProxy = var_58_10
	BayProxy = var_2

	local var_58_13 = var_58_10(var_2)
	local var_58_14 = var_1.getRawData(var_58_13)

	local function var_58_15(arg_59_0)
		if not arg_59_0 then
			return
		end

		for iter_59_0 = #arg_59_0, 1, -1 do
			if var_58_14[arg_59_0[iter_59_0]] == nil then
				table = var_5
	...
	for iter_58_3, iter_58_4 in var_3(arg_58_0.eliteFleetList) do
		ipairs = var_1_10008

		for iter_58_5, iter_58_6 in var_1_10008(iter_58_4) do
			local var_58_16 = var_58_15

			TeamType = var_1_10014

			var_58_16(iter_58_6[var_1_10014.FormShips])
		end
	end

	local function var_58_17(arg_60_0, arg_60_1)
		Clone = var_2_10002
		...
		while var_60_0 <= #arg_60_0 do
			...
			local var_60_2
			local var_60_3 = var_58_14[var_60_1]
			local var_60_4 = var_5.getShipType(var_60_3)

			ipairs = var_60_3

			for iter_60_0, iter_60_1 in var_60_3(arg_60_1) do
			...
			if var_60_2 then
				...
				var_6.remove(arg_60_1, var_60_2)

				var_60_0 = var_60_0 + 1
			else
				table = var_6

				var_6.remove(arg_60_0, var_60_0)
			end
		end
	...
	local var_58_19 = arg_58_0.getConfig(var_58_18, "limitation")

	pairs = var_58_18

	for iter_58_7, iter_58_8 in var_58_18(arg_58_0.eliteFleetList) do
		ipairs = var_1_10010

		for iter_58_9, iter_58_10 in var_1_10010(iter_58_8) do
			switch = var_1_10015

			local var_58_20 = iter_58_7
			local var_58_21 = {}

			FleetType = var_1_10018
			var_58_21[var_1_10018.Normal] = function()
				local var_61_0 = var_58_19[iter_58_9]
				...
				var_61_2[1] = var_2_10003.Main
				TeamType = var_3
				var_61_2[2] = var_3.Vanguard
				...
				local var_61_3 = var_61_1(var_61_2, function(arg_62_0)
					...
					TeamType = var_3_10003

					return var_62_0(var_62_1[var_3_10003.FormShips], function(arg_63_0)
						local var_63_0 = var_58_14[arg_63_0]

						return var_1.getTeamType(var_63_0) == arg_62_0
					end)
				end)

				var_58_17(var_61_3[1], var_61_0[1])
				var_58_17(var_61_3[2], var_61_0[2])

				local var_61_4 = iter_58_10

				TeamType = var_3

				local var_61_5 = var_3.FormShips
			...
			FleetType = var_1_10018
			var_58_21[var_1_10018.Submarine] = function()
				local var_64_0 = var_58_17
				local var_64_1 = iter_58_10

				TeamType = var_2_10002

				var_64_0(var_64_1[var_2_10002.FormShips], {
					0,
					0,
					0
				})
			...
			FleetType = var_1_10018
			var_58_21[var_1_10018.Support] = function()
				...
				local var_65_2 = var_58_17
				local var_65_3 = iter_58_10

				TeamType = var_2_10003

				var_65_2(var_65_3[var_2_10003.FormShips], var_65_1)

				return
			end

			var_1_10015(var_58_20, var_58_21)
		end
	end
...
function var_0_1.EliteCommanderFilter(arg_66_0)
	...
	for iter_66_0, iter_66_1 in var_1_10002(arg_66_0.eliteFleetList) do
		...
		for iter_66_2, iter_66_3 in var_1_10007(iter_66_1) do
			...
			for iter_66_4, iter_66_5 in var_1_10012(iter_66_3[var_1_10013.FormCommander]) do
...
function var_0_1.singleEliteFleetVertify(arg_67_0, arg_67_1)
	...
	local var_67_0 = var_1_10002(var_1_10003)
	local var_67_1 = var_2.getRawData(var_67_0)
	local var_67_2, var_67_3 = arg_67_0:getEliteTeamByIndex(arg_67_1)

	TeamType = var_5

	if not var_67_2[var_5.FormShips] or #var_5 == 0 then
		return false, "empty"
	end
	...
	TeamType = var_1_10007
	var_67_4[var_1_10007.Main] = 0
	TeamType = var_7
	var_67_4[var_7.Vanguard] = 0
	TeamType = var_7
	var_67_4[var_7.Submarine] = 0
	...
	for iter_67_0, iter_67_1 in var_8(var_5) do
		if var_67_1[iter_67_1] then
			if var_13:getFlag("inEvent") then
				return false, "inEvent"
			end

			var_67_4[var_14] = var_67_4[var_13:getTeamType()] + 1

			local var_67_6 = #var_67_5 + 1

			var_1_10017 = var_13
			var_67_5[var_67_6] = var_13.getShipType(var_1_10017)
		end
	end

	FleetType = var_8

	if var_67_3 == var_8.Normal then
		TeamType = var_67_7

		local var_67_7 = var_67_4[var_67_7.Main]

		TeamType = var_9

		if not (var_9.MainMax < var_67_7) then
			TeamType = var_67_7
			var_67_7 = var_67_4[var_67_7.Vanguard]
			TeamType = var_9

			if not (var_9.VanguardMax < var_67_7) then
				TeamType = var_67_7
				var_67_7 = var_67_4[var_67_7.Main]
				TeamType = var_9

				if var_67_7 * var_67_4[var_9.Vanguard] == 0 then
				...
				if not var_9(arg_67_0:getConfig("limitation"), {
					arg_67_1
				}) then
					var_67_8 = {}
				end
				...
				ChapterProxy = var_67_12

				var_67_12.SortRecommendLimitation(var_67_13)

				local var_67_14 = 1

				while var_67_14 <= #var_67_5 do
					local var_67_15 = var_67_5[var_67_14]
					local var_67_16
					...
					if var_67_16 then
						...
						var_12.remove(var_67_5, var_67_14)
					end
				end

				FleetType = var_67_15

				if var_67_3 == var_67_15.Normal then
					local var_67_17 = {}

					ipairs = var_67_16

					for iter_67_4, iter_67_5 in var_67_16(var_67_5) do
						ShipType = iter_67_3
					...
					TeamType = var_13
					var_67_18[1] = var_13.Vanguard
					TeamType = var_13
					var_67_18[2] = var_13.Main
					...
					for iter_67_6, iter_67_7 in var_11(var_67_18) do
						...
						if not var_67_17[iter_67_7] then
							...
							var_67_19 = var_67_19.all(var_67_13, function(arg_69_0)
								...
								return var_69_0(var_2_10002.GetShipTypesFromLimit(arg_69_0), function(arg_70_0)
				...
				elseif #var_67_13 == 0 or #var_67_5 > 0 then
					return true
				else
					return false, "typeLimitation"
				end
...
function var_0_1.getSupportFleet(arg_71_0)
	...
	local var_71_1 = arg_71_0.getEliteTeamByIndex(var_71_0, 4)

	underscore = var_71_0

	local var_71_2 = var_71_0.to_array

	TeamType = var_3

	return var_71_2(var_71_1[var_3.FormShips])
end
...
function var_0_1.activeAlways(arg_72_0)
	...
	local var_72_0 = var_1_10001(var_1_10002)
	local var_72_1 = var_1.getMapById
	local var_72_2 = arg_72_0
	local var_72_3 = var_72_1(var_72_0, arg_72_0.getConfig(var_72_2, "map"))

	if var_1.isActivity(var_72_3) then
		local var_72_4 = arg_72_0
		local var_72_5 = arg_72_0.GetBindActID(var_72_4)

		pg = var_72_4

		local var_72_6 = var_72_4.activity_template[var_72_5]

		type = var_72_2

		if var_72_2(var_72_6.config_client) == "table" then
			local var_72_7

			if not var_72_6.config_client.prevs then
				var_72_7 = {}
			end

			table = var_5

			return var_5.contains(var_72_7, arg_72_0.id)
		end
	end
...
function var_0_1.GetPrevChapterNames(arg_73_0)
	...
	for iter_73_0, iter_73_1 in var_1_10002(arg_73_0:getConfig("pre_chapter")) do
		if iter_73_1[1] ~= 0 then
			...
			local var_73_2 = arg_73_0.bindConfigTable(var_73_1)[var_7].chapter_name

			table = var_73_1

			var_73_1.insert(var_73_0, var_73_2)
		end
	end
...
function var_0_1.getNpcShipByType(arg_82_0, arg_82_1)
	...
	local var_82_1 = var_1_10003(var_1_10004)
	...
	local function var_82_2(arg_83_0)
		...
		var_83_1 = var_1.getTaskVO(var_83_0, arg_83_0) and not var_1:isFinish()
	...
	for iter_82_0, iter_82_1 in var_1_10005(arg_82_0:getConfig("npc_data")) do
		pg = var_1_10010
		var_1_10010 = var_1_10010.npc_squad_template[iter_82_1]

		if not arg_82_1 or arg_82_1 == var_1_10010.type and var_82_2(var_1_10010.task_id) then
			ipairs = var_1_10011
			...
			for iter_82_2, iter_82_3 in var_1_10011({
				...
				for iter_82_4, iter_82_5 in var_1_10016(var_1_10010[iter_82_3]) do
					table = var_1_10021
					...
					var_1_10021(var_82_3, var_1_10023.New({
						id = iter_82_5[1],
...
function var_0_1.getTodayDefeatCount(arg_84_0)
	...
	local var_84_0 = var_1_10001(var_1_10002)
...
function var_0_1.updateTodayDefeatCount(arg_86_0)
	...
	local var_86_0 = var_1_10001(var_1_10002)
...
function var_0_1.GetRestDailyBonus(arg_88_0)
	...
	local var_88_2 = arg_88_0.getConfig(var_88_1, "boss_expedition_id")

	ipairs = var_88_1

	for iter_88_0, iter_88_1 in var_88_1(var_88_2) do
		pg = var_1_10008
		var_1_10008 = var_1_10008.expedition_activity_template[iter_88_1]
		math = var_1_10009
		var_1_10009 = var_1_10009.max

		local var_88_3 = var_88_0
		local var_88_4
		...
		var_88_0 = var_1_10009(var_88_3, var_88_4)
	end
	...
	if var_3.chapter_defense[arg_88_0.id] then
		math = var_88_5
		var_88_5 = var_88_5.max

		local var_88_6 = var_88_0
		local var_88_7
		...
		var_88_0 = var_88_5(var_88_6, var_88_7)
	end

	math = var_88_5

	return (var_88_5.max(var_88_0 - arg_88_0.todayDefeatCount, 0))
end
...
function var_0_1.GetDailyBonusRate(arg_90_0)
	...
	local var_90_2 = arg_90_0.getConfig(var_90_1, "boss_expedition_id")

	ipairs = var_90_1

	for iter_90_0, iter_90_1 in var_90_1(var_90_2) do
		pg = var_1_10008
		var_1_10008 = var_1_10008.expedition_activity_template[iter_90_1]
		math = var_1_10009
		var_1_10009 = var_1_10009.max

		local var_90_3 = var_90_0
		local var_90_4
		...
		var_90_0 = var_1_10009(var_90_3, var_90_4)
	end
	...
	if var_3.chapter_defense[arg_90_0.id] then
		...
		local var_90_5 = var_4.max
		local var_90_6 = var_90_0
		local var_90_7
		...
		var_90_0 = var_90_5(var_90_6, var_90_7)
	end
...
function var_0_1.GetDailyBonusIconName(arg_91_0)
	if arg_91_0:GetDailyBonusRate() then
		local var_91_0 = "bonusX"

		tostring = var_1_10003

		local var_91_1

		if not (var_91_0 .. var_1_10003(var_1)) then
			var_91_1 = "bonusX5"
		end
...
function var_0_1.GetSpItems(arg_93_0)
	...
	local var_93_1 = var_1_10002(var_1_10003)
	local var_93_2 = var_2.getItemsByType

	Item = var_1_10004

	local var_93_3 = var_93_2(var_93_1, var_1_10004.SPECIAL_OPERATION_TICKET)

	noEmptyStr = var_93_1

	if var_93_1(arg_93_0:getConfig("special_operation_list")) then
		next = var_4

		if not var_4(var_3) then
			return var_93_0
		end

		ipairs = var_4

		for iter_93_0, iter_93_1 in var_4(var_3) do
			pg = var_1_10009
...
function var_0_1.GetSPBuffByItem(arg_94_0)
	...
	local var_94_0 = var_1_10002.benefit_buff_template.get_id_list_by_benefit_type

	Chapter = var_1_10003

	for iter_94_0, iter_94_1 in var_1_10001(var_94_0[var_1_10003.OPERATION_BUFF_TYPE_DESC]) do
		pg = var_1_10006
...
function var_0_1.GetActiveSPItemID(arg_95_0)
	...
	if var_2.GetInt(var_95_0, 0) == 0 then
		return 0
	end
	...
	local var_95_2 = arg_95_0.GetSpItems(var_95_1)
...
function var_0_1.GetLimitOilCost(arg_97_0, arg_97_1, arg_97_2)
	...
	if not arg_97_0.isLoop(var_97_0) then
		return 9999
	end
	...
	local var_97_2 = var_97_0.expedition_data_template[arg_97_2].type

	ChapterConst = var_1_10006

	if var_97_2 ~= var_1_10006.ExpeditionTypeBoss then
		do
			local var_97_3 = var_4.type

			ChapterConst = var_6

			if var_97_3 == var_6.ExpeditionTypeMulBoss then
				var_97_1 = 2
			else
				var_97_1 = 1
			end
		...
		if not arg_97_0:getConfig("use_oil_limit")[var_97_1] then
			var_97_4 = 9999
		end
...
function var_0_1.IsRemaster(arg_98_0)
	...
	local var_98_0 = var_1_10001(var_1_10002)
	local var_98_1

	var_98_1 = var_1.getMapById(var_98_0, arg_98_0:getConfig("map")) and var_1:isRemaster()
...
function var_0_1.GetMaxBattleCount(arg_100_0)
	...
	local var_100_1 = var_1_10002(var_1_10003)
	local var_100_2 = var_2.getMapById(var_100_1, arg_100_0:getConfig("map"))
	local var_100_3 = var_2.getMapType(var_100_2)

	Map = var_100_2

	if var_100_3 == var_100_2.ELITE then
		pg = var_100_3
		var_100_0 = var_100_3.gameset.hard_level_multiple_sorties_times.key_value
		math = var_3

		local var_100_4 = var_3.clamp
		local var_100_5 = var_100_0
		local var_100_6 = 0

		getProxy = var_6
		DailyLevelProxy = var_1_10007
		var_1_10007 = var_6(var_1_10007)
		var_100_0 = var_100_4(var_100_5, var_100_6, var_6.GetRestEliteCount(var_1_10007))
	elseif var_2:isRemaster() then
		pg = var_3
		var_100_0 = var_3.gameset.archives_level_multiple_sorties_times.key_value
		math = var_3

		local var_100_7 = var_3.clamp
		local var_100_8 = var_100_0
		local var_100_9 = 0

		getProxy = var_6
		ChapterProxy = var_1_10007
		var_100_0 = var_100_7(var_100_8, var_100_9, var_6(var_1_10007).remasterTickets)
	...
	if arg_100_0:isTriesLimit() then
		local var_100_10 = arg_100_0:getConfig("count") - arg_100_0:getTodayDefeatCount()

		math = var_4
		var_100_0 = var_4.clamp(var_100_0, 0, var_100_10)
	end
