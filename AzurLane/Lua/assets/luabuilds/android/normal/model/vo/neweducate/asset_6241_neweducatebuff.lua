...
function var_0_1.GetBenefitIdsByEffectType(arg_7_0, arg_7_1)
	...
	for iter_7_0, iter_7_1 in var_1_10003(arg_7_0:getConfig("show_content")) do
		...
		var_1_10008 = var_1_10008.any
		pg = var_1_10009

		if var_1_10008(var_1_10009.child2_benefit[iter_7_1].effect, function(arg_8_0)
			assert = var_2_10001
			type = var_2_10002

			var_2_10001(var_2_10002(arg_8_0) == "table", "请检查effect配置的括号,benefit id:" .. iter_7_1)

			return arg_8_0[1] == arg_7_1
		end) then
			table = var_1_10008

			var_1_10008.insert(var_7_0, iter_7_1)
		end
	end
