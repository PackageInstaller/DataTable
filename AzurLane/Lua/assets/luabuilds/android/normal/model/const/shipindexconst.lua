...
bit = var_1
var_0_0.SortRarity = var_1.lshift(1, 0)
bit = var_1
...
function var_0_0.getSortFuncAndName(arg_1_0, arg_1_1)
	...
	for iter_1_0 = var_1_0, #var_1_10003.sort do
		...
		local var_1_1 = var_7.band(var_1_10006, arg_1_0)

		if 0 < var_1_1 then
			underscore = var_1_1

			local var_1_2 = var_1_1.map

			ShipIndexCfg = var_8

			local var_1_3 = var_1_2(var_8.sort[iter_1_0].sortFuncs, function(arg_2_0)
			...
			return var_1_3, var_9.sort[iter_1_0].name
		end
	end
...
function var_0_0.getSortName(arg_4_0)
	...
	for iter_4_0 = var_4_0, #var_1_10002.SortRoleStory do
		...
		if var_6.band(var_1_10005, arg_4_0) > 0 then
			return iter_4_0
		end
	end
...
function var_0_0.filterByType(arg_26_0, arg_26_1)
	...
	for iter_26_0 = var_26_0, #var_1_10003.type do
		...
		if var_7.band(var_1_10006, arg_26_1) > 0 then
			ShipIndexCfg = var_7

			local var_26_1 = var_7.type[iter_26_0].types
			local var_26_2

			if iter_26_0 < 4 then
				ShipIndexCfg = var_26_2
				var_26_2 = var_26_2.type[iter_26_0].shipTypes
				table = var_9

				if var_9.contains(var_26_1, arg_26_0:getShipType()) then
					return true
				end

				table = var_9

				if var_9.contains(var_26_1, arg_26_0:getTeamType()) then
					return true
				end
			else
				table = var_26_2

				if var_26_2.contains(var_26_1, arg_26_0:getShipType()) then
					return true
				end
			end
		end
...
function var_0_0.filterRoleProgressBar(arg_27_0, arg_27_1)
	...
	local var_27_0 = var_1_10002(var_1_10003)
	local var_27_1 = var_2.getShipGroup(var_27_0, arg_27_0.ship_group)
	local var_27_2 = 2

	RoleIndexCfg = var_4

	for iter_27_0 = var_27_2, #var_4.progress do
		bit = var_1_10007
		var_1_10007 = var_1_10007.lshift(1, iter_27_0 - 2)
		bit = var_8

		if var_8.band(var_1_10007, arg_27_1) > 0 then
			RoleIndexCfg = var_8

			if #var_8.progress[iter_27_0].types == 0 then
				return true
			end

			ipairs = var_9

			for iter_27_1, iter_27_2 in var_9(var_8) do
				if iter_27_2 == 1 then
					pg = var_1_10014
...
function var_0_0.filterByCamp(arg_28_0, arg_28_1)
	...
	local var_28_1 = var_28_0(var_1_10003.camp)

	LOCK_NATION_HNLMS = var_3

	if var_3 then
		underscore = var_3
		var_28_1 = var_3.filter(var_28_1, function(arg_29_0)
			local var_29_1
	...
	for iter_28_0 = 2, #var_28_1 do
		...
		local var_28_2 = var_8.band(var_1_10007, arg_28_1)

		if 0 < var_28_2 then
			local var_28_3 = var_28_1[iter_28_0].types

			ipairs = var_9

			for iter_28_1, iter_28_2 in var_9(var_28_3) do
				Nation = var_1_10014

				if iter_28_2 == var_1_10014.LINK then
					local var_28_4 = arg_28_0

					var_1_10014 = arg_28_0.getNation(var_28_4)
					Nation = var_28_4

					if var_1_10014 >= var_28_4.LINK then
						return true
					end
...
function var_0_0.RolefilterByCamp(arg_30_0, arg_30_1)
	...
	local var_30_1 = var_30_0(var_1_10003.camp)

	LOCK_NATION_HNLMS = var_3

	if var_3 then
		underscore = var_3
		var_30_1 = var_3.filter(var_30_1, function(arg_31_0)
			local var_31_1
	...
	for iter_30_0 = 2, #var_30_1 do
		...
		local var_30_2 = var_8.band(var_1_10007, arg_30_1)

		if 0 < var_30_2 then
			local var_30_3 = var_30_1[iter_30_0].types

			ipairs = var_9

			for iter_30_1, iter_30_2 in var_9(var_30_3) do
				Nation = var_1_10014
...
function var_0_0.filterByRarity(arg_32_0, arg_32_1)
	...
	for iter_32_0 = var_32_0, #var_1_10003.rarity do
		...
		local var_32_1 = var_7.band(var_1_10006, arg_32_1)

		if 0 < var_32_1 then
			ShipIndexCfg = var_32_1

			local var_32_2 = var_32_1.rarity[iter_32_0].types

			table = var_8

			if var_8.contains(var_32_2, arg_32_0:getRarity()) then
				return true
			end
		end
	end
...
function var_0_0.filterByCollExtra(arg_34_0, arg_34_1)
	...
	if arg_34_1 == var_0_0.CollExtraNotObtained then
		...
		local var_34_2 = arg_34_0.isRemoulded(var_34_1)

		getProxy = var_34_1
		CollectionProxy = var_1_10005

		local var_34_3 = var_34_1(var_1_10005)
		local var_34_4 = var_4.getShipGroup(var_34_3, var_34_0)

		ShipGroup = var_34_3

		local var_34_5 = var_34_3.getState(var_34_0, var_34_4, var_34_2)

		ShipGroup = var_6

		if var_34_5 ~= var_6.STATE_UNLOCK then
			return true
		end
	end
