...
function var_0_0.ContainInLimitBundle(arg_7_0, arg_7_1)
	if var_0_0.GetShipTypesFromLimit(arg_7_0) == "all" then
		...
		return var_3.any(var_2, function(arg_8_0)
...
function var_0_0.MergeFengFanType(arg_16_0, arg_16_1, arg_16_2)
	...
	if var_1_10004.all(var_0_0.BundleList.fengfan, function(arg_17_0)
		...
		underscore = var_5
		arg_16_0 = var_5.filter(arg_16_0, function(arg_18_0)
			table = var_2_10001
...
function var_0_0.GetTeamFromShipType(arg_19_0)
	if not var_0_1 then
		...
		var_19_0[var_1_10003.Vanguard] = var_0_0.VanguardShipType
		TeamType = var_3
		var_19_0[var_3.Main] = var_0_0.MainShipType
		TeamType = var_3
		var_19_0[var_3.Submarine] = var_0_0.SubShipType
