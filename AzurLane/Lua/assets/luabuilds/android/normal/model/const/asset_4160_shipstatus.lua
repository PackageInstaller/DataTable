...
function var_0_0.ShipStatusToTag(arg_2_0, arg_2_1)
	if var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inChapter") then
		...
		i18n = var_3
		var_2_0[3] = var_3("word_status_inFight")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inFleet") then
		...
		local var_2_2 = var_2.GetRegularFleetByShip(var_2_1, arg_2_0)

		assert = var_2_1

		var_2_1(var_2_2)

		local var_2_3 = var_2_2.id

		var_1_10006 = var_2_2

		if var_2_2.isRegularFleet(var_1_10006) then
			math = var_5
			var_2_3 = var_5.fmod(var_2_3, 10)
			...
			Fleet = var_1_10006
			var_2_4[3] = var_1_10006.DEFAULT_NAME_FOR_DOCKYARD[var_2_3]
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inElite") then
		...
		i18n = var_3
		var_2_5[3] = var_3("word_status_inHardFormation")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inSupport") then
		...
		i18n = var_3
		var_2_6[3] = var_3("word_status_inSupportFleet")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inActivity") then
		...
		i18n = var_3
		var_2_7[3] = var_3("word_status_activity")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inChallenge") then
		...
		i18n = var_3
		var_2_8[3] = var_3("word_status_challenge")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inPvP") then
		...
		i18n = var_3
		var_2_9[3] = var_3("word_status_inPVP")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inEvent") then
		...
		i18n = var_3
		var_2_10[3] = var_3("word_status_inEvent")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inBackyard") then
		...
		local var_2_11 = var_2(var_3)
		local var_2_12 = var_2.getRawData(var_2_11)
		local var_2_13, var_2_14 = var_2.InBackYard(var_2_12, arg_2_0.id)
		local var_2_15

		if var_2_13 then
			DormShip = var_2_15

			if var_2_14 == var_2_15.FLOOR_2 then
				var_2_15 = {
					"shipstatus",
					"purple"
				}
				i18n = var_1_10006
				var_2_15[3] = var_1_10006("word_status_rest")

				do return var_2_15 end
		...
		if var_2_13 then
			...
			if var_2_14 == var_2_15.FLOOR_1 then
				local var_2_16 = {
					"shipstatus",
					"purple"
				}
				...
				i18n = var_1_10006
				var_2_16[3] = var_1_10006("word_status_train")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inClass") then
		...
		i18n = var_3
		var_2_17[3] = var_3("word_status_inClass")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inTactics") then
		...
		i18n = var_3
		var_2_18[3] = var_3("word_status_inTactics")
	...
	elseif var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inAdmiral") then
		...
		i18n = var_3
		var_2_19[3] = var_3("common_flag_ship")
		...
		if var_0_0.checkShipFlag(arg_2_0, arg_2_1, "inWorld") then
			...
			i18n = var_3
			var_2_20[3] = var_3("word_status_world")
			...
			local var_2_21 = var_2_20(var_3)

			if var_2.IsRandomFlagShip(var_2_21, arg_2_0:GetShipPhantomMark()) then
				local var_2_22 = {
					"shipstatus",
					"light_yellow"
				}
				...
				i18n = var_2_21
				var_2_22[3] = var_2_21("random_flag_ship")
...
function var_0_0.ChangeStatusCheckBox(arg_5_0, arg_5_1, arg_5_2)
	if arg_5_0 == "inBackyard" then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("ship_vo_moveout_backyard")
		...
		function var_1_10005.onYes()
			...
			var_6_1(var_6_0, var_2_10002.EXIT_SHIP, {
				callback = arg_5_2,
				shipId = arg_5_1.id
			})
		...
		var_1_10003(var_1_10004, var_1_10005)
	...
	elseif arg_5_0 == "inFleet" then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("shipchange_alert_infleet")

		function var_1_10005.onYes()
			getProxy = var_2_10000
			FleetProxy = var_2_10001
			...
			if var_0.canRemove(var_7_1, arg_5_1) then
				...
				var_7_3(var_7_2, var_3.UPDATE_FLEET, {
					callback = arg_5_2,
					fleet = var_0
				})
			else
				...
				var_7_5(var_7_4, var_3("shipmodechange_reject_1stfleet_only"))
			end
	...
	elseif arg_5_0 == "inSupport" then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("ship_formationMediator_request_replace_support")
		...
		function var_1_10005.onYes()
			...
			var_8_1(var_8_0, var_2_10002.REMOVE_ELITE_TARGET_SHIP, {
				shipId = arg_5_1.id,
				callback = arg_5_2
			})
	...
	elseif arg_5_0 == "inPvP" then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("shipchange_alert_inpvp")
		...
		function var_1_10005.onYes()
			...
			local var_9_2 = var_9_1(var_9_0, var_2_10002.PVP_FLEET_ID)
			...
			if var_0.canRemove(var_9_2, arg_5_1) then
				...
				var_9_4(var_9_3, var_3.UPDATE_FLEET, {
					callback = arg_5_2,
					fleet = var_0
				})
			else
				...
				if var_9_6 == var_9_5.Vanguard then
					pg = var_9_8
					...
					var_9_8(var_9_7, var_2_10004("ship_vo_vanguardFleet_must_hasShip"))
				else
					TeamType = var_9_8
					...
					if var_9_6 == var_9_8.Main then
						...
						var_9_10(var_9_9, var_2_10004("ship_vo_mainFleet_must_hasShip"))
					end
				end
			end
	...
	elseif arg_5_0 == "inExercise" then
		...
		var_1_10005 = var_1_10003(var_1_10004)
		var_1_10006 = var_1_10003.getExerciseFleet(var_1_10005)

		if var_4.canRemove(var_1_10006, arg_5_1) then
			pg = var_1_10005
			var_1_10006 = var_1_10005.MsgboxMgr.GetInstance()
			var_1_10005 = var_1_10005.ShowMsgBox

			local var_5_0 = {}

			i18n = var_1_10008
			var_5_0.content = var_1_10008("shipchange_alert_inexercise")
			...
			function var_5_0.onYes()
				...
				var_10_2(var_10_1, var_2.UPDATE_EXERCISE_FLEET, {
					fleet = var_0,
					callback = arg_5_2
				})
			...
			var_1_10005(var_1_10006, var_5_0)
		else
			pg = var_1_10005
			var_1_10006 = var_1_10005.MsgboxMgr.GetInstance()
			var_1_10005 = var_1_10005.ShowMsgBox
			...
			i18n = var_1_10008
			var_5_1.content = var_1_10008("exercise_clear_fleet_tip")
			...
			function var_5_1.onYes()
				...
				var_11_2(var_11_1, var_2.UPDATE_EXERCISE_FLEET, {
					fleet = var_0,
					callback = arg_5_2
				})
			...
			var_1_10005(var_1_10006, var_5_1)
		end
	...
	elseif arg_5_0 == "inTactics" then
		...
		local var_5_2 = var_1_10003.MsgboxMgr.GetInstance()

		var_1_10003 = var_1_10003.ShowMsgBox
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("tactics_lesson_cancel")
		...
		function var_1_10005.onYes()
			...
			local var_12_4 = var_2_10004.CANCEL_LEARN_TACTICS
			local var_12_5 = {
				callback = arg_5_2,
				shipId = var_12_1
			}
			...
			Student = var_6
			var_12_5.type = var_6.CANCEL_TYPE_MANUAL
		...
		var_1_10003(var_5_2, var_1_10005)

		return false, nil
	elseif arg_5_0 == "inGuildBossEvent" then
		pg = var_1_10003

		local var_5_3 = var_1_10003.MsgboxMgr.GetInstance()

		var_1_10003 = var_1_10003.ShowMsgBox
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("word_shipState_guild_boss")
		...
		function var_1_10005.onYes()
			...
			if not var_0:GetActiveEvent() then
				return
			end

			local var_13_1 = var_1

			if var_1.GetBossMission(var_13_1) then
				var_2_10004 = var_2

				if not var_2.IsActive(var_2_10004) then
					return
				end
				...
				local var_13_2 = var_13_1(var_2_10004)
				local var_13_3 = var_3.getRawData(var_13_2).id
				local var_13_4 = var_2

				if not var_2.GetFleetUserId(var_13_4, var_13_3, arg_5_1.id) then
					return
				end

				Clone = var_13_4

				local var_13_5 = var_13_4(var_4)

				var_5.RemoveUserShip(var_13_5, var_13_3, arg_5_1.id)

				pg = var_6

				local var_13_6 = var_6.m02
				local var_13_7 = var_6.sendNotification

				GAME = var_8

				var_13_7(var_13_6, var_8.GUILD_UPDATE_BOSS_FORMATION, {
					force = true,
					editFleet = {
						[var_5.id] = var_5
					},
		...
		var_1_10003(var_5_3, var_1_10005)

		return false, nil
	elseif arg_5_0 == "inWorld" then
		nowWorld = var_1_10003

		local var_5_4 = var_1_10003().type

		World = var_1_10005

		if var_5_4 == var_1_10005.TypeBase then
			WorldConst = var_5_4

			var_5_4.ReqWorldCheck(arg_5_2)

			return false, nil
		else
			local var_5_5 = var_3:GetShip(arg_5_1.id).fleetId

			if #var_3:GetFleet(var_5_5)[arg_5_1:getTeamType()] > 1 then
				return true
			else
				pg = var_7

				local var_5_6 = var_7.TipsMgr.GetInstance()
				local var_5_7 = var_7.ShowTips

				i18n = var_1_10009

				var_5_7(var_5_6, var_1_10009("shipmodechange_reject_worldfleet_only"))
...
function var_0_0.canDestroyShip(arg_14_0, arg_14_1)
	...
	if arg_14_0.isBluePrintShip(var_14_0) then
		local var_14_1 = false

		i18n = var_14_0

		local var_14_2 = var_14_0("blueprint_destory_tip")

		return
	else
		local var_14_3 = arg_14_0
		local var_14_4 = arg_14_0.GetLockState(var_14_3)

		Ship = var_14_3

		if var_14_4 == var_14_3.LOCK_STATE_LOCK then
			local var_14_5 = false

			i18n = var_3

			local var_14_6 = var_3("ship_vo_locked")

			return
		else
			local var_14_7 = arg_14_0

			if arg_14_0.isMetaShip(var_14_7) then
				local var_14_8 = false

				i18n = var_14_7

				local var_14_9 = var_14_7("meta_destroy_tip")
