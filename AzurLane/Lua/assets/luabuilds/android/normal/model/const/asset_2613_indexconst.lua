...
function var_0_0.Flags2Bits(arg_1_0)
	...
	for iter_1_0, iter_1_1 in var_1_10002(arg_1_0) do
		...
		bit = var_1_10009
		var_1_0 = var_1_10007(var_1_1, var_1_10009.lshift(1, iter_1_1))
	end
...
function var_0_0.FlagRange2Bits(arg_2_0, arg_2_1)
	...
	for iter_2_0 = arg_2_0, arg_2_1 do
		...
		bit = var_1_10009
		var_2_0 = var_1_10007(var_2_1, var_1_10009.lshift(1, iter_2_0))
	end
...
function var_0_0.ToggleBits(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_2 then
		bit = var_3_2
		var_3_2 = var_3_2.lshift(1, arg_3_2)
		_ = var_7

		local var_3_3 = var_7.reduce(arg_3_1, 0, function(arg_4_0, arg_4_1)
		...
		if var_3_1 == var_3_2 then
			...
			if var_8.band(var_3_0, var_3_2) > 0 then
			...
			if var_3_0 + var_3_1 == var_3_3 or var_3_0 == 0 then
				var_3_0 = var_3_2
			end
		end
	else
		...
		if var_3_2.band(var_3_0, var_3_1) > 0 then
			var_3_1 = -var_3_1
		end
...
function var_0_0.SingleToggleBits(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if var_5_0 == var_1_10005.lshift(1, arg_5_3) then
		bit = var_6
		var_5_0 = var_6.lshift(1, arg_5_2)
	else
		var_5_0 = var_5
	end
...
function var_0_0.StrAnd(arg_7_0, arg_7_1)
	...
	local var_7_2 = (var_7_1 > var_4.len(arg_7_1) and arg_7_0 or arg_7_1) == arg_7_0 and arg_7_1 or arg_7_0
...
function var_0_0.StrOr(arg_8_0, arg_8_1)
	...
	local var_8_2 = (var_8_1 > var_4.len(arg_8_1) and arg_8_0 or arg_8_1) == arg_8_0 and arg_8_1 or arg_8_0
	...
	if arg_11_2 then
		...
		if var_11_0 ~= var_11_3 then
			...
			if var_11_4.find(var_11_0, "1") == nil then
				...
				local var_11_10 = var_7.len(var_11_9) - arg_11_3
...
function var_0_0.filterEquipByType(arg_13_0, arg_13_1)
	...
	for iter_13_0 = var_13_0, #var_1_10003.index do
		...
		local var_13_1 = var_7.band(var_1_10006, arg_13_1)

		if 0 < var_13_1 then
			EquipmentSortCfg = var_13_1

			local var_13_2 = var_13_1.index[iter_13_0].types

			table = var_8

			if var_8.contains(var_13_2, arg_13_0:getConfig("type")) then
				return true
			end
		end
	end
...
function var_0_0.filterEquipByCamp(arg_14_0, arg_14_1)
	...
	for iter_14_0 = var_14_0, #var_1_10003.campIndex do
		...
		local var_14_1 = var_7.band(var_1_10006, arg_14_1)

		if 0 < var_14_1 then
			EquipmentSortCfg = var_14_1

			local var_14_2 = var_14_1.campIndex[iter_14_0].types

			ipairs = var_8

			for iter_14_1, iter_14_2 in var_8(var_14_2) do
				Nation = var_1_10013

				if iter_14_2 == var_1_10013.LINK then
					local var_14_3 = arg_14_0

					var_1_10013 = arg_14_0.getNation(var_14_3)
					Nation = var_14_3

					if var_1_10013 >= var_14_3.LINK then
						return true
					end
...
function var_0_0.filterEquipByProperty(arg_15_0, arg_15_1)
	...
	if arg_15_0.getConfig(var_15_1, "attribute_3") then
		table = var_3
	...
	for iter_15_0, iter_15_1 in var_15_1(arg_15_1) do
		if not iter_15_1 or iter_15_1 == var_0_0.EquipPropertyAll then
			...
			for iter_15_2 = var_15_3, #var_1_10010.propertyIndex do
				bit = var_1_10013
				var_1_10013 = var_1_10013.lshift(1, iter_15_2 - 2)
				bit = var_14

				if var_14.band(var_1_10013, iter_15_1) > 0 then
					EquipmentSortCfg = var_14

					local var_15_4 = var_14.propertyIndex[iter_15_2].types

					for iter_15_3 = #var_15_0, 1, -1 do
						local var_15_5 = var_15_0[iter_15_3]

						table = var_1_10020

						if var_1_10020.contains(var_15_4, var_15_5) then
							var_15_2 = var_15_2 + 1
							table = var_1_10020
...
function var_0_0.filterEquipAmmo1(arg_16_0, arg_16_1)
	...
	for iter_16_0 = var_16_0, #var_1_10003.ammoIndex1 do
		...
		local var_16_1 = var_7.band(var_1_10006, arg_16_1)

		if 0 < var_16_1 then
			EquipmentSortCfg = var_16_1

			local var_16_2 = var_16_1.ammoIndex1[iter_16_0].types

			table = var_8

			if var_8.contains(var_16_2, arg_16_0:getConfig("ammo")) then
				return true
			end
		end
	end
...
function var_0_0.filterEquipAmmo2(arg_17_0, arg_17_1)
	...
	for iter_17_0 = var_17_0, #var_1_10003.ammoIndex2 do
		...
		local var_17_1 = var_7.band(var_1_10006, arg_17_1)

		if 0 < var_17_1 then
			EquipmentSortCfg = var_17_1

			local var_17_2 = var_17_1.ammoIndex2[iter_17_0].types

			table = var_8

			if var_8.contains(var_17_2, arg_17_0:getConfig("ammo")) then
				return true
			end
		end
	end
...
function var_0_0.filterEquipByRarity(arg_18_0, arg_18_1)
	...
	local var_18_1 = var_3.lshift(1, var_18_0)
...
for iter_0_0, iter_0_1 in var_1(var_2.equip_skin_theme_template.all) do
	table = var_0_10006
...
for iter_0_2, iter_0_3 in var_0_3(var_2.equip_skin_theme_template.all) do
	pg = var_0_10006
...
function var_0_0.filterEquipSkinByIndex(arg_20_0, arg_20_1)
	...
	if var_20_0(var_20_1, var_1_10004.lshift(1, var_0_0.EquipSkinIndexAll)) > 0 then
		return true
	end
	...
	for iter_20_0, iter_20_1 in var_4(var_0_0.EquipSkinIndexTypes) do
		bit = var_1_10009
		...
		bit = var_1_10011
		var_1_10009 = var_1_10009(var_20_4, var_1_10011.lshift(1, iter_20_1))
		...
		if 0 < var_1_10009 then
			...
			for iter_20_2, iter_20_3 in var_1_10011(var_20_5) do
				table = var_1_10016
...
function var_0_0.filterEquipSkinByTheme(arg_21_0, arg_21_1)
	...
	local var_21_1 = var_3.equip_skin_theme_template
...
function var_0_0.filterSpWeaponByType(arg_22_0, arg_22_1)
	...
	for iter_22_0 = 0, #var_0_0.SpWeaponTypeIndexs - 2 do
		...
		if var_8.band(var_1_10007, arg_22_1) > 0 then
			ShipIndexCfg = var_8

			local var_22_1 = var_8.type[4 + iter_22_0].types

			_ = var_9

			if var_9.any(var_22_1, function(arg_23_0)
				table = var_2_10001
...
function var_0_0.filterSpWeaponByRarity(arg_24_0, arg_24_1)
	...
	local var_24_1 = var_3.lshift(1, var_24_0)
...
for iter_0_4 = 1, var_0_0.LABEL_COUNT do
	bit = iter_0_3
	iter_0_3 = iter_0_3.lshift(1, iter_0_4 - 1)
	table = var_6

	var_6.insert(var_0_0.ECodeLabelNames, "equip_share_label_" .. iter_0_4)

	table = var_6

	var_6.insert(var_0_0.ECodeLabelIndexs, iter_0_3)
end

local var_0_4 = var_0_0.BitAll(var_0_0.ECodeLabelIndexs)
...
var_2.insert(var_0_0.ECodeLabelIndexs, 1, var_0_4)

function var_0_0.filterEquipCodeByLable(arg_25_0, arg_25_1)
	if not arg_25_1 or arg_25_1 == var_0_4 then
		return true
	end
	...
	for iter_25_0, iter_25_1 in var_1_10002(arg_25_0:GetLabels()) do
		...
		bit = var_1_10008
		var_1_10007 = var_1_10007(var_1_10008.lshift(1, iter_25_1 - 1), arg_25_1)
