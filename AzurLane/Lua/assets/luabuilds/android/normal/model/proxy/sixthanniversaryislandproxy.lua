...
function var_0_1.CheckAndRequest(arg_4_0, arg_4_1)
	...
	if var_4_2(var_4_1, var_1_10005.ACTIVITY_TYPE_ISLAND) and not var_3:isEnd() and not arg_4_0:CheckValid() then
		table = var_4_1

		var_4_1.insert(var_4_0, function(arg_5_0)
			local var_5_0 = arg_4_0
			local var_5_1 = var_1.sendNotification

			GAME = var_2_10003

			var_5_1(var_5_0, var_2_10003.REQUEST_NODE_LIST, {
				act_id = var_0.id,
				callback = arg_5_0
			})
