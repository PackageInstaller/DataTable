...
function var_0_1.WriteBackOnExitBattleResult(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_1 = arg_13_0.getUserChallengeInfo(var_13_0, arg_13_2)

	ys = var_13_0

	if arg_13_1 < var_13_0.Battle.BattleConst.BattleScore.S then
		local var_13_2 = arg_13_0
		local var_13_3 = arg_13_0.sendNotification

		GAME = var_1_10006

		var_13_3(var_13_2, var_1_10006.CHALLENGE2_RESET, {
			mode = arg_13_2
		})
	else
		local var_13_4 = var_13_1:IsFinish()

		var_13_1:updateLevelForward()

		local var_13_5 = var_13_1
		local var_13_6 = var_13_1.getMode(var_13_5)

		ChallengeProxy = var_13_5

		if var_13_6 == var_13_5.MODE_INFINITE and var_13_4 then
			var_13_1:setInfiniteDungeonIDListByLevel()
		end
	end

	local var_13_7 = arg_13_0:getChallengeInfo()

	if not arg_13_0:userSeaonExpire(var_13_1:getMode()) then
		var_13_7:checkRecord(var_13_1)
	end
