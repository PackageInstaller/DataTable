...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(14001, function(arg_2_0)
		...
		for iter_2_4, iter_2_5 in var_1(arg_2_0.spweapon_list) do
			...
			SpWeapon = var_2_10008

			var_2_2(var_2_1, var_2_10008.CreateByNet(iter_2_5))
		end
...
function var_0_1.getSkinsByType(arg_6_0, arg_6_1)
	...
	local var_6_3 = arg_6_0.getEquipmentSkins(var_6_2)
...
function var_0_1.getSkinsByTypes(arg_7_0, arg_7_1)
	...
	local var_7_3 = arg_7_0.getEquipmentSkins(var_7_2)

	pairs = var_7_2

	for iter_7_0, iter_7_1 in var_7_2(var_7_3) do
		assert = var_1_10010
...
function var_0_1.addEquipment(arg_11_0, arg_11_1)
	...
	var_1_10002(var_1_10003(var_11_0, var_1_10005), "should be an instance of Equipment")
...
function var_0_1.updateEquipment(arg_13_0, arg_13_1)
	...
	var_1_10002(var_1_10003(var_13_0, var_1_10005), "should be an instance of Equipment")
...
function var_0_1.getSameTypeEquipmentId(arg_19_0, arg_19_1)
	...
	while var_19_0.config.next ~= 0 do
		...
		if arg_19_0.getEquipmentById(var_19_2, var_19_0.config.next) and var_4.count > 0 then
			var_19_1 = var_4
		end

		Equipment = var_19_2
		var_19_0 = var_19_2.New({
	...
	if not var_19_1 then
		...
		while var_19_3.config.prev ~= 0 do
			...
			if arg_19_0.getEquipmentById(var_19_4, var_19_3.config.prev) and var_4.count > 0 then
				var_19_1 = var_4
...
function var_0_1.getEquipmentSkinCount(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10003(var_21_0) do
...
function var_0_1.StaticGetSpWeapon(arg_27_0, arg_27_1)
	...
	if arg_27_0 and 0 < arg_27_0 then
		...
		if var_1_10004.getShipById(var_1_10005, arg_27_0) then
			::label_27_0::

			var_1_10005 = var_27_0
			var_27_1 = var_27_0.GetSpWeapon(var_1_10005)
		end
	else
		getProxy = var_1_10004
		EquipmentProxy = var_1_10005

		local var_27_2 = var_1_10004(var_1_10005)
...
function var_0_1.GetSameTypeSpWeapon(arg_28_0, arg_28_1)
	...
	while var_28_1 ~= 0 do
		...
		var_1_10005 = var_4.GetRarity(var_28_3)
		var_1_10007 = arg_28_1

		if var_1_10005 ~= arg_28_1.GetRarity(var_1_10007) then
			break
		end

		pairs = var_1_10005
		var_1_10007 = arg_28_0

		for iter_28_0, iter_28_1 in var_1_10005(arg_28_0.GetSpWeapons(var_1_10007)) do
		...
		if var_28_0 then
			...
			var_28_1 = var_4:GetNextUpgradeID()
		end
	end
	...
	if not var_28_0 then
		...
		while var_28_4 ~= 0 do
			...
			local var_28_6 = var_1_10007.New({
				id = var_28_4
			})

			if var_6.GetRarity(var_28_6) ~= arg_28_1:GetRarity() then
				break
			end

			pairs = var_1_10007

			for iter_28_2, iter_28_3 in var_1_10007(arg_28_0:GetSpWeapons()) do
			...
			if var_28_0 then
				...
				var_28_4 = var_6:GetPrevUpgradeID()
			end
		end
	end
...
for iter_0_0, iter_0_1 in var_1(var_2.equip_upgrade_data.all) do
	pg = var_0_10006
...
for iter_0_3, iter_0_4 in var_1(var_2.equip_upgrade_template.all) do
	pg = var_0_10006
...
function var_0_1.BuildEquipmentDesignObtainWayIndex(arg_41_0)
	...
	local function var_41_2(arg_43_0)
		...
		if var_2_10002.getConfigData(arg_43_0) then
			...
			if var_43_1 == var_2_10004.DESIGN_TYPE then
				table = var_43_1
			...
			for iter_43_0, iter_43_1 in var_43_1(var_43_2) do
				...
				if var_41_0(var_43_3) then
					...
					if var_10.getConfigData(var_43_4) then
						...
						if var_43_5 == var_2_10012.DESIGN_TYPE then
							table = var_43_5
	...
	for iter_41_0, iter_41_1 in var_1_10006(var_1_10007.chapter_template.all) do
		pg = var_1_10011
		...
		if var_41_4(var_1_10011) then
			...
			for iter_41_2, iter_41_3 in var_1_10014(var_1_10012) do
	...
	for iter_41_6, iter_41_7 in var_6(var_7.technology_data_template.all) do
		pg = var_1_10011
	...
	if var_6.getFragmentShop(var_41_8) then
		...
		local var_41_11 = var_41_10(var_41_9, iter_41_6)

		ipairs = var_41_9

		for iter_41_12, iter_41_13 in var_41_9(var_41_11) do
			ipairs = var_1_10013
			...
			for iter_41_14, iter_41_15 in var_1_10013(iter_41_13:GetDropList()) do
				...
				if var_41_12 == var_1_10020 then
					...
					if var_1_10020.getConfigData(var_41_13) then
						...
						if var_41_14 == iter_41_10.DESIGN_TYPE then
