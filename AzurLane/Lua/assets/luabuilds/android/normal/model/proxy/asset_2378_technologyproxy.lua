...
function var_0_1.register(arg_1_0)
	...
	var_1_1(var_1_0.ship_data_blueprint.all, function(arg_3_0)
		...
		math = var_2_10003
		var_3_1.maxConfigVersion = var_2_10003.max(arg_1_0.maxConfigVersion, var_3_0:getConfig("blueprint_version"))
...
function var_0_1.updateTechnologyQueue(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_2(arg_19_1) do
		...
		Technology = var_1_10009

		var_1_10007(var_19_0, var_1_10009.New({
			queue = true,
			id = iter_19_1.id,
			time = iter_19_1.time
		}))
...
function var_0_1.updateTechnology(arg_25_0, arg_25_1)
	...
	var_1_10002(var_3(var_25_0, var_5), "technology should be instance of Technology")
...
function var_0_1.addBluePrint(arg_31_0, arg_31_1)
	...
	ShipBluePrint = var_1_10005

	var_1_10002(var_1_10003(var_31_0, var_1_10005), "bluePrint should be instance of ShipBluePrint")
...
function var_0_1.updateBluePrint(arg_32_0, arg_32_1)
	...
	var_1_10002(var_1_10003(var_32_0, var_1_10005), "bluePrint should be instance of ShipBluePrint")
...
function var_0_1.getNewestCatchupTecID(arg_43_0)
	...
	return var_43_0(var_1_10002(var_1_10003.technology_catchup_template.all))
end
...
function var_0_1.IsShowTip(arg_49_0)
	...
	local var_49_4 = var_1_10005(var_1_10006)
	local var_49_5, var_49_6 = var_49_3(var_49_2, var_5.getData(var_49_4).level, "TechnologyMediator")

	OPEN_TEC_TREE_SYSTEM = var_49_8

	local var_49_8

	if var_49_8 then
		getProxy = var_49_8
		TechnologyNationProxy = var_6

		local var_49_7 = var_49_8(var_6)

		var_49_8 = var_49_8.getShowRedPointTag(var_49_7)
	end

	return var_49_8 or (var_49_1 or var_49_0) and var_49_5
end
...
function var_0_1.resetPursuingTimes(arg_51_0)
	...
	var_51_1(var_51_0, var_1_10003.PURSUING_RESET_DONE)
...
function var_0_1.calcMaxPursuingCount(arg_53_0, arg_53_1)
	...
	local var_53_6 = var_53_5(var_53_4, var_1_10005.ResGold)
	local var_53_7 = 0
...
function var_0_1.getItemCanUnlockBluePrint(arg_58_0, arg_58_1)
	if not arg_58_0.unlockItemDic then
		...
		for iter_58_0, iter_58_1 in var_2(var_1_10003.ship_data_blueprint.all) do
