...
function var_0_1.register(arg_1_0)
	arg_1_0:on(50000, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in var_2_0(arg_2_0.request_list) do
			...
			var_2_10007 = var_2_10007.ChannelFriend

			local var_2_1 = {}

			Player = var_2_10009
			var_2_1.player = var_2_10009.New(iter_2_1.player)
			var_2_1.content = iter_2_1.content
			var_2_1.timestamp = iter_2_1.timestamp

			local var_2_2 = var_2_10006(var_2_10007, var_2_1)

			var_2_10006.display(var_2_2, "request loaded")

			var_2_10007 = arg_1_0.data.requests
			var_2_10007[var_2_10006.player.id] = var_2_10006
		end
	...
	arg_1_0:on(50005, function(arg_3_0)
		...
		local var_3_1 = var_2_10002.ChannelFriend
		local var_3_2 = {}

		Player = var_2_10004
		var_3_2.player = var_2_10004.New(arg_3_0.msg.player)
...
function var_0_1.RawgetAllMessages(arg_9_0)
	...
	var_9_2.each(var_9_3:getCacheMsgList(), function(arg_12_0)
		table = var_2_10001
...
function var_0_1.getAllMessages(arg_13_0)
	...
	local var_13_3 = var_1_10003(var_13_1)
