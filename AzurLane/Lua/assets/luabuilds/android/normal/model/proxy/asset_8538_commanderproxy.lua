...
function var_0_1.register(arg_1_0)
	...
	for iter_1_2, iter_1_3 in var_2(var_3.commander_data_create_material.all) do
		...
		var_8.insert(arg_1_0.pools, var_1_10007)
	end
	...
	arg_1_0:on(25001, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in var_2_10001(arg_2_0.commanders) do
			...
			var_7.addCommander(var_2_0, var_2_10006)
		end
		...
		for iter_2_2, iter_2_3 in var_1(arg_2_0.box) do
			...
			var_7.updateBox(var_2_1, var_2_10006)
		end
		...
		for iter_2_4, iter_2_5 in var_1(arg_2_0.presets) do
			...
			for iter_2_6, iter_2_7 in var_2_10009(var_2_3) do
				local var_2_5 = arg_1_0

				if var_14.getCommanderById(var_2_5, iter_2_7.id) then
					var_2_4[iter_2_7.pos] = var_14
				end
			end

			local var_2_6 = arg_1_0.prefabFleet[var_2_2]

			var_2_10009.Update(var_2_6, {
				id = var_2_2,
				name = arg_2_0.name,
				commanders = var_2_4
			})
		...
		var_2_7.boxUsageCount = var_2_8
		LOCK_CATTERY = var_2_7

		if not var_2_7 then
			local var_2_9 = arg_1_0
			local var_2_10 = var_1.sendNotification

			GAME = var_3

			var_2_10(var_2_9, var_3.GET_COMMANDER_HOME)
		end
...
function var_0_1.updateCommander(arg_26_0, arg_26_1)
	...
	Commander = var_1_10005

	var_1_10002(var_3(var_26_0, var_1_10005), "commander should be and instance of Commander")
...
function var_0_1.haveFinishedBox(arg_29_0)
	...
	for iter_29_0, iter_29_1 in var_1_10001(arg_29_0.boxes) do
		...
		CommanderBox = var_29_0

		if var_29_1 == var_29_0.STATE_FINISHED then
			return true
		end
	end
...
function var_0_1.IsFinishAllBox(arg_30_0)
	...
	for iter_30_0, iter_30_1 in var_1_10004(arg_30_0.boxes) do
		local var_30_3 = iter_30_1
		local var_30_4 = iter_30_1.getState(var_30_3)

		CommanderBox = var_30_3

		if var_30_4 == var_30_3.STATE_FINISHED then
			var_30_0 = var_30_0 + 1
		else
			CommanderBox = var_10

			if var_30_4 == var_10.STATE_EMPTY then
				var_30_1 = var_30_1 + 1
			end
		end
...
function var_0_1.AddCommanderHome(arg_32_0, arg_32_1)
	...
	GetNextHour = var_32_0

	local var_32_2 = var_32_0(1) - var_32_1
...
function var_0_1.StartCalcExpTimer(arg_34_0, arg_34_1)
	...
	arg_34_0.calcExpTimer = var_2.New(function()
		...
		var_35_2(var_35_1, var_2_10002.CALC_CATTERY_EXP, {
...
function var_0_1.AnyPoolIsWaiting(arg_42_0)
	...
	for iter_42_0, iter_42_1 in var_1_10002(arg_42_0.boxes) do
		local var_42_1 = iter_42_1
		local var_42_2 = iter_42_1.getState(var_42_1)

		CommanderBox = var_42_1

		if var_42_2 ~= var_42_1.STATE_WAITING then
			CommanderBox = var_8

			if var_42_2 == var_8.STATE_STARTING then
				return false
			end

			CommanderBox = var_8

			if var_42_2 == var_8.STATE_FINISHED then
				var_42_0 = var_42_0 + 1
			end
		end
	end
...
function var_0_1.ShouldTipBox(arg_43_0)
	...
	local function var_43_1()
		...
		for iter_45_0, iter_45_1 in var_2_10000(arg_43_0.boxes) do
			...
			local var_45_1 = iter_45_1.getState(var_45_0)

			CommanderBox = var_45_0

			if var_45_1 == var_45_0.STATE_EMPTY then
				return true
			end
		end
...
function var_0_1.CalcQuickItemUsageCnt(arg_46_0)
	...
	local var_46_3 = var_1_10004(var_1_10005)
	...
	for iter_46_2, iter_46_3 in var_10(var_46_9) do
		...
		local var_46_12 = iter_46_3.getState(var_46_11)

		CommanderBox = var_46_11

		local var_46_14

		if var_46_12 == var_46_11.STATE_WAITING then
			var_46_5 = var_46_5 + 1
			var_46_7 = var_46_7 + 1
			table = var_46_14

			var_46_14.insert(var_46_8, iter_46_3)

			var_46_6 = var_46_6 + var_46_2(iter_46_3.beginTime, iter_46_3.finishTime)
		else
			CommanderBox = var_46_14

			if var_46_12 == var_46_14.STATE_STARTING then
				var_46_5 = var_46_5 + 1
				var_46_7 = var_46_7 + 1
				table = var_46_14
				...
				local var_46_13 = var_46_14.TimeMgr.GetInstance()

				var_46_14 = var_46_14.GetServerTime(var_46_13)
				var_46_6 = var_46_6 + var_46_2(var_46_14, iter_46_3.finishTime)
			end
		end
		...
		elseif var_46_4 < var_46_6 then
			...
			var_46_14.remove(var_46_8, #var_46_8)
	...
	for iter_46_4, iter_46_5 in var_11(var_46_8) do
		local var_46_16 = iter_46_5.pool

		var_46_15[var_16] = var_46_15[var_16.getRarity(var_46_16)] + 1
	end

	return var_46_6, var_46_5, var_46_7, var_46_15
end
