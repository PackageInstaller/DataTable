...
function var_0_1.GetVoteActivityByConfigId(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_1(var_6_0, var_1_10005.ACTIVITY_TYPE_VOTE)
...
function var_0_1.AnyVoteActIsOpening(arg_11_0)
	...
	local var_11_2 = var_11_1(var_11_0, var_1_10004.ACTIVITY_TYPE_VOTE)
...
function var_0_1.IsAllRaceEnd(arg_15_0)
	...
	local var_15_2 = var_15_0.all

	pg = var_1_10003

	return var_15_2(var_1_10003.activity_vote.all, function(arg_16_0)
		pg = var_2_10001
...
function var_0_1.ExistPastVoteAward(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10003(var_18_1) do
		...
		if var_1_10008.any(iter_18_1, function(arg_19_0)
			...
			local var_19_1 = var_2_10002(var_2_10003)
			local var_19_2 = var_2.getTaskById(var_19_1, var_19_0.task)

			pg = var_19_1

			local var_19_3 = var_19_1.task_data_template[var_19_0.task].award_display[1]
			local var_19_4 = var_18_2
			local var_19_5 = var_4.getAttireFrame

			AttireConst = var_2_10006

			local var_19_6 = var_19_5(var_19_4, var_2_10006.TYPE_ICON_FRAME, var_19_3[2])
			local var_19_7
...
function var_0_1.IsNewRace(arg_20_0, arg_20_1)
	...
	return var_20_0.GetInt(arg_20_1.configId .. "_vote__tip_" .. var_20_1, 0) == 0
end
...
function var_0_1.MarkRaceNonNew(arg_21_0, arg_21_1)
	if arg_21_1 then
		...
		if not arg_21_0.IsNewRace(var_1_10003, arg_21_1) then
			return
		end
		...
		local var_21_2 = var_21_0.SetInt(arg_21_1.configId .. "_vote__tip_" .. var_21_1, 1)
