...
function var_0_1.saveNewEmojiIDList(arg_6_0)
	...
	local var_6_1 = var_2(var_3)
	local var_6_2 = var_2.getRawData(var_6_1).id

	PlayerPrefs = var_6_1

	local var_6_3 = var_6_1.SetString
	local var_6_4 = var_0_1.NEW_EMOJI_SAVE_TAG .. var_6_2

	table = var_5

	var_6_3(var_6_4, var_5.concat(var_6_0, ":"))
...
function var_0_1.loadNewEmojiIDList(arg_7_0)
	...
	local var_7_0 = var_1(var_1_10002)
	local var_7_1 = var_1.getRawData(var_7_0).id

	string = var_7_0

	local var_7_2 = var_7_0.split

	PlayerPrefs = var_1_10003

	local var_7_3

	if not var_1_10003.GetString(var_0_1.NEW_EMOJI_SAVE_TAG .. var_7_1) then
		var_7_3 = ""
	end
	...
	if #var_7_2(var_7_3, ":") > 0 then
		...
		for iter_7_0, iter_7_1 in var_3(var_2) do
			...
			var_1_10008(var_7_4, var_1_10010(iter_7_1))
		end
	end
...
function var_0_1.removeNewEmojiID(arg_9_0, arg_9_1)
	...
	if not var_1_10002.indexof(arg_9_0._newIDList, arg_9_1, 1) then
		...
		var_3(false, "new emoji list does not exit this emojiID:" .. arg_9_1)
	else
		table = var_3

		var_3.remove(arg_9_0._newIDList, var_2)
	end
...
function var_0_1.getExEmojiDataByType(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_1_10003(arg_12_0._emojiIDList) do
		...
		if not var_1_10008.contains(arg_12_0._newIDList, iter_12_1) then
			...
			if var_9.contains(var_1_10008.type, arg_12_1) then
				table = var_9

				var_9.insert(var_12_0, var_1_10008)
			end
		end
	end
