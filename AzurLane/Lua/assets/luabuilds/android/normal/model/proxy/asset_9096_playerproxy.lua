...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(11000, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003.TIME_SYNCHRONIZATION, arg_2_0)
	...
	arg_1_0:on(11003, function(arg_3_0)
		...
		var_3_5(var_3_7 .. var_4.GetDaysFromRegister(var_3_8))
		...
		if var_2.GetDaysFromRegister(var_3_9) == 1 then
			...
			TRACKING_2D_RETENTION = var_4

			var_3_11(var_3_10, var_4)
		else
			...
			if var_2.GetDaysFromRegister(var_3_12) == 6 then
				...
				TRACKING_7D_RETENTION = var_4

				var_3_14(var_3_13, var_4)
			end
		end
		...
		local var_3_17 = var_4.TYPE_COMBAT_UI_STYLE
		local var_3_18
	...
	arg_1_0:on(10999, function(arg_5_0)
		...
		if var_5_0 == var_2_10002 then
			...
			var_5_0(var_2_10002).lastRequestVersionTime = nil
		else
			...
			var_5_2(var_5_1, var_2_10003.LOGOUT, {
				code = arg_5_0.reason
			})
		end
	...
	arg_1_0:on(11503, function(arg_7_0)
		...
		var_7_2(var_7_1, var_4.CHARGE_SUCCESS, {
...
function var_0_1.updatePlayer(arg_14_0, arg_14_1)
	...
	var_1_10002(var_1_10003(var_14_0, var_1_10005), "should be an instance of Player")
	...
	if arg_14_0.data then
		...
		var_14_2(var_14_1, var_4.ON_PLAYER_RES_CHANGE, {
...
function var_0_1.IsShowCommssionTip(arg_25_0)
	...
	local var_25_2 = var_25_0(var_1_10004)
	...
	local var_25_10 = var_25_6:GetEffectAttrs()
	local var_25_11 = 0

	ipairs = var_1_10013

	for iter_25_0, iter_25_1 in var_1_10013(var_25_10) do
		if iter_25_1.attrName == "stock" then
			var_25_11 = iter_25_1.value
		end
	end

	NotifyTipHelper = var_13

	local var_25_12 = var_13.ShouldShowUrTip()
	local var_25_13 = var_25_2:getStudents()
	local var_25_14 = 0

	_ = iter_25_0

	local var_25_15 = iter_25_0.each

	_ = iter_25_1

	var_25_15(iter_25_1.values(var_25_13), function(arg_26_0)
		local var_26_0 = arg_26_0
		local var_26_1 = arg_26_0.getFinishTime(var_26_0)

		pg = var_26_0

		local var_26_2 = var_26_0.TimeMgr.GetInstance()

		if var_26_1 <= var_2.GetServerTime(var_26_2) then
	...
	local var_25_17 = var_17.each

	getProxy = var_18
	TechnologyProxy = var_1_10019

	local var_25_18 = var_18(var_1_10019)

	var_25_17(var_18.getPlanningTechnologys(var_25_18), function(arg_27_0)
	...
	WorldBossConst = var_25_17

	local var_25_19 = var_25_17.GetCommissionSceneMetaBossBtnState()

	CommissionMetaBossBtn = var_18

	local var_25_20

	if var_18.STATE_GET_AWARDS ~= var_25_19 then
		CommissionMetaBossBtn = var_18

		if var_18.STATE_FINSH_BATTLE ~= var_25_19 then
			var_25_20 = false
	...
	local var_25_21 = var_19(var_1_10020)
	local var_25_22 = var_19.getAliveActivityByType

	ActivityConst = var_1_10021

	local var_25_23 = var_25_22(var_25_21, var_1_10021.ACTIVITY_TYPE_PT_CRUSING)
	local var_25_24 = false

	if var_25_23 and not var_25_23:isEnd() then
		var_25_24 = #var_25_23:GetCrusingUnreceiveAward() > 0
	end

	return var_25_20 or var_25_1 or var_25_7 or var_25_8 or var_25_11 ~= 0 and var_25_9 > var_25_11 - 10 or var_25_12 or var_25_14 > 0 or var_25_16 > 0 or var_25_24
end
