...
ActivityConst = var_2
var_0_2[1] = var_2.ACTIVITY_TYPE_PT_OTHER
...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(20201, function(arg_2_0)
		...
		for iter_2_0, iter_2_1 in var_1(arg_2_0.info) do
			...
			if var_2_10010(var_2_10011.avatar_task_type, var_2_10009) then
				getProxy = var_2_10010
				AvatarFrameProxy = var_2_10011
				var_2_10011 = var_2_10010(var_2_10011)

				var_2_10010.initListData(var_2_10011, var_2_2, var_2_3, var_2_4)
			else
				table = var_2_10010
				var_2_10010 = var_2_10010.contains
				TotalTaskProxy = var_2_10011

				if var_2_10010(var_2_10011.activity_task_type, var_2_10009) then
					getProxy = var_2_10010
					ActivityTaskProxy = var_2_10011
					var_2_10011 = var_2_10010(var_2_10011)

					var_2_10010.initActList(var_2_10011, var_2_2, var_2_3, var_2_4)
				else
					table = var_2_10010
					var_2_10010 = var_2_10010.contains
					TotalTaskProxy = var_2_10011

					if var_2_10010(var_2_10011.normal_task_type, var_2_10009) then
						getProxy = var_2_10010
						TaskProxy = var_2_10011
						var_2_10011 = var_2_10010(var_2_10011)

						var_2_10010.initActData(var_2_10011, var_2_2, var_2_3, var_2_4)
					end
				end
			end
		end
	...
	arg_1_0:on(20202, function(arg_3_0)
		...
		for iter_3_0, iter_3_1 in var_2_10001(arg_3_0.info) do
			...
			TotalTaskProxy = var_2_10010

			if var_2_10009(var_2_10010.avatar_task_type, var_2_10008) then
				getProxy = var_2_10009
				AvatarFrameProxy = var_2_10010
				var_2_10010 = var_2_10009(var_2_10010)

				var_2_10009.update(var_2_10010, var_3_0, var_3_1)
			else
				table = var_2_10009
				var_2_10009 = var_2_10009.contains
				TotalTaskProxy = var_2_10010

				if var_2_10009(var_2_10010.activity_task_type, var_2_10008) then
					getProxy = var_2_10009
					ActivityTaskProxy = var_2_10010
					var_2_10010 = var_2_10009(var_2_10010)

					var_2_10009.updateActList(var_2_10010, var_3_0, var_3_1)
				else
					table = var_2_10009
					var_2_10009 = var_2_10009.contains
					TotalTaskProxy = var_2_10010

					if var_2_10009(var_2_10010.normal_task_type, var_2_10008) then
						getProxy = var_2_10009
						TaskProxy = var_2_10010
						var_2_10010 = var_2_10009(var_2_10010)

						var_2_10009.updateActProgress(var_2_10010, var_3_0, var_3_1)
					end
				end
			end
			...
			var_2_10010 = var_2_10009(var_2_10010)
			var_2_10009 = var_2_10009.getActivityById(var_2_10010, var_3_0)

			local var_3_2 = arg_1_0

			var_2_10010 = var_2_10010.sendNotification
			ActivityProxy = var_2_10012

			var_2_10010(var_3_2, var_2_10012.ACTIVITY_UPDATED, var_2_10009:clone())
		end
		...
		var_3_4(var_3_3, var_3.TOTAL_TASK_UPDATED)
	...
	arg_1_0:on(20203, function(arg_4_0)
		...
		for iter_4_0, iter_4_1 in var_2_10001(arg_4_0.info) do
			...
			if var_2_10009(var_2_10010.avatar_task_type, var_2_10008) then
				...
				var_2_10009.addData(var_2_10010, var_4_0, var_4_1)
			else
				table = var_2_10009
				var_2_10009 = var_2_10009.contains
				TotalTaskProxy = var_2_10010
				...
				if var_2_10009(var_2_10010.activity_task_type, var_2_10008) then
					...
					var_2_10009.addActList(var_2_10010, var_4_0, var_4_1)
				else
					table = var_2_10009
					var_2_10009 = var_2_10009.contains
					TotalTaskProxy = var_2_10010
					...
					if var_2_10009(var_2_10010.normal_task_type, var_2_10008) then
						...
						var_2_10009.addActData(var_2_10010, var_4_0, var_4_1)
					end
				end
			end
			...
			ActivityProxy = var_2_10010
			var_2_10010 = var_2_10009(var_2_10010)
			var_2_10009 = var_2_10009.getActivityById(var_2_10010, var_4_0)
			...
			var_2_10010(var_4_2, var_2_10012.ACTIVITY_UPDATED, var_2_10009:clone())
		end

		local var_4_3 = arg_1_0.facade
		local var_4_4 = var_1.sendNotification

		GAME = var_3

		var_4_4(var_4_3, var_3.TOTAL_TASK_UPDATED)
	...
	arg_1_0:on(20204, function(arg_5_0)
		...
		for iter_5_0, iter_5_1 in var_2_10001(arg_5_0.info) do
			...
			if var_2_10009(var_2_10010.avatar_task_type, var_2_10008) then
				...
				var_2_10009.removeData(var_2_10010, var_5_0, var_5_1)
			else
				table = var_2_10009
				var_2_10009 = var_2_10009.contains
				TotalTaskProxy = var_2_10010
				...
				if var_2_10009(var_2_10010.activity_task_type, var_2_10008) then
					...
					var_2_10009.removeActList(var_2_10010, var_5_0, var_5_1)
				else
					table = var_2_10009
					var_2_10009 = var_2_10009.contains
					TotalTaskProxy = var_2_10010
					...
					if var_2_10009(var_2_10010.normal_task_type, var_2_10008) then
						...
						var_2_10009.removeActData(var_2_10010, var_5_0, var_5_1)
					end
				end
			end
			...
			ActivityProxy = var_2_10010
			var_2_10010 = var_2_10009(var_2_10010)
			var_2_10009 = var_2_10009.getActivityById(var_2_10010, var_5_0)
			...
			var_2_10010(var_5_2, var_2_10012.ACTIVITY_UPDATED, var_2_10009:clone())
		end

		local var_5_3 = arg_1_0.facade
		local var_5_4 = var_1.sendNotification

		GAME = var_3

		var_5_4(var_5_3, var_3.TOTAL_TASK_UPDATED)
