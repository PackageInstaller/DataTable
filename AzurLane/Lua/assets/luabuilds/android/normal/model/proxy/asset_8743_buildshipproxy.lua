...
function var_0_1.GetPools(arg_3_0)
	...
	var_3_4[1] = var_1_10007.ACTIVITY_TYPE_BUILDSHIP_1
	ActivityConst = var_7
	var_3_4[2] = var_7.ACTIVITY_TYPE_NEWSERVER_BUILD
	...
	for iter_3_0, iter_3_1 in var_1_10003(var_3_3(var_3_2, var_3_4)) do
		...
		var_1_10009.insert(var_3_5, function(arg_4_0)
			if iter_3_1 then
		...
		var_1_10009.insert(var_3_5, function(arg_5_0)
			pg = var_2_10001
			...
			if var_5_2 == var_5_1.ACTIVITY_TYPE_NEWSERVER_BUILD and iter_3_1.data2 >= var_5_0.exchange_available_times then
				-- block empty
			else
				arg_5_0()
			end
		...
		var_1_10009(var_3_5, function()
			table = var_2_10000

			local var_6_0 = var_2_10000.insert
			local var_6_1 = var_3_0

			BuildShipActivityPool = var_2_10002
			...
			var_6_3.id = var_4.getConfig(var_6_4, "config_id")
			BuildShipPool = var_4
			var_6_3.mark = var_4.BUILD_POOL_MARK_NEW
	...
	local var_3_8 = var_5.New
	local var_3_9 = {
		id = 2
	}

	BuildShipPool = iter_3_1
	var_3_9.mark = iter_3_1.BUILD_POOL_MARK_LIGHT
	...
	local var_3_12 = var_5.New
	local var_3_13 = {
		id = 3
	}

	BuildShipPool = var_7
	var_3_13.mark = var_7.BUILD_POOL_MARK_HEAVY
	...
	local var_3_16 = var_5.New
	local var_3_17 = {
		id = 1
	}

	BuildShipPool = var_7
	var_3_17.mark = var_7.BUILD_POOL_MARK_SPECIAL
...
function var_0_1.GetPoolsWithoutNewServer(arg_7_0)
	...
	local var_7_1 = arg_7_0.GetPools(var_7_0)

	_ = var_7_0

	return var_7_0.select(var_7_1, function(arg_8_0)
		local var_8_0
...
function var_0_1.setBuildShipState(arg_9_0)
	...
	arg_9_0.removeBuildTimer(var_9_0)
	...
	for iter_9_0, iter_9_1 in var_9_0(var_9_2) do
		if var_9_1 == arg_9_0:getMaxWorkCount() then
			break
		end
		...
		if iter_9_1:isFinish() then
			...
			if not var_9_3.FINISH then
				BuildShip = var_9_3
				var_9_3 = var_9_3.ACTIVE
			end

			iter_9_1.state = var_9_3
		end
	end
...
function var_0_1.addBuildTimer(arg_12_0)
	...
	if arg_12_0.buildTimers[var_12_0] then
		local var_12_1 = arg_12_0.buildTimers[var_12_0]
	...
	local var_12_3 = arg_12_0.data[var_12_0].finishTime

	pg = var_1_10004

	local var_12_4 = var_1_10004.TimeMgr.GetInstance()

	if var_12_3 - var_4.GetServerTime(var_12_4) > 0 then
		local var_12_5 = arg_12_0.buildTimers

		Timer = var_12_4
		var_12_5[var_12_0] = var_12_4.New(function()
		...
		local var_12_6 = arg_12_0.buildTimers[var_12_0]

		var_4.Start(var_12_6)
	else
		var_12_2()
	end
...
function var_0_1.canBuildShip(arg_24_0, arg_24_1)
	...
	local var_24_2 = var_24_0.ship_data_create_material[arg_24_1]

	getProxy = var_1_10004
	BagProxy = var_1_10005

	local var_24_3 = var_1_10004(var_1_10005)

	if var_4.getItemById(var_24_3, var_24_2.use_item) then
		local var_24_4 = var_5.count

		if var_24_2.number_1 <= var_24_4 then
			getProxy = var_24_4
			PlayerProxy = var_7

			local var_24_5 = var_24_4(var_7)

			return var_6.getData(var_24_5).gold >= var_24_2.use_gold and var_24_1 == 0
		end
	end
...
function var_0_1.addBuildShip(arg_28_0, arg_28_1)
	...
	BuildShip = var_1_10005

	var_1_10002(var_1_10003(var_28_0, var_1_10005), "should be an instance of BuildShip")

	table = var_1_10002

	var_1_10002.insert(arg_28_0.data, arg_28_1)

	local var_28_1 = arg_28_0:getActiveCount()
	local var_28_2 = arg_28_0

	if var_28_1 < arg_28_0.getMaxWorkCount(var_28_2) then
		local var_28_3 = arg_28_1

		var_28_2 = arg_28_1.setState
		BuildShip = var_1_10006

		var_28_2(var_28_3, var_1_10006.ACTIVE)

		arg_28_0.buildIndex = #arg_28_0.data

		arg_28_0:addBuildTimer()
	elseif var_28_1 == var_3 then
		local var_28_4 = arg_28_1

		var_28_2 = arg_28_1.setState
		BuildShip = var_1_10006

		var_28_2(var_28_4, var_1_10006.INACTIVE)
	else
		assert = var_28_2

		var_28_2(false, "激活的建船数量大于最大数量")
	end
...
function var_0_1.updateBuildShip(arg_30_0, arg_30_1, arg_30_2)
	...
	var_1_10003(var_1_10004(var_30_0, var_1_10006), "should be an instance of BuildShip")
...
function var_0_1.removeBuildShipByIndex(arg_31_0, arg_31_1)
	...
	var_31_0(var_31_1 ~= nil, "buildShip should exist")
...
function var_0_1.changeRegularExchangeCount(arg_36_0, arg_36_1)
	...
	local var_36_3 = var_1_10005.ship_data_create_exchange

	REGULAR_BUILD_POOL_EXCHANGE_ID = var_1_10006
	arg_36_0.regularExchangeCount = var_36_0(var_36_1, var_36_2, var_36_3[var_1_10006].exchange_request)
