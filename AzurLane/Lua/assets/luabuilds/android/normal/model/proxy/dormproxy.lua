...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(19001, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003.GET_BACKYARD_DATA, {
			isMine = true,
			data = arg_2_0
		})
...
function var_0_1.SettlementShipExp(arg_5_0)
	...
	if var_1.ShouldRequestShipExp(var_5_0) then
		...
		var_5_2(var_5_1, var_1_10005.BACKYARD_REQUEST_SHIP_EXP)
	else
...
function var_0_1.RequestShipExp(arg_6_0)
	...
	Timer = var_1_10005
	arg_6_0.requestShipExpTimer = var_1_10005.New(function()
		...
		var_7_2(var_7_1, var_2_10002.BACKYARD_REQUEST_SHIP_EXP)
...
function var_0_1.RequestPopEvent(arg_9_0)
	...
	arg_9_0.ClearRequestPopEvent(var_9_0)

	pg = var_1

	local var_9_1 = var_1.gameset.dorm_pop_time.key_value

	Timer = var_9_0
	arg_9_0.requestEventTimer = var_9_0.New(function()
		local var_10_0 = arg_9_0
		local var_10_1 = var_0.sendNotification

		GAME = var_2_10002

		var_10_1(var_10_0, var_2_10002.BACKYARD_REQUEST_POP_EVENT)

		return
	end, var_9_1, -1)

	local var_9_2 = arg_9_0.requestEventTimer
...
function var_0_1.addDorm(arg_14_0, arg_14_1)
	...
	var_1_10002(var_1_10003(var_14_0, var_1_10005), "dorm should instance of Dorm")
...
function var_0_1.updateDrom(arg_15_0, arg_15_1, arg_15_2)
	...
	var_1_10003(var_1_10004(var_15_0, var_1_10006), "dorm should instance of Dorm")
...
function var_0_1.UpdateCustomThemeTemplate(arg_20_0, arg_20_1)
	...
	var_20_3.type = var_1_10006.THEME_TEMPLATE_TYPE_CUSTOM
...
function var_0_1.UpdateShopThemeTemplate(arg_28_0, arg_28_1)
	...
	BackYardConst = var_1_10006
	var_28_3.type = var_1_10006.THEME_TEMPLATE_TYPE_SHOP
...
function var_0_1.UpdateCollectionThemeTemplate(arg_36_0, arg_36_1)
	...
	BackYardConst = var_1_10006
	var_36_3.type = var_1_10006.THEME_TEMPLATE_TYPE_COLLECTION
...
function var_0_1.GetTemplateNewID(arg_37_0)
	...
	local var_37_1 = var_1_10002.values
	local var_37_2
	...
	if not arg_39_0.systemThemes or #arg_39_0.systemThemes == 0 then
		...
		for iter_39_0, iter_39_1 in var_1_10002(var_39_0.all) do
			if var_39_0[iter_39_1].is_view == 1 then
				...
				var_8.insert(arg_39_0.systemThemes, var_39_1)
			end
		end
	end
...
function var_0_1.NeedCollectionTip(arg_42_0)
	...
	local var_42_0 = var_1_10001(var_1_10002)
	local var_42_1 = var_1.getRawData(var_42_0).id

	PlayerPrefs = var_42_0

	local var_42_2 = var_42_0.GetInt("backyard_template" .. var_42_1, 0)
	local var_42_3 = arg_42_0

	if arg_42_0.GetThemeTemplateCollectionCnt(var_42_3) ~= var_42_2 then
		PlayerPrefs = var_42_3

		var_42_3.SetInt("backyard_template" .. var_42_1, var_3)
...
function var_0_1.NeedShopShowHelp(arg_43_0)
	...
	local var_43_2 = var_43_0.GetInt("backyard_template_help" .. var_43_1, 0)
...
function var_0_1.IsShowRedDot(arg_45_0)
	...
	local var_45_2 = var_45_0.SystemOpenMgr.GetInstance()
	local var_45_3 = var_2.isOpenSystem(var_45_2, var_45_1.level, "CourtYardMediator")

	getProxy = var_45_2
	DormProxy = var_4

	local var_45_4 = var_45_2(var_4)
	local var_45_5 = var_3.getRawData(var_45_4)
	local var_45_6 = var_4.IsLackOfFood(var_45_5)
	local var_45_7 = var_4
	local var_45_8 = var_4.AnyShipExistIntimacyOrMoney(var_45_7)

	if var_45_3 and not var_45_6 and not var_45_8 then
		::label_45_2::

		getProxy = var_45_7
		SettingsProxy = var_1_10008

		local var_45_9 = var_45_7(var_1_10008)

		if not var_45_7.IsTipNewTheme(var_45_9) then
			getProxy = var_45_7
			SettingsProxy = var_45_9

			local var_45_10 = var_45_7(var_45_9)

			var_45_7 = var_45_7.IsTipNewGemFurniture(var_45_10)
		end
	end
