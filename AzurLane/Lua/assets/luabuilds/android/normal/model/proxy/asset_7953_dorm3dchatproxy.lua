...
local var_0_2 = var_0_0.dorm3d_ins_chat_group
...
function var_0_1.CreateChat(arg_3_0, arg_3_1)
	...
	var_3.insert(arg_3_0.chatList, var_3_0)
...
function var_0_1.UpdateTopicDisplayWordList(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	if arg_12_0.GetTopicById(var_12_0, arg_12_1) then
		table = var_12_0

		var_12_0.insert(var_4.replyList, {
			key = arg_12_2,
			value = arg_12_3
		})
...
function var_0_1.TriggerEvent(arg_19_0, arg_19_1)
	...
	local var_19_2 = var_1_10004.APARTMENT_CHAT_OP
	local var_19_3 = {}

	Dorm3dChatProxy = var_1_10006
	var_19_3.operation = var_1_10006.APARTMENT_CHAT_TRIGGER_EVENT
...
function var_0_1.SetChatCare(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_2 = var_1_10005.APARTMENT_CHAT_OP
	local var_21_3 = {}

	Dorm3dChatProxy = var_1_10007
	var_21_3.operation = var_1_10007.APARTMENT_CHAT_SET_CARE
	...
	if arg_22_1 then
		if arg_22_1.currentTopic then
			...
			if var_2.IsCompleted(var_22_0) then
				...
				local var_22_2 = arg_22_1.GetTopicsSortByActivateTime(var_22_1)
				...
				for iter_22_0, iter_22_1 in var_22_1(var_22_2) do
					if iter_22_1.active and not iter_22_1:IsCompleted() then
						...
						local var_22_4 = arg_22_0.sendNotification

						GAME = var_1_10010
						var_1_10010 = var_1_10010.APARTMENT_CHAT_OP

						local var_22_5 = {}

						Dorm3dChatProxy = var_1_10012
						var_22_5.operation = var_1_10012.APARTMENT_CHAT_SET_TOPIC
						var_22_5.characterId = arg_22_1.characterId
						var_22_5.topicId = iter_22_1.topicId

						var_22_4(var_22_3, var_1_10010, var_22_5)
