...
local var_0_7 = var_6(var_0_6, var_0_10008(".NetProxy"))
...
function var_0_7.register(arg_13_0)
	...
	arg_13_0:on(23096, function(arg_15_0)
		if arg_15_0.reason == 1 then
			...
			var_15_0(var_2_10002, var_2_10003("match_ui_room_out"))
		end
		...
		if arg_13_0.roomData then
			...
			if var_15_1 == var_2_10002.PLAY_ROOM_TYPE.MATCH then
				...
				if arg_13_0.matchReadyRoom == nil then
					...
					var_1.ExitRoom(var_15_2)
				else
					local var_15_3 = arg_13_0.matchReadyRoom.readyList

					getProxy = var_15_2
					PlayerProxy = var_2_10003
					var_2_10003 = var_15_2(var_2_10003)

					local var_15_4 = var_2.getPlayerId(var_2_10003)

					table = var_2_10003
					var_2_10003 = var_2_10003.keyof(var_15_3, var_15_4)

					local var_15_5 = arg_13_0.matchReadyRoom.endTimestamp
					local var_15_6 = arg_13_0

					var_5.ExitMatchReadyRoom(var_15_6)

					if arg_13_0.matchStartTime then
						pg = var_5

						local var_15_7 = var_5.TimeMgr.GetInstance()
						local var_15_8 = var_5.GetServerTime(var_15_7) - arg_13_0.matchStartTime

						pg = var_6
						var_2_10007 = var_6.GameTrackerMgr.GetInstance()

						local var_15_9 = var_6.Record

						GameTrackerBuilder = var_2_10008

						var_15_9(var_2_10007, var_2_10008.BuildPlayRoomMatch("bar", 2, 1, var_15_8, 2))

						arg_13_0.matchStartTime = nil
					end

					local var_15_10 = arg_13_0
					local var_15_11 = var_5.sendNotification

					GAME = var_2_10007

					var_15_11(var_15_10, var_2_10007.PLAY_ROOM_EXIT_MATCH_READY_ROOM)

					if arg_15_0.reason == 3 then
						local var_15_12 = arg_13_0
						local var_15_13 = var_5.sendNotification

						GAME = var_7

						local var_15_14 = var_7.PLAY_ROOM_CREATE_ROOM
						local var_15_15 = {}

						PlayRoomConst = var_2_10009
						var_15_15.type = var_2_10009.PLAY_ROOM_TYPE.MATCH
						var_15_15.gameType = arg_13_0.roomData.gameType

						var_15_13(var_15_12, var_15_14, var_15_15)

						local var_15_16 = arg_13_0
						local var_15_17 = var_5.sendNotification

						GAME = var_15_14

						var_15_17(var_15_16, var_15_14.PLAY_ROOM_START_GAME)
					else
						local var_15_18 = arg_13_0

						var_5.ExitRoom(var_15_18)
					end
				end
		...
		do
			...
			var_1.ExitRoom(var_15_19)

			local var_15_20 = arg_13_0
			local var_15_21 = var_1.sendNotification

			GAME = var_2_10003

			var_15_21(var_15_20, var_2_10003.PLAY_ROOM_EXIT_ROOM_DONE)
		end
...
function var_0_7.UpdateRoomData(arg_22_0, arg_22_1)
	...
	if not arg_22_0.isPlayingGame then
		...
		var_22_2(var_22_1, var_4.PLAY_ROOM_REDAY_ROOM_REFRESH)
	end
...
function var_0_7.ExitRoom(arg_24_0)
	...
	if arg_24_0.matchStartTime then
		...
		var_24_3(var_24_2, var_1_10004.BuildPlayRoomMatch("bar", 2, 1, var_24_1, 1))
...
function var_0_7.AddInviteList(arg_27_0, arg_27_1)
	...
	if arg_27_0.roomData then
		...
		var_27_1(var_27_0, var_1_10004.BuildPlayRoomInvate("bar", arg_27_1.invitor.id, 3))
	...
	var_27_4.timestamp = var_5.GetServerTime(var_27_5)
...
function var_0_7.AddInviteRecord(arg_31_0, arg_31_1)
	...
	local var_31_3 = var_1_10005.TimeMgr.GetInstance()

	var_31_2.timestamp = var_5.GetServerTime(var_31_3)
...
function var_0_7.UpdateMatchRoomData(arg_36_0, arg_36_1)
	...
	if arg_36_0.matchReadyRoom == nil then
		...
		if arg_36_0.matchStartTime then
			...
			var_36_4(var_36_3, var_1_10006.BuildPlayRoomMatch("bar", 2, 1, var_36_2, 3))
	...
	if var_36_0 then
		...
		var_36_7(var_36_6, var_5.PLAY_ROOM_MATCH_ENTER_READY_ROOM)
	else
		...
		var_36_9(var_36_8, var_5.PLAY_ROOM_MATCH_REDAY_ROOM_REFRESH)
	end
...
function var_0_7.GetMatchFlag(arg_41_0)
	if arg_41_0.matchReadyRoom == nil then
		...
		local var_41_1 = arg_41_0.GetMatchTime(var_41_0)
		...
		if not (var_41_1 >= var_2.GetServerTime(var_41_2)) then
			var_41_3 = false
		else
			var_41_3 = true
		end
...
function var_0_7.RefreshMatchTime(arg_42_0)
	...
	pg = var_42_0
	arg_42_0.matchEndTime = var_42_1 + var_42_0.gameset.level_get_proficency.key_value
...
function var_0_7.UpdateGameLoadData(arg_47_0, arg_47_1)
	...
	if var_47_0 and arg_47_0.roomData then
		...
		PlayRoomConst = var_47_1
		var_47_2.roomState = var_47_1.PLAY_ROOM_STATE.PLAYING
		...
		var_47_4(var_47_3, var_5.PLAY_ROOM_CLOSE_MATCH_READY)
		...
		var_47_6(var_47_5, var_5.PLAY_ROOM_ENTER_LOAD)
	end
	...
	if arg_47_0.gameLoadData.isAllLoadOver then
		...
		var_47_8(var_47_7, var_5.PLAY_ROOM_ALL_LOAD_OVER)
...
function var_0_7.AddChatMsg(arg_50_0, arg_50_1)
	...
	local var_50_2 = var_50_0(var_50_1, var_1_10004.New(arg_50_1.player))
	...
	local var_50_4 = var_50_3(var_4.ChannelPlayRoom, var_50_2)
	...
	var_50_6(var_50_5, var_6.CHAT_MSG_UPDATE, {
		msg = var_50_4
	})
...
function var_0_7.UpdateRankData(arg_53_0, arg_53_1, arg_53_2)
	...
	local var_53_1 = var_53_0(var_4)
	local var_53_2 = var_3.getPlayerId(var_53_1)

	ipairs = var_53_1

	for iter_53_0, iter_53_1 in var_53_1(arg_53_2.rank_list) do
