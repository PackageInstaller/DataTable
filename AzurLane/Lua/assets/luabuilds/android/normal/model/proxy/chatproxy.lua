	...
	for iter_1_0 = 1, #arg_1_1.args do
		...
		if var_1_4 == var_1_10011.TypePlayerName then
			...
			if var_1_4 == var_1_10011.TypeShipId then
				...
				local var_1_6 = var_12(var_1_5, var_1_10014(var_1_4.type))

				var_1_10014 = arg_1_0

				arg_1_0.AddSprite(var_1_10014, var_1_10011, var_1_6)

				local var_1_7 = "shipcolor" .. iter_1_0

				string = var_1_10014
				var_1_10014 = var_1_10014.gsub

				local var_1_8 = var_1_1
				local var_1_9 = var_1_7

				ItemRarity = var_1_10017
				var_1_1 = var_1_10014(var_1_8, var_1_9, var_1_10017.Rarity2HexColor(var_1_4.rarity - 1))
				...
				if arg_1_2 then
					...
					if var_1_8 == var_1_9 then
						contentWrap = var_1_8
						var_1_10014, var_1_3 = var_1_8(var_1_3, 18, 1.65)
					end
...
function var_0_1.InjectPublicMsg(arg_2_0, arg_2_1)
	...
	local var_2_3 = var_1_10005.gsub
	local var_2_4 = var_2_1

	ChatConst = var_1_10007

	var_2_3(var_2_4, var_1_10007.EmojiCodeMatch, function(arg_3_0)
...
function var_0_1.register(arg_4_0)
	arg_4_0:on(50101, function(arg_5_0)
		...
		if var_5_0 == var_2_10002.CODE_BANED then
			pg = var_5_0
			var_5_1 = var_5_0.TipsMgr.GetInstance()
			...
			if var_5_2 == var_5_1.CODE_ACTOBSS_MSG_WORD then
				local var_5_3 = {
				...
				var_5_4(var_2_10003, var_2_10004.ACTIVITY_BOSS_MSG_ADDED, var_5_3)

				table = var_5_4

				var_5_4.insert(arg_4_0.actBossMsg, var_5_3)

				local var_5_5 = #arg_4_0.actBossMsg

				if 6 < var_5_5 then
					table = var_5_5

					var_5_5.remove(arg_4_0.actBossMsg, 1)
				end
			else
				local var_5_6 = var_0_1.InjectPublicMsg
				local var_5_7 = arg_5_0.content

				Player = var_2_10003

				local var_5_8 = var_5_6(var_5_7, var_2_10003.New(arg_5_0.player))
				local var_5_9 = arg_4_0
				local var_5_10 = var_2.addNewMsg

				ChatMsg = var_4

				local var_5_11 = var_4.New

				ChatConst = var_2_10005

				var_5_10(var_5_9, var_5_11(var_2_10005.ChannelWorld, var_5_8))
			end
		end
	...
	arg_4_0:on(50103, function(arg_6_0)
		...
		for iter_6_0, iter_6_1 in var_2_10002(arg_6_0.arg_list) do
			...
			PublicArg = var_2_10009

			var_2_10007(var_6_1, var_2_10009.New(iter_6_1))
		end
		...
		local var_6_6 = iter_6_0.New

		ChatConst = iter_6_1

		var_6_5(var_6_4, var_6_6(iter_6_1.ChannelPublic, var_6_2))
...
function var_0_1.loadUsedEmoji(arg_13_0)
	...
	local var_13_2 = var_13_0.split

	PlayerPrefs = var_1_10003

	local var_13_3 = var_1_10003.GetString

	ChatConst = var_1_10004

	local var_13_4

	if not var_13_3(var_1_10004.EMOJI_SAVE_TAG .. var_13_1) then
		var_13_4 = ""
	end
...
function var_0_1.saveUsedEmoji(arg_15_0)
	...
	local var_15_1 = var_2(var_3)
	local var_15_2 = var_2.getRawData(var_15_1).id

	PlayerPrefs = var_15_1

	local var_15_3 = var_15_1.SetString

	ChatConst = var_4

	local var_15_4 = var_4.EMOJI_SAVE_TAG .. var_15_2

	table = var_5

	var_15_3(var_15_4, var_5.concat(var_15_0, ":"))
...
function var_0_1.loadUsedEmojiIcon(arg_18_0)
	...
	local var_18_1 = var_1(var_2)
	local var_18_2 = var_1.getRawData(var_18_1).id

	string = var_18_1

	local var_18_3 = var_18_1.split

	PlayerPrefs = var_3

	local var_18_4 = var_3.GetString

	ChatConst = iter_18_0

	local var_18_5

	if not var_18_4(iter_18_0.EMOJI_ICON_SAVE_TAG .. var_18_2) then
		var_18_5 = ""
	end
...
function var_0_1.saveUsedEmojiIcon(arg_19_0)
	...
	local var_19_3 = var_19_1.SetString

	ChatConst = var_4

	local var_19_4 = var_4.EMOJI_ICON_SAVE_TAG .. var_19_2

	table = var_5

	var_19_3(var_19_4, var_5.concat(var_19_0, ":"))
...
function var_0_1.addUsedEmojiIcon(arg_21_0, arg_21_1)
	...
	if var_21_0.indexof(var_21_1, arg_21_1, 1) then
		table = var_4

		var_4.remove(var_21_1, var_3)
	else
		table = var_4

		var_4.remove(var_21_1, #var_21_1)
	end

	table = var_4

	var_4.insert(var_21_1, 1, arg_21_1)
...
function var_0_1.GetAllTypeChatMessages(arg_22_0, arg_22_1)
	...
	if not var_1_10003(var_1_10004) then
		return
	end
	...
	var_22_1.each(var_22_2:getCacheMsgList(), function(arg_25_0)
		table = var_2_10001
	...
	local var_22_3 = var_6(var_22_0)
	local var_22_4 = var_6.chain(var_22_3)
	local var_22_5 = var_6.filter(var_22_4, function(arg_26_0)
		local var_26_0 = var_22_2

		return not var_1.isInBlackList(var_26_0, arg_26_0.playerId)
	end)
	local var_22_6 = var_6.sort(var_22_5, function(arg_27_0, arg_27_1)
		return arg_27_0.timestamp < arg_27_1.timestamp
	end)

	var_22_0 = var_6.value(var_22_6)
	NotificationLayer = var_6

	local var_22_7 = var_6.ChannelBits.recv

	bit = var_22_6

	local var_22_8 = var_22_6.lshift
	local var_22_9 = 1

	ChatConst = var_1_10009

	local var_22_10 = var_22_8(var_22_9, var_1_10009.ChannelAll)

	_ = var_22_9
	var_22_0 = var_22_9.filter(var_22_0, function(arg_28_0)
		local var_28_2

		if var_22_7 ~= var_22_10 then
			bit = var_1

			local var_28_0 = var_1.band
			local var_28_1 = var_22_7

			bit = var_2_10003

			if not (var_28_0(var_28_1, var_2_10003.lshift(1, arg_28_0.type)) > 0) then
				var_28_2 = false
