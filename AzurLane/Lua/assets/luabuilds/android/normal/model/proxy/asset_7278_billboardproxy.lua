...
function var_0_1.setPlayerRankData(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_1 = arg_2_0.getHashId(var_2_0, arg_2_1, arg_2_2)

	table = var_2_0

	if var_2_0.contains(var_0_1.NONTIMER, arg_2_1) then
		return
	end

	arg_2_0.playerData[var_2_1] = arg_2_3
...
function var_0_1.setRankList(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if var_4_0.contains(var_0_1.NONTIMER, arg_4_1) then
		return
	end
