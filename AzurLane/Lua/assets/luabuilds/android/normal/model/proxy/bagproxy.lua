...
function var_0_1.hasExtraData(arg_5_0, arg_5_1, arg_5_2)
	...
	var_1_10003(var_1_10004(var_5_0))
...
function var_0_1.addItemById(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	if arg_6_1 == var_1_10004 then
		...
		TRACKING_CUBE_ADD = var_6

		var_6_1(var_6_0, var_6, arg_6_2)
	end
...
function var_0_1.removeItemById(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	if arg_7_1 == var_1_10004 then
		...
		TRACKING_CUBE_CONSUME = var_6

		var_7_1(var_7_0, var_6, arg_7_2)
	end
...
function var_0_1.getItemsByExclude(arg_8_0)
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_0.data) do
		...
		local var_8_2 = iter_8_1.getConfig(var_8_1, "type")

		Item = var_8_1

		if not var_8_1.INVISIBLE_TYPE[var_8_2] then
			local var_8_3 = iter_8_1.count

			if 0 < var_8_3 then
				local var_8_4

				if arg_8_0.extraItemData[iter_8_0] then
					var_8_4 = iter_8_1.count
					ipairs = var_9
					...
					for iter_8_2, iter_8_3 in var_9(arg_8_0.extraItemData[iter_8_0]) do
						...
						var_1_10014(var_8_5, var_1_10016.New({
							count = 1,
							id = iter_8_0,
							extra = iter_8_3
						}))
					...
					if 0 < var_8_4 then
						...
						local var_8_6 = var_9.insert
						local var_8_7 = var_8_0

						Item = var_11

						var_8_6(var_8_7, var_11.New({
							id = iter_8_0,
							count = var_8_4
						}))
					end
					...
					var_8_4.insert(var_8_0, iter_8_1)
				end
			end
		end
	end
...
function var_0_1.getBoxCount(arg_15_0)
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10003.EQUIPMENT_BOX_TYPE_5)

	table = var_15_0

	return var_15_0.getCount(var_15_2)
end
...
function var_0_1.canUpgradeFlagShipEquip(arg_18_0)
	...
	if var_1.getEquipment2ByflagShip(var_18_0) then
		...
		for iter_18_0, iter_18_1 in var_18_0(var_2:getConfig("trans_use_item")) do
...
function var_0_1.GetSkinExperienceItems(arg_27_0)
	...
	local var_27_1 = var_1_10002(var_1_10003)
...
function var_0_1.GetAllLoveLetterItem(arg_28_0)
	...
	local var_28_1 = var_1_10002(var_1_10003)
	local var_28_2 = var_2.GetLoveLetterItemDic(var_28_1)

	pairs = var_28_1

	for iter_28_0, iter_28_1 in var_28_1(arg_28_0.data) do
		assert = var_1_10008
