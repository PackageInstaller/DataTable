...
function var_0_1.ReqDataCheck(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10003(var_1_10004.child2_data.all) do
		table = var_1_10008
		...
		var_1_10008.insert(var_2_0, function(arg_3_0)
			if not arg_2_0.data[iter_2_1] then
				...
				var_3_1(var_3_0, var_2_10003.NEW_EDUCATE_REQUEST, {
					id = iter_2_1,
					callback = arg_3_0
				})
			else
...
function var_0_1.ResetChar(arg_7_0, arg_7_1, arg_7_2)
	...
	NewEducateChar = var_7_1
	var_7_2[arg_7_1] = var_7_1.New(arg_7_2)
...
function var_0_1.RefreshChar(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_2[arg_8_1] = var_1_10005.New(arg_8_2)
...
function var_0_1.AddBuff(arg_12_0, arg_12_1, arg_12_2)
	...
	var_1_10003(var_1_10004.child2_benefit_list[arg_12_1], "child2_benefit_list不存在id" .. arg_12_1)
	...
	NewEducateBuff = var_12_0

	if var_12_1 == var_12_0.TYPE.TALENT then
...
function var_0_1.AddPolaroid(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_4 = var_5.NEW_EDUCATE_TRACK

	NewEducateTrackCommand = var_1_10006

	local var_17_5 = var_1_10006.BuildDataPolariod
	local var_17_6 = arg_17_0.data[arg_17_0.curId]
	local var_17_7 = var_7.GetGameCnt(var_17_6)
	local var_17_8 = arg_17_0.data[arg_17_0.curId]

	var_17_3(var_17_2, var_17_4, var_17_5(var_17_7, var_8.GetRoundData(var_17_8).round, arg_17_1))
...
function var_0_1.Cost(arg_23_0, arg_23_1)
	...
	var_23_1[var_1_10005.DROP_TYPE.ATTR] = function()
	...
	var_23_1[var_5.DROP_TYPE.RES] = function()
