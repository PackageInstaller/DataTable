...
function var_0_1.timeCall(arg_2_0)
	...
	var_2_0[var_1_10002.DayCall] = function(arg_3_0)
		...
		var_3_2(var_3_1, var_3.REFLUX_REQUEST_DATA)
...
function var_0_1.isCanSign(arg_13_0)
	if arg_13_0:isActive() and not arg_13_0.autoActionForbidden then
		...
		local var_13_2 = #var_1_10003.return_sign_template.all
...
function var_0_1.isInRefluxTime(arg_14_0)
	...
	if arg_14_0.isActive(var_14_0) then
		pg = var_1

		local var_14_1 = var_1.TimeMgr.GetInstance()

		pg = var_14_0

		local var_14_2 = #var_14_0.return_sign_template.all

		if arg_14_0.returnTimestamp + var_14_2 * 0 <= var_14_1:GetServerTime() then
			return false
		else
			return true
		end
