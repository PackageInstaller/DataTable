	...
	arg_1_0:on(13001, function(arg_2_0)
		...
		for iter_2_2, iter_2_3 in var_1(arg_2_0.chapter_list) do
			...
			if not var_2_10006.chapter_template[iter_2_3.id] then
				...
				var_2_5(var_2_4, var_2_10010(arg_1_0.mapEliteFleetCache[var_2_3]))
...
function var_0_1.timeCall(arg_4_0)
	...
	var_4_0[var_1_10002.DayCall] = function(arg_5_0)
		...
		for iter_5_0, iter_5_1 in var_5_2(var_5_3) do
...
function var_0_1.OnBattleFinished(arg_6_0, arg_6_1, arg_6_2)
	if arg_6_0:getActiveChapter() then
		...
		local function var_6_1()
			...
			if not var_2_10000(var_2_10001) then
				return
			end

			local var_7_0 = var_0:getCurrentContext().mediator

			LevelMediator2 = var_2_10003

			if var_7_0 == var_2_10003 then
				bit = var_7_0

				local var_7_1 = var_7_0.bor
				local var_7_2 = var_6_0

				ChapterConst = var_2_10004
				var_2_10004 = var_2_10004.DirtyAttachment
				ChapterConst = var_2_10005
				var_6_0 = var_7_1(var_7_2, var_2_10004, var_2_10005.DirtyStrategy)

				local var_7_3 = arg_6_0

				var_2.SetChapterAutoFlag(var_7_3, var_0.id, false)

				return
			end

			local var_7_4 = var_0
			local var_7_5 = var_0.getContextByMediator

			LevelMediator2 = var_2_10004

			if not var_7_5(var_7_4, var_2_10004) then
				return
			end
		...
		if #arg_6_1.map_update > 0 then
					...
					if var_10_1 == var_2.StoryTrigger then
						...
						if var_2.GetChapterCellAttachemnts(var_10_3)[var_10_2] then
							...
							if var_2_10004 == var_2_10005.CellFlagTriggerActive then
								var_2_10004 = arg_10_0.item_flag
								ChapterConst = var_5
								...
								if var_2_10004 == var_5.CellFlagTriggerDisabled then
									...
									if var_2_10004.map_event_template[var_3.attachmentId].gametip ~= "" then
										...
										var_10_5(var_10_4, var_2_10007(var_2_10004))
									end
								end
							end
							...
							var_2[var_10_2] = var_2_10004.New(arg_10_0)
						end
			...
			var_6_0 = var_6_2(var_6_3, var_6_4, var_1_10009.DirtyAutoAction)
		end
		...
		if #arg_6_1.ai_list > 0 then
			...
			ChapterConst = var_1_10009
			var_6_0 = var_6_5(var_6_6, var_6_4, var_1_10009.DirtyAutoAction)
		end
		...
		if #arg_6_1.add_flag_list > 0 or #arg_6_1.del_flag_list > 0 then
			...
			ChapterConst = var_1_10009
			var_1_10009 = var_1_10009.DirtyStrategy
			ChapterConst = var_1_10010
			var_1_10010 = var_1_10010.DirtyCellFlag
			ChapterConst = var_1_10011

			local var_6_10 = var_1_10011.DirtyFloatItems

			ChapterConst = var_1_10012

			local var_6_11 = var_1_10012.DirtyAttachment

			ChapterConst = var_1_10013
			var_6_0 = var_6_7(var_6_8, var_6_9, var_1_10009, var_1_10010, var_6_10, var_6_11, var_1_10013.DirtyWeather)
		...
		if #arg_6_1.cell_flag_list > 0 then
			...
			var_6.each(arg_6_1.cell_flag_list, function(arg_12_0)
				...
				if var_1.getChapterCell(var_12_0, arg_12_0.pos.row, arg_12_0.pos.column) then
					...
					ChapterCell = var_12_0
					var_12_1 = var_12_0.New(arg_12_0)
				end
			...
			local var_6_14 = var_8.DirtyCellFlag

			ChapterConst = var_1_10009
			var_6_0 = var_6_12(var_6_13, var_6_14, var_1_10009.DirtyWeather)
		end
		...
		if arg_6_2 then
			...
			local var_6_17 = var_8.CHAPTER_OP_DONE
			local var_6_18 = {}

			ChapterConst = var_1_10010
			var_6_18.type = var_1_10010.OpSkipBattle
...
function var_0_1.setEliteCache(arg_13_0, arg_13_1)
	...
	for iter_13_2, iter_13_3 in var_2(arg_13_0.data) do
		...
		var_13_6(var_13_5, var_1_10010(arg_13_0.mapEliteFleetCache[var_13_4]))
...
function var_0_1.initChapters(arg_15_0)
	...
	pg = var_1_10003
	var_15_0.MapToChapters = var_15_1(var_1_10003.chapter_template.get_id_list_by_map)
	pairs = var_15_0
	pg = var_2

	for iter_15_0, iter_15_1 in var_15_0(var_2.story_group.get_id_list_by_map) do
...
function var_0_1.buildBaseMaps(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_2(var_1_10003.expedition_data_by_map.all) do
		Map = var_1_10007
...
function var_0_1.buildRemasterMaps(arg_17_0)
	...
	var_17_1(var_1_10003.GetAllNonActivityIds(), function(arg_18_0)
		pg = var_2_10001
...
function var_0_1.IsChapterInRemaster(arg_20_0, arg_20_1)
	...
	return var_20_0(var_1_10003.GetAllNonActivityIds(), function(arg_21_0)
		pg = var_2_10001
...
function var_0_1.addChapterListener(arg_26_0, arg_26_1)
	...
	if arg_26_0.timers[arg_26_1.id] then
		var_26_0 = arg_26_0.timers[arg_26_1.id]
	...
	local function var_26_4()
		...
		var_27_4.chapter = var_4.clone(var_27_5)
...
function var_0_1.getChapterById(arg_32_0, arg_32_1, arg_32_2)
	if not arg_32_0.data[arg_32_1] then
		...
		var_1_10004(var_1_10005.chapter_template[arg_32_1], "Not Exist Chapter ID: " .. (arg_32_1 or "NIL"))
		...
		local var_32_2 = var_3
		local var_32_3 = var_3.getConfig(var_32_2, "type")

		Chapter = var_32_2

		if var_32_3 == var_32_2.CustomFleet or var_3:GetSupportFleetMaxCount() > 0 then
			local var_32_4 = var_3
			local var_32_5 = var_3.setEliteFleetList

			Clone = var_7

			var_32_5(var_32_4, var_7(arg_32_0.mapEliteFleetCache[var_32_1]))
		end
...
function var_0_1.GetChapterItemById(arg_33_0, arg_33_1)
	...
	if var_1_10002:bindConfigTable()[arg_33_1] then
		...
		local var_33_0 = var_2

		if var_2.bindConfigTable(var_33_0)[arg_33_1] then
			local var_33_1

			if not arg_33_0.chapterStoryGroups[arg_33_1] then
				ChapterStoryGroup = var_33_0
				var_33_1 = var_33_0.New({
					configId = arg_33_1
				})
				arg_33_0.chapterStoryGroups[arg_33_1] = var_33_1
			end
...
function var_0_1.updateChapter(arg_34_0, arg_34_1, arg_34_2)
	...
	var_1_10003(var_1_10004(var_34_0, var_1_10006), "should be an instance of Chapter")
	...
	if var_5.getInited(var_34_4) then
		...
		defaultValue = var_9
		var_34_7.dirty = var_9(arg_34_2, 0)
...
function var_0_1.getMapsByActivities(arg_43_0, arg_43_1)
	...
	if arg_43_1 then
		...
		var_1_10004 = var_1_10004(var_43_2, var_1_10006.ACTIVITY_TYPE_ZPROJECT)
		table = var_43_2

		local var_43_3 = var_43_2.sort
		local var_43_4 = var_1_10004

		CompareFuncs = var_1_10007

		var_43_3(var_43_4, var_1_10007({
			function(arg_44_0)
	...
	local var_43_5 = var_1_10004.chapter_template
	local var_43_6 = var_43_1
	local var_43_7 = var_43_5[var_43_1.getConfig(var_43_6, "config_data")[1]].map

	pg = var_5

	local var_43_8 = var_5.expedition_data_by_map[var_43_7].on_activity

	getProxy = var_43_6
	ActivityProxy = var_7

	local var_43_9 = var_43_6(var_7)

	if var_6.IsActivityNotEnd(var_43_9, var_43_8) then
		return arg_43_0:getMapsByActId(var_43_8)
	else
		return {}
	end
...
function var_0_1.updateExtraFlag(arg_46_0, arg_46_1, arg_46_2, arg_46_3, arg_46_4)
	...
	for iter_46_0, iter_46_1 in var_8(arg_46_1:getExtraFlags()) do
		table = var_1_10013

		if not var_1_10013.contains(var_46_0, iter_46_1) then
			table = var_1_10013

			var_1_10013.insert(var_46_2, iter_46_1)
		end
	end
...
function var_0_1.duplicateEliteFleet(arg_56_0, arg_56_1)
	...
	local var_56_1 = arg_56_1.getConfig(var_56_0, "type")

	Chapter = var_56_0

	if var_56_1 ~= var_56_0.CustomFleet and arg_56_1:GetSupportFleetMaxCount() == 0 then
		return
	end
	...
	Clone = var_4
	var_56_3[var_56_2] = var_4(arg_56_1.eliteFleetList)
	pg = var_56_3
	...
	for iter_56_0, iter_56_1 in var_3(var_0_1.FormationToChapters[var_56_2]) do
		if arg_56_0:getChapterById(iter_56_1, true).configId ~= arg_56_1.configId then
			...
			var_56_7(var_56_6, var_11(arg_56_1.eliteFleetList))
...
function var_0_1.RemoveUnitFromSupportFleet(arg_57_0, arg_57_1)
	...
	var_57_1(var_57_0, var_1_10004.REMOVE_ELITE_TARGET_SHIP, {
		shipId = arg_57_1.id
	})
...
function var_0_1.GetLastNormalMap(arg_59_0)
	...
	if var_1_10001.lastMap then
		...
		var_59_1 = arg_59_0.getMapById
		Map = var_1_10003
		var_59_1 = var_59_1(var_59_0, var_1_10003.lastMap)
	end

	if var_59_1 and var_59_1:isUnlock() then
		local var_59_2 = var_59_1
		local var_59_3 = var_59_1.getMapType(var_59_2)

		Map = var_59_2

		if var_59_3 == var_59_2.SCENARIO then
			Map = var_59_3

			return var_59_3.lastMap
		end
	end
...
function var_0_1.getLastMapForActivity(arg_60_0, arg_60_1)
	...
	if var_4.lastMapForActivity then
		...
		Map = var_1_10006
		var_60_0 = var_60_4(var_60_3, var_1_10006.lastMapForActivity)
	end
...
function var_0_1.getActivityLastUnlockMap(arg_61_0, arg_61_1)
	...
	local var_61_1 = arg_61_0.getMapsByActivities(var_61_0, arg_61_1)

	_ = var_61_0

	if not var_61_0.all(var_61_1, function(arg_62_0)
		local var_62_0 = arg_62_0
		local var_62_1 = arg_62_0.getConfig(var_62_0, "type")

		Map = var_62_0

		return var_62_1 == var_62_0.EVENT
	end) then
		ipairs = var_3
		...
		Map = var_5
		var_61_2[1] = var_5.ACTIVITY_EASY
		Map = var_5
		var_61_2[2] = var_5.ACTIVITY_HARD

		for iter_61_0, iter_61_1 in var_3(var_61_2) do
			underscore = var_1_10008

			if #var_1_10008.filter(var_61_1, function(arg_63_0)
	...
	for iter_61_2 = #var_61_1, 1, -1 do
		local var_61_3 = var_61_1[iter_61_2]

		if var_7.isUnlock(var_61_3) then
			return var_7.id
		end
	end

	if #var_61_1 > 0 then
		return var_61_1[1].id
	end
...
function var_0_1.updateActiveChapterShips(arg_65_0)
	...
	if arg_65_0.getActiveChapter(var_65_0, true) then
		_ = var_65_0

		var_65_0.each(var_1.fleets, function(arg_66_0)
			arg_66_0:flushShips()

			return
		end)

		local var_65_1 = arg_65_0
		local var_65_2 = arg_65_0.updateChapter
		local var_65_3 = var_1

		ChapterConst = var_1_10005

		var_65_2(var_65_1, var_65_3, var_1_10005.DirtyFleet)
	end
...
function var_0_1.getUseableEliteMap(arg_68_0)
	...
	for iter_68_0, iter_68_1 in var_1_10002(var_68_2(var_68_1, var_1_10005.ELITE)) do
...
function var_0_1.getUseableMaxEliteMap(arg_69_0)
	if #arg_69_0:getUseableEliteMap() == 0 then
		return false
	else
		local var_69_0
		...
		for iter_69_0, iter_69_1 in var_1_10003(var_1) do
			if not var_69_0 or var_69_0.id < iter_69_1.id then
				var_69_0 = iter_69_1
			end
		end
...
function var_0_1.getHigestClearChapterAndMap(arg_70_0)
	...
	local var_70_2 = arg_70_0.getChapterById(var_70_1, var_70_0.chapterIds[1])

	ipairs = var_70_1

	for iter_70_2, iter_70_3 in var_70_1(var_70_0:getChapters()) do
...
function var_0_1.eliteFleetRecommend(arg_73_0, arg_73_1, arg_73_2)
	...
	local function var_73_1(arg_74_0, arg_74_1, arg_74_2, arg_74_3)
		...
		return var_4.FleetRecommend(var_74_0, arg_74_0, var_73_0, arg_74_2, arg_74_1, function(arg_75_0)
			...
			var_75_4[var_75_5] = var_7.getConfig(var_75_6, "formation")
	...
	local var_73_4 = var_7.insertto

	TeamType = iter_73_1

	local var_73_5 = var_73_2[iter_73_1.FormShips]

	switch = var_1_10009

	local var_73_6 = var_73_3
	local var_73_7 = {}

	FleetType = iter_73_2
	var_73_7[iter_73_2.Normal] = function()
		...
		if var_0.getConfig(var_76_0, "limitation")[arg_73_2] then
			...
			if var_0 then
				...
				local var_76_4 = var_4(var_2_10005)
				...
				local var_76_7 = var_2_10007.Main
				local var_76_8 = {
					var_76_1
				}

				ShipType = var_2_10009
				var_76_8[2] = var_2_10009.MainShipType
				...
				ShipType = var_9
				var_76_10[2] = var_9.VanguardShipType
				var_76_6[var_76_9] = var_76_10

				for iter_76_0, iter_76_1 in var_76_4(var_76_6) do
					unpack = var_2_10010

					local var_76_11

					var_2_10010, var_76_11 = var_2_10010(iter_76_1)
					table = var_2_10012
					var_2_10012 = var_2_10012.insertto

					local var_76_12 = var_76_3
					local var_76_13 = var_73_1

					underscore = var_2_10015
					var_2_10015 = var_2_10015.filter

					local var_76_14 = var_73_2

					TeamType = var_2_10017

					var_2_10012(var_76_12, var_76_13(var_2_10015(var_76_14[var_2_10017.FormShips], function(arg_77_0)
						local var_77_1
	...
	FleetType = var_12
	var_73_7[var_12.Submarine] = function()
		local var_78_0 = {
			0,
			0,
			0
		...
		local var_78_2 = var_73_2

		TeamType = var_2_10003

		local var_78_3 = var_78_2[var_2_10003.FormShips]
		local var_78_4 = var_78_0

		ShipType = var_2_10004

		return var_78_1(var_78_3, var_78_4, var_2_10004.SubShipType)
	end
	FleetType = var_12
	var_73_7[var_12.Support] = function()
		...
		local var_79_3 = var_73_2

		TeamType = var_2_10003

		local var_79_4 = var_79_3[var_2_10003.FormShips]
		local var_79_5 = var_79_1

		ShipType = var_2_10004

		return var_79_2(var_79_4, var_79_5, var_2_10004.AllShipType, "inSupport")
	end

	var_73_4(var_73_5, var_1_10009(var_73_6, var_73_7))
...
function var_0_1.FleetRecommend(arg_80_0, arg_80_1, arg_80_2, arg_80_3, arg_80_4, arg_80_5)
	...
	local var_80_0 = var_6(var_7)

	getProxy = var_7
	BayProxy = var_1_10008

	local var_80_1 = var_7(var_1_10008)
	local var_80_2 = var_7.getRawData(var_80_1)

	ipairs = var_80_1

	for iter_80_0, iter_80_1 in var_80_1(arg_80_1) do
		local var_80_3 = var_80_2[iter_80_1]
		local var_80_4 = var_13.getShipType(var_80_3)

		ipairs = var_80_3

		for iter_80_2, iter_80_3 in var_80_3(arg_80_4) do
...
function var_0_1.recordLastMap(arg_84_0, arg_84_1, arg_84_2)
	...
	if var_84_0 then
		...
		local var_84_1 = var_4(var_1_10005)
		local var_84_2 = var_4.getRawData(var_84_1)

		PlayerPrefs = var_84_1

		var_84_1.SetInt(arg_84_1 .. var_84_2.id, arg_84_2)
...
function var_0_1.getLastMap(arg_85_0, arg_85_1)
	...
	local var_85_0 = var_1_10002(var_1_10003)
	local var_85_1 = var_2.getRawData(var_85_0)

	PlayerPrefs = var_85_0

	if var_85_0.GetInt(arg_85_1 .. var_85_1.id) ~= 0 then
		return var_3
	end
...
function var_0_1.IsActivitySPChapterActive(arg_86_0, arg_86_1)
	...
	local var_86_2 = var_86_0.reduce(var_86_1, {}, function(arg_87_0, arg_87_1)
		table = var_2_10002
		...
		var_87_0(var_87_1, var_2_10004.select(arg_87_1:getChapters(), function(arg_88_0)
	...
	return var_4.any(var_86_2, function(arg_89_0)
		local var_89_0
...
function var_0_1.getSubAidFlag(arg_90_0, arg_90_1)
	...
	local var_90_3, var_90_4

	if var_1_10005.detect(arg_90_0.fleets, function(arg_91_0)
		local var_91_0 = arg_91_0
		local var_91_1 = arg_91_0.getFleetType(var_91_0)

		FleetType = var_91_0

		return var_91_1 == var_91_0.Submarine and arg_91_0:isValid()
	end) then
		var_90_3 = var_5
		...
		if var_5.inHuntingRange(var_90_3, var_90_1.line.row, var_90_1.line.column) then
			...
			var_90_3 = var_5
			var_90_4 = var_5.getStrategies(var_90_3)
			_ = var_90_3

			if var_90_3.detect(var_90_4, function(arg_92_0)
				local var_92_0 = arg_92_0.id

				ChapterConst = var_2_10002

				return var_92_0 == var_2_10002.StrategyCallSubOutofRange
			end) and var_90_3.count > 0 then
				var_90_2 = true
			end
		end
	end
	...
	if var_90_2 then
		...
		local var_90_5 = var_90_4(var_90_3)
		local var_90_6 = var_6.getRawData(var_90_5)
		local var_90_7, var_90_8 = arg_90_0:getFleetCost(var_90_1, arg_90_1)
		local var_90_9, var_90_10 = arg_90_0:getFleetAmmo(var_5)
		local var_90_11 = 0

		ipairs = var_1_10013

		for iter_90_0, iter_90_1 in var_1_10013({
...
function var_0_1.GetChapterAuraBuffs(arg_93_0)
	...
	for iter_93_0, iter_93_1 in var_1_10002(arg_93_0.fleets) do
		local var_93_1 = iter_93_1
		local var_93_2 = iter_93_1.getFleetType(var_93_1)

		FleetType = var_93_1

		if var_93_2 ~= var_93_1.Support then
			local var_93_3 = iter_93_1
			local var_93_4 = iter_93_1.getMapAura(var_93_3)

			ipairs = var_93_3

			for iter_93_2, iter_93_3 in var_93_3(var_93_4) do
				table = var_1_10013
...
function var_0_1.GetChapterAidBuffs(arg_94_0)
	...
	for iter_94_0, iter_94_1 in var_1_10002(arg_94_0.fleets) do
		if iter_94_1 ~= arg_94_0.fleet then
			local var_94_1 = iter_94_1
			local var_94_2 = iter_94_1.getFleetType(var_94_1)

			FleetType = var_94_1

			if var_94_2 ~= var_94_1.Support then
				local var_94_3 = iter_94_1
				local var_94_4 = iter_94_1.getMapAid(var_94_3)

				pairs = var_94_3

				for iter_94_2, iter_94_3 in var_94_3(var_94_4) do
...
function var_0_1.UpdateSkipPrecombat(arg_108_0, arg_108_1)
	...
	if arg_108_1 ~= arg_108_0.GetSkipPrecombat(var_108_0) then
		PlayerPrefs = var_108_0

		var_108_0.SetInt("chapter_skip_precombat", arg_108_1)
...
function var_0_1.SetChapterAutoFlag(arg_110_0, arg_110_1, arg_110_2, arg_110_3)
	...
	if arg_110_2 then
		...
		if var_5.autoBotSatisfied() then
			...
			AutoBotCommand = var_7

			var_110_1(var_110_0 .. var_7.GetAutoBotMark(), 1)
		end
		...
		var_110_10(var_110_9, var_7, arg_110_3)
	...
	var_110_16(var_110_15, var_7.CHANGE_TOUCH_ABLE, not arg_110_2)
...
function var_0_1.FinishAutoFight(arg_112_0, arg_112_1)
	...
	if arg_112_0.GetChapterAutoFlag(var_112_0, arg_112_1) == 1 then
		pg = var_112_0

		local var_112_1 = var_112_0.BrightnessMgr.GetInstance()

		var_3.SetScreenNeverSleep(var_112_1, false)
		...
		if not var_3 then
			...
			local var_112_2 = var_3.BrightnessMgr.GetInstance()

			var_3.ExitManualMode(var_112_2)

			getProxy = var_3
			SettingsProxy = var_112_2

			local var_112_3 = var_3(var_112_2)

			var_3.RestoreFrameRate(var_112_3)
		end

		local var_112_4 = arg_112_0.facade
		local var_112_5 = var_3.sendNotification

		PlayerResUI = var_5

		var_112_5(var_112_4, var_5.CHANGE_TOUCH_ABLE, true)
	end

	local var_112_6 = arg_112_0:GetExtendChapter(arg_112_1)
...
function var_0_1.buildRemasterInfo(arg_113_0)
	...
	for iter_113_0, iter_113_1 in var_1(var_1_10002.re_map_template.all) do
		pg = var_1_10006
...
function var_0_1.checkRemasterInfomation(arg_114_0)
	if not arg_114_0.checkRemaster then
		...
		var_114_1(var_114_0, var_1_10003.CHAPTER_REMASTER_INFO_REQUEST)
	end
...
function var_0_1.addRemasterPassCount(arg_116_0, arg_116_1, arg_116_2)
	if not arg_116_0:getRemasterInfo(arg_116_2, arg_116_1) then
		return
	end
	...
	for iter_116_0, iter_116_1 in var_5(var_3) do
...
function var_0_1.StopContinuousOperation(arg_126_0, arg_126_1, arg_126_2)
	...
	if not arg_126_0.GetContinuousData(var_126_0, arg_126_1) or not var_3:IsActive() then
		return
	end

	ChapterConst = var_126_0

	if arg_126_2 == var_126_0.AUTOFIGHT_STOP_REASON.MANUAL then
		SYSTEM_SCENARIO = var_4

		if arg_126_1 == var_4 then
			pg = var_4

			local var_126_1 = var_4.TipsMgr.GetInstance()
			local var_126_2 = var_4.ShowTips

			i18n = var_1_10006

			var_126_2(var_126_1, var_1_10006("multiple_sorties_stop"))
		end
	end
...
function var_0_1.RemoveEliteFleetCommander(arg_130_0, arg_130_1)
	...
	for iter_130_2, iter_130_3 in var_4(arg_130_0.mapEliteFleetCache) do
		...
		for iter_130_4, iter_130_5 in var_1_10009(iter_130_3) do
			...
			for iter_130_6, iter_130_7 in var_1_10014(iter_130_5) do
				...
				for iter_130_8, iter_130_9 in var_1_10019(iter_130_7[var_1_10020.FormCommander]) do
	...
	for iter_130_10, iter_130_11 in var_4(arg_130_0.data) do
		if var_130_1[iter_130_11:getConfig("formation")] then
			...
			var_130_3(var_130_2, iter_130_4(arg_130_0.mapEliteFleetCache[var_9]))
