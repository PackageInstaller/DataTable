...
function var_0_1.register(arg_1_0)
	arg_1_0:on(11200, function(arg_2_0)
		...
		for iter_2_2, iter_2_3 in var_1(arg_2_0.activity_list) do
			...
			if not var_2_10006.activity_template[iter_2_3.id] then
				...
				local var_2_1 = var_2_10006.getConfig(var_2_0, "type")

				ActivityConst = var_2_0

				if var_2_1 == var_2_0.ACTIVITY_TYPE_PARAMETER then
					local var_2_2 = arg_1_0

					var_8.addActivityParameter(var_2_2, var_2_10006)
				else
					ActivityConst = var_8

					if var_2_1 == var_8.ACTIVITY_TYPE_EVENT_SINGLE then
						local var_2_3 = arg_1_0

						var_8.CheckDailyEventRequest(var_2_3, var_2_10006)
					else
						local var_2_4 = arg_1_0

						var_8.CheckCreateActivityFleet(var_2_4, var_2_10006, iter_2_3)
					end
				end
				...
				if var_2_10006.stopTime > 0 then
					...
					local var_2_5 = var_8.sort
					local var_2_6 = arg_1_0.stopList

					CompareFuncs = var_10

					var_2_5(var_2_6, var_10({
						function(arg_3_0)
							return arg_3_0[1]
						end
					}))
		...
		local var_2_8 = var_1.getActivityByType

		ActivityConst = var_3

		if var_2_8(var_2_7, var_3.ACTIVITY_TYPE_CHALLENGE) and not var_1:isEnd() then
			local var_2_9 = arg_1_0
			local var_2_10 = var_2.sendNotification

			GAME = iter_2_2

			var_2_10(var_2_9, iter_2_2.CHALLENGE2_INFO, {})
		end
		...
		if var_2_12(var_2_11, iter_2_2.ACTIVITY_TYPE_TASK_LIST_MONITOR) and not var_2:isEnd() and var_2.data1 == 0 then
			local var_2_13 = arg_1_0

			var_2_11.monitorTaskList(var_2_13, var_2)
		end

		pg = var_2_11

		local var_2_14 = var_2_11.ShipFlagMgr.GetInstance()

		var_3.UpdateFlagShips(var_2_14, "inElite")
		;(function()
			...
			if not var_4_1(var_4_0, var_3_10002.ACTIVITY_TYPE_ATELIER_LINK) then
				return
			end
			...
			var_4_3(var_4_2, var_3_10003.REQUEST_ATELIER, var_0.id)

			return
		end)()

		local var_2_15 = arg_1_0
		local var_2_16 = var_4.getActivityByType

		ActivityConst = var_2_10006

		if var_2_16(var_2_15, var_2_10006.ACTIVITY_TYPE_COLLECTION_EVENT) then
			local var_2_17 = var_4

			if not var_4.isEnd(var_2_17) then
				getProxy = var_2_15
				EventProxy = var_2_17

				local var_2_18 = var_2_15(var_2_17)

				var_2_15.CheckAddActivityEvent(var_2_18)
			end
		end
	...
	arg_1_0:on(11201, function(arg_5_0)
		...
		var_2(var_5_0.id, "should exist activity")

		local var_5_1 = var_5_0
		local var_5_2 = var_5_0.getConfig(var_5_1, "type")

		ActivityConst = var_5_1

		if var_5_2 == var_5_1.ACTIVITY_TYPE_PARAMETER then
			local var_5_3 = arg_1_0

			var_3.addActivityParameter(var_5_3, var_5_0)
		end

		if arg_1_0.data[var_5_0.id] then
			ActivityConst = var_3

			if var_5_2 == var_3.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2 then
				local var_5_4 = arg_1_0

				var_3.CheckCreateActivityFleet(var_5_4, var_5_0, arg_5_0.activity_info)
			end

			if not arg_1_0.data[var_5_0.id] then
				local var_5_5 = arg_1_0

				var_3.addActivity(var_5_5, var_5_0)
			else
				local var_5_6 = arg_1_0

				var_3.updateActivity(var_5_6, var_5_0)
			end

			local var_5_7 = arg_1_0
			local var_5_8 = var_3.sendNotification

			GAME = var_2_10005

			var_5_8(var_5_7, var_2_10005.ACTIVITY_BE_UPDATED, {
				activity = var_5_0
			})
	...
	arg_1_0:on(40009, function(arg_6_0)
		...
		if not var_1.GetBossActivityByChapterId(var_6_0, arg_6_0.arg1) then
			...
			var_6_3 = var_6_2(var_6_1, var_2_10004.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB)
		end
		...
		BossRushSettlementCommand = var_6_1

		local var_6_5 = var_6_1.ConcludeEXP(arg_6_0, var_6_3, var_6_4 and var_6_4:GetBattleStatistics())
	...
	arg_1_0:on(24100, function(arg_8_0)
		(function()
			...
			if not var_9_1(var_9_0, var_3_10002.ACTIVITY_TYPE_EXTRA_BOSSRUSH_RANK) then
				return
			end
	...
	arg_1_0:on(11028, function(arg_10_0)
		...
		elseif arg_10_0.result > 0 then
			...
			var_10_3(var_10_2, var_3("", arg_10_0.result))
		end
	...
	arg_1_0:on(26033, function(arg_11_0)
		...
		if not var_11_1(var_11_0, var_2_10003.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2) then
			return
		end
	...
	var_13_0[var_1_10002.DayCall] = function(arg_14_0)
		...
		for iter_14_0, iter_14_1 in var_2_10001(arg_13_0.data) do
			if not iter_14_1:isEnd() then
				...
				local var_14_0 = iter_14_1:getConfig("type")
				local var_14_1 = {}

				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_7DAYSLOGIN] = function()
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_PROGRESSLOGIN] = function()
					iter_14_1.autoActionForbidden = false
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_MONTHSIGN] = function()
					iter_14_1.autoActionForbidden = false
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_REFLUX] = function()
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_HITMONSTERNIAN] = function()
					iter_14_1.autoActionForbidden = false
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_BB] = function()
					iter_14_1.data2 = 0
					iter_14_1.autoActionForbidden = false
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_LOTTERY_AWARD] = function()
					iter_14_1.data2 = 0
					iter_14_1.autoActionForbidden = false
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_BOSSRUSH] = function()
					local var_22_0 = iter_14_1
					local var_22_1 = var_0.GetUsedBonus(var_22_0)

					table = var_22_0

					var_22_0.Foreach(var_22_1, function(arg_23_0, arg_23_1)
						var_22_1[arg_23_0] = 0
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_BOSSSINGLE] = function()
					local var_24_0 = iter_14_1
					local var_24_1 = var_0.GetDailyCounts(var_24_0)

					table = var_24_0

					var_24_0.Foreach(var_24_1, function(arg_25_0, arg_25_1)
						var_24_1[arg_25_0] = 0
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE] = function()
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_MANUAL_SIGN] = function()
					local var_27_0 = arg_13_0
					local var_27_1 = var_0.sendNotification

					GAME = var_3_10002

					local var_27_2 = var_3_10002.ACT_MANUAL_SIGN
					local var_27_3 = {
						activity_id = iter_14_1.id
					}

					ManualSignActivity = var_4
					var_27_3.cmd = var_4.OP_SIGN
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_TURNTABLE] = function()
					local var_28_0 = iter_14_1
					local var_28_1 = var_0.getConfig(var_28_0, "config_id")

					pg = var_28_0

					if var_28_0.activity_event_turning[var_28_1].total_num <= iter_14_1.data3 then
						return
					end
					...
					getProxy = var_4
					TaskProxy = var_3_10005

					local var_28_2 = var_4(var_3_10005)
					...
					var_28_5(var_28_4, var_7.ACTIVITY_OPERATION, {
						cmd = 2,
						activity_id = iter_14_1.id
					})
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_MONOPOLY] = function()
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_CHALLENGE] = function()
					local var_30_0 = arg_13_0
					local var_30_1 = var_0.sendNotification

					GAME = var_3_10002

					var_30_1(var_30_0, var_3_10002.CHALLENGE2_INFO, {})

					return
				end
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2] = function()
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_RANDOM_DAILY_TASK] = function()
					pg = var_3_10000
					...
					local var_32_2 = var_32_0.TimeMgr.GetInstance()
					...
					local var_32_3 = var_32_2.m02
					local var_32_4 = var_2.sendNotification

					GAME = var_4

					local var_32_5 = var_4.ACT_RANDOM_DAILY_TASK
					local var_32_6 = {
						activity_id = iter_14_1.id
					}

					ActivityConst = var_6
					var_32_6.cmd = var_6.RANDOM_DAILY_TASK_OP_RANDOM
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_EVENT_SINGLE] = function()
					local var_33_0 = arg_13_0
					local var_33_1 = var_0.sendNotification

					GAME = var_3_10002

					var_33_1(var_33_0, var_3_10002.SINGLE_EVENT_REFRESH, {
						actId = iter_14_1.id
					})
				...
				ActivityConst = var_9
				var_14_1[var_9.ACTIVITY_TYPE_LOVE_LETTER_UP] = function()
	...
	var_13_0[var_2.SecondCall] = function(arg_35_0)
		...
		for iter_35_0, iter_35_1 in var_2_10001(arg_13_0.data) do
			if not iter_35_1:isEnd() then
				...
				local var_35_0 = iter_35_1:getConfig("type")
				local var_35_1 = {}

				ActivityConst = var_9
				var_35_1[var_9.ACTIVITY_TYPE_TOWN] = function()
				...
				ActivityConst = var_9
				var_35_1[var_9.ACTIVITY_TYPE_TOWN2] = function()
		...
		local var_35_4 = #arg_13_0.stopList

		if 0 < var_35_4 and arg_13_0.stopList[1][1] <= var_35_3 then
			repeat
				unpack = var_35_5
				table = var_35_6

				local var_35_5, var_35_6 = var_35_5(var_35_6.remove(arg_13_0.stopList, 1))
				local var_35_7 = arg_13_0.data[var_35_6]

				switch = var_5

				local var_35_8 = var_35_7:getConfig("type")
				local var_35_9 = {}

				ActivityConst = var_8
				var_35_9[var_8.ACTIVITY_TYPE_MILITARY_EXERCISE] = function()
					getProxy = var_3_10000
					MilitaryExerciseProxy = var_3_10001

					local var_38_0 = var_3_10000(var_3_10001)
				...
				ActivityConst = var_8
				var_35_9[var_8.ACTIVITY_TYPE_NPC_COLLECTION] = function()
					getProxy = var_3_10000
					BayProxy = var_3_10001

					local var_39_0 = var_3_10000(var_3_10001)

					if var_0.getShipById(var_39_0, var_35_7.data2) and var_0:isActivityNpc() then
						local var_39_1 = arg_13_0
						local var_39_2 = var_1.sendNotification

						GAME = var_3_10003

						var_39_2(var_39_1, var_3_10003.SEND_CMD, {
							cmd = "kick"
						})
					end
				...
				ActivityConst = var_8
				var_35_9[var_8.ACTIVITY_TYPE_TASKS] = function()
					getProxy = var_3_10000
					TaskProxy = var_3_10001

					local var_40_0 = var_3_10000(var_3_10001)

					ipairs = var_3_10001

					local var_40_1 = var_35_7

					for iter_40_0, iter_40_1 in var_3_10001(var_2.getConfig(var_40_1, "config_data")) do
				...
				var_5(var_35_8, var_35_9)

				pg = var_5

				local var_35_10 = var_5.ShipFlagMgr.GetInstance()

				var_5.UpdateFlagShips(var_35_10, "inActivity")

				local var_35_11 = arg_13_0

				var_5.sendNotification(var_35_11, var_0_1.ACTIVITY_END, var_35_6)
...
function var_0_1.getMilitaryExerciseActivity(arg_45_0)
	...
	for iter_45_0, iter_45_1 in var_1_10002(arg_45_0.data) do
		local var_45_1 = iter_45_1
		local var_45_2 = iter_45_1.getConfig(var_45_1, "type")

		ActivityConst = var_45_1

		if var_45_2 == var_45_1.ACTIVITY_TYPE_MILITARY_EXERCISE then
			var_45_0 = iter_45_1
...
function var_0_1.getPanelActivities(arg_46_0)
	local function var_46_0(arg_47_0)
		...
		if arg_47_0.isShow(var_47_1) then
			var_47_1 = arg_47_0

			local var_47_2

			if not arg_47_0.isAfterShow(var_47_1) then
				var_47_1 = arg_47_0
				var_47_2 = arg_47_0.isCorePage(var_47_1, "")
			else
				var_47_2 = false
			end
		end
		...
		if var_47_2 then
			...
			if var_47_0 == var_47_1.ACTIVITY_TYPE_CHARGEAWARD then
				var_47_2 = arg_47_0.data2 == 0
			else
				ActivityConst = var_3

				if var_47_0 == var_3.ACTIVITY_TYPE_PROGRESSLOGIN then
					var_47_2 = arg_47_0.data1 < 7 or not arg_47_0.achieved
				else
					ActivityConst = var_3

					if var_47_0 == var_3.ACTIVITY_TYPE_SURVEY then
						PLATFORM = var_3
						PLATFORM_OPENHARMONY = var_2_10004
						var_47_2 = var_3 ~= var_2_10004
					end
				end
			end
		end

		return var_47_2 and not arg_47_0:isEnd()
	end
...
function var_0_1.getIslandPanelActivities(arg_53_0)
	local function var_53_0(arg_54_0)
		...
		if arg_54_0.isIslandShow(var_54_1) then
			ActivityConst = var_54_1

			if var_54_0 == var_54_1.ACTIVITY_TYPE_SURVEY then
				...
				PLATFORM = var_54_4
				PLATFORM_OPENHARMONY = var_2_10006

				if var_54_4 == var_2_10006 then
					var_54_6 = false
				end
			end
		end
...
function var_0_1.getBannerDisplays(arg_56_0)
	...
	local var_56_0 = var_1_10001(var_1_10002.activity_banner.all)
	...
	local var_56_3 = var_1.filter(var_56_2, function(arg_58_0)
		...
		if var_1.inTime(var_58_0, arg_58_0.time) then
			...
			GAMEUI_BANNER_9 = var_58_0

			if var_58_1 ~= var_58_0 then
				var_58_1 = arg_58_0.type
				GAMEUI_BANNER_11 = var_58_0

				if var_58_1 ~= var_58_0 then
					var_58_1 = arg_58_0.type
					GAMEUI_BANNER_10 = var_58_0

					if var_58_1 ~= var_58_0 then
						var_58_1 = arg_58_0.type
						GAMEUI_BANNER_12 = var_58_0

						if var_58_1 ~= var_58_0 then
							var_58_1 = arg_58_0.type
							GAMEUI_BANNER_13 = var_58_0
...
function var_0_1.getNoticeBannerDisplays(arg_60_0)
	...
	return var_60_0(var_1_10002.activity_banner_notice.all, function(arg_61_0)
		pg = var_2_10001
...
function var_0_1.findNextAutoActivity(arg_62_0, arg_62_1)
	...
	if arg_62_1 and arg_62_1 ~= "" then
		var_1_10006 = arg_62_0

		local var_62_3

		if not arg_62_0.getCorePanelActivities(var_1_10006, arg_62_1) then
			var_1_10006 = arg_62_0
			var_62_3 = arg_62_0.getPanelActivities(var_1_10006)
		end

		ipairs = var_1_10006

		for iter_62_0, iter_62_1 in var_1_10006(var_62_3) do
			if not iter_62_1.autoActionForbidden then
				...
				if var_62_5 == var_62_4.ACTIVITY_TYPE_7DAYSLOGIN then
					var_62_6 = iter_62_1

					if iter_62_1.getConfig(var_62_6, "config_client") and var_12.manulSign == true then
						-- block empty
					else
						local var_62_7 = iter_62_1

						var_62_6 = iter_62_1.getConfig(var_62_7, "config_id")
						pg = var_62_7

						local var_62_8 = var_62_7.activity_7_day_sign[var_62_6].front_drops

						if iter_62_1.data1 < #var_62_8 and not var_3:IsSameDay(var_62_2, iter_62_1.data2) and var_62_2 > iter_62_1.data2 then
							var_62_0 = iter_62_1
					...
					if var_62_5 == var_12.ACTIVITY_TYPE_PROGRESSLOGIN then
						getProxy = var_62_9
						ChapterProxy = var_62_6
						var_62_9 = var_62_9(var_62_6)

						if iter_62_1.data1 < 7 and not var_3:IsSameDay(var_62_2, iter_62_1.data2) or iter_62_1.data1 == 7 and not iter_62_1.achieved and var_62_9:isClear(204) then
							var_62_0 = iter_62_1

							break
						end
					else
						ActivityConst = var_62_9

						if var_62_5 == var_62_9.ACTIVITY_TYPE_MONTHSIGN then
							pg = var_12
							var_62_6 = var_12.TimeMgr.GetInstance()

							local var_62_10 = var_12.STimeDescS(var_62_6, var_62_2, "*t")

							iter_62_1:setSpecialData("reMonthSignDay", nil)

							if var_62_10.year ~= iter_62_1.data1 or var_62_10.month ~= iter_62_1.data2 then
								iter_62_1.data1 = var_62_10.year
								iter_62_1.data2 = var_62_10.month
								...
								if not var_62_6.contains(iter_62_1.data1_list, var_62_10.day) then
									var_62_0 = iter_62_1

									break
								elseif var_62_10.day > #iter_62_1.data1_list then
									pg = var_62_6

									if var_62_6.activity_month_sign[iter_62_1.data2].resign_count > iter_62_1.data3 then
										for iter_62_2 = var_62_10.day, 1, -1 do
											table = var_1_10018
							...
							local var_62_11 = iter_62_1.id

							ActivityConst = var_62_6

							if var_62_11 == var_62_6.SHADOW_PLAY_ID and iter_62_1.clientData1 == 0 then
								local var_62_12 = iter_62_1
								local var_62_13 = iter_62_1.getConfig(var_62_12, "config_data")[1]

								getProxy = var_62_12
								TaskProxy = var_14

								local var_62_14 = var_62_12(var_14)
								local var_62_15

								if not var_13.getTaskById(var_62_14, var_62_13) then
									var_62_15 = var_13:getFinishTaskById(var_62_13)
								end

								if var_62_15 and not var_62_15:isReceive() then
									var_62_0 = iter_62_1
		...
		if not var_62_0 then
			...
			for iter_62_3, iter_62_4 in var_6(arg_62_0.data) do
				if not iter_62_4:isShow() then
					local var_62_16 = iter_62_4
					local var_62_17 = iter_62_4.getConfig(var_62_16, "type")

					ActivityConst = var_62_16

					if var_62_17 == var_62_16.ACTIVITY_TYPE_7DAYSLOGIN then
						local var_62_18 = iter_62_4
						local var_62_19 = iter_62_4.getConfig(var_62_18, "config_id")

						pg = var_62_18

						local var_62_20 = var_62_18.activity_7_day_sign[var_62_19].front_drops

						if iter_62_4.data1 < #var_62_20 and not var_3:IsSameDay(var_62_2, iter_62_4.data2) and var_62_2 > iter_62_4.data2 then
							var_62_0 = iter_62_4
...
function var_0_1.findRefluxAutoActivity(arg_63_0)
	...
	if var_63_1(var_63_0, var_1_10003.ACTIVITY_TYPE_REFLUX) and not var_1:isEnd() and not var_1.autoActionForbidden then
		pg = var_2

		local var_63_2 = var_2.TimeMgr.GetInstance()
		local var_63_3 = var_1.data1_list[2]

		pg = var_1_10004

		if var_63_3 < #var_1_10004.return_sign_template.all and not var_63_2:IsSameDay(var_63_2:GetServerTime(), var_1.data1_list[1]) then
			return 1
		end
	end
...
function var_0_1.existRefluxAwards(arg_64_0)
	...
	if var_64_1(var_64_0, var_1_10003.ACTIVITY_TYPE_REFLUX) and not var_1:isEnd() then
		pg = var_2
		...
		if var_64_9.any(var_64_10, function(arg_68_0)
...
function var_0_1.updateActivity(arg_71_0, arg_71_1)
	...
	var_1_10002(var_3(var_71_0, var_5), "activity should instance of Activity")

	local var_71_1 = arg_71_1
	local var_71_2 = arg_71_1.getConfig(var_71_1, "type")

	ActivityConst = var_71_1

	if var_71_2 == var_71_1.ACTIVITY_TYPE_PT_CRUSING then
		pg = var_71_2

		local var_71_3 = var_71_2.battlepass_event_pt[arg_71_1.id].target

		if arg_71_0.data[arg_71_1.id].data1 < var_71_3[#var_71_3] and arg_71_1.data1 - arg_71_0.data[arg_71_1.id].data1 > 0 then
			pg = var_3

			local var_71_4 = var_3.ToastMgr.GetInstance()
			local var_71_5 = var_3.ShowToast

			pg = var_5

			local var_71_6 = var_5.ToastMgr.TYPE_CRUSING
			local var_71_7 = {}

			pg = var_1_10007
			var_71_7.ptId = var_1_10007.battlepass_event_pt[arg_71_1.id].pt
			var_71_7.ptCount = arg_71_1.data1 - arg_71_0.data[arg_71_1.id].data1

			var_71_5(var_71_4, var_71_6, var_71_7)
		end
	else
		local var_71_8 = arg_71_1
		local var_71_9 = arg_71_1.getConfig(var_71_8, "type")

		ActivityConst = var_71_8

		if var_71_9 == var_71_8.ACTIVITY_TYPE_PT_HEI5 then
			pg = var_71_9

			local var_71_10 = var_71_9.black_friday_battlepass_event_pt[arg_71_1.id].target

			if arg_71_0.data[arg_71_1.id].data1 < var_71_10[#var_71_10] and arg_71_1.data1 - arg_71_0.data[arg_71_1.id].data1 > 0 then
				pg = var_3

				local var_71_11 = var_3.ToastMgr.GetInstance()
				local var_71_12 = var_3.ShowToast

				pg = var_5

				local var_71_13 = var_5.ToastMgr.TYPE_CRUSING
				local var_71_14 = {}

				pg = var_1_10007
				var_71_14.ptId = var_1_10007.black_friday_battlepass_event_pt[arg_71_1.id].pt
				var_71_14.ptCount = arg_71_1.data1 - arg_71_0.data[arg_71_1.id].data1

				var_71_12(var_71_11, var_71_13, var_71_14)
			end
		end
	end
	...
	local var_71_15 = arg_71_0
	local var_71_16 = arg_71_0.sendNotification

	GAME = var_4

	var_71_16(var_71_15, var_4.SYN_GRAFTING_ACTIVITY, {
		id = arg_71_1.id
	})

	BuffHelper = var_71_16

	var_71_16.GenBuffsForActivity(arg_71_1)
...
function var_0_1.addActivity(arg_72_0, arg_72_1)
	...
	var_1_10002(var_3(var_72_0, var_5), "activity should instance of Activity")
...
function var_0_1.readyToAchieveByType(arg_77_0, arg_77_1)
	...
	local var_77_2 = arg_77_0.getActivitiesByType(var_77_1, arg_77_1)

	ipairs = var_77_1

	for iter_77_0, iter_77_1 in var_77_1(var_77_2) do
...
function var_0_1.getBuildActivityCfgByID(arg_78_0, arg_78_1)
	...
	var_78_2[1] = var_1_10005.ACTIVITY_TYPE_BUILDSHIP_1
	ActivityConst = var_5
	var_78_2[2] = var_5.ACTIVITY_TYPE_NEWSERVER_BUILD

	local var_78_3 = var_78_1(var_78_0, var_78_2)

	ipairs = var_78_0

	for iter_78_0, iter_78_1 in var_78_0(var_78_3) do
...
function var_0_1.getNoneActBuildActivityCfgByID(arg_79_0, arg_79_1)
	...
	ActivityConst = var_1_10005
	var_79_2[1] = var_1_10005.ACTIVITY_TYPE_BUILD

	local var_79_3 = var_79_1(var_79_0, var_79_2)

	ipairs = var_79_0

	for iter_79_0, iter_79_1 in var_79_0(var_79_3) do
...
function var_0_1.getBuffShipList(arg_80_0)
	...
	local var_80_3 = var_80_2(var_80_1, var_1_10004.ACTIVITY_TYPE_SHIP_BUFF)

	_ = var_80_1

	var_80_1.each(var_80_3, function(arg_81_0)
		if arg_81_0 and not arg_81_0:isEnd() then
			local var_81_0 = arg_81_0
			local var_81_1 = arg_81_0.getConfig(var_81_0, "config_id")

			pg = var_81_0

			if not var_81_0.activity_expup_ship[var_81_1] then
				return
			end

			local var_81_2 = var_2.expup

			pairs = var_2_10004

			for iter_81_0, iter_81_1 in var_2_10004(var_81_2) do
...
function var_0_1.getVirtualItemNumber(arg_82_0, arg_82_1)
	...
	if var_82_1(var_82_0, var_1_10004.ACTIVITY_TYPE_VIRTUAL_BAG) and not var_2:isEnd() then
		local var_82_2
...
function var_0_1.removeVitemById(arg_83_0, arg_83_1, arg_83_2)
	...
	local var_83_2 = var_83_1(var_83_0, var_1_10005.ACTIVITY_TYPE_VIRTUAL_BAG)

	assert = var_83_0

	var_83_0(var_83_2, "vbagType invalid")
...
function var_0_1.addVitemById(arg_84_0, arg_84_1, arg_84_2)
	...
	if not var_84_1(var_84_0, var_1_10005.ACTIVITY_TYPE_VIRTUAL_BAG) then
		local var_84_2 = arg_84_0

		var_84_0 = arg_84_0.getActivityByType
		ActivityConst = var_1_10006
		var_84_3 = var_84_0(var_84_2, var_1_10006.ACTIVITY_TYPE_HOLIDAY_VILLA)
	end
	...
	if not var_84_3 then
		...
		var_84_0 = arg_84_0.getActivityByType
		ActivityConst = var_1_10006
		var_84_3 = var_84_0(var_84_4, var_1_10006.ACTIVITY_TYPE_CITY_REBUILD)
	end

	assert = var_84_0

	var_84_0(var_84_3, "vbagType invalid")
...
function var_0_1.monitorTaskList(arg_85_0, arg_85_1)
	if arg_85_1 and not arg_85_1:isEnd() then
		...
		local var_85_1 = arg_85_1.getConfig(var_85_0, "type")

		ActivityConst = var_85_0

		if var_85_1 == var_85_0.ACTIVITY_TYPE_TASK_LIST_MONITOR then
			local var_85_2 = arg_85_1
			local var_85_3

			if not arg_85_1.getConfig(var_85_2, "config_data")[1] then
				var_85_3 = {}
			end
			...
			local var_85_4 = var_85_2(var_4)

			if var_3.isReceiveTasks(var_85_4, var_85_3) then
				local var_85_5 = arg_85_0
				local var_85_6 = arg_85_0.sendNotification

				GAME = var_5

				var_85_6(var_85_5, var_5.ACTIVITY_OPERATION, {
					cmd = 1,
...
function var_0_1.CheckCreateActivityFleet(arg_86_0, arg_86_1, arg_86_2)
	...
	local var_86_0 = arg_86_1:getConfig("type")
	local var_86_1 = {}

	ActivityConst = var_6
	var_86_1[var_6.ACTIVITY_TYPE_BOSS_BATTLE_MARK_2] = function()
	...
	ActivityConst = var_6
	var_86_1[var_6.ACTIVITY_TYPE_CHALLENGE] = function()
	...
	local var_86_2 = var_6.ACTIVITY_TYPE_BOSSRUSH

	ActivityConst = var_7
	var_86_1[var_86_2] = var_7.ACTIVITY_TYPE_CHALLENGE
	ActivityConst = var_86_2

	local var_86_3 = var_86_2.ACTIVITY_TYPE_BOSSSINGLE

	ActivityConst = var_7
	var_86_1[var_86_3] = var_7.ACTIVITY_TYPE_CHALLENGE
	ActivityConst = var_86_3

	local var_86_4 = var_86_3.ACTIVITY_TYPE_BOSSSINGLE_VARIABLE

	ActivityConst = var_7
	var_86_1[var_86_4] = var_7.ACTIVITY_TYPE_CHALLENGE
	ActivityConst = var_86_4

	local var_86_5 = var_86_4.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB

	ActivityConst = var_7
	var_86_1[var_86_5] = var_7.ACTIVITY_TYPE_CHALLENGE

	var_1_10003(var_86_0, var_86_1)
...
function var_0_1.InitActtivityFleet(arg_89_0, arg_89_1, arg_89_2)
	...
	local var_89_0 = var_1_10003(var_1_10004)
...
function var_0_1.InitActivityBossData(arg_90_0, arg_90_1)
	...
	local var_90_0 = var_1_10002.activity_event_worldboss
	local var_90_1 = arg_90_1

	if not var_90_0[arg_90_1.getConfig(var_90_1, "config_id")] then
		return
	end

	local var_90_2 = arg_90_1.data1KeyValueList
	...
	for iter_90_0, iter_90_1 in var_90_1(var_90_3) do
		pairs = var_1_10009
		...
		for iter_90_2, iter_90_3 in var_1_10009(iter_90_1[1]) do
			...
			if not var_90_2[1][iter_90_3] then
				var_90_5 = 0
			end

			local var_90_6 = var_90_2[1]

			math = var_1_10017
			var_90_6[iter_90_3] = var_1_10017.max(var_90_4 - var_90_5, 0)

			local var_90_7 = var_90_2[2]

			if not var_90_2[2][iter_90_3] then
				var_1_10017 = 0
			end

			var_90_7[iter_90_3] = var_1_10017
		end
	end
...
function var_0_1.addActivityParameter(arg_92_0, arg_92_1)
	...
	for iter_92_0, iter_92_1 in var_4(var_92_0) do
...
function var_0_1.IsShowFreeBuildMark(arg_94_0, arg_94_1)
	...
	for iter_94_0, iter_94_1 in var_1_10002(var_94_1(var_94_0, var_1_10005.ACTIVITY_TYPE_BUILD_FREE)) do
...
function var_0_1.getBuildFreeActivityByBuildId(arg_95_0, arg_95_1)
	...
	for iter_95_0, iter_95_1 in var_1_10002(var_95_1(var_95_0, var_1_10005.ACTIVITY_TYPE_BUILD_FREE)) do
		underscore = var_1_10007

		if var_1_10007.any(iter_95_1:getConfig("config_data"), function(arg_96_0)
...
function var_0_1.AtelierActivityAllSlotIsEmpty(arg_108_0)
	...
	if not var_108_1(var_108_0, var_1_10003.ACTIVITY_TYPE_ATELIER_LINK) or var_1:isEnd() then
		return false
	end

	local var_108_2 = var_1
	local var_108_3 = var_1.GetSlots(var_108_2)

	pairs = var_108_2

	for iter_108_0, iter_108_1 in var_108_2(var_108_3) do
...
function var_0_1.OwnAtelierActivityItemCnt(arg_109_0, arg_109_1, arg_109_2)
	...
	if not var_109_1(var_109_0, var_1_10005.ACTIVITY_TYPE_ATELIER_LINK) or var_3:isEnd() then
		return false
	end
...
function var_0_1.GetTaskActivities(arg_117_0)
	...
	Activity = var_1_10003

	var_117_1(var_1_10003.GetType2Class(), function(arg_118_0, arg_118_1)
		isa = var_2_10002

		local var_118_0 = arg_118_1

		ITaskActivity = var_2_10004

		if not var_2_10002(var_118_0, var_2_10004) then
			return
		end
		...
		var_118_1(var_118_2, var_4.getActivitiesByType(var_118_3, arg_118_0))
...
function var_0_1.setSurveyState(arg_119_0, arg_119_1)
	...
	if var_119_1(var_119_0, var_1_10004.ACTIVITY_TYPE_SURVEY) and not var_2:isEnd() then
		...
		if arg_119_1 > 0 then
			...
			var_119_3(var_119_2, var_1_10005.SURVEY_DONE, var_2)
		end
	end
...
function var_0_1.isSurveyDone(arg_120_0)
	...
	if var_120_1(var_120_0, var_1_10003.ACTIVITY_TYPE_SURVEY) and not var_1:isEnd() then
		local var_120_2
...
function var_0_1.isSurveyOpen(arg_121_0)
	...
	if var_121_1(var_121_0, var_1_10003.ACTIVITY_TYPE_SURVEY) and not var_1:isEnd() then
		...
		if var_121_2 == 1 then
			...
			local var_121_4 = var_1_10005(var_1_10006)
...
function var_0_1.GetActBossLinkPTActID(arg_122_0, arg_122_1)
	...
	return var_1_10002.Find(arg_122_0.data, function(arg_123_0, arg_123_1)
		...
		local var_123_1 = arg_123_1.getConfig(var_123_0, "type")

		ActivityConst = var_123_0

		if var_123_1 ~= var_123_0.ACTIVITY_TYPE_PT_BUFF then
			return
		end
...
function var_0_1.CheckDailyEventRequest(arg_124_0, arg_124_1)
	if arg_124_1:CheckDailyEventRequest() then
		...
		var_124_1(var_124_0, var_1_10004.SINGLE_EVENT_REFRESH, {
			actId = arg_124_1.id
		})
	end
...
function var_0_1.IsTipLoveLetterMail(arg_125_0)
	...
	var_125_2 = var_125_1(var_125_0, var_1_10003.ACTIVITY_TYPE_LOVE_LETTER_MAIL) and not var_1:isEnd() and var_1:readyToAchieve()
...
function var_0_1.GetBossRushActivities(arg_126_0, arg_126_1)
	...
	local var_126_2 = var_126_1(var_126_0, var_1_10004.ACTIVITY_TYPE_BOSSRUSH)

	_ = var_126_0

	return var_126_0.select(var_126_2, function(arg_127_0)
		pg = var_2_10001
...
function var_0_1.GetBossRushActivityById(arg_129_0, arg_129_1)
	if arg_129_0:getActivityById(arg_129_1) then
		local var_129_0 = var_2
		local var_129_1 = var_2.getConfig(var_129_0, "type")
...
function var_0_1.GetBossActivityByChapterId(arg_130_0, arg_130_1)
	...
	local var_130_0 = var_1_10002(var_1_10003)
	local var_130_1 = var_2.getActivitiesByType

	ActivityConst = var_1_10004

	local var_130_2 = var_130_1(var_130_0, var_1_10004.ACTIVITY_TYPE_BOSSRUSH)

	ipairs = var_130_0

	for iter_130_0, iter_130_1 in var_130_0(var_130_2) do
		if not iter_130_1:isEnd() then
			local var_130_3 = iter_130_1
			local var_130_4 = iter_130_1.getConfig(var_130_3, "config_data")

			table = var_130_3

			if var_130_3.contains(var_130_4, arg_130_1) then
				return iter_130_1
			end
		end
	end
...
function var_0_1.GetFakeGiftPackActivity(arg_131_0, arg_131_1)
	...
	ActivityConst = var_1_10006
	var_131_2[1] = var_1_10006.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE
	ActivityConst = var_6
	var_131_2[2] = var_6.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE

	for iter_131_0, iter_131_1 in var_1_10002(var_131_1(var_131_0, var_131_2)) do
		switch = var_1_10007

		local var_131_3 = iter_131_1:getConfig("type")
		local var_131_4 = {}

		ActivityConst = var_10
		var_131_4[var_10.ACTIVITY_TYPE_SKIN_FAKE_PACKAGE] = function()
			...
			if not var_0.isEnd(var_132_0) and iter_131_1.data1 < 1 then
				...
				var_132_3 = var_132_1(var_1.getConfig(var_132_2, "config_data")[1], function(arg_133_0)
					pg = var_3_10001
		...
		ActivityConst = var_10
		var_131_4[var_10.ACTIVITY_TYPE_TIMES_FAKE_PACKAGE] = function()
			pg = var_2_10000
			...
			if not var_1.isEnd(var_134_3) and iter_131_1.data1 < var_134_2.limit_count then
				...
				if var_134_4.any(var_134_2.skin, function(arg_135_0)
					...
					var_134_4 = not var_134_4.all(var_134_2.skin, function(arg_136_0)
						...
						local var_136_0 = var_3_10001(var_3_10002)
		...
		if var_1_10007(var_131_3, var_131_4, function()
			return
		end) then
			return iter_131_1
		end
