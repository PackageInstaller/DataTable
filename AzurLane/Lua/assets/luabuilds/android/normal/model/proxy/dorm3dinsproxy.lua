		...
		for iter_3_0, iter_3_1 in var_2_10001(arg_3_0.list) do
			...
			var_2_10006(iter_3_1.type, {
				[var_0_1.UNLOCK_TYPE_CHAT] = function()
					...
					local var_4_0 = var_3_10000(var_3_10001)
...
function var_0_1.BuildInstagrams(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_2, iter_8_3 in var_6(var_8_2) do
		...
		if var_8_1[iter_8_3] then
			...
			Instagram3Dorm = var_1_10013

			var_8_3(var_8_4, var_1_10013.New(var_8_1[iter_8_3], false))
		else
			table = var_8_3
			...
			var_8_5(var_8_6, var_1_10013.New({
				id = iter_8_3
			}))
		end
	end
...
function var_0_1.UnlockInstagram(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_1 = arg_10_0.GetInstagramList(var_10_0, arg_10_1)

	_ = var_10_0

	if var_10_0.detect(var_10_1, function(arg_11_0)
...
function var_0_1.AnyInstagramShouldTip(arg_12_0, arg_12_1)
	...
	local var_12_1 = arg_12_0.GetInstagramList(var_12_0, arg_12_1)

	_ = var_12_0

	return var_12_0.any(var_12_1 or {}, function(arg_13_0)
...
function var_0_1.AllInstagramShouldTip(arg_14_0)
	...
	return var_14_0(var_1_10002.keys(arg_14_0.instagrams), function(arg_15_0)
...
function var_0_1.BuildPhoneData(arg_16_0)
	...
	for iter_16_0, iter_16_1 in var_1_10002(var_1_10003.dorm3d_ins_telephone_group.get_id_list_by_ship_group) do
		local var_16_1 = {}
		...
		var_1_10008.each(iter_16_1, function(arg_17_0)
			...
			Dorm3dInsPhone = var_2_10003

			var_17_0(var_17_1, var_2_10003.New(arg_17_0))
...
function var_0_1.UnlockPhone(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	local var_19_1 = arg_19_0.GetPhoneListByGroup(var_19_0, arg_19_1)

	_ = var_19_0

	if var_19_0.detect(var_19_1, function(arg_20_0)
...
function var_0_1.ExtendPhoneData(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_1 = arg_21_0.GetPhoneListByGroup(var_21_0, arg_21_1)

	ipairs = var_21_0

	for iter_21_0, iter_21_1 in var_21_0(arg_21_2) do
		_ = var_1_10009

		if var_1_10009.detect(var_21_1, function(arg_22_0)
...
function var_0_1.ShoudTipPhoneById(arg_23_0, arg_23_1)
	...
	if not arg_23_0.GetPhoneListByGroup(var_23_0, arg_23_1) then
		return false
	end

	_ = var_23_0

	return var_23_0.any(var_2, function(arg_24_0)
...
function var_0_1.AnyPhoneShouldTip(arg_25_0)
	...
	return var_25_0(var_1_10002.keys(arg_25_0.insPhoneData), function(arg_26_0)
...
function var_0_1.BuildRoomList(arg_27_0)
	...
	var_27_1(var_1_10003.dorm3d_rooms.all, function(arg_28_0)
		pg = var_2_10001
		...
		if var_2_10001.dorm3d_rooms[arg_28_0].type == 1 then
			...
			if #var_28_0.dorm3d_rooms[arg_28_0].character_pay > 0 then
				...
				Dorm3dInsPublicRoom = var_2_10003
		...
		if var_28_0.dorm3d_rooms[arg_28_0].type == 2 then
			...
			Dorm3dInsCharRoom = var_2_10003

			var_28_2(var_28_3, var_2_10003.New(arg_28_0))
		end
