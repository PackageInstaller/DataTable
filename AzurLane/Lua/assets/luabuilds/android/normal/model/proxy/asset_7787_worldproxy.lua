...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(33114, function(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003.TypeBase)

		local var_2_2 = arg_1_0.world

		underscore = var_2_0
		var_2_2.baseShipIds = var_2_0.rest(arg_2_0.ship_id_list, 1)
		...
		var_2_7(var_2_6, var_3.WORLD_GET_BOSS)
	...
	arg_1_0:on(33105, function(arg_3_0)
		...
		var_3_0(var_3_1, "active map not exist.")
	...
	arg_1_0:on(33203, function(arg_4_0)
		...
		for iter_4_0, iter_4_1 in var_4_0(arg_4_0.update_list) do
			...
			if var_4_1:getTaskById(var_2_10007.id) then
				...
				var_4_3(var_4_2, var_10.WORLD_TRIGGER_TASK_DONE, {
					task = var_2_10007
				})
			end
		end
	...
	arg_1_0:on(33204, function(arg_5_0)
		...
		for iter_5_0, iter_5_1 in var_5_0(arg_5_0.delete_list) do
	...
	arg_1_0:on(34507, function(arg_7_0)
		if arg_1_0.world then
			...
			var_7_3(var_7_2, var_7_4, var_2_10006.New(arg_7_0.user_info))
			...
			local var_7_7 = var_5.TimeMgr.GetInstance()

			var_7_6(var_7_5, var_5.GetServerTime(var_7_7))
			...
			if not var_7_1:IsSelfBoss(var_2) then
				...
				if var_7_9(var_7_8, var_5.SystemWorldBoss) then
					pg = var_3
	...
	arg_1_0:on(34508, function(arg_8_0)
		...
		if var_1.GetBossProxy(var_8_0).isSetup then
			...
			var_8_2(var_8_1, var_2_10004.WORLD_GET_BOSS_RANK, {
...
function var_0_1.BuildTestFunc(arg_13_0)
	...
	local function var_13_2()
		...
		if var_0.CheckIdentityFlag(var_14_1) then
			...
			world_skip_battle = var_2_10003

			var_14_3(var_14_4, var_2_10003)
			...
			var_14_6(var_14_5, var_2_10003 == 1 and "已开启大世界战斗跳略" or "已关闭大世界战斗跳略")
		end
	...
	if var_1 then
		local function var_13_3()
			...
			if var_15_1(var_15_0, var_2_10002.__cname) then
...
function var_0_1.BuildWorld(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_0.world then
		...
		tobool = var_1_10007
		var_17_3 = var_17_3(var_17_2, var_1_10007(arg_17_2))
	end
...
function var_0_1.NetUpdateWorld(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	var_19_3(var_19_2, var_8.rest(arg_19_1.chapter_list, 1))
	...
	var_19_5(var_19_4, var_8.rest(arg_19_1.sairen_chapter, 1))
	...
	var_7(var_19_9 == var_9(var_19_7), "error active map info:" .. arg_19_1.map_id)

	if var_19_7 then
		local var_19_10 = arg_19_1.enter_map_id
		local var_19_11 = var_19_7.random_id
		local var_19_12 = var_19_7.template_id
		local var_19_13 = var_4:GetEntrance(var_19_10)
		local var_19_14 = var_4
		local var_19_15 = var_4.GetMap(var_19_14, var_19_11)

		assert = var_19_14

		var_19_14(var_19_13, "entrance not exist: " .. var_19_10)

		assert = var_19_14

		var_19_14(var_19_15, "map not exist: " .. var_19_11)

		assert = var_19_14
		pg = var_13

		var_19_14(var_13.world_chapter_template[var_19_12], "world_chapter_template not exist: " .. var_19_12)

		assert = var_19_14

		var_19_14(#arg_19_1.group_list > 0, "amount of group_list is not enough.")
		var_19_13:UpdateActive(true)

		local var_19_16 = var_19_15

		var_19_15.UpdateGridId(var_19_16, var_19_12)

		local var_19_17 = arg_19_1.group_list[1].id

		table = var_19_16
		var_19_15.findex = var_19_16.indexof(var_4.fleets, var_4:GetFleet(var_19_17))

		var_19_15:BindFleets(var_4.fleets)
		var_19_15:UpdateActive(true)
	end
...
function var_0_1.NetUpdateActiveMap(arg_31_0, arg_31_1, arg_31_2, arg_31_3)
	...
	var_31_6(var_31_7, "entrance not exist: " .. arg_31_1)
	...
	var_31_8(var_31_9, "map not exist: " .. arg_31_2)
...
function var_0_1.NetUpdateMap(arg_32_0, arg_32_1)
	...
	var_1_10004(var_1_10005.world_chapter_random[var_32_0], "world_chapter_random not exist: " .. var_32_0)

	assert = var_1_10004
	pg = var_5

	var_1_10004(var_5.world_chapter_template[var_32_1], "world_chapter_template not exist: " .. var_32_1)

	local var_32_2 = {}

	_ = var_5

	var_5.each(arg_32_1.state_flag, function(arg_33_0)
	...
	if not var_32_2[2] then
		...
		var_32_8 = var_8.IsMapVisioned(var_32_7, var_32_0)
	end
...
function var_0_1.NetUpdateMapDiscoveredCells(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	var_34_0(var_34_1, "map not exist: " .. arg_34_1)

	if arg_34_2 then
		pairs = var_34_0

		for iter_34_0, iter_34_1 in var_34_0(var_34_1.cells) do
			iter_34_1:UpdateDiscovered(true)
		end
	else
		_ = var_34_0

		var_34_0.each(arg_34_3, function(arg_35_0)
			local var_35_0 = var_34_1
			local var_35_1 = var_1.GetCell(var_35_0, arg_35_0.pos.row, arg_35_0.pos.column)

			assert = var_35_0

			var_35_0(var_35_1, "cell not exist: " .. arg_35_0.pos.row .. ", " .. arg_35_0.pos.column)
...
function var_0_1.NetUpdateMapPort(arg_36_0, arg_36_1, arg_36_2)
	...
	var_36_0(var_36_1, "map not exist: " .. arg_36_1)

	local var_36_2 = var_36_1
	local var_36_3 = var_36_1.GetPort(var_36_2, arg_36_2.port_id)

	assert = var_36_2

	var_36_2(var_36_3, "port not exist: " .. arg_36_2.port_id)

	local var_36_4 = var_36_3
	local var_36_5 = var_36_3.UpdateTaskIds

	_ = var_7

	var_36_5(var_36_4, var_7.rest(arg_36_2.task_list, 1))

	local var_36_6 = var_36_3
	local var_36_7 = var_36_3.UpdateGoods

	_ = var_7

	var_36_7(var_36_6, var_7.map(arg_36_2.goods_list, function(arg_37_0)
		WPool = var_2_10001

		local var_37_0 = var_2_10001
		local var_37_1 = var_2_10001.Get

		WorldGoods = var_2_10003

		local var_37_2 = var_37_1(var_37_0, var_2_10003)

		var_1.Setup(var_37_2, arg_37_0)

		return var_1
	end))
	var_36_3:UpdateExpiredTime(arg_36_2.next_refresh_time)
...
function var_0_1.NetUpdateAchievements(arg_38_0, arg_38_1)
	...
	var_1_10002.each(arg_38_1, function(arg_39_0)
		...
		var_39_3(var_39_2, var_2_10004.EventAchieved, var_39_1:NetUpdate(arg_39_0.process_list))
...
function var_0_1.NetBuildMapFleetList(arg_40_0, arg_40_1)
	...
	if arg_40_1 and #arg_40_1 > 0 then
		...
		var_3.each(arg_40_1, function(arg_41_0)
		...
		FleetType = var_4
		var_40_1[var_4.Normal] = 1
		FleetType = var_4
		var_40_1[var_4.Submarine] = 1
		_ = var_4
...
function var_0_1.NetBuildPortShipList(arg_44_0, arg_44_1)
	...
	return var_1_10002.map(arg_44_1, function(arg_45_0)
		...
		local var_45_2 = var_45_1(var_45_0, var_2_10003)
...
function var_0_1.NetResetWorld(arg_46_0)
	...
	var_46_1(var_46_0, var_1_10003.SEND_CMD, {
		cmd = "world",
		arg1 = "reset"
	})
	...
	var_46_3(var_46_2, var_3.SEND_CMD, {
		cmd = "kick"
	})
...
function var_0_1.NetBuildMapAttachmentCells(arg_47_0, arg_47_1)
	...
	for iter_47_0, iter_47_1 in var_3(var_47_0) do
		...
		var_1_10009.each(iter_47_1.attachmentList, function(arg_49_0)
			...
			local var_49_2 = var_49_1(var_49_0, var_2_10003)
			local var_49_3 = var_1.Setup

			setmetatable = var_2_10004

			var_49_3(var_49_2, var_2_10004({
				pos = iter_47_1.pos
			}, {
				__index = arg_49_0
			}))
...
function var_0_1.UpdateMapAttachmentCells(arg_50_0, arg_50_1, arg_50_2)
	...
	var_50_0(var_50_1, "map not exist: " .. arg_50_1)

	pairs = var_50_0

	for iter_50_0, iter_50_1 in var_50_0(arg_50_2) do
	...
	var_1_10003.each(arg_54_1, function(arg_55_0)
		...
		var_2.each(arg_55_0.item_list, function(arg_56_0)
			...
			if var_56_0 == var_3_10002.TypeFleet then
				...
				NetFleetAttachUpdate = var_3_10003

				local var_56_3 = var_56_2(var_56_1, var_3_10003)
				local var_56_4 = var_1.Setup

				setmetatable = var_3_10004

				var_56_4(var_56_3, var_3_10004({
					pos = var_55_0
				}, {
					__index = arg_56_0
				}))
...
function var_0_1.ApplyFleetAttachUpdate(arg_57_0, arg_57_1, arg_57_2)
	...
	var_57_0(var_57_1, "map not exist: " .. arg_57_1)

	_ = var_57_0

	var_57_0.each(arg_57_2, function(arg_58_0)
...
function var_0_1.NetBulidTerrainUpdate(arg_59_0, arg_59_1)
	...
	return var_1_10002.map(arg_59_1, function(arg_60_0)
		...
		NetTerrainUpdate = var_2_10003

		local var_60_2 = var_60_1(var_60_0, var_2_10003)
...
function var_0_1.ApplyTerrainUpdate(arg_61_0, arg_61_1, arg_61_2)
	...
	var_61_0(var_61_1, "map not exist: " .. arg_61_1)

	_ = var_61_0

	var_61_0.each(arg_61_2, function(arg_62_0)
		...
		if var_2.FindFleet(var_62_2, var_62_1.row, var_62_1.column) then
			...
			var_3.CheckFleetUpdateFOV(var_62_3, var_2, function()
				...
				var_63_1(var_63_0, var_2.GetTerrain(var_63_2), arg_62_0.terrainDir, arg_62_0.terrainStrong)
...
function var_0_1.NetBuildFleetUpdate(arg_64_0, arg_64_1)
	...
	return var_1_10002.map(arg_64_1, function(arg_65_0)
		...
		NetFleetUpdate = var_2_10003

		local var_65_2 = var_65_1(var_65_0, var_2_10003)
...
function var_0_1.ApplyFleetUpdate(arg_66_0, arg_66_1, arg_66_2)
	...
	var_66_0(var_66_1, "map not exist: " .. arg_66_1)

	_ = var_66_0

	var_66_0.each(arg_66_2, function(arg_67_0)
		local var_67_0 = var_66_1
		local var_67_1 = var_1.GetFleet(var_67_0, arg_67_0.id)

		assert = var_67_0

		var_67_0(var_67_1, "fleet not exist: " .. arg_67_0.id)
...
function var_0_1.NetBuildShipUpdate(arg_69_0, arg_69_1)
	...
	return var_1_10002.map(arg_69_1, function(arg_70_0)
		...
		NetShipUpdate = var_2_10003

		local var_70_2 = var_70_1(var_70_0, var_2_10003)
...
function var_0_1.ApplyShipUpdate(arg_71_0, arg_71_1)
	...
	var_1_10002.each(arg_71_1, function(arg_72_0)
		...
		var_72_0(var_72_1, "ship not exist: " .. arg_72_0.id)
...
function var_0_1.NetUpdateWorldPressingAward(arg_76_0, arg_76_1)
	...
	var_76_0.each(arg_76_1, function(arg_77_0)
...
function var_0_1.NetBuildSalvageUpdate(arg_79_0, arg_79_1)
	...
	return var_1_10002.map(arg_79_1, function(arg_80_0)
		...
		NetSalvageUpdate = var_2_10003

		local var_80_2 = var_80_1(var_80_0, var_2_10003)
...
function var_0_1.ApplySalvageUpdate(arg_81_0, arg_81_1)
	...
	var_1_10002.each(arg_81_1, function(arg_82_0)
		...
		var_82_0(var_82_1, "fleet not exit: " .. arg_82_0.id)
