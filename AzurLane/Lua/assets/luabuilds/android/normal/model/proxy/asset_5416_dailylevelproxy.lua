...
function var_0_1.register(arg_1_0)
	...
	arg_1_0:on(13201, function(arg_2_0)
		...
		getProxy = var_2_1
		ChapterProxy = var_2
		var_2_1(var_2).escortChallengeTimes = arg_2_0.escort_expedition_count
		ipairs = var_2
		...
		Clone = iter_2_4
		var_2_4.dailyList = var_2_5(iter_2_4(var_2_3.all))
...
function var_0_1.updateChapterDefeatCount(arg_12_0, arg_12_1)
	...
	if var_12_0.detect(arg_12_0.chapterCountList, function(arg_13_0)
		...
		var_4.insert(arg_12_0.chapterCountList, {
			id = arg_12_1,
			count = var_12_1
		})
	end
...
function var_0_1.resetDailyCount(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_14_1(arg_14_0.data) do
...
function var_0_1.GetRestEliteCount(arg_15_0)
	...
	return var_15_0(var_15_1, var_1_10003.gameset.elite_quota.key_value - arg_15_0.eliteCount)
end
...
function var_0_1.EliteCountPlus(arg_17_0)
	...
	pg = var_1_10003
	arg_17_0.eliteCount = var_17_0(var_17_1, var_1_10003.gameset.elite_quota.key_value)
