...
local var_0_3 = var_2.item_data_chat
...
function var_0_1.register(arg_1_0)
	...
	if var_2.gameset.new_auto_unlock_combat_ui.description ~= var_1_6 then
		...
		pg = var_3
		var_1_7 = var_1_7(var_3.gameset.new_auto_unlock_combat_ui.description, "|")
		ipairs = var_3
	...
	var_1_9(var_1_10, iter_1_4.gameset.new_auto_unlock_combat_ui.description)
	...
	if var_0_5 then
		...
		arg_1_0.timer = var_2.New(function()
			...
			for iter_3_0 = 1, 5 do
				...
				local var_3_2 = var_7.New
				local var_3_3 = {
					count = 1
				}

				if iter_3_0 % 2 == 0 then
					DROP_TYPE_ICON_FRAME = var_9

					if not var_9 then
						DROP_TYPE_CHAT_FRAME = var_9
					end

					var_3_3.type = var_9
					var_3_3.id = var_3_1[var_2_10006]

					local var_3_4 = var_3_2(var_3_3)
					local var_3_5 = arg_1_0
					local var_3_6 = var_8.sendNotification

					GAME = var_2_10010

					var_3_6(var_3_5, var_2_10010.ADD_ITEM, var_3_4)

					table = var_3_6

					var_3_6.insert(var_3_0, var_3_4)
				end
			end

			table = var_2

			local var_3_7 = var_2.insert
			local var_3_8 = var_3_0

			Drop = var_4

			local var_3_9 = var_4.New
			local var_3_10 = {
				count = 1000
			}

			DROP_TYPE_RESOURCE = var_2_10006
			var_3_10.type = var_2_10006
			PlayerConst = var_2_10006
			var_3_10.id = var_2_10006.ResGold

			var_3_7(var_3_8, var_3_9(var_3_10))
			...
			var_3_12(var_3_11, var_4.ACT_NEW_PT_DONE, {
				awards = var_3_0
			})
...
function var_0_1.getDataAndTrophys(arg_4_0, arg_4_1)
	...
	local var_4_1 = arg_4_0.getData(var_4_0)

	if arg_4_1 then
		var_1_10004 = arg_4_0

		arg_4_0.clearNew(var_1_10004)
	end
	...
	var_4_1.trophys = var_3.getTrophys(var_4_2)
	getProxy = var_3
	LoveLetterProxy = var_4_2

	local var_4_3 = var_3(var_4_2)

	var_4_1.loveTrophys = var_3.GetTrophyList(var_4_3)
...
function var_0_1.updateAttireFrame(arg_9_0, arg_9_1)
	...
	local var_9_1 = arg_9_1.getType(var_9_0)

	AttireConst = var_9_0

	local var_9_2

	if var_9_1 == var_9_0.TYPE_ICON_FRAME then
		assert = var_9_2

		var_9_2(arg_9_0.data.iconFrames[arg_9_1.id])

		var_9_2 = arg_9_0.data.iconFrames
		...
		if var_9_1 == var_9_2.TYPE_CHAT_FRAME then
			assert = var_9_3

			var_9_3(arg_9_0.data.chatFrames[arg_9_1.id])

			var_9_3 = arg_9_0.data.chatFrames
			var_9_3[arg_9_1.id] = arg_9_1
		else
			AttireConst = var_9_3

			if var_9_1 == var_9_3.TYPE_COMBAT_UI_STYLE then
				assert = var_3
...
function var_0_1.addExpiredTimer(arg_10_0, arg_10_1)
	...
	local function var_10_0()
		...
		var_11_5(var_11_4, var_11_6, var_7.clone(var_11_7))

		return
	end

	local var_10_1 = arg_10_1
	local var_10_2 = arg_10_1.getExpiredTime(var_10_1)
	...
	if var_10_2 - var_4.GetServerTime(var_10_3) > 0 then
		local var_10_4 = arg_10_1:getTimerKey()
		local var_10_5 = arg_10_0.timers

		Timer = var_1_10007
		var_10_5[var_10_4] = var_1_10007.New(function()
			var_10_0()
		...
		local var_10_6 = arg_10_0.timers[var_10_4]

		var_6.Start(var_10_6)
	else
		var_10_0()
	end
