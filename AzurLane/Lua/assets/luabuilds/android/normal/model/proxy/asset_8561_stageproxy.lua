...
function var_0_1.addStage(arg_5_0, arg_5_1)
	...
	var_1_10002(var_1_10003(var_5_0, var_1_10005), "should be an instance of Stage")
...
function var_0_1.updateStage(arg_7_0, arg_7_1)
	...
	var_1_10002(var_1_10003(var_7_0, var_1_10005), "should be an instance of Stage")
...
function var_0_1.addRandomStage(arg_9_0, arg_9_1)
	...
	var_1_10002(var_1_10003(var_9_0, var_1_10005), "should be an instance of Stage")
...
function var_0_1.listenerRandomStage(arg_10_0)
	...
	arg_10_0.timerId = var_1.AddTimer(var_10_0, "listenerRandomStage", 0, 1, function()
		if arg_10_0.data.randomexpeditions then
			...
			if var_0.getCount(arg_10_0.data.randomexpeditions) > 0 then
				pg = var_0
				...
				for iter_11_0, iter_11_1 in var_11_0(arg_10_0.data.randomexpeditions) do
					if iter_11_1.out_time == var_11_1 then
						local var_11_2 = arg_10_0

						var_6.removeRandomStageById(var_11_2, iter_11_1.id)
					end
				end
			end
		end
