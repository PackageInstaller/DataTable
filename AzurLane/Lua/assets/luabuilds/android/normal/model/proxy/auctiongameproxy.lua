...
function var_0_1.register(arg_1_0)
	arg_1_0:on(23400, function(arg_2_0)
		...
		var_2_2(var_2_1, var_3.PLAY_ROOM_QUICK_MATCH_SUCCESS)
	...
	arg_1_0:on(23401, function(arg_3_0)
		...
		var_3_3(var_3_2, var_3.AUCTION_GAME_NEW_ROUND)
	...
	arg_1_0:on(23404, function(arg_4_0)
		...
		if arg_4_0.event_effect and arg_4_0.event_effect.event_id ~= 0 then
			...
			var_1.SetPersonalEventSelectedID(var_4_0, arg_4_0.event_effect.event_id)

			var_4_0 = arg_1_0

			var_1.UpdateEventEffect(var_4_0, arg_4_0.event_effect)
		end

		local var_4_1 = arg_1_0

		AuctionGameConst = var_4_0
		var_4_1.auctionState = var_4_0.AUCTION_PHASE.BID

		local var_4_2 = arg_1_0

		var_1.ResetPlayerOptState(var_4_2)
		...
		var_4_4(var_4_3, var_3.AUCTION_GAME_BID_PHASE)
	...
	arg_1_0:on(23407, function(arg_6_0)
		...
		local var_6_2 = var_2_10003(var_2_10004)

		if var_6_0(var_6_1, var_3.getPlayerId(var_6_2)) then
			return
		end
		...
		var_6_5(var_6_4, var_3.AUCTION_GAME_ROUND_OVER)

		local var_6_6 = arg_1_0

		AuctionGameConst = var_6_4
		var_6_6.auctionState = var_6_4.AUCTION_PHASE.ROUND_OVER
	...
	arg_1_0:on(23408, function(arg_7_0)
		...
		var_7_2(var_7_1, var_3.AUCTION_GAME_SETTLEMENT)
	...
	arg_1_0:on(23411, function(arg_8_0)
		...
		for iter_8_0, iter_8_1 in var_2_10001(arg_8_0.user_ids) do
			...
			if iter_8_1 == var_2_10006.getPlayerId(var_2_10007) then
				var_2_10007 = arg_1_0
				var_2_10006 = var_2_10006.sendNotification
				GAME = var_2_10008

				var_2_10006(var_2_10007, var_2_10008.AUCTION_GAME_KICK)
			end
	...
	arg_1_0:on(23415, function(arg_9_0)
		...
		var_9_1(var_9_0, var_2_10003.AUCTION_GAME_SHOW_EMOJI, {
...
function var_0_1.UpdatePlayerList(arg_11_0, arg_11_1)
	...
	for iter_11_2, iter_11_3 in var_5(var_11_0) do
		...
		if var_11_4 == var_1_10011.getPlayerId(var_1_10012) then
			var_11_3 = iter_11_3
		else
			table = var_11_4
...
function var_0_1.UpdateEventEffect(arg_23_0, arg_23_1)
	...
	var_23_1(var_23_0, var_1_10004.AUCTION_GAME_EVENT_EFFECT_UPDATE)
...
function var_0_1.UpdateGroundEventList(arg_31_0, arg_31_1)
	...
	for iter_31_0, iter_31_1 in var_31_0(arg_31_1) do
		...
		if iter_31_1.event_id == nil or iter_31_1.event_id == 0 then
			...
			var_7(var_8.format("竞拍活动:轮数:%s, 玩家ID:%s, 选择事件ID:<color=red>%s</color>", arg_31_0.round, iter_31_1.user_id, iter_31_1.event_id))
		end
	end
...
function var_0_1.UpdatePlayerBidList(arg_32_0, arg_32_1)
	...
	for iter_32_0, iter_32_1 in var_32_0(arg_32_1) do
		...
		var_32_6(var_8.format("竞拍活动:轮数:%s, 玩家ID:%s, 出价:%s", arg_32_0.round, iter_32_1.user_id, iter_32_1.price))
	end
...
function var_0_1.ResetPlayerOptState(arg_33_0)
	...
	var_33_1(var_33_0, var_1_10003.AUCTION_GAME_PLAYER_OPT_STATE_UPDATE)
...
function var_0_1.UpdatePlayerOptState(arg_34_0, arg_34_1)
	...
	var_34_1(var_34_0, var_4.AUCTION_GAME_PLAYER_OPT_STATE_UPDATE)
