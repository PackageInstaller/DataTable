...
if not var_0_10001(var_0_10002, "commander_skill_template") then
...
;(function()
	...
	var_1_81[11] = {
		...
		exp = 0,
		prev_id = 0,
		desc = "依据指挥喵指挥属性，提高所在舰队中战列、战巡、航战、风帆M的炮击属性(效果中)；",
		id = 960011,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	var_1_82[12] = {
		...
		exp = 0,
		prev_id = 960011,
		desc = "所在舰队中存在任意风帆舰时，依据指挥喵战术属性，降低旗舰受到的伤害",
		id = 960012,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	var_1_83[13] = {
		...
		exp = 0,
		prev_id = 960012,
		desc = "依据指挥喵战术属性，提高队伍中风帆V、风帆M的机动属性(效果大)",
		id = 960013,
		icon = "96001",
		lv = 1,
		effect_tactic = {
	...
	var_1_84[21] = {
		...
		exp = 0,
		prev_id = 0,
		desc = "依据指挥喵指挥属性，提高所在舰队中轻巡、重巡、超巡、风帆V的命中属性(效果中)；",
		id = 960021,
		icon = "96002",
		lv = 1,
		effect_tactic = {
	...
	var_1_86[23] = {
		...
		exp = 0,
		prev_id = 960022,
		desc = "所在舰队中存在任意风帆舰时，依据指挥喵战术属性，降低轻巡、重巡、风帆舰V受到的伤害",
		id = 960023,
		icon = "96002",
		lv = 1,
		effect_tactic = {
	...
	var_1_88[960032] = {
		...
		exp = 0,
		prev_id = 960031,
		desc = "作为潜艇编队指挥喵时，进入战斗后恢复所有风帆舰2%耐久",
		id = 960032,
		icon = "96003",
		lv = 1,
		effect_tactic = {
	...
	var_1_89[960033] = {
		...
		exp = 0,
		prev_id = 960032,
		desc = "作为潜艇编队指挥喵时，进入战斗后依据指挥喵战术属性，提高所在舰队中潜艇、潜母、风帆S的命中属性（效果中）",
		id = 960033,
		icon = "96003",
		lv = 1,
		effect_tactic = {
	...
	var_1_90[960041] = {
		...
		exp = 0,
		prev_id = 0,
		desc = "所在舰队中存在任意风帆舰时，依据指挥喵指挥属性，降低先锋舰队成员受到的伤害",
		id = 960041,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	var_1_91[960042] = {
		...
		exp = 0,
		prev_id = 960041,
		desc = "作为司令位指挥喵时，依据指挥喵战术属性，提高所在舰队全员的炮击属性(效果中)",
		id = 960042,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	var_1_92[960043] = {
		...
		exp = 0,
		prev_id = 960042,
		desc = "舰队成员在战斗中受到伤害，导致耐久低于30%后，为其恢复5%耐久（每场战斗1次）",
		id = 960043,
		icon = "96004",
		lv = 1,
		effect_tactic = {
	...
	var_1_94[960052] = {
		...
		exp = 0,
		prev_id = 960051,
		desc = "作为潜艇编队指挥喵时，进入战斗后依据指挥喵指挥属性，提高所在舰队中风帆S的炮击属性，潜艇、潜母的雷击属性（效果中）",
		id = 960052,
		icon = "96005",
		lv = 1,
		effect_tactic = {
	...
	var_1_95[960053] = {
		...
		exp = 0,
		prev_id = 960052,
		desc = "所在舰队中包含皇家财富号时，进入战斗后发射一轮特殊弹幕，每场战斗一次",
		id = 960053,
		icon = "96005",
		lv = 1,
		effect_tactic = {
	...
	var_1_96[960061] = {
		...
		exp = 0,
		prev_id = 0,
		desc = "依据指挥喵战术属性，提高所在舰队中战列、战巡、航战、风帆M的炮击属性(效果中)",
		id = 960061,
		icon = "96006",
		lv = 1,
		effect_tactic = {
	...
	var_1_97[960062] = {
		...
		exp = 0,
		prev_id = 960061,
		desc = "与主力舰队交战时，依据指挥喵战术属性，提高所在舰队中战列、正航、风帆M的命中属性(效果中)",
		id = 960062,
		icon = "96006",
		lv = 1,
		effect_tactic = {
	...
	var_1_98[960063] = {
		...
		exp = 0,
		prev_id = 960062,
		desc = "所在舰队中包含安妮女王复仇号时，进入战斗后发射一轮特殊弹幕，每场战斗一次",
		id = 960063,
		icon = "96006",
		lv = 1,
		effect_tactic = {
...
;(function()
	...
	var_2_0[960072] = {
		...
		exp = 0,
		prev_id = 960071,
		desc = "作为参谋位指挥喵时，依据指挥喵后勤属性，提高先锋舰队的炮击属性(效果小)",
		id = 960072,
		icon = "96007",
		lv = 1,
		effect_tactic = {
	...
	var_2_0.base.commander_skill_template[960073] = {
		...
		exp = 0,
		prev_id = 960072,
		desc = "舰队旗舰及先锋领舰在战斗中受到伤害，导致耐久低于50%后，为其恢复5%耐久（每场战斗1次）",
		id = 960073,
		icon = "96007",
		lv = 1,
		effect_tactic = {
