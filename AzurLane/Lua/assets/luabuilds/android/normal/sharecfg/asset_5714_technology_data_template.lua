...
if not var_0_10001(var_0_10002, "technology_data_template") then
...
;(function()
	...
	var_1_0[1] = {
		...
		name = "C-153-MI",
		lv_limit = 30,
		desc = "目前一切关于心智魔方的理论基础，其基石都来源于对心智魔方的基础构造的了解程度。一些工程师们正致力于推导心智魔方的基础构造。",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
		sub_name = "中型项目",
	...
	var_1_12[21] = {
		...
		name = "T-018-MI",
		lv_limit = 30,
		desc = "除去建造方面，心智魔方在日用性上的研究也被提上了进程。该科研项目希望能够找出心智魔方在日用性上的可能性。",
		condition = 52021,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_1_15[31] = {
		...
		name = "E-031-MI",
		lv_limit = 30,
		desc = "尝试阐明心智魔方与舰装之间的联系，但这无疑必须建立在大量的实验基础之上。用一些废弃的舰装当试验品吧。",
		condition = 52031,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_1_23[41] = {
		...
		name = "G-412-MI",
		lv_limit = 30,
		desc = "科技的高速发展，离不开金钱的推动。如果指挥官愿意投入大量的研发资金，相信一定能够取得丰硕的成果。",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_1_29[51] = {
		...
		name = "D-718-MI",
		lv_limit = 30,
		desc = "心智魔方能够具象化人类对于某一事物的认知集合，如果能够定向心智魔方具象化的目标，会有什么样的效果呢？",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_1_41[71] = {
		...
		name = "Q-302-MI",
		lv_limit = 30,
		desc = "从已观测到的心智魔方与舰装的相互影响效果中，试图以可控并且稳定的方式，寻找可以利用这一效果的场景。",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_1_56[91] = {
		...
		name = "H-387-MI",
		lv_limit = 30,
		desc = "虽然至今仍未有成功的记录。但是对于心智魔方的构造研究，最简单并且粗暴的方法，就是将心智魔方分解解析。",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
		sub_name = "小型项目",
...
;(function()
	...
	var_6_26[1013] = {
		...
		name = "D-018-UL",
		lv_limit = 30,
		desc = "在心智魔方的认知具象化实验中，突然产生异常的离散值升高的现象。找到异常的产生原因将会大大拓展我们对心智魔方的理论认知。",
		condition = 0,
		bg = "3",
		blueprint_version = 1,
		sub_name = "小型项目",
	...
	var_6_32[1019] = {
		...
		name = "Q-002-UL",
		lv_limit = 30,
		desc = "在心智魔方与舰装的影响实验中，突然对某一部件产生了极高的相适度，也许这其中隐藏着一些我们都未所知的原理存在。",
		condition = 0,
		bg = "3",
		blueprint_version = 1,
		sub_name = "小型项目",
