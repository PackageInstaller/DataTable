...
if not var_0_10001(var_0_10002, "island_chara_skill") then
...
;(function()
	...
	var_1_28[1028] = {
		...
		id = 1028,
		icon = "chara_all_skill_14",
		desc = "在基地工厂使用手工制作设备工作时，每次生产有$1%概率获得额外产出",
		desc_add = {
			{
				{
					"6"
	...
	var_1_29[1029] = {
		...
		id = 1029,
		icon = "chara_all_skill_8",
		desc = "在翠土林场工作时，工作速度提高$1%；当体力低于70时，与莫加多尔打招呼可恢复$2体力，每日限1次",
		desc_add = {
			{
				{
					"1"
	...
	var_1_30[1030] = {
		...
		id = 1030,
		icon = "chara_all_skill_12",
		desc = "在任意店铺工作时，体力消耗减少$1%；委派为任意店铺的店员时，当前店铺每个餐品格的容量+1",
		desc_add = {
			{
				{
					"3"
	...
	var_1_31[1031] = {
		...
		desc = "与皇家财富号打招呼时，可获得一次随机奖励（$1），每日限1次",
		desc_add = {
			{
				{
					"Lv1"
	...
	var_1_32[1032] = {
		...
		id = 1032,
		icon = "chara_all_skill_4",
		desc = "在啾咖啡工作时，每次生产有$1%概率获得额外产出，餐品营业利润增加$2%",
		desc_add = {
			{
				{
					"1"
