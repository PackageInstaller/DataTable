...
if not var_0_10001(var_0_10002, "puzzle_combat_template") then
...
var_0.puzzle_combat_template = var_0_2
pg = var_0

local var_0_3 = var_0.puzzle_combat_template
...
pg = var_0_3
var_0_3.base.puzzle_combat_template = {}

;(function()
	pg = var_1_10000

	local var_1_0 = var_1_10000.base.puzzle_combat_template
	...
	local var_1_1 = var_1_0.base.puzzle_combat_template
	...
	local var_1_2 = var_1_1.base.puzzle_combat_template
	...
	local var_1_3 = var_1_2.base.puzzle_combat_template
	...
	pg = var_1_3
	var_1_3.base.puzzle_combat_template[106] = {
