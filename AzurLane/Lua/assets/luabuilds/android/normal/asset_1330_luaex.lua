...
local function var_0_2()
	...
	var_1.SetInt("stage_scratch", var_1_1)
...
local function var_0_5(arg_3_0)
	...
	if var_1.CheckPretest(var_3_0) then
		...
		IsUnityEditor = var_3_0

		if var_3_0 then
			PathMgr = var_3_0
			var_3_1 = var_3_0.getAssetBundle("../localization.txt")
		else
			Application = var_3_0
			var_3_1 = var_3_0.persistentDataPath .. "/localization.txt"
		end

		if arg_3_0 == "true" then
			System = var_3_0

			var_3_0.IO.File.WriteAllText(var_3_1, "Localization = true\nLocalization_skin = true")
		end

		if arg_3_0 == "false" then
			System = var_3_0

			var_3_0.IO.File.WriteAllText(var_3_1, "Localization = false\nLocalization_skin = false")
		end
	end
...
function var_0_10002.execute(arg_4_0, arg_4_1)
	...
	var_4_0(var_4_1.cmd, "cmd should exist")
	...
	if var_4_1.cmd == "local" then
		...
		if var_4_1.arg1 == "debug" then
			...
			if var_4_1.arg1 == "story" then
				...
				if var_3.CheckPretest(var_4_2) then
					...
					if var_4_2(var_4_3) then
						pg = var_4_2
						var_4_4 = var_4_2.NewStoryMgr.GetInstance()
						var_4_2 = var_4_2.StoryId2StoryName
						tonumber = var_1_10006
						var_4_3 = var_4_2(var_4_4, var_1_10006(var_4_1.arg2))
					end
					...
					if var_4_3 then
						...
						var_4_2.Play(var_4_4, var_4_3, function()
							return
						end, true)
					else
						pg = var_4_2
						var_4_4 = var_4_2.TipsMgr.GetInstance()

						var_4_2.ShowTips(var_4_4, "不存在剧情")
					end
			...
			elseif var_4_1.arg1 == "time" then
				...
				var_4_2 = "server time: "
				pg = var_4_4
				var_1_10006 = var_4_4.TimeMgr.GetInstance()

				var_3(var_4_2 .. var_4_4.GetServerTime(var_1_10006))
			elseif var_4_1.arg1 == "act" then
				...
				for iter_4_0, iter_4_1 in var_4_2(var_4_6) do
					print = var_1_10009
			...
			elseif var_4_1.arg1 == "guide" then
				...
				if var_3.isEditor then
					if not var_4_1.arg2 or var_4_1.arg2 == "" then
						...
						getProxy = var_4_2
						PlayerProxy = var_4_4
						var_4_4 = var_4_2(var_4_4)

						var_3(var_4_2.getRawData(var_4_4).guideIndex)
					else
						var_4_2 = arg_4_0
						...
						tonumber = iter_4_0
						var_1_10006.index = iter_4_0(var_4_1.arg2)

						var_4_7(var_4_2, var_4_4, var_1_10006)
					end
				end
			elseif var_4_1.arg1 == "newguide" then
				...
				if var_3.isEditor then
					if not var_4_1.arg2 or var_4_1.arg2 == "" then
						...
						var_3(var_4.getRawData(var_4_4).newGuideIndex)
					else
						local var_4_8 = arg_4_0
						local var_4_9 = arg_4_0.sendNotification

						GAME = var_4_4

						local var_4_10 = var_4_4.UPDATE_GUIDE_INDEX
						...
						var_4_9(var_4_8, var_4_10, var_1_10006)
					end
				end
	...
	local var_4_11 = var_4_1.cmd
	local var_4_12 = var_4_1.arg1
	local var_4_13 = var_4_1.arg2

	pg = var_1_10006

	local var_4_14 = var_1_10006.ConnectionMgr.GetInstance()

	var_6.Send(var_4_14, 11100, {
		cmd = var_4_1.cmd,
		arg1 = var_4_1.arg1,
		arg2 = var_4_1.arg2,
		arg3 = var_4_1.arg3,
		...
		var_6_1(var_6_0, var_3.SEND_CMD_DONE, arg_6_0.msg)

		if var_4_11 == "into" then
			string = var_1
			...
			if var_1.find(arg_6_0.msg, "Result:ok") then
				...
				tonumber = var_6_0
				var_6_2.stageId = var_6_0(var_4_12)
				SYSTEM_TEST = var_6_0
				var_6_2.system = var_6_0
				var_6_2.drops = {}
				tonumber = var_6_0
				var_6_2.cmdArgs = var_6_0(var_4_13)
				...
				local var_6_4 = var_4.GO_SCENE

				SCENE = var_2_10005

				var_6_0(var_6_3, var_6_4, var_2_10005.COMBATLOAD, var_6_2)

				goto label_6_0
			end
		end

		if var_4_11 == "kill" then
			getProxy = var_1
			PlayerProxy = var_6_0
			...
			var_6_5.DeleteKey("last_map" .. var_6_6.id)
		...
		elseif var_4_11 ~= "time" and var_4_11 == "nowtime" then
			-- block empty
		end
...
_G = var_0_10079
var_0_10079[var_0_72][var_0_73] = function(arg_19_0, arg_19_1)
	...
	local var_19_1 = #var_19_0(var_3[var_0_75])[var_0_76](var_2)
