...
function var_0.GetBuildActIDList()
	...
	for iter_12_0, iter_12_1 in var_1_10001(var_1_10002.activity_template.all) do
...
function var_0.GetShipConfigIDListByPoolList(arg_14_0)
	...
	for iter_14_0, iter_14_1 in var_1_10002(var_1_10003.ship_data_create) do
		local var_14_1 = iter_14_1.weight_group

		if var_0.IsPoolWeightConfigMatch(var_14_1, arg_14_0) then
			table = var_9

			if not var_9.contains(var_14_0, iter_14_0) then
				table = var_9

				var_9.insert(var_14_0, iter_14_0)
			end
		end
	end
	...
	if var_1_10004(arg_15_0) == "number" then
		...
		if var_4(arg_15_1) == "number" then
			...
			if var_4(arg_15_2) == "number" then
				...
				if var_4(var_5.ship_data_create) == "table" then
					type = var_4
					pg = var_5

					if var_4(var_5.ship_data_statistics) ~= "table" then
						return var_15_0
					end
					...
					for iter_15_0, iter_15_1 in var_4(var_5.ship_data_create) do
						type = var_1_10009
						...
						if var_1_10009(iter_15_0) == "number" then
							...
							if var_1_10009(iter_15_1) == "table" then
								...
								local var_15_1 = var_10.ship_data_statistics[iter_15_0]

								type = var_1_10011

								if var_1_10011(var_1_10009) == "number" and 0 < var_1_10009 then
									type = var_1_10011

									if var_1_10011(var_15_1) == "table" and var_15_1.rarity == arg_15_1 and var_15_1.type == arg_15_2 then
										table = var_1_10011

										var_1_10011.insert(var_15_0, iter_15_0)
									end
								end
							end
						end
...
function var_0.GetActID2MemoryMap()
	...
	for iter_16_0, iter_16_1 in var_1_10001(var_1_10002.memory_group.all) do
		pg = var_1_10006
	...
	for iter_19_0, iter_19_1 in var_1_10002(var_19_1) do
		...
		for iter_19_2, iter_19_3 in var_1_10008(var_19_2) do
			...
			if var_1_10013.ship_data_create_exchange[iter_19_3] then
				...
				for iter_19_4, iter_19_5 in var_1_10013(var_1_10014.ship_data_create_exchange[iter_19_3].exchange_ship_id) do
					table = var_1_10018
...
function var_0.GetNPCShipConfigIDList()
	...
	for iter_20_0, iter_20_1 in var_1_10001(var_1_10002("act_npc_ship_id")[2]) do
		if var_0.IsActMatchTime(iter_20_1) then
			...
			local var_20_2 = var_7.task_data_template[var_20_1].award_display[1][2]
...
function var_0.GetNormalShopSkinIDList()
	...
	local var_22_1 = var_1_10002.shop_template.get_id_list_by_genre

	ShopArgs = var_1_10003

	for iter_22_0, iter_22_1 in var_1_10001(var_22_1[var_1_10003.SkinShop]) do
		if var_0.IsNormalShopMatch(iter_22_1) then
			local var_22_2 = var_0.GetSkinIDFromNormalShopID(iter_22_1)

			table = var_7

			if not var_7.contains(var_22_0, var_22_2) then
				table = var_7

				var_7.insert(var_22_0, var_22_2)
			end

			ShipSkin = var_7

			if var_7.IsChangeSkin(var_22_2) then
				ShipSkin = var_7

				local var_22_3 = var_7.GetAllChangeSkinIds(var_22_2)

				ipairs = var_8

				for iter_22_2, iter_22_3 in var_8(var_22_3) do
					table = var_1_10013
...
function var_0.GetActShopSkinIDList()
	...
	local var_24_1 = var_1_10002.activity_shop_extra.get_id_list_by_commodity_type

	DROP_TYPE_SKIN = var_1_10003

	for iter_24_0, iter_24_1 in var_1_10001(var_24_1[var_1_10003]) do
		if var_0.IsActShopMatch(iter_24_1) then
			local var_24_2 = var_0.GetSkinIDFromActShopID(iter_24_1)

			table = var_7

			if not var_7.contains(var_24_0, var_24_2) then
				table = var_7

				var_7.insert(var_24_0, var_24_2)
			end

			ShipSkin = var_7

			if var_7.IsChangeSkin(var_24_2) then
				ShipSkin = var_7

				local var_24_3 = var_7.GetAllChangeSkinIds(var_24_2)

				ipairs = var_8

				for iter_24_2, iter_24_3 in var_8(var_24_3) do
					table = var_1_10013
...
local function var_0_1(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in var_3(var_25_0) do
		table = var_1_10008
...
local function var_0_5()
	...
	if var_7.painting_filte_config.current_sale_skin == 1 then
		...
		var_29_9("normalShopSkinIDList:" .. #var_29_8)
		var_29_2(var_29_8)

		PaintingfilteConst = var_29_9
		var_29_9 = var_29_9.GetActShopSkinIDList()
		warning = var_9
	...
	for iter_29_0, iter_29_1 in var_29_8(var_29_9.secretary_special_ship.all) do
		pg = var_1_10012
...
local function var_0_9(arg_35_0)
	...
	local var_35_1 = arg_35_0.ToTable(var_35_0)

	pg = var_35_0

	local var_35_2 = var_35_0.NewStoryMgr.GetInstance()

	return var_2.GetStoryPaintingsByNameList(var_35_2, var_35_1)
end
...
local function var_0_11()
	...
	for iter_36_0, iter_36_1 in var_1_10003(var_1_10004.activity_template.all) do
...
local function var_0_13()
	...
	for iter_37_0, iter_37_1 in var_1_10001(var_1_10002.activity_template.all) do
		pg = var_1_10006
