local function var_0_0(arg_1_0)
	...
	local var_1_2, var_1_3 = var_1_1(var_1_10003, arg_1_0)
	local var_1_4

	if not var_1_2 then
		package = var_1_4
		var_1_4 = var_1_4.loaded
		var_1_4[arg_1_0] = var_1_0
		assert = var_1_4

		var_1_4(false, "<color=red>Reload lua file failed.</color>" .. var_1_3)
	...
	local var_1_5 = var_1_4.loaded[arg_1_0]
	local var_1_6 = {}

	update_table = var_1_10006

	var_1_10006(var_1_5, var_1_0, var_1_6)
...
local function var_0_2(arg_2_0, arg_2_1)
	...
	if var_1_10003(arg_2_1) == "function" then
		...
		for iter_2_0 = var_2_1, var_4.huge do
			debug = var_1_10007
	...
	for iter_2_1 = var_2_3, var_4.huge do
		debug = var_1_10007
		...
		if var_2_0[var_1_10007] then
			...
			var_1_10010.setupvalue(arg_2_0, iter_2_1, var_9)
		end
	end
	...
	if var_1_10003(arg_3_0) == "table" then
		...
		for iter_3_0, iter_3_1 in var_3(arg_3_0) do
			...
			elseif var_1_10009 == "table" and arg_3_2[iter_3_1] == nil then
				...
				var_10(iter_3_1, var_3_0, arg_3_2)
			end
		end
