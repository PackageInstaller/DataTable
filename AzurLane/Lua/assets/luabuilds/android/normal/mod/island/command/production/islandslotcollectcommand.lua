...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_8.Send(var_1_6, 21507, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10003.UpdateCollectRefreshtTime(var_2_3, arg_2_0.refresh_time)

			local var_2_4 = var_2_1:GetBuildingCollectData()

			var_2_10003.UpdateGetCollectNum(var_2_4, var_1_5)
			var_2_1:UpdateCollectDataBySlotId(var_2_2, var_1_5)

			IslandDropHelper = var_2_10003
			var_2_10003 = var_2_10003.AddItems(arg_2_0)
			...
			var_2_6(var_2_5, var_6.ISLAND_DROPMAIN_AWARD, {
				dropData = var_2_10003
			})

			local var_2_7 = var_0

			var_4.DispatchEvent(var_2_7, var_0_1.START_HAND_COLLECT_DONE, {
				build_id = var_1_0,
				area_id = var_1_1
			})
		else
