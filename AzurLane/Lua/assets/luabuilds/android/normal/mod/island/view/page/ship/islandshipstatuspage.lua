...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_6 = var_2.Find(var_2_5, "adapt/attr_panel/send_panel/scrollrect/list")
	local var_2_7 = arg_2_0._tf

	arg_2_0.giftEffectList = var_2_4(var_2_6, var_3.Find(var_2_7, "adapt/attr_panel/send_panel/scrollrect/list/tpl"))
	IslandShipStatusPanel = var_1

	local var_2_8 = var_1.New
	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "adapt/attr_panel/status")
	local var_2_11 = arg_2_0._tf

	arg_2_0.statusPanel = var_2_8(var_2_10, var_3.Find(var_2_11, "adapt/attr_panel/status_empty"))
	setText = var_1
	...
	var_1(var_2_13, var_2_12("island_select_ship_gift"))
	...
	var_1(var_2_16, var_2_15("island_gift_tip_title"))
...
function var_0_1.OnInit(arg_5_0)
	...
	local function var_5_2()
		...
		if arg_5_0.addPower + arg_5_0.curPower > arg_5_0.maxPower then
			...
			var_1.insert(var_6_0, function(arg_7_0)
				local var_7_0 = arg_5_0
				local var_7_1 = var_1.ShowMsgBox
				local var_7_2 = {}

				IslandMsgBox = var_3_10004
				var_7_2.type = var_3_10004.TYPE_COMMON
				i18n = var_4
				var_7_2.content = var_4("island_gift_tip")
		...
		local var_6_2 = var_1.CollectGiftBuffs(var_6_1, arg_5_0.selectedId)
		...
		var_2(var_6_0, function()
			...
			var_9_1(var_9_0, var_3_10002.ON_GIVE_GIFT, arg_5_0.selectedId, 1, arg_5_0.shipId)
...
function var_0_1.AddListeners(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.ISLAND_GIVE_GIFT_DONE, arg_10_0.OnUseItem)
...
function var_0_1.RemoveListeners(arg_11_0)
	...
	var_11_1(var_11_0, var_1_10003.ISLAND_GIVE_GIFT_DONE, arg_11_0.OnUseItem)
...
function var_0_1.FlushStatus(arg_14_0, arg_14_1)
	...
	local var_14_2 = arg_14_1.GetDisplayStatus(var_14_1)

	onButton = var_14_1

	local var_14_3 = arg_14_0
	local var_14_4 = arg_14_0.statusPanel.viewBtn
	...
	local function var_14_5()
		...
		var_15_2.type = var_2_10003.TYPE_SHIP_OWN_STATUS
		i18n = var_3
		var_15_2.title = var_3("island_word_ship_buff_desc")
		var_15_2.statusList = var_14_2
	...
	var_14_1(var_14_3, var_14_4, var_14_5, var_1_10007)
...
function var_0_1.OnInitItem(arg_16_0, arg_16_1)
	...
	local function var_16_3()
		...
		if var_0.GetCount(var_17_0) <= 0 then
			...
			i18n = var_2_10003
			var_17_3.title = var_2_10003("island_word_ship_buff_desc")
			IslandMsgBox = var_3
			var_17_3.type = var_3.TYPE_COMMON_ITEM
	...
	var_3(var_16_1, var_16_2, var_16_3, var_1_10007)
...
function var_0_1.CollectGiftEffect(arg_24_0, arg_24_1)
	...
	local var_24_2 = var_4.GIFT_INDEX_COMMON

	IslandConst = var_1_10005

	local var_24_3 = var_1_10005.GIFT_INDEX_FAVORITE
	...
	if var_24_5[var_24_2] > 0 then
		...
		var_24_6(var_24_7, var_1_10009("island_word_ship_enengy_recover") .. var_24_5[var_24_2])
	end
...
function var_0_1.GetGiftAddPower(arg_25_0, arg_25_1)
	...
	local var_25_1 = var_3.GIFT_INDEX_COMMON

	IslandConst = var_1_10004

	local var_25_2 = var_1_10004.GIFT_INDEX_FAVORITE
...
function var_0_1.FlushPower(arg_26_0)
	...
	local var_26_4 = var_4.Find(var_26_3, "value")
	local var_26_5 = arg_26_0.curPower

	setColorStr = var_6

	var_3(var_26_4, var_26_5 .. var_6(var_26_2, "#4FD775") .. "/" .. arg_26_0.maxPower)

	setSlider = var_3

	local var_26_6 = arg_26_0.powerTr

	var_3(var_4.Find(var_26_6, "progress"), 0, 1, arg_26_0.curPower / arg_26_0.maxPower)

	setSlider = var_3

	local var_26_7 = arg_26_0.powerTr
	local var_26_8 = var_4.Find(var_26_7, "progress/add")
	local var_26_9 = 0
	local var_26_10 = 1
	local var_26_11
