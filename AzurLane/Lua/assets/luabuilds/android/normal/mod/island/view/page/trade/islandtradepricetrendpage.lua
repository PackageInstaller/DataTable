...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame/prices")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiPriceList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/prices/tpl"))
	UIItemList = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_2.Find(var_2_5, "frame/date")
	local var_2_7 = arg_2_0._tf

	arg_2_0.uiDateList = var_2_4(var_2_6, var_3.Find(var_2_7, "frame/date/tpl"))
...
function var_0_1.CollectDate(arg_8_0)
	...
	for iter_8_0 = 6, 1, -1 do
		var_1_10011 = arg_8_0.island
		var_1_10011 = var_10.GetTradeAgency(var_1_10011)

		if var_10.ExistTrade(var_1_10011, var_8_3 - iter_8_0 * 0) then
			var_8_5 = iter_8_0
	...
	for iter_8_1 = var_8_5, 1, -1 do
		local var_8_6 = var_8_3 - iter_8_1 * 0

		table = var_1_10011

		var_1_10011.insert(var_8_4, var_8_6)
	end
	...
	for iter_8_2 = 1, 7 - #var_8_4 do
		local var_8_7 = var_8_3 + iter_8_2 * 0

		table = var_1_10011

		var_1_10011.insert(var_8_4, var_8_7)
	end
...
function var_0_1.InitDate(arg_9_0)
	...
	local var_9_1 = arg_9_0.CollectDate(var_9_0)
	...
	var_2.make(var_9_2, function(arg_10_0, arg_10_1, arg_10_2)
		UIItemList = var_2_10003
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			var_10_1(arg_10_2:Find("Text"), var_10_2)
	...
	local var_9_3 = arg_9_0.uiDateList
...
function var_0_1.UpdateCurve(arg_11_0)
	...
	if var_11_3 == var_1_10004.MODE_SELL then
		var_11_4 = var_11_1
		var_11_2 = var_11_1.GetSellPriceTrend(var_11_4)
	else
		local var_11_5 = arg_11_0.mode

		IslandTradePage = var_11_4

		if var_11_5 == var_11_4.MODE_PURCHAS then
			var_11_4 = var_11_1
			var_11_2 = var_11_1.GetPriceTrend(var_11_4)
		end
	end
	...
	for iter_11_0, iter_11_1 in var_11_4(arg_11_0.dateList) do
		if var_11_2[iter_11_0] then
			local var_11_7 = arg_11_0
			local var_11_8 = arg_11_0.UpdateCurveItem(var_11_7, iter_11_0, iter_11_1, var_9)

			table = var_11_7

			var_11_7.insert(var_11_6, {
				iter_11_0,
				var_11_8
			})
		end
	...
	var_4.sort(var_11_6, function(arg_13_0, arg_13_1)
		return arg_13_0[1] < arg_13_1[1]
	end)

	_ = var_4

	local var_11_9 = var_4.map(var_11_6, function(arg_14_0)
		return arg_14_0[2]
	end)

	ipairs = var_5

	for iter_11_2, iter_11_3 in var_5(var_11_6) do
		local var_11_10 = iter_11_3[1]
		local var_11_11 = arg_11_0.dots[var_11_10]
		local var_11_12 = var_11.Find(var_11_11, "line")
		local var_11_13 = var_11_6[iter_11_2 + 1]
		local var_11_14

		if var_11_12 and var_11_13 and var_11_13[1] - iter_11_3[1] == 0 then
			Vector2 = var_11_14
			var_11_14 = var_11_14.Distance(iter_11_3[2].localPosition, var_11_13[2].localPosition)
			Vector2 = var_14
			var_11_12.sizeDelta = var_14(4, var_11_14)
			var_11_12.up = (var_11_13[2].position - iter_11_3[2].position).normalized
			setActive = var_15

			var_15(var_11_12, true)
		elseif var_11_12 then
			setActive = var_11_14

			var_11_14(var_11_12, false)
		end
	end

	arg_11_0:PlayDotAnimations(var_11_9)
...
function var_0_1.UpdateCurveItem(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_2 = var_5.InverseTransformPoint(var_18_1, arg_18_2:Find("Text").position)
	local var_18_3 = arg_18_0
	local var_18_4 = arg_18_0.GetPriceYScale(var_18_3, arg_18_3)
	...
	var_18_3(var_18_5, var_9(var_18_2.x, var_18_4, 0))

	setActive = var_18_3

	local var_18_6 = var_18_0
	local var_18_7 = var_18_0.Find(var_18_6, "dot/current")

	pg = var_18_6

	local var_18_8 = var_18_6.TimeMgr.GetInstance()
	local var_18_9 = var_9.IsSameDay
	local var_18_10 = arg_18_1

	pg = var_12

	local var_18_11 = var_12.TimeMgr.GetInstance()

	var_18_3(var_18_7, var_18_9(var_18_8, var_18_10, var_12.GetServerTime(var_18_11)))
