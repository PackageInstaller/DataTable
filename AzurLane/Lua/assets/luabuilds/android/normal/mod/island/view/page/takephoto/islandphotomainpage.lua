...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	YSTool = var_1_10004
	arg_2_0.ysScreenShoter = var_2_14(var_2_13, var_3(var_1_10004.YSScreenShoter))
	...
	IslandConst = var_2_21
	var_2_22[var_2_21.TakePhotoModel.First] = arg_2_0.firstModelTF
	IslandConst = var_2
	...
	IslandConst = var_3
	arg_2_0.fpsCamera = var_2_25(var_2_24, var_3.FIRST_PERSON_TAKE_PHOTO_CAMERA_NAME)
	IslandCameraMgr = var_1
	...
	IslandConst = var_3
	arg_2_0.tpsCamera = var_2_27(var_2_26, var_3.Third_PERSON_TAKE_PHOTO_CAMERA_NAME)
	pg = var_1
...
function var_0_1.OnInit(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "Center/Normal/Back/help")
	...
	local function var_5_3()
		...
		pg = var_2_10003
		var_6_2.helps = var_2_10003.gametip.island_help_photo.tip
	...
	local var_5_6 = var_3.Find(var_5_5, "Center/Normal/Back")
	...
	local var_5_10 = var_3.Find(var_5_9, "RightTop/Shot/Switch")
	...
	local var_5_14 = var_3.Find(var_5_13, "RightTop/Film/Switch")
	...
	local function var_5_18()
		local function var_10_0(arg_11_0)
			...
			var_3_10001(var_2.Find(var_11_0, "RightTop"), arg_11_0)
			...
			local var_11_2 = var_11_1(var_2, 1)

			if 0 < var_11_2 then
				setActive = var_2
				pg = var_3

				var_2(var_3.UIMgr.GetInstance().OverlayEffect, arg_11_0)
			end
		...
		local function var_10_1(arg_12_0)
			...
			var_3_10001(var_12_0 .. var_3_10003(true))
			...
			IslandPhotoSharePage = var_4

			var_12_3(var_12_2, var_4, var_12_1, arg_12_0)
		...
		var_10_3(var_10_2, var_2_10004.BuildIslandTakeThoto(2))
	...
	local var_5_21 = var_3.Find(var_5_20, "left_btn")
	...
	var_1_10001(var_5_19, var_5_21, var_5_22, var_5)

	onButton = var_1_10001

	local var_5_23 = arg_5_0
	local var_5_24 = arg_5_0.select_bgTF
	local var_5_25 = var_3.Find(var_5_24, "left_btn")
	...
	var_1_10001(var_5_23, var_5_25, var_5_26, var_5)
	...
	local function var_5_29()
		...
		var_15_1(var_15_0, var_2_10002.TakePhotoModel.First)
	...
	var_1_10001(var_5_27, var_5_28, var_5_29, var_5)
	...
	local function var_5_32()
		...
		var_16_1(var_16_0, var_2_10002.TakePhotoModel.Third)
	...
	var_1_10001(var_5_30, var_5_31, var_5_32, var_5)
	...
	local function var_5_35()
		...
		var_18_3(var_18_2, var_2.SetOpMoveBtnActve, false)
	...
	var_1(var_5_33, var_5_34, var_5_35, var_5)
	...
	local function var_5_38()
		...
		if arg_5_0.takePhotoModel == 2 then
			...
			var_19_2(var_19_1, var_3.Change_TakePhoto_Model, arg_5_0.takePhotoModel)
		end
	...
	var_1(var_5_36, var_5_37, var_5_38, var_5)
	...
	var_1(arg_5_0, arg_5_0.hideuiMask, function()
		...
		var_20_3(var_20_2, var_2.SetOpMoveBtnActve, true)
	...
	local function var_5_41()
		...
		var_21_1(var_21_0, var_2_10002.BuildIslandTakeThoto(3))
		...
		local function var_21_2(arg_22_0)
			...
			var_22_3(var_22_2, var_3.SetOpMoveBtnActve, arg_22_0, true)
		...
		if not arg_5_0.recordState then
			...
			local function var_21_4()
				...
				var_24_1(var_24_0, var_2.Action(function()
					var_0_1.SetMute(true)

					local var_25_0 = arg_5_0

					YSNormalTool = var_1
					var_25_0.recordFilePath = var_1.RecordTool.GenRecordFilePath()
			...
			var_3({
				...
				function(arg_27_0)
					...
					if not var_1.GetInt("hadShowForVideoTipDorm", 0) or var_1 <= 0 then
						...
						i18n = var_27_1
						var_27_2.text = var_27_1("word_take_video_tip")
						onButton = var_27_2
	...
	var_1(var_5_39, var_5_40, var_5_41, var_5)
	...
	var_1(arg_5_0, arg_5_0.stopRecBtn, function()
		...
		local function var_29_0(arg_30_0)
			if arg_30_0 then
				...
				if var_3_10001 == var_3_10002 then
					...
					i18n = var_3_10004
					var_30_2.content = var_3_10004("word_save_video")
					...
					function var_30_2.onYes()
						...
						var_4_10000.MediaTool.SaveVideoToAlbum(arg_5_0.recordFilePath, function(arg_33_0, arg_33_1)
							if arg_33_0 then
								...
								var_33_1(var_33_0, var_5_10004("word_save_ok"))
		...
		if not var_29_2(var_2_10003(arg_5_0.stopRecBtn)) then
			LeanTween = var_2
...
function var_0_1.ChangeSliderValue(arg_37_0, arg_37_1)
	...
	if arg_37_0.takePhotoModel == 2 then
		...
		var_37_0 = var_37_3(var_37_2, var_1_10006(var_1_10007))
		...
		typeof = var_1_10006
		CameraPovLook = var_1_10007
		var_37_0 = var_37_5(var_37_4, var_1_10006(var_1_10007))
		...
		var_37_7(var_37_6, var_6.Change_Photo_Height, arg_37_0.takePhotoModel, var_37_1)
	end
...
function var_0_1.RightSelectBtnHandle(arg_38_0)
	...
	var_1_10001(var_2.Find(var_38_0, "left_btn"), true)
...
function var_0_1.LeftSelectBtnHandle(arg_39_0)
	...
	var_1_10001(var_2.Find(var_39_0, "left_btn"), false)

	local var_39_1 = 1

	pairs = var_2

	for iter_39_0, iter_39_1 in var_2(arg_39_0.takeModelTFDic) do
...
function var_0_1.ChangeTakePhotoModel(arg_40_0, arg_40_1)
	...
	if arg_40_0.takePhotoModel == 2 then
		...
		typeof = var_1_10007
		CameraPovZoom = var_1_10008
		var_40_2 = var_40_5(var_40_4, var_1_10007(var_1_10008))
		...
		typeof = var_1_10007
		CameraPovZoom = var_1_10008
		var_40_2 = var_40_5(var_40_6, var_1_10007(var_1_10008))
	...
	var_40_8(var_40_7, var_7.Change_TakePhoto_Model, arg_40_0.takePhotoModel)
...
function var_0_1.OnShow(arg_41_0)
	...
	var_41_1(var_41_0, var_1_10003.BuildIslandTakeThoto(1))
	...
	var_41_3(var_41_2, var_3.TakePhotoModel.First)
...
function var_0_1.OnExit(arg_44_0)
	...
	local var_44_4 = var_1_10004.Change_TakePhoto_Model

	IslandConst = var_1_10005

	var_44_3(var_44_2, var_44_4, var_1_10005.TakePhotoModel.None, var_44_1)
