...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.itemCntTxt = var_1_3(var_1_2, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.detaltipsTf = var_1_7(var_1_6, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	arg_1_0.nameTxt = var_1_10(var_1_9, var_5(var_1_10006))
...
function var_0_0.Show(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_2 = arg_2_2.GetIcon(var_2_1)

	GetImageSpriteFromAtlasAsync = var_2_1

	var_2_1("island/" .. var_2_2, "", arg_2_0.iconTr)

	arg_2_0.detaltipsTf.text = arg_2_2:GetDesc()

	local var_2_3 = arg_2_0.nameTxt

	var_2_3.text = arg_2_2:GetName()
	setActive = var_2_3

	var_2_3(arg_2_0.tr, true)
