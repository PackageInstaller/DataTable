...
function var_0_1.OnInitFlags(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_1_10002(arg_2_0.controller.sceneData.unitList) do
		...
		if not var_2_1(var_2_0, var_2_2, var_1_10010.UNIT_LIST_OBJ) then
	...
	for iter_3_0, iter_3_1 in var_1_10003(arg_3_1) do
		...
		if var_3_0 ~= nil and var_3_1 ~= nil and var_3_0 ~= var_3_1 then
			if var_3_0 == true and var_3_1 == false then
				...
				var_3_3(var_3_2, var_1_10012.UNIT_LIST_OBJ, iter_3_0)
			elseif var_3_0 == false and var_3_1 == true and arg_3_0:GetUnitData(iter_3_0) then
				var_1_10012 = arg_3_0

				arg_3_0.GenUnit(var_1_10012, var_10)
			end
		end
	end
...
function var_0_1.ApplyCondition(arg_5_0, arg_5_1)
	...
	local var_5_5 = var_4:GetMainTraceId()
	local var_5_6 = arg_5_0
	local var_5_7 = arg_5_0.CollectAllTaskStatus(var_5_6, var_4)

	pg = var_5_6

	local var_5_8 = var_5_6.NewStoryMgr.GetInstance()
	local var_5_9 = var_8.GetPlayedList(var_5_8)
	local var_5_10 = arg_5_0.flags[arg_5_1.id]
	local var_5_11 = arg_5_0:GetCondition(var_5_7, var_5_9, var_5_4, var_5_5, var_5_0)
	local var_5_12 = arg_5_0:GetCondition(var_5_7, var_5_9, var_5_4, var_5_5, var_5_1)
	...
	elseif #var_5_0 > 0 and #var_5_1 > 0 then
		var_5_10 = arg_5_0:SortCondition(arg_5_1, var_5_4, var_5_5, var_5_11, var_5_12)
	end
...
function var_0_1.CollectAllTaskStatus(arg_12_0, arg_12_1)
	...
	local var_12_2 = arg_12_1.GetTasks(var_12_1)
	...
	for iter_12_0, iter_12_1 in var_12_1(var_12_2) do
		...
		var_1_10010 = iter_12_1

		if iter_12_1.IsFinish(var_1_10010) then
			var_1_10009 = iter_12_1.id
			IslandConst = var_1_10010
