...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandBaseMapPage"))
...
function var_0_1.Flush(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1(arg_2_0.maps) do
		if arg_2_0:CheckUnlock(iter_2_0) then
			...
			local var_2_1 = iter_2_1.Find(var_2_0, "icon")

			isActive = var_2_0

			local var_2_2

			if not var_2_0(iter_2_1:Find("fetch")) then
				isActive = var_8

				if not var_8(iter_2_1:Find("finish")) then
					isActive = var_8
					var_2_2 = not var_8(iter_2_1:Find("fetch"))
...
function var_0_1.CheckProductions(arg_8_0, arg_8_1)
	...
	if arg_8_0.timers[arg_8_1] then
		var_1_10004 = arg_8_0.timers[arg_8_1]

		var_8_1.Stop(var_1_10004)
	...
	local var_8_2 = var_8_1(var_1_10004)
...
function var_0_1.GoDesc(arg_12_0, arg_12_1)
	...
	IslandMapDescPage = var_1_10004

	var_12_1(var_12_0, var_1_10004, arg_12_1)
