...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandCore"))
		...
		if var_1.IsLoaded(var_6_2) and arg_6_0.miniGameUILoaded then
			...
			local var_6_3 = var_1.New(function()
				...
				if arg_6_0.isReconected then
					...
					var_7_1(var_7_0, var_2_10002.PLAY_ROOM_ALL_LOAD_OVER)
				else
					pg = var_7_1
					...
					var_7_3(var_7_2, var_2_10002.PLAY_ROOM_LOAD_SCENE_COMPLETE)
				end
...
function var_0_1.OnChangeMiniGameScene(arg_8_0, arg_8_1)
	if arg_8_1 then
		...
		isReConnected = var_1_10006

		var_1_10002(var_8_0, var_1_10004, var_8_1, var_1_10006)
		...
		var_1_10002(function()
			...
			if arg_8_0.isReconected then
				...
				var_9_2(var_9_1, var_2_10002.ISLAND_CHEATER_RECONECTING)
			end
		...
		var_8_3(var_8_2, var_1_10004, var_8_4, var_1_10006)
