...
function var_0_1.Init(arg_1_0)
	...
	local var_1_2 = var_2.Find(var_1_1, "finished/Text")

	i18n = var_1_1

	var_1(var_1_2, var_1_1("island_freight_btn_receive"))

	setText = var_1

	local var_1_3 = arg_1_0.statesTF
	local var_1_4 = var_2.Find(var_1_3, "waiting")

	i18n = var_1_3

	var_1(var_1_4, var_1_3("island_freight_btn_idle"))
	...
	typeof = var_3
	Text = var_4
	arg_1_0.timeTxt = var_1_7(var_1_6, var_3(var_4))
...
function var_0_1.FlushDataUI(arg_2_0)
	...
	local var_2_2 = arg_2_0.statesTF

	var_1_10003(var_4.Find(var_2_2, "finished"), var_2_0 == var_0_1.STATES.FINISHED)

	setActive = var_1_10003

	local var_2_3 = arg_2_0.statesTF

	var_1_10003(var_4.Find(var_2_3, "running"), var_2_0 == var_0_1.STATES.RUNNING)

	setActive = var_1_10003

	local var_2_4 = arg_2_0.statesTF

	var_1_10003(var_4.Find(var_2_4, "waiting"), var_2_0 == var_0_1.STATES.WAITING)
	...
	local var_2_7 = var_2_6(var_2_5, var_5(var_6))

	if var_2_0 == var_0_1.STATES.FINISHED then
		var_2_7:Play("IslandDeviceUI_shipoderfinished_")
	elseif var_2_0 == var_0_1.STATES.RUNNING then
		var_2_7:Play("IslandDeviceUI_shipoderrunning_")
	elseif var_2_0 == var_0_1.STATES.WAITING then
		var_2_7:Play("IslandDeviceUI_shipoderwaiting_")
	else
		var_2_7:Stop()
	end
	...
	if var_2_0 == var_0_1.STATES.RUNNING then
...
function var_0_1.AddTimer(arg_3_0, arg_3_1)
	...
	local var_3_1 = arg_3_1.GetEndTime(var_3_0)

	Timer = var_3_0
	arg_3_0.timer = var_3_0.New(function(arg_4_0, arg_4_1, arg_4_2)
		pg = var_2_10003

		local var_4_0 = var_2_10003.TimeMgr.GetInstance()
		local var_4_1 = var_3.GetServerTime(var_4_0)
		local var_4_2 = var_3_1 - var_4_1
...
function var_0_1.GetState(arg_6_0)
	...
	local var_6_3 = var_6_1.values(var_6_2:GetShipSlotList())

	underscore = var_3

	if var_3.detect(var_6_3, function(arg_7_0)
