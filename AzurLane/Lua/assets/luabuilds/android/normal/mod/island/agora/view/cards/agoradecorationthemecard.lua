...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.icon = var_1_4(var_1_3, var_4(var_1_10005))
	...
	arg_1_0.iconRaw = var_1_7(var_1_6, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.idTxt = var_1_9(var_1_8, var_4(var_1_10005))
	findTF = var_2
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.nameTxt = var_1_11(var_1_10, var_4(var_1_10005))
	findTF = var_2
	...
	var_2(var_1_13, var_1_12("island_agora_save_theme"))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	if not var_3 then
		...
		AgoraTheme = var_1_10008
		var_2_2 = var_6(var_2_1, var_1_10008)
	else
		var_2_2 = false
	end
...
function var_0_0.LoadRawTex(arg_3_0, arg_3_1)
	...
	if not var_3.FileExists(var_3_0) then
		arg_3_0:LoadImage(0)
