...
function var_0_1.OnInit(arg_5_0)
	...
	local var_5_2 = var_2.Find(var_5_1, "options")
	local var_5_3 = arg_5_0._tf

	arg_5_0.uilist = var_5_0(var_5_2, var_3.Find(var_5_3, "options/notify_tpl"))
...
function var_0_1.JumpToCustomSetting(arg_7_0, arg_7_1)
	...
	local var_7_2 = var_4.APARTMENT_TRACK

	Dorm3dTrackCommand = var_1_10005

	var_7_1(var_7_0, var_7_2, var_1_10005.BuildDataGraphics(4))
	...
	IslandSettingsPage = var_4

	var_7_5(var_7_4, var_4.SELECTCUSTOMGRAPHICSETTING)
...
function var_0_1.UpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	var_8_2, setText = arg_8_2.Find(var_8_1, "mask/Text"), var_8_1
	i18n = var_1_10007

	var_8_1(var_8_2, var_1_10007(var_8_0.settingName))

	local var_8_3 = var_8_0.settingType == var_0_2.toggle
	local var_8_4 = arg_8_2:Find("toggle")
	local var_8_5 = arg_8_2
	local var_8_6 = arg_8_2.Find(var_8_5, "select")

	setActive = var_8_5

	var_8_5(var_8_4, var_8_3)

	setActive = var_8_5

	var_8_5(var_8_6, not var_8_3)
	...
	if var_8_3 then
		...
		local var_8_8 = arg_8_2:Find("toggle/off")

		var_1_10011 = arg_8_2

		local var_8_9 = arg_8_2.Find(var_1_10011, "toggle/on")

		var_1_10011 = nil

		local function var_8_10(arg_10_0)
			var_1_10011 = arg_10_0
		...
		local function var_8_13()
			...
			if var_8_0.tips then
				...
				var_2_10001.insert(var_11_0, function(arg_12_0)
					...
					i18n = var_3_10004
					var_12_2.content = var_3_10004(var_8_0.tips)
				...
				if arg_8_0.customSetting and var_8_0.hasChild then
					...
					IslandSettingsPage = var_2_10002

					var_11_2(var_11_1, var_2_10002.SELECTCUSTOMGRAPHICSETTING)
		...
		var_1_10013(var_8_11, var_8_12, var_8_13, var_1_10017)
		...
		local function var_8_16()
			...
			if arg_8_0.customSetting and var_8_0.hasChild then
				...
				var_16_1(var_16_0, var_2_10002.SELECTCUSTOMGRAPHICSETTING)
		...
		var_1_10013(var_8_14, var_8_15, var_8_16, var_1_10017)
		...
		if arg_8_0.graphicLevel == var_0_5.Custom then
			...
			if arg_8_0.graphicLevel == var_0_5.Custom then
				...
				do
					...
					for iter_8_0, iter_8_1 in var_1_10011(var_8_0.options) do
					...
					;(function()
						...
						local var_17_2 = var_8_6

						var_2(var_3.Find(var_17_2, "leftbu"), not var_17_0)

						setActive = var_2

						local var_17_3 = var_8_6

						var_2(var_3.Find(var_17_3, "leftline"), var_17_0)

						setActive = var_2

						local var_17_4 = var_8_6

						var_2(var_3.Find(var_17_4, "rightbu"), not var_17_1)

						setActive = var_2

						local var_17_5 = var_8_6

						var_2(var_3.Find(var_17_5, "rightline"), var_17_1)

						setText = var_2

						local var_17_6 = var_8_6
						local var_17_7 = var_3.Find(var_17_6, "Text")

						i18n = var_17_6

						var_2(var_17_7, var_17_6(var_8_0.optionNames[var_8_19]))
					...
					var_12(arg_8_0, var_8_6:Find("leftbu"), function()
						var_8_19 = var_8_19 - 1
					...
					var_12(arg_8_0, var_8_6:Find("rightbu"), function()
						var_8_19 = var_8_19 + 1
...
function var_0_1.OnUpdate(arg_21_0)
	...
	arg_21_0.graphicLevel = var_21_0(var_1_10002.PlayerGraphicLevelIsland, 4)
