...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandBaseVisitorCard"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.btn1Txt = var_1_3(var_1_2, var_4(var_1_10005))
	...
	var_2(var_1_7, var_1_6("island_btn_label_online"))
	...
	typeof = var_4
	Text = var_5
	arg_1_0.offlineTxt = var_1_10(var_1_9, var_4(var_5))
...
function var_0_1.Update(arg_2_0, arg_2_1, arg_2_2)
	...
	i18n = var_4
	var_2_0.text = var_4("island_btn_label_invitation")
	...
	var_2_2(arg_2_0.online, var_2_3)

	setActive = var_2_2

	var_2_2(arg_2_0.offline, not var_2_3)

	if not var_2_3 then
		var_2_2 = arg_2_0.offlineTxt
		getOfflineTimeStamp = var_5
		var_2_2.text = var_5(arg_2_1.preOnLineTime)
	end

	setActive = var_2_2

	var_2_2(arg_2_0.btn, not arg_2_2)

	setActive = var_2_2

	var_2_2(arg_2_0.btn1, arg_2_2)
