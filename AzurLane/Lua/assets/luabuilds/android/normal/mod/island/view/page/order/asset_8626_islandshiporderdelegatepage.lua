...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_4
	arg_2_0.refreshTimeTxt = var_2_14(var_2_13, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.autoRefreshTimeTxt = var_2_18(var_2_17, var_3(var_4))
	UIItemList = var_1

	local var_2_19 = var_1.New
	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_2.Find(var_2_20, "frame/list/content")
	local var_2_22 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_19(var_2_21, var_3.Find(var_2_22, "frame/list/content/tpl"))
	setText = var_1

	local var_2_23 = arg_2_0._tf
	local var_2_24 = var_2.Find(var_2_23, "frame/confirm/Text")

	i18n = var_2_23

	var_1(var_2_24, var_2_23("word_ok"))

	setText = var_1

	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_2.Find(var_2_25, "frame/cancel/Text")
	...
	local var_2_28 = var_2.Find(var_2_27, "frame/list/label")

	i18n = var_2_27

	var_1(var_2_28, var_2_27("island_ship_order_delegate_auto_refresh_label"))

	setText = var_1

	local var_2_29 = arg_2_0._tf
	local var_2_30 = var_2.Find(var_2_29, "frame/list/label/Text")

	i18n = var_2_29

	var_1(var_2_30, var_2_29("island_ship_order_delegate_auto_refresh_time"))
...
function var_0_1.IsEmptySlot(arg_3_0)
	...
	var_3_2 = var_1.GetShipOrderSlot(var_3_1, arg_3_0.slotId) and var_1:IsEmpty()
...
function var_0_1.CanExchange(arg_5_0)
	...
	var_5_2 = var_1.GetShipOrderSlot(var_5_1, arg_5_0.slotId) and var_1:CanTransport()
...
function var_0_1.OnInit(arg_6_0)
	...
	local function var_6_2()
		...
		if var_0.IsSelectMode(var_7_0) and arg_6_0.selectedId then
			...
			if var_1.IsEmptySlot(var_7_2) then
				...
				var_7_4(var_7_3, var_2_10003.EXCHANGE_SHIP_ORDER, arg_6_0.slotId, var_7_1)
			...
			if var_1.IsAnyLoadUp(var_7_5) then
				...
				if not var_1.CanExchange(var_7_6) then
					...
					var_7_8(var_7_7, var_2_10003("island_order_ship_exchange_tip_2"))
				...
				do
					...
					var_2.ShowMsgBox(var_7_11, {
						...
						onYes = function()
							...
							var_8_1(var_8_0, var_3_10002.EXCHANGE_SHIP_ORDER, arg_6_0.slotId, var_7_1)
	...
	local function var_6_11()
		...
		i18n = var_2_10003
		var_11_2.content = var_2_10003("island_order_ship_reset_all")
		...
		function var_11_2.onYes()
			...
			var_12_1(var_12_0, var_3_10002.RESET_SHIP_ORDER)
	...
	local function var_6_14()
		...
		var_13_1(var_13_0, var_2_10002, var_2_10003.TYPES.SHIP_ORDER_RELOAD, 0)
...
function var_0_1.AddListeners(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.ISLAND_RESET_SHIP_ORDER_DONE, arg_14_0.OnResetShipOrderList)
	...
	var_14_3(var_14_2, var_3.ISLAND_USE_TICKET_DONE, arg_14_0.OnUseTicketDone)
...
function var_0_1.RemoveListeners(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.ISLAND_RESET_SHIP_ORDER_DONE, arg_15_0.OnResetShipOrderList)
	...
	var_15_3(var_15_2, var_3.ISLAND_USE_TICKET_DONE, arg_15_0.OnUseTicketDone)
...
function var_0_1.InitList(arg_22_0)
	...
	var_2.make(var_22_2, function(arg_23_0, arg_23_1, arg_23_2)
		...
		if arg_23_0 == var_2_10003.EventUpdate then
			...
			var_3(var_23_1, var_23_2, var_23_3, var_7)
...
function var_0_1.AddNextAutoRefreshTimer(arg_25_0)
	...
	Timer = var_25_1
	arg_25_0.autoTimer = var_25_1.New(function()
		pg = var_2_10000
		...
		if var_25_2 - var_26_1 < 0 then
			...
			var_2.RemoveNextAutoRefreshTimer(var_2_10003)

			arg_25_0.autoRefreshTimeTxt.text = ""
			var_2_10003 = arg_25_0

			if #var_2.GetDisplays(var_2_10003) > 0 then
				local var_26_2 = arg_25_0

				var_2_10003.InitList(var_26_2)
			end
		else
			local var_26_3 = arg_25_0.autoRefreshTimeTxt

			pg = var_2_10003

			local var_26_4 = var_2_10003.TimeMgr.GetInstance()

			var_26_3.text = var_3.DescCDTime(var_26_4, var_1)
		end
...
function var_0_1.UpdateItem(arg_28_0, arg_28_1, arg_28_2)
	...
	local var_28_1 = arg_28_2.GetRequestList(var_28_0)

	setText = var_28_0

	var_28_0(arg_28_1:Find("num"), "0" .. arg_28_2.id)

	UIItemList = var_28_0

	local var_28_2 = var_28_0.New(arg_28_1:Find("request"), arg_28_1:Find("request/tpl"))

	var_4.make(var_28_2, function(arg_29_0, arg_29_1, arg_29_2)
		UIItemList = var_2_10003
		...
		if arg_29_0 == var_2_10003.EventUpdate then
			...
			if not var_4.New(var_29_0).icon then
				var_2_10006 = var_4
				var_29_1 = var_4.getConfig(var_2_10006, "icon")
			end

			GetImageSpriteFromAtlasAsync = var_2_10006

			var_2_10006("island/" .. var_29_1, "", arg_29_2:Find("icon"))

			local var_29_2 = var_4
			local var_29_3 = var_4.getOwnedCount(var_29_2)

			setText = var_29_2

			local var_29_4 = arg_29_2
			local var_29_5 = arg_29_2.Find(var_29_4, "cnt")

			setColorStr = var_29_4

			var_29_2(var_29_5, var_29_4(var_29_3 .. "/" .. var_4.count, var_29_3 >= var_4.count and "#39beff" or "#f36c6e"))

			setActive = var_29_2

			var_29_2(arg_29_2:Find("mark"), var_29_3 >= var_4.count)
		end

		return
	end)
	var_4:align(#var_28_1)

	local var_28_3 = arg_28_2
	local var_28_4 = arg_28_2.GetAwardList(var_28_3)

	UIItemList = var_28_3

	local var_28_5 = var_28_3.New(arg_28_1:Find("award"), arg_28_1:Find("award/tpl"))

	var_6.make(var_28_5, function(arg_30_0, arg_30_1, arg_30_2)
		UIItemList = var_2_10003

		if arg_30_0 == var_2_10003.EventUpdate then
			local var_30_0 = var_28_4[arg_30_1 + 1]
			...
			var_5(var_30_2, var_2_10007.New(var_30_0))
		end

		return
	end)
	var_6:align(#var_28_4)
...
function var_0_1.FlushRefreshBtn(arg_31_0)
	...
	var_1_10003(arg_31_0.refreshBtn, not var_31_2, true)

	setButtonEnabled = var_1_10003

	var_1_10003(arg_31_0.refreshBtn, var_31_2)

	setActive = var_1_10003

	var_1_10003(arg_31_0.refreshTimeTxt.gameObject.transform.parent, not var_31_2)
...
function var_0_1.AddRefreshTimer(arg_32_0, arg_32_1)
	...
	arg_32_0.timer = var_1_10002.New(function()
		...
		if arg_32_1 - var_33_1 < 0 then
			var_2_10003 = arg_32_0

			var_2.RemoveRefreshTimer(var_2_10003)

			arg_32_0.refreshTimeTxt.text = ""
			var_2_10003 = arg_32_0

			var_2.FlushRefreshBtn(var_2_10003)
		else
			local var_33_2 = arg_32_0.refreshTimeTxt

			pg = var_2_10003

			local var_33_3 = var_2_10003.TimeMgr.GetInstance()

			var_33_2.text = var_3.DescCDTime(var_33_3, var_1)
		end
...
function var_0_1.InitToggles(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10001(arg_35_0.toggles) do
		...
		var_1_10006(var_35_0, var_35_1, var_35_2, var_1_10010)
	end
...
function var_0_1.SwitchPage(arg_37_0, arg_37_1)
	...
	for iter_37_0, iter_37_1 in var_1_10002(arg_37_0.toggles) do
		...
		var_9(iter_37_1:Find("Text"), var_1_10008)
	end
