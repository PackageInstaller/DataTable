...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandRestaurantSettlePage"))
...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "window/event/addition")
	local var_2_3 = arg_2_0._tf

	arg_2_0.additionList = var_2_0(var_2_2, var_3.Find(var_2_3, "window/event/addition/tpl"))
	...
	typeof = var_3
	Text = var_2_3
	arg_2_0.priceAdd = var_2_6(var_2_5, var_3(var_2_3))
	setText = var_1

	local var_2_7 = arg_2_0._tf
	local var_2_8 = var_2.Find(var_2_7, "window/event/Image/Text")

	i18n = var_2_7

	var_1(var_2_8, var_2_7("island_post_event_label"))
...
function var_0_1.WarpAdditionInfo(arg_6_0, arg_6_1)
	...
	i18n = var_1_10006
	var_6_3[1] = var_1_10006("island_addition_influence")
	...
	i18n = var_6
	var_6_6[1] = var_6("island_addition_sale")
...
function var_0_1.UpdateCommonItem(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_1.Find(var_8_0, "event")

	table = var_8_0

	var_3(var_8_1, var_8_0.contains(arg_8_0.itemList, arg_8_2.id))
