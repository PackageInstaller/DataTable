...
function var_0_1.StartGather(arg_3_0, arg_3_1)
	...
	if var_3_1 == var_1_10004.UNIT_TYPE_ITEM_GATHER_ITEM then
...
function var_0_1.StartGaherSign(arg_4_0, arg_4_1)
	...
	if var_4_1 == var_1_10004.UNIT_TYPE_ITEM_GATHER_ITEM then
...
function var_0_1.CheckGatherCanSign(arg_5_0)
	...
	if var_5_1 == var_1_10003.UNIT_TYPE_ITEM_GATHER_ITEM then
