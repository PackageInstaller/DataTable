...
function var_0_0.InitProductionCfg(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1(var_1_10002.island_production_farm.all) do
		pg = var_1_10006
...
function var_0_0.SetAreaDetection(arg_5_0)
	...
	var_5_2(var_5_1, var_1_10004(var_5_0))
	...
	for iter_6_0 = -1, 1 do
		for iter_6_1 = -1, 1 do
			...
			if var_6_5(var_6_6, var_6_7) then
				...
				local var_6_9 = arg_6_0:GetUnitModule(var_6_8)

				if var_20.GetPlantType(var_6_9) == var_6_4 then
					table = var_6_9
...
function var_0_0.CheckHighLight(arg_8_0)
	...
	local var_8_2 = arg_8_0:GetNearArea(var_8_0)

	local function var_8_3(arg_9_0)
		ipairs = var_2_10001

		for iter_9_0, iter_9_1 in var_2_10001(var_8_2) do
	...
	for iter_8_0, iter_8_1 in var_5(arg_8_0.lastHighlightDic) do
		if not var_8_3(iter_8_0) then
			arg_8_0.lastHighlightDic[iter_8_0] = nil

			local var_8_4 = arg_8_0:GetUnitModule(iter_8_0)

			var_10.SetHighLight(var_8_4, false)
		end
	end

	ipairs = var_5

	for iter_8_2, iter_8_3 in var_5(var_8_2) do
...
function var_0_0.GetUnitModule(arg_11_0, arg_11_1)
	...
	return var_11_1(var_11_0, var_1_10004.UNIT_LIST_OBJ, arg_11_1)
end
