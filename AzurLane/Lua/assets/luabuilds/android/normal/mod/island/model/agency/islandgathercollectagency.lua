	...
	for iter_7_0, iter_7_1 in var_1_10002(arg_7_1.gather_list) do
		...
		if iter_7_1.push_type == 1 then
			if arg_7_0.gatherDic[iter_7_1.id] then
				local var_7_4 = arg_7_0.gatherDic[iter_7_1.id]
				local var_7_5, var_7_6, var_7_7

				var_7_5, var_7_6, var_1_10013, var_7_7 = var_11.UpdateData(var_7_4, iter_7_1)
				var_7_3 = var_7_7
				var_7_2 = var_1_10013
				var_7_1 = var_7_6
				var_7_0 = var_7_5
		...
		elseif iter_7_1.push_type == 2 then
			if not arg_7_0.gatherDic[iter_7_1.id] then
				local var_7_8 = arg_7_0.gatherDic
				local var_7_9 = iter_7_1.id

				IslandWildGatherData = var_1_10013
				var_7_8[var_7_9] = var_1_10013.New(iter_7_1)
				var_7_0 = true
		...
		if var_7_1 then
			arg_7_0:DispatchEvent(var_0_1.RemoveGatherUnit, {
				unitId = var_7_3
			})
		end
		...
		if var_7_0 then
			...
			local var_7_11 = arg_7_0.DispatchEvent

			var_1_10013 = var_0_1.AddGatherUnit
			...
			IslandConst = var_15
			var_7_12.gatherType = var_15.UNIT_TYPE_ITEM_GATHER_ITEM

			var_7_11(var_7_10, var_1_10013, var_7_12)
		end
	end
	...
	for iter_8_0, iter_8_1 in var_1_10002(arg_8_1.gather_list) do
		...
		if iter_8_1.push_type == 1 then
			if arg_8_0.collectDic[iter_8_1.id] then
				local var_8_4 = arg_8_0.collectDic[iter_8_1.id]
				local var_8_5, var_8_6, var_8_7

				var_8_5, var_8_6, var_1_10013, var_8_7 = var_11.UpdateData(var_8_4, iter_8_1)
				var_8_3 = var_8_7
				var_8_2 = var_1_10013
				var_8_1 = var_8_6
				var_8_0 = var_8_5

				local var_8_8 = arg_8_0.collectDic[iter_8_1.id].pos
				local var_8_9 = unitId
			end
		elseif iter_8_1.push_type == 2 then
			if not arg_8_0.collectDic[iter_8_1.id] then
				local var_8_10 = arg_8_0.collectDic
				local var_8_11 = iter_8_1.id

				IslandCollectFragmentData = var_1_10013
				var_8_10[var_8_11] = var_1_10013.New(iter_8_1)
				var_8_0 = true
		...
		if var_8_1 then
			arg_8_0:DispatchEvent(var_0_1.RemoveGatherUnit, {
				unitId = var_8_3
			})
		end

		if var_8_0 then
			arg_8_0:DispatchEvent(var_0_1.AddGatherUnit, {
				unitId = var_8_2
			})
		end
	end
...
function var_0_1.GetUnitList(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_1_10002(arg_9_0.gatherDic) do
		if iter_9_1:IsShow() then
			...
			IslandConst = var_10
			var_9_3.gatherType = var_10.UNIT_TYPE_ITEM_GATHER_ITEM
	...
	for iter_9_2, iter_9_3 in var_2(arg_9_0.collectDic) do
		if iter_9_3:IsShow() then
			...
			IslandConst = var_10
			var_9_6.gatherType = var_10.UNIT_TYPE_ITEM_WILD_COLLECT_ITEM
