...
function var_0_1.register(arg_1_0)
	arg_1_0:bind(var_0_1.GIVE_CARD_LIKE, function(arg_2_0, arg_2_1, arg_2_2)
		...
		var_2_1(var_2_0, var_2_10005.ISLAND_GIVE_CARD_LIKE, {
			userId = arg_2_1,
			callback = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.GIVE_CARD_LABEL, function(arg_3_0, arg_3_1, arg_3_2)
		...
		var_3_1(var_3_0, var_2_10005.ISLAND_GIVE_CARD_LABEL, {
			userId = arg_3_1,
			labelId = arg_3_2
		})
	...
	arg_1_0:bind(var_0_1.ADD_FRIEND, function(arg_4_0, arg_4_1, arg_4_2)
		...
		var_4_1(var_4_0, var_2_10005.FRIEND_SEND_REQUEST, {
			id = arg_4_1,
			msg = arg_4_2
		})
	...
	arg_1_0:bind(var_0_1.REMOVE_FRIEND, function(arg_5_0, arg_5_1)
		...
		var_5_1(var_5_0, var_2_10004.FRIEND_DELETE, arg_5_1)
	...
	arg_1_0:bind(var_0_1.ADD_WHITE_LIST, function(arg_6_0, arg_6_1)
		...
		local var_6_2 = var_2_10004.ISLAND_ACCESS_OP
		local var_6_3 = {}

		IslandConst = var_2_10006
		var_6_3.op = var_2_10006.ACCESS_OP_ADD_WHITELIST
		var_6_3.list = {
			arg_6_1
		}
	...
	arg_1_0:bind(var_0_1.ADD_BLACK_LIST, function(arg_7_0, arg_7_1)
		...
		local var_7_2 = var_2_10004.ISLAND_ACCESS_OP
		local var_7_3 = {}

		IslandConst = var_2_10006
		var_7_3.op = var_2_10006.ACCESS_OP_ADD_BLACKLIST
		var_7_3.list = {
			arg_7_1
		}
...
function var_0_1.handleNotification(arg_9_0, arg_9_1)
	...
	if var_9_0 == var_9_1.ISLAND_GIVE_CARD_LIKE_DONE then
		...
		if var_9_0 == var_4.ISLAND_GIVE_CARD_LABEL_DONE then
			...
			if var_9_0 == var_4.FRIEND_SEND_REQUEST_DONE then
				...
				if var_9_0 == var_4.FRIEND_ADDED then
					...
					if var_9_0 == var_4.FRIEND_DELETE_DONE then
						...
						if var_9_0 == var_4.ISLAND_ACCESS_OP_DONE then
