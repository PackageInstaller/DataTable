...
function var_0_0.Add(arg_2_0, arg_2_1, arg_2_2)
	...
	if arg_2_0.preTimeStampDic[arg_2_1] then
		...
		var_2_0 = var_2_1(var_2_2, var_6.GetServerTimeMs(var_2_3) + arg_2_0.delayedTime)
	else
...
function var_0_0.Update(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_0(arg_3_0.delayedDataDic) do
		if #iter_3_1 > 0 and iter_3_1[1].timeStamp <= var_3_1 then
			...
			var_7(function()
				...
				var_2_10000(var_2_10001.traceback(...))
