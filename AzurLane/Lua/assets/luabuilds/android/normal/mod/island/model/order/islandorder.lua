...
function var_0_1.CanFinish(arg_6_0)
	...
	local var_6_1 = arg_6_0.GetConsume(var_6_0)
...
function var_0_1.GetDisplayAwards(arg_10_0)
	...
	if 0 < var_10_1 then
		...
		DROP_TYPE_ISLAND_ITEM = var_1_10006
		var_10_4.type = var_1_10006
...
function var_0_1.GetAwardConfigByTendency(arg_11_0, arg_11_1)
	...
	var_4(var_11_2, var_11_3 .. var_11_4 .. var_1_10008(var_11_1))
...
function var_0_1.GetRoleIcon(arg_14_0)
	...
	local var_14_1 = arg_14_0.getConfig(var_14_0, "npc_id")

	pg = var_14_0

	return var_14_0.island_unit_character[var_14_1].IslandShipIcon
end

function var_0_1.GetRoleName(arg_15_0)
	local var_15_0 = arg_15_0
	local var_15_1 = arg_15_0.getConfig(var_15_0, "npc_id")

	pg = var_15_0

	return var_15_0.island_unit_character[var_15_1].name
end
