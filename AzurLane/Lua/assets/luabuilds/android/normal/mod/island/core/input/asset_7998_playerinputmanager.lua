...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.inputController = var_1_1(var_1_0, var_1_10004(var_1_10005))
...
function var_0_0.Init(arg_3_0)
	...
	function var_0_0.UpdateMoveFunc(arg_4_0)
		...
		var_4_2(var_4_1, var_4.MOVE_PLAYER_BEFORE)

		local var_4_3 = arg_4_0.magnitude

		table = var_4_1

		var_4_1.insert(arg_3_0.inputCommandQueue, {
			Execute = function()
				...
				var_5_1(var_5_0, var_3_10002.MOVE_PLAYER, {
					targetDir = var_4_0,
					force = var_4_3
				})
	...
	function var_0_0.CancelMoveFunc(arg_6_0)
		...
		var_2_10001.insert(arg_3_0.inputCommandQueue, {
			Execute = function()
				...
				var_7_1(var_7_0, var_3_10002.STOP_MOVE_PLAYER)
	...
	function var_0_0.UpdateJumpFunc(arg_8_0)
		...
		var_2_10001.insert(arg_3_0.inputCommandQueue, {
			Execute = function()
				...
				var_9_1(var_9_0, var_3_10002.JUMP_PLAYER)
	...
	function var_0_0.UpdateSprintFuc(arg_10_0)
		...
		var_2_10001.insert(arg_3_0.inputCommandQueue, {
			Execute = function()
				...
				var_11_1(var_11_0, var_3_10002.SPRINT_PLAYER)
	...
	function var_0_0.CancelSprintFuc(arg_12_0)
		...
		var_2_10001.insert(arg_3_0.inputCommandQueue, {
			Execute = function()
				...
				var_13_1(var_13_0, var_3_10002.STOP_SPRINT_PLAYER)
...
function var_0_0.UpdataWorkStateFunc(arg_16_0, arg_16_1, arg_16_2)
	...
	var_1_10003.insert(arg_16_0.inputCommandQueue, {
		Execute = function()
			...
			var_17_1(var_17_0, var_2_10002.SET_PLAYER_WORK, arg_16_1, arg_16_2)
