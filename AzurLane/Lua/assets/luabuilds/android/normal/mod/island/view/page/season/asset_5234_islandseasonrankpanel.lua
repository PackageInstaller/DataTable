...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2(var_2_2, var_4("island_season_charts_refresh"))

	local var_2_3 = var_1
	local var_2_4 = var_1.Find(var_2_3, "header")

	setText = var_2_3

	local var_2_5 = var_2_4
	local var_2_6 = var_2_4.Find(var_2_5, "rank")

	i18n = var_2_5

	var_2_3(var_2_6, var_2_5("island_season_charts_ranking"))

	setText = var_2_3

	local var_2_7 = var_2_4
	local var_2_8 = var_2_4.Find(var_2_7, "info")

	i18n = var_2_7

	var_2_3(var_2_8, var_2_7("island_season_charts_information"))

	setText = var_2_3

	local var_2_9 = var_2_4
	local var_2_10 = var_2_4.Find(var_2_9, "pt")

	i18n = var_2_9

	var_2_3(var_2_10, var_2_9("island_season_charts_pt"))

	setText = var_2_3

	local var_2_11 = var_2_4
	local var_2_12 = var_2_4.Find(var_2_11, "award")

	i18n = var_2_11

	var_2_3(var_2_12, var_2_11("island_season_charts_award"))
	...
	local var_2_13 = var_1:Find("ranks")

	arg_2_0.rankRect = var_3.GetComponent(var_2_13, "LScrollRect")
...
function var_0_1.OnInit(arg_3_0)
	...
	IslandRankCard = var_1_10003
	arg_3_0.playerCard = var_3_1(var_3_2, var_1_10003.TYPE_SELF, arg_3_0)
...
function var_0_1.OnInitItem(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_0(var_6_1, var_1_10004.TYPE_OTHER, arg_6_0)
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	if arg_9_0.rankVOs[arg_9_0.seasonId] then
		getProxy = var_3
		BillboardProxy = var_1_10004

		local var_9_0 = var_3(var_1_10004)
		...
		if var_3.canFetch(var_9_0, arg_9_0.rankType, arg_9_0.seasonId) then
			...
			var_9_2(var_9_1, var_1_10005.ON_GET_SEASON_RANK, arg_9_0.rankType, arg_9_0.seasonId)
		else
