...
function var_0_1.InitPrivateData(arg_2_0, arg_2_1)
	...
	for iter_2_4, iter_2_5 in var_2(var_2_2) do
		...
		var_1_10008 = arg_2_0.visitorList
		IslandVisitorLog = var_1_10009

		var_1_10007(var_1_10008, var_1_10009.New(iter_2_5))
	end

	ipairs = var_2

	for iter_2_6, iter_2_7 in var_2(arg_2_1.daily_list) do
		local var_2_3 = iter_2_7.key

		IslandConst = var_1_10008

		if var_2_3 == var_1_10008.DL_INVITE_CODE_FLAG then
