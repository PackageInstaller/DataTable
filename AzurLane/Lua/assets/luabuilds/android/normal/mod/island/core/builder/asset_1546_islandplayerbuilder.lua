...
function var_0_1.AddComponents(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3_1(var_3_0, var_1_10005(var_1_10006)).isPlayer = true
	...
	typeof = var_7
	CharacterHandleController = var_8

	var_5(var_3_4, var_7(var_8))
	...
	typeof = var_7
	CharacterFootprintMgr = var_8

	var_5(var_3_5, var_7(var_8))
...
function var_0_1.LoadOtherPart(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	var_1_10005({
		function(arg_6_0)
			...
			typeof = var_2_10005
			JumpCurve = var_2_10006

			local var_6_4 = var_2_10005(var_2_10006)

			UnityEngine = var_2_10006

			local var_6_5 = var_6_1(var_6_0, var_6_2, var_6_3, var_6_4, var_2_10006.Events.UnityAction_UnityEngine_Object(function(arg_7_0)
