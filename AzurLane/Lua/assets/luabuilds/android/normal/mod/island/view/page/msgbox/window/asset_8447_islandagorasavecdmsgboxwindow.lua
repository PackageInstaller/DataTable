...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandCommonMsgboxEXWindow"))
...
function var_0_1.OnLoaded(arg_1_0)
	...
	local var_1_1 = var_2.Find(var_1_0, "cancel/Text")

	i18n = var_1_0

	var_1(var_1_1, var_1_0("island_label_furniture_exit"))

	setText = var_1

	local var_1_2 = arg_1_0._tf
	local var_1_3 = var_2.Find(var_1_2, "confirm/Text")

	i18n = var_1_2

	var_1(var_1_3, var_1_2("island_label_furniture_save"))
...
function var_0_1.AddTimer(arg_3_0, arg_3_1)
	...
	arg_3_0.timer = var_3.New(function()
		...
		if arg_3_1 - var_4_1 <= 0 then
			...
			var_2.Hide(var_2_10003)
		else
			local var_4_2 = arg_3_0.contentTxt

			i18n = var_2_10003

			local var_4_3 = "island_label_furniture_save_tip"

			pg = var_2_10005

			local var_4_4 = var_2_10005.TimeMgr.GetInstance()

			var_4_2.text = var_2_10003(var_4_3, var_5.DescCDTime(var_4_4, arg_3_1 - var_4_1))
		end
