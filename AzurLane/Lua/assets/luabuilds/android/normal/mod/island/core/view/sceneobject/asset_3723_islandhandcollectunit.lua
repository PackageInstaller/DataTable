...
local var_0_2 = var_0_0("Framework.toLua.UnityEngine.Vector3")
...
function var_0_1.LoadEffectItem(arg_4_0)
	...
	local var_4_2 = var_4.Euler(var_1.vfx_offset[2][1], var_1.vfx_offset[2][2], var_1.vfx_offset[2][3])
	...
	local function var_4_3(arg_5_0)
		...
		var_2_10001(var_5_0, var_3.GetView(var_5_1).root)
...
function var_0_1.GetToolId(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_7_4(var_7_1) do
		pg = var_1_10010
...
function var_0_1.CheckCanStartColloct(arg_11_0)
	...
	if not (var_1.GetCanCollectTimeStamps(var_11_0) == 0) then
		...
		local var_11_5 = (function(arg_12_0)
			...
			local var_12_1 = var_2.floor(arg_12_0 % 16 / 60)
			local var_12_2 = arg_12_0 % 60

			string = var_2_10004

			return var_2_10004.format("%02d:%02d:%02d", var_12_0, var_12_1, var_12_2)
		end)(var_11_4)

		pg = var_6

		local var_11_6 = var_6.TipsMgr.GetInstance()
		local var_11_7 = var_6.ShowTips

		i18n = var_1_10008

		var_11_7(var_11_6, var_1_10008("island_production_log_recover", var_11_5))
...
function var_0_1.GetHudInfo(arg_13_0)
	...
	string = var_13_1
	var_13_0.numProcess = var_13_1.format("%d/%d", var_13_2, 1)

	local var_13_3 = "island/"

	pg = var_5
	var_13_0.itemIcon = var_13_3 .. var_5.island_item_data_template[var_2.item_id].icon
...
function var_0_1.TakeAttack(arg_14_0)
	...
	local var_14_3 = var_1_10005.GEN_RECYCLEITEM
	local var_14_4 = {
		id = arg_14_0.id,
		unitId = var_14_0,
	...
	IslandDelayRecycleUnitBuilder = var_7
	var_14_4.recycleAssetType = var_7.RecycleType.ProductEffect
	...
	if arg_14_0.maxHp ~= 0 then
		...
		local var_14_6 = arg_14_0.GetToolId(var_14_5)

		pg = var_14_5

		local var_14_7 = var_14_5.island_animation_attachments[var_14_6].attack

		arg_14_0:TakeDamage(var_14_7)

		local var_14_8 = arg_14_0
		local var_14_9 = arg_14_0.NotifiyCore

		ISLAND_EVT = var_7

		local var_14_10 = var_7.UPDATE_HUD

		tonumber = var_1_10008

		var_14_9(var_14_8, var_14_10, var_1_10008(arg_14_0.id))

		if arg_14_0.currentHp < 0 then
			local var_14_11 = arg_14_0.slotData

			var_5.StartColloct(var_14_11)
		end
	else
		local var_14_12 = arg_14_0.slotData

		var_3.StartColloct(var_14_12)
	end
