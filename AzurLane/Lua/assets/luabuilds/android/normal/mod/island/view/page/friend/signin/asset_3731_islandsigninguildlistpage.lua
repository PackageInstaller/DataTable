...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..pages.IslandFriendList4GuildPage"))
...
function var_0_1.GetOpBtns(arg_2_0)
	...
	var_2_1[2] = function(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10003.SIGN_IN_INVITATION, {
			arg_3_0.id
		})
	...
	var_2_1[3] = function(arg_4_0)
		...
		local var_4_0 = var_2_10001(var_2)
