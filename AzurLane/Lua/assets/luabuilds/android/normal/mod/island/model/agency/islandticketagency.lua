...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	getProxy = var_4
	PlayerProxy = iter_1_0

	local var_1_6 = var_4(iter_1_0)
...
function var_0_1.AddTicket(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_2_0.data[arg_2_1][arg_2_2] then
		var_1_10005 = arg_2_0.data[arg_2_1][arg_2_2]

		var_4.AddCount(var_1_10005, arg_2_3)
	else
		local var_2_0 = arg_2_0.data[arg_2_1]

		IslandTicket = var_1_10005
		var_2_0[arg_2_2] = var_1_10005.New(arg_2_1, arg_2_2, arg_2_3)
	end
...
function var_0_1.GetExpireRemindTickets(arg_9_0)
	...
	if var_9_1(var_9_2 .. var_9_3 .. var_1_10005()) == 1 then
		return var_9_0
	end

	pairs = var_3

	for iter_9_0, iter_9_1 in var_3(arg_9_0.data) do
		pairs = var_1_10008
...
function var_0_1.SetRemindFlag(arg_10_0)
	...
	var_10_0(var_10_1 .. var_10_2 .. var_1_10004(), 1)
