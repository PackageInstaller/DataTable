...
function var_0_1.GetUnlockShipEffectIds(arg_21_0)
	...
	return var_1.select(arg_21_0:GetEffectIds(), function(arg_22_0)
		...
		return not var_22_0(var_2_10002.island_buff_template[arg_22_0].buff_type)
	end)
end
...
function var_0_1.GetEffectDesc(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_2(arg_23_0:getConfig("desc_add")) do
		string = var_1_10007
		var_23_0 = var_1_10007.gsub(var_23_0, "$" .. iter_23_0, iter_23_1[arg_23_0.level][1])
	end
...
function var_0_1.GetUpgradeMaterial(arg_32_0)
	...
	if not var_32_0[arg_32_0.level] then
		var_32_2 = {}
	end
	...
	for iter_32_0, iter_32_1 in var_3(var_32_2) do
		...
		var_32_4.type = var_1_10011
		var_32_4.id = iter_32_1[1]
		var_32_4.count = iter_32_1[2]

		var_1_10008(var_32_3, var_32_4)
	end
