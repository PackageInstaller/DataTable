...
local var_0_0 = "IslandShipDressUpSortPage"
...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame")
	local var_2_3 = arg_2_0._tf

	arg_2_0.sortUIItemList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/tpl"))
...
function var_0_1.InitList(arg_6_0)
	...
	var_1.make(var_6_0, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			local var_7_3 = arg_7_2.Find(var_7_2, "Text")

			setColorStr = var_7_2
			IslandShipDressUpPageNew = var_8

			var_2_10005(var_7_3, var_7_2(var_8.Sort2CN(var_7_0), var_7_1 and "#393a3c" or "#7c7e81"))
			...
			var_2_10005(var_7_4, var_7_5, var_7_6, var_9)
		end
	...
	var_6_2(var_6_1, #var_3.SORT_LIST)
