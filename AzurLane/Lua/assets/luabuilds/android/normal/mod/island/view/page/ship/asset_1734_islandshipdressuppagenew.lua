...
var_0_2[1] = var_2.DressType.Hair
IslandShipDressHelperNew = var_2
...
function var_0_1.OnLoaded(arg_3_0)
	...
	var_1(var_3_5, var_3_4("word_save"))
	...
	var_1(var_3_7, var_3_6("island_word_reset"))
	...
	typeof = var_3
	Text = var_4
	arg_3_0.orderTxt = var_3_32(var_3_31, var_3(var_4))
	...
	var_1(var_3_35, var_3("island_dress_initial_makesure"))
	...
	local var_3_45 = var_2.Find(var_3_44, "tips")

	i18n = var_3_44

	var_1(var_3_45, var_3_44("island_dresscolorunlock_tips"))

	setText = var_1

	local var_3_46 = arg_3_0.color_lockedBtn
	local var_3_47 = var_2.Find(var_3_46, "Text")

	i18n = var_3_46

	var_1(var_3_47, var_3_46("island_dresscolorunlock"))
...
function var_0_1.ClickDressCardItem(arg_9_0, arg_9_1)
	if arg_9_0.shipId ~= 0 then
		if arg_9_1.needRedDot then
			...
			pg = var_1_10003
			var_1_10004 = var_1_10003.m02
			var_1_10003 = var_1_10003.sendNotification
			GAME = var_5

			var_1_10003(var_1_10004, var_5.ISLAND_SEND_ROLE_DRESS_READ, {
				dress_List = var_9_0
			})
		end
		...
		var_9_1, var_1_10003 = arg_9_0.CheckDressIsExclusive(var_1_10003, arg_9_1.id)

		if var_1_10003 or var_9_1 then
			pg = var_1_10004
			var_1_10004 = var_1_10004.island_dress_template[arg_9_1.id]
			...
			if var_9_1 then
				...
				var_9_3(var_9_2, var_1_10007("island_dress_mutually_exclusive1", var_1_10004.name))
				...
				local var_9_5 = var_5.ShowTips

				i18n = var_1_10007

				var_9_5(var_9_4, var_1_10007("island_dress_mutually_exclusive1", var_1_10004.name))
		...
		local var_9_7 = var_1_10004.CheckIsEqualByShipIdAndDressId
		local var_9_8
		...
		if var_9_7(var_9_6, var_9_8, arg_9_1.id) then
			var_1_10004:SetShipAndDressId(nil, nil)
		else
			local var_9_9 = var_1_10004
			local var_9_10 = var_1_10004.SetShipAndDressId
			local var_9_11
			...
			var_9_10(var_9_9, var_9_11, arg_9_1.id)
		end

		local var_9_12 = arg_9_0.shipDressHelper
		local var_9_13 = var_5.ChangeDressByType
		local var_9_14 = arg_9_0.dressType
		local var_9_15 = {
			colorId = 0
		}
		local var_9_16

		if not var_1_10004.dress_id then
			var_9_16 = 0
		end

		var_9_15.id = var_9_16

		var_9_13(var_9_12, var_9_14, var_9_15)

		local var_9_17 = #arg_9_0.dressList
		local var_9_18 = arg_9_0.dressRect

		var_6.SetTotalCount(var_9_18, var_9_17)
	...
	if arg_9_1.needRedDot then
		...
		var_1_10003.insert(var_9_19, arg_9_1.id)
		...
		var_1_10003(var_1_10004, var_5.ISLAND_SEND_COMMANDER_DRESS_READ, {
			dress_List = var_9_19
		})
	end

	local var_9_20 = arg_9_1.id

	table = var_1_10003

	local var_9_21 = var_1_10003.contains

	IslandShipDressHelperNew = var_1_10004

	local var_9_22 = var_9_21(var_1_10004.CommanderCustom, arg_9_0.dressType)

	if arg_9_0.curDressTypeDataDic[arg_9_0.dressType] == var_9_20 then
		if var_9_22 then
			return
		else
			var_9_20 = 0
	...
	local var_9_23 = arg_9_0.dressType

	IslandShipDressHelperNew = var_5

	if var_9_23 == var_5.DressType.Body then
		local var_9_24 = arg_9_0.dressUpAgency

		if var_4.GetTwinCurId(var_9_24, var_9_20) and var_4 ~= 0 then
			var_9_20 = var_4
		end
	end

	arg_9_0.curDressTypeDataDic[arg_9_0.dressType] = var_9_20

	local var_9_25 = (function()
		local var_10_0 = 0

		if var_9_20 ~= 0 and arg_9_0.shipId == 0 then
			local var_10_1 = arg_9_0.dressUpAgency

			var_10_0 = var_1.GetCurrentColorByDressId(var_10_1, var_9_20)
			arg_9_0.dressColorDic[var_9_20] = var_10_0
		end

		return var_10_0
	end)()
	local var_9_26 = arg_9_0.shipDressHelper

	var_6.ChangeDressByType(var_9_26, arg_9_0.dressType, {
		id = var_9_20,
		colorId = var_9_25
	})

	local var_9_27 = #arg_9_0.dressList
	local var_9_28 = arg_9_0.dressRect

	var_7.SetTotalCount(var_9_28, var_9_27)
	arg_9_0:CheckHatAutoTakeOff(var_9_20)
...
function var_0_1.CheckHatAutoTakeOff(arg_11_0, arg_11_1)
	...
	if var_11_0 == var_1_10003.DressType.Body then
		...
		if not var_2.GetBodyHatDressId(var_11_1, arg_11_1) or var_2 == 0 then
			...
			var_11_2[var_4.DressType.Hat] = 0
			...
			var_11_4(var_11_3, var_5.DressType.Hat, {
				id = 0,
				colorId = 0
			})
		end
...
function var_0_1.AddLongPressListeners(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	typeof = var_1_10008
	LongPressTrigger = var_1_10009

	local var_26_2 = var_1_10006(var_26_1, var_1_10008(var_1_10009)).onClick
	...
	var_7.AddListener(var_26_5, function()
		...
		local var_29_2 = var_29_1(var_29_0, var_2_10002(arg_26_2).position)
		...
		local var_29_4 = var_29_3 - var_3(arg_26_2).sizeDelta.x / 2
		local var_29_5 = var_29_2.y

		tf = var_4

		local var_29_6 = var_29_0(var_29_4, var_29_5 + var_4(arg_26_2).sizeDelta.y / 2)
...
function var_0_1.OnDressUpdateItem(arg_30_0, arg_30_1, arg_30_2)
	...
	var_6(var_30_0.ownNumTF, var_30_2)

	if var_30_2 then
		setText = var_6

		var_6(var_30_0.ownNumText, "×" .. var_30_1.ownCount)
	end
	...
	IslandShipDressDescBox = var_1_10012

	var_30_9(var_30_8, var_1_10012.TYPE.DRESS, arg_30_2, var_30_6, function()
	...
	if arg_30_0.shipId == 0 then
		if (arg_30_0.curDressTypeDataDic[arg_30_0.dressType] ~= 0 and var_11 or nil) ~= var_30_1.id then
			var_30_11 = var_30_1

			if var_12 ~= var_30_1.getConfig(var_30_11, "cloth_related") then
				var_30_10 = false
		...
		local var_30_12, var_30_13 = arg_30_0:CheckDressIsExclusive(var_30_1.id)
		local var_30_14 = var_30_12 or var_30_13

		setActive = var_30_11

		var_30_11(var_30_0.exclusionTF, var_30_14)

		local var_30_15 = arg_30_0.curShipDressTypeDataDic[arg_30_0.dressType]
		local var_30_16 = var_14.CheckIsEqualByShipIdAndDressId
		local var_30_17
		...
		var_30_10 = var_30_16(var_30_15, var_30_17, var_30_1.id)
	end
...
function var_0_1.OnSkinUpdateItem(arg_33_0, arg_33_1, arg_33_2)
	...
	var_6(var_33_2:Find("changeColor"), true)
	...
	IslandShipDressDescBox = var_10

	var_33_5(var_33_4, var_10.TYPE.SKIN, arg_33_2, var_33_1, function()
...
function var_0_1.ChangeModelBySkinAndSkinColor(arg_35_0)
	...
	IslandShipDressHelperNew = var_1_10004
	var_35_3[1] = var_1_10004.DressType.BackDecorate
	IslandShipDressHelperNew = var_4
	...
	if 0 < var_35_6 then
		...
		pg = var_5
		var_35_8 = var_5.TipsMgr.GetInstance()

		local var_35_9 = var_5.ShowTips

		i18n = var_7

		var_35_9(var_35_8, var_7("island_dress_mutually_exclusive", var_35_7))
	end

	local var_35_10 = arg_35_0
	local var_35_11 = arg_35_0.emit

	IslandShipMainPage = var_35_8

	var_35_11(var_35_10, var_35_8.CLEAR_ITEM_ANIMATOR)

	local var_35_12 = var_35_1:GetModelBySkinAndColorId(arg_35_0.curSkinId, arg_35_0.curskinColorId)

	if #var_35_2 > 0 then
		local var_35_13 = arg_35_0.shipDressHelper

		var_5.ChangeModelTransfromByUnitIdAndChangeDress(var_35_13, var_35_12, var_35_2, nil, nil, true)
	else
		local var_35_14 = arg_35_0.shipDressHelper

		var_5.ChangeModelTransfromByUnitId(var_35_14, var_35_12, nil, true)
	end
...
function var_0_1.AddListeners(arg_38_0)
	...
	var_38_1(var_38_0, var_1_10003.ISLAND_CHANGE_ROLE_DRESS_DONE, arg_38_0.OnChangeRoleDressDone)
	...
	var_38_3(var_38_2, var_3.ISLAND_SEND_ROLE_DRESS_READ_DONE, arg_38_0.OnSendRoleDressReadDone)
	...
	var_38_5(var_38_4, var_3.ISLAND_SEND_COMMANDER_DRESS_READ_DONE, arg_38_0.OnSendRoleDressReadDone)
	...
	var_38_7(var_38_6, var_3.ISLAND_BUY_ROLE_SKIN_COLOR_DONE, arg_38_0.OnBuyRoleSkinColorDone)
	...
	var_38_9(var_38_8, var_3.ISLAND_BUY_ROLE_DRESS_COLOR_DONE, arg_38_0.OnBuyRoleDressColorDone)
	...
	var_38_11(var_38_10, var_3.ISLAND_SHOP_OP_DONE, arg_38_0.GetBuySkindDone)
...
function var_0_1.RemoveListeners(arg_39_0)
	...
	var_39_1(var_39_0, var_1_10003.ISLAND_CHANGE_ROLE_DRESS_DONE, arg_39_0.OnChangeRoleDressDone)
	...
	var_39_3(var_39_2, var_3.ISLAND_SEND_ROLE_DRESS_READ_DONE, arg_39_0.OnSendRoleDressReadDone)
	...
	var_39_5(var_39_4, var_3.ISLAND_SEND_COMMANDER_DRESS_READ_DONE, arg_39_0.OnSendRoleDressReadDone)
	...
	var_39_7(var_39_6, var_3.ISLAND_BUY_ROLE_SKIN_COLOR_DONE, arg_39_0.OnBuyRoleSkinColorDone)
	...
	var_39_9(var_39_8, var_3.ISLAND_BUY_ROLE_DRESS_COLOR_DONE, arg_39_0.OnBuyRoleDressColorDone)
	...
	var_39_11(var_39_10, var_3.ISLAND_SHOP_OP_DONE, arg_39_0.GetBuySkindDone)
...
function var_0_1.OnInit(arg_41_0)
	...
	local function var_41_2()
		...
		if not var_0.CheckDressIsDirty(var_42_0) then
			...
			if arg_41_0.changeDressType then
				...
				GAME = var_2_10002
				var_2_10002 = var_2_10002.ISLAND_CHEATER_CHANGE_VIEW_DRESSID
				...
				PlayRoomTools = var_4
				var_42_3.game_type = var_4.GetGameTypeID()
				var_42_3.ship_id = arg_41_0.shipId

				var_42_2(var_42_1, var_2_10002, var_42_3)
				...
				var_42_2(var_42_4, var_2_10002.PLAY_ROOM_REFRESH_ROOM_INFO)
			end
			...
			var_42_6(var_42_5, var_2_10002("island_dress_save1"))
	...
	var_1_10001(var_41_0, var_41_1, var_41_2, var_1_10005)
	...
	local function var_41_5()
		...
		var_43_2.type = var_2_10003.TYPE_COMMON
		i18n = var_3
		var_43_2.content = var_3("island_dressup_tip")
	...
	var_1_10001(var_41_3, var_41_4, var_41_5, var_1_10005)
	...
	var_1_10001(var_41_6, var_41_7, var_41_8, var_1_10005)
	...
	for iter_41_0, iter_41_1 in var_1_10001(arg_41_0.toggles) do
		...
		var_1_10006(var_41_9, var_41_10, var_41_11, var_1_10010)
	end
	...
	var_1(var_41_12, var_41_13, var_41_14, iter_41_1)
	...
	var_1(var_41_15, var_41_16, var_41_17, iter_41_1)
	...
	if arg_54_0.currentToggleIndex == 4 then
		...
		if arg_54_0.SmoothFunc then
			...
			if var_54_0 == var_3.DressType.BackDecorate then
				...
				var_54_0(var_3.Euler(0, 0, 0))
			else
				var_54_0 = arg_54_0.SmoothFunc
				Quaternion = var_3

				var_54_0(var_3.Euler(0, 180, 0))
			end
		end
...
function var_0_1.GetDressUpList(arg_55_0)
	...
	if arg_55_0.shipId == 0 then
		...
		local var_55_0 = arg_55_0.dressUpAgency

		for iter_55_4, iter_55_1 in var_1(var_2.GetHasDressByType(var_55_0, arg_55_0.dressType)) do
			pg = var_1_10006

			if var_1_10006.island_dress_template[iter_55_1.id].is_hide ~= 1 then
				local var_55_1 = var_1_10006.quality

				table = var_1_10008
				var_1_10008 = var_1_10008.insert
				var_1_10009 = arg_55_0.dressList
				IslandDressItem = var_1_10010

				var_1_10008(var_1_10009, var_1_10010.New({
					id = iter_55_1.id,
					quality = var_55_1,
		...
		local var_55_2 = arg_55_0.characterAgency

		for iter_55_4, iter_55_3 in var_1(var_2.GetAllOwnDressDic(var_55_2)) do
			if iter_55_3:getConfigTable().type == arg_55_0.dressType and iter_55_3.num > 0 and iter_55_3:getConfigTable().is_hide ~= 1 then
				pg = var_1_10006
				var_1_10006 = var_1_10006.island_dress_template[iter_55_3.id].quality
				table = var_7

				local var_55_3 = var_7.insert
				local var_55_4 = arg_55_0.dressList

				IslandDressItem = var_1_10009

				var_55_3(var_55_4, var_1_10009.New({
					id = iter_55_3.id,
		...
		local var_55_5 = arg_55_0.characterAgency

		for iter_55_4, iter_55_5 in var_1(var_2.GetShipHoldedDressDic(var_55_5)) do
			ipairs = var_1_10006
			...
			for iter_55_6, iter_55_7 in var_1_10006(iter_55_5) do
				if iter_55_7:getConfigTable().type == arg_55_0.dressType and iter_55_7:getConfigTable().is_hide ~= 1 then
					...
					local var_55_6 = var_11.island_dress_template[iter_55_7.dress_id].quality

					table = var_12

					local var_55_7 = var_12.insert
					local var_55_8 = arg_55_0.dressList

					IslandDressItem = var_1_10014

					var_55_7(var_55_8, var_1_10014.New({
	...
	local var_55_10 = var_2.sort
	local var_55_11 = arg_55_0.dressList

	CompareFuncs = iter_55_4

	var_55_10(var_55_11, iter_55_4(var_55_9))
...
function var_0_1.GetSkinList(arg_60_0)
	if arg_60_0.shipId ~= 0 then
		...
		if not var_1_10002.island_skin_template.get_id_list_by_ship_group[arg_60_0.shipId] then
			var_60_0 = {}
		end
...
function var_0_1.UpdateSkinList(arg_61_0)
	...
	var_2(var_61_2, var_4("island_dress_no_item"))
...
function var_0_1.UpdateDressUpList(arg_62_0)
	...
	var_1_10002(var_62_1, var_4("island_dress_no_item"))
...
function var_0_1.OnShow(arg_63_0, arg_63_1, arg_63_2, arg_63_3, arg_63_4, arg_63_5)
	...
	local var_63_0 = var_1_10006(var_7)
	...
	if arg_63_0.changeDressType then
		...
		for iter_63_0, iter_63_1 in var_6(var_7.gameset.bar_not_display_dress_type.description) do
			pairs = var_1_10011
		...
		if arg_64_0.isFirstDressUp then
			...
			if false then
				...
				for iter_64_2, iter_64_3 in var_2(var_64_6.ExtraDressType) do
					...
					IslandShipDressItem = var_9
					var_64_9[iter_64_3] = var_9.New(var_64_8)
				end
			end
...
function var_0_1.ResetDressUp(arg_66_0)
	if arg_66_0.shipId == 0 then
		...
		for iter_66_0, iter_66_1 in var_1(var_1_10002.DressType) do
		...
		if (function()
			...
			local var_66_10 = var_66_9.GetModelBySkinAndColorId(iter_66_0, arg_66_0.curSkinId, arg_66_0.curskinColorId)
			local var_66_11 = arg_66_0.shipDressHelper

			iter_66_0.ChangeModelTransfromByUnitId(var_66_11, var_66_10)
		...
		IslandShipDressHelperNew = iter_66_0
		var_66_12[1] = iter_66_0.DressType.BackDecorate
		IslandShipDressHelperNew = var_4
		...
		for iter_66_2, iter_66_3 in var_4(var_66_12) do
			...
			IslandShipDressItem = var_66_15
			var_66_20[iter_66_3] = var_66_15.New(var_66_14)
		end
...
function var_0_1.SaveDressUpDataHandle(arg_69_0, arg_69_1)
	if arg_69_0.shipId == 0 then
		...
		if not arg_69_0:CheckShipCanSave() then
			...
			var_69_5(var_69_4, var_7("island_dress_save2"))
	...
	if arg_70_0.shipId == 0 then
		local var_70_0, var_70_1 = (function()
			...
			for iter_71_0, iter_71_1 in var_2_10002(arg_70_0.curDressTypeDataDic) do
				...
				IslandShipDressHelperNew = var_9

				if iter_71_0 == var_9.DressType.Hat and iter_71_1 == 0 then
					var_71_4 = true
				end
		...
		pg = var_1_10005
		var_1_10006 = var_1_10005.m02

		local var_70_2 = var_5.sendNotification

		GAME = var_1_10007

		var_70_2(var_1_10006, var_1_10007.ISLAND_CHANGE_COMMANDER_DRESS, {
			dress_List = var_70_0,
			color_list = var_70_1,
		...
		for iter_70_0, iter_70_1 in var_1_10006(arg_70_0.curShipDressTypeDataDic) do
			local var_70_7 = arg_70_0.characterAgency
			local var_70_8

			if not var_11.GetCurDressIdByShipId(var_70_7, arg_70_0.shipId, iter_70_0) then
				var_70_8 = {}
			end

			if not iter_70_1:CheckIsEqualByShipDressItem(var_70_8) then
				if not iter_70_1.dress_id then
					table = var_12

					var_12.insert(var_70_4, var_70_8.dress_id)
				elseif iter_70_1.ship_id ~= 0 then
					if var_70_8.dress_id then
						table = var_12

						var_12.insert(var_70_6, var_70_8.dress_id)
					end

					table = var_12

					var_12.insert(var_70_5, {
		...
		local function var_70_9()
			...
			var_72_1(var_72_0, var_2_10002.ISLAND_CHANGE_DRESS, {
				dress_List = var_70_3,
				unload_dress = var_70_4,
			...
			if arg_70_0.changeDressType then
				...
				local var_72_4 = var_2.ISLAND_CHEATER_CHANGE_VIEW_DRESSID
				local var_72_5 = {
					type = arg_70_0.changeDressType
				}

				PlayRoomTools = var_4
				var_72_5.game_type = var_4.GetGameTypeID()
		...
		IslandMsgBox = iter_70_1
		var_70_12.type = iter_70_1.TYPE_DRESS_WEAR_CONFIRE
		i18n = var_10
		var_70_12.content = var_10("island_dress_replace_tip")
		var_70_12.needconfirmDressList = var_70_5

		function var_70_12.onYes()
			ipairs = var_2_10000

			for iter_73_0, iter_73_1 in var_2_10000(var_70_5) do
				table = var_2_10005

				var_2_10005.insert(var_70_3, iter_73_1)
			end

			ipairs = var_0

			for iter_73_2, iter_73_3 in var_0(var_70_6) do
				table = var_2_10005

				var_2_10005.insert(var_70_4, iter_73_3)
			end
...
function var_0_1.CheckInReturn(arg_75_0, arg_75_1)
	...
	if not arg_75_0.CheckShipCanSave(var_75_0) then
		existCall = var_75_0
		...
		local var_75_1 = var_75_0.TipsMgr.GetInstance()
		local var_75_2 = var_3.ShowTips

		i18n = var_1_10005

		var_75_2(var_75_1, var_1_10005("island_dress_exit2"))

		return
	end

	local var_75_3 = arg_75_0
	local var_75_4 = arg_75_0.ShowMsgBox
	local var_75_5 = {}

	IslandMsgBox = var_1_10006
	var_75_5.type = var_1_10006.TYPE_COMMON
	i18n = var_6
	var_75_5.content = var_6("island_dressup_tip_1")
...
function var_0_1.OnChangeRoleDressDone(arg_78_0)
	...
	for iter_78_0, iter_78_1 in var_1_10001(arg_78_0.curShipDressTypeDataDic) do
		...
		IslandShipDressItem = var_8
		var_78_2[iter_78_0] = var_8.New(var_78_1)
	end
	...
	var_1_10007(arg_86_0, arg_86_0.color_lockedBtn, function()
		local function var_88_0()
			...
			if arg_86_0.isDressColor then
				...
				var_89_1(var_89_0, var_3_10002.ISLAND_BUY_ROLE_DRESS_COLOR, {
					id = arg_86_0.shipId,
					dress_id = var_86_2,
					color_id = var_86_1
				})
				...
				var_89_3(var_89_2, var_3_10002.ISLAND_BUY_ROLE_SKIN_COLOR, {
		...
		IslandMsgBox = var_6
		var_88_5.type = var_6.TYPE_COMMON
		...
		function var_88_5.onYes()
			if not (function(arg_91_0)
				...
				var_90_1(var_90_0, var_3_10003("common_no_resource"))
...
function var_0_1.UpdateColorItemList(arg_93_0)
		...
		if arg_93_0.isDressColor then
			...
			if #var_94_2 > 0 then
				...
				for iter_94_0, iter_94_1 in var_5(var_94_2) do
					...
					local var_94_6 = arg_93_0.dressUpAgency
					local var_94_7 = var_11.CheckDressColorIsOwned(var_94_6, var_94_0, iter_94_1)

					table = var_94_6

					local var_94_8 = var_94_6.insert

					var_2_10013 = arg_93_0.colorItemList
					...
					pg = var_2_10015
					var_94_9.costItemIcon = var_2_10015.island_dress_colordiff_template[iter_94_1].color_icon

					var_94_8(var_2_10013, var_94_9)
				end
			end
		else
			pg = var_94_0
			...
			local var_94_11 = arg_93_0.curskinColorId == 0
			local var_94_12 = arg_93_0.characterAgency
			local var_94_13 = var_2.CheckSkinIsOwned(var_94_12, arg_93_0.curSkinId)

			table = var_94_12

			var_94_12.insert(arg_93_0.colorItemList, {
				itemId = 0,
				selected = var_94_11,
				owned = var_94_13
			})
			...
			for iter_94_2, iter_94_3 in var_3(var_94_10) do
				local var_94_14 = arg_93_0.curskinColorId == iter_94_3
				local var_94_15 = arg_93_0.characterAgency
				local var_94_16 = var_9.CheckSkinColorIsOwned(var_94_15, arg_93_0.curSkinId, iter_94_3)

				table = var_94_15

				local var_94_17 = var_94_15.insert
				local var_94_18 = arg_93_0.colorItemList
				local var_94_19 = {
					itemId = iter_94_3,
					selected = var_94_14,
					owned = var_94_16
				...
				pg = var_2_10013
				var_94_19.costItemIcon = var_2_10013.island_skin_colordiff_template[iter_94_3].color_icon

				var_94_17(var_94_18, var_94_19)
			end
		end
	...
	var_2.make(var_93_0, function(arg_95_0, arg_95_1, arg_95_2)
		...
		if arg_95_0 == var_2_10003.EventUpdate then
			...
			var_5(arg_95_2:Find("orginName"), var_95_1 == 0)

			setActive = var_5

			var_5(arg_95_2:Find("locked"), var_95_1 == 0)

			setActive = var_5

			var_5(arg_95_2:Find("icon"), false)
