...
function var_0_1.UpdateRotation(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_1_10004.ITEM_DIR_UPDATE, arg_8_0.rotation)
...
function var_0_1.UpdatePosition(arg_9_0, arg_9_1)
	...
	var_9_1(var_9_0, var_4.ITEM_POSITION_UPDATE, arg_9_0.area)
...
function var_0_1.Rotation(arg_14_0)
	...
	var_14_2(var_14_1, var_1_10004(0, var_14_0, 0))
...
function var_0_1.GenAreaByPosition(arg_16_0, arg_16_1)
	if arg_16_0:IsForward() then
		...
		return var_16_0(var_16_1, var_1_10004(arg_16_0.size.y, arg_16_0.size.x))
	end
