...
function var_0_0.Ctor(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	for iter_2_0, iter_2_1 in var_4(var_2_2) do
		...
		var_10.insert(arg_2_0.steps, var_2_3)
	end
...
function var_0_0.LastStepIsTimeline(arg_5_0)
	...
	if var_2(var_5_1, var_1_10004) then
...
function var_0_0.GetTriggerDelayTime(arg_18_0)
	...
	if var_18_0(var_1_10002.STORY_AUTO_SPEED, arg_18_0.speed) then
		Story = var_2

		local var_18_1

		if not var_2.TRIGGER_DELAY_TIME[var_1] then
			var_18_1 = 0
		end
...
function var_0_0.GetLookGroup(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10004(arg_26_0.unitMap) do
		...
		if var_26_5(var_26_4, var_26_6) then
			...
			var_26_4.insert(var_26_0, var_10)

			table = var_11

			local var_26_8 = var_11.insert
			...
			var_26_8(var_26_9, var_26_10)

			table = var_26_8

			local var_26_11 = var_26_8.insert
			local var_26_12 = var_26_2
			local var_26_13
			...
			var_26_11(var_26_12, var_26_13)
		end
	end

	local var_26_14 = arg_26_0
	local var_26_15 = arg_26_0.GetPlayerRole(var_26_14)

	table = var_26_14

	if not var_26_14.contains(var_26_0, var_26_15) then
		table = var_5

		var_5.insert(var_26_0, var_26_15)
		...
		local var_26_17 = var_6.insert
		local var_26_18 = var_26_1
		local var_26_19

		if not var_26_16[1] then
			var_26_19 = 1
		end
		...
		local var_26_21 = var_26_2
		local var_26_22

		if not var_26_16[2] then
			var_26_22 = 0
		end

		var_26_20(var_26_21, var_26_22)
	end
...
function var_0_0.GetPlayerRole(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10001(arg_27_0.unitList) do
		...
		IslandPlayerUnit = var_1_10008

		if var_1_10006(var_27_0, var_1_10008) then
