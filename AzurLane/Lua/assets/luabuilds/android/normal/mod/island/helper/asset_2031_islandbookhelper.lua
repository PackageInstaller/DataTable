...
function var_0_0.OnNpcInteract(arg_3_0)
	...
	if var_2.GetIllustration(var_3_3, var_3_0, arg_3_0) then
		...
		var_3_3 = var_3.GetStatus(var_3_4)
		IslandIllustration = var_3_4

		if var_3_3 ~= var_3_4.STATUS.LOCK then
			return
		end

		pg = var_3_3

		local var_3_5 = var_3_3.m02
		local var_3_6 = var_4.sendNotification

		GAME = var_6

		var_3_6(var_3_5, var_6.ISLAND_UPDATE_ILLUSTRATION, {
			type = var_3_0,
			linkId = arg_3_0
		})
