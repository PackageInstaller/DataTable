...
function var_0_1.FirstFlush(arg_5_0)
	...
	arg_5_0.moveBtnCg = var_1(var_5_5, var_3(var_1_10004))
	...
	arg_5_0.chatView = var_5_7(var_5_8, var_3.Find(var_5_9, "adapt/chat"))
	onButton = var_1
	...
	var_1(var_5_10, var_5_11, var_5_12, var_5)

	onToggle = var_1

	local var_5_13 = arg_5_0
	local var_5_14 = arg_5_0._tf
	local var_5_15 = var_3.Find(var_5_14, "adapt/tags/1")
	...
	var_1(var_5_13, var_5_15, var_5_16, var_5)

	onToggle = var_1

	local var_5_17 = arg_5_0
	local var_5_18 = arg_5_0._tf
	local var_5_19 = var_3.Find(var_5_18, "adapt/tags/2")
	...
	var_1(var_5_17, var_5_19, var_5_20, var_5)

	onToggle = var_1

	local var_5_21 = arg_5_0
	local var_5_22 = arg_5_0._tf
	local var_5_23 = var_3.Find(var_5_22, "adapt/tags/3")
	...
	var_1(var_5_21, var_5_23, var_5_24, var_5)
...
function var_0_1.SwitchPage(arg_13_0, arg_13_1)
	...
	if arg_13_1 == var_0_2 then
		...
		arg_13_0.InitList(var_13_0)

		local var_13_1 = arg_13_0.lookBtn

		Vector2 = var_13_0
		var_13_1.offsetMax = var_13_0(-594, arg_13_0.lookBtn.offsetMax.y)
	elseif arg_13_1 == var_0_3 then
		local var_13_2 = arg_13_0

		arg_13_0.InitList(var_13_2)

		local var_13_3 = arg_13_0.lookBtn

		Vector2 = var_13_2
		var_13_3.offsetMax = var_13_2(-594, arg_13_0.lookBtn.offsetMax.y)
	elseif arg_13_1 == var_0_4 then
		local var_13_4 = arg_13_0.chatView

		var_2.Execute(var_13_4, "Show", true)

		local var_13_5 = arg_13_0.lookBtn

		Vector2 = var_13_4
		var_13_5.offsetMax = var_13_4(-985, arg_13_0.lookBtn.offsetMax.y)
	end
...
function var_0_1.UpdateMoveBtn(arg_14_0)
	...
	local var_14_0 = var_1_10001(var_1_10002.Find("UICamera/Canvas")).sizeDelta.x
	...
	local var_14_5 = var_1_10005.GetFloat

	IslandSettingsConst = var_1_10006

	local var_14_6 = var_14_5(var_1_10006.ISLAND_KEY_JOYSTICK_ANCHORX, var_14_4.x)

	PlayerPrefs = var_6

	local var_14_7 = var_6.GetFloat

	IslandSettingsConst = var_7

	local var_14_8 = var_14_7(var_7.ISLAND_KEY_JOYSTICK_ANCHORY, var_14_4.y)
...
function var_0_1.GetData(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_21_4(var_21_5) do
		pg = var_1_10010
...
function var_0_1.SortForNpcAction(arg_25_0, arg_25_1)
	...
	if var_4.data then
		...
		IslandStrollUnitVO = var_7

		if not var_5(var_25_3, var_7) then
			return
		end
...
function var_0_1.OnInitItem(arg_26_0, arg_26_1)
	...
	var_3(var_26_1, var_26_2, var_26_3, var_1_10007)
	...
	var_3(var_26_4, var_26_5, var_26_6, var_1_10007)
...
function var_0_1.CanPlayCoupleAction(arg_29_0, arg_29_1)
	...
	local var_29_1 = arg_29_0.GetPlayerUnit(var_29_0)

	BuildVector3 = var_29_0

	local var_29_2 = var_29_0(arg_29_1.respond_point).magnitude

	IslandCalcUtil = var_1_10005

	return var_1_10005.IsCircleInsideNavMesh(var_29_1.agent, var_29_1._tf.position, var_29_2, 12)
end
...
function var_0_1.PlayAniamtion(arg_30_0, arg_30_1)
	...
	if var_30_0 == var_1_10004.ANIMATION_OP_DOUBLE then
		...
		if not arg_30_0.CanPlayCoupleAction(var_30_1, var_2) then
			pg = var_3
			var_30_1 = var_3.TipsMgr.GetInstance()

			local var_30_2 = var_3.ShowTips

			i18n = var_1_10005

			var_30_2(var_30_1, var_1_10005("island_position_cant_play_cp_action"))
		...
		var_30_3(var_30_1, var_1_10005.LOCK_PLAYER_INPUT)

		arg_30_0.startSingleActionId = nil
		var_30_1 = arg_30_0

		arg_30_0.AddWaitTimer(var_30_1, arg_30_1)

		var_30_1 = arg_30_0
		var_30_1 = arg_30_0.GetPlayerUnit(var_30_1)

		var_3.PlayAnimation(var_30_1, var_2.resource, 0.25, function()
			...
			if var_0.HasFollowerAndNoVisitorAround(var_31_0) then
				...
				var_31_2(var_31_1, var_2_10002.COUPLE_ACTION_WITH_FOLLOWER, arg_30_0.startCoupleActionId)
			else
				...
				var_31_4(var_31_3, var_2_10002.ANIMATION_OP, 0, arg_30_0.startCoupleActionId)
			end
		...
		arg_30_0.ApplyEffect(var_30_1, arg_30_1)
	else
		local var_30_4 = var_2.type

		IslandConst = var_30_1

		if var_30_4 == var_30_1.ANIMATION_OP_SIGNLE then
			if arg_30_0.startSingleActionId == arg_30_1 then
				return
			end

			local var_30_5 = arg_30_0
			local var_30_6 = arg_30_0.NotifiyCore

			ISLAND_EVT = var_1_10005

			var_30_6(var_30_5, var_1_10005.LOCK_PLAYER_INPUT)

			arg_30_0.startSingleActionId = arg_30_1

			arg_30_0:RemoveWaitTimer()

			local var_30_7 = arg_30_0:GetPlayerUnit()

			var_3.PlayAnimation(var_30_7, var_2.resource, 0.25, function()
				...
				var_32_2(var_32_1, var_2_10002.PLAY_SIGNLE_ANIMATION_END, var_0.id)
...
function var_0_1.HasFollowerAndNoVisitorAround(arg_34_0)
	...
	local var_34_5 = var_34_4(var_34_3, var_1_10006.UNIT_LIST_PLAYER)

	_ = var_34_3

	local var_34_6 = var_34_3.any(var_34_5, function(arg_35_0)
	...
	local var_34_9 = var_34_8(var_34_7, var_1_10008.UNIT_LIST_FOLLOW)

	_ = var_34_7

	local var_34_10 = var_34_7.any(var_34_5, function(arg_36_0)
		Vector3 = var_2_10001
...
function var_0_1.RemoveWaitTimer(arg_41_0, arg_41_1)
	...
	if arg_41_0.isWaitingCoupleAction then
		...
		var_41_3(var_41_2, var_4.ANIMATION_OP, 0, 0)
	end
...
function var_0_1.OnDisable(arg_44_0)
	if arg_44_0.isShowing then
		...
		var_44_1(var_44_0, var_1_10003.CLOSE_ANIMATION_OP)
