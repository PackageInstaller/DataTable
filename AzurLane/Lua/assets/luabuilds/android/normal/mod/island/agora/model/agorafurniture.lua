...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".AgoraPlaceableItem"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	var_1_1(var_1_2, var_1_3, var_1_10005(arg_1_0.config.size[1], arg_1_0.config.size[2]))
...
function var_0_1.IsOptionalShapeType(arg_20_0)
	...
	local var_20_1 = arg_20_0.GetType(var_20_0)

	AgoraFurnitureType = var_20_0

	local var_20_4

	if var_20_1 ~= var_20_0.FLOOR then
		local var_20_2 = arg_20_0
		local var_20_3 = arg_20_0.GetType(var_20_2)

		AgoraFurnitureType = var_20_2

		if var_20_3 ~= var_20_2.TILE then
			var_20_4 = false
...
function var_0_1.IsFoundationType(arg_21_0)
	...
	local var_21_1 = arg_21_0.GetType(var_21_0)

	AgoraFurnitureType = var_21_0

	return var_21_1 == var_21_0.FOUNDATION
end

function var_0_1.IsBuildingType(arg_22_0)
	local var_22_0 = arg_22_0
	local var_22_1 = arg_22_0.GetType(var_22_0)

	AgoraFurnitureType = var_22_0

	return var_22_1 == var_22_0.BUILDING
end

function var_0_1.IsNewTileType(arg_23_0)
	local var_23_0 = arg_23_0
	local var_23_1 = arg_23_0.GetType(var_23_0)

	AgoraFurnitureType = var_23_0

	return var_23_1 == var_23_0.TILE_NEW
end
...
function var_0_1.IsFloor(arg_26_0)
	...
	local var_26_1 = arg_26_0.GetType(var_26_0)

	AgoraFurnitureType = var_26_0

	return var_26_1 == var_26_0.FLOOR
end

function var_0_1.IsTile(arg_27_0)
	local var_27_0 = arg_27_0
	local var_27_1 = arg_27_0.GetType(var_27_0)

	AgoraFurnitureType = var_27_0

	return var_27_1 == var_27_0.TILE
end
...
function var_0_1.Match(arg_28_0, arg_28_1)
	...
	local var_28_1 = arg_28_0.GetName(var_28_0)

	string = var_28_0
	arg_28_1 = var_28_0.lower(arg_28_1)
	string = var_3

	local var_28_2 = var_3.lower(var_28_1)

	string = var_3

	if var_3.find(var_28_2, arg_28_1) then
		return true
	end
