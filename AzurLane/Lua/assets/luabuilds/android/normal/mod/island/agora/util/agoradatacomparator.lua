...
function var_0_0.TakeSample(arg_2_0)
	...
	arg_2_0.placedData = var_1_10001(var_2.GetPlacedlist(var_2_0))
	Clone = var_1

	local var_2_1 = arg_2_0.agora

	arg_2_0.floorData = var_1(var_2.GetFloorLayer(var_2_1))
	Clone = var_1

	local var_2_2 = arg_2_0.agora

	arg_2_0.tileData = var_1(var_2.GetTileLayer(var_2_2))
	arg_2_0.isTake = true
...
function var_0_0.AnyChanged(arg_4_0)
	...
	if arg_4_0.ComparePlacedData(var_4_7, var_4_1, arg_4_0.placedData) then
		bit = var_4_7
		var_4_6 = var_4_7.bor(var_4_6, var_0_0.CHANGE_TYPE_PLACED)
	end
	...
	if arg_4_0.CompareLayer(var_4_8, var_4_3, arg_4_0.floorData) then
		bit = var_4_8
		var_4_6 = var_4_8.bor(var_4_6, var_0_0.CHANGE_TYPE_FLOOR)
	end

	local var_4_9 = arg_4_0

	if arg_4_0.CompareLayer(var_4_9, var_4_5, arg_4_0.tileData) then
		bit = var_4_9
		var_4_6 = var_4_9.bor(var_4_6, var_0_0.CHANGE_TYPE_TILE)
	end

	bit = var_4_9

	return var_4_9.band(var_4_6, arg_4_0.allCode) > 0, var_4_6
end
...
function var_0_0.ComparePlacedData(arg_5_0, arg_5_1, arg_5_2)
	...
	if var_5_0 ~= var_4.getCount(arg_5_2) then
		return true
	end
