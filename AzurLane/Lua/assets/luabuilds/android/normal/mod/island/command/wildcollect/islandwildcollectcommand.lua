...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_7.Send(var_1_5, 21529, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10003 = var_1.GetWildCollectAgency(var_2_0)

			var_1.AddCollectFragment(var_2_10003, var_1_1)

			pg = var_2
			var_2_10003 = var_2.GameTrackerMgr.GetInstance()

			local var_2_1 = var_2.Record

			GameTrackerBuilder = var_4

			var_2_1(var_2_10003, var_4.BuildIslandWildCollect(var_1_1))
			...
			var_2_2(var_2_10003, var_4.RemoveGatherUnit, {
				unitId = var_1_2
			})
		else
			pg = var_1
