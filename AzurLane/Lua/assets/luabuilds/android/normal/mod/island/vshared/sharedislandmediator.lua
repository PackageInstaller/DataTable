...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..View.base.IslandBaseMediator"))
...
function var_0_1._register(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.SELECT_GIFT, function(arg_2_0, arg_2_1, arg_2_2)
		local var_2_0 = arg_1_0
		local var_2_1 = var_3.sendNotification

		GAME = var_2_10005

		var_2_1(var_2_0, var_2_10005.ISLAND_SELECT_GIFT, {
			islandId = arg_2_1,
			pos = arg_2_2
		})
	...
	arg_1_0:bind(var_0_1.EXIT, function(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_2_10004.ISLAND_EXIT_SHARED, {
			id = arg_3_1
		})
	...
	arg_1_0:bind(var_0_1.RETURN_SELF_ISLAND, function(arg_4_0)
		...
		local var_4_2 = var_4_0(var_2_10003)
		local var_4_3 = var_2.GetIsland(var_4_2)

		pg = var_4_2

		local var_4_4 = var_4_2.m02
		local var_4_5 = var_3.sendNotification

		GAME = var_2_10005

		var_4_5(var_4_4, var_2_10005.ISLAND_EXIT, {
			id = var_4_1.id,
			callback = function()
				pg = var_3_10000
				...
				var_5_1(var_5_0, var_3_10002.ISLAND_ENTER, {
					id = var_4_3.id
				})
...
function var_0_1._handleNotification(arg_7_0, arg_7_1)
	...
	if var_7_0 == var_7_1.ISLAND_EXIT_SHARED_DONE then
		local var_7_3 = arg_7_0.viewComponent
		local var_7_4 = var_4.emit

		BaseUI = var_1_10006

		var_7_4(var_7_3, var_1_10006.ON_HOME)
	end
