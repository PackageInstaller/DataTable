...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandTicketCard"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	var_2(var_1_6, var_1_5("island_ticket_shop"))
...
function var_0_1.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	...
	if not arg_2_0.tickets[1] then
		...
		var_2_2 = var_2_2.New
		pg = var_7
		var_2_2 = var_2_2(var_7.island_speedup_ticket.get_id_list_by_speedup_time[arg_2_1][1], 0, 1)
	end
	...
	var_2_2(var_2_3, var_8.getConfig(var_2_4, "name"))
	...
	var_2_2(var_2_5, var_8.GetFrameName(var_2_6), arg_2_0.frameTF, true)
	...
	var_2_2(var_2_7, var_8.GetBgName(var_2_8), arg_2_0.bgTF, true)

	GetImageSpriteFromAtlasAsync = var_2_2

	local var_2_9 = arg_2_0.showTicket

	var_2_2(var_7.GetIconName(var_2_9), "", arg_2_0.iconTF, true)
