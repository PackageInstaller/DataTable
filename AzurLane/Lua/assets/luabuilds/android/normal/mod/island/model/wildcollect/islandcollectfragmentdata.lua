...
function var_0_1.IsShow(arg_4_0)
	...
	local var_4_1 = arg_4_0.getConfigTable(var_4_0).show

	IslandGatherCollectAgency = var_4_0

	return var_4_1 ~= var_4_0.ShowTpye.OnlySelf
end
...
function var_0_1.StartCollect(arg_5_0, arg_5_1, arg_5_2)
	...
	var_5_1(var_5_0, var_1_10005.ISLAND_START_WILD_COLLECT, {
		unitId = arg_5_1,
		island_id = arg_5_2,
...
function var_0_1.StartCollectSign(arg_6_0, arg_6_1, arg_6_2)
	...
	var_6_1(var_6_0, var_1_10005.ISLAND_START_WILD_COLLECT_SIGN, {
		unitId = arg_6_1,
		island_id = arg_6_2,
