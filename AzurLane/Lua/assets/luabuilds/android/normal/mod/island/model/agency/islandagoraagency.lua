...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	arg_1_0.maxLevel = var_1_1(var_1_10003.AGORA_LEVEL_2_SIZE)
	arg_1_0.furnitures = {}
	arg_1_0.themes = {}
	...
	for iter_1_0, iter_1_1 in var_2(var_3.island_furniture_theme.all) do
		pg = var_1_10007
		...
		IslandTheme = var_1_10010

		local var_1_3 = var_1_10010.New(var_1_2)

		var_1_10010.SetName(var_1_3, var_1_10007.name)

		table = var_11

		var_11.insert(arg_1_0.systemThemes, var_1_10010)
	end
	...
	for iter_1_2, iter_1_3 in var_2(var_3.island_set.island_build_expansion.key_value_varchar) do
		table = var_1_10007
...
function var_0_1.InitPrivateData(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_1_10003(arg_3_1.furniture_list) do
		...
		var_1_10008(var_3_1, var_1_10010.New(iter_3_1))
	end
	...
	if var_3.island_set.island_pre_placement.key_value_varchar[1] then
		...
		if var_3_3.all(var_3_0, function(arg_4_0)
			...
			IslandFurniture = var_7

			var_3_3(var_3_4, var_7.New({
				count = 1,
				id = var_3_2
			}))
		end
...
function var_0_1.RawAddFurniture(arg_6_0, arg_6_1, arg_6_2)
	...
	IslandFurniture = var_1_10006

	var_1_10003(var_1_10004(var_6_0, var_1_10006), "IslandAgoraAgency:AddFurniture: furniture must be IslandFurniture")
	...
	if var_1_10003.detect(arg_6_0.furnitures, function(arg_7_0)
		...
		var_4.insert(arg_6_0.furnitures, arg_6_1)
	end
...
function var_0_1.AddFurniture(arg_8_0, arg_8_1, arg_8_2)
	...
	var_1_10003(var_1_10004(var_8_0, var_1_10006), "IslandAgoraAgency:AddFurniture: furniture must be IslandFurniture")
	...
	local var_8_1 = var_4.GameTrackerMgr.GetInstance()
	local var_8_2 = var_4.Record

	GameTrackerBuilder = var_1_10006

	var_8_2(var_8_1, var_1_10006.BuildIslandFurnitureAdd(arg_8_1.id, arg_8_2 or ""))
	...
	if var_3 then
		...
		local var_8_3 = var_8_2.UpdateRecordWithAdd

		IslandAchievementType = var_8_1

		var_8_3(var_8_1.FURNITURE, 0, 1)

		pg = var_8_3

		local var_8_4 = var_8_3.island_furniture_template[arg_8_1.id].type

		IslandAchievementHelper = var_5

		local var_8_5 = var_5.UpdateRecordWithAdd

		IslandAchievementType = var_6

		var_8_5(var_6.FURNITURE, var_8_4, 1)

		table = var_8_5

		var_8_5.insert(arg_8_0.furnitures, arg_8_1)
...
function var_0_1.DelTheme(arg_14_0, arg_14_1)
	...
	if var_1_10002.detect(arg_14_0.themes, function(arg_15_0)
		...
		var_3.removebyvalue(arg_14_0.themes, var_2)
