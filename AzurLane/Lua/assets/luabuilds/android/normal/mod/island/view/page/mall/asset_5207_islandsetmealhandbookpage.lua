...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_2.Find(var_2_2, "setMealList/Viewport/Content")
	local var_2_4 = arg_2_0._tf

	arg_2_0.setMealList = var_2_1(var_2_3, var_3.Find(var_2_4, "setMealList/Viewport/Content/setMealTpl"))
	...
	local var_2_12 = var_2.Find(var_2_11, "conditionList")
	local var_2_13 = arg_2_0.detail

	arg_2_0.conditionList = var_2_10(var_2_12, var_3.Find(var_2_13, "conditionList/condition"))
	setActive = var_1
	...
	local var_2_15 = var_2.Find(var_2_14, "top/title/Text")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("island_setmeal_title"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "top/title/Text/en")

	i18n1 = var_2_16

	var_1(var_2_17, var_2_16("HANDBOOK"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_2.Find(var_2_18, "detail/condition")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("island_tech_detail_unlocktitle"))

	setText = var_1

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_2.Find(var_2_20, "detail/decoration2/text")

	i18n = var_2_20

	var_1(var_2_21, var_2_20("island_setmeal_benifit_title"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_3()
		...
		pg = var_2_10003
		var_4_2.helps = var_2_10003.gametip.island_help_combo.tip
...
function var_0_1.InitData(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1(var_6_2.island_combo.all) do
		Clone = var_1_10006
		pg = var_1_10007
		var_1_10006 = var_1_10006(var_1_10007.island_formula[iter_6_1])
		pg = var_1_10007
	...
	var_1.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			for iter_10_0, iter_10_1 in var_2_10007(var_3.unlock_condition) do
				var_2_10012 = iter_10_1[1]

				local var_10_3 = iter_10_1[2]

				if not arg_9_0.formulaNums[var_2_10012] or arg_9_0.formulaNums[var_2_10012] < 1 then
					var_10_1 = false
				end

				if not arg_9_0.formulaNums[var_2_10012] or var_10_3 > arg_9_0.formulaNums[var_2_10012] then
					var_10_2 = false
				end
			end

			local var_10_4 = not var_10_0 and var_10_1 or var_10_0 and var_10_2

			setActive = var_10_5

			var_10_5(arg_10_2:Find("special"), var_10_0 and var_10_2)

			setActive = var_10_5

			var_10_5(arg_10_2:Find("name"), var_10_4)

			setActive = var_10_5

			var_10_5(arg_10_2:Find("IslandItemTpl"), var_10_4)

			setActive = var_10_5

			var_10_5(arg_10_2:Find("lock"), not var_10_4)

			local var_10_5

			if var_10_4 then
				setScrollText = var_10_5

				var_10_5(arg_10_2:Find("name/text"), var_3.name)
				...
				var_10_5.type = var_9
				var_10_5.id = var_3.item_id
				updateCustomDrop = var_9

				var_9(arg_10_2:Find("IslandItemTpl"), var_10_5)
			end
			...
			if var_10_4 then
				...
				local function var_10_8(arg_11_0)
					...
					var_3_10001(var_2.Find(var_11_0, "select"), arg_11_0)
				...
				var_10_5(var_10_6, var_10_7, var_10_8, var_2_10012)
			else
				removeOnToggle = var_10_5
...
function var_0_1.SetDetail(arg_12_0, arg_12_1)
	...
	if #arg_12_1.unlock_condition == 2 then
		for iter_12_0 = 1, 2 do
			...
			var_8(var_12_1, var_12_2, var_11.Find(var_12_3, "formula" .. iter_12_0 .. "/icon"))
		end
	elseif #arg_12_1.unlock_condition == 3 then
		for iter_12_1 = 1, 3 do
			...
			var_8(var_12_5, var_12_6, var_11.Find(var_12_7, "formula" .. iter_12_1 .. "/icon"))
		end
	end
	...
	var_3.make(var_12_9, function(arg_13_0, arg_13_1, arg_13_2)
		...
		if arg_13_0 == var_2_10003.EventUpdate then
			...
			local var_13_4 = arg_13_2.Find(var_13_3, "name/text")

			i18n = var_13_3

			var_2_10006(var_13_4, var_13_3("island_combo_produced") .. var_13_2.name)
			...
			var_13_4(arg_13_2:Find("notComplete"), var_13_5 < var_13_1)

			setActive = var_13_4

			var_13_4(arg_13_2:Find("complete"), var_13_1 <= var_13_5)

			if var_13_1 < var_13_5 then
				var_13_1 = formulaNum
			end
			...
			local var_13_7 = arg_13_2.Find(var_13_6, "count")

			i18n = var_13_6

			var_13_4(var_13_7, var_13_6("island_combo_produced_times", "" .. var_13_5 .. "/" .. var_13_1))
	...
	if var_12_8 == true then
		...
		var_3(var_12_11, var_5("island_combo_unlock"))
	else
		setText = var_3
