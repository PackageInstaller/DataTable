...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 21002, {
		...
		if arg_2_0.result == 0 then
			...
			for iter_2_0, iter_2_1 in var_2_1(var_1_1) do
			...
			var_2_3(var_2_10003, var_4.ISLAND_SET_ACCESS_TYPE_DONE)
		else
			pg = var_2_2
			...
			var_2_5(var_2_4, var_2_10003[arg_2_0.result] .. arg_2_0.ret)
		end
