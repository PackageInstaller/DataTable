...
function var_0_1.getLinkConfigTable(arg_10_0)
	...
	local var_10_1 = arg_10_0.bindLinkConfigTable(var_10_0)

	assert = var_10_0

	var_10_0(var_10_1, "should bindLinkConfigTable() first: " .. arg_10_0.__cname)

	return var_10_1[arg_10_0:GetLinkConfigID()]
end

function var_0_1.getLinkConfig(arg_11_0, arg_11_1)
	local var_11_0 = arg_11_0
	local var_11_1 = arg_11_0.getLinkConfigTable(var_11_0)

	assert = var_11_0

	local var_11_2 = var_11_1 ~= nil
	local var_11_3 = "LinkConfig missed, type -"
	local var_11_4 = arg_11_0.__cname
	local var_11_5 = " configId: "

	tostring = var_1_10008

	var_11_0(var_11_2, var_11_3 .. var_11_4 .. var_11_5 .. var_1_10008(arg_11_0.configId))

	return var_11_1[arg_11_1]
end
...
function var_0_1.GetName(arg_12_0)
	...
	return var_1_10001(arg_12_0:getConfig("type"), {
		[var_0_1.TYPES.CHAR] = function()
			...
			return var_13_0.island_unit_character[var_13_1].name
		end,
		[var_0_1.TYPES.NPC] = function()
...
function var_0_1.GetEnName(arg_17_0)
	...
	return var_1_10001(arg_17_0:getConfig("type"), {
		[var_0_1.TYPES.CHAR] = function()
			...
			return var_18_0.island_unit_character[var_18_1].english_name
		end,
		[var_0_1.TYPES.NPC] = function()
...
function var_0_1.GetDesc(arg_22_0)
	...
	return var_1_10001(arg_22_0:getConfig("type"), {
		[var_0_1.TYPES.CHAR] = function()
			...
			return var_23_0.island_unit_character[var_23_1].describe_illustrated_guid
		end,
		[var_0_1.TYPES.NPC] = function()
		...
		[var_0_1.TYPES.FISH] = function()
			...
			return var_26_0.island_item_data_template[var_26_1].desc
		end
	})
end
...
function var_0_1.GetIcon(arg_27_0)
	...
	return var_1_10001(arg_27_0:getConfig("type"), {
		[var_0_1.TYPES.CHAR] = function()
			...
			IslandShip = var_2_10002

			return var_28_2 .. var_2_10002.StaticGetPrefab(var_28_1)
		end,
		[var_0_1.TYPES.NPC] = function()
		...
		[var_0_1.TYPES.FISH] = function()
			...
			return var_31_2 .. var_2.island_item_data_template[var_31_1].icon
		end
	})
end
