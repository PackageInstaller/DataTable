...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "frame_1/star/prev")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiStarPreList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame_1/star/prev/tpl"))
	UIItemList = var_1

	local var_2_4 = var_1.New
	local var_2_5 = arg_2_0._tf
	local var_2_6 = var_2.Find(var_2_5, "frame_1/star/now")
	local var_2_7 = arg_2_0._tf

	arg_2_0.uiStarNextList = var_2_4(var_2_6, var_3.Find(var_2_7, "frame_1/star/now/tpl"))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.prevLevelTxt = var_2_10(var_2_9, var_3(var_2_7))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.nextLevelTxt = var_2_13(var_2_12, var_3(var_2_7))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.skillTxt = var_2_16(var_2_15, var_3(var_2_7))
	...
	typeof = var_3
	Text = var_2_7
	arg_2_0.skillLabelTxt = var_2_19(var_2_18, var_3(var_2_7))
	UIItemList = var_1

	local var_2_20 = var_1.New
	local var_2_21 = arg_2_0._tf
	local var_2_22 = var_2.Find(var_2_21, "frame_3/attrs")
	local var_2_23 = arg_2_0._tf

	arg_2_0.uiAttrList = var_2_20(var_2_22, var_3.Find(var_2_23, "frame_3/attrs/tpl"))
	UIItemList = var_1

	local var_2_24 = var_1.New
	local var_2_25 = arg_2_0._tf
	local var_2_26 = var_2.Find(var_2_25, "frame_2/comsume")
	local var_2_27 = arg_2_0._tf

	arg_2_0.uiConsumeList = var_2_24(var_2_26, var_3.Find(var_2_27, "frame_2/comsume/tpl"))
	...
	local var_2_31 = var_2.Find(var_2_30, "frame_1/title")

	i18n = var_2_30

	var_1(var_2_31, var_2_30("island_ship_breakout"))

	setText = var_1

	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_2.Find(var_2_32, "frame_2/consume_title/Text")

	i18n = var_2_32

	var_1(var_2_33, var_2_32("island_ship_breakout_consume"))

	setText = var_1

	local var_2_34 = arg_2_0.upgradeBtn
	local var_2_35 = var_2.Find(var_2_34, "Text")

	i18n = var_2_34

	var_1(var_2_35, var_2_34("island_chara_breakout_button"))
...
function var_0_1.AddListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.ISLAND_SHIP_BREAKOUT_DONE, arg_3_0.OnBreakOutDone)
...
function var_0_1.RemoveListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.ISLAND_SHIP_BREAKOUT_DONE, arg_4_0.OnBreakOutDone)
...
function var_0_1.UpdateBreakOutLevel(arg_10_0, arg_10_1, arg_10_2)
	...
	var_3.make(var_10_0, function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			var_3(var_11_0, var_11_1 <= var_6.GetBreakLevel(var_11_2))
		end
	...
	var_3.make(var_10_2, function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			...
			var_3(var_12_0, var_12_1 <= var_6.GetBreakLevel(var_12_2))
		end
...
function var_0_1.UpdateSkill(arg_14_0, arg_14_1, arg_14_2)
	...
	if var_4.IsUnlock(var_14_2) and var_14_1 then
		...
		i18n = var_1_10007
		var_14_5.text = var_1_10007("island_ship_newskill_unlock")
	else
...
function var_0_1.UpdateAttrs(arg_15_0, arg_15_1, arg_15_2)
	...
	var_5.make(var_15_2, function(arg_16_0, arg_16_1, arg_16_2)
		...
		if arg_16_0 == var_2_10003.EventUpdate then
			...
			IslandShipAttr = var_16_1

			local var_16_3 = var_16_1.Grade2Img(var_16_2)
			...
			local var_16_6 = var_16_5(var_16_4, var_8(var_2_10009))

			GetSpriteFromAtlas = var_16_4
			var_16_6.sprite = var_16_4("ui/IslandShipUI_atlas", var_16_3[2])
			setText = var_16_6

			local var_16_7 = arg_16_2
			local var_16_8 = arg_16_2.Find(var_16_7, "name")

			IslandShipAttr = var_16_7

			var_16_6(var_16_8, var_16_7.ToChinese(var_16_0))

			setText = var_16_6

			local var_16_9 = arg_16_2:Find("value")
			local var_16_10 = "+"
			local var_16_11
			...
			var_16_6(var_16_9, var_16_10 .. var_16_11 .. var_16_12 .. var_16_13)
		end
...
function var_0_1.UpdateConsume(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = arg_17_2.GetBreakoutMatrials(var_17_0)

	getProxy = var_17_0
	IslandProxy = var_1_10005

	local var_17_2 = var_17_0(var_1_10005)
	local var_17_3 = var_4.GetIsland(var_17_2)
	local var_17_4 = var_4.GetInventoryAgency(var_17_3)
	local var_17_5 = arg_17_0.uiConsumeList

	var_5.make(var_17_5, function(arg_18_0, arg_18_1, arg_18_2)
		UIItemList = var_2_10003
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			if var_18_0.count <= var_18_2 then
				...
				local var_18_4 = var_18_1(var_18_3, var_7)

				setText = var_18_3

				var_18_3(arg_18_2:Find("icon_bg/count_bg/count"), var_18_4 .. "/" .. var_18_0.count)
	...
	local var_17_6 = arg_17_0.uiConsumeList

	var_5.align(var_17_6, #var_17_1)
...
function var_0_1.UpdateUpgradeBtn(arg_19_0, arg_19_1)
	...
	local var_19_5 = var_19_3.all(var_19_1, function(arg_20_0)
	...
	var_5(arg_19_0.upgradeBtn, not var_19_5, true)
	...
	local function var_19_8()
		...
		var_21_1(var_21_0, var_2_10002.SHIP_BREAKOUT, arg_19_1.id)
