...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_4.island_dress_template[var_1_1] then
		existCall = var_8
	...
	if not var_1_10009.island_dress_template.get_id_list_by_related_dress[var_1_1] then
		var_1_6 = {}
	end
	...
	local function var_1_8()
		...
		local var_2_2 = var_2_10002.ISLAND_CHANGE_COMMANDER_DRESS
		local var_2_3 = {
			hideTip = true
		}
		local var_2_4 = {}
		...
		var_2_5.type = var_2_10006.DressType.Body
		var_2_5.id = var_1_1
		var_2_4[1] = var_2_5
		...
		var_2_6.type = var_6.DressType.Hat
		var_2_6.id = var_1_7
		var_2_4[2] = var_2_6
	...
	IslandDressUpAgency = var_1_10015

	var_1_10(var_1_9, var_1_10015.MORPH_PLAYER_DRESS, var_1_0, var_1_1, var_1_7, var_1_5, var_1_8)
