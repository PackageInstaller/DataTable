...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_5 = var_2_3.Find(var_2_4, "btns/opening/Text")

	i18n = var_2_4

	var_2_2(var_2_5, var_2_4("island_manage_view"))

	setText = var_2_2

	local var_2_6 = var_2_3
	local var_2_7 = var_2_3.Find(var_2_6, "btns/close/Text")

	i18n = var_2_6

	var_2_2(var_2_7, var_2_6("island_manage_result"))

	setText = var_2_2

	local var_2_8 = var_2_3
	local var_2_9 = var_2_3.Find(var_2_8, "btns/lock/Text")

	i18n = var_2_8

	var_2_2(var_2_9, var_2_8("word_lock"))

	setText = var_2_2

	local var_2_10 = var_2_3
	local var_2_11 = var_2_3.Find(var_2_10, "name/event/Text")

	i18n = var_2_10

	var_2_2(var_2_11, var_2_10("island_post_event_label"))
...
function var_0_1.InitItem(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_2:Find("btns/prepare")
	...
	var_1_10003(var_8_0, var_8_1, var_8_2, var_7)

	onButton = var_1_10003

	local var_8_3 = arg_8_0
	local var_8_4 = arg_8_2:Find("btns/opening")
	...
	local var_8_7 = arg_8_2:Find("btns/close")
...
function var_0_1.OpenRestaurant(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_1_10004.OPEN_PAGE, "IslandRestaurantPage", {
		arg_12_1,
		true
	})
...
function var_0_1.UpdateItem(arg_13_0, arg_13_1, arg_13_2)
	...
	var_13_6(arg_13_2:Find("lock"), not var_13_1)

	setActive = var_13_6

	var_13_6(arg_13_2:Find("btns/lock"), not var_13_1)

	setActive = var_13_6

	var_13_6(arg_13_2:Find("rank"), var_13_1)
	...
	if var_13_1 then
		...
		var_13_2 = var_13_1.GetStatus(var_13_4)
		IslandRestaurant = var_13_4
		var_13_2 = var_13_2 == var_13_4.STATUS.OPENING
	end

	var_13_6(var_13_3, var_13_2)
	...
	if var_13_1 then
		...
		var_13_6 = var_13_1.GetEventInfo(var_13_5)
		setActive = var_13_5

		var_13_5(arg_13_2:Find("name/event"), var_13_1:GetEventInfo() ~= 0)
	else
		setActive = var_13_6

		var_13_6(arg_13_2:Find("name/event"), false)
	end

	onButton = var_13_6

	local var_13_7 = arg_13_0
	local var_13_8 = arg_13_2:Find("name/event")

	local function var_13_9()
		local var_14_0 = arg_13_0
		local var_14_1 = var_0.emit

		IslandPostManagePage = var_2_10002

		var_14_1(var_14_0, var_2_10002.EVENT_SHOW_SP_EVENT_TIP, var_13_1, false)
	...
	var_13_6(var_13_7, var_13_8, var_13_9, var_10)
	...
	if var_13_1 then
		...
		if not var_13_1.GetAssistants(var_13_7) then
			var_13_10 = {}
		end

		UIItemList = var_13_7

		var_13_7.StaticAlign(arg_13_2:Find("ships"), arg_13_2:Find("ships/tpl"), var_0_1.MAX_ASSISTANT_CNT, function(arg_15_0, arg_15_1, arg_15_2)
			UIItemList = var_2_10003

			if arg_15_0 == var_2_10003.EventUpdate then
				local var_15_0 = var_13_10[arg_15_1 + 1]
				...
				var_5(arg_15_2:Find("icon"), var_15_1 and var_15_1 ~= 0)

				if var_15_1 and var_15_1 ~= 0 then
					IslandShip = var_5

					local var_15_2 = var_5.StaticGetPrefab(var_15_1)
		...
		if not var_13_1 or not var_13_1:GetCommondities() then
			var_13_11 = {}
		end

		if var_13_1 then
			local var_13_12 = var_13_1
			local var_13_13

			if not var_13_1.GetShelfCnt(var_13_12) then
				var_13_13 = 0
			end

			UIItemList = var_13_12

			var_13_12.StaticAlign(arg_13_2:Find("shelfs"), arg_13_2:Find("shelfs/tpl"), var_0_1.MAX_SHELF_CNT, function(arg_16_0, arg_16_1, arg_16_2)
				UIItemList = var_2_10003

				if arg_16_0 == var_2_10003.EventUpdate then
					local var_16_0 = var_13_11[arg_16_1 + 1]
					local var_16_1 = var_13_13 < arg_16_1 + 1
					...
					if var_16_0 then
						...
						updateCustomDrop = var_16_3

						var_16_3(arg_16_2:Find("drop"), var_16_4)
					end
				end
			...
			if var_13_1 then
				local var_13_14 = var_13_1:getConfig("opening_number")
				local var_13_15 = var_13_1
				local var_13_16 = var_13_1.GetRemainCnt(var_13_15)

				setText = var_13_15

				local var_13_17 = arg_13_2
				local var_13_18 = arg_13_2.Find(var_13_17, "btns/prepare/Text")

				string = var_13_17

				local var_13_19 = var_13_17.format
				local var_13_20 = "%s(%d/%d)"

				i18n = var_1_10015

				var_13_15(var_13_18, var_13_19(var_13_20, var_1_10015("island_manage_prepare"), var_13_16, var_13_14))

				setText = var_13_15

				local var_13_21 = arg_13_2
				local var_13_22 = arg_13_2.Find(var_13_21, "btns/end/Text")

				string = var_13_21

				local var_13_23 = var_13_21.format
				local var_13_24 = "%s(%d/%d)"

				i18n = var_15

				var_13_15(var_13_22, var_13_23(var_13_24, var_15("island_manage_daily_cnt_tip"), var_13_16, var_13_14))

				LoadImageSpriteAsync = var_13_15

				var_13_15("island/islandrestaurant/" .. var_13_1:GetRankIcon(), arg_13_2:Find("rank"), true)
...
function var_0_1.UpdataStatusInfo(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = arg_17_2.GetStatus(var_17_0)

	IslandRestaurant = var_17_0

	local var_17_2

	if var_17_1 == var_17_0.STATUS.OPENING then
		pg = var_17_2
		var_17_2 = var_17_2.TimeMgr.GetInstance()

		local var_17_3 = arg_17_2:GetEndTime() - var_17_2:GetServerTime()

		setText = var_6

		var_6(arg_17_1:Find("opening/Text"), var_17_2:DescCDTime(var_17_3))
	end

	eachChild = var_17_2

	var_17_2(arg_17_1:Find("btns"), function(arg_18_0)
		setActive = var_2_10001

		var_2_10001(arg_18_0, arg_18_0.name == var_17_1)
...
function var_0_1.CheckEventTip(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10003(arg_20_0.rests) do
	...
	if var_20_1 then
		...
		IslandPostManagePage = var_5

		var_20_4(var_20_3, var_5.EVENT_SHOW_SP_EVENT_TIP, var_20_1, true)
	end
...
function var_0_1.GetStatusSortWeight(arg_25_0, arg_25_1)
	...
	IslandRestaurant = var_1_10005
	var_25_1[var_1_10005.STATUS.CLOSE] = function()
		return 1
	end
	IslandRestaurant = var_5
	var_25_1[var_5.STATUS.PREPARE] = function()
		return 2
	end
	IslandRestaurant = var_5
	var_25_1[var_5.STATUS.OPENING] = function()
		return 3
	end
	IslandRestaurant = var_5
	var_25_1[var_5.STATUS.END] = function()
		return 4
	end
