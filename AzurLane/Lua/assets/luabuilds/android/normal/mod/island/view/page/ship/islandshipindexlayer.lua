...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.common.CustomIndexLayer"))
...
function var_0_1.getSortFuncAndName(arg_4_0, arg_4_1)
	for iter_4_0 = 1, #var_0_1.sort do
		...
		if var_7.band(var_1_10006, arg_4_0) > 0 then
			underscore = var_7

			return var_7.map(var_0_1.sort[iter_4_0].sortFuncs, function(arg_5_0)
...
function var_0_1.filterByExtra(arg_11_0, arg_11_1)
	...
	for iter_11_0 = 2, #var_0_2 do
		...
		if var_7.band(var_1_10006, arg_11_1) > 0 and var_0_2[iter_11_0](arg_11_0) then
			return true
		end
	end
...
function var_0_1.init(arg_13_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_13_0.titleTxt = var_13_2(var_13_1, var_3(var_1_10004))
...
function var_0_1.didEnter(arg_16_0)
	...
	i18n = var_2
	var_16_0.text = var_2("child_filter_title")
	onButton = var_16_0
	...
	var_16_0(var_16_1, var_16_2, var_16_3, var_1_10005)
...
function var_0_1.InitData(arg_20_0)
	...
	local var_20_1 = var_2(var_0_1.SortIndexs)
	...
	Clone = var_1_10004
	var_20_2.indexDatas = var_1_10004(arg_20_0.indexDatas)
	...
	var_20_4.mode = var_1_10006.Mode.OR
...
function var_0_1.UpdateBtnStyle(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_3 = var_22_2(var_22_1, var_1_10006(var_1_10007))

	if var_22_0 then
		Color = var_22_1

		if not var_22_1.New(0, 0, 0, 1) then
			Color = var_22_1
			var_22_1 = var_22_1.New(1, 1, 1, 1)
		end

		var_22_3.color = var_22_1
		...
		local var_22_6 = var_22_5(var_22_4, var_7(var_1_10008))

		if var_22_0 then
			Color = var_22_4

			if not var_22_4.New(1, 1, 1, 1) then
				Color = var_22_4
				var_22_4 = var_22_4.New(0.2235294, 0.227451, 0.2352941, 1)
			end

			var_22_6.color = var_22_4
			setActive = var_22_4

			var_22_4(arg_22_1:Find("selected"), var_22_0)
