...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("view.main.ChatBubble"))
...
function var_0_1.GetAttireFrameRes(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if var_2_0(var_2_1, var_2_2, var_1_10007.TYPE_CHAT_FRAME, arg_2_3) == "0_self" then
		return "island_self"
	end
...
function var_0_1.UpdateChannel(arg_3_0, arg_3_1)
	...
	local var_3_1 = var_1_10002(var_3_0, var_1_10004.GetChannelSprite(arg_3_1.type) .. "_mel")

	setImageSprite = var_3_0

	var_3_0(arg_3_0.channel, var_3_1, true)
...
function var_0_1.UpdateContent(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_0(var_4_1, var_1_10005.TRADE_SHARE_CODE) then
		string = var_3

		local var_4_2 = var_3.split(arg_4_2, "*")

		i18n = var_4
		arg_4_2 = var_4("island_trade_send_msg_label", var_4_2[2], var_4_2[3])
