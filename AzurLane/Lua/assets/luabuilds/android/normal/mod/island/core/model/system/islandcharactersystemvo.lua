...
function var_0_1.GetUnit(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_0.config.interactionType == var_0_2 and not arg_5_3 then
		...
		local var_5_6 = var_5_4.island_world_objects[var_5_5]

		IslandCalcUtil = var_1_10011
		var_1_10011 = var_1_10011.GetRandomPointOnCircle
		BuildVector3 = var_1_10012
		var_1_10011 = var_1_10011(var_1_10012(var_5_6.param.position), 2)
		var_5_2 = {
			var_1_10011.x,
			var_1_10011.y,
			var_1_10011.z
	...
	if arg_5_0.isSelf then
		...
		local var_5_8 = var_10(var_1_10011)

		var_1_10012 = var_10.GetIsland(var_5_8)

		local var_5_9 = var_10.GetCharacterAgency(var_1_10012)

		var_1_10014 = var_11.GetShipById(var_5_9, arg_5_1)
		var_5_7 = var_1_10012.GetModelUnit(var_1_10014)
	else
		pg = var_10
		var_5_7 = var_10.island_chara_template[arg_5_1].unit_id
	end

	local var_5_10

	if arg_5_1 ~= 1 or not arg_5_0.config.chickenbehaviourTree then
		var_5_10 = arg_5_0.config.npcbehaviourTree
	end
	...
	local var_5_12 = var_1_10012.New
	local var_5_13 = {
		id = arg_5_1,
		isChicken = var_5_11,
		modelId = var_5_7
	...
	var_5_13.type = var_1_10014.UNIT_TYPE_SYSTEM_DELEAGTION
	var_5_13.name = "system_unit" .. arg_5_1
	var_5_13.position = var_5_2
	...
	if not var_5_3 then
		...
		Vector3 = var_5_14
		var_5_14 = var_5_14.zero
	end

	var_5_13.rotation = var_5_14
	Vector3 = var_5_14
	var_5_13.scale = var_5_14.one
	var_5_13.behaviourTree = var_5_10
...
function var_0_1.GetperformanceObjidList(arg_8_0, arg_8_1)
	...
	if var_5.contains(var_8_1, arg_8_0.id) then
		...
		for iter_8_0, iter_8_1 in var_6(var_8_3.exclusion_slot) do
			local var_8_4 = arg_8_0.productSystem

			var_1_10011 = var_1_10011.GetUnitIdBySlotId(var_8_4, iter_8_1)
			...
			var_8_5.unitType = var_1_10013.UNIT_LIST_OBJ
			table = var_1_10013

			var_1_10013.insert(var_8_0, var_8_5)
		end
	else
		table = var_8_3
		...
		if var_8_3.contains(var_8_2, arg_8_0.id) then
			...
			pg = var_8_7
			var_8_7 = var_8_7.island_production_commission[var_8_6]
			...
			IslandConst = var_8
			var_8_8.unitType = var_8.UNIT_LIST_OBJ
			table = var_8

			var_8.insert(var_8_0, var_8_8)
		else
			local var_8_9 = arg_8_0.id

			IslandProductConst = var_8_7

			if var_8_9 == var_8_7.PasturePlaceId then
				pg = var_8_9

				local var_8_10 = var_8_9.island_production_slot[arg_8_1]

				ipairs = var_6

				for iter_8_2, iter_8_3 in var_6(var_8_10.animal) do
					pg = var_1_10011
					...
					IslandConst = var_1_10013
					var_8_11.unitType = var_1_10013.UNIT_LIST_DELEGATION_ANIMATION
					table = var_1_10013

					var_1_10013.insert(var_8_0, var_8_11)
				end
			end
		end
	end
