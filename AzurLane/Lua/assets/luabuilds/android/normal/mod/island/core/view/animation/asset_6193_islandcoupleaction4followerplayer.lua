...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandCoupleActionPlayer"))
...
function var_0_1.EnableOrDisableUnitSyn(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	IslandFollowNpcUnit = var_1_10007

	if var_1_10005(var_1_1, var_1_10007) then
	...
	if var_5(var_1_2, var_1_10007) then
...
function var_0_1.EnableOrDisableNavMeshObstacle(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_4 = arg_3_0.GetView(var_3_3).player

	if arg_3_2 then
		IslandHelper = var_3_3

		var_3_3.DisableNavMeshObstacle(var_3_4._go)

		ipairs = var_3_3

		for iter_3_0, iter_3_1 in var_3_3(var_3_2) do
		...
		var_3_3.EnableNavMeshObstacle(var_3_4._go)
