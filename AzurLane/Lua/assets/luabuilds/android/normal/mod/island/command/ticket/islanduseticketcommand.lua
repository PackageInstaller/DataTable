...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if 0 < var_1_3 then
		local function var_1_4()
			...
			var_3_1(var_3_0, var_2_10002.ISLAND_REMOVE_EXPIRED_TICKET, {
				tickets = var_0
			})
		...
		pg = var_8
		var_1_10009 = var_8.NewStyleMsgboxMgr.GetInstance()

		local var_1_5 = var_8.Show

		pg = var_1_10010

		local var_1_6 = var_1_10010.NewStyleMsgboxMgr.TYPE_COMMON_MSGBOX
		local var_1_7 = {}

		i18n = var_1_10012
		var_1_7.contentText = var_1_10012("island_ticket_expiration_tip2")
		var_1_7.onClose = var_1_4

		local var_1_8 = {}
		local var_1_9 = {}

		pg = var_1_10014
		var_1_9.type = var_1_10014.NewStyleMsgboxMgr.BUTTON_TYPE.confirm
		i18n = var_1_10014
		var_1_9.name = var_1_10014("msgbox_text_confirm")
		var_1_9.func = var_1_4
		SFX_CONFIRM = var_1_10014
		var_1_9.sound = var_1_10014
		var_1_8[1] = var_1_9
		var_1_7.btnList = var_1_8

		var_1_5(var_1_10009, var_1_6, var_1_7)
...
function var_0_1.Send(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	var_5.Send(var_4_0, 21423, {
		...
		if arg_5_0.result == 0 then
			...
			var_5_3(var_2_10003, var_4("island_use_ticket_success"))
			...
			var_5_4(var_2_10003, var_4.ISLAND_USE_TICKET_DONE, {
				type = arg_4_1,
				id = arg_4_2
			})
		else
...
function var_0_1.SendForAppoint(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	var_4.Send(var_10_0, 21427, {
		...
		if arg_11_0.result == 0 then
			...
			local var_11_0 = var_11_1(var_2_10002)

			var_11_1 = var_11_1.GetIsland(var_11_0)
			pg = var_11_0

			local var_11_2 = var_11_0.island_production_slot[arg_10_1].place
			local var_11_3 = var_11_1:GetBuildingAgency()
			local var_11_4 = var_2_10003.GetBuilding(var_11_3, var_11_2)
			local var_11_5 = var_2_10003.GetDelegationSlotData(var_11_4, arg_10_1)
			local var_11_6 = var_4.GetSlotRoleData(var_11_5)
			...
			local var_11_10 = var_11_1.GetTicketAgency(var_11_9)

			ipairs = var_11_9

			for iter_11_0, iter_11_1 in var_11_9(arg_10_2) do
				var_11_10:ReduceTicket(iter_11_1.key.speed_id, iter_11_1.key.end_time, iter_11_1.num)
			end

			pg = var_8

			local var_11_11 = var_8.TipsMgr.GetInstance()
			local var_11_12 = var_8.ShowTips

			i18n = var_10

			var_11_12(var_11_11, var_10("island_use_ticket_success"))

			local var_11_13 = arg_10_0
			local var_11_14 = var_8.sendNotification

			GAME = var_10

			var_11_14(var_11_13, var_10.ISLAND_USE_TICKET_DONE, {
			...
			local var_11_15 = var_11_1.TipsMgr.GetInstance()
			local var_11_16 = var_1.ShowTips

			ERROR_MESSAGE = var_2_10003

			var_11_16(var_11_15, var_2_10003[arg_11_0.result] .. arg_11_0.result)
		end
