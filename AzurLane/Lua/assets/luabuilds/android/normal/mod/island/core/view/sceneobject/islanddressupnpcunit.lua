...
function var_0_1.OnCharacterChangeDress(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	if arg_4_1 then
		...
		local function var_4_0()
			...
			var_5_0._animator = var_5_3(var_5_2, var_3(var_2_10004))
			ipairs = var_5_0

			for iter_5_0, iter_5_1 in var_5_0(var_1_10004) do
				local var_5_4 = arg_4_0._animator

				var_5.Play(var_5_4, iter_5_1.shortNameHash, iter_5_0 - 1, iter_5_1.normalizedTime)
			end
			...
			local var_5_7 = var_5_6(var_5_5, var_2(iter_5_0.BehaviourTrees.BehaviourTreeOwner))
		...
		local var_4_3 = var_4_2(var_4_1, var_1_10008(var_1_10009.BehaviourTrees.BehaviourTreeOwner))

		var_6.PauseBehaviour(var_4_3)

		local var_4_4 = 0

		var_1_10009 = arg_4_0._animator
		var_1_10009 = var_8.GetCurrentAnimatorStateInfo(var_1_10009, var_4_4).normalizedTime % 1
