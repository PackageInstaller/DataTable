...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_8, var_2_7("island_tech_unlock_need"))

	UIItemList = var_1

	local var_2_9 = var_1.New
	local var_2_10 = arg_2_0.unlockTF
	local var_2_11 = var_2.Find(var_2_10, "list")
	local var_2_12 = arg_2_0.unlockTF

	arg_2_0.unlockUIList = var_2_9(var_2_11, var_3.Find(var_2_12, "list/tpl"))
	...
	local var_2_18 = var_2_16.Find(var_2_17, "lock/content/Text")

	i18n = var_2_17

	var_2_15(var_2_18, var_2_17("island_tech_unlock_dev"))

	setText = var_2_15

	local var_2_19 = var_2_16
	local var_2_20 = var_2_16.Find(var_2_19, "unlock/Text")

	i18n = var_2_19

	var_2_15(var_2_20, var_2_19("island_tech_unlock_dev"))

	setText = var_2_15

	local var_2_21 = var_2_16
	local var_2_22 = var_2_16.Find(var_2_21, "normal/content/Text")

	i18n = var_2_21

	var_2_15(var_2_22, var_2_21("island_tech_dev_start"))

	setText = var_2_15

	local var_2_23 = var_2_16
	local var_2_24 = var_2_16.Find(var_2_23, "normal/cost/title")

	i18n = var_2_23

	var_2_15(var_2_24, var_2_23("island_tech_dev_cost"))

	setText = var_2_15

	local var_2_25 = var_2_16
	local var_2_26 = var_2_16.Find(var_2_25, "studying/Text")

	i18n = var_2_25

	var_2_15(var_2_26, var_2_25("island_tech_dev_starting"))

	setText = var_2_15

	local var_2_27 = var_2_16
	local var_2_28 = var_2_16.Find(var_2_27, "receive/Text")

	i18n = var_2_27

	var_2_15(var_2_28, var_2_27("island_tech_dev_success"))

	setText = var_2_15

	local var_2_29 = var_2_16
	local var_2_30 = var_2_16.Find(var_2_29, "finished/normal/Text")

	i18n = var_2_29

	var_2_15(var_2_30, var_2_29("island_tech_dev_finish"))

	arg_2_0.noramlFinsh = var_2_16:Find("finished/normal")
	arg_2_0.mapFinsh = var_2_16:Find("finished/map")

	local var_2_31 = arg_2_0.mapFinsh

	arg_2_0.mapFinshIcon = var_2.Find(var_2_31, "mapicon")

	local var_2_32 = arg_2_0.mapFinsh

	arg_2_0.mapFinshName = var_2.Find(var_2_32, "maptitle/name")

	local var_2_33 = arg_2_0.mapFinsh

	arg_2_0.npcTF = var_2.Find(var_2_33, "npc")

	local var_2_34 = arg_2_0.npcTF

	arg_2_0.npcIcon = var_2.Find(var_2_34, "npcicon")

	local var_2_35 = arg_2_0.npcTF

	arg_2_0.npcName = var_2.Find(var_2_35, "npcName")

	local var_2_36 = {}

	IslandTechnology = var_2_35
	var_2_36[var_2_35.STATUS.LOCK] = var_2_16:Find("lock")
	IslandTechnology = var_3
	var_2_36[var_3.STATUS.UNLOCK] = var_2_16:Find("unlock")
	IslandTechnology = var_3
	var_2_36[var_3.STATUS.NORMAL] = var_2_16:Find("normal")
	IslandTechnology = var_3
	var_2_36[var_3.STATUS.STUDYING] = var_2_16:Find("studying")
	IslandTechnology = var_3
	var_2_36[var_3.STATUS.RECEIVE] = var_2_16:Find("receive")
	IslandTechnology = var_3
	var_2_36[var_3.STATUS.FINISHED] = var_2_16:Find("finished")
	arg_2_0.statusTFs = var_2_36

	local var_2_37 = arg_2_0.panel

	arg_2_0.costTF = var_2.Find(var_2_37, "status/normal/cost")
	UIItemList = var_2

	local var_2_38 = var_2.New
	local var_2_39 = arg_2_0.costTF
	local var_2_40 = var_3.Find(var_2_39, "list")
	local var_2_41 = arg_2_0.costTF

	arg_2_0.costUIList = var_2_38(var_2_40, var_4.Find(var_2_41, "list/tpl"))
	setText = var_2

	local var_2_42 = arg_2_0._tf
	local var_2_43 = var_3.Find(var_2_42, "panel/unlock/title")

	i18n = var_2_42

	var_2(var_2_43, var_2_42("island_tech_detail_unlocktitle"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_1.make(var_3_4, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			local var_5_2 = arg_5_2.Find(var_5_1, "Text")

			IslandTechnology = var_5_1

			var_4(var_5_2, var_5_1.GetUnlockText(var_5_0))

			local var_5_3 = arg_3_0.showTechVO
			local var_5_4 = var_4.MatchCondition(var_5_3, var_5_0) and "1E90FF" or "F5F5F5"
			...
			var_6(var_5_6, var_5_5.NewHex(var_5_4))

			setImageColor = var_6

			local var_5_7 = arg_5_2
			local var_5_8 = arg_5_2.Find(var_5_7, "dot")

			Color = var_5_7

			var_6(var_5_8, var_5_7.NewHex(var_5_4))
		end
	...
	var_1.make(var_3_5, function(arg_6_0, arg_6_1, arg_6_2)
		...
		if arg_6_0 == var_2_10003.EventUpdate then
			...
			updateCustomDrop = var_6_1

			var_6_1(arg_6_2, var_6_0)

			local var_6_3 = arg_6_2:Find("icon_bg/count_bg/count")
			local var_6_4 = var_6_0.id

			IslandItem = var_7

			if var_6_4 == var_7.GOLD_ID then
				setText = var_6_4
				...
				if var_6_2 < var_6_0.count then
					setColorStr = var_8
					var_6_6 = var_8(var_6_0.count, "#FF6767")
				else
					var_6_6 = false
				end
			...
			if var_6_2 < var_6_0.count then
				...
				do
					...
					if not var_8(var_6_2, "#FF6767") then
						var_6_8 = var_6_2
					end

					var_6_4(var_6_7, var_6_8 .. "/" .. var_6_0.count)
				end
				...
				var_6_4(arg_3_0, arg_6_2, function()
					local var_7_0 = arg_3_0.contextData
					local var_7_1 = var_0.ShowMsgBox
					local var_7_2 = {}

					i18n = var_3_10003
					var_7_2.title = var_3_10003("island_word_desc")
					IslandMsgBox = var_3
...
function var_0_1.Flush(arg_8_0)
	...
	var_2(var_8_4 .. var_4.getConfig(var_8_5, "tech_icon"), arg_8_0.iconTF, true)
	...
	var_2(var_8_6, var_4.getConfig(var_8_7, "tech_name"))
	...
	var_2(var_8_8, var_4.getConfig(var_8_9, "tech_desc"))
	...
	local var_8_12 = var_8_10.floor

	pg = var_4

	local var_8_13 = var_8_12(var_4.island_formula[var_8_11].workload / arg_8_0.baseEffectSpeed)
	...
	var_4(var_8_14, var_6.DescCDTime(var_8_15, var_8_13))

	Clone = var_4

	local var_8_16 = arg_8_0.showTechVO

	arg_8_0.unlockCondList = var_4(var_5.getConfig(var_8_16, "sys_unlock"))
	...
	if var_4.getConfig(var_8_17, "island_level") ~= 0 then
		...
		var_8_17.insert(arg_8_0.unlockCondList, 1, {
			0,
			var_4
		})
	end
	...
	for iter_8_0, iter_8_1 in var_8_19(arg_8_0.statusTFs) do
	...
	local var_8_25 = var_8.Find(var_8_24, "panel/desc/name")
	local var_8_26 = arg_8_0.showTechVO

	var_7(var_8_25, var_9.getConfig(var_8_26, "complete_title"))
	...
	IslandTechnology = var_8_26
	var_8_28[var_8_26.STATUS.LOCK] = function()
		...
		local function var_9_2()
			...
			var_10_1(var_10_0, var_3_10002("island_tech_unlock_tip"))
		...
		var_2_10000(var_9_0, var_9_1, var_9_2, var_2_10004)

		return
	end
	IslandTechnology = var_10
	var_8_28[var_10.STATUS.UNLOCK] = function()
		onButton = var_2_10000
		...
		local function var_11_2()
			...
			var_12_1(var_12_0, var_3_10002.ON_UNLOCK_TECH, arg_8_0.showTechVO.id)
		...
		var_2_10000(var_11_0, var_11_1, var_11_2, var_2_10004)

		return
	end
	IslandTechnology = var_10
	var_8_28[var_10.STATUS.NORMAL] = function()
		setGray = var_2_10000

		local var_13_0 = arg_8_0.statusTFs[var_8_20]
		local var_13_1 = arg_8_0

		var_2_10000(var_13_0, not var_2.CheckCost(var_13_1), false)
		...
		local function var_13_4()
			...
			if not var_0.CheckCost(var_14_0) then
				...
				var_14_2(var_14_1, var_3_10002("island_production_cost_notenough"))
			...
			if not var_0.GetEmptySlotId(var_14_3) then
				...
				local var_14_4 = var_14_3.TipsMgr.GetInstance()
				local var_14_5 = var_1.ShowTips

				i18n = var_3_10003

				var_14_5(var_14_4, var_3_10003("island_tech_no_slot"))
			...
			if var_1.IsAutoType(var_14_6) then
				...
				var_1(var_14_7, var_3.GetFormulaId(var_14_8))
			end
		...
		var_2_10000(var_13_2, var_13_3, var_13_4, var_2_10004)

		return
	end
	IslandTechnology = var_10
	var_8_28[var_10.STATUS.STUDYING] = function()
		onButton = var_2_10000

		local var_15_0 = arg_8_0
		local var_15_1 = arg_8_0.statusTFs[var_8_20]
		local var_15_2 = var_2.Find(var_15_1, "ticket")
		...
		local function var_15_3()
			...
			var_3_10000(var_16_0, var_2.GetSlotId(var_16_1))
		...
		var_2_10000(var_15_0, var_15_2, var_15_3, var_4)

		return
	end
	IslandTechnology = var_10
	var_8_28[var_10.STATUS.RECEIVE] = function()
		onButton = var_2_10000
		...
		local function var_17_2()
			...
			local var_18_2 = var_3_10002.GET_DELEGATION_AWARD
			local var_18_3 = arg_8_0.placeId
			local var_18_4 = arg_8_0.showTechVO

			var_18_1(var_18_0, var_18_2, var_18_3, var_4.GetSlotId(var_18_4), 2, function()
		...
		var_2_10000(var_17_0, var_17_1, var_17_2, var_2_10004)

		return
	end
	IslandTechnology = var_10
	var_8_28[var_10.STATUS.FINISHED] = function()
		local var_20_0 = arg_8_0.showTechVO

		if var_0.getConfig(var_20_0, "complete_map_id") == 0 then
			setActive = var_20_0

			var_20_0(arg_8_0.noramlFinsh, true)

			setActive = var_20_0

			var_20_0(arg_8_0.mapFinsh, false)
		...
		var_20_0(arg_8_0.noramlFinsh, false)

		setActive = var_20_0

		var_20_0(arg_8_0.mapFinsh, true)

		local var_20_1 = var_0

		LoadImageSpriteAtlasAsync = var_2

		var_2("island/IslandMapIcon/" .. var_20_1, "", arg_8_0.mapFinshIcon)
		...
		var_2(var_20_2, var_4.island_map[var_20_1].name)
		...
		var_20_3(arg_8_0.npcTF, true)

		pg = var_20_3

		local var_20_4 = var_20_3.island_unit_character[var_2[1]]
...
function var_0_1.FlushSelectedItem(arg_24_0)
	...
	var_1_10001(var_2.Find(var_24_0, "selected"), true)
	...
	IslandTechTreePanel = var_24_1

	local var_24_3 = var_24_1.SetTechName
	local var_24_4 = arg_24_0.selectedTF

	var_24_3(var_3.Find(var_24_4, "name"), var_24_2:getConfig("tech_name"))

	local var_24_5 = var_24_2
	local var_24_6 = var_24_2.GetStatus(var_24_5)

	IslandTechnology = var_24_5

	local var_24_7 = var_24_6 == var_24_5.STATUS.FINISHED

	setTextColor = var_4

	local var_24_8 = arg_24_0.selectedTF
	local var_24_9 = var_5.Find(var_24_8, "name/Text")

	Color = var_24_8

	var_4(var_24_9, var_24_8.NewHex(var_24_7 and "1b3650" or "ffffff"))

	setTextColor = var_4

	local var_24_10 = arg_24_0.selectedTF
	local var_24_11 = var_5.Find(var_24_10, "name/ScrollText")

	Color = var_24_10

	var_4(var_24_11, var_24_10.NewHex(var_24_7 and "1b3650" or "ffffff"))

	LoadImageSpriteAsync = var_4

	local var_24_12 = "island/IslandTechnology/" .. var_24_2:getConfig("tech_icon")
	local var_24_13 = arg_24_0.selectedTF

	var_4(var_24_12, var_6.Find(var_24_13, "icon"), true)

	setActive = var_4

	local var_24_14 = arg_24_0.selectedTF
	local var_24_15 = var_5.Find(var_24_14, "icon")

	IslandTechnology = var_24_14

	if var_24_6 ~= var_24_14.STATUS.STUDYING then
		IslandTechnology = var_6

		local var_24_16

		if var_24_6 == var_6.STATUS.RECEIVE then
			var_24_16 = false
		else
			var_24_16 = true
		end

		var_4(var_24_15, var_24_16)

		setImageColor = var_4

		local var_24_17 = arg_24_0.selectedTF
		local var_24_18 = var_5.Find(var_24_17, "icon")

		Color = var_24_17

		var_4(var_24_18, var_24_17.NewHex(var_24_7 and "455a81" or "ffffff"))

		eachChild = var_4

		local var_24_19 = arg_24_0.selectedTF

		var_4(var_5.Find(var_24_19, "back"), function(arg_25_0)
			setActive = var_2_10001

			var_2_10001(arg_25_0, arg_25_0.name == var_24_6)
		...
		local var_24_20 = arg_24_0.selectedTF
		local var_24_21 = var_5.Find(var_24_20, "back/normal")

		if not var_24_7 then
			IslandTechnology = var_24_20

			local var_24_22

			if var_24_6 == var_24_20.STATUS.STUDYING then
				var_24_22 = false
			else
				var_24_22 = true
			end

			var_4(var_24_21, var_24_22)

			eachChild = var_4

			local var_24_23 = arg_24_0.selectedTF

			var_4(var_5.Find(var_24_23, "front"), function(arg_26_0)
				setActive = var_2_10001

				var_2_10001(arg_26_0, arg_26_0.name == var_24_6)
...
function var_0_1.OnShipSelected(arg_28_0, arg_28_1)
	...
	local var_28_0 = var_1_10002(var_1_10003)
	...
	local var_28_6 = var_28_4.island_formula[var_28_5]

	math = var_1_10007

	local var_28_7 = var_1_10007.floor
	local var_28_8 = var_28_6.stamina_cost

	IslandProductCostHelper = var_1_10009

	local var_28_9 = var_28_7(var_28_8 * (1 - var_1_10009.GetReducePercentInPlace(arg_28_1, arg_28_0.placeId)))

	math = var_8

	local var_28_10 = var_8.max(var_28_9, 1)
	...
	if var_28_3:GetCurrentEnergy() < var_28_10 then
		...
		var_28_12(var_28_11, var_10("island_production_cost_notenough"))
	...
	var_28_18(var_28_17, var_1_10012.START_DELEGATION, arg_28_0.placeId, var_28_14, arg_28_1, var_28_16, 1)
...
function var_0_1.UpdateTime(arg_29_0)
	...
	if var_2.GetDelegationSlotDataByTechId(var_29_2, arg_29_0.showTechVO.id) then
		local var_29_3 = var_2

		if var_2.GetSlotRewardData(var_29_3) then
			setText = var_29_3

			var_29_3(arg_29_0.timeTextTF, "00:00:00")

			goto label_29_0
		end

		local var_29_4 = var_2:GetSlotRoleData()
		local var_29_5 = var_4.GetFinishTime(var_29_4)
		local var_29_6 = arg_29_0.timeMgr
		local var_29_7 = var_29_5 - var_6.GetServerTime(var_29_6)

		setText = var_6

		local var_29_8 = arg_29_0.timeTextTF

		if var_29_7 > 0 then
			do
				local var_29_9 = arg_29_0.timeMgr
				local var_29_10

				if not var_8.DescCDTime(var_29_9, var_29_7) then
					var_29_10 = "00:00:00"
				end

				var_6(var_29_8, var_29_10)

				if false then
					setText = var_29_2

					var_29_2(arg_29_0.timeTextTF, "??:??:??")
				end
			end
