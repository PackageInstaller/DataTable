...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		if arg_3_0.frameDic[arg_3_0.selectFrameId] then
			...
			var_4_2(var_4_1, var_2_10005.ShareMgr.TypeDorm3dPhoto, nil, nil, true, var_0:Find("frame").sizeDelta, var_4_0.watermark_location)
		end
	...
	local function var_3_5()
		if arg_3_0.frameDic[arg_3_0.selectFrameId] then
			...
			local var_5_1 = var_0
			local var_5_2 = var_0.Find(var_5_1, "frame").sizeDelta

			pg = var_5_1

			if var_5_1.island_camera_photo_frame[arg_3_0.selectFrameId].frameTfName == "IslandWoodFrame" then
				local var_5_3 = var_0:Find("frame")
				local var_5_4 = var_4.GetComponent(var_5_3, "Image").sprite

				var_2_10006 = var_0

				local var_5_5 = var_0.Find(var_2_10006, "mask").sizeDelta

				Object = var_2_10006
				var_2_10006 = var_2_10006.Instantiate(var_5_4.texture)
				UnityEngine = var_7

				local var_5_6 = var_7.Texture2D.New(var_5_4.rect.width, var_5_4.rect.height)
				local var_5_7 = var_2_10006:GetPixels(0, 0, var_5_4.rect.width, var_5_4.rect.height)

				var_5_6:SetPixels(var_5_7)
				var_5_6:Apply()

				local var_5_8 = arg_3_0
				local var_5_9 = var_9.TakePhoto

				pg = var_11

				var_5_9(var_5_8, var_11.ShareMgr.TypeDorm3dPhoto, var_5_2, var_5_6, var_5_5)
			else
				local var_5_10 = arg_3_0
				local var_5_11 = var_4.TakePhoto

				pg = var_2_10006

				var_5_11(var_5_10, var_2_10006.ShareMgr.TypeDorm3dPhoto, var_5_2)
			end
		end
	...
	var_1(var_3_6, var_3.Find(var_3_7, "Mask"), function()
	...
	var_1(arg_3_0, arg_3_0.frameBtn, function()
		...
		IslandPhotoSelectFramePage = var_2_10002

		var_8_1(var_8_0, var_2_10002, arg_3_0.bytes, arg_3_0.photoTexture, arg_3_0.selectFrameId, function(arg_9_0)
...
function var_0_1.LoadFrame(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	local function var_15_2(arg_16_0)
		...
		typeof = var_2_10004
		RawImage = var_2_10005

		local var_16_2 = var_16_1(var_16_0, var_2_10004(var_2_10005))
		...
		if arg_15_3 then
			...
			for iter_16_0, iter_16_1 in var_7(var_16_4) do
				...
				typeof = var_2_10015
				RawImage = var_2_10016

				local var_16_9 = var_16_8(var_16_7, var_2_10015(var_2_10016))

				var_16_9.texture = arg_15_0.photoTexture
				GameObject = var_14
				var_2_10015 = var_14.Find("OverlayCamera").transform

				local var_16_10 = var_14.GetChild(var_2_10015, 0)

				if var_15_1 and iter_16_1 == "mask_up/realImage" then
					Vector2 = var_2_10015
					var_12.sizeDelta = var_2_10015(var_16_10.sizeDelta.x / 10, var_16_10.sizeDelta.y / 10)
				else
					var_12.sizeDelta = var_16_10.sizeDelta
				end

				var_2_10015 = var_16_5[iter_16_0]
				setAnchoredPosition = var_2_10016

				var_2_10016(var_16_9, {
					x = arg_15_3[var_2_10015].x,
					y = arg_15_3[var_2_10015].y
				})
	...
	typeof = var_1_10014
	GameObject = var_1_10015

	local var_15_8 = var_1_10014(var_1_10015)

	UnityEngine = var_1_10015

	local var_15_9 = var_15_5(var_15_4, var_15_6, var_15_7, var_15_8, var_1_10015.Events.UnityAction_UnityEngine_Object(function(arg_17_0)
		...
		var_17_3(var_17_2, var_4(var_2_10005)).enabled = false

		local var_17_4 = var_17_1:Find("mask/realImage")
		local var_17_5 = var_3.GetComponent

		typeof = var_5
		PinchZoom = var_2_10006
		var_17_5(var_17_4, var_5(var_2_10006)).enabled = false
		...
		if var_17_6 then
			...
			typeof = var_2_10008
			PinchZoom = var_2_10009
			var_17_9(var_17_8, var_2_10008(var_2_10009)).enabled = false
		end
		...
		if var_17_7 then
			...
			typeof = var_2_10008
			PinchZoom = var_2_10009
			var_17_11(var_17_10, var_2_10008(var_2_10009)).enabled = false
		end
	...
	local var_15_10 = var_15_4.insert
	local var_15_11
...
function var_0_1.TakePhoto(arg_18_0, arg_18_1, arg_18_2, arg_18_3, arg_18_4)
	...
	var_1_10009.each(var_18_3.hidden_comps, function(arg_19_0)
		...
		if not var_2(var_19_0) and var_19_0.activeSelf then
			table = var_2
	...
	var_9.each(var_18_3.show_comps, function(arg_20_0)
		...
		if not var_2(var_20_0) and not var_20_0.activeSelf then
			table = var_2
	...
	local var_18_6 = var_18_5(var_18_4, var_11(var_12)).transform
	...
	local function var_18_8(arg_22_0)
		...
		local var_22_7 = arg_22_0:GetPixels(var_22_5, var_22_6, var_22_1, var_22_3)

		var_22_4:SetPixels(var_22_7)
		var_22_4:Apply()

		if not arg_18_4 then
			Tex2DExtension = var_7

			local var_22_8 = var_7.EncodeToPNG(var_22_4)

			YSNormalTool = var_8

			var_8.MediaTool.SaveImageWithBytes(var_22_8, function(arg_26_0, arg_26_1)
				if arg_26_0 then
					pg = var_3_10002
					...
					var_26_1(var_26_0, var_3_10004("word_save_ok"))
				end
		...
		local var_22_9 = arg_18_4.x / var_18_7.sizeDelta.x

		Screen = var_8

		local var_22_10 = var_22_9 * var_8.width
		local var_22_11 = arg_18_4.y / var_18_7.sizeDelta.y

		Screen = var_9

		local var_22_12 = var_22_11 * var_9.height
		local var_22_13 = var_22_1 - var_22_10
		local var_22_14 = var_22_3 - var_22_12
		local var_22_15 = var_22_4:GetPixels(var_22_13 / 2, var_22_14 / 2, var_22_10, var_22_12)
		local var_22_16 = arg_18_3

		var_12.SetPixels(var_22_16, var_22_13 / 2, var_22_14 / 2, var_22_10, var_22_12, var_22_15)

		Tex2DExtension = var_12

		local var_22_17 = var_12.EncodeToPNG(arg_18_3)

		YSNormalTool = var_13

		var_13.MediaTool.SaveImageWithBytes(var_22_17, function(arg_27_0, arg_27_1)
			if arg_27_0 then
				pg = var_3_10002
				...
				var_27_1(var_27_0, var_3_10004("word_save_ok"))
			end
	...
	var_12.Rendering.HotUpdate.ScreenShooterPass.TakePhoto(var_9, var_18_8)
