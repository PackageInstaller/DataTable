...
function var_0_1.GetCanSellCnt(arg_8_0, arg_8_1)
	...
	local var_8_4 = var_8_3(var_8_2, var_1_10006.PEARL_ID)
...
function var_0_1.GetCanPurchaseCnt(arg_9_0)
	...
	local var_9_4 = var_9_3(var_9_2, var_1_10005.GOLD_ID)
	local var_9_5 = arg_9_0
	local var_9_6 = arg_9_0.GetTodayPrice(var_9_5)

	math = var_9_5

	local var_9_7 = var_9_5.floor(var_9_4 / var_9_6)

	math = var_6

	return var_6.min(var_9_7, arg_9_0.weekNumMax - arg_9_0.weekNum)
end
...
function var_0_1.GetRanks(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10004.floor(var_1.value * arg_16_0.coefficient))
	...
	return var_16_1.map(arg_16_0.ranks, function(arg_17_0)
		...
		var_17_1(var_17_0, var_2_10004.floor(arg_17_0.value * arg_16_0.coefficient))
...
function var_0_1.GetSelfRank(arg_18_0)
	...
	IslandTradeRank = var_18_5

	local var_18_7 = var_18_5.New
	local var_18_8 = {
		id = var_18_1.id,
		value = var_18_6,
...
function var_0_1.GetTodayPrice(arg_23_0)
	...
	local var_23_1 = arg_23_0.GetTodaySellPrice(var_23_0)

	math = var_23_0

	return var_23_0.floor(var_23_1 * arg_23_0.coefficient)
end
