...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 21014, {
		...
		if arg_2_0.result == 0 then
			...
			pg = var_2_10003
			var_2_10003 = var_2_10003.island_item_data_template
			ipairs = var_2_10004
			...
			for iter_2_0, iter_2_1 in var_2_10004(var_1_1) do
				if var_1_0 == 2 then
					...
					var_2_2.RemoveOverflowItem(var_2_10010, iter_2_1.id, iter_2_1.num)
				elseif var_1_0 == 1 then
					var_2_10010 = var_2_2

					var_2_2.RemoveItem(var_2_10010, iter_2_1.id, iter_2_1.num)
				end

				if var_2_10003[iter_2_1.id].convert == 1 then
					var_2_3 = var_2_3 + var_2_10003[iter_2_1.id].pt_num * iter_2_1.num
				end
			end
			...
			for iter_2_2, iter_2_3 in var_5(arg_2_0.item_list) do
				...
				DROP_TYPE_ISLAND_ITEM = var_2_10013
				var_2_6.type = var_2_10013
			...
			local var_2_8 = var_2_4
			local var_2_9 = {
				id = 0
			}

			VIRTUAL_DROP_TYPE_ISLAND_SEASON_PT = iter_2_2
			var_2_9.type = iter_2_2
			...
			var_2_12(var_2_11, iter_2_2.ISLAND_CONVERT_SEASON_PT_DONE, {
				dropData = var_2_10
			})
		else
			pg = var_2_2
