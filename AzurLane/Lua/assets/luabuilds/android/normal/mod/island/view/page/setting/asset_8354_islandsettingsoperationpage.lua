...
Color = var_0_0
var_0_1.CLD_RED = var_0_0.New(0.6, 0.05, 0.05, 0.5)
Color = var_1
...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_2_2(var_2_3, var_4(arg_2_0.interface, "op_btn"))
	...
	var_2_4(var_2_5, var_4(arg_2_0.interface, "jump"))
	...
	var_2_6(var_2_7, var_4(arg_2_0.interface, "scope"))
	...
	var_2_8(var_2_9, var_4(arg_2_0.interface, "seed"))
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_0.opTFList) do
		...
		var_1_10007.insert(arg_2_0.eventStickList, iter_2_1:GetComponent("EventTriggerListener"))
	end
	...
	arg_2_0.cg = var_2_12(var_2_11, var_4(iter_2_0))
	...
	typeof = var_4
	CanvasGroup = iter_2_0
	arg_2_0.topLayerCg = var_2_15(var_2_14, var_4(iter_2_0))
	setActive = var_2
	...
	local var_2_17 = var_3.Find(var_2_16, "editor/editing_region/mask/middle/Text")

	i18n = var_2_16

	var_2(var_2_17, var_2_16("settings_battle_tip"))

	setText = var_2

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_3.Find(var_2_18, "editor/buttons/normal/edit/Image")

	i18n = var_2_18

	var_2(var_2_19, var_2_18("settings_battle_Btn_edit"))

	setText = var_2

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_3.Find(var_2_20, "editor/buttons/normal/reset/Image")

	i18n = var_2_20

	var_2(var_2_21, var_2_20("settings_battle_Btn_reset"))

	setText = var_2

	local var_2_22 = arg_2_0._tf
	local var_2_23 = var_3.Find(var_2_22, "editor/title/title_name")

	i18n = var_2_22

	var_2(var_2_23, var_2_22("settings_battle_title"))

	setText = var_2

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_3.Find(var_2_24, "editor/buttons/editing/save/Image")

	i18n = var_2_24

	var_2(var_2_25, var_2_24("settings_battle_Btn_save"))

	setText = var_2

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_3.Find(var_2_26, "editor/buttons/editing/cancel/Image")

	i18n = var_2_26

	var_2(var_2_27, var_2_26("settings_battle_Btn_cancel"))
...
function var_0_1.InitInterfaceComponents(arg_10_0)
	...
	local var_10_5 = var_1_10006.ISLAND_KEY_JOYSTICK_ANCHORX

	IslandSettingsConst = var_1_10007

	var_10_2(var_10_1, var_10_3, var_10_4, var_10_5, var_1_10007.ISLAND_KEY_JOYSTICK_ANCHORY, var_10_0)
	...
	for iter_10_0, iter_10_1 in var_10_2(arg_10_0.opTFList) do
		...
		var_1_10011 = var_1_10011.ISLAND_KEY_OPERATION_ANCHORX[iter_10_0]
		IslandSettingsConst = var_1_10012
		var_1_10012 = var_1_10012.ISLAND_KEY_OPERATION_ANCHORY[iter_10_0]
		IslandSettingsConst = var_1_10013

		var_10_7(var_10_6, var_10_8, var_10_9, var_1_10011, var_1_10012, var_1_10013.OPERATION_DEFAULT_PREFERENCE[iter_10_0])
	end
	...
	for iter_10_2, iter_10_3 in var_3(arg_10_0.opTFList) do
		...
		var_10_6.insert(arg_10_0.components, iter_10_3)
	end
...
function var_0_1.RevertInterfaceSetting(arg_20_0, arg_20_1)
	...
	local var_20_4 = var_1_10006.ISLAND_KEY_JOYSTICK_ANCHORX

	IslandSettingsConst = var_1_10007

	var_20_2(var_20_1, var_20_3, var_20_4, var_1_10007.ISLAND_KEY_JOYSTICK_ANCHORY, var_20_0, arg_20_1)
	...
	for iter_20_0, iter_20_1 in var_20_2(arg_20_0.opTFList) do
		...
		IslandSettingsConst = var_1_10011
		var_1_10011 = var_1_10011.ISLAND_KEY_OPERATION_ANCHORX[iter_20_0]
		IslandSettingsConst = var_1_10012
		var_1_10012 = var_1_10012.ISLAND_KEY_OPERATION_ANCHORY[iter_20_0]
		IslandSettingsConst = var_1_10013

		var_20_6(var_20_5, var_20_7, var_1_10011, var_1_10012, var_1_10013.OPERATION_DEFAULT_PREFERENCE[iter_20_0], arg_20_1)
	end
...
function var_0_1.SaveInterfaceSetting(arg_21_0)
	...
	local var_21_3 = var_1_10004.ISLAND_KEY_JOYSTICK_ANCHORX

	IslandSettingsConst = var_1_10005

	var_21_1(var_21_0, var_21_2, var_21_3, var_1_10005.ISLAND_KEY_JOYSTICK_ANCHORY)
	...
	for iter_21_0, iter_21_1 in var_21_1(arg_21_0.opTFList) do
		...
		IslandSettingsConst = var_1_10009
		var_1_10009 = var_1_10009.ISLAND_KEY_OPERATION_ANCHORX[iter_21_0]
		IslandSettingsConst = var_1_10010

		var_21_5(var_21_4, var_21_6, var_1_10009, var_1_10010.ISLAND_KEY_OPERATION_ANCHORY[iter_21_0])
	end
