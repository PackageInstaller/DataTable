...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_15 = var_2.Find(var_2_14, "itemList/Viewport/Content")
	local var_2_16 = arg_2_0.panel

	arg_2_0.bottomItemList = var_2_13(var_2_15, var_3.Find(var_2_16, "itemList/Viewport/Content/IslandItemTpl"))
	...
	local var_2_21 = var_2.Find(var_2_20, "panel/title")

	i18n = var_2_20

	var_1(var_2_21, var_2_20("island_3Dshop_buy_confirm"))

	setText = var_1

	local var_2_22 = arg_2_0._tf
	local var_2_23 = var_2.Find(var_2_22, "panel/buyBtn/text")

	i18n = var_2_22

	var_1(var_2_23, var_2_22("island_3Dshop_buy"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_2.Find(var_2_24, "panel/getDesc")

	i18n = var_2_24

	var_1(var_2_25, var_2_24("island_3Dshop_buy_tip0"))
...
function var_0_1.SetUp(arg_6_0, arg_6_1, arg_6_2)
	...
	var_3(var_4.Find(var_6_0, "Text"), "-" .. arg_6_2:GetDiscount() .. "%")
	...
	var_6_1(arg_6_0.remainTimer, var_6_2)

	if var_6_2 then
		local var_6_3 = arg_6_2

		var_6_1 = arg_6_2.getConfig(var_6_3, "time")[2]
		pg = var_6_3

		local var_6_4 = var_6_3.TimeMgr.GetInstance()
		local var_6_5 = var_5.Table2ServerTime(var_6_4, {
			year = var_6_1[1][1],
			month = var_6_1[1][2],
			day = var_6_1[1][3],
			hour = var_6_1[2][1],
		...
		arg_6_0:StartTimer(function()
			...
			if var_6_5 - var_7_1 < var_6_6 then
				pg = var_7_3
				...
				var_7_2(var_4.Find(var_7_4, "text"), var_7_3)
			else
				setText = var_7_3

				local var_7_5 = arg_6_0.remainTimer
				local var_7_6 = var_3.Find(var_7_5, "text")
				...
				var_7_3(var_7_6, var_7_5(var_7_7, var_2_10006.floor(var_1 / var_6_6)))
			end
	...
	local var_6_7 = var_6_1("island_3Dshop_buy_no")
	local var_6_8

	if arg_6_2:GetMaxNum() ~= 0 then
		var_6_8 = arg_6_2:GetMaxNum() - arg_6_2.purchasedNum

		local var_6_9 = var_6_7

		i18n = var_7
		var_6_7 = var_6_9 .. var_7("island_3Dshop_last", var_6_8)
	end

	setText = var_6_8

	var_6_8(arg_6_0.buyDesc, var_6_7)
	...
	if var_6_14 == var_1_10011 then
		...
		var_1_10011 = var_1_10011.getRawData(var_1_10012)

		if var_6_15 == 1 then
			var_1_10012 = var_1_10011.gold
			math = var_1_10013
			var_6_13 = var_1_10013.floor(var_1_10012 / var_6_12)
		elseif var_6_15 == 4 or var_6_15 == 14 then
			local var_6_16 = var_1_10011

			var_1_10012 = var_1_10011.getTotalGem(var_6_16)
			math = var_6_16
			var_6_13 = var_6_16.floor(var_1_10012 / var_6_12)
		end
	else
		...
		if var_6_14 == var_1_10011 then
			...
			local var_6_17 = var_1_10011(var_1_10012)
			local var_6_18 = var_1_10011.GetIsland(var_6_17)
			local var_6_19 = var_1_10011.GetInventoryAgency(var_6_18)
			local var_6_20 = var_1_10011.GetOwnCount(var_6_19, var_6_15)

			math = var_6_19
			var_6_13 = var_6_19.floor(var_6_20 / var_6_12)
		end
	end

	math = var_1_10011

	local var_6_21 = var_1_10011.clamp(var_6_13, 1, var_6_10)
	local var_6_22 = arg_6_2:GetItemsWithPt()

	local function var_6_23(arg_8_0)
		math = var_2_10001
		arg_8_0 = var_2_10001.clamp(arg_8_0, 1, var_6_21)
		...
		for iter_8_0 = 1, #arg_6_0.itemsCountTFs do
			...
			var_2_10006(var_8_1, var_6_22[iter_8_0][3] * arg_6_0.curCount)
		end
		...
		var_1(var_8_2, var_3.ceil(var_6_12 * arg_6_0.curCount))
	...
	local var_6_24 = arg_6_0.leftBtn
	local var_6_25 = 0.5

	local function var_6_26(arg_9_0)
		var_6_23(arg_6_0.curCount - 1)
	...
	var_13(var_6_24, var_6_25, var_6_26, var_6_27, var_6_28, var_6_29, var_6_30, var_1_10021)

	pressPersistTrigger = var_13

	local var_6_31 = arg_6_0.rightBtn
	local var_6_32 = 0.5

	local function var_6_33(arg_10_0)
		var_6_23(arg_6_0.curCount + 1)
	...
	var_13(var_6_31, var_6_32, var_6_33, var_6_34, var_6_35, var_6_36, var_6_37, var_1_10021)

	pressPersistTrigger = var_13

	local var_6_38 = arg_6_0.minBtn
	local var_6_39 = 0.5

	local function var_6_40(arg_11_0)
		var_6_23(arg_6_0.curCount - 10)
	...
	var_13(var_6_38, var_6_39, var_6_40, var_6_41, var_6_42, var_6_43, var_6_44, var_1_10021)

	pressPersistTrigger = var_13

	local var_6_45 = arg_6_0.maxBtn
	local var_6_46 = 0.5

	local function var_6_47(arg_12_0)
		var_6_23(arg_6_0.curCount + 10)
	...
	var_13(var_6_45, var_6_46, var_6_47, var_6_48, var_6_49, var_6_50, var_6_51, var_1_10021)

	arg_6_0.itemsCountTFs = {}

	local var_6_52 = arg_6_0.bottomItemList

	var_13.make(var_6_52, function(arg_13_0, arg_13_1, arg_13_2)
		UIItemList = var_2_10003

		if arg_13_0 == var_2_10003.EventUpdate then
			local var_13_0 = var_6_22[arg_13_1 + 1]
			local var_13_1 = {
				type = var_13_0[1],
				id = var_13_0[2],
				count = var_13_0[3]
	...
	local var_6_53 = arg_6_0.bottomItemList

	var_13.align(var_6_53, #var_6_22)
	var_6_23(1)

	local var_6_54 = var_6_11[1]

	DROP_TYPE_RESOURCE = var_14

	if var_6_54 == var_14 then
		GetImageSpriteFromAtlasAsync = var_6_54
		Drop = var_14

		local var_6_55 = var_14.New({
			type = var_6_11[1],
			id = var_6_11[2]
		})

		var_6_54(var_14.getIcon(var_6_55), "", arg_6_0.consumeIcon)
	else
		var_6_54 = var_6_11[1]
		...
		if var_6_54 == var_14 then
			...
			local var_6_56 = var_14.New({
				type = var_6_11[1],
				id = var_6_11[2]
			})

			var_6_54(var_14.getIcon(var_6_56), "", arg_6_0.consumeIcon)
		end
	end

	onButton = var_6_54

	local var_6_57 = arg_6_0
	local var_6_58 = arg_6_0.buyBtn
	...
	local function var_6_59()
		...
		var_14_2(var_14_1, var_2_10003.BUY_COMMODITY, var_14_0)
	...
	var_6_54(var_6_57, var_6_58, var_6_59, var_6_48)
...
function var_0_1.AddListeners(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.ISLAND_SHOP_OP_DONE, arg_15_0.Hide)
...
function var_0_1.RemoveListeners(arg_16_0)
	...
	var_16_1(var_16_0, var_1_10003.ISLAND_SHOP_OP_DONE, arg_16_0.Hide)
