...
function var_0_1.OnInit(arg_1_0, arg_1_1)
	...
	for iter_1_2, iter_1_3 in var_3(var_1_2) do
		...
		IslandCommanderDressItem = var_1_10010

		var_1_10008(var_1_3, var_1_10010.New(iter_1_3))
	end
...
function var_0_1.AddDressByDressId(arg_13_0, arg_13_1)
	...
	IslandCommanderDressItem = var_1_10004

	var_13_0(var_13_1, var_1_10004.New({
		color = 0,
		state = 0,
		id = arg_13_1,
		color_list = {}
	...
	if var_13_2 == var_4.DressType.Body then
		pg = var_13_2
...
function var_0_1.GetHairFaceBodyDress(arg_15_0)
	...
	local var_15_2 = var_15_1(var_15_0, var_1_10003.DressType.Hair)
	local var_15_3 = arg_15_0
	local var_15_4 = arg_15_0.GetDressByType

	IslandShipDressHelperNew = var_1_10004

	local var_15_5 = var_15_4(var_15_3, var_1_10004.DressType.Face)
	local var_15_6 = arg_15_0
	local var_15_7 = arg_15_0.GetDressByType

	IslandShipDressHelperNew = var_1_10005

	local var_15_8 = var_15_7(var_15_6, var_1_10005.DressType.Body)
...
function var_0_1.ChangeDress(arg_16_0, arg_16_1)
	...
	for iter_16_0, iter_16_1 in var_1_10002(arg_16_1) do
		...
		arg_16_0.SetDressByTpye(var_16_0, iter_16_1.type, iter_16_1.id)

		local var_16_1 = iter_16_1.type

		IslandShipDressHelperNew = var_16_0

		if var_16_1 == var_16_0.DressType.Body and arg_16_0:GetMorphTargetId(iter_16_1.id) and var_7 ~= 0 then
