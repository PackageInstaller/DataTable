...
function var_0_1.Resopon(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	local var_1_3 = var_6.GameTrackerMgr.GetInstance()
	local var_1_4 = var_6.Record

	GameTrackerBuilder = var_1_10008

	var_1_4(var_1_3, var_1_10008.BuildActionOp(1, arg_1_3, 2, arg_1_1.modelId, var_1_1, 1))
	...
	var_1_4({
		...
		if var_1_2 then
			...
			var_3_3(var_3_2, var_2_10003.NPC_ACTION_AWARD, var_3_0, arg_1_1.data.shipId, var_1_1)
		end
...
function var_0_1.PlayBubble(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_1_10005(var_3.emoji) == "table" then
		var_4_1 = var_3.emoji
		math = var_6
		var_4_0 = var_4_1[var_6.random(1, #var_4_1)]
	else
		var_4_0 = var_3.emoji
	end
...
function var_0_1.ResoponByRandom(arg_6_0, arg_6_1, arg_6_2)
	...
	arg_6_0.TurnToPlayer(var_6_3, var_6, arg_6_1)

	local var_6_4 = {}

	table = var_6_3

	var_6_3.insert(var_6_4, function(arg_7_0)
	...
	for iter_6_0, iter_6_1 in var_8(var_6) do
		...
		var_1_10013.insert(var_6_4, function(arg_8_0)
	...
	var_8.insert(var_6_4, function(arg_9_0)
		onNextTick = var_2_10001
...
function var_0_1.TurnToPlayer(arg_13_0, arg_13_1, arg_13_2)
	local function var_13_0(arg_14_0, arg_14_1)
		...
		Quaternion = var_4
		arg_14_0.rotation = var_4.Euler(0, var_14_1.eulerAngles.y, 0)
...
function var_0_1.GetNearestUnit(arg_17_0, arg_17_1, arg_17_2, arg_17_3)
	...
	for iter_17_0, iter_17_1 in var_1_10006(var_17_1) do
		...
		IslandNpcUnit = var_1_10013

		if var_1_10011(var_17_3, var_1_10013) then
			table = var_1_10011
	...
	for iter_17_2, iter_17_3 in var_8(var_17_2) do
		...
		if var_1_10013.Distance(iter_17_3._go.transform.position, arg_17_2._go.transform.position) <= arg_17_3 and var_1_10013 < var_17_5 then
			var_17_5 = var_1_10013
			var_17_4 = iter_17_3
		end
	end
	...
	if var_17_4 then
		...
		var_8.insert(arg_17_1, var_17_4)
	end
...
function var_0_1.GetNearestFollower(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10006.UNIT_LIST_FOLLOW)
	local var_18_3

	math = var_6

	local var_18_4 = var_6.huge

	ipairs = var_1_10007

	for iter_18_0, iter_18_1 in var_1_10007(var_18_2) do
		Vector3 = var_1_10012
...
function var_0_1.GetAllFollower(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	local var_19_2 = var_19_1(var_19_0, var_1_10006.UNIT_LIST_FOLLOW)
	...
	for iter_19_0, iter_19_1 in var_19_0(var_19_2) do
		...
		if var_1_10010.Distance(iter_19_1._go.transform.position, arg_19_2._go.transform.position) <= arg_19_3 then
			...
			var_11.insert(arg_19_1, iter_19_1)
		end
	end
...
function var_0_1.GetRandomFollower(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local var_20_2 = var_20_1(var_20_0, var_1_10006.UNIT_LIST_FOLLOW)
	local var_20_3 = {}

	ipairs = var_6

	for iter_20_0, iter_20_1 in var_6(var_20_2) do
		Vector3 = var_1_10011

		if var_1_10011.Distance(iter_20_1._go.transform.position, arg_20_2._go.transform.position) <= arg_20_3 then
			table = var_12

			var_12.insert(var_20_3, iter_20_1)
		end
	end
