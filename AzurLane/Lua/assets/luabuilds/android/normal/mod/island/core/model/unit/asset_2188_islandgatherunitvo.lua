...
function var_0_1.BindGatherData(arg_2_0)
	...
	if var_2_0 == var_2.GetIsland(var_2_1).id then
		...
		local var_2_4 = var_2_3:GetWildCollectAgency()
		local var_2_5 = arg_2_0.gatherType

		IslandConst = var_1_10005

		if var_2_5 == var_1_10005.UNIT_TYPE_ITEM_GATHER_ITEM then
			arg_2_0.gatherData = var_2_4:GetGatherDataByUnitId(arg_2_0.id)
		else
			arg_2_0.gatherData = var_2_4:GetCollectDataByUnitId(arg_2_0.id)
		end
