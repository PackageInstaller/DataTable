...
function var_0_0.StartGame()
	...
	GameTrackerBuilder = var_1_10002

	var_1_1(var_1_0, var_1_10002.BuildCheaterTavernGame(0, 0))
...
function var_0_0.StopPlayTime()
	...
	var_2_3(var_2_2, var_1_10003.BuildCheaterTavernGame(1, var_2_1))
...
function var_0_0.RecordResult(arg_3_0)
	...
	local var_3_1 = var_3_0(var_1_10002.GetGameTypeID())

	pg = var_2

	local var_3_2 = var_2.GameTrackerMgr.GetInstance()
	local var_3_3 = var_2.Record

	GameTrackerBuilder = var_1_10004

	var_3_3(var_3_2, var_1_10004.BuildCheaterTavernResult(arg_3_0, var_0_0.scoreBefore, var_3_1, var_0_0.turnCnt, var_0_0.roundCnt, var_0_0.duration))
