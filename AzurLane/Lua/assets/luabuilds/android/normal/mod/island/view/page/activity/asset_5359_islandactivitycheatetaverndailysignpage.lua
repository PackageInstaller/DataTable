...
function var_0_1.OnInit(arg_1_0)
	...
	function arg_1_0.scrollCom.onInitItem(arg_2_0)
		...
		var_2_1(var_2_0, var_2_10003(arg_2_0))
	...
	function var_1_1.onUpdateItem(arg_3_0, arg_3_1)
		...
		var_3_1(var_3_0, var_3_2, var_2_10005(arg_3_1))
	...
	local function var_1_4()
		...
		var_4_1(var_4_0, var_2_10002.RECORD_PLAYER_POS)
		...
		var_4_3(var_4_2, var_2.OPEN_PAGE, "IslandCheaterTavernPrepareMainPage")
	...
	var_1_1(var_1_5, var_3("bar_ui_check1"))
	...
	var_1_1(var_1_6, var_3("bar_ui_check2"))
...
function var_0_1.UpdateTask(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_5 = var_10_0.Find(var_10_4, "IslandItemTpl")

	Drop = var_10_4

	local var_10_6 = var_10_4.Create(arg_10_0.taskConfig[var_10_2].award_display[1])

	if 1 <= var_10_1 then
		updateCustomDrop = var_9

		var_9(var_10_5, var_10_6, {
			style = "island"
		})
		...
		local function var_10_9()
			...
			local var_11_2 = var_2_10002.SHOW_MSG_BOX
			local var_11_3 = {}

			i18n = var_2_10004
			var_11_3.title = var_2_10004("island_word_desc")
			IslandMsgBox = var_4
			var_11_3.type = var_4.TYPE_COMMON_DROP_DESCRIBE
			var_11_3.dropData = var_10_6
		...
		var_9(var_10_7, var_10_8, var_10_9, var_1_10013)

		onButton = var_9

		local var_10_10 = arg_10_0
		local var_10_11 = var_10_0:Find("canget")
		...
		local function var_10_12()
			...
			local var_12_2 = var_2_10002.SUBMIT_ACTIVITY_TASK
			local var_12_3 = {
				inIsland = true,
			...
			var_12_3.task_ids = var_4.GetCanSubmitTaskIds(var_12_4)
		...
		var_9(var_10_10, var_10_11, var_10_12, var_13)
	end

	setText = var_9

	local var_10_13 = var_10_0:Find("target")
	local var_10_14 = "Day"

	tostring = var_12

	var_9(var_10_13, var_10_14 .. var_12(var_10_1))
...
function var_0_1.OnDataSetting(arg_13_0)
	...
	arg_13_0.actTaskProxy = var_1_10001(var_1_10002)
	underscore = var_1

	local var_13_0 = var_1.flatten
	local var_13_1 = arg_13_0.activity

	arg_13_0.taskGroup = var_13_0(var_2.getConfig(var_13_1, "config_data"))
	pg = var_1
...
function var_0_1.OnUpdateFlush(arg_15_0)
	...
	var_2(arg_15_0.uiPtNum, var_15_1)

	PlayRoomTools = var_2

	local var_15_2 = var_2.GetPtScoreIcon(arg_15_0:GetGameType())
