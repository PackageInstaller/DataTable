...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_9.Send(var_1_7, 21626, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10003 = var_1.GetDressUpAgency(var_2_0)

			var_1.ChangeCapState(var_2_10003, arg_2_0.cap_list)
			...
			var_1.ChangeDress(var_2_10003, var_1_1)
			...
			var_2_1(var_2_10003, var_4.CHANGE_PLAYER_DRESS, var_1_1, var_1_2)
			...
			var_2_2(var_2_10003, var_4.ISLAND_CHANGE_COMMANDER_DRESS_DONE)

			local var_2_3

			if not var_1_4 then
				pg = var_2_3
				var_2_10003 = var_2_3.TipsMgr.GetInstance()
				var_2_3 = var_2_3.ShowTips
				i18n = var_4

				var_2_3(var_2_10003, var_4("island_dress_save1"))
			end
