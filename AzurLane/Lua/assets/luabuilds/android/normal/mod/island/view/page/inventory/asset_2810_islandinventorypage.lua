...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.orderTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.capacityTxt = var_2_23(var_2_22, var_3(var_4))
	...
	local var_2_29 = var_2.Find(var_2_28, "tip")

	i18n = var_2_28

	var_1(var_2_29, var_2_28("island_quickselect_tip"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.sellPriceTxt = var_2_37(var_2_36, var_3(var_4))
	...
	local var_2_39 = var_2_38 .. var_3().icon
	local var_2_40 = arg_2_0._tf

	var_1(var_2_39, var_3.Find(var_2_40, "window/sell_panel/price/Text/icon"))
	...
	local var_2_46 = var_2.Find(var_2_45, "window/title/Text")

	i18n = var_2_45

	var_1(var_2_46, var_2_45("island_bag_title"))

	setText = var_1

	local var_2_47 = arg_2_0._tf
	local var_2_48 = var_2.Find(var_2_47, "window/batch_sell/Text")

	i18n = var_2_47

	var_1(var_2_48, var_2_47("island_batch_covert"))

	setText = var_1

	local var_2_49 = arg_2_0._tf
	local var_2_50 = var_2.Find(var_2_49, "window/sell_panel/price/label")

	i18n = var_2_49

	var_1(var_2_50, var_2_49("island_total_price"))

	setText = var_1

	local var_2_51 = arg_2_0._tf
	local var_2_52 = var_2.Find(var_2_51, "window/sell_panel/cancel/Text")

	i18n = var_2_51

	var_1(var_2_52, var_2_51("word_cancel"))

	setText = var_1

	local var_2_53 = arg_2_0._tf
	local var_2_54 = var_2.Find(var_2_53, "window/sell_panel/all/Text")

	i18n = var_2_53

	var_1(var_2_54, var_2_53("island_selectall"))

	setText = var_1

	local var_2_55 = arg_2_0._tf
	local var_2_56 = var_2.Find(var_2_55, "window/sell_panel/batch_sell_1/Text")

	i18n = var_2_55

	var_1(var_2_56, var_2_55("island_batch_covert"))

	setText = var_1

	local var_2_57 = arg_2_0._tf
	local var_2_58 = var_2.Find(var_2_57, "window/one_key_panel/fetch_btn/Text")

	i18n = var_2_57

	var_1(var_2_58, var_2_57("mail_get_oneclick"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_8()
		...
		IslandInventoryUpgradePage = var_2_10002
	...
	local function var_3_20()
		...
		i18n = var_2_10004
		var_10_3.content = var_2_10004("island_season_window_transformtip")
		...
		function var_10_3.onYes()
			if arg_3_0.tagType == var_0_1.INVENTORY_TYPE_OVERFLOW then
				...
				var_11_1(var_11_0, var_3_10002.ON_CONVERT_SEASON_PT_4_OVERFLOW, var_0)
			else
				...
				var_11_3(var_11_2, var_3_10002.ON_CONVERT_SEASON_PT, var_0)
			end
	...
	local function var_3_23()
		...
		var_12_1(var_12_0, var_2_10002.ONE_KEY)
	...
	var_1_10001(var_3_21, var_3_22, var_3_23, var_1_10005)
...
function var_0_1.AddListeners(arg_16_0)
	...
	IslandScene = var_1_10003

	var_16_1(var_16_0, var_1_10003.ON_INVENTORY_FILTER, arg_16_0.OnInventoryFilter)
	...
	var_16_3(var_16_2, var_3.ISLAND_UPGRADE_INVENTORY_DONE, arg_16_0.OnUpgrade)
	...
	var_16_5(var_16_4, var_3.ISLAND_CONVERT_SEASON_PT_DONE, arg_16_0.OnSell)
	...
	var_16_7(var_16_6, var_3.ISLAND_GET_OVERFLOW_ITEM_DOME, arg_16_0.OnSell)
	...
	var_16_9(var_16_8, var_3.ISLAND_INVITE_SHIP_DONE, arg_16_0.OnUseInvitation)
...
function var_0_1.RemoveListeners(arg_17_0)
	...
	var_17_1(var_17_0, var_1_10003.ON_INVENTORY_FILTER, arg_17_0.OnInventoryFilter)
	...
	var_17_3(var_17_2, var_3.ISLAND_UPGRADE_INVENTORY_DONE, arg_17_0.OnUpgrade)
	...
	var_17_5(var_17_4, var_3.ISLAND_CONVERT_SEASON_PT_DONE, arg_17_0.OnSell)
	...
	var_17_7(var_17_6, var_3.ISLAND_GET_OVERFLOW_ITEM_DOME, arg_17_0.OnSell)
	...
	var_17_9(var_17_8, var_3.ISLAND_INVITE_SHIP_DONE, arg_17_0.OnUseInvitation)
...
function var_0_1.OnUpgrade(arg_22_0)
	...
	IslandInventoryUpgradePage = var_1_10003

	var_22_1(var_22_0, var_1_10003)
...
function var_0_1.FlushCapacity(arg_25_0)
	...
	if var_25_0 == var_1_10002.TYPE_MATERIAL then
		...
		setButtonEnabled = var_25_5

		var_25_5(arg_25_0.upgradeBtn, not var_1:IsMaxLevel())

		local var_25_7 = var_25_4 / var_25_6

		math = var_5

		local var_25_8 = var_5.min(var_25_7, 1)
		local var_25_9 = arg_25_0
		local var_25_10 = arg_25_0.managedTween

		LeanTween = var_1_10008

		local var_25_11 = var_1_10008.value
		local var_25_12

		go = var_1_10010

		local var_25_13 = var_25_10(var_25_9, var_25_11, var_25_12, var_1_10010(arg_25_0.upgradeBtn), 0, var_25_7, var_25_8)
		local var_25_14 = var_6.setOnUpdate

		System = var_25_11

		local var_25_15 = var_25_14(var_25_13, var_25_11.Action_float(function(arg_26_0)
		...
		local var_25_16 = var_6.setOnComplete

		System = var_8

		var_25_16(var_25_15, var_8.Action(function()
			local var_27_0 = arg_25_0.capacityTxt

			var_27_0.text = var_25_4 .. "/" .. var_25_6
			setFillAmount = var_27_0

			var_27_0(arg_25_0.upgradeProg, var_25_7)

			return
		end))

		if 0.85 < var_25_7 then
			Color = var_25_17

			local var_25_17

			if not var_25_17.New(0.9529411764705882, 0.4235294117647059, 0.43137254901960786, 1) then
				Color = var_25_17
				var_25_17 = var_25_17.New(0.2235294117647059, 0.7450980392156863, 1, 1)
			end

			local var_25_18 = arg_25_0.upgradeProg
			local var_25_19 = var_7.GetComponent

			typeof = var_9
			Image = var_10
			var_25_19(var_25_18, var_9(var_10)).color = var_25_17
...
function var_0_1.FlushTags(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_1_10001(arg_28_0.toggles) do
		...
		var_1_10006(var_28_0, var_28_1, var_28_2, var_1_10010)

		if iter_28_0 == var_0_1.INVENTORY_TYPE_OVERFLOW then
			setText = var_1_10006

			local var_28_3 = iter_28_1
			local var_28_4 = iter_28_1.Find(var_28_3, "Text")

			i18n = var_28_3

			var_1_10006(var_28_4, var_28_3("island_word_temp"))
		else
			setText = var_1_10006

			local var_28_5 = iter_28_1
			local var_28_6 = iter_28_1.Find(var_28_5, "Text")

			IslandItemKind = var_28_5

			var_1_10006(var_28_6, var_28_5.Type2TagName(iter_28_0))
		end
	end
...
function var_0_1.ActiveDefaultTag(arg_30_0)
	...
	var_30_2(arg_30_0.toggles[var_0_1.INVENTORY_TYPE_OVERFLOW], var_30_3)

	if var_30_3 then
		triggerToggle = var_30_2

		var_30_2(arg_30_0.toggles[var_0_1.INVENTORY_TYPE_OVERFLOW], true)
	else
		triggerToggle = var_30_2
		...
		var_30_2(var_30_4[var_5.TYPE_MATERIAL], true)
	end
...
function var_0_1.FlushFilterBtn(arg_32_0)
	...
	local function var_32_2()
		...
		IslandInventoryIndexPage = var_2_10003

		var_33_3(var_33_2, var_2_10003, var_33_1)
	...
	var_1_10001(var_32_0, var_32_1, var_32_2, var_1_10005)
...
function var_0_1.FlushSortBtn(arg_34_0)
	...
	var_1_10002(var_34_1, var_34_2, var_34_3, var_1_10006)
	var_34_0()
...
function var_0_1.SetTotalCount(arg_40_0)
	...
	local var_40_1 = arg_40_0.GetIndexData(var_40_0, arg_40_0.tagType)

	table = var_40_0

	var_40_0.sort(arg_40_0.displays, function(arg_41_0, arg_41_1)
		local var_41_0 = var_40_1

		return var_2.Sort(var_41_0, arg_41_0, arg_41_1, arg_40_0.asc)
	end)

	local var_40_2 = arg_40_0.scrollRect

	var_2.SetTotalCount(var_40_2, #arg_40_0.displays, -1)
...
function var_0_1.OnInitItem(arg_42_0, arg_42_1)
	...
	var_3(var_42_1, var_42_2, var_42_3, var_1_10007)
	...
	var_3(arg_42_0, var_42_0.valueInput, function(arg_45_0)
		table = var_2_10001
	...
	var_3(var_42_7, var_42_8, var_42_9, var_42_10, var_42_11, var_42_12, var_42_13, var_1_10011)
...
function var_0_1.OnClickItem(arg_47_0, arg_47_1)
	...
	IslandInvitation = var_1_10004

	if var_1_10002(var_47_0, var_1_10004) then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("island_open_ship_tip")
		...
		function var_1_10005.onYes()
			...
			local var_48_3 = var_2_10002.SWITCH_MAP

			IslandConst = var_2_10003

			local var_48_4 = var_2_10003.LABORATORY_MAP_ID

			IslandConst = var_2_10004

			var_48_2(var_48_1, var_48_3, var_48_4, var_2_10004.LETTEROFINVITATION_SP)

			return
		end

		var_47_4(var_47_3, var_1_10005)
	else
		...
		i18n = var_1_10005
		var_47_7.title = var_1_10005("island_word_desc")
		IslandMsgBox = var_5
		var_47_7.type = var_5.TYPE_COMMON_ITEM
...
function var_0_1.UpdataSelAll(arg_52_0)
	...
	for iter_52_2, iter_52_3 in var_52_0(arg_52_0.values) do
...
function var_0_1.UpdateSellPrice(arg_54_0, arg_54_1, arg_54_2)
	...
	local var_54_2 = var_1_10006.max
	local var_54_3 = 0

	math = var_1_10008

	local var_54_4 = var_1_10008.min
	local var_54_5 = var_54_0
	local var_54_6 = arg_54_1.item

	var_54_1[var_3] = var_54_2(var_54_3, var_54_4(var_54_5, var_10.GetCount(var_54_6)))

	local var_54_7 = arg_54_1

	arg_54_1.UpdateValue(var_54_7, arg_54_0.values[var_3])

	local var_54_8 = 0

	ipairs = var_54_7

	for iter_54_0, iter_54_1 in var_54_7(arg_54_0.values) do
		local var_54_9 = arg_54_0.displays[iter_54_0]

		var_54_8 = var_11.GetConvertPt(var_54_9) * iter_54_1 + var_54_8
	end

	arg_54_0.sellPriceTxt.text = "x " .. var_54_8
...
function var_0_1.CollectOverFlowInventoryItems(arg_58_0, arg_58_1)
	...
	local var_58_0 = var_1_10002(var_1_10003)
	...
	for iter_58_0, iter_58_1 in var_58_2(var_58_3) do
		table = var_1_10009
...
function var_0_1.CollectCommonInventoryItems(arg_59_0, arg_59_1)
	...
	local var_59_0 = var_1_10002(var_1_10003)
	...
	for iter_59_0, iter_59_1 in var_59_2(var_59_3) do
		local var_59_4 = arg_59_0.tagType

		IslandItem = var_1_10010

		if var_59_4 == var_1_10010.TYPE_MATERIAL then
			var_1_10010 = iter_59_1

			if iter_59_1.IsMaterial(var_1_10010) then
				local var_59_5 = arg_59_0.indexDatas

				IslandItem = var_1_10010
				var_1_10010 = var_59_5[var_1_10010.TYPE_MATERIAL]

				if var_9.Match(var_1_10010, iter_59_1) then
					table = var_9
		...
		do
			...
			if var_59_6 == var_1_10010.TYPE_PROP then
				...
				if iter_59_1.IsProp(var_1_10010) then
					local var_59_7 = arg_59_0.indexDatas

					IslandItem = var_1_10010
					var_1_10010 = var_59_7[var_1_10010.TYPE_PROP]
			...
			if var_59_8 == var_1_10010.TYPE_SPECIAL_PROP then
				...
				if iter_59_1.IsSpecialProp(var_1_10010) then
					local var_59_9 = arg_59_0.indexDatas

					IslandItem = var_1_10010
					var_1_10010 = var_59_9[var_1_10010.TYPE_SPECIAL_PROP]
	...
	if var_59_10 == var_5.TYPE_SPECIAL_PROP then
		...
		local var_59_11 = var_59_10(var_5)
		...
		for iter_59_2, iter_59_3 in var_59_13(var_59_14) do
			...
			var_1_10013 = var_59_15[var_1_10013.TYPE_SPECIAL_PROP]

			if var_12.Match(var_1_10013, var_1_10011) then
				table = var_12
