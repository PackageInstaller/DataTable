...
function var_0_1.CreateCharacterContainer(arg_6_0)
	...
	var_6_0(var_6_1, var_1_10003.Character3D)
...
function var_0_1.LoadCharacterScene(arg_7_0, arg_7_1)
	...
	var_7_2(var_7_1, var_7_3, var_7_4, var_1_10007.Additive, function(arg_8_0)
		if arg_8_0 == 1 then
			arg_7_1()
		end
...
function var_0_1.ActivityCharacterCamera(arg_10_0)
	...
	local var_10_2 = var_10_0.instance

	IsNil = var_1_10003

	if var_1_10003(var_10_2) then
...
function var_0_1.InitSceneTimeline(arg_11_0)
	...
	if var_1_10001.Find("[sequence]") then
		...
		local var_11_2 = var_11_1(var_11_0, var_1_10004(var_1_10005.Playables.PlayableDirector))

		TimelineSupport = var_11_0

		var_11_0.DynamicBinding(var_11_2)
		var_11_2:Play()
	end
...
function var_0_1.ClearCharacterScene(arg_12_0, arg_12_1)
	if arg_12_0.isLoadCharacterScene then
		...
		var_12_1(var_12_0, var_4.REFRESH_WEATHER_SYSTEM)
	end
...
function var_0_1.LoadCharacter(arg_15_0, arg_15_1, arg_15_2)
	...
	local function var_15_0(arg_16_0, arg_16_1)
		...
		var_16_2(var_16_3, var_2_10004.Character3D)
		...
		var_16_8, GetOrAddComponent = var_4.GetSmoothRotateObject(var_16_7), var_16_7
		typeof = var_7
		SmoothRotateObject = var_8

		local var_16_9 = var_16_7(var_16_8, var_7(var_8))
		...
		local var_16_11, var_16_13

		if arg_16_1 and arg_16_1 ~= "" then
			GetOrAddComponent = var_16_13
			var_16_11 = arg_15_0.role.transform

			local var_16_12 = var_8.GetChild(var_16_11, 0)

			typeof = var_16_11
			Animator = var_10
			var_16_13 = var_16_13(var_16_12, var_16_11(var_10))
		...
		typeof = var_16_11
		CharacterFootprintMgr = var_10

		local var_16_15 = var_16_13(var_16_14, var_16_11(var_10))
...
function var_0_1.UnloadCharacter(arg_21_0, arg_21_1)
	...
	local var_21_2 = arg_21_0:GetSmoothRotateObject()
	local var_21_3 = var_4.GetComponent

	typeof = var_1_10007
	SmoothRotateObject = var_1_10008

	if var_21_3(var_21_2, var_1_10007(var_1_10008)) then
		Object = var_21_2
	...
	if arg_21_0.role then
		local var_21_5 = arg_21_0.displayUnit

		var_6.OnDetach(var_21_5)

		pg = var_6

		local var_21_6 = var_6.ViewUtils.SetLayer
		local var_21_7 = arg_21_0.role.transform

		Layer = var_1_10008

		var_21_6(var_21_7, var_1_10008.Default)

		if arg_21_0.isCommander then
			local var_21_8 = arg_21_0:GetPoolMgr()

			var_6.ReturnCommanderModel(var_21_8, arg_21_0.role)
		elseif arg_21_0:IsPreviewScene() then
			...
			var_6.ReturnCharacter(var_21_9, var_21_0.model, var_21_0.animator, arg_21_0.role)
		end
...
function var_0_1.ResetCameraMask(arg_25_0)
	...
	if arg_25_0.defaultCullingMask and var_25_0 then
		...
		var_3.ResetCamCullingMask(var_25_1, arg_25_0.defaultCullingMask)
	end
...
function var_0_1.ActivityPlayerCamera(arg_26_0)
	...
	var_26_1(var_26_0, var_1_10003.FOLLOW_CAMERA_NAME)
...
function var_0_1.CreateToolContainer(arg_27_0)
	...
	var_27_0(var_27_1, var_1_10003.Default)
