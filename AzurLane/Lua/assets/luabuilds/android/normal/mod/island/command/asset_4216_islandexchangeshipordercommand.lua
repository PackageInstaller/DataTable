...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5.GetShipOrderSlot(var_1_5, var_1_0) then
		return
	end
	...
	var_8.Send(var_1_6, 21431, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.RemoveDelegateSlot(var_2_10003, var_1_1)

			var_2_10003 = var_0

			var_2.AddDelegateSlot(var_2_10003, var_2_4)
			...
			var_2_5(var_2_10003, var_4.ISLAND_EXCHANGE_SHIP_ORDER_DONE, {
				id = var_1_0,
				delegateId = var_1_1
			})
		else
