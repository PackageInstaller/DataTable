...
function var_0_1.OnInit(arg_2_0)
	...
	var_1_10001(var_2_0, var_1_10003("island_draw_reward"))
...
function var_0_1.UpdateActivity(arg_5_0, arg_5_1)
	...
	var_1_10002(arg_5_0.rtRarities, function(arg_6_0, arg_6_1)
		...
		local var_6_4 = arg_6_0.Find(var_6_3, "title/Text")

		i18n = var_6_3

		var_6_1(var_6_4, var_6_3("island_draw_" .. var_6_0))

		UIItemList = var_6_1

		var_6_1.StaticAlign(arg_6_0:Find("container"), arg_6_0:Find("container/tpl"), #var_6_2, function(arg_7_0, arg_7_1, arg_7_2)
			arg_7_1 = arg_7_1 + 1
			...
			if arg_7_0 == var_3_10003.EventUpdate then
				...
				local var_7_2 = var_3_10005.island_draw_reward[var_7_0]
				...
				var_7.ShowDropInfo(var_7_3, arg_7_2:Find("mask/Image"))
				...
				local var_7_5 = arg_7_2.Find(var_7_4, "got/got/Text")

				i18n = var_7_4

				var_7(var_7_5, var_7_4("island_draw_get"))
