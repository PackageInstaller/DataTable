...
function var_0_1.LoadCharacterScene(arg_6_0, arg_6_1)
	...
	var_6_2(var_6_1, var_6_3, var_6_4, var_1_10007.Additive, function(arg_7_0)
		if arg_7_0 == 1 then
...
function var_0_1.CreateCharacterContainer(arg_8_0)
	...
	var_8_0(var_8_1, var_1_10003.Character3D)
...
function var_0_1.ActivityCharacterCamera(arg_10_0)
	...
	local var_10_3 = var_2.GetVirtualCamera(var_10_2, var_10_1)

	var_10_3.Follow = arg_10_0.roleContainer
	var_10_3.LookAt = arg_10_0.roleContainer
	IslandCameraMgr = var_3

	local var_10_4 = var_3.instance

	var_3.ActiveVirtualCamera(var_10_4, var_10_1)
...
function var_0_1.LoadCharacter(arg_16_0, arg_16_1)
	...
	var_2.GetCommanderModel(var_16_0, arg_16_1, function(arg_17_0)
		...
		var_17_1(var_17_2, var_2_10003.Character3D)
		...
		Vector3 = var_2
		var_17_3.eulerAngles = var_2(0, 180, 0)
		...
		local var_17_11 = var_7.GetActiveCamName(var_17_10)

		Vector3 = var_17_10

		var_17_9(var_17_8, var_17_11, var_17_10(var_17_7 - var_17_6, 1, 0))

		local var_17_12 = arg_16_0.role.transform

		Vector3 = var_17_8
		var_17_12.localPosition = var_17_8(0, 0, 0)

		local var_17_13 = arg_16_0
		local var_17_14

		var_17_14, GetOrAddComponent = var_5.GetSmoothRotateObject(var_17_13), var_17_13
		typeof = var_8
		SmoothRotateObject = var_9

		local var_17_15 = var_17_13(var_17_14, var_8(var_9))
		...
		typeof = var_10
		CharacterFootprintMgr = var_11

		local var_17_18 = var_8(var_17_17, var_10(var_11))
...
function var_0_1.UnloadCharacter(arg_18_0)
	...
	typeof = var_1_10004
	SmoothRotateObject = var_1_10005

	if var_18_1(var_18_0, var_1_10004(var_1_10005)) then
		Object = var_18_0
	...
	if arg_18_0.role then
		...
		var_3.ReturnCommanderModel(var_18_2, arg_18_0.role)
