...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.codeTxt = var_2_6(var_2_5, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.codeRefreshTxt = var_2_11(var_2_10, var_3(var_1_10004))
	...
	local var_2_15 = var_2.Find(var_2_14, "frame/title/Text")

	i18n = var_2_14

	var_1(var_2_15, var_2_14("island_open_settings"))

	setText = var_1

	local var_2_16 = arg_2_0._tf
	local var_2_17 = var_2.Find(var_2_16, "frame/on_panel/friend/Text")

	i18n = var_2_16

	var_1(var_2_17, var_2_16("island_friend"))

	setText = var_1

	local var_2_18 = arg_2_0._tf
	local var_2_19 = var_2.Find(var_2_18, "frame/on_panel/guild/Text")

	i18n = var_2_18

	var_1(var_2_19, var_2_18("island_guild"))

	setText = var_1

	local var_2_20 = arg_2_0._tf
	local var_2_21 = var_2.Find(var_2_20, "frame/on_panel/code/Text")

	i18n = var_2_20

	var_1(var_2_21, var_2_20("island_code"))

	setText = var_1

	local var_2_22 = arg_2_0._tf
	local var_2_23 = var_2.Find(var_2_22, "frame/on_tip/Text")

	i18n = var_2_22

	var_1(var_2_23, var_2_22("island_open_settings_tip1"))

	setText = var_1

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_2.Find(var_2_24, "frame/off_tip/Text")

	i18n = var_2_24

	var_1(var_2_25, var_2_24("island_open_settings_tip2"))

	setText = var_1

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_2.Find(var_2_26, "frame/code_panel/copy/Text")

	i18n = var_2_26

	var_1(var_2_27, var_2_26("island_btn_label_copy"))

	setText = var_1

	local var_2_28 = arg_2_0._tf
	local var_2_29 = var_2.Find(var_2_28, "frame/toggle/on/Text")

	i18n = var_2_28

	var_1(var_2_29, var_2_28("island_visit_on"))

	setText = var_1

	local var_2_30 = arg_2_0._tf
	local var_2_31 = var_2.Find(var_2_30, "frame/toggle/off/Text_1")

	i18n = var_2_30

	var_1(var_2_31, var_2_30("island_visit_on"))

	setText = var_1

	local var_2_32 = arg_2_0._tf
	local var_2_33 = var_2.Find(var_2_32, "frame/toggle/on/Text_2")

	i18n = var_2_32

	var_1(var_2_33, var_2_32("island_visit_off"))

	setText = var_1

	local var_2_34 = arg_2_0._tf
	local var_2_35 = var_2.Find(var_2_34, "frame/toggle/off/Text")

	i18n = var_2_34

	var_1(var_2_35, var_2_34("island_visit_off"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		var_4_1(var_4_0, var_2_10002.REFRESH_INVITECODE, false)
	...
	local function var_3_5()
		...
		IslandFriendPage = var_2_10002

		local var_5_2 = var_2_10002.EVENT_MSG

		i18n = var_2_10003

		var_5_1(var_5_0, var_5_2, var_2_10003("island_open_settings_tip3"))
	...
	local function var_3_8()
		...
		var_6_1(var_6_0, var_2_10002("friend_id_copy_ok"))
...
function var_0_1.InitToggles(arg_10_0)
	...
	local var_10_1 = var_1_10003.contains
	local var_10_2 = arg_10_0.openFlags

	IslandConst = var_1_10005

	var_1_10001(var_10_0, var_10_1(var_10_2, var_1_10005.OPEN_ALL))
	...
	local var_10_4 = var_3.contains
	local var_10_5 = arg_10_0.openFlags

	IslandConst = var_5

	var_1_10001(var_10_3, not var_10_4(var_10_5, var_5.OPEN_FRIEND))
	...
	local var_10_7 = var_3.contains
	local var_10_8 = arg_10_0.openFlags

	IslandConst = var_5

	var_1_10001(var_10_6, not var_10_7(var_10_8, var_5.OPEN_GUILD))
	...
	local var_10_10 = var_3.contains
	local var_10_11 = arg_10_0.openFlags

	IslandConst = var_5

	var_1_10001(var_10_9, var_10_10(var_10_11, var_5.OPEN_CODE))
	...
	local var_10_14 = var_3.contains
	local var_10_15 = arg_10_0.openFlags

	IslandConst = var_5

	var_10_13(var_10_12, var_10_14(var_10_15, var_5.OPEN_CODE))
	...
	var_10_13(arg_10_0, arg_10_0.toggle, function(arg_11_0)
		if arg_11_0 then
			...
			var_2_10001(var_11_0, var_2_10003.OPEN_ALL)
			...
			var_11_2(var_11_3, var_2_10003.OPEN_ALL)
	...
	local function var_10_18(arg_12_0)
		if arg_12_0 then
			...
			var_2_10001(var_12_0, var_2_10003.OPEN_FRIEND)
		else
			table = var_2_10001
			...
			var_12_1(var_12_2, var_2_10003.OPEN_FRIEND)
		end
	...
	var_10_13(var_10_16, var_10_17, var_10_18, var_5)
	...
	local function var_10_21(arg_13_0)
		if arg_13_0 then
			...
			var_2_10001(var_13_0, var_2_10003.OPEN_GUILD)
		else
			table = var_2_10001
			...
			var_13_1(var_13_2, var_2_10003.OPEN_GUILD)
		end
	...
	var_10_13(var_10_19, var_10_20, var_10_21, var_5)
	...
	local function var_10_24(arg_14_0)
		if arg_14_0 then
			...
			var_2_10001(var_14_0, var_2_10003.OPEN_CODE)
			...
			if not arg_10_0.inviteCode or arg_10_0.inviteCode == "" then
				...
				var_2_10001(var_14_1, var_2_10003.REFRESH_INVITECODE, true)
			end
		else
			table = var_2_10001
			...
			var_14_2(var_14_3, var_2_10003.OPEN_CODE)
		end
	...
	var_10_13(var_10_22, var_10_23, var_10_24, var_5)
...
function var_0_1.UpdateRefreshBtn(arg_15_0)
	...
	i18n = var_1_10004
	var_15_4.text = var_1_10004("island_code_refresh_cnt", var_15_3)
...
function var_0_1.Send(arg_17_0)
	...
	local var_17_2 = var_1_10003(var_1_10004)
	...
	for iter_17_0, iter_17_1 in var_1_10006(var_17_6) do
		table = var_1_10011
	...
	if #var_17_0 > 0 or #var_17_1 > 0 then
		...
		var_17_8(var_17_7, var_8.SET_ACCESS_FLAG, var_17_0, var_17_1)
	end
