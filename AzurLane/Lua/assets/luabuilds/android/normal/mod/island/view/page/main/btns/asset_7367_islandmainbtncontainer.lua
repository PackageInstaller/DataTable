...
function var_0_0.InitBtns(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_2_1(var_2_0) do
		pg = var_1_10007
		var_1_10007 = var_1_10007.island_main_btns[iter_2_1]
		table = var_1_10008

		var_1_10008.insert(arg_2_0.unlockIds, var_1_10007.ability_id)

		var_1_10008 = var_1_10007.btn_name

		local var_2_4

		if var_0_0.SPECIAL_BTN[var_1_10008] then
			local var_2_3 = var_0_0.SPECIAL_BTN[var_1_10008]

			var_2_4 = arg_2_0.btns
			_G = var_1_10011
			var_1_10011 = var_1_10011[var_2_3].New

			local var_2_5 = arg_2_0._tf

			var_2_4[var_1_10008] = var_1_10011(var_12.Find(var_2_5, var_1_10008), arg_2_0.event, iter_2_1)
		else
			local var_2_6 = arg_2_0.btns

			IslandMainBaseBtn = var_2_4

			local var_2_7 = var_2_4.New

			cloneTplTo = var_1_10011
			var_2_6[var_1_10008] = var_2_7(var_1_10011(arg_2_0.tpl, arg_2_0._tf), arg_2_0.event, iter_2_1)
		end

		local var_2_8 = arg_2_0.btns[var_1_10008]

		var_9.SetAsLastSibling(var_2_8)
	end
