...
function var_0_1.OnCoreInitFinish(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.INIT_FINISH, arg_3_0.sceneData.camreaZoomData)
	...
	var_3_3(var_3_2, var_3.INIT_FINISH)
...
function var_0_1.AddListeners(arg_5_0)
	...
	IslandCheaterTavernMonitor = var_1_10003

	var_5_1(var_5_0, var_1_10003.ADD_CHEATERTAVERN_PLAYER, arg_5_0.OnAddCheaterPlayer)
	...
	var_5_3(var_5_2, var_3.INIT_PLAYER_DATA_DONE, arg_5_0.OnInitPlayerDone)

	local var_5_4 = arg_5_0
	local var_5_5 = arg_5_0.AddIslandListener

	PlayRoomExitRoomCommand = var_3

	var_5_5(var_5_4, var_3.PLAY_ROOM_EXIT_ROOM_DONE, arg_5_0.OnRoomExitRoom)
	...
	var_5_7(var_5_6, var_3.LINK_CORE, arg_5_0.OnLinkCore)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.ADD_CHEATERTAVERN_PLAYER, arg_6_0.OnAddCheaterPlayer)
	...
	var_6_3(var_6_2, var_3.INIT_PLAYER_DATA_DONE, arg_6_0.OnInitPlayerDone)
	...
	var_6_5(var_6_4, var_3.PLAY_ROOM_EXIT_ROOM_DONE, arg_6_0.OnRoomExitRoom)
	...
	var_6_7(var_6_6, var_3.LINK_CORE, arg_6_0.OnLinkCore)
...
function var_0_1.OnInitPlayerDone(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10003.INITPLAYER_DATA_DONE)
...
function var_0_1.OnRoomExitRoom(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10003.PLAY_ROOM_EXIT_ROOM_DONE)
