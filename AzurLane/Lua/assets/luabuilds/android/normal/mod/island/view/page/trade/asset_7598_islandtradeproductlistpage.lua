...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "shopView/Viewport/Content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiitemList = var_2_0(var_2_2, var_3.Find(var_2_3, "shopView/Viewport/Content/tpl"))
...
function var_0_1.GetDisplays(arg_4_0)
	...
	var_4_2.id = var_1_10004.PEARL_ID
...
function var_0_1.UpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_1 = arg_8_1.Find(var_8_0, "item")
	...
	var_8_3.type = var_7
	var_8_3.id = arg_8_2.id

	var_1_10003(var_8_1, var_8_2(var_8_3))
	...
	var_1_10003(arg_8_1:Find("cost/num"), arg_8_0:GetPrice())
	...
	var_1_10003(var_8_4, var_8_5, var_8_6, var_7)
...
function var_0_1.OnClick(arg_10_0)
	...
	IslandTradePage = var_1_10003

	local var_10_2 = var_1_10003.OPEN_CONFIRM_PAGE

	IslandConst = var_1_10004

	var_10_1(var_10_0, var_10_2, var_1_10004.TRADE_PURCHASE)
