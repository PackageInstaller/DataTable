	...
	var_3.Send(var_1_2, 21006, {
		...
		if arg_2_0.result == 0 then
			...
			if 0 < var_2_0 then
				...
				local var_2_1 = var_2.GetIsland(var_2_10003)

				var_2_10003 = var_2.GetInventoryAgency(var_2_1)
				ipairs = var_2_1

				for iter_2_0, iter_2_1 in var_2_1(arg_2_0.item_list) do
					local var_2_2 = {}

					DROP_TYPE_ISLAND_ITEM = var_2_10010
					var_2_2.type = var_2_10010
					var_2_2.id = iter_2_1.id
					var_2_2.count = iter_2_1.num

					var_2_10003:RemoveOverflowItem(iter_2_1.id, iter_2_1.num)

					table = var_2_10010

					var_2_10010.insert(var_2_0, var_2_2)
				end

				IslandDropHelper = var_4

				local var_2_3 = var_4.AddItems({
					drop_list = var_2_0
				})
				...
				var_2_5(var_2_4, iter_2_0.ISLAND_GET_OVERFLOW_ITEM_DOME, {
