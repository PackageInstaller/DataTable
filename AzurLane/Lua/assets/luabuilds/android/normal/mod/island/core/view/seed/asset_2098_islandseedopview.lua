...
function var_0_1.OnInit(arg_2_0, arg_2_1)
	...
	arg_2_0.uiSeedItemList = var_2_2(var_2_4, var_4.Find(var_2_5, "content/itemSeed"))
	onButton = var_2
	...
	var_2(var_2_6, var_2_7, var_2_8, var_6)
...
function var_0_1.ActiveSeedSelect(arg_5_0, arg_5_1)
	if arg_5_1 then
		...
		local var_5_1 = var_1_10002(var_5_0, var_1_10004)

		var_1_10002 = var_1_10002.GetSeedBtnWorldPos(var_5_1)
		GameObject = var_5_1

		local var_5_2 = var_5_1.Find("UICamera")
		local var_5_3 = var_3.GetComponent

		typeof = var_1_10005
		Camera = var_1_10006

		local var_5_4 = var_5_3(var_5_2, var_1_10005(var_1_10006))
		local var_5_5 = var_3.WorldToScreenPoint(var_5_4, var_1_10002)

		LuaHelper = var_5_4

		local var_5_6 = var_5_4.ScreenToLocal(arg_5_0._tf, var_5_5, var_3)
...
function var_0_1.RefreshSeedPlane(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_6_0.island_production_slot[var_6_1].place

	pg = var_1_10004

	local var_6_3 = var_1_10004.island_production_place[var_6_2].seed_list

	getProxy = var_1_10005
	IslandProxy = var_1_10006

	local var_6_4 = var_1_10005(var_1_10006)
	...
	for iter_6_0, iter_6_1 in var_1_10007(var_6_3) do
		pg = var_1_10012
		var_1_10012 = var_1_10012.island_farm_seed[iter_6_1].itemid

		local var_6_8 = var_6_6

		if var_6_6.GetItemById(var_6_8, var_1_10012) then
			table = var_6_8

			var_6_8.insert(var_6_7, iter_6_1)
		end
	end
	...
	local var_6_10 = 30
	local var_6_11 = 40
	local var_6_12 = arg_6_0.seedSelectPlane
	local var_6_13 = var_10.Find(var_6_12, "content")
	local var_6_14 = var_10.GetComponent

	typeof = var_12
	GridLayoutGroup = var_1_10013

	local var_6_15 = var_6_14(var_6_13, var_12(var_1_10013)).cellSize.x
	local var_6_16 = var_10.cellSize.y

	math = var_1_10013

	local var_6_17 = var_1_10013.min(var_6_9, 7)

	math = var_14

	local var_6_18 = var_14.ceil(var_6_9 / 7)
	local var_6_19 = var_6_15 * var_6_17 + var_10.spacing.x * (var_6_17 - 1) + var_10.padding.right + var_6_11
	local var_6_20 = var_6_16 * var_6_18 + var_10.spacing.y * (var_6_18 - 1) + var_10.padding.bottom + var_6_10
	local var_6_21 = arg_6_0.seedSelectPlane
	local var_6_22 = var_17.Find(var_6_21, "content")

	Vector2 = var_6_21
	var_6_22.sizeDelta = var_6_21(var_6_19, var_6_20)

	local var_6_23 = arg_6_0.uiSeedItemList

	var_17.make(var_6_23, function(arg_7_0, arg_7_1, arg_7_2)
		...
		if arg_7_0 == var_2_10003.EventUpdate then
			...
			updateCustomDrop = var_7_2

			local var_7_4 = arg_7_2

			Drop = var_2_10008

			local var_7_5 = var_2_10008.New
			local var_7_6 = {}

			DROP_TYPE_ISLAND_ITEM = var_2_10010
			var_7_6.type = var_2_10010
			var_7_6.id = var_7_3.id

			local var_7_7 = var_7_3

			var_7_6.count = var_7_3.GetCount(var_7_7)

			var_7_2(var_7_4, var_7_5(var_7_6))
			...
			local function var_7_11()
				...
				local var_8_5 = var_8_4(var_8_3, var_2)
			...
			var_7_4(var_7_9, var_7_10, var_7_11, var_7_7)

			GetOrAddComponent = var_7_4

			local var_7_12 = arg_7_2

			typeof = var_7_10
			UILongPressTrigger = var_7_11

			local var_7_13 = var_7_4(var_7_12, var_7_10(var_7_11)).onLongPressed

			var_8.AddListener(var_7_13, function()
				var_7_8 = true
				...
				local var_9_2 = var_1.Find(var_9_1, "bg/itemSeed/icon_bg/count_bg/count")
				local var_9_3 = var_7_3

				var_9_0(var_9_2, var_2.GetCount(var_9_3))

				local var_9_4 = var_7_3
				local var_9_5 = var_0.GetIcon(var_9_4)

				GetImageSpriteFromAtlasAsync = var_9_4

				local var_9_6 = "island/" .. var_9_5
				local var_9_7 = ""
				local var_9_8 = arg_6_0.seed_detals

				var_9_4(var_9_6, var_9_7, var_4.Find(var_9_8, "bg/itemSeed/icon_bg/icon"))

				local var_9_9 = arg_6_0.seed_detals
				local var_9_10

				var_9_10, setText = var_1.Find(var_9_9, "bg/detaiView/Viewport/detaiViewText"), var_9_9

				local var_9_11 = var_7_3

				var_9_9(var_9_10, var_4.GetDesc(var_9_11))

				setText = var_9_9

				local var_9_12 = arg_6_0.seed_detals
				local var_9_13 = var_3.Find(var_9_12, "bg/seedName")
				local var_9_14 = var_7_3

				var_9_9(var_9_13, var_4.GetName(var_9_14))
	...
	local var_6_24 = arg_6_0.uiSeedItemList

	var_17.align(var_6_24, var_6_9)
...
function var_0_1.CheckSeedEmpty(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_10_0.island_production_slot[var_10_1].place

	pg = var_1_10004

	local var_10_3 = var_1_10004.island_production_place[var_10_2].seed_list

	getProxy = var_1_10005
	IslandProxy = var_1_10006

	local var_10_4 = var_1_10005(var_1_10006)
	...
	if var_6.GetInt("island_last_selectItemId" .. var_10_2, 0) ~= 0 then
		pg = var_10_7
		var_10_7 = var_10_7.island_farm_seed[var_6].itemid

		if var_10_6:GetOwnCount(var_10_7) > 0 then
	...
	for iter_10_0, iter_10_1 in var_10_7(var_10_3) do
		pg = var_1_10012
