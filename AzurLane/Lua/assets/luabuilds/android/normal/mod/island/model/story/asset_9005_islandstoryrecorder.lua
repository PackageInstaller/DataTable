...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("Mgr.Story.model.Record.StoryRecorder"))
...
function var_0_1.Collect3DDialogueContent(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_5 = var_1_10008.insert
	...
	local var_2_9 = arg_2_0:FormatContent(var_2_0)
	local var_2_10
	...
	var_2_8[1] = var_1_10012(var_2_9, var_2_10)
