...
function var_0_1.OnStart(arg_2_0)
	...
	var_2_1(var_2_0, var_2_2, var_1_10004(arg_2_0.id))
...
function var_0_1.MoveHandle(arg_7_0)
	...
	local var_7_6 = var_7_3 - arg_7_0.GetLocalPosition(var_7_5)

	Time = var_7_5

	local var_7_7 = var_7_6 / var_7_5.deltaTime

	Vector2 = var_6
	arg_7_0.speed = var_6(var_7_7.x, var_7_7.z).magnitude
...
function var_0_1.AnimHandle(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10004.SPEED_FLAG_HASH, arg_8_0.speed)
