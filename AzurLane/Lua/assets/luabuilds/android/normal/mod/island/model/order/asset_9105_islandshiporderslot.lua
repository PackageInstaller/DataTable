...
function var_0_0.FillDelegate(arg_4_0, arg_4_1)
	...
	var_4_3(var_4_2, var_1_10006(var_4_0))
...
function var_0_0.GetNextRefreshFinishCntTime(arg_12_0)
	...
	local var_12_3 = var_4.TimeMgr.GetInstance()
	...
	if not var_12_3.detect(var_12_2, function(arg_14_0)
		return arg_14_0 > var_12_4
	end) then
		::label_12_0::

		GetZeroTime = var_12_5
		var_12_5 = var_12_5() + var_12_1[1]
	end
