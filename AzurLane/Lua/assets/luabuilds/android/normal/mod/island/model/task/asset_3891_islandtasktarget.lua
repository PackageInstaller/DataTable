...
function var_0_1.GetProgress(arg_9_0)
	...
	IslandTaskTargetType = var_9_0

	local var_9_2

	if var_9_1 == var_9_0.TASK_DAILY_IN_WEEK then
		var_9_2 = arg_9_0.progress
		IslandTaskHelper = var_1_10003

		return var_9_2 + var_1_10003.GetRuntimeData(var_9_1, arg_9_0:GetTargetParam())
	end
	...
	if var_9_3(var_1_10003.GetRuntimeTypes(), var_9_1) then
