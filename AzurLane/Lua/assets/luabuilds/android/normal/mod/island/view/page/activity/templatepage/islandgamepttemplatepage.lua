...
function var_0_1.BuildAllTask(arg_2_0)
	...
	var_1.each(arg_2_0.config.task_id, function(arg_3_0)
		...
		var_3_2.insert(arg_2_0.taskList, var_3_3)
...
function var_0_1.GetFirstUncompletedTaskIndex(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10001(arg_4_0.taskList) do
		...
		var_1_10007 = var_1_10006.GetIsland(var_1_10007)
		var_1_10007 = var_1_10006.GetTaskAgency(var_1_10007)

		if not var_1_10006.IsFinishTask(var_1_10007, iter_4_1.id) then
			return iter_4_0
		end
	end
...
function var_0_1.OnFirstFlush(arg_7_0)
	...
	var_1(var_7_1, var_7_0("island_activity_pt_got_all"))
	...
	var_1(var_7_2, var_3("island_activity_pt_point"))
	...
	var_1(var_7_3, var_3("island_activity_pt_get_oneclick"))
	...
	local function var_7_6()
		...
		var_8_2(var_8_1, var_2_10003.ON_SUBMIT_TASK_ONE_STEP, var_0, function()
	...
	var_1.each(arg_7_0.config.btn_param, function(arg_10_0)
		...
		local var_10_0 = var_1
		local var_10_1 = var_1.Find(var_10_0, "Text")

		i18n = var_10_0

		var_2(var_10_1, var_10_0(arg_10_0[2]))

		onButton = var_2

		local var_10_2 = arg_7_0
		local var_10_3 = var_1
		...
		local function var_10_4()
			...
			var_11_1(var_11_0, var_3_10002.OPEN_PAGE, arg_10_0[3][1], arg_10_0[3][2])
		...
		var_2(var_10_2, var_10_3, var_10_4, var_2_10006)

		local var_10_5 = arg_7_0
		local var_10_6 = var_2.CheckBtnSkip
		local var_10_7 = var_1
		local var_10_8
	...
	function arg_7_0.scrollCom.onUpdateItem(arg_12_0, arg_12_1)
		...
		var_12_1(var_12_0, var_12_2, var_2_10005(arg_12_1))
...
function var_0_1.CheckBtnSkip(arg_13_0, arg_13_1, arg_13_2)
	...
	return var_1_10005(var_13_0, {
		function()
			...
			local var_14_1 = var_2_10001(var_2_10002)
			local var_14_2 = var_1.getActivityById(var_14_1, var_14_0)

			setActive = var_14_1

			var_14_1(arg_13_1, var_14_2 and not var_14_2:isEnd())
...
function var_0_1.OnUpdateFlush(arg_19_0)
	...
	local var_19_2 = arg_19_0.GetFirstUncompletedTaskIndex(var_19_1)
	...
	var_19_1(function()
		...
		var_20_1(var_20_0, var_2.HeadIndexToValue(var_20_2, var_19_2 - 1))

		return
	end)

	local var_19_3 = #arg_19_0:GetAllAvailableTaskIds()
	local var_19_4 = 0 < var_19_3

	setActive = var_3

	local var_19_5 = arg_19_0.getButton

	var_3(var_4.Find(var_19_5, "red"), var_19_4)

	setGray = var_3

	var_3(arg_19_0.getButton, not var_19_4, true)
...
function var_0_1.UpdateTaskList(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_2 = var_1_10005(var_1_10006)
	...
	local var_21_6 = var_21_1:GetTargetList()[1]
	local var_21_7 = var_21_1
	local var_21_8

	if var_21_1.IsFinish(var_21_7) then
		var_21_8 = not var_21_5
	end

	setText = var_21_7

	var_21_7(arg_21_2:Find("bg/name"), var_21_1:GetName())

	setText = var_21_7

	var_21_7(arg_21_2:Find("bg/count"), var_21_6:GetProgress() .. "/" .. var_21_6:GetTargetNum())

	setText = var_21_7

	var_21_7(arg_21_2:Find("bg/desc"), var_21_6:GetName())

	local var_21_9 = var_21_1:GetAwards()
	local var_21_10 = arg_21_2
	local var_21_11 = arg_21_2.Find(var_21_10, "bg/items")

	UIItemList = var_21_10

	var_21_10.StaticAlign(var_21_11, var_21_11:Find("IslandItemTpl"), #var_21_9, function(arg_22_0, arg_22_1, arg_22_2)
		UIItemList = var_2_10003

		if arg_22_0 == var_2_10003.EventUpdate then
			local var_22_0 = var_21_9[arg_22_1 + 1]
			...
			local function var_22_3()
				...
				local var_23_2 = var_3_10002.SHOW_MSG_BOX
				local var_23_3 = {}

				i18n = var_3_10004
				var_23_3.title = var_3_10004("island_word_desc")
				IslandMsgBox = var_4
				var_23_3.type = var_4.TYPE_COMMON_DROP_DESCRIBE
	...
	local var_21_13 = arg_21_2:Find("get")
	...
	local function var_21_14()
		...
		var_24_1(var_24_0, var_2_10002.ON_SUBMIT_TASK, var_21_0, function()
	...
	var_10(var_21_12, var_21_13, var_21_14, var_14)
...
function var_0_1.GetShowImportInfo(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10003(var_27_3) do
...
function var_0_1.UpdateImport(arg_28_0)
	...
	var_1_10003(arg_28_0.importGot, var_28_1)

	setImageAlpha = var_1_10003

	var_1_10003(arg_28_0.importIcon, var_28_1 and 0.6 or 1)

	local var_28_2 = arg_28_0.config.import[var_28_0]

	GetImageSpriteFromAtlasAsync = var_4

	var_4(arg_28_0:GetAtlasName(), var_28_0, arg_28_0.importIcon, true)

	setText = var_4

	local var_28_3 = arg_28_0.goTipText

	i18n = var_6

	var_4(var_28_3, var_6(var_28_2[2]))

	IslandTask = var_4

	local var_28_4 = var_4.GetAwardsStatic(var_28_2[1])

	onButton = var_5

	local var_28_5 = arg_28_0
	local var_28_6 = arg_28_0.viewButton

	local function var_28_7()
		if not var_28_4[1] then
			return
		end
		...
		local var_29_2 = var_2_10002.SHOW_MSG_BOX
		local var_29_3 = {}

		i18n = var_2_10004
		var_29_3.title = var_2_10004("island_word_desc")
		IslandMsgBox = var_4
		var_29_3.type = var_4.TYPE_COMMON_DROP_DESCRIBE
		var_29_3.dropData = var_28_4[1]
	...
	var_5(var_28_5, var_28_6, var_28_7, var_1_10009)
...
function var_0_1.GetTipKey(arg_31_0)
	...
	local var_31_3 = var_1_10004(var_1_10005)
...
function var_0_1.ShouldFirstTip(arg_32_0)
	...
	return var_2.GetInt(var_32_0, 0) == 0
end
