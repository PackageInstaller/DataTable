...
function var_0_1.SubViewInit(arg_3_0)
	...
	IslandHudView = var_1_10003

	var_3_0(var_3_1, var_1_10003.New(arg_3_0.view))
...
function var_0_1.OnLateUpdate(arg_5_0)
	...
	Time = var_2
	arg_5_0.time = var_5_0 + var_2.deltaTime
...
function var_0_1.CheckAnimationOpDistance(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in var_1_10002(arg_6_0.animationOpShowFlags) do
		...
		local var_6_2 = arg_6_0:GetView()

		if var_9.GetUnitModuleWithType(var_6_2, var_6_1.type, var_6_1.id) then
			Vector3 = var_6_2

			local var_6_3 = var_6_2.Distance(arg_6_1._go.transform.position, var_9._go.transform.position) <= arg_6_0.animationOpShowDistance

			isActive = var_11

			local var_6_4 = var_11(var_6_0)

			setActive = var_12

			var_12(var_6_0, var_6_3)
...
function var_0_1.PlayAnimationOpEffect(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	local var_7_3 = var_7_2(var_7_1, var_1_10008(var_1_10009))
	local var_7_4 = var_5
	...
	local var_7_6 = var_7_5(var_7_4, var_1_10009(var_1_10010))
...
function var_0_1.CheckChatBubbleDistance(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in var_1_10002(arg_9_0.chatPlayers) do
		...
		if iter_9_1.IsPlaying(var_9_0) and arg_9_1.role then
			Vector3 = var_9_0

			local var_9_1 = var_9_0.Distance(arg_9_1._go.transform.position, var_7._go.transform.position) <= arg_9_0.chatBubbleShowDistance

			iter_9_1:SetShowFlag(var_9_1)
		end
	end
...
function var_0_1.PlayChat(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	if not arg_11_0.chatPlayers[var_11_0.key] then
		...
		Object = var_8
		var_11_5 = var_11_5(var_8.Instantiate(arg_11_0.chatTpl, var_11_4), arg_11_1._go)
	end
...
function var_0_1.RawPlayBubble(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	IslandStory = var_1_10008

	local var_13_4 = var_13_1(var_13_2, var_13_3, var_1_10008.MODE_BUBBLE)

	arg_13_0:TryHidePlayerChat()

	local var_13_5 = var_13_4

	if var_13_4.ContainerPlayer(var_13_5) then
		table = var_6
	...
	for iter_13_0, iter_13_1 in var_13_5(var_13_4.steps) do
		local var_13_7 = iter_13_1:GetUnitData()
		local var_13_8 = arg_13_0:GetUnitHudRoot(var_13_7)
		local var_13_9 = var_13.Find(var_13_8, "bubleContainer")
		local var_13_10 = arg_13_0:GetView()
		local var_13_11 = var_14.GetUnitModuleWithType(var_13_10, var_13_7.type, var_13_7.id)
		...
		var_13_10.insert(var_13_6, function(arg_14_0)
			local var_14_0

			if not arg_13_0.bubblePlayers[var_13_7.key] then
				IslandChatBubblePlayer = var_14_0
				var_14_0 = var_14_0.New
				Object = var_2
				var_14_0 = var_14_0(var_2.Instantiate(arg_13_0.chatTpl, var_13_9), var_13_11._go)
			end

			var_14_0:Play(iter_13_1, arg_14_0)

			arg_13_0.bubblePlayers[var_13_7.key] = var_14_0
	...
	arg_13_0.bubbleTasks[arg_13_1.id] = var_13_6
...
function var_0_1.RawStopBubble(arg_18_0, arg_18_1)
	...
	local var_18_3 = var_18_1(var_18_2, var_4, var_1_10005.MODE_BUBBLE)

	ipairs = var_18_2

	for iter_18_0, iter_18_1 in var_18_2(var_18_3.steps) do
...
function var_0_1.ShowAnimationOp(arg_19_0, arg_19_1, arg_19_2)
	...
	local function var_19_7()
		...
		if not var_0.CanReponseAnimationOp(var_20_0, arg_19_1, arg_19_2) then
			...
			var_20_2(var_20_1, var_2("island_position_cant_response_cp_action"))
		...
		IslandBaseMediator = var_2

		var_20_4(var_20_3, var_2.ANIMATION_OP, arg_19_1.id, arg_19_2)
	...
	var_19_4(var_19_5, var_19_6, var_19_7, var_1_10010)
...
function var_0_1.CanReponseAnimationOp(arg_21_0, arg_21_1, arg_21_2)
	...
	local var_21_2 = var_21_0.island_action[arg_21_2]

	BuildVector3 = var_1_10005

	local var_21_3 = var_1_10005(var_21_2.respond_point).magnitude

	IslandCalcUtil = var_1_10007

	return var_1_10007.CanReachPoint(var_21_1._go.transform.position, var_21_3, arg_21_1.agent, arg_21_1._tf.position, 36)
end
...
function var_0_1.HideAnimationOp(arg_22_0, arg_22_1)
	...
	local var_22_4 = var_22_3(var_22_2, var_1_10007(var_1_10008))
	...
	local var_22_7 = var_22_6(var_22_5, var_1_10008(var_1_10009))
...
function var_0_1.ShowHud(arg_24_0, arg_24_1)
	...
	local var_24_2 = arg_24_0.GetUnitHudRoot
	local var_24_3 = arg_24_0
	local var_24_4 = var_24_2(var_24_1, arg_24_0.GenUnitData(var_24_3, arg_24_1.id, arg_24_1.type))
	local var_24_5 = var_3.Find(var_24_4, var_24_0)
	local var_24_6 = arg_24_0
	local var_24_7 = arg_24_0.GetSubView

	IslandHudView = var_24_3

	local var_24_8 = var_24_7(var_24_6, var_24_3)

	var_4.ShowHud(var_24_8, arg_24_1, var_24_5)
...
function var_0_1.RefreshHud(arg_25_0, arg_25_1)
	...
	local var_25_2 = arg_25_0.GetUnitHudRoot
	local var_25_3 = arg_25_0
	local var_25_4 = var_25_2(var_25_1, arg_25_0.GenUnitData(var_25_3, arg_25_1.id, arg_25_1.type))
	local var_25_5 = var_3.Find(var_25_4, var_25_0)
	local var_25_6 = arg_25_0
	local var_25_7 = arg_25_0.GetSubView

	IslandHudView = var_25_3

	local var_25_8 = var_25_7(var_25_6, var_25_3)

	var_4.RefreshHud(var_25_8, arg_25_1, var_25_5)
...
function var_0_1.OnDispose(arg_28_0)
	...
	for iter_28_8, iter_28_9 in var_1(arg_28_0.animationOpTpls) do
		...
		local var_28_3 = var_28_2(var_28_1, var_8(var_1_10009))
