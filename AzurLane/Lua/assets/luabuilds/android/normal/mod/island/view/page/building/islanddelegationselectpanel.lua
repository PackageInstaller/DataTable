...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	Image = var_1_10005
	arg_2_0.formulaProcess = var_2_27(var_2_26, var_4(var_1_10005))
	...
	local var_2_37 = var_3.Find(var_2_36, "formulalayout/formula/tips")

	i18n = var_2_36

	var_2(var_2_37, var_2_36("island_production_finish"))
	...
	typeof = var_4
	Text = var_5
	arg_2_0.shipDetailsName = var_2_54(var_2_53, var_4(var_5))
	...
	typeof = var_4
	Text = var_5
	arg_2_0.shipDetailsDes = var_2_57(var_2_56, var_4(var_5))
	setText = var_2

	local var_2_58 = arg_2_0.shipDetailsPanel
	local var_2_59 = var_3.Find(var_2_58, "title")

	i18n = var_2_58

	var_2(var_2_59, var_2_58("island_production_character_info"))

	setText = var_2

	local var_2_60 = arg_2_0.getBtn
	local var_2_61 = var_3.Find(var_2_60, "Text")

	i18n = var_2_60

	var_2(var_2_61, var_2_60("island_production_collect"))

	setText = var_2

	local var_2_62 = arg_2_0.addBtn
	local var_2_63 = var_3.Find(var_2_62, "num")

	i18n = var_2_62

	var_2(var_2_63, var_2_62("island_additional_production_tip1"))

	setText = var_2

	local var_2_64 = arg_2_0.currentFormula
	local var_2_65 = var_3.Find(var_2_64, "tips")

	i18n = var_2_64

	var_2(var_2_65, var_2_64("island_production_count"))

	setText = var_2

	local var_2_66 = arg_2_0.quickBtn
	local var_2_67 = var_3.Find(var_2_66, "Text")

	i18n = var_2_66

	var_2(var_2_67, var_2_66("island_quick_delegation"))
	arg_2_0:ApplyDiff()
	...
	local var_2_70 = var_3.Find(var_2_69, "process")
	local var_2_71 = arg_2_0.extraProduct

	arg_2_0.extraProductList = var_2_68(var_2_70, var_4.Find(var_2_71, "process/item"))
...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_14()
		...
		var_11_6(var_11_5, var_2_10006.GET_DELEGATION_AWARD, arg_4_0.placeId, arg_4_0.slotId, var_11_4, nil, arg_4_0.contextData.isPost)
	...
	local function var_4_17()
		...
		var_12_1(var_12_0, var_2_10002.STOP_DELEGATION, arg_4_0.placeId, arg_4_0.slotId)
	...
	local function var_4_20()
		...
		var_13_4[1] = var_2_10005.TYPES.APPOINT
	...
	local function var_4_24()
		local var_15_0, var_15_1 = (function()
			...
			local var_16_1 = var_1.GetString(var_16_0, "")
		...
		IslandProductCostHelper = var_2_10006

		local var_15_5 = var_15_3(var_15_4 * (1 - var_2_10006.GetReducePercentInPlace(var_15_0, arg_4_0.placeId)))

		math = var_5

		local var_15_6 = var_5.max(var_15_5, 1)

		getProxy = var_5
		IslandProxy = var_6

		local var_15_7 = var_5(var_6)
		...
		if not var_6.IsDelegable(var_15_10) then
			...
			var_15_12(var_15_11, var_2_10009("island_quick_delegation_notenough_onduty", var_6:GetName()))
		...
		elseif var_6:GetCurrentEnergy() < var_15_6 then
			...
			var_15_14(var_15_13, var_2_10009("island_quick_delegation_notenough_encourage", var_6:GetName()))
...
function var_0_1.ShowDetailPanel(arg_17_0)
	...
	var_17_1(arg_17_0.shipSkillDetails, var_17_2)

	setActive = var_17_1

	var_17_1(arg_17_0.shipSkillEmp, not var_17_2)
	...
	var_17_1(var_17_3, var_5(var_17_4, var_7.GetSkillUnlockLevel(var_17_5)))

	GetImageSpriteFromAtlasAsync = var_17_1

	var_17_1("island/IslandSkillIcon/" .. var_1:GetIcon(), "", arg_17_0.shipDetailsIcon)

	local var_17_6 = arg_17_0.shipDetailsName

	string = var_4
	var_17_6.text = var_4.format("%s - %s", var_1:GetName(), "[Lv." .. var_1:GetLevel() .. "]")
...
function var_0_1.FlushInfos(arg_21_0)
	...
	var_3(var_21_5, var_21_6 .. var_21_7 .. var_1_10007.island_production_commission[arg_21_0.commissionId].name)
	...
	if var_3.CanStartDelegation(var_21_8) then
		...
		var_21_8(arg_21_0.finishTF, false)

		setActive = var_21_8

		var_21_8(arg_21_0.emptyAddShipTF, not arg_21_0.selectedShipId)

		setActive = var_21_8

		var_21_8(arg_21_0.contentTF, arg_21_0.selectedShipId)

		IslandStartDelegationCommand = var_21_8
		var_21_8 = var_21_8.GetLocalKeyForLastData(arg_21_0.slotId)
		PlayerPrefs = var_5

		if var_5.GetString(var_21_8, "") ~= "" then
			setActive = var_6
		...
		if arg_21_0.selectedShipId then
			...
			var_21_9 = var_21_9.GetMaxEnergy(var_21_11)
			setText = var_21_11

			var_21_11(arg_21_0.energyTFText, var_21_10 .. "/" .. var_21_9)

			setSlider = var_21_11

			var_21_11(arg_21_0.energySliderTF, 0, 1, var_21_10 / var_21_9)

			setText = var_21_11

			local var_21_12 = arg_21_0.seletShipName
			local var_21_13 = arg_21_0.showShip

			var_21_11(var_21_12, var_10.GetName(var_21_13))

			IslandShip = var_21_11

			local var_21_14 = var_21_11.StaticGetPrefab(arg_21_0.selectedShipId)

			GetImageSpriteFromAtlasAsync = var_9

			var_9("ShipYardIcon/" .. var_21_14, "", arg_21_0.shipIconTF)
		end
		...
		var_21_8(arg_21_0.contentTF, true)

		setActive = var_21_8

		var_21_8(arg_21_0.emptyAddShipTF, false)

		setActive = var_21_8

		var_21_8(arg_21_0.quickBtn, false)

		setActive = var_21_8

		var_21_8(arg_21_0.selectShipBtn, false)

		setActive = var_21_8

		var_21_8(arg_21_0.selectFormulaBtn, false)
		...
		var_21_9(arg_21_0.processTF, not var_21_19)

		setActive = var_21_9

		var_21_9(arg_21_0.finishTF, var_21_19)

		setActive = var_21_9

		var_21_9(arg_21_0.getBtn, var_21_19)

		setActive = var_21_9

		var_21_9(arg_21_0.stopBtn, not var_21_19)

		setActive = var_21_9

		var_21_9(arg_21_0.inprocessFormulaTF, not var_21_19)

		if var_21_19 then
			var_21_9 = var_21_18.formula_id
			pg = var_8

			local var_21_20 = var_8.island_formula[var_21_9].commission_product[1][1]
			...
			var_21_23.type = var_1_10013
			var_21_23.id = var_21_20

			local var_21_24 = var_21_22(var_21_23)
			local var_21_25 = var_11.getConfigTable(var_21_24).icon

			GetImageSpriteFromAtlasAsync = var_21_24

			var_21_24("island/" .. var_21_25, "", arg_21_0.canRewardIcon)
			...
			var_1_10014 = "×" .. var_21_21 + var_21_26

			if 0 < var_21_26 then
				setTextColor = var_1_10015

				local var_21_27 = arg_21_0.canRewardNum

				Color = var_1_10017

				var_1_10015(var_21_27, var_1_10017.NewHex("#7df39f"))
			else
				setTextColor = var_1_10015
				...
				var_1_10015(var_21_28, var_1_10017.NewHex("#FFFFFF"))
			end

			setText = var_1_10015

			var_1_10015(arg_21_0.canRewardNum, var_1_10014)

			pg = var_1_10015
			var_1_10015 = var_1_10015.island_formula[var_21_9].item_id
			pg = var_16

			local var_21_29 = var_16.island_item_data_template[var_1_10015]

			GetImageSpriteFromAtlasAsync = var_1_10017

			var_1_10017("island/" .. var_21_29.icon, "", arg_21_0.finishFurmalaIcon)

			if var_21_18.formula_drop_list[2] then
				setActive = var_1_10017

				var_1_10017(arg_21_0.canExtraRewardIcon, true)

				setActive = var_1_10017

				var_1_10017(arg_21_0.canExtraRewardNum, true)

				pg = var_1_10017
				var_1_10017 = var_1_10017.island_formula[var_21_9].second_product_display[1][1]

				local var_21_30 = var_21_18.formula_drop_list[2].num

				pg = var_19

				local var_21_31 = var_21_30 * var_19.island_formula[var_21_9].second_product_display[1][2]

				Drop = var_19

				local var_21_32 = var_19.New

				var_1_10020 = {
					count = 0
				}
				DROP_TYPE_ISLAND_ITEM = var_1_10021
				var_1_10020.type = var_1_10021
				var_1_10020.id = var_1_10017

				local var_21_33 = var_21_32(var_1_10020)

				var_1_10020 = var_19.getConfigTable(var_21_33).icon
				GetImageSpriteFromAtlasAsync = var_21_33

				var_21_33("island/" .. var_1_10020, "", arg_21_0.canExtraRewardIcon)
				...
				local var_21_35 = "×" .. var_21_31 + var_21_34
				...
				if 0 < var_21_34 then
					...
					var_23(var_21_36, var_1_10025.NewHex("#7df39f"))
				else
					setTextColor = var_23

					local var_21_37 = arg_21_0.canExtraRewardNum

					Color = var_1_10025

					var_23(var_21_37, var_1_10025.NewHex("#FFFFFF"))
				end

				setText = var_23

				var_23(arg_21_0.canExtraRewardNum, var_21_35)
			end
		end
		...
		if var_21_16 then
			...
			local var_21_38 = var_21_9(var_8)
			local var_21_39 = var_7.GetIsland(var_21_38)
			local var_21_40 = var_7.GetCharacterAgency(var_21_39)

			arg_21_0.showShip = var_7.GetShipById(var_21_40, var_21_16.ship_id)

			local var_21_41 = arg_21_0.showShip
			local var_21_42 = var_7.GetCurrentEnergy(var_21_41)
			local var_21_43 = arg_21_0.showShip
			local var_21_44 = var_8.GetMaxEnergy(var_21_43)

			setText = var_21_43

			var_21_43(arg_21_0.energyTFText, var_21_42 .. "/" .. var_21_44)

			setSlider = var_21_43

			var_21_43(arg_21_0.energySliderTF, 0, 1, var_21_42 / var_21_44)

			setText = var_21_43

			local var_21_45 = arg_21_0.seletShipName
			local var_21_46 = arg_21_0.showShip

			var_21_43(var_21_45, var_11.GetName(var_21_46))

			IslandShip = var_21_43

			local var_21_47 = var_21_43.StaticGetPrefab(var_21_16.ship_id)

			GetImageSpriteFromAtlasAsync = var_10

			var_10("ShipYardIcon/" .. var_21_47, "", arg_21_0.shipIconTF)

			local var_21_48 = var_21_16.formula_id

			pg = var_11

			local var_21_49 = var_11.island_formula[var_21_48].commission_product[1][1]

			pg = var_1_10014

			local var_21_50 = var_1_10014.island_item_data_template[var_21_49]

			Drop = var_1_10015

			local var_21_51 = var_1_10015.New
			local var_21_52 = {
				count = 0
			}

			DROP_TYPE_ISLAND_ITEM = var_1_10017
			var_21_52.type = var_1_10017
			var_21_52.id = var_21_49

			local var_21_53 = var_21_51(var_21_52)

			onButton = var_21_52

			var_21_52(arg_21_0, arg_21_0.currentFormulaIcon, function()
			...
			GetImageSpriteFromAtlasAsync = var_21_52

			var_21_52("island/" .. var_21_50.icon, "", arg_21_0.currentFormulaIcon)

			setText = var_21_52

			var_21_52(arg_21_0.currentFormulaNum, "×" .. var_11.commission_product[1][2])

			GetImageSpriteFromAtlasAsync = var_21_52

			var_21_52("island/" .. var_21_50.icon, "", arg_21_0.canRewardIcon)

			getProxy = var_21_52
			IslandProxy = var_17

			local var_21_54 = var_21_52(var_17)
			local var_21_55 = var_16.GetIsland(var_21_54)
			local var_21_56 = var_16.GetAblityAgency(var_21_55)

			if #var_11.second_product == 0 or not var_21_56:IsUnlcokSecondProduct(var_21_48) then
				setActive = var_17
				...
				local var_21_57 = var_11.second_product_display[1][1]

				pg = var_19

				local var_21_58 = var_19.island_item_data_template[var_21_57]

				GetImageSpriteFromAtlasAsync = var_1_10020

				var_1_10020("island/" .. var_21_58.icon, "", arg_21_0.extraProductIcon)

				GetImageSpriteFromAtlasAsync = var_1_10020

				var_1_10020("island/" .. var_21_58.icon, "", arg_21_0.canExtraRewardIcon)

				setText = var_1_10020

				var_1_10020(arg_21_0.extraProductName, var_21_58.name)

				setText = var_1_10020

				var_1_10020(arg_21_0.extraProductNum, "×" .. var_17[1][2])

				Drop = var_1_10020

				local var_21_59 = var_1_10020.New
				local var_21_60 = {
					count = 0
				}

				DROP_TYPE_ISLAND_ITEM = var_22
				var_21_60.type = var_22
				var_21_60.id = var_21_57

				local var_21_61 = var_21_59(var_21_60)

				onButton = var_21_60

				var_21_60(arg_21_0, arg_21_0.extraProductIcon, function()
...
function var_0_1.OpenShipSelectPage(arg_25_0)
	...
	local var_25_3 = var_1_10004.OPEN_PAGE
	...
	IslandSelectShipCard = var_1_10008
	var_25_6.showType = var_1_10008.SHOW_TYPE.PLACE
...
function var_0_1.OpenFormulaSelectPage(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5)
	...
	var_27_1(var_27_0, var_1_10008.OPEN_PAGE, "IslandFormulaSelectPage", {
		{
...
function var_0_1.UpdateTime(arg_29_0)
	...
	var_5(var_29_7, var_7.DescCDTime(var_29_8, var_29_6))

	setSlider = var_5

	local var_29_9 = arg_29_0.roleDelegationSliderTF
	local var_29_10 = 0
	local var_29_11 = 1
	local var_29_12 = var_3

	var_5(var_29_9, var_29_10, var_29_11, 1 - var_29_6 / var_3.GetAllTime(var_29_12))

	local var_29_13 = var_3:CanRewardTimes()
	local var_29_14 = var_3.formula_id

	pg = var_29_10

	local var_29_15 = var_29_10.island_formula[var_29_14]
	local var_29_16 = var_3:GetCurrentCanRewardExtraMainNum()
	local var_29_17 = "×"

	tostring = var_29_12

	local var_29_18 = var_29_17 .. var_29_12(var_29_15.commission_product[1][2] * var_29_13 + var_29_16)

	if var_29_16 and 0 < var_29_16 then
		setTextColor = var_10

		local var_29_19 = arg_29_0.canRewardNum

		Color = var_1_10012

		var_10(var_29_19, var_1_10012.NewHex("#7df39f"))
	else
		setTextColor = var_10

		local var_29_20 = arg_29_0.canRewardNum

		Color = var_1_10012

		var_10(var_29_20, var_1_10012.NewHex("#FFFFFF"))
	end

	setText = var_10

	var_10(arg_29_0.canRewardNum, var_29_18)

	local var_29_21 = var_3:InCurrentTime()
	local var_29_22 = arg_29_0.timeMgr
	local var_29_23 = var_11.GetServerTime(var_29_22) - var_3:InCurrentTimeStart(var_29_21)

	arg_29_0.formulaProcess.fillAmount = var_29_23 / var_3:CurrentTimeNeed(var_29_21)

	local var_29_24 = var_3
	local var_29_25 = var_3.LastTimes(var_29_24)

	setText = var_29_24

	var_29_24(arg_29_0.currentFormulaLastNum, var_29_25)

	local var_29_26 = var_3:GetExtraMainProduct(var_29_21)
	local var_29_27 = "×" .. var_29_15.commission_product[1][2]

	if 0 < var_29_26 then
		string = var_15
		var_29_27 = var_15.format("×(%s<color=#7df39f>+%d</color>)", var_29_15.commission_product[1][2], var_29_26)
	end

	setText = var_15

	local var_29_28 = arg_29_0.currentFormulaNum
	local var_29_29 = var_29_27

	i18n = var_1_10018

	var_15(var_29_28, var_29_29 .. var_1_10018("island_production_tip"))
	...
	if 0 < var_29_13 then
		...
		if not var_29_15.production_limit then
			var_29_30 = 5
		end

		setActive = var_29_28

		var_29_28(arg_29_0.addBtn, var_29_25 < var_29_30)

		onButton = var_29_28

		local var_29_31 = arg_29_0
		local var_29_32 = arg_29_0.addBtn

		local function var_29_33()
			local var_30_0 = arg_29_0

			var_0.OpenFormulaSelectPage(var_30_0, var_29_14, var_29_25, var_29_13, var_0.ship_id)
		...
		var_29_28(var_29_31, var_29_32, var_29_33, var_1_10020)
	end

	if #var_29_15.second_product ~= 0 then
		getProxy = var_15
		IslandProxy = var_29_28

		local var_29_34 = var_15(var_29_28)
		local var_29_35 = var_15.GetIsland(var_29_34)
		local var_29_36 = var_15.GetAblityAgency(var_29_35)

		if not var_15.IsUnlcokSecondProduct(var_29_36, var_29_14) then
			return
		end

		local var_29_37 = var_3:GetExtraExtraProduct(var_29_21)
		local var_29_38 = "×" .. var_29_15.second_product_display[1][2]

		if 0 < var_29_37 then
			string = var_17
			var_29_38 = var_17.format("×(%s<color=#7df39f>+%d</color>)", var_29_15.second_product_display[1][2], var_29_37)
		end

		setText = var_17

		local var_29_39 = arg_29_0.extraProductNum
		local var_29_40 = var_29_38

		i18n = var_1_10020

		var_17(var_29_39, var_29_40 .. var_1_10020("island_production_tip"))

		if (var_2:GetFromulaTatalCount(var_29_15.id) + var_29_13) % var_29_15.second_product[1] ~= arg_29_0.extraProcess then
			arg_29_0.extraProcess = var_20

			local var_29_41 = arg_29_0.extraProductList

			var_21.align(var_29_41, var_19)
		end

		math = var_21

		local var_29_42 = var_21.floor((var_29_25 + var_20) / var_19)

		setText = var_22

		var_22(arg_29_0.extraProductLastNum, "×" .. var_29_42)

		math = var_22

		local var_29_43 = var_22.floor(var_17 / var_19)

		math = var_23

		local var_29_44 = var_23.floor(var_18 / var_19) - var_29_43

		setActive = var_25

		var_25(arg_29_0.canExtraRewardIcon, var_29_44 > 0)

		setActive = var_25

		var_25(arg_29_0.canExtraRewardNum, var_29_44 > 0)

		if var_29_44 > 0 then
			local var_29_45 = var_17 % var_19
			local var_29_46 = 0

			for iter_29_0 = 1, var_29_44 do
				local var_29_47 = var_29_21 - (iter_29_0 - 1) * var_19

				math = var_1_10032
				var_1_10032 = var_1_10032.floor((var_29_47 + var_29_45) / var_19) * var_19 - var_29_45
				var_29_46 = var_29_46 + var_3:GetExtraExtraProduct(var_1_10032)
			end

			local var_29_48 = "×" .. var_29_15.second_product_display[1][2] * var_29_44 + var_29_46

			if 0 < var_29_46 then
				setTextColor = var_28

				local var_29_49 = arg_29_0.canExtraRewardNum

				Color = iter_29_0

				var_28(var_29_49, iter_29_0.NewHex("#7df39f"))
			else
				setTextColor = var_28

				local var_29_50 = arg_29_0.canExtraRewardNum

				Color = iter_29_0

				var_28(var_29_50, iter_29_0.NewHex("#FFFFFF"))
			end

			setText = var_28

			var_28(arg_29_0.canExtraRewardNum, var_29_48)
		end
