...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.themeNameTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.capacityTxt = var_2_8(var_2_7, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.icon = var_2_14(var_2_13, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.cntTxt = var_2_17(var_2_16, var_3(var_1_10004))
	setActive = var_1

	local var_2_18 = arg_2_0._tf

	var_1(var_2.Find(var_2_18, "cnt"), false)
...
function var_0_1.Show(arg_3_0, arg_3_1, arg_3_2)
	...
	if arg_3_0._tf.localPosition.x + arg_3_0.width > arg_3_0.prantLeftBound then
		...
		Vector3 = var_1_10005
		var_3_1.localPosition = var_1_10005(var_3_0.x - arg_3_0.width, var_3_0.y, var_3_0.z)
	end
