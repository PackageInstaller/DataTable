...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_6 = var_2_4.Find(var_2_5, "lock/content/tip/Text")

	i18n = var_2_5

	var_2_3(var_2_6, var_2_5("island_tech_lock"))

	setText = var_2_3

	local var_2_7 = var_2_4
	local var_2_8 = var_2_4.Find(var_2_7, "empty/content/Text")

	i18n = var_2_7

	var_2_3(var_2_8, var_2_7("island_tech_empty"))

	UIItemList = var_2_3
	arg_2_0.uiList = var_2_3.New(var_1, var_2_4)
	setText = var_3

	local var_2_9 = var_1
	local var_2_10 = var_1.Find(var_2_9, "tpl/content/get/Image/Text")

	i18n = var_2_9

	var_3(var_2_10, var_2_9("island_tech_can_get"))

	setText = var_3

	local var_2_11 = arg_2_0.toggle
	local var_2_12 = var_4.Find(var_2_11, "normal/Text")

	i18n = var_2_11

	var_3(var_2_12, var_2_11("island_tech_nodev"))

	setText = var_3

	local var_2_13 = arg_2_0.toggle
	local var_2_14 = var_4.Find(var_2_13, "studying/Text")

	i18n = var_2_13

	var_3(var_2_14, var_2_13("island_tech_dev_starting"))

	setText = var_3

	local var_2_15 = arg_2_0.toggle
	local var_2_16 = var_4.Find(var_2_15, "finished/Text")

	i18n = var_2_15

	var_3(var_2_16, var_2_15("island_tech_dev_finish_1"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_3 = var_3.Find(var_3_2, "off")
...
function var_0_1.UpdateItem(arg_7_0, arg_7_1, arg_7_2)
	...
	if var_4.GetDelegationSlotData(var_7_1, var_7_0) then
		::label_7_0::

		var_7_2 = var_4
		var_7_3 = var_4.GetFormulaId(var_7_2)
	end

	setActive = var_7_2

	var_7_2(arg_7_2:Find("lock"), not var_4)

	setActive = var_7_2

	var_7_2(arg_7_2:Find("empty"), var_4 and not var_7_3)

	setActive = var_7_2

	var_7_2(arg_7_2:Find("content"), var_7_3)

	if var_7_3 then
		local var_7_4 = arg_7_2:Find("content")
		local var_7_5 = arg_7_0.technologyAgency
		local var_7_6 = var_7.GetTechnologyByFormulaId(var_7_5, var_7_3)

		setText = var_7_5

		var_7_5(var_7_4:Find("title"), var_7_6:getConfig("tech_name"))
		...
		var_7_7(var_7_4:Find("icon_bg"), var_7_8)

		if var_7_8 then
			IslandShip = var_7_7

			local var_7_9 = var_7_7.StaticGetPrefab(var_7_8.ship_id)

			GetImageSpriteFromAtlasAsync = var_10

			var_10("squareicon/" .. var_7_9, "", var_7_4:Find("icon_bg/mask/icon"))

			local var_7_10 = var_7_8:GetFinishTime()
			local var_7_11 = arg_7_0.timeMgr
			local var_7_12 = var_7_10 - var_11.GetServerTime(var_7_11)

			setSlider = var_11

			var_11(var_7_4:Find("silder"), 0, 1, 1 - var_7_12 / var_7_8:GetAllTime())

			setText = var_11

			local var_7_13 = var_7_4:Find("silder/Text")
			local var_7_14 = arg_7_0.timeMgr

			var_11(var_7_13, var_13.DescCDTime(var_7_14, var_7_12))
		end

		local var_7_15 = var_4
		local var_7_16 = var_4.GetSlotRewardData(var_7_15)

		setActive = var_7_15

		var_7_15(var_7_4:Find("get"), var_7_16)

		setActive = var_7_15

		var_7_15(var_7_4:Find("silder"), not var_7_16)
	end
...
function var_0_1.Flush(arg_8_0)
	...
	IslandTechnologyAgency = var_1_10004
	arg_8_0.buildingData = var_8_4(var_8_3, var_1_10004.PLACE_ID)
...
function var_0_1.GetToggleStatus(arg_9_0)
	...
	if var_1_10001.any(arg_9_0.slotIds, function(arg_10_0)
		...
		var_10_1 = var_1.GetDelegationSlotData(var_10_0, arg_10_0) and var_1:GetSlotRewardData()
	...
	if var_1.any(arg_9_0.slotIds, function(arg_11_0)
		...
		var_11_1 = var_1.GetDelegationSlotData(var_11_0, arg_11_0) and var_1:GetSlotRoleData()
...
function var_0_1.QuickGetAward(arg_14_0)
	...
	local var_14_0 = var_1_10001.detect(arg_14_0.slotIds, function(arg_15_0)
		...
		var_15_1 = var_1.GetDelegationSlotData(var_15_0, arg_15_0) and var_1:GetSlotRewardData()
	...
	local var_14_8 = var_1_10006.GET_DELEGATION_AWARD

	IslandTechnologyAgency = var_1_10007

	var_14_7(var_14_6, var_14_8, var_1_10007.PLACE_ID, var_14_0, 2, function()
...
function var_0_1.UpdateTime(arg_17_0)
	...
	var_1.eachActive(var_17_0, function(arg_18_0, arg_18_1)
		...
		if var_3.GetDelegationSlotData(var_18_1, var_18_0) then
			::label_18_0::

			var_18_2 = var_3
			var_18_3 = var_3.GetFormulaId(var_18_2)
		end

		if var_18_3 then
			var_18_2 = arg_18_1:Find("content")

			local var_18_4 = var_3
			local var_18_5 = var_3.GetSlotRoleData(var_18_4)

			setActive = var_18_4

			var_18_4(var_18_2:Find("icon_bg"), var_18_5)

			if var_18_5 then
				local var_18_6 = var_18_5:GetFinishTime()
				local var_18_7 = arg_17_0.timeMgr
				local var_18_8 = var_18_6 - var_8.GetServerTime(var_18_7)

				setSlider = var_8

				var_8(var_18_2:Find("silder"), 0, 1, 1 - var_18_8 / var_18_5:GetAllTime())

				setText = var_8

				local var_18_9 = var_18_2:Find("silder/Text")

				if var_18_8 > 0 then
					local var_18_10 = arg_17_0.timeMgr
					local var_18_11

					if not var_10.DescCDTime(var_18_10, var_18_8) then
						var_18_11 = "00:00:00"
					end

					var_8(var_18_9, var_18_11)

					local var_18_12 = var_3
					local var_18_13 = var_3.GetSlotRewardData(var_18_12)

					setActive = var_18_12

					var_18_12(var_18_2:Find("get"), var_18_13)

					setActive = var_18_12

					var_18_12(var_18_2:Find("silder"), not var_18_13)

					onButton = var_18_12

					local var_18_14 = arg_17_0
					local var_18_15 = arg_18_1
					...
					var_18_12(var_18_14, var_18_15, var_18_16, var_2_10012)

					goto label_18_1

					removeOnButton = var_18_2
