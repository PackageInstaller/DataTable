...
function var_0_1.OnAttach(arg_1_0, arg_1_1)
	...
	arg_1_0.animator = var_1_7(var_1_6, var_4(var_1_10005))
	...
	PlayRoomTools = var_1_10

	local var_1_12 = var_1_10.GetGameViewID(var_1_11.player_info.user_view)
	...
	if var_1_14 == var_6.getRawData(var_1_15).id then
		...
		var_1_16(var_1_17, var_8.UIHidden)
	else
		pg = var_1_16
		...
		var_1_18(var_1_19, var_8.Default)
	end
	...
	var_6.OnRoleLoaded(var_1_20, arg_1_0._tf, nil, function(arg_5_0)
		if var_0 then
			...
			var_5_0(var_5_1, var_2_10003.UIHidden)
		end
...
function var_0_1.LoadEffect(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_6.Instantiate(var_10_1)
...
function var_0_1.OnPlayerQuestion(arg_13_0, arg_13_1)
	if arg_13_1 then
		...
		var_13_0(var_13_1, var_1_10004.Default)
		...
		local function var_13_4()
			...
			var_14_0(var_14_1, var_2_10002.UIHidden)

			return
		end

		IslandCheaterTavernConst = var_4
		arg_13_0.questTimer = var_13_3(var_13_4, var_4.qusanimationTime, 1)
...
function var_0_1.OnPlayWinAnimation(arg_15_0, arg_15_1, arg_15_2)
	if arg_15_1 then
		...
		var_15_0(var_15_1, var_1_10005.Default)
		...
		local function var_15_6()
			...
			var_16_0(var_16_1, var_2_10002.UIHidden)
		...
		arg_15_0.winTimer = var_15_5(var_15_6, var_6.winAnimationTime, 1)
...
function var_0_1.OnPlayerOut(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_1 == var_3.getRawData(var_17_0).id then
		...
		var_17_2(var_17_3, var_1_10006.Default)
