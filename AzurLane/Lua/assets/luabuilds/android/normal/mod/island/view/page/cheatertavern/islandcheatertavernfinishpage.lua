...
function var_0_1.OnLoaded(arg_3_0)
	...
	var_1_10001(arg_3_0, arg_3_0.uiquitBtn, function()
		...
		var_4_2(var_4_1, var_2_10002.FINSH_PAGE_QUIT)
	...
	var_1_10001(var_3_0, var_3("bar_ui_end1"))
	...
	var_1_10001(var_3_1, var_3("bar_ui_end2"))
	...
	var_1_10001(var_3_2, var_3("bar_ui_game3"))
...
function var_0_1.AddListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.ISLAND_CHEATER_REAL_END_NOTIFY, arg_6_0.OnGameEndNotify)
...
function var_0_1.RemoveListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10003.ISLAND_CHEATER_REAL_END_NOTIFY, arg_7_0.OnGameEndNotify)
...
function var_0_1.OnInit(arg_8_0)
	...
	arg_8_0.animation = var_8_1(var_8_0, var_1_10003(var_1_10004))
...
function var_0_1.OnGameEndNotify(arg_9_0, arg_9_1)
	...
	var_9_4(var_9_3, var_1_10006.SettlementType.ByFinal)
...
function var_0_1.RefreshUI(arg_10_0, arg_10_1)
	...
	if arg_10_1 == var_1_10003.SettlementType.ByScore then
		...
		var_10_6(arg_10_0.uiSus, var_10_5 == 1)

		setActive = var_10_6

		var_10_6(arg_10_0.uiFail, var_10_5 ~= 1)

		setText = var_10_6

		var_10_6(arg_10_0.uiWinNameText, var_2:GetName())

		setActive = var_10_6

		var_10_6(arg_10_0.conninueBtn, var_10_5 ~= 1)

		PlayRoomTools = var_10_6

		local var_10_8 = var_10_6.GetPtScoreIcon

		PlayRoomTools = var_6

		local var_10_9 = var_10_8(var_6.GetGameTypeID())

		GetImageSpriteFromAtlasAsync = var_6

		var_6("Island/IslandCheaterTavernIcon/" .. var_10_9, "", arg_10_0.uiPtIcon)

		PlayRoomTools = var_6

		local var_10_10 = var_6.GetPtScrore

		PlayRoomTools = var_7

		local var_10_11 = var_10_10(var_7.GetGameTypeID())
		...
		local var_10_13 = var_9(var_1_10010)
		local var_10_14 = var_9.GetRoomData(var_10_13).roomType

		PlayRoomConst = var_10_13

		var_7(var_10_12, var_10_14 == var_10_13.PLAY_ROOM_TYPE.MATCH)

		local var_10_15 = var_10_7 >= 0 and "+" or ""

		setText = var_10_12

		var_10_12(arg_10_0.uiPtAddText, var_10_15 .. var_10_7)

		if var_10_5 == 1 then
			local var_10_16 = arg_10_0.animation

			var_10_12.Play(var_10_16, "Anim_IslandCheaterTavernFinishUI_win")
		else
			local var_10_17 = arg_10_0.animation

			var_10_12.Play(var_10_17, "Anim_IslandCheaterTavernFinishUI_los")
		end

		IslandCheaterTavernConst = var_10_12

		if arg_10_1 == var_10_12.SettlementType.ByFinal then
			setActive = var_8
