...
function var_0_1.IsLoaded(arg_5_0)
	...
	local var_5_1 = arg_5_0.GetAllUnits(var_5_0)

	_ = var_5_0

	local var_5_2

	if var_5_0.all(arg_5_0.views, function(arg_6_0)
		return arg_6_0:IsLoaded()
	end) then
		_ = var_5_2
		var_5_2 = var_5_2.all(var_5_1, function(arg_7_0)
...
function var_0_1.AddListeners(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10003.GEN_UNIT, arg_9_0.OnGenUnit)
	...
	var_9_3(var_9_2, var_3.RMOVE_UNIT, arg_9_0.OnRemoveUnit)
	...
	var_9_5(var_9_4, var_3.INIT_CHEATERTAVERN_CAMERA, arg_9_0.OnInitCamera)
	...
	var_9_7(var_9_6, var_3.PLAYER_QUESTION_ANIMATION, arg_9_0.OnPlayerQuestion)
	...
	var_9_9(var_9_8, var_3.SHOOT_AND_TURN_TABLE, arg_9_0.OnPlayerShoot)
	...
	var_9_11(var_9_10, var_3.PLAYER_OUT_ANIMATION, arg_9_0.OnPlayerOut)
	...
	var_9_13(var_9_12, var_3.FIRST_TAKE_SHOOT_TIPS, arg_9_0.OnFirstTakeShootTip)
	...
	var_9_15(var_9_14, var_3.CLOSE_PREPARE_MAIN_PAGE, arg_9_0.OnCloseCheaterMainPage)
	...
	var_9_17(var_9_16, var_3.PLAY_ROOM_EXIT_ROOM_DONE, arg_9_0.OnExitRoomDone)
	...
	var_9_19(var_9_18, var_3.INITPLAYER_DATA_DONE, arg_9_0.OnInitPlayerDone)
	...
	var_9_21(var_9_20, var_3.PLAY_WIN_ANIMATION, arg_9_0.OnPlayWinAnimation)
...
function var_0_1.RemoveListeners(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.GEN_UNIT, arg_10_0.OnGenUnit)
	...
	var_10_3(var_10_2, var_3.RMOVE_UNIT, arg_10_0.OnRemoveUnit)
	...
	var_10_5(var_10_4, var_3.INIT_CHEATERTAVERN_CAMERA, arg_10_0.OnInitCamera)
	...
	var_10_7(var_10_6, var_3.PLAYER_QUESTION_ANIMATION, arg_10_0.OnPlayerQuestion)
	...
	var_10_9(var_10_8, var_3.SHOOT_AND_TURN_TABLE, arg_10_0.OnPlayerShoot)
	...
	var_10_11(var_10_10, var_3.PLAYER_OUT_ANIMATION, arg_10_0.OnPlayerOut)
	...
	var_10_13(var_10_12, var_3.FIRST_TAKE_SHOOT_TIPS, arg_10_0.OnFirstTakeShootTip)
	...
	var_10_15(var_10_14, var_3.CLOSE_PREPARE_MAIN_PAGE, arg_10_0.OnCloseCheaterMainPage)
	...
	var_10_17(var_10_16, var_3.PLAY_ROOM_EXIT_ROOM_DONE, arg_10_0.OnExitRoomDone)
	...
	var_10_19(var_10_18, var_3.INITPLAYER_DATA_DONE, arg_10_0.OnInitPlayerDone)
	...
	var_10_21(var_10_20, var_3.PLAY_WIN_ANIMATION, arg_10_0.OnPlayWinAnimation)
...
function var_0_1.OnInitCamera(arg_11_0, arg_11_1)
	...
	var_3(var_11_1 .. var_1_10005.frameCount)
...
function var_0_1.OnCloseCheaterMainPage(arg_13_0)
	...
	var_13_2(var_13_1, var_1_10004.SWITCH_MAP, var_13_0:GetLastExitPosition().mapId)
...
function var_0_1.OnFirstTakeShootTip(arg_14_0, arg_14_1)
	...
	local var_14_2 = var_1_10004.UNIT_LIST_CHEATER_ITEM

	IslandCheaterTavernConst = var_1_10005

	if var_14_1(var_14_0, var_14_2, var_1_10005.deskTableId) then
...
function var_0_1.OnPlayerQuestion(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	if var_15_1(var_15_0, var_1_10006.UNIT_LIST_PLAYER, arg_15_1) then
		var_4:OnPlayerQuestion(arg_15_2)
	end

	if arg_15_3 then
		IslandCheaterTavernConst = var_15_0

		local var_15_2 = var_15_0.deskCharIdList[arg_15_3]
		local var_15_3 = arg_15_0
		local var_15_4 = arg_15_0.GetUnitModuleWithType

		IslandConst = var_1_10008

		if var_15_4(var_15_3, var_1_10008.UNIT_LIST_CHEATER_ITEM, var_15_2) then
...
function var_0_1.OnPlayWinAnimation(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	if var_16_1(var_16_0, var_1_10006.UNIT_LIST_PLAYER, arg_16_1) then
	...
	if arg_16_2 then
		...
		local var_16_2 = var_16_0.deskCharIdList[arg_16_3]
		local var_16_3 = arg_16_0
		local var_16_4 = arg_16_0.GetUnitModuleWithType

		IslandConst = var_1_10008

		if var_16_4(var_16_3, var_1_10008.UNIT_LIST_CHEATER_ITEM, var_16_2) then
...
function var_0_1.OnPlayerShoot(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5)
	...
	local var_17_2 = var_1_10008.UNIT_LIST_CHEATER_ITEM

	IslandCheaterTavernConst = var_1_10009

	if var_17_1(var_17_0, var_17_2, var_1_10009.deskTableId) then
...
function var_0_1.OnPlayerOut(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	if var_18_1(var_18_0, var_1_10006.UNIT_LIST_PLAYER, arg_18_1) then
	...
	local var_18_4 = var_7.UNIT_LIST_CHEATER_ITEM

	IslandCheaterTavernConst = var_1_10008

	if var_18_3(var_18_2, var_18_4, var_1_10008.deskCharIdList[arg_18_2]) then
...
function var_0_1.OnInitPlayerDone(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10001(var_1_10002.deskCharIdList) do
		local var_20_0 = arg_20_0
		local var_20_1 = arg_20_0.GetUnitModuleWithType

		IslandConst = var_1_10008

		if var_20_1(var_20_0, var_1_10008.UNIT_LIST_CHEATER_ITEM, iter_20_1) then
			var_1_10008 = var_6

			var_6.InitDisplayState(var_1_10008)
		end
	end
...
function var_0_1.ClearSceneObject(arg_21_0)
	...
	local var_21_2 = var_21_1(var_21_0, var_1_10003.UNIT_LIST_PLAYER)
	local var_21_3 = {}

	ipairs = var_3

	for iter_21_0, iter_21_1 in var_3(var_21_2) do
		table = var_1_10008
	...
	for iter_21_2, iter_21_3 in var_3(var_21_3) do
		...
		local var_21_5 = arg_21_0.OnRemoveUnit

		IslandConst = var_1_10010

		var_21_5(var_21_4, var_1_10010.UNIT_LIST_PLAYER, iter_21_3)
	end

	local var_21_6 = {}
	local var_21_7 = arg_21_0
	local var_21_8 = arg_21_0.GetUnitListByKey

	IslandConst = iter_21_2

	local var_21_9 = var_21_8(var_21_7, iter_21_2.UNIT_LIST_CHEATER_ITEM)

	ipairs = var_21_7

	for iter_21_4, iter_21_5 in var_21_7(var_21_9) do
		table = var_1_10010

		var_1_10010.insert(var_21_6, iter_21_5.id)
	end

	ipairs = var_5

	for iter_21_6, iter_21_7 in var_5(var_21_6) do
		local var_21_10 = arg_21_0
		local var_21_11 = arg_21_0.OnRemoveUnit

		IslandConst = var_1_10012

		var_21_11(var_21_10, var_1_10012.UNIT_LIST_CHEATER_ITEM, iter_21_7)
	end
...
function var_0_1.InitSceneGameObject(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10002(var_1_10003.deskCharIdList) do
		pg = var_1_10007
		...
		if 0 < var_22_1 then
			...
			var_10.insert(var_22_0, var_22_3)
		end
	end
	...
	var_5.insert(var_22_0, var_22_7)
...
function var_0_1.OnRemoveUnit(arg_28_0, arg_28_1, arg_28_2)
	...
	for iter_28_0, iter_28_1 in var_5(var_28_0 or {}) do
