...
function var_0_0.AddIslandOverFlowItems(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10003(arg_5_0) do
		...
		local var_5_6 = var_11.New
		local var_5_7 = {}

		DROP_TYPE_ISLAND_ITEM = var_1_10013
		var_5_7.type = var_1_10013
		var_5_7.id = iter_5_1.id

		if not iter_5_1.number and not iter_5_1.num then
			var_1_10013 = iter_5_1.count
		end

		var_5_7.count = var_1_10013
...
function var_0_0.AddIslandAbility(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_1_10003(arg_6_0) do
		if not var_6_2:HasAbility(iter_6_1.id) then
			...
			local var_6_6 = var_10.New
			local var_6_7 = {
				count = 1
			}

			DROP_TYPE_ISLAND_ABILITY = var_1_10012
			var_6_7.type = var_1_10012
...
function var_0_0.HandleIslandShopAbility(arg_7_0)
	...
	if var_2.IsShopTypeNormal(arg_7_0) then
		pg = var_2
		...
		if var_2.island_shop_normal_template[var_7_0] then
			...
			for iter_7_0, iter_7_1 in var_1_10005(var_7_1) do
				...
				var_1_10011 = var_1_10010.GetAblityAgency(var_1_10011)

				if not var_1_10010.HasAbility(var_1_10011, iter_7_1) then
					var_7_2 = false
...
function var_0_0.HandleIslandAbilityByType(arg_8_0)
	...
	IslandAblityAgency = var_8_0

	local var_8_2 = var_8_0.GetEffect(arg_8_0)

	switch = var_3
	IslandAblityAgency = var_1_10004

	local var_8_3 = var_1_10004.GetAblityType(arg_8_0)
	local var_8_4 = {}

	IslandAblityAgency = var_1_10006
	var_8_4[var_1_10006.TYPE_SLOT] = function()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_RESTAURANT] = function()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_ASSISTANT] = function()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_ANIMAL] = function()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_RECOVER_CAMP] = function()
		local var_13_0 = var_8_1
		local var_13_1 = var_0.GetBuildingAgency(var_13_0)
		local var_13_2 = var_0.GetBuilding

		IslandProductConst = var_2_10002

		local var_13_3 = var_13_2(var_13_1, var_2_10002.FellingPlaceId)
		...
		local var_13_7 = var_13_5.TimeMgr.GetInstance()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_RECOVER_ORE] = function()
		...
		local var_14_3 = var_14_2(var_14_1, var_2_10002.MinePlaceId)
		...
		local var_14_7 = var_14_5.TimeMgr.GetInstance()
	...
	IslandAblityAgency = var_6
	var_8_4[var_6.TYPE_FISHING_ROD] = function()
...
function var_0_0.AddShipInvitations(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10003(arg_17_0) do
		...
		local var_17_6 = var_10.New
		local var_17_7 = {}

		DROP_TYPE_ISLAND_INVITATION = var_1_10012
		var_17_7.type = var_1_10012
		var_17_7.id = iter_17_1.id

		if not iter_17_1.number and not iter_17_1.num then
			var_1_10012 = iter_17_1.count
		end

		var_17_7.count = var_1_10012
...
function var_0_0.AddVirtualDrops(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10002(arg_18_0) do
		...
		VIRTUAL_DROP_TYPE_ISLAND_SEASON_PT = var_1_10010
		var_18_2[var_1_10010] = function()
			Drop = var_2_10000
			...
			var_19_1.insert(var_18_0, var_19_3)

			getProxy = var_1
			IslandProxy = var_2

			local var_19_4 = var_1(var_2)
...
function var_0_0.AddIslandFurnitureDrops(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10003(arg_20_0) do
		...
		local var_20_8 = var_1_10011.TimeMgr
		local var_20_9 = var_1_10011.GetInstance(var_20_8)

		var_20_7(var_20_6, var_1_10011.GetServerTime(var_20_9))
		...
		DROP_TYPE_ISLAND_FURNITURE = var_1_10013
		var_20_14.type = var_1_10013
		var_20_14.id = iter_20_1.id

		if not iter_20_1.number and not iter_20_1.num then
			var_1_10013 = iter_20_1.count
		end

		var_20_14.count = var_1_10013

		var_20_12(var_20_13, var_1_10011(var_20_14))
	end
...
function var_0_0.AddIslandDressDrops(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_21_1(arg_21_0) do
		pg = var_1_10008

		if var_1_10008.island_dress_template[iter_21_1.id].belongto == 1 then
			var_1_10011 = var_21_2:GetDressUpAgency()

			var_9.AddDressByDressId(var_1_10011, iter_21_1.id)

			IslandTaskHelper = var_10

			local var_21_3 = var_10.UpdateRuntimeTaskByTargetType

			IslandTaskTargetType = var_1_10011

			var_21_3(var_1_10011.COMMANDER_DRESS)
			...
			var_21_4(var_1_10011.COMMANDER_DRESS_ID)

			IslandAchievementHelper = var_21_4

			local var_21_5 = var_21_4.UpdateRecordWithAdd

			IslandAchievementType = var_1_10011

			var_21_5(var_1_10011.COMMANDER_DRESS_TYPE, var_1_10008.type, 1)
		else
			var_1_10011 = var_21_2:GetCharacterAgency()

			local var_21_6 = not var_9.ExistDressId(var_1_10011, iter_21_1.id)
			local var_21_7 = var_9

			var_9.AddDressItem(var_21_7, iter_21_1.id, iter_21_1.number, true)

			IslandTaskHelper = var_1_10011
			var_1_10011 = var_1_10011.UpdateRuntimeTaskByTargetType
			IslandTaskTargetType = var_21_7

			var_1_10011(var_21_7.SHIP_DRESS_ID)

			if var_21_6 then
				IslandTaskHelper = var_1_10011
				var_1_10011 = var_1_10011.UpdateRuntimeTaskByTargetType
				IslandTaskTargetType = var_12

				var_1_10011(var_12.SHIP_DRESS)

				IslandAchievementHelper = var_1_10011
				var_1_10011 = var_1_10011.UpdateRecordWithAdd
				IslandAchievementType = var_12

				var_1_10011(var_12.SHIP_DRESS_TYPE, var_1_10008.type, 1)
			end
		end

		table = var_9

		local var_21_8 = var_9.insert
		local var_21_9 = var_21_0
		...
		DROP_TYPE_ISLAND_DRESS = var_1_10013
		var_21_10.type = var_1_10013
		var_21_10.id = iter_21_1.id

		if not iter_21_1.number and not iter_21_1.num then
			var_1_10013 = iter_21_1.count
		end

		var_21_10.count = var_1_10013

		var_21_8(var_21_9, var_1_10011(var_21_10))

		pg = var_21_8

		local var_21_11 = var_21_8.GameTrackerMgr.GetInstance()
		local var_21_12 = var_9.Record

		GameTrackerBuilder = var_1_10011

		var_21_12(var_21_11, var_1_10011.BuildIslandGetDress(var_1_10008.belongto, iter_21_1.id))
	end
...
function var_0_0.AddIslandSkinDrops(arg_22_0)
	...
	for iter_22_0, iter_22_1 in var_1_10004(arg_22_0) do
		...
		local var_22_6 = var_11.New
		local var_22_7 = {}

		DROP_TYPE_ISLAND_SKIN = var_1_10013
		var_22_7.type = var_1_10013
		var_22_7.id = iter_22_1.id

		if not iter_22_1.number and not iter_22_1.num then
			var_1_10013 = iter_22_1.count
		end

		var_22_7.count = var_1_10013
	...
	if 0 < var_22_8 then
		IslandTaskHelper = var_22_8

		local var_22_9 = var_22_8.UpdateRuntimeTaskByTargetType

		IslandTaskTargetType = var_5

		var_22_9(var_5.SHIP_SKIN)

		IslandAchievementHelper = var_22_9

		local var_22_10 = var_22_9.UpdateRecordWithAdd

		IslandAchievementType = var_5

		var_22_10(var_5.SHIP_SKIN, 0, #arg_22_0)
	end
...
function var_0_0.AddIslandActionDrops(arg_23_0)
	...
	for iter_23_0, iter_23_1 in var_1_10003(arg_23_0) do
		...
		local var_23_9 = var_10.New
		local var_23_10 = {}

		DROP_TYPE_ISLAND_ACTION = var_1_10012
		var_23_10.type = var_1_10012
		var_23_10.id = iter_23_1.id

		if not iter_23_1.number and not iter_23_1.num then
			var_1_10012 = iter_23_1.count
		end

		var_23_10.count = var_1_10012
...
function var_0_0.AddIslandCardDiyDrops(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1_10003(arg_24_0) do
		...
		DROP_TYPE_ISLAND_CARD_DIY = var_1_10012
		var_24_7.type = var_1_10012
		var_24_7.id = iter_24_1.id

		if not iter_24_1.number and not iter_24_1.num then
			var_1_10012 = iter_24_1.count
		end

		var_24_7.count = var_1_10012
...
function var_0_0.AddIslandTicketDrops(arg_25_0, arg_25_1)
	...
	for iter_25_0, iter_25_1 in var_1_10004(arg_25_0) do
		...
		local var_25_8 = var_14.New
		local var_25_9 = {}

		DROP_TYPE_ISLAND_SPEEDUP_TICKET = var_16
		var_25_9.type = var_16
...
function var_0_0.AddIslandCollectDrops(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_1_10003(arg_26_0) do
		...
		local var_26_6 = var_10.New
		local var_26_7 = {}

		DROP_TYPE_ISLAND_COLLECTION = var_1_10012
		var_26_7.type = var_1_10012
		var_26_7.id = iter_26_1.id

		if not iter_26_1.number and not iter_26_1.num then
			var_1_10012 = iter_26_1.count
		end

		var_26_7.count = var_1_10012
