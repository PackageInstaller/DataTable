...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandSystemNpcBuilder"))
...
function var_0_1.LoadOtherPart(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	var_1_10007({
		function(arg_5_0)
			...
			IslandShipDressHelperNew = var_5_0

			local var_5_2 = var_5_0.New(var_5_1)
