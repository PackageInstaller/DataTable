...
function var_0_1.OnLoaded(arg_2_0)
	...
	i18n = var_2_1
	var_2_3.text = var_2_1("island_book_award_title")
	...
	var_1(var_2.Find(var_2_5, "tpl"), false)
...
function var_0_1.OnUpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	var_7(var_8_1:Find("drop"), var_8_3, {
		style = "island"
	})

	onButton = var_7

	var_7(arg_8_0, var_8_1, function()
	...
	local var_8_5 = var_8_1.Find(var_8_4, "level")

	string = var_8_4

	var_7(var_8_5, var_8_4.format("%02d", var_8_2.level))

	setText = var_7

	var_7(var_8_1:Find("desc"), var_8_2.describe)

	table = var_7

	local var_8_6 = var_7.contains(arg_8_0.gotIds, var_8_0)

	setActive = var_8

	var_8(var_8_1:Find("drop/got"), var_8_6)

	setGray = var_8

	var_8(var_8_1, not var_8_6, true)
