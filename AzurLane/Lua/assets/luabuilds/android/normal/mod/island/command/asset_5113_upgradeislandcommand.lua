...
function var_0_1.DoUpgrade(arg_2_0, arg_2_1)
	...
	var_3.Send(var_2_2, 21000, {
		...
		if arg_3_0.ret == 0 then
			...
			var_2_10003 = var_1.GetIsland(var_3_0)

			var_1.Upgrade(var_2_10003)
			...
			var_2_10003(var_2_10004.ISLAND_LV)

			IslandAchievementHelper = var_2_10003
			var_2_10003 = var_2_10003.UpdateRecord
			IslandAchievementType = var_4

			var_2_10003(var_4.ISLAND_LV, 0, var_1:GetLevel())
			...
			var_2_10003(var_3_2, var_5.ISLAND_UPGRADE_DONE, {
				dropData = var_3_1,
				callback = function()
			...
			local var_3_3 = var_2_10003.GameTrackerMgr.GetInstance()

			var_2_10003 = var_2_10003.Record
			GameTrackerBuilder = var_5

			var_2_10003(var_3_3, var_5.BuildIslandUpgrade(var_1:GetLevel()))

			local var_3_4 = var_1:GetTechnologyAgency()

			var_2_10003.TryAutoUnlock(var_3_4)
		else
			pg = var_1
			...
			var_3_6(var_3_5, var_2_10003[arg_3_0.ret] .. arg_3_0.ret)
		end
