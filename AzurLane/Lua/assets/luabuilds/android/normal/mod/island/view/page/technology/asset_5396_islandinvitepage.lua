...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_1, var_2_0("island_invite_title"))
...
function var_0_1.AddListeners(arg_9_0)
	...
	var_9_1(var_9_0, var_1_10003.ADD_SHIP, arg_9_0.Flush)
...
function var_0_1.RemoveListeners(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.ADD_SHIP, arg_10_0.Flush)
...
function var_0_1.Flush(arg_12_0)
	...
	local var_12_0 = var_1(var_1_10002)
	...
	for iter_12_0, iter_12_1 in var_12_2(var_12_3) do
		...
		var_9.insert(arg_12_0.displays, var_1_10008)
	end
...
function var_0_1.OnInitItem(arg_13_0, arg_13_1)
	...
	arg_13_0:AddDrag(var_13_0.frameTF, function()
		...
		var_15_1(var_15_0, var_2_10002.INVITE_SHIP, var_13_0.item.shipId)
...
function var_0_1.CheckCardBound(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4)
	...
	if arg_25_3 then
		getBounds = var_25_1
		var_25_1 = var_25_1(arg_25_2._tf)
		getBounds = var_7

		local var_25_2 = var_7(arg_25_1._tf)

		math = var_8

		if var_8.ceil(var_25_2:GetMax().x - var_25_0:GetMax().x) > var_25_1.size.x then
			local var_25_3 = arg_25_0.scrollrect
			local var_25_4 = var_8.HeadIndexToValue(var_25_3, arg_25_4 - 1)
			local var_25_5 = arg_25_0.scrollrect
			local var_25_6 = var_25_4 - var_9.HeadIndexToValue(var_25_5, arg_25_4)
			local var_25_7 = arg_25_0.scrollrect.value - var_25_6
			local var_25_8 = arg_25_0.scrollrect

			var_10.SetNormalizedPosition(var_25_8, var_25_7, 0)
		end
	else
		getBounds = var_25_1

		local var_25_9 = var_25_1(arg_25_1._tf)

		getBounds = var_7

		local var_25_10 = var_7(arg_25_1._tf.parent)

		if var_7.GetMin(var_25_10).x < var_25_0:GetMin().x and var_25_9:GetMin().x < var_25_0:GetMin().x then
			local var_25_11 = arg_25_0.scrollrect
			local var_25_12 = var_8.HeadIndexToValue(var_25_11, arg_25_4 - 1)
			local var_25_13 = arg_25_0.scrollrect

			var_9.SetNormalizedPosition(var_25_13, var_25_12, 0)
		end
	end
