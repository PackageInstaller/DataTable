...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_3 = var_2_1.Find(var_2_2, "left/Text")

	i18n = var_2_2

	var_2_0(var_2_3, var_2_2("island_ticket_remain_time"))
	...
	arg_2_0.formulaNumTF = var_2.Find(var_2_4, "window/Text")

	local var_2_5 = arg_2_0._tf

	arg_2_0.viewBtn = var_2.Find(var_2_5, "window/view")
	setText = var_2
	...
	var_2(var_2_7, var_2_6("island_ticket_view"))

	local var_2_8 = arg_2_0._tf

	arg_2_0.autoBtn = var_2.Find(var_2_8, "window/auto")
	setText = var_2

	local var_2_9 = arg_2_0.autoBtn
	local var_2_10 = var_3.Find(var_2_9, "Text")

	i18n = var_2_9

	var_2(var_2_10, var_2_9("island_ticket_auto_select"))

	local var_2_11 = arg_2_0._tf

	arg_2_0.useBtn = var_2.Find(var_2_11, "window/use")
	setText = var_2

	local var_2_12 = arg_2_0.useBtn
	local var_2_13 = var_3.Find(var_2_12, "Text")

	i18n = var_2_12

	var_2(var_2_13, var_2_12("island_ticket_use"))

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_2.Find(var_2_14, "window/scrollrect")

	arg_2_0.scrollRect = var_2.GetComponent(var_2_15, "LScrollRect")
...
function var_0_1.OnInit(arg_5_0)
	...
	local var_5_2 = var_3.Find(var_5_1, "window/help")
	...
	local var_5_6 = var_3.Find(var_5_5, "window/close")
	...
	local function var_5_14()
		...
		IslandTicketStoragePage = var_2_10002
...
function var_0_1.OnInitItem(arg_13_0, arg_13_1)
	...
	local function var_13_4()
		...
		if not var_2_10000.IsUnlock("shop") then
			...
			var_14_1(var_14_0, var_2_10003("island_shop_lock_tip"))
		...
		local var_14_2 = var_14_1.island_set.island_ticket_shopid.key_value_varchar
		local var_14_3 = arg_13_0
		local var_14_4 = var_2.OpenPage

		IslandShopPage = var_2_10004
		unpack = var_2_10005

		var_14_4(var_14_3, var_2_10004, var_2_10005(var_14_2))
	...
	var_13_1(var_13_2, var_13_3, var_13_4, var_1_10007)
...
function var_0_1.OnUpdateItem(arg_15_0, arg_15_1, arg_15_2)
	...
	var_1_10006(var_15_6, var_15_7, var_15_8, var_1_10010)
...
function var_0_1.AddListeners(arg_21_0)
	...
	var_21_1(var_21_0, var_1_10003.ISLAND_REMOVE_EXPIRED_TICKET_DONE, arg_21_0.Flush)
	...
	var_21_3(var_21_2, var_3.ISLAND_USE_TICKET_DONE, arg_21_0.Flush)
	...
	var_21_5(var_21_4, var_3.ISLAND_SHOP_OP_DONE, arg_21_0.Flush)
...
function var_0_1.RemoveListeners(arg_22_0)
	...
	var_22_1(var_22_0, var_1_10003.ISLAND_REMOVE_EXPIRED_TICKET_DONE, arg_22_0.Flush)
	...
	var_22_3(var_22_2, var_3.ISLAND_USE_TICKET_DONE, arg_22_0.Flush)
	...
	var_22_5(var_22_4, var_3.ISLAND_SHOP_OP_DONE, arg_22_0.Flush)
...
function var_0_1.SetSystemData(arg_25_0)
	...
	IslandUseTicketCommand = var_1_10004
	var_25_1[var_1_10004.TYPES.ORDER_CD] = function()
	...
	IslandUseTicketCommand = var_4
	var_25_1[var_4.TYPES.SHIP_ORDER] = function()
		getProxy = var_2_10000
		IslandProxy = var_2_10001
	...
	IslandUseTicketCommand = var_4
	var_25_1[var_4.TYPES.MANAGE] = function()
		getProxy = var_2_10000
		IslandProxy = var_2_10001
	...
	IslandUseTicketCommand = var_4
	var_25_1[var_4.TYPES.APPOINT] = function()
		pg = var_2_10000
		...
		local var_29_1 = var_1(var_2_10002)
	...
	IslandUseTicketCommand = var_4
	var_25_1[var_4.TYPES.SHIP_ORDER_RELOAD] = function()
		local var_30_0 = arg_25_0

		getProxy = var_2_10001
		IslandProxy = var_2_10002

		local var_30_1 = var_2_10001(var_2_10002)
...
function var_0_1.SetTicketsData(arg_32_0)
	...
	for iter_32_0, iter_32_1 in var_32_2(var_32_3) do
		underscore = var_1_10007

		local var_32_4 = #var_1_10007.values(iter_32_1)

		if 0 < var_32_4 then
			var_1_10009 = var_1_10007[1]

			local var_32_5 = var_8.GetTime(var_1_10009)

			if not arg_32_0.displayDic[var_32_5] then
				var_1_10009 = arg_32_0.displayDic
				var_1_10009[var_32_5] = {}
			end

			var_1_10009 = arg_32_0.displayDic
			table = var_1_10010
			var_1_10009[var_32_5] = var_1_10010.mergeArray(arg_32_0.displayDic[var_32_5], var_1_10007)
		end
	end
	...
	for iter_32_2, iter_32_3 in var_2(arg_32_0.displayDic) do
		...
		local var_32_6 = iter_32_3

		CompareFuncs = var_1_10009

		var_1_10007(var_32_6, var_1_10009({
			function(arg_33_0)
	...
	for iter_32_4, iter_32_5 in var_2(arg_32_0.displayGroups) do
		...
		if not arg_32_0.displayDic[iter_32_5] then
			var_32_7 = arg_32_0.displayDic
			var_32_7[iter_32_5] = {}
		end

		underscore = var_32_7

		local var_32_8 = var_32_7.reduce(arg_32_0.displayDic[iter_32_5], 0, function(arg_36_0, arg_36_1)
			return arg_36_0 + arg_36_1:GetCount()
		end)

		table = var_8

		var_8.insert(arg_32_0.allCounts, var_32_8)

		table = var_8

		var_8.insert(arg_32_0.selCounts, 0)
	end
...
function var_0_1.UpdateSliderUI(arg_37_0)
	...
	if 0 < var_37_2 then
		...
		var_4(var_37_3, var_1_10006.DescCDTime(var_37_4, var_37_2))
	else
		setText = var_4
		...
		var_4(var_37_5, var_1_10006("island_ticket_finished"))
	end
	...
	var_4(var_37_6, var_37_7 .. var_7.DescCDTime(var_37_8, arg_37_0.reduceTime))
	...
	local var_37_10 = var_37_9 == var_5.TYPES.APPOINT
	...
	if var_37_10 and arg_37_0.appointRoleData then
		...
		var_37_11(var_37_13, var_8("island_ticket_completed_quantity", var_37_12))
	end
...
function var_0_1.UpdataSelected(arg_39_0)
	...
	var_2(arg_39_0.useBtn, not var_39_0, true)

	setButtonEnabled = var_2

	var_2(arg_39_0.useBtn, var_39_0)
	...
	for iter_43_0, iter_43_1 in var_1_10002(arg_43_0.selCounts) do
		...
		for iter_43_2, iter_43_3 in var_1_10010(var_43_2) do
			...
			if iter_43_1 - var_43_3 <= iter_43_3:GetCount() then
				...
				IslandTicket = var_1_10018

				var_43_4(var_43_5, var_1_10018.New(iter_43_3.id, iter_43_3.endTime, var_15))
				...
				var_43_6(var_43_7, var_1_10018.New(iter_43_3.id, iter_43_3.endTime, iter_43_3:GetCount()))
	...
	var_1_10001({
		function(arg_46_0)
			...
			if var_46_0 - var_2.GetServerTime(var_46_1) <= 0 then
				...
				var_46_3(var_46_2, var_2_10004("island_ticket_finished"))
			else
				arg_46_0()
			end
		...
		function(arg_47_0)
			...
			if var_47_0 - var_2.GetServerTime(var_47_1) < arg_45_0.reduceTime then
				...
				var_47_4.type = var_2_10005.TYPE_COMMON
				i18n = var_5
				var_47_4.content = var_5("island_sure_ticket_overflow")
		...
		var_48_3(var_48_2, var_2_10003.USE_TICKETS, arg_45_0.type, arg_45_0.id, var_48_1)
