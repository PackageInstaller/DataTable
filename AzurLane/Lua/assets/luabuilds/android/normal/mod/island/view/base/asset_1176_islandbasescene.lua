...
function var_0_1.LoadUIContainer(arg_12_0, arg_12_1)
	...
	local var_12_4 = var_1_10006(var_1_10007)

	UnityEngine = var_1_10007

	var_12_1(var_12_0, var_12_2, var_12_3, var_12_4, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_13_0)
		...
		var_2_10001.InstantiateAsyncGameObject(arg_13_0, function(arg_14_0)
			...
			var_14_0.canvasGroup = var_2(var_14_1, var_3_10004(var_3_10005))
	...
	if arg_16_1 ~= var_1_10002.ON_HOME then
		...
		if arg_16_1 == var_2.CHANGE_SCENE then
			...
			if var_2 then
				...
				var_16_1(var_16_0, var_1_10004("island_home_btn_cant_use"))
...
function var_0_1.emitCore(arg_18_0, arg_18_1, ...)
	...
	var_18_1(var_18_0, var_18_2, var_1_10005.LINK_CORE, arg_18_1, ...)
...
function var_0_1.ExitProcess(arg_19_0, arg_19_1, arg_19_2, ...)
	...
	local var_19_2 = arg_19_0.GetIsland(var_19_1)
	...
	var_19_1({
		function(arg_20_0)
			...
			var_20_1(var_20_0, var_2_10003.RECORD_PLAYER_POS)
			...
			var_20_3(var_20_2, var_3.ISLAND_EXIT, {
				id = var_19_2.id,
				callback = arg_20_0
			})
		...
		var_21_0(var_21_1, var_21_2, var_2_10003(var_19_0))
...
function var_0_1.onUILoaded(arg_23_0, arg_23_1)
	...
	pg = var_4
	var_23_0[1] = var_23_1(var_4.UIMgr.GetInstance().OverlayMain, arg_23_0.event)
	IslandToast = var_3

	local var_23_2 = var_3.New

	pg = var_4
	var_23_0[2] = var_23_2(var_4.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	IslandStoryMgr = var_3

	local var_23_3 = var_3.New

	pg = var_4
	var_23_0[3] = var_23_3(var_4.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	IslandAwardDisplayPage = var_3

	local var_23_4 = var_3.New

	pg = var_4
	var_23_0[4] = var_23_4(var_4.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	IslandQueueUpMsgBox = var_3

	local var_23_5 = var_3.New

	pg = var_4
	var_23_0[5] = var_23_5(var_4.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	IslandTimelineMgr = var_3

	local var_23_6 = var_3.New
	local var_23_7 = arg_23_0
	local var_23_8 = arg_23_0.GetPoolMgr(var_23_7)

	pg = var_23_7
	var_23_0[6] = var_23_6(var_23_8, var_23_7.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	Island3dTaskAcceptPage = var_3

	local var_23_9 = var_3.New

	pg = var_23_8
	var_23_0[7] = var_23_9(var_23_8.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	IslandSystemUnlockPage = var_3

	local var_23_10 = var_3.New

	pg = var_4
	var_23_0[8] = var_23_10(var_4.UIMgr.GetInstance().OverlayToast, arg_23_0.event)
	arg_23_0.subViews = var_23_0

	local var_23_11 = {}

	IslandPlayerDataMonitor = var_3
	var_23_11[1] = var_3.New(arg_23_0:GetIsland())
	IslandSyncDataMonitor = var_3
	var_23_11[2] = var_3.New(arg_23_0:GetIsland())
	IslandCheaterTavernMonitor = var_3
	var_23_11[3] = var_3.New(arg_23_0:GetIsland())
	arg_23_0.monitors = var_23_11
	IslandPoppingQueue = var_23_11
	arg_23_0.poppingQueue = var_23_11.New(arg_23_0)
...
function var_0_1.AddCommonListeners(arg_24_0)
	...
	var_24_1(var_24_0, var_1_10003.EMIT, arg_24_0.OnEmit)
	...
	var_24_3(var_24_2, var_3.INIT_FINISH, arg_24_0.OnSceneLoaded)
	...
	var_24_5(var_24_4, var_3.SHOW_MSG, arg_24_0.OnShowMsgBox)
	...
	var_24_7(var_24_6, var_3.OPEN_PAGE, arg_24_0.OnOpenPage)
	...
	var_24_9(var_24_8, var_3.PLAY_TIMELINE, arg_24_0.OnPlayTimeline)
	...
	var_24_11(var_24_10, var_3.OPEN_ANIMATION_OP, arg_24_0.OnOpenAnimatonOpPage)
	...
	var_24_13(var_24_12, var_3.CLOSE_ANIMATION_OP, arg_24_0.OnCloseAnimatonOpPage)
...
function var_0_1.StartCore(arg_36_0)
	...
	IslandBaseMediator = var_1_10003

	var_36_1(var_36_0, var_1_10003.SET_UP)
...
function var_0_1.setVisible(arg_37_0, arg_37_1)
	...
	local var_37_1 = var_1_10002(var_37_0, var_1_10004(var_1_10005))
...
function var_0_1.DisplayAward(arg_45_0, arg_45_1)
	...
	IslandAwardDisplayPage = var_1_10004
...
function var_0_1.PlayStory(arg_48_0, arg_48_1)
	...
	IslandPoppingQueue = var_1_10004

	var_48_1(var_48_0, var_1_10004.STORY, arg_48_1)
...
function var_0_1.ShowMsgbox(arg_49_0, arg_49_1)
	...
	var_49_1(var_49_0, var_1_10004.MSGBOX, arg_49_1)
...
function var_0_1.PlayPerformance(arg_50_0, arg_50_1)
	...
	var_50_1(var_50_0, var_1_10004.PERFORMANCE, arg_50_1)
...
function var_0_1.DisplaySystemUnlock(arg_51_0, arg_51_1, arg_51_2)
	...
	for iter_51_0, iter_51_1 in var_5(var_3) do
		...
		var_1_10010.insert(var_51_0, function(arg_53_0)
			...
			IslandSystemUnlockPage = var_2_10003

			local var_53_2 = var_53_1(var_53_0, var_2_10003)
...
function var_0_1.HandleAwardDisplay(arg_55_0, arg_55_1, arg_55_2, arg_55_3)
	...
	IslandPoppingQueue = var_1_10007

	var_55_2(var_55_1, var_1_10007.DISPLAY_AWARD, var_55_0)
...
function var_0_1.ShowTaskAcceptPage(arg_56_0, arg_56_1)
	...
	var_56_1(var_56_0, var_1_10004.TASK_ACCEPT_PAGE, arg_56_1)
...
function var_0_1.ShowQueueUpMsgBox(arg_57_0, arg_57_1, arg_57_2)
	...
	IslandQueueUpMsgBox = var_1_10005
...
function var_0_1.onBackPressed(arg_61_0)
	...
	IslandTimelineMgr = var_1_10003

	local var_61_2 = var_61_1(var_61_0, var_1_10003)
	...
	local var_61_5 = var_61_4(var_61_3, var_1_10004)
	...
	for iter_61_0, iter_61_1 in var_3(arg_61_0.subViews) do
		if iter_61_1:GetLoaded() and iter_61_1:isShowing() then
			...
			if var_8(var_61_6, var_1_10010) then
...
function var_0_1.RemoveCommonListeners(arg_62_0)
	...
	var_62_1(var_62_0, var_1_10003.EMIT, arg_62_0.OnEmit)
	...
	var_62_3(var_62_2, var_3.INIT_FINISH, arg_62_0.OnSceneLoaded)
	...
	var_62_5(var_62_4, var_3.SHOW_MSG, arg_62_0.OnShowMsgBox)
	...
	var_62_7(var_62_6, var_3.OPEN_PAGE, arg_62_0.OnOpenPage)
	...
	var_62_9(var_62_8, var_3.PLAY_TIMELINE, arg_62_0.OnPlayTimeline)
	...
	var_62_11(var_62_10, var_3.OPEN_ANIMATION_OP, arg_62_0.OnOpenAnimatonOpPage)
	...
	var_62_13(var_62_12, var_3.CLOSE_ANIMATION_OP, arg_62_0.OnCloseAnimatonOpPage)
