...
function var_0_1.AddFinishedCnt(arg_3_0)
	...
	if arg_3_0.finishedCnt == 1 then
		...
		IslandTaskTargetType = var_2

		var_3_0(var_2.TECHNOLOGY)
	end
...
function var_0_1.IsUnlock(arg_14_0)
	...
	if arg_14_0.GetAbilityId(var_14_0) ~= 0 then
		getProxy = var_14_0
		IslandProxy = var_1_10003

		local var_14_1 = var_14_0(var_1_10003)
		local var_14_2 = var_2.GetIsland(var_14_1)
		local var_14_3 = var_2.GetAblityAgency(var_14_2)

		var_14_4 = var_2.HasAbility(var_14_3, var_1)
...
function var_0_1.GetCostItems(arg_15_0)
	...
	var_15_1(var_1_10003.island_formula[arg_15_0:GetFormulaId()].commission_cost, function(arg_16_0)
		table = var_2_10001
...
function var_0_1.CanUnlock(arg_17_0)
	...
	if arg_17_0.getConfig(var_17_2, "sys_unlock") == "" or #var_1 == 0 then
		return true
	end

	underscore = var_17_2

	return var_17_2.all(var_1, function(arg_18_0)
...
function var_0_1.GetSlotId(arg_26_0)
	...
	var_26_3 = var_1.GetDelegationSlotDataByTechId(var_26_2, arg_26_0.id) and var_1.id
...
function var_0_1.GetUnlockText(arg_27_0)
	...
	return var_1_10003(var_27_0, {
		...
		[var_0_1.UNLOCK_TYPE.FINISH_TASK] = function()
			...
			return var_2_10000(var_29_0, var_2_10002.island_task[var_27_1].name)
		end,
		[var_0_1.UNLOCK_TYPE.EXIST_ABILITY] = function()
			i18n = var_2_10000
			...
			return var_2_10000(var_30_0, var_2_10002.island_ability_template[var_27_1].unlock_text)
		end,
		[var_0_1.UNLOCK_TYPE.FINISH_TECHNOLOGY] = function()
			i18n = var_2_10000
			...
			return var_2_10000(var_31_0, var_2_10002.island_technology_template[var_27_1].tech_name)
		end
	})
end
