...
function var_0_1.UpdateCollectData(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_2 == var_0_1.slotType.Task then
		...
		local var_4_2 = var_4_1.DispatchEvent

		IslandBuildingAgency = var_1_10006

		var_4_2(var_1_10005, var_1_10006.COLLECT_SLOT_UNIT_REMOVE, {
	...
	local var_4_3 = arg_4_0.placeData.placeId

	IslandProductConst = var_1_10005

	if var_4_3 == var_1_10005.MinePlaceId then
		local var_4_4 = var_4_1
		local var_4_5 = var_4_1.DispatchEvent

		IslandBuildingAgency = var_1_10006

		var_4_5(var_4_4, var_1_10006.COLLECT_SLOT_UNIT_REMOVE, {
			slotId = arg_4_0.configId
		})
	end
