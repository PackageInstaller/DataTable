...
function var_0_1.OnInit(arg_2_0)
	...
	if var_2.OnlyShowOwnedFrame == true then
		...
		for iter_2_0, iter_2_1 in var_2(var_3.island_camera_photo_frame.all) do
			pg = var_1_10007
			...
			if var_1_10008 then
				...
				var_1_10010.insert(arg_2_0.frameDataList, iter_2_1)
			end
		end
	else
		pg = var_2
	...
	local function var_2_6()
		...
		var_3_0(var_3_1, var_2.GetChild(var_3_2, 0), #arg_2_0.frameDataList, function(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_2_7 = var_3.UIMgr.GetInstance()
	...
	UIItemList = var_3
	arg_2_0.frameUIList = var_3.New(var_2_4, var_2_4:GetChild(0))

	local var_2_8 = arg_2_0.frameUIList

	var_3.make(var_2_8, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_2_10005(var_2_10006.format("Island/IslandPhotoFrame/%s", var_3.farme_small_path), "", arg_5_2:Find("Icon"))
			...
			var_7(arg_2_0, arg_5_2, function()
				...
				local var_6_1 = var_0.frameTfName == "IslandFilmFrame"
				local var_6_2 = var_0.frameTfName == "IslandInsFrame"
				...
				local function var_6_3(arg_7_0)
					...
					var_7_1(var_7_0, var_4_10004(var_4_10005)).texture = arg_2_0.texture
					GameObject = var_3
					...
					for iter_7_0, iter_7_1 in var_5(var_7_3) do
						...
						var_7_5(var_7_4, var_4_10013(var_4_10014)).texture = arg_2_0.texture
						GameObject = var_12
				...
				IslandAssetLoadDispatcher = var_6_4

				local var_6_5 = var_6_4.Instance
				local var_6_6 = var_4.Enqueue
				local var_6_7 = "ui/" .. var_0.frameTfName
				local var_6_8 = ""

				typeof = var_3_10008
				GameObject = var_3_10009

				local var_6_9 = var_3_10008(var_3_10009)

				UnityEngine = var_3_10009

				local var_6_10 = var_6_6(var_6_5, var_6_7, var_6_8, var_6_9, var_3_10009.Events.UnityAction_UnityEngine_Object(function(arg_8_0)
	...
	local var_2_10 = arg_2_0.cancelBtnTrans
	...
	var_3(var_2_9, var_2_10, var_2_11, var_7)

	onButton = var_3

	local var_2_12 = arg_2_0
	local var_2_13 = arg_2_0.confirmBtnTrans
	...
	var_3(var_2_12, var_2_13, var_2_14, var_7)
...
function var_0_1.SelectFrame(arg_17_0)
	...
	local var_17_3 = var_2:Find("mask/realImage").localScale
	local var_17_4

	pg = var_6

	if var_6.island_camera_photo_frame[var_17_0].frameTfName == "IslandFilmFrame" or var_6 == "IslandInsFrame" then
		var_17_4 = {
		...
		if var_2:Find("mask_down/realImage") then
			var_17_4.downPos = var_2:Find("mask_down/realImage").anchoredPosition
			var_17_4.downScale = var_2:Find("mask_up/realImage").localScale
		end
	end

	existCall = var_1_10007

	var_1_10007(arg_17_0.selectCallback, {
