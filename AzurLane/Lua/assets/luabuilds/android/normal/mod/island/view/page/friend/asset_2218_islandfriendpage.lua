...
function var_0_1.OnLoaded(arg_4_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_4_0.giftTipTxt = var_4_3(var_4_2, var_3(var_1_10004))
	UIItemList = var_1

	local var_4_4 = var_1.New
	local var_4_5 = arg_4_0._tf
	local var_4_6 = var_2.Find(var_4_5, "adapt/toggles/content")
	local var_4_7 = arg_4_0._tf

	arg_4_0.uiToggleList = var_4_4(var_4_6, var_3.Find(var_4_7, "adapt/toggles/content/tpl"))
	...
	IslandFriendListPage = var_3
	var_4_9[var_4_10] = var_3.New(arg_4_0.mainTr, arg_4_0.event)
	...
	local var_4_19 = var_2.Find(var_4_18, "top/title/Text")

	i18n = var_4_18

	var_4_9(var_4_19, var_4_18("island_btn_label_visit"))
...
function var_0_1.AddListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10003.FRIEND_SEARCH_DONE, arg_5_0.OnSearch)
	...
	var_5_3(var_5_2, var_3.ISLAND_REFRESH_INVITECODE_DONE, arg_5_0.OnRefreshInviteCode)
	...
	var_5_5(var_5_4, var_3.ISLAND_ACCESS_OP_DONE, arg_5_0.OnAccessOp)
	...
	var_5_7(var_5_6, var_3.FRIEND_DELETE_DONE, arg_5_0.OnDelFriend)
	...
	var_5_9(var_5_8, var_3.OTHER_FETCH_CNT_UPDATE, arg_5_0.OnOtherFetchCntUpdate)
	...
	var_5_11(var_5_10, var_3.FRIEND_REQUEST_REMOVED, arg_5_0.OnRequestChange)
	...
	var_5_13(var_5_12, var_3.FRIEND_REQUEST_ADDED, arg_5_0.OnRequestChange)
	...
	var_5_15(var_5_14, var_3.FRIEND_SEND_REQUEST_DONE, arg_5_0.OnAddFriendDone)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.FRIEND_SEARCH_DONE, arg_6_0.OnSearch)
	...
	var_6_3(var_6_2, var_3.ISLAND_REFRESH_INVITECODE_DONE, arg_6_0.OnRefreshInviteCode)
	...
	var_6_5(var_6_4, var_3.ISLAND_ACCESS_OP_DONE, arg_6_0.OnAccessOp)
	...
	var_6_7(var_6_6, var_3.FRIEND_DELETE_DONE, arg_6_0.OnDelFriend)
	...
	var_6_9(var_6_8, var_3.OTHER_FETCH_CNT_UPDATE, arg_6_0.OnOtherFetchCntUpdate)
	...
	var_6_11(var_6_10, var_3.FRIEND_REQUEST_REMOVED, arg_6_0.OnRequestChange)
	...
	var_6_13(var_6_12, var_3.FRIEND_REQUEST_ADDED, arg_6_0.OnRequestChange)
	...
	var_6_15(var_6_14, var_3.FRIEND_SEND_REQUEST_DONE, arg_6_0.OnAddFriendDone)
...
function var_0_1.OnShowMsg(arg_14_0, arg_14_1)
	...
	var_14_2.type = var_1_10005.TYPE_WHITOUT_BTN
...
function var_0_1.OnInit(arg_15_0)
	...
	local var_15_2 = var_3.Find(var_15_1, "top/title/help")
	...
	local function var_15_3()
		...
		var_16_2.type = var_2_10003
		pg = var_2_10003
		var_16_2.helps = var_2_10003.gametip.island_help_friends.tip
	...
	var_1_10001(var_15_4, var_15_5, var_15_6, var_5)
	...
	var_1.make(var_15_7, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			SF_PANEL = var_2_10007

			var_3(var_18_0, var_18_1, var_18_2, var_2_10007)
			...
			var_4(arg_18_2:Find("sel/content/Image"), var_18_3, true)

			table = var_4

			var_4.insert(arg_15_0.toggles, arg_18_2)
		end
...
function var_0_1.UpdateTip(arg_20_0)
	...
	local var_20_2 = var_20_0.Find(var_20_1, "tip")

	getProxy = var_20_1
	NotificationProxy = var_5

	local var_20_3 = var_20_1(var_5)

	var_2(var_20_2, var_4.getRequestCount(var_20_3) > 0)
...
function var_0_1.UpdateGiftTxt(arg_23_0)
	...
	local var_23_4 = var_1:GetMaxOtheFetchcnt()
	local var_23_5 = arg_23_0.giftTipTxt

	i18n = var_1_10005
	var_23_5.text = var_1_10005("island_git_cnt_tip") .. var_23_3 .. "/" .. var_23_4
