...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("...page.temp.IslandExternalBridgePage"))
...
function var_0_1.AddListeners(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10003.PLAY_ROOM_ALL_LOAD_OVER, arg_1_0.OnRoomAllLoadDone)
	...
	var_1_3(var_1_2, var_3.PLAY_ROOM_REDAY_ROOM_REFRESH, arg_1_0.OnRefreshModel)
	...
	var_1_5(var_1_4, var_3.PLAY_ROOM_MATCH_REDAY_ROOM_REFRESH, arg_1_0.OnRefreshModel)
	...
	var_1_7(var_1_6, var_3.ISLAND_CHEATER_CHANGE_VIEW_DRESSID, arg_1_0.OnRefreshModel)
	...
	var_1_9(var_1_8, var_3.PLAY_ROOM_ENTER_LOAD, arg_1_0.OnRefreshModel)
...
function var_0_1.RemoveListeners(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10003.PLAY_ROOM_ALL_LOAD_OVER, arg_2_0.OnRoomAllLoadDone)
	...
	var_2_3(var_2_2, var_3.PLAY_ROOM_REDAY_ROOM_REFRESH, arg_2_0.OnRefreshModel)
	...
	var_2_5(var_2_4, var_3.PLAY_ROOM_MATCH_REDAY_ROOM_REFRESH, arg_2_0.OnRefreshModel)
	...
	var_2_7(var_2_6, var_3.ISLAND_CHEATER_CHANGE_VIEW_DRESSID, arg_2_0.OnRefreshModel)
	...
	var_2_9(var_2_8, var_3.PLAY_ROOM_ENTER_LOAD, arg_2_0.OnRefreshModel)
...
function var_0_1.GetContext(arg_6_0)
	...
	var_6_1.mediator = var_1_10003
	PlayRoomInfoScene = var_1_10003
	var_6_1.viewComponent = var_1_10003
...
function var_0_1.AddSubLayers(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_7_2(var_7_1, var_1_10006)
	...
	var_7_5(var_7_4, var_1_10007.LOAD_LAYERS, {
...
function var_0_1.RefreshLight(arg_12_0)
	...
	if var_2.GetGameLoadData(var_12_1) == nil then
		...
		if var_12_2 == var_1_10004.SceneRoomType.CustomRoom then
			var_12_3 = var_12_0
			var_12_4 = var_12_0.GetRoomData(var_12_3)
		else
			local var_12_5 = arg_12_0.sceneRoomType

			IslandCheaterTavernConst = var_12_3

			if var_12_5 == var_12_3.SceneRoomType.MatchInfoRoom then
				var_12_4 = var_12_0:GetMatchRoomData()
			end
		end
	end
	...
	local var_12_6 = var_12_4.teamPosList

	for iter_12_0 = 1, arg_12_0.playerSlotCount do
		if var_12_6[iter_12_0] and var_12_6[iter_12_0][1] then
			local var_12_7 = arg_12_0.playRoomProxy

			if not var_8.GetGameLoadData(var_12_7) then
				table = var_8

				if var_8.keyof(var_12_4.readyList, var_12_6[iter_12_0][1]) then
					setActive = var_8
...
function var_0_1.LoadRoomPlayerModel(arg_13_0)
	getProxy = var_1_10001
	PlayRoomProxy = var_1_10002
	arg_13_0.playRoomProxy = var_1_10001(var_1_10002)
	...
	if var_2.GetGameLoadData(var_13_1) == nil then
		...
		if var_13_2 == var_1_10004.SceneRoomType.CustomRoom then
			var_1_10004 = var_13_0
			var_13_3 = var_13_0.GetRoomData(var_1_10004)
		else
			local var_13_4 = arg_13_0.sceneRoomType

			IslandCheaterTavernConst = var_1_10004

			if var_13_4 == var_1_10004.SceneRoomType.MatchInfoRoom then
				var_1_10004 = var_13_0
				var_13_3 = var_13_0.GetMatchRoomData(var_1_10004)
			end
		end
	end
	...
	arg_13_0.playerSlotCount = var_1_10004.GetMaxTeamCnt(var_13_3.gameType)
		...
		if var_13_5[iter_13_0] then
			...
			if var_13_3.playerDataList[var_13_6] then
				...
				if not arg_13_0.dressHelperDic[iter_13_0] then
					...
					IslandShipDressHelperMiniGameNew = var_1_10012
					var_13_9[iter_13_0] = var_1_10012.New()
					var_1_10012 = arg_13_0.dressHelperDic[iter_13_0]
					var_13_9 = var_13_9.SetShipId

					local var_13_10 = var_13_8.ship_id
					local var_13_11
					...
					var_13_9(var_1_10012, var_13_10, var_13_11)
				end

				CheaterTavernHelper = var_13_9

				local var_13_12 = var_13_9.GetModelDataByViewData(var_13_8)

				arg_13_0:LoadCharacter(iter_13_0, var_13_12)
			else
...
function var_0_1.CreateCharacterContainer(arg_18_0)
	...
	var_18_0(var_18_1, var_1_10003.Character3D)
...
function var_0_1.ActivityCharacterCamera(arg_20_0)
	...
	IslandCameraMgr = var_20_0

	local var_20_2 = var_20_0.instance

	IsNil = var_1_10003

	if var_1_10003(var_20_2) then
...
function var_0_1.InitSceneTimeline(arg_21_0)
	...
	if var_1_10001.Find("[sequence]") then
		...
		local var_21_2 = var_21_1(var_21_0, var_1_10004(var_1_10005.Playables.PlayableDirector))

		TimelineSupport = var_21_0

		var_21_0.DynamicBinding(var_21_2)
		var_21_2:Play()
	end
...
function var_0_1.ClearCharacterScene(arg_22_0, arg_22_1)
	...
	if arg_22_0.isLoadCharacterScene then
		...
		var_22_1(var_22_0, var_4.REFRESH_WEATHER_SYSTEM)
	end
...
function var_0_1.OnHome(arg_24_0)
	arg_24_0:ClearCharacterScene(function()
		...
		var_25_1(var_25_0, var_2_10002.ON_HOME)
...
function var_0_1.LoadCharacter(arg_26_0, arg_26_1, arg_26_2)
	...
	local function var_26_1(arg_27_0)
		if arg_26_0.modelDataDic[arg_26_1] == nil or var_1.modelData.model ~= arg_26_2.model then
			var_2_10003 = arg_26_0
			var_2_10003 = var_2.GetPoolMgr(var_2_10003)

			var_2.ReturnCharacter(var_2_10003, arg_26_2.model, arg_26_2.animator, arg_27_0)
		...
		typeof = var_2_10005
		CharacterHandleController = var_2_10006

		var_2_10003(var_27_1, var_2_10005(var_2_10006))

		local var_27_2 = arg_26_0.modelDataDic[arg_26_1]

		var_27_2.role = var_27_0
		pg = var_27_2
		...
		var_27_3(var_27_4, var_5.Character3D)

		setParent = var_27_3

		var_27_3(var_27_0, arg_26_0.roleContainer)

		local var_27_5 = var_27_0.transform

		Vector3 = var_4
		var_27_5.eulerAngles = var_4(0, 180, 0)
		GameObject = var_27_5

		local var_27_6 = var_27_5.Find("UICamera")
		local var_27_7 = var_3.GetComponent

		typeof = var_5
		Camera = var_6

		local var_27_8 = var_27_7(var_27_6, var_5(var_6))
		local var_27_9 = arg_26_0.playerCharTF[arg_26_1]
		local var_27_10 = var_27_8
		local var_27_11 = var_27_8.WorldToScreenPoint(var_27_10, var_27_9.position)

		IslandCameraMgr = var_27_10

		local var_27_12 = var_27_10.instance

		IsNil = var_7

		if var_7(var_27_12) then
			CheatTavernCameraMgr = var_7
			var_27_12 = var_7.instance
		end

		local var_27_13 = var_27_12._mainCamera
		local var_27_14 = var_7.ScreenToWorldPoint

		Vector3 = var_2_10009

		local var_27_15 = var_27_14(var_27_13, var_2_10009(var_27_11.x, var_27_11.y, 10))
		local var_27_16 = var_27_0.transform

		Vector3 = var_9
		var_27_16.localPosition = var_9(var_27_15.x, var_27_15.y + 0.4, var_27_15.z)

		local var_27_17 = arg_26_0

		var_8.OnCharLoaded(var_27_17, arg_26_1, arg_26_2)
...
function var_0_1.UnloadCharacter(arg_30_0, arg_30_1)
	if arg_30_0.modelDataDic[arg_30_1] and var_2.role then
		...
		var_30_1(var_30_2, var_1_10006.Default)
...
function var_0_1.LoadLightEffect(arg_31_0, arg_31_1)
	...
	for iter_31_0 = 1, arg_31_1 do
		...
		typeof = var_1_10011
		Camera = var_1_10012
		var_1_10009 = var_1_10009(var_31_3, var_1_10011(var_1_10012))

		local var_31_4 = arg_31_0.playerCharTF[iter_31_0]

		var_1_10012 = var_1_10009
		var_1_10011 = var_1_10009.WorldToScreenPoint(var_1_10012, var_31_4.position)
		IslandCameraMgr = var_1_10012
		var_1_10012 = var_1_10012.instance
		IsNil = var_13

		if var_13(var_1_10012) then
			CheatTavernCameraMgr = var_13
			var_1_10012 = var_13.instance
		end

		local var_31_5 = var_1_10012._mainCamera
		local var_31_6 = var_13.ScreenToWorldPoint

		Vector3 = var_1_10015

		local var_31_7 = var_31_6(var_31_5, var_1_10015(var_1_10011.x, var_1_10011.y, 10))

		Vector3 = var_31_5

		local var_31_8 = var_31_5(var_31_7.x, var_31_7.y + 0.4, var_31_7.z)

		table = var_1_10015

		var_1_10015.insert(var_31_2, function(arg_32_0)
			...
			var_1.GetSceneProductEffect(var_32_1, var_31_0, function(arg_33_0)
				if arg_31_0.isExit then
					...
					var_33_2.localPosition = var_31_8
					setParent = var_33_2
		...
		var_1_10015.insert(var_31_2, function(arg_34_0)
...
function var_0_1.UnLoadLightEffect(arg_37_0)
	...
	for iter_37_0, iter_37_1 in var_1_10003(arg_37_0.readyEffectList) do
		local var_37_2 = arg_37_0:GetPoolMgr()

		var_8.ReturnSceneProductEffect(var_37_2, var_37_1, iter_37_1)
	end
	...
	for iter_37_2, iter_37_3 in var_3(arg_37_0.unReadyEffectList) do
		...
		var_8.ReturnSceneProductEffect(var_37_3, var_37_0, iter_37_3)
	end
...
function var_0_1.ResetCameraMask(arg_39_0)
	...
	if arg_39_0.defaultCullingMask and var_39_0 then
		...
		var_3.ResetCamCullingMask(var_39_1, arg_39_0.defaultCullingMask)
	end
...
function var_0_1.ActivityPlayerCamera(arg_40_0)
	...
	var_40_1(var_40_0, var_1_10003.FOLLOW_CAMERA_NAME)
...
function var_0_1.LoadCharacterScene(arg_46_0, arg_46_1)
	...
	var_46_2(var_46_1, var_46_3, var_46_4, var_1_10007.Additive, function(arg_47_0)
		if arg_47_0 == 1 then
			arg_46_1()
		end
