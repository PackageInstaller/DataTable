...
function var_0_1.Init(arg_2_0)
	...
	var_2_1(var_2_3, var_1_10004.format("%s/%s", var_2_2, var_2_2))

	onButton = var_2_1

	var_2_1(arg_2_0, arg_2_0.uiqueryBtn, function()
		local var_5_0 = arg_2_0
		local var_5_1 = var_0.emit

		IslandMediator = var_2_10002

		local var_5_2 = var_2_10002.CHEATER_TAVERN_OPERATE

		IslandCheaterTavernConst = var_2_10003

		var_5_1(var_5_0, var_5_2, var_2_10003.PlayerOperateType.Query)

		return
	end)

	GetOrAddComponent = var_2_1

	local var_2_4 = var_2_1(arg_2_0.uishootBtn, "EventTriggerListener")
	local var_2_5 = 10
	...
	var_2_4:AddDragFunc(function(arg_7_0, arg_7_1)
		...
		if not var_2_10002 then
			...
			if (var_7_0 - var_2_10003).magnitude >= var_2_5 then
				...
				local var_7_5 = var_2_10005.CHEATER_TAVERN_OPERATE

				IslandCheaterTavernConst = var_2_10006

				var_7_4(var_7_3, var_7_5, var_2_10006.PlayerOperateType.Shoot)
			end
	...
	var_4(arg_2_0, arg_2_0.uiDelegate, function()
		...
		var_9_1(var_9_0, var_2_10002.CHEATER_TAVERN_CANCEL_DELEGATE)
	...
	var_4(arg_2_0, arg_2_0.uiputCardBtn, function()
		...
		if var_10_0.putCardTest then
			var_2_10002 = arg_2_0.cardViewManager

			var_1.PutDownMainCard(var_2_10002, var_10_1)

			return
		end

		if #var_10_1 ~= 0 then
			IslandCheaterTavernConst = var_2_10002

			if var_1 > var_2_10002.putCountMax then
				return
			end
			...
			local var_10_4 = var_2_10004.CHEATER_TAVERN_OPERATE

			IslandCheaterTavernConst = var_2_10005

			var_10_3(var_10_2, var_10_4, var_2_10005.PlayerOperateType.PutCard, var_10_1)
	...
	local var_2_7 = var_2_6(var_5.GetGameTypeID())
	...
	var_5(var_2_8, var_7("bar_ui_start2"))
	...
	var_5(var_2_9, var_7("bar_ui_start1"))
	...
	var_5(var_2_10, var_7("bar_ui_game3"))
	...
	var_5(var_2_11, var_7("bar_ui_game4"))
	...
	var_5(var_2_12, var_7("bar_ui_game1"))
	...
	var_5(var_2_13, var_7.UIMgr.GetInstance().OverlayToast)
...
function var_0_1.OnCheaterOperateDone(arg_11_0, arg_11_1)
	...
	if var_11_0 == var_1_10003.PlayerOperateType.PutCard then
		...
		arg_11_0.PutMainCardDone(var_11_1, arg_11_1.arg_list)
	else
		local var_11_2 = arg_11_1.type

		IslandCheaterTavernConst = var_11_1

		if var_11_2 == var_11_1.PlayerOperateType.Shoot then
			setActive = var_11_2

			var_11_2(arg_11_0.uishootOp, false)
		else
			setActive = var_11_2

			var_11_2(arg_11_0.uiopBtn, false)
		end
	end
...
function var_0_1.UpdataLastBoutDisplay(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_3 = var_1_10006(var_1_10007)

	if var_17_0 == var_6.getRawData(var_17_3).id then
		var_1_10008 = arg_17_0.cheaterTavernAgency

		local var_17_4

		if not var_7.GetMainPlayer(var_1_10008) then
			var_1_10008 = arg_17_0.cheaterTavernAgency
			var_17_4 = var_7.GetPlayerData(var_1_10008, var_17_0)
		end

		getProxy = var_1_10008
		PlayerProxy = var_1_10009

		local var_17_5 = var_1_10008(var_1_10009)
		local var_17_6 = var_8.getRawData(var_17_5).id
		...
		local var_17_8 = arg_17_1.type
		local var_17_9 = {}

		IslandCheaterTavernConst = var_1_10013
		var_17_9[var_1_10013.PlayerOperateType.PutCard] = function()
			var_17_7()
		...
		IslandCheaterTavernConst = var_13
		var_17_9[var_13.PlayerOperateType.Query] = function()
			var_17_7()
			...
			if var_0 then
				...
				var_2(var_20_2, var_2_10004(var_0_2[1], var_0_2[2]))
			else
				...
				var_2(var_20_4, var_2_10004(var_0_3[var_20_3][1], var_0_3[var_20_3][2]))
			end

			local var_20_5

			if var_0 then
				var_20_5 = var_17_4.seat

				local var_20_6 = "questSeet0" .. var_20_5

				CheatTavernCameraMgr = var_4
				var_2_10005 = var_4.instance

				var_4.ActiveVirtualCamera(var_2_10005, var_20_6)
			...
			var_20_9(var_20_8, var_2_10005.PLAYER_QUESTION_ANIMATION, var_17_0, var_0, var_20_5)
			...
			local function var_20_10()
				...
				var_2.PlayerCardSetActive(var_22_7, var_17_6, false)
			...
			local function var_20_11()
				...
				local var_24_9 = var_3_10005(var_24_0, var_24_3)

				i18n = var_6

				var_24_8(var_24_7, var_24_9, var_6("bar_tips_game5", var_20_0 == 1 and var_24_6 or var_24_3))
			...
			if arg_17_0.questionTimer then
				var_20_12 = arg_17_0.questionTimer
			...
			Timer = var_20_12
			var_20_13.questionTimer = var_20_12.New(function()
				var_20_10()
			...
			Timer = var_20_14
			var_20_15.tipsTimer = var_20_14.New(function()
				var_20_11()
		...
		IslandCheaterTavernConst = var_13
		var_17_9[var_13.PlayerOperateType.Shoot] = function()
			var_17_7()
			...
			local var_28_4 = var_17_4
			local var_28_5, var_28_6 = var_2.GetCurrentBombId(var_28_4)
			local var_28_7 = var_17_4.seat
			local var_28_8 = arg_17_0.parent
			local var_28_9 = var_5.emitCore

			CheaterTavernEvent = var_2_10007

			var_28_9(var_28_8, var_2_10007.SHOOT_AND_TURN_TABLE, var_0, var_28_7, var_28_5, var_28_6, var_28_1 == 1)
			...
			function var_17_2()
				...
				var_1.PlayerCardSetActive(var_29_2, var_17_6, true)

				local var_29_3 = var_17_4
				...
				var_29_7(var_29_6, var_3_10005(var_29_5, var_29_4))
				...
				if var_28_1 == 1 then
					...
					local var_29_10 = var_17_4.seat
					local var_29_11 = arg_17_0.parent
					local var_29_12 = var_4.emitCore

					CheaterTavernEvent = var_6

					local var_29_13 = var_6.PLAYER_OUT_ANIMATION
					local var_29_14 = var_17_0
					local var_29_15 = var_29_10
					local var_29_16 = var_17_0

					getProxy = var_3_10010
					PlayerProxy = var_3_10011

					local var_29_17 = var_3_10010(var_3_10011)

					var_29_12(var_29_11, var_29_13, var_29_14, var_29_15, var_29_16 == var_10.getRawData(var_29_17).id)
				end

				local var_29_18

				if arg_17_0.playerUserIndexDic[var_17_0] then
					var_29_18 = arg_17_0.playerHudTFDic[var_3]

					if var_28_1 == 1 then
						local var_29_19 = arg_17_0.playerList[var_3]
						local var_29_20 = var_5.IsOut(var_29_19)

						setActive = var_29_19

						var_29_19(var_29_18:Find("out"), var_29_20)
					end
				end

				onNextTick = var_29_18
		...
		var_1_10010(var_17_8, var_17_9, function()
			return
		end)
...
function var_0_1.OnPlayerEscape(arg_35_0, arg_35_1)
	...
	local var_35_2 = arg_35_0.playerUserIndexDic[arg_35_1]
	local var_35_3 = arg_35_0.playerHudTFDic[var_35_2]

	setActive = var_1_10005

	var_1_10005(var_35_3:Find("out"), true)

	setActive = var_1_10005

	var_1_10005(var_35_3:Find("hp"), false)

	local var_35_4 = arg_35_0.cardViewManager

	var_5.OtherPlayerCardDestroy(var_35_4, arg_35_1)

	local var_35_5 = arg_35_0.parent
	local var_35_6 = var_5.emitCore

	CheaterTavernEvent = var_7

	local var_35_7 = var_7.PLAYER_OUT_ANIMATION
	local var_35_8 = arg_35_1
	local var_35_9 = var_2.seat

	getProxy = var_1_10010
	PlayerProxy = var_1_10011

	local var_35_10 = var_1_10010(var_1_10011)

	var_35_6(var_35_5, var_35_7, var_35_8, var_35_9, arg_35_1 == var_10.getRawData(var_35_10).id)
...
function var_0_1.OnInitPlayerHudInfoItem(arg_37_0, arg_37_1, arg_37_2)
	...
	var_37_1(var_37_3, var_37_2("bar_ui_game1"))
	...
	local var_37_6 = var_37_0.Find(var_37_5, "hp/hpNum")

	string = var_37_5

	var_37_3(var_37_6, var_37_5.format("%s/%s", var_37_4, var_37_4))

	setActive = var_37_3

	var_37_3(arg_37_0.uiOutGo, false)

	setActive = var_37_3

	var_37_3(arg_37_0.uiHpGo, true)
...
function var_0_1.OnUpdatePlayerHudInfoItem(arg_38_0, arg_38_1, arg_38_2)
	...
	if var_1_10016.abs(var_38_11 - var_6) == 2 then
		var_38_12 = 0.3
	end
	...
	IslandCheaterTavernConst = var_1_10018

	local var_38_14 = var_16(var_38_13, var_1_10018.hudHeight + var_38_12, var_38_9)
	local var_38_15 = arg_38_0

	var_38_0.localPosition = arg_38_0.WorldPosition2LocalPosition(var_38_15, arg_38_0.uiplayerInfoList, var_38_14)
	setText = var_38_15

	local var_38_16 = var_38_0
	local var_38_17 = var_38_0.Find(var_38_16, "adapt/name")

	tostring = var_38_16

	var_38_15(var_38_17, var_38_16(var_5.player_info.name))

	local var_38_18, var_38_19 = var_5:GetCurrentAndAllHp()

	setText = var_20

	var_20(var_38_0:Find("hp/hpNum"), var_38_18 .. "/" .. var_38_19)

	local var_38_20

	if arg_38_0.operation then
		var_38_20 = arg_38_0.operation.user_id == var_5.user_id
	end

	setActive = var_21

	var_21(var_38_0:Find("in_process"), var_38_20)

	local var_38_21 = var_5
	local var_38_22 = var_5.IsOut(var_38_21)

	setActive = var_38_21

	var_38_21(var_38_0:Find("hp"), not var_38_22)

	setActive = var_38_21

	var_38_21(var_38_0:Find("adapt/delegate"), var_5:IsDelegate())
...
function var_0_1.StartRounCountDown(arg_39_0, arg_39_1)
	...
	arg_39_0.randCoundDownTimer = var_2.New(function()
		...
		if var_40_2 < 0 then
			...
			var_1(var_40_3, var_3.GetNumSpriteByIndex(var_40_4, 0), true)
			...
			var_1(var_40_5, var_3.GetNumSpriteByIndex(var_40_6, 0), true)
		...
		local var_40_9 = var_2.floor(var_40_8 / 10)
		...
		if var_40_9 <= 0 then
			...
			var_4(var_40_11, var_6.GetNumSpriteByIndex(var_40_12, var_40_10), true)
		...
		var_4(var_40_13, var_6.GetNumSpriteByIndex(var_40_14, var_40_9), true)
		...
		var_4(var_40_15, var_6.GetNumSpriteByIndex(var_40_16, var_40_10), true)
...
function var_0_1.OnCheaterEveryRoundStartDone(arg_44_0, arg_44_1)
	...
	local var_44_6 = var_44_4.bar_card[var_44_5]

	GetImageSpriteFromAtlasAsync = var_6

	var_6("Island/IslandCheaterTavernIcon/" .. var_44_6.card_res, "", arg_44_0.uirealCard)

	GetImageSpriteFromAtlasAsync = var_6

	var_6("Island/IslandCheaterTavernIcon/" .. var_44_6.card_res, "", arg_44_0.uirealCardTip)

	local var_44_7 = arg_44_0

	arg_44_0.RemoveRealCardTipShowTime(var_44_7)

	pg = var_6

	local var_44_8 = var_6.gameset.bar_refreshcard_time.key_value

	Timer = var_44_7
	arg_44_0.realCardTipShowTimer = var_44_7.New(function()
	...
	local var_44_9 = arg_44_0.realCardTipShowTimer

	var_7.Start(var_44_9)
...
function var_0_1.OnCheaterReconected(arg_46_0, arg_46_1)
	...
	local var_46_5 = var_46_3.bar_card[var_46_4]

	GetImageSpriteFromAtlasAsync = var_5

	var_5("Island/IslandCheaterTavernIcon/" .. var_46_5.card_res, "", arg_46_0.uirealCard)

	GetImageSpriteFromAtlasAsync = var_5

	var_5("Island/IslandCheaterTavernIcon/" .. var_46_5.card_res, "", arg_46_0.uirealCardTip)
...
function var_0_1.UpdateOneBout(arg_52_0, arg_52_1)
	...
	if var_2.putCardTest then
		...
		var_2(var_3.Find(var_52_0, "putCard"), true)
	...
	if not arg_52_0.IsSelf(var_52_1, arg_52_1.user_id) then
		return
	end

	local var_52_2 = arg_52_1.operationType

	IslandCheaterTavernConst = var_52_1

	if var_52_2 >= var_52_1.PlayerCurrentOperateType.ShootByOther then
		local var_52_3 = arg_52_0.cheaterTavernAgency
		local var_52_4 = var_52_2.GetMainPlayer(var_52_3)
		local var_52_5, var_52_6 = var_52_2.GetCurrentAndAllHp(var_52_4)

		if var_52_5 == var_52_6 then
			local var_52_7 = arg_52_0.cardViewManager

			var_5.ClearTableCard(var_52_7)

			setActive = var_5

			var_5(arg_52_0.uishootOp, true)

			local var_52_8 = arg_52_0.parent
			local var_52_9 = var_5.emitCore

			CheaterTavernEvent = var_7

			var_52_9(var_52_8, var_7.FIRST_TAKE_SHOOT_TIPS, var_52_2.seat)
		end
	...
	var_52_2(arg_52_0.uiopBtn, true)

	IslandCheaterTavernRecordTools = var_52_2

	var_52_2.StartPutCardTime()

	local var_52_10 = arg_52_0.cheaterTavernAgency
	local var_52_11 = var_2.CheckCanOnlyQurey(var_52_10)

	setActive = var_52_10

	local var_52_12 = arg_52_0.uiopBtn

	var_52_10(var_4.Find(var_52_12, "putCard"), not var_52_11)

	setActive = var_52_10

	local var_52_13 = arg_52_0.uiopBtn

	var_52_10(var_4.Find(var_52_13, "query"), arg_52_0.tableCardNum > 0)
...
function var_0_1.UpdataHp(arg_53_0)
	...
	if var_1.IsOut(var_53_1) then
		...
		local var_53_2, var_53_3 = var_1:GetCurrentAndAllHp()

		setText = var_4

		var_4(arg_53_0.uicurHpNum, var_53_2 .. "/" .. var_53_3)
	end
...
function var_0_1.WorldPosition2LocalPosition(arg_56_0, arg_56_1, arg_56_2)
	...
	local var_56_3 = var_56_0:ViewportToScreenPoint(var_56_2)
	local var_56_4 = arg_56_1
	local var_56_5 = arg_56_1.GetComponent(var_56_4, "RectTransform")

	LuaHelper = var_56_4

	return (var_56_4.ScreenToLocal(var_56_5, var_56_3, var_56_0))
end
...
function var_0_1.UpdateDelegateState(arg_57_0)
	...
	var_57_0(arg_57_0.uiDelegate, var_57_1:IsDelegate())
