...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.iconRaw = var_2_3(var_2_2, var_3(var_1_10004))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_2()
		...
		if not var_2_10000(arg_3_0.inputTr) or var_0 == "" then
			...
			var_4_1(var_4_0, var_2_10003("island_input_theme_name"))
...
function var_0_1.OnShow(arg_5_0)
	...
	var_1_10001(var_5_0, var_1_10003("island_custom_theme_name", arg_5_0.settings.id))

	local var_5_1 = arg_5_0.settings

	i18n = var_5_0
	var_5_1.content = var_5_0("island_custom_theme_name_tip")
...
function var_0_1.LoadRawTex(arg_7_0, arg_7_1)
	...
	if not var_3.FileExists(var_7_0) then
		return
	end
