...
function var_0_0.SetUp(arg_3_0)
	...
	arg_3_0.layer1ContainerCg = var_2(var_3_3, var_4(var_1_10005))
...
function var_0_0.AddUnit(arg_11_0, arg_11_1)
	...
	IslandSceneUnit = var_1_10005

	var_1_10002(var_1_10003(var_11_0, var_1_10005), "unit should be IslandSceneUnit")

	local var_11_1 = arg_11_0
	local var_11_2 = arg_11_0.GetUnitListByKey(var_11_1, arg_11_1:GetUnitType())

	table = var_11_1

	var_11_1.insert(var_11_2, arg_11_1)
...
function var_0_0.RemoveUnit(arg_12_0, arg_12_1)
	...
	var_1_10002(var_1_10003(var_12_0, var_1_10005), "unit should be IslandSceneUnit")

	local var_12_1 = arg_12_0
	local var_12_2 = arg_12_0.GetUnitListByKey(var_12_1, arg_12_1:GetUnitType())

	table = var_12_1

	var_12_1.removebyvalue(var_12_2, arg_12_1)
...
function var_0_0.NotifiyCore(arg_17_0, arg_17_1, ...)
	...
	var_17_1(var_17_0, var_17_2, var_17_3, var_1_10006({
		...
	}))
...
function var_0_0.ShowMsgbox(arg_25_0, arg_25_1)
	...
	var_25_1(var_25_0, var_1_10004.SHOW_MSG, arg_25_1)
