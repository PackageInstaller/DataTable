...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_10(var_1_6, function()
		...
		if 0 < var_8_0 then
			...
			var_8_0.HandleSamePoint(var_8_1, var_1_1, var_1_2)
		end
		...
		var_0.setRankList(var_8_2, var_1_0, var_1_1, var_1_2)
		...
		var_8_4(var_8_3, var_3.ISLAND_GET_SEASON_RANK_DONE, {
			seasonId = var_1_1,
			list = var_1_2,
			playerInfo = var_1_4
		})
