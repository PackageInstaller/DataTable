...
local var_0_2 = var_0_0.island_shop_template

pg = var_2

local var_0_3 = var_2.island_shop_goods
...
function var_0_1.SetShops(arg_2_0, arg_2_1)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_1) do
		...
		var_8.insert(arg_2_0.shops, var_1_10007)

		table = var_8

		var_8.insert(arg_2_0.shopIds, iter_2_1.id)
	end
...
function var_0_1.RefreshShopData(arg_6_0, arg_6_1)
	...
	local var_6_2 = var_1_10004.ISLAND_SHOP_OP
	local var_6_3 = {}

	IslandConst = var_1_10006
	var_6_3.operation = var_1_10006.SHOP_GET_DATA
...
function var_0_1.UpdateShop(arg_7_0, arg_7_1, arg_7_2)
	...
	if arg_7_0.GetShopById(var_7_0, arg_7_1) then
		if arg_7_2 ~= nil then
			...
			var_7_0.removebyvalue(arg_7_0.shops, var_3)

			table = var_7_0

			var_7_0.removebyvalue(arg_7_0.shopIds, arg_7_1)
		end
	elseif arg_7_2 ~= nil then
		IslandShopp = var_7_0

		local var_7_1 = var_7_0.New(arg_7_2, arg_7_0:GetHost())

		table = var_5

		var_5.insert(arg_7_0.shops, var_7_1)
...
function var_0_1.SetSeasonShops(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10002(var_1_10003.island_season[var_18_0].shop_id) do
		local var_18_1 = arg_18_0

		if not arg_18_0.GetShopById(var_18_1, iter_18_1) then
			IslandShopp = var_18_1

			local var_18_2 = var_18_1.New({
				refresh_count = 0,
				refresh_time = 0,
				exist_time = 0,
				id = iter_18_1,
			...
			var_9.insert(arg_18_0.shops, var_18_2)
...
function var_0_1.GetSeasonShops(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_1_10003(var_1_10004.island_season[var_19_0].shop_id) do
