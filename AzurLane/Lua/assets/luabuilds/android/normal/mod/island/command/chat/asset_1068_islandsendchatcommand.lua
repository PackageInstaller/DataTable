...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	IslandChatConst = var_1_10009

	if var_1_0 == var_1_10009.CHANNEL_ISLAND then
		getProxy = var_9
		IslandProxy = var_1_10010
		var_1_10011 = var_9(var_1_10010)

		for iter_1_1 = #var_9.GetChatMsgList(var_1_10011, var_1_1), 1, -1 do
			if var_1_10010[iter_1_1].player.id == var_1_3.id then
