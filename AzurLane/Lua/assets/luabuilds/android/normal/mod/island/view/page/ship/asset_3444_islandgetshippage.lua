...
function var_0_1.OnLoaded(arg_8_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_8_0.chatTxt = var_8_9(var_8_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_8_0.nameTxt = var_8_12(var_8_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_8_0.enNameTxt = var_8_15(var_8_14, var_3(var_1_10004))
	setActive = var_1
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[1] = var_8_19(var_8_18, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[2] = var_8_22(var_8_21, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[3] = var_8_25(var_8_24, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[4] = var_8_28(var_8_27, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[5] = var_8_31(var_8_30, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_8_16[6] = var_8_34(var_8_33, var_4(var_1_10005))
...
function var_0_1.OnInit(arg_10_0)
	...
	local function var_10_8()
		...
		IslandShipMainPage = var_2_10002

		var_13_2(var_13_1, var_2_10002)
...
function var_0_1.OnShow(arg_14_0, arg_14_1)
	...
	var_14_1(var_14_0, var_4.GetModel(var_14_2))
...
function var_0_1.OnCharLoaded(arg_15_0)
	...
	local var_15_1 = var_2.GetChild(var_15_0, 0)

	typeof = var_15_0
	Animator = var_4
	arg_15_0.animator = var_1(var_15_1, var_15_0(var_4))
...
function var_0_1.InitRaderTxt(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10001(var_1_10002.ATTRS) do
...
function var_0_1.InitRader(arg_22_0, arg_22_1)
	...
	local var_22_4 = var_6.insert
	local var_22_5 = var_22_1

	Vector3 = var_8

	var_22_4(var_22_5, var_8(0, 0, 0))

	ipairs = var_22_4

	for iter_22_0, iter_22_1 in var_22_4(var_22_0) do
		local var_22_6 = arg_22_1
		local var_22_7 = arg_22_1.GetAttr(var_22_6, iter_22_1)

		table = var_22_6

		var_22_6.insert(var_22_1, arg_22_0:GetPoint(var_22_3[iter_22_0], var_22_7, 30))
	...
	local var_22_8 = var_6.Vetor3Table2Array(var_22_1)
	local var_22_9 = arg_22_0.drawPolygon

	var_7.draw(var_22_9, var_22_8, var_22_2)
...
function var_0_1.GetPoint(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	local var_23_1 = var_5.Normalize(arg_23_1)
