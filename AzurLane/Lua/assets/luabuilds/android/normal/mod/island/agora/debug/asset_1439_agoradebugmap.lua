...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("Mod.Island.Core.View.IslandBaseOpView"))

Color = var_0_0

local var_0_2 = var_0_0.New(1, 0, 0, 1)

Color = var_2

local var_0_3 = var_2.New(0, 1, 0, 1)
...
function var_0_1.OnInit(arg_2_0, arg_2_1)
	...
	var_1_10002(var_2_0, var_1_10004.UIMgr.GetInstance().UIMain)
	...
	for iter_3_0, iter_3_1 in var_1_10004(arg_3_1) do
		...
		for iter_3_2, iter_3_3 in var_1_10009(iter_3_1) do
			...
			var_1_10014.insert(var_3_0, function(arg_4_0)
				...
				Vector2 = var_2_10004
				var_4_2.position = var_2_10004(iter_3_0, iter_3_2)
...
function var_0_1.FlushAll(arg_6_0, arg_6_1)
	...
	for iter_6_0, iter_6_1 in var_1_10002(arg_6_1) do
		...
		for iter_6_2, iter_6_3 in var_1_10007(iter_6_1) do
			...
			var_6_1(var_6_0, var_1_10014(iter_6_0, iter_6_2), iter_6_3)
		end
	end
...
function var_0_1.UpdateItem(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_2 = var_8_1(var_8_0, var_1_10006(var_1_10007))
	local var_8_3
