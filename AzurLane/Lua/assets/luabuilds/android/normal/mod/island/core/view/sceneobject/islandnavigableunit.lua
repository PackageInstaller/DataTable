...
function var_0_1.OnLaterAttach(arg_2_0, arg_2_1)
	...
	arg_2_0.agent = var_1_10002(var_2_0, var_1_10004(var_1_10005.AI.NavMeshAgent))
	...
	typeof = var_4
	Animator = var_5
	arg_2_0._animator = var_2_3(var_2_2, var_4(var_5))
	...
	typeof = var_4
	UnityEngine = var_5
	arg_2_0._characterController = var_2_5(var_2_4, var_4(var_5.CharacterController))
...
function var_0_1.StopMove(arg_4_0)
	...
	if arg_4_0._animator then
		...
		var_4_2(var_4_1, var_3.SPEED_FLAG_HASH, 0)
	end
...
function var_0_1.Update(arg_5_0)
	...
	if not arg_5_0.IsLoaded(var_5_0) then
		return
	end

	local var_5_1 = arg_5_0.elapsedTime

	Time = var_5_0
	arg_5_0.elapsedTime = var_5_1 + var_5_0.deltaTime
...
function var_0_1.NavUpdate(arg_7_0)
	...
	if not arg_7_0.reached then
		...
		var_1_10008 = var_7_2 * var_7_3
		Time = var_1_10009
		arg_7_0.smoothVelocity = var_7_5(var_7_6, var_1_10008, var_1_10009.deltaTime * 10)
	...
	if not arg_7_0.reached then
		...
		if 0.05 < var_7_8 then
			...
			Quaternion = var_7_11
			var_7_11 = var_7_11.Slerp

			local var_7_12 = arg_7_0._tf.rotation
			local var_7_13 = var_7_9

			Time = var_1_10008
			var_7_10.rotation = var_7_11(var_7_12, var_7_13, var_1_10008.deltaTime * 10)
		end
	end
	...
	var_7_16(var_7_15, var_7_0 * var_7_11.deltaTime)
	...
	local var_7_19 = var_5.Lerp
	local var_7_20 = arg_7_0.agent.nextPosition
	local var_7_21 = var_7_17

	Time = var_1_10008
	var_7_18.nextPosition = var_7_19(var_7_20, var_7_21, var_1_10008.deltaTime * 20)
...
function var_0_1.CheckMovement(arg_19_0)
	...
	if var_19_2(var_4.CANT_SWITCH_TO_MOVEMENT_STATES, function(arg_20_0)
...
function var_0_1.PlayAnimation(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	if arg_21_1 == var_5.ANIMATION_HEROCOMING then
		var_21_0 = 0
	end

	local var_21_1 = arg_21_0
	local var_21_2 = arg_21_0.GetAnimator(var_21_1)

	Animator = var_21_1

	local var_21_3 = var_21_1.StringToHash(arg_21_1)

	for iter_21_0 = 1, var_21_2.layerCount do
		var_21_2:CrossFadeInFixedTime(var_21_3, var_21_0, iter_21_0 - 1)
	end
