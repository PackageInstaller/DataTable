...
function var_0_0.GetRuntimeData(arg_1_0, arg_1_1)
	...
	IslandTaskTargetType = var_1_10008
	var_1_5[var_1_10008.RECYCLE] = function()
		local var_2_0 = var_0
		local var_2_1 = var_0.GetInventoryAgency(var_2_0)

		return var_0.GetOwnCount(var_2_1, var_1_0)
	end
	IslandTaskTargetType = var_8
	var_1_5[var_8.TECHNOLOGY] = function()
		local var_3_0 = var_0
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.ISLAND_LV] = function()
		local var_4_0 = var_0

		return var_0.GetLevel(var_4_0)
	end
	IslandTaskTargetType = var_8
	var_1_5[var_8.FRAGMENT] = function()
		local var_5_0 = var_0
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.COMMANDER_DRESS] = function()
		local var_8_0 = var_0
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.SHIP_DRESS] = function()
		if var_1_0 == 0 then
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.SHIP_SKIN] = function()
		if var_1_0 == 0 then
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.ACHIEVEMENT] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.TASK_TYPE_PLUS] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.RESTAURANT_RANK] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.COMMANDER_DRESS_ID] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.SHIP_DRESS_ID] = function()
		local var_20_0 = var_1_3

		return var_0.GetDressIdRealCount(var_20_0, var_1_0)
	end
	IslandTaskTargetType = var_8
	var_1_5[var_8.ACTIVITY_ORDER] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.ORDER_DAILY] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.ACTION_HELLO_DAILY] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.TASK_DAILY_IN_WEEK] = function()
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.GAME_MAX_SCORE] = function()
		pg = var_2_10000
		...
		local var_25_1 = var_1(var_2_10002)
		local var_25_2
	...
	IslandTaskTargetType = var_8
	var_1_5[var_8.GAME_CUR_SCORE] = function()
		pg = var_2_10000
		...
		local var_26_1 = var_1(var_2_10002)
		local var_26_2
	...
	return var_1_2(var_1_4, var_1_5, function()
		assert = var_2_10000
...
function var_0_0.UpdateRuntimeTaskByTargetType(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_28_1(var_28_2:GetTasks()) do
...
function var_0_0.UpdateClientTaskProgress(arg_29_0, arg_29_1)
	...
	for iter_29_0, iter_29_1 in var_29_2(var_29_3) do
		...
		var_1_10009(var_29_4, var_1_10011.ISLAND_UPDATE_TASK, {
			progress = 1,
			taskId = 0,
			targetId = iter_29_1
		})
...
function var_0_0.OnApproach(arg_30_0)
	...
	var_1_10001({
		function(arg_31_0)
			...
			local var_31_2 = var_3.GetIsland(var_31_1)
			local var_31_3 = var_3.GetTaskAgency(var_31_2)

			for iter_31_0, iter_31_1 in var_2_10002(var_3.GetCanAcceptTasks(var_31_3)) do
			...
			if #var_31_0 > 0 then
				...
				var_31_5(var_31_4, var_4.ISLAND_ACCEPT_TASK, {
					taskIds = var_31_0,
					callback = arg_31_0
				})
			else
		...
		function(arg_32_0)
			...
			local var_32_1 = var_2_10003(var_2_10004)
			local var_32_2 = var_3.GetIsland(var_32_1)
			local var_32_3 = var_3.GetTaskAgency(var_32_2)

			for iter_32_0, iter_32_1 in var_2_10002(var_3.GetCanSubmitTasks(var_32_3)) do
				var_2_10008 = iter_32_1

				if iter_32_1.CheckSubmitOnApproach(var_2_10008, arg_30_0) then
					table = var_7
			...
			for iter_32_2, iter_32_3 in var_3(var_32_0) do
				...
				var_2_10008.insert(var_32_4, function(arg_33_0)
					...
					var_33_1(var_33_0, var_3_10003.ISLAND_SUBMIT_TASK, {
						taskId = iter_32_3,
						callback = arg_33_0
					})
		...
		var_34_0(var_2_10001.APPROACH, arg_30_0)
...
function var_0_0.OnSubmitTask(arg_36_0)
	...
	if var_36_1.any(arg_36_0, function(arg_37_0)
		...
		var_36_2(var_2.TASK_DAILY_IN_WEEK)
	end
...
function var_0_0._GetTaskTargetLinkStoryIds(arg_39_0)
	...
	if var_39_2 == var_1_10005.TYPE_STORY then
		pg = var_39_2
		var_39_3 = var_39_2.NewStoryMgr.GetInstance()
		...
		local var_39_4 = var_3.type

		IslandInteractionUntil = var_39_3

		if var_39_4 == var_39_3.TYPE_PERFORMANCE then
			IslandPerformancePerformer = var_39_4

			return var_39_4.GetStoryNameList(var_3.param)
		end
	end
...
function var_0_0._GetTaskLinkStoryIds(arg_41_0)
	...
	if var_0_0._GetTaskAcceptStoryId(arg_41_0.id) then
		...
		var_3.insert(var_41_0, var_2)
	end

	ipairs = var_3

	for iter_41_0, iter_41_1 in var_3(arg_41_0:GetTargetList()) do
		if iter_41_1:IsFinish() and var_0_0._GetTaskTargetLinkStoryIds(iter_41_1.id) then
			table = var_9

			var_9.insertto(var_41_0, var_8)
		end
	end
...
function var_0_0._GetFinishTaskLinkStoryIds(arg_42_0)
	...
	if var_0_0._GetTaskAcceptStoryId(arg_42_0) then
		...
		var_3.insert(var_42_0, var_2)
	end

	ipairs = var_3
	pg = var_1_10004

	for iter_42_0, iter_42_1 in var_3(var_1_10004.island_task[arg_42_0].target_id) do
		if var_0_0._GetTaskTargetLinkStoryIds(iter_42_1) then
			table = var_9

			var_9.insertto(var_42_0, var_8)
		end
	end
...
function var_0_0.FixTaskLinksStory(arg_43_0)
	...
	for iter_43_0, iter_43_1 in var_1_10003(var_43_2:GetTasks()) do
		table = var_1_10008
	...
	for iter_43_4 = 3110000, 3119999 do
		...
		if iter_43_3.StoryId2StoryName(var_43_4, iter_43_4) then
			...
			local var_43_5 = var_43_4.NewStoryMgr.GetInstance()

			if var_8.GetPlayedFlag(var_43_5, iter_43_4) then
				IslandPerformancePerformer = var_8

				local var_43_6 = var_8.GetStoryNameList(iter_43_3)

				ipairs = var_9

				for iter_43_5, iter_43_6 in var_9(var_43_6) do
					table = var_1_10014
	...
	if #var_43_3 > 0 then
		...
		local var_43_7 = var_3.m02
		local var_43_8 = var_3.sendNotification

		GAME = var_5

		var_43_8(var_43_7, var_5.STORY_UPDATE_LIST, {
			storyIds = var_43_3,
			callback = arg_43_0
		})
	else
