...
local var_0_0 = "IslandSettings3DPage"
...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_4
	ContentSizeFitter = iter_2_0
	arg_2_0.contentSizeFitter = var_2_3(var_2_2, var_4(iter_2_0))

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_2.GetComponent

	typeof = var_4
	CanvasGroup = iter_2_0
	arg_2_0.cg = var_2_5(var_2_4, var_4(iter_2_0))
	...
	typeof = var_4
	ScrollRect = iter_2_0
	arg_2_0.scrollrect = var_2_7(var_2_6, var_4(iter_2_0))
...
function var_0_1.OnBindEvent(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.EVT_UPDTAE, function()
		local var_4_0 = arg_3_0
		local var_4_1 = var_0.GetPanel

		IslandSettingsOtherGraphicsPanle = var_2_10002

		if var_4_1(var_4_0, var_2_10002) then
	...
	IslandSettingsGraphicsPanle = var_3

	var_3_3(var_3_2, var_3.EVT_UPDTAE, function()
		local var_6_0 = arg_3_0
		local var_6_1 = var_0.GetPanel

		IslandSettingsGraphicsPanle = var_2_10002

		if var_6_1(var_6_0, var_2_10002) then
			var_0:OnUpdate()
		end
...
function var_0_1.GetPanels(arg_7_0)
	...
	IslandSettingsGraphicsPanle = var_1_10002
	var_7_0[1] = var_1_10002
	IslandSettingsOtherGraphicsPanle = var_1_10002
	...
	if arg_7_0:NeedAdjustScreen() then
		...
		IslandSettingsAdjustScreenPanle = var_1_10005

		var_7_1(var_7_2, var_7_3, var_1_10005)
	end
...
function var_0_1.InitPanels(arg_11_0)
	...
	local var_11_2 = var_1_10002(var_11_1, var_1_10004(var_1_10005))
...
function var_0_1.OnInitPanle(arg_16_0)
	if arg_16_0.contextData.scroll then
		...
		if arg_16_0.contextData.scroll == "world_settings" then
			...
			SettingsWorldPanle = var_1_10004

			local var_16_3 = var_16_2(var_16_1, var_1_10004)
		else
...
function var_0_1.ScrollToPanel(arg_17_0, arg_17_1)
	...
	var_17_0(arg_17_0.panelContainer, {
		y = -var_17_1.y
	})
