...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "adapt/title/Text")

	i18n = var_2_1

	var_1(var_2_2, var_2_1("island_map_title"))
...
function var_0_1.OnInit(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1_10001(arg_5_0.maps) do
		...
		var_1_10006(var_5_0, var_5_1, var_5_2, var_1_10010)
	end
	...
	local var_5_9 = var_3.Find(var_5_8, "adapt/back")
	...
	local var_5_13 = var_3.Find(var_5_12, "adapt/home")
...
function var_0_1.Flush(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10001(arg_13_0.maps) do
		...
		var_1_10006 = arg_13_0.CheckUnlock(var_13_0, iter_13_0)
		setActive = var_13_0

		var_13_0(iter_13_1:Find("lock"), not var_1_10006)

		setActive = var_13_0

		var_13_0(iter_13_1:Find("full"), false)

		setActive = var_13_0

		var_13_0(iter_13_1:Find("finish"), false)

		setActive = var_13_0

		var_13_0(iter_13_1:Find("fetch"), false)

		setActive = var_13_0

		var_13_0(iter_13_1:Find("icon"), var_1_10006)
	end
...
function var_0_1.ShowDesc(arg_15_0, arg_15_1)
	if arg_15_0.selectedId then
		...
		arg_15_0.HideSelected(var_1_10003, arg_15_0.selectedId)
	end
...
function var_0_1.HideSelected(arg_16_0)
	...
	local var_16_6 = var_16_5(var_16_4, var_6(var_1_10007))
...
function var_0_1.GoDesc(arg_18_0, arg_18_1)
	...
	IslandBaseMapDescPage = var_1_10004

	var_18_1(var_18_0, var_1_10004, arg_18_1)
