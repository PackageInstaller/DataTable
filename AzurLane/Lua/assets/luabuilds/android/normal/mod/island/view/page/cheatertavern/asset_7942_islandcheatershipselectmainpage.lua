...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..ship.IslandShipMainPage"))
...
function var_0_1.AddListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.CLOSE_SHIP_SELECT_PAGE, arg_6_0.SetNeedNotLoadingUI)
...
function var_0_1.RemoveListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10003.CLOSE_SHIP_SELECT_PAGE, arg_7_0.SetNeedNotLoadingUI)
...
function var_0_1.FlushShips(arg_9_0, arg_9_1)
	...
	for iter_9_0 = #arg_9_0.displays, 1, -1 do
		if arg_9_0.displays[iter_9_0] then
			...
			var_1_10009 = var_1_10008.GetIsland(var_1_10009)
			var_1_10009 = var_1_10008.GetCharacterAgency(var_1_10009)

			if var_1_10008.GetShipById(var_1_10009, var_7) == nil then
				table = var_1_10009
...
function var_0_1.UpdateMainView(arg_10_0, arg_10_1)
	...
	var_10_2(var_10_1, var_4.PAGE_DRESS)
...
function var_0_1.ClearCharacterScene(arg_14_0, arg_14_1)
	if arg_14_0.isLoadCharacterScene then
		...
		var_14_1(var_14_0, var_1_10004.REFRESH_WEATHER_SYSTEM)
	end
