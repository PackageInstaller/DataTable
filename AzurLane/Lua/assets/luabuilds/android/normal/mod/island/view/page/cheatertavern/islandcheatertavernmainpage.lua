...
function var_0_1.AddListeners(arg_12_0)
	...
	var_12_1(var_12_0, var_1_10003.ISLAND_CHEATER_FIRSTROND_START, arg_12_0.OnCheaterEveryRoundStart)
	...
	if not var_12_1.putCardTest then
		...
		var_12_3(var_12_2, var_3.ISLAND_PLAYER_CHEATER_OPERATE_DONE, arg_12_0.OnCheaterOperateDone)
		...
		var_12_5(var_12_4, var_3.ISLAND_CHEATER_OPERATE_DONE_NOTIFY, arg_12_0.OnCheaterOperateDoneNotify)
		...
		var_12_7(var_12_6, var_3.ISLAND_CHEATER_END_SCORE_NOTIFY, arg_12_0.OnCheaterEndScoreNotify)
		...
		var_12_9(var_12_8, var_3.ISLAND_CHEATER_REAL_END_NOTIFY, arg_12_0.OnGameEndNotify)
		...
		var_12_11(var_12_10, var_3.FINSH_PAGE_QUIT, arg_12_0.OnCheaterFinishQuit)
		...
		var_12_13(var_12_12, var_3.ISLAND_CHEATER_DELEGATE_NOTIFY, arg_12_0.OnCheaterDelegateNotify)
		...
		var_12_15(var_12_14, var_3.ISLAND_CHEATER_RECONNECT, arg_12_0.OnCheaterReconected)
	end
	...
	var_12_17(var_12_16, var_3.NEW_MSG, arg_12_0.RefreshMessage)
	...
	var_12_19(var_12_18, var_3.FRIEND_NEW_MSG, arg_12_0.RefreshMessage)
	...
	var_12_21(var_12_20, var_3.NEW_MSG_ADDED, arg_12_0.RefreshMessage)
	...
	var_12_23(var_12_22, var_3.CHAT_MSG_UPDATE, arg_12_0.RefreshMessage)
	...
	var_12_25(var_12_24, var_3.CHANGE_CHAT_ROOM_DONE, arg_12_0.RefreshMessage)
	...
	var_12_27(var_12_26, var_3.PRESS_BACK, arg_12_0.OnPressBack)
...
function var_0_1.RemoveListeners(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10003.ISLAND_CHEATER_FIRSTROND_START, arg_13_0.OnCheaterEveryRoundStart)
	...
	if not var_13_1.putCardTest then
		...
		var_13_3(var_13_2, var_3.ISLAND_PLAYER_CHEATER_OPERATE_DONE, arg_13_0.OnCheaterOperateDone)
		...
		var_13_5(var_13_4, var_3.ISLAND_CHEATER_OPERATE_DONE_NOTIFY, arg_13_0.OnCheaterOperateDoneNotify)
		...
		var_13_7(var_13_6, var_3.ISLAND_CHEATER_END_SCORE_NOTIFY, arg_13_0.OnCheaterEndScoreNotify)
		...
		var_13_9(var_13_8, var_3.ISLAND_CHEATER_REAL_END_NOTIFY, arg_13_0.OnGameEndNotify)
		...
		var_13_11(var_13_10, var_3.FINSH_PAGE_QUIT, arg_13_0.OnCheaterFinishQuit)
		...
		var_13_13(var_13_12, var_3.ISLAND_CHEATER_DELEGATE_NOTIFY, arg_13_0.OnCheaterDelegateNotify)
		...
		var_13_15(var_13_14, var_3.ISLAND_CHEATER_RECONNECT, arg_13_0.OnCheaterReconected)
	end
	...
	var_13_17(var_13_16, var_3.NEW_MSG, arg_13_0.RefreshMessage)
	...
	var_13_19(var_13_18, var_3.FRIEND_NEW_MSG, arg_13_0.RefreshMessage)
	...
	var_13_21(var_13_20, var_3.NEW_MSG_ADDED, arg_13_0.RefreshMessage)
	...
	var_13_23(var_13_22, var_3.CHAT_MSG_UPDATE, arg_13_0.RefreshMessage)
	...
	var_13_25(var_13_24, var_3.CHANGE_CHAT_ROOM_DONE, arg_13_0.RefreshMessage)
	...
	var_13_27(var_13_26, var_3.PRESS_BACK, arg_13_0.OnPressBack)
...
function var_0_1.OnCheaterFinishQuit(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.PLAY_ROOM_MATCH_STOP)
...
function var_0_1.OnCheaterEndScoreNotify(arg_15_0)
	...
	IslandCheaterTavernInGamingView = var_1_10003

	local var_15_2 = var_15_1(var_15_0, var_1_10003)
	...
	local var_15_5 = var_1_10003.OPEN_PAGE
	local var_15_6 = "IslandCheaterTavernFinishPage"
	local var_15_7 = {}

	IslandCheaterTavernConst = var_1_10006
	var_15_7[1] = var_1_10006.SettlementType.ByScore
...
function var_0_1.OnGameEndNotify(arg_16_0, arg_16_1)
	...
	var_16_7(var_16_6, var_1_10008.PLAY_WIN_ANIMATION, var_16_2, var_16_4, var_16_5.seat)
	...
	IslandCheaterTavernFinishPage = var_8

	if var_16_9(var_16_8, var_8) then
		return
	end
	...
	IslandMediator = var_8

	local var_16_12 = var_8.OPEN_PAGE
	local var_16_13 = "IslandCheaterTavernFinishPage"
	local var_16_14 = {}

	IslandCheaterTavernConst = var_11
	var_16_14[1] = var_11.SettlementType.ByFinal
...
function var_0_1.OnCheaterOperateDoneNotify(arg_18_0, arg_18_1)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10004)
...
function var_0_1.OnCheaterReconected(arg_20_0, arg_20_1)
	...
	local var_20_2 = var_20_1(var_20_0, var_1_10004)
...
function var_0_1.OnCheaterEveryRoundStart(arg_21_0, arg_21_1)
	...
	arg_21_0.RemoveEveryRondStartTimer(var_21_1)

	pg = var_2

	local var_21_2 = var_2.gameset.bar_showcard_time.key_value

	Timer = var_21_1
	arg_21_0.everyRondStartTimer = var_21_1.New(function()
		ipairs = var_2_10000
	...
	local var_21_3 = arg_21_0.everyRondStartTimer

	var_3.Start(var_21_3)
...
function var_0_1.OnInit(arg_24_0)
	...
	var_1_10001(var_24_0, var_24_1, var_24_2, var_1_10005)
	...
	local function var_24_5()
		...
		local var_26_2 = var_2_10002.ON_ADD_SUBLAYER

		Context = var_2_10003

		local var_26_3 = var_2_10003.New
		local var_26_4 = {}

		PlayRoomNotificationLayer = var_2_10005
		var_26_4.viewComponent = var_2_10005
		PlayRoomNotificationMediator = var_2_10005
		var_26_4.mediator = var_2_10005
		var_26_4.data = {
			inRoom = true
		}
	...
	var_1_10001(var_24_3, var_24_4, var_24_5, var_1_10005)
	...
	local function var_24_8()
		...
		var_27_2.type = var_2_10003
		pg = var_2_10003
		var_27_2.helps = var_2_10003.gametip.island_help_bar.tip
	...
	var_1_10001(var_24_6, var_24_7, var_24_8, var_1_10005)
	...
	typeof = var_24_7
	Animation = var_24_8
	arg_24_0.animation = var_24_10(var_24_9, var_24_7(var_24_8))
...
function var_0_1.OnShow(arg_28_0, arg_28_1, arg_28_2)
	...
	IslandCheaterTavernStartGameView = var_5

	local var_28_5 = var_28_4(var_28_3, var_5)
...
function var_0_1.RefreshMessage(arg_32_0)
	...
	arg_32_0.GetMessages(var_32_0)

	local var_32_1 = arg_32_0.displays

	setActive = var_32_0

	var_32_0(arg_32_0.uiChatItemGo, #var_32_1 > 0)

	if #var_32_1 <= 0 then
		return
	end

	local var_32_2 = var_32_1[#var_32_1]
	local var_32_3 = arg_32_0.uiChannelImage

	GetSpriteFromAtlas = var_4

	local var_32_4 = "channel"

	ChatConst = var_1_10006
	var_32_3.sprite = var_4(var_32_4, var_1_10006.GetChannelSprite(var_32_2.type) .. "_mel")

	local var_32_5 = arg_32_0.uiChatText
	local var_32_6 = var_3.GetComponent(var_32_5, "RichText")
	local var_32_7 = var_32_2.type

	ChatConst = var_5

	if var_32_7 == var_5.ChannelPublic then
		var_32_6.supportRichText = true
		ChatProxy = var_4

		var_4.InjectPublic(var_32_6, var_32_2, true)
	elseif var_32_2:IsWorldBossNotify() then
		var_32_6.supportRichText = true

		local var_32_8 = var_32_2.args.playerName
		local var_32_9 = var_32_2.args.bossName

		GetPerceptualSize = var_6

		local var_32_10 = var_6(var_32_8 .. var_32_9) - 18
		local var_32_11
		...
		i18n = var_32_11
		var_32_6.text = var_32_11("ad_4", var_32_2.args.supportType, var_32_8, var_32_9, var_32_2.args.level)
	else
		var_32_6.supportRichText = var_32_2.emojiId ~= nil
		var_32_6.text = arg_32_0:MatchEmoji(var_32_6, var_32_2)
	end
...
function var_0_1.MatchEmoji(arg_33_0, arg_33_1, arg_33_2)
	...
	for iter_33_0 in var_33_3(var_33_4, var_1_10008.EmojiIconCodeMatch) do
		table = var_1_10011
		...
		if var_1_10011(var_1_10012, var_1_10013(iter_33_0)) then
			var_33_2 = true
			pg = var_1_10011
	...
	if not arg_33_2.emojiId then
		if var_33_2 then
			...
			return (var_33_5(var_33_6, var_9.EmojiIconCodeMatch, function(arg_34_0)
				table = var_2_10001
				...
				local var_34_1 = var_2_10002.emoji_small_template.all

				tonumber = var_2_10003

				if var_34_0(var_34_1, var_2_10003(arg_34_0)) then
					string = var_1
...
function var_0_1.GetMessages(arg_35_0)
	...
	var_35_1.each(var_35_2:getCacheMsgList(), function(arg_38_0)
	...
	local var_35_4 = var_5(var_6)

	var_35_3(var_5.GetChatMsgs(var_35_4), function(arg_39_0)
	...
	var_35_3.sort(arg_35_0.displays, function(arg_40_0, arg_40_1)
...
function var_0_1.InsertMsg(arg_41_0, arg_41_1, arg_41_2)
	...
	local var_41_0 = var_1_10003(var_1_10004)
...
function var_0_1.OnClickCloseBtn(arg_42_0)
	...
	local var_42_1 = var_1_10002(var_1_10003)
	local var_42_2 = var_2.GetRoomData(var_42_1)
	local var_42_3

	if not arg_42_0.isFinish then
		var_42_3 = var_42_2.roomType
		PlayRoomConst = var_1_10005

		if var_42_3 == var_1_10005.PLAY_ROOM_TYPE.MATCH then
			table = var_42_3
			...
			var_42_3.insert(var_42_0, function(arg_43_0)
				...
				i18n = var_2_10004
				var_43_2.content = var_2_10004("bar_tips_game6")
			...
			var_42_3.insert(var_42_0, function(arg_44_0)
				...
				i18n = var_2_10004
				var_44_2.content = var_2_10004("bar_tips_game7")
	...
	var_42_3(var_42_0, function()
		...
		var_45_2(var_45_1, var_2_10002.PLAY_ROOM_MATCH_STOP)
