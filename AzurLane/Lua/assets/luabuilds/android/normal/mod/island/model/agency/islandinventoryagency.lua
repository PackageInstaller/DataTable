...
function var_0_1.GetGroupedItemList(arg_7_0)
	...
	for iter_7_0, iter_7_1 in var_1_10002(arg_7_0.itemList) do
		if iter_7_1:GetNumberOfSlotsOccupied() <= 1 then
			...
			var_7_1(var_7_2, var_1_10010.New({
				id = iter_7_0,
			...
			local var_7_4 = iter_7_1.GetCount(var_1_10010) % var_7_3
...
function var_0_1.TryAddItemFromOverflowList(arg_8_0)
	...
	for iter_8_2, iter_8_3 in var_3(var_8_1) do
...
function var_0_1.AddItem(arg_10_0, arg_10_1)
	...
	var_1_10002(var_1_10003(var_10_0, var_1_10005))
...
function var_0_1.SplitItemList4Add(arg_11_0, arg_11_1)
	...
	for iter_11_0, iter_11_1 in var_11_2(arg_11_1) do
		...
		for iter_11_2 = var_11_4, iter_11_1.GetCount(var_1_10011) do
	...
	for iter_11_3, iter_11_4 in var_6(var_11_0) do
		...
		var_12.insert(var_11_9, var_1_10011)
	end
	...
	for iter_11_5, iter_11_6 in var_6(var_11_1) do
		...
		var_12.insert(var_11_10, var_1_10011)
	end
...
function var_0_1.TryAddItems(arg_14_0, arg_14_1)
	...
	for iter_14_0, iter_14_1 in var_4(var_14_0) do
		arg_14_0:AddItem(iter_14_1)
	end

	ipairs = var_4

	for iter_14_2, iter_14_3 in var_4(var_14_1) do
...
function var_0_1.CanAddItem(arg_16_0, arg_16_1, arg_16_2)
	...
	if arg_16_0:OwnItem(arg_16_1) then
		...
		local var_16_2 = arg_16_2 + var_4.GetCount(var_16_1)

		IslandItem = var_16_1

		local var_16_3 = var_16_1.New({
			id = arg_16_1,
			num = var_16_2
		})

		var_16_0 = var_16_0 + (var_6.GetNumberOfSlotsOccupied(var_16_3) - var_4:GetNumberOfSlotsOccupied())
	end
...
function var_0_1.GetNextCapacity(arg_22_0, arg_22_1)
	...
	if not var_22_1.island_storage_level[arg_22_1] then
		return 0
	end
...
function var_0_1.GetGifts(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_3(var_31_2) do
		...
		if not arg_31_0.GetItemById(var_31_3, iter_31_1) then
			IslandItem = var_31_3
			var_31_4 = var_31_3.New({
				num = 0,
				id = iter_31_1
			})
		end
		...
		if var_31_4 then
			...
			var_31_3.insert(var_31_0, var_31_4)
		end
	end
...
function var_0_1.GetShipExpBooks(arg_32_0)
	...
	for iter_32_0, iter_32_1 in var_3(var_32_2) do
		...
		if not arg_32_0.GetItemById(var_32_3, iter_32_1) then
			IslandItem = var_32_3
			var_32_4 = var_32_3.New({
				num = 0,
				id = iter_32_1
			})
		end
		...
		if var_32_4 then
			...
			var_32_3.insert(var_32_0, var_32_4)
		end
	end
