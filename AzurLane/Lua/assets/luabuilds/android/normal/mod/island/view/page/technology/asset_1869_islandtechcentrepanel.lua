...
function var_0_1.InifConfigData(arg_6_0)
	...
	for iter_6_2, iter_6_3 in var_1(arg_6_0.level2Ids) do
		...
		var_1_10006(var_6_2, var_1_10008({
			function(arg_7_0)
...
function var_0_1.AutoFocus(arg_15_0)
	...
	local var_15_2 = var_1_10003.indexof(arg_15_0.levels, var_15_1)
	local var_15_3 = arg_15_0.scrollRect
	local var_15_4 = var_4.ScrollTo

	math = var_1_10006

	var_15_4(var_15_3, var_1_10006.max(var_15_2 - 4, 0) / (#arg_15_0.levels - 7))
...
function var_0_1.GetFocusTechId(arg_16_0)
	...
	ipairs = var_2
	IslandTechTreePanel = var_3

	for iter_16_2, iter_16_3 in var_2(var_3.FocusPriorities) do
