...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_3.AGORA_MAP_TYPE_COMMON

	AgoraMap = var_1_10004
	var_1_0[var_1_1] = var_1_10004.New(arg_1_1)
	IslandConst = var_1_1
...
function var_0_1.GenLayer(arg_6_0)
	...
	local var_6_4 = var_1_10004.zero

	Vector2 = var_1_10005

	local var_6_5 = var_6_3(var_6_4, var_1_10005(var_6_2, var_6_2))

	ipairs = var_6_4

	for iter_6_0, iter_6_1 in var_6_4(var_6_5) do
		...
		Vector2 = var_1_10013
		var_6_8[var_6_7] = var_1_10012(var_1_10013(var_6_6, var_6_7))
	end
...
function var_0_1.UpdateSize(arg_11_0, arg_11_1)
	...
	var_11_1(var_11_0, var_4.MAP_SIZE_UPDATE, arg_11_0.size)
...
function var_0_1.ClampRange(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	local var_16_0 = arg_16_3
	local var_16_1 = arg_16_3.GetSizeWithRotation(var_16_0)

	AgoraCalc = var_16_0

	local var_16_2 = var_16_0.GetSizeCoord(var_16_1)
	local var_16_3 = arg_16_0:GetRangeCoord().x - var_16_2.x
	local var_16_4 = var_6.z - var_16_2.z
	local var_16_5 = var_6.w - var_16_2.w
	local var_16_6 = var_6.y - var_16_2.y

	Mathf = var_11
	arg_16_1 = var_11.Clamp(arg_16_1, var_16_3, var_16_4)
	Mathf = var_11
	arg_16_2 = var_11.Clamp(arg_16_2, var_16_5, var_16_6)
	Vector2 = var_11
...
function var_0_1._ClampRange(arg_17_0, arg_17_1, arg_17_2)
	...
	local var_17_1 = var_4.Clamp(arg_17_2.y, arg_17_1.y, arg_17_1.w)
...
function var_0_1.AddItem(arg_22_0, arg_22_1)
	...
	local var_22_2 = arg_22_0.GetMap(var_22_1, arg_22_1)

	ipairs = var_22_1

	for iter_22_0, iter_22_1 in var_22_1(var_22_0) do
...
function var_0_1.RemoveItem(arg_23_0, arg_23_1)
	...
	local var_23_2 = arg_23_0.GetMap(var_23_1, arg_23_1)

	ipairs = var_23_1

	for iter_23_0, iter_23_1 in var_23_1(var_23_0) do
...
function var_0_1.IsEmptyArea(arg_24_0, arg_24_1)
	...
	local var_24_3 = arg_24_0.GetRangeCoord(var_24_2)

	_ = var_24_2

	return var_24_2.all(var_24_0, function(arg_25_0)
		local var_25_0 = arg_24_0
		local var_25_2

		if var_1._InRange(var_25_0, var_24_3, arg_25_0.x, arg_25_0.y) then
			local var_25_1 = var_24_1
...
function var_0_1.IsEmptyAreaInPoint(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_3 = arg_26_0.GetRangeCoord(var_26_2)

	_ = var_26_2

	return var_26_2.all(var_26_0, function(arg_27_0)
...
function var_0_1.FindItemInPosition(arg_33_0, arg_33_1, arg_33_2)
	...
	for iter_33_0, iter_33_1 in var_1_10003(arg_33_0.placedlist) do
		if iter_33_1:GetMapType() == arg_33_1 then
			...
			local var_33_1 = iter_33_1.GetArea(var_33_0)
...
function var_0_1.FindEmptyArea4Item(arg_34_0, arg_34_1, arg_34_2)
	...
	local var_34_1 = arg_34_0.GetRangeCoord(var_34_0)

	AgoraCalc = var_34_0

	local var_34_2 = var_34_0.GetSizeCoord(arg_34_2:GetSizeWithRotation())
	local var_34_3 = var_34_1.x - var_34_2.x
	local var_34_4 = var_34_1.z - var_34_2.z
	local var_34_5 = var_34_1.w - var_34_2.w
	local var_34_6 = var_34_1.y - var_34_2.y

	if var_34_4 < var_34_3 or var_34_6 < var_34_5 then
		return nil
	end

	Mathf = var_9

	local var_34_7 = var_9.Clamp(arg_34_1.x, var_34_3, var_34_4)

	Mathf = var_10

	local var_34_8 = var_10.Clamp(arg_34_1.y, var_34_5, var_34_6)
	local var_34_9 = arg_34_0
	local var_34_10 = arg_34_0.GetMap(var_34_9, arg_34_2)

	math = var_34_9

	local var_34_11 = var_34_9.max

	math = var_13

	local var_34_12 = var_13.abs(var_34_7 - var_34_3)

	math = var_14

	local var_34_13 = var_34_12 + var_14.abs(var_34_8 - var_34_5)

	math = var_14

	local var_34_14 = var_14.abs(var_34_7 - var_34_3)

	math = var_15

	local var_34_15 = var_34_14 + var_15.abs(var_34_8 - var_34_6)

	math = var_15

	local var_34_16 = var_15.abs(var_34_7 - var_34_4)

	math = var_16

	local var_34_17 = var_34_16 + var_16.abs(var_34_8 - var_34_5)

	math = var_16

	local var_34_18 = var_16.abs(var_34_7 - var_34_4)

	math = var_17

	local var_34_19 = var_34_11(var_34_13, var_34_15, var_34_17, var_34_18 + var_17.abs(var_34_8 - var_34_6))

	local function var_34_20(arg_35_0, arg_35_1)
		if arg_35_0 < var_34_3 or var_34_4 < arg_35_0 or arg_35_1 < var_34_5 or var_34_6 < arg_35_1 then
			return false
		end
		...
		local var_35_2 = var_3.GenAreaByPosition

		Vector2 = var_2_10005

		return var_35_0(var_35_2(var_35_1, var_2_10005(arg_35_0, arg_35_1)), function(arg_36_0)
			local var_36_0 = arg_34_0
			local var_36_2

			if var_1._InRange(var_36_0, var_34_1, arg_36_0.x, arg_36_0.y) then
				local var_36_1 = var_34_10
	...
	for iter_34_0 = 0, var_34_19 do
		for iter_34_1 = -iter_34_0, iter_34_0 do
			math = var_1_10022
			var_1_10022 = iter_34_0 - var_1_10022.abs(iter_34_1)

			local var_34_21 = var_34_7 + iter_34_1

			if var_34_20(var_34_21, var_34_8 + var_1_10022) then
				Vector2 = var_24

				return var_24(var_34_21, var_34_8 + var_1_10022)
			end

			if var_1_10022 ~= 0 and var_34_20(var_34_21, var_34_8 - var_1_10022) then
				Vector2 = var_24
...
function var_0_1.ToString(arg_38_0)
	...
	local var_38_4 = var_5.EncodeLayer(var_38_2)
	...
	var_38_9(var_38_10, var_12.concat(var_38_5, "\n"))
	...
	var_38_11(var_38_12, var_12.concat(var_38_6, ",\n"))
	...
	var_38_13(var_38_14, var_12.concat(var_38_7, ",\n"))
