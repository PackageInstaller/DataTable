...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_6 = var_1_4.EncodeLayer(var_1_1)

	AgoraCalc = var_9

	local var_1_7 = var_9.EncodeLayer(var_1_2)
	...
	var_12.Send(var_1_10, 21307, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10003("island_agora_save_success"))
			...
			var_2_2(var_2_3, var_2_10003.BuildIslandAgoraSave())
		else
			pg = var_2_2
