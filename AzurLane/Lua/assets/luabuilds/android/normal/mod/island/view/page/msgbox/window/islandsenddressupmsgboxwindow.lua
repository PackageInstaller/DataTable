...
function var_0_1.FlushDressItem(arg_4_0, arg_4_1)
	...
	if var_1_10002.island_dress_template[arg_4_1.configId].icon ~= "" then
		...
		var_3(var_1_10004.format("island/IslandDressIcon/%s", var_2.icon), "", arg_4_0.itemIconTF)
	end
	...
	if var_2.quality ~= 0 then
		...
		var_3(var_1_10004.format("island/IslandDressIcon/%s", var_0_2[var_2.quality]), "", arg_4_0.itemFrameTF)
	end

	getProxy = var_3
	IslandProxy = var_1_10004

	local var_4_0 = var_3(var_1_10004)
	local var_4_1 = var_3.GetIsland(var_4_0)
	local var_4_2 = var_3.GetCharacterAgency(var_4_1)

	setText = var_4_1

	var_4_1(arg_4_0.ownNum, var_4_2:GetOwnDressCountByDressId(arg_4_1.configId))
