...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.layoutElement = var_1_9(var_1_8, var_4(var_1_10005))
	...
	typeof = var_4
	LayoutElement = var_1_10005
	arg_1_0.cutOffHeight = var_1_11(var_1_10, var_4(var_1_10005)).preferredHeight
	...
	arg_1_0.animationItem1 = var_1_14(var_1_13, var_4(var_1_10005))
	...
	typeof = var_4
	Animation = var_1_10005
	arg_1_0.animationItem2 = var_1_17(var_1_16, var_4(var_1_10005))
...
function var_0_0.UpdateItem(arg_5_0, arg_5_1, arg_5_2)
	...
	var_4(arg_5_1:Find("Text"), var_5_0.name)

	setActive = var_4

	local var_5_1 = arg_5_1:Find("double")
	local var_5_2 = var_5_0.type

	IslandConst = var_7

	var_4(var_5_1, var_5_2 == var_7.ANIMATION_OP_DOUBLE)

	LoadImageSpriteAsync = var_4

	var_4("island/IslandActionIcon/" .. var_5_0.resource, arg_5_1:Find("icon"), true)
...
function var_0_0.Clear(arg_8_0, ...)
	...
	var_8_3(var_2(arg_8_0.item2TimeTr))
...
function var_0_0.LoadingEffect(arg_9_0, arg_9_1)
	...
	local var_9_9 = var_9_8(var_12(var_9_2), var_9_6, 1, var_9_7)
	local var_9_10 = var_11.setOnUpdate

	System = var_13

	local var_9_11 = var_9_10(var_9_9, var_13.Action_float(function(arg_10_0)
	...
	var_9_12(var_9_11, var_13.Action(function()
...
function var_0_0.ClearLoadingEffect(arg_12_0)
	...
	var_12_0(var_2(arg_12_0.item1TimeTr))
	...
	var_12_1(var_2(arg_12_0.item2TimeTr))
