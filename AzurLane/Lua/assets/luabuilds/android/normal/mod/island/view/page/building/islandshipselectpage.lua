...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_2, var_3("island_select_ship"))
	...
	local var_2_7 = var_2.Find(var_2_6, "selected/Text")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("island_select_ship_label_1"))
	...
	local var_2_13 = var_2.Find(var_2_12, "tip/Text")

	i18n = var_2_12

	var_1(var_2_13, var_2_12("island_select_ship_overview"))
	...
	local var_2_16 = var_2.Find(var_2_15, "main/Text")

	IslandShipAttr = var_2_15

	local var_2_17 = var_2_15.ATTRS_CH

	IslandShipAttr = var_4

	var_1(var_2_16, var_2_17[var_4.MANAGE_KEY])

	UIItemList = var_1

	local var_2_18 = var_1.New
	local var_2_19 = arg_2_0.benefitsTF
	local var_2_20 = var_2.Find(var_2_19, "subs")
	local var_2_21 = arg_2_0.benefitsTF

	arg_2_0.subAttrUIList = var_2_18(var_2_20, var_3.Find(var_2_21, "subs/tpl"))
	...
	local var_2_24 = var_2.Find(var_2_23, "Image/Text")

	i18n = var_2_23

	var_1(var_2_24, var_2_23("island_select_ship"))
	...
	local var_2_31 = var_2.Find(var_2_30, "attrs")
	local var_2_32 = arg_2_0.infoPanel

	arg_2_0.attrUIList = var_2_29(var_2_31, var_3.Find(var_2_32, "attrs/tpl"))
	...
	local var_2_41 = var_2.Find(var_2_40, "Text")

	i18n = var_2_40

	var_1(var_2_41, var_2_40("island_shipselect_confirm"))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.orderTxt = var_2_47(var_2_46, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.skillName = var_2_58(var_2_57, var_3(var_4))
	...
	typeof = var_3
	Text = var_4
	arg_2_0.skillDes = var_2_61(var_2_60, var_3(var_4))
	...
	local var_2_72 = var_2.Find(var_2_71, "effects")
	local var_2_73 = arg_2_0.addStutasInfoPanel

	arg_2_0.buffInfoUIList = var_2_70(var_2_72, var_3.Find(var_2_73, "effects/tpl"))
	setText = var_1

	local var_2_74 = arg_2_0.addStutasInfoPanel
	local var_2_75 = var_2.Find(var_2_74, "Text")

	i18n = var_2_74

	var_1(var_2_75, var_2_74("island_production_speed_tip2"))
	...
	local var_2_78 = var_2.Find(var_2_77, "Text")

	i18n = var_2_77

	var_1(var_2_78, var_2_77("island_manage_no_addition"))
	...
	local var_2_81 = var_2.Find(var_2_80, "Text")

	i18n = var_2_80

	var_1(var_2_81, var_2_80("island_production_selected_tip2"))
	...
	var_1(var_2_82, var_3("island_ship_energy_recoverytips"))
...
function var_0_1.AddListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.ISLAND_FOLLOWER_OP_DONE, arg_4_0.OnFollowerOp)
	...
	var_4_3(var_4_2, var_3.ISLAND_GIVE_GIFT_DONE, arg_4_0.OnUseItem)
...
function var_0_1.RemoveListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10003.ISLAND_FOLLOWER_OP_DONE, arg_5_0.OnFollowerOp)
	...
	var_5_3(var_5_2, var_3.ISLAND_GIVE_GIFT_DONE, arg_5_0.OnUseItem)
...
function var_0_1.OnUseItem(arg_6_0)
	...
	IslandShipStatusBox = var_1_10003

	var_6_1(var_6_0, var_1_10003)
	arg_6_0:FlushInfo()
...
function var_0_1.OnInit(arg_8_0)
	...
	local function var_8_8()
		...
		for iter_11_0, iter_11_1 in var_2_10003(arg_8_0.selectedIds) do
		...
		if #var_11_3 > 0 then
			...
			IslandMsgBox = iter_11_0
			var_11_6.type = iter_11_0.TYPE_COMMON
			i18n = var_6
			var_11_6.content = var_6("island_cancel_follow_tip")
			...
			function var_11_6.onYes()
				...
				for iter_12_0, iter_12_1 in var_3_10001(var_11_3) do
					...
					var_3_10006.insert(var_12_0, function(arg_13_0)
						...
						IslandMediator = var_4_10003

						var_13_1(var_13_0, var_4_10003.DEL_FOLLOWER, iter_12_1, arg_13_0)
	...
	local function var_8_11(arg_15_0)
		if arg_15_0 then
			...
			var_15_1(var_15_0, var_2_10003.OPEN_SHIP_INDEX, {
	...
	local function var_8_17()
		...
		var_18_2.type = var_2_10003.TYPE_COMMON
		i18n = var_3
		var_18_2.content = var_3("island_manage_help_tip")
	...
	local var_8_20 = var_3.Find(var_8_19, "top/title/help")
	...
	local function var_8_21()
		...
		pg = var_2_10003
		var_19_2.helps = var_2_10003.gametip.island_help_commission.tip
	...
	var_1_10001(var_8_18, var_8_20, var_8_21, var_5)
	...
	local function var_8_24()
		if arg_8_0.showId then
			...
			IslandShipStatusBox = var_2_10002

			var_20_2(var_20_1, var_2_10002, arg_8_0.showId)
	...
	var_1_10001(var_8_22, var_8_23, var_8_24, var_5)
	...
	var_1.make(var_8_25, function(arg_21_0, arg_21_1, arg_21_2)
		...
		if arg_21_0 == var_2_10003.EventInit then
			...
			local var_21_1 = arg_21_2.Find(var_21_0, "Text")

			IslandShipAttr = var_21_0

			var_4(var_21_1, var_21_0.ToChinese(var_3))
		else
			UIItemList = var_3
			...
			if arg_21_0 == var_3.EventUpdate then
				...
				local var_21_2 = arg_21_2:Find("slider/bar")
				local var_21_3 = arg_8_0
				local var_21_4 = var_5.GetShipsAttrProgress

				IslandShipAttr = var_2_10007

				var_3(var_21_2, var_21_4(var_21_3, var_2_10007.ATTRS[arg_21_1 + 1]))
			end
		end
...
function var_0_1.UpdateSortBtn(arg_25_0)
	...
	if arg_25_0.selectAsc then
		...
		i18n = var_1_10004
		var_25_4.text = var_1_10004(var_25_3)
...
function var_0_1.UpdateAttr(arg_28_0, arg_28_1, arg_28_2, arg_28_3, arg_28_4)
	...
	local var_28_1 = arg_28_4
	local var_28_2 = arg_28_4.GetAttr(var_28_1, var_28_0)

	setText = var_28_1

	local var_28_3 = arg_28_1
	local var_28_4 = arg_28_1.Find(var_28_3, "name")

	IslandShipAttr = var_28_3

	var_28_1(var_28_4, var_28_3.ToChinese(var_28_0))

	IslandProductTimeHelper = var_28_1

	local var_28_5 = var_28_1.GetAttributeAddPercentByAttribute(arg_28_4.id, arg_28_3)
	local var_28_6
	local var_28_7 = 0 < var_28_5 and "#00B91E" or var_28_5 < 0 and "#FF6767" or "#393A3C"

	setTextColor = var_9

	local var_28_8 = arg_28_1
	local var_28_9 = arg_28_1.Find(var_28_8, "value")

	Color = var_28_8

	var_9(var_28_9, var_28_8.NewHex(var_28_7))
	...
	if var_28_5 ~= 0 then
		...
		if not var_9.floor(var_28_2 * (1 + 0.01 * var_28_5)) then
			var_28_10 = var_28_2
		end

		setText = var_28_9

		var_28_9(arg_28_1:Find("value"), var_28_10)

		if var_28_5 ~= 0 then
			local var_28_11 = arg_28_4

			var_28_9 = arg_28_4.GetDisplayStatus(var_28_11)
			_ = var_28_11
			var_28_9 = var_28_11.select(var_28_9, function(arg_29_0)
				local var_29_0 = arg_29_0
				local var_29_1 = arg_29_0.GetBuffType(var_29_0)

				IslandBuffType = var_29_0

				return var_29_1 == var_29_0.SHIP_ATTR
			end)
			onButton = var_11

			local var_28_12 = arg_28_0
			local var_28_13 = arg_28_1
			...
			local function var_28_14()
				...
				IslandMsgBox = var_2_10003
				var_30_2.type = var_2_10003.TYPE_SHIP_OWN_STATUS
				i18n = var_3
				var_30_2.title = var_3("island_word_ship_buff_desc")
				var_30_2.statusList = var_28_9
			...
			var_11(var_28_12, var_28_13, var_28_14, var_1_10015)
		else
			removeOnButton = var_28_9

			var_28_9(arg_28_1)
		end

		local var_28_15 = arg_28_4
		local var_28_16 = arg_28_4.GetAttrGradeByValue(var_28_15, var_28_10)

		IslandShipAttr = var_28_15

		local var_28_17 = var_28_15.Grade2Img(var_28_16)
		local var_28_18 = arg_28_1:Find("grade")
		local var_28_19 = var_12.GetComponent

		typeof = var_14
		Image = var_1_10015

		local var_28_20 = var_28_19(var_28_18, var_14(var_1_10015))

		GetSpriteFromAtlas = var_28_18
		var_28_20.sprite = var_28_18("ui/IslandShipUI_atlas", var_28_17[1])

		local var_28_21 = arg_28_1:Find("grade_bg")
		local var_28_22 = var_12.GetComponent

		typeof = var_14
		Image = var_15

		local var_28_23 = var_28_22(var_28_21, var_14(var_15))

		GetSpriteFromAtlas = var_28_21
		var_28_23.sprite = var_28_21("ui/IslandShipUI_atlas", var_28_17[2])
		setActive = var_28_23

		var_28_23(arg_28_1:Find("vx_tpl"), arg_28_0.attrType == arg_28_3)
...
function var_0_1.OnShow(arg_31_0, arg_31_1)
	...
	var_31_0(arg_31_0.infoEmptyTitleTF, var_31_5)
	...
	if arg_31_0.needWorkSpeed then
		...
		IslandShipIndexLayer = var_31_8
		var_31_9.sortIndex = var_31_8.SortWorkSpeed
	else
		local var_31_10 = arg_31_0.sortData

		IslandShipIndexLayer = var_31_8
		var_31_10.sortIndex = var_31_8.SortLevel
	end
...
function var_0_1.OnUpdateShip(arg_34_0, arg_34_1, arg_34_2)
	...
	local function var_34_6()
		...
		if var_0.Following(var_35_3, var_34_1) then
			...
			i18n = var_2_10003
			var_35_6.content = var_2_10003("island_cancel_follow_tip")
			...
			function var_35_6.onYes()
				...
				var_36_1(var_36_0, var_3_10002.DEL_FOLLOWER, var_34_1)
	...
	var_34_2(var_34_4, var_34_5, var_34_6, var_1_10010)

	local var_34_7 = arg_34_0.showType

	IslandSelectShipCard = var_34_4

	local var_34_8

	if var_34_7 == var_34_4.SHOW_TYPE.PLACE then
		var_34_8 = var_34_0

		var_34_0.Update(var_34_8, arg_34_0.showType, var_34_1, arg_34_0.attrType, arg_34_0.placeId, arg_34_0.selectedIds, arg_34_0.autoCollectionSelectShip)
	else
		local var_34_9 = arg_34_0.showType

		IslandSelectShipCard = var_34_8

		if var_34_9 == var_34_8.SHOW_TYPE.RESTAURANT then
...
function var_0_1.FlushShips(arg_37_0, arg_37_1)
	...
	if #arg_37_0.showShips ~= 0 and arg_37_1 then
		...
		if arg_37_0.GetFristSelectableShipId(var_37_0) then
			arg_37_0.showId = var_2
			table = var_37_0

			var_37_0.insert(arg_37_0.selectedIds, var_2)
		end
	end
	...
	local var_37_1 = arg_37_0.shipRectCom

	var_2.SetTotalCount(var_37_1, #arg_37_0.showShips)
	arg_37_0:FlushInfo()
...
function var_0_1.GetFristSelectableShipId(arg_38_0)
	...
	for iter_38_0, iter_38_1 in var_1_10001(arg_38_0.showShips) do
		...
		if var_38_2 == var_38_1.STATE_NORMAL and not arg_38_0:CheckHasSelected(iter_38_1) then
			return iter_38_1
		end
	end
...
function var_0_1.UpdateTimer(arg_39_0, arg_39_1)
	...
	var_39_0(var_39_2, var_5.DescCDTime(var_39_3, var_39_1))
...
function var_0_1.FlushInfo(arg_41_0)
	...
	var_1(var_41_0, var_41_1 ~= var_4.NPC_CONFIG_ID)
	...
	var_41_4(arg_41_0.nameTF, var_41_5:GetName())
	...
	var_41_4(var_41_6, var_4.format("-Lv.%d", var_41_5:GetLevel()))
	...
	var_3("ShipYardIcon/" .. var_41_7, "", arg_41_0.shipIconTF)

	local var_41_8 = var_41_5:GetCurrentEnergy()
	local var_41_9 = var_41_5
	local var_41_10 = var_41_5.GetMaxEnergy(var_41_9)

	setText = var_41_9

	local var_41_11 = arg_41_0.energyTF

	var_41_9(var_6.Find(var_41_11, "text"), var_41_8 .. "/" .. var_41_10)

	setSlider = var_41_9

	local var_41_12 = arg_41_0.energyTF

	var_41_9(var_6.Find(var_41_12, "energy_bar"), 0, 1, var_41_8 / var_41_10)

	if var_41_8 ~= var_41_10 then
		setActive = var_41_9

		var_41_9(arg_41_0.recoveryTimeTips, true)

		setActive = var_41_9

		var_41_9(arg_41_0.energyTimeTextTf, true)
	...
	local var_41_15 = var_41_5:GetSkill()
	local var_41_16 = var_5.IsUnlock(var_41_15)

	setActive = var_41_15

	var_41_15(arg_41_0.skill, var_41_16)

	setActive = var_41_15

	var_41_15(arg_41_0.skillEmp, not var_41_16)

	setText = var_41_15

	local var_41_17 = arg_41_0.skillEmpDes

	i18n = var_9

	var_41_15(var_41_17, var_9("island_need_star", var_41_5:GetSkillUnlockLevel()))

	local var_41_18 = arg_41_0.showType

	IslandSelectShipCard = var_41_17

	local var_41_19

	if var_41_18 ~= var_41_17.SHOW_TYPE.PLACE or not arg_41_0.placeId then
		var_41_19 = arg_41_0.restId
	end
	...
	if var_41_16 then
		...
		IslandSelectShipCard = var_41_20
		var_41_20 = var_41_20.GetSkillEffective(var_41_5, arg_41_0.showType, var_41_19)
	end

	setActive = var_9

	var_9(arg_41_0.skillInuse, var_41_20)

	setActive = var_9

	var_9(arg_41_0.skillUnuse, not var_41_20)

	local var_41_21 = arg_41_0.skillName

	string = var_10
	var_41_21.text = var_10.format("%s - %s", var_5:GetName(), "[Lv." .. var_5:GetLevel() .. "]")
...
function var_0_1.FlushEnergyCostAnim(arg_43_0, arg_43_1)
	...
	if arg_43_0.energyCost ~= 0 then
		...
		IslandSelectShipCard = var_43_0

		local var_43_2

		if var_43_1 ~= var_43_0.SHOW_TYPE.PLACE then
			var_43_2 = false
		else
			var_43_2 = true
		end
		...
		var_43_0(arg_43_0.energyCostSilderTF, var_43_2)
		...
		if var_43_3 == var_4.NPC_CONFIG_ID then
			var_43_3 = arg_43_1:GetCurrentEnergy()
			var_43_4 = arg_43_1

			local var_43_5 = arg_43_1.GetMaxEnergy(var_43_4)
			...
			local var_43_6 = arg_43_0.energyTF

			var_43_4(var_6.Find(var_43_6, "energy_bar"), 0, 1, var_43_3 / var_43_5)

			setText = var_43_4

			local var_43_7 = arg_43_0.energyTF
			local var_43_8 = var_6.Find(var_43_7, "text")

			string = var_43_7

			var_43_4(var_43_8, var_43_7.format("%d-<color=#fadfb6>%d</color>/%d", var_43_3, 0, var_43_5))
		...
		local var_43_9 = var_43_3.floor
		local var_43_10 = arg_43_0.energyCost

		IslandProductCostHelper = var_43_4

		local var_43_11 = var_43_9(var_43_10 * (1 - var_43_4.GetReducePercentInPlace(arg_43_1.id, arg_43_0.placeId)))

		math = var_4

		local var_43_12 = var_4.max(var_43_11, 1)
		...
		arg_43_0.energyCostTimer = var_4.New(function()
			...
			var_44_2(var_3.Find(var_44_4, "energy_bar"), 0, 1, (var_44_1 - var_43_12) / var_44_3)

			setSlider = var_44_2

			var_44_2(arg_43_0.energyCostSilderTF, 0, 1, var_44_1 / var_44_3)

			setText = var_44_2

			local var_44_5 = arg_43_0.energyTF
			local var_44_6 = var_3.Find(var_44_5, "text")

			string = var_44_5

			var_44_2(var_44_6, var_44_5.format("%d-<color=#fadfb6>%d</color>/%d", var_44_1, var_43_12, var_44_3))

			return
		end, 1, -1)

		local var_43_13 = arg_43_0.energyCostTimer

		var_4.Start(var_43_13)
...
function var_0_1.FlushEnergyPercent(arg_45_0)
	...
	local var_45_1 = var_2.format("<color=#39bfff> -%d%%</color>", var_45_0)
...
function var_0_1.FlushAddPercent(arg_46_0)
	...
	if 0 < var_46_0 then
		...
		var_46_10.name = var_1_10011(var_46_11, var_1_10013.ToChinese(var_46_7))
	...
	if 0 < var_46_1 then
		...
		var_46_8 = arg_46_0.buffInfos

		local var_46_13 = {}

		i18n = var_46_10
		var_46_13.name = var_46_10("island_production_speed_addition2")
		var_46_13.effect = "+" .. var_46_1 .. "%"

		var_46_12(var_46_8, var_46_13)
	end

	if 0 < var_46_2 then
		getProxy = var_7
		IslandProxy = var_46_8

		local var_46_14 = var_7(var_46_8)
		local var_46_15 = var_7.GetIsland(var_46_14)
		local var_46_16 = var_7.GetCharacterAgency(var_46_15)
		local var_46_17 = var_7.GetShipById(var_46_16, arg_46_0.showId)
		local var_46_18 = var_7.GetSkill(var_46_17)
		local var_46_19 = var_8.GetName(var_46_18)

		table = var_46_18

		var_46_18.insert(arg_46_0.buffInfos, {
			name = var_46_19,
			effect = "+" .. var_46_2 .. "%"
		})
	end
	...
	if 0 < var_46_3 then
		...
		local var_46_20 = var_7.insert
		local var_46_21 = arg_46_0.buffInfos
		local var_46_22 = {}

		i18n = var_46_10
		var_46_22.name = var_46_10("island_production_speed_addition3")
		var_46_22.effect = "+" .. var_46_3 .. "%"

		var_46_20(var_46_21, var_46_22)
	end

	local var_46_23 = arg_46_0.buffInfoUIList

	var_7.align(var_46_23, #arg_46_0.buffInfos)
...
function var_0_1.FlushBenefits(arg_47_0)
	...
	if arg_47_0.showBenefits then
		...
		var_1(var_47_0, var_47_2(var_47_1, var_1_10005.ATTRS[1]))
...
local function var_0_2(arg_54_0, arg_54_1)
	...
	local var_54_1 = var_54_0(var_1_10003.gsub(arg_54_1, "%.", "%%."))

	IslandShip = var_3

	local var_54_2 = var_3.StaticGetName(arg_54_0)
	...
	return var_54_3(var_5.lower(var_54_2), var_54_1)
end
...
local function var_0_3(arg_55_0, arg_55_1, arg_55_2)
	...
	local var_55_3 = arg_55_0.characterAgency
	local var_55_4 = var_6.GetShipById(var_55_3, arg_55_1)

	ShipIndexConst = var_55_3

	if var_55_3.filterByCamp(var_55_2, arg_55_2.campIndex) then
		ShipIndexConst = var_7

		if var_7.filterByRarity(var_55_2, arg_55_2.rarityIndex) then
			IslandShipIndexLayer = var_7

			if var_7.filterByExtra(var_55_4, arg_55_2.extraIndex) then
				return true
			end
		end
	end
...
function var_0_1.GetShips(arg_56_0)
	...
	CompareFuncs = iter_56_0

	var_56_6(var_56_7, iter_56_0(var_56_5))
	...
	for iter_56_2, iter_56_3 in var_56_6(var_56_1) do
		...
		var_1_10010.insert(var_56_0, iter_56_3.id)
	end
