...
function var_0_4.Move(arg_7_0, arg_7_1)
	...
	if arg_7_0.gravitySpeed >= 0 then
		...
		if var_7_1 then
			...
			var_1_10005, var_7_3 = arg_7_0:CalcNotFalling()
	...
	local var_7_5 = var_7_1(var_7_4, var_1_10005.GRAVITYDIR.y * var_7_0, 0)
	...
	var_7_8(var_7_7, var_7_9 * var_1_10008.deltaTime + var_7_6)
