		...
		if var_6_0 ~= nil and var_6_1 ~= nil and var_6_0 ~= var_6_1 then
			if var_6_0 == true and var_6_1 == false then
				if arg_6_0:GetUnitData(iter_6_0) then
					...
					var_6_3(var_6_2, var_1_10013.UNIT_LIST_OBJ, var_10.id)
				end
...
function var_0_1.IsVisible(arg_7_0, arg_7_1)
	...
	if var_3.IsSelfIsland(var_7_3) then
		...
		local var_7_9 = var_7_8(var_7_7, var_1_10006.OPEN_SIGNIN)
		...
		local var_7_12 = var_1_10007(var_1_10008)
		local var_7_13 = var_7_11(var_7_10, var_7.getRawData(var_7_12).id)
