...
local var_0_0 = "IslandReplaceOrderCommand"
...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5.CanReplace(var_1_4) then
		pg = var_1_6
		...
		var_1_6(var_1_5, var_1_10008("island_order_cant_replace"))
	...
	var_6.Send(var_1_7, 21403, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2.Flush(var_2_0, arg_2_0.slot)
			...
			var_2_2(var_2_1, var_2_10003.ISLAND_REPLACE_ORDER_DONE, {
				slotId = var_1_0
			})
		else
			pg = var_2_2
