...
function var_0_1.OnLoaded(arg_2_0)
	...
	arg_2_0.uiItemList = var_2_0(var_2_2, var_3.Find(var_2_3, "frame/list/tpl"))
	...
	local var_2_8 = var_2.Find(var_2_7, "frame/top/title")

	i18n = var_2_7

	var_1(var_2_8, var_2_7("child_filter_title"))
	...
	var_1(var_2_10, var_2_9("island_word_reset"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_11()
		...
		IslandScene = var_2_10002

		var_7_1(var_7_0, var_2_10002.ON_INVENTORY_FILTER, arg_3_0.values)
...
function var_0_1.Flush(arg_9_0, arg_9_1)
	...
	var_2.make(var_9_0, function(arg_10_0, arg_10_1, arg_10_2)
		...
		if arg_10_0 == var_2_10003.EventUpdate then
			...
			var_10_1.insert(arg_9_0.btns, var_10_2)
		end
...
function var_0_1.InitLayout(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	var_11_0:make(function(arg_12_0, arg_12_1, arg_12_2)
		...
		if arg_12_0 == var_2_10003.EventUpdate then
			...
			var_5(var_12_2, var_12_3, var_12_4, var_2_10009)
...
function var_0_1.FlushBtns(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	if arg_15_4 == var_1_10005.MODE_SINGLE then
		...
		for iter_15_0, iter_15_1 in var_5(arg_15_1) do
			...
			var_1_10012 = iter_15_1.mark
			bit = var_1_10013
			var_1_10013 = var_1_10013.band(var_15_0, arg_15_3) > 0
		...
		if arg_15_4 == var_5.MODE_MULTI then
			...
			if var_5.CheckSelectedAll(arg_15_2, arg_15_3) then
				...
				for iter_15_2, iter_15_3 in var_6(arg_15_1) do
					triggerToggle = var_1_10011
				...
				for iter_15_4, iter_15_5 in var_6(arg_15_1) do
					local var_15_1 = arg_15_2[iter_15_4]

					triggerToggle = var_1_10012

					local var_15_2 = iter_15_5.mark
					...
					if not iter_15_5.isAll then
						...
						if not (var_14.band(var_15_1, arg_15_3) > 0) then
							var_15_3 = false
						else
							var_15_3 = true
						end

						var_1_10012(var_15_2, var_15_3)
					end
				end
			end
		end
