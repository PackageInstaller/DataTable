...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_4 = var_2_2.Find(var_2_3, "title/Text")

	i18n = var_2_3

	var_2_1(var_2_4, var_2_3("island_manage_result_3"))

	arg_2_0.shelfTF = var_2_2:Find("shelf/info/value")
	setText = var_2

	local var_2_5 = var_2_2
	local var_2_6 = var_2_2.Find(var_2_5, "shelf/info/name")

	i18n = var_2_5

	var_2(var_2_6, var_2_5("island_manage_slot"))

	arg_2_0.capacityTF = var_2_2:Find("capacity/info/value")
	setText = var_2

	local var_2_7 = var_2_2
	local var_2_8 = var_2_2.Find(var_2_7, "capacity/info/name")

	i18n = var_2_7

	var_2(var_2_8, var_2_7("island_manage_food_cnt"))

	arg_2_0.percentTF = var_2_2:Find("percent/info/value")
	setText = var_2

	local var_2_9 = var_2_2
	local var_2_10 = var_2_2.Find(var_2_9, "percent/info/name")

	i18n = var_2_9

	var_2(var_2_10, var_2_9("island_manage_sale_ratio"))

	arg_2_0.assistantTF = var_2_2:Find("assistant/info/value")
	setText = var_2

	local var_2_11 = var_2_2
	local var_2_12 = var_2_2.Find(var_2_11, "assistant/info/name")

	i18n = var_2_11

	var_2(var_2_12, var_2_11("island_manage_worker_cnt"))

	local var_2_13 = arg_2_0._tf

	arg_2_0.viewTF = var_2.Find(var_2_13, "window/rank")
	UIItemList = var_2

	local var_2_14 = var_2.New
	local var_2_15 = arg_2_0.viewTF
	local var_2_16 = var_3.Find(var_2_15, "content")
	local var_2_17 = arg_2_0.viewTF

	arg_2_0.uiList = var_2_14(var_2_16, var_4.Find(var_2_17, "content/tpl"))
	setText = var_2
	...
	var_2(var_2_19, var_2_18("child_close_tip"))
...
function var_0_1.OnShow(arg_6_0, arg_6_1, arg_6_2)
	...
	var_3(var_6_6, var_5.getConfig(var_6_7, "name"))
...
function var_0_1.UpdataSummary(arg_8_0)
	...
	var_3(var_4.Find(var_8_2, "base"), var_8_1.slot_num[1])
	...
	local var_8_5 = var_5.Find(var_8_4, "add")
	local var_8_6
	...
	var_4(var_5.Find(var_8_7, "base"), var_8_1.slot_num[2])
	...
	local var_8_10 = var_6.Find(var_8_9, "add")
	local var_8_11
	...
	var_5(var_6.Find(var_8_12, "base"), var_8_1.bonus_coefficient / 100 .. "%")
	...
	local var_8_15 = var_7.Find(var_8_14, "add")
	local var_8_16
	...
	var_6(var_7.Find(var_8_17, "base"), var_8_1.assistant_num)
	...
	local var_8_20 = var_8.Find(var_8_19, "add")
	local var_8_21
