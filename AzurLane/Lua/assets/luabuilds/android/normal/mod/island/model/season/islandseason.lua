...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_2.parseTimeFromConfig
	local var_1_5 = arg_1_0

	arg_1_0.endTime = var_1_4(var_1_3, arg_1_0.getConfig(var_1_5, "time")[2])

	local var_1_6 = var_0_1.RESET_TIP_KEY
	local var_1_7 = "_"

	getProxy = var_4
	PlayerProxy = var_1_5

	local var_1_8 = var_4(var_1_5)

	arg_1_0.localTipKey = var_1_6 .. var_1_7 .. var_4.getRawData(var_1_8).id .. "_" .. arg_1_0.id
...
function var_0_1.GetTimeStr(arg_4_0)
	...
	return var_1_10004.format("%d.%d.%d - %d.%d.%d", var_4_0[1], var_4_0[2], var_4_0[3], var_4_1[1], var_4_1[2], var_4_1[3])
end
...
function var_0_1.AddPt(arg_9_0, arg_9_1)
	if arg_9_0.pt == 0 then
		...
		IslandAchievementType = var_1_10003

		var_9_0(var_1_10003.SEASON_NUM, 0, 1)
	end
...
function var_0_1.GetPtAwardInfos(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10003(var_18_1.target) do
		...
		Drop = var_1_10011
		var_18_3.drop = var_1_10011.Create(var_18_1.ptaward_display[iter_18_0])
		table = var_1_10011
		var_18_3.isImportant = var_1_10011.contains(var_18_1.ptaward_highvalue, iter_18_0)
