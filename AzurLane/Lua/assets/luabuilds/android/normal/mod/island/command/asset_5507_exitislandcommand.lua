...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 21204, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1.IsPrivate(var_2_10003) then
				var_2_10003 = var_1
				var_2_1 = var_1.GetSystemTipInfos(var_2_10003)
				getProxy = var_2_10003
				SystemTipProxy = var_2_10004
				var_2_10004 = var_2_10003(var_2_10004)

				var_2_10003.SetIslandTipData(var_2_10004, var_2_1.awardCnt, var_2_1.emptyCnt, var_2_1.timestamps, var_2_1.postFlag)
			end
			...
			var_2_2(var_2_10003, var_2_10004.ISLAND_EXIT_DONE)
