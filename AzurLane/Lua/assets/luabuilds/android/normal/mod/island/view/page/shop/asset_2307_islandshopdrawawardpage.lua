...
function var_0_1.OnInit(arg_4_0)
	...
	var_1(arg_4_0.rtMiddle, function(arg_5_0, arg_5_1)
		...
		local var_5_1 = arg_5_0.Find(var_5_0, "got/Text")

		i18n = var_5_0

		var_2_10002(var_5_1, var_5_0("island_draw_get"))

		local var_5_2 = arg_5_0.name
		...
		var_5_1(var_5_2, {
			S = function()
				...
				local var_6_1 = var_1.Find(var_6_0, "state_sequence/Text")

				i18n = var_6_0

				var_3_10000(var_6_1, var_6_0("选择"))

				setText = var_3_10000

				local var_6_2 = arg_5_0
				local var_6_3 = var_1.Find(var_6_2, "finish/Text")

				i18n = var_6_2

				var_3_10000(var_6_3, var_6_2("island_draw_null"))

				onButton = var_3_10000

				local var_6_4 = arg_4_0
				local var_6_5 = arg_5_0
				local var_6_6 = var_2.Find(var_6_5, "state_sequence")
				...
				var_3_10000(var_6_4, var_6_6, var_6_7, var_4)

				onButton = var_3_10000

				local var_6_8 = arg_4_0
				local var_6_9 = arg_5_0
				local var_6_10 = var_2.Find(var_6_9, "btn_sequence")
				...
				var_3_10000(var_6_8, var_6_10, var_6_11, var_4)

				local var_6_12 = arg_4_0.bannerRectDic
				local var_6_13 = var_5_2

				BannerScrollRect4IslandDrawAward = var_6_10

				local var_6_14 = var_6_10.New
				local var_6_15 = arg_5_0
				local var_6_16 = var_3.Find(var_6_15, "mask/view/container")
				local var_6_17 = arg_5_0

				var_6_12[var_6_13] = var_6_14(var_6_16, var_4.Find(var_6_17, "dots"))

				return
			end,
			A = function()
				local var_9_0 = arg_4_0.bannerRectDic
				local var_9_1 = var_5_2

				BannerScrollRect4IslandDrawAward = var_3_10002

				local var_9_2 = var_3_10002.New
				local var_9_3 = arg_5_0
				local var_9_4 = var_3.Find(var_9_3, "mask/view/container")
				local var_9_5 = arg_5_0

				var_9_0[var_9_1] = var_9_2(var_9_4, var_4.Find(var_9_5, "dots"))
			...
			select = function()
				...
				local var_10_1 = var_1.Find(var_10_0, "count_word/Text")

				i18n = var_10_0

				var_3_10000(var_10_1, var_10_0("island_draw_num"))

				setText = var_3_10000

				local var_10_2 = arg_5_0
				local var_10_3 = var_1.Find(var_10_2, "btn_select/Text")

				i18n = var_10_2

				var_3_10000(var_10_3, var_10_2("island_draw_pick"))

				onButton = var_3_10000

				local var_10_4 = arg_4_0
				local var_10_5 = arg_5_0
				local var_10_6 = var_2.Find(var_10_5, "btn_select")
				...
				var_3_10000(var_10_4, var_10_6, var_10_7, var_4)

				local var_10_8 = arg_4_0.bannerRectDic
				local var_10_9 = var_5_2

				BannerScrollRect4IslandDrawAward = var_10_6

				local var_10_10 = var_10_6.New
				local var_10_11 = arg_5_0
				local var_10_12 = var_3.Find(var_10_11, "mask/view/container")
				local var_10_13 = arg_5_0

				var_10_8[var_10_9] = var_10_10(var_10_12, var_4.Find(var_10_13, "dots"))
	...
	local var_4_1 = var_2.Find(var_4_0, "Text")

	i18n = var_4_0

	var_1(var_4_1, var_4_0("island_draw_time"))
	...
	var_1(var_4_3, var_4_2("island_draw_reward"))
	...
	var_1(var_4_8, var_4_7("island_draw_lottery"))
	...
	local function var_4_11()
		...
		if var_0.GetTimesLeft(var_13_0) < 1 then
			...
			var_13_2(var_13_1, var_2_10002("island_draw_float"))
	...
	var_1(var_4_13, var_4_12("island_draw_lottery"))
	...
	local function var_4_16()
		...
		if var_0.GetTimesLeft(var_14_0) < 10 then
			...
			var_14_2(var_14_1, var_2_10002("island_draw_float"))
	...
	local var_4_19 = var_3.Find(var_4_18, "bg")
	...
	var_1(var_4_17, var_4_19, var_4_20, var_5)
...
function var_0_1.TryDraw(arg_16_0, arg_16_1)
	...
	if var_2.GetDrawTimes(var_16_0) < arg_16_1 then
		...
		local var_16_1 = var_16_0.Create
		local var_16_2 = {}

		var_1_10006 = arg_16_0.activity
		var_16_2.id = var_5.GetDrawConfig(var_1_10006, "shop")
		Goods = var_5

		local var_16_3 = var_16_1(var_16_2, var_5.TYPE_SHOPSTREET)
		local var_16_4 = var_3.GetConsume(var_16_3)
		local var_16_5 = arg_16_0.rawIconDic

		if not arg_16_0.rawIconDic.diamond then
			GetSpriteFromAtlas = var_1_10006
			var_1_10008 = var_16_4
			var_1_10006 = var_1_10006(var_16_4.getIcon(var_1_10008), "")
		end

		var_16_5.diamond = var_1_10006
		var_1_10006 = arg_16_0.viewComponent

		local var_16_6 = var_5.ShowMsgBox
		local var_16_7 = {}

		IslandMsgBox = var_1_10008
		var_16_7.type = var_1_10008.TYPE_COMMON
		i18n = var_8

		local var_16_8 = "island_draw_tip3"

		string = var_1_10010

		local var_16_9 = var_1_10010.format("<icon name=diamond w=0.76 h=0.76/>×%d", var_16_4.count * (arg_16_1 - var_2))

		string = var_11
		var_16_7.content = var_8(var_16_8, var_16_9, var_11.format("<icon name=ticket w=0.76 h=0.76/>×%d", arg_16_1 - var_2))

		function var_16_7.onYes()
			local var_17_0 = var_16_4

			if var_0.getOwnedCount(var_17_0) < var_16_4.count * (arg_16_1 - var_0) then
				...
				var_17_3(var_17_2, var_2.SHOPPING, var_0.id, arg_16_1 - var_0)
			end

			return
		end

		var_16_7.rawIconDic = arg_16_0.rawIconDic

		var_16_6(var_1_10006, var_16_7)
	else
		local var_16_10 = arg_16_0.viewComponent
		local var_16_11 = var_3.ShowMsgBox
		local var_16_12 = {}

		IslandMsgBox = var_1_10006
		var_16_12.type = var_1_10006.TYPE_COMMON
		i18n = var_6
		var_16_12.content = var_6("island_draw_ready")
		...
		function var_16_12.onYes()
			...
			var_18_1(var_18_0, var_2_10002.DRAW_AWARD_OPERATION, {
				op = "do_draw",
...
function var_0_1.ShowChargeWindow(arg_19_0)
	...
	var_19_2.type = var_1_10004.TYPE_COMMON
	i18n = var_4
	var_19_2.content = var_4("island_draw_tip4")
	...
	function var_19_2.onYes()
		...
		local var_20_2 = var_2_10002.CHANGE_SCENE

		SCENE = var_2_10003

		local var_20_3 = var_2_10003.CHARGE
		local var_20_4 = {}

		ChargeScene = var_2_10005
		var_20_4.wrap = var_2_10005.TYPE_DIAMOND
...
function var_0_1.UpdateActivity(arg_21_0, arg_21_1)
	...
	var_21_0(arg_21_0.rtMiddle, function(arg_22_0, arg_22_1)
		...
		var_2_10003(var_22_0, {
			S = function()
				...
				var_3_10000(var_1.Find(var_23_0, "mask"), var_21_1)

				setActive = var_3_10000

				local var_23_1 = arg_22_0

				var_3_10000(var_1.Find(var_23_1, "btn_sequence"), var_21_1)

				setActive = var_3_10000

				local var_23_2 = arg_22_0

				var_3_10000(var_1.Find(var_23_2, "state_sequence"), not var_21_1)
				...
				if var_21_1 then
					...
					var_1.Reset(var_23_5)

					ipairs = var_1

					for iter_23_0, iter_23_1 in var_1(var_23_4) do
						local var_23_6 = arg_21_0.bannerRectDic[var_22_0]
						local var_23_7 = var_6.AddChild(var_23_6)

						pg = var_23_6

						local var_23_8 = var_23_6.island_draw_reward[iter_23_1]

						GetImageSpriteFromAtlasAsync = var_3_10008

						var_3_10008("island/IslandDrawAwardIcon/" .. var_23_8.show, "", var_23_7:Find("Image"), true)
					end

					local var_23_9 = arg_21_0.bannerRectDic[var_22_0]

					var_1.SetTriggerDotCall(var_23_9, function(arg_24_0)
						local var_24_0 = var_23_4[arg_24_0]

						setActive = var_4_10002

						local var_24_1 = arg_22_0
						local var_24_2 = var_3.Find(var_24_1, "got")
						local var_24_3 = arg_21_0.activity

						var_4_10002(var_24_2, var_4.GetLastItemCount(var_24_3, var_24_0) == 0)
					...
					var_1.SetUp(var_23_10)
				else
					setActive = var_23_4

					local var_23_11 = arg_22_0

					var_23_4(var_1.Find(var_23_11, "got"), false)
				end
				...
				local var_23_15 = var_2.Find(var_23_14, "times_left/Text")
				...
				if 0 < var_23_13 then
					...
					var_23_12(var_23_15, var_23_16)

					setText = var_23_12

					local var_23_17 = arg_22_0

					var_23_12(var_2.Find(var_23_17, "times_left/times"), var_23_13 > 0 and var_23_13 or "")
			...
			A = function()
				...
				var_3_10000(var_1.Find(var_25_0, "got"), false)
				...
				local var_25_4 = var_2.Find(var_25_3, "times_left/Text")
				...
				if 0 < var_25_2 then
					...
					var_25_1(var_25_4, var_25_5)

					setText = var_25_1

					local var_25_6 = arg_22_0

					var_25_1(var_2.Find(var_25_6, "times_left/times"), var_25_2 > 0 and var_25_2 or "")
					...
					for iter_25_0, iter_25_1 in var_2(var_25_8) do
						...
						local var_25_12 = var_25_10.island_draw_reward[iter_25_1]

						GetImageSpriteFromAtlasAsync = var_3_10009

						var_3_10009("island/IslandDrawAwardIcon/" .. var_25_12.show, "", var_25_11:Find("Image"), true)
					end
					...
					var_2.SetTriggerDotCall(var_25_13, function(arg_26_0)
						...
						local var_26_2 = var_3.Find(var_26_1, "got")
						local var_26_3 = arg_21_0.activity

						var_4_10002(var_26_2, var_4.GetLastItemCount(var_26_3, var_26_0) == 0)
			...
			select = function()
				...
				var_3_10000(var_1.Find(var_27_0, "got"), false)
				...
				local var_27_6 = var_3.Find(var_27_5, "count_word")

				string = var_27_5

				var_27_3(var_27_6, var_27_5.format("%d/%d", var_27_2, var_27_4))

				setActive = var_27_3

				local var_27_7 = arg_22_0

				var_27_3(var_3.Find(var_27_7, "btn_select/on"), var_27_4 > 0 and var_27_4 <= var_27_2)
				...
				for iter_27_0, iter_27_1 in var_3(var_27_9) do
					...
					var_3_10008, var_27_11 = var_3_10008(iter_27_1)

					local var_27_12 = arg_21_0.bannerRectDic[var_22_0]
					local var_27_13 = var_10.AddChild(var_27_12)

					pg = var_27_12

					local var_27_14 = var_27_12.island_draw_reward[var_3_10008]

					GetImageSpriteFromAtlasAsync = var_3_10012

					var_3_10012("island/IslandDrawAwardIcon/" .. var_27_14.show, "", var_27_13:Find("Image"), true)
				end

				local var_27_15 = arg_21_0.bannerRectDic[var_22_0]

				var_3.SetTriggerDotCall(var_27_15, function(arg_28_0)
					unpack = var_4_10001

					local var_28_0, var_28_1 = var_4_10001(var_27_9[arg_28_0])

					setActive = var_4_10003

					local var_28_2 = arg_22_0

					var_4_10003(var_4.Find(var_28_2, "got"), not var_28_1)
			...
			var_3_10000(var_1.Find(var_29_0, "got"), false)
			...
			local var_29_4 = var_2.Find(var_29_3, "times_left/Text")
			...
			if 0 < var_29_2 then
				...
				var_29_1(var_29_4, var_29_5)

				setText = var_29_1

				local var_29_6 = arg_22_0

				var_29_1(var_2.Find(var_29_6, "times_left/times"), var_29_2 > 0 and var_29_2 or "")
				...
				if var_1.GetShowRankList(var_29_7, var_22_0)[1] then
					...
					local var_29_8 = var_29_7.island_draw_reward[var_1]
					...
					var_3(var_29_9, var_29_10, var_6.Find(var_29_11, "mask/Image"), true)

					setActive = var_3

					local var_29_12 = arg_22_0

					var_3(var_4.Find(var_29_12, "got"), false)
				end
	...
	local var_21_2 = var_21_0.TimeMgr.GetInstance()

	underscore = var_4

	local var_21_3 = var_4.map
	local var_21_4 = {}
	local var_21_5 = arg_21_0.activity

	var_21_4[1] = var_6.getStartTime(var_21_5)
	...
	local var_21_6 = var_21_3(var_21_4, function(arg_30_0)
		...
		local var_30_1 = var_2_10004.split
		local var_30_2 = var_21_2

		return var_2_10001(var_30_0, var_2_10003(var_30_1(var_5.STimeDescS(var_30_2, arg_30_0, "%Y/%m/%d"), "/")))
	end)

	setText = var_21_4

	local var_21_7 = arg_21_0.rtTitle
	local var_21_8 = var_6.Find(var_21_7, "Text_1")

	string = var_21_7

	local var_21_9 = var_21_7.format
	local var_21_10 = "%s\n-%s"

	unpack = var_1_10009

	local var_21_11 = var_21_9(var_21_10, var_1_10009(var_21_6))

	i18n = var_21_10

	var_21_4(var_21_8, var_21_11 .. var_21_10("island_draw_time_1"))
	...
	var_21_12(var_7.Find(var_21_14, "bg/on"), var_21_13 >= 1)

	setActive = var_21_12

	local var_21_15 = arg_21_0.btnDraw

	var_21_12(var_7.Find(var_21_15, "bg/off"), var_21_13 < 1)

	setActive = var_21_12

	local var_21_16 = arg_21_0.btnDrawTen

	var_21_12(var_7.Find(var_21_16, "bg/on"), var_21_13 >= 10)

	setActive = var_21_12

	local var_21_17 = arg_21_0.btnDrawTen

	var_21_12(var_7.Find(var_21_17, "bg/off"), var_21_13 < 10)

	Drop = var_21_12

	local var_21_18 = var_21_12.New
	local var_21_19 = {}

	DROP_TYPE_VITEM = var_8
	var_21_19.type = var_8

	local var_21_20 = arg_21_0.activity

	var_21_19.id = var_8.GetDrawConfig(var_21_20, "cost_free")

	local var_21_21 = var_21_18(var_21_19)
	local var_21_22 = {}

	GetSpriteFromAtlas = var_8
	var_21_22.ticket = var_8(var_21_21:getIcon(), "")
	...
	var_21_22(var_21_23, var_21_24, var_10.Find(var_21_25, "cost/icon"))
	...
	var_21_22(var_21_26, var_21_27, var_10.Find(var_21_28, "cost/icon"))
...
function var_0_1.OpenChangeListWindow(arg_31_0)
	...
	IslandMsgBox = var_1_10004
	var_31_2.type = var_1_10004.TYPE_DRAW_AWARD_LIST
...
function var_0_1.OpenAllAwardWindow(arg_32_0)
	...
	IslandMsgBox = var_1_10004
	var_32_2.type = var_1_10004.TYPE_DRAW_AWARD_ALL
...
function var_0_1.OpenSelectAwardWindow(arg_33_0)
	...
	IslandMsgBox = var_1_10004
	var_33_2.type = var_1_10004.TYPE_DRAW_AWARD_COUNT
...
function var_0_1.DrawOperation(arg_34_0, arg_34_1)
	...
	var_1_10002(arg_34_1.op, {
		set_list = function()
			...
			var_35_1(var_35_0, var_2_10002("island_draw_sort"))
...
function var_0_1.ShowDrawAwardWindow(arg_37_0, arg_37_1)
	...
	var_1_10004(var_5.Find(var_37_2, "window"), function(arg_38_0, arg_38_1)
		...
		var_2(arg_38_0:Find("container"), function(arg_39_0, arg_39_1)
			...
			local var_39_1 = arg_39_0.Find(var_39_0, "card")

			setActive = var_39_0

			var_39_0(var_39_1:Find("front/S/IslandDrawAwardPage_bomb01"), false)

			setActive = var_39_0

			var_39_0(var_39_1:Find("bg/S/SCardLoopVX"), false)

			setActive = var_39_0

			var_39_0(var_39_1:Find("front/A/IslandDrawAwardPage_bomb02"), false)

			setActive = var_39_0

			var_39_0(var_39_1:Find("bg/A/ACardLoopVX"), false)
	...
	var_5.StaticAlign(var_37_1:Find("container"), var_37_1:Find("container/tpl"), #arg_37_1, function(arg_40_0, arg_40_1, arg_40_2)
		local var_40_0
		...
		if arg_40_0 == var_40_0.EventUpdate then
			local var_40_1 = arg_40_2:Find("card")
			local var_40_2 = arg_37_1[arg_40_1]

			pg = var_5

			local var_40_3 = var_5.island_draw_reward[var_40_2]

			Drop = var_2_10006

			local var_40_4 = var_2_10006.New({
				type = var_40_3.drop_type,
				id = var_40_3.drop_id
			})

			var_0_1.ShowDropInfo(var_40_4, var_40_1:Find("mask/Image"))

			switch = var_7

			local var_40_5 = var_7(var_40_3.rarity, {
				function()
					return "C"
				end,
				function()
			...
			local var_40_6 = var_40_1
			local var_40_7 = var_40_1.Find(var_40_6, "mask/Image")

			if var_40_5 == "S" then
				setLocalScale = var_40_6

				local var_40_8 = var_40_1
				local var_40_9 = var_40_1.Find(var_40_8, "mask/Image")

				Vector3 = var_40_8

				var_40_6(var_40_9, var_40_8(1.2, 1.2, 1))

				setLocalPosition = var_40_6

				var_40_6(var_40_1:Find("mask/Image"), {
					x = -17.5,
					y = -20
				})
			else
				...
				local var_40_10 = var_40_1
				local var_40_11 = var_40_1.Find(var_40_10, "mask/Image")

				Vector3 = var_40_10

				var_40_6(var_40_11, var_40_10(1.7, 1.7, 1))

				setLocalPosition = var_40_6

				local var_40_12 = var_40_1
				local var_40_13 = var_40_1.Find(var_40_12, "mask/Image")

				Vector3 = var_40_12

				var_40_6(var_40_13, var_40_12.zero)
			end

			eachChild = var_40_6

			var_40_6(var_40_1:Find("bg"), function(arg_45_0, arg_45_1)
				setActive = var_3_10002

				var_3_10002(arg_45_0, arg_45_0.name == var_40_5)
			...
			var_40_6(var_40_1:Find("word"), function(arg_46_0, arg_46_1)
				setActive = var_3_10002

				var_3_10002(arg_46_0, arg_46_0.name == var_40_5)
			...
			var_40_6(var_40_1:Find("front"), function(arg_47_0, arg_47_1)
				setActive = var_3_10002

				var_3_10002(arg_47_0, arg_47_0.name == var_40_5)

				return
			end)

			local var_40_14 = var_40_1:Find("Book")
			local var_40_15 = var_9.GetComponent

			typeof = var_11
			Book = var_12

			local var_40_16 = var_40_15(var_40_14, var_11(var_12))

			var_9.SetCurrentPage(var_40_16, 2)
	...
	var_5(var_6.Find(var_37_4, "page"), 0)
	...
	var_6.insert(var_37_5, function(arg_48_0)
		...
		local var_48_4 = var_48_3(var_48_2, var_3(var_4))
	...
	var_6.insert(var_37_5, function(arg_49_0)
		...
		for iter_49_0, iter_49_1 in var_2_10002(var_37_3) do
			local var_49_1 = iter_49_1
			local var_49_2 = iter_49_1.Find(var_49_1, "card")

			table = var_49_1

			var_49_1.insert(var_49_0, function(arg_50_0)
				local var_50_0 = {}
				...
				if var_37_0 == "ten" and 0 < var_50_1 then
					...
					var_3.insert(var_50_0, function(arg_51_0)
						...
						var_51_0(var_51_1, var_51_2, var_4_10004.Action(arg_51_0))
				...
				var_3.insert(var_50_0, function(arg_52_0)
					local var_52_0 = var_49_2
					local var_52_1 = var_1.GetComponent

					typeof = var_4_10003
					DftAniEvent = var_4_10004

					local var_52_2 = var_52_1(var_52_0, var_4_10003(var_4_10004))
					...
					var_1(var_37_0, {
						one = function()
							...
							var_5_10000(var_49_2, "anim_IslandDrawAwardPage_onetpl_In")
						...
						ten = function()
							...
							var_5_10000(var_49_2, var_50_1 % 2 == 0 and "anim_IslandDrawAwardPage_ten" or "anim_IslandDrawAwardPage_ten02")
		...
		var_2(var_49_0, function()
			...
			var_56_0(var_56_1, var_3_10002.Action(function()
				arg_49_0()
	...
	var_6.insert(var_37_5, function(arg_58_0)
		...
		for iter_58_0, iter_58_1 in var_2_10002(var_37_3) do
			local var_58_1 = iter_58_1
			local var_58_2 = iter_58_1.Find(var_58_1, "card")

			table = var_58_1

			var_58_1.insert(var_58_0, function(arg_59_0)
				local var_59_0 = {}
				...
				if 0 < var_59_1 then
					...
					var_3.insert(var_59_0, function(arg_60_0)
						...
						var_60_0(var_60_1, var_60_2, var_4_10004.Action(arg_60_0))
				...
				var_3.insert(var_59_0, function(arg_61_0)
					local var_61_0 = var_58_2
					local var_61_1 = var_1.Find(var_61_0, "Book")
					local var_61_2 = var_1.GetComponent

					typeof = var_3
					AutoFlip = var_4_10004

					local var_61_3 = var_61_2(var_61_1, var_3(var_4_10004))

					var_1.StartControl(var_61_3)

					local var_61_4 = var_58_2
					local var_61_5 = var_2.GetComponent

					typeof = var_4_10004
					DftAniEvent = var_4_10005

					local var_61_6 = var_61_5(var_61_4, var_4_10004(var_4_10005))
					...
					var_2(var_58_2, "anim_IslandDrawAwardPage_uncover")
		...
		local var_58_3 = arg_37_0.rtDisplayPanel

		var_2(var_3.Find(var_58_3, "page"), "anim_IslandDrawAwardPage_page_in")
	...
	var_6.insert(var_37_5, function(arg_63_0)
		...
		var_63_0(var_63_1, var_2_10003.Action(function()
			arg_63_0()
	...
	var_6(var_37_5, function()
		...
		var_0(var_1.Find(var_65_0, "page"), "anim_IslandDrawAwardPage_page_out")
...
function var_0_1.HideDrawAwardWindow(arg_66_0)
	...
	var_1(var_2.Find(var_66_1, "window"), function(arg_67_0, arg_67_1)
...
function var_0_1.ShowDropInfo(arg_71_0, arg_71_1)
	...
	var_71_1[var_1_10005] = function()
		...
		var_2_10000(var_73_0 .. var_2.getConfig(var_73_1, "icon"), "", arg_71_1, true)
	...
	var_71_1[var_1_10005] = function()
		...
		var_2_10000(var_74_0 .. var_2.getConfig(var_74_1, "icon"), "", arg_71_1, true)
	...
	var_71_1[var_1_10005] = function()
		...
		var_2_10000(var_75_0 .. var_2.getConfig(var_75_1, "icon"), "", arg_71_1, true)
	...
	var_71_1[var_1_10005] = function()
		...
		var_2_10000(var_76_0 .. var_2.getConfig(var_76_1, "resource"), "", arg_71_1, true)
