...
function var_0_1.FirstFlush(arg_3_0)
	...
	arg_3_0.gridLayoutGroup = var_3_4(var_3_3, var_3(var_1_10004))
	UIItemList = var_1
	...
	arg_3_0.descPanle = var_3_5(var_2.Find(var_3_6, "desc"), arg_3_0:IsShowItemCount())
	onButton = var_1
...
function var_0_1.Filter(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10003(arg_5_1) do
		...
		var_1_10008(var_1_10009(var_5_1, var_1_10011), "v is not a IslandItem")

		var_1_10009 = iter_5_1
		var_1_10008 = iter_5_1.GetCount(var_1_10009)
...
function var_0_1.UpdateLayout(arg_13_0)
	...
	local var_13_2 = arg_13_0.GetMaxHrzCnt(var_13_1)

	math = var_13_1

	local var_13_3 = var_13_1.min(#var_13_0, var_13_2)

	arg_13_0.gridLayoutGroup.constraintCount = var_13_3

	local var_13_4 = arg_13_0:GetTargetTr()

	arg_13_0.frameTr.position = var_0_1.TrPosition2LocalPos(var_13_4.parent, arg_13_0.frameTr.parent, var_13_4.position)
...
function var_0_1.TrPosition2LocalPos(arg_14_0, arg_14_1, arg_14_2)
	if arg_14_0 == arg_14_1 then
		...
		local var_14_2 = arg_14_1.InverseTransformPoint(var_14_1, var_14_0)

		Vector3 = var_14_1

		return var_14_1(var_14_2.x, var_14_2.y, 0)
	end
...
function var_0_1.UpdateItem(arg_17_0, arg_17_1, arg_17_2)
	...
	var_1_10003(var_1_10004(var_17_0, var_1_10006), "islandItem is not a IslandItem")
	...
	local var_17_2 = var_5.New
	local var_17_3 = {}

	DROP_TYPE_ISLAND_ITEM = var_1_10007
	var_17_3.type = var_1_10007
	var_17_3.id = arg_17_2.id

	local var_17_4 = arg_17_2

	var_17_3.count = arg_17_2.GetCount(var_17_4)
	...
	var_4(var_17_6, var_17_7, var_17_8, var_17_4)
	...
	typeof = var_17_7
	UILongPressTrigger = var_17_8

	local var_17_10 = var_4(var_17_9, var_17_7(var_17_8)).onLongPressed

	var_5.RemoveAllListeners(var_17_10)

	local var_17_11 = var_4.onLongPressed

	var_5.AddListener(var_17_11, function()
		var_17_5 = true
...
function var_0_1.OnHide(arg_22_0)
	...
	var_1.each(var_22_1, function(arg_23_0, arg_23_1)
		...
		typeof = var_2_10004
		UILongPressTrigger = var_2_10005

		local var_23_1 = var_2_10002(var_23_0, var_2_10004(var_2_10005)).onLongPressed
