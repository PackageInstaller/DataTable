...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.peopleCntTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_4
	Text = var_1_10005
	var_2_9[1] = var_2_12(var_2_11, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	var_2_9[2] = var_2_15(var_2_14, var_4(var_1_10005))
	...
	local var_2_23 = var_2.Find(var_2_22, "frame/public/Text")

	i18n = var_2_22

	var_2_21(var_2_23, var_2_22("island_kick_all"))

	setText = var_2_21

	local var_2_24 = arg_2_0._tf
	local var_2_25 = var_2.Find(var_2_24, "frame/onkey/Text")

	i18n = var_2_24

	var_2_21(var_2_25, var_2_24("island_close_visit"))

	setText = var_2_21

	local var_2_26 = arg_2_0._tf
	local var_2_27 = var_2.Find(var_2_26, "frame/cnt/label")

	i18n = var_2_26

	var_2_21(var_2_27, var_2_26("island_curr_people_cnt"))
...
function var_0_1.OnInit(arg_7_0)
	...
	local function var_7_8()
		...
		var_10_1(var_10_0, var_2_10003.KICK_ALL_VISITOR, var_0)
	...
	local function var_7_11()
		...
		if not var_12_3(var_12_2, var_2_10003.OPEN_ALL) then
			pg = var_1

			local var_12_4 = var_1.TipsMgr.GetInstance()
			local var_12_5 = var_1.ShowTips

			i18n = var_3

			var_12_5(var_12_4, var_3("island_close_access_state"))
		...
		IslandConst = var_3
		var_12_7[1] = var_3.OPEN_ALL

		local var_12_8 = arg_7_0
		local var_12_9 = var_3.emit

		IslandMediator = var_2_10005

		var_12_9(var_12_8, var_2_10005.SET_ACCESS_FLAG, var_12_6, var_12_7)
	...
	for iter_7_0, iter_7_1 in var_1_10001(arg_7_0.toggles) do
		...
		local function var_7_16(arg_13_0)
			if arg_13_0 then
				...
				var_1.SwitchPage(var_2_10002, iter_7_0)
			end

			local var_13_0 = var_7_12
		...
		var_1_10008(var_7_14, var_7_15, var_7_16, var_1_10012)
...
function var_0_1.AddListeners(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.PLAYER_ADD, arg_14_0.OnFlush)
	...
	var_14_3(var_14_2, var_3.PLAYER_EXIT, arg_14_0.OnFlush)
...
function var_0_1.RemoveListeners(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.PLAYER_ADD, arg_15_0.OnFlush)
	...
	var_15_3(var_15_2, var_3.PLAYER_EXIT, arg_15_0.OnFlush)
...
function var_0_1.GetDisplayData(arg_17_0, arg_17_1)
	...
	if arg_17_1 == var_0_2 then
		var_1_10004 = arg_17_0
		var_1_10004 = arg_17_0.GetIsland(var_1_10004)
		var_1_10004 = var_3.GetVisitorAgency(var_1_10004)

		local var_17_1 = var_3.GetPlayerList(var_1_10004)
	...
	elseif arg_17_1 == var_0_3 then
		...
		for iter_17_2, iter_17_3 in var_1_10005(var_17_5) do
			var_1_10011 = iter_17_3

			if not iter_17_3.IsSelf(var_1_10011) then
				table = var_10
		...
		for iter_17_4 = 2, #var_17_6 do
			...
			if not var_1_10011.IsSameDay(var_17_9, var_17_7, var_17_8) then
				...
				IslandVisitorLog = var_13

				var_1_10011(var_17_10, var_13.New({
					id = -1,
					time = var_17_8
				}))
			end
...
function var_0_1.OnInitItem(arg_20_0, arg_20_1)
	...
	local function var_20_3()
		...
		local var_21_2 = var_2_10002.ON_KICK_PLAYER

		IslandConst = var_2_10003

		var_21_1(var_21_0, var_21_2, var_2_10003.ACCESS_OP_KICK, var_20_0.player.id)
	...
	var_3(var_20_1, var_20_2, var_20_3, var_1_10007)
	...
	local function var_20_6()
		...
		var_22_1(var_22_0, var_2_10002.OPEN_PAGE, "IslandOtherCardPage", {
			var_20_0.player.id
		})
	...
	var_3(var_20_4, var_20_5, var_20_6, var_1_10007)
