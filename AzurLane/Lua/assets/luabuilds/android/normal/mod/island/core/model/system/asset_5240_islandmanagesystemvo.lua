...
function var_0_1.GetUnits(arg_4_0, arg_4_1)
	...
	for iter_4_0, iter_4_1 in var_3(arg_4_0.assistants) do
		...
		if var_4_3 ~= 0 then
			...
			if var_4_3 == 1 then
				...
				pg = var_1_10015
				var_1_10014.modelId = var_1_10015.island_chara_template[var_4_3].unit_id
				IslandConst = var_1_10015
				var_1_10014.type = var_1_10015.UNIT_TYPE_MANAGE_CHARA
				var_1_10014.name = "system_unit" .. var_4_3
				var_1_10014.position = var_1_10011.param.position
				var_1_10014.rotation = var_1_10011.param.rotation
				Vector3 = var_1_10015
				var_1_10014.scale = var_1_10015.one
	...
	local var_4_6 = var_4_4(var_5.island_set.island_manage_customer_list.key_value_varchar)

	ipairs = var_5

	for iter_4_2, iter_4_3 in var_5(var_4_5) do
		...
		var_15.removebyvalue(var_4_6, var_1_10014)

		IslandUnitVO = var_15

		local var_4_9 = var_15.New
		local var_4_10 = {
		...
		IslandConst = var_17
		var_4_10.type = var_17.UNIT_TYPE_MANAGE_CUSTOMER
		var_4_10.name = "system_unit" .. var_4_7
		var_4_10.position = var_1_10012.param.position
		var_4_10.rotation = var_1_10012.param.rotation
		Vector3 = var_17
		var_4_10.scale = var_17.one

		local var_4_11 = var_4_9(var_4_10)

		table = var_4_10

		var_4_10.insert(var_4_0, var_4_11)

		IslandUnitVO = var_16

		local var_4_12 = var_16.New
		local var_4_13 = {
			behaviourTree = "",
			id = var_4_8,
		...
		IslandConst = var_18
		var_4_13.type = var_18.UNIT_TYPE_MANAGE_ITEM
		var_4_13.name = "system_unit" .. var_4_8
		var_4_13.position = var_1_10013.param.position
		var_4_13.rotation = var_1_10013.param.rotation
		Vector3 = var_18
		var_4_13.scale = var_18.one

		local var_4_14 = var_4_12(var_4_13)

		table = var_4_13

		var_4_13.insert(var_4_0, var_4_14)
	end
