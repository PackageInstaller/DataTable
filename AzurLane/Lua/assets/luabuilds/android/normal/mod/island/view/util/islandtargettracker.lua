...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.cg = var_2(var_1_0, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.distanceTxt = var_1_4(var_1_3, var_4(var_1_10005))
	Vector2 = var_2
	Screen = var_1_3
	...
	Screen = var_4
	arg_1_0.screenSize = var_2(var_1_5, var_4.height)
	Vector2 = var_2
...
function var_0_0.Update(arg_4_0, arg_4_1)
	...
	if arg_4_1 and not arg_4_0.isAttach then
		...
		arg_4_0.AdjustTargetPosition(var_1_10003, arg_4_1)
	end
	...
	Time = var_1_10006
	var_4_0.localPosition = var_4_1(var_4_2, var_4_3, var_1_10006.deltaTime * arg_4_0.lerpSpeed)
...
function var_0_0.AdjustTargetPosition(arg_6_0, arg_6_1)
	...
	local var_6_3 = var_6_2 * var_4.atan2(arg_6_0.targetPosition.x - 1, arg_6_0.targetPosition.y)

	math = var_4

	if var_4.abs(var_6_3 - var_6_1) < var_0_2 then
		local var_6_4, var_6_5 = arg_6_0:RotatePoint(arg_6_1.x, arg_6_1.y, var_0_2)

		Vector3 = var_6
		arg_6_0.targetPosition = var_6(var_6_4, var_6_5, 0)
	end
...
function var_0_0.RotatePoint(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_2 = var_7_1 - arg_7_2 * var_6.sin(var_7_0)
...
function var_0_0.SetUp(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	arg_12_0.timer = var_4.New(function()
		...
		local var_13_1 = var_1.IsInViewport(var_13_0)
		...
		if var_13_6 then
			var_2_10009 = arg_12_0

			local var_13_10, var_13_11

			var_13_10, var_2_10009, var_13_11 = var_8.CalcNearPosition(var_2_10009, arg_12_2.transform)
			var_13_9 = var_13_11
			var_13_8 = var_2_10009
			var_13_7 = var_13_10
		else
			var_2_10009 = arg_12_0
			...
			var_13_12, var_2_10009, var_13_13 = var_8.CalcPosition(var_2_10009, arg_12_2.transform)
			var_13_9 = var_13_13
			var_13_8 = var_2_10009
			var_13_7 = var_13_12
		end
		...
		Vector3 = var_2_10009
		var_13_14.targetPosition = var_2_10009(var_13_7.x, var_13_7.y, 0)

		local var_13_15 = arg_12_0.arrTr

		Vector3 = var_9
		var_13_15.localEulerAngles = var_9(0, 0, var_13_8)
...
function var_0_0.CalcPosition(arg_14_0, arg_14_1)
	...
	if var_14_7 + var_8.pow(var_14_6.y / arg_14_0.radiusOfEllipse.y, 2) > 1 then
		...
		Mathf = var_14_10
		var_14_10 = var_14_10.Pow(arg_14_0.radiusOfEllipse.y, 2)
		Mathf = var_1_10011
		var_1_10011 = var_1_10011.Pow(var_14_8, 2)
		Mathf = var_12
		var_14_10 = var_14_10 + var_1_10011 * var_12.Pow(arg_14_0.radiusOfEllipse.x, 2)
		math = var_1_10011
		var_1_10011 = var_1_10011.sqrt(var_14_9 / var_14_10)
		math = var_12

		local var_14_11 = var_12.sign(var_1_10011)

		math = var_13

		if var_14_11 ~= var_13.sign(var_14_6.x) then
			var_1_10011 = -1 * var_1_10011
		end

		local var_14_12 = var_1_10011 * var_14_8

		Vector2 = var_13

		local var_14_13 = var_13(var_1_10011, var_14_12)
		...
		local var_14_15 = var_15.up

		Vector2 = var_1_10016

		local var_14_16 = var_14_14(var_14_15, var_1_10016(var_14_6.x, var_14_6.y))

		return
	elseif var_7 < 1 then
		var_14_9 = arg_14_0

		return arg_14_0.CalcNearPosition(var_14_9, arg_14_1)
	else
		...
		local var_14_19 = var_14_10.up

		Vector2 = var_1_10011

		local var_14_20 = var_14_18(var_14_19, var_1_10011(var_14_6.x, var_14_6.y))
...
function var_0_0.CalcNearPosition(arg_15_0, arg_15_1)
	...
	local var_15_3 = var_15_0.WorldToScreenPoint(var_15_2, var_15_1)

	Vector2 = var_15_2

	return var_15_2(var_15_3.x, var_15_3.y) - arg_15_0.screenCenter, 180, true
end
