...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandBaseDressupPage"))
...
function var_0_1.OnLoaded(arg_3_0)
	...
	local var_3_4 = var_2.Find(var_3_3, "adapt/left_panel/title/Text")

	i18n = var_3_3

	var_1(var_3_4, var_3_3("island_dressup_titile"))
...
function var_0_1.AddListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.ISLAND_CHANGE_COMMANDER_DRESS_DONE, arg_4_0.OnDressUpDone)
...
function var_0_1.RemoveListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10003.ISLAND_CHANGE_COMMANDER_DRESS_DONE, arg_5_0.OnDressUpDone)
...
function var_0_1.OnInit(arg_6_0)
	...
	local function var_6_5()
		...
		if var_0.CheckDressIsDirty(var_8_0) then
			...
			var_8_3.type = var_2_10003.TYPE_COMMON
			i18n = var_3
			var_8_3.content = var_3("island_dressup_tip_1")
...
function var_0_1.Show(arg_11_0, arg_11_1)
	...
	arg_11_0.currentChildPage = var_11_2(var_11_1, var_4, 0, true, arg_11_0.shipDressHelper)
	pg = var_2
