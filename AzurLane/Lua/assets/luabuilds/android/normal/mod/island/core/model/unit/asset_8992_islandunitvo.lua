...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.genType = var_2(var_1_0, var_1_10004.UNIT_GEN_TYPE_STATIC)

	local var_1_1 = arg_1_0.genType

	IslandConst = var_1_0
	arg_1_0.isDynamic = var_1_1 == var_1_0.UNIT_GEN_TYPE_DYNAMIC
	defaultValue = var_2
...
function var_0_0.GetAssetPath(arg_11_0)
	...
	if arg_11_0:IsNpcType() then
		...
		var_2(var_3.island_unit_character[arg_11_0.modelId], arg_11_0.modelId)
