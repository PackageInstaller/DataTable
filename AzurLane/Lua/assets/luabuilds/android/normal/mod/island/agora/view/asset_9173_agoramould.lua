...
function var_0_1.InitArea(arg_2_0)
	...
	Vector3 = var_1_10003
	var_2_2.localScale = var_1_10003(var_2_1.x, 0.01, var_2_1.y)
...
function var_0_1.OnInit(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_2 = var_1_10005.NameToLayer

	IslandConst = var_1_10006

	var_5_0(var_5_1, var_5_2(var_1_10006.LAYER_WORLDMAP3D))
	...
	typeof = var_5
	NodeCanvas = var_5_9
	arg_5_0.behaviourTreeOwner = var_5_11(var_5_10, var_5(var_5_9.BehaviourTrees.BehaviourTreeOwner))
...
function var_0_1.AddListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.ITEM_POSITION_UPDATE, arg_6_0.UpdatePosition)
	...
	var_6_3(var_6_2, var_3.ITEM_DIR_UPDATE, arg_6_0.UpdateRotation)
...
function var_0_1.RemoveListeners(arg_7_0)
	...
	var_7_1(var_7_0, var_1_10003.ITEM_POSITION_UPDATE, arg_7_0.UpdatePosition)
	...
	var_7_3(var_7_2, var_3.ITEM_DIR_UPDATE, arg_7_0.UpdateRotation)
...
function var_0_1.UpdatePosition(arg_8_0, arg_8_1)
	...
	if var_4.IsBuildingType(var_8_2) then
		...
		var_8_2 = arg_8_0.data

		if var_4.IsNewTileType(var_8_2) then
			Vector3 = var_4
			var_8_1 = var_4(0, 0.01, 0)
		end
	end

	local var_8_3 = arg_8_0.root

	IslandConst = var_8_2
	var_8_3.position = var_8_0 + var_8_2.AGORA_POSITION_OFFSET + var_8_1
