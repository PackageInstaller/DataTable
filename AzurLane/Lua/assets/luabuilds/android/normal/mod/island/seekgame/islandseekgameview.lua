...
function var_0_1.Init(arg_1_0)
	...
	var_1_1(var_1_0, var_1_2, var_1_10004.SEEK_GAME_START)
...
function var_0_1.OnSceneInited(arg_2_0)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10003.SEEK_GAME_SYSTEM_ID)

	IslandSeekGameResultView = var_2_0

	local var_2_3 = var_2_0.New
	local var_2_4 = arg_2_0
	local var_2_5 = var_2_2.data

	arg_2_0.resultView = var_2_3(var_2_4, var_4.GetResultUIName(var_2_5))
...
function var_0_1.AddListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.SEEK_GAME_FAILED, arg_3_0.OnGameFailed)
	...
	var_3_3(var_3_2, var_3.SEEK_GAME_SUCCESS, arg_3_0.OnGameSuccess)
...
function var_0_1.RemoveListeners(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.SEEK_GAME_FAILED, arg_4_0.OnGameFailed)
	...
	var_4_3(var_4_2, var_3.SEEK_GAME_SUCCESS, arg_4_0.OnGameSuccess)
...
function var_0_1.OnGameStart(arg_5_0)
	...
	local var_5_3 = var_5_2(var_5_1, var_3.SEEK_GAME_SYSTEM_ID)
...
function var_0_1.OnGameFailed(arg_6_0)
	...
	local var_6_2 = var_6_1(var_6_0, var_1_10003.SEEK_GAME_SYSTEM_ID)
...
function var_0_1.OnGameSuccess(arg_7_0)
	...
	local var_7_2 = var_7_1(var_7_0, var_1_10003.SEEK_GAME_SYSTEM_ID)
...
function var_0_1.RestartGame(arg_8_0)
	...
	local var_8_2 = var_8_1(var_8_0, var_1_10003.SEEK_GAME_SYSTEM_ID)
...
function var_0_1.DisableOp(arg_10_0)
	...
	local var_10_3 = var_10_2(var_10_1, var_1_10003)
	...
	local var_10_6 = var_10_5(var_10_4, var_1_10003)
	...
	local var_10_9 = var_10_8(var_10_7, var_1_10003)
...
function var_0_1.EnableOp(arg_11_0)
	...
	local var_11_2 = var_11_1(var_11_0, var_1_10003)
	...
	local var_11_5 = var_11_4(var_11_3, var_1_10003)
	...
	local var_11_8 = var_11_7(var_11_6, var_1_10003)
...
function var_0_1.OnDispose(arg_12_0)
	...
	var_12_1(var_12_0, var_12_2, var_1_10004.SEEK_GAME_END)
