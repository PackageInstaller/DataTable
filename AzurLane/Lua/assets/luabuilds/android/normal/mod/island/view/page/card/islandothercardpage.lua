...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".IslandSelfCardPage"))
...
function var_0_1.GetContext(arg_2_0)
	...
	var_2_1.mediator = var_1_10003
	IslandOtherCardAttach = var_1_10003
	var_2_1.viewComponent = var_1_10003
	var_2_1.data = {
		isIslandPage = true,
