...
function var_0_1.Recycle(arg_3_0, arg_3_1, arg_3_2)
	...
	IslandDelayRecycleUnitBuilder = var_1_10005

	if var_3_1 == var_1_10005.RecycleType.NormalSceneItem then
		local var_3_2 = arg_3_0:GetPoolMgr()

		var_5.ReturnSceneProductItem(var_3_2, var_3_0, arg_3_2)
	else
		IslandDelayRecycleUnitBuilder = var_5

		if var_3_1 == var_5.RecycleType.ProductEffect then
			local var_3_3 = arg_3_0:GetPoolMgr()

			var_5.ReturnSceneProductEffect(var_3_3, var_3_0, arg_3_2)
		end
	end
