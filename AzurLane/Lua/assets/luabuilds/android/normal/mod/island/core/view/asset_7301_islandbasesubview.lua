...
function var_0_1.LoadUI(arg_3_0, arg_3_1)
	...
	local var_3_6 = var_3_3(var_1_10007)

	UnityEngine = var_1_10007
	arg_3_0.loadingId = var_3_1(var_3_0, var_3_4, var_3_5, var_3_6, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_4_0)
		local var_4_0 = arg_3_0
		local var_4_1 = var_1.GetUIParent(var_4_0)
		local var_4_2 = arg_3_0

		FrameAsyncInstantiateManager = var_2_10003

		local var_4_3 = var_2_10003.Instance
		local var_4_4 = var_3.EnqueueInstantiateUI
		local var_4_5 = arg_4_0
		local var_4_6 = var_4_1

		Vector3 = var_2_10007
		var_4_2.insId = var_4_4(var_4_3, var_4_5, var_4_6, var_2_10007.zero, arg_3_1)
...
function var_0_1.DoInit(arg_5_0, arg_5_1, arg_5_2)
	...
	Vector3 = var_4
	var_5_0.localPosition = var_4.zero
