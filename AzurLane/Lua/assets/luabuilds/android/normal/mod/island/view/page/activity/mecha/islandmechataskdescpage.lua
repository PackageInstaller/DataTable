...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_2.Find(var_2_1, "list/content")
	local var_2_3 = arg_2_0._tf

	arg_2_0.uiItemList = var_2_0(var_2_2, var_3.Find(var_2_3, "list/content/tpl"))
...
function var_0_1.GetDayDesc(arg_10_0, arg_10_1)
	...
	return var_10_1.split(var_10_2, "/")[2], var_4[3]
end
...
function var_0_1.UpdateTask(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	local var_11_1 = arg_11_3:Find("Text")
	local var_11_2 = var_11_0

	var_5(var_11_1, var_11_0.getConfig(var_11_2, "task_desc"))

	IslandTaskActhelper = var_5

	local var_11_3, var_11_4, var_11_5 = var_5.GetIslandTaskState(arg_11_2)

	setText = var_11_2

	var_11_2(arg_11_3:Find("progress_1/Text"), var_11_3 .. "/" .. var_11_4)

	setFillAmount = var_11_2

	var_11_2(arg_11_3:Find("progress_1/bar"), var_11_3 / var_11_4)

	setActive = var_11_2

	var_11_2(arg_11_3:Find("lock"), arg_11_1 > arg_11_0.nday)

	local var_11_6 = var_11_0:GetAwards()[1]
	local var_11_7 = arg_11_3
	local var_11_8 = arg_11_3.Find(var_11_7, "InventoryTpl_1")

	updateCustomDrop = var_11_7
	...
	local function var_11_11()
		...
		local var_12_2 = var_2_10002.SHOW_MSG_BOX
		local var_12_3 = {}

		i18n = var_2_10004
		var_12_3.title = var_2_10004("island_word_desc")
		IslandMsgBox = var_4
		var_12_3.type = var_4.TYPE_COMMON_DROP_DESCRIBE
		var_12_3.dropData = var_11_6
	...
	var_11_7(var_11_9, var_11_10, var_11_11, var_1_10014)

	local var_11_12, var_11_13 = arg_11_0:GetDayDesc(arg_11_1 - 1)

	setText = var_12

	local var_11_14 = arg_11_3
	local var_11_15 = arg_11_3.Find(var_11_14, "lock/Text")

	i18n = var_11_14

	var_12(var_11_15, var_11_14("island_mecha_task_lock_tip", var_11_12, var_11_13))

	setActive = var_12

	local var_11_16 = arg_11_3.parent

	var_12(var_13.Find(var_11_16, "finish"), var_11_5 == 2)
