...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_5
	Text = var_1_10006
	var_2_8[var_2_9] = var_2_12(var_2_11, var_5(var_1_10006))
	...
	typeof = var_5
	Text = var_1_10006
	var_2_8[var_2_13] = var_2_16(var_2_15, var_5(var_1_10006))
	...
	local var_2_22 = var_2.Find(var_2_21, "frame/public/Text")

	i18n = var_2_21

	var_2_20(var_2_22, var_2_21("island_public_invitation"))

	setText = var_2_20

	local var_2_23 = arg_2_0._tf
	local var_2_24 = var_2.Find(var_2_23, "frame/onkey/Text")

	i18n = var_2_23

	var_2_20(var_2_24, var_2_23("island_onekey_invitation"))
	...
	for iter_5_0, iter_5_1 in var_1(arg_5_0.toggles) do
		...
		local function var_5_16(arg_10_0)
			if arg_10_0 then
				...
				var_1.SwitchPage(var_2_10002, iter_5_0)
			end

			local var_10_0 = var_5_12
		...
		var_1_10008(var_5_14, var_5_15, var_5_16, var_1_10012)
...
function var_0_1.DoShare(arg_11_0)
	...
	if var_11_2(var_11_1, var_1_10005.OPEN_SIGNIN) then
		pg = var_3
		...
		var_11_4(var_11_3, var_5("island_public_invitation_1"))
	...
	var_11_6(var_11_5, var_5.SHARE_SIGNIN)
...
function var_0_1.OnOneKey(arg_12_0)
	...
	var_12_2(var_12_1, var_4.SIGN_IN_INVITATION, var_12_0)
...
function var_0_1.AddListeners(arg_13_0)
	...
	var_13_1(var_13_0, var_1_10003.ISLAND_SIGN_IN_INVITATION_DONE, arg_13_0.OnInvitation)
	...
	var_13_3(var_13_2, var_3.ISLAND_SIGN_SHARE_SIGNIN_DONE, arg_13_0.OnShare)
...
function var_0_1.RemoveListeners(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.ISLAND_SIGN_IN_INVITATION_DONE, arg_14_0.OnInvitation)
	...
	var_14_3(var_14_2, var_3.ISLAND_SIGN_SHARE_SIGNIN_DONE, arg_14_0.OnShare)
...
function var_0_1.GetDisplayData(arg_17_0, arg_17_1)
	...
	if arg_17_1 == var_0_2 then
		...
		var_17_0 = var_3.getAllFriends(var_1_10004)
	elseif arg_17_1 == var_0_3 then
		getProxy = var_3
		GuildProxy = var_1_10004

		local var_17_1 = var_3(var_1_10004)
...
function var_0_1.DoInvitation(arg_21_0, arg_21_1)
	...
	var_21_1(var_21_0, var_1_10004.SIGN_IN_INVITATION, {
		arg_21_1.player.id
	})
