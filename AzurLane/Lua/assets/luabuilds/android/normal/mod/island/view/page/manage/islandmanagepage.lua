...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_6 = var_2_4.Find(var_2_5, "bg/event/Text")

	i18n = var_2_5

	var_2_3(var_2_6, var_2_5("island_manage_sp_event"))

	setText = var_2_3

	local var_2_7 = var_2_4
	local var_2_8 = var_2_4.Find(var_2_7, "bg/status/prepare/Text")

	i18n = var_2_7

	var_2_3(var_2_8, var_2_7("island_manage_no_work"))

	setText = var_2_3

	local var_2_9 = var_2_4
	local var_2_10 = var_2_4.Find(var_2_9, "bg/status/end/Text")

	i18n = var_2_9

	var_2_3(var_2_10, var_2_9("island_manage_end_work"))

	setText = var_2_3

	local var_2_11 = var_2_4
	local var_2_12 = var_2_4.Find(var_2_11, "btns/opening/Text")

	i18n = var_2_11

	var_2_3(var_2_12, var_2_11("island_manage_view"))

	setText = var_2_3

	local var_2_13 = var_2_4
	local var_2_14 = var_2_4.Find(var_2_13, "btns/close/Text")

	i18n = var_2_13

	var_2_3(var_2_14, var_2_13("island_manage_result"))
...
function var_0_1.OnInit(arg_3_0)
	...
	var_1.make(var_3_4, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventInit then
			...
			local var_5_1 = arg_5_2:Find("btns/prepare")

			local function var_5_2()
				local var_6_0 = arg_3_0
				local var_6_1 = var_0.OpenPage

				IslandRestaurantPage = var_3_10002

				var_6_1(var_6_0, var_3_10002, arg_3_0.restIds[arg_5_1 + 1])
			...
			var_3(var_5_0, var_5_1, var_5_2, var_7)

			onButton = var_3

			local var_5_3 = arg_3_0
			local var_5_4 = arg_5_2:Find("btns/opening")
			...
			local function var_5_5()
				...
				var_7_1(var_7_0, var_3_10002, arg_3_0.restIds[arg_5_1 + 1])
			...
			var_3(var_5_3, var_5_4, var_5_5, var_7)

			onButton = var_3

			local var_5_6 = arg_3_0
			local var_5_7 = arg_5_2:Find("btns/close")
			...
			local function var_5_8()
				...
				var_8_1(var_8_0, var_3_10002, arg_3_0.restIds[arg_5_1 + 1])
			...
			var_3(var_5_6, var_5_7, var_5_8, var_7)
		else
			UIItemList = var_3
			...
			if arg_5_0 == var_3.EventUpdate then
				...
				var_3.UpdataRest(var_5_9, arg_5_1, arg_5_2)
			end
		end
...
function var_0_1.AddListeners(arg_9_0)
	...
	IslandManageAgecny = var_1_10003

	var_9_1(var_9_0, var_1_10003.UPDATE_RESTAURANT, arg_9_0.Flush)
	...
	var_9_3(var_9_2, var_3.ADD_RESTAURANT, arg_9_0.Flush)
	...
	var_9_5(var_9_4, var_3.ON_DAILY_REFRESH, arg_9_0.Flush)
...
function var_0_1.RemoveListeners(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.UPDATE_RESTAURANT, arg_10_0.Flush)
	...
	var_10_3(var_10_2, var_3.ADD_RESTAURANT, arg_10_0.Flush)
	...
	var_10_5(var_10_4, var_3.ON_DAILY_REFRESH, arg_10_0.Flush)
...
function var_0_1.OnShow(arg_11_0)
	...
	var_2.eachActive(var_11_1, function(arg_12_0, arg_12_1)
		...
		var_12_2.insert(var_11_0, function(arg_13_0)
			...
			local var_13_2 = var_13_1(var_13_0, var_3_10003(var_3_10004))
			...
			var_13_4(var_13_3, var_3.delayedCall, function()
				arg_13_0()
...
function var_0_1.UpdataRest(arg_19_0, arg_19_1, arg_19_2)
	...
	if var_5 then
		local var_19_3 = var_5:getConfig("opening_number")
		local var_19_4 = var_5
		local var_19_5 = var_5.GetRemainCnt(var_19_4)

		setText = var_19_4

		local var_19_6 = arg_19_2
		local var_19_7 = arg_19_2.Find(var_19_6, "btns/prepare/Text")

		string = var_19_6

		local var_19_8 = var_19_6.format
		local var_19_9 = "%s(%d/%d)"

		i18n = var_1_10013

		var_19_4(var_19_7, var_19_8(var_19_9, var_1_10013("island_manage_prepare"), var_19_5, var_19_3))

		setText = var_19_4

		local var_19_10 = arg_19_2
		local var_19_11 = arg_19_2.Find(var_19_10, "btns/end/Text")

		string = var_19_10

		local var_19_12 = var_19_10.format
		local var_19_13 = "%s(%d/%d)"

		i18n = var_13

		var_19_4(var_19_11, var_19_12(var_19_13, var_13("island_manage_daily_cnt_tip"), var_19_5, var_19_3))

		LoadImageSpriteAsync = var_19_4

		var_19_4("island/islandrestaurant/" .. var_5:GetRankIcon(), arg_19_2:Find("bg/rank"))

		local var_19_14 = var_5
		local var_19_15 = var_5.GetEventInfo(var_19_14)

		setActive = var_19_14

		var_19_14(arg_19_2:Find("bg/event"), var_19_15 ~= 0)
...
function var_0_1.UpdataStatusInfo(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_4 = arg_20_1.Find(var_20_3, "bg/status/prepare")

	IslandRestaurant = var_20_3

	var_1_10005(var_20_4, var_20_1 == var_20_3.STATUS.PREPARE)

	setActive = var_1_10005

	var_1_10005(arg_20_1:Find("bg/status/opening"), var_20_2)

	setActive = var_1_10005

	local var_20_5 = arg_20_1
	local var_20_6 = arg_20_1.Find(var_20_5, "bg/status/end")

	IslandRestaurant = var_20_5

	var_1_10005(var_20_6, var_20_1 == var_20_5.STATUS.END)

	IslandRestaurant = var_1_10005

	local var_20_7

	if var_20_1 == var_1_10005.STATUS.OPENING then
		pg = var_20_7
		var_20_7 = var_20_7.TimeMgr.GetInstance()

		local var_20_8 = arg_20_2:GetEndTime() - var_20_7:GetServerTime()

		setText = var_7

		var_7(arg_20_1:Find("bg/status/opening/Text"), var_20_7:DescCDTime(var_20_8))
	else
		IslandRestaurant = var_20_7

		if var_20_1 == var_20_7.STATUS.CLOSE then
			setText = var_20_7

			var_20_7(arg_20_1:Find("bg/status/opening/Text"), "00:00:00")
		end
	end

	eachChild = var_20_7

	var_20_7(arg_20_1:Find("btns"), function(arg_21_0)
