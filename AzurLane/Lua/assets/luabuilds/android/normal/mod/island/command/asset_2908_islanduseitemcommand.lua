...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_1 > var_7.GetOwnCount(var_1_5, var_1_0) then
		...
		var_1_5(var_1_6, var_1_10011("common_no_resource"))
	...
	var_9.Send(var_1_7, 21026, {
		...
		if arg_2_0.result == 0 then
			...
			for iter_2_0, iter_2_1 in var_2(arg_2_0.ship_list) do
				local var_2_1 = var_0
				local var_2_2 = var_7.GetCharacterAgency(var_2_1)
				local var_2_3 = var_7.AddShip

				IslandShip = var_2_10009

				var_2_3(var_2_2, var_2_10009.New(iter_2_1))
			end

			var_2_10003 = var_0

			var_2.RemoveItem(var_2_10003, var_1_0, var_1_1)

			var_2_10003 = arg_1_0

			var_2.HandleUsageEffect(var_2_10003, var_1_0, var_1_2)
			...
			var_2_4(var_2_10003, var_4.ISLAND_USE_ITEM_DONE, {
				dropData = var_2_0
			})
		else
			pg = var_2_0
