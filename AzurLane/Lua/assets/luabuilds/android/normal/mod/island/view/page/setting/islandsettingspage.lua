...
function var_0_1.AddListeners(arg_2_0)
	...
	var_2_1(var_2_0, var_3.ISLAND_SETTING_FLAG_DONE, arg_2_0.OnSettingFlagDone)
...
function var_0_1.RemoveListeners(arg_3_0)
	...
	var_3_1(var_3_0, var_3.ISLAND_SETTING_FLAG_DONE, arg_3_0.OnSettingFlagDone)
...
function var_0_1.OnSelectGraphicSettingLevel(arg_4_0)
	...
	IslandSettingsOtherGraphicsPanle = var_1_10003

	var_4_1(var_4_0, var_1_10003.EVT_UPDTAE)
...
function var_0_1.OnSelectCustomGraphicSetting(arg_5_0)
	...
	IslandSettingsGraphicsPanle = var_1_10003

	var_5_1(var_5_0, var_1_10003.EVT_UPDTAE)
...
function var_0_1.OnSettingFlagDone(arg_6_0)
	...
	IslandSettingsCommonPage = var_1_10003

	if var_6_1(var_6_0, var_1_10003) and var_1:GetLoaded() then
		var_1:Update()
	end
...
function var_0_1.OnLoaded(arg_8_0)
	...
	IslandSettings3DPage = var_3
	var_8_3[1] = var_3.New(var_8_2, arg_8_0.event, {})
	...
	local var_8_10 = var_4.Find(var_8_9, "adapt/left_length/imageQuality")

	i18n = var_8_9

	var_8_8(var_8_10, var_8_9("grapihcs3d_setting_3Dquality"))

	local var_8_11 = var_2
	local var_8_12 = arg_8_0._tf
	local var_8_13 = var_4.Find(var_8_12, "adapt/left_length/operation")

	i18n = var_8_12

	var_8_11(var_8_13, var_8_12("grapihcs3d_setting_control"))

	local var_8_14 = var_2
	local var_8_15 = arg_8_0._tf
	local var_8_16 = var_4.Find(var_8_15, "adapt/left_length/common")

	i18n = var_8_15

	var_8_14(var_8_16, var_8_15("grapihcs3d_setting_general"))

	setText = var_8_14

	local var_8_17 = arg_8_0._tf
	local var_8_18 = var_4.Find(var_8_17, "top/title/Text")

	i18n = var_8_17

	var_8_14(var_8_18, var_8_17("island_settings"))

	setText = var_8_14

	local var_8_19 = arg_8_0._tf
	local var_8_20 = var_4.Find(var_8_19, "top/title/Text/en")

	i18n = var_8_19

	var_8_14(var_8_20, var_8_19("island_settings_en"))
...
function var_0_1.OnShow(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10001(arg_10_0.toggles) do
		...
		var_1_10006(var_10_3, var_10_4, var_10_5, var_1_10010)
	end
...
function var_0_1.SwitchPage(arg_14_0, arg_14_1)
	...
	IslandSettings3DPage = var_5

	if var_3(var_14_3, var_5) then
	...
	IslandSettingsOperationPage = var_5

	if var_3(var_14_4, var_5) then
...
function var_0_1.OnHide(arg_17_0)
	...
	if arg_17_0.hasShowOP then
		...
		var_17_2(var_17_1, var_3.UPDATE_CUSTOM_OP_POSITON)
	end
	...
	if var_17_4(var_17_3, var_3) and var_1:GetLoaded() then
		var_1:Save()
	end
