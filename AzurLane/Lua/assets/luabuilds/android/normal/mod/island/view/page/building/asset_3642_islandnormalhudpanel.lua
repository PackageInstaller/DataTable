...
function var_0_1.GetPlayer(arg_6_0)
	...
	for iter_6_0, iter_6_1 in var_6_2(var_6_3) do
...
function var_0_1.CheckIsNear(arg_7_0)
	...
	if var_1 then
		...
		if not var_3(var_7_1) then
			IsNil = var_3

			if var_3(var_7_1.transform) then
				return false
			end

			IsNil = var_3

			if var_3(arg_7_0.playerTF) then
				return false
			end
...
function var_0_1.OnUpdate(arg_8_0)
	if not arg_8_0.hasPlayer then
		...
		if arg_8_0:CheckIsNear() == arg_8_0.isNear then
			return
		end
...
function var_0_1.SetTFActive(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_3 = var_9_2(var_9_1, var_1_10006(var_1_10007))
...
function var_0_1.UpdateTaskDisplay(arg_12_0)
	...
	if arg_12_0.currentTaskId ~= var_12_1 then
		...
		if var_12_1 then
			...
			var_1_10005(arg_12_0.hudImageBg, true)

			GetImageSpriteFromAtlasAsync = var_1_10005

			var_1_10005("island/IslandHudIcon", var_12_2, arg_12_0.hudImageBg)
			...
			var_1_10005(var_12_3, var_7.NewHex(var_1_10004))
		else
			setActive = var_12_2
			...
			var_1_10004 = arg_12_0.hudImageTF
			Color = var_5

			var_12_2(var_1_10004, var_5.NewHex("78787a"))
		end
	end
	...
	if var_12_0 ~= arg_12_0.currentTaskType then
		...
		if not var_3.TaskProcessToHudIcon[var_12_0] then
			var_12_4 = arg_12_0.hudImageIcon
		end

		setActive = var_1_10004

		var_1_10004(arg_12_0.hudImageBg, var_12_4 ~= "")

		if var_12_4 ~= "" then
			GetImageSpriteFromAtlasAsync = var_1_10004

			var_1_10004("island/IslandHudIcon", var_12_4, arg_12_0.hudImageTF)
		end
	end
...
function var_0_1.Show(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_2(var_13_0) do
