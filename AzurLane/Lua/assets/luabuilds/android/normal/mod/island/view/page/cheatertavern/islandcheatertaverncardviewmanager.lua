...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_1_10005
	JumpCurve = var_1_10006
	arg_1_0.curveX = var_2(var_1_0, var_1_1, var_1_10005(var_1_10006)).curve
	LoadAny = var_2
	...
	typeof = var_5
	JumpCurve = var_1_10006
	arg_1_0.curveY = var_2(var_1_2, var_1_3, var_5(var_1_10006)).curve
	LoadAny = var_2
	...
	typeof = var_5
	JumpCurve = var_1_10006
	arg_1_0.curveZ = var_2(var_1_4, var_1_5, var_5(var_1_10006)).curve
...
function var_0_0.UpDateHandler(arg_3_0)
	...
	if not var_1(var_2.EventSystems.EventSystem.current.currentSelectedGameObject) then
		UnityEngine = var_1
	...
	CheatTavernCameraMgr = var_3_3

	local var_3_5 = var_3_3.instance._mainCamera
	local var_3_6 = var_2.ScreenPointToRay(var_3_5, var_3_4)

	Physics = var_3_5

	local var_3_7 = var_3_5.Raycast
	local var_3_8 = var_3_6

	hit = iter_3_7

	local var_3_9, var_3_10 = var_3_7(var_3_8, iter_3_7, 1000, arg_3_0.layerMask)
	...
	if var_3_9 then
		...
		typeof = var_7
		CheaterTavernCard = var_1_10008

		if var_3_12(var_3_11, var_7(var_1_10008)) == nil then
			return
		end
...
function var_0_0.PlayerCardSetActive(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_3.getRawData(var_12_0).id == arg_12_1 then
		...
		for iter_12_2, iter_12_3 in var_12_0(var_12_1) do
...
function var_0_0.CreateOtherCardRoot(arg_17_0)
	...
	for iter_17_0 = 1, 4 do
		...
		var_17_1[iter_17_0] = var_1_10007(var_1_10008(iter_17_0)).transform

		local var_17_2 = 10110000 + iter_17_0

		pg = var_1_10007
		var_1_10008 = var_1_10007.island_world_objects[var_17_2].param.position[1]

		local var_17_3 = var_1_10007.param.position[3]
		local var_17_4 = {
			1,
			0,
			-1,
		...
		var_1_10008 = var_1_10008 + var_17_6 * var_1_10013.horOffset

		local var_17_7 = var_17_5[var_17_0]

		IslandCheaterTavernConst = var_1_10013

		local var_17_8 = var_17_3 + var_17_7 * var_1_10013.horOffset
		local var_17_9 = {
			-90,
			0,
			90,
		...
		local var_17_10 = var_1_10008

		IslandCheaterTavernConst = var_1_10015
		var_1_10013 = var_1_10013(var_17_10, var_1_10015.verOffset, var_17_8)
		arg_17_0.seatOherRootDic[iter_17_0].position = var_1_10013

		local var_17_11 = arg_17_0.seatOherRootDic[iter_17_0]

		Quaternion = var_1_10015
		var_17_11.rotation = var_1_10015.Euler(var_1_10007.param.rotation[1], var_17_9[var_17_0], var_1_10007.param.rotation[3])
	end
...
function var_0_0.UpdateCardMainRootPos(arg_18_0)
	...
	local var_18_2 = var_18_1(var_18_0, var_1_10003(var_1_10004))
	local var_18_3 = var_1.WorldToScreenPoint(var_18_2, arg_18_0.uiContainer.position)

	IslandCheaterTavernConst = var_18_2

	local var_18_4 = var_18_2.cardOffsetToCamara

	CheatTavernCameraMgr = var_4

	local var_18_5 = var_4.instance._mainCamera
	local var_18_6 = var_4.ScreenToWorldPoint

	Vector3 = var_1_10006

	local var_18_7 = var_18_6(var_18_5, var_1_10006(var_18_3.x, var_18_3.y, var_18_4))
	local var_18_8 = arg_18_0.CardMainRoot.transform

	Vector3 = var_6
	var_18_8.localPosition = var_6(var_18_7.x, var_18_7.y, var_18_7.z)
