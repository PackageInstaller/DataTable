...
local var_0_5 = var_0_10004.island_buff_template
...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_1, var_2_0("island_manage_title"))
	...
	var_1(var_2.Find(var_2_9, "event/desc/effect"), "")

	UIItemList = var_1

	local var_2_10 = var_1.New
	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_2.Find(var_2_11, "content/event_container/event/items")
	local var_2_13 = arg_2_0._tf

	arg_2_0.itemsList = var_2_10(var_2_12, var_3.Find(var_2_13, "content/event_container/event/items/tpl"))
	UIItemList = var_1

	local var_2_14 = var_1.New
	local var_2_15 = arg_2_0._tf
	local var_2_16 = var_2.Find(var_2_15, "content/event_container/event/addition")
	local var_2_17 = arg_2_0._tf

	arg_2_0.additionList = var_2_14(var_2_16, var_3.Find(var_2_17, "content/event_container/event/addition/tpl"))
	...
	UIItemList = var_2_21
	arg_2_0.shipUIList = var_2_21.New(var_2_22, var_2_22:Find("tpl"))
	setText = var_3

	local var_2_23 = var_2_22
	local var_2_24 = var_2_22.Find(var_2_23, "tpl/empty/Image/Text")

	i18n = var_2_23

	var_3(var_2_24, var_2_23("island_manage_sel_worker"))

	setText = var_3

	local var_2_25 = var_2_22
	local var_2_26 = var_2_22.Find(var_2_25, "tpl/lock/Image/Text")

	i18n = var_2_25

	var_3(var_2_26, var_2_25("island_manage_upgrade_worker_level"))

	setText = var_3

	local var_2_27 = var_2_22
	local var_2_28 = var_2_22.Find(var_2_27, "tpl/ship/skill/invalid/Text")

	i18n = var_2_27

	var_3(var_2_28, var_2_27("island_manage_skill_cant_use"))

	arg_2_0.commoditiesTF = var_1:Find("right/commodities")
	arg_2_0.commoditiesEmptyTF = var_1:Find("right/commodities_empty")
	setText = var_3

	local var_2_29 = arg_2_0.commoditiesEmptyTF

	i18n = var_5

	var_3(var_2_29, var_5("island_manage_stock_out"))

	local var_2_30 = arg_2_0.commoditiesTF

	arg_2_0.scrollRect = var_3.GetComponent(var_2_30, "LScrollRect")
	arg_2_0.detailPanel = var_1:Find("right/detail")

	local var_2_31 = arg_2_0.detailPanel

	arg_2_0.detailNameTF = var_3.Find(var_2_31, "dot/name")

	local var_2_32 = arg_2_0.detailPanel

	arg_2_0.detailPriceTF = var_3.Find(var_2_32, "price/value")

	local var_2_33 = arg_2_0.detailPanel

	arg_2_0.detailDescTF = var_3.Find(var_2_33, "desc")

	local var_2_34 = arg_2_0.detailPanel

	arg_2_0.detailEffectTF = var_3.Find(var_2_34, "effect/Text")
	arg_2_0.shelfsTF = var_1:Find("right/shelfs")
	setText = var_3

	local var_2_35 = arg_2_0.shelfsTF
	local var_2_36 = var_4.Find(var_2_35, "infos/tip")

	i18n = var_2_35

	var_3(var_2_36, var_2_35("island_manage_item_select"))

	local var_2_37 = arg_2_0.shelfsTF

	arg_2_0.extraCapacityTF = var_3.Find(var_2_37, "infos/capacity")
	setText = var_3

	local var_2_38 = arg_2_0.extraCapacityTF
	local var_2_39 = var_4.Find(var_2_38, "name")

	i18n = var_2_38

	var_3(var_2_39, var_2_38("island_manage_capacity"))

	local var_2_40 = arg_2_0.extraCapacityTF

	arg_2_0.extraCapacityEffectTF = var_3.Find(var_2_40, "effect")
	UIItemList = var_3

	local var_2_41 = var_3.New
	local var_2_42 = arg_2_0.shelfsTF
	local var_2_43 = var_4.Find(var_2_42, "content")
	local var_2_44 = arg_2_0.shelfsTF

	arg_2_0.shelfUIList = var_2_41(var_2_43, var_5.Find(var_2_44, "content/tpl"))

	local var_2_45 = var_1
	local var_2_46 = var_1.Find(var_2_45, "estimate")

	setText = var_2_45

	local var_2_47 = var_2_46
	local var_2_48 = var_2_46.Find(var_2_47, "Text")

	i18n = var_2_47

	var_2_45(var_2_48, var_2_47("island_manage_predict_saleroom"))

	setText = var_2_45

	local var_2_49 = var_2_46
	local var_2_50 = var_2_46.Find(var_2_49, "count/Text")

	i18n = var_2_49

	var_2_45(var_2_50, var_2_49("island_manage_cnt"))

	setText = var_2_45

	local var_2_51 = var_2_46
	local var_2_52 = var_2_46.Find(var_2_51, "sales/Text")

	i18n = var_2_51

	var_2_45(var_2_52, var_2_51("island_manage_saleroom") .. ":")

	arg_2_0.estimateCntTF = var_2_46:Find("count/value")
	arg_2_0.estimateSalesTF = var_2_46:Find("sales/value")
	arg_2_0.buffInfoBtn = var_2_46:Find("info")
	arg_2_0.buffInfoPanel = var_2_46:Find("info_panel")
	setText = var_4

	local var_2_53 = arg_2_0.buffInfoPanel
	local var_2_54 = var_5.Find(var_2_53, "Text")

	i18n = var_2_53

	var_4(var_2_54, var_2_53("island_manage_addition"))

	UIItemList = var_4

	local var_2_55 = var_4.New
	local var_2_56 = arg_2_0.buffInfoPanel
	local var_2_57 = var_5.Find(var_2_56, "effects")
	local var_2_58 = arg_2_0.buffInfoPanel

	arg_2_0.buffInfoUIList = var_2_55(var_2_57, var_6.Find(var_2_58, "effects/tpl"))

	local var_2_59 = arg_2_0.buffInfoPanel

	arg_2_0.buffInfoEmptyTF = var_4.Find(var_2_59, "empty")
	setText = var_4

	local var_2_60 = arg_2_0.buffInfoEmptyTF
	local var_2_61 = var_5.Find(var_2_60, "Text")

	i18n = var_2_60

	var_4(var_2_61, var_2_60("island_manage_no_addition"))

	setText = var_4

	local var_2_62 = arg_2_0.buffInfoPanel
	local var_2_63 = var_5.Find(var_2_62, "tips")

	i18n = var_2_62

	var_4(var_2_63, var_2_62("island_manage_buff_tip"))

	arg_2_0.btnsTF = var_1:Find("btns")

	local var_2_64 = arg_2_0.btnsTF
	local var_2_65 = var_4.Find(var_2_64, "prepare/open")

	setText = var_2_64

	local var_2_66 = arg_2_0.btnsTF
	local var_2_67 = var_6.Find(var_2_66, "prepare/auto/Text")

	i18n = var_2_66

	var_2_64(var_2_67, var_2_66("island_manage_auto_work"))

	arg_2_0.openBtn = var_2_65
	setText = var_2_65

	local var_2_68 = arg_2_0.btnsTF
	local var_2_69 = var_5.Find(var_2_68, "prepare/open/Text")

	i18n = var_2_68

	var_2_65(var_2_69, var_2_68("island_manage_start_work"))

	setText = var_2_65

	local var_2_70 = arg_2_0.btnsTF
	local var_2_71 = var_5.Find(var_2_70, "opening/Text")

	i18n = var_2_70

	var_2_65(var_2_71, var_2_70("island_manage_working"))

	setText = var_2_65

	local var_2_72 = arg_2_0.btnsTF
	local var_2_73 = var_5.Find(var_2_72, "close/Text")

	i18n = var_2_72

	var_2_65(var_2_73, var_2_72("island_manage_result"))

	setText = var_2_65

	local var_2_74 = arg_2_0.btnsTF
	local var_2_75 = var_5.Find(var_2_74, "end/Text")

	i18n = var_2_74

	var_2_65(var_2_75, var_2_74("island_manage_end_daily_work"))

	setText = var_2_65

	local var_2_76 = arg_2_0._tf
	local var_2_77 = var_5.Find(var_2_76, "content/event_container/event/title/Text")

	i18n = var_2_76

	var_2_65(var_2_77, var_2_76("island_post_event_addition_label"))

	local var_2_78 = arg_2_0.btnsTF

	arg_2_0.ticketBtn = var_4.Find(var_2_78, "opening/ticket")
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "top/title/help")
	...
	local function var_3_3()
		...
		pg = var_2_10003
		var_4_2.helps = var_2_10003.gametip.island_help_manage.tip
	...
	local var_3_6 = var_3.Find(var_3_5, "top/back")
	...
	local function var_3_10()
		...
		IslandRestaurantRankPage = var_2_10002

		var_6_1(var_6_0, var_2_10002, arg_3_0.restId)
	...
	local var_3_13 = var_3.Find(var_3_12, "prepare/auto")
	...
	var_1_10001(var_3_11, var_3_13, var_3_14, var_5)
	...
	local function var_3_17()
		...
		var_8_2(var_8_1, var_3.OPEN_RESTAURANT, {
	...
	local var_3_20 = var_3.Find(var_3_19, "close")
	...
	local function var_3_21()
		...
		var_9_1(var_9_0, var_2_10002.CLOSE_RESTAURANT, arg_3_0.restId, arg_3_0.isPost)
	...
	var_1_10001(var_3_18, var_3_20, var_3_21, var_5)
	...
	var_1_10001(var_3_22, var_3_23, var_3_24, var_5)
	...
	local function var_3_27()
		...
		var_11_1(var_11_0, var_2_10002, var_2_10003.TYPES.MANAGE, arg_3_0.restId)
	...
	var_1_10001(var_3_25, var_3_26, var_3_27, var_5)
...
function var_0_1.AddListeners(arg_17_0)
	...
	var_17_1(var_17_0, var_1_10003.ISLAND_OPEN_RESTAURANT_DONE, arg_17_0.Flush)
	...
	var_17_3(var_17_2, var_3.ISLAND_CLOSE_RESTAURANT_DONE, arg_17_0.Flush)
	...
	var_17_5(var_17_4, var_3.ON_DAILY_REFRESH, arg_17_0.Flush)
...
function var_0_1.RemoveListeners(arg_18_0)
	...
	var_18_1(var_18_0, var_1_10003.ISLAND_OPEN_RESTAURANT_DONE, arg_18_0.Flush)
	...
	var_18_3(var_18_2, var_3.ISLAND_CLOSE_RESTAURANT_DONE, arg_18_0.Flush)
	...
	var_18_5(var_18_4, var_3.ON_DAILY_REFRESH, arg_18_0.Flush)
...
function var_0_1.AddOnShelf(arg_21_0, arg_21_1)
	...
	local var_21_2 = var_21_0(var_3.GetCount(var_21_1), arg_21_0.baseCapacity + arg_21_0.extraCapacity)
...
function var_0_1.ShowDetailPanel(arg_22_0, arg_22_1, arg_22_2)
	...
	var_4(arg_22_0.detailPriceTF, var_22_0)

	setText = var_4

	var_4(arg_22_0.detailDescTF, arg_22_1:GetDesc())

	IslandShipAttr = var_4

	local var_22_1 = var_4.GetAtrrName(arg_22_1:getConfig("sub_attribute")[1])

	i18n = var_5

	local var_22_2 = var_5("island_manage_attr_effect")

	IslandShipAttr = var_6

	local var_22_3 = var_6.ATTRS_CH[1]
	local var_22_4 = "、"

	IslandShipAttr = var_1_10008

	local var_22_5 = var_22_2 .. var_22_3 .. var_22_4 .. var_1_10008.ToChinese(var_22_1)

	setText = var_22_3

	var_22_3(arg_22_0.detailEffectTF, var_22_5)
...
function var_0_1.OnUpdateItem(arg_23_0, arg_23_1, arg_23_2)
	...
	if arg_23_0.displays[arg_23_1 + 1] then
		...
		var_1_10008 = var_23_0

		var_23_0.Update(var_1_10008, var_4, arg_23_0.isOperable and var_23_2 or 0, arg_23_0.eventEffects[var_4.id], var_23_1)
	end

	local var_23_3 = arg_23_0.detailPanel.parent
	local var_23_4 = var_5.InverseTransformPoint(var_23_3, var_23_0._tf.position)

	GetOrAddComponent = var_23_3

	local var_23_5 = var_23_0._go

	typeof = var_1_10008
	UILongPressTrigger = var_1_10009

	local var_23_6 = var_23_3(var_23_5, var_1_10008(var_1_10009)).onLongPressed

	var_7.AddListener(var_23_6, function()
		local var_24_0 = arg_23_0

		var_0.ShowDetailPanel(var_24_0, var_23_0.item, var_23_4)
...
function var_0_1.FlushData(arg_29_0)
	...
	IslandRestaurant = var_29_6
	arg_29_0.isOperable = var_29_7 == var_29_6.STATUS.PREPARE
...
function var_0_1.FlushName(arg_30_0)
	...
	var_1_10001(var_30_0, var_3.getConfig(var_30_1, "name"))
	...
	var_1_10001(var_30_2, var_3.getConfig(var_30_3, "name_en"))
...
function var_0_1.FlushRank(arg_31_0)
	...
	var_1_10001(var_31_0 .. var_3.GetRankIcon(var_31_1), arg_31_0.rankIcon)
	...
	var_31_4(arg_31_0.rankText, var_31_3 .. "/" .. var_31_5)

	setSlider = var_31_4

	var_31_4(arg_31_0.rankSlider, 0, 1, var_31_5 == 0 and 0 or var_31_3 / var_31_5)
...
function var_0_1.FlushEvent(arg_32_0)
	...
	if arg_32_0.eventId ~= 0 then
		...
		local var_32_6 = var_4.gsub
		local var_32_7 = var_32_4.desc
		local var_32_8 = "$1"
		local var_32_9 = arg_32_0.rest

		var_2(var_32_5, var_32_6(var_32_7, var_32_8, var_7.getConfig(var_32_9, "name")))
...
function var_0_1.UpdateAddition(arg_33_0, arg_33_1)
	...
	local var_33_1 = arg_33_0.itemsList

	var_3.make(var_33_1, function(arg_34_0, arg_34_1, arg_34_2)
		UIItemList = var_2_10003

		if arg_34_0 == var_2_10003.EventUpdate then
			local var_34_0 = var_33_0[arg_34_1 + 1]
			...
			var_34_2.type = var_2_10006
			var_34_2.id = var_34_0.id

			local var_34_3 = var_34_1(var_34_2)

			updateCustomDrop = var_34_2

			var_34_2(arg_34_2, var_34_3)
		end
	...
	var_3.align(var_33_2, #var_33_0)

	local var_33_3 = arg_33_1
	local var_33_4 = arg_33_1.GetEventInfo(var_33_3)

	pg = var_33_3

	local var_33_5 = var_33_3.island_manage_event[var_33_4]
...
function var_0_1.WarpItemInfo(arg_36_0, arg_36_1)
	...
	local var_36_3 = var_1_10005(var_1_10006)
	local var_36_4 = var_5.GetIsland(var_36_3)
	local var_36_5 = var_5.GetInventoryAgency(var_36_4)

	ipairs = var_36_4

	for iter_36_0, iter_36_1 in var_36_4(arg_36_1:getConfig("item_id")) do
		local var_36_6

		if not var_36_5:GetItemById(iter_36_1[1]) then
			IslandItem = var_36_6
			var_36_6 = var_36_6.New({
				id = iter_36_1[1]
			})
		end

		if var_36_6 and var_36_2[var_36_6.id] then
			table = var_12

			var_12.insert(var_36_0, var_36_6)
		end
	end
...
function var_0_1.WarpAdditionInfo(arg_37_0, arg_37_1)
	...
	i18n = var_1_10006
	var_37_3[1] = var_1_10006("island_addition_influence")
	...
	i18n = var_6
	var_37_6[1] = var_6("island_addition_sale")
...
function var_0_1.FlushAssistants(arg_38_0)
	if not arg_38_0.selectedShipIds then
		...
		var_1_10002 = var_1.GetIsland(var_1_10002)

		local var_38_0 = var_1.GetCharacterAgency(var_1_10002)
	...
	local var_38_1 = var_1(var_1_10002)
	local var_38_2 = var_1.GetIsland(var_38_1)
	local var_38_3 = var_1.GetCharacterAgency(var_38_2)

	ipairs = var_38_2

	for iter_38_2, iter_38_3 in var_38_2(arg_38_0.selectedShipIds) do
		table = var_1_10007
	...
	for iter_38_4, iter_38_5 in var_3(var_38_5) do
		local var_38_6 = iter_38_5
		local var_38_7 = iter_38_5.GetBuffEffect(var_38_6)[2]

		table = var_38_6

		local var_38_8 = var_38_6.insert
		local var_38_9 = arg_38_0.buffInfos
		local var_38_10 = {}

		i18n = var_1_10012
		var_38_10.name = var_1_10012("island_manage_saleroom")
		var_38_10.effect = "+" .. var_38_7 .. "%"

		var_38_8(var_38_9, var_38_10)

		arg_38_0.extraPricePer = arg_38_0.extraPricePer + var_38_7 / 100
	end

	IslandBuffHelper = var_3

	local var_38_11 = var_3.GetManageSellNumBuffs(arg_38_0.selectedShips, arg_38_0.restId)

	ipairs = var_4

	for iter_38_6, iter_38_7 in var_4(var_38_11) do
		local var_38_12 = iter_38_7
		local var_38_13 = iter_38_7.GetBuffEffect(var_38_12)[2]

		table = var_38_12

		local var_38_14 = var_38_12.insert
		local var_38_15 = arg_38_0.buffInfos
		local var_38_16 = {}

		i18n = var_1_10013
		var_38_16.name = var_1_10013("island_manage_capacity")
		var_38_16.effect = "+" .. var_38_13

		var_38_14(var_38_15, var_38_16)

		arg_38_0.extraCapacity = arg_38_0.extraCapacity + var_38_13
	end

	if arg_38_0.statusCheckTimer then
		local var_38_17 = arg_38_0.statusCheckTimer

		var_4.Stop(var_38_17)
	end

	if arg_38_0.isOperable then
		IslandBuffHelper = var_4
		arg_38_0.shipStatus = var_4.GetManageStatus(arg_38_0.selectedShips, arg_38_0.restId)

		if #arg_38_0.shipStatus > 0 then
			Timer = var_4
			arg_38_0.statusCheckTimer = var_4.New(function()
			...
			local var_38_18 = arg_38_0.statusCheckTimer

			var_4.Start(var_38_18)
		end
	end

	setActive = var_4

	local var_38_19 = arg_38_0.extraCapacityTF
	local var_38_20

	if arg_38_0.isOperable then
		var_38_20 = arg_38_0.extraCapacity > 0
	end

	var_4(var_38_19, var_38_20)

	setText = var_4

	var_4(arg_38_0.extraCapacityEffectTF, "+" .. arg_38_0.extraCapacity)

	local var_38_21 = arg_38_0.buffInfoUIList

	var_4.align(var_38_21, #arg_38_0.buffInfos)
	...
	if arg_38_0.shelfInfos then
		local var_38_22 = #arg_38_0.shelfInfos

		if 0 < var_38_22 then
			local var_38_24

			if arg_38_0.selectedShipIds then
				local var_38_23 = #arg_38_0.selectedShipIds

				if not (0 < var_38_23) then
					var_38_24 = false
				else
					var_38_24 = true
				end
			...
			var_5(arg_38_0.openBtn, not var_38_24, true)

			setButtonEnabled = var_5

			var_5(arg_38_0.openBtn, var_38_24)
...
function var_0_1.UpdateShipItem(arg_43_0, arg_43_1, arg_43_2)
	...
	var_6(arg_43_2:Find("empty"), var_43_0 and not var_43_1)

	setActive = var_6

	var_6(arg_43_2:Find("ship"), var_43_0 and var_43_1)
	...
	local function var_43_4()
		...
		IslandShipSelectPage = var_2_10002

		local var_44_2 = {
			showBenefits = true
		}

		IslandSelectShipCard = var_2_10004
		var_44_2.showType = var_2_10004.SHOW_TYPE.RESTAURANT
		var_44_2.restId = arg_43_0.restId
		var_44_2.selectNum = #arg_43_0.assistantsData
		Clone = var_4
		var_44_2.selectedIds = var_4(arg_43_0.selectedShipIds)
		IslandShipAttr = var_4
		var_44_2.attrType = var_4.MANAGE_KEY
		...
		var_44_2.emptyInfoTitle = var_4.getConfig(var_44_3, "name")

		var_44_1(var_44_0, var_2_10002, var_44_2)
	...
	var_6(var_43_2, var_43_3, var_43_4, var_1_10010)
	...
	if var_43_1 then
		...
		var_43_5(var_43_6:Find("name"), var_43_1:GetName())
		...
		var_43_7(var_43_6:Find("skill"), var_43_8 and var_43_8:IsUnlock())

		setActive = var_43_7

		var_43_7(var_43_6:Find("skill_lock"), var_43_8 and not var_43_8:IsUnlock())

		IslandShip = var_43_7

		local var_43_9 = var_43_7.StaticGetPrefab(var_43_1.id)

		GetImageSpriteFromAtlasAsync = var_9

		var_9("ShipYardIcon/" .. var_43_9, "", var_43_6:Find("icon"))

		local var_43_10 = var_43_6:Find("skill")
		...
		if var_43_8 then
			...
			if var_43_8:IsUnlock() then
				...
				var_43_11(var_43_10:Find("effects"), true)

				setActive = var_43_11

				var_43_11(var_43_10:Find("invalid"), false)

				LoadImageSpriteAsync = var_43_11

				var_43_11("island/islandskillicon/" .. var_43_8:GetIcon(), var_43_10:Find("skill_icon"))

				setText = var_43_11

				var_43_11(var_43_10:Find("skill_name"), var_43_8:GetName())

				IslandBuffHelper = var_43_11
				var_43_11 = var_43_11.GetAllShipManageBuffs(var_43_1, arg_43_0.restId)
				UIItemList = var_11

				var_11.StaticAlign(var_43_10:Find("effects"), var_43_10:Find("effects/tpl"), #var_43_11, function(arg_46_0, arg_46_1, arg_46_2)
					UIItemList = var_2_10003

					if arg_46_0 == var_2_10003.EventUpdate then
						local var_46_0 = var_43_11[arg_46_1 + 1]
				...
				local var_43_12 = var_43_6
				local var_43_13 = var_43_6.Find(var_43_12, "skill_lock/Image/Text")

				i18n = var_43_12

				var_43_11(var_43_13, var_43_12("island_need_star_1", var_43_1:GetSkillUnlockLevel()))
			end
		else
			local var_43_14 = var_43_1
			local var_43_15 = var_43_1.GetSkill(var_43_14)

			setActive = var_43_14

			var_43_14(var_43_6:Find("skill"), true)

			LoadImageSpriteAsync = var_43_14

			var_43_14("island/islandskillicon/" .. var_43_15:GetIcon(), var_43_10:Find("skill_icon"))

			setText = var_43_14

			var_43_14(var_43_10:Find("skill_name"), var_43_15:GetName())

			setActive = var_43_14

			var_43_14(var_43_10:Find("effects"), false)

			setActive = var_43_14

			var_43_14(var_43_10:Find("invalid"), true)
		end
	end
...
function var_0_1.FlushCards(arg_47_0)
	...
	local var_47_0 = var_1(var_1_10002)
	...
	for iter_47_0, iter_47_1 in var_47_1(var_3.getConfig(var_47_3, "item_id")) do
		local var_47_4 = var_47_2

		if var_47_2.GetItemById(var_47_4, iter_47_1[1]) then
			table = var_47_4

			var_47_4.insert(arg_47_0.displays, var_7)
		end
	end
...
function var_0_1.CaclAttrsFactors(arg_52_0)
	...
	for iter_52_0, iter_52_1 in var_1(arg_52_0.displays) do
		...
		var_52_4[var_52_5] = var_52_6(var_52_7, var_1_10011.MANAGE_KEY)
	end
...
function var_0_1.GetMainAttrFactors(arg_54_0, arg_54_1)
	...
	IslandShipAttr = var_1_10005
	var_54_0[arg_54_1] = var_54_1(var_54_2, var_1_10005.MANAGE_KEY)
...
function var_0_1.FlushShelfs(arg_56_0)
	if not arg_56_0.selectedDic then
		...
		for iter_56_0, iter_56_1 in var_1(var_2.GetCommondities(var_56_0)) do
	...
	if arg_56_0.shelfInfos then
		...
		if 0 < var_56_2 then
			...
			var_56_1(arg_56_0.openBtn, not var_56_4, true)

			setButtonEnabled = var_56_1

			var_56_1(arg_56_0.openBtn, var_56_4)
...
function var_0_1.UpdateShelfItem(arg_57_0, arg_57_1, arg_57_2)
	...
	var_6(arg_57_2:Find("empty"), var_57_0 and not var_57_1)

	setActive = var_6

	var_6(arg_57_2:Find("commodity"), var_57_0 and var_57_1)

	if var_57_1 then
		local var_57_2 = arg_57_2
		local var_57_3 = arg_57_2.Find(var_57_2, "commodity")

		LoadImageSpriteAsync = var_57_2

		var_57_2("island/" .. var_0_3[var_57_1.id].icon, var_57_3:Find("bg/icon"))

		local var_57_4 = arg_57_0.baseCapacity + arg_57_0.extraCapacity

		if arg_57_0.isOperable then
			setText = var_8

			local var_57_5 = var_57_3:Find("count/Text")
			local var_57_6 = var_57_1.num
			local var_57_7 = "/"
			...
			if arg_57_0.extraCapacity > 0 then
				...
				if not var_12(var_57_4, "#7BF59DFF") then
					var_57_8 = var_57_4
				end

				var_8(var_57_5, var_57_6 .. var_57_7 .. var_57_8)

				if false then
					setText = var_8

					var_8(var_57_3:Find("count/Text"), var_57_1.num)
				end

				setActive = var_8

				var_8(var_57_3:Find("event"), arg_57_0.eventEffects[var_57_1.id])

				local var_57_9 = arg_57_0
				local var_57_10 = arg_57_0.GetAttrsFactorsRatio(var_57_9, var_57_1.id)

				setFillAmount = var_57_9

				var_57_9(var_57_3:Find("bg/silder/bar"), var_57_10)

				setActive = var_57_9

				var_57_9(var_57_3:Find("reduce"), arg_57_0.isOperable)

				onButton = var_57_9

				local var_57_11 = arg_57_0
				local var_57_12 = var_57_3:Find("reduce")
				...
				var_57_9(var_57_11, var_57_12, var_57_13, var_13)

				if var_57_4 < var_57_1.num then
					arg_57_0:ReduceShelfCnt(var_57_1.id, var_57_1.num - var_57_4)
...
function var_0_1.FlushEstimate(arg_60_0)
	...
	IslandRestaurant = var_60_0

	if var_60_1 ~= var_60_0.STATUS.OPENING then
		...
		if var_60_1 == var_2.STATUS.CLOSE then
			...
			var_60_2(arg_60_0.estimateCntTF, var_60_3.cntMin .. "-" .. var_60_3.cntMax)

			setText = var_60_2

			var_60_2(arg_60_0.estimateSalesTF, var_60_3.salesMin .. "-" .. var_60_3.salesMax)
		else
			...
			for iter_60_0, iter_60_1 in var_60_7(arg_60_0.selectedDic) do
				...
				local var_60_10 = var_60_8.min
				local var_60_11 = iter_60_1

				math = var_1_10012

				local var_60_12 = var_60_10(var_60_11, var_1_10012.max(arg_60_0.minSaleCnt, var_60_9 + var_60_5))

				math = var_60_11

				local var_60_13 = var_60_11.min

				var_1_10012 = iter_60_1
				math = var_13

				local var_60_14 = var_60_13(var_1_10012, var_13.max(arg_60_0.minSaleCnt, var_60_9 + var_60_6))

				arg_60_0.totalMinSales = arg_60_0.totalMinSales + arg_60_0:CaclGroupPrice(iter_60_0, var_60_12)
				arg_60_0.totalMaxSales = arg_60_0.totalMaxSales + arg_60_0:CaclGroupPrice(iter_60_0, var_60_14)
				arg_60_0.totalMinCnt = arg_60_0.totalMinCnt + var_60_12
				arg_60_0.totalMaxCnt = arg_60_0.totalMaxCnt + var_60_14
			end
...
function var_0_1.GetAutoShipIds(arg_66_0)
	...
	local var_66_1 = var_1_10002(var_1_10003)
	local var_66_2 = var_2.GetIsland(var_66_1)
	local var_66_3 = var_2.GetCharacterAgency(var_66_2)
	local var_66_4 = var_66_0(var_2.GetShips(var_66_3), function(arg_67_0)
		return arg_67_0:IsDelegable()
	end)

	table = var_2

	local var_66_5 = var_2.sort
	local var_66_6 = var_66_4

	CompareFuncs = var_1_10004

	var_66_5(var_66_6, var_1_10004({
		function(arg_68_0)
		...
		function(arg_69_0)
			...
			local var_69_2 = var_69_0(var_69_1, var_2_10003.SHIP_MANAGE_SELL_PRICE)

			underscore = var_69_1

			return -var_69_1.reduce(var_69_2, 0, function(arg_70_0, arg_70_1)
		...
		function(arg_71_0)
			...
			local var_71_2 = var_71_0(var_71_1, var_2_10003.SHIP_MANAGE_SELL_NUM)

			underscore = var_71_1

			return -var_71_1.reduce(var_71_2, 0, function(arg_72_0, arg_72_1)
	...
	if #var_66_7 == 0 and #arg_66_0.assistantsData > 0 then
		...
		IslandCharacterAgency = var_5

		var_66_8(var_66_9, var_5.NPC_CONFIG_ID)
	end
...
function var_0_1.FlushBtns(arg_74_0)
	...
	var_74_0(arg_74_0.btnsTF, function(arg_75_0)
	...
	IslandRestaurant = var_74_0

	if var_74_1 == var_74_0.STATUS.OPENING then
...
function var_0_1.UpdateTime(arg_76_0)
	...
	var_3(var_4.Find(var_76_3, "opening/time"), var_76_0:DescCDTime(var_76_2))
...
function var_0_1.CaclShipAttrFactors(arg_83_0, arg_83_1)
	...
	for iter_83_0, iter_83_1 in var_1_10003(arg_83_0) do
		...
		local var_83_3 = var_83_2(var_83_1, var_1_10010.GetAtrrName(arg_83_1))

		pg = var_83_1
		var_83_0 = var_83_0 + var_83_1.island_chara_att[var_83_3].manage_effect / 16
	end
