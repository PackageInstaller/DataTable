...
function var_0_1.UpdatePerSecond(arg_14_0)
	...
	if arg_14_0.needRefresh and var_14_1 >= arg_14_0.refresh_time then
		...
		local var_14_3 = var_3(var_1_10004)
		local var_14_4 = var_3.GetIsland(var_14_3)

		math = var_14_3

		local var_14_5 = var_14_3.max(1, var_14_2)
		...
		for iter_14_0 = #arg_14_0.recoverQueue, var_14_5, -1 do
			...
			if var_14_7 == var_1_10010.MinePlaceId then
				var_1_10010 = var_14_4

				local var_14_8 = var_14_4.DispatchEvent

				IslandBuildingAgency = var_1_10011

				var_14_8(var_1_10010, var_1_10011.COLLECT_SlOT_UNIT_INIT, {
					slotId = var_14_6
				})
			else
				var_1_10010 = var_14_4
				...
				var_14_9(var_1_10010, var_1_10011.COLLECT_SlOT_UNIT_UPDATE, {
					slotId = var_14_6
				})
			end
		end
