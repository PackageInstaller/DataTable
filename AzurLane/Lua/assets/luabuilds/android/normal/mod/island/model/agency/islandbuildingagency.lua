...
function var_0_1.InitSlotDataByAbility(arg_9_0, arg_9_1)
	...
	if not arg_9_0.GetBuilding(var_9_2, var_9_1) then
		warning = var_9_2

		var_9_2("需要先解锁产地,再解锁产地上的槽位")
	...
	if var_4.type == 1 then
		...
		var_6.InitSlotHandPlantByAbility(var_9_3, var_9_0)

		getProxy = var_7
		IslandProxy = var_9_3

		local var_9_4 = var_7(var_9_3)
		local var_9_5 = var_7.GetIsland(var_9_4)
		local var_9_6 = var_7.DispatchEvent

		IslandBuildingAgency = var_1_10010

		var_9_6(var_9_5, var_1_10010.SLOT_HANDPLABT_SLOT_UNIT_CHANGE, {
			build_id = var_9_1,
			slotId = var_9_0
		})
...
function var_0_1.InitBuildData(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_10_1(var_4)
	local var_10_3 = var_3.GetIsland(var_10_2)

	table = var_10_2

	local var_10_4 = var_10_2.contains

	IslandProductConst = var_1_10005

	local var_10_6

	if var_10_4(var_1_10005.haveModelPlaces, arg_10_1.id) then
		local var_10_5 = var_10_3

		var_10_6 = var_10_3.DispatchEvent
		IslandBuildingAgency = var_6

		var_10_6(var_10_5, var_6.CHANGE_PRODUCT_MODEL, {
	...
	for iter_10_0, iter_10_1 in var_10_6(var_10_7) do
		var_1_10010 = var_10_3

		local var_10_8 = var_10_3.DispatchEvent

		IslandBuildingAgency = var_1_10011

		var_10_8(var_1_10010, var_1_10011.COLLECT_SlOT_UNIT_INIT, {
			slotId = iter_10_1
		})
	end
	...
	for iter_10_2, iter_10_3 in var_4(var_10_9) do
		var_1_10010 = var_10_3

		local var_10_10 = var_10_3.DispatchEvent

		IslandBuildingAgency = var_1_10011

		var_10_10(var_1_10010, var_1_10011.SLOT_HANDPLABT_SLOT_UNIT_CHANGE, {
			build_id = arg_10_1.id,
			slotId = iter_10_3.id
		})
	end
	...
	for iter_10_4, iter_10_5 in var_4(var_10_11) do
		local var_10_12 = {}
		...
		for iter_10_6, iter_10_7 in var_1_10010(iter_10_5.part_list) do
			...
			var_1_10015.insert(var_10_12, iter_10_7)
		end
		...
		if #var_10_12 > 0 then
			...
			IslandBuildingAgency = var_12

			var_1_10010(var_10_13, var_12.GEN_ANIMAL_INT, {
				aniList = var_10_12,
				slotId = iter_10_5.id
			})
		end

		local var_10_14 = var_10_3

		var_1_10010 = var_10_3.DispatchEvent
		IslandBuildingAgency = var_12

		var_1_10010(var_10_14, var_12.SLOT_DELEGATE_INIT, {
			slotId = iter_10_5.id
		})
	end
...
function var_0_1.InitBuildAnimalDataByAbility(arg_11_0, arg_11_1)
	...
	var_11_5(var_11_4, var_1_10009.GEN_ANIMAL_INT, {
		aniList = {
			arg_11_1
		},
		slotId = var_11_0
...
function var_0_1.InitHandSlotData(arg_12_0, arg_12_1)
	...
	if not arg_12_0.GetBuilding(var_12_2, var_12_1) then
		warning = var_12_2

		var_12_2("需要先解锁产地,再解锁产地上的槽位")
...
function var_0_1.GetMinimumDelegationCompletionTimeByMapId(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in var_1_10004(var_13_0) do
		if arg_13_0.buildings[iter_13_1] then
			local var_13_2 = var_9

			if var_9.GetMinRoleDeleGationTime(var_13_2) ~= -1 then
				if var_13_1 then
					math = var_13_2

					if not var_13_2.min(var_10, var_13_1) then
						::label_13_0::
...
function var_0_1.GetTipInfos(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_1_10004(var_1_10005.island_set.post_manage_produce.key_value_varchar) do
		if arg_20_0.buildings[iter_20_1] then
			...
			for iter_20_2, iter_20_3 in var_1_10010(var_9:GetDelegationSlotDatas()) do
				...
				elseif iter_20_3:GetSlotRoleData() then
					...
					var_20_3(var_20_4, var_17.GetFinishTime(var_20_5))
				end
			end
		end
	end
