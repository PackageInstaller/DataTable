...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_2 = var_1
	local var_2_3 = var_1.Find(var_2_2, "view/content/tpl/sellOut/Text")

	i18n = var_2_2

	var_2(var_2_3, var_2_2("common_sale_out"))

	local var_2_4 = var_1:Find("res/Text")
	local var_2_5 = var_2.GetComponent

	typeof = var_4
	Text = var_5
	arg_2_0.resCntTxt = var_2_5(var_2_4, var_4(var_5))
	UIItemList = var_2
	arg_2_0.goodUIList = var_2.New(var_1:Find("view/content"), var_1:Find("view/content/tpl"))

	local var_2_6 = var_1
	local var_2_7 = var_1.Find(var_2_6, "toggles")

	UIItemList = var_2_6
	arg_2_0.togglesUIList = var_2_6.New(var_2_7, var_2_7:Find("tpl"))
	...
	var_1.make(var_3_1, function(arg_4_0, arg_4_1, arg_4_2)
		...
		if arg_4_0 == var_2_10003.EventInit then
			local function var_4_0()
				...
				local var_5_1 = var_1.Find(var_5_0, "red")

				IslandSeasonRedDotHelper = var_5_0

				var_3_10000(var_5_1, var_5_0.TipShopShowPhase(arg_4_1 + 1))
			...
			local var_4_2 = arg_4_2.Find(var_4_1, "unsel/Text")

			i18n = var_4_1

			var_4(var_4_2, var_4_1("island_season_shop_stage" .. arg_4_1 + 1))

			setText = var_4

			local var_4_3 = arg_4_2
			local var_4_4 = arg_4_2.Find(var_4_3, "sel/Text")

			i18n = var_4_3

			var_4(var_4_4, var_4_3("island_season_shop_stage" .. arg_4_1 + 1))
			...
			var_4(var_4_5, var_4_6, var_4_7, var_8)
			var_4_0()
		end
...
function var_0_1.Show(arg_8_0)
	...
	var_1(var_2.GetChild(var_8_0, 0), true)
...
function var_0_1.UpdateGood(arg_9_0, arg_9_1, arg_9_2)
	...
	var_4(var_9_0, not var_6.IsInTime(var_9_1))
...
function var_0_1.Flush(arg_11_0)
	...
	local var_11_10 = var_1_10004.UPDATE_REDDOT

	IslandSeasonPage = var_1_10005

	var_11_9(var_11_8, var_11_10, var_1_10005.PAGE_SHOP)
	...
	local var_11_15 = var_11_11.inTime(var_11_14, var_11_13)

	setActive = var_11_14

	var_11_14(arg_11_0.lockTF, not var_11_15)

	if not var_11_15 then
		local var_11_16 = var_11_11:DescDateFromConfig(var_11_13[1]) .. "~" .. var_11_11:DescDateFromConfig(var_11_13[2])

		setText = var_6

		local var_11_17 = arg_11_0.lockTF

		var_6(var_7.Find(var_11_17, "layout/Text"), var_11_16)
	end

	local var_11_18 = arg_11_0.displayShop

	arg_11_0.displaysGoods = var_5.GetCommodities(var_11_18)
	IslandShopPage = var_5

	var_5.SortShopCommodities(arg_11_0.displaysGoods)

	local var_11_19 = arg_11_0.goodUIList

	var_5.align(var_11_19, #arg_11_0.displaysGoods)

	setActive = var_5

	local var_11_20 = arg_11_0.lockTF
	local var_11_21 = arg_11_0.displayShop

	var_5(var_11_20, not var_7.IsInTime(var_11_21))

	local var_11_22 = arg_11_0.resCntTxt
	local var_11_23 = arg_11_0.inventoryAgency
	local var_11_24 = var_6.GetOwnCount

	IslandItem = var_11_21
	var_11_22.text = var_11_24(var_11_23, var_11_21.GOLD_ID)
