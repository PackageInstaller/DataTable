...
function var_0_1.OnInit(arg_5_0)
	...
	typeof = var_3
	Toggle = var_1_10004
	arg_5_0.labelToggleCom = var_5_2(var_5_1, var_3(var_1_10004))
	setText = var_1

	local var_5_3 = arg_5_0._tf
	local var_5_4 = var_2.Find(var_5_3, "options/label/mask/Text")

	i18n = var_5_3

	var_1(var_5_4, var_5_3("grapihcs3d_setting_card_tag"))
	...
	typeof = var_3
	Toggle = var_4
	arg_5_0.socialToggleCom = var_5_7(var_5_6, var_3(var_4))
	setText = var_1

	local var_5_8 = arg_5_0._tf
	local var_5_9 = var_2.Find(var_5_8, "options/social/mask/Text")

	i18n = var_5_8

	var_1(var_5_9, var_5_8("grapihcs3d_setting_card_socialdata"))
...
function var_0_1.OnUpdate(arg_6_0)
	...
	IslandSettingsAgency = var_1_10004
	arg_6_0.labelFlag = var_6_3(var_6_2, var_1_10004.FLAG_TYPES.SHOW_CARD_LABEL)

	local var_6_4 = var_1
	local var_6_5 = var_1.GetFlagByType

	IslandSettingsAgency = var_4
	arg_6_0.socialFlag = var_6_5(var_6_4, var_4.FLAG_TYPES.SHOW_CARD_SOCIAL)
	triggerToggle = var_2
...
function var_0_1.GetFlags(arg_7_0)
	...
	IslandSettingsAgency = var_1_10006
	var_7_4.type = var_1_10006.FLAG_TYPES.SHOW_CARD_LABEL
	...
	local var_7_6 = var_7_3.insert
	local var_7_7 = var_7_0
	local var_7_8 = {}

	IslandSettingsAgency = var_1_10007
	var_7_8.type = var_1_10007.FLAG_TYPES.SHOW_CARD_SOCIAL
