...
function var_0_1.OnLoaded(arg_2_0)
	...
	local var_2_14 = var_2.Find(var_2_13, "frame/attr")
	local var_2_15 = arg_2_0._tf

	arg_2_0.uiAttrList = var_2_12(var_2_14, var_3.Find(var_2_15, "frame/attr/tpl"))
	UIItemList = var_1

	local var_2_16 = var_1.New
	local var_2_17 = arg_2_0._tf
	local var_2_18 = var_2.Find(var_2_17, "frame/frame_2/items")
	local var_2_19 = arg_2_0._tf

	arg_2_0.uiUpgradeList = var_2_16(var_2_18, var_3.Find(var_2_19, "frame/frame_2/items/tpl"))
	...
	local var_2_23 = var_2.Find(var_2_22, "frame/frame_3/items")
	local var_2_24 = arg_2_0._tf

	arg_2_0.uiLimitConsumrList = var_2_21(var_2_23, var_3.Find(var_2_24, "frame/frame_3/items/tpl"))
	setText = var_1
	...
	var_1(var_2_26, var_2_25("island_ship_title1"))

	setText = var_1

	local var_2_27 = arg_2_0._tf
	local var_2_28 = var_2.Find(var_2_27, "frame/toggles/upgrade/Text")

	i18n = var_2_27

	var_1(var_2_28, var_2_27("island_ship_title2"))

	setText = var_1

	local var_2_29 = arg_2_0._tf
	local var_2_30 = var_2.Find(var_2_29, "frame/toggles/limit/Text")

	i18n = var_2_29

	var_1(var_2_30, var_2_29("island_ship_title3"))

	setText = var_1

	local var_2_31 = arg_2_0._tf
	local var_2_32 = var_2.Find(var_2_31, "frame/toggles/upgrade/Text_1")

	i18n = var_2_31

	var_1(var_2_32, var_2_31("island_ship_title2"))

	setText = var_1

	local var_2_33 = arg_2_0._tf
	local var_2_34 = var_2.Find(var_2_33, "frame/toggles/limit/Text_1")

	i18n = var_2_33

	var_1(var_2_34, var_2_33("island_ship_title3"))

	setText = var_1

	local var_2_35 = arg_2_0._tf
	local var_2_36 = var_2.Find(var_2_35, "frame/frame_2/sub_title/Text")

	i18n = var_2_35

	var_1(var_2_36, var_2_35("island_ship_title4"))

	setText = var_1

	local var_2_37 = arg_2_0._tf
	local var_2_38 = var_2.Find(var_2_37, "frame/frame_3/sub_title/Text")

	i18n = var_2_37

	var_1(var_2_38, var_2_37("island_ship_title4"))
	...
	var_1(var_2_40, var_2_39("island_confirm"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local var_3_2 = var_3.Find(var_3_1, "frame/frame_1/title/help")
	...
	local function var_3_3()
		...
		var_4_2.type = var_2_10003.TYPE_WHITOUT_BTN
		i18n = var_3
		var_4_2.content = var_3("island_chara_attr_help")
	...
	for iter_3_0, iter_3_1 in var_1_10001(arg_3_0.toggles) do
		...
		var_1_10006(var_3_19, var_3_20, var_3_21, var_1_10010)
	end
...
function var_0_1.AddListeners(arg_11_0)
	...
	var_11_1(var_11_0, var_1_10003.ISLNAD_SHIP_ATTR_UPGRADE_DONE, arg_11_0.OnAttrUpgrade)
	...
	var_11_3(var_11_2, var_3.ISLNAD_SHIP_ATTR_LIMIT_UNLOCK_DONE, arg_11_0.OnLimitUnlock)
...
function var_0_1.RemoveListeners(arg_12_0)
	...
	var_12_1(var_12_0, var_1_10003.ISLNAD_SHIP_ATTR_UPGRADE_DONE, arg_12_0.OnAttrUpgrade)
	...
	var_12_3(var_12_2, var_3.ISLNAD_SHIP_ATTR_LIMIT_UNLOCK_DONE, arg_12_0.OnLimitUnlock)
...
function var_0_1.UpdateAttrPanel(arg_17_0)
	...
	var_2.make(var_17_1, function(arg_18_0, arg_18_1, arg_18_2)
		...
		if arg_18_0 == var_2_10003.EventUpdate then
			...
			IslandShipAttr = var_18_1

			local var_18_3 = var_18_1.Grade2Img(var_18_2)
			...
			local var_18_6 = var_18_5(var_18_4, var_8(var_2_10009))

			GetSpriteFromAtlas = var_18_4
			var_18_6.sprite = var_18_4("ui/IslandShipUI_atlas", var_18_3[2])
			setText = var_18_6

			local var_18_7 = arg_18_2
			local var_18_8 = arg_18_2.Find(var_18_7, "name")

			IslandShipAttr = var_18_7

			var_18_6(var_18_8, var_18_7.ToChinese(var_18_0))

			local var_18_9 = arg_17_0

			var_6.UpdateAtrrValue(var_18_9, var_17_0, var_18_0)
		end
...
function var_0_1.UpdateAtrrValue(arg_19_0, arg_19_1, arg_19_2)
	...
	if arg_19_0.page == var_0_2 then
		...
		var_5(var_19_2, var_19_3, var_19_4, var_9)
	...
	elseif arg_19_0.page == var_0_3 then
		...
		var_6(var_19_1:Find("value/value_2"), var_5:GetExtraAttrLimit(arg_19_2))
		...
		for iter_19_0, iter_19_1 in var_6(arg_19_0.attrTrs) do
			...
			var_1_10011(iter_19_1:Find("Image"), false)
		end
	end
...
function var_0_1.UpdateLimitUpgradeConsume(arg_21_0)
	...
	local var_21_2 = var_21_0(var_1_10004)
		...
		var_6.make(var_21_8, function(arg_22_0, arg_22_1, arg_22_2)
			...
			if arg_22_0 == var_2_10003.EventUpdate then
				...
				if var_22_0.count <= var_22_2 then
					...
					local var_22_4 = var_22_1(var_22_3, var_7)

					setText = var_22_3

					var_22_3(arg_22_2:Find("icon_bg/count_bg/count"), var_22_4 .. "/" .. var_22_0.count)
...
function var_0_1.FlushAttrs(arg_25_0, arg_25_1)
	...
	var_4.make(var_25_2, function(arg_26_0, arg_26_1, arg_26_2)
		...
		if arg_26_0 == var_2_10003.EventUpdate then
			...
			var_26_3(arg_26_2:Find("icon_bg/count_bg/count"), "X" .. var_26_4)
			...
			var_26_3(var_26_5, var_26_6, var_26_7, var_2_10010)

			onButton = var_26_3

			local var_26_8 = arg_25_0
			local var_26_9 = arg_26_2:Find("calc/bg")
			...
			var_26_3(var_26_8, var_26_9, var_26_10, var_10)

			local var_26_11 = arg_25_0

			var_6.UpdateAttrCalcPanel(var_26_11, arg_26_2, var_26_0)
		end
...
function var_0_1.OpenAtrrCalcPanel(arg_30_0, arg_30_1, arg_30_2)
	...
	local var_30_0 = var_1_10003(var_1_10004)
...
function var_0_1.UpdateAttrValue(arg_32_0)
	...
	var_1_10008(var_32_1:Find("value/value_1"), var_32_2:GetAttr(var_32_0) .. var_32_6)

	local var_32_7 = arg_32_0
	local var_32_8

	if arg_32_0.NothingSelected(var_32_7) then
		var_32_8 = not var_32_3
	end

	setGray = var_32_7

	var_32_7(arg_32_0.upgradeBtn, var_32_8 or arg_32_0:NothingSelected())
...
function var_0_1.CanAddItemForAttrValue(arg_33_0, arg_33_1, arg_33_2)
	...
	for iter_33_0, iter_33_1 in var_33_0(arg_33_2 or {}) do
		IslandItem = var_1_10010
		var_1_10010 = var_1_10010.New({
			id = iter_33_0
		})
		tonumber = var_11
		var_33_1 = var_33_1 + var_11(var_1_10010:GetUseArg()) * iter_33_1
	end
...
function var_0_1.FillSelected(arg_34_0)
	...
	var_5.sort(var_34_5, function(arg_36_0, arg_36_1)
...
function var_0_1.Confirm(arg_38_0)
	if arg_38_0.page == var_0_2 then
		...
		var_1_10003 = arg_38_0

		local var_38_2 = arg_38_0.emit

		IslandMediator = var_1_10004

		var_38_2(var_1_10003, var_1_10004.SHIP_ATTR_UPGRADE, arg_38_0.ship.id, var_1, arg_38_0.selected)
	elseif arg_38_0.page == var_0_3 then
		...
		var_38_5(var_38_4, var_1_10003.SHIP_ATTR_LIMIT_UNLOCK, arg_38_0.ship.id)
	end
