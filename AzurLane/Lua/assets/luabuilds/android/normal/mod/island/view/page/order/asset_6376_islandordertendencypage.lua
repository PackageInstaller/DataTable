...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("Mod.Island.View.page.msgbox.window.IslandCommonMsgboxWindow"))
...
function var_0_1.OnLoaded(arg_2_0)
	...
	IslandOrderSlot = var_2

	local var_2_1 = var_2.TENDENCY_TYPE_COMMON
	...
	local var_2_8 = var_2.Find(var_2_7, "toggle/0/Text")

	i18n = var_2_7

	var_2_0(var_2_8, var_2_7("island_order_difficulty_2"))

	setText = var_2_0

	local var_2_9 = arg_2_0._tf
	local var_2_10 = var_2.Find(var_2_9, "toggle/1/Text")

	i18n = var_2_9

	var_2_0(var_2_10, var_2_9("island_order_difficulty_1"))

	setText = var_2_0

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_2.Find(var_2_11, "toggle/2/Text")

	i18n = var_2_11

	var_2_0(var_2_12, var_2_11("island_order_difficulty_3"))
