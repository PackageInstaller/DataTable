...
function var_0_1.InitEndTime(arg_4_0)
	...
	if arg_4_0.getConfig(var_4_0, "unlock_time") == "always" then
		arg_4_0.endTime = 0
	else
		pg = var_4_0
		...
		arg_4_0.endTime = var_2.parseTimeFromConfig(var_4_1, var_1[2])
	end
...
function var_0_1.UpdateTargetData(arg_6_0, arg_6_1)
	...
	for iter_6_2, iter_6_3 in var_3(arg_6_0:getConfig("target_id")) do
		...
		local var_6_1 = arg_6_0.targetList

		IslandTaskTarget = var_1_10010
		...
		var_1_10008(var_6_1, var_1_10010(var_6_2))
	end
...
function var_0_1.GetRecycleItemInfos(arg_10_0)
	...
	var_1_10002.each(arg_10_0.targetList, function(arg_11_0)
		...
		local var_11_1 = arg_11_0.GetType(var_11_0)

		IslandTaskTargetType = var_11_0

		if var_11_1 == var_11_0.RECYCLE then
			table = var_11_1

			local var_11_2 = var_11_1.insert
			local var_11_3 = var_10_0
			...
			var_11_5.type = var_2_10005
			var_11_5.id = arg_11_0:GetTargetId()
			var_11_5.count = arg_11_0:GetTargetNum()

			var_11_2(var_11_3, var_11_4(var_11_5))
		end
...
function var_0_1.GetRemainTimeStr(arg_15_0)
	...
	local var_15_4 = var_3.floor(var_15_2 % 0 / 16)
...
function var_0_1.GetAwards(arg_33_0)
	...
	if var_3(var_33_0) == "table" then
		underscore = var_3
		var_33_1 = var_3.map(var_33_0, function(arg_34_0)
			Drop = var_2_10001
	...
	if arg_33_0:GetExpAward() then
		...
		var_3.insert(var_33_1, arg_33_0:GetExpAward())
	end
...
function var_0_1.GetExpAward(arg_36_0)
	...
	if arg_36_0.GetExp(var_36_0) ~= 0 then
		local var_36_1 = {
			id = 2
		}

		DROP_TYPE_ISLAND_ITEM = var_36_0
		var_36_1.type = var_36_0
		var_36_1.count = arg_36_0:GetExp()
...
function var_0_1.GetAwardsStatic(arg_37_0)
	...
	if var_1_10004(var_37_0) == "table" then
		...
		pg = var_5
		var_37_2 = var_37_3(var_5.island_task[arg_37_0].reward_show, function(arg_38_0)
			Drop = var_2_10001
...
function var_0_1.BuildFakeTask(arg_40_0)
	...
	local var_40_1 = var_40_0(var_1_10002.island_task[arg_40_0].target_id, function(arg_41_0)
		local var_41_0 = {
			target_id = arg_41_0
		}
