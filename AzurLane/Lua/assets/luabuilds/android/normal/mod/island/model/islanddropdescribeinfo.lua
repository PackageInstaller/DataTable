...
function var_0_1.GetAcquiringWay(arg_6_0)
	...
	if not arg_6_0:GetDropConfig().jump_page then
		var_6_1 = {}
	end
...
function var_0_1.GetTecDes(arg_8_0)
	if arg_8_0:GetDropConfig().tech_id == 0 then
		return ""
	end

	pg = var_1_10003

	local var_8_0 = var_1_10003.island_technology_template[var_2]

	IslandTechBelong = var_1_10004

	local var_8_1 = var_1_10004.Names[var_8_0.tech_belong]
	local var_8_2 = var_8_0.tech_name

	i18n = var_1_10006

	return var_1_10006("island_information_tech", var_8_1, var_8_2)
end
