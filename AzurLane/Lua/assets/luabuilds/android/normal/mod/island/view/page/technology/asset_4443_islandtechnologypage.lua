...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_2, var_2_1("island_technology_title"))
	...
	ipairs = var_2_10
	IslandTechBelong = var_2_11

	for iter_2_0, iter_2_1 in var_2_10(var_2_11.COMMON_SHOW_TYPES) do
		local var_2_12 = arg_2_0.pages

		IslandTechTreePanel = var_1_10010
		var_1_10010 = var_1_10010.New

		local var_2_13 = var_2_8
		local var_2_14 = arg_2_0.event

		setmetatable = var_1_10013
		var_2_12[iter_2_1] = var_1_10010(var_2_13, var_2_14, var_1_10013({
			type = iter_2_1
		}, {
			__index = var_2_9
		}))
	...
	local var_2_17 = arg_2_0.event

	setmetatable = iter_2_0
	arg_2_0.quickPanel = var_2_15(var_2_16, var_2_17, iter_2_0({
		onGetAwardDone = function(arg_4_0)
			local var_4_0 = arg_2_0
			local var_4_1 = var_1.OpenPage

			IslandTechAwardPage = var_2_10003

			var_4_1(var_4_0, var_2_10003, arg_4_0)
	...
	local var_2_18 = arg_2_0.quickPanel

	var_4.RegisterView(var_2_18, arg_2_0.viewComponent)

	IslandTechDetailPanel = var_4

	local var_2_19 = var_4.New
	local var_2_20 = arg_2_0._tf
	local var_2_21 = arg_2_0.event

	setmetatable = var_7
	arg_2_0.detailPanel = var_2_19(var_2_20, var_2_21, var_7({
		onSelecteShip = function(arg_5_0)
			...
			IslandShipSelectPage = var_2_10005

			local var_5_4 = {
				needWorkSpeed = true
			}

			IslandSelectShipCard = var_2_10007
			var_5_4.showType = var_2_10007.SHOW_TYPE.PlACE
			...
			var_5_4.placeId = var_7.TechnologyPlaceId
			var_5_4.energyCost = var_5_1

			var_5_3(var_5_2, var_2_10005, var_5_4)
		...
		onFinishImmd = function(arg_7_0)
			...
			var_7_1(var_7_0, var_2_10003.ON_FINISH_TECH_IMMD, arg_7_0, function()
				local var_8_0 = arg_2_0
				local var_8_1 = var_0.OpenPage

				IslandTechAwardPage = var_3_10002

				var_8_1(var_8_0, var_3_10002, arg_7_0)
		...
		onGetAwardDone = function(arg_9_0)
			...
			var_9_1(var_9_0, var_2_10003, arg_9_0)
		...
		openTicketPage = function(arg_10_0)
			...
			var_10_1(var_10_0, var_2_10003, var_2_10004.TYPES.APPOINT, arg_10_0)
	...
	local var_2_22 = arg_2_0.detailPanel

	var_4.RegisterView(var_2_22, arg_2_0.viewComponent)
...
function var_0_1.OnInit(arg_12_0)
	...
	local var_12_2 = var_3.Find(var_12_1, "title/help")
	...
	local function var_12_3()
		...
		var_13_2.type = var_2_10003.TYPE_WHITOUT_BTN
		i18n = var_3
		var_13_2.content = var_3("island_helpbtn_technology")
	...
	local var_12_6 = var_3.Find(var_12_5, "back")
	...
	local var_12_10 = var_3.Find(var_12_9, "home")
	...
	local function var_12_11()
		...
		var_15_1(var_15_0, var_2_10002.ON_HOME)
	...
	var_1_10001(var_12_8, var_12_10, var_12_11, var_5)
...
function var_0_1.AddListeners(arg_18_0)
	...
	var_18_1(var_18_0, var_1_10003.ISLAND_UNLOCK_TECH_DONE, arg_18_0.Flush)
	...
	var_18_3(var_18_2, var_3.ISLAND_START_DELEGATION_DONE, arg_18_0.Flush)
	...
	var_18_5(var_18_4, var_3.ISLAND_FINISH_TECH_IMMD_DONE, arg_18_0.CheckAutoUnlock)
	...
	var_18_7(var_18_6, var_3.ISLAND_FINISH_DELEGATION_DONE, arg_18_0.Flush)
	...
	var_18_9(var_18_8, var_3.ISLAND_GET_DELEGATION_AWARD_DONE, arg_18_0.CheckAutoUnlock)
...
function var_0_1.RemoveListeners(arg_19_0)
	...
	var_19_1(var_19_0, var_1_10003.ISLAND_UNLOCK_TECH_DONE, arg_19_0.Flush)
	...
	var_19_3(var_19_2, var_3.ISLAND_START_DELEGATION_DONE, arg_19_0.Flush)
	...
	var_19_5(var_19_4, var_3.ISLAND_FINISH_TECH_IMMD_DONE, arg_19_0.CheckAutoUnlock)
	...
	var_19_7(var_19_6, var_3.ISLAND_FINISH_DELEGATION_DONE, arg_19_0.Flush)
	...
	var_19_9(var_19_8, var_3.ISLAND_GET_DELEGATION_AWARD_DONE, arg_19_0.CheckAutoUnlock)
...
function var_0_1.InitTypeItem(arg_20_0, arg_20_1, arg_20_2)
	...
	IslandTechBelong = var_7

	var_1_10005(var_20_1 .. var_7.Fields[var_3], arg_20_2:Find("sel/content/Image"), true)
...
function var_0_1.IsReceiveByType(arg_23_0, arg_23_1)
	...
	for iter_23_0, iter_23_1 in var_1_10002(var_3.GetTechnologys(var_23_0)) do
		if iter_23_1:getConfig("tech_belong") == arg_23_1 then
			local var_23_1 = iter_23_1
			local var_23_2 = iter_23_1.GetStatus(var_23_1)

			IslandTechnology = var_23_1

			if var_23_2 == var_23_1.STATUS.RECEIVE then
				return true
			end
		end
	end
...
function var_0_1.FlushCentreTip(arg_24_0)
	...
	IslandTechBelong = var_1_10005

	var_1_10001(var_24_0, var_24_2(var_24_1, var_1_10005.CENTRE))
