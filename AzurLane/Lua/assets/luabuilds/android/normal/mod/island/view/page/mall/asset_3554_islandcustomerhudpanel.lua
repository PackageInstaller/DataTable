...
function var_0_1.OnInit(arg_2_0)
	...
	var_1(var_2_1[var_3.random(#arg_2_0.images)], "", arg_2_0.hudImage)
	...
	local function var_2_3()
		...
		if arg_2_0.active then
			...
			var_3_0 = arg_2_0.images
			math = var_2_10002

			var_0(var_3_0[var_2_10002.random(#arg_2_0.images)], "", arg_2_0.hudImage)

			local var_3_1 = arg_2_0.timer

			math = var_3_0
			var_3_1.duration = var_3_0.random(arg_2_0.durations[1], arg_2_0.durations[2])
		else
			local var_3_2 = arg_2_0.timer

			math = var_3_0
			var_3_2.duration = var_3_0.random(arg_2_0.cds[1], arg_2_0.cds[2])
		end
	...
	math = var_3
	arg_2_0.timer = var_2_2(var_2_3, var_3.random(arg_2_0.durations[1], arg_2_0.durations[2]), -1)
