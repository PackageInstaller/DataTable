...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	...
	var_1_3.type = var_1_10008.UNIT_TYPE_STROLL
...
function var_0_1.GetResponeAction(arg_15_0, arg_15_1)
	local var_15_0 = arg_15_0:GetGreetingFeedback() and var_2 == arg_15_1

	pg = var_1_10004

	local var_15_1 = var_1_10004.island_action[arg_15_1].feedback_type

	if var_15_0 then
		pg = var_1_10006
		var_1_10006 = var_1_10006.island_action_feedback.get_id_list_by_condition[1]

		return var_0_2(var_15_1, var_1_10006), true
	else
		pg = var_1_10006

		local var_15_2 = var_1_10006.island_action_feedback.get_id_list_by_condition[2]

		return var_0_2(var_15_1, var_15_2), false
	end
