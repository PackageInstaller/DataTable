...
function var_0_1.OnInit(arg_3_0)
	...
	var_1_10001(var_3_0, var_1_10003("island_draw_choice_title"))
	...
	var_1.make(var_3_4, function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == var_2_10003.EventUpdate then
			...
			var_7(var_5_6, var_5_7, var_5_8, var_11)
	...
	var_1(var_3_6, var_3_5("word_take"))
	...
	local function var_3_9()
		if arg_3_0.selectedTarget then
			...
			var_7_2(var_7_1, var_2_10002.DRAW_AWARD_OPERATION, {
				op = "count_award",
...
function var_0_1.UpdateActivity(arg_9_0, arg_9_1)
	...
	local var_9_6 = var_1_10006("island_draw_choice")

	string = var_7

	var_9_3(var_9_5, var_9_6 .. var_7.format("%d/%d", var_9_2, var_9_4))
	...
	var_9_3(var_9_7, not var_6.CanCountAward(var_9_8, arg_9_0.selectedTarget))
