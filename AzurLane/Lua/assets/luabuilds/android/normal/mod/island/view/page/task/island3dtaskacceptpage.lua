...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1(var_2_3, var_3("island_task_open"))
...
function var_0_1.TouchEvent(arg_5_0)
	...
	local var_5_2 = var_5_1(var_5_0, var_1_10003(var_1_10004))
	...
	local var_5_5 = var_5_4(var_5_3, var_1_10004(var_1_10005))
	...
	var_2.SetEndEvent(var_5_5, function()
		...
		IslandGuideChecker = var_6_0

		if var_6_1 == var_6_0.FIRST_TASK_ID then
...
function var_0_1.Show(arg_7_0, arg_7_1, arg_7_2)
	...
	var_7_2(arg_7_0.chapterText, var_7_3:getConfig("series"))

	setText = var_7_2

	var_7_2(arg_7_0.nameText, var_7_3:getConfig("series_name"))
