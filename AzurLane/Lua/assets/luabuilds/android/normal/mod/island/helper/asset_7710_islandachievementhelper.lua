...
function var_0_0.GetRuntimeData(arg_1_0, arg_1_1)
	...
	IslandAchievementType = var_1_10007
	var_1_4[var_1_10007.ISLAND_LV] = function()
		local var_2_0 = var_0

		return var_0.GetLevel(var_2_0)
	end
	IslandAchievementType = var_7
	var_1_4[var_7.FINISH_MAIN_TASK] = function()
		local var_3_0 = var_0
	...
	IslandAchievementType = var_7
	var_1_4[var_7.SHIP_LV] = function()
		underscore = var_2_10000

		local var_4_0 = var_2_10000.reduce
		local var_4_1 = var_1_2

		return var_4_0(var_1.GetShips(var_4_1), 0, function(arg_5_0, arg_5_1)
			return arg_5_0 + (arg_5_1:GetLevel() >= arg_1_1 and 1 or 0)
		end)
	end
	IslandAchievementType = var_7
	var_1_4[var_7.SHIP_SKILL_LV] = function()
		underscore = var_2_10000

		local var_6_0 = var_2_10000.reduce
		local var_6_1 = var_1_2

		return var_6_0(var_1.GetShips(var_6_1), 0, function(arg_7_0, arg_7_1)
	...
	IslandAchievementType = var_7
	var_1_4[var_7.SEASON_RANK] = function()
	...
	IslandAchievementType = var_7
	var_1_4[var_7.SEASON_NUM] = function()
	...
	IslandAchievementType = var_7
	var_1_4[var_7.FINISH_TECH] = function()
	...
	IslandAchievementType = var_7
	var_1_4[var_7.FINISH_TYPE_TECH] = function()
	...
	IslandAchievementType = var_7
	var_1_4[var_7.RESTAURANT_SALES] = function()
	...
	IslandAchievementType = var_7
	var_1_4[var_7.FURNITURE] = function()
		if arg_1_1 == 0 then
	...
	return var_1_1(var_1_3, var_1_4, function()
		assert = var_2_10000
...
function var_0_0.UpdateRecord(arg_31_0, arg_31_1, arg_31_2)
	...
	local var_31_0 = var_1_10003(var_1_10004)
...
function var_0_0.UpdateRecordWithAdd(arg_32_0, arg_32_1, arg_32_2)
	...
	local var_32_0 = var_1_10003(var_1_10004)
...
function var_0_0.OnShipUpgrade(arg_33_0, arg_33_1)
	...
	local var_33_1 = var_1_10003(var_1_10004)
	...
	for iter_33_0, iter_33_1 in var_33_3(var_33_4) do
...
function var_0_0.OnShipSkillUpgrade(arg_34_0)
	...
	for iter_34_0, iter_34_1 in var_34_3(var_34_4) do
...
function var_0_0.OnShipAttrUpgrade(arg_36_0, arg_36_1)
	...
	if var_0_0.CheckAttrUpgrade(arg_36_0, arg_36_1) then
		ipairs = var_3
		IslandAchievementType = var_4

		for iter_36_0, iter_36_1 in var_3(var_4.GetAttrTypes()) do
			local var_36_3 = var_36_2
			local var_36_4 = var_36_2.GetRecordsByType(var_36_3, iter_36_1)

			pairs = var_36_3

			for iter_36_2, iter_36_3 in var_36_3(var_36_4) do
...
function var_0_0.OnFinishTechnolog(arg_38_0)
	...
	var_38_3(var_38_2, var_1_10004.FINISH_TECH, 0, 1)
	...
	var_38_6(var_38_5, var_5.FINISH_TYPE_TECH, var_38_4, 1)
...
function var_0_0.OnTakePhoto(arg_39_0)
	...
	local var_39_1 = var_1_10002(var_1_10003)
	...
	if var_2.CheckRecordExist(var_39_3, var_39_0, arg_39_0) then
		...
		var_39_5(var_39_4, var_5.ISLAND_UPDATE_ACHV, {
			records = {
				{
					value = 1,
					event_type = var_39_0,
