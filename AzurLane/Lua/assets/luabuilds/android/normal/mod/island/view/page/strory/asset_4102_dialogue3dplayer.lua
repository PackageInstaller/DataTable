...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.contentTxt = var_1_10(var_1_9, var_4(var_1_10005))
	...
	arg_1_0.typewriter = var_1_12(var_1_11, var_4(var_1_10005))
	...
	arg_1_0.blackBg = var_1_15(var_1_14, var_4(var_1_10005))
	...
	local var_1_19 = var_3.Find(var_1_18, "options_panel/options_l")
	local var_1_20 = arg_1_0.dialoguePanel

	arg_1_0.uiOptionList = var_1_17(var_1_19, var_4.Find(var_1_20, "options_panel/options_l/option_tpl"))
...
function var_0_1.Reset(arg_7_0, arg_7_1)
	...
	var_1_10002(var_7_0, arg_7_1 == var_1_10004.STYLE_DIALOGUE)
	...
	var_1_10002(var_7_1, arg_7_1 == var_4.STYLE_ASIDE)
			...
			if var_8_0 == var_7.STYLE_EXIT_GROUP then
				arg_8_0:PlayNavObject(var_5, function()
					...
					if var_0.GetNavObject(var_9_0) then
						IslandCameraMgr = var_9_0

						local var_9_1 = var_9_0.instance
				...
				if var_8_0 == var_7.STYLE_JOIN_GROUP then
					arg_8_0:PlayNavObject(var_5, nil, function()
						...
						if var_0.GetNavObject(var_10_0) then
							IslandCameraMgr = var_10_0

							local var_10_1 = var_10_0.instance
...
function var_0_1.PlayNavObject(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	arg_11_0:DelayCall(var_11_0.delay, function()
		...
		IslandBaseScene = var_2_10003

		local var_12_3 = var_2_10003.LINK_CORE_EVENT

		IslandProxy = var_2_10004

		var_12_2(var_12_1, var_12_3, var_2_10004.START_PATHFINDER, {
			navData = var_12_0,
			callback = arg_11_3
		})
...
function var_0_1.ActiveDefaultCamera(arg_22_0, arg_22_1)
	...
	local var_22_4 = var_22_3(var_1_10006(var_1_10007), #var_22_0)

	System = var_6

	local var_22_5 = var_6.Array.CreateInstance

	typeof = var_7
	UnityEngine = var_1_10008

	local var_22_6 = var_22_5(var_7(var_1_10008.Vector2), #var_22_0)

	for iter_22_0 = 0, #var_22_0 - 1 do
		var_22_4[iter_22_0] = var_22_0[iter_22_0 + 1].transform
		UnityEngine = var_11

		local var_22_7 = var_11.Vector2.New
		local var_22_8
		...
		var_22_6[iter_22_0] = var_22_7(var_22_8, var_22_9)
	end
	...
	if var_22_4.Length > 1 then
		...
		if arg_22_1:ShouldSetCamOffset() then
			...
			var_22_11 = arg_22_1.GetFollowOffset(var_22_10)
			IslandCameraMgr = var_22_10
			var_22_12 = var_22_10.instance

			local var_22_13 = var_8.SetVirtualCameraBodyOffset

			IslandConst = iter_22_0

			var_22_13(var_22_12, iter_22_0.INTERACTION_CAMERA_NAME, var_22_11)
		end

		IslandCameraMgr = var_22_11

		local var_22_14 = var_22_11.instance

		var_7.LookAtGroup(var_22_14, var_22_4, var_22_6)
	else
		local var_22_16

		if var_22_4.Length == 1 then
			IslandCameraMgr = var_22_16

			local var_22_15 = var_22_16.instance

			var_22_16 = var_22_16.SetVirtualCameraBodyOffset
			IslandConst = var_22_12

			var_22_16(var_22_15, var_22_12.SOLO_INTERACTION_CAMERA_NAME, arg_22_1:IsFacingWhenSolo())

			IslandCameraMgr = var_22_16

			local var_22_17 = var_22_16.instance

			var_22_16 = var_22_16.LookAt
			IslandConst = var_9

			var_22_16(var_22_17, var_9.SOLO_INTERACTION_CAMERA_NAME, var_22_4[0])
		else
			assert = var_22_16

			var_22_16(false, "should have at least one target")
		end
	end
...
function var_0_1.ShowOptions(arg_24_0, arg_24_1, arg_24_2)
	...
	var_4.make(var_24_1, function(arg_25_0, arg_25_1, arg_25_2)
		...
		if arg_25_0 == var_2_10003.EventUpdate then
			...
			local var_25_2 = var_5.Find(var_25_1, "main/content/Text")

			HXSet = var_25_1

			var_4(var_25_2, var_25_1.hxLan(var_25_0.content))
			...
			local var_25_7 = var_25_6(var_25_5, var_7(var_2_10008))
			...
			var_6(var_25_8, var_25_9, var_25_10, var_2_10010)
		end
...
function var_0_1.ResponseOption(arg_27_0, arg_27_1, arg_27_2)
	...
	if var_27_0 == var_1_10004.OPTION_TYPE_TEXT then
		var_27_1 = arg_27_0.script

		var_3.SetBranchCode(var_27_1, arg_27_1.param)
	else
		local var_27_2 = arg_27_1.type

		Dialogue3DStep = var_27_1

		local var_27_3

		if var_27_2 == var_27_1.OPTION_TYPE_PAGE then
			var_27_3 = arg_27_0.script

			var_3.MarkSkipAll(var_27_3)

			var_27_3 = arg_27_0.view

			local var_27_4 = var_3.emit

			ISLAND_EX_EVT = var_1_10005
			var_1_10005 = var_1_10005.OPEN_PAGE
			_G = var_1_10006

			var_27_4(var_27_3, var_1_10005, var_1_10006[arg_27_1.param])
		else
			local var_27_5 = arg_27_1.type

			Dialogue3DStep = var_27_3

			local var_27_6

			if var_27_5 == var_27_3.OPTION_TYPE_TASK then
				var_27_6 = arg_27_0.script

				var_3.MarkSkipAll(var_27_6)

				var_27_6 = arg_27_0.view

				local var_27_7 = var_3.emit

				ISLAND_EX_EVT = var_1_10005

				var_27_7(var_27_6, var_1_10005.TRIGGER_TASK, arg_27_1.param)
			else
				local var_27_8 = arg_27_1.type

				Dialogue3DStep = var_27_6

				if var_27_8 == var_27_6.OPTION_TYPE_EXIT then
					local var_27_9 = arg_27_0.script

					var_3.MarkSkipAll(var_27_9)
				end
			end
		end
	end
...
function var_0_1.PlayOptionExitAnimation(arg_28_0, arg_28_1)
	...
	var_3.eachActive(var_28_1, function(arg_29_0, arg_29_1)
		...
		var_2_10002.insert(var_28_0, function(arg_30_0)
			...
			typeof = var_3_10003
			DftAniEvent = var_3_10004

			local var_30_2 = var_30_1(var_30_0, var_3_10003(var_3_10004))
			...
			local var_30_5 = var_30_4(var_30_3, var_4(var_3_10005))
	...
	var_3(var_28_0, function()
		...
		var_0.each(var_32_0, function(arg_33_0, arg_33_1)
			...
			local var_33_2 = var_33_1(var_33_0, var_3_10004(var_3_10005))
...
function var_0_1.StartAction(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_1 = arg_36_1.GetPlayMode(var_36_0)

	Dialogue3DStep = var_36_0

	local var_36_3

	if var_36_1 == var_36_0.PLAY_MODE_SCENE_TIMELINE then
		setActive = var_36_3

		var_36_3(arg_36_0._tf, false)

		local var_36_2 = arg_36_0.view

		var_36_3 = var_36_3.emit
		ISLAND_EX_EVT = var_6

		var_36_3(var_36_2, var_6.PLAY_TIMELINE, arg_36_1:GetSceneTimelinePath(), {}, function()
		...
		Dialogue3DStep = var_36_3

		if var_36_1 == var_36_3.PLAY_MODE_TIMELINE then
			arg_36_2()
		else
			Dialogue3DStep = var_4

			if var_36_1 == var_4.PLAY_MODE_DIALOGUE then
...
function var_0_1.ActiveCamera(arg_43_0, arg_43_1, arg_43_2)
	...
	if var_43_0 then
		arg_43_0:CollectFadeOutFunc(var_43_1)
	end

	table = var_1_10005

	var_1_10005.insert(var_43_1, function(arg_44_0)
		local var_44_0 = arg_43_1
		local var_44_1 = var_1.GetActiveCamera(var_44_0)

		IslandCameraMgr = var_44_0

		local var_44_2 = var_44_0.instance
	...
	if var_43_0 then
		arg_43_0:CollectFadeInFunc(var_43_1)
	end

	seriesAsync = var_5

	var_5(var_43_1, arg_43_2)
...
function var_0_1.LoadShakeSrc(arg_48_0, arg_48_1, arg_48_2)
	...
	local var_48_1 = arg_48_1.GetCameraShakeSrc(var_48_0)

	PoolMgr = var_48_0

	local var_48_2 = var_48_0.GetInstance()

	var_4.GetUI(var_48_2, var_48_1, true, function(arg_49_0)
...
function var_0_1.Turn2Unit(arg_60_0, arg_60_1, arg_60_2, arg_60_3)
	...
	Quaternion = var_6
	arg_60_1.rotation = var_6.Euler(0, var_60_1.eulerAngles.y, 0)
...
function var_0_1.Face2Face(arg_63_0, arg_63_1, arg_63_2, arg_63_3)
	...
	if var_63_0.sqrMagnitude > 0.0001 then
		...
		local var_63_2 = var_6.LookRotation(var_63_0)

		Quaternion = var_7
		arg_63_1.rotation = var_7.Euler(0, var_63_2.eulerAngles.y, 0)
	end

	if var_63_1.sqrMagnitude > 0.0001 then
		Quaternion = var_6

		local var_63_3 = var_6.LookRotation(var_63_1)

		Quaternion = var_7
		arg_63_2.rotation = var_7.Euler(0, var_63_3.eulerAngles.y, 0)
	end
...
function var_0_1.RegisterEvent(arg_65_0, arg_65_1, arg_65_2)
	...
	var_3(arg_65_0.optionPanel, arg_65_1:ExistOption())
	...
	if arg_65_1:ExistOption() then
		...
		if arg_65_0.autoNext then
			local var_65_0 = arg_65_0.script

			var_65_1 = var_65_1.GetTriggerDelayTime(var_65_0)

			arg_65_0:UnscaleDelayCall(var_65_1, arg_65_2)
		else
			onButton = var_65_1

			local var_65_2 = arg_65_0
			local var_65_3 = arg_65_0._tf
			local var_65_4 = arg_65_2

			SFX_PANEL = var_1_10007

			var_65_1(var_65_2, var_65_3, var_65_4, var_1_10007)
		end
	end
...
function var_0_1.UpdateTypeWriter(arg_66_0, arg_66_1, arg_66_2)
	...
	if var_66_0 and var_66_0 ~= "" then
		System = var_1_10005
		var_66_1 = var_1_10005.String.New(var_66_0).Length
	end

	if not var_66_0 or var_66_0 == "" or var_66_0 == "…" or not (#var_66_0 > 1) or not (var_66_1 > 1) then
		arg_66_2()
	...
	local var_66_2 = arg_66_0.typewriter

	function var_66_2.endFunc()
	...
	arg_66_0.typewriterSpeed = var_66_3(var_66_4 * arg_66_0.timeScale, 0.001)

	local var_66_5

	if not var_5.speedUp then
		var_66_5 = arg_66_0.typewriterSpeed
	end

	local var_66_6 = arg_66_0.typewriter

	var_7.setSpeed(var_66_6, arg_66_0.typewriterSpeed)
	...
	local var_66_9 = arg_66_0._tf

	local function var_66_10()
		...
		math = var_2_10001
		var_68_0.typewriterSpeed = var_2_10001.min(arg_66_0.typewriterSpeed, var_66_5)
	...
	var_7(var_66_8, var_66_9, var_66_10, var_1_10011)
...
function var_0_1.LoadContentAndIcon(arg_69_0, arg_69_1, arg_69_2)
	...
	if arg_69_1.GetActorIcon(var_69_1) then
		GetImageSpriteFromAtlasAsync = var_69_1

		var_69_1("island/IslandShipIcon/" .. var_4, "", arg_69_0.iconImg)
	end

	setActive = var_69_1

	var_69_1(arg_69_0.iconImg, not arg_69_1:IsHideIcon())
	arg_69_2()
...
function var_0_1.PlayCharatorAnimation(arg_70_0, arg_70_1, arg_70_2)
	...
	if not var_3.GetRole(var_70_0, arg_70_1:GetUnitData()) then
		arg_70_2()
	...
	local var_70_2 = var_3
	local var_70_3 = var_3.GetComponent
	...
	if not var_70_3(var_70_2, var_1_10007(var_1_10008)) then
		local var_70_4 = var_3.transform
		local var_70_5 = var_6.GetChild(var_70_4, 0)
		local var_70_6 = var_6.GetComponent

		typeof = var_8
		Animator = var_1_10009
		var_70_7 = var_70_6(var_70_5, var_8(var_1_10009))
	end

	local var_70_8 = var_70_7:GetCurrentAnimatorStateInfo(0)

	if not var_6.IsName(var_70_8, var_70_1) then
		Animator = var_6

		local var_70_9 = var_6.StringToHash(var_70_1)

		for iter_70_0 = 1, var_70_7.layerCount do
			var_70_7:CrossFadeInFixedTime(var_70_9, 0.2, iter_70_0 - 1)
		end
	end
