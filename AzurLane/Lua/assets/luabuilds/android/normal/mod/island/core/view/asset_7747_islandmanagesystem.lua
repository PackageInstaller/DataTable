...
function var_0_1.OnStart(arg_2_0)
	...
	IslandRestaurant = var_2_0

	if var_2_1 == var_2_0.STATUS.OPENING then
...
function var_0_1.ExecuteManage(arg_4_0, arg_4_1)
	...
	var_2.SendEvent(var_4_2, "manage_add_customer", arg_4_1:GetCustomerUnitNodeList(), nil)

	LuaHelper = var_2

	var_2.NodeCanvasSetIntVariableValue(arg_4_0.behaviourTreeOwner, "systemId", arg_4_1.id)
	...
	for iter_4_0, iter_4_1 in var_2(arg_4_1:GetFoodUnitIds()) do
		...
		if var_1_10007(var_1_10008.UNIT_LIST_MANAGE, iter_4_1) then
...
function var_0_1.EndManage(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_2(arg_5_1:GetFoodUnitIds()) do
		...
		if var_1_10007(var_1_10008.UNIT_LIST_MANAGE, iter_5_1) then
			setActive = var_1_10008
...
function var_0_1.OnUpdate(arg_6_0)
	...
	if arg_6_0.isShowing then
		...
		if var_6_1 ~= var_2.STATUS.OPENING then
			...
			local var_6_2 = var_2(var_1_10003)

			var_1_10004 = var_2.GetIsland(var_6_2)

			local var_6_3 = var_2.DispatchEvent

			IslandCloseRestaurantCommand = var_1_10005

			var_6_3(var_1_10004, var_1_10005.CLOSE_RESTAURANT, {
	...
	typeof = var_1_10004
	ParadoxNotion = var_1_10005

	if not var_6_6(var_6_5, var_1_10004(var_1_10005.Services.EventRouter)) then
		return
	end
	...
	for iter_6_0, iter_6_1 in var_6_7(var_6_8) do
		local var_6_9 = arg_6_0:GetView()
		local var_6_10 = var_10.GetUnitModuleWithType

		IslandConst = var_1_10012
		var_1_10012 = var_6_10(var_6_9, var_1_10012.UNIT_LIST_MANAGE, iter_6_1.id)

		if not var_10.IsLoaded(var_1_10012) then
			return
		end
		...
		if var_6_11 == var_1_10012.UNIT_TYPE_MANAGE_CHARA then
			var_1_10012 = var_10._go

			local var_6_12 = var_11.GetComponent

			typeof = var_13
			ParadoxNotion = var_1_10014

			if not var_6_12(var_1_10012, var_13(var_1_10014.Services.EventRouter)) then
				return
			end
		end
	end
