...
function var_0_1.OnLoaded(arg_2_0)
	...
	var_1_10001(var_2_1, var_2_0("island_exchange_title"))

	setText = var_1_10001

	local var_2_2 = arg_2_0._tf
	local var_2_3 = var_2.Find(var_2_2, "top/title/Text/en")

	i18n = var_2_2

	var_1_10001(var_2_3, var_2_2("island_exchange_title_en"))

	local var_2_4 = arg_2_0._tf
	local var_2_5 = var_1.Find(var_2_4, "adapt/toggles/content")

	UIItemList = var_2_4
	arg_2_0.toggleUIList = var_2_4.New(var_2_5, var_2_5:Find("tpl"))
	...
	local var_2_9 = var_2_7.Find(var_2_8, "tip")

	i18n = var_2_8

	var_2_6(var_2_9, var_2_8("island_quickselect_tip"))

	arg_2_0.allBtn = var_2_7:Find("btn_all")

	local var_2_10 = arg_2_0.allBtn

	arg_2_0.allFlagTF = var_3.Find(var_2_10, "flag")
	setText = var_3

	local var_2_11 = arg_2_0.allBtn
	local var_2_12 = var_4.Find(var_2_11, "Text")

	i18n = var_2_11

	var_3(var_2_12, var_2_11("island_selectall"))

	arg_2_0.deleteBtn = var_2_7:Find("btn_delete")

	local var_2_13 = var_2_7:Find("view")

	arg_2_0.scrollRect = var_3.GetComponent(var_2_13, "LScrollRect")
	arg_2_0.emptyTF = var_2_7:Find("empty")

	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "adapt/right")
	local var_2_16 = var_3.Find(var_2_15, "title/name")
	local var_2_17 = var_4.GetComponent

	typeof = var_6
	Text = var_1_10007
	arg_2_0.itemNameTxt = var_2_17(var_2_16, var_6(var_1_10007))
	arg_2_0.itemTF = var_3:Find("bg_item/item")
	setText = var_4

	local var_2_18 = var_3
	local var_2_19 = var_3.Find(var_2_18, "bg_count/Text")

	i18n = var_2_18

	var_4(var_2_19, var_2_18("island_exchange_own_count"))

	local var_2_20 = var_3:Find("bg_count/content/Text")
	local var_2_21 = var_4.GetComponent

	typeof = var_6
	Text = var_7
	arg_2_0.itemOwnTxt = var_2_21(var_2_20, var_6(var_7))

	local var_2_22 = var_3:Find("bg_count/content/add")
	local var_2_23 = var_4.GetComponent

	typeof = var_6
	Text = var_7
	arg_2_0.itemAddTxt = var_2_23(var_2_22, var_6(var_7))
	arg_2_0.exchangeBtn = var_3:Find("btn_exchange")
	setText = var_4

	local var_2_24 = arg_2_0.exchangeBtn
	local var_2_25 = var_5.Find(var_2_24, "Text")

	i18n = var_2_24

	var_4(var_2_25, var_2_24("island_exchange_btn_text"))

	local var_2_26 = arg_2_0._tf

	arg_2_0.blockTF = var_4.Find(var_2_26, "block")
	...
	typeof = var_6
	Animation = var_7
	arg_2_0.itemAnim = var_2_28(var_2_27, var_6(var_7))

	local var_2_29 = var_3:Find("bg_item")
	local var_2_30 = var_4.GetComponent

	typeof = var_6
	DftAniEvent = var_7
	arg_2_0.itemAnimEvent = var_2_30(var_2_29, var_6(var_7))
...
function var_0_1.SendExchangeProto(arg_15_0)
	...
	var_15_1(var_15_0, var_1_10003.EXCHANGE_ITME, arg_15_0.exchangeItems, arg_15_0.showItemId, arg_15_0.totalAddCnt)
...
function var_0_1.OnShow(arg_16_0, arg_16_1)
	...
	local var_16_3 = var_3.GetChild(var_16_2, 0)

	var_2(var_3.Find(var_16_3, "title"), true)
...
function var_0_1.AddListeners(arg_17_0)
	...
	var_17_1(var_17_0, var_1_10003.ISLAND_EXCHANGE_ITEM_DONE, arg_17_0.OnExchangeDone)
...
function var_0_1.RemoveListeners(arg_18_0)
	...
	var_18_1(var_18_0, var_1_10003.ISLAND_EXCHANGE_ITEM_DONE, arg_18_0.OnExchangeDone)
...
function var_0_1.UpdateToggleItem(arg_20_0, arg_20_1, arg_20_2)
	...
	local var_20_3 = arg_20_2:Find("title")
	...
	local function var_20_4(arg_21_0)
		if arg_21_0 then
			...
			local var_21_1 = var_2.Find(var_21_0, "list")

			var_2_10001(var_2.GetChild(var_21_1, 0), true)
		end
	...
	var_1_10005(var_20_2, var_20_3, var_20_4, var_9)

	local var_20_5 = var_20_1.exchange_group

	UIItemList = var_20_2

	var_20_2.StaticAlign(arg_20_2:Find("list"), arg_20_2:Find("list/tpl"), #var_20_5, function(arg_22_0, arg_22_1, arg_22_2)
		UIItemList = var_2_10003

		if arg_22_0 == var_2_10003.EventUpdate then
			local var_22_0 = arg_22_1 + 1
			local var_22_1 = var_20_5[var_22_0][1]
			local var_22_2 = var_20_5[var_22_0][2]
			...
			var_2_10006(arg_22_2:Find("line2"), var_22_0 ~= #var_20_5)
			...
			var_2_10006(var_22_3, var_22_4, var_22_5, var_2_10010)
		end
...
function var_0_1.FlushGroup(arg_24_0)
	...
	local var_24_2 = var_3(var_1_10004)
...
function var_0_1.OnInitItem(arg_27_0, arg_27_1)
	...
	var_3(var_27_1, var_27_2, var_27_3, var_1_10007)
	...
	var_3(var_27_4, var_27_5, var_27_6, var_1_10007)

	onInputEndEdit = var_3

	var_3(arg_27_0, var_27_0.valueInput, function(arg_30_0)
		table = var_2_10001
	...
	var_3(var_27_7, var_27_8, var_27_9, var_27_10, var_27_11, var_27_12, var_27_13, var_1_10011)
...
function var_0_1.UpdateCardSel(arg_33_0, arg_33_1, arg_33_2)
	...
	local var_33_2 = var_1_10006.max
	local var_33_3 = 0

	math = var_1_10008

	local var_33_4 = var_1_10008.min
	local var_33_5 = var_33_0
	local var_33_6 = arg_33_1.item

	var_33_1[var_3] = var_33_2(var_33_3, var_33_4(var_33_5, var_10.GetCount(var_33_6)))
...
function var_0_1.CollectDisplayItems(arg_37_0)
	...
	local var_37_1 = var_1_10002(var_1_10003)
	local var_37_2 = var_2.GetIsland(var_37_1)
	local var_37_3 = var_2.GetInventoryAgency(var_37_2)

	pg = var_37_2
	arg_37_0.showExchangeIds = var_37_2.island_exchange_template.get_id_list_by_group[arg_37_0.showGroupId]
	...
	for iter_37_0, iter_37_1 in var_4(arg_37_0.showExchangeIds) do
		...
		local var_37_5 = var_37_3

		if var_37_3.GetItemById(var_37_5, var_37_4) then
			Clone = var_37_5

			local var_37_6 = var_37_5(var_10)

			var_37_6.exchangeId = iter_37_1
			var_37_6.targetNum = var_3[iter_37_1].target_num
			table = var_12

			var_12.insert(var_37_0, var_37_6)
		end
	end
