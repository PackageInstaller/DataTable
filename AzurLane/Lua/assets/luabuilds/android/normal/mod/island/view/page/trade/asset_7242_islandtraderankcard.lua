...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.nameTxt = var_1_4(var_1_3, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.lvTxt = var_1_7(var_1_6, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.numTxt = var_1_11(var_1_10, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.valueTxt = var_1_14(var_1_13, var_4(var_1_10005))
	...
	local var_1_18 = var_3.Find(var_1_17, "island")

	i18n = var_1_17

	var_2(var_1_18, var_1_17("island_trade_rank_level_label"))
	...
	typeof = var_4
	CanvasGroup = var_5
	arg_1_0.cg = var_2(var_1_19, var_4(var_5))
...
function var_0_0.Update(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local var_2_7 = arg_2_2.IsSelf(var_2_6)

	setActive = var_2_6

	var_2_6(arg_2_0.visitBtn, not var_2_7)

	setActive = var_2_6

	var_2_6(arg_2_0.inviteBtn, var_2_7)

	setActive = var_2_6

	var_2_6(arg_2_0.numTxt.gameObject, arg_2_1 > 3)

	setActive = var_2_6

	var_2_6(arg_2_0.numImg, arg_2_1 <= 3)
