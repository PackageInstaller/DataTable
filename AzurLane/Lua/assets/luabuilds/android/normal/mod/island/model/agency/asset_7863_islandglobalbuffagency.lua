...
function var_0_1.InitShipSkillGlobalBuff(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_2(arg_2_0.shipIds) do
		local var_2_3 = var_2_2:GetShipById(iter_2_1)
		local var_2_4 = var_7.GetSkill(var_2_3)
		local var_2_5 = var_8.GetEffectIds(var_2_4)
...
function var_0_1.OnShipSkillUpgrade(arg_5_0, arg_5_1)
	...
	local var_5_6 = var_2
	local var_5_7 = var_2.GetEffectIds(var_5_6)

	table = var_5_6

	if var_5_6.contains(arg_5_0.shipIds, arg_5_1) then
		underscore = var_5
	...
	if #arg_5_0:_SelectGlobalType(var_5_7) > 0 then
		underscore = var_6
...
function var_0_1.GetBuffsByType(arg_8_0, arg_8_1)
	...
	local var_8_3 = var_8_1.mergeArray
...
function var_0_1._RemoveById(arg_11_0, arg_11_1, arg_11_2)
	...
	var_5.removebyvalue(var_11_0, var_11_1)
...
function var_0_1._SelectGlobalType(arg_13_0, arg_13_1)
	...
	return var_1_10002.select(arg_13_1, function(arg_14_0)
		...
		return var_14_0(var_2_10002.island_buff_template[arg_14_0].buff_type)
	end)
end
