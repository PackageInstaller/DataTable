...
ys = var_1
var_1.Battle.BattleGateScenario = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if var_1_10002.DockOverload() then
		...
		var_1_10003 = var_1_0(var_1_10003)
		var_1_0 = var_1_0.StopAutoFight
		ChapterConst = var_1_10004

		var_1_0(var_1_10003, var_1_10004.AUTOFIGHT_STOP_REASON.DOCK_OVERLOADED)
	...
	local var_1_1 = var_1_0(var_1_10003)
	...
	local var_1_10 = var_1_10011(var_1_10012)
	...
	if var_1_4 and var_1_19.oil < var_1_18 then
		getProxy = var_18
		ChapterProxy = iter_1_1
		iter_1_1 = var_18(iter_1_1)

		local var_1_20 = var_18.StopAutoFight

		ChapterConst = var_1_10020

		var_1_20(iter_1_1, var_1_10020.AUTOFIGHT_STOP_REASON.OIL_LACK)

		ItemTipPanel = var_1_20

		if not var_1_20.ShowOilBuyTip(var_1_18) then
			pg = var_18
			iter_1_1 = var_18.TipsMgr.GetInstance()

			local var_1_21 = var_18.ShowTips

			i18n = var_1_10020

			var_1_21(iter_1_1, var_1_10020("stage_beginStage_error_noResource"))
		end

		return
	end

	local var_1_22 = arg_1_0.stageId

	pg = iter_1_1

	local var_1_23 = iter_1_1.expedition_data_template[var_1_22].dungeon_id

	ys = var_1_10020

	local var_1_24 = var_1_10020.Battle.BattleDataFunction.GetDungeonTmpDataByID(var_1_23).fleet_prefab

	arg_1_1.ShipVertify()

	local var_1_25
	local var_1_26 = var_12
	local var_1_27 = var_12.getPlayType(var_1_26)

	ChapterConst = var_1_26

	if var_1_27 == var_1_26.TypeExtra then
		var_1_25 = true
	end
	...
	local function var_1_29(arg_2_0)
		...
		if var_0.enter_energy_cost > 0 and not var_1_25 then
			pg = var_1
	...
	local function var_1_30(arg_3_0)
		...
		var_3_2(var_3_1, var_3.AUTOFIGHT_STOP_REASON.UNKNOWN)
	...
	SYSTEM_SCENARIO = var_1_10026

	var_1_31(var_1_10026, var_1_5, {
		var_1_22
	}, var_1_29, var_1_30)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local var_4_6 = 0
	local var_4_7 = {}
	local var_4_8 = var_4_3:getActiveChapter()
	local var_4_9 = var_9.getPlayType(var_4_8)

	ChapterConst = var_4_8

	local var_4_10 = var_4_9 == var_4_8.TypeExtra
	local var_4_11 = var_9.fleet
	local var_4_12 = var_11.getShips(var_4_11, true)

	ipairs = var_4_11

	for iter_4_0, iter_4_1 in var_4_11(var_4_12) do
		table = var_1_10018

		var_1_10018.insert(var_4_7, iter_4_1)
	end

	local var_4_13 = arg_4_0.stageId
	local var_4_14, var_4_15 = var_9:getFleetCost(var_11, var_4_13)
	local var_4_16 = var_4_15.gold
	local var_4_17 = var_4_15.oil
	local var_4_18 = var_9:GetExtraCostRate()

	if arg_4_0.statistics.submarineAid then
		local var_4_19 = var_9

		if var_9.GetSubmarineFleet(var_4_19) then
			var_4_19 = 0
			ipairs = var_1_10019

			local var_4_20 = var_17
			local var_4_21 = var_17.getShipsByTeam

			TeamType = var_1_10022

			for iter_4_2, iter_4_3 in var_1_10019(var_4_21(var_4_20, var_1_10022.Submarine, true)) do
			...
			math = var_19
			var_4_17 = var_4_17 + var_19.min(var_4_19, var_9:GetLimitOilCost(true)) * var_4_18
		else
	...
	local var_4_22 = var_4_4 > var_17.Battle.BattleConst.BattleScore.C

	var_9:writeBack(var_4_22, arg_4_0)
	var_4_3:updateChapter(var_9)

	local var_4_23 = arg_4_1.GeneralPackage(arg_4_0, var_4_7)

	local function var_4_24(arg_5_0)
		...
		local var_5_3 = var_3.getActiveChapter(var_5_2).fleet
		local var_5_4 = var_0
		local var_5_5 = var_5_0(var_5_1, var_5_3, var_4.GetSubmarineFleet(var_5_4))
		...
		SYSTEM_SCENARIO = var_5_4

		var_5_9(var_5_4, var_4_22, var_4_17, arg_5_0.player_exp, var_4_10)

		local var_5_10 = {}

		SYSTEM_SCENARIO = var_5_4
		var_5_10.system = var_5_4
		...
		if var_6.CanDropItem(var_5_7) then
			...
			for iter_5_2, iter_5_1 in var_7(var_5_7) do
				table = var_2_10012

				var_2_10012.insert(var_5_15, iter_5_1)
			end
		...
		if var_5_21.lastMap and var_5_22 ~= var_5_20 and var_5_20 < var_5_22 then
			Map = var_8
		...
		var_5_24(var_5_23, iter_5_2.CHAPTER_BATTLE_RESULT_REQUEST, {
			callback = function()
				...
				var_6_1(var_6_0, var_3_10002.FINISH_STAGE_DONE, var_5_10)
	...
	arg_4_1:SendRequest(var_4_23, var_4_24)
...
function var_0_0.GetPreloadList(arg_7_0)
	...
	local var_7_4 = var_7_2.Battle.BattleResourceManager.GetInstance()
	...
	if var_7_11 == true or var_7_11 > 0 then
		...
		local var_7_15 = var_7_14(var_7_13, iter_7_3.Submarine, false)

		ipairs = var_7_13

		for iter_7_6, iter_7_7 in var_7_13(var_7_15) do
			table = iter_7_4

			iter_7_4.insert(var_7_0, iter_7_7)
		end

		local var_7_16, var_7_17 = var_7_3:getFleetBattleBuffs(var_7_12)

		ipairs = var_17

		for iter_7_8, iter_7_11 in var_17(var_7_16) do
			table = var_1_10022
		...
		for iter_7_10, iter_7_11 in var_17(var_7_17) do
			table = var_1_10022
	...
	local var_7_18, var_7_19 = var_7_4.GetPlayerShipResource(var_7_0, arg_7_0.system)
	local var_7_20 = var_7_4.GetCommanderBuffRes(var_7_8)

	ipairs = var_16

	for iter_7_12, iter_7_13 in var_16(var_7_20) do
		table = iter_7_11

		iter_7_11.insert(var_7_18, iter_7_13)
	end

	local var_7_21 = var_7_4.GetResFromBuffIDList(var_7_7)

	ipairs = var_16

	for iter_7_14, iter_7_15 in var_16(var_7_21) do
		table = iter_7_11

		iter_7_11.insert(var_7_18, iter_7_15)
	end

	local var_7_22 = var_7_4.GetResFromBuffList(var_7_9)

	ipairs = var_16

	for iter_7_16, iter_7_17 in var_16(var_7_22) do
		table = iter_7_11

		iter_7_11.insert(var_7_18, iter_7_17)
	end

	return var_7_18, var_7_19
end
