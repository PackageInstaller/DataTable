...
function var_0_4.doBehaviour(arg_3_0)
	...
	if arg_3_0._targetIndex <= arg_3_0._rounds then
		...
		local var_3_4 = var_3_2(arg_3_0._content)

		if var_3_0 then
			table = var_6

			var_6.merge(var_3_4, var_3_0)
		end
		...
		if var_3:GetAreaType() == var_0_1.AreaType.CUBE then
			...
			local var_3_12 = var_3.GetHeight(var_1_10014)

			var_1_10014 = var_3_5
			math = var_1_10015
			var_3_7 = var_3_10(var_3_11, var_3_12, var_1_10014, var_1_10015.max(var_3_8, var_3_9 or 0))
		elseif var_3:GetAreaType() == var_0_1.AreaType.COLUMN then
			unpack = var_9

			local var_3_13, var_3_14 = var_9(var_3_6.cld_data)
			local var_3_15 = arg_3_0.GenerateRandomCirclePosition
			local var_3_16 = var_3:GetRange()
			local var_3_17 = var_3_5

			math = var_1_10014
			var_3_7 = var_3_15(var_3_16, var_3_17, var_1_10014.max(var_3_13, var_3_14 or 0))
		end
...
function var_0_4.PlayAlert(arg_7_0, arg_7_1)
	...
	if var_1_10007.effect_offset[var_3] and var_7[var_3].y_scale == true then
		var_7_3 = var_7_0
	end
...
function var_0_4.GenerateRandomRectanglePosition(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	for iter_8_1 = 1, arg_8_2 do
		...
		var_8_7(var_8_8, var_19(var_8_5, 0, var_8_6))
	end
...
function var_0_4.GenerateRandomCirclePosition(arg_9_0, arg_9_1, arg_9_2)
	...
	for iter_9_1 = 1, arg_9_1 do
		...
		var_9_12(var_9_11, var_21(var_9_10 * var_0.cos(var_9_9), var_9_10 * var_0.sin(var_9_9)))
		...
		var_9_13(var_9_14, var_21(var_1_10015.x, 0, var_1_10015.y))
	end
