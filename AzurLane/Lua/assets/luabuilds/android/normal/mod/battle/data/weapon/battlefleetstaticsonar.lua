...
function var_0_10.getSonarProperty(arg_13_0)
	...
	local var_13_6 = var_6.contains

	ShipType = var_1_10007

	if var_13_6(var_1_10007.MainShipType, var_13_0) then
...
function var_0_10.updateDetectedList(arg_16_0)
	...
	local var_16_3 = arg_16_0.FilterRange(var_16_2, var_16_1)

	ipairs = var_16_2

	for iter_16_0, iter_16_1 in var_16_2(var_16_1) do
		table = var_1_10009
		var_1_10009 = var_1_10009.contains(var_16_3, iter_16_1)
		table = var_10

		if var_10.contains(arg_16_0._detectedList, iter_16_1) then
			if not var_1_10009 then
				iter_16_1:Undetected()
			end
		elseif not var_10 and var_1_10009 then
			iter_16_1:Detected()
		end
	end

	arg_16_0._detectedList = var_16_3
