...
function var_0_5.onUpdateCards(arg_4_0, arg_4_1)
	...
	while 0 < var_4_2 do
		...
		if not var_4_3.contains(var_4_1, var_4_4) then
...
function var_0_5.updateCardReferenceInHand(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10001(arg_18_0._activeCardList) do
		...
		local var_18_1 = arg_18_0.getcardGap(var_18_0)

		Vector3 = var_18_0

		local var_18_2 = var_18_0.New(arg_18_0._startPos.x + (iter_18_0 - 1) * var_18_1, arg_18_0._startPos.y, 0)

		iter_18_1:SetReferencePos(var_18_2)
...
function var_0_5.activeHighlight(arg_22_0, arg_22_1)
	if arg_22_1 then
		...
		var_1_10002.AddPointEnterFunc(var_22_2, function()
			...
			var_25_2(arg_22_0._cancelHint, not var_25_3)

			setActive = var_25_2

			var_25_2(arg_22_0._returnHint, var_25_3)
