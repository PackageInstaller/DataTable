...
ys = var_1
var_1.Battle.BattleGateBossRush = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_19 = var_1_3.getSortShipsByFleet(var_1_18, var_1_15)
	...
	local var_1_20 = var_1_1:getRawData()
	local var_1_21 = var_1_15:GetCostSum().oil

	if var_1_6 and var_1_20.oil < var_1_21 then
		pg = var_22

		local var_1_22 = var_22.TipsMgr.GetInstance()
		local var_1_23 = var_22.ShowTips

		i18n = iter_1_1

		var_1_23(var_1_22, iter_1_1("stage_beginStage_error_noResource"))
	...
	local var_1_24 = var_1_15:getStartCost().oil
	...
	local function var_1_25(arg_2_0)
		...
		if 0 < var_2_1 then
			...
			for iter_2_0, iter_2_1 in var_2(var_1_19) do
		...
		if arg_1_0.curIndex then
			...
			var_2_7(var_2_6, var_2_10004.CONTINUE_STAGE_DONE, var_2_5)
		else
			...
			var_2_9(var_2_8, var_2_10004.BEGIN_STAGE_DONE, var_2_5)
		end
	...
	local var_1_27 = var_1_10025.SendRequest

	SYSTEM_BOSS_RUSH = var_1_10026

	var_1_27(var_1_10026, var_1_17, {
		var_1_11
	}, var_1_25, var_1_26)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	;(function()
		...
		;(function(arg_6_0)
			...
			var_6_0(var_6_1, var_3_10003.values(arg_6_0.commanderIds))
			...
			var_6_2(var_6_3, var_3.getSortShipsByFleet(var_6_4, arg_6_0))
	...
	if var_4_8 then
		...
		var_4_10(var_4_9, var_1_10013.FINISH_STAGE_ERROR)
	...
	local function var_4_12(arg_7_0)
		...
		local var_7_2 = var_2_10003(var_2_10004)
		...
		var_7_7(var_7_6, var_7.FINISH_STAGE_DONE, var_7_0)
...
function var_0_0.GetPreloadList(arg_8_0)
	...
	if var_8_14 then
		local var_8_16 = var_8_14
		local var_8_17 = var_8_14.GetRawShipIds(var_8_16)

		ipairs = var_8_16

		for iter_8_0, iter_8_1 in var_8_16(var_8_17) do
			table = var_1_10023
	...
	if var_8_15 then
		local var_8_18 = var_8_15
		local var_8_19 = var_8_15.GetRawShipIds(var_8_18)

		ipairs = var_8_18

		for iter_8_2, iter_8_3 in var_8_18(var_8_19) do
			table = var_1_10023
	...
	local var_8_20, var_8_21 = var_8_3.GetPlayerShipResource(var_8_0, arg_8_0.system)
	local var_8_22 = var_8_3.GetCommanderBuffRes(var_8_1)

	ipairs = var_19

	for iter_8_6, iter_8_7 in var_19(var_8_22) do
		table = var_1_10024

		var_1_10024.insert(var_8_20, iter_8_7)
	end

	return var_8_20, var_8_21
end
