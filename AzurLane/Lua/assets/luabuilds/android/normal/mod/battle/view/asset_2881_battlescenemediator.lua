...
function var_0_7.InitPopNumPool(arg_5_0)
	...
	if var_5_3 == var_5_2 then
		...
		var_5_5(var_5_4, var_5.Find(var_5_6, var_1.CONTAINER_CHARACTER_HP .. "/container"))
	else
		local var_5_7 = arg_5_0._popNumMgr
		local var_5_8 = var_3.InitialBundlePool
		local var_5_9 = var_5_1._tf

		var_5_8(var_5_7, var_5.Find(var_5_9, var_1.CONTAINER_CHARACTER_HP .. "/container"))
	end
...
function var_0_7.InitCharacterFactory(arg_8_0)
	...
	var_8_3(var_8_2, var_4.Find(var_8_4, var_0.Battle.BattleHPBarManager.ROOT_NAME))

	local var_8_5 = var_0.Battle.BattleArrowManager.GetInstance()
	local var_8_6 = var_2.Init
	local var_8_7 = var_8_1._tf

	var_8_6(var_8_5, var_4.Find(var_8_7, var_0.Battle.BattleArrowManager.ROOT_NAME))
...
function var_0_7.InitPlayerAntiSubArea(arg_10_0)
	...
	arg_10_0._antiSubScanAnima = var_10_4(var_10_3, var_3(var_1_10004))
...
function var_0_7.InitDetailAntiSubArea(arg_11_0)
	...
	local function var_11_6(arg_12_0, arg_12_1, arg_12_2)
		...
		Vector3 = var_5
		var_12_2.localScale = var_5(arg_12_0, 0, arg_12_0)
	...
	var_11_6(var_11_7, var_1_10008.New(1, 1, 1, 1), "技能额外直径：" .. var_11_5)
	...
	var_11_8(var_11_9, var_8.New(0.07, 1, 0, 1), "装备提供直径：" .. var_11_4)
	...
	var_11_10(var_11_11, var_8.New(1, 0.32, 0, 1), "主力提供直径：" .. var_11_3)
	...
	var_11_12(var_11_13, var_8.New(1, 0, 0, 1), "基础直径：" .. var_11_2)
...
function var_0_7.AddEvent(arg_13_0)
	...
	pg = var_3
	arg_13_0._camEventId = var_13_17(var_13_16, var_3.CameraFixMgr.ASPECT_RATIO_UPDATE, function()
...
function var_0_7.onAddShelter(arg_25_0, arg_25_1)
	...
	local var_25_5 = var_25_0.GetPosition(var_25_4)

	pg = var_25_4

	local var_25_6 = var_25_4.EffectMgr.GetInstance()

	var_6.PlayBattleEffect(var_25_6, var_25_2, var_25_5:Add(var_25_3), true)

	if var_25_0:GetIFF() == var_0_4.FOE_CODE then
		local var_25_7 = var_25_2.transform.localEulerAngles

		var_25_7.y = 180
		var_6.localEulerAngles = var_25_7
	end
...
function var_0_7.onAntiAirArea(arg_27_0, arg_27_1)
	if arg_27_1.Data.isShow ~= nil then
		...
		if var_2 == true then
			...
			Vector3 = var_5
			var_27_4.localScale = var_5(var_27_3, 0, var_27_3)
		end
	end
...
function var_0_7.onAntiAirOverload(arg_28_0, arg_28_1)
	...
	local var_28_4 = var_28_3(var_28_2, var_5(var_1_10006))
...
function var_0_7.updateSonarView(arg_30_0)
	...
	var_30_4 = var_2.GetCurrentState(var_30_3) ~= var_0.Battle.BattleFleetStaticSonar.STATE_DISABLE and var_1
	...
	if var_30_4 then
		...
		Vector3 = var_6
		var_30_9.localScale = var_6(var_30_8, 0, var_30_8)
	end
...
function var_0_7.onSonarScan(arg_31_0, arg_31_1)
	if arg_31_1.Data.indieSonar then
		...
		Vector3 = var_5
		var_31_1.localScale = var_5(100, 0, 100)
		SetActive = var_5

		var_5(var_31_1:Find("static"), false)

		local var_31_2 = var_31_1:Find("Quad")
		local var_31_3 = var_5.GetComponent

		typeof = var_8
		Animator = var_1_10009

		local var_31_4 = var_31_3(var_31_2, var_8(var_1_10009))

		var_31_4.enabled = true

		var_31_4:Play("antiSubZoom", -1, 0)

		arg_31_0._anitSubAreaTFList[var_31_1] = true

		local var_31_5 = var_5:GetComponent("DftAniEvent")

		var_7.SetEndEvent(var_31_5, function(arg_32_0)
	...
	elseif arg_31_0._antiSubScanAnima and arg_31_0._sonarActive then
		...
		local var_31_6 = arg_31_0._antiSubScanAnima

		var_3.Play(var_31_6, "antiSubZoom", -1, 0)
	end
...
function var_0_7.AddCameraFX(arg_39_0, arg_39_1, arg_39_2, arg_39_3, arg_39_4)
	...
	Vector3 = var_8
	var_39_4.localScale = var_8(arg_39_4 / var_39_3.x, arg_39_4 / var_39_3.y, arg_39_4 / var_39_3.z)
	pg = var_39_4
...
function var_0_7.Pause(arg_44_0)
	...
	for iter_44_0, iter_44_1 in var_1(arg_44_0._areaList) do
		...
		local var_44_2 = var_44_1(var_44_0, var_1_10008(var_1_10009))
	...
	for iter_44_4, iter_44_5 in var_1(arg_44_0._arcEffectList) do
		...
		local var_44_7 = var_44_6(var_44_5, var_1_10008(var_1_10009))
		local var_44_8 = var_6.ToTable(var_44_7)

		ipairs = var_44_7

		for iter_44_6, iter_44_7 in var_44_7(var_44_8) do
			iter_44_7:Pause()
		end
	end
	...
	for iter_44_8, iter_44_9 in var_1(arg_44_0._particleBulletList) do
		...
		local var_44_11 = var_44_10(var_44_9, var_1_10008(var_1_10009))
		local var_44_12 = var_6.ToTable(var_44_11)

		ipairs = var_44_11

		for iter_44_10, iter_44_11 in var_44_11(var_44_12) do
			iter_44_11:Pause()
		end
	end
...
function var_0_7.Resume(arg_45_0)
	...
	for iter_45_0, iter_45_1 in var_1(arg_45_0._areaList) do
		...
		local var_45_2 = var_45_1(var_45_0, var_1_10008(var_1_10009))
	...
	for iter_45_4, iter_45_5 in var_1(arg_45_0._arcEffectList) do
		...
		local var_45_7 = var_45_6(var_45_5, var_1_10008(var_1_10009))
		local var_45_8 = var_6.ToTable(var_45_7)

		ipairs = var_45_7

		for iter_45_6, iter_45_7 in var_45_7(var_45_8) do
			iter_45_7:Pause()
		end
	end
	...
	for iter_45_8, iter_45_9 in var_1(arg_45_0._particleBulletList) do
		...
		local var_45_11 = var_45_10(var_45_9, var_1_10008(var_1_10009))
		local var_45_12 = var_6.ToTable(var_45_11)

		ipairs = var_45_11

		for iter_45_10, iter_45_11 in var_45_11(var_45_12) do
			iter_45_11:Pause()
		end
	end
...
function var_0_7.UpdateFlagShipMark(arg_48_0)
	...
	local var_48_3 = var_48_1(var_48_0, var_3.GetPos(var_48_2))
...
function var_0_7.UpdateAimBiasArea(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10001(arg_50_0._aimBiasTFList) do
		...
		local var_50_4 = iter_50_0

		if iter_50_0.GetCurrentState(var_50_4) ~= var_50_2 then
			setActive = var_50_4

			var_50_4(var_50_0:Find("suofang/Quad"), var_10 ~= iter_50_0.STATE_SKILL_EXPOSE)
		end
...
function var_0_7.updateCardAim(arg_51_0)
	...
	for iter_51_8, iter_51_9 in var_2(arg_51_0._cardAimTargetList) do
		if not var_51_0[iter_51_8] then
			...
			var_51_3(var_1_10008(iter_51_9))
...
function var_0_7.AddBullet(arg_52_0, arg_52_1)
	...
	if arg_52_1:GetGO() then
		...
		if var_52_2(var_52_1, var_1_10006(var_1_10007)) then
...
function var_0_7.EnablePopContainer(arg_55_0, arg_55_1, arg_55_2)
	...
	local var_55_1 = var_4.GetUI(var_55_0)._tf

	var_1_10003(var_4.Find(var_55_1, arg_55_1), arg_55_2)
...
function var_0_7.AddPlayerCharacter(arg_56_0, arg_56_1)
	...
	SYSTEM_DUEL = var_56_2

	if var_56_1 == var_56_2 then
		goto label_56_0
	end

	SYSTEM_SUBMARINE_RUN = var_56_2

	if var_56_1 ~= var_56_2 then
		SYSTEM_SUB_ROUTINE = var_56_2
...
function var_0_7.InstantiateCharacterComponent(arg_59_0, arg_59_1)
	...
	return var_59_1(var_59_2, var_59_2.parent).gameObject
end
...
function var_0_7.AddArea(arg_66_0, arg_66_1, arg_66_2)
	...
	local var_66_2 = var_66_0.effect_offset[arg_66_2]
...
function var_0_7.AddEffect(arg_68_0, arg_68_1, arg_68_2, arg_68_3)
	...
	Vector3 = var_6
	var_68_2.localScale = var_6(arg_68_3, 1, arg_68_3)
	pg = var_68_2
...
function var_0_7.AllBulletNeutralize(arg_73_0)
	...
	for iter_73_2, iter_73_3 in var_73_0(arg_73_0._bulletList) do
		var_73_1 = var_73_1 + 1
...
function var_0_7.Clear(arg_74_0)
	...
	for iter_74_0, iter_74_1 in var_1_10001(arg_74_0._characterList) do
		var_1_10007 = iter_74_1
		var_1_10007 = iter_74_1.GetFactory(var_1_10007)

		var_6.RemoveCharacter(var_1_10007, iter_74_1)
	end

	pairs = var_1

	for iter_74_2, iter_74_3 in var_1(arg_74_0._aircraftList) do
		var_1_10007 = iter_74_3
		var_1_10007 = iter_74_3.GetFactory(var_1_10007)

		var_6.RemoveCharacter(var_1_10007, iter_74_3)
	end
	...
	for iter_74_4, iter_74_5 in var_1(arg_74_0._bulletList) do
		var_1_10007 = arg_74_0

		arg_74_0.RemoveBullet(var_1_10007, iter_74_4)
	end

	local var_74_0 = var_0.Battle.BattleBulletFactory.GetFactoryList()

	pairs = var_2

	for iter_74_6, iter_74_7 in var_2(var_74_0) do
		var_1_10008 = iter_74_7

		iter_74_7.Clear(var_1_10008)
	end

	local var_74_1 = arg_74_0._fxPool

	var_2.Clear(var_74_1)

	pairs = var_2

	for iter_74_8, iter_74_9 in var_2(arg_74_0._areaList) do
		var_1_10008 = arg_74_0

		arg_74_0.RemoveArea(var_1_10008, iter_74_8)
	end
	...
	for iter_74_10, iter_74_11 in var_2(arg_74_0._arcEffectList) do
		var_1_10008 = iter_74_11

		iter_74_11.Dispose(var_1_10008)
	end
	...
	for iter_74_12, iter_74_13 in var_2(arg_74_0._cardAimTargetList) do
		...
		var_1_10007(var_1_10008(iter_74_13))
	end

	arg_74_0._cardAimTargetList = nil

	local var_74_2 = var_0.Battle.BattleCharacterFXContainersPool.GetInstance()

	var_2.Clear(var_74_2)

	local var_74_3 = arg_74_0._popNumMgr

	var_2.Clear(var_74_3)

	local var_74_4 = var_0.Battle.BattleHPBarManager.GetInstance()

	var_2.Clear(var_74_4)

	local var_74_5 = var_0.Battle.BattleArrowManager.GetInstance()
