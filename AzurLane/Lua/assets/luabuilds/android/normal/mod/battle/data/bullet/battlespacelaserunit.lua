...
function var_0_3.DoTrack(arg_7_0)
	...
	local var_7_12 = var_7_10.cos(var_1._cosAngularSpeed * var_7_11)

	math = var_10

	local var_7_13 = var_10.sin(var_1._sinAngularSpeed * var_7_11)
	...
	math = var_7_22
	arg_7_0._yAngle = var_7_23 * var_7_22.atan2(var_7_16, var_7_17)
...
function var_0_3.InitSpeed(arg_8_0, ...)
	...
	if arg_8_0:IsTracker() then
		...
		local var_8_1 = var_3.cos(var_8_0)
		local var_8_2 = 0

		math = var_1_10005
		arg_8_0._speedNormal = var_2(var_8_1, var_8_2, var_1_10005.sin(var_8_0))
...
function var_0_3.Update(arg_12_0, arg_12_1)
	...
	for iter_12_0, iter_12_1 in var_12_0(arg_12_0._collidedTimes) do
