...
function var_0_0.HandleBulletHit(arg_6_0, arg_6_1, arg_6_2)
	...
	var_6_3(var_6_2, var_8.Battle.BattleConst.BuffEffectType.ON_BULLET_COLLIDE, var_6_0)
	...
	if arg_6_2:GetUnitType() == var_0_3.UnitType.PLAYER_UNIT and arg_6_2:GetIFF() == var_0_4.FRIENDLY_CODE and not arg_6_1:IsSpectreBullet() then
		...
		var_6_5(var_6_4, var_8.shake_template[var_0_3.ShakeType.HIT])
	end
...
function var_0_0.HandleDamage(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	if arg_7_2:GetIFF() == var_0_4.FOE_CODE and arg_7_2:IsShowHPBar() then
		...
		var_7_1(var_7_0, var_1_10008.Event.New(var_0_1.HIT_ENEMY, arg_7_2))
	end
	...
	if not var_7_10 and arg_7_1:GetWeaponTempData().type ~= var_0_3.EquipmentType.ANTI_AIR then
		...
		var_7_21(var_7_20, var_26.Battle.BattleConst.BuffEffectType.ON_BULLET_HIT, var_7_15)

		if arg_7_1:GetHost() and var_7_27:IsAlive() then
			local var_7_22 = var_7_27
			local var_7_23 = var_7_27.GetUnitType(var_7_22)
			...
			if var_7_23 ~= var_7_22.Battle.BattleConst.UnitType.AIRFIGHTER_UNIT then
				...
				local var_7_24 = var_7_23.contains
				local var_7_25 = var_0_3.AircraftUnitType

				var_7_26 = var_7_27

				local var_7_27

				if var_7_24(var_7_25, var_7_27.GetUnitType(var_7_26)) then
					var_7_27 = var_7_27:GetMotherUnit()
				end

				local var_7_28 = var_7_27
				local var_7_29 = var_7_27.GetIFF(var_7_28)

				pairs = var_7_28

				for iter_7_0, iter_7_1 in var_7_28(arg_7_0._unitList) do
					if iter_7_1:GetIFF() == var_7_29 and iter_7_1 ~= var_7_27 then
						local var_7_30 = iter_7_1
						local var_7_31 = iter_7_1.TriggerBuff

						ys = var_1_10033

						var_7_31(var_7_30, var_1_10033.Battle.BattleConst.BuffEffectType.ON_TEAMMATE_BULLET_HIT, var_7_15)
					end
				end
			end
		end
	...
	local var_7_32 = arg_7_2:GetUnitType()
	local var_7_33 = true

	if var_7_32 ~= var_0_3.UnitType.AIRCRAFT_UNIT and var_7_32 ~= var_0_3.UnitType.AIRFIGHTER_UNIT and var_7_32 ~= var_0_3.UnitType.FUNNEL_UNIT and var_7_32 ~= var_0_3.UnitType.UAV_UNIT then
		var_7_33 = false
	end

	if arg_7_2:IsAlive() then
		if not var_7_33 then
			ipairs = var_26
			var_7_26 = arg_7_1

			for iter_7_2, iter_7_3 in var_26(arg_7_1.GetAttachBuff(var_7_26)) do
		...
		local var_7_34 = arg_7_1
		local var_7_35 = arg_7_1.BuffTrigger

		ys = var_7_26

		var_7_35(var_7_34, var_7_26.Battle.BattleConst.BuffEffectType.ON_BULLET_KILL, {
			unit = arg_7_2,
			killer = arg_7_1
		})
		arg_7_0:obituary(arg_7_2, var_7_33, arg_7_1)
...
function var_0_0.HandleMeteoDamage(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in var_4(arg_8_2) do
...
function var_0_0.HandleAircraftMissDamage(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = arg_11_2.GetCloakList(var_11_0)
	...
	local var_11_2 = arg_11_1:GetPosition()
	local var_11_3 = arg_11_2
	local var_11_4 = arg_11_2.NearestUnitByType
	local var_11_5 = var_11_2

	ShipType = iter_11_1

	if var_11_4(var_11_3, var_11_5, iter_11_1.CloakShipTypeList) then
	...
	if arg_11_2:RandomMainVictim({
		...
		local var_11_6 = arg_11_0._calculateDamageKamikazeAir(arg_11_1, var_6)

		var_6:TriggerBuff(var_0_3.BuffEffectType.ON_BE_HIT, {})
		arg_11_0:HandleDirectDamage(var_6, var_11_6, arg_11_1)
	end
...
function var_0_0.HandleShipMissDamage(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = arg_12_2.GetCloakList(var_12_0)
	...
	local var_12_4 = arg_12_2.NearestUnitByType
	local var_12_5 = var_12_2

	ShipType = iter_12_1

	if var_12_4(var_12_3, var_12_5, iter_12_1.CloakShipTypeList) then
		var_5:CloakExpose(arg_12_0._shipExposeEX)
	end

	if arg_12_2:RandomMainVictim({
		"immuneDirectHit"
	}) then
		local var_12_6 = arg_12_1
		local var_12_7 = arg_12_1.GetTemplate(var_12_6).type

		table = var_12_6

		local var_12_8 = var_12_6.contains

		ShipType = var_1_10009

		if var_12_8(var_1_10009.SubShipType, var_12_7) then
			...
			if var_6:IsAlive() and var_0_2.RollSubmarineDualDice(arg_12_1) then
				local var_12_10 = var_0_2.CalculateDamageFromSubmarinToMainShip(arg_12_1, var_6)

				var_6:TriggerBuff(var_0_3.BuffEffectType.ON_BE_HIT, {})
				arg_12_0:HandleDirectDamage(var_6, var_12_10, arg_12_1)
			end
		else
			local var_12_11 = arg_12_0._calculateDamageKamikazeShip(arg_12_1, var_6)

			var_6:TriggerBuff(var_0_3.BuffEffectType.ON_BE_HIT, {})
			arg_12_0:HandleDirectDamage(var_6, var_12_11, arg_12_1)
		end
	end
...
function var_0_0.HandleBuffPlacer(arg_14_0, arg_14_1, arg_14_2)
	...
	if var_14_1 then
		...
		if not arg_14_0.buff_level then
			var_14_3 = arg_14_0.level
		end

		ys = var_1_10007

		local var_14_4 = var_1_10007.Battle.BattleBuffUnit.New(arg_14_0.buff_id, var_14_3, arg_14_1)

		var_7.SetGroupLevel(var_14_4, arg_14_0.group_level)
...
function var_0_0.HandleShipCrashDamageList(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_1 = arg_16_1.GetHostileCldList(var_16_0)
	...
	for iter_16_0, iter_16_1 in var_16_0(var_16_1) do
		...
		if not var_1_10009.contains(arg_16_2, iter_16_0) then
			var_1_10010 = arg_16_1

			arg_16_1.RemoveHostileCld(var_1_10010, iter_16_0)
		end
	end
	...
	for iter_16_2, iter_16_3 in var_4(arg_16_2) do
		if var_16_1[iter_16_3] == nil then
			local var_16_2
			...
			local var_16_4 = var_1_10010.TimeMgr.GetInstance()

			var_1_10010 = var_1_10010.AddBattleTimer(var_16_4, "shipCld", nil, var_0_4.SHIP_CLD_INTERVAL, var_16_3, true)
...
function var_0_0.HandleWallDamage(arg_21_0, arg_21_1, arg_21_2)
	if arg_21_2:GetIFF() == var_0_4.FOE_CODE and arg_21_2:IsShowHPBar() then
		...
		var_21_1(var_21_0, var_1_10006.Event.New(var_0_1.HIT_ENEMY, arg_21_2))
	end
