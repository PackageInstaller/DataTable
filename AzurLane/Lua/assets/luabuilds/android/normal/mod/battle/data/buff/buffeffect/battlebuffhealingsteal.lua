...
function var_0_2.onTakeHealing(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_2:GetCaster() and var_5:IsAlive() and var_5 ~= arg_3_1 then
		...
		local var_3_1 = var_5:GetAttrByName("healingRate")
		local var_3_2 = var_6 * arg_3_0._absorbRate

		math = var_9

		local var_3_3 = var_9.ceil(var_3_1 * var_3_2)
		local var_3_4 = {
			isMiss = false,
			isCri = false,
			isShare = false,
		...
		var_5:UpdateHP(var_3_3, var_3_4)
	end
