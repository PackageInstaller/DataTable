...
function var_0_1.GetDirection(arg_3_0, arg_3_1)
	...
	local var_3_6 = var_2
	local var_3_7 = var_2.GetPosition(var_3_6)

	Vector3 = var_3_6

	local var_3_8 = var_3_6(var_3_7.x + arg_3_0._distX, arg_3_1.y, var_3_7.z + arg_3_0._distZ) - arg_3_1

	if arg_3_0:IsExpired() then
		arg_3_0:Finish()
	end

	if var_3_8.magnitude < 0.4 then
		Vector3 = var_6
