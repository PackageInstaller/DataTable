...
ys = var_1
var_1.Battle.BattleGateActBoss = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_6 = var_1_4.activity_event_worldboss[var_1_5]
	...
	local var_1_8 = var_1_10009(var_1_10010)

	getProxy = var_1_10010
	FleetProxy = var_1_10011

	local var_1_9 = var_1_10010(var_1_10011)
	...
	local var_1_19 = var_1_9:getActivityFleets()[var_1_2][var_1_18]
	local var_1_20 = var_1_8
	local var_1_21 = var_1_8.getSortShipsByFleet(var_1_20, var_1_19)

	ipairs = var_1_20

	for iter_1_0, iter_1_1 in var_1_20(var_1_21) do
		var_1_12[#var_1_12 + 1] = iter_1_1.id
	end

	local var_1_22 = var_1_19:getStartCost().oil
	local var_1_23 = var_1_19:GetCostSum().oil
	local var_1_24 = var_1_6.use_oil_limit[var_1_18]

	if var_5:IsOilLimit(var_1_17) and var_1_24[1] > 0 then
		math = var_26
		var_1_23 = var_26.min(var_1_23, var_1_24[1])
	end

	local var_1_25 = var_1_7
	local var_1_26 = var_1_7.getData(var_1_25)

	if var_1_11 and var_1_26.oil < var_1_23 then
		pg = var_1_25
		var_1_10028 = var_1_25.TipsMgr.GetInstance()
		var_1_25 = var_1_25.ShowTips
		i18n = var_1_10029

		var_1_25(var_1_10028, var_1_10029("stage_beginStage_error_noResource"))
	...
	local var_1_27 = var_1_25.expedition_data_template[var_1_17].dungeon_id

	ys = var_1_10028

	local var_1_28 = var_1_10028.Battle.BattleDataFunction.GetDungeonTmpDataByID(var_1_27).fleet_prefab

	arg_1_1.ShipVertify()

	local function var_1_29(arg_2_0)
		if var_1_11 then
			local var_2_0 = var_1_26
		...
		var_1.updatePlayer(var_2_4, var_1_26)

		local var_2_5 = {
			mainFleetId = var_1_18,
			actId = var_1_2,
			prefabFleet = var_1_28,
			stageId = var_1_17
		}
	...
	local var_1_31 = var_1_10031.SendRequest

	SYSTEM_ACT_BOSS = var_1_10032

	var_1_31(var_1_10032, var_1_12, {
		var_1_17
	}, var_1_29, var_1_30)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local var_4_8 = var_4_6.activity_event_worldboss[var_4_7].use_oil_limit[arg_4_0.mainFleetId]
	...
	local function var_4_23(arg_6_0)
		...
		var_6_6(var_6, var_6_4, var_4_12, arg_6_0.player_exp)
		...
		if var_6_4 then
			var_6_7 = (function()
				...
				local var_7_0 = var_3_10000(var_3_10001)
		...
		if var_7.CanDropItem(var_6_1) then
			...
			ContinuousOperationMediator = var_10

			if var_6_13(var_6_12, var_10) then
				getProxy = var_8
...
function var_0_0.GetPreloadList(arg_8_0)
	...
	local var_8_4 = var_1_10005(var_1_10006)
	...
	if var_8_4:getActivityFleets()[arg_8_0.actId][arg_8_0.mainFleetId] then
		...
		for iter_8_0, iter_8_1 in var_1_10010(var_8_6) do
			table = var_1_10015
	...
	if var_7[arg_8_0.mainFleetId + 10] then
		...
		local var_8_10 = var_8_9(var_8_8, var_1_10012.Submarine)

		ipairs = var_8_8

		for iter_8_4, iter_8_5 in var_8_8(var_8_10) do
			table = var_1_10016
