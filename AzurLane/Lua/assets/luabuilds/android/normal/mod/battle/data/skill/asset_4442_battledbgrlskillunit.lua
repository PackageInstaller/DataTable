...
function var_0_4.Cast(arg_4_0, arg_4_1, arg_4_2)
	...
	if arg_4_0._tempData.painting == 1 then
		if arg_4_2 then
			...
			var_1_10007 = var_1_10007.getConfig(var_4_4, "name")
			var_1_10009 = arg_4_2

			var_4_3(var_4_2, var_1_10007, arg_4_2.getPainting(var_1_10009))
		else
	...
	if var_4_3(arg_4_0._tempData.castCV) == "string" then
		...
		arg_4_1.DispatchVoice(var_1_10007, arg_4_0._tempData.castCV)
	elseif var_5 == "table" then
		ShipWordHelper = var_6

		local var_4_5, var_4_6

		var_4_5, var_1_10007, var_4_6 = var_6.GetWordAndCV(arg_4_0._tempData.castCV.skinID, arg_4_0._tempData.castCV.key)
		pg = var_1_10009

		local var_4_7 = var_1_10009.CriMgr.GetInstance()

		var_9.PlaySoundEffect_V3(var_4_7, var_1_10007)
	end

	local var_4_8 = arg_4_0._attachData

	ipairs = var_1_10007

	for iter_4_0, iter_4_1 in var_1_10007(arg_4_0._effectList) do
		arg_4_0._lastEffectTarget = iter_4_1:GetTarget(arg_4_1, arg_4_0)

		iter_4_1:SetCommander(arg_4_2)
		iter_4_1:Effect(arg_4_1, var_12, var_4_8)
	end
...
function var_0_4.IsFireSkill(arg_9_0, arg_9_1)
	...
	for iter_9_0, iter_9_1 in var_4(var_9_1.effect_list) do
