...
function var_0_2.RefreshScaleRate(arg_4_0)
	...
	Vector3 = var_1_10005
	arg_4_0._xScale = var_4_0 / var_4_3(var_4_2, var_1_10005(var_4_0, var_4_1, 0)).x
...
function var_0_2.init(arg_6_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_6_0._resourceText = var_6_3(var_6_2, var_3(var_1_10004))
...
function var_0_2.pop(arg_7_0, arg_7_1)
	...
	if #arg_7_1 == 0 then
		if arg_7_1 == arg_7_0._resourcePool then
			...
			local var_7_3 = var_1_10005.zero

			Quaternion = var_1_10006
			var_7_0 = var_7_1(var_7_2, var_7_3, var_1_10006.identity)
...
function var_0_2.push(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_3 = var_8_2(var_8_1, var_5(var_6))
...
function var_0_2.ShowDrop(arg_10_0, arg_10_1)
	...
	local var_10_2 = var_10_0(var_3.Clone(var_10_1))
...
function var_0_2.makeFloatAnima(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4, arg_12_5, arg_12_6, arg_12_7, arg_12_8, arg_12_9)
	local var_12_0 = arg_12_0:pop(arg_12_2).transform

	SetActive = var_12

	var_12(var_10, true)

	var_12_0.position = arg_12_1
	var_12_0.localPosition = var_12_0.localPosition - arg_12_0._containerTF.localPosition

	arg_12_0:Update()

	local var_12_1 = var_12_0

	var_12_0.SetParent(var_12_1, arg_12_0._container, false)

	math = var_12

	local var_12_2 = var_12.random() * 200 - 100

	math = var_12_1

	local var_12_3 = var_12_1.random() * 200

	LeanTween = var_14

	local var_12_4 = var_14.moveX

	rtf = var_15

	local var_12_5 = var_12_4(var_15(var_10), var_12_0.anchoredPosition.x + var_12_2, var_0_1.RESOURCE_STAY_DURATION + arg_12_9 * 0.05)
	local var_12_6 = var_14.setOnComplete

	System = var_16

	var_12_6(var_12_5, var_16.Action(function()
		...
		local var_13_1 = var_2_10001(var_0)

		Vector3 = var_2

		var_13_0(var_13_1, var_2(0.2, 0.2, 1), var_0_2.FLOAT_DURATION)

		Vector3 = var_13_0

		local var_13_2 = var_13_0(arg_12_3 - var_12_0.position.x, arg_12_4 - var_12_0.position.y, 0)

		var_12_0.localPosition = var_12_0.localPosition + arg_12_0._containerTF.localPosition

		local var_13_3 = var_12_0
		...
		var_13_6(var_13_5, var_3.Action(function()
			...
			Vector3 = var_14_0
			var_14_1.localScale = var_14_0(0.35, 0.35, 0.35)
			...
			local var_14_5 = var_14_3(var_14_4, var_2(0.5, 0.5, 0.5), 0.12)
			local var_14_6 = var_0.setEase

			LeanTweenType = var_2

			local var_14_7 = var_14_6(var_14_5, var_2.easeOutExpo)
			local var_14_8 = var_0.setOnComplete

			System = var_2

			var_14_8(var_14_7, var_2.Action(function()
				...
				local var_15_1 = var_4_10001(arg_12_5)

				Vector3 = var_2

				var_15_0(var_15_1, var_2(0.35, 0.35, 0.35), 0.3)
	...
	local var_12_7 = var_12_3 / 200

	LeanTween = var_12_5

	local var_12_8 = var_12_5.moveY

	rtf = var_16

	local var_12_9 = var_12_8(var_16(var_10), var_12_0.anchoredPosition.y + var_12_3, 0.5 * var_12_7)
	local var_12_10 = var_15.setOnComplete

	System = var_17

	var_12_10(var_12_9, var_17.Action(function()
		...
		local var_16_3 = var_16_2(var_1(var_0), var_12_0.anchoredPosition.y - var_12_3, 1.5 * var_12_7)
		local var_16_4 = var_0.setEase

		LeanTweenType = var_2

		var_16_4(var_16_3, var_2.easeOutBounce)
...
function var_0_2.Dispose(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10001(arg_17_0._timerList) do
		if iter_17_1 then
			pg = var_1_10006
			var_1_10007 = var_1_10006.TimeMgr.GetInstance()

			var_1_10006.RemoveBattleTimer(var_1_10007, iter_17_0)
		end
	end
	...
	for iter_17_2, iter_17_3 in var_1(arg_17_0._resourceList) do
		...
		var_1_10006(var_1_10007(iter_17_3))
	end
