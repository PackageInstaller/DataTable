...
function var_0_3.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._animator = var_1_1(var_1_0, var_6(var_1_10007))
	...
	if var_4.Find(var_1_2, "text") then
		...
		typeof = var_1_10007
		Text = var_1_10008
		arg_1_0.textCom = var_1_4(var_1_3, var_1_10007(var_1_10008))
	end
	...
	local var_1_7 = var_1_6(var_1_5, var_1_10007(var_1_10008))
