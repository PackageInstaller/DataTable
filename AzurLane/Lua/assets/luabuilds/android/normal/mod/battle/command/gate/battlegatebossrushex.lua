...
ys = var_1
var_1.Battle.BattleGateBossRushEX = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	local var_1_10 = var_1_10012(var_1_10013)
	...
	local var_1_22 = var_1_3.getSortShipsByFleet(var_1_21, var_1_18)

	ipairs = var_1_21

	for iter_1_0, iter_1_1 in var_1_21(var_1_22) do
		var_1_20[#var_1_20 + 1] = iter_1_1.id
	end

	local var_1_23 = var_1_1:getRawData()

	if var_1_5 and var_1_23.oil < var_1_9 then
		pg = var_25

		local var_1_24 = var_25.TipsMgr.GetInstance()
		local var_1_25 = var_25.ShowTips

		i18n = iter_1_0

		var_1_25(var_1_24, iter_1_0("stage_beginStage_error_noResource"))
	...
	local function var_1_26(arg_2_0)
		...
		if 0 < var_2_1 then
			...
			for iter_2_0, iter_2_1 in var_2(var_1_22) do
		...
		var_1.updatePlayer(var_2_4, var_1_23)
	...
	local var_1_28 = iter_1_0.SendRequest

	SYSTEM_BOSS_RUSH_EX = iter_1_1

	var_1_28(iter_1_1, var_1_20, {
		var_1_14
	}, var_1_26, var_1_27)
