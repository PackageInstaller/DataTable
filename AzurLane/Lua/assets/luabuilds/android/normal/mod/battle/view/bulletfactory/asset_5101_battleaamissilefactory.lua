...
function var_0_5.onBulletHitFunc(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_12 = arg_2_0.GetTf(var_2_11).localPosition

	pg = var_2_11

	local var_2_13 = var_2_11.EffectMgr.GetInstance()

	var_11.PlayBattleEffect(var_2_13, var_2_9, var_2_10:Add(var_2_12), true)

	local var_2_14, var_2_15 = var_2_2:HandleDamage(var_3, var_2_3)
...
function var_0_5.MakeModel(arg_4_0, arg_4_1, arg_4_2)
	...
	if not var_6.InstBullet(var_4_3, arg_4_1:GetModleID(), function(arg_5_0)
		...
		var_4_5(var_4_4, var_9.GetObject(var_4_6))
	end
	...
	if var_3:GetIFF() ~= var_4_2:GetFriendlyCode() and var_4_1.alert_fx ~= "" then
		...
		var_4_9(var_4_8, var_9.GetFX(var_4_10, var_4_1.alert_fx))
	end
