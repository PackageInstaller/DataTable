...
function var_0_5.CreateEmitter(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	local function var_2_4(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
		...
		var_3_5(var_3_4, var_3_6, var_11.GetBaseAngle(var_3_7), arg_3_2)
	...
	local function var_2_5(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
		...
		var_5_2:RegisterLifeEndCB(function()
			...
			local var_6_2 = var_1.GetPosition(var_6_1)

			Vector3 = var_6_1
			var_2_0 = var_6_0(var_6_2 - var_6_1(arg_5_0, 0, arg_5_1))
		...
		if var_5_2.GetTemplate(var_5_3).alert_fx and #var_8 > 0 then
		...
		var_5_5(var_5_4, var_5_6, var_13.GetBaseAngle(var_5_7), arg_5_2)
