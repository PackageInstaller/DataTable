...
function var_0_1.MakeModel(arg_3_0, arg_3_1)
	...
	local function var_3_1(arg_4_0)
		...
		for iter_4_0, iter_4_1 in var_4_16(var_4_17) do
...
function var_0_1.MakeBloodBar(arg_8_0, arg_8_1)
	...
	local var_8_4 = var_8_2(var_8_1, "type")
	local var_8_7

	if var_8_3 ~= 0 then
		GetSpriteFromAtlas = var_8_7

		local var_8_5 = "shiptype"

		shipType2print = var_1_10007

		local var_8_6 = arg_8_1:GetUnitData()

		var_8_7 = var_8_7(var_8_5, var_1_10007(var_8.GetTemplate(var_8_6).icon_type))
		setImageSprite = var_8_5

		var_8_5(var_8_4, var_8_7, true)

		findTF = var_8_5

		local var_8_8 = var_8_5(var_8_4, "type")

		setImageSprite = var_7

		var_7(var_8_8, var_8_7, true)
...
function var_0_1.RemoveCharacter(arg_11_0, arg_11_1)
	...
	var_11_1(var_11_0, var_1_10004.shake_template[var_0.Battle.BattleConst.ShakeType.UNIT_DIE])
