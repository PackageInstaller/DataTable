...
function var_0_9.createMajorEmitter(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5)
	local function var_7_0(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
		...
		if arg_7_0._tmpData.aim_type == var_0_1.WeaponAimType.AIM and arg_8_4 ~= nil then
			...
			var_8_4(var_8_3, var_8_5, var_10.GetBaseAngle(var_8_6), arg_8_2)
		else
			local var_8_7 = var_6
			...
			var_8_8(var_8_7, var_8_9, var_10.GetBaseAngle(var_8_10), arg_8_2)
		end
...
function var_0_9.cacheSectorData(arg_11_0)
	...
	local var_11_1 = arg_11_0.GetAttackAngle(var_11_0) / 2

	math = var_11_0
	arg_11_0._upperEdge = var_11_0.deg2Rad * var_11_1
	arg_11_0._lowerEdge = -1 * arg_11_0._upperEdge
	math = var_2

	local var_11_2 = var_2.deg2Rad * arg_11_0._tmpData.axis_angle

	if arg_11_0:GetDirection() == var_0_1.UnitDir.LEFT then
		math = var_3
		arg_11_0._normalizeOffset = var_3.pi - var_11_2
	elseif arg_11_0:GetDirection() == var_0_1.UnitDir.RIGHT then
		arg_11_0._normalizeOffset = var_11_2
	end
	...
	math = var_4
	arg_11_0._wholeCircleNormalizeOffset = var_11_3 - var_4.pi * 2

	local var_11_4 = arg_11_0._normalizeOffset

	math = var_4
	arg_11_0._negativeCircleNormalizeOffset = var_11_4 + var_4.pi * 2
...
function var_0_9.CheckReloadTimeStamp(arg_34_0)
	...
	if arg_34_0._CDstartTime then
		...
		var_34_1 = arg_34_0.GetReloadFinishTimeStamp(var_34_0)
		pg = var_34_0

		local var_34_2 = var_34_0.TimeMgr.GetInstance()

		var_34_1 = var_34_1 <= var_2.GetCombatTime(var_34_2)
	end
...
function var_0_9.UpdateReload(arg_35_0)
	if arg_35_0._CDstartTime and not arg_35_0._jammingStartTime then
		...
		local var_35_1 = arg_35_0.GetReloadFinishTimeStamp(var_35_0)

		pg = var_35_0

		local var_35_2 = var_35_0.TimeMgr.GetInstance()

		if var_35_1 <= var_2.GetCombatTime(var_35_2) then
...
function var_0_9.ChangeDiveState(arg_37_0)
	...
	if var_1.GetOxyState(var_37_0) then
		...
		for iter_37_0, iter_37_1 in var_37_2(arg_37_0._oxyList) do
			table = var_1_10007
...
function var_0_9.Tracking(arg_39_0)
	...
	if var_39_0 then
		if var_0_9.TrackingFunc[var_39_0] then
			var_39_1 = var_4(arg_39_0, var_39_2)
		else
	...
	if var_39_1 and var_0_7.GetCurrentGuardianID(var_39_1) then
		...
		for iter_39_0, iter_39_1 in var_5(var_39_2) do
...
function var_0_9.FilterTarget(arg_50_0)
	...
	for iter_50_0, iter_50_1 in var_1_10005(var_50_0) do
		...
		if var_0_7.IsCloak(iter_50_1) then
			...
			if not var_12.contains(var_50_3, var_50_4) then
				-- block empty
			else
				local var_50_5 = true
...
function var_0_9.IsOutOfAngle(arg_55_0, arg_55_1)
	...
	local var_55_1 = arg_55_1.GetPosition(var_55_0)

	math = var_55_0

	local var_55_2

	if var_55_0.atan2(var_55_1.z - arg_55_0._hostPos.z, var_55_1.x - arg_55_0._hostPos.x) > arg_55_0._wholeCircle then
	...
	for iter_67_0, iter_67_1 in var_67_1(arg_67_0._barrageList) do
		local function var_67_2(arg_68_0, arg_68_1, arg_68_2, arg_68_3)
			...
			if arg_67_1 ~= nil then
				...
				local var_68_7 = var_9.GetBeenAimedPosition(var_68_6)
				local var_68_8 = arg_67_0

				var_68_5(var_68_4, var_68_7, var_10.GetBaseAngle(var_68_8), arg_68_2)
			else
				...
				var_68_10(var_68_9, var_68_11, var_10.GetBaseAngle(var_68_12), arg_68_2)
			end
...
function var_0_9.DispatchBulletEvent(arg_101_0, arg_101_1, arg_101_2)
	...
	if var_6(var_101_1.spawn_bound) == "table" and not var_101_0 then
		...
		if var_6.GetStageInfo(var_101_3).mainUnitPosition and var_6[arg_101_0._hostIFF] then
			Clone = var_101_3
			var_101_0 = var_101_3(var_6[arg_101_0._hostIFF][var_101_1.spawn_bound[1]])
		else
			Clone = var_101_3
			var_101_0 = var_101_3(var_0_2.MAIN_UNIT_POS[arg_101_0._hostIFF][var_101_1.spawn_bound[1]])
		end
	end
...
function var_0_9.CheckAndShake(arg_103_0)
	if arg_103_0._tmpData.shakescreen ~= 0 then
		...
		var_103_1(var_103_0, var_1_10003.shake_template[arg_103_0._tmpData.shakescreen])
	end
...
function var_0_9.GetReloadRate(arg_131_0)
	...
	elseif arg_131_0._CDstartTime then
		...
		local var_131_1 = arg_131_0.GetReloadFinishTimeStamp(var_131_0)

		pg = var_131_0

		local var_131_2 = var_131_0.TimeMgr.GetInstance()

		return (var_131_1 - var_2.GetCombatTime(var_131_2)) / arg_131_0._reloadRequire
	else
		return 1
	end
