...
var_0_5(var_0_10003.Battle.BattleConfig.AMMO_DAMAGE_ENHANCE)

local var_0_6 = var_0_2.InsertInheritedAttr

ys = var_3

var_0_6(var_3.Battle.BattleConfig.AMMO_DAMAGE_REDUCE)

local var_0_7 = var_0_2.InsertInheritedAttr

ys = var_3

var_0_7(var_3.Battle.BattleConfig.DAMAGE_AMMO_TO_ARMOR_RATE_ENHANCE)

local var_0_8 = var_0_2.InsertInheritedAttr

ys = var_3

var_0_8(var_3.Battle.BattleConfig.DAMAGE_TO_ARMOR_RATE_ENHANCE)

local var_0_9 = var_0_2.InsertInheritedAttr

ys = var_3

var_0_9(var_3.Battle.BattleConfig.SHIP_TYPE_ACCURACY_ENHANCE)
...
function var_0_2.GetCurrentTargetSelect(arg_28_0)
	...
	local var_28_2 = var_3.Battle.BattleConfig.TARGET_SELECT_PRIORITY
...
function var_0_2.AddGuardianID(arg_32_0, arg_32_1)
	...
	if not var_3.contains(var_32_0, arg_32_1) then
		table = var_3
...
function var_0_2.RemoveGuardianID(arg_33_0, arg_33_1)
	...
	for iter_33_0, iter_33_1 in var_3(var_33_0) do
...
function var_0_2.SetPlayerAttrFromOutBattle(arg_34_0, arg_34_1, arg_34_2)
	...
	if arg_34_2 then
		...
		if not (var_34_5 + var_5.Battle.BattleConfig.CLOAK_EXPOSE_CONST) then
			var_34_6 = 0
		end
...
function var_0_2.AttrFixer(arg_35_0, arg_35_1)
	...
	if arg_35_0 == var_1_10002 then
		ys = var_1_10002
		var_1_10004 = var_1_10002.Battle.BattleDataProxy.GetInstance()
		arg_35_1.repressReduce = var_1_10002.GetRepressReduce(var_1_10004)
	...
	if arg_35_0 ~= var_1_10002 then
		...
		if arg_35_0 == var_1_10002 then
			...
			local var_35_2, var_35_3 = var_1_10004.Battle.BattleDataFunction.GetPlayerUnitDurabilityExtraAddition(arg_35_0, var_35_0)
...
function var_0_2.SetEnemyAttr(arg_37_0, arg_37_1)
	...
	var_37_2.battleUID = arg_37_0.GetUniqueID(var_37_3)
	var_37_2.level = var_37_1
	var_37_2.formulaLevel = var_37_1

	local var_37_4 = (var_37_1 - 1) / 1000

	math = var_37_3
	var_37_2.maxHP = var_37_3.ceil(var_37_0.durability + var_37_0.durability_growth * var_37_4)
	var_37_2.HPRate = 1
	var_37_2.DMGRate = 0
	var_37_2.cannonPower = var_37_0.cannon + var_37_0.cannon_growth * var_37_4
	var_37_2.torpedoPower = var_37_0.torpedo + var_37_0.torpedo_growth * var_37_4
	var_37_2.antiAirPower = var_37_0.antiaircraft + var_37_0.antiaircraft_growth * var_37_4
	var_37_2.airPower = var_37_0.air + var_37_0.air_growth * var_37_4
	var_37_2.antiSubPower = var_37_0.antisub + var_37_0.antisub_growth * var_37_4
	var_37_2.loadSpeed = var_37_0.reload + var_37_0.reload_growth * var_37_4
	var_37_2.armorType = var_37_0.armor_type
	var_37_2.attackRating = var_37_0.hit + var_37_0.hit_growth * var_37_4
	var_37_2.dodgeRate = var_37_0.dodge + var_37_0.dodge_growth * var_37_4
	ys = var_6
	var_37_2.velocity = var_6.Battle.BattleFormulas.ConvertShipSpeed(var_37_0.speed + var_37_0.speed_growth * var_37_4)
	var_37_2.baseVelocity = var_37_2.velocity
	var_37_2.luck = var_37_0.luck + var_37_0.luck_growth * var_37_4
	var_37_2.bulletSpeedRatio = 0

	local var_37_5 = "enemy_"

	tostring = var_7
	var_37_2.id = var_37_5 .. var_7(var_37_0.id)
...
function var_0_2.MonsterAttrFixer(arg_42_0, arg_42_1)
	...
	if arg_42_0 == var_1_10002 then
		...
		var_42_3(var_42_4, var_42_5, var_1_10008.max(1, var_42_2 - var_42_1))
	else
...
function var_0_2.SetAircraftAttFromMother(arg_43_0, arg_43_1)
	...
	if not var_3(arg_43_1._attr.id) ~= "string" then
		...
		for iter_43_0, iter_43_1 in var_4(var_0_2.AttrListInheritance) do
...
function var_0_2.SetAirFighterAttr(arg_45_0, arg_45_1)
	...
	local var_45_3 = var_3

	if var_3.IsCompletelyRepress(var_45_3) then
		math = var_5
		var_45_0.formulaLevel = var_5.max(var_45_0.formulaLevel - 10, 1)
	end

	local var_45_4 = (var_45_2 - 1) / 1000

	math = var_45_3
	var_45_0.maxHP = var_45_3.floor(arg_45_1.max_hp + arg_45_1.hp_growth * var_45_4)
	var_45_0.attackRating = arg_45_1.accuracy + arg_45_1.ACC_growth * var_45_4

	local var_45_5 = arg_45_1.attack_power + arg_45_1.AP_growth * var_45_4

	var_45_0.dodge = arg_45_1.dodge
	var_45_0.dodgeLimit = arg_45_1.dodge_limit
	var_45_0.cannonPower = var_45_5
	var_45_0.torpedoPower = var_45_5
	var_45_0.antiAirPower = var_45_5
	var_45_0.antiSubPower = var_45_5
	var_45_0.airPower = var_45_5
...
function var_0_2.SetFusionAttrFromElement(arg_46_0, arg_46_1, arg_46_2, arg_46_3)
	...
	local var_46_2 = arg_46_1
	local var_46_3 = arg_46_1.GetHP(var_46_2)

	ipairs = var_46_2

	for iter_46_6, iter_46_7 in var_46_2(arg_46_2) do
		var_46_3 = var_46_3 + iter_46_7:GetHP()
	end

	var_46_1.maxHP = var_46_3
	var_46_1.hpProvideRate = {}

	local var_46_4 = var_46_1.hpProvideRate

	var_46_4[var_0_2.GetCurrent(arg_46_1, "id")] = arg_46_1:GetHP() / var_46_3
	ipairs = var_46_4

	for iter_46_8, iter_46_9 in var_46_4(arg_46_2) do
		var_46_1.hpProvideRate[var_0_2.GetCurrent(iter_46_9, "id")] = iter_46_9:GetHP() / var_46_3
	end
...
function var_0_2.HasSonar(arg_50_0)
	...
	local var_50_1 = arg_50_0.GetTemplate(var_50_0).type

	ys = var_50_0

	return var_50_0.Battle.BattleConfig.VAN_SONAR_PROPERTY[var_50_1] ~= nil
end
...
function var_0_2.GetTagAttr(arg_59_0, arg_59_1, arg_59_2)
	...
	for iter_59_0, iter_59_1 in var_1_10005(var_59_0) do
		var_59_1[var_0_2.TAG_EHC_KEY .. iter_59_1] = true
	end
	...
	for iter_59_2, iter_59_3 in var_6(var_59_1) do
		if var_0_2.GetCurrent(arg_59_0, iter_59_2) ~= 0 then
			local var_59_3

			if arg_59_2 then
				ys = var_12
				var_59_3 = var_12.Battle.BattleDataFunction.GetLimitAttributeRange(iter_59_2, var_59_3)
			end
	...
	if var_0_2.GetCurrent(arg_59_1, var_0_2.FROM_TAG_EHC_KEY) > 0 then
		...
		local var_59_5 = var_0_2.FROM_TAG_EHC_KEY .. var_59_4 .. "_"
		local var_59_6 = var_0_2.GetCurrentTags(arg_59_0)

		pairs = var_10

		for iter_59_4, iter_59_5 in var_10(var_59_6) do
			if iter_59_5 > 0 then
				local var_59_7 = var_59_5 .. iter_59_4

				if var_0_2.GetCurrent(arg_59_1, var_59_7) ~= 0 then
					var_59_2 = var_59_2 * (1 + var_16)
				end
			end
		end
	end
...
function var_0_2.GetTagAttrCri(arg_60_0, arg_60_1)
	...
	for iter_60_0, iter_60_1 in var_1_10004(var_60_0) do
		var_60_1[var_0_2.TAG_CRI_EHC_KEY .. iter_60_1] = true
	end
	...
	for iter_60_2, iter_60_3 in var_5(var_60_1) do
		if var_0_2.GetCurrent(arg_60_0, iter_60_2) ~= 0 then
			var_60_2 = var_60_2 + var_10
		end
	end
...
function var_0_2.GetTagAttrCriDmg(arg_61_0, arg_61_1)
	...
	for iter_61_0, iter_61_1 in var_1_10004(var_61_0) do
		var_61_1[var_0_2.TAG_CRIDMG_EHC_KEY .. iter_61_1] = true
	end
	...
	for iter_61_2, iter_61_3 in var_5(var_61_1) do
		if var_0_2.GetCurrent(arg_61_0, iter_61_2) ~= 0 then
			var_61_2 = var_61_2 + var_10
		end
	end
