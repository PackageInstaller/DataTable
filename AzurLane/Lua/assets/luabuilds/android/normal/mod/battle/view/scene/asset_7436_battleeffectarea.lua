...
function var_0_3.updateCubeScale(arg_6_0)
	...
	if not var_3.GetFXStatic(var_6_2) then
		var_6_2 = arg_6_0._aoeData

		local var_6_3 = var_3.GetWidth(var_6_2)
		local var_6_4 = arg_6_0._aoeData

		var_6_0 = var_6_3 * var_6_2.GetIFF(var_6_4)
		var_6_2 = arg_6_0._aoeData
		var_6_1 = var_3.GetHeight(var_6_2)
	end
	...
	Vector3 = var_6_2
	var_6_5.localScale = var_6_2(var_6_0, 1, var_6_1)
...
function var_0_3.updateColumnScale(arg_7_0)
	...
	Vector3 = var_1_10003
	var_7_1.localScale = var_1_10003(var_1, 1, var_1)
...
function var_0_3.UpdateRotation(arg_9_0)
	...
	Vector3 = var_1_10003
	var_9_1.localEulerAngles = var_1_10003(0, var_9_0, 0)
