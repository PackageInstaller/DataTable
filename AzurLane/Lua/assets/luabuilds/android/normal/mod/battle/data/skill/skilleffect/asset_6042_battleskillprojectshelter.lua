...
function var_0_3.DoDataEffect(arg_2_0, arg_2_1)
	...
	if arg_2_1:GetIFF() == var_0_2.FOE_CODE then
		arg_2_0._offset[1] = arg_2_0._offset[1] * -1
	end

	local var_2_2 = arg_2_1
	local var_2_3 = arg_2_1.GetPosition(var_2_2)
	...
	local var_2_7 = var_8.TimeMgr.GetInstance()

	var_2_6(var_2_5, var_8.GetCombatTime(var_2_7))
