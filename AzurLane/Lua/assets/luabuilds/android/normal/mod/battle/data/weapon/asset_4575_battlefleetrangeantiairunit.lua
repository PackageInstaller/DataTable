...
function var_0_10.getAimPoint(arg_7_0, arg_7_1)
	...
	if var_1_10003 then
		...
		local var_7_2 = arg_7_1.GetPosition(var_7_1)

		Vector3 = var_7_1
		var_7_0 = var_7_1(var_7_2.x + arg_7_0._aimOffset, 0, var_7_2.z)
	else
		local var_7_3 = arg_7_0:GetHost()
		local var_7_4 = var_3.GetPosition(var_7_3).z
		local var_7_5 = var_3.x + arg_7_0._maxRangeSqr * arg_7_0._hostIFF + arg_7_0._aimOffset

		Vector3 = var_6
		var_7_0 = var_6(var_7_5, 0, var_7_4)
	end
...
function var_0_10.DoAreaSplit(arg_13_0, arg_13_1)
	local function var_13_0(arg_14_0)
		...
		for iter_14_0, iter_14_1 in var_14_1(arg_14_0) do
			if iter_14_1.Active and var_14_2[iter_14_1.UID] then
				var_2_10010 = var_8
		...
		for iter_14_2, iter_14_3 in var_5(var_14_0) do
			...
			math = var_2_10012
			var_2_10010 = var_2_10010(var_14_5, var_2_10012.floor(var_14_3 * var_14_4[iter_14_2]))

			local var_14_6 = var_0_2.WeightListRandom(arg_13_0._weightList, arg_13_0._totalWeight)
			local var_14_7 = arg_13_0._dataProxy

			var_2_10012.HandleDirectDamage(var_14_7, iter_14_3, var_2_10010, var_14_6)
		end
	...
	for iter_13_0, iter_13_1 in var_1_10003(arg_13_0._crewUnitList) do
		...
		var_1_10008(var_13_1, var_10.GetTemplateData(var_13_2).fire_fx, true)
	end
	...
	for iter_13_2, iter_13_3 in var_3(arg_13_0._hitFXResIDList) do
		...
		local var_13_6 = var_13_5 + var_13_4(var_1_10008, 10, var_13_3)
		local var_13_7 = var_0.Battle.BattleFXPool.GetInstance()
		local var_13_8 = var_11.GetFX(var_13_7, iter_13_3)

		pg = var_13_7

		local var_13_9 = var_13_7.EffectMgr.GetInstance()

		var_12.PlayBattleEffect(var_13_9, var_13_8, var_13_6, true)
	end

	local var_13_10 = arg_13_0._dataProxy

	var_3.SpawnColumnArea(var_13_10, var_0_3.BulletField.AIR, arg_13_1:GetIFF(), arg_13_1:GetPosition(), arg_13_0._exploRange, -1, var_13_0)

	RANGE_ANTI_AREA = var_3

	if var_3 then
		local var_13_11 = var_0.Battle.BattleFXPool.GetInstance()
		local var_13_12 = var_3.GetFX(var_13_11, "AlertArea").transform

		Vector3 = var_5
		var_13_12.localScale = var_5(arg_13_0._exploRange, 1, arg_13_0._exploRange)
		pg = var_5

		local var_13_13 = var_5.EffectMgr.GetInstance()

		var_5.PlayBattleEffect(var_13_13, var_3, arg_13_1:GetPosition())
	end

	local var_13_14 = arg_13_0._dataProxy

	var_3.RemoveBulletUnit(var_13_14, arg_13_1:GetUniqueID())
...
function var_0_10.FilterTarget(arg_18_0)
	...
	for iter_18_0, iter_18_1 in var_1_10005(var_18_1) do
