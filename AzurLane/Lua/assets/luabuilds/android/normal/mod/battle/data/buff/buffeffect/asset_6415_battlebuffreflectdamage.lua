...
function var_0_2.onDamageConclude(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	if arg_3_0:damageCheck(arg_3_3) and not arg_3_3.isReflect then
		...
		if var_3_2 >= var_1_10007.floor(var_3_1 * arg_3_0._triggerValve) then
			local var_3_3 = var_0.Battle.BattleDataProxy.GetInstance()

			if #arg_3_0:getTargetList(arg_3_1, arg_3_0._reflectTargetChoice, arg_3_0._reflectTargetParam, {}) ~= 0 then
				local var_3_4 = var_8[1]

				math = var_10

				local var_3_5 = var_10.floor(arg_3_0._reflectRate * var_3_2)

				var_3_3:HandleDirectDamage(var_3_4, var_3_5, arg_3_1, nil, true)
			end
		end
	end
