...
function var_0_6.SetUnit(arg_2_0, arg_2_1)
	...
	if var_2.GetUnitType(var_2_0) == var_0_3.UnitType.PLAYER_UNIT then
		...
		local var_2_4 = var_2_2(var_2_1, var_5.GetTemplate(var_2_3).painting)

		setImageSprite = var_2_1

		var_2_1(arg_2_0._icon, var_2_4)
		...
		for iter_2_0 = var_2_5, var_5.GetTemplate(var_2_6).star do
			...
			var_1_10008 = var_1_10008(arg_2_0._starTpl, arg_2_0._stars)
			setActive = var_9
	...
	var_2(var_2_7, var_4.GetTemplate(var_2_8).id)
	...
	var_2(var_2_9, var_4.GetTemplate(var_2_10).name)
	...
	var_2(var_2_11, var_4.GetAttrByName(var_2_12, "level"))
	...
	for iter_2_1, iter_2_2 in var_2(var_0_6.PrimalAttr) do
		...
		var_8(var_9.Find(var_2_14, iter_2_2 .. "/base"), var_2_13)

		arg_2_0._preAttrList[iter_2_2] = var_2_13
	end
...
function var_0_6.Update(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_1_10001(var_0_6.PrimalAttr) do
		...
		arg_3_0.updatePrimalAttr(var_1_10007, iter_3_1)
	end
	...
	for iter_3_2, iter_3_3 in var_1(var_0_6.BaseEnhancement) do
		...
		arg_3_0.updateBaseEnhancement(var_1_10007, iter_3_2, iter_3_3)
	end
	...
	for iter_3_4, iter_3_5 in var_3_0(var_3_1) do
		string = var_1_10007
...
function var_0_6.updateHP(arg_5_0)
	...
	var_5_3(arg_5_0._totalHP, var_5_2)

	setText = var_5_3

	var_5_3(arg_5_0._currentHP, var_5_1)
	...
	for iter_5_0, iter_5_1 in var_6(var_5_6) do
		ipairs = var_1_10011
...
function var_0_6.updatePrimalAttr(arg_6_0, arg_6_1)
	...
	var_6_0(var_4.Find(var_6_2, arg_6_1 .. "/current"), var_6_1)
...
function var_0_6.updateBaseEnhancement(arg_7_0, arg_7_1, arg_7_2)
	...
	var_6(var_7_1:Find("current"), var_4)
...
function var_0_6.updateSecondaryAttr(arg_8_0, arg_8_1, arg_8_2)
	...
	if arg_8_0._secondaryAttrList[arg_8_1].value ~= arg_8_2 then
		...
		var_6(var_8_2:Find("current"), arg_8_2)
...
function var_0_6.updateBuffList(arg_9_0)
	...
	for iter_9_0, iter_9_1 in var_9_0(arg_9_0._buffList) do
	...
	for iter_9_2, iter_9_3 in var_2(var_9_1) do
		if not arg_9_0._buffList[iter_9_2] then
			...
			if iter_9_3._stack > 1 then
				...
				local var_9_4 = var_9_2.Find(var_9_3, "buff_stack")
				...
				var_9_3(var_9_4, "x" .. iter_9_3._stack)
			end
		end
	end
	...
	for iter_9_4, iter_9_5 in var_2(var_9_1) do
		local var_9_5 = iter_9_5
		local var_9_6 = iter_9_5.GetEffectList(var_9_5)

		ipairs = var_9_5

		for iter_9_6, iter_9_7 in var_9_5(var_9_6) do
...
function var_0_6.updateWeaponList(arg_10_0)
	...
	if var_1.GetAirAssistList(var_10_0) then
		...
		for iter_10_0, iter_10_1 in var_10_0(var_1) do
			...
			local var_10_1 = var_1_10007
			local var_10_2 = var_1_10007.Find(var_10_1, "common/icon")

			GetImageSpriteFromAtlasAsync = var_10_1

			var_10_1("skillicon/2130", "", var_10_2)

			setText = var_10_1

			var_10_1(var_1_10007:Find("common/index"), "空袭")

			setText = var_10_1

			var_10_1(var_1_10007:Find("common/templateID"), iter_10_1:GetStrikeSkillID())

			arg_10_0._aaList[iter_10_1] = var_1_10007
		end
	end

	local var_10_3 = arg_10_0._unit
	local var_10_4 = var_2.GetAllWeapon(var_10_3)

	ipairs = var_10_3

	for iter_10_2, iter_10_3 in var_10_3(var_10_4) do
		if iter_10_3:GetType() ~= var_0_5.STRIKE_AIRCRAFT and var_8 ~= var_0_5.FLEET_ANTI_AIR then
			cloneTplTo = var_9

			local var_10_5 = var_9(arg_10_0._weaponTpl, arg_10_0._weaponContainer)
			...
			var_10(var_10_5:Find("common/index"), iter_10_3:GetEquipmentIndex())

			setText = var_10

			var_10(var_10_5:Find("common/templateID"), iter_10_3:GetTemplateData().id)

			local var_10_6 = iter_10_3:GetSrcEquipmentID()
			local var_10_7 = var_10_5
			local var_10_8 = var_10_5.Find(var_10_7, "common/icon")

			if var_10_6 then
				var_10_7 = var_0_2.GetWeaponDataFromID(var_10_6).icon
				GetImageSpriteFromAtlasAsync = var_13

				var_13("equips/" .. var_10_7, "", var_10_8)
			else
				setActive = var_10_7

				var_10_7(var_10_8, false)
			end
			...
			var_10_9(arg_10_0, var_10_5:Find("common/sector"), function(arg_11_0)
	...
	if var_3.GetFleetRangeAAWeapon(var_10_10) then
		cloneTplTo = var_10_10

		local var_10_11 = var_10_10(arg_10_0._weaponTpl, arg_10_0._weaponContainer)
		...
		local var_10_13 = var_10_11.Find(var_10_12, "common/icon")

		GetImageSpriteFromAtlasAsync = var_10_12

		var_10_12("skillicon/2130", "", var_10_13)

		setText = var_10_12

		var_10_12(var_10_11:Find("common/index"), "远程防空")

		setText = var_10_12

		var_10_12(var_10_11:Find("common/templateID"), "N/A")

		onToggle = var_10_12

		var_10_12(arg_10_0, var_10_11:Find("common/sector"), function(arg_12_0)
...
function var_0_6.updateWeaponProgress(arg_13_0)
	...
	for iter_13_0, iter_13_1 in var_1_10001(arg_13_0._weaponList) do
		...
		local var_13_3 = var_13_0.Find(var_13_2, "sum/CTRate")

		string = var_13_2

		var_8(var_13_3, var_13_2.format("%.2f", iter_13_0:GetCTRate() * 100) .. "%")

		setText = var_8

		local var_13_4 = var_13_0
		local var_13_5 = var_13_0.Find(var_13_4, "sum/ACCRate")

		string = var_13_4

		var_8(var_13_5, var_13_4.format("%.2f", iter_13_0:GetACCRate() * 100) .. "%")
	...
	for iter_13_2, iter_13_3 in var_1(arg_13_0._aaList) do
		local var_13_6 = iter_13_2:GetReloadRate()

		arg_13_0.updateBarProgress(iter_13_3, var_13_6)

		local var_13_7, var_13_8 = iter_13_2:GetDamageSUM()

		setText = var_9

		var_9(iter_13_3:Find("sum/damageSum"), var_13_7 .. " + " .. var_13_8)
	end
...
function var_0_6.updateBulletAttrBuff(arg_15_0, arg_15_1)
	...
	local var_15_3 = var_15_0:Find("weapon_attr_container")
	local var_15_4 = {}

	pairs = var_8

	for iter_15_0, iter_15_1 in var_8(var_15_1) do
		var_15_4[iter_15_0] = true
	end

	pairs = var_8

	local var_15_5 = arg_15_0._unit

	for iter_15_2, iter_15_3 in var_8(var_9.GetBuffList(var_15_5)) do
		ipairs = var_1_10013
		...
		for iter_15_4, iter_15_5 in var_1_10013(iter_15_3:GetEffectList()) do
			if iter_15_5.__name == var_0.Battle.BattleBuffAddBulletAttr.__name then
				...
				local var_15_7 = iter_15_5

				if iter_15_5.equipIndexRequire(var_15_7, var_15_6) then
					local var_15_8

					if not var_15_1[iter_15_5] then
						cloneTplTo = var_15_7
						var_15_8 = var_15_7(var_15_2, var_15_3)
						setText = var_15_7

						var_15_7(var_15_8:Find("tag_name"), iter_15_5._attr)

						setText = var_15_7

						local var_15_9 = var_15_8:Find("src_buff")
						local var_15_10 = iter_15_3

						var_15_7(var_15_9, iter_15_3.GetID(var_15_10))

						Canvas = var_15_7

						var_15_7.ForceUpdateCanvases()

						local var_15_11 = var_15_8:Find("src_buff")

						var_15_7 = var_15_7.GetComponent
						typeof = var_22
						Text = var_15_10
						var_15_7 = var_15_7(var_15_11, var_22(var_15_10))
						Color = var_15_11
						var_15_7.color = var_15_11.green
						var_15_1[iter_15_5] = var_15_8
					end

					setText = var_15_7

					var_15_7(var_15_8:Find("current"), iter_15_5._number)

					var_15_4[iter_15_5] = false
				end
			end
		end
	end
	...
	for iter_15_6, iter_15_7 in var_8(var_15_4) do
		if iter_15_7 then
			local var_15_12 = var_15_1[iter_15_6]

			SetActive = var_1_10014

			var_1_10014(var_15_12:Find("expire"), true)
		end
	end
...
function var_0_6.addBuff(arg_16_0, arg_16_1, arg_16_2)
	...
	if var_4.contains(var_0_6.HIGH_LIGHT_BUFF, arg_16_1) then
		...
		local var_16_2 = var_16_0.Find(var_16_1, "high_light")

		setActive = var_16_1

		var_16_1(var_16_2, true)
	end
	...
	if arg_16_2._stack > 1 then
		...
		var_16_4 = var_16_0.Find(var_16_3, "buff_stack")
		setActive = var_16_3

		var_16_3(var_16_4, true)

		setText = var_16_3

		var_16_3(var_16_4, "x" .. arg_16_2._stack)
	end

	setActive = var_16_4

	var_16_4(var_16_0, true)
...
function var_0_6.addSkillCaster(arg_17_0, arg_17_1)
	...
	if not arg_17_0._skillList[var_17_0] then
		...
		local var_17_3 = var_5(arg_17_0._skillTpl, arg_17_0._skillContainer)
		local var_17_4 = var_5.Find(var_17_3, "common")

		setText = var_17_3

		var_17_3(var_17_4:Find("skillID"), arg_17_1._skill_id)

		local var_17_5 = var_5:Find("common/icon")
		local var_17_6
		...
		var_9("skillicon/" .. var_17_6, "", var_17_5)

		Canvas = var_9

		var_9.ForceUpdateCanvases()

		var_17_7 = {
			tf = var_5,
			effectList = {}
		}
		arg_17_0._skillList[var_17_0] = var_17_7
	end

	table = var_5

	var_5.insert(var_17_7.effectList, arg_17_1)
...
function var_0_6.updateCastEffectTpl(arg_19_0, arg_19_1)
	...
	local var_19_5 = var_19_0.Find(var_19_4, "common")

	setText = var_19_4

	var_19_4(var_19_5:Find("count"), var_19_2)

	setText = var_19_4

	var_19_4(var_19_5:Find("damageSum"), var_19_3)
...
function var_0_6.setDeltaText(arg_21_0, arg_21_1)
	...
	if 0 < arg_21_1 then
		...
		typeof = var_1_10005
		Text = var_1_10006
		var_21_2(var_21_1, var_1_10005(var_1_10006)).color = var_21_0
