...
function var_0_3.activeSubmarineWarning(arg_8_0)
	...
	local var_8_3 = var_8_2(var_2(arg_8_0._subIcon), 1, 2)
...
function var_0_3.deactiveSubmarineWarning(arg_9_0)
	...
	var_9_0(var_1_10002(arg_9_0._subIcon))
	...
	local var_9_2 = var_9_1(var_2(arg_9_0._subIcon), 0, 1)
	local var_9_3 = var_1.setFrom(var_9_2, 1)
	local var_9_4 = var_1.setOnComplete

	System = var_3

	var_9_4(var_9_3, var_3.Action(function()
