...
function var_0.Battle.BattleBuffHOT.CalcNumber(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_4 = var_6_2.max(0, var_6_0 * arg_6_0._currentHPRatio + var_6_1 * arg_6_0._maxHPRatio + arg_6_0._number)

	math = var_7

	return (var_7.floor(var_6_4 * arg_6_2._stack * var_6_3))
end
