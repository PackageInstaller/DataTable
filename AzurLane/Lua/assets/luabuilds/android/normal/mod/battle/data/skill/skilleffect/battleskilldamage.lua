...
function var_0.Battle.BattleSkillDamage.DoDataEffect(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_2 = var_1_10005.floor(var_2_1 * arg_2_0._maxHPRate)

	math = var_6

	local var_2_3 = var_2_2 + var_6.floor(var_2_0 * arg_2_0._currentHPRate) + arg_2_0._number
	local var_2_4
	...
	local var_2_5 = arg_2_0._proxy

	var_7.HandleDirectDamage(var_2_5, arg_2_2, var_2_3, arg_2_1, var_2_4, false, arg_2_0._ignoreInvincible)
