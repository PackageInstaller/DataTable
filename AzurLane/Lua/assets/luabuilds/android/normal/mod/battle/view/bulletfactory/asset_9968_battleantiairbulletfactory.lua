...
function var_0_2.CreateBullet(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	...
	local function var_3_8()
		...
		local var_5_3 = var_2.GetEffectField(var_5_2)
		local var_5_4 = arg_3_2

		var_5_1(var_5_0, var_5_3, var_3.GetIFF(var_5_4), var_3_5, var_3_6, var_3_0.time, var_3_7)

		local var_5_5 = var_3_1
		local var_5_6 = var_0.RemoveBulletUnit
		local var_5_7 = arg_3_2

		var_5_6(var_5_5, var_2.GetUniqueID(var_5_7))
	...
	local function var_3_9()
		...
		if var_1.IsAlive(var_6_1) and var_0 then
			...
			local var_6_6 = var_2_10004.random(var_3_6) - var_3_6 * 0.5
			local var_6_7 = 0

			math = var_2_10006
			var_3_5 = var_6_5(var_6_4, var_2_10003(var_6_6, var_6_7, var_2_10006.random(var_3_6) - var_3_6 * 0.5))
		else
			var_6_0 = var_3_5
		end
		...
		local var_6_12, var_6_13 = var_6_10(var_6_9, var_3.GetTemplate(var_6_11).hit_fx)

		pg = var_3

		local var_6_14 = var_3.EffectMgr.GetInstance()
