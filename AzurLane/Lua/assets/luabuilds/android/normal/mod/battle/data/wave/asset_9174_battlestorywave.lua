...
function var_0_2.DoWave(arg_3_0)
	...
	if var_3_3 == var_3_2 then
		...
		if var_3_2.getActiveChapter(var_3_4, true) then
			var_3_5 = var_3_2
			var_3_1 = var_3_2.IsAutoFight(var_3_5) or var_3_1
		end
		...
		if arg_3_0._param.progress then
			if not var_3_2 then
				...
				if var_3_7.min(var_3_2.progress + var_3_2:getConfig("progress_boss"), 100) < arg_3_0._param.progress then
					var_3_0 = false
				end
			end
		end
		...
		if var_3_2 then
			...
			var_3_7 = var_3_7.getMapById(var_3_6, var_3_2:getConfig("map"))
		end
	...
	if var_3_0 then
		...
		local var_3_8 = var_3_2.MsgboxMgr.GetInstance()
		...
		ChapterOpCommand = var_3_10

		var_3_10.PlayChapterStory(arg_3_0._storyID, var_3_9, var_3_1, var_3_11)
