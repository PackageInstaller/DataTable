...
function var_0_4.SetFromTo(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5, arg_2_6, arg_2_7)
	...
	local var_2_4 = var_2_3(var_2_2, var_10.Action_UnityEngine_Vector3(function(arg_3_0)
	...
	if arg_2_6 then
		...
		var_2_6(var_2_5, var_11.easeOutExpo)
	end
	...
	if arg_2_7 then
		...
		var_2_8(var_2_7, var_11.Action(function()
			arg_2_7()
