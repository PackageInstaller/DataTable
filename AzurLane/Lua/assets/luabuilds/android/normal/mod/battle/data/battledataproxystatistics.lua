...
function var_0_0.BotPercentage(arg_11_0, arg_11_1)
	...
	math = var_1_10005
	var_11_1._botPercentage = var_11_2(var_1_10005.floor(arg_11_1 / var_11_0 * 100), 0, 100)
...
function var_0_0.CalcBattleScoreWhenDead(arg_12_0, arg_12_1)
	if arg_12_1:GetIFF() == var_0_4.FRIENDLY_CODE then
		...
		if not var_12_0(var_1_10004.SubShipType, arg_12_1:GetTemplate().type) then
...
function var_0_0.CalcDodgemCount(arg_27_0, arg_27_1)
	...
	local var_27_2 = arg_27_1.GetTemplate(var_27_1).type

	ys = var_27_1

	local var_27_3

	if var_27_0 == var_27_1.Battle.BattleConst.UnitDeathReason.CRUSH then
		...
		if var_27_2 == var_27_3.JinBi then
			...
			var_1_10006 = arg_27_0
			var_27_3 = var_27_3 + arg_27_0.GetScorePoint(var_1_10006)
			...
			var_27_4(var_1_10006, var_7.Event.New(var_0_1.UPDATE_DODGEM_SCORE, {
				totalScore = var_27_3
			}))
		else
			ShipType = var_27_3
		...
		var_27_3(var_27_5, var_1_10006.Event.New(var_0_1.UPDATE_DODGEM_COMBO, {
...
function var_0_0.AddAirFightScore(arg_43_0, arg_43_1)
	...
	var_43_2(var_43_1, var_4.Event.New(var_0_1.UPDATE_DODGEM_SCORE, {
...
function var_0_0.DecreaseAirFightScore(arg_44_0, arg_44_1)
	...
	var_44_2(var_44_1, var_4.Event.New(var_0_1.UPDATE_DODGEM_SCORE, {
