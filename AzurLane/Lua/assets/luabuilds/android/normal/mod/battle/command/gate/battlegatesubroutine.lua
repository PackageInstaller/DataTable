...
local var_0_0 = var_0_10000("BattleGateSubRoutine")

ys = var_1
var_1.Battle.BattleGateSubRoutine = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	SYSTEM_SUB_ROUTINE = var_1_10006
	...
	local var_1_12 = var_1_1.getShipByTeam
	local var_1_13 = var_1_10

	TeamType = var_1_10016

	local var_1_14 = var_1_12(var_1_11, var_1_13, var_1_10016.Submarine)

	ipairs = var_1_11

	for iter_1_0, iter_1_1 in var_1_11(var_1_14) do
		var_1_5[#var_1_5 + 1] = iter_1_1.id
	end

	local var_1_15 = var_1_10:getStartCost().oil
	local var_1_16 = var_1_10:GetCostSum().oil
	local var_1_17 = var_1_0:getData()

	if var_1_4 and var_1_17.oil < var_1_16 then
		pg = var_17

		local var_1_18 = var_17.TipsMgr.GetInstance()
		local var_1_19 = var_17.ShowTips

		i18n = var_1_10019

		var_1_19(var_1_18, var_1_10019("stage_beginStage_error_noResource"))

		return
	end

	local var_1_20 = arg_1_0.mainFleetId
	local var_1_21 = arg_1_0.stageId

	pg = var_1_10019

	local var_1_22 = var_1_10019.expedition_data_template[var_1_21].dungeon_id
	...
	local function var_1_24(arg_2_0)
		...
		local var_2_5 = {
			mainFleetId = var_1_20,
			prefabFleet = var_1_23,
			stageId = var_1_21
		}

		SYSTEM_SUB_ROUTINE = var_2
	...
	local var_1_26 = var_1_10023.SendRequest

	SYSTEM_SUB_ROUTINE = var_1_10024

	var_1_26(var_1_10024, var_1_5, {
		var_1_21
	}, var_1_24, var_1_25)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local function var_4_11(arg_5_0)
		...
		SYSTEM_SUB_ROUTINE = var_2_10005
