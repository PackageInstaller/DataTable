	...
	for iter_3_0, iter_3_1 in var_1_10004(arg_3_0) do
		if iter_3_1.id then
			...
			if var_0_35.GetWeaponDataFromID(var_9) then
				...
				for iter_3_2, iter_3_3 in var_12(var_11.skill_id) do
					local var_3_3
				...
				for iter_3_4, iter_3_5 in var_12(var_11.hidden_skill_id) do
					local var_3_6
...
function var_0_35.AttachWeather(arg_4_0, arg_4_1)
	...
	if var_1_10002.contains(arg_4_1, var_0_1.WEATHER.NIGHT) then
		...
		if arg_4_0:GetFleetVO() then
			...
			local var_4_2 = arg_4_0.GetFleetVO(var_4_1)

			table = var_4_1

			local var_4_3 = var_4_1.contains

			ShipType = var_1_10005

			local var_4_4

			if var_4_3(var_1_10005.VanguardShipType, var_4_0) then
				var_4_4 = var_4_2

				local var_4_5 = var_4_2.GetFleetBias(var_4_4)

				var_4_4 = var_4.GetCrewCount(var_4_5) + 1

				var_4:ConfigMinRange(var_0_2.AIM_BIAS_MIN_RANGE_SCOUT[var_4_4])
				var_4:AppendCrew(arg_4_0)
			else
				table = var_4

				local var_4_6 = var_4.contains

				ShipType = var_4_4

				local var_4_7

				if var_4_6(var_4_4.MainShipType, var_4_0) then
					var_4_7 = var_4_2

					var_4_2.AttachCloak(var_4_7, arg_4_0)
				else
					table = var_4

					local var_4_8 = var_4.contains

					ShipType = var_4_7

					if var_4_8(var_4_7.SubShipType, var_4_0) then
						local var_4_9 = var_0.Battle.BattleUnitAimBiasComponent.New()

						var_4.ConfigRangeFormula(var_4_9, var_0.Battle.BattleFormulas.CalculateMaxAimBiasRangeSub, var_0.Battle.BattleFormulas.CalculateBiasDecay)
		...
		elseif arg_4_0:GetUnitType() == var_0_1.UnitType.ENEMY_UNIT or arg_4_0:GetUnitType() == var_0_1.UnitType.MINION_UNIT or arg_4_0:GetUnitType() == var_0_1.UnitType.BOSS_UNIT then
			...
			var_3.ConfigRangeFormula(var_4_10, var_0.Battle.BattleFormulas.CalculateMaxAimBiasRangeMonster, var_0.Battle.BattleFormulas.CalculateBiasDecayMonster)

			table = var_4

			local var_4_11 = var_4.contains

			ShipType = var_4_10

			if var_4_11(var_4_10.SubShipType, var_4_0) then
...
function var_0_35.InitEquipSkill(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_4(var_6_0) do
...
function var_0_35.InitCommanderSkill(arg_7_0, arg_7_1, arg_7_2)
	...
	for iter_7_0, iter_7_1 in var_7_0(arg_7_0) do
...
function var_0_35.CreateWeaponUnit(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	...
	var_8(var_8_2 ~= nil, "找不到武器配置：id = " .. arg_8_0)
...
function var_0_35.CreateAircraftUnit(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	var_6(var_9_1 ~= nil, "找不到飞机配置：id = " .. arg_9_1)

	type = var_6

	if var_6(var_9_1.funnel_behavior) == "table" then
...
function var_0_35.CreateAirFighterWeaponUnit(arg_41_0, arg_41_1, arg_41_2, arg_41_3)
	...
	var_6(var_41_1 ~= nil, "找不到武器配置：id = " .. arg_41_0)
...
function var_0_35.AttachUltimateBonus(arg_48_0)
	...
	local var_48_1 = arg_48_0.GetTemplateID(var_48_0)

	Ship = var_48_0

	if not var_48_0.IsMaxStarByTmpID(var_48_1) then
		return
	end

	local var_48_2 = var_0_35.GetPlayerShipModelFromID(var_48_1).specific_type

	ipairs = var_4

	for iter_48_0, iter_48_1 in var_4(var_48_2) do
...
function var_0_35.AuxBoost(arg_49_0)
	...
	local var_49_1 = arg_49_0.GetEquipment(var_49_0)

	ipairs = var_49_0

	for iter_49_0, iter_49_1 in var_49_0(var_49_1) do
		if iter_49_1 and iter_49_1.equipment then
			table = var_7

			local var_49_2 = var_7.contains

			EquipType = var_1_10008

			if var_49_2(var_1_10008.DeviceEquipTypes, iter_49_1.equipment.type) then
				local var_49_3 = iter_49_1.equipment

				for iter_49_2 = 1, 3 do
					if var_49_3["attribute_" .. iter_49_2] then
						local var_49_4 = var_49_3["value_" .. iter_49_2]

						AttributeType = var_14

						local var_49_5 = var_14.ConvertBattleAttrName(var_49_3[var_12])
						local var_49_6 = var_0_3.GetBase(arg_49_0, var_49_5) + var_49_4 * var_0_1.UltimateBonus.AuxBoostValue

						var_0_3.SetCurrent(arg_49_0, var_49_5, var_49_6)
