...
function var_0_5.handleInfect(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_3 = arg_9_0.getTargetList(var_9_2, arg_9_1, var_9_0, var_9_1, {})

	ipairs = var_9_2

	for iter_9_0, iter_9_1 in var_9_2(var_9_3) do
		local var_9_4 = var_0.Battle.BattleBuffUnit.New(arg_9_2:GetID(), arg_9_2:GetLv())

		var_11.SetInfection(var_9_4, arg_9_0._igniteDMG)
...
function var_0_5.CalcNumber(arg_10_0, arg_10_1, arg_10_2)
	if arg_10_0._metaDot then
		...
		local var_10_10 = var_1_10010.floor

		math = var_1_10011

		return var_10_8(var_10_9, var_10_10(var_1_10011.min(var_10_3 - var_10_4 * arg_10_0._minRestHPRatio, var_10_7 * arg_10_2._stack * var_0_1.GetCurrent(arg_10_1, "repressReduce"))))
	end
