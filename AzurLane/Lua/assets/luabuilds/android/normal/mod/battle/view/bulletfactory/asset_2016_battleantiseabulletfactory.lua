...
function var_0_2.CreateBullet(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	...
	local function var_3_8()
		if var_3_5 then
			...
			if var_2.IsAlive(var_4_4) and var_0 then
				...
				local var_4_7 = var_2_10005.random(var_3_4) - var_3_4 * 0.5
				local var_4_8 = 0

				math = var_2_10007
				var_4_0 = var_4_6(var_4_5, var_2_10004(var_4_7, var_4_8, var_2_10007.random(var_3_4) - var_3_4 * 0.5))
			else
				var_4_0 = var_4_3
			end
			...
			local var_4_13, var_4_14 = var_4_11(var_4_10, var_4.GetTemplate(var_4_12).hit_fx)

			pg = var_4

			local var_4_15 = var_4.EffectMgr.GetInstance()
	...
	local function var_3_9()
		...
		if var_0.IsAlive(var_5_0) then
			...
			var_5_3(var_5_2, var_2.GetUniqueID(var_5_4))
		end
