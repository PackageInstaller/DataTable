...
function var_0_4.initDebug(arg_2_0)
	...
	local function var_2_17()
		...
		local var_4_1 = var_1(arg_2_0._minX.text)
	...
	local function var_2_33()
		...
		local var_6_1 = var_1(arg_2_0._summonStrikeTotal.text)
	...
	var_1(var_2_31, var_2_32, var_2_33, var_1_10005)
	...
	var_1(var_2_35, var_2_36, var_2_37, var_1_10005)
	...
	var_1(var_2_42, var_2_43, var_2_44, var_1_10005)
	...
	var_1(var_2_45, var_2_46, var_2_47, var_1_10005)
	...
	var_1(var_2_48, var_2_49, var_2_50, var_1_10005)
	...
	var_1(var_2_51, var_2_52, var_2_53, var_1_10005)
	...
	local function var_2_59()
		...
		var_12_1(var_12_0, var_2_10002(arg_2_0._dungeonLevel.text))
	...
	var_1(var_2_57, var_2_58, var_2_59, var_1_10005)
	...
	var_1(var_2_61, var_2_62, var_2_63, var_1_10005)
...
function var_0_4.initComponent(arg_19_0)
	...
	var_1(var_19_4, var_19_5, var_19_6, var_1_10005)
	...
	var_1(var_19_8, var_19_9, var_19_10, var_1_10005)
	...
	var_1(var_19_15, var_19_16, var_19_17, var_1_10005)
	...
	var_1(var_19_18, var_19_19, var_19_20, var_1_10005)
	...
	var_1(var_19_21, var_19_22, var_19_23, var_1_10005)
	...
	var_1(var_19_24, var_19_25, var_19_26, var_1_10005)
	...
	var_19_31(nil, arg_19_0._triggerWave, function()
		...
		var_26_1(var_26_0, var_2_10002(arg_19_0._waveIndex.text))
	...
	var_1(nil, arg_19_0._triggerWeather, function()
		...
		var_27_1(var_27_0, var_2_10002(arg_19_0._weatherInput.text))
	...
	var_1(nil, arg_19_0._instantReload, function()
		...
		;(function(arg_30_0)
			...
			local var_30_1 = arg_30_0.GetWeaponList(var_30_0)

			ipairs = var_30_0

			for iter_30_0, iter_30_1 in var_30_0(var_30_1) do
	...
	var_1(var_19_40, var_19_41, var_19_42, var_1_10005)
...
function var_0_4.activeReference(arg_35_0)
	...
	if not var_1.GetMediatorByName(var_35_1, var_0.Battle.BattleReferenceBoxMediator.__name) then
		var_35_1 = arg_35_0._state
		var_35_2 = var_1.AddMediator(var_35_1, var_0.Battle.BattleReferenceBoxMediator.New())
	end

	pg = var_35_1

	local var_35_3 = var_35_1.TipsMgr.GetInstance()

	var_2.ShowTips(var_35_3, "┏━━━━━━━━━━━━━━━━━━━┓")

	pg = var_2

	local var_35_4 = var_2.TipsMgr.GetInstance()

	var_2.ShowTips(var_35_4, "┃ヽ(•̀ω•́ )ゝ战斗调试模块初始化成功！(ง •̀_•́)ง┃")

	pg = var_2

	local var_35_5 = var_2.TipsMgr.GetInstance()

	var_2.ShowTips(var_35_5, "┗━━━━━━━━━━━━━━━━━━━┛")

	local var_35_6 = arg_35_0._activeReference.transform

	var_2.GetComponent(var_35_6, "Button").enabled = false

	local var_35_7 = arg_35_0._activeReference
	local var_35_8 = var_2.Find(var_35_7, "text")
	local var_35_9 = var_2.GetComponent

	typeof = var_4
	Text = var_1_10005
	var_35_9(var_35_8, var_4(var_1_10005)).text = "(ﾉ･ω･)ﾉﾞ"

	local var_35_10 = arg_35_0._common

	arg_35_0._referenceConsole = var_2.Find(var_35_10, "reference_btns")
	SetActive = var_2

	var_2(arg_35_0._referenceConsole, true)

	local var_35_11 = arg_35_0._referenceConsole

	arg_35_0._speedUp = var_2.Find(var_35_11, "speed_up")

	local var_35_12 = arg_35_0._referenceConsole

	arg_35_0._speedDown = var_2.Find(var_35_12, "speed_down")

	local var_35_13 = arg_35_0._referenceConsole

	arg_35_0._speedLevel = var_2.Find(var_35_13, "speed")
	onButton = var_2

	local var_35_14
	local var_35_15 = arg_35_0._speedUp
	...
	local function var_35_16()
		...
		typeof = var_2_10003
		Text = var_2_10004
		var_36_1(var_36_0, var_2_10003(var_2_10004)).text = var_0.Battle.BattleConfig.BASIC_TIME_SCALE
	...
	var_2(var_35_14, var_35_15, var_35_16, var_1_10006)

	onButton = var_2

	local var_35_17
	local var_35_18 = arg_35_0._speedDown
	...
	local function var_35_19()
		...
		typeof = var_2_10003
		Text = var_2_10004
		var_37_1(var_37_0, var_2_10003(var_2_10004)).text = var_0.Battle.BattleConfig.BASIC_TIME_SCALE
	...
	var_2(var_35_17, var_35_18, var_35_19, var_1_10006)

	local var_35_20 = arg_35_0._referenceConsole

	arg_35_0._shipBox = var_2.Find(var_35_20, "ship_box")

	local var_35_21 = arg_35_0._referenceConsole

	arg_35_0._bulletBox = var_2.Find(var_35_21, "bullet_box")

	local var_35_22 = arg_35_0._referenceConsole

	arg_35_0._pp = var_2.Find(var_35_22, "property_panel")
	onToggle = var_2

	local var_35_23
	local var_35_24 = arg_35_0._shipBox

	local function var_35_25(arg_38_0)
		local var_38_0 = var_35_2
	...
	var_2(var_35_23, var_35_24, var_35_25, var_1_10006)

	onToggle = var_2

	local var_35_26
	local var_35_27 = arg_35_0._bulletBox

	local function var_35_28(arg_39_0)
		local var_39_0 = var_35_2
	...
	var_2(var_35_26, var_35_27, var_35_28, var_1_10006)

	onToggle = var_2

	local var_35_29
	local var_35_30 = arg_35_0._pp

	local function var_35_31(arg_40_0)
		local var_40_0 = var_35_2
	...
	var_2(var_35_29, var_35_30, var_35_31, var_1_10006)
...
function var_0_4.forceTrigger(arg_41_0, arg_41_1)
	...
	if var_2.GetCommandByName(var_41_0, "BattleSingleDungeonCommand")._waveUpdater._waveInfoList[arg_41_1] == nil then
		...
		local var_41_1 = var_4.TipsMgr.GetInstance()
