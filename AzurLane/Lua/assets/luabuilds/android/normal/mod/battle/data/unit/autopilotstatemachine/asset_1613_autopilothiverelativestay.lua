...
function var_0_1.GetDirection(arg_3_0, arg_3_1)
	...
	local var_3_3 = var_2
	local var_3_4 = var_2.GetPosition(var_3_3)

	Vector3 = var_3_3

	local var_3_5 = var_3_3(var_3_4.x + arg_3_0._distX, arg_3_1.y, var_3_4.z + arg_3_0._distZ) - arg_3_1

	if arg_3_0:IsExpired() then
		arg_3_0:Finish()
	end

	if var_3_5.magnitude < 0.4 then
		Vector3 = var_6
