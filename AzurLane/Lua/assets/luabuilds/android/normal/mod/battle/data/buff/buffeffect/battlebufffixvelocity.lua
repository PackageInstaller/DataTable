...
function var_0_1.calcMulValue(arg_7_0, arg_7_1)
	...
	local var_7_5 = arg_7_1.GetBuffList(var_7_4)

	pairs = var_7_4

	for iter_7_0, iter_7_1 in var_7_4(var_7_5) do
		ipairs = var_1_10012

		for iter_7_2, iter_7_3 in var_1_10012(iter_7_1._effectList) do
			if iter_7_3:GetEffectType() == var_0_1.FX_TYPE then
				local var_7_6 = iter_7_3._mulValue
				local var_7_7
				...
				local var_7_9 = 1 + var_7_6

				if var_7_6 > 0 and var_7_7 < var_7_9 then
					var_7_0 = var_7_0 / var_7_7 * var_7_9
					var_7_7 = var_7_9
				end

				if var_7_6 < 0 and var_7_9 < var_7_8 then
					var_7_1 = var_7_1 / var_7_8 * var_7_9
					var_7_8 = var_7_9
				end

				var_7_2[var_18] = var_7_7
				var_7_3[var_18] = var_7_8
			end
		end
	end
