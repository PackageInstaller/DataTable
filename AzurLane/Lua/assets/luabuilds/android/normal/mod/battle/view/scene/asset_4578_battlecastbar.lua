...
function var_0_2.Casting(arg_2_0, arg_2_1, arg_2_2)
	...
	Vector3 = var_4
	var_2_0.localScale = var_4(0.1, 0.1, 1)
	SetActive = var_2_0
	...
	local var_2_2 = var_4(arg_2_0._castClockGO)

	Vector3 = var_5

	local var_2_3 = var_2_1(var_2_2, var_5.New(1, 1, 1), 0.1)
	local var_2_4 = var_3.setEase

	LeanTweenType = var_5

	var_2_4(var_2_3, var_5.easeInBack)
...
function var_0_2.Interrupt(arg_3_0, arg_3_1)
	...
	var_3_0(var_1_10003(arg_3_0._danger))

	for iter_3_0 = 1, 2 do
		LeanTween = var_1_10006

		local var_3_1 = var_1_10006.alphaCanvas(arg_3_0._clockCG, 0.3, 0.3)
		local var_3_2 = var_1_10006.setFrom(var_3_1, 1)

		var_1_10006.setDelay(var_3_2, 0.3 * (iter_3_0 - 1))

		LeanTween = var_1_10006

		local var_3_3 = var_1_10006.alphaCanvas(arg_3_0._clockCG, 1, 0.3)

		var_1_10006.setDelay(var_3_3, 0.3 * iter_3_0)
	end
	...
	local var_3_5 = var_3(arg_3_0._castClockGO)

	Vector3 = var_4

	local var_3_6 = var_3_4(var_3_5, var_4.New(0.1, 0.1, 1), 0.3)
	local var_3_7 = var_2.setEase

	LeanTweenType = var_4

	local var_3_8 = var_3_7(var_3_6, var_4.easeInBack)
	local var_3_9 = var_2.setDelay(var_3_8, 1.25)
	local var_3_10 = var_2.setOnComplete

	System = var_4

	var_3_10(var_3_9, var_4.Action(function()
