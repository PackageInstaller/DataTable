...
function var_0_5.SetUnitData(arg_2_0, arg_2_1)
	...
	if arg_2_1.GetAirAssistList(var_2_0) ~= nil then
		ipairs = var_2_0

		for iter_2_4, iter_2_5 in var_2_0(var_2) do
...
function var_0_5.AddUnitEvent(arg_3_0)
	...
	if var_1.GetFleetRangeAAWeapon(var_3_4) then
		...
		var_3_6(var_3_5, var_3.GetFleetRangeAAWeapon(var_3_7))
	end
...
function var_0_5.RemoveUnitEvent(arg_4_0)
	...
	if var_1.GetFleetRangeAAWeapon(var_4_0) then
		...
		var_4_2(var_4_1, var_3.GetFleetRangeAAWeapon(var_4_3))
	end
...
function var_0_5.UpdateArrowBarPosition(arg_6_0)
	...
	if var_2.GetGroupID(var_6_3) then
		...
		if var_6_4(var_6_5, var_4.GetGroupID(var_6_6)) then
			local var_6_7

			if arg_6_0._arrowVector.x > 0 then
				local var_6_8 = arg_6_0._unitData

				var_6_7 = var_3.GetTemplate(var_6_8).painting .. var_0_2.MIRROR_QICON_KEY
			else
				local var_6_9 = arg_6_0._unitData

				var_6_7 = var_3.GetTemplate(var_6_9).painting
			end

			local var_6_10 = var_0.Battle.BattleResourceManager.GetInstance()
			local var_6_11 = var_3.GetCharacterQIcon(var_6_10, var_6_7)

			setImageSprite = var_6_10
			findTF = var_5

			var_6_10(var_5(arg_6_0._arrowBar, "icon"), var_6_11)
		end
	end
...
function var_0_5.AddArrowBar(arg_11_0, arg_11_1)
	...
	arg_11_0._arrowCG = var_2(var_11_0, var_4(var_1_10005))
	...
	typeof = var_4
	Image = var_1_10005
	arg_11_0._vectorProgress = var_11_3(var_11_2, var_4(var_1_10005))
	...
	local var_11_7 = var_11_5(var_11_4, var_5.GetTemplate(var_11_6).painting)

	setImageSprite = var_11_4
	findTF = var_5

	var_11_4(var_5(arg_11_0._arrowBar, "icon"), var_11_7)
...
function var_0_5.SonarAcitve(arg_14_0, arg_14_1)
	if var_0.Battle.BattleAttr.HasSonar(arg_14_0._unitData) then
		...
		var_14_1(var_14_0, var_1_10004(var_1_10005)).enabled = arg_14_1
	end
...
function var_0_5.UpdateDiveInvisible(arg_15_0)
	...
	var_15_0(arg_15_0._diveMark, var_15_1)
	...
	var_15_2(arg_15_0._oxygenBar, var_15_3)
...
function var_0_5.onTorpedoPrepar(arg_22_0, arg_22_1)
	...
	local var_22_3 = var_22_1(var_3.GetTemplateData(var_22_2).bullet_ID[1])
	local var_22_4 = arg_22_0._torpedoTrack
	local var_22_5 = var_3.SetScale

	Vector3 = var_1_10005

	var_22_5(var_22_4, var_1_10005(var_22_3.range / var_0_2.SPINE_SCALE, var_22_3.cld_box[3] / var_0_2.SPINE_SCALE, 1))
...
function var_0_5.AddHPBar(arg_27_0, arg_27_1)
	...
	typeof = var_4
	Slider = var_1_10005
	arg_27_0._oxygenSlider = var_27_9(var_27_8, var_4(var_1_10005))
...
function var_0_5.AddModel(arg_28_0, arg_28_1)
	...
	typeof = var_4
	Renderer = var_1_10005
	arg_28_0._renderer = var_28_1(var_28_0, var_4(var_1_10005))
...
function var_0_5.AddCloakBar(arg_31_0, arg_31_1)
	...
	var_31_3(var_31_2, var_5.GetCloak(var_31_4))
