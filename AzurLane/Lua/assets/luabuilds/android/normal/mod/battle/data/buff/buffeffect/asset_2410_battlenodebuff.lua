...
local var_0_2 = var_0(var_0_1, var_0_10002.Battle.BattleBuffEffect)

ys = var_0_1
var_0_1.Battle.BattleNodeBuff = var_0_2
...
function var_0_2.onFire(arg_3_0, arg_3_1, arg_3_2)
	...
	for iter_3_0, iter_3_1 in var_3_2(arg_3_1:GetAutoWeapons()) do
		if iter_3_1:GetWeaponId() == var_3_1 then
			...
			local var_3_6 = var_3_4.Battle.NodeData.New(arg_3_1, {
				weapon = iter_3_1
			}, var_3_5)

			pg = var_14

			local var_3_7 = var_14.NodeMgr.GetInstance()
			local var_3_8 = var_14.GenNode
			local var_3_9 = var_3_6

			pg = var_1_10017

			var_3_8(var_3_7, var_3_9, var_1_10017.BattleNodesCfg[var_3_0], var_3_5)
