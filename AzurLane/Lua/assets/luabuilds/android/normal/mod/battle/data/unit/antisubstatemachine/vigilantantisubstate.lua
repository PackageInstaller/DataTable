...
class = var_0_10002
var_0_1.VigilantAntiSubState = var_0_10002("VigilantAntiSubState", var_0.Battle.IAntiSubState)
var_0.Battle.VigilantAntiSubState.__name = "VigilantAntiSubState"

local var_0_2 = var_0.Battle.VigilantAntiSubState
...
function var_0_2.OnHateChain(arg_5_0, arg_5_1)
	arg_5_1:OnEngageState(true)

	return
end

function var_0_2.ToPreLevel(arg_6_0, arg_6_1)
