...
function var_0_2.displacementConvert(arg_10_0, arg_10_1, arg_10_2)
	...
	if arg_10_0._displacementConvert then
		...
		if 0 < var_10_3 then
			...
			math = var_1_10009
			arg_10_0._number = var_10_5(var_1_10009.max(var_10_1 - var_10_2, 0) * var_10_3, var_10_4)
		elseif var_10_3 < 0 then
			...
			math = var_1_10009
			arg_10_0._number = var_10_6(var_1_10009.max(0, var_10_4 + (var_10_1 - var_10_2) * var_10_3), var_10_4)
		elseif var_10_3 == 0 then
			arg_10_0._number = 0
		end
	elseif arg_10_0._displacementDynamic then
		...
		if arg_10_0:getTargetList(arg_10_2, var_10_7, arg_10_0._displacementDynamic) and #var_8 > 0 then
			...
			local var_10_15 = var_10_13.Distance(var_10_12, var_10_14)

			math = var_12

			local var_10_16 = var_12.min

			math = var_13
			arg_10_0._number = var_10_16(var_13.max(var_10_15 - var_10_8, 0) * var_10_9, var_10_10)
		else
			arg_10_0._number = 0
		end
	end
