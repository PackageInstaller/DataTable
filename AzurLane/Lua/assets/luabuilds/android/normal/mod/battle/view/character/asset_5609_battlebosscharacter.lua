...
function var_0_2.AddHPBar(arg_7_0, arg_7_1, arg_7_2)
	...
	typeof = var_6
	Text = var_7
	arg_7_0._HPBarCountText = var_7_3(var_7_2, var_6(var_7))
...
function var_0_2.SetTemplateInfo(arg_8_0)
	...
	typeof = var_5
	Text = var_1_10006
	var_8_5(var_8_4, var_5(var_1_10006)).text = var_8_2
	...
	local var_8_9 = var_8_8(var_8_7, var_5(var_1_10006))
	local var_8_10 = "Lv."
	...
	setImageSprite = var_8_13

	local var_8_15 = arg_8_0._HPBarTf

	var_8_13(var_6.Find(var_8_15, "BossIcon/typeIcon/icon"), var_8_14, true)
	...
	setImageSprite = var_8_16
	findTF = var_8

	var_8_16(var_8(arg_8_0._HPBarTf, "BossIcon/icon"), var_8_17)
	...
	typeof = var_9
	Image = var_10
	arg_8_0._armorProgress = var_8_21(var_8_20, var_9(var_10))
	SetActive = var_7
	...
	typeof = var_9
	Image = var_10
	arg_8_0._barrierProgress = var_8_25(var_8_24, var_9(var_10))
	SetActive = var_7
...
function var_0_2.initBarComponent(arg_11_0)
	...
	while var_11_1 <= arg_11_0._resTotalCount do
		...
		typeof = var_1_10010
		Image = var_1_10011
		var_11_2.progressImage = var_11_9(var_11_8, var_1_10010(var_1_10011))
		...
		typeof = var_1_10010
		Image = var_1_10011
		var_11_2.deltaImage = var_11_11(var_11_10, var_1_10010(var_1_10011))
	...
	if arg_11_0._HPBarTotalCount < 5 then
		...
		while var_11_12 > arg_11_0._HPBarTotalCount do
			...
			var_5(var_6.Find(var_11_14, var_11_13), false)

			SetActive = var_5

			local var_11_15 = arg_11_0._HPBarTf

			var_5(var_6.Find(var_11_15, var_11_13 .. "_delta"), false)
	...
	if arg_11_0._activeVernier then
		...
		var_3(var_4.Find(var_11_23, "vernier"), arg_11_0._activeVernier)
	end
...
function var_0_2.UpdateHpBar(arg_13_0)
	...
	arg_13_0.SortBar(var_13_8, var_13_5, var_13_7)
	...
	if var_13_1 < arg_13_0._cacheHP then
		...
		var_13_8 = arg_13_0._chargeTimer
	...
	if arg_13_0._activeVernier then
		...
		Vector2 = var_13_8
		var_13_9.anchorMin = var_13_8(var_13_6, 0.5)
...
function var_0_2.generateTween(arg_14_0)
	...
	local var_14_4 = var_14_3(var_1_10005(arg_14_0._HPBar), var_14_0.fillAmount, var_14_1, 0.7)
	local var_14_5 = var_4.setOnUpdate

	System = var_6

	return (var_14_5(var_14_4, var_6.Action_float(function(arg_15_0)
...
function var_0_2.GetCurrentFmod(arg_16_0)
	...
	local var_16_2, var_16_3 = var_16_0.modf(var_16_1 / arg_16_0._stepHP)
	...
	if var_1_10004.fmod(var_16_4, arg_16_0._resTotalCount) == 0 then
		var_16_5 = 5
	end
...
function var_0_2.AddAimBiasBar(arg_35_0, arg_35_1)
	...
	var_35_1(var_35_0, var_4.GetAimBias(var_35_2))
