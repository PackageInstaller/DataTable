...
function var_0_1.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_1_10005(arg_2_0._target) ~= "string" or arg_2_0._target ~= "TargetAllHarm" then
		if var_5 == "table" then
			table = var_6

			if not var_6.contains(arg_2_0._target, "TargetAllHarm") then
				if var_5 ~= "string" or arg_2_0._target ~= "TargetAllFoe" then
					if var_5 == "table" then
						table = var_6

						if var_6.contains(arg_2_0._target, "TargetAllFoe") then
							var_2_1 = false
						end
					end
					...
					local var_2_5 = arg_2_0._isUpdateAura and true or false
					local var_2_6 = var_0.Battle.BattleDataProxy.GetInstance()
					local var_2_7, var_2_8, var_2_9, var_2_10 = var_10.GetFieldBound(var_2_6)

					Vector3 = var_1_10015

					local var_2_11 = var_1_10015((var_2_9 + var_2_10) * 0.5, 0, (var_2_7 + var_2_8) * 0.5)

					math = var_16

					local var_2_12 = var_16.abs(var_2_10 - var_2_9)

					math = var_17

					local var_2_13 = var_17.abs(var_2_7 - var_2_8)

					arg_2_0._aura = var_10:SpawnLastingCubeArea(var_0_2.AOEField.SURFACE, arg_2_1:GetIFF(), var_2_11, var_2_12, var_2_13, 0, var_2_2, var_2_3, var_2_1, nil, var_2_4, var_2_5)
