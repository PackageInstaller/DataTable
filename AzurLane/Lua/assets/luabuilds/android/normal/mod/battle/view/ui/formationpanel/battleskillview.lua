...
function var_0_3.InitBtns(arg_6_0)
	...
	local function var_6_3()
		...
		var_7_1(var_7_0, var_2_10002("battle_emptyBlock"))
	...
	local function var_6_5()
		if arg_6_0._main_cannon_sound then
			var_2_10001 = arg_6_0._main_cannon_sound

			var_0.Stop(var_2_10001, true)
		end
		...
		local var_9_1 = var_2_10001.CriMgr.GetInstance()

		var_9_0._main_cannon_sound = var_1.PlaySE_V3(var_9_1, "battle-cannon-main-prepared")

		local var_9_2 = arg_6_0._fleetVO

		var_0.CastChargeWeapon(var_9_2)
	...
	if var_23.GetUseable(var_6_51) then
		...
		local var_6_52 = var_23.GetCount(var_6_51)
		...
		if 0 < var_6_52 then
			...
			var_6_51 = var_6_51.GetSkin(var_6_54)

			arg_6_0.SetSkillButtonPreferences(var_6_51, 4)
	...
	local var_6_58 = var_6_51(arg_6_0._progressSkin, arg_6_0._buttonContainer)
...
function var_0_3.SubmarineButton(arg_27_0)
	...
	Vector2 = var_1_10004
	var_27_7.anchorMin = var_1_10004(var_27_8.x, var_27_8.y)
	Vector2 = var_4
...
function var_0_3.SetSkillButtonPreferences(arg_36_0, arg_36_1)
	...
	local var_36_2 = var_4.GetFloat("skill_" .. arg_36_1 .. "_anchorX", var_36_0.x)
