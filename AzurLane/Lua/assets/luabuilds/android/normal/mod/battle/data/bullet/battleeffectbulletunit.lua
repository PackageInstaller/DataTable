...
function var_0_1.Update(arg_2_0, arg_2_1)
	...
	if arg_2_0._flare then
		...
		local var_2_2 = var_4.Tool.FilterY
		local var_2_3 = arg_2_0:GetPosition()

		var_2_1(var_2_0, var_2_2(var_5.Clone(var_2_3)))
	end
...
function var_0_1.spawnArea(arg_5_0, arg_5_1)
	...
	if var_2.extra_param.ellipse_range then
		...
		local var_5_10 = arg_5_0:GetEffectField()
		local var_5_11 = arg_5_0
		local var_5_12 = arg_5_0.GetIFF(var_5_11)

		pg = var_5_11

		local var_5_13 = var_5_11.Tool.FilterY
		local var_5_14 = arg_5_0:GetPosition()
		local var_5_15 = var_5_13(var_15.Clone(var_5_14))
		local var_5_16 = var_5_0.range
		local var_5_17 = var_2.extra_param.ellipse_range

		time = var_1_10017
		var_5_7 = var_5_9(var_5_8, var_5_10, var_5_12, var_5_15, var_5_16, var_5_17, var_1_10017, var_5_3, var_5_4, var_4.friendly, var_4.effect_id)
	else
		local var_5_18 = arg_5_0._battleProxy
		local var_5_19 = var_10.SpawnLastingColumnArea
		local var_5_20 = arg_5_0:GetEffectField()
		local var_5_21 = arg_5_0
		local var_5_22 = arg_5_0.GetIFF(var_5_21)

		pg = var_5_21

		local var_5_23 = var_5_21.Tool.FilterY
		local var_5_24 = arg_5_0:GetPosition()
		local var_5_25 = var_5_23(var_15.Clone(var_5_24))
		local var_5_26 = var_5_0.range

		time = var_5_24
		var_5_7 = var_5_19(var_5_18, var_5_20, var_5_22, var_5_25, var_5_26, var_5_24, var_5_3, var_5_4, var_4.friendly, var_4.effect_id)
	end
