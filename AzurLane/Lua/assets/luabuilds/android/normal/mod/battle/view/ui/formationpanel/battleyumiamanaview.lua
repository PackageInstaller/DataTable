...
function var_0_3.init(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0._countText = var_2_1(var_2_0, var_3(var_1_10004))
	SetActive = var_1
	...
	var_1(var_2_3, var_3("yumia_mana_battle_tip"))
	...
	var_1(var_2_4, var_3("yumia_mana_battle_tip"))
...
function var_0_3.showTips(arg_6_0)
	...
	var_1(var_2.Find(var_6_0, "tips"), true)
	...
	var_6_1(var_6_2, var_6_3, var_4.Action(function()
		SetActive = var_2_10000

		local var_7_0 = arg_6_0._tf

		var_2_10000(var_1.Find(var_7_0, "tips"), false)
