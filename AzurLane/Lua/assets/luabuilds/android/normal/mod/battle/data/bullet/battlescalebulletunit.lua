...
function var_0_7.calcScaleSpeed(arg_5_0)
	...
	local var_5_2 = var_5_0 * var_1_10004.cos(var_5_1)
	local var_5_3 = 0

	math = var_1_10006
	arg_5_0._speed = var_3(var_5_2, var_5_3, var_5_0 * var_1_10006.sin(var_5_1))
...
function var_0_7.GetRadian(arg_7_0)
	...
	if not arg_7_0._radCache then
		...
		var_7_1 = arg_7_0.GetYAngle(var_7_0)
		math = var_7_0
		var_7_1 = var_7_1 * var_7_0.deg2Rad
	end
