...
function var_0_3.AddBuff(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if arg_8_0._check_target then
		if #arg_8_0:getTargetList(arg_8_1, arg_8_0._check_target, arg_8_0._tempData.arg_list, arg_8_2) >= arg_8_0._minTargetNumber and var_5 <= arg_8_0._maxTargetNumber then
			local var_8_0 = arg_8_0
			local var_8_1 = arg_8_0.getTargetList(var_8_0, arg_8_1, arg_8_0._target, arg_8_0._tempData.arg_list, arg_8_2)

			ipairs = var_8_0

			for iter_8_0, iter_8_1 in var_8_0(var_8_1) do
				if arg_8_0._isBuffStackByCheckTarget then
					iter_8_1:SetBuffStack(arg_8_0._buff_id, arg_8_0._level, var_5)
				else
		...
		local var_8_3 = arg_8_0.getTargetList(var_8_2, arg_8_1, arg_8_0._target, arg_8_0._tempData.arg_list, arg_8_2)

		ipairs = var_8_2

		for iter_8_2, iter_8_3 in var_8_2(var_8_3) do
