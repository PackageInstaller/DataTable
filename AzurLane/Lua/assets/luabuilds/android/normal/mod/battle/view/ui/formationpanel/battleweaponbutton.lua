...
function var_0_1.SwitchIcon(arg_5_0, arg_5_1, arg_5_2)
	...
	var_1_10005(var_5_2, var_1_10007("ui/CombatUI" .. var_5_1 .. "_atlas", "weapon_unfill_" .. var_5_0))
	...
	var_1_10005(var_5_3, var_7("ui/CombatUI" .. var_5_1 .. "_atlas", "filled_combined_" .. var_5_0))
...
function var_0_1.SwitchIconEffect(arg_6_0, arg_6_1, arg_6_2)
	...
	var_1_10005(var_6_2, var_1_10007("ui/CombatUI" .. var_6_1 .. "_atlas", "filled_effect_" .. var_6_0), true)
	...
	var_1_10005(var_6_3, var_7("ui/CombatUI" .. var_6_1 .. "_atlas", "skill_jam_" .. var_6_0), true)
...
function var_0_1.ConfigSkin(arg_7_0, arg_7_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_7_0._progressBar = var_7_1(var_7_0, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_7_0._countTxt = var_7_6(var_7_5, var_4(var_1_10005))
	...
	arg_7_0._animtor = var_7_13(var_7_12, var_6(var_1_10007))
...
function var_0_1.Enabled(arg_10_0, arg_10_1)
	...
	local var_10_1 = var_3(arg_10_0._block, "EventTriggerListener")
...
function var_0_1.Disable(arg_11_0)
	...
	local var_11_1 = var_2(arg_11_0._block, "EventTriggerListener")
...
function var_0_1.OnOverLoadChange(arg_17_0, arg_17_1)
	...
	if var_2.IsOverLoad(var_17_0) then
		...
		arg_17_0.OnFilled(var_17_3)

		if arg_17_1 and arg_17_1.Data and arg_17_1.Data.preCast then
			if var_2 == 0 then
				quickCheckAndPlayAnimator = var_17_3

				var_17_3(arg_17_0._skin, "weapon_button_progress_filled")
			elseif 0 < var_2 then
	...
	if var_2.GetTotal(var_17_4) > 0 then
...
function var_0_1.OnCountChange(arg_21_0)
	...
	string = var_1_10004
	var_21_4.text = var_1_10004.format("%d/%d", var_21_1, var_21_3)
...
function var_0_1.OnTotalChange(arg_22_0, arg_22_1)
	...
	if var_2.GetTotal(var_22_0) <= 0 then
		...
		if arg_22_0._bgEff then
			...
			var_22_4(var_22_3, var_4(var_1_10005)).alpha = 0
		end
		...
		typeof = var_4
		Text = var_1_10005
		var_22_6(var_22_5, var_4(var_1_10005)).text = "0/0"
...
function var_0_1.SetControllerActive(arg_23_0, arg_23_1)
	...
	local var_23_1 = var_3(arg_23_0._block, "EventTriggerListener")
...
function var_0_1.InitialAnima(arg_27_0, arg_27_1)
	...
	System = var_4
	arg_27_0._leanID = var_27_0(var_27_1, var_4.Action(function()
...
function var_0_1.SetToCombatUIPreview(arg_30_0, arg_30_1)
	...
	if arg_30_1 ~= var_1_10002.WeaponButtonPreviewMode.UNFILLED then
		...
		if arg_30_0._bgEff then
			...
			var_1_10004 = var_1_10004(var_30_1, var_6(var_1_10007))
			var_1_10004.alpha = 1
		end
		...
		if arg_30_0._bgEff then
			...
			typeof = var_6
			CanvasGroup = var_1_10007
			var_30_4(var_30_3, var_6(var_1_10007)).alpha = 0
		end
	...
	if arg_31_0._bgEff then
		if arg_31_0._progressInfo.GetCount then
			...
			if var_2.GetCount(var_31_4) > 0 then
				...
				typeof = var_1_10004
				CanvasGroup = var_1_10005
				var_31_6(var_31_5, var_1_10004(var_1_10005)).alpha = 1
		...
		typeof = var_1_10004
		CanvasGroup = var_1_10005
		var_31_8(var_31_7, var_1_10004(var_1_10005)).alpha = var_31_3
	end
