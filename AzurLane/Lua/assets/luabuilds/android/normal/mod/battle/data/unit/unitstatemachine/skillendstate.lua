...
class = var_0_10003
var_0_2.SkillEndState = var_0_10003("SkillEndState", var_0.Battle.IUnitState)
var_0.Battle.SkillEndState.__name = "SkillEndState"

local var_0_3 = var_0.Battle.SkillEndState
...
function var_0_3.AddSpellState(arg_7_0, arg_7_1, arg_7_2)
	return
end

function var_0_3.AddSkillState(arg_8_0, arg_8_1, arg_8_2)
	return
end
