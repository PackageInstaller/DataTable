...
function var_0_2.Update(arg_4_0)
	...
	for iter_4_0, iter_4_1 in var_1_10001(arg_4_0._unitHollowList) do
		if iter_4_0:IsAlive() then
			...
			Vector3 = var_10
			var_4_1.position = var_4_3(var_4_2 + var_10(0, 0, 0))
		else
...
function var_0_2.AddHollow(arg_7_0, arg_7_1)
	...
	if arg_7_0._unitHollowList[arg_7_1] then
		if var_3.range ~= var_7_0 then
			arg_7_0.doHollowScaleAnima(var_3.hollow, var_7_0)
		end
	...
	local var_7_2 = var_4(arg_7_0._hollowTpl, arg_7_0._hollowContainer)

	Vector3 = var_5
	var_7_2.localScale = var_5(125, 125, 0)

	arg_7_0.doHollowScaleAnima(var_7_2, var_7_0)

	Vector3 = var_5

	local var_7_3 = var_5.zero

	var_5.Copy(var_7_3, arg_7_1:GetPosition())
...
function var_0_2.doHollowScaleAnima(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	local var_10_4 = var_10_2(var_10_3, var_7(arg_10_1, arg_10_1, 0), var_10_0)
	...
	if arg_10_3 then
		...
		var_10_6(var_10_5, var_8.Action(function()
			arg_10_3()
