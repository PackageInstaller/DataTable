...
local var_0_3 = var_0_10003("BattleGuildBossCommand", var_0.Battle.BattleSingleDungeonCommand)

var_0.Battle.BattleGuildBossCommand = var_0_3
...
function var_0_3.onInitBattle(arg_7_0)
	...
	arg_7_0._specificEnemyList = var_0.Battle.BattleDataFunction.GetSpecificGuildBossEnemyList(var_7_1.ActID, var_7_1.StageTmpId)
...
function var_0_3.calcDamageData(arg_11_0)
	...
	var_2.CalcGuildBossEnemyInfo(var_11_2, var_11_1.ActID)
