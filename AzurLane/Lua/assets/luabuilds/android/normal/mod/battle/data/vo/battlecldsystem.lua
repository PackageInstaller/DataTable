...
function var_0_7.InitCldTree(arg_3_0)
	...
	local var_3_6 = var_6(var_3_4, 0, var_3_1)
	...
	if var_10_0 == var_0_2.BulletField.SURFACE then
		...
		if arg_10_1:IsIndiscriminate() then
			...
			if var_10_5 ~= arg_10_0._shipTree or not arg_10_0._foeShipTree then
				var_10_7 = arg_10_0._shipTree
			end

			local var_10_8 = arg_10_0
			local var_10_9 = arg_10_0.getBulletCldShipList(var_10_8, arg_10_1, var_10_7)

			ipairs = var_10_8

			for iter_10_0, iter_10_1 in var_10_8(var_10_9) do
				table = var_1_10015
...
function var_0_7.UpdateAOECld(arg_13_0, arg_13_1)
	...
	if var_13_1 == var_0_2.AOEField.SURFACE then
		...
		if arg_13_1:OpponentAffected() ~= var_13_6 or not arg_13_0._shipTree then
			var_13_7 = arg_13_0._foeShipTree
		end
		...
		if arg_13_1:GetIndiscriminate() then
			...
			if var_13_7 ~= arg_13_0._shipTree or not arg_13_0._foeShipTree then
				var_13_9 = arg_13_0._shipTree
			end

			local var_13_10 = arg_13_0
			local var_13_11 = arg_13_0.getAreaCldShipList(var_13_10, arg_13_1, var_13_9)

			ipairs = var_13_10

			for iter_13_0, iter_13_1 in var_13_10(var_13_11) do
				table = var_1_10019

				var_1_10019.insert(var_13_8, iter_13_1)
			end
		end
	...
	elseif var_13_1 == var_0_2.AOEField.BULLET then
		...
		if var_13_4 == arg_13_0._foeCode then
			var_13_12 = arg_13_0._foeSurafceBulletTree
		else
			var_13_12 = arg_13_0._surfaceBulletTree
		end

		local var_13_13 = var_13_12:GetCldList(var_13_0, var_0_3)

		arg_13_1:ClearCLDList()
		arg_13_0:HandleAreaCldWithBullet(arg_13_1, var_13_13)
	else
		local var_13_14 = {}
		local var_13_15 = arg_13_0._aircraftTree
		local var_13_16 = var_8.GetCldList(var_13_15, var_13_0, var_0_3)

		ipairs = var_13_15

		for iter_13_2, iter_13_3 in var_13_15(var_13_16) do
			if iter_13_3.data.IFF == var_13_4 then
				table = var_14

				var_14.insert(var_13_14, iter_13_3)
			end
		end

		arg_13_0:HandleAreaCldWithAircraft(arg_13_1, var_13_14)
	end
...
function var_0_7.getAreaCldShipList(arg_14_0, arg_14_1, arg_14_2)
	...
	if arg_14_1:GetAreaType() ~= var_0_2.AreaType.COLUMN then
		local var_14_1 = arg_14_1
		local var_14_2 = arg_14_1.GetAnchorPointAlignment(var_14_1)
		...
		elseif var_4 == var_0_2.AreaType.ELLIPSE then
			...
			pos = var_1_10011
			var_14_0 = var_14_7(var_14_6, var_14_8, var_14_9, var_1_10011)
		else
			local var_14_10 = arg_14_1:GetCldData().IFF == arg_14_0._foeCode
			local var_14_11 = arg_14_1
			local var_14_12 = arg_14_1.GetAngle(var_14_11)

			math = var_14_11

			local var_14_13 = var_14_12 * var_14_11.deg2Rad
	...
	for iter_15_0 = 1, var_15_2 do
		if arg_15_2[iter_15_0].data.Active == true and var_10.ImmuneCLD == false then
			...
			if var_15_3 then
				...
				local var_15_7 = var_15_4.GetCurrentOxyState(var_15_6)

				table = var_15_6

				if var_15_6.contains(var_15_3, var_15_7) then
					var_15_5 = false
				end
			end
