...
function var_0_3.doTrack(arg_2_0)
	...
	local var_2_1 = var_2 - arg_2_0:GetPosition()

	var_3.SetNormalize(var_2_1)

	Vector3 = var_4

	local var_2_2 = var_4.Normalize(arg_2_0._speed)

	Vector3 = var_5

	local var_2_3 = var_5.Dot(var_2_2, var_3)
	local var_2_4 = var_2_2.z * var_3.x - var_2_2.x * var_3.z
	local var_2_5 = arg_2_0:GetSpeedRatio()
	local var_2_6 = var_2_3
	local var_2_7 = var_2_4
	local var_2_8 = arg_2_0._speed.x * var_2_6 + arg_2_0._speed.z * var_2_7
	local var_2_9 = arg_2_0._speed.z * var_2_6 - arg_2_0._speed.x * var_2_7
	local var_2_10 = arg_2_0._speed

	var_12.Set(var_2_10, var_2_8, 0, var_2_9)
