...
class = var_0_10003
var_0_2.InterruptState = var_0_10003("InterruptState", var_0.Battle.IUnitState)
var_0.Battle.InterruptState.__name = "InterruptState"

local var_0_3 = var_0.Battle.InterruptState
...
function var_0_3.OnTrigger(arg_18_0, arg_18_1)
	...
	var_2.SetInterruptSickness(var_18_0, true)
...
function var_0_3.OnEnd(arg_20_0, arg_20_1)
	...
	var_2.SetInterruptSickness(var_20_0, false)
