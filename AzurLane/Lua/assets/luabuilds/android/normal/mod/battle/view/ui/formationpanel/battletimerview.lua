...
function var_0.Battle.BattleTimerView.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0._blinker = var_1_2(var_1_1, var_4(var_1_10005))
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0._text = var_1_4(var_1_3, var_4(var_1_10005))
	arg_1_0.timeStr = ""
...
function var_0.Battle.BattleTimerView.SetCountDownText(arg_3_0, arg_3_1)
	...
	if var_3_0(var_1_10003.floor(arg_3_1)) == arg_3_0.timeStr then
		return
	end
...
function var_0.Battle.BattleTimerView.formatTime(arg_4_0)
	...
	return var_4_0(var_4_1, var_1_10003.floor(arg_4_0 / 60), arg_4_0 % 60)
end
