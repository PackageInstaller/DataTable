...
function var_0_5._updateStop(arg_14_0, arg_14_1)
	...
	local var_14_1 = arg_14_0.getStopDuration(var_14_0)

	pg = var_14_0

	local var_14_2 = var_14_0.TimeMgr.GetInstance()

	if var_14_1 < var_3.GetCombatTime(var_14_2) then
...
function var_0_5.generateMoveTargetPoint(arg_18_0)
	...
	local var_18_1 = var_2.random(arg_18_0._upperBound, arg_18_0._lowerBound)
