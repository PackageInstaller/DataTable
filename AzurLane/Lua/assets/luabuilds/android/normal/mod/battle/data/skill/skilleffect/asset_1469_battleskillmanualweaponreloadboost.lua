...
function var_0_1.DoDataEffect(arg_2_0, arg_2_1, arg_2_2)
	if arg_2_0.getWeaponQueueByType(arg_2_1, arg_2_0._weaponType) then
		local var_2_0 = var_3:GetCoolDownList()

		if arg_2_0._boostValue then
			local var_2_1 = arg_2_0._boostValue * -1

			ipairs = var_1_10006

			for iter_2_0, iter_2_1 in var_1_10006(var_2_0) do
				iter_2_1:AppendReloadBoost(var_2_1)
			end
		elseif arg_2_0._boostRate then
			ipairs = var_5

			for iter_2_2, iter_2_3 in var_5(var_2_0) do
				local var_2_2 = iter_2_3:GetReloadTimeByRate(arg_2_0._boostRate) * -1
				local var_2_3 = boostValue
				local var_2_4 = iter_2_3
				local var_2_5 = iter_2_3.AppendReloadBoost

				boostValue = var_12

				var_2_5(var_2_4, var_12)
			end
		end
	end
