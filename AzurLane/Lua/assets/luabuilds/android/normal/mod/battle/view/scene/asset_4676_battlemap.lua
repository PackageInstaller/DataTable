...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	var_3(var_1_0, "找不到地图: " .. arg_1_1)

	ipairs = var_3

	for iter_1_0, iter_1_1 in var_3(var_0_1.LAYERS) do
		GameObject = var_1_10008
		var_1_10008 = var_1_10008.New(iter_1_1 .. "Layer")
		setParent = var_9

		var_9(var_1_10008, arg_1_0._go, false)

		if iter_1_1 ~= "sky" then
			GetOrAddComponent = var_9

			local var_1_1 = var_9(var_1_10008, "MapLayerCtrl")

			var_1_1.leftBorder = var_1_0.range_left
			var_1_1.rightBorder = var_1_0.range_right
			...
			var_1_1.speedToLeft = var_1_2
			var_1_1.speedScaler = 1
			pg = var_10
			var_1_1.mainCamera = var_10.UIMgr.GetInstance().mainCameraComp
			table = var_10

			var_10.insert(arg_1_0.mapLayerCtrls, var_1_1)
		end
		...
		local var_1_4 = var_10.split(var_1_0[iter_1_1 .. "_pos"], ";")

		string = var_11

		local var_1_5 = var_11.split(var_1_0[iter_1_1 .. "_scale"], ";")

		ipairs = var_12

		for iter_1_2, iter_1_3 in var_12(var_1_3) do
			local var_1_6 = var_0.Battle.BattleResourceManager.GetInstance()
			local var_1_7 = var_17.InstMap(var_1_6, iter_1_3)
			...
			var_1_8.localScale = var_19(var_1_5[iter_1_2])
			setParent = var_1_8

			var_1_8(var_1_7, var_1_10008, false)
			...
			string2vector3 = var_19
			var_1_9.localPosition = var_19(var_1_4[iter_1_2])

			local var_1_10 = var_1_7
			local var_1_11 = var_1_7.GetComponent

			typeof = var_20
			SeaAnim = var_21

			if var_1_11(var_1_10, var_20(var_21)) then
				table = var_1_10

				var_1_10.insert(arg_1_0.seaAnimList, var_18)
			end

			local var_1_12 = var_1_7
			local var_1_13 = var_1_7.GetComponent

			typeof = var_21
			Renderer = var_1_10022

			if var_1_13(var_1_12, var_21(var_1_10022)) then
				var_19.sortingOrder = -1500
			end
		end

		if iter_1_1 == "sea" then
			local var_1_14 = var_1_10008.transform

			arg_1_0._buffer = var_12.Find(var_1_14, "gelidai(Clone)")

			if arg_1_0._buffer then
				local var_1_15 = arg_1_0._buffer

				arg_1_0._bufferRenderer = var_12.GetComponent(var_1_15, "SpriteRenderer")

				local var_1_16 = arg_1_0._bufferRenderer

				Color = var_1_15
				var_1_16.color = var_1_15.New(1, 1, 1, 0)
