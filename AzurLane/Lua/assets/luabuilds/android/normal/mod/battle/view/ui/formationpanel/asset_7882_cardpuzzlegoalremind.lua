...
function var_0_5.SetCardPuzzleComponent(arg_2_0, arg_2_1)
	...
	var_3(var_4.Find(var_2_1, "text"), arg_2_0._tmp.description)
...
function var_0_5.init(arg_3_0)
	...
	local var_3_2 = var_2.Find(var_3_1, "label_ch")

	i18n = var_3_1

	var_1(var_3_2, var_3_1("card_puzzel_goal_ch"))

	setText = var_1

	local var_3_3 = arg_3_0._bg
	local var_3_4 = var_2.Find(var_3_3, "label_en")

	i18n = var_3_3

	var_1(var_3_4, var_3_3("card_puzzel_goal_en"))
	...
	var_1(arg_3_0, arg_3_0._bg, function()
		...
		Vector2 = var_3
		var_4_1.sizeDelta = var_3(var_0.width, var_4_0)
