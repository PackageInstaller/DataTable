...
function var_0_7.SetBoneList(arg_5_0)
	...
	local var_5_1 = arg_5_0.GetInitScale(var_5_0)

	pairs = var_5_0

	local var_5_2 = arg_5_0._unitData

	for iter_5_0, iter_5_1 in var_5_0(var_3.GetTemplate(var_5_2).bound_bone) do
...
function var_0_7.insertBondList(arg_6_0, arg_6_1, arg_6_2)
	...
	for iter_6_0, iter_6_1 in var_1_10003(arg_6_2) do
		...
		if var_1_10008(iter_6_1) == "table" then
			...
			Vector3 = var_1_10010
			var_1_10008[var_6_0] = var_1_10010(iter_6_1[1], iter_6_1[2], iter_6_1[3])
...
function var_0_7.SpawnBullet(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_7_5(var_7_4, var_7_6, var_7_7, var_7_8, var_7_9, var_14.GetDirection(var_7_10))
...
function var_0_7.GetBonePos(arg_8_0, arg_8_1)
	...
	if #var_8_2 == 1 then
		...
		return var_8_2[var_8_3(iter_8_0.Random(0, #var_8_2)) + 1]
	end
...
function var_0_7.PlayFX(arg_14_0, arg_14_1)
	...
	local var_14_3 = var_14_1.EffectMgr.GetInstance()
...
function var_0_7.AddFX(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	if arg_15_2 then
		...
		var_7.insert(var_15_3, var_15_2)
...
function var_0_7.GetOffsetPos(arg_28_0)
	...
	return (var_1_10001(var_2.GetTemplate(var_28_0).position_offset))
end
...
function var_0_7.AddUnitEvent(arg_31_0)
	...
	for iter_31_0, iter_31_1 in var_31_28(var_31_29) do
...
function var_0_7.UpdateBlindInvisible(arg_48_0)
	...
	var_48_3(var_48_2, var_1_10004(var_1_10005)).enabled = var_48_1
...
function var_0_7.onBlindExposed(arg_54_0, arg_54_1)
	...
	var_54_3(var_54_2, var_1_10005(var_1_10006)).enabled = var_54_1
...
function var_0_7.updateComponentDiveInvisible(arg_56_0)
	...
	var_1_10004(arg_56_0._arrowBarTf, var_56_6)

	SetActive = var_1_10004

	var_1_10004(arg_56_0._HPBarTf, var_56_6)

	SetActive = var_1_10004

	var_1_10004(arg_56_0._FXAttachPoint, var_56_6)
...
function var_0_7.updateComponentBlindInvisible(arg_57_0)
	...
	local var_57_4 = var_57_3(var_57_2, var_1_10004(var_1_10005))
...
function var_0_7.onInitVigilantState(arg_60_0, arg_60_1)
	...
	local var_60_3 = arg_60_0:AddFX("AntiSubArea", true).transform
	...
	range = var_1_10007
	var_60_3.localScale = var_4(var_5, var_60_4, var_1_10007)

	local function var_60_5()
		...
		local var_61_3 = var_61_2(var_61_1, var_2(var_2_10003))
	...
	local var_60_6 = arg_60_0._unitData

	var_5.RegisterEventListener(var_60_6, arg_60_0, var_0_1.CHANGE_ANTI_SUB_VIGILANCE, arg_60_0.onVigilantStateChange)

	local var_60_7 = arg_60_0._unitData

	var_5.RegisterEventListener(var_60_7, arg_60_0, var_0_1.ANTI_SUB_VIGILANCE_SONAR_CHECK, var_60_5)
...
function var_0_7.PlayAction(arg_65_0, arg_65_1)
	...
	if arg_65_0._skeleton then
		...
		var_1_10005 = arg_65_0._skeleton
		math = var_1_10006
		var_65_2, var_1_10005 = var_65_2(var_1_10005, var_1_10006.sign(arg_65_0._modelScale.x), var_65_0)
		var_65_1 = var_1_10005
		var_65_0 = var_65_2
	end
	...
	if var_65_1 then
		...
		local var_65_3 = var_65_2(var_1_10005.abs(arg_65_0._modelScale.x), arg_65_0._modelScale.y, arg_65_0._modelScale.z)

		arg_65_0:setLocalScale(var_65_3, true)
	end

	local var_65_4 = arg_65_0._animator

	var_4.SetAction(var_65_4, var_65_0, 0, var_0_3.ActionLoop[arg_65_1])

	arg_65_0._actionIndex = arg_65_1

	if arg_65_1 == var_0_3.ActionName.VICTORY or arg_65_1 == var_0_3.ActionName.VICTORY_SWIM then
		local var_65_5 = arg_65_0._effectOb

		var_4.ClearEffect(var_65_5)
	end
	...
	if #arg_65_0._orbitActionUpdateList > 0 then
		...
		for iter_65_0, iter_65_1 in var_4(arg_65_0._orbitActionUpdateList) do
			local var_65_6 = iter_65_1.orbit
			local var_65_7 = iter_65_1.change.condition.param
			local var_65_8 = false

			ipairs = var_1_10013

			for iter_65_2, iter_65_3 in var_1_10013(var_65_7) do
				string = var_1_10018
			...
			if var_65_8 then
				arg_65_0:changeOrbitAction(var_65_6, var_10)
...
function var_0_7.UpdatePosition(arg_67_0)
	...
	if var_67_3 == var_67_2.zero and arg_67_0._characterPos == var_67_1 then
		return
	end
...
function var_0_7.AddModel(arg_81_0, arg_81_1)
	...
	arg_81_0._hpBarOffset = var_2(var_81_0, var_4.GetBoxSize(var_81_1).y, 0)
	...
	typeof = var_4
	SpineAnim = var_5
	arg_81_0._animator = var_81_3(var_81_2, var_4(var_5))
	...
	var_81_9(var_81_8, var_5(var_81_7 * var_6.GetDirection(var_81_10), var_81_7, var_81_7))
...
function var_0_7.SwitchModel(arg_84_0, arg_84_1, arg_84_2)
	...
	arg_84_0._animator = var_84_2(var_84_1, var_6(var_1_10007))
	...
	var_84_9(var_84_8, var_1_10007(var_84_7 * var_8.GetDirection(var_84_10), var_84_7, var_84_7))
	...
	for iter_84_0, iter_84_1 in var_7(arg_84_0._blinkDict) do
		SpineAnim = var_1_10012
		var_84_12[var_1_10012.CharBlink(arg_84_0._go, iter_84_1.r, iter_84_1.g, iter_84_1.b, iter_84_1.a, iter_84_1.peroid, iter_84_1.duration, false)] = iter_84_1
		var_84_13[iter_84_0] = var_1_10012
	end

	arg_84_0._blinkDict = var_84_12
	...
	if not arg_84_2 then
		...
		for iter_84_2, iter_84_3 in var_7(arg_84_0._orbitList) do
			...
			local var_84_14 = var_1_10012.AddFollower(iter_84_3.boundBone, arg_84_0._tf, iter_84_2.transform)

			var_1_10012 = var_1_10012.GetComponent(var_84_14, "Spine.Unity.BoneFollower")
			var_1_10012.followBoneRotation = false
		end
	end

	local var_84_15 = arg_84_0._effectOb

	var_7.SwitchOwner(var_84_15, arg_84_0, var_84_13)

	local var_84_16 = arg_84_0._FXAttachPoint.transform

	var_7.SetParent(var_84_16, arg_84_0:GetTf(), false)

	local var_84_17 = var_0_5.GetInstance()

	var_7.DestroyOb(var_84_17, var_84_0)
	...
	if arg_86_2.orbit_combat_anima_change.default then
		...
		for iter_86_0, iter_86_1 in var_9(arg_86_2.orbit_combat_anima_change.change) do
			if iter_86_1.condition.type == 1 then
				...
				Clone = var_1_10017
				var_86_10.change = var_1_10017(iter_86_1)
			...
			elseif iter_86_1.condition.type == 2 then
				...
				Clone = var_1_10017
				var_86_13.change = var_1_10017(iter_86_1)
...
function var_0_7.sortOrbitZOrder(arg_87_0)
	...
	for iter_87_0, iter_87_1 in var_1_10001(arg_87_0._orbitList) do
		...
		var_7(iter_87_0, function(arg_88_0)
...
function var_0_7.getMaxZSort(arg_89_0)
	...
	var_1_10002(arg_89_0, function(arg_90_0)
		if arg_90_0 and arg_90_0:GetComponent("MeshRenderer") then
			...
			local var_90_1 = arg_90_0.GetComponent(var_90_0, "MeshRenderer").sortingOrder

			math = var_90_0
			var_89_0 = var_90_0.max(var_89_0, var_90_1)
		end
...
function var_0_7.changeOrbitAction(arg_91_0, arg_91_1, arg_91_2)
	...
	for iter_91_0, iter_91_1 in var_1_10003(arg_91_2) do
		...
		if var_8.Find(var_91_0, iter_91_1.node) then
			...
			var_91_0(var_9, iter_91_1.active)

			if iter_91_1.active and arg_91_0._orbitActionCacheList[var_9] ~= iter_91_1.activate then
				local var_91_1 = iter_91_1.activate
				local var_91_2 = var_9
				local var_91_3 = var_9.GetComponent

				typeof = var_1_10013
				Animator = var_1_10014

				local var_91_4 = var_91_3(var_91_2, var_1_10013(var_1_10014))

				var_11.SetBool(var_91_4, "activate", var_91_1)
...
function var_0_7.UpdateOrbit(arg_92_0)
	...
	for iter_92_0, iter_92_1 in var_92_1(arg_92_0._orbitSpeedUpdateList) do
...
function var_0_7.AddHPBar(arg_95_0, arg_95_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_95_0._HPProgress = var_95_2(var_95_1, var_4(var_1_10005))
...
function var_0_7.AddPopNumPool(arg_97_0, arg_97_1)
	...
	arg_97_0._popNumBundle = var_97_1(var_97_0, var_4.GetUnitType(var_97_2))
...
function var_0_7.AddVigilantBar(arg_102_0, arg_102_1)
	...
	var_102_1(var_102_0, var_4.GetAntiSubState(var_102_2))
...
function var_0_7.AddCloakBar(arg_104_0, arg_104_1)
	...
	var_104_1(var_104_0, var_4.GetCloak(var_104_2))
...
function var_0_7.AddAimBiasBar(arg_110_0, arg_110_1)
	...
	var_110_1(var_110_0, var_4.GetAimBias(var_110_2))
...
function var_0_7.configShieldBuffBar(arg_115_0)
	...
	for iter_115_0, iter_115_1 in var_1_10003(var_115_1) do
		local var_115_3 = iter_115_1
		local var_115_4 = iter_115_1.GetEffectList(var_115_3)

		ipairs = var_115_3

		for iter_115_2, iter_115_3 in var_115_3(var_115_4) do
	...
	local var_115_5 = arg_115_0._shieldBar

	var_3.ConfigShieldBuff(var_115_5, var_115_2)
...
function var_0_7.onUpdateScore(arg_127_0, arg_127_1)
	...
	var_127_3(var_127_2, var_127_4, var_1_10007.zero)
	var_3:Play()
...
function var_0_7.updateSomkeFX(arg_130_0)
	...
	for iter_130_0, iter_130_1 in var_130_0(arg_130_0._smokeList) do
...
function var_0_7.doChangeSize(arg_131_0, arg_131_1)
	...
	var_131_3(var_131_2, var_1_10005(var_131_1 * var_6.GetDirection(var_131_4), var_131_1, var_131_1))
...
function var_0_7.UpdateTagEffect(arg_134_0, arg_134_1)
	...
	for iter_134_0, iter_134_1 in var_134_0(arg_134_0._tagFXList) do
		...
		var_134_3(var_134_2, var_134_4 + var_1_10011(0, var_134_1, 0))
	end
...
function var_0_7.SetPopup(arg_135_0, arg_135_1, arg_135_2, arg_135_3)
	...
	if arg_135_0._popGO then
		...
		if var_135_1(var_135_0, var_1_10006(var_1_10007)) then
			var_1_10006 = var_4

			var_4.Play(var_1_10006, "popup_out")

			var_1_10006 = arg_135_0._popGO
			var_1_10007 = var_135_0.GetComponent(var_1_10006, "DftAniEvent")

			var_135_0.SetEndEvent(var_1_10007, function(arg_136_0)
			...
			var_135_0.cancel(arg_135_0._popGO)
			...
			rtf = var_1_10006
			var_1_10006 = var_1_10006(arg_135_0._popGO.gameObject)
			Vector3 = var_1_10007
			var_1_10006 = var_135_2(var_1_10006, var_1_10007.New(0, 0, 1), 0.1)

			local var_135_3 = var_5.setEase

			LeanTweenType = var_1_10007
			var_1_10006 = var_135_3(var_1_10006, var_1_10007.easeInBack)

			local var_135_4 = var_5.setOnComplete

			System = var_1_10007

			var_135_4(var_1_10006, var_1_10007.Action(function()
		...
		if var_135_7(var_135_6, var_1_10006(var_1_10007)) then
			arg_135_0.ChatPopAnimation(arg_135_0._popGO, arg_135_2)
		else
			local var_135_8 = arg_135_0._popTF

			Vector3 = var_6
			var_135_8.localScale = var_6(0, 0, 0)
...
function var_0_7.ChatPopAnimation(arg_138_0, arg_138_1)
	...
	local var_138_2 = var_138_1(var_138_0, var_1_10004(var_1_10005))
	...
	var_138_3(var_138_4, var_138_5, var_1_10006.Action(function()
...
function var_0_7.ChatPop(arg_141_0, arg_141_1)
	...
	local var_141_1 = var_1_10003(arg_141_0.gameObject)

	Vector3 = var_4

	local var_141_2 = var_141_0(var_141_1, var_4.New(1, 1, 1), 0.3)
	local var_141_3 = var_2.setEase

	LeanTweenType = var_4

	local var_141_4 = var_141_3(var_141_2, var_4.easeOutBack)
	local var_141_5 = var_2.setOnComplete

	System = var_4

	var_141_5(var_141_4, var_4.Action(function()
		...
		local var_142_1 = var_2_10001(arg_141_0.gameObject)

		Vector3 = var_2

		local var_142_2 = var_142_0(var_142_1, var_2.New(0, 0, 1), 0.3)
		local var_142_3 = var_0.setEase

		LeanTweenType = var_2

		local var_142_4 = var_142_3(var_142_2, var_2.easeInBack)
		local var_142_5 = var_0.setDelay(var_142_4, arg_141_1)
		local var_142_6 = var_0.setOnComplete

		System = var_2

		var_142_6(var_142_5, var_2.Action(function()
...
function var_0_7.setChatText(arg_144_0, arg_144_1)
	...
	local var_144_2 = var_144_1(var_144_0, var_4(var_1_10005))

	var_144_2.text = arg_144_1

	local var_144_3 = #var_144_2.text

	CHAT_POP_STR_LEN = var_4

	if var_4 < var_144_3 then
...
function var_0_7.Voice(arg_145_0, arg_145_1, arg_145_2)
	...
	var_3.PlayMultipleSound_V3(var_145_0, arg_145_1, function(arg_146_0)
		if arg_146_0 then
			...
			var_146_0._voiceTimer = var_146_2(var_146_1, var_146_3, var_146_4, var_6.GetLength(var_146_5) * 0.001, function()
				pg = var_3_10000
