...
function var_0_4.SetSpawnPosition(arg_7_0, arg_7_1)
	...
	if arg_7_0._barragePriority then
		...
		Vector3 = var_3
		arg_7_0._explodePos = var_7_0 + var_3(arg_7_0._offsetX, 0, arg_7_0._offsetZ)
		Quaternion = var_2
		...
		local var_7_2 = var_3.Tool.FilterY(arg_7_0._spawnPos)

		arg_7_0._explodePos = var_7_1 * (arg_7_0._explodePos - var_7_2) + var_7_2
	end

	if arg_7_0._fixToRange then
		Vector3 = var_2

		local var_7_3 = var_2.BattleDistance(arg_7_0._explodePos, arg_7_0._spawnPos)

		if arg_7_0._range < var_7_3 then
			pg = var_3

			local var_7_4 = var_3.Tool.FilterY(arg_7_0._explodePos - arg_7_0._spawnPos)

			Vector3 = var_4
			arg_7_0._explodePos = var_4.Normalize(var_7_4) * arg_7_0._range + arg_7_0._spawnPos
		end
	end
	...
	if arg_7_0._convertedVelocity ~= 0 then
		...
		local var_7_5 = var_2.Tool.FilterY(arg_7_0._spawnPos)

		Vector3 = var_3

		local var_7_6 = var_3.Distance(var_7_5, arg_7_0._explodePos) / arg_7_0._convertedVelocity
		local var_7_7 = arg_7_0._explodePos.y - arg_7_0._spawnPos.y
		local var_7_8

		if not arg_7_0:GetTemplate().extra_param.launchVrtSpeed then
			var_7_8 = var_7_7 / var_7_6 - 0.5 * arg_7_0._gravity * var_7_6
		end

		arg_7_0._verticalSpeed = var_7_8
	end
...
function var_0_4.SetTemplateData(arg_10_0, arg_10_1)
	...
	if var_2.barragePriority then
		...
		if var_10_0 then
			var_10_1 = arg_10_0:GetAttrByName(var_10_0)
		end
...
function var_0_4.CanDealDamage(arg_12_0)
	if not arg_12_0._nextDamageTime then
		...
		arg_12_0._nextDamageTime = var_1.GetCombatTime(var_1_10002) + arg_12_0._tempData.extra_param.alert_duration

		return false
	else
		local var_12_0 = arg_12_0._nextDamageTime

		pg = var_1_10002

		local var_12_1 = var_1_10002.TimeMgr.GetInstance()

		return var_12_0 < var_2.GetCombatTime(var_12_1)
	end
