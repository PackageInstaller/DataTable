...
function var_0_5.CreateBullet(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	...
	if var_10.contains(var_0_2, var_2_1) then
		local var_2_3 = var_0_5.GetSceneMediator()

		var_2_2 = var_10.GetAircraft(var_2_3, var_2_0)
	else
		table = var_10

		if var_10.contains(var_0_3, var_2_1) then
	...
	if var_2_2 then
		...
		local var_2_6 = arg_2_2:GetWeapon()

		if var_10.GetHost(var_2_6) then
			local var_2_7 = arg_2_2:GetWeapon()
			local var_2_8 = var_11.GetTemplateData(var_2_7).spawn_bound
			local var_2_9 = arg_2_0:GetSceneMediator()
			local var_2_10 = var_12.GetCharacter(var_2_9, var_10:GetUniqueID())
			local var_2_11 = arg_2_0:GetSceneMediator()

			var_13.AddArcEffect(var_2_11, arg_2_2:GetTemplate().modle_ID, var_2_10, var_6, var_2_8)
		end
	end
