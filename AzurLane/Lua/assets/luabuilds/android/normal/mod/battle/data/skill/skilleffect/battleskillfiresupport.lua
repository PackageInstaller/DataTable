	...
	if var_2.GetType(var_7_1) ~= var_0_2.EquipmentType.INTERCEPT_AIRCRAFT then
		do
			...
			if var_2.GetType(var_7_2) == var_0_2.EquipmentType.STRIKE_AIRCRAFT then
				...
				for iter_7_0, iter_7_1 in var_2(var_3.GetATKAircraftList(var_7_3)) do
					local var_7_4 = iter_7_1
					local var_7_5 = iter_7_1.GetWeapon(var_7_4)

					ipairs = var_7_4

					for iter_7_2, iter_7_3 in var_7_4(var_7_5) do
						var_7_0 = var_7_0 + iter_7_3:GetDamageSUM()
					end
				end
			else
				local var_7_6 = arg_7_0._weapon

				var_7_0 = var_2.GetDamageSUM(var_7_6)
			end
		end
