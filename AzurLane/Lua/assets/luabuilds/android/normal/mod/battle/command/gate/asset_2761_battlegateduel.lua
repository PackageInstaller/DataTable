...
ys = var_1
var_1.Battle.BattleGateDuel = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	if not var_4.canExercise(var_1_2) then
		...
		var_1_3(var_1_2, var_1_10007("exercise_count_insufficient"))
	...
	local var_1_5 = var_1_2(var_1_10007)
	...
	MilitaryExerciseProxy = var_1_10011

	local var_1_10 = var_1_10010(var_1_10011)
	local var_1_11 = var_10.getRivalById(var_1_10, var_1_9)

	pg = var_1_10

	local var_1_12 = var_1_10.battle_cost_template

	SYSTEM_DUEL = var_13

	local var_1_13 = var_1_12[var_13].oil_cost > 0
	local var_1_14 = {}
	local var_1_15 = 0
	local var_1_16 = 0
	local var_1_17 = 0
	local var_1_18 = 0
	local var_1_19 = var_1_6:getFleetById(var_1_0)
	local var_1_20 = var_1_5
	local var_1_21 = var_1_5.getSortShipsByFleet(var_1_20, var_1_19)
	...
	local var_1_22 = var_1_4:getData()
	local var_1_23

	if var_1_13 and var_1_22.oil < var_1_18 then
		pg = var_22
		var_1_23 = var_22.TipsMgr.GetInstance()

		local var_1_24 = var_22.ShowTips

		i18n = iter_1_0

		var_1_24(var_1_23, iter_1_0("stage_beginStage_error_noResource"))
	...
	for iter_1_2, iter_1_3 in var_1_23(var_1_11.mainShips) do
		var_1_25 = var_1_25 + iter_1_3.level
	end

	ipairs = var_23

	for iter_1_4, iter_1_5 in var_23(var_1_11.vanguardShips) do
		var_1_25 = var_1_25 + iter_1_5.level
	end

	local var_1_26 = RivalLevelVertiry

	arg_1_1.ShipVertify()

	local function var_1_27(arg_2_0)
		if var_1_13 then
		...
		if 0 < var_2_1 then
			...
			for iter_2_0, iter_2_1 in var_2(var_1_21) do
				...
				var_7.updateShip(var_2_2, iter_2_1)
			end
		end
		...
		var_3.updatePlayer(var_2_5, var_1_22)
	...
	local function var_1_28(arg_3_0)
	...
	local var_1_29 = var_25.SendRequest

	SYSTEM_DUEL = iter_1_4

	var_1_29(iter_1_4, var_1_14, {
		var_1_9
	}, var_1_27, var_1_28)
...
function var_0_0.Exit(arg_4_0, arg_4_1)
	...
	local function var_4_11(arg_5_0)
		...
		getProxy = var_5_5
		MilitaryExerciseProxy = var_2_10005
...
function var_0_0.GetPreloadList(arg_6_0)
	...
	local var_6_3 = var_1_10004(var_1_10005)
	local var_6_4 = var_6_2:getFleetById(arg_6_0.mainFleetId)
	local var_6_5 = var_6_3
	local var_6_6 = var_6_3.getShipsByFleet(var_6_5, var_6_4)
	...
	getProxy = var_7
	MilitaryExerciseProxy = var_8

	local var_6_7 = var_7(var_8)
	local var_6_8 = var_7.getRivalById(var_6_7, arg_6_0.rivalId)
	local var_6_9 = var_8.getShips(var_6_8)

	ipairs = var_6_8

	for iter_6_2, iter_6_3 in var_6_8(var_6_9) do
		table = var_1_10015
