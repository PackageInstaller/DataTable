...
class = var_0_10004
var_0_3.FreeBenchOxyState = var_0_10004("FreeBenchOxyState", var_0.Battle.IOxyState)
var_0.Battle.FreeBenchOxyState.__name = "FreeBenchOxyState"

local var_0_4 = var_0.Battle.FreeBenchOxyState
...
function var_0_4.DoUpdateOxy(arg_6_0, arg_6_1)
	arg_6_1:OxyRecover(var_0.Battle.OxyState.STATE_FREE_BENCH)
