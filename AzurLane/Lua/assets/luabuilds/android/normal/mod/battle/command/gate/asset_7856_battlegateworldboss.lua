...
ys = var_1
var_1.Battle.BattleGateWorldBoss = var_0_0
...
function var_0_0.Entrance(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_14(var_1_11) do
	...
	if var_18:IsSelfBoss(var_19) and var_19:GetSelfFightCnt() > 0 then
		var_1_8 = var_19:GetOilConsume()
	end

	if var_1_5 and var_1_13.oil < var_1_8 then
		pg = var_21

		local var_1_19 = var_21.TipsMgr.GetInstance()
		local var_1_20 = var_21.ShowTips

		i18n = var_23

		var_1_20(var_1_19, var_23("stage_beginStage_error_noResource"))
	...
	local function var_1_21(arg_2_0)
		...
		var_2_13(var_2_12, var_2_10004.BEGIN_STAGE_DONE, var_2_9)
	...
	local function var_1_22(arg_3_0)
		local function var_3_0()
			...
			var_4_3(var_4_2, var_2.WORLD_BOSS_START_BATTLE_FIALED)
		...
		if arg_3_0.result == 1 then
			...
			var_3_2(var_3_1, var_2_10004("world_boss_none"))
			var_3_0()
		elseif arg_3_0.result == 3 then
			...
			var_3_4(var_3_3, var_2_10004("world_boss_none"))
			var_3_0()
		elseif arg_3_0.result == 6 then
			...
			var_3_6(var_3_5, var_2_10004("world_max_challenge_cnt"))
			var_3_0()
		elseif arg_3_0.result == 20 then
			...
			var_3_8(var_3_7, var_2_10004("world_boss_none"))
			var_3_0()
		elseif arg_3_0.result == 13 then
			...
			var_3_10(var_3_9, var_2_10004("world_boss_maintenance"))
			var_3_0()
		else
			...
			var_3_13(var_3_12, var_4[arg_3_0.result] .. arg_3_0.result)
		end

		return
	end

	BeginStageCommand = var_23

	local var_1_23 = var_23.SendRequest

	SYSTEM_WORLD_BOSS = var_1_10024

	var_1_23(var_1_10024, var_1_6, {
		var_1_14
	}, var_1_21, var_1_22)
...
function var_0_0.Exit(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in var_1_10011(arg_5_0.statistics._enemyInfoList) do
		table = var_1_10016
	...
	local function var_5_12(arg_6_0)
		...
		accumulate = var_2_10006

		var_6_3(var_6_4, var_6_5, var_2_10006)
		...
		var_6_12(var_6_11, var_2_10010.FINISH_STAGE_DONE, var_6_10)
...
function var_0_0.GetPreloadList(arg_7_0)
	...
	local var_7_6 = var_7_4(var_8)
	local var_7_7 = var_7.getSortShipsByFleet(var_7_6, var_7_5)

	ipairs = var_7_6

	for iter_7_0, iter_7_1 in var_7_6(var_7_7) do
		table = var_1_10013
	...
	if var_5:GetBossById(arg_7_0.bossId) and var_10:IsSelf() then
		...
		if var_7_10 then
			...
			for iter_7_2, iter_7_3 in var_15(var_7_13) do
				table = var_1_10020
