...
function var_0_2.SetStaticState(arg_19_0, arg_19_1)
	arg_19_0._staticState = arg_19_1

	return
end

function var_0_2.SetAutoMoveAI(arg_20_0, arg_20_1, arg_20_2)
	function arg_20_0._autoMoveAi()
		local var_21_0 = arg_20_1
		local var_21_1 = var_0.GetDirection(var_21_0)
		local var_21_2 = var_0.Mul
		local var_21_3 = arg_20_2

		return var_21_2(var_21_1, var_3.GetAttrByName(var_21_3, "velocity"))
	end

	return
end

function var_0_2.SetFormationCtrlInfo(arg_22_0, arg_22_1)
	function arg_22_0._manuallyMove()
		local var_23_0 = arg_22_0

		return var_0.UpdateFleetInfo(var_23_0, arg_22_1)
	end

	return
end

function var_0_2.CancelFormationCtrl(arg_24_0)
	arg_24_0._manuallyMove = nil

	return
end

function var_0_2.SetMotionVO(arg_25_0, arg_25_1)
	arg_25_0._fleetMotionVO = arg_25_1

	return
end

function var_0_2.UpdateFleetInfo(arg_26_0, arg_26_1)
	local var_26_0 = arg_26_0._fleetMotionVO
	local var_26_1 = var_2.GetSpeed(var_26_0)

	if arg_26_1:EqualZero() then
		return var_26_1
	end

	local var_26_2 = var_2:GetPos()
	local var_26_3 = var_2:GetDirAngle() * arg_26_1
	local var_26_4 = var_5.Add(var_26_3, var_26_2)
	local var_26_5 = var_6.Sub(var_26_4, arg_26_0._pos)
	local var_26_6 = var_6.Div(var_26_5, 25)

	return var_6.Add(var_26_6, var_26_1)
end

function var_0_2.AdditiveForce(arg_27_0, arg_27_1)
...
function var_0_2.UpdateAdditiveSpeed(arg_28_0, arg_28_1)
	arg_28_0._additiveSpeed = arg_28_1

	return
end

function var_0_2.RemoveAdditiveSpeed(arg_29_0)
	Vector3 = var_1_10001
	arg_29_0._additiveSpeed = var_1_10001.zero

	return
end

function var_0_2.ActiveUnstoppable(arg_30_0, arg_30_1)
