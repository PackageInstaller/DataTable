...
function var_0_4.Ctor(arg_1_0)
	...
	typeof = var_1_10003
	Camera = var_1_10004
	arg_1_0._camera = var_1_2(var_1_1, var_1_10003(var_1_10004))
	...
	typeof = var_3
	Camera = var_1_10004
	arg_1_0._uiCamera = var_1_4(var_1_3, var_3(var_1_10004))
	pg = var_1
...
function var_0_4.Clear(arg_4_0)
	...
	Vector3 = var_4_5
	var_4_6.localPosition = var_4_5(0, 62, -10)
	CameraMgr = var_4_6
...
function var_0_4.SetMapData(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	local var_5_9 = var_12.ScreenToWorldPoint

	Vector3 = var_1_10014

	var_5_7(var_5_6, var_5_9(var_5_8, var_1_10014(var_5_5 * var_0_3.CAMERA_GOLDEN_RATE, 0, 0)).x - arg_5_0._cameraTF.position.x)
...
function var_0_4.SetFocusFleet(arg_6_0, arg_6_1)
	...
	var_6_1.position = var_6_3(var_6_2, var_5.GetCameraPos(var_6_4))
...
function var_0_4.SwitchCameraPos(arg_8_0, arg_8_1)
	...
	elseif arg_8_1 == "FOLLOW_GESTURE" then
		function arg_8_0._currentCameraPos()
			...
			return var_10_1(var_10_0, var_2.GetCameraPos(var_10_2, arg_8_0._cameraTF.position))
		end
	else
		function arg_8_0._currentCameraPos()
			...
			return var_11_1(var_11_0, var_2.GetCameraPos(var_11_2))
		end
	end
...
function var_0_4.setArrowPoint(arg_13_0)
	...
	local var_13_3 = var_13_2 + var_13_1(var_13_0, var_13_0, 0)
	local var_13_4 = arg_13_0._uiCamera
	local var_13_5 = var_3.ScreenToWorldPoint(var_13_4, arg_13_0._cameraFixMgr.rightTopVector)

	Vector3 = var_13_4
	arg_13_0._arrowCenterPos = (var_13_3 + (var_13_5 - var_13_4(var_13_0, var_13_0, 0))) * 0.5
	...
	Vector3 = var_13_6
	arg_13_0._arrowLeftBottomPos_notch = var_13_7 + var_13_6(var_13_0, var_13_0, 0)
	...
	Vector3 = var_13_8
	arg_13_0._arrowRightTopPos_notch = var_13_9 - var_13_8(var_13_0, var_13_0, 0)
...
function var_0_4.DoShake(arg_17_0)
	...
	var_17_6.UpdateTFLocalPos(arg_17_0._cameraTF, var_17_7 - arg_17_0._shakeInfo._diff)
...
function var_0_4.BulletTime(arg_24_0, arg_24_1, arg_24_2, arg_24_3)
	...
	if arg_24_0._uiMediator then
		...
		if var_7.GetAppearFX(var_24_4) ~= nil then
			...
			var_24_7(var_24_6, var_9(var_1_10010)).speed = var_24_2
		end
	end
...
function var_0_4.ZoomCamara(arg_25_0, arg_25_1, arg_25_2, arg_25_3, arg_25_4)
	...
	if not arg_25_1 then
		...
		var_1_10006 = var_1_10005.instance
		arg_25_1 = var_1_10005.GetCameraOrthographicSize(var_1_10006, arg_25_0._camera)
	end
	...
	local var_25_1 = var_25_0(var_1_10006(arg_25_0._camera), arg_25_1, arg_25_2, arg_25_3)
	local var_25_2 = var_5.setOnUpdate

	System = var_7

	local var_25_3 = var_25_2(var_25_1, var_7.Action_float(function(arg_26_0)
	...
	if arg_25_4 then
		...
		var_25_5(var_25_4, var_8.easeOutExpo)
	end
...
function var_0_4.FocusCharacter(arg_27_0, arg_27_1, arg_27_2, arg_27_3, arg_27_4, arg_27_5)
	...
	var_27_3(var_1_10008(arg_27_0._camera))
	...
	if arg_27_1 ~= nil then
		...
		var_27_9(var_27_8, var_27_10, var_27_11, var_27_12, var_27_13, var_1_10015, arg_27_5)
		...
		local var_27_17 = var_27_15(var_27_14, var_10.GetCameraPos(var_27_16))
		...
		var_27_20(var_27_19, var_27_21, var_27_22, var_27_23, var_27_24, var_1_10016, arg_27_5, var_27_18)
		arg_27_0:SwitchCameraPos(var_0_4.TWEEN_TO_CHARACTER)
	end
...
function var_0_4.ResetFocus(arg_29_0)
	...
	var_29_2(var_2(arg_29_0._uiCamera))

	local var_29_3 = arg_29_0._boundFix
	local var_29_4 = var_1.GetCameraPos
	local var_29_5 = arg_29_0._followPilot
	local var_29_6 = var_29_4(var_29_3, var_3.GetCameraPos(var_29_5))

	LeanTween = var_29_3

	local var_29_7 = var_29_3.move

	go = var_3

	local var_29_8 = var_29_7(var_3(arg_29_0._camera), var_29_6, var_0_3.CAM_RESET_DURATION)
	local var_29_9 = var_2.setOnUpdate

	System = var_4

	var_29_9(var_29_8, var_4.Action_float(function(arg_30_0)
		var_0_1.UpdateCameraPositionArgs()
...
function var_0_4.PauseCameraTween(arg_36_0)
	...
	var_36_0(var_1_10002(arg_36_0._camera))
	...
	var_36_1(var_2(arg_36_0._uiCamera))
...
function var_0_4.ResumeCameraTween(arg_37_0)
	...
	var_37_0(var_1_10002(arg_37_0._camera))
	...
	var_37_1(var_2(arg_37_0._uiCamera))
