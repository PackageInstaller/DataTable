...
function var_0_4.setRemoveTime(arg_4_0)
	...
	if var_1_10002(var_4_0) == "string" then
		...
		arg_4_0._duration = var_4_1(var_4_2, var_4_3(var_4_4, var_6.GetAttrManager(var_4_5)))
	else
...
function var_0_4.onTrigger(arg_11_0, arg_11_1, arg_11_2)
	...
	for iter_11_0, iter_11_1 in var_1_10004(var_3) do
		assert = var_1_10009
		type = var_1_10010
		var_1_10010 = var_1_10010(iter_11_1[arg_11_1]) == "function"

		var_1_10009(var_1_10010, "fleet buff效果的触发函数缺失,buff id:>>" .. arg_11_0._id .. "<<, trigger:>>" .. arg_11_1 .. "<<")

		var_1_10010 = iter_11_1

		if iter_11_1.IsActive(var_1_10010) then
			var_1_10010 = iter_11_1

			iter_11_1.NotActive(var_1_10010)

			var_1_10010 = iter_11_1

			iter_11_1.Trigger(var_1_10010, arg_11_1, arg_11_2)

			var_1_10010 = iter_11_1

			iter_11_1.SetActive(var_1_10010)
		end
	end
