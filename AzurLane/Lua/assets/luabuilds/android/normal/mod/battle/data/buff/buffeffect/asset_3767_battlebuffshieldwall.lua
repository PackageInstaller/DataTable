...
function var_0_3.SetArgs(arg_2_0, arg_2_1, arg_2_2)
	...
	if var_0_1[var_2_0.effect] then
		...
		local var_2_12 = arg_2_1.GetTemplate(var_2_11).fx_container[var_2_9]

		Vector3 = var_2_11

		local var_2_13 = var_2_11(var_2_12[1], var_2_12[2], var_2_12[3])

		var_14.Add(var_2_13, var_2_10)
...
function var_0_3.Clear(arg_13_0)
	...
	var_13_3(var_13_2, var_3.GetUniqueID(var_13_4))
