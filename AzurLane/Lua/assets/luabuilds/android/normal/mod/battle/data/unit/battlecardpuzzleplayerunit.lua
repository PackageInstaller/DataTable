...
function var_0_9.UpdateHP(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_9 = arg_2_0.GetCurrentHP(var_2_8)
	...
	if not var_2_2 then
		...
		arg_2_0:TriggerBuff(var_0.BuffEffectType.ON_TAKE_DAMAGE, var_2_8)

		if var_2_9 <= var_2_8.damage then
		...
		arg_2_0:TriggerBuff(var_0.BuffEffectType.ON_TAKE_HEALING, var_2_8)

		var_2_2 = var_2_8.isHeal
		arg_2_1 = var_2_8.damage
	end

	math = var_2_8

	local var_2_10 = var_2_8.min
	local var_2_11 = arg_2_0
	local var_2_12 = arg_2_0.GetMaxHP(var_2_11)

	math = var_2_11

	local var_2_13 = var_2_10(var_2_12, var_2_11.max(0, var_2_9 + arg_2_1)) - var_2_9
	local var_2_14 = {
		preShieldHP = var_2_7,
		dHP = arg_2_1,
		validDHP = var_2_13,
	...
	if var_2_6 and not var_2_6:EqualZero() then
		local var_2_15 = arg_2_0:GetPosition()
		local var_2_16 = arg_2_0:GetBoxSize().x
		local var_2_17 = var_2_15.x - var_2_16
		local var_2_18 = var_2_15.x + var_2_16
		local var_2_19 = var_2_6
		local var_2_20 = var_2_6.Clone(var_2_19)

		Mathf = var_2_19
		var_2_20.x = var_2_19.Clamp(var_2_20.x, var_2_17, var_2_18)
		var_2_14.posOffset = var_2_15 - var_2_20
	end

	arg_2_0:UpdateHPAction(var_2_14)
...
function var_0_9.setWeapon(arg_17_0)
	...
	for iter_17_0, iter_17_1 in var_1_10002(var_17_0) do
		if iter_17_1 ~= 0 then
			...
			for iter_17_2, iter_17_3 in var_8(var_17_1) do
				if iter_17_3 ~= -1 then
