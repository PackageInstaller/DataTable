...
function var_0_7.UpdateReload(arg_3_0)
	if arg_3_0._CDstartTime and not arg_3_0._jammingStartTime then
		...
		local var_3_1 = arg_3_0.GetReloadFinishTimeStamp(var_3_0)

		pg = var_3_0

		local var_3_2 = var_3_0.TimeMgr.GetInstance()

		if var_3_1 <= var_2.GetCombatTime(var_3_2) then
...
function var_0_7.SetHost(arg_6_0, arg_6_1)
	...
	if var_6_0 and var_6_0 ~= "" then
		...
		for iter_6_2, iter_6_3 in var_6_5(var_6_6) do
...
function var_0_7.GetReloadRate(arg_38_0)
	...
	elseif arg_38_0._CDstartTime then
		...
		local var_38_1 = arg_38_0.GetReloadFinishTimeStamp(var_38_0)

		pg = var_38_0

		local var_38_2 = var_38_0.TimeMgr.GetInstance()

		return (var_38_1 - var_2.GetCombatTime(var_38_2)) / arg_38_0._reloadRequire
	else
		return 1
	end
...
function var_0_7.GetDamageSUM(arg_39_0)
	...
	for iter_39_0, iter_39_1 in var_1_10003(arg_39_0._hiveList) do
		...
		for iter_39_2, iter_39_3 in var_1_10008(iter_39_1:GetATKAircraftList()) do
			local var_39_2 = iter_39_3
			local var_39_3 = iter_39_3.GetWeapon(var_39_2)

			ipairs = var_39_2

			for iter_39_4, iter_39_5 in var_39_2(var_39_3) do
				var_39_0 = var_39_0 + iter_39_5:GetDamageSUM()
			end
		end
	end

	local var_39_4 = arg_39_0._skill
	local var_39_5 = var_3.GetSkillEffectList(var_39_4)

	ipairs = var_39_4

	for iter_39_6, iter_39_7 in var_39_4(var_39_5) do
