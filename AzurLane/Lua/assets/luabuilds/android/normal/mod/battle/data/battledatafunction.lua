...
function var_0_5.ConvertSkillTemplate()
	...
	var_1_10000(var_1.ConvertedSkill, {
		__index = function(arg_5_0, arg_5_1)
			...
			if var_2_10003.skillCfg[arg_5_1] then
				...
				for iter_5_2, iter_5_3 in var_6(var_3) do
					...
					for iter_5_4, iter_5_5 in var_12(iter_5_3) do
...
function var_0_5.ConvertBuffTemplate()
	...
	var_1_10000(var_1.ConvertedBuff, {
		__index = function(arg_8_0, arg_8_1)
			...
			if var_2_10003.buffCfg[arg_8_1] then
				...
				for iter_8_2, iter_8_3 in var_6(var_3) do
					...
					for iter_8_4, iter_8_5 in var_12(iter_8_3) do
...
function var_0_5.GetBuffBulletRes(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	for iter_9_0, iter_9_1 in var_11(arg_9_1) do
		table = var_1_10016
	...
	for iter_9_2, iter_9_3 in var_12(var_9_5) do
		...
		for iter_9_4, iter_9_5 in var_18(var_9_6) do
	...
	if var_0_5.GetShipTransformDataTemplate(arg_9_0) and var_12.skill_id ~= 0 then
		...
		if var_13.transform_data_template[var_12.skill_id].skill_id ~= 0 then
			...
			for iter_9_6, iter_9_7 in var_16(var_9_9) do
...
function var_0_5.GetResFromBuff(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	for iter_13_4, iter_13_5 in var_7(var_6.effect_list) do
		if iter_13_5.arg_list.skill_id ~= nil then
			...
			for iter_13_6, iter_13_12 in var_1_10014(var_13_3) do
		...
		if iter_13_5.arg_list.skill_id_list ~= nil then
			...
			for iter_13_8, iter_13_12 in var_1_10014(var_13) do
				...
				for iter_13_10, iter_13_11 in var_20(var_13_4) do
		...
		if iter_13_5.arg_list.damage_attr_list ~= nil then
			...
			for iter_13_12, iter_13_13 in var_1_10015(var_1_10014) do
				local var_13_5 = var_0_5.GetResFromSkill(iter_13_13, arg_13_1, arg_13_2, arg_13_3)

				ipairs = var_21

				for iter_13_14, iter_13_15 in var_21(var_13_5) do
		...
		if iter_13_5.arg_list.bullet_id then
			local var_13_6 = var_0.Battle.BattleResourceManager.GetBulletResource(var_1_10015)

			ipairs = var_17

			for iter_13_16, iter_13_17 in var_17(var_13_6) do
		...
		if iter_13_5.arg_list.aircraft_id_list then
			...
			for iter_13_18, iter_13_19 in iter_13_12(var_17) do
				var_0_5.getWeaponResource(iter_13_19, var_13_0)
			end
		end

		if iter_13_5.arg_list.skin_id then
			local var_13_7 = var_0.Battle.BattleResourceManager.GetEquipSkinBulletRes(iter_13_12)

			ipairs = var_20

			for iter_13_20, iter_13_21 in var_20(var_13_7) do
				var_13_0[#var_13_0 + 1] = iter_13_21
			end
		end

		if iter_13_5.arg_list.ship_skin_id then
			local var_13_8 = var_0_5.GetPlayerShipSkinDataFromID(var_19)

			var_13_0[#var_13_0 + 1] = var_0.Battle.BattleResourceManager.GetCharacterPath(var_13_8.prefab)
		end

		if iter_13_5.arg_list.buff_id then
			local var_13_9 = var_0_5.GetResFromBuff(var_20, arg_13_1, arg_13_2, arg_13_3)

			ipairs = var_22

			for iter_13_22, iter_13_23 in var_22(var_13_9) do
				type = iter_13_27
		...
		if iter_13_5.arg_list.buff_skin_id then
			local var_13_10 = var_0_5.GetResFromBuff(var_21, arg_13_1, arg_13_2, arg_13_3)

			ipairs = var_23

			for iter_13_26, iter_13_27 in var_23(var_13_10) do
				type = var_1_10028
		...
		if iter_13_5.arg_list.effect then
			var_13_0[#var_13_0 + 1] = var_0.Battle.BattleResourceManager.GetFXPath(var_22)
		end
	end
	...
	local function var_15_2(arg_16_0)
		...
		for iter_16_0, iter_16_1 in var_2_10001(arg_16_0) do
			...
			if iter_16_1.type == var_0.Battle.BattleSkillFusion.__name then
				...
				for iter_16_4, iter_16_11 in var_9(var_16_2) do
				...
				for iter_16_11, iter_16_7 in var_10(var_16_3) do
					local var_16_4 = var_0_5.GetResFromBuff(iter_16_7, arg_15_1, arg_15_2)

					ipairs = var_16

					for iter_16_8, iter_16_9 in var_16(var_16_4) do
			...
			if iter_16_1.arg_list.buff_id then
				local var_16_5 = var_0_5.GetResFromBuff(var_7, arg_15_1, arg_15_2)

				ipairs = var_9

				for iter_16_10, iter_16_11 in var_9(var_16_5) do
			...
			if iter_16_1.arg_list.damage_buff_id then
				...
				local var_16_7 = var_0_5.GetResFromBuff(var_8, var_16_6, arg_15_2)

				ipairs = var_11

				for iter_16_12, iter_16_13 in var_11(var_16_7) do
					var_15_0[#var_15_0 + 1] = iter_16_13
				end
			end

			if iter_16_1.arg_list.effect then
				var_15_0[#var_15_0 + 1] = var_0.Battle.BattleResourceManager.GetFXPath(var_9)
			end

			if iter_16_1.arg_list.finale_effect then
				var_15_0[#var_15_0 + 1] = var_0.Battle.BattleResourceManager.GetFXPath(var_10)
			end

			if iter_16_1.arg_list.spawnData then
				local var_16_8 = var_0.Battle.BattleResourceManager.GetMonsterRes(var_11)

				ipairs = iter_16_11

				for iter_16_14, iter_16_15 in iter_16_11(var_16_8) do
...
function var_0_5.GetShipSkillTriggerCount(arg_17_0, arg_17_1)
	local function var_17_0(arg_18_0)
		...
		for iter_18_0, iter_18_1 in var_2_10002(arg_18_0) do
			...
			for iter_18_2, iter_18_3 in var_2_10009(var_18_1) do
	...
	for iter_17_0, iter_17_1 in var_1_10007(var_17_4) do
		table = var_1_10012
...
function var_0_5.GetSongList(arg_19_0)
	...
	for iter_19_0, iter_19_1 in var_2(arg_19_0) do
		...
		for iter_19_2, iter_19_3 in var_8(var_19_1.effect_list) do
...
function var_0_5.GetCardRes(arg_20_0)
	...
	for iter_20_0, iter_20_1 in var_3(var_20_1.effect_list) do
		local var_20_2 = var_0_5.GetCardFXRes(iter_20_1)

		ipairs = var_9

		for iter_20_2, iter_20_3 in var_9(var_20_2) do
			table = var_1_10014
	...
	for iter_20_4, iter_20_5 in var_3(var_20_1.effect_list) do
		...
		for iter_20_6, iter_20_7 in var_9(var_20_3) do
			table = var_1_10014
...
function var_0_5.GetCardFXRes(arg_21_0)
	...
	for iter_21_0, iter_21_1 in var_1_10002(arg_21_0) do
		if iter_21_1.type == "BattleCardPuzzleSkillCreateCard" then
			...
			for iter_21_2, iter_21_3 in var_8(var_21_1) do
				table = var_1_10013
		...
		elseif iter_21_1.type == "BattleCardPuzzleSkillFire" then
			...
			for iter_21_4, iter_21_5 in var_8(var_21_2) do
				table = var_1_10013
		...
		elseif iter_21_1.type == "BattleCardPuzzleSkillAddBuff" then
			...
			for iter_21_6, iter_21_7 in var_8(var_21_3) do
				table = var_1_10013
...
function var_0_5.GetLimitAttributeRange(arg_27_0, arg_27_1)
	...
	if var_1_10002.battle_attribute_range[arg_27_0] then
		...
		local var_27_2 = var_1_10004.battle_attribute_range[arg_27_0].min / 16

		pg = var_1_10005

		return var_27_0(var_27_1, var_27_2, var_1_10005.battle_attribute_range[arg_27_0].max / 16)
	end
