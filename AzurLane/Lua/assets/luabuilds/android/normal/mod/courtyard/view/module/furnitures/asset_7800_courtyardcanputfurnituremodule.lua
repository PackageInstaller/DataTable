...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".CourtYardFurnitureModule"))
local var_0_2 = false
...
function var_0_1.OnInit(arg_2_0)
	...
	if var_0_2 then
		...
		Color = var_1_10003
		arg_2_0.mapDebug = var_2_0(var_2_1, var_1_10003.New(1, 0, 0))
		GetOrAddComponent = var_1

		local var_2_2 = arg_2_0
		local var_2_3 = arg_2_0.GetParentTF(var_2_2)

		typeof = var_2_2
		CanvasGroup = var_4
		var_1(var_2_3, var_2_2(var_4)).alpha = 0.3
	end
...
function var_0_1.AddListeners(arg_5_0)
	...
	var_5_1(var_5_0, var_1_10003.REMOVE_ITEM, arg_5_0.OnRemoveItem)
	...
	var_5_3(var_5_2, var_3.ADD_ITEM, arg_5_0.OnAddItem)
...
function var_0_1.RemoveListeners(arg_6_0)
	...
	var_6_1(var_6_0, var_1_10003.REMOVE_ITEM, arg_6_0.OnRemoveItem)
	...
	var_6_3(var_6_2, var_3.ADD_ITEM, arg_6_0.OnAddItem)
...
function var_0_1.RefreshDepth(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10001(var_2.GetItems(var_12_0)) do
...
function var_0_1.Dispose(arg_14_0)
	...
	if var_0_2 then
		...
		local var_14_2 = arg_14_0.GetParentTF(var_14_1)

		typeof = var_14_1
		CanvasGroup = var_1_10004
		var_1(var_14_2, var_14_1(var_1_10004)).alpha = 1
	end
