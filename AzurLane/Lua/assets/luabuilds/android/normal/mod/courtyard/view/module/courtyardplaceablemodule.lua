...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.cg = var_1_1(var_1_0, var_1_10005(var_1_10006))
	...
	Vector3 = var_5
	var_1_12.localScale = var_5(var_1_11 == 1 and 1 or -1, 1, 1)
	setParent = var_1_12
	...
	local var_1_16 = var_6.GetPosition(var_1_15)

	Vector3 = var_1_15

	var_1_14(var_1_13, var_1_16, var_1_15.zero)
...
function var_0_1.OnInit(arg_4_0)
	...
	arg_4_0.dragAgent = var_4_0(var_4_1, var_3.GetRect(var_4_2))
...
function var_0_1.NewBoneFollower(arg_7_0, arg_7_1)
	...
	local var_7_3 = var_7_1(var_7_2, var_1_10005(var_1_10006)).transform
	...
	local var_7_5 = var_5(var_7_4, var_7(var_8.Unity.BoneFollowerGraphic))
...
function var_0_1.PuddingAnim(arg_9_0)
	...
	local var_9_4 = var_1_10004(arg_9_0._tf)

	Vector3 = var_5

	local var_9_5 = var_9_3(var_9_4, var_5(var_9_0 + 0.2, var_9_1 + 0.2, 1), 0.2)
	local var_9_6 = var_3.setFrom(var_9_5, 0)
	local var_9_7 = var_3.setOnComplete

	System = var_5

	var_9_7(var_9_6, var_5.Action(function()
		...
		local var_10_1 = var_2_10001(arg_9_0._tf)

		Vector3 = var_2

		local var_10_2 = var_10_0(var_10_1, var_2(var_9_0, var_9_1, 1), 0.1)
		local var_10_3 = var_0.setOnComplete

		System = var_2

		var_10_3(var_10_2, var_2.Action(function()
...
function var_0_1.CancelPuddingAnim(arg_12_0)
	if arg_12_0.doPuddingAniming then
		...
		Vector3 = var_2
		var_12_0.localScale = var_2(arg_12_0.normalX, arg_12_0.normalY, 1)
...
function var_0_1.GetParentTF(arg_13_0)
	...
	CourtYardConst = var_13_0

	if var_13_1 == var_13_0.DEPTH_TYPE_MAT then
		return arg_13_0.mat
	else
...
function var_0_1.UpdatePosition(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_3 = var_1_10005.TrPosition2LocalPos(arg_19_0:GetParentTF(), arg_19_0._tf.parent, var_19_2)

	arg_19_0._tf.localPosition = var_19_3
