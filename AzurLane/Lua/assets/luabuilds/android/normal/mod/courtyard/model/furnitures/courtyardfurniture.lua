...
local var_0_1 = var_0_10000(var_0_0, var_0_10002("..map.CourtYardDepthItem"))
...
function var_0_1.InitSlots(arg_2_0)
	...
	if arg_2_0:IsSpine() then
		...
		CourtYardFurnitureSpineSlot = var_1_10003

		var_2_0(var_2_1, var_1_10003.New(1, arg_2_0.config.spine, arg_2_0.config.spine_combine_action_replace, arg_2_0.host))
		...
		if var_2_0(arg_2_0.config.spine_extra) == "table" then
			...
			for iter_2_0, iter_2_1 in var_2_0(arg_2_0.config.spine_extra) do
				...
				var_1_10008 = arg_2_0.slots
				CourtYardFurnitureSpineSlot = var_1_10009

				var_2_2(var_1_10008, var_1_10009.New(iter_2_0 + 1, var_1_10006, arg_2_0.config.spine_combine_action_replace, arg_2_0.host))
			end
		end
			...
			if var_2_0(arg_2_0.config.followBone[1]) == "table" then
				...
				for iter_2_2, iter_2_3 in var_2_0(arg_2_0.config.followBone) do
					if arg_2_0.slots[iter_2_2] then
						var_1_10008 = var_1_10006

						var_1_10006.SetFollower(var_1_10008, iter_2_3)
					end
				end
			else
				type = var_2_0
		...
		if var_2_0(arg_2_0.config.interAction) == "table" then
			...
			for iter_2_8, iter_2_9 in var_1(arg_2_0.config.interAction) do
				...
				CourtYardFurnitureSlot = var_1_10008

				var_1_10006(var_2_4, var_1_10008.New(iter_2_8, iter_2_9, arg_2_0.config.spine_combine_action_replace, arg_2_0.host))
			end
		end
	end
...
function var_0_1._InitMusicData(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	local var_4_1 = var_6(arg_4_3) == "table" and arg_4_3 or {
		arg_4_3
	}
...
function var_0_1.DisableRotation(arg_7_0)
	...
	if arg_7_0.config.can_rotate == 0 then
		...
		if not var_7_1(var_7_0, var_1_10003.TYPE_WALL) then
			local var_7_2 = arg_7_0

			var_7_1 = arg_7_0.IsType
			Furniture = var_3
			var_7_1 = var_7_1(var_7_2, var_3.TYPE_WALL_MAT)
		end
...
function var_0_1.IsMusicalInstruments(arg_9_0)
	...
	return var_9_1(var_9_0, var_1_10003.TYPE_LUTE)
end
...
function var_0_1.IsRandomSlotType(arg_10_0)
	...
	return var_10_1(var_10_0, var_1_10003.TYPE_RANDOM_SLOT)
end
...
function var_0_1.SetPosition(arg_12_0, arg_12_1)
	...
	var_12_1(var_12_0, var_4.FURNITURE_POSITION_CHANGE, arg_12_1, arg_12_0:GetOffset())
...
function var_0_1.UpdateOpFlag(arg_13_0, arg_13_1)
	...
	var_13_1(var_13_0, var_4.FURNITURE_OP_FLAG_CHANGE, arg_13_0.opFlag)
...
function var_0_1.IsOverlap(arg_19_0, arg_19_1)
	...
	local var_19_1 = arg_19_0.GetArea(var_19_0)

	_ = var_19_0

	return var_19_0.any(var_19_1, function(arg_20_0)
...
function var_0_1.Rotate(arg_21_0)
	...
	var_21_2(var_21_1, var_4.ROTATE_FURNITURE, arg_21_0.dir)
...
function var_0_1.GetGametipType(arg_32_0)
	...
	i18n = var_1_10003
	var_32_1[1] = var_1_10003("word_wallpaper")
	i18n = var_3
	var_32_1[2] = var_3("word_furniture")
	i18n = var_3
	var_32_1[3] = var_3("word_decorate")
	i18n = var_3
	var_32_1[4] = var_3("word_floorpaper")
	i18n = var_3
	var_32_1[5] = var_3("word_mat")
	i18n = var_3
	var_32_1[6] = var_3("word_wall")
	i18n = var_3
	var_32_1[7] = var_3("word_collection")
	i18n = var_3
	var_32_1[15] = var_3("word_collection")
...
function var_0_1.GetTouchAction(arg_34_0)
	if arg_34_0:CanTouch() then
		...
		var_1_10003.insert(var_34_1, var_34_0[1][3][1])

		ipairs = var_3

		local var_34_2

		if not var_34_0[1][3][3] then
			var_34_2 = {}
		end

		for iter_34_0, iter_34_1 in var_3(var_34_2) do
			table = var_1_10008

			var_1_10008.insert(var_34_1, iter_34_1)
		end

		math = var_3

		return var_34_1[var_3.random(1, #var_34_1)], var_34_0[1][3][2]
	end
...
function var_0_1.GetTouchSound(arg_38_0)
	...
	if arg_38_0.CanTouch(var_38_0) then
		local var_38_1 = arg_38_0.config.spine[1][3][4]

		type = var_38_0

		if var_38_0(var_38_1) == "table" then
			math = var_2

			return var_38_1[var_2.random(1, #var_38_1)]
		else
			return var_38_1
		end
	end
...
function var_0_1.GetInteractionSlot(arg_54_0)
	...
	if arg_54_0.IsRandomSlotType(var_54_0) then
		var_54_1 = {}
		ipairs = var_54_0

		for iter_54_0, iter_54_1 in var_54_0(arg_54_0.slots) do
			if iter_54_1:IsEmpty() then
				table = var_7

				var_7.insert(var_54_1, iter_54_1)
			end
		end

		math = var_2

		return var_54_1[var_2.random(1, #var_54_1)]
	else
		_ = var_54_1

		return var_54_1.detect(arg_54_0.slots, function(arg_55_0)
...
function var_0_1._ChangeState(arg_56_0, arg_56_1)
	...
	var_56_1(var_56_0, var_1_10004.FURNITURE_STATE_CHANGE, arg_56_1)
...
function var_0_1.WillInteraction(arg_60_0, arg_60_1)
	...
	var_60_1(var_60_0, var_1_10004.FURNITURE_WILL_INTERACTION, arg_60_1)
...
function var_0_1.StartInteraction(arg_61_0, arg_61_1)
	...
	var_1_10003.each(arg_61_0.slots, function(arg_62_0)
		if arg_62_0.id ~= arg_61_1.id and arg_62_0:IsUsing() then
			...
			var_62_1(var_62_0, var_3.FURNITURE_STOP_INTERACTION, arg_62_0)
		end
	...
	for iter_61_0, iter_61_1 in var_3(var_61_0) do
		...
		var_61_2(var_61_1, var_1_10010.FURNITURE_START_INTERACTION, iter_61_1)
	end
	...
	var_61_4(var_61_3, var_5.FURNITURE_START_INTERACTION, arg_61_1)
...
function var_0_1.UpdateInteraction(arg_64_0, ...)
	...
	var_64_1(var_64_0, var_1_10003.FURNITURE_UPDATE_INTERACTION, ...)
...
function var_0_1.ClearInteraction(arg_67_0, arg_67_1)
	...
	for iter_67_0, iter_67_1 in var_3(var_67_0) do
		iter_67_1:Reset()
	end
	...
	var_3(function()
		...
		CourtYardEvent = var_2_10002

		var_69_1(var_69_0, var_2_10002.FURNITURE_STOP_INTERACTION, arg_67_1)
