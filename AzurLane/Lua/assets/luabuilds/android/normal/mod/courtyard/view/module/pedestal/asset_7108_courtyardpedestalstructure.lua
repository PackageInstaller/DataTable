...
function var_0_0.Load(arg_11_0, arg_11_1)
	...
	local var_11_2 = arg_11_0:GetAssetPath()
	local var_11_3 = ""

	typeof = var_1_10006
	GameObject = var_1_10007

	local var_11_4 = var_1_10006(var_1_10007)

	UnityEngine = var_1_10007

	var_11_1(var_11_0, var_11_2, var_11_3, var_11_4, var_1_10007.Events.UnityAction_UnityEngine_Object(function(arg_12_0)
		...
		if not var_1.IsExit(var_12_0) then
			...
			local var_12_7 = var_12_4(var_12_5, var_3.GetParent(var_12_6))
