...
function var_0_1.SetLevel(arg_3_0, arg_3_1)
	...
	var_3_5(var_3_4, var_1_10006(var_3_3, var_3_3))
	...
	var_3_7(var_3_6, var_6.UPDATE_STOREY, arg_3_1)
...
function var_0_1.LevelUp(arg_4_0)
	...
	var_4_2(var_4_1, var_4.UPDATE_FLOORPAPER, arg_4_0.floorPaper)
	...
	var_4_4(var_4_3, var_4.UPDATE_WALLPAPER, arg_4_0.wallPaper)
...
function var_0_1.SetWallPaper(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_1_10004.UPDATE_WALLPAPER, arg_5_1)
...
function var_0_1.SetFloorPaper(arg_6_0, arg_6_1)
	...
	var_6_1(var_6_0, var_1_10004.UPDATE_FLOORPAPER, arg_6_1)
...
function var_0_1.AddFurniture(arg_15_0, arg_15_1, arg_15_2)
	...
	var_15_1(var_15_0, var_1_10005.CREATE_ITEM, arg_15_1, arg_15_2)
...
function var_0_1.AddPaper(arg_17_0, arg_17_1)
	...
	local var_17_1 = arg_17_1.GetType(var_17_0)

	Furniture = var_17_0

	if var_17_1 == var_17_0.TYPE_WALLPAPER then
		arg_17_0:SetWallPaper(arg_17_1)
	else
		Furniture = var_3

		if var_17_1 == var_3.TYPE_FLOORPAPER then
...
function var_0_1.AddChildFurniture(arg_18_0, arg_18_1, arg_18_2)
	...
	var_18_1(var_18_0, var_1_10005.CREATE_ITEM, arg_18_1)
	...
	var_18_4(var_18_3, var_6.CHILD_ITEM, arg_18_1, var_18_2)
...
function var_0_1.AddShip(arg_20_0, arg_20_1)
	...
	var_20_1(var_20_0, var_1_10004.STATE_IDLE)
	...
	var_20_3(var_20_2, var_4.CREATE_ITEM, arg_20_1)
...
function var_0_1.RemoveShip(arg_22_0, arg_22_1)
	...
	var_22_3(var_22_2, var_5.DETORY_ITEM, arg_22_1)
	...
	if var_22_4[var_22_5 + var_5.DOUBLE_SKIN_ADD] then
		...
		var_22_7(var_22_6, var_22_8[var_22_9 + var_1_10007.DOUBLE_SKIN_ADD])
	end
...
function var_0_1.CheckShipState(arg_24_0)
	...
	for iter_24_0, iter_24_1 in var_1_10001(arg_24_0:GetShips()) do
		...
		local var_24_1 = iter_24_1.GetState(var_24_0)

		CourtYardShip = var_24_0

		if var_24_1 == var_24_0.STATE_MOVE then
			arg_24_0:ReadyMoveShip(iter_24_1.id)
		else
			CourtYardShip = var_7

			if var_24_1 == var_7.STATE_MOVING_HALF then
...
function var_0_1.ReadyMoveShip(arg_25_0, arg_25_1)
	...
	if var_1_10006.HalfProbability() then
		if var_25_0:HasParent() then
			...
			if var_25_5(var_25_4, var_1_10008.TYPE_ARCH) then
...
function var_0_1.ShipAddFollower(arg_26_0, arg_26_1)
	...
	local var_26_2 = var_26_1(var_26_0, var_1_10004.TYPE_FOLLOWER)
	...
	local function var_26_3(arg_27_0)
		...
		return var_2_10001.detect(var_26_2, function(arg_28_0)
			...
			local var_28_1 = arg_28_0.GetArea(var_28_0)

			_ = var_28_0

			return var_28_0.any(var_28_1, function(arg_29_0)
	...
	for iter_26_0, iter_26_1 in var_1_10005(arg_26_1:GetAroundPositions()) do
...
function var_0_1.ShipExitArch(arg_31_0, arg_31_1)
	if arg_31_0:GetNextPositionForMove(arg_31_1) then
		...
		var_31_2(var_31_1, var_6.UN_CHILD_ITEM, arg_31_1, var_3)
		...
		var_31_4(var_31_3, var_6.EXIT_ARCH, arg_31_1, var_3)
...
function var_0_1.ShipEnterArch(arg_32_0, arg_32_1)
	local function var_32_0(arg_33_0, arg_33_1)
		...
		var_33_2(var_33_1, var_4.CHILD_ITEM, arg_32_1, arg_33_0)
		...
		var_33_4(var_33_3, var_4.ENTER_ARCH, arg_32_1, arg_33_0)
	...
	for iter_32_0, iter_32_1 in var_1_10003(arg_32_1:GetAroundPositions()) do
		if arg_32_0:GetParentForItem(arg_32_1, iter_32_1) then
			...
			if var_32_2(var_32_1, var_11.TYPE_ARCH) then
...
function var_0_1.RandomNextShipPosition(arg_34_0, arg_34_1)
	...
	if not var_3.GetNextPositionForMove(var_34_1, var_34_0) then
		...
		var_34_3(var_34_2, var_1_10007.STATE_IDLE)
...
function var_0_1.MoveShipToNextPosition(arg_35_0, arg_35_1)
	...
	var_35_4(var_35_3, var_7.STATE_MOVING_ONE)
...
function var_0_1.DragShip(arg_36_0, arg_36_1)
	...
	local var_36_2 = var_36_0:GetPosition()
	local var_36_3 = var_36_0

	if var_36_0.GetInterActionData(var_36_3) == nil then
		local var_36_4 = var_36_0

		var_36_3 = var_36_0.GetState(var_36_4)
		CourtYardShip = var_36_4

		if var_36_3 == var_36_4.STATE_INTERACT then
			isa = var_36_3

			local var_36_5 = var_5

			CourtYardFollowerSlot = var_1_10008

			if var_36_3(var_36_5, var_1_10008) then
				arg_36_0:RemoveItem(var_36_0)
			end

			var_5:Stop()
		elseif var_36_0:HasParent() then
			var_1_10008 = var_36_0:GetParent()

			var_6.RemoveChild(var_1_10008, var_36_0)

			var_1_10008 = var_36_0

			local var_36_6 = var_36_0.ChangeState

			CourtYardShip = var_9

			var_36_6(var_1_10008, var_9.STATE_IDLE)

			var_1_10008 = arg_36_0

			local var_36_7 = arg_36_0.DispatchEvent

			CourtYardEvent = var_9

			var_36_7(var_1_10008, var_9.UN_CHILD_ITEM, var_36_0, var_6)
		else
			arg_36_0:RemoveItem(var_36_0)
		end
		...
		var_36_9(var_36_8, var_1_10008.STATE_DRAG)

		local var_36_10 = arg_36_0:AreaWithInfo(var_36_0, var_36_2, var_36_0:GetOffset())
		...
		var_36_12(var_36_11, var_9.SELETED_ITEM, var_36_0, var_36_10)
		...
		var_36_14(var_36_13, var_9.DRAG_ITEM, var_36_0)
...
function var_0_1.DragingShip(arg_37_0, arg_37_1, arg_37_2)
	...
	var_37_6(var_37_5, var_10.DRAGING_ITEM, var_3, var_37_4, arg_37_2, var_37_3)
...
function var_0_1.DragShipEnd(arg_38_0, arg_38_1, arg_38_2)
	...
	local var_38_3 = arg_38_0:GetParentForItem(var_3, arg_38_2)
	local var_38_4

	if not var_38_1 and var_38_2 then
		isa = var_8

		local var_38_5 = var_38_2

		CourtYardFollowerFurniture = var_1_10010

		if var_8(var_38_5, var_1_10010) then
			arg_38_0:RemoveItemAndRefresh(var_38_2)
			arg_38_0:ResetShip(var_3, arg_38_2)

			local var_38_6 = var_3
			local var_38_7 = var_3.ChangeState

			CourtYardShip = var_10

			var_38_7(var_38_6, var_10.STATE_MOVE)
		end

		local var_38_8 = var_38_2:GetInteractionSlot()

		var_8.Occupy(var_38_8, var_38_2, var_3, arg_38_0)
	elseif not var_38_1 and var_38_3 then
		var_3:SetPosition(arg_38_2)

		local var_38_9 = arg_38_0
		local var_38_10 = arg_38_0.DispatchEvent

		CourtYardEvent = var_10

		var_38_10(var_38_9, var_10.CHILD_ITEM, var_3, var_38_3)
		var_38_3:AddChild(var_3)

		local var_38_11 = var_3
		local var_38_12 = var_3.ChangeState

		CourtYardShip = var_10

		var_38_12(var_38_11, var_10.STATE_IDLE)

		var_38_4 = var_38_3:AreaWithInfo(var_3, arg_38_2, var_38_3:RawGetOffset(), true)
	else
		local var_38_13 = var_38_1 and arg_38_2 or var_3:GetPosition()

		arg_38_0:ResetShip(var_3, var_38_13)

		var_38_4 = arg_38_0:AreaWithInfo(var_3, var_38_13, var_3:GetOffset(), true)
	end

	var_3:UpdateOpFlag(false)

	local var_38_14 = arg_38_0
	local var_38_15 = arg_38_0.DispatchEvent

	CourtYardEvent = var_10

	var_38_15(var_38_14, var_10.DRAG_ITEM_END, var_38_4)

	local var_38_16 = arg_38_0
	local var_38_17 = arg_38_0.DispatchEvent

	CourtYardEvent = var_10

	var_38_17(var_38_16, var_10.UNSELETED_ITEM, var_3)
...
function var_0_1.TouchShip(arg_40_0, arg_40_1)
	...
	var_40_3(var_40_2, var_6.STATE_TOUCH)
...
function var_0_1.ShipAnimtionFinish(arg_46_0, arg_46_1, arg_46_2)
	...
	if arg_46_2 ~= var_1_10004.STATE_TOUCH then
		...
		if arg_46_2 == var_46_2.STATE_GETAWARD then
			...
			var_46_2(var_46_1, var_1_10006.STATE_IDLE)
		else
			CourtYardShip = var_46_2
...
function var_0_1.ResetShip(arg_47_0, arg_47_1, arg_47_2)
	local function var_47_0(arg_48_0, arg_48_1)
		...
		var_48_1(var_48_0, var_4.STATE_IDLE)
	...
	elseif arg_47_0:GetRandomPosition(arg_47_1) then
		...
		var_47_2(var_47_1, var_7._NO_POS_TO_ADD_SHIP, arg_47_1.id)
	end
...
function var_0_1.SelectFurniture(arg_49_0, arg_49_1)
	...
	var_49_5(var_49_4, var_8.SELETED_ITEM, var_2, var_49_3)
...
function var_0_1.ClickFurniture(arg_51_0, arg_51_1)
	...
	if var_2.HasDescription(var_51_0) then
		...
		var_51_2(var_51_1, var_1_10005.SHOW_FURNITURE_DESC, var_2)
	elseif var_2:CanTouch() then
		...
		if not var_2:IsTouchState() then
			...
			var_51_4(var_51_3, var_1_10006.STATE_TOUCH)
			...
			var_51_6(var_51_5, var_1_10006.ON_TOUCH_ITEM, var_2)
		else
			...
			var_51_8(var_51_7, var_1_10006.STATE_IDLE)
			...
			var_51_10(var_51_9, var_6.ON_CANCEL_TOUCH_ITEM, var_2)
		end
	end
...
function var_0_1.CheckFurnitureTouchBG(arg_52_0, arg_52_1)
	...
	for iter_52_0, iter_52_1 in var_1_10002(arg_52_0.furnitures) do
		if iter_52_1.id ~= arg_52_1.id and iter_52_1:IsTouchState() and iter_52_1:GetTouchBg() then
			...
			CourtYardFurniture = var_1_10009

			var_52_1(var_52_0, var_1_10009.STATE_IDLE)
			...
			var_52_3(var_52_2, var_1_10009.ON_CANCEL_TOUCH_ITEM, iter_52_1)
		end
	end
...
function var_0_1.PlayMusicalInstruments(arg_53_0, arg_53_1)
	...
	var_53_2(var_53_1, var_1_10005.FURNITURE_PLAY_MUSICALINSTRUMENTS, var_53_0)
...
function var_0_1.StopPlayMusicalInstruments(arg_54_0, arg_54_1)
	...
	var_54_2(var_54_1, var_1_10005.FURNITURE_STOP_PLAY_MUSICALINSTRUMENTS, var_54_0)
...
function var_0_1.PlayFurnitureVoice(arg_55_0, arg_55_1)
	...
	if #var_1_10003.select(var_55_0.musicDatas, function(arg_56_0)
		...
		var_55_3(var_55_2, var_1_10007.ON_ITEM_PLAY_MUSIC, var_55_1.voice, var_55_1.voiceType)
	end
...
function var_0_1.PlayFurnitureBg(arg_57_0, arg_57_1)
	...
	var_57_2(var_57_1, var_1_10006.STATE_PLAY_MUSIC)
	...
	if var_57_0:GetMusicData() then
		...
		var_57_4(var_57_3, var_1_10007.ON_ITEM_PLAY_MUSIC, var_4.voice, var_4.voiceType)
	end
...
function var_0_1.MuteAll(arg_58_0)
	...
	for iter_58_0, iter_58_1 in var_1_10001(arg_58_0.furnitures) do
		if iter_58_1:GetMusicData() then
			...
			var_58_2(var_58_1, var_1_10010.ON_ITEM_STOP_MUSIC, var_58_0.voice, var_58_0.voiceType)
			...
			var_58_4(var_58_3, var_1_10010.STATE_STOP_MUSIC)
		end
	end
	...
	var_58_6(var_58_5, var_3.FURNITURE_MUTE_ALL)
...
function var_0_1.StopPrevFurnitureVoice(arg_59_0)
	...
	if var_59_0 then
		...
		CourtYardEvent = iter_59_0

		var_59_3(var_59_2, iter_59_0.ON_ITEM_STOP_MUSIC, var_59_1.voice, var_59_1.voiceType)
		...
		var_59_5(var_59_4, var_5.STATE_STOP_MUSIC)
	end
...
function var_0_1.FurnitureAnimtionFinish(arg_60_0, arg_60_1, arg_60_2)
	...
	if arg_60_2 == var_1_10004.STATE_TOUCH then
		...
		var_60_2(var_60_1, var_1_10006.STATE_IDLE)
	else
		...
		if arg_60_2 == var_60_2.STATE_INTERACT then
			local var_60_3 = var_60_0

			var_60_4 = var_60_0.GetUsingSlots(var_60_3)
			_ = var_60_3

			var_60_3.each(var_60_4, function(arg_61_0)
				arg_61_0:Continue(var_60_0)

				return
			end)
		else
			CourtYardFurniture = var_60_4

			if arg_60_2 == var_60_4.STATE_TOUCH_PREPARE then
				local var_60_5 = var_60_0
				local var_60_6 = var_60_0._ChangeState

				CourtYardFurniture = var_1_10006

				var_60_6(var_60_5, var_1_10006.STATE_TOUCH)
			end
		end
	end
...
function var_0_1.BeginDragFurniture(arg_62_0, arg_62_1)
	...
	var_62_2(var_62_1, var_1_10005.STATE_DRAG)
	...
	if var_2:HasParent() then
		...
		var_62_5(var_62_4, var_6.UN_CHILD_ITEM, var_2, var_3)
	else
		...
		var_62_7(var_62_6, var_5.DRAG_ITEM, var_2)
	end
...
function var_0_1.DragingFurniture(arg_63_0, arg_63_1, arg_63_2)
	...
	CourtYardWallFurniture = var_1_10006

	if var_4(var_63_1, var_1_10006) then
	...
	var_63_5(var_63_4, var_1_10009.DRAGING_ITEM, var_3, var_63_3, arg_63_2, var_63_2)
...
function var_0_1.GetParentForItem(arg_64_0, arg_64_1, arg_64_2)
	...
	local var_64_1 = var_64_0(var_1_10004.values(arg_64_0.furnitures), function(arg_65_0)
		isa = var_2_10001

		local var_65_0 = arg_65_0

		CourtYardCanPutFurniture = var_2_10003

		local var_65_1

		if var_2_10001(var_65_0, var_2_10003) then
	...
	var_4.sort(var_64_1, function(arg_66_0, arg_66_1)
...
function var_0_1.DragFurnitureEnd(arg_67_0, arg_67_1, arg_67_2)
	...
	var_67_2(var_67_1, var_1_10006.STATE_IDLE)

	isa = var_67_2

	local var_67_3 = var_3

	CourtYardWallFurniture = var_6

	if var_67_2(var_67_3, var_6) then
		arg_67_2 = var_3:NormalizePosition(arg_67_2, arg_67_0.minSizeX)
	end

	local var_67_4 = arg_67_0

	if not arg_67_0.VerifyDragPositionForFurniture(var_67_4, var_3, arg_67_2) then
		arg_67_0:RemoveFurniture(arg_67_1)

		local var_67_5 = arg_67_0

		var_67_4 = arg_67_0.DispatchEvent
		CourtYardEvent = var_7

		var_67_4(var_67_5, var_7.REMOVE_ILLEGALITY_ITEM)
	...
	local var_67_6 = var_3

	CourtYardWallFurniture = var_7

	if var_67_4(var_67_6, var_7) then
		var_3:UpdatePosition(var_4)
	else
		var_3:SetPosition(var_4)
	end

	local var_67_7 = arg_67_0:GetParentForItem(var_3, var_4)
	local var_67_8

	if var_67_7 then
		local var_67_9 = arg_67_0
		local var_67_10 = arg_67_0.DispatchEvent

		CourtYardEvent = var_1_10009

		var_67_10(var_67_9, var_1_10009.CHILD_ITEM, var_3, var_67_7)
		var_67_7:AddChild(var_3)

		var_67_8 = var_67_7:AreaWithInfo(var_3, var_4, var_67_7:RawGetOffset(), true)
	else
		arg_67_0:AddItem(var_3)

		var_67_8 = arg_67_0:AreaWithInfo(var_3, var_4, var_3:GetOffset(), true)
	end

	local var_67_11 = arg_67_0
	local var_67_12 = arg_67_0.DispatchEvent

	CourtYardEvent = var_1_10009

	var_67_12(var_67_11, var_1_10009.DRAG_ITEM_END, var_3, var_67_8)
...
function var_0_1.VerifyDragPositionForFurniture(arg_70_0, arg_70_1, arg_70_2)
	...
	if arg_70_0:IsLegalAreaForFurniture(arg_70_1, arg_70_2) then
		...
		if arg_70_1.GetPosition(var_70_1) then
			isa = var_70_1
			...
			if var_70_1(var_70_2, var_7) then
		...
		if var_4 and arg_70_0:IsLegalAreaForFurniture(arg_70_1, var_4) then
			...
			if var_4 then
				...
				if var_70_1(var_70_3, var_7) then
...
function var_0_1.UnSelectFurniture(arg_71_0, arg_71_1)
	...
	var_71_2(var_71_1, var_5.UNSELETED_ITEM, var_2)
...
function var_0_1.RotateFurniture(arg_72_0, arg_72_1)
	...
	if var_2.DisableRotation(var_72_0) then
		...
		var_72_2(var_72_1, var_1_10005.DISABLE_ROTATE_ITEM)
	elseif not arg_72_0:CanRotateItem(var_2) then
		...
		var_72_4(var_72_3, var_5.ROTATE_ITEM_FAILED)
	else
		...
		var_72_7(var_72_6, var_7.ROTATE_ITEM, var_2, var_72_5)
	end
...
function var_0_1.RemoveFurniture(arg_73_0, arg_73_1)
	...
	if var_2:GetMusicData() then
		...
		CourtYardEvent = iter_73_0

		var_73_4(var_73_3, iter_73_0.ON_ITEM_STOP_MUSIC, var_5.voice, var_5.voiceType)

		local var_73_5 = var_2
		local var_73_6 = var_2.ChangeState

		CourtYardFurniture = var_8

		var_73_6(var_73_5, var_8.STATE_STOP_MUSIC)
	end
	...
	var_73_10(var_73_9, var_1_10009.DETORY_ITEM, var_2)
...
function var_0_1.CheckFurnitureState(arg_76_0)
	...
	for iter_76_0, iter_76_1 in var_1_10001(arg_76_0.furnitures) do
		...
		if var_76_1(var_76_0, var_1_10008.TYPE_MOVEABLE) and iter_76_1:IsReadyMove() then
...
function var_0_1.EnterEditMode(arg_79_0)
	...
	for iter_79_0, iter_79_1 in var_1(arg_79_0.ships) do
		local var_79_0 = iter_79_1
		local var_79_1 = iter_79_1.GetState(var_79_0)

		CourtYardShip = var_79_0

		if var_79_1 == var_79_0.STATE_DRAG then
			local var_79_2 = arg_79_0
			local var_79_3 = arg_79_0.DragShipEnd

			var_1_10008 = iter_79_1.id
			Vector2 = var_1_10009

			var_79_3(var_79_2, var_1_10008, var_1_10009(-1, -1))
		end

		var_1_10008 = arg_79_0:GetPlaceableArea(iter_79_1)

		var_6._ClearLockPosition(var_1_10008, iter_79_1)

		var_1_10008 = iter_79_1

		if iter_79_1.HasParent(var_1_10008) then
			var_1_10008 = iter_79_1
			var_1_10009 = iter_79_1.GetParent(var_1_10008)

			var_7.RemoveChild(var_1_10009, iter_79_1)

			var_1_10009 = arg_79_0
			var_1_10008 = arg_79_0.DispatchEvent
			CourtYardEvent = var_10

			var_1_10008(var_1_10009, var_10.UN_CHILD_ITEM, iter_79_1, var_7)
		else
			var_1_10008 = arg_79_0

			arg_79_0.RemoveItem(var_1_10008, iter_79_1)
		end

		var_1_10008 = iter_79_1

		local var_79_4 = iter_79_1.ChangeState

		CourtYardShip = var_1_10009

		var_79_4(var_1_10008, var_1_10009.STATE_STOP)
	end

	pairs = var_1

	for iter_79_2, iter_79_3 in var_1(arg_79_0.furnitures) do
		local var_79_5 = iter_79_3
		local var_79_6 = iter_79_3.IsType

		Furniture = var_1_10008

		if var_79_6(var_79_5, var_1_10008.TYPE_TRANSPORT) and iter_79_3:IsUsing() then
			iter_79_3:Stop()
		end

		local var_79_7 = iter_79_3
		local var_79_8 = iter_79_3.IsType

		Furniture = var_1_10008

		if var_79_8(var_79_7, var_1_10008.TYPE_FOLLOWER) and iter_79_3:IsUsing() then
			iter_79_3:Stop()
		end

		local var_79_9 = iter_79_3
		local var_79_10 = iter_79_3.IsType

		Furniture = var_1_10008

		if var_79_10(var_79_9, var_1_10008.TYPE_MOVEABLE) and iter_79_3:IsMoving() then
			iter_79_3:Stop()
		end
	...
	local var_79_11 = arg_79_0.recoder

	var_1.BeginCheckChange(var_79_11)

	local var_79_12 = arg_79_0
	local var_79_13 = arg_79_0.DispatchEvent

	CourtYardEvent = var_3

	var_79_13(var_79_12, var_3.ENTER_EDIT_MODE)
...
function var_0_1.ExitEditMode(arg_80_0)
	...
	for iter_80_0, iter_80_1 in var_1_10001(arg_80_0.ships) do
		if iter_80_1:ShouldResetPosition() then
			...
			var_1_10008 = arg_80_0

			arg_80_0.ResetShip(var_1_10008, iter_80_1, var_80_0)
		end
	end
	...
	for iter_80_2, iter_80_3 in var_1(arg_80_0.furnitures) do
		...
		if var_80_2(var_80_1, var_1_10008.TYPE_MOVEABLE) and iter_80_3:IsStop() then
			iter_80_3:ReStart()
	...
	if var_80_3(var_2.values(arg_80_0.furnitures), function(arg_81_0)
	...
	CourtYardEvent = iter_80_2

	var_80_6(var_80_5, iter_80_2.EXIT_EDIT_MODE)
...
function var_0_1.StopAllDragState(arg_83_0)
	local function var_83_0()
		...
		for iter_84_0, iter_84_1 in var_2_10000(arg_83_0.ships) do
			local var_84_0 = iter_84_1
			local var_84_1 = iter_84_1.GetState(var_84_0)

			CourtYardShip = var_84_0

			if var_84_1 == var_84_0.STATE_DRAG then
				local var_84_2 = arg_83_0
				local var_84_3 = var_5.DragShipEnd
				local var_84_4 = iter_84_1.id

				Vector2 = var_2_10008

				var_84_3(var_84_2, var_84_4, var_2_10008(-1, -1))
			end
		end
	...
	local function var_83_1()
		...
		for iter_85_0, iter_85_1 in var_2_10000(arg_83_0.furnitures) do
			if iter_85_1:IsDragingState() then
				...
				var_85_1(var_85_0, var_85_2, var_2_10008(-1, -1))
...
function var_0_1.StartInteraction(arg_86_0, arg_86_1)
	...
	local var_86_1 = arg_86_1
	local var_86_2 = arg_86_1.GetOwner(var_86_1)
	...
	if var_86_1(var_86_3, var_1_10006) and var_86_2:GetInterActionBgm() then
		pairs = var_4
		...
		for iter_86_0, iter_86_1 in var_4(arg_86_0.furnitures) do
			if iter_86_1:IsPlayMusicState() then
				...
				var_86_5(var_86_4, var_1_10011.STATE_STOP_MUSIC)
			end
		end
	end
	...
	var_86_7(var_86_6, var_1_10006.ITEM_INTERACTION, var_86_0, var_86_2, arg_86_1)
...
function var_0_1.WillClearInteraction(arg_87_0, arg_87_1, arg_87_2)
	...
	var_87_3(var_87_2, var_1_10007.CLEAR_ITEM_INTERACTION, var_87_0, var_87_1, arg_87_1)
...
function var_0_1.ClearInteraction(arg_88_0, arg_88_1, arg_88_2)
	...
	local var_88_1 = arg_88_1
	local var_88_2 = arg_88_1.GetOwner(var_88_1)

	isa = var_88_1

	local var_88_3 = var_88_0

	CourtYardFollowerFurniture = var_1_10007

	if var_88_1(var_88_3, var_1_10007) then
		arg_88_0:ClearInteractionForFollower(var_88_0, var_88_2, arg_88_1, arg_88_2)
	elseif not arg_88_2 then
		isa = var_5

		local var_88_4 = var_88_2

		CourtYardTransportFurniture = var_1_10007

		if var_5(var_88_4, var_1_10007) then
			arg_88_0:ClearInteractionForTransPort(var_88_0, var_88_2, arg_88_1)
		else
...
function var_0_1.ClearInteractionForFollower(arg_89_0, arg_89_1, arg_89_2, arg_89_3, arg_89_4)
	if not arg_89_0:GetAroundEmptyArea(arg_89_1, arg_89_2:GetPosition()) then
		...
		var_89_1(var_89_0, var_8.REMOVE_ILLEGALITY_ITEM)
...
function var_0_1.ClearInteractionForTransPort(arg_90_0, arg_90_1, arg_90_2, arg_90_3)
	if arg_90_3:IsFirstTime() then
		...
		local var_90_1 = arg_90_0.GetFurnituresByType

		Furniture = var_1_10007

		local var_90_2 = var_90_1(var_90_0, var_1_10007.TYPE_TRANSPORT)

		_ = var_90_0

		local var_90_3 = var_90_0.select(var_90_2, function(arg_91_0)
			return arg_91_0.id ~= arg_90_2.id
		end)

		math = var_7

		if var_90_3[var_7.random(1, #var_90_3)] and var_7:CanInterAction(arg_90_1) then
			local var_90_4 = var_7:GetInteractionSlot()

			var_8.Link(var_90_4, var_7, arg_90_1, arg_90_0)
		else
...
function var_0_1.ToTable(arg_96_0)
	...
	if arg_96_0.wallPaper then
		...
		var_96_2(var_4.ToTable(var_96_3))
	end
	...
	if arg_96_0.floorPaper then
		...
		var_96_4(var_4.ToTable(var_96_5))
	end
