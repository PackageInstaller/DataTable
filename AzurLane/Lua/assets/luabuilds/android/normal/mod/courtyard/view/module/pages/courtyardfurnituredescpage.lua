...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.iconImg = var_2_3(var_2_2, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.nameTxt = var_2_5(var_2_4, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.typeTxt = var_2_7(var_2_6, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.contentTxt = var_2_9(var_2_8, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.comtableTxt = var_2_11(var_2_10, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.approachTxt = var_2_13(var_2_12, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.approachLongTxt = var_2_15(var_2_14, var_3(var_1_10004))
	findTF = var_1
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.dateTxt = var_2_17(var_2_16, var_3(var_1_10004))
	findTF = var_1
	...
	local var_2_18 = var_2(arg_2_0._tf, "desc/container/frame/comfortable_container/label")

	i18n = var_3

	var_1(var_2_18, var_3("word_comfort_level"))
	...
	var_1(var_2_19, var_3("word_get_way"))
	...
	var_1(var_2_20, var_3("word_get_date"))
...
function var_0_1.OnInit(arg_3_0)
	...
	local function var_3_11()
		...
		var_0(var_7_1, var_2.GetMusicData(var_7_2))
...
function var_0_1.Show(arg_9_0, arg_9_1)
	...
	var_4(arg_9_0.voiceBtn, var_9_0 and (var_9_1 == 1 or var_9_1 == 3))

	setActive = var_4

	var_4(arg_9_0.bgVoiceBtn, var_9_0 and (var_9_1 == 2 or var_9_1 == 3))

	setAnchoredPosition = var_4

	var_4(arg_9_0.voiceBtn, {
		y = var_9_1 == 3 and -72 or -22
	})

	setActive = var_4

	var_4(arg_9_0.musicalInstrumentsBtn, arg_9_1:IsMusicalInstruments())

	setActive = var_4

	local var_9_2 = arg_9_0.bgVoiceMark
	local var_9_3 = arg_9_0.furniture

	var_4(var_9_2, var_6.GetMusicData(var_9_3))

	LoadSpriteAsync = var_4

	var_4("FurnitureIcon/" .. arg_9_1:GetIcon(), function(arg_10_0)
	...
	local var_9_4 = arg_9_0.nameTxt

	shortenString = var_5
	var_9_4.text = var_5(arg_9_1:GetName(), 6)
	getProxy = var_9_4
	DormProxy = var_5

	local var_9_5 = var_9_4(var_5)
	local var_9_6 = var_4.getRawData(var_9_5)
	local var_9_7 = var_4.GetFurniture(var_9_6, arg_9_1.configId)
	local var_9_8 = arg_9_0.dateTxt
	local var_9_9

	if not var_9_7 or not var_9_7:getDate() then
		var_9_9 = arg_9_1:GetAddDate()
	end

	var_9_8.text = var_9_9
	arg_9_0.comtableTxt.text = "+" .. arg_9_1:GetComfortable()
	arg_9_0.contentTxt.text = arg_9_1:GetDescription()

	arg_9_0:ShowTxt()

	local var_9_10 = arg_9_0.typeTxt

	var_9_10.text = arg_9_1:GetGametipType()
	pg = var_9_10

	local var_9_11 = var_9_10.UIMgr.GetInstance()

	var_5.BlurPanel(var_9_11, arg_9_0._tf)

	local var_9_12 = arg_9_1
	local var_9_13 = arg_9_1.IsType

	Furniture = var_7

	local var_9_14 = var_9_13(var_9_12, var_7.TYPE_LUTE)

	setActive = var_9_12

	var_9_12(arg_9_0.approachTxt.gameObject.transform.parent, not var_9_14)

	setActive = var_9_12

	var_9_12(arg_9_0.dateTxt.gameObject.transform.parent, not var_9_14)
...
function var_0_1.ShowTxt(arg_11_0)
	...
	local var_11_2 = var_11_0("word_get_way") .. var_11_1
	...
	local var_11_6 = var_11_5(var_11_4, var_1_10005(var_1_10006))
