...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".CourtYardController"))
...
function var_0_1.ShipBubbleInterActionFinish(arg_1_0, arg_1_1)
	...
	if var_2.GetShip(var_1_0, arg_1_1) then
		...
		var_1_3(var_1_2, var_1_10006._FEAST_INTERACTION, {
			groupId = arg_1_1,
			special = var_1_1
		})
	end
...
function var_0_1.AddShipWithSpecialPosition(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_1_10005(25, 11))
	...
	if var_3.GetAroundEmptyPosition(var_5_2, var_2) then
		...
		var_5_5(var_5_4, var_6._NO_POS_TO_ADD_SHIP, var_2.id)
	end
