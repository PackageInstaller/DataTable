...
function var_0_0.InstantiateObj(arg_3_0, arg_3_1, arg_3_2)
	...
	var_4.insert(arg_3_0.rollBacks, var_3_0)
...
local function var_0_4(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	local var_8_6 = var_8_3(var_1_10009)

	UnityEngine = var_1_10009

	var_8_1(var_8_0, var_8_4, var_8_5, var_8_6, var_1_10009.Events.UnityAction_UnityEngine_Object(function(arg_9_0)
...
local function var_0_5(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	for iter_10_0, iter_10_1 in var_1_10006(var_10_0) do
		...
		var_1_10011.insert(var_10_1, function(arg_11_0)
			...
			local var_11_4 = var_2_10005(var_2_10006)

			UnityEngine = var_2_10006

			var_11_1(var_11_0, var_11_2, var_11_3, var_11_4, var_2_10006.Events.UnityAction_UnityEngine_Object(function(arg_12_0)
				...
				if not var_1.IsStop(var_12_0) then
					...
					if not var_1(arg_10_1) then
						...
						local var_12_6 = var_12_3(var_12_2, var_12_4, var_4.Find(var_12_5, "masks"))
...
local function var_0_6(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_1 = arg_13_0.poolMgr.root
	local var_13_2 = var_5.Find(var_13_1, "mask")

	pairs = var_13_1

	for iter_13_0, iter_13_1 in var_13_1(var_13_0) do
		local var_13_3 = arg_13_0:CloneTplTo(var_13_2, arg_13_1:Find("interaction"), "body_mask" .. iter_13_0)

		var_13_3.anchoredPosition = iter_13_1.offset
		var_13_3.sizeDelta = iter_13_1.size

		if iter_13_1.img then
			ResourceMgr = var_12

			local var_13_4 = var_12.Inst
			local var_13_5 = var_12.getAssetSync(var_13_4, "furnitrues/" .. iter_13_1.img, "", true, true)
			local var_13_6 = var_13_3
			local var_13_7 = var_13_3.GetComponent

			typeof = var_15
			Image = var_16

			local var_13_8 = var_13_7(var_13_6, var_15(var_16))
			local var_13_9 = var_13_5
			local var_13_10 = var_13_5.GetComponent

			typeof = var_16
			Image = var_17
			var_13_8.sprite = var_13_10(var_13_9, var_16(var_17)).sprite
		end
	end
...
local function var_0_7(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	if var_14_1 == var_14_0.TYPE_ARCH then
		local var_14_2 = arg_14_2
		local var_14_3 = arg_14_2.GetArchMask(var_14_2)

		checkABExist = var_14_2

		if not var_14_2("furnitrues/" .. var_14_3) then
			arg_14_3()
		...
		local var_14_4 = var_6.Inst
		local var_14_5 = var_6.getAssetAsync
		local var_14_6 = "furnitrues/" .. var_14_3
		local var_14_7 = ""

		typeof = var_1_10010
		GameObject = var_1_10011

		local var_14_8 = var_1_10010(var_1_10011)

		UnityEngine = var_1_10011

		var_14_5(var_14_4, var_14_6, var_14_7, var_14_8, var_1_10011.Events.UnityAction_UnityEngine_Object(function(arg_15_0)
			...
			if not var_1.IsStop(var_15_0) then
				...
				if not var_1(arg_14_1) then
					...
					local var_15_6 = var_15_3(var_15_2, var_15_4, var_4.Find(var_15_5, "masks"))
...
local function var_0_8(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	local var_16_6 = var_1_10009(var_1_10010)

	UnityEngine = var_1_10010

	var_16_3(var_16_2, var_16_4, var_16_5, var_16_6, var_1_10010.Events.UnityAction_UnityEngine_Object(function(arg_17_0)
		...
		if not var_1.IsStop(var_17_0) then
			...
			if not var_1(arg_16_1) then
				...
				Vector3 = var_17_4
				var_17_5.localPosition = var_17_4(0, 0, 0)
...
local function var_0_9(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	for iter_18_0, iter_18_1 in var_1_10006(var_18_0) do
		...
		var_1_10011.insert(var_18_1, function(arg_19_0)
			ResourceMgr = var_2_10001
			...
			local var_19_4 = var_2_10005(var_2_10006)

			UnityEngine = var_2_10006

			var_19_1(var_19_0, var_19_2, var_19_3, var_19_4, var_2_10006.Events.UnityAction_UnityEngine_Object(function(arg_20_0)
				...
				if not var_1.IsStop(var_20_0) then
					...
					if not var_1(arg_18_1) then
						...
						local var_20_6 = var_20_3(var_20_2, var_20_4, var_4.Find(var_20_5, "masks"))
	...
	var_6(var_18_1, arg_18_3)

	return
end

local function var_0_10(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	if arg_21_2:GetAnimatorMask() then
		var_1_10006 = arg_21_0.poolMgr.root

		local var_21_0 = var_5.Find(var_1_10006, "mask")

		var_1_10006 = arg_21_0:CloneTplTo(var_21_0, arg_21_1:Find("interaction"), "animtor_mask")
		var_1_10006.sizeDelta = var_4.size
		setAnchoredPosition = var_7

		var_7(var_1_10006, var_4.offset)
	end
	...
	for iter_21_0, iter_21_1 in var_1_10006(arg_21_2:GetAnimators()) do
		local var_21_2 = iter_21_1.key
		local var_21_3 = iter_21_1.value

		table = var_1_10013

		var_1_10013.insert(var_21_1, function(arg_22_0)
			ResourceMgr = var_2_10001

			local var_22_0 = var_2_10001.Inst
			local var_22_1 = var_1.getAssetAsync
			local var_22_2 = "sfurniture/" .. var_21_3
			local var_22_3 = ""

			typeof = var_2_10005
			GameObject = var_2_10006

			local var_22_4 = var_2_10005(var_2_10006)

			UnityEngine = var_2_10006

			var_22_1(var_22_0, var_22_2, var_22_3, var_22_4, var_2_10006.Events.UnityAction_UnityEngine_Object(function(arg_23_0)
				...
				if not var_1.IsStop(var_23_0) then
					...
					if not var_1(arg_21_1) then
						...
						var_23_6.name = "Animator" .. var_21_2
						setActive = var_4
