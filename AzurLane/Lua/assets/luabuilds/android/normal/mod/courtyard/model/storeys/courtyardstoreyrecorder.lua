...
function var_0_0.TakeSample(arg_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_2(arg_3_0.furnitures) do
...
function var_0_0.HasChange(arg_7_0)
	...
	local var_7_3 = var_1_10003.getCount(var_7_1)

	table = var_4

	if var_7_3 ~= var_4.getCount(var_7_2) then
		return true
	end
...
function var_0_0.GetHeadSample(arg_9_0)
	...
	var_9_1(var_9_2, var_4._LoadWeight)
