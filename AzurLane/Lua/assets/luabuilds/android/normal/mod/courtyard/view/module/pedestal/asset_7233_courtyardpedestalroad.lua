...
function var_0_1.OnLoaded(arg_2_0, arg_2_1)
	...
	var_1_10002(var_2_0, var_1_10004(0, var_0_2[arg_2_0.level], 0))
	...
	if arg_2_0.level ~= 4 then
		...
		local var_2_3 = var_4.Find(var_2_2, "warn")
		...
		var_2(var_2_1, var_2_3, var_2_4, var_6)
		...
		var_2(var_2_5, var_2_6, var_2_7, var_6)
	end
