...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	local var_1_3 = var_1_2(var_1_1, var_5.ACTIVITY_TYPE_FEAST)
...
function var_0_1.UpdateBubble(arg_5_0, arg_5_1)
	...
	var_5_1(var_5_0, var_1_10004.FEAST_SHIP_BUBBLE_CHANGE, arg_5_1)
...
function var_0_1.UpdateChatBubble(arg_7_0, arg_7_1)
	...
	var_7_1(var_7_0, var_1_10004.FEAST_SHIP_CHAT_CHANGE, arg_7_1)
...
function var_0_1.EnterFeast(arg_8_0)
	if arg_8_0:IsSpecial() then
		...
		var_8_1(var_8_0, var_1_10003.FEAST_SHIP_SHOW_EXPRESS, 1)
	end
...
function var_0_1.OnInterAction(arg_9_0, arg_9_1)
	...
	local var_9_1 = arg_9_1.GetOwner(var_9_0)
	...
	if var_9_0(var_9_2, var_1_10005) and arg_9_0:ExistBubble() and arg_9_0:IsSameInterAction(var_9_1, arg_9_0.bubble) then
		local var_9_3 = arg_9_0
		local var_9_4 = arg_9_0.DispatchEvent

		CourtYardEvent = var_5

		var_9_4(var_9_3, var_5.FEAST_SHIP_BUBBLE_INTERACTION, arg_9_0.bubble)

		if not arg_9_0:IsSpecial() then
			local var_9_5 = arg_9_0:GetInterActionExpress(var_9_1)
			local var_9_6 = arg_9_0
			local var_9_7 = arg_9_0.DispatchEvent

			CourtYardEvent = var_6

			var_9_7(var_9_6, var_6.FEAST_SHIP_SHOW_EXPRESS, var_9_5)
		end
	end
...
function var_0_1._ChangeState(arg_12_0, arg_12_1, arg_12_2)
	...
	if arg_12_1 == var_3.STATE_TOUCH then
		...
		if var_12_0 == var_4.BUBBLE_TYPE_GREET then
			local var_12_1 = arg_12_0
			local var_12_2 = arg_12_0.DispatchEvent

			CourtYardEvent = var_5

			var_12_2(var_12_1, var_5.FEAST_SHIP_BUBBLE_INTERACTION, arg_12_0.bubble)
		end
	end
