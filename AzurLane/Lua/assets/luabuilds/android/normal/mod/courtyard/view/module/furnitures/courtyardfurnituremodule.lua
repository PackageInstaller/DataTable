...
function var_0_1.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	var_1_1(var_1_0, var_5.FURNITURE_POSITION_CHANGE, arg_1_0.OnPositionUpdate)
...
function var_0_1.OnInit(arg_2_0)
	...
	for iter_2_0, iter_2_1 in var_1(var_2.GetMaskNames(var_2_5)) do
	...
	for iter_2_2, iter_2_3 in var_1(var_2.GetBodyMasks(var_2_9)) do
	...
	for iter_2_4, iter_2_5 in var_1(var_2.GetAnimators(var_2_12)) do
...
function var_0_1.GetCenterPoint(arg_6_0)
	local var_6_0 = arg_6_0:GetParentTF()
	local var_6_1 = var_1.InverseTransformPoint(var_6_0, arg_6_0._tf.position)

	Vector2 = var_6_0

	local var_6_2 = var_6_0(var_6_1.x, var_6_1.y)
	local var_6_3 = arg_6_0._tf.sizeDelta

	Vector2 = var_5

	local var_6_4 = var_5(0.5, 0.5) - arg_6_0._tf.pivot
	local var_6_5 = arg_6_0._tf.localScale.x

	Vector2 = var_7

	local var_6_6 = var_6_2 + var_7(var_6_5 * var_6_3.x * var_6_4.x, var_6_3.y * var_6_4.y)

	Vector3 = var_7

	return var_7(var_6_6.x, var_6_6.y, 0)
end

function var_0_1.GetSpinePoint(arg_7_0)
	local var_7_0 = arg_7_0:GetParentTF()
	local var_7_1 = var_1.InverseTransformPoint
	local var_7_2 = arg_7_0._tf
	local var_7_3 = var_7_1(var_7_0, var_4.Find(var_7_2, "spine_icon/spine").position)

	Vector3 = var_7_0

	return var_7_0(var_7_3.x, var_7_3.y, 0)
end
...
function var_0_1.AddListeners(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.FURNITURE_OP_FLAG_CHANGE, arg_10_0.EnableTrigger)
	...
	var_10_3(var_10_2, var_3.ROTATE_FURNITURE, arg_10_0.OnDirChange)
	...
	var_10_5(var_10_4, var_3.FURNITURE_STATE_CHANGE, arg_10_0.OnStateChange)
	...
	var_10_7(var_10_6, var_3.FURNITURE_WILL_INTERACTION, arg_10_0.OnWillInterAction)
	...
	var_10_9(var_10_8, var_3.FURNITURE_START_INTERACTION, arg_10_0.OnStartInterAction)
	...
	var_10_11(var_10_10, var_3.FURNITURE_UPDATE_INTERACTION, arg_10_0.OnUpdateInteraction)
	...
	var_10_13(var_10_12, var_3.FURNITURE_STOP_INTERACTION, arg_10_0.OnStopInterAction)
	...
	var_10_15(var_10_14, var_3.FURNITURE_MOVE, arg_10_0.OnMove)
	...
	var_10_17(var_10_16, var_3.FURNITURE_STOP_MOVE, arg_10_0.OnStopMove)
...
function var_0_1.RemoveListeners(arg_11_0)
	...
	var_11_1(var_11_0, var_1_10003.FURNITURE_OP_FLAG_CHANGE, arg_11_0.EnableTrigger)
	...
	var_11_3(var_11_2, var_3.ROTATE_FURNITURE, arg_11_0.OnDirChange)
	...
	var_11_5(var_11_4, var_3.FURNITURE_STATE_CHANGE, arg_11_0.OnStateChange)
	...
	var_11_7(var_11_6, var_3.FURNITURE_WILL_INTERACTION, arg_11_0.OnWillInterAction)
	...
	var_11_9(var_11_8, var_3.FURNITURE_START_INTERACTION, arg_11_0.OnStartInterAction)
	...
	var_11_11(var_11_10, var_3.FURNITURE_UPDATE_INTERACTION, arg_11_0.OnUpdateInteraction)
	...
	var_11_13(var_11_12, var_3.FURNITURE_STOP_INTERACTION, arg_11_0.OnStopInterAction)
	...
	var_11_15(var_11_14, var_3.FURNITURE_MOVE, arg_11_0.OnMove)
	...
	var_11_17(var_11_16, var_3.FURNITURE_STOP_MOVE, arg_11_0.OnStopMove)
...
function var_0_1.InitAttachment(arg_13_0, arg_13_1)
	...
	var_1_10002(var_13_0, var_13_1, var_13_2, var_1_10006)
...
function var_0_1.OnStartInterAction(arg_21_0, arg_21_1)
	...
	if arg_21_1.GetUsingAnimator(var_21_0) then
		...
		var_21_0(arg_21_0:GetAnimator(var_2.key), true)
	end

	local var_21_1 = arg_21_1
	local var_21_2 = arg_21_1.GetSkew(var_21_1)

	Vector3 = var_21_1

	local var_21_3

	if var_21_2 ~= var_21_1.zero then
		var_21_3 = arg_21_0._tf
		var_21_3.localPosition = var_21_2
	end

	pairs = var_21_3

	for iter_21_0, iter_21_1 in var_21_3(arg_21_0.masks) do
...
function var_0_1.OnUpdateInteraction(arg_22_0, arg_22_1)
	...
	if arg_22_0:GetBodyMask(arg_22_1.slot.id) then
		...
		typeof = var_1_10005
		Image = var_1_10006
		var_22_2(var_22_1, var_1_10005(var_1_10006)).enabled = not arg_22_1.closeBodyMask
	end
	...
	if arg_22_1.isReset and var_22_4 then
		...
		local var_22_6 = arg_22_0.GetAnimator(var_22_5, var_22_4.key)
...
function var_0_1.OnStopInterAction(arg_23_0, arg_23_1)
	if arg_23_1:GetUsingAnimator() then
		local var_23_0 = arg_23_0
		local var_23_1 = arg_23_0.GetAnimator(var_23_0, var_2.key)

		Vector3 = var_23_0
		var_23_1.localScale = var_23_0.one
		Vector3 = var_4
		var_23_1.localEulerAngles = var_4.zero
		setActive = var_4

		var_4(var_23_1, false)
	end
	...
	if var_4.AnySlotIsUsing(var_23_3) then
		...
		if var_23_3.getCount(arg_23_0.masks) >= 1 then
			goto label_23_0
		end
	end
	...
	for iter_23_0, iter_23_1 in var_23_3(arg_23_0.masks) do
...
function var_0_1.OnMove(arg_28_0, arg_28_1)
	...
	local var_28_3 = var_28_1(var_28_0.x, var_28_0.y, 0)

	CourtYardCalcUtil = var_5

	local var_28_4 = var_5.TrPosition2LocalPos(arg_28_0:GetParentTF(), arg_28_0._tf.parent, var_28_3)
...
function var_0_1.OnDispose(arg_30_0)
	...
	local var_30_5 = var_2.GetComponent

	typeof = iter_30_4
	ButtonEventExtend = iter_30_5

	var_30_3(var_30_5(var_30_4, iter_30_4(iter_30_5)))

	Object = var_30_3

	local var_30_6 = var_30_3.Destroy
	local var_30_7 = arg_30_0._tf
	local var_30_8 = var_2.GetComponent

	typeof = var_4
	Button = iter_30_5

	var_30_6(var_30_8(var_30_7, var_4(iter_30_5)))
...
function var_0_1.OnDestroy(arg_31_0)
	...
	var_31_1(var_31_0, var_1_10003.FURNITURE_POSITION_CHANGE, arg_31_0.OnPositionUpdate)
