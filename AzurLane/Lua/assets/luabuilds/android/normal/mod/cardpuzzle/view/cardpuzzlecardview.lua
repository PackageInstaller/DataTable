...
function var_0_0.UpdateView(arg_6_0)
	...
	var_1_10001(var_6_0, var_1_10003(var_4.GetIconPath(var_6_1), ""), true)
	...
	var_1_10001(var_6_2, var_3(var_6_3, var_6_5(var_6_4, var_7.GetType(var_6_6))))
	...
	var_1_10001(var_6_7, var_3(var_6_8, var_6_10(var_6_9, var_7.GetRarity(var_6_11))))
	...
	var_1_10001(var_6_12, var_3.GetName(var_6_13))
	...
	var_1_10001(var_6_14, var_3.GetDesc(var_6_15))
	...
	var_1_10001(var_6_16, var_3.GetCost(var_6_17))
	...
	local var_6_20 = var_6_18.filter(var_6_19, function(arg_7_0)
		return arg_7_0.affix_type == var_0_0.AFFIX_TYPE.AFFIX and arg_7_0.show == 0
	end)

	UIItemList = var_3

	local var_6_21 = var_3.StaticAlign
	local var_6_22 = arg_6_0.keywordListContainer
	local var_6_23 = arg_6_0.keywordListContainer

	var_6_21(var_6_22, var_5.GetChild(var_6_23, 0), #var_6_20, function(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_6_24 then
		...
		var_4(var_6_25, var_6(var_6_26, var_6_27 .. var_6_28[var_10.GetType(var_6_29)]))

		setImageSprite = var_4
		var_6_25 = arg_6_0.schoolIcon
		LoadSprite = var_6

		var_4(var_6_25, var_6("ui/RogueCardSchoolIcons_atlas", var_6_24.icon), true)
	end
...
function var_0_0.Clear(arg_10_0)
	...
	var_1_10001(var_1_10002(arg_10_0._tf))
