...
function var_0_1.init(arg_2_0)
	...
	local var_2_2 = var_3.Find(var_2_1, "btn_quit")

	local function var_2_3()
		local var_3_0 = arg_2_0
		local var_3_1 = var_0.emit

		CardPuzzleCombatPauseMediator = var_2_10002

		var_3_1(var_3_0, var_2_10002.QUIT_COMBAT, {})
	...
	local var_2_6 = var_3.Find(var_2_5, "btn_resume")
	...
	var_1(var_2_4, var_2_6, var_2_7, var_5)
...
function var_0_1.OnBackward(arg_5_0)
	...
	CardPuzzleCombatPauseMediator = var_1_10003

	var_5_1(var_5_0, var_1_10003.RESUME_COMBAT)
	arg_5_0:closeView()
