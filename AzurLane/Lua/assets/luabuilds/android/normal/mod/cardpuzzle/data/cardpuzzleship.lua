...
function var_0_1.getShipArmorName(arg_2_0)
	...
	local var_2_1 = arg_2_0.getShipArmor(var_2_0)

	ArmorType = var_2_0

	return var_2_0.Type2Name(var_2_1)
end
...
function var_0_1.Ctor(arg_10_0, arg_10_1)
	...
	if arg_10_1.name and arg_10_1.name ~= "" then
		...
		var_2(var_1_10003.ship_data_statistics[arg_10_0.configId], "必须存在配置" .. arg_10_0.configId)
...
function var_0_1.updateEquip(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_2 then
		...
		if not var_1_10005(arg_17_2) then
			var_17_2 = false
		end
...
var_0_2[1] = var_0_10002.Durability
AttributeType = var_2
...
function var_0_1.getBaseProperties(arg_22_0)
	...
	var_22_0(var_22_1, "配置表没有这艘船" .. arg_22_0.configId)

	local var_22_2 = {}

	ipairs = var_3

	for iter_22_0, iter_22_1 in var_3(var_0_1.PROPERTIES) do
...
function var_0_1.getGiftProperties(arg_23_0, arg_23_1)
	...
	for iter_23_6, iter_23_7 in var_3(arg_23_1) do
		if iter_23_7 then
			local var_23_1 = iter_23_7
			local var_23_2 = iter_23_7.GetAttributeBonus(var_23_1, arg_23_0)

			ipairs = var_23_1

			for iter_23_8, iter_23_9 in var_23_1(var_23_2) do
...
function var_0_1.getProperties(arg_24_0, arg_24_1)
	...
	local var_24_2 = arg_24_0.getGiftProperties(var_24_1, arg_24_1)

	ipairs = var_24_1

	for iter_24_0, iter_24_1 in var_24_1(var_0_1.PROPERTIES) do
		AttributeType = var_1_10009

		if iter_24_1 == var_1_10009.Speed then
			var_24_0[iter_24_1] = var_24_0[iter_24_1] + var_24_2[iter_24_1]
		else
			calcFloor = var_1_10009
			var_24_0[iter_24_1] = var_1_10009(var_24_0[iter_24_1] + var_24_2[iter_24_1])
		end
	end
	...
	for iter_24_2, iter_24_3 in var_4(var_0_1.DIVE_PROPERTIES) do
		var_24_0[iter_24_3] = var_24_0[iter_24_3] + var_24_2[iter_24_3]
	end

	ipairs = var_4

	for iter_24_4, iter_24_5 in var_4(var_0_1.SONAR_PROPERTIES) do
		var_24_0[iter_24_5] = var_24_0[iter_24_5] + var_24_2[iter_24_5]
	end
...
function var_0_1.getTriggerSkills(arg_25_0)
	...
	local var_25_2 = arg_25_0.getSkillEffects(var_25_1)

	_ = var_25_1

	var_25_1.each(var_25_2, function(arg_26_0)
...
function var_0_1.GetEquipmentSkills(arg_27_0)
	...
	local var_27_2 = arg_27_0.getActiveEquipments(var_27_1)
...
function var_0_1.getAllSkills(arg_28_0)
	...
	for iter_28_0, iter_28_1 in var_2(arg_28_0:GetEquipmentSkills()) do
...
function var_0_1.getSkillList(arg_34_0)
	...
	local var_34_2 = var_3(var_34_0.buff_list)
...
function var_0_1.getDisplaySkillIds(arg_35_0)
	...
	return var_35_0(var_1_10002.ship_data_template[arg_35_0.configId].buff_list_display, function(arg_36_0)
...
function var_0_1.getSkillIndex(arg_37_0, arg_37_1)
	...
	local var_37_1 = arg_37_0.getSkillList(var_37_0)
...
function var_0_1.IsBgmSkin(arg_38_0)
	...
	local var_38_1 = arg_38_0.GetSkinConfig(var_38_0)

	table = var_38_0

	local var_38_2 = var_38_0.contains
	local var_38_3 = var_38_1.tag

	ShipSkin = var_1_10004

	return var_38_2(var_38_3, var_1_10004.WITH_BGM)
end
