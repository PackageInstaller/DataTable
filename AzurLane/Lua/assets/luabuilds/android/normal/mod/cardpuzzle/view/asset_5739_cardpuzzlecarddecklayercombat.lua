...
CardPuzzleCardDeckLayer = var_0_10002
...
function var_0_1.init(arg_2_0)
	...
	var_1(var_2_2, var_3("card_battle_card details"))
	...
	local var_2_5 = var_2.Find(var_2_4, "switch_toggle/toggle/hand")

	i18n = var_2_4

	var_1(var_2_5, var_2_4("card_battle_card details_switchto_deck"))

	setText = var_1

	local var_2_6 = arg_2_0._tf
	local var_2_7 = var_2.Find(var_2_6, "switch_toggle/toggle/deck")

	i18n = var_2_6

	var_1(var_2_7, var_2_6("card_battle_card details_switchto_hand"))
	...
	local var_2_10 = var_2.Find(var_2_9, "empty/label_en")

	i18n = var_2_9

	var_1(var_2_10, var_2_9("card_battle_card_empty_en"))

	setText = var_1

	local var_2_11 = arg_2_0._tf
	local var_2_12 = var_2.Find(var_2_11, "empty/label_ch")

	i18n = var_2_11

	var_1(var_2_12, var_2_11("card_battle_card_empty_ch"))

	onButton = var_1

	local var_2_13 = arg_2_0
	local var_2_14 = arg_2_0._tf
	local var_2_15 = var_3.Find(var_2_14, "backBtn")
...
function var_0_1.showHand(arg_5_0)
	...
	var_1_10001(var_5_0, var_1_10003("card_battle_card details_hand"))
...
function var_0_1.showDeck(arg_6_0)
	...
	var_1_10001(var_6_0, var_1_10003("card_battle_card details_deck"))
...
function var_0_1.OnBackward(arg_10_0)
	...
	var_10_1(var_10_0, var_1_10003.CLOSE_LAYER)
