...
function var_0_0.UpdateView(arg_3_0)
	...
	local var_3_1 = var_2.Find(var_3_0, "Icon")

	LoadSprite = var_3_0

	local var_3_2 = arg_3_0.data

	var_1_10001(var_3_1, var_3_0(var_4.GetIconPath(var_3_2), ""), true)

	setText = var_1_10001

	local var_3_3 = arg_3_0._tf
	local var_3_4 = var_2.Find(var_3_3, "Name")
	local var_3_5 = arg_3_0.data

	var_1_10001(var_3_4, var_3.GetName(var_3_5))

	setText = var_1_10001

	local var_3_6 = arg_3_0._tf
	local var_3_7 = var_2.Find(var_3_6, "Detail")
	local var_3_8 = arg_3_0.data

	var_1_10001(var_3_7, var_3.GetDesc(var_3_8))
...
function var_0_0.Clear(arg_4_0)
	...
	var_1_10001(var_1_10002(arg_4_0._tf))
