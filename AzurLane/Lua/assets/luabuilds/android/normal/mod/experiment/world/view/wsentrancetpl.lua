...
function var_0_1.Build(arg_1_0)
	...
	arg_1_0.transform = var_1_10001(var_1_10002.New())
...
function var_0_1.Dispose(arg_3_0)
	...
	arg_3_0.RemoveEntranceListener(var_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_0(arg_3_0.markTFs) do
		Vector3 = var_1_10007
		iter_3_1.localPosition = var_1_10007.zero

		local var_3_2 = var_3_1

		var_1_10007 = var_3_1.ReturnPrefab

		local var_3_3 = "world/mark/" .. var_0_1.prefabName[iter_3_0]
		local var_3_4 = var_0_1.prefabName[iter_3_0]

		go = var_1_10011

		var_1_10007(var_3_2, var_3_3, var_3_4, var_1_10011(iter_3_1), true)
	end
...
function var_0_1.AddEntranceListener(arg_8_0)
	if arg_8_0.entrance then
		...
		WorldEntrance = var_1_10003

		var_8_1(var_8_0, var_1_10003.EventUpdateDisplayMarks, arg_8_0.onUpdateDisplayMarks)
	end
...
function var_0_1.RemoveEntranceListener(arg_9_0)
	if arg_9_0.entrance then
		...
		var_9_1(var_9_0, var_1_10003.EventUpdateDisplayMarks, arg_9_0.onUpdateDisplayMarks)
	end
...
function var_0_1.GetPrefabOffset(arg_12_0, arg_12_1)
	...
	PIXEL_PER_UNIT = var_1_10005

	local var_12_2 = var_12_1 / var_1_10005
	local var_12_3 = 0
	local var_12_4 = var_12_0[2]

	PIXEL_PER_UNIT = var_1_10007

	return var_1_10003(var_12_2, var_12_3, var_12_4 / var_1_10007)
end
...
function var_0_1.UpdatePressingAward(arg_18_0)
	...
	if var_1.GetPressingAward(var_18_0, arg_18_0.entrance.id) then
		...
		local var_18_1 = var_18_0.world_event_complete[var_1.id]
