...
function var_0_1.OnInit(arg_4_0)
	...
	typeof = var_1_10003
	Camera = var_1_10004
	arg_4_0.camera = var_4_1(var_4_0, var_1_10003(var_1_10004))

	local var_4_2 = arg_4_0._tf

	GetOrAddComponent = var_4_0
	arg_4_0.canvas = var_4_0(var_4_2, "CanvasGroup")
	...
	arg_4_0.buffUIItemList = var_4_12(var_4_13, var_4.Find(var_4_14, "buff"))
	...
	arg_4_0.mapBuffItemList = var_4_16(var_4_17, var_4.Find(var_4_18, "buff"))
	...
	arg_4_0.weaknessUIItemList = var_4_20(var_4_21, var_4.Find(var_4_22, "buff"))
	...
	var_2(var_4_24, var_4_25, var_4_26, var_6)

	onButton = var_2

	local var_4_27 = arg_4_0
	local var_4_28 = arg_4_0.rtClick
	local var_4_29 = var_4.Find(var_4_28, "enemy")
	...
	var_2(var_4_27, var_4_29, var_4_30, var_6)

	onButton = var_2

	local var_4_31 = arg_4_0
	local var_4_32 = arg_4_0.rtClick
	local var_4_33 = var_4.Find(var_4_32, "other")
	...
	var_2(var_4_31, var_4_33, var_4_34, var_6)
...
function var_0_1.Hide(arg_14_0, arg_14_1)
	...
	if not arg_14_1 then
		...
		var_3.insert(var_14_0, function(arg_15_0)
...
function var_0_1.DisplayWindow(arg_18_0, arg_18_1, arg_18_2)
	...
	if var_1_10003(arg_18_0.rtPanel) and arg_18_0.attachment == arg_18_1 then
		...
		if not var_18_7.IsEnemyType(arg_18_1.type) then
			var_18_8 = arg_18_1
			var_18_9 = arg_18_1.GetSpEventType(var_18_8)
			WorldMapAttachment = var_18_8
			var_18_9 = var_18_9 == var_18_8.SpEventEnemy
		end
		...
		var_18_8(var_5.Find(var_18_10, "enemy"), var_18_9)

		setActive = var_18_8

		local var_18_11 = arg_18_0.rtClick

		var_18_8(var_5.Find(var_18_11, "other"), not var_18_9)

		setActive = var_18_8

		var_18_8(arg_18_0.rtPanel, true)
	end
...
function var_0_1.HideWindow(arg_19_0)
	...
	var_1_10001(var_19_0, var_1_10003.zero)
...
function var_0_1.EaseInOut(arg_20_0, arg_20_1, arg_20_2)
	...
	System = var_5
	arg_20_0.alphaLT = var_20_2(var_20_1, var_5.Action(arg_20_2 or function()
		return
	end)).uniqueId
...
function var_0_1.OnUpdate(arg_23_0)
	...
	if var_1_10009.IsEnemyType(var_23_1.type) then
		...
		var_23_7 = false
		var_23_9 = var_23_1
		var_23_4 = var_23_1.GetBuffList(var_23_9)
		var_23_9 = var_23_0
		var_23_10 = var_23_0.GetBuffList
		WorldMap = var_1_10011
		var_23_5 = var_23_10(var_23_9, var_1_10011.FactionEnemy, var_23_1)
		var_23_10 = var_23_1.config.difficulty
		ys = var_23_9

		if var_23_10 == var_23_9.Battle.BattleConst.Difficulty.WORLD then
			var_23_10 = var_23_8
			var_23_9 = " LV."
			WorldConst = var_1_10011
			var_23_8 = var_23_10 .. var_23_9 .. var_1_10011.WorldLevelCorrect(var_23_0.config.expedition_level, var_23_1.config.type)
		else
	...
	WorldMapAttachment = var_23_9

	local var_23_11

	if var_23_10 == var_23_9.TypeEvent then
		var_23_11 = var_23_1
		var_23_4 = var_23_1.GetBuffList(var_23_11)
		var_23_11 = var_23_0
		var_23_10 = var_23_0.GetBuffList
		WorldMap = var_1_10011
		var_23_5 = var_23_10(var_23_11, var_1_10011.FactionEnemy, var_23_1)
		...
		if var_23_1.config.is_scanevent == 1 or var_23_10 == 3 then
			...
			var_23_11(var_11.Find(var_23_12, "Image"), false)

			setText = var_23_11

			local var_23_13 = arg_23_0.rtInfo

			var_23_11(var_11.Find(var_23_13, "Text"), var_23_1.config.scan_desc)
		elseif var_23_10 == 2 or var_23_10 == 4 then
			...
			var_23_11(var_11.Find(var_23_14, "Image"), true)

			GetImageSpriteFromAtlasAsync = var_23_11

			local var_23_15 = "icondesc/" .. var_23_1.config.icon
			local var_23_16 = ""
			local var_23_17 = arg_23_0.rtInfo

			var_23_11(var_23_15, var_23_16, var_13.Find(var_23_17, "Image"))

			setText = var_23_11

			local var_23_18 = arg_23_0.rtInfo

			var_23_11(var_11.Find(var_23_18, "Text"), var_23_1.config.scan_desc)
		end
	...
	var_23_10 = var_23_1.type
	WorldMapAttachment = var_23_11

	if var_23_10 == var_23_11.TypeTrap then
		var_23_6 = true
		var_23_7 = true
		setActive = var_23_10
		...
		var_23_10(var_10.Find(var_23_19, "Image"), true)
		...
		var_10(var_23_20, var_23_21, var_13.Find(var_23_22, "Image"))

		setText = var_10

		local var_23_23 = arg_23_0.rtInfo

		var_10(var_11.Find(var_23_23, "Text"), var_23_1.config.desc)
	...
	if var_23_10 == var_10.TypePort then
		...
		if 0 < var_23_10 then
			...
			do
				...
				var_10(var_11.Find(var_23_25, "Image"), false)

				setText = var_10

				local var_23_26 = arg_23_0.rtInfo

				var_10(var_11.Find(var_23_26, "Text"), var_23_1.config.scan_desc)
			end
			...
			var_10(var_11.Find(var_23_31, "red"), var_23_6)

			setActive = var_10

			local var_23_32 = arg_23_0.rtTitle

			var_10(var_11.Find(var_23_32, "yellow"), not var_23_6)

			local var_23_33 = var_23_1
			local var_23_34 = var_23_1.GetRadiationBuffs(var_23_33)

			setActive = var_23_33

			local var_23_35 = arg_23_0.rtRadiation
			local var_23_36 = #var_23_34

			var_23_33(var_23_35, 0 < var_23_36)

			if #var_23_34 > 0 then
				unpack = var_11

				local var_23_37, var_23_38, var_23_39 = var_11(var_23_34[1])

				GetImageSpriteFromAtlasAsync = var_14

				local var_23_40 = "world/mapbuff/"

				pg = var_1_10016

				local var_23_41 = var_23_40 .. var_1_10016.world_SLGbuff_data[var_23_38].icon
				local var_23_42 = ""
				local var_23_43 = arg_23_0.rtRadiation

				var_14(var_23_41, var_23_42, var_17.Find(var_23_43, "info/map_buff/Image"))

				setText = var_14

				local var_23_44 = arg_23_0.rtRadiation
				local var_23_45 = var_15.Find(var_23_44, "info/Text")

				i18n = var_23_44

				var_14(var_23_45, var_23_44("world_mapbuff_tip"))
			end
