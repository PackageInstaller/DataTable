...
function var_0_1.OnInit(arg_4_0)
	...
	local function var_4_4()
		...
		i18n = var_2_10003
		var_5_2.helps = var_2_10003("world_instruction_help_1")
	...
	var_3(var_4_2, var_4_3, var_4_4, var_1_10007)
	...
	var_3(var_4_5, var_4_6, var_4_7, var_1_10007)
	...
	local var_4_10 = var_4.Find(var_4_9, "window/top/bg/infomation/title")

	i18n = var_4_9

	var_3(var_4_10, var_4_9("title_info"))
	...
	local var_4_13 = var_5.Find(var_4_12, "bg")
	...
	var_3(var_4_11, var_4_13, var_4_14, var_7)

	onButton = var_3

	local var_4_15 = arg_4_0
	local var_4_16 = arg_4_0.rtMsgbox
	local var_4_17 = var_5.Find(var_4_16, "window/top/btnBack")
	...
	var_3(var_4_15, var_4_17, var_4_18, var_7)
	...
	local var_4_21 = var_4.Find(var_4_20, "name")

	i18n = var_4_20

	var_3(var_4_21, var_4_20("world_ap"))
	...
	local var_4_26 = var_4.Find(var_4_25, "btn_setting/pic")

	i18n = var_4_25

	var_3(var_4_26, var_4_25("msgbox_text_save"))

	setText = var_3

	local var_4_27 = arg_4_0.rtMsgBtns
	local var_4_28 = var_4.Find(var_4_27, "btn_confirm/pic")

	i18n = var_4_27

	var_3(var_4_28, var_4_27("text_confirm"))

	setText = var_3

	local var_4_29 = arg_4_0.rtMsgBtns
	local var_4_30 = var_4.Find(var_4_29, "btn_cancel/pic")

	i18n = var_4_29

	var_3(var_4_30, var_4_29("text_cancel"))

	onButton = var_3

	local var_4_31 = arg_4_0
	local var_4_32 = arg_4_0.rtMsgBtns
	local var_4_33 = var_5.Find(var_4_32, "btn_cancel")
	...
	var_3(var_4_31, var_4_33, var_4_34, var_7)
...
function var_0_1.SetButton(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_3 = arg_15_1.Find(var_15_2, "type_enable")

	nowWorld = var_15_2

	local var_15_4 = var_15_2()
	local var_15_5 = var_6.IsSystemOpen(var_15_4, arg_15_2.system)

	setActive = var_15_4

	var_15_4(var_15_0, not var_15_5)
	...
	if not var_9(var_15_0) then
		local var_15_7

		if not arg_15_2.isLock and arg_15_2.timeStamp then
			var_15_7 = arg_15_2.timeStamp
			pg = var_10
			var_1_10011 = var_10.TimeMgr.GetInstance()

			if not (var_15_7 > var_10.GetServerTime(var_1_10011)) then
				var_15_7 = false
			else
				var_15_7 = true
			end
		...
		if not var_15_7(var_15_0) then
			isActive = var_9
			var_15_9 = not var_9(var_15_1)
		else
			var_15_9 = false
		end
		...
		var_15_4(var_15_8, var_15_9)

		isActive = var_15_4

		if var_15_4(var_15_0) then
			onButton = var_7
			...
			local function var_15_12()
				...
				var_16_1(var_16_0, var_2_10002("world_instruction_all_1"))
			...
			var_7(var_15_10, var_15_11, var_15_12, var_1_10011)
		end
		...
		if var_7(var_15_1) then
			setActive = var_15_16

			var_15_16(var_15_1:Find("cost"), arg_15_2.isLock)

			setActive = var_15_16

			var_15_16(var_15_1:Find("time"), not arg_15_2.isLock)
			...
			if arg_15_2.isLock then
				...
				var_15_16(var_15_1:Find("cost/Text"), arg_15_2.cost)

				onButton = var_15_16
				var_15_13 = arg_15_0

				local var_15_14 = var_15_1
				local var_15_15 = arg_15_2.lockFunc

				SFX_CONFIRM = var_1_10011

				var_15_16(var_15_13, var_15_14, var_15_15, var_1_10011)
			else
				var_15_16 = arg_15_0.timers
				Timer = var_15_13
				var_15_16[var_15_1] = var_15_13.New(function()
					...
					if var_17_0 - var_1.GetServerTime(var_17_1) < 0 then
						...
						local var_17_3 = var_15_1
						local var_17_4 = var_2.Find(var_17_3, "time/Text")

						string = var_17_3

						local var_17_5 = var_17_3.format
						local var_17_6 = "%d:%02d:%02d"

						math = var_2_10005

						local var_17_7 = var_2_10005.floor(var_0 / 16)

						math = var_6

						var_1(var_17_4, var_17_5(var_17_6, var_17_7, var_6.floor(var_0 % 16 / 60), var_0 % 60))
					end
				...
				local var_15_17 = arg_15_0.timers[var_15_1]

				var_15_16.Start(var_15_17)

				onButton = var_15_16

				local var_15_18 = arg_15_0
				local var_15_19 = var_15_1
				local var_15_20 = arg_15_2.timeFunc

				SFX_CONFIRM = var_1_10011

				var_15_16(var_15_18, var_15_19, var_15_20, var_1_10011)
			end
		end

		isActive = var_15_16

		if var_15_16(var_15_3) then
			setText = var_7

			var_7(var_15_3:Find("cost/Text"), arg_15_2.cost)

			onButton = var_7

			local var_15_21 = arg_15_0
			local var_15_22 = var_15_3
			local var_15_23 = arg_15_2.enableFunc

			SFX_CONFIRM = var_1_10011

			var_7(var_15_21, var_15_22, var_15_23, var_1_10011)
		end
...
function var_0_1.UpdateOrderBtn(arg_18_0)
	...
	local var_18_0 = var_1()
	local var_18_1 = arg_18_0.map
	local var_18_2 = var_2.GetConfig(var_18_1, "instruction_available")

	checkExist = var_18_1

	local var_18_3 = var_18_1(arg_18_0.map, {
		"GetPort"
	})
	local var_18_4 = var_18_0:GetRealm()
	local var_18_5 = var_18_0
	local var_18_6 = var_18_0.IsSystemOpen

	WorldConst = var_1_10007

	if var_18_6(var_18_5, var_1_10007.SystemOrderRedeploy) then
		checkExist = var_18_7

		local var_18_7

		if var_18_4 == var_18_7(var_18_3, {
			"GetRealm"
		}) then
			checkExist = var_18_7

			if var_18_7(var_18_3, {
				"IsOpen",
				{
					var_18_4,
				...
				var_18_7 = var_18_0:BuildFormationIds()
			end
		else
			var_18_7 = false
		end
	...
	WorldConst = var_7
	var_18_8.system = var_7.SystemOrderRedeploy
	var_18_8.isLock = not var_18_7

	function var_18_8.lockFunc()
		pg = var_2_10000
		...
		var_19_1(var_19_0, var_2_10002("world_instruction_redeploy_1"))

		return
	end

	local var_18_9 = var_18_0
	local var_18_10 = var_18_0.CalcOrderCost

	WorldConst = var_1_10009
	var_18_8.cost = var_18_10(var_18_9, var_1_10009.OpReqRedeploy)

	function var_18_8.enableFunc(arg_20_0, arg_20_1)
		...
		WorldScene = var_2_10004

		var_20_2(var_20_1, var_2_10004.SceneOp, "OpRedeploy")

		return
	end

	arg_18_0:SetButton(arg_18_0.btnRedeploy, var_18_8)
	arg_18_0:SetButton(arg_18_0.btnExpansion, var_18_8)

	setActive = var_7

	local var_18_11 = arg_18_0.btnRedeploy

	WorldConst = var_9

	var_7(var_18_11, var_18_7 ~= var_9.FleetExpansion)

	setActive = var_7

	local var_18_12 = arg_18_0.btnExpansion

	WorldConst = var_9

	var_7(var_18_12, var_18_7 == var_9.FleetExpansion)

	local var_18_13 = arg_18_0
	local var_18_14 = arg_18_0.SetButton
	local var_18_15 = arg_18_0.btnSubmarine
	local var_18_16 = {}

	WorldConst = var_1_10011
	var_18_16.system = var_1_10011.SystemOrderSubmarine

	if var_18_2[1] ~= 0 and var_18_0:CanCallSubmarineSupport() then
		if var_18_0:IsSubmarineSupporting() then
			local var_18_17 = var_18_0:GetSubAidFlag()
		end
	...
	var_18_16.isLock = var_18_17

	function var_18_16.lockFunc()
		if var_18_2[1] == 0 then
			pg = var_0
			...
			var_21_1(var_21_0, var_2_10002("world_instruction_submarine_1"))
		else
			local var_21_2 = var_18_0
			local var_21_4
			...
			if not var_0.CanCallSubmarineSupport(var_21_2) then
				...
				var_21_4(var_21_3, var_2_10002("world_instruction_submarine_4"))
			else
				pg = var_21_4
				...
				var_21_6(var_21_5, var_2_10002("world_instruction_submarine_3"))
			end
		end
	...
	local var_18_18 = var_18_0
	local var_18_19 = var_18_0.CalcOrderCost

	WorldConst = var_1_10013
	var_18_16.cost = var_18_19(var_18_18, var_1_10013.OpReqSub)

	function var_18_16.enableFunc()
		local var_22_0 = arg_18_0
		local var_22_1 = var_0.ShowMsgbox

		WorldConst = var_2_10002

		var_22_1(var_22_0, var_2_10002.OpReqSub)
	...
	local var_18_21 = arg_18_0.SetButton
	local var_18_22 = arg_18_0.btnFOV
	local var_18_23 = {}

	WorldConst = var_11
	var_18_23.system = var_11.SystemOrderFOV
	var_18_23.isLock = var_18_2[2] == 0 or arg_18_0.map.visionFlag

	function var_18_23.lockFunc()
		local var_23_1

		if var_18_2[2] == 0 then
			pg = var_23_1
			...
			var_23_1(var_23_0, var_2_10002("world_instruction_submarine_1"))
		else
			pg = var_23_1
			...
			var_23_3(var_23_2, var_2_10002("world_instruction_detect_2"))
		end

		return
	end

	local var_18_24 = var_18_0
	local var_18_25 = var_18_0.CalcOrderCost

	WorldConst = var_13
	var_18_23.cost = var_18_25(var_18_24, var_13.OpReqVision)

	function var_18_23.enableFunc()
		local var_24_0 = arg_18_0
		local var_24_1 = var_0.ShowMsgbox

		WorldConst = var_2_10002

		var_24_1(var_24_0, var_2_10002.OpReqVision)

		return
	end

	var_18_21(var_18_20, var_18_22, var_18_23)

	pg = var_18_21

	local var_18_26 = var_18_21.TimeMgr.GetInstance()

	pg = var_18_20

	local var_18_27 = var_18_20.gameset.world_instruction_maintenance.description[2]
	local var_18_28 = var_18_0
	local var_18_29 = var_18_0.GetReqCDTime

	WorldConst = var_11

	local var_18_30 = var_18_29(var_18_28, var_11.OpReqMaintenance) + var_18_27
	local var_18_31 = arg_18_0
	local var_18_32 = arg_18_0.SetButton
	local var_18_33 = arg_18_0.btnMaintenance
	local var_18_34 = {}

	WorldConst = var_1_10014
	var_18_34.system = var_1_10014.SystemOrderMaintenance
	var_18_34.isLock = var_18_2[3] == 0

	function var_18_34.lockFunc()
		pg = var_2_10000
		...
		var_25_1(var_25_0, var_2_10002("world_instruction_submarine_1"))

		return
	end

	var_18_34.timeStamp = var_18_30

	function var_18_34.timeFunc(arg_26_0)
		pg = var_2_10001
		...
		local var_26_3 = var_18_26
		local var_26_4 = var_5.DescCDTime
		local var_26_5 = var_18_30

		pg = var_2_10008

		local var_26_6 = var_2_10008.TimeMgr.GetInstance()

		var_26_1(var_26_0, var_2_10003(var_26_2, var_26_4(var_26_3, var_26_5 - var_8.GetServerTime(var_26_6))))

		return
	end

	local var_18_35 = var_18_0
	local var_18_36 = var_18_0.CalcOrderCost

	WorldConst = var_1_10016
	var_18_34.cost = var_18_36(var_18_35, var_1_10016.OpReqMaintenance)

	function var_18_34.enableFunc()
		local var_27_0 = arg_18_0
		local var_27_1 = var_0.ShowMsgbox

		WorldConst = var_2_10002

		var_27_1(var_27_0, var_2_10002.OpReqMaintenance)

		return
	end

	var_18_32(var_18_31, var_18_33, var_18_34)
...
function var_0_1.ShowMsgbox(arg_31_0, arg_31_1)
	...
	var_31_0(var_5.Find(var_31_2, "Text"), var_31_1)
	...
	if arg_31_1 == var_1_10008.OpReqMaintenance then
		i18n = var_8
		...
		var_1_10010 = var_1_10010(var_31_8, var_1_10012)
		setColorStr = var_31_8
		var_1_10012 = var_31_1
		...
		if var_31_3 <= var_31_1 then
			...
			var_31_4 = var_8(var_31_7, var_1_10010, var_31_8(var_1_10012, var_1_10013))
			i18n = var_8
			...
			function var_31_6()
				...
				local var_32_2 = var_2_10002.SceneOp
				local var_32_3 = "OpReqMaintenance"
				local var_32_4 = arg_31_0.map

				var_32_1(var_32_0, var_32_2, var_32_3, var_4.GetFleet(var_32_4).id)
			...
			if arg_31_1 == var_8.OpReqSub then
				...
				local var_31_9 = var_2.IsSubmarineSupporting(var_1_10010) and "world_instruction_submarine_7" or "world_instruction_submarine_2"
				...
				COLOR_GREEN = var_1_10012
				var_1_10010 = var_1_10010(var_31_10, var_1_10012)
				setColorStr = var_31_10
				var_1_10012 = var_31_1
				...
				if var_31_3 <= var_31_1 then
					...
					var_31_4 = var_8(var_31_9, var_1_10010, var_31_10(var_1_10012, var_1_10013))
					i18n = var_8
					...
					function var_31_6()
						...
						var_33_1(var_33_0, var_2_10002.SceneOp, "OpReqSub")
					...
					if arg_31_1 == var_8.OpReqVision then
						...
						local var_31_13 = var_1_10010(var_31_12, var_1_10012)

						setColorStr = var_31_12
						...
						if var_31_3 <= var_31_1 then
							...
							var_31_4 = var_8(var_31_11, var_31_13, var_31_12(var_31_14, var_1_10013))
							i18n = var_8
							var_31_5 = var_8("world_instruction_submarine_8")
							...
							function var_31_6()
								...
								var_34_1(var_34_0, var_2_10002.SceneOp, "OpReqVision")
							...
							var_8(var_9.Find(var_31_15, "content"), var_31_4)

							setText = var_8

							local var_31_16 = arg_31_0.rtMsgBase

							var_8(var_9.Find(var_31_16, "other"), var_31_5)

							onButton = var_8

							local var_31_17 = arg_31_0
							local var_31_18 = arg_31_0.rtMsgBtns
							local var_31_19 = var_10.Find(var_31_18, "btn_confirm")
							...
							var_8(var_31_17, var_31_19, var_31_20, var_12)
							...
							if arg_31_1 == var_8.OpReqSub then
								...
								local var_31_23 = var_9.Find(var_31_22, "content/text_1")

								i18n = var_31_22

								var_8(var_31_23, var_31_22("world_instruction_submarine_9"))

								local var_31_24 = arg_31_0.rtMsgExtra
								local var_31_25 = var_8.Find(var_31_24, "content/toggle_area/toggle")

								PlayerPrefs = var_31_24

								local var_31_26 = var_31_24.GetInt("world_sub_auto_call", 0) == 1

								triggerToggle = var_10

								var_10(var_31_25, var_31_26)
								...
								var_10(var_31_27, var_31_28, var_31_29, var_1_10014)

								pg = var_10

								local var_31_30 = var_10.gameset.world_instruction_submarine.description[1]

								math = var_31_27

								local var_31_31 = var_31_27.clamp
								...
								var_31_33(var_31_34:Find("number/Text"), var_31_32)

								pressPersistTrigger = var_31_33
								...
								local function var_31_37(arg_37_0)
									...
									var_1(var_2.Find(var_37_0, "number/Text"), var_31_32)
								...
								var_31_33(var_31_35, var_31_36, var_31_37, var_31_38, var_31_39, var_31_40, var_31_41, var_1_10021)
								...
								local function var_31_44(arg_38_0)
									...
									var_1(var_2.Find(var_38_0, "number/Text"), var_31_32)
								...
								var_31_33(var_31_42, var_31_43, var_31_44, var_31_45, var_31_46, var_31_47, var_31_48, var_1_10021)

								onButton = var_31_33

								local var_31_49 = arg_31_0
								local var_31_50 = arg_31_0.rtMsgBtns
								local var_31_51 = var_15.Find(var_31_50, "btn_setting")
								...
								local function var_31_52()
									...
									var_39_3(var_39_2, var_2("world_instruction_submarine_11"))
								...
								var_31_33(var_31_49, var_31_51, var_31_52, var_17)
							end
...
function var_0_1.DisplayAutoSetting(arg_41_0, arg_41_1)
	...
	var_1_10002(var_3.Find(var_41_0, "btn_confirm"), not arg_41_1)

	setActive = var_1_10002

	local var_41_1 = arg_41_0.rtMsgBtns

	var_1_10002(var_3.Find(var_41_1, "btn_setting"), arg_41_1)
