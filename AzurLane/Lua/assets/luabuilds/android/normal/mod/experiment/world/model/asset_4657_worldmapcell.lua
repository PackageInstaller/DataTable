...
function var_0_1.AddAttachment(arg_5_0, arg_5_1)
	...
	var_1_10002(not var_1_10003.any(arg_5_0.attachments, function(arg_6_0)
	...
	var_1_10002(var_3.SortOrder[arg_5_1.type], arg_5_1.type .. " : sort order not set.")
...
function var_0_1.RemoveAttachment(arg_7_0, arg_7_1)
	if arg_7_1 ~= nil then
		...
		if var_1_10002(arg_7_1) == "number" then
			...
			assert = var_1_10002
			var_1_10003 = 1 <= arg_7_1 and arg_7_1 <= #arg_7_0.attachments
...
function var_0_1.GetEventAttachment(arg_45_0)
	...
	return var_1_10001.detect(arg_45_0.attachments, function(arg_46_0)
		...
		if arg_46_0.IsAlive(var_46_0) then
			var_46_1 = arg_46_0.type
			WorldMapAttachment = var_46_0
			var_46_1 = var_46_1 == var_46_0.TypeEvent
		end
...
function var_0_1.GetCompassAttachment(arg_47_0)
	...
	var_47_2 = var_47_1(var_3.sort(var_47_0, function(arg_48_0, arg_48_1)
		local var_48_0
		...
		if var_1.ShouldMarkAsLurk(var_49_0) then
			...
			if var_1.IsAlive(var_49_0) then
				var_49_0 = var_1

				if var_1.IsVisible(var_49_0) then
			...
			WorldMapAttachment = var_49_0

			local var_49_3

			if var_49_2 == var_49_0.TypeEvent then
				var_49_3 = var_1

				local var_49_4

				if var_1.IsAlive(var_49_3) then
					var_49_4 = var_1.config.visuality == 0
				end
				...
				WorldMapAttachment = var_49_3

				if var_49_5 ~= var_49_3.TypeFleet then
					local var_49_6 = var_1.type

					WorldMapAttachment = var_3

					if var_49_6 ~= var_3.TypePort then
...
function var_0_1.GetDisplayQuad(arg_64_0)
	...
	if not arg_64_0.InFog(var_64_2) and var_64_1 then
		local var_64_3 = var_64_1.type

		WorldMapAttachment = var_64_2

		if var_64_3 == var_64_2.TypeEvent then
			if var_64_1.config.object_icon and #var_64_3 > 0 then
				var_64_0 = var_64_3
			end
		...
		if var_64_3.IsEnemyType(var_64_1.type) then
			var_64_0 = {
				"cell_red"
			}
		...
		local var_64_4 = var_64_1.type

		WorldMapAttachment = var_4

		if var_64_4 ~= var_4.TypePort then
			do
				local var_64_5 = var_64_1.type
...
function var_0_1.GetTerrainObstacleConfig(arg_67_0, arg_67_1)
	...
	local var_67_2 = var_67_0.GetObstacleKey(arg_67_1)

	bit = var_4

	return var_4.band(var_0_1.TerrainObstacleConfig[var_67_1], var_67_2) > 0
end
