...
function var_0_1.Setup(arg_2_0, arg_2_1)
	...
	var_2_1(var_2_0, var_1_10004.EventUpdateCount, arg_2_0.onUpdate)
	arg_2_0:Init()
...
function var_0_1.Dispose(arg_3_0)
	...
	WorldGoods = var_1_10003

	var_3_1(var_3_0, var_1_10003.EventUpdateCount, arg_3_0.onUpdate)
	arg_3_0:Clear()
...
function var_0_1.Init(arg_4_0)
	...
	local var_4_1 = var_1
	local var_4_2 = var_1.Find(var_4_1, "mask/tag/sellout_tag")

	i18n = var_4_1

	var_2(var_4_2, var_4_1("word_sell_out"))

	setText = var_2

	local var_4_3 = var_1
	local var_4_4 = var_1.Find(var_4_3, "count_contain/label")

	i18n = var_4_3

	var_2(var_4_4, var_4_3("activity_shop_exchange_count"))

	local var_4_5 = arg_4_0.goods.item

	updateDrop = var_4_4

	var_4_4(arg_4_0.rtItem, var_4_5)

	setText = var_4_4

	local var_4_6 = arg_4_0.txName

	shortenString = var_5

	var_4_4(var_4_6, var_5(var_4_5:getConfig("name"), 6))

	local var_4_7 = arg_4_0.goods.moneyItem

	GetImageSpriteFromAtlasAsync = var_4_6

	var_4_6(var_4_7:getIcon(), "", arg_4_0.rtResIcon, false)

	setText = var_4_6

	var_4_6(arg_4_0.rtResCount, var_4_7.count)
	arg_4_0:Update()
