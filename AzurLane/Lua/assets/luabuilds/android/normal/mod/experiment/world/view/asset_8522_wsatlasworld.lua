...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".WSAtlas"))
...
function var_0_1.UpdateAtlas(arg_3_0, arg_3_1)
	if arg_3_0.atlas ~= arg_3_1 then
		...
		var_3_1(var_3_0, var_3_2, var_3_3, var_6.GetActiveEntrance(var_3_4))
...
function var_0_1.AddAtlasListener(arg_4_0)
	if arg_4_0.atlas then
		...
		var_4_1(var_4_0, var_1_10003.EventUpdatePortMark, arg_4_0.onUpdatePortMark)
	end
...
function var_0_1.RemoveAtlasListener(arg_5_0)
	if arg_5_0.atlas then
		...
		var_5_1(var_5_0, var_1_10003.EventUpdatePortMark, arg_5_0.onUpdatePortMark)
	end
...
function var_0_1.ReturnModel(arg_10_0)
	if arg_10_0.tfModel then
		...
		var_10_1(var_10_0, var_10_2, var_10_3, var_1_10005(arg_10_0.tfModel), true)
	end
...
function var_0_1.LoadScene(arg_11_0, arg_11_1)
	...
	LoadSceneMode = var_1_10006

	var_11_1(var_11_0, var_11_2, var_11_3, var_1_10006.Additive, function(arg_12_0, arg_12_1)
		...
		var_12_16.depthTextureMode = var_12_15.DepthTextureMode.Depth
		...
		UnityEngine = var_12_22

		local var_12_25 = var_12_24 / var_12_22.Screen.height
		...
		var_4.AddDragFunc(var_12_29, function(arg_13_0, arg_13_1)
			...
			if arg_11_0.nowArea then
				...
				local var_13_5 = var_2(var_13_2, var_13_3, var_13_4 / var_3_10006.cos(var_12_23)) * var_12_25
		...
		typeof = var_8
		PointerInfo = var_2_10009
		var_12_34.cmPointer = var_12_37(var_12_36, var_8(var_2_10009))
...
function var_0_1.ShowOrHide(arg_17_0, arg_17_1)
	...
	if arg_17_1 then
		...
		var_17_0(var_3.GetSceneByName("WorldMap3D"))
	else
		SceneManager = var_17_0
		...
		var_17_1(var_3.GetSceneByName("main"))
	end
...
function var_0_1.GetOffsetMapPos(arg_18_0)
	...
	local var_18_4 = var_18_3 * var_1_10006.cos(var_18_2)
	local var_18_5 = var_18_0.y

	math = var_7

	local var_18_6 = var_18_4 - var_18_5 * var_7.sin(var_18_2)
	local var_18_7 = var_18_0.y

	math = var_7

	local var_18_8 = var_18_7 * var_7.cos(var_18_2)
	local var_18_9 = var_18_0.x

	math = var_8

	return var_4(var_18_6, var_18_8 + var_18_9 * var_8.sin(var_18_2))
end
...
function var_0_1.UpdateSelect(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	if arg_19_1 then
		...
		var_19_1(var_19_0, var_1_10006(arg_19_1.config.area_pos[1], arg_19_1.config.area_pos[2]) + arg_19_0:GetOffsetMapPos(), nil, 1, true, function()
...
function var_0_1.UpdateEntranceMask(arg_22_0, arg_22_1)
	...
	if arg_22_1:HasPort() then
		...
		var_22_2(var_22_1, var_5.GetEntrancePortInfo(var_22_3, arg_22_1.id))
	end
...
function var_0_1.UpdateAreaLock(arg_24_0)
	for iter_24_0 = 1, 5 do
		...
		var_24_0(var_7.Find(var_24_1, "lock_layer/" .. iter_24_0), not var_1_10005)

		setActive = var_24_0

		local var_24_2 = arg_24_0.tfMapScene

		var_24_0(var_7.Find(var_24_2, "mask_layer/" .. iter_24_0), var_1_10005)

		if var_1_10005 and arg_24_0.areaLockPressingAward[iter_24_0] then
			ipairs = var_6

			for iter_24_1, iter_24_2 in var_6(arg_24_0.areaLockPressingAward[iter_24_0]) do
...
function var_0_1.OnUpdateActiveEntrance(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	for iter_25_0 = 1, 5 do
		...
		var_1_10009(var_10.Find(var_25_2, "selected_layer/B" .. iter_25_0 .. "_2"), iter_25_0 == var_25_1)

		setActive = var_1_10009

		local var_25_3 = arg_25_0.tfAreaScene

		var_1_10009(var_10.Find(var_25_3, "base_layer/B" .. iter_25_0), iter_25_0 ~= var_25_1)
	end
...
function var_0_1.OnUpdatePressingAward(arg_26_0, arg_26_1, arg_26_2, arg_26_3)
	...
	for iter_26_0, iter_26_1 in var_1_10004(arg_26_3) do
		if iter_26_1 then
			...
			if var_10.CheckAreaUnlock(var_26_3, var_26_2) then
				local var_26_4 = arg_26_0.entranceTplDic[iter_26_0]

				var_10.UpdatePressingAward(var_26_4)
			else
				local var_26_5 = arg_26_0.areaLockPressingAward
				local var_26_6
				...
				var_26_5[var_26_2] = var_26_6
				table = var_26_5

				var_26_5.insert(arg_26_0.areaLockPressingAward[var_26_2], iter_26_0)
			end
		end
	end
...
function var_0_1.OnUpdatePortMark(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	for iter_27_0, iter_27_1 in var_1_10004(arg_27_3) do
		if iter_27_1 then
			...
			var_27_1(var_27_0, var_11.GetEntrancePortInfo(var_27_2, iter_27_0))
		end
	end
...
function var_0_1.DisposeEntranceTplDic(arg_29_0)
	...
	var_29_1(var_29_0, var_1_10003.values(arg_29_0.entranceTplDic))
...
function var_0_1.NewEntranceTpl(arg_30_0, arg_30_1)
	...
	WSEntranceTpl = var_1_10004

	local var_30_2 = var_30_1(var_30_0, var_1_10004).transform
	...
	WorldConst = var_30_2
	var_30_3.localPosition = var_30_2.CalcModelPosition(arg_30_1, arg_30_0.spriteBaseSize)
...
function var_0_1.UpdateScale(arg_32_0, arg_32_1)
	...
	local var_32_6 = -var_1_10007.sin(var_32_1) * var_32_4

	math = var_8

	local var_32_7 = var_5(var_32_5, var_32_6, var_8.cos(var_32_1) * var_32_4)
...
function var_0_1.FocusPos(arg_33_0, arg_33_1, arg_33_2, arg_33_3, arg_33_4, arg_33_5)
	...
	if not arg_33_1 then
		...
		local var_33_2 = var_33_1 * var_1_10009.cos(var_33_0)

		var_1_10009 = arg_33_1.y
		math = var_10

		local var_33_3 = var_33_2 - var_1_10009 * var_10.sin(var_33_0)

		var_1_10009 = arg_33_1.y
		math = var_10
		var_1_10009 = var_1_10009 * var_10.cos(var_33_0)

		local var_33_4 = arg_33_1.x

		math = var_11
		arg_33_1 = var_7(var_33_3, var_1_10009 + var_33_4 * var_11.sin(var_33_0)) + var_0_1.spriteBaseSize / 2
	end

	math = var_33_0

	local var_33_5 = var_33_0.rad(arg_33_0.tfEntity.localEulerAngles.y - arg_33_2)

	arg_33_1 = arg_33_1 - var_0_1.spriteBaseSize / 2
	Vector2 = var_7

	local var_33_6 = arg_33_1.x

	math = var_1_10009

	local var_33_7 = var_33_6 * var_1_10009.cos(var_33_5)
	local var_33_8 = arg_33_1.y

	math = var_10

	local var_33_9 = var_33_7 - var_33_8 * var_10.sin(var_33_5)
	local var_33_10 = arg_33_1.y

	math = var_10

	local var_33_11 = var_33_10 * var_10.cos(var_33_5)
	local var_33_12 = arg_33_1.x

	math = var_11
	arg_33_1 = var_7(var_33_9, var_33_11 + var_33_12 * var_11.sin(var_33_5))
	Vector3 = var_7

	local var_33_13 = var_7(arg_33_1.x, 0, arg_33_1.y)

	PIXEL_PER_UNIT = var_8

	local var_33_14 = var_33_13 / var_8
	local var_33_15 = arg_33_0.transform
	local var_33_16 = var_8.InverseTransformPoint
	local var_33_17 = arg_33_0.tfSpriteScene
	local var_33_18 = var_33_16(var_33_15, var_10.TransformPoint(var_33_17, var_33_14))

	math = var_33_15

	local var_33_19 = var_33_15.rad(arg_33_0.tfCamera.localEulerAngles.x)

	Vector3 = var_10

	local var_33_20 = 0
	local var_33_21 = var_33_18.y
	local var_33_22 = var_33_18.y

	math = var_1_10014

	local var_33_23 = var_33_18 - var_10(var_33_20, var_33_21, var_33_22 / -var_1_10014.tan(var_33_19))

	Vector3 = var_10

	local var_33_24 = 0
	local var_33_25 = arg_33_0.tfCamera.localPosition.y
	local var_33_26 = arg_33_0.tfCamera.localPosition.y

	math = var_14

	local var_33_27 = (var_33_23 + var_10(var_33_24, var_33_25, var_33_26 / -var_14.tan(var_33_19))).y

	math = var_33_25

	local var_33_28 = var_33_27 / -var_33_25.sin(var_33_19)
	local var_33_29 = var_0_1.baseDistance * (1 - arg_33_3) + var_0_1.frontDistance * arg_33_3 - var_33_28
	...
	local var_33_31 = -var_15.sin(var_33_19) * var_33_29

	math = var_16

	local var_33_32 = var_10 + var_13(var_33_30, var_33_31, var_16.cos(var_33_19) * var_33_29)

	if arg_33_4 then
		math = var_13

		local var_33_33 = var_13.min

		Vector3 = var_33_30

		local var_33_34 = var_33_33(var_33_30.Distance(arg_33_0.tfCamera.localPosition, var_33_32) / var_0_1.baseMoveDistance, 1) * var_0_1.baseDuration

		math = var_33_30
		var_33_30 = var_33_30.min
		math = var_15
		var_33_30 = var_33_30(var_15.abs(arg_33_2 - arg_33_0.tfEntity.localEulerAngles.y) / 180, 1) * var_0_1.baseDuration
		...
		var_16.insert(var_33_35, function(arg_34_0)
			...
			local var_34_1 = var_34_0(var_2_10002(arg_33_0.tfCamera), var_33_32, var_33_34)
			local var_34_2 = var_1.setEase

			LeanTweenType = var_3

			local var_34_3 = var_34_2(var_34_1, var_3.easeInOutSine)
			local var_34_4 = var_1.setOnComplete

			System = var_3

			local var_34_5 = var_34_4(var_34_3, var_3.Action(arg_34_0)).uniqueId

			table = var_34_3

			var_34_3.insert(arg_33_0.twFocusIds, var_34_5)
		...
		var_16.insert(var_33_35, function(arg_35_0)
			...
			local var_35_1 = var_35_0(var_2_10002(arg_33_0.tfEntity), arg_33_2, var_33_30)
			local var_35_2 = var_1.setEase

			LeanTweenType = var_3

			local var_35_3 = var_35_2(var_35_1, var_3.easeInOutSine)
			local var_35_4 = var_1.setOnComplete

			System = var_3

			local var_35_5 = var_35_4(var_35_3, var_3.Action(arg_35_0)).uniqueId

			table = var_35_3

			var_35_3.insert(arg_33_0.twFocusIds, var_35_5)
		...
		arg_33_0.tfCamera.localPosition = var_33_32

		local var_33_36 = arg_33_0.tfEntity

		Vector3 = var_33_30
		var_33_36.localEulerAngles = var_33_30(0, arg_33_2, 0)
		existCall = var_33_36
...
function var_0_1.FocusPosInArea(arg_37_0, arg_37_1, arg_37_2, arg_37_3)
	if arg_37_1 then
		...
		var_37_2(var_37_1, var_1_10007(var_37_0.regions_pos[1], var_37_0.regions_pos[2]), var_37_0.regions_rotation[1], 1, arg_37_2, arg_37_3)
	else
...
function var_0_1.SwitchArea(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	if arg_38_2 then
		...
		if var_1_10005 ~= var_6(arg_38_0.nowArea) then
			table = var_1_10005
...
function var_0_1.SwitchMode(arg_44_0, arg_44_1, arg_44_2, arg_44_3)
	local function var_44_0(arg_45_0)
		...
		local var_45_6 = var_45_5(var_45_4, var_4.Action_float(function(arg_46_0)
		...
		local var_45_8 = var_45_7(var_45_6, var_4.Action(function()
			var_0.alpha = 1
		...
		var_45_6.insert(arg_44_0.twFocusIds, var_45_8)
	...
	local function var_44_1(arg_48_0)
		...
		local var_48_6 = var_48_5(var_48_4, var_4.Action_float(function(arg_49_0)
		...
		local var_48_8 = var_48_7(var_48_6, var_4.Action(function()
			var_0.alpha = 1
		...
		var_48_6.insert(arg_44_0.twFocusIds, var_48_8)
	...
	local function var_44_2(arg_51_0)
		...
		var_3.insert(var_51_0, function(arg_52_0)
			...
			local var_52_6 = var_52_5(var_52_4, var_5.Action_float(function(arg_53_0)
			...
			local var_52_8 = var_52_7(var_52_6, var_5.Action(function()
			...
			var_52_6.insert(arg_44_0.twFocusIds, var_52_8)
		...
		var_3.insert(var_51_0, function(arg_55_0)
			...
			local var_55_7 = var_55_6(var_55_5, var_5.Action_float(function(arg_56_0)
			...
			local var_55_9 = var_55_8(var_55_7, var_5.Action(function()
				var_0.alpha = 1
			...
			var_55_7.insert(arg_44_0.twFocusIds, var_55_9)
...
function var_0_1.BreathRotate(arg_61_0, arg_61_1)
	...
	local function var_61_1()
		...
		local var_62_2 = var_2_10002(arg_61_0.tfEntity)
		local var_62_3
		...
		System = var_3
		var_62_0.twRotateId = var_62_7(var_62_6, var_3.Action(function()
			var_61_1()
	...
	local var_61_3 = var_61_2(var_1_10005(arg_61_0.tfEntity), var_0_1.LowRotation, var_0_1.BreathTime / 2)
	local var_61_4 = var_4.setEase

	LeanTweenType = var_6

	local var_61_5 = var_61_4(var_61_3, var_6.easeOutSine)
	local var_61_6 = var_4.setOnComplete

	System = var_6

	local var_61_7 = var_61_6(var_61_5, var_6.Action(function()
		var_61_1()
...
function var_0_1.ActiveTrans(arg_66_0, arg_66_1)
	if arg_66_0.entranceTplDic[arg_66_1.id].portCamp then
		...
		var_66_7(var_66_6, var_7.Action(function()
			...
			local var_67_1 = var_67_0(var_2_10001(var_66_1), 0, 0.2)
			local var_67_2 = var_0.setDelay(var_67_1, 0.1)
			local var_67_3 = var_0.setOnComplete

			System = var_2

			var_67_3(var_67_2, var_2.Action(function()
				setActive = var_3_10000
...
function var_0_1.UpdateTransMark(arg_70_0, arg_70_1, arg_70_2)
	...
	for iter_70_0, iter_70_1 in var_1_10003(arg_70_1) do
		if iter_70_1 then
			...
			var_70_1(var_70_0, var_10.GetEntrance(var_70_2, iter_70_0))
		end
	end
...
function var_0_1.UpdateActiveMark(arg_72_0)
	...
	var_72_1(arg_72_0.tfActiveMark, function(arg_73_0)
		setActive = var_2_10001
