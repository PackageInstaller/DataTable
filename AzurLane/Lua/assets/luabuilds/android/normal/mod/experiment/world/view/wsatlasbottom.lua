...
function var_0_1.Init(arg_3_0)
	...
	CAMERA_MOVE_OPEN = var_3_6
	var_3_7.interactable = var_3_6
...
function var_0_1.UpdateScale(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	if arg_5_2 then
		...
		local var_5_1 = var_6(arg_5_0.comSilder)
		local var_5_2 = var_1_10004
		local var_5_3 = arg_5_1

		WSAtlasWorld = var_1_10009

		local var_5_4 = var_5_0(var_5_1, var_5_2, var_5_3, var_1_10009.baseDuration)
		...
		local var_5_8 = var_5_7(var_5_6, var_7.Action_float(function(arg_6_0)
		...
		System = var_7
		arg_5_0.twId = var_5_9(var_5_8, var_7.Action(function()
