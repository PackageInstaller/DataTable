...
function var_0_1.Setup(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_1_1 * var_3.pi
...
function var_0_1.GetLinePosition(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_1 = var_1_10003(var_2_0, var_1_10005.MaxRow * 0.5 - arg_2_1 - 0.5)

	Vector3 = var_2_0

	return var_2_0(var_2_1.x * (arg_2_0.cellSize.x + arg_2_0.cellSpace.x), var_2_1.y * (arg_2_0.cellSize.y + arg_2_0.cellSpace.y), 0)
end
...
function var_0_1.Y2Row(arg_4_0, arg_4_1)
	...
	return var_4_0(var_1_10003.MaxRow * 0.5 - 0.5 - arg_4_1 / (arg_4_0.cellSize.y + arg_4_0.cellSpace.y))
end
