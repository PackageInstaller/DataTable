...
function var_0_1.InitPlane(arg_8_0, arg_8_1)
	...
	var_2.GetPrefab(var_8_0, "world/object/world_plane", "world_plane", true, function(arg_9_0)
		...
		local var_9_19 = var_9_17:Find("display")
		local var_9_20 = var_4.Find(var_9_19, "mask/sea")
		...
		local var_9_21 = var_9_19(10000, 10000)

		Vector2 = var_7

		local var_9_22 = var_7.zero

		Vector2 = var_8
		WorldConst = var_9

		local var_9_23 = var_9.MaxColumn

		WorldConst = var_2_10010

		local var_9_24 = var_8(var_9_23, var_2_10010.MaxRow)

		Vector2 = var_9_23
		WorldConst = var_10

		local var_9_25 = -var_10.MaxColumn

		WorldConst = var_2_10011

		local var_9_26 = var_9_23(var_9_25, -var_2_10011.MaxRow)
		local var_9_27 = 0

		WorldConst = var_11

		for iter_9_0 = var_9_27, var_11.MaxRow - 1 do
			local var_9_28 = 0

			WorldConst = var_2_10015

			for iter_9_1 = var_9_28, var_2_10015.MaxColumn - 1 do
				var_2_10019 = var_9_15

				if var_9_15.GetCell(var_2_10019, iter_9_0, iter_9_1) then
					math = var_2_10019
					var_9_21.x = var_2_10019.min(var_9_21.x, iter_9_1)
					math = var_2_10019
					var_2_10019 = var_2_10019.min
					var_2_10020 = var_9_21.y
					WorldConst = var_2_10021
					var_9_21.y = var_2_10019(var_2_10020, var_2_10021.MaxRow * 0.5 - iter_9_0 - 1)
					math = var_2_10019
					var_9_24.x = var_2_10019.min(var_9_24.x, iter_9_1)
					math = var_2_10019
					var_9_24.y = var_2_10019.min(var_9_24.y, iter_9_0)
					math = var_2_10019
					var_9_26.x = var_2_10019.max(var_9_26.x, iter_9_1)
					math = var_2_10019
					var_9_26.y = var_2_10019.max(var_9_26.y, iter_9_0)
				end
			end
		end
		...
		var_9_21.x = var_9_21.x * var_9_29.x
		var_9_21.y = var_9_21.y * var_9_29.y
		var_9_22.x = (var_9_26.x - var_9_24.x + 1) * var_9_29.x
		var_9_22.y = (var_9_26.y - var_9_24.y + 1) * var_9_29.y
		var_4.anchoredPosition = var_9_21 + var_9_22 * 0.5
		var_4.sizeDelta = var_9_22
		Vector2 = var_11
		math = var_12

		local var_9_30 = var_12.floor(var_4.sizeDelta.x / var_9_29.x)

		math = var_13

		local var_9_31 = var_11(var_9_30, var_13.floor(var_4.sizeDelta.y / var_9_29.y))
		...
		typeof = var_2_10016
		GridLayoutGroup = iter_9_1

		local var_9_36 = var_9_35(var_9_34, var_2_10016(iter_9_1))

		Vector2 = var_9_34
		WorldConst = var_16
		var_9_36.cellSize = var_9_34(var_16.LineCross, var_4.sizeDelta.y)
		Vector2 = var_15

		local var_9_37 = var_9_29.x

		WorldConst = var_17
		var_9_36.spacing = var_15(var_9_37 - var_17.LineCross, 0)

		local var_9_38 = var_9_36.padding

		math = var_16
		var_9_38.left = var_16.floor(var_9_36.spacing.x)
		...
		for iter_9_2 = var_9_39, var_16.max(var_9_31.x - 1, 0), -1 do
			if 0 < iter_9_2 then
				...
				var_2_10019(var_12.GetChild(var_2_10021, iter_9_2))
			end
		end

		for iter_9_3 = var_12.childCount, var_9_31.x - 2 do
			Instantiate = var_2_10019
			var_2_10020 = var_2_10019(var_9_33).transform

			var_2_10019.SetParent(var_2_10020, var_12, false)
		end
		...
		typeof = var_2_10019
		GridLayoutGroup = var_2_10020

		local var_9_44 = var_9_43(var_9_42, var_2_10019(var_2_10020))

		Vector2 = var_9_42

		local var_9_45 = var_4.sizeDelta.x

		WorldConst = var_2_10020
		var_9_44.cellSize = var_9_42(var_9_45, var_2_10020.LineCross)
		Vector2 = var_18
		...
		WorldConst = var_2_10021
		var_9_44.spacing = var_18(var_9_46, var_9_47 - var_2_10021.LineCross)

		local var_9_48 = var_9_44.padding

		math = var_9_46
		var_9_48.top = var_9_46.floor(var_9_44.spacing.y)
		...
		for iter_9_4 = var_9_49, var_19.max(var_9_31.y - 1, 0), -1 do
			if 0 < iter_9_4 then
				...
				var_2_10022(var_15:GetChild(iter_9_4))
			end
		end

		for iter_9_5 = var_15.childCount, var_9_31.y - 2 do
			Instantiate = var_2_10022

			local var_9_50 = var_2_10022(var_9_41).transform

			var_2_10022.SetParent(var_9_50, var_15, false)
		end
...
function var_0_1.InitClutter(arg_11_0)
	...
	local var_11_4 = var_11_0(var_11_1, var_11_2, var_11_3, var_1_10005.QuadBlinkDuration)
...
function var_0_1.InitMap(arg_12_0)
	...
	var_4.sort(var_12_1, function(arg_13_0, arg_13_1)
	...
	for iter_12_0, iter_12_1 in var_4(var_12_1) do
		var_1_10009 = arg_12_0:NewQuad(iter_12_1)

		local var_12_2 = arg_12_0.wsMapQuads

		WSMapQuad = var_11
		var_12_2[var_11.GetName(iter_12_1.row, iter_12_1.column)] = var_1_10009

		local var_12_3 = arg_12_0:NewCell(iter_12_1)
		local var_12_4 = arg_12_0.wsMapCells

		WSMapCell = var_12
		var_12_4[var_12.GetName(iter_12_1.row, iter_12_1.column)] = var_12_3
	end
	...
	for iter_12_2, iter_12_3 in var_4(var_1.config.float_items) do
		...
		if var_1:GetCell(var_1_10009, var_12_5) then
			local var_12_7

			if not arg_12_0:GetItem(var_1_10009, var_12_5) then
				local var_12_6 = arg_12_0

				var_12_7 = arg_12_0.NewItem(var_12_6, var_11)

				local var_12_8 = arg_12_0.wsMapItems

				WSMapItem = var_12_6
				var_12_8[var_12_6.GetName(var_11.row, var_11.column)] = var_12_7
			end

			local var_12_9 = arg_12_0
			local var_12_10 = arg_12_0.NewArtifact(var_12_9, var_12_7, iter_12_3)

			table = var_12_9

			var_12_9.insert(arg_12_0.wsMapArtifacts, var_12_10)
		end
	end
	...
	for iter_12_4, iter_12_5 in var_4(var_12_1) do
		...
		for iter_12_6, iter_12_7 in var_1_10009(iter_12_5.attachments) do
			local var_12_11 = arg_12_0:GetCell(iter_12_7.row, iter_12_7.column)
			local var_12_12 = iter_12_7.type

			WorldMapAttachment = var_16

			if var_12_12 == var_16.TypeArtifact then
				local var_12_14

				if not arg_12_0:GetItem(iter_12_5.row, iter_12_5.column) then
					local var_12_13 = arg_12_0

					var_12_14 = arg_12_0.NewItem(var_12_13, iter_12_5)

					local var_12_15 = arg_12_0.wsMapItems

					WSMapItem = var_12_13
					var_12_15[var_12_13.GetName(iter_12_5.row, iter_12_5.column)] = var_12_14
				end

				local var_12_16 = arg_12_0
				local var_12_17 = arg_12_0.NewArtifact(var_12_16, var_12_14, iter_12_7:GetArtifaceInfo(), iter_12_7)

				table = var_12_16

				var_12_16.insert(arg_12_0.wsMapArtifactsFA, var_12_17)
			else
				local var_12_18 = arg_12_0
				local var_12_19 = arg_12_0.NewAttachment(var_12_18, var_12_11, iter_12_7)

				table = var_12_18

				var_12_18.insert(arg_12_0.wsMapAttachments, var_12_19)
			end
		end
	end
	...
	for iter_12_8, iter_12_9 in var_4(var_1:GetNormalFleets()) do
		...
		local var_12_21 = arg_12_0.NewFleet(var_12_20, iter_12_9)

		table = var_12_20

		var_12_20.insert(arg_12_0.wsMapFleets, var_12_21)

		ipairs = var_10

		for iter_12_10, iter_12_11 in var_10(iter_12_9:GetCarries()) do
			local var_12_22 = arg_12_0
			local var_12_23 = arg_12_0.NewCarryItem(var_12_22, iter_12_9, iter_12_11)

			table = var_12_22

			var_12_22.insert(arg_12_0.wsCarryItems, var_12_23)
		end
	end

	arg_12_0:FlushFleets()

	local var_12_24 = var_1
	local var_12_25 = var_1.AddListener

	WorldMap = var_6

	var_12_25(var_12_24, var_6.EventUpdateFleetFOV, arg_12_0.onUpdateFleetFOV)
...
function var_0_1.DisposeMap(arg_14_0)
	...
	var_14_1(var_14_0, var_1_10003.EventUpdateFleetFOV, arg_14_0.onUpdateFleetFOV)
...
function var_0_1.OnAddAttachment(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	var_20_0(var_20_1, "cell not exist: " .. arg_20_2.row .. ", " .. arg_20_2.column)

	local var_20_2 = arg_20_3.type

	WorldMapAttachment = var_6

	if var_20_2 == var_6.TypeArtifact then
		local var_20_4

		if not arg_20_0:GetItem(arg_20_2.row, arg_20_2.column) then
			local var_20_3 = arg_20_0

			var_20_4 = arg_20_0.NewItem(var_20_3, arg_20_2)

			local var_20_5 = arg_20_0.wsMapItems
		...
		local var_20_7 = arg_20_0.NewArtifact(var_20_6, var_20_4, arg_20_3:GetArtifaceInfo(), arg_20_3)

		table = var_20_6

		var_20_6.insert(arg_20_0.wsMapArtifactsFA, var_20_7)
	else
		local var_20_8 = arg_20_0
		local var_20_9 = arg_20_0.NewAttachment(var_20_8, var_20_1, arg_20_3)

		table = var_20_8

		var_20_8.insert(arg_20_0.wsMapAttachments, var_20_9)
...
function var_0_1.OnUpdateAttachment(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_1 = arg_22_0.FindAttachments(var_22_0, arg_22_2.row, arg_22_2.column)

	_ = var_22_0

	var_22_0.each(var_22_1, function(arg_23_0)
...
function var_0_1.OnUpdateTerrain(arg_24_0, arg_24_1, arg_24_2)
	...
	WorldMapCell = var_24_2

	if var_24_3 ~= var_24_2.TerrainStream then
		WorldMapCell = var_6
		...
		if var_24_3 ~= var_6.TerrainWind then
			...
			if var_24_3 ~= var_6.TerrainIce then
				...
				if var_24_3 == var_6.TerrainPoison then
					...
					local var_24_5 = arg_24_0.NewTerrainEffect(var_24_4, arg_24_2)

					table = var_24_4

					var_24_4.insert(arg_24_0.wsTerrainEffects, var_24_5)
				end
...
function var_0_1.OnAddCarry(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	local var_25_1 = arg_25_0.NewCarryItem(var_25_0, arg_25_2, arg_25_3)

	table = var_25_0

	var_25_0.insert(arg_25_0.wsCarryItems, var_25_1)
...
function var_0_1.NewQuad(arg_28_0, arg_28_1)
	...
	WSMapQuad = var_1_10004

	local var_28_2 = var_28_1(var_28_0, var_1_10004)

	WSMapQuad = var_28_0

	local var_28_3 = var_28_0.GetResName()
...
function var_0_1.NewItem(arg_30_0, arg_30_1)
	...
	WSMapItem = var_1_10004

	local var_30_2 = var_30_1(var_30_0, var_1_10004)

	WSMapItem = var_30_0

	local var_30_3 = var_30_0.GetResName()
...
function var_0_1.NewCell(arg_32_0, arg_32_1)
	...
	WSMapCell = var_1_10004

	local var_32_2 = var_32_1(var_32_0, var_1_10004)

	WSMapCell = var_32_0

	local var_32_3 = var_32_0.GetResName()
	...
	var_32_7(var_32_6, var_6.Find(var_32_8, "fogs"), true)
	...
	var_32_10(var_32_9, var_6.EventAddAttachment, arg_32_0.onAddAttachment)
	...
	var_32_12(var_32_11, var_6.EventRemoveAttachment, arg_32_0.onRemoveAttachment)
	...
	var_32_14(var_32_13, var_6.EventUpdateTerrain, arg_32_0.onUpdateTerrain)
...
function var_0_1.DisposeCell(arg_33_0, arg_33_1)
	...
	var_33_3(var_33_2, var_5.EventAddAttachment, arg_33_0.onAddAttachment)
	...
	var_33_5(var_33_4, var_5.EventRemoveAttachment, arg_33_0.onRemoveAttachment)
	...
	var_33_7(var_33_6, var_5.EventUpdateTerrain, arg_33_0.onUpdateTerrain)
...
function var_0_1.NewTransport(arg_34_0, arg_34_1, arg_34_2, arg_34_3)
	...
	WSMapTransport = var_1_10006

	local var_34_2 = var_34_1(var_34_0, var_1_10006)

	WSMapTransport = var_34_0

	local var_34_3 = var_34_0.GetResName()
...
function var_0_1.NewAttachment(arg_36_0, arg_36_1, arg_36_2)
	...
	WSMapAttachment = var_1_10005

	local var_36_2 = var_36_1(var_36_0, var_1_10005)

	WSMapAttachment = var_36_0

	local var_36_3 = var_36_0.GetResName(arg_36_2)
	...
	var_36_7(var_36_6, var_7.EventUpdateFlag, arg_36_0.onUpdateAttachment)
	...
	var_36_9(var_36_8, var_7.EventUpdateData, arg_36_0.onUpdateAttachment)
	...
	var_36_11(var_36_10, var_7.EventUpdateLurk, arg_36_0.onUpdateAttachment)
...
function var_0_1.DisposeAttachment(arg_37_0, arg_37_1)
	...
	var_37_1(var_37_0, var_1_10005.EventUpdateFlag, arg_37_0.onUpdateAttachment)
	...
	var_37_3(var_37_2, var_5.EventUpdateData, arg_37_0.onUpdateAttachment)
	...
	var_37_5(var_37_4, var_5.EventUpdateLurk, arg_37_0.onUpdateAttachment)
...
function var_0_1.NewArtifact(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	WSMapArtifact = var_1_10006

	local var_38_2 = var_38_1(var_38_0, var_1_10006).transform
...
function var_0_1.NewTerrainEffect(arg_41_0, arg_41_1)
	...
	WSMapCellEffect = var_1_10004

	local var_41_2 = var_41_1(var_41_0, var_1_10004)

	createNewGameObject = var_41_0
	var_41_2.transform = var_41_0("mapCellEffect")
...
function var_0_1.NewFleet(arg_44_0, arg_44_1)
	...
	WSMapFleet = var_1_10004

	local var_44_2 = var_44_1(var_44_0, var_1_10004)

	WSMapFleet = var_44_0

	local var_44_3 = var_44_0.GetResName()
	...
	var_44_8(var_44_7, var_6.EventAddCarry, arg_44_0.onAddCarry)
	...
	var_44_10(var_44_9, var_6.EventRemoveCarry, arg_44_0.onRemoveCarry)
...
function var_0_1.DisposeFleet(arg_45_0, arg_45_1)
	...
	var_45_1(var_45_0, var_1_10004.EventAddCarry, arg_45_0.onAddCarry)
	...
	var_45_3(var_45_2, var_4.EventRemoveCarry, arg_45_0.onRemoveCarry)
	...
	var_45_6(var_45_5, var_4.GetResName(), arg_45_1.transform.gameObject)
...
function var_0_1.NewCarryItem(arg_46_0, arg_46_1, arg_46_2)
	...
	local var_46_2 = var_46_1(var_46_0, var_1_10005)

	WSCarryItem = var_46_0

	local var_46_3 = var_46_0.GetResName()
...
function var_0_1.DisposeCarryItem(arg_47_0, arg_47_1)
	...
	var_47_1(var_47_0, var_1_10004.GetResName(), arg_47_1.transform.gameObject)
...
function var_0_1.DisplayMoveRange(arg_65_0)
	...
	for iter_65_0, iter_65_1 in var_4(var_65_3) do
		...
		var_65_5(var_65_7, var_65_8(var_65_9, var_65_10))

		setLocalScale = var_65_5

		local var_65_11 = var_65_6.rtWalkQuad

		Vector3 = var_12

		var_65_5(var_65_11, var_12.zero)

		ManhattonDist = var_65_5

		local var_65_12 = var_65_5(var_65_1, iter_65_1)

		math = var_11
		var_65_4 = var_11.max(var_65_4, var_65_12)

		local var_65_13 = {
			line = iter_65_1
		}

		function var_65_13.func()
			local var_66_0 = var_65_13
			...
			local var_66_3 = var_66_1(var_66_2, var_2_10003.one, 0.2)
			local var_66_4 = var_1.setEase

			LeanTweenType = var_3
			var_66_0.uid = var_66_4(var_66_3, var_3.easeInOutSine).uniqueId

			local var_66_5 = arg_65_0.wsTimer

			var_0.AddInMapTween(var_66_5, var_65_13.uid)

			return
		end

		local var_65_14 = arg_65_0.displayRangeLines
		local var_65_15

		if not arg_65_0.displayRangeLines[var_65_12] then
			var_65_15 = {}
		end

		var_65_14[var_65_12] = var_65_15
		table = var_65_14

		var_65_14.insert(arg_65_0.displayRangeLines[var_65_12], var_65_13)
	end

	if var_65_4 > 0 then
		local var_65_16 = 0
		local var_65_17 = arg_65_0.wsTimer

		arg_65_0.displayRangeTimer = var_5.AddInMapTimer(var_65_17, function()
			var_65_16 = var_65_16 + 1

			if arg_65_0.displayRangeLines[var_65_16] then
				ipairs = var_0

				for iter_67_0, iter_67_1 in var_0(arg_65_0.displayRangeLines[var_65_16]) do
					iter_67_1.func()
				end
			end
		...
		local var_65_18 = arg_65_0.displayRangeTimer

		var_5.Start(var_65_18)
	end
		...
		for iter_68_0, iter_68_1 in var_1(arg_68_0.displayRangeLines) do
			...
			for iter_68_2, iter_68_3 in var_1_10006(iter_68_1) do
				if iter_68_3.uid then
					local var_68_1 = arg_68_0.wsTimer

					var_11.RemoveInMapTween(var_68_1, iter_68_3.uid)
				end

				local var_68_2 = iter_68_3.line
				local var_68_3 = arg_68_0
				local var_68_4 = arg_68_0.GetQuad(var_68_3, var_68_2.row, var_68_2.column)

				setImageAlpha = var_68_3

				var_68_3(var_68_4.rtWalkQuad, 0)

				setLocalScale = var_68_3

				local var_68_5 = var_68_4.rtWalkQuad

				Vector3 = var_15

				var_68_3(var_68_5, var_15.one)
			end
		end
...
function var_0_1.MovePath(arg_69_0, arg_69_1, arg_69_2, arg_69_3, arg_69_4, arg_69_5)
	...
	if arg_69_5 then
		...
		local var_69_3 = var_9.Get

		WSMapEffect = var_1_10011
		var_69_2 = var_69_3(var_1_10010, var_1_10011)
		createNewGameObject = var_9
		var_69_2.transform = var_9("mapEffect")
		var_1_10010 = var_69_2.transform

		var_9.SetParent(var_1_10010, arg_69_1.transform, false)

		local var_69_4 = var_69_2.transform

		Vector3 = var_1_10010
		var_69_4.anchoredPosition3D = var_1_10010.zero

		local var_69_5 = var_69_2.transform

		Vector3 = var_1_10010
		var_69_5.localEulerAngles = var_1_10010(arg_69_0.map.theme.angle, 0, 0)
		var_69_2.modelOrder = arg_69_1.modelOrder
		var_1_10010 = var_69_2

		local var_69_6 = var_69_2.Setup

		WorldConst = var_11

		var_69_6(var_1_10010, var_11.GetWindEffect())

		var_1_10010 = var_69_2

		var_69_2.Load(var_1_10010)
	end
	...
	for iter_69_0, iter_69_1 in var_1_10010(var_69_1) do
		...
		local var_69_8 = iter_69_1.rtWalkQuad

		Vector3 = var_1_10017

		var_1_10015(var_69_8, var_1_10017.one)
		...
		local var_69_9 = var_1_10015.alpha(iter_69_1.rtWalkQuad, 1, arg_69_2[iter_69_0].duration / 2)

		var_1_10015.setDelay(var_69_9, var_69_7)

		var_69_7 = var_69_7 + arg_69_2[iter_69_0].duration / 2
	end

	local var_69_10 = 0
	local var_69_11

	local function var_69_12(arg_71_0, arg_71_1, arg_71_2)
		var_69_10 = var_69_10 + 1

		if var_69_10 <= #var_69_1 then
			local var_71_0 = var_69_1[var_69_10]
			...
			var_4.alpha(var_71_0.rtWalkQuad, 0, arg_69_2[var_69_10].duration)
		end
	...
	local function var_69_14()
		...
		WSMapPath = var_2_10002

		var_72_1(var_72_0, var_2_10002.EventArrivedStep, var_69_12)
		...
		var_72_3(var_72_2, var_2.EventArrived, var_69_14)
	...
	local var_69_15 = arg_69_0.wsMapPath
	local var_69_16 = var_13.AddListener

	WSMapPath = var_1_10015

	var_69_16(var_69_15, var_1_10015.EventArrivedStep, var_69_12)

	local var_69_17 = arg_69_0.wsMapPath
	local var_69_18 = var_13.AddListener

	WSMapPath = var_15

	var_69_18(var_69_17, var_15.EventArrived, var_69_14)

	local var_69_19 = arg_69_0.wsMapPath

	var_13.UpdateObject(var_69_19, arg_69_1)

	local var_69_20 = arg_69_0.wsMapPath
	local var_69_21 = var_13.UpdateAction

	if arg_69_5 then
		WorldConst = var_69_22

		local var_69_22

		if not var_69_22.ActionDrag then
			WorldConst = var_69_22
			var_69_22 = var_69_22.ActionMove
		end

		var_69_21(var_69_20, var_69_22)

		local var_69_23 = arg_69_0.wsMapPath

		var_13.UpdateDirType(var_69_23, arg_69_4)

		local var_69_24 = arg_69_0.wsMapPath

		var_13.StartMove(var_69_24, arg_69_3, arg_69_2, arg_69_5 and 100 or 0)
...
function var_0_1.FlushFleets(arg_74_0)
	...
	var_74_0.each(arg_74_0.wsMapFleets, function(arg_75_0)
...
function var_0_1.FlushFleetRetreatBtn(arg_76_0)
	...
	var_76_0.each(arg_76_0.wsMapFleets, function(arg_77_0)
		...
		var_77_2(arg_77_0.rtRetreat, var_77_3)
		...
		if var_77_3 then
			...
			Vector3 = var_77_5
			var_77_4.localPosition = var_77_6 + var_77_5(89, 0, 0)
...
function var_0_1.FlushEnemyFightingMark(arg_78_0)
	...
	var_1_10001.each(arg_78_0.wsMapAttachments, function(arg_79_0)
		...
		if var_2_10002.IsEnemyType(var_79_0.type) then
			...
			var_79_2(var_79_1, var_4.ExistFleet(var_79_3, var_79_0.row, var_79_0.column))
		end
	...
	var_1.each(arg_80_0.wsMapFleets, function(arg_82_0)
		...
		for iter_82_0 = var_82_0, var_2_10002.DirLeft do
			...
			if var_6.GetCell(var_82_1, arg_82_0.fleet.row + var_2_10005.row, arg_82_0.fleet.column + var_2_10005.column) then
				...
				local var_82_2 = var_82_1.DirUp

				WorldConst = var_8

				for iter_82_1 = var_82_2, var_8.DirLeft do
					bit = var_2_10011
					var_2_10011 = var_2_10011.band

					local var_82_3 = var_6.dir

					bit = var_2_10013

					if var_2_10011(var_82_3, var_2_10013.lshift(1, iter_82_1)) > 0 then
						WSMapTransport = var_2_10011
						var_2_10011 = var_2_10011.GetName(var_6.row, var_6.column, iter_82_1)

						local var_82_5

						if not arg_80_0.wsMapTransports[var_2_10011] then
							local var_82_4 = arg_80_0

							var_82_5 = var_2_10013.NewTransport(var_82_4, var_6.row, var_6.column, iter_82_1)
							var_2_10013 = arg_80_0.wsMapTransports
							var_2_10013[var_2_10011] = var_82_5
							setActive = var_2_10013

							var_2_10013(var_82_5.rtClick, false)
						end

						_ = var_2_10013
						var_2_10013 = var_2_10013.any(arg_80_0.wsMapFleets, function(arg_83_0)
							return arg_83_0.fleet.row == var_0.row and arg_83_0.fleet.column == var_0.column
						end)

						var_82_5:UpdateAlpha(var_2_10013 and 1 or 0)

						setActive = var_14

						var_14(var_82_5.rtForbid, arg_80_0.map.config.is_transfer == 0)
					end
				end
			end
		end
...
function var_0_1.FlushFleetVisibility(arg_84_0)
	...
	var_1_10001.each(arg_84_0.wsMapFleets, function(arg_85_0)
		...
		var_85_4(var_5.FindCarryItems(var_85_5, var_85_0), function(arg_86_0)
...
function var_0_1.FlushMovingAttachmentOrder(arg_90_0, arg_90_1, arg_90_2)
	...
	local var_90_1 = arg_90_1.transform
	local var_90_2

	if var_90_0:GetInFOV() then
		var_90_2 = not var_90_0:InFog()
	end

	var_5(var_90_1, var_90_2)

	local var_90_3 = arg_90_1
	local var_90_4 = arg_90_1.SetModelOrder
	local var_90_5 = arg_90_1.attachment

	var_90_4(var_90_3, var_7.GetModelOrder(var_90_5), arg_90_2.row)
...
function var_0_1.FlushTransportVisibleByState(arg_93_0)
	...
	for iter_93_0, iter_93_1 in var_93_0(arg_93_0.wsMapTransports) do
		_ = var_1_10007
	...
	var_3.each(var_93_1, function(arg_95_0)
		...
		for iter_95_0 = var_95_0, var_2_10002.DirLeft do
			...
			if var_2_10005(var_95_1, var_2_10007.lshift(1, iter_95_0)) > 0 then
				...
				if not arg_93_0.wsMapTransports[var_2_10005] then
					...
					var_95_3 = var_2_10007.NewTransport(var_95_2, arg_95_0.row, arg_95_0.column, iter_95_0)
					var_2_10007 = arg_93_0.wsMapTransports
					var_2_10007[var_2_10005] = var_95_3
				end

				setActive = var_2_10007

				local var_95_4 = var_95_3.rtForbid
				local var_95_5 = arg_93_0.transportDisplay

				WorldConst = var_2_10010

				var_2_10007(var_95_4, var_95_5 == var_2_10010.TransportDisplayGuideForbid)

				setActive = var_2_10007

				local var_95_6 = var_95_3.rtDanger
				local var_95_7 = arg_93_0.transportDisplay

				WorldConst = var_2_10010

				var_2_10007(var_95_6, var_95_7 == var_2_10010.TransportDisplayGuideDanger)
...
function var_0_1.DisplayTargetArrow(arg_97_0, arg_97_1, arg_97_2)
	...
	local var_97_1 = arg_97_0.rtTargetArrow

	var_4.SetParent(var_97_1, var_97_0.transform, false)

	local var_97_2 = arg_97_0.rtTargetArrow

	Vector2 = var_97_1
	var_97_2.anchoredPosition = var_97_1.zero

	local var_97_3 = arg_97_0.rtTargetArrow

	Vector3 = var_5
	var_97_3.localEulerAngles = var_5(-arg_97_0.map.theme.angle, 0, 0)

	local var_97_4 = arg_97_0.rtTargetArrow
	local var_97_5 = var_4.GetComponent

	typeof = var_6
	Canvas = var_7

	local var_97_6 = var_97_5(var_97_4, var_6(var_7))

	WorldConst = var_97_4

	local var_97_7 = var_97_4.LOFleet

	defaultValue = var_6
	var_97_6.sortingOrder = var_97_7 + var_6(arg_97_1, 0) * 10
	setActive = var_97_6

	var_97_6(arg_97_0.rtTargetArrow, true)
