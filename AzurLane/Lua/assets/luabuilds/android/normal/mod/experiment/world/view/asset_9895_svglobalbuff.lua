...
function var_0_1.Setup(arg_8_0, arg_8_1, arg_8_2)
	...
	var_1_10003(arg_8_0.rtPanel, function(arg_9_0)
		...
		var_2_10001(var_9_0, var_9_1 == var_2_10004(arg_8_1.id))
	...
	var_4(var_5.Find(var_8_1, "name"), var_3.config.name)

	setText = var_4

	local var_8_2 = arg_8_0.rtInfo

	var_4(var_5.Find(var_8_2, "value_before"), var_3:GetFloor())
	...
	var_4(var_5.Find(var_8_3, "value"), var_3:GetFloor())
