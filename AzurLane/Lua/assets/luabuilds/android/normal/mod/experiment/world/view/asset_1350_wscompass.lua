...
function var_0_1.Update(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_3 = var_1_10006(var_3_1 - 1, var_3_2 - 1)
...
function var_0_1.UpdateByViewer(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_3 = var_1_10007(var_4_1 - 1, var_4_2 - 1)
...
function var_0_1.AddCellListener(arg_9_0, arg_9_1)
	...
	var_9_1(var_9_0, var_1_10004.EventAddAttachment, arg_9_0.onAdd)
	...
	var_9_3(var_9_2, var_4.EventRemoveAttachment, arg_9_0.onRemove)
	...
	var_9_3.each(arg_9_1.attachments, function(arg_10_0)
		...
		var_10_1(var_10_0, var_2_10003.EventUpdateLurk, arg_9_0.onUpdateAttachment)
		...
		var_10_3(var_10_2, var_3.EventUpdateData, arg_9_0.onUpdateAttachment)
		...
		var_10_5(var_10_4, var_3.EventUpdateFlag, arg_9_0.onUpdateAttachment)
...
function var_0_1.RemoveCellsListener(arg_11_0)
	...
	var_11_0(var_11_1, function(arg_12_0)
		...
		var_12_1(var_12_0, var_2_10003.EventAddAttachment, arg_11_0.onAdd)
		...
		var_12_3(var_12_2, var_3.EventRemoveAttachment, arg_11_0.onRemove)
		...
		var_12_3.each(arg_12_0.attachments, function(arg_13_0)
			...
			WorldMapAttachment = var_3_10003

			var_13_1(var_13_0, var_3_10003.EventUpdateLurk, arg_11_0.onUpdateAttachment)
			...
			var_13_3(var_13_2, var_3.EventUpdateData, arg_11_0.onUpdateAttachment)
			...
			var_13_5(var_13_4, var_3.EventUpdateFlag, arg_11_0.onUpdateAttachment)
...
function var_0_1.OnAdd(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	...
	var_14_1(var_14_0, var_1_10006.EventUpdateLurk, arg_14_0.onUpdateAttachment)
	...
	var_14_3(var_14_2, var_6.EventUpdateData, arg_14_0.onUpdateAttachment)
	...
	var_14_5(var_14_4, var_6.EventUpdateFlag, arg_14_0.onUpdateAttachment)
	arg_14_0:ClearMarks()
...
function var_0_1.OnRemove(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	var_15_1(var_15_0, var_1_10006.EventUpdateLurk, arg_15_0.onUpdateAttachment)
	...
	var_15_3(var_15_2, var_6.EventUpdateData, arg_15_0.onUpdateAttachment)
	...
	var_15_5(var_15_4, var_6.EventUpdateFlag, arg_15_0.onUpdateAttachment)
	arg_15_0:ClearMarks()
...
function var_0_1.CalcTaskMarkPos(arg_22_0, arg_22_1)
	...
	local var_22_3 = var_22_2(var_1_10005.rad(var_22_0)) * var_22_1
	...
	local var_22_5 = var_22_4(var_6.rad(var_22_0)) * var_22_1
...
function var_0_1.UpdateInnerMark(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	if arg_23_1:GetCompassAttachment() then
		local var_23_1 = var_5

		if var_5.GetCompassType(var_23_1) then
	...
	elseif #var_23_0.ports > 0 then
		...
		if var_23_3 == arg_23_1.row and var_23_4 == arg_23_1.column then
			...
			var_23_7(var_23_6, var_11.CompassTypePort, var_23_5)
		end
	end
...
function var_0_1.CalcInnerPos(arg_24_0, arg_24_1, arg_24_2, arg_24_3, arg_24_4)
	...
	return var_6(arg_24_0.normal * var_24_0.x, arg_24_0.normal * var_24_0.y, 0)
end

function var_0_1.UpdateOutsideMark(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	local var_25_0 = arg_25_0.map

	if arg_25_1:GetCompassAttachment() then
		local var_25_1 = var_5
		local var_25_2 = var_5.GetCompassType(var_25_1)
				...
				if var_25_2 == var_7.CompassTypePort then
					...
					if #var_25_0.ports > 0 then
						...
						if var_25_4 == arg_25_1.row and var_25_5 == arg_25_1.column then
							...
							var_25_8(var_25_7, var_11.CompassTypePort, var_25_6)
						end
					end
				end
...
function var_0_1.CalcOutsidePos(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	local var_26_1 = var_1_10006(arg_26_1 - arg_26_3, arg_26_2 - arg_26_4)

	Vector2 = var_7

	local var_26_2 = var_26_0(var_26_1, var_7.up)

	math = var_26_1

	local var_26_3 = var_26_1.abs(var_26_2 - 90)
	...
	local var_26_7 = var_26_6(var_1_10009.rad(var_26_3)) * var_26_5
	...
	local var_26_10 = var_26_9(var_10.rad(var_26_3)) * var_26_5
...
function var_0_1.NewTransportMark(arg_28_0, arg_28_1, arg_28_2)
	...
	var_28_0(var_28_1, arg_28_0.border)
...
function var_0_1.GetMarkPosition(arg_31_0, arg_31_1, arg_31_2)
	...
	if var_1_10006.InFOVRange(var_31_1.row, var_31_1.column, arg_31_1, arg_31_2, arg_31_0.fov) then
