...
function var_0_1.Dispose(arg_2_0)
	...
	var_1(var_2.Find(var_2_0, "lock_layer"), function(arg_3_0)
...
function var_0_1.UpdateAtlas(arg_5_0, arg_5_1)
	if arg_5_0.atlas ~= arg_5_1 then
		...
		var_5_1(var_5_0, var_5_2, var_5_3, var_6.GetActiveEntrance(var_5_4))
...
function var_0_1.AddAtlasListener(arg_6_0)
	if arg_6_0.atlas then
		...
		var_6_1(var_6_0, var_1_10003.EventUpdateProgress, arg_6_0.onUpdateProgress)
		...
		var_6_3(var_6_2, var_3.EventUpdateActiveEntrance, arg_6_0.onUpdateActiveEntrance)
		...
		var_6_5(var_6_4, var_3.EventAddPressingEntrance, arg_6_0.onUpdatePressingAward)
	end
...
function var_0_1.RemoveAtlasListener(arg_7_0)
	if arg_7_0.atlas then
		...
		var_7_1(var_7_0, var_1_10003.EventUpdateProgress, arg_7_0.onUpdateProgress)
		...
		var_7_3(var_7_2, var_3.EventUpdateActiveEntrance, arg_7_0.onUpdateActiveEntrance)
		...
		var_7_5(var_7_4, var_3.EventAddPressingEntrance, arg_7_0.onUpdatePressingAward)
	end
...
function var_0_1.ActiveSelect(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_1:HasPort() then
		...
		var_3(var_4.Find(var_13_0, "A" .. arg_13_1:GetColormaskUniqueID() .. "_2"), arg_13_2)
	end
...
function var_0_1.ActiveStatic(arg_14_0, arg_14_1, arg_14_2)
	...
	if arg_14_1:HasPort() then
		...
		local var_14_2 = var_14_0.cancel

		go = var_5

		var_14_2(var_5(var_14_1))
		...
		if arg_14_2 then
			...
			local var_14_5 = var_14_4(var_6(var_14_1), 0.75, 1)
...
function var_0_1.BuildActiveMark(arg_20_0)
	...
	arg_20_0.tfActiveMark = var_1_10001(var_1_10002.New())

	local var_20_0 = arg_20_0.tfActiveMark.gameObject

	Layer = var_2
	var_20_0.layer = var_2.UI
...
function var_0_1.RemoveExtraMarkPrefab(arg_24_0, arg_24_1)
	...
	var_1_10003(arg_24_1, function(arg_25_0)
		...
		var_25_1(var_25_0, var_25_2, var_25_3, var_2_10005(arg_25_0), true)
...
function var_0_1.DoUpdatExtraMark(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
	...
	if arg_26_1.Find(var_26_0, arg_26_2) then
		setActive = var_26_0

		var_26_0(var_5, arg_26_3)

		existCall = var_26_0

		var_26_0(arg_26_4, var_5)
...
function var_0_1.UpdateStaticMark(arg_28_0, arg_28_1)
	...
	for iter_28_0, iter_28_1 in var_1_10002(arg_28_0.staticEntranceDic) do
		...
		var_28_1(var_28_0, var_9.GetEntrance(var_28_2, iter_28_0), false)
	end
	...
	for iter_28_2, iter_28_3 in var_2(arg_28_1 or {}) do
		if iter_28_3 then
			...
			var_28_4(var_28_3, var_9.GetEntrance(var_28_5, iter_28_2), true)
		end
	end
...
function var_0_1.OnUpdatePressingAward(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	for iter_29_0, iter_29_1 in var_1_10004(arg_29_3) do
		if iter_29_1 then
			...
			var_29_1(var_29_0, var_11.GetEntrance(var_29_2, iter_29_0))
		end
	end
...
function var_0_1.UpdateCenterEffectDisplay(arg_30_0)
	...
	var_30_0(var_3.Find(var_30_2, "decolation_layer/DSJ_xuanwo"), not var_30_1)

	setActive = var_30_0

	local var_30_3 = arg_30_0.tfEntity

	var_30_0(var_3.Find(var_30_3, "decolation_layer/DSJ_xuanwo_jianhua"), var_30_1)
