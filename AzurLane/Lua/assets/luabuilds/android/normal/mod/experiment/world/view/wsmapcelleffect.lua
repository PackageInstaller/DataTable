...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".WSMapEffect"))
...
function var_0_1.Setup(arg_2_0, arg_2_1, arg_2_2)
	...
	var_2_1(var_2_0, var_1_10005.EventUpdateInFov, arg_2_0.onUpdate)
	...
	var_2_3(var_2_2, var_5.EventUpdateDiscovered, arg_2_0.onUpdate)
	...
	var_2_5(var_2_4, var_5.EventUpdateFog, arg_2_0.onUpdate)
	...
	local var_2_8 = var_5.GetTerrainEffectRes
	local var_2_9 = arg_2_0.cell

	var_2_6(var_2_7, var_2_8(var_6.GetTerrain(var_2_9), arg_2_0.cell.terrainDir, arg_2_0.cell.terrainStrong))
	arg_2_0:Load(function()
		local var_3_0 = arg_2_0.cell
		local var_3_1 = var_0.GetTerrain(var_3_0)

		WorldMapCell = var_3_0

		local var_3_3

		if var_3_1 == var_3_0.TerrainStream then
			local var_3_2 = arg_2_0

			var_3_3 = var_3_3.SetModelOrder
			WorldConst = var_2_10004

			var_3_3(var_3_2, var_2_10004.LOEffectB, var_0.row)
		else
			...
			if var_3_1 == var_3_3.TerrainWind then
				...
				var_3_5(var_3_4, var_2_10004.LOEffectC, var_0.row)

				setActive = var_3_5
				var_2_10004 = arg_2_0.model
				var_2_10004 = var_3.GetChild(var_2_10004, 0)

				local var_3_6 = var_3.Find(var_2_10004, "Xyz/Arrow")

				var_2_10004 = var_0.terrainStrong > 0

				var_3_5(var_3_6, var_2_10004)
				...
				var_3_5(var_3_7, var_2_10004.GetWindScale(var_0.terrainStrong))
			else
				...
				if var_3_1 == var_3_5.TerrainIce then
					...
					var_3_9 = var_3_9.SetModelOrder
					WorldConst = var_2_10004

					var_3_9(var_3_8, var_2_10004.LOEffectA, var_0.row)
				else
					WorldMapCell = var_3_9

					if var_3_1 == var_3_9.TerrainPoison then
						local var_3_10 = arg_2_0
						local var_3_11 = var_2.SetModelOrder

						WorldConst = var_2_10004

						var_3_11(var_3_10, var_2_10004.LOEffectA, var_0.row)
					end
				end
			end
		end
...
function var_0_1.Dispose(arg_4_0)
	...
	var_4_1(var_4_0, var_1_10003.EventUpdateInFov, arg_4_0.onUpdate)
	...
	var_4_3(var_4_2, var_3.EventUpdateDiscovered, arg_4_0.onUpdate)
	...
	var_4_5(var_4_4, var_3.EventUpdateFog, arg_4_0.onUpdate)
