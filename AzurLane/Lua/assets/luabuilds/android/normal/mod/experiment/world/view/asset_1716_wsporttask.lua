...
function var_0_1.OnTaskUpdate(arg_5_0)
	...
	if arg_5_0.task.config.type == 5 then
		...
		var_1_10001(var_2.Find(var_5_2, "Text"), arg_5_0.task.config.name)
		...
		var_1_10001(var_5_3, var_3.WorldToastMgr.Type2PictrueName[arg_5_0.task.config.type], arg_5_0.rtType, true)
		...
		var_2(arg_5_0.rfAwardPanle)

		ipairs = var_2

		for iter_5_0, iter_5_1 in var_2(var_5_4) do
			...
			var_9(var_5_6, var_5_7, var_5_8, var_1_10013)
		...
		var_5_9(var_5_11, var_5_10 == iter_5_0.STATE_INACTIVE)
		...
		var_5_9(var_5_12, var_5_10 == var_5.STATE_ONGOING)
		...
		var_5_9(var_5_13, var_5_10 == var_5.STATE_FINISHED)

		setActive = var_5_9

		var_5_9(arg_5_0.txProgress, false)

		setActive = var_5_9

		var_5_9(arg_5_0.progress, false)
