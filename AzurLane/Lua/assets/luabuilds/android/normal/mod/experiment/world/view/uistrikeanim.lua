...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".UIAnim"))
...
function var_0_1.ReloadShip(arg_5_0, arg_5_1)
	...
	var_3.GetPainting(var_5_0, arg_5_1:getPainting(), true, function(arg_6_0)
		...
		var_6_1(var_6_2, var_3.getPainting(var_6_3))
	...
	var_3.Load(var_5_2, true, function(arg_7_0)
		...
		var_7_1(var_7_0, var_2_10003.one)
...
function var_0_1.UnloadShipVO(arg_8_0)
	...
	var_1_10002(var_3.Find(var_8_1, "mask/painting"), var_8_0:getPainting())
...
function var_0_1.Init(arg_14_0)
	...
	var_14_4(arg_14_0.painting, var_14_3:Find("fitter"), false)
