...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".WorldBaseFleet"))
...
function var_0_1.DebugPrint(arg_2_0)
	...
	local var_2_1 = var_2.map(arg_2_0.carries, function(arg_4_0)
		return "carries"
	end)
	...
	local var_2_4 = var_1_10005.format
	local var_2_5 = "[第%s舰队] [id: %s] [位置: %s, %s] [弹药: %s/%s] [携带物: %s] [战损: %s] [buff: %s]"
	local var_2_6 = arg_2_0.index
	local var_2_7 = arg_2_0.id
	local var_2_8 = arg_2_0.row
	local var_2_9 = arg_2_0.column
	local var_2_10 = var_2_2
	local var_2_11 = var_2_3

	table = var_1_10013

	local var_2_12 = var_1_10013.concat(var_2_1, ", ")
	local var_2_13 = arg_2_0.damageLevel

	table = var_15

	local var_2_14 = var_2_4(var_2_5, var_2_6, var_2_7, var_2_8, var_2_9, var_2_10, var_2_11, var_2_12, var_2_13, var_15.concat(var_2_0, ", "))
	local var_2_15 = {}

	TeamType = var_2_6
	var_2_15[var_2_6.Main] = "主力"
	TeamType = var_7
	var_2_15[var_7.Vanguard] = "先锋"
	TeamType = var_7
	var_2_15[var_7.Submarine] = "潜艇"
	...
	for iter_2_0, iter_2_1 in var_8(arg_2_0:GetShips(true)) do
		WorldConst = var_2_12
		var_2_12 = var_2_12.FetchShipVO(iter_2_1.id)
		_ = var_14

		local var_2_17 = var_14.map(iter_2_1:GetBuffList(), function(arg_5_0)
			return arg_5_0.id .. "#" .. arg_5_0:GetFloor()
		end)

		string = var_15

		local var_2_18 = var_15.format
		local var_2_19 = "\t\t[%s] [id: %s] [config_id: %s] [%s] [hp: %s%%] [buff: %s]" .. " <material=underline c=#A9F548 event=ShipProperty args=%s><color=#A9F548>属性</color></material>"
		local var_2_20 = var_2_12:getName()
		local var_2_21 = var_2_12.id
		local var_2_22 = var_2_12.configId
		local var_2_23 = var_2_15[var_2_12:getTeamType()]
		local var_2_24 = iter_2_1.hpRant / 100

		table = var_1_10022

		local var_2_25 = var_2_18(var_2_19, var_2_20, var_2_21, var_2_22, var_2_23, var_2_24, var_1_10022.concat(var_2_17, ", "), var_2_12.id)

		table = var_2_19

		var_2_19.insert(var_2_16, var_2_25)
	end

	local var_2_26 = var_2_14
	local var_2_27 = "\n"

	table = var_10

	return var_2_26 .. var_2_27 .. var_10.concat(var_2_16, "\n")
end
...
function var_0_1.Setup(arg_7_0, arg_7_1)
	...
	WorldConst = iter_7_0
	arg_7_0.damageLevel = var_7_2(var_7_3, var_7_4, #iter_7_0.DamageBuffList)
	_ = var_3
	...
	local var_7_6 = arg_7_0.GetFleetType(var_7_5)

	FleetType = var_7_5

	if var_7_6 == var_7_5.Submarine then
		arg_7_0.row = -1
		arg_7_0.column = -1
	end
...
function var_0_1.FormationEqual(arg_13_0, arg_13_1)
	...
	local var_13_1 = var_3.map(arg_13_1:GetShips(true), function(arg_15_0)
		return arg_15_0.id
	end)
	local var_13_2 = 1
...
function var_0_1.GetPropertiesSum(arg_16_0)
	...
	local var_16_2 = arg_16_0.GetShipVOs(var_16_1, true)

	ipairs = var_16_1

	for iter_16_0, iter_16_1 in var_16_1(var_16_2) do
		local var_16_3 = iter_16_1:getProperties()
		local var_16_4 = var_16_0.cannon

		math = var_1_10010
		var_16_0.cannon = var_16_4 + var_1_10010.floor(var_16_3.cannon)

		local var_16_5 = var_16_0.torpedo

		math = var_1_10010
		var_16_0.torpedo = var_16_5 + var_1_10010.floor(var_16_3.torpedo)

		local var_16_6 = var_16_0.antiAir

		math = var_1_10010
		var_16_0.antiAir = var_16_6 + var_1_10010.floor(var_16_3.antiaircraft)

		local var_16_7 = var_16_0.air

		math = var_1_10010
		var_16_0.air = var_16_7 + var_1_10010.floor(var_16_3.air)
	end
...
function var_0_1.GetGearScoreSum(arg_17_0, arg_17_1)
	...
	if arg_17_1 then
		...
		if not arg_17_0.GetTeamShipVOs(var_1_10004, arg_17_1) then
			var_1_10004 = arg_17_0
			var_17_1 = arg_17_0.GetShipVOs(var_1_10004)
		end
...
function var_0_1.GetLevelCount(arg_18_0)
	...
	var_1_10003.each(var_18_0, function(arg_19_0)
...
function var_0_1.AddShip(arg_20_0, arg_20_1, arg_20_2)
	...
	WorldMapShip = var_1_10005

	var_1_10003(var_20_0 == var_1_10005)

	assert = var_1_10003
	_ = var_4

	var_1_10003(not var_4.any(arg_20_0:GetShips(true), function(arg_21_0)
	...
	var_4(var_20_1, "ship not exist: " .. arg_20_1.id)
...
function var_0_1.RemoveShip(arg_22_0, arg_22_1)
	...
	var_3(var_22_0, "ship not exist: " .. arg_22_1)
...
function var_0_1.SwitchShip(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_1 = var_4.FetchRawShipVO(arg_24_2)
	...
	local var_24_4 = var_24_1.getTeamType(var_24_3)
	...
	for iter_24_0, iter_24_1 in var_1_10009(arg_24_0[var_24_2]) do
	...
	if var_24_5 ~= var_24_6 then
		arg_24_0[var_24_2][var_24_5], arg_24_0[var_24_4][var_24_6] = arg_24_0[var_24_4][var_24_6], arg_24_0[var_24_2][var_24_5]
...
function var_0_1.CheckRemoveShip(arg_25_0, arg_25_1)
	...
	if #arg_25_0.GetTeamShips(var_25_1, var_25_0, true) == 1 then
		local var_25_2 = false

		i18n = var_25_1

		local var_25_3 = "ship_formationUI_removeError_onlyShip"
		local var_25_4 = arg_25_1:getConfig("name")
		local var_25_5 = ""

		Fleet = var_8

		local var_25_6 = var_25_1(var_25_3, var_25_4, var_25_5, var_8.C_TEAM_NAME[var_25_0])
...
function var_0_1.CheckChangeShip(arg_26_0, arg_26_1, arg_26_2)
	...
	if not var_26_0 and (not arg_26_1 or not arg_26_1:isSameKind(arg_26_2)) then
		...
		if var_1_10004.any(arg_26_0:GetShips(true), function(arg_27_0)
			...
			local var_26_2 = var_5("ship_formationMediator_changeNameError_sameShip")
...
function var_0_1.RepairSubmarine(arg_32_0)
	...
	var_32_0(var_32_2(var_32_1, var_1_10004.Submarine, true), function(arg_33_0)
		arg_33_0:Repair()
...
function var_0_1.GetSpeed(arg_34_0)
	...
	if #var_34_2(var_34_1, var_1_10004.TrapVortex) > 0 then
		math = var_2
	...
	for iter_34_0, iter_34_1 in var_2(var_34_4(var_34_3, var_1_10005.TrapCripple)) do
		math = var_1_10007
		var_34_0 = var_1_10007.min(var_34_0, iter_34_1:GetTrapParams()[2])
	end
...
function var_0_1.GetStepDurationRate(arg_35_0)
	...
	for iter_35_0, iter_35_1 in var_1_10002(var_35_2(var_35_1, var_1_10005.TrapCripple)) do
		math = var_1_10007
		var_35_0 = var_1_10007.min(var_35_0, iter_35_1:GetTrapParams()[3] / 100)
	end
...
function var_0_1.GetFOVRange(arg_36_0)
	...
	for iter_36_0, iter_36_1 in var_1_10002(var_36_2(var_36_1, var_1_10005.TrapCripple)) do
		math = var_1_10007
		var_36_0 = var_1_10007.min(var_36_0, iter_36_1:GetTrapParams()[1] / 100)
	end
	...
	return var_36_3(var_3.GetFOVRadius() * var_36_0)
end
...
function var_0_1.AddCarry(arg_40_0, arg_40_1)
	...
	var_40_1(var_40_0, var_4.EventAddCarry, arg_40_1)
...
function var_0_1.RemoveCarry(arg_41_0, arg_41_1)
	...
	for iter_41_0, iter_41_1 in var_1_10002(arg_41_0.carries) do
		if iter_41_1.id == arg_41_1 then
			...
			var_41_2(var_41_1, var_9.EventRemoveCarry, iter_41_1)
...
function var_0_1.RemoveAllCarries(arg_42_0)
	...
	for iter_42_0 = #arg_42_0.carries, 1, -1 do
		...
		WorldMapFleet = var_1_10008

		var_1_10006(var_42_2, var_1_10008.EventRemoveCarry, var_42_1)
	end
...
function var_0_1.BuildCarryPath(arg_43_0, arg_43_1, arg_43_2, arg_43_3)
	...
	local var_43_2 = var_43_0.indexof(var_43_1, arg_43_1)

	assert = var_6

	var_6(var_43_2, "can not find carry item: " .. arg_43_1.id)

	_ = var_6

	local var_43_3 = var_6.map(arg_43_3, function(arg_44_0)
		return {
			row = arg_44_0.row,
...
function var_0_1.GetDamageBuff(arg_48_0)
	if arg_48_0.damageLevel > 0 then
		...
		var_48_2.id = var_1_10005.DamageBuffList[arg_48_0.damageLevel]
...
function var_0_1.GetBuffList(arg_49_0)
	...
	local var_49_1 = var_49_0(var_1_10002.values(arg_49_0.buffs), function(arg_50_0)
		return arg_50_0:GetFloor() > 0
	end)

	nowWorld = var_2

	local var_49_2 = var_2()
	local var_49_3 = var_2.GetActiveMap(var_49_2)

	table = var_49_2

	local var_49_4 = var_49_2.mergeArray
	local var_49_5 = var_49_1
	local var_49_6 = var_49_3
	local var_49_7 = var_49_3.GetBuffList

	WorldMap = var_1_10007

	return var_49_4(var_49_5, var_49_7(var_49_6, var_1_10007.FactionSelf))
end
...
function var_0_1.UpdateBuffs(arg_51_0, arg_51_1)
	if arg_51_0.buffs ~= arg_51_1 then
		...
		for iter_51_0, iter_51_1 in var_51_0(var_1_10005.CompareBuffs(arg_51_0.buffs, arg_51_1).add) do
			noEmptyStr = var_1_10009

			if var_1_10009(iter_51_1.config.trap_lua) then
...
function var_0_1.GetWatchingBuff(arg_58_0)
	...
	for iter_58_0, iter_58_1 in var_1_10002(var_1_10003.gameset.world_sairenbuff_fleeticon.description) do
...
function var_0_1.getMapAura(arg_62_0)
	...
	for iter_62_0, iter_62_1 in var_1_10002(arg_62_0:GetShips(true)) do
		...
		local var_62_2 = iter_62_1:GetImportWorldShipVO()

		var_62_0 = var_1_10007(var_62_1, var_9.getMapAuras(var_62_2))
	end
...
function var_0_1.getMapAid(arg_63_0)
	...
	for iter_63_0, iter_63_1 in var_1_10002(arg_63_0:GetShips(true)) do
		...
		for iter_63_2, iter_63_3 in var_63_1(var_63_2) do
			local var_63_3
...
function var_0_1.getCommanders(arg_65_0, arg_65_1)
	...
	if arg_65_1 and arg_65_0:IsCatSalvage() then
		...
		for iter_65_0, iter_65_1 in var_1_10003(arg_65_0.commanderIds) do
			...
			var_65_0[iter_65_0] = var_1_10008.getCommanderById(var_1_10009, iter_65_1)
		end
	end
...
function var_0_1.getCommandersAddition(arg_68_0)
	...
	for iter_68_0, iter_68_1 in var_1_10002(var_1_10003.PROPERTIES) do
		local var_68_1 = 0
...
function var_0_1.getCommandersTalentDesc(arg_69_0)
	...
	for iter_69_0, iter_69_1 in var_1_10002(arg_69_0:getCommanders()) do
		local var_69_1 = iter_69_1
		local var_69_2 = iter_69_1.getTalentsDesc(var_69_1)

		pairs = var_69_1

		for iter_69_2, iter_69_3 in var_69_1(var_69_2) do
...
function var_0_1.findCommanderBySkillId(arg_70_0, arg_70_1)
	...
	local var_70_1 = arg_70_0.getCommanders(var_70_0)
...
function var_0_1.updateCommanderSkills(arg_73_0)
	...
	while var_73_0 > 0 do
		...
		if not arg_73_0:findCommanderBySkillId(var_73_1.id) then
			local var_73_2 = var_73_1
			local var_73_3 = var_73_1.GetSystem(var_73_2)
	...
	local var_73_5 = arg_73_0.getCommanders(var_73_4)

	pairs = var_73_4

	for iter_73_0, iter_73_1 in var_73_4(var_73_5) do
		ipairs = var_1_10008
		...
		for iter_73_2, iter_73_3 in var_1_10008(iter_73_1:getSkills()) do
			...
			for iter_73_4, iter_73_5 in var_1_10013(iter_73_3:GetTacticSkillForWorld()) do
				...
				local var_73_6 = arg_73_0.skills

				FleetSkill = var_1_10020
				var_1_10020 = var_1_10020.New
				FleetSkill = var_1_10021

				var_1_10018(var_73_6, var_1_10020(var_1_10021.SystemCommanderNeko, iter_73_5))
			end
		end
	end
...
function var_0_1.UpdateCatSalvage(arg_80_0, arg_80_1, arg_80_2, arg_80_3)
	...
	if arg_80_0:GetRarityState() == 2 and not var_80_0.isAutoFight then
		...
		pg = var_1_10009
		var_80_3.story = var_1_10009.gameset.world_catsearch_raritytip.description[1]
...
function var_0_1.GetSalvageScoreRarity(arg_84_0)
	...
	for iter_84_2, iter_84_3 in var_3(var_4.gameset.world_catsearch_score.description) do
...
function var_0_1.GetDisplayCommander(arg_85_0)
	...
	for iter_85_0 = 1, 2 do
		if arg_85_0.commanderIds[iter_85_0] then
			...
			return var_6.getCommanderById(var_1_10007, arg_85_0.commanderIds[iter_85_0])
		end
	end
