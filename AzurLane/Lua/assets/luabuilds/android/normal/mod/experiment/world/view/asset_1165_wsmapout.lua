...
function var_0_1.Dispose(arg_3_0)
	...
	arg_3_0.RemoveMapListener(var_3_0)
	...
	for iter_3_0, iter_3_1 in var_3_0(arg_3_0.emotionTFs) do
		local var_3_2 = var_3_1
		local var_3_3 = var_3_1.ReturnUI
		local var_3_4 = iter_3_0

		go = var_1_10010

		var_3_3(var_3_2, var_3_4, var_1_10010(iter_3_1))
	end
...
function var_0_1.AddFleetListener(arg_7_0, arg_7_1)
	if arg_7_1 then
		...
		var_7_1(var_7_0, var_1_10004.EventUpdateLocation, arg_7_0.onUpdateFleetEmotion)
	end
...
function var_0_1.RemoveFleetListener(arg_8_0, arg_8_1)
	if arg_8_1 then
		...
		var_8_1(var_8_0, var_1_10004.EventUpdateLocation, arg_8_0.onUpdateFleetEmotion)
	end
