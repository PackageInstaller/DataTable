...
function var_0_1.AddMapListener(arg_5_0)
	if arg_5_0.map then
		...
		var_5_1(var_5_0, var_1_10003.EventUpdateFIndex, arg_5_0.onUpdateSelectedFleet)
	end
...
function var_0_1.AddFleetListener(arg_7_0, arg_7_1)
	if arg_7_1 then
		...
		var_1_10002.each(arg_7_1:GetShips(true), function(arg_8_0)
			...
			var_8_1(var_8_0, var_2_10003.EventHpRantChange, arg_7_0.onUpdateShip)
...
function var_0_1.RemoveFleetListener(arg_9_0, arg_9_1)
	if arg_9_1 then
		...
		var_1_10002.each(arg_9_1:GetShips(true), function(arg_10_0)
			...
			var_10_1(var_10_0, var_2_10003.EventHpRantChange, arg_9_0.onUpdateShip)
...
function var_0_1.OnUpdateSelectedFleet(arg_11_0)
	...
	if arg_11_0.fleet ~= var_11_1 then
		...
		local var_11_6 = var_5.GetTeamShipVOs

		TeamType = var_1_10007

		var_11_3(var_11_2, var_11_4, var_11_6(var_11_5, var_1_10007.Main, true))
		...
		local var_11_11 = var_5.GetTeamShipVOs

		TeamType = var_7

		var_11_8(var_11_7, var_11_9, var_11_11(var_11_10, var_7.Vanguard, true))
	end
...
function var_0_1.OnUpdateShip(arg_12_0, arg_12_1, arg_12_2)
	...
	var_12_0(var_12_1, "can not find fleet: " .. arg_12_2.fleetId)

	local var_12_2 = var_12_1
	local var_12_3 = var_12_1.GetFleetType(var_12_2)

	FleetType = var_12_2

	local var_12_5

	if var_12_3 == var_12_2.Normal then
		local var_12_4 = arg_12_0

		var_12_5 = arg_12_0.UpdateShipList

		local var_12_6 = arg_12_0.rtMain
		local var_12_7 = arg_12_0.fleet
		local var_12_8 = var_8.GetTeamShipVOs

		TeamType = var_1_10010

		var_12_5(var_12_4, var_12_6, var_12_8(var_12_7, var_1_10010.Main, true))

		local var_12_9 = arg_12_0

		var_12_5 = arg_12_0.UpdateShipList

		local var_12_10 = arg_12_0.rtVanguard
		local var_12_11 = arg_12_0.fleet
		local var_12_12 = var_8.GetTeamShipVOs

		TeamType = var_1_10010

		var_12_5(var_12_9, var_12_10, var_12_12(var_12_11, var_1_10010.Vanguard, true))
	else
		FleetType = var_12_5

		if var_12_3 == var_12_5.Submarine then
			local var_12_13 = arg_12_0
			local var_12_14 = arg_12_0.UpdateShipList
			local var_12_15 = arg_12_0.rtSubmarine
			local var_12_16 = arg_12_0.submarineFleet
			local var_12_17 = var_8.GetTeamShipVOs

			TeamType = var_1_10010

			var_12_14(var_12_13, var_12_15, var_12_17(var_12_16, var_1_10010.Submarine, true))
		end
	end
...
function var_0_1.UpdateShipList(arg_13_0, arg_13_1, arg_13_2)
	...
	var_3.make(var_13_0, function(arg_14_0, arg_14_1, arg_14_2)
		...
		if arg_14_0 == var_2_10003.EventUpdate then
			...
			var_5(arg_14_2, var_14_0)

			findTF = var_5

			local var_14_2 = var_5(arg_14_2, "HP_POP")
			...
			var_6(var_7(var_14_2, "heal"), false)

			setActive = var_6
			findTF = var_7

			var_6(var_7(var_14_2, "normal"), false)
			...
			local var_14_7 = not var_14_1.IsHpSafe(var_14_6)

			setActive = var_14_6

			var_14_6(var_14_4, not var_14_7)

			setActive = var_14_6

			var_14_6(var_14_5, var_14_7)

			local var_14_8 = var_14_3
			local var_14_9 = var_14_3.GetComponent

			typeof = var_12
			Slider = var_2_10013

			local var_14_10 = var_14_9(var_14_8, var_12(var_2_10013))

			var_14_10.fillRect = var_14_7 and var_14_5 or var_14_4
			setSlider = var_14_10

			var_14_10(var_14_3, 0, 10000, var_14_1.hpRant)

			local var_14_11 = arg_14_2
			local var_14_12 = arg_14_2.Find(var_14_11, "agony")

			setActive = var_14_11

			var_14_11(var_14_12, var_14_7)

			local var_14_13 = arg_14_2
			local var_14_14 = arg_14_2.Find(var_14_13, "broken")

			setActive = var_14_13

			var_14_13(var_14_14, var_14_1:IsBroken())
		end
