...
function var_0_1.Init(arg_3_0)
	...
	arg_3_0.rtEmptyTpl = var_1.Find(var_3_1, "panel/emptytpl")

	local var_3_2 = {}

	FleetType = var_3_1
	var_3_2[var_3_1.Normal] = {
	...
	local var_3_3 = var_3.Submarine
	local var_3_4 = {}
	local var_3_5 = var_1

	var_3_4[1] = var_1.Find(var_3_5, "panel/bg/content/sub/1")
	var_3_2[var_3_3] = var_3_4
	arg_3_0.rtFleets = var_3_2
	...
	for iter_3_0 = 0, arg_3_0.toggleList.childCount - 1 do
		table = var_3_5
		var_3_5 = var_3_5.insert

		local var_3_6 = arg_3_0.toggles
		local var_3_7 = arg_3_0.toggleList

		var_3_5(var_3_6, var_8.Find(var_3_7, "item" .. iter_3_0 + 1))
	end
...
function var_0_1.UpdateMulti(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_0 = var_1_10004(var_1_10005.values(arg_4_2))
	...
	for iter_4_0, iter_4_1 in var_4_4(arg_4_3 or {}) do
		if arg_4_0:getFleetById(iter_4_1) then
			local var_4_5 = var_9:getFleetType()
	...
	local function var_4_8()
		...
		var_7_0(var_1.getSelectIds(var_7_1))

		return
	end

	SFX_UI_WEIGHANCHOR_GO = iter_4_1

	var_4(var_4_6, var_4_7, var_4_8, iter_4_1)
	...
	var_4(var_4_9, var_4_10, var_4_11, iter_4_1)
	...
	var_4(var_4_12, var_4_13, var_4_14, iter_4_1)
	...
	var_4(var_4_15, var_4_16, var_4_17, iter_4_1)
	arg_4_0:clearFleets()
...
function var_0_1.updateLimit(arg_17_0)
	...
	local var_17_2 = #var_17_0(var_17_1[var_1_10003.Normal], function(arg_18_0)
		return arg_18_0 > 0
	end)

	_ = var_2

	local var_17_3 = var_2.filter
	local var_17_4 = arg_17_0.selectIds

	FleetType = var_1_10004

	local var_17_5 = #var_17_3(var_17_4[var_1_10004.Submarine], function(arg_19_0)
		return arg_19_0 > 0
	end)
	...
	local var_17_8 = var_17_7(var_17_6, var_1_10005.Normal)

	setText = var_17_6

	local var_17_9 = arg_17_0.rtLimit
	local var_17_10 = var_5.Find(var_17_9, "number")

	string = var_17_9

	var_17_6(var_17_10, var_17_9.format("%d/%d", var_17_2, var_17_8))
	...
	local var_17_13 = var_17_12(var_17_11, var_6.Submarine)

	setText = var_17_11

	local var_17_14 = arg_17_0.rtLimit
	local var_17_15 = var_6.Find(var_17_14, "number_sub")

	string = var_17_14

	var_17_11(var_17_15, var_17_14.format("%d/%d", var_17_5, var_17_13))
	...
	if var_1_10004 ~= arg_20_3 then
		...
		if arg_20_1 == var_5.Normal and arg_20_0:getLimitNums(arg_20_1) > 0 and arg_20_3 == 0 then
			...
			if #var_5.filter(var_20_0, function(arg_21_0)
				...
				var_20_2(var_20_1, var_7("level_fleet_lease_one_ship"))
		...
		if arg_20_0:getFleetById(arg_20_3) then
			...
			if var_5:isLegalToFight() ~= true then
				...
				var_20_4(var_20_3, var_1_10008("level_fleet_not_enough"))
...
function var_0_1.updateFleet(arg_22_0, arg_22_1, arg_22_2)
	...
	local var_22_11 = var_7:Find("blank")
	local var_22_12 = var_7
	local var_22_13 = var_7.Find(var_22_12, "selected")
	...
	var_22_12(var_22_13, false)

	setActive = var_22_12

	var_22_12(var_22_8, var_22_2)

	setActive = var_22_12

	var_22_12(var_22_10, var_22_2)

	setActive = var_22_12

	var_22_12(var_22_9, false)

	setActive = var_22_12

	var_22_12(var_22_11, not var_22_2)

	if var_22_5 then
		setActive = var_22_12

		var_22_12(var_22_5, var_22_2 and var_22_1)
	end

	if var_22_6 then
		setActive = var_22_12

		var_22_12(var_22_6, var_22_2 and var_22_1)
	end

	if var_22_7 then
		setActive = var_22_12

		var_22_12(var_22_7, var_22_2 and var_22_1)
	end
	...
	if var_22_2 then
		if var_22_1 then
			...
			if var_22_1.name == "" then
				...
				if not var_19.DEFAULT_NAME[var_22_1.id] then
					var_22_15 = var_22_1.name
				end

				var_22_12(var_22_14, var_22_15)

				FleetType = var_22_12

				if arg_22_1 == var_22_12.Submarine then
				...
				var_22_12(var_22_16, var_22_17, var_22_18, var_1_10021)
				...
				var_22_12(var_22_19, var_22_20, var_22_21, var_1_10021)
...
function var_0_1.updateShips(arg_26_0, arg_26_1, arg_26_2)
	...
	var_3.make(var_26_0, function(arg_27_0, arg_27_1, arg_27_2)
		...
		if arg_27_0 == var_2_10003.EventUpdate then
			...
			local var_27_0 = var_3(var_2_10004)
			local var_27_1 = var_3.getShipById(var_27_0, arg_26_2[arg_27_1 + 1])

			updateShip = var_27_0

			var_27_0(arg_27_2, var_27_1)

			local var_27_2 = arg_27_2:Find("icon_bg/energy")
			local var_27_3 = var_27_1

			if var_27_1.getEnergeConfig(var_27_3) and var_6.id <= 2 then
				setActive = var_27_3

				var_27_3(var_27_2, true)

				GetImageSpriteFromAtlasAsync = var_27_3

				var_27_3("energy", var_6.icon, var_27_2)
			else
				setActive = var_27_3

				var_27_3(var_27_2, false)
			end
		end
...
function var_0_1.showToggleMask(arg_28_0, arg_28_1, arg_28_2)
	...
	for iter_28_0, iter_28_1 in var_4(arg_28_0.toggles) do
		...
		if var_28_1 then
			...
			setButtonEnabled = var_28_3

			var_28_3(iter_28_1, var_1_10010)

			setActive = var_28_3

			var_28_3(var_28_4, not var_1_10010)

			if var_1_10010 then
				table = var_28_3
				var_28_3 = var_28_3.contains(arg_28_0.selectIds[arg_28_1], var_28_1.id)
				setActive = var_14

				var_14(iter_28_1:Find("selected"), var_28_3)

				setActive = var_14

				var_14(iter_28_1:Find("text"), not var_28_3)

				setActive = var_14

				var_14(iter_28_1:Find("text_selected"), var_28_3)

				onButton = var_14

				local var_28_5 = arg_28_0
				local var_28_6 = iter_28_1
				...
				var_14(var_28_5, var_28_6, var_1_10017, var_1_10018)
			else
				onButton = var_28_3
				...
				var_28_3(var_28_7, var_28_8, var_28_9, var_1_10017)
			end
		end
	end
...
function var_0_1.clearFleet(arg_35_0, arg_35_1)
	...
	local var_35_3 = arg_35_1.Find(var_35_2, "sub")
