...
function var_0_1.Show(arg_6_0)
	...
	var_1_10001(var_6_0, var_1_10003(0.5, 0.5, 0.5))
	...
	var_6_2(var_6_3, var_3.one, 0.15)
...
function var_0_1.Hide(arg_7_0)
	...
	var_7_0(var_1_10002(arg_7_0.rtFrame))
...
function var_0_1.Setup(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_4 = var_7.Find(var_8_3, "frame/buff_panel/info/name")

	i18n = var_8_3

	var_6(var_8_4, var_8_3("world_boss_drop_title"))

	setText = var_6

	local var_8_5 = arg_8_0._tf

	var_6(var_7.Find(var_8_5, "frame/buff_panel/info/value_before"), var_8_2 - var_8_1)

	setText = var_6

	local var_8_6 = arg_8_0._tf

	var_6(var_7.Find(var_8_6, "frame/buff_panel/info/value"), var_8_2)
