...
function var_0_1.DebugPrint(arg_7_0)
	if arg_7_0.type == var_0_1.TypeEvent then
		...
		while var_1_10006 <= #var_7_1 do
			if arg_7_0.effects[#arg_7_0.effects - var_7_4 + 1] == var_7_1[#var_7_1 - var_1_10006 + 1] then
				table = var_1_10009
			...
			elseif not var_1_10007 then
				...
				var_1_10013 = var_1_10008
				COLOR_GREEN = var_1_10014

				var_1_10009(var_1_10010, var_7_5, var_1_10012(var_1_10013, var_1_10014))
				...
				if var_1_10009.world_effect_data[var_1_10008].effect_type == 27 or var_1_10009 == 35 or var_1_10009 == 36 or var_1_10009 == 53 then
					...
					var_1_10014 = var_1_10007
					COLOR_BLUE = var_1_10015

					var_1_10010(var_7_6, var_1_10012, var_1_10013(var_1_10014, var_1_10015))
					...
					var_1_10010(var_7_7, var_1_10012, var_1_10013(var_1_10014, var_1_10015))

					var_1_10010 = var_7_4 + 1
					var_1_10006 = var_1_10006 + 1
					var_7_4 = var_1_10010
				end
			end
		...
		local var_7_8 = var_1_10007 .. var_1_10008.concat(var_7_3, ", ")
		...
		for iter_7_0, iter_7_1 in var_1_10007(arg_7_0.config.event_op) do
			...
			if iter_7_0 <= #arg_7_0.config.event_op - arg_7_0.dataop then
				table = var_7_9
				var_7_9 = var_7_9.insert

				local var_7_10 = var_7_0

				setColorStr = var_1_10014
				var_1_10015 = iter_7_1
				COLOR_GREEN = var_1_10016

				var_7_9(var_7_10, var_1_10014(var_1_10015, var_1_10016))
			else
				table = var_7_9

				var_7_9.insert(var_7_0, iter_7_1)
			end
		end

		string = var_1_10007
		var_1_10007 = var_1_10007.format
		var_1_10008 = "事件  [id: %d]  [%s]  [位置: %d, %d]  [flag: %s]  [data: %d]  [感染值：%s]  [自动优先级：%s] \n     [effect: %s] \n     [effect_op: %s] \n     [buff: %s]"

		local var_7_11 = arg_7_0.id
		local var_7_12 = arg_7_0.config.name
		local var_7_13 = arg_7_0.row
		local var_7_14 = arg_7_0.column
		local var_7_15 = arg_7_0.flag
		local var_7_16 = arg_7_0.data

		setColorStr = var_1_10015

		local var_7_17 = arg_7_0.config.infection_value

		COLOR_RED = var_1_10017

		local var_7_18 = var_1_10015(var_7_17, var_1_10017)

		setColorStr = var_7_17

		local var_7_19 = arg_7_0.config.auto_pri

		COLOR_YELLOW = var_1_10018

		local var_7_20 = var_7_17(var_7_19, var_1_10018)
		local var_7_21 = var_7_8

		table = var_1_10018

		local var_7_22 = var_1_10018.concat(var_7_0, ", ")

		table = var_19

		return var_1_10007(var_1_10008, var_7_11, var_7_12, var_7_13, var_7_14, var_7_15, var_7_16, var_7_18, var_7_20, var_7_21, var_7_22, var_19.concat(arg_7_0.buffList, ", "))
	elseif var_0_1.IsEnemyType(arg_7_0.type) then
		string = var_1

		local var_7_23 = var_1.format
		local var_7_24 = "敌人  [id: %s]  [%s]  [类型 %s]  [位置: %s, %s]  [flag: %s]  [data: %s]  [buff: %s]"
		local var_7_25 = arg_7_0.id
		local var_7_26 = arg_7_0.config.name
		local var_7_27 = arg_7_0.type

		var_1_10006 = arg_7_0.row
		var_1_10007 = arg_7_0.column
		tostring = var_1_10008

		local var_7_28 = var_1_10008(arg_7_0.flag)

		tostring = var_9

		local var_7_29 = var_9(arg_7_0.data)

		table = var_10

		return var_7_23(var_7_24, var_7_25, var_7_26, var_7_27, var_1_10006, var_1_10007, var_7_28, var_7_29, var_10.concat(arg_7_0.buffList, ", "))
	elseif arg_7_0.type == var_0_1.TypeTrap then
		...
		var_1_10006 = arg_7_0.column
		tostring = var_1_10007
		var_1_10007 = var_1_10007(arg_7_0.flag)
		tostring = var_8

		return var_7_30(var_7_31, var_7_32, var_7_33, var_7_34, var_1_10006, var_1_10007, var_8(arg_7_0.data))
	elseif arg_7_0.type == var_0_1.TypeFleet then
		...
		local var_7_40 = var_1_10007(arg_7_0.flag)

		tostring = var_8

		return var_7_35(var_7_36, var_7_37, var_7_38, var_7_39, var_1_10006, var_7_40, var_8(arg_7_0.data))
	elseif arg_7_0.type == var_0_1.TypeArtifact then
		string = var_1

		local var_7_41 = var_1.format
		local var_7_42 = "场景物件  [id: %s]  [位置: %s, %s]  [flag: %s]  [data: %s]  [buff: %s]"
		local var_7_43 = arg_7_0.id
		local var_7_44 = arg_7_0.row
		local var_7_45 = arg_7_0.column

		tostring = var_1_10006

		local var_7_46 = var_1_10006(arg_7_0.flag)

		tostring = var_7

		local var_7_47 = var_7(arg_7_0.data)

		table = var_8

		return var_7_41(var_7_42, var_7_43, var_7_44, var_7_45, var_7_46, var_7_47, var_8.concat(arg_7_0.buffList, ", "))
	end
...
function var_0_1.GetEventEffect(arg_18_0)
	...
	var_1_10001(var_18_0, var_3.format("type error:%d", arg_18_0.type))

	if arg_18_0.effects[1] then
		::label_18_0::

		pg = var_18_0
		var_18_0 = var_18_0.world_effect_data[var_1]
	end
...
function var_0_1.GetEventEffects(arg_19_0)
	...
	var_1_10001(var_19_0, var_3.format("type error:%d", arg_19_0.type))
...
function var_0_1.GetOpEffect(arg_22_0)
	...
	var_3(var_1_10004.world_effect_data[var_22_0], "world_effect_data not exist: " .. var_22_0)
...
function var_0_1.GetWeaknessBuffId(arg_35_0)
	...
	local var_35_1 = var_2.each

	underscore = var_1_10003

	local var_35_2 = var_1_10003.flatten

	pg = var_1_10004

	var_35_1(var_35_2(var_1_10004.world_expedition_data[arg_35_0:GetBattleStageId()].weak_list), function(arg_36_0)
...
function var_0_1.SetHP(arg_50_0, arg_50_1)
	if var_0_1.IsHPEnemyType(arg_50_0.type) then
		...
		if arg_50_0.IsPeriodEnemy(var_50_1) then
			nowWorld = var_3

			local var_50_2 = var_3()

			math = var_50_1
			var_50_0 = var_50_1.min(var_50_0, var_50_2:GetHistoryLowestHP(arg_50_0.id))
			var_1_10005 = var_50_2

			var_50_2.SetHistoryLowestHP(var_1_10005, arg_50_0.id, arg_50_1)
		end
		...
		for iter_50_0, iter_50_1 in var_50_1(var_1_10005.world_expedition_data[arg_50_0:GetBattleStageId()].phase_story) do
			if var_50_0 > iter_50_1[1] and arg_50_1 <= iter_50_1[1] then
				table = var_9

				var_9.insert(var_50_3, {
					hp = iter_50_1[1],
					story = iter_50_1[2]
				})
			end
...
function var_0_1.GetArtifaceInfo(arg_53_0)
	...
	var_1_10002(var_3.floor(var_53_0.enemyicon / 2) == 2, "enemyicon error from id: " .. arg_53_0.id)
...
function var_0_1.IsPeriodEnemy(arg_58_0)
	...
	var_1_10001(var_58_0, var_3.format("enemy %d type %d error", arg_58_0.id, arg_58_0.type))
