...
Vector2 = var_0_0
var_0_1.windowSize = var_0_0(1747, 776)
var_0_1.Fields = {
...
function var_0_1.LoadScene(arg_2_0, arg_2_1)
	...
	var_2_1(var_2_0, var_2_2, var_2_3, var_1_10006.Additive, function(arg_3_0, arg_3_1)
		...
		typeof = var_5
		PointerInfo = var_2_10006
		var_3_19.cmPointer = var_3_22(var_3_21, var_5(var_2_10006))
		nowWorld = var_3_19
		...
		if iter_8_1 then
			...
			if var_8_2 then
				arg_8_0:LoadExtraMarkPrefab(arg_8_0.tfMarkScene, var_8_2, function(arg_9_0)
					...
					WorldConst = var_2
					var_9_0.localPosition = var_2.CalcModelPosition(var_0, arg_8_0.spriteBaseSize)
...
function var_0_1.UpdateTargetEntrance(arg_10_0, arg_10_1)
	...
	calcPositionAngle = var_10_2

	local var_10_4 = var_10_2(var_10_1.config.area_pos[1] - var_10_3.config.area_pos[1], var_10_1.config.area_pos[2] - var_10_3.config.area_pos[2])
