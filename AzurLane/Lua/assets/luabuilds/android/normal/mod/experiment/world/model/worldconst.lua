...
function var_0_0.IsRookieMap(arg_7_0)
	...
	return var_7_0(var_1_10002.gameset.world_guide_map_list.description, function(arg_8_0)
...
function var_0_0.GetRealmRookieId(arg_9_0)
	...
	return var_1_10001(var_2.gameset.world_default_entrance.description[arg_9_0])
end
...
function var_0_0.ArrayEffectOrder(arg_15_0, arg_15_1)
	...
	local var_15_3 = var_15_2(var_15_1, var_1_10005(var_1_10006), true)
	local var_15_4 = var_3.ToTable(var_15_3)

	table = var_15_3

	var_15_3.insertto(var_15_0, var_15_4)
	...
	local var_15_7 = var_15_6(var_15_5, var_6(var_1_10007), true)
	local var_15_8 = var_4.ToTable(var_15_7)

	table = var_15_7

	var_15_7.insertto(var_15_0, var_15_8)
...
function var_0_0.CalcModelPosition(arg_18_0, arg_18_1)
	...
	PIXEL_PER_UNIT = var_4

	local var_18_1 = var_18_0 / var_4
	local var_18_2 = 0
	local var_18_3 = arg_18_0.config.area_pos[2] - arg_18_1.y / 2

	PIXEL_PER_UNIT = var_6

	return var_1_10002(var_18_1, var_18_2, var_18_3 / var_6)
end
...
function var_0_0.ExtendPropertiesRatesFromBuffList(arg_19_0, arg_19_1)
	...
	for iter_19_0, iter_19_1 in var_1_10002(arg_19_1) do
		...
		WorldBuff = var_1_10009

		var_1_10007(var_19_0 == var_1_10009)
...
function var_0_0.AppendPropertiesFromBuffList(arg_20_0, arg_20_1, arg_20_2)
	...
	for iter_20_0, iter_20_1 in var_1_10003(arg_20_2) do
		...
		WorldBuff = var_1_10010

		var_1_10008(var_20_0 == var_1_10010)
...
function var_0_0.CalcRelativeRectPos(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	Vector2 = var_13
	var_21_8[1] = var_13(var_21_0, var_21_2)
	Vector2 = var_13
	var_21_8[2] = var_13(var_21_0, var_21_3)
	Vector2 = var_13
	var_21_8[3] = var_13(var_21_1, var_21_3)
	Vector2 = var_13
	var_21_8[4] = var_13(var_21_1, var_21_2)
...
function var_0_0.BuildHelpTips(arg_26_0)
	...
	local var_26_1 = var_2.gameset.world_stage_help.description
	local var_26_2 = 1
...
function var_0_0.FindStageTemplates(arg_27_0)
	...
	for iter_27_0, iter_27_1 in var_1_10002(var_1_10003.world_stage_template.all) do
		pg = var_1_10007
...
function var_0_0.WorldLevelCorrect(arg_30_0, arg_30_1)
	...
	for iter_30_0, iter_30_1 in var_1_10002(var_1_10003.gameset.world_expedition_level.description) do
		ipairs = var_1_10007
...
function var_0_0.GetTransportBlockEvent()
	if not var_0_0.blockEventDic then
		...
		for iter_32_0, iter_32_1 in var_32_0(var_1.gameset.world_movelimit_event.description) do
...
function var_0_0.GetTransportStoryEvent()
	if not var_0_0.blockStoryDic then
		...
		for iter_33_0, iter_33_1 in var_33_0(var_1.gameset.world_transfer_eventlist.description) do
	...
	if var_1_10002.HasKey("world_help_progress") then
		...
		do
			...
			if var_34_0 < arg_34_0 then
				...
				for iter_34_0, iter_34_1 in var_3(var_1_10004.world_help_data.all) do
					pg = var_1_10008
...
function var_0_0.FetchWorldShip(arg_38_0)
	...
	var_38_0(var_38_1, "world ship not exist: " .. arg_38_0)
...
function var_0_0.FetchShipVO(arg_39_0)
	...
	var_39_0(var_39_1, "ship not exist: " .. arg_39_0)
...
function var_0_0.FetchRawShipVO(arg_40_0)
	...
	var_40_0(var_40_1, "ship not exist: " .. arg_40_0)
	...
	if var_41_1 == var_1_10003.TypeBase then
		...
		var_41_1.insert(var_41_0, function(arg_42_0)
			...
			var_1.Send(var_42_0, 33000, {
				...
				WorldProxy = var_3_10002

				local var_43_0 = var_3_10001(var_3_10002)
				local var_43_1 = var_1.BuildWorld

				World = var_3_10004

				var_43_1(var_43_0, var_3_10004.TypeFull)
...
function var_0_0.GetObstacleKey(arg_46_0)
	...
	return var_46_0(var_46_1, var_46_2 - var_1_10004.indexof(var_0_0.ObstacleType, arg_46_0))
end
...
function var_0_0.GetObstacleConfig(arg_47_0, arg_47_1)
	...
	return var_3.band(var_0_0.ObstacleConfig[arg_47_0], var_47_0) > 0
end
...
function var_0_0.CheckWorldStorySkip(arg_49_0)
	...
	if var_49_0(var_1_10002.gameset.world_quickmode_skiplua.description, arg_49_0) then
		getProxy = var_49_3
		SettingsProxy = var_2

		local var_49_1 = var_49_3(var_2)
...
function var_0_0.GetNShopTimeStamp()
	if not var_0_0.nShopTimestamp then
		...
		var_50_0.year, var_50_0.month, var_50_0.day = var_1_10001(var_1_10002("world_newshop_date")[2])
