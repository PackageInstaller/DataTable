...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".WSBaseCommand"))
local var_0_2
...
function var_0_1.OpSwitchMap(arg_5_0, arg_5_1, arg_5_2)
	...
	if not var_5.GetInMap(var_5_2) then
		...
		local var_5_3 = var_5_0:GetActiveEntrance()
		local var_5_4 = var_5_0
		local var_5_5 = var_5_0.GetActiveMap(var_5_4)

		World = var_5_4

		if var_5_4.ReplacementMapType(var_5_3, var_5_5) == "complete_chapter" then
			getProxy = var_7
			SettingsProxy = var_8

			local var_5_6 = var_7(var_8)
			...
			if var_7.GetWorldFlag(var_5_6, "auto_save_area") then
				...
				AutoBotCommand = var_9

				local var_5_9 = var_9.GetAutoBotMark

				SYSTEM_WORLD = var_1_10010

				var_5_7(var_5_8 .. var_5_9(var_1_10010), 1)
			end
		end
		...
		if not var_5_0.isAutoSwitch then
			...
			if var_5_13.ReplacementMapType(var_5_3, var_5_5) == "complete_chapter" then
				getProxy = var_5_13
				SettingsProxy = var_10

				local var_5_12 = var_5_13(var_10)
	...
	elseif arg_5_1.destMapId ~= var_5_1.id or arg_5_1.destGridId ~= var_5_1.gid then
		...
		var_6.insert(var_5_14, function(arg_7_0)
			...
			var_7_1(var_7_0, var_2_10003.UIMgr.CameraOverlay, true)
		...
		var_6.insert(var_5_14, function(arg_8_0)
			...
			var_8_1(var_8_0, var_2_10003.UIMgr.CameraOverlay)
		...
		var_6.insert(var_5_14, function(arg_9_0)
			...
			if var_9_3.ReplacementMapType(var_9_2, var_9_4) == "complete_chapter" then
				getProxy = var_3
				SettingsProxy = var_4

				local var_9_5 = var_3(var_4)
				...
				if var_3.GetWorldFlag(var_9_5, "auto_save_area") then
					...
					local var_9_8 = var_5.GetAutoBotMark

					SYSTEM_WORLD = var_2_10006

					var_9_6(var_9_7 .. var_9_8(var_2_10006), 1)
				end
			end
		...
		var_5_16(var_5_15, var_7.GetFleet(var_5_17).transform.position)
...
function var_0_1.OpOpenLayer(arg_15_0, arg_15_1)
	...
	var_15_1(var_15_0, var_1_10004.OnOpenLayer, arg_15_1)
...
function var_0_1.OpOpenScene(arg_16_0, arg_16_1, ...)
	...
	var_16_1(var_16_0, var_1_10004.OnOpenScene, arg_16_1, ...)
...
function var_0_1.OpChangeScene(arg_17_0, arg_17_1, ...)
	...
	var_17_1(var_17_0, var_1_10004.OnChangeScene, arg_17_1, ...)
...
function var_0_1.OpInteractive(arg_18_0, arg_18_1)
	...
	if var_0_2.contextData.inShop then
		...
		var_1_10005 = {}
		i18n = var_1_10006
		var_1_10005.content = var_1_10006("world_shop_init_notice")

		function var_1_10005.onYes()
		...
		var_18_2(var_18_1, var_1_10005)

		return
	end

	local var_18_3 = var_2
	local var_18_4 = var_2.GetRound(var_18_3)

	WorldConst = var_18_3

	if var_18_4 == var_18_3.RoundElse then
		arg_18_0:OpReqRound()
	...
	local var_18_7 = var_2:GetActiveMap()
	local var_18_8 = {}

	table = var_1_10005

	var_1_10005.insert(var_18_8, function(arg_21_0)
	...
	var_5.insert(var_18_8, function(arg_22_0)
		...
		if var_1.CheckEventForMsg(var_22_0) then
			...
			if var_2_10003.collection_template[var_22_1] then
				pg = var_3
				...
				if var_0.isAutoFight then
					...
					local var_22_3 = var_4.AddAutoInfo
					local var_22_4 = "message"

					i18n = var_2_10007

					var_22_3(var_2_10005, var_22_4, var_2_10007("autofight_entrust", var_22_2))
					arg_22_0()
				else
					...
					local var_22_6 = var_2_10005.MsgboxMgr.GetInstance()
					local var_22_7 = var_5.ShowMsgBox
					local var_22_8 = {
						hideNo = true
					}

					i18n = var_2_10008
					var_22_8.content = var_2_10008("event_special_update", var_22_2)
					var_22_8.onYes = var_22_5
					var_22_8.onNo = var_22_5

					var_22_7(var_22_6, var_22_8)
				end
	...
	var_5.insert(var_18_8, function(arg_24_0)
		pg = var_2_10001
		...
		if var_0.isAutoFight then
			if var_24_0:GetShouldShowBattleTip() then
				var_24_0:SubmitTask(function(arg_25_0, arg_25_1, arg_25_2)
					...
					var_25_1(var_25_0, var_25_2, var_3_10006(var_25_3, var_3_10008.task_data_template[arg_25_2].desc))
					...
					if arg_25_1 then
						if arg_25_0 then
							...
							var_25_5(var_25_4, var_25_6, var_6(var_25_7, var_8.task_data_template[arg_25_2].desc))
						end
	...
	var_5.insert(var_18_8, function(arg_26_0)
		local var_26_0 = var_18_7.isLoss
		local var_26_1 = var_18_7
		...
		if var_26_0 then
			...
			if var_26_1.IsRookieMap(var_18_7.id) then
				local var_26_2 = arg_18_0

				var_26_3 = var_26_3.OpStory
				WorldConst = var_2_10004

				var_26_3(var_26_2, var_2_10004.GetRookieBattleLoseStory(), true, false, false, function()
	...
	var_5.insert(var_18_8, function(arg_28_0)
	...
	var_5.insert(var_18_8, function(arg_29_0)
		if #var_18_7.phaseDisplayList > 0 then
			local var_29_0 = var_0_2

			var_1.DisplayPhaseAction(var_29_0, var_18_7.phaseDisplayList)
		else
			arg_29_0()
		end
	...
	var_5.insert(var_18_8, function(arg_30_0)
		local var_30_0 = var_18_7
	...
	var_5.insert(var_18_8, function(arg_31_0)
		...
		if not var_1.ShouldTipProgress(var_31_1) then
			...
			if var_2.PlayGuide(var_31_3, "WorldG190") then
				...
				i18n = var_2_10005
				var_31_6.content = var_2_10005("world_boss_get_item")
				...
				function var_31_6.onYes()
					...
					var_32_1(var_32_0, var_3_10002.WORLDBOSS)
		...
		if var_1.CheckInteractive(var_34_0) then
			...
			if var_34_3.IsEnemyType(var_1.type) then
				if var_0.isAutoFight or arg_18_1 then
					...
					pg = var_34_6
					var_34_6 = var_34_6.expedition_data_template[var_34_7]
					assert = var_2_10005

					var_2_10005(var_34_6, "expedition_data_template not exist: " .. var_34_7)

					local var_34_8 = var_0

					if var_5.CheckSkipBattle(var_34_8) then
						local var_34_9 = arg_18_0

						var_5.OpReqSkipBattle(var_34_9, var_34_2.id)

						goto label_34_1
					end

					if not var_0.isAutoFight then
						PlayerPrefs = var_34_11

						do
							local var_34_11

							if var_34_11.GetInt("world_skip_precombat", 0) == 1 then
								local var_34_10 = var_0_2

								var_34_11 = var_34_11.emit
								WorldMediator = var_7

								var_34_11(var_34_10, var_7.OnStart, var_34_7, var_34_2, var_1)
							else
								pg = var_34_11

								local var_34_12

								if var_34_11.world_expedition_data[var_34_7] and var_5.battle_type then
									var_34_12 = var_5.battle_type ~= 0
								end
								...
								if var_34_12 then
									...
									var_34_13.mediator = var_8
									WorldBossInformationLayer = var_8
									var_34_13.viewComponent = var_8
								else
								...
								local var_34_14 = arg_18_0
								local var_34_15 = var_8.OpOpenLayer

								Context = var_2_10010

								var_34_15(var_34_14, var_2_10010.New(var_34_13))
							end
							...
							local var_34_16 = var_1.type

							WorldMapAttachment = var_34_6

							if var_34_16 == var_34_6.TypeBox then
								local var_34_17 = arg_18_0

								var_34_16.OpReqBox(var_34_17, var_34_2, var_1)
							else
								assert = var_34_16

								var_34_16(false, "invalide interactive type: " .. var_1.type)
							end
	...
	var_5.insert(var_18_8, function(arg_35_0)
		if var_0_2.inLoopAutoFight then
			...
			i18n = var_2_10004
			var_35_3.content = var_2_10004("autofight_tip_bigworld_loop")
	...
	var_5.insert(var_18_8, function(arg_36_0)
		if not var_0.isAutoFight and not var_0.isAutoSwitch then
			...
			if var_1.HasAutoFightDrops(var_36_0) then
				...
				local var_36_3 = var_2_10003.New
				local var_36_4 = {}

				WorldAutoFightRewardMediator = var_2_10005
				var_36_4.mediator = var_2_10005
				WorldAutoFightRewardLayer = var_2_10005
				var_36_4.viewComponent = var_2_10005
...
function var_0_1.OpReqDiscover(arg_38_0)
	...
	if #var_1.CheckDiscover(var_38_1) > 0 then
		...
		var_1_10005.each(var_2, function(arg_39_0)
			...
			var_39_0.insert(var_38_2, var_39_1)
		...
		local var_38_6 = var_7.OnMapOp
		local var_38_7 = var_0_2
		local var_38_8 = var_8.NewMapOp
		local var_38_9 = {}

		WorldConst = var_1_10011
		var_38_9.op = var_1_10011.OpReqDiscover
...
function var_0_1.OpReqDiscoverDone(arg_41_0, arg_41_1)
	...
	if arg_41_1 and #arg_41_1.hiddenAttachments > 0 then
		...
		var_1_10005.insert(var_41_2, function(arg_42_0)
			local var_42_0 = arg_41_0
			local var_42_1 = var_1.OpAnim

			WorldConst = var_2_10003

			var_42_1(var_42_0, var_2_10003.AnimRadar, arg_42_0)
			...
			if var_0.CheckMapPressing(var_43_2) then
				...
				if var_0.CheckFleetMovable(var_43_4) then
					...
					if not var_1.CheckFleetMovable(var_43_8, var_43_7) then
						...
						WorldMapCell = var_43_9

						if var_43_10 == var_43_9.TerrainWind then
							pg = var_43_10
							...
							var_43_12(var_43_11, var_3("world_wind_move"))
						end
					end
				end
			end
...
function var_0_1.OpReadyToMove(arg_46_0)
	...
	WorldBuff = var_1_10006

	local var_46_4

	if #var_46_2(var_46_1, var_1_10006.TrapDisturbance) > 0 then
		local var_46_3 = var_2

		var_46_4 = var_2.GetMoveRange(var_46_3, var_3)
		math = var_46_3

		local var_46_5 = var_46_3.clamp

		math = var_6

		local var_46_6 = var_6.ceil

		math = var_1_10007

		if var_46_4[var_46_5(var_46_6(var_1_10007.random() * #var_46_4), 1, #var_46_4)] then
			local var_46_7 = var_0_2

			var_6.ClearMoveQueue(var_46_7)
			arg_46_0:OpReqMoveFleet(var_3, var_46_4[var_5].row, var_46_4[var_5].column)
	...
	if var_46_4().isAutoFight then
		if #var_0_2.moveQueue > 0 then
			local var_46_8 = var_0_2

			var_5.DoQueueMove(var_46_8, var_3)
		else
			local var_46_9 = var_0_2

			if var_5.CheckLostMoveQueueCount(var_46_9) then
				local var_46_10 = var_0_2

				var_5.ResetLostMoveQueueCount(var_46_10, true)
	...
	if #var_0_2.moveQueue > 0 and var_2:CanLongMove(var_3) then
		...
		var_5.DoQueueMove(var_46_11, var_3)

		return
	end

	local var_46_12 = var_0_2

	var_5.ClearMoveQueue(var_46_12)
	var_1:UpdateRangeVisible(true)

	local var_46_13 = var_0_2.contextData.inPort
	local var_46_14 = var_0_2.contextData

	var_46_14.inPort = false

	if var_46_13 then
		checkExist = var_46_14
	...
	local var_46_15 = var_0_2

	var_6.CheckGuideSLG(var_46_15, var_2, var_3)
...
function var_0_1.OpLongMoveFleet(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	...
	if var_4:CheckFleetMovable() then
		...
		if not var_10.any(var_47_4, function(arg_48_0)
			return arg_48_0.row == var_47_3.row and arg_48_0.column == var_47_3.column
		end) then
			pg = var_11

			local var_47_6 = var_11.TipsMgr.GetInstance()
			local var_47_7 = var_11.ShowTips

			i18n = var_1_10013

			var_47_7(var_47_6, var_1_10013("destination_not_in_range"))
		else
			local var_47_8 = {}
			local var_47_9 = 0
			local var_47_10
			...
			;(function(arg_49_0, arg_49_1)
				...
				return
			end)(var_47_5[var_47_3.row][var_47_3.column], 0)

			local var_47_11 = var_0_2

			var_14.SetMoveQueue(var_47_11, var_47_8)

			local var_47_12 = var_0_2

			var_14.DoQueueMove(var_47_12, arg_47_1)
		end
	end
...
function var_0_1.OpReqMoveFleet(arg_50_0, arg_50_1, arg_50_2, arg_50_3)
	...
	if var_4:CheckFleetMovable() then
		...
		if var_50_1:IsSign(var_50_3.row, var_50_3.column) then
			...
			if var_50_5 < var_11.PrioObstacle then
				var_50_4 = var_50_3
		...
		local var_50_9, var_50_11

		if var_50_7.detect(var_50_8, function(arg_51_0)
			return arg_51_0.row == var_50_3.row and arg_51_0.column == var_50_3.column
		end) then
			var_50_9 = nil

			local var_50_10 = arg_50_1

			var_50_11 = arg_50_1.GetBuffsByTrap
			WorldBuff = var_1_10014

			local var_50_12 = #var_50_11(var_50_10, var_1_10014.TrapVortex)

			if 0 < var_50_12 then
				math = var_50_12

				local var_50_13 = var_50_12.random() * 100

				underscore = var_1_10014

				if var_1_10014.all(var_50_11, function(arg_52_0)
					return var_50_13 < arg_52_0:GetTrapParams()[1]
				end) then
					var_1_10014 = arg_50_1.row
					var_50_3.column = arg_50_1.column
					var_50_3.row = var_1_10014
					WorldBuff = var_1_10014
					var_50_9 = var_1_10014.TrapVortex
				end
			end

			var_1_10014 = var_50_1

			local var_50_14

			var_50_14, var_1_10014 = var_50_1.FindPath(var_1_10014, var_50_2, var_50_3)
			PathFinding = var_15

			local var_50_16

			if var_50_14 < var_15.PrioObstacle then
				local var_50_15 = var_0_2

				var_50_16 = var_50_16.emit
				WorldMediator = var_1_10017
				var_1_10017 = var_1_10017.OnMapOp

				local var_50_17 = var_0_2
				local var_50_18 = var_18.NewMapOp
				local var_50_19 = {}

				WorldConst = var_1_10021
				var_50_19.op = var_1_10021.OpReqMoveFleet
				var_50_19.id = arg_50_1.id
				var_50_19.arg1 = var_50_3.row
				var_50_19.arg2 = var_50_3.column
				var_50_19.sign = var_50_4
				var_50_19.trap = var_50_9

				var_50_16(var_50_15, var_1_10017, var_50_18(var_50_17, var_50_19))

				return
			else
				PathFinding = var_50_16

				local var_50_21

				if var_50_14 < var_50_16.PrioForbidden then
					pg = var_50_21

					local var_50_20 = var_50_21.TipsMgr.GetInstance()

					var_50_21 = var_50_21.ShowTips
					i18n = var_1_10017

					var_50_21(var_50_20, var_1_10017("destination_can_not_reach_safety"))
				else
					pg = var_50_21

					local var_50_22 = var_50_21.TipsMgr.GetInstance()
					local var_50_23 = var_15.ShowTips

					i18n = var_1_10017

					var_50_23(var_50_22, var_1_10017("destination_can_not_reach"))
				end
			end
		else
			trap = var_50_9

			local var_50_24 = var_50_9 and "world_fleet_in_vortex" or "destination_not_in_range"

			pg = var_50_11

			local var_50_25 = var_50_11.TipsMgr.GetInstance()
			local var_50_26 = var_12.ShowTips

			i18n = var_1_10014

			var_50_26(var_50_25, var_1_10014(var_50_24))
		end
	end

	local var_50_27 = var_0_2

	var_6.ClearMoveQueue(var_50_27)
	arg_50_0:OpDone()
...
function var_0_1.OpReqMoveFleetDone(arg_53_0, arg_53_1)
	...
	var_53_1.insert(var_53_0, function(arg_54_0)
...
function var_0_1.OpMoveFleet(arg_58_0, arg_58_1, arg_58_2)
	...
	local var_58_11 = var_1_10013.DirType2
	local var_58_12 = var_58_5
	local var_58_13 = var_58_5.GetTerrain(var_58_12)

	WorldMapCell = var_58_12

	local var_58_14 = var_58_7(var_58_6, var_58_8, var_58_9, var_58_10, var_58_11, var_58_13 == var_58_12.TerrainWind)
	...
	local function var_58_15(arg_59_0, arg_59_1)
		...
		if #var_59_0.hiddenAttachments > 0 then
			...
			var_4.insert(var_59_1, function(arg_60_0)
				...
				var_60_2(var_60_1, var_3_10003.AnimRadar, function()
					if arg_59_0 < #arg_58_1.stepOps then
	...
	local function var_58_16(arg_63_0)
		...
		var_63_4(var_63_3, var_63_5, var_63_6, var_2_10007.linear)
	...
	local function var_58_20()
		...
		var_65_1(var_65_0, var_2_10002.EventArrivedStep, var_58_18)
		...
		var_65_3(var_65_2, var_2.EventArrived, var_58_20)
		...
		var_58_15(var_58_17, function()
			if #arg_58_1.locations > 0 then
				...
				WorldMediator = var_3_10002

				local var_66_2 = var_3_10002.OnMapOp
				local var_66_3 = var_0_2
				local var_66_4 = var_3.NewMapOp
				local var_66_5 = {}

				WorldConst = var_3_10006
				var_66_5.op = var_3_10006.OpReqDiscover
	...
	var_58_22(var_58_21, var_1_10016.EventArrivedStep, var_58_18)
	...
	var_58_24(var_58_23, var_16.EventArrived, var_58_20)
...
function var_0_1.OpMoveAttachment(arg_68_0, arg_68_1, arg_68_2)
	...
	local function var_68_8()
		...
		var_70_1(var_70_0, var_2_10002.EventArrivedStep, var_68_6)
		...
		var_70_3(var_70_2, var_2.EventArrived, var_68_8)
	...
	var_68_10(var_68_9, var_13.EventArrivedStep, var_68_6)
	...
	var_68_12(var_68_11, var_13.EventArrived, var_68_8)
...
function var_0_1.OpReqRound(arg_71_0)
	...
	WorldMediator = var_1_10003

	local var_71_2 = var_1_10003.OnMapOp
	local var_71_3 = var_0_2
	local var_71_4 = var_4.NewMapOp
	local var_71_5 = {}

	WorldConst = var_1_10007
	var_71_5.op = var_1_10007.OpReqRound
...
function var_0_1.OpAction(arg_77_0, arg_77_1, arg_77_2)
	...
	if arg_77_1.childOps then
		...
		var_4.insert(var_77_0, function(arg_78_0)
	...
	local var_77_1 = arg_77_1.op

	WorldConst = var_1_10005

	if var_77_1 == var_1_10005.OpActionUpdate then
		table = var_77_1

		var_77_1.insert(var_77_0, function(arg_79_0)
		...
		var_77_1 = arg_77_1.op
		WorldConst = var_5

		if var_77_1 == var_5.OpActionFleetMove then
			table = var_77_1

			var_77_1.insert(var_77_0, function(arg_80_0)
			...
			if var_77_1 == var_5.OpActionAttachmentMove then
				table = var_77_1

				var_77_1.insert(var_77_0, function(arg_82_0)
				...
				if var_77_1 == var_5.OpActionAttachmentAnim then
					table = var_77_1

					var_77_1.insert(var_77_0, function(arg_84_0)
					...
					if var_77_1 == var_5.OpActionFleetAnim then
						table = var_77_1

						var_77_1.insert(var_77_0, function(arg_86_0)
						...
						if var_77_1 == var_5.OpActionEventEffect then
							table = var_77_1

							var_77_1.insert(var_77_0, function(arg_88_0)
							...
							if var_77_1 == var_5.OpActionCameraMove then
								table = var_77_1

								var_77_1.insert(var_77_0, function(arg_89_0)
								...
								if var_77_1 == var_5.OpActionTrapGravityAnim then
									table = var_77_1

									var_77_1.insert(var_77_0, function(arg_91_0)
	...
	seriesAsync = var_77_1

	var_77_1(var_77_0, arg_77_2)
...
function var_0_1.OpEvent(arg_93_0, arg_93_1, arg_93_2)
		...
		if var_93_3 == var_93_6.EffectEventConsumeItem then
			if var_93_0.isAutoFight or var_93_4[4] then
				...
				var_93_6.insert(var_93_5, function(arg_98_0)
					...
					var_98_2.type = var_2_10004
					i18n = var_2_10004
					var_98_2.content = var_2_10004("sub_item_warning")

					local var_98_3 = {}
					local var_98_4 = {}

					DROP_TYPE_WORLD_ITEM = var_2_10006
					var_98_4.type = var_2_10006
			...
			if var_93_3 == var_93_6.EffectEventGuide then
				...
				if var_93_3 == var_93_6.EffectEventConsumeCarry then
					...
					if var_1_10011.any(var_93_6, function(arg_104_0)
						...
						local var_93_7 = var_93_0

						var_93_0.TriggerAutoFight(var_93_7, false)

						if var_6.effect_paramater[2] then
							table = var_93_7

							var_93_7.insert(var_93_5, function(arg_105_0)
								local var_105_0 = arg_93_0

								var_1.OpStory(var_105_0, var_0, true, false, false, arg_105_0)
						...
						var_93_7.insert(var_93_5, function(arg_106_0)
					...
					if var_93_3 == var_93_6.EffectEventCatSalvage then
						local var_93_8 = arg_93_1

						if arg_93_1.GetDisplayCommander(var_93_8) then
							var_93_8 = arg_93_1

							if not arg_93_1.IsCatSalvage(var_93_8) then
						...
						if not var_93_0.isAutoFight then
							...
							var_93_8.insert(var_93_5, function(arg_109_0)
						...
						if var_93_3 == var_93_6.EffectEventMsgbox then
							...
							var_93_6.insert(var_93_5, function(arg_111_0)
								...
								i18n = var_2_10004
								var_111_3.content = var_2_10004(var_93_4[1])
							...
							if var_93_3 == var_93_6.EffectEventStoryBattle then
								...
								var_93_6.insert(var_93_5, function(arg_113_0)
									...
									if var_1.IsAttachmentFinish(var_113_0) then
										...
										var_113_2(var_113_1, var_2_10003.OnStartPerform, var_93_4[1], function()
											arg_93_2.finishMark = arg_93_2.data
	...
	var_93_6(var_93_5, function()
		...
		WorldConst = var_2_10003
		var_115_2.op = var_2_10003.OpReqEvent
...
function var_0_1.OpReqEvent(arg_116_0, arg_116_1)
	...
	var_116_1(var_116_0, var_1_10004.OnMapOp, arg_116_1)
...
function var_0_1.OpEventOp(arg_119_0, arg_119_1)
	...
	WorldConst = var_1_10005
	var_119_2.op = var_1_10005.OpActionEventOp
...
function var_0_1.OpTriggerEvent(arg_121_0, arg_121_1, arg_121_2)
	...
	var_121_5[var_1_10011.EffectEventStory] = function()
		getProxy = var_2_10000
		WorldProxy = var_2_10001

		local var_122_0 = var_2_10000(var_2_10001)
	...
	var_121_5[var_11.EffectEventTeleport] = function()
		...
		if var_126_0 then
			...
			var_2_10002 = var_126_0.type
			WorldMapAttachment = var_2_10003
			var_2_10002 = var_2_10002 == var_2_10003.TypeEvent
		end

		var_2_10001(var_2_10002)
		...
		if var_3.GetInMap(var_126_3) and var_126_0.config.icon == "chuansong01" then
			...
			var_3.insert(var_121_1, function(arg_128_0)
				...
				var_128_1(var_128_0, var_3.NewMapOp(var_128_2, {
					anim = "chuansong_open",
	...
	local var_121_6 = var_11.EffectEventTeleportBack

	WorldMapAttachment = var_12
	var_121_5[var_121_6] = var_12.EffectEventTeleport
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventCameraMove] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventShakePlane] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventBlink1] = function()
		table = var_2_10000
	...
	local var_121_7 = var_11.EffectEventBlink2

	WorldMapAttachment = var_12
	var_121_5[var_121_7] = var_12.EffectEventBlink1
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventShipBuff] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventHelp] = function()
		if var_121_0.isAutoFight then
			-- block empty
		else
			table = var_0
			...
			var_0.insert(var_121_1, function(arg_148_0)
				...
				local var_148_2 = var_148_0(var_2.GetProgress(var_148_1))
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventProgress] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventReturn2World] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventShowPort] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventGlobalBuff] = function()
		local var_158_0 = {
			id = var_121_3[1],
			floor = var_121_3[2]
		}
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventSound] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventHelpLayer] = function()
		table = var_2_10000
		...
		var_2_10000.insert(var_121_1, function(arg_165_0)
			...
			local var_165_4 = var_3.New
			local var_165_5 = {}

			WorldHelpMediator = var_3_10005
			var_165_5.mediator = var_3_10005
			WorldHelpLayer = var_3_10005
			var_165_5.viewComponent = var_3_10005
			var_165_5.data = {
				titleId = var_121_3[1],
				pageId = var_121_3[2]
			}
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventFleetShipHP] = function()
		table = var_2_10000
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventCatSalvage] = function()
		table = var_2_10000
		...
		var_2_10000.insert(var_121_1, function(arg_169_0)
			...
			var_169_2(var_169_1, var_3_10003("world_catsearch_success"))
			arg_169_0()
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectEventTeleportEvent] = function()
		table = var_2_10000
		...
		var_2_10000.insert(var_121_1, function(arg_171_0)
			...
			LeanTweenType = var_3_10006

			var_171_4(var_171_3, var_171_5, var_171_6, var_3_10006.easeInOutSine, arg_171_0)
	...
	WorldMapAttachment = var_11
	var_121_5[var_11.EffectSideText] = function()
		table = var_2_10000
...
function var_0_1.OpReqRetreat(arg_176_0, arg_176_1)
	...
	var_176_1(var_176_2:ExistEnemy())

	local var_176_3 = var_176_2:GetAliveAttachment()
	local var_176_4 = var_0_2
	local var_176_5 = var_5.emit

	WorldMediator = var_1_10007

	local var_176_6 = var_1_10007.OnMapOp
	local var_176_7 = var_0_2
	local var_176_8 = var_8.NewMapOp
	local var_176_9 = {}

	WorldConst = var_1_10011
	var_176_9.op = var_1_10011.OpReqRetreat
	var_176_9.id = arg_176_1.id
	var_176_9.attachment = var_176_3

	var_176_5(var_176_4, var_176_6, var_176_8(var_176_7, var_176_9))
...
function var_0_1.OpTransport(arg_180_0, arg_180_1, arg_180_2)
	...
	if not var_180_3(var_180_2, var_1_10007.SystemOutMap) then
		pg = var_5
		...
		var_180_5(var_180_4, var_7("word_systemClose"))
	elseif not arg_180_2:IsMapOpen() then
		...
		var_180_7(var_180_6, var_7("world_map_not_open"))
	else
...
function var_0_1.OpReqTransport(arg_181_0, arg_181_1, arg_181_2, arg_181_3)
	...
	local var_181_2 = var_1_10006.OnMapOp
	local var_181_3 = var_0_2
	local var_181_4 = var_7.NewMapOp
	local var_181_5 = {}

	WorldConst = var_1_10010
	var_181_5.op = var_1_10010.OpReqTransport
	...
	local var_181_9 = var_1_10013()

	var_181_6[1] = var_181_8(var_181_7, var_13.GetActiveEntrance(var_181_9), arg_181_2)
...
function var_0_1.OpReqSub(arg_184_0, arg_184_1)
	...
	local var_184_0 = var_1_10003()

	var_1_10002(var_3.CanCallSubmarineSupport(var_184_0))
	...
	WorldMediator = var_184_0

	local var_184_3 = var_184_0.OnMapOp
	local var_184_4 = var_0_2
	local var_184_5 = var_5.NewMapOp
	local var_184_6 = {}

	WorldConst = var_1_10008
	var_184_6.op = var_1_10008.OpReqSub
	nowWorld = var_8

	local var_184_7 = var_8()

	var_184_6.id = var_8.GetSubmarineFleet(var_184_7).id
...
function var_0_1.OpReqSubDone(arg_185_0, arg_185_1)
	...
	local var_185_2 = var_185_1(var_185_0, var_1_10005.OpReqSub)
	...
	local var_185_6 = var_6.OpReqSub

	pg = var_1_10007

	local var_185_7 = var_1_10007.TimeMgr.GetInstance()

	var_185_5(var_185_4, var_185_6, var_7.GetServerTime(var_185_7))
...
function var_0_1.OpReqJumpOut(arg_187_0, arg_187_1, arg_187_2)
	...
	if not arg_187_2 then
		...
		var_1_10004.insert(var_187_0, function(arg_188_0)
			...
			pg = var_2_10004
			var_188_2.content = var_2_10004.world_chapter_template_reset[arg_187_1].tip
	...
	var_1_10004(var_187_0, function()
		...
		local var_190_2 = var_2_10002.OnMapOp
		local var_190_3 = var_0_2
		local var_190_4 = var_3.NewMapOp
		local var_190_5 = {}

		WorldConst = var_2_10006
		var_190_5.op = var_2_10006.OpReqJumpOut
...
function var_0_1.OpReqSwitchFleet(arg_194_0, arg_194_1)
	...
	local var_194_2 = var_1_10004.OnMapOp
	local var_194_3 = var_0_2
	local var_194_4 = var_5.NewMapOp
	local var_194_5 = {}

	WorldConst = var_1_10008
	var_194_5.op = var_1_10008.OpReqSwitchFleet
...
function var_0_1.OpStory(arg_196_0, arg_196_1, arg_196_2, arg_196_3, arg_196_4, arg_196_5)
	...
	var_196_2(var_196_1, var_196_3, var_196_4, var_196_5, var_196_6, var_196_7, var_1_10014(arg_196_4), arg_196_3)
...
function var_0_1.OpTriggerSign(arg_198_0, arg_198_1, arg_198_2, arg_198_3)
	...
	if arg_198_2:IsAvatar() then
		...
		if arg_198_2.column ~= var_198_3.fleet.column then
			local var_198_4 = var_198_1:GetModelAngles()

			var_198_4.y = arg_198_2.column < var_198_3.fleet.column and 0 or 180

			var_198_1:UpdateModelAngles(var_198_4)

			local var_198_5 = var_198_3:GetModelAngles()

			var_198_5.y = 180 - var_198_4.y

			var_198_3:UpdateModelAngles(var_198_5)
		end
	end

	local var_198_6 = {}
	local var_198_7 = arg_198_2
	local var_198_8 = arg_198_2.GetEventEffects(var_198_7)

	_ = var_198_7

	var_198_7.each(var_198_8, function(arg_199_0)
		...
		if var_199_0 == var_2_10003.EffectEventStoryOptionClient then
			...
			if arg_199_0.autoflag[1] then
				...
				if var_2_10005.CheckWorldStorySkip(var_199_2) then
					...
					var_2_10005.insert(var_198_6, function(arg_200_0)
						arg_200_0(var_0)
			...
			var_2_10005.insert(var_198_6, function(arg_201_0)
				...
				nowWorld = var_3_10006

				local var_201_5

				if not var_3_10006().isAutoFight or not var_0 or not {
					var_0
				} then
					var_201_5 = false
				end
			...
			var_2_10005.insert(var_198_6, function(arg_202_0, arg_202_1)
				assert = var_3_10002
				...
				if var_3_10002.detect(var_199_1[2], function(arg_203_0)
					...
					local var_202_3 = var_5.NewMapOp
					local var_202_4 = {
						attachment = arg_198_2
					}

					pg = var_8
					var_202_4.effect = var_8.world_effect_data[var_2[2]]
			...
			var_199_2.insert(var_198_6, function(arg_204_0)
				local var_204_0 = arg_198_0
				local var_204_1 = var_1.OpTriggerEvent
				local var_204_2 = var_0_2

				var_204_1(var_204_0, var_3.NewMapOp(var_204_2, {
					attachment = arg_198_2,
					effect = arg_199_0
				}), arg_204_0)
...
function var_0_1.OpShowMarkOverview(arg_205_0, arg_205_1, arg_205_2)
	...
	local var_205_2 = var_1_10005.OnOpenLayer

	Context = var_1_10006

	local var_205_3 = var_1_10006.New
	local var_205_4 = {}

	WorldOverviewMediator = var_1_10008
	var_205_4.mediator = var_1_10008
	WorldOverviewLayer = var_1_10008
	var_205_4.viewComponent = var_1_10008
	var_205_4.data = {
		info = arg_205_1
	}
...
function var_0_1.OpShowOrderPanel(arg_210_0)
	...
	var_210_4[3] = var_6.GetAnchorEulerAngles(var_210_5)
...
function var_0_1.OpMoveCamera(arg_212_0, arg_212_1, arg_212_2, arg_212_3)
	...
	if arg_212_1 > 0 then
		var_212_2 = var_0_2.wsMap.map

		local var_212_3 = var_5.FindAttachments

		WorldMapAttachment = var_1_10007

		local var_212_4 = var_212_3(var_212_2, var_1_10007.TypeEvent, arg_212_1)

		ipairs = var_212_2

		for iter_212_0, iter_212_1 in var_212_2(var_212_4) do
			table = var_1_10011
		...
		var_212_2 = var_0_2.wsMap

		local var_212_5 = var_5.GetFleet(var_212_2)

		table = var_212_2

		var_212_2.insert(var_212_1, {
			focusPos = function()
				return var_212_5.transform.position
			end,
			row = var_212_5.fleet.row,
			column = var_212_5.fleet.column
		})
	end
	...
	for iter_212_2, iter_212_3 in var_212_2(var_212_1) do
		table = var_1_10011

		var_1_10011.insert(var_212_6, function(arg_215_0)
		...
		var_1_10011.insert(var_212_6, function(arg_216_0)
			...
			var_216_1(var_216_0, var_216_2, var_216_3, var_2_10005.easeInOutSine, arg_216_0)
		...
		var_1_10011.insert(var_212_6, function(arg_217_0)
...
function var_0_1.OpMoveCameraTarget(arg_219_0, arg_219_1, arg_219_2, arg_219_3)
	...
	if not arg_219_1 then
		var_219_0 = var_0_2.wsMap

		local var_219_1 = var_4.GetFleet(var_219_0)

		arg_219_1 = {
			row = var_219_1.fleet.row,
			column = var_219_1.fleet.column
		}
	end
	...
	var_219_0.insert(var_219_2, function(arg_220_0)
	...
	var_5.insert(var_219_2, function(arg_221_0)
		local var_221_0 = var_0_2.wsDragProxy
		local var_221_1 = var_1.Focus
		local var_221_2 = var_0_2.wsMap
		local var_221_3 = var_3.GetCell(var_221_2, arg_219_1.row, arg_219_1.column).transform.position
		local var_221_4

		LeanTweenType = var_5

		var_221_1(var_221_0, var_221_3, var_221_4, var_5.easeInOutSine, arg_221_0)
	...
	var_5.insert(var_219_2, function(arg_222_0)
...
function var_0_1.OpFlash(arg_232_0, arg_232_1, arg_232_2, arg_232_3, arg_232_4, arg_232_5)
	...
	var_232_0(var_232_1, true)

	setImageColor = var_232_0

	var_232_0(var_232_1, arg_232_4)

	setImageAlpha = var_232_0

	var_232_0(var_232_1, 0)
	...
	var_232_3(var_232_2, var_9.alpha(var_232_1, arg_232_4.a, arg_232_1).uniqueId)
	...
	local var_232_6 = var_9.alpha(var_232_1, 0, arg_232_3)
	local var_232_7 = var_9.setDelay(var_232_6, arg_232_1 + arg_232_2)
	local var_232_8 = var_9.setOnComplete

	System = var_11

	var_232_5(var_232_4, var_232_8(var_232_7, var_11.Action(function()
...
function var_0_1.OpReqBox(arg_234_0, arg_234_1, arg_234_2)
	...
	if arg_234_2 then
		...
		var_1_10004 = arg_234_2.type
		WorldMapAttachment = var_1_10005
		var_1_10004 = var_1_10004 == var_1_10005.TypeBox
	end
	...
	local var_234_2 = var_1_10005.OnMapOp
	local var_234_3 = var_0_2
	local var_234_4 = var_6.NewMapOp
	local var_234_5 = {}

	WorldConst = var_1_10009
	var_234_5.op = var_1_10009.OpReqBox
...
function var_0_1.OpRedeploy(arg_253_0)
	...
	local var_253_0 = var_1()
	local var_253_1 = var_1.GetActiveMap(var_253_0)

	underscore = var_253_0

	if var_253_0.any(var_253_1:GetNormalFleets(), function(arg_254_0)
		return #arg_254_0:GetCarries() > 0
	end) then
		pg = var_3

		local var_253_2 = var_3.TipsMgr.GetInstance()
		local var_253_3 = var_3.ShowTips

		i18n = var_5

		var_253_3(var_253_2, var_5("world_instruction_redeploy_3"))
	...
	if var_253_1:CheckFleetSalvage(true) then
		...
		local var_253_4 = var_3.MsgboxMgr.GetInstance()
		local var_253_5 = var_3.ShowMsgBox
		local var_253_6 = {}

		i18n = var_1_10006
		var_253_6.content = var_1_10006("world_catsearch_fleetcheck")

		function var_253_6.onYes()
		...
		var_253_5(var_253_4, var_253_6)
	else
		local var_253_7, var_253_8 = var_1:BuildFormationIds()
		local var_253_9 = arg_253_0
		local var_253_10 = arg_253_0.OpOpenScene

		SCENE = var_1_10007

		var_253_10(var_253_9, var_1_10007.WORLD_FLEET_SELECT, {
			type = var_253_7,
			fleets = var_253_8
		})
	end
...
function var_0_1.OpKillWorld(arg_256_0)
	...
	local var_256_0 = var_1_10001(var_1_10002)
	local var_256_1 = var_1.getContextByMediator

	WorldMediator = var_1_10003
	var_256_1(var_256_0, var_1_10003).onRemoved = function()
		pg = var_2_10000
		...
		var_257_1(var_257_0, var_2_10002.WORLD_KILL)
...
function var_0_1.OpReqMaintenance(arg_259_0, arg_259_1)
	...
	local var_259_2 = var_1_10004.OnMapOp
	local var_259_3 = var_0_2
	local var_259_4 = var_5.NewMapOp
	local var_259_5 = {}

	WorldConst = var_1_10008
	var_259_5.op = var_1_10008.OpReqMaintenance
...
function var_0_1.OpReqMaintenanceDone(arg_260_0, arg_260_1)
	...
	local var_260_0 = var_2()
	local var_260_1 = var_2.GetFleets(var_260_0)

	_ = var_260_0

	var_260_0.each(var_260_1, function(arg_261_0)
	...
	local var_260_2 = var_2
	local var_260_3 = var_2.CalcOrderCost

	WorldConst = var_6

	local var_260_4 = var_260_3(var_260_2, var_6.OpReqMaintenance)
	local var_260_5 = var_2.staminaMgr

	var_5.ConsumeStamina(var_260_5, var_260_4)

	local var_260_6 = var_2
	local var_260_7 = var_2.SetReqCDTime

	WorldConst = var_7

	local var_260_8 = var_7.OpReqMaintenance

	pg = var_1_10008

	local var_260_9 = var_1_10008.TimeMgr.GetInstance()

	var_260_7(var_260_6, var_260_8, var_8.GetServerTime(var_260_9))

	local var_260_10 = var_0_2.wsMap

	var_5.UpdateRangeVisible(var_260_10, false)
...
function var_0_1.OpReqVision(arg_263_0)
	...
	local var_263_2 = var_1_10003.OnMapOp
	local var_263_3 = var_0_2
	local var_263_4 = var_4.NewMapOp
	local var_263_5 = {}

	WorldConst = var_1_10007
	var_263_5.op = var_1_10007.OpReqVision
...
function var_0_1.OpReqVisionDone(arg_264_0, arg_264_1)
	...
	local var_264_2 = var_264_1(var_264_0, var_1_10005.OpReqVision)
	...
	local var_264_6 = var_6.OpReqVision

	pg = var_1_10007

	local var_264_7 = var_1_10007.TimeMgr.GetInstance()

	var_264_5(var_264_4, var_264_6, var_7.GetServerTime(var_264_7))
...
function var_0_1.OpReqPressingMap(arg_265_0)
	...
	local var_265_5 = var_1_10005.OnMapOp
	local var_265_6 = var_0_2
	local var_265_7 = var_6.NewMapOp
	local var_265_8 = {}

	WorldConst = var_1_10009
	var_265_8.op = var_1_10009.OpReqPressingMap
...
function var_0_1.OpReqPressingMapDone(arg_266_0, arg_266_1, arg_266_2)
	...
	local var_266_4 = var_5

	if var_5.GetPressingAward(var_266_4, var_266_1) and var_6.flag then
		pg = var_266_4

		if #var_266_4.world_event_complete[var_6.id].event_reward_slgbuff > 1 then
			local var_266_5 = {
				id = var_8[1],
				floor = var_8[2]
			}
			local var_266_6 = var_5:GetGlobalBuff(var_8[1])

			var_266_5.before = var_10.GetFloor(var_266_6)

			if var_5.isAutoFight then
				var_5:AddAutoInfo("buffs", var_266_5)
			else
				table = var_10
	...
	seriesAsync = var_266_4

	var_266_4(var_266_0, function()
...
function var_0_1.OpReqEnterPort(arg_271_0)
	...
	if var_2.IsOpen(var_271_2, var_1:GetRealm(), var_1:GetProgress()) then
		...
		local var_271_5 = var_5.OnMapOp
		local var_271_6 = var_0_2
		local var_271_7 = var_6.NewMapOp
		local var_271_8 = {}

		WorldConst = var_1_10009
		var_271_8.op = var_1_10009.OpReqEnterPort
...
function var_0_1.OpReqCatSalvage(arg_273_0, arg_273_1)
	...
	local var_273_4 = var_1_10004.OnMapOp
	local var_273_5 = var_0_2
	local var_273_6 = var_5.NewMapOp
	local var_273_7 = {}

	WorldConst = var_1_10008
	var_273_7.op = var_1_10008.OpReqCatSalvage
...
function var_0_1.OpReqCatSalvageDone(arg_274_0, arg_274_1, arg_274_2)
	...
	if var_1_10004().isAutoFight then
		...
		var_5.insert(var_274_0, 1, function(arg_275_0)
			...
			var_275_5(var_275_4, var_2_10004.gameset.world_catsearch_completed.description[var_275_3], arg_275_0, true)
...
function var_0_1.OpReqSkipBattle(arg_277_0, arg_277_1)
	...
	local var_277_2 = var_1_10004.OnMapOp
	local var_277_3 = var_0_2
	local var_277_4 = var_5.NewMapOp
	local var_277_5 = {}

	WorldConst = var_1_10008
	var_277_5.op = var_1_10008.OpReqSkipBattle
...
function var_0_1.OpTaskGoto(arg_281_0, arg_281_1)
	...
	elseif var_2:GetActiveEntrance().id ~= var_3:GetFollowingEntrance() then
		...
		var_6.QueryTransport(var_281_6, function()
			...
			var_282_2.entrance = var_3.GetEntrance(var_282_3, var_281_3)
		...
		if 0 < var_281_10 then
			...
			if not var_281_10.any(var_281_8, function(arg_283_0)
				...
				pg = var_7
				var_281_11 = var_7.TipsMgr.GetInstance()

				local var_281_12 = var_7.ShowTips

				i18n = var_1_10009

				var_281_12(var_281_11, var_1_10009("world_task_goto0"))
		...
		elseif var_281_7[1] == 1 then
			...
			for iter_281_0, iter_281_1 in var_281_11(var_281_7[2]) do
				assert = var_1_10013
				pg = var_1_10014

				var_1_10013(var_1_10014.world_effect_data[iter_281_1], "without effect: " .. iter_281_1)
				...
				var_1_10013.insert(var_281_13, function(arg_284_0)
					...
					WorldConst = var_2_10004
					var_284_2.op = var_2_10004.OpActionTaskGoto
					pg = var_4
					var_284_2.effect = var_4.world_effect_data[iter_281_1]
		...
		elseif var_281_7[1] == 2 then
			...
			local var_281_14 = var_7(var_2.GetActiveMap(var_1_10009), {
				"GetPort"
			})

			var_1_10009 = var_2

			local var_281_15 = var_2.GetRealm(var_1_10009)

			checkExist = var_1_10009

			if var_281_15 == var_1_10009(var_281_14, {
				"GetRealm"
			}) then
				checkExist = var_1_10009

				if var_1_10009(var_281_14, {
					"IsOpen",
					{
						var_281_15,
						var_2:GetProgress()
			...
			local var_281_16 = var_1_10009.TipsMgr.GetInstance()

			var_1_10009 = var_1_10009.ShowTips
			i18n = var_11

			var_1_10009(var_281_16, var_11("world_instruction_redeploy_1"))
			...
			if var_281_7[1] == 3 then
				...
				local var_281_17 = var_281_18.TipsMgr.GetInstance()

				var_281_18 = var_281_18.ShowTips
				i18n = var_1_10009

				var_281_18(var_281_17, var_1_10009("world_task_goto3"))

				return
			else
				assert = var_281_18

				var_281_18(false, "goto info error:" .. var_281_7[1])
...
function var_0_1.OpAutoSubmitTask(arg_287_0, arg_287_1)
	...
	var_287_1(var_287_0, var_1_10004.OnAutoSubmitTask, arg_287_1)
...
function var_0_1.OpAutoFightSeach(arg_291_0)
	...
	for iter_291_0, iter_291_1 in var_1_10007(var_291_3) do
		var_1_10013 = var_2
		var_1_10013 = var_2.GetCell(var_1_10013, iter_291_1.row, iter_291_1.column)
		var_1_10013 = var_1_10012.GetEventAttachment(var_1_10013) and var_1_10012:GetEventAutoPri()

		if var_1_10013 and var_291_5 < var_1_10013 and var_2:CheckEventAutoTrigger(var_1_10012) then
	...
	elseif var_291_2:IsCatSalvage() then
		...
		if var_1.isAutoSwitch then
			...
			local var_291_12 = var_291_11(var_291_10, var_1_10012.TypeEvent)
			...
			local function var_291_13(arg_292_0)
				...
				do
					...
					for iter_292_0, iter_292_1 in var_2_10002(var_2_10003.gameset[arg_292_0[2]].description) do
			...
			switch = var_12
			PlayerPrefs = var_1_10013

			local var_291_14 = var_1_10013.GetInt("auto_switch_mode", 0)
			local var_291_15 = {}

			WorldSwitchPlanningLayer = var_15
			var_291_15[var_15.MODE_DIFFICULT] = function()
				local var_294_0
			...
			WorldSwitchPlanningLayer = var_15
			var_291_15[var_15.MODE_SAFE] = function()
				...
				if var_2_10000.GetString("auto_switch_difficult_safe", "only") == "only" then
					...
					if var_296_0(var_1.GetActiveEntrance(var_296_1), var_0) ~= "base_chapter" then
						var_296_2 = false
					else
						var_296_2 = true
					end
			...
			WorldSwitchPlanningLayer = var_15
			var_291_15[var_15.MODE_TREASURE] = function()
				World = var_2_10000
				...
				if not (var_298_0(var_1.GetActiveEntrance(var_298_1), var_0) ~= "teasure_chapter") then
					::label_298_0::

					underscore = var_298_2
					var_298_2 = not var_298_2.any({
						"event_1",
						"event_3"
					}, function(arg_299_0)
		...
		var_291_9(var_291_7, function()
			...
			var_301_1(var_301_0, var_2_10002("autofight_tip_bigworld_suspend"))
...
function var_0_1.OpAutoSwitchMap(arg_302_0, arg_302_1)
	...
	local var_302_7 = var_1_10010.GetInt("auto_switch_mode", 0)
	local var_302_8 = {}

	WorldSwitchPlanningLayer = var_12
	var_302_8[var_12.MODE_DIFFICULT] = function()
		...
		local var_303_1 = var_1.sort
		local var_303_2 = var_303_0

		CompareFuncs = var_2_10003

		var_303_1(var_303_2, var_2_10003({
			function(arg_304_0)
	...
	WorldSwitchPlanningLayer = var_12
	var_302_8[var_12.MODE_SAFE] = function()
		PlayerPrefs = var_2_10000
		...
		var_1(var_306_0, {
			all = function()
				...
				for iter_307_0, iter_307_1 in var_3_10002(var_302_1.entranceDic) do
				...
				local var_307_5 = #var_307_2

				if 0 < var_307_5 then
					unpack = var_307_5
					math = var_3

					local var_307_6 = var_3.floor

					math = var_4
					var_302_6, var_302_5 = var_307_5(var_307_2[var_307_6(var_4.random() * #var_307_2) + 1])
				end
			...
			only = function()
				...
				var_3_10002(var_308_1 and var_308_2)
	...
	WorldSwitchPlanningLayer = var_12
	var_302_8[var_12.MODE_TREASURE] = function()
		World = var_2_10000
		...
		local var_309_2 = var_1.GetInventoryProxy(var_309_1)
		local var_309_3 = var_1.GetItemsByType

		WorldItem = var_2_10003

		local var_309_4 = var_309_0(var_309_3(var_309_2, var_2_10003.UsageWorldMap), function(arg_310_0)
			return arg_310_0.id
		end)

		underscore = var_1

		local var_309_5 = var_1.filter(var_309_4, function(arg_311_0)
			pg = var_3_10001
		...
		local var_309_6 = var_1.map(var_309_5, function(arg_312_0)
			...
			for iter_312_0, iter_312_1 in var_3(var_312_1.config.teasure_chapter) do
		...
		var_309_7(var_309_8, var_2_10004({
			function(arg_313_0)
		...
		for iter_309_0, iter_309_1 in var_3(var_309_6) do
			...
			var_2_10008, var_309_10 = var_2_10008(iter_309_1)

			if var_302_1.transportDic[var_309_10.id] and var_2_10008:IsMapOpen() then
				WorldSwitchPlanningLayer = var_10

				if var_10.checkDifficultValid(var_309_9, var_2_10008:GetDanger()) and not var_302_5 then
					var_302_5, var_302_6 = var_2_10008, var_309_10
	...
	elseif not var_302_5 then
		...
		var_302_10(var_302_9, var_11("world_automode_start_tip1"))
		...
		if not var_302_5.isCost then
			...
			if var_302_13.GetTotalStamina(var_302_11) < var_302_5.config.enter_cost then
				...
				var_302_13(var_302_12, var_11("world_automode_start_tip2"))
