...
function var_0_1.GetOilConsume(arg_9_0)
	...
	if not arg_9_0.IsSelf(var_9_0) then
		return 0
	end

	local var_9_1 = arg_9_0.fightCount + 1

	WorldBossConst = var_9_0

	return var_9_0.GetBossOilConsume(var_9_1)
end
...
function var_0_1.IsFullPeople(arg_13_0)
	...
	local var_13_1 = arg_13_0.GetRankCnt(var_13_0)

	pg = var_13_0

	return var_13_1 >= var_13_0.gameset.joint_boss_fighter_max.key_value
end
...
function var_0_1.SetBossType(arg_19_0)
	...
	local var_19_2 = var_19_0(var_1_10003)

	getProxy = var_1_10003
	GuildProxy = var_1_10004

	local var_19_3 = var_1_10003(var_1_10004)
