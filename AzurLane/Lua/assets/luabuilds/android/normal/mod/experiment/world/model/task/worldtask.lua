...
function var_0_0.Ctor(arg_2_0, arg_2_1)
	...
	if var_2_6 == var_4.TaskTypeSubmitItem then
		...
		var_2_8(var_2_7, var_5.GetItemCount(var_2_9, arg_2_0.config.complete_parameter[1]))
	else
		local var_2_10 = arg_2_0.config.complete_condition

		WorldConst = var_2_7

		if var_2_10 == var_2_7.TaskTypePressingMap then
...
function var_0_0.canSubmit(arg_12_0)
	if arg_12_0:getState() ~= var_0_0.STATE_FINISHED then
		...
		local var_12_1 = var_1_10003("this task is not finish or is finished")
...
function var_0_0.canTrigger(arg_23_0)
	...
	if var_3.getTaskById(var_23_2, arg_23_0) then
		local var_23_3 = false

		i18n = var_23_2

		local var_23_4 = var_23_2("world_sametask_tip")
	...
	elseif var_23_0:GetLevel() < var_23_1.config.need_level then
		...
		local var_23_6 = var_5("舰队总等级需达到（缺gametip）" .. var_23_1.config.need_level)
	...
	elseif var_3.taskFinishCount < var_23_1.config.need_task_complete then
		...
		local var_23_8 = var_5("任务完成数需达到（缺gametip）" .. var_23_1.config.need_task_complete)
