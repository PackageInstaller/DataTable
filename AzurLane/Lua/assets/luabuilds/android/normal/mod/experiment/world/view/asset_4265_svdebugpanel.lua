...
function var_0_1.OnInit(arg_3_0)
	...
	arg_3_0.scrollRect = var_3_2(var_3_1, var_4(var_1_10005))
	...
	local var_3_4 = var_1:Find("panel/buttons")
	local var_3_5 = var_2.Find(var_3_4, "button")
	...
	local var_3_7 = {
		{
			...
			func = function()
				for iter_5_0 = arg_3_0.rtContent.childCount - 1, 0, -1 do
					...
					var_2_10004(var_5.GetChild(var_5_0, iter_5_0))
				end
		...
		},
		{
			...
			func = function()
				...
				for iter_6_0, iter_6_1 in var_6_1(var_2.pools) do
					table = var_2_10006
		...
		},
		{
			...
			func = function()
				...
				local var_7_4 = var_3_6

				var_7_3(var_7_2, var_2(var_3.GetProgress(var_7_4)))
		...
		},
		{
			...
			func = function()
				...
				if var_0.GetActiveMap(var_9_2) then
					...
					local var_9_5 = var_9_4(var_9_3, var_2_10003.TypeEvent)

					_ = var_9_3

					var_9_3.each(var_9_5, function(arg_10_0)
		...
		},
		{
			...
			func = function()
				...
				if var_0.GetActiveMap(var_11_2) then
					...
					local var_11_5 = var_11_4(var_11_3, var_2_10003.TypeEvent)

					_ = var_11_3

					var_11_3.each(var_11_5, function(arg_12_0)
		...
		},
		{
			...
			func = function()
				...
				if var_0.GetActiveMap(var_13_2) then
					...
					local var_13_5 = var_13_4(var_13_3, var_2_10003.TypeEvent)

					_ = var_13_3

					var_13_3.each(var_13_5, function(arg_14_0)
		...
		},
		{
			...
			func = function()
				...
				local var_15_3 = var_3_6

				var_15_2(var_1.GetFleets(var_15_3), function(arg_16_0)
		...
		},
		{
			...
			func = function()
				...
				local var_17_2 = var_3_6

				if var_0.GetActiveMap(var_17_2) then
					local var_17_3 = var_0
					local var_17_4 = var_0.FindEnemys(var_17_3)

					_ = var_17_3

					var_17_3.each(var_17_4, function(arg_18_0)
				...
				local var_17_5 = arg_3_0

				var_1.AppendText(var_17_5, "-------------------------------------------------------------------------")
		...
		},
		{
			...
			func = function()
				...
				if var_0.GetActiveMap(var_19_2) then
					...
					local var_19_5 = var_19_4(var_19_3, var_2_10003.TypeTrap)

					_ = var_19_3

					var_19_3.each(var_19_5, function(arg_20_0)
		...
		},
		{
			...
			func = function()
				...
				if var_0.GetActiveMap(var_21_2) then
					...
					local var_21_5 = var_21_4(var_21_3, var_2_10003.TypeArtifact)

					_ = var_21_3

					var_21_3.each(var_21_5, function(arg_22_0)
	...
	local var_3_8 = var_6.New(var_2, var_3_5)

	var_6.make(var_3_8, function(arg_24_0, arg_24_1, arg_24_2)
		arg_24_1 = arg_24_1 + 1
		...
		if arg_24_0 == var_2_10003.EventUpdate then
			...
			var_3(arg_24_2:Find("Text"), var_3_7[arg_24_1].name)

			onButton = var_3

			var_3(arg_3_0, arg_24_2, var_3_7[arg_24_1].func)
		end
...
function var_0_1.OnClickRichText(arg_29_0, arg_29_1, arg_29_2)
	if arg_29_1 == "ShipProperty" then
		...
		local var_29_1 = var_4()
		local var_29_2 = var_4.GetShipVO(var_29_1, var_29_0)

		assert = var_29_1

		var_29_1(var_29_2, "ship not exist: " .. var_29_0)
		arg_29_0:AppendText("-------------------------------------------------------------------------")
		...
		var_29_4(var_29_3, var_7.format("[%s] [id: %s] [config_id: %s]", var_29_2:getName(), var_29_2.id, var_29_2.configId))
		...
		local var_29_37 = var_29_2.getProperties(var_29_36)

		ipairs = var_29_36

		for iter_29_0, iter_29_1 in var_29_36(var_29_5) do
			local var_29_38
			local var_29_39 = iter_29_1[1]

			AttributeType = var_1_10014

			if var_29_39 == var_1_10014.Armor then
				var_1_10014 = var_29_2
				var_29_38 = var_29_2.getShipArmorName(var_1_10014)
			else
				var_29_38 = var_29_37[iter_29_1[1]]
			end
			...
			if var_29_38 then
				...
				var_29_40(var_1_10014, var_1_10015.format("\t\t%s[%s] : <color=#A9F548>%s</color>", iter_29_1[1], iter_29_1[2], var_29_38))
			end
		end
