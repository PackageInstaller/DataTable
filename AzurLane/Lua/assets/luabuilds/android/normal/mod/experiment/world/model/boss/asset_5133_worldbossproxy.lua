...
function var_0_1.Setup(arg_1_0, arg_1_1)
	local var_1_0 = arg_1_0:GetMaxPt()
	local var_1_1
	...
	if arg_1_1.self_boss then
		...
		var_1_2:Setup(arg_1_1.self_boss, var_1_4)

		if var_1_2:Active() then
			arg_1_0.boss = var_1_2
		end
	end
	...
	arg_1_0.summonPtDailyAcc = var_1_7
	...
	arg_1_0.summonPtOldDailyAcc = var_1_8
	...
	arg_1_0.autoFightFinishTime = var_1_9
	...
	arg_1_0.highestDamage = var_1_12
	...
	arg_1_0.friendSupport = var_1_14
	...
	arg_1_0.currentBossLV = var_1_16
	arg_1_0.cacheBosses = {}
	arg_1_0.ranks = {}
	arg_1_0.timers = {}
	arg_1_0.fleet = nil
...
function var_0_1.AddSummonPt(arg_24_0, arg_24_1)
	...
	math = var_7
	arg_24_0.summonPtDailyAcc = var_7.min(arg_24_0.summonPtDailyAcc + var_24_4, var_24_1)
...
function var_0_1.AddSummonPtOld(arg_29_0, arg_29_1)
	...
	math = var_7
	arg_29_0.summonPtOldDailyAcc = var_7.min(arg_29_0.summonPtOldDailyAcc + var_29_4, var_29_1)
...
function var_0_1.BossId2FleetKey(arg_35_0, arg_35_1)
	...
	if arg_35_0.GetBossById(var_35_0, arg_35_1) then
		WorldBossConst = var_35_0

		if not var_35_0._IsCurrBoss(var_2) then
...
function var_0_1.GenFleet(arg_36_0)
	...
	local var_36_2 = var_36_0.New
	local var_36_3 = {
		id = 1
	}

	i18n = var_1_10004
	var_36_3.name = var_1_10004("world_boss_fleet")
	var_36_3.ship_list = var_36_1
	FleetType = var_4
	var_36_3.fleetType = var_4.Normal
	arg_36_0.fleet = var_36_2(var_36_3)

	local var_36_4 = arg_36_0
	local var_36_5 = arg_36_0.GetCacheShips(var_36_4, var_0_3)
	...
	i18n = var_5
	var_36_7.name = var_5("world_boss_fleet")
	var_36_7.ship_list = var_36_5
	FleetType = var_5
	var_36_7.fleetType = var_5.Normal
	arg_36_0.fleetForArchives = var_36_6(var_36_7)
...
function var_0_1.GetCacheShips(arg_37_0, arg_37_1)
	local function var_37_0(arg_38_0, arg_38_1)
		...
		local var_38_1 = arg_38_0.getTeamType(var_38_0)

		TeamType = var_38_0

		if var_38_0.GetTeamShipMax(var_38_1) < arg_38_1 + 1 then
			return true
		end
	...
	local var_37_3 = var_1_10005(var_1_10006)
	local var_37_4 = var_37_1(var_37_2 .. var_5.getRawData(var_37_3).id)

	string = var_4

	local var_37_5 = var_4.split(var_37_4, "|")
	local var_37_6 = {}
	local var_37_7 = {}

	TeamType = var_1_10007
	var_37_7[var_1_10007.Vanguard] = 0
	TeamType = var_7
	...
	if var_37_5 and #var_37_5 > 0 and (#var_37_5 ~= 1 or var_37_5[1] ~= "") then
		...
		for iter_37_0, iter_37_1 in var_7(var_37_5) do
			...
			var_1_10014 = var_13(var_1_10014)

			if var_13.getShipById(var_1_10014, var_1_10012) then
				var_1_10014 = var_13:getTeamType()

				if not var_37_0(var_13, var_37_7[var_1_10014]) then
					var_37_7[var_1_10014] = var_37_7[var_1_10014] + 1
					table = var_15

					var_15.insert(var_37_6, var_1_10012)
				end
			end
		end
	end
...
function var_0_1.GetFleet(arg_39_0, arg_39_1)
	...
	if not var_39_1 then
		...
		i18n = var_1_10006
		var_39_3.name = var_1_10006("world_boss_fleet")
		var_39_3.ship_list = {}
		FleetType = var_6
		var_39_3.fleetType = var_6.Normal
	...
	for iter_39_0 = #var_39_1.ships, 1, -1 do
		...
		if not var_1_10009.getShipById(var_1_10010, var_39_4) then
			var_1_10010 = var_39_1

			var_39_1.removeShipById(var_1_10010, var_39_4)
		end
	end
...
function var_0_1.SavaCacheShips(arg_41_0, arg_41_1, arg_41_2)
	...
	for iter_41_0, iter_41_1 in var_1_10006(var_41_1) do
		var_41_2 = var_41_2 .. iter_41_1 .. "|"
	end

	PlayerPrefs = var_6

	local var_41_3 = var_6.SetString
	local var_41_4 = var_41_0

	getProxy = var_8
	PlayerProxy = iter_41_0

	local var_41_5 = var_8(iter_41_0)

	var_41_3(var_41_4 .. var_8.getRawData(var_41_5).id, var_41_2)
...
function var_0_1.ClearCacheShips(arg_42_0, arg_42_1)
	...
	local var_42_1 = arg_42_0.BossId2FleetKey(var_42_0, arg_42_1)

	PlayerPrefs = var_42_0

	local var_42_2 = var_42_0.DeleteKey
	local var_42_3 = var_42_1

	getProxy = var_1_10005
	PlayerProxy = var_1_10006

	local var_42_4 = var_1_10005(var_1_10006)

	var_42_2(var_42_3 .. var_5.getRawData(var_42_4).id)

	PlayerPrefs = var_42_2
...
function var_0_1.increasePt(arg_65_0)
	...
	local var_65_1 = arg_65_0.GetMaxPt(var_65_0)

	math = var_65_0

	local var_65_2 = var_65_0.min
	local var_65_3 = var_65_1
	local var_65_4 = arg_65_0.pt

	pg = var_1_10005
	arg_65_0.pt = var_65_2(var_65_3, var_65_4 + var_1_10005.gameset.joint_boss_ap_recove_cnt_pre_day.key_value)
...
function var_0_1.addTimer(arg_69_0, arg_69_1)
	...
	if arg_69_0.timers[arg_69_1] then
		var_1_10003 = arg_69_0.timers[arg_69_1]
	...
	local var_69_0 = arg_69_0.timers

	Timer = var_1_10003
	var_69_0[arg_69_1] = var_1_10003.New(function()
	...
	local var_69_1 = arg_69_0.timers[arg_69_1]
...
function var_0_1.UpdatedUnlockProgress(arg_80_0, arg_80_1, arg_80_2)
	if not (arg_80_2 <= arg_80_1) then
		...
		if not var_1_10003(var_80_0, var_1_10005.SystemWorldBoss) then
			...
			if not var_80_2 then
				...
				local var_80_3 = var_5(var_1_10006)
...
function var_0_1.IsNeedSupport()
	...
	WorldBossConst = var_88_3

	if not var_88_3._IsCurrBoss(var_2) then
		return
	end
