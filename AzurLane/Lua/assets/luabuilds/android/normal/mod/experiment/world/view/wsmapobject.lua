...
function var_0_1.PlayModelAction(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	if arg_10_0.model then
		...
		if var_10_1 == var_1_10006.ModelSpine then
			if arg_10_0.modelComps[1] then
				...
				if var_6(var_10_2, var_1_10008) and var_10_1:GetModel().transform.gameObject.activeInHierarchy then
					table = var_6
			...
			if var_10_1 then
				...
				SpineRole = var_1_10008

				if var_6(var_10_3, var_1_10008) and var_10_1:GetRootModel().transform.gameObject.activeInHierarchy then
					table = var_6
	...
	if arg_23_0.model then
		...
		if 0 < var_23_0 then
			...
			if var_23_0 == var_2.ModelSpine then
				...
				arg_23_0.UnloadSpine(var_23_1)
			else
				var_23_0 = arg_23_0.modelType
				WorldConst = var_23_1

				if var_23_0 == var_23_1.ModelPrefab then
...
function var_0_1.LoadSpine(arg_24_0, arg_24_1)
	...
	var_4:Load(var_24_1, function(arg_25_0)
		...
		var_25_2(var_25_1, var_2_10003.zero)
...
function var_0_1.LoadPrefab(arg_26_0, arg_26_1)
	...
	var_5.GetPrefab(var_26_3, var_26_0, var_26_1, var_26_2, function(arg_27_0)
		...
		local var_27_4 = var_27_3(var_27_2, var_2_10003(var_2_10004))
		local var_27_5 = var_1.ToTable(var_27_4)

		ipairs = var_27_4

		for iter_27_0, iter_27_1 in var_27_4(var_27_5) do
		...
		if var_27_8(var_27_7, var_4(var_5)) then
...
function var_0_1.UnloadSpine(arg_28_0)
	if arg_28_0.modelComps[1] then
		...
		if var_1_10002(var_28_0, var_1_10004) then
...
function var_0_1.UnloadPrefab(arg_29_0)
	...
	var_29_1(var_29_0, var_29_2, var_29_3, var_6.GetChild(var_29_4, 0).gameObject, true)
