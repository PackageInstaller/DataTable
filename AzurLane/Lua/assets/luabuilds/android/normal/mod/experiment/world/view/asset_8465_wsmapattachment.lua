...
function var_0_1.GetResName(arg_1_0)
	...
	if var_1_0 == var_1_10002.TypeEvent then
		...
		if arg_1_0.GetReplaceDisplayEnemyConfig(var_1_1) then
			return "enemy_tpl"
		else
			return "event_tpl"
		end
		...
		if var_1_2 == var_1_1.TypeBox then
			return "event_tpl"
		else
			WorldMapAttachment = var_1_2

			if var_1_2.IsEnemyType(arg_1_0.type) then
				return "enemy_tpl"
			else
				...
				if var_1_3 == var_2.TypePort then
					return "blank_tpl"
				else
					...
					if var_1_4 == var_2.TypeTransportFleet then
						return "transport_tpl"
					else
						local var_1_5 = arg_1_0.type

						WorldMapAttachment = var_2

						if var_1_5 == var_2.TypeTrap then
							return "event_tpl"
						else
							assert = var_1_5

							local var_1_6 = false
							local var_1_7 = "invalid attachment type: "

							tostring = var_1_10004

							var_1_5(var_1_6, var_1_7 .. var_1_10004(arg_1_0.type))
						end
					end
				end
			end
...
function var_0_1.Setup(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	var_2_3(var_2_2, var_6.EventUpdateMapBuff, arg_2_0.onUpdate)
...
function var_0_1.Dispose(arg_3_0)
	...
	var_3_1(var_3_0, var_1_10003.EventUpdateInFov, arg_3_0.onUpdate)
	...
	var_3_3(var_3_2, var_3.EventUpdateMapBuff, arg_3_0.onUpdate)
	...
	Vector3 = var_3_2
	var_3_4.localEulerAngles = var_3_2.zero
...
function var_0_1.Init(arg_4_0)
	...
	var_4_5(var_4_4, var_3.GetModelOrder(var_4_6), arg_4_0.cell.row)
	arg_4_0:Update()
...
function var_0_1.LoadAvatar(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
	...
	if arg_5_1 and #arg_5_1 > 0 then
		...
		var_1_10005.insert(var_5_0, function(arg_6_0)
			...
			var_6_1(var_6_0, var_2_10003.ModelSpine, arg_5_1, nil, true, function()
...
function var_0_1.LoadBoxPrefab(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if arg_8_1 and #arg_8_1 > 0 then
		...
		var_1_10005.insert(var_8_0, function(arg_9_0)
			...
			local var_9_2 = var_2_10003.ModelPrefab

			WorldConst = var_2_10004

			var_9_1(var_9_0, var_9_2, var_2_10004.ResBoxPrefab .. arg_8_1, arg_8_1, true, function()
...
function var_0_1.LoadChapterPrefab(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	if arg_11_1 and #arg_11_1 > 0 then
		...
		var_1_10005.insert(var_11_0, function(arg_12_0)
			...
			local var_12_2 = var_2_10003.ModelPrefab

			WorldConst = var_2_10004

			var_12_1(var_12_0, var_12_2, var_2_10004.ResChapterPrefab .. arg_11_1, arg_11_1, true, function()
...
function var_0_1.Update(arg_14_0, arg_14_1)
	...
	if var_14_0 == var_1_10004.TypeEvent then
		...
		if var_2.GetReplaceDisplayEnemyConfig(var_14_1) then
			var_14_1 = arg_14_0

			arg_14_0.UpdateEventEnemy(var_14_1, arg_14_1)
		else
			var_14_1 = arg_14_0

			arg_14_0.UpdateEvent(var_14_1, arg_14_1)
		end
	else
		local var_14_2 = var_2.type

		WorldMapAttachment = var_14_1

		local var_14_3

		if var_14_2 == var_14_1.TypeBox then
			var_14_3 = arg_14_0

			arg_14_0.UpdateBox(var_14_3, arg_14_1)
		else
			local var_14_4 = var_2.type

			WorldMapAttachment = var_14_3

			if var_14_4 == var_14_3.TypePort then
				arg_14_0:UpdatePort(arg_14_1)
			else
				WorldMapAttachment = var_14_4

				local var_14_5

				if var_14_4.IsEnemyType(var_2.type) then
					var_14_5 = arg_14_0

					arg_14_0.UpdateEnemy(var_14_5, arg_14_1)
				else
					local var_14_6 = var_2.type

					WorldMapAttachment = var_14_5

					local var_14_7

					if var_14_6 == var_14_5.TypeTransportFleet then
						var_14_7 = arg_14_0

						arg_14_0.UpdateTransportFleet(var_14_7, arg_14_1)
					else
						local var_14_8 = var_2.type

						WorldMapAttachment = var_14_7

						if var_14_8 == var_14_7.TypeTrap then
							arg_14_0:UpdateTrap(arg_14_1)
						else
							assert = var_14_8

							var_14_8(false, "invalid attachment type: " .. var_2.type)
						end
					end
				end
			end
	...
	local var_14_10 = arg_14_0.UpdateModelAngles
	local var_14_11 = arg_14_0.attachment

	if var_5.GetMillor(var_14_11) then
		Vector3 = var_14_12

		local var_14_12

		if not var_14_12(0, 180, 0) then
			Vector3 = var_14_12
			var_14_12 = var_14_12.zero
		end

		var_14_10(var_14_9, var_14_12)

		local var_14_13 = arg_14_0
		local var_14_14 = arg_14_0.UpdateModelScale
		local var_14_15 = arg_14_0.attachment

		var_14_14(var_14_13, var_5.GetScale(var_14_15))
...
function var_0_1.UpdateEvent(arg_15_0, arg_15_1)
	...
	local var_15_5 = var_15_0.CheckDisplay(var_15_4, var_15_2)

	setActive = var_15_4

	var_15_4(var_15_3, var_15_5)

	if var_15_5 then
		local var_15_6 = var_15_2:IsAvatar()
		...
		if arg_15_0.isInit then
			...
			if arg_15_1 == var_8.EventUpdateMapBuff then
				...
				local var_15_8 = arg_15_0.UpdateMapBuff
				local var_15_9 = var_15_3
				local var_15_10 = var_15_2:GetRadiationBuffs()
				local var_15_11 = var_15_0
				local var_15_12 = var_15_0.GetBuffList

				WorldMap = var_1_10014

				var_15_8(var_15_7, var_15_9, var_15_10, var_15_12(var_15_11, var_1_10014.FactionEnemy, var_15_2))
			end
		end
		...
		if not arg_15_0.isInit then
			...
			var_15_13 = var_15_2.config

			local var_15_14 = var_15_3:Find("char")
			local var_15_15 = var_15_3
			local var_15_16 = var_15_3.Find(var_15_15, "icon")

			setActive = var_15_15

			var_15_15(var_15_14, var_15_6)

			setActive = var_15_15

			var_15_15(var_15_16, not var_15_6)

			if var_15_6 then
				arg_15_0:LoadAvatar(var_15_13.icon, var_15_14:Find("ship"), function()
					if #var_15_13.icon > 0 then
						setAnchoredPosition = var_0

						local var_16_0 = arg_15_0.model
						local var_16_1 = var_15_2

						var_0(var_16_0, var_2.GetDeviation(var_16_1))
					end
				...
				if var_15_15.floor(var_15_13.enemyicon / 2) == 2 then
					arg_15_0:LoadChapterPrefab(var_15_13.icon, var_15_16, function()
						if #var_15_13.icon > 0 then
							setAnchoredPosition = var_0
							...
							var_0(var_17_0, var_2.GetDeviation(var_17_1))
						end
					...
					if var_11.floor(var_15_13.enemyicon / 2) == 0 then
						arg_15_0:LoadBoxPrefab(var_15_13.icon, var_15_16, function()
							if #var_15_13.icon > 0 then
								setAnchoredPosition = var_0
								...
								var_0(var_18_0, var_2.GetDeviation(var_18_1))
							end
			...
			local var_15_18 = arg_15_0.UpdateMapBuff
			local var_15_19 = var_15_3
			local var_15_20 = var_15_2:GetRadiationBuffs()
			local var_15_21 = var_15_0
			local var_15_22 = var_15_0.GetBuffList

			WorldMap = var_1_10017

			var_15_18(var_15_17, var_15_19, var_15_20, var_15_22(var_15_21, var_1_10017.FactionEnemy, var_15_2))
		end

		WorldMapAttachment = var_15_13

		if arg_15_1 == var_15_13.EventUpdateLurk and var_15_1:GetInFOV() and not var_15_2.lurk then
			setActive = var_8
			...
			arg_15_0.lurkTimer = var_8.New(function()
				...
				var_2_10000(var_1.Find(var_19_0, "effect_found"), false)

				return
			end, 3, 1)

			local var_15_23 = arg_15_0.lurkTimer

			var_8.Start(var_15_23)
		else
			setActive = var_8
...
function var_0_1.UpdateEventEnemy(arg_20_0, arg_20_1)
	...
	local var_20_5 = var_5:Find("dead")
	local var_20_6 = var_20_0
	local var_20_7 = var_20_0.CheckDisplay(var_20_6, var_20_2)

	setActive = var_20_6

	var_20_6(var_5, var_20_7)
	...
	if var_20_7 then
		...
		if arg_20_0.isInit then
			...
			if arg_20_1 == var_11.EventUpdateMapBuff then
				...
				var_20_11(var_20_10, var_20_12, var_20_13, var_20_15(var_20_14, var_1_10017.FactionEnemy, var_20_2))
			end
		end
		...
		if not arg_20_0.isInit then
			...
			local var_20_17 = var_20_4:Find("char")
			local var_20_18 = var_20_4
			local var_20_19 = var_20_4.Find(var_20_18, "icon")

			setActive = var_20_18

			var_20_18(var_20_17, var_20_9)

			setActive = var_20_18

			var_20_18(var_20_19, not var_20_9)

			if var_20_9 then
				arg_20_0:LoadAvatar(var_20_16.icon, var_20_17:Find("ship"))
			else
				GetImageSpriteFromAtlasAsync = var_20_18

				var_20_18("enemies/" .. var_20_16.icon, "", var_20_19:Find("pic"))

				WorldConst = var_20_18

				local var_20_20 = var_20_18.EnemySize[var_20_16.type]
				...
				if var_20_21 == var_16.Battle.BattleConst.Difficulty.WORLD then
					...
					local var_20_22 = var_20_19
					local var_20_23 = var_20_19.Find(var_20_22, "lv/Text")

					WorldConst = var_20_22

					var_20_21(var_20_23, var_20_22.WorldLevelCorrect(var_20_0.config.expedition_level, var_20_16.type))
				else
					setText = var_20_21
				...
				var_20_21("enemies/" .. var_20_16.icon .. "_d_blue", "", var_20_5:Find("icon"))
			end
			...
			local var_20_25 = arg_20_0.UpdateMapBuff
			local var_20_26 = var_20_4
			local var_20_27 = var_20_2:GetRadiationBuffs()
			local var_20_28 = var_20_0
			local var_20_29 = var_20_0.GetBuffList

			WorldMap = var_1_10020

			var_20_25(var_20_24, var_20_26, var_20_27, var_20_29(var_20_28, var_1_10020.FactionEnemy, var_20_2))
		end
		...
		if arg_20_1 == var_20_16.EventUpdateLurk and var_20_1:GetInFOV() and not var_20_2.lurk then
			...
			arg_20_0.lurkTimer = var_11.New(function()
				...
				var_2_10000(var_1.Find(var_21_0, "effect_found"), false)

				return
			end, 3, 1)

			local var_20_30 = arg_20_0.lurkTimer

			var_11.Start(var_20_30)
		else
			setActive = var_11
...
function var_0_1.UpdateBox(arg_22_0, arg_22_1)
	...
	local var_22_5 = var_22_0.CheckDisplay(var_22_4, var_22_2)
	...
	if var_22_5 then
		local var_22_6 = var_22_2:IsAvatar()

		if not arg_22_0.isInit then
			arg_22_0.isInit = true

			local var_22_7 = var_22_2.config
			local var_22_8 = var_22_3:Find("char")
			local var_22_9 = var_22_3
			local var_22_10 = var_22_3.Find(var_22_9, "icon")

			setActive = var_22_9

			var_22_9(var_22_8, var_22_6)

			setActive = var_22_9

			var_22_9(var_22_10, not var_22_6)

			setAnchoredPosition = var_22_9

			var_22_9(var_22_8, var_0_1.CharBasePos)

			setAnchoredPosition = var_22_9

			var_22_9(var_22_10, var_0_1.IconBasePos)

			if var_22_6 then
				arg_22_0:LoadAvatar(var_22_7.icon, var_22_8:Find("ship"))
			else
				arg_22_0:LoadBoxPrefab(var_22_7.icon, var_22_10)
			end
...
function var_0_1.UpdateEnemy(arg_23_0, arg_23_1)
	...
	local var_23_5 = var_5:Find("dead")
	local var_23_6 = var_23_0
	local var_23_7 = var_23_0.CheckDisplay(var_23_6, var_23_2)

	setActive = var_23_6

	var_23_6(var_5, var_23_7)
	...
	if var_23_7 then
		...
		if arg_23_0.isInit then
			...
			if arg_23_1 == var_11.EventUpdateMapBuff then
				...
				var_23_11(var_23_10, var_23_12, var_23_13, var_23_15(var_23_14, var_1_10017.FactionEnemy, var_23_2))
			end
		end
		...
		if not arg_23_0.isInit then
			...
			local var_23_17 = var_23_4:Find("char")
			local var_23_18 = var_23_4
			local var_23_19 = var_23_4.Find(var_23_18, "icon")

			setActive = var_23_18

			var_23_18(var_23_17, var_23_9)

			setActive = var_23_18

			var_23_18(var_23_19, not var_23_9)

			if var_23_9 then
				arg_23_0:LoadAvatar(var_23_16.icon, var_23_17:Find("ship"))
			else
				GetImageSpriteFromAtlasAsync = var_23_18

				var_23_18("enemies/" .. var_23_16.icon, "", var_23_19:Find("pic"))

				WorldConst = var_23_18

				local var_23_20 = var_23_18.EnemySize[var_23_16.type]
				...
				if var_23_21 == var_16.Battle.BattleConst.Difficulty.WORLD then
					...
					local var_23_22 = var_23_19
					local var_23_23 = var_23_19.Find(var_23_22, "lv/Text")

					WorldConst = var_23_22

					var_23_21(var_23_23, var_23_22.WorldLevelCorrect(var_23_0.config.expedition_level, var_23_16.type))
				else
					setText = var_23_21
				...
				var_23_21("enemies/" .. var_23_16.icon .. "_d_blue", "", var_23_5:Find("icon"))
			end
			...
			local var_23_25 = arg_23_0.UpdateMapBuff
			local var_23_26 = var_23_4
			local var_23_27 = var_23_2:GetRadiationBuffs()
			local var_23_28 = var_23_0
			local var_23_29 = var_23_0.GetBuffList

			WorldMap = var_1_10020

			var_23_25(var_23_24, var_23_26, var_23_27, var_23_29(var_23_28, var_1_10020.FactionEnemy, var_23_2))
		end
		...
		var_23_16(var_23_5, not var_23_9 and var_23_2.flag == 1)
...
function var_0_1.UpdateTransportFleet(arg_25_0, arg_25_1)
	...
	local var_25_5 = var_25_0.CheckDisplay(var_25_4, var_25_2)

	setActive = var_25_4

	var_25_4(var_25_3, var_25_5)

	if var_25_5 and not arg_25_0.isInit then
		arg_25_0.isInit = true

		local var_25_6 = var_25_2.config
		local var_25_7 = var_25_3
		local var_25_8 = var_25_3.Find(var_25_7, "ship/icon")

		GetImageSpriteFromAtlasAsync = var_25_7

		var_25_7("enemies/" .. var_25_6.icon, "", var_25_8)
	end
...
function var_0_1.UpdateTrap(arg_26_0, arg_26_1)
	...
	local var_26_5 = var_26_0.CheckDisplay(var_26_4, var_26_2)

	setActive = var_26_4

	var_26_4(var_26_3, var_26_5)

	if var_26_5 then
		local var_26_6 = var_26_2:IsAvatar()

		if not arg_26_0.isInit then
			arg_26_0.isInit = true

			local var_26_7 = var_26_2.config
			local var_26_8 = var_26_3:Find("char")
			local var_26_9 = var_26_3
			local var_26_10 = var_26_3.Find(var_26_9, "icon")

			setActive = var_26_9

			var_26_9(var_26_8, var_26_6)

			setActive = var_26_9

			var_26_9(var_26_10, not var_26_6)

			setAnchoredPosition = var_26_9

			var_26_9(var_26_8, var_0_1.CharBasePos)

			setAnchoredPosition = var_26_9

			var_26_9(var_26_10, var_0_1.IconBasePos)

			if var_26_6 then
				arg_26_0:LoadAvatar(var_26_7.trap_fx, var_26_8:Find("ship"))
			else
				arg_26_0:LoadBoxPrefab(var_26_7.trap_fx, var_26_10)
			end
...
function var_0_1.UpdateBuffList(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_1 = arg_27_1.Find(var_27_0, "buffs")

	setActive = var_27_0

	var_27_0(var_27_1, #arg_27_2 > 0)

	UIItemList = var_27_0

	local var_27_2 = var_27_0.New(var_27_1, var_27_1:GetChild(0))

	var_4.make(var_27_2, function(arg_28_0, arg_28_1, arg_28_2)
		arg_28_1 = arg_28_1 + 1
	...
	local var_27_4 = {}
	local var_27_5 = arg_27_0.modelType

	WorldConst = var_1_10009
	var_27_4.y = var_27_5 == var_1_10009.ModelSpine and 100 or 0

	var_5(var_27_3, var_27_4)
...
function var_0_1.UpdateMapBuff(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	...
	if #arg_29_2 > 0 then
		...
		var_1_10009(var_29_5 .. var_1_10011.world_SLGbuff_data[var_29_3].icon, "", var_29_0:Find("Image"))
	else
		var_29_2 = #arg_29_3
...
function var_0_1.UpdateBreathTween(arg_31_0)
	...
	if var_1.IsFloating(var_31_0) and var_1:IsAlive() then
		local var_31_1 = var_1

		if var_1.IsVisible(var_31_1) then
			if not arg_31_0.twBreathId then
				local var_31_2 = arg_31_0.transform

				Vector3 = var_31_1
				var_31_2.localPosition = var_31_1(0, 40, 0)
				LeanTween = var_31_2

				local var_31_3 = var_31_2.moveY(arg_31_0.transform, 50, 1)
				local var_31_4 = var_2.setEase

				LeanTweenType = var_4

				local var_31_5 = var_31_4(var_31_3, var_4.easeInOutSine)
				local var_31_6 = var_2.setLoopPingPong(var_31_5)

				var_31_6.passed = arg_31_0.twTimer.passed
				var_31_6.direction = arg_31_0.twTimer.direction
				arg_31_0.twBreathId = var_31_6.uniqueId
			end
	...
	if arg_31_0.twBreathId then
		...
		local var_31_7 = arg_31_0.transform

		Vector3 = var_3
		var_31_7.localPosition = var_3(0, 40, 0)
	end
...
function var_0_1.UpdateIsFighting(arg_32_0, arg_32_1)
	...
	var_1_10002(var_1_10003.IsEnemyType(arg_32_0.attachment.type))
...
function var_0_1.TrapAnimDisplay(arg_33_0, arg_33_1)
	...
	var_33_1.insert(var_33_0, function(arg_34_0)
	...
	var_4.insert(var_33_0, function(arg_36_0)
		...
		var_36_1(var_36_0, var_2_10003.zero)
