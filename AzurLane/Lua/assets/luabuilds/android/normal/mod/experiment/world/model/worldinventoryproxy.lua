...
function var_0_1.AddItem(arg_5_0, arg_5_1, arg_5_2)
	...
	if arg_5_0.GetItem(var_5_0, arg_5_1) then
		var_5_1.count = var_5_1.count + arg_5_2
	else
		WorldItem = var_5_0
		var_5_1 = var_5_0.New({
			id = arg_5_1,
		...
		arg_5_0.data[arg_5_1] = var_5_1
	end

	arg_5_0:DispatchEvent(var_0_1.EventUpdateItem, var_5_1:clone())
...
function var_0_1.RemoveItem(arg_6_0, arg_6_1, arg_6_2)
	...
	if arg_6_0.GetItem(var_6_0, arg_6_1) then
		arg_6_2 = arg_6_2 or var_3.count
		assert = var_6_0

		var_6_0(arg_6_2 <= var_3.count, "item count not enough: " .. var_3.id)
...
function var_0_1.CalcResetExchangeResource(arg_10_0)
	...
	for iter_10_0, iter_10_1 in var_1_10002(arg_10_0.data) do
		if ({
			...
			local var_10_1 = var_7.type
			local var_10_2

			if not var_10_0[var_7.type] then
				var_10_2 = {}
			end

			var_10_0[var_10_1] = var_10_2

			local var_10_3 = var_10_0[var_7.type]
			local var_10_4 = var_7.id

			defaultValue = var_10

			local var_10_5 = var_10(var_10_0[var_7.type][var_7.id], 0)

			math = var_11
			var_10_3[var_10_4] = var_10_5 + var_11.floor(iter_10_1.count / iter_10_1:getConfig("item_transform_num")) * var_7.count
		end
	end
