...
function var_0_1.Show(arg_6_0)
	...
	var_1_10001(var_6_0, var_1_10003.New(100, 0))

	setActive = var_1_10001

	local var_6_1 = arg_6_0.rtStar

	var_1_10001(var_2.Find(var_6_1, "SVAstar"), false)
...
function var_0_1.Hide(arg_7_0)
	...
	var_3.insert(var_7_2, function(arg_8_0)
		...
		var_2_10001(var_2.Find(var_8_0, "SVAstar"), true)
		...
		local var_8_2 = var_2(arg_7_0.rtStar)

		Vector3 = var_3

		local var_8_3 = var_8_1(var_8_2, var_3.New(var_7_1.x, var_7_1.y, 0), 0.5)
		local var_8_4 = var_1.setEase

		LeanTweenType = var_3

		local var_8_5 = var_8_4(var_8_3, var_3.easeInOutSine)
		local var_8_6 = var_1.setOnComplete

		System = var_3

		var_8_6(var_8_5, var_3.Action(arg_8_0))
