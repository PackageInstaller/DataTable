...
function var_0_1.Init(arg_3_0)
	...
	local var_3_5 = var_3.Find(var_3_4, "power/bg/Word")

	i18n = var_3_4

	var_2(var_3_5, var_3_4("world_total_power"))

	setText = var_2

	local var_3_6 = arg_3_0.rtWorldInfo
	local var_3_7 = var_3.Find(var_3_6, "explore/mileage/Text")

	i18n = var_3_6

	var_2(var_3_7, var_3_6("world_mileage"))

	setText = var_2

	local var_3_8 = arg_3_0.rtWorldInfo
	local var_3_9 = var_3.Find(var_3_8, "explore/pressing/Text")

	i18n = var_3_8

	var_2(var_3_9, var_3_8("world_pressing"))
	...
	local var_3_12 = var_4()
	local var_3_13 = var_4.IsSystemOpen

	WorldConst = var_1_10006

	var_2(var_3_11, var_3_13(var_3_12, var_1_10006.SystemWorldInfo))

	setText = var_2

	local var_3_14 = arg_3_0.rtDisplayIcon
	local var_3_15 = var_3.Find(var_3_14, "name")

	i18n = var_3_14

	var_2(var_3_15, var_3_14("world_map_title_tips"))
	...
	var_2(var_3_16, var_3_17, var_3_18, var_6)
