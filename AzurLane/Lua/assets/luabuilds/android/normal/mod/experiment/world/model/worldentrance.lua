...
function var_0_1.Setup(arg_2_0, arg_2_1, arg_2_2)
	...
	var_1_10003(var_1_10004.world_chapter_colormask[arg_2_1], "world_chapter_colormask.csv without this id:" .. arg_2_0.id)
...
function var_0_1.HasPort(arg_9_0, arg_9_1)
	...
	if 0 < var_9_0 then
		...
		if arg_9_1 then
			...
			local var_9_1 = var_3.world_port_data[var_9_0].port_camp

			nowWorld = var_1_10004

			local var_9_2 = var_1_10004()

			if var_9_1 ~= var_4.GetRealm(var_9_2) then
				var_9_3 = false
...
function var_0_1.UpdateSairenMark(arg_15_0, arg_15_1)
	...
	if var_15_0 ~= var_3(arg_15_1) then
