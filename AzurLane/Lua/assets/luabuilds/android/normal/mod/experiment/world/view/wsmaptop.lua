...
function var_0_1.Setup(arg_1_0)
	...
	var_1_1(var_1_0, var_1_10004.EventUpdateGlobalBuff, arg_1_0.onUpdateGlobalBuff)
	...
	var_1_3(var_1_2, var_4.EventUpdateActiveMap, arg_1_0.onUpdateFleetBuff)
...
function var_0_1.Dispose(arg_2_0)
	...
	var_2_1(var_2_0, var_1_10004.EventUpdateGlobalBuff, arg_2_0.onUpdateGlobalBuff)
	...
	var_2_3(var_2_2, var_4.EventUpdateActiveMap, arg_2_0.onUpdateFleetBuff)
...
local function var_0_2(arg_3_0, arg_3_1)
	if arg_3_1.config.icon and #arg_3_1.config.icon > 0 then
		...
		var_2("world/buff/" .. arg_3_1.config.icon, "", arg_3_0:Find("icon"))
	else
		clearImageSprite = var_2

		var_2(arg_3_0:Find("icon"))
	end

	setText = var_2

	var_2(arg_3_0:Find("floor"), arg_3_1:GetFloor())

	setActive = var_2

	var_2(arg_3_0:Find("floor"), arg_3_1.config.buff_maxfloor > 1)

	local var_3_0 = arg_3_1
	local var_3_1 = arg_3_1.GetLost(var_3_0)

	setText = var_3_0

	var_3_0(arg_3_0:Find("lost"), var_3_1)
	...
	local function var_3_3()
		...
		DROP_TYPE_STRATEGY = var_2_10005
		var_4_4.type = var_2_10005
	...
	var_3_0(var_4, var_3_2, var_3_3, var_1_10007)
...
function var_0_1.Init(arg_5_0)
	...
	arg_5_0.globalBuffItemList = var_5_1(var_5_2, var_4.GetChild(var_5_3, 0))
	...
	arg_5_0.fleetBuffItemList = var_5_5(var_5_6, var_4.GetChild(var_5_7, 0))
	...
	arg_5_0.cmdSkillItemList = var_5_9(var_5_10, var_4.GetChild(var_5_11, 0))
	...
	var_2.make(var_5_12, function(arg_8_0, arg_8_1, arg_8_2)
		...
		if arg_8_0 == var_2_10003.EventUpdate then
			...
			local var_8_1 = arg_8_2:Find("floor")
			local var_8_2 = "Lv."
			local var_8_3 = var_8_0

			var_4(var_8_1, var_8_2 .. var_8_0.getConfig(var_8_3, "lv"))
			...
			var_4(var_8_4, var_8_5, var_8_6, var_8_3)
		end
...
function var_0_1.AddMapListener(arg_11_0)
	if arg_11_0.map then
		...
		var_11_1(var_11_0, var_1_10003.EventUpdateFIndex, arg_11_0.onUpdateSelectedFleet)
	end
...
function var_0_1.RemoveMapListener(arg_12_0)
	if arg_12_0.map then
		...
		var_12_1(var_12_0, var_1_10003.EventUpdateFIndex, arg_12_0.onUpdateSelectedFleet)
	end
...
function var_0_1.AddFleetListener(arg_13_0, arg_13_1)
	if arg_13_1 then
		...
		var_13_1(var_13_0, var_1_10004.EventUpdateBuff, arg_13_0.onUpdateFleetBuff)
		...
		var_13_3(var_13_2, var_4.EventUpdateDamageLevel, arg_13_0.onUpdateFleetBuff)
		...
		var_13_5(var_13_4, var_4.EventUpdateCatSalvage, arg_13_0.onUpdateCmdSkill)
		...
		var_13_7(var_13_6, var_4.EventUpdateFlashTips, arg_13_0.onUpdateFlashTips)
	end
...
function var_0_1.RemoveFleetListener(arg_14_0, arg_14_1)
	if arg_14_1 then
		...
		var_14_1(var_14_0, var_1_10004.EventUpdateBuff, arg_14_0.onUpdateFleetBuff)
		...
		var_14_3(var_14_2, var_4.EventUpdateDamageLevel, arg_14_0.onUpdateFleetBuff)
		...
		var_14_5(var_14_4, var_4.EventUpdateCatSalvage, arg_14_0.onUpdateCmdSkill)
		...
		var_14_7(var_14_6, var_4.EventUpdateFlashTips, arg_14_0.onUpdateFlashTips)
	end
...
function var_0_1.OnUpdateMap(arg_15_0)
	...
	var_1_10001(var_15_0, var_3.GetName(var_15_1, arg_15_0.entrance))
...
function var_0_1.OnUpdateMoveLimit(arg_18_0)
	...
	var_18_0(arg_18_0.rtMoveLimit, var_18_1)

	if var_18_1 then
		WorldBuff = var_18_0

		local var_18_2 = var_18_0.New()
		...
		var_18_4.id = var_1_10006.MoveLimitBuffId
...
function var_0_1.OnUpdatePoison(arg_19_0)
	...
	var_1_10003(arg_19_0.rtPoisonRate, var_19_2 > 0)
	...
	if 0 < var_19_2 then
		...
		local var_19_4 = var_4(var_5.gameset.world_sairen_infection.description)
		...
		var_5(var_6.Find(var_19_5, "bg/ring"), function(arg_20_0)
			...
			if var_19_3 >= var_19_4[var_20_0] and var_19_3 < var_19_4[var_20_0 + 1] then
				...
				typeof = var_4
				Image = var_2_10005
				var_20_2 = var_20_2(var_20_1, var_4(var_2_10005))
			...
			var_20_2(var_3.Find(var_20_3, "bg/Text"), var_19_3 .. "%")
...
function var_0_1.OnUpdateFleetBuff(arg_22_0)
	...
	if var_1.GetDamageBuff(var_22_1) then
		...
		var_22_1.insert(arg_22_0.fleetBuffs, 1, var_1)
	end
...
function var_0_1.OnUpdateCmdSkill(arg_23_0)
	...
	if var_1.IsCatSalvage(var_23_0) then
		...
		arg_23_0.cmdSkills = var_23_1(var_23_2(var_3.getCommanders(var_23_3)), function(arg_24_0)
...
function var_0_1.OnUpdateFlashTips(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	local var_25_1 = var_5.Find(var_25_0, "Text")

	HXSet = var_25_0

	var_4(var_25_1, var_25_0.hxLan(arg_25_3))

	GetOrAddComponent = var_4

	local var_25_2 = arg_25_0.rtFlashTipWord
	local var_25_3 = var_5.Find(var_25_2, "Text")

	typeof = var_25_2
	Typewriter = var_7

	local var_25_4 = var_4(var_25_3, var_25_2(var_7))

	Timer = var_25_3

	local var_25_5 = var_25_3.New
	...
	local function var_25_6()
		...
		local var_26_5 = var_26_4(var_26_3, var_2_10003(var_2_10004))
	...
	getGameset = var_7
	arg_25_0.flashTimer = var_25_5(var_25_6, var_7("world_tip_last")[1])
	...
	var_25_8(var_25_7, var_7("world_tip_typewriter")[2][1])
	var_25_4:Play()
