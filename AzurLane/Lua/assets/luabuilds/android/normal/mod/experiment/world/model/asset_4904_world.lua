...
function var_0_1.Build(arg_5_0)
	...
	arg_5_0.atlas = var_5_0(var_1_10002.DefaultAtlas)
	arg_5_0.realm = 0
	arg_5_0.fleets = {}
	...
	var_5_2(var_5_1, var_1_10003.EventUpdateItem, arg_5_0.onUpdateItem)
	...
	var_5_4(var_5_3, var_3.EventUpdateTask, arg_5_0.onUpdateTask)
...
function var_0_1.Dispose(arg_6_0, arg_6_1)
	...
	WorldInventoryProxy = var_5

	var_6_3(var_6_2, var_5.EventUpdateItem, arg_6_0.onUpdateItem)
	...
	var_6_6(var_6_5, var_5.EventUpdateTask, arg_6_0.onUpdateTask)
...
function var_0_1.UsePortNShop(arg_8_0)
	...
	if arg_8_0.IsReseted(var_8_0) then
		var_8_1 = arg_8_0.activateTime
		WorldConst = var_8_0
		var_8_1 = var_8_1 >= var_8_0.GetNShopTimeStamp()
	end
...
function var_0_1.OnSwitchMap(arg_19_0)
	...
	if arg_19_0.submarineSupport then
		...
		var_19_1(var_19_0, var_1_10003("world_instruction_submarine_5"))
	...
	local var_19_3 = arg_19_0:GetActiveMap().id
	local var_19_4 = ", "

	tostring = var_1_10005

	var_1(var_19_2 .. var_19_3 .. var_19_4 .. var_1_10005(arg_19_0:GetActiveMap().gid))
...
function var_0_1.GetNormalFleets(arg_36_0)
	...
	return var_1_10001.filter(arg_36_0.fleets, function(arg_37_0)
		...
		return var_37_1 == var_37_0.Normal
	end)
end
...
function var_0_1.GetSubmarineFleet(arg_38_0)
	...
	return var_1_10001.detect(arg_38_0.fleets, function(arg_39_0)
		...
		local var_39_1 = arg_39_0.GetFleetType(var_39_0)

		FleetType = var_39_0

		return var_39_1 == var_39_0.Submarine
	end)
end
...
function var_0_1.GetShipVO(arg_48_0, arg_48_1)
	...
	if arg_48_0.GetShip(var_48_0, arg_48_1) then
		::label_48_0::

		WorldConst = var_48_0
		var_48_0 = var_48_0.FetchShipVO(var_2.id)
	end
...
function var_0_1.TransDefaultFleets(arg_51_0)
	...
	arg_51_0.defaultFleets = var_1_10001.map(arg_51_0.fleets, function(arg_52_0)
		...
		WorldBaseFleet = var_2_10003

		return var_52_1(var_52_0, var_2_10003)
	end)
...
function var_0_1.GetWorldPower(arg_55_0)
	...
	local var_55_3 = arg_55_0.GetWorldMapBuffAverageLevel(var_55_2)

	pg = var_55_2

	return var_55_1(var_55_0 * (1 + var_55_3 / var_55_2.gameset.world_strength_correct.key_value))
end
...
function var_0_1.GetWorldRank(arg_57_0)
	...
	local var_57_2 = var_3.gameset.world_level_correct.description
	...
	if arg_57_0:GetSubmarineFleet() then
		var_57_0 = var_57_0 + var_4:GetLevelCount() / 3 * var_57_2[5]
	end

	local var_57_3 = arg_57_0
	local var_57_4 = var_57_0 * arg_57_0.GetWorldMapBuffAverageLevel(var_57_3)
	local var_57_5

	pg = var_57_3

	local var_57_6 = var_57_3.gameset.world_suggest_level.description

	ipairs = iter_57_0

	for iter_57_2, iter_57_3 in iter_57_0(var_57_6) do
...
function var_0_1.CalcRepairCost(arg_65_0, arg_65_1)
	...
	if arg_65_1.IsBroken(var_65_1) then
		pg = var_4

		local var_65_2 = var_4.gameset.world_port_service_2_interval.description

		_ = var_65_1

		local var_65_3

		if not var_65_1.detect(var_65_2, function(arg_66_0)
			return arg_66_0[1] >= var_65_0
		end) then
			var_65_3 = var_65_2[#var_65_2]
		end

		var_1_10006 = var_65_3[2]
		pg = var_7

		return var_1_10006 * var_7.gameset.world_port_service_2_price.key_value
	else
		local var_65_4 = arg_65_1

		if not arg_65_1.IsHpFull(var_65_4) then
			pg = var_4

			local var_65_5 = var_4.gameset.world_port_service_1_interval.description

			pg = var_65_4

			local var_65_6 = var_65_4.gameset.world_port_service_1_price.description

			_ = var_1_10006

			local var_65_7

			if not var_1_10006.detect(var_65_5, function(arg_67_0)
				return arg_67_0[1] >= var_65_0
			end) then
				var_65_7 = var_65_5[#var_65_5]
			end

			local var_65_8 = var_65_7[2]

			_ = var_8

			local var_65_9

			if not var_8.detect(var_65_6, function(arg_68_0)
				return arg_68_0[1] >= arg_65_1.hpRant
			end) then
				var_65_9 = var_65_6[#var_65_6]
			end

			return var_65_8 * var_65_9[2]
		end
	end
...
function var_0_1.EntranceToReplacementMapList(arg_71_0, arg_71_1)
	...
	if arg_71_1:GetBaseMap().isPressing and #arg_71_1.config.complete_chapter > 0 then
		table = var_4

		var_4.insert(var_71_0, arg_71_0:GetMap(arg_71_1.config.complete_chapter[1]))
	end

	table = var_4

	var_4.insert(var_71_0, var_3)
	...
	return (var_5.filter(var_71_0, function(arg_73_0)
...
function var_0_1.FindTreasureEntrance(arg_75_0, arg_75_1)
	...
	return var_75_0(var_3.GetTreasureDic(var_75_1, arg_75_1))[1]
end

function var_0_1.TreasureMap2ItemId(arg_76_0, arg_76_1, arg_76_2)
	local var_76_0 = arg_76_0
	local var_76_1 = arg_76_0.GetEntrance(var_76_0, arg_76_2)

	ipairs = var_76_0

	for iter_76_0, iter_76_1 in var_76_0(var_76_1.config.teasure_chapter) do
...
function var_0_1.CheckFleetMovable(arg_77_0)
	...
	local var_77_3 = arg_77_0.GetRound(var_77_2)

	WorldConst = var_77_2

	local var_77_4

	if var_77_3 == var_77_2.RoundPlayer then
		if var_1:CheckFleetMovable(var_77_1) then
			var_77_4 = not var_1:CheckInteractive()
		end
	else
		var_77_4 = false
	end
...
function var_0_1.GetAchievements(arg_81_0, arg_81_1)
	...
	var_1_10003.each(arg_81_1.config.normal_target, function(arg_82_0)
		...
		var_82_0(var_82_1, var_3.GetAchievement(var_82_2, arg_82_0))
	...
	var_3.each(arg_81_1.config.cryptic_target, function(arg_83_0)
		...
		var_83_0(var_83_1, var_3.GetAchievement(var_83_2, arg_83_0))
...
function var_0_1.AnyUnachievedAchievement(arg_85_0, arg_85_1)
	...
	local var_85_1 = arg_85_0.GetMapAchieveStarDic(var_85_0, arg_85_1.id)

	_ = var_85_0

	if var_85_0.detect(arg_85_1:GetAchievementAwards(), function(arg_86_0)
		return not var_85_1[arg_86_0.star]
	end) then
		local var_85_2, var_85_3 = arg_85_0:CountAchievements(arg_85_1)

		return var_85_2 + var_85_3 >= var_3.star, var_3
	end
...
function var_0_1.GetFinishAchievements(arg_87_0, arg_87_1)
	if not arg_87_1 then
		local var_87_0 = arg_87_0.atlas

		arg_87_1 = var_2.GetAchEntranceList(var_87_0)
	end
	...
	for iter_87_0, iter_87_1 in var_1_10004(arg_87_1) do
		local var_87_3, var_87_4 = arg_87_0:CountAchievements(iter_87_1)
		local var_87_5 = arg_87_0:GetMapAchieveStarDic(iter_87_1.id)
		local var_87_6 = {}

		ipairs = var_13

		for iter_87_2, iter_87_3 in var_13(iter_87_1:GetAchievementAwards()) do
			if not var_87_5[iter_87_3.star] and var_87_3 + var_87_4 >= iter_87_3.star then
				table = var_18
		...
		if #var_87_6 > 0 then
			...
			var_13.insert(var_87_2, iter_87_1.id)
		end
	end

	return var_87_1, var_87_2
end
...
function var_0_1.CountAchievements(arg_88_0, arg_88_1)
	...
	if not arg_88_1 or not {
		...
		var_1_10006 = arg_88_0.atlas
		var_88_3 = var_5.GetAchEntranceList(var_1_10006)
	end

	ipairs = var_1_10006

	for iter_88_0, iter_88_1 in var_1_10006(var_88_3) do
		ipairs = var_1_10011
		...
		for iter_88_2, iter_88_3 in var_1_10011(iter_88_1.config.normal_target) do
			...
			if arg_88_0.achievements[iter_88_3] then
				local var_88_4 = arg_88_0.achievements[iter_88_3]

				if var_16.IsAchieved(var_88_4) then
					var_88_5 = 1
		...
		for iter_88_4, iter_88_5 in var_1_10011(iter_88_1.config.cryptic_target) do
			...
			if arg_88_0.achievements[iter_88_5] then
				local var_88_6 = arg_88_0.achievements[iter_88_5]

				if var_16.IsAchieved(var_88_6) then
					var_88_7 = 1
...
function var_0_1.BuildFormationIds(arg_90_0)
	...
	for iter_90_0, iter_90_1 in var_3(var_4.world_stage_template.all) do
		pg = var_1_10008
		var_1_10008 = var_1_10008.world_stage_template[iter_90_1]

		local var_90_2 = arg_90_0:GetProgress()
		...
		if var_1_10008.stage_key <= var_90_2 then
			...
			FleetType = iter_90_6
			var_90_1[var_90_3] = var_90_4(var_90_1[iter_90_6.Normal], var_1_10008.fleet_num)
		else
			break
		end
	end
	...
	if var_90_6(var_90_5, var_5.SystemSubmarine) then
		FleetType = var_3
	...
	for iter_90_7, iter_90_8 in var_90_10(var_90_11) do
		local var_90_12 = iter_90_8.config.complete_condition

		WorldConst = iter_90_6

		if var_90_12 == iter_90_6.TaskTypeFleetExpansion then
			iter_90_6 = iter_90_8

			if iter_90_8.isAlive(iter_90_6) then
...
function var_0_1.FormationIds2NetIds(arg_91_0, arg_91_1)
	...
	var_91_1[1] = var_1_10005.Normal
	FleetType = var_5
	var_91_1[2] = var_5.Submarine
	...
	for iter_91_0, iter_91_1 in var_1_10003(var_91_1) do
		...
		for iter_91_2, iter_91_3 in var_1_10008(arg_91_1[iter_91_1]) do
			...
			var_91_3[1] = var_1_10016.Main
			TeamType = var_1_10016
			var_91_3[2] = var_1_10016.Vanguard
			TeamType = var_1_10016
			var_91_3[3] = var_1_10016.Submarine
			...
			if #var_91_2 > 0 then
				...
				Clone = iter_91_4
				var_1_10016.commanders = iter_91_4(iter_91_3.commanders)

				var_1_10014(var_91_4, var_1_10016)
			end
		end
	end
...
function var_0_1.CompareRedeploy(arg_92_0, arg_92_1)
	...
	for iter_92_7, iter_92_8 in var_7(arg_92_0:GetFleets()) do
		...
		for iter_92_9, iter_92_10 in var_1_10012(var_92_0) do
			local var_92_5 = iter_92_8
			local var_92_6 = iter_92_8.GetTeamShips(var_92_5, iter_92_10, true)

			ipairs = var_92_5

			for iter_92_11, iter_92_12 in var_92_5(var_92_6) do
...
function var_0_1.IsSystemOpen(arg_93_0, arg_93_1)
	...
	local var_93_1 = arg_93_0.GetRealm(var_93_0)

	ipairs = var_93_0
	pg = var_1_10004

	for iter_93_0, iter_93_1 in var_93_0(var_1_10004.world_stage_template.all) do
		pg = var_1_10008

		if var_1_10008.world_stage_template[iter_93_1].stage_ui[1] == arg_93_1 and (var_1_10008.stage_ui[2] == 0 or var_1_10008.stage_ui[2] == var_93_1) then
...
function var_0_1.CalcCDTimeCost(arg_94_0, arg_94_1, arg_94_2)
	...
	local var_94_1 = var_1_10004.TimeMgr.GetInstance()
	local var_94_2 = var_94_0(var_4.GetServerTime(var_94_1) - arg_94_1, 0)

	math = var_4

	local var_94_3 = var_4.floor
	local var_94_4 = arg_94_0[1]

	math = var_1_10006

	local var_94_5 = var_94_4 * var_1_10006.max(arg_94_0[2] - var_94_2, 0) / arg_94_0[2]

	math = var_6

	return var_94_3(var_94_5 * var_6.max(16 - arg_94_2, 0) / 16)
end
...
function var_0_1.InitWorldShopGoods(arg_97_0)
	...
	var_97_0[1] = var_1_10003.WorldShop
	ShopArgs = var_3
	var_97_0[2] = var_3.WorldCollection

	for iter_97_0, iter_97_1 in var_1(var_97_0) do
		ipairs = var_1_10006
		pg = var_1_10007

		for iter_97_2, iter_97_3 in var_1_10006(var_1_10007.shop_template.get_id_list_by_genre[iter_97_1]) do
...
function var_0_1.InitWorldColorDictionary(arg_101_0)
	...
	var_101_0(var_1_10002.world_chapter_colormask.all, function(arg_102_0)
		pg = var_2_10001
...
function var_0_1.GetWorldMapBuffAverageLevel(arg_109_0)
	...
	var_1_10003.each(var_109_0, function(arg_110_0)
...
function var_0_1.GetWorldMapDifficultyBuffLevel(arg_113_0)
	...
	local var_113_1 = arg_113_0.GetActiveMap(var_113_0).config.difficulty

	pg = var_113_0

	return var_113_0.gameset.world_difficult_value.description[var_113_1]
end

function var_0_1.OnUpdateItem(arg_114_0, arg_114_1, arg_114_2, arg_114_3)
	local var_114_0 = arg_114_3
	local var_114_1 = arg_114_3.getWorldItemType(var_114_0)

	WorldItem = var_114_0

	if var_114_1 == var_114_0.UsageWorldMap and arg_114_0.atlas then
		local var_114_2 = arg_114_0.atlas

		var_5.UpdateTreasure(var_114_2, arg_114_3.id)
	end

	local var_114_3 = arg_114_0.taskProxy

	var_5.doUpdateTaskByItem(var_114_3, arg_114_3)
...
function var_0_1.CheckTaskLockMap(arg_120_0)
	...
	local var_120_3 = arg_120_0.GetActiveMap(var_120_2).gid

	_ = var_120_2

	return var_120_2.any(var_120_1, function(arg_121_0)
...
function var_0_1.CheckResetAward(arg_123_0, arg_123_1)
	...
	local var_123_0 = var_1_10002(var_1_10003)
	local var_123_1 = var_2.getData(var_123_0)
	local var_123_2 = var_2.getResource

	WorldConst = var_1_10004

	local var_123_3 = var_123_2(var_123_1, var_1_10004.ResourceID)

	pg = var_123_1

	if var_123_3 == var_123_1.gameset.world_resource_max.key_value then
...
function var_0_1.CalcOrderCost(arg_129_0, arg_129_1)
	...
	if arg_129_1 == var_1_10003.OpReqRedeploy then
		...
		pg = var_1_10004
		var_1_10004 = var_1_10004.gameset.world_fleet_redeploy_cost.description

		local var_129_2 = arg_129_0

		var_1_10005 = arg_129_0.GetReqCDTime
		WorldConst = var_1_10007

		return var_129_1(var_1_10004, var_1_10005(var_129_2, var_1_10007.OpReqRedeploy), var_129_0)
	else
		...
		if arg_129_1 == var_129_1.OpReqMaintenance then
			...
			if arg_129_1 == var_129_3.OpReqSub then
				var_1_10004 = arg_129_0

				if arg_129_0.GetSubmarineFleet(var_1_10004) then
					...
					var_1_10004.each(var_3:GetShips(true), function(arg_130_0)
						...
						var_129_0 = var_130_0 + var_130_2(var_130_1, var_2_10004.OpReqSub)
				...
				World = var_1_10004
				var_1_10004 = var_1_10004.CalcCDTimeCost
				pg = var_1_10005

				local var_129_4 = var_1_10005.gameset.world_instruction_submarine.description

				var_1_10007 = arg_129_0

				local var_129_5 = arg_129_0.GetReqCDTime

				WorldConst = var_1_10008

				return var_1_10004(var_129_4, var_129_5(var_1_10007, var_1_10008.OpReqSub), var_129_0)
			else
				WorldConst = var_3
				...
				if arg_129_1 == var_3.OpReqVision then
					World = var_129_6
					var_129_6 = var_129_6.CalcCDTimeCost
					pg = var_1_10004

					local var_129_7 = var_1_10004.gameset.world_instruction_detect.description
					local var_129_8 = arg_129_0
					local var_129_9 = arg_129_0.GetReqCDTime

					WorldConst = var_1_10007

					return var_129_6(var_129_7, var_129_9(var_129_8, var_1_10007.OpReqVision), var_129_0)
				else
					assert = var_129_6

					var_129_6(false, "op type error: " .. arg_129_1)
				end
			end
		end
	end
...
function var_0_1.CheckSkipBattle(arg_134_0)
	...
	local var_134_0 = var_1_10001(var_1_10002)
...
function var_0_1.TriggerAutoFight(arg_140_0, arg_140_1)
	...
	if var_140_1 ~= var_3(arg_140_0.isAutoFight) then
		...
		var_140_10(var_140_9, var_4.WORLD_TRIGGER_AUTO_FIGHT)
	end
...
function var_0_1.TriggerAutoSwitch(arg_141_0, arg_141_1)
	...
	if var_141_0 ~= var_3(arg_141_0.isAutoSwitch) then
		...
		var_141_2(var_141_1, var_4.WORLD_TRIGGER_AUTO_SWITCH)
	end
