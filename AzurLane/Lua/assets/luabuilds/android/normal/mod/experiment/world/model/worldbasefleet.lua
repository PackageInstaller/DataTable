...
function var_0_1.Setup(arg_2_0, arg_2_1)
	...
	local var_2_0 = var_2.map(arg_2_1.ship_list, function(arg_3_0)
		...
		local var_3_2 = var_3_1(var_3_0, var_2_10003)
...
function var_0_1.UpdateShips(arg_4_0, arg_4_1)
	...
	var_2.each(arg_4_1, function(arg_5_0)
		...
		var_2_10001(var_5_0 == var_2_10003)
		...
		if arg_5_0:IsValid() then
			...
			local var_5_3 = var_2_10003.FetchRawShipVO(arg_5_0.id)

			var_5_1(var_5_2[var_3.getTeamType(var_5_3)], arg_5_0)
		end
	...
	TeamType = var_4
	var_4_0[1] = var_4.Main
	TeamType = var_4
	var_4_0[2] = var_4.Vanguard
	TeamType = var_4
	var_4_0[3] = var_4.Submarine
...
function var_0_1.IsValid(arg_7_0)
	...
	if var_7_1 == var_7_0.Submarine then
		local var_7_2 = arg_7_0
		local var_7_3 = arg_7_0.GetTeamShips

		TeamType = var_1_10003

		do return #var_7_3(var_7_2, var_1_10003.Submarine, true) > 0 end

		goto label_7_0
	end

	local var_7_4 = arg_7_0
	local var_7_5 = arg_7_0.GetTeamShips

	TeamType = var_1_10003

	if #var_7_5(var_7_4, var_1_10003.Vanguard, true) > 0 then
		do
			local var_7_6 = arg_7_0
			local var_7_7 = arg_7_0.GetTeamShips

			TeamType = var_3

			local var_7_8

			if not (#var_7_7(var_7_6, var_3.Main, true) > 0) then
				var_7_8 = false
			else
				var_7_8 = true
			end
...
function var_0_1.GetShips(arg_12_0, arg_12_1)
	...
	var_12_2[1] = var_1_10005.Main
	TeamType = var_5
	var_12_2[2] = var_5.Vanguard
	TeamType = var_5
	var_12_2[3] = var_5.Submarine
...
function var_0_1.GetFlagShipVO(arg_20_0)
	...
	if var_20_1 == var_20_0.Submarine then
		WorldConst = var_20_1
		var_20_1 = var_20_1.FetchShipVO
		_ = var_20_2
		var_20_2 = var_20_2.detect
		TeamType = var_1_10003

		return var_20_1(var_20_2(arg_20_0[var_1_10003.Submarine], function(arg_21_0)
			return arg_21_0:IsAlive()
		end).id)
	else
		WorldConst = var_20_1

		local var_20_3 = var_20_1.FetchShipVO

		_ = var_20_2

		local var_20_4 = var_20_2.detect

		TeamType = var_1_10003

		return var_20_3(var_20_4(arg_20_0[var_1_10003.Main], function(arg_22_0)
...
function var_0_1.IsAlive(arg_23_0)
	...
	if var_23_0(arg_23_0[var_1_10002.Main], function(arg_24_0)
		return arg_24_0:IsAlive()
	end) then
		_ = var_23_1
		var_23_1 = var_23_1.any
		TeamType = var_2
		var_23_1 = var_23_1(arg_23_0[var_2.Vanguard], function(arg_25_0)
...
function var_0_1.GetLevel(arg_26_0)
	...
	local var_26_1 = arg_26_0.GetShips(var_26_0, true)

	math = var_26_0

	local var_26_2 = var_26_0.floor

	_ = var_3

	return var_26_2(var_3.reduce(var_26_1, 0, function(arg_27_0, arg_27_1)
...
function var_0_1.getShipVOsDic(arg_32_0)
	...
	local var_32_2 = arg_32_0.GetShipVOs(var_32_1)
