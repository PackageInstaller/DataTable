...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_1_10006(var_2.list) do
		...
		if not var_1_10011.GetPlayerDataCache(var_1_10012, iter_1_1) then
			table = var_1_10012
	...
	if #var_1_2 == 0 then
		...
		var_1_4(var_1_3, var_8.BATCH_GET_FRIEND_DONE)
	...
	var_6.Send(var_1_5, 50018, {
		...
		for iter_2_0, iter_2_1 in var_2_10001(arg_2_0.user_list) do
			...
			var_7.insert(var_1_1, var_2_10006)

			getProxy = var_7
			IslandProxy = var_8

			local var_2_0 = var_7(var_8)

			var_7.AddPlayerDataCache(var_2_0, var_2_10006)
		end
		...
		var_2_2(var_2_1, var_3.BATCH_GET_FRIEND_DONE)
