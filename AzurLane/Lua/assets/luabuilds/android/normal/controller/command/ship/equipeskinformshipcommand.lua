...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_8.getShipById(var_1_5, var_1_0) then
		...
		var_1_7(var_1_6, var_1_10012("equipment_skin_no_old_ship"))
	...
	if var_9.getEquipSkin(var_1_8, var_1_1) == 0 then
		...
		var_1_10(var_1_9, var_1_10013("equipment_skin_no_old_skinorequipment"))
	...
	if not var_8.getShipById(var_1_11, var_1_2) then
		pg = var_1_11
		var_1_12 = var_1_11.TipsMgr.GetInstance()

		local var_1_13 = var_12.ShowTips

		i18n = var_1_10014

		var_1_13(var_1_12, var_1_10014("equipment_skin_no_new_ship"))
	...
	local function var_1_14()
		...
		if not var_0.getEquipmnentSkinById(var_2_0, var_0) or var_0.count == 0 then
			...
			var_2_0(var_2_1, var_2_10003("equipment_skin_count_noenough"))
		...
		local var_2_2 = var_2_0.ConnectionMgr.GetInstance()
		...
		var_1.Send(var_2_2, 12036, {
			...
			if arg_3_0.result == 0 then
				...
				if var_1.getEquipSkin(var_3_0, var_1_3) ~= 0 then
					...
					var_2.addEquipmentSkin(var_3_10003, var_1, 1)
					...
					var_3_1(var_3_10003, var_4("equipment_skin_unload"))
				end

				var_3_10003 = var_0

				var_2.updateEquipmentSkin(var_3_10003, var_1_3, var_0)
				...
				var_2.useageEquipmnentSkin(var_3_10003, var_0)
				...
				var_3_2(var_3_10003, var_4("equipment_skin_replace_done"))
				...
				var_3_3(var_3_10003, var_4.EQUIP_EQUIPMENTSKIN_FROM_SHIP_DONE)
			else
				pg = var_1
				...
				var_3_5(var_3_4, var_3_10003("equipment_skin_unload_failed" .. arg_3_0.result))
			end
	...
	var_13.Send(var_1_15, 12036, {
		...
		if arg_4_0.result == 0 then
			...
			var_4_4(var_4_3, var_2_10003("equipment_skin_unload_failed" .. arg_4_0.result))
		end
