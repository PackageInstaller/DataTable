...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0 then
		...
		var_1_10012 = var_1_10010(var_1_10011)
		var_1_10013 = var_1_10010.getShipById(var_1_10012, var_1_0)
		var_1_6 = var_1_10011.getEquip(var_1_10013, var_1_1)
		assert = var_1_10012
		...
		var_1_10012 = var_1_10010(var_1_10011)
		var_1_6 = var_1_10010.getEquipmentById(var_1_10012, var_1_2)
		assert = var_11
	...
	if not var_1_10010.canUpgrade(var_1_6.configId) then
		...
		var_1_8(var_1_7, var_1_10012("equipment_max_level"))

		return
	end

	local var_1_9 = var_1_0 and 14002 or 14004
	local var_1_10 = var_1_0 and 14003 or 14005
	local var_1_11
	...
	local var_1_12 = var_1_10013.ConnectionMgr.GetInstance()

	var_13.Send(var_1_12, var_1_9, var_1_11, var_1_10, function(arg_2_0)
		local var_2_0
		...
		if arg_2_0.result == 0 then
			...
			if var_1_0 then
				var_2_10008 = var_2_0
				var_2_10008 = var_2_0.getShipById(var_2_10008, var_1_0)
				var_2_4 = var_2_3.getEquip(var_2_10008, var_1_1)
			else
				var_2_10008 = var_2_10003
				var_2_4 = var_2_10003.getEquipmentById(var_2_10008, var_1_2)
			end

			reducePlayerOwn = var_7
			Drop = var_2_10008

			local var_2_5 = var_2_10008.New
			local var_2_6 = {}

			DROP_TYPE_RESOURCE = var_2_10010
			var_2_6.type = var_2_10010
			PlayerConst = var_2_10010
			var_2_6.id = var_2_10010.ResGold
			...
			for iter_2_0, iter_2_1 in var_7(var_1_4) do
				reducePlayerOwn = var_2_10012

				var_2_10012(iter_2_1)
			end
			...
			elseif var_2_4 then
				var_2_10003:removeEquipmentById(var_2_4.id, 1)
				var_2_10003:addEquipmentById(var_1_3.id, 1, true)
			end
			...
			var_2_8(var_2_7, var_9.UPGRADE_EQUIPMENTS_DONE, {
				ship = var_2_3,
				equip = var_2_4,
				newEquip = var_1_3
			})
			...
			var_2_10(var_2_9, var_2_10003("equipment_upgrade_erro", arg_2_0.result))
		end
