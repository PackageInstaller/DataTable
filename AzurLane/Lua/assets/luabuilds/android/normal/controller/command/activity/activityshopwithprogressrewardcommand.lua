...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_3.getConfig(var_1_3, "type")

	assert = var_1_3
	ActivityConst = var_6

	var_1_3(var_1_4 == var_6.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD, "Operation Cant Fit ActivityType " .. var_1_4)

	ActivityConst = var_1_3

	local var_1_6

	if var_1_4 == var_1_3.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD then
		if var_1_1.cmd == 1 then
			getProxy = var_1_6
			PlayerProxy = var_6

			local var_1_5 = var_1_6(var_6)

			var_1_6 = var_1_6.getData(var_1_5)
			pg = var_1_5

			local var_1_7 = var_1_5.activity_shop_template[var_1_1.arg1]
			local var_1_8
			...
			if var_1_6[var_8(var_1_7.resource_type)] < var_1_7.resource_num * var_1_8 then
				pg = var_8
				...
				var_1_10(var_1_9, var_1_10010("common_no_resource"))
			...
			if var_1_7.commodity_type == 1 then
				if var_1_7.commodity_id == 1 and var_1_6:GoldMax(var_1_7.num * var_1_8) then
					...
					local var_1_11 = var_8.TipsMgr.GetInstance()
					local var_1_12 = var_8.ShowTips

					i18n = var_10

					local var_1_13 = var_10("gold_max_tip_title")

					i18n = var_11

					var_1_12(var_1_11, var_1_13 .. var_11("resource_max_tip_shop"))
				...
				if var_1_7.commodity_id == 2 and var_1_6:OilMax(var_1_7.num * var_1_8) then
					...
					local var_1_14 = var_8.TipsMgr.GetInstance()
					local var_1_15 = var_8.ShowTips

					i18n = var_10

					local var_1_16 = var_10("oil_max_tip_title")

					i18n = var_11

					var_1_15(var_1_14, var_1_16 .. var_11("resource_max_tip_shop"))

					return
				end
			end
		elseif var_1_1.cmd == 2 then
			table = var_1_6

			if var_1_6.contains(var_3.data3_list, var_1_1.arg1) then
				pg = var_1_6

				local var_1_17 = var_1_6.TipsMgr.GetInstance()

				var_1_6 = var_1_6.ShowTips
				i18n = var_7

				var_1_6(var_1_17, var_7("common_count_noenough"))
	...
	local var_1_18 = var_1_6.ConnectionMgr.GetInstance()

	var_5.Send(var_1_18, 11202, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1 = var_2_1.getAwards(var_2_0, var_1_1, arg_2_0)
			getProxy = var_2_0
			ActivityProxy = var_3

			local var_2_2 = var_2_0(var_3)
			local var_2_3 = var_2.getActivityById(var_2_2, var_1_1.activity_id)
			local var_2_4 = arg_1_0
			local var_2_5 = var_3.updateActivityData(var_2_4, var_1_1, arg_2_0, var_2_3, var_2_1)
			local var_2_6 = arg_1_0

			var_3.performance(var_2_6, var_1_1, arg_2_0, var_2_5, var_2_1)
		else
			print = var_2_1
			...
			if arg_2_0.result == 3 or arg_2_0.result == 4 then
				...
				var_2_8(var_2_7, var_3("common_activity_end"))
			else
				pg = var_2_8
				...
				var_2_10(var_2_9, var_3("activity_op_error", arg_2_0.result))
			end
			...
			var_2_12(var_2_11, var_3.ACTIVITY_OPERATION_ERRO, {
...
function var_0_1.getAwards(arg_3_0, arg_3_1, arg_3_2)
	...
	for iter_3_2, iter_3_3 in var_5(var_3_0) do
		...
		if var_3_3 == var_1_10011 then
			...
			if not var_1_10011.getShipGroup(var_1_10012, var_3_4.group_type) then
				Ship = var_1_10012
				...
				if var_1_10012.inUnlockTip(iter_3_3.id) then
					...
					var_1_10012(var_3_5, var_1_10014("collection_award_ship", var_3_4.name))
				end
			end
		end
	end
...
function var_0_1.updateActivityData(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	local var_5_2 = var_5_0(var_7)

	getProxy = var_7
	TaskProxy = var_1_10008

	local var_5_3 = var_7(var_1_10008)

	ActivityConst = var_1_10008

	if var_5_1 == var_1_10008.ACTIVITY_TYPE_SHOP_PROGRESS_REWARD then
		if arg_5_1.cmd == 1 then
			...
			id2res = var_1_10014
			var_5_7[var_1_10014(var_8.resource_type)] = var_5_4
