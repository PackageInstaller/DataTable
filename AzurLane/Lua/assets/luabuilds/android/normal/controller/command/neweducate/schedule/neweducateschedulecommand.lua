...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 29040, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, var_2_10005.SYSTEM.PLAN)
			...
			local var_2_6 = var_2_5(var_2_4, var_5.SYSTEM.PLAN)
			local var_2_7
			...
			for iter_2_0, iter_2_1 in var_2_11(var_1_1) do
				...
				getProxy = var_2_13
				NewEducateProxy = var_14

				local var_2_15 = var_2_13(var_14)
			...
			local function var_2_16()
				if #var_2_7 > 0 then
					if not var_1_2 then
						...
						var_3_1(var_3_0, var_3_10002.NEW_EDUCATE_NEXT_PLAN, {
							id = var_1_0
						})
					else
						...
						var_3_3(var_3_2, var_3_10002.NEW_EDUCATE_SCHEDULE_SKIP, {
							id = var_1_0
						})
					end
				else
					...
					var_3_5(var_3_4, var_3_10002.NEW_EDUCATE_GET_EXTRA_DROP, {
						id = var_1_0,
						scheduleDrops = {}
					})
				end
			...
			var_2_19(var_2_18, iter_2_1.NEW_EDUCATE_SCHEDULE_DONE, {
				drops = var_2_17,
				callback = var_2_16
			})
		else
...
function var_0_1.TrackPlan(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_1 = var_5.sort
	local var_4_2 = arg_4_3

	CompareFuncs = var_1_10007

	var_4_1(var_4_2, var_1_10007({
		function(arg_6_0)
			return arg_6_0.key
		end
	}))
	...
	local var_4_6 = var_8.NEW_EDUCATE_TRACK

	NewEducateTrackCommand = var_9

	local var_4_7 = var_9.BuildDataPlan
	local var_4_8 = arg_4_1.id
	local var_4_9 = arg_4_1:GetGameCnt()
	local var_4_10 = arg_4_1
	local var_4_11 = arg_4_1.GetRoundData(var_4_10).round

	table = var_4_10

	local var_4_12 = var_4_10.concat(var_4_0, ",")

	table = var_14

	var_4_5(var_4_4, var_4_6, var_4_7(var_4_8, var_4_9, var_4_11, var_4_12, var_14.concat(var_4_3, ",")))
