...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_2.isFriend(var_1_0) then
		...
		var_1_2(var_1_1, var_1_10005("friend_player_is_friend_tip"))
	...
	var_3.Send(var_1_3, 50109, {
		...
		if arg_2_0.result == 0 then
			...
			var_1.addIntoBlackList(var_2_10003, var_0)
			...
			var_2_0(var_2_10003, var_4.FRIEND_ADD_BLACKLIST_DONE)
			...
			var_2_1(var_2_10003, var_4("friend_addblacklist_success"))
		else
			pg = var_1
			...
			var_2_3(var_2_2, var_2_10003("friend_addblacklist", arg_2_0.result))
		end
