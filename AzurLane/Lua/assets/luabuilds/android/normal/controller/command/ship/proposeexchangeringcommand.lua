...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_3 = var_1_10004.gameset.vow_prop_conversion.description
	local var_1_5
	...
	if var_1_2:getItemCountById(var_1_3[1]) < 1 then
		...
		var_1_5(var_1_4, var_1_10008("common_no_item_1"))
	...
	var_6.Send(var_1_6, 15010, {
		...
		if arg_2_0.result == 0 then
			...
			GAME = var_2_10003
			var_2_10003 = var_2_10003.PROPOSE_EXCHANGE_RING_DONE
			...
			var_2_3(var_2_2, var_2_10003, var_2_4)
		else
			pg = var_2_3
