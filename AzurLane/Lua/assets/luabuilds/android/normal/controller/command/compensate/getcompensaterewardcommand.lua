...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_2(arg_2_0)
		...
		var_1.Send(var_2_0, 30104, {
			...
			if arg_3_0.result == 0 then
				getProxy = var_1
				CompensateProxy = var_3_10002
				var_3_10003 = var_1(var_3_10002)

				var_1.DealMailOperation(var_3_10003, var_1_1)

				var_3_10003 = var_1

				var_1.unpdateLatestTime(var_3_10003, arg_3_0.max_timestamp)

				var_3_10003 = var_1

				var_1.unpdateUnreadCount(var_3_10003, arg_3_0.number)
				arg_2_0(arg_3_0)
			else
				local var_3_1
				...
				if arg_3_0.result == 6 then
					...
					var_3_1(var_3_0, var_3_10003("mail_moveto_markroom_max"))
				else
					pg = var_3_1
					...
					var_3_3(var_3_2, var_3_10003("", arg_3_0.result))
				end
			end
	...
	var_1_10007.insert(var_1_3, function(arg_4_0, arg_4_1)
		...
		local var_4_1, var_4_2 = var_3(var_4_0)
		...
		if not var_4_1 then
			...
			var_2_10005(var_4_2, {
				gold = function()
					...
					var_5_1(var_5_0, var_3_10002("gold_max_tip_title"))
				...
				oil = function()
					...
					var_6_1(var_6_0, var_3_10002("oil_max_tip_title"))
				...
				equip = function()
					...
					var_7_1(var_7_0, var_3_10002("mail_takeAttachment_error_magazine_full"))
				...
				ship = function()
					...
					var_8_1(var_8_0, var_3_10002("mail_takeAttachment_error_dockYrad_full"))
	...
	var_7.insert(var_1_3, function(arg_9_0, arg_9_1)
		...
		for iter_9_0, iter_9_1 in var_2_10002(arg_9_1.isExpBookOverflow) do
			...
			var_2_10007.insert(var_1_3, function(arg_10_0)
				...
				Item = var_3_10006
				var_10_2.content = var_3_10004(var_10_3, var_3_10006.getConfigData(iter_9_1).name)
	...
	var_8.insert(var_1_4, function(arg_11_0)
		local var_11_0 = arg_11_0

		getProxy = var_2_10002
		CompensateProxy = var_2_10003

		local var_11_1 = var_2_10002(var_2_10003)

		var_11_0(var_2.GetCompensateAttachments(var_11_1, var_1_1))
	...
	var_8(var_1_4, function(arg_14_0)
		...
		var_14_2(var_14_1, var_2_10004.DEAL_COMPENSATE_REWARD_DONE, {
			items = var_14_0
		})
