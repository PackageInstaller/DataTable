...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not arg_1_1.getBody(var_1_0) or var_1_1 == "" then
		pg = var_1_0
		var_1_10004 = var_1_0.TipsMgr.GetInstance()
		var_1_0 = var_1_0.ShowTips
		i18n = var_1_10005

		var_1_0(var_1_10004, var_1_10005("guild_should_input_keyword"))
	...
	if var_1_1 then
		string = var_1_0
		var_1_1 = var_1_0.gsub(var_1_1, "^%s*(.-)%s*$", "%1")
	end
	...
	local var_1_3 = var_1_10004(var_1_1) and 0 or 1

	pg = var_4

	local var_1_4 = var_4.ConnectionMgr.GetInstance()

	var_4.Send(var_1_4, 60028, {
		type = var_1_3,
		keyword = var_1_1
		...
		if arg_2_0.result == 0 then
			...
			var_2_4(var_2_10003, var_4.GUILD_SEARCH_DONE, var_2_0)
			...
			var_2_5(var_2_10003, var_4("guild_search_sucess"))
		else
			pg = var_2_0
			...
			var_2_7(var_2_6, var_2_10003("guild_no_exist"))
		end
