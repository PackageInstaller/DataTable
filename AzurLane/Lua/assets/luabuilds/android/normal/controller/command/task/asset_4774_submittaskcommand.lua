...
function var_0_1.execute(arg_4_0, arg_4_1)
	...
	if var_1_10008(var_4_0) ~= "number" then
		...
		if var_8(var_4_0) == "string" then
			...
			if var_8(var_4_0) == "table" then
				if var_4_0.normal_submit then
					...
					local var_4_8 = var_4_4.getTaskById(var_4_7, var_4_2)

					assert = var_4_7

					var_4_7(var_4_8:isSelectable())

					var_1_10011 = var_4_8

					local var_4_9 = var_4_8.getConfig(var_1_10011, "award_choice")[var_4_6]

					ipairs = var_1_10011

					for iter_4_0, iter_4_1 in var_1_10011(var_4_9) do
						table = var_1_10016
		...
		if not var_4_4.getTaskById(var_4_10, var_4_2) then
			pg = var_4_10

			local var_4_11 = var_4_10.TipsMgr.GetInstance()
			local var_4_12 = var_9.ShowTips

			i18n = var_1_10011

			var_4_12(var_4_11, var_1_10011("task_is_not_existence", var_4_2))
		...
		if not var_8:isFinish() then
			...
			local var_4_13 = var_9.TipsMgr.GetInstance()
			local var_4_14 = var_9.ShowTips

			i18n = var_1_10011

			var_4_14(var_4_13, var_1_10011("task_submitTask_error_notFinish"))
		...
		if var_8:isActivityTask() then
			...
			local var_4_15 = var_9.m02

			var_9.sendNotification(var_4_15, arg_4_0:GetSubmitActivityTask(), {
		...
		if var_8:IsOverflowShipExpItem() and not arg_4_0:InTaskScene() then
			...
			var_10.insert(var_4_16, function(arg_6_0)
				pg = var_2_10001
				...
				i18n = var_2_10004
				var_6_2.content = var_2_10004("player_expResource_mail_fullBag")
		...
		var_10(var_4_16, function()
			...
			var_0.Send(var_8_0, 20005, {
				...
				if arg_9_0.result == 0 then
					...
					var_9_4(var_9_3, var_4.GetSubmitTaskDone(var_9_5), var_9_1, {
						var_0.id
					})
					...
					var_9_6(var_9_3, var_4.GetSubmitTaskAwardDone(var_9_7), {
						awards = var_9_1
					}, {
						var_0.id
					})
...
function var_0_1.CheckTaskSub(arg_11_0)
	...
	local var_11_1 = arg_11_0.getConfig(var_11_0, "sub_type")
	...
	if var_11_1 == var_11_0 then
		...
		local var_11_2 = var_11_1(arg_11_0:getConfig("target_id"))
		local var_11_3 = arg_11_0
		local var_11_4 = arg_11_0.getConfig(var_11_3, "target_num")

		getProxy = var_11_3
		BagProxy = var_4

		local var_11_5 = var_11_3(var_4)
		local var_11_6 = var_3.removeItemById

		tonumber = var_1_10006

		local var_11_7 = var_1_10006(var_11_2)

		tonumber = var_7

		var_11_6(var_11_5, var_11_7, var_7(var_11_4))
	else
		local var_11_8 = arg_11_0
		local var_11_9 = arg_11_0.getConfig(var_11_8, "sub_type")
		...
		if var_11_9 == var_11_8 then
			...
			local var_11_10 = var_11_9(arg_11_0:getConfig("target_id"))
			local var_11_11 = arg_11_0
			local var_11_12 = arg_11_0.getConfig(var_11_11, "target_num")

			getProxy = var_11_11
			ActivityProxy = var_4

			local var_11_13 = var_11_11(var_4)

			var_3.removeVitemById(var_11_13, var_11_10, var_11_12)
		else
			local var_11_14 = arg_11_0
			local var_11_15 = arg_11_0.getConfig(var_11_14, "sub_type")

			TASK_SUB_TYPE_PLAYER_RES = var_11_14

			if var_11_15 == var_11_14 then
				tonumber = var_11_15

				local var_11_16 = var_11_15(arg_11_0:getConfig("target_id"))
				local var_11_17 = arg_11_0
				local var_11_18 = arg_11_0.getConfig(var_11_17, "target_num")

				getProxy = var_11_17
				PlayerProxy = var_4

				local var_11_19 = var_11_17(var_4)
				local var_11_20 = var_3.getData(var_11_19)
				local var_11_21 = var_4.consume
				local var_11_22 = {}

				id2res = var_1_10008
				var_11_22[var_1_10008(var_11_16)] = var_11_18

				var_11_21(var_11_20, var_11_22)
...
function var_0_1.CheckTaskType(arg_12_0)
	...
	if var_12_1 == var_12_0.TYPE_REFLUX then
		getProxy = var_2
		RefluxProxy = var_12_2
		var_12_2 = var_2(var_12_2)

		var_2.addPtAfterSubTasks(var_12_2, {
			arg_12_0
		})
	end
	...
	if var_12_1 == var_2.TYPE_REPEATABLE then
		-- block empty
	elseif var_12_1 == 8 then
		...
		var_2.updateTask(var_12_2, arg_12_0)
	else
		getProxy = var_2
		TaskProxy = var_12_2
		...
		var_2.removeTask(var_12_3, arg_12_0)
	end
	...
	if arg_13_0.IsGuildAddLivnessType(var_13_0) then
		...
		if var_13_2 and arg_13_0:isGuildTask() then
			...
			if var_13_2:getWeeklyTask() then
				var_1_10007 = var_5
				var_13_3 = var_5.GetLivenessAddition(var_1_10007)
			end
		...
		if var_13_2 and var_13_3 and var_13_3 > 0 then
			...
			local var_13_7 = var_1_10007(var_1_10008)
			local var_13_8 = var_13_6(var_13_5, var_7.getRawData(var_13_7).id)
...
function var_0_1.UpdateActivity(arg_14_0)
	...
	if var_14_1(var_14_0, var_1_10004.ACTIVITY_TYPE_TASK_LIST_MONITOR) and not var_2:isEnd() then
		local var_14_2 = var_2
		local var_14_3

		if not var_2.getConfig(var_14_2, "config_data")[1] then
			var_14_3 = {}
		end

		table = var_14_2

		if var_14_2.contains(var_14_3, arg_14_0.id) then
