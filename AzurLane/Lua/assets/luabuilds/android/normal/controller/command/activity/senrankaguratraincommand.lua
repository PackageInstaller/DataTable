	...
	var_1_3(var_1_2, var_1_4, var_1_5, 11203, function(arg_2_0)
		...
		if arg_2_0.result == 0 then
			if var_0.cmd == 1 then
				...
				for iter_2_2, iter_2_1 in var_2_0(var_0.arg_list) do
					table = var_2_10006

					var_2_10006.insert(var_0.data2_list, iter_2_1)
				end
			...
			var_2_2(var_2_10003, iter_2_2.SENRANKAGURA_TRAIN_ACT_OP_DONE, var_2_0)
		else
			pg = var_2_0
