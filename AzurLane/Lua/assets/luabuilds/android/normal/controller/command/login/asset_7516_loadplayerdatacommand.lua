...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	pg = var_1_10005
	ProxyRegister = var_6
	var_1_10005.proxyRegister = var_6.New()
	pg = var_1_10005
	...
	SixthAnniversaryIslandProxy = var_10
	var_1_55[1] = var_10
	var_1_5[50] = var_1_55
	...
	EducateProxy = var_10
	var_1_59[1] = var_10
	LOCK_EDUCATE_SYSTEM = var_10
	var_1_59[2] = not var_10
	var_1_5[54] = var_1_59
	...
	var_5.Send(var_1_76, 11001, {
		...
		if var_2_5 then
			...
			var_2_8(var_2_7, var_2_10007.GET_SURVEY_STATE, {
				surveyID = var_2_6
			})
		end
		...
		var_2_10(var_2_9, var_2_10007.AUCTION_GAME_INIT, {})
		...
		local var_2_17 = var_2_15(var_8)
		local var_2_18 = var_7.getLastServer(var_2_17, var_2_16.uid)

		pg = var_2_17

		local var_2_19 = var_2_17.SdkMgr.GetInstance()
		local var_2_20 = var_9.EnterServer

		tostring = var_2_10011

		var_2_20(var_2_19, var_2_10011(var_2_18.id), var_2_18.name, var_2_3.id, var_2_3.name, var_2_3.registerTime, var_2_3.level, var_2_3:getTotalGem())
		...
		var_2_24(var_2_23, var_11.REQUEST_META_PT_DATA, {
			isAll = true
		})
		...
		var_2_26(var_2_25, var_11.GET_SEASON_INFO)
		...
		var_2_28(var_2_27, var_11.GET_GUILD_INFO)
		...
		var_2_30(var_2_29, var_11.GET_PUBLIC_GUILD_USER_DATA, {})
		...
		local var_2_33 = var_11.REQUEST_MINI_GAME
		local var_2_34 = {}

		MiniGameRequestCommand = var_13
		var_2_34.type = var_13.REQUEST_HUB_DATA
		...
		if not var_2_37 then
			...
			var_2_37(var_2_35, var_11.EDUCATE_REQUEST)
		end
		...
		local var_2_41 = var_11.ACT_INSTAGRAM_CHAT
		local var_2_42 = {}

		ActivityConst = var_13
		var_2_42.operation = var_13.INSTAGRAM_CHAT_GET_DATA
		...
		if var_10.Check(var_2_49, arg_2_0.ship_count) then
			...
			var_2_51(var_2_50, var_12.LOAD_PLAYER_DATA_DONE)
		end
		...
		if var_10.FirstDefaultSetting then
			...
			local var_2_55 = var_12.APARTMENT_TRACK

			Dorm3dTrackCommand = var_13

			local var_2_56 = var_13.BuildDataGraphics

			Dorm3dRoomTemplateScene = var_14

			var_2_54(var_2_53, var_2_55, var_2_56(var_14.FirstDefaultSetting))
