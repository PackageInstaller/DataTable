...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_3.IsReqNewInstagramData(var_1_2) then
	...
	local var_1_3 = #var_3:GetNewInstagramIds()
	...
	if 30 <= var_1_3 then
		...
		if var_1_3 then
			...
			var_1_3("！！！！注意！！！！！一次请求太多ins数据，策划需检查配置是不是有问题！！！")
		end
	end
	...
	local var_1_5 = var_6.ceil(#var_4 / var_0_2)
	...
	for iter_1_0 = 1, var_1_5 do
		...
		for iter_1_1 = 1 + (iter_1_0 - 1) * var_0_2, iter_1_0 * var_0_2 do
			...
			var_1_10016.insert(var_1_6, var_4[iter_1_1])
		end
	...
	var_7(var_1_4, function()
		...
		var_3_2(var_3_1, var_2_10002.REQ_NEW_INSTAGRAM_DATA_DONE)
