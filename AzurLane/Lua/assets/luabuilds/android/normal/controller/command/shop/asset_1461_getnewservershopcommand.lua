	...
	var_6.Send(var_1_3, 26041, {
		...
		if arg_2_0.result == 0 then
			...
			if var_2_1 == var_2_10003.ACTIVITY_TYPE_NEWSERVER_SHOP then
				...
				if var_2_1 == var_2_10003.ACTIVITY_TYPE_BLACK_FRIDAY_SHOP then
			...
			var_2.SetNewServerShop(var_2_10003, var_1_1, var_2_0)
			var_1_0(var_2_0)
			...
			var_2_2(var_2_10003, var_4.GET_NEW_SERVER_SHOP_DONE)
		else
			var_1_0()
