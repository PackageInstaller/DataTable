...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = #var_1_10005(var_1_10006).queue

	TechnologyConst = var_1_10007

	if var_1_2 >= var_1_10007.QUEUE_TOTAL_COUNT then
		return
	end

	local var_1_3 = var_5

	if not var_5.getTechnologyById(var_1_3, var_1_0) or not var_6:isActivate() or not var_6:finishCondition() or var_6:isCompleted() then
		return
	end
	...
	var_7.Send(var_1_4, 63013, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, var_2_10003.JOIN_QUEUE_TECHNOLOGY_DONE)
			...
			var_2_3(var_2_4, var_2_10003("technology_queue_in_success"))
		else
			pg = var_2_3
			...
			var_2_6(var_2_5, var_2_10003("blueprint_stop_erro") .. arg_2_0.result)
		end
