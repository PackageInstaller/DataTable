...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 29050, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_4(var_2_3, var_4.SYSTEM.ASSESS)
			...
			NewEducateAssessState = var_2_6

			local var_2_8 = var_2_6.New({
			...
			var_2_10(var_2_9, var_2_10006.SYSTEM.ASSESS, var_2_8)
			...
			var_2_13(var_2_12, var_7.NEW_EDUCATE_ENTER_ASSESS_DONE, {
				drops = var_2_11,
				callback = var_1_0
			})
		else
