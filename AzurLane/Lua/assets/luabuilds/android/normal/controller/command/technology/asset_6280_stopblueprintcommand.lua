...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_7.Send(var_1_3, 63206, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.updateStartUpTime(var_2_10003, var_2_1)

			var_2_10003 = var_0

			var_2.reset(var_2_10003)

			var_2_10003 = var_0

			var_2.updateBluePrint(var_2_10003, var_0)
			...
			var_2_2(var_2_10003, var_4.STOP_BLUEPRINT_DONE, {
				id = var_0.id
			})
			...
			var_2_4(var_2_3, var_2_10003("technology_stop_erro") .. arg_2_0.result)
		end
