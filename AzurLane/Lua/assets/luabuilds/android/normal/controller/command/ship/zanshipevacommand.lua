...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 17105, {
		...
		if var_2_1 and var_2_1.evaluation then
			_ = var_2_10005
			var_2_2 = var_2_10005.detect(var_4.evas, function(arg_3_0)
		...
		if arg_2_0.result == 0 then
			...
			if var_2_2 then
				...
				var_2_5(var_2_4, var_2_10006.GROUP_EVALUATION_UPDATE, var_1_0)
			end
			...
			var_2_7(var_2_6, var_2_10006("zan_ship_eva_success"))
		else
			local var_2_9
			...
			if arg_2_0.result == 7 then
				if var_2_2 then
					...
					var_2_9(var_2_8, var_2_10006.GROUP_EVALUATION_UPDATE, var_1_0)
				end
				...
				var_2_9(var_2_10, var_2_10006("zan_ship_eva_error_7"))
			else
				pg = var_2_9
				...
				errorTip = var_2_10006

				var_2_12(var_2_11, var_2_10006("zan_ship_eva", arg_2_0.result))
			end
		end
