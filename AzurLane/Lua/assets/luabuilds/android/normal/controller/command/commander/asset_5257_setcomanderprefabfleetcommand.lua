	...
	if #var_1_3 ~= 0 then
		...
		var_7.Send(var_1_4, 25022, {
			...
			if arg_3_0.result == 0 then
				...
				var_2_10003 = var_1.getPrefabFleetById(var_3_0, var_1_0)

				var_1.updateCommanders(var_2_10003, var_1_1)

				var_2_10003 = var_1_2

				var_2.updatePrefabFleet(var_2_10003, var_1)
				...
				var_3_1(var_2_10003, var_4.SET_COMMANDER_PREFAB_DONE)
			else
				pg = var_1
				...
				var_3_3(var_3_2, var_2_10003[arg_3_0.result])
			end
