...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_10006(var_1_10007).data[var_1_0] then
		var_1_3 = 0
	end
	...
	if var_1_3 + var_1_2 > var_1_4.limit_time then
		...
		var_1_6(var_1_5, var_1_10011("dailyLevel_restCount_notEnough"))
	...
	SYSTEM_ROUTINE = var_1_10013
	var_1_10.system = var_1_10013
	var_1_10.id = var_1_1
	...
	var_1_8(var_1_7, var_1_9, var_1_10, 40008, function(arg_2_0)
		...
		if arg_2_0.result == 0 then
			...
			for iter_2_0, iter_2_1 in var_2_10002(arg_2_0.reward_list) do
				...
				var_2_10007(var_2_1, var_2_10009.addTranDrop(iter_2_1.drop_list))
				...
				var_2_10009 = var_2_10009.map
				PlayerConst = var_10

				local var_2_3 = var_10.addTranDrop
				local var_2_4
				...
				var_2_10007(var_2_2, var_2_10009(var_2_3(var_2_4), function(arg_3_0)
					arg_3_0.riraty = true
			...
			var_2_5[var_2_10003] = var_2_6 + var_1_2
			var_2_10003 = arg_1_0
			...
			var_2_7(var_2_10003, var_4.DAILY_LEVEL_QUICK_BATTLE_DONE, {
				awards = var_2_0,
				stageId = var_1_1,
