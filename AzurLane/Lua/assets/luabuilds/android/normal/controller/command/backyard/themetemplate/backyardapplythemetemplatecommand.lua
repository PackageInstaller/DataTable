...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_3(arg_2_0, arg_2_1)
		if #arg_2_0 == 0 then
			...
			local var_2_0 = var_2.ShowTips

			i18n = var_2_10004

			var_2_0(var_2_10003, var_2_10004("backyard_theme_template_list_is_empty"))
		...
		for iter_2_2, iter_2_3 in var_4(var_2_1) do
			var_2_2[iter_2_3.id] = iter_2_3:ToSaveData()
		end
		...
		var_2_4(var_2_3, var_6.PUT_FURNITURE, {
			furnsPos = var_2_2,
			floor = arg_2_1,
			callback = function(arg_3_0, arg_3_1)
				if arg_3_0 then
					...
					var_3_10002(var_3_0, var_3_10004.BACKYARD_APPLY_THEME_TEMPLATE_DONE)
				else
					pg = var_3_10002
					...
					var_3_2(var_3_1, var_3_10004("backyard_apply_theme_template_erro"))
	...
	if var_1_6 then
		...
		local var_1_9 = var_1_0.GetAllFurniture(var_1_8)
...
function var_0_1.WarpList(arg_6_0)
	...
	local var_6_13 = var_1.GetMapSize(var_6_12)

	ipairs = var_6_12

	for iter_6_3, iter_6_4 in var_6_12(arg_6_0) do
		CourtYardRawDataChecker = var_1_10019

		local var_6_14

		var_1_10019, var_6_14 = var_1_10019.CheckFurnitrue(iter_6_4, var_6_9, var_6_13)
		...
		if not var_1_10019 then
			...
			if not var_21.contains(var_6_10, iter_6_4.id) then
				...
				for iter_6_5, iter_6_6 in var_21(var_6_15) do
					table = var_1_10026
	...
	for iter_6_7 = #arg_6_0, 1, -1 do
		...
		if var_1_10019.contains(var_6_10, var_6_16.id) then
			table = var_1_10019

			var_1_10019.remove(arg_6_0, iter_6_7)
		elseif var_6_11[var_6_16.id] then
			pairs = var_20

			local var_6_17

			if not var_6_16.child then
				var_6_17 = {}
			end

			for iter_6_8, iter_6_9 in var_20(var_6_17) do
				table = iter_6_6

				if iter_6_6.contains(var_1_10019, iter_6_8) then
					iter_6_6 = var_6_16.child
