...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 25037, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10003.COMMANDER_QUICKLY_TOOL_ID, var_1_0)
			...
			var_2_3(var_2_2, var_2_10003.COMMANDER_QUICKLY_FINISH_BOXES_DONE)
			...
			var_2_5(var_2_4, var_2_10003.REFRESH_COMMANDER_BOXES)
		else
			...
			var_2_7(var_2_6, var_2_10003.COMMANDER_QUICKLY_FINISH_BOXES_ERROR)
		end
