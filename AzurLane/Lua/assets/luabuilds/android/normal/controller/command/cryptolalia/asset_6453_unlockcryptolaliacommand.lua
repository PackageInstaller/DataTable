...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_1_10008(var_1_4) do
	...
	if not var_1_5 or not var_1_5:IsLock() then
		...
		var_1_7(var_1_6, var_10("common_activity_end"))
	...
	if not var_1_5:InTime() then
		...
		var_1_9(var_1_8, var_10("common_activity_end"))
	...
	if var_5:getResById(var_1_10.id) < var_1_10.count then
		...
		if var_1_1 == var_1_12.COST_TYPE_TICKET then
			...
			var_1_12(var_1_11, iter_1_1("cryptolalia_no_ticket"))
		else
			pg = var_1_12
			...
			var_1_12(var_1_13, iter_1_1("common_no_resource"))
		end
	...
	var_10.Send(var_1_14, 16205, {
		...
		if arg_2_0.ret == 0 then
			...
			var_1.UnlockCryptolalia(var_2_10003, var_1_0)
			...
			id2res = var_2_10005
			var_2_2[var_2_10005(var_1_10.id)] = var_1_10.count
			...
			var_2_3(var_2_10003, var_4("cryptolalia_exchange_success"))
			...
			var_2_4(var_2_10003, var_4.UNLOCK_CRYPTOLALIA_DONE, {
				id = var_1_0
			})
		else
			pg = var_1
			...
			var_2_6(var_2_5, var_2_10003[arg_2_0.ret] .. arg_2_0.ret)
		end
