...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_4(var_5, "shipGroup is nil" .. var_1_1)

	local var_1_5 = var_1_3 - var_5.lastReqStamp

	ShipGroup = var_7

	if var_1_5 > var_7.REQ_INTERVAL then
		pg = var_1_5
		...
		var_6.Send(var_1_6, 17101, {
			...
			if arg_2_0.ship_discuss and var_1.ship_group_id == var_1_1 then
				if var_0 then
					...
					var_2_10002 = var_0
					pg = var_3
					var_2_10004 = var_3.TimeMgr.GetInstance()
					var_2_10002.lastReqStamp = var_3.GetServerTime(var_2_10004)
					...
					var_2_10002(var_2_1, var_2_10004.FETCH_EVALUATION_DONE, var_1_1)
				end
			else
				pg = var_2_10002
				...
				var_2_3(var_2_2, var_2_10004("fetch_ship_eva", arg_2_0.result))
			end
	...
	elseif var_5.evaluation then
		...
		var_1_8(var_1_7, var_8.FETCH_EVALUATION_DONE, var_1_1)
	end
