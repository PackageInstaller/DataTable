...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_8.getActivityById(var_1_5, var_1_2) then
		local var_1_6 = var_8

		if var_8.isEnd(var_1_6) then
			return
		end

		pg = var_1_5

		if not var_1_5.activity_event_picturepuzzle[var_1_2] then
			return
		end

		PuzzleActivity = var_1_6

		local var_1_8

		if var_1_1 == var_1_6.CMD_COMPLETE then
			...
			GAME = var_1_10012
			var_1_10012 = var_1_10012.ACTIVITY_OPERATION

			local var_1_9 = {
				activity_id = var_1_2
			}

			PuzzleActivity = var_1_10014
			var_1_9.cmd = var_1_10014.CMD_COMPLETE

			var_1_8(var_1_7, var_1_10012, var_1_9)

			return
		else
			PuzzleActivity = var_1_8

			if var_1_1 == var_1_8.CMD_ACTIVATE then
				table = var_1_8

				if not var_1_8.contains(var_8.data1_list, var_1_0) then
					table = var_1_8

					if not var_1_8.contains(var_9.pickup_picturepuzzle, var_1_0) then
						return
					end
				end
				...
				if var_1_8.contains(var_8.data2_list, var_1_0) then
					return
				end
			else
				PuzzleActivity = var_1_8

				if var_1_1 == var_1_8.CMD_UNLCOK_TIP then
					table = var_1_8

					if var_1_8.contains(var_8.data3_list, var_1_0) then
						return
					end

					pg = var_1_8

					local var_1_10 = var_1_8.TimeMgr.GetInstance()

					if var_1_8.GetServerTime(var_1_10) < var_8.data2 then
						pg = var_1_8
						...
						var_1_8(var_1_11, var_1_10012("bulin_tip_other2"))
					...
					if var_1_1 == var_1_8.CMD_EARN_EXTRA then
						...
						var_1_8(var_1_12, var_1_10012.ACTIVITY_OPERATION, {
							cmd = 4,
							activity_id = var_1_2
						})
		...
		var_10.Send(var_1_13, 11202, {
			...
			if arg_2_0.result == 0 then
				...
				var_2_1 = var_1_1
				PuzzleActivity = var_2_0

				if var_2_1 == var_2_0.CMD_COMPLETE then
					var_2_1 = var_0
					var_2_1.data1 = 1
				else
					var_2_1 = var_1_1
					...
					if var_2_1 == var_2.CMD_ACTIVATE then
						...
						if var_2_1 == var_2.CMD_UNLCOK_TIP then
							...
							var_2_1 = var_0
							pg = var_2
							var_2_10003 = var_2.TimeMgr.GetInstance()
							var_2_1.data2 = var_2.GetServerTime(var_2_10003) + var_0.cd
						else
							var_2_1 = var_1_1
							PuzzleActivity = var_2
