...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_6.getData(var_1_3).gold < var_1_2 then
		pg = var_1_4
		var_1_10009 = var_1_4.TipsMgr.GetInstance()
		var_1_4 = var_1_4.ShowTips
		i18n = var_1_10010

		var_1_4(var_1_10009, var_1_10010("common_no_resource"))
	...
	local var_1_5 = var_1_4(var_1_10009)
	...
	if var_1_0 == var_0_1.TYPE.ENDING then
		...
		if var_9.contains(var_1_5:GetAllEndings(), var_1_1) then
			...
			var_1_7(var_1_6, var_11("common_already owned"))
	...
	if var_1_0 == var_0_1.TYPE.MEMORY then
		...
		if var_9.contains(var_1_5:GetMemories(), var_1_1) then
			...
			var_1_9(var_1_8, var_11("common_already owned"))
	...
	if var_1_0 == var_0_1.TYPE.POLAROID then
		...
		if var_1_11.contains(var_1_5:GetPolaroidList(), var_1_1) then
			...
			var_1_11(var_1_10, var_11("common_already owned"))
	...
	var_9.Send(var_1_12, 27049, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_3(var_2_2, var_2_10003("child_buy_collect_success"))
			...
			var_2_3(var_2_4, var_2_10003.EDUCATE_BUY_COLLECT_DONE)
		else
			pg = var_2_3
			...
			var_2_6(var_2_5, var_2_10003("educate buy collect error: ", arg_2_0.result))
		end
