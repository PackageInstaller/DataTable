		...
		var_7.Send(var_1_5, 11202, {
			...
			if arg_2_0.result == 0 then
				...
				if var_2_3 == var_2_10004.MONOPOLY_OP_AWARD then
					...
					if var_9.contains(var_2_9, 1) then
						var_2_15 = var_2_1.data1_list
						var_2_15[3] = var_2_1.data1_list[3] + 1
					end
					...
					if var_2_3 == var_2_15.MONOPOLY_OP_THROW then
						print = var_2_16

						var_2_16("点数 : ", var_2_11)

						var_2_1.data3 = var_2_11
						var_2_16 = var_2_1.data1_list
						var_2_16[2] = var_2_1.data1_list[2] + 1
						var_2_16 = var_2_1:getDataConfig("reward_time")
						...
						if var_2_17 ~= 0 then
							math = var_12
							var_2_18 = var_12.min(var_2_1.data1_list[2], var_2_17)
						else
						...
						if var_2_16 > 0 then
							...
							math = var_2_10013
							var_2_19[1] = var_2_10013.floor(var_2_18 / var_2_16)
						else
						...
						var_12.updateActivity(var_2_20, var_2_1)
						...
						if var_2_3 == var_2_16.MONOPOLY_OP_MOVE then
							var_2_1.data3 = var_2_11
							...
							if var_2_3 == var_2_21.MONOPOLY_OP_TRIGGER then
								...
								var_10.updateActivity(var_2_24, var_2_1)

								if #var_2_2 > 0 then
									local var_2_25 = arg_1_0
									local var_2_26 = var_10.sendNotification

									GAME = var_12

									var_2_26(var_2_25, var_12.MONOPOLY_AWARD_DONE, {
										awards = var_2_2,
										autoFlag = var_1_0,
										callback = function()
											var_2_23(var_2_9, var_2_12)
								...
								if var_2_3 == var_2_23.MONOPOLY_OP_PICK then
									if not var_0.callback then
									...
									var_10.updateActivity(var_2_29, var_2_1)
									...
									if #var_2_2 > 0 then
										...
										var_2_31(var_2_30, var_12.MONOPOLY_AWARD_DONE, {
											awards = var_2_2,
											autoFlag = var_1_0,
											callback = function()
												var_2_27(var_2_9, var_2_12)
									...
									var_2_31("cmd : 6", " 路径 ： ", var_2_10, "  剩余步数 ： ", var_2_11)
								else
									ActivityConst = var_2_27

									if var_2_3 == var_2_27.MONOPOLY_OP_DIALOGUE then
										table = var_9
										...
										var_9.updateActivity(var_2_32, var_2_1)

										print = var_9

										var_9("cmd : 8", " 路径 ： ", var_2_10, "  剩余步数 ： ", var_2_11)
									else
										ActivityConst = var_9

										local var_2_33

										if var_2_3 == var_9.MONOPOLY_OP_AUTO then
											...
											var_2_33("cmd : 7", " 路径 ： ", var_2_10, "  剩余步数 ： ", var_2_11)
										else
											ActivityConst = var_2_33

											if var_2_3 == var_2_33.MONOPOLY_OP_ROUND_AWD then
												var_2_1.data1_list[6] = var_0.arg1

												local var_2_35 = var_0

												var_9.updateActivity(var_2_35, var_2_1)
												...
												if #var_2_2 > 0 then
													...
													var_2_37(var_2_36, var_11.MONOPOLY_AWARD_DONE, {
														awards = var_2_2,
														autoFlag = var_1_0
													})
												end
												...
												var_2_37("cmd : 9", " 路径 ： ", var_2_10, "  剩余步数 ： ", var_2_11)
											end
										end
									end
								end
