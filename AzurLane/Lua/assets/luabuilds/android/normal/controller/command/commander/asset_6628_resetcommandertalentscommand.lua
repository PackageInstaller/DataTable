...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_1_1.TimeMgr.GetInstance()
	local var_1_3 = var_6.GetServerTime(var_1_2)
	local var_1_4 = var_5

	if var_1_3 < var_5.GetNextResetAbilityTime(var_1_4) then
		pg = var_1_3
		...
		var_1_6(var_1_5, var_1_4("commander_reset_talent_time_no_rearch"))

		return
	end

	local var_1_7 = var_5:getTalentOrigins()
	local var_1_8 = var_5:getTalents()
	local var_1_9, var_1_10

	if #var_1_7 == #var_1_8 then
		_ = var_1_10

		if var_1_10.all(var_1_7, function(arg_2_0)
			_ = var_2_10001

			return var_2_10001.any(var_1_8, function(arg_3_0)
				return arg_3_0.id == arg_2_0.id
			end)
		end) then
			pg = var_1_10
			var_1_9 = var_1_10.TipsMgr.GetInstance()
			var_1_10 = var_1_10.ShowTips
			i18n = var_10

			var_1_10(var_1_9, var_10("commander_reset_talent_is_not_need"))
	...
	local var_1_11 = var_1_10(var_1_9)
	...
	if var_1_12.gold < var_1_13 then
		...
		var_1_15(var_1_14, var_1_10013("common_no_resource"))
	...
	var_11.Send(var_1_16, 25014, {
		...
		if arg_4_0.result == 0 then
			...
			local var_4_8 = var_2_10003.TimeMgr.GetInstance()

			var_4_7(var_4_6, var_2_10003.GetServerTime(var_4_8))
			...
			var_4_7(var_4_9, var_2_10003.COMMANDER_RESET_TALENTS_DONE)
			...
			var_4_7(var_4_10, var_2_10003("commander_reset_talent_success"))
		else
			pg = var_4_7
			...
			var_4_12(var_4_11, var_2_10003("commander_reset_talent_erro", arg_4_0.result))
		end
