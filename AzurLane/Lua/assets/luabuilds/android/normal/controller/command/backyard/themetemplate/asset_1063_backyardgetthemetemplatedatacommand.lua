...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 19113, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10002 = arg_2_0.has_fav and 1 or 0
			...
			var_2_4(var_2_3, var_8.BACKYARD_GET_THEME_TEMPLATE_DATA_DONE, {
				template = var_2_1
			})
		elseif arg_2_0.result == 20 then
			...
			if var_1.GetShopThemeTemplateById(var_2_10003, var_1_0) then
				var_2_10003 = var_1

				var_1.DeleteShopThemeTemplate(var_2_10003, var_1_0)
			end

			var_2_10003 = var_1

			if var_1.GetCollectionThemeTemplateById(var_2_10003, var_1_0) then
				var_2_10003 = var_1

				var_1.DeleteCollectionThemeTemplate(var_2_10003, var_1_0)
			end
			...
			var_2_5(var_2_10003, var_4("Backyard_theme_template_be_delete_tip"))
		else
			pg = var_1
