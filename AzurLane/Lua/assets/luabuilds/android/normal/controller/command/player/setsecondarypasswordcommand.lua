...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_3.Send(var_1_3, 11605, {
		password = var_1_1.pwd,
		notice = var_1_1.tip,
		system_list = var_1_1.settings
		...
		if arg_2_0.result == 0 then
			getProxy = var_2_0
			SecondaryPWDProxy = var_2_10003
			var_2_10004 = var_2_0(var_2_10003)

			var_2.OnFirstSet(var_2_10004, var_1_1)
		end
		...
		var_2_2(var_2_1, var_2_10004.SET_PASSWORD_DONE, arg_2_0)
