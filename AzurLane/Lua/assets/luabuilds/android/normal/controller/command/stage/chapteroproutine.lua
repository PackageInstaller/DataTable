...
function var_0_1.doDropUpdate(arg_2_0)
	...
	local var_2_2 = var_1_10003.map

	PlayerConst = var_1_10004

	var_2_0(var_2_1, var_2_2(var_1_10004.addTranDrop(arg_2_0.data.extra_drop_list), function(arg_3_0)
		arg_3_0.riraty = true
...
function var_0_1.doMapUpdate(arg_4_0)
	...
	if #var_4_0.map_update > 0 then
			...
			if var_5_0 == var_2_10002.AttachStory then
				...
				if var_5_1 == var_2.StoryTrigger then
					...
					if var_2.GetChapterCellAttachemnts(var_5_3)[var_5_2] then
						var_2_10004 = var_3.flag
						ChapterConst = var_2_10005

						if var_2_10004 == var_2_10005.CellFlagTriggerActive then
							var_2_10004 = arg_5_0.item_flag
							ChapterConst = var_5

							if var_2_10004 == var_5.CellFlagTriggerDisabled then
								pg = var_2_10004

								if var_2_10004.map_event_template[var_3.attachmentId].gametip ~= "" then
									pg = var_5
									...
									var_5_5(var_5_4, var_2_10007(var_2_10004))
								end
							end
						end
						...
						ChapterCell = var_2_10004
						var_2[var_5_2] = var_2_10004.New(arg_5_0)
					end
		...
		ChapterConst = var_7
		var_4_1 = var_4_4(var_4_5, var_7.DirtyAttachment)
		bit = var_5
		...
		ChapterConst = var_7
		var_4_2 = var_4_6(var_4_7, var_7.DirtyAutoAction)
	end
...
function var_0_1.doCellFlagUpdate(arg_6_0)
	...
	if #var_6_0.cell_flag_list > 0 then
		...
		ChapterConst = var_6
		var_6_1 = var_6_3(var_6_4, var_6.DirtyCellFlag)
	end
...
function var_0_1.doAIUpdate(arg_8_0)
	...
	if #var_8_0.ai_list > 0 then
		...
		ChapterConst = var_7
		var_8_1 = var_8_4(var_8_5, var_7.DirtyChampion)
		bit = var_5
		...
		ChapterConst = var_7
		var_8_2 = var_8_6(var_8_7, var_7.DirtyAutoAction)
	end
...
function var_0_1.doShipUpdate(arg_10_0)
	...
	if #var_10_0.ship_update > 0 then
		...
		var_4.each(var_10_0.ship_update, function(arg_11_0)
			...
			ChapterConst = var_3
			var_10_1 = var_11_1(var_11_2, var_3.DirtyStrategy)
		...
		ChapterConst = var_6
		var_10_1 = var_10_3(var_10_4, var_6.DirtyFleet)
	end
...
function var_0_1.doExtraFlagUpdate(arg_13_0)
	...
	if #var_13_0.add_flag_list > 0 or #var_13_0.del_flag_list > 0 then
		...
		local var_13_5 = var_6.DirtyFleet

		ChapterConst = var_7

		local var_13_6 = var_7.DirtyStrategy

		ChapterConst = var_8

		local var_13_7 = var_8.DirtyCellFlag

		ChapterConst = var_1_10009

		local var_13_8 = var_1_10009.DirtyFloatItems

		ChapterConst = var_1_10010
		arg_13_0.flag = var_13_3(var_13_4, var_13_5, var_13_6, var_13_7, var_13_8, var_1_10010.DirtyAttachment)
	end
...
function var_0_1.doRetreat(arg_14_0)
	...
	if var_14_0.id then
		if #var_14_2.fleets > 0 then
			...
			local var_14_5 = var_6.DirtyFleet

			ChapterConst = var_1_10007

			local var_14_6 = var_1_10007.DirtyAttachment

			ChapterConst = var_1_10008

			local var_14_7 = var_1_10008.DirtyChampion

			ChapterConst = var_1_10009
			var_14_1 = var_14_3(var_14_4, var_14_5, var_14_6, var_14_7, var_1_10009.DirtyStrategy)
		end
	else
...
function var_0_1.doMove(arg_15_0)
	...
	local var_15_3
	local var_15_4 = #var_15_1.move_path

	if 0 < var_15_4 then
		_ = var_15_4

		local var_15_5 = var_15_4.map

		_ = var_6
		var_15_3 = var_15_5(var_6.rest(var_15_1.move_path, 1), function(arg_16_0)
			return {
				row = arg_16_0.row,
		...
		local var_15_6 = var_5.bor
		local var_15_7 = var_15_0

		ChapterConst = var_7

		local var_15_8 = var_7.DirtyAutoAction

		ChapterConst = var_8
		var_15_0 = var_15_6(var_15_7, var_15_8, var_8.DirtyWeather)
	end
...
function var_0_1.doOpenBox(arg_17_0)
	...
	local var_17_4 = var_3.getChapterCell(var_17_3, var_17_2.row, var_17_2.column)

	ChapterConst = var_17_3
	var_17_4.flag = var_17_3.CellFlagDisabled
	bit = var_7

	local var_17_5 = var_7.bor
	local var_17_6 = var_17_1

	ChapterConst = var_9

	local var_17_7 = var_17_5(var_17_6, var_9.DirtyAttachment)

	pg = var_7

	local var_17_8 = var_7.box_data_template[var_17_4.attachmentId]

	assert = var_8

	var_8(var_17_8, "box_data_template not exist: " .. var_17_4.attachmentId)

	local var_17_9 = var_17_8.type

	ChapterConst = var_9

	local var_17_11, var_17_12

	if var_17_9 == var_9.BoxStrategy then
		local var_17_10 = var_17_8.effect_id

		var_17_11 = var_17_8.effect_arg
		var_17_12 = var_4

		var_4.achievedStrategy(var_17_12, var_17_10, var_17_11)

		table = var_10

		local var_17_13 = var_10.insert

		var_17_12 = var_17_0
		Drop = var_12

		local var_17_14 = var_12.New
		local var_17_15 = {}

		DROP_TYPE_STRATEGY = var_1_10014
		var_17_15.type = var_1_10014
		var_17_15.id = var_17_10
		var_17_15.count = var_17_11

		var_17_13(var_17_12, var_17_14(var_17_15))

		bit = var_17_13

		local var_17_16 = var_17_13.bor

		var_17_12 = var_17_7
		ChapterConst = var_12
		var_17_7 = var_17_16(var_17_12, var_12.DirtyStrategy)
	else
		local var_17_17 = var_17_8.type

		ChapterConst = var_17_11

		if var_17_17 == var_17_11.BoxSupply then
			local var_17_18, var_17_19 = var_3:getFleetAmmo(var_4)
			local var_17_20 = var_4.restAmmo

			math = var_17_12
			var_4.restAmmo = var_17_20 + var_17_12.min(var_17_18 - var_17_19, var_17_8.effect_id)
			bit = var_10
			...
			ChapterConst = var_12
			var_17_7 = var_17_21(var_17_22, var_12.DirtyFleet)
			pg = var_10
			...
			var_17_24(var_17_23, var_12("level_ammo_supply_p1", var_17_8.effect_id))
		end
	end

	var_3:clearChapterCell(var_17_2.row, var_17_2.column)

	arg_17_0.flag = var_17_7
	bit = var_8
	...
	ChapterConst = var_10
	arg_17_0.extraFlag = var_17_25(var_17_26, var_10.DirtyAutoAction)
...
function var_0_1.doPlayStory(arg_18_0)
	...
	local var_18_3 = var_2.getChapterCell(var_18_2, var_18_1.row, var_18_1.column)

	ChapterConst = var_18_2
	var_18_3.flag = var_18_2.CellFlagDisabled

	var_2:updateChapterCell(var_18_3)

	bit = var_6

	local var_18_4 = var_6.bor
	local var_18_5 = var_18_0

	ChapterConst = var_8
	arg_18_0.flag = var_18_4(var_18_5, var_8.DirtyAttachment)
...
function var_0_1.doAmbush(arg_19_0)
	...
	if var_19_0.arg1 == 1 then
		...
		local var_19_3 = var_2:getChapterCell(var_19_2.row, var_19_2.column).flag

		ChapterConst = var_7

		if var_19_3 == var_7.CellFlagAmbush then
			var_2:clearChapterCell(var_19_2.row, var_19_2.column)
		end

		pg = var_19_3

		local var_19_4 = var_19_3.TipsMgr.GetInstance()
		local var_19_5 = var_6.ShowTips
		local var_19_6 = var_5.flag

		ChapterConst = var_1_10009

		if var_19_6 == var_1_10009.CellFlagActive then
			i18n = var_19_6

			if not var_19_6("chapter_tip_aovid_failed") then
				i18n = var_19_6
				var_19_6 = var_19_6("chapter_tip_aovid_succeed")
			end
...
function var_0_1.doStrategy(arg_20_0)
	...
	if var_20_3 == var_1_10006.StgTypeForm then
		...
		pg = var_20_4
		var_1_10007 = var_20_4.TipsMgr.GetInstance()
		var_20_4 = var_20_4.ShowTips
		i18n = var_8

		var_20_4(var_1_10007, var_8("chapter_tip_change", var_4.name))
	...
	if var_20_3 == var_20_4.StgTypeConsume then
		var_1_10007 = var_20_2.fleet

		var_20_3.consumeOneStrategy(var_1_10007, var_4.id)
		...
		if var_20_5 ~= var_1_10007.StrategyRepair then
			...
			if var_20_5 == var_1_10007.StrategyExchange then
				pg = var_20_5
				var_1_10007 = var_20_5.TipsMgr.GetInstance()
				var_20_5 = var_20_5.ShowTips
				i18n = var_8

				var_20_5(var_1_10007, var_8("chapter_tip_use", var_4.name))
			end
			...
			if var_20_5 == var_1_10007.StrategyExchange then
				var_1_10007 = var_20_2
				var_20_5 = var_20_2.getFleetById(var_1_10007, var_20_1.id)

				local var_20_6 = var_20_2:getFleetById(var_20_1.arg2).line

				var_1_10007.line = var_20_5.line
				var_20_5.line = var_20_6
				bit = var_20_6

				local var_20_7 = var_20_6.bor
				local var_20_8 = var_20_0

				ChapterConst = iter_20_1
				var_20_0 = var_20_7(var_20_8, iter_20_1.DirtyFleet)
			end
			...
			if false then
				...
				if var_20_3 == var_20_5.StgTypeBindSupportConsume then
					var_1_10007 = var_20_2:getChapterSupportFleet()
			...
			local var_20_9 = var_20_3.bor
			local var_20_10 = var_20_0

			ChapterConst = var_1_10007
			arg_20_0.flag = var_20_9(var_20_10, var_1_10007.DirtyStrategy)
...
function var_0_1.doRepair(arg_21_0)
	...
	var_1.repairTimes = var_1_10001(var_1_10002).repairTimes + 1
	ChapterConst = var_2
	...
	if var_21_0 < var_1.repairTimes then
		...
		local var_21_3 = var_5(var_1_10006)
...
function var_0_1.doSupply(arg_22_0)
	...
	local var_22_5 = var_2
	local var_22_6 = var_2.getChapterCell(var_22_5, var_22_4.row, var_22_4.column)

	math = var_22_5

	local var_22_7 = var_22_5.min(var_22_6.attachmentId, var_22_2 - var_22_3)

	var_22_6.attachmentId = var_22_6.attachmentId - var_22_7
	var_22_1.restAmmo = var_22_1.restAmmo + var_22_7

	var_2:updateChapterCell(var_22_6)
	...
	if var_22_6.attachmentId > 20 then
		...
		local var_22_8 = var_22_9.TipsMgr.GetInstance()

		var_22_9 = var_22_9.ShowTips
		i18n = var_11

		var_22_9(var_22_8, var_11("level_ammo_supply_p1", var_22_7))
	elseif var_22_6.attachmentId > 0 then
		pg = var_22_9

		local var_22_10 = var_22_9.TipsMgr.GetInstance()

		var_22_9 = var_22_9.ShowTips
		i18n = var_11

		var_22_9(var_22_10, var_11("level_ammo_supply", var_22_7, var_22_6.attachmentId))
	else
		pg = var_22_9

		local var_22_11 = var_22_9.TipsMgr.GetInstance()

		var_22_9 = var_22_9.ShowTips
		i18n = var_11

		var_22_9(var_22_11, var_11("level_ammo_empty", var_22_7))
	end

	bit = var_22_9

	local var_22_12 = var_22_9.bor
	local var_22_13 = var_22_0

	ChapterConst = var_11

	local var_22_14 = var_11.DirtyAttachment

	ChapterConst = var_1_10012
	arg_22_0.flag = var_22_12(var_22_13, var_22_14, var_1_10012.DirtyFleet)
...
function var_0_1.doSubState(arg_23_0)
	...
	ChapterConst = var_1_10006
	arg_23_0.flag = var_23_2(var_23_3, var_1_10006.DirtyStrategy)
...
function var_0_1.doCollectAI(arg_24_0)
	...
	if var_24_0.submarine_act_list then
		...
		var_2.each(var_24_0.submarine_act_list, function(arg_25_0)
			...
			SubAIAction = var_2_10003

			var_25_0(var_25_1, var_2_10003.New(arg_25_0))
	...
	if var_24_0.escort_act_list then
		...
		var_2.each(var_24_0.escort_act_list, function(arg_26_0)
			...
			TransportAIAction = var_2_10003

			var_26_0(var_26_1, var_2_10003.New(arg_26_0))
	...
	var_2.each(var_24_0.ai_act_list, function(arg_27_0)
		...
		if var_27_1 == var_2_10003.ActType_TargetDown then
			...
			ChapterConst = var_27_2

			if var_27_1 == var_27_2.OpStrategy then
				var_27_1 = arg_24_0.op.arg1
				ChapterConst = var_27_2

				if var_27_1 == var_27_2.StrategyMissileStrike then
					...
					if var_27_1 == var_27_2.StrategyAirSupport then
			...
			if var_27_1 == var_27_2.ActType_Expel then
				ChapterExpelAIAction = var_27_1

				local var_27_3 = var_27_1.New(arg_27_0)

				var_27_0.SetTargetLine(var_27_3, {
					row = arg_24_0.op.arg2,
					column = arg_24_0.op.arg3
				}, {
	...
	var_2.each(var_24_0.fleet_act_list, function(arg_28_0)
		...
		FleetAIAction = var_2_10003

		var_28_0(var_28_1, var_2_10003.New(arg_28_0))
...
function var_0_1.doBarrier(arg_29_0)
	...
	var_29_2(var_29_3, "cell not exist: " .. var_29_1.arg1 .. ", " .. var_29_1.arg2)

	ChapterConst = var_29_2

	local var_29_4 = var_29_2.AttachBox

	_ = var_6

	local var_29_5 = var_6.detect

	pg = var_7

	local var_29_6 = var_29_5(var_7.box_data_template.all, function(arg_30_0)
		pg = var_2_10001
	...
	local var_29_11 = var_9.DirtyAttachment

	ChapterConst = var_10
	arg_29_0.flag = var_29_9(var_29_10, var_29_11, var_10.DirtyStrategy)
...
function var_0_1.doSkipBattle(arg_32_0)
	...
	local var_32_3 = var_1_10004.DirtyStrategy

	ChapterConst = var_1_10005

	local var_32_4 = var_1_10005.DirtyAttachment

	ChapterConst = var_1_10006

	local var_32_5 = var_1_10006.DirtyAchieve

	ChapterConst = var_1_10007

	local var_32_6 = var_1_10007.DirtyFleet

	ChapterConst = var_1_10008
	arg_32_0.flag = var_32_1(var_32_2, var_32_3, var_32_4, var_32_5, var_32_6, var_1_10008.DirtyChampion)
...
function var_0_1.doEnemyRound(arg_35_0)
	...
	local var_35_3 = var_35_0.getPlayType(var_35_2)

	ChapterConst = var_35_2

	if var_35_3 == var_35_2.TypeDefence then
		bit = var_35_3
		var_35_3 = var_35_3.bor

		local var_35_4 = arg_35_0.flag

		ChapterConst = var_1_10005
		arg_35_0.flag = var_35_3(var_35_4, var_1_10005.DirtyAttachment)
	end

	bit = var_35_3

	local var_35_5 = var_35_3.bor
	local var_35_6 = var_35_1

	ChapterConst = var_1_10005
	arg_35_0.extraFlag = var_35_5(var_35_6, var_1_10005.DirtyAutoAction)
...
function var_0_1.doTeleportByPortal(arg_36_0)
	...
	if var_36_3 == var_1_10005.OpMove then
		var_36_4 = var_36_1
		var_36_2 = var_36_1.GetCellEventByKey(var_36_4, "jump", var_36_0.row, var_36_0.column)
	else
		local var_36_5 = arg_36_0.op.type

		ChapterConst = var_36_4

		if var_36_5 == var_36_4.OpSubTeleport then
	...
	local var_36_7 = arg_36_0.op.type

	ChapterConst = var_1_10006

	if var_36_7 == var_1_10006.OpMove then
		local var_36_8 = var_36_1
		local var_36_9 = var_36_1.getFleet

		FleetType = var_1_10007

		if var_36_9(var_36_8, var_1_10007.Normal, var_36_6.row, var_36_6.column) then
			return
		end
	end
	...
	arg_36_0.teleportPaths = var_36_10
	table = var_36_10

	var_36_10.insert(arg_36_0.teleportPaths, {
		row = var_36_0.row,
	...
	var_5.insert(arg_36_0.teleportPaths, var_36_6)
...
function var_0_1.doCollectCommonAction(arg_37_0)
	...
	ChapterCommonAction = var_1_10003

	var_37_1(var_37_2, var_1_10003.New(arg_37_0))
...
function var_0_1.AddBoxAction(arg_38_0)
	...
	local var_38_1 = var_1
	local var_38_2 = var_1.getChapterCell(var_38_1, var_38_0.row, var_38_0.column)

	pg = var_38_1

	local var_38_3 = var_38_1.box_data_template[var_38_2.attachmentId]

	assert = var_6

	var_6(var_38_3, "box_data_template not exist: " .. var_38_2.attachmentId)

	local var_38_4 = var_38_3.type

	ChapterConst = var_7

	local var_38_7

	if var_38_4 == var_7.BoxStrategy then
		local var_38_5 = var_38_3.effect_id
		local var_38_6 = var_38_3.effect_arg

		table = var_38_7
		var_38_7 = var_38_7.insert

		local var_38_8 = arg_38_0.items

		Drop = var_1_10010

		local var_38_9 = var_1_10010.New
		local var_38_10 = {}

		DROP_TYPE_STRATEGY = var_1_10012
		var_38_10.type = var_1_10012
		var_38_10.id = var_38_5
		var_38_10.count = var_38_6

		var_38_7(var_38_8, var_38_9(var_38_10))
	end
	...
	arg_38_0.aiActs = var_38_11
	table = var_38_11

	local var_38_12 = var_38_11.insert
	local var_38_13 = arg_38_0.aiActs

	ChapterBoxAction = var_38_7

	var_38_12(var_38_13, var_38_7.New(arg_38_0))
