...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_3.Send(var_1_1, 11202, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_10003 = var_1.getActivityById(var_2_0, var_1_0.actId)

			local var_2_1 = var_1.GetSeriesData(var_2_10003)

			var_1:SetSeriesData(nil)

			PlayerConst = var_2_10003
			var_2_10003 = var_2_10003.GetTranAwards(var_1_0, arg_2_0)

			local var_2_2 = var_1_0.actId

			getProxy = var_5
			ActivityProxy = var_2_10006

			local var_2_3 = var_5(var_2_10006)
			local var_2_4 = var_5.GetBossRushRuntime(var_2_3, var_2_2).settlementData

			getProxy = var_2_3
			ActivityProxy = var_7

			local var_2_5 = var_2_3(var_7)
			...
			if var_2_4.win then
				...
				local var_2_9 = var_1
				local var_2_10 = var_1.getConfig(var_2_9, "type")

				ActivityConst = var_2_9

				if var_2_10 ~= var_2_9.ACTIVITY_TYPE_BOSS_RUSH_DAL_COLLAB then
			...
			for iter_2_0, iter_2_1 in var_7(var_2_4) do
				...
				var_2_10012.insertto(var_2_10003, iter_2_1.drops)

				table = var_2_10012

				var_2_10012.insertto(var_2_10003, iter_2_1.extraDrops)
			end
			...
			if var_2_1 then
				...
				var_2_1.AddFinalResults(var_2_11, var_2_4)
			end

			getProxy = var_7
			ActivityProxy = var_2_11

			local var_2_12 = var_7(var_2_11)

			var_7.updateActivity(var_2_12, var_1)
			...
			var_7({
				function(arg_3_0, arg_3_1)
					...
					if var_1_0.callback then
						...
						var_3_2(var_3_1, var_3_10005.BOSSRUSH_SETTLE_DONE, var_3_0)
					end
			...
			var_2_14(var_2_13, var_2_10003("", arg_2_0.result))
		end
...
function var_0_1.ConcludeEXP(arg_6_0, arg_6_1, arg_6_2)
	...
	if var_6_0 == var_1_10006 then
		...
		for iter_6_0, iter_6_1 in var_1_10006(var_1_10007.extraenemy_series_template) do
			pg = var_1_10011
	...
	for iter_6_2, iter_6_3 in iter_6_0(arg_6_0.re40004) do
		...
		SYSTEM_BOSS_RUSH = var_1_10016

		if var_6_0 ~= var_1_10016 then
			SYSTEM_BOSS_RUSH_COLLABRATE = var_1_10016
		...
		local var_6_7, var_6_8 = var_6_5(var_6_6, var_1_10016)

		var_1_10016 = var_6_3[iter_6_2]
		var_1_10016.oldShips = var_6_7
		var_1_10016 = var_6_3[iter_6_2]
		var_1_10016.newShips = var_6_8

		local var_6_9

		var_1_10016, var_6_9 = var_0_1.GenerateCommanderExp(iter_6_3.commander_exp)
		var_6_3[iter_6_2].oldCmds = var_1_10016
		var_6_3[iter_6_2].newCmds = var_6_9
		...
		if var_1_10021.battle_cost_template[var_6_0].oil_cost > 0 then
			...
			var_23.Foreach(var_6_7, function(arg_7_0, arg_7_1)
				...
				local var_7_3 = arg_7_1.getTeamType(var_7_2)

				TeamType = var_7_2

				local var_7_4 = var_7_3 == var_7_2.Submarine and 2 or 1

				var_6_13[var_7_4][1] = var_6_13[var_7_4][1] + var_7_0
				var_6_13[var_7_4][2] = var_6_13[var_7_4][2] + var_7_1
...
function var_0_1.addShipsExp(arg_8_0, arg_8_1)
	...
	for iter_8_0, iter_8_1 in var_1_10005(arg_8_0) do
		...
		local var_8_8 = var_8_2.getShipById(var_8_7, var_8_3)

		Clone = var_8_7
		var_8_0[var_8_3] = var_8_7(var_8_8)
		var_8_0[var_8_3].expAdd = var_8_4

		var_8_8:addExp(var_8_4, arg_8_1)

		if arg_8_1 then
			pg = var_15

			if var_15.gameset.level_get_proficency.key_value < var_8_8.level or var_8_8.level == var_15 and var_8_8.exp > 0 then
				pg = var_16

				if var_16.ship_data_template[var_8_8.configId].can_get_proficency == 1 then
					getProxy = var_17
					NavalAcademyProxy = var_18

					local var_8_9 = var_17(var_18)

					var_17.AddCourseProficiency(var_8_9, var_8_4)
				end
			end
		end

		if var_8_5 then
			var_8_8:addLikability(var_8_5 - 16)
		end

		if var_8_6 then
			var_8_8:cosumeEnergy(var_8_6)
		end

		Clone = var_15
		var_8_1[var_8_3] = var_15(var_8_8)

		var_8_2:updateShip(var_8_8)
	end
...
function var_0_1.GenerateCommanderExp(arg_9_0)
	...
	local var_9_2 = var_1_10003(var_1_10004)
	...
	for iter_9_0, iter_9_1 in var_1_10004(arg_9_0) do
		...
		local var_9_6 = var_9_2.getCommanderById(var_9_5, var_9_3)

		Clone = var_9_5
		var_9_0[var_9_3] = var_9_5(var_9_6)
		var_9_0[var_9_3].expAdd = iter_9_1.exp

		var_9_6:addExp(var_9_4)

		Clone = var_12
		var_9_1[var_9_3] = var_12(var_9_6)

		var_9_2:updateCommander(var_9_6)
	end
	...
	for iter_10_0, iter_10_1 in var_2(var_10_0) do
		...
		var_1_10007.each(var_10_0[iter_10_0], function(arg_11_0)
			...
			if var_11_0 == var_2_10002 then
				...
				var_11_2 = var_2(var_2_10003) and var_2.shipGroups[var_11_1] == nil
				arg_11_0.virgin = var_11_2
			end
