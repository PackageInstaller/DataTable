...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_4.Send(var_1_3, 60022, {
		...
		if arg_2_0.result == 0 then
			...
			var_1.deleteRequest(var_2_10003, var_1_0)
			...
			var_2_0(var_2_10003, var_4.GUIDL_REQUEST_REJECT_DONE)
			...
			if not var_1_2 then
				...
				var_2_1(var_2_10003, var_4("guild_rejecet_apply_sucess"))
			end
		else
			pg = var_1
			...
			var_2_3(var_2_2, var_2_10003("guild_reject_erro", arg_2_0.result))
		end
