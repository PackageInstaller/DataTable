...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 17603, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10003.EQUIP_CODE_SHARE_DONE)
			...
			var_2_3(var_2_2, var_2_10003("equipcode_share_success"))
		elseif arg_2_0.result == 7 then
			...
			var_2_5(var_2_4, var_2_10003("equipcode_share_errorcode7"))
		else
			local var_2_7
			...
			if arg_2_0.result == 44 then
				...
				var_2_7(var_2_6, var_2_10003("equipcode_share_errorcode44"))
			else
				pg = var_2_7
