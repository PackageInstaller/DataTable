...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_6(var_1_5, var_1_10011.ACTIVITY_TYPE_COLLECTION_EVENT) or var_9:isEnd() then
		pg = var_1_5
		...
		var_1_5(var_1_7, var_1_10012("common_activity_end"))
		...
		if arg_2_0.result == 0 then
			...
			if var_2_0 == var_2_10002.COLLETION_EVENT_OP_JOIN then
				...
				if var_2_0 == var_2.COLLETION_EVENT_OP_SUBMIT then
					...
					getProxy = var_2_0
					EventProxy = var_2_1
					var_2_1 = var_2_0(var_2_1)

					var_2_0.CheckAddActivityEvent(var_2_1)
					...
					var_2_0 = var_0.cmd
					ActivityConst = var_2_1

					if var_2_0 == var_2_1.COLLETION_EVENT_OP_GIVE_UP then
