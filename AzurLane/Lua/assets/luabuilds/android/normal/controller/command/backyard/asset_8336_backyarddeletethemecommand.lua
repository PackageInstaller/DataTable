...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_3.getThemeById(var_1_2, var_1_1) then
		pg = var_1_4
		...
		var_1_4(var_1_3, var_6("backyard_theme_no_exist"))
	...
	var_4.Send(var_1_5, 19022, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2.deleteTheme(var_2_0, var_1_1)
			...
			var_2_2(var_2_1, var_2_10003.DELETE_BACKYARD_THEME_DONE)
			...
			var_2_2(var_2_3, var_2_10003("backayrd_theme_delete_sucess"))
		else
			pg = var_2_2
			...
			var_2_5(var_2_4, var_2_10003("backayrd_theme_delete_erro"))
		end
