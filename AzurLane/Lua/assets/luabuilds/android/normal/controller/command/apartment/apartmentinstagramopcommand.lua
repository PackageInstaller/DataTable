...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_4.GetInstagramList(var_1_1, var_2.shipId)

	_ = var_1_1

	if not var_1_1.detect(var_1_2, function(arg_2_0)
	...
	if var_1_0 == var_6.OP_DISCUSS then
		arg_1_0:HandleDiscuss(var_5, var_2)
	else
		Instagram3Dorm = var_6

		if var_1_0 == var_6.OP_READ then
			arg_1_0:HandleRead(var_5, var_2)
		else
			Instagram3Dorm = var_6

			if var_1_0 == var_6.OP_LIKE then
				arg_1_0:HandleLike(var_5, var_2)
			else
				Instagram3Dorm = var_6

				if var_1_0 == var_6.OP_SHARE then
					arg_1_0:HandleShare(var_5, var_2)
				else
					Instagram3Dorm = var_6

					if var_1_0 == var_6.OP_EXIT then
...
function var_0_1.HandleDiscuss(arg_3_0, arg_3_1, arg_3_2)
	...
	var_3.Send(var_3_0, 28028, {
		...
		if arg_4_0.result == 0 then
			...
			var_4_2(var_4_1, var_2_10003.APARTMENT_INS_OP_DONE, {
				op = arg_3_2.op
			})
		else
			pg = var_4_2
...
function var_0_1.HandleRead(arg_5_0, arg_5_1, arg_5_2)
	...
	var_3.Send(var_5_0, 28026, {
		...
		if arg_6_0.result == 0 then
			...
			var_6_2(var_6_1, var_2_10003.APARTMENT_INS_OP_DONE, {
				op = arg_5_2.op
			})
		else
			pg = var_6_2
...
function var_0_1.HandleLike(arg_7_0, arg_7_1, arg_7_2)
	...
	var_3.Send(var_7_0, 28026, {
		...
		if arg_8_0.result == 0 then
			...
			var_8_2(var_8_1, var_2_10003.APARTMENT_INS_OP_DONE, {
				op = arg_7_2.op
			})
		else
			pg = var_8_2
...
function var_0_1.HandleShare(arg_9_0, arg_9_1, arg_9_2)
	...
	var_3.Send(var_9_0, 28026, {
		...
		if arg_10_0.result == 0 then
			...
			var_10_1(var_10_0, var_2_10003.ShareMgr.TypeInstagram)
			...
			var_10_1(var_10_2, var_2_10003.APARTMENT_INS_OP_DONE, {
				op = arg_9_2.op
			})
		else
			pg = var_10_1
			...
			var_10_4(var_10_3, var_2_10003[arg_10_0.result] .. arg_10_0.result)
		end
...
function var_0_1.HandleExit(arg_11_0, arg_11_1, arg_11_2)
	...
	var_3.Send(var_11_0, 28026, {
		...
		if arg_12_0.result == 0 then
			...
			local var_12_2 = var_2_10003.TimeMgr.GetInstance()

			var_12_1(var_12_0, var_2_10003.GetServerTime(var_12_2))
			...
			var_12_1(var_12_3, var_2_10003.APARTMENT_INS_OP_DONE, {
				op = arg_11_2.op
			})
		else
			pg = var_12_1
			...
			var_12_5(var_12_4, var_2_10003[arg_12_0.result] .. arg_12_0.result)
		end
