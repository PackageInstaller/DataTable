		...
		var_0.Send(var_3_0, 33207, {
			...
			if arg_4_0.result == 0 then
				function var_4_0(arg_5_0, arg_5_1, arg_5_2)
					...
					local var_5_0 = var_4_10003(var_4_10004)
					local var_5_1 = {}
					local var_5_2 = {}
					local var_5_3 = arg_5_0
					local var_5_4 = arg_5_0.GetShipVOs(var_5_3)
					...
					for iter_5_0, iter_5_1 in var_5_3(var_5_4) do
						...
						local var_5_5 = var_5_0:getShipById(iter_5_1.id)
				...
				var_3_10003 = arg_4_0.exp

				local var_4_2 = arg_4_0.intimacy
				local var_4_3 = var_0
				local var_4_4 = var_5.GetFleets(var_4_3)

				pairs = var_4_3

				for iter_4_0, iter_4_1 in var_4_3(var_4_4) do
					local var_4_5 = var_4_0(iter_4_1, var_3_10003, var_4_2)
				...
				if var_1_6 then
					...
					var_4_12(var_4_11, var_4_13, var_10.getMaxProgress(var_4_14))
				end
				...
				var_4_18(var_4_17, var_3_10003("task_submitTask", arg_4_0.result))
			end
