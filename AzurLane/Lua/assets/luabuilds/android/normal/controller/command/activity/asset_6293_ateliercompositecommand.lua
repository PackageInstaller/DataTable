...
function var_0_1.execute(arg_3_0, arg_3_1)
	...
	local var_3_3 = var_1_10006(var_1_10007)
	local var_3_4 = var_6.getActivityByType

	ActivityConst = var_1_10008

	local var_3_5 = var_3_4(var_3_3, var_1_10008.ACTIVITY_TYPE_ATELIER_LINK)
	...
	local var_3_6 = var_3_3.ConnectionMgr.GetInstance()
	...
	var_7.Send(var_3_6, 26053, {
		...
		if arg_4_0.result == 0 then
			...
			var_3_5 = var_4_1(var_4_0, var_2_10003.ACTIVITY_TYPE_ATELIER_LINK)
			...
			var_4_2.each(var_3_1, function(arg_5_0)
			...
			var_2.AddFormulaUseCount(var_2_10003, var_3_0, var_3_2)

			getProxy = var_2
			ActivityProxy = var_2_10003
			var_2_10003 = var_2(var_2_10003)

			var_2.updateActivity(var_2_10003, var_3_5)
			...
			var_2_10003(var_4_4, var_5.COMPOSITE_ATELIER_RECIPE_DONE, var_4_3)
		else
			pg = var_4_1

			local var_4_5 = var_4_1.TipsMgr.GetInstance()
			local var_4_6 = var_1.ShowTips

			errorTip = var_2_10003

			var_4_6(var_4_5, var_2_10003("", arg_4_0.result))
		end
