...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 17607, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10003.EQUIP_CODE_IMPEACH_DONE)
			...
			var_2_3(var_2_2, var_2_10003("equipcode_dislike_success"))
		else
			local var_2_5
			...
			if arg_2_0.result == -1 then
				...
				var_2_5(var_2_4, var_2_10003("equipcode_report_warning"))
			else
				pg = var_2_5
