...
local var_0_0 = "NewEducateReplaceTarotCommand"
...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_2.tarotId

	pg = var_1_10005

	local var_1_2 = var_1_10005.ConnectionMgr.GetInstance()

	var_5.Send(var_1_2, 29120, {
		id = var_1_0,
		tarot_id = var_1_1
		...
		if arg_2_0.result == 0 then
			...
			var_2_6(var_2_5, var_2_10006.NEW_EDUCATE_REPLACE_TAROT_DONE, {
				drops = var_2_4
			})
		else
			pg = var_1
			...
			var_1.ShowTips(var_2_7, "NewEducate_ReplaceTarot_Error: " .. arg_2_0.result)
		end
