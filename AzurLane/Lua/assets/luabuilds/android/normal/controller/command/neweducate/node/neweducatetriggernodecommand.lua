...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 29030, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_6(var_2_5, var_5.NEW_EDUCATE_NEXT_NODE, {
				...
				noNextCb = function()
					if arg_2_0.next_node == 0 then
						...
						NewEducateFSM = var_3_0

						if var_3_1 == var_3_0.SYSTEM.PLAN then
							local var_3_2 = var_0
							local var_3_3 = var_0.GetState

							NewEducateFSM = var_3_10002
							var_3_10002 = var_3_3(var_3_2, var_3_10002.SYSTEM.PLAN)

							if var_0.IsFinish(var_3_10002) then
								var_3_10002 = arg_1_0
								...
								var_3_4(var_3_10002, var_3_10003.NEW_EDUCATE_GET_EXTRA_DROP, {
									id = var_1_0,
								...
								var_3_5(var_3_10002, var_3_10003.NEW_EDUCATE_NEXT_PLAN, {
									id = var_1_0
								})
							end
						else
							...
							var_3_7(var_3_6, var_3_10002.NEW_EDUCATE_CHECK_FSM)
						end
					end
