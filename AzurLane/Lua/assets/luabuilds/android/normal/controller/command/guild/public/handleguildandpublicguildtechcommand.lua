...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_4 = var_1_1.GetTechnologyGroups(var_1_3)

	pairs = var_1_3

	for iter_1_0, iter_1_1 in var_1_3(var_1_4) do
		local var_1_5 = var_4:getTechnologyGroupById(iter_1_1.id)

		var_12.update(var_1_5, {
			id = var_12.pid,
			state = var_12.state,
	...
	var_1_7(var_1_6, var_9.HANDLE_GUILD_AND_PUBLIC_GUILD_TECH_DONE)
