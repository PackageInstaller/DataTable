...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_7.Send(var_1_3, 28013, {
		...
		if arg_2_0.result == 0 then
			...
			GAME = var_2_10003
			var_2_10003 = var_2_10003.APARTMENT_CHANGE_SKIN_DONE

			local var_2_3 = var_0

			var_2_2(var_2_1, var_2_10003, var_4.getApartment(var_2_3, var_1_0))
			...
			var_2_2(var_2_4, var_2_10003, var_4.BuildDataChangeSkin(var_1_1))
		else
			pg = var_2_2
