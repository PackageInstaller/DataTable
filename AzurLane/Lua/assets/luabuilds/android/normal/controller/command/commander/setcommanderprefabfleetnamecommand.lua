...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_6.getName(var_1_4) == var_1_1 or var_1_1 == "" then
		...
		var_1_6(var_1_5, var_1_10009("login_newPlayerScene_name_tooShort"))

		return
	end

	local var_1_7, var_1_8 = var_6:canRename()

	if not var_1_7 then
		pg = var_1_10009

		local var_1_9 = var_1_10009.TipsMgr.GetInstance()

		var_1_10009.ShowTips(var_1_9, var_1_8)
	...
	nameValidityCheck = var_1_10009

	if not var_1_10009(var_1_1, 0, 12, {
		"spece_illegal_tip",
	...
	var_9.Send(var_1_10, 25024, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10003.SET_COMMANDER_PREFAB_NAME_DONE)
			...
			var_2_4(var_2_3, var_2_10003("commander_prefab_rename_success"))
		else
			if var_1_2 then
				var_1_2()
			end
