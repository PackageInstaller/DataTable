...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_8.contains(var_1_4.data1_list, var_1_0) then
		return
	end
	...
	var_8.Send(var_1_6, 11202, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2(var_2_1, var_2_10003.MEMORYBOOK_UNLOCK_DONE, var_1_0)
			...
			if arg_2_0.award_list then
				if var_1_5 then
					...
					var_2_2 = var_2_2.sendNotification
					GAME = var_2_10003
					var_2_10003 = var_2_10003.MEMORYBOOK_UNLOCK_AWARD_DONE

					local var_2_4 = {}

					PlayerConst = var_2_10005
					var_2_4.awards = var_2_10005.addTranDrop(arg_2_0.award_list)

					var_2_2(var_2_3, var_2_10003, var_2_4)
				end
			end
		else
			pg = var_2_2
