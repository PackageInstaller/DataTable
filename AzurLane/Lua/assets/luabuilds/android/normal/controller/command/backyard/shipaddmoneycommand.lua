	...
	var_3.Send(var_1_2, 19013, {
		...
		if arg_2_0.result == 0 then
			...
			if var_2_4 == 0 then
				...
				var_2_11(var_2_10, var_2_8("backyard_shipAddMoney_ok", var_2_1:getName(), var_2_4))
			end
			...
			var_2_13(var_2_12, var_2_8.BACKYARD_ADD_MONEY_DONE, {
				id = var_1_1
			})
		else
			pg = var_2_1
			...
			var_2_15(var_2_14, var_2_10003("backyard_shipAddMoney", arg_2_0.result))
		end
