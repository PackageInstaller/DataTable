...
function var_0_1.GetCustomThemeTemplate(arg_10_0, arg_10_1)
	...
	if not var_2.GetCustomThemeTemplates(var_10_0) then
		...
		local var_10_3 = var_1_10006.BACKYARD_GET_THEME_TEMPLATE
		local var_10_4 = {}

		BackYardConst = var_1_10008
		var_10_4.type = var_1_10008.THEME_TEMPLATE_TYPE_CUSTOM
...
function var_0_1.GetCollectionThemeTemplate(arg_13_0, arg_13_1)
	...
	if not var_2.GetCollectionThemeTemplates(var_13_0) then
		...
		local var_13_3 = var_1_10006.BACKYARD_GET_THEME_TEMPLATE
		local var_13_4 = {}

		BackYardConst = var_1_10008
		var_13_4.type = var_1_10008.THEME_TEMPLATE_TYPE_COLLECTION
