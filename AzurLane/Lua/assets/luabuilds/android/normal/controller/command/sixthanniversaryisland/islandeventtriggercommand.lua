...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_5 then
		...
		var_7.ShowTips(var_1_7, var_1_6)
	...
	local var_1_8 = var_7.ConnectionMgr.GetInstance()
	...
	var_7.Send(var_1_8, 11202, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_5(var_2_4, var_2_10005.ISLAND_EVENT_TRIGGER_DONE, {
				awards = var_2_3,
				node_id = var_2_2.id
			})
		else
