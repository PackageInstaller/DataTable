...
function var_0_1.execute(arg_1_0, arg_1_1)
	if not arg_1_1:getBody().str or var_3 == "" then
		...
		var_1_1(var_1_0, var_1_10006.BACKYARD_SEARCH_THEME_TEMPLATE_ERRO)
	...
	local function var_1_2(arg_2_0)
		...
		var_2_5(var_2_4, var_2_10007.BACKYARD_SEARCH_THEME_TEMPLATE_DONE, {
			template = var_2_3
		})
	...
	local function var_1_3(arg_3_0)
		...
		var_3_1(var_3_0, var_2_10003.BACKYARD_SEARCH_THEME_TEMPLATE_ERRO)
	...
	var_6.Send(var_1_4, 19113, {
		...
		if arg_4_0.result == 0 then
			...
			if arg_4_0.result == 20 then
				...
				var_4_1(var_4_0, var_2_10003("backyard_not_found_theme_template"))
			else
				pg = var_4_1
