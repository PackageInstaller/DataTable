...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0 == var_1_10007.MANUAL_REFRESH then
		...
		local var_1_6 = var_1_5(var_1_4, var_1_10010.ResGuildCoin)
		...
		if var_1_6 < var_9.GetResetConsume(var_1_7) then
			...
			var_1_9(var_1_8, var_1_10012("common_no_resource"))
	...
	var_7.Send(var_1_10, 1, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1_3.guildShop then
				...
				var_2.updateGuildShop(var_2_10003, var_2_0, true)
			else
				var_2_10003 = var_1_3

				var_2.setGuildShop(var_2_10003, var_2_0)
			end
			...
			if var_2_1 == var_2_10003.MANUAL_REFRESH then
				var_2_10003 = var_2_0

				local var_2_2 = var_2_0.GetResetConsume(var_2_10003)

				var_2_10004 = var_1_2

				local var_2_3 = var_2_10003.getData(var_2_10004)

				var_2_10003.consume(var_2_3, {
					guildCoin = var_2_2
				})

				local var_2_4 = var_1_2

				var_2_10004.updatePlayer(var_2_4, var_2_10003)
				...
				var_2_10004(var_2_5, var_6("guild_shop_refresh_done"))
			end
			...
			var_2_6(var_2_10003, var_2_10004.GET_GUILD_SHOP_DONE)
		else
			if var_1_1 then
				var_1_1()
			end
