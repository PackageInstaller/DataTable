...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_7, 29064, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_12.key = var_2_10009.SITE_STATE_TYPE.EVENT
			...
			var_2_15(var_2_14, var_9.NEW_EDUCATE_MAP_EVENT_DONE, {
				drops = var_2_13,
			...
			var_2_17(var_2_16, var_2_18, var_10.BuildDataSite(var_3.id, var_3:GetGameCnt(), var_3:GetRoundData().round, 2, var_1_1))
		else
			pg = var_2_0
