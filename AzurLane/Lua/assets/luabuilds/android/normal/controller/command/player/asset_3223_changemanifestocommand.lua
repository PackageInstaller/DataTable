...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_4.getData(var_1_1)

	pg = var_1_1

	local var_1_3 = var_1_1.ConnectionMgr.GetInstance()

	var_6.Send(var_1_3, 11009, {
		adv = var_1_0
		...
		if arg_2_0.result == 0 then
			var_2_0 = var_1_2
			var_2_0.manifesto = var_1_0

			local var_2_1 = var_0

			var_2_0.updatePlayer(var_2_1, var_1_2)
			...
			var_2_0(var_2_2, var_2_10003("player_changeManifesto_ok"))
		else
			pg = var_2_0
			...
			var_2_4(var_2_3, var_2_10003("player_changeManifesto", arg_2_0.result))
		end
