...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_3 then
		if var_1_5 then
			...
			local var_1_6 = var_1_10010("switch_to_shop_tip_1")

			ChargeScene = var_11

			var_9(var_1_6, var_11.TYPE_ITEM, var_1_5)
		else
			pg = var_9
	...
	var_9.Send(var_1_8, 12002, {
		...
		if arg_2_0.result == 0 then
			...
			TRACKING_BUILD_SHIP = var_2_10003
			...
			if var_1_2 then
				...
				local var_2_2 = var_2(var_2_10003)

				var_2_10003.data1 = var_2.getBuildFreeActivityByBuildId(var_2_2, var_1_0).data1 - var_1_1
				...
				local var_2_4 = var_2_10003(var_2_3)
				local var_2_5 = var_2_10003.getData(var_2_4)

				var_4.consume(var_2_5, {
			...
			local var_2_6 = var_2(var_2_10003)

			if var_2_1.exchange_count > 0 then
				var_2_6:changeRegularExchangeCount(var_1_1 * var_2_1.exchange_count)
			end

			ipairs = var_2_10003

			for iter_2_0, iter_2_1 in var_2_10003(arg_2_0.build_info) do
			...
			var_2_10003(var_2_7, var_5.BUILD_SHIP_DONE)
			...
			var_2_10003(var_2_8, var_5("ship_buildShipMediator_startBuild"))
		else
			pg = var_2_1
			...
			var_2_10(var_2_9, var_2_10003("ship_buildShip_error", arg_2_0.result))
		end
