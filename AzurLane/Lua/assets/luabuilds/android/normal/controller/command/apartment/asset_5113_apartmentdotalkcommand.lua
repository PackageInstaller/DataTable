...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_6.getApartment(var_1_3, var_1_2).talkDic[var_1_0] then
		...
		var_1_5(var_1_4, var_1_10010.APARTMENT_DO_TALK_DONE, {
			talkId = var_1_0
		})
	...
	var_8.Send(var_1_6, 28015, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.ModifyApartment(var_2_10003, var_1_2, function(arg_3_0)
			...
			var_2_10003(var_2_1, var_5.APARTMENT_DO_TALK_DONE, {
				talkId = var_1_0,
				awards = var_2_0
			})
		else
