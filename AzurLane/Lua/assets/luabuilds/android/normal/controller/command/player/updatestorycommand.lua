...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_10005(var_1_10006(var_1_0) == "string")
	...
	if var_5.getConnection(var_1_2) then
		...
		local function var_1_5(arg_2_0, arg_2_1)
			...
			var_2.Send(var_2_0, 11017, {
				...
				var_2.insertto(var_1_4, var_3_1)
		...
		local function var_1_6(arg_4_0, arg_4_1)
			...
			if var_4_1 and 0 < var_4_1 then
				...
				if not var_2_10005.GetPlayedFlag(var_4_4, var_4_1) then
					table = var_2_10005

					var_2_10005.insert(var_4_3, function(arg_5_0)
			...
			if var_4_2 and 0 < var_4_2 then
				...
				if not var_2_10005.GetPlayedFlag(var_4_5, var_4_2) then
					table = var_2_10005

					var_2_10005.insert(var_4_3, function(arg_6_0)
			...
			parallelAsync = var_2_10005

			var_2_10005(var_4_3, arg_4_1)
		...
		var_1_7.insert(var_1_8, var_1_0)

		local var_1_9 = {}

		ipairs = var_11

		for iter_1_0, iter_1_1 in var_11(var_1_8) do
			table = var_1_10016
		...
		var_11(var_1_9, function()
			...
			var_8_1(var_8_0, var_2_10002.STORY_UPDATE_DONE, {
				storyName = var_1_0,
				awards = var_1_4
			})
