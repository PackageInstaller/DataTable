...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_4
	local var_1_3 = var_4.GetCost(var_1_2)

	getProxy = var_1_2
	EducateProxy = var_1_10008

	local var_1_4 = var_1_2(var_1_10008)
	local var_1_5 = var_7.GetCharData(var_1_4)
	local var_1_6 = {}

	if #var_1_3 > 0 then
		ipairs = var_9

		for iter_1_0, iter_1_1 in var_9(var_1_3) do
			assert = var_1_10014

			local var_1_7 = iter_1_1[1]

			EducateConst = var_1_10016

			var_1_10014(var_1_7 == var_1_10016.DROP_TYPE_RES, "child_site_option的cost只支持资源类型，请检查id:" .. var_1_1)

			EducateChar = var_1_10014

			if var_1_5[var_1_10014.RES_ID_2_NAME[iter_1_1[2]]] < iter_1_1[3] then
				pg = var_1_10014
				...
				var_1_10014(var_1_8, var_1_10016("child_no_resource"))
	...
	local var_1_9 = var_9.ConnectionMgr.GetInstance()

	var_9.Send(var_1_9, 27004, {
		siteid = var_2.siteId,
		optionid = var_1_1
		...
		if arg_2_0.result == 0 then
			...
			local var_2_0 = var_2_4(var_2)

			var_2_4.ReduceResForCosts(var_2_0, var_1_6)
			...
			var_2_4(var_2_3, var_2_10003.EDUCATE_MAP_SITE_DONE, {
				optionId = var_1_1,
				drops = arg_2_0.drops,
			...
			var_2_6(var_2_5, var_2_10003("educate map site error: ", arg_2_0.result))
		end
