...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_2(var_1_1.activity_id, var_1_1.cmd, var_1_1.arg1, var_1_1.arg2)
	...
	var_1_4(var_1_3, var_1_5, var_1_6, 11203, function(arg_2_0)
		...
		if arg_2_0.result == 0 then
			...
			if var_2_0 == var_2_10002.OP_GET_MAP_AWARD then
				...
				var_2_0.insert(var_0.data1_list, var_1_1.arg1)
			else
				var_2_0 = var_1_1.cmd
				DreamlandData = var_2
				...
				if var_2_0 == var_2.OP_GET_EXPLORE_AWARD then
					...
					var_2_0.insert(var_0.data2_list, var_1_1.arg1)
				else
					var_2_0 = var_1_1.cmd
					DreamlandData = var_2
					...
					if var_2_0 == var_2.OP_RECORD_EXPLORE then
						...
						var_2_0.insert(var_0.data3_list, var_1_1.arg1)
					end
				end
			end
			...
			var_2_1(var_2_10003, var_4.ACTIVITY_DREAMLAND_OP_DONE, {
				activity = var_0,
				cmd = var_1_1.cmd,
				awards = var_2_0
			})
