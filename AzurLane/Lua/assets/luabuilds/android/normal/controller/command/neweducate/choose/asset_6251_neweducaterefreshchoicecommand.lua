...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_4(var_1_3, var_1_10008.RES_TYPE.REFRESH_CHOICE) <= 0 then
		pg = var_1_6
	...
	var_7.Send(var_1_7, 29105, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_6.type = var_2_10006.DROP_TYPE.RES

			local var_2_7 = var_0
			local var_2_8 = var_6.GetResIdByType

			NewEducateChar = var_2_10008
			var_2_6.id = var_2_8(var_2_7, var_2_10008.RES_TYPE.REFRESH_CHOICE)
