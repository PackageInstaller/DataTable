...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 29023, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_7(var_2_6, var_2_10007.NEW_EDUCATE_SEL_TALENT_DONE, {
				idx = var_1_2,
				drops = var_2_5
			})
			...
			local var_2_10 = var_2_8.m02
			local var_2_11 = var_6.sendNotification

			GAME = var_8

			local var_2_12 = var_8.NEW_EDUCATE_TRACK

			NewEducateTrackCommand = var_9

			local var_2_13 = var_9.BuildDataTalent
			...
			var_2_11(var_2_10, var_2_12, var_2_13(var_2_14, var_2_15, var_2_16, var_2_17, var_2_18, var_2_10015.concat(var_3:GetTalents(), ",")))
		else
			pg = var_1
