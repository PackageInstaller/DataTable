...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 61007, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_3 = var_4.GetCanFormationIndex(var_2_2)

			var_4:UpdateFleet(var_2_3, var_1_1)

			local var_2_4 = var_4
			local var_2_5 = var_4.UpdateFormationTime

			pg = var_8

			local var_2_6 = var_8.TimeMgr.GetInstance()

			var_2_5(var_2_4, var_8.GetServerTime(var_2_6))
			...
			var_2_8(var_2_7, var_8.GUILD_JOIN_MISSION_DONE, {
				id = var_1_0
			})
