...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_8.CheckPriorityStystem(var_1_7) then
		...
		var_1_8(var_1_7, var_1_10010("child2_priority_tip"))
	...
	NewEducateGoods = var_1_9

	local var_1_11 = var_1_9.New(var_1_1)
	...
	if not var_1_10:IsMatch(var_12) then
		...
		var_1_14(var_1_13, var_15("common_no_resource"))
	...
	var_13.Send(var_1_15, 29066, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_4 = var_2_3(var_2_2, var_3.SYSTEM.MAP)
			...
			var_2_7(var_2_6, var_5.NEW_EDUCATE_SHOPPING_DONE, {
				drops = var_2_5,
			...
			local var_2_10 = var_5.NEW_EDUCATE_TRACK

			NewEducateTrackCommand = var_6

			local var_2_11 = var_6.BuildDataSite
			local var_2_12 = var_1_10.id
			local var_2_13 = var_1_10
			local var_2_14 = var_8.GetGameCnt(var_2_13)
			local var_2_15 = var_1_10

			var_2_9(var_2_8, var_2_10, var_2_11(var_2_12, var_2_14, var_9.GetRoundData(var_2_15).round, 4, var_1_1))
