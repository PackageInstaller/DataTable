...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_5.Send(var_1_2, 17301, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.updateTrophyClaim(var_2_1, var_1_0, var_2_0)

			local var_2_2 = {}

			ipairs = var_2_1

			for iter_2_0, iter_2_1 in var_2_1(arg_2_0.next) do
			...
			var_2_6(var_2_5, var_5.TROPHY_CLAIM_DONE, {
				trophyID = var_1_0
			})
