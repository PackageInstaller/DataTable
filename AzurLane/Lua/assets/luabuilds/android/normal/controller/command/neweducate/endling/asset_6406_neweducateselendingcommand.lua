...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_6.Send(var_1_3, 29005, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_4 = var_2_3(var_2_2, var_2_10005.SYSTEM.ENDING)
			...
			var_2_6(var_2_5, var_6.NEW_EDUCATE_SEL_ENDING_DONE, {
				id = var_1_1,
				isMain = var_1_2
			})
			...
			NewEducateTrackCommand = var_8

			var_2_10(var_2_9, var_2_11, var_8.BuildDataEnding(var_1_0, var_2_8, var_1_1))
		else
			pg = var_1
