...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_6 or var_1_6.id ~= var_1_2 then
		...
		local var_1_9 = var_1_7(var_1_10011)
		local var_1_10 = var_10.getCommanderById(var_1_9, var_1_2)

		pairs = var_1_9

		for iter_1_0, iter_1_1 in var_1_9(var_1_8) do
			if iter_1_1.groupId == var_1_10.groupId and iter_1_0 ~= var_1_1 and var_1_2 ~= iter_1_1.id then
				pg = var_1_10016

				local var_1_11 = var_1_10016.TipsMgr.GetInstance()

				var_1_10016 = var_1_10016.ShowTips
				i18n = var_1_10018

				var_1_10016(var_1_11, var_1_10018("commander_can_not_select_same_group"))
	...
	local var_1_14 = {}
	local var_1_15 = true
	local var_1_16, var_1_17 = var_1_12(var_1_2)

	if var_1_16 then
		table = var_1_10016

		var_1_10016.insert(var_1_14, function(arg_4_0)
			if var_1_17.pos == 1 then
				i18n = var_4_0
				...
				local var_4_1 = var_2_10002.DEFAULT_NAME[var_1_17.fleetId]
				...
				i18n = var_2_10006
				var_4_4.content = var_2_10006("comander_repalce_tip", var_4_1, var_4_0)
				...
				function var_4_4.onYes()
					...
					var_5_1(var_5_0, var_3_10002.COOMMANDER_EQUIP_TO_FLEET, {
						commanderId = 0,
						fleetId = var_1_17.fleetId,
						pos = var_1_17.pos,
						callback = arg_4_0
					})
	...
	local var_1_18, var_1_19 = var_1_13(var_1_2)

	if var_1_18 then
		table = var_1_10018

		var_1_10018.insert(var_1_14, function(arg_7_0)
			pg = var_2_10001
			...
			var_7_1(var_7_0, var_2_10003.COOMMANDER_EQUIP_TO_FLEET, {
				commanderId = 0,
				fleetId = var_1_0,
				pos = var_1_19,
				callback = arg_7_0
	...
	var_1_10018.insert(var_1_14, function(arg_8_0)
		if var_1_15 then
			pg = var_1
			...
			var_8_1(var_8_0, var_2_10003.COOMMANDER_EQUIP_TO_FLEET, {
				fleetId = var_1_0,
				pos = var_1_1,
				commanderId = var_1_2,
