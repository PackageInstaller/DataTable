...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_9.Send(var_1_16, 19020, var_1_15, 19021, function(arg_2_0)
		if arg_2_0.result == 0 then
			getProxy = var_1
			DormProxy = var_2_10002
			var_2_10003 = var_1(var_2_10002)

			var_1.AddTheme(var_2_10003, var_1_15)
			...
			var_2_0(var_2_10003, var_4.SAVE_DORMTHEME_DONE)

			pg = var_2_0
			var_2_10003 = var_2_0.TipsMgr.GetInstance()

			var_2.ShowTips(var_2_10003, "保存成功")
		else
			pg = var_1
