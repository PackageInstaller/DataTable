...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_9.getOwnedCount(var_1_6) < var_1_5.resource_num * var_1_1 then
		...
		var_1_8(var_1_7, var_1_10012("common_no_x", var_9:getName()))
	...
	var_10.Send(var_1_9, 16201, {
		...
		if arg_2_0.result == 0 then
			...
			local var_2_1 = var_2.getQuotaShop(var_2_10003)
			local var_2_2 = var_0

			var_2_10003.updateQuotaShop(var_2_2, var_2_1)

			reducePlayerOwn = var_2_10003
			...
			var_2_10003(var_2_3, var_5.QUOTA_SHOPPING_DONE, {
				awards = var_2_0,
				id = var_1_0
			})
		else
