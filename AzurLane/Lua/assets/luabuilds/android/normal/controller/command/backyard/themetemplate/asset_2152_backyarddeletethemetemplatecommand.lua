...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_4(arg_8_0)
		...
		var_8_1[1] = var_3.GetTextureName(var_8_2)

		local var_8_3 = var_1_2

		var_8_1[2] = var_3.GetTextureIconName(var_8_3)

		var_8_0(var_8_1)

		local var_8_4 = var_0

		var_1.DeleteCustomThemeTemplate(var_8_4, var_1_0)
		...
		if var_1.IsInitShopThemeTemplates(var_8_5) then
			...
			if var_1.GetShopThemeTemplateById(var_8_6, var_1_0) then
				local var_8_7 = var_0

				var_1.DeleteShopThemeTemplate(var_8_7, var_1_0)
			end

			local var_8_8 = var_0

			if var_1.GetCollectionThemeTemplateById(var_8_8, var_1_0) then
				local var_8_9 = var_0

				var_1.DeleteCollectionThemeTemplate(var_8_9, var_1_0)
			end
		end
		...
		var_8_11(var_8_10, var_3.BACKYARD_DELETE_THEME_TEMPLATE_DONE)
