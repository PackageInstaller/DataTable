...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_2 and var_1_2 ~= 0 then
		var_1_10008 = var_1_3
		var_1_10007 = var_1_3.getEquipmnentSkinById(var_1_10008, var_1_2)
		assert = var_1_10008
		...
		if not var_1_10007 or var_1_10007.count == 0 then
			...
			var_1_10008(var_1_4, var_10("equipment_skin_count_noenough"))
	...
	if not var_7.getShipById(var_1_5, var_1_0) then
		...
		var_1_5(var_1_6, var_1_10011("equipment_skin_no_new_ship"))
	...
	var_9.Send(var_1_7, 12036, {
		...
		if arg_2_0.result == 0 then
			...
			var_2.updateEquipmentSkin(var_2_10003, var_1_1, var_1_2)
			...
			if var_1_2 and var_1_2 ~= 0 then
				if var_2_1 and var_2_1 ~= 0 then
					...
					var_2.addEquipmentSkin(var_2_10003, var_2_1, 1)
				end

				var_2_10003 = var_1_3

				var_2.useageEquipmnentSkin(var_2_10003, var_1_2)
				...
				var_2_2(var_2_10003, var_4("equipment_skin_replace_done"))
			else
				var_2_10003 = var_1_3
				...
				var_2_3(var_2_10003, var_4("equipment_skin_unload"))
			end
			...
			var_2_4(var_2_10003, var_4.EQUIP_EQUIPMENTSKIN_TO_SHIP_DONE, {
				ship = var_0
			})
		else
			pg = var_2_1
