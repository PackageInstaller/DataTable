...
function var_0_1.CheaterVertify()
	...
	if not var_2_0 then
		...
		var_2_3(var_2_2, var_1_10004.CHEATER_MARK, {
			reason = var_2_1
		})
	end
...
function var_0_1.GeneralPackage(arg_3_0, arg_3_1)
	...
	for iter_3_0, iter_3_1 in var_1_10008(arg_3_1) do
		if arg_3_0.statistics[iter_3_1.id] then
			...
			local var_3_9 = var_16.floor(var_13.output)

			math = var_17

			local var_3_10 = var_17.max
			local var_3_11 = 0

			math = var_1_10019

			local var_3_12 = var_3_10(var_3_11, var_1_10019.floor(var_13.damage))

			math = var_3_11

			local var_3_13 = var_3_11.floor(var_13.maxDamageOnce)

			math = var_1_10019
			var_1_10019 = var_1_10019.floor(var_13.gearScore)
			table = var_20

			var_20.insert(var_3_1, {
				ship_id = var_3_8,
				hp_rest = var_1_10015,
				damage_cause = var_3_9,
				damage_caused = var_3_12,
				max_damage_once = var_3_13,
				ship_gear_score = var_1_10019
			})

			var_3_7 = var_3_7 + var_3_8 + var_1_10015 + var_3_9 + var_3_13
...
function var_0_1.RequestFailStandardProcess(arg_6_0, arg_6_1)
	...
	if arg_6_1.result == 2 then
		...
		var_6_1(var_6_0, var_4("stage_finishStage", arg_6_1.result))
		...
		var_6_1(var_6_2, var_4.FINISH_STAGE_ERROR, {})
	else
		originalPrint = var_6_1
		...
		var_6_4(var_6_3, var_4("stage_finishStage", arg_6_1.result))
	end
...
function var_0_1.GenerateCommanderExp(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_2 = (function(arg_13_0)
		...
		for iter_13_0, iter_13_1 in var_2_10003(var_13_0) do
			local var_13_2 = iter_13_1.id
			local var_13_3 = var_12_1
			local var_13_4 = var_9.getCommanderById(var_13_3, var_13_2).exp
			local var_13_5

			ipairs = var_2_10012

			for iter_13_2, iter_13_3 in var_2_10012(var_12_0) do
			...
			if not var_13_5 or not var_13_5.exp then
				var_2_10012 = 0
			end

			var_9:addExp(var_2_10012)

			local var_13_6 = var_12_1

			var_13.updateCommander(var_13_6, var_9)

			table = var_13

			var_13.insert(var_13_1, {
