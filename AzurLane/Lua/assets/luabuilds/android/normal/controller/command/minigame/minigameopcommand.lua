	...
	var_9.Send(var_1_6, 26103, {
		...
		if arg_2_0.result == 0 then
			...
			if var_1_2 == var_0_1.CMD_COMPLETE then
				var_2_10005 = var_2_0:GetHubByHubId(var_1_1)

				if var_3.getConfig(var_2_10005, "reward_target") ~= "" and var_4 ~= 0 then
					var_2_10005 = {
						count = 1
					}
					DROP_TYPE_VITEM = var_6
					var_2_10005.type = var_6
					var_2_10005.id = var_4
					table = var_6

					var_6.insert(var_2_1, var_2_10005)
				end
			end
			...
			var_2_3(var_2_2, var_2_10005.SEND_MINI_GAME_OP_DONE, {
				awards = var_2_1,
				hubid = var_1_1,
				cmd = var_1_2,
				argList = var_1_3
			...
			var_1.ShowTips(var_2_4, "mini game Error : " .. arg_2_0.result)
		end
