...
local var_0_0 = "ShamShoppingCommand"
...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_6 = var_8.getShamShop(var_1_5)
	...
	if var_1_7.commodity_type == 1 then
		if var_1_7.commodity_id == 1 and var_1_4:GoldMax(var_1_7.num * var_1_1) then
			...
			var_1_12(var_1_11, var_1_13 .. var_15("resource_max_tip_shop"))
		...
		if var_1_7.commodity_id == 2 and var_1_4:OilMax(var_1_7.num * var_1_1) then
			...
			local var_1_15 = var_14("oil_max_tip_title")

			i18n = var_15

			var_1_12(var_1_14, var_1_15 .. var_15("resource_max_tip_shop"))
	...
	var_12.Send(var_1_16, 16201, {
		id = var_1_0,
		type = var_0_1.SHAM_SHOP,
		count = var_1_1
		...
		if arg_2_0.result == 0 then
			...
			local var_2_1 = var_2.getShamShop(var_2_10003)
			...
			var_4.updateShamShop(var_2_3, var_2)
			...
			var_2_5(var_2_4, var_6.SHAM_SHOPPING_DONE, {
				awards = var_2_0,
				id = var_1_0
			})
		else
