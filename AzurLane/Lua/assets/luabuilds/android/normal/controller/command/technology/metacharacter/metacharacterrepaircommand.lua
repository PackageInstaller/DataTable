...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_8 = var_9
	local var_1_9 = var_9.getItemId(var_1_8)

	getProxy = var_1_8
	BagProxy = var_1_10013

	local var_1_10 = var_1_8(var_1_10013)

	if var_1_7 > var_12.getItemCountById(var_1_10, var_1_9) then
		return
	end
	...
	local var_1_11 = var_14.ConnectionMgr.GetInstance()

	var_14.Send(var_1_11, 63301, {
		ship_id = var_1_0,
		repair_id = var_9.id
		...
		if arg_2_0.result == 0 then
			...
			var_2_10003 = var_1(var_2_1)

			local var_2_2 = var_1.getMetaProgressVOByID(var_2_10003, var_0.id)
			...
			local var_2_4 = var_5.CONSUME_ITEM
			...
			var_2_6.id = var_1_9
			var_2_6.count = var_1_7

			var_2_10003(var_2_3, var_2_4, var_2_5(var_2_6))
			...
			var_2_10003(var_2_7, var_2_4.REPAIR_META_CHARACTER_DONE)
		else
			pg = var_1
