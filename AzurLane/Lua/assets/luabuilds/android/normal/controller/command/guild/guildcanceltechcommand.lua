...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_5:getActiveTechnologyGroup() then
		...
		var_1_5(var_1_4, var_1_10008("guild_not_exist_activation_tech"))
	...
	if not var_5:CanCancelTech() then
		...
		var_1_10(var_1_9, var_1_10009("guild_cancel_only_once_pre_day"))
	...
	var_7.Send(var_1_11, 62026, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_1(var_2_0, var_2_10003.GUILD_CANCEL_TECH_DONE)
		else
			pg = var_2_1
