...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_3.IsReqOldInstagramData(var_1_2) then
	...
	local var_1_3 = var_3:GetOldInstagramIds()
	local var_1_4 = {}

	math = var_1_10006

	local var_1_5 = var_1_10006.ceil(#var_1_3 / var_0_2)
	...
	var_7(var_1_4, function()
		...
		var_3_2(var_3_1, var_2_10002.REQ_OLD_INSTAGRAM_DATA_DONE)
