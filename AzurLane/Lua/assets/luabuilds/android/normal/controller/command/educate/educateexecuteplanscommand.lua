	...
	var_5.Send(var_1_2, 27002, {
		...
		if arg_2_0.result == 0 then
			...
			local function var_2_3()
				...
				var_3_1(var_3_0, var_3_10002.EDUCATE_EXECUTE_PLANS_DONE, {
					gridData = var_2_2,
			...
			var_2_10003.ReduceResForPlans(var_2_4)

			local var_2_5 = var_1_1
			local var_2_6 = var_2_10003.GetPlanProxy(var_2_5)

			var_2_10003.OnExecutePlanDone(var_2_6)

			local var_2_7 = var_1_1
			local var_2_8 = var_2_10003.GetPlanProxy(var_2_7)

			var_2_10003.UpdateHistory(var_2_8)
			...
			local var_2_10 = var_2_10005.CHANGE_SCENE

			SCENE = var_2_10006

			var_2_10003(var_2_9, var_2_10, var_2_10006.EDUCATE, {
			...
			var_2_12(var_2_11, var_2_10003("educate execute plans error: ", arg_2_0.result))
		end
