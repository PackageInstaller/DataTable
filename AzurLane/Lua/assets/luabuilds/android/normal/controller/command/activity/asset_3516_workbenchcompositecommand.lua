...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if not var_1_2(var_1_1, var_1_10005.ACTIVITY_TYPE_WORKBENCH) or var_3:isEnd() then
		return
	end
	...
	if not (function()
		...
		local var_2_6 = var_2_5(var_4)
		local var_2_7 = var_3.getActivityByType

		ActivityConst = var_2_10005

		local var_2_8 = var_2_7(var_2_6, var_2_10005.ACTIVITY_TYPE_VIRTUAL_BAG)

		_ = var_2_6

		if not var_2_6.all(var_1_7, function(arg_3_0)
			assert = var_3_10001

			local var_3_0 = arg_3_0[1]

			DROP_TYPE_USE_ACTIVITY_DROP = var_3_10003

			var_3_10001(var_3_10003 < var_3_0)
			...
			var_2_10(var_2_9, var_6("workbench_tips2"))
	...
	var_10.Send(var_1_8, 11202, {
		...
		if arg_4_0.result == 0 then
			...
			local var_4_0 = var_4_1(var_2_10002)

			var_4_1 = var_4_1.getActivityByType
			ActivityConst = var_2_10003
			var_4_1 = var_4_1(var_4_0, var_2_10003.ACTIVITY_TYPE_VIRTUAL_BAG)
			_ = var_4_0

			var_4_0.each(var_1_7, function(arg_5_0)
			...
			var_2.updateActivity(var_2_10003, var_4_1)
			...
			local var_4_3 = var_2_10003(var_4)
			local var_4_4 = var_2_10003.getActivityById(var_4_3, var_1_3)

			var_2_10003.AddFormulaUseCount(var_4_4, var_1_4, var_1_5)

			getProxy = var_4
			ActivityProxy = var_4_4

			local var_4_5 = var_4(var_4_4)

			var_4.updateActivity(var_4_5, var_2_10003)

			local var_4_6 = arg_1_0
			local var_4_7 = var_4.sendNotification

			GAME = var_6

			var_4_7(var_4_6, var_6.WORKBENCH_COMPOSITE_DONE, var_4_2)
		else
			pg = var_4_1

			local var_4_8 = var_4_1.TipsMgr.GetInstance()
			local var_4_9 = var_1.ShowTips

			errorTip = var_2_10003

			var_4_9(var_4_8, var_2_10003("", arg_4_0.result))
		end
