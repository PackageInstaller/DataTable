...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_4.GetSelfBoss(var_1_2) then
		var_1_10007 = var_5

		if var_5.isDeath(var_1_10007) then
			return
		end

		WorldBossConst = var_1_2

		local var_1_3 = var_1_2.GetAutoBattleOilConsume()
		...
		if var_1_6(var_1_5, var_1_10010.ResOil) < var_1_3 then
			pg = var_1_8
			...
			var_1_8(var_1_7, var_10("world_boss_auto_battle_no_oil"))
		...
		var_8.Send(var_1_9, 34523, {
			...
			if arg_2_0.result == 0 then
				...
				var_2.UpdateAutoBattleFinishTime(var_2_10003, arg_2_0.auto_fight_finish_time)
				...
				var_2_1(var_2_10003, var_4.WORLD_ARCHIVES_BOSS_AUTO_BATTLE_DONE)
			else
				pg = var_1
