...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_1_10003(var_1_1, var_1_10005.CastToString(var_1_0))
	...
	if var_3.getConnection(var_1_2) then
		...
		if var_1_0.args then
			...
			if var_1_0.strs then
				...
				if not var_1_5(var_5.range(var_1_0.strs.Count), function(arg_3_0)
					local var_3_0
				...
				local var_1_7 = var_5.GameTrackerMgr.GetInstance()
				local var_1_8 = var_5.Record

				GameTrackerBuilder = var_1_10007

				var_1_8(var_1_7, var_1_10007.BuildDorm3d({
...
function var_0_1.BuildCameraMsg(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4, arg_12_5, arg_12_6)
	...
	return var_12_0(var_1_10008.map({
		arg_12_0,
		arg_12_1,
		arg_12_2,
		arg_12_3,
