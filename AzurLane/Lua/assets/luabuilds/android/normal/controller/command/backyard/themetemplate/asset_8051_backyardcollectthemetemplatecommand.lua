...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_3(arg_2_0)
		...
		var_2_2(var_2_1, var_2_10006.BACKYARD_COLLECT_THEME_TEMPLATE_DONE)
	...
	if var_1_2 then
		pg = var_1_10007
		var_1_10008 = var_1_10007.ConnectionMgr.GetInstance()

		var_1_10007.Send(var_1_10008, 19127, {
			theme_id = var_1_0
		...
		BackYardConst = var_1_4

		if var_1_5 >= var_1_4.MAX_COLLECTION_CNT then
			pg = var_1_5
			...
			var_1_5(var_1_6, var_1_10009("backyard_theme_template_collection_cnt_max"))
		...
		var_7.Send(var_1_7, 19119, {
			...
			if arg_4_0.result == 0 then
				...
				var_4_1(var_4_0, var_2_10003[arg_4_0.result] .. arg_4_0.result)
			end
