...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0 == "" then
		...
		var_1_10005(var_1_2, var_1_10007("login_createNewPlayer_error_nameNull"))
	end
	...
	local var_1_7 = var_1_10009.SdkMgr.GetInstance()

	var_1_6.device_id = var_9.GetDeviceId(var_1_7)
	...
	var_1_4(var_1_3, var_1_5, var_1_6, 10025, function(arg_2_0)
		if arg_2_0.result == 0 then
			...
			TRACKING_ROLE_CREATE = var_2_10003

			var_2_1(var_2_0, var_2_10003, nil, arg_2_0.user_id)

			getProxy = var_2_1
			SettingsProxy = var_2_0
			var_2_10003 = var_2_1(var_2_0)

			var_1.SetSelectedShipId(var_2_10003, var_1_1)
			...
			var_2_2(var_2_10003, var_4.CREATE_NEW_PLAYER_DONE, arg_2_0.user_id)
			...
			var_2_3(var_2_10003, var_4("create_player_success"))
		elseif arg_2_0.result == 6 then
			...
			var_2_5(var_2_4, var_2_10003("login_createNewPlayer_full"))
		else
			local var_2_7
			...
			if arg_2_0.result == 18 then
				...
				var_2_7(var_2_6, var_2_10003("system_database_busy"))
			else
				pg = var_2_7
