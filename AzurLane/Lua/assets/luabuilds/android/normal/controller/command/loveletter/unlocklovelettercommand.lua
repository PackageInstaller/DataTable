...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local var_1_1 = var_1_10004.lover_letter_content[var_1_0]

	getProxy = var_1_10005
	LoveLetterProxy = var_1_10006

	local var_1_2 = var_1_10005(var_1_10006)
	local var_1_3 = var_5.GetGroupData(var_1_2, var_1_1.ship_group)

	if not var_5.CanUnlockLetter(var_1_3, var_1_0) then
		return
	end
	...
	var_6.Send(var_1_4, 12400, {
		...
		if arg_2_0.result == 0 then
			...
			var_2_2.UnlockLetter(var_2_0, var_1_1.ship_group, var_1_0)
			...
			var_2_2(var_2_1, var_2_10003.UNLOCK_LOVE_LETTER_DONE, {
				letterId = var_1_0
			})
		else
			pg = var_2_2
