	...
	if var_1_1 == var_1_10010.OP_RANDOM_SHIPS then
		...
		var_10.Send(var_1_7, 26158, {
			...
			if arg_2_0.ret == 0 then
				...
				for iter_2_0, iter_2_1 in var_2_0(arg_2_0.party_roles) do
					var_2_10003[iter_2_1.tid] = true

					local var_2_1 = var_2

					if not var_2.GetFeastShip(var_2_1, iter_2_1.tid) then
						FeastShip = var_2_1

						local var_2_2 = var_2_1.New(iter_2_1)
						...
						var_9:UpdateBubble(iter_2_1.bubble)
						var_9:UpdateSpeechBubble(iter_2_1.speech_bubble)
					end
				end

				pairs = var_4

				for iter_2_2, iter_2_3 in var_4(var_2:GetFeastShipList()) do
					if var_2_10003[iter_2_2] ~= true then
				...
				local var_2_5 = var_6.FEAST_OP_DONE
				local var_2_6 = {}

				FeastDorm = iter_2_3
				var_2_6.cmd = iter_2_3.OP_RANDOM_SHIPS
				var_2_6.ships = var_2:GetBayShipOnFloor()
				var_2_6.awards = {}
				...
				var_2_8(var_2_7, var_2_10003[arg_2_0.ret] .. arg_2_0.ret)
			end
		...
		var_10.Send(var_1_10, 11202, {
			...
			if arg_3_0.result == 0 then
				...
				FeastDorm = var_2_10003

				if var_3_1 == var_2_10003.OP_INTERACTION then
					var_2_10003 = arg_1_0
					...
					var_3_2(var_2_10003, var_3_3, var_3_4, var_3_5, var_3_0)
				else
					local var_3_6 = var_1_1

					FeastDorm = var_2_10003

					if var_3_6 == var_2_10003.OP_MAKE_TICKET then
						var_2_10003 = arg_1_0

						var_2.HandleMakeTicket(var_2_10003, var_1_2)
					else
						local var_3_7 = var_1_1

						FeastDorm = var_2_10003

						if var_3_7 == var_2_10003.OP_GIVE_TICKET then
							var_2_10003 = arg_1_0
							...
							var_3_8(var_2_10003, var_3_9, var_3_10, var_3_0)
						else
							local var_3_11 = var_1_1

							FeastDorm = var_2_10003

							if var_3_11 == var_2_10003.OP_GIVE_GIFT then
								var_2_10003 = arg_1_0

								var_2.HandleGiveGift(var_2_10003, var_1_2, var_3_0)
							else
								local var_3_12 = var_1_1

								FeastDorm = var_2_10003

								if var_3_12 == var_2_10003.OP_ENTER then
									-- block empty
								end
							end
						end
...
function var_0_1.CheckRes(arg_4_0, arg_4_1, arg_4_2)
	...
	local var_4_2 = var_4_1(var_4_0, var_1_10006.ACTIVITY_TYPE_VIRTUAL_BAG)
	local var_4_3 = 0
	local var_4_4 = 1
	...
	local var_4_5 = var_1_10007(var_1_10008)
	...
	if arg_4_1 == var_4_6.OP_MAKE_TICKET then
...
function var_0_1.HandleInteraction(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	local var_5_0 = var_1_10005(var_1_10006)
	...
	if var_5_2:IsSpecial() then
		var_1_10010 = var_5:GetInvitedFeastShip(arg_5_1)
		var_5_3 = var_8.GetSpeechContent(var_1_10010, var_5_2.bubble, var_5_2.speechBubble)
	end
	...
	local var_5_6 = var_1_10010.FEAST_OP_DONE
	local var_5_7 = {}

	FeastDorm = var_1_10012
	var_5_7.cmd = var_1_10012.OP_INTERACTION
...
function var_0_1.HandleMakeTicket(arg_6_0, arg_6_1)
	...
	local var_6_4 = var_6_2(var_1_10006)
	local var_6_5 = var_5.getActivityByType

	ActivityConst = var_1_10008

	local var_6_6 = var_6_5(var_6_4, var_1_10008.ACTIVITY_TYPE_VIRTUAL_BAG)
	...
	InvitedFeastShip = var_9

	var_6_8(var_6_7, var_9.STATE_MAKE_TICKET)
	...
	local var_6_11 = var_9.FEAST_OP_DONE
	local var_6_12 = {}

	FeastDorm = var_1_10011
	var_6_12.cmd = var_1_10011.OP_MAKE_TICKET
...
function var_0_1.HandleGiveTicket(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_0 = var_1_10004(var_1_10005)
	...
	var_7_3(var_7_2, var_1_10008.STATE_GOT_TICKET)

	local var_7_4 = var_5
	local var_7_5 = var_5.GetSkinId(var_7_4)

	FeastShip = var_7_4

	local var_7_6 = var_7_4.New({
		skinId = 0,
		tid = arg_7_1,
		bubble = arg_7_2
	})

	var_7.SetSkinId(var_7_6, var_7_5)
	var_4:AddShip(var_7)

	local var_7_7 = arg_7_0
	local var_7_8 = arg_7_0.sendNotification

	GAME = var_10

	local var_7_9 = var_10.FEAST_OP_DONE
	local var_7_10 = {}

	FeastDorm = var_1_10012
	var_7_10.cmd = var_1_10012.OP_GIVE_TICKET
	var_7_10.groupId = arg_7_1
	var_7_10.value = var_5:GetInvitationState()
	var_7_10.awards = arg_7_3
...
function var_0_1.HandleGiveGift(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_4 = var_8_2(var_1_10007)
	local var_8_5 = var_6.getActivityByType

	ActivityConst = var_1_10009

	local var_8_6 = var_8_5(var_8_4, var_1_10009.ACTIVITY_TYPE_VIRTUAL_BAG)
	...
	var_8_8(var_8_7, var_10.GIFT_STATE_GOT)
	...
	local var_8_11 = var_10.FEAST_OP_DONE
	local var_8_12 = {}

	FeastDorm = var_1_10012
	var_8_12.cmd = var_1_10012.OP_GIVE_GIFT
