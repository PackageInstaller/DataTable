...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	BillboardProxy = var_6

	local var_1_2 = var_1_10005(var_6)
	...
	local function var_1_3(arg_2_0, arg_2_1)
		...
		var_2_3(var_2_2, var_4.GET_POWERRANK_DONE, {
			list = arg_2_0,
			type = var_1_0,
	...
	if var_1_0 == var_7.TYPE_MILITARY_RANK then
		...
		var_7.Send(var_1_4, 18006, {
			...
			for iter_3_0, iter_3_1 in var_2_10002(arg_3_0.arena_rank_lsit) do
				...
				var_3_3(var_3_2, var_10.getEmblem(iter_3_1.score, iter_3_0))
			...
			local var_3_4 = var_2(var_3)
			local var_3_5 = var_2.getData(var_3_4)

			getProxy = var_3_4
			BayProxy = var_4

			local var_3_6 = var_3_4(var_4)
		...
		local function var_1_8(arg_6_0)
			...
			var_6_1(var_6_0, var_6_2, var_6_3, 18204, function(arg_7_0)
				...
				local var_7_2 = var_7_0(var_3_10003)
				...
				if var_7_7 == var_7_4.TYPE_POWER then
					getProxy = var_7_7
					BayProxy = var_7_8
					var_7_8 = var_7_7(var_7_8)
					var_7_6 = var_4.getBayPower(var_7_8)

					goto label_7_1
				end

				local var_7_9 = var_1_0

				PowerRank = var_7_8

				local var_7_10

				if var_7_9 == var_7_8.TYPE_COLLECTION then
					getProxy = var_7_9
					CollectionProxy = var_7_10
					var_7_10 = var_7_9(var_7_10)
					var_7_6 = var_4.getCollectionCount(var_7_10)

					goto label_7_1
				end

				local var_7_11 = var_1_0

				PowerRank = var_7_10

				if var_7_11 ~= var_7_10.TYPE_PT then
					var_7_11 = var_1_0
					PowerRank = var_7_12
					...
					do
						...
						if var_7_11 == var_7_12.TYPE_ACT_BOSS_BATTLE then
							assert = var_7_11

							var_7_11(var_1_1)

							getProxy = var_7_11
							ActivityProxy = var_7_12
							var_7_12 = var_7_11(var_7_12)
							var_7_6 = var_4.getActivityById(var_7_12, var_1_1) and var_4.data1 or arg_7_0.point
						else
							local var_7_13 = var_1_0

							PowerRank = var_7_12

							local var_7_14

							if var_7_13 == var_7_12.TYPE_CHALLENGE then
								PowerRank = var_7_13
								var_7_14 = var_7_13

								local var_7_15 = var_7_13.getActivityByRankType

								PowerRank = var_3_10006

								local var_7_16 = var_7_15(var_7_14, var_3_10006.TYPE_CHALLENGE)

								getProxy = var_7_14
								ChallengeProxy = var_3_10006
								var_3_10006 = var_7_14(var_3_10006)

								if var_7_14.getChallengeInfo(var_3_10006) then
									if var_7_16 then
										::label_7_0::
										...
										ChallengeProxy = var_3_10006
										var_3_10006 = var_7_14(var_3_10006)
										var_3_10006 = var_7_14.getChallengeInfo(var_3_10006)
										var_7_14 = var_7_14.getGradeList(var_3_10006).seasonMaxScore
									end

									var_7_6 = var_7_16 and var_7_14 or arg_7_0.point
								else
								...
								if var_7_17 == var_7_14.TYPE_EXTRA_CHAPTER then
									PowerRank = var_7_17
									var_7_18 = var_7_17
									...
									PowerRank = var_3_10006
									var_7_6 = var_7_19(var_7_18, var_3_10006.TYPE_EXTRA_CHAPTER) and var_4.data1 or arg_7_0.point
								else
									local var_7_20 = var_1_0

									PowerRank = var_7_18

									if var_7_20 == var_7_18.TYPE_BOSSRUSH then
										PowerRank = var_7_20
										...
										PowerRank = var_3_10006
										var_7_6 = var_7_22(var_7_21, var_3_10006.TYPE_BOSSRUSH) and var_4.data1 or arg_7_0.point
									else
										var_7_6 = arg_7_0.point
									end
								end
