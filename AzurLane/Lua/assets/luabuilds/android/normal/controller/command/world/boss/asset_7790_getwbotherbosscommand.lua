...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	if var_1_0 == var_1_10005.OTHER_BOSS_TYPE_FRIEND then
		...
		var_1_10006 = var_5.getRawData(var_1_2)
		pairs = var_1_2

		for iter_1_0, iter_1_1 in var_1_2(var_1_10006) do
			table = var_1_10012
		...
		if var_1_0 == var_5.OTHER_BOSS_TYPE_GUILD then
			...
			for iter_1_2, iter_1_3 in var_1_3(var_1_4.member) do
				table = var_1_10012
	...
	var_5.Send(var_1_5, 33503, {
		...
		var_2_5(var_2_4, var_5.WORLD_BOSS_GET_OTHER_BOSS_DONE)
