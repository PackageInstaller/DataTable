...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	local function var_1_5(arg_5_0, arg_5_1)
		...
		local var_5_4 = var_2_10006.indexof

		MailProxy = var_2_10007
		var_5_3.cmd = var_5_4(var_2_10007.DEAL_CMD_LIST, arg_5_0)
		var_5_3.match_list = var_1_4

		var_5_1(var_5_0, var_5_2, var_5_3, 30007, function(arg_6_0)
			if arg_6_0.result == 0 then
				getProxy = var_1
				MailProxy = var_3_10002

				local var_6_0 = var_1(var_3_10002)
				...
				table = var_3_10003
				var_3_10003 = var_3_10003.sort

				local var_6_2 = var_6_1

				CompareFuncs = var_3_10005

				var_3_10003(var_6_2, var_3_10005({
					function(arg_7_0)
						return -arg_7_0
					end
				}))
				...
				for iter_6_0, iter_6_1 in var_3_10003(var_6_1) do
				...
				if arg_6_0.result == 6 then
					...
					var_6_4(var_6_3, var_3_10003("mail_moveto_markroom_max"))
				else
					pg = var_6_4
					...
					var_6_6(var_6_5, var_3_10003("", arg_6_0.result))
				end
			end
	...
	if var_1_0 == "attachment" or var_1_0 == "move" then
		...
		var_1_10011.insert(var_1_7, function(arg_8_0, arg_8_1)
			CheckEquipLimit = var_2_10002

			local var_8_0 = var_2_10002(arg_8_1)

			GetItemsOverflowDic = var_3

			local var_8_1 = var_3(arg_8_1)
			...
			if not var_8_2 then
				...
				var_6(var_8_3, {
					gold = function()
						...
						var_9_1(var_9_0, var_3_10002("gold_max_tip_title"))
					...
					oil = function()
						...
						var_10_1(var_10_0, var_3_10002("oil_max_tip_title"))
					...
					equip = function()
						...
						var_11_1(var_11_0, var_3_10002("mail_takeAttachment_error_magazine_full"))
					...
					ship = function()
						...
						var_12_1(var_12_0, var_3_10002("mail_takeAttachment_error_dockYrad_full"))
				...
				if var_8_0 then
					...
					for iter_8_0, iter_8_1 in var_2_10007(var_8_0) do
						...
						local var_8_7 = var_8_4

						Drop = var_2_10016
						var_2_10016 = var_2_10016.New

						local var_8_8 = {}

						DROP_TYPE_EQUIP = var_2_10018
						var_8_8.type = var_2_10018
						var_8_8.id = var_8_5
						var_8_8.count = var_8_6

						var_2_10014(var_8_7, var_2_10016(var_8_8))
					end

					local var_8_9 = arg_1_0
					local var_8_10 = var_7.sendNotification

					GAME = var_9

					local var_8_11 = var_9.MAIL_DOUBLE_CONFIREMATION_MSGBOX
					local var_8_12 = {
						content = "mail_takeAttachment_error_equipment_overlimit"
					}

					MailProxy = iter_8_1
					var_8_12.type = iter_8_1.MailMessageBoxType.ReDropConfirm
		...
		var_11.insert(var_1_7, function(arg_14_0, arg_14_1)
			if arg_14_1.isStoreOverflow then
				...
				var_2.insert(var_1_7, function(arg_15_0)
					...
					if 0 < var_15_0 then
						...
						Drop = var_3_10006
						var_3_10006 = var_3_10006.New

						local var_15_5 = {}

						DROP_TYPE_RESOURCE = var_3_10008
						var_15_5.type = var_3_10008
						PlayerConst = var_3_10008
						var_15_5.id = var_3_10008.ResGold
						var_15_5.count = var_15_0

						var_15_3(var_15_4, var_3_10006(var_15_5))
					end

					if 0 < var_15_1 then
						table = var_4

						local var_15_6 = var_4.insert
						...
						DROP_TYPE_RESOURCE = var_3_10008
						var_15_8.type = var_3_10008
						PlayerConst = var_3_10008
						var_15_8.id = var_3_10008.ResOil
						var_15_8.count = var_15_1

						var_15_6(var_15_7, var_3_10006(var_15_8))
					end

					local var_15_9 = arg_1_0
					local var_15_10 = var_4.sendNotification

					GAME = var_3_10006

					local var_15_11 = var_3_10006.MAIL_DOUBLE_CONFIREMATION_MSGBOX
					local var_15_12 = {}

					MailProxy = var_3_10008
					var_15_12.type = var_3_10008.MailMessageBoxType.OverflowConfirm
					i18n = var_8
					var_15_12.content = var_8("mail_storeroom_max_1")
					var_15_12.onYes = arg_15_0
					var_15_12.dropList = var_15_2

					var_15_10(var_15_9, var_15_11, var_15_12)
			...
			for iter_14_0, iter_14_1 in var_2(arg_14_1.isExpBookOverflow) do
				...
				var_2_10007.insert(var_1_7, function(arg_16_0)
					...
					local var_16_2 = var_3_10003.MAIL_DOUBLE_CONFIREMATION_MSGBOX
					local var_16_3 = {}

					MailProxy = var_3_10005
					var_16_3.type = var_3_10005.MailMessageBoxType.ShowTips
					i18n = var_5

					local var_16_4 = "player_expResource_mail_overflow"

					Item = var_3_10007
					var_16_3.content = var_5(var_16_4, var_3_10007.getConfigData(iter_14_1).name)
		...
		if var_1_1.type == "ids" then
			...
			var_11.insert(var_1_6, function(arg_17_0)
				...
				local var_17_1 = var_2_10002(var_2_10003)

				var_17_0(var_2.GetMailsAttachments(var_17_1, var_1_1.list), var_1_1.list)
			...
			var_11.insert(var_1_6, function(arg_19_0, arg_19_1)
				...
				var_19_0(var_2_10003.map(arg_19_1.drop_list, function(arg_20_0)
					Drop = var_3_10001
		...
		if not var_1_3 then
			...
			var_11.insert(var_1_6, function(arg_21_0, arg_21_1, arg_21_2)
				if #arg_21_2 > 0 then
					...
					GAME = var_2_10005
					var_2_10005 = var_2_10005.MAIL_DOUBLE_CONFIREMATION_MSGBOX

					local var_21_2 = {}

					MailProxy = var_2_10007
					var_21_2.type = var_2_10007.MailMessageBoxType.ReceiveAward
					i18n = var_2_10007
					var_21_2.content = var_2_10007("mail_take_all_mail_msgbox")
					...
					var_21_1(var_21_0, var_2_10005, var_21_2)
				else
					...
					local var_21_5 = var_2_10005.MAIL_DOUBLE_CONFIREMATION_MSGBOX
					local var_21_6 = {}

					MailProxy = var_2_10007
					var_21_6.type = var_2_10007.MailMessageBoxType.ShowTips
					i18n = var_7
					var_21_6.content = var_7("mail_manage_3")
	...
	var_10(var_1_6, function(arg_25_0)
		...
		local var_25_3 = var_2_10004.DEAL_MAIL_OPERATION_DONE
		local var_25_4 = {
			cmd = var_1_0
		}

		underscore = var_6
		var_25_4.ids = var_6.rest(arg_25_0.mail_id_list, 1)
