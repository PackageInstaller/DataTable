...
function var_0_1.execute(arg_1_0, arg_1_1)
	...
	var_3.Send(var_1_2, 23420, {
		...
		if arg_2_0.result == 0 then
			...
			var_1.SetOrderTimestamp(var_2_10003, arg_2_0.timestamp)
			...
			var_2_0(var_2_10003, var_4.GetPreorderCurrentyCnt() * -1)
			...
			var_2_1(var_2_10003, var_4.AUCTION_GAME_PREORDER_BOX_DONE)
		else
			pg = var_1
