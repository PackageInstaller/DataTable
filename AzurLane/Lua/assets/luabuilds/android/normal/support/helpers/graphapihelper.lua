...
function var_0.SetForceGraphApi(arg_4_0)
	...
	var_2("Set Graphi Api " .. arg_4_0)

	PlayerPrefs = var_2

	var_2.SetInt(var_0.SaveKey_Graphics_API, arg_4_0)
...
function var_0.GetCurGraphApi()
	...
	return var_1_10000(var_1_10001.graphicsDeviceType)
end
...
function var_0.IsUsingVulkan()
	...
	return var_6_1(var_1_10002.lower(var_6_0), "vulkan")
end
