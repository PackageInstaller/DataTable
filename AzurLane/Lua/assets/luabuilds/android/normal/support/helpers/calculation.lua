...
local function var_0_1(arg_1_0, arg_1_1)
	...
	local var_1_2 = arg_1_0.getEquipmentProperties(var_1_1)

	defaultValue = var_1_1

	local var_1_3 = arg_1_0
	local var_1_4 = arg_1_0.getProperties(var_1_3, arg_1_1)

	AttributeType = var_1_3

	local var_1_5 = var_1_1(var_1_4[var_1_3.Air], 0)

	defaultValue = var_5
	EquipType = var_6

	local var_1_6 = var_5(var_1_0[var_6.FighterAircraft], 0) * var_0_0.p

	defaultValue = var_6
	EquipType = var_7

	local var_1_7 = var_1_6 + var_6(var_1_0[var_7.TorpedoAircraft], 0) * var_0_0.q

	defaultValue = var_6
	EquipType = var_7

	local var_1_8 = var_1_7 + var_6(var_1_0[var_7.BomberAircraft], 0) * var_0_0.s

	defaultValue = var_6
	EquipType = var_7

	local var_1_9 = var_1_5 * (var_1_8 + var_6(var_1_0[var_7.SeaPlane], 0) * var_0_0.t) * (0.8 + arg_1_0.level * var_0_0.r / 100) / 100

	defaultValue = var_5
	AttributeType = var_6

	return var_1_9 + var_5(var_1_2[var_6.AirDominate], 0)
end
...
local function var_0_7(arg_4_0, arg_4_1, arg_4_2)
	...
	while var_4_2 - var_4_1 > 0.01 do
		...
		local var_4_5 = var_7.sqrt(var_4_4)

		math = var_8

		if var_4_0 > var_4_5 + var_8.sqrt(var_4_4 + arg_4_2) then
			var_4_1 = var_4_4
		else
			var_4_2 = var_4_4
		end
