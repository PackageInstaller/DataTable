...
function var_0_10000.IpairsCArray(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in var_1_10002(var_1_10003.CArrayToArray(arg_13_0)) do
...
function var_0_10000.shallowCopy(arg_26_0)
	...
	for iter_26_0, iter_26_1 in var_2(arg_26_0) do
...
function var_0_10000.CastToString(arg_33_0)
	...
	if var_1_10001(arg_33_0) == "string" then
		...
		return var_33_0 .. var_2(arg_33_0) .. "'"
	end
	...
	for iter_33_2, iter_33_3 in var_4(arg_33_0) do
		...
		if var_1_10009(iter_33_2) == "number" then
			if var_33_2 < iter_33_2 then
				...
				var_1_10009 = var_33_1
				string = var_33_4
				var_33_4 = var_33_4.format

				local var_33_5 = "[%s]=%s"
				local var_33_6 = iter_33_2

				table = var_1_10013
				var_33_1 = var_1_10009 .. var_33_4(var_33_5, var_33_6, var_1_10013.CastToString(iter_33_3))
			end
		else
			if var_33_3 then
				var_33_1 = var_33_1 .. ","
			...
			local var_33_7 = var_33_4.format
			local var_33_8 = "%s=%s"
			local var_33_9 = iter_33_2

			table = var_1_10013
			var_33_1 = var_1_10009 .. var_33_7(var_33_8, var_33_9, var_1_10013.CastToString(iter_33_3))
		end
	end
