...
function var_5._insert(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_6 = var_9(var_8_1.x, 0, var_8_3.z)

	Vector3 = var_10
	var_8_4[2] = var_8_5(var_8_6, var_10(var_8_2.x, 0, var_8_1.z), arg_8_2)
	...
	Vector3 = var_10
	var_8_7[3] = var_8_8(var_8_9, var_10(var_8_1.x, 0, var_8_2.z), arg_8_2)
...
function var_5.GetCldList(arg_14_0, arg_14_1, arg_14_2)
	...
	while #var_14_5 > 0 do
		local var_14_6 = var_0_10004.remove(var_14_5)

		ipairs = var_10

		for iter_14_2, iter_14_3 in var_10(var_14_6.nodes) do
		...
		for iter_14_4, iter_14_5 in var_10(var_14_6.childs) do
			null = var_1_10015
...
function var_5.GetCldListGradient(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	local var_15_0 = var_1_10006.cos(arg_15_1)
	local var_15_1 = 0

	math = var_1_10008

	local var_15_2 = var_1_10005(var_15_0, var_15_1, var_1_10008.sin(arg_15_1))

	Vector3 = var_15_0

	local var_15_3 = var_15_0.Cross
	local var_15_4 = var_15_2

	Vector3 = var_8

	local var_15_5 = var_15_3(var_15_4, var_8.up)
	local var_15_6 = {
		1,
		2,
		3,
	...
	for iter_15_0 = #var_15_11, 1, -1 do
		...
		repeat
			...
			local var_15_18 = var_24.Dot(var_15_2, var_15_13 - var_15_6[1])

			if var_15_17 < 0 and var_15_18 < 0 or arg_15_3 < var_15_17 and arg_15_3 < var_15_18 then
			...
			local var_15_19 = var_25.Dot(var_15_5, var_15_14 - var_15_6[1])

			Vector3 = var_26

			local var_15_20 = var_26.Dot(var_15_5, var_15_15 - var_15_6[1])

			if var_15_19 < 0 and var_15_20 < 0 or arg_15_2 < var_15_19 and arg_15_2 < var_15_20 then
				var_0_10004.remove(var_15_11, iter_15_0)
			end
...
function var_5.GetCldListEllipse(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	local var_16_4 = var_1_10009(var_16_0 - arg_16_1, 0, var_16_1 - arg_16_2)

	Vector3 = var_10

	var_16_3(var_16_2, var_16_4, var_10(var_16_0 + arg_16_1, 0, var_16_1 + arg_16_2))

	local var_16_5 = arg_16_0:GetCldList(var_6, nil)
	local var_16_6 = {}

	ipairs = var_9

	for iter_16_0, iter_16_1 in var_9(var_16_5) do
		ellipseIntersectsRect = var_1_10014

		if var_1_10014(var_16_0, var_16_1, arg_16_1, arg_16_2, iter_16_1.min, iter_16_1.max) then
			var_0_10004.insert(var_16_6, iter_16_1)
		end
	end
