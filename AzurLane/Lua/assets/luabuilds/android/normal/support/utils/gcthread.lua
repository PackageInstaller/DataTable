...
function var_0.GCFinal(arg_4_0)
	...
	if var_1 then
		...
		var_1(var_4_2 .. var_3("count") * var_0.R1024 .. "MB")
	end
...
function var_0.CalcStep(arg_6_0)
	...
	local var_6_1 = var_2.max

	math = var_3
	arg_6_0.step = var_6_0 * var_6_1(1 - var_3.max(arg_6_0.gccost - 3, 0) * 0.1, 0.1)
...
function var_0.WatchStep(arg_10_0)
	...
	if var_1_10002("step", arg_10_0.step) then
		...
		if var_2 then
			...
			var_2(var_10_1 .. var_4("count") * var_0.R1024 .. "MB")
		end
