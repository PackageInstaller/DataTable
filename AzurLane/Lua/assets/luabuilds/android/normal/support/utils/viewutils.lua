...
function var_1.SetLayer(arg_1_0, arg_1_1)
	...
	if var_1_10002(var_1_10003(arg_1_0)) then
		return
	end
...
function var_1.SetSortingOrder(arg_2_0, arg_2_1)
	...
	local var_2_2 = var_2_1(var_2_0, var_1_10004(var_1_10005))
	...
	if var_2_5(var_2_4, var_5(iter_2_0)) then
...
function var_1.AddSortingOrder(arg_3_0, arg_3_1)
	...
	if var_3_5(var_3_4, var_5(iter_3_0)) then
