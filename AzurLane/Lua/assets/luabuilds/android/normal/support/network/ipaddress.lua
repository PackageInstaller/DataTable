...
function var_0_1.ConvertIPRange(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_1(var_0_3) do
		...
		var_5_1.insert(var_5_0, var_5_2)

		local var_5_3 = arg_5_0
		local var_5_4 = arg_5_0.IP2Int(var_5_3, iter_5_1[2])

		table = var_5_3

		var_5_3.insert(var_5_0, var_5_4)

		assert = var_9

		var_9(var_5_2 < var_5_4, "ip range is illegal" .. iter_5_1[1] .. "-" .. iter_5_1[2])
...
function var_0_1.CheckExportIP(arg_6_0)
	...
	local var_6_1 = arg_6_0.IP2Int(var_6_0, arg_6_0.exportIP)

	ipairs = var_6_0

	for iter_6_0, iter_6_1 in var_6_0(arg_6_0.IPRangeIntList) do
		if var_6_1 >= iter_6_1[1] and var_6_1 <= iter_6_1[2] then
			return true
		end
	end
...
function var_0_1.GetLocalIP(arg_8_0)
	...
	local var_8_1 = var_8_0(var_1_10002("UnityEngine.Network"), "player")

	ReflectionHelp = var_2

	local var_8_2 = var_2.RefGetProperty

	typeof = var_3
	arg_8_0.localIP = var_8_2(var_3("UnityEngine.NetworkPlayer"), "ipAddress", var_8_1)
