...
function var_0_1.StartSend(arg_8_0)
	...
	if #arg_8_0.toSends > 0 then
		...
		var_8_1(var_8_0, var_1_10003(arg_8_0.toSends[1]))
	else
		warning = var_8_1
...
function var_0_1.Send(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7)
	...
	if not var_8.getConnection(var_9_1) then
		var_9_1 = arg_9_0.connectionMgr
		var_9_1.needStartSend = true

		local var_9_2 = arg_9_0.connectionMgr

		var_9_1.Reconnect(var_9_2, function()
			return
		end)
	...
	defaultValue = var_9_1
	arg_9_5 = var_9_1(arg_9_5, true)
	defaultValue = var_9
			...
			if var_2_10007(iter_13_1) == "table" then
				if arg_13_0[iter_13_0].add then
					...
					for iter_13_2, iter_13_3 in var_2_10007(iter_13_1) do
						...
						var_13_0(var_13.add(var_13_1), iter_13_3)
					end
	...
	if arg_9_5 then
		...
		var_9_14(var_9_13, var_15.Pack(var_9_15, var_9_4, var_9_10:GetId(), var_9_12))
		...
		var_9_14(var_9_16, var_15.Pack(var_9_17, 0, var_9_10:GetId(), var_9_12))
