		...
		function(arg_4_0)
			if not arg_3_0._go then
				...
				var_1.GetUI(var_4_0, "PerformUI", true, function(arg_5_0)
					...
					CpkPerformPlayer = var_5_2

					local var_5_4 = var_5_2.New

					findTF = var_3
					var_5_3.cpkPlayer = var_5_4(var_3(arg_3_0._tf, "window_cpk"))
					...
					findTF = var_3
					var_5_5.dialoguePlayer = var_5_6(var_3(arg_3_0._tf, "window_dialogue"))
					...
					findTF = var_3
					var_5_7.picturePlayer = var_5_8(var_3(arg_3_0._tf, "window_picture"))
					...
					findTF = var_3
					var_5_9.storyPlayer = var_5_10(var_3(arg_3_0._tf, "window_story"))
					setActive = var_5_9
...
function var_0_1.PlayOne(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_1_10005(var_1_10006.child_performance[arg_7_1], "child_performance not exist id: " .. arg_7_1)
...
function var_0_1.play(arg_12_0, arg_12_1, arg_12_2, arg_12_3, arg_12_4)
	...
	var_1_10005(var_1_10006.child_performance[arg_12_1], "child_performance not exist id: " .. arg_12_1)
	...
	arg_12_0.addTaskProgress(var_12_0, arg_12_1)
	...
	local var_12_2 = var_12_0.child_performance[arg_12_1]

	arg_12_0:setWindowStatus(var_12_2)
	...
	var_12_4[var_1_10010.PERFORM_TYPE_ANIM] = function()
		local var_14_0 = arg_12_0.cpkPlayer

		var_0.Play(var_14_0, var_12_2, var_12_1, arg_12_4)

		return
	end
	EducateConst = var_10
	var_12_4[var_10.PERFORM_TYPE_WORD] = function()
		...
		var_1.Play(var_15_3, var_15_2, var_12_1)

		return
	end
	EducateConst = var_10
	var_12_4[var_10.PERFORM_TYPE_STORY] = function()
		local var_16_0 = arg_12_0.storyPlayer

		var_0.Play(var_16_0, var_12_2, var_12_1)

		return
	end
	EducateConst = var_10
	var_12_4[var_10.PERFORM_TYPE_PICTURE] = function()
		local var_17_0 = arg_12_0.picturePlayer

		var_0.Play(var_17_0, var_12_2, var_12_1, arg_12_4)

		return
	end

	var_7(var_12_3, var_12_4)
...
function var_0_1.addTaskProgress(arg_18_0, arg_18_1)
	...
	if #var_18_3 > 0 then
		...
		GAME = var_18_8
		var_18_8 = var_18_8.EDUCATE_ADD_TASK_PROGRESS

		local var_18_9 = {}

		EducateTask = iter_18_1
		var_18_9.system = iter_18_1.SYSTEM_TYPE_MIND
		var_18_9.progresses = var_18_3
	...
	if #var_18_4 > 0 then
		...
		local var_18_10 = var_6.m02
		local var_18_11 = var_6.sendNotification
		...
		EducateTask = iter_18_1
		var_18_12.system = iter_18_1.SYSTEM_TYPE_TARGET
		var_18_12.progresses = var_18_4

		var_18_11(var_18_10, var_18_8, var_18_12)
	end

	if #var_18_5 > 0 then
		pg = var_6

		local var_18_13 = var_6.m02
		local var_18_14 = var_6.sendNotification

		GAME = var_18_8

		local var_18_15 = var_18_8.EDUCATE_ADD_TASK_PROGRESS
		local var_18_16 = {}

		EducateTask = iter_18_1
		var_18_16.system = iter_18_1.STSTEM_TYPE_MAIN
		var_18_16.progresses = var_18_5
