...
function var_0_1.Play(arg_2_0, arg_2_1, arg_2_2)
	...
	local var_2_2 = var_2_0.child_word[var_2_1]

	assert = var_5

	var_5(var_2_1 and var_2_2, "child_word not exist id: " .. var_2_1)

	setActive = var_5

	var_5(arg_2_0.eventTipBig, arg_2_1.show_event == 1)
...
function var_0_1._play(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	local var_4_2 = var_4_1 ~= var_5.WORD_TYPE_CHILD
	...
	if not var_4_2 then
		getProxy = var_6
		EducateProxy = var_4_4
		var_4_4 = var_6(var_4_4)
		var_4_4 = var_6.GetCharData(var_4_4)

		local var_4_5 = var_6.GetPaintingName(var_4_4)

		setImageSprite = var_4_4

		local var_4_6 = arg_4_0.image

		LoadSprite = var_1_10009

		var_4_4(var_4_6, var_1_10009("storyicon/" .. var_4_5), true)
	end

	local var_4_7 = var_4_2 and arg_4_0.text2 or arg_4_0.text
	local var_4_8 = arg_4_2.word

	string = var_4_4

	local var_4_9 = var_4_4.gsub(var_4_8, "$1", arg_4_0.callName)

	setText = var_7

	var_7(var_4_7, var_4_9)

	GetComponent = var_7

	local var_4_10 = var_4_7

	typeof = var_9
	Typewriter = var_10

	local var_4_11 = var_7(var_4_10, var_9(var_10))
	local var_4_12 = arg_4_2.char_type

	EducateConst = var_9

	if var_4_12 == var_9.WORD_TYPE_ASIDE then
		setActive = var_4_12

		var_4_12(arg_4_0.nameTF, false)
	else
		setActive = var_4_12

		var_4_12(arg_4_0.nameTF, true)

		local var_4_13 = ""
		local var_4_14 = arg_4_2.char_type

		EducateConst = var_10

		if var_4_14 == var_10.WORD_TYPE_CHILD then
			var_4_13 = arg_4_0.name
		else
			var_4_14 = arg_4_2.char_type
			EducateConst = var_10

			if var_4_14 == var_10.WORD_TYPE_PLAYER then
				var_4_13 = arg_4_0.playerName
			end
		end

		setText = var_4_14

		var_4_14(arg_4_0.nameText, var_4_13)
	end

	function var_4_11.endFunc()
		...
		for iter_5_0 = 1, #arg_4_0.drops do
			...
			var_2_10005.insert(var_5_0, function(arg_6_0)
				...
				if iter_5_0 < arg_4_0.resultTF.childCount then
					local var_6_5 = arg_4_0.resultTF
					local var_6_6

					if not var_6_6.GetChild(var_6_5, iter_5_0 - 1) then
						cloneTplTo = var_6_6
						var_6_6 = var_6_6(arg_4_0.resultTpl, arg_4_0.resultTF)
					end

					local var_6_7 = var_6_4.type

					EducateConst = var_4

					if var_6_7 == var_4.DROP_TYPE_BUFF then
						setActive = var_6_7

						var_6_7(var_6_6:Find("icon"), false)

						setText = var_6_7

						local var_6_8 = var_6_6
						local var_6_9 = var_6_6.Find(var_6_8, "name")

						pg = var_6_8

						var_6_7(var_6_9, var_6_8.child_buff[var_6_4.id].name)

						setText = var_6_7

						var_6_7(var_6_6:Find("value"), "")
					else
						setActive = var_6_7

						var_6_7(var_6_6:Find("icon"), true)

						EducateHelper = var_6_7

						var_6_7.UpdateDropShowForAttr(var_6_6, var_6_4)
					end

					setActive = var_6_7

					var_6_7(var_6_6, true)

					local var_6_10 = var_6_6
					local var_6_11 = var_6_6.GetComponent

					typeof = var_5
					Animation = var_3_10006

					local var_6_12 = var_6_11(var_6_10, var_5(var_3_10006))

					var_3.Play(var_6_12, "anim_educate_attr_in")
		...
		var_1(var_5_0, function()
			...
			System = var_3_10003
			var_8_0.twId = var_8_1(var_8_2, var_3_10003.Action(function()
	...
	var_4_11:setSpeed(arg_4_0.speed)
	var_4_11:Play()
...
function var_0_1.checkName(arg_13_0)
	if not arg_13_0.callName then
		...
		var_1_10002 = var_1.GetCharData(var_1_10002)
		arg_13_0.callName = var_1.GetCallName(var_1_10002)
	end
	...
	if not arg_13_0.name then
		...
		var_1_10002 = var_1(var_1_10002)
		var_1_10002 = var_1.GetCharData(var_1_10002)
		arg_13_0.name = var_1.GetName(var_1_10002)
	end
