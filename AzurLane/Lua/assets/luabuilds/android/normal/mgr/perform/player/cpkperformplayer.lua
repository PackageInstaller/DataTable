...
function var_0_1.getCpkName(arg_2_0, arg_2_1)
	...
	elseif var_2 == arg_2_0.maxStage then
		...
		local var_2_4 = var_2_2.indexof(arg_2_0.personalityIds, var_2_3)
...
function var_0_1.Play(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	var_4(var_3_0, not var_1_10006(arg_3_0.cpkTF))

	local var_3_1

	if not arg_3_0:getCpkName(arg_3_1.param[1]) then
		var_3_1 = ""
	end
	...
	if var_6("educateanim/" .. var_3_1) then
		LoadAnyAsync = var_7

		var_7("educateanim/" .. var_3_1, "", nil, function(arg_4_0)
			Object = var_2_10001
			...
			var_4_1.player = var_4_4(var_4_3, var_5(var_2_10006))
			arg_3_0.time = var_3_2
			...
			var_4_9(var_4_8, var_5.CriManaMovieMaterialBase.MaxFrameDrop.Infinite)
...
function var_0_1.SetUIParam(arg_10_0, arg_10_1)
	...
	typeof = var_4
	Image = var_1_10005
	var_1_10002(var_10_0, var_4(var_1_10005)).enabled = arg_10_1.showCpkBg
