...
local function var_0_5(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if arg_4_0 == "SYG001" then
		...
		TRACKING_TUTORIAL_COMPLETE_2 = var_1_10006

		var_4_3(var_4_2, var_1_10006)
	elseif arg_4_0 == "SYG003" then
		...
		var_4_3 = var_4_3.Tracking
		TRACKING_TUTORIAL_COMPLETE_3 = var_1_10006

		var_4_3(var_4_4, var_1_10006)
	elseif arg_4_0 == "SYG006" then
		...
		var_4_3 = var_4_3.Tracking
		TRACKING_TUTORIAL_COMPLETE_4 = var_1_10006

		var_4_3(var_4_5, var_1_10006)
	end
	...
	if arg_4_3 then
		...
		var_4_8(var_4_7, var_1_10006.STORY_UPDATE, {
			storyId = arg_4_0
		})
...
function var_0_1.PlayDailyLevel(arg_11_0, arg_11_1)
	if not var_0_3("NG0015") then
		...
		var_11_1(var_11_0, var_1_10004.STORY_UPDATE, {
			storyId = "NG0015"
		})
		arg_11_1()
	end
...
function var_0_1.PlayCommander(arg_12_0)
	...
	for iter_12_0, iter_12_1 in var_1_10005(var_12_1) do
		table = var_1_10010
		...
		var_1_10010.insert(var_12_2, function(arg_14_0)
			if iter_12_1 == "NG006" then
				...
				var_14_0 = var_14_0(var_2_10002.getData(var_2_10003))

				if not (1 <= var_14_0) then
					if iter_12_1 == "NG007" then
						getProxy = var_14_0
						BagProxy = var_2_10002
						var_2_10002 = var_14_0(var_2_10002)

						if not (var_14_0.getItemCountById(var_2_10002, 20012) < 1) then
							if iter_12_1 == "NG008" then
								getProxy = var_14_0
								CommanderProxy = var_2_10002
								var_2_10002 = var_14_0(var_2_10002)
								var_2_10002 = var_14_0.getBoxes(var_2_10002)[1]
								var_14_0 = var_14_0.getState(var_2_10002)
								...
								if var_14_0 == var_2_10002.STATE_FINISHED then
									if iter_12_1 == "NG009" then
										...
										if var_14_0(var_2.getData(var_2_10003)) ~= 1 then
											pg = var_14_0

											local var_14_1 = var_14_0.m02
											local var_14_2 = var_1.sendNotification

											GAME = var_2_10003

											var_14_2(var_14_1, var_2_10003.STORY_UPDATE, {
												storyId = iter_12_1
											})
											arg_14_0()
									...
									if iter_12_1 == "ZHIHUIMIAO2" or iter_12_1 == "ZHIHUIMIAO3" or iter_12_1 == "ZHIHUIMIAO4" then
										...
										local var_14_3 = var_1.NewStoryMgr.GetInstance()

										var_1.Play(var_14_3, iter_12_1, arg_14_0, true)
