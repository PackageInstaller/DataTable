...
function var_0_1.Init(arg_5_0, arg_5_1)
	...
	tf = var_5_2
	GameObject = var_3
	arg_5_0.levelCamera = var_5_2(var_3.Find("LevelCamera"))
	...
	tf = var_5_4
	GameObject = var_3
	arg_5_0.overlayCamera = var_5_4(var_3.Find("OverlayCamera"))
	...
	for iter_5_0, iter_5_1 in var_5_22(arg_5_0.cameraBlurs) do
		DevicePerformanceLevel = var_1_10008

		if var_5_25 == var_1_10008.Low then
	...
	Shader = var_4
	arg_5_0.defaultMaterial = var_5_26(var_4.Find("UI/Default"))
	Material = var_3

	local var_5_27 = var_3.New

	Shader = var_4
	arg_5_0.partialBlurMaterial = var_5_27(var_4.Find("UI/PartialBlur"))
	DebugPanel = var_3
	...
	var_3({
		function(arg_6_0)
			...
			LoadingPanel = var_2
			var_6_0._loadPanel = var_2.New(arg_6_0)
...
function var_0_1.displayLoadingBG(arg_9_0, arg_9_1)
	...
	if arg_9_0.showBG then
		...
		local var_9_2 = var_0.UIMgr.GetInstance()
...
function var_0_1.AttachStickOb(arg_16_0, arg_16_1)
	...
	typeof = var_5
	Image = var_1_10006
	arg_16_0._areaImg = var_16_2(var_16_1, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	arg_16_0._stickImg = var_16_4(var_16_3, var_5(var_1_10006))

	local var_16_5 = arg_16_1
	local var_16_6 = arg_16_1.GetComponent

	typeof = var_5
	StickController = var_1_10006
	arg_16_0._stickCom = var_16_6(var_16_5, var_5(var_1_10006))
...
function var_0_1.Marching(arg_19_0)
	...
	local var_19_2 = var_19_1(var_1_10003(arg_19_0._stick), 0, 0.625, 1.8)
	local var_19_3 = var_2.setOnUpdate

	System = var_4

	local var_19_4 = var_19_3(var_19_2, var_4.Action_float(function(arg_20_0)
	...
	var_19_5(var_19_4, var_4.Action(function()
		arg_19_0.hrz = 0
...
function var_0_1.OverlayPanel(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_0 = var_0.LayerWeightMgr.GetInstance()
...
function var_0_1.BlurPanel(arg_26_0, arg_26_1, arg_26_2)
	...
	local var_26_0 = var_0.LayerWeightMgr.GetInstance()
...
function var_0_1.UnOverlayPanel(arg_27_0, arg_27_1, arg_27_2)
	local var_27_0 = var_0.LayerWeightMgr.GetInstance()
...
function var_0_1.UpdatePBList(arg_30_0, arg_30_1)
	...
	for iter_30_2, iter_30_3 in var_2(arg_30_1) do
		...
		local var_30_2 = var_30_1(var_30_0, var_1_10009(var_1_10010))

		assert = var_30_0

		var_30_0(var_30_2, "mask should be an image.")

		var_0_6[var_30_2] = var_30_2.material
...
function var_0_1.TempOverlayPanelPB(arg_32_0, arg_32_1, arg_32_2)
	...
	var_32_1(var_32_0, var_32_2, var_1_10006({}, {
...
function var_0_1.UpdateOtherPBList(arg_35_0, arg_35_1)
	...
	for iter_35_2, iter_35_3 in var_2(arg_35_1 or {}) do
		...
		local var_35_2 = var_35_1(var_35_0, var_1_10009(var_1_10010))

		assert = var_35_0

		var_35_0(var_35_2, "mask should be an image.")

		var_0_8[var_35_2] = var_35_2.material
...
function var_0_1.SetMainCamBlurTexture(arg_39_0, arg_39_1)
	...
	local var_39_2 = var_39_1(var_39_0, var_1_10004(var_1_10005))

	ReflectionHelp = var_39_0

	local var_39_3 = var_39_0.RefCallStaticMethod

	typeof = var_4

	local var_39_4 = var_4("UnityEngine.RenderTexture")
	local var_39_5 = "GetTemporary"
	local var_39_6 = {}

	typeof = var_1_10007
	var_39_6[1] = var_1_10007("System.Int32")
	typeof = var_7
	var_39_6[2] = var_7("System.Int32")
	typeof = var_7
	var_39_6[3] = var_7("System.Int32")
	...
	Screen = var_8
	var_39_7[1] = var_8.width
	Screen = var_8
	var_39_7[2] = var_8.height
	var_39_2.targetTexture = var_39_3(var_39_4, var_39_5, var_39_6, var_39_7)

	var_39_2:Render()

	local var_39_8 = var_0.ShaderMgr.GetInstance()
	...
	local var_39_11 = var_6("UnityEngine.RenderTexture")
	local var_39_12 = "ReleaseTemporary"
	local var_39_13 = {}

	typeof = var_1_10009
	var_39_13[1] = var_1_10009("UnityEngine.RenderTexture")
