...
function var_0_1.RealtimeSinceStartup(arg_16_0)
	...
	return var_16_0(var_1_10002.realtimeSinceStartup)
end
...
function var_0_1.GetServerTimeMs(arg_20_0)
	...
	return var_20_0((var_1_10002.realtimeSinceStartup + arg_20_0._serverUnitydelta) * 1000)
end
...
function var_0_1.GetServerOverWeek(arg_22_0, arg_22_1)
	...
	return (var_1_10005.ceil((arg_22_0:GetServerTime() - var_22_0) / 0))
end
...
function var_0_1.GetServerHour(arg_25_0)
	...
	return var_1_10003.floor(var_25_0 % var_0_3 / var_0_2)
end
...
function var_0_1.STimeDescC(arg_28_0, arg_28_1, arg_28_2, arg_28_3)
	...
	if arg_28_3 then
		...
		return var_1_10004(var_28_0, arg_28_1 + var_1_10006.time() - arg_28_0:GetServerTime())
	else
		os = var_1_10004
...
function var_0_1.ChieseDescTime(arg_31_0, arg_31_1, arg_31_2)
	...
	if arg_31_2 then
		...
		os = var_1_10007
		var_31_1 = var_1_10005(var_31_2, arg_31_1 + var_1_10007.time() - arg_31_0:GetServerTime())
	end
	...
	NumberToChinese = var_6

	local var_31_4 = var_6(var_31_3[1], false)
	local var_31_5 = "年"
...
function var_0_1.GetTimeToNextTime(arg_32_0, arg_32_1, arg_32_2, arg_32_3)
	if not arg_32_1 then
		var_1_10005 = arg_32_0
		arg_32_1 = arg_32_0.GetServerTime(var_1_10005)
	end
...
function var_0_1.DescCDTime(arg_40_0, arg_40_1)
	...
	local var_40_1 = var_3.floor(arg_40_1 / 60)
...
function var_0_1.DescCDTimeForMinute(arg_41_0, arg_41_1)
	...
	local var_41_1 = var_3.floor(arg_41_1 / 60)
...
function var_0_1.parseTimeFrom(arg_42_0, arg_42_1)
	...
	local var_42_1 = var_3.fmod

	math = var_1_10004

	local var_42_2 = var_42_1(var_1_10004.floor(arg_42_1 / 16), 24)
	...
	local var_42_4 = var_42_3(var_5.floor(arg_42_1 / 60), 60)
...
function var_0_1.DiffDay(arg_43_0, arg_43_1, arg_43_2)
	...
	return var_43_0 - var_4.floor((arg_43_1 - arg_43_0._sAnchorTime) / var_0_3)
end
...
function var_0_1.IsSameDay(arg_44_0, arg_44_1, arg_44_2)
	...
	return var_44_0 == var_4.floor((arg_44_2 - arg_44_0._sAnchorTime) / var_0_3)
end
...
function var_0_1.IsSameWeek(arg_45_0, arg_45_1, arg_45_2)
	...
	return var_45_0 == var_4.floor((arg_45_2 - arg_45_0._sAnchorTime) / var_0_4)
end
