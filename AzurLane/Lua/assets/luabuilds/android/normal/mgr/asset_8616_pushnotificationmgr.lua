...
function var_0_1.Push(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_2 = var_7_0.time() + var_7_1
	local var_7_3 = arg_7_0

	arg_7_0.log(var_7_3, arg_7_1, arg_7_2, var_7_2)
	...
	var_7_3.insert(var_0_4, var_7_4)
...
function var_0_1.PushAll(arg_10_0)
	...
	if var_1_10001(var_1_10002) and var_1:getInited() then
...
function var_0_1.PushGold(arg_12_0)
	...
	local var_12_5 = var_1_10007(var_1_10008).data.resUpdateTm
...
function var_0_1.PushOil(arg_13_0)
	...
	local var_13_5 = var_1_10007(var_1_10008).data.resUpdateTm
...
function var_0_1.PushSchool(arg_15_0)
	...
	local var_15_3 = var_3(var_1_10004)
	...
	for iter_15_0, iter_15_1 in var_15_3(var_15_1) do
		...
		if var_15_5 > var_11.GetServerTime(var_15_6) then
			...
			getSkillName = var_15_10

			local var_15_12 = var_15_10(iter_15_1:getSkillId(var_15_7))

			string = var_15

			local var_15_13 = var_15.gsub(var_15_2.content, "$1", var_15_11)
...
function var_0_1.PushTechnlogy(arg_16_0)
	...
	local var_16_1 = var_2(var_1_10003)
...
function var_0_1.PushBluePrint(arg_17_0)
	...
	if var_17_0 and var_17_1 and var_17_2 and var_17_1:getBuildingBluePrint() then
		local var_17_3 = var_4
		local var_17_4 = var_4.getTaskIds(var_17_3)
		...
		for iter_17_0, iter_17_1 in var_17_3(var_17_4) do
			...
			if var_17_5 > var_12.GetServerTime(var_17_6) then
				...
				local var_17_8 = var_17_2:isFinishPrevTasks(iter_17_1)

				if not var_17_7 and var_17_8 then
					local var_17_9 = var_4
					local var_17_10 = var_4.getShipVO(var_17_9)

					string = var_17_9

					local var_17_11 = var_17_9.gsub(var_17_0.content, "$1", var_17_10:getConfig("name"))
...
function var_0_1.PushCommander(arg_18_0)
	...
	local var_18_1 = var_2(var_1_10003)

	if var_18_0 and var_18_1 then
		local var_18_2 = var_18_1
		local var_18_3 = var_18_1.getBoxes(var_18_2)

		pairs = var_18_2

		for iter_18_0, iter_18_1 in var_18_2(var_18_3) do
			local var_18_4 = iter_18_1
			local var_18_5 = iter_18_1.getState(var_18_4)

			CommanderBox = var_18_4

			if var_18_5 == var_18_4.STATE_STARTING then
				local var_18_6 = var_18_0.content

				arg_18_0:Push(var_18_0.title, var_18_6, iter_18_1.finishTime)
...
function var_0_1.log(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	originalPrint = var_20_1

	var_20_1(var_20_2, "-", arg_20_1, " - ", arg_20_2, " - ", var_20_0, "s后推送")
