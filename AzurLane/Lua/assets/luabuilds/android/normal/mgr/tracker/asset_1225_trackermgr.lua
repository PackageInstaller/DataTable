...
function var_0_1.Tracking(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if var_1_10004(var_1_10005) == nil or not var_4:getData() then
		var_3_0 = nil
	end
	...
	if var_1_10007(var_1_10008) == nil or not var_7:getData() then
		var_3_2 = nil
	end
	...
	ServerProxy = var_1_10011

	local var_3_4 = var_1_10010(var_1_10011)
	local var_3_5 = var_10.getLastServer(var_3_4, var_3_1).id

	TRACKING_2D_RETENTION = var_3_6

	if arg_3_1 ~= var_3_6 then
		TRACKING_7D_RETENTION = var_3_6

		local var_3_6

		if arg_3_1 == var_3_6 then
			var_3_6 = "tracking_" .. arg_3_1
			PlayerPrefs = var_14

			if var_14.GetInt(var_3_6, 0) <= 0 then
				originalPrint = var_1_10015

				var_1_10015("tracking type : " .. arg_3_1 .. "   user_id:" .. var_3_3)

				PlayerPrefs = var_1_10015

				var_1_10015.SetInt(var_3_6, 1)
			...
			originalPrint = var_3_6

			var_3_6("tracking type : " .. arg_3_1 .. ",   user_id:" .. var_3_3 .. ",   data:" .. (arg_3_2 or "nil"))
			arg_3_0:Call("Tracking", arg_3_1, var_3_3, arg_3_2, var_3_5)
		end

		TRACKING_PURCHASE_CLICK = var_3_6

		if arg_3_1 == var_3_6 then
			if arg_3_2 == 1 then
				originalPrint = var_3_6

				local var_3_7 = "tracking type : "

				TRACKING_PURCHASE_CLICK_MONTHLYCARD = var_1_10015

				var_3_6(var_3_7 .. var_1_10015 .. "   user_id:" .. var_3_3)

				local var_3_8 = arg_3_0

				var_3_6 = arg_3_0.Call
				var_1_10015 = "Tracking"
				TRACKING_PURCHASE_CLICK_MONTHLYCARD = var_16

				var_3_6(var_3_8, var_1_10015, var_16, var_3_3, arg_3_2)
			elseif arg_3_2 == 2 then
				originalPrint = var_3_6

				local var_3_9 = "tracking type : "

				TRACKING_PURCHASE_CLICK_GIFTBAG = var_1_10015

				var_3_6(var_3_9 .. var_1_10015 .. "   user_id:" .. var_3_3)

				local var_3_10 = arg_3_0

				var_3_6 = arg_3_0.Call
				var_1_10015 = "Tracking"
				TRACKING_PURCHASE_CLICK_GIFTBAG = var_16

				var_3_6(var_3_10, var_1_10015, var_16, var_3_3, arg_3_2)
			else
				originalPrint = var_3_6

				local var_3_11 = "tracking type : "

				TRACKING_PURCHASE_CLICK_DIAMOND = var_1_10015

				var_3_6(var_3_11 .. var_1_10015 .. "   user_id:" .. var_3_3)

				local var_3_12 = arg_3_0
				local var_3_13 = arg_3_0.Call
				local var_3_14 = "Tracking"

				TRACKING_PURCHASE_CLICK_DIAMOND = var_16

				var_3_13(var_3_12, var_3_14, var_16, var_3_3, arg_3_2)
			end
		end
