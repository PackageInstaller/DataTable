...
function var_0_1.OnLoaded(arg_5_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.contentTxt = var_5_2(var_5_1, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.acceptBtnTxt = var_5_6(var_5_5, var_3(var_1_10004))
	...
	arg_5_0.scrollrect = var_5_9(var_5_8, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.titleTxt = var_5_12(var_5_11, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_5_0.msgboxTitleTxt = var_5_15(var_5_14, var_3(var_1_10004))
...
function var_0_1.Flush(arg_6_0)
	...
	var_2(nil, arg_6_0.acceptBtn, function()
		if var_6_2 then
			...
			var_7_2(var_7_1, var_2_10002("read_the_user_agreement"))
		end
...
function var_0_1.Hide(arg_9_0)
	...
	if arg_9_0._go then
		...
		var_9_2(var_9_1, var_9_3, var_1_10004.UIMgr.GetInstance().UIMain)
