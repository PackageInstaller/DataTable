...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.fingerAnim = var_1_2(var_1_1, var_4(var_1_10005))
...
function var_0_1.DuplicateNode(arg_4_0, arg_4_1, arg_4_2)
	...
	arg_4_0:SearchUI(var_4_0, function(arg_5_0)
		...
		if var_4_0.childIndex then
			var_2_10005 = var_5_3
			var_5_3 = var_5_3.GetChild(var_2_10005, var_4_0.childIndex)
			var_2_10005 = var_5_2
			var_5_2 = var_5_2.GetChild(var_2_10005, var_4_0.childIndex)
		...
		Timer = var_2_10005
		var_5_4.fingerTimer = var_2_10005.New(function()
		...
		GuideEventTrigger = var_6
		var_5_8.eventTrigger = var_6.New(var_5_7.type, var_5_2, var_5_3, var_5_7.arg, arg_4_2)
...
function var_0_1.UpdateFinger(arg_8_0, arg_8_1, arg_8_2)
	...
	var_5(arg_8_0.fingerTF, not arg_8_2.fingerPos or not arg_8_2.fingerPos.hideFinger)

	Vector2 = var_5

	local var_8_3 = var_5(arg_8_1.sizeDelta.x / 2, -arg_8_1.sizeDelta.y / 2) - var_8_2
	local var_8_4
	...
	Vector3 = var_1_10008
	var_8_5.localScale = var_1_10008(var_8_4, var_8_4, 1)
	...
	if arg_8_2.fingerPos then
		...
		if arg_8_2.slipAnim then
			...
			if not var_12.isTweening(arg_8_0.fingerXyz.gameObject) then
				...
				LeanTween = var_8_16
				var_8_17 = var_8_16.value(arg_8_0.fingerXyz.gameObject, 0, -200, 1)

				local var_8_18 = var_12.setOnUpdate

				System = var_14
				var_8_17 = var_8_18(var_8_17, var_14.Action_float(function(arg_9_0)
		...
		do
			local var_8_19 = arg_8_0.fingerXyz

			Vector3 = var_8_17
			var_8_19.localPosition = var_8_17.zero
		end
...
function var_0_1.OnClear(arg_11_0)
	...
	Vector3 = var_2
	var_11_1.localScale = var_2(1, 1, 1)
