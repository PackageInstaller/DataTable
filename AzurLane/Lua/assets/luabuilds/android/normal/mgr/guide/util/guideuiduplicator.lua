...
local function var_0_1(arg_3_0)
	...
	if var_3_1(var_3_0, var_1_10003(var_1_10004)) == nil then
		...
		if var_3_3(var_3_2, var_3(var_1_10004)) == nil then
			...
			if var_3_5(var_3_4, var_3(var_1_10004)) == nil then
				var_3_6 = false
...
local function var_0_2(arg_4_0)
	...
	local var_4_9 = var_4_8(var_4_7, var_5(iter_4_0))
	...
	local var_4_12 = var_4_11(var_4_10, iter_4_0(iter_4_1))
	local var_4_13 = var_4.ToTable(var_4_12)

	ipairs = var_4_12

	for iter_4_2, iter_4_3 in var_4_12(var_4_13) do
...
local function var_0_4(arg_7_0)
	...
	Animator = var_1_10003
	var_7_0[1] = var_1_10003
	Animation = var_1_10003
	var_7_0[2] = var_1_10003
	...
	for iter_7_0, iter_7_1 in var_1_10001(var_7_0) do
		...
		local var_7_3 = var_7_2(var_7_1, var_1_10008(iter_7_1))
...
function var_0_0.InitDuplication(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	if var_8_1(var_8_0, var_1_10006(var_1_10007)) then
		var_4.alpha = 1
	end
	...
	local var_8_4 = var_8_3(var_8_2, var_1_10007(var_1_10008.UI.Graphic))
	...
	if var_8_6(var_8_5, var_8(var_1_10009)) or var_8_4 == nil then
		...
		local var_8_8 = var_8_5(var_8_7, var_1_10009(var_1_10010))

		Color = var_8_7
		var_8_8.color = var_8_7.New(1, 1, 1, 0)
	end
	...
	if not arg_8_3.keepScrollTxt then
		...
		local var_8_11 = var_8_10(var_8_9, var_1_10009(var_1_10010))
	...
	if var_8_14(var_8_13, var_1_10009(var_1_10010)) then
		local var_8_15 = arg_8_1
		local var_8_16 = arg_8_1.GetComponent

		typeof = var_1_10010
		GraphicRaycaster = iter_8_0

		if var_8_16(var_8_15, var_1_10010(iter_8_0)) == nil then
			...
			var_8(var_8_17, var_10(iter_8_0))
		end
	end
...
function var_0_0.UpdateSettings(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	if arg_9_3.clearAllEvent then
		...
		typeof = var_1_10006
		CanvasGroup = var_1_10007
		var_4(var_9_0, var_1_10006(var_1_10007)).blocksRaycasts = false
	end
...
function var_0_0.SetCustomPosition(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	if arg_10_3.pos then
		Vector3 = var_4
		var_1_10005 = arg_10_3.pos.x

		local var_10_0 = arg_10_3.pos.y
		local var_10_1
		...
		arg_10_1.localPosition = var_4(var_1_10005, var_10_0, var_10_1)
	elseif arg_10_3.isLevelPoint then
		pg = var_4

		local var_10_2 = var_4.UIMgr.GetInstance().levelCameraComp
		local var_10_3 = arg_10_2.transform.parent

		var_1_10005 = var_1_10005.TransformPoint(var_10_3, arg_10_2.transform.localPosition)

		local var_10_4 = var_10_2
		local var_10_5 = var_10_2.WorldToScreenPoint(var_10_4, var_1_10005)

		pg = var_10_4

		local var_10_6 = var_10_4.UIMgr.GetInstance().overlayCameraComp

		LuaHelper = var_8
		arg_10_1.localPosition = var_8.ScreenToLocal(arg_10_0.root, var_10_5, var_10_6)
	else
	...
	Vector3 = var_1_10005
	arg_10_1.localScale = var_1_10005(var_10_7, var_10_7, var_10_7)
	...
	if arg_10_3.eulerAngles then
		...
		if not var_10_8(arg_10_3.eulerAngles[1], arg_10_3.eulerAngles[2], arg_10_3.eulerAngles[3]) then
			Vector3 = var_10_8
			var_10_8 = var_10_8(0, 0, 0)
		end

		arg_10_1.eulerAngles = var_10_8
...
local function var_0_5(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	Vector3 = var_11_0
	arg_11_1.localPosition = var_11_0(var_11_1.x, var_11_1.y, 0)

	local var_11_2 = arg_11_2.transform.localScale

	Vector3 = var_6
	arg_11_1.localScale = var_6(var_11_2.x, var_11_2.y, var_11_2.z)
...
local function var_0_6(arg_12_0, arg_12_1, arg_12_2)
	...
	if not var_5(var_12_0) then
		...
		local var_12_4 = var_12_3(var_12_2, var_1_10007(var_1_10008))
		...
		local var_12_7 = var_12_6(var_12_5, var_1_10008(var_1_10009))
