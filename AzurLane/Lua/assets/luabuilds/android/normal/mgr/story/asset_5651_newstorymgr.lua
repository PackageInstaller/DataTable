...
local var_0_10 = var_9.New(1, 1, 1, 1)
...
function var_0_1.GetStoryPaintingsByName(arg_18_0, arg_18_1)
	...
	local var_18_0 = var_3.New(var_2, false)
...
function var_0_1.ShouldDownloadRes(arg_23_0, arg_23_1)
	...
	local var_23_1 = arg_23_0.GetStoryPaintingsByName(var_23_0, arg_23_1)

	_ = var_23_0

	return var_23_0.any(var_23_1, function(arg_24_0)
...
function var_0_1._Init(arg_27_0, arg_27_1, arg_27_2)
	...
	typeof = var_5
	Image = var_1_10006
	arg_27_0.autoBtnImg = var_27_1(var_27_0, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	arg_27_0.alphaImage = var_27_3(var_27_2, var_5(var_1_10006))
	...
	typeof = var_5
	Image = var_1_10006
	arg_27_0.mainImage = var_27_5(var_27_4, var_5(var_1_10006))
	findTF = var_3
	...
	AsideStoryPlayer = var_4
	var_27_6[1] = var_4.New(arg_27_1)
	...
	DialogueStoryPlayer = var_4
	var_27_6[9] = var_4.New(arg_27_1)
	SubPageStoryPlayer = var_4
	var_27_6[10] = var_4.New(arg_27_1)
	...
	local function var_36_0()
		...
		var_2_10000.each(arg_36_0.branchSelectCache, function(arg_38_0)
			...
			if var_3_10001.GetOptionBranchByStoryName(arg_36_1, arg_38_0) then
				...
				var_38_2(var_38_1, var_3_10005.STORY_UPDATE, {
					storyId = var_38_0
				})
			end
	...
	var_1_10002({
		...
		for iter_54_0, iter_54_1 in var_54_2(arg_51_0.storyScript.steps) do
			...
			var_2_10006.insert(var_54_1, function(arg_55_0)
				...
				var_55_1(var_55_0, var_3_10003.STORY_NEXT)
...
function var_0_1.CheckResDownload(arg_58_0, arg_58_1, arg_58_2)
	...
	local var_58_1 = arg_58_0._GetResList(var_58_0, arg_58_1)

	SplitPackConst = var_58_0

	var_58_0.DownloadByLuaArr(var_58_1, arg_58_2)
...
local function var_0_16(arg_59_0, arg_59_1)
	...
	var_59_1(var_59_0, var_59_2, var_59_3, var_1_10006.Events.UnityAction_UnityEngine_Object(function(arg_60_0)
		arg_59_1(arg_60_0)
...
function var_0_1.RegistSkipBtn(arg_64_0)
		...
		if not var_0.IsStopping(var_66_0) then
			...
			if not var_0.IsReView(var_66_3) then
				...
				if not var_0.IsPlayed(var_66_4) then
					...
					var_66_10.parent = var_2_10003(var_4.Find(var_66_11, "front"))
					i18n = var_3
					var_66_10.content = var_3("story_skip_confirm")
	...
	var_1_10002(var_64_1, var_64_2, var_64_3, var_1_10006)
...
function var_0_1.RegistAutoBtn(arg_69_0)
	...
	var_1_10001(var_69_0, var_69_1, var_69_2, var_1_10005)
...
function var_0_1.RegistRecordBtn(arg_71_0)
	...
	var_1_10001(var_71_0, var_71_1, var_71_2, var_1_10005)
...
function var_0_1.OnStart(arg_78_0)
	...
	var_78_1.color = var_2(var_78_2, var_78_3, var_78_4, var_6.GetStoryAlpha(var_78_5))
	setActive = var_78_1

	local var_78_6 = arg_78_0.recordBtn
	local var_78_7 = arg_78_0.storyScript

	var_78_1(var_78_6, not var_3.ShouldHideRecord(var_78_7))
	...
	var_78_12(var_78_11, var_78_13, var_5.GetName(var_78_14))
	...
	if not arg_78_0:IsReView() then
		...
		var_78_18.storyId = var_6.GetName(var_78_19)
	...
	var_2(var_78_21, not var_4.ShouldHideSkip(var_78_22))
	...
	var_2(var_78_23, not var_4.ShouldHideAutoBtn(var_78_24))
...
function var_0_1.RegistHideUIBtn(arg_79_0)
	...
	var_1_10001(var_79_0, var_79_1, var_79_2, var_1_10005)
	...
	var_1_10001(var_79_3, var_79_4, var_79_5, var_1_10005)
...
function var_0_1.TrackingStart(arg_82_0)
	...
	if var_1_10001(var_1_10002) then
		...
		local var_82_0 = var_1(var_1_10002)
		...
		if var_82_2(var_82_1, var_3.GetName(var_82_3)) and not arg_82_0:GetPlayedFlag(var_1) then
			pg = var_2
			...
			var_82_5(var_82_4, var_4.BuildStoryStart(var_1, 0))
...
function var_0_1.TrackingSkip(arg_83_0)
	...
	if var_83_1(var_83_0, var_3.GetName(var_83_2)) then
		pg = var_83_0

		local var_83_3 = var_83_0.GameTrackerMgr.GetInstance()
		local var_83_4 = var_2.Record

		GameTrackerBuilder = var_83_2

		local var_83_5 = var_83_2.BuildStorySkip
...
function var_0_1.TrackingOption(arg_84_0, arg_84_1, arg_84_2)
	...
	if var_84_1(var_84_0, var_5.GetName(var_84_2)) then
		pg = var_84_0

		local var_84_3 = var_84_0.GameTrackerMgr.GetInstance()
		local var_84_4 = var_4.Record

		GameTrackerBuilder = var_84_2

		var_84_4(var_84_3, var_84_2.BuildStoryOption(var_3, arg_84_1 .. "_" .. (arg_84_2 or 0)))
	end
...
function var_0_1.Clear(arg_91_0)
	...
	var_91_4(var_91_3, var_3.STORY_END)
...
function var_0_1.IsAutoPlay(arg_102_0)
	...
	local var_102_0 = var_1(var_1_10002)
	local var_102_1
...
function var_0_1.Fix(arg_106_0)
	...
	if var_106_2 <= var_106_4 then
		...
		var_5.each(var_106_5, function(arg_107_0)
	...
	local var_106_8 = var_1_10007(var_1_10008)
	local var_106_9 = 0
	...
	for iter_106_1 = var_106_9, var_106_7, -1 do
		...
		if var_1_10013.task_data_template[iter_106_1] and var_1_10013.story_id then
			...
			if 0 < var_106_10 then
				var_1_10016 = arg_106_0

				if not arg_106_0.IsPlayed(var_1_10016, var_14) then
	...
	local var_106_11 = var_9(var_10)
	local var_106_12 = var_9.getActivityById

	ActivityConst = var_11

	if var_106_12(var_106_11, var_11.JYHZ_ACTIVITY_ID) and not var_9:isEnd() then
		_ = var_10
...
function var_0_1._GetResList(arg_108_0, arg_108_1)
	...
	var_8.each(var_108_4, function(arg_109_0)
		PaintingGroupConst = var_2_10001

		var_2_10001.AddPaintingNameWithFilteMap(var_108_5, arg_109_0)
	...
	var_9.each(var_108_4, function(arg_110_0)
		table = var_2_10001

		var_2_10001.insert(var_108_6, "paintingface/" .. arg_110_0)
	...
	var_10.each(arg_108_1.steps, function(arg_111_0)
		...
		local var_111_1 = arg_111_0.GetResList(var_111_0)

		_ = var_111_0

		var_111_0.each(var_111_1, function(arg_112_0)
			table = var_3_10001

			var_3_10001.insert(var_108_7, arg_112_0)
	...
	local var_108_8 = var_10.MergeLuaArr(var_108_5, var_108_6, var_108_7)

	table = var_11

	var_11.insert(var_108_8, var_108_0)

	table = var_11

	var_11.insert(var_108_8, var_108_2)

	table = var_11

	var_11.insert(var_108_8, var_108_3)
