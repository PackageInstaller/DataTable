...
function var_0_1.UpdateBg(arg_1_0, arg_1_1)
	...
	pg = var_3
	arg_1_0.blurOptimized = var_1_0[var_3.UIMgr.CameraOverlay][1]
...
function var_0_1.PlayOpenEyeEffect(arg_5_0, arg_5_1, arg_5_2)
	...
	local var_5_1 = arg_5_1.GetOpenEyeData(var_5_0)
	...
	var_5_0({
		...
		function(arg_8_0)
			...
			var_1.ApplyOpenEyeEffect(var_8_0, arg_5_1, var_5_1, arg_5_0.targetGo, arg_8_0)
...
function var_0_1.ClearTarget(arg_10_0)
	if arg_10_0.targetGo then
		...
		local var_10_2 = var_10_1(var_10_0, var_1_10003(var_1_10004)).material
...
function var_0_1.ApplyOpenEyeEffect(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	local var_15_6 = var_15_5(var_15_4, var_1_10011(var_1_10012)).material
...
function var_0_1.UpdateNextBg(arg_31_0, arg_31_1, arg_31_2)
	...
	if not arg_31_1.GetNextBgName(var_31_0) then
		arg_31_2()
	...
	var_31_0(arg_31_0.bgPanel, true)
	...
	Color = var_5
	var_31_1.color = var_5.New(1, 1, 1)
	var_31_1.sprite = arg_31_0:GetBg(var_3)
