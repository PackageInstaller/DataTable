...
function var_0_1.Play(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	if not arg_10_1:GetStepByIndex(arg_10_2) then
		arg_10_3()

		return
	end

	local var_10_0 = var_4
	local var_10_1 = var_4.GetMode(var_10_0)
	...
	local var_10_5 = arg_10_1:GetTriggerDelayTime()
	...
	local var_10_7 = arg_10_1.GetPrevStep(var_10_6, arg_10_2)
	...
	var_10_6({
		...
		function(arg_26_0)
			...
			if var_1.ShouldAutoTrigger(var_26_2) then
				...
				var_1.UnscaleDelayCall(var_26_3, var_10_5, arg_26_0)
			...
			var_1.TriggerEventIfAuto(var_26_5, var_10_5)
		...
		function(arg_27_0)
			...
			var_1.InitBranches(var_27_2, arg_10_1, var_0, function(arg_28_0)
				...
				var_0.TriggerOptionIfAuto(var_29_0, var_10_5, var_0)
