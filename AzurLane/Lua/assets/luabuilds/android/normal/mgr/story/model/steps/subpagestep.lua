...
function var_0_1.ShouldShowSubPage(arg_4_0)
	if arg_4_0.page == var_0_2 then
		...
		if not var_4_1(var_4_0, var_1_10004.ACTIVITY_TYPE_MONOPOLY) or var_2:isEnd() then
			return false
		end

		local var_4_2 = var_2:getConfig("config_client").link_act
		local var_4_3 = var_1
		local var_4_4 = var_1.RawGetActivityById(var_4_3, var_4_2)

		pg = var_4_3

		local var_4_5 = var_4_3.NewStoryMgr.GetInstance()
