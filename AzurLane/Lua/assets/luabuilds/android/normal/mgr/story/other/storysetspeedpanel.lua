...
local var_0_1 = var_1.New(1, 0.8705, 0.4196, 1)
...
local function var_0_7(arg_2_0)
	...
	local var_2_1 = arg_2_0.GetPlaySpeed(var_2_0)

	table = var_2_0

	local var_2_2 = var_2_0.indexof

	Story = var_1_10003

	if not (var_2_2(var_1_10003.STORY_AUTO_SPEED, var_2_1 or 0) <= 0) then
		Story = var_3

		local var_2_3

		if var_2_3 > #var_3.STORY_AUTO_SPEED then
			var_2_3 = 1
		end

		return var_0_6(var_2_3)
	end
end
...
function var_0_0.Ctor(arg_3_0, arg_3_1, arg_3_2)
	...
	typeof = var_5
	Image = var_1_10006
	arg_3_0.speedImg = var_3_2(var_3_1, var_5(var_1_10006))
	...
	arg_3_0.speedAnim = var_3_4(var_3_3, var_5(var_1_10006))
	...
	arg_3_0.speedAniEvent = var_3_6(var_3_5, var_5(var_1_10006))
	findTF = var_3
	...
	typeof = var_5
	Image = var_6
	arg_3_0.speedPanelImg = var_3_14(var_3_13, var_5(var_6))
	...
	typeof = var_5
	Animation = var_6
	arg_3_0.speedPanelAnim = var_3_16(var_3_15, var_5(var_6))
	...
	typeof = var_5
	DftAniEvent = var_6
	arg_3_0.speedPanelAniEvent = var_3_18(var_3_17, var_5(var_6))
...
function var_0_0.Show(arg_8_0, arg_8_1)
	...
	var_8_0.sprite = var_3("ui/story_atlas", var_0_7(arg_8_1))
...
function var_0_0.ShowSettings(arg_11_0)
	...
	for iter_11_0, iter_11_1 in var_2(arg_11_0.speedList) do
		...
		local var_11_6 = var_11_5(var_11_4, var_10(var_1_10011))
		local var_11_7
