...
local var_0_1 = var_0_10000(var_0_0, var_0_10002(".DialogueStoryPlayer"))
...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Image = var_1_10005
	arg_1_0.subImage = var_1_2(var_1_1, var_4(var_1_10005))
	setActive = var_2
...
function var_0_1.UpdateBg(arg_4_0, arg_4_1)
	...
	if arg_4_1.GetSubBg(var_4_0) then
		...
		var_4_0(arg_4_0.subImage.gameObject, true)

		local var_4_1 = arg_4_0

		if arg_4_0.GetBg(var_4_1, var_2) then
			var_4_1 = arg_4_0.subImage
			var_4_1.sprite = var_4_0
			originalPrint = var_4_1

			local var_4_2 = "story sub bg load : "

			tostring = var_1_10006

			var_4_1(var_4_2 .. var_1_10006(var_2))
		else
			warning = var_4_1

			local var_4_3 = "story sub bg load faild : "

			tostring = var_1_10006

			var_4_1(var_4_3 .. var_1_10006(var_2))
		end
	else
		setActive = var_4_0

		var_4_0(arg_4_0.subImage.gameObject, false)
	end
...
function var_0_1.OnEnter(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	if arg_6_1:ShouldBlackScreen() then
		arg_6_0:DelayCall(arg_6_1:ShouldBlackScreen(), function()
			...
			var_0(not var_1.ExistOption(var_7_1))
			arg_6_3()
