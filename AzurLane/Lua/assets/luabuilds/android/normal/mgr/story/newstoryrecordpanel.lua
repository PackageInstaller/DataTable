...
function var_0_0.Load(arg_3_0)
	...
	var_3_1(var_3_0, var_3_4, var_3_5, var_3_3.Events.UnityAction_UnityEngine_Object(function(arg_4_0)
		Object = var_2_10001
...
function var_0_0.Init(arg_10_0, arg_10_1)
	...
	arg_10_0.pageAnim = var_10_1(var_10_0, var_1_10004(var_1_10005))
	...
	arg_10_0.pageAniEvent = var_10_3(var_10_2, var_4(var_1_10005))
	...
	arg_10_0.cg = var_2(var_10_6, var_4(var_1_10005))
	arg_10_0.tplPools = {
		arg_10_0.tpl
	}
	...
	typeof = var_4
	Image = var_1_10005
	arg_10_0.bgImage = var_10_9(var_10_8, var_4(var_1_10005))
	...
	arg_10_0.scrollrect = var_10_11(var_10_10, var_4(var_1_10005))
	...
	typeof = var_4
	ContentSizeFitter = var_1_10005
	arg_10_0.contentSizeFitter = var_10_14(var_10_13, var_4(var_1_10005))
	onButton = var_2
	...
	var_2(var_10_15, var_10_16, var_10_17, var_1_10006)
...
local function var_0_9(arg_20_0)
	...
	var_3(var_20_2, var_1_10005(var_1_10006)).alpha = 1
...
local function var_0_10(arg_21_0, arg_21_1)
	...
	typeof = var_4
	CanvasGroup = var_1_10005
	var_1_10002(var_21_0, var_4(var_1_10005)).alpha = 1
...
function var_0_0.UpdateList(arg_22_0, arg_22_1)
	...
	for iter_22_0, iter_22_1 in var_6(var_22_0) do
		...
		var_1_10012.insert(var_22_1, function(arg_23_0)
			...
			local var_23_6 = var_23_5(var_23_4, var_5(var_6))
			...
			if iter_22_0 + var_22_3 <= var_22_4 then
				...
				local var_23_8 = var_4(var_23_7, var_6(var_2_10007))
...
function var_0_0.PlayAnimation(arg_26_0, arg_26_1)
	...
	for iter_26_0 = 1, var_26_0 do
		...
		var_1_10009.insert(var_26_1, function(arg_27_0)
			...
			local var_27_3 = var_27_2(var_27_1, var_2_10005(var_2_10006))
...
function var_0_0.UpdateRecord(arg_30_0, arg_30_1, arg_30_2)
	...
	typeof = var_1_10005
	CanvasGroup = var_1_10006
	var_1_10003(var_30_0, var_1_10005(var_1_10006)).alpha = 1
	...
	var_30_1(var_30_2, arg_30_2.icon)
	...
	if arg_30_2.icon then
		...
		arg_30_0.UpdateIcon(var_30_3, arg_30_2, var_30_2)
	end
	...
	if arg_30_2.name and arg_30_2.nameColor then
		string = var_30_4
		var_30_4 = var_30_4.gsub(arg_30_2.nameColor, "#", "")

		local var_30_5 = arg_30_1:Find("name")

		var_30_3 = var_30_3.GetComponent
		typeof = var_7
		Outline = var_1_10008
		var_30_3 = var_30_3(var_30_5, var_7(var_1_10008))
		Color = var_30_5
		var_30_3.effectColor = var_30_5.NewHex(var_30_4)
		setText = var_6

		local var_30_6 = arg_30_1
		local var_30_7 = arg_30_1.Find(var_30_6, "name")

		setColorStr = var_30_6

		var_6(var_30_7, var_30_6(arg_30_2.name, arg_30_2.nameColor))
	else
		setText = var_30_4
		var_30_3 = arg_30_1:Find("name")
		...
		var_30_4(var_30_3, var_30_8)
	end

	local var_30_9 = arg_30_2.list

	UIItemList = var_30_3

	local var_30_10 = var_30_3.New(arg_30_1:Find("content"), arg_30_1:Find("content/Text"))

	var_5.make(var_30_10, function(arg_31_0, arg_31_1, arg_31_2)
		UIItemList = var_2_10003

		if arg_31_0 == var_2_10003.EventUpdate then
			setText = var_3

			var_3(arg_31_2, var_30_9[arg_31_1 + 1])
		end

		return
	end)
	var_5:align(#var_30_9)

	setActive = var_6

	var_6(arg_30_1:Find("player"), arg_30_2.icon == nil and arg_30_2.isPlayer)
	...
	local var_30_14 = var_30_13(var_30_12, var_9(var_1_10010.UI.HorizontalOrVerticalLayoutGroup))

	UnityEngine = var_30_12

	local var_30_15 = var_30_12.RectOffset.New()
...
function var_0_0.BlurPanel(arg_35_0)
	...
	local var_35_0 = var_1_10002.NewStoryMgr.GetInstance()._tf

	pg = var_1_10003

	var_1_10001(var_35_0, var_1_10003.UIMgr.GetInstance().UIMain)
	...
	for iter_35_0 = 1, var_35_1.childCount do
		...
		local var_35_3 = var_35_1.GetChild(var_35_2, iter_35_0 - 1)
		...
		if var_35_2(var_35_3) then
			...
			var_7.insert(arg_35_0.hideNodes, var_35_3)

			setActive = var_7

			var_7(var_35_3, false)
		end
	end

	pg = var_2

	local var_35_4 = var_2.UIMgr.GetInstance()

	var_2.BlurPanel(var_35_4, arg_35_0._tf)
...
function var_0_0.UnblurPanel(arg_36_0)
	...
	local var_36_0 = var_1_10002.NewStoryMgr.GetInstance()._tf

	pg = var_1_10003

	var_1_10001(var_36_0, var_1_10003.UIMgr.GetInstance().OverlayToast)
