		...
		if var_1(var_2) then
			...
			if var_1(var_2) then
				...
				if not var_1.IsReView(var_6_0) then
					...
					local var_6_2 = var_6_0(var_1_10003)
					local var_6_3
					...
					if not var_2.GetCurChar(var_6_2) then
						...
						var_6_3, var_6_2, var_6_4 = var_6_3.GetStoryInfo(var_6_2)
						var_6_1 = var_6_4
					else
						getProxy = var_6_3
...
function var_0_1.GetExPression(arg_17_0)
	if arg_17_0.expression then
		...
		if arg_17_0.GetPainting(var_17_0) then
			ShipExpressionHelper = var_17_0

			if var_17_0.DefaultFaceless(var_1) then
...
function var_0_1.GetPaintingAction(arg_36_0, arg_36_1)
	...
	local var_36_2 = arg_36_0.GetPaintingActions(var_36_1)
...
function var_0_1.GetContent(arg_38_0)
	...
	if arg_38_0.ShouldReplaceDorm(var_38_1) then
		var_38_1 = arg_38_0
		var_38_0 = arg_38_0.ReplaceDormName(var_38_1, var_38_0)
	end

	PLATFORM_CODE = var_2
	PLATFORM_US = var_38_1

	if var_2 ~= var_38_1 then
...
function var_0_1.GetNameWithColor(arg_40_0)
	if not arg_40_0:GetName() then
		return nil
	end

	local var_40_0 = arg_40_0
	local var_40_1 = arg_40_0.GetNameColor(var_40_0)
...
function var_0_1.GetNameColorCode(arg_42_0)
	...
	local var_42_1 = arg_42_0.GetNameColor(var_42_0)

	string = var_42_0

	return var_42_0.gsub(var_42_1, "#", "")
end
...
function var_0_1.GetPortraitName(arg_44_0)
	...
	if not var_1_10004.getDefaultShipConfig(var_44_1) then
		...
		Ship = var_5
		var_44_0 = var_5.getShipName(var_4.id)
	end
...
function var_0_1.GetPaintingAndName(arg_53_0)
	...
	if not var_1_10003 and arg_53_0.actor == var_0_1.ACTOR_TYPE_FLAGSHIP then
		...
		local var_53_2 = var_1_10003(var_4)

		var_1_10003 = var_1_10003.getRawData(var_53_2).character
		getProxy = var_53_2
		BayProxy = var_1_10005
		var_1_10005 = var_53_2(var_1_10005)

		local var_53_3 = var_4.getShipById(var_1_10005, var_1_10003)

		var_53_0 = var_4.getName(var_53_3)
		...
		if not var_1_10003 and arg_53_0.actor == var_0_1.ACTOR_TYPE_PLAYER then
			...
			if var_1_10003(var_4) then
				...
				local var_53_4 = var_1_10003(var_4)

				var_53_0 = var_1_10003.getRawData(var_53_4).name
			else
				var_53_0 = ""
			end
		else
			...
			if not var_1_10003 and arg_53_0.actor == var_0_1.ACTOR_TYPE_TB then
				...
				local var_53_5 = var_1_10003.NewStoryMgr.GetInstance()

				if var_1_10003.IsReView(var_53_5) then
					assert = var_1_10003

					if arg_53_0.defaultTb then
						var_53_5 = arg_53_0.defaultTb
						var_53_5 = 0 < var_53_5
					end

					var_1_10003(var_53_5, "<<< defaultTb is nil >>>")
				...
				elseif arg_53_0.specialTbId then
					...
					var_53_5(var_1_10003)

					var_53_0 = var_1_10003.name or ""
					var_53_1 = var_1_10003.prefab
				else
					getProxy = var_1_10003
					NewEducateProxy = var_53_5

					if var_1_10003(var_53_5) then
						getProxy = var_1_10003
						NewEducateProxy = var_53_5
						var_53_5 = var_1_10003(var_53_5)

						if var_1_10003.GetCurChar(var_53_5) then
							getProxy = var_1_10003
							NewEducateProxy = var_53_5
							var_53_5 = var_1_10003(var_53_5)
							var_1_10003, var_53_5 = var_1_10003.GetStoryInfo(var_53_5)
							var_53_0 = var_53_5
					...
					if var_1_10003 then
						getProxy = var_1_10003
						EducateProxy = var_53_5

						if var_1_10003(var_53_5) then
							getProxy = var_1_10003
							EducateProxy = var_53_5

							local var_53_6 = var_1_10003(var_53_5)
							local var_53_7

							var_1_10003, var_53_7 = var_1_10003.GetStoryInfo(var_53_6)
							var_53_0 = var_53_7
							var_53_1 = var_1_10003
			...
			elseif not arg_53_0.actor or var_0_2[arg_53_0.actor] == nil then
				...
				local var_53_8 = var_0_2[arg_53_0.actor].ship_group

				ShipGroup = var_1_10005

				if not var_1_10005.getDefaultShipConfig(var_53_8) then
					var_53_0 = var_1_10003.name
				else
					Ship = var_6
					var_53_0 = var_6.getShipName(var_5.id)
				end
...
function var_0_1.GetShipSkinId(arg_54_0)
	if arg_54_0.actor == var_0_1.ACTOR_TYPE_FLAGSHIP then
		...
		local var_54_0 = var_1(var_2)
		local var_54_1 = var_1.getRawData(var_54_0)

		getProxy = var_54_0
		BayProxy = var_1_10003

		local var_54_2 = var_54_0(var_1_10003)
...
function var_0_1.IsSpinePainting(arg_67_0)
	...
	local var_67_1 = arg_67_0.GetPainting(var_67_0)

	tobool = var_67_0

	return var_67_0(var_67_1 ~= nil and arg_67_0.spine)
end
...
function var_0_1.IsLive2dPainting(arg_70_0)
	...
	local var_70_1 = arg_70_0.GetPainting(var_70_0)

	tobool = var_70_0

	return var_70_0(var_70_1 ~= nil and arg_70_0.live2d)
end
...
function var_0_1.GetVirtualShip(arg_72_0)
	...
	local var_72_2 = var_72_0.ship_skin_template[var_72_1].ship_group

	StoryShip = var_1_10003

	return var_1_10003.New({
		skin_id = var_72_1
	})
end
...
function var_0_1.GetSubActorName(arg_75_0)
	if arg_75_0.subActorName and arg_75_0.subActorName ~= "" then
		...
		return var_75_1 .. var_1_10003(var_75_0, arg_75_0.subActorNameColor)
	else
		return ""
	end
...
function var_0_1.GetUsingPaintingNames(arg_82_0)
	...
	if arg_82_0.GetPainting(var_82_1) ~= nil then
		...
		var_82_1.insert(var_82_0, var_2)
	end

	local var_82_2 = arg_82_0
	local var_82_3 = arg_82_0.GetSubPaintings(var_82_2)

	ipairs = var_82_2

	for iter_82_0, iter_82_1 in var_82_2(var_82_3) do
		local var_82_4 = iter_82_1.name

		table = var_1_10010

		var_1_10010.insert(var_82_0, var_82_4)
	end
