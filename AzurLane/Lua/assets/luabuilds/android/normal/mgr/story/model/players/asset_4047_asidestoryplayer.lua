...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	local var_1_2 = var_3.Find(var_1_1, "aside")
	local var_1_3 = arg_1_0.asidePanel

	arg_1_0.hrzList = var_1_0(var_1_2, var_4.Find(var_1_3, "aside/aside_txt_tpl"))
	UIItemList = var_2

	local var_1_4 = var_2.New
	local var_1_5 = arg_1_0.asidePanel
	local var_1_6 = var_3.Find(var_1_5, "aside_2")
	local var_1_7 = arg_1_0.asidePanel

	arg_1_0.vetList = var_1_4(var_1_6, var_4.Find(var_1_7, "aside_2/aside_txt_tpl_2"))
	UIItemList = var_2

	local var_1_8 = var_2.New
	local var_1_9 = arg_1_0.asidePanel
	local var_1_10 = var_3.Find(var_1_9, "aside_3")
	local var_1_11 = arg_1_0.asidePanel

	arg_1_0.leftBotomVetList = var_1_8(var_1_10, var_4.Find(var_1_11, "aside_3/aside_txt_tpl"))
	UIItemList = var_2

	local var_1_12 = var_2.New
	local var_1_13 = arg_1_0.asidePanel
	local var_1_14 = var_3.Find(var_1_13, "aside_4")
	local var_1_15 = arg_1_0.asidePanel

	arg_1_0.centerWithFrameVetList = var_1_12(var_1_14, var_4.Find(var_1_15, "aside_4/aside_txt_tpl"))
	UIItemList = var_2

	local var_1_16 = var_2.New
	local var_1_17 = arg_1_0.asidePanel
	local var_1_18 = var_3.Find(var_1_17, "aside_4_1")
	local var_1_19 = arg_1_0.asidePanel

	arg_1_0.centerWithFrameVetListMargin = var_1_16(var_1_18, var_4.Find(var_1_19, "aside_4_1/aside_txt_tpl"))
...
function var_0_1.OnInit(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_1.ShouldHideBGAlpha(var_3_0) then
		arg_3_0.color = arg_3_0.mainImg.color

		local var_3_1 = arg_3_0.mainImg

		Color = var_3_0
		var_3_1.color = var_3_0.New(1, 1, 1, 0)
	end
	...
	local var_3_2 = {
		...
		function(arg_5_0)
			...
			if var_5_1 == var_5_0.SHOW_MODE_DEFAUT then
...
function var_0_1.LoadPainting(arg_7_0, arg_7_1, arg_7_2)
	...
	if not arg_7_1.GetPainting(var_7_0) or var_3 == "" then
		arg_7_2()
	...
	setPaintingPrefabAsync = var_7_0

	var_7_0(arg_7_0.meshImagePaintingContainer, var_3, "duihua", function(arg_8_0)
...
function var_0_1.PlayAside(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_2 = var_5.Sign(var_10_1.container.localScale.x)

	setActive = var_6

	var_6(var_10_1.container, true)
	...
	var_10_1:make(function(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_11_0 == var_2_10003.EventUpdate then
			...
			local var_11_4 = var_2_10006(var_11_3, var_8(var_2_10009))
			...
			local var_11_5 = var_10_2

			Mathf = var_8

			if var_11_5 ~= var_8.Sign(arg_11_2.localScale.x) then
				Vector3 = var_11_5
				arg_11_2.localScale = var_11_5(var_10_2 * arg_11_2.localScale.x, arg_11_2.localScale.y, 1)
			end
		end
...
function var_0_1.PlayBubbleAside(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_3 = arg_13_1.GetSequence(var_13_2)

	setActive = var_13_2

	var_13_2(var_13_0.container, true)

	for iter_13_0 = var_13_0.container.childCount, 1, -1 do
		local var_13_4 = var_13_0.container

		if var_10.GetChild(var_13_4, iter_13_0 - 1) ~= var_13_0.item then
			Object = var_11
	...
	for iter_13_1 = 1, #var_13_3 do
		...
		var_1_10012.insert(var_13_5, function(arg_14_0)
			...
			var_2(var_14_1, var_4.hxLan(var_13_3[iter_13_1][1]))
			...
			local var_14_3 = var_2(var_14_2, var_4(var_5))
			...
			var_14_5(var_14_4, var_5.GetTypewriterSpeed(var_14_6))
			var_14_3:Play()
...
function var_0_1.UpdateLayoutPaddingAndSpacing(arg_16_0, arg_16_1, arg_16_2)
	...
	if (var_16_0 or var_16_1) and not var_16_2 then
		...
		local var_16_5 = var_16_4(var_16_3, var_1_10008(var_1_10009.UI.HorizontalOrVerticalLayoutGroup))
		...
		if var_16_1 then
			local var_16_6, var_16_7

			var_16_6, var_16_7, var_1_10009, var_1_10010 = arg_16_1:GetPadding()
			UnityEngine = var_1_10011

			local var_16_8 = var_1_10011.RectOffset.New()

			var_16_8.bottom = var_16_7
			var_16_8.left = var_1_10009
			var_16_8.right = var_1_10010
			var_16_8.top = var_16_6
			arg_16_0.padding = var_16_5.padding
			var_16_5.padding = var_16_8
		end
	elseif var_16_2 then
		local var_16_9 = 0
		local var_16_10 = arg_16_2
		local var_16_11 = arg_16_2.GetComponent

		typeof = var_1_10009
		UnityEngine = var_1_10010

		local var_16_12 = var_16_11(var_16_10, var_1_10009(var_1_10010.UI.HorizontalOrVerticalLayoutGroup))

		if var_16_0 then
			var_16_9 = arg_16_1:GetSpacing()
		end

		var_16_12.spacing = var_16_9

		local var_16_13, var_16_14, var_16_15, var_16_16 = arg_16_1:GetMargin()

		rtf = var_1_10012

		local var_16_17 = var_1_10012(arg_16_2)

		Vector2 = var_13
		var_16_17.offsetMin = var_13(var_16_15, var_16_14)
		Vector2 = var_13
		var_16_17.offsetMax = var_13(-var_16_16, -var_16_13)
		eachChild = var_13
		...
		var_13(arg_16_2, function(arg_17_0)
			...
			var_2_10001(var_17_0, var_2_10003(var_2_10004)).preferredWidth = var_16_17.rect.width - 50
...
function var_0_1.UpdateRectAlhpa(arg_18_0, arg_18_1, arg_18_2)
	...
	if not var_18_1(var_18_0, var_1_10005(var_1_10006)) then
		return
	end

	local var_18_2 = arg_18_1
	local var_18_3 = arg_18_1.GetRectAlpha(var_18_2)

	Color = var_18_2
	var_3.color = var_18_2.New(1, 1, 1, var_18_3)
...
function var_0_1.PlayDateSign(arg_19_0, arg_19_1, arg_19_2)
	...
	if not arg_19_1.GetDateSign(var_19_0) then
		arg_19_2()
	...
	local var_19_1 = var_19_0.hxLan(var_3[1])
	local var_19_2 = var_3[2]
	local var_19_3
	...
	var_1_10007(arg_19_0.dataTxt, var_19_1)

	GetOrAddComponent = var_1_10007

	local var_19_4 = arg_19_0.dataTxt

	typeof = var_9
	CanvasGroup = var_1_10010

	local var_19_5 = var_1_10007(var_19_4, var_9(var_1_10010))

	var_19_5.alpha = 0

	local var_19_6 = arg_19_0
	local var_19_7 = arg_19_0.TweenValueForcanvasGroup
	...
	var_19_7(var_19_6, var_19_8, var_19_9, var_19_10, var_19_11, var_19_2, arg_19_2)

	setAnchoredPosition = var_19_7

	local var_19_12 = arg_19_0.dataTxt

	Vector3 = var_19_8

	var_19_7(var_19_12, var_19_8(var_19_3[1], var_19_3[2], 0))
...
function var_0_1.ResetPaddingAndSpacing(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	local var_21_2 = var_21_1(var_21_0, var_1_10006(var_1_10007.UI.HorizontalOrVerticalLayoutGroup))
