...
function var_0_1.GetSequence(arg_5_0)
	...
	for iter_5_0, iter_5_1 in var_5_1(var_5_3) do
		...
		if not var_5_2 or not arg_5_0:ReplacePlayerName(iter_5_1[1]) then
			var_5_4 = iter_5_1[1]
		end

		if arg_5_0:ShouldReplaceCar2026() then
			var_5_4 = arg_5_0:ReplaceCar2026Name(var_5_4)
		end

		table = var_9

		local var_5_5 = var_9.insert
		local var_5_6 = var_5_0
		local var_5_7 = {}

		HXSet = var_1_10012
		var_5_7[1] = var_1_10012.hxLan(var_5_4)
		var_5_7[2] = iter_5_1[2]

		var_5_5(var_5_6, var_5_7)
	end
