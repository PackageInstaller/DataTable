...
function var_0_1.LoadBg(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5, arg_2_6)
	...
	if var_10(var_2_1) then
		...
		var_10.GetPrefab(var_2_3, var_2_1, "", true, function(arg_3_0)
			...
			typeof = var_3
			CriManaEffectUI = var_4

			if var_3_2(var_3_1, var_3(var_4)) then
				CriWare = var_3_1
				var_1.renderMode = var_3_1.CriManaMovieMaterialBase.RenderMode.Always
...
function var_0_1.ClearBg(arg_5_0, arg_5_1)
	...
	if arg_5_0.cache[arg_5_1].dyBg then
		...
		typeof = var_1_10005
		CriManaEffectUI = var_1_10006

		if var_5_1(var_5_0, var_1_10005(var_1_10006)) then
			var_3:Pause(true)
		end
