...
function var_0_1.PlayCpkMovie(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4, arg_4_5, arg_4_6, arg_4_7, arg_4_8)
	...
	local function var_4_2()
		...
		local var_6_0, var_6_2

		if arg_4_0._criUsm then
			var_6_0 = arg_4_0._criUsm.player
			...
			DEFAULT_BGMVOLUME = var_2_10004

			var_6_1(var_6_0, var_6_2(var_6_3, var_2_10004))

			var_6_0 = arg_4_0._criUsm.player

			var_0.SetShaderDispatchCallback(var_6_0, function(arg_8_0, arg_8_1)
		...
		if arg_4_0._criCpk then
			var_6_0 = arg_4_0._criCpk.player

			local var_6_4 = var_0.SetVolume

			PlayerPrefs = var_6_2

			local var_6_5 = var_6_2.GetFloat
			local var_6_6 = "bgm_vol"

			DEFAULT_BGMVOLUME = var_2_10004

			var_6_4(var_6_0, var_6_5(var_6_6, var_2_10004))

			var_6_0 = arg_4_0._criCpk.player

			var_0.SetShaderDispatchCallback(var_6_0, function(arg_9_0, arg_9_1)
		...
		if arg_4_0._animator ~= nil then
			var_6_7 = arg_4_0._animator
			var_6_7.enabled = true
			var_6_0 = arg_4_0._mainTF

			local var_6_8 = var_6_7.GetComponent(var_6_0, "DftAniEvent")

			var_6_7.SetStartEvent(var_6_8, function(arg_10_0)
				if arg_4_0._criUsm then
			...
			var_6_7:SetEndEvent(function(arg_11_0)
				var_4_1()
			...
			var_6_7 = arg_4_0
			Timer = var_6_0
			var_6_7._timer = var_6_0.New(var_4_1, arg_4_7)

			local var_6_9 = arg_4_0._timer

			var_6_7.Start(var_6_9)
		end

		setActive = var_6_7

		var_6_7(arg_4_0._mainTF, true)

		if arg_4_0._stopGameBGM then
			pg = var_0

			local var_6_10 = var_0.BgmMgr.GetInstance()

			var_0.StopPlay(var_6_10)
		end
	...
	if var_1_10011(arg_4_0._mainTF) then
		...
		var_11(arg_4_3, arg_4_4, function(arg_12_0)
			...
			Time = var_12_0
			var_12_1._closeLimit = var_12_0.realtimeSinceStartup + 1
			...
			local var_12_7 = var_12_5(arg_4_0._mainTF)
