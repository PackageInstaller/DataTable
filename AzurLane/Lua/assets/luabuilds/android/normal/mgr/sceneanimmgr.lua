...
function var_0_1.Init(arg_2_0, arg_2_1)
	...
	var_1_10002("ui", "SceneAnimUI", function(arg_3_0)
		...
		var_3_2(var_3_1, var_3.UIMgr.GetInstance().OverlayToast, false)
...
function var_0_1.SixthAnniversaryJPCoverGoScene(arg_4_0, arg_4_1)
	...
	var_3.GetUI(var_4_1, var_4_0, true, function(arg_5_0)
		...
		local var_5_3 = var_5_2(var_5_1, var_4(var_5))
		...
		var_2.SetActionCallBack(var_5_3, function(arg_6_0)
			...
			elseif arg_6_0 == "action" then
				...
				var_6_2(var_6_1, var_3_10003.GO_SCENE, arg_4_1)
			end
...
function var_0_1.OtherWorldCoverGoScene(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_1 = var_4.GetInstance()
	...
	var_4.GetUI(var_7_1, var_7_0, true, function(arg_8_0)
		...
		local var_8_3 = var_8_2(var_8_1, var_4(var_5))
		...
		var_2.SetActionCallBack(var_8_3, function(arg_9_0)
			...
			elseif arg_9_0 == "action" then
				...
				var_9_2(var_9_1, var_3_10003.GO_SCENE, arg_7_1, arg_7_2)
			end
...
function var_0_1.DoSceneChange(arg_11_0)
	...
	if not var_11_4 then
		...
		var_5.insert(var_11_5, function(arg_12_0)
			PoolMgr = var_2_10001
	...
	var_5.insert(var_11_5, function(arg_14_0)
	...
	var_5.insert(var_11_5, function(arg_15_0)
		...
		local function var_15_1()
			if #arg_11_0.loadingList > 0 and arg_11_0.loadingList[1][1] == var_11_1 then
				unpack = var_0
				table = var_1
				var_11_1, var_11_2 = var_0(var_1.remove(arg_11_0.loadingList, 1))
...
function var_0_1.StartLoading(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	...
	var_1_10004(arg_19_1, {
		Dorm3DLoading = function()
			...
			local var_20_1 = var_2_10000(var_20_0, var_2_10002(var_2_10003))
			...
			local var_20_5 = var_20_4(var_20_3, var_2(var_3)).material
			...
			local var_20_8 = var_20_7(var_20_6, var_3.Action_float(function(arg_21_0)
			...
			var_20_9(var_20_8, var_3.easeOutCubic)
...
function var_0_1.EndLoading(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	var_1_10004(arg_33_1, {
		Dorm3DLoading = function()
			...
			local var_34_3 = var_34_2(var_34_1, var_2(var_2_10003)).material
			...
			local var_34_6 = var_34_5(var_34_4, var_3.Action_float(function(arg_35_0)
			...
			var_34_7(var_34_6, var_3.easeInOutCubic)
			...
			local var_34_11 = var_2(var_34_10, var_4(var_2_10005))
...
function var_0_1.DoDorm3DSceneChange(arg_45_0, arg_45_1)
	...
	var_4(var_45_1, function()
		...
		local var_48_3 = var_48_2(var_48_1, var_2(var_2_10003)).material
		...
		var_1.SetTriggerEvent(var_48_5, function(arg_49_0)
			...
			;(function()
				if #arg_45_0.dormCallbackList > 0 then
					...
					typeof = var_4_10002
					Animator = var_4_10003

					local var_50_1 = var_0(var_50_0, var_4_10002(var_4_10003))
					...
					local var_50_5 = var_50_4(var_50_3, var_2.Action_float(function(arg_51_0)
					...
					var_50_6(var_50_5, var_2.easeInOutCubic)
				end
		...
		local var_48_7 = var_2(var_48_6, var_4(var_2_10005))
		...
		local var_48_10 = var_48_9(var_48_8, var_4.Action_float(function(arg_53_0)
		...
		var_48_11(var_48_10, var_4.easeOutCubic)
