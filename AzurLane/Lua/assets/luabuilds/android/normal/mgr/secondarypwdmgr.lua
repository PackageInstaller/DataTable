...
function var_0_1.LimitedOperation(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if not var_3_0.contains(var_3_1.system_list, arg_3_1) then
		if arg_3_3 then
			arg_3_3()
		end
	...
	if not var_3_2 then
		...
		var_3_5(var_3_4, var_1_10010.CANCEL_LIMITED_OPERATION)
	...
	var_3_7.mediator = var_1_10010
	SecondaryPasswordLayer = var_1_10010
	var_3_7.viewComponent = var_1_10010

	local var_3_8 = {}

	SecondaryPasswordLayer = var_1_10011
	var_3_8.mode = var_1_10011.InputView
...
function var_0_1.ChangeSetting(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_0.equal(arg_4_1, var_4_1.system_list) then
		return
	end

	local var_4_2, var_4_3 = var_3:GetPermissionState()
	local var_4_5

	if not var_4_2 then
		arg_4_0:ShowWarningWindow()

		local var_4_4 = var_0.m02

		var_4_5 = var_4_5.sendNotification
		GAME = var_1_10009

		var_4_5(var_4_4, var_1_10009.CANCEL_LIMITED_OPERATION)
	...
	local var_4_6 = var_4_5.New
	local var_4_7 = {}

	SecondaryPasswordMediator = var_1_10009
	var_4_7.mediator = var_1_10009
	SecondaryPasswordLayer = var_1_10009
	var_4_7.viewComponent = var_1_10009

	local var_4_8 = {}

	SecondaryPasswordLayer = var_1_10010
	var_4_8.mode = var_1_10010.InputView
...
function var_0_1.SetPassword(arg_5_0, arg_5_1)
	...
	SecondaryPasswordMediator = var_1_10006
	var_5_2.mediator = var_1_10006
	SecondaryPasswordLayer = var_1_10006
	var_5_2.viewComponent = var_1_10006

	local var_5_3 = {}

	SecondaryPasswordLayer = var_1_10007
	var_5_3.mode = var_1_10007.SetView
...
function var_0_1.LoadLayer(arg_6_0, arg_6_1)
	...
	var_6_4(var_6_3, var_6.LOAD_LAYERS, {
...
function var_0_1.FetchData(arg_8_0)
	...
	var_8_1(var_8_0, var_1_10003.FETCH_PASSWORD_STATE)
