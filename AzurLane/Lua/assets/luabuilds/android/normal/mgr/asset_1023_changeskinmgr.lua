...
function var_0_1.initUI(arg_2_0, arg_2_1)
	if arg_2_0._go == nil then
		...
		var_2.GetUI(var_2_0, "ChangeSkinUI", true, function(arg_3_0)
			...
			findTF = var_3_2
			var_3_3._spineContent = var_3_2(arg_2_0._go, "ad/spine")
...
function var_0_1.play(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	if arg_7_0.changeState == var_0_2 then
		...
		var_5.GetPrefab(var_7_0, arg_7_0._loadObjectName, "", true, function(arg_8_0)
			...
			tf = var_8_0
			var_8_1._spineUI = var_8_0(arg_8_0)
			...
			local var_8_4 = var_3(arg_7_0._spineUI, "ad/spine")

			typeof = var_4
			SpineAnimUI = var_5
			var_8_3._spineAnimUI = var_2(var_8_4, var_4(var_5))
	...
	elseif arg_7_0.changeState == var_0_5 then
		...
		var_5.GetPrefab(var_7_1, arg_7_0._loadObjectName, "", true, function(arg_10_0)
			...
			tf = var_10_0
			var_10_1._aniamtorTf = var_10_0(arg_10_0)
			...
			local var_10_4 = var_3(arg_7_0._aniamtorTf, "ad/animator")

			typeof = var_4
			Animator = var_5
			var_10_3._animatorCom = var_2(var_10_4, var_4(var_5))
			...
			typeof = var_4
			DftAniEvent = var_5
			var_10_5._dftEventCom = var_2(var_10_6, var_4(var_5))
...
function var_0_1.localizationUI(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	if arg_14_2 == "changeAsmr" then
		...
		local var_14_0 = var_1_10005(arg_14_1, "ad/animator/desc")

		i18n = var_6

		var_1_10004(var_14_0, var_6("change_skin_asmr_desc_" .. arg_14_3))
	end
...
function var_0_1.finish(arg_15_0, arg_15_1)
	...
	var_15_0(var_15_1, var_1_10004.Action(function()
