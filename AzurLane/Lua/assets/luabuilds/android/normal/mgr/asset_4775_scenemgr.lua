...
function var_0_1.prepare(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_2_0._cacheUI[var_2_0.__cname] ~= nil then
		...
		var_2_4 = var_2_0.New(var_2_3)

		var_2_2.setContextData(var_2_4, arg_2_2.data)

		var_2_4 = arg_2_1

		arg_2_1.registerMediator(var_2_4, var_2_2)
		arg_2_3(var_2_2)
	else
		var_2_3 = var_2_1.New()
		assert = var_8
		...
		var_8(var_2_4(var_2_5, var_1_10011), "should be an instance of BaseUI: " .. var_2_3.__cname)
		...
		local function var_2_7()
			...
			var_3_1(var_3_0, var_2_10002.LOADED, var_2_7)
		...
		if var_2_3:isLoaded() then
			...
			local var_2_8 = var_2_3.event
			local var_2_9 = var_9.connect

			BaseUI = var_11

			var_2_9(var_2_8, var_11.LOADED, var_2_7)
			var_2_3:load()
		end
	end
...
function var_0_1.prepareLayer(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	while #var_4_0 > 0 do
		...
		local var_4_3 = var_4_3.remove(var_4_0, 1)
...
function var_0_1.enter(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in var_1_10004(arg_8_1) do
		...
		local function var_8_2()
			...
			var_9_1(var_9_0, var_2_10002.AVALIBLE, var_8_2)
		...
		var_8_4(var_8_3, var_1_10013.AVALIBLE, var_8_2)
		var_9:enter()
	end
...
function var_0_1.removeLayer(arg_10_0, arg_10_1, arg_10_2, arg_10_3)
	...
	for iter_10_0 = #var_10_1, 1, -1 do
		...
		local var_10_6 = arg_10_1.removeMediator(var_10_5, var_10_4.mediator.__cname)

		table = var_10_5

		var_10_5.insert(var_10_3, function(arg_11_0)
			if var_10_6 then
				local var_11_0 = arg_10_0

				var_1.remove(var_11_0, var_10_6, function()
...
function var_0_1.removeView(arg_15_0, arg_15_1, arg_15_2)
	...
	var_15_1(var_15_0, var_1_10005.DID_EXIT, function()
...
function var_0_1.clearCacheUI(arg_17_0)
	...
	local var_17_0 = var_1_10002(arg_17_0._cacheUI)
	local var_17_1 = var_2.chain(var_17_0)
	local var_17_2 = var_2.values(var_17_1)
	local var_17_3 = var_2.map(var_17_2, function(arg_18_0)
	...
	var_1_10001(var_2.value(var_17_3), function()
		arg_17_0._cacheUI = {}
...
function var_0_1.gc(arg_21_0, arg_21_1)
	...
	local var_21_1 = arg_21_1.forceGC(var_21_0)

	table = var_21_0

	var_21_0.clear(arg_21_1)
	...
	if var_21_1 or arg_21_0._gcCounter >= arg_21_0._gcLimit then
		...
		local var_21_2 = var_3.GetInstance()

		var_3.LuaGC(var_21_2, false)
	end
