...
function var_0_1.ShowTips(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if not arg_4_3 then
		...
		SFX_UI_TIP = var_1_10006
	end

	var_4_1(var_4_0, var_1_10006)
	...
	var_6(var_7.Find(var_4_5, "Text"), "<color=" .. var_4_4 .. ">" .. arg_4_1 .. "</color>")
	...
	local var_4_9 = var_4_7(var_4_8, var_8(1.8, 0.1, 1), 0.1)
	...
	local var_4_12 = var_4_10(var_4_11, var_8(1.1, 1.1, 1), 0.1)
	...
	local function var_4_14(arg_5_0, arg_5_1)
		...
		local var_5_1 = var_3.New(function()
			IsNil = var_3_10000
			...
			local var_6_2 = var_6_0(var_6_1, var_3_10002(0.1, 1.5, 1), 0.1)
			local var_6_3 = var_0.setUseEstimatedTime(var_6_2, true)
			local var_6_4 = var_0.setOnComplete

			System = var_2

			var_6_4(var_6_3, var_2.Action(function()
				...
				local var_7_2 = var_7_0(var_7_1, var_4_10002.zero, 0.1)
				local var_7_3 = var_0.setUseEstimatedTime(var_7_2, true)
				local var_7_4 = var_0.setOnComplete

				System = var_2

				var_7_4(var_7_3, var_2.Action(function()
					Destroy = var_5_10000
...
function var_0_1.ShowPicTips(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	...
	var_7(var_8.Find(var_9_5, "Text"), "<color=" .. var_9_4 .. ">\"" .. arg_9_1 .. "\" x" .. arg_9_2 .. "</color>")
	...
	local function var_9_6(arg_10_0)
		...
		local var_10_4 = var_10_3(var_10_2, var_4.Action(function()
			Destroy = var_3_10000
