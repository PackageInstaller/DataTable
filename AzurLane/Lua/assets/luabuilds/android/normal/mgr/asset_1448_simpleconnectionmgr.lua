...
local var_0_2 = var_2("SimpleConnectionMgr", false)
local var_0_3
local var_0_4
local var_0_5 = false
local var_0_6 = {}
...
function var_0_1.Connect(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	SEND_TIMEOUT = var_7
	arg_1_4 = var_5(var_1_6, var_7)

	local var_1_7 = var_0_1

	Timer = var_1_6
	var_1_7.timer = var_1_6.New(function()
		if not var_0_5 then
			warning = var_0
...
function var_0_1.onDisconnected(arg_5_0, arg_5_1)
	...
	var_5_0(var_5_1 .. var_1_10004(arg_5_0))
...
function var_0_1.onData(arg_6_0)
	if var_0_6[arg_6_0.cmd] then
		...
		for iter_6_0, iter_6_1 in var_6_0(var_0_6[arg_6_0.cmd]) do
			iter_6_1(var_6_1)
		end
	end
