...
LOG_CONNECTION = var_0_10004

local var_0_3 = var_2(var_0_2, var_0_10004)
local var_0_4
local var_0_5
local var_0_6
local var_0_7
...
function var_0_1.Connect(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
	...
	var_5.AddListener(var_1_2, function()
		...
		PLATFORM_CODE = var_0
		PLATFORM_CHT = var_2_2

		if var_0 == var_2_2 then
...
function var_0_1.ConnectByDomain(arg_4_0, arg_4_1, arg_4_2)
	...
	arg_4_0:Connect(var_4_0, var_4, arg_4_2)
...
function var_0_1.Reconnect(arg_5_0, arg_5_1)
	...
	arg_5_0:Connect(arg_5_0:GetLastHost(), arg_5_0:GetLastPort(), function()
		...
		if var_6_1 then
			...
			if not var_6_1.isLogin(var_2_10004) then
				if var_0_5.currentCS == 10020 then
					local var_6_3 = var_0_13

					DISCONNECT_TIME_OUT = var_2_10004
				...
				do
					...
					var_6_6(var_6_5, var_2_10005.LOGOUT, {
						code = 3
					})
				end
			...
			local var_6_11 = var_7.CalcMD5
			local var_6_12 = var_6_1.token

			AABBUDUD = var_2_10009
			var_6_10.check_key = var_6_11(var_6_12 .. var_2_10009)

			local var_6_13 = var_0.SdkMgr.GetInstance()

			var_6_10.device_id = var_7.GetDeviceId(var_6_13)
			...
			var_6_8(var_6_7, var_6_9, var_6_10, 10023, function(arg_7_0)
				...
				if arg_7_0.result == 0 then
					...
					var_7_0 = var_0_13
					DISCONNECT_TIME_OUT = var_7_2

					if var_7_0 ~= var_7_2 then
						var_7_2 = var_0_5
						var_7_0 = var_7_0.getPacketIdx(var_7_2)
						...
						if 0 < var_7_0 then
							...
							var_7_0.Send(var_7_2, 11001, {
								...
								var_8_2(var_8_1, var_3.CHANGE_CHAT_ROOM, 0)
							...
							if var_7_0() then
								var_7_2 = var_7_0.type
								World = var_3

								if var_7_2 ~= var_3.TypeBase then
									WorldConst = var_7_2

									var_7_2.ReqWorldForServer()
								end
							end

							NewEducateHelper = var_7_2

							var_7_2.ReqDataForServer()
					...
					if var_7_0(var_7_2) and var_7_0:getInited() then
						local var_7_3 = var_0.SecondaryPWDMgr.GetInstance()

						var_2.FetchData(var_7_3)
					end

					local var_7_4 = var_0.NewGuideMgr.GetInstance()

					var_2.Resume(var_7_4)

					local var_7_5 = var_0.m02
					local var_7_6 = var_2.sendNotification

					GAME = var_4

					var_7_6(var_7_5, var_4.ON_RECONNECTION)

					local var_7_7 = var_0.m02
					local var_7_8 = var_2.sendNotification

					GAME = var_4

					var_7_8(var_7_7, var_4.ON_APPLICATION_PAUSE, false)
				else
					originalPrint = var_7_0

					var_7_0("reconnect failed: " .. arg_7_0.result)

					local var_7_9 = var_0.m02
					local var_7_10 = var_1.sendNotification

					GAME = var_3

					var_7_10(var_7_9, var_3.LOGOUT, {
						code = 199,
						tip = arg_7_0.result
					})
				end
...
function var_0_1.onDisconnected(arg_9_0, arg_9_1)
	...
	var_1_10002(var_9_0 .. var_1_10004(arg_9_0))
...
function var_0_1.onData(arg_10_0)
	if var_0_9[arg_10_0.cmd] then
		...
		for iter_10_0, iter_10_1 in var_10_0(var_0_9[arg_10_0.cmd]) do
			iter_10_1(var_10_1)
		end
	end
...
function var_0_1.onError(arg_11_0)
	...
	local function var_11_1()
		...
		local var_12_2 = var_2_10002.LOGOUT
		local var_12_3 = {}
		local var_12_4
	...
	if var_0_6 and var_0_7 then
		...
		if var_3.contains({
			...
			i18n = var_1_10007
			var_11_8.content = var_1_10007("reconnect_tip", arg_11_0)
...
function var_0_1.Send(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4, arg_15_5, arg_15_6)
	local function var_15_0(arg_16_0)
		if arg_16_0.result == 14 then
			...
			var_16_1(var_16_0, var_2_10003.EXTRA_PROTO_RESULT, {
...
function var_0_1.resetHBTimer(arg_25_0)
	...
	HEART_BEAT_TIMEOUT = var_1_10003
	var_0_10 = var_25_0(var_25_1, var_1_10003, -1, true)
...
function var_0_1.SwitchProxy(arg_33_0)
	if var_0_14 then
		...
		if var_1.IsSpecialIP(var_33_0) then
			...
			DISCONNECT_TIME_OUT = var_1_10003

			var_33_4(var_33_5, var_1_10003)
		end
	end
