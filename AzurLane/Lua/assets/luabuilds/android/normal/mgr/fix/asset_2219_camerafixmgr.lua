...
import = var_0_10003
var_0.CameraFixMgr = var_0_10001(var_0_1, var_0_10003("view.base.BaseEventLogic"))
pg = var_0
...
function var_0_2.BlockCameraRatioControll(arg_10_0, arg_10_1)
	...
	if arg_10_1 then
		...
		typeof = var_1_10004
		var_1_10003 = var_1_10003(var_1_10004("System.Single"), 2)
		var_1_10003[0] = 0
		var_1_10003[1] = 100
		ReflectionHelp = var_1_10004

		var_1_10004.RefSetField(var_10_0:GetType(), "AspectRatioRange", var_10_0, var_1_10003)
	else
		System = var_1_10003
		...
		local var_10_2 = var_10_1(var_1_10004("System.Single"), 2)
	...
	if arg_14_0.paddingCanvas then
		...
		if var_2(arg_14_0.paddingCanvas) then
			...
			if var_2.Find("/OverlayCamera/Adpter") then
				...
				rtf = var_3
				arg_14_0.paddingCanvas = var_3(var_2)
				...
				arg_14_0.paddingCanvasScaler = var_14_1(var_14_0, var_1_10005(var_1_10006))
				...
				if not var_2(arg_14_0.paddingTop) then
					...
					if not var_2(arg_14_0.paddingBottom) then
						...
						if not var_2(arg_14_0.paddingLeft) then
							...
							local var_14_11 = var_8.max((var_14_7 - var_14_9) * 0.5, 0)
