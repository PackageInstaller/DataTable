...
function var_0_0.GetSay(arg_3_0)
	...
	if var_2.getApartment(var_3_1, arg_3_0.shipGroup) then
		local var_3_2 = var_2
		local var_3_3

		if not var_2.GetCallName(var_3_2) then
			var_3_3 = arg_3_0.shipGroup
		end

		string = var_3_2

		return (var_3_2.gsub(var_3_0, "{dorm3d}", var_3_3))
	end
end
