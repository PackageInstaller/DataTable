...
function var_0_1.OnLoaded(arg_2_0)
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.stateTxt = var_2_2(var_2_1, var_3(var_1_10004))
	...
	typeof = var_3
	Text = var_1_10004
	arg_2_0.stateEnTxt = var_2_5(var_2_4, var_3(var_1_10004))
	...
	typeof = var_3
	Image = var_1_10004
	arg_2_0.bgImg = var_2_15(var_2_14, var_3(var_1_10004))
...
function var_0_1.LoadScript(arg_3_0, arg_3_1)
	...
	var_1_10006(var_3_4, "load script failed:" .. arg_3_1)

	VoiceChat = var_1_10006

	return var_1_10006.New(var_3_4)
end
...
function var_0_1.Play(arg_5_0, arg_5_1, arg_5_2)
	...
	var_5.insert(var_5_1, function(arg_6_0)
		local var_6_0 = arg_5_0

		var_1.WaitForRespond(var_6_0, var_5_0, arg_6_0, arg_5_2)
	...
	var_5.insert(var_5_1, function(arg_7_0)
		local var_7_0 = arg_5_0

		var_1.StartAction(var_7_0, var_5_0)
		arg_7_0()
	...
	for iter_5_0, iter_5_1 in var_5(var_5_0.steps) do
		table = var_1_10010

		var_1_10010.insert(var_5_1, function(arg_8_0)
			local var_8_0 = arg_5_0.player

			var_1.Play(var_8_0, var_5_0, iter_5_0, arg_8_0)
	...
	var_5.insert(var_5_1, function(arg_9_0)
...
function var_0_1.InitAction(arg_11_0, arg_11_1)
	...
	if arg_11_1.HasBg(var_11_0) then
		local var_11_1 = arg_11_0.bgImg

		LoadSprite = var_11_0
		var_11_1.sprite = var_11_0("bg/" .. arg_11_1:GetBgName())

		local var_11_2 = arg_11_0.bgImg

		var_2.SetNativeSize(var_11_2)
	end

	local var_11_3 = arg_11_0.player

	var_2.OnStart(var_11_3)
...
function var_0_1.WaitForRespond(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_1 = arg_12_1:GetLabel()
	local var_12_2 = arg_12_1

	var_12_0.text = var_5(var_12_1, arg_12_1.GetShipName(var_12_2))

	local var_12_3 = arg_12_0.stateEnTxt

	var_12_3.text = "P R I V A T E C H A T"
	onButton = var_12_3

	local var_12_4 = arg_12_0
	local var_12_5 = arg_12_0.respondBtn
	local var_12_6 = arg_12_2

	SFX_PANEL = var_12_2

	var_12_3(var_12_4, var_12_5, var_12_6, var_12_2)

	onButton = var_12_3

	local var_12_7 = arg_12_0
	local var_12_8 = arg_12_0.closeBtn
	...
	local function var_12_9()
		...
		local var_13_5 = var_13_4(var_13_3, var_3(var_2_10004))
	...
	var_12_3(var_12_7, var_12_8, var_12_9, var_12_2)
...
local function var_0_7(arg_15_0)
	...
	return var_1_10003.format("%02d:%02d", var_15_0, var_15_1)
end
