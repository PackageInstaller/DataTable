...
function var_0_1.Ctor(arg_1_0, arg_1_1)
	...
	typeof = var_4
	Text = var_1_10005
	arg_1_0.content = var_1_2(var_1_1, var_4(var_1_10005))
	...
	local var_1_6 = var_3.Find(var_1_5, "options_c")
	local var_1_7 = arg_1_0.optionPanel

	arg_1_0.optionUIList = var_1_4(var_1_6, var_4.Find(var_1_7, "options_c/option_tpl"))
...
function var_0_1.PlayVoice(arg_10_0, arg_10_1)
	...
	local var_10_1 = arg_10_1.GetVoice(var_10_0)

	pg = var_10_0

	local var_10_2 = var_10_0.CriMgr.GetInstance()

	var_3.PlaySoundEffect_V3(var_10_2, var_10_1, function(arg_11_0)
		if arg_11_0 then
		...
		local var_11_2 = var_2.GetWaitForClickTime(var_11_1)

		assert = var_11_1

		local var_11_3 = var_11_2 < var_11_0

		string = var_2_10005

		var_11_1(var_11_3, var_2_10005.format("chatShowTime must > wait time voice:%s voiceLenth:%f wait:%f", var_10_1, var_11_0, var_11_2))

		local var_11_4 = arg_10_0

		var_3.AddTimeTriggerNextOne(var_11_4, var_11_0)
...
function var_0_1.ReigsetEvent(arg_15_0, arg_15_1, arg_15_2)
	...
	arg_15_0:DelayCall(var_15_0, function()
		...
		var_2_10000(var_16_0, var_16_1, var_16_2, var_2_10004)
...
function var_0_1.InitOptionIfNeed(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	var_5.make(var_18_1, function(arg_19_0, arg_19_1, arg_19_2)
		...
		if arg_19_0 == var_2_10003.EventUpdate then
			...
			typeof = var_6
			Text = var_2_10007
			var_19_2(var_19_1, var_6(var_2_10007)).text = var_19_0[1]
			onButton = var_5
			...
			var_5(arg_18_0, arg_19_2, function()
				...
				local var_20_3 = var_20_2(var_20_1, var_3_10003(var_3_10004))
				...
				local var_20_6 = var_20_5(var_20_4, var_4(var_3_10005))
...
function var_0_1.DispatcherEvent(arg_22_0, arg_22_1)
	...
	local var_22_1 = arg_22_1.GetDispatcher(var_22_0)

	pg = var_22_0

	local var_22_2 = var_22_0.NewStoryMgr.GetInstance()

	var_3.ClearStoryEvent(var_22_2)

	pg = var_3

	local var_22_3 = var_3.m02

	var_3.sendNotification(var_22_3, var_22_1.name, {
		data = var_22_1.data,
		callbackData = var_22_1.callbackData
	})
