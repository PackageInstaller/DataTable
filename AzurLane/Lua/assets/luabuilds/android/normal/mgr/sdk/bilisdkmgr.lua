...
function var_0_0.DeleteAccount()
	...
	if var_18_0 == var_1_10001 then
		...
		getProxy = var_18_1
		ServerProxy = var_1_10003

		local var_18_3 = var_18_1(var_1_10003)
		...
		local var_18_7 = var_1_10004(var_1_10005)

		if var_4.getRawData(var_18_7) then
			var_1_10006 = var_4

			local var_18_8

			if not var_4.GetName(var_1_10006) then
				var_18_8 = ""
			end
			...
			if var_4 then
				...
				if not var_1_10006(var_4.level) then
					var_18_9 = "0"
				end
				...
				if var_4 then
					...
					if not var_4.GetRegisterTime(var_1_10008) then
						var_18_10 = 0
					end
...
function var_0_0.OnAndoridBackPress()
	...
	if var_19_0 ~= var_1_10001 then
		...
		if var_19_0 == var_1_10001 then
			...
			if not var_1_10001(var_1_10002.MsgboxMgr.GetInstance()._go) then
				pg = var_1
				...
				i18n = var_1_10004
				var_19_3.content = var_1_10004("confirm_app_exit")
...
function var_0_0.Service()
	...
	if not var_1_10000(var_1_10001) then
		return
	end
...
local function var_0_14()
	...
	local var_34_2 = var_1_10002.GO_SCENE

	SCENE = var_1_10003

	var_34_1(var_34_0, var_34_2, var_1_10003.LOGIN)
...
local function var_0_16(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local var_35_1 = var_5.GetCHPackageType()

	PACKAGE_TYPE_UNION = var_1_10006

	if var_35_1 == var_1_10006 then
		pg = var_1_10006

		local var_35_2 = var_1_10006.m02

		var_1_10006 = var_1_10006.sendNotification
		GAME = var_1_10008

		var_1_10006(var_35_2, var_1_10008.PLATFORM_LOGIN_DONE, {
			user = var_35_0
		})
	else
		pg = var_1_10006

		local var_35_3 = var_1_10006.m02
		local var_35_4 = var_6.sendNotification

		GAME = var_1_10008

		var_35_4(var_35_3, var_1_10008.SERVER_INTERCOMMECTION, {
			user = var_35_0
		})
	end
...
local function var_0_18(arg_36_0)
	...
	var_36_1(var_36_0, var_1_10003.LOGOUT, {
		code = arg_36_0
	})
...
local function var_0_20(arg_37_0, arg_37_1)
	...
	local var_37_0 = var_2(var_1_10003)
	...
	var_37_2(var_37_1, var_1_10004.CHARGE_CONFIRM, {
		payId = arg_37_0,
		bsId = arg_37_1
	})
...
local function var_0_22(arg_38_0, arg_38_1)
	...
	var_38_2(var_38_1, var_1_10004.CHARGE_FAILED, {
		payId = arg_38_0,
		code = arg_38_1
	})

	PLATFORM = var_38_2
	PLATFORM_IPHONEPLAYER = var_38_1

	if var_38_2 == var_38_1 then
		pg = var_38_2
		...
		var_38_2(var_38_3, var_4("支付失败" .. arg_38_1))
	elseif arg_38_1 == -5 then
		...
		var_38_5(var_38_4, var_4("订单签名异常" .. arg_38_1))
	else
		local var_38_7
		...
		if 0 < arg_38_1 then
			if 1000 < arg_38_1 and arg_38_1 < 2000 then
				...
				var_38_7(var_38_6, var_4("数据格式验证错误" .. arg_38_1))
			elseif 2000 <= arg_38_1 and arg_38_1 < 3000 then
				...
				var_38_7(var_38_8, var_4("服务器返回异常" .. arg_38_1))
			elseif 3000 <= arg_38_1 and arg_38_1 < 4000 then
				...
				var_38_7(var_38_9, var_4("未登录或者会话已超时" .. arg_38_1))
			elseif arg_38_1 == 4000 then
				...
				var_38_7(var_38_10, var_4("系统错误" .. arg_38_1))
			elseif arg_38_1 == 6001 then
				...
				var_38_7(var_38_11, var_4("用户中途取消" .. arg_38_1))
			elseif arg_38_1 == 7005 then
				...
				var_38_7(var_38_12, var_4("支付失败" .. arg_38_1))
			elseif arg_38_1 == 7004 then
				...
				var_38_7(var_38_13, var_4("支付失败" .. arg_38_1))
			end
		elseif arg_38_1 == -201 then
			...
			var_38_7(var_38_14, var_4("生成订单失败" .. arg_38_1))
		elseif arg_38_1 == -202 then
			...
			var_38_7(var_38_15, var_4("支付取消" .. arg_38_1))
		elseif arg_38_1 == -203 then
			...
			var_38_17(var_38_16, var_4("支付失败" .. arg_38_1))
		end
	end
...
local function var_0_38()
	...
	var_46_1(var_46_0, var_1_10002.LOGOUT, {
		code = 0
	})
