...
function var_0_0.GetPNInfo()
	...
	if var_1_10003(var_1_10004) then
		var_1_10005 = var_3
		var_2_0 = var_3.getData(var_1_10005).id
		var_1_10005 = var_3
		var_2_1 = var_3.getData(var_1_10005).level
		var_1_10005 = var_3
		var_2_2 = var_3.getData(var_1_10005).name
	end
	...
	local var_2_4 = var_1_10005(var_1_10006)

	if var_5.getData(var_2_4) then
		getProxy = var_2_4
		ServerProxy = var_1_10008

		local var_2_5 = var_2_4(var_1_10008)

		var_2_3 = var_2_4.getLastServer(var_2_5, var_6.uid).id
	end

	PNInfo = var_2_4

	local var_2_6 = var_2_4.New(var_2_0, var_2_1)
	local var_2_7 = {}
...
function var_0_0.GetClientVer()
	...
	GroupMainHelper = var_1_10002

	local var_3_2 = var_3_1(var_3_0, var_1_10002.DefaultGroupName).CurrentVersion
...
function var_0_0.GetSDKServerID()
	...
	var_1_10002(var_4_2 .. var_1_10004(var_4_1))
...
function var_0_0.SdkPay(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4, arg_21_5, arg_21_6, arg_21_7, arg_21_8, arg_21_9)
	...
	var_12(var_21_1, var_14(var_21_0))
	...
	var_21_4(var_21_3, var_21_5, var_21_6, var_21_7, var_18.GetJson(var_21_8))
...
local function var_0_2()
	...
	local var_32_2 = var_1_10002.GO_SCENE

	SCENE = var_1_10003

	var_32_1(var_32_0, var_32_2, var_1_10003.LOGIN)
...
local function var_0_4(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	local var_33_1 = var_5.m02
	local var_33_2 = var_5.sendNotification

	GAME = var_1_10007

	var_33_2(var_33_1, var_1_10007.PLATFORM_LOGIN_DONE, {
		user = var_33_0
	})
...
local function var_0_6(arg_34_0)
	...
	var_34_1(var_34_0, var_1_10003.LOGOUT, {
		code = arg_34_0
	})
...
local function var_0_8(arg_35_0, arg_35_1)
	...
	local var_35_0 = var_2(var_1_10003)
...
local function var_0_10(arg_36_0, arg_36_1)
	...
	var_36_2(var_36_1, var_1_10004.CHARGE_FAILED, {
		payId = arg_36_0,
		code = arg_36_1
	})
	...
	if arg_36_1 == -202 then
		...
		var_36_4(var_36_3, var_4("pay_cancel") .. arg_36_1)
	end
...
local function var_0_12(arg_38_0)
	local function var_38_0(arg_39_0, arg_39_1)
		...
		for iter_39_0, iter_39_1 in var_2_10002(var_2_10003.pay_data_display.all) do
			pg = var_2_10007
...
local function var_0_18(arg_42_0)
	...
	var_42_4(var_42_3, var_42_5, var_42_6, var_42_7, var_9.GetJson(var_42_8))
