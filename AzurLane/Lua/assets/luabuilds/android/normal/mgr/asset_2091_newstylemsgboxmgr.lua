...
function var_1.Init(arg_1_0, arg_1_1)
	...
	for iter_1_0, iter_1_1 in var_3(var_0.RES_LIST) do
		table = var_1_10008
...
function var_1.Show(arg_5_0, ...)
	...
	if #arg_5_0.showList == 1 then
		...
		var_5_3(var_5_2, var_3(arg_5_0.showList[1]))
	end
...
function var_1.DeepShow(arg_6_0, ...)
	if #arg_6_0.showList == 0 then
		...
		var_6_0(var_6_1, var_6_2, var_1_10004(...))
		arg_6_0:Hide(true)
	end
...
function var_1.Hide(arg_11_0, arg_11_1)
	...
	if #arg_11_0.showList > 0 then
		...
		var_11_3(var_11_2, var_4(arg_11_0.showList[1]))
	end
...
function var_1.CommonSetting(arg_12_0, arg_12_1)
	...
	local var_12_1 = var_3.Find(var_12_0, "window/top/title")
	local var_12_2
	...
	local var_12_5 = var_4.Find(var_12_4, "bg")
	...
	var_2(var_12_3, var_12_5, var_12_6, var_6)

	onButton = var_2

	local var_12_7 = arg_12_0
	local var_12_8 = arg_12_0._tf
	local var_12_9 = var_4.Find(var_12_8, "window/top/btn_close")
	...
	var_2(var_12_7, var_12_9, var_12_10, var_6)
	...
	if not arg_12_1.btnList then
		...
		i18n = var_4
		var_12_12.name = var_4("msgbox_text_cancel")
		...
		i18n = var_4
		var_12_13.name = var_4("msgbox_text_confirm")
	...
	var_12_14(var_12_15, function(arg_19_0)
	...
	for iter_12_0, iter_12_1 in var_12_14(var_12_11) do
		...
		var_10(var_12_18, var_12_19, var_12_20, var_14)
	end
...
function var_1.DisplaySetting(arg_22_0, arg_22_1, arg_22_2)
	...
	var_1_10003(arg_22_1, {
		[var_0.TYPE_MSGBOX] = function(arg_23_0)
			...
			var_2_10001(var_2.Find(var_23_0, "window/middle/content"), arg_23_0.contentText)
		...
		[var_0.TYPE_DROP] = function(arg_24_0)
			...
			updateCustomDrop = var_24_1

			var_24_1(var_24_2:Find("Dorm3dIconTpl"), arg_24_0.drop, {
				style = arg_24_0.style
			})

			setText = var_24_1

			var_24_1(var_24_2:Find("info/name"), var_24_0:getName())

			setText = var_24_1

			local var_24_3 = var_24_2
			local var_24_4 = var_24_2.Find(var_24_3, "info/scroll/desc")

			cancelColorRich = var_24_3

			var_24_1(var_24_4, var_24_3(var_24_0.desc))

			local var_24_5, var_24_6 = var_24_0:getOwnedCount()

			setActive = var_5

			var_5(var_24_2:Find("info/count"), var_24_6)
			...
			if var_24_6 then
				...
				local var_24_9 = var_24_7("dorm3d_item_num")

				string = var_8

				var_5(var_24_8, var_24_9 .. var_8.format("<color=#39bfff>%d</color>", var_24_5))
			end
		...
		[var_0.TYPE_DROP_CLIENT] = function(arg_25_0)
			...
			Dorm3dIconHelper = var_25_0

			var_25_0.UpdateDorm3dIcon(var_25_1:Find("Dorm3dIconTpl"), arg_25_0.data)
			...
			var_3(var_25_1:Find("info/name"), var_25_2.name)

			setText = var_3

			var_3(var_25_1:Find("info/scroll/desc"), var_25_2.desc)
		...
		[var_0.TYPE_COMMON_HELP] = function(arg_27_0)
			...
			var_2_10001(var_2.Find(var_27_0, "window/bottom"), false)
			...
			local var_27_3 = var_27_1.New(var_27_2, var_27_2:Find("tpl"))
			...
			var_2.make(var_27_3, function(arg_28_0, arg_28_1, arg_28_2)
				...
				if arg_28_0 == var_3_10003.EventUpdate then
					...
					local var_28_2 = arg_28_2.Find(var_28_1, "Text")

					HXSet = var_28_1

					local var_28_3 = var_28_1.hxLan
					...
					if var_28_0.info then
						...
						if not var_7(var_28_0.info, true) then
							var_28_4 = ""
						end

						var_3_10004(var_28_2, var_28_3(var_28_4))
		...
		[var_0.TYPE_COMMON_DROP] = function(arg_29_0)
			...
			var_29_1(var_29_2:Find("left/IconTpl"), var_29_0)

			setText = var_29_1

			var_29_1(var_29_2:Find("info/name_container/name/Text"), var_29_0:getConfig("name"))

			local var_29_3 = var_29_2:Find("info/desc/Text")
			local var_29_4 = arg_22_0

			var_4.InitRichText(var_29_4, var_29_3)
			var_29_0:MsgboxIntroSet(arg_29_0, var_29_3)

			setTextInNewStyleBox = var_4

			local var_29_5 = var_29_3
			local var_29_6 = var_29_3
			local var_29_7 = var_29_3.GetComponent

			typeof = var_2_10008
			Text = var_2_10009

			var_4(var_29_5, var_29_7(var_29_6, var_2_10008(var_2_10009)).text)
			...
			local var_29_9 = var_29_2.Find(var_29_8, "left/detail/Text")

			i18n = var_29_8

			var_4(var_29_9, var_29_8("technology_detail"))
			...
			local var_29_11 = var_29_10 == var_5
			local var_29_12 = var_29_2:Find("info/name_container/shiptype")
			local var_29_13 = var_29_2
			local var_29_14 = var_29_2.Find(var_29_13, "extra_info/ship")

			setActive = var_29_13

			var_29_13(var_29_12, var_29_11)

			setActive = var_29_13

			var_29_13(var_29_14, var_29_11)

			local var_29_15

			if var_29_11 then
				GetImageSpriteFromAtlasAsync = var_29_13
				var_29_15 = "shiptype"
				shipType2print = var_9

				var_29_13(var_29_15, var_9(var_29_0:getConfig("type")), var_29_12)

				tobool = var_29_13
				getProxy = var_29_15
				CollectionProxy = var_9

				local var_29_16 = var_29_15(var_9)
				local var_29_17 = var_29_13(var_29_15.getShipGroup(var_29_16, var_0.ship_data_template[var_29_0.id].group_type))

				setActive = var_29_15

				var_29_15(var_29_14:Find("unlock"), var_29_17)

				setText = var_29_15

				local var_29_18 = var_29_14
				local var_29_19 = var_29_14.Find(var_29_18, "unlock/Text")

				i18n = var_29_18

				var_29_15(var_29_19, var_29_18("tag_ship_unlocked"))

				setActive = var_29_15

				var_29_15(var_29_14:Find("lock"), not var_29_17)

				setText = var_29_15

				local var_29_20 = var_29_14
				local var_29_21 = var_29_14.Find(var_29_20, "lock/Text")

				i18n = var_29_20

				var_29_15(var_29_21, var_29_20("tag_ship_locked"))
			end

			local var_29_22 = var_29_0.type

			DROP_TYPE_EQUIPMENT_SKIN = var_29_15

			local var_29_23 = var_29_22 == var_29_15
			local var_29_24 = var_29_2
			local var_29_25 = var_29_2.Find(var_29_24, "extra_info/equip_skin")

			setActive = var_29_24

			var_29_24(var_29_25, var_29_23)

			setActive = var_29_24

			var_29_24(var_29_2:Find("left/placeholder"), var_29_23)

			local var_29_27

			if var_29_23 then
				setTextInNewStyleBox = var_29_24

				var_29_24(var_29_2:Find("info/desc/Text"), var_29_0:getConfig("desc"))

				local var_29_26 = var_0.equip_skin_template[var_29_0.id]

				underscore = var_29_27
				var_29_27 = var_29_27.map(var_29_26.equip_type, function(arg_30_0)
				...
				local var_29_28 = var_11.concat(var_29_27, ",")

				setScrollText = var_12

				local var_29_29 = var_29_25
				local var_29_30 = var_29_25.Find(var_29_29, "tag/mask/Text")

				i18n = var_29_29

				var_12(var_29_30, var_29_29("word_fit") .. ":" .. var_29_28)

				onButton = var_12

				local var_29_31 = arg_22_0
				local var_29_32 = var_29_25:Find("play")

				local function var_29_33()
					Ship = var_3_10000

					local var_31_0 = var_3_10000.New({
						id = var_29_26.ship_config_id,
						configId = var_29_26.ship_config_id,
						skin_id = var_29_26.ship_skin_id
					})
					...
					if var_29_26.ship_skin_id == 0 then
						Clone = var_5

						local var_31_5

						if not var_5(var_29_26.weapon_ids) then
							var_31_5 = {}
						end
						...
						if var_29_26.ship_skin_id ~= 0 or not var_29_0.id then
							var_31_6 = 0
						end
				...
				var_12(var_29_31, var_29_32, var_29_33, var_16)
			end

			local var_29_34 = var_29_0.type

			DROP_TYPE_COMBAT_UI_STYLE = var_29_27

			local var_29_35 = var_29_34 == var_29_27
			local var_29_36 = var_29_2
			local var_29_37 = var_29_2.Find(var_29_36, "extra_info/combat_skin")

			setActive = var_29_36

			var_29_36(var_29_37, var_29_35)

			setActive = var_29_36

			var_29_36(var_29_2:Find("left/placeholder"), var_29_35)

			if var_29_35 then
				local var_29_38 = var_0.item_data_battleui[var_29_0.id].rare_display

				UIItemList = var_12

				local var_29_39 = var_12.New(var_29_2:Find("extra_info/combat_skin/elementList"), var_29_2:Find("extra_info/combat_skin/elementList/main"))

				var_12.make(var_29_39, function(arg_32_0, arg_32_1, arg_32_2)
					UIItemList = var_3_10003
					...
					if arg_32_0 == var_3_10003.EventUpdate then
						...
						CombatSkinConst = var_3_10005

						var_3(var_32_0, var_3_10005.TYPE_ICON_NAME[var_29_38[arg_32_1 + 1]], arg_32_2:Find("icon"), true)

						setScrollText = var_3

						local var_32_1 = arg_32_2
						local var_32_2 = arg_32_2.Find(var_32_1, "TextMask/Text")

						i18n = var_32_1

						var_3(var_32_2, var_32_1("battleui_display" .. var_29_38[arg_32_1 + 1]))
					end

					return
				end)
				var_12:align(#var_29_38)

				onButton = var_13

				local var_29_40 = arg_22_0
				local var_29_41 = var_29_37:Find("play")

				local function var_29_42()
				...
				var_13(var_29_40, var_29_41, var_29_42, var_17)
			end
		...
		[var_0.TYPE_COMMON_ITEMS] = function(arg_35_0)
			...
			var_35_0(var_35_1:Find("info/Text"), arg_35_0.content)

			setTextInNewStyleBox = var_35_0
			...
			var_35_0(var_35_2, var_35_3)

			local var_35_4 = arg_35_0.items
			local var_35_5 = arg_35_0.itemFunc
			local var_35_6 = var_35_1
			local var_35_7 = var_35_1.Find(var_35_6, "scrollview/content")

			UIItemList = var_35_6

			var_35_6.StaticAlign(var_35_7, var_35_7:Find("item"), #var_35_4, function(arg_36_0, arg_36_1, arg_36_2)
				arg_36_1 = arg_36_1 + 1
				UIItemList = var_3_10003
				...
				if arg_36_0 == var_3_10003.EventUpdate then
					...
					local var_36_2 = arg_36_2.Find(var_36_1, "IconTpl/name")
					...
					var_36_1(var_36_3, var_7(var_8(var_36_2), 6))

					setActive = var_36_1

					var_36_1(arg_36_2:Find("own"), arg_35_0.showOwn)
					...
					if arg_35_0.showOwn then
						...
						local var_36_5 = arg_36_2.Find(var_36_4, "own/Text")

						i18n = var_36_4

						local var_36_6 = var_36_4("equip_skin_detail_count")

						var_36_7 = var_36_0

						var_5(var_36_5, var_36_6 .. var_36_0.getOwnedCount(var_36_7))
					end

					onButton = var_5

					local var_36_8 = arg_22_0
					...
					SFX_UI_CLICK = var_36_7

					var_5(var_36_8, var_36_9, var_36_10, var_36_7)
				end
		...
		[var_0.TYPE_SHIP_PREVIEW] = function(arg_38_0)
			...
			var_38_2(var_38_3, false)

			GameObject = var_38_2

			local var_38_4 = var_38_2.Find("BarrageCamera")
			...
			Vector3 = var_6
			var_38_7.localPosition = var_6(-360, 50, 40)
			setActive = var_38_7
			...
			local var_38_11 = arg_22_0
			local var_38_12 = arg_22_0._tf

			local function var_38_13()
				setActive = var_3_10000

				var_3_10000(var_38_9, false)

				if var_38_10 then
					local var_42_0 = var_38_10
			...
			var_8(var_38_11, var_38_12, var_38_13, var_2_10012)
		...
		[var_0.TYPE_COMMON_SHOPPING] = function(arg_43_0)
			...
			var_3(var_43_1:Find("IconTpl"), var_43_2)

			setText = var_3

			var_3(var_43_1:Find("info/name/Text"), var_43_2:getConfig("name"))

			setText = var_3

			local var_43_3 = var_43_1
			local var_43_4 = var_43_1.Find(var_43_3, "IconTpl/own")

			i18n = var_43_3

			var_3(var_43_4, var_43_3("equip_skin_detail_count") .. var_43_2:getOwnedCount())

			local var_43_5 = var_43_1:Find("info/desc/Text")
			local var_43_6 = arg_22_0

			var_4.InitRichText(var_43_6, var_43_5)

			local var_43_7 = arg_22_0._tf
			local var_43_8 = var_4.Find(var_43_7, "window/bottom/button_container/btn_shopping/price/Text")
			local var_43_9 = arg_22_0._tf
			local var_43_10 = var_5.Find(var_43_9, "window/bottom/count")

			PageUtil = var_43_9

			local var_43_11 = var_43_9.New(var_43_10:Find("reduce"), var_43_10:Find("increase"), var_43_10:Find("max"), var_43_10:Find("Text"))
			local var_43_12 = arg_43_0.price
			local var_43_13 = arg_43_0.numUpdate
			local var_43_14
			...
			var_43_11:setNumUpdate(function(arg_44_0)
				if var_43_13 ~= nil then
					var_43_13(var_43_5, arg_44_0)
				end

				setText = var_1

				var_1(var_43_8, "x" .. arg_44_0 * var_43_12)

				return
			end)
			var_43_11:setAddNum(var_43_14)
			var_43_11:setMaxNum(var_43_15)
			var_43_11:setDefaultNum(var_43_16)
		...
		[var_0.TYPE_LOVE_LETTER_LEVEL_REWARD] = function(arg_45_0)
			...
			local var_45_1 = var_2.Find(var_45_0, "window/top/title")

			i18n = var_45_0

			var_2_10001(var_45_1, var_45_0("loveactivity_ui_20"))
			...
			local var_45_4 = var_45_2.first(var_0.lover_reward.all, var_1:GetAllLevelAwardDisplayIndex())
			local var_45_5 = var_1:GetAllLevelRewardMarkDic()
			local var_45_6 = arg_22_0._tf
			local var_45_7 = var_5.Find(var_45_6, "window/middle/view/content")

			UIItemList = var_45_6

			local var_45_8 = var_45_6.StaticAlign
			local var_45_9 = var_45_7
			local var_45_10 = var_45_7
			local var_45_11 = var_45_7.Find(var_45_10, "tpl")

			math = var_45_10

			var_45_8(var_45_9, var_45_11, var_45_10.max(#var_45_4, 3), function(arg_46_0, arg_46_1, arg_46_2)
				arg_46_1 = arg_46_1 + 1
				UIItemList = var_3_10003
				...
				if arg_46_0 == var_3_10003.EventUpdate then
					...
					var_46_1(arg_46_2:Find("active_bg"), not var_45_5[var_46_0] and var_45_3 >= var_46_2.total_level)

					setActive = var_46_1

					var_46_1(arg_46_2:Find("lock"), var_45_3 < var_46_2.total_level)

					setText = var_46_1

					var_46_1(arg_46_2:Find("mark/Text"), var_46_2.total_level)

					underscore = var_46_1

					local var_46_3 = var_46_1.map(var_46_2.show_reward, function(arg_47_0)
						Drop = var_4_10001
					...
					var_6.StaticAlign(arg_46_2:Find("awards"), arg_46_2:Find("awards/tpl"), #var_46_3, function(arg_48_0, arg_48_1, arg_48_2)
						arg_48_1 = arg_48_1 + 1
						...
						if var_48_0 == var_4_10004.EventUpdate then
							...
							local function var_48_4()
								...
								var_49_1(var_49_0, var_5_10002.ON_DROP, var_48_1)

								return
							end

							SFX_PANEL = var_4_10008

							var_4(var_48_2, var_48_3, var_48_4, var_4_10008)

							setActive = var_4

							var_4(arg_48_2:Find("got"), var_45_5[var_46_0])
						end
			...
			local var_45_12 = var_1

			if var_1.GetAllLevelNextAwardIndex(var_45_12) then
				scrollToIndex = var_45_12

				var_45_12(var_45_7, var_6)
			else
				scrollToBottom = var_45_12
...
function var_1.InitRichText(arg_50_0, arg_50_1)
	...
	local var_50_1 = arg_50_1.GetComponent(var_50_0, "RichText")

	pairs = var_50_0

	for iter_50_0, iter_50_1 in var_50_0(arg_50_0.richTextSprites) do
		var_50_1:AddSprite(iter_50_0, iter_50_1)
	end
	...
	if not arg_51_0.analogyMediator then
		arg_51_0.analogyMediator = {
			addSubLayers = function(arg_52_0, arg_52_1)
				...
				local var_52_2 = var_2_10004.LOAD_LAYERS
				local var_52_3 = {}

				getProxy = var_2_10006
				ContextProxy = var_2_10007

				local var_52_4 = var_2_10006(var_2_10007)

				var_52_3.parentContext = var_6.getCurrentContext(var_52_4)
