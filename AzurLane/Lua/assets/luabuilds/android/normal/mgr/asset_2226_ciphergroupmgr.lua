...
function var_0_1.GetValidFileList(arg_4_0, arg_4_1)
	...
	if var_1_10003.IsGroupWaitToUpdate(var_0_1.GroupName) then
		...
		for iter_4_0, iter_4_1 in var_3(arg_4_1) do
			...
			var_9(var_4_1 .. var_4_2 .. var_1_10012(var_1_10008))

			if var_1_10008 then
				table = var_9

				var_9.insert(var_4_0, iter_4_1)
			end
		end
	end
...
function var_0_1.DelFile(arg_9_0, arg_9_1)
	...
	local var_9_2 = var_9_1(var_1_10004(var_1_10005.String), var_9_0)
...
function var_0_1.DelFile_Old(arg_10_0, arg_10_1)
	...
	if iter_10_0.FileExists(var_10_3) then
		PathMgr = var_5
		var_10_4 = var_5.ReadAllLines(var_10_3)
		var_10_4 = #var_5.ToTable(var_10_4)

		local var_10_5 = {}

		ipairs = var_1_10008

		for iter_10_2, iter_10_3 in var_1_10008(var_5) do
			if not var_10_1(iter_10_3) then
				warning = var_13

				var_13("add origin hash:" .. iter_10_3)

				table = var_13

				var_13.insert(var_10_5, iter_10_3)
			else
				warning = var_13

				var_13("find del hash:" .. iter_10_3)

				local var_10_6 = iter_10_3

				System = iter_10_6
				iter_10_6 = iter_10_6.Array.CreateInstance
				typeof = var_15
				System = var_1_10016
				iter_10_6 = iter_10_6(var_15(var_1_10016.String), 3)
				string = var_15

				local var_10_7 = var_15.split(var_10_6, ",")

				for iter_10_4 = 1, 3 do
					local var_10_8 = var_10_7[iter_10_4]

					warning = var_1_10021

					var_1_10021("add info:" .. var_10_8)

					iter_10_6[iter_10_4 - 1] = var_10_8
				end

				table = var_1_10016

				var_1_10016.insert(var_10_2, iter_10_6)
			end
		end

		local var_10_9 = #var_10_5

		warning = var_9

		var_9("new hash count:" .. var_10_9)

		if var_10_9 < var_10_4 then
			GroupHelper = var_9

			local var_10_10

			if var_9.IsGroupVerLastest(var_0_1.GroupName) then
				Application = var_10_10
				var_10_10 = var_10_10.persistentDataPath .. "/" .. arg_10_0.group.localVersionFile
				System = var_10

				var_10.IO.File.WriteAllText(var_10_10, "0.0.1")

				warning = var_10

				var_10("ver write:" .. var_10_10)
			end

			System = var_10_10

			local var_10_11 = var_10_10.Array.CreateInstance

			typeof = var_10
			System = iter_10_2

			local var_10_12 = var_10_11(var_10(iter_10_2.String), var_10_9)

			ipairs = var_10

			for iter_10_5, iter_10_6 in var_10(var_10_5) do
				var_10_12[iter_10_5 - 1] = iter_10_6
			end

			System = var_10

			var_10.IO.File.WriteAllLines(var_10_3, var_10_12)
	...
	if arg_10_0.group.toUpdate then
		...
		for iter_10_7, iter_10_8 in var_5(var_10_2) do
			local var_10_13 = iter_10_8[0]

			warning = iter_10_2

			iter_10_2("re add info:" .. var_10_13)

			local var_10_14 = arg_10_0.group.toUpdate

			iter_10_2.Add(var_10_14, iter_10_8)

			local var_10_15 = arg_10_0.group

			iter_10_2 = iter_10_2.UpdateFileDownloadStates

			local var_10_16 = var_10_13

			DownloadState = iter_10_6

			iter_10_2(var_10_15, var_10_16, iter_10_6.CheckToUpdate)
		end

		local var_10_17 = arg_10_0.group.state

		DownloadState = var_10_4

		if var_10_17 == var_10_4.UpdateSuccess then
			local var_10_18 = arg_10_0.group

			DownloadState = var_10_4
			var_10_18.state = var_10_4.CheckToUpdate
		end
	else
		local var_10_19 = arg_10_0.group

		DownloadState = var_10_4
		var_10_19.state = var_10_4.None

		local var_10_20 = arg_10_0.group

		var_5.CheckD(var_10_20)
	end
...
function var_0_1.isCipherExist(arg_13_0, arg_13_1)
	...
	DownloadState = var_13_0

	local var_13_2

	if var_13_1 ~= var_13_0.None then
		DownloadState = var_3
	...
	local var_13_3 = var_4.getAssetBundle(arg_13_1)
...
function var_0_1.Repair(arg_14_0)
	...
	function var_14_0.onCallback()
		...
		if var_15_0(var_2_10001.persistentDataPath .. "/hashes-cipher.csv") then
			...
			var_15_3(var_15_2, var_2("word_no_cache"))
		end
	...
	i18n = var_1_10005
	var_14_3.content = var_1_10005("resource_verify_warn")
	var_14_3.custom = {
		var_14_0
	}
...
function var_0_1.onUpdateD(arg_18_0)
	...
	local var_18_1 = arg_18_0.group
	local var_18_2 = var_2.CheckF(var_18_1, var_18_0)

	DownloadState = var_18_1

	if var_18_2 == var_18_1.UpdateSuccess then
		...
		if var_18_2 == var_3.UpdateFailure then
			...
			if var_18_2 == var_3.Updating and arg_18_0.progressCB then
				local var_18_3 = arg_18_0.progressCB
				local var_18_4 = var_18_0
				local var_18_5 = arg_18_0.group

				var_18_3(var_18_4, var_5.GetWebReqProgress(var_18_5))
			end
		end
	end
