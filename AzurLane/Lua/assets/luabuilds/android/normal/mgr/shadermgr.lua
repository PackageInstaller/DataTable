		...
		if not var_2_10001 then
			...
			var_2_10002({
				...
				function(arg_10_0)
					...
					PathMgr = var_3_10003
					var_10_0.cacheCustomBuiltin = var_10_1(var_3_10003.getAssetBundle("custom_builtin"))
...
function var_0_1.GetBlurMaterialSync(arg_14_0)
	if arg_14_0.blurMaterial ~= nil then
		...
		local var_14_1 = arg_14_0.GetShader(var_14_0, "Hidden/MobileBlur")

		Material = var_14_0
		arg_14_0.blurMaterial = var_14_0.New(var_14_1)

		local var_14_2 = arg_14_0.blurMaterial
		local var_14_3 = var_2.SetVector
		local var_14_4 = "_Parameter"

		Vector4 = var_1_10005

		var_14_3(var_14_2, var_14_4, var_1_10005.New(1, -1, 0, 0))
...
function var_0_1.BlurTexture(arg_15_0, arg_15_1)
	...
	local var_15_1 = var_1_10003("UnityEngine.RenderTexture")
	local var_15_2 = "GetTemporary"
	local var_15_3 = {}

	typeof = var_1_10006
	var_15_3[1] = var_1_10006("System.Int32")
	typeof = var_6
	var_15_3[2] = var_6("System.Int32")
	typeof = var_6
	var_15_3[3] = var_6("System.Int32")
	...
	Screen = var_7
	var_15_4[1] = var_7.width * 0.25
	Screen = var_7
	var_15_4[2] = var_7.height * 0.25

	local var_15_5 = var_15_0(var_15_1, var_15_2, var_15_3, var_15_4)

	ReflectionHelp = var_15_1

	local var_15_6 = var_15_1.RefCallStaticMethod
	...
	typeof = var_7
	var_15_9[1] = var_7("System.Int32")
	typeof = var_7
	var_15_9[2] = var_7("System.Int32")
	typeof = var_7
	var_15_9[3] = var_7("System.Int32")
	...
	Screen = var_8
	var_15_10[1] = var_8.width * 0.25
	Screen = var_8
	var_15_10[2] = var_8.height * 0.25

	local var_15_11 = var_15_6(var_15_7, var_15_8, var_15_9, var_15_10)

	ReflectionHelp = var_15_7

	local var_15_12 = var_15_7.RefGetField

	typeof = var_15_8
	var_15_5.filterMode = var_15_12(var_15_8("UnityEngine.FilterMode"), "Bilinear")

	local var_15_13 = arg_15_0
	local var_15_14 = arg_15_0.GetBlurMaterialSync(var_15_13)

	ReflectionHelp = var_15_13

	local var_15_15 = var_15_13.RefCallStaticMethod

	typeof = var_6

	local var_15_16 = var_6("UnityEngine.Graphics")
	local var_15_17 = "Blit"
	local var_15_18 = {}

	typeof = var_1_10009
	var_15_18[1] = var_1_10009("UnityEngine.RenderTexture")
	typeof = var_9
	var_15_18[2] = var_9("UnityEngine.RenderTexture")
	typeof = var_9
	var_15_18[3] = var_9("UnityEngine.Material")
	typeof = var_9
	var_15_18[4] = var_9("System.Int32")

	var_15_15(var_15_16, var_15_17, var_15_18, {
		arg_15_1,
		var_15_5,
		var_15_14,
		0
	...
	for iter_15_0 = 0, 1 do
		local var_15_19 = var_15_14
		local var_15_20 = var_15_14.SetVector
		local var_15_21 = "_Parameter"

		Vector4 = var_1_10012

		var_15_20(var_15_19, var_15_21, var_1_10012.New(1 + iter_15_0, -1 - iter_15_0, 0, 0))

		ReflectionHelp = var_15_20
		var_15_20 = var_15_20.RefCallStaticMethod
		typeof = var_15_19

		local var_15_22 = var_15_19("UnityEngine.Graphics")
		local var_15_23 = "Blit"

		var_1_10012 = {}
		typeof = var_13
		var_1_10012[1] = var_13("UnityEngine.RenderTexture")
		typeof = var_13
		var_1_10012[2] = var_13("UnityEngine.RenderTexture")
		typeof = var_13
		var_1_10012[3] = var_13("UnityEngine.Material")
		typeof = var_13
		var_1_10012[4] = var_13("System.Int32")

		var_15_20(var_15_22, var_15_23, var_1_10012, {
			var_15_5,
			var_15_11,
			var_15_14,
			1
		...
		local var_15_24 = var_15_22("UnityEngine.Graphics")
		local var_15_25 = "Blit"
		...
		var_15_20(var_15_24, var_15_25, var_1_10012, {
			var_15_11,
			var_15_5,
			var_15_14,
			2
	...
	local var_15_26 = var_5.RefCallStaticMethod

	typeof = var_6

	local var_15_27 = var_6("UnityEngine.RenderTexture")
	local var_15_28 = "ReleaseTemporary"
	local var_15_29 = {}

	typeof = var_15_20
	var_15_29[1] = var_15_20("UnityEngine.RenderTexture")

	var_15_26(var_15_27, var_15_28, var_15_29, {
		var_15_11
	})
...
function var_0_1.SetSpineUIOutline(arg_16_0, arg_16_1, arg_16_2)
	...
	GetComponent = var_16_0

	local var_16_2 = var_16_0(arg_16_1, "SkeletonGraphic")

	Material = var_5

	local var_16_3 = var_5.New(var_16_1)
