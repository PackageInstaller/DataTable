...
function var_0_1.InitCri(arg_8_0, arg_8_1)
	...
	var_8_1(var_8_0, var_1_10005(var_1_10006))
	...
	typeof = var_5
	CriWare = var_1_10006
	arg_8_0.criInitializer = var_8_3(var_8_2, var_5(var_1_10006.CriWareInitializer))
	...
	var_3.Init(var_8_5, function()
		...
		var_9_4(var_9_3, var_9_5, var_2_10004.CRI_CHANNEL_TYPE.SINGLE)
		...
		var_9_8(var_9_7, var_9_9, var_4.CRI_CHANNEL_TYPE.SINGLE)
		...
		var_9_12(var_9_11, var_9_13, var_4.CRI_CHANNEL_TYPE.MULTI_NOT_REPEAT)
		...
		typeof = var_2_10005
		CriAtomWaveAnalyzer = var_2_10006
		var_9_17.bgmWaveAnalyzer = var_3(var_9_18, var_2_10005(var_2_10006))
...
function var_0_1.StopBGM(arg_12_0)
	...
	var_12_1(var_12_0, var_1_10003.CRI_FADE_TYPE.FADE_INOUT)
...
function var_0_1.playCueSheetVoice(arg_14_0, arg_14_1, arg_14_2, arg_14_3, arg_14_4)
	...
	if arg_14_3 then
		...
		var_14_2(var_14_1, var_14_3, var_1_10008.CRI_FADE_TYPE.NONE, arg_14_1, function(arg_16_0)
			if arg_14_4 ~= nil then
				arg_14_4(arg_16_0)
			end
...
function var_0_1.StopPaintingBgm(arg_20_0, arg_20_1)
	if arg_20_0._paintingBgmSheetInfo and arg_20_0._paintingBgmSheetInfo[arg_20_1] then
		...
		var_20_1(var_20_0, var_20_2, var_1_10005.CRI_FADE_TYPE.FADE_INOUT)
...
function var_0_1.CheckFModeEvent(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	...
	var_1_10006.gsub(arg_27_1, "event:/cv/(.+)/(.+)", function(arg_28_0, arg_28_1)
		...
		local var_28_1 = var_3(var_4.CVBattleKey[var_28_0])

		tobool = var_4
		ShipWordHelper = var_5

		local var_28_2 = var_4(var_5.CVGiftKey[arg_28_1])
...
function var_0_1.PlayCV_V3(arg_45_0, arg_45_1, arg_45_2, arg_45_3)
	...
	var_45_1(var_45_0, var_45_2, var_1_10007.CRI_FADE_TYPE.NONE, arg_45_1, function(arg_46_0)
...
function var_0_1.CreateCvMultipleHandler(arg_47_0, arg_47_1, arg_47_2, arg_47_3)
	if not arg_47_0.luHandle then
		...
		var_1_10005 = var_4
		arg_47_0.luHandle = var_4.CreateListener(var_1_10005, arg_47_0.LateCvHandler, arg_47_0)
		LateUpdateBeat = var_4
		var_1_10005 = var_4

		var_4.AddListener(var_1_10005, arg_47_0.luHandle)
	end
...
function var_0_1.LateCvHandler(arg_48_0)
	...
	for iter_48_0, iter_48_1 in var_1_10001(arg_48_0.cvCacheDataList) do
		...
		if iter_48_0 == 1 then
			...
			CriWareMgr = var_1_10012

			var_1_10009(var_48_3, var_48_4, var_1_10012.CRI_FADE_TYPE.NONE, var_48_0, function(arg_49_0)
			...
			var_10(function()
				...
				CriWareMgr = var_2_10003

				var_50_1(var_50_0, var_50_2, var_2_10003.CRI_FADE_TYPE.FADE_CROSS, function(arg_51_0)
					if var_48_2 ~= nil then
						var_48_2(arg_51_0)
					end
...
function var_0_1.PlaySE_Loop(arg_57_0, arg_57_1, arg_57_2, arg_57_3)
	...
	var_57_2(var_57_1, var_57_3, var_1_10008.CRI_FADE_TYPE.FADE_INOUT, function(arg_58_0)
...
function var_0_1.StopSE_Loop(arg_59_0, arg_59_1, arg_59_2)
	...
	var_59_2(var_59_1, var_59_3, var_1_10007.CRI_FADE_TYPE.FADE_INOUT)
...
function var_0_1.getCVVolume(arg_63_0)
	...
	DEFAULT_CVVOLUME = var_1_10003

	return var_63_0(var_63_1, var_1_10003)
end
...
function var_0_1.getBGMVolume(arg_65_0)
	...
	DEFAULT_BGMVOLUME = var_1_10003

	return var_65_0(var_65_1, var_1_10003)
end
...
function var_0_1.getSEVolume(arg_68_0)
	...
	DEFAULT_SEVOLUME = var_1_10003

	return var_68_0(var_68_1, var_1_10003)
end
	...
	if var_2 then
		...
		if var_2 == var_1_10003 then
			...
			var_7.WebRequest(var_72_5, var_72_1, function(arg_75_0, arg_75_1)
				...
				var_3("content: " .. arg_75_1)

				originalPrint = var_3

				var_3("country is: " .. var_75_0)
				...
				var_75_1(var_75_2 .. var_5(arg_72_0.isDefaultBGM))
...
function var_0_1.getAtomSource(arg_77_0, arg_77_1)
	...
	return var_1_10002(var_1_10003.Find("CRIWARE/" .. arg_77_1), "CriAtomSource")
end
