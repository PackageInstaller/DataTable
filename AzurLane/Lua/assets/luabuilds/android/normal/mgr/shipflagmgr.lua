...
function var_0_1.Init(arg_1_0, arg_1_1)
	...
	arg_1_0.extraInfo = {}
	ipairs = var_2
	ShipStatus = var_1_10003

	for iter_1_0, iter_1_1 in var_2(var_1_10003.flagList) do
...
local var_0_2 = {
	inChapter = function()
		...
		if var_0.getActiveChapter(var_2_0) then
			...
			if not var_2_0.map(var_1:getShips(), function(arg_3_0)
				return arg_3_0.id
			end) then
				var_2_1 = {}
			end
	...
	inElite = function()
		...
		local var_5_2 = var_1_10002(var_1_10003)
		...
		for iter_5_0, iter_5_1 in var_3(var_5_1.mapEliteFleetCache) do
			...
			var_1_10009 = var_1_10008(var_1_10009.FormationToChapters[iter_5_0], {
				1
			}) and var_0.chapter_template[var_1_10008].map
			...
			if not var_0.expedition_data_by_map[var_1_10009].on_activity then
				var_5_3 = 0
			end
			...
			if var_5_3 ~= 0 then
				...
				if var_1_10011(var_5_2:getActivityById(var_5_3), {
					"isEnd"
				}) == false then
					var_1_10011 = {}
					ipairs = var_1_10012
					...
					var_5_4[1] = iter_5_1[var_1_10014.Normal]
					FleetType = var_1_10014
					var_5_4[2] = iter_5_1[var_1_10014.Submarine]
					...
					for iter_5_2, iter_5_3 in var_1_10012(var_5_4) do
						...
						for iter_5_4, iter_5_5 in var_1_10017(iter_5_3) do
							...
							local var_5_5 = var_1_10011

							TeamType = var_1_10024

							var_1_10022(var_5_5, iter_5_5[var_1_10024.FormShips])
						end
					end

					var_5_0[iter_5_0] = var_1_10011
				end
		...
		return var_5_6(var_4.values(var_5_0)), var_5_0
	end,
	inSupport = function()
		local var_6_0 = {}
		...
		local var_6_1 = var_1_10001(var_1_10002)

		getProxy = var_1_10002
		ActivityProxy = var_1_10003

		local var_6_2 = var_1_10002(var_1_10003)
		...
		for iter_6_0, iter_6_1 in var_3(var_6_1.mapEliteFleetCache) do
			checkExist = var_1_10008
			ChapterProxy = var_1_10009
			var_1_10009 = var_1_10008(var_1_10009.FormationToChapters[iter_6_0], {
				1
			}) and var_0.chapter_template[var_1_10008].map
			...
			if var_6_3 ~= 0 then
				...
				if var_1_10011(var_6_2.getActivityById(var_1_10013, var_6_3), {
					"isEnd"
				}) == false then
					var_1_10011 = {}
					ipairs = var_1_10012
					...
					for iter_6_2, iter_6_3 in var_1_10012(iter_6_1[var_1_10013.Support]) do
						table = var_1_10017
						var_1_10017 = var_1_10017.insertto

						local var_6_4 = var_1_10011

						TeamType = var_1_10019

						var_1_10017(var_6_4, iter_6_3[var_1_10019.FormShips])
					end

					var_6_0[iter_6_0] = var_1_10011
				end
		...
		return var_6_5(var_4.values(var_6_0)), var_6_0
	end,
	inActivity = function()
		local var_7_0 = {}
		...
		local var_7_1 = var_1_10001(var_1_10002)
		...
		for iter_7_0, iter_7_1 in var_1_10002(var_7_1:getActivityFleets()) do
			...
			_ = var_1_10008
			var_1_10008 = var_1_10008.map
			_ = var_1_10009
			var_7_0[iter_7_0] = var_1_10007(var_1_10008(var_1_10009.values(iter_7_1), function(arg_8_0)
		...
		return var_7_2(var_3.values(var_7_0)), var_7_0
	end,
	inPvP = function()
		getProxy = var_1_10000
		FleetProxy = var_1_10001
		...
		if not var_9_1(var_9_0, var_1_10003.PVP_FLEET_ID) or not var_1:getShipIds() then
			var_9_2 = {}
		end
	...
	inChallenge = function()
		...
		local var_10_2 = var_10_1(var_10_0, var_1_10003.CHALLENGE_FLEET_ID)
		local var_10_3 = var_0
		local var_10_4 = var_0.getFleetById

		FleetProxy = var_1_10004

		local var_10_5 = var_10_4(var_10_3, var_1_10004.CHALLENGE_SUB_FLEET_ID)
		local var_10_6 = var_10_2
		local var_10_7 = var_10_2.getShipIds(var_10_6)

		table = var_10_6

		var_10_6.insertto(var_10_7, var_10_5:getShipIds())

		return var_10_7
	end,
	inExercise = function()
		getProxy = var_1_10000
		MilitaryExerciseProxy = var_1_10001
	...
	inTactics = function()
		...
		local var_14_2 = var_14_0.map

		underscore = var_1_10003

		return var_14_2(var_1_10003.values(var_14_1), function(arg_15_0)
			return arg_15_0 and arg_15_0.shipId
		end)
	end,
	inBackyard = function()
		getProxy = var_1_10000
		DormProxy = var_1_10001
	...
	isActivityNpc = function()
		...
		return var_1_10000(var_1_10001).activityNPCShipIds
	end,
	...
	if var_4(arg_24_3) == "boolean" then
		...
		if var_24_0(arg_24_3) == "number" then
			if arg_24_2 == "inElite" then
				...
				return var_5.any(var_24_1, function(arg_25_0)
			...
			elseif arg_24_2 == "inActivity" then
				...
				return var_5.any(var_24_1, function(arg_26_0)
			...
			elseif arg_24_2 == "inSupport" then
				...
				return var_5.any(var_24_1, function(arg_27_0)
...
function var_0_1.FilterShips(arg_28_0, arg_28_1, arg_28_2)
	if not arg_28_2 then
		...
		arg_28_2 = var_28_0(var_1_10004.getRawData(var_28_1))
	end
...
function var_0_1.DebugPrint(arg_31_0, arg_31_1)
	...
	for iter_31_0, iter_31_1 in var_1_10002(var_3.flagList) do
