-- chunkname: @IQIGame\\UIExternalApi\\FlightGameBossRankRewardUIApi.lua

FlightGameBossRankRewardUIApi = BaseLangApi:Extend()

function FlightGameBossRankRewardUIApi:Init()
...
function FlightGameBossRankRewardUIApi:GetMazeBossRankIconPath(rank, mySelf, type)
	if type == 1 then
		if rank < 11 then
...
function FlightGameBossRankRewardUIApi:GetTextRewardIndex(num1, num2, type)
...
function FlightGameBossRankRewardUIApi:GetRankRewardIconPath(num1, num2, type)
	if type == 1 then
		if num1 == 4 then
			return self:GetResUrl(2700101)
		elseif num1 == 11 then
...
FlightGameBossRankRewardUIApi:Init()
