-- chunkname: @IQIGame\\UIExternalApi\\RestaurantOperationBossRankRewardUIApi.lua

RestaurantOperationBossRankRewardUIApi = BaseLangApi:Extend()

function RestaurantOperationBossRankRewardUIApi:Init()
...
function RestaurantOperationBossRankRewardUIApi:GetMazeBossRankIconPath(rank, mySelf, type)
	if type == 1 then
		if rank < 11 then
...
function RestaurantOperationBossRankRewardUIApi:GetTextRewardIndex(num1, num2, type)
...
function RestaurantOperationBossRankRewardUIApi:GetRankRewardIconPath(num1, num2, type)
	if type == 1 then
		if num1 == 4 then
			return self:GetResUrl(2700101)
		elseif num1 == 11 then
...
RestaurantOperationBossRankRewardUIApi:Init()
