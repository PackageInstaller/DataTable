-- chunkname: @IQIGame\\UI\\Guild\\GuildTraining\\GuildTrainingTotalPointReward\\GuildTrainingTotalPointRewardRender.lua
...
function m:UpdateView()
	if self.cfgData then
		UGUIUtil.SetText(self.TextScore, self.cfgData.PointsLowerLimit)
