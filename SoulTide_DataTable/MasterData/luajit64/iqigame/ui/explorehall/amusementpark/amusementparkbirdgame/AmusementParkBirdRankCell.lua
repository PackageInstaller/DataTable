-- chunkname: @IQIGame\\UI\\ExploreHall\\AmusementPark\\AmusementParkBirdGame\\AmusementParkBirdRankCell.lua
...
function m:SetMyData(ranking, hurt, customData, rankType)
	...
	UGUIUtil.SetText(self.RankingText, AmusementParkGameFlappyBirdRankUIApi:GetString("ChallengeRankStr", ranking, true, rankType))
	UGUIUtil.SetText(self.PlayerNameText, AmusementParkGameFlappyBirdRankUIApi:GetString("PlayerNameText", PlayerModule.PlayerInfo.baseInfo.pName))

	local tab = string.split(customData, ",")

	UGUIUtil.SetText(self.GameLv, AmusementParkGameFlappyBirdRankUIApi:GetString("GameLv", tab[1] or "", true))
	UGUIUtil.SetText(self.ScoreText, AmusementParkGameFlappyBirdRankUIApi:GetString("ChallengeRankHurt", tab[2] or "", true))
end
