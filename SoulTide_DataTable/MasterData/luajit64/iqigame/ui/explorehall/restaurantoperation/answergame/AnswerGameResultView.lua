-- chunkname: @IQIGame\\UI\\ExploreHall\\RestaurantOperation\\AnswerGame\\AnswerGameResultView.lua
...
function m:UpdateView()
	UGUIUtil.SetText(self.TextRightNum, ROAnswerGameModule.answerQuestionData.questionPOD.rightNumber)

	self.rewards = {}

	local cfgData = ROAnswerGameModule.cfgAnswerControlData

	for i = 1, #cfgData.Reward, 2 do
		local data = {}

		data.cid = cfgData.Reward[i]
		data.num = cfgData.Reward[i + 1] * ROAnswerGameModule.answerQuestionData.questionPOD.rightNumber
