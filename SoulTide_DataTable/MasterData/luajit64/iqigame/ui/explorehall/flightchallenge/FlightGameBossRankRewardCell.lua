-- chunkname: @IQIGame\\UI\\ExploreHall\\FlightChallenge\\FlightGameBossRankRewardCell.lua
...
function m:Update(index)
	...
	UGUIUtil.SetText(self.RankingText, FlightGameBossRankRewardUIApi:GetString("TextRewardIndex", self.cfgReward.RankLowerLimit, self.cfgReward.RankUpperLimit, self.cfgReward.RankType))

	if not isShowImgNum then
		local path = FlightGameBossRankRewardUIApi:GetString("RankRewardIconPath", self.cfgReward.RankLowerLimit, self.cfgReward.RankUpperLimit, self.cfgReward.RankType)
