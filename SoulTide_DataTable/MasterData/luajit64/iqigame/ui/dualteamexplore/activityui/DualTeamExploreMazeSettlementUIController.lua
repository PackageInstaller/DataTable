-- chunkname: @IQIGame\\UI\\DualTeamExplore\\ActivityUI\\DualTeamExploreMazeSettlementUIController.lua

local MazeRewardCell = require("IQIGame.UI.MazeDetail.MazeRewardCell")
local DualTeamExploreMazeSettlementUIController = {}

function DualTeamExploreMazeSettlementUIController.New(uiController)
	local obj = Clone(DualTeamExploreMazeSettlementUIController)
...
function DualTeamExploreMazeSettlementUIController:__Init(uiController)
	self.UIController = uiController
end

function DualTeamExploreMazeSettlementUIController:InitView(view)
	self.View = view

	LuaCodeInterface.BindOutlet(self.View, self)
end

function DualTeamExploreMazeSettlementUIController:OnInit()
...
function DualTeamExploreMazeSettlementUIController:GetPreloadAssetPaths()
	return {
		UIGlobalApi.GetItemCellAssetPath()
	}
end

function DualTeamExploreMazeSettlementUIController:GetOpenPreloadAssetPaths(userData)
	return nil
end

function DualTeamExploreMazeSettlementUIController:IsManualShowOnOpen(userData)
	return false
end

function DualTeamExploreMazeSettlementUIController:GetBGM(userData)
	return nil
end

function DualTeamExploreMazeSettlementUIController:OnOpen(userData)
	self:OnShow()
end

function DualTeamExploreMazeSettlementUIController:OnClose(userData)
	return
end

function DualTeamExploreMazeSettlementUIController:OnAddListeners()
	self.ConfirmBtn:GetComponent("Button").onClick:AddListener(self.DelegateOnQuitMaze)
end

function DualTeamExploreMazeSettlementUIController:OnRemoveListeners()
	self.ConfirmBtn:GetComponent("Button").onClick:RemoveListener(self.DelegateOnQuitMaze)
end

function DualTeamExploreMazeSettlementUIController:OnPause()
	return
end

function DualTeamExploreMazeSettlementUIController:OnResume()
	return
end

function DualTeamExploreMazeSettlementUIController:OnCover()
	return
end

function DualTeamExploreMazeSettlementUIController:OnReveal()
	return
end

function DualTeamExploreMazeSettlementUIController:OnRefocus(userData)
	return
end

function DualTeamExploreMazeSettlementUIController:OnUpdate(elapseSeconds, realElapseSeconds)
	return
end

function DualTeamExploreMazeSettlementUIController:OnDepthChanged(uiGroupDepth, depthInUIGroup)
	return
end

function DualTeamExploreMazeSettlementUIController:OnLoadSucceed(assetName, asset, duration, userData)
	return
end

function DualTeamExploreMazeSettlementUIController:OnLoadFailed(assetName, status, errorMessage, userData)
	return
end

function DualTeamExploreMazeSettlementUIController:OnDestroy()
...
function DualTeamExploreMazeSettlementUIController:OnQuitMaze()
	UIModule.CloseSelf(self)
	MazeModule.ExitMaze(function()
		DualTeamExploreModule.MazeBackToLevel()
	end)
end

function DualTeamExploreMazeSettlementUIController:Clear()
	self.NoItemNoticeText:SetActive(false)
end

function DualTeamExploreMazeSettlementUIController:OnShow()
	self:Clear()
...
function DualTeamExploreMazeSettlementUIController:ShowItems()
	local normalItems = {}
...
return DualTeamExploreMazeSettlementUIController
