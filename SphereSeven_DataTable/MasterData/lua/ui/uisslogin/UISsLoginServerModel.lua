...
--- Created by daiyi.
--- DateTime: 2019/3/21 21:01
---

local UISsLoginServerModel = BaseClass("UISsLoginServerModel", UIBaseModel)
...
UISsLoginServerModel.OnCreate = OnCreate
UISsLoginServerModel.OnEnable = OnEnable
UISsLoginServerModel.OnRefresh = OnRefresh
UISsLoginServerModel.OnAddListener = OnAddListener
UISsLoginServerModel.OnRemoveListener = OnRemoveListener
UISsLoginServerModel.OnDisable = OnDisable
UISsLoginServerModel.OnDestroy = OnDestroy

return UISsLoginServerModel