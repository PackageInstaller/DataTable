...
local UIStarKingShopModel = BaseClass("UIStarKingShopModel",UIBaseModel)
local base = UIBaseModel
local this = UIStarKingShopModel;
...
function this.OnRefresh(self)
    self.paid_num = Game.Scene.Player.EmperorStarPoint;
    if self.shop_data == nil then
        self.shop_data = {};
        for k,v in table.pairsByKeys(Z_Store) do
            if v.StoreType == StoreType.Shard then 
