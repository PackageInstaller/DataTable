...
local BattleDataManager = BaseClass("BattleDataManager", Singleton);
...
BattleDataManager.__init = __init
BattleDataManager.__delete = __delete
BattleDataManager.AddListener = AddListener
BattleDataManager.Broadcast = Broadcast
BattleDataManager.RemoveListener = RemoveListener
