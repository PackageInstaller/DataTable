...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = HitBack; PlaySkillCostFeatureStepPoint; PlayAudio,audioID = 5073,audioType=1; PlayCasterBindEffect,effectID=761; Wait,waitTime=3000; "
    }
  },
  {
    2,
