...
local config = {
  ...
  },
  {
    ...
    550,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=888403341,label=doAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  },
  {
    4,
    ...
    560,
    {
      "PlaySummonTrap,trapID=11180311; "
    }
  }
}
