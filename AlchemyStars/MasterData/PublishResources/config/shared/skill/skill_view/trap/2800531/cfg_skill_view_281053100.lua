...
local config = {
  ...
  },
  {
    ...
    200,
    {
      " PlayCasterBindEffect,effectID=3357; DataSelectDamage,damageIndex=1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; "
    }
  },
  {
    4,
  ...
  },
  {
    ...
    0,
    {
      " PlayTargetAddBuff,buffID=28005311; PlayTargetAddBuff,buffID=28005312; PlayTargetAddBuff,buffID=30181; "
    }
  }
}
