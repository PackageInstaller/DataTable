...
local config = {
  {
    ...
    0,
    {
      " PlayCasterLegacyAnimation,animNames=eff_2800221_huode; PlayAudio,audioID = 8000,audioType=1; PauseMove, matchers=MonsterID|PetPstID, moveAnim=1; Wait,waitTime=100; ResumeMove, matchers=MonsterID|PetPstID, moveAnim=1; "
    }
  },
  {
    2,
