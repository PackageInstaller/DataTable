...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayAudio,audioID = 160233103,audioType=1; PlayCasterAnimation,animName = AtkUlt; PlayTurnToPickUpPosDirection,pickUpIndex=1; PlayCasterBindEffect,effectID =160233103; Wait,waitTime=10500; "
    }
  },
  {
    3,
    ...
    1600,
    {
      " PlayEffectAtPickUpIndexGrid,effectID=160233104,pickUpIndex=1; "
    }
  },
  {
    4,
