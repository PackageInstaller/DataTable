...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayAudio,audioID = 2673,audioType=1; PlayCasterBindEffect,effectID=160207104; PlayCasterBindEffect,effectID=160207105; PlayCasterSubMaterialAnim,nodeName=1602071_body02,animName=effanim_1602071_atkult; PlayCasterAnimation,animName=AtkUlt; Wait,waitTime=1800; "
    }
  },
  {
    3,
