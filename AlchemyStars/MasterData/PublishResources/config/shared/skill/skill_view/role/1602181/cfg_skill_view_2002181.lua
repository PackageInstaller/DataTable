...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName=AtkChain; PlayAudio,audioID = 160218102,audioType=1; PlayCasterBindEffect,effectID =160218103; PlayCasterBindEffect,effectID =160218104; Wait,waitTime=5000; "
    }
  },
  {
    2,
