...
local config = {
  ...
  },
  {
    ...
    2000,
    {
      " DataSelectResult,effectType=11,index=1,damageStageIndex=1; Jump,condition=CheckEffectResultIndex,param=11,goto=phaseEnd; DataSelectResult,effectType=11,index=1; PlaySummonTrap,trapID=16014511; Wait,waitTime=500; "
    }
  }
}
