...
local config = {
  ...
  },
  {
    ...
    1000,
    {
      " DataSelectDamage,damageIndex = 1; PlayTargetBeHitEffect,hitEffectID=160153103,hitEffectIDBodyAreaMoreThanOne=160153104,label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; "
    }
  },
  {
    3,
