...
local config = {
  ...
  },
  {
    ...
    1700,
    {
      " DataSelectBuff,buffIndex=1; Jump,condition=CheckBuffIndexValid,result=0,goto=phaseEnd; PlayTargetAddBuff,buffID=3002040,label=buffAgain; PlayTargetAddBuff,buffID=3062041; PlayTargetAddBuff,buffID=3002042; PlayTargetAddBuff,buffID=3502041; PlayTargetAddBuff,buffID=3532041; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=buffAgain; "
    }
  },
  {
    5,
