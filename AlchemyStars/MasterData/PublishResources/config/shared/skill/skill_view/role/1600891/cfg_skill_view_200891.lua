...
local config = {
  {
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=1665; PlayCasterAnimation,animName=AtkChain; PlayAudio,audioID = 3115,audioType=1; Wait,waitTime=5800; "
    }
  },
  {
    2,
