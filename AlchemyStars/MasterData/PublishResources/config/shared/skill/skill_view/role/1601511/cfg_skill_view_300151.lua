...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=3548; PlayCasterBindEffect,effectID=3555; PlayCasterAnimation,animName=AtkUlt; PlayAudio,audioID = 2454,audioType=1; Wait,waitTime=1900; PlayEffectAtPickUpIndexGrid,effectID=3550,pickUpIndex=1; DataSelectDamage,damageIndex = 1; DataSelectDamageInfo,damageInfoIndex=1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0, label=doAgain; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=doAgain; "
    }
  }
}
