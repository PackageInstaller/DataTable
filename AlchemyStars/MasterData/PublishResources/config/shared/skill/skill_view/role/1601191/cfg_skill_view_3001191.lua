...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayTurnToPickUpPosDirection,pickUpIndex=1,waitTime=0; PlayCasterAnimation,animName = AtkUlt; PlayCasterBindEffect,effectID = 3000; PlayCasterBindEffect,effectID = 3001; PlayCasterBindEffect,effectID = 3002; PlayCasterBindEffect,effectID = 160119402; PlayCameraEffect,effectID = 3003; Wait,waitTime=6400; "
    }
  },
  {
    3,
