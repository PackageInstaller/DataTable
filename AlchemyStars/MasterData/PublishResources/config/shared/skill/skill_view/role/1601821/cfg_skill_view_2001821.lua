...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2589,audioType=1; PlayCasterBindEffect,effectID=160182103; PlayCasterBindEffect,effectID=160182105; PlayCasterMaterialAnim,animName=eff_1601821_chain1_mat; Wait,waitTime = 800; DataSelectDamage,damageIndex = 1; PlayTargetBeHitEffect,hitEffectID=160182104,label=hitAgain; Wait,waitTime=50; DataSelectNextDamage; Jump,condition=CheckDamageIndexValid,goto=hitAgain; "
    }
  },
  {
    2,
