...
local config = {
  ...
  },
  {
    ...
    3700,
    {
      " PlayConvertFlyTrajectorySummonTrap, flyEffectID=3798, fireTimeMin=0, fireTimeMax=700, flyTime=1000, flyRandomDis=8, flyRandomPointCount=3, targetHitOffsetMin=0, targetHitOffsetMax=0.1, fireEffectID=3799, disableRoot=1501651_daodan, destroyBulletDelay=1000, convertEffectID=3806, hitSoundID=2506, summonTrap=1, needLookAt=1, firstPosX=0, firstPosY=1, firstPosZ=0, firstPosRandom=0.5, offsetPosX=0, offsetPosY=1.5, offsetPosZ=-0.035; Wait,waitTime=300; "
    }
  }
}
