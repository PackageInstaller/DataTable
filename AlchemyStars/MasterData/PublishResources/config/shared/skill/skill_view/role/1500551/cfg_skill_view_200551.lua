...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2354,audioType=1; PlayCasterBindEffect,effectID=3074; Wait,waitTime=1100; PlayCasterBindEffect,effectID=3075; "
    }
  },
  {
    2,
