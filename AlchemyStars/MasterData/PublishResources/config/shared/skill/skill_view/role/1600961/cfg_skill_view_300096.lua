...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkUlt; PlayCasterBindEffect,effectID=2383; PlayCasterBindEffect,effectID=2385; PlayAudio,audioID = 2267,audioType=1; Wait,waitTime=5000; "
    }
  },
  {
    3,
