...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2308,audioType=1; PlayCasterBindEffect,effectID=2797; Wait,waitTime=4800; "
    }
  },
  {
    2,
