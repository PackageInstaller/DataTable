...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayCasterBindEffect,effectID = 3721; PlayCasterBindEffect,effectID = 3722; PlayAudio,audioID = 2485,audioType=1; Wait,waitTime = 2000; "
    },
    {"", "1,0"}
  },
  {
