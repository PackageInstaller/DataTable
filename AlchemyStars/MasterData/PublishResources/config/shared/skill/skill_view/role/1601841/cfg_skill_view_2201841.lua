...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayAudio,audioID = 2593,audioType=1; PlayCasterBindEffect,effectID=160184103; Wait,waitTime=2600; PlaySummonTrap,trapID=14; "
    }
  },
  {
    2,
