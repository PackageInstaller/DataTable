...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " DataSelectLastDamage; Jump,condition=CheckDamageIndexValid,result=0,goto=phaseEnd; Wait,waitTime=267; PlayAudio,audioID = 2153; PlayCasterTurnToTarget; PlayCasterAnimation,animName = AtkUlt03; Wait,waitTime=233; PlayCasterBindRotationToTargetEffect,offsetx=0,offsety=1.688,offsetz=0.511,effectID=467; Wait,waitTime=500; PlayFlyEffectCasterToTarget,flyEffectID = 465,flyTime = 100,offsetx=0,offsety=1.688,offsetz=0.511,flyTrace = 3; Wait,waitTime=0; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=468,turnToTarget=1,deathClear=0; "
    }
  }
}
