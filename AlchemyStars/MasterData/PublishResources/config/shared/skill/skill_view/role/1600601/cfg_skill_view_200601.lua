...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkChain; PlayCasterBindEffect,effectID =1781; PlayCasterBindEffect,effectID =1782; PlayCasterBindEffect,effectID =1783; PlayAudio,audioID = 3111; "
    }
  },
  {
    2,
