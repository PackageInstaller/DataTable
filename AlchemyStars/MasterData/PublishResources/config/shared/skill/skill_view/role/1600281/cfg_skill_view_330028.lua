...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkUlt; PlayCasterBindEffect,effectID=1854; PlayCasterBindEffect,effectID=1855; PlayCasterBindEffect,effectID=1858; Wait,waitTime=800; PlayCasterVisible,visible=0; Wait,waitTime = 2500; PlayCasterVisible,visible=1; PlayCasterAnimation,animName = AtkUlt1; PlayCasterBindEffect,effectID=1861; Wait,waitTime = 1800; PlayDisplayAddHP; "
    }
  },
  {
    3,
