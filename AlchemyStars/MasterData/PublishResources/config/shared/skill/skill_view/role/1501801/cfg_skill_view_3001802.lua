...
local config = {
  ...
  },
  {
    ...
    1500,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=4101802,label=doAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  },
  {
    5,
    ...
    1501,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=4301801,label=doAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  }
}
