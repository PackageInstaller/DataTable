...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = AtkUlt; PlayCameraEffect,effectID=160211107; PlayCasterBindEffect,effectID=160211106; PlayAudio,audioID = 160211103,audioType=1; Wait,waitTime=5000; "
    }
  },
  {
    3,
