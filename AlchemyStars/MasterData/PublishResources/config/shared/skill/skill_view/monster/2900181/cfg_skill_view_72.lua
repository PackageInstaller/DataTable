...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = Skill01; PlayCasterBindEffect,effectID=865; PlayCasterBindEffect,effectID=866; PlayCasterTurnToTarget; PlayAudio,audioID = 5049; Wait,waitTime=1250; "
    }
  },
  {
    2,
