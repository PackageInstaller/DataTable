...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName=Atk2; PlayCasterBindEffect,effectID =291030101; PlayCasterVisible,visible=1; PlayCasterMaterialAnim,animName=eff_2910301_skill02_shadow_in; PlayAudio,audioID=6275,audioType=1; Wait,waitTime=1200; "
    }
  },
  {
    2,
