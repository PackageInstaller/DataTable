...
local config = {
  ...
  },
  {
    ...
    2000,
    {
      " PlaySummonMonsterBySummonEveryThing,monsterID=2002401,interval=0; "
    }
  },
  {
    4,
    ...
    0,
    {
      " PlayCasterBindEffect,effectID =290500105; PlayCasterBindEffect,effectID =290500106; PlayCasterAnimation,animName=skill01; Wait,waitTime=2000; PlayStageTeleport,type=3, onlySelf=1,stageIndex=3; PlayCasterControlGridDown,enable=0; "
    }
  },
  {
    5,
