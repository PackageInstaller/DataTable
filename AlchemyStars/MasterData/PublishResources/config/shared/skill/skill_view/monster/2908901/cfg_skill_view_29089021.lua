...
local config = {
  {
    ...
    0,
    {
      " PlayCasterTurnToRoundBeginPlayerPos; PlayCasterAnimation,animName=Skill01; PlayCasterBindEffect,effectID =290890106; PlayAudio,audioID = 290890104,audioType=1; Wait,waitTime=1200; Wait,waitTime=1000; "
    }
  },
  {
    2,
