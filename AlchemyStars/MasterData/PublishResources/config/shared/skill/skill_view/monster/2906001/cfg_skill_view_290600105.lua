...
local config = {
  ...
  },
  {
    ...
    0,
    {
      "PlayCasterBindEffect,effectID=290600101; PlayCasterAnimation,animName =skill03; DataSelectResult,effectType=5,index=1,damageStageIndex=2; PlayTargetAddBuff,buffID=290600103,label=go2; DataSelectNextResult,effectType=5; Jump,condition=CheckEffectResultIndex,param=5,goto=go2; Wait,waitTime=1000; "
    }
  }
}
