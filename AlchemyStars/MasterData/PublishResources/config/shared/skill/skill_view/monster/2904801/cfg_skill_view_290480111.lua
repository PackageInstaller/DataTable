...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterBindEffect,effectID=582; PlayCasterAnimation,animName=Skill02_down; Wait,waitTime=1830; PlaySummonTrap,trapID=400; PlayRoleTeleport,type=3, onlySelf=1; PlayRoleTeleport,type=5, onlySelf=1; PlayEffectAtCasterPos,effectID=583; Wait,waitTime=1000; PlayRoleTeleport,type=6, onlySelf=1; PlayCasterAnimation,animName=Skill02_up; PlayCasterBindEffect,effectID=578; "
    }
  },
  {
    3,
