...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = Skill02; PlayAudio,audioID = 6016,audioType=1; PlayCasterBindEffect,effectID=PARAM.Skill02EffectId; DataSelectDamage,damageIndex = 1; Wait,waitTime=2200; DataSelectDamage,damageIndex = 1; PlayCommonBeHit,hitAnimName=Hit,hitEffectID=0,turnToTarget=1,deathClear=0;PlayTargetAddBuff,buffID=50001; PlayTargetAddBuff,buffID=50002; PlayCasterBindEffect,effectID=PARAM.Idle1EffectId; PlayCasterBindEffect,effectID=PARAM.Idle2EffectId; Wait,waitTime=1400; "
    }
  }
}
