...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " PlaySummonOnFixPosLimit,isDestroy=1; DataSelectSummonOnFixPos,index=1; PlayCasterTurnToTargetGrid,label=redoShow; PlayCasterAnimation,animName=Skill03; PlayCasterBindEffect,effectID=3283; PlayAudio,audioID=6142,audioType=1; Wait,waitTime=1000; PlayFlyEffectCasterToTarget,flyEffectID=3283,flyTime=600,flyTrace=1,originalBoneName=Bip001 L Hand,isBlock=1; PlayAudio,audioID=6143,audioType=1; PlayEffectAtTargetGrid,effectID=3284; Wait,waitTime=500; PlaySummonOnFixPosLimit,isDestroy=0; DataSelectNextSummonOnFixPos; Jump,condition=CheckSummonOnFixPosValid,goto=redoShow; "
    }
  },
  {
    3,
