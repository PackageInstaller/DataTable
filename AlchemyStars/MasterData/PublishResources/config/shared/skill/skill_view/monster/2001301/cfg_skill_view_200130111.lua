...
local config = {
  ...
  },
  {
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=20013014,label=doAgain1; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain1; "
    }
  },
  {
    5,
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffID=20013013,label=doAgain; DataSelectNextBuff; Jump,condition=CheckBuffIndexValid,goto=doAgain; "
    }
  }
}
