...
local config = {
  {
    ...
    0,
    {
      " PlayCasterAnimation,animName = Skill01; PlayCasterBindEffect,effectID=855; PlayCasterBindEffect,effectID=856; PlayCasterTurnToTarget; PlayAudio,audioID = 5047; Wait,waitTime=800; "
    }
  },
  {
    2,
