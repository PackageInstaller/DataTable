...
local config = {
  ...
  },
  {
    ...
    1800,
    {
      " PlayCasterControlGridDown,enable=0; PlayCasterControlOutLine,enable=0; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID4,gridPosX=3,gridPosY=3,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID4,gridPosX=4,gridPosY=4,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID4,gridPosX=5,gridPosY=5,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID4,gridPosX=6,gridPosY=6,gridDirX=0,gridDirY=-1; Wait,waitTime=100; PlayEffectAGridPos,effectID=PARAM.effectID4,gridPosX=7,gridPosY=7,gridDirX=0,gridDirY=-1; Wait,waitTime=100; Wait,waitTime=100; "
    }
  },
  {
    3,
  ...
  },
  {
    ...
    0,
    {
      " DataSelectBuff,buffIndex=1; PlayTargetAddBuff,buffEffectType=10014; "
    }
  }
}
