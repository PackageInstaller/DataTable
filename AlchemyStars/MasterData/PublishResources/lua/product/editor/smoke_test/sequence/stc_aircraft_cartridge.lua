__TestCaseSequence_AircraftCartridge = {
  [1] = {
  ...
  [2] = {
    Type = "Cartridge_CheatGetCartridgeItem",
    Next = {5},
    Data = {}
  },
  [3] = {
...
return __TestCaseSequence_AircraftCartridge
