__TestCaseSequence_Tower_Elemental = {
  [1] = {
  ...
  [176] = {
    Type = "Tower_BattleCheat_SuperAurorian",
    Next = {180}
  },
  [180] = {
...
return __TestCaseSequence_Tower_Elemental
