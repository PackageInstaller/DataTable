__TestCaseSequence_ElementalSeason = {
  [1] = {
  ...
  [30] = {
    Type = "Season_GM_PassCampMission",
    Next = {31}
  },
  [31] = {
    Type = "Season_GM_SeasonSetProcess",
    Next = {40}
  },
  [40] = {
    Type = "GM_AddResource",
...
return __TestCaseSequence_ElementalSeason
