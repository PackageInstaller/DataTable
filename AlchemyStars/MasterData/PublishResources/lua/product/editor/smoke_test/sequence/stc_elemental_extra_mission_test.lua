__TestCaseSequence_ExtraMisson_Elemental = {
  [1] = {
  ...
  [3] = {
    Type = "ExtraMission_GM_PassAll",
    Next = {4}
  },
  [4] = {
    Type = "ExtraMission_RequestSummary",
    Next = {5}
  },
  [5] = {
...
return __TestCaseSequence_ExtraMisson_Elemental
