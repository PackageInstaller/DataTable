_class("SeasonMazeSceneLayerFogMask", SeasonMazeSceneLayerBase)
SeasonMazeSceneLayerFogMask = SeasonMazeSceneLayerFogMask

function SeasonMazeSceneLayerFogMask:Constructor(sceneRoot)
...
function SeasonMazeSceneLayerFogMask:Dispose()
  SeasonMazeSceneLayerFogMask.super.Dispose(self)
...
function SeasonMazeSceneLayerFogMask:UnLock(zoneMask, zoneID2Animation)
...
function SeasonMazeSceneLayerFogMask:_CacheHighBuildingRenderer()
...
function SeasonMazeSceneLayerFogMask:_InsertMagFog(trans)
...
function SeasonMazeSceneLayerFogMask:HideEffect(zoneid)
