_class("UIActivityCN18N47CommonComponentEnterLock", UICustomWidget)
UIActivityCN18N47CommonComponentEnterLock = UIActivityCN18N47CommonComponentEnterLock
...
function UIActivityCN18N47CommonComponentEnterLock:OnShow()
  self:_AttachEvents()
  self._isOpen = true
end

function UIActivityCN18N47CommonComponentEnterLock:OnHide()
  self:_DetachEvents()
  self._isOpen = false
  self._timeEvent = UIActivityHelper.CancelTimerEvent(self._timeEvent)
end

function UIActivityCN18N47CommonComponentEnterLock:SetNew(widgetName, checkNewFunc)
  self._widgetName_New = widgetName
  self._checkNewFunc = checkNewFunc
end

function UIActivityCN18N47CommonComponentEnterLock:SetRed(widgetName, checkRedFunc)
  self._widgetName_Red = widgetName
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN18N47CommonComponentEnterLock:SetRedCount(widgetName, widgetNameText, checkRedFunc)
  self._widgetName_RedCount = widgetName
  self._widgetName_RedCountText = widgetNameText
  self._checkRedFunc = checkRedFunc
end

function UIActivityCN18N47CommonComponentEnterLock:SetNew_RedDotModule(widgetName, newdotType)
  self._widgetName_New = widgetName
  self._newdotType = newdotType
end

function UIActivityCN18N47CommonComponentEnterLock:SetRed_RedDotModule(widgetName, reddotType)
  self._widgetName_Red = widgetName
  self._reddotType = reddotType
end

function UIActivityCN18N47CommonComponentEnterLock:SetLockStateCallback(lockWithTimeCallback, lockCallback, closedCallback)
  self._lockWithTimeCallback = lockWithTimeCallback
  self._lockCallback = lockCallback
  self._closedCallback = closedCallback
end

function UIActivityCN18N47CommonComponentEnterLock:SetActivityCommonRemainingTime(widgetName, descId, endTime, customTimeStr, tickCallback, stopCallback)
...
function UIActivityCN18N47CommonComponentEnterLock:SetWidgetNameGroup(widgetNameGroup)
  self._stateObj = UIWidgetHelper.GetObjGroupByWidgetName(self, widgetNameGroup)
end

function UIActivityCN18N47CommonComponentEnterLock:SetData(campaign, componentId, uiCallback)
...
function UIActivityCN18N47CommonComponentEnterLock:_SetTimerForUpdate()
...
function UIActivityCN18N47CommonComponentEnterLock:_Refresh()
...
function UIActivityCN18N47CommonComponentEnterLock:_CheckState()
  local component = self._component
  if not component then
    Log.info("UIActivityCN18N47CommonComponentEnterLock:_CheckState() component == nil")
...
function UIActivityCN18N47CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()
  local lockName = "UIActivityCN18N47CommonComponentEnterLock:_ReloadCampaignInfo_ChangeState()"
  self:Lock(lockName)
...
function UIActivityCN18N47CommonComponentEnterLock:_ChangeState()
  local state = self:_CheckState()
...
function UIActivityCN18N47CommonComponentEnterLock:GetBtnGameObject()
...
function UIActivityCN18N47CommonComponentEnterLock:BtnOnClick()
  Log.info("UIActivityCN18N47CommonComponentEnterLock:BtnOnClick")
...
function UIActivityCN18N47CommonComponentEnterLock:_AttachEvents()
  self:AttachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:AttachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN18N47CommonComponentEnterLock:_DetachEvents()
  self:DetachEvent(GameEventType.CampaignComponentStepChange, self._OnComponentStepChange)
  self:DetachEvent(GameEventType.QuestUpdate, self._OnQuestUpdate)
end

function UIActivityCN18N47CommonComponentEnterLock:_OnComponentStepChange(campaign_id, component_id, component_step)
  if self._campaign and self._campaign._id == campaign_id then
    self:_CheckPoint()
  end
end

function UIActivityCN18N47CommonComponentEnterLock:_OnQuestUpdate()
  self:_CheckPoint()
end

function UIActivityCN18N47CommonComponentEnterLock:_CheckPoint()
...
function UIActivityCN18N47CommonComponentEnterLock:_CheckPoint_RedDotModule()
  GameGlobal.TaskManager():StartTask(function(TT)
    local checkList = {}
