...
_class("UICNUIActivityCN22N51IntroType1Widget", UIIntroType1Widget)
UICNUIActivityCN22N51IntroType1Widget = UICNUIActivityCN22N51IntroType1Widget

function UICNUIActivityCN22N51IntroType1Widget:_PlayAnimation(animName, duration, callback)
...
function UICNUIActivityCN22N51IntroType1Widget:CloseDialog()
  self._uiView:CloseDialogWithAnimation()
end

function UICNUIActivityCN22N51IntroType1Widget:SetData(uiView, cfgId)
  self._uiView = uiView
  self._cfg = Cfg.cfg_intro_loader_type_1[cfgId]
  if not self._cfg then
    Log.exception("UICNUIActivityCN22N51IntroType1Widget:SetData() cfg_intro_loader_type_1[", cfgId, "] error")
    self:CloseDialog()
    return
  end
  self:_SetSubTitle()
...
function UICNUIActivityCN22N51IntroType1Widget:_SetTitle()
...
function UICNUIActivityCN22N51IntroType1Widget:_SetSubTitle()
...
function UICNUIActivityCN22N51IntroType1Widget:_SetIntro()
...
function UICNUIActivityCN22N51IntroType1Widget:_CalcLen(keyHead)
  local n = 0
  while true do
    n = n + 1
...
function UICNUIActivityCN22N51IntroType1Widget:CloseBtnOnClick(go)
