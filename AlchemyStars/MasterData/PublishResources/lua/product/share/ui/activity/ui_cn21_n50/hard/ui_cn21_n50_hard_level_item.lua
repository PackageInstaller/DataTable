_class("UICN21N50HardLevelItem", UICustomWidget)
UICN21N50HardLevelItem = UICN21N50HardLevelItem

function UICN21N50HardLevelItem:Constructor(uiview)
  self._view = uiview
  self:OnShow()
end

function UICN21N50HardLevelItem:OnShow()
...
function UICN21N50HardLevelItem:OnHide()
end

function UICN21N50HardLevelItem:SetData(idx, cfg, passInfo, cur, atlas)
  if idx < cur then
...
function UICN21N50HardLevelItem:LocalPosition()
  return self._localPos
end

function UICN21N50HardLevelItem:Anim_Pass()
  self._anim:Play("uieff_UIN28HardLevel_Finish")
end

function UICN21N50HardLevelItem:Anim_Open()
end

function UICN21N50HardLevelItem:SetActive(bShow)
