...
function UIActivityN9LineMissionController:_SetRemainingTime_Action(widgetName, descId, endTime, tickCallback, stopCallback)
  local obj = self:_SpawnObject(widgetName, "UIActivityCommonRemainingTime")
  obj:SetCustomTimeStr_Common_1()
...
function UIActivityN9LineMissionController:OnShow(uiParams)
  ...
  UIActivityN9LineMissionController.Passed = 888
...
function UIActivityN9LineMissionController:_SetExchangeBtn()
  ...
  obj:SetData(self._campaign, function()
    ClientCampaignShop.OpenCampaignShop(self._campaign._type, self._campaign._id, function()
      self._campaign._campaign_module:CampaignSwitchState(true, UIStateType.UIActivityN9LineMissionController, UIStateType.UIMain, nil, self._campaign._id, self._componentId_LineMission)
    end)
  end)
end
