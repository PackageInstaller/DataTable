_class("UICN19N48MiniGameOrderformItem", UICustomWidget)
UICN19N48MiniGameOrderformItem = UICN19N48MiniGameOrderformItem

function UICN19N48MiniGameOrderformItem:Constructor()
...
function UICN19N48MiniGameOrderformItem:OnShow(uiParams)
  self:_GetComponents()
end

function UICN19N48MiniGameOrderformItem:_GetComponents()
...
function UICN19N48MiniGameOrderformItem:SetData(orderform)
...
function UICN19N48MiniGameOrderformItem:_Update(ms)
...
function UICN19N48MiniGameOrderformItem:_GetGuestMood(time)
...
function UICN19N48MiniGameOrderformItem:SetActive(active)
  self.view.gameObject:SetActive(active)
end

function UICN19N48MiniGameOrderformItem:PlayAnimation(animation)
  self._animation:Play(MGAnimations.Orderform[animation])
end

function UICN19N48MiniGameOrderformItem:PlayReadyAnimation(play)
  if play then
...
function UICN19N48MiniGameOrderformItem:SetPosition(position, offset)
  self.view.transform.position = position
  self.view.transform.localPosition = self.view.transform.localPosition + offset
end

function UICN19N48MiniGameOrderformItem:GetCurrentMood()
