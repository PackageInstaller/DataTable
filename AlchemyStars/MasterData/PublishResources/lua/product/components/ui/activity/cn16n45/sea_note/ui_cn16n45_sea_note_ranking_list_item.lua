_class("UICN16N45SeaNoteRankingListItem", UICustomWidget)
UICN16N45SeaNoteRankingListItem = UICN16N45SeaNoteRankingListItem

function UICN16N45SeaNoteRankingListItem:OnShow(uiParams)
  self:InitWidget()
end

function UICN16N45SeaNoteRankingListItem:InitWidget()
...
function UICN16N45SeaNoteRankingListItem:SetNull()
  self.rootObj:SetActive(false)
end

function UICN16N45SeaNoteRankingListItem:SetData(rank, playerName, damage, headBgID, headIconID, frameID, isRealPlayer, isMyself, pstid)
...
function UICN16N45SeaNoteRankingListItem:BgOnClick()
