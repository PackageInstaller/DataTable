_class("UIN39LineMissionMapLine", UICustomWidget)
UIN39LineMissionMapLine = UIN39LineMissionMapLine

function UIN39LineMissionMapLine:OnShow()
  self._rect = self:GetUIComponent("RectTransform", "shape")
end

function UIN39LineMissionMapLine:Flush(from, to)
