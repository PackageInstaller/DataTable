_class("UIFavourPetVoteItem", UICustomWidget)
UIFavourPetVoteItem = UIFavourPetVoteItem

function UIFavourPetVoteItem:SetData(campaign, component, petId, isChampion, clickCallback)
...
function UIFavourPetVoteItem:PlayAnimationInSequence(index)
...
function UIFavourPetVoteItem:_SetCrown(isShow)
  isShow = isShow or false
  self:GetGameObject("_crown"):SetActive(isShow)
end

function UIFavourPetVoteItem:_SetPet(petId)
...
function UIFavourPetVoteItem:_SetPetCg(petId)
...
function UIFavourPetVoteItem:_SetVote(petId)
...
function UIFavourPetVoteItem:BtnOnClick(go)
