...
function UIN23Line:LoadDataOnEnter(TT, res, uiParams)
  ...
  self._componentId_LineMissionFixteam = ECampaignN23ComponentID.ECAMPAIGN_N23_FIRST_MEET
...
function UIN23Line:OnShow(uiParams)
  ...
  UIN23Line.SLeval = 111111
  UIN23Line.Passed = 888
  UIN23Line.NodeCfg = {
...
function UIN23Line:GetFormatTimerStr(time)
  ...
  if 0 < day then
    timeStr = "<color=#d9ab57>" .. day .. "</color>" .. StringTable.Get(id.day) .. "<color=#d9ab57>" .. hour .. "</color>" .. StringTable.Get(id.hour)
  elseif 0 < hour then
    timeStr = "<color=#d9ab57>" .. hour .. "</color>" .. StringTable.Get(id.hour) .. "<color=#d9ab57>" .. min .. "</color>" .. StringTable.Get(id.min)
  elseif 0 < min then
...
function UIN23Line:_SetExchangeBtn()
  ...
  obj:SetData(self._campaign, function()
    ClientCampaignShop.OpenCampaignShop(self._campaign._type, self._campaign._id, function()
      self._campaign._campaign_module:CampaignSwitchState(true, UIStateType.UIN23Line, UIStateType.UIMain, nil, self._campaign._id, componentId)
    end)
  end)
end
