_class("UITimeLoginV2CellItem", UICustomWidget)
UITimeLoginV2CellItem = UITimeLoginV2CellItem

function UITimeLoginV2CellItem:OnShow(uiParams)
  self:InitWidget()
end

function UITimeLoginV2CellItem:InitWidget()
...
function UITimeLoginV2CellItem:SetData(roleAsset, tipsCallback)
...
function UITimeLoginV2CellItem:IconOnClick(go)
