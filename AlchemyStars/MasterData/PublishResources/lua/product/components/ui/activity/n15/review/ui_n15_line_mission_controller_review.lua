...
function UIN15LineMissionControllerReview:_OnValue(uiParams)
  ...
  UIN15LineMissionControllerReview.SLeval = 999
  UIN15LineMissionControllerReview.Passed = 888
...
function UIN15LineMissionControllerReview:_GetComponents()
  ...
  self._backBtns:SetData(function()
    ...
    campaignModule:CampaignSwitchState(true, UIStateType.UIN15MainControllerReview, UIStateType.UIMain, nil, self._campaign._id)
  end)
...
function UIN15LineMissionControllerReview:_EnterStage(stageId, worldPos)
  ...
  self:ShowDialog("UIActivityLevelStageNew", stageId, self._line_info.m_pass_mission_info[stageId], self._line_component, autoFightShow, nil, nil, nil, nil, nil, false, false)
end
