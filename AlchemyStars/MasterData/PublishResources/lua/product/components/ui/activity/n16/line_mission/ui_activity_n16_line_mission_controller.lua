...
function UIActivityN16LineMissionController:_SetRemainingTime_Action(widgetName, descId, endTime, tickCallback, stopCallback)
  local obj = self:_SpawnObject(widgetName, "UIActivityCommonRemainingTime")
  obj:SetCustomTimeStr_Common_1()
...
function UIActivityN16LineMissionController:OnShow(uiParams)
  ...
  UIActivityN16LineMissionController.SLeval = 999
  UIActivityN16LineMissionController.Passed = 888
...
function UIActivityN16LineMissionController:_SetExchangeBtn()
  ...
  obj:SetData(self._campaign, function()
    ClientCampaignShop.OpenCampaignShop(self._campaign._type, self._campaign._id, function()
      self._campaign._campaign_module:CampaignSwitchState(true, UIStateType.UIActivityN16LineMissionController, UIStateType.UIMain, nil, self._campaign._id, self._componentId_LineMission)
    end)
  end)
end
