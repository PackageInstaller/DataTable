...
function UIActivityN8LineMissionController_Review:InitWidget()
  ...
  self._backBtns:SetData(function()
    ...
    campaignModule:CampaignSwitchState(true, UIStateType.UIActivityN8MainController_Review, UIStateType.UIMain, nil, self._campaign._id)
  end)
...
function UIActivityN8LineMissionController_Review:OnShow(uiParams)
  ...
  UIActivityN8LineMissionController_Review.SLeval = 999
  UIActivityN8LineMissionController_Review.Passed = 888
