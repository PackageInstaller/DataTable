...
function UIHomelandAlbumItem:OnShow(uiParams)
  self:InitWidget()
  self._color = {}
  self._color.valid = Color(0.34509803921568627, 0.3411764705882353, 0.3411764705882353)
  self._color.inValid = Color(0.6196078431372549, 0.6196078431372549, 0.6196078431372549)
end
