_class("UISeasonBuffLevelUpS2", UIController)
UISeasonBuffLevelUpS2 = UISeasonBuffLevelUpS2

function UISeasonBuffLevelUpS2:LoadDataOnEnter(TT, res, uiParams)
...
function UISeasonBuffLevelUpS2:OnShow(uiParams)
...
function UISeasonBuffLevelUpS2:OnUpdate(deltaTimeMS)
...
function UISeasonBuffLevelUpS2:FullScreenBtnOnClick(go)
