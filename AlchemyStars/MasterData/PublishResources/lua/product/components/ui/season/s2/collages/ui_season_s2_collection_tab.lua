_class("UISeasonS2CollectionTab", UICustomWidget)
UISeasonS2CollectionTab = UISeasonS2CollectionTab

function UISeasonS2CollectionTab:OnShow(uiParams)
  self:InitWidget()
  self._firstItem = nil
end

function UISeasonS2CollectionTab:InitWidget()
  ...
  self.titleShadow = self:GetUIComponent("UILocalizationText", "titleShadow")
end

function UISeasonS2CollectionTab:SetData(data)
  ...
  self._items = self.content:SpawnObjects("UISeasonS2CollageCollectionItem", count)
  for i = 1, count do
...
function UISeasonS2CollectionTab:SetShow(show)
  self:GetGameObject():SetActive(show)
end

function UISeasonS2CollectionTab:_OnSelect(data)
  ...
  if data:IsGot() then
    ...
    self.titleShadow:SetText(StringTable.Get(itemCfg.Name))
...
function UISeasonS2CollectionTab:FinalPlotEnterOnClick(go)
...
function UISeasonS2CollectionTab:GetGuideItem()
  return self._firstItem:GetGameObject("icon")
end

function UISeasonS2CollectionTab:PlayExitAnim()
