_class("UISeasonMainOvalAreaS6", UICustomWidget)
UISeasonMainOvalAreaS6 = UISeasonMainOvalAreaS6

function UISeasonMainOvalAreaS6:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonMainOvalAreaS6:InitWidget()
  self._tipsParent = self:GetUIComponent("Transform", "tips")
end

function UISeasonMainOvalAreaS6:SetData()
end

function UISeasonMainOvalAreaS6:OnHide()
...
function UISeasonMainOvalAreaS6:AddTarget(target, type)
  if self._tips[target] then
    Log.error("duplicate target")
    return
  end
  local prefab = self:_LoadPrefab()
  local tip = UISeasonMainOvalTipS6:New(self._seasonID, prefab, function(tip)
...
function UISeasonMainOvalAreaS6:RemoveTarget(obj)
...
function UISeasonMainOvalAreaS6:GetTipByType(type)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS6:Update(dt)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS6:_LoadPrefab()
...
function UISeasonMainOvalAreaS6:_ReleaseTip(req)
  req:Dispose()
end

function UISeasonMainOvalAreaS6:_ScreenToOval(screenPos)
  return screenPos - self._ovalCenter
end

function UISeasonMainOvalAreaS6:_OnTipClick(tip)
...
function UISeasonMainOvalAreaS6:_RefreshMainLevelTarget()
...
function UISeasonMainOvalAreaS6:_RefreshDailyLevelTarget()
...
function UISeasonMainOvalAreaS6:_RefreshBoxTarget()
...
function UISeasonMainOvalAreaS6:_RefreshPlayer()
...
function UISeasonMainOvalAreaS6:_RefreshTarget()
  self:_RefreshMainLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshTask()
end

function UISeasonMainOvalAreaS6:_OnModeChanged()
  self:_RefreshMainLevelTarget()
  self:_RefreshDailyLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshPlayer()
...
function UISeasonMainOvalAreaS6:_RefreshTask()
  local oldTips = {}
  for _, tip in pairs(self._tips) do
