_class("UISeasonMainOvalAreaS5", UICustomWidget)
UISeasonMainOvalAreaS5 = UISeasonMainOvalAreaS5

function UISeasonMainOvalAreaS5:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonMainOvalAreaS5:InitWidget()
  self._tipsParent = self:GetUIComponent("Transform", "tips")
end

function UISeasonMainOvalAreaS5:SetData()
end

function UISeasonMainOvalAreaS5:OnHide()
...
function UISeasonMainOvalAreaS5:AddTarget(target, type)
  if self._tips[target] then
    Log.error("duplicate target")
    return
  end
  local prefab = self:_LoadPrefab()
  local tip = UISeasonMainOvalTipS5:New(self._seasonID, prefab, function(tip)
...
function UISeasonMainOvalAreaS5:RemoveTarget(obj)
...
function UISeasonMainOvalAreaS5:GetTipByType(type)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS5:Update(dt)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS5:_LoadPrefab()
...
function UISeasonMainOvalAreaS5:_ReleaseTip(req)
  req:Dispose()
end

function UISeasonMainOvalAreaS5:_ScreenToOval(screenPos)
  return screenPos - self._ovalCenter
end

function UISeasonMainOvalAreaS5:_OnTipClick(tip)
...
function UISeasonMainOvalAreaS5:_RefreshMainLevelTarget()
...
function UISeasonMainOvalAreaS5:_RefreshDailyLevelTarget()
...
function UISeasonMainOvalAreaS5:_RefreshBoxTarget()
...
function UISeasonMainOvalAreaS5:_RefreshPlayer()
...
function UISeasonMainOvalAreaS5:_RefreshTarget()
  self:_RefreshMainLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshTask()
end

function UISeasonMainOvalAreaS5:_OnModeChanged()
  self:_RefreshMainLevelTarget()
  self:_RefreshDailyLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshPlayer()
...
function UISeasonMainOvalAreaS5:_RefreshTask()
  local oldTips = {}
  for _, tip in pairs(self._tips) do
