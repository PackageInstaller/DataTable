_class("UISeasonShowAwardsItemS5", UICustomWidget)
UISeasonShowAwardsItemS5 = UISeasonShowAwardsItemS5
local maxNumCount = 5

function UISeasonShowAwardsItemS5:OnShow(uiParams)
  ...
  self.uiItem = sop:SpawnObject("UISeasonItemS5")
end

function UISeasonShowAwardsItemS5:SetData(itemInfo, index, clickCallback, nameColor, tweenIdx, beforeTime)
...
function UISeasonShowAwardsItemS5:_PlayAnim()
  self._anim:Play("uieff_UIGetItemControllerItem")
end

function UISeasonShowAwardsItemS5:GetIndex()
  return self._index
end

function UISeasonShowAwardsItemS5:OnHide()
  if self._tweenEvent then
    GameGlobal.Timer():CancelEvent(self._tweenEvent)
    self._tweenEvent = nil
  end
...
function UISeasonShowAwardsItemS5:FormatItemCount(count)
