_class("UISeasonLevelStageS2", UIController)
UISeasonLevelStageS2 = UISeasonLevelStageS2

function UISeasonLevelStageS2:_GetComponents()
...
function UISeasonLevelStageS2:OnShow(uiParams)
...
function UISeasonLevelStageS2:LoadDataOnEnter(TT, res)
end

function UISeasonLevelStageS2.GetAutoOpenState(matchType, stageId)
...
function UISeasonLevelStageS2.SetAutoOpenState(matchType, stageId, isOpen)
  local roleModule = GameGlobal.GetModule(RoleModule)
  local pstId = roleModule:GetPstId()
  local playerPrefsKey = pstId .. "AutoOpenState" .. matchType
  if stageId then
...
function UISeasonLevelStageS2:_CanAutoFight()
  local tipsStr = ""
...
function UISeasonLevelStageS2:_CanShowAutoFight()
  local missionCfg = Cfg.cfg_season_mission[self._missionID]
  if not missionCfg then
    return false
  end
...
function UISeasonLevelStageS2:InitAutoBtnState()
...
function UISeasonLevelStageS2:_CheckShowWordBuff()
  local missionCfg = Cfg.cfg_season_mission[self._missionID]
  if not missionCfg then
    return false
  end
...
function UISeasonLevelStageS2:AutoFightBtnOnClick()
...
function UISeasonLevelStageS2:OnHide()
...
function UISeasonLevelStageS2:HasPassThreeStar(missionCfg)
...
function UISeasonLevelStageS2:GetSortedArr(awardType, cfg, stageAwardType)
...
function UISeasonLevelStageS2:ProcessAward(missionCfg, noNormal)
  local missionId = missionCfg.ID
  local awards = {}
...
function UISeasonLevelStageS2:RefreshAwardsShowState()
  self._noDiffAwardGo = self:GetGameObject("NoDiffAward")
  self._seasonAwardGo = self:GetGameObject("SeasonAward")
  self._seasonNormalAwardGo = self:GetGameObject("MultiAwardGroup1")
  self._seasonHardAwardGo = self:GetGameObject("MultiAwardGroup2")
...
function UISeasonLevelStageS2:RefreshWordsArea()
  if self._hasMultiDiff then
...
function UISeasonLevelStageS2:InitWords()
  if self._hasMultiDiff then
...
function UISeasonLevelStageS2:_InitWords(sop, missionId)
...
function UISeasonLevelStageS2:_GetWordDesc(levelId, wordId)
...
function UISeasonLevelStageS2:RefreshBtnUnknown()
  local show = self:_CheckShowWordBuff()
  self.btnWord:SetActive(show)
end

function UISeasonLevelStageS2:InitForMultiDiff()
  local missionCfg = Cfg.cfg_season_mission[self._missionID]
...
function UISeasonLevelStageS2:RefreshPanelShow()
...
function UISeasonLevelStageS2:RefreshPanelBg()
  ...
  elseif self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
    bgName = "exp_s2_map_di12"
  else
    bgName = "exp_s2_map_di13"
  end
  self._bgImg:LoadImage(bgName)
end

function UISeasonLevelStageS2:RefreshPanelText()
  if self._missionDiff == UISeasonLevelDiff.Normal then
    if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonLevelStageS2:RefreshDiffArea()
  if self._missionDiff == UISeasonLevelDiff.Normal then
...
function UISeasonLevelStageS2:InitAllAwards()
  if self._hasMultiDiff then
    ...
    self._normalMultiAwardList = normalAwardGen:SpawnObject("UISeasonStageMultiAwardListS2")
    ...
    self._hardMultiAwardList = hardAwardGen:SpawnObject("UISeasonStageMultiAwardListS2")
...
function UISeasonLevelStageS2:PlayAnimAwardList(totalAnimDelay)
...
function UISeasonLevelStageS2:_ProcessLevelDiffAwards(missionId, levelDiff, noNormal)
  if missionId then
...
function UISeasonLevelStageS2:Init()
  local missionCfg = Cfg.cfg_season_mission[self._missionID]
...
function UISeasonLevelStageS2:UpdateCondition(three_star_condition, conditions)
...
function UISeasonLevelStageS2:BtnFightOnClick(go)
...
function UISeasonLevelStageS2:IsPowerEnough()
...
function UISeasonLevelStageS2:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonLevelStageS2:BgOnClick()
  self:Close()
end

function UISeasonLevelStageS2:ThreeStarTipsBtnOnClick(go)
  self:ShowDialog("UIThreeStarTips")
end

function UISeasonLevelStageS2:BtnUnknownOnClick(go)
  local buffData = {}
  buffData.name = ""
  buffData.des = ""
...
function UISeasonLevelStageS2:_SetStoryBtn()
...
function UISeasonLevelStageS2:BtnPlotOnClick()
  local storyList = DiscoveryStoryList:New()
  storyList:Init(self._missionID)
...
function UISeasonLevelStageS2:SliderHardOnClick()
  if self._hasMultiDiff then
...
function UISeasonLevelStageS2:SliderNormalOnClick()
  if self._hasMultiDiff then
    if self._missionDiff == UISeasonLevelDiff.Normal then
      return
    end
...
function UISeasonLevelStageS2:_SwitchDiff()
  if self._hasMultiDiff then
    if self._missionDiff == UISeasonLevelDiff.Normal then
...
function UISeasonLevelStageS2:DiffInfoBtnOnClick(go)
  self:ShowDialog("UISeasonStageDiffTips")
end

function UISeasonLevelStageS2:RefreshPowerTips()
...
function UISeasonLevelStageS2:RefreshPowerCost()
  local needPowerText = self._needPower
  if self._powerID == RoleAssetID.RoleAssetPhyPoint then
  else
    if not self._pointComp then
...
function UISeasonLevelStageS2:InitChapterName()
  if self._hasMultiDiff then
    local normalMissionId = self._diffMissonIdMap[UISeasonLevelDiff.Normal]
    local hardMissionId = self._diffMissonIdMap[UISeasonLevelDiff.Hard]
...
function UISeasonLevelStageS2:_InitChapterName(text, missionId)
  local missionCfg = Cfg.cfg_season_mission[missionId]
...
function UISeasonLevelStageS2:RefreshChapter()
  if self._hasMultiDiff then
...
function UISeasonLevelStageS2:RefreshThreeStarArea(playAnim, animDelay)
  local missionCfg = Cfg.cfg_season_mission[self._missionID]
...
function UISeasonLevelStageS2:PlayAnimThreeStarArea(totalAnimDelay)
...
function UISeasonLevelStageS2:InitEnemys()
  if self._hasMultiDiff then
    local normalMissionId = self._diffMissonIdMap[UISeasonLevelDiff.Normal]
    local hardMissionId = self._diffMissonIdMap[UISeasonLevelDiff.Hard]
...
function UISeasonLevelStageS2:_InitEnemy(sop, missionId)
  local missionCfg = Cfg.cfg_season_mission[missionId]
  local progress = self._curLevelProgress
...
function UISeasonLevelStageS2:RefreshEnemyArea()
...
function UISeasonLevelStageS2:RefreshRecommendLv()
...
function UISeasonLevelStageS2:RefreshAreasTitleStyle()
end

function UISeasonLevelStageS2:InitBuffLevelArea()
  self._buffLevelArea = self.buffLevelGen:SpawnObject("UISeasonBuffStageAreaS2")
  if self._buffLevelArea then
    self._buffLevelArea:SetData(self._seasonObj)
  end
end

function UISeasonLevelStageS2:RefreshBuffArea()
  if self._buffLevelArea then
    self._buffLevelArea:RefreshInfo()
  end
end

function UISeasonLevelStageS2:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonLevelStageS2:_CloseDialogWithAnim(callback)
...
function UISeasonLevelStageS2:_Resume()
...
function UISeasonLevelStageS2:BattleInfoPanelBtnOnClick()
...
function UISeasonLevelStageS2:AwardsPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.AwardsInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonLevelStageS2:PowerTopTipsOnClick(go)
  self:ShowDialog("UISeasonActionPointTipS2", self._pointComp, go.transform.anchoredPosition)
end

function UISeasonLevelStageS2:_Countdown()
...
function UISeasonLevelStageS2:_ReqFlushPower(TT)
...
function UISeasonLevelStageS2:OnAfterUILayerChanged()
...
function UISeasonLevelStageS2:ShowMainUI(show)
...
function UISeasonLevelStageS2:RecordOnClick(go)
  self:ShowDialog("UIActivityLevelRecordController", self._component, self._missionID)
end

function UISeasonLevelStageS2:_TryFixStory(TT)
  local normalMissionID = self._diffMissonIdMap[UISeasonLevelDiff.Normal]
...
function UISeasonLevelStageS2:_ReqFinishStory(TT, id, type)
