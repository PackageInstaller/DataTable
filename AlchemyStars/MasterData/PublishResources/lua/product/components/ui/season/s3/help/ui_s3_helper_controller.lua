_class("UIS3HelperController", UIController)
UIS3HelperController = UIS3HelperController

function UIS3HelperController:OnShow(uiParams)
  local tabIndex = 1
...
function UIS3HelperController:OnHide()
end

function UIS3HelperController:InitWidget(tabIndex)
...
function UIS3HelperController:AddListener()
end

function UIS3HelperController:_InitBanner(tabIndex)
  local bannerGen = self:GetUIComponent("UISelectObjectPath", "BannerRoot")
  self._bannerWidget = bannerGen:SpawnObject("UIS3HelperBanner")
  self._bannerWidget:SetData(tabIndex)
end

function UIS3HelperController:OnUpdate(deltaTimeMS)
  if self._bannerWidget then
    self._bannerWidget:OnUpdate(deltaTimeMS)
  end
end

function UIS3HelperController:_InitTabList(tabIndex)
  ...
  self._tabPool:SpawnObjects("UIS3HelperTab", tabCount)
...
function UIS3HelperController:OnTabClick(tabId)
