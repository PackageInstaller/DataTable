_class("UISeasonSeasonCollageCGItem", UICustomWidget)
UISeasonSeasonCollageCGItem = UISeasonSeasonCollageCGItem

function UISeasonSeasonCollageCGItem:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonSeasonCollageCGItem:InitWidget()
...
function UISeasonSeasonCollageCGItem:SetData(data, onClick)
  self._data = data
...
function UISeasonSeasonCollageCGItem:SetNew(new)
  self.new:SetActive(new)
end

function UISeasonSeasonCollageCGItem:RootOnClick(go)
  self._onClick(self._data)
end

function UISeasonSeasonCollageCGItem:ResetShareState()
...
function UISeasonSeasonCollageCGItem:PlayExitAnim()
end
