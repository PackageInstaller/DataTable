_class("UIS4HelperBanner", UICustomWidget)
UIS4HelperBanner = UIS4HelperBanner

function UIS4HelperBanner:OnShow()
  self:InitWidget()
end

function UIS4HelperBanner:OnHide()
...
function UIS4HelperBanner:SetData(tabIndex)
  if tabIndex then
...
function UIS4HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UIS4HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UIS4HelperBannerItem")
...
function UIS4HelperBanner:ScrollToIndex(tarIdx)
...
function UIS4HelperBanner:ImageLeftOnClick(go)
...
function UIS4HelperBanner:ImageRightOnClick(go)
  AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SoundDefaultClick)
  if self._count <= 1 then
    return
  end
...
function UIS4HelperBanner:InitScrollView()
...
function UIS4HelperBanner:_RefreshArrowBtn()
  local showLeft = true
...
function UIS4HelperBanner:_MatchOpenTime(cfgTab)
...
function UIS4HelperBanner:_CreateScrollData()
  self._carouselTab = {}
  self._cfgTab = Cfg.cfg_season_helper({
    SeasonID = UISeasonID.S4,
    Tab = self._tabIndex
  })
...
function UIS4HelperBanner:_CreateScrollItem()
  self._grid = self:GetUIComponent("UISelectObjectPath", "grid")
  self._grid:SpawnObjects("UIS4HelperBannerIdxItem", self._count)
...
function UIS4HelperBanner:_SetScrollCellData(cellWidget, dataIndex)
...
function UIS4HelperBanner:_CreateScrollEvent()
  do return end
...
function UIS4HelperBanner:_SetCellForNormal()
...
function UIS4HelperBanner:_SetCellForAnim()
  self._cellArea1Go:SetActive(true)
...
function UIS4HelperBanner:OnUpdate(deltaTimeMS)
  if self._isScrollReady and self._count <= 1 then
    return
  end
end

function UIS4HelperBanner:_PlayScrollAnim(bDown)
  self._cellCanvas1.alpha = 1
