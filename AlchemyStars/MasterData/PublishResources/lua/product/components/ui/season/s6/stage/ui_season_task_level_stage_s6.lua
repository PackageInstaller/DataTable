_class("UISeasonTaskLevelStageS6", UIController)
UISeasonTaskLevelStageS6 = UISeasonTaskLevelStageS6

function UISeasonTaskLevelStageS6:LoadDataOnEnter(TT, res)
...
function UISeasonTaskLevelStageS6:OnShow(uiParams)
...
function UISeasonTaskLevelStageS6:_GetComponents()
...
function UISeasonTaskLevelStageS6:RefreshPanelBg()
...
function UISeasonTaskLevelStageS6:RefreshPanelText()
  if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonTaskLevelStageS6:_OnValue()
...
function UISeasonTaskLevelStageS6:BtnFightOnClick(go)
...
function UISeasonTaskLevelStageS6:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonTaskLevelStageS6:BgOnClick()
  self:Close()
end

function UISeasonTaskLevelStageS6:InitChapterName()
...
function UISeasonTaskLevelStageS6:InitEnemys()
  self:_InitEnemy()
  self:_RefreshEnemyArea()
end

function UISeasonTaskLevelStageS6:_InitEnemy()
...
function UISeasonTaskLevelStageS6:_RefreshEnemyArea()
  self._enemyNormalGo = self:GetGameObject("enemy_normal")
  self._enemyNormalGo:SetActive(true)
end

function UISeasonTaskLevelStageS6:RefreshRecommendLv()
...
function UISeasonTaskLevelStageS6:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonTaskLevelStageS6:_CloseDialogWithAnim(callback)
...
function UISeasonTaskLevelStageS6:_Resume()
...
function UISeasonTaskLevelStageS6:BattleInfoPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.BattleInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonTaskLevelStageS6:AwardsPanelBtnOnClick()
...
function UISeasonTaskLevelStageS6:_ShowMainUI(show)
