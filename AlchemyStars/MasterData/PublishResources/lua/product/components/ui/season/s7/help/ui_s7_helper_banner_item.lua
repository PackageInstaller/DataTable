_class("UIS7HelperBannerItem", UICustomWidget)
UIS7HelperBannerItem = UIS7HelperBannerItem

function UIS7HelperBannerItem:OnShow()
end

function UIS7HelperBannerItem:OnHide()
end

function UIS7HelperBannerItem:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UIS7HelperBannerItem:BtnOnClick()
end

function UIS7HelperBannerItem:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
