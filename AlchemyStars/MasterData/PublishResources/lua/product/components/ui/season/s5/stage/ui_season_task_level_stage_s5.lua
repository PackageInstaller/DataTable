_class("UISeasonTaskLevelStageS5", UIController)
UISeasonTaskLevelStageS5 = UISeasonTaskLevelStageS5

function UISeasonTaskLevelStageS5:LoadDataOnEnter(TT, res)
...
function UISeasonTaskLevelStageS5:OnShow(uiParams)
...
function UISeasonTaskLevelStageS5:_GetComponents()
...
function UISeasonTaskLevelStageS5:RefreshPanelBg()
...
function UISeasonTaskLevelStageS5:RefreshPanelText()
  if self._curPanel == UISeasonLevelStagePanelMode.AwardsInfo then
...
function UISeasonTaskLevelStageS5:_OnValue()
...
function UISeasonTaskLevelStageS5:BtnFightOnClick(go)
...
function UISeasonTaskLevelStageS5:ShowTips(itemId, pos)
  self._tips:SetData(itemId, pos)
end

function UISeasonTaskLevelStageS5:BgOnClick()
  self:Close()
end

function UISeasonTaskLevelStageS5:InitChapterName()
...
function UISeasonTaskLevelStageS5:InitEnemys()
  self:_InitEnemy()
  self:_RefreshEnemyArea()
end

function UISeasonTaskLevelStageS5:_InitEnemy()
...
function UISeasonTaskLevelStageS5:_RefreshEnemyArea()
  self._enemyNormalGo = self:GetGameObject("enemy_normal")
  self._enemyNormalGo:SetActive(true)
end

function UISeasonTaskLevelStageS5:RefreshRecommendLv()
...
function UISeasonTaskLevelStageS5:Close()
  self:_CloseDialogWithAnim()
end

function UISeasonTaskLevelStageS5:_CloseDialogWithAnim(callback)
...
function UISeasonTaskLevelStageS5:_Resume()
...
function UISeasonTaskLevelStageS5:BattleInfoPanelBtnOnClick()
  self._curPanel = UISeasonLevelStagePanelMode.BattleInfo
  self:RefreshPanelShow()
  self:RefreshPanelBg()
  self:RefreshPanelText()
...
function UISeasonTaskLevelStageS5:AwardsPanelBtnOnClick()
...
function UISeasonTaskLevelStageS5:_ShowMainUI(show)
