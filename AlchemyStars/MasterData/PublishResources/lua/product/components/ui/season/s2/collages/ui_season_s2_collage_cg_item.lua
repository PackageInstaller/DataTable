_class("UISeasonS2CollageCGItem", UICustomWidget)
UISeasonS2CollageCGItem = UISeasonS2CollageCGItem

function UISeasonS2CollageCGItem:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonS2CollageCGItem:InitWidget()
...
function UISeasonS2CollageCGItem:SetData(data, onClick)
  self._data = data
...
function UISeasonS2CollageCGItem:SetNew(new)
  self.new:SetActive(new)
end

function UISeasonS2CollageCGItem:RootOnClick(go)
  self._onClick(self._data)
end

function UISeasonS2CollageCGItem:ResetShareState()
...
function UISeasonS2CollageCGItem:PlayExitAnim()
