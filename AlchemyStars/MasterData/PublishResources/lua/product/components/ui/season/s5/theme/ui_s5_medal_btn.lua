_class("UIS5MedalBtn", UICustomWidget)
UIS5MedalBtn = UIS5MedalBtn

function UIS5MedalBtn:OnShow()
  self._constBtnName = self:GetName()
end

function UIS5MedalBtn:OnHide()
end

function UIS5MedalBtn:SetData(seasonId, playAnim)
  ...
  self:_CheckPoint()
  if playAnim then
    UIWidgetHelper.PlayAnimationInSequence(self, "_anim", "_anim", "uieffanim_UIS5_MedalBtn_in", 0, 667)
  end
end

function UIS5MedalBtn:_SetFin(cfg)
