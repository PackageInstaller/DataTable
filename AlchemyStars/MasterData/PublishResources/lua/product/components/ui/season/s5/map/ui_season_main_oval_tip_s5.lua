_class("UISeasonMainOvalTipS5", Object)
UISeasonMainOvalTipS5 = UISeasonMainOvalTipS5

function UISeasonMainOvalTipS5:Constructor(seasonID, req, onClick)
...
function UISeasonMainOvalTipS5:TargetWorldPos()
...
function UISeasonMainOvalTipS5:Show()
  self._isIn = false
  local show = true
...
function UISeasonMainOvalTipS5:Hide()
  self._isIn = true
  self._gameObject:SetActive(false)
end

function UISeasonMainOvalTipS5:Delete()
  self._req = nil
...
function UISeasonMainOvalTipS5:GetReq()
  return self._req
end

function UISeasonMainOvalTipS5:Dispose()
  self._req:Dispose()
  self:Delete()
end

function UISeasonMainOvalTipS5:IsInOval()
  return self._isIn
end

function UISeasonMainOvalTipS5:Sync(pos, rot)
  self._rectTransform.anchoredPosition = pos
  self._arrowRect.localRotation = rot
end

function UISeasonMainOvalTipS5:Type()
  return self._type
end

function UISeasonMainOvalTipS5:Target()
  return self._target
end

function UISeasonMainOvalTipS5:IconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS5:ArrowIconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS5:ResetTarget(target, type)
  self._uiView:SetShow(false, self)
  self._uiView:SetShow(true, self)
  self._type = type
...
function UISeasonMainOvalTipS5:GetCanShowDistance(cameraSize)
...
function UISeasonMainOvalTipS5:_RefreshIcon()
  if self._type == UISeasonOvalTipType.Player then
...
function UISeasonMainOvalTipS5:_RefreshIconBackTrack()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_s1_map_icon05")
