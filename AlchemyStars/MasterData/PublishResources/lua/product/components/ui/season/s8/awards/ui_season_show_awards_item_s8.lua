_class("UISeasonShowAwardsItemS8", UICustomWidget)
UISeasonShowAwardsItemS8 = UISeasonShowAwardsItemS8
local maxNumCount = 5

function UISeasonShowAwardsItemS8:OnShow(uiParams)
  ...
  self.uiItem = sop:SpawnObject("UISeasonItemS8")
end

function UISeasonShowAwardsItemS8:SetData(itemInfo, index, clickCallback, nameColor, tweenIdx, beforeTime)
...
function UISeasonShowAwardsItemS8:_PlayAnim()
  self._anim:Play("uieff_UIGetItemControllerItem")
end

function UISeasonShowAwardsItemS8:GetIndex()
  return self._index
end

function UISeasonShowAwardsItemS8:OnHide()
  if self._tweenEvent then
    GameGlobal.Timer():CancelEvent(self._tweenEvent)
    self._tweenEvent = nil
  end
...
function UISeasonShowAwardsItemS8:FormatItemCount(count)
