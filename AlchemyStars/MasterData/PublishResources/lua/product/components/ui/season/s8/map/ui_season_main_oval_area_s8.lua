_class("UISeasonMainOvalAreaS8", UICustomWidget)
UISeasonMainOvalAreaS8 = UISeasonMainOvalAreaS8

function UISeasonMainOvalAreaS8:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonMainOvalAreaS8:InitWidget()
  self._tipsParent = self:GetUIComponent("Transform", "tips")
end

function UISeasonMainOvalAreaS8:SetData()
end

function UISeasonMainOvalAreaS8:OnHide()
...
function UISeasonMainOvalAreaS8:AddTarget(target, type)
  if self._tips[target] then
    Log.error("duplicate target")
    return
  end
  local prefab = self:_LoadPrefab()
  local tip = UISeasonMainOvalTipS8:New(self._seasonID, prefab, function(tip)
...
function UISeasonMainOvalAreaS8:RemoveTarget(obj)
...
function UISeasonMainOvalAreaS8:GetTipByType(type)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS8:Update(dt)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS8:_LoadPrefab()
...
function UISeasonMainOvalAreaS8:_ReleaseTip(req)
  req:Dispose()
end

function UISeasonMainOvalAreaS8:_ScreenToOval(screenPos)
  return screenPos - self._ovalCenter
end

function UISeasonMainOvalAreaS8:_OnTipClick(tip)
...
function UISeasonMainOvalAreaS8:_RefreshMainLevelTarget()
...
function UISeasonMainOvalAreaS8:_RefreshDailyLevelTarget()
...
function UISeasonMainOvalAreaS8:_RefreshBoxTarget()
...
function UISeasonMainOvalAreaS8:_RefreshPlayer()
...
function UISeasonMainOvalAreaS8:_RefreshTarget()
  self:_RefreshMainLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshTask()
end

function UISeasonMainOvalAreaS8:_OnModeChanged()
  self:_RefreshMainLevelTarget()
  self:_RefreshDailyLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshPlayer()
...
function UISeasonMainOvalAreaS8:_RefreshTask()
  local oldTips = {}
  for _, tip in pairs(self._tips) do
