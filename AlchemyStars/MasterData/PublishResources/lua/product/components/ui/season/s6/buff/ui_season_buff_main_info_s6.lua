_class("UISeasonBuffMainInfoS6", UIController)
UISeasonBuffMainInfoS6 = UISeasonBuffMainInfoS6

function UISeasonBuffMainInfoS6:OnShow(uiParams)
...
function UISeasonBuffMainInfoS6:InitInfo()
  ...
  self._progressCells = self.progressCellsGen:SpawnObject("UISeasonBuffProgressCellsS6")
  self._progressCells:SetData(self._curProgress, self._curMaxProgress)
end

function UISeasonBuffMainInfoS6:RefreshContent()
...
function UISeasonBuffMainInfoS6:BgOnClick()
  self:_CloseWithAni()
end

function UISeasonBuffMainInfoS6:CloseBtnOnClick()
  self:_CloseWithAni()
end

function UISeasonBuffMainInfoS6:_CloseWithAni()
  self._animation:Play("uieff_UISeasonBuffMainInfoS6_out")
  self:Lock("UISeasonBuffMainInfoS6:CloseAni")
  self:StartTask(function(TT)
    YIELD(TT, 130)
    self:CloseDialog()
    self:UnLock("UISeasonBuffMainInfoS6:CloseAni")
  end)
end

function UISeasonBuffMainInfoS6:NextBtnOnClick()
...
function UISeasonBuffMainInfoS6:PrevBtnOnClick()
  self.nextBtnGo:SetActive(true)
  self.prevBtnGo:SetActive(false)
  self._curShowContentLevel = self._curShowContentLevel - 1
  self:RefreshContent()
...
function UISeasonBuffMainInfoS6:HelpOnClick()
  GameGlobal.UIStateManager():ShowDialog("UISeasonBuffMainTipsS6")
end
