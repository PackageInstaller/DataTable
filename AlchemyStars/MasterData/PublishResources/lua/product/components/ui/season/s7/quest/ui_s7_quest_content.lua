_class("UIS7QuestContent", UICustomWidget)
UIS7QuestContent = UIS7QuestContent

function UIS7QuestContent:Constructor()
  self._scrollViewInit = false
end

function UIS7QuestContent:CloseDialogWithAnim(callback)
  self:_PlayAnim("out", callback)
end

function UIS7QuestContent:OnShow(uiParams)
...
function UIS7QuestContent:OnHide()
  self:_Detach()
end

function UIS7QuestContent:SetData(params)
...
function UIS7QuestContent:_Refresh(isFirst)
  self:_DynamicSv(isFirst)
  self:_SetClaimAllBtn()
end

function UIS7QuestContent:_PlayAnim(type, callback)
  local tb = {
    ["in"] = {
...
function UIS7QuestContent:_SetGoBtn()
...
function UIS7QuestContent:_DynamicSv(isFirst)
...
function UIS7QuestContent:DynamicSvInfo(scrollView, index)
...
function UIS7QuestContent:_Attach()
  self:AttachEvent(GameEventType.OnUIGetItemCloseInQuest, self.OnUIGetItemCloseInQuest)
end

function UIS7QuestContent:_Detach()
  self:DetachEvent(GameEventType.OnUIGetItemCloseInQuest, self.OnUIGetItemCloseInQuest)
end

function UIS7QuestContent:OnUIGetItemCloseInQuest()
...
function UIS7QuestContent:SetResponseEvent(val)
