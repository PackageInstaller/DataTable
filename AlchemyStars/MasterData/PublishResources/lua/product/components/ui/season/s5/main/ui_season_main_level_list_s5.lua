_class("UISeasonMainLevelListS5", UICustomWidget)
UISeasonMainLevelListS5 = UISeasonMainLevelListS5

function UISeasonMainLevelListS5:OnShow(uiParams)
  self._active = true
  self:InitWidget()
  self:_SetShow(false)
...
function UISeasonMainLevelListS5:OnHide()
  self._active = false
...
function UISeasonMainLevelListS5:InitWidget()
...
function UISeasonMainLevelListS5:SetData(obj)
  self._seasonObj = obj
end

function UISeasonMainLevelListS5:_Init()
...
function UISeasonMainLevelListS5:_BeforeStoryPlay()
  self._levelBtn:SetActive(true)
  self:_SetShow(false)
  self._levelBtnGroup.alpha = 1
end

function UISeasonMainLevelListS5:_OnDiffChanged(diff, onEnter)
  ...
  local atlas = self:GetAsset("UIS5Scene.spriteatlas", LoadType.SpriteAtlas)
...
function UISeasonMainLevelListS5:_OnClickLevelItem(data)
...
function UISeasonMainLevelListS5:_SetShow(show)
  self._isShown = show
...
function UISeasonMainLevelListS5:LevelBtnOnClick()
  self:_SetShow(true)
end

function UISeasonMainLevelListS5:CloseBtnOnClick()
  self:StartTask(function(TT)
    self:Lock("uieff_UISeasonMainLevelListS5_end")
    self._levelBtn:SetActive(true)
    self._anim:Play("uieff_UISeasonMainLevelListS5_out")
    YIELD(TT, 725)
    self:_SetShow(false)
    self:UnLock("uieff_UISeasonMainLevelListS5_end")
  end, self)
end

function UISeasonMainLevelListS5:_Refresh()
  ...
  self._levelWidgets = self.content:SpawnObjects("UISeasonMainLevelListItemS5", #self._levels)
...
function UISeasonMainLevelListS5:DiffOnClick()
  local diff
  if self._curDiff == UISeasonLevelDiff.Normal then
...
function UISeasonMainLevelListS5:_ScrollTo(index, onEnter)
...
function UISeasonMainLevelListS5:_OnEnterAnim(TT, index)
  self:Lock("UISeasonMainLevelListS5_OnEnterAnim")
  self._anim:Play("uieff_UISeasonMainLevelListS5_in")
  ...
  self:UnLock("UISeasonMainLevelListS5_OnEnterAnim")
end

function UISeasonMainLevelListS5:_OnSwitchDiffAnim(TT, index)
  self:Lock("UISeasonMainLevelListS5_OnSwitchDiffAnim")
  local showCount = 6
  local from, to
  if showCount >= #self._levels then
    from = 1
  ...
  self:UnLock("UISeasonMainLevelListS5_OnSwitchDiffAnim")
end

function UISeasonMainLevelListS5:PlayEnterAnim()
  self._anim:Play("uieff_UISeasonMainLevelListS5_LevelBtnin")
end
