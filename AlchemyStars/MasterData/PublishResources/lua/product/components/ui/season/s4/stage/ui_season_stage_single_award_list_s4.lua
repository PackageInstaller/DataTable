_class("UISeasonStageSingleAwardListS4", UICustomWidget)
UISeasonStageSingleAwardListS4 = UISeasonStageSingleAwardListS4

function UISeasonStageSingleAwardListS4:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonStageSingleAwardListS4:InitWidget()
...
function UISeasonStageSingleAwardListS4:OnHide()
end

function UISeasonStageSingleAwardListS4:SetData(awardList)
  self._awardList = awardList
  local levelDiff = self._awardList.levelDiff
  if levelDiff then
  end
  local count = #self._awardList
  self._awardsGen:SpawnObjects("UISeasonStageAwardItemS4", count)
...
function UISeasonStageSingleAwardListS4:SetWaitAnim()
  if self._list then
...
function UISeasonStageSingleAwardListS4:PlayAnim(totalAnimDelay)
  if self._list then
