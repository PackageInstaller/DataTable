_class("UISeasonItemS8", UICustomWidget)
UISeasonItemS8 = UISeasonItemS8

function UISeasonItemS8:Constructor()
  self.mRole = GameGlobal.GetModule(RoleModule)
  self.colorTxtCount = Color.white
end

function UISeasonItemS8:OnShow()
...
function UISeasonItemS8:OnHide()
  self.imgIcon:DestoryLastImage()
end

function UISeasonItemS8:Flush(roleAsset, funcClick, notShowTips)
...
function UISeasonItemS8:SetFin(show)
  self:GetGameObject("_fin"):SetActive(show)
end

function UISeasonItemS8:FormatCount(count)
...
function UISeasonItemS8:TxtCountRedIfNotEnough(cost)
...
function UISeasonItemS8:SetNotShowTips(notShowTips)
  self._notShowTips = notShowTips
end

function UISeasonItemS8:BtnOnClick(go)
...
function UISeasonItemS8:GetBtn()
  return self.bgGo
end

function UISeasonItemS8:SetRect(scale)
