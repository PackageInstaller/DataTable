_class("UISeasonResultSingleAwardListS8", UICustomWidget)
UISeasonResultSingleAwardListS8 = UISeasonResultSingleAwardListS8

function UISeasonResultSingleAwardListS8:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonResultSingleAwardListS8:InitWidget()
...
function UISeasonResultSingleAwardListS8:OnHide()
end

function UISeasonResultSingleAwardListS8:SetData(awardsTb)
  self._taskIDList = {}
  ...
  self._awardsGen:SpawnObjects("UIWidgetSeasonResultRewardS8", count)
