_class("UISeasonMainOvalAreaS4", UICustomWidget)
UISeasonMainOvalAreaS4 = UISeasonMainOvalAreaS4

function UISeasonMainOvalAreaS4:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonMainOvalAreaS4:InitWidget()
  self._tipsParent = self:GetUIComponent("Transform", "tips")
end

function UISeasonMainOvalAreaS4:SetData()
end

function UISeasonMainOvalAreaS4:OnHide()
...
function UISeasonMainOvalAreaS4:AddTarget(target, type)
  if self._tips[target] then
    Log.error("duplicate target")
    return
  end
  local prefab = self:_LoadPrefab()
  local tip = UISeasonMainOvalTipS4:New(self._seasonID, prefab, function(tip)
...
function UISeasonMainOvalAreaS4:RemoveTarget(obj)
...
function UISeasonMainOvalAreaS4:GetTipByType(type)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS4:Update(dt)
  for _, tip in pairs(self._tips) do
...
function UISeasonMainOvalAreaS4:_LoadPrefab()
...
function UISeasonMainOvalAreaS4:_ReleaseTip(req)
  req:Dispose()
end

function UISeasonMainOvalAreaS4:_ScreenToOval(screenPos)
  return screenPos - self._ovalCenter
end

function UISeasonMainOvalAreaS4:_OnTipClick(tip)
...
function UISeasonMainOvalAreaS4:_RefreshMainLevelTarget()
...
function UISeasonMainOvalAreaS4:_RefreshDailyLevelTarget()
...
function UISeasonMainOvalAreaS4:_RefreshBoxTarget()
...
function UISeasonMainOvalAreaS4:_RefreshPlayer()
...
function UISeasonMainOvalAreaS4:_RefreshTarget()
  self:_RefreshMainLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshTask()
end

function UISeasonMainOvalAreaS4:_OnModeChanged()
  self:_RefreshMainLevelTarget()
  self:_RefreshDailyLevelTarget()
  self:_RefreshBoxTarget()
  self:_RefreshPlayer()
...
function UISeasonMainOvalAreaS4:_RefreshTask()
  local oldTips = {}
  for _, tip in pairs(self._tips) do
