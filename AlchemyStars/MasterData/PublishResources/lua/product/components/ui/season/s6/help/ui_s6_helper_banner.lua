_class("UIS6HelperBanner", UICustomWidget)
UIS6HelperBanner = UIS6HelperBanner

function UIS6HelperBanner:OnShow()
  self:InitWidget()
end

function UIS6HelperBanner:OnHide()
...
function UIS6HelperBanner:SetData(tabIndex)
  if tabIndex then
...
function UIS6HelperBanner:InitWidget()
  ...
  self._cellWidget1 = cellGen1:SpawnObject("UIS6HelperBannerItem")
  local cellGen2 = self:GetUIComponent("UISelectObjectPath", "CellArea2")
  self._cellWidget2 = cellGen2:SpawnObject("UIS6HelperBannerItem")
...
function UIS6HelperBanner:ScrollToIndex(tarIdx)
...
function UIS6HelperBanner:ImageLeftOnClick(go)
...
function UIS6HelperBanner:ImageRightOnClick(go)
  AudioHelperController.PlayUISoundAutoRelease(CriAudioIDConst.SoundDefaultClick)
  if self._count <= 1 then
    return
  end
...
function UIS6HelperBanner:InitScrollView()
...
function UIS6HelperBanner:_RefreshArrowBtn()
  local showLeft = true
...
function UIS6HelperBanner:_MatchOpenTime(cfgTab)
...
function UIS6HelperBanner:_CreateScrollData()
  self._carouselTab = {}
...
function UIS6HelperBanner:_CreateScrollItem()
  self._grid = self:GetUIComponent("UISelectObjectPath", "grid")
  self._grid:SpawnObjects("UIS6HelperBannerIdxItem", self._count)
...
function UIS6HelperBanner:_SetScrollCellData(cellWidget, dataIndex)
...
function UIS6HelperBanner:_CreateScrollEvent()
  do return end
...
function UIS6HelperBanner:_SetCellForNormal()
...
function UIS6HelperBanner:_SetCellForAnim()
  self._cellArea1Go:SetActive(true)
...
function UIS6HelperBanner:OnUpdate(deltaTimeMS)
  if self._isScrollReady and self._count <= 1 then
    return
  end
end

function UIS6HelperBanner:_PlayScrollAnim(bDown)
  self._cellCanvas1.alpha = 1
