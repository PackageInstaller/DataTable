_class("UISeasonBuffMainAreaS7", UICustomWidget)
UISeasonBuffMainAreaS7 = UISeasonBuffMainAreaS7

function UISeasonBuffMainAreaS7:OnShow(uiParams)
...
function UISeasonBuffMainAreaS7:DetailBtnOnClick()
...
function UISeasonBuffMainAreaS7:SetData(obj)
  self._seasonObj = obj
  self._progressCells = self.progressCellsGen:SpawnObject("UISeasonBuffProgressCellsS7")
  self:RefreshInfo()
end

function UISeasonBuffMainAreaS7:RefreshInfo()
