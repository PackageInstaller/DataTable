_class("UISeasonActionPointTipS6", UIController)
UISeasonActionPointTipS6 = UISeasonActionPointTipS6

function UISeasonActionPointTipS6:LoadDataOnEnter(TT, res)
  res:SetSucc(true)
end

function UISeasonActionPointTipS6:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonActionPointTipS6:OnHide()
  if self._timer then
...
function UISeasonActionPointTipS6:InitWidget()
...
function UISeasonActionPointTipS6:BgOnClick(go)
  self:CloseDialog()
end

function UISeasonActionPointTipS6:_Countdown()
...
function UISeasonActionPointTipS6:_ReqFlush(TT)
