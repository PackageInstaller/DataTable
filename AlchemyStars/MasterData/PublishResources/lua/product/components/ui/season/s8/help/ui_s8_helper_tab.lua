_class("UIS8HelperTab", UICustomWidget)
UIS8HelperTab = UIS8HelperTab

function UIS8HelperTab:OnShow(uiParams)
  self:InitWidget()
end

function UIS8HelperTab:InitWidget()
...
function UIS8HelperTab:OnHide()
end

function UIS8HelperTab:TabBtnOnClick()
...
function UIS8HelperTab:SetData(tabCfg, callback)
  self._tabCfg = tabCfg
...
function UIS8HelperTab:OnSelectIndex(tabId)
  if self._selectedGo then
