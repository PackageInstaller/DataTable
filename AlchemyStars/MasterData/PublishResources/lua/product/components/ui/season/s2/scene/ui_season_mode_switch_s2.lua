_class("UISeasonModeSwitchS2", UICustomWidget)
UISeasonModeSwitchS2 = UISeasonModeSwitchS2

function UISeasonModeSwitchS2:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonModeSwitchS2:OnHide()
...
function UISeasonModeSwitchS2:InitWidget()
...
function UISeasonModeSwitchS2:SetData(seasonObj)
...
function UISeasonModeSwitchS2:BtnMode1OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode1)
end

function UISeasonModeSwitchS2:BtnMode2OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode2)
end

function UISeasonModeSwitchS2:BtnSwitchOnClick(go)
  local mode
...
function UISeasonModeSwitchS2:_SwitchTo(mode)
...
function UISeasonModeSwitchS2:_CheckModeValid(mode)
...
function UISeasonModeSwitchS2:_Switch(TT, mode)
  self:Lock("UISeasonModeSwitchS2:SwitchMode")
  self._anim:Stop()
  self._anim:Play()
  YIELD(TT, 200)
  if self.view then
  ...
  self:UnLock("UISeasonModeSwitchS2:SwitchMode")
end

function UISeasonModeSwitchS2:_RefreshBtn(mode)
...
function UISeasonModeSwitchS2:_OnModeChanged()
  self._curMode = self._mapManager:Mode()
  self:_RefreshBtn(self._curMode)
end

function UISeasonModeSwitchS2:_OnEventPointProgressChange()
  self._canSwitch = self:_CheckModeValid(SeasonMapMode.Mode2)
  self._root:SetActive(self._canSwitch)
end
