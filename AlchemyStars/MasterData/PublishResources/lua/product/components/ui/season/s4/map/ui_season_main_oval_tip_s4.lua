_class("UISeasonMainOvalTipS4", Object)
UISeasonMainOvalTipS4 = UISeasonMainOvalTipS4

function UISeasonMainOvalTipS4:Constructor(seasonID, req, onClick)
...
function UISeasonMainOvalTipS4:TargetWorldPos()
...
function UISeasonMainOvalTipS4:Show()
  self._isIn = false
  local show = true
...
function UISeasonMainOvalTipS4:Hide()
  self._isIn = true
  self._gameObject:SetActive(false)
end

function UISeasonMainOvalTipS4:Delete()
  self._req = nil
...
function UISeasonMainOvalTipS4:GetReq()
  return self._req
end

function UISeasonMainOvalTipS4:Dispose()
  self._req:Dispose()
  self:Delete()
end

function UISeasonMainOvalTipS4:IsInOval()
  return self._isIn
end

function UISeasonMainOvalTipS4:Sync(pos, rot)
  self._rectTransform.anchoredPosition = pos
  self._arrowRect.localRotation = rot
end

function UISeasonMainOvalTipS4:Type()
  return self._type
end

function UISeasonMainOvalTipS4:Target()
  return self._target
end

function UISeasonMainOvalTipS4:IconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS4:ArrowIconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS4:ResetTarget(target, type)
  self._uiView:SetShow(false, self)
  self._uiView:SetShow(true, self)
  self._type = type
...
function UISeasonMainOvalTipS4:GetCanShowDistance(cameraSize)
...
function UISeasonMainOvalTipS4:_RefreshIcon()
  if self._type == UISeasonOvalTipType.Player then
    ...
    local s4Atlas = UIResourceManager.GetAsset("UIS4Scene.spriteatlas", LoadType.SpriteAtlas, self._name2Asset)
    self._iconImg.sprite = s4Atlas:GetSprite(player:CurModule():Cfg().PlayIconOval)
  elseif self._type == UISeasonOvalTipType.Mission then
...
function UISeasonMainOvalTipS4:_RefreshIconBackTrack()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_s1_map_icon05")
