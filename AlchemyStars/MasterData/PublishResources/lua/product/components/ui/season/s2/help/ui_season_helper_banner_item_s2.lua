_class("UISeasonHelperBannerItemS2", UICustomWidget)
UISeasonHelperBannerItemS2 = UISeasonHelperBannerItemS2

function UISeasonHelperBannerItemS2:OnShow()
end

function UISeasonHelperBannerItemS2:OnHide()
end

function UISeasonHelperBannerItemS2:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UISeasonHelperBannerItemS2:BtnOnClick()
end

function UISeasonHelperBannerItemS2:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
