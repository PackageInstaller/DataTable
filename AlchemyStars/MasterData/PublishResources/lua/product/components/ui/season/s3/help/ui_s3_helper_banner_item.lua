_class("UIS3HelperBannerItem", UICustomWidget)
UIS3HelperBannerItem = UIS3HelperBannerItem

function UIS3HelperBannerItem:OnShow()
end

function UIS3HelperBannerItem:OnHide()
end

function UIS3HelperBannerItem:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UIS3HelperBannerItem:BtnOnClick()
end

function UIS3HelperBannerItem:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
