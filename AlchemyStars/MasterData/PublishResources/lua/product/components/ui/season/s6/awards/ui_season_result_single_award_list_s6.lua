_class("UISeasonResultSingleAwardListS6", UICustomWidget)
UISeasonResultSingleAwardListS6 = UISeasonResultSingleAwardListS6

function UISeasonResultSingleAwardListS6:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonResultSingleAwardListS6:InitWidget()
...
function UISeasonResultSingleAwardListS6:OnHide()
end

function UISeasonResultSingleAwardListS6:SetData(awardsTb)
  self._taskIDList = {}
  ...
  self._awardsGen:SpawnObjects("UIWidgetSeasonResultRewardS6", count)
