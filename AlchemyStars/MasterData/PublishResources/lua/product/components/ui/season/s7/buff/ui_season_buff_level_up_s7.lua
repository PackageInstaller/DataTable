_class("UISeasonBuffLevelUpS7", UIController)
UISeasonBuffLevelUpS7 = UISeasonBuffLevelUpS7

function UISeasonBuffLevelUpS7:LoadDataOnEnter(TT, res, uiParams)
...
function UISeasonBuffLevelUpS7:OnShow(uiParams)
...
function UISeasonBuffLevelUpS7:OnUpdate(deltaTimeMS)
...
function UISeasonBuffLevelUpS7:FullScreenBtnOnClick(go)
