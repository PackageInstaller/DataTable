_class("UISeasonShowAwardsItemS6", UICustomWidget)
UISeasonShowAwardsItemS6 = UISeasonShowAwardsItemS6
local maxNumCount = 5

function UISeasonShowAwardsItemS6:OnShow(uiParams)
  ...
  self.uiItem = sop:SpawnObject("UISeasonItemS6")
end

function UISeasonShowAwardsItemS6:SetData(itemInfo, index, clickCallback, nameColor, tweenIdx, beforeTime)
...
function UISeasonShowAwardsItemS6:_PlayAnim()
  self._anim:Play("uieff_UIGetItemControllerItem")
end

function UISeasonShowAwardsItemS6:GetIndex()
  return self._index
end

function UISeasonShowAwardsItemS6:OnHide()
  if self._tweenEvent then
    GameGlobal.Timer():CancelEvent(self._tweenEvent)
    self._tweenEvent = nil
  end
...
function UISeasonShowAwardsItemS6:FormatItemCount(count)
