_class("UISeasonActionPointTipS5", UIController)
UISeasonActionPointTipS5 = UISeasonActionPointTipS5

function UISeasonActionPointTipS5:LoadDataOnEnter(TT, res)
  res:SetSucc(true)
end

function UISeasonActionPointTipS5:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonActionPointTipS5:OnHide()
  if self._timer then
...
function UISeasonActionPointTipS5:InitWidget()
...
function UISeasonActionPointTipS5:BgOnClick(go)
  self:CloseDialog()
end

function UISeasonActionPointTipS5:_Countdown()
...
function UISeasonActionPointTipS5:_ReqFlush(TT)
