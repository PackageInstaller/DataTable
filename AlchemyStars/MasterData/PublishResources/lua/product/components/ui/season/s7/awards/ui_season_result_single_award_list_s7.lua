_class("UISeasonResultSingleAwardListS7", UICustomWidget)
UISeasonResultSingleAwardListS7 = UISeasonResultSingleAwardListS7

function UISeasonResultSingleAwardListS7:OnShow(uiParams)
  self:InitWidget()
end

function UISeasonResultSingleAwardListS7:InitWidget()
...
function UISeasonResultSingleAwardListS7:OnHide()
end

function UISeasonResultSingleAwardListS7:SetData(awardsTb)
  self._taskIDList = {}
  ...
  self._awardsGen:SpawnObjects("UIWidgetSeasonResultRewardS7", count)
