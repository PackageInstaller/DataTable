_class("UISeasonStageAwardItemS2", UICustomWidget)
UISeasonStageAwardItemS2 = UISeasonStageAwardItemS2

function UISeasonStageAwardItemS2:OnShow()
  self._trans = self:GetGameObject()
  self:GetComponents()
end

function UISeasonStageAwardItemS2:GetComponents()
  self._trans = self:GetGameObject()
...
function UISeasonStageAwardItemS2:Flush(v, levelDiff)
  if not v then
    return
  end
  self._v = v
...
function UISeasonStageAwardItemS2:SetIcon(name, itemId)
...
function UISeasonStageAwardItemS2:ShowIcon(show, itemId)
  self._iconGO:SetActive(show)
  self:SetIconOffset(itemId)
end

function UISeasonStageAwardItemS2:SetIconOffset(itemId)
...
function UISeasonStageAwardItemS2:_IsPet(id)
  local cfg = Cfg.cfg_pet({ID = id})
  return cfg and true or false
end

function UISeasonStageAwardItemS2:SetQuality(quality)
  if quality <= 0 then
    quality = 1
  end
...
function UISeasonStageAwardItemS2:ShowQuality(show)
  self._qualityGO:SetActive(show)
end

function UISeasonStageAwardItemS2:SetText1(text, showNumber)
  if text ~= nil then
    local show = false
...
function UISeasonStageAwardItemS2:ShowText1(show)
  self._text1GO:SetActive(show)
  self:SetOffset(show)
end

function UISeasonStageAwardItemS2:SetOffset(showText1)
end

function UISeasonStageAwardItemS2:SetAwardText(awardText, color)
  self._awardTxt:SetText(awardText)
  self._awardTxt.color = color
end

function UISeasonStageAwardItemS2:SetTypeBg(typeBgName)
end

function UISeasonStageAwardItemS2:SetTypeMainBg(typeBgName)
  self._typeMainBgImg.sprite = self.atlas:GetSprite(typeBgName)
end

function UISeasonStageAwardItemS2:SetTopAward()
  self:SetTopText(self._topTextStr)
end

function UISeasonStageAwardItemS2:SetTopText(text)
...
function UISeasonStageAwardItemS2:ShowTopText(show)
  self._topGo:SetActive(show)
end

function UISeasonStageAwardItemS2:SetAct()
...
function UISeasonStageAwardItemS2:ShowText(show)
  self._actGo:SetActive(show)
end

function UISeasonStageAwardItemS2:BtnOnClick(go)
...
function UISeasonStageAwardItemS2:PlayAnim(totalDelay)
...
function UISeasonStageAwardItemS2:_PlayInAnim()
  if self._anim then
...
function UISeasonStageAwardItemS2:OnHide()
  if self._animTimer then
    GameGlobal.Timer():CancelEvent(self._animTimer)
    self._animTimer = nil
  end
...
function UISeasonStageAwardItemS2:SetWaitAnim()
  if self._rootGo then
