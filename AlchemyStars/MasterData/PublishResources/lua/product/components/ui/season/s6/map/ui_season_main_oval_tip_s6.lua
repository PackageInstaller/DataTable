_class("UISeasonMainOvalTipS6", Object)
UISeasonMainOvalTipS6 = UISeasonMainOvalTipS6

function UISeasonMainOvalTipS6:Constructor(seasonID, req, onClick)
  ...
  self._atlas = UIResourceManager.GetAsset("UIS6Main.spriteatlas", LoadType.SpriteAtlas, self._name2Asset)
end

function UISeasonMainOvalTipS6:TargetWorldPos()
...
function UISeasonMainOvalTipS6:Show()
  self._isIn = false
  local show = true
...
function UISeasonMainOvalTipS6:Hide()
  self._isIn = true
  self._gameObject:SetActive(false)
end

function UISeasonMainOvalTipS6:Delete()
  self._req = nil
...
function UISeasonMainOvalTipS6:GetReq()
  return self._req
end

function UISeasonMainOvalTipS6:Dispose()
  self._req:Dispose()
  self:Delete()
end

function UISeasonMainOvalTipS6:IsInOval()
  return self._isIn
end

function UISeasonMainOvalTipS6:Sync(pos, rot)
  self._rectTransform.anchoredPosition = pos
  self._arrowRect.localRotation = rot
end

function UISeasonMainOvalTipS6:Type()
  return self._type
end

function UISeasonMainOvalTipS6:Target()
  return self._target
end

function UISeasonMainOvalTipS6:IconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS6:ArrowIconOnClick()
  self._onClick(self)
end

function UISeasonMainOvalTipS6:ResetTarget(target, type)
  self._uiView:SetShow(false, self)
  self._uiView:SetShow(true, self)
  self._type = type
...
function UISeasonMainOvalTipS6:GetCanShowDistance(cameraSize)
...
function UISeasonMainOvalTipS6:_RefreshIcon()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S6_map_arrowhead_yellow")
  ...
  elseif self._type == UISeasonOvalTipType.Mission then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S6_map_arrowhead_red")
  elseif self._type == UISeasonOvalTipType.Daily then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S6_map_arrowhead_green")
  elseif self._type == UISeasonOvalTipType.Box then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S6_map_arrowhead_blue")
  elseif self._type == UISeasonOvalTipType.Task then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_s6_map_icon33")
  end
end

function UISeasonMainOvalTipS6:_RefreshIconBackTrack()
  if self._type == UISeasonOvalTipType.Player then
    self._arrowIcon.sprite = self._atlas:GetSprite("exp_S6_map_arrowhead_yellow")
