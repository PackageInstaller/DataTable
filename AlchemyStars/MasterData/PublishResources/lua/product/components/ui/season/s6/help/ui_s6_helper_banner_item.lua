_class("UIS6HelperBannerItem", UICustomWidget)
UIS6HelperBannerItem = UIS6HelperBannerItem

function UIS6HelperBannerItem:OnShow()
end

function UIS6HelperBannerItem:OnHide()
end

function UIS6HelperBannerItem:SetData(cfg, callbcak, begindrag, drag, enddrag)
  self._cfg = cfg
...
function UIS6HelperBannerItem:BtnOnClick()
end

function UIS6HelperBannerItem:Dispose()
  self._cfg = nil
  self._callback = nil
  self._icon = nil
end
