_class("UISeasonModeSwitchS5", UICustomWidget)
UISeasonModeSwitchS5 = UISeasonModeSwitchS5

function UISeasonModeSwitchS5:OnShow(uiParams)
  self:InitWidget()
...
function UISeasonModeSwitchS5:OnHide()
...
function UISeasonModeSwitchS5:InitWidget()
...
function UISeasonModeSwitchS5:SetData(seasonObj)
...
function UISeasonModeSwitchS5:BtnMode1OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode1)
end

function UISeasonModeSwitchS5:BtnMode2OnClick(go)
  self:_SwitchTo(SeasonMapMode.Mode2)
end

function UISeasonModeSwitchS5:BtnSwitchOnClick(go)
  local mode
...
function UISeasonModeSwitchS5:Switch2Modle2(finishCb)
  self:_SwitchTo(SeasonMapMode.Mode2, finishCb)
end

function UISeasonModeSwitchS5:_SwitchTo(mode, finishCb)
...
function UISeasonModeSwitchS5:_CheckModeValid(mode)
...
function UISeasonModeSwitchS5:_Switch(TT, mode, finishCb)
  self:Lock("UISeasonModeSwitchS5:SwitchMode")
  self._anim:Stop()
  ...
  YIELD(TT, 1000)
  self:UnLock("UISeasonModeSwitchS5:SwitchMode")
  if finishCb then
    finishCb()
  end
end

function UISeasonModeSwitchS5:_RefreshBtn(mode)
  if mode == SeasonMapMode.Mode1 then
...
function UISeasonModeSwitchS5:_OnModeChanged()
  self._curMode = self._mapManager:Mode()
  self:_RefreshBtn(self._curMode)
end

function UISeasonModeSwitchS5:_OnEventPointProgressChange()
  self._canSwitch = true
  self._root:SetActive(self._canSwitch)
end
