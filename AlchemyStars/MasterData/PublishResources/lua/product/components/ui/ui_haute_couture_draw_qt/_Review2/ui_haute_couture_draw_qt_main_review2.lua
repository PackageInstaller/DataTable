...
_class("UIHauteCoutureDraw_QT_Main_Review2", UIHauteCoutureDrawBase)
UIHauteCoutureDraw_QT_Main_Review2 = UIHauteCoutureDraw_QT_Main_Review2

function UIHauteCoutureDraw_QT_Main_Review2:Constructor()
  self._allPrizes = {}
  self._EnterAniKey = nil
end

function UIHauteCoutureDraw_QT_Main_Review2:CloseSelf()
  if self._rt then
    self._rt:Release()
    self._rt = nil
  end
...
function UIHauteCoutureDraw_QT_Main_Review2:OnShow(uiParams)
  self:InitWidgets()
  self:_OnValue()
...
function UIHauteCoutureDraw_QT_Main_Review2:OnHide()
...
function UIHauteCoutureDraw_QT_Main_Review2:GetEnterAniKey()
...
function UIHauteCoutureDraw_QT_Main_Review2:InitWidgets()
...
function UIHauteCoutureDraw_QT_Main_Review2:GetCoinId()
  return self.controller.CtxData:CostItemID()
end

function UIHauteCoutureDraw_QT_Main_Review2:_OnValue()
...
function UIHauteCoutureDraw_QT_Main_Review2:GetSkinId()
  return 91484
end

function UIHauteCoutureDraw_QT_Main_Review2:_LoadVideo()
...
function UIHauteCoutureDraw_QT_Main_Review2:LoadVideo(url)
...
function UIHauteCoutureDraw_QT_Main_Review2:_LoadPrize()
...
function UIHauteCoutureDraw_QT_Main_Review2:_RefreshReward()
...
function UIHauteCoutureDraw_QT_Main_Review2:ItemCountChanged()
  self:_RefreshReward()
end

function UIHauteCoutureDraw_QT_Main_Review2:IsAllAwardCollected()
  return #self.controller._componentInfo.shake_win_ids == #self._allPrizes
end

function UIHauteCoutureDraw_QT_Main_Review2:HandleDrawBtnClick()
...
function UIHauteCoutureDraw_QT_Main_Review2:CanDrawSpecialAward()
  return self.controller._componentInfo.shake_num >= 5
end

function UIHauteCoutureDraw_QT_Main_Review2:DrawAnim(TT)
  self:Lock("UIHauteCoutureDraw_QT_Main_Review2:drawBtnOnClick")
  ...
  if not result or not result:GetSucc() then
    self:UnLock("UIHauteCoutureDraw_QT_Main_Review2:drawBtnOnClick")
    return
  end
...
function UIHauteCoutureDraw_QT_Main_Review2:CheckAllPrizeCollected()
  if self:IsAllAwardCollected() then
...
function UIHauteCoutureDraw_QT_Main_Review2:VideoMaskOnClick(go)
  self:HandleFgBtnClick()
end

function UIHauteCoutureDraw_QT_Main_Review2:VideoMaskOnClick1(go)
...
function UIHauteCoutureDraw_QT_Main_Review2:CheckEndTime()
...
function UIHauteCoutureDraw_QT_Main_Review2:CheckAndDoEnterAni(TT)
...
function UIHauteCoutureDraw_QT_Main_Review2:_EnterRoot()
  self._rootGo:SetActive(true)
  self._rootAni:Play("UIHauteCoutureDraw_QT_Main_Review2_in")
  self:_LoadVideo()
  self:_LoadPrize()
  self:CheckAllPrizeCollected()
...
function UIHauteCoutureDraw_QT_Main_Review2:_CheckDuplicateAutoTip()
  if self.hasDuplicate then
    local key = self:GetAutoDuplicateTipsKey()
    if not UnityEngine.PlayerPrefs.HasKey(key) then
      UnityEngine.PlayerPrefs.SetInt(key, 1)
      self:Lock("UIHauteCoutureDraw_QT_Main_Review2_duplicateTips")
      self:StartTask(function(TT)
        YIELD(TT, 1000)
        self:UnLock("UIHauteCoutureDraw_QT_Main_Review2_duplicateTips")
...
function UIHauteCoutureDraw_QT_Main_Review2:GetAutoDuplicateTipsKey()
...
function UIHauteCoutureDraw_QT_Main_Review2:ShowItemInfo(item, pos)
...
function UIHauteCoutureDraw_QT_Main_Review2:DuplicateTipOnClick()
  self:ShowDialog("UIHauteCoutureDuplicateReward", self._prizes, self._replaceIdxs)
end

function UIHauteCoutureDraw_QT_Main_Review2:SpineAreaOnClick(go)
