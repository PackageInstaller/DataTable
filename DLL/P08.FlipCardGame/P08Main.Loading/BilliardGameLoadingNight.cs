...
public class BilliardGameLoadingNight : CustomLoadingBase
{
	private static string UIPath = "Widget/System/Activity_SummerPub/MainPub/DayNightCutSceneLoading_Night";

	private GameObject billiardLoading;

	private PlayableDirector director;

	public static BilliardGameLoadingNight Instance;
	...
	{
		return LoadingImpl.BilliardGame_Night;
	}
	...
	public override void ShowLoadUI()
	{
		...
		AudioManager.Instance.Play("effect", "minigame_activity_4_3", "minigame_activity_4_3_marble_ui_turn01", useStream: false);
