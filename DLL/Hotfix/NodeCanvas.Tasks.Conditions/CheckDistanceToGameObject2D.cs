...
public class CheckDistanceToGameObject2D : ConditionTask<Transform>
{
	...
	{
		return OperationTools.Compare(Vector2.Distance(base.agent.position, checkTarget.value.transform.position), distance.value, checkType, floatingPoint);
	}
	...
	public override void OnDrawGizmosSelected()
	{
		if (base.agent != null)
		{
			Gizmos.DrawWireSphere((Vector2)base.agent.position, distance.value);
		}
	}
}
