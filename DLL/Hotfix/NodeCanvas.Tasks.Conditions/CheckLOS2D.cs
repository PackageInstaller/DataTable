...
public class CheckLOS2D : ConditionTask<Transform>
{
	...
	{
		hits = Physics2D.LinecastAll((Vector2)base.agent.position, (Vector2)LOSTarget.value.transform.position, (int)layerMask.value);
		foreach (Collider2D item in hits.Select((RaycastHit2D h) => ((RaycastHit2D)(ref h)).collider))
		{
			if ((Object)(object)item != (Object)(object)agentCollider && (Object)(object)item != (Object)(object)LOSTarget.value.GetComponent<Collider2D>())
			{
				return false;
			}
		}
