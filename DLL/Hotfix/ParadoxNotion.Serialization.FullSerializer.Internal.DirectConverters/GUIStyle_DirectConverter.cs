...
public class GUIStyle_DirectConverter : fsDirectConverter<GUIStyle>
{
	protected override fsResult DoSerialize(GUIStyle model, Dictionary<string, fsData> serialized)
	{
		...
		return fsResult.Success + SerializeMember<GUIStyleState>(serialized, null, "active", model.active) + SerializeMember<TextAnchor>(serialized, null, "alignment", model.alignment) + SerializeMember(serialized, null, "border", model.border) + SerializeMember<TextClipping>(serialized, null, "clipping", model.clipping) + SerializeMember(serialized, null, "contentOffset", model.contentOffset) + SerializeMember(serialized, null, "fixedHeight", model.fixedHeight) + SerializeMember(serialized, null, "fixedWidth", model.fixedWidth) + SerializeMember<GUIStyleState>(serialized, null, "focused", model.focused) + SerializeMember<Font>(serialized, null, "font", model.font) + SerializeMember(serialized, null, "fontSize", model.fontSize) + SerializeMember<FontStyle>(serialized, null, "fontStyle", model.fontStyle) + SerializeMember<GUIStyleState>(serialized, null, "hover", model.hover) + SerializeMember<ImagePosition>(serialized, null, "imagePosition", model.imagePosition) + SerializeMember(serialized, null, "margin", model.margin) + SerializeMember(serialized, null, "name", model.name) + SerializeMember<GUIStyleState>(serialized, null, "normal", model.normal) + SerializeMember<GUIStyleState>(serialized, null, "onActive", model.onActive) + SerializeMember<GUIStyleState>(serialized, null, "onFocused", model.onFocused) + SerializeMember<GUIStyleState>(serialized, null, "onHover", model.onHover) + SerializeMember<GUIStyleState>(serialized, null, "onNormal", model.onNormal) + SerializeMember(serialized, null, "overflow", model.overflow) + SerializeMember(serialized, null, "padding", model.padding) + SerializeMember(serialized, null, "richText", model.richText) + SerializeMember(serialized, null, "stretchHeight", model.stretchHeight) + SerializeMember(serialized, null, "stretchWidth", model.stretchWidth) + SerializeMember(serialized, null, "wordWrap", model.wordWrap);
	}
