...
public class PropertyViceBuff : BuffOperationBase<BuffDataPropertyVice>
{
	...
	protected override void OnExecute()
	{
		...
		case PropertyType.Init:
			...
			break;
		case PropertyType.Cur:
			base.buffOwner.SetPropertyBuff(dataBase.propertyKey, num3 + num, isIgnoreMax: false, base.config.FinishClearOperations);
			break;
		}
	...
	protected override void OnDispose()
	{
		...
		case PropertyType.Init:
			...
			break;
		case PropertyType.Cur:
			num = base.buffOwner.GetPropertyBuff(dataBase.propertyKey);
			break;
		}
		switch (dataBase.propertyType)
		{
