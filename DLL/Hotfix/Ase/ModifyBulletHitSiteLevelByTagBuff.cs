...
public class ModifyBulletHitSiteLevelByTagBuff : BuffOperationBase<BuffDataModifyBulletHitSiteLevelByTag>
{
	...
	protected override void OnExecute()
	{
		...
		if (system != null)
		{
			...
			{
				modifyEnum = BulletModifyEnum.BulletLabel,
				bulletLabel = dataBase.bulletLabel,
