...
public class CinemachineTriggerAction : MonoBehaviour
{
			...
			if (target != null)
			{
				...
				case Mode.Play:
				{
					...
					else
					{
						...
						if ((UnityEngine.Object)(object)component4 != null)
						{
							component4.Play();
						}
					}
	...
	{
		InternalDoTriggerEnter(((Component)(object)other).gameObject);
	}

	private void OnTriggerExit(Collider other)
	{
		InternalDoTriggerExit(((Component)(object)other).gameObject);
	}
