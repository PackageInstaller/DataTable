...
public class UnityEngine_UI_ButtonWrap
{
	...
	{
		L.BeginClass(typeof(Button), typeof(Selectable));
		...
		L.RegFunction("SetRaycastTargetEx", SetRaycastTargetEx);
		L.RegFunction("SetRaycastTarget", SetRaycastTarget);
		L.RegFunction("GetInteractable", GetInteractable);
	...
	private static int OnPointerClick(IntPtr L)
	{
		try
		{
			...
			Button obj = (Button)ToLua.CheckObject<Button>(L, 1);
	...
	private static int ShowHideByScale(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			Button cmpt = (Button)ToLua.CheckObject<Button>(L, 1);
	...
	private static int GetHorizontalOrVerticalLayoutGroupSpacing(IntPtr L)
	{
		try
		{
			...
			float horizontalOrVerticalLayoutGroupSpacing = ((Button)ToLua.CheckObject<Button>(L, 1)).GetHorizontalOrVerticalLayoutGroupSpacing();
	...
	private static int GetLayoutGroupPaddingTop(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			int layoutGroupPaddingTop = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLayoutGroupPaddingTop();
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int SetRaycastTargetEx(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			Button btn = (Button)ToLua.CheckObject<Button>(L, 1);
			bool enable = LuaDLL.luaL_checkboolean(L, 2);
			btn.SetRaycastTargetEx(enable);
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetRaycastTarget(IntPtr L)
	{
		try
		{
			...
			if (num == 2 && TypeChecker.CheckTypes<Button, bool>(L, 1))
			{
				Button btn = (Button)ToLua.ToObject(L, 1);
				bool enable = LuaDLL.lua_toboolean(L, 2);
				btn.SetRaycastTarget(enable);
				return 0;
			}
			if (num == 2 && TypeChecker.CheckTypes<Component, bool>(L, 1))
			{
				Button btn2 = (Button)ToLua.ToObject(L, 1);
				bool enable2 = LuaDLL.lua_toboolean(L, 2);
				btn2.SetRaycastTarget(enable2);
				return 0;
			}
			return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Button.SetRaycastTarget");
		}
		catch (Exception e)
		{
			return LuaDLL.toluaL_exception(L, e);
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int GetInteractable(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			bool interactable = ((Button)ToLua.CheckObject<Button>(L, 1)).GetInteractable();
	...
	[MonoPInvokeCallback(typeof(LuaCSFunction))]
	private static int RemoveAllListener(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).RemoveAllListener();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetGraphicColor(IntPtr L)
	{
		try
		{
			...
			Button button = (Button)ToLua.CheckObject<Button>(L, 1);
			...
			button.SetGraphicColor(r, g, b, a);
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetGraphicGray(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetGraphicGray();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetGraphicWhite(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetGraphicWhite();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int CopyRectTransform(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			Button srcBtn = (Button)ToLua.CheckObject<Button>(L, 1);
			Button tarBtn = (Button)ToLua.CheckObject<Button>(L, 2);
			bool value = srcBtn.CopyRectTransform(tarBtn);
	...
	private static int GetRectSize(IntPtr L)
	{
		try
		{
			...
			((Button)ToLua.CheckObject<Button>(L, 1)).GetRectSize(out var width, out var height);
	...
	private static int GetRectHeight(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetRectHeight(out var height);
			LuaDLL.lua_pushnumber(L, height);
			return 1;
		}
		catch (Exception e)
	...
	private static int GetRectWidth(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float rectWidth = ((Button)ToLua.CheckObject<Button>(L, 1)).GetRectWidth();
	...
	private static int GetAnchoredPositionY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetAnchoredPositionY(out var y);
	...
	private static int GetAnchoredPositionX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetAnchoredPositionX(out var x);
	...
	private static int GetAnchoredPosition(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 3);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetAnchoredPosition(out var x, out var y);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
			return 2;
		}
	...
	private static int GetSizeDeltaY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetSizeDeltaY(out var y);
			LuaDLL.lua_pushnumber(L, y);
			return 1;
		}
		catch (Exception e)
	...
	private static int GetSizeDeltaX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 2);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetSizeDeltaX(out var x);
			LuaDLL.lua_pushnumber(L, x);
			return 1;
		}
		catch (Exception e)
	...
	private static int GetSizeDeltaEx(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 3);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetSizeDeltaEx(out var x, out var y);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
			return 2;
		}
	...
	private static int RotateAxisY(IntPtr L)
	{
		try
		{
			...
			case 2:
			{
				Button cmpt2 = (Button)ToLua.CheckObject<Button>(L, 1);
			...
			default:
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.Button.RotateAxisY");
			}
		}
		catch (Exception e)
		{
	...
	private static int GetLocalEulerAngleZ(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localEulerAngleZ = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalEulerAngleZ();
	...
	private static int GetLocalEulerAngleY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localEulerAngleY = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalEulerAngleY();
	...
	private static int GetLocalEulerAngleX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localEulerAngleX = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalEulerAngleX();
	...
	private static int GetEulerAngleY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float eulerAngleY = ((Button)ToLua.CheckObject<Button>(L, 1)).GetEulerAngleY();
	...
	private static int GetEulerAngle(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Vector3 eulerAngle = ((Button)ToLua.CheckObject<Button>(L, 1)).GetEulerAngle();
	...
	private static int GetLocalEulerAngle(IntPtr L)
	{
		try
		{
			...
			((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalEulerAngle(out var x, out var y, out var z);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
	...
	private static int GetLocalEulerAngleOrigin(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Vector3 localEulerAngleOrigin = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalEulerAngleOrigin();
	...
	private static int SetLocalRotationOne(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetLocalRotationOne();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int GetLocalScaleX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localScaleX = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalScaleX();
	...
	private static int GetLocalScaleEx(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 4);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalScaleEx(out var x, out var y, out var z);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
			LuaDLL.lua_pushnumber(L, z);
			return 3;
	...
	private static int GetLocalScale(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Vector3 localScale = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalScale();
	...
	private static int SetLocalScaleOne(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetLocalScaleOne();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int SetLocalScaleZero(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetLocalScaleZero();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int GetPositionEx(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 4);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetPositionEx(out var x, out var y, out var z);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
			LuaDLL.lua_pushnumber(L, z);
			return 3;
	...
	private static int GetPositionY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float positionY = ((Button)ToLua.CheckObject<Button>(L, 1)).GetPositionY();
	...
	private static int GetPositionX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float positionX = ((Button)ToLua.CheckObject<Button>(L, 1)).GetPositionX();
	...
	private static int GetPosition(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Vector3 position = ((Button)ToLua.CheckObject<Button>(L, 1)).GetPosition();
	...
	private static int SetPostionZero(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetPostionZero();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int GetLocalPositionY(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localPositionY = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalPositionY();
	...
	private static int GetLocalPositionX(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			float localPositionX = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalPositionX();
	...
	private static int GetLocalPositionEx(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 4);
			((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalPositionEx(out var x, out var y, out var z);
			LuaDLL.lua_pushnumber(L, x);
			LuaDLL.lua_pushnumber(L, y);
			LuaDLL.lua_pushnumber(L, z);
			return 3;
	...
	private static int GetLocalPosition(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			Vector3 localPosition = ((Button)ToLua.CheckObject<Button>(L, 1)).GetLocalPosition();
	...
	private static int SetLocalPositionZero(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).SetLocalPositionZero();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int InitTransform(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			((Button)ToLua.CheckObject<Button>(L, 1)).InitTransform();
			return 0;
		}
		catch (Exception e)
		{
	...
	private static int get_onClick(IntPtr L)
	{
		...
		try
		{
			...
			Button.ButtonClickedEvent onClick = ((Button)obj).onClick;
	...
	private static int set_onClick(IntPtr L)
	{
		...
		{
			obj = ToLua.ToObject(L, 1);
			Button obj2 = (Button)obj;
			Button.ButtonClickedEvent onClick = (Button.ButtonClickedEvent)ToLua.CheckObject<Button.ButtonClickedEvent>(L, 2);
