...
public class Alpha_uveffect_blend : MonoBehaviour, IMaterialModifier
{
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			...
			_material.SetFloat(ShaderID._Min, _Min);
			_material.SetFloat(ShaderID._Max, _Max);
