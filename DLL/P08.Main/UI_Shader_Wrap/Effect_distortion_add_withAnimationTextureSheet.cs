...
public class Effect_distortion_add_withAnimationTextureSheet : MonoBehaviour, IMaterialModifier
{
	private class ShaderID
	{
		public static readonly int _SpriteParams = Shader.PropertyToID("_SpriteParams");

		public static readonly int _X_Tile = Shader.PropertyToID("_X_Tile");

		public static readonly int _Y_Tile = Shader.PropertyToID("_Y_Tile");

		public static readonly int _CurrentTile = Shader.PropertyToID("_CurrentTile");
	...
	[Range(1f, 10f)]
	public float _X_Tile = 1f;

	[Range(1f, 10f)]
	public float _Y_Tile = 1f;

	public float _CurrentTile;
	...
	internal void UpdateMaterial()
	{
		if (!(_material == null))
		{
			_material.SetFloat(ShaderID._X_Tile, _X_Tile);
			_material.SetFloat(ShaderID._Y_Tile, _Y_Tile);
			_material.SetFloat(ShaderID._CurrentTile, _CurrentTile);
