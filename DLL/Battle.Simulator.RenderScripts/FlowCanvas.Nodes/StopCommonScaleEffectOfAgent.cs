...
[Name("移除特效(绑定)(渲染)", 0)]
[Category("Render/函数")]
[Description("停止【创建特效(绑定)】节点创建出来的特效\n特效路径对应【创建特效(绑定)】中的路径字段")]
public class StopCommonScaleEffectOfAgent : FlowControlNode
{
	protected override void RegisterPorts()
	{
		...
		AddFlowInput("In", "input", delegate(Flow f)
		{
			...
			{
				agent.ComponentTimeline.StopCommonTimeScaleEffect(effectNameInput.value);
				Out.Call(f);
			}
		});
	}
