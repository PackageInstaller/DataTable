...
[Name("得到连携奥义结束资源路径(渲染)", 0)]
[Category("Render/奥义")]
[Description("如题")]
public class GetCooperateUniqueSkillEndAssetPath : FlowControlNode
{
	private ValueInput<int> _CooperateUniqueSkillIDInput;

	private FlowOutput _Out;

	private FlowOutput _Empty;
	...
	protected override void RegisterPorts()
	{
		...
		_Empty = AddFlowOutput("Empty", "empty");
