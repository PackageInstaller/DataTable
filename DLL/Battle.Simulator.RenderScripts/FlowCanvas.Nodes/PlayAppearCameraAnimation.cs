...
public class PlayAppearCameraAnimation : FlowNode
{
	protected override void RegisterPorts()
	{
		...
		AddFlowInput("", delegate(Flow f)
		{
			...
			component.GetCinemachineComponent<CinemachineComposer>().m_TrackedObjectOffset = virtualCameraParam.composer.m_TrackedObjectOffset;
