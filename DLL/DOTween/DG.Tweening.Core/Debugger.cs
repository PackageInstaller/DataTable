...
public static class Debugger
{
	...
	public static void Log(object message)
	{
		...
		if (DOTween.onWillLog == null || DOTween.onWillLog((LogType)3, text))
		{
	...
	public static void LogWarning(object message, Tween t = null)
	{
		...
		if (DOTween.onWillLog == null || DOTween.onWillLog((LogType)2, text))
		{
	...
	{
		string text = ((!DOTween.debugMode) ? ("<color=#0099bc><b>DOTWEEN ► </b></color>" + message) : ("<color=#0099bc><b>DOTWEEN ► </b></color>" + GetDebugDataMessage(t) + message));
		if (DOTween.onWillLog == null || DOTween.onWillLog((LogType)0, text))
		{
