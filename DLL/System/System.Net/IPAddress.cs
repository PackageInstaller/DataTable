...
public class IPAddress
{
	...
	public static bool TryParse(string ipString, out IPAddress address)
	{
		...
		address = IPAddressParser.Parse(MemoryExtensions.AsSpan(ipString), tryParse: true);
		return address != null;
	}
	...
	public static IPAddress Parse(string ipString)
	{
		...
		return IPAddressParser.Parse(MemoryExtensions.AsSpan(ipString), tryParse: false);
	}
	...
	public override int GetHashCode()
	{
		...
		if (IsIPv6)
		{
			...
			hashCode = System.Marvin.ComputeHash32(span, System.Marvin.DefaultSeed);
		}
		else
		{
			hashCode = System.Marvin.ComputeHash32(MemoryMarshal.AsBytes(MemoryMarshal.CreateReadOnlySpan(ref _addressOrScopeId, 1)), System.Marvin.DefaultSeed);
		}
		_hashCode = hashCode;
		return _hashCode;
	}
