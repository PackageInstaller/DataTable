...
public struct RenderTargetIdentifier : IEquatable<RenderTargetIdentifier>
{
	...
	{
		return UnityString.Format("Type {0} NameID {1} InstanceID {2} BufferPointer {3} MipLevel {4} CubeFace {5} DepthSlice {6}", new object[7] { m_Type, m_NameID, m_InstanceID, m_BufferPointer, m_MipLevel, m_CubeFace, m_DepthSlice });
	}
