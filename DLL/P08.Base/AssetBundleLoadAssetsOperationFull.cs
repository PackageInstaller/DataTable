...
public class AssetBundleLoadAssetsOperationFull<T> : AssetBundleLoadAssetsOperation<T> where T : UnityEngine.Object
{
	...
	public AssetBundleLoadAssetsOperationFull(string bundleName, OnVoidHandler<T[]> callback)
	{
	...
	public override bool Update()
	{
		...
		else
		{
			...
			{
				flag = false;
				num = m_Request.progress;
				num2 = m_Request.allAssets.Length;
				flag2 = m_Request.allowSceneActivation;
			}
		...
		if (loadedAssetBundle != null)
		{
			...
			try
			{
				m_Request = loadedAssetBundle.m_AssetBundle.LoadAllAssetsAsync<T>();
			}
			catch (Exception ex)
			{
