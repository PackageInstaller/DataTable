...
[Name("队友技能执行事件(奥义)(指定时间)(逻辑)", 0)]
[Category("Logic/事件/奥义")]
[Description("队友在指定时间触发的奥义执行事件")]
public class UniqueSkillAbilityEventOfTeammateWithSpecifiedTime : LogicAbilityEventBase
{
	...
	protected override bool ConditionFunc(SimEntity simEntity, int abilityID, int logicTime, int actionID)
	{
		...
		if (!simEntity.hasEntityCamp || simEntity.entityCamp.mRoleTypeCamp != 1)
		{
			return false;
		}
