...
[Name("Buff触发器事件(子类型)(任一)(逻辑)", 0)]
[Category("Logic/事件")]
[Description("身上的buff处理")]
public class BuffTriggerEventWithSubTypeIDArr : EventNode
{
	...
	private ValueInput<List<string>> m_subTypeInput;
	...
	protected override void RegisterPorts()
	{
		...
		m_subTypeInput = AddValueInput<List<string>>("子类型组", "expectationSubType");
	...
	public override void OnGraphStarted()
	{
		...
		simulatorInferface.mUpdateBuffLogicTriggerEvent = (Action<int, int, int, int, EBuffLife, bool>)Delegate.Combine(simulatorInferface.mUpdateBuffLogicTriggerEvent, new Action<int, int, int, int, EBuffLife, bool>(LogicBuffUpdate));
	}

	public void LogicBuffUpdate(int triggerID, int ownerID, int buffIndex, int buffClass, EBuffLife buffLife, bool isTimeout)
	{
		...
		if (simEntityByTriggerID == null || !simEntityByTriggerID.entityTrigger.mEnabled || entityWithEntityID == null || !entityWithEntityID.hasEntityBuff)
		{
			return;
		}
