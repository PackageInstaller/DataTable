...
[Name("设置!实体配置ID(放在属性中)(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置!实体配置ID(放在属性中)")]
public class SetENTITY_CONFIG_ID_ON_ATTR : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2189, value, 0L, 0L);
		}
	}
}
