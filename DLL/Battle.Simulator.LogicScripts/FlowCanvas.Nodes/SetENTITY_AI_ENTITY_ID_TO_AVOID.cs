...
[Name("设置将要命中我的实体ID(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置将要命中我的实体ID")]
public class SetENTITY_AI_ENTITY_ID_TO_AVOID : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2206, value, 0L, 0L);
		}
	}
}
