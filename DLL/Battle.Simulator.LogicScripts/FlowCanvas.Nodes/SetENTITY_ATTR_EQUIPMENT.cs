...
[Description("设置装备")]
public class SetENTITY_ATTR_EQUIPMENT : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2100, value, 0L, 0L);
		}
	}
}
