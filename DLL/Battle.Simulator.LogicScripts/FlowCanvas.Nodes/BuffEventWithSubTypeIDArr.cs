...
[Name("Buff事件(子类型)(任一)(逻辑)", 0)]
[Category("Logic/事件")]
[Description("身上的buff处理")]
public class BuffEventWithSubTypeIDArr : EventNode
{
	...
	public void LogicBuffUpdate(int ownerID, int buffIndex, int buffClass, EBuffLife buffLife, bool isTimeout)
	{
		...
		if (config != null && BuffSubTypeComparer.ContainsAny(m_subTypeArrInput.value, config.SubType))
		{
			m_ownerID = ownerID;
