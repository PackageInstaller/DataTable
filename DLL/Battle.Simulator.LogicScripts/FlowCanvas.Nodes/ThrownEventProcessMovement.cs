...
[Name("抛掷物移动逻辑", 0)]
[Category("Logic/抛掷物")]
[Description("处理抛掷物移动逻辑")]
public class ThrownEventProcessMovement : EventNode
{
	...
	public override void OnGraphStarted()
	{
		...
		simInterface.mThrownProcessMovement = (Action<int, int>)Delegate.Combine(simInterface.mThrownProcessMovement, new Action<int, int>(ThrownMovementHandler));
	}
	...
	public void ThrownMovementHandler(int thrownID, int abilityID)
	{
		mThrownID = thrownID;
