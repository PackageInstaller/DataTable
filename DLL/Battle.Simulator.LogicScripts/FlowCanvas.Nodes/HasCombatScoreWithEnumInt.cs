...
[Name("是否有战斗评分(int)(逻辑)", 0)]
[Category("Logic/Attribute")]
[Description("检查实体上是否有指定来源和类型的战斗评分")]
public class HasCombatScoreWithEnumInt : FlowControlNode
{
	...
	protected override void RegisterPorts()
	{
		...
		{
			switch (HasCombatScoreBase.HasCombatScore(base.mSimContext, m_entityIDInput.GetValue(), m_sourceIDInput.GetValue(), m_typeInput.GetValue()))
			{
