...
[Name("设置零时空间时长(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置零时空间时长")]
public class SetENTITY_ATTR_ULTIMATE_AVOID_SPACE_TIME : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2015, value, 0L, 0L);
		}
	}
}
