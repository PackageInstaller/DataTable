...
[Name("设置AI的最佳距离(自动生成)", 0)]
[Category("Logic/Attribute/AutoGen")]
[Description("设置AI的最佳距离")]
public class SetENTITY_AI_BEST_DISTANCE : FlowControlNode
{
	...
	private void Invoke(int entityID, long value)
	{
		...
		{
			AttributeProcessor.SetAttributeWithIntName(entityWithEntityID.entityBlackboard.var.mAttributeID, 2201, value, 0L, 0L);
		}
	}
}
