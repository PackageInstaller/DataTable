...
public class ResourceUpdater : ResourceUpdaterBase
{
	public ResourceUpdater(ProgressBar progressBar, string[] resourcePackages, string[] audioResourcePackages, bool appReview)
	...
	protected override void CreateDownloader()
	{
		...
		{
			ResourceDownloaderOperation val = CreateDownloader(package);
		...
		{
			ResourceDownloaderOperation val2 = CreateDownloader(package2, new string[3]
			{
				"NecessaryRes",
				"downloadRes",
