...
public class ES3Type_CapsuleCollider : ES3ComponentType
{
	...
	protected override void WriteComponent(object obj, ES3Writer writer)
	{
		...
		CapsuleCollider val = (CapsuleCollider)obj;
		...
		writer.WriteProperty("height", val.height, ES3Type_float.Instance);
		writer.WriteProperty("direction", val.direction, ES3Type_int.Instance);
	...
	protected override void ReadComponent<T>(ES3Reader reader, object obj)
	{
		...
		foreach (string property in reader.Properties)
		{
			...
			case "radius":
				...
				break;
			case "height":
				val.height = reader.Read<float>(ES3Type_float.Instance);
				break;
			case "direction":
				val.direction = reader.Read<int>(ES3Type_int.Instance);
				break;
			case "enabled":
