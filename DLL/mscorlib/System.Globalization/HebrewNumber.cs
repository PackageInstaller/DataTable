...
internal class HebrewNumber
{
	...
	static HebrewNumber()
	{
		//IL_01d4: Field data (rva=0x4d0) could not be found in any section!
		//IL_01d4: Field data (rva=0x4d0) could not be found in any section!
		s_hebrewValues = new HebrewValue[27]
		{
		...
		s_maxHebrewNumberCh = (char)(1488 + s_hebrewValues.Length - 1);
		HS[] array = new HS[170];
		RuntimeHelpers.InitializeArray(array, (RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/);
		s_numberPasingState = array;
	}
}
