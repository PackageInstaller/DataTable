...
public class DataSetConverter : JsonConverter
{
	public override void WriteJson(JsonWriter writer, object? value, JsonSerializer serializer)
	{
		...
		foreach (DataTable item in (InternalDataCollectionBase)obj.Tables)
		{
			writer.WritePropertyName((defaultContractResolver != null) ? defaultContractResolver.GetResolvedPropertyName(item.TableName) : item.TableName);
			dataTableConverter.WriteJson(writer, item, serializer);
		}
