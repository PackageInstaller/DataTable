local scene_064240 = {
	...
	points = {
		...
		[1007] = {
			...
			pos = {-248,-90},
			id = 1007,
			grids = {[2]=1004,[4]=1008,[3]=1006,[1]=1010,},
			desc = "长廊古色古香，曲折蜿蜒、似断似连，与楼阁连为一体。风过，竹声如萧……",
		},
		...
		[1009] = {
			...
			id = 1009,
			grids = {[4]=1010,},
			desc = "晶莹剔透的房间，模糊的光晕透出仅能进入五人的小缝隙。最大的镜中阁。",
			npcs = {
				{
					npcName = "镜中人",
					desc = "镜中灰色的身影不断闪动，时而突进时而腾空辗转，似是正在演武。",
					visibleConditions = "visibleConditionsE",
					[1] = {
						talks = {
							{npc = "来战斗吧！",player = "好",npcName="镜中人"},
						},
		...
		[1010] = {
			...
			pos = {-248,14},
			id = 1010,
			grids = {[2]=1007,[4]=1011,[1]=1012,[3]=1009,},
			desc = "长廊古色古香，曲折蜿蜒、似断似连，与楼阁连为一体。风过，竹声如萧……",
		},
			...
			npcs = {
				{
					npcName = "镜中人",
					desc = "镜中灰色的身影不断闪动，时而突进时而腾空辗转，似是正在演武。",
					visibleConditions = "visibleConditionsF",
					[1] = {
						talks = {
							{npc = "来战斗吧！",player = "好",npcName="镜中人"},
						},
			...
			npcs = {
				{
					...
					[1] = {
						talks = {
							{npc = "少侠，恭喜你首次通关了【胭脂紫】，这是给你的节玉。",player = "好",npcName="老人"},
						},
						next = 6,
					},
					[6] = {
