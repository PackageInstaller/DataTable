---@class ProtoAgreementCheck_Generate_registerAgreement_okBtn
---@field public gameObject UnityEngine.GameObject
---@field public button UnityEngine.UI.Button

---@class ProtoAgreementCheck_Generate_registerAgreement_agreementTitle
---@field public gameObject UnityEngine.GameObject
---@field public text UnityEngine.UI.Text

---@class ProtoAgreementCheck_Generate_registerAgreement_agreeText
---@field public gameObject UnityEngine.GameObject
---@field public text UnityEngine.UI.Text

---@class ProtoAgreementCheck_Generate_scrollView
---@field public gameObject UnityEngine.GameObject
---@field public scrollRect UnityEngine.UI.ScrollRect

---@class ProtoAgreementCheck_Generate_registerAgreement
---@field public gameObject UnityEngine.GameObject
---@field public content UnityEngine.GameObject
---@field public agreeText ProtoAgreementCheck_Generate_registerAgreement_agreeText
---@field public agreementTitle ProtoAgreementCheck_Generate_registerAgreement_agreementTitle
---@field public okBtn ProtoAgreementCheck_Generate_registerAgreement_okBtn

---@class ProtoAgreementCheck_Generate_agreement2Btn
---@field public gameObject UnityEngine.GameObject
---@field public button UnityEngine.UI.Button

---@class ProtoAgreementCheck_Generate_agreement1Btn
---@field public gameObject UnityEngine.GameObject
---@field public button UnityEngine.UI.Button

---@class ProtoAgreementCheck_Generate
---@field public gameObject UnityEngine.GameObject
---@field public transform UnityEngine.Transform
---@field public uiConfig table
---@field public toggle UnityEngine.UI.Toggle
---@field public agreement1Btn ProtoAgreementCheck_Generate_agreement1Btn
---@field public agreement2Btn ProtoAgreementCheck_Generate_agreement2Btn
---@field public registerAgreement ProtoAgreementCheck_Generate_registerAgreement
---@field public scrollView ProtoAgreementCheck_Generate_scrollView
local ProtoAgreementCheck = class("ProtoAgreementCheck", require("WndBase"))

function ProtoAgreementCheck:ctor(data)
end

---@private
function ProtoAgreementCheck:InitGenerate(data)

	self.uiConfig = Config.GetUIConfigInfo("ProtoAgreementCheck")
...
---@private
function ProtoAgreementCheck:InitGenerate__1(Root, data)
--[[
	Root
--]]
...
---@private
function ProtoAgreementCheck:InitGenerate__2(Root, data)
--[[
	agreement1Btn
--]]
	...
	tmp.button.onClick:AddListener(function ()
		UIMgr:SendUiUseMessage("ProtoAgreementCheck_agreement1Btn")
...
---@private
function ProtoAgreementCheck:InitGenerate__3(Root, data)
--[[
	agreement2Btn
--]]
	...
	tmp.button.onClick:RemoveAllListeners()
	tmp.button.onClick:AddListener(function ()
		UIMgr:SendUiUseMessage("ProtoAgreementCheck_agreement2Btn")
...
---@private
function ProtoAgreementCheck:InitGenerate__4(Root, data)
--[[
	RegisterAgreement
--]]
...
---@private
function ProtoAgreementCheck:InitGenerate__5(Root, data)
--[[
...
---@private
function ProtoAgreementCheck:InitGenerate__6(Root, data)
--[[
...
---@private
function ProtoAgreementCheck:InitGenerate__7(Root, data)
--[[
...
---@private
function ProtoAgreementCheck:InitGenerate__8(Root, data)
--[[
...
---@private
function ProtoAgreementCheck:InitGenerate__9(Root, data)
--[[
...
--]]
	...
	tmp.button.onClick:RemoveAllListeners()
	tmp.button.onClick:AddListener(function ()
		UIMgr:SendUiUseMessage("ProtoAgreementCheck_okBtn")
...
function ProtoAgreementCheck:SetLocalizedText(Root)
