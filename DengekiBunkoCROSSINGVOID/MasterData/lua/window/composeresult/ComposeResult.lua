...
local m_callback
local m_hold = false
local m_labelRef, m_contentRef, m_titleRef
...
function ShowComposeResult(items, callback, durationTime, bSkinExchange)
  m_callback = callback
  ...
  WU.ToggleRendering(m_contentRef, false)
  REF.EffectCompose.EffectGenerator:Reset()
  REF.EffectCompose.EffectGenerator:Play()
...
function ShowHintIcon()
  ...
  WU.ToggleRendering(m_contentRef, true)
