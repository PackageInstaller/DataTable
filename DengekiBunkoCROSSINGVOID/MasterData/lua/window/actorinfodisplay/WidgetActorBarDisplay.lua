...
function OnActorChange(actor, equips)
  if actor then
    ...
    local cultivation = math.floor(AU.GetActorCultivationDegreeAttr(actor) + AU.GetActorCultivationDegreeSkill(actor) + AU.GetActorCultivationDegreeTalent(actor))
    REF.LevelCultivationDegree.UIHtmlLabel.text = WU.GetString("Window_ActorCultivationDegree", cultivation)
