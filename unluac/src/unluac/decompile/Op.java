...
public enum Op {
  ...
  // Path to Nowhere / libxlua (Lua 5.4 + fix32)
  LOADFIX32("loadfix32", OpV.LUA54, OperandFormat.AR, OperandFormat.sBxI),
  FIX32("fix32", OpV.LUA54, OperandFormat.AR, OperandFormat.BR),
  ASFIX32("asfix32", OpV.LUA54, OperandFormat.AR, OperandFormat.BR),
  // Lua 5.5 Opcodes
  ...
  public int target(int codepoint, CodeExtract ex) {
    switch(this) {
      case MOVE:
      case LOADI: case LOADF: case LOADFIX32: case LOADK: case LOADKX:
