...
public class BaseEntityView : MonoBehaviour, IEntityView, ILifeCycle, IInit, IAwake, IStart, IUpdate, IFixedUpdate, IPause, IDispose
{
	...
	public virtual void OnEntityFrozen(bool isFrozen)
	{
	}
	...
	public virtual void OnRePlay(bool isClear)
	{
	}
