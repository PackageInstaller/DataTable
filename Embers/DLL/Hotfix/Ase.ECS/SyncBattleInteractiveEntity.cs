...
public class SyncBattleInteractiveEntity : BaseEntity
{
	...
	public override EntityUpdateType UpdateType => EntityUpdateType.Authority;
	...
	protected override Type[] GetEntityComps()
	{
		return new Type[5]
		{
			...
			typeof(BattleInteractiveStateComponent),
