...
public class CinemachineCustomImpulseDefinition
{
	...
	{
		private CinemachineCustomImpulseDefinition m_Def;

		private Vector3 m_Velocity;

		public float SignalDuration => m_Def.m_ImpulseDuration;

		public SignalSource(CinemachineCustomImpulseDefinition def, Vector3 velocity)
		{
			m_Def = def;
			m_Velocity = velocity;
		}
	...
	private class LegacySignalSource : ISignalSource6D
	{
		...
		public LegacySignalSource(CinemachineCustomImpulseDefinition def, Vector3 velocity)
		{
			m_Def = def;
			m_Velocity = velocity;
	...
	public CinemachineCustomImpulseManager.EnvelopeDefinition m_TimeEnvelope = CinemachineCustomImpulseManager.EnvelopeDefinition.Default();
	...
	public CinemachineCustomImpulseManager.ImpulseEvent.DirectionMode m_DirectionMode;

	[Tooltip("Legacy mode only: This defines how the signal will dissipate with distance beyond the impact radius.")]
	public CinemachineCustomImpulseManager.ImpulseEvent.DissipationMode m_DissipationMode = CinemachineCustomImpulseManager.ImpulseEvent.DissipationMode.ExponentialDecay;
	...
	public CinemachineCustomImpulseManager.ImpulseEvent CreateAndReturnEvent(Vector3 position, Vector3 velocity)
	{
		...
		CinemachineCustomImpulseManager.ImpulseEvent impulseEvent = CinemachineCustomImpulseManager.Instance.NewImpulseEvent();
		impulseEvent.m_Envelope = new CinemachineCustomImpulseManager.EnvelopeDefinition
		{
		...
		impulseEvent.m_DirectionMode = CinemachineCustomImpulseManager.ImpulseEvent.DirectionMode.Fixed;
		...
		CinemachineCustomImpulseManager.Instance.AddImpulseEvent(impulseEvent);
		return impulseEvent;
	}

	private CinemachineCustomImpulseManager.ImpulseEvent LegacyCreateAndReturnEvent(Vector3 position, Vector3 velocity)
	{
