...
public class PropertyIgnoreBindBuff : BuffOperationBase<BuffDataPropertyIgnoreBind>
{
	...
	private void OnAddition()
	{
		...
		case PropertyType.Min:
			...
			break;
		case PropertyType.Max:
			base.buffOwner.SetPropertyMax(dataBase.propertyKey, num + num2, isExecuteValueChanged: false);
			break;
		case PropertyType.Init:
			base.buffOwner.SetPropertyInit(dataBase.propertyKey, num + num2);
			break;
		case PropertyType.Cur:
			base.buffOwner.SetPropertyBuff(dataBase.propertyKey, num + num2, isIgnoreMax: false, base.config.FinishClearOperations, isExcuteValueChanged: false);
			break;
		}
		deltaVal += num2;
	...
	private void OnClearAddition()
	{
		...
		case PropertyType.Init:
			...
			break;
		case PropertyType.Cur:
			base.buffOwner.SetPropertyBuff(dataBase.propertyKey, num - deltaVal, base.config.FinishClearOperations, isClearEffect: false);
			break;
		}
		if (LockstepData.Instance != null)
		{
