...
[Trigger("音频控制触发器")]
public class AudioControlTrigger : BaseTrigger
{
	...
	public bool openAngleCheck;

	public override string TriggerName => "音频控制触发器";

	protected override bool OpenAngleCheck => openAngleCheck;
