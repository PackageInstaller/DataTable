...
public struct InputEvent
{
	...
	public unsafe static bool Equals(InputEvent* first, InputEvent* second)
	{
		...
		if (((NativeInputEvent)(&first->m_Event)).sizeInBytes != ((NativeInputEvent)(&second->m_Event)).sizeInBytes)
		{
			return false;
		}
		return UnsafeUtility.MemCmp(first, second, ((NativeInputEvent)(&first->m_Event)).sizeInBytes) == 0;
	}
}
