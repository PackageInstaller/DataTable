...
{
	public struct PlayerActions(DefaultInputActions wrapper)
	{
		private DefaultInputActions m_Wrapper = wrapper;
	...
	public struct UIActions(DefaultInputActions wrapper)
	{
		private DefaultInputActions m_Wrapper = wrapper;
