...
{
	private unsafe struct Enumerator(InputControlList<TControl> list) : IEnumerator<TControl>, IEnumerator, IDisposable
	{
		private unsafe readonly ulong* m_Indices = (ulong*)((m_Count > 0) ? list.m_Indices.GetUnsafeReadOnlyPtr() : null);

		private readonly int m_Count = list.m_Count;
