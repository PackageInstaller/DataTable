...
public class CanvasUpdateRegistry
{
	...
	protected CanvasUpdateRegistry()
	{
		...
		m_CanvasUpdateProfilerStrings = new string[5] { "CanvasUpdate.Prelayout", "CanvasUpdate.Layout", "CanvasUpdate.PostLayout", "CanvasUpdate.PreRender", "CanvasUpdate.LatePreRender" };
		m_LayoutRebuildQueue = new IndexedSet<ICanvasElement>();
		m_GraphicRebuildQueue = new IndexedSet<ICanvasElement>();
		base._002Ector();
