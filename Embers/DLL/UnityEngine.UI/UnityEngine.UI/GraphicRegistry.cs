...
public class GraphicRegistry
{
	...
	{
		if (!((Object)(object)c == null) && !(graphic == null))
		{
	...
	{
		if (!((Object)(object)c == null) && !(graphic == null) && graphic.raycastTarget)
		{
	...
	{
		if (!((Object)(object)c == null) && !(graphic == null) && instance.m_Graphics.TryGetValue(c, out var value))
		{
	...
	{
		if (!((Object)(object)c == null) && !(graphic == null) && instance.m_RaycastableGraphics.TryGetValue(c, out var value))
		{
			value.Remove(graphic);
			if (value.Count == 0)
			{
	...
	{
		if (!((Object)(object)c == null) && instance.m_Graphics.TryGetValue(c, out var value))
		{
	...
	{
		if (!((Object)(object)c == null) && graphic.raycastTarget && instance.m_RaycastableGraphics.TryGetValue(c, out var value))
		{
			value.DisableItem(graphic);
			if (value.Capacity == 0)
			{
