...
public class JsonTextWriter : JsonWriter
{
	...
	{
		return WriteValueInternalAsync(JsonToken.Integer, value.ToString((IFormatProvider)CultureInfo.InvariantCulture), cancellationToken);
	}
	...
	public override void WriteValue(object? value)
	{
		if (value is BigInteger bigInteger)
		{
			...
			WriteValueInternal(bigInteger.ToString((IFormatProvider)CultureInfo.InvariantCulture), JsonToken.String);
		}
		else
		{
