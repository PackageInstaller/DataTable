...
public class Graphics
{
	...
	internal static void CheckLoadActionValid(RenderBufferLoadAction load, string bufferType)
	{
		...
		{
			throw new ArgumentException(UnityString.Format("Bad {0} LoadAction provided.", new object[1] { bufferType }));
		}
	}
	...
	internal static void CheckStoreActionValid(RenderBufferStoreAction store, string bufferType)
	{
		...
		{
			throw new ArgumentException(UnityString.Format("Bad {0} StoreAction provided.", new object[1] { bufferType }));
		}
	}
