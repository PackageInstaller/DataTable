	...
	public int this[int index]
	{
		...
		get
		{
			return index switch
			{
				...
				1 => y, 
				2 => z, 
				_ => throw new IndexOutOfRangeException(UnityString.Format("Invalid Vector3Int index addressed: {0}!", new object[1] { index })), 
			};
		}
		[MethodImpl((MethodImplOptions)256)]
		set
		{
			...
			case 2:
				...
				break;
			default:
				throw new IndexOutOfRangeException(UnityString.Format("Invalid Vector3Int index addressed: {0}!", new object[1] { index }));
			}
		}
	}
