...
local UILordRoadCtrl = BaseClass("UILordRoadCtrl",UIBaseCtrl);
...
local function CloseSelf()
    UIManager:GetInstance():CloseWindow(UIWindowNames.UILordRoad);
end

local function OpenIntensWindow()
    UIManager:GetInstance():OpenWindow(UIWindowNames.UIMainIntens);
end
UILordRoadCtrl.OpenIntensWindow = OpenIntensWindow
UILordRoadCtrl.OnSectionChg = OnSectionChg
UILordRoadCtrl.OnOpenMonsterMessageWindow = OnOpenMonsterMessageWindow
UILordRoadCtrl.OnOpenItemMessageWindow = OnOpenItemMessageWindow
UILordRoadCtrl.OpenFormatWindow = OpenFormatWindow
UILordRoadCtrl.CloseSelf = CloseSelf
UILordRoadCtrl.OpenReadyWindow = OpenReadyWindow
UILordRoadCtrl.OpenSelectWindow = OpenSelectWindow
UILordRoadCtrl.OnQuickBattle = OnQuickBattle
UILordRoadCtrl.SendMopUpRequest = SendMopUpRequest
UILordRoadCtrl.PlaySectionStory = PlaySectionStory

return UILordRoadCtrl