...
local UILordTowerCtrl = BaseClass("UILordTowerCtrl",UIBaseCtrl);
...
local function CloseSelf()
    UIManager:GetInstance():CloseWindow(UIWindowNames.UILordTower);
end

local function OpenIntensWindow()
    UIManager:GetInstance():OpenWindow(UIWindowNames.UIMainIntens);
end
UILordTowerCtrl.OpenIntensWindow = OpenIntensWindow
UILordTowerCtrl.OnSectionChg = OnSectionChg
UILordTowerCtrl.OnOpenMonsterMessageWindow = OnOpenMonsterMessageWindow
UILordTowerCtrl.OnOpenItemMessageWindow = OnOpenItemMessageWindow
UILordTowerCtrl.OpenFormatWindow = OpenFormatWindow
UILordTowerCtrl.CloseSelf = CloseSelf
UILordTowerCtrl.OpenReadyWindow = OpenReadyWindow
UILordTowerCtrl.OpenSelectWindow = OpenSelectWindow
UILordTowerCtrl.OnQuickBattle = OnQuickBattle
UILordTowerCtrl.SendMopUpRequest = SendMopUpRequest
UILordTowerCtrl.PlaySectionStory = PlaySectionStory

return UILordTowerCtrl