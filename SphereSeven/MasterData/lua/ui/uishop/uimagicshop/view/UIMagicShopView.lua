...
local UIMagicShopView = BaseClass("UIMagicShopView",UIBaseView)
local base = UIBaseView
local this = UIMagicShopView;
...
function this.OnRefresh(self)
    self.money_text.text = "魔晶:"..self.model.paid_num; -- ignoreCN
...
function this.OnAddListener(self)
    ...
    self:AddUIListener(UIMessageNames.ON_DAY_PURCHASE_INFO_CHG,self.OnRefresh);
    self:AddUIListener(UIMessageNames.ON_WEEK_PURCHASE_INFO_CHG,self.OnRefresh);
    self:AddUIListener(UIMessageNames.ON_MONTH_PURCHASE_INFO_CHG,self.OnRefresh);
end
