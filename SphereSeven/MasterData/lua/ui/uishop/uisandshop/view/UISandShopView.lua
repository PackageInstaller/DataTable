...
local UISandShopView = BaseClass("UISandShopView",UIBaseView)
local base = UIBaseView
local this = UISandShopView;
...
function this.OnCreate(self)
    ...
    self.money_text = LangUtil.BindText(self.rc:GetObject(money_text_path));
...
function this.OnRefresh(self)
    self.money_text.text = "星砂:"..self.model.paid_num; -- ignoreCN
