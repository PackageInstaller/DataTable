...
function loadtable(tableChunk)
	if tableChunk == nil then
		return {}
	end
	return assert(load("return "..tableChunk))()
end

function loadfunc(funcString)
	assert(load(funcString))();
end

function CoroutineStart(func)
