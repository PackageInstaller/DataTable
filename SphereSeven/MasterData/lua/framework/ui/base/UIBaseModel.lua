...
local function __delete(self)
	...
	if self.__data_callback ~= nil then
...
local function OnCreate(self)
	--Logger.Log("<color=green>OnCreate: "..self._class_type.__cname.."</color>")
end

-- 打开：刷新数据模型
-- 注意：窗口关闭时可以清理的成员变量放这
local function OnEnable(self, ...)
	--Logger.Log("<color=green>OnEnable: "..self._class_type.__cname.."</color>")
	self:OnAddListener()
end
...
local function OnDestroy(self)
	--Logger.Log("<color=green>OnDestroy: "..self._class_type.__cname.."</color>")
end

-- 注册消息
local function OnAddListener(self)
	--Logger.Log("<color=green>OnAddListener: "..self._class_type.__cname.."</color>")
end

-- 注销消息
local function OnRemoveListener(self)
	--Logger.Log("<color=green>OnRemoveListener: "..self._class_type.__cname.."</color>")
end
...
local function RealDeactive(self)
	self:OnRealDeactive()
end
...
local function OnRealDeactive(self)
...
UIBaseModel.OnRealDeactive = OnRealDeactive
UIBaseModel.RealDeactive = RealDeactive
