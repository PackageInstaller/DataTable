module("game.purchase.fashionShop.view.item.FashionPairtsShowItem", Class.impl(BaseReuseItem))

UIRes = UrlManager:getUIPrefabPath("purchase/FashionPairtsShowItem.prefab")
...
function setData(self, cusParent, data)
    ...
    self.mTag1:SetActive(false)
    self.mTag2:SetActive(false)
    self.mTag3:SetActive(false)
