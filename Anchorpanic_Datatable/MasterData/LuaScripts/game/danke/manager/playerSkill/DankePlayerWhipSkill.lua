-- @FileName:   DankePlayerWhipSkill.lua
-- @Description:   玩家皮鞭技能类
-- @Author: ZDH
-- @Date:   2023-08-10 15:45:29
-- @Copyright:   (LY) 2023 雷焰网络

module('game.danke.playerSkill.DankePlayerWhipSkill', Class.impl(danke.DankePlayerInitiativeSkill))
...
function refreshParam(self)
    ...
    self.m_scale = self.m_skillParam[1] * 0.01 --基础倍数
end
...
function onFrame(self)
    ...
    if self.m_deltaTime - self.m_lastExecuteTime >= 0.2 then
        self:clearBullet()
    end
end
