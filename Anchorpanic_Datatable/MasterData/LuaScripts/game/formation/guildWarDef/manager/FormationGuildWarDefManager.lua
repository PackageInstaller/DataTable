--[[ 
-----------------------------------------------------
@filename       : FormationGuildWarDefManager
@Description    : 联盟团战防守管理器
-----------------------------------------------------
]]
module("formation.FormationGuildWarDefManager", Class.impl("game.formation.normal.manager.FormationManager"))
