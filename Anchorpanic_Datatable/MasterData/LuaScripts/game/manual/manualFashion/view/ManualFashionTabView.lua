module("manual.ManualFashionTabView", Class.impl(TabView))
UIRes = UrlManager:getUIPrefabPath("manual/ManualFashionTabView.prefab")
...
function getTabDatas(self)
    self.tabDataList = {}
    for i, vo in ipairs(manual.getTabList(manual.ManualType.Fashion)) do
...
function getTabClass(self)
    for _, vo in ipairs(manual.getTabList(manual.ManualType.Fashion)) do
        self.tabClassDic[vo.page] = manual.ManualFashionTabSubView
    end
