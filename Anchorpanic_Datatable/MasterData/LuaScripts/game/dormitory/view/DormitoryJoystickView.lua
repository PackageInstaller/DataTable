--[[ 
-----------------------------------------------------
@filename       : DormitoryJoystickView
@Description    : 宿舍战员操控虚拟摇杆，区别于主线探索摇杆 速度位置为1
@date           : 2022-4-18 13:44:00
@Author         : ZDH
@copyright      : (LY) 2020 雷焰网络
-----------------------------------------------------
]]
module('game.dormitory.view..DormitoryJoystickView', Class.impl(mainExplore.MainExploreJoystickView))
UIRes = UrlManager:getUIPrefabPath("dormitory/DormitoryJoystickView.prefab")
...
function onKeyboard(self, deltaTime)
    ...
    GameDispatcher:dispatchEvent(EventName.MAIN_EXPLORE_JOYSTICK_UPDATE, { deltaTime = deltaTime, deltaRatioX = gs.Input.GetAxis("Horizontal"), deltaRatioY = gs.Input.GetAxis("Vertical") })
end
