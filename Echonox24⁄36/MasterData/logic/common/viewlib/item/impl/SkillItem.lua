-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/common/viewlib/item/impl/SkillItem.lua

module("logic.common.viewlib.item.impl.SkillItem", package.seeall)

local M = class("SkillItem", UIReusableLuaBehavior)
...
function M:buildUI()
	...
	self._goRootCommon = registry:findUIElement("skill_item_1_1530695070")
	self._goRootPas = registry:findUIElement("skill_item_1_-539079550")
...
function M:setHeroAndSkillId(heroId, skillId)
	...
	goutil.setActive(self._goRootCommon, not self._isPassiveSkill)
	goutil.setActive(self._goRootPas, self._isPassiveSkill)
