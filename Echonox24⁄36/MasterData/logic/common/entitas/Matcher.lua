-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/common/entitas/Matcher.lua

module("logic.common.entitas.Matcher", package.seeall)
...
function M.__tostring(t)
	return string.format("<Matcher [all=({%s}) any=({%s}) none=({%s})]>", string_components(t._all), string_components(t._any), string_components(t._none))
end
