-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/equip/TaskGetEquipByOptionType.lua

module("logic.extensions.task.util.impl.equip.TaskGetEquipByOptionType", package.seeall)

local M = class("TaskGetEquipByOptionType")
