-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/house/TaskAtmosphereLvUp.lua

module("logic.extensions.task.util.impl.house.TaskAtmosphereLvUp", package.seeall)

local M = class("TaskAtmosphereLvUp")
