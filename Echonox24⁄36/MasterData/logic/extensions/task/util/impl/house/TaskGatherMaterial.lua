-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/house/TaskGatherMaterial.lua

module("logic.extensions.task.util.impl.house.TaskGatherMaterial", package.seeall)

local M = class("TaskGatherMaterial")
