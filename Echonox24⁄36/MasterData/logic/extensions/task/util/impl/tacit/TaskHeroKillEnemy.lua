-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroKillEnemy.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroKillEnemy", package.seeall)

local M = class("TaskHeroKillEnemy")
