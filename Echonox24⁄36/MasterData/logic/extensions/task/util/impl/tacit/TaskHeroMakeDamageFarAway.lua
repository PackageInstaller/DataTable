-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroMakeDamageFarAway.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroMakeDamageFarAway", package.seeall)

local M = class("TaskHeroMakeDamageFarAway")
...
function M:parseContent(code, desc, param, heroId)
	...
	local id = tonumber(paramArray[2] or heroId)
