-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/task/util/impl/tacit/TaskHeroGiveBuff.lua

module("logic.extensions.task.util.impl.tacit.TaskHeroGiveBuff", package.seeall)

local M = class("TaskHeroGiveBuff")
