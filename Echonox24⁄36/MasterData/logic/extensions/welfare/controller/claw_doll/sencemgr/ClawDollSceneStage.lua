-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/welfare/controller/claw_doll/sencemgr/ClawDollSceneStage.lua

module("logic.extensions.welfare.controller.claw_doll.sencemgr.ClawDollSceneStage", package.seeall)

local M = class("ClawDollSceneStage", SceneStageBase)
