-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/welfare/model/task_reward/ActTaskRewardModel.lua

module("logic.extensions.welfare.model.task_reward.ActTaskRewardModel", package.seeall)

local M = class("ActTaskRewardModel", BaseModel)
