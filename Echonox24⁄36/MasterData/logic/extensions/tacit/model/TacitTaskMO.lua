-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/tacit/model/TacitTaskMO.lua

module("logic.extensions.tacit.model.TacitTaskMO", package.seeall)

local M = class("TacitTaskMO")
...
function M:updateByAgent(data, index)
	self._index = index
	self._id = data.id
...
function M:setTarget(state)
	self._isTarget = state
end

function M:getIsTarget()
