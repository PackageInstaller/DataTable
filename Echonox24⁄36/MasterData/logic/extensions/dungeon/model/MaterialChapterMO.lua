-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/dungeon/model/MaterialChapterMO.lua

module("logic.extensions.dungeon.model.MaterialChapterMO", package.seeall)

local M = class("MaterialChapterMO", DungeonChapterMO)
...
function M:ctor(chapterCo)
	...
	self._career = chapterCo.career
	self._iconRes1 = chapterCo.iconRes1
	self._iconRes2 = chapterCo.iconRes2
	self._bg = chapterCo.bg
	self._bgItemIcon = chapterCo.bgItemIcon
...
function M:getIconRes2()
	return self._iconRes2
end
...
function M:getBgItemIcon()
	return self._bgItemIcon
end

function M:getIconItem()
	return self._dropItems[1]
end
...
function M:getSystemOpenKey()
	return GameEnum.SystemEnum.MaterialDungeonChapter1 + self._chapterId - 1001
end
