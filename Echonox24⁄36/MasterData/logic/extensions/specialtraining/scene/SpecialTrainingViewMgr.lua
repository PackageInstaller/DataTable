-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/specialtraining/scene/SpecialTrainingViewMgr.lua

module("logic.extensions.specialtraining.scene.SpecialTrainingViewMgr", package.seeall)

local M = class("SpecialTrainingViewMgr", ISceneFlowComp)
...
function M:onEnterDone()
	...
	if isBackScene then
		printWarn("===is back special training===")
		ViewMgr.instance:_openPreFullUpView()
	else
		printWarn("===is normal enter special training===")
