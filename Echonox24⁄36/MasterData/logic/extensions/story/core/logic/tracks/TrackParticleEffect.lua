-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/story/core/logic/tracks/TrackParticleEffect.lua

module("logic.extensions.story.core.logic.tracks.TrackParticleEffect", package.seeall)

local M = class("TrackParticleEffect", StoryTrackBase)
...
function M:OnStoryAwakeInternal()
	...
	if assetObj then
		...
		self.binder:AddProxyPtr(self.instUID, proxyInst, StoryPtrTag.ParticleSystemInstance, nil, nil)
