-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/story/core/logic/handles/StoryHandleModelCreate.lua

module("logic.extensions.story.core.logic.handles.StoryHandleModelCreate", package.seeall)

local M = class("StoryHandleModelCreate")
