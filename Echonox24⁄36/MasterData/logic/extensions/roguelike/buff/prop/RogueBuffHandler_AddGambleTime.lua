-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/roguelike/buff/prop/RogueBuffHandler_AddGambleTime.lua

module("logic.extensions.roguelike.buff.prop.RogueBuffHandler_AddGambleTime", package.seeall)

local M = class("RogueBuffHandler_AddGambleTime", RogueBaseBuffHandler)
