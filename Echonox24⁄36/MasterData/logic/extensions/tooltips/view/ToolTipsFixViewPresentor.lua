-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/tooltips/view/ToolTipsFixViewPresentor.lua

module("logic.extensions.tooltips.view.ToolTipsFixViewPresentor", package.seeall)

local M = class("ToolTipsFixViewPresentor", ViewPresentor)
