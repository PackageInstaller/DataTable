-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/airworkshop/flow/defflow/unit/herounit/AirWorkLeaveUnit.lua

module("logic.extensions.airworkshop.flow.defflow.unit.herounit.AirWorkLeaveUnit", package.seeall)

local M = class("AirWorkLeaveUnit", AirWorkShopBuildingUnit)
...
function M:_initComponents()
	...
	self:_addComponent("property", AirWorkUnitCompLeaveProperty)
