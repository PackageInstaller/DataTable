-- chunkname: @/Users/baioo/builds/866EVqtU/3/spacex/spacex-client/UnityProj/Assets/Scripts/Lua/logic/extensions/airworkshop/flow/defflow/unit/herounit/AirWorkShopBuildingUnit.lua

module("logic.extensions.airworkshop.flow.defflow.unit.herounit.AirWorkShopBuildingUnit", package.seeall)

local M = class("AirWorkShopBuildingUnit", AirUnitBase)
...
function M:_initComponents()
	...
	self:_addComponent("property", AirWorkUnitCompBuildingProperty)
