module("framework.network.pipeline.NetworkTailHandler", package.seeall)

local var_0_0 = class("NetworkTailHandler", NetworkHandler)

function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2, arg_1_3)
	NetworkTailHandler.super.ctor(arg_1_0, arg_1_2, arg_1_3)
...
function var_0_0.onReceive(arg_3_0, ...)
	local var_3_0
	local var_3_1
	local var_3_2
	local var_3_3
