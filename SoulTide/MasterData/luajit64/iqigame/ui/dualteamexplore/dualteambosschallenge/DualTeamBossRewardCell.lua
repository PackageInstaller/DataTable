-- chunkname: @IQIGame\\UI\\DualTeamExplore\\DualTeamBossChallenge\\DualTeamBossRewardCell.lua
...
function m:SetData(data, index)
	self.cfgDualTeamExploreEXBossReward = data
...
function m:Update(index)
	...
	UGUIUtil.SetText(self.RankingText, DualTeamExploreExBossRewardUIApi:GetString("TextRewardIndex", self.cfgDualTeamExploreEXBossReward.RankLowerLimit, self.cfgDualTeamExploreEXBossReward.RankUpperLimit, self.cfgDualTeamExploreEXBossReward.RankType))

	if not isShowImgNum then
		local path = DualTeamExploreExBossRewardUIApi:GetString("RankRewardIconPath", self.cfgDualTeamExploreEXBossReward.RankLowerLimit, self.cfgDualTeamExploreEXBossReward.RankUpperLimit, self.cfgDualTeamExploreEXBossReward.RankType)
	...
	for i = 1, #self.cfgDualTeamExploreEXBossReward.Reward, 2 do
		local itemId = self.cfgDualTeamExploreEXBossReward.Reward[i]
		local itemNum = self.cfgDualTeamExploreEXBossReward.Reward[i + 1]
