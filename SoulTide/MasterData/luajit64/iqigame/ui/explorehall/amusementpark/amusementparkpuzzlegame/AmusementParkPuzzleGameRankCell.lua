-- chunkname: @IQIGame\\UI\\ExploreHall\\AmusementPark\\AmusementParkPuzzleGame\\AmusementParkPuzzleGameRankCell.lua
...
function m:SetMyData(ranking, hurt, customData, rankType)
	...
	UGUIUtil.SetText(self.RankingText, AmusementParkGameBlocksRankUIApi:GetString("ChallengeRankStr", ranking, true, rankType))
	UGUIUtil.SetText(self.PlayerNameText, AmusementParkGameBlocksRankUIApi:GetString("PlayerNameText", PlayerModule.PlayerInfo.baseInfo.pName))

	local tab = string.split(customData, ",")

	UGUIUtil.SetText(self.GameLv, AmusementParkGameBlocksRankUIApi:GetString("GameLv", tab[1] or "", true))
	UGUIUtil.SetText(self.ScoreText, AmusementParkGameBlocksRankUIApi:GetString("ChallengeRankHurt", tab[2] or "", true))
end
