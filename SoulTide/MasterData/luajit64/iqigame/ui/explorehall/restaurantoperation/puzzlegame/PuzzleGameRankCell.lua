-- chunkname: @IQIGame\\UI\\ExploreHall\\RestaurantOperation\\PuzzleGame\\PuzzleGameRankCell.lua
...
function m:SetData(index, rankingPOD)
	...
	UGUIUtil.SetText(self.TimeText, rankingPOD.value)
...
function m:SetMyData(ranking, hurt, customData, rankType)
	...
	UGUIUtil.SetText(self.RankingText, RestaurantGameBlocksRankUIApi:GetString("ChallengeRankStr", ranking, true, rankType))
	UGUIUtil.SetText(self.PlayerNameText, RestaurantGameBlocksRankUIApi:GetString("PlayerNameText", PlayerModule.PlayerInfo.baseInfo.pName))
	UGUIUtil.SetText(self.TimeText, RestaurantGameBlocksRankUIApi:GetString("ChallengeRankHurt", hurt, true))
end
