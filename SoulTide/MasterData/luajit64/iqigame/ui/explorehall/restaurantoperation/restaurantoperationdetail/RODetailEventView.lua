-- chunkname: @IQIGame\\UI\\ExploreHall\\RestaurantOperation\\RestaurantOperationDetail\\RODetailEventView.lua

local m = {
	eventRenders = {}
}
local UIObjectPool = require("IQIGame.UI.Common.UIObjectPool")
local RODetailEventRender = require("IQIGame.UI.ExploreHall.RestaurantOperation.RestaurantOperationDetail.RODetailEventRender")
...
function m:Init(view)
	...
	self.eventRenderPool = UIObjectPool.New(50, function()
		return RODetailEventRender.New(UnityEngine.Object.Instantiate(self.EventMould))
	end, function(cell)
		cell:Dispose()
	end)
end
...
function m:UpdateView()
	...
	local events = RestaurantOperationModule.DailyDupPOD.restaurantOperationPOD.event
