-- chunkname: @IQIGame\\UI\\ExploreHall\\RestaurantOperation\\RestaurantOperationDetail\\RODetailStoryView.lua

local m = {
	storyData = {},
	storyRenderPool = {}
}
local RODetailStoryRender = require("IQIGame.UI.ExploreHall.RestaurantOperation.RestaurantOperationDetail.RODetailStoryRender")
...
function m:UpdateView()
	self.storyData = RestaurantOperationModule.ROAttributePOD.plot or {}
...
function m:OnRenderCell(cell)
	...
	if renderCell == nil then
		renderCell = RODetailStoryRender.New(cell.gameObject)
...
function m:OnSelectedCell(cell)
	...
	log("剧情对话 " .. data)
	DialogModule.OpenDialog(CfgRestaurantOperationEventControlTable[data].Parameter, false, false)
end
