-- chunkname: @IQIGame\\UIExternalApi\\RestaurantOperationChallengeDetailUIApi.lua

RestaurantOperationChallengeDetailUIApi = BaseLangApi:Extend()

function RestaurantOperationChallengeDetailUIApi:Init()
...
function RestaurantOperationChallengeDetailUIApi:GetTextBossLevel(boosLv)
	if boosLv == 1 then
...
function RestaurantOperationChallengeDetailUIApi:GetTextPower(power, needPower)
...
function RestaurantOperationChallengeDetailUIApi:GetRecommendPowerText(recommendPower)
	return string.format(self:GetCfgText(2100005) .. "：%s", recommendPower)
end

RestaurantOperationChallengeDetailUIApi:Init()
