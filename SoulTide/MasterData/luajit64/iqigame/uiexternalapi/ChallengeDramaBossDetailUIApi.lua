-- chunkname: @IQIGame\\UIExternalApi\\ChallengeDramaBossDetailUIApi.lua

ChallengeDramaBossDetailUIApi = BaseLangApi:Extend()

function ChallengeDramaBossDetailUIApi:Init()
...
function ChallengeDramaBossDetailUIApi:GetBtnShopLabel()
	return self:GetCfgText(1213161)
end

function ChallengeDramaBossDetailUIApi:GetCostValue(num)
	return string.format("x%s", num)
end

function ChallengeDramaBossDetailUIApi:GetTextChallengeBtn()
	return self:GetCfgText(1213003)
end

function ChallengeDramaBossDetailUIApi:GetTextReward()
	return self:GetCfgText(1213071)
end

function ChallengeDramaBossDetailUIApi:GetTextPower(power, needPower)
...
function ChallengeDramaBossDetailUIApi:GetRecommendPowerText(recommendPower)
	return self:GetCfgText(2100005) .. "：" .. recommendPower
end

function ChallengeDramaBossDetailUIApi:GetMazeBossRankIconPath(rank, mySelf, type)
	if type == 1 then
		if rank < 11 then
...
function ChallengeDramaBossDetailUIApi:GetChallengeRankHurt(hurt, mySelf)
	local str = hurt
...
function ChallengeDramaBossDetailUIApi:GetChallengeRankStr(rank, mySelf, type)
	local str = ""
...
function ChallengeDramaBossDetailUIApi:GetNoneRankText()
	return self:GetCfgText(1213068)
end

function ChallengeDramaBossDetailUIApi:GetRankingLabels()
	return {
...
function ChallengeDramaBossDetailUIApi:GetTitleName()
	return self:GetCfgText(9100008)
end

ChallengeDramaBossDetailUIApi:Init()
