-- chunkname: @IQIGame\\UIExternalApi\\EndlessPlusExBossRewardUIApi.lua

EndlessPlusExBossRewardUIApi = BaseLangApi:Extend()

function EndlessPlusExBossRewardUIApi:Init()
...
function EndlessPlusExBossRewardUIApi:GetMazeBossRankIconPath(rank, mySelf, type)
	if type == 1 then
		if rank < 11 then
...
function EndlessPlusExBossRewardUIApi:GetRankRewardIconPath(num1, num2, type)
	if type == 1 then
		if num1 == 4 then
			return self:GetResUrl(2700101)
		elseif num1 == 11 then
...
function EndlessPlusExBossRewardUIApi:GetTextRewardIndex(num1, num2, type)
...
function EndlessPlusExBossRewardUIApi:GetTextNoRank()
	return self:GetCfgText(1213066)
end

function EndlessPlusExBossRewardUIApi:GetTextMsg()
	return self:GetCfgText(3100601)
end

function EndlessPlusExBossRewardUIApi:GetTextRewardTitle()
	return self:GetCfgText(1213077)
end

function EndlessPlusExBossRewardUIApi:GetTextTitle()
	return self:GetCfgText(1213001)
end

EndlessPlusExBossRewardUIApi:Init()
